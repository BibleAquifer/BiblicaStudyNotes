...
* **Associated ACAI Concepts:** Eliud (ID: `person:Eliud`); Jacob (ID: `person:Jacob.2`); Azor (ID: `person:Azor`); Matthan (ID: `person:Matthan`); Zadok (ID: `person:Zadok`); Eleazar (ID: `person:Eleazar`); Abiud (ID: `person:Abiud`); Achim (ID: `person:Achim`); Eliakim (ID: `person:Eliakim`); Ram (ID: `person:Ram`); Salmon (ID: `person:Salmon`); David (ID: `person:David`); Jesus (ID: `person:Jesus.2`); Jehoiachin (ID: `person:Jehoiachin`); Zerubbabel (ID: `person:Zerubbabel.2`); Uzziah (ID: `person:Uzziah`); Josiah (ID: `person:Josiah`); Asa (ID: `person:Asa`); Hezekiah (ID: `person:Hezekiah`); Solomon (ID: `person:Solomon`); Obed (ID: `person:Obed`); Tamar (ID: `person:Tamar`); Rahab (ID: `person:Rahab`); Amminadab (ID: `person:Amminadab`); Nahshon (ID: `person:Nahshon`); Zerah (ID: `person:Zerah.3`); Hezron (ID: `person:Hezron.2`); Joseph (ID: `person:Joseph.4`); Perez (ID: `person:Perez`); Amon (ID: `person:Amon.3`); Abijah (ID: `person:Abijah.4`); Jotham (ID: `person:Jotham.2`); Jehoram (ID: `person:Jehoram`); Uriah (ID: `person:Uriah`); Boaz (ID: `person:Boaz`); Ahaz (ID: `person:Ahaz`); Rehoboam (ID: `person:Rehoboam`); Jehoshaphat (ID: `person:Jehoshaphat.3`); Isaac (ID: `person:Isaac`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Joseph (ID: `person:Joseph.4`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); Mary (ID: `person:Mary`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** Herod (ID: `person:Herod`); Bethlehem (ID: `place:Bethlehem`); Archelaus (ID: `person:Archelaus`); Egypt (ID: `place:Egypt`); Bow Down (ID: `keyterm:BowDown`); Joseph (ID: `person:Joseph.4`); Money Box (ID: `realia:MoneyBox`); Myrrh (ID: `realia:Myrrh`); Frankincense (ID: `flora:Frankincense`); Nazareth (ID: `place:Nazareth`); Myrrh (ID: `flora:Myrrh`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Jeremiah (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** Judea (ID: `place:Judea`); John (ID: `person:John`); Winnowing Fork (ID: `realia:WinnowingFork`); Baptist (ID: `keyterm:Baptist`); Sandal (ID: `realia:Sandal`); Belt (ID: `realia:Belt`); Leather (ID: `realia:Leather`); Threshing Floor (ID: `realia:ThreshingFloor`); Locust (ID: `fauna:Locust`); Isaiah (ID: `person:Isaiah`)
...
* **Associated ACAI Concepts:** Galilee (ID: `place:Galilee`); Nazareth (ID: `place:Nazareth`); Proclaim (ID: `keyterm:Proclaim`); Repent (ID: `keyterm:Repent`)
...
* **Associated ACAI Concepts:** Fishnet (ID: `realia:Fishnet`); Decapolis (ID: `place:Decapolis`); Galilee (ID: `place:Galilee`); Sea of Galilee (ID: `place:GalileeSea`); Zebedee (ID: `person:Zebedee`); Andrew (ID: `person:Andrew`); James (ID: `person:James`); John (ID: `person:John.2`); Synagogue (ID: `realia:Synagogue`); Good News (ID: `keyterm:GoodNews`)
...
* **Associated ACAI Concepts:** Tax Collector (ID: `keyterm:TaxCollector`); Patch (ID: `realia:Patch`); Matthew (ID: `person:Matthew`); Must (ID: `realia:Must`); Mercy (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Tassel (ID: `realia:Tassel`); Affection (ID: `keyterm:Affection`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Zealots (ID: `group:Zealot`); Bag (ID: `realia:Bag`); Simon (ID: `person:Simon.2`); Bartholomew (ID: `person:Bartholomew`); Alphaeus (ID: `person:Alphaeus`); James (ID: `person:James.2`); Judas (ID: `person:Judas`); Thomas (ID: `person:Thomas`); Philip (ID: `person:Philip`); Judas (ID: `person:Judas.2`); Make Peace (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** Baptist (ID: `keyterm:Baptist`); Reed (ID: `flora:Reed`); John (ID: `person:John`)
...
* **Associated ACAI Concepts:** Chorazin (ID: `place:Chorazin`); Yoke (ID: `realia:Yoke`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Disaster (ID: `keyterm:Disaster`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** Jonah (ID: `person:Jonah.2`); Ninevites (ID: `group:Nineveh`); Symbol (ID: `keyterm:Example`); Queen of Sheba (ID: `person:QueenOfSheba`)
...
* **Associated ACAI Concepts:** Herod Antipas (ID: `person:Herod.2`); Herodias (ID: `person:Herodias`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Philip (ID: `person:Philip.2`); Simon (ID: `person:Simon.3`); Prison (ID: `realia:Prison`); Jude (ID: `person:Jude`); James (ID: `person:James.3`); Disbelieve (ID: `keyterm:Disbelieve`); John (ID: `person:John`)
...
* **Associated ACAI Concepts:** Gennesaret (ID: `place:Gennesaret`); Having Little Faith (ID: `keyterm:HavingLittleFaith`); Cheer Up (ID: `keyterm:CheerUp`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Syrophonecian Woman (ID: `person:SyrophonecianWoman`); Dog (ID: `fauna:Dog`); Sidon (ID: `place:Sidon`); Tyre (ID: `place:Tyre`)
...
* **Associated ACAI Concepts:** Peter (ID: `person:Peter`); Caesarea Philippi (ID: `place:CaesareaPhilippi`); Key (ID: `realia:Key`); Church (ID: `keyterm:Church`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Elijah (ID: `person:Elijah`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Stater (ID: `realia:Stater`); Two-Drachma Piece (ID: `realia:Two-drachmaPiece`); Fishhook (ID: `realia:Fishhook`); Mustard (ID: `flora:Mustard`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Serve (ID: `keyterm:Serve`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); Hosanna (ID: `keyterm:Hosanna`); Jerusalem (ID: `place:Jerusalem`); Seat (ID: `realia:Seat`); Bethphage (ID: `place:Bethphage`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Herodians (ID: `group:Herodian`); Sadducees (ID: `group:Sadducee`); Denarius (ID: `realia:Denarius`); Money (ID: `realia:Money`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Dill (ID: `flora:Dill`); Phylactery (ID: `realia:Phylactery`); Mint (ID: `flora:Mint`); Gehenna (ID: `keyterm:Gehenna`); Zechariah (ID: `person:Zechariah.12`); Seat (ID: `realia:Seat`); Cumin (ID: `flora:Cumin`); Mosquito (ID: `fauna:Mosquito`); Plate (ID: `realia:Plate.2`); Hypocrisy (ID: `keyterm:Hypocrisy`); Clean (ID: `keyterm:Clean`); Jehoiada (ID: `person:Jehoiada.2`); Disaster (ID: `keyterm:Disaster`); Pharisees (ID: `group:Pharisee`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Noah (ID: `person:Noah`); Inner Room (ID: `realia:InnerRoom`); Housetop (ID: `realia:Housetop`); Vulture (ID: `fauna:Vulture`); Trumpet (ID: `realia:Trumpet`); Daniel (ID: `person:Daniel.3`); Faithfulness (ID: `keyterm:Faithfulness`); Sky (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** Simon (ID: `person:Simon.4`); Alabaster Jar (ID: `realia:AlabasterJar`); Bethany (ID: `place:Bethany`); Judas (ID: `person:Judas.2`)
...
* **Associated ACAI Concepts:** Gethsemane (ID: `place:Gethsemane`); Rooster (ID: `fauna:Rooster`); Spirit (ID: `keyterm:Spirit.2`); Pray (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** To Cause to Happen (ID: `keyterm:Happen`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Caiaphas (ID: `person:Caiaphas`); Courtyard (ID: `realia:Courtyard`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Akeldama (ID: `place:Akeldama`); Temple Treasury (ID: `place:Corban`); Pilate (ID: `person:Pilate`)
...
* **Associated ACAI Concepts:** Judgment Seat (ID: `realia:JudgmentSeat`); Barabbas (ID: `person:Barabbas`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Simon (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); Cyrene (ID: `place:Cyrene`); Crown (ID: `realia:Crown.2`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Crown (ID: `realia:Crown`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Mary (ID: `person:Mary.2`); Joseph (ID: `person:Joseph.6`); Joseph (ID: `person:Joseph.5`); James (ID: `person:James.4`); Mary Magdalene (ID: `person:Marymagdalene`); Arimathea (ID: `place:Arimathea`); Sour Wine (ID: `realia:SourWine`); Zebedee (ID: `person:Zebedee`); Seal (ID: `realia:Seal`); Curtain (ID: `realia:Curtain`); Reed (ID: `flora:Reed`); Jesus (ID: `person:Jesus.2`)
