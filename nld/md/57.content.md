...
* **Associated ACAI Concepts:** Philemon (ID: `person:Philemon`); Apphia (ID: `person:Apphia`); Archippus (ID: `person:Archippus`); Onesimus (ID: `person:Onesimus`); Epaphras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Luke (ID: `person:Luke`); Guest Room (ID: `realia:GuestRoom`); Owe (ID: `keyterm:Owe`); Jesus (ID: `person:Jesus.2`)
