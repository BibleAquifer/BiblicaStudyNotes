...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Bethlehem (ID: `place:Bethlehem`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Orpah (ID: `person:Orpah`); Chilion (ID: `person:Chilion`); Mahlon (ID: `person:Mahlon`); Elimelech (ID: `person:Elimelech`); Ephrathites (ID: `group:Ephrathah`); Women (ID: `group:GenericFemales`); Ephrathah (ID: `person:Ephrathah`); Kindness (ID: `keyterm:Kindness`); Appoint (ID: `keyterm:Appoint`); Hope (ID: `keyterm:Hope`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Boaz (ID: `person:Boaz`); Naomi (ID: `person:Naomi`); LORD (ID: `deity:Lord`); Ruth (ID: `person:Ruth`); Redeem (ID: `keyterm:Redeem`); Obed (ID: `person:Obed`); Threshing Floor (ID: `realia:ThreshingFloor`); To Cause to Possess (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Israel (ID: `person:Israel`); Kinsman Redeemer (ID: `person:KinsmanRedeemer`); Salmon (ID: `person:Salmon`); Hezron (ID: `person:Hezron.2`); Barley (ID: `flora:Barley`); Mahlon (ID: `person:Mahlon`); Perez (ID: `person:Perez`); Bless (ID: `keyterm:Bless`); David (ID: `person:David`); Elimelech (ID: `person:Elimelech`); Jesse (ID: `person:Jesse`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Women (ID: `group:GenericFemales`); Chilion (ID: `person:Chilion`); Rachel (ID: `person:Rachel`); Love (ID: `keyterm:Love`); Judah (ID: `person:Judah.4`); Tamar (ID: `person:Tamar`); Bethlehem (ID: `place:Bethlehem`); Nahshon (ID: `person:Nahshon`); Fear (ID: `keyterm:Fear`); Elders (ID: `group:GenericElders`); Kindness (ID: `keyterm:Kindness`); Leah (ID: `person:Leah`); Tribe of Judah (ID: `group:Judah`)
