...
* **Associated ACAI Concepts:** Joseph (ID: `person:Joseph.3`); Simon (ID: `person:Simon.3`); Jude (ID: `person:Jude`); Disbelieve (ID: `keyterm:Disbelieve`)
...
* **Associated ACAI Concepts:** Herod Antipas (ID: `person:Herod.2`); Herodias (ID: `person:Herodias`); Plate (ID: `realia:Plate.2`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Philip (ID: `person:Philip.2`); John (ID: `person:John`)
...
* **Associated ACAI Concepts:** Gennesaret (ID: `place:Gennesaret`); Bethsaida (ID: `place:Bethsaida`)
...
* **Associated ACAI Concepts:** Teaching (ID: `keyterm:Teaching`); Pharisees (ID: `group:Pharisee`); Temple Treasury (ID: `place:Corban`); Defilement (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** Syrophoenicians (ID: `group:Phoenicia`); Tyre (ID: `place:Tyre`); Decapolis (ID: `place:Decapolis`); Phoenicia (ID: `place:Phoenicia`); Greeks (ID: `group:Greek`); Sidon (ID: `place:Sidon`)
...
* **Associated ACAI Concepts:** Caesarea Philippi (ID: `place:CaesareaPhilippi`); Bethsaida (ID: `place:Bethsaida`); Baptist (ID: `keyterm:Baptist`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); Jesus (ID: `person:Jesus.2`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Bartimaeus (ID: `person:Bartimaeus`); Timaeus (ID: `person:Timaeus`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Hosanna (ID: `keyterm:Hosanna`); Bethany (ID: `place:Bethany`); Bethphage (ID: `place:Bethphage`); Rush (ID: `flora:Rush`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Herodians (ID: `group:Herodian`); Denarius (ID: `realia:Denarius`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `realia:Myrrh`); Simon (ID: `person:Simon.4`); Oil of Nard (ID: `realia:OilOfNard`); Alabaster Jar (ID: `realia:AlabasterJar`); Nard (ID: `flora:Nard`); Bethany (ID: `place:Bethany`)
...
* **Associated ACAI Concepts:** Centurion at Crucifixion (ID: `person:Centurion.3`); Alexander (ID: `person:Alexander`); Rufus (ID: `person:Rufus`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Simon (ID: `person:Simon.5`); Purple Cloth (ID: `realia:PurpleCloth`); Golgotha (ID: `place:Golgotha`); Palace (ID: `realia:Palace`); Cyrene (ID: `place:Cyrene`); Myrrh (ID: `flora:Myrrh`); Cross (ID: `realia:Cross`)
