...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Canaan (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Israel (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Joshua (ID: `person:Joshua.2`); Caleb (ID: `person:Caleb`); Force to Serve (ID: `keyterm:EnticedToServe`); Bethel (ID: `place:Bethel`); Amorites (ID: `group:Amorites`); Adoni-bezek (ID: `person:Adoni-bezek`); Joseph (ID: `person:Joseph.10`); Perizzites (ID: `group:Perizzites`); Moses (ID: `person:Moses`); Negev (ID: `place:Negeb`); Covenant (ID: `keyterm:Covenant`); Jerusalem (ID: `place:Jerusalem`); Bezek (ID: `place:Bezek`); Achsah (ID: `person:Achsah`); Tribe of Asher (ID: `group:Asher`); Baal (ID: `deity:Baal`); Jebusites (ID: `group:Jebusites`); To Cause to Possess (ID: `keyterm:Possess`); Egypt (ID: `place:Egypt`); Tribe of Simeon (ID: `group:Simeon`); Simeon (ID: `person:Simeon.5`); Hebron (ID: `place:Hebron`); Debir (ID: `place:Debir`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Sisera (ID: `person:Sisera`); Barak (ID: `person:Barak`); Deborah (ID: `person:Deborah.2`); Ehud (ID: `person:Ehud`); Jael (ID: `person:Jael`); Moab (ID: `place:Moab`); Jabin (ID: `person:Jabin.2`); Heber (ID: `person:Heber.2`); Abinoam (ID: `person:Abinoam`); Eglon (ID: `person:Eglon`); Chariot (ID: `realia:Chariot`); Tent (ID: `realia:Tent`); Kedesh (ID: `place:Kedesh`); Zebulun (ID: `person:Zebulun`); Canaan (ID: `place:Canaan`); Tribe of Zebulun (ID: `group:Zebulun`); Sword (ID: `realia:Sword`); Harosheth-hagoyim (ID: `place:Harosheth-hagoyim`); Mount Tabor (ID: `place:TaborMount`); Kishon (ID: `place:Kishon`); Kenites (ID: `group:Kenite`); Force to Serve (ID: `keyterm:EnticedToServe`); Naphtali (ID: `person:Naphtali`); Tribe of Naphtali (ID: `group:Naphtali`); Offering (ID: `keyterm:Offering`); Bless (ID: `keyterm:Bless`); Tribe of Ephraim (ID: `group:Ephraim`); Ephraim (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Gideon (ID: `person:Gideon`); LORD (ID: `deity:Lord`); Abimelech (ID: `person:Abimelech.2`); Midian (ID: `place:Midian`); Israel (ID: `person:Israel`); Shechem (ID: `place:Shechem`); Gaal (ID: `person:Gaal`); Joash (ID: `person:Joash`); Zalmunna (ID: `person:Zalmunna`); Zebah (ID: `person:Zebah`); An Angel (ID: `deity:Angel`); Ophrah (ID: `place:Ophrah.2`); Zebul (ID: `person:Zebul`); Ebed (ID: `person:Ebed`); Baal (ID: `deity:Baal`); Succoth (ID: `place:Succoth`); Fear (ID: `keyterm:Fear`); Abiezer (ID: `person:Abiezer`); Jotham (ID: `person:Jotham`); Asherah (ID: `deity:Asherah`); East (ID: `place:East`); Tower (ID: `realia:Tower`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Rams Horn (ID: `realia:RamsHorn`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Abiezrites (ID: `group:Abiezer`); Egypt (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Ammon (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Jephthah (ID: `person:Jephthah`); LORD (ID: `deity:Lord`); Gilead (ID: `place:Gilead`); Tribe of Ephraim (ID: `group:Ephraim`); Ephraim (ID: `person:Ephraim`); Jordan River (ID: `place:Jordan`); Amorites (ID: `group:Amorites`); Moab (ID: `place:Moab`); An Angel (ID: `deity:Angel`); Arnon (ID: `place:Arnon`); Mizpah (ID: `place:Mizpah.2`); Force to Serve (ID: `keyterm:EnticedToServe`); Gileadites (ID: `group:Gilead`); Dispossess (ID: `keyterm:Dispossess`); Egypt (ID: `place:Egypt`); Philistines (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); Sihon (ID: `person:Sihon`); To Sin (ID: `keyterm:Sin`); Gilead (ID: `person:Gilead.2`); Abdon (ID: `person:Abdon`); Hillel (ID: `person:Hillel`); Shamir (ID: `place:Shamir.2`); Jair (ID: `person:Jair.3`); Elon (ID: `person:Elon.3`); Ibzan (ID: `person:Ibzan`); Tribe of Zebulun (ID: `group:Zebulun`)
...
* **Associated ACAI Concepts:** Samson (ID: `person:Samson`); LORD (ID: `deity:Lord`); Philistines (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); Manoah (ID: `person:Manoah`); An Angel (ID: `deity:Angel`); Delilah (ID: `person:Delilah`); Strength (ID: `keyterm:Strength`); Israel (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Zorah (ID: `place:Zorah`); Lehi (ID: `place:Lehi`); Nazirites (ID: `group:Nazirite`); Offering (ID: `keyterm:Offering`); Gaza (ID: `place:Gaza`); Tribe of Judah (ID: `group:Judah`); Defilement (ID: `keyterm:Defilement`); Judah (ID: `person:Judah.4`); Timnah (ID: `place:Timnah`); Love (ID: `keyterm:Love`); Goat (ID: `fauna:Goat`); Lion (ID: `fauna:Lion`); Rope (ID: `realia:Rope`); Kid (ID: `fauna:Kid`); Manoah's Wife (ID: `person:WifeOfManoah`); Etam (ID: `place:Etam`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Eshtaol (ID: `place:Eshtaol`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Micah (ID: `person:Micah.3`); Dan (ID: `place:Dan`); Tribe of Dan (ID: `group:Dan`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Teraphim (ID: `deity:Teraphim`); Graven Image (ID: `realia:GravenImage`); Household Idols (ID: `realia:HouseholdIdols`); Molten Image (ID: `realia:MoltenImage`); Ephod (ID: `realia:Ephod`); Ephraim (ID: `person:Ephraim`); Tribe of Ephraim (ID: `group:Ephraim`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Eshtaol (ID: `place:Eshtaol`); Money (ID: `realia:Money`); A Person (ID: `person:GenericPerson`); Trust (ID: `keyterm:LeanOn`); Zorah (ID: `place:Zorah`); Bethlehem (ID: `place:Bethlehem`); Mother of Micah (ID: `person:MotherOfMicah.3`); Sidon (ID: `place:Sidon`); Peace (ID: `keyterm:IntactState`); Dispossess (ID: `keyterm:Dispossess`); Mahaneh-dan (ID: `place:Mahaneh-dan`); Gershom (ID: `person:Gershom`); Military Members (ID: `group:MilitaryMembers`); Jonathan (ID: `person:Jonathan.2`); Beth-rehob (ID: `place:Beth-rehob`); To Cause to Possess (ID: `keyterm:Possess`); Kiriath-jearim (ID: `place:Kiriath-jearim`); To Curse (ID: `keyterm:Curse`); Bless (ID: `keyterm:Bless`); Shiloh (ID: `place:Shiloh`); Moses (ID: `person:Moses`); Safety (ID: `keyterm:Safety`); Holy (ID: `keyterm:Holy`); Sidonians (ID: `group:Sidon`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Tribe of Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`); Gibeah (ID: `place:Gibeah.2`); LORD (ID: `deity:Lord`); Jabesh-gilead (ID: `place:Jabesh-gilead`); Mizpah (ID: `place:Mizpah`); Bethel (ID: `place:Bethel`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); To Cause to Possess (ID: `keyterm:Possess`); A Father (ID: `person:GenericFather`); Tribe of Judah (ID: `group:Judah`); Foolish (ID: `keyterm:Foolish`); Judah (ID: `person:Judah.4`); Donkey (ID: `fauna:Donkey`); Rock of Rimmon (ID: `place:Rimmon.3`); Ephraim (ID: `person:Ephraim`); Tribe of Ephraim (ID: `group:Ephraim`); Swear (ID: `keyterm:Swear`); Shiloh (ID: `place:Shiloh`); Bethlehem (ID: `place:Bethlehem`); Offering (ID: `keyterm:Offering`); A Man (ID: `person:GenericMale`); Jerusalem (ID: `place:Jerusalem`); Tribe of Levi (ID: `group:Levi`); Wickedness (ID: `keyterm:Wickedness`); Levi (ID: `person:Levi.3`); Peace (ID: `keyterm:IntactState`); Vine (ID: `flora:Vine`)
