...
* **Associated ACAI Concepts:** Moses (ID: `person:Moses`); LORD (ID: `deity:Lord`); Aaron (ID: `person:Aaron`); Israel (ID: `person:Israel`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Gershon (ID: `person:Gershon`); Kohath (ID: `person:Kohath`); Holy (ID: `keyterm:Holy`); Merari (ID: `person:Merari`); Force to Serve (ID: `keyterm:EnticedToServe`); Gershonites (ID: `group:Gershon`); Judah (ID: `person:Judah.4`); Kohathites (ID: `group:Kohath`); Dan (ID: `place:Dan`); Tribe of Dan (ID: `group:Dan`); Ephraim (ID: `person:Ephraim`); Tribe of Reuben (ID: `group:Reuben`); Reuben (ID: `person:Reuben`); Tribe of Judah (ID: `group:Judah`); Tribe of Ephraim (ID: `group:Ephraim`); Tent of Meeting (ID: `realia:TentOfMeeting`); Standard (ID: `realia:Standard`); Wilderness of Sinai (ID: `place:SinaiWilderness`); Ithamar (ID: `person:Ithamar`); Tribe of Manasseh (ID: `group:Manasseh`); Tribe of Issachar (ID: `group:Issachar`); Tribe of Zebulun (ID: `group:Zebulun`); Asher (ID: `person:Asher`); Eleazar (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); To Sin (ID: `keyterm:Sin`); LORD (ID: `deity:Lord`); Slaughtering (ID: `keyterm:Slaughtering`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Aaron (ID: `person:Aaron`); Force to Serve (ID: `keyterm:EnticedToServe`); Dish (ID: `realia:Dish`); Shekel (ID: `realia:Shekel`); Money (ID: `realia:Money`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Tent of Meeting (ID: `realia:TentOfMeeting`); Pure (ID: `keyterm:Pure`); Smear (ID: `keyterm:Smear`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Appease (ID: `keyterm:Appease`); Wagon (ID: `realia:Wagon`); Helon (ID: `person:Helon`); Gideoni (ID: `person:Gideoni`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Moses (ID: `person:Moses`); Passover (ID: `keyterm:Passover`); Trumpet (ID: `realia:Trumpet`); Standard (ID: `realia:Standard`); Defilement (ID: `keyterm:Defilement`); Offering (ID: `keyterm:Offering`); Wilderness of Sinai (ID: `place:SinaiWilderness`); Testimony (ID: `keyterm:Witness.2`); Covenant Box (ID: `keyterm:CovenantBox`); Aaron (ID: `person:Aaron`); Elizur (ID: `person:Elizur`); Zurishaddai (ID: `person:Zurishaddai`); Eliasaph (ID: `person:Eliasaph`); Ochran (ID: `person:Ochran`); Hobab (ID: `person:Hobab`); Kohathites (ID: `group:Kohath`); Enan (ID: `person:Enan`); Pedahzur (ID: `person:Pedahzur`); Deuel (ID: `person:Deuel`); Ammihud (ID: `person:Ammihud`); Zuar (ID: `person:Zuar`); Eliab (ID: `person:Eliab`); Abidan (ID: `person:Abidan`); Ahiezer (ID: `person:Ahiezer`); Pagiel (ID: `person:Pagiel`); Gamaliel (ID: `person:Gamaliel.2`); Ahira (ID: `person:Ahira`); Jethro (ID: `person:Jethro`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Aaron (ID: `person:Aaron`); Defilement (ID: `keyterm:Defilement`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Korah (ID: `person:Korah.3`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Abiram (ID: `person:Abiram`); To Cause to Possess (ID: `keyterm:Possess`); Pure (ID: `keyterm:Pure`); Holy (ID: `keyterm:Holy`); Dathan (ID: `person:Dathan`); Testimony (ID: `keyterm:Witness.2`); To Cleanse (ID: `keyterm:Cleanse.2`); Force to Serve (ID: `keyterm:EnticedToServe`); Tent of Meeting (ID: `realia:TentOfMeeting`); Cattle (ID: `fauna:Bull`); Rod (ID: `realia:Rod`); Instruction (ID: `keyterm:Instruction`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Eleazar (ID: `person:Eleazar.2`); Appease (ID: `keyterm:Appease`); Temple Altar (ID: `realia:TempleAltar`); Shovel (ID: `realia:Shovel`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Eleazar (ID: `person:Eleazar.2`); Complete (ID: `keyterm:Complete`); Vow (ID: `keyterm:Vow`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Midian (ID: `place:Midian`); To Cause to Possess (ID: `keyterm:Possess`); Aaron (ID: `person:Aaron`); Sheep (ID: `fauna:Lamb`); Work (ID: `keyterm:Work`); Tribe of Levi (ID: `group:Levi`); Midianites (ID: `group:Midian`); Levi (ID: `person:Levi.3`); Korah (ID: `person:Korah.3`); Appease (ID: `keyterm:Appease`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Plague (ID: `keyterm:Blow`); Tribe of Manasseh (ID: `group:Manasseh`); Manasseh (ID: `person:Manasseh`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Donkey (ID: `fauna:Donkey`); Zelophehad (ID: `person:Zelophehad`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); To Cause to Possess (ID: `keyterm:Possess`); Jordan River (ID: `place:Jordan`); Refuge (ID: `keyterm:Refuge`); Gad (ID: `person:Gad`); Tribe of Reuben (ID: `group:Reuben`); Reuben (ID: `person:Reuben`); Canaan (ID: `place:Canaan`); Tribe of Manasseh (ID: `group:Manasseh`); Manasseh (ID: `person:Manasseh`); Dispossess (ID: `keyterm:Dispossess`); Gilead (ID: `place:Gilead`); Tribe of Levi (ID: `group:Levi`); Egypt (ID: `place:Egypt`); Plains of Moab (ID: `place:MoabPlains`); Joseph (ID: `person:Joseph.10`); Levi (ID: `person:Levi.3`); Jericho (ID: `place:Jericho`); Mount Hor (ID: `place:HorMount`); Dibon (ID: `place:Dibon`); Zelophehad (ID: `person:Zelophehad`); Kadesh-barnea (ID: `place:Kadesh-barnea`); Lot (ID: `keyterm:Lot`); Machir (ID: `person:Machir`); Nebo (ID: `place:Nebo`); Eleazar (ID: `person:Eleazar.2`); Etham (ID: `place:Etham`); Nun (ID: `person:Nun`)
