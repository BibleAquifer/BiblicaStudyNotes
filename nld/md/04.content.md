...
* **Associated ACAI Concepts:** Moses (ID: `person:Moses`); LORD (ID: `deity:Lord`); Aaron (ID: `person:Aaron`); Israel (ID: `person:Israel`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Gershon (ID: `person:Gershon`); Kohath (ID: `person:Kohath`); Holy (ID: `keyterm:Holy`); Merari (ID: `person:Merari`); Force to Serve (ID: `keyterm:EnticedToServe`); Gershonites (ID: `group:Gershon`); Tribe of Judah (ID: `group:Judah`); Tribe of Dan (ID: `group:Dan`); Tribe of Reuben (ID: `group:Reuben`); Judah (ID: `person:Judah.4`); Kohathites (ID: `group:Kohath`); Tribe of Ephraim (ID: `group:Ephraim`); Dan (ID: `place:Dan`); Ephraim (ID: `person:Ephraim`); Reuben (ID: `person:Reuben`); Tent of Meeting (ID: `realia:TentOfMeeting`); Standard (ID: `realia:Standard`); Ithamar (ID: `person:Ithamar`); Wilderness of Sinai (ID: `place:SinaiWilderness`); Tribe of Zebulun (ID: `group:Zebulun`); Tribe of Issachar (ID: `group:Issachar`); Zebulun (ID: `person:Zebulun`); Naphtali (ID: `person:Naphtali`); Tribe of Asher (ID: `group:Asher`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Moses (ID: `person:Moses`); Passover (ID: `keyterm:Passover`); Trumpet (ID: `realia:Trumpet`); Standard (ID: `realia:Standard`); Offering (ID: `keyterm:Offering`); Defilement (ID: `keyterm:Defilement`); Wilderness of Sinai (ID: `place:SinaiWilderness`); Covenant Box (ID: `keyterm:CovenantBox`); Aaron (ID: `person:Aaron`); Testimony (ID: `keyterm:Witness.2`); Jethro (ID: `person:Jethro`); Pagiel (ID: `person:Pagiel`); Hobab (ID: `person:Hobab`); Pedahzur (ID: `person:Pedahzur`); Enan (ID: `person:Enan`); Eliasaph (ID: `person:Eliasaph`); Ochran (ID: `person:Ochran`); Ammihud (ID: `person:Ammihud`); Kohathites (ID: `group:Kohath`); Ahira (ID: `person:Ahira`); Elizur (ID: `person:Elizur`); Eliab (ID: `person:Eliab`); Abidan (ID: `person:Abidan`); Zuar (ID: `person:Zuar`); Deuel (ID: `person:Deuel`); Zurishaddai (ID: `person:Zurishaddai`); Ahiezer (ID: `person:Ahiezer`); Gamaliel (ID: `person:Gamaliel.2`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Eleazar (ID: `person:Eleazar.2`); Complete (ID: `keyterm:Complete`); Vow (ID: `keyterm:Vow`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Midian (ID: `place:Midian`); To Cause to Possess (ID: `keyterm:Possess`); Aaron (ID: `person:Aaron`); Sheep (ID: `fauna:Lamb`); Work (ID: `keyterm:Work`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Midianites (ID: `group:Midian`); Korah (ID: `person:Korah.3`); Appease (ID: `keyterm:Appease`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Plague (ID: `keyterm:Blow`); Tribe of Manasseh (ID: `group:Manasseh`); Manasseh (ID: `person:Manasseh`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Donkey (ID: `fauna:Donkey`); Hepher (ID: `person:Hepher`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); To Cause to Possess (ID: `keyterm:Possess`); Jordan River (ID: `place:Jordan`); Refuge (ID: `keyterm:Refuge`); Gad (ID: `person:Gad`); Tribe of Reuben (ID: `group:Reuben`); Reuben (ID: `person:Reuben`); Canaan (ID: `place:Canaan`); Tribe of Manasseh (ID: `group:Manasseh`); Manasseh (ID: `person:Manasseh`); Gilead (ID: `place:Gilead`); Dispossess (ID: `keyterm:Dispossess`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Jericho (ID: `place:Jericho`); Joseph (ID: `person:Joseph.10`); Plains of Moab (ID: `place:MoabPlains`); Egypt (ID: `place:Egypt`); Mount Hor (ID: `place:HorMount`); Dibon (ID: `place:Dibon`); Lot (ID: `keyterm:Lot`); Kadesh-barnea (ID: `place:Kadesh-barnea`); Zelophehad (ID: `person:Zelophehad`); Machir (ID: `person:Machir`); Aaron (ID: `person:Aaron`); Etham (ID: `place:Etham`); Joshua (ID: `person:Joshua.2`); Jazer (ID: `place:Jazer`)
