...
* **Associated ACAI Concepts:** Moses (ID: `person:Moses`); LORD (ID: `deity:Lord`); Aaron (ID: `person:Aaron`); Israel (ID: `person:Israel`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Gershon (ID: `person:Gershon`); Kohath (ID: `person:Kohath`); Holy (ID: `keyterm:Holy`); Merari (ID: `person:Merari`); Force to Serve (ID: `keyterm:EnticedToServe`); Gershonites (ID: `group:Gershon`); Kohathites (ID: `group:Kohath`); Judah (ID: `person:Judah.4`); Reuben (ID: `person:Reuben`); Tribe of Ephraim (ID: `group:Ephraim`); Tribe of Reuben (ID: `group:Reuben`); Tribe of Dan (ID: `group:Dan`); Tribe of Judah (ID: `group:Judah`); Dan (ID: `place:Dan`); Ephraim (ID: `person:Ephraim`); Tent of Meeting (ID: `realia:TentOfMeeting`); Standard (ID: `realia:Standard`); Ithamar (ID: `person:Ithamar`); Wilderness of Sinai (ID: `place:SinaiWilderness`); Tribe of Issachar (ID: `group:Issachar`); Asher (ID: `person:Asher`); Tribe of Simeon (ID: `group:Simeon`); Naphtali (ID: `person:Naphtali`); Simeon (ID: `person:Simeon.5`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); To Sin (ID: `keyterm:Sin`); LORD (ID: `deity:Lord`); Slaughtering (ID: `keyterm:Slaughtering`); Israel (ID: `person:Israel`); Moses (ID: `person:Moses`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Aaron (ID: `person:Aaron`); Force to Serve (ID: `keyterm:EnticedToServe`); Dish (ID: `realia:Dish`); Shekel (ID: `realia:Shekel`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Tent of Meeting (ID: `realia:TentOfMeeting`); Pure (ID: `keyterm:Pure`); Smear (ID: `keyterm:Smear`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Appease (ID: `keyterm:Appease`); Wagon (ID: `realia:Wagon`); Ammishaddai (ID: `person:Ammishaddai`); Pagiel (ID: `person:Pagiel`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Moses (ID: `person:Moses`); Passover (ID: `keyterm:Passover`); Standard (ID: `realia:Standard`); Trumpet (ID: `realia:Trumpet`); Defilement (ID: `keyterm:Defilement`); Wilderness of Sinai (ID: `place:SinaiWilderness`); Offering (ID: `keyterm:Offering`); Testimony (ID: `keyterm:Witness.2`); Covenant Box (ID: `keyterm:CovenantBox`); Aaron (ID: `person:Aaron`); Ammihud (ID: `person:Ammihud`); Jethro (ID: `person:Jethro`); Pagiel (ID: `person:Pagiel`); Elizur (ID: `person:Elizur`); Kohathites (ID: `group:Kohath`); Ahiezer (ID: `person:Ahiezer`); Eliasaph (ID: `person:Eliasaph`); Zuar (ID: `person:Zuar`); Hobab (ID: `person:Hobab`); Abidan (ID: `person:Abidan`); Gamaliel (ID: `person:Gamaliel.2`); Zurishaddai (ID: `person:Zurishaddai`); Enan (ID: `person:Enan`); Ahira (ID: `person:Ahira`); Deuel (ID: `person:Deuel`); Ochran (ID: `person:Ochran`); Pedahzur (ID: `person:Pedahzur`); Eliab (ID: `person:Eliab`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Egypt (ID: `place:Egypt`); Aaron (ID: `person:Aaron`); Caleb (ID: `person:Caleb`); Nun (ID: `person:Nun`); Canaan (ID: `place:Canaan`); Joshua (ID: `person:Joshua.2`); Miriam (ID: `person:Miriam`); Jephunneh (ID: `person:Jephunneh`); Amalek (ID: `place:Amalek`); Canaanites (ID: `group:Canaan`); Amalekites (ID: `group:Amalek`); Tent (ID: `realia:Tent`); Paran (ID: `place:Paran`); Negev (ID: `place:Negeb`); Anak (ID: `person:Anak`); Speak as a Prophet (ID: `keyterm:Speak`); Forgive (ID: `keyterm:Forgive`); Glory (ID: `keyterm:Glory`); Dispossess (ID: `keyterm:Dispossess`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Swear (ID: `keyterm:Swear`); Passion (ID: `keyterm:Ardour`); Kibroth-hattaavah (ID: `place:Kibroth-hattaavah`); Eldad (ID: `person:Eldad`); Medad (ID: `person:Medad`); Land Flowing of Milk and Honey (ID: `keyterm:LandFlowingOfMilkAndHoney`); Valley of Eshcol (ID: `place:EshcolValley`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Aaron (ID: `person:Aaron`); Defilement (ID: `keyterm:Defilement`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Korah (ID: `person:Korah.3`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Abiram (ID: `person:Abiram`); To Cause to Possess (ID: `keyterm:Possess`); Pure (ID: `keyterm:Pure`); Holy (ID: `keyterm:Holy`); Dathan (ID: `person:Dathan`); Force to Serve (ID: `keyterm:EnticedToServe`); Testimony (ID: `keyterm:Witness.2`); To Cleanse (ID: `keyterm:Cleanse.2`); Tent of Meeting (ID: `realia:TentOfMeeting`); Cattle (ID: `fauna:Bull`); Rod (ID: `realia:Rod`); Appease (ID: `keyterm:Appease`); Eleazar (ID: `person:Eleazar.2`); Instruction (ID: `keyterm:Instruction`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Temple Altar (ID: `realia:TempleAltar`); Shovel (ID: `realia:Shovel`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Balaam (ID: `person:Balaam`); Balak (ID: `person:Balak`); Israel (ID: `person:Israel`); Moab (ID: `place:Moab`); Moses (ID: `person:Moses`); An Angel (ID: `deity:Angel`); To Curse (ID: `keyterm:Curse`); Aaron (ID: `person:Aaron`); Amorites (ID: `group:Amorites`); Bless (ID: `keyterm:Bless`); Egypt (ID: `place:Egypt`); Sihon (ID: `person:Sihon`); Proverb (ID: `keyterm:Saying`); Edom (ID: `place:Edom`); Arnon (ID: `place:Arnon`); Heshbon (ID: `place:Heshbon`); Zippor (ID: `person:Zippor`); Mount Hor (ID: `place:HorMount`); Donkey (ID: `fauna:Donkey`); Kadesh-barnea (ID: `place:Kadesh-barnea`); Cattle (ID: `fauna:Bull`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Offering (ID: `keyterm:Offering`); Sheep (ID: `fauna:Lamb`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Eleazar (ID: `person:Eleazar.2`); Complete (ID: `keyterm:Complete`); Vow (ID: `keyterm:Vow`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Midian (ID: `place:Midian`); To Cause to Possess (ID: `keyterm:Possess`); Aaron (ID: `person:Aaron`); Sheep (ID: `fauna:Lamb`); Work (ID: `keyterm:Work`); Appease (ID: `keyterm:Appease`); Levi (ID: `person:Levi.3`); Midianites (ID: `group:Midian`); Tribe of Levi (ID: `group:Levi`); Korah (ID: `person:Korah.3`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Plague (ID: `keyterm:Blow`); Tribe of Manasseh (ID: `group:Manasseh`); Manasseh (ID: `person:Manasseh`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Donkey (ID: `fauna:Donkey`); Hepher (ID: `person:Hepher`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); To Cause to Possess (ID: `keyterm:Possess`); Jordan River (ID: `place:Jordan`); Refuge (ID: `keyterm:Refuge`); Gad (ID: `person:Gad`); Reuben (ID: `person:Reuben`); Tribe of Reuben (ID: `group:Reuben`); Canaan (ID: `place:Canaan`); Tribe of Manasseh (ID: `group:Manasseh`); Manasseh (ID: `person:Manasseh`); Dispossess (ID: `keyterm:Dispossess`); Gilead (ID: `place:Gilead`); Levi (ID: `person:Levi.3`); Joseph (ID: `person:Joseph.10`); Egypt (ID: `place:Egypt`); Tribe of Levi (ID: `group:Levi`); Plains of Moab (ID: `place:MoabPlains`); Jericho (ID: `place:Jericho`); Dibon (ID: `place:Dibon`); Mount Hor (ID: `place:HorMount`); Kadesh-barnea (ID: `place:Kadesh-barnea`); Lot (ID: `keyterm:Lot`); Zelophehad (ID: `person:Zelophehad`); Machir (ID: `person:Machir`); Wilderness of Zin (ID: `place:Zin`); Eleazar (ID: `person:Eleazar.2`); Joshua (ID: `person:Joshua.2`); Nun (ID: `person:Nun`)
