...
* **Associated ACAI Concepts:** Moses (ID: `person:Moses`); LORD (ID: `deity:Lord`); Aaron (ID: `person:Aaron`); Israel (ID: `person:Israel`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Gershon (ID: `person:Gershon`); Kohath (ID: `person:Kohath`); Holy (ID: `keyterm:Holy`); Merari (ID: `person:Merari`); Force to Serve (ID: `keyterm:EnticedToServe`); Gershonites (ID: `group:Gershon`); Tribe of Judah (ID: `group:Judah`); Tribe of Reuben (ID: `group:Reuben`); Reuben (ID: `person:Reuben`); Tribe of Ephraim (ID: `group:Ephraim`); Dan (ID: `place:Dan`); Ephraim (ID: `person:Ephraim`); Tribe of Dan (ID: `group:Dan`); Kohathites (ID: `group:Kohath`); Judah (ID: `person:Judah.4`); Tent of Meeting (ID: `realia:TentOfMeeting`); Standard (ID: `realia:Standard`); Ithamar (ID: `person:Ithamar`); Wilderness of Sinai (ID: `place:SinaiWilderness`); Tribe of Asher (ID: `group:Asher`); Tribe of Simeon (ID: `group:Simeon`); Simeon (ID: `person:Simeon.5`); Naphtali (ID: `person:Naphtali`); Tribe of Naphtali (ID: `group:Naphtali`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Nazirites (ID: `group:Nazirite`); Defilement (ID: `keyterm:Defilement`); Consecration (ID: `keyterm:Consecration.2`); Passion (ID: `keyterm:Ardour`); Withdraw Oneself (ID: `keyterm:WithdrawOneself`); Israel (ID: `person:Israel`); To Curse (ID: `keyterm:Curse`); To Sin (ID: `keyterm:Sin`); Instruction (ID: `keyterm:Instruction`); Moses (ID: `person:Moses`); Holy (ID: `keyterm:Holy`); Wine (ID: `realia:Wine`); Sheep (ID: `fauna:Lamb`); Bless (ID: `keyterm:Bless`); Be Blameless (ID: `keyterm:Blameless`); Be Unfaithful (ID: `keyterm:Unfaithful`); Vow (ID: `keyterm:Vow`); Slaughtering (ID: `keyterm:Slaughtering`); Appease (ID: `keyterm:Appease`); Swear (ID: `keyterm:Swear`); Pure (ID: `keyterm:Pure`); Be Zealous (ID: `keyterm:Zealous`); Vine (ID: `flora:Vine`); Tent of Meeting (ID: `realia:TentOfMeeting`); Basket (ID: `realia:Basket`); Unleavened Bread (ID: `realia:UnleavenedBread`); Peace (ID: `keyterm:IntactState`); Aaron (ID: `person:Aaron`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); LORD (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Slaughtering (ID: `keyterm:Slaughtering`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Aaron (ID: `person:Aaron`); Force to Serve (ID: `keyterm:EnticedToServe`); Dish (ID: `realia:Dish`); Money (ID: `realia:Money`); Shekel (ID: `realia:Shekel`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Tent of Meeting (ID: `realia:TentOfMeeting`); Pure (ID: `keyterm:Pure`); Smear (ID: `keyterm:Smear`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Appease (ID: `keyterm:Appease`); Wagon (ID: `realia:Wagon`); Ahiezer (ID: `person:Ahiezer`); Abidan (ID: `person:Abidan`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Moses (ID: `person:Moses`); Passover (ID: `keyterm:Passover`); Standard (ID: `realia:Standard`); Trumpet (ID: `realia:Trumpet`); Offering (ID: `keyterm:Offering`); Defilement (ID: `keyterm:Defilement`); Wilderness of Sinai (ID: `place:SinaiWilderness`); Testimony (ID: `keyterm:Witness.2`); Covenant Box (ID: `keyterm:CovenantBox`); Aaron (ID: `person:Aaron`); Jethro (ID: `person:Jethro`); Ahiezer (ID: `person:Ahiezer`); Abidan (ID: `person:Abidan`); Eliab (ID: `person:Eliab`); Ahira (ID: `person:Ahira`); Gamaliel (ID: `person:Gamaliel.2`); Zuar (ID: `person:Zuar`); Hobab (ID: `person:Hobab`); Pagiel (ID: `person:Pagiel`); Enan (ID: `person:Enan`); Deuel (ID: `person:Deuel`); Ochran (ID: `person:Ochran`); Elizur (ID: `person:Elizur`); Pedahzur (ID: `person:Pedahzur`); Ammihud (ID: `person:Ammihud`); Eliasaph (ID: `person:Eliasaph`); Zurishaddai (ID: `person:Zurishaddai`); Kohathites (ID: `group:Kohath`)
...
* **Associated Articles:** Mens (ID: `778531@BiblicaStudyNotesKeyTerms`); Oordeel (ID: `778806@BiblicaStudyNotesKeyTerms`); Kanaän (ID: `769665@BiblicaStudyNotesKeyTerms`); Verbond met Abraham (ID: `769684@BiblicaStudyNotesKeyTerms`); Egypte (ID: `772763@BiblicaStudyNotes`); Izaäk (ID: `778764@BiblicaStudyNotesKeyTerms`); 40 jaar (ID: `761244@BiblicaStudyNotesKeyTerms`); Kaleb (ID: `769663@BiblicaStudyNotesKeyTerms`); Verbondszegen (ID: `769682@BiblicaStudyNotesKeyTerms`); Vergeven (ID: `775221@BiblicaStudyNotesKeyTerms`); Heilige Geest (ID: `778528@BiblicaStudyNotesKeyTerms`); Jacob (ID: `778768@BiblicaStudyNotesKeyTerms`); Joshua (ID: `778798@BiblicaStudyNotesKeyTerms`); Kades Barnea (ID: `778808@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Egypt (ID: `place:Egypt`); Aaron (ID: `person:Aaron`); Caleb (ID: `person:Caleb`); Nun (ID: `person:Nun`); Joshua (ID: `person:Joshua.2`); Canaan (ID: `place:Canaan`); Miriam (ID: `person:Miriam`); Jephunneh (ID: `person:Jephunneh`); Amalek (ID: `place:Amalek`); Amalekites (ID: `group:Amalek`); Canaanites (ID: `group:Canaan`); Tent (ID: `realia:Tent`); Paran (ID: `place:Paran`); Negev (ID: `place:Negeb`); Speak as a Prophet (ID: `keyterm:Speak`); Anak (ID: `person:Anak`); Forgive (ID: `keyterm:Forgive`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Passion (ID: `keyterm:Ardour`); Swear (ID: `keyterm:Swear`); Dispossess (ID: `keyterm:Dispossess`); Glory (ID: `keyterm:Glory`); Eldad (ID: `person:Eldad`); Kibroth-hattaavah (ID: `place:Kibroth-hattaavah`); Medad (ID: `person:Medad`); Hazeroth (ID: `place:Hazeroth`); Land Flowing of Milk and Honey (ID: `keyterm:LandFlowingOfMilkAndHoney`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Aaron (ID: `person:Aaron`); Defilement (ID: `keyterm:Defilement`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Korah (ID: `person:Korah.3`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Abiram (ID: `person:Abiram`); To Cause to Possess (ID: `keyterm:Possess`); Holy (ID: `keyterm:Holy`); Pure (ID: `keyterm:Pure`); Dathan (ID: `person:Dathan`); Testimony (ID: `keyterm:Witness.2`); Force to Serve (ID: `keyterm:EnticedToServe`); To Cleanse (ID: `keyterm:Cleanse.2`); Tent of Meeting (ID: `realia:TentOfMeeting`); Cattle (ID: `fauna:Bull`); Rod (ID: `realia:Rod`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Instruction (ID: `keyterm:Instruction`); Appease (ID: `keyterm:Appease`); Eleazar (ID: `person:Eleazar.2`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Shovel (ID: `realia:Shovel`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Balaam (ID: `person:Balaam`); Balak (ID: `person:Balak`); Israel (ID: `person:Israel`); Moses (ID: `person:Moses`); Moab (ID: `place:Moab`); An Angel (ID: `deity:Angel`); To Curse (ID: `keyterm:Curse`); Aaron (ID: `person:Aaron`); Amorites (ID: `group:Amorites`); Egypt (ID: `place:Egypt`); Bless (ID: `keyterm:Bless`); Sihon (ID: `person:Sihon`); Proverb (ID: `keyterm:Saying`); Edom (ID: `place:Edom`); Arnon (ID: `place:Arnon`); Heshbon (ID: `place:Heshbon`); Zippor (ID: `person:Zippor`); Mount Hor (ID: `place:HorMount`); Donkey (ID: `fauna:Donkey`); Kadesh-barnea (ID: `place:Kadesh-barnea`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Sheep (ID: `fauna:Lamb`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Eleazar (ID: `person:Eleazar.2`); Complete (ID: `keyterm:Complete`); Vow (ID: `keyterm:Vow`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Midian (ID: `place:Midian`); To Cause to Possess (ID: `keyterm:Possess`); Aaron (ID: `person:Aaron`); Sheep (ID: `fauna:Lamb`); Work (ID: `keyterm:Work`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Korah (ID: `person:Korah.3`); Midianites (ID: `group:Midian`); Appease (ID: `keyterm:Appease`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Plague (ID: `keyterm:Blow`); Manasseh (ID: `person:Manasseh`); Tribe of Manasseh (ID: `group:Manasseh`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Donkey (ID: `fauna:Donkey`); Zelophehad (ID: `person:Zelophehad`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Moses (ID: `person:Moses`); To Cause to Possess (ID: `keyterm:Possess`); Jordan River (ID: `place:Jordan`); Refuge (ID: `keyterm:Refuge`); Gad (ID: `person:Gad`); Tribe of Reuben (ID: `group:Reuben`); Reuben (ID: `person:Reuben`); Canaan (ID: `place:Canaan`); Manasseh (ID: `person:Manasseh`); Tribe of Manasseh (ID: `group:Manasseh`); Gilead (ID: `place:Gilead`); Dispossess (ID: `keyterm:Dispossess`); Joseph (ID: `person:Joseph.10`); Egypt (ID: `place:Egypt`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Plains of Moab (ID: `place:MoabPlains`); Jericho (ID: `place:Jericho`); Mount Hor (ID: `place:HorMount`); Dibon (ID: `place:Dibon`); Kadesh-barnea (ID: `place:Kadesh-barnea`); Zelophehad (ID: `person:Zelophehad`); Lot (ID: `keyterm:Lot`); Machir (ID: `person:Machir`); Joshua (ID: `person:Joshua.2`); Jazer (ID: `place:Jazer`); Wilderness of Zin (ID: `place:Zin`); Nun (ID: `person:Nun`)
