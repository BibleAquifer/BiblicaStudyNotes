...
* **Associated ACAI Concepts:** Theophilus (ID: `person:Theophilus`); Sky (ID: `keyterm:Heaven`); Galileans (ID: `group:Galilee`); Witness (ID: `keyterm:Witness`); Judea (ID: `place:Judea`); Promise (ID: `keyterm:Promise`)
...
* **Associated ACAI Concepts:** Matthias (ID: `person:Matthias`); Joseph (ID: `person:Joseph.9`); Half a Mile (ID: `realia:HalfAMile`); Pray (ID: `keyterm:Pray`); Simon (ID: `person:Simon.2`); Bartholomew (ID: `person:Bartholomew`); Akeldama (ID: `place:Akeldama`); Alphaeus (ID: `person:Alphaeus`); James (ID: `person:James.2`); Mount of Olives (ID: `place:OlivesMount`); Upstairs Room (ID: `realia:UpstairsRoom`); Lot (ID: `realia:Lot`); Thomas (ID: `person:Thomas`); Andrew (ID: `person:Andrew`); Mary (ID: `person:Mary`)
...
* **Associated ACAI Concepts:** Sweet Wine (ID: `realia:SweetWine`); Parthians (ID: `group:Parthians`); Cappadocia (ID: `place:Cappadocia`); Elamites (ID: `group:Elam`); Cretans (ID: `group:Cretan`); Phrygia (ID: `place:Phrygia`); Pontus (ID: `place:Pontus`); Libya (ID: `place:Libya`); Cyrene (ID: `place:Cyrene`); Galileans (ID: `group:Galilee`); Elam (ID: `place:Elam`); Medan (ID: `person:Medan`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Peter (ID: `person:Peter`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Joel (ID: `person:Joel.14`); Portent (ID: `keyterm:Portent`); Baptism (ID: `keyterm:Baptism`); Judeans (ID: `group:Judea`); Call Upon (ID: `keyterm:CallUpon`); Word (ID: `keyterm:Word`); Repent (ID: `keyterm:Repent`); Resurrection (ID: `keyterm:Resurrection`); Jesus (ID: `person:Jesus.2`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Solomon's Colonnade (ID: `place:SolomonsPortico`); Abraham (ID: `person:Abraham`); Porch (ID: `realia:Porch`); To Cause to Happen (ID: `keyterm:Happen`); Samuel (ID: `person:Samuel`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); John (ID: `person:John.3`); Alexander (ID: `person:Alexander.2`); Salvation (ID: `keyterm:Salvation`); Annas (ID: `person:Annas`); Caiaphas (ID: `person:Caiaphas`); Cornerstone (ID: `realia:Cornerstone`); Sadducees (ID: `group:Sadducee`)
...
* **Associated ACAI Concepts:** Cypriots (ID: `group:Cyprus`); Ask for (ID: `keyterm:AskFor`); Barnabas (ID: `person:Barnabas`); Pilate (ID: `person:Pilate`)
...
* **Associated ACAI Concepts:** Ananias (ID: `person:Ananias`); Sapphira (ID: `person:Sapphira`)
...
* **Associated ACAI Concepts:** Theudas (ID: `person:Theudas`); Judas (ID: `person:Judas.3`); Persuade (ID: `keyterm:Persuade`); Gamaliel (ID: `person:Gamaliel`); Savior (ID: `keyterm:Savior`); Witness (ID: `keyterm:Witness`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Timon (ID: `person:Timon`); Antiochians (ID: `group:Antioch`); Prochorus (ID: `person:Prochorus`); Nicolaus (ID: `person:Nicolaus`); Nicanor (ID: `person:Nicanor`); Parmenas (ID: `person:Parmenas`); Serve (ID: `keyterm:Serve`); Hellenists (ID: `group:Hellenist`); Stephen (ID: `person:Stephen`); Philip (ID: `person:Philip.4`)
...
* **Associated ACAI Concepts:** Freedmen (ID: `group:Freedmen`); Stephen (ID: `person:Stephen`); Alexandrians (ID: `group:Alexandria`); Alexandria (ID: `place:Alexandria`)
...
* **Associated ACAI Concepts:** Rephan (ID: `deity:Rephan`); Joseph (ID: `person:Joseph.10`); To Act Wickedly (ID: `keyterm:ActWickedly`); Rescue (ID: `keyterm:Rescue`); Pharaoh (ID: `person:Pharaoh.4`); Mesopotamia (ID: `place:Mesopotamia`); Hamor (ID: `person:Hamor`); Shechem (ID: `place:Shechem`); Judge (ID: `keyterm:Judge`); Egypt (ID: `place:Egypt`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Stephen (ID: `person:Stephen`); Call Upon (ID: `keyterm:CallUpon`)
...
* **Associated ACAI Concepts:** Philip (ID: `person:Philip.4`); Stephen (ID: `person:Stephen`); Judea (ID: `place:Judea`); Proclaim (ID: `keyterm:Proclaim`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Simon (ID: `person:Simon.8`); Philip (ID: `person:Philip.4`); Money (ID: `realia:Money`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Philip (ID: `person:Philip.4`); Chariot (ID: `realia:Chariot`); Good News (ID: `keyterm:GoodNews`); Ethiopians (ID: `group:Ethiopia`); Ethiopia (ID: `place:Ethiopia`); Ashdod (ID: `place:Ashdod`); Gaza (ID: `place:Gaza`)
...
* **Associated ACAI Concepts:** Ananias (ID: `person:Ananias.2`); Damascus (ID: `place:Damascus`); Paul (ID: `person:Paul`); Judas (ID: `person:Judas.4`); Straight Street (ID: `place:Straight`); Tarsians (ID: `group:Tarsus`); The Way (ID: `keyterm:TheWay`); Name (ID: `keyterm:Name`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Damascus (ID: `place:Damascus`); Hellenists (ID: `group:Hellenist`); Tarsus (ID: `place:Tarsus`); Basket (ID: `realia:Basket`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Tabitha (ID: `person:Tabitha`); Aeneas (ID: `person:Aeneas`); Joppa (ID: `place:Joppa`); Simon (ID: `person:Simon.9`); Sharon Plain (ID: `place:Sharon.2`); Peter (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Italians (ID: `group:Italy`); Cornelius (ID: `person:Cornelius`); Linen Cloth (ID: `realia:LinenCloth`); Simon (ID: `person:Simon.9`); Housetop (ID: `realia:Housetop`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Cornelius (ID: `person:Cornelius`); Simon (ID: `person:Simon.9`); Peter (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Declare (ID: `keyterm:Declare`); Anointed (ID: `keyterm:Anointed`); Bear Witness (ID: `keyterm:BearWitness`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Linen Cloth (ID: `realia:LinenCloth`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Antioch (ID: `place:Antioch`); Agabus (ID: `person:Agabus`); Cyprus (ID: `place:Cyprus`); Cypriots (ID: `group:Cyprus`); Christians (ID: `group:Christ`); Hellenists (ID: `group:Hellenist`); Be a Disciple (ID: `keyterm:Disciple`); Phoenicia (ID: `place:Phoenicia`); Claudius (ID: `person:Claudius`)
...
* **Associated ACAI Concepts:** Herod (ID: `person:Herod.3`); Rhoda (ID: `person:Rhoda`); Mary (ID: `person:Mary.5`); Chain (ID: `realia:Chain`); Mark (ID: `person:Mark`); James (ID: `person:James`); John (ID: `person:John.2`); Peter (ID: `person:Peter`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Bedroom (ID: `realia:Bedroom`); Blastus (ID: `person:Blastus`); Herod (ID: `person:Herod.3`); Tyrians (ID: `group:Tyre`)
...
* **Associated ACAI Concepts:** Bar-jesus (ID: `person:Bar-jesus`); Paul (ID: `person:Paul`); Barnabas (ID: `person:Barnabas`); Seleucia (ID: `place:Seleucia`); Salamis (ID: `place:Salamis`); Manaen (ID: `person:Manaen`); Sergius Paulus (ID: `person:SergiusPaulus`); Mark (ID: `person:Mark`); Paphos (ID: `place:Paphos`); Simeon (ID: `person:Simeon.4`); Abstain from Food (ID: `keyterm:Fast`); Antioch (ID: `place:Antioch`); Herod Antipas (ID: `person:Herod.2`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Perga (ID: `place:Perga`); Paphos (ID: `place:Paphos`); Synagogue (ID: `realia:Synagogue`); Antioch (ID: `place:Antioch.2`); Pamphylia (ID: `place:Pamphylia`); Kish (ID: `person:Kish`); Jesse (ID: `person:Jesse`); Canaan (ID: `place:Canaan`); Saul (ID: `person:Saul.2`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Worship (ID: `keyterm:Worship`); Resentment (ID: `keyterm:Resentment`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Lycaonia (ID: `place:Lycaonia`); Derbe (ID: `place:Derbe`); Lystra (ID: `place:Lystra`); Iconium (ID: `place:Iconium`)
...
* **Associated ACAI Concepts:** Zeus (ID: `deity:Zeus`); Garland (ID: `realia:Garland`); Hermes (ID: `deity:Hermes`); Lycaonians (ID: `group:Lycaonia`); Worthless (ID: `keyterm:Worthless`); Do Good (ID: `keyterm:DoGood`)
...
* **Associated ACAI Concepts:** Attalia (ID: `place:Attalia`); Antioch (ID: `place:Antioch.2`); Iconium (ID: `place:Iconium`); Pisidia (ID: `place:Pisidia`); Perga (ID: `place:Perga`); Derbe (ID: `place:Derbe`); Pamphylia (ID: `place:Pamphylia`); Abstain from Food (ID: `keyterm:Fast`)
...
* **Associated ACAI Concepts:** Judas (ID: `person:Judas.5`); Antioch (ID: `place:Antioch`); Silas (ID: `person:Silas`); Phoenicia (ID: `place:Phoenicia`); James (ID: `person:James.3`); Yoke (ID: `realia:Yoke`); Judea (ID: `place:Judea`); Barnabas (ID: `person:Barnabas`); Gentiles (ID: `group:Gentile`); Paul (ID: `person:Paul`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Mark (ID: `person:Mark`); Cilicia (ID: `place:Cilicia`)
...
* **Associated ACAI Concepts:** Mysia (ID: `place:Mysia`); Lystra (ID: `place:Lystra`); Bithynia (ID: `place:Bithynia`); Macedonia (ID: `place:Macedonia`); Phrygia (ID: `place:Phrygia`); Derbe (ID: `place:Derbe`); Troas (ID: `place:Troas`); Galatia (ID: `place:Galatia`); Asia (ID: `place:Asia`); Timothy (ID: `person:Timothy`)
...
* **Associated ACAI Concepts:** Neapolis (ID: `place:Neapolis`); Samothrace (ID: `place:Samothrace`); Lydia (ID: `person:Lydia`); Thyatira (ID: `place:Thyatira`); Philippi (ID: `place:Philippi`); Macedonia (ID: `place:Macedonia`)
...
* **Associated ACAI Concepts:** Philippian Jailer (ID: `person:PhilippianJailer`); Lydia (ID: `person:Lydia`); Silas (ID: `person:Silas`); Believe (ID: `keyterm:Believe`); Torch (ID: `realia:Torch`); Paul (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Jason (ID: `person:Jason`); Apollonia (ID: `place:Apollonia`); Amphipolis (ID: `place:Amphipolis`); Berea (ID: `place:Berea`); Thessalonica (ID: `place:Thessalonica`); Greeks (ID: `group:Greek`); Written (ID: `keyterm:Scripture`); Discern (ID: `keyterm:Discern`); Paul (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Areopagus (ID: `place:Areopagus`); Athens (ID: `place:Athens`); Athenians (ID: `group:Athens`); Stoics (ID: `group:Stoic`); Epicureans (ID: `group:Epicurean`); Dionysius (ID: `person:Dionysius`); Areopagites (ID: `group:Areopagus`); Damaris (ID: `person:Damaris`); Worship (ID: `keyterm:Worship`); Divine (ID: `keyterm:Divine`); Decided (ID: `keyterm:Decided`)
...
* **Associated ACAI Concepts:** Gallio (ID: `person:Gallio`); Justus (ID: `person:Justus.2`); Pontus (ID: `group:Pontus`); Judgment Seat (ID: `realia:JudgmentSeat`); Corinth (ID: `place:Corinth`); Corinthians (ID: `group:Corinth`); Crispus (ID: `person:Crispus`); Sosthenes (ID: `person:Sosthenes`); Worship (ID: `keyterm:Worship`); Pontus (ID: `place:Pontus`); Priscilla (ID: `person:Priscilla`); Aquila (ID: `person:Aquila`); Achaia (ID: `place:Achaia`); Claudius (ID: `person:Claudius`); Rome (ID: `place:Rome`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Aquila (ID: `person:Aquila`); Cenchreae (ID: `place:Cenchreae`); Alexandrians (ID: `group:Alexandria`); Phrygia (ID: `place:Phrygia`); Alexandria (ID: `place:Alexandria`); Galatia (ID: `place:Galatia`); Apollos (ID: `person:Apollos`)
...
* **Associated ACAI Concepts:** Tyrannus (ID: `person:Tyrannus`); Apron (ID: `realia:Apron`); Sceva (ID: `person:Sceva`); Lecture Hall (ID: `realia:LectureHall`); Asia (ID: `place:Asia`); Ephesus (ID: `place:Ephesus`); Macedonia (ID: `place:Macedonia`); Erastus (ID: `person:Erastus`); Band of Cloth (ID: `realia:BandOfCloth`); Achaia (ID: `place:Achaia`); Demons (ID: `deity:Demons`); Paul (ID: `person:Paul`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Artemis (ID: `deity:Artemis`); Ephesians (ID: `group:Ephesus`); Theater (ID: `realia:Theater`); Replica Temple (ID: `realia:ReplicaTemple`); Gaius (ID: `person:Gaius`); Alexander (ID: `person:Alexander.3`); Demetrius (ID: `person:Demetrius`); Aristarchus (ID: `person:Aristarchus`)
...
* **Associated ACAI Concepts:** Second Story (ID: `realia:SecondStory`); Secundus (ID: `person:Secundus`); Asians (ID: `group:Asia`); Gaius (ID: `person:Gaius.2`); Bereans (ID: `group:Berea`); Pyrrhus (ID: `person:Pyrrhus`); Eutychus (ID: `person:Eutychus`); Troas (ID: `place:Troas`); Sopater (ID: `person:Sopater`); Macedonia (ID: `place:Macedonia`); Trophimus (ID: `person:Trophimus`); Philippi (ID: `place:Philippi`); Tychicus (ID: `person:Tychicus`); Week (ID: `keyterm:Week`); Greece (ID: `place:Greece`); Window (ID: `realia:Window`)
...
* **Associated ACAI Concepts:** Assos (ID: `place:Assos`); Declare (ID: `keyterm:Declare`); Mitylene (ID: `place:Mitylene`); Chios (ID: `place:Chios`); Samos (ID: `place:Samos`); Miletus (ID: `place:Miletus`); Ephesus (ID: `place:Ephesus`); Be Enslaved (ID: `keyterm:Serve.2`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Cos (ID: `place:Cos`); Rhodes (ID: `place:Rhodes`); Patara (ID: `place:Patara`); Mnason (ID: `person:Mnason`); Agabus (ID: `person:Agabus`); Caesarea (ID: `place:Caesarea`); Cypriots (ID: `group:Cyprus`); Phoenicia (ID: `place:Phoenicia`); Philip (ID: `person:Philip.4`); Belt (ID: `realia:Belt`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Step (ID: `realia:Step`); Tarsians (ID: `group:Tarsus`); Trophimus (ID: `person:Trophimus`); Tarsus (ID: `place:Tarsus`); Cilicia (ID: `place:Cilicia`); Paul (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Paul (ID: `person:Paul`); Gamaliel (ID: `person:Gamaliel`); Ananias (ID: `person:Ananias.2`)
...
* **Associated ACAI Concepts:** Antipatris (ID: `place:Antipatris`); Felix (ID: `person:Felix`); Lysias (ID: `person:Lysias`); Ananias (ID: `person:Ananias.3`); Rome (ID: `place:Rome`); Palace (ID: `realia:Palace`); Cheer Up (ID: `keyterm:CheerUp`); Cilicia (ID: `place:Cilicia`); Paul (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Felix (ID: `person:Felix`); Tertullus (ID: `person:Tertullus`); Drusilla (ID: `person:Drusilla`); Ananias (ID: `person:Ananias.3`); Lysias (ID: `person:Lysias`); The Way (ID: `keyterm:TheWay`); Festus (ID: `person:Festus`); Conscience (ID: `keyterm:Conscience`); Paul (ID: `person:Paul`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Festus (ID: `person:Festus`); Agrippa (ID: `person:Agrippa`); Caesarea (ID: `place:Caesarea`); Audience Hall (ID: `realia:AudienceHall`); Bernice (ID: `person:Bernice`); Augustus (ID: `person:Augustus`); Claudius (ID: `person:Claudius`); Paul (ID: `person:Paul`); Jews (ID: `group:Jews`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Agrippa (ID: `person:Agrippa`); Festus (ID: `person:Festus`); Bernice (ID: `person:Bernice`); Christians (ID: `group:Christ`); Rescue (ID: `keyterm:Rescue`); Paul (ID: `person:Paul`); Jews (ID: `group:Jews`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Anchor (ID: `realia:Anchor`); Ship (ID: `realia:Ship`); Julius (ID: `person:Julius`); Crete (ID: `place:Crete`); Myra (ID: `place:Myra`); Lycia (ID: `place:Lycia`); the Syrtis (ID: `place:Syrtis`); Cnidus (ID: `place:Cnidus`); Fair Havens (ID: `place:FairHavens`); Cauda (ID: `place:Cauda`); Fathom (ID: `realia:Fathom`); Adriatic Sea (ID: `place:AdriaticSea`); Adramyttium (ID: `place:Adramyttium`); Phoenix (ID: `place:Phoenix`); Lasea (ID: `place:Lasea`); Salmone (ID: `place:Salmone`); Italy (ID: `place:Italy`); Rudder (ID: `realia:Rudder`); Sail (ID: `realia:Sail`); Alexandria (ID: `place:Alexandria`); Pamphylia (ID: `place:Pamphylia`); Aristarchus (ID: `person:Aristarchus`); Augustus (ID: `person:Augustus`); Cilicia (ID: `place:Cilicia`); Asia (ID: `place:Asia`); Sidon (ID: `place:Sidon`); Paul (ID: `person:Paul`); Salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Publius (ID: `person:Publius`); Puteoli (ID: `place:Puteoli`); Forum of Appius (ID: `place:ForumOfAppius`); Emblem (ID: `realia:Emblem`); Three Taverns (ID: `place:ThreeTaverns`); Rhegium (ID: `place:Rhegium`); Malta (ID: `place:Malta`); Syracuse (ID: `place:Syracuse`); Rome (ID: `place:Rome`); Alexandria (ID: `place:Alexandria`)
