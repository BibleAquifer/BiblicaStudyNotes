...
* **Associated Passages:** 2 पतरस 1:1-11
* **Associated Articles:** सुसमाचार (ID: `182937@BiblicaStudyNotesKeyTerms`); विश्वासी (ID: `182971@BiblicaStudyNotesKeyTerms`); पौलुस (ID: `182996@BiblicaStudyNotes`); पवित्र आत्मा का फल (ID: `183048@BiblicaStudyNotesKeyTerms`); परमेश्वर (ID: `183093@BiblicaStudyNotesKeyTerms`); काम (ID: `183102@BiblicaStudyNotesKeyTerms`); संसार (ID: `183109@BiblicaStudyNotesKeyTerms`); यीशु  (ID: `183113@BiblicaStudyNotesKeyTerms`); विश्वास (ID: `183126@BiblicaStudyNotesKeyTerms`); पवित्र (ID: `183255@BiblicaStudyNotesKeyTerms`); परमेश्वर का राज्य (ID: `183455@BiblicaStudyNotesKeyTerms`); पतरस (ID: `183466@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Divine (ID: `keyterm:Divine`); Ability (ID: `keyterm:Ability`); यहोवा (ID: `deity:Lord`); Savior (ID: `keyterm:Savior`); Believe (ID: `keyterm:Believe`); Promise (ID: `keyterm:Promise`); Eagerness (ID: `keyterm:Eagerness`); To Cleanse (ID: `keyterm:Cleanse.2`); Useless (ID: `keyterm:Idle`); Kingdom (ID: `keyterm:Kingdom`); Make Peace (ID: `keyterm:Peace`); Stumble (ID: `keyterm:Stumble`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Always (ID: `keyterm:Always`); Chosen (ID: `keyterm:Chosen`); Favor (ID: `keyterm:Favor`); Love for One's Fellow Believer (ID: `keyterm:LoveForOnesFellowBeliever`); Life (ID: `keyterm:Life`); पतरस (ID: `person:Peter`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`)
...
* **Associated Passages:** 2 पतरस 2:1-9
...
* **Associated ACAI Concepts:** Be (Or Show Oneself) Just (ID: `keyterm:Just`); Judgment (ID: `keyterm:Judgment`); Lawless (ID: `keyterm:Lawless`); Court Case (ID: `keyterm:CourtCase`); यहोवा (ID: `deity:Lord`); Deliver (ID: `keyterm:Deliver`); लूत (ID: `person:Lot`); नूह (ID: `person:Noah`); Blaspheme (ID: `keyterm:Blaspheme`); Redeem (ID: `keyterm:Redeem`); An Angel (ID: `deity:Angel`); सदोम (ID: `place:Sodom`); गमोरा (ID: `place:Gomorrah`); To Hold in Tartarus (ID: `keyterm:HoldInTartarus`); Truth (ID: `keyterm:Truth`); नरक (ID: `place:Hell`); Ability (ID: `keyterm:Ability`); Condemn (ID: `keyterm:Condemn`); To Sin (ID: `keyterm:Sin`)
...
* **Associated Passages:** 2 पतरस 2:10-22
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Blaspheme (ID: `keyterm:Blaspheme`); Unjust Deed (ID: `keyterm:UnjustDeed`); Body (ID: `keyterm:Body.3`); Defilement (ID: `keyterm:Defilement`); Be Unfaithful (ID: `keyterm:Unfaithful`); बओर (ID: `person:Beor.2`); बिलाम (ID: `person:Balaam`); Heart (ID: `keyterm:Heart`); To Act Wickedly (ID: `keyterm:ActWickedly`); A Person (ID: `person:GenericPerson`); True (ID: `keyterm:True`); Court Case (ID: `keyterm:CourtCase`); Commandment (ID: `keyterm:Commandment`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); Worthless (ID: `keyterm:Worthless`); Promise (ID: `keyterm:Promise`); Behavior (ID: `keyterm:Behavior`); Savior (ID: `keyterm:Savior`); Straightness (ID: `keyterm:Straightness`); Blasphemous (ID: `keyterm:Blasphemous`); यीशु (ID: `person:Jesus.2`); Judgment (ID: `keyterm:Judgment`); To Sin (ID: `keyterm:Sin`); Holy (ID: `keyterm:Holy`); Love (ID: `keyterm:Love`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); Donkey (ID: `fauna:Donkey`); Dog (ID: `fauna:Dog`)
...
* **Associated Passages:** 2 पतरस 3:1-10
* **Associated Articles:** न्याय का दिन (ID: `182949@BiblicaStudyNotesKeyTerms`); स्वर्ग (ID: `183095@BiblicaStudyNotesKeyTerms`); परमेश्वर चुनता है (ID: `183123@BiblicaStudyNotesKeyTerms`); न्याय  (ID: `183127@BiblicaStudyNotes`); पश्चाताप (ID: `183240@BiblicaStudyNotesKeyTerms`); पुनरुत्थान (ID: `183462@BiblicaStudyNotesKeyTerms`); मलाकी (ID: `183472@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Promise (ID: `keyterm:Promise`); Beloved (ID: `keyterm:Beloved`); Fundamental Principles (ID: `keyterm:FundamentalPrinciples`); Pure (ID: `keyterm:Pure`); Commandment (ID: `keyterm:Commandment`); यीशु (ID: `person:Jesus.2`); Judgment (ID: `keyterm:Judgment`); Ability (ID: `keyterm:Ability`); Repent (ID: `keyterm:Repent`); Holy (ID: `keyterm:Holy`); Court Case (ID: `keyterm:CourtCase`); Mind (ID: `keyterm:Mind.2`); Savior (ID: `keyterm:Savior`); Word (ID: `keyterm:Word`)
...
* **Associated Passages:** 2 पतरस 3:11-18
* **Associated Articles:** पवित्र जीवन (ID: `182938@BiblicaStudyNotesKeyTerms`); शांति (ID: `183105@BiblicaStudyNotesKeyTerms`); अनुग्रह  (ID: `183129@BiblicaStudyNotes`); उद्धारकर्ता (ID: `183213@BiblicaStudyNotesKeyTerms`); प्रभु- शासक (ID: `183223@BiblicaStudyNotesKeyTerms`); नई सृष्टि (ID: `183437@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Beloved (ID: `keyterm:Beloved`); Sky (ID: `keyterm:Heaven`); यहोवा (ID: `deity:Lord`); Written (ID: `keyterm:Scripture`); Fundamental Principles (ID: `keyterm:FundamentalPrinciples`); Be Blameless (ID: `keyterm:Blameless`); Make Peace (ID: `keyterm:Peace`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Always (ID: `keyterm:Always`); Lawless (ID: `keyterm:Lawless`); Favor (ID: `keyterm:Favor`); Promise (ID: `keyterm:Promise`); Savior (ID: `keyterm:Savior`); Salvation (ID: `keyterm:Salvation`); पौलुस (ID: `person:Paul`); यीशु (ID: `person:Jesus.2`); Holy (ID: `keyterm:Holy`); Above Criticism (ID: `keyterm:AboveCriticism`); Glory (ID: `keyterm:Glory`)
