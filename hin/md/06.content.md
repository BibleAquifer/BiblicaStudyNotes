...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); मूसा (ID: `person:Moses`); यहोशू (ID: `person:Joshua.2`); यरदन (ID: `place:Jordan`); House (ID: `realia:House`); Swear (ID: `keyterm:Swear`); Exempt (ID: `keyterm:Exempt`); नून (ID: `person:Nun`); यरीहो (ID: `place:Jericho`); Spies (ID: `group:Spies`); Window (ID: `realia:Window`); राहाब (ID: `person:Rahab`); Dispossess (ID: `keyterm:Dispossess`); Have Insight (ID: `keyterm:HaveInsight`); Truth (ID: `keyterm:Truth`); Oath (ID: `keyterm:Oath`); Instruction (ID: `keyterm:Instruction`); Kindness (ID: `keyterm:Kindness`); इस्राएल (ID: `person:Israel`); To Cause to Possess (ID: `keyterm:Possess`); महासागर (ID: `place:GreatSea`); शित्तीम (ID: `place:Shittim`); रूबेन (ID: `group:Reuben`); Terror (ID: `keyterm:Terror`); Rebel (ID: `keyterm:Rebel`); गाद (ID: `person:Gad`); मनश्शे (ID: `person:Manasseh`); रूबेन (ID: `person:Reuben`); Amorites (ID: `group:Amorites`); Heth (ID: `person:Heth`); ओग (ID: `person:Og`); सीहोन (ID: `person:Sihon`); लाल समुद्र (ID: `place:RedSea`); Euphrates River (ID: `place:Euphrates`); मनश्शे (ID: `group:Manasseh`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); हित्ती (ID: `group:Hittite`); मिस्र (ID: `place:Egypt`); लबानोन (ID: `place:Lebanon`); Thread (ID: `realia:Thread`); Scroll (ID: `realia:Scroll`); Rope (ID: `realia:Rope`); Cattails (ID: `flora:Cattails`); Flax (ID: `flora:Flax`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यरदन (ID: `place:Jordan`); यहोशू (ID: `person:Joshua.2`); इस्राएल (ID: `person:Israel`); Covenant Box (ID: `keyterm:CovenantBox`); Covenant (ID: `keyterm:Covenant`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Complete (ID: `keyterm:Complete`); Circumcision (ID: `keyterm:Circumcision`); Gilgal (ID: `place:Gilgal.2`); यरीहो (ID: `place:Jericho`); मूसा (ID: `person:Moses`); मिस्र (ID: `place:Egypt`); कनान (ID: `place:Canaan`); कनानी (ID: `group:Canaan`); Amorites (ID: `group:Amorites`); Fear (ID: `keyterm:Fear`); Passover (ID: `keyterm:Passover`); Perizzites (ID: `group:Perizzites`); Foreskin (ID: `keyterm:Foreskin`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); सारतान (ID: `place:Zarethan`); आदम (ID: `place:Adam`); Knife (ID: `realia:Knife`); गाद (ID: `person:Gad`); Holy (ID: `keyterm:Holy`); मनश्शे (ID: `person:Manasseh`); Jebusites (ID: `group:Jebusites`); Dispossess (ID: `keyterm:Dispossess`); Land Flowing of Milk and Honey (ID: `keyterm:LandFlowingOfMilkAndHoney`)
...
* **Associated ACAI Concepts:** यहोशू (ID: `person:Joshua.2`); यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); आई (ID: `place:Ai`); Covenant Box (ID: `keyterm:CovenantBox`); आकान (ID: `person:Achan`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); यरीहो (ID: `place:Jericho`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Rams Horn (ID: `realia:RamsHorn`); यहूदा (ID: `person:Judah.4`); बेतेल (ID: `place:Bethel`); Covenant (ID: `keyterm:Covenant`); यहूदा (ID: `group:Judah`); Money (ID: `realia:Money`); जब्दी (ID: `person:Zabdi`); राहाब (ID: `person:Rahab`); जेरह (ID: `person:Zerah.3`); An Angel (ID: `deity:Angel`); Tent (ID: `realia:Tent`); Cattle (ID: `fauna:Bull`); कर्मी (ID: `person:Carmi.3`); Valley of Achor (ID: `place:AchorValley`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); To Sin (ID: `keyterm:Sin`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Swear (ID: `keyterm:Swear`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Set Apart for God (ID: `keyterm:Proscribe`)
...
* **Associated ACAI Concepts:** यहोशू (ID: `person:Joshua.2`); इस्राएल (ID: `person:Israel`); यहोवा (ID: `deity:Lord`); गिबोन (ID: `place:Gibeon`); मूसा (ID: `person:Moses`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); लाकीश (ID: `place:Lachish`); Amorites (ID: `group:Amorites`); मक्केदा (ID: `place:Makkedah`); एग्लोन (ID: `place:Eglon`); हेब्रोन (ID: `place:Hebron`); Gilgal (ID: `place:Gilgal.2`); Covenant (ID: `keyterm:Covenant`); हासोर (ID: `place:Hazor`); Libnah (ID: `place:Libnah.2`); Shephelah (ID: `place:Shephelah`); हेर्मोन पर्वत (ID: `place:HermonMount`); Fear (ID: `keyterm:Fear`); Hivites (ID: `group:Hivites`); यरूशलेम (ID: `place:Jerusalem`); यरीहो (ID: `place:Jericho`); अराबा (ID: `place:Arabah`); Sword (ID: `realia:Sword`); दबीर (ID: `place:Debir`); यर्मूत (ID: `place:Jarmuth`); आई (ID: `place:Ai`); Swear (ID: `keyterm:Swear`); यरदन (ID: `place:Jordan`); Negev (ID: `place:Negeb`); To Cause to Possess (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** To Cause to Possess (ID: `keyterm:Possess`); यहोवा (ID: `deity:Lord`); Lot (ID: `keyterm:Lot`); इस्राएल (ID: `person:Israel`); मनश्शे (ID: `person:Manasseh`); मनश्शे (ID: `group:Manasseh`); मूसा (ID: `person:Moses`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); यरदन (ID: `place:Jordan`); यहोशू (ID: `person:Joshua.2`); एप्रैम (ID: `person:Ephraim`); एप्रैम (ID: `group:Ephraim`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); Dispossess (ID: `keyterm:Dispossess`); यूसुफ (ID: `person:Joseph.10`); कालेब (ID: `person:Caleb`); रूबेन (ID: `person:Reuben`); बाशान (ID: `place:Bashan`); रूबेन (ID: `group:Reuben`); कनान (ID: `place:Canaan`); गिलाद (ID: `place:Gilead`); हेब्रोन (ID: `place:Hebron`); आशेर (ID: `person:Asher`); आशेर (ID: `group:Asher`); किर्यत्यारीम (ID: `place:Kiriath-jearim`); Refuge (ID: `keyterm:Refuge`); कनानी (ID: `group:Canaan`); गाद (ID: `person:Gad`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); यहोशू (ID: `person:Joshua.2`); Force to Serve (ID: `keyterm:EnticedToServe`); रूबेन (ID: `person:Reuben`); रूबेन (ID: `group:Reuben`); गाद (ID: `person:Gad`); मनश्शे (ID: `group:Manasseh`); मनश्शे (ID: `person:Manasseh`); यरदन (ID: `place:Jordan`); मूसा (ID: `person:Moses`); मिस्र (ID: `place:Egypt`); कनान (ID: `place:Canaan`); Rebel (ID: `keyterm:Rebel`); Dispossess (ID: `keyterm:Dispossess`); पीनहास (ID: `person:Phinehas`); Offering (ID: `keyterm:Offering`); Amorites (ID: `group:Amorites`); Slaughtering (ID: `keyterm:Slaughtering`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); To Cause to Possess (ID: `keyterm:Possess`); गिलाद (ID: `place:Gilead`); एलीआजर (ID: `person:Eleazar.2`); Be Unfaithful (ID: `keyterm:Unfaithful`); Bless (ID: `keyterm:Bless`); Euphrates River (ID: `place:Euphrates`); शेकेम (ID: `place:Shechem`)
