...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); मूसा (ID: `person:Moses`); यहोशू (ID: `person:Joshua.2`); यरदन (ID: `place:Jordan`); House (ID: `realia:House`); Swear (ID: `keyterm:Swear`); Exempt (ID: `keyterm:Exempt`); यरीहो (ID: `place:Jericho`); नून (ID: `person:Nun`); Spies (ID: `group:Spies`); Window (ID: `realia:Window`); Dispossess (ID: `keyterm:Dispossess`); राहाब (ID: `person:Rahab`); Instruction (ID: `keyterm:Instruction`); Oath (ID: `keyterm:Oath`); Have Insight (ID: `keyterm:HaveInsight`); Truth (ID: `keyterm:Truth`); Kindness (ID: `keyterm:Kindness`); इस्राएल (ID: `person:Israel`); To Cause to Possess (ID: `keyterm:Possess`); रूबेन (ID: `group:Reuben`); शित्तीम (ID: `place:Shittim`); Terror (ID: `keyterm:Terror`); महासागर (ID: `place:GreatSea`); गाद (ID: `person:Gad`); Rebel (ID: `keyterm:Rebel`); Amorites (ID: `group:Amorites`); सीहोन (ID: `person:Sihon`); हित्ती (ID: `group:Hittite`); रूबेन (ID: `person:Reuben`); Euphrates River (ID: `place:Euphrates`); ओग (ID: `person:Og`); मनश्शे (ID: `group:Manasseh`); मनश्शे (ID: `person:Manasseh`); मिस्र (ID: `place:Egypt`); लबानोन (ID: `place:Lebanon`); Heth (ID: `person:Heth`); लाल समुद्र (ID: `place:RedSea`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Thread (ID: `realia:Thread`); Scroll (ID: `realia:Scroll`); Rope (ID: `realia:Rope`); Flax (ID: `flora:Flax`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यरदन (ID: `place:Jordan`); यहोशू (ID: `person:Joshua.2`); इस्राएल (ID: `person:Israel`); Covenant Box (ID: `keyterm:CovenantBox`); Covenant (ID: `keyterm:Covenant`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Complete (ID: `keyterm:Complete`); Circumcision (ID: `keyterm:Circumcision`); Gilgal (ID: `place:Gilgal.2`); यरीहो (ID: `place:Jericho`); मूसा (ID: `person:Moses`); मिस्र (ID: `place:Egypt`); कनान (ID: `place:Canaan`); कनानी (ID: `group:Canaan`); Passover (ID: `keyterm:Passover`); Amorites (ID: `group:Amorites`); Fear (ID: `keyterm:Fear`); Foreskin (ID: `keyterm:Foreskin`); सारतान (ID: `place:Zarethan`); Perizzites (ID: `group:Perizzites`); आदम (ID: `place:Adam`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Knife (ID: `realia:Knife`); गाद (ID: `person:Gad`); Dispossess (ID: `keyterm:Dispossess`); लेवी (ID: `group:Levi`); मृत सागर (ID: `place:SaltSea`); रूबेन (ID: `group:Reuben`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** यहोशू (ID: `person:Joshua.2`); यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); आई (ID: `place:Ai`); Covenant Box (ID: `keyterm:CovenantBox`); आकान (ID: `person:Achan`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); यरीहो (ID: `place:Jericho`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Rams Horn (ID: `realia:RamsHorn`); बेतेल (ID: `place:Bethel`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); Covenant (ID: `keyterm:Covenant`); Money (ID: `realia:Money`); जब्दी (ID: `person:Zabdi`); राहाब (ID: `person:Rahab`); जेरह (ID: `person:Zerah.3`); An Angel (ID: `deity:Angel`); Cattle (ID: `fauna:Bull`); Tent (ID: `realia:Tent`); कर्मी (ID: `person:Carmi.3`); Valley of Achor (ID: `place:AchorValley`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); To Sin (ID: `keyterm:Sin`); Swear (ID: `keyterm:Swear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Set Apart for God (ID: `keyterm:Proscribe`)
...
* **Associated ACAI Concepts:** यहोशू (ID: `person:Joshua.2`); इस्राएल (ID: `person:Israel`); यहोवा (ID: `deity:Lord`); गिबोन (ID: `place:Gibeon`); मूसा (ID: `person:Moses`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); लाकीश (ID: `place:Lachish`); Amorites (ID: `group:Amorites`); मक्केदा (ID: `place:Makkedah`); एग्लोन (ID: `place:Eglon`); हेब्रोन (ID: `place:Hebron`); Gilgal (ID: `place:Gilgal.2`); Covenant (ID: `keyterm:Covenant`); हासोर (ID: `place:Hazor`); Libnah (ID: `place:Libnah.2`); Hivites (ID: `group:Hivites`); यरूशलेम (ID: `place:Jerusalem`); यरीहो (ID: `place:Jericho`); Fear (ID: `keyterm:Fear`); Shephelah (ID: `place:Shephelah`); अराबा (ID: `place:Arabah`); हेर्मोन पर्वत (ID: `place:HermonMount`); Sword (ID: `realia:Sword`); यर्मूत (ID: `place:Jarmuth`); दबीर (ID: `place:Debir`); यरदन (ID: `place:Jordan`); Swear (ID: `keyterm:Swear`); आई (ID: `place:Ai`); Negev (ID: `place:Negeb`); To Cause to Possess (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** To Cause to Possess (ID: `keyterm:Possess`); यहोवा (ID: `deity:Lord`); Lot (ID: `keyterm:Lot`); मनश्शे (ID: `group:Manasseh`); इस्राएल (ID: `person:Israel`); मनश्शे (ID: `person:Manasseh`); मूसा (ID: `person:Moses`); यरदन (ID: `place:Jordan`); यहोशू (ID: `person:Joshua.2`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); एप्रैम (ID: `group:Ephraim`); एप्रैम (ID: `person:Ephraim`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); Dispossess (ID: `keyterm:Dispossess`); यूसुफ (ID: `person:Joseph.10`); कालेब (ID: `person:Caleb`); कनान (ID: `place:Canaan`); रूबेन (ID: `person:Reuben`); बाशान (ID: `place:Bashan`); रूबेन (ID: `group:Reuben`); आशेर (ID: `group:Asher`); आशेर (ID: `person:Asher`); गिलाद (ID: `place:Gilead`); हेब्रोन (ID: `place:Hebron`); किर्यत्यारीम (ID: `place:Kiriath-jearim`); Refuge (ID: `keyterm:Refuge`); कनानी (ID: `group:Canaan`); गाद (ID: `person:Gad`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); यहोशू (ID: `person:Joshua.2`); Force to Serve (ID: `keyterm:EnticedToServe`); रूबेन (ID: `group:Reuben`); गाद (ID: `person:Gad`); रूबेन (ID: `person:Reuben`); मनश्शे (ID: `group:Manasseh`); मनश्शे (ID: `person:Manasseh`); यरदन (ID: `place:Jordan`); मूसा (ID: `person:Moses`); मिस्र (ID: `place:Egypt`); कनान (ID: `place:Canaan`); Rebel (ID: `keyterm:Rebel`); Dispossess (ID: `keyterm:Dispossess`); पीनहास (ID: `person:Phinehas`); Amorites (ID: `group:Amorites`); Offering (ID: `keyterm:Offering`); Slaughtering (ID: `keyterm:Slaughtering`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); To Cause to Possess (ID: `keyterm:Possess`); गिलाद (ID: `place:Gilead`); Be Unfaithful (ID: `keyterm:Unfaithful`); Bless (ID: `keyterm:Bless`); एलीआजर (ID: `person:Eleazar.2`); Euphrates River (ID: `place:Euphrates`); शेकेम (ID: `place:Shechem`)
