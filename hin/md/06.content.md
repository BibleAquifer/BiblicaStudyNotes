...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); मूसा (ID: `person:Moses`); यहोशू (ID: `person:Joshua.2`); यरदन (ID: `place:Jordan`); House (ID: `realia:House`); Swear (ID: `keyterm:Swear`); Exempt (ID: `keyterm:Exempt`); नून (ID: `person:Nun`); यरीहो (ID: `place:Jericho`); Spies (ID: `group:Spies`); Window (ID: `realia:Window`); Dispossess (ID: `keyterm:Dispossess`); राहाब (ID: `person:Rahab`); Instruction (ID: `keyterm:Instruction`); Have Insight (ID: `keyterm:HaveInsight`); इस्राएल (ID: `person:Israel`); Kindness (ID: `keyterm:Kindness`); Truth (ID: `keyterm:Truth`); Oath (ID: `keyterm:Oath`); शित्तीम (ID: `place:Shittim`); महासागर (ID: `place:GreatSea`); रूबेन (ID: `group:Reuben`); Terror (ID: `keyterm:Terror`); To Cause to Possess (ID: `keyterm:Possess`); लबानोन (ID: `place:Lebanon`); मनश्शे (ID: `person:Manasseh`); Rebel (ID: `keyterm:Rebel`); मनश्शे (ID: `group:Manasseh`); Heth (ID: `person:Heth`); ओग (ID: `person:Og`); लाल समुद्र (ID: `place:RedSea`); गाद (ID: `person:Gad`); सीहोन (ID: `person:Sihon`); मिस्र (ID: `place:Egypt`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); रूबेन (ID: `person:Reuben`); Amorites (ID: `group:Amorites`); Euphrates River (ID: `place:Euphrates`); हित्ती (ID: `group:Hittite`); Rope (ID: `realia:Rope`); Thread (ID: `realia:Thread`); Scroll (ID: `realia:Scroll`); Cattails (ID: `flora:Cattails`); Flax (ID: `flora:Flax`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यरदन (ID: `place:Jordan`); यहोशू (ID: `person:Joshua.2`); इस्राएल (ID: `person:Israel`); Covenant Box (ID: `keyterm:CovenantBox`); Covenant (ID: `keyterm:Covenant`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Complete (ID: `keyterm:Complete`); Circumcision (ID: `keyterm:Circumcision`); Gilgal (ID: `place:Gilgal.2`); यरीहो (ID: `place:Jericho`); मिस्र (ID: `place:Egypt`); मूसा (ID: `person:Moses`); कनान (ID: `place:Canaan`); कनानी (ID: `group:Canaan`); Passover (ID: `keyterm:Passover`); Amorites (ID: `group:Amorites`); Fear (ID: `keyterm:Fear`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); सारतान (ID: `place:Zarethan`); आदम (ID: `place:Adam`); Foreskin (ID: `keyterm:Foreskin`); Perizzites (ID: `group:Perizzites`); Knife (ID: `realia:Knife`); लेवी (ID: `person:Levi.3`); Hivites (ID: `group:Hivites`); Dispossess (ID: `keyterm:Dispossess`); शित्तीम (ID: `place:Shittim`); लेवी (ID: `group:Levi`); Jebusites (ID: `group:Jebusites`)
...
* **Associated ACAI Concepts:** यहोशू (ID: `person:Joshua.2`); यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); आई (ID: `place:Ai`); Covenant Box (ID: `keyterm:CovenantBox`); आकान (ID: `person:Achan`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); यरीहो (ID: `place:Jericho`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Rams Horn (ID: `realia:RamsHorn`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); बेतेल (ID: `place:Bethel`); Covenant (ID: `keyterm:Covenant`); Money (ID: `realia:Money`); जब्दी (ID: `person:Zabdi`); राहाब (ID: `person:Rahab`); जेरह (ID: `person:Zerah.3`); An Angel (ID: `deity:Angel`); Tent (ID: `realia:Tent`); Cattle (ID: `fauna:Bull`); कर्मी (ID: `person:Carmi.3`); Valley of Achor (ID: `place:AchorValley`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); To Sin (ID: `keyterm:Sin`); Swear (ID: `keyterm:Swear`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Set Apart for God (ID: `keyterm:Proscribe`)
...
* **Associated ACAI Concepts:** यहोशू (ID: `person:Joshua.2`); इस्राएल (ID: `person:Israel`); यहोवा (ID: `deity:Lord`); गिबोन (ID: `place:Gibeon`); मूसा (ID: `person:Moses`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); लाकीश (ID: `place:Lachish`); Amorites (ID: `group:Amorites`); मक्केदा (ID: `place:Makkedah`); एग्लोन (ID: `place:Eglon`); हेब्रोन (ID: `place:Hebron`); Covenant (ID: `keyterm:Covenant`); Gilgal (ID: `place:Gilgal.2`); हासोर (ID: `place:Hazor`); Libnah (ID: `place:Libnah.2`); हेर्मोन पर्वत (ID: `place:HermonMount`); Shephelah (ID: `place:Shephelah`); Hivites (ID: `group:Hivites`); यरीहो (ID: `place:Jericho`); अराबा (ID: `place:Arabah`); Fear (ID: `keyterm:Fear`); यरूशलेम (ID: `place:Jerusalem`); Sword (ID: `realia:Sword`); दबीर (ID: `place:Debir`); यर्मूत (ID: `place:Jarmuth`); Swear (ID: `keyterm:Swear`); आई (ID: `place:Ai`); यरदन (ID: `place:Jordan`); Negev (ID: `place:Negeb`); To Cause to Possess (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** To Cause to Possess (ID: `keyterm:Possess`); यहोवा (ID: `deity:Lord`); Lot (ID: `keyterm:Lot`); मनश्शे (ID: `person:Manasseh`); इस्राएल (ID: `person:Israel`); मनश्शे (ID: `group:Manasseh`); मूसा (ID: `person:Moses`); यहूदा (ID: `person:Judah.4`); यहोशू (ID: `person:Joshua.2`); यरदन (ID: `place:Jordan`); यहूदा (ID: `group:Judah`); एप्रैम (ID: `person:Ephraim`); एप्रैम (ID: `group:Ephraim`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); Dispossess (ID: `keyterm:Dispossess`); यूसुफ (ID: `person:Joseph.10`); कालेब (ID: `person:Caleb`); कनान (ID: `place:Canaan`); बाशान (ID: `place:Bashan`); रूबेन (ID: `person:Reuben`); रूबेन (ID: `group:Reuben`); हेब्रोन (ID: `place:Hebron`); आशेर (ID: `person:Asher`); गिलाद (ID: `place:Gilead`); आशेर (ID: `group:Asher`); किर्यत्यारीम (ID: `place:Kiriath-jearim`); Refuge (ID: `keyterm:Refuge`); कनानी (ID: `group:Canaan`); गाद (ID: `person:Gad`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); यहोशू (ID: `person:Joshua.2`); Force to Serve (ID: `keyterm:EnticedToServe`); रूबेन (ID: `group:Reuben`); रूबेन (ID: `person:Reuben`); गाद (ID: `person:Gad`); मनश्शे (ID: `group:Manasseh`); मनश्शे (ID: `person:Manasseh`); यरदन (ID: `place:Jordan`); मिस्र (ID: `place:Egypt`); मूसा (ID: `person:Moses`); कनान (ID: `place:Canaan`); Rebel (ID: `keyterm:Rebel`); Dispossess (ID: `keyterm:Dispossess`); पीनहास (ID: `person:Phinehas`); Slaughtering (ID: `keyterm:Slaughtering`); Offering (ID: `keyterm:Offering`); Amorites (ID: `group:Amorites`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); To Cause to Possess (ID: `keyterm:Possess`); एलीआजर (ID: `person:Eleazar.2`); Euphrates River (ID: `place:Euphrates`); Bless (ID: `keyterm:Bless`); गिलाद (ID: `place:Gilead`); Be Unfaithful (ID: `keyterm:Unfaithful`); शेकेम (ID: `place:Shechem`)
