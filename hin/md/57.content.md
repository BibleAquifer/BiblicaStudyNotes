...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Ask for (ID: `keyterm:AskFor`); Love (ID: `keyterm:Love`); Affection (ID: `keyterm:Affection`); पौलुस (ID: `person:Paul`); In Christ (ID: `keyterm:InChrist`); Pray (ID: `keyterm:Pray`); Believe (ID: `keyterm:Believe`); यहोवा (ID: `deity:Lord`); Beloved (ID: `keyterm:Beloved`); Holy (ID: `keyterm:Holy`); Favor (ID: `keyterm:Favor`); Good (ID: `keyterm:Good`); उनेसिमुस (ID: `person:Onesimus`); फिलेमोन (ID: `person:Philemon`); इपफ्रास (ID: `person:Epaphras`); लूका (ID: `person:Luke`); अरखिप्पुस (ID: `person:Archippus`); Owe (ID: `keyterm:Owe`); देमास (ID: `person:Demas`); अफफिया (ID: `person:Apphia`); मरकुस (ID: `person:Mark`); Persuade (ID: `keyterm:Persuade`); अरिस्तर्खुस (ID: `person:Aristarchus`); Spirit (ID: `keyterm:Spirit.2`); Fellowship (ID: `keyterm:Fellowship`); Heart (ID: `keyterm:Heart`); Hope (ID: `keyterm:Hope`); Make Peace (ID: `keyterm:Peace`); Church (ID: `keyterm:Church`); Good News (ID: `keyterm:GoodNews`); Forgive (ID: `keyterm:Forgive`); Always (ID: `keyterm:Always`); Body (ID: `keyterm:Body.3`); Cause of Joy (ID: `keyterm:CauseOfJoy`); To Act Wickedly (ID: `keyterm:ActWickedly`); Serve (ID: `keyterm:Serve`); तीमुथियुस (ID: `person:Timothy`); Guest Room (ID: `realia:GuestRoom`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
