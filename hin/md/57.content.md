...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Love (ID: `keyterm:Love`); पौलुस (ID: `person:Paul`); In Christ (ID: `keyterm:InChrist`); Affection (ID: `keyterm:Affection`); Ask for (ID: `keyterm:AskFor`); Holy (ID: `keyterm:Holy`); Beloved (ID: `keyterm:Beloved`); यहोवा (ID: `deity:Lord`); Pray (ID: `keyterm:Pray`); Favor (ID: `keyterm:Favor`); Good (ID: `keyterm:Good`); Believe (ID: `keyterm:Believe`); उनेसिमुस (ID: `person:Onesimus`); फिलेमोन (ID: `person:Philemon`); देमास (ID: `person:Demas`); इपफ्रास (ID: `person:Epaphras`); Owe (ID: `keyterm:Owe`); लूका (ID: `person:Luke`); अफफिया (ID: `person:Apphia`); अरखिप्पुस (ID: `person:Archippus`); Good News (ID: `keyterm:GoodNews`); Body (ID: `keyterm:Body.3`); Heart (ID: `keyterm:Heart`); Persuade (ID: `keyterm:Persuade`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Always (ID: `keyterm:Always`); To Act Wickedly (ID: `keyterm:ActWickedly`); अरिस्तर्खुस (ID: `person:Aristarchus`); Fellowship (ID: `keyterm:Fellowship`); मरकुस (ID: `person:Mark`); Serve (ID: `keyterm:Serve`); Forgive (ID: `keyterm:Forgive`); तीमुथियुस (ID: `person:Timothy`); Make Peace (ID: `keyterm:Peace`); Spirit (ID: `keyterm:Spirit.2`); Hope (ID: `keyterm:Hope`); Church (ID: `keyterm:Church`); Guest Room (ID: `realia:GuestRoom`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
