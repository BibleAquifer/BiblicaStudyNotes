...
* **Associated ACAI Concepts:** मूसा (ID: `person:Moses`); यहोवा (ID: `deity:Lord`); हारून (ID: `person:Aaron`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); To Sin (ID: `keyterm:Sin`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Priesthood (ID: `keyterm:Priesthood`); इस्राएल (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Tent of Meeting (ID: `realia:TentOfMeeting`); Cattle (ID: `fauna:Bull`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Decree (ID: `keyterm:Decree`); Appease (ID: `keyterm:Appease`); ईतामार (ID: `person:Ithamar`); Smear (ID: `keyterm:Smear`); एलीआजर (ID: `person:Eleazar.2`); Glory (ID: `keyterm:Glory`); Pure (ID: `keyterm:Pure`); Bless (ID: `keyterm:Bless`); Complete (ID: `keyterm:Complete`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Slaughtering (ID: `keyterm:Slaughtering`); Tunic (ID: `realia:Tunic`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Holy (ID: `keyterm:Holy`); Defilement (ID: `keyterm:Defilement`); इस्राएल (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); To Dishonor (ID: `keyterm:Dishonor`); मूसा (ID: `person:Moses`); हारून (ID: `person:Aaron`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Slaughtering (ID: `keyterm:Slaughtering`); Passion (ID: `keyterm:Ardour`); मोलेक (ID: `deity:Molech`); Delight (ID: `keyterm:Delight`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Cattle (ID: `fauna:Bull`); Pure (ID: `keyterm:Pure`); Fear (ID: `keyterm:Fear`); मिस्र (ID: `place:Egypt`); Sheep (ID: `fauna:Lamb`); Tent of Meeting (ID: `realia:TentOfMeeting`); Necromancer (ID: `keyterm:Spirit`); Vow (ID: `keyterm:Vow`); Flock (ID: `fauna:Flock`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Goat (ID: `fauna:Goat`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Appease (ID: `keyterm:Appease`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); इस्राएल (ID: `person:Israel`); Sabbath (ID: `keyterm:Sabbath`); मूसा (ID: `person:Moses`); Work (ID: `keyterm:Work`); Appointed Feast (ID: `keyterm:AppointedFeast`); Barley (ID: `flora:Barley`); Complete (ID: `keyterm:Complete`); Sheep (ID: `fauna:Lamb`); Sickle (ID: `realia:Sickle`); Atonement (ID: `keyterm:Atonement`); Pure (ID: `keyterm:Pure`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Slaughtering (ID: `keyterm:Slaughtering`); हारून (ID: `person:Aaron`); Wine (ID: `realia:Wine`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Lamp (ID: `realia:Lamp`); Delight (ID: `keyterm:Delight`); Memorial Portion (ID: `keyterm:MemorialOrTokenPortion`); Decree (ID: `keyterm:Decree`); इस्राएली (ID: `group:Israel`); To Sin (ID: `keyterm:Sin`); Appease (ID: `keyterm:Appease`); Testimony (ID: `keyterm:Witness.2`); Passover (ID: `keyterm:Passover`); Covenant (ID: `keyterm:Covenant`); मिस्र (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); मूसा (ID: `person:Moses`); इस्राएली (ID: `group:Israel`); Cattle (ID: `fauna:Bull`); दिब्री (ID: `person:Dibri`); शलोमीत (ID: `person:Shelomith.2`); दान (ID: `group:Dan`); दान (ID: `place:Dan`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); मिस्र (ID: `place:Egypt`); मिस्री (ID: `group:Egypt`)
...
* **Associated ACAI Concepts:** Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Redeem (ID: `keyterm:Redeem`); यहोवा (ID: `deity:Lord`); Sabbath (ID: `keyterm:Sabbath`); इस्राएल (ID: `person:Israel`); House (ID: `realia:House`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); मिस्र (ID: `place:Egypt`); Safety (ID: `keyterm:Safety`); Holy (ID: `keyterm:Holy`); Complete (ID: `keyterm:Complete`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); Bless (ID: `keyterm:Bless`); कनान (ID: `place:Canaan`); Dispossess (ID: `keyterm:Dispossess`); सीनै पर्वत (ID: `place:SinaiMount`); Work (ID: `keyterm:Work`); मूसा (ID: `person:Moses`); Atonement (ID: `keyterm:Atonement`); Barley (ID: `flora:Barley`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`); Rams Horn (ID: `realia:RamsHorn`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Passion (ID: `keyterm:Ardour`); Sabbath (ID: `keyterm:Sabbath`); To Sin (ID: `keyterm:Sin`); इस्राएल (ID: `person:Israel`); मिस्र (ID: `place:Egypt`); Idol (ID: `keyterm:Idol`); Strength (ID: `keyterm:Strength`); Safety (ID: `keyterm:Safety`); Decree (ID: `keyterm:Decree`); Repent (ID: `keyterm:Repent`); Stubborn (ID: `keyterm:Stubborn`); सीनै पर्वत (ID: `place:SinaiMount`); Complete (ID: `keyterm:Complete`); अब्राहम (ID: `person:Abraham`); Be Unfaithful (ID: `keyterm:Unfaithful`); Fear (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); मूसा (ID: `person:Moses`); Pleasing Odor (ID: `keyterm:PleasingOdor`); इसहाक (ID: `person:Isaac`); Peace (ID: `keyterm:IntactState`); Image (ID: `realia:Image`); High Place (ID: `realia:HighPlace`); Yoke (ID: `realia:Yoke`); Graven Image (ID: `realia:GravenImage`); Sacred Pillar (ID: `realia:SacredPillar`); Sword (ID: `realia:Sword`); Stone Pine (ID: `flora:Pine`); Lion (ID: `fauna:Lion`); Vine (ID: `flora:Vine`); Barley (ID: `flora:Barley`); Hyena (ID: `fauna:Hyena`); Coriander (ID: `flora:Coriander`); Bear (ID: `fauna:Bear`); Jackal (ID: `fauna:Jackal`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); यहोवा (ID: `deity:Lord`); Redeem (ID: `keyterm:Redeem`); Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Shekel (ID: `realia:Shekel`); Money (ID: `realia:Money`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Set Apart for God (ID: `keyterm:Proscribe`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); मूसा (ID: `person:Moses`); इस्राएल (ID: `person:Israel`); Defilement (ID: `keyterm:Defilement`); Vow (ID: `keyterm:Vow`); Barley (ID: `flora:Barley`); House (ID: `realia:House`); Coriander (ID: `flora:Coriander`); सीनै पर्वत (ID: `place:SinaiMount`); Gerah (ID: `realia:Gerah`); Homer (ID: `realia:Homer`); Sheep (ID: `fauna:Lamb`); Rod (ID: `realia:Rod`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Staff (ID: `realia:Staff`)
