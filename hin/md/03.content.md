...
* **Associated ACAI Concepts:** मूसा (ID: `person:Moses`); यहोवा (ID: `deity:Lord`); हारून (ID: `person:Aaron`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); To Sin (ID: `keyterm:Sin`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Priesthood (ID: `keyterm:Priesthood`); इस्राएल (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Tent of Meeting (ID: `realia:TentOfMeeting`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Decree (ID: `keyterm:Decree`); Appease (ID: `keyterm:Appease`); ईतामार (ID: `person:Ithamar`); Smear (ID: `keyterm:Smear`); एलीआजर (ID: `person:Eleazar.2`); Slaughtering (ID: `keyterm:Slaughtering`); Glory (ID: `keyterm:Glory`); Bless (ID: `keyterm:Bless`); Complete (ID: `keyterm:Complete`); Pure (ID: `keyterm:Pure`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Tunic (ID: `realia:Tunic`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); इस्राएल (ID: `person:Israel`); Sabbath (ID: `keyterm:Sabbath`); मूसा (ID: `person:Moses`); Work (ID: `keyterm:Work`); Appointed Feast (ID: `keyterm:AppointedFeast`); Barley (ID: `flora:Barley`); Complete (ID: `keyterm:Complete`); Sheep (ID: `fauna:Lamb`); Sickle (ID: `realia:Sickle`); Atonement (ID: `keyterm:Atonement`); Slaughtering (ID: `keyterm:Slaughtering`); हारून (ID: `person:Aaron`); Pure (ID: `keyterm:Pure`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Wine (ID: `realia:Wine`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Lamp (ID: `realia:Lamp`); Testimony (ID: `keyterm:Witness.2`); Memorial Portion (ID: `keyterm:MemorialOrTokenPortion`); Passover (ID: `keyterm:Passover`); Vow (ID: `keyterm:Vow`); Delight (ID: `keyterm:Delight`); मिस्र (ID: `place:Egypt`); Covenant (ID: `keyterm:Covenant`); इस्राएली (ID: `group:Israel`); To Sin (ID: `keyterm:Sin`); Decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); मूसा (ID: `person:Moses`); इस्राएली (ID: `group:Israel`); Cattle (ID: `fauna:Bull`); दिब्री (ID: `person:Dibri`); शलोमीत (ID: `person:Shelomith.2`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); दान (ID: `place:Dan`); मिस्री (ID: `group:Egypt`); मिस्र (ID: `place:Egypt`); दान (ID: `group:Dan`)
...
* **Associated ACAI Concepts:** Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Redeem (ID: `keyterm:Redeem`); यहोवा (ID: `deity:Lord`); Sabbath (ID: `keyterm:Sabbath`); इस्राएल (ID: `person:Israel`); House (ID: `realia:House`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); मिस्र (ID: `place:Egypt`); Complete (ID: `keyterm:Complete`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); Safety (ID: `keyterm:Safety`); Holy (ID: `keyterm:Holy`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); सीनै पर्वत (ID: `place:SinaiMount`); कनान (ID: `place:Canaan`); Bless (ID: `keyterm:Bless`); Atonement (ID: `keyterm:Atonement`); मूसा (ID: `person:Moses`); Work (ID: `keyterm:Work`); Dispossess (ID: `keyterm:Dispossess`); Barley (ID: `flora:Barley`); Cattle (ID: `fauna:Bull`); Rams Horn (ID: `realia:RamsHorn`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`)
...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); यहोवा (ID: `deity:Lord`); Redeem (ID: `keyterm:Redeem`); Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Shekel (ID: `realia:Shekel`); Money (ID: `realia:Money`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Set Apart for God (ID: `keyterm:Proscribe`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); Vow (ID: `keyterm:Vow`); मूसा (ID: `person:Moses`); Defilement (ID: `keyterm:Defilement`); इस्राएल (ID: `person:Israel`); Barley (ID: `flora:Barley`); House (ID: `realia:House`); Coriander (ID: `flora:Coriander`); सीनै पर्वत (ID: `place:SinaiMount`); Gerah (ID: `realia:Gerah`); Homer (ID: `realia:Homer`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
