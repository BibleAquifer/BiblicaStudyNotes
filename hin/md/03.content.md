...
* **Associated ACAI Concepts:** हारून (ID: `person:Aaron`); Priesthood (ID: `keyterm:Priesthood`); Sheep (ID: `fauna:Lamb`); Tunic (ID: `realia:Tunic`); ईतामार (ID: `person:Ithamar`); Smear (ID: `keyterm:Smear`); मीशाएल (ID: `person:Mishael`); Turban (ID: `realia:Turban`); Plate (ID: `realia:Plate`); एलीसापान (ID: `person:Elizaphan`); Profane (ID: `keyterm:Profane`); अबीहू (ID: `person:Abihu`); नादाब (ID: `person:Nadab`); उज्जीएल (ID: `person:Uzziel`); Breast-Piece (ID: `realia:Breast-piece`); Ephod (ID: `realia:Ephod`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Wine (ID: `realia:Wine`); Tent of Meeting (ID: `realia:TentOfMeeting`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); मूसा (ID: `person:Moses`); Offering (ID: `keyterm:Offering`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Holy (ID: `keyterm:Holy`); To Sin (ID: `keyterm:Sin`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** अजाजेल (ID: `deity:Azazel`); Appease (ID: `keyterm:Appease`); Goat (ID: `fauna:Goat`); Cover Lid (ID: `realia:CoverLid`); Lot (ID: `realia:Lot`); Lot (ID: `keyterm:Lot`); Linen (ID: `realia:Linen`); Tunic (ID: `realia:Tunic`); पवित्रस्थान (ID: `place:HolyPlace`); Tent of Meeting (ID: `realia:TentOfMeeting`); Flock (ID: `fauna:Flock`); हारून (ID: `person:Aaron`); Holy (ID: `keyterm:Holy`); To Sin (ID: `keyterm:Sin`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); इस्राएल (ID: `person:Israel`); यहोवा (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** मोलेक (ID: `deity:Molech`); To Dishonor (ID: `keyterm:Dishonor`); Necromancer (ID: `keyterm:Spirit`); Appease (ID: `keyterm:Appease`); Idol (ID: `keyterm:Idol`); Balance (ID: `realia:Balance`); Hin (ID: `realia:Hin`); Ephah (ID: `realia:Ephah`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Delight (ID: `keyterm:Delight`); Defilement (ID: `keyterm:Defilement`); Holy (ID: `keyterm:Holy`); Slaughtering (ID: `keyterm:Slaughtering`); Tent of Meeting (ID: `realia:TentOfMeeting`); हारून (ID: `person:Aaron`); Passion (ID: `keyterm:Ardour`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); Sheep (ID: `fauna:Lamb`); मूसा (ID: `person:Moses`); यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** दिब्री (ID: `person:Dibri`); शलोमीत (ID: `person:Shelomith.2`); यहोवा (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Redeem (ID: `keyterm:Redeem`); House (ID: `realia:House`); यहोवा (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Passion (ID: `keyterm:Ardour`); Yoke (ID: `realia:Yoke`); Graven Image (ID: `realia:GravenImage`); High Place (ID: `realia:HighPlace`); Covenant (ID: `keyterm:Covenant`); यहोवा (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Shekel (ID: `realia:Shekel`); Set Apart for God (ID: `keyterm:Proscribe`); Barley (ID: `flora:Barley`); Gerah (ID: `realia:Gerah`); Homer (ID: `realia:Homer`); Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Redeem (ID: `keyterm:Redeem`); Holy (ID: `keyterm:Holy`); Money (ID: `realia:Money`); यहोवा (ID: `deity:Lord`)
