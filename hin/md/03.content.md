...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); इस्राएल (ID: `person:Israel`); Sabbath (ID: `keyterm:Sabbath`); मूसा (ID: `person:Moses`); Work (ID: `keyterm:Work`); Appointed Feast (ID: `keyterm:AppointedFeast`); Barley (ID: `flora:Barley`); Complete (ID: `keyterm:Complete`); Sheep (ID: `fauna:Lamb`); Sickle (ID: `realia:Sickle`); Atonement (ID: `keyterm:Atonement`); हारून (ID: `person:Aaron`); Pure (ID: `keyterm:Pure`); Slaughtering (ID: `keyterm:Slaughtering`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Wine (ID: `realia:Wine`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Lamp (ID: `realia:Lamp`); Memorial Portion (ID: `keyterm:MemorialOrTokenPortion`); Testimony (ID: `keyterm:Witness.2`); Decree (ID: `keyterm:Decree`); Appease (ID: `keyterm:Appease`); Vow (ID: `keyterm:Vow`); मिस्र (ID: `place:Egypt`); Delight (ID: `keyterm:Delight`); Passover (ID: `keyterm:Passover`); इस्राएली (ID: `group:Israel`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); मूसा (ID: `person:Moses`); इस्राएली (ID: `group:Israel`); Cattle (ID: `fauna:Bull`); दिब्री (ID: `person:Dibri`); शलोमीत (ID: `person:Shelomith.2`); दान (ID: `place:Dan`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); दान (ID: `group:Dan`); मिस्री (ID: `group:Egypt`); मिस्र (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Redeem (ID: `keyterm:Redeem`); यहोवा (ID: `deity:Lord`); Sabbath (ID: `keyterm:Sabbath`); इस्राएल (ID: `person:Israel`); House (ID: `realia:House`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); मिस्र (ID: `place:Egypt`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); Complete (ID: `keyterm:Complete`); Safety (ID: `keyterm:Safety`); Holy (ID: `keyterm:Holy`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); सीनै पर्वत (ID: `place:SinaiMount`); Dispossess (ID: `keyterm:Dispossess`); Atonement (ID: `keyterm:Atonement`); Work (ID: `keyterm:Work`); मूसा (ID: `person:Moses`); कनान (ID: `place:Canaan`); Bless (ID: `keyterm:Bless`); Barley (ID: `flora:Barley`); Sorghum (ID: `flora:Sorghum`); Cattle (ID: `fauna:Bull`); Wheat (ID: `flora:Wheat`); Rams Horn (ID: `realia:RamsHorn`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Passion (ID: `keyterm:Ardour`); Sabbath (ID: `keyterm:Sabbath`); To Sin (ID: `keyterm:Sin`); इस्राएल (ID: `person:Israel`); मिस्र (ID: `place:Egypt`); सीनै पर्वत (ID: `place:SinaiMount`); Idol (ID: `keyterm:Idol`); Instruction (ID: `keyterm:Instruction`); Strength (ID: `keyterm:Strength`); Complete (ID: `keyterm:Complete`); Safety (ID: `keyterm:Safety`); Decree (ID: `keyterm:Decree`); इसहाक (ID: `person:Isaac`); Be Unfaithful (ID: `keyterm:Unfaithful`); Peace (ID: `keyterm:IntactState`); मूसा (ID: `person:Moses`); Stubborn (ID: `keyterm:Stubborn`); Repent (ID: `keyterm:Repent`); अब्राहम (ID: `person:Abraham`); Fear (ID: `keyterm:Fear`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Image (ID: `realia:Image`); Graven Image (ID: `realia:GravenImage`); High Place (ID: `realia:HighPlace`); Yoke (ID: `realia:Yoke`); Hyena (ID: `fauna:Hyena`); Cattle (ID: `fauna:Bull`); Coriander (ID: `flora:Coriander`); Bear (ID: `fauna:Bear`); Sword (ID: `realia:Sword`); Jackal (ID: `fauna:Jackal`); Lion (ID: `fauna:Lion`); Vine (ID: `flora:Vine`); Barley (ID: `flora:Barley`); Stone Pine (ID: `flora:Pine`); Sacred Pillar (ID: `realia:SacredPillar`)
...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); यहोवा (ID: `deity:Lord`); Redeem (ID: `keyterm:Redeem`); Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Shekel (ID: `realia:Shekel`); Money (ID: `realia:Money`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Set Apart for God (ID: `keyterm:Proscribe`); Cattle (ID: `fauna:Bull`); Defilement (ID: `keyterm:Defilement`); Offering (ID: `keyterm:Offering`); इस्राएल (ID: `person:Israel`); Vow (ID: `keyterm:Vow`); मूसा (ID: `person:Moses`); Barley (ID: `flora:Barley`); Coriander (ID: `flora:Coriander`); House (ID: `realia:House`); सीनै पर्वत (ID: `place:SinaiMount`); Gerah (ID: `realia:Gerah`); Homer (ID: `realia:Homer`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Staff (ID: `realia:Staff`); Sheep (ID: `fauna:Lamb`); Rod (ID: `realia:Rod`)
