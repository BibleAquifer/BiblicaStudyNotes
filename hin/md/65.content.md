...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); यहोवा (ID: `deity:Lord`); Love (ID: `keyterm:Love`); यहूदा (ID: `person:Jude`); Holy (ID: `keyterm:Holy`); Ask for (ID: `keyterm:AskFor`); Make Peace (ID: `keyterm:Peace`); In Common (ID: `keyterm:InCommon`); Mercy (ID: `keyterm:Mercy`); Favor (ID: `keyterm:Favor`); याकूब (ID: `person:James.3`); Eagerness (ID: `keyterm:Eagerness`); Salvation (ID: `keyterm:Salvation`); Believe (ID: `keyterm:Believe`); Judgment (ID: `keyterm:Judgment`); Beloved (ID: `keyterm:Beloved`)
...
* **Associated ACAI Concepts:** Judgment (ID: `keyterm:Judgment`); Blaspheme (ID: `keyterm:Blaspheme`); Court Case (ID: `keyterm:CourtCase`); Always (ID: `keyterm:Always`); Body (ID: `keyterm:Body.3`); यहोवा (ID: `deity:Lord`); कोरह (ID: `person:Korah.3`); मीकाएल (ID: `person:Michael.11`); आदम (ID: `person:Adam`); Fellowship Meal (ID: `keyterm:FellowshipMeal`); Discern (ID: `keyterm:Discern`); Eternal Fire (ID: `keyterm:EternalFire`); Defilement (ID: `keyterm:Defilement`); Believe (ID: `keyterm:Believe`); यीशु (ID: `person:Jesus.2`); Speak as a Prophet (ID: `keyterm:Speak`); सदोम (ID: `place:Sodom`); गमोरा (ID: `place:Gomorrah`); To Command (ID: `keyterm:Command`); कैन (ID: `person:Cain`); मिस्र (ID: `place:Egypt`); Salvation (ID: `keyterm:Salvation`); मूसा (ID: `person:Moses`); An Angel (ID: `deity:Angel`); Holy (ID: `keyterm:Holy`); हनोक (ID: `person:Enoch.2`); बिलाम (ID: `person:Balaam`); Ability (ID: `keyterm:Ability`); Disaster (ID: `keyterm:Disaster`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Chain (ID: `realia:Chain`)
