...
* **Associated Passages:** यहूदा 1:1-4
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); यहोवा (ID: `deity:Lord`); Love (ID: `keyterm:Love`); यहूदा (ID: `person:Jude`); Holy (ID: `keyterm:Holy`); Make Peace (ID: `keyterm:Peace`); याकूब (ID: `person:James.3`); Salvation (ID: `keyterm:Salvation`); Ask for (ID: `keyterm:AskFor`); Mercy (ID: `keyterm:Mercy`); Eagerness (ID: `keyterm:Eagerness`); Favor (ID: `keyterm:Favor`); In Common (ID: `keyterm:InCommon`); Beloved (ID: `keyterm:Beloved`); Believe (ID: `keyterm:Believe`); Judgment (ID: `keyterm:Judgment`)
...
* **Associated Passages:** यहूदा 1:5-16
...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Judgment (ID: `keyterm:Judgment`); Court Case (ID: `keyterm:CourtCase`); Always (ID: `keyterm:Always`); Blaspheme (ID: `keyterm:Blaspheme`); यहोवा (ID: `deity:Lord`); कोरह (ID: `person:Korah.3`); गमोरा (ID: `place:Gomorrah`); Salvation (ID: `keyterm:Salvation`); To Command (ID: `keyterm:Command`); Fellowship Meal (ID: `keyterm:FellowshipMeal`); Discern (ID: `keyterm:Discern`); Believe (ID: `keyterm:Believe`); कैन (ID: `person:Cain`); Ability (ID: `keyterm:Ability`); सदोम (ID: `place:Sodom`); Eternal Fire (ID: `keyterm:EternalFire`); मूसा (ID: `person:Moses`); Disaster (ID: `keyterm:Disaster`); हनोक (ID: `person:Enoch.2`); मिस्र (ID: `place:Egypt`); Defilement (ID: `keyterm:Defilement`); बिलाम (ID: `person:Balaam`); आदम (ID: `person:Adam`); यीशु (ID: `person:Jesus.2`); Holy (ID: `keyterm:Holy`); An Angel (ID: `deity:Angel`); मीकाएल (ID: `person:Michael.11`); Speak as a Prophet (ID: `keyterm:Speak`); Chain (ID: `realia:Chain`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated Passages:** यहूदा 1:17-25
