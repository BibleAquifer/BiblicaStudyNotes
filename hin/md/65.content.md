...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); यीशु (ID: `person:Jesus.2`); यहोवा (ID: `deity:Lord`); यहूदा (ID: `person:Jude`); Make Peace (ID: `keyterm:Peace`); In Common (ID: `keyterm:InCommon`); Favor (ID: `keyterm:Favor`); Eagerness (ID: `keyterm:Eagerness`); Holy (ID: `keyterm:Holy`); Beloved (ID: `keyterm:Beloved`); याकूब (ID: `person:James.3`); Believe (ID: `keyterm:Believe`); Judgment (ID: `keyterm:Judgment`); Ask for (ID: `keyterm:AskFor`); Salvation (ID: `keyterm:Salvation`); Mercy (ID: `keyterm:Mercy`)
...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Always (ID: `keyterm:Always`); Judgment (ID: `keyterm:Judgment`); Blaspheme (ID: `keyterm:Blaspheme`); Court Case (ID: `keyterm:CourtCase`); यहोवा (ID: `deity:Lord`); कोरह (ID: `person:Korah.3`); Ability (ID: `keyterm:Ability`); Speak as a Prophet (ID: `keyterm:Speak`); गमोरा (ID: `place:Gomorrah`); यीशु (ID: `person:Jesus.2`); Eternal Fire (ID: `keyterm:EternalFire`); Holy (ID: `keyterm:Holy`); An Angel (ID: `deity:Angel`); कैन (ID: `person:Cain`); To Command (ID: `keyterm:Command`); Discern (ID: `keyterm:Discern`); Believe (ID: `keyterm:Believe`); आदम (ID: `person:Adam`); हनोक (ID: `person:Enoch.2`); मूसा (ID: `person:Moses`); सदोम (ID: `place:Sodom`); Defilement (ID: `keyterm:Defilement`); मीकाएल (ID: `person:Michael.11`); मिस्र (ID: `place:Egypt`); Disaster (ID: `keyterm:Disaster`); Fellowship Meal (ID: `keyterm:FellowshipMeal`); बिलाम (ID: `person:Balaam`); Salvation (ID: `keyterm:Salvation`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Chain (ID: `realia:Chain`)
