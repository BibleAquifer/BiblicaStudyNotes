...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); यहोवा (ID: `deity:Lord`); Love (ID: `keyterm:Love`); यहूदा (ID: `person:Jude`); Favor (ID: `keyterm:Favor`); Believe (ID: `keyterm:Believe`); Ask for (ID: `keyterm:AskFor`); Salvation (ID: `keyterm:Salvation`); Make Peace (ID: `keyterm:Peace`); Judgment (ID: `keyterm:Judgment`); Beloved (ID: `keyterm:Beloved`); Mercy (ID: `keyterm:Mercy`); Eagerness (ID: `keyterm:Eagerness`); Holy (ID: `keyterm:Holy`); याकूब (ID: `person:James.3`); In Common (ID: `keyterm:InCommon`)
...
* **Associated ACAI Concepts:** Blaspheme (ID: `keyterm:Blaspheme`); Court Case (ID: `keyterm:CourtCase`); Always (ID: `keyterm:Always`); Body (ID: `keyterm:Body.3`); Judgment (ID: `keyterm:Judgment`); यहोवा (ID: `deity:Lord`); कोरह (ID: `person:Korah.3`); To Command (ID: `keyterm:Command`); Fellowship Meal (ID: `keyterm:FellowshipMeal`); मिस्र (ID: `place:Egypt`); Disaster (ID: `keyterm:Disaster`); An Angel (ID: `deity:Angel`); सदोम (ID: `place:Sodom`); गमोरा (ID: `place:Gomorrah`); आदम (ID: `person:Adam`); कैन (ID: `person:Cain`); मीकाएल (ID: `person:Michael.11`); Ability (ID: `keyterm:Ability`); Eternal Fire (ID: `keyterm:EternalFire`); मूसा (ID: `person:Moses`); Discern (ID: `keyterm:Discern`); Defilement (ID: `keyterm:Defilement`); हनोक (ID: `person:Enoch.2`); Believe (ID: `keyterm:Believe`); Salvation (ID: `keyterm:Salvation`); यीशु (ID: `person:Jesus.2`); Speak as a Prophet (ID: `keyterm:Speak`); बिलाम (ID: `person:Balaam`); Holy (ID: `keyterm:Holy`); Chain (ID: `realia:Chain`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
