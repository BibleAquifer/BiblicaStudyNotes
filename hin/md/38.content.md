...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); यरूशलेम (ID: `place:Jerusalem`); Word of the Lord (ID: `keyterm:WordOfTheLord`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); यहोशू (ID: `person:Joshua.5`); Peace (ID: `keyterm:IntactState`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`); जकर्याह (ID: `person:Zechariah.17`); जरूब्बाबेल (ID: `person:Zerubbabel.2`); Passion (ID: `keyterm:Ardour`); Horn (ID: `keyterm:Horn`); Ask for (ID: `keyterm:AskFor`); दारा (ID: `person:Darius.2`); Horse (ID: `fauna:Horse`); Olive Tree (ID: `flora:OliveTree`); यदायाह (ID: `person:Jedaiah.6`); योशियाह (ID: `person:Josiah.2`); बेरेक्याह (ID: `person:Berechiah.6`); इद्दो (ID: `person:Iddo.6`); सपन्याह (ID: `person:Zephaniah.4`); तोबियाह (ID: `person:Tobijah.2`); हेल्दै (ID: `person:Heldai`); शैतान (ID: `deity:Satan`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); इस्राएल (ID: `person:Israel`); Come On! (ID: `keyterm:ComeOn`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यरूशलेम (ID: `place:Jerusalem`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); दाऊद (ID: `person:David`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Horse (ID: `fauna:Horse`); House (ID: `realia:House`); मिस्र (ID: `place:Egypt`); Money (ID: `realia:Money`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Plague (ID: `keyterm:Blow`); इस्राएल (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); एप्रैम (ID: `group:Ephraim`); एप्रैम (ID: `person:Ephraim`); Utterance (ID: `keyterm:Utterance`); Assyria (ID: `place:Assyria`); एक्रोन (ID: `place:Ekron`); Appoint (ID: `keyterm:Appoint`); Covenant (ID: `keyterm:Covenant`); लबानोन (ID: `place:Lebanon`); Speak as a Prophet (ID: `keyterm:Speak`); सोर (ID: `place:Tyre`); Bow (ID: `realia:Bow`); Sword (ID: `realia:Sword`); Vine (ID: `flora:Vine`); Staff (ID: `realia:Staff`)
