...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); यरूशलेम (ID: `place:Jerusalem`); Word of the Lord (ID: `keyterm:WordOfTheLord`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); यहोशू (ID: `person:Joshua.5`); Peace (ID: `keyterm:IntactState`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`); जकर्याह (ID: `person:Zechariah.17`); जरूब्बाबेल (ID: `person:Zerubbabel.2`); Passion (ID: `keyterm:Ardour`); Horn (ID: `keyterm:Horn`); दारा (ID: `person:Darius.2`); Ask for (ID: `keyterm:AskFor`); Horse (ID: `fauna:Horse`); Olive Tree (ID: `flora:OliveTree`); योशियाह (ID: `person:Josiah.2`); यदायाह (ID: `person:Jedaiah.6`); इद्दो (ID: `person:Iddo.6`); बेरेक्याह (ID: `person:Berechiah.6`); सपन्याह (ID: `person:Zephaniah.4`); तोबियाह (ID: `person:Tobijah.2`); हेल्दै (ID: `person:Heldai`); शैतान (ID: `deity:Satan`); Be Zealous (ID: `keyterm:Zealous`); Come On! (ID: `keyterm:ComeOn`); इस्राएल (ID: `person:Israel`); बेबीलोन (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यरूशलेम (ID: `place:Jerusalem`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); दाऊद (ID: `person:David`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); मिस्र (ID: `place:Egypt`); House (ID: `realia:House`); Horse (ID: `fauna:Horse`); Money (ID: `realia:Money`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Word of the Lord (ID: `keyterm:WordOfTheLord`); इस्राएल (ID: `person:Israel`); एप्रैम (ID: `group:Ephraim`); एप्रैम (ID: `person:Ephraim`); Plague (ID: `keyterm:Blow`); लबानोन (ID: `place:Lebanon`); सोर (ID: `place:Tyre`); Speak as a Prophet (ID: `keyterm:Speak`); Covenant (ID: `keyterm:Covenant`); Assyria (ID: `place:Assyria`); एक्रोन (ID: `place:Ekron`); Appoint (ID: `keyterm:Appoint`); Utterance (ID: `keyterm:Utterance`); Bow (ID: `realia:Bow`); Sword (ID: `realia:Sword`); Rod (ID: `realia:Rod`); Staff (ID: `realia:Staff`)
