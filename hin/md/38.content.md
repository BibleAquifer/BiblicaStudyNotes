...
* **Associated ACAI Concepts:** जकर्याह (ID: `person:Zechariah.17`); यहोशू (ID: `person:Joshua.5`); हेल्दै (ID: `person:Heldai`); तोबियाह (ID: `person:Tobijah.2`); सपन्याह (ID: `person:Zephaniah.4`); यदायाह (ID: `person:Jedaiah.6`); बेरेक्याह (ID: `person:Berechiah.6`); योशियाह (ID: `person:Josiah.2`); Myrtle (ID: `flora:Myrtle`); जरूब्बाबेल (ID: `person:Zerubbabel.2`); शरेसेर (ID: `person:Sharezer.2`); रेगेम्मेलेक (ID: `person:Regem-melech`); इद्दो (ID: `person:Iddo.6`); शैतान (ID: `deity:Satan`); Turban (ID: `realia:Turban.2`); शिनार (ID: `place:Shinar`); यहोसादाक (ID: `person:Jehozadak`); Jews (ID: `group:Jews`); An Angel (ID: `deity:Angel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Peace (ID: `keyterm:IntactState`); Truth (ID: `keyterm:Truth`); यरूशलेम (ID: `place:Jerusalem`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); यहोवा (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** आसेल (ID: `place:Azal`); हद्राक (ID: `place:Hadrach`); Hadad-rimmon (ID: `place:Hadad-rimmon`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Bow (ID: `realia:Bow`); Shimeites (ID: `group:Shimei`); Cedar (ID: `flora:Cedar`); Donkey (ID: `fauna:Donkey`); Tower of Hananel (ID: `place:TowerOfHananel`); Benjamin Gate (ID: `place:BenjaminGate`); जैतून पर्वत (ID: `place:OlivesMount`); शिमी (ID: `person:Shimei.4`); Teraphim (ID: `deity:Teraphim`); Fir (ID: `flora:Fir`); Horse (ID: `fauna:Horse`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); यरूशलेम (ID: `place:Jerusalem`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); Money (ID: `realia:Money`); House (ID: `realia:House`); दाऊद (ID: `person:David`); यहोवा (ID: `deity:Lord`)
