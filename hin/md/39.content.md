...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); एदोम (ID: `place:Edom`); इस्राएल (ID: `person:Israel`); एदोमी (ID: `group:Edom`); मलाकी (ID: `person:Malachi`); Utterance (ID: `keyterm:Utterance`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Love (ID: `keyterm:Love`); To Cause to Possess (ID: `keyterm:Possess`); Jackal (ID: `fauna:Jackal`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); Instruction (ID: `keyterm:Instruction`); इस्राएल (ID: `person:Israel`); Fear (ID: `keyterm:Fear`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); To Dishonor (ID: `keyterm:Dishonor`); To Curse (ID: `keyterm:Curse`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Bless (ID: `keyterm:Bless`); यरूशलेम (ID: `place:Jerusalem`); यहूदा (ID: `person:Judah.4`); Pure (ID: `keyterm:Pure`); Glory (ID: `keyterm:Glory`); यहूदा (ID: `group:Judah`); Defile (ID: `keyterm:Stain`); Priests (ID: `group:GenericPriests`); Peace (ID: `keyterm:IntactState`); An Angel (ID: `deity:Angel`); Fairness (ID: `keyterm:Fairness`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Ask for (ID: `keyterm:AskFor`); A Group of People (ID: `group:GenericGroup`); Love (ID: `keyterm:Love`); The Way (ID: `keyterm:TheWay`); Passion (ID: `keyterm:Ardour`); Force to Serve (ID: `keyterm:EnticedToServe`); Decree (ID: `keyterm:Decree`); अन्यजाति (ID: `group:Gentile`); Swear (ID: `keyterm:Swear`); Intention (ID: `keyterm:Intention`); Vow (ID: `keyterm:Vow`); Delight (ID: `keyterm:Delight`); Truth (ID: `keyterm:Truth`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Sorghum (ID: `flora:Sorghum`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); Scroll (ID: `realia:Scroll`); Molten Image (ID: `realia:MoltenImage`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`)
...
* **Associated ACAI Concepts:** सीनै पर्वत (ID: `place:SinaiMount`); यहोवा (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Decree (ID: `keyterm:Decree`); Fear (ID: `keyterm:Fear`); मूसा (ID: `person:Moses`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); इस्राएल (ID: `person:Israel`); एलिय्याह (ID: `person:Elijah`)
