...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); कनान (ID: `place:Canaan`); कनानी (ID: `group:Canaan`); इस्राएल (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); यहोशू (ID: `person:Joshua.2`); कालेब (ID: `person:Caleb`); Force to Serve (ID: `keyterm:EnticedToServe`); बेतेल (ID: `place:Bethel`); Amorites (ID: `group:Amorites`); अदोनीबेजेक (ID: `person:Adoni-bezek`); यूसुफ (ID: `person:Joseph.10`); Perizzites (ID: `group:Perizzites`); मूसा (ID: `person:Moses`); Negev (ID: `place:Negeb`); Covenant (ID: `keyterm:Covenant`); यरूशलेम (ID: `place:Jerusalem`); बेजेक (ID: `place:Bezek`); अकसा (ID: `person:Achsah`); आशेर (ID: `group:Asher`); बाल (ID: `deity:Baal`); Jebusites (ID: `group:Jebusites`); To Cause to Possess (ID: `keyterm:Possess`); मिस्र (ID: `place:Egypt`); शिमोन (ID: `group:Simeon`); शिमोन (ID: `person:Simeon.5`); हेब्रोन (ID: `place:Hebron`); दबीर (ID: `place:Debir`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); सीसरा (ID: `person:Sisera`); बाराक (ID: `person:Barak`); दबोरा (ID: `person:Deborah.2`); एहूद (ID: `person:Ehud`); याएल (ID: `person:Jael`); मोआब (ID: `place:Moab`); याबीन (ID: `person:Jabin.2`); हेबेर (ID: `person:Heber.2`); अबीनोअम (ID: `person:Abinoam`); एग्लोन (ID: `person:Eglon`); Chariot (ID: `realia:Chariot`); Tent (ID: `realia:Tent`); केदेश (ID: `place:Kedesh`); जबूलून (ID: `person:Zebulun`); कनान (ID: `place:Canaan`); जबूलून (ID: `group:Zebulun`); Sword (ID: `realia:Sword`); हरोशेत (ID: `place:Harosheth-hagoyim`); ताबोर पर्वत (ID: `place:TaborMount`); कीशोन (ID: `place:Kishon`); केनी (ID: `group:Kenite`); Force to Serve (ID: `keyterm:EnticedToServe`); नप्ताली (ID: `person:Naphtali`); नप्ताली (ID: `group:Naphtali`); Offering (ID: `keyterm:Offering`); Bless (ID: `keyterm:Bless`); एप्रैम (ID: `group:Ephraim`); एप्रैम (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** गिदोन (ID: `person:Gideon`); यहोवा (ID: `deity:Lord`); अबीमेलेक (ID: `person:Abimelech.2`); मिद्यान (ID: `place:Midian`); इस्राएल (ID: `person:Israel`); शेकेम (ID: `place:Shechem`); गाल (ID: `person:Gaal`); योआश (ID: `person:Joash`); सल्मुन्ना (ID: `person:Zalmunna`); जेबह (ID: `person:Zebah`); An Angel (ID: `deity:Angel`); ओप्रा (ID: `place:Ophrah.2`); जबूल (ID: `person:Zebul`); एबेद (ID: `person:Ebed`); बाल (ID: `deity:Baal`); सुक्कोत (ID: `place:Succoth`); Fear (ID: `keyterm:Fear`); अबीएजेर (ID: `person:Abiezer`); योताम (ID: `person:Jotham`); अशेरा (ID: `deity:Asherah`); पूर्व (ID: `place:East`); Tower (ID: `realia:Tower`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Rams Horn (ID: `realia:RamsHorn`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); अबीएजेरी (ID: `group:Abiezer`); मिस्र (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** इस्राएल (ID: `person:Israel`); अम्मोन (ID: `place:Ammon`); अम्मोनी (ID: `group:Ammon`); यिप्तह (ID: `person:Jephthah`); यहोवा (ID: `deity:Lord`); गिलाद (ID: `place:Gilead`); एप्रैम (ID: `group:Ephraim`); एप्रैम (ID: `person:Ephraim`); यरदन (ID: `place:Jordan`); Amorites (ID: `group:Amorites`); मोआब (ID: `place:Moab`); An Angel (ID: `deity:Angel`); अर्नोन (ID: `place:Arnon`); Mizpah (ID: `place:Mizpah.2`); Force to Serve (ID: `keyterm:EnticedToServe`); Gileadites (ID: `group:Gilead`); Dispossess (ID: `keyterm:Dispossess`); मिस्र (ID: `place:Egypt`); पलिश्ती (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); सीहोन (ID: `person:Sihon`); To Sin (ID: `keyterm:Sin`); गिलाद (ID: `person:Gilead.2`); अब्दोन (ID: `person:Abdon`); Hillel (ID: `person:Hillel`); शामीर (ID: `place:Shamir.2`); याईर (ID: `person:Jair.3`); एलोन (ID: `person:Elon.3`); इबसान (ID: `person:Ibzan`); जबूलून (ID: `group:Zebulun`)
...
* **Associated ACAI Concepts:** शिमशोन (ID: `person:Samson`); यहोवा (ID: `deity:Lord`); पलिश्ती (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); मानोह (ID: `person:Manoah`); An Angel (ID: `deity:Angel`); दलीला (ID: `person:Delilah`); Strength (ID: `keyterm:Strength`); इस्राएल (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); सोरा (ID: `place:Zorah`); लही (ID: `place:Lehi`); Nazirites (ID: `group:Nazirite`); Offering (ID: `keyterm:Offering`); गाज़ा (ID: `place:Gaza`); यहूदा (ID: `group:Judah`); Defilement (ID: `keyterm:Defilement`); यहूदा (ID: `person:Judah.4`); तिम्नाह (ID: `place:Timnah`); Love (ID: `keyterm:Love`); Goat (ID: `fauna:Goat`); Lion (ID: `fauna:Lion`); Rope (ID: `realia:Rope`); Kid (ID: `fauna:Kid`); Manoah's Wife (ID: `person:WifeOfManoah`); एताम (ID: `place:Etam`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); एश्ताओल (ID: `place:Eshtaol`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** मीका (ID: `person:Micah.3`); दान (ID: `place:Dan`); दान (ID: `group:Dan`); यहोवा (ID: `deity:Lord`); House (ID: `realia:House`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); Teraphim (ID: `deity:Teraphim`); Graven Image (ID: `realia:GravenImage`); Household Idols (ID: `realia:HouseholdIdols`); Molten Image (ID: `realia:MoltenImage`); Ephod (ID: `realia:Ephod`); एप्रैम (ID: `person:Ephraim`); एप्रैम (ID: `group:Ephraim`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); इस्राएल (ID: `person:Israel`); एश्ताओल (ID: `place:Eshtaol`); Money (ID: `realia:Money`); A Person (ID: `person:GenericPerson`); Trust (ID: `keyterm:LeanOn`); सोरा (ID: `place:Zorah`); बैतलहम (ID: `place:Bethlehem`); Mother of Micah (ID: `person:MotherOfMicah.3`); सीदोन (ID: `place:Sidon`); Peace (ID: `keyterm:IntactState`); Dispossess (ID: `keyterm:Dispossess`); महनेदान (ID: `place:Mahaneh-dan`); गेर्शोम (ID: `person:Gershom`); Military Members (ID: `group:MilitaryMembers`); योनातान (ID: `person:Jonathan.2`); Beth-rehob (ID: `place:Beth-rehob`); To Cause to Possess (ID: `keyterm:Possess`); किर्यत्यारीम (ID: `place:Kiriath-jearim`); To Curse (ID: `keyterm:Curse`); Bless (ID: `keyterm:Bless`); शीलो (ID: `place:Shiloh`); मूसा (ID: `person:Moses`); Safety (ID: `keyterm:Safety`); Holy (ID: `keyterm:Holy`); Sidonians (ID: `group:Sidon`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** इस्राएल (ID: `person:Israel`); बिन्यामीन (ID: `group:Benjamin`); बिन्यामीन (ID: `person:Benjamin`); Gibeah (ID: `place:Gibeah.2`); यहोवा (ID: `deity:Lord`); Jabesh-gilead (ID: `place:Jabesh-gilead`); मिस्पा (ID: `place:Mizpah`); बेतेल (ID: `place:Bethel`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); To Cause to Possess (ID: `keyterm:Possess`); A Father (ID: `person:GenericFather`); यहूदा (ID: `group:Judah`); Foolish (ID: `keyterm:Foolish`); यहूदा (ID: `person:Judah.4`); Donkey (ID: `fauna:Donkey`); Rock of Rimmon (ID: `place:Rimmon.3`); एप्रैम (ID: `person:Ephraim`); एप्रैम (ID: `group:Ephraim`); Swear (ID: `keyterm:Swear`); शीलो (ID: `place:Shiloh`); बैतलहम (ID: `place:Bethlehem`); Offering (ID: `keyterm:Offering`); A Man (ID: `person:GenericMale`); यरूशलेम (ID: `place:Jerusalem`); लेवी (ID: `group:Levi`); Wickedness (ID: `keyterm:Wickedness`); लेवी (ID: `person:Levi.3`); Peace (ID: `keyterm:IntactState`); Vine (ID: `flora:Vine`)
