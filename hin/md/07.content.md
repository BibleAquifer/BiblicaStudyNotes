...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); कनान (ID: `place:Canaan`); कनानी (ID: `group:Canaan`); इस्राएल (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); यहोशू (ID: `person:Joshua.2`); कालेब (ID: `person:Caleb`); Force to Serve (ID: `keyterm:EnticedToServe`); Amorites (ID: `group:Amorites`); बेतेल (ID: `place:Bethel`); अदोनीबेजेक (ID: `person:Adoni-bezek`); मूसा (ID: `person:Moses`); यरूशलेम (ID: `place:Jerusalem`); Perizzites (ID: `group:Perizzites`); Negev (ID: `place:Negeb`); यूसुफ (ID: `person:Joseph.10`); Covenant (ID: `keyterm:Covenant`); बेजेक (ID: `place:Bezek`); अकसा (ID: `person:Achsah`); आशेर (ID: `group:Asher`); बाल (ID: `deity:Baal`); To Cause to Possess (ID: `keyterm:Possess`); Hivites (ID: `group:Hivites`); हेब्रोन (ID: `place:Hebron`); Jebusites (ID: `group:Jebusites`); सीदोन (ID: `place:Sidon`); An Angel (ID: `deity:Angel`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); सीसरा (ID: `person:Sisera`); बाराक (ID: `person:Barak`); दबोरा (ID: `person:Deborah.2`); एहूद (ID: `person:Ehud`); याएल (ID: `person:Jael`); मोआब (ID: `place:Moab`); याबीन (ID: `person:Jabin.2`); अबीनोअम (ID: `person:Abinoam`); हेबेर (ID: `person:Heber.2`); एग्लोन (ID: `person:Eglon`); Tent (ID: `realia:Tent`); Chariot (ID: `realia:Chariot`); जबूलून (ID: `group:Zebulun`); जबूलून (ID: `person:Zebulun`); कनान (ID: `place:Canaan`); केदेश (ID: `place:Kedesh`); Sword (ID: `realia:Sword`); हरोशेत (ID: `place:Harosheth-hagoyim`); ताबोर पर्वत (ID: `place:TaborMount`); कीशोन (ID: `place:Kishon`); केनी (ID: `group:Kenite`); Force to Serve (ID: `keyterm:EnticedToServe`); नप्ताली (ID: `person:Naphtali`); Offering (ID: `keyterm:Offering`); नप्ताली (ID: `group:Naphtali`); Bless (ID: `keyterm:Bless`); एप्रैम (ID: `group:Ephraim`); एप्रैम (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** गिदोन (ID: `person:Gideon`); यहोवा (ID: `deity:Lord`); अबीमेलेक (ID: `person:Abimelech.2`); मिद्यान (ID: `place:Midian`); इस्राएल (ID: `person:Israel`); शेकेम (ID: `place:Shechem`); गाल (ID: `person:Gaal`); योआश (ID: `person:Joash`); जेबह (ID: `person:Zebah`); सल्मुन्ना (ID: `person:Zalmunna`); An Angel (ID: `deity:Angel`); एबेद (ID: `person:Ebed`); जबूल (ID: `person:Zebul`); ओप्रा (ID: `place:Ophrah.2`); सुक्कोत (ID: `place:Succoth`); Fear (ID: `keyterm:Fear`); बाल (ID: `deity:Baal`); अबीएजेर (ID: `person:Abiezer`); योताम (ID: `person:Jotham`); अशेरा (ID: `deity:Asherah`); पूर्व (ID: `place:East`); Altar (ID: `realia:Altar`); Rams Horn (ID: `realia:RamsHorn`); Tower (ID: `realia:Tower`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); House (ID: `realia:House`); अबीएजेरी (ID: `group:Abiezer`); Truth (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** इस्राएल (ID: `person:Israel`); अम्मोन (ID: `place:Ammon`); अम्मोनी (ID: `group:Ammon`); यिप्तह (ID: `person:Jephthah`); यहोवा (ID: `deity:Lord`); गिलाद (ID: `place:Gilead`); एप्रैम (ID: `group:Ephraim`); एप्रैम (ID: `person:Ephraim`); Amorites (ID: `group:Amorites`); यरदन (ID: `place:Jordan`); मोआब (ID: `place:Moab`); An Angel (ID: `deity:Angel`); अर्नोन (ID: `place:Arnon`); Mizpah (ID: `place:Mizpah.2`); Force to Serve (ID: `keyterm:EnticedToServe`); Dispossess (ID: `keyterm:Dispossess`); Gileadites (ID: `group:Gilead`); Philistia (ID: `place:Philistine`); To Sin (ID: `keyterm:Sin`); सीहोन (ID: `person:Sihon`); पलिश्ती (ID: `group:Philistine`); मिस्र (ID: `place:Egypt`); जबूलून (ID: `group:Zebulun`); शामीर (ID: `place:Shamir.2`); Hillel (ID: `person:Hillel`); इबसान (ID: `person:Ibzan`); गिलाद (ID: `person:Gilead.2`); अब्दोन (ID: `person:Abdon`); याईर (ID: `person:Jair.3`); एलोन (ID: `person:Elon.3`)
...
* **Associated ACAI Concepts:** शिमशोन (ID: `person:Samson`); यहोवा (ID: `deity:Lord`); Philistia (ID: `place:Philistine`); पलिश्ती (ID: `group:Philistine`); मानोह (ID: `person:Manoah`); An Angel (ID: `deity:Angel`); दलीला (ID: `person:Delilah`); Strength (ID: `keyterm:Strength`); इस्राएल (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); सोरा (ID: `place:Zorah`); लही (ID: `place:Lehi`); Nazirites (ID: `group:Nazirite`); Love (ID: `keyterm:Love`); गाज़ा (ID: `place:Gaza`); तिम्नाह (ID: `place:Timnah`); यहूदा (ID: `group:Judah`); Defilement (ID: `keyterm:Defilement`); यहूदा (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); Lion (ID: `fauna:Lion`); Rope (ID: `realia:Rope`); Goat (ID: `fauna:Goat`); Kid (ID: `fauna:Kid`); Manoah's Wife (ID: `person:WifeOfManoah`); एताम (ID: `place:Etam`); एश्ताओल (ID: `place:Eshtaol`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** मीका (ID: `person:Micah.3`); दान (ID: `place:Dan`); दान (ID: `group:Dan`); यहोवा (ID: `deity:Lord`); House (ID: `realia:House`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); Teraphim (ID: `deity:Teraphim`); Graven Image (ID: `realia:GravenImage`); Molten Image (ID: `realia:MoltenImage`); Household Idols (ID: `realia:HouseholdIdols`); Ephod (ID: `realia:Ephod`); एप्रैम (ID: `group:Ephraim`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); एप्रैम (ID: `person:Ephraim`); इस्राएल (ID: `person:Israel`); एश्ताओल (ID: `place:Eshtaol`); Money (ID: `realia:Money`); A Person (ID: `person:GenericPerson`); सोरा (ID: `place:Zorah`); बैतलहम (ID: `place:Bethlehem`); Trust (ID: `keyterm:LeanOn`); Mother of Micah (ID: `person:MotherOfMicah.3`); Dispossess (ID: `keyterm:Dispossess`); Peace (ID: `keyterm:IntactState`); सीदोन (ID: `place:Sidon`); Military Members (ID: `group:MilitaryMembers`); महनेदान (ID: `place:Mahaneh-dan`); Beth-rehob (ID: `place:Beth-rehob`); योनातान (ID: `person:Jonathan.2`); गेर्शोम (ID: `person:Gershom`); To Cause to Possess (ID: `keyterm:Possess`); To Curse (ID: `keyterm:Curse`); शीलो (ID: `place:Shiloh`); Bless (ID: `keyterm:Bless`); मूसा (ID: `person:Moses`); Safety (ID: `keyterm:Safety`); किर्यत्यारीम (ID: `place:Kiriath-jearim`); Holy (ID: `keyterm:Holy`); Sidonians (ID: `group:Sidon`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** इस्राएल (ID: `person:Israel`); बिन्यामीन (ID: `group:Benjamin`); बिन्यामीन (ID: `person:Benjamin`); Gibeah (ID: `place:Gibeah.2`); यहोवा (ID: `deity:Lord`); Jabesh-gilead (ID: `place:Jabesh-gilead`); मिस्पा (ID: `place:Mizpah`); बेतेल (ID: `place:Bethel`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); To Cause to Possess (ID: `keyterm:Possess`); Foolish (ID: `keyterm:Foolish`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); A Father (ID: `person:GenericFather`); Donkey (ID: `fauna:Donkey`); Rock of Rimmon (ID: `place:Rimmon.3`); Swear (ID: `keyterm:Swear`); शीलो (ID: `place:Shiloh`); बैतलहम (ID: `place:Bethlehem`); एप्रैम (ID: `group:Ephraim`); एप्रैम (ID: `person:Ephraim`); Wickedness (ID: `keyterm:Wickedness`); लेवी (ID: `group:Levi`); Peace (ID: `keyterm:IntactState`); यरूशलेम (ID: `place:Jerusalem`); लेवी (ID: `person:Levi.3`); Offering (ID: `keyterm:Offering`); A Man (ID: `person:GenericMale`); Vine (ID: `flora:Vine`)
