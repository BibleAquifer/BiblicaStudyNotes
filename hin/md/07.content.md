...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); कनान (ID: `place:Canaan`); कनानी (ID: `group:Canaan`); इस्राएल (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); यहोशू (ID: `person:Joshua.2`); कालेब (ID: `person:Caleb`); Force to Serve (ID: `keyterm:EnticedToServe`); बेतेल (ID: `place:Bethel`); Amorites (ID: `group:Amorites`); अदोनीबेजेक (ID: `person:Adoni-bezek`); मूसा (ID: `person:Moses`); यूसुफ (ID: `person:Joseph.10`); Covenant (ID: `keyterm:Covenant`); Negev (ID: `place:Negeb`); Perizzites (ID: `group:Perizzites`); यरूशलेम (ID: `place:Jerusalem`); बेजेक (ID: `place:Bezek`); अकसा (ID: `person:Achsah`); बाल (ID: `deity:Baal`); आशेर (ID: `group:Asher`); Jebusites (ID: `group:Jebusites`); मिस्र (ID: `place:Egypt`); हित्ती (ID: `group:Hittite`); To Cause to Possess (ID: `keyterm:Possess`); Swear (ID: `keyterm:Swear`); आशेर (ID: `person:Asher`); Hivites (ID: `group:Hivites`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); सीसरा (ID: `person:Sisera`); बाराक (ID: `person:Barak`); दबोरा (ID: `person:Deborah.2`); एहूद (ID: `person:Ehud`); याएल (ID: `person:Jael`); मोआब (ID: `place:Moab`); याबीन (ID: `person:Jabin.2`); हेबेर (ID: `person:Heber.2`); अबीनोअम (ID: `person:Abinoam`); एग्लोन (ID: `person:Eglon`); Chariot (ID: `realia:Chariot`); Tent (ID: `realia:Tent`); कनान (ID: `place:Canaan`); जबूलून (ID: `group:Zebulun`); जबूलून (ID: `person:Zebulun`); केदेश (ID: `place:Kedesh`); Sword (ID: `realia:Sword`); हरोशेत (ID: `place:Harosheth-hagoyim`); कीशोन (ID: `place:Kishon`); ताबोर पर्वत (ID: `place:TaborMount`); केनी (ID: `group:Kenite`); Offering (ID: `keyterm:Offering`); एप्रैम (ID: `person:Ephraim`); नप्ताली (ID: `group:Naphtali`); नप्ताली (ID: `person:Naphtali`); Bless (ID: `keyterm:Bless`); Force to Serve (ID: `keyterm:EnticedToServe`); एप्रैम (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** गिदोन (ID: `person:Gideon`); यहोवा (ID: `deity:Lord`); अबीमेलेक (ID: `person:Abimelech.2`); मिद्यान (ID: `place:Midian`); इस्राएल (ID: `person:Israel`); शेकेम (ID: `place:Shechem`); गाल (ID: `person:Gaal`); योआश (ID: `person:Joash`); जेबह (ID: `person:Zebah`); सल्मुन्ना (ID: `person:Zalmunna`); An Angel (ID: `deity:Angel`); एबेद (ID: `person:Ebed`); ओप्रा (ID: `place:Ophrah.2`); जबूल (ID: `person:Zebul`); सुक्कोत (ID: `place:Succoth`); बाल (ID: `deity:Baal`); Fear (ID: `keyterm:Fear`); अबीएजेर (ID: `person:Abiezer`); योताम (ID: `person:Jotham`); पूर्व (ID: `place:East`); अशेरा (ID: `deity:Asherah`); Tower (ID: `realia:Tower`); Rams Horn (ID: `realia:RamsHorn`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); अबीएजेरी (ID: `group:Abiezer`); अमालेकी (ID: `group:Amalek`)
...
* **Associated ACAI Concepts:** इस्राएल (ID: `person:Israel`); अम्मोन (ID: `place:Ammon`); अम्मोनी (ID: `group:Ammon`); यिप्तह (ID: `person:Jephthah`); यहोवा (ID: `deity:Lord`); गिलाद (ID: `place:Gilead`); एप्रैम (ID: `group:Ephraim`); एप्रैम (ID: `person:Ephraim`); यरदन (ID: `place:Jordan`); Amorites (ID: `group:Amorites`); An Angel (ID: `deity:Angel`); मोआब (ID: `place:Moab`); अर्नोन (ID: `place:Arnon`); Mizpah (ID: `place:Mizpah.2`); Gileadites (ID: `group:Gilead`); Dispossess (ID: `keyterm:Dispossess`); Force to Serve (ID: `keyterm:EnticedToServe`); पलिश्ती (ID: `group:Philistine`); मिस्र (ID: `place:Egypt`); To Sin (ID: `keyterm:Sin`); Philistia (ID: `place:Philistine`); सीहोन (ID: `person:Sihon`); इबसान (ID: `person:Ibzan`); Hillel (ID: `person:Hillel`); जबूलून (ID: `group:Zebulun`); याईर (ID: `person:Jair.3`); एलोन (ID: `person:Elon.3`); अब्दोन (ID: `person:Abdon`); शामीर (ID: `place:Shamir.2`); गिलाद (ID: `person:Gilead.2`)
...
* **Associated ACAI Concepts:** शिमशोन (ID: `person:Samson`); यहोवा (ID: `deity:Lord`); Philistia (ID: `place:Philistine`); पलिश्ती (ID: `group:Philistine`); मानोह (ID: `person:Manoah`); An Angel (ID: `deity:Angel`); दलीला (ID: `person:Delilah`); Strength (ID: `keyterm:Strength`); इस्राएल (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); सोरा (ID: `place:Zorah`); लही (ID: `place:Lehi`); Nazirites (ID: `group:Nazirite`); Love (ID: `keyterm:Love`); Defilement (ID: `keyterm:Defilement`); यहूदा (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); यहूदा (ID: `group:Judah`); गाज़ा (ID: `place:Gaza`); तिम्नाह (ID: `place:Timnah`); Goat (ID: `fauna:Goat`); Rope (ID: `realia:Rope`); Kid (ID: `fauna:Kid`); Lion (ID: `fauna:Lion`); एताम (ID: `place:Etam`); Manoah's Wife (ID: `person:WifeOfManoah`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); एश्ताओल (ID: `place:Eshtaol`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** मीका (ID: `person:Micah.3`); दान (ID: `place:Dan`); दान (ID: `group:Dan`); यहोवा (ID: `deity:Lord`); House (ID: `realia:House`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); Teraphim (ID: `deity:Teraphim`); Graven Image (ID: `realia:GravenImage`); Household Idols (ID: `realia:HouseholdIdols`); Molten Image (ID: `realia:MoltenImage`); Ephod (ID: `realia:Ephod`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); इस्राएल (ID: `person:Israel`); एप्रैम (ID: `person:Ephraim`); एप्रैम (ID: `group:Ephraim`); एश्ताओल (ID: `place:Eshtaol`); Money (ID: `realia:Money`); Trust (ID: `keyterm:LeanOn`); बैतलहम (ID: `place:Bethlehem`); सोरा (ID: `place:Zorah`); A Person (ID: `person:GenericPerson`); Mother of Micah (ID: `person:MotherOfMicah.3`); Dispossess (ID: `keyterm:Dispossess`); सीदोन (ID: `place:Sidon`); Peace (ID: `keyterm:IntactState`); Military Members (ID: `group:MilitaryMembers`); महनेदान (ID: `place:Mahaneh-dan`); योनातान (ID: `person:Jonathan.2`); गेर्शोम (ID: `person:Gershom`); Beth-rehob (ID: `place:Beth-rehob`); Sidonians (ID: `group:Sidon`); Safety (ID: `keyterm:Safety`); शीलो (ID: `place:Shiloh`); To Curse (ID: `keyterm:Curse`); मूसा (ID: `person:Moses`); Holy (ID: `keyterm:Holy`); किर्यत्यारीम (ID: `place:Kiriath-jearim`); To Cause to Possess (ID: `keyterm:Possess`); Bless (ID: `keyterm:Bless`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** इस्राएल (ID: `person:Israel`); बिन्यामीन (ID: `group:Benjamin`); बिन्यामीन (ID: `person:Benjamin`); Gibeah (ID: `place:Gibeah.2`); यहोवा (ID: `deity:Lord`); Jabesh-gilead (ID: `place:Jabesh-gilead`); मिस्पा (ID: `place:Mizpah`); बेतेल (ID: `place:Bethel`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); A Father (ID: `person:GenericFather`); यहूदा (ID: `person:Judah.4`); Foolish (ID: `keyterm:Foolish`); यहूदा (ID: `group:Judah`); To Cause to Possess (ID: `keyterm:Possess`); Donkey (ID: `fauna:Donkey`); Rock of Rimmon (ID: `place:Rimmon.3`); शीलो (ID: `place:Shiloh`); बैतलहम (ID: `place:Bethlehem`); एप्रैम (ID: `person:Ephraim`); एप्रैम (ID: `group:Ephraim`); Swear (ID: `keyterm:Swear`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); यरूशलेम (ID: `place:Jerusalem`); A Man (ID: `person:GenericMale`); Wickedness (ID: `keyterm:Wickedness`); Offering (ID: `keyterm:Offering`); Peace (ID: `keyterm:IntactState`); Vine (ID: `flora:Vine`)
