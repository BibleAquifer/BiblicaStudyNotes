...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); कनान (ID: `place:Canaan`); कनानी (ID: `group:Canaan`); इस्राएल (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); यहोशू (ID: `person:Joshua.2`); कालेब (ID: `person:Caleb`); Force to Serve (ID: `keyterm:EnticedToServe`); Amorites (ID: `group:Amorites`); बेतेल (ID: `place:Bethel`); अदोनीबेजेक (ID: `person:Adoni-bezek`); Negev (ID: `place:Negeb`); यूसुफ (ID: `person:Joseph.10`); Perizzites (ID: `group:Perizzites`); मूसा (ID: `person:Moses`); Covenant (ID: `keyterm:Covenant`); यरूशलेम (ID: `place:Jerusalem`); अकसा (ID: `person:Achsah`); बेजेक (ID: `place:Bezek`); आशेर (ID: `group:Asher`); बाल (ID: `deity:Baal`); To Cause to Possess (ID: `keyterm:Possess`); आशेर (ID: `person:Asher`); सीदोन (ID: `place:Sidon`); शिमोन (ID: `group:Simeon`); शिमोन (ID: `person:Simeon.5`); An Angel (ID: `deity:Angel`); Jebusites (ID: `group:Jebusites`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); सीसरा (ID: `person:Sisera`); बाराक (ID: `person:Barak`); दबोरा (ID: `person:Deborah.2`); एहूद (ID: `person:Ehud`); याएल (ID: `person:Jael`); मोआब (ID: `place:Moab`); याबीन (ID: `person:Jabin.2`); अबीनोअम (ID: `person:Abinoam`); हेबेर (ID: `person:Heber.2`); एग्लोन (ID: `person:Eglon`); Tent (ID: `realia:Tent`); Chariot (ID: `realia:Chariot`); कनान (ID: `place:Canaan`); केदेश (ID: `place:Kedesh`); जबूलून (ID: `person:Zebulun`); जबूलून (ID: `group:Zebulun`); Sword (ID: `realia:Sword`); हरोशेत (ID: `place:Harosheth-hagoyim`); ताबोर पर्वत (ID: `place:TaborMount`); कीशोन (ID: `place:Kishon`); केनी (ID: `group:Kenite`); नप्ताली (ID: `person:Naphtali`); नप्ताली (ID: `group:Naphtali`); एप्रैम (ID: `group:Ephraim`); Bless (ID: `keyterm:Bless`); Force to Serve (ID: `keyterm:EnticedToServe`); Offering (ID: `keyterm:Offering`); एप्रैम (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** गिदोन (ID: `person:Gideon`); यहोवा (ID: `deity:Lord`); अबीमेलेक (ID: `person:Abimelech.2`); मिद्यान (ID: `place:Midian`); इस्राएल (ID: `person:Israel`); शेकेम (ID: `place:Shechem`); गाल (ID: `person:Gaal`); योआश (ID: `person:Joash`); जेबह (ID: `person:Zebah`); सल्मुन्ना (ID: `person:Zalmunna`); An Angel (ID: `deity:Angel`); ओप्रा (ID: `place:Ophrah.2`); एबेद (ID: `person:Ebed`); जबूल (ID: `person:Zebul`); Fear (ID: `keyterm:Fear`); बाल (ID: `deity:Baal`); सुक्कोत (ID: `place:Succoth`); अबीएजेर (ID: `person:Abiezer`); योताम (ID: `person:Jotham`); पूर्व (ID: `place:East`); अशेरा (ID: `deity:Asherah`); Rams Horn (ID: `realia:RamsHorn`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Tower (ID: `realia:Tower`); Stone Altar (ID: `realia:StoneAltar`); House (ID: `realia:House`); अबीएजेरी (ID: `group:Abiezer`); Peace (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** इस्राएल (ID: `person:Israel`); अम्मोन (ID: `place:Ammon`); अम्मोनी (ID: `group:Ammon`); यिप्तह (ID: `person:Jephthah`); यहोवा (ID: `deity:Lord`); गिलाद (ID: `place:Gilead`); एप्रैम (ID: `group:Ephraim`); एप्रैम (ID: `person:Ephraim`); Amorites (ID: `group:Amorites`); यरदन (ID: `place:Jordan`); मोआब (ID: `place:Moab`); An Angel (ID: `deity:Angel`); अर्नोन (ID: `place:Arnon`); Mizpah (ID: `place:Mizpah.2`); Dispossess (ID: `keyterm:Dispossess`); Force to Serve (ID: `keyterm:EnticedToServe`); Gileadites (ID: `group:Gilead`); To Sin (ID: `keyterm:Sin`); सीहोन (ID: `person:Sihon`); मिस्र (ID: `place:Egypt`); Philistia (ID: `place:Philistine`); पलिश्ती (ID: `group:Philistine`); इबसान (ID: `person:Ibzan`); गिलाद (ID: `person:Gilead.2`); Hillel (ID: `person:Hillel`); याईर (ID: `person:Jair.3`); अब्दोन (ID: `person:Abdon`); एलोन (ID: `person:Elon.3`); जबूलून (ID: `group:Zebulun`); शामीर (ID: `place:Shamir.2`)
...
* **Associated ACAI Concepts:** शिमशोन (ID: `person:Samson`); यहोवा (ID: `deity:Lord`); Philistia (ID: `place:Philistine`); पलिश्ती (ID: `group:Philistine`); मानोह (ID: `person:Manoah`); An Angel (ID: `deity:Angel`); दलीला (ID: `person:Delilah`); Strength (ID: `keyterm:Strength`); इस्राएल (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); सोरा (ID: `place:Zorah`); लही (ID: `place:Lehi`); Nazirites (ID: `group:Nazirite`); Love (ID: `keyterm:Love`); यहूदा (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); तिम्नाह (ID: `place:Timnah`); गाज़ा (ID: `place:Gaza`); यहूदा (ID: `group:Judah`); Defilement (ID: `keyterm:Defilement`); Kid (ID: `fauna:Kid`); Goat (ID: `fauna:Goat`); Lion (ID: `fauna:Lion`); Rope (ID: `realia:Rope`); Manoah's Wife (ID: `person:WifeOfManoah`); एताम (ID: `place:Etam`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); एश्ताओल (ID: `place:Eshtaol`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** मीका (ID: `person:Micah.3`); दान (ID: `place:Dan`); दान (ID: `group:Dan`); यहोवा (ID: `deity:Lord`); House (ID: `realia:House`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); Teraphim (ID: `deity:Teraphim`); Graven Image (ID: `realia:GravenImage`); Molten Image (ID: `realia:MoltenImage`); Household Idols (ID: `realia:HouseholdIdols`); Ephod (ID: `realia:Ephod`); यहूदा (ID: `person:Judah.4`); एप्रैम (ID: `person:Ephraim`); इस्राएल (ID: `person:Israel`); एप्रैम (ID: `group:Ephraim`); यहूदा (ID: `group:Judah`); एश्ताओल (ID: `place:Eshtaol`); Money (ID: `realia:Money`); Trust (ID: `keyterm:LeanOn`); बैतलहम (ID: `place:Bethlehem`); A Person (ID: `person:GenericPerson`); सोरा (ID: `place:Zorah`); Mother of Micah (ID: `person:MotherOfMicah.3`); सीदोन (ID: `place:Sidon`); Dispossess (ID: `keyterm:Dispossess`); Peace (ID: `keyterm:IntactState`); महनेदान (ID: `place:Mahaneh-dan`); योनातान (ID: `person:Jonathan.2`); Military Members (ID: `group:MilitaryMembers`); Beth-rehob (ID: `place:Beth-rehob`); गेर्शोम (ID: `person:Gershom`); To Cause to Possess (ID: `keyterm:Possess`); Safety (ID: `keyterm:Safety`); Sidonians (ID: `group:Sidon`); Holy (ID: `keyterm:Holy`); Bless (ID: `keyterm:Bless`); किर्यत्यारीम (ID: `place:Kiriath-jearim`); To Curse (ID: `keyterm:Curse`); मूसा (ID: `person:Moses`); शीलो (ID: `place:Shiloh`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** इस्राएल (ID: `person:Israel`); बिन्यामीन (ID: `group:Benjamin`); बिन्यामीन (ID: `person:Benjamin`); Gibeah (ID: `place:Gibeah.2`); यहोवा (ID: `deity:Lord`); Jabesh-gilead (ID: `place:Jabesh-gilead`); मिस्पा (ID: `place:Mizpah`); बेतेल (ID: `place:Bethel`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); Foolish (ID: `keyterm:Foolish`); To Cause to Possess (ID: `keyterm:Possess`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); A Father (ID: `person:GenericFather`); Donkey (ID: `fauna:Donkey`); Rock of Rimmon (ID: `place:Rimmon.3`); बैतलहम (ID: `place:Bethlehem`); Swear (ID: `keyterm:Swear`); एप्रैम (ID: `person:Ephraim`); एप्रैम (ID: `group:Ephraim`); शीलो (ID: `place:Shiloh`); यरूशलेम (ID: `place:Jerusalem`); Offering (ID: `keyterm:Offering`); A Man (ID: `person:GenericMale`); Wickedness (ID: `keyterm:Wickedness`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); Peace (ID: `keyterm:IntactState`); Vine (ID: `flora:Vine`)
