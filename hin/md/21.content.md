...
* **Associated ACAI Concepts:** दाऊद (ID: `person:David`); यरूशलेम (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Stupid (ID: `keyterm:Stupid`); To Sin (ID: `keyterm:Sin`); Intention (ID: `keyterm:Intention`); Love (ID: `keyterm:Love`); Fear (ID: `keyterm:Fear`); यरूशलेम (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); Glory (ID: `keyterm:Glory`); Oath (ID: `keyterm:Oath`); Strength (ID: `keyterm:Strength`); Passion (ID: `keyterm:Ardour`); Favor (ID: `keyterm:Favor`); A Man (ID: `person:GenericMale`); Vow (ID: `keyterm:Vow`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); Anointing Oil (ID: `realia:AnointingOil`); नरक (ID: `place:Hell`); To Cause to Possess (ID: `keyterm:Possess`); Swear (ID: `keyterm:Swear`); Stupidity (ID: `keyterm:Stupidity`); Slaughtering (ID: `keyterm:Slaughtering`); To Act Wickedly (ID: `keyterm:ActWickedly`); Peace (ID: `keyterm:IntactState`); Pure (ID: `keyterm:Pure`); Safety (ID: `keyterm:Safety`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); House (ID: `realia:House`); Truth (ID: `keyterm:Truth`); Intention (ID: `keyterm:Intention`); Straightness (ID: `keyterm:Straightness`); Proverb (ID: `keyterm:Saying`); Goad (ID: `realia:Goad`); Caper (ID: `flora:Caper`); Bird (ID: `fauna:Bird`); Money (ID: `realia:Money`); Scroll (ID: `realia:Scroll`); Pit (ID: `realia:Pit`); Rope (ID: `realia:Rope`); Goat (ID: `fauna:Goat`); Locust (ID: `fauna:Locust`); Sheep (ID: `fauna:Lamb`); Clay Jar (ID: `realia:ClayJar`); Nail (ID: `realia:Nail`); Almond (ID: `flora:Almond`); Flock (ID: `fauna:Flock`)
