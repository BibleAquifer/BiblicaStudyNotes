...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Stupid (ID: `keyterm:Stupid`); To Sin (ID: `keyterm:Sin`); Intention (ID: `keyterm:Intention`); Love (ID: `keyterm:Love`); Fear (ID: `keyterm:Fear`); यरूशलेम (ID: `place:Jerusalem`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); Glory (ID: `keyterm:Glory`); Strength (ID: `keyterm:Strength`); A Man (ID: `person:GenericMale`); Favor (ID: `keyterm:Favor`); Oath (ID: `keyterm:Oath`); Vow (ID: `keyterm:Vow`); Passion (ID: `keyterm:Ardour`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); To Cause to Possess (ID: `keyterm:Possess`); Pure (ID: `keyterm:Pure`); नरक (ID: `place:Hell`); Safety (ID: `keyterm:Safety`); To Act Wickedly (ID: `keyterm:ActWickedly`); Holy (ID: `keyterm:Holy`); An Angel (ID: `deity:Angel`); Swear (ID: `keyterm:Swear`); Force to Serve (ID: `keyterm:EnticedToServe`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); House (ID: `realia:House`); Truth (ID: `keyterm:Truth`); Straightness (ID: `keyterm:Straightness`); Proverb (ID: `keyterm:Saying`); Intention (ID: `keyterm:Intention`); Caper (ID: `flora:Caper`); Goad (ID: `realia:Goad`); Sheep (ID: `fauna:Lamb`); Clay Jar (ID: `realia:ClayJar`); Locust (ID: `fauna:Locust`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Pit (ID: `realia:Pit`); Money (ID: `realia:Money`); Almond (ID: `flora:Almond`); Nail (ID: `realia:Nail`); Scroll (ID: `realia:Scroll`); Bird (ID: `fauna:Bird`); Rope (ID: `realia:Rope`)
