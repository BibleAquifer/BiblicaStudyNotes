...
* **Associated ACAI Concepts:** क्षयर्ष (ID: `person:Ahasuerus`); वशती (ID: `person:Vashti`); एस्तेर (ID: `person:Esther`); मोर्दकै (ID: `person:Mordecai.2`); शूशन (ID: `place:Susa`); House (ID: `realia:House`); फारस (ID: `place:Persia`); हेगे (ID: `person:Hegai`); ममूकान (ID: `person:Memucan`); मादियों (ID: `place:Media`); Kindness (ID: `keyterm:Kindness`); Favor (ID: `keyterm:Favor`); भारत (ID: `place:India`); महूमान (ID: `person:Mehuman`); याईर (ID: `person:Jair.4`); शेतार (ID: `person:Shethar`); शिमी (ID: `person:Shimei.18`); कर्कस (ID: `person:Carkas`); बिगता (ID: `person:Bigtha`); बिजता (ID: `person:Biztha`); अदमाता (ID: `person:Admatha`); कर्शना (ID: `person:Carshena`); हर्बोना (ID: `person:Harbona`); अबगता (ID: `person:Abagtha`); Crown (ID: `realia:Crown`); अबीहैल (ID: `person:Abihail.5`); जेतेर (ID: `person:Zethar`); बिगताना (ID: `person:Bigthan`); कीश (ID: `person:Kish.4`); मर्सना (ID: `person:Marsena`); शाशगज (ID: `person:Shaashgaz`); मेरेस (ID: `person:Meres`); तेरेश (ID: `person:Teresh`); Jews (ID: `group:Jews`); Love (ID: `keyterm:Love`); यरूशलेम (ID: `place:Jerusalem`); मादियों (ID: `person:Medan`); यहूदा (ID: `person:Judah.4`); बिन्यामीन (ID: `group:Benjamin`); फारसी (ID: `group:Persia`); Glory (ID: `keyterm:Glory`); यहोयाकीन (ID: `person:Jehoiachin`); यहूदा (ID: `group:Judah`); Peace (ID: `keyterm:IntactState`); तर्शीश (ID: `place:Tarshish`); Delight (ID: `keyterm:Delight`); नबूकदनेस्सर (ID: `person:Nebuchadnezzar`); बेबीलोन (ID: `place:Babylon`); Scroll (ID: `realia:Scroll`); Wine (ID: `realia:Wine`); कूश (ID: `place:Ethiopia`); Vine (ID: `flora:Vine`); Appoint (ID: `keyterm:Appoint`); बिन्यामीन (ID: `person:Benjamin`); मादी (ID: `group:Mede`); Cotton (ID: `flora:Cotton`); Balsam Tree (ID: `flora:BalsamTree`); Doorstep (ID: `realia:Doorstep`); Purple Cloth (ID: `realia:PurpleCloth`); Rope (ID: `realia:Rope`); Linen (ID: `realia:Linen`); Olive Oil (ID: `realia:OliveOil`); Myrrh (ID: `flora:Myrrh`); Anointing Oil (ID: `realia:AnointingOil`); Money (ID: `realia:Money`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** हामान (ID: `person:Haman`); क्षयर्ष (ID: `person:Ahasuerus`); मोर्दकै (ID: `person:Mordecai.2`); Jews (ID: `group:Jews`); अगागी (ID: `group:Agag`); हम्मदाता (ID: `person:Hammedatha`); अगाग (ID: `person:Agag.2`); Money (ID: `realia:Money`); Lot (ID: `keyterm:Lot`); Servants (ID: `group:GenericServants`); शूशन (ID: `place:Susa`); Scroll (ID: `realia:Scroll`); Lot (ID: `realia:Lot`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** मोर्दकै (ID: `person:Mordecai.2`); एस्तेर (ID: `person:Esther`); Jews (ID: `group:Jews`); हताक (ID: `person:Hathach`); Sackcloth (ID: `realia:Sackcloth`); शूशन (ID: `place:Susa`); हामान (ID: `person:Haman`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** हामान (ID: `person:Haman`); एस्तेर (ID: `person:Esther`); मोर्दकै (ID: `person:Mordecai.2`); House (ID: `realia:House`); Jews (ID: `group:Jews`); जेरेश (ID: `person:Zeresh`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Horse (ID: `fauna:Horse`); Love (ID: `keyterm:Love`); क्षयर्ष (ID: `person:Ahasuerus`); Favor (ID: `keyterm:Favor`); A Group of People (ID: `group:GenericGroup`); Servants (ID: `group:GenericServants`); हर्बोना (ID: `person:Harbona.2`); बिगताना (ID: `person:Bigthan`); तेरेश (ID: `person:Teresh`); Cubit (ID: `realia:Cubit`); Glory (ID: `keyterm:Glory`); Doorstep (ID: `realia:Doorstep`); Throne (ID: `realia:Throne`); Crown (ID: `realia:Crown`); Scroll (ID: `realia:Scroll`); Bed (ID: `realia:Bed`)
