...
* **Associated ACAI Concepts:** क्षयर्ष (ID: `person:Ahasuerus`); वशती (ID: `person:Vashti`); एस्तेर (ID: `person:Esther`); मोर्दकै (ID: `person:Mordecai.2`); शूशन (ID: `place:Susa`); House (ID: `realia:House`); फारस (ID: `place:Persia`); हेगे (ID: `person:Hegai`); ममूकान (ID: `person:Memucan`); मादियों (ID: `place:Media`); Favor (ID: `keyterm:Favor`); Kindness (ID: `keyterm:Kindness`); शिमी (ID: `person:Shimei.18`); भारत (ID: `place:India`); बिगताना (ID: `person:Bigthan`); जेतेर (ID: `person:Zethar`); शाशगज (ID: `person:Shaashgaz`); Crown (ID: `realia:Crown`); अदमाता (ID: `person:Admatha`); मेरेस (ID: `person:Meres`); महूमान (ID: `person:Mehuman`); हर्बोना (ID: `person:Harbona`); बिगता (ID: `person:Bigtha`); बिजता (ID: `person:Biztha`); तेरेश (ID: `person:Teresh`); कर्कस (ID: `person:Carkas`); अबगता (ID: `person:Abagtha`); मर्सना (ID: `person:Marsena`); कीश (ID: `person:Kish.4`); याईर (ID: `person:Jair.4`); कर्शना (ID: `person:Carshena`); शेतार (ID: `person:Shethar`); अबीहैल (ID: `person:Abihail.5`); Glory (ID: `keyterm:Glory`); यरूशलेम (ID: `place:Jerusalem`); Delight (ID: `keyterm:Delight`); Love (ID: `keyterm:Love`); बेबीलोन (ID: `place:Babylon`); यहोयाकीन (ID: `person:Jehoiachin`); बिन्यामीन (ID: `person:Benjamin`); फारसी (ID: `group:Persia`); तर्शीश (ID: `place:Tarshish`); यहूदा (ID: `person:Judah.4`); मादियों (ID: `person:Medan`); यहूदा (ID: `group:Judah`); नबूकदनेस्सर (ID: `person:Nebuchadnezzar`); Vine (ID: `flora:Vine`); मादी (ID: `group:Mede`); बिन्यामीन (ID: `group:Benjamin`); Jews (ID: `group:Jews`); कूश (ID: `place:Ethiopia`); Scroll (ID: `realia:Scroll`); Appoint (ID: `keyterm:Appoint`); Wine (ID: `realia:Wine`); Peace (ID: `keyterm:IntactState`); Balsam Tree (ID: `flora:BalsamTree`); Cotton (ID: `flora:Cotton`); Purple Cloth (ID: `realia:PurpleCloth`); Linen (ID: `realia:Linen`); Doorstep (ID: `realia:Doorstep`); Myrrh (ID: `flora:Myrrh`); Money (ID: `realia:Money`); Bed (ID: `realia:Bed`); Anointing Oil (ID: `realia:AnointingOil`); Rope (ID: `realia:Rope`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** हामान (ID: `person:Haman`); मोर्दकै (ID: `person:Mordecai.2`); क्षयर्ष (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); अगागी (ID: `group:Agag`); हम्मदाता (ID: `person:Hammedatha`); अगाग (ID: `person:Agag.2`); Money (ID: `realia:Money`); Servants (ID: `group:GenericServants`); शूशन (ID: `place:Susa`); Lot (ID: `keyterm:Lot`); Scroll (ID: `realia:Scroll`); Lot (ID: `realia:Lot`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** मोर्दकै (ID: `person:Mordecai.2`); एस्तेर (ID: `person:Esther`); Jews (ID: `group:Jews`); हताक (ID: `person:Hathach`); Sackcloth (ID: `realia:Sackcloth`); शूशन (ID: `place:Susa`); To Beg for Mercy (ID: `keyterm:BegForMercy`); हामान (ID: `person:Haman`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** हामान (ID: `person:Haman`); एस्तेर (ID: `person:Esther`); मोर्दकै (ID: `person:Mordecai.2`); House (ID: `realia:House`); Jews (ID: `group:Jews`); जेरेश (ID: `person:Zeresh`); Horse (ID: `fauna:Horse`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Love (ID: `keyterm:Love`); क्षयर्ष (ID: `person:Ahasuerus`); Favor (ID: `keyterm:Favor`); Servants (ID: `group:GenericServants`); A Group of People (ID: `group:GenericGroup`); बिगताना (ID: `person:Bigthan`); तेरेश (ID: `person:Teresh`); हर्बोना (ID: `person:Harbona.2`); Cubit (ID: `realia:Cubit`); Glory (ID: `keyterm:Glory`); Throne (ID: `realia:Throne`); Crown (ID: `realia:Crown`); Doorstep (ID: `realia:Doorstep`); Bed (ID: `realia:Bed`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); मोर्दकै (ID: `person:Mordecai.2`); शूशन (ID: `place:Susa`); क्षयर्ष (ID: `person:Ahasuerus`); हामान (ID: `person:Haman`); एस्तेर (ID: `person:Esther`); Scroll (ID: `realia:Scroll`); हम्मदाता (ID: `person:Hammedatha`); अगागी (ID: `group:Agag`); अगाग (ID: `person:Agag.2`); Peace (ID: `keyterm:IntactState`); भारत (ID: `place:India`); वैजाता (ID: `person:Vaizatha`); अस्पाता (ID: `person:Aspatha`); अरीसै (ID: `person:Arisai`); दल्पोन (ID: `person:Dalphon`); पोराता (ID: `person:Poratha`); अदल्या (ID: `person:Adalia`); पर्मशता (ID: `person:Parmashta`); पर्शन्दाता (ID: `person:Parshandatha`); अरीदै (ID: `person:Aridai`); अरीदाता (ID: `person:Aridatha`); अबीहैल (ID: `person:Abihail.5`); मादियों (ID: `place:Media`); Delight (ID: `keyterm:Delight`); Truth (ID: `keyterm:Truth`); Lot (ID: `keyterm:Lot`); Favor (ID: `keyterm:Favor`); फारस (ID: `place:Persia`); कूश (ID: `place:Ethiopia`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Horse (ID: `fauna:Horse`); Lot (ID: `realia:Lot`); Purple Cloth (ID: `realia:PurpleCloth`); Crown (ID: `realia:Crown`); Linen (ID: `realia:Linen`); House (ID: `realia:House`)
