...
* **Associated ACAI Concepts:** क्षयर्ष (ID: `person:Ahasuerus`); वशती (ID: `person:Vashti`); एस्तेर (ID: `person:Esther`); मोर्दकै (ID: `person:Mordecai.2`); शूशन (ID: `place:Susa`); House (ID: `realia:House`); फारस (ID: `place:Persia`); हेगे (ID: `person:Hegai`); ममूकान (ID: `person:Memucan`); मादियों (ID: `place:Media`); Kindness (ID: `keyterm:Kindness`); Favor (ID: `keyterm:Favor`); भारत (ID: `place:India`); कर्कस (ID: `person:Carkas`); कर्शना (ID: `person:Carshena`); अदमाता (ID: `person:Admatha`); तेरेश (ID: `person:Teresh`); मेरेस (ID: `person:Meres`); जेतेर (ID: `person:Zethar`); शेतार (ID: `person:Shethar`); हर्बोना (ID: `person:Harbona`); याईर (ID: `person:Jair.4`); कीश (ID: `person:Kish.4`); अबगता (ID: `person:Abagtha`); शाशगज (ID: `person:Shaashgaz`); शिमी (ID: `person:Shimei.18`); Crown (ID: `realia:Crown`); बिगता (ID: `person:Bigtha`); अबीहैल (ID: `person:Abihail.5`); बिजता (ID: `person:Biztha`); महूमान (ID: `person:Mehuman`); बिगताना (ID: `person:Bigthan`); मर्सना (ID: `person:Marsena`); मादी (ID: `group:Mede`); बिन्यामीन (ID: `person:Benjamin`); बेबीलोन (ID: `place:Babylon`); Wine (ID: `realia:Wine`); कूश (ID: `place:Ethiopia`); Scroll (ID: `realia:Scroll`); मादियों (ID: `person:Medan`); फारसी (ID: `group:Persia`); Delight (ID: `keyterm:Delight`); यहूदा (ID: `group:Judah`); यरूशलेम (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); यहोयाकीन (ID: `person:Jehoiachin`); Appoint (ID: `keyterm:Appoint`); Peace (ID: `keyterm:IntactState`); यहूदा (ID: `person:Judah.4`); नबूकदनेस्सर (ID: `person:Nebuchadnezzar`); Jews (ID: `group:Jews`); बिन्यामीन (ID: `group:Benjamin`); तर्शीश (ID: `place:Tarshish`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Cotton (ID: `flora:Cotton`); Balsam Tree (ID: `flora:BalsamTree`); Olive Oil (ID: `realia:OliveOil`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`); Linen (ID: `realia:Linen`); Myrrh (ID: `flora:Myrrh`); Rope (ID: `realia:Rope`); Anointing Oil (ID: `realia:AnointingOil`); Bed (ID: `realia:Bed`); Doorstep (ID: `realia:Doorstep`)
...
* **Associated ACAI Concepts:** हामान (ID: `person:Haman`); मोर्दकै (ID: `person:Mordecai.2`); क्षयर्ष (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); अगागी (ID: `group:Agag`); हम्मदाता (ID: `person:Hammedatha`); अगाग (ID: `person:Agag.2`); Money (ID: `realia:Money`); Servants (ID: `group:GenericServants`); Lot (ID: `keyterm:Lot`); शूशन (ID: `place:Susa`); Talent (ID: `realia:Talent`); Lot (ID: `realia:Lot`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** मोर्दकै (ID: `person:Mordecai.2`); एस्तेर (ID: `person:Esther`); Jews (ID: `group:Jews`); हताक (ID: `person:Hathach`); Sackcloth (ID: `realia:Sackcloth`); शूशन (ID: `place:Susa`); हामान (ID: `person:Haman`); To Beg for Mercy (ID: `keyterm:BegForMercy`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); मोर्दकै (ID: `person:Mordecai.2`); शूशन (ID: `place:Susa`); हामान (ID: `person:Haman`); एस्तेर (ID: `person:Esther`); क्षयर्ष (ID: `person:Ahasuerus`); Scroll (ID: `realia:Scroll`); हम्मदाता (ID: `person:Hammedatha`); अगाग (ID: `person:Agag.2`); अगागी (ID: `group:Agag`); Peace (ID: `keyterm:IntactState`); भारत (ID: `place:India`); अरीदै (ID: `person:Aridai`); अस्पाता (ID: `person:Aspatha`); अरीसै (ID: `person:Arisai`); वैजाता (ID: `person:Vaizatha`); पोराता (ID: `person:Poratha`); अरीदाता (ID: `person:Aridatha`); दल्पोन (ID: `person:Dalphon`); पर्शन्दाता (ID: `person:Parshandatha`); पर्मशता (ID: `person:Parmashta`); अदल्या (ID: `person:Adalia`); अबीहैल (ID: `person:Abihail.5`); To Beg for Mercy (ID: `keyterm:BegForMercy`); कूश (ID: `place:Ethiopia`); मादियों (ID: `place:Media`); Delight (ID: `keyterm:Delight`); फारस (ID: `place:Persia`); Favor (ID: `keyterm:Favor`); Truth (ID: `keyterm:Truth`); Lot (ID: `keyterm:Lot`); Lot (ID: `realia:Lot`); Horse (ID: `fauna:Horse`); Purple Cloth (ID: `realia:PurpleCloth`); House (ID: `realia:House`); Linen (ID: `realia:Linen`); Crown (ID: `realia:Crown`)
