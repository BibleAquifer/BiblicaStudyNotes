...
* **Associated ACAI Concepts:** यूहन्ना (ID: `person:John`); यीशु (ID: `person:Jesus.2`); Baptism (ID: `keyterm:Baptism`); Good News (ID: `keyterm:GoodNews`); Proclaim (ID: `keyterm:Proclaim`); यहोवा (ID: `deity:Lord`); पवित्र आत्मा (ID: `deity:HolySpirit`); यरदन (ID: `place:Jordan`); जब्दी (ID: `person:Zebedee`); गलील (ID: `place:Galilee`); An Angel (ID: `deity:Angel`); To Sin (ID: `keyterm:Sin`); Repent (ID: `keyterm:Repent`); Sky (ID: `keyterm:Heaven`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Casting Net (ID: `realia:CastingNet`); याकूब (ID: `person:James`); Hired Worker (ID: `keyterm:HiredWorker`); Sea of Galilee (ID: `place:GalileeSea`); यरूशलेम (ID: `place:Jerusalem`); Kingdom (ID: `keyterm:Kingdom`); Beloved (ID: `keyterm:Beloved`); Straightness (ID: `keyterm:Straightness`); पतरस (ID: `person:Peter`); Put to the Test (ID: `keyterm:PutToTheTest`); यशायाह (ID: `person:Isaiah`); यहूदिया (ID: `place:Judea`); Believe (ID: `keyterm:Believe`); शैतान (ID: `deity:Satan`); नासरत (ID: `place:Nazareth`); अन्द्रियास (ID: `person:Andrew`); Serve (ID: `keyterm:Serve`); Forgive (ID: `keyterm:Forgive`); यूहन्ना (ID: `person:John.2`); Strap (ID: `realia:Strap`); Bag (ID: `realia:Bag`); Camel (ID: `fauna:Camel`); Belt (ID: `realia:Belt`); Locust (ID: `fauna:Locust`); Bee (ID: `fauna:Bee`); Dove (ID: `fauna:Dove`); Leather (ID: `realia:Leather`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** To Cleanse (ID: `keyterm:Cleanse.2`); Synagogue (ID: `realia:Synagogue`); Proclaim (ID: `keyterm:Proclaim`); पतरस (ID: `person:Peter`); गलील (ID: `place:Galilee`); Ability (ID: `keyterm:Ability`); यीशु (ID: `person:Jesus.2`); Authority (ID: `keyterm:Authority.2`); Serve (ID: `keyterm:Serve`); Demons (ID: `deity:Demons`); कफरनहूम (ID: `place:Capernaum`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Sabbath (ID: `keyterm:Sabbath`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); यहोवा (ID: `deity:Lord`); Pray (ID: `keyterm:Pray`); To Command (ID: `keyterm:Command`); नासरत (ID: `place:Nazareth`); अन्द्रियास (ID: `person:Andrew`); Ask for (ID: `keyterm:AskFor`); मूसा (ID: `person:Moses`); याकूब (ID: `person:James`); यूहन्ना (ID: `person:John.2`); Bear Witness (ID: `keyterm:BearWitness`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); To Sin (ID: `keyterm:Sin`); Forgive (ID: `keyterm:Forgive`); Bed (ID: `realia:Bed`); Abstain from Food (ID: `keyterm:Fast`); Be a Disciple (ID: `keyterm:Disciple`); House (ID: `realia:House`); Tax Collector (ID: `keyterm:TaxCollector`); Heart (ID: `keyterm:Heart`); यहोवा (ID: `deity:Lord`); फरीसी (ID: `group:Pharisee`); Temple (ID: `realia:Temple`); हलफईस (ID: `person:Alphaeus.2`); कफरनहूम (ID: `place:Capernaum`); मत्ती (ID: `person:Matthew`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Authority (ID: `keyterm:Authority.2`); यूहन्ना (ID: `person:John`); Believe (ID: `keyterm:Believe`); Be Healthy (ID: `keyterm:Healthy`); Tax Office (ID: `keyterm:TaxOffice`); Spirit (ID: `keyterm:Spirit.2`); Religious Officials (ID: `group:ReligiousOfficials`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Housetop (ID: `realia:Housetop`); Patch (ID: `realia:Patch`); Skin-Bottle (ID: `realia:Skin-bottle`); Clothing (ID: `realia:Clothing`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Sabbath (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); फरीसी (ID: `group:Pharisee`); एब्यातार (ID: `person:Abiathar`); हेरोदियों (ID: `group:Herodian`); Be a Disciple (ID: `keyterm:Disciple`); Salvation (ID: `keyterm:Salvation`); Life (ID: `keyterm:Life`); यहोवा (ID: `deity:Lord`); Serve (ID: `keyterm:Serve`); Heart (ID: `keyterm:Heart`); दाऊद (ID: `person:David`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Synagogue (ID: `realia:Synagogue`); Grain (ID: `flora:Grain`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); Be a Disciple (ID: `keyterm:Disciple`); बरतुल्मै (ID: `person:Bartholomew`); इदूमिया (ID: `place:Idumea`); हलफईस (ID: `person:Alphaeus`); जेलोतेस (ID: `group:Zealot`); याकूब (ID: `person:James`); यूहन्ना (ID: `person:John.2`); याकूब (ID: `person:James.2`); यरूशलेम (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); जब्दी (ID: `person:Zebedee`); Proclaim (ID: `keyterm:Proclaim`); यीशु (ID: `person:Jesus.2`); सोर (ID: `place:Tyre`); गलील (ID: `place:Galilee`); सीदोन (ID: `place:Sidon`); यहूदा (ID: `person:Judas.2`); पतरस (ID: `person:Peter`); Authority (ID: `keyterm:Authority.2`); फिलिप्पुस (ID: `person:Philip`); यहूदिया (ID: `place:Judea`); To Command (ID: `keyterm:Command`); थोमा (ID: `person:Thomas`); अन्द्रियास (ID: `person:Andrew`); Serve (ID: `keyterm:Serve`); शमौन (ID: `person:Simon.2`); यहूदा (ID: `person:Judas`); Demons (ID: `deity:Demons`); मत्ती (ID: `person:Matthew`); यरदन (ID: `place:Jordan`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** शैतान (ID: `deity:Satan`); Blaspheme (ID: `keyterm:Blaspheme`); To Sin (ID: `keyterm:Sin`); Forgive (ID: `keyterm:Forgive`); House (ID: `realia:House`); यरूशलेम (ID: `place:Jerusalem`); Kingdom (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); Surely! (ID: `keyterm:Surely`); Religious Officials (ID: `group:ReligiousOfficials`); Always (ID: `keyterm:Always`); यहोवा (ID: `deity:Lord`); पवित्र आत्मा (ID: `deity:HolySpirit`); Parable (ID: `keyterm:Parable`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Ask for (ID: `keyterm:AskFor`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); Ship (ID: `realia:Ship`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); Grave (ID: `realia:Grave`); यहोवा (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Chain (ID: `realia:Chain`); To Command (ID: `keyterm:Command`); दिकापुलिस (ID: `place:Decapolis`); गिरासा (ID: `place:Gerasa`); सेना (ID: `deity:Legion`); Proclaim (ID: `keyterm:Proclaim`); Name (ID: `keyterm:Name`); Authority (ID: `keyterm:Authority.2`); Bow Down (ID: `keyterm:BowDown`); Mercy (ID: `keyterm:Mercy`); Believe (ID: `keyterm:Believe`); Become Still (ID: `keyterm:BecomeStill`); Fetter (ID: `realia:Fetter`); Cushion (ID: `realia:Cushion`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Salvation (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`); Fear (ID: `keyterm:Fear`); Believe (ID: `keyterm:Believe`); याईर (ID: `person:Jairus`); Ability (ID: `keyterm:Ability`); Blood (ID: `keyterm:Blood`); Body (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); Truth (ID: `keyterm:Truth`); Name (ID: `keyterm:Name`); पतरस (ID: `person:Peter`); Ask for (ID: `keyterm:AskFor`); याकूब (ID: `person:James`); Be a Disciple (ID: `keyterm:Disciple`); Make Peace (ID: `keyterm:Peace`); A Group of Disciples (ID: `group:GenericDisciples`); यूहन्ना (ID: `person:John.2`); Temple (ID: `realia:Temple`); Ship (ID: `realia:Ship`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Serve (ID: `keyterm:Serve`); Disbelieve (ID: `keyterm:Disbelieve`); यहूदा (ID: `person:Jude`); शमौन (ID: `person:Simon.3`); यूसुफ (ID: `person:Joseph.3`); Proclaim (ID: `keyterm:Proclaim`); याकूब (ID: `person:James.3`); यीशु (ID: `person:Jesus.2`); Sabbath (ID: `keyterm:Sabbath`); Anointed (ID: `keyterm:Anointed`); Repent (ID: `keyterm:Repent`); Authority (ID: `keyterm:Authority.2`); मरियम (ID: `person:Mary`); Be a Disciple (ID: `keyterm:Disciple`); Demons (ID: `deity:Demons`); Bear Witness (ID: `keyterm:BearWitness`); Bag (ID: `realia:Bag`); Synagogue (ID: `realia:Synagogue`); Belt (ID: `realia:Belt`); Tunic (ID: `realia:Tunic.2`); House (ID: `realia:House`); Staff (ID: `realia:Staff`); Sandal (ID: `realia:Sandal`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); गन्नेसरत (ID: `place:Gennesaret`); बैतसैदा (ID: `place:Bethsaida`); Be a Disciple (ID: `keyterm:Disciple`); Fear (ID: `keyterm:Fear`); Ask for (ID: `keyterm:AskFor`); Heart (ID: `keyterm:Heart`); Cheer Up (ID: `keyterm:CheerUp`); Salvation (ID: `keyterm:Salvation`); Pray (ID: `keyterm:Pray`); Bed (ID: `realia:Bed`); Tassel (ID: `realia:Tassel`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Defilement (ID: `keyterm:Defilement`); Teaching (ID: `keyterm:Teaching`); फरीसी (ID: `group:Pharisee`); Heart (ID: `keyterm:Heart`); यहोवा (ID: `deity:Lord`); Be a Disciple (ID: `keyterm:Disciple`); Commandment (ID: `keyterm:Commandment`); Temple Treasury (ID: `place:Corban`); यरूशलेम (ID: `place:Jerusalem`); Speak as a Prophet (ID: `keyterm:Speak`); Fornication (ID: `keyterm:Fornication`); Live (ID: `keyterm:Live.3`); Offering (ID: `keyterm:Offering`); Parable (ID: `keyterm:Parable`); यशायाह (ID: `person:Isaiah`); To Cleanse (ID: `keyterm:Cleanse.2`); Blaspheme (ID: `keyterm:Blaspheme`); Baptism (ID: `keyterm:Baptism`); Jews (ID: `group:Jews`); मूसा (ID: `person:Moses`); Religious Officials (ID: `group:ReligiousOfficials`); Worship (ID: `keyterm:Worship`); Cooking Pot (ID: `realia:CookingPot`); House (ID: `realia:House`); Bed (ID: `realia:Bed`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); सोर (ID: `place:Tyre`); Ask for (ID: `keyterm:AskFor`); House (ID: `realia:House`); Dog (ID: `fauna:Dog`); फीनीके (ID: `place:Phoenicia`); सीदोन (ID: `place:Sidon`); दिकापुलिस (ID: `place:Decapolis`); सुरूफ‍िनीकी (ID: `group:Phoenicia`); यूनानी (ID: `group:Greek`); Sky (ID: `keyterm:Heaven`); Proclaim (ID: `keyterm:Proclaim`); यावान (ID: `person:Javan`); Honest (ID: `keyterm:Honest`); Sea of Galilee (ID: `place:GalileeSea`); Temple (ID: `realia:Temple`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); Basket (ID: `realia:Basket`); Symbol (ID: `keyterm:Example`); A Group of Disciples (ID: `group:GenericDisciples`); फरीसी (ID: `group:Pharisee`); Ship (ID: `realia:Ship`); Sky (ID: `keyterm:Heaven`); Herod Antipas (ID: `person:Herod.2`); Bless (ID: `keyterm:Bless`); Spirit (ID: `keyterm:Spirit.2`); Surely! (ID: `keyterm:Surely`); Ask for (ID: `keyterm:AskFor`); Heart (ID: `keyterm:Heart`); मगदन (ID: `place:Magadan`); Affection (ID: `keyterm:Affection`); House (ID: `realia:House`); Fish (ID: `fauna:Fish`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Caesarea Philippi (ID: `place:CaesareaPhilippi`); Baptist (ID: `keyterm:Baptist`); बैतसैदा (ID: `place:Bethsaida`); Be a Disciple (ID: `keyterm:Disciple`); To Command (ID: `keyterm:Command`); एलिय्याह (ID: `person:Elijah`); पतरस (ID: `person:Peter`); Ask for (ID: `keyterm:AskFor`); यूहन्ना (ID: `person:John`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Life (ID: `keyterm:Life`); यहोवा (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); To Command (ID: `keyterm:Command`); पतरस (ID: `person:Peter`); Be a Disciple (ID: `keyterm:Disciple`); Kingdom (ID: `keyterm:Kingdom`); Reject (ID: `keyterm:Reject`); Glory (ID: `keyterm:Glory`); Be Unfaithful (ID: `keyterm:Unfaithful`); Holy (ID: `keyterm:Holy`); An Angel (ID: `deity:Angel`); Good News (ID: `keyterm:GoodNews`); Surely! (ID: `keyterm:Surely`); शैतान (ID: `deity:Satan`); Think (ID: `keyterm:Think`); Salvation (ID: `keyterm:Salvation`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** एलिय्याह (ID: `person:Elijah`); यीशु (ID: `person:Jesus.2`); पतरस (ID: `person:Peter`); मूसा (ID: `person:Moses`); Beloved (ID: `keyterm:Beloved`); यूहन्ना (ID: `person:John.2`); याकूब (ID: `person:James`); Clothing (ID: `realia:Clothing`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); A Father (ID: `person:GenericFather`); यीशु (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`); Be Unfaithful (ID: `keyterm:Unfaithful`); To Command (ID: `keyterm:Command`); Disbelieve (ID: `keyterm:Disbelieve`); A Group of Disciples (ID: `group:GenericDisciples`); A Group of People (ID: `group:GenericGroup`); Affection (ID: `keyterm:Affection`); Pray (ID: `keyterm:Pray`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); Name (ID: `keyterm:Name`); Word (ID: `keyterm:Word`); Fear (ID: `keyterm:Fear`); कफरनहूम (ID: `place:Capernaum`); गलील (ID: `place:Galilee`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Cause to Stumble (ID: `keyterm:CauseToStumble`); नरक (ID: `place:Hell`); Name (ID: `keyterm:Name`); Gehenna (ID: `keyterm:Gehenna`); यीशु (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Kingdom (ID: `keyterm:Kingdom`); Ability (ID: `keyterm:Ability`); Demons (ID: `deity:Demons`); Surely! (ID: `keyterm:Surely`); Believe (ID: `keyterm:Believe`); यूहन्ना (ID: `person:John.2`); यहोवा (ID: `deity:Lord`); Be at Peace (ID: `keyterm:AtPeace`); Worm (ID: `fauna:Maggot`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Kingdom (ID: `keyterm:Kingdom`); Be a Disciple (ID: `keyterm:Disciple`); To Command (ID: `keyterm:Command`); यीशु (ID: `person:Jesus.2`); Fornication (ID: `keyterm:Fornication`); मूसा (ID: `person:Moses`); यहूदिया (ID: `place:Judea`); Hardheartedness (ID: `keyterm:Hardheartedness`); Bless (ID: `keyterm:Bless`); Body (ID: `keyterm:Body.3`); Surely! (ID: `keyterm:Surely`); Be Lawful (ID: `keyterm:Lawful`); Commandment (ID: `keyterm:Commandment`); यरदन (ID: `place:Jordan`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); याकूब (ID: `person:James`); यरूशलेम (ID: `place:Jerusalem`); अन्यजाति (ID: `group:Gentile`); Baptism (ID: `keyterm:Baptism`); यूहन्ना (ID: `person:John.2`); Glory (ID: `keyterm:Glory`); जब्दी (ID: `person:Zebedee`); Ransom (ID: `keyterm:Ransom`); Fear (ID: `keyterm:Fear`); Condemn (ID: `keyterm:Condemn`); Authority (ID: `keyterm:Authority.2`); Life (ID: `keyterm:Life`); Serve (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); A Group of People (ID: `group:GenericGroup`); दाऊद (ID: `person:David`); Mercy (ID: `keyterm:Mercy`); तिमाई (ID: `person:Timaeus`); बरतिमाई (ID: `person:Bartimaeus`); Be a Disciple (ID: `keyterm:Disciple`); To Command (ID: `keyterm:Command`); यरीहो (ID: `place:Jericho`); Believe (ID: `keyterm:Believe`); Cheer Up (ID: `keyterm:CheerUp`); Salvation (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Donkey (ID: `fauna:Donkey`); यीशु (ID: `person:Jesus.2`); यरूशलेम (ID: `place:Jerusalem`); बैतनिय्याह (ID: `place:Bethany`); Hosanna (ID: `keyterm:Hosanna`); Bless (ID: `keyterm:Bless`); A Group of People (ID: `group:GenericGroup`); Cloak (ID: `realia:Cloak`); बैतफगे (ID: `place:Bethphage`); Kingdom (ID: `keyterm:Kingdom`); Be a Disciple (ID: `keyterm:Disciple`); Name (ID: `keyterm:Name`); Height (ID: `keyterm:Height`); यहोवा (ID: `deity:Lord`); दाऊद (ID: `person:David`); Rush (ID: `flora:Rush`); Olive Tree (ID: `flora:OliveTree`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); तिबिरियुस (ID: `person:Tiberius`); Resurrection (ID: `keyterm:Resurrection`); यीशु (ID: `person:Jesus.2`); मूसा (ID: `person:Moses`); हेरोदियों (ID: `group:Herodian`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); Truth (ID: `keyterm:Truth`); Be Lawful (ID: `keyterm:Lawful`); An Angel (ID: `deity:Angel`); The Way (ID: `keyterm:TheWay`); True (ID: `keyterm:True`); सदूकी (ID: `group:Sadducee`); अब्राहम (ID: `person:Abraham`); Sky (ID: `keyterm:Heaven`); Poll Tax (ID: `keyterm:PollTax`); Written (ID: `keyterm:Scripture`); इस्राएल (ID: `person:Israel`); Hypocrisy (ID: `keyterm:Hypocrisy`); फरीसी (ID: `group:Pharisee`); इसहाक (ID: `person:Isaac`); Denarius (ID: `realia:Denarius`); Boxthorn (ID: `flora:Boxthorn`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Love (ID: `keyterm:Love`); यीशु (ID: `person:Jesus.2`); दाऊद (ID: `person:David`); Heart (ID: `keyterm:Heart`); Commandment (ID: `keyterm:Commandment`); A Priest (ID: `person:GenericPriest`); A Scribe (ID: `person:Scribe`); Treasury (ID: `realia:Treasury`); Mind (ID: `keyterm:Mind.2`); Surely! (ID: `keyterm:Surely`); Truth (ID: `keyterm:Truth`); Kingdom (ID: `keyterm:Kingdom`); Offering (ID: `keyterm:Offering`); Judgment (ID: `keyterm:Judgment`); Pray (ID: `keyterm:Pray`); Daily Life (ID: `keyterm:DailyLife`); पवित्र आत्मा (ID: `deity:HolySpirit`); Be a Disciple (ID: `keyterm:Disciple`); इस्राएल (ID: `person:Israel`); Quadrans (ID: `realia:Quadrans`); Lepton (ID: `realia:Lepton`); Synagogue (ID: `realia:Synagogue`); Cloak (ID: `realia:Cloak`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); यीशु (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Be a Disciple (ID: `keyterm:Disciple`); Bear Witness (ID: `keyterm:BearWitness`); Good News (ID: `keyterm:GoodNews`); Kingdom (ID: `keyterm:Kingdom`); Salvation (ID: `keyterm:Salvation`); Symbol (ID: `keyterm:Example`); Proclaim (ID: `keyterm:Proclaim`); पतरस (ID: `person:Peter`); पवित्र आत्मा (ID: `deity:HolySpirit`); A Group of Disciples (ID: `group:GenericDisciples`); यूहन्ना (ID: `person:John.2`); अन्द्रियास (ID: `person:Andrew`); याकूब (ID: `person:James`); Synagogue (ID: `realia:Synagogue`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Sky (ID: `keyterm:Heaven`); Chosen (ID: `keyterm:Chosen`); यहोवा (ID: `deity:Lord`); House (ID: `realia:House`); Ability (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); Glory (ID: `keyterm:Glory`); Body (ID: `keyterm:Body.3`); Surely! (ID: `keyterm:Surely`); Portent (ID: `keyterm:Portent`); यीशु (ID: `person:Jesus.2`); Symbol (ID: `keyterm:Example`); Authority (ID: `keyterm:Authority.2`); Parable (ID: `keyterm:Parable`); Pray (ID: `keyterm:Pray`); यहूदिया (ID: `place:Judea`); To Command (ID: `keyterm:Command`); Believe (ID: `keyterm:Believe`); Abomination of Desolation (ID: `keyterm:AbominationOfDesolation`); Disaster (ID: `keyterm:Disaster`); Salvation (ID: `keyterm:Salvation`); Housetop (ID: `realia:Housetop`); Cloak (ID: `realia:Cloak`); Door (ID: `realia:Door`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `flora:Myrrh`); Myrrh (ID: `realia:Myrrh`); शमौन (ID: `person:Simon.4`); बैतनिय्याह (ID: `place:Bethany`); Ability (ID: `keyterm:Ability`); Good News (ID: `keyterm:GoodNews`); Body (ID: `keyterm:Body.3`); Proclaim (ID: `keyterm:Proclaim`); Surely! (ID: `keyterm:Surely`); यीशु (ID: `person:Jesus.2`); Pure (ID: `keyterm:Pure`); यहूदा (ID: `person:Judas.2`); Promise (ID: `keyterm:Promise`); Passover (ID: `keyterm:Passover`); A Group of Disciples (ID: `group:GenericDisciples`); Alabaster Jar (ID: `realia:AlabasterJar`); Oil of Nard (ID: `realia:OilOfNard`); Nard (ID: `flora:Nard`); House (ID: `realia:House`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); पतरस (ID: `person:Peter`); Linen (ID: `realia:Linen`); गतसमनी (ID: `place:Gethsemane`); Be a Disciple (ID: `keyterm:Disciple`); To Cause to Happen (ID: `keyterm:Happen`); Name (ID: `keyterm:Name`); Body (ID: `keyterm:Body.3`); Spirit (ID: `keyterm:Spirit.2`); यहूदा (ID: `person:Judas.2`); यीशु (ID: `person:Jesus.2`); यूहन्ना (ID: `person:John.2`); Written (ID: `keyterm:Scripture`); Put to the Test (ID: `keyterm:PutToTheTest`); यहोवा (ID: `deity:Lord`); याकूब (ID: `person:James`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Bear Witness (ID: `keyterm:BearWitness`); Witness (ID: `keyterm:Witness`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Speak as a Prophet (ID: `keyterm:Speak`); पतरस (ID: `person:Peter`); Blaspheme (ID: `keyterm:Blaspheme`); Condemn (ID: `keyterm:Condemn`); Temple (ID: `realia:Temple`); Courtyard (ID: `realia:Courtyard`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** पतरस (ID: `person:Peter`); यीशु (ID: `person:Jesus.2`); Rooster (ID: `fauna:Rooster`); Word (ID: `keyterm:Word`); नासरत (ID: `place:Nazareth`); गलीली (ID: `group:Galilee`); True (ID: `keyterm:True`); गलील (ID: `place:Galilee`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); यीशु (ID: `person:Jesus.2`); एलिय्याह (ID: `person:Elijah`); Jews (ID: `group:Jews`); Salvation (ID: `keyterm:Salvation`); Purple Cloth (ID: `realia:PurpleCloth`); Clothing (ID: `realia:Clothing`); Reed (ID: `flora:Reed`); Temple (ID: `realia:Temple`); शमौन (ID: `person:Simon.5`); रूफुस (ID: `person:Rufus`); कुरेने (ID: `place:Cyrene`); सिकन्दर (ID: `person:Alexander`); Centurion at Crucifixion (ID: `person:Centurion.3`); गुलगुता (ID: `place:Golgotha`); यहोवा (ID: `deity:Lord`); True (ID: `keyterm:True`); Priests (ID: `group:GenericPriests`); Bow Down (ID: `keyterm:BowDown`); Blaspheme (ID: `keyterm:Blaspheme`); Believe (ID: `keyterm:Believe`); A Group of People (ID: `group:GenericGroup`); Elders (ID: `group:GenericElders`); इस्राएल (ID: `person:Israel`); Religious Officials (ID: `group:ReligiousOfficials`); Palace (ID: `realia:Palace`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Myrrh (ID: `flora:Myrrh`); Boxthorn (ID: `flora:Boxthorn`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`); Acacia (ID: `flora:Acacia`); Lot (ID: `realia:Lot`); Brier (ID: `flora:Brier`); Sour Wine (ID: `realia:SourWine`); Curtain (ID: `realia:Curtain`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** यूसुफ (ID: `person:Joseph.6`); मरियम (ID: `person:Mary.2`); पिलातुस (ID: `person:Pilate`); Mary Magdalene (ID: `person:Marymagdalene`); याकूब (ID: `person:James.4`); सलोमी (ID: `person:Salome`); यूसुफ (ID: `person:Joseph.5`); यूसुफ (ID: `person:Joseph.3`); अरिमतियाह (ID: `place:Arimathea`); यरूशलेम (ID: `place:Jerusalem`); Body (ID: `keyterm:Body.3`); यीशु (ID: `person:Jesus.2`); गलील (ID: `place:Galilee`); Kingdom (ID: `keyterm:Kingdom`); यहोवा (ID: `deity:Lord`); Day Before the Sabbath (ID: `keyterm:DayBeforeTheSabbath`); Serve (ID: `keyterm:Serve`); Linen (ID: `realia:Linen`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); सलोमी (ID: `person:Salome`); Angels (ID: `group:Angels`); मरियम (ID: `person:Mary.2`); Surely! (ID: `keyterm:Surely`); याकूब (ID: `person:James.3`); यीशु (ID: `person:Jesus.2`); Sabbath (ID: `keyterm:Sabbath`); Anointed (ID: `keyterm:Anointed`); गलील (ID: `place:Galilee`); पतरस (ID: `person:Peter`); Mary Magdalene (ID: `person:Marymagdalene`); To Command (ID: `keyterm:Command`); Fear (ID: `keyterm:Fear`); Resurrection (ID: `keyterm:Resurrection`); नासरत (ID: `place:Nazareth`); Imperishable (ID: `keyterm:Imperishable`); Be a Disciple (ID: `keyterm:Disciple`); Week (ID: `keyterm:Week`); Salvation (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`); Cross (ID: `realia:Cross`); Aloes (ID: `realia:Aloes`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Disbelieve (ID: `keyterm:Disbelieve`); Proclaim (ID: `keyterm:Proclaim`); यीशु (ID: `person:Jesus.2`); Symbol (ID: `keyterm:Example`); Demons (ID: `deity:Demons`); Ability (ID: `keyterm:Ability`); Good News (ID: `keyterm:GoodNews`); Life (ID: `keyterm:Life`); Name (ID: `keyterm:Name`); Mary Magdalene (ID: `person:Marymagdalene`); यहोवा (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Baptism (ID: `keyterm:Baptism`); Resurrection (ID: `keyterm:Resurrection`); Hardheartedness (ID: `keyterm:Hardheartedness`); Week (ID: `keyterm:Week`); Condemn (ID: `keyterm:Condemn`); Salvation (ID: `keyterm:Salvation`); Snake (ID: `fauna:Snake`)
