...
* **Associated ACAI Concepts:** यूहन्ना (ID: `person:John`); Baptism (ID: `keyterm:Baptism`); यीशु (ID: `person:Jesus.2`); Good News (ID: `keyterm:GoodNews`); Proclaim (ID: `keyterm:Proclaim`); यहोवा (ID: `deity:Lord`); पवित्र आत्मा (ID: `deity:HolySpirit`); यरदन (ID: `place:Jordan`); गलील (ID: `place:Galilee`); जब्दी (ID: `person:Zebedee`); To Sin (ID: `keyterm:Sin`); Sky (ID: `keyterm:Heaven`); Repent (ID: `keyterm:Repent`); An Angel (ID: `deity:Angel`); Ship (ID: `realia:Ship`); Casting Net (ID: `realia:CastingNet`); Fishnet (ID: `realia:Fishnet`); Sea of Galilee (ID: `place:GalileeSea`); Hired Worker (ID: `keyterm:HiredWorker`); याकूब (ID: `person:James`); यूहन्ना (ID: `person:John.2`); यहूदिया (ID: `place:Judea`); Forgive (ID: `keyterm:Forgive`); Believe (ID: `keyterm:Believe`); Straightness (ID: `keyterm:Straightness`); यशायाह (ID: `person:Isaiah`); Put to the Test (ID: `keyterm:PutToTheTest`); शैतान (ID: `deity:Satan`); पतरस (ID: `person:Peter`); नासरत (ID: `place:Nazareth`); यरूशलेम (ID: `place:Jerusalem`); Serve (ID: `keyterm:Serve`); Kingdom (ID: `keyterm:Kingdom`); Beloved (ID: `keyterm:Beloved`); अन्द्रियास (ID: `person:Andrew`); Strap (ID: `realia:Strap`); Bag (ID: `realia:Bag`); Belt (ID: `realia:Belt`); Dove (ID: `fauna:Dove`); Bee (ID: `fauna:Bee`); Camel (ID: `fauna:Camel`); Locust (ID: `fauna:Locust`); Sandal (ID: `realia:Sandal`); Leather (ID: `realia:Leather`)
...
* **Associated ACAI Concepts:** To Cleanse (ID: `keyterm:Cleanse.2`); Synagogue (ID: `realia:Synagogue`); पतरस (ID: `person:Peter`); Proclaim (ID: `keyterm:Proclaim`); गलील (ID: `place:Galilee`); Ability (ID: `keyterm:Ability`); Demons (ID: `deity:Demons`); Authority (ID: `keyterm:Authority.2`); Serve (ID: `keyterm:Serve`); यीशु (ID: `person:Jesus.2`); कफरनहूम (ID: `place:Capernaum`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); यूहन्ना (ID: `person:John.2`); To Command (ID: `keyterm:Command`); Bear Witness (ID: `keyterm:BearWitness`); Sabbath (ID: `keyterm:Sabbath`); याकूब (ID: `person:James`); यहोवा (ID: `deity:Lord`); मूसा (ID: `person:Moses`); नासरत (ID: `place:Nazareth`); Ask for (ID: `keyterm:AskFor`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Pray (ID: `keyterm:Pray`); Holy (ID: `keyterm:Holy`); Offering (ID: `keyterm:Offering`); अन्द्रियास (ID: `person:Andrew`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Sabbath (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); फरीसी (ID: `group:Pharisee`); हेरोदियों (ID: `group:Herodian`); एब्यातार (ID: `person:Abiathar`); Serve (ID: `keyterm:Serve`); दाऊद (ID: `person:David`); Be a Disciple (ID: `keyterm:Disciple`); Salvation (ID: `keyterm:Salvation`); Life (ID: `keyterm:Life`); Heart (ID: `keyterm:Heart`); यहोवा (ID: `deity:Lord`); Wheat (ID: `flora:Wheat`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`); House (ID: `realia:House`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); Name (ID: `keyterm:Name`); बरतुल्मै (ID: `person:Bartholomew`); यूहन्ना (ID: `person:John.2`); हलफईस (ID: `person:Alphaeus`); याकूब (ID: `person:James.2`); याकूब (ID: `person:James`); जेलोतेस (ID: `group:Zealot`); इदूमिया (ID: `place:Idumea`); मत्ती (ID: `person:Matthew`); यहूदिया (ID: `place:Judea`); To Command (ID: `keyterm:Command`); गलील (ID: `place:Galilee`); थोमा (ID: `person:Thomas`); सोर (ID: `place:Tyre`); जब्दी (ID: `person:Zebedee`); Ability (ID: `keyterm:Ability`); यहूदा (ID: `person:Judas.2`); यरदन (ID: `place:Jordan`); यहूदा (ID: `person:Judas`); पतरस (ID: `person:Peter`); यरूशलेम (ID: `place:Jerusalem`); सीदोन (ID: `place:Sidon`); Demons (ID: `deity:Demons`); Authority (ID: `keyterm:Authority.2`); शमौन (ID: `person:Simon.2`); Serve (ID: `keyterm:Serve`); यीशु (ID: `person:Jesus.2`); फिलिप्पुस (ID: `person:Philip`); Proclaim (ID: `keyterm:Proclaim`); अन्द्रियास (ID: `person:Andrew`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** शैतान (ID: `deity:Satan`); Blaspheme (ID: `keyterm:Blaspheme`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); House (ID: `realia:House`); यरूशलेम (ID: `place:Jerusalem`); Surely! (ID: `keyterm:Surely`); Always (ID: `keyterm:Always`); Demons (ID: `deity:Demons`); Kingdom (ID: `keyterm:Kingdom`); Parable (ID: `keyterm:Parable`); यहोवा (ID: `deity:Lord`); Religious Officials (ID: `group:ReligiousOfficials`); पवित्र आत्मा (ID: `deity:HolySpirit`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Ask for (ID: `keyterm:AskFor`); यीशु (ID: `person:Jesus.2`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); Ship (ID: `realia:Ship`); Grave (ID: `realia:Grave`); यहोवा (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Chain (ID: `realia:Chain`); To Command (ID: `keyterm:Command`); दिकापुलिस (ID: `place:Decapolis`); सेना (ID: `deity:Legion`); गिरासा (ID: `place:Gerasa`); Bow Down (ID: `keyterm:BowDown`); Believe (ID: `keyterm:Believe`); Become Still (ID: `keyterm:BecomeStill`); Mercy (ID: `keyterm:Mercy`); Authority (ID: `keyterm:Authority.2`); Name (ID: `keyterm:Name`); Proclaim (ID: `keyterm:Proclaim`); Cushion (ID: `realia:Cushion`); Fetter (ID: `realia:Fetter`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Salvation (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`); Believe (ID: `keyterm:Believe`); Fear (ID: `keyterm:Fear`); याईर (ID: `person:Jairus`); यूहन्ना (ID: `person:John.2`); Ability (ID: `keyterm:Ability`); Truth (ID: `keyterm:Truth`); A Group of Disciples (ID: `group:GenericDisciples`); याकूब (ID: `person:James`); Body (ID: `keyterm:Body.3`); पतरस (ID: `person:Peter`); Ask for (ID: `keyterm:AskFor`); Life (ID: `keyterm:Life`); Be a Disciple (ID: `keyterm:Disciple`); Make Peace (ID: `keyterm:Peace`); Name (ID: `keyterm:Name`); Blood (ID: `keyterm:Blood`); House (ID: `realia:House`); Ship (ID: `realia:Ship`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Serve (ID: `keyterm:Serve`); शमौन (ID: `person:Simon.3`); यूसुफ (ID: `person:Joseph.3`); Disbelieve (ID: `keyterm:Disbelieve`); यहूदा (ID: `person:Jude`); Bear Witness (ID: `keyterm:BearWitness`); Sabbath (ID: `keyterm:Sabbath`); याकूब (ID: `person:James.3`); मरियम (ID: `person:Mary`); Anointed (ID: `keyterm:Anointed`); Repent (ID: `keyterm:Repent`); Demons (ID: `deity:Demons`); Authority (ID: `keyterm:Authority.2`); यीशु (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Proclaim (ID: `keyterm:Proclaim`); Bag (ID: `realia:Bag`); Staff (ID: `realia:Staff`); Olive Oil (ID: `realia:OliveOil`); House (ID: `realia:House`); Belt (ID: `realia:Belt`); Tunic (ID: `realia:Tunic.2`); Sandal (ID: `realia:Sandal`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Fish (ID: `fauna:Fish`); Be a Disciple (ID: `keyterm:Disciple`); Affection (ID: `keyterm:Affection`); यीशु (ID: `person:Jesus.2`); A Group of Disciples (ID: `group:GenericDisciples`); Bless (ID: `keyterm:Bless`); Sky (ID: `keyterm:Heaven`); Basket (ID: `realia:Basket`); Ship (ID: `realia:Ship`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`); Sheep (ID: `fauna:Lamb`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** Defilement (ID: `keyterm:Defilement`); Teaching (ID: `keyterm:Teaching`); फरीसी (ID: `group:Pharisee`); Heart (ID: `keyterm:Heart`); यहोवा (ID: `deity:Lord`); Be a Disciple (ID: `keyterm:Disciple`); Commandment (ID: `keyterm:Commandment`); Temple Treasury (ID: `place:Corban`); Baptism (ID: `keyterm:Baptism`); Worship (ID: `keyterm:Worship`); Live (ID: `keyterm:Live.3`); यशायाह (ID: `person:Isaiah`); मूसा (ID: `person:Moses`); यरूशलेम (ID: `place:Jerusalem`); Parable (ID: `keyterm:Parable`); Religious Officials (ID: `group:ReligiousOfficials`); To Cleanse (ID: `keyterm:Cleanse.2`); Offering (ID: `keyterm:Offering`); Fornication (ID: `keyterm:Fornication`); Speak as a Prophet (ID: `keyterm:Speak`); Jews (ID: `group:Jews`); Blaspheme (ID: `keyterm:Blaspheme`); Bed (ID: `realia:Bed`); House (ID: `realia:House`); Cooking Pot (ID: `realia:CookingPot`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); सोर (ID: `place:Tyre`); Ask for (ID: `keyterm:AskFor`); Dog (ID: `fauna:Dog`); House (ID: `realia:House`); सीदोन (ID: `place:Sidon`); दिकापुलिस (ID: `place:Decapolis`); यूनानी (ID: `group:Greek`); फीनीके (ID: `place:Phoenicia`); सुरूफ‍िनीकी (ID: `group:Phoenicia`); यावान (ID: `person:Javan`); Honest (ID: `keyterm:Honest`); Proclaim (ID: `keyterm:Proclaim`); Sea of Galilee (ID: `place:GalileeSea`); Sky (ID: `keyterm:Heaven`); Bed (ID: `realia:Bed`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); बैतसैदा (ID: `place:Bethsaida`); Baptist (ID: `keyterm:Baptist`); Caesarea Philippi (ID: `place:CaesareaPhilippi`); Be a Disciple (ID: `keyterm:Disciple`); पतरस (ID: `person:Peter`); Ask for (ID: `keyterm:AskFor`); To Command (ID: `keyterm:Command`); एलिय्याह (ID: `person:Elijah`); यूहन्ना (ID: `person:John`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Life (ID: `keyterm:Life`); यहोवा (ID: `deity:Lord`); पतरस (ID: `person:Peter`); Be a Disciple (ID: `keyterm:Disciple`); To Command (ID: `keyterm:Command`); Ability (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); Holy (ID: `keyterm:Holy`); Surely! (ID: `keyterm:Surely`); Salvation (ID: `keyterm:Salvation`); Think (ID: `keyterm:Think`); Glory (ID: `keyterm:Glory`); Good News (ID: `keyterm:GoodNews`); Kingdom (ID: `keyterm:Kingdom`); Be Unfaithful (ID: `keyterm:Unfaithful`); Reject (ID: `keyterm:Reject`); शैतान (ID: `deity:Satan`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** एलिय्याह (ID: `person:Elijah`); यीशु (ID: `person:Jesus.2`); पतरस (ID: `person:Peter`); मूसा (ID: `person:Moses`); यूहन्ना (ID: `person:John.2`); याकूब (ID: `person:James`); Beloved (ID: `keyterm:Beloved`); Tent (ID: `realia:Tent`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); A Father (ID: `person:GenericFather`); Believe (ID: `keyterm:Believe`); Pray (ID: `keyterm:Pray`); Disbelieve (ID: `keyterm:Disbelieve`); A Group of Disciples (ID: `group:GenericDisciples`); To Command (ID: `keyterm:Command`); A Group of People (ID: `group:GenericGroup`); Be Unfaithful (ID: `keyterm:Unfaithful`); Affection (ID: `keyterm:Affection`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); कफरनहूम (ID: `place:Capernaum`); Name (ID: `keyterm:Name`); गलील (ID: `place:Galilee`); Word (ID: `keyterm:Word`); Fear (ID: `keyterm:Fear`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Cause to Stumble (ID: `keyterm:CauseToStumble`); Name (ID: `keyterm:Name`); Gehenna (ID: `keyterm:Gehenna`); नरक (ID: `place:Hell`); यीशु (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); यूहन्ना (ID: `person:John.2`); Surely! (ID: `keyterm:Surely`); Demons (ID: `deity:Demons`); Kingdom (ID: `keyterm:Kingdom`); Be at Peace (ID: `keyterm:AtPeace`); यहोवा (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); Worm (ID: `fauna:Maggot`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यीशु (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); To Command (ID: `keyterm:Command`); Kingdom (ID: `keyterm:Kingdom`); Fornication (ID: `keyterm:Fornication`); मूसा (ID: `person:Moses`); यहूदिया (ID: `place:Judea`); Commandment (ID: `keyterm:Commandment`); Hardheartedness (ID: `keyterm:Hardheartedness`); Surely! (ID: `keyterm:Surely`); Bless (ID: `keyterm:Bless`); Body (ID: `keyterm:Body.3`); यरदन (ID: `place:Jordan`); Be Lawful (ID: `keyterm:Lawful`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); यहोवा (ID: `deity:Lord`); Kingdom (ID: `keyterm:Kingdom`); Rich Young Ruler (ID: `person:RichYoungRuler`); Good (ID: `keyterm:Good`); Life (ID: `keyterm:Life`); Be a Disciple (ID: `keyterm:Disciple`); Always (ID: `keyterm:Always`); House (ID: `realia:House`); Commandment (ID: `keyterm:Commandment`); Salvation (ID: `keyterm:Salvation`); Surely! (ID: `keyterm:Surely`); Good News (ID: `keyterm:GoodNews`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Love (ID: `keyterm:Love`); पतरस (ID: `person:Peter`); Fornication (ID: `keyterm:Fornication`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); याकूब (ID: `person:James`); यूहन्ना (ID: `person:John.2`); यरूशलेम (ID: `place:Jerusalem`); Baptism (ID: `keyterm:Baptism`); अन्यजाति (ID: `group:Gentile`); Serve (ID: `keyterm:Serve`); Life (ID: `keyterm:Life`); Glory (ID: `keyterm:Glory`); Condemn (ID: `keyterm:Condemn`); Authority (ID: `keyterm:Authority.2`); Fear (ID: `keyterm:Fear`); जब्दी (ID: `person:Zebedee`); Ransom (ID: `keyterm:Ransom`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); दाऊद (ID: `person:David`); Mercy (ID: `keyterm:Mercy`); A Group of People (ID: `group:GenericGroup`); बरतिमाई (ID: `person:Bartimaeus`); तिमाई (ID: `person:Timaeus`); Be a Disciple (ID: `keyterm:Disciple`); Salvation (ID: `keyterm:Salvation`); To Command (ID: `keyterm:Command`); Cheer Up (ID: `keyterm:CheerUp`); यरीहो (ID: `place:Jericho`); Believe (ID: `keyterm:Believe`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Donkey (ID: `fauna:Donkey`); यीशु (ID: `person:Jesus.2`); यरूशलेम (ID: `place:Jerusalem`); Hosanna (ID: `keyterm:Hosanna`); बैतनिय्याह (ID: `place:Bethany`); Bless (ID: `keyterm:Bless`); A Group of People (ID: `group:GenericGroup`); Cloak (ID: `realia:Cloak`); बैतफगे (ID: `place:Bethphage`); दाऊद (ID: `person:David`); Be a Disciple (ID: `keyterm:Disciple`); Height (ID: `keyterm:Height`); Name (ID: `keyterm:Name`); Kingdom (ID: `keyterm:Kingdom`); यहोवा (ID: `deity:Lord`); Rush (ID: `flora:Rush`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Pray (ID: `keyterm:Pray`); Temple (ID: `realia:Temple`); Fig (ID: `flora:Fig`); यहोवा (ID: `deity:Lord`); Surely! (ID: `keyterm:Surely`); Forgive (ID: `keyterm:Forgive`); Discern (ID: `keyterm:Discern`); Sky (ID: `keyterm:Heaven`); Heart (ID: `keyterm:Heart`); पतरस (ID: `person:Peter`); यरूशलेम (ID: `place:Jerusalem`); Fear (ID: `keyterm:Fear`); बैतनिय्याह (ID: `place:Bethany`); यीशु (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Always (ID: `keyterm:Always`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Ability (ID: `keyterm:Ability`); Authority (ID: `keyterm:Authority.2`); Sky (ID: `keyterm:Heaven`); यूहन्ना (ID: `person:John`); Parable (ID: `keyterm:Parable`); Fear (ID: `keyterm:Fear`); यीशु (ID: `person:Jesus.2`); Reject (ID: `keyterm:Reject`); Written (ID: `keyterm:Scripture`); Baptism (ID: `keyterm:Baptism`); Believe (ID: `keyterm:Believe`); यहोवा (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); यरूशलेम (ID: `place:Jerusalem`); Empty (ID: `keyterm:Empty`); Priests (ID: `group:GenericPriests`); Religious Officials (ID: `group:ReligiousOfficials`); Beloved (ID: `keyterm:Beloved`); Watch-Tower (ID: `realia:Watch-tower`); Thorn Hedge (ID: `realia:ThornHedge`); Cornerstone (ID: `realia:Cornerstone`); Tower (ID: `realia:Tower`); Temple (ID: `realia:Temple`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); तिबिरियुस (ID: `person:Tiberius`); Resurrection (ID: `keyterm:Resurrection`); मूसा (ID: `person:Moses`); यीशु (ID: `person:Jesus.2`); हेरोदियों (ID: `group:Herodian`); Written (ID: `keyterm:Scripture`); Poll Tax (ID: `keyterm:PollTax`); अब्राहम (ID: `person:Abraham`); सदूकी (ID: `group:Sadducee`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Truth (ID: `keyterm:Truth`); The Way (ID: `keyterm:TheWay`); Life (ID: `keyterm:Life`); True (ID: `keyterm:True`); इसहाक (ID: `person:Isaac`); Hypocrisy (ID: `keyterm:Hypocrisy`); Be Lawful (ID: `keyterm:Lawful`); An Angel (ID: `deity:Angel`); फरीसी (ID: `group:Pharisee`); इस्राएल (ID: `person:Israel`); Denarius (ID: `realia:Denarius`); Brier (ID: `flora:Brier`); Boxthorn (ID: `flora:Boxthorn`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Love (ID: `keyterm:Love`); यीशु (ID: `person:Jesus.2`); दाऊद (ID: `person:David`); Commandment (ID: `keyterm:Commandment`); A Priest (ID: `person:GenericPriest`); A Scribe (ID: `person:Scribe`); Heart (ID: `keyterm:Heart`); Treasury (ID: `realia:Treasury`); Surely! (ID: `keyterm:Surely`); Daily Life (ID: `keyterm:DailyLife`); Mind (ID: `keyterm:Mind.2`); Truth (ID: `keyterm:Truth`); Judgment (ID: `keyterm:Judgment`); Pray (ID: `keyterm:Pray`); पवित्र आत्मा (ID: `deity:HolySpirit`); Be a Disciple (ID: `keyterm:Disciple`); Kingdom (ID: `keyterm:Kingdom`); Offering (ID: `keyterm:Offering`); इस्राएल (ID: `person:Israel`); Quadrans (ID: `realia:Quadrans`); Lepton (ID: `realia:Lepton`); Cloak (ID: `realia:Cloak`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); Temple (ID: `realia:Temple`); Be a Disciple (ID: `keyterm:Disciple`); पतरस (ID: `person:Peter`); यूहन्ना (ID: `person:John.2`); Salvation (ID: `keyterm:Salvation`); A Group of Disciples (ID: `group:GenericDisciples`); याकूब (ID: `person:James`); Bear Witness (ID: `keyterm:BearWitness`); Kingdom (ID: `keyterm:Kingdom`); Good News (ID: `keyterm:GoodNews`); Symbol (ID: `keyterm:Example`); Proclaim (ID: `keyterm:Proclaim`); अन्द्रियास (ID: `person:Andrew`); पवित्र आत्मा (ID: `deity:HolySpirit`); Synagogue (ID: `realia:Synagogue`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Sky (ID: `keyterm:Heaven`); यहोवा (ID: `deity:Lord`); Chosen (ID: `keyterm:Chosen`); House (ID: `realia:House`); Ability (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); Surely! (ID: `keyterm:Surely`); Salvation (ID: `keyterm:Salvation`); यहूदिया (ID: `place:Judea`); To Command (ID: `keyterm:Command`); Glory (ID: `keyterm:Glory`); Portent (ID: `keyterm:Portent`); Believe (ID: `keyterm:Believe`); Abomination of Desolation (ID: `keyterm:AbominationOfDesolation`); Body (ID: `keyterm:Body.3`); Disaster (ID: `keyterm:Disaster`); Parable (ID: `keyterm:Parable`); Authority (ID: `keyterm:Authority.2`); Pray (ID: `keyterm:Pray`); यीशु (ID: `person:Jesus.2`); Symbol (ID: `keyterm:Example`); Cloak (ID: `realia:Cloak`); Fig (ID: `flora:Fig`); Door (ID: `realia:Door`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `flora:Myrrh`); Myrrh (ID: `realia:Myrrh`); शमौन (ID: `person:Simon.4`); बैतनिय्याह (ID: `place:Bethany`); Surely! (ID: `keyterm:Surely`); Good News (ID: `keyterm:GoodNews`); Passover (ID: `keyterm:Passover`); Ability (ID: `keyterm:Ability`); यहूदा (ID: `person:Judas.2`); A Group of Disciples (ID: `group:GenericDisciples`); Body (ID: `keyterm:Body.3`); Promise (ID: `keyterm:Promise`); Pure (ID: `keyterm:Pure`); यीशु (ID: `person:Jesus.2`); Proclaim (ID: `keyterm:Proclaim`); Alabaster Jar (ID: `realia:AlabasterJar`); Oil of Nard (ID: `realia:OilOfNard`); Nard (ID: `flora:Nard`); House (ID: `realia:House`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); Surely! (ID: `keyterm:Surely`); Passover (ID: `keyterm:Passover`); यीशु (ID: `person:Jesus.2`); Sheep (ID: `fauna:Lamb`); Blood (ID: `keyterm:Blood`); गलील (ID: `place:Galilee`); Bless (ID: `keyterm:Bless`); Body (ID: `keyterm:Body.3`); यहोवा (ID: `deity:Lord`); पतरस (ID: `person:Peter`); Disaster (ID: `keyterm:Disaster`); Covenant (ID: `keyterm:Covenant`); Resurrection (ID: `keyterm:Resurrection`); Kingdom (ID: `keyterm:Kingdom`); Offering (ID: `keyterm:Offering`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); Rooster (ID: `fauna:Rooster`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Bowl (ID: `realia:Bowl.2`); Clay Jar (ID: `realia:ClayJar`); Flock (ID: `fauna:Flock`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); पतरस (ID: `person:Peter`); Linen (ID: `realia:Linen`); गतसमनी (ID: `place:Gethsemane`); यीशु (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Spirit (ID: `keyterm:Spirit.2`); Written (ID: `keyterm:Scripture`); यूहन्ना (ID: `person:John.2`); Name (ID: `keyterm:Name`); याकूब (ID: `person:James`); Body (ID: `keyterm:Body.3`); Put to the Test (ID: `keyterm:PutToTheTest`); यहोवा (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); यहूदा (ID: `person:Judas.2`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Bear Witness (ID: `keyterm:BearWitness`); पतरस (ID: `person:Peter`); Witness (ID: `keyterm:Witness`); Sky (ID: `keyterm:Heaven`); Condemn (ID: `keyterm:Condemn`); Speak as a Prophet (ID: `keyterm:Speak`); Ability (ID: `keyterm:Ability`); Blaspheme (ID: `keyterm:Blaspheme`); Temple (ID: `realia:Temple`); Clothing (ID: `realia:Clothing`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** पतरस (ID: `person:Peter`); यीशु (ID: `person:Jesus.2`); Rooster (ID: `fauna:Rooster`); नासरत (ID: `place:Nazareth`); गलीली (ID: `group:Galilee`); True (ID: `keyterm:True`); गलील (ID: `place:Galilee`); Word (ID: `keyterm:Word`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); यीशु (ID: `person:Jesus.2`); Salvation (ID: `keyterm:Salvation`); एलिय्याह (ID: `person:Elijah`); Jews (ID: `group:Jews`); Purple Cloth (ID: `realia:PurpleCloth`); Reed (ID: `flora:Reed`); Clothing (ID: `realia:Clothing`); Temple (ID: `realia:Temple`); शमौन (ID: `person:Simon.5`); गुलगुता (ID: `place:Golgotha`); सिकन्दर (ID: `person:Alexander`); कुरेने (ID: `place:Cyrene`); रूफुस (ID: `person:Rufus`); Centurion at Crucifixion (ID: `person:Centurion.3`); Bow Down (ID: `keyterm:BowDown`); Believe (ID: `keyterm:Believe`); A Group of People (ID: `group:GenericGroup`); यहोवा (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); True (ID: `keyterm:True`); Priests (ID: `group:GenericPriests`); Religious Officials (ID: `group:ReligiousOfficials`); इस्राएल (ID: `person:Israel`); Blaspheme (ID: `keyterm:Blaspheme`); Myrrh (ID: `flora:Myrrh`); Palace (ID: `realia:Palace`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Sour Wine (ID: `realia:SourWine`); Boxthorn (ID: `flora:Boxthorn`); Lot (ID: `realia:Lot`); Curtain (ID: `realia:Curtain`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** यूसुफ (ID: `person:Joseph.6`); मरियम (ID: `person:Mary.2`); पिलातुस (ID: `person:Pilate`); Mary Magdalene (ID: `person:Marymagdalene`); याकूब (ID: `person:James.4`); यूसुफ (ID: `person:Joseph.3`); यूसुफ (ID: `person:Joseph.5`); अरिमतियाह (ID: `place:Arimathea`); सलोमी (ID: `person:Salome`); गलील (ID: `place:Galilee`); Day Before the Sabbath (ID: `keyterm:DayBeforeTheSabbath`); Body (ID: `keyterm:Body.3`); यहोवा (ID: `deity:Lord`); यरूशलेम (ID: `place:Jerusalem`); Serve (ID: `keyterm:Serve`); यीशु (ID: `person:Jesus.2`); Kingdom (ID: `keyterm:Kingdom`); Grave (ID: `realia:Grave`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Angels (ID: `group:Angels`); सलोमी (ID: `person:Salome`); मरियम (ID: `person:Mary.2`); Salvation (ID: `keyterm:Salvation`); Surely! (ID: `keyterm:Surely`); To Command (ID: `keyterm:Command`); गलील (ID: `place:Galilee`); Mary Magdalene (ID: `person:Marymagdalene`); Sabbath (ID: `keyterm:Sabbath`); Week (ID: `keyterm:Week`); याकूब (ID: `person:James.3`); Anointed (ID: `keyterm:Anointed`); पतरस (ID: `person:Peter`); नासरत (ID: `place:Nazareth`); Imperishable (ID: `keyterm:Imperishable`); Fear (ID: `keyterm:Fear`); यीशु (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Resurrection (ID: `keyterm:Resurrection`); Cloak (ID: `realia:Cloak`); Aloes (ID: `realia:Aloes`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Disbelieve (ID: `keyterm:Disbelieve`); Demons (ID: `deity:Demons`); यीशु (ID: `person:Jesus.2`); Symbol (ID: `keyterm:Example`); Proclaim (ID: `keyterm:Proclaim`); Salvation (ID: `keyterm:Salvation`); Good News (ID: `keyterm:GoodNews`); Baptism (ID: `keyterm:Baptism`); Mary Magdalene (ID: `person:Marymagdalene`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Week (ID: `keyterm:Week`); Condemn (ID: `keyterm:Condemn`); यहोवा (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Hardheartedness (ID: `keyterm:Hardheartedness`); Resurrection (ID: `keyterm:Resurrection`); Name (ID: `keyterm:Name`); Snake (ID: `fauna:Snake`)
