...
* **Associated ACAI Concepts:** यूहन्ना (ID: `person:John`); यीशु (ID: `person:Jesus.2`); Baptism (ID: `keyterm:Baptism`); Good News (ID: `keyterm:GoodNews`); Proclaim (ID: `keyterm:Proclaim`); यहोवा (ID: `deity:Lord`); पवित्र आत्मा (ID: `deity:HolySpirit`); यरदन (ID: `place:Jordan`); जब्दी (ID: `person:Zebedee`); गलील (ID: `place:Galilee`); An Angel (ID: `deity:Angel`); Repent (ID: `keyterm:Repent`); Sky (ID: `keyterm:Heaven`); To Sin (ID: `keyterm:Sin`); Ship (ID: `realia:Ship`); Fishnet (ID: `realia:Fishnet`); Casting Net (ID: `realia:CastingNet`); Hired Worker (ID: `keyterm:HiredWorker`); याकूब (ID: `person:James`); Sea of Galilee (ID: `place:GalileeSea`); शैतान (ID: `deity:Satan`); यशायाह (ID: `person:Isaiah`); यरूशलेम (ID: `place:Jerusalem`); यहूदिया (ID: `place:Judea`); Beloved (ID: `keyterm:Beloved`); अन्द्रियास (ID: `person:Andrew`); Straightness (ID: `keyterm:Straightness`); Forgive (ID: `keyterm:Forgive`); Put to the Test (ID: `keyterm:PutToTheTest`); यूहन्ना (ID: `person:John.2`); नासरत (ID: `place:Nazareth`); Serve (ID: `keyterm:Serve`); पतरस (ID: `person:Peter`); Kingdom (ID: `keyterm:Kingdom`); Believe (ID: `keyterm:Believe`); Strap (ID: `realia:Strap`); Leather (ID: `realia:Leather`); Belt (ID: `realia:Belt`); Camel (ID: `fauna:Camel`); Sandal (ID: `realia:Sandal`); Bag (ID: `realia:Bag`); Dove (ID: `fauna:Dove`); Bee (ID: `fauna:Bee`); Locust (ID: `fauna:Locust`)
...
* **Associated ACAI Concepts:** To Cleanse (ID: `keyterm:Cleanse.2`); Synagogue (ID: `realia:Synagogue`); पतरस (ID: `person:Peter`); Proclaim (ID: `keyterm:Proclaim`); गलील (ID: `place:Galilee`); यीशु (ID: `person:Jesus.2`); Authority (ID: `keyterm:Authority.2`); Demons (ID: `deity:Demons`); Ability (ID: `keyterm:Ability`); Serve (ID: `keyterm:Serve`); कफरनहूम (ID: `place:Capernaum`); Ask for (ID: `keyterm:AskFor`); Pray (ID: `keyterm:Pray`); याकूब (ID: `person:James`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); Sabbath (ID: `keyterm:Sabbath`); यहोवा (ID: `deity:Lord`); Bear Witness (ID: `keyterm:BearWitness`); Offering (ID: `keyterm:Offering`); अन्द्रियास (ID: `person:Andrew`); To Command (ID: `keyterm:Command`); यूहन्ना (ID: `person:John.2`); मूसा (ID: `person:Moses`); नासरत (ID: `place:Nazareth`); Holy (ID: `keyterm:Holy`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); Bed (ID: `realia:Bed`); Abstain from Food (ID: `keyterm:Fast`); Be a Disciple (ID: `keyterm:Disciple`); House (ID: `realia:House`); यहोवा (ID: `deity:Lord`); फरीसी (ID: `group:Pharisee`); Heart (ID: `keyterm:Heart`); Tax Collector (ID: `keyterm:TaxCollector`); Temple (ID: `realia:Temple`); हलफईस (ID: `person:Alphaeus.2`); कफरनहूम (ID: `place:Capernaum`); मत्ती (ID: `person:Matthew`); Be Healthy (ID: `keyterm:Healthy`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Glory (ID: `keyterm:Glory`); Authority (ID: `keyterm:Authority.2`); Spirit (ID: `keyterm:Spirit.2`); यूहन्ना (ID: `person:John`); Religious Officials (ID: `group:ReligiousOfficials`); Tax Office (ID: `keyterm:TaxOffice`); Ability (ID: `keyterm:Ability`); Believe (ID: `keyterm:Believe`); Patch (ID: `realia:Patch`); Housetop (ID: `realia:Housetop`); Skin-Bottle (ID: `realia:Skin-bottle`); Must (ID: `realia:Must`); Clothing (ID: `realia:Clothing`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Sabbath (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); फरीसी (ID: `group:Pharisee`); हेरोदियों (ID: `group:Herodian`); एब्यातार (ID: `person:Abiathar`); Be a Disciple (ID: `keyterm:Disciple`); यहोवा (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Heart (ID: `keyterm:Heart`); Salvation (ID: `keyterm:Salvation`); Serve (ID: `keyterm:Serve`); दाऊद (ID: `person:David`); Grain (ID: `flora:Grain`); Wheat (ID: `flora:Wheat`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); Name (ID: `keyterm:Name`); बरतुल्मै (ID: `person:Bartholomew`); हलफईस (ID: `person:Alphaeus`); याकूब (ID: `person:James`); इदूमिया (ID: `place:Idumea`); यूहन्ना (ID: `person:John.2`); याकूब (ID: `person:James.2`); जेलोतेस (ID: `group:Zealot`); थोमा (ID: `person:Thomas`); सोर (ID: `place:Tyre`); यरदन (ID: `place:Jordan`); यरूशलेम (ID: `place:Jerusalem`); यीशु (ID: `person:Jesus.2`); सीदोन (ID: `place:Sidon`); यहूदिया (ID: `place:Judea`); Authority (ID: `keyterm:Authority.2`); अन्द्रियास (ID: `person:Andrew`); To Command (ID: `keyterm:Command`); शमौन (ID: `person:Simon.2`); Demons (ID: `deity:Demons`); यहूदा (ID: `person:Judas`); मत्ती (ID: `person:Matthew`); यहूदा (ID: `person:Judas.2`); Serve (ID: `keyterm:Serve`); पतरस (ID: `person:Peter`); फिलिप्पुस (ID: `person:Philip`); Ability (ID: `keyterm:Ability`); जब्दी (ID: `person:Zebedee`); Proclaim (ID: `keyterm:Proclaim`); गलील (ID: `place:Galilee`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Ask for (ID: `keyterm:AskFor`); यीशु (ID: `person:Jesus.2`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); Ship (ID: `realia:Ship`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); Grave (ID: `realia:Grave`); यहोवा (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Chain (ID: `realia:Chain`); गिरासा (ID: `place:Gerasa`); To Command (ID: `keyterm:Command`); दिकापुलिस (ID: `place:Decapolis`); सेना (ID: `deity:Legion`); Mercy (ID: `keyterm:Mercy`); Proclaim (ID: `keyterm:Proclaim`); Authority (ID: `keyterm:Authority.2`); Name (ID: `keyterm:Name`); Bow Down (ID: `keyterm:BowDown`); Become Still (ID: `keyterm:BecomeStill`); Believe (ID: `keyterm:Believe`); Cushion (ID: `realia:Cushion`); Fetter (ID: `realia:Fetter`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Salvation (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`); Fear (ID: `keyterm:Fear`); Believe (ID: `keyterm:Believe`); याईर (ID: `person:Jairus`); Ask for (ID: `keyterm:AskFor`); याकूब (ID: `person:James`); Life (ID: `keyterm:Life`); Make Peace (ID: `keyterm:Peace`); Be a Disciple (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); यूहन्ना (ID: `person:John.2`); Name (ID: `keyterm:Name`); Body (ID: `keyterm:Body.3`); Truth (ID: `keyterm:Truth`); Blood (ID: `keyterm:Blood`); पतरस (ID: `person:Peter`); Ability (ID: `keyterm:Ability`); Ship (ID: `realia:Ship`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Serve (ID: `keyterm:Serve`); यूसुफ (ID: `person:Joseph.3`); यहूदा (ID: `person:Jude`); शमौन (ID: `person:Simon.3`); Disbelieve (ID: `keyterm:Disbelieve`); Sabbath (ID: `keyterm:Sabbath`); यीशु (ID: `person:Jesus.2`); Authority (ID: `keyterm:Authority.2`); Bear Witness (ID: `keyterm:BearWitness`); मरियम (ID: `person:Mary`); Be a Disciple (ID: `keyterm:Disciple`); Anointed (ID: `keyterm:Anointed`); याकूब (ID: `person:James.3`); Demons (ID: `deity:Demons`); Repent (ID: `keyterm:Repent`); Proclaim (ID: `keyterm:Proclaim`); Synagogue (ID: `realia:Synagogue`); Belt (ID: `realia:Belt`); Tunic (ID: `realia:Tunic.2`); Staff (ID: `realia:Staff`); Olive Oil (ID: `realia:OliveOil`); Bag (ID: `realia:Bag`); Sandal (ID: `realia:Sandal`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Herod Antipas (ID: `person:Herod.2`); यूहन्ना (ID: `person:John`); हेरोदियास (ID: `person:Herodias`); Resurrection (ID: `keyterm:Resurrection`); Baptism (ID: `keyterm:Baptism`); Plate (ID: `realia:Plate.2`); Prison (ID: `realia:Prison`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); फिलिप्पुस (ID: `person:Philip.2`); A Group of People (ID: `group:GenericGroup`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Baptist (ID: `keyterm:Baptist`); Haste (ID: `keyterm:Haste`); Be Lawful (ID: `keyterm:Lawful`); Be a Disciple (ID: `keyterm:Disciple`); Name (ID: `keyterm:Name`); एलिय्याह (ID: `person:Elijah`); Holy (ID: `keyterm:Holy`); Fear (ID: `keyterm:Fear`); Kingdom (ID: `keyterm:Kingdom`); Ability (ID: `keyterm:Ability`); Oath (ID: `keyterm:Oath`); गलील (ID: `place:Galilee`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Fish (ID: `fauna:Fish`); Be a Disciple (ID: `keyterm:Disciple`); Affection (ID: `keyterm:Affection`); यीशु (ID: `person:Jesus.2`); Sky (ID: `keyterm:Heaven`); A Group of Disciples (ID: `group:GenericDisciples`); Bless (ID: `keyterm:Bless`); Basket (ID: `realia:Basket`); Goat (ID: `fauna:Goat`); Ship (ID: `realia:Ship`); Denarius (ID: `realia:Denarius`); Sheep (ID: `fauna:Lamb`); Grass (ID: `flora:Grass`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Defilement (ID: `keyterm:Defilement`); Teaching (ID: `keyterm:Teaching`); फरीसी (ID: `group:Pharisee`); यहोवा (ID: `deity:Lord`); Heart (ID: `keyterm:Heart`); Be a Disciple (ID: `keyterm:Disciple`); Commandment (ID: `keyterm:Commandment`); Temple Treasury (ID: `place:Corban`); Jews (ID: `group:Jews`); To Cleanse (ID: `keyterm:Cleanse.2`); यशायाह (ID: `person:Isaiah`); यरूशलेम (ID: `place:Jerusalem`); Speak as a Prophet (ID: `keyterm:Speak`); Offering (ID: `keyterm:Offering`); Blaspheme (ID: `keyterm:Blaspheme`); Live (ID: `keyterm:Live.3`); Religious Officials (ID: `group:ReligiousOfficials`); Baptism (ID: `keyterm:Baptism`); Parable (ID: `keyterm:Parable`); मूसा (ID: `person:Moses`); Fornication (ID: `keyterm:Fornication`); Worship (ID: `keyterm:Worship`); Temple (ID: `realia:Temple`); Cooking Pot (ID: `realia:CookingPot`); Bed (ID: `realia:Bed`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); सोर (ID: `place:Tyre`); Ask for (ID: `keyterm:AskFor`); Dog (ID: `fauna:Dog`); House (ID: `realia:House`); सुरूफ‍िनीकी (ID: `group:Phoenicia`); फीनीके (ID: `place:Phoenicia`); सीदोन (ID: `place:Sidon`); दिकापुलिस (ID: `place:Decapolis`); यूनानी (ID: `group:Greek`); Sea of Galilee (ID: `place:GalileeSea`); यावान (ID: `person:Javan`); Sky (ID: `keyterm:Heaven`); Honest (ID: `keyterm:Honest`); Proclaim (ID: `keyterm:Proclaim`); Temple (ID: `realia:Temple`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); Basket (ID: `realia:Basket`); A Group of Disciples (ID: `group:GenericDisciples`); Symbol (ID: `keyterm:Example`); फरीसी (ID: `group:Pharisee`); Ship (ID: `realia:Ship`); Ask for (ID: `keyterm:AskFor`); Affection (ID: `keyterm:Affection`); Herod Antipas (ID: `person:Herod.2`); Surely! (ID: `keyterm:Surely`); Sky (ID: `keyterm:Heaven`); Spirit (ID: `keyterm:Spirit.2`); मगदन (ID: `place:Magadan`); Bless (ID: `keyterm:Bless`); Heart (ID: `keyterm:Heart`); Temple (ID: `realia:Temple`); Fish (ID: `fauna:Fish`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Baptist (ID: `keyterm:Baptist`); बैतसैदा (ID: `place:Bethsaida`); Caesarea Philippi (ID: `place:CaesareaPhilippi`); Ask for (ID: `keyterm:AskFor`); Be a Disciple (ID: `keyterm:Disciple`); पतरस (ID: `person:Peter`); To Command (ID: `keyterm:Command`); यूहन्ना (ID: `person:John`); एलिय्याह (ID: `person:Elijah`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Be a Disciple (ID: `keyterm:Disciple`); पतरस (ID: `person:Peter`); To Command (ID: `keyterm:Command`); Ability (ID: `keyterm:Ability`); Holy (ID: `keyterm:Holy`); Reject (ID: `keyterm:Reject`); Be Unfaithful (ID: `keyterm:Unfaithful`); Good News (ID: `keyterm:GoodNews`); Think (ID: `keyterm:Think`); Surely! (ID: `keyterm:Surely`); शैतान (ID: `deity:Satan`); Glory (ID: `keyterm:Glory`); Salvation (ID: `keyterm:Salvation`); Kingdom (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** एलिय्याह (ID: `person:Elijah`); यीशु (ID: `person:Jesus.2`); पतरस (ID: `person:Peter`); मूसा (ID: `person:Moses`); याकूब (ID: `person:James`); यूहन्ना (ID: `person:John.2`); Beloved (ID: `keyterm:Beloved`); Tent (ID: `realia:Tent`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); यीशु (ID: `person:Jesus.2`); A Father (ID: `person:GenericFather`); Believe (ID: `keyterm:Believe`); Affection (ID: `keyterm:Affection`); Be Unfaithful (ID: `keyterm:Unfaithful`); A Group of People (ID: `group:GenericGroup`); To Command (ID: `keyterm:Command`); Pray (ID: `keyterm:Pray`); A Group of Disciples (ID: `group:GenericDisciples`); Disbelieve (ID: `keyterm:Disbelieve`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** कफरनहूम (ID: `place:Capernaum`); Be a Disciple (ID: `keyterm:Disciple`); Fear (ID: `keyterm:Fear`); Word (ID: `keyterm:Word`); Name (ID: `keyterm:Name`); गलील (ID: `place:Galilee`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Cause to Stumble (ID: `keyterm:CauseToStumble`); नरक (ID: `place:Hell`); Gehenna (ID: `keyterm:Gehenna`); Name (ID: `keyterm:Name`); यीशु (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Surely! (ID: `keyterm:Surely`); यहोवा (ID: `deity:Lord`); Be at Peace (ID: `keyterm:AtPeace`); यूहन्ना (ID: `person:John.2`); Kingdom (ID: `keyterm:Kingdom`); Believe (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); Demons (ID: `deity:Demons`); Worm (ID: `fauna:Maggot`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Be a Disciple (ID: `keyterm:Disciple`); यीशु (ID: `person:Jesus.2`); To Command (ID: `keyterm:Command`); मूसा (ID: `person:Moses`); Kingdom (ID: `keyterm:Kingdom`); Fornication (ID: `keyterm:Fornication`); यहूदिया (ID: `place:Judea`); Be Lawful (ID: `keyterm:Lawful`); Commandment (ID: `keyterm:Commandment`); Hardheartedness (ID: `keyterm:Hardheartedness`); Surely! (ID: `keyterm:Surely`); यरदन (ID: `place:Jordan`); Body (ID: `keyterm:Body.3`); Bless (ID: `keyterm:Bless`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); यहोवा (ID: `deity:Lord`); Kingdom (ID: `keyterm:Kingdom`); Life (ID: `keyterm:Life`); Rich Young Ruler (ID: `person:RichYoungRuler`); Be a Disciple (ID: `keyterm:Disciple`); Always (ID: `keyterm:Always`); Good (ID: `keyterm:Good`); House (ID: `realia:House`); Commandment (ID: `keyterm:Commandment`); Love (ID: `keyterm:Love`); Good News (ID: `keyterm:GoodNews`); Surely! (ID: `keyterm:Surely`); Salvation (ID: `keyterm:Salvation`); Fornication (ID: `keyterm:Fornication`); पतरस (ID: `person:Peter`); Sky (ID: `keyterm:Heaven`); Ability (ID: `keyterm:Ability`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); याकूब (ID: `person:James`); यरूशलेम (ID: `place:Jerusalem`); Baptism (ID: `keyterm:Baptism`); यूहन्ना (ID: `person:John.2`); अन्यजाति (ID: `group:Gentile`); Serve (ID: `keyterm:Serve`); Condemn (ID: `keyterm:Condemn`); Life (ID: `keyterm:Life`); Glory (ID: `keyterm:Glory`); Authority (ID: `keyterm:Authority.2`); Fear (ID: `keyterm:Fear`); Ransom (ID: `keyterm:Ransom`); जब्दी (ID: `person:Zebedee`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Mercy (ID: `keyterm:Mercy`); A Group of People (ID: `group:GenericGroup`); दाऊद (ID: `person:David`); बरतिमाई (ID: `person:Bartimaeus`); तिमाई (ID: `person:Timaeus`); Be a Disciple (ID: `keyterm:Disciple`); To Command (ID: `keyterm:Command`); Cheer Up (ID: `keyterm:CheerUp`); Salvation (ID: `keyterm:Salvation`); यरीहो (ID: `place:Jericho`); Believe (ID: `keyterm:Believe`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Donkey (ID: `fauna:Donkey`); यीशु (ID: `person:Jesus.2`); Hosanna (ID: `keyterm:Hosanna`); यरूशलेम (ID: `place:Jerusalem`); बैतनिय्याह (ID: `place:Bethany`); A Group of People (ID: `group:GenericGroup`); Bless (ID: `keyterm:Bless`); Cloak (ID: `realia:Cloak`); बैतफगे (ID: `place:Bethphage`); Height (ID: `keyterm:Height`); Be a Disciple (ID: `keyterm:Disciple`); यहोवा (ID: `deity:Lord`); Kingdom (ID: `keyterm:Kingdom`); Name (ID: `keyterm:Name`); दाऊद (ID: `person:David`); Rush (ID: `flora:Rush`); Olive Tree (ID: `flora:OliveTree`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); Believe (ID: `keyterm:Believe`); Temple (ID: `realia:Temple`); Fig (ID: `flora:Fig`); यहोवा (ID: `deity:Lord`); Discern (ID: `keyterm:Discern`); यरूशलेम (ID: `place:Jerusalem`); बैतनिय्याह (ID: `place:Bethany`); यीशु (ID: `person:Jesus.2`); Heart (ID: `keyterm:Heart`); Fear (ID: `keyterm:Fear`); Be a Disciple (ID: `keyterm:Disciple`); Surely! (ID: `keyterm:Surely`); Forgive (ID: `keyterm:Forgive`); Always (ID: `keyterm:Always`); पतरस (ID: `person:Peter`); Sky (ID: `keyterm:Heaven`); Seat (ID: `realia:Seat`); Dove (ID: `fauna:Dove`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Authority (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); यीशु (ID: `person:Jesus.2`); यूहन्ना (ID: `person:John`); Fear (ID: `keyterm:Fear`); Parable (ID: `keyterm:Parable`); Sky (ID: `keyterm:Heaven`); Reject (ID: `keyterm:Reject`); यरूशलेम (ID: `place:Jerusalem`); यहोवा (ID: `deity:Lord`); Beloved (ID: `keyterm:Beloved`); Empty (ID: `keyterm:Empty`); Priests (ID: `group:GenericPriests`); Religious Officials (ID: `group:ReligiousOfficials`); Baptism (ID: `keyterm:Baptism`); Elders (ID: `group:GenericElders`); Written (ID: `keyterm:Scripture`); Believe (ID: `keyterm:Believe`); Winepress (ID: `realia:Winepress`); Temple (ID: `realia:Temple`); Watch-Tower (ID: `realia:Watch-tower`); Tower (ID: `realia:Tower`); Cornerstone (ID: `realia:Cornerstone`); Thorn Hedge (ID: `realia:ThornHedge`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); तिबिरियुस (ID: `person:Tiberius`); Resurrection (ID: `keyterm:Resurrection`); यीशु (ID: `person:Jesus.2`); मूसा (ID: `person:Moses`); हेरोदियों (ID: `group:Herodian`); The Way (ID: `keyterm:TheWay`); Life (ID: `keyterm:Life`); Hypocrisy (ID: `keyterm:Hypocrisy`); फरीसी (ID: `group:Pharisee`); इस्राएल (ID: `person:Israel`); इसहाक (ID: `person:Isaac`); Be Lawful (ID: `keyterm:Lawful`); Poll Tax (ID: `keyterm:PollTax`); An Angel (ID: `deity:Angel`); Truth (ID: `keyterm:Truth`); Sky (ID: `keyterm:Heaven`); अब्राहम (ID: `person:Abraham`); सदूकी (ID: `group:Sadducee`); Written (ID: `keyterm:Scripture`); Ability (ID: `keyterm:Ability`); True (ID: `keyterm:True`); Denarius (ID: `realia:Denarius`); Boxthorn (ID: `flora:Boxthorn`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Love (ID: `keyterm:Love`); यीशु (ID: `person:Jesus.2`); दाऊद (ID: `person:David`); Commandment (ID: `keyterm:Commandment`); A Priest (ID: `person:GenericPriest`); Heart (ID: `keyterm:Heart`); A Scribe (ID: `person:Scribe`); Treasury (ID: `realia:Treasury`); Daily Life (ID: `keyterm:DailyLife`); Pray (ID: `keyterm:Pray`); Judgment (ID: `keyterm:Judgment`); Offering (ID: `keyterm:Offering`); इस्राएल (ID: `person:Israel`); Be a Disciple (ID: `keyterm:Disciple`); Surely! (ID: `keyterm:Surely`); Mind (ID: `keyterm:Mind.2`); पवित्र आत्मा (ID: `deity:HolySpirit`); Truth (ID: `keyterm:Truth`); Kingdom (ID: `keyterm:Kingdom`); Quadrans (ID: `realia:Quadrans`); Lepton (ID: `realia:Lepton`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); Temple (ID: `realia:Temple`); Be a Disciple (ID: `keyterm:Disciple`); Good News (ID: `keyterm:GoodNews`); पतरस (ID: `person:Peter`); याकूब (ID: `person:James`); A Group of Disciples (ID: `group:GenericDisciples`); Symbol (ID: `keyterm:Example`); अन्द्रियास (ID: `person:Andrew`); Salvation (ID: `keyterm:Salvation`); पवित्र आत्मा (ID: `deity:HolySpirit`); यूहन्ना (ID: `person:John.2`); Bear Witness (ID: `keyterm:BearWitness`); Proclaim (ID: `keyterm:Proclaim`); Kingdom (ID: `keyterm:Kingdom`); Olive Tree (ID: `flora:OliveTree`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Sky (ID: `keyterm:Heaven`); यहोवा (ID: `deity:Lord`); Chosen (ID: `keyterm:Chosen`); House (ID: `realia:House`); An Angel (ID: `deity:Angel`); Ability (ID: `keyterm:Ability`); Pray (ID: `keyterm:Pray`); Believe (ID: `keyterm:Believe`); यीशु (ID: `person:Jesus.2`); Portent (ID: `keyterm:Portent`); यहूदिया (ID: `place:Judea`); Glory (ID: `keyterm:Glory`); Symbol (ID: `keyterm:Example`); Authority (ID: `keyterm:Authority.2`); Abomination of Desolation (ID: `keyterm:AbominationOfDesolation`); Surely! (ID: `keyterm:Surely`); To Command (ID: `keyterm:Command`); Parable (ID: `keyterm:Parable`); Salvation (ID: `keyterm:Salvation`); Body (ID: `keyterm:Body.3`); Disaster (ID: `keyterm:Disaster`); Housetop (ID: `realia:Housetop`); Door (ID: `realia:Door`); Cloak (ID: `realia:Cloak`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `flora:Myrrh`); Myrrh (ID: `realia:Myrrh`); बैतनिय्याह (ID: `place:Bethany`); शमौन (ID: `person:Simon.4`); Pure (ID: `keyterm:Pure`); यीशु (ID: `person:Jesus.2`); Good News (ID: `keyterm:GoodNews`); Surely! (ID: `keyterm:Surely`); A Group of Disciples (ID: `group:GenericDisciples`); Body (ID: `keyterm:Body.3`); Passover (ID: `keyterm:Passover`); यहूदा (ID: `person:Judas.2`); Ability (ID: `keyterm:Ability`); Proclaim (ID: `keyterm:Proclaim`); Promise (ID: `keyterm:Promise`); Nard (ID: `flora:Nard`); Alabaster Jar (ID: `realia:AlabasterJar`); Oil of Nard (ID: `realia:OilOfNard`); Denarius (ID: `realia:Denarius`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); यीशु (ID: `person:Jesus.2`); Surely! (ID: `keyterm:Surely`); Passover (ID: `keyterm:Passover`); Sheep (ID: `fauna:Lamb`); Blood (ID: `keyterm:Blood`); यहोवा (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Resurrection (ID: `keyterm:Resurrection`); Covenant (ID: `keyterm:Covenant`); Body (ID: `keyterm:Body.3`); पतरस (ID: `person:Peter`); Kingdom (ID: `keyterm:Kingdom`); Disaster (ID: `keyterm:Disaster`); Bless (ID: `keyterm:Bless`); गलील (ID: `place:Galilee`); Upstairs Room (ID: `realia:UpstairsRoom`); Guest Room (ID: `realia:GuestRoom`); Goat (ID: `fauna:Goat`); Rooster (ID: `fauna:Rooster`); Flock (ID: `fauna:Flock`); Bowl (ID: `realia:Bowl.2`); Olive Tree (ID: `flora:OliveTree`); Vine (ID: `flora:Vine`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); पतरस (ID: `person:Peter`); Linen (ID: `realia:Linen`); गतसमनी (ID: `place:Gethsemane`); Body (ID: `keyterm:Body.3`); Be a Disciple (ID: `keyterm:Disciple`); यहूदा (ID: `person:Judas.2`); यीशु (ID: `person:Jesus.2`); To Cause to Happen (ID: `keyterm:Happen`); याकूब (ID: `person:James`); यहोवा (ID: `deity:Lord`); Put to the Test (ID: `keyterm:PutToTheTest`); यूहन्ना (ID: `person:John.2`); Spirit (ID: `keyterm:Spirit.2`); Written (ID: `keyterm:Scripture`); Name (ID: `keyterm:Name`); Olive Tree (ID: `flora:OliveTree`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** पतरस (ID: `person:Peter`); यीशु (ID: `person:Jesus.2`); Rooster (ID: `fauna:Rooster`); गलील (ID: `place:Galilee`); Word (ID: `keyterm:Word`); नासरत (ID: `place:Nazareth`); True (ID: `keyterm:True`); गलीली (ID: `group:Galilee`); Courtyard (ID: `realia:Courtyard`); Entrance (ID: `realia:Entrance`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); यीशु (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Salvation (ID: `keyterm:Salvation`); एलिय्याह (ID: `person:Elijah`); Purple Cloth (ID: `realia:PurpleCloth`); Reed (ID: `flora:Reed`); Temple (ID: `realia:Temple`); Clothing (ID: `realia:Clothing`); सिकन्दर (ID: `person:Alexander`); गुलगुता (ID: `place:Golgotha`); रूफुस (ID: `person:Rufus`); Centurion at Crucifixion (ID: `person:Centurion.3`); शमौन (ID: `person:Simon.5`); कुरेने (ID: `place:Cyrene`); A Group of People (ID: `group:GenericGroup`); यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); Blaspheme (ID: `keyterm:Blaspheme`); Priests (ID: `group:GenericPriests`); Religious Officials (ID: `group:ReligiousOfficials`); Elders (ID: `group:GenericElders`); Bow Down (ID: `keyterm:BowDown`); Believe (ID: `keyterm:Believe`); True (ID: `keyterm:True`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Myrrh (ID: `flora:Myrrh`); Palace (ID: `realia:Palace`); Sour Wine (ID: `realia:SourWine`); Boxthorn (ID: `flora:Boxthorn`); Curtain (ID: `realia:Curtain`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`); Brier (ID: `flora:Brier`); Courtyard (ID: `realia:Courtyard`); Acacia (ID: `flora:Acacia`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** यूसुफ (ID: `person:Joseph.6`); मरियम (ID: `person:Mary.2`); Mary Magdalene (ID: `person:Marymagdalene`); पिलातुस (ID: `person:Pilate`); याकूब (ID: `person:James.4`); यूसुफ (ID: `person:Joseph.3`); अरिमतियाह (ID: `place:Arimathea`); सलोमी (ID: `person:Salome`); यूसुफ (ID: `person:Joseph.5`); Day Before the Sabbath (ID: `keyterm:DayBeforeTheSabbath`); यरूशलेम (ID: `place:Jerusalem`); यीशु (ID: `person:Jesus.2`); यहोवा (ID: `deity:Lord`); Body (ID: `keyterm:Body.3`); Kingdom (ID: `keyterm:Kingdom`); Serve (ID: `keyterm:Serve`); गलील (ID: `place:Galilee`); Grave (ID: `realia:Grave`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Angels (ID: `group:Angels`); सलोमी (ID: `person:Salome`); मरियम (ID: `person:Mary.2`); Sabbath (ID: `keyterm:Sabbath`); Week (ID: `keyterm:Week`); Imperishable (ID: `keyterm:Imperishable`); यीशु (ID: `person:Jesus.2`); Resurrection (ID: `keyterm:Resurrection`); Anointed (ID: `keyterm:Anointed`); Be a Disciple (ID: `keyterm:Disciple`); Surely! (ID: `keyterm:Surely`); To Command (ID: `keyterm:Command`); याकूब (ID: `person:James.3`); Salvation (ID: `keyterm:Salvation`); नासरत (ID: `place:Nazareth`); Mary Magdalene (ID: `person:Marymagdalene`); पतरस (ID: `person:Peter`); Fear (ID: `keyterm:Fear`); गलील (ID: `place:Galilee`); Cross (ID: `realia:Cross`); Cloak (ID: `realia:Cloak`); Aloes (ID: `realia:Aloes`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Disbelieve (ID: `keyterm:Disbelieve`); यीशु (ID: `person:Jesus.2`); Symbol (ID: `keyterm:Example`); Demons (ID: `deity:Demons`); Proclaim (ID: `keyterm:Proclaim`); Hardheartedness (ID: `keyterm:Hardheartedness`); Week (ID: `keyterm:Week`); Condemn (ID: `keyterm:Condemn`); यहोवा (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Resurrection (ID: `keyterm:Resurrection`); Baptism (ID: `keyterm:Baptism`); Good News (ID: `keyterm:GoodNews`); Salvation (ID: `keyterm:Salvation`); Name (ID: `keyterm:Name`); Mary Magdalene (ID: `person:Marymagdalene`); Sky (ID: `keyterm:Heaven`); Ability (ID: `keyterm:Ability`); Snake (ID: `fauna:Snake`)
