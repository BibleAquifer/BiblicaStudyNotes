...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यरूशलेम (ID: `place:Jerusalem`); Fear (ID: `keyterm:Fear`); मूसा (ID: `person:Moses`); हकल्याह (ID: `person:Hacaliah`); हनानी (ID: `person:Hanani.4`); शूशन (ID: `place:Susa`); नहेम्याह (ID: `person:Nehemiah.2`); Love (ID: `keyterm:Love`); Strength (ID: `keyterm:Strength`); Redeem (ID: `keyterm:Redeem`); यहूदा (ID: `person:Judah.4`); Decree (ID: `keyterm:Decree`); To Sin (ID: `keyterm:Sin`); Repent (ID: `keyterm:Repent`); Be Unfaithful (ID: `keyterm:Unfaithful`); Jews (ID: `group:Jews`); Kindness (ID: `keyterm:Kindness`); इस्राएल (ID: `person:Israel`); Covenant (ID: `keyterm:Covenant`); यहूदा (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** यरूशलेम (ID: `place:Jerusalem`); यहोवा (ID: `deity:Lord`); Horonites (ID: `group:Horonites`); तोबियाह (ID: `person:Tobiah.2`); Valley Gate (ID: `place:ValleyGate`); सम्बल्लत (ID: `person:Sanballat`); यहूदा (ID: `person:Judah.4`); Euphrates River (ID: `place:Euphrates`); अम्मोन (ID: `place:Ammon`); अम्मोनी (ID: `group:Ammon`); यहूदा (ID: `group:Judah`); Cattle (ID: `fauna:Bull`); गेशेम (ID: `person:Geshem`); आसाप (ID: `person:Asaph.4`); Dragon Spring (ID: `place:DragonSpring`); अर्तक्षत्र (ID: `person:Artaxerxes`); Fountain Gate (ID: `place:FountainGate`); Dung Gate (ID: `place:DungGate`); Rebel (ID: `keyterm:Rebel`); अरब (ID: `place:Arabia`); Siloam (ID: `place:Siloam`); Arabians (ID: `group:Arabia`); Fear (ID: `keyterm:Fear`); Jews (ID: `group:Jews`); इस्राएल (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); यरूशलेम (ID: `place:Jerusalem`); तोबियाह (ID: `person:Tobiah.2`); सम्बल्लत (ID: `person:Sanballat`); Jews (ID: `group:Jews`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); मशुल्लाम (ID: `person:Meshullam.12`); बेरेक्याह (ID: `person:Berechiah.5`); गेशेम (ID: `person:Geshem`); एल्याशीब (ID: `person:Eliashib.7`); मिस्पा (ID: `place:Mizpah`); Grain (ID: `flora:Grain`); Money (ID: `realia:Money`); Tower (ID: `realia:Tower`); हक्कोस (ID: `person:Hakkoz.3`); भेड़ फाटक (ID: `place:SheepGate`); ऊरिय्याह (ID: `person:Uriah.4`); ओपेल (ID: `place:Ophel`); अजर्याह (ID: `person:Azariah.17`); तकोआ (ID: `place:Tekoa`); मरेमोत (ID: `person:Meremoth`); Dung Gate (ID: `place:DungGate`); To Sin (ID: `keyterm:Sin`); Arabians (ID: `group:Arabia`); लेवी (ID: `person:Levi.3`); अरब (ID: `place:Arabia`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); यहोवा (ID: `deity:Lord`); एज्रा (ID: `person:Ezra`); Perceive (ID: `keyterm:Perceive`); लेवी (ID: `person:Levi.3`); इस्राएल (ID: `person:Israel`); लेवी (ID: `group:Levi`); Scroll (ID: `realia:Scroll`); जलफाटक (ID: `place:WaterGate`); Holy (ID: `keyterm:Holy`); एलाम (ID: `person:Elam`); मूसा (ID: `person:Moses`); येशुअ (ID: `person:Jeshua.4`); यरूशलेम (ID: `place:Jerusalem`); सुलैमान (ID: `person:Solomon`); Daric (ID: `realia:Daric`); शल्मै (ID: `person:Shalmai`); शोबै (ID: `person:Shobai`); हाशूम (ID: `person:Hashum.2`); केरोस (ID: `person:Keros`); यदायाह (ID: `person:Jedaiah.4`); महीदा (ID: `person:Mehida`); पदायाह (ID: `person:Pedaiah.5`); शेमा (ID: `person:Shema.4`); सीहा (ID: `person:Ziha`); शब्बतै (ID: `person:Shabbethai.2`); होदिय्याह (ID: `person:Hodiah.2`); नतोपा (ID: `place:Netophah`); गहर (ID: `person:Gahar`); आतेर (ID: `person:Ater.2`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); Dispossess (ID: `keyterm:Dispossess`); House (ID: `realia:House`); To Sin (ID: `keyterm:Sin`); इस्राएल (ID: `person:Israel`); शबन्याह (ID: `person:Shebaniah.2`); बानी (ID: `person:Bani.8`); कदमीएल (ID: `person:Kadmiel`); Sabbath (ID: `keyterm:Sabbath`); येशुअ (ID: `person:Jeshua.4`); मिस्र (ID: `place:Egypt`); Decree (ID: `keyterm:Decree`); Offering (ID: `keyterm:Offering`); बानी (ID: `person:Bani.11`); होदिय्याह (ID: `person:Hodiah.2`); शेरेब्याह (ID: `person:Sherebiah`); कनान (ID: `place:Canaan`); Generous (ID: `keyterm:Generous`); Truth (ID: `keyterm:Truth`); मूसा (ID: `person:Moses`); कनानी (ID: `group:Canaan`); Compassionate (ID: `keyterm:Compassionate`); Kindness (ID: `keyterm:Kindness`); Covenant (ID: `keyterm:Covenant`); Delight (ID: `keyterm:Delight`); Repent (ID: `keyterm:Repent`); Work (ID: `keyterm:Work`)
...
* **Associated ACAI Concepts:** लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); यरूशलेम (ID: `place:Jerusalem`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); यहोवा (ID: `deity:Lord`); House (ID: `realia:House`); Praise (ID: `keyterm:Praise`); बिन्यामीन (ID: `person:Benjamin`); यहोशू (ID: `person:Joshua.5`); बिन्यामीन (ID: `group:Benjamin`); योयादा (ID: `person:Joiada.2`); एज्रा (ID: `person:Ezra.2`); योयाकीम (ID: `person:Joiakim`); योहानान (ID: `person:Johanan.9`); बकबुक्याह (ID: `person:Bakbukiah`); मत्तन्याह (ID: `person:Mattaniah`); योयारीब (ID: `person:Joiarib`); एल्याशीब (ID: `person:Eliashib.8`); यिर्मयाह (ID: `person:Jeremiah.7`); यदायाह (ID: `person:Jedaiah.3`); शमायाह (ID: `person:Shemaiah.20`); दाऊद (ID: `person:David`); आमोक (ID: `person:Amok`); ओबद्याह (ID: `person:Obadiah.5`); गिन्नतोन (ID: `person:Ginnethon`); अमर्याह (ID: `person:Amariah.7`); यहूदा (ID: `person:Judah.7`); यदायाह (ID: `person:Jedaiah.5`); यद्दू (ID: `person:Jaddua.2`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); Sabbath (ID: `keyterm:Sabbath`); यरूशलेम (ID: `place:Jerusalem`); यहूदा (ID: `person:Judah.4`); इस्राएल (ID: `person:Israel`); यहूदा (ID: `group:Judah`); House (ID: `realia:House`); Pure (ID: `keyterm:Pure`); Offering (ID: `keyterm:Offering`); तोबियाह (ID: `person:Tobiah.2`); एल्याशीब (ID: `person:Eliashib.9`); Vine (ID: `flora:Vine`); सुलैमान (ID: `person:Solomon`); Holy (ID: `keyterm:Holy`); दाऊद (ID: `person:David`); अश्दोद (ID: `place:Ashdod`); अम्मोन (ID: `place:Ammon`); To Dishonor (ID: `keyterm:Dishonor`); Instruction (ID: `keyterm:Instruction`); मोआब (ID: `place:Moab`); Kindness (ID: `keyterm:Kindness`); एल्याशीब (ID: `person:Eliashib.8`); शेलेम्याह (ID: `person:Shelemiah.5`); जक्कूर (ID: `person:Zaccur.8`); Horonites (ID: `group:Horonites`); हानान (ID: `person:Hanan.8`); सादोक (ID: `person:Zadok.8`); पदायाह (ID: `person:Pedaiah.7`); आसाप (ID: `person:Asaph.2`); योयादा (ID: `person:Joiada.2`); मत्तन्याह (ID: `person:Mattaniah.10`); Grain (ID: `flora:Grain`); Frankincense (ID: `flora:Frankincense`); Mule (ID: `fauna:Mule`); Must (ID: `realia:Must`); Olive Tree (ID: `flora:OliveTree`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Love (ID: `keyterm:Love`); बेबीलोन (ID: `place:Babylon`); सोर (ID: `place:Tyre`); Well-Established (ID: `keyterm:BeFirm`); सोरी (ID: `group:Tyre`); हारून (ID: `person:Aaron`); जरूब्बाबेल (ID: `person:Zerubbabel.2`); Bless (ID: `keyterm:Bless`); To Sin (ID: `keyterm:Sin`); Swear (ID: `keyterm:Swear`); Priesthood (ID: `keyterm:Priesthood`); अर्तक्षत्र (ID: `person:Artaxerxes`); Be Unfaithful (ID: `keyterm:Unfaithful`); सम्बल्लत (ID: `person:Sanballat`); Jews (ID: `group:Jews`); मूसा (ID: `person:Moses`); अम्मोनी (ID: `group:Ammon`); Perceive (ID: `keyterm:Perceive`); Appoint (ID: `keyterm:Appoint`); Defilement (ID: `keyterm:Defilement`); Covenant (ID: `keyterm:Covenant`); नहेम्याह (ID: `person:Nehemiah.2`); बिलाम (ID: `person:Balaam`); Fish (ID: `fauna:Fish`); Donkey (ID: `fauna:Donkey`); Winepress (ID: `realia:Winepress`); Fig (ID: `flora:Fig`); Scroll (ID: `realia:Scroll`); Wine (ID: `realia:Wine`)
