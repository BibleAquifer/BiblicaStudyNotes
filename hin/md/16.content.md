...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यरूशलेम (ID: `place:Jerusalem`); Horonites (ID: `group:Horonites`); Valley Gate (ID: `place:ValleyGate`); तोबियाह (ID: `person:Tobiah.2`); सम्बल्लत (ID: `person:Sanballat`); अम्मोन (ID: `place:Ammon`); Euphrates River (ID: `place:Euphrates`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); अम्मोनी (ID: `group:Ammon`); Cattle (ID: `fauna:Bull`); Dung Gate (ID: `place:DungGate`); गेशेम (ID: `person:Geshem`); Dragon Spring (ID: `place:DragonSpring`); Fountain Gate (ID: `place:FountainGate`); आसाप (ID: `person:Asaph.4`); अर्तक्षत्र (ID: `person:Artaxerxes`); Rebel (ID: `keyterm:Rebel`); अरब (ID: `place:Arabia`); Siloam (ID: `place:Siloam`); Fear (ID: `keyterm:Fear`); Arabians (ID: `group:Arabia`); Jews (ID: `group:Jews`); इस्राएल (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यरूशलेम (ID: `place:Jerusalem`); Fear (ID: `keyterm:Fear`); तोबियाह (ID: `person:Tobiah.2`); सम्बल्लत (ID: `person:Sanballat`); Jews (ID: `group:Jews`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); गेशेम (ID: `person:Geshem`); मशुल्लाम (ID: `person:Meshullam.12`); बेरेक्याह (ID: `person:Berechiah.5`); एल्याशीब (ID: `person:Eliashib.7`); मिस्पा (ID: `place:Mizpah`); Money (ID: `realia:Money`); Tower (ID: `realia:Tower`); Grain (ID: `flora:Grain`); अजर्याह (ID: `person:Azariah.17`); भेड़ फाटक (ID: `place:SheepGate`); हक्कोस (ID: `person:Hakkoz.3`); ऊरिय्याह (ID: `person:Uriah.4`); ओपेल (ID: `place:Ophel`); तकोआ (ID: `place:Tekoa`); Dung Gate (ID: `place:DungGate`); मरेमोत (ID: `person:Meremoth`); लेवी (ID: `group:Levi`); दाऊद (ID: `person:David`); लेवी (ID: `person:Levi.3`); अम्मोन (ID: `place:Ammon`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); यहोवा (ID: `deity:Lord`); एज्रा (ID: `person:Ezra`); Perceive (ID: `keyterm:Perceive`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); इस्राएल (ID: `person:Israel`); Scroll (ID: `realia:Scroll`); जलफाटक (ID: `place:WaterGate`); Holy (ID: `keyterm:Holy`); एलाम (ID: `person:Elam`); येशुअ (ID: `person:Jeshua.4`); सुलैमान (ID: `person:Solomon`); मूसा (ID: `person:Moses`); यरूशलेम (ID: `place:Jerusalem`); Daric (ID: `realia:Daric`); सोतै (ID: `person:Sotai`); शल्मै (ID: `person:Shalmai`); सीहा (ID: `person:Ziha`); हानान (ID: `person:Hanan.5`); शब्बतै (ID: `person:Shabbethai.2`); बर्जिल्लै (ID: `person:Barzillai.3`); बेसै (ID: `person:Bezai`); तेमह (ID: `person:Temah`); सोपेरेत (ID: `person:Sophereth`); हादीद (ID: `place:Hadid`); हगाबा (ID: `person:Hagabah`); शल्लूम (ID: `person:Shallum.8`); महीदा (ID: `person:Mehida`); बिगवै (ID: `person:Bigvai.2`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); Dispossess (ID: `keyterm:Dispossess`); House (ID: `realia:House`); इस्राएल (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); शबन्याह (ID: `person:Shebaniah.2`); बानी (ID: `person:Bani.8`); कदमीएल (ID: `person:Kadmiel`); येशुअ (ID: `person:Jeshua.4`); Sabbath (ID: `keyterm:Sabbath`); Offering (ID: `keyterm:Offering`); Decree (ID: `keyterm:Decree`); मिस्र (ID: `place:Egypt`); बानी (ID: `person:Bani.11`); होदिय्याह (ID: `person:Hodiah.2`); शेरेब्याह (ID: `person:Sherebiah`); Truth (ID: `keyterm:Truth`); मूसा (ID: `person:Moses`); Repent (ID: `keyterm:Repent`); कनान (ID: `place:Canaan`); Compassionate (ID: `keyterm:Compassionate`); Generous (ID: `keyterm:Generous`); Delight (ID: `keyterm:Delight`); Work (ID: `keyterm:Work`); Kindness (ID: `keyterm:Kindness`); कनानी (ID: `group:Canaan`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); यरूशलेम (ID: `place:Jerusalem`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); यहोवा (ID: `deity:Lord`); House (ID: `realia:House`); यहोशू (ID: `person:Joshua.5`); बिन्यामीन (ID: `group:Benjamin`); Praise (ID: `keyterm:Praise`); बिन्यामीन (ID: `person:Benjamin`); योयादा (ID: `person:Joiada.2`); बकबुक्याह (ID: `person:Bakbukiah`); योहानान (ID: `person:Johanan.9`); एज्रा (ID: `person:Ezra.2`); योयाकीम (ID: `person:Joiakim`); यिर्मयाह (ID: `person:Jeremiah.7`); एल्याशीब (ID: `person:Eliashib.8`); मत्तन्याह (ID: `person:Mattaniah`); शमायाह (ID: `person:Shemaiah.20`); योयारीब (ID: `person:Joiarib`); यदायाह (ID: `person:Jedaiah.3`); दाऊद (ID: `person:David`); मल्लूक (ID: `person:Malluch.4`); गिन्नतोन (ID: `person:Ginnethon`); मीका (ID: `person:Mica.3`); यद्दू (ID: `person:Jaddua.2`); अमर्याह (ID: `person:Amariah.7`); शबन्याह (ID: `person:Shebaniah.3`); अबिय्याह (ID: `person:Abijah.7`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); Sabbath (ID: `keyterm:Sabbath`); यरूशलेम (ID: `place:Jerusalem`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); इस्राएल (ID: `person:Israel`); House (ID: `realia:House`); Pure (ID: `keyterm:Pure`); Offering (ID: `keyterm:Offering`); तोबियाह (ID: `person:Tobiah.2`); एल्याशीब (ID: `person:Eliashib.9`); Vine (ID: `flora:Vine`); Instruction (ID: `keyterm:Instruction`); मोआब (ID: `place:Moab`); अम्मोन (ID: `place:Ammon`); Kindness (ID: `keyterm:Kindness`); To Dishonor (ID: `keyterm:Dishonor`); सुलैमान (ID: `person:Solomon`); अश्दोद (ID: `place:Ashdod`); दाऊद (ID: `person:David`); Holy (ID: `keyterm:Holy`); एल्याशीब (ID: `person:Eliashib.8`); Horonites (ID: `group:Horonites`); आसाप (ID: `person:Asaph.2`); शेलेम्याह (ID: `person:Shelemiah.5`); योयादा (ID: `person:Joiada.2`); सादोक (ID: `person:Zadok.8`); पदायाह (ID: `person:Pedaiah.7`); हानान (ID: `person:Hanan.8`); मत्तन्याह (ID: `person:Mattaniah.10`); जक्कूर (ID: `person:Zaccur.8`); Frankincense (ID: `flora:Frankincense`); Olive Oil (ID: `realia:OliveOil`); Must (ID: `realia:Must`); Mule (ID: `fauna:Mule`); Grain (ID: `flora:Grain`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); जरूब्बाबेल (ID: `person:Zerubbabel.2`); Priesthood (ID: `keyterm:Priesthood`); सोर (ID: `place:Tyre`); To Sin (ID: `keyterm:Sin`); Swear (ID: `keyterm:Swear`); हारून (ID: `person:Aaron`); Love (ID: `keyterm:Love`); Bless (ID: `keyterm:Bless`); मूसा (ID: `person:Moses`); बेबीलोन (ID: `place:Babylon`); सोरी (ID: `group:Tyre`); Defilement (ID: `keyterm:Defilement`); बिलाम (ID: `person:Balaam`); सम्बल्लत (ID: `person:Sanballat`); अर्तक्षत्र (ID: `person:Artaxerxes`); Covenant (ID: `keyterm:Covenant`); अम्मोनी (ID: `group:Ammon`); Perceive (ID: `keyterm:Perceive`); Well-Established (ID: `keyterm:BeFirm`); नहेम्याह (ID: `person:Nehemiah.2`); Be Unfaithful (ID: `keyterm:Unfaithful`); Appoint (ID: `keyterm:Appoint`); Jews (ID: `group:Jews`); Fig (ID: `flora:Fig`); Scroll (ID: `realia:Scroll`); Fish (ID: `fauna:Fish`); Wine (ID: `realia:Wine`); Donkey (ID: `fauna:Donkey`); Winepress (ID: `realia:Winepress`)
