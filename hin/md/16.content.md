...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); यरूशलेम (ID: `place:Jerusalem`); मूसा (ID: `person:Moses`); नहेम्याह (ID: `person:Nehemiah.2`); हकल्याह (ID: `person:Hacaliah`); शूशन (ID: `place:Susa`); हनानी (ID: `person:Hanani.4`); Repent (ID: `keyterm:Repent`); Kindness (ID: `keyterm:Kindness`); Strength (ID: `keyterm:Strength`); Be Unfaithful (ID: `keyterm:Unfaithful`); Redeem (ID: `keyterm:Redeem`); यहूदा (ID: `group:Judah`); Covenant (ID: `keyterm:Covenant`); यहूदा (ID: `person:Judah.4`); Jews (ID: `group:Jews`); To Sin (ID: `keyterm:Sin`); Decree (ID: `keyterm:Decree`); इस्राएल (ID: `person:Israel`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** यरूशलेम (ID: `place:Jerusalem`); यहोवा (ID: `deity:Lord`); Horonites (ID: `group:Horonites`); Valley Gate (ID: `place:ValleyGate`); तोबियाह (ID: `person:Tobiah.2`); सम्बल्लत (ID: `person:Sanballat`); अम्मोन (ID: `place:Ammon`); यहूदा (ID: `group:Judah`); अम्मोनी (ID: `group:Ammon`); यहूदा (ID: `person:Judah.4`); Euphrates River (ID: `place:Euphrates`); Cattle (ID: `fauna:Bull`); Dung Gate (ID: `place:DungGate`); गेशेम (ID: `person:Geshem`); Fountain Gate (ID: `place:FountainGate`); आसाप (ID: `person:Asaph.4`); अर्तक्षत्र (ID: `person:Artaxerxes`); Dragon Spring (ID: `place:DragonSpring`); Arabians (ID: `group:Arabia`); Siloam (ID: `place:Siloam`); Fear (ID: `keyterm:Fear`); Rebel (ID: `keyterm:Rebel`); अरब (ID: `place:Arabia`); Jews (ID: `group:Jews`); इस्राएल (ID: `person:Israel`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); यरूशलेम (ID: `place:Jerusalem`); सम्बल्लत (ID: `person:Sanballat`); तोबियाह (ID: `person:Tobiah.2`); Jews (ID: `group:Jews`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); गेशेम (ID: `person:Geshem`); एल्याशीब (ID: `person:Eliashib.7`); मशुल्लाम (ID: `person:Meshullam.12`); बेरेक्याह (ID: `person:Berechiah.5`); मिस्पा (ID: `place:Mizpah`); Tower (ID: `realia:Tower`); Money (ID: `realia:Money`); Grain (ID: `flora:Grain`); ओपेल (ID: `place:Ophel`); ऊरिय्याह (ID: `person:Uriah.4`); अजर्याह (ID: `person:Azariah.17`); हक्कोस (ID: `person:Hakkoz.3`); भेड़ फाटक (ID: `place:SheepGate`); मरेमोत (ID: `person:Meremoth`); तकोआ (ID: `place:Tekoa`); Dung Gate (ID: `place:DungGate`); Arabians (ID: `group:Arabia`); अम्मोनी (ID: `group:Ammon`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); यहोवा (ID: `deity:Lord`); एज्रा (ID: `person:Ezra`); Perceive (ID: `keyterm:Perceive`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); इस्राएल (ID: `person:Israel`); Scroll (ID: `realia:Scroll`); जलफाटक (ID: `place:WaterGate`); Holy (ID: `keyterm:Holy`); एलाम (ID: `person:Elam`); मूसा (ID: `person:Moses`); येशुअ (ID: `person:Jeshua.4`); सुलैमान (ID: `person:Solomon`); यरूशलेम (ID: `place:Jerusalem`); Daric (ID: `realia:Daric`); आरह (ID: `person:Arah.2`); दर्कोन (ID: `person:Darkon`); हत्तील (ID: `person:Hattil`); नबो (ID: `place:Nebo.2`); मल्किय्याह (ID: `person:Malchijah.9`); हिजकिय्याह (ID: `person:Hezekiah.2`); यामीन (ID: `person:Jamin.3`); नकोदा (ID: `person:Nekoda`); बेसै (ID: `person:Besai`); हादीद (ID: `place:Hadid`); हर्हूर (ID: `person:Harhur`); आमी (ID: `person:Ami`); हारीम (ID: `person:Harim.2`); लबाना (ID: `person:Lebanah`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); Dispossess (ID: `keyterm:Dispossess`); House (ID: `realia:House`); इस्राएल (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); शबन्याह (ID: `person:Shebaniah.2`); बानी (ID: `person:Bani.8`); कदमीएल (ID: `person:Kadmiel`); मिस्र (ID: `place:Egypt`); येशुअ (ID: `person:Jeshua.4`); Offering (ID: `keyterm:Offering`); Decree (ID: `keyterm:Decree`); Sabbath (ID: `keyterm:Sabbath`); बानी (ID: `person:Bani.11`); होदिय्याह (ID: `person:Hodiah.2`); शेरेब्याह (ID: `person:Sherebiah`); मूसा (ID: `person:Moses`); Compassionate (ID: `keyterm:Compassionate`); Delight (ID: `keyterm:Delight`); Repent (ID: `keyterm:Repent`); Covenant (ID: `keyterm:Covenant`); कनानी (ID: `group:Canaan`); Kindness (ID: `keyterm:Kindness`); कनान (ID: `place:Canaan`); Truth (ID: `keyterm:Truth`); Work (ID: `keyterm:Work`); Generous (ID: `keyterm:Generous`)
...
* **Associated ACAI Concepts:** लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); यरूशलेम (ID: `place:Jerusalem`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); यहोवा (ID: `deity:Lord`); House (ID: `realia:House`); बिन्यामीन (ID: `group:Benjamin`); Praise (ID: `keyterm:Praise`); यहोशू (ID: `person:Joshua.5`); बिन्यामीन (ID: `person:Benjamin`); एज्रा (ID: `person:Ezra.2`); बकबुक्याह (ID: `person:Bakbukiah`); योयाकीम (ID: `person:Joiakim`); योहानान (ID: `person:Johanan.9`); योयादा (ID: `person:Joiada.2`); मत्तन्याह (ID: `person:Mattaniah`); एल्याशीब (ID: `person:Eliashib.8`); यिर्मयाह (ID: `person:Jeremiah.7`); यदायाह (ID: `person:Jedaiah.3`); शमायाह (ID: `person:Shemaiah.20`); योयारीब (ID: `person:Joiarib`); दाऊद (ID: `person:David`); यहूदा (ID: `person:Judah.7`); ओबद्याह (ID: `person:Obadiah.5`); मल्लूक (ID: `person:Malluch.4`); मीका (ID: `person:Mica.3`); शबन्याह (ID: `person:Shebaniah.3`); इद्दो (ID: `person:Iddo.7`); अबिय्याह (ID: `person:Abijah.7`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); Sabbath (ID: `keyterm:Sabbath`); यरूशलेम (ID: `place:Jerusalem`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); इस्राएल (ID: `person:Israel`); House (ID: `realia:House`); Pure (ID: `keyterm:Pure`); Offering (ID: `keyterm:Offering`); तोबियाह (ID: `person:Tobiah.2`); एल्याशीब (ID: `person:Eliashib.9`); Vine (ID: `flora:Vine`); Kindness (ID: `keyterm:Kindness`); अम्मोन (ID: `place:Ammon`); दाऊद (ID: `person:David`); अश्दोद (ID: `place:Ashdod`); To Dishonor (ID: `keyterm:Dishonor`); Instruction (ID: `keyterm:Instruction`); Holy (ID: `keyterm:Holy`); सुलैमान (ID: `person:Solomon`); मोआब (ID: `place:Moab`); एल्याशीब (ID: `person:Eliashib.8`); पदायाह (ID: `person:Pedaiah.7`); आसाप (ID: `person:Asaph.2`); योयादा (ID: `person:Joiada.2`); Horonites (ID: `group:Horonites`); हानान (ID: `person:Hanan.8`); शेलेम्याह (ID: `person:Shelemiah.5`); सादोक (ID: `person:Zadok.8`); मत्तन्याह (ID: `person:Mattaniah.10`); जक्कूर (ID: `person:Zaccur.8`); Frankincense (ID: `flora:Frankincense`); Grain (ID: `flora:Grain`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Must (ID: `realia:Must`); Olive Oil (ID: `realia:OliveOil`); बेबीलोन (ID: `place:Babylon`); हारून (ID: `person:Aaron`); Priesthood (ID: `keyterm:Priesthood`); Well-Established (ID: `keyterm:BeFirm`); Be Unfaithful (ID: `keyterm:Unfaithful`); Bless (ID: `keyterm:Bless`); नहेम्याह (ID: `person:Nehemiah.2`); Swear (ID: `keyterm:Swear`); Covenant (ID: `keyterm:Covenant`); अम्मोनी (ID: `group:Ammon`); मूसा (ID: `person:Moses`); सम्बल्लत (ID: `person:Sanballat`); Appoint (ID: `keyterm:Appoint`); Defilement (ID: `keyterm:Defilement`); अर्तक्षत्र (ID: `person:Artaxerxes`); सोरी (ID: `group:Tyre`); Perceive (ID: `keyterm:Perceive`); सोर (ID: `place:Tyre`); To Sin (ID: `keyterm:Sin`); Jews (ID: `group:Jews`); बिलाम (ID: `person:Balaam`); जरूब्बाबेल (ID: `person:Zerubbabel.2`); Love (ID: `keyterm:Love`); Wine (ID: `realia:Wine`); Winepress (ID: `realia:Winepress`); Fig (ID: `flora:Fig`); Scroll (ID: `realia:Scroll`); Fish (ID: `fauna:Fish`); Donkey (ID: `fauna:Donkey`)
