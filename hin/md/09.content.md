...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); हन्ना (ID: `person:Hannah`); एली (ID: `person:Eli`); एल्काना (ID: `person:Elkanah.2`); रामाह (ID: `place:Ramah`); House (ID: `realia:House`); शीलो (ID: `place:Shiloh`); पनिन्ना (ID: `person:Peninnah`); Horn (ID: `keyterm:Horn`); Vow (ID: `keyterm:Vow`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); तोहू (ID: `person:Tohu`); पीनहास (ID: `person:Phinehas.2`); यरोहाम (ID: `person:Jeroham`); एलीहू (ID: `person:Elihu`); शमूएल (ID: `person:Samuel`); सूफ (ID: `person:Zuph`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); होप्नी (ID: `person:Hophni`); Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); Loyal Person (ID: `keyterm:LoyalPerson`); नरक (ID: `place:Hell`); Glory (ID: `keyterm:Glory`); Wickedness (ID: `keyterm:Wickedness`); Slaughtering (ID: `keyterm:Slaughtering`); इस्राएल (ID: `person:Israel`); Anointed (ID: `keyterm:Anointed`); Peace (ID: `keyterm:IntactState`); Salvation (ID: `keyterm:Salvation`); एप्रैम (ID: `person:Ephraim`); Holy (ID: `keyterm:Holy`); एप्रैम (ID: `group:Ephraim`); Favor (ID: `keyterm:Favor`); Throne (ID: `realia:Throne`); Doorpost (ID: `realia:Doorpost`); Skin-Bottle (ID: `realia:Skin-bottle`); Bow (ID: `realia:Bow`); Razor (ID: `realia:Razor`); Ephah (ID: `realia:Ephah`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); शमूएल (ID: `person:Samuel`); शाऊल (ID: `person:Saul.2`); इस्राएल (ID: `person:Israel`); बिन्यामीन (ID: `group:Benjamin`); बिन्यामीन (ID: `person:Benjamin`); Force to Serve (ID: `keyterm:EnticedToServe`); Speak as a Prophet (ID: `keyterm:Speak`); Jabesh-gilead (ID: `place:Jabesh-gilead`); Donkey (ID: `fauna:Donkey`); High Place (ID: `realia:HighPlace`); कीश (ID: `person:Kish`); Stone Pine (ID: `flora:Pine`); Slaughtering (ID: `keyterm:Slaughtering`); मिस्र (ID: `place:Egypt`); अम्मोनी (ID: `group:Ammon`); अम्मोन (ID: `place:Ammon`); An Angel (ID: `deity:Angel`); Gibeah (ID: `place:Gibeah.2`); Fear (ID: `keyterm:Fear`); नाहाश (ID: `person:Nahash`); पलिश्ती (ID: `group:Philistine`); Offering (ID: `keyterm:Offering`); To Sin (ID: `keyterm:Sin`); Philistia (ID: `place:Philistine`); Gilgal (ID: `place:Gilgal.2`); A Group of People (ID: `group:GenericGroup`); मूसा (ID: `person:Moses`); Men (ID: `group:GenericMales`); हारून (ID: `person:Aaron`)
...
* **Associated ACAI Concepts:** शाऊल (ID: `person:Saul.2`); यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); योनातान (ID: `person:Jonathan.3`); शमूएल (ID: `person:Samuel`); पलिश्ती (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); अमालेक (ID: `place:Amalek`); मिकमाश (ID: `place:Michmash`); अमालेकी (ID: `group:Amalek`); Gilgal (ID: `place:Gilgal.2`); To Sin (ID: `keyterm:Sin`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); अगाग (ID: `person:Agag.2`); Hebrews (ID: `group:Hebrews`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Gibeah (ID: `place:Gibeah.2`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); बिन्यामीन (ID: `group:Benjamin`); बिन्यामीन (ID: `person:Benjamin`); Sword (ID: `realia:Sword`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); गेबा (ID: `place:Geba`); मिस्र (ID: `place:Egypt`); Sheep (ID: `fauna:Lamb`); नेर (ID: `person:Ner.2`); अब्नेर (ID: `person:Abner`); बेतावेन (ID: `place:Beth-aven`)
...
* **Associated ACAI Concepts:** दाऊद (ID: `person:David`); पलिश्ती (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); शाऊल (ID: `person:Saul.2`); यहोवा (ID: `deity:Lord`); यिशै (ID: `person:Jesse`); इस्राएल (ID: `person:Israel`); शमूएल (ID: `person:Samuel`); बैतलहम (ID: `place:Bethlehem`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Peace (ID: `keyterm:IntactState`); Sword (ID: `realia:Sword`); एलीआब (ID: `person:Eliab.3`); Smear (ID: `keyterm:Smear`); बैतलहमवासी (ID: `group:Bethlehem`); गत (ID: `place:Gath`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); Sheep (ID: `fauna:Lamb`); गोलियत (ID: `person:Goliath`); अबीनादाब (ID: `person:Abinadab.3`); Valley of Elah (ID: `place:ElahValley`); शिमआह (ID: `person:Shimeah.2`); Slaughtering (ID: `keyterm:Slaughtering`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); अब्नेर (ID: `person:Abner`); Fear (ID: `keyterm:Fear`); Spear (ID: `realia:Spear`); Bear (ID: `fauna:Bear`)
...
* **Associated ACAI Concepts:** दाऊद (ID: `person:David`); शाऊल (ID: `person:Saul.2`); यहोवा (ID: `deity:Lord`); योनातान (ID: `person:Jonathan.3`); पलिश्ती (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); कीला (ID: `place:Keilah`); अहीमेलेक (ID: `person:Ahimelech`); इस्राएल (ID: `person:Israel`); मीकल (ID: `person:Michal`); यिशै (ID: `person:Jesse`); Love (ID: `keyterm:Love`); An Angel (ID: `deity:Angel`); Fear (ID: `keyterm:Fear`); एब्यातार (ID: `person:Abiathar`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Naioth (ID: `place:Naioth`); रामाह (ID: `place:Ramah`); Speak as a Prophet (ID: `keyterm:Speak`); दोएग (ID: `person:Doeg`); अहीतूब (ID: `person:Ahitub`); Wilderness of Ziph (ID: `place:Ziph.2`); होरेश (ID: `place:Horesh`); नोब (ID: `place:Nob`); आकीश (ID: `person:Achish`); यहूदा (ID: `person:Judah.4`); एदोम (ID: `place:Edom`); Peace (ID: `keyterm:IntactState`); Swear (ID: `keyterm:Swear`); शमूएल (ID: `person:Samuel`)
...
* **Associated ACAI Concepts:** दाऊद (ID: `person:David`); यहोवा (ID: `deity:Lord`); शाऊल (ID: `person:Saul.2`); नाबाल (ID: `person:Nabal`); अबीगैल (ID: `person:Abigail`); इस्राएल (ID: `person:Israel`); Bless (ID: `keyterm:Bless`); Anointed (ID: `keyterm:Anointed`); कर्मेल (ID: `place:Carmel`); अबीशै (ID: `person:Abishai`); अब्नेर (ID: `person:Abner`); Spear (ID: `realia:Spear`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Donkey (ID: `fauna:Donkey`); हकीला (ID: `place:Hachilah`); Wickedness (ID: `keyterm:Wickedness`); To Sin (ID: `keyterm:Sin`); Swear (ID: `keyterm:Swear`); नेर (ID: `person:Ner.2`); An Angel (ID: `deity:Angel`); Rebel (ID: `keyterm:Rebel`); यशीमोन (ID: `place:Jeshimon`); Wilderness of Ziph (ID: `place:Ziph.2`); Clay Jar (ID: `realia:ClayJar`); अहीमेलेक (ID: `person:Ahimelech.2`); गल्लीम (ID: `place:Gallim`); कालेबवंशी (ID: `group:Caleb`)
...
* **Associated ACAI Concepts:** दाऊद (ID: `person:David`); शाऊल (ID: `person:Saul.2`); पलिश्ती (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); आकीश (ID: `person:Achish`); यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); शमूएल (ID: `person:Samuel`); अमालेक (ID: `place:Amalek`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); यिज्रेल (ID: `place:Jezreel`); सिकलग (ID: `place:Ziklag`); Necromancer (ID: `keyterm:Spirit`); अमालेकी (ID: `group:Amalek`); Negev (ID: `place:Negeb`); Fear (ID: `keyterm:Fear`); गत (ID: `place:Gath`); बसोर (ID: `place:Besor`); Jabesh-gilead (ID: `place:Jabesh-gilead`); गिलबो पर्वत (ID: `place:GilboaMount`); मिस्र (ID: `place:Egypt`); Strength (ID: `keyterm:Strength`); कर्मेल (ID: `place:Carmel`); यरहमेलियों (ID: `group:Jerahmeel`); यरहमेल (ID: `person:Jerahmeel`); यिज्रेल (ID: `place:Jezreel.2`); अहीनोअम (ID: `person:Ahinoam.2`); यिज्रेल (ID: `group:Jezreel`); A Woman (ID: `person:GenericFemale`)
