...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); हन्ना (ID: `person:Hannah`); एली (ID: `person:Eli`); एल्काना (ID: `person:Elkanah.2`); रामाह (ID: `place:Ramah`); House (ID: `realia:House`); शीलो (ID: `place:Shiloh`); पनिन्ना (ID: `person:Peninnah`); Horn (ID: `keyterm:Horn`); Vow (ID: `keyterm:Vow`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); यरोहाम (ID: `person:Jeroham`); एलीहू (ID: `person:Elihu`); तोहू (ID: `person:Tohu`); सूफ (ID: `person:Zuph`); शमूएल (ID: `person:Samuel`); पीनहास (ID: `person:Phinehas.2`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Salvation (ID: `keyterm:Salvation`); Wickedness (ID: `keyterm:Wickedness`); नरक (ID: `place:Hell`); Glory (ID: `keyterm:Glory`); Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); Slaughtering (ID: `keyterm:Slaughtering`); Peace (ID: `keyterm:IntactState`); Anointed (ID: `keyterm:Anointed`); एप्रैम (ID: `group:Ephraim`); होप्नी (ID: `person:Hophni`); इस्राएल (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Loyal Person (ID: `keyterm:LoyalPerson`); Favor (ID: `keyterm:Favor`); एप्रैम (ID: `person:Ephraim`); Skin-Bottle (ID: `realia:Skin-bottle`); Bow (ID: `realia:Bow`); Throne (ID: `realia:Throne`); Doorpost (ID: `realia:Doorpost`); Razor (ID: `realia:Razor`); Ephah (ID: `realia:Ephah`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); Covenant Box (ID: `keyterm:CovenantBox`); शमूएल (ID: `person:Samuel`); Philistia (ID: `place:Philistine`); पलिश्ती (ID: `group:Philistine`); एली (ID: `person:Eli`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Offering (ID: `keyterm:Offering`); Tumors (ID: `keyterm:Tumors`); बेतशेमेश (ID: `place:Beth-shemesh`); अश्दोद (ID: `place:Ashdod`); मिस्पा (ID: `place:Mizpah`); दागोन (ID: `deity:Dagon`); पीनहास (ID: `person:Phinehas.2`); शीलो (ID: `place:Shiloh`); Slaughtering (ID: `keyterm:Slaughtering`); होप्नी (ID: `person:Hophni`); House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); एक्रोन (ID: `place:Ekron`); Wagon (ID: `realia:Wagon`); एबेनेजेर (ID: `place:Ebenezer`); Word of the Lord (ID: `keyterm:WordOfTheLord`); किर्यत्यारीम (ID: `place:Kiriath-jearim`); Force to Serve (ID: `keyterm:EnticedToServe`); Glory (ID: `keyterm:Glory`); To Sin (ID: `keyterm:Sin`); गत (ID: `place:Gath`); मिस्र (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); शमूएल (ID: `person:Samuel`); शाऊल (ID: `person:Saul.2`); इस्राएल (ID: `person:Israel`); बिन्यामीन (ID: `group:Benjamin`); बिन्यामीन (ID: `person:Benjamin`); Force to Serve (ID: `keyterm:EnticedToServe`); Speak as a Prophet (ID: `keyterm:Speak`); Jabesh-gilead (ID: `place:Jabesh-gilead`); Donkey (ID: `fauna:Donkey`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); कीश (ID: `person:Kish`); अम्मोन (ID: `place:Ammon`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); अम्मोनी (ID: `group:Ammon`); Gibeah (ID: `place:Gibeah.2`); Slaughtering (ID: `keyterm:Slaughtering`); मिस्र (ID: `place:Egypt`); नाहाश (ID: `person:Nahash`); Philistia (ID: `place:Philistine`); Gilgal (ID: `place:Gilgal.2`); Offering (ID: `keyterm:Offering`); To Sin (ID: `keyterm:Sin`); पलिश्ती (ID: `group:Philistine`); मूसा (ID: `person:Moses`); Smear (ID: `keyterm:Smear`); हारून (ID: `person:Aaron`); Men (ID: `group:GenericMales`)
...
* **Associated ACAI Concepts:** शाऊल (ID: `person:Saul.2`); यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); योनातान (ID: `person:Jonathan.3`); शमूएल (ID: `person:Samuel`); Philistia (ID: `place:Philistine`); पलिश्ती (ID: `group:Philistine`); अमालेक (ID: `place:Amalek`); मिकमाश (ID: `place:Michmash`); Gilgal (ID: `place:Gilgal.2`); अमालेकी (ID: `group:Amalek`); To Sin (ID: `keyterm:Sin`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); अगाग (ID: `person:Agag.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Gibeah (ID: `place:Gibeah.2`); Hebrews (ID: `group:Hebrews`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); बिन्यामीन (ID: `group:Benjamin`); बिन्यामीन (ID: `person:Benjamin`); Goat (ID: `fauna:Goat`); Sword (ID: `realia:Sword`); Flock (ID: `fauna:Flock`); गेबा (ID: `place:Geba`); मिस्र (ID: `place:Egypt`); Sheep (ID: `fauna:Lamb`); नेर (ID: `person:Ner.2`); अब्नेर (ID: `person:Abner`); अहीमेलेक (ID: `person:Ahimelech`)
...
* **Associated ACAI Concepts:** दाऊद (ID: `person:David`); पलिश्ती (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); शाऊल (ID: `person:Saul.2`); यहोवा (ID: `deity:Lord`); यिशै (ID: `person:Jesse`); इस्राएल (ID: `person:Israel`); शमूएल (ID: `person:Samuel`); बैतलहम (ID: `place:Bethlehem`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Peace (ID: `keyterm:IntactState`); Sword (ID: `realia:Sword`); एलीआब (ID: `person:Eliab.3`); Smear (ID: `keyterm:Smear`); गत (ID: `place:Gath`); बैतलहमवासी (ID: `group:Bethlehem`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); Sheep (ID: `fauna:Lamb`); गोलियत (ID: `person:Goliath`); अबीनादाब (ID: `person:Abinadab.3`); Valley of Elah (ID: `place:ElahValley`); शिमआह (ID: `person:Shimeah.2`); Fear (ID: `keyterm:Fear`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Slaughtering (ID: `keyterm:Slaughtering`); अब्नेर (ID: `person:Abner`); Sling (ID: `realia:Sling`); Bear (ID: `fauna:Bear`)
...
* **Associated ACAI Concepts:** दाऊद (ID: `person:David`); शाऊल (ID: `person:Saul.2`); यहोवा (ID: `deity:Lord`); योनातान (ID: `person:Jonathan.3`); Philistia (ID: `place:Philistine`); पलिश्ती (ID: `group:Philistine`); कीला (ID: `place:Keilah`); अहीमेलेक (ID: `person:Ahimelech`); इस्राएल (ID: `person:Israel`); मीकल (ID: `person:Michal`); An Angel (ID: `deity:Angel`); यिशै (ID: `person:Jesse`); Love (ID: `keyterm:Love`); Fear (ID: `keyterm:Fear`); एब्यातार (ID: `person:Abiathar`); Naioth (ID: `place:Naioth`); New Moon Festival (ID: `keyterm:NewMoonFestival`); रामाह (ID: `place:Ramah`); Speak as a Prophet (ID: `keyterm:Speak`); दोएग (ID: `person:Doeg`); अहीतूब (ID: `person:Ahitub`); Wilderness of Ziph (ID: `place:Ziph.2`); होरेश (ID: `place:Horesh`); नोब (ID: `place:Nob`); आकीश (ID: `person:Achish`); यहूदा (ID: `group:Judah`); शमूएल (ID: `person:Samuel`); Arrow (ID: `keyterm:Arrow`); यहूदा (ID: `person:Judah.4`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** दाऊद (ID: `person:David`); यहोवा (ID: `deity:Lord`); शाऊल (ID: `person:Saul.2`); नाबाल (ID: `person:Nabal`); अबीगैल (ID: `person:Abigail`); इस्राएल (ID: `person:Israel`); Bless (ID: `keyterm:Bless`); Anointed (ID: `keyterm:Anointed`); अबीशै (ID: `person:Abishai`); कर्मेल (ID: `place:Carmel`); अब्नेर (ID: `person:Abner`); Goat (ID: `fauna:Goat`); Spear (ID: `realia:Spear`); Flock (ID: `fauna:Flock`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Donkey (ID: `fauna:Donkey`); हकीला (ID: `place:Hachilah`); नेर (ID: `person:Ner.2`); यशीमोन (ID: `place:Jeshimon`); An Angel (ID: `deity:Angel`); Wickedness (ID: `keyterm:Wickedness`); To Sin (ID: `keyterm:Sin`); Swear (ID: `keyterm:Swear`); Rebel (ID: `keyterm:Rebel`); Wilderness of Ziph (ID: `place:Ziph.2`); Clay Jar (ID: `realia:ClayJar`); गल्लीम (ID: `place:Gallim`); यिज्रेल (ID: `place:Jezreel`); अहीमेलेक (ID: `person:Ahimelech.2`)
...
* **Associated ACAI Concepts:** दाऊद (ID: `person:David`); शाऊल (ID: `person:Saul.2`); Philistia (ID: `place:Philistine`); पलिश्ती (ID: `group:Philistine`); आकीश (ID: `person:Achish`); यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); शमूएल (ID: `person:Samuel`); अमालेक (ID: `place:Amalek`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); यिज्रेल (ID: `place:Jezreel`); सिकलग (ID: `place:Ziklag`); Necromancer (ID: `keyterm:Spirit`); Fear (ID: `keyterm:Fear`); Negev (ID: `place:Negeb`); गत (ID: `place:Gath`); अमालेकी (ID: `group:Amalek`); Jabesh-gilead (ID: `place:Jabesh-gilead`); बसोर (ID: `place:Besor`); गिलबो पर्वत (ID: `place:GilboaMount`); Strength (ID: `keyterm:Strength`); कर्मेल (ID: `place:Carmel`); मिस्र (ID: `place:Egypt`); यरहमेलियों (ID: `group:Jerahmeel`); यरहमेल (ID: `person:Jerahmeel`); यिज्रेल (ID: `place:Jezreel.2`); अहीनोअम (ID: `person:Ahinoam.2`); यिज्रेल (ID: `group:Jezreel`); नाबाल (ID: `person:Nabal`)
