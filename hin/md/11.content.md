...
* **Associated ACAI Concepts:** सुलैमान (ID: `person:Solomon`); यहोवा (ID: `deity:Lord`); दाऊद (ID: `person:David`); अदोनिय्याह (ID: `person:Adonijah`); इस्राएल (ID: `person:Israel`); बनायाह (ID: `person:Benaiah`); यहोयादा (ID: `person:Jehoiada`); नातान (ID: `person:Nathan.2`); सादोक (ID: `person:Zadok.2`); योआब (ID: `person:Joab`); एब्यातार (ID: `person:Abiathar`); बतशेबा (ID: `person:Bathsheba`); शिमी (ID: `person:Shimei.5`); Swear (ID: `keyterm:Swear`); अबीशग (ID: `person:Abishag`); यरूशलेम (ID: `place:Jerusalem`); Shunammites (ID: `group:Shunammites`); यहूदा (ID: `group:Judah`); Ability (ID: `keyterm:Ability`); यहूदा (ID: `person:Judah.4`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Perceive (ID: `keyterm:Perceive`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); हग्गीत (ID: `person:Haggith`); गिलाद (ID: `place:Gilead`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); House (ID: `realia:House`); दाऊद (ID: `person:David`); Holy (ID: `keyterm:Holy`); सुलैमान (ID: `person:Solomon`); Force to Serve (ID: `keyterm:EnticedToServe`); इस्राएल (ID: `person:Israel`); Straightness (ID: `keyterm:Straightness`); Plea for Mercy (ID: `keyterm:Supplication`); मिस्र (ID: `place:Egypt`); Decree (ID: `keyterm:Decree`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Proverb (ID: `keyterm:Saying`); गिबोन (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** सुलैमान (ID: `person:Solomon`); यहोवा (ID: `deity:Lord`); दाऊद (ID: `person:David`); इस्राएल (ID: `person:Israel`); यरूशलेम (ID: `place:Jerusalem`); फ़िरौन (ID: `person:Pharaoh.7`); Ability (ID: `keyterm:Ability`); मिस्र (ID: `place:Egypt`); हदद (ID: `person:Hadad.3`); एदोम (ID: `place:Edom`); हीराम (ID: `person:Hiram`); यारोबाम (ID: `person:Jeroboam`); House (ID: `realia:House`); Queen of Sheba (ID: `person:QueenOfSheba`); अम्मोन (ID: `place:Ammon`); अम्मोनी (ID: `group:Ammon`); Money (ID: `realia:Money`); गेजेर (ID: `place:Gezer`); मोआब (ID: `place:Moab`); मिल्लो (ID: `place:Millo`); Offering (ID: `keyterm:Offering`); सीदोन (ID: `place:Sidon`); Sidonians (ID: `group:Sidon`); Love (ID: `keyterm:Love`); हित्ती (ID: `group:Hittite`); मोलेक (ID: `deity:Molech`); योआब (ID: `person:Joab`); Heth (ID: `person:Heth`); एदोमी (ID: `group:Edom`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यारोबाम (ID: `person:Jeroboam`); इस्राएल (ID: `person:Israel`); रहबाम (ID: `person:Rehoboam`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); बेतेल (ID: `place:Bethel`); दाऊद (ID: `person:David`); अहिय्याह (ID: `person:Ahijah.2`); सुलैमान (ID: `person:Solomon`); यरूशलेम (ID: `place:Jerusalem`); House (ID: `realia:House`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); To Sin (ID: `keyterm:Sin`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Donkey (ID: `fauna:Donkey`); Yoke (ID: `realia:Yoke`); Counsel (ID: `keyterm:Counsel`); Rebel (ID: `keyterm:Rebel`); शीलो (ID: `place:Shiloh`); मिस्र (ID: `place:Egypt`); Lion (ID: `fauna:Lion`); नामाह (ID: `person:Naamah`); नबात (ID: `person:Nebat`); शेकेम (ID: `place:Shechem`)
