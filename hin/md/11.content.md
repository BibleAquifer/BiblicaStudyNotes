...
* **Associated ACAI Concepts:** अबीशग (ID: `person:Abishag`); अदोनिय्याह (ID: `person:Adonijah`); बतशेबा (ID: `person:Bathsheba`); Shunammites (ID: `group:Shunammites`); बनायाह (ID: `person:Benaiah`); यहोयादा (ID: `person:Jehoiada`); शिमी (ID: `person:Shimei.5`); नातान (ID: `person:Nathan.2`); एब्यातार (ID: `person:Abiathar`); सादोक (ID: `person:Zadok.2`); सुलैमान (ID: `person:Solomon`); शिमी (ID: `person:Shimei.6`); Prostitute (ID: `person:FirstProstitute`); योआब (ID: `person:Joab`); House (ID: `realia:House`); हग्गीत (ID: `person:Haggith`); बाना (ID: `person:Baana`); Goose (ID: `fauna:Goose`); बासमत (ID: `person:Basemath.2`); एला (ID: `person:Ela`); तिप्सह (ID: `place:Tiphsah`); अहीनादाब (ID: `person:Ahinadab`); Ben-hur (ID: `person:Ben-hur`); अबीनादाब (ID: `person:Abinadab.4`); Deker (ID: `person:Deker`); अहीमास (ID: `person:Ahimaaz.3`); बाना (ID: `person:Baana.2`); जाबूद (ID: `person:Zabud`); एलीहोरोप (ID: `person:Elihoreph`); पारुह (ID: `person:Paruah`)
...
* **Associated ACAI Concepts:** Floor (ID: `realia:Floor`); Aleppo Pine (ID: `flora:PineTree`); हीराम (ID: `person:Hiram`); Bottle Gourd (ID: `flora:BottleGourd`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Forgive (ID: `keyterm:Forgive`); हीराम (ID: `person:Hiram.2`); Fir (ID: `flora:Fir`); Hall of Pillars (ID: `place:HallOfPillars`); Rafts (ID: `realia:Rafts`); Hall of Judgment (ID: `place:HallOfJudgment`); Hall of the Throne (ID: `place:HallOfTheThrone`); Wheel (ID: `realia:Wheel`); परमपवित्र स्थान (ID: `place:MostHolyPlace`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Lily (ID: `flora:Lily`); Bath (ID: `realia:Bath`); Room (ID: `realia:Room`); गबाली (ID: `group:Gebal`); Stone Plane (ID: `realia:StonePlane`); Ability (ID: `keyterm:Ability`); गबल (ID: `place:Gebal`); सारतान (ID: `place:Zarethan`); Wick Trimmer (ID: `realia:WickTrimmer`); House of the Forest of Lebanon (ID: `place:HouseOfTheForestOfLebanon`); Bowl (ID: `realia:Bowl`); Bread of Display (ID: `realia:BreadOfDisplay`); Handbreadth (ID: `realia:Handbreadth`); Brook of Egypt (ID: `place:BrookOfEgypt`); Hammer (ID: `realia:Hammer`)
...
* **Associated ACAI Concepts:** Straightness (ID: `keyterm:Straightness`); यहोवा (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** हदद (ID: `person:Hadad.3`); फ़िरौन (ID: `person:Pharaoh.7`); Queen of Sheba (ID: `person:QueenOfSheba`); तहपनेस (ID: `person:Tahpenes`); यारोबाम (ID: `person:Jeroboam`); गनूबत (ID: `person:Genubath`); कबूल (ID: `place:Cabul.2`); सरूआह (ID: `person:Zeruah`); एल्यादा (ID: `person:Eliada.2`); Zeredah (ID: `place:Zeredah.2`); रजोन (ID: `person:Rezon`); Talent (ID: `realia:Talent`); House of the Forest of Lebanon (ID: `place:HouseOfTheForestOfLebanon`); अश्तोरेत (ID: `deity:Ashtoreth`); ओपीर (ID: `place:Ophir`); बालात (ID: `place:Baalath.2`); Baboon (ID: `fauna:Baboon`); Monkey (ID: `fauna:Monkey`); Kue (ID: `place:Kue`); अहिय्याह (ID: `person:Ahijah.2`); Sheba (ID: `place:Sheba.2`); Detested Thing (ID: `keyterm:DetestedThing`); Sandalwood (ID: `flora:Sandalwood`); Throne (ID: `realia:Throne`); शीलोवासी (ID: `group:Shiloh`); शीशक (ID: `person:Shishak`); Sycomore Fig (ID: `flora:SycomoreFig`); हासोर (ID: `place:Hazor`); Shephelah (ID: `place:Shephelah`); Large Shield (ID: `realia:LargeShield`)
...
* **Associated ACAI Concepts:** अहिय्याह (ID: `person:Ahijah.2`); रहबाम (ID: `person:Rehoboam`); यारोबाम (ID: `person:Jeroboam`); Yoke (ID: `realia:Yoke`); Word of the Lord (ID: `keyterm:WordOfTheLord`); अबिय्याह (ID: `person:Abijah.3`); नामाह (ID: `person:Naamah`); Lion (ID: `fauna:Lion`); Whip (ID: `realia:Whip`); Scorpion (ID: `fauna:Scorpion`); नबात (ID: `person:Nebat`); शमायाह (ID: `person:Shemaiah`); अदोराम (ID: `person:Adoram`); शीशक (ID: `person:Shishak`); तिर्सा (ID: `place:Tirzah`); अबिय्याह (ID: `person:Abijah.4`); बेतेल (ID: `place:Bethel`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Donkey (ID: `fauna:Donkey`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); सुलैमान (ID: `person:Solomon`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); House (ID: `realia:House`); इस्राएल (ID: `person:Israel`); दाऊद (ID: `person:David`)
...
* **Associated ACAI Concepts:** ओबद्याह (ID: `person:Obadiah`); जिम्री (ID: `person:Zimri.2`); नाबोत (ID: `person:Naboth`); बेन्हदद (ID: `person:Ben-hadad`); बाशा (ID: `person:Baasha`); ओम्री (ID: `person:Omri`); एला (ID: `person:Elah.2`); ईजेबेल (ID: `person:Jezebel`); अहाब (ID: `person:Ahab`); Micaiah (ID: `person:Micaiah.5`); आसा (ID: `person:Asa`); एलिय्याह (ID: `person:Elijah`); यहोशाफात (ID: `person:Jehoshaphat.3`); नादाब (ID: `person:Nadab.2`); अहिय्याह (ID: `person:Ahijah.3`); सामरिया (ID: `place:Samaria`); गीनत (ID: `person:Ginath`); तिब्नी (ID: `person:Tibni`); करीत (ID: `place:Cherith`); Stone Altar (ID: `realia:StoneAltar`); कर्मेल पर्वत (ID: `place:CarmelMount`); येहू (ID: `person:Jehu`); गिब्बतोन (ID: `place:Gibbethon`); तिशबी (ID: `group:Tishbite`); तिशबी (ID: `place:Tishbe`); अहज्याह (ID: `person:Ahaziah`); अर्सा (ID: `person:Arza`); सगूब (ID: `person:Segub`); अबीराम (ID: `person:Abiram.2`); हेज्योन (ID: `person:Hezion`)
