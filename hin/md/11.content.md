...
* **Associated ACAI Concepts:** सुलैमान (ID: `person:Solomon`); यहोवा (ID: `deity:Lord`); दाऊद (ID: `person:David`); अदोनिय्याह (ID: `person:Adonijah`); इस्राएल (ID: `person:Israel`); बनायाह (ID: `person:Benaiah`); यहोयादा (ID: `person:Jehoiada`); नातान (ID: `person:Nathan.2`); सादोक (ID: `person:Zadok.2`); योआब (ID: `person:Joab`); एब्यातार (ID: `person:Abiathar`); बतशेबा (ID: `person:Bathsheba`); शिमी (ID: `person:Shimei.5`); Swear (ID: `keyterm:Swear`); अबीशग (ID: `person:Abishag`); यरूशलेम (ID: `place:Jerusalem`); Shunammites (ID: `group:Shunammites`); यहूदा (ID: `person:Judah.4`); Peace (ID: `keyterm:IntactState`); Ability (ID: `keyterm:Ability`); यहूदा (ID: `group:Judah`); House (ID: `realia:House`); Perceive (ID: `keyterm:Perceive`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); हग्गीत (ID: `person:Haggith`); अबशालोम (ID: `person:Absalom`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); House (ID: `realia:House`); सुलैमान (ID: `person:Solomon`); Force to Serve (ID: `keyterm:EnticedToServe`); Holy (ID: `keyterm:Holy`); इस्राएल (ID: `person:Israel`); दाऊद (ID: `person:David`); Straightness (ID: `keyterm:Straightness`); गिबोन (ID: `place:Gibeon`); Proverb (ID: `keyterm:Saying`); Decree (ID: `keyterm:Decree`); मिस्र (ID: `place:Egypt`); Plea for Mercy (ID: `keyterm:Supplication`); To Beg for Mercy (ID: `keyterm:BegForMercy`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यारोबाम (ID: `person:Jeroboam`); इस्राएल (ID: `person:Israel`); रहबाम (ID: `person:Rehoboam`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); बेतेल (ID: `place:Bethel`); दाऊद (ID: `person:David`); अहिय्याह (ID: `person:Ahijah.2`); यरूशलेम (ID: `place:Jerusalem`); सुलैमान (ID: `person:Solomon`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); To Sin (ID: `keyterm:Sin`); High Place (ID: `realia:HighPlace`); Donkey (ID: `fauna:Donkey`); Stone Pine (ID: `flora:Pine`); Yoke (ID: `realia:Yoke`); मिस्र (ID: `place:Egypt`); शीलो (ID: `place:Shiloh`); Rebel (ID: `keyterm:Rebel`); Counsel (ID: `keyterm:Counsel`); Lion (ID: `fauna:Lion`); नामाह (ID: `person:Naamah`); नबात (ID: `person:Nebat`); शेकेम (ID: `place:Shechem`)
