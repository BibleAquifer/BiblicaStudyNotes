...
* **Associated Passages:** 3 यूहन्ना 1:1-15
...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); Beloved (ID: `keyterm:Beloved`); Bear Witness (ID: `keyterm:BearWitness`); Church (ID: `keyterm:Church`); Love (ID: `keyterm:Love`); Live (ID: `keyterm:Live.3`); यहोवा (ID: `deity:Lord`); Name (ID: `keyterm:Name`); दिमेत्रियुस (ID: `person:Demetrius`); गयुस (ID: `person:Gaius.4`); दियुत्रिफेस (ID: `person:Diotrephes`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Obligated (ID: `keyterm:Ought`); Hope (ID: `keyterm:Hope`); Good (ID: `keyterm:Good`); True (ID: `keyterm:True`); Pray (ID: `keyterm:Pray`); Make Peace (ID: `keyterm:Peace`); Faithfulness (ID: `keyterm:Faithfulness`); Do Good (ID: `keyterm:DoGood`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); Reed (ID: `flora:Reed`)
