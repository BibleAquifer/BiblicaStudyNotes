...
* **Associated Passages:** योएल 1:1-20
* **Associated Articles:** पाप (ID: `183089@BiblicaStudyNotesKeyTerms`); प्रार्थना (ID: `183121@BiblicaStudyNotesKeyTerms`); न्याय  (ID: `183127@BiblicaStudyNotesKeyTerms`); मिस्र (ID: `183145@BiblicaStudyNotesKeyTerms`); परमेश्वर के लोग  (ID: `183196@BiblicaStudyNotesKeyTerms`); दस विपत्तियाँ  (ID: `183202@BiblicaStudyNotesKeyTerms`); पश्चाताप (ID: `183240@BiblicaStudyNotesKeyTerms`); उपवास (ID: `183350@BiblicaStudyNotesKeyTerms`); दक्षिणी राज्य (ID: `183374@BiblicaStudyNotesKeyTerms`); प्रभु का दिन (ID: `183465@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Offering (ID: `keyterm:Offering`); Must (ID: `realia:Must`); Grain (ID: `flora:Grain`); Sackcloth (ID: `realia:Sackcloth`); Fig (ID: `flora:Fig`); पतूएल (ID: `person:Pethuel`); योएल (ID: `person:Joel.14`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Holy (ID: `keyterm:Holy`); Locust (ID: `fauna:Locust`); Goat (ID: `fauna:Goat`); Barn (ID: `realia:Barn`); Flock (ID: `fauna:Flock`); Pomegranate (ID: `flora:Pomegranate`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Olive Oil (ID: `realia:OliveOil`); Cattle (ID: `fauna:Bull`); Stone Altar (ID: `realia:StoneAltar`); Mule (ID: `fauna:Mule`); Wheat (ID: `flora:Wheat`); Altar (ID: `realia:Altar`); Olive Tree (ID: `flora:OliveTree`); Anointing Oil (ID: `realia:AnointingOil`); Lion (ID: `fauna:Lion`); Barley (ID: `flora:Barley`); Date Palm (ID: `flora:DatePalm`); Grass (ID: `flora:Grass`)
...
* **Associated Passages:** योएल 2:1-27
...
* **Associated Passages:** योएल 2:28-3:21
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यरूशलेम (ID: `place:Jerusalem`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); इस्राएल (ID: `person:Israel`); किद्रोन (ID: `place:Kidron`); Valley of Shittim (ID: `place:ShittimValley`); यूनानी (ID: `group:Greek`); सबाई (ID: `group:Sabean`); Exempt (ID: `keyterm:Exempt`); सोर (ID: `place:Tyre`); Philistia (ID: `place:Philistine`); A Man (ID: `person:GenericMale`); सीदोन (ID: `place:Sidon`); शेबा (ID: `person:Sheba`); Speak as a Prophet (ID: `keyterm:Speak`); Symbol (ID: `keyterm:Example`); अन्यजाति (ID: `group:Gentile`); Lot (ID: `keyterm:Lot`); एदोम (ID: `place:Edom`); यावान (ID: `person:Javan`); मिस्र (ID: `place:Egypt`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); Holy (ID: `keyterm:Holy`); Refuge (ID: `keyterm:Refuge`); Fear (ID: `keyterm:Fear`); To Cause to Possess (ID: `keyterm:Possess`); Pruning Knife (ID: `realia:PruningKnife`); Winepress (ID: `realia:Winepress`); Fortress (ID: `realia:Fortress`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); Spear (ID: `realia:Spear`); Mattock (ID: `realia:Mattock`); Wine (ID: `realia:Wine`); Sickle (ID: `realia:Sickle`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`)
