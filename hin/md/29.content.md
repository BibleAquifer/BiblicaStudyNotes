...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Offering (ID: `keyterm:Offering`); Must (ID: `realia:Must`); Fig (ID: `flora:Fig`); Sackcloth (ID: `realia:Sackcloth`); Grain (ID: `flora:Grain`); योएल (ID: `person:Joel.14`); पतूएल (ID: `person:Pethuel`); Holy (ID: `keyterm:Holy`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Locust (ID: `fauna:Locust`); Stone Altar (ID: `realia:StoneAltar`); Olive Oil (ID: `realia:OliveOil`); Pomegranate (ID: `flora:Pomegranate`); Cattle (ID: `fauna:Bull`); Lion (ID: `fauna:Lion`); Barley (ID: `flora:Barley`); Goat (ID: `fauna:Goat`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Mule (ID: `fauna:Mule`); Wheat (ID: `flora:Wheat`); Altar (ID: `realia:Altar`); Barn (ID: `realia:Barn`); Anointing Oil (ID: `realia:AnointingOil`); Temple Altar (ID: `realia:TempleAltar`); Date Palm (ID: `flora:DatePalm`); Flock (ID: `fauna:Flock`); Olive Tree (ID: `flora:OliveTree`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यरूशलेम (ID: `place:Jerusalem`); Fear (ID: `keyterm:Fear`); Vine (ID: `flora:Vine`); Holy (ID: `keyterm:Holy`); Rams Horn (ID: `realia:RamsHorn`); Olive Oil (ID: `realia:OliveOil`); Must (ID: `realia:Must`); Mule (ID: `fauna:Mule`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); To Cause to Possess (ID: `keyterm:Possess`); Be Zealous (ID: `keyterm:Zealous`); Garden of Eden (ID: `place:Eden.2`); Kindness (ID: `keyterm:Kindness`); Bless (ID: `keyterm:Bless`); Compassionate (ID: `keyterm:Compassionate`); Generous (ID: `keyterm:Generous`); Offering (ID: `keyterm:Offering`); इस्राएल (ID: `person:Israel`); Stone Altar (ID: `realia:StoneAltar`); House (ID: `realia:House`); Fig (ID: `flora:Fig`); Weapons (ID: `realia:Weapons`); Window (ID: `realia:Window`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Locust (ID: `fauna:Locust`); Wine (ID: `realia:Wine`); Horse (ID: `fauna:Horse`); Grain (ID: `flora:Grain`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Chariot (ID: `realia:Chariot`); Threshing Floor (ID: `realia:ThreshingFloor`); Grass (ID: `flora:Grass`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यरूशलेम (ID: `place:Jerusalem`); यहूदा (ID: `group:Judah`); यहूदा (ID: `person:Judah.4`); किद्रोन (ID: `place:Kidron`); इस्राएल (ID: `person:Israel`); सबाई (ID: `group:Sabean`); Valley of Shittim (ID: `place:ShittimValley`); यूनानी (ID: `group:Greek`); एदोम (ID: `place:Edom`); सोर (ID: `place:Tyre`); To Cause to Possess (ID: `keyterm:Possess`); Philistia (ID: `place:Philistine`); सीदोन (ID: `place:Sidon`); Exempt (ID: `keyterm:Exempt`); मिस्र (ID: `place:Egypt`); Lot (ID: `keyterm:Lot`); Fear (ID: `keyterm:Fear`); यावान (ID: `person:Javan`); Holy (ID: `keyterm:Holy`); शेबा (ID: `person:Sheba`); Symbol (ID: `keyterm:Example`); Refuge (ID: `keyterm:Refuge`); A Man (ID: `person:GenericMale`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); अन्यजाति (ID: `group:Gentile`); Speak as a Prophet (ID: `keyterm:Speak`); Pruning Knife (ID: `realia:PruningKnife`); Fortress (ID: `realia:Fortress`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); Sickle (ID: `realia:Sickle`); Spear (ID: `realia:Spear`); Wine (ID: `realia:Wine`); Mattock (ID: `realia:Mattock`); Winepress (ID: `realia:Winepress`)
