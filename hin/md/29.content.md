...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Offering (ID: `keyterm:Offering`); Sackcloth (ID: `realia:Sackcloth`); Grain (ID: `flora:Grain`); Must (ID: `realia:Must`); Fig (ID: `flora:Fig`); योएल (ID: `person:Joel.14`); पतूएल (ID: `person:Pethuel`); Holy (ID: `keyterm:Holy`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Locust (ID: `fauna:Locust`); Wheat (ID: `flora:Wheat`); Barn (ID: `realia:Barn`); Flock (ID: `fauna:Flock`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Goat (ID: `fauna:Goat`); Date Palm (ID: `flora:DatePalm`); Grass (ID: `flora:Grass`); Lion (ID: `fauna:Lion`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Barley (ID: `flora:Barley`); Mule (ID: `fauna:Mule`); Olive Tree (ID: `flora:OliveTree`); Pomegranate (ID: `flora:Pomegranate`); Anointing Oil (ID: `realia:AnointingOil`); Stone Altar (ID: `realia:StoneAltar`); Cattle (ID: `fauna:Bull`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); यरूशलेम (ID: `place:Jerusalem`); यहूदा (ID: `person:Judah.4`); यहूदा (ID: `group:Judah`); किद्रोन (ID: `place:Kidron`); इस्राएल (ID: `person:Israel`); यूनानी (ID: `group:Greek`); Valley of Shittim (ID: `place:ShittimValley`); सबाई (ID: `group:Sabean`); Exempt (ID: `keyterm:Exempt`); Speak as a Prophet (ID: `keyterm:Speak`); सोर (ID: `place:Tyre`); To Cause to Possess (ID: `keyterm:Possess`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); Philistia (ID: `place:Philistine`); Holy (ID: `keyterm:Holy`); Symbol (ID: `keyterm:Example`); सीदोन (ID: `place:Sidon`); A Man (ID: `person:GenericMale`); शेबा (ID: `person:Sheba`); Lot (ID: `keyterm:Lot`); Fear (ID: `keyterm:Fear`); Refuge (ID: `keyterm:Refuge`); अन्यजाति (ID: `group:Gentile`); यावान (ID: `person:Javan`); मिस्र (ID: `place:Egypt`); एदोम (ID: `place:Edom`); Pruning Knife (ID: `realia:PruningKnife`); Mattock (ID: `realia:Mattock`); Sword (ID: `realia:Sword`); Winepress (ID: `realia:Winepress`); Fortress (ID: `realia:Fortress`); Spear (ID: `realia:Spear`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); Sickle (ID: `realia:Sickle`); Wine (ID: `realia:Wine`)
