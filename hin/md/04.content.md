...
* **Associated ACAI Concepts:** मूसा (ID: `person:Moses`); यहोवा (ID: `deity:Lord`); हारून (ID: `person:Aaron`); इस्राएल (ID: `person:Israel`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); गेर्शोन (ID: `person:Gershon`); कहात (ID: `person:Kohath`); Holy (ID: `keyterm:Holy`); मरारी (ID: `person:Merari`); Force to Serve (ID: `keyterm:EnticedToServe`); Gershonites (ID: `group:Gershon`); यहूदा (ID: `group:Judah`); दान (ID: `group:Dan`); रूबेन (ID: `group:Reuben`); यहूदा (ID: `person:Judah.4`); कहातियों (ID: `group:Kohath`); एप्रैम (ID: `group:Ephraim`); दान (ID: `place:Dan`); एप्रैम (ID: `person:Ephraim`); रूबेन (ID: `person:Reuben`); Tent of Meeting (ID: `realia:TentOfMeeting`); Standard (ID: `realia:Standard`); ईतामार (ID: `person:Ithamar`); Wilderness of Sinai (ID: `place:SinaiWilderness`); जबूलून (ID: `group:Zebulun`); इस्साकार (ID: `group:Issachar`); जबूलून (ID: `person:Zebulun`); नप्ताली (ID: `person:Naphtali`); आशेर (ID: `group:Asher`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); मूसा (ID: `person:Moses`); Passover (ID: `keyterm:Passover`); Trumpet (ID: `realia:Trumpet`); Standard (ID: `realia:Standard`); Offering (ID: `keyterm:Offering`); Defilement (ID: `keyterm:Defilement`); Wilderness of Sinai (ID: `place:SinaiWilderness`); Covenant Box (ID: `keyterm:CovenantBox`); हारून (ID: `person:Aaron`); Testimony (ID: `keyterm:Witness.2`); यित्रो (ID: `person:Jethro`); पगीएल (ID: `person:Pagiel`); होबाब (ID: `person:Hobab`); पदासूर (ID: `person:Pedahzur`); एनान (ID: `person:Enan`); एल्यासाप (ID: `person:Eliasaph`); ओक्रान (ID: `person:Ochran`); अम्मीहूद (ID: `person:Ammihud`); कहातियों (ID: `group:Kohath`); अहीरा (ID: `person:Ahira`); एलीसूर (ID: `person:Elizur`); एलीआब (ID: `person:Eliab`); अबीदान (ID: `person:Abidan`); सूआर (ID: `person:Zuar`); दूएल (ID: `person:Deuel`); सूरीशद्दै (ID: `person:Zurishaddai`); अहीएजेर (ID: `person:Ahiezer`); गमलीएल (ID: `person:Gamaliel.2`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); मूसा (ID: `person:Moses`); इस्राएल (ID: `person:Israel`); मिस्र (ID: `place:Egypt`); हारून (ID: `person:Aaron`); कालेब (ID: `person:Caleb`); नून (ID: `person:Nun`); कनान (ID: `place:Canaan`); यहोशू (ID: `person:Joshua.2`); मिर्याम (ID: `person:Miriam`); यपुन्ने (ID: `person:Jephunneh`); अमालेक (ID: `place:Amalek`); कनानी (ID: `group:Canaan`); अमालेकी (ID: `group:Amalek`); Tent (ID: `realia:Tent`); पारान (ID: `place:Paran`); अनाक (ID: `person:Anak`); Speak as a Prophet (ID: `keyterm:Speak`); Negev (ID: `place:Negeb`); Forgive (ID: `keyterm:Forgive`); Passion (ID: `keyterm:Ardour`); Glory (ID: `keyterm:Glory`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Dispossess (ID: `keyterm:Dispossess`); Swear (ID: `keyterm:Swear`); किब्रोतहत्तावा (ID: `place:Kibroth-hattaavah`); एलदाद (ID: `person:Eldad`); मेदाद (ID: `person:Medad`); हसेरोत (ID: `place:Hazeroth`); Valley of Eshcol (ID: `place:EshcolValley`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); मूसा (ID: `person:Moses`); इस्राएल (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); हारून (ID: `person:Aaron`); Defilement (ID: `keyterm:Defilement`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); कोरह (ID: `person:Korah.3`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); अबीराम (ID: `person:Abiram`); To Cause to Possess (ID: `keyterm:Possess`); Holy (ID: `keyterm:Holy`); Pure (ID: `keyterm:Pure`); दातान (ID: `person:Dathan`); Force to Serve (ID: `keyterm:EnticedToServe`); To Cleanse (ID: `keyterm:Cleanse.2`); Testimony (ID: `keyterm:Witness.2`); Tent of Meeting (ID: `realia:TentOfMeeting`); Cattle (ID: `fauna:Bull`); Rod (ID: `realia:Rod`); Instruction (ID: `keyterm:Instruction`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); एलीआजर (ID: `person:Eleazar.2`); Appease (ID: `keyterm:Appease`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Shovel (ID: `realia:Shovel`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); बिलाम (ID: `person:Balaam`); बालाक (ID: `person:Balak`); इस्राएल (ID: `person:Israel`); मोआब (ID: `place:Moab`); मूसा (ID: `person:Moses`); An Angel (ID: `deity:Angel`); To Curse (ID: `keyterm:Curse`); हारून (ID: `person:Aaron`); Amorites (ID: `group:Amorites`); Bless (ID: `keyterm:Bless`); मिस्र (ID: `place:Egypt`); सीहोन (ID: `person:Sihon`); एदोम (ID: `place:Edom`); Proverb (ID: `keyterm:Saying`); अर्नोन (ID: `place:Arnon`); हेशबोन (ID: `place:Heshbon`); सिप्पोर (ID: `person:Zippor`); होर पर्वत (ID: `place:HorMount`); Donkey (ID: `fauna:Donkey`); Kadesh-barnea (ID: `place:Kadesh-barnea`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Altar (ID: `realia:Altar`); Sheep (ID: `fauna:Lamb`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); मूसा (ID: `person:Moses`); इस्राएल (ID: `person:Israel`); एलीआजर (ID: `person:Eleazar.2`); Complete (ID: `keyterm:Complete`); Vow (ID: `keyterm:Vow`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); मिद्यान (ID: `place:Midian`); To Cause to Possess (ID: `keyterm:Possess`); हारून (ID: `person:Aaron`); Sheep (ID: `fauna:Lamb`); Work (ID: `keyterm:Work`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); मिद्यानी (ID: `group:Midian`); कोरह (ID: `person:Korah.3`); Appease (ID: `keyterm:Appease`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Plague (ID: `keyterm:Blow`); मनश्शे (ID: `group:Manasseh`); मनश्शे (ID: `person:Manasseh`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Donkey (ID: `fauna:Donkey`); हेपेर (ID: `person:Hepher`)
...
* **Associated ACAI Concepts:** इस्राएल (ID: `person:Israel`); यहोवा (ID: `deity:Lord`); मूसा (ID: `person:Moses`); To Cause to Possess (ID: `keyterm:Possess`); यरदन (ID: `place:Jordan`); Refuge (ID: `keyterm:Refuge`); गाद (ID: `person:Gad`); रूबेन (ID: `group:Reuben`); रूबेन (ID: `person:Reuben`); कनान (ID: `place:Canaan`); मनश्शे (ID: `group:Manasseh`); मनश्शे (ID: `person:Manasseh`); गिलाद (ID: `place:Gilead`); Dispossess (ID: `keyterm:Dispossess`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); यरीहो (ID: `place:Jericho`); यूसुफ (ID: `person:Joseph.10`); Plains of Moab (ID: `place:MoabPlains`); मिस्र (ID: `place:Egypt`); होर पर्वत (ID: `place:HorMount`); दीबोन (ID: `place:Dibon`); Lot (ID: `keyterm:Lot`); Kadesh-barnea (ID: `place:Kadesh-barnea`); सलोफाद (ID: `person:Zelophehad`); माकीर (ID: `person:Machir`); हारून (ID: `person:Aaron`); एताम (ID: `place:Etham`); यहोशू (ID: `person:Joshua.2`); याजेर (ID: `place:Jazer`)
