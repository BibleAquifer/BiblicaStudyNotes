...
* **Associated ACAI Concepts:** मूसा (ID: `person:Moses`); यहोवा (ID: `deity:Lord`); हारून (ID: `person:Aaron`); इस्राएल (ID: `person:Israel`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); गेर्शोन (ID: `person:Gershon`); कहात (ID: `person:Kohath`); Holy (ID: `keyterm:Holy`); मरारी (ID: `person:Merari`); Force to Serve (ID: `keyterm:EnticedToServe`); Gershonites (ID: `group:Gershon`); यहूदा (ID: `group:Judah`); रूबेन (ID: `group:Reuben`); रूबेन (ID: `person:Reuben`); एप्रैम (ID: `group:Ephraim`); दान (ID: `place:Dan`); एप्रैम (ID: `person:Ephraim`); दान (ID: `group:Dan`); कहातियों (ID: `group:Kohath`); यहूदा (ID: `person:Judah.4`); Tent of Meeting (ID: `realia:TentOfMeeting`); Standard (ID: `realia:Standard`); ईतामार (ID: `person:Ithamar`); Wilderness of Sinai (ID: `place:SinaiWilderness`); आशेर (ID: `group:Asher`); शिमोन (ID: `group:Simeon`); शिमोन (ID: `person:Simeon.5`); नप्ताली (ID: `person:Naphtali`); नप्ताली (ID: `group:Naphtali`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); यहोवा (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Slaughtering (ID: `keyterm:Slaughtering`); मूसा (ID: `person:Moses`); इस्राएल (ID: `person:Israel`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); हारून (ID: `person:Aaron`); Force to Serve (ID: `keyterm:EnticedToServe`); Dish (ID: `realia:Dish`); Money (ID: `realia:Money`); Shekel (ID: `realia:Shekel`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Tent of Meeting (ID: `realia:TentOfMeeting`); Pure (ID: `keyterm:Pure`); Smear (ID: `keyterm:Smear`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Appease (ID: `keyterm:Appease`); Wagon (ID: `realia:Wagon`); अहीएजेर (ID: `person:Ahiezer`); अबीदान (ID: `person:Abidan`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); मूसा (ID: `person:Moses`); Passover (ID: `keyterm:Passover`); Standard (ID: `realia:Standard`); Trumpet (ID: `realia:Trumpet`); Offering (ID: `keyterm:Offering`); Defilement (ID: `keyterm:Defilement`); Wilderness of Sinai (ID: `place:SinaiWilderness`); Testimony (ID: `keyterm:Witness.2`); Covenant Box (ID: `keyterm:CovenantBox`); हारून (ID: `person:Aaron`); यित्रो (ID: `person:Jethro`); अहीएजेर (ID: `person:Ahiezer`); अबीदान (ID: `person:Abidan`); एलीआब (ID: `person:Eliab`); अहीरा (ID: `person:Ahira`); गमलीएल (ID: `person:Gamaliel.2`); सूआर (ID: `person:Zuar`); होबाब (ID: `person:Hobab`); पगीएल (ID: `person:Pagiel`); एनान (ID: `person:Enan`); दूएल (ID: `person:Deuel`); ओक्रान (ID: `person:Ochran`); एलीसूर (ID: `person:Elizur`); पदासूर (ID: `person:Pedahzur`); अम्मीहूद (ID: `person:Ammihud`); एल्यासाप (ID: `person:Eliasaph`); सूरीशद्दै (ID: `person:Zurishaddai`); कहातियों (ID: `group:Kohath`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); मूसा (ID: `person:Moses`); इस्राएल (ID: `person:Israel`); मिस्र (ID: `place:Egypt`); हारून (ID: `person:Aaron`); कालेब (ID: `person:Caleb`); नून (ID: `person:Nun`); यहोशू (ID: `person:Joshua.2`); कनान (ID: `place:Canaan`); मिर्याम (ID: `person:Miriam`); यपुन्ने (ID: `person:Jephunneh`); अमालेक (ID: `place:Amalek`); अमालेकी (ID: `group:Amalek`); कनानी (ID: `group:Canaan`); Tent (ID: `realia:Tent`); पारान (ID: `place:Paran`); Negev (ID: `place:Negeb`); Speak as a Prophet (ID: `keyterm:Speak`); अनाक (ID: `person:Anak`); Forgive (ID: `keyterm:Forgive`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Passion (ID: `keyterm:Ardour`); Swear (ID: `keyterm:Swear`); Dispossess (ID: `keyterm:Dispossess`); Glory (ID: `keyterm:Glory`); एलदाद (ID: `person:Eldad`); किब्रोतहत्तावा (ID: `place:Kibroth-hattaavah`); मेदाद (ID: `person:Medad`); हसेरोत (ID: `place:Hazeroth`); Land Flowing of Milk and Honey (ID: `keyterm:LandFlowingOfMilkAndHoney`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); मूसा (ID: `person:Moses`); इस्राएल (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); हारून (ID: `person:Aaron`); Defilement (ID: `keyterm:Defilement`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); कोरह (ID: `person:Korah.3`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); अबीराम (ID: `person:Abiram`); To Cause to Possess (ID: `keyterm:Possess`); Holy (ID: `keyterm:Holy`); Pure (ID: `keyterm:Pure`); दातान (ID: `person:Dathan`); Testimony (ID: `keyterm:Witness.2`); Force to Serve (ID: `keyterm:EnticedToServe`); To Cleanse (ID: `keyterm:Cleanse.2`); Tent of Meeting (ID: `realia:TentOfMeeting`); Cattle (ID: `fauna:Bull`); Rod (ID: `realia:Rod`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Instruction (ID: `keyterm:Instruction`); Appease (ID: `keyterm:Appease`); एलीआजर (ID: `person:Eleazar.2`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Shovel (ID: `realia:Shovel`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); मूसा (ID: `person:Moses`); इस्राएल (ID: `person:Israel`); एलीआजर (ID: `person:Eleazar.2`); Complete (ID: `keyterm:Complete`); Vow (ID: `keyterm:Vow`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); मिद्यान (ID: `place:Midian`); To Cause to Possess (ID: `keyterm:Possess`); हारून (ID: `person:Aaron`); Sheep (ID: `fauna:Lamb`); Work (ID: `keyterm:Work`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); कोरह (ID: `person:Korah.3`); मिद्यानी (ID: `group:Midian`); Appease (ID: `keyterm:Appease`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Plague (ID: `keyterm:Blow`); मनश्शे (ID: `person:Manasseh`); मनश्शे (ID: `group:Manasseh`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Donkey (ID: `fauna:Donkey`); सलोफाद (ID: `person:Zelophehad`)
...
* **Associated ACAI Concepts:** इस्राएल (ID: `person:Israel`); यहोवा (ID: `deity:Lord`); मूसा (ID: `person:Moses`); To Cause to Possess (ID: `keyterm:Possess`); यरदन (ID: `place:Jordan`); Refuge (ID: `keyterm:Refuge`); गाद (ID: `person:Gad`); रूबेन (ID: `group:Reuben`); रूबेन (ID: `person:Reuben`); कनान (ID: `place:Canaan`); मनश्शे (ID: `person:Manasseh`); मनश्शे (ID: `group:Manasseh`); गिलाद (ID: `place:Gilead`); Dispossess (ID: `keyterm:Dispossess`); यूसुफ (ID: `person:Joseph.10`); मिस्र (ID: `place:Egypt`); लेवी (ID: `group:Levi`); लेवी (ID: `person:Levi.3`); Plains of Moab (ID: `place:MoabPlains`); यरीहो (ID: `place:Jericho`); होर पर्वत (ID: `place:HorMount`); दीबोन (ID: `place:Dibon`); Kadesh-barnea (ID: `place:Kadesh-barnea`); सलोफाद (ID: `person:Zelophehad`); Lot (ID: `keyterm:Lot`); माकीर (ID: `person:Machir`); यहोशू (ID: `person:Joshua.2`); याजेर (ID: `place:Jazer`); Wilderness of Zin (ID: `place:Zin`); नून (ID: `person:Nun`)
