...
* **Associated ACAI Concepts:** मूसा (ID: `person:Moses`); यहोवा (ID: `deity:Lord`); हारून (ID: `person:Aaron`); इस्राएल (ID: `person:Israel`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); गेर्शोन (ID: `person:Gershon`); कहात (ID: `person:Kohath`); Holy (ID: `keyterm:Holy`); मरारी (ID: `person:Merari`); Force to Serve (ID: `keyterm:EnticedToServe`); Gershonites (ID: `group:Gershon`); कहातियों (ID: `group:Kohath`); यहूदा (ID: `person:Judah.4`); रूबेन (ID: `person:Reuben`); एप्रैम (ID: `group:Ephraim`); रूबेन (ID: `group:Reuben`); दान (ID: `group:Dan`); यहूदा (ID: `group:Judah`); दान (ID: `place:Dan`); एप्रैम (ID: `person:Ephraim`); Tent of Meeting (ID: `realia:TentOfMeeting`); Standard (ID: `realia:Standard`); ईतामार (ID: `person:Ithamar`); Wilderness of Sinai (ID: `place:SinaiWilderness`); इस्साकार (ID: `group:Issachar`); आशेर (ID: `person:Asher`); शिमोन (ID: `group:Simeon`); नप्ताली (ID: `person:Naphtali`); शिमोन (ID: `person:Simeon.5`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); To Sin (ID: `keyterm:Sin`); यहोवा (ID: `deity:Lord`); Slaughtering (ID: `keyterm:Slaughtering`); इस्राएल (ID: `person:Israel`); मूसा (ID: `person:Moses`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); हारून (ID: `person:Aaron`); Force to Serve (ID: `keyterm:EnticedToServe`); Dish (ID: `realia:Dish`); Shekel (ID: `realia:Shekel`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Tent of Meeting (ID: `realia:TentOfMeeting`); Pure (ID: `keyterm:Pure`); Smear (ID: `keyterm:Smear`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Appease (ID: `keyterm:Appease`); Wagon (ID: `realia:Wagon`); अम्मीशद्दै (ID: `person:Ammishaddai`); पगीएल (ID: `person:Pagiel`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); इस्राएल (ID: `person:Israel`); मूसा (ID: `person:Moses`); Passover (ID: `keyterm:Passover`); Standard (ID: `realia:Standard`); Trumpet (ID: `realia:Trumpet`); Defilement (ID: `keyterm:Defilement`); Wilderness of Sinai (ID: `place:SinaiWilderness`); Offering (ID: `keyterm:Offering`); Testimony (ID: `keyterm:Witness.2`); Covenant Box (ID: `keyterm:CovenantBox`); हारून (ID: `person:Aaron`); अम्मीहूद (ID: `person:Ammihud`); यित्रो (ID: `person:Jethro`); पगीएल (ID: `person:Pagiel`); एलीसूर (ID: `person:Elizur`); कहातियों (ID: `group:Kohath`); अहीएजेर (ID: `person:Ahiezer`); एल्यासाप (ID: `person:Eliasaph`); सूआर (ID: `person:Zuar`); होबाब (ID: `person:Hobab`); अबीदान (ID: `person:Abidan`); गमलीएल (ID: `person:Gamaliel.2`); सूरीशद्दै (ID: `person:Zurishaddai`); एनान (ID: `person:Enan`); अहीरा (ID: `person:Ahira`); दूएल (ID: `person:Deuel`); ओक्रान (ID: `person:Ochran`); पदासूर (ID: `person:Pedahzur`); एलीआब (ID: `person:Eliab`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); मूसा (ID: `person:Moses`); इस्राएल (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); हारून (ID: `person:Aaron`); Defilement (ID: `keyterm:Defilement`); लेवी (ID: `person:Levi.3`); लेवी (ID: `group:Levi`); कोरह (ID: `person:Korah.3`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); अबीराम (ID: `person:Abiram`); To Cause to Possess (ID: `keyterm:Possess`); Pure (ID: `keyterm:Pure`); Holy (ID: `keyterm:Holy`); दातान (ID: `person:Dathan`); Force to Serve (ID: `keyterm:EnticedToServe`); Testimony (ID: `keyterm:Witness.2`); To Cleanse (ID: `keyterm:Cleanse.2`); Tent of Meeting (ID: `realia:TentOfMeeting`); Cattle (ID: `fauna:Bull`); Rod (ID: `realia:Rod`); Appease (ID: `keyterm:Appease`); एलीआजर (ID: `person:Eleazar.2`); Instruction (ID: `keyterm:Instruction`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Temple Altar (ID: `realia:TempleAltar`); Shovel (ID: `realia:Shovel`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); मूसा (ID: `person:Moses`); इस्राएल (ID: `person:Israel`); एलीआजर (ID: `person:Eleazar.2`); Complete (ID: `keyterm:Complete`); Vow (ID: `keyterm:Vow`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); मिद्यान (ID: `place:Midian`); To Cause to Possess (ID: `keyterm:Possess`); हारून (ID: `person:Aaron`); Sheep (ID: `fauna:Lamb`); Work (ID: `keyterm:Work`); Appease (ID: `keyterm:Appease`); लेवी (ID: `person:Levi.3`); मिद्यानी (ID: `group:Midian`); लेवी (ID: `group:Levi`); कोरह (ID: `person:Korah.3`); Cattle (ID: `fauna:Bull`); Wine (ID: `realia:Wine`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Plague (ID: `keyterm:Blow`); मनश्शे (ID: `group:Manasseh`); मनश्शे (ID: `person:Manasseh`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Donkey (ID: `fauna:Donkey`); हेपेर (ID: `person:Hepher`)
...
* **Associated ACAI Concepts:** इस्राएल (ID: `person:Israel`); यहोवा (ID: `deity:Lord`); मूसा (ID: `person:Moses`); To Cause to Possess (ID: `keyterm:Possess`); यरदन (ID: `place:Jordan`); Refuge (ID: `keyterm:Refuge`); गाद (ID: `person:Gad`); रूबेन (ID: `person:Reuben`); रूबेन (ID: `group:Reuben`); कनान (ID: `place:Canaan`); मनश्शे (ID: `group:Manasseh`); मनश्शे (ID: `person:Manasseh`); Dispossess (ID: `keyterm:Dispossess`); गिलाद (ID: `place:Gilead`); लेवी (ID: `person:Levi.3`); यूसुफ (ID: `person:Joseph.10`); मिस्र (ID: `place:Egypt`); लेवी (ID: `group:Levi`); Plains of Moab (ID: `place:MoabPlains`); यरीहो (ID: `place:Jericho`); दीबोन (ID: `place:Dibon`); होर पर्वत (ID: `place:HorMount`); Kadesh-barnea (ID: `place:Kadesh-barnea`); Lot (ID: `keyterm:Lot`); सलोफाद (ID: `person:Zelophehad`); माकीर (ID: `person:Machir`); Wilderness of Zin (ID: `place:Zin`); एलीआजर (ID: `person:Eleazar.2`); यहोशू (ID: `person:Joshua.2`); नून (ID: `person:Nun`)
