...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); यहोवा (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); Holy (ID: `keyterm:Holy`); Pray (ID: `keyterm:Pray`); Faithfulness (ID: `keyterm:Faithfulness`); Truth (ID: `keyterm:Truth`); In Christ (ID: `keyterm:InChrist`); Favor (ID: `keyterm:Favor`); इपफ्रास (ID: `person:Epaphras`); कुलुस्से (ID: `place:Colossae`); Deliver (ID: `keyterm:Deliver`); Beloved (ID: `keyterm:Beloved`); Live (ID: `keyterm:Live.3`); Authority (ID: `keyterm:Authority.2`); Hope (ID: `keyterm:Hope`); Make Peace (ID: `keyterm:Peace`); Good News (ID: `keyterm:GoodNews`); Forgive (ID: `keyterm:Forgive`); पवित्र आत्मा (ID: `deity:HolySpirit`); पौलुस (ID: `person:Paul`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Good (ID: `keyterm:Good`); Sky (ID: `keyterm:Heaven`); To Sin (ID: `keyterm:Sin`); Liberation (ID: `keyterm:Liberation`); Kingdom (ID: `keyterm:Kingdom`); Believe (ID: `keyterm:Believe`); तीमुथियुस (ID: `person:Timothy`)
...
* **Associated ACAI Concepts:** Sky (ID: `keyterm:Heaven`); Body (ID: `keyterm:Body.3`); Make Peace (ID: `keyterm:Peace`); Church (ID: `keyterm:Church`); Unblemished (ID: `keyterm:Unblemished`); Without Reproach (ID: `keyterm:WithoutReproach`); Reconcile (ID: `keyterm:Reconcile`); यहोवा (ID: `deity:Lord`); Authority (ID: `keyterm:Authority.2`); Hope (ID: `keyterm:Hope`); Good News (ID: `keyterm:GoodNews`); Mind (ID: `keyterm:Mind.2`); पौलुस (ID: `person:Paul`); Holy (ID: `keyterm:Holy`); Blood (ID: `keyterm:Blood`); Ability (ID: `keyterm:Ability`); Believe (ID: `keyterm:Believe`); Proclaim (ID: `keyterm:Proclaim`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); यहोवा (ID: `deity:Lord`); Body (ID: `keyterm:Body.3`); Ask for (ID: `keyterm:AskFor`); Love (ID: `keyterm:Love`); Encourage (ID: `keyterm:Encourage`); Glory (ID: `keyterm:Glory`); Spirit (ID: `keyterm:Spirit.2`); अन्यजाति (ID: `group:Gentile`); Heart (ID: `keyterm:Heart`); Hope (ID: `keyterm:Hope`); Church (ID: `keyterm:Church`); Always (ID: `keyterm:Always`); लौदीकिया (ID: `place:Laodicea`); Holy (ID: `keyterm:Holy`); In Christ (ID: `keyterm:InChrist`); Ability (ID: `keyterm:Ability`); Believe (ID: `keyterm:Believe`); Proclaim (ID: `keyterm:Proclaim`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); यहोवा (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Love (ID: `keyterm:Love`); Heart (ID: `keyterm:Heart`); Think (ID: `keyterm:Think`); Scythians (ID: `group:Scythians`); Jews (ID: `group:Jews`); Defilement (ID: `keyterm:Defilement`); Affection (ID: `keyterm:Affection`); Mercy (ID: `keyterm:Mercy`); Glory (ID: `keyterm:Glory`); यूनानी (ID: `group:Greek`); Resurrection (ID: `keyterm:Resurrection`); Blaspheme (ID: `keyterm:Blaspheme`); Live (ID: `keyterm:Live.3`); Make Peace (ID: `keyterm:Peace`); यावान (ID: `person:Javan`); Forgive (ID: `keyterm:Forgive`); Circumcision (ID: `keyterm:Circumcision`); Body (ID: `keyterm:Body.3`); Name (ID: `keyterm:Name`); Kindness (ID: `keyterm:Kindness`); Fornication (ID: `keyterm:Fornication`); Holy (ID: `keyterm:Holy`); Favor (ID: `keyterm:Favor`); Idolatry (ID: `keyterm:Idolatry`); Chosen (ID: `keyterm:Chosen`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Partiality (ID: `keyterm:Partiality`); To Act Wickedly (ID: `keyterm:ActWickedly`); Be Enslaved (ID: `keyterm:Serve.2`); Sky (ID: `keyterm:Heaven`); Love (ID: `keyterm:Love`); Fear (ID: `keyterm:Fear`); Body (ID: `keyterm:Body.3`); Heart (ID: `keyterm:Heart`); Be (Or Show Oneself) Just (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); Live (ID: `keyterm:Live.3`); यीशु (ID: `person:Jesus.2`); यहोवा (ID: `deity:Lord`); Favor (ID: `keyterm:Favor`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** लौदीकिया (ID: `place:Laodicea`); यीशु (ID: `person:Jesus.2`); Beloved (ID: `keyterm:Beloved`); यहोवा (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); Church (ID: `keyterm:Church`); हियरापुलिस (ID: `place:Hierapolis`); इपफ्रास (ID: `person:Epaphras`); उनेसिमुस (ID: `person:Onesimus`); अरिस्तर्खुस (ID: `person:Aristarchus`); लूका (ID: `person:Luke`); नुमफास (ID: `person:Nympha`); अरखिप्पुस (ID: `person:Archippus`); यूस्तुस (ID: `person:Justus.3`); देमास (ID: `person:Demas`); तुखिकुस (ID: `person:Tychicus`); मरकुस (ID: `person:Mark`); Ask for (ID: `keyterm:AskFor`); Commandment (ID: `keyterm:Commandment`); Pray (ID: `keyterm:Pray`); Complete (ID: `keyterm:Complete`); Encourage (ID: `keyterm:Encourage`); Bear Witness (ID: `keyterm:BearWitness`); Heart (ID: `keyterm:Heart`); To Cause to Happen (ID: `keyterm:Happen`); To Command (ID: `keyterm:Command`); Circumcision (ID: `keyterm:Circumcision`); पौलुस (ID: `person:Paul`); Favor (ID: `keyterm:Favor`); Laodiceans (ID: `group:Laodicea`); बरनबास (ID: `person:Barnabas`); Kingdom (ID: `keyterm:Kingdom`); Serve (ID: `keyterm:Serve`); Temple (ID: `realia:Temple`); Chain (ID: `realia:Chain`); House (ID: `realia:House`)
