...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); यहोवा (ID: `deity:Lord`); Favor (ID: `keyterm:Favor`); Believe (ID: `keyterm:Believe`); Mercy (ID: `keyterm:Mercy`); In Christ (ID: `keyterm:InChrist`); Good News (ID: `keyterm:GoodNews`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); Heart (ID: `keyterm:Heart`); Persuade (ID: `keyterm:Persuade`); Life (ID: `keyterm:Life`); पवित्र आत्मा (ID: `deity:HolySpirit`); Serve (ID: `keyterm:Serve`); उनेसिफुरूस (ID: `person:Onesiphorus`); Long For (ID: `keyterm:LongFor`); फूगिलुस (ID: `person:Phygelus`); लोइस (ID: `person:Lois`); यूनीके (ID: `person:Eunice`); हिरमुगिनेस (ID: `person:Hermogenes`); Priesthood (ID: `keyterm:Priesthood`); Salvation (ID: `keyterm:Salvation`); Unhypocritical (ID: `keyterm:Unhypocritical`); Bear Witness (ID: `keyterm:BearWitness`); पौलुस (ID: `person:Paul`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Clean (ID: `keyterm:Clean`); तीमुथियुस (ID: `person:Timothy`); आसिया (ID: `place:Asia`); Promise (ID: `keyterm:Promise`); Savior (ID: `keyterm:Savior`); Conscience (ID: `keyterm:Conscience`); Pray (ID: `keyterm:Pray`); Holy (ID: `keyterm:Holy`); Make Peace (ID: `keyterm:Peace`); इफिसुस (ID: `place:Ephesus`); Spirit (ID: `keyterm:Spirit.2`); रोम (ID: `place:Rome`); Always (ID: `keyterm:Always`); Beloved (ID: `keyterm:Beloved`); Chain (ID: `realia:Chain`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); यहोवा (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Faithfulness (ID: `keyterm:Faithfulness`); Believe (ID: `keyterm:Believe`); Resurrection (ID: `keyterm:Resurrection`); In Christ (ID: `keyterm:InChrist`); Approved (ID: `keyterm:Approved`); हुमिनयुस (ID: `person:Hymenaeus`); फिलेतुस (ID: `person:Philetus`); Salvation (ID: `keyterm:Salvation`); Daily Life (ID: `keyterm:DailyLife`); Good News (ID: `keyterm:GoodNews`); Glory (ID: `keyterm:Glory`); Call Upon (ID: `keyterm:CallUpon`); Declare (ID: `keyterm:Declare`); Live With (ID: `keyterm:LiveWith`); Consecration (ID: `keyterm:Consecration.2`); Love (ID: `keyterm:Love`); Clean (ID: `keyterm:Clean`); Foolish (ID: `keyterm:Foolish`); Heart (ID: `keyterm:Heart`); Chosen (ID: `keyterm:Chosen`); Unjust Deed (ID: `keyterm:UnjustDeed`); Good (ID: `keyterm:Good`); Lawfully (ID: `keyterm:Lawfully`); Pure (ID: `keyterm:Pure`); Repent (ID: `keyterm:Repent`); Witness (ID: `keyterm:Witness`); Disbelieve (ID: `keyterm:Disbelieve`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); दाऊद (ID: `person:David`); Make Peace (ID: `keyterm:Peace`); Profane (ID: `keyterm:Profane`); Name (ID: `keyterm:Name`); Favor (ID: `keyterm:Favor`); Always (ID: `keyterm:Always`); House (ID: `realia:House`); Chain (ID: `realia:Chain`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); यहोवा (ID: `deity:Lord`); Life (ID: `keyterm:Life`); In Christ (ID: `keyterm:InChrist`); Written (ID: `keyterm:Scripture`); Declare (ID: `keyterm:Declare`); यम्ब्रेस (ID: `person:Jambres`); यन्नेस (ID: `person:Jannes`); इकुनियुम (ID: `place:Iconium`); God-Breathed (ID: `keyterm:GodBreathed`); Salvation (ID: `keyterm:Salvation`); To Command (ID: `keyterm:Command`); Deliver (ID: `keyterm:Deliver`); To Sin (ID: `keyterm:Sin`); Loving God (ID: `keyterm:LovingGod`); Ability (ID: `keyterm:Ability`); Be Convinced Of (ID: `keyterm:ConvincedOf`); Love (ID: `keyterm:Love`); Loving Wealth (ID: `keyterm:LovingWealth`); मूसा (ID: `person:Moses`); Good (ID: `keyterm:Good`); Ask for (ID: `keyterm:AskFor`); अन्ताकिया (ID: `place:Antioch.2`); Loving Pleasure (ID: `keyterm:LovingPleasure`); Selfish Love (ID: `keyterm:SelfishLove`); Decided (ID: `keyterm:Decided`); Letter (ID: `keyterm:Letter`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Irreconcilable (ID: `keyterm:Irreconcilable`); Serve (ID: `keyterm:Serve`); Kingdom (ID: `keyterm:Kingdom`); Behavior (ID: `keyterm:Behavior`); Encourage (ID: `keyterm:Encourage`); Proclaim (ID: `keyterm:Proclaim`); Blasphemous (ID: `keyterm:Blasphemous`); लुस्त्रा (ID: `place:Lystra`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** यीशु (ID: `person:Jesus.2`); Deliver (ID: `keyterm:Deliver`); Love (ID: `keyterm:Love`); Always (ID: `keyterm:Always`); इरास्तुस (ID: `person:Erastus`); सिकन्दर (ID: `person:Alexander.4`); त्रुफिमुस (ID: `person:Trophimus`); करपुस (ID: `person:Carpus`); पूदेंस (ID: `person:Pudens`); क्लौदिया (ID: `person:Claudia`); दलमतिया (ID: `place:Dalmatia`); देमास (ID: `person:Demas`); प्रिस्किल्ला (ID: `person:Priscilla`); क्रेसकेंस (ID: `person:Crescens`); लूका (ID: `person:Luke`); मीलेतुस (ID: `place:Miletus`); लीनुस (ID: `person:Linus`); यूबूलुस (ID: `person:Eubulus`); उनेसिफुरूस (ID: `person:Onesiphorus`); Salvation (ID: `keyterm:Salvation`); Surely! (ID: `keyterm:Surely`); Be Poured Out (ID: `keyterm:PouredOut`); Glory (ID: `keyterm:Glory`); Believe (ID: `keyterm:Believe`); कुरिन्थुस (ID: `place:Corinth`); Ability (ID: `keyterm:Ability`); अक्विला (ID: `person:Aquila`); मरकुस (ID: `person:Mark`); गलातिया (ID: `place:Galatia`); तीतुस (ID: `person:Titus`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Heavenly (ID: `keyterm:Heavenly`); Serve (ID: `keyterm:Serve`); इफिसुस (ID: `place:Ephesus`); Spirit (ID: `keyterm:Spirit.2`); त्रोआस (ID: `place:Troas`); Favor (ID: `keyterm:Favor`); Kingdom (ID: `keyterm:Kingdom`); Proclaim (ID: `keyterm:Proclaim`); अन्यजाति (ID: `group:Gentile`); थिस्सलुनीके (ID: `place:Thessalonica`); तुखिकुस (ID: `person:Tychicus`); Parchment (ID: `realia:Parchment`); Cloak (ID: `realia:Cloak`); Scroll (ID: `realia:Scroll`); Lion (ID: `fauna:Lion`)
