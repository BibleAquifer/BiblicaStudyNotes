...
* **Associated Passages:** 1 यूहन्ना 1:1-2:2
* **Associated Articles:** अंधकार (ID: `182933@BiblicaStudyNotesKeyTerms`); चेले  (ID: `182934@BiblicaStudyNotesKeyTerms`); पाप (ID: `183089@BiblicaStudyNotesKeyTerms`); परमेश्वर (ID: `183093@BiblicaStudyNotesKeyTerms`); परमेश्वर का शब्द  (ID: `183094@BiblicaStudyNotesKeyTerms`); प्रेरित (ID: `182947@BiblicaStudyNotesKeyTerms`); संसार (ID: `183109@BiblicaStudyNotesKeyTerms`); यीशु  (ID: `183113@BiblicaStudyNotesKeyTerms`); क्षमा करना (ID: `183175@BiblicaStudyNotesKeyTerms`); पश्चाताप (ID: `183240@BiblicaStudyNotesKeyTerms`); यूहन्ना (ID: `183436@BiblicaStudyNotesKeyTerms`); प्रकाश (ID: `183440@BiblicaStudyNotesKeyTerms`); अनन्त जीवन (ID: `183463@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); यहोवा (ID: `deity:Lord`); Fellowship (ID: `keyterm:Fellowship`); यीशु (ID: `person:Jesus.2`); To Cleanse (ID: `keyterm:Cleanse.2`); Truth (ID: `keyterm:Truth`); Live (ID: `keyterm:Live.3`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Life (ID: `keyterm:Life`); Faithfulness (ID: `keyterm:Faithfulness`); Bear Witness (ID: `keyterm:BearWitness`); Blood (ID: `keyterm:Blood`); Mercy Seat (ID: `keyterm:Propitiation`); Forgive (ID: `keyterm:Forgive`); Ability (ID: `keyterm:Ability`); Unjust Deed (ID: `keyterm:UnjustDeed`); Always (ID: `keyterm:Always`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated Passages:** 1 यूहन्ना 2:3-14
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); Live (ID: `keyterm:Live.3`); True (ID: `keyterm:True`); यहोवा (ID: `deity:Lord`); Love (ID: `keyterm:Love`); Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); Stumbling Block (ID: `keyterm:StumblingBlock`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); Beloved (ID: `keyterm:Beloved`); Obligated (ID: `keyterm:Ought`)
...
* **Associated Passages:** 1 यूहन्ना 2:15-29
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Anointed (ID: `keyterm:Anointed`); Always (ID: `keyterm:Always`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Daily Life (ID: `keyterm:DailyLife`); Truth (ID: `keyterm:Truth`); पवित्र आत्मा (ID: `deity:HolySpirit`); यीशु (ID: `person:Jesus.2`); Promise (ID: `keyterm:Promise`); True (ID: `keyterm:True`); Body (ID: `keyterm:Body.3`); Holy (ID: `keyterm:Holy`); Life (ID: `keyterm:Life`); Love (ID: `keyterm:Love`)
...
* **Associated Passages:** 1 यूहन्ना 3:1-24
* **Associated Articles:** परमेश्वर का परिवार (ID: `182939@BiblicaStudyNotesKeyTerms`); बुरा व्यवहार किया गया (ID: `182948@BiblicaStudyNotesKeyTerms`); कै़न (ID: `183116@BiblicaStudyNotesKeyTerms`); हत्या (ID: `183117@BiblicaStudyNotesKeyTerms`); प्रार्थना (ID: `183121@BiblicaStudyNotesKeyTerms`); बलिदान (ID: `183150@BiblicaStudyNotes`); परमेश्वर से प्रेम करो (ID: `183249@BiblicaStudyNotesKeyTerms`); जरूरतमंद लोग (ID: `183312@BiblicaStudyNotesKeyTerms`); हृदय (ID: `183313@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); यहोवा (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Heart (ID: `keyterm:Heart`); Commandment (ID: `keyterm:Commandment`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); Condemn (ID: `keyterm:Condemn`); Truth (ID: `keyterm:Truth`); Beloved (ID: `keyterm:Beloved`); कैन (ID: `person:Cain`); Hope (ID: `keyterm:Hope`); Persuade (ID: `keyterm:Persuade`); Always (ID: `keyterm:Always`); Lawless (ID: `keyterm:Lawless`); Name (ID: `keyterm:Name`); Pure (ID: `keyterm:Pure`); Affection (ID: `keyterm:Affection`); Daily Life (ID: `keyterm:DailyLife`); Believe (ID: `keyterm:Believe`); पवित्र आत्मा (ID: `deity:HolySpirit`); यीशु (ID: `person:Jesus.2`)
...
* **Associated Passages:** 1 यूहन्ना 4:1-6
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Spirit (ID: `keyterm:Spirit.2`); पवित्र आत्मा (ID: `deity:HolySpirit`); यीशु (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`); Believe (ID: `keyterm:Believe`); Beloved (ID: `keyterm:Beloved`); Body (ID: `keyterm:Body.3`); Interpret (ID: `keyterm:Interpret`)
...
* **Associated Passages:** 1 यूहन्ना 4:7-21
* **Associated Articles:** सुसमाचार (ID: `182925@BiblicaStudyNotesKeyTerms`); सही (ID: `183059@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); यहोवा (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Beloved (ID: `keyterm:Beloved`); Obligated (ID: `keyterm:Ought`); Savior (ID: `keyterm:Savior`); Bear Witness (ID: `keyterm:BearWitness`); Believe (ID: `keyterm:Believe`); पवित्र आत्मा (ID: `deity:HolySpirit`); Fear (ID: `keyterm:Fear`); Commandment (ID: `keyterm:Commandment`); यीशु (ID: `person:Jesus.2`); A Person (ID: `person:GenericPerson`); Judgment (ID: `keyterm:Judgment`); Mercy Seat (ID: `keyterm:Propitiation`); To Sin (ID: `keyterm:Sin`); Court Case (ID: `keyterm:CourtCase`); Life (ID: `keyterm:Life`)
...
* **Associated Passages:** 1 यूहन्ना 5:1-21
* **Associated Articles:** केवल परमेश्वर की आराधना करो (ID: `183226@BiblicaStudyNotes`)

* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Bear Witness (ID: `keyterm:BearWitness`); Believe (ID: `keyterm:Believe`); यीशु (ID: `person:Jesus.2`); Always (ID: `keyterm:Always`); Ability (ID: `keyterm:Ability`); To Sin (ID: `keyterm:Sin`); Love (ID: `keyterm:Love`); Commandment (ID: `keyterm:Commandment`); Blood (ID: `keyterm:Blood`); पवित्र आत्मा (ID: `deity:HolySpirit`); Unjust Deed (ID: `keyterm:UnjustDeed`); Ask for (ID: `keyterm:AskFor`); True (ID: `keyterm:True`); Mind (ID: `keyterm:Mind.2`); Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); Image (ID: `realia:Image`)
