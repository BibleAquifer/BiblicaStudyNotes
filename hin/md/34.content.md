...
* **Associated Articles:** पाप (ID: `183089@BiblicaStudyNotesKeyTerms`); उद्धार (ID: `183090@BiblicaStudyNotesKeyTerms`); सृष्टि (ID: `183091@BiblicaStudyNotesKeyTerms`); मनुष्य (ID: `183096@BiblicaStudyNotesKeyTerms`); न्याय  (ID: `183127@BiblicaStudyNotesKeyTerms`); दर्शन (ID: `183190@BiblicaStudyNotesKeyTerms`); परमेश्वर के लोग  (ID: `183196@BiblicaStudyNotes`); जलन रखने वाला  (ID: `183239@BiblicaStudyNotesKeyTerms`); पश्चाताप (ID: `183240@BiblicaStudyNotesKeyTerms`); नबी (ID: `183310@BiblicaStudyNotesKeyTerms`); परमेश्वर का क्रोध  (ID: `183394@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Elkosh (ID: `place:Elkosh`); नहूम (ID: `person:Nahum.2`); बाशान (ID: `place:Bashan`); नीनवे (ID: `place:Nineveh`); The Way (ID: `keyterm:TheWay`); Utterance (ID: `keyterm:Utterance`); लबानोन (ID: `place:Lebanon`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Zealous (ID: `keyterm:Zealous.3`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); कर्मेल (ID: `place:Carmel`); Strength (ID: `keyterm:Strength`); Fortress (ID: `realia:Fortress`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Locust (ID: `fauna:Locust`); Lion (ID: `fauna:Lion`); नीनवे (ID: `place:Nineveh`); Wickedness (ID: `keyterm:Wickedness`); आमोन (ID: `deity:Amon`); Thebes (ID: `place:Thebes`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); पूत (ID: `place:Put`); Strength (ID: `keyterm:Strength`); Detested Thing (ID: `keyterm:DetestedThing`); Incantations (ID: `keyterm:Incantations`); यहूदा (ID: `group:Judah`); Vow (ID: `keyterm:Vow`); मिस्र (ID: `place:Egypt`); An Angel (ID: `deity:Angel`); Woe (ID: `keyterm:Woe.2`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Cush (ID: `place:Cush.2`); Lot (ID: `keyterm:Lot`); Nile River (ID: `place:Nile`); Assyria (ID: `place:Assyria`); Peace (ID: `keyterm:IntactState`); यहूदा (ID: `person:Judah.4`); Under Siege (ID: `keyterm:StateOfBeingUnderSiege`); लीबिया (ID: `place:Libya`); इस्राएल (ID: `person:Israel`); Glory (ID: `keyterm:Glory`); Brick Mold (ID: `realia:BrickMold`); Protective Shield (ID: `realia:ProtectiveShield`); Brier (ID: `flora:Brier`); Fortress (ID: `realia:Fortress`); Yoke (ID: `realia:Yoke`); Small Shield (ID: `realia:SmallShield`); Money (ID: `realia:Money`); Fortification (ID: `realia:Fortification`); Train (ID: `realia:Train`); Phoenician Juniper (ID: `flora:JuniperTree`); Fig (ID: `flora:Fig`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); Dyed Cloth (ID: `realia:DyedCloth`); Dove (ID: `fauna:Dove`); Wagon (ID: `realia:Wagon`); Strong Drink (ID: `realia:StrongDrink`); Molten Image (ID: `realia:MoltenImage`); Fir (ID: `flora:Fir`); Spear (ID: `realia:Spear`); Whip (ID: `realia:Whip`); Graven Image (ID: `realia:GravenImage`); Horse (ID: `fauna:Horse`); Grecian Juniper (ID: `flora:Juniper`); Grass (ID: `flora:Grass`); Cypress (ID: `flora:Cypress`); Sword (ID: `realia:Sword`)
