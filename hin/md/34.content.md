...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); नहूम (ID: `person:Nahum.2`); Elkosh (ID: `place:Elkosh`); Zealous (ID: `keyterm:Zealous.3`); बाशान (ID: `place:Bashan`); कर्मेल (ID: `place:Carmel`); The Way (ID: `keyterm:TheWay`); Strength (ID: `keyterm:Strength`); Utterance (ID: `keyterm:Utterance`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); नीनवे (ID: `place:Nineveh`); लबानोन (ID: `place:Lebanon`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Scroll (ID: `realia:Scroll`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Locust (ID: `fauna:Locust`); Lion (ID: `fauna:Lion`); Wickedness (ID: `keyterm:Wickedness`); नीनवे (ID: `place:Nineveh`); आमोन (ID: `deity:Amon`); Thebes (ID: `place:Thebes`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Glory (ID: `keyterm:Glory`); Woe (ID: `keyterm:Woe.2`); Strength (ID: `keyterm:Strength`); Incantations (ID: `keyterm:Incantations`); यहूदा (ID: `person:Judah.4`); Nile River (ID: `place:Nile`); An Angel (ID: `deity:Angel`); Cush (ID: `place:Cush.2`); Lot (ID: `keyterm:Lot`); पूत (ID: `place:Put`); Assyria (ID: `place:Assyria`); Detested Thing (ID: `keyterm:DetestedThing`); इस्राएल (ID: `person:Israel`); Vow (ID: `keyterm:Vow`); Under Siege (ID: `keyterm:StateOfBeingUnderSiege`); लीबिया (ID: `place:Libya`); मिस्र (ID: `place:Egypt`); यहूदा (ID: `group:Judah`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Peace (ID: `keyterm:IntactState`); Protective Shield (ID: `realia:ProtectiveShield`); Brick Mold (ID: `realia:BrickMold`); Molten Image (ID: `realia:MoltenImage`); Sheep (ID: `fauna:Lamb`); Wagon (ID: `realia:Wagon`); Cypress (ID: `flora:Cypress`); Fir (ID: `flora:Fir`); Horse (ID: `fauna:Horse`); Whip (ID: `realia:Whip`); Sword (ID: `realia:Sword`); Small Shield (ID: `realia:SmallShield`); Dyed Cloth (ID: `realia:DyedCloth`); Strong Drink (ID: `realia:StrongDrink`); Phoenician Juniper (ID: `flora:JuniperTree`); Fortress (ID: `realia:Fortress`); Spear (ID: `realia:Spear`); Dove (ID: `fauna:Dove`); Grass (ID: `flora:Grass`); House (ID: `realia:House`); Brier (ID: `flora:Brier`); Yoke (ID: `realia:Yoke`); Money (ID: `realia:Money`); Fig (ID: `flora:Fig`); Grecian Juniper (ID: `flora:Juniper`); Train (ID: `realia:Train`); Graven Image (ID: `realia:GravenImage`); Fortification (ID: `realia:Fortification`)
