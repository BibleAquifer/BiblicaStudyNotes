...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Elkosh (ID: `place:Elkosh`); नहूम (ID: `person:Nahum.2`); Zealous (ID: `keyterm:Zealous.3`); बाशान (ID: `place:Bashan`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); The Way (ID: `keyterm:TheWay`); लबानोन (ID: `place:Lebanon`); कर्मेल (ID: `place:Carmel`); Strength (ID: `keyterm:Strength`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); Utterance (ID: `keyterm:Utterance`); नीनवे (ID: `place:Nineveh`); Scroll (ID: `realia:Scroll`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** यहोवा (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Lion (ID: `fauna:Lion`); Locust (ID: `fauna:Locust`); Wickedness (ID: `keyterm:Wickedness`); नीनवे (ID: `place:Nineveh`); आमोन (ID: `deity:Amon`); Thebes (ID: `place:Thebes`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); पूत (ID: `place:Put`); Woe (ID: `keyterm:Woe.2`); Nile River (ID: `place:Nile`); Glory (ID: `keyterm:Glory`); Strength (ID: `keyterm:Strength`); Under Siege (ID: `keyterm:StateOfBeingUnderSiege`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Peace (ID: `keyterm:IntactState`); मिस्र (ID: `place:Egypt`); यहूदा (ID: `group:Judah`); Detested Thing (ID: `keyterm:DetestedThing`); यहूदा (ID: `person:Judah.4`); इस्राएल (ID: `person:Israel`); An Angel (ID: `deity:Angel`); Incantations (ID: `keyterm:Incantations`); Cush (ID: `place:Cush.2`); Assyria (ID: `place:Assyria`); लीबिया (ID: `place:Libya`); Lot (ID: `keyterm:Lot`); Vow (ID: `keyterm:Vow`); Protective Shield (ID: `realia:ProtectiveShield`); Brick Mold (ID: `realia:BrickMold`); Brier (ID: `flora:Brier`); Fortification (ID: `realia:Fortification`); Phoenician Juniper (ID: `flora:JuniperTree`); Cypress (ID: `flora:Cypress`); Fortress (ID: `realia:Fortress`); Molten Image (ID: `realia:MoltenImage`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Fir (ID: `flora:Fir`); Dove (ID: `fauna:Dove`); Money (ID: `realia:Money`); Fig (ID: `flora:Fig`); Dyed Cloth (ID: `realia:DyedCloth`); Small Shield (ID: `realia:SmallShield`); Grecian Juniper (ID: `flora:Juniper`); Graven Image (ID: `realia:GravenImage`); Spear (ID: `realia:Spear`); Whip (ID: `realia:Whip`); Horse (ID: `fauna:Horse`); Wagon (ID: `realia:Wagon`); Sheep (ID: `fauna:Lamb`); Strong Drink (ID: `realia:StrongDrink`); Grass (ID: `flora:Grass`); Train (ID: `realia:Train`); Yoke (ID: `realia:Yoke`)
