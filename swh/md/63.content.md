...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); Commandment (ID: `keyterm:Commandment`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`); Live (ID: `keyterm:Live.3`); Chosen (ID: `keyterm:Chosen`); Ask for (ID: `keyterm:AskFor`); Share (ID: `keyterm:Share`); Mercy (ID: `keyterm:Mercy`); Hope (ID: `keyterm:Hope`); Make Peace (ID: `keyterm:Peace`); Always (ID: `keyterm:Always`); Body (ID: `keyterm:Body.3`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Favor (ID: `keyterm:Favor`); Ability (ID: `keyterm:Ability`); Ink (ID: `realia:Ink`); Paper (ID: `realia:Paper`); Papyrus (ID: `flora:Papyrus`); House (ID: `realia:House`)
