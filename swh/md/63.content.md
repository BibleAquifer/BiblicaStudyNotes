...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); Yesu (ID: `person:Jesus.2`); Commandment (ID: `keyterm:Commandment`); BWANA (ID: `deity:Lord`); Live (ID: `keyterm:Live.3`); Chosen (ID: `keyterm:Chosen`); Ability (ID: `keyterm:Ability`); Body (ID: `keyterm:Body.3`); Share (ID: `keyterm:Share`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Always (ID: `keyterm:Always`); Mercy (ID: `keyterm:Mercy`); Favor (ID: `keyterm:Favor`); Ask for (ID: `keyterm:AskFor`); Make Peace (ID: `keyterm:Peace`); Hope (ID: `keyterm:Hope`); Paper (ID: `realia:Paper`); Ink (ID: `realia:Ink`); House (ID: `realia:House`); Papyrus (ID: `flora:Papyrus`)
