...
* **Associated Passages:** Isaya 1:1-31
...
* **Associated ACAI Concepts:** Rebel (ID: `keyterm:Rebel`); Terebinth (ID: `flora:Terebinth`); Muskmelon (ID: `flora:Muskmelon`); Strong Drink (ID: `realia:StrongDrink`); Hammada (ID: `flora:Soap`); Manger (ID: `realia:Manger`); Amozi (ID: `person:Amoz`); Wool (ID: `realia:Wool`); Yothamu (ID: `person:Jotham.2`); Have a Vision (ID: `keyterm:HaveAVision`); Isaya (ID: `person:Isaiah`); BWANA (ID: `deity:Lord`)
...
* **Associated Passages:** Isaya 2:1-5:30
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); Mole Rat (ID: `fauna:MoleRat`); Idol (ID: `keyterm:Idol`); Wine (ID: `realia:Wine`); Acre (ID: `realia:Acre`); Woe (ID: `keyterm:Woe`); Tower (ID: `realia:Tower`); Bat (ID: `fauna:Bat`); Instruction (ID: `keyterm:Instruction`); Turban (ID: `realia:Turban.2`); Ephah (ID: `realia:Ephah`); Winepress (ID: `realia:Winepress`); Standard (ID: `realia:Standard`); Vine (ID: `flora:Vine`); Yerusalemu (ID: `place:Jerusalem`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); House (ID: `realia:House`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`)
...
* **Associated Passages:** Isaya 6:1-8:18
...
* **Associated ACAI Concepts:** Remalia (ID: `person:Remaliah`); Resini (ID: `person:Rezin`); maserafi (ID: `deity:Seraph`); Maher-shalal-hash-bazi (ID: `person:Maher-shalal-hash-baz`); Brier (ID: `flora:Brier`); Ahazi (ID: `person:Ahaz`); Zekaria (ID: `person:Zechariah.29`); Tabeeli (ID: `person:Tabeal`); Shear-yashubu (ID: `person:Shear-jashub`); Hoe (ID: `realia:Hoe`); Yeberekia (ID: `person:Jeberechiah`); Uzia (ID: `person:Uzziah`); Well-Established (ID: `keyterm:BeFirm`); Dameski (ID: `place:Damascus`); Stylus (ID: `realia:Stylus`); Uwanda (ID: `place:WashersField`); Uria (ID: `person:Uriah.3`); Fly (ID: `fauna:Fly`); Razor (ID: `realia:Razor`); Train (ID: `realia:Train`); Isaya (ID: `person:Isaiah`); Assyria (ID: `place:Assyria`); Efraimu (ID: `group:Ephraim`); Efraimu (ID: `person:Ephraim`); BWANA (ID: `deity:Lord`)
...
* **Associated Passages:** Isaya 8:19-12:6
...
* **Associated ACAI Concepts:** Gebimu (ID: `place:Gebim`); Sea of Egypt (ID: `place:EgyptSea`); Madmena (ID: `place:Madmenah`); Laisha (ID: `place:Laishah`); Galimu (ID: `place:Gallim`); Migroni (ID: `place:Migron`); Woe (ID: `keyterm:Woe.2`); Yese (ID: `person:Jesse`); Karkemishi (ID: `place:Carchemish`); Kalne (ID: `place:Calneh`); Orebu (ID: `person:Oreb`); Nobu (ID: `place:Nob`); Leopard (ID: `fauna:Leopard`); Brick (ID: `realia:Brick`); Wolf (ID: `fauna:Wolf`); Visitation (ID: `keyterm:Visitation`); Cobra (ID: `fauna:Cobra`); Elamu (ID: `place:Elam`); Fairness (ID: `keyterm:Fairness`); Cush (ID: `place:Cush.2`); mji (ID: `place:Ai`); Galilaya (ID: `place:Galilee`); Assyria (ID: `place:Assyria`); Yerusalemu (ID: `place:Jerusalem`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
...
* **Associated Passages:** Isaya 13:1-23:18
...
* **Associated ACAI Concepts:** Utterance (ID: `keyterm:Utterance`); Tiro (ID: `place:Tyre`); Counsel (ID: `keyterm:Counsel`); Tarshishi (ID: `place:Tarshish`); hata (ID: `place:Bajith`); alfajiri (ID: `deity:Lucifer`); kijito (ID: `place:BrookOfTheWillows`); Beer-elim (ID: `place:Beer-elim`); miji (ID: `place:CityOfDestruction`); Dimoni (ID: `place:Dibon.3`); Dedanites (ID: `group:Dedan`); Duma (ID: `place:Dumah`); Eglaimu (ID: `place:Eglaim`); A Lookout (ID: `person:Lookout`); Eleale (ID: `place:Elealeh`); Sibma (ID: `place:Sibmah`); Nimrimu (ID: `place:Nimrim`); Rug (ID: `realia:Rug`); jemadari (ID: `person:Tartan`); Cotton (ID: `flora:Cotton`); Luhithi (ID: `place:Luhith`); Peg (ID: `realia:Peg.2`); Waarabu (ID: `place:Arabia`); Standard (ID: `realia:Standard`); Tema (ID: `place:Tema`); Owl (ID: `fauna:Owl.3`); Small Shield (ID: `realia:SmallShield`); Pruning Knife (ID: `realia:PruningKnife`); Horonaimu (ID: `place:Horonaim`); Sela (ID: `place:Sela`)
...
* **Associated Passages:** Isaya 24:1-27:13
...
* **Associated ACAI Concepts:** Fortress (ID: `realia:Fortress`); kijito (ID: `place:BrookOfEgypt`); Refuge (ID: `keyterm:Refuge`); Appoint (ID: `keyterm:Appoint`); Vine (ID: `flora:Vine`); BWANA (ID: `deity:Lord`)
...
* **Associated Passages:** Isaya 28:1-39:8
...
* **Associated ACAI Concepts:** kamanda (ID: `person:Rabshakeh`); Hezekia (ID: `person:Hezekiah`); Shebna (ID: `person:Shebna`); Nutmeg Flower (ID: `flora:NutmegFlower`); Yerusalemu (ID: `place:Jerusalem`); Farao (ID: `person:Pharaoh.8`); Senakeribu (ID: `person:Sennacherib`); Yoa (ID: `person:Joah`); Chickpea (ID: `flora:Chickpea`); Tawny Owl (ID: `fauna:TawnyOwl.2`); Sinners (ID: `group:Sinners`); Perasimu (ID: `place:PerazimMount`); njia (ID: `place:WayOfHoliness`); Owl (ID: `fauna:Owl.4`); Hanesi (ID: `place:Hanes`); Cumin (ID: `flora:Cumin`); Safety (ID: `keyterm:Safety`); Asafu (ID: `person:Asaph`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Sefarvaimu (ID: `place:Sepharvaim`); Sharon Plain (ID: `place:Sharon.2`); Arpadi (ID: `place:Arpad`); Bit and Bridle (ID: `realia:BitAndBridle`); Tirhaka (ID: `person:Tirhakah`); Shareza (ID: `person:Sharezer`); Crane (ID: `fauna:Crane`); Telasari (ID: `place:Telassar`); Narcissus (ID: `flora:Narcissus`); Adrameleki (ID: `person:Adrammelech.2`); Baladan (ID: `person:Baladan`)
...
* **Associated Passages:** Isaya 40:1-48:22
...
* **Associated ACAI Concepts:** Graven Image (ID: `realia:GravenImage`); Craftsman (ID: `realia:Craftsman`); Grass (ID: `flora:Grass`); Strength (ID: `keyterm:Strength`); Stylus (ID: `realia:Stylus.2`); Laurel (ID: `flora:Laurel`); Nebo (ID: `deity:Nebo`); Elm (ID: `flora:Elm`); Anvil (ID: `realia:Anvil`); Compass (ID: `realia:Compass`); Chisel (ID: `realia:Chisel`); Redeem (ID: `keyterm:Redeem`); Incantations (ID: `keyterm:Incantations`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Understanding (ID: `keyterm:Understanding`); Salvation (ID: `keyterm:Salvation`); Seba (ID: `place:Seba`); Mulberry (ID: `flora:Mulberry`); Laurustinus (ID: `flora:Laurustinus`); Koreshi (ID: `person:Cyrus`); Beli (ID: `deity:Bel`); Sabeans (ID: `group:Sabean`); Calamus (ID: `flora:Calamus`); Span (ID: `realia:Span`); Sheba (ID: `person:Sheba`); Aleppo Pine (ID: `flora:PineTree`); Mighty One (ID: `keyterm:MightyOne`); Kedari (ID: `person:Kedar`); Veil (ID: `realia:Veil`); Grecian Juniper (ID: `flora:Juniper`)
...
* **Associated Passages:** Isaya 49:1-53:12
...
* **Associated ACAI Concepts:** Oryx (ID: `fauna:Oryx`); Moth (ID: `fauna:Moth`); Sewene (ID: `place:Syene`); Mosquito (ID: `fauna:Mosquito`); Quiver (ID: `realia:Quiver`); Garden of Eden (ID: `place:Eden.2`); Arrow (ID: `keyterm:Arrow`); Rebel (ID: `keyterm:Rebel`); Salvation (ID: `keyterm:Salvation`); Yerusalemu (ID: `place:Jerusalem`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`)
...
* **Associated Passages:** Isaya 54:1-66:24
...
* **Associated ACAI Concepts:** Gentiles (ID: `group:Gentile`); Delight (ID: `keyterm:Delight`); Mischief (ID: `keyterm:Mischief`); Peace (ID: `keyterm:IntactState`); Passion (ID: `keyterm:Ardour`); Sabbath (ID: `keyterm:Sabbath`); Ajali (ID: `deity:Destiny`); Bahati (ID: `deity:Fortune`); Efa (ID: `place:Ephah`); To Sin (ID: `keyterm:Sin`); Pig (ID: `fauna:Pig`); Redeem (ID: `keyterm:Redeem`); Defile (ID: `keyterm:Stain`); Spider (ID: `fauna:Spider`); Laurustinus (ID: `flora:Laurustinus`); Robe (ID: `realia:Robe`); Rush (ID: `flora:Rush`); Turban (ID: `realia:Turban.2`); Tubali (ID: `place:Tubal`); Breastplate (ID: `realia:Breastplate`); Nebayothi (ID: `person:Nebaioth`); Mouse (ID: `fauna:Mouse`); Nettle (ID: `flora:Nettle`); Helmet (ID: `realia:Helmet`); Sheba (ID: `place:Sheba.2`); Peg (ID: `realia:Peg`); Poor (ID: `keyterm:Poor`); Ship (ID: `realia:Ship`); The Way (ID: `keyterm:TheWay`); Rebel (ID: `keyterm:Rebel`)
