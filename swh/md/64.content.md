...
* **Associated ACAI Concepts:** Diotrefe (ID: `person:Diotrephes`); Gayo (ID: `person:Gaius.4`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); Demetrio (ID: `person:Demetrius`); Truth (ID: `keyterm:Truth`)
