...
* **Associated ACAI Concepts:** Musa (ID: `person:Moses`); BWANA (ID: `deity:Lord`); Haruni (ID: `person:Aaron`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); To Sin (ID: `keyterm:Sin`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Priesthood (ID: `keyterm:Priesthood`); Israeli (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Tent of Meeting (ID: `realia:TentOfMeeting`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Decree (ID: `keyterm:Decree`); Appease (ID: `keyterm:Appease`); Ithamari (ID: `person:Ithamar`); Smear (ID: `keyterm:Smear`); Eleazari (ID: `person:Eleazar.2`); Slaughtering (ID: `keyterm:Slaughtering`); Glory (ID: `keyterm:Glory`); Bless (ID: `keyterm:Bless`); Complete (ID: `keyterm:Complete`); Pure (ID: `keyterm:Pure`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Tunic (ID: `realia:Tunic`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Appease (ID: `keyterm:Appease`); To Sin (ID: `keyterm:Sin`); Holy (ID: `keyterm:Holy`); BWANA (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Haruni (ID: `person:Aaron`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Israeli (ID: `person:Israel`); patakatifu (ID: `place:HolyPlace`); Cattle (ID: `fauna:Bull`); Tent of Meeting (ID: `realia:TentOfMeeting`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Azazeli (ID: `deity:Azazel`); Cover Lid (ID: `realia:CoverLid`); Lot (ID: `keyterm:Lot`); Musa (ID: `person:Moses`); Linen (ID: `realia:Linen`); Lot (ID: `realia:Lot`); Curtain (ID: `realia:Curtain`); Pure (ID: `keyterm:Pure`); Defilement (ID: `keyterm:Defilement`); Rebel (ID: `keyterm:Rebel`); Passion (ID: `keyterm:Ardour`); Sheep (ID: `fauna:Lamb`); Repent (ID: `keyterm:Repent`); Priesthood (ID: `keyterm:Priesthood`); Testimony (ID: `keyterm:Witness.2`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Covenant Box (ID: `keyterm:CovenantBox`); Sabbath (ID: `keyterm:Sabbath`); Smear (ID: `keyterm:Smear`); Tunic (ID: `realia:Tunic`); Sash (ID: `realia:Sash`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Breeches (ID: `realia:Breeches`); Shovel (ID: `realia:Shovel`); Horns of Altar (ID: `realia:HornsOfAltar`); Turban (ID: `realia:Turban`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Holy (ID: `keyterm:Holy`); Defilement (ID: `keyterm:Defilement`); Israeli (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); To Dishonor (ID: `keyterm:Dishonor`); Musa (ID: `person:Moses`); Haruni (ID: `person:Aaron`); Slaughtering (ID: `keyterm:Slaughtering`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Passion (ID: `keyterm:Ardour`); Moleki (ID: `deity:Molech`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Delight (ID: `keyterm:Delight`); Cattle (ID: `fauna:Bull`); Fear (ID: `keyterm:Fear`); Misri (ID: `place:Egypt`); Pure (ID: `keyterm:Pure`); Sheep (ID: `fauna:Lamb`); Tent of Meeting (ID: `realia:TentOfMeeting`); Necromancer (ID: `keyterm:Spirit`); Vow (ID: `keyterm:Vow`); Stone Altar (ID: `realia:StoneAltar`); Goat (ID: `fauna:Goat`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Flock (ID: `fauna:Flock`); Altar (ID: `realia:Altar`); Appease (ID: `keyterm:Appease`); Complete (ID: `keyterm:Complete`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); Israeli (ID: `person:Israel`); Sabbath (ID: `keyterm:Sabbath`); Musa (ID: `person:Moses`); Work (ID: `keyterm:Work`); Appointed Feast (ID: `keyterm:AppointedFeast`); Barley (ID: `flora:Barley`); Complete (ID: `keyterm:Complete`); Sheep (ID: `fauna:Lamb`); Sickle (ID: `realia:Sickle`); Atonement (ID: `keyterm:Atonement`); Slaughtering (ID: `keyterm:Slaughtering`); Haruni (ID: `person:Aaron`); Pure (ID: `keyterm:Pure`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Wine (ID: `realia:Wine`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Lamp (ID: `realia:Lamp`); Testimony (ID: `keyterm:Witness.2`); Memorial Portion (ID: `keyterm:MemorialOrTokenPortion`); Passover (ID: `keyterm:Passover`); Vow (ID: `keyterm:Vow`); Delight (ID: `keyterm:Delight`); Misri (ID: `place:Egypt`); Covenant (ID: `keyterm:Covenant`); Israelites (ID: `group:Israel`); To Sin (ID: `keyterm:Sin`); Decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Musa (ID: `person:Moses`); Israelites (ID: `group:Israel`); Cattle (ID: `fauna:Bull`); Dibri (ID: `person:Dibri`); Shelomithi (ID: `person:Shelomith.2`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Dani (ID: `place:Dan`); Egyptians (ID: `group:Egypt`); Misri (ID: `place:Egypt`); Dani (ID: `group:Dan`)
...
* **Associated ACAI Concepts:** Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Redeem (ID: `keyterm:Redeem`); BWANA (ID: `deity:Lord`); Sabbath (ID: `keyterm:Sabbath`); Israeli (ID: `person:Israel`); House (ID: `realia:House`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); Misri (ID: `place:Egypt`); Complete (ID: `keyterm:Complete`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Safety (ID: `keyterm:Safety`); Holy (ID: `keyterm:Holy`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); Sinai (ID: `place:SinaiMount`); Wakanaani (ID: `place:Canaan`); Bless (ID: `keyterm:Bless`); Atonement (ID: `keyterm:Atonement`); Musa (ID: `person:Moses`); Work (ID: `keyterm:Work`); Dispossess (ID: `keyterm:Dispossess`); Barley (ID: `flora:Barley`); Cattle (ID: `fauna:Bull`); Rams Horn (ID: `realia:RamsHorn`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Passion (ID: `keyterm:Ardour`); Sabbath (ID: `keyterm:Sabbath`); To Sin (ID: `keyterm:Sin`); Misri (ID: `place:Egypt`); Israeli (ID: `person:Israel`); Repent (ID: `keyterm:Repent`); Strength (ID: `keyterm:Strength`); Sinai (ID: `place:SinaiMount`); Isaka (ID: `person:Isaac`); Be Unfaithful (ID: `keyterm:Unfaithful`); Abrahamu (ID: `person:Abraham`); Complete (ID: `keyterm:Complete`); Fear (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); Stubborn (ID: `keyterm:Stubborn`); Idol (ID: `keyterm:Idol`); Musa (ID: `person:Moses`); Safety (ID: `keyterm:Safety`); Peace (ID: `keyterm:IntactState`); Decree (ID: `keyterm:Decree`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Image (ID: `realia:Image`); Yoke (ID: `realia:Yoke`); High Place (ID: `realia:HighPlace`); Graven Image (ID: `realia:GravenImage`); Cattle (ID: `fauna:Bull`); Stone Pine (ID: `flora:Pine`); Jackal (ID: `fauna:Jackal`); Coriander (ID: `flora:Coriander`); Sacred Pillar (ID: `realia:SacredPillar`); Vine (ID: `flora:Vine`); Bear (ID: `fauna:Bear`); Lion (ID: `fauna:Lion`); Hyena (ID: `fauna:Hyena`); Barley (ID: `flora:Barley`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); BWANA (ID: `deity:Lord`); Redeem (ID: `keyterm:Redeem`); Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Shekel (ID: `realia:Shekel`); Money (ID: `realia:Money`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Set Apart for God (ID: `keyterm:Proscribe`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); Vow (ID: `keyterm:Vow`); Musa (ID: `person:Moses`); Defilement (ID: `keyterm:Defilement`); Israeli (ID: `person:Israel`); Barley (ID: `flora:Barley`); House (ID: `realia:House`); Coriander (ID: `flora:Coriander`); Sinai (ID: `place:SinaiMount`); Gerah (ID: `realia:Gerah`); Homer (ID: `realia:Homer`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
