...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yesu (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); Holy (ID: `keyterm:Holy`); Truth (ID: `keyterm:Truth`); Pray (ID: `keyterm:Pray`); Faithfulness (ID: `keyterm:Faithfulness`); Favor (ID: `keyterm:Favor`); In Christ (ID: `keyterm:InChrist`); Deliver (ID: `keyterm:Deliver`); Kolosai (ID: `place:Colossae`); Live (ID: `keyterm:Live.3`); Epafra (ID: `person:Epaphras`); Beloved (ID: `keyterm:Beloved`); Good News (ID: `keyterm:GoodNews`); Paulo (ID: `person:Paul`); To Sin (ID: `keyterm:Sin`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Forgive (ID: `keyterm:Forgive`); Believe (ID: `keyterm:Believe`); Sky (ID: `keyterm:Heaven`); Timotheo (ID: `person:Timothy`); Hope (ID: `keyterm:Hope`); Good (ID: `keyterm:Good`); Liberation (ID: `keyterm:Liberation`); Authority (ID: `keyterm:Authority.2`); Roho (ID: `deity:HolySpirit`); Make Peace (ID: `keyterm:Peace`); Kingdom (ID: `keyterm:Kingdom`)
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Body (ID: `keyterm:Body.3`); BWANA (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Believe (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); Laodikia (ID: `place:Laodicea`); Heart (ID: `keyterm:Heart`); Hope (ID: `keyterm:Hope`); Ask for (ID: `keyterm:AskFor`); Church (ID: `keyterm:Church`); Holy (ID: `keyterm:Holy`); Spirit (ID: `keyterm:Spirit.2`); Always (ID: `keyterm:Always`); Encourage (ID: `keyterm:Encourage`); Proclaim (ID: `keyterm:Proclaim`); Gentiles (ID: `group:Gentile`); In Christ (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Love (ID: `keyterm:Love`); Heart (ID: `keyterm:Heart`); Think (ID: `keyterm:Think`); Scythians (ID: `group:Scythians`); Glory (ID: `keyterm:Glory`); Forgive (ID: `keyterm:Forgive`); Affection (ID: `keyterm:Affection`); Ability (ID: `keyterm:Ability`); Kindness (ID: `keyterm:Kindness`); Live (ID: `keyterm:Live.3`); Body (ID: `keyterm:Body.3`); Chosen (ID: `keyterm:Chosen`); Mercy (ID: `keyterm:Mercy`); Idolatry (ID: `keyterm:Idolatry`); Defilement (ID: `keyterm:Defilement`); Yavani (ID: `person:Javan`); Holy (ID: `keyterm:Holy`); Make Peace (ID: `keyterm:Peace`); Resurrection (ID: `keyterm:Resurrection`); Circumcision (ID: `keyterm:Circumcision`); Name (ID: `keyterm:Name`); Favor (ID: `keyterm:Favor`); Greeks (ID: `group:Greek`); Fornication (ID: `keyterm:Fornication`); Jews (ID: `group:Jews`); Blaspheme (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); To Act Wickedly (ID: `keyterm:ActWickedly`); Partiality (ID: `keyterm:Partiality`); Body (ID: `keyterm:Body.3`); Be Enslaved (ID: `keyterm:Serve.2`); Heart (ID: `keyterm:Heart`); Fear (ID: `keyterm:Fear`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Sky (ID: `keyterm:Heaven`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); Yesu (ID: `person:Jesus.2`); Live (ID: `keyterm:Live.3`); Favor (ID: `keyterm:Favor`); BWANA (ID: `deity:Lord`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** Laodikia (ID: `place:Laodicea`); Yesu (ID: `person:Jesus.2`); Beloved (ID: `keyterm:Beloved`); BWANA (ID: `deity:Lord`); Church (ID: `keyterm:Church`); Faithfulness (ID: `keyterm:Faithfulness`); Arkipo (ID: `person:Archippus`); Hierapoli (ID: `place:Hierapolis`); Aristarko (ID: `person:Aristarchus`); Dema (ID: `person:Demas`); Nimfa (ID: `person:Nympha`); Onesimo (ID: `person:Onesimus`); Epafra (ID: `person:Epaphras`); Luka (ID: `person:Luke`); Yusto (ID: `person:Justus.3`); Tikiko (ID: `person:Tychicus`); Commandment (ID: `keyterm:Commandment`); To Command (ID: `keyterm:Command`); Paulo (ID: `person:Paul`); Bear Witness (ID: `keyterm:BearWitness`); Laodiceans (ID: `group:Laodicea`); Marko (ID: `person:Mark`); Heart (ID: `keyterm:Heart`); To Cause to Happen (ID: `keyterm:Happen`); Ask for (ID: `keyterm:AskFor`); Barnaba (ID: `person:Barnabas`); Pray (ID: `keyterm:Pray`); Serve (ID: `keyterm:Serve`); Complete (ID: `keyterm:Complete`); Circumcision (ID: `keyterm:Circumcision`); Favor (ID: `keyterm:Favor`); Kingdom (ID: `keyterm:Kingdom`); Encourage (ID: `keyterm:Encourage`); House (ID: `realia:House`); Chain (ID: `realia:Chain`); Temple (ID: `realia:Temple`)
