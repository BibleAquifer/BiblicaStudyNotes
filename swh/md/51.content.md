...
* **Associated ACAI Concepts:** Kolosai (ID: `place:Colossae`); Epafra (ID: `person:Epaphras`); Deliver (ID: `keyterm:Deliver`); Live (ID: `keyterm:Live.3`); Beloved (ID: `keyterm:Beloved`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Fundamental Principles (ID: `keyterm:FundamentalPrinciples`); Divine (ID: `keyterm:Divine`); Teaching (ID: `keyterm:Teaching`); Empty (ID: `keyterm:Empty`); Baptism (ID: `keyterm:Baptism`); Body (ID: `keyterm:Body.3`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Scythians (ID: `group:Scythians`); Think (ID: `keyterm:Think`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Partiality (ID: `keyterm:Partiality`); To Act Wickedly (ID: `keyterm:ActWickedly`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Laodikia (ID: `place:Laodicea`); Nimfa (ID: `person:Nympha`); Hierapoli (ID: `place:Hierapolis`); Yusto (ID: `person:Justus.3`); Arkipo (ID: `person:Archippus`); Onesimo (ID: `person:Onesimus`); Epafra (ID: `person:Epaphras`); Dema (ID: `person:Demas`); Luka (ID: `person:Luke`); Aristarko (ID: `person:Aristarchus`); Tikiko (ID: `person:Tychicus`)
