...
* **Associated ACAI Concepts:** Misri (ID: `place:Egypt`); Farao (ID: `person:Pharaoh.5`); Israeli (ID: `person:Israel`); Hebrews (ID: `group:Hebrews`); Musa (ID: `person:Moses`); BWANA (ID: `deity:Lord`); Egyptians (ID: `group:Egypt`); mto (ID: `place:Nile`); Yusufu (ID: `person:Joseph.10`); Fear (ID: `keyterm:Fear`); Force to Serve (ID: `keyterm:EnticedToServe`); Work (ID: `keyterm:Work`); Midiani (ID: `place:Midian`); Walawi (ID: `person:Levi.3`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Pithomu (ID: `place:Pithom`); Sipora (ID: `person:Zipporah`); Gershomu (ID: `person:Gershom`); Shifra (ID: `person:Shiphrah`); Pua (ID: `person:Puah.3`); Cattails (ID: `flora:Cattails`); Yethro (ID: `person:Jethro`); Benyamini (ID: `person:Benjamin`); Reubeni (ID: `person:Reuben`); Isaka (ID: `person:Isaac`); Abrahamu (ID: `person:Abraham`); Ramesesi (ID: `place:Raamses`); Covenant (ID: `keyterm:Covenant`); Walawi (ID: `group:Levi`); Gadi (ID: `person:Gad`); Isakari (ID: `person:Issachar`); Simeoni (ID: `person:Simeon.5`); Naftali (ID: `person:Naphtali`); Dani (ID: `person:Dan`); Yuda (ID: `person:Judah.4`); Zabuloni (ID: `person:Zebulun`); Asheri (ID: `person:Asher`); Sheep (ID: `fauna:Lamb`); Ship (ID: `realia:Ship`); Papyrus (ID: `flora:Papyrus`); Birthstool (ID: `realia:Birthstool`); Brick (ID: `realia:Brick`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); Israeli (ID: `person:Israel`); Misri (ID: `place:Egypt`); Farao (ID: `person:Pharaoh.6`); Haruni (ID: `person:Aaron`); Isaka (ID: `person:Isaac`); Abrahamu (ID: `person:Abraham`); Believe In (ID: `keyterm:BelieveIn`); Force to Serve (ID: `keyterm:EnticedToServe`); Walawi (ID: `person:Levi.3`); Egyptians (ID: `group:Egypt`); Wakanaani (ID: `place:Canaan`); Work (ID: `keyterm:Work`); Brick (ID: `realia:Brick`); Walawi (ID: `group:Levi`); Canaanites (ID: `group:Canaan`); Rod (ID: `realia:Rod`); Yethro (ID: `person:Jethro`); Perizzites (ID: `group:Perizzites`); Uzieli (ID: `person:Uzziel`); Gershoni (ID: `person:Gershon`); Kohathi (ID: `person:Kohath`); Mhiti (ID: `person:Heth`); Land Flowing of Milk and Honey (ID: `keyterm:LandFlowingOfMilkAndHoney`); Amramu (ID: `person:Amram`); Midiani (ID: `place:Midian`); Eleazari (ID: `person:Eleazar.2`); Ishari (ID: `person:Izhar`); Jebusites (ID: `group:Jebusites`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Farao (ID: `person:Pharaoh.6`); Musa (ID: `person:Moses`); Misri (ID: `place:Egypt`); Haruni (ID: `person:Aaron`); mto (ID: `place:Nile`); Force to Serve (ID: `keyterm:EnticedToServe`); Israeli (ID: `person:Israel`); Egyptians (ID: `group:Egypt`); Rod (ID: `realia:Rod`); Frog (ID: `fauna:Frog`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Miraculous Sign (ID: `keyterm:MiraculousSign`); To Sin (ID: `keyterm:Sin`); Hebrews (ID: `group:Hebrews`); Fly (ID: `fauna:Fly`); Locust (ID: `fauna:Locust`); Snake (ID: `fauna:Snake`); Grass (ID: `flora:Grass`); Symbol (ID: `keyterm:Example`); Gosheni (ID: `place:Goshen`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Mosquito (ID: `fauna:Mosquito`); Dragon (ID: `fauna:Dragon`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Magicians of Pharoah (ID: `group:Magicians`); Plague (ID: `keyterm:Blow`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Misri (ID: `place:Egypt`); Israeli (ID: `person:Israel`); Musa (ID: `person:Moses`); Farao (ID: `person:Pharaoh.6`); Haruni (ID: `person:Aaron`); Passover (ID: `keyterm:Passover`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Unleavened Bread (ID: `realia:UnleavenedBread`); Work (ID: `keyterm:Work`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Circumcision (ID: `keyterm:Circumcision`); Canaanites (ID: `group:Canaan`); Symbol (ID: `keyterm:Example`); Wakanaani (ID: `place:Canaan`); Force to Serve (ID: `keyterm:EnticedToServe`); Redeem (ID: `keyterm:Redeem`); Swear (ID: `keyterm:Swear`); Favor (ID: `keyterm:Favor`); Instruction (ID: `keyterm:Instruction`); Holy (ID: `keyterm:Holy`); Doorpost (ID: `realia:Doorpost`); Money (ID: `realia:Money`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Sukothi (ID: `place:Succoth.2`); Jebusites (ID: `group:Jebusites`); Slaughtering (ID: `keyterm:Slaughtering`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Misri (ID: `place:Egypt`); Israeli (ID: `person:Israel`); Farao (ID: `person:Pharaoh.6`); Musa (ID: `person:Moses`); Egyptians (ID: `group:Egypt`); Chariot (ID: `realia:Chariot`); Fear (ID: `keyterm:Fear`); Horse (ID: `fauna:Horse`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Baal-sefoni (ID: `place:Baal-zephon`); Shamu (ID: `place:RedSea`); Pi-hahirothi (ID: `place:Pi-hahiroth`); Wafilisti (ID: `place:Philistine`); Miriamu (ID: `person:Miriam`); Force to Serve (ID: `keyterm:EnticedToServe`); Salvation (ID: `keyterm:Salvation`); Holy (ID: `keyterm:Holy`); Migdoli (ID: `place:Migdol`); Believe In (ID: `keyterm:BelieveIn`); Sukothi (ID: `place:Succoth.2`); Ethamu (ID: `place:Etham`); Leader (ID: `keyterm:Leader`); Wafilisti (ID: `group:Philistine`); Haruni (ID: `person:Aaron`); Kindness (ID: `keyterm:Kindness`); To Cause to Possess (ID: `keyterm:Possess`); Strength (ID: `keyterm:Strength`); Wakanaani (ID: `place:Canaan`); Mighty (ID: `keyterm:Mighty`)
...
* **Associated ACAI Concepts:** Musa (ID: `person:Moses`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Misri (ID: `place:Egypt`); Haruni (ID: `person:Aaron`); Yethro (ID: `person:Jethro`); Amaleki (ID: `place:Amalek`); Omer (ID: `realia:Omer`); Decree (ID: `keyterm:Decree`); Yoshua (ID: `person:Joshua.2`); Instruction (ID: `keyterm:Instruction`); Sabbath (ID: `keyterm:Sabbath`); Farao (ID: `person:Pharaoh.6`); Huri (ID: `person:Hur.2`); Sini (ID: `place:Sin`); Elimu (ID: `place:Elim`); Refidimu (ID: `place:Rephidim`); Sinai (ID: `place:SinaiMount`); Glory (ID: `keyterm:Glory`); Peace (ID: `keyterm:IntactState`); Shur (ID: `place:Shur`); Masa (ID: `place:Massah`); Gershomu (ID: `person:Gershom`); Mara (ID: `place:Marah`); Eliezeri (ID: `person:Eliezer.3`); Sipora (ID: `person:Zipporah`); Offering (ID: `keyterm:Offering`); Slaughtering (ID: `keyterm:Slaughtering`); Midiani (ID: `place:Midian`); Testimony (ID: `keyterm:Witness.2`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Holy (ID: `keyterm:Holy`); Haruni (ID: `person:Aaron`); Musa (ID: `person:Moses`); Israeli (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Pure (ID: `keyterm:Pure`); Priesthood (ID: `keyterm:Priesthood`); Testimony (ID: `keyterm:Witness.2`); Covenant Box (ID: `keyterm:CovenantBox`); Sabbath (ID: `keyterm:Sabbath`); Sinai (ID: `place:SinaiMount`); Force to Serve (ID: `keyterm:EnticedToServe`); Misri (ID: `place:Egypt`); patakatifu (ID: `place:HolyPlace`); Smear (ID: `keyterm:Smear`); Appease (ID: `keyterm:Appease`); Covenant (ID: `keyterm:Covenant`); To Sin (ID: `keyterm:Sin`); Glory (ID: `keyterm:Glory`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Money (ID: `realia:Money`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Cubit (ID: `realia:Cubit`); Tent of Meeting (ID: `realia:TentOfMeeting`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); Haruni (ID: `person:Aaron`); Misri (ID: `place:Egypt`); To Sin (ID: `keyterm:Sin`); Israeli (ID: `person:Israel`); Molten Image (ID: `realia:MoltenImage`); Cattle (ID: `fauna:Bull`); Tablet (ID: `realia:Tablet`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Earring (ID: `realia:Earring`); Ask for (ID: `keyterm:AskFor`); Stubborn (ID: `keyterm:Stubborn`); Scroll (ID: `realia:Scroll`); Offering (ID: `keyterm:Offering`); Forgive (ID: `keyterm:Forgive`); Yoshua (ID: `person:Joshua.2`); Strength (ID: `keyterm:Strength`); Isaka (ID: `person:Isaac`); Testimony (ID: `keyterm:Witness.2`); Bless (ID: `keyterm:Bless`); Abrahamu (ID: `person:Abraham`); Swear (ID: `keyterm:Swear`); An Angel (ID: `deity:Angel`); The Way (ID: `keyterm:TheWay`); Appoint (ID: `keyterm:Appoint`); Egyptians (ID: `group:Egypt`); Appease (ID: `keyterm:Appease`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); Israeli (ID: `person:Israel`); Sinai (ID: `place:SinaiMount`); Covenant (ID: `keyterm:Covenant`); Favor (ID: `keyterm:Favor`); Tent (ID: `realia:Tent`); Stubborn (ID: `keyterm:Stubborn`); Tablet (ID: `realia:Tablet`); Kindness (ID: `keyterm:Kindness`); Glory (ID: `keyterm:Glory`); Hittites (ID: `group:Hittite`); To Sin (ID: `keyterm:Sin`); Veil (ID: `realia:Veil`); Jebusites (ID: `group:Jebusites`); Slaughtering (ID: `keyterm:Slaughtering`); Haruni (ID: `person:Aaron`); Forgive (ID: `keyterm:Forgive`); Canaanites (ID: `group:Canaan`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Wakanaani (ID: `place:Canaan`); Perizzites (ID: `group:Perizzites`); Fear (ID: `keyterm:Fear`); Misri (ID: `place:Egypt`); Mhiti (ID: `person:Heth`); Amorites (ID: `group:Amorites`); Passion (ID: `keyterm:Ardour`); Hivites (ID: `group:Hivites`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); Feast of Weeks (ID: `keyterm:FeastOfWeeks`)
