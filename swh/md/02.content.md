...
* **Associated ACAI Concepts:** Farao (ID: `person:Pharaoh.5`); Misri (ID: `place:Egypt`); Musa (ID: `person:Moses`); Pua (ID: `person:Puah.3`); Pithomu (ID: `place:Pithom`); Birthstool (ID: `realia:Birthstool`); Shifra (ID: `person:Shiphrah`); mto (ID: `place:Nile`); Cattails (ID: `flora:Cattails`); Sipora (ID: `person:Zipporah`); Work (ID: `keyterm:Work`); Force to Serve (ID: `keyterm:EnticedToServe`); Gershomu (ID: `person:Gershom`); Papyrus (ID: `flora:Papyrus`); Hebrews (ID: `group:Hebrews`); Egyptians (ID: `group:Egypt`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Brick (ID: `realia:Brick`); Farao (ID: `person:Pharaoh.6`); Bush (ID: `flora:Bush`); Believe In (ID: `keyterm:BelieveIn`); Musa (ID: `person:Moses`); Haruni (ID: `person:Aaron`); BWANA (ID: `deity:Lord`); Zikri (ID: `person:Zichri`); Nefegi (ID: `person:Nepheg`); Putieli (ID: `person:Putiel`); Sithri (ID: `person:Sithri`); Elisheba (ID: `person:Elisheba`); mwanamke (ID: `person:CanaaniteWoman`); Elkana (ID: `person:Elkanah`); Mishaeli (ID: `person:Mishael`); Asiri (ID: `person:Assir`); Yokebedi (ID: `person:Jochebed`); Ohadi (ID: `person:Ohad`); Yethro (ID: `person:Jethro`); Amramu (ID: `person:Amram`); Uzieli (ID: `person:Uzziel`); Ishari (ID: `person:Izhar`); Land Flowing of Milk and Honey (ID: `keyterm:LandFlowingOfMilkAndHoney`); Perizzites (ID: `group:Perizzites`); Gershoni (ID: `person:Gershon`); Kohathi (ID: `person:Kohath`); Mhiti (ID: `person:Heth`); Midiani (ID: `place:Midian`); Sipora (ID: `person:Zipporah`); Eleazari (ID: `person:Eleazar.2`)
...
* **Associated ACAI Concepts:** Frog (ID: `fauna:Frog`); Fly (ID: `fauna:Fly`); Farao (ID: `person:Pharaoh.6`); mto (ID: `place:Nile`); Locust (ID: `fauna:Locust`); Egyptians (ID: `group:Egypt`); Mosquito (ID: `fauna:Mosquito`); Miraculous Sign (ID: `keyterm:MiraculousSign`); Magicians of Pharoah (ID: `group:Magicians`); Symbol (ID: `keyterm:Example`); Flax (ID: `flora:Flax`); Plague (ID: `keyterm:Blow`); Wheat (ID: `flora:Wheat`); Barley (ID: `flora:Barley`); Rod (ID: `realia:Rod`); Haruni (ID: `person:Aaron`); Musa (ID: `person:Moses`); Misri (ID: `place:Egypt`); Force to Serve (ID: `keyterm:EnticedToServe`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Unleavened Bread (ID: `realia:UnleavenedBread`); Passover (ID: `keyterm:Passover`); Misri (ID: `place:Egypt`); Doorpost (ID: `realia:Doorpost`); Sukothi (ID: `place:Succoth.2`); Bitter Herbs (ID: `flora:Chicory`); Bowl (ID: `realia:Bowl`); Hyssop (ID: `flora:Hyssop`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Staff (ID: `realia:Staff`); Farao (ID: `person:Pharaoh.6`); Cattle (ID: `fauna:Bull`); Musa (ID: `person:Moses`); Haruni (ID: `person:Aaron`); House (ID: `realia:House`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Chariot (ID: `realia:Chariot`); Baal-sefoni (ID: `place:Baal-zephon`); Pi-hahirothi (ID: `place:Pi-hahiroth`); Miriamu (ID: `person:Miriam`); Shamu (ID: `place:RedSea`); Wafilisti (ID: `place:Philistine`); Sukothi (ID: `place:Succoth.2`); Ethamu (ID: `place:Etham`); Leader (ID: `keyterm:Leader`); Migdoli (ID: `place:Migdol`); Drum (ID: `realia:Drum`); Believe In (ID: `keyterm:BelieveIn`); Egyptians (ID: `group:Egypt`); Farao (ID: `person:Pharaoh.6`); Horse (ID: `fauna:Horse`); Misri (ID: `place:Egypt`); Musa (ID: `person:Moses`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Omer (ID: `realia:Omer`); Yethro (ID: `person:Jethro`); Decree (ID: `keyterm:Decree`); Elimu (ID: `place:Elim`); Sini (ID: `place:Sin`); Refidimu (ID: `place:Rephidim`); Huri (ID: `person:Hur.2`); Worm (ID: `fauna:Maggot`); Sipora (ID: `person:Zipporah`); Mara (ID: `place:Marah`); Quail (ID: `fauna:Quail`); Eliezeri (ID: `person:Eliezer.3`); Masa (ID: `place:Massah`); Shur (ID: `place:Shur`); Gershomu (ID: `person:Gershom`); Coriander (ID: `flora:Coriander`); Date Palm (ID: `flora:DatePalm`); Throne (ID: `realia:Throne`); Amaleki (ID: `place:Amalek`); Musa (ID: `person:Moses`); Haruni (ID: `person:Aaron`); Misri (ID: `place:Egypt`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Breast-Piece (ID: `realia:Breast-piece`); Lampstand (ID: `realia:Lampstand`); Turban (ID: `realia:Turban`); Loop (ID: `realia:Loop`); Linen Strips (ID: `realia:LinenStrips`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Frame (ID: `realia:Frame`); Cover Lid (ID: `realia:CoverLid`); Spindle (ID: `realia:Spindle`); Tunic (ID: `realia:Tunic`); Perimiter Curtain (ID: `realia:PerimiterCurtain`); Acacia (ID: `flora:Acacia`); Ephod (ID: `realia:Ephod`); Horns of Altar (ID: `realia:HornsOfAltar`); Purple Cloth (ID: `realia:PurpleCloth`); Lampstand (ID: `realia:Lampstand.2`); Testimony (ID: `keyterm:Witness.2`); Curtain (ID: `realia:Curtain`); patakatifu (ID: `place:HolyPlace`); Priesthood (ID: `keyterm:Priesthood`); Linen (ID: `realia:Linen`); Sash (ID: `realia:Sash`); Sinai (ID: `place:SinaiMount`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Holy (ID: `keyterm:Holy`); Smear (ID: `keyterm:Smear`); Winged Creature (ID: `realia:WingedCreature`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Molten Image (ID: `realia:MoltenImage`); Tablet (ID: `realia:Tablet`); Earring (ID: `realia:Earring`); Stubborn (ID: `keyterm:Stubborn`); Ask for (ID: `keyterm:AskFor`); Haruni (ID: `person:Aaron`); Musa (ID: `person:Moses`); Cattle (ID: `fauna:Bull`); Misri (ID: `place:Egypt`); To Sin (ID: `keyterm:Sin`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Tent (ID: `realia:Tent`); Musa (ID: `person:Moses`); Veil (ID: `realia:Veil`); Hittites (ID: `group:Hittite`); Kindness (ID: `keyterm:Kindness`); Glory (ID: `keyterm:Glory`); To Sin (ID: `keyterm:Sin`); Jealous (ID: `keyterm:Zealous.2`); Feast of Weeks (ID: `keyterm:FeastOfWeeks`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); Generous (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); Sacred Pole (ID: `realia:SacredPole`); Tent of Meeting (ID: `realia:TentOfMeeting`); Truth (ID: `keyterm:Truth`); Sinai (ID: `place:SinaiMount`); Favor (ID: `keyterm:Favor`); Covenant (ID: `keyterm:Covenant`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Grating (ID: `realia:Grating`); Besaleli (ID: `person:Bezalel`); Spindle (ID: `realia:Spindle`); Perimiter Curtain (ID: `realia:PerimiterCurtain`); Screen (ID: `realia:Screen`); Frame (ID: `realia:Frame`); Oholiabu (ID: `person:Oholiab`); Lampstand (ID: `realia:Lampstand`); Breast-Piece (ID: `realia:Breast-piece`); Linen Strips (ID: `realia:LinenStrips`); Goat Hair Strips (ID: `realia:GoatHairStrips`); Dyed Cloth (ID: `realia:DyedCloth`); Tent of Meeting (ID: `realia:TentOfMeeting`); Offering (ID: `keyterm:Offering`); Ability (ID: `keyterm:Ability`); Peg (ID: `realia:Peg`); Ahisamaki (ID: `person:Ahisamach`); Uri (ID: `person:Uri`); Almond (ID: `flora:Almond`); A Half Shekel (ID: `realia:AHalfShekel`); Plate (ID: `realia:Plate`); Glory (ID: `keyterm:Glory`); Mirror (ID: `realia:Mirror`); Crown (ID: `realia:Crown`); Loop (ID: `realia:Loop`); Cover Lid (ID: `realia:CoverLid`); Acacia (ID: `flora:Acacia`); Embroidered Cloth (ID: `realia:EmbroideredCloth`); Ephod (ID: `realia:Ephod`); Purple Cloth (ID: `realia:PurpleCloth`)
