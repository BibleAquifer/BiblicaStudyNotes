...
* **Associated ACAI Concepts:** Misri (ID: `place:Egypt`); Farao (ID: `person:Pharaoh.5`); Israeli (ID: `person:Israel`); Hebrews (ID: `group:Hebrews`); Musa (ID: `person:Moses`); BWANA (ID: `deity:Lord`); Egyptians (ID: `group:Egypt`); mto (ID: `place:Nile`); Yusufu (ID: `person:Joseph.10`); Fear (ID: `keyterm:Fear`); Force to Serve (ID: `keyterm:EnticedToServe`); Work (ID: `keyterm:Work`); Midiani (ID: `place:Midian`); Walawi (ID: `person:Levi.3`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Pithomu (ID: `place:Pithom`); Shifra (ID: `person:Shiphrah`); Sipora (ID: `person:Zipporah`); Pua (ID: `person:Puah.3`); Gershomu (ID: `person:Gershom`); Cattails (ID: `flora:Cattails`); Simeoni (ID: `person:Simeon.5`); Yethro (ID: `person:Jethro`); Asheri (ID: `person:Asher`); Benyamini (ID: `person:Benjamin`); Yuda (ID: `person:Judah.4`); Gadi (ID: `person:Gad`); Ramesesi (ID: `place:Raamses`); Reubeni (ID: `person:Reuben`); Isakari (ID: `person:Issachar`); Abrahamu (ID: `person:Abraham`); Naftali (ID: `person:Naphtali`); Dani (ID: `person:Dan`); Zabuloni (ID: `person:Zebulun`); Covenant (ID: `keyterm:Covenant`); Isaka (ID: `person:Isaac`); Walawi (ID: `group:Levi`); Sheep (ID: `fauna:Lamb`); Ship (ID: `realia:Ship`); Birthstool (ID: `realia:Birthstool`); Papyrus (ID: `flora:Papyrus`); Brick (ID: `realia:Brick`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); Israeli (ID: `person:Israel`); Misri (ID: `place:Egypt`); Farao (ID: `person:Pharaoh.6`); Haruni (ID: `person:Aaron`); Abrahamu (ID: `person:Abraham`); Isaka (ID: `person:Isaac`); Believe In (ID: `keyterm:BelieveIn`); Wakanaani (ID: `place:Canaan`); Walawi (ID: `person:Levi.3`); Force to Serve (ID: `keyterm:EnticedToServe`); Work (ID: `keyterm:Work`); Egyptians (ID: `group:Egypt`); Brick (ID: `realia:Brick`); Canaanites (ID: `group:Canaan`); Walawi (ID: `group:Levi`); Rod (ID: `realia:Rod`); Yethro (ID: `person:Jethro`); Land Flowing of Milk and Honey (ID: `keyterm:LandFlowingOfMilkAndHoney`); Gershoni (ID: `person:Gershon`); Eleazari (ID: `person:Eleazar.2`); Uzieli (ID: `person:Uzziel`); Perizzites (ID: `group:Perizzites`); Mhiti (ID: `person:Heth`); Midiani (ID: `place:Midian`); Amramu (ID: `person:Amram`); Ishari (ID: `person:Izhar`); Kohathi (ID: `person:Kohath`); Unable to Speak Well (ID: `keyterm:UnableToSpeakWell`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Misri (ID: `place:Egypt`); Israeli (ID: `person:Israel`); Farao (ID: `person:Pharaoh.6`); Musa (ID: `person:Moses`); Egyptians (ID: `group:Egypt`); Chariot (ID: `realia:Chariot`); Fear (ID: `keyterm:Fear`); Horse (ID: `fauna:Horse`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Baal-sefoni (ID: `place:Baal-zephon`); Shamu (ID: `place:RedSea`); Wafilisti (ID: `place:Philistine`); Pi-hahirothi (ID: `place:Pi-hahiroth`); Miriamu (ID: `person:Miriam`); Holy (ID: `keyterm:Holy`); Force to Serve (ID: `keyterm:EnticedToServe`); Salvation (ID: `keyterm:Salvation`); Sukothi (ID: `place:Succoth.2`); Leader (ID: `keyterm:Leader`); Believe In (ID: `keyterm:BelieveIn`); Ethamu (ID: `place:Etham`); Migdoli (ID: `place:Migdol`); Strength (ID: `keyterm:Strength`); To Cause to Possess (ID: `keyterm:Possess`); Redeem (ID: `keyterm:Redeem`); Yusufu (ID: `person:Joseph.10`); An Angel (ID: `deity:Angel`); Wakanaani (ID: `place:Canaan`); Dispossess (ID: `keyterm:Dispossess`)
...
* **Associated ACAI Concepts:** Musa (ID: `person:Moses`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Misri (ID: `place:Egypt`); Haruni (ID: `person:Aaron`); Yethro (ID: `person:Jethro`); Amaleki (ID: `place:Amalek`); Omer (ID: `realia:Omer`); Decree (ID: `keyterm:Decree`); Sabbath (ID: `keyterm:Sabbath`); Instruction (ID: `keyterm:Instruction`); Yoshua (ID: `person:Joshua.2`); Farao (ID: `person:Pharaoh.6`); Huri (ID: `person:Hur.2`); Elimu (ID: `place:Elim`); Sini (ID: `place:Sin`); Refidimu (ID: `place:Rephidim`); Glory (ID: `keyterm:Glory`); Sinai (ID: `place:SinaiMount`); Peace (ID: `keyterm:IntactState`); Mara (ID: `place:Marah`); Sipora (ID: `person:Zipporah`); Shur (ID: `place:Shur`); Masa (ID: `place:Massah`); Eliezeri (ID: `person:Eliezer.3`); Gershomu (ID: `person:Gershom`); Truth (ID: `keyterm:Truth`); Meriba (ID: `place:Meribah`); mto (ID: `place:Nile`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Holy (ID: `keyterm:Holy`); Haruni (ID: `person:Aaron`); Musa (ID: `person:Moses`); Israeli (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Pure (ID: `keyterm:Pure`); Priesthood (ID: `keyterm:Priesthood`); Testimony (ID: `keyterm:Witness.2`); Covenant Box (ID: `keyterm:CovenantBox`); Sabbath (ID: `keyterm:Sabbath`); Sinai (ID: `place:SinaiMount`); Force to Serve (ID: `keyterm:EnticedToServe`); Misri (ID: `place:Egypt`); patakatifu (ID: `place:HolyPlace`); Smear (ID: `keyterm:Smear`); Appease (ID: `keyterm:Appease`); Covenant (ID: `keyterm:Covenant`); Glory (ID: `keyterm:Glory`); To Sin (ID: `keyterm:Sin`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Money (ID: `realia:Money`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Tent of Meeting (ID: `realia:TentOfMeeting`); Cubit (ID: `realia:Cubit`)
