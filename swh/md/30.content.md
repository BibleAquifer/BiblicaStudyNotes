...
* **Associated ACAI Concepts:** mwa (ID: `place:AvenValley`); katika (ID: `place:Beth-eden`); Amosi (ID: `person:Amos.3`); Kiri (ID: `place:Kir`); Tekoa (ID: `place:Tekoa`); Have a Vision (ID: `keyterm:HaveAVision`); Hazaeli (ID: `person:Hazael`); Rebel (ID: `keyterm:Rebel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Sikuthi (ID: `deity:Sikkuth`); Kiuni (ID: `deity:Kiyyun`); Harmoni (ID: `place:Harmon`); kijito (ID: `place:BrookOfTheArabah`); Woe (ID: `keyterm:Woe.2`); Kalne (ID: `place:Calneh`); Lo-debari (ID: `place:Lo-debar`); Lamentation (ID: `keyterm:Lamentation`); Horns of Altar (ID: `realia:HornsOfAltar`); Israeli (ID: `person:Israel`); House (ID: `realia:House`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Amosi (ID: `person:Amos.3`); Amazia (ID: `person:Amaziah.4`); Yeroboamu (ID: `person:Jeroboam.2`); Plumb Line (ID: `realia:PlumbLine`); Sieve (ID: `realia:Sieve`); Floor (ID: `realia:Floor`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
