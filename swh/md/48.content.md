...
* **Associated ACAI Concepts:** Good News (ID: `keyterm:GoodNews`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Church (ID: `keyterm:Church`); Yakobo (ID: `person:James.3`); Behavior (ID: `keyterm:Behavior`); Waarabu (ID: `place:Arabia`); Glory (ID: `keyterm:Glory`); Blood (ID: `keyterm:Blood`); Body (ID: `keyterm:Body.3`); Teaching (ID: `keyterm:Teaching`); Petro (ID: `person:Peter`); In Christ (ID: `keyterm:InChrist`); Yudea (ID: `place:Judea`); Dameski (ID: `place:Damascus`); Favor (ID: `keyterm:Favor`); Believe (ID: `keyterm:Believe`); Gentiles (ID: `group:Gentile`); Kilikia (ID: `place:Cilicia`)
...
* **Associated ACAI Concepts:** Good News (ID: `keyterm:GoodNews`); Petro (ID: `person:Peter`); Circumcision (ID: `keyterm:Circumcision`); Gentiles (ID: `group:Gentile`); Tito (ID: `person:Titus`); Barnaba (ID: `person:Barnabas`); Yerusalemu (ID: `place:Jerusalem`); Proclaim (ID: `keyterm:Proclaim`); Yakobo (ID: `person:James.3`); Truth (ID: `keyterm:Truth`); Yesu (ID: `person:Jesus.2`); Empty (ID: `keyterm:Empty`); Greeks (ID: `group:Greek`); Fellowship (ID: `keyterm:Fellowship`); BWANA (ID: `deity:Lord`); In Christ (ID: `keyterm:InChrist`); Favor (ID: `keyterm:Favor`); Believe (ID: `keyterm:Believe`); Yavani (ID: `person:Javan`); Yohana (ID: `person:John.2`)
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Law (ID: `keyterm:Law`); Jews (ID: `group:Jews`); Gentiles (ID: `group:Gentile`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Body (ID: `keyterm:Body.3`); Petro (ID: `person:Peter`); BWANA (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Antiokia (ID: `place:Antioch`); Hypocrisy (ID: `keyterm:Hypocrisy`); Good News (ID: `keyterm:GoodNews`); Love (ID: `keyterm:Love`); Yakobo (ID: `person:James.3`); Truth (ID: `keyterm:Truth`); To Sin (ID: `keyterm:Sin`); In Christ (ID: `keyterm:InChrist`); Favor (ID: `keyterm:Favor`); Fear (ID: `keyterm:Fear`); Circumcision (ID: `keyterm:Circumcision`); Barnaba (ID: `person:Barnabas`); Condemn (ID: `keyterm:Condemn`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Promise (ID: `keyterm:Promise`); Yesu (ID: `person:Jesus.2`); Law (ID: `keyterm:Law`); Believe (ID: `keyterm:Believe`); BWANA (ID: `deity:Lord`); Abrahamu (ID: `person:Abraham`); In Christ (ID: `keyterm:InChrist`); Covenant (ID: `keyterm:Covenant`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); To Sin (ID: `keyterm:Sin`); Baptism (ID: `keyterm:Baptism`); Yavani (ID: `person:Javan`); Forgive (ID: `keyterm:Forgive`); Written (ID: `keyterm:Scripture`); Jews (ID: `group:Jews`); Greeks (ID: `group:Greek`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Fundamental Principles (ID: `keyterm:FundamentalPrinciples`); Be Enslaved (ID: `keyterm:Serve.2`); Law (ID: `keyterm:Law`); Body (ID: `keyterm:Body.3`); Yesu (ID: `person:Jesus.2`); To Act Wickedly (ID: `keyterm:ActWickedly`); Ability (ID: `keyterm:Ability`); Good News (ID: `keyterm:GoodNews`); Bear Witness (ID: `keyterm:BearWitness`); An Angel (ID: `deity:Angel`); Happiness (ID: `keyterm:Happiness`); Fear (ID: `keyterm:Fear`); Redeem (ID: `keyterm:Redeem`); Heart (ID: `keyterm:Heart`); Speak the Truth (ID: `keyterm:SpeakTheTruth`); Roho (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** Sinai (ID: `place:SinaiMount`); Hajiri (ID: `person:Hagar`); Yerusalemu (ID: `place:Jerusalem`); Body (ID: `keyterm:Body.3`); Promise (ID: `keyterm:Promise`); Enslavement (ID: `keyterm:Slavery`); Law (ID: `keyterm:Law`); Waarabu (ID: `place:Arabia`); Abrahamu (ID: `person:Abraham`); Covenant (ID: `keyterm:Covenant`); Written (ID: `keyterm:Scripture`); Isaka (ID: `person:Isaac`); Roho (ID: `deity:HolySpirit`); Be Enslaved (ID: `keyterm:Serve.2`)
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Circumcision (ID: `keyterm:Circumcision`); Heart (ID: `keyterm:Heart`); Persuade (ID: `keyterm:Persuade`); Law (ID: `keyterm:Law`); Believe (ID: `keyterm:Believe`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Proclaim (ID: `keyterm:Proclaim`); Love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); Paulo (ID: `person:Paul`); Enslavement (ID: `keyterm:Slavery`); Judgment (ID: `keyterm:Judgment`); Think (ID: `keyterm:Think`); Favor (ID: `keyterm:Favor`); That Which Persuades (ID: `keyterm:ThatWhichPersuades`); Stumbling Block (ID: `keyterm:StumblingBlock`); Roho (ID: `deity:HolySpirit`); Hope (ID: `keyterm:Hope`); Declare (ID: `keyterm:Declare`); Yoke (ID: `realia:Yoke`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Roho (ID: `deity:HolySpirit`); Love (ID: `keyterm:Love`); Law (ID: `keyterm:Law`); Resentment (ID: `keyterm:Resentment`); Live (ID: `keyterm:Live.3`); Good (ID: `keyterm:Good`); Yesu (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Fornication (ID: `keyterm:Fornication`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Be Enslaved (ID: `keyterm:Serve.2`); Kingdom (ID: `keyterm:Kingdom`); BWANA (ID: `deity:Lord`); Idolatry (ID: `keyterm:Idolatry`); Believe (ID: `keyterm:Believe`); Kindness (ID: `keyterm:Kindness`); Make Peace (ID: `keyterm:Peace`); Defilement (ID: `keyterm:Defilement`); Empty Conceit (ID: `keyterm:Conceit`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); Share (ID: `keyterm:Share`); Law (ID: `keyterm:Law`); Ability (ID: `keyterm:Ability`); Body (ID: `keyterm:Body.3`); Spirit (ID: `keyterm:Spirit.2`); Believe (ID: `keyterm:Believe`); Yesu (ID: `person:Jesus.2`); Always (ID: `keyterm:Always`); Life (ID: `keyterm:Life`); Put to the Test (ID: `keyterm:PutToTheTest`); BWANA (ID: `deity:Lord`); Roho (ID: `deity:HolySpirit`); Interpret (ID: `keyterm:Interpret`)
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Body (ID: `keyterm:Body.3`); Cross (ID: `realia:Cross`); Law (ID: `keyterm:Law`); Ability (ID: `keyterm:Ability`); Make Peace (ID: `keyterm:Peace`); Israeli (ID: `person:Israel`); Favor (ID: `keyterm:Favor`); Spirit (ID: `keyterm:Spirit.2`); Surely! (ID: `keyterm:Surely`); Circumcision (ID: `keyterm:Circumcision`); BWANA (ID: `deity:Lord`); Mark (ID: `keyterm:Mark`); Mercy (ID: `keyterm:Mercy`)
