...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Height (ID: `keyterm:Height`); An Angel (ID: `deity:Angel`); Name (ID: `keyterm:Name`); Glory (ID: `keyterm:Glory`); Always (ID: `keyterm:Always`); Word (ID: `keyterm:Word`); To Sin (ID: `keyterm:Sin`); BWANA (ID: `deity:Lord`); To Cleanse (ID: `keyterm:Cleanse.2`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Spirit (ID: `keyterm:Spirit.2`); Cloak (ID: `realia:Cloak`); Clothing (ID: `realia:Clothing`); Anointed (ID: `keyterm:Anointed`); Priesthood (ID: `keyterm:Priesthood`); Salvation (ID: `keyterm:Salvation`); Bow Down (ID: `keyterm:BowDown`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Love (ID: `keyterm:Love`); Lawless (ID: `keyterm:Lawless`); Serve (ID: `keyterm:Serve`); Always (ID: `keyterm:Always`); Kingdom (ID: `keyterm:Kingdom`); Minister (ID: `keyterm:Servant`); Staff (ID: `realia:Staff`); Olive Oil (ID: `realia:OliveOil`); Rod (ID: `realia:Rod`); Footstool (ID: `realia:Footstool`); Throne (ID: `realia:Throne`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); BWANA (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Declare (ID: `keyterm:Declare`); Portent (ID: `keyterm:Portent`); Yesu (ID: `person:Jesus.2`); Salvation (ID: `keyterm:Salvation`); Symbol (ID: `keyterm:Example`); Roho (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** Heart (ID: `keyterm:Heart`); Musa (ID: `person:Moses`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Yesu (ID: `person:Jesus.2`); Disbelieve (ID: `keyterm:Disbelieve`); To Sin (ID: `keyterm:Sin`); BWANA (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); Glory (ID: `keyterm:Glory`); Bear Witness (ID: `keyterm:BearWitness`); Confidence (ID: `keyterm:Confidence`); The Way (ID: `keyterm:TheWay`); Hope (ID: `keyterm:Hope`); Ask for (ID: `keyterm:AskFor`); Life (ID: `keyterm:Life`); Misri (ID: `place:Egypt`); Roho (ID: `deity:HolySpirit`); Holy (ID: `keyterm:Holy`); Encourage (ID: `keyterm:Encourage`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Good News (ID: `keyterm:GoodNews`); Heart (ID: `keyterm:Heart`); Believe (ID: `keyterm:Believe`); Sabbath (ID: `keyterm:Sabbath`); Daudi (ID: `person:David`); Able to Discern (ID: `keyterm:AbleToDiscern`); Spirit (ID: `keyterm:Spirit.2`); Life (ID: `keyterm:Life`); Yoshua (ID: `person:Joshua.2`); Promise (ID: `keyterm:Promise`); Fear (ID: `keyterm:Fear`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); BWANA (ID: `deity:Lord`); Yesu (ID: `person:Jesus.2`); Salvation (ID: `keyterm:Salvation`); Always (ID: `keyterm:Always`); Offering (ID: `keyterm:Offering`); Melkizedeki (ID: `person:Melchizedek`); Mercy (ID: `keyterm:Mercy`); Glory (ID: `keyterm:Glory`); Favor (ID: `keyterm:Favor`); Obligated (ID: `keyterm:Ought`); Body (ID: `keyterm:Body.3`); Put to the Test (ID: `keyterm:PutToTheTest`); Deal Gently (ID: `keyterm:DealGently`); Haruni (ID: `person:Aaron`); Pray (ID: `keyterm:Pray`); Sky (ID: `keyterm:Heaven`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Repent (ID: `keyterm:Repent`); Always (ID: `keyterm:Always`); Discern (ID: `keyterm:Discern`); Eagerness (ID: `keyterm:Eagerness`); Fundamental Principles (ID: `keyterm:FundamentalPrinciples`); Salvation (ID: `keyterm:Salvation`); Word (ID: `keyterm:Word`); Baptism (ID: `keyterm:Baptism`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); Bless (ID: `keyterm:Bless`); Obligated (ID: `keyterm:Ought`); Hope (ID: `keyterm:Hope`); Promise (ID: `keyterm:Promise`); Heart (ID: `keyterm:Heart`); Judgment (ID: `keyterm:Judgment`); Persuade (ID: `keyterm:Persuade`); Partake (ID: `keyterm:Partake`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Roho (ID: `deity:HolySpirit`); Heavenly (ID: `keyterm:Heavenly`); Yesu (ID: `person:Jesus.2`); Serve (ID: `keyterm:Serve`); Holy (ID: `keyterm:Holy`); Complete (ID: `keyterm:Complete`); Resurrection (ID: `keyterm:Resurrection`); Name (ID: `keyterm:Name`); Beloved (ID: `keyterm:Beloved`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Promise (ID: `keyterm:Promise`); BWANA (ID: `deity:Lord`); Oath (ID: `keyterm:Oath`); Hope (ID: `keyterm:Hope`); Yesu (ID: `person:Jesus.2`); Ask for (ID: `keyterm:AskFor`); Bless (ID: `keyterm:Bless`); Always (ID: `keyterm:Always`); Melkizedeki (ID: `person:Melchizedek`); Something Definite (ID: `keyterm:SomethingDefinite`); Abrahamu (ID: `person:Abraham`); Anchor (ID: `realia:Anchor`); Curtain (ID: `realia:Curtain`)
...
* **Associated ACAI Concepts:** Abrahamu (ID: `person:Abraham`); Melkizedeki (ID: `person:Melchizedek`); Law (ID: `keyterm:Law`); Priesthood (ID: `keyterm:Priesthood`); BWANA (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Always (ID: `keyterm:Always`); Commandment (ID: `keyterm:Commandment`); Oath (ID: `keyterm:Oath`); Walawi (ID: `group:Levi`); Bless (ID: `keyterm:Bless`); Walawi (ID: `person:Levi.3`); Yerusalemu (ID: `place:Jerusalem`); Bear Witness (ID: `keyterm:BearWitness`); Yesu (ID: `person:Jesus.2`); Salvation (ID: `keyterm:Salvation`); To Sin (ID: `keyterm:Sin`); Haruni (ID: `person:Aaron`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Hope (ID: `keyterm:Hope`); Promise (ID: `keyterm:Promise`); Musa (ID: `person:Moses`); Repent (ID: `keyterm:Repent`); Yuda (ID: `group:Judah`); Enact Laws (ID: `keyterm:EnactLaws`); Yuda (ID: `person:Judah.4`); Partake (ID: `keyterm:Partake`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Covenant (ID: `keyterm:Covenant`); Make Peace (ID: `keyterm:Peace`); Carnal (ID: `keyterm:Carnal`); Undefiled (ID: `keyterm:Undefiled`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Priesthood (ID: `keyterm:Priesthood`); Law (ID: `keyterm:Law`); Offering (ID: `keyterm:Offering`); Israeli (ID: `person:Israel`); Tabernacle (ID: `realia:Tabernacle`); Mind (ID: `keyterm:Mind.2`); Minister (ID: `keyterm:Servant`); To Sin (ID: `keyterm:Sin`); Sky (ID: `keyterm:Heaven`); Heart (ID: `keyterm:Heart`); Promise (ID: `keyterm:Promise`); Unjust Deed (ID: `keyterm:UnjustDeed`); Musa (ID: `person:Moses`); Mercy (ID: `keyterm:Mercy`); True (ID: `keyterm:True`); Misri (ID: `place:Egypt`); Yuda (ID: `group:Judah`); Enact Laws (ID: `keyterm:EnactLaws`); Yuda (ID: `person:Judah.4`); Heavenly (ID: `keyterm:Heavenly`); patakatifu (ID: `place:HolyPlace`); Serve (ID: `keyterm:Serve`); Holy (ID: `keyterm:Holy`); Be Blameless (ID: `keyterm:Blameless`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Blood (ID: `keyterm:Blood`); Holy (ID: `keyterm:Holy`); patakatifu (ID: `place:HolyPlace`); Offering (ID: `keyterm:Offering`); Priesthood (ID: `keyterm:Priesthood`); Covenant (ID: `keyterm:Covenant`); Tabernacle (ID: `realia:Tabernacle`); The Holy Place (ID: `realia:TheHolyPlace`); Most Holy Place (ID: `realia:MostHolyPlace`); To Cleanse (ID: `keyterm:Cleanse.2`); Yesu (ID: `person:Jesus.2`); Serve (ID: `keyterm:Serve`); Always (ID: `keyterm:Always`); BWANA (ID: `deity:Lord`); Liberation (ID: `keyterm:Liberation`); Regulations (ID: `keyterm:Regulations`); Cattle (ID: `fauna:Bull`); To Sin (ID: `keyterm:Sin`); Sky (ID: `keyterm:Heaven`); Body (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); Law (ID: `keyterm:Law`); Conscience (ID: `keyterm:Conscience`); Roho (ID: `deity:HolySpirit`); Goat (ID: `fauna:Goat`); Haruni (ID: `person:Aaron`); Defilement (ID: `keyterm:Defilement`); Flock (ID: `fauna:Flock`); Mercy Seat (ID: `keyterm:Propitiation`); Commandment (ID: `keyterm:Commandment`); Salvation (ID: `keyterm:Salvation`); To Command (ID: `keyterm:Command`); Glory (ID: `keyterm:Glory`); Baptism (ID: `keyterm:Baptism`); Forgive (ID: `keyterm:Forgive`); Ability (ID: `keyterm:Ability`); Consecration (ID: `keyterm:Consecration.2`); Promise (ID: `keyterm:Promise`); Musa (ID: `person:Moses`); Good (ID: `keyterm:Good`); Judgment (ID: `keyterm:Judgment`); patakatifu (ID: `place:MostHolyPlace`); True (ID: `keyterm:True`); Parable (ID: `keyterm:Parable`); Court Case (ID: `keyterm:CourtCase`); Heavenly (ID: `keyterm:Heavenly`); Shedding of Blood (ID: `keyterm:SheddingOfBlood`); Unblemished (ID: `keyterm:Unblemished`); Winged Creature (ID: `realia:WingedCreature`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Staff (ID: `realia:Staff`); Hyssop (ID: `flora:Hyssop`); Curtain (ID: `realia:Curtain`); Altar (ID: `realia:Altar`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Life (ID: `keyterm:Life`); Fear (ID: `keyterm:Fear`); Extremely (ID: `keyterm:Extremely`); To Sin (ID: `keyterm:Sin`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Consecration (ID: `keyterm:Consecration.2`); Truth (ID: `keyterm:Truth`); Promise (ID: `keyterm:Promise`); Eternal Fire (ID: `keyterm:EternalFire`); Musa (ID: `person:Moses`); Judgment (ID: `keyterm:Judgment`); Witness (ID: `keyterm:Witness`); Mercy (ID: `keyterm:Mercy`); Avenge (ID: `keyterm:GrantJustice`); Decided (ID: `keyterm:Decided`); Law (ID: `keyterm:Law`); Defilement (ID: `keyterm:Defilement`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Court Case (ID: `keyterm:CourtCase`); Roho (ID: `deity:HolySpirit`); Have Sympathy For (ID: `keyterm:HaveSympathyFor`); Covenant (ID: `keyterm:Covenant`); Favor (ID: `keyterm:Favor`); Offering (ID: `keyterm:Offering`); Blood (ID: `keyterm:Blood`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); BWANA (ID: `deity:Lord`); Isaka (ID: `person:Isaac`); Promise (ID: `keyterm:Promise`); Israeli (ID: `person:Israel`); Bear Witness (ID: `keyterm:BearWitness`); Ability (ID: `keyterm:Ability`); Yusufu (ID: `person:Joseph.10`); Offering (ID: `keyterm:Offering`); Abrahamu (ID: `person:Abraham`); Bless (ID: `keyterm:Bless`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Kaini (ID: `person:Cain`); Henoko (ID: `person:Enoch.2`); Habili (ID: `person:Abel`); Heavenly (ID: `keyterm:Heavenly`); Nuhu (ID: `person:Noah`); Salvation (ID: `keyterm:Salvation`); To Command (ID: `keyterm:Command`); Bow Down (ID: `keyterm:BowDown`); Word (ID: `keyterm:Word`); Confidence (ID: `keyterm:Confidence`); Sky (ID: `keyterm:Heaven`); Sara (ID: `person:Sarah`); Condemn (ID: `keyterm:Condemn`); Hope (ID: `keyterm:Hope`); Parable (ID: `keyterm:Parable`); Esau (ID: `person:Esau`); Faithfulness (ID: `keyterm:Faithfulness`); Israelites (ID: `group:Israel`); Resurrection (ID: `keyterm:Resurrection`); Always (ID: `keyterm:Always`); Boat (ID: `realia:Boat`); Staff (ID: `realia:Staff`); Tent (ID: `realia:Tent`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Misri (ID: `place:Egypt`); Fear (ID: `keyterm:Fear`); Ability (ID: `keyterm:Ability`); BWANA (ID: `deity:Lord`); Promise (ID: `keyterm:Promise`); Musa (ID: `person:Moses`); Gideoni (ID: `person:Gideon`); Farao (ID: `person:Pharaoh.5`); Samsoni (ID: `person:Samson`); Rahabu (ID: `person:Rahab`); Baraka (ID: `person:Barak`); Yeftha (ID: `person:Jephthah`); Samweli (ID: `person:Samuel`); Passover (ID: `keyterm:Passover`); Yeriko (ID: `place:Jericho`); Bear Witness (ID: `keyterm:BearWitness`); To Sin (ID: `keyterm:Sin`); Liberation (ID: `keyterm:Liberation`); Shamu (ID: `place:RedSea`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Yesu (ID: `person:Jesus.2`); Daudi (ID: `person:David`); Make Peace (ID: `keyterm:Peace`); Resurrection (ID: `keyterm:Resurrection`); Egyptians (ID: `group:Egypt`); Kingdom (ID: `keyterm:Kingdom`); Blood (ID: `keyterm:Blood`); Skin (ID: `realia:Skin`); Chain (ID: `realia:Chain`); Lion (ID: `fauna:Lion`); Goat (ID: `fauna:Goat`); Prison (ID: `realia:Prison`); City Wall (ID: `realia:CityWall`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Make Peace (ID: `keyterm:Peace`); To Sin (ID: `keyterm:Sin`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Esau (ID: `person:Esau`); Profane (ID: `keyterm:Profane`); Reject (ID: `keyterm:Reject`); Believe (ID: `keyterm:Believe`); Consecration (ID: `keyterm:Consecration.2`); Love (ID: `keyterm:Love`); Bless (ID: `keyterm:Bless`); Body (ID: `keyterm:Body.3`); Repent (ID: `keyterm:Repent`); Ask for (ID: `keyterm:AskFor`); Life (ID: `keyterm:Life`); Witness (ID: `keyterm:Witness`); Defilement (ID: `keyterm:Defilement`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Yesu (ID: `person:Jesus.2`); Holy (ID: `keyterm:Holy`); Spirit (ID: `keyterm:Spirit.2`); Favor (ID: `keyterm:Favor`); Blood (ID: `keyterm:Blood`); Throne (ID: `realia:Throne`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Priesthood (ID: `keyterm:Priesthood`); Word (ID: `keyterm:Word`); Register (ID: `keyterm:Register`); Promise (ID: `keyterm:Promise`); Musa (ID: `person:Moses`); Yerusalemu (ID: `place:Jerusalem`); Life (ID: `keyterm:Life`); Habili (ID: `person:Abel`); Church (ID: `keyterm:Church`); Fear (ID: `keyterm:Fear`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Heavenly (ID: `keyterm:Heavenly`); Covenant (ID: `keyterm:Covenant`); Yesu (ID: `person:Jesus.2`); Serve (ID: `keyterm:Serve`); An Angel (ID: `deity:Angel`); Spirit (ID: `keyterm:Spirit.2`); Favor (ID: `keyterm:Favor`); Kingdom (ID: `keyterm:Kingdom`); Blood (ID: `keyterm:Blood`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Always (ID: `keyterm:Always`); Italia (ID: `place:Italy`); Holy (ID: `keyterm:Holy`); Make Peace (ID: `keyterm:Peace`); Surely! (ID: `keyterm:Surely`); Ask for (ID: `keyterm:AskFor`); Glory (ID: `keyterm:Glory`); Favor (ID: `keyterm:Favor`); Timotheo (ID: `person:Timothy`); BWANA (ID: `deity:Lord`); Good (ID: `keyterm:Good`); Blood (ID: `keyterm:Blood`); Covenant (ID: `keyterm:Covenant`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`)
