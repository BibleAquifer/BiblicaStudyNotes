...
* **Associated ACAI Concepts:** Anointed (ID: `keyterm:Anointed`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Portent (ID: `keyterm:Portent`); Declare (ID: `keyterm:Declare`)
...
* **Associated ACAI Concepts:** Enslavement (ID: `keyterm:Slavery`); Partake (ID: `keyterm:Partake`); Obligated (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** Fundamental Principles (ID: `keyterm:FundamentalPrinciples`); Eagerness (ID: `keyterm:Eagerness`); Discern (ID: `keyterm:Discern`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Promise (ID: `keyterm:Promise`); Oath (ID: `keyterm:Oath`); Anchor (ID: `realia:Anchor`); Hope (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Melkizedeki (ID: `person:Melchizedek`); Priesthood (ID: `keyterm:Priesthood`); Yerusalemu (ID: `place:Jerusalem`); Law (ID: `keyterm:Law`); Abrahamu (ID: `person:Abraham`)
...
* **Associated ACAI Concepts:** Minister (ID: `keyterm:Servant`); Mind (ID: `keyterm:Mind.2`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** The Holy Place (ID: `realia:TheHolyPlace`); Most Holy Place (ID: `realia:MostHolyPlace`); Tabernacle (ID: `realia:Tabernacle`); Blood (ID: `keyterm:Blood`); Holy (ID: `keyterm:Holy`); Regulations (ID: `keyterm:Regulations`); Liberation (ID: `keyterm:Liberation`); Goat (ID: `fauna:Goat`); Winged Creature (ID: `realia:WingedCreature`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Defilement (ID: `keyterm:Defilement`); Haruni (ID: `person:Aaron`); patakatifu (ID: `place:HolyPlace`); Priesthood (ID: `keyterm:Priesthood`); Covenant (ID: `keyterm:Covenant`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** Conscience (ID: `keyterm:Conscience`); Consecration (ID: `keyterm:Consecration.2`); Most Holy Place (ID: `realia:MostHolyPlace`); Curtain (ID: `realia:Curtain`); Faithfulness (ID: `keyterm:Faithfulness`); To Sin (ID: `keyterm:Sin`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** Extremely (ID: `keyterm:Extremely`)
...
* **Associated ACAI Concepts:** Isaka (ID: `person:Isaac`); Yusufu (ID: `person:Joseph.10`); Offering (ID: `keyterm:Offering`); Habili (ID: `person:Abel`); Henoko (ID: `person:Enoch.2`); Kaini (ID: `person:Cain`); Heavenly (ID: `keyterm:Heavenly`); Nuhu (ID: `person:Noah`); Believe (ID: `keyterm:Believe`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Skin (ID: `realia:Skin`); Fear (ID: `keyterm:Fear`); Rahabu (ID: `person:Rahab`); Farao (ID: `person:Pharaoh.5`); Baraka (ID: `person:Barak`); Yeftha (ID: `person:Jephthah`); Samsoni (ID: `person:Samson`); Gideoni (ID: `person:Gideon`); Samweli (ID: `person:Samuel`); Believe (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Make Peace (ID: `keyterm:Peace`); Profane (ID: `keyterm:Profane`); Esau (ID: `person:Esau`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Love for One's Fellow Believer (ID: `keyterm:LoveForOnesFellowBeliever`); Bring In (ID: `keyterm:BringIn`); Always (ID: `keyterm:Always`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Italia (ID: `place:Italy`)
