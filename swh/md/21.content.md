...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); House (ID: `realia:House`); Truth (ID: `keyterm:Truth`); Proverb (ID: `keyterm:Saying`); Straightness (ID: `keyterm:Straightness`); Intention (ID: `keyterm:Intention`); Caper (ID: `flora:Caper`); Goad (ID: `realia:Goad`); Locust (ID: `fauna:Locust`); Clay Jar (ID: `realia:ClayJar`); Money (ID: `realia:Money`); Scroll (ID: `realia:Scroll`); Nail (ID: `realia:Nail`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Bird (ID: `fauna:Bird`); Almond (ID: `flora:Almond`); Rope (ID: `realia:Rope`); Flock (ID: `fauna:Flock`); Pit (ID: `realia:Pit`)
