...
* **Associated Passages:** Mhubiri 1:1-11
...
* **Associated ACAI Concepts:** Yerusalemu (ID: `place:Jerusalem`); Daudi (ID: `person:David`)
...
* **Associated Passages:** Mhubiri 1:12-11:6
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Stupid (ID: `keyterm:Stupid`); To Sin (ID: `keyterm:Sin`); Intention (ID: `keyterm:Intention`); Love (ID: `keyterm:Love`); Fear (ID: `keyterm:Fear`); Yerusalemu (ID: `place:Jerusalem`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); Strength (ID: `keyterm:Strength`); Passion (ID: `keyterm:Ardour`); A Man (ID: `person:GenericMale`); Glory (ID: `keyterm:Glory`); Vow (ID: `keyterm:Vow`); Favor (ID: `keyterm:Favor`); Oath (ID: `keyterm:Oath`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Wine (ID: `realia:Wine`); Defilement (ID: `keyterm:Defilement`); Stupidity (ID: `keyterm:Stupidity`); Force to Serve (ID: `keyterm:EnticedToServe`); Pure (ID: `keyterm:Pure`); Safety (ID: `keyterm:Safety`); Hell (ID: `place:Hell`); Slaughtering (ID: `keyterm:Slaughtering`); Israeli (ID: `person:Israel`); To Act Wickedly (ID: `keyterm:ActWickedly`)
...
* **Associated Passages:** Mhubiri 11:7-12:14
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); House (ID: `realia:House`); Straightness (ID: `keyterm:Straightness`); Intention (ID: `keyterm:Intention`); Truth (ID: `keyterm:Truth`); Proverb (ID: `keyterm:Saying`); Goad (ID: `realia:Goad`); Caper (ID: `flora:Caper`); Goat (ID: `fauna:Goat`); Bird (ID: `fauna:Bird`); Rope (ID: `realia:Rope`); Nail (ID: `realia:Nail`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Pit (ID: `realia:Pit`); Locust (ID: `fauna:Locust`); Scroll (ID: `realia:Scroll`); Money (ID: `realia:Money`); Clay Jar (ID: `realia:ClayJar`); Almond (ID: `flora:Almond`)
