...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); House (ID: `realia:House`); Truth (ID: `keyterm:Truth`); Straightness (ID: `keyterm:Straightness`); Proverb (ID: `keyterm:Saying`); Intention (ID: `keyterm:Intention`); Caper (ID: `flora:Caper`); Goad (ID: `realia:Goad`); Sheep (ID: `fauna:Lamb`); Clay Jar (ID: `realia:ClayJar`); Locust (ID: `fauna:Locust`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Pit (ID: `realia:Pit`); Money (ID: `realia:Money`); Almond (ID: `flora:Almond`); Nail (ID: `realia:Nail`); Scroll (ID: `realia:Scroll`); Bird (ID: `fauna:Bird`); Rope (ID: `realia:Rope`)
