...
* **Associated ACAI Concepts:** Stupid (ID: `keyterm:Stupid`); Intention (ID: `keyterm:Intention`); Ability (ID: `keyterm:Ability`); To Sin (ID: `keyterm:Sin`); Love (ID: `keyterm:Love`); Fear (ID: `keyterm:Fear`); House (ID: `realia:House`); BWANA (ID: `deity:Lord`)
