...
* **Associated ACAI Concepts:** Put to the Test (ID: `keyterm:PutToTheTest`); Grass (ID: `flora:Grass`); Approved (ID: `keyterm:Approved`); Interpret (ID: `keyterm:Interpret`); Happy (ID: `keyterm:Happy`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Useless (ID: `keyterm:Idle`); Rahabu (ID: `person:Rahab`); Believe (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Decided (ID: `keyterm:Decided`); Honest (ID: `keyterm:Honest`); Friendship (ID: `keyterm:Friendship`); Be Unfaithful (ID: `keyterm:Unfaithful`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Compassionate (ID: `keyterm:Compassionate`); Ayubu (ID: `person:Job`); BWANA (ID: `deity:Lord`)
