...
* **Associated Passages:** Yakobo 1:1-18
* **Associated Articles:** Mwamini (ID: `367568@BiblicaStudyNotesKeyTerms`); Yakobo (ID: `367610@BiblicaStudyNotes`); Mungu (ID: `367690@BiblicaStudyNotesKeyTerms`); Imani (ID: `367723@BiblicaStudyNotesKeyTerms`); Makabila 12 (ID: `367777@BiblicaStudyNotesKeyTerms`); Hekima (ID: `367816@BiblicaStudyNotesKeyTerms`); Myahudi (ID: `367994@BiblicaStudyNotesKeyTerms`); Uumbaji mpya (ID: `368034@BiblicaStudyNotesKeyTerms`); Uzima wa milele (ID: `368060@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Put to the Test (ID: `keyterm:PutToTheTest`); Believe (ID: `keyterm:Believe`); Grass (ID: `flora:Grass`); Wild Flower (ID: `flora:WildFlower`); Approved (ID: `keyterm:Approved`); Interpret (ID: `keyterm:Interpret`); Happy (ID: `keyterm:Happy`); To Sin (ID: `keyterm:Sin`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Discern (ID: `keyterm:Discern`); A Person (ID: `person:GenericPerson`); Love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); Yakobo (ID: `person:James.3`); Promise (ID: `keyterm:Promise`); Good (ID: `keyterm:Good`); Life (ID: `keyterm:Life`); Yesu (ID: `person:Jesus.2`); Not Tempted (ID: `keyterm:NotTempted`); Beloved (ID: `keyterm:Beloved`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated Passages:** Yakobo 1:19-27
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Clean (ID: `keyterm:Clean`); Worthless (ID: `keyterm:Worthless`); Happy (ID: `keyterm:Happy`); Salvation (ID: `keyterm:Salvation`); Law (ID: `keyterm:Law`); Beloved (ID: `keyterm:Beloved`); Undefiled (ID: `keyterm:Undefiled`); Heart (ID: `keyterm:Heart`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Ability (ID: `keyterm:Ability`); Above Criticism (ID: `keyterm:AboveCriticism`); Mirror (ID: `realia:Mirror`)
...
* **Associated Passages:** Yakobo 2:1-13
...
* **Associated ACAI Concepts:** Law (ID: `keyterm:Law`); Partiality (ID: `keyterm:Partiality`); Court Case (ID: `keyterm:CourtCase`); Believe (ID: `keyterm:Believe`); Love (ID: `keyterm:Love`); Clothing (ID: `realia:Clothing`); Stumble (ID: `keyterm:Stumble`); Judgment (ID: `keyterm:Judgment`); Written (ID: `keyterm:Scripture`); Glory (ID: `keyterm:Glory`); To Sin (ID: `keyterm:Sin`); Discern (ID: `keyterm:Discern`); Ability (ID: `keyterm:Ability`); BWANA (ID: `deity:Lord`); Promise (ID: `keyterm:Promise`); Chosen (ID: `keyterm:Chosen`); Mercy (ID: `keyterm:Mercy`); Decided (ID: `keyterm:Decided`); Yesu (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); Merciless (ID: `keyterm:Merciless`); Kingdom (ID: `keyterm:Kingdom`); Beloved (ID: `keyterm:Beloved`); Fornication (ID: `keyterm:Fornication`); Blaspheme (ID: `keyterm:Blaspheme`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`)
...
* **Associated Passages:** Yakobo 2:14-26
* **Associated Articles:** Matendo mema (ID: `367551@BiblicaStudyNotesKeyTerms`); Ibrahimu (ID: `367734@BiblicaStudyNotesKeyTerms`); Haki na Mungu (ID: `367745@BiblicaStudyNotes`); Amini katika (ID: `367746@BiblicaStudyNotesKeyTerms`); Isaka (ID: `367752@BiblicaStudyNotesKeyTerms`); Kutoa sadaka  watoto (ID: `367755@BiblicaStudyNotesKeyTerms`); Israeli (ID: `367771@BiblicaStudyNotesKeyTerms`); Madhabahu (ID: `367776@BiblicaStudyNotesKeyTerms`); Rahabu (ID: `367912@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Body (ID: `keyterm:Body.3`); Abrahamu (ID: `person:Abraham`); BWANA (ID: `deity:Lord`); A Person (ID: `person:GenericPerson`); Useless (ID: `keyterm:Idle`); Rahabu (ID: `person:Rahab`); An Angel (ID: `deity:Angel`); Make Peace (ID: `keyterm:Peace`); Spirit (ID: `keyterm:Spirit.2`); Written (ID: `keyterm:Scripture`); Salvation (ID: `keyterm:Salvation`); Empty (ID: `keyterm:Empty`); Demons (ID: `deity:Demons`); Isaka (ID: `person:Isaac`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated Passages:** Yakobo 3:1-12
* **Associated Articles:** Baba (ID: `367803@BiblicaStudyNotesKeyTerms`); Mpenda Mungu (ID: `367846@BiblicaStudyNotesKeyTerms`); Moyo (ID: `367910@BiblicaStudyNotes`)

* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Bless (ID: `keyterm:Bless`); Persuade (ID: `keyterm:Persuade`); Stumble (ID: `keyterm:Stumble`); Hell (ID: `place:Hell`); Ability (ID: `keyterm:Ability`); Heart (ID: `keyterm:Heart`); BWANA (ID: `deity:Lord`); Unjust Deed (ID: `keyterm:UnjustDeed`); Judgment (ID: `keyterm:Judgment`); Gehenna (ID: `keyterm:Gehenna`); Rudder (ID: `realia:Rudder`); Bit and Bridle (ID: `realia:BitAndBridle`); Bird (ID: `fauna:Bird`); Rooster (ID: `fauna:Rooster`); Creeping Animal (ID: `fauna:CreepingAnimal`); Ship (ID: `realia:Ship`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`); Fish (ID: `fauna:Fish`); Monitor (ID: `fauna:Iguana`); Horse (ID: `fauna:Horse`); Chameleon (ID: `fauna:Chameleon`); Lizard (ID: `fauna:Lizard`); Snake (ID: `fauna:Snake`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated Passages:** Yakobo 3:13-18
* **Associated Articles:** Mbingu (ID: `367692@BiblicaStudyNotes`); Amani (ID: `367702@BiblicaStudyNotesKeyTerms`); Ibilisi (ID: `367707@BiblicaStudyNotesKeyTerms`); Roho Mtakatifu (ID: `367879@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Resentment (ID: `keyterm:Resentment`); Make Peace (ID: `keyterm:Peace`); Natural (ID: `keyterm:Natural`); Unhypocritical (ID: `keyterm:Unhypocritical`); Behavior (ID: `keyterm:Behavior`); Gentle (ID: `keyterm:Gentle`); Truth (ID: `keyterm:Truth`); Mercy (ID: `keyterm:Mercy`); Demonic (ID: `keyterm:Demonic`); Heart (ID: `keyterm:Heart`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Good (ID: `keyterm:Good`); Pure (ID: `keyterm:Pure`)
...
* **Associated Passages:** Yakobo 4:1-17
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Decided (ID: `keyterm:Decided`); Life (ID: `keyterm:Life`); Friendship (ID: `keyterm:Friendship`); Honest (ID: `keyterm:Honest`); Be Unfaithful (ID: `keyterm:Unfaithful`); Long For (ID: `keyterm:LongFor`); Written (ID: `keyterm:Scripture`); Salvation (ID: `keyterm:Salvation`); To Sin (ID: `keyterm:Sin`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ability (ID: `keyterm:Ability`); Heart (ID: `keyterm:Heart`); Pure (ID: `keyterm:Pure`); Law (ID: `keyterm:Law`); Lawgiver (ID: `keyterm:Lawgiver`); Roho (ID: `deity:HolySpirit`); To Cleanse (ID: `keyterm:Cleanse.2`); Spirit (ID: `keyterm:Spirit.2`); Favor (ID: `keyterm:Favor`)
...
* **Associated Passages:** Yakobo 5:1-11
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Heart (ID: `keyterm:Heart`); Compassionate (ID: `keyterm:Compassionate`); Ayubu (ID: `person:Job`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Name (ID: `keyterm:Name`); Body (ID: `keyterm:Body.3`); Bear Witness (ID: `keyterm:BearWitness`); Full of Compassion (ID: `keyterm:FullOfCompassion`); Regard as Happy (ID: `keyterm:RegardAsHappy`); Decided (ID: `keyterm:Decided`); Condemn (ID: `keyterm:Condemn`); Door (ID: `realia:Door`); Clothing (ID: `realia:Clothing`)
...
* **Associated Passages:** Yakobo 5:12-20
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); To Sin (ID: `keyterm:Sin`); Salvation (ID: `keyterm:Salvation`); BWANA (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Believe (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Name (ID: `keyterm:Name`); Oath (ID: `keyterm:Oath`); Forgive (ID: `keyterm:Forgive`); Authority (ID: `keyterm:Authority.2`); Church (ID: `keyterm:Church`); Anointed (ID: `keyterm:Anointed`); Eliya (ID: `person:Elijah`); Olive Oil (ID: `realia:OliveOil`)
