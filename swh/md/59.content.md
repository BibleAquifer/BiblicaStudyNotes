...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Put to the Test (ID: `keyterm:PutToTheTest`); Believe (ID: `keyterm:Believe`); Grass (ID: `flora:Grass`); Wild Flower (ID: `flora:WildFlower`); Interpret (ID: `keyterm:Interpret`); Happy (ID: `keyterm:Happy`); Approved (ID: `keyterm:Approved`); Discern (ID: `keyterm:Discern`); Love (ID: `keyterm:Love`); Not Tempted (ID: `keyterm:NotTempted`); Yesu (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Beloved (ID: `keyterm:Beloved`); Yakobo (ID: `person:James.3`); Truth (ID: `keyterm:Truth`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Good (ID: `keyterm:Good`); To Sin (ID: `keyterm:Sin`); A Person (ID: `person:GenericPerson`); Promise (ID: `keyterm:Promise`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); BWANA (ID: `deity:Lord`); Abrahamu (ID: `person:Abraham`); A Person (ID: `person:GenericPerson`); Body (ID: `keyterm:Body.3`); Useless (ID: `keyterm:Idle`); Rahabu (ID: `person:Rahab`); Make Peace (ID: `keyterm:Peace`); Empty (ID: `keyterm:Empty`); To Cause to Happen (ID: `keyterm:Happen`); Isaka (ID: `person:Isaac`); Salvation (ID: `keyterm:Salvation`); Spirit (ID: `keyterm:Spirit.2`); Written (ID: `keyterm:Scripture`); An Angel (ID: `deity:Angel`); Demons (ID: `deity:Demons`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Decided (ID: `keyterm:Decided`); Life (ID: `keyterm:Life`); Honest (ID: `keyterm:Honest`); Friendship (ID: `keyterm:Friendship`); Be Unfaithful (ID: `keyterm:Unfaithful`); To Cleanse (ID: `keyterm:Cleanse.2`); Pure (ID: `keyterm:Pure`); Spirit (ID: `keyterm:Spirit.2`); Law (ID: `keyterm:Law`); Heart (ID: `keyterm:Heart`); Long For (ID: `keyterm:LongFor`); Salvation (ID: `keyterm:Salvation`); Roho (ID: `deity:HolySpirit`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Lawgiver (ID: `keyterm:Lawgiver`); Favor (ID: `keyterm:Favor`); To Sin (ID: `keyterm:Sin`); Written (ID: `keyterm:Scripture`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Heart (ID: `keyterm:Heart`); Ayubu (ID: `person:Job`); Compassionate (ID: `keyterm:Compassionate`); Condemn (ID: `keyterm:Condemn`); Full of Compassion (ID: `keyterm:FullOfCompassion`); Name (ID: `keyterm:Name`); Regard as Happy (ID: `keyterm:RegardAsHappy`); Bear Witness (ID: `keyterm:BearWitness`); Body (ID: `keyterm:Body.3`); Decided (ID: `keyterm:Decided`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Door (ID: `realia:Door`); Clothing (ID: `realia:Clothing`)
