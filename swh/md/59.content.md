...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Put to the Test (ID: `keyterm:PutToTheTest`); Believe (ID: `keyterm:Believe`); Grass (ID: `flora:Grass`); Wild Flower (ID: `flora:WildFlower`); Happy (ID: `keyterm:Happy`); Interpret (ID: `keyterm:Interpret`); Approved (ID: `keyterm:Approved`); A Person (ID: `person:GenericPerson`); Truth (ID: `keyterm:Truth`); Promise (ID: `keyterm:Promise`); Beloved (ID: `keyterm:Beloved`); Yakobo (ID: `person:James.3`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Discern (ID: `keyterm:Discern`); Life (ID: `keyterm:Life`); Good (ID: `keyterm:Good`); Yesu (ID: `person:Jesus.2`); Not Tempted (ID: `keyterm:NotTempted`); To Sin (ID: `keyterm:Sin`); Love (ID: `keyterm:Love`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Worthless (ID: `keyterm:Worthless`); Clean (ID: `keyterm:Clean`); Heart (ID: `keyterm:Heart`); Happy (ID: `keyterm:Happy`); Salvation (ID: `keyterm:Salvation`); Undefiled (ID: `keyterm:Undefiled`); Ability (ID: `keyterm:Ability`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Beloved (ID: `keyterm:Beloved`); Above Criticism (ID: `keyterm:AboveCriticism`); Law (ID: `keyterm:Law`); Mirror (ID: `realia:Mirror`)
...
* **Associated ACAI Concepts:** Law (ID: `keyterm:Law`); Partiality (ID: `keyterm:Partiality`); Court Case (ID: `keyterm:CourtCase`); Believe (ID: `keyterm:Believe`); Love (ID: `keyterm:Love`); Clothing (ID: `realia:Clothing`); Stumble (ID: `keyterm:Stumble`); Judgment (ID: `keyterm:Judgment`); Merciless (ID: `keyterm:Merciless`); Written (ID: `keyterm:Scripture`); Blaspheme (ID: `keyterm:Blaspheme`); Kingdom (ID: `keyterm:Kingdom`); Decided (ID: `keyterm:Decided`); Mercy (ID: `keyterm:Mercy`); Chosen (ID: `keyterm:Chosen`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Promise (ID: `keyterm:Promise`); Fornication (ID: `keyterm:Fornication`); BWANA (ID: `deity:Lord`); Beloved (ID: `keyterm:Beloved`); Discern (ID: `keyterm:Discern`); Yesu (ID: `person:Jesus.2`); To Sin (ID: `keyterm:Sin`); Glory (ID: `keyterm:Glory`); Seal (ID: `realia:Seal`); Synagogue (ID: `realia:Synagogue`); Footstool (ID: `realia:Footstool`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Abrahamu (ID: `person:Abraham`); A Person (ID: `person:GenericPerson`); BWANA (ID: `deity:Lord`); Body (ID: `keyterm:Body.3`); Useless (ID: `keyterm:Idle`); Rahabu (ID: `person:Rahab`); Written (ID: `keyterm:Scripture`); To Cause to Happen (ID: `keyterm:Happen`); Salvation (ID: `keyterm:Salvation`); Make Peace (ID: `keyterm:Peace`); Empty (ID: `keyterm:Empty`); Demons (ID: `deity:Demons`); An Angel (ID: `deity:Angel`); Isaka (ID: `person:Isaac`); Spirit (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** Resentment (ID: `keyterm:Resentment`); Make Peace (ID: `keyterm:Peace`); Gentle (ID: `keyterm:Gentle`); Behavior (ID: `keyterm:Behavior`); Unhypocritical (ID: `keyterm:Unhypocritical`); Natural (ID: `keyterm:Natural`); Heart (ID: `keyterm:Heart`); Pure (ID: `keyterm:Pure`); Truth (ID: `keyterm:Truth`); Good (ID: `keyterm:Good`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Demonic (ID: `keyterm:Demonic`); Mercy (ID: `keyterm:Mercy`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Decided (ID: `keyterm:Decided`); Life (ID: `keyterm:Life`); Friendship (ID: `keyterm:Friendship`); Be Unfaithful (ID: `keyterm:Unfaithful`); Honest (ID: `keyterm:Honest`); Heart (ID: `keyterm:Heart`); To Cleanse (ID: `keyterm:Cleanse.2`); Written (ID: `keyterm:Scripture`); Lawgiver (ID: `keyterm:Lawgiver`); Favor (ID: `keyterm:Favor`); Pure (ID: `keyterm:Pure`); Long For (ID: `keyterm:LongFor`); Ability (ID: `keyterm:Ability`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Law (ID: `keyterm:Law`); Salvation (ID: `keyterm:Salvation`); Roho (ID: `deity:HolySpirit`); To Sin (ID: `keyterm:Sin`); Spirit (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Heart (ID: `keyterm:Heart`); Compassionate (ID: `keyterm:Compassionate`); Ayubu (ID: `person:Job`); Name (ID: `keyterm:Name`); Bear Witness (ID: `keyterm:BearWitness`); Full of Compassion (ID: `keyterm:FullOfCompassion`); Decided (ID: `keyterm:Decided`); Condemn (ID: `keyterm:Condemn`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Regard as Happy (ID: `keyterm:RegardAsHappy`); Body (ID: `keyterm:Body.3`); Clothing (ID: `realia:Clothing`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); To Sin (ID: `keyterm:Sin`); Sky (ID: `keyterm:Heaven`); Salvation (ID: `keyterm:Salvation`); BWANA (ID: `deity:Lord`); Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); Authority (ID: `keyterm:Authority.2`); Believe (ID: `keyterm:Believe`); Eliya (ID: `person:Elijah`); Forgive (ID: `keyterm:Forgive`); Church (ID: `keyterm:Church`); Anointed (ID: `keyterm:Anointed`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Oath (ID: `keyterm:Oath`); Olive Oil (ID: `realia:OliveOil`)
