...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Elisha (ID: `person:Elisha`); Israeli (ID: `person:Israel`); Eliya (ID: `person:Elijah`); Gehazi (ID: `person:Gehazi`); Moabu (ID: `place:Moab`); Samaria (ID: `place:Samaria`); Syrians (ID: `group:Syria`); Naamani (ID: `person:Naaman.3`); An Angel (ID: `deity:Angel`); Yordani (ID: `place:Jordan`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Hazaeli (ID: `person:Hazael`); Yehoshafati (ID: `person:Jehoshaphat.3`); Yuda (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Offering (ID: `keyterm:Offering`); Edomu (ID: `place:Edom`); Peace (ID: `keyterm:IntactState`); Yuda (ID: `person:Judah.4`); House (ID: `realia:House`); Horse (ID: `fauna:Horse`); Chariot (ID: `realia:Chariot`); kwa (ID: `person:Baal-zebub`); Pure (ID: `keyterm:Pure`); Ekroni (ID: `place:Ekron`); Yeriko (ID: `place:Jericho`); Bed (ID: `realia:Bed`); Money (ID: `realia:Money`); Donkey (ID: `fauna:Donkey`)
...
* **Associated ACAI Concepts:** Yehu (ID: `person:Jehu.2`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`); Ahabu (ID: `person:Ahab`); Yezreeli (ID: `place:Jezreel.2`); Yoramu (ID: `person:Joram.3`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Ahazia (ID: `person:Ahaziah.2`); Baali (ID: `deity:Baal`); Peace (ID: `keyterm:IntactState`); Yehoramu (ID: `person:Jehoram`); Yezebeli (ID: `person:Jezebel`); Ramoth-gileadi (ID: `place:Ramoth-gilead`); Force to Serve (ID: `keyterm:EnticedToServe`); Samaria (ID: `place:Samaria`); Hazaeli (ID: `person:Hazael`); Chariot (ID: `realia:Chariot`); House (ID: `realia:House`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Nimshi (ID: `person:Nimshi`); Nabothi (ID: `person:Naboth`); Eliya (ID: `person:Elijah`); Syrians (ID: `group:Syria`); Daudi (ID: `person:David`); Edomu (ID: `place:Edom`); Yeroboamu (ID: `person:Jeroboam`); Yerusalemu (ID: `place:Jerusalem`); Smear (ID: `keyterm:Smear`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Fear (ID: `keyterm:Fear`); Assyria (ID: `place:Assyria`); Samaria (ID: `place:Samaria`); Force to Serve (ID: `keyterm:EnticedToServe`); Hoshea (ID: `person:Hoshea`); Stone Pine (ID: `flora:Pine`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); High Place (ID: `realia:HighPlace`); Misri (ID: `place:Egypt`); Covenant (ID: `keyterm:Covenant`); Instruction (ID: `keyterm:Instruction`); To Sin (ID: `keyterm:Sin`); Babeli (ID: `place:Babylon`); Kutha (ID: `place:Cuthah`); Sefarvaimu (ID: `place:Sepharvaim`); House (ID: `realia:House`); Offering (ID: `keyterm:Offering`); Yeroboamu (ID: `person:Jeroboam`); Iva (ID: `place:Ivvah`); Hamathi (ID: `place:Hamath`); Ashera (ID: `deity:Asherah`); Dispossess (ID: `keyterm:Dispossess`); Decree (ID: `keyterm:Decree`); So (ID: `person:So`); Habori (ID: `place:Habor`); Medes (ID: `group:Mede`); Adrameleki (ID: `person:Adrammelech`); Shalmanesa (ID: `person:Shalmaneser`); Sukoth-benothi (ID: `deity:Succoth-benoth`); Hala (ID: `place:Halah`); Gozani (ID: `place:Gozan`); Nergali (ID: `deity:Nergal`); Avvites (ID: `group:Avva`); Tartaki (ID: `deity:Tartak`); Ashima (ID: `deity:Ashima`); Anameleki (ID: `person:Anammelech`); Nibhazi (ID: `deity:Nibhaz`); Ela (ID: `person:Elah.3`); Sacred Pole (ID: `realia:SacredPole`); Lion (ID: `fauna:Lion`); Nebati (ID: `person:Nebat`); Samaritans (ID: `group:Samaritan`); Strength (ID: `keyterm:Strength`); Testimony (ID: `keyterm:Witness.2`); Believe In (ID: `keyterm:BelieveIn`); Baali (ID: `deity:Baal`); Ahazi (ID: `person:Ahaz`); Wamedi (ID: `person:Medan`); Daudi (ID: `person:David`); An Angel (ID: `deity:Angel`); Fee for Divination (ID: `keyterm:FeeForDivination`); Farao (ID: `person:Pharaoh.6`); Betheli (ID: `place:Bethel`); Practice Divination (ID: `keyterm:PracticeDivination`); Israelites (ID: `group:Israel`); Cattle (ID: `fauna:Bull`); Prison (ID: `realia:Prison`); Image (ID: `realia:Image`); Sacred Pillar (ID: `realia:SacredPillar`); Molten Image (ID: `realia:MoltenImage`); Graven Image (ID: `realia:GravenImage`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Hezekia (ID: `person:Hezekiah`); Assyria (ID: `place:Assyria`); Isaya (ID: `person:Isaiah`); Yuda (ID: `group:Judah`); Israeli (ID: `person:Israel`); Yuda (ID: `person:Judah.4`); kamanda (ID: `person:Rabshakeh`); Trust (ID: `keyterm:LeanOn`); Yerusalemu (ID: `place:Jerusalem`); House (ID: `realia:House`); Senakeribu (ID: `person:Sennacherib`); Eliakimu (ID: `person:Eliakim.3`); Shebna (ID: `person:Shebna`); Babeli (ID: `place:Babylon`); Daudi (ID: `person:David`); An Angel (ID: `deity:Angel`); Yoa (ID: `person:Joah`); Hilkia (ID: `person:Hilkiah`); Amozi (ID: `person:Amoz`); Misri (ID: `place:Egypt`); Musa (ID: `person:Moses`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Lakishi (ID: `place:Lachish`); Samaria (ID: `place:Samaria`); Hoshea (ID: `person:Hoshea`); Asafu (ID: `person:Asaph`); Hena (ID: `place:Hena`); Iva (ID: `place:Ivvah`); Arpadi (ID: `place:Arpad`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Israeli (ID: `person:Israel`); Manase (ID: `person:Manasseh.2`); Shafani (ID: `person:Shaphan`); House (ID: `realia:House`); Yosia (ID: `person:Josiah`); Hilkia (ID: `person:Hilkiah.2`); Ashera (ID: `deity:Asherah`); Amoni (ID: `person:Amon.3`); Instruction (ID: `keyterm:Instruction`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Scroll (ID: `realia:Scroll`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Betheli (ID: `place:Bethel`); Defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); Kidroni (ID: `place:Kidron`); Samaria (ID: `place:Samaria`); Baali (ID: `deity:Baal`); Covenant (ID: `keyterm:Covenant`); Passover (ID: `keyterm:Passover`); Sacred Pole (ID: `realia:SacredPole`); Ahikamu (ID: `person:Ahikam`)
...
* **Associated ACAI Concepts:** Babeli (ID: `place:Babylon`); Yerusalemu (ID: `place:Jerusalem`); BWANA (ID: `deity:Lord`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Chaldeans (ID: `group:Chaldea`); Wakaldayo (ID: `place:Chaldea`); Yehoyakimu (ID: `person:Jehoiakim`); Nebukadneza (ID: `person:Nebuchadnezzar`); Sedekia (ID: `person:Zedekiah.3`); Yekonia (ID: `person:Jehoiachin`); Ribla (ID: `place:Riblah.2`); House (ID: `realia:House`); Neko (ID: `person:Neco`); Yosia (ID: `person:Josiah`); Gedalia (ID: `person:Gedaliah.2`); Misri (ID: `place:Egypt`); Yehoahazi (ID: `person:Jehoahaz.3`); Nebuzaradani (ID: `person:Nebuzaradan`); Hamutali (ID: `person:Hamutal`); Yeremia (ID: `person:Jeremiah`); Ishmaeli (ID: `person:Ishmael.2`); Nethania (ID: `person:Nethaniah`); Under Siege (ID: `keyterm:StateOfBeingUnderSiege`); Hamathi (ID: `place:Hamath`); Megido (ID: `place:Megiddo`); Israeli (ID: `person:Israel`); Sulemani (ID: `person:Solomon`); Mto (ID: `place:Euphrates`); Fear (ID: `keyterm:Fear`)
