...
* **Associated Articles:** Mungu (ID: `367690@BiblicaStudyNotesKeyTerms`); Mbingu (ID: `367692@BiblicaStudyNotesKeyTerms`); Kazi (ID: `367699@BiblicaStudyNotesKeyTerms`); Israeli (ID: `367771@BiblicaStudyNotesKeyTerms`); Miungu wa uongo (ID: `367775@BiblicaStudyNotesKeyTerms`); Yuda (ID: `367782@BiblicaStudyNotesKeyTerms`); Watu wa Mungu (ID: `367793@BiblicaStudyNotesKeyTerms`); Miujiza (ID: `367796@BiblicaStudyNotesKeyTerms`); Mfalme (ID: `367821@BiblicaStudyNotes`); Roho Mtakatifu (ID: `367879@BiblicaStudyNotesKeyTerms`); Moabu (ID: `367888@BiblicaStudyNotesKeyTerms`); Unabii (ID: `367890@BiblicaStudyNotes`); Edomu (ID: `367902@BiblicaStudyNotesKeyTerms`); Nabii (ID: `367907@BiblicaStudyNotesKeyTerms`); Viumbe wa kiroho (ID: `367914@BiblicaStudyNotesKeyTerms`); Aramu (ID: `367925@BiblicaStudyNotesKeyTerms`); Kiroho (ID: `367953@BiblicaStudyNotesKeyTerms`); Yeroboamu (ID: `367967@BiblicaStudyNotesKeyTerms`); Ufalme wa Kaskazini (ID: `367970@BiblicaStudyNotesKeyTerms`); Ufalme wa Kusini (ID: `367971@BiblicaStudyNotesKeyTerms`); Yehoshafati (ID: `367974@BiblicaStudyNotesKeyTerms`); Ahabu (ID: `367975@BiblicaStudyNotesKeyTerms`); Elia (ID: `367977@BiblicaStudyNotesKeyTerms`); Elisha (ID: `367978@BiblicaStudyNotesKeyTerms`); Naamani (ID: `367979@BiblicaStudyNotesKeyTerms`); Samaria (ID: `367980@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Elisha (ID: `person:Elisha`); Israeli (ID: `person:Israel`); Eliya (ID: `person:Elijah`); Gehazi (ID: `person:Gehazi`); Moabu (ID: `place:Moab`); Samaria (ID: `place:Samaria`); Syrians (ID: `group:Syria`); Naamani (ID: `person:Naaman.3`); An Angel (ID: `deity:Angel`); Yordani (ID: `place:Jordan`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Hazaeli (ID: `person:Hazael`); Yehoshafati (ID: `person:Jehoshaphat.3`); Yuda (ID: `group:Judah`); Offering (ID: `keyterm:Offering`); Yuda (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Edomu (ID: `place:Edom`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Horse (ID: `fauna:Horse`); Chariot (ID: `realia:Chariot`); kwa (ID: `person:Baal-zebub`); Yeriko (ID: `place:Jericho`); Pure (ID: `keyterm:Pure`); Ekroni (ID: `place:Ekron`); Bed (ID: `realia:Bed`); Money (ID: `realia:Money`); Barley (ID: `flora:Barley`)
...
* **Associated Articles:** Dhambi (ID: `367686@BiblicaStudyNotes`); Ndoa (ID: `367697@BiblicaStudyNotesKeyTerms`); Ukoo (ID: `367711@BiblicaStudyNotesKeyTerms`); Hukumu (ID: `367724@BiblicaStudyNotesKeyTerms`); Ndama wa chuma (ID: `367832@BiblicaStudyNotesKeyTerms`); Baali (ID: `367892@BiblicaStudyNotesKeyTerms`); Yezebeli (ID: `367976@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yehu (ID: `person:Jehu.2`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`); Ahabu (ID: `person:Ahab`); Yezreeli (ID: `place:Jezreel.2`); Yoramu (ID: `person:Joram.3`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Ahazia (ID: `person:Ahaziah.2`); Baali (ID: `deity:Baal`); Peace (ID: `keyterm:IntactState`); Yehoramu (ID: `person:Jehoram`); Yezebeli (ID: `person:Jezebel`); Ramoth-gileadi (ID: `place:Ramoth-gilead`); Force to Serve (ID: `keyterm:EnticedToServe`); Samaria (ID: `place:Samaria`); Hazaeli (ID: `person:Hazael`); Chariot (ID: `realia:Chariot`); House (ID: `realia:House`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Nimshi (ID: `person:Nimshi`); Nabothi (ID: `person:Naboth`); Yeroboamu (ID: `person:Jeroboam`); Yerusalemu (ID: `place:Jerusalem`); Daudi (ID: `person:David`); Smear (ID: `keyterm:Smear`); Syrians (ID: `group:Syria`); Edomu (ID: `place:Edom`); Eliya (ID: `person:Elijah`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Fear (ID: `keyterm:Fear`); Assyria (ID: `place:Assyria`); Samaria (ID: `place:Samaria`); Force to Serve (ID: `keyterm:EnticedToServe`); Hoshea (ID: `person:Hoshea`); Stone Pine (ID: `flora:Pine`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); High Place (ID: `realia:HighPlace`); Instruction (ID: `keyterm:Instruction`); To Sin (ID: `keyterm:Sin`); Misri (ID: `place:Egypt`); Covenant (ID: `keyterm:Covenant`); Kutha (ID: `place:Cuthah`); Babeli (ID: `place:Babylon`); Sefarvaimu (ID: `place:Sepharvaim`); House (ID: `realia:House`); Dispossess (ID: `keyterm:Dispossess`); Hamathi (ID: `place:Hamath`); Yeroboamu (ID: `person:Jeroboam`); Ashera (ID: `deity:Asherah`); Decree (ID: `keyterm:Decree`); Iva (ID: `place:Ivvah`); Offering (ID: `keyterm:Offering`); Habori (ID: `place:Habor`); Gozani (ID: `place:Gozan`); Nibhazi (ID: `deity:Nibhaz`); Nergali (ID: `deity:Nergal`); Shalmanesa (ID: `person:Shalmaneser`); Hala (ID: `place:Halah`); Anameleki (ID: `person:Anammelech`); Ela (ID: `person:Elah.3`); Tartaki (ID: `deity:Tartak`); Avvites (ID: `group:Avva`); So (ID: `person:So`); Ashima (ID: `deity:Ashima`); Medes (ID: `group:Mede`); Sukoth-benothi (ID: `deity:Succoth-benoth`); Adrameleki (ID: `person:Adrammelech`); Lion (ID: `fauna:Lion`); Sacred Pole (ID: `realia:SacredPole`); Strength (ID: `keyterm:Strength`); Ahazi (ID: `person:Ahaz`); Nebati (ID: `person:Nebat`); Betheli (ID: `place:Bethel`); Testimony (ID: `keyterm:Witness.2`); Believe In (ID: `keyterm:BelieveIn`); Wamedi (ID: `person:Medan`); Samaritans (ID: `group:Samaritan`); Practice Divination (ID: `keyterm:PracticeDivination`); Daudi (ID: `person:David`); An Angel (ID: `deity:Angel`); Farao (ID: `person:Pharaoh.6`); Israelites (ID: `group:Israel`); Baali (ID: `deity:Baal`); Fee for Divination (ID: `keyterm:FeeForDivination`); Molten Image (ID: `realia:MoltenImage`); Image (ID: `realia:Image`); Cattle (ID: `fauna:Bull`); Graven Image (ID: `realia:GravenImage`); Prison (ID: `realia:Prison`); Sacred Pillar (ID: `realia:SacredPillar`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Hezekia (ID: `person:Hezekiah`); Assyria (ID: `place:Assyria`); Isaya (ID: `person:Isaiah`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Israeli (ID: `person:Israel`); kamanda (ID: `person:Rabshakeh`); Trust (ID: `keyterm:LeanOn`); Yerusalemu (ID: `place:Jerusalem`); House (ID: `realia:House`); Eliakimu (ID: `person:Eliakim.3`); Senakeribu (ID: `person:Sennacherib`); Shebna (ID: `person:Shebna`); Babeli (ID: `place:Babylon`); Daudi (ID: `person:David`); An Angel (ID: `deity:Angel`); Hilkia (ID: `person:Hilkiah`); Yoa (ID: `person:Joah`); Amozi (ID: `person:Amoz`); Musa (ID: `person:Moses`); Samaria (ID: `place:Samaria`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Hoshea (ID: `person:Hoshea`); Lakishi (ID: `place:Lachish`); Misri (ID: `place:Egypt`); Asafu (ID: `person:Asaph`); Hena (ID: `place:Hena`); Iva (ID: `place:Ivvah`); Arpadi (ID: `place:Arpad`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Israeli (ID: `person:Israel`); Manase (ID: `person:Manasseh.2`); Shafani (ID: `person:Shaphan`); House (ID: `realia:House`); Yosia (ID: `person:Josiah`); Hilkia (ID: `person:Hilkiah.2`); Ashera (ID: `deity:Asherah`); Amoni (ID: `person:Amon.3`); Instruction (ID: `keyterm:Instruction`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Scroll (ID: `realia:Scroll`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Betheli (ID: `place:Bethel`); To Sin (ID: `keyterm:Sin`); Defilement (ID: `keyterm:Defilement`); Kidroni (ID: `place:Kidron`); Passover (ID: `keyterm:Passover`); Samaria (ID: `place:Samaria`); Covenant (ID: `keyterm:Covenant`); Baali (ID: `deity:Baal`); Sacred Pole (ID: `realia:SacredPole`); Ahikamu (ID: `person:Ahikam`)
...
* **Associated ACAI Concepts:** Babeli (ID: `place:Babylon`); Yerusalemu (ID: `place:Jerusalem`); BWANA (ID: `deity:Lord`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Chaldeans (ID: `group:Chaldea`); Wakaldayo (ID: `place:Chaldea`); Yehoyakimu (ID: `person:Jehoiakim`); Nebukadneza (ID: `person:Nebuchadnezzar`); Yekonia (ID: `person:Jehoiachin`); Sedekia (ID: `person:Zedekiah.3`); Ribla (ID: `place:Riblah.2`); House (ID: `realia:House`); Gedalia (ID: `person:Gedaliah.2`); Neko (ID: `person:Neco`); Yosia (ID: `person:Josiah`); Misri (ID: `place:Egypt`); Yehoahazi (ID: `person:Jehoahaz.3`); Nebuzaradani (ID: `person:Nebuzaradan`); Hamutali (ID: `person:Hamutal`); Yeremia (ID: `person:Jeremiah`); Nethania (ID: `person:Nethaniah`); Under Siege (ID: `keyterm:StateOfBeingUnderSiege`); Ishmaeli (ID: `person:Ishmael.2`); Sulemani (ID: `person:Solomon`); Manase (ID: `person:Manasseh.2`); Mispa (ID: `place:Mizpah`); Megido (ID: `place:Megiddo`); Fear (ID: `keyterm:Fear`); Israeli (ID: `person:Israel`)
