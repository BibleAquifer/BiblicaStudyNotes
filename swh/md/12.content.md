...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Elisha (ID: `person:Elisha`); Israeli (ID: `person:Israel`); Eliya (ID: `person:Elijah`); Gehazi (ID: `person:Gehazi`); Syrians (ID: `group:Syria`); Moabu (ID: `place:Moab`); Samaria (ID: `place:Samaria`); Naamani (ID: `person:Naaman.3`); An Angel (ID: `deity:Angel`); Yordani (ID: `place:Jordan`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Hazaeli (ID: `person:Hazael`); Yehoshafati (ID: `person:Jehoshaphat.3`); Yuda (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); Edomu (ID: `place:Edom`); Peace (ID: `keyterm:IntactState`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Yuda (ID: `group:Judah`); House (ID: `realia:House`); Horse (ID: `fauna:Horse`); Chariot (ID: `realia:Chariot`); kwa (ID: `person:Baal-zebub`); Pure (ID: `keyterm:Pure`); Yeriko (ID: `place:Jericho`); Ekroni (ID: `place:Ekron`); Bed (ID: `realia:Bed`); Money (ID: `realia:Money`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Yehu (ID: `person:Jehu.2`); Israeli (ID: `person:Israel`); Ahabu (ID: `person:Ahab`); BWANA (ID: `deity:Lord`); Yezreeli (ID: `place:Jezreel.2`); Yoramu (ID: `person:Joram.3`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Ahazia (ID: `person:Ahaziah.2`); Baali (ID: `deity:Baal`); Peace (ID: `keyterm:IntactState`); Yehoramu (ID: `person:Jehoram`); Yezebeli (ID: `person:Jezebel`); Ramoth-gileadi (ID: `place:Ramoth-gilead`); Hazaeli (ID: `person:Hazael`); Samaria (ID: `place:Samaria`); Force to Serve (ID: `keyterm:EnticedToServe`); Chariot (ID: `realia:Chariot`); House (ID: `realia:House`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Nimshi (ID: `person:Nimshi`); Nabothi (ID: `person:Naboth`); Yeroboamu (ID: `person:Jeroboam`); Edomu (ID: `place:Edom`); Eliya (ID: `person:Elijah`); Syrians (ID: `group:Syria`); Daudi (ID: `person:David`); Yerusalemu (ID: `place:Jerusalem`); Smear (ID: `keyterm:Smear`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Assyria (ID: `place:Assyria`); Fear (ID: `keyterm:Fear`); Samaria (ID: `place:Samaria`); Force to Serve (ID: `keyterm:EnticedToServe`); Hoshea (ID: `person:Hoshea`); Stone Pine (ID: `flora:Pine`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); High Place (ID: `realia:HighPlace`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`); Misri (ID: `place:Egypt`); To Sin (ID: `keyterm:Sin`); Kutha (ID: `place:Cuthah`); Babeli (ID: `place:Babylon`); Sefarvaimu (ID: `place:Sepharvaim`); House (ID: `realia:House`); Dispossess (ID: `keyterm:Dispossess`); Yeroboamu (ID: `person:Jeroboam`); Hamathi (ID: `place:Hamath`); Decree (ID: `keyterm:Decree`); Offering (ID: `keyterm:Offering`); Iva (ID: `place:Ivvah`); Ashera (ID: `deity:Asherah`); Sukoth-benothi (ID: `deity:Succoth-benoth`); Gozani (ID: `place:Gozan`); Adrameleki (ID: `person:Adrammelech`); Nibhazi (ID: `deity:Nibhaz`); Nergali (ID: `deity:Nergal`); Shalmanesa (ID: `person:Shalmaneser`); Hala (ID: `place:Halah`); Tartaki (ID: `deity:Tartak`); Habori (ID: `place:Habor`); Ashima (ID: `deity:Ashima`); Avvites (ID: `group:Avva`); Anameleki (ID: `person:Anammelech`); Medes (ID: `group:Mede`); Ela (ID: `person:Elah.3`); So (ID: `person:So`); Lion (ID: `fauna:Lion`); Sacred Pole (ID: `realia:SacredPole`); Strength (ID: `keyterm:Strength`); Wamedi (ID: `person:Medan`); Practice Divination (ID: `keyterm:PracticeDivination`); Testimony (ID: `keyterm:Witness.2`); Ahazi (ID: `person:Ahaz`); Fee for Divination (ID: `keyterm:FeeForDivination`); Samaritans (ID: `group:Samaritan`); Believe In (ID: `keyterm:BelieveIn`); Daudi (ID: `person:David`); Baali (ID: `deity:Baal`); An Angel (ID: `deity:Angel`); Farao (ID: `person:Pharaoh.6`); Nebati (ID: `person:Nebat`); Israelites (ID: `group:Israel`); Betheli (ID: `place:Bethel`); Graven Image (ID: `realia:GravenImage`); Prison (ID: `realia:Prison`); Cattle (ID: `fauna:Bull`); Molten Image (ID: `realia:MoltenImage`); Image (ID: `realia:Image`); Sacred Pillar (ID: `realia:SacredPillar`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Hezekia (ID: `person:Hezekiah`); Assyria (ID: `place:Assyria`); Isaya (ID: `person:Isaiah`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Israeli (ID: `person:Israel`); kamanda (ID: `person:Rabshakeh`); Trust (ID: `keyterm:LeanOn`); Yerusalemu (ID: `place:Jerusalem`); House (ID: `realia:House`); Senakeribu (ID: `person:Sennacherib`); Eliakimu (ID: `person:Eliakim.3`); Babeli (ID: `place:Babylon`); Shebna (ID: `person:Shebna`); Daudi (ID: `person:David`); An Angel (ID: `deity:Angel`); Hilkia (ID: `person:Hilkiah`); Amozi (ID: `person:Amoz`); Yoa (ID: `person:Joah`); Misri (ID: `place:Egypt`); Musa (ID: `person:Moses`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Lakishi (ID: `place:Lachish`); Samaria (ID: `place:Samaria`); Hoshea (ID: `person:Hoshea`); Asafu (ID: `person:Asaph`); Iva (ID: `place:Ivvah`); Hena (ID: `place:Hena`); Arpadi (ID: `place:Arpad`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Israeli (ID: `person:Israel`); Manase (ID: `person:Manasseh.2`); Shafani (ID: `person:Shaphan`); House (ID: `realia:House`); Yosia (ID: `person:Josiah`); Hilkia (ID: `person:Hilkiah.2`); Ashera (ID: `deity:Asherah`); Amoni (ID: `person:Amon.3`); Instruction (ID: `keyterm:Instruction`); Scroll (ID: `realia:Scroll`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Defilement (ID: `keyterm:Defilement`); To Sin (ID: `keyterm:Sin`); Betheli (ID: `place:Bethel`); Kidroni (ID: `place:Kidron`); Covenant (ID: `keyterm:Covenant`); Baali (ID: `deity:Baal`); Samaria (ID: `place:Samaria`); Passover (ID: `keyterm:Passover`); Sacred Pole (ID: `realia:SacredPole`); Ahikamu (ID: `person:Ahikam`)
...
* **Associated ACAI Concepts:** Babeli (ID: `place:Babylon`); Yerusalemu (ID: `place:Jerusalem`); BWANA (ID: `deity:Lord`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Chaldeans (ID: `group:Chaldea`); Wakaldayo (ID: `place:Chaldea`); Yehoyakimu (ID: `person:Jehoiakim`); Nebukadneza (ID: `person:Nebuchadnezzar`); Yekonia (ID: `person:Jehoiachin`); Sedekia (ID: `person:Zedekiah.3`); Ribla (ID: `place:Riblah.2`); House (ID: `realia:House`); Neko (ID: `person:Neco`); Yosia (ID: `person:Josiah`); Gedalia (ID: `person:Gedaliah.2`); Misri (ID: `place:Egypt`); Yehoahazi (ID: `person:Jehoahaz.3`); Nebuzaradani (ID: `person:Nebuzaradan`); Hamutali (ID: `person:Hamutal`); Yeremia (ID: `person:Jeremiah`); Ishmaeli (ID: `person:Ishmael.2`); Under Siege (ID: `keyterm:StateOfBeingUnderSiege`); Nethania (ID: `person:Nethaniah`); Libnah (ID: `place:Libnah.2`); Mto (ID: `place:Euphrates`); Fear (ID: `keyterm:Fear`); Hamathi (ID: `place:Hamath`); Megido (ID: `place:Megiddo`); Sulemani (ID: `person:Solomon`)
