...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); BWANA (ID: `deity:Lord`); Abneri (ID: `person:Abner`); Sauli (ID: `person:Saul.2`); Israeli (ID: `person:Israel`); Hebroni (ID: `place:Hebron`); Yoabu (ID: `person:Joab`); Ishboshethi (ID: `person:Ish-bosheth`); Covenant Box (ID: `keyterm:CovenantBox`); Asaheli (ID: `person:Asahel`); Yonathani (ID: `person:Jonathan.3`); Yuda (ID: `person:Judah.4`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); Yuda (ID: `group:Judah`); Mikali (ID: `person:Michal`); Neri (ID: `person:Ner.2`); Gibeoni (ID: `place:Gibeon`); Benyamini (ID: `group:Benjamin`); Benyamini (ID: `person:Benjamin`); Yerusalemu (ID: `place:Jerusalem`); An Angel (ID: `deity:Angel`); Bless (ID: `keyterm:Bless`); Smear (ID: `keyterm:Smear`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); House (ID: `realia:House`); Baana (ID: `person:Baanah`); Rekabu (ID: `person:Rechab`); Uza (ID: `person:Uzzah`); Beerothi (ID: `place:Beeroth`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Syrians (ID: `group:Syria`); Ammonites (ID: `group:Ammon`); Waamoni (ID: `place:Ammon`); Hadadezeri (ID: `person:Hadadezer`); Siba (ID: `person:Ziba`); Sauli (ID: `person:Saul.2`); Yoabu (ID: `person:Joab`); Mefiboshethi (ID: `person:Mephibosheth`); Soba (ID: `place:Zobah`); Kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Hanuni (ID: `person:Hanun`); Nathani (ID: `person:Nathan.2`); Yonathani (ID: `person:Jonathan.3`); Edomu (ID: `place:Edom`); Fear (ID: `keyterm:Fear`); Yerusalemu (ID: `place:Jerusalem`); Rehobu (ID: `person:Rehob`); Tou (ID: `person:Toi`); Bethrehobu (ID: `place:Beth-rehob`); Shobaki (ID: `person:Shobach`); Amieli (ID: `person:Ammiel.2`); People of Tob (ID: `group:Tob`); Makiri (ID: `person:Machir.2`); Helamu (ID: `place:Helam`); Lo-debari (ID: `place:Lo-debar`); Dameski (ID: `place:Damascus`)
...
* **Associated ACAI Concepts:** Absalomu (ID: `person:Absalom`); Daudi (ID: `person:David`); Israeli (ID: `person:Israel`); Yoabu (ID: `person:Joab`); BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Ahithofeli (ID: `person:Ahithophel`); Ahimaasi (ID: `person:Ahimaaz.2`); Sadoki (ID: `person:Zadok.2`); Hushai (ID: `person:Hushai`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Bikri (ID: `person:Bichri`); Yordani (ID: `place:Jordan`); Sheba (ID: `person:Sheba.4`); Peace (ID: `keyterm:IntactState`); Amasa (ID: `person:Amasa`); Abishai (ID: `person:Abishai`); Abiathari (ID: `person:Abiathar`); Shimei (ID: `person:Shimei.5`); Itai (ID: `person:Ittai`); Counsel (ID: `keyterm:Counsel`); Barzilai (ID: `person:Barzillai`); Seruya (ID: `person:Zeruiah`); Siba (ID: `person:Ziba`); Cushites (ID: `group:Cush`); Mefiboshethi (ID: `person:Mephibosheth`); Cush (ID: `place:Cush.2`); House (ID: `realia:House`); Yonathani (ID: `person:Jonathan.4`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Daudi (ID: `person:David`); Israeli (ID: `person:Israel`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); Sauli (ID: `person:Saul.2`); Arauna (ID: `person:Ornan`); Salvation (ID: `keyterm:Salvation`); Yoabu (ID: `person:Joab`); Gadi (ID: `person:Gad.2`); Gibeoni (ID: `place:Gibeon`); Bethlehemu (ID: `place:Bethlehem`); Gibeonites (ID: `group:Gibeon`); Mrefai (ID: `person:Rapha`); Complete (ID: `keyterm:Complete`); Yuda (ID: `person:Judah.4`); Yonathani (ID: `person:Jonathan.3`); Yuda (ID: `group:Judah`); Aya (ID: `person:Aiah.2`); Rispa (ID: `person:Rizpah`); Offering (ID: `keyterm:Offering`); Shield (ID: `keyterm:Shield`); Dani (ID: `place:Dan`); Seruya (ID: `person:Zeruiah`); Dani (ID: `group:Dan`); Beer-sheba (ID: `place:Beersheba`); Gathi (ID: `place:Gath`); Threshing Floor (ID: `realia:ThreshingFloor`); Spear (ID: `realia:Spear`); Yehoyada (ID: `person:Jehoiada`)
