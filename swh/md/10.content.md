...
* **Associated ACAI Concepts:** Ishboshethi (ID: `person:Ish-bosheth`); Abneri (ID: `person:Abner`); Asaheli (ID: `person:Asahel`); Rekabu (ID: `person:Rechab`); Baana (ID: `person:Baanah`); Beerothites (ID: `group:Beeroth`); Neri (ID: `person:Ner.2`); Rimoni (ID: `person:Rimmon`); Mikali (ID: `person:Michal`); Hebroni (ID: `place:Hebron`); Uza (ID: `person:Uzzah`); Yonathani (ID: `person:Jonathan.3`); Beerothi (ID: `place:Beeroth`); Yerusalemu (ID: `place:Jerusalem`); Bithroni (ID: `place:Bithron`); Helkath-hasurimu (ID: `place:Helkath-hazzurim`); Shaker (ID: `realia:Shaker`); Sirah (ID: `place:Sirah`); Yezreeli (ID: `place:Jezreel.3`); Water-Tunnel (ID: `realia:Water-tunnel`); Gia (ID: `place:Giah`); Ama (ID: `place:Ammah`); Ahio (ID: `person:Ahio`); Abinadabu (ID: `person:Abinadab`); Obed-edomu (ID: `person:Obed-edom`); Abishai (ID: `person:Abishai`); Seruya (ID: `person:Zeruiah`); Yezreeli (ID: `place:Jezreel.2`); Ahinoamu (ID: `person:Ahinoam.2`); Maaka (ID: `person:Maacah.2`)
...
* **Associated ACAI Concepts:** Siba (ID: `person:Ziba`); Hadadezeri (ID: `person:Hadadezer`); Soba (ID: `place:Zobah`); Mefiboshethi (ID: `person:Mephibosheth`); Hanuni (ID: `person:Hanun`); People of Tob (ID: `group:Tob`); Rehobu (ID: `person:Rehob`); Helamu (ID: `place:Helam`); Yoabu (ID: `person:Joab`); Daudi (ID: `person:David`); Nathani (ID: `person:Nathan.2`); Makiri (ID: `person:Machir.2`); Amieli (ID: `person:Ammiel.2`); Tou (ID: `person:Toi`); Tobu (ID: `place:Tob`); Shobaki (ID: `person:Shobach`); Bethrehobu (ID: `place:Beth-rehob`); Lo-debari (ID: `place:Lo-debar`); Yoramu (ID: `person:Joram.2`); Tibhathi (ID: `place:Betah`); Maaka (ID: `place:Maacah`); Dameski (ID: `place:Damascus`); Nahashi (ID: `person:Nahash.2`); Moabu (ID: `place:Moab`); Yehoshafati (ID: `person:Jehoshaphat`); Seraya (ID: `person:Seraiah`); katika (ID: `place:SaltValley`); Ahimeleki (ID: `person:Ahimelech.3`); Mika (ID: `person:Micah.2`); Ahiludi (ID: `person:Ahilud`)
...
* **Associated ACAI Concepts:** Tamari (ID: `person:Tamar.2`); Amnoni (ID: `person:Amnon`); Uria (ID: `person:Uriah`); Absalomu (ID: `person:Absalom`); Yonadabu (ID: `person:Jonadab.2`); Yoabu (ID: `person:Joab`); Nathani (ID: `person:Nathan.2`); Wageshuri (ID: `place:Geshur`); Amihudi (ID: `person:Ammihud.4`); Baal-hasori (ID: `place:Baal-hazor`); Tamari (ID: `person:Tamar.3`); Cake (ID: `realia:Cake`); Bed (ID: `realia:Bed`); Shama (ID: `person:Shimeah.2`); Eliamu (ID: `person:Eliam`); Brick Mold (ID: `realia:BrickMold`); Thebesi (ID: `place:Thebez`); Efraimu (ID: `place:Ephraim`); Bathsheba (ID: `person:Bathsheba`); Tunic (ID: `realia:Tunic.2`); Talmai (ID: `person:Talmai.2`); Stone Plane (ID: `realia:StonePlane`); An Informant (ID: `person:Informant`); Hittites (ID: `group:Hittite`); Mhiti (ID: `person:Heth`); Waamoni (ID: `place:Ammon`); Daudi (ID: `person:David`); An Angel (ID: `deity:Angel`); House (ID: `realia:House`); Yerusalemu (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Bikri (ID: `person:Bichri`); Itai (ID: `person:Ittai`); Sheba (ID: `person:Sheba.4`); Hushai (ID: `person:Hushai`); Ahithofeli (ID: `person:Ahithophel`); Ahimaasi (ID: `person:Ahimaaz.2`); Amasa (ID: `person:Amasa`); Barzilai (ID: `person:Barzillai`); Absalomu (ID: `person:Absalom`); Cushites (ID: `group:Cush`); Shimei (ID: `person:Shimei.5`); Kimhamu (ID: `person:Chimham`); Yonathani (ID: `person:Jonathan.4`); Abishai (ID: `person:Abishai`); Seruya (ID: `person:Zeruiah`); Gera (ID: `person:Gera.2`); Rogelimu (ID: `place:Rogelim`); Abeli (ID: `place:Abel-beth-maacah`); Bahurimu (ID: `place:Bahurim`); Pelethites (ID: `group:Pelethites`); Ira (ID: `person:Ira`); Jairites (ID: `group:Jair`); Nahashi (ID: `person:Nahash.3`); Nahashi (ID: `person:Nahash.4`); Shobi (ID: `person:Shobi`); ndani (ID: `place:ForestEphraim`); Bethlebaothi (ID: `place:Beth-merchak`); Bichrites (ID: `group:Bichri`); Cherethites (ID: `group:Cherethite`); Terebinth (ID: `flora:Terebinth`)
...
* **Associated ACAI Concepts:** Arauna (ID: `person:Ornan`); Gadi (ID: `person:Gad.2`); Mrefai (ID: `person:Rapha`); Rispa (ID: `person:Rizpah`); Aya (ID: `person:Aiah.2`); Salvation (ID: `keyterm:Salvation`); Threshing Floor (ID: `realia:ThreshingFloor`); Adino (ID: `person:Adino`); Paarai (ID: `person:Paarai`); Bani (ID: `person:Bani.2`); Agee (ID: `person:Agee`); Igali (ID: `person:Igal.2`); Elika (ID: `person:Elika`); Wahiti (ID: `place:Kadesh`); Naye (ID: `person:Ishbi-benob`); Eliamu (ID: `person:Eliam.2`); Shama (ID: `person:Shammah`); Barzilai (ID: `person:Barzillai.2`); Elifeleti (ID: `person:Eliphelet.2`); Armoni (ID: `person:Armoni`); Mefiboshethi (ID: `person:Mephibosheth.2`); Ahasbai (ID: `person:Ahasbai`); Hararites (ID: `group:Hararites`); Hushathites (ID: `group:Hushathites`); Sibekai (ID: `person:Sibbecai`); Ahoa (ID: `group:Ahoah`); Fortress (ID: `realia:Fortress`); Mwahohi (ID: `person:Ahoah`); cha (ID: `group:Harod`); Eleazari (ID: `person:Eleazar.4`)
