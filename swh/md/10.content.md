...
* **Associated Passages:** 2 Samweli 1:1-6:23
* **Associated Articles:** Mungu (ID: `367690@BiblicaStudyNotesKeyTerms`); Ukoo (ID: `367711@BiblicaStudyNotesKeyTerms`); Mauaji (ID: `367714@BiblicaStudyNotesKeyTerms`); Agano (ID: `367728@BiblicaStudyNotesKeyTerms`); Wafilisti (ID: `367758@BiblicaStudyNotesKeyTerms`); Wake (ID: `367768@BiblicaStudyNotesKeyTerms`); Israeli (ID: `367771@BiblicaStudyNotesKeyTerms`); Makabila 12 (ID: `367777@BiblicaStudyNotesKeyTerms`); Yuda (ID: `367782@BiblicaStudyNotesKeyTerms`); Watu wa Mungu (ID: `367793@BiblicaStudyNotesKeyTerms`); Waamaleki (ID: `367815@BiblicaStudyNotesKeyTerms`); Mfalme (ID: `367821@BiblicaStudyNotesKeyTerms`); Aliyepakwa mafuta (ID: `367851@BiblicaStudyNotesKeyTerms`); Takatifu (ID: `367852@BiblicaStudyNotesKeyTerms`); Sanduku la agano (ID: `367876@BiblicaStudyNotesKeyTerms`); Moyo (ID: `367910@BiblicaStudyNotesKeyTerms`); Daudi (ID: `367940@BiblicaStudyNotesKeyTerms`); Sauli (ID: `367946@BiblicaStudyNotesKeyTerms`); Yonathani (ID: `367948@BiblicaStudyNotes`); Yoabu (ID: `367954@BiblicaStudyNotesKeyTerms`); Yerusalemu (ID: `367955@BiblicaStudyNotesKeyTerms`); Aibu na heshima (ID: `367956@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Daudi (ID: `person:David`); BWANA (ID: `deity:Lord`); Abneri (ID: `person:Abner`); Sauli (ID: `person:Saul.2`); Israeli (ID: `person:Israel`); Hebroni (ID: `place:Hebron`); Yoabu (ID: `person:Joab`); Ishboshethi (ID: `person:Ish-bosheth`); Covenant Box (ID: `keyterm:CovenantBox`); Asaheli (ID: `person:Asahel`); Yonathani (ID: `person:Jonathan.3`); Yuda (ID: `group:Judah`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); Yuda (ID: `person:Judah.4`); Neri (ID: `person:Ner.2`); Mikali (ID: `person:Michal`); Gibeoni (ID: `place:Gibeon`); Benyamini (ID: `group:Benjamin`); Benyamini (ID: `person:Benjamin`); Yerusalemu (ID: `place:Jerusalem`); Bless (ID: `keyterm:Bless`); An Angel (ID: `deity:Angel`); Smear (ID: `keyterm:Smear`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); House (ID: `realia:House`); Baana (ID: `person:Baanah`); Rekabu (ID: `person:Rechab`); Uza (ID: `person:Uzzah`); Beerothi (ID: `place:Beeroth`)
...
* **Associated Passages:** 2 Samweli 7:1-10:19
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Syrians (ID: `group:Syria`); Ammonites (ID: `group:Ammon`); Waamoni (ID: `place:Ammon`); Hadadezeri (ID: `person:Hadadezer`); Siba (ID: `person:Ziba`); Sauli (ID: `person:Saul.2`); Soba (ID: `place:Zobah`); Yoabu (ID: `person:Joab`); Mefiboshethi (ID: `person:Mephibosheth`); Kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Hanuni (ID: `person:Hanun`); Nathani (ID: `person:Nathan.2`); Yonathani (ID: `person:Jonathan.3`); Fear (ID: `keyterm:Fear`); Edomu (ID: `place:Edom`); Yerusalemu (ID: `place:Jerusalem`); Rehobu (ID: `person:Rehob`); Shobaki (ID: `person:Shobach`); Bethrehobu (ID: `place:Beth-rehob`); Tou (ID: `person:Toi`); Amieli (ID: `person:Ammiel.2`); Makiri (ID: `person:Machir.2`); People of Tob (ID: `group:Tob`); Moabu (ID: `place:Moab`); Lo-debari (ID: `place:Lo-debar`); Tobu (ID: `place:Tob`)
...
* **Associated Passages:** 2 Samweli 11:1-14:33
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); Absalomu (ID: `person:Absalom`); Yoabu (ID: `person:Joab`); BWANA (ID: `deity:Lord`); Amnoni (ID: `person:Amnon`); Uria (ID: `person:Uriah`); Tamari (ID: `person:Tamar.2`); Israeli (ID: `person:Israel`); An Angel (ID: `deity:Angel`); Mhiti (ID: `person:Heth`); Hittites (ID: `group:Hittite`); Nathani (ID: `person:Nathan.2`); Waamoni (ID: `place:Ammon`); Yerusalemu (ID: `place:Jerusalem`); House (ID: `realia:House`); Yonadabu (ID: `person:Jonadab.2`); Wageshuri (ID: `place:Geshur`); Ammonites (ID: `group:Ammon`); Love (ID: `keyterm:Love`); Tekoa (ID: `place:Tekoa`); A Woman (ID: `person:GenericFemale`); Fear (ID: `keyterm:Fear`); Bathsheba (ID: `person:Bathsheba`); Shama (ID: `person:Shimeah.2`); Yuda (ID: `group:Judah`); Bless (ID: `keyterm:Bless`); Passion (ID: `keyterm:Ardour`); Sulemani (ID: `person:Solomon`); Yuda (ID: `person:Judah.4`); Cake (ID: `realia:Cake`)
...
* **Associated Passages:** 2 Samweli 15:1-20:26
...
* **Associated ACAI Concepts:** Absalomu (ID: `person:Absalom`); Daudi (ID: `person:David`); Israeli (ID: `person:Israel`); Yoabu (ID: `person:Joab`); BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Ahithofeli (ID: `person:Ahithophel`); Ahimaasi (ID: `person:Ahimaaz.2`); Sadoki (ID: `person:Zadok.2`); Hushai (ID: `person:Hushai`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Bikri (ID: `person:Bichri`); Yordani (ID: `place:Jordan`); Sheba (ID: `person:Sheba.4`); Peace (ID: `keyterm:IntactState`); Amasa (ID: `person:Amasa`); Abishai (ID: `person:Abishai`); Abiathari (ID: `person:Abiathar`); Shimei (ID: `person:Shimei.5`); Itai (ID: `person:Ittai`); Counsel (ID: `keyterm:Counsel`); Barzilai (ID: `person:Barzillai`); Seruya (ID: `person:Zeruiah`); Siba (ID: `person:Ziba`); Cushites (ID: `group:Cush`); Cush (ID: `place:Cush.2`); Mefiboshethi (ID: `person:Mephibosheth`); House (ID: `realia:House`); Yonathani (ID: `person:Jonathan.4`)
...
* **Associated Passages:** 2 Samweli 21:1-24:25
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Daudi (ID: `person:David`); Israeli (ID: `person:Israel`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); Sauli (ID: `person:Saul.2`); Arauna (ID: `person:Ornan`); Salvation (ID: `keyterm:Salvation`); Yoabu (ID: `person:Joab`); Gadi (ID: `person:Gad.2`); Gibeoni (ID: `place:Gibeon`); Bethlehemu (ID: `place:Bethlehem`); Gibeonites (ID: `group:Gibeon`); Mrefai (ID: `person:Rapha`); Yuda (ID: `group:Judah`); Yonathani (ID: `person:Jonathan.3`); Complete (ID: `keyterm:Complete`); Yuda (ID: `person:Judah.4`); Rispa (ID: `person:Rizpah`); Aya (ID: `person:Aiah.2`); Offering (ID: `keyterm:Offering`); Seruya (ID: `person:Zeruiah`); Gathi (ID: `place:Gath`); Dani (ID: `place:Dan`); Dani (ID: `group:Dan`); Beer-sheba (ID: `place:Beersheba`); Shield (ID: `keyterm:Shield`); Threshing Floor (ID: `realia:ThreshingFloor`); Spear (ID: `realia:Spear`); Benaya (ID: `person:Benaiah`)
