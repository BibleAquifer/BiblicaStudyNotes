...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); BWANA (ID: `deity:Lord`); Abneri (ID: `person:Abner`); Sauli (ID: `person:Saul.2`); Israeli (ID: `person:Israel`); Hebroni (ID: `place:Hebron`); Yoabu (ID: `person:Joab`); Ishboshethi (ID: `person:Ish-bosheth`); Covenant Box (ID: `keyterm:CovenantBox`); Asaheli (ID: `person:Asahel`); Yonathani (ID: `person:Jonathan.3`); Wafilisti (ID: `place:Philistine`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Wafilisti (ID: `group:Philistine`); Neri (ID: `person:Ner.2`); Mikali (ID: `person:Michal`); Gibeoni (ID: `place:Gibeon`); Benyamini (ID: `group:Benjamin`); Benyamini (ID: `person:Benjamin`); Yerusalemu (ID: `place:Jerusalem`); Smear (ID: `keyterm:Smear`); An Angel (ID: `deity:Angel`); Bless (ID: `keyterm:Bless`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); House (ID: `realia:House`); Baana (ID: `person:Baanah`); Rekabu (ID: `person:Rechab`); Uza (ID: `person:Uzzah`); Beerothi (ID: `place:Beeroth`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Syrians (ID: `group:Syria`); Waamoni (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Hadadezeri (ID: `person:Hadadezer`); Siba (ID: `person:Ziba`); Sauli (ID: `person:Saul.2`); Mefiboshethi (ID: `person:Mephibosheth`); Soba (ID: `place:Zobah`); Yoabu (ID: `person:Joab`); Kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Hanuni (ID: `person:Hanun`); Nathani (ID: `person:Nathan.2`); Yonathani (ID: `person:Jonathan.3`); Yerusalemu (ID: `place:Jerusalem`); Fear (ID: `keyterm:Fear`); Edomu (ID: `place:Edom`); Shobaki (ID: `person:Shobach`); Makiri (ID: `person:Machir.2`); Bethrehobu (ID: `place:Beth-rehob`); Tou (ID: `person:Toi`); People of Tob (ID: `group:Tob`); Amieli (ID: `person:Ammiel.2`); Rehobu (ID: `person:Rehob`); Maaka (ID: `place:Maacah`); Moabu (ID: `place:Moab`); Helamu (ID: `place:Helam`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); Absalomu (ID: `person:Absalom`); Yoabu (ID: `person:Joab`); BWANA (ID: `deity:Lord`); Amnoni (ID: `person:Amnon`); Uria (ID: `person:Uriah`); Tamari (ID: `person:Tamar.2`); An Angel (ID: `deity:Angel`); Israeli (ID: `person:Israel`); Hittites (ID: `group:Hittite`); Mhiti (ID: `person:Heth`); Nathani (ID: `person:Nathan.2`); Waamoni (ID: `place:Ammon`); Yerusalemu (ID: `place:Jerusalem`); House (ID: `realia:House`); Yonadabu (ID: `person:Jonadab.2`); Wageshuri (ID: `place:Geshur`); Ammonites (ID: `group:Ammon`); Love (ID: `keyterm:Love`); Tekoa (ID: `place:Tekoa`); A Woman (ID: `person:GenericFemale`); Fear (ID: `keyterm:Fear`); Bathsheba (ID: `person:Bathsheba`); Shama (ID: `person:Shimeah.2`); Sulemani (ID: `person:Solomon`); Yuda (ID: `group:Judah`); Passion (ID: `keyterm:Ardour`); Yuda (ID: `person:Judah.4`); Bless (ID: `keyterm:Bless`); Cake (ID: `realia:Cake`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Daudi (ID: `person:David`); Israeli (ID: `person:Israel`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Sauli (ID: `person:Saul.2`); Arauna (ID: `person:Ornan`); Salvation (ID: `keyterm:Salvation`); Yoabu (ID: `person:Joab`); Gadi (ID: `person:Gad.2`); Bethlehemu (ID: `place:Bethlehem`); Gibeoni (ID: `place:Gibeon`); Gibeonites (ID: `group:Gibeon`); Mrefai (ID: `person:Rapha`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Yonathani (ID: `person:Jonathan.3`); Complete (ID: `keyterm:Complete`); Rispa (ID: `person:Rizpah`); Aya (ID: `person:Aiah.2`); Dani (ID: `group:Dan`); Offering (ID: `keyterm:Offering`); Beer-sheba (ID: `place:Beersheba`); Dani (ID: `place:Dan`); Gathi (ID: `place:Gath`); Seruya (ID: `person:Zeruiah`); Shield (ID: `keyterm:Shield`); Threshing Floor (ID: `realia:ThreshingFloor`); Spear (ID: `realia:Spear`); Ahoa (ID: `group:Ahoah`)
