...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); BWANA (ID: `deity:Lord`); Abneri (ID: `person:Abner`); Sauli (ID: `person:Saul.2`); Israeli (ID: `person:Israel`); Hebroni (ID: `place:Hebron`); Yoabu (ID: `person:Joab`); Ishboshethi (ID: `person:Ish-bosheth`); Covenant Box (ID: `keyterm:CovenantBox`); Asaheli (ID: `person:Asahel`); Yonathani (ID: `person:Jonathan.3`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Neri (ID: `person:Ner.2`); Mikali (ID: `person:Michal`); Gibeoni (ID: `place:Gibeon`); Benyamini (ID: `person:Benjamin`); Benyamini (ID: `group:Benjamin`); Yerusalemu (ID: `place:Jerusalem`); An Angel (ID: `deity:Angel`); Bless (ID: `keyterm:Bless`); Smear (ID: `keyterm:Smear`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); House (ID: `realia:House`); Baana (ID: `person:Baanah`); Rekabu (ID: `person:Rechab`); Uza (ID: `person:Uzzah`); Beerothi (ID: `place:Beeroth`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Syrians (ID: `group:Syria`); Waamoni (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Hadadezeri (ID: `person:Hadadezer`); Siba (ID: `person:Ziba`); Sauli (ID: `person:Saul.2`); Yoabu (ID: `person:Joab`); Mefiboshethi (ID: `person:Mephibosheth`); Soba (ID: `place:Zobah`); Kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Hanuni (ID: `person:Hanun`); Nathani (ID: `person:Nathan.2`); Yonathani (ID: `person:Jonathan.3`); Fear (ID: `keyterm:Fear`); Yerusalemu (ID: `place:Jerusalem`); Edomu (ID: `place:Edom`); People of Tob (ID: `group:Tob`); Rehobu (ID: `person:Rehob`); Bethrehobu (ID: `place:Beth-rehob`); Tou (ID: `person:Toi`); Shobaki (ID: `person:Shobach`); Amieli (ID: `person:Ammiel.2`); Makiri (ID: `person:Machir.2`); Maaka (ID: `place:Maacah`); Moabu (ID: `place:Moab`); Tobu (ID: `place:Tob`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Daudi (ID: `person:David`); Israeli (ID: `person:Israel`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Sauli (ID: `person:Saul.2`); Arauna (ID: `person:Ornan`); Salvation (ID: `keyterm:Salvation`); Yoabu (ID: `person:Joab`); Gadi (ID: `person:Gad.2`); Gibeonites (ID: `group:Gibeon`); Gibeoni (ID: `place:Gibeon`); Bethlehemu (ID: `place:Bethlehem`); Mrefai (ID: `person:Rapha`); Yuda (ID: `person:Judah.4`); Yonathani (ID: `person:Jonathan.3`); Yuda (ID: `group:Judah`); Complete (ID: `keyterm:Complete`); Aya (ID: `person:Aiah.2`); Rispa (ID: `person:Rizpah`); Shield (ID: `keyterm:Shield`); Beer-sheba (ID: `place:Beersheba`); Seruya (ID: `person:Zeruiah`); Dani (ID: `group:Dan`); Gathi (ID: `place:Gath`); Offering (ID: `keyterm:Offering`); Dani (ID: `place:Dan`); Threshing Floor (ID: `realia:ThreshingFloor`); Spear (ID: `realia:Spear`); Sibekai (ID: `person:Sibbecai`)
