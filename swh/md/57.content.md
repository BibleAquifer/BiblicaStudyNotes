...
* **Associated ACAI Concepts:** Filemoni (ID: `person:Philemon`); Afia (ID: `person:Apphia`); Arkipo (ID: `person:Archippus`); Onesimo (ID: `person:Onesimus`); Epafra (ID: `person:Epaphras`); Dema (ID: `person:Demas`); Luka (ID: `person:Luke`); Guest Room (ID: `realia:GuestRoom`); Owe (ID: `keyterm:Owe`); Yesu (ID: `person:Jesus.2`)
