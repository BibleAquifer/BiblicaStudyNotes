...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Ask for (ID: `keyterm:AskFor`); In Christ (ID: `keyterm:InChrist`); Affection (ID: `keyterm:Affection`); Paulo (ID: `person:Paul`); Love (ID: `keyterm:Love`); Favor (ID: `keyterm:Favor`); BWANA (ID: `deity:Lord`); Beloved (ID: `keyterm:Beloved`); Pray (ID: `keyterm:Pray`); Believe (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); Holy (ID: `keyterm:Holy`); Onesimo (ID: `person:Onesimus`); Filemoni (ID: `person:Philemon`); Epafra (ID: `person:Epaphras`); Arkipo (ID: `person:Archippus`); Owe (ID: `keyterm:Owe`); Afia (ID: `person:Apphia`); Dema (ID: `person:Demas`); Luka (ID: `person:Luke`); Heart (ID: `keyterm:Heart`); To Act Wickedly (ID: `keyterm:ActWickedly`); Forgive (ID: `keyterm:Forgive`); Aristarko (ID: `person:Aristarchus`); Good News (ID: `keyterm:GoodNews`); Hope (ID: `keyterm:Hope`); Timotheo (ID: `person:Timothy`); Make Peace (ID: `keyterm:Peace`); Persuade (ID: `keyterm:Persuade`); Marko (ID: `person:Mark`); Always (ID: `keyterm:Always`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Body (ID: `keyterm:Body.3`); Church (ID: `keyterm:Church`); Fellowship (ID: `keyterm:Fellowship`); Spirit (ID: `keyterm:Spirit.2`); Serve (ID: `keyterm:Serve`); Guest Room (ID: `realia:GuestRoom`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
