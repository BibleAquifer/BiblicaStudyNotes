...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Kind (ID: `keyterm:Kind.2`); Adamu (ID: `person:Adam`); Grass (ID: `flora:Grass`); Garden of Eden (ID: `place:Eden.2`); Bless (ID: `keyterm:Bless`); Cattle (ID: `fauna:Bull`); Likeness (ID: `keyterm:Semblance`); Intention (ID: `keyterm:Intention`); Lizard (ID: `fauna:Lizard`); Monitor (ID: `fauna:Iguana`); Barley (ID: `flora:Barley`); Coriander (ID: `flora:Coriander`); Chameleon (ID: `fauna:Chameleon`); Gihoni (ID: `place:Gihon`); Mto (ID: `place:Euphrates`); Kushi (ID: `place:Cush`); Hidekeli (ID: `place:Tigris`); Havila (ID: `place:Havilah`); Green Vegetation (ID: `flora:GreenVegetation`); Fish (ID: `fauna:Fish`); Holy (ID: `keyterm:Holy`); Cush (ID: `place:Cush.2`); Assyria (ID: `place:Assyria`); Dragon (ID: `fauna:Dragon`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Kaini (ID: `person:Cain`); Enoshi (ID: `person:Enosh`); Sethi (ID: `person:Seth`); Adamu (ID: `person:Adam`); Henoko (ID: `person:Enoch.2`); Habili (ID: `person:Abel`); Lameki (ID: `person:Lamech.2`); Methusela (ID: `person:Methuselah`); Mahalaleli (ID: `person:Mahalalel`); Yaredi (ID: `person:Jared`); Kenani (ID: `person:Kenan`); Lameki (ID: `person:Lamech`); Ada (ID: `person:Adah`); Sila (ID: `person:Zillah`); Offering (ID: `keyterm:Offering`); Nuhu (ID: `person:Noah`); Henoko (ID: `person:Enoch`); To Curse (ID: `keyterm:Curse`); Likeness (ID: `keyterm:Semblance`); Yubali (ID: `person:Jubal`); Yabali (ID: `person:Jabal`); Naama (ID: `person:Naamah.2`); Mehuyaeli (ID: `person:Mehujael`); To Sin (ID: `keyterm:Sin`); Shemu (ID: `person:Shem`); Tubal-kaini (ID: `person:Tubal-cain`); Nodi (ID: `place:Nod`); Yafethi (ID: `person:Japheth`); Methushaeli (ID: `person:Methushael`)
...
* **Associated ACAI Concepts:** Nuhu (ID: `person:Noah`); BWANA (ID: `deity:Lord`); Ship (ID: `realia:Ship`); Dove (ID: `fauna:Dove`); Destroy (ID: `keyterm:Destroy`); Lizard (ID: `fauna:Lizard`); Monitor (ID: `fauna:Iguana`); Chameleon (ID: `fauna:Chameleon`); Cubit (ID: `realia:Cubit`); Pure (ID: `keyterm:Pure`); Shemu (ID: `person:Shem`); Hamu (ID: `person:Ham`); Kind (ID: `keyterm:Kind.2`); Yafethi (ID: `person:Japheth`); Cattle (ID: `fauna:Bull`); Complete (ID: `keyterm:Complete`); Nephilim (ID: `group:Nephilim`); Favor (ID: `keyterm:Favor`); Ararati (ID: `place:Ararat`); Covenant (ID: `keyterm:Covenant`); Window (ID: `realia:Window`); Olive Tree (ID: `flora:OliveTree`); Crow (ID: `fauna:Crow`); Cypress (ID: `flora:Cypress`); Lion (ID: `fauna:Lion`); Bear (ID: `fauna:Bear`); Bird (ID: `fauna:Bird`); Covering (ID: `realia:Covering`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Nuhu (ID: `person:Noah`); Shemu (ID: `person:Shem`); Wakanaani (ID: `person:Canaan`); Eberi (ID: `person:Eber`); Tera (ID: `person:Terah`); Covenant (ID: `keyterm:Covenant`); Harani (ID: `person:Haran`); Yafethi (ID: `person:Japheth`); Arfaksadi (ID: `person:Arpachshad`); Pelegi (ID: `person:Peleg`); Hamu (ID: `person:Ham`); Sala (ID: `person:Shelah.2`); Serugi (ID: `person:Serug`); Reu (ID: `person:Reu`); Abrahamu (ID: `person:Abraham`); Nahori (ID: `person:Nahor`); Wakanaani (ID: `place:Canaan`); Yoktani (ID: `person:Joktan`); Kushi (ID: `person:Cush.2`); Sara (ID: `person:Sarah`); Nahori (ID: `person:Nahor.2`); Ship (ID: `realia:Ship`); Kala (ID: `place:Calah`); Uru (ID: `place:Ur`); Nimrodi (ID: `person:Nimrod`); Yavani (ID: `person:Javan`); Aramu (ID: `person:Aram`); Misri (ID: `person:Egypt`); Ninawi (ID: `place:Nineveh`)
...
* **Associated ACAI Concepts:** Abrahamu (ID: `person:Abraham`); BWANA (ID: `deity:Lord`); Lutu (ID: `person:Lot`); Sodoma (ID: `place:Sodom`); Kedorlaoma (ID: `person:Chedorlaomer`); Misri (ID: `place:Egypt`); Gomora (ID: `place:Gomorrah`); Farao (ID: `person:Pharaoh.3`); Wakanaani (ID: `place:Canaan`); Bless (ID: `keyterm:Bless`); bonde (ID: `place:SiddimValley`); Negebu (ID: `place:Negeb`); Sara (ID: `person:Sarah`); Mamre (ID: `place:Mamre`); Zoar (ID: `place:Zoar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Stone Altar (ID: `realia:StoneAltar`); Tidali (ID: `person:Tidal`); Aneri (ID: `person:Aner`); Eshkoli (ID: `person:Eshcol`); Arioko (ID: `person:Arioch`); Amrafeli (ID: `person:Amraphel`); Goiim (ID: `group:Goiim`); Elasari (ID: `place:Ellasar`); mji (ID: `place:Ai`); Harani (ID: `place:Haran`)
...
* **Associated ACAI Concepts:** Abrahamu (ID: `person:Abraham`); BWANA (ID: `deity:Lord`); Isaka (ID: `person:Isaac`); Sara (ID: `person:Sarah`); Offering (ID: `keyterm:Offering`); Abimeleki (ID: `person:Abimelech`); Beer-sheba (ID: `place:Beersheba`); Sheep (ID: `fauna:Lamb`); Swear (ID: `keyterm:Swear`); An Angel (ID: `deity:Angel`); Hajiri (ID: `person:Hagar`); Fikoli (ID: `person:Phicol`); Milka (ID: `person:Milcah`); Bless (ID: `keyterm:Bless`); Bethueli (ID: `person:Bethuel`); Skin-Bottle (ID: `realia:Skin-bottle`); Wafilisti (ID: `place:Philistine`); Dispossess (ID: `keyterm:Dispossess`); Nahori (ID: `person:Nahor.2`); Fear (ID: `keyterm:Fear`); Wafilisti (ID: `group:Philistine`); Covenant (ID: `keyterm:Covenant`); Misri (ID: `place:Egypt`); Yidlafu (ID: `person:Jidlaph`); Hazo (ID: `person:Hazo`); Tahashi (ID: `person:Tahash`); Parani (ID: `place:Paran`); Gahamu (ID: `person:Gaham`); Kesedi (ID: `person:Chesed`); Reuma (ID: `person:Reumah`)
...
* **Associated ACAI Concepts:** Abrahamu (ID: `person:Abraham`); BWANA (ID: `deity:Lord`); Rebeka (ID: `person:Rebekah`); Isaka (ID: `person:Isaac`); Mhiti (ID: `person:Heth`); Efroni (ID: `person:Ephron.2`); Sara (ID: `person:Sarah`); Bless (ID: `keyterm:Bless`); Ishmaeli (ID: `person:Ishmael`); Camel (ID: `fauna:Camel`); Clay Jar (ID: `realia:ClayJar`); Makpela (ID: `place:Machpelah`); Bethueli (ID: `person:Bethuel`); Nahori (ID: `person:Nahor.2`); Money (ID: `realia:Money`); Wakanaani (ID: `place:Canaan`); Swear (ID: `keyterm:Swear`); Kindness (ID: `keyterm:Kindness`); Mamre (ID: `place:Mamre`); Milka (ID: `person:Milcah`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`); Ketura (ID: `person:Keturah`); Yokshani (ID: `person:Jokshan`); Beer-lahai-roi (ID: `place:Beer-lahai-roi`); Midiani (ID: `person:Midian`); Sohari (ID: `person:Zohar`); Oath (ID: `keyterm:Oath`); Hebroni (ID: `place:Hebron`); Labani (ID: `person:Laban`)
...
* **Associated ACAI Concepts:** Isaka (ID: `person:Isaac`); Esau (ID: `person:Esau`); Bless (ID: `keyterm:Bless`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`); Rebeka (ID: `person:Rebekah`); Abrahamu (ID: `person:Abraham`); Abimeleki (ID: `person:Abimelech`); Gerari (ID: `place:Gerar`); Padan-aramu (ID: `place:Paddan-aram`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Love (ID: `keyterm:Love`); Labani (ID: `person:Laban`); Bethueli (ID: `person:Bethuel`); Wakanaani (ID: `place:Canaan`); Swear (ID: `keyterm:Swear`); Force to Serve (ID: `keyterm:EnticedToServe`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Mhiti (ID: `person:Heth`); Beer-sheba (ID: `place:Beersheba`); Oath (ID: `keyterm:Oath`); Fear (ID: `keyterm:Fear`); Arameans (ID: `group:Aramean`); Peace (ID: `keyterm:IntactState`); Vine (ID: `flora:Vine`); Nebayothi (ID: `person:Nebaioth`); Eloni (ID: `person:Elon`); Fikoli (ID: `person:Phicol`)
...
* **Associated ACAI Concepts:** Israeli (ID: `person:Israel`); Labani (ID: `person:Laban`); BWANA (ID: `deity:Lord`); Raheli (ID: `person:Rachel`); Lea (ID: `person:Leah`); Force to Serve (ID: `keyterm:EnticedToServe`); Bilha (ID: `person:Bilhah`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Zilpa (ID: `person:Zilpah`); Love (ID: `keyterm:Love`); Bless (ID: `keyterm:Bless`); Isaka (ID: `person:Isaac`); Yegarsahadutha (ID: `place:Jegar-sahadutha`); kinyago (ID: `deity:Teraphim`); Gileadi (ID: `place:Gilead`); Abrahamu (ID: `person:Abraham`); Padan-aramu (ID: `place:Paddan-aram`); Reubeni (ID: `person:Reuben`); Work (ID: `keyterm:Work`); Betheli (ID: `place:Bethel`); Yusufu (ID: `person:Joseph.10`); An Angel (ID: `deity:Angel`); Nahori (ID: `person:Nahor.2`); Harani (ID: `place:Haran`); Fear (ID: `keyterm:Fear`); Arameans (ID: `group:Aramean`); Vow (ID: `keyterm:Vow`); Peace (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`); Esau (ID: `person:Esau`); Shekemu (ID: `person:Shechem`); Hamori (ID: `person:Hamor`); Raheli (ID: `person:Rachel`); Betheli (ID: `place:Bethel`); Dina (ID: `person:Dinah`); Lea (ID: `person:Leah`); Offering (ID: `keyterm:Offering`); Isaka (ID: `person:Isaac`); Favor (ID: `keyterm:Favor`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Bless (ID: `keyterm:Bless`); Circumcision (ID: `keyterm:Circumcision`); Cattle (ID: `fauna:Bull`); Wakanaani (ID: `place:Canaan`); Abrahamu (ID: `person:Abraham`); Walawi (ID: `person:Levi.3`); Simeoni (ID: `person:Simeon.5`); Yusufu (ID: `person:Joseph.10`); An Angel (ID: `deity:Angel`); Padan-aramu (ID: `place:Paddan-aram`); Defilement (ID: `keyterm:Defilement`); Seiri (ID: `place:Seir`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`)
...
* **Associated ACAI Concepts:** Esau (ID: `person:Esau`); Yuda (ID: `person:Judah.4`); Yusufu (ID: `person:Joseph.10`); Edomu (ID: `place:Edom`); Israeli (ID: `person:Israel`); Elifazi (ID: `person:Eliphaz`); Ada (ID: `person:Adah.2`); Wahori (ID: `person:Hori`); Mahalathi (ID: `person:Mahalath`); Wakanaani (ID: `place:Canaan`); Goat (ID: `fauna:Goat`); Reueli (ID: `person:Reuel.3`); Flock (ID: `fauna:Flock`); Oholibama (ID: `person:Oholibamah`); Tamari (ID: `person:Tamar`); Sala (ID: `person:Shelah`); Ishmaeli (ID: `person:Ishmael`); Tunic (ID: `realia:Tunic.2`); Pit (ID: `realia:Pit`); Sheep (ID: `fauna:Lamb`); Sibeoni (ID: `person:Zibeon.2`); Ana (ID: `person:Anah`); Adullamites (ID: `group:Adullam`); Timna (ID: `place:Timnah`); Kora (ID: `person:Korah`); Yeushi (ID: `person:Jeush`); Yalamu (ID: `person:Jalam`); Onani (ID: `person:Onan`); Ezeri (ID: `person:Ezer`); Eri (ID: `person:Er.2`)
...
* **Associated ACAI Concepts:** Yusufu (ID: `person:Joseph.10`); Farao (ID: `person:Pharaoh.4`); Misri (ID: `place:Egypt`); BWANA (ID: `deity:Lord`); mto (ID: `place:Nile`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Hebrews (ID: `group:Hebrews`); Egyptians (ID: `group:Egypt`); Appoint (ID: `keyterm:Appoint`); To Sin (ID: `keyterm:Sin`); Asenathi (ID: `person:Asenath`); Potifera (ID: `person:Potiphera`); Favor (ID: `keyterm:Favor`); Oni (ID: `place:On`); Kindness (ID: `keyterm:Kindness`); Perceive (ID: `keyterm:Perceive`); Vine (ID: `flora:Vine`); Basket (ID: `realia:Basket`); Manase (ID: `person:Manasseh`); Efraimu (ID: `person:Ephraim`); Potifa (ID: `person:Potiphar`); Ishmaelites (ID: `group:Ishmael`); Bless (ID: `keyterm:Bless`); Ishmaeli (ID: `person:Ishmael`); Peace (ID: `keyterm:IntactState`); Grass (ID: `flora:Grass`); Prison (ID: `realia:Prison`); Linen (ID: `realia:Linen`); Chariot (ID: `realia:Chariot`)
...
* **Associated ACAI Concepts:** Yusufu (ID: `person:Joseph.10`); Misri (ID: `place:Egypt`); Benyamini (ID: `person:Benjamin`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Wakanaani (ID: `place:Canaan`); Yuda (ID: `person:Judah.4`); Farao (ID: `person:Pharaoh.4`); Bag (ID: `realia:Bag`); Money (ID: `realia:Money`); House (ID: `realia:House`); Offering (ID: `keyterm:Offering`); Peace (ID: `keyterm:IntactState`); Donkey (ID: `fauna:Donkey`); Simeoni (ID: `person:Simeon.5`); Hell (ID: `place:Hell`); Fear (ID: `keyterm:Fear`); Reubeni (ID: `person:Reuben`); Egyptians (ID: `group:Egypt`); Gosheni (ID: `place:Goshen`); Exempt (ID: `keyterm:Exempt`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); Well-Established (ID: `keyterm:BeFirm`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); To Sin (ID: `keyterm:Sin`); Hebrews (ID: `group:Hebrews`); Be Poor (ID: `keyterm:Be`); To Beg for Mercy (ID: `keyterm:BegForMercy`)
...
* **Associated ACAI Concepts:** Yusufu (ID: `person:Joseph.10`); Israeli (ID: `person:Israel`); Misri (ID: `place:Egypt`); Farao (ID: `person:Pharaoh.4`); Wakanaani (ID: `place:Canaan`); BWANA (ID: `deity:Lord`); Bless (ID: `keyterm:Bless`); Gosheni (ID: `place:Goshen`); Manase (ID: `person:Manasseh`); Efraimu (ID: `person:Ephraim`); Abrahamu (ID: `person:Abraham`); Yuda (ID: `person:Judah.4`); Isaka (ID: `person:Isaac`); Swear (ID: `keyterm:Swear`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Reubeni (ID: `person:Reuben`); Raheli (ID: `person:Rachel`); Benyamini (ID: `person:Benjamin`); Mhiti (ID: `person:Heth`); Egyptians (ID: `group:Egypt`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Money (ID: `realia:Money`); Dani (ID: `person:Dan`); Simeoni (ID: `person:Simeon.5`); Lea (ID: `person:Leah`); Fear (ID: `keyterm:Fear`); Efroni (ID: `person:Ephron.2`); Favor (ID: `keyterm:Favor`)
