...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Kind (ID: `keyterm:Kind.2`); Adamu (ID: `person:Adam`); Grass (ID: `flora:Grass`); Bless (ID: `keyterm:Bless`); Garden of Eden (ID: `place:Eden.2`); Cattle (ID: `fauna:Bull`); Likeness (ID: `keyterm:Semblance`); Intention (ID: `keyterm:Intention`); Chameleon (ID: `fauna:Chameleon`); Monitor (ID: `fauna:Iguana`); Lizard (ID: `fauna:Lizard`); Coriander (ID: `flora:Coriander`); Barley (ID: `flora:Barley`); Hidekeli (ID: `place:Tigris`); Havila (ID: `place:Havilah`); Gihoni (ID: `place:Gihon`); Kushi (ID: `place:Cush`); Mto (ID: `place:Euphrates`); Fish (ID: `fauna:Fish`); Green Vegetation (ID: `flora:GreenVegetation`); Cush (ID: `place:Cush.2`); Assyria (ID: `place:Assyria`); Holy (ID: `keyterm:Holy`); Dragon (ID: `fauna:Dragon`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Kaini (ID: `person:Cain`); Enoshi (ID: `person:Enosh`); Sethi (ID: `person:Seth`); Adamu (ID: `person:Adam`); Henoko (ID: `person:Enoch.2`); Lameki (ID: `person:Lamech.2`); Mahalaleli (ID: `person:Mahalalel`); Habili (ID: `person:Abel`); Yaredi (ID: `person:Jared`); Methusela (ID: `person:Methuselah`); Kenani (ID: `person:Kenan`); Lameki (ID: `person:Lamech`); Sila (ID: `person:Zillah`); Ada (ID: `person:Adah`); Offering (ID: `keyterm:Offering`); Nuhu (ID: `person:Noah`); Henoko (ID: `person:Enoch`); To Curse (ID: `keyterm:Curse`); Yafethi (ID: `person:Japheth`); Shemu (ID: `person:Shem`); Nodi (ID: `place:Nod`); Mehuyaeli (ID: `person:Mehujael`); Methushaeli (ID: `person:Methushael`); Likeness (ID: `keyterm:Semblance`); Naama (ID: `person:Naamah.2`); Yabali (ID: `person:Jabal`); Hawa (ID: `person:Eve`); Yubali (ID: `person:Jubal`); Iradi (ID: `person:Irad`)
...
* **Associated ACAI Concepts:** Nuhu (ID: `person:Noah`); BWANA (ID: `deity:Lord`); Ship (ID: `realia:Ship`); Dove (ID: `fauna:Dove`); Destroy (ID: `keyterm:Destroy`); Chameleon (ID: `fauna:Chameleon`); Monitor (ID: `fauna:Iguana`); Lizard (ID: `fauna:Lizard`); Cubit (ID: `realia:Cubit`); Yafethi (ID: `person:Japheth`); Shemu (ID: `person:Shem`); Hamu (ID: `person:Ham`); Pure (ID: `keyterm:Pure`); Kind (ID: `keyterm:Kind.2`); Cattle (ID: `fauna:Bull`); Ararati (ID: `place:Ararat`); Nephilim (ID: `group:Nephilim`); Complete (ID: `keyterm:Complete`); Favor (ID: `keyterm:Favor`); Covenant (ID: `keyterm:Covenant`); Crow (ID: `fauna:Crow`); Window (ID: `realia:Window`); Olive Tree (ID: `flora:OliveTree`); Bear (ID: `fauna:Bear`); Lion (ID: `fauna:Lion`); Covering (ID: `realia:Covering`); Bird (ID: `fauna:Bird`); Cypress (ID: `flora:Cypress`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Nuhu (ID: `person:Noah`); Shemu (ID: `person:Shem`); Wakanaani (ID: `person:Canaan`); Eberi (ID: `person:Eber`); Covenant (ID: `keyterm:Covenant`); Tera (ID: `person:Terah`); Harani (ID: `person:Haran`); Yafethi (ID: `person:Japheth`); Arfaksadi (ID: `person:Arpachshad`); Hamu (ID: `person:Ham`); Sala (ID: `person:Shelah.2`); Pelegi (ID: `person:Peleg`); Serugi (ID: `person:Serug`); Abrahamu (ID: `person:Abraham`); Reu (ID: `person:Reu`); Nahori (ID: `person:Nahor`); Yoktani (ID: `person:Joktan`); Kushi (ID: `person:Cush.2`); Wakanaani (ID: `place:Canaan`); Sara (ID: `person:Sarah`); Nahori (ID: `person:Nahor.2`); Ship (ID: `realia:Ship`); Kala (ID: `place:Calah`); Uru (ID: `place:Ur`); Aramu (ID: `person:Aram`); Misri (ID: `person:Egypt`); Nimrodi (ID: `person:Nimrod`); Yavani (ID: `person:Javan`); Lutu (ID: `person:Lot`)
...
* **Associated ACAI Concepts:** Abrahamu (ID: `person:Abraham`); BWANA (ID: `deity:Lord`); Lutu (ID: `person:Lot`); Sodoma (ID: `place:Sodom`); Kedorlaoma (ID: `person:Chedorlaomer`); Misri (ID: `place:Egypt`); Gomora (ID: `place:Gomorrah`); Farao (ID: `person:Pharaoh.3`); Bless (ID: `keyterm:Bless`); Wakanaani (ID: `place:Canaan`); bonde (ID: `place:SiddimValley`); Mamre (ID: `place:Mamre`); Sara (ID: `person:Sarah`); Negebu (ID: `place:Negeb`); Zoar (ID: `place:Zoar`); Goat (ID: `fauna:Goat`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Flock (ID: `fauna:Flock`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Goiim (ID: `group:Goiim`); Aneri (ID: `person:Aner`); Eshkoli (ID: `person:Eshcol`); Tidali (ID: `person:Tidal`); Amrafeli (ID: `person:Amraphel`); Arioko (ID: `person:Arioch`); Elasari (ID: `place:Ellasar`); Elamu (ID: `place:Elam`); mji (ID: `place:Ai`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Abrahamu (ID: `person:Abraham`); Sara (ID: `person:Sarah`); Lutu (ID: `person:Lot`); Covenant (ID: `keyterm:Covenant`); Abimeleki (ID: `person:Abimelech`); Circumcision (ID: `keyterm:Circumcision`); Ishmaeli (ID: `person:Ishmael`); Sodoma (ID: `place:Sodom`); Hajiri (ID: `person:Hagar`); An Angel (ID: `deity:Angel`); Foreskin (ID: `keyterm:Foreskin`); Fear (ID: `keyterm:Fear`); Dispossess (ID: `keyterm:Dispossess`); Tent (ID: `realia:Tent`); Money (ID: `realia:Money`); House (ID: `realia:House`); Gomora (ID: `place:Gomorrah`); Zoar (ID: `place:Zoar`); Wakanaani (ID: `place:Canaan`); Misri (ID: `place:Egypt`); Bless (ID: `keyterm:Bless`); To Sin (ID: `keyterm:Sin`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); Vine (ID: `flora:Vine`); Gerari (ID: `place:Gerar`); Shur (ID: `place:Shur`); Isaka (ID: `person:Isaac`); Force to Serve (ID: `keyterm:EnticedToServe`)
...
* **Associated ACAI Concepts:** Abrahamu (ID: `person:Abraham`); BWANA (ID: `deity:Lord`); Isaka (ID: `person:Isaac`); Sara (ID: `person:Sarah`); Offering (ID: `keyterm:Offering`); Abimeleki (ID: `person:Abimelech`); Beer-sheba (ID: `place:Beersheba`); Sheep (ID: `fauna:Lamb`); Swear (ID: `keyterm:Swear`); An Angel (ID: `deity:Angel`); Hajiri (ID: `person:Hagar`); Fikoli (ID: `person:Phicol`); Bless (ID: `keyterm:Bless`); Bethueli (ID: `person:Bethuel`); Milka (ID: `person:Milcah`); Skin-Bottle (ID: `realia:Skin-bottle`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); Fear (ID: `keyterm:Fear`); Misri (ID: `place:Egypt`); Covenant (ID: `keyterm:Covenant`); Nahori (ID: `person:Nahor.2`); Dispossess (ID: `keyterm:Dispossess`); Aramu (ID: `person:Aram.2`); Teba (ID: `person:Tebah`); Pildashi (ID: `person:Pildash`); Yidlafu (ID: `person:Jidlaph`); Gahamu (ID: `person:Gaham`); Kemueli (ID: `person:Kemuel`); Kesedi (ID: `person:Chesed`)
...
* **Associated ACAI Concepts:** Abrahamu (ID: `person:Abraham`); BWANA (ID: `deity:Lord`); Rebeka (ID: `person:Rebekah`); Isaka (ID: `person:Isaac`); Mhiti (ID: `person:Heth`); Efroni (ID: `person:Ephron.2`); Sara (ID: `person:Sarah`); Bless (ID: `keyterm:Bless`); Ishmaeli (ID: `person:Ishmael`); Camel (ID: `fauna:Camel`); Clay Jar (ID: `realia:ClayJar`); Makpela (ID: `place:Machpelah`); Bethueli (ID: `person:Bethuel`); Nahori (ID: `person:Nahor.2`); Money (ID: `realia:Money`); Swear (ID: `keyterm:Swear`); Kindness (ID: `keyterm:Kindness`); Wakanaani (ID: `place:Canaan`); Mamre (ID: `place:Mamre`); Milka (ID: `person:Milcah`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`); Ketura (ID: `person:Keturah`); Yokshani (ID: `person:Jokshan`); Beer-lahai-roi (ID: `place:Beer-lahai-roi`); Midiani (ID: `person:Midian`); Sohari (ID: `person:Zohar`); Oath (ID: `keyterm:Oath`); Misri (ID: `place:Egypt`); Hebroni (ID: `place:Hebron`)
...
* **Associated ACAI Concepts:** Isaka (ID: `person:Isaac`); Esau (ID: `person:Esau`); Bless (ID: `keyterm:Bless`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`); Rebeka (ID: `person:Rebekah`); Abrahamu (ID: `person:Abraham`); Abimeleki (ID: `person:Abimelech`); Padan-aramu (ID: `place:Paddan-aram`); Gerari (ID: `place:Gerar`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); Labani (ID: `person:Laban`); Love (ID: `keyterm:Love`); Bethueli (ID: `person:Bethuel`); Wakanaani (ID: `place:Canaan`); Force to Serve (ID: `keyterm:EnticedToServe`); Swear (ID: `keyterm:Swear`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Arameans (ID: `group:Aramean`); Oath (ID: `keyterm:Oath`); Fear (ID: `keyterm:Fear`); Beer-sheba (ID: `place:Beersheba`); Mhiti (ID: `person:Heth`); Peace (ID: `keyterm:IntactState`); Vine (ID: `flora:Vine`); Eloni (ID: `person:Elon`); Fikoli (ID: `person:Phicol`); Rehobothi (ID: `place:Rehoboth`)
...
* **Associated ACAI Concepts:** Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`); Esau (ID: `person:Esau`); Shekemu (ID: `person:Shechem`); Hamori (ID: `person:Hamor`); Raheli (ID: `person:Rachel`); Betheli (ID: `place:Bethel`); Dina (ID: `person:Dinah`); Offering (ID: `keyterm:Offering`); Lea (ID: `person:Leah`); Isaka (ID: `person:Isaac`); Favor (ID: `keyterm:Favor`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Bless (ID: `keyterm:Bless`); Circumcision (ID: `keyterm:Circumcision`); Cattle (ID: `fauna:Bull`); Yusufu (ID: `person:Joseph.10`); Seiri (ID: `place:Seir`); Simeoni (ID: `person:Simeon.5`); Walawi (ID: `person:Levi.3`); Abrahamu (ID: `person:Abraham`); Defilement (ID: `keyterm:Defilement`); An Angel (ID: `deity:Angel`); Wakanaani (ID: `place:Canaan`); Padan-aramu (ID: `place:Paddan-aram`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Esau (ID: `person:Esau`); Yuda (ID: `person:Judah.4`); Yusufu (ID: `person:Joseph.10`); Edomu (ID: `place:Edom`); Israeli (ID: `person:Israel`); Elifazi (ID: `person:Eliphaz`); Ada (ID: `person:Adah.2`); Wahori (ID: `person:Hori`); Mahalathi (ID: `person:Mahalath`); Wakanaani (ID: `place:Canaan`); Goat (ID: `fauna:Goat`); Reueli (ID: `person:Reuel.3`); Flock (ID: `fauna:Flock`); Oholibama (ID: `person:Oholibamah`); Sala (ID: `person:Shelah`); Tamari (ID: `person:Tamar`); Ishmaeli (ID: `person:Ishmael`); Tunic (ID: `realia:Tunic.2`); Pit (ID: `realia:Pit`); Sheep (ID: `fauna:Lamb`); Sibeoni (ID: `person:Zibeon.2`); Yeushi (ID: `person:Jeush`); Ana (ID: `person:Anah`); Adullamites (ID: `group:Adullam`); Kora (ID: `person:Korah`); Yalamu (ID: `person:Jalam`); Timna (ID: `place:Timnah`); Dishani (ID: `person:Dishan`); Dishoni (ID: `person:Dishon`); Shobali (ID: `person:Shobal`)
...
* **Associated ACAI Concepts:** Yusufu (ID: `person:Joseph.10`); Farao (ID: `person:Pharaoh.4`); Misri (ID: `place:Egypt`); BWANA (ID: `deity:Lord`); mto (ID: `place:Nile`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Hebrews (ID: `group:Hebrews`); Appoint (ID: `keyterm:Appoint`); Egyptians (ID: `group:Egypt`); To Sin (ID: `keyterm:Sin`); Asenathi (ID: `person:Asenath`); Potifera (ID: `person:Potiphera`); Oni (ID: `place:On`); Favor (ID: `keyterm:Favor`); Kindness (ID: `keyterm:Kindness`); Perceive (ID: `keyterm:Perceive`); Vine (ID: `flora:Vine`); Basket (ID: `realia:Basket`); Efraimu (ID: `person:Ephraim`); Manase (ID: `person:Manasseh`); Potifa (ID: `person:Potiphar`); Bless (ID: `keyterm:Bless`); Ishmaelites (ID: `group:Ishmael`); Peace (ID: `keyterm:IntactState`); Ishmaeli (ID: `person:Ishmael`); Prison (ID: `realia:Prison`); Grass (ID: `flora:Grass`); Chariot (ID: `realia:Chariot`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** Yusufu (ID: `person:Joseph.10`); Israeli (ID: `person:Israel`); Misri (ID: `place:Egypt`); Farao (ID: `person:Pharaoh.4`); Wakanaani (ID: `place:Canaan`); BWANA (ID: `deity:Lord`); Bless (ID: `keyterm:Bless`); Gosheni (ID: `place:Goshen`); Manase (ID: `person:Manasseh`); Efraimu (ID: `person:Ephraim`); Abrahamu (ID: `person:Abraham`); Yuda (ID: `person:Judah.4`); Isaka (ID: `person:Isaac`); Swear (ID: `keyterm:Swear`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Raheli (ID: `person:Rachel`); Mhiti (ID: `person:Heth`); Reubeni (ID: `person:Reuben`); Egyptians (ID: `group:Egypt`); Benyamini (ID: `person:Benjamin`); Cattle (ID: `fauna:Bull`); Money (ID: `realia:Money`); Sheep (ID: `fauna:Lamb`); Dani (ID: `person:Dan`); Simeoni (ID: `person:Simeon.5`); Lea (ID: `person:Leah`); Efroni (ID: `person:Ephron.2`); Fear (ID: `keyterm:Fear`); Favor (ID: `keyterm:Favor`)
