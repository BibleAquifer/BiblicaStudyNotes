...
* **Associated Articles:** Ukoo (ID: `367711@BiblicaStudyNotesKeyTerms`); Abeli (ID: `367712@BiblicaStudyNotesKeyTerms`); Kaini (ID: `367713@BiblicaStudyNotesKeyTerms`); Mauaji (ID: `367714@BiblicaStudyNotesKeyTerms`); Sethi (ID: `367715@BiblicaStudyNotes`); Jina (ID: `367716@BiblicaStudyNotes`); Bwana (ID: `367717@BiblicaStudyNotes`); Sala (ID: `367718@BiblicaStudyNotes`); Henoko (ID: `367719@BiblicaStudyNotesKeyTerms`); Mungu huchagua (ID: `367720@BiblicaStudyNotesKeyTerms`); Nohu (ID: `367721@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Kaini (ID: `person:Cain`); Enoshi (ID: `person:Enosh`); Sethi (ID: `person:Seth`); Adamu (ID: `person:Adam`); Henoko (ID: `person:Enoch.2`); Yaredi (ID: `person:Jared`); Methusela (ID: `person:Methuselah`); Habili (ID: `person:Abel`); Lameki (ID: `person:Lamech.2`); Mahalaleli (ID: `person:Mahalalel`); Kenani (ID: `person:Kenan`); Lameki (ID: `person:Lamech`); Ada (ID: `person:Adah`); Sila (ID: `person:Zillah`); Offering (ID: `keyterm:Offering`); Nuhu (ID: `person:Noah`); Henoko (ID: `person:Enoch`); To Curse (ID: `keyterm:Curse`); Nodi (ID: `place:Nod`); To Sin (ID: `keyterm:Sin`); Yubali (ID: `person:Jubal`); Iradi (ID: `person:Irad`); Naama (ID: `person:Naamah.2`); Yafethi (ID: `person:Japheth`); Tubal-kaini (ID: `person:Tubal-cain`); Mehuyaeli (ID: `person:Mehujael`); Shemu (ID: `person:Shem`); Yabali (ID: `person:Jabal`); Likeness (ID: `keyterm:Semblance`)
...
* **Associated ACAI Concepts:** Nuhu (ID: `person:Noah`); BWANA (ID: `deity:Lord`); Ship (ID: `realia:Ship`); Dove (ID: `fauna:Dove`); Destroy (ID: `keyterm:Destroy`); Monitor (ID: `fauna:Iguana`); Chameleon (ID: `fauna:Chameleon`); Lizard (ID: `fauna:Lizard`); Cubit (ID: `realia:Cubit`); Hamu (ID: `person:Ham`); Yafethi (ID: `person:Japheth`); Pure (ID: `keyterm:Pure`); Kind (ID: `keyterm:Kind.2`); Shemu (ID: `person:Shem`); Cattle (ID: `fauna:Bull`); Nephilim (ID: `group:Nephilim`); Ararati (ID: `place:Ararat`); Complete (ID: `keyterm:Complete`); Favor (ID: `keyterm:Favor`); Covenant (ID: `keyterm:Covenant`); Crow (ID: `fauna:Crow`); Window (ID: `realia:Window`); Olive Tree (ID: `flora:OliveTree`); Bird (ID: `fauna:Bird`); Cypress (ID: `flora:Cypress`); Lion (ID: `fauna:Lion`); Covering (ID: `realia:Covering`); Bear (ID: `fauna:Bear`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Nuhu (ID: `person:Noah`); Shemu (ID: `person:Shem`); Wakanaani (ID: `person:Canaan`); Eberi (ID: `person:Eber`); Tera (ID: `person:Terah`); Covenant (ID: `keyterm:Covenant`); Harani (ID: `person:Haran`); Yafethi (ID: `person:Japheth`); Arfaksadi (ID: `person:Arpachshad`); Hamu (ID: `person:Ham`); Pelegi (ID: `person:Peleg`); Sala (ID: `person:Shelah.2`); Abrahamu (ID: `person:Abraham`); Nahori (ID: `person:Nahor`); Reu (ID: `person:Reu`); Serugi (ID: `person:Serug`); Kushi (ID: `person:Cush.2`); Wakanaani (ID: `place:Canaan`); Yoktani (ID: `person:Joktan`); Nahori (ID: `person:Nahor.2`); Sara (ID: `person:Sarah`); Ship (ID: `realia:Ship`); Nimrodi (ID: `person:Nimrod`); Kala (ID: `place:Calah`); Yavani (ID: `person:Javan`); Aramu (ID: `person:Aram`); Misri (ID: `person:Egypt`); Uru (ID: `place:Ur`); Gomeri (ID: `person:Gomer`)
...
* **Associated ACAI Concepts:** Abrahamu (ID: `person:Abraham`); BWANA (ID: `deity:Lord`); Lutu (ID: `person:Lot`); Sodoma (ID: `place:Sodom`); Kedorlaoma (ID: `person:Chedorlaomer`); Misri (ID: `place:Egypt`); Gomora (ID: `place:Gomorrah`); Farao (ID: `person:Pharaoh.3`); Wakanaani (ID: `place:Canaan`); Bless (ID: `keyterm:Bless`); bonde (ID: `place:SiddimValley`); Sara (ID: `person:Sarah`); Negebu (ID: `place:Negeb`); Mamre (ID: `place:Mamre`); Zoar (ID: `place:Zoar`); Goat (ID: `fauna:Goat`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Flock (ID: `fauna:Flock`); Arioko (ID: `person:Arioch`); Amrafeli (ID: `person:Amraphel`); Elasari (ID: `place:Ellasar`); Aneri (ID: `person:Aner`); Eshkoli (ID: `person:Eshcol`); Goiim (ID: `group:Goiim`); Tidali (ID: `person:Tidal`); Betheli (ID: `place:Bethel`); Elamu (ID: `place:Elam`)
...
* **Associated ACAI Concepts:** Abrahamu (ID: `person:Abraham`); BWANA (ID: `deity:Lord`); Isaka (ID: `person:Isaac`); Sara (ID: `person:Sarah`); Offering (ID: `keyterm:Offering`); Abimeleki (ID: `person:Abimelech`); Beer-sheba (ID: `place:Beersheba`); Sheep (ID: `fauna:Lamb`); Swear (ID: `keyterm:Swear`); Hajiri (ID: `person:Hagar`); An Angel (ID: `deity:Angel`); Fikoli (ID: `person:Phicol`); Bless (ID: `keyterm:Bless`); Milka (ID: `person:Milcah`); Bethueli (ID: `person:Bethuel`); Skin-Bottle (ID: `realia:Skin-bottle`); Dispossess (ID: `keyterm:Dispossess`); Nahori (ID: `person:Nahor.2`); Wafilisti (ID: `place:Philistine`); Misri (ID: `place:Egypt`); Fear (ID: `keyterm:Fear`); Covenant (ID: `keyterm:Covenant`); Wafilisti (ID: `group:Philistine`); Tahashi (ID: `person:Tahash`); Gahamu (ID: `person:Gaham`); Reuma (ID: `person:Reumah`); Teba (ID: `person:Tebah`); Parani (ID: `place:Paran`); Pildashi (ID: `person:Pildash`); Kesedi (ID: `person:Chesed`)
...
* **Associated ACAI Concepts:** Abrahamu (ID: `person:Abraham`); BWANA (ID: `deity:Lord`); Rebeka (ID: `person:Rebekah`); Isaka (ID: `person:Isaac`); Mhiti (ID: `person:Heth`); Efroni (ID: `person:Ephron.2`); Sara (ID: `person:Sarah`); Bless (ID: `keyterm:Bless`); Ishmaeli (ID: `person:Ishmael`); Camel (ID: `fauna:Camel`); Clay Jar (ID: `realia:ClayJar`); Makpela (ID: `place:Machpelah`); Nahori (ID: `person:Nahor.2`); Bethueli (ID: `person:Bethuel`); Money (ID: `realia:Money`); Wakanaani (ID: `place:Canaan`); Swear (ID: `keyterm:Swear`); Kindness (ID: `keyterm:Kindness`); Mamre (ID: `place:Mamre`); Milka (ID: `person:Milcah`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`); Yokshani (ID: `person:Jokshan`); Beer-lahai-roi (ID: `place:Beer-lahai-roi`); Ketura (ID: `person:Keturah`); Sohari (ID: `person:Zohar`); Midiani (ID: `person:Midian`); Hebroni (ID: `place:Hebron`); Oath (ID: `keyterm:Oath`); Misri (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** Isaka (ID: `person:Isaac`); Esau (ID: `person:Esau`); Bless (ID: `keyterm:Bless`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`); Rebeka (ID: `person:Rebekah`); Abrahamu (ID: `person:Abraham`); Abimeleki (ID: `person:Abimelech`); Gerari (ID: `place:Gerar`); Padan-aramu (ID: `place:Paddan-aram`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Love (ID: `keyterm:Love`); Labani (ID: `person:Laban`); Bethueli (ID: `person:Bethuel`); Swear (ID: `keyterm:Swear`); Force to Serve (ID: `keyterm:EnticedToServe`); Wakanaani (ID: `place:Canaan`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Arameans (ID: `group:Aramean`); Oath (ID: `keyterm:Oath`); Peace (ID: `keyterm:IntactState`); Mhiti (ID: `person:Heth`); Fear (ID: `keyterm:Fear`); Beer-sheba (ID: `place:Beersheba`); Vine (ID: `flora:Vine`); Sitna (ID: `place:Sitnah`); Judith (ID: `person:Judith`); Beeri (ID: `person:Beeri`)
...
* **Associated ACAI Concepts:** Israeli (ID: `person:Israel`); Labani (ID: `person:Laban`); BWANA (ID: `deity:Lord`); Raheli (ID: `person:Rachel`); Lea (ID: `person:Leah`); Force to Serve (ID: `keyterm:EnticedToServe`); Bilha (ID: `person:Bilhah`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Zilpa (ID: `person:Zilpah`); Love (ID: `keyterm:Love`); Bless (ID: `keyterm:Bless`); Isaka (ID: `person:Isaac`); Gileadi (ID: `place:Gilead`); kinyago (ID: `deity:Teraphim`); Yegarsahadutha (ID: `place:Jegar-sahadutha`); Abrahamu (ID: `person:Abraham`); Padan-aramu (ID: `place:Paddan-aram`); Work (ID: `keyterm:Work`); Reubeni (ID: `person:Reuben`); Betheli (ID: `place:Bethel`); Arameans (ID: `group:Aramean`); Vow (ID: `keyterm:Vow`); Nahori (ID: `person:Nahor.2`); Harani (ID: `place:Haran`); Peace (ID: `keyterm:IntactState`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Yusufu (ID: `person:Joseph.10`)
...
* **Associated ACAI Concepts:** Yusufu (ID: `person:Joseph.10`); Israeli (ID: `person:Israel`); Misri (ID: `place:Egypt`); Farao (ID: `person:Pharaoh.4`); Wakanaani (ID: `place:Canaan`); BWANA (ID: `deity:Lord`); Bless (ID: `keyterm:Bless`); Gosheni (ID: `place:Goshen`); Efraimu (ID: `person:Ephraim`); Manase (ID: `person:Manasseh`); Abrahamu (ID: `person:Abraham`); Yuda (ID: `person:Judah.4`); Swear (ID: `keyterm:Swear`); Isaka (ID: `person:Isaac`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Benyamini (ID: `person:Benjamin`); Raheli (ID: `person:Rachel`); Reubeni (ID: `person:Reuben`); Mhiti (ID: `person:Heth`); Egyptians (ID: `group:Egypt`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Money (ID: `realia:Money`); Dani (ID: `person:Dan`); Lea (ID: `person:Leah`); Simeoni (ID: `person:Simeon.5`); Fear (ID: `keyterm:Fear`); Favor (ID: `keyterm:Favor`); Efroni (ID: `person:Ephron.2`)
