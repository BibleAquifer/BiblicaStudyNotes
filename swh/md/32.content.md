...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yona (ID: `person:Jonah.2`); Ninawi (ID: `place:Nineveh`); Fear (ID: `keyterm:Fear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Sackcloth (ID: `realia:Sackcloth`); Hell (ID: `place:Hell`); Vow (ID: `keyterm:Vow`); Amitai (ID: `person:Amittai`); Yafa (ID: `place:Joppa`); Cattle (ID: `fauna:Bull`); Salvation (ID: `keyterm:Salvation`); Kindness (ID: `keyterm:Kindness`); Slaughtering (ID: `keyterm:Slaughtering`); Exempt (ID: `keyterm:Exempt`); Tarshishi (ID: `place:Tarshish`); Believe In (ID: `keyterm:BelieveIn`); Praise (ID: `keyterm:Praise`); Hebrews (ID: `group:Hebrews`); Lot (ID: `keyterm:Lot`); Goat (ID: `fauna:Goat`); Clothing (ID: `realia:Clothing`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yona (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Kindness (ID: `keyterm:Kindness`); Generous (ID: `keyterm:Generous`); Tarshishi (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`); Ninawi (ID: `place:Nineveh`); Worm (ID: `fauna:Maggot`); Cattle (ID: `fauna:Bull`)
