...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yona (ID: `person:Jonah.2`); Ninawi (ID: `place:Nineveh`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Sackcloth (ID: `realia:Sackcloth`); Fish (ID: `fauna:Fish`); Hell (ID: `place:Hell`); Vow (ID: `keyterm:Vow`); Amitai (ID: `person:Amittai`); Yafa (ID: `place:Joppa`); Cattle (ID: `fauna:Bull`); Exempt (ID: `keyterm:Exempt`); Praise (ID: `keyterm:Praise`); Hebrews (ID: `group:Hebrews`); Slaughtering (ID: `keyterm:Slaughtering`); Believe In (ID: `keyterm:BelieveIn`); Lot (ID: `keyterm:Lot`); Salvation (ID: `keyterm:Salvation`); Tarshishi (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Goat (ID: `fauna:Goat`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Cattails (ID: `flora:Cattails`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yona (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Ninawi (ID: `place:Nineveh`); Generous (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); Tarshishi (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Cattle (ID: `fauna:Bull`); Worm (ID: `fauna:Maggot`)
