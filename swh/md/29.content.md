...
* **Associated ACAI Concepts:** Pethueli (ID: `person:Pethuel`); Yoeli (ID: `person:Joel.14`); Locust (ID: `fauna:Locust`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** bonde (ID: `place:ShittimValley`); Pruning Knife (ID: `realia:PruningKnife`); Sabeans (ID: `group:Sabean`); Greeks (ID: `group:Greek`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Yerusalemu (ID: `place:Jerusalem`); BWANA (ID: `deity:Lord`)
