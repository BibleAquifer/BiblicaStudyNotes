...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Offering (ID: `keyterm:Offering`); Fig (ID: `flora:Fig`); Sackcloth (ID: `realia:Sackcloth`); Grain (ID: `flora:Grain`); Must (ID: `realia:Must`); Pethueli (ID: `person:Pethuel`); Yoeli (ID: `person:Joel.14`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Holy (ID: `keyterm:Holy`); Locust (ID: `fauna:Locust`); Date Palm (ID: `flora:DatePalm`); Pomegranate (ID: `flora:Pomegranate`); Cattle (ID: `fauna:Bull`); Stone Altar (ID: `realia:StoneAltar`); Goat (ID: `fauna:Goat`); Lion (ID: `fauna:Lion`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Flock (ID: `fauna:Flock`); Wheat (ID: `flora:Wheat`); Anointing Oil (ID: `realia:AnointingOil`); Barn (ID: `realia:Barn`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Grass (ID: `flora:Grass`); Barley (ID: `flora:Barley`); Olive Oil (ID: `realia:OliveOil`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Yerusalemu (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Holy (ID: `keyterm:Holy`); Rams Horn (ID: `realia:RamsHorn`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Must (ID: `realia:Must`); Olive Oil (ID: `realia:OliveOil`); Offering (ID: `keyterm:Offering`); Kindness (ID: `keyterm:Kindness`); To Cause to Possess (ID: `keyterm:Possess`); Bless (ID: `keyterm:Bless`); Be Zealous (ID: `keyterm:Zealous`); Garden of Eden (ID: `place:Eden.2`); Compassionate (ID: `keyterm:Compassionate`); Generous (ID: `keyterm:Generous`); Israeli (ID: `person:Israel`); Wine (ID: `realia:Wine`); Locust (ID: `fauna:Locust`); Winepress (ID: `realia:Winepress`); Threshing Floor (ID: `realia:ThreshingFloor`); Fig (ID: `flora:Fig`); Stone Altar (ID: `realia:StoneAltar`); House (ID: `realia:House`); Chariot (ID: `realia:Chariot`); Grain (ID: `flora:Grain`); Temple Altar (ID: `realia:TempleAltar`); Weapons (ID: `realia:Weapons`); Window (ID: `realia:Window`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Horse (ID: `fauna:Horse`); Grass (ID: `flora:Grass`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Kidroni (ID: `place:Kidron`); Israeli (ID: `person:Israel`); Greeks (ID: `group:Greek`); Sabeans (ID: `group:Sabean`); bonde (ID: `place:ShittimValley`); A Man (ID: `person:GenericMale`); To Cause to Possess (ID: `keyterm:Possess`); Symbol (ID: `keyterm:Example`); Wafilisti (ID: `place:Philistine`); Exempt (ID: `keyterm:Exempt`); Fear (ID: `keyterm:Fear`); Sheba (ID: `person:Sheba`); Misri (ID: `place:Egypt`); Yavani (ID: `person:Javan`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); Edomu (ID: `place:Edom`); Lot (ID: `keyterm:Lot`); Gentiles (ID: `group:Gentile`); Wasidoni (ID: `place:Sidon`); Refuge (ID: `keyterm:Refuge`); Tiro (ID: `place:Tyre`); Speak as a Prophet (ID: `keyterm:Speak`); Holy (ID: `keyterm:Holy`); Pruning Knife (ID: `realia:PruningKnife`); Wine (ID: `realia:Wine`); Mattock (ID: `realia:Mattock`); Fortress (ID: `realia:Fortress`); Winepress (ID: `realia:Winepress`); Money (ID: `realia:Money`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Sickle (ID: `realia:Sickle`); Spear (ID: `realia:Spear`); Sword (ID: `realia:Sword`)
