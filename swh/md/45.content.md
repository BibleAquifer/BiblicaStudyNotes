...
* **Associated ACAI Concepts:** Long For (ID: `keyterm:LongFor`); Beloved (ID: `keyterm:Beloved`); Believe (ID: `keyterm:Believe`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Unjust Deed (ID: `keyterm:UnjustDeed`); Creeping Animal (ID: `fauna:CreepingAnimal`); Divine (ID: `keyterm:Divine`); Imperishable (ID: `keyterm:Imperishable`); Worship (ID: `keyterm:Worship`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Decided (ID: `keyterm:Decided`); Judgment (ID: `keyterm:Judgment`); Partiality (ID: `keyterm:Partiality`); Condemn (ID: `keyterm:Condemn`); Conscience (ID: `keyterm:Conscience`); Kindness (ID: `keyterm:Kindness`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Law (ID: `keyterm:Law`); Cobra (ID: `fauna:Cobra`); Disbelieve (ID: `keyterm:Disbelieve`); Unjust Deed (ID: `keyterm:UnjustDeed`); True (ID: `keyterm:True`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Believe (ID: `keyterm:Believe`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Promise (ID: `keyterm:Promise`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Abrahamu (ID: `person:Abraham`); Believe (ID: `keyterm:Believe`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Reconcile (ID: `keyterm:Reconcile`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Life (ID: `keyterm:Life`); Consecration (ID: `keyterm:Consecration.2`); Baptism (ID: `keyterm:Baptism`); Be Enslaved (ID: `keyterm:Serve.2`); Live (ID: `keyterm:Live.3`); To Sin (ID: `keyterm:Sin`); Favor (ID: `keyterm:Favor`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Spirit (ID: `keyterm:Spirit.2`); In Christ (ID: `keyterm:InChrist`); Enslavement (ID: `keyterm:Slavery`); Make Alive (ID: `keyterm:Alive`); Regulations (ID: `keyterm:Regulations`); Think (ID: `keyterm:Think`); Body (ID: `keyterm:Body.3`); Roho (ID: `deity:HolySpirit`); Life (ID: `keyterm:Life`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Chosen (ID: `keyterm:Chosen`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Mercy (ID: `keyterm:Mercy`); Farao (ID: `person:Pharaoh.6`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Stumbling Block (ID: `keyterm:StumblingBlock`); Hosea (ID: `person:Hosea`); Stumble (ID: `keyterm:Stumble`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Heart (ID: `keyterm:Heart`); Believe (ID: `keyterm:Believe`); Call Upon (ID: `keyterm:CallUpon`); Isaya (ID: `person:Isaiah`); Extremely (ID: `keyterm:Extremely`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Olive Tree (ID: `flora:OliveTree`); Stumble (ID: `keyterm:Stumble`); Trap (ID: `realia:Trap`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Discern (ID: `keyterm:Discern`); Approved (ID: `keyterm:Approved`); Honest (ID: `keyterm:Honest`); Judgment Seat (ID: `realia:JudgmentSeat`); Building Up (ID: `keyterm:BuildingUp`); Kingdom (ID: `keyterm:Kingdom`); Decided (ID: `keyterm:Decided`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hope (ID: `keyterm:Hope`); Minister (ID: `keyterm:Servant`); Gentiles (ID: `group:Gentile`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Spania (ID: `place:Spain`); Iliriko (ID: `place:Illyricum`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Herodioni (ID: `person:Herodion`); Flegoni (ID: `person:Phlegon`); Fibi (ID: `person:Phoebe`); Stakisi (ID: `person:Stachys`); Herma (ID: `person:Hermas`); Yulia (ID: `person:Julia`); Asinkrito (ID: `person:Asyncritus`); Nerea (ID: `person:Nereus`); Urbano (ID: `person:Urbanus`); Olimpa (ID: `person:Olympas`); Apele (ID: `person:Apelles`); Trifaina (ID: `person:Tryphaena`); Trifosa (ID: `person:Tryphosa`); Filologo (ID: `person:Philologus`); Mariamu (ID: `person:Mary.6`); Rufo (ID: `person:Rufus.2`); Epaineto (ID: `person:Epaenetus`); Androniko (ID: `person:Andronicus`); mwa (ID: `person:Narcissus`); Herme (ID: `person:Hermes`); Ampliato (ID: `person:Ampliatus`); Patroba (ID: `person:Patrobas`); Yunia (ID: `person:Junia`); Persisi (ID: `person:Persis`); Aristobulo (ID: `person:Aristobulus`); Beloved (ID: `keyterm:Beloved`); Kenkrea (ID: `place:Cenchreae`); Priskila (ID: `person:Priscilla`); Akila (ID: `person:Aquila`); Asia (ID: `place:Asia`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Tertio (ID: `person:Tertius`); Kwarto (ID: `person:Quartus`); Sopatro (ID: `person:Sopater`); Gayo (ID: `person:Gaius.3`); Erasto (ID: `person:Erastus`); Yasoni (ID: `person:Jason`); Yesu (ID: `person:Jesus.2`)
