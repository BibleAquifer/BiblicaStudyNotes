...
* **Associated ACAI Concepts:** Eliudi (ID: `person:Eliud`); Yakobo (ID: `person:Jacob.2`); Azori (ID: `person:Azor`); Matani (ID: `person:Matthan`); Sadoki (ID: `person:Zadok`); Eleazari (ID: `person:Eleazar`); Abihudi (ID: `person:Abiud`); Akimu (ID: `person:Achim`); Eliakimu (ID: `person:Eliakim`); Ramu (ID: `person:Ram`); Salmoni (ID: `person:Salmon`); Daudi (ID: `person:David`); Yesu (ID: `person:Jesus.2`); Yekonia (ID: `person:Jehoiachin`); Zerubabeli (ID: `person:Zerubbabel.2`); Uzia (ID: `person:Uzziah`); Yosia (ID: `person:Josiah`); Asa (ID: `person:Asa`); Hezekia (ID: `person:Hezekiah`); Sulemani (ID: `person:Solomon`); Obedi (ID: `person:Obed`); Tamari (ID: `person:Tamar`); Rahabu (ID: `person:Rahab`); Aminadabu (ID: `person:Amminadab`); Nashoni (ID: `person:Nahshon`); Zera (ID: `person:Zerah.3`); Hesroni (ID: `person:Hezron.2`); Yusufu (ID: `person:Joseph.4`); Peresi (ID: `person:Perez`); Amoni (ID: `person:Amon.3`); Abiya (ID: `person:Abijah.4`); Yothamu (ID: `person:Jotham.2`); Yehoramu (ID: `person:Jehoram`); Uria (ID: `person:Uriah`); Boazi (ID: `person:Boaz`); Ahazi (ID: `person:Ahaz`); Rehoboamu (ID: `person:Rehoboam`); Yehoshafati (ID: `person:Jehoshaphat.3`); Isaka (ID: `person:Isaac`); Israeli (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Yusufu (ID: `person:Joseph.4`); Yesu (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); Mariamu (ID: `person:Mary`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** Herode (ID: `person:Herod`); Bethlehemu (ID: `place:Bethlehem`); Arkelao (ID: `person:Archelaus`); Misri (ID: `place:Egypt`); Bow Down (ID: `keyterm:BowDown`); Yusufu (ID: `person:Joseph.4`); Money Box (ID: `realia:MoneyBox`); Myrrh (ID: `realia:Myrrh`); Frankincense (ID: `flora:Frankincense`); Nazareti (ID: `place:Nazareth`); Myrrh (ID: `flora:Myrrh`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Yeremia (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** Yudea (ID: `place:Judea`); Yohana (ID: `person:John`); Winnowing Fork (ID: `realia:WinnowingFork`); Baptist (ID: `keyterm:Baptist`); Sandal (ID: `realia:Sandal`); Belt (ID: `realia:Belt`); Leather (ID: `realia:Leather`); Threshing Floor (ID: `realia:ThreshingFloor`); Locust (ID: `fauna:Locust`); Isaya (ID: `person:Isaiah`)
...
* **Associated ACAI Concepts:** Baptism (ID: `keyterm:Baptism`); Dove (ID: `fauna:Dove`); Yordani (ID: `place:Jordan`)
...
* **Associated ACAI Concepts:** Galilaya (ID: `place:Galilee`); Nazareti (ID: `place:Nazareth`); Proclaim (ID: `keyterm:Proclaim`); Repent (ID: `keyterm:Repent`)
...
* **Associated ACAI Concepts:** Fishnet (ID: `realia:Fishnet`); Dekapoli (ID: `place:Decapolis`); Galilaya (ID: `place:Galilee`); Sea of Galilee (ID: `place:GalileeSea`); Zebedayo (ID: `person:Zebedee`); Andrea (ID: `person:Andrew`); Yakobo (ID: `person:James`); Yohana (ID: `person:John.2`); Synagogue (ID: `realia:Synagogue`); Good News (ID: `keyterm:GoodNews`)
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); Forgive (ID: `keyterm:Forgive`); Sky (ID: `keyterm:Heaven`); Inner Room (ID: `realia:InnerRoom`); Bring In (ID: `keyterm:BringIn`); Kingdom (ID: `keyterm:Kingdom`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Abstain from Food (ID: `keyterm:Fast`); Oven (ID: `realia:Oven`); Moth (ID: `fauna:Moth`); Clothing (ID: `realia:Clothing`); Cubit (ID: `realia:Cubit.2`); Having Little Faith (ID: `keyterm:HavingLittleFaith`); Wild Flower (ID: `flora:WildFlower`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Tax Collector (ID: `keyterm:TaxCollector`); Patch (ID: `realia:Patch`); Mathayo (ID: `person:Matthew`); Must (ID: `realia:Must`); Mercy (ID: `keyterm:Mercy`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Tassel (ID: `realia:Tassel`); Affection (ID: `keyterm:Affection`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Zelote (ID: `group:Zealot`); Bag (ID: `realia:Bag`); Simoni (ID: `person:Simon.2`); Bartholomayo (ID: `person:Bartholomew`); Alfayo (ID: `person:Alphaeus`); Yakobo (ID: `person:James.2`); Yuda (ID: `person:Judas`); Tomaso (ID: `person:Thomas`); Filipo (ID: `person:Philip`); Yuda (ID: `person:Judas.2`); Make Peace (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** Baptist (ID: `keyterm:Baptist`); Reed (ID: `flora:Reed`); Yohana (ID: `person:John`)
...
* **Associated ACAI Concepts:** Korazini (ID: `place:Chorazin`); Yoke (ID: `realia:Yoke`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Disaster (ID: `keyterm:Disaster`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** Yona (ID: `person:Jonah.2`); Ninawi (ID: `group:Nineveh`); Symbol (ID: `keyterm:Example`); malkia (ID: `person:QueenOfSheba`)
...
* **Associated ACAI Concepts:** Herode (ID: `person:Herod.2`); Herodia (ID: `person:Herodias`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Filipo (ID: `person:Philip.2`); Simoni (ID: `person:Simon.3`); Prison (ID: `realia:Prison`); Yuda (ID: `person:Jude`); Yakobo (ID: `person:James.3`); Disbelieve (ID: `keyterm:Disbelieve`); Yohana (ID: `person:John`)
...
* **Associated ACAI Concepts:** Genesareti (ID: `place:Gennesaret`); Having Little Faith (ID: `keyterm:HavingLittleFaith`); Cheer Up (ID: `keyterm:CheerUp`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Syrophonecian Woman (ID: `person:SyrophonecianWoman`); Dog (ID: `fauna:Dog`); Wasidoni (ID: `place:Sidon`); Tiro (ID: `place:Tyre`)
...
* **Associated ACAI Concepts:** Magadani (ID: `place:Magadan`)
...
* **Associated ACAI Concepts:** Petro (ID: `person:Peter`); vya (ID: `place:CaesareaPhilippi`); Key (ID: `realia:Key`); Church (ID: `keyterm:Church`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Eliya (ID: `person:Elijah`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Stater (ID: `realia:Stater`); Two-Drachma Piece (ID: `realia:Two-drachmaPiece`); Fishhook (ID: `realia:Fishhook`); Mustard (ID: `flora:Mustard`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Yerusalemu (ID: `place:Jerusalem`); Serve (ID: `keyterm:Serve`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); Hosanna (ID: `keyterm:Hosanna`); Yerusalemu (ID: `place:Jerusalem`); Seat (ID: `realia:Seat`); Bethfage (ID: `place:Bethphage`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Herodians (ID: `group:Herodian`); Sadducees (ID: `group:Sadducee`); Denarius (ID: `realia:Denarius`); Money (ID: `realia:Money`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Dill (ID: `flora:Dill`); Phylactery (ID: `realia:Phylactery`); Mint (ID: `flora:Mint`); Gehenna (ID: `keyterm:Gehenna`); Zekaria (ID: `person:Zechariah.12`); Seat (ID: `realia:Seat`); Cumin (ID: `flora:Cumin`); Mosquito (ID: `fauna:Mosquito`); Plate (ID: `realia:Plate.2`); Hypocrisy (ID: `keyterm:Hypocrisy`); Clean (ID: `keyterm:Clean`); Yehoyada (ID: `person:Jehoiada.2`); Disaster (ID: `keyterm:Disaster`); Pharisees (ID: `group:Pharisee`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Nuhu (ID: `person:Noah`); Inner Room (ID: `realia:InnerRoom`); Housetop (ID: `realia:Housetop`); Vulture (ID: `fauna:Vulture`); Trumpet (ID: `realia:Trumpet`); Danieli (ID: `person:Daniel.3`); Faithfulness (ID: `keyterm:Faithfulness`); Sky (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** Simoni (ID: `person:Simon.4`); Alabaster Jar (ID: `realia:AlabasterJar`); Bethania (ID: `place:Bethany`); Yuda (ID: `person:Judas.2`)
...
* **Associated ACAI Concepts:** To Cause to Happen (ID: `keyterm:Happen`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Kayafa (ID: `person:Caiaphas`); Courtyard (ID: `realia:Courtyard`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Akeldama (ID: `place:Akeldama`); Korbani (ID: `place:Corban`); Pilato (ID: `person:Pilate`)
...
* **Associated ACAI Concepts:** Judgment Seat (ID: `realia:JudgmentSeat`); Baraba (ID: `person:Barabbas`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Simoni (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); Mkirene (ID: `place:Cyrene`); Crown (ID: `realia:Crown.2`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Crown (ID: `realia:Crown`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Mariamu (ID: `person:Mary.2`); Yusufu (ID: `person:Joseph.6`); Yusufu (ID: `person:Joseph.5`); Yakobo (ID: `person:James.4`); Mariamu (ID: `person:Marymagdalene`); Arimathaya (ID: `place:Arimathea`); Sour Wine (ID: `realia:SourWine`); Zebedayo (ID: `person:Zebedee`); Seal (ID: `realia:Seal`); Curtain (ID: `realia:Curtain`); Reed (ID: `flora:Reed`); Yesu (ID: `person:Jesus.2`)
