...
* **Associated Articles:** Mungu (ID: `367690@BiblicaStudyNotesKeyTerms`); Shairi (ID: `367695@BiblicaStudyNotesKeyTerms`); Yesu (ID: `367710@BiblicaStudyNotesKeyTerms`); Sala (ID: `367718@BiblicaStudyNotesKeyTerms`); Hukumu (ID: `367724@BiblicaStudyNotesKeyTerms`); Sara (ID: `367738@BiblicaStudyNotesKeyTerms`); Rebeka (ID: `367757@BiblicaStudyNotesKeyTerms`); Raheli (ID: `367767@BiblicaStudyNotesKeyTerms`); Wake (ID: `367768@BiblicaStudyNotesKeyTerms`); Bwana - Mtawala (ID: `367820@BiblicaStudyNotesKeyTerms`); Mfalme (ID: `367821@BiblicaStudyNotesKeyTerms`); Hema takatifu (ID: `367825@BiblicaStudyNotesKeyTerms`); Kuwekwa kando (ID: `367849@BiblicaStudyNotes`); Aliyepakwa mafuta (ID: `367851@BiblicaStudyNotesKeyTerms`); Wanadhiri (ID: `367875@BiblicaStudyNotesKeyTerms`); Unabii (ID: `367890@BiblicaStudyNotesKeyTerms`); Watu wenye mahitaji (ID: `367909@BiblicaStudyNotesKeyTerms`); Samsoni (ID: `367930@BiblicaStudyNotesKeyTerms`); Hana (ID: `367941@BiblicaStudyNotesKeyTerms`); Eli (ID: `367942@BiblicaStudyNotesKeyTerms`); Samweli (ID: `367943@BiblicaStudyNotesKeyTerms`); Shilo (ID: `367944@BiblicaStudyNotesKeyTerms`); Maryamu wa Nazareti (ID: `367945@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Hana (ID: `person:Hannah`); Eli (ID: `person:Eli`); Elkana (ID: `person:Elkanah.2`); Rama (ID: `place:Ramah`); House (ID: `realia:House`); Shilo (ID: `place:Shiloh`); Penina (ID: `person:Peninnah`); Vow (ID: `keyterm:Vow`); Horn (ID: `keyterm:Horn`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Tohu (ID: `person:Tohu`); Finehasi (ID: `person:Phinehas.2`); Samweli (ID: `person:Samuel`); Sufu (ID: `person:Zuph`); Yerohamu (ID: `person:Jeroham`); Elihu (ID: `person:Elihu`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Loyal Person (ID: `keyterm:LoyalPerson`); Efraimu (ID: `person:Ephraim`); Slaughtering (ID: `keyterm:Slaughtering`); Efraimu (ID: `group:Ephraim`); Strength (ID: `keyterm:Strength`); Favor (ID: `keyterm:Favor`); Hell (ID: `place:Hell`); Wickedness (ID: `keyterm:Wickedness`); Hofni (ID: `person:Hophni`); Peace (ID: `keyterm:IntactState`); Salvation (ID: `keyterm:Salvation`); Anointed (ID: `keyterm:Anointed`); Israeli (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Razor (ID: `realia:Razor`); Bow (ID: `realia:Bow`); Ephah (ID: `realia:Ephah`); Throne (ID: `realia:Throne`); Doorpost (ID: `realia:Doorpost`); Skin-Bottle (ID: `realia:Skin-bottle`)
...
* **Associated Articles:** Dhambi (ID: `367686@BiblicaStudyNotesKeyTerms`); Binadamu (ID: `367693@BiblicaStudyNotesKeyTerms`); Amani (ID: `367702@BiblicaStudyNotesKeyTerms`); Watu wa Mungu (ID: `367793@BiblicaStudyNotesKeyTerms`); Mfalme (ID: `367821@BiblicaStudyNotesKeyTerms`); Laana za Agano (ID: `367871@BiblicaStudyNotesKeyTerms`); Roho Mtakatifu (ID: `367879@BiblicaStudyNotesKeyTerms`); Kuondoa (ID: `367900@BiblicaStudyNotes`); Waamoni (ID: `367903@BiblicaStudyNotesKeyTerms`); Moyo (ID: `367910@BiblicaStudyNotes`); Sauli (ID: `367946@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Samweli (ID: `person:Samuel`); Sauli (ID: `person:Saul.2`); Israeli (ID: `person:Israel`); Benyamini (ID: `group:Benjamin`); Benyamini (ID: `person:Benjamin`); Force to Serve (ID: `keyterm:EnticedToServe`); Speak as a Prophet (ID: `keyterm:Speak`); Yabeshi (ID: `place:Jabesh-gilead`); Donkey (ID: `fauna:Donkey`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Kishi (ID: `person:Kish`); Misri (ID: `place:Egypt`); Ammonites (ID: `group:Ammon`); Waamoni (ID: `place:Ammon`); Slaughtering (ID: `keyterm:Slaughtering`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Gibeah (ID: `place:Gibeah.2`); Nahashi (ID: `person:Nahash`); Gilgal (ID: `place:Gilgal.2`); Offering (ID: `keyterm:Offering`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); To Sin (ID: `keyterm:Sin`); Musa (ID: `person:Moses`); Salvation (ID: `keyterm:Salvation`); Men (ID: `group:GenericMales`); A Group of People (ID: `group:GenericGroup`)
...
* **Associated ACAI Concepts:** Sauli (ID: `person:Saul.2`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Yonathani (ID: `person:Jonathan.3`); Samweli (ID: `person:Samuel`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); Amaleki (ID: `place:Amalek`); Mikmashi (ID: `place:Michmash`); Gilgal (ID: `place:Gilgal.2`); Amalekites (ID: `group:Amalek`); To Sin (ID: `keyterm:Sin`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Agagi (ID: `person:Agag.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Hebrews (ID: `group:Hebrews`); Gibeah (ID: `place:Gibeah.2`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); Benyamini (ID: `group:Benjamin`); Benyamini (ID: `person:Benjamin`); Goat (ID: `fauna:Goat`); Sword (ID: `realia:Sword`); Flock (ID: `fauna:Flock`); Misri (ID: `place:Egypt`); Geba (ID: `place:Geba`); Sheep (ID: `fauna:Lamb`); Neri (ID: `person:Ner.2`); Abneri (ID: `person:Abner`); Ahimeleki (ID: `person:Ahimelech`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); Sauli (ID: `person:Saul.2`); BWANA (ID: `deity:Lord`); Yese (ID: `person:Jesse`); Israeli (ID: `person:Israel`); Samweli (ID: `person:Samuel`); Bethlehemu (ID: `place:Bethlehem`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Peace (ID: `keyterm:IntactState`); Sword (ID: `realia:Sword`); Eliabu (ID: `person:Eliab.3`); Gathi (ID: `place:Gath`); Bethlehemites (ID: `group:Bethlehem`); Smear (ID: `keyterm:Smear`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Sheep (ID: `fauna:Lamb`); Goliathi (ID: `person:Goliath`); bonde (ID: `place:ElahValley`); Abinadabu (ID: `person:Abinadab.3`); Shama (ID: `person:Shimeah.2`); Slaughtering (ID: `keyterm:Slaughtering`); Fear (ID: `keyterm:Fear`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Abneri (ID: `person:Abner`); Sling (ID: `realia:Sling`); Bear (ID: `fauna:Bear`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); Sauli (ID: `person:Saul.2`); BWANA (ID: `deity:Lord`); Yonathani (ID: `person:Jonathan.3`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); Keila (ID: `place:Keilah`); Ahimeleki (ID: `person:Ahimelech`); Israeli (ID: `person:Israel`); Mikali (ID: `person:Michal`); Yese (ID: `person:Jesse`); An Angel (ID: `deity:Angel`); Love (ID: `keyterm:Love`); Fear (ID: `keyterm:Fear`); Abiathari (ID: `person:Abiathar`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Nayothi (ID: `place:Naioth`); Speak as a Prophet (ID: `keyterm:Speak`); Rama (ID: `place:Ramah`); Doegi (ID: `person:Doeg`); Ahitubu (ID: `person:Ahitub`); Wilderness of Ziph (ID: `place:Ziph.2`); Nobu (ID: `place:Nob`); Akishi (ID: `person:Achish`); Horeshi (ID: `place:Horesh`); Arrow (ID: `keyterm:Arrow`); Have Insight (ID: `keyterm:HaveInsight`); Yuda (ID: `group:Judah`); Samweli (ID: `person:Samuel`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); BWANA (ID: `deity:Lord`); Sauli (ID: `person:Saul.2`); Nabali (ID: `person:Nabal`); Abigaili (ID: `person:Abigail`); Israeli (ID: `person:Israel`); Bless (ID: `keyterm:Bless`); Anointed (ID: `keyterm:Anointed`); Abishai (ID: `person:Abishai`); Karmeli (ID: `place:Carmel`); Abneri (ID: `person:Abner`); Goat (ID: `fauna:Goat`); Spear (ID: `realia:Spear`); Flock (ID: `fauna:Flock`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Donkey (ID: `fauna:Donkey`); Hakila (ID: `place:Hachilah`); Neri (ID: `person:Ner.2`); Wilderness of Ziph (ID: `place:Ziph.2`); Swear (ID: `keyterm:Swear`); An Angel (ID: `deity:Angel`); Wickedness (ID: `keyterm:Wickedness`); To Sin (ID: `keyterm:Sin`); Yeshimoni (ID: `place:Jeshimon`); Rebel (ID: `keyterm:Rebel`); Clay Jar (ID: `realia:ClayJar`); Ziphites (ID: `group:Ziph`); Mikali (ID: `person:Michal`); Galimu (ID: `place:Gallim`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); Sauli (ID: `person:Saul.2`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); Akishi (ID: `person:Achish`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Samweli (ID: `person:Samuel`); Amaleki (ID: `place:Amalek`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Yezreeli (ID: `place:Jezreel`); Necromancer (ID: `keyterm:Spirit`); Siklagi (ID: `place:Ziklag`); Negebu (ID: `place:Negeb`); Fear (ID: `keyterm:Fear`); Amalekites (ID: `group:Amalek`); Gathi (ID: `place:Gath`); Yabeshi (ID: `place:Jabesh-gilead`); Besori (ID: `place:Besor`); Gileadi (ID: `place:GilboaMount`); Misri (ID: `place:Egypt`); Strength (ID: `keyterm:Strength`); Karmeli (ID: `place:Carmel`); Jerahmeelites (ID: `group:Jerahmeel`); Yerameeli (ID: `person:Jerahmeel`); Ahinoamu (ID: `person:Ahinoam.2`); Yezreeli (ID: `place:Jezreel.2`); Yezreeli (ID: `group:Jezreel`); Beth-sheani (ID: `place:Beth-shan`)
