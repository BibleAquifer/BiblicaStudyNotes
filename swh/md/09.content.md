...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Hana (ID: `person:Hannah`); Eli (ID: `person:Eli`); Elkana (ID: `person:Elkanah.2`); Rama (ID: `place:Ramah`); House (ID: `realia:House`); Shilo (ID: `place:Shiloh`); Penina (ID: `person:Peninnah`); Horn (ID: `keyterm:Horn`); Vow (ID: `keyterm:Vow`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Yerohamu (ID: `person:Jeroham`); Elihu (ID: `person:Elihu`); Tohu (ID: `person:Tohu`); Sufu (ID: `person:Zuph`); Samweli (ID: `person:Samuel`); Finehasi (ID: `person:Phinehas.2`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Salvation (ID: `keyterm:Salvation`); Wickedness (ID: `keyterm:Wickedness`); Hell (ID: `place:Hell`); Glory (ID: `keyterm:Glory`); Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); Slaughtering (ID: `keyterm:Slaughtering`); Peace (ID: `keyterm:IntactState`); Anointed (ID: `keyterm:Anointed`); Efraimu (ID: `group:Ephraim`); Hofni (ID: `person:Hophni`); Israeli (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Loyal Person (ID: `keyterm:LoyalPerson`); Favor (ID: `keyterm:Favor`); Efraimu (ID: `person:Ephraim`); Skin-Bottle (ID: `realia:Skin-bottle`); Bow (ID: `realia:Bow`); Throne (ID: `realia:Throne`); Doorpost (ID: `realia:Doorpost`); Razor (ID: `realia:Razor`); Ephah (ID: `realia:Ephah`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Covenant Box (ID: `keyterm:CovenantBox`); Samweli (ID: `person:Samuel`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Eli (ID: `person:Eli`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Offering (ID: `keyterm:Offering`); Tumors (ID: `keyterm:Tumors`); Beth-shemeshi (ID: `place:Beth-shemesh`); Ashdodi (ID: `place:Ashdod`); Mispa (ID: `place:Mizpah`); Dagoni (ID: `deity:Dagon`); Finehasi (ID: `person:Phinehas.2`); Shilo (ID: `place:Shiloh`); Slaughtering (ID: `keyterm:Slaughtering`); Hofni (ID: `person:Hophni`); House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); Ekroni (ID: `place:Ekron`); Wagon (ID: `realia:Wagon`); Ebenezeri (ID: `place:Ebenezer`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Kiriath-yearimu (ID: `place:Kiriath-jearim`); Force to Serve (ID: `keyterm:EnticedToServe`); Glory (ID: `keyterm:Glory`); To Sin (ID: `keyterm:Sin`); Gathi (ID: `place:Gath`); Misri (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Samweli (ID: `person:Samuel`); Sauli (ID: `person:Saul.2`); Israeli (ID: `person:Israel`); Benyamini (ID: `group:Benjamin`); Benyamini (ID: `person:Benjamin`); Force to Serve (ID: `keyterm:EnticedToServe`); Speak as a Prophet (ID: `keyterm:Speak`); Yabeshi (ID: `place:Jabesh-gilead`); Donkey (ID: `fauna:Donkey`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Kishi (ID: `person:Kish`); Waamoni (ID: `place:Ammon`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Ammonites (ID: `group:Ammon`); Gibeah (ID: `place:Gibeah.2`); Slaughtering (ID: `keyterm:Slaughtering`); Misri (ID: `place:Egypt`); Nahashi (ID: `person:Nahash`); Wafilisti (ID: `place:Philistine`); Gilgal (ID: `place:Gilgal.2`); Offering (ID: `keyterm:Offering`); To Sin (ID: `keyterm:Sin`); Wafilisti (ID: `group:Philistine`); Musa (ID: `person:Moses`); Smear (ID: `keyterm:Smear`); Haruni (ID: `person:Aaron`); Men (ID: `group:GenericMales`)
...
* **Associated ACAI Concepts:** Sauli (ID: `person:Saul.2`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Yonathani (ID: `person:Jonathan.3`); Samweli (ID: `person:Samuel`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Amaleki (ID: `place:Amalek`); Mikmashi (ID: `place:Michmash`); Gilgal (ID: `place:Gilgal.2`); Amalekites (ID: `group:Amalek`); To Sin (ID: `keyterm:Sin`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Agagi (ID: `person:Agag.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Gibeah (ID: `place:Gibeah.2`); Hebrews (ID: `group:Hebrews`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); Benyamini (ID: `group:Benjamin`); Benyamini (ID: `person:Benjamin`); Goat (ID: `fauna:Goat`); Sword (ID: `realia:Sword`); Flock (ID: `fauna:Flock`); Geba (ID: `place:Geba`); Misri (ID: `place:Egypt`); Sheep (ID: `fauna:Lamb`); Neri (ID: `person:Ner.2`); Abneri (ID: `person:Abner`); Ahimeleki (ID: `person:Ahimelech`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); Sauli (ID: `person:Saul.2`); BWANA (ID: `deity:Lord`); Yonathani (ID: `person:Jonathan.3`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Keila (ID: `place:Keilah`); Ahimeleki (ID: `person:Ahimelech`); Israeli (ID: `person:Israel`); Mikali (ID: `person:Michal`); An Angel (ID: `deity:Angel`); Yese (ID: `person:Jesse`); Love (ID: `keyterm:Love`); Fear (ID: `keyterm:Fear`); Abiathari (ID: `person:Abiathar`); Nayothi (ID: `place:Naioth`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Rama (ID: `place:Ramah`); Speak as a Prophet (ID: `keyterm:Speak`); Doegi (ID: `person:Doeg`); Ahitubu (ID: `person:Ahitub`); Wilderness of Ziph (ID: `place:Ziph.2`); Horeshi (ID: `place:Horesh`); Nobu (ID: `place:Nob`); Akishi (ID: `person:Achish`); Yuda (ID: `group:Judah`); Samweli (ID: `person:Samuel`); Arrow (ID: `keyterm:Arrow`); Yuda (ID: `person:Judah.4`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); BWANA (ID: `deity:Lord`); Sauli (ID: `person:Saul.2`); Nabali (ID: `person:Nabal`); Abigaili (ID: `person:Abigail`); Israeli (ID: `person:Israel`); Bless (ID: `keyterm:Bless`); Anointed (ID: `keyterm:Anointed`); Abishai (ID: `person:Abishai`); Karmeli (ID: `place:Carmel`); Abneri (ID: `person:Abner`); Goat (ID: `fauna:Goat`); Spear (ID: `realia:Spear`); Flock (ID: `fauna:Flock`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Donkey (ID: `fauna:Donkey`); Hakila (ID: `place:Hachilah`); Neri (ID: `person:Ner.2`); Yeshimoni (ID: `place:Jeshimon`); An Angel (ID: `deity:Angel`); Wickedness (ID: `keyterm:Wickedness`); To Sin (ID: `keyterm:Sin`); Swear (ID: `keyterm:Swear`); Rebel (ID: `keyterm:Rebel`); Wilderness of Ziph (ID: `place:Ziph.2`); Clay Jar (ID: `realia:ClayJar`); Galimu (ID: `place:Gallim`); Yezreeli (ID: `place:Jezreel`); Ahimeleki (ID: `person:Ahimelech.2`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); Sauli (ID: `person:Saul.2`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Akishi (ID: `person:Achish`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Samweli (ID: `person:Samuel`); Amaleki (ID: `place:Amalek`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Yezreeli (ID: `place:Jezreel`); Siklagi (ID: `place:Ziklag`); Necromancer (ID: `keyterm:Spirit`); Fear (ID: `keyterm:Fear`); Negebu (ID: `place:Negeb`); Gathi (ID: `place:Gath`); Amalekites (ID: `group:Amalek`); Yabeshi (ID: `place:Jabesh-gilead`); Besori (ID: `place:Besor`); Gileadi (ID: `place:GilboaMount`); Strength (ID: `keyterm:Strength`); Karmeli (ID: `place:Carmel`); Misri (ID: `place:Egypt`); Jerahmeelites (ID: `group:Jerahmeel`); Yerameeli (ID: `person:Jerahmeel`); Yezreeli (ID: `place:Jezreel.2`); Ahinoamu (ID: `person:Ahinoam.2`); Yezreeli (ID: `group:Jezreel`); Nabali (ID: `person:Nabal`)
