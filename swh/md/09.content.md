...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Hana (ID: `person:Hannah`); Eli (ID: `person:Eli`); Elkana (ID: `person:Elkanah.2`); Rama (ID: `place:Ramah`); House (ID: `realia:House`); Shilo (ID: `place:Shiloh`); Penina (ID: `person:Peninnah`); Horn (ID: `keyterm:Horn`); Vow (ID: `keyterm:Vow`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Elihu (ID: `person:Elihu`); Yerohamu (ID: `person:Jeroham`); Tohu (ID: `person:Tohu`); Sufu (ID: `person:Zuph`); Samweli (ID: `person:Samuel`); Finehasi (ID: `person:Phinehas.2`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Loyal Person (ID: `keyterm:LoyalPerson`); Strength (ID: `keyterm:Strength`); Anointed (ID: `keyterm:Anointed`); Hell (ID: `place:Hell`); Holy (ID: `keyterm:Holy`); Favor (ID: `keyterm:Favor`); Wickedness (ID: `keyterm:Wickedness`); Efraimu (ID: `person:Ephraim`); Hofni (ID: `person:Hophni`); Israeli (ID: `person:Israel`); Efraimu (ID: `group:Ephraim`); Slaughtering (ID: `keyterm:Slaughtering`); Salvation (ID: `keyterm:Salvation`); Peace (ID: `keyterm:IntactState`); Doorpost (ID: `realia:Doorpost`); Throne (ID: `realia:Throne`); Ephah (ID: `realia:Ephah`); Skin-Bottle (ID: `realia:Skin-bottle`); Razor (ID: `realia:Razor`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Samweli (ID: `person:Samuel`); Sauli (ID: `person:Saul.2`); Israeli (ID: `person:Israel`); Benyamini (ID: `person:Benjamin`); Benyamini (ID: `group:Benjamin`); Force to Serve (ID: `keyterm:EnticedToServe`); Speak as a Prophet (ID: `keyterm:Speak`); Yabeshi (ID: `place:Jabesh-gilead`); Donkey (ID: `fauna:Donkey`); Stone Pine (ID: `flora:Pine`); High Place (ID: `realia:HighPlace`); Kishi (ID: `person:Kish`); Gibeah (ID: `place:Gibeah.2`); An Angel (ID: `deity:Angel`); Fear (ID: `keyterm:Fear`); Misri (ID: `place:Egypt`); Waamoni (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Slaughtering (ID: `keyterm:Slaughtering`); Nahashi (ID: `person:Nahash`); Gilgal (ID: `place:Gilgal.2`); To Sin (ID: `keyterm:Sin`); Wafilisti (ID: `place:Philistine`); Offering (ID: `keyterm:Offering`); Wafilisti (ID: `group:Philistine`); Men (ID: `group:GenericMales`); Musa (ID: `person:Moses`); Salvation (ID: `keyterm:Salvation`); Smear (ID: `keyterm:Smear`)
...
* **Associated ACAI Concepts:** Sauli (ID: `person:Saul.2`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Yonathani (ID: `person:Jonathan.3`); Samweli (ID: `person:Samuel`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Amaleki (ID: `place:Amalek`); Mikmashi (ID: `place:Michmash`); Gilgal (ID: `place:Gilgal.2`); Amalekites (ID: `group:Amalek`); To Sin (ID: `keyterm:Sin`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Agagi (ID: `person:Agag.2`); Gibeah (ID: `place:Gibeah.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Hebrews (ID: `group:Hebrews`); Cattle (ID: `fauna:Bull`); Benyamini (ID: `person:Benjamin`); Offering (ID: `keyterm:Offering`); Benyamini (ID: `group:Benjamin`); Sword (ID: `realia:Sword`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Geba (ID: `place:Geba`); Misri (ID: `place:Egypt`); Sheep (ID: `fauna:Lamb`); Neri (ID: `person:Ner.2`); Abneri (ID: `person:Abner`); To Curse (ID: `keyterm:Curse`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); Sauli (ID: `person:Saul.2`); BWANA (ID: `deity:Lord`); Yese (ID: `person:Jesse`); Israeli (ID: `person:Israel`); Samweli (ID: `person:Samuel`); Bethlehemu (ID: `place:Bethlehem`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Peace (ID: `keyterm:IntactState`); Sword (ID: `realia:Sword`); Eliabu (ID: `person:Eliab.3`); Bethlehemites (ID: `group:Bethlehem`); Smear (ID: `keyterm:Smear`); Gathi (ID: `place:Gath`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Sheep (ID: `fauna:Lamb`); Goliathi (ID: `person:Goliath`); bonde (ID: `place:ElahValley`); Abinadabu (ID: `person:Abinadab.3`); Shama (ID: `person:Shimeah.2`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Fear (ID: `keyterm:Fear`); Abneri (ID: `person:Abner`); Slaughtering (ID: `keyterm:Slaughtering`); Sling (ID: `realia:Sling`); Bear (ID: `fauna:Bear`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); Sauli (ID: `person:Saul.2`); BWANA (ID: `deity:Lord`); Yonathani (ID: `person:Jonathan.3`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Keila (ID: `place:Keilah`); Ahimeleki (ID: `person:Ahimelech`); Israeli (ID: `person:Israel`); Mikali (ID: `person:Michal`); Love (ID: `keyterm:Love`); An Angel (ID: `deity:Angel`); Yese (ID: `person:Jesse`); Fear (ID: `keyterm:Fear`); Abiathari (ID: `person:Abiathar`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Nayothi (ID: `place:Naioth`); Rama (ID: `place:Ramah`); Speak as a Prophet (ID: `keyterm:Speak`); Doegi (ID: `person:Doeg`); Wilderness of Ziph (ID: `place:Ziph.2`); Ahitubu (ID: `person:Ahitub`); Horeshi (ID: `place:Horesh`); Nobu (ID: `place:Nob`); Akishi (ID: `person:Achish`); Have Insight (ID: `keyterm:HaveInsight`); Peace (ID: `keyterm:IntactState`); Yuda (ID: `person:Judah.4`); Arrow (ID: `keyterm:Arrow`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); BWANA (ID: `deity:Lord`); Sauli (ID: `person:Saul.2`); Nabali (ID: `person:Nabal`); Abigaili (ID: `person:Abigail`); Israeli (ID: `person:Israel`); Bless (ID: `keyterm:Bless`); Anointed (ID: `keyterm:Anointed`); Karmeli (ID: `place:Carmel`); Abishai (ID: `person:Abishai`); Abneri (ID: `person:Abner`); Spear (ID: `realia:Spear`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Peace (ID: `keyterm:IntactState`); Donkey (ID: `fauna:Donkey`); House (ID: `realia:House`); Hakila (ID: `place:Hachilah`); Wilderness of Ziph (ID: `place:Ziph.2`); To Sin (ID: `keyterm:Sin`); Neri (ID: `person:Ner.2`); An Angel (ID: `deity:Angel`); Swear (ID: `keyterm:Swear`); Rebel (ID: `keyterm:Rebel`); Yeshimoni (ID: `place:Jeshimon`); Wickedness (ID: `keyterm:Wickedness`); Clay Jar (ID: `realia:ClayJar`); Ziphites (ID: `group:Ziph`); Ahinoamu (ID: `person:Ahinoam.2`); Laisha (ID: `person:Laish`)
...
* **Associated ACAI Concepts:** Daudi (ID: `person:David`); Sauli (ID: `person:Saul.2`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Akishi (ID: `person:Achish`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Samweli (ID: `person:Samuel`); Amaleki (ID: `place:Amalek`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Necromancer (ID: `keyterm:Spirit`); Yezreeli (ID: `place:Jezreel`); Siklagi (ID: `place:Ziklag`); Negebu (ID: `place:Negeb`); Fear (ID: `keyterm:Fear`); Gathi (ID: `place:Gath`); Amalekites (ID: `group:Amalek`); Yabeshi (ID: `place:Jabesh-gilead`); Besori (ID: `place:Besor`); Gileadi (ID: `place:GilboaMount`); Karmeli (ID: `place:Carmel`); Strength (ID: `keyterm:Strength`); Misri (ID: `place:Egypt`); Jerahmeelites (ID: `group:Jerahmeel`); Yerameeli (ID: `person:Jerahmeel`); Ahinoamu (ID: `person:Ahinoam.2`); Yezreeli (ID: `place:Jezreel.2`); Peace (ID: `keyterm:IntactState`); Yezreeli (ID: `group:Jezreel`)
