...
* **Associated ACAI Concepts:** Patmo (ID: `place:Patmos`); Lampstand (ID: `realia:Lampstand.2`); Pergamo (ID: `place:Pergamum`); Smirna (ID: `place:Smyrna`); Filadelfia (ID: `place:Philadelphia`); Sardi (ID: `place:Sardis`); Laodikia (ID: `place:Laodicea`); Kiln (ID: `realia:Kiln`); Efeso (ID: `place:Ephesus`)
...
* **Associated ACAI Concepts:** Nicolaitans (ID: `group:Nicolaitans`); Antipa (ID: `person:Antipas`); Pergamo (ID: `place:Pergamum`); Smirna (ID: `place:Smyrna`); Efeso (ID: `place:Ephesus`); To Act Wickedly (ID: `keyterm:ActWickedly`); Church (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** Thiatira (ID: `place:Thyatira`); Sardi (ID: `place:Sardis`); Fornication (ID: `keyterm:Fornication`); Clothing (ID: `realia:Clothing`); Yezebeli (ID: `person:Jezebel`); Rod (ID: `realia:Rod`); Church (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** Eye Salve (ID: `realia:EyeSalve`); Filadelfia (ID: `place:Philadelphia`); Door (ID: `realia:Door`); True (ID: `keyterm:True`); Laodikia (ID: `place:Laodicea`); Friendship (ID: `keyterm:Friendship`)
...
* **Associated ACAI Concepts:** Isakari (ID: `person:Issachar`); Zabuloni (ID: `person:Zebulun`); Naftali (ID: `person:Naphtali`); Reubeni (ID: `person:Reuben`); Throne (ID: `realia:Throne`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Uharibifu (ID: `deity:Abaddon`); Abyss (ID: `keyterm:Abyss`)
...
* **Associated ACAI Concepts:** Sky (ID: `keyterm:Heaven`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Dragon (ID: `fauna:Dragon`); Bear Witness (ID: `keyterm:BearWitness`); Mikaeli (ID: `person:Michael.11`); Rod (ID: `realia:Rod`); Sky (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** Bowl (ID: `realia:Bowl.2`); Frog (ID: `fauna:Frog`); Talent (ID: `realia:Talent`); Mto (ID: `place:Euphrates`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Regulations (ID: `keyterm:Regulations`); Avenge (ID: `keyterm:GrantJustice`); Linen (ID: `realia:Linen`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Abyss (ID: `keyterm:Abyss`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Magogu (ID: `place:Magog`); Key (ID: `realia:Key`); Gog (ID: `place:Gog`); Chain (ID: `realia:Chain`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); Always (ID: `keyterm:Always`); BWANA (ID: `deity:Lord`)
