...
* **Associated ACAI Concepts:** Lampstand (ID: `realia:Lampstand.2`); Church (ID: `keyterm:Church`); Filadelfia (ID: `place:Philadelphia`); Patmo (ID: `place:Patmos`); Efeso (ID: `place:Ephesus`); Pergamo (ID: `place:Pergamum`); Laodikia (ID: `place:Laodicea`); Smirna (ID: `place:Smyrna`); Sardi (ID: `place:Sardis`); Thiatira (ID: `place:Thyatira`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`); Hell (ID: `place:Hell`); Life (ID: `keyterm:Life`); Bear Witness (ID: `keyterm:BearWitness`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Always (ID: `keyterm:Always`); Yohana (ID: `person:John.2`); Roho (ID: `deity:HolySpirit`); An Angel (ID: `deity:Angel`); Fear (ID: `keyterm:Fear`); Kingdom (ID: `keyterm:Kingdom`); Ability (ID: `keyterm:Ability`); Kiln (ID: `realia:Kiln`); Belt (ID: `realia:Belt`); Cloak (ID: `realia:Cloak`); Bag (ID: `realia:Bag`); Trumpet (ID: `realia:Trumpet`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); Life (ID: `keyterm:Life`); Roho (ID: `deity:HolySpirit`); Name (ID: `keyterm:Name`); An Angel (ID: `deity:Angel`); Nicolaitans (ID: `group:Nicolaitans`); Shetani (ID: `deity:Satan`); Faithfulness (ID: `keyterm:Faithfulness`); Repent (ID: `keyterm:Repent`); Lampstand (ID: `realia:Lampstand.2`); Antipa (ID: `person:Antipas`); Efeso (ID: `place:Ephesus`); Pergamo (ID: `place:Pergamum`); Smirna (ID: `place:Smyrna`); To Act Wickedly (ID: `keyterm:ActWickedly`); Jews (ID: `group:Jews`); Love (ID: `keyterm:Love`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Blaspheme (ID: `keyterm:Blaspheme`); Paradise (ID: `keyterm:Paradise`); Fornication (ID: `keyterm:Fornication`); Balaki (ID: `person:Balak`); Witness (ID: `keyterm:Witness`); Balaamu (ID: `person:Balaam`); Stumbling Block (ID: `keyterm:StumblingBlock`); Fear (ID: `keyterm:Fear`); Believe (ID: `keyterm:Believe`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); BWANA (ID: `deity:Lord`); True (ID: `keyterm:True`); Roho (ID: `deity:HolySpirit`); Name (ID: `keyterm:Name`); An Angel (ID: `deity:Angel`); Ability (ID: `keyterm:Ability`); Door (ID: `realia:Door`); Filadelfia (ID: `place:Philadelphia`); Friendship (ID: `keyterm:Friendship`); Laodikia (ID: `place:Laodicea`); Jews (ID: `group:Jews`); Shetani (ID: `deity:Satan`); Love (ID: `keyterm:Love`); Yerusalemu (ID: `place:Jerusalem`); Pitiful (ID: `keyterm:Pitiful`); Faithfulness (ID: `keyterm:Faithfulness`); Daudi (ID: `person:David`); Anointed (ID: `keyterm:Anointed`); Surely! (ID: `keyterm:Surely`); Repent (ID: `keyterm:Repent`); Holy (ID: `keyterm:Holy`); Bow Down (ID: `keyterm:BowDown`); Sky (ID: `keyterm:Heaven`); Witness (ID: `keyterm:Witness`); Eye Salve (ID: `realia:EyeSalve`); Throne (ID: `realia:Throne`); Temple (ID: `realia:Temple`); Capital (ID: `realia:Capital`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Throne (ID: `realia:Throne`); BWANA (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Glory (ID: `keyterm:Glory`); Always (ID: `keyterm:Always`); Sky (ID: `keyterm:Heaven`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`); Spirit (ID: `keyterm:Spirit.2`); Roho (ID: `deity:HolySpirit`); Holy (ID: `keyterm:Holy`); Bow Down (ID: `keyterm:BowDown`); Ability (ID: `keyterm:Ability`); Torch (ID: `realia:Torch`); Cattle (ID: `fauna:Bull`); Door (ID: `realia:Door`); Trumpet (ID: `realia:Trumpet`); Clothing (ID: `realia:Clothing`); Vulture (ID: `fauna:Vulture`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** Blood (ID: `keyterm:Blood`); Sky (ID: `keyterm:Heaven`); Seal (ID: `realia:Seal`); Holy (ID: `keyterm:Holy`); Avenge (ID: `keyterm:GrantJustice`); BWANA (ID: `deity:Lord`); Decided (ID: `keyterm:Decided`); Bear Witness (ID: `keyterm:BearWitness`); True (ID: `keyterm:True`); Cloak (ID: `realia:Cloak`); Scroll (ID: `realia:Scroll`); Throne (ID: `realia:Throne`); Sackcloth (ID: `realia:Sackcloth`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Throne (ID: `realia:Throne`); An Angel (ID: `deity:Angel`); Cloak (ID: `realia:Cloak`); Life (ID: `keyterm:Life`); To Act Wickedly (ID: `keyterm:ActWickedly`); Isakari (ID: `person:Issachar`); Reubeni (ID: `person:Reuben`); Zabuloni (ID: `person:Zebulun`); Naftali (ID: `person:Naphtali`); Walawi (ID: `person:Levi.3`); Asheri (ID: `person:Asher`); Walawi (ID: `group:Levi`); Manase (ID: `person:Manasseh`); Simeoni (ID: `person:Simeon.5`); Yuda (ID: `person:Judah.4`); Benyamini (ID: `group:Benjamin`); Manase (ID: `group:Manasseh`); Glory (ID: `keyterm:Glory`); Reubeni (ID: `group:Reuben`); Yuda (ID: `group:Judah`); Israeli (ID: `person:Israel`); Gadi (ID: `person:Gad`); Surely! (ID: `keyterm:Surely`); Always (ID: `keyterm:Always`); Asheri (ID: `group:Asher`); Salvation (ID: `keyterm:Salvation`); Priesthood (ID: `keyterm:Priesthood`); Simeoni (ID: `group:Simeon`); Bow Down (ID: `keyterm:BowDown`); Blood (ID: `keyterm:Blood`); Benyamini (ID: `person:Benjamin`); Isakari (ID: `group:Issachar`); Ability (ID: `keyterm:Ability`); Serve (ID: `keyterm:Serve`); Bless (ID: `keyterm:Bless`); Yusufu (ID: `person:Joseph.10`); Zabuloni (ID: `group:Zebulun`); Goat (ID: `fauna:Goat`); Temple (ID: `realia:Temple`); Flock (ID: `fauna:Flock`); Seal (ID: `realia:Seal`); Cornerstone (ID: `realia:Cornerstone`); Date Palm (ID: `flora:DatePalm`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); Holy (ID: `keyterm:Holy`); Pray (ID: `keyterm:Pray`); BWANA (ID: `deity:Lord`); Incense (ID: `realia:Incense`); Censer (ID: `realia:Censer`); Sky (ID: `keyterm:Heaven`); Trumpet (ID: `realia:Trumpet`); Throne (ID: `realia:Throne`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Ability (ID: `keyterm:Ability`); Temple (ID: `realia:Temple`); Witness (ID: `keyterm:Witness`); A Disembodied Voice (ID: `deity:Voice`); Yesu (ID: `person:Jesus.2`); Abyss (ID: `keyterm:Abyss`); Life (ID: `keyterm:Life`); Speak as a Prophet (ID: `keyterm:Speak`); Glory (ID: `keyterm:Glory`); Spirit (ID: `keyterm:Spirit.2`); Authority (ID: `keyterm:Authority.2`); Gentiles (ID: `group:Gentile`); Bear Witness (ID: `keyterm:BearWitness`); Offering (ID: `keyterm:Offering`); Sodoma (ID: `place:Sodom`); Misri (ID: `place:Egypt`); Name (ID: `keyterm:Name`); Holy (ID: `keyterm:Holy`); Bow Down (ID: `keyterm:BowDown`); Blood (ID: `keyterm:Blood`); Fear (ID: `keyterm:Fear`); To Act Wickedly (ID: `keyterm:ActWickedly`); Disaster (ID: `keyterm:Disaster`); Measuring Reed (ID: `realia:MeasuringReed`); Measuring Rod (ID: `realia:MeasuringRod`); Reed (ID: `flora:Reed`); Grave (ID: `realia:Grave`); Sheepfold (ID: `realia:Sheepfold`); Staff (ID: `realia:Staff`); Cross (ID: `realia:Cross`); Sackcloth (ID: `realia:Sackcloth`); Olive Tree (ID: `flora:OliveTree`); Courtyard (ID: `realia:Courtyard`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Authority (ID: `keyterm:Authority.2`); Name (ID: `keyterm:Name`); Bow Down (ID: `keyterm:BowDown`); Blaspheme (ID: `keyterm:Blaspheme`); Dragon (ID: `fauna:Dragon`); Life (ID: `keyterm:Life`); Symbol (ID: `keyterm:Example`); Holy (ID: `keyterm:Holy`); Sky (ID: `keyterm:Heaven`); Serve (ID: `keyterm:Serve`); Image (ID: `realia:Image`); Believe (ID: `keyterm:Believe`); BWANA (ID: `deity:Lord`); Spirit (ID: `keyterm:Spirit.2`); Leopard (ID: `fauna:Leopard`); Bear (ID: `fauna:Bear`); Tabernacle (ID: `realia:Tabernacle`); Sheep (ID: `fauna:Lamb`); Crown (ID: `realia:Crown`); Lion (ID: `fauna:Lion`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Redeem (ID: `keyterm:Redeem`); Unblemished (ID: `keyterm:Unblemished`); Sky (ID: `keyterm:Heaven`); Defilement (ID: `keyterm:Defilement`); Yerusalemu (ID: `place:Jerusalem`); Name (ID: `keyterm:Name`); Lyre (ID: `realia:Lyre`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Bow Down (ID: `keyterm:BowDown`); Always (ID: `keyterm:Always`); Holy (ID: `keyterm:Holy`); Sky (ID: `keyterm:Heaven`); Image (ID: `realia:Image`); Wine (ID: `realia:Wine`); Commandment (ID: `keyterm:Commandment`); A Disembodied Voice (ID: `deity:Voice`); Judgment (ID: `keyterm:Judgment`); Yesu (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`); Court Case (ID: `keyterm:CourtCase`); Good News (ID: `keyterm:GoodNews`); Roho (ID: `deity:HolySpirit`); Name (ID: `keyterm:Name`); Fornication (ID: `keyterm:Fornication`); Babeli (ID: `place:Babylon`); Happy (ID: `keyterm:Happy`); Fear (ID: `keyterm:Fear`); Believe (ID: `keyterm:Believe`); Midheaven (ID: `keyterm:Midheaven`)
...
* **Associated ACAI Concepts:** Sickle (ID: `realia:Sickle`); An Angel (ID: `deity:Angel`); Winepress (ID: `realia:Winepress`); Vine (ID: `flora:Vine`); Temple (ID: `realia:Temple`); Blood (ID: `keyterm:Blood`); BWANA (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Authority (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); Crown (ID: `realia:Crown.2`); Stade (ID: `realia:Stade`); Crown (ID: `realia:Crown`); Bit and Bridle (ID: `realia:BitAndBridle`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Temple (ID: `realia:Temple`); Glory (ID: `keyterm:Glory`); Name (ID: `keyterm:Name`); Sky (ID: `keyterm:Heaven`); Regulations (ID: `keyterm:Regulations`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); The Way (ID: `keyterm:TheWay`); Life (ID: `keyterm:Life`); Symbol (ID: `keyterm:Example`); Bear Witness (ID: `keyterm:BearWitness`); Clean (ID: `keyterm:Clean`); Always (ID: `keyterm:Always`); Musa (ID: `person:Moses`); Bow Down (ID: `keyterm:BowDown`); Fear (ID: `keyterm:Fear`); Ability (ID: `keyterm:Ability`); True (ID: `keyterm:True`); Linen (ID: `realia:Linen`); Belt (ID: `realia:Belt`); Tabernacle (ID: `realia:Tabernacle`); Lyre (ID: `realia:Lyre`); Bowl (ID: `realia:Bowl.2`); Bag (ID: `realia:Bag`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Bowl (ID: `realia:Bowl.2`); Blaspheme (ID: `keyterm:Blaspheme`); Blood (ID: `keyterm:Blood`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); Repent (ID: `keyterm:Repent`); Sky (ID: `keyterm:Heaven`); Ability (ID: `keyterm:Ability`); Throne (ID: `realia:Throne`); Temple (ID: `realia:Temple`); Mto (ID: `place:Euphrates`); A Disembodied Voice (ID: `deity:Voice`); Megido (ID: `place:Megiddo`); Judgment (ID: `keyterm:Judgment`); Life (ID: `keyterm:Life`); Glory (ID: `keyterm:Glory`); Symbol (ID: `keyterm:Example`); Authority (ID: `keyterm:Authority.2`); Court Case (ID: `keyterm:CourtCase`); Name (ID: `keyterm:Name`); Decided (ID: `keyterm:Decided`); Babeli (ID: `place:Babylon`); Demons (ID: `deity:Demons`); Happy (ID: `keyterm:Happy`); Holy (ID: `keyterm:Holy`); Bow Down (ID: `keyterm:BowDown`); Kingdom (ID: `keyterm:Kingdom`); True (ID: `keyterm:True`); Frog (ID: `fauna:Frog`); Talent (ID: `realia:Talent`); Dragon (ID: `fauna:Dragon`); Clothing (ID: `realia:Clothing`); Image (ID: `realia:Image`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); Kingdom (ID: `keyterm:Kingdom`); Ability (ID: `keyterm:Ability`); Yesu (ID: `person:Jesus.2`); Authority (ID: `keyterm:Authority.2`); Fornication (ID: `keyterm:Fornication`); An Angel (ID: `deity:Angel`); Abomination (ID: `keyterm:Abomination`); Defilement (ID: `keyterm:Defilement`); Judgment (ID: `keyterm:Judgment`); Abyss (ID: `keyterm:Abyss`); BWANA (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Faithfulness (ID: `keyterm:Faithfulness`); Heart (ID: `keyterm:Heart`); Blaspheme (ID: `keyterm:Blaspheme`); Roho (ID: `deity:HolySpirit`); Body (ID: `keyterm:Body.3`); Babeli (ID: `place:Babylon`); Holy (ID: `keyterm:Holy`); Blood (ID: `keyterm:Blood`); Witness (ID: `keyterm:Witness`); Chosen (ID: `keyterm:Chosen`); Purple Cloth (ID: `realia:PurpleCloth`); Gold Jewelry (ID: `realia:GoldJewelry`); Bowl (ID: `realia:Bowl.2`); Scroll (ID: `realia:Scroll`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Throne (ID: `realia:Throne`); Idolater (ID: `keyterm:Idolater`); Holy (ID: `keyterm:Holy`); Be Unfaithful (ID: `keyterm:Unfaithful`); True (ID: `keyterm:True`); Life (ID: `keyterm:Life`); A Disembodied Voice (ID: `deity:Voice`); Yerusalemu (ID: `place:Jerusalem`); Faithfulness (ID: `keyterm:Faithfulness`); Tabernacle (ID: `realia:Tabernacle`)
...
* **Associated ACAI Concepts:** City Wall (ID: `realia:CityWall`); Temple (ID: `realia:Temple`); An Angel (ID: `deity:Angel`); Foundation (ID: `realia:Foundation`); Clean (ID: `keyterm:Clean`); BWANA (ID: `deity:Lord`); Name (ID: `keyterm:Name`); Measuring Rod (ID: `realia:MeasuringRod`); Measuring Reed (ID: `realia:MeasuringReed`); Reed (ID: `flora:Reed`); Holy (ID: `keyterm:Holy`); Israeli (ID: `person:Israel`); Sky (ID: `keyterm:Heaven`); Glory (ID: `keyterm:Glory`); Roho (ID: `deity:HolySpirit`); Yerusalemu (ID: `place:Jerusalem`); Bowl (ID: `realia:Bowl.2`); Cubit (ID: `realia:Cubit.2`)
