...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Yerusalemu (ID: `place:Jerusalem`); Sulemani (ID: `person:Solomon`); Lebanoni (ID: `place:Lebanon`); Swear (ID: `keyterm:Swear`); Vine (ID: `flora:Vine`); Lily (ID: `flora:Lily`); Wine (ID: `realia:Wine`); Gazelle (ID: `fauna:Gazelle`); Dove (ID: `fauna:Dove`); Balsam Tree (ID: `flora:BalsamTree`); Myrrh (ID: `flora:Myrrh`); Pomegranate (ID: `flora:Pomegranate`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Deer (ID: `fauna:Deer`); Apple (ID: `flora:AppleTree`); Money (ID: `realia:Money`); Veil (ID: `realia:Veil`); Hermoni (ID: `place:HermonMount`); Gileadi (ID: `place:Gilead`); Fairness (ID: `keyterm:Fairness`); Henna (ID: `flora:Henna`); Nard (ID: `flora:Nard`); Sheep (ID: `fauna:Lamb`); Frankincense (ID: `flora:Frankincense`); Cedar (ID: `flora:Cedar`); Tower (ID: `realia:Tower`); Standard (ID: `realia:Standard`)
