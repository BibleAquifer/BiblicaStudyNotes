...
* **Associated ACAI Concepts:** Loisi (ID: `person:Lois`); Eunike (ID: `person:Eunice`); Figelo (ID: `person:Phygelus`); Hermogene (ID: `person:Hermogenes`); Onesiforo (ID: `person:Onesiphorus`); Long For (ID: `keyterm:LongFor`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Fileto (ID: `person:Philetus`); Himenayo (ID: `person:Hymenaeus`); Approved (ID: `keyterm:Approved`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Yambre (ID: `person:Jambres`); Yane (ID: `person:Jannes`); Ikonio (ID: `place:Iconium`); Declare (ID: `keyterm:Declare`); Written (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** Kreske (ID: `person:Crescens`); Klaudia (ID: `person:Claudia`); Karpo (ID: `person:Carpus`); Dalmatia (ID: `place:Dalmatia`); Pude (ID: `person:Pudens`); Parchment (ID: `realia:Parchment`); Eubulo (ID: `person:Eubulus`); Lino (ID: `person:Linus`); Iskanda (ID: `person:Alexander.4`); Onesiforo (ID: `person:Onesiphorus`); Deliver (ID: `keyterm:Deliver`); Mileto (ID: `place:Miletus`); Dema (ID: `person:Demas`); Erasto (ID: `person:Erastus`); Trofimo (ID: `person:Trophimus`); Luka (ID: `person:Luke`); Priskila (ID: `person:Priscilla`); Yesu (ID: `person:Jesus.2`)
