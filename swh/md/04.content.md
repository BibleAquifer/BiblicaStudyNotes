...
* **Associated ACAI Concepts:** Musa (ID: `person:Moses`); BWANA (ID: `deity:Lord`); Haruni (ID: `person:Aaron`); Israeli (ID: `person:Israel`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Gershoni (ID: `person:Gershon`); Kohathi (ID: `person:Kohath`); Holy (ID: `keyterm:Holy`); Merari (ID: `person:Merari`); Force to Serve (ID: `keyterm:EnticedToServe`); Gershonites (ID: `group:Gershon`); Kohathites (ID: `group:Kohath`); Yuda (ID: `person:Judah.4`); Reubeni (ID: `person:Reuben`); Efraimu (ID: `group:Ephraim`); Reubeni (ID: `group:Reuben`); Dani (ID: `group:Dan`); Yuda (ID: `group:Judah`); Dani (ID: `place:Dan`); Efraimu (ID: `person:Ephraim`); Tent of Meeting (ID: `realia:TentOfMeeting`); Standard (ID: `realia:Standard`); Ithamari (ID: `person:Ithamar`); Sinai (ID: `place:SinaiWilderness`); Isakari (ID: `group:Issachar`); Asheri (ID: `person:Asher`); Simeoni (ID: `group:Simeon`); Naftali (ID: `person:Naphtali`); Simeoni (ID: `person:Simeon.5`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); To Sin (ID: `keyterm:Sin`); BWANA (ID: `deity:Lord`); Slaughtering (ID: `keyterm:Slaughtering`); Israeli (ID: `person:Israel`); Musa (ID: `person:Moses`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Haruni (ID: `person:Aaron`); Force to Serve (ID: `keyterm:EnticedToServe`); Dish (ID: `realia:Dish`); Shekel (ID: `realia:Shekel`); Money (ID: `realia:Money`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Tent of Meeting (ID: `realia:TentOfMeeting`); Pure (ID: `keyterm:Pure`); Smear (ID: `keyterm:Smear`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Appease (ID: `keyterm:Appease`); Wagon (ID: `realia:Wagon`); Amishadai (ID: `person:Ammishaddai`); Pagieli (ID: `person:Pagiel`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Musa (ID: `person:Moses`); Passover (ID: `keyterm:Passover`); Standard (ID: `realia:Standard`); Trumpet (ID: `realia:Trumpet`); Defilement (ID: `keyterm:Defilement`); Sinai (ID: `place:SinaiWilderness`); Offering (ID: `keyterm:Offering`); Testimony (ID: `keyterm:Witness.2`); Covenant Box (ID: `keyterm:CovenantBox`); Haruni (ID: `person:Aaron`); Amihudi (ID: `person:Ammihud`); Yethro (ID: `person:Jethro`); Pagieli (ID: `person:Pagiel`); Elisuri (ID: `person:Elizur`); Kohathites (ID: `group:Kohath`); Ahiezeri (ID: `person:Ahiezer`); Eliasafu (ID: `person:Eliasaph`); Suari (ID: `person:Zuar`); Hobabu (ID: `person:Hobab`); Abidani (ID: `person:Abidan`); Gamalieli (ID: `person:Gamaliel.2`); Suri-shadai (ID: `person:Zurishaddai`); Enani (ID: `person:Enan`); Ahira (ID: `person:Ahira`); Deueli (ID: `person:Deuel`); Okirani (ID: `person:Ochran`); Pedasuri (ID: `person:Pedahzur`); Eliabu (ID: `person:Eliab`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); Israeli (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Haruni (ID: `person:Aaron`); Defilement (ID: `keyterm:Defilement`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Kora (ID: `person:Korah.3`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Abiramu (ID: `person:Abiram`); To Cause to Possess (ID: `keyterm:Possess`); Pure (ID: `keyterm:Pure`); Holy (ID: `keyterm:Holy`); Dathani (ID: `person:Dathan`); Force to Serve (ID: `keyterm:EnticedToServe`); Testimony (ID: `keyterm:Witness.2`); To Cleanse (ID: `keyterm:Cleanse.2`); Tent of Meeting (ID: `realia:TentOfMeeting`); Cattle (ID: `fauna:Bull`); Rod (ID: `realia:Rod`); Appease (ID: `keyterm:Appease`); Eleazari (ID: `person:Eleazar.2`); Instruction (ID: `keyterm:Instruction`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Temple Altar (ID: `realia:TempleAltar`); Shovel (ID: `realia:Shovel`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); To Cause to Possess (ID: `keyterm:Possess`); Yordani (ID: `place:Jordan`); Refuge (ID: `keyterm:Refuge`); Gadi (ID: `person:Gad`); Reubeni (ID: `person:Reuben`); Reubeni (ID: `group:Reuben`); Wakanaani (ID: `place:Canaan`); Manase (ID: `group:Manasseh`); Manase (ID: `person:Manasseh`); Dispossess (ID: `keyterm:Dispossess`); Gileadi (ID: `place:Gilead`); Walawi (ID: `person:Levi.3`); Yusufu (ID: `person:Joseph.10`); Misri (ID: `place:Egypt`); Walawi (ID: `group:Levi`); tambarare (ID: `place:MoabPlains`); Yeriko (ID: `place:Jericho`); Diboni (ID: `place:Dibon`); Hori (ID: `place:HorMount`); Kadeshi (ID: `place:Kadesh-barnea`); Lot (ID: `keyterm:Lot`); Selofehadi (ID: `person:Zelophehad`); Makiri (ID: `person:Machir`); Sini (ID: `place:Zin`); Eleazari (ID: `person:Eleazar.2`); Yoshua (ID: `person:Joshua.2`); Nuni (ID: `person:Nun`)
