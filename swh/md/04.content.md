...
* **Associated Articles:** Mungu (ID: `367690@BiblicaStudyNotesKeyTerms`); Ukoo (ID: `367711@BiblicaStudyNotes`); Kutoa sadaka  watoto (ID: `367755@BiblicaStudyNotesKeyTerms`); Israeli (ID: `367771@BiblicaStudyNotesKeyTerms`); Makabila 12 (ID: `367777@BiblicaStudyNotesKeyTerms`); Yuda (ID: `367782@BiblicaStudyNotesKeyTerms`); Musa (ID: `367791@BiblicaStudyNotesKeyTerms`); Aroni (ID: `367797@BiblicaStudyNotesKeyTerms`); Mlima Sinai (ID: `367818@BiblicaStudyNotesKeyTerms`); Kuhani (ID: `367824@BiblicaStudyNotesKeyTerms`); Hema takatifu (ID: `367825@BiblicaStudyNotesKeyTerms`); Walawi (ID: `367834@BiblicaStudyNotesKeyTerms`); Kuwekwa kando (ID: `367849@BiblicaStudyNotesKeyTerms`); Takatifu (ID: `367852@BiblicaStudyNotesKeyTerms`); Lawi (ID: `367874@BiblicaStudyNotesKeyTerms`); Safi au chafu (ID: `367854@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Musa (ID: `person:Moses`); BWANA (ID: `deity:Lord`); Haruni (ID: `person:Aaron`); Israeli (ID: `person:Israel`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Gershoni (ID: `person:Gershon`); Kohathi (ID: `person:Kohath`); Holy (ID: `keyterm:Holy`); Merari (ID: `person:Merari`); Force to Serve (ID: `keyterm:EnticedToServe`); Gershonites (ID: `group:Gershon`); Yuda (ID: `group:Judah`); Reubeni (ID: `group:Reuben`); Reubeni (ID: `person:Reuben`); Efraimu (ID: `group:Ephraim`); Dani (ID: `place:Dan`); Efraimu (ID: `person:Ephraim`); Dani (ID: `group:Dan`); Kohathites (ID: `group:Kohath`); Yuda (ID: `person:Judah.4`); Tent of Meeting (ID: `realia:TentOfMeeting`); Standard (ID: `realia:Standard`); Ithamari (ID: `person:Ithamar`); Sinai (ID: `place:SinaiWilderness`); Asheri (ID: `group:Asher`); Simeoni (ID: `group:Simeon`); Simeoni (ID: `person:Simeon.5`); Naftali (ID: `person:Naphtali`); Naftali (ID: `group:Naphtali`)
...
* **Associated Articles:** Dhambi (ID: `367686@BiblicaStudyNotes`); Ndoa (ID: `367697@BiblicaStudyNotesKeyTerms`); Amani (ID: `367702@BiblicaStudyNotesKeyTerms`); Dhabihu (ID: `367747@BiblicaStudyNotesKeyTerms`); Uchawi (ID: `367801@BiblicaStudyNotesKeyTerms`); Kutubu (ID: `367837@BiblicaStudyNotesKeyTerms`); Fidia (ID: `367858@BiblicaStudyNotesKeyTerms`); Wanadhiri (ID: `367875@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Nazirites (ID: `group:Nazirite`); Defilement (ID: `keyterm:Defilement`); Consecration (ID: `keyterm:Consecration.2`); Passion (ID: `keyterm:Ardour`); Withdraw Oneself (ID: `keyterm:WithdrawOneself`); Israeli (ID: `person:Israel`); To Curse (ID: `keyterm:Curse`); To Sin (ID: `keyterm:Sin`); Instruction (ID: `keyterm:Instruction`); Musa (ID: `person:Moses`); Holy (ID: `keyterm:Holy`); Wine (ID: `realia:Wine`); Sheep (ID: `fauna:Lamb`); Bless (ID: `keyterm:Bless`); Be Blameless (ID: `keyterm:Blameless`); Be Unfaithful (ID: `keyterm:Unfaithful`); Vow (ID: `keyterm:Vow`); Slaughtering (ID: `keyterm:Slaughtering`); Appease (ID: `keyterm:Appease`); Swear (ID: `keyterm:Swear`); Pure (ID: `keyterm:Pure`); Be Zealous (ID: `keyterm:Zealous`); Vine (ID: `flora:Vine`); Tent of Meeting (ID: `realia:TentOfMeeting`); Basket (ID: `realia:Basket`); Unleavened Bread (ID: `realia:UnleavenedBread`); Peace (ID: `keyterm:IntactState`); Haruni (ID: `person:Aaron`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); Cattle (ID: `fauna:Bull`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); BWANA (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Slaughtering (ID: `keyterm:Slaughtering`); Musa (ID: `person:Moses`); Israeli (ID: `person:Israel`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Haruni (ID: `person:Aaron`); Force to Serve (ID: `keyterm:EnticedToServe`); Dish (ID: `realia:Dish`); Money (ID: `realia:Money`); Shekel (ID: `realia:Shekel`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Tent of Meeting (ID: `realia:TentOfMeeting`); Pure (ID: `keyterm:Pure`); Smear (ID: `keyterm:Smear`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Appease (ID: `keyterm:Appease`); Wagon (ID: `realia:Wagon`); Ahiezeri (ID: `person:Ahiezer`); Abidani (ID: `person:Abidan`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Musa (ID: `person:Moses`); Passover (ID: `keyterm:Passover`); Standard (ID: `realia:Standard`); Trumpet (ID: `realia:Trumpet`); Offering (ID: `keyterm:Offering`); Defilement (ID: `keyterm:Defilement`); Sinai (ID: `place:SinaiWilderness`); Testimony (ID: `keyterm:Witness.2`); Covenant Box (ID: `keyterm:CovenantBox`); Haruni (ID: `person:Aaron`); Yethro (ID: `person:Jethro`); Ahiezeri (ID: `person:Ahiezer`); Abidani (ID: `person:Abidan`); Eliabu (ID: `person:Eliab`); Ahira (ID: `person:Ahira`); Gamalieli (ID: `person:Gamaliel.2`); Suari (ID: `person:Zuar`); Hobabu (ID: `person:Hobab`); Pagieli (ID: `person:Pagiel`); Enani (ID: `person:Enan`); Deueli (ID: `person:Deuel`); Okirani (ID: `person:Ochran`); Elisuri (ID: `person:Elizur`); Pedasuri (ID: `person:Pedahzur`); Amihudi (ID: `person:Ammihud`); Eliasafu (ID: `person:Eliasaph`); Suri-shadai (ID: `person:Zurishaddai`); Kohathites (ID: `group:Kohath`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); Israeli (ID: `person:Israel`); Misri (ID: `place:Egypt`); Haruni (ID: `person:Aaron`); Kalebu (ID: `person:Caleb`); Nuni (ID: `person:Nun`); Yoshua (ID: `person:Joshua.2`); Wakanaani (ID: `place:Canaan`); Miriamu (ID: `person:Miriam`); Yefune (ID: `person:Jephunneh`); Amaleki (ID: `place:Amalek`); Amalekites (ID: `group:Amalek`); Canaanites (ID: `group:Canaan`); Tent (ID: `realia:Tent`); Parani (ID: `place:Paran`); Negebu (ID: `place:Negeb`); Speak as a Prophet (ID: `keyterm:Speak`); Anaki (ID: `person:Anak`); Forgive (ID: `keyterm:Forgive`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Passion (ID: `keyterm:Ardour`); Swear (ID: `keyterm:Swear`); Dispossess (ID: `keyterm:Dispossess`); Glory (ID: `keyterm:Glory`); Eldadi (ID: `person:Eldad`); Kibroth-hataava (ID: `place:Kibroth-hattaavah`); Medadi (ID: `person:Medad`); Haserothi (ID: `place:Hazeroth`); Land Flowing of Milk and Honey (ID: `keyterm:LandFlowingOfMilkAndHoney`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); Israeli (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Haruni (ID: `person:Aaron`); Defilement (ID: `keyterm:Defilement`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Kora (ID: `person:Korah.3`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Abiramu (ID: `person:Abiram`); To Cause to Possess (ID: `keyterm:Possess`); Holy (ID: `keyterm:Holy`); Pure (ID: `keyterm:Pure`); Dathani (ID: `person:Dathan`); Testimony (ID: `keyterm:Witness.2`); Force to Serve (ID: `keyterm:EnticedToServe`); To Cleanse (ID: `keyterm:Cleanse.2`); Tent of Meeting (ID: `realia:TentOfMeeting`); Cattle (ID: `fauna:Bull`); Rod (ID: `realia:Rod`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Instruction (ID: `keyterm:Instruction`); Appease (ID: `keyterm:Appease`); Eleazari (ID: `person:Eleazar.2`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Shovel (ID: `realia:Shovel`)
...
* **Associated ACAI Concepts:** Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); To Cause to Possess (ID: `keyterm:Possess`); Yordani (ID: `place:Jordan`); Refuge (ID: `keyterm:Refuge`); Gadi (ID: `person:Gad`); Reubeni (ID: `group:Reuben`); Reubeni (ID: `person:Reuben`); Wakanaani (ID: `place:Canaan`); Manase (ID: `person:Manasseh`); Manase (ID: `group:Manasseh`); Gileadi (ID: `place:Gilead`); Dispossess (ID: `keyterm:Dispossess`); Yusufu (ID: `person:Joseph.10`); Misri (ID: `place:Egypt`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); tambarare (ID: `place:MoabPlains`); Yeriko (ID: `place:Jericho`); Hori (ID: `place:HorMount`); Diboni (ID: `place:Dibon`); Kadeshi (ID: `place:Kadesh-barnea`); Selofehadi (ID: `person:Zelophehad`); Lot (ID: `keyterm:Lot`); Makiri (ID: `person:Machir`); Yoshua (ID: `person:Joshua.2`); Yazeri (ID: `place:Jazer`); Sini (ID: `place:Zin`); Nuni (ID: `person:Nun`)
