...
* **Associated ACAI Concepts:** Dugong (ID: `fauna:Dugong`); Covering (ID: `realia:Covering`); Gershonites (ID: `group:Gershon`); Gershoni (ID: `person:Gershon`); Kohathi (ID: `person:Kohath`); Standard (ID: `realia:Standard`); Screen (ID: `realia:Screen`); Merari (ID: `person:Merari`); Leather (ID: `realia:Leather`); Walawi (ID: `person:Levi.3`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Sinai (ID: `place:SinaiWilderness`); Ithamari (ID: `person:Ithamar`); Surieli (ID: `person:Zuriel`); Laeli (ID: `person:Lael`); Abihaili (ID: `person:Abihail`); Eliasafu (ID: `person:Eliasaph.2`); Shedeuri (ID: `person:Shedeur`); Pedasuri (ID: `person:Pedahzur`); Suri-shadai (ID: `person:Zurishaddai`); Ahiezeri (ID: `person:Ahiezer`); Amishadai (ID: `person:Ammishaddai`); Okirani (ID: `person:Ochran`); Nethaneli (ID: `person:Nethanel`); Gideoni (ID: `person:Gideoni`); Deueli (ID: `person:Deuel`); Elisuri (ID: `person:Elizur`); Pagieli (ID: `person:Pagiel`); Shelumieli (ID: `person:Shelumiel`); Eliasafu (ID: `person:Eliasaph`)
...
* **Associated ACAI Concepts:** Dish (ID: `realia:Dish`); Tent of Meeting (ID: `realia:TentOfMeeting`); Wagon (ID: `realia:Wagon`); Shedeuri (ID: `person:Shedeur`); Pedasuri (ID: `person:Pedahzur`); Ahiezeri (ID: `person:Ahiezer`); Amishadai (ID: `person:Ammishaddai`); Nethaneli (ID: `person:Nethanel`); Gideoni (ID: `person:Gideoni`); Pagieli (ID: `person:Pagiel`); Shelumieli (ID: `person:Shelumiel`); Gamalieli (ID: `person:Gamaliel.2`); Abidani (ID: `person:Abidan`); Heloni (ID: `person:Helon`); Lampstand (ID: `realia:Lampstand.2`); Elishama (ID: `person:Elishama`); Nashoni (ID: `person:Nahshon`); Shekel (ID: `realia:Shekel`); Slaughtering (ID: `keyterm:Slaughtering`); Offering (ID: `keyterm:Offering`); Anointing Oil (ID: `realia:AnointingOil`); Cattle (ID: `fauna:Bull`); Olive Oil (ID: `realia:OliveOil`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Money (ID: `realia:Money`); Force to Serve (ID: `keyterm:EnticedToServe`)
...
* **Associated ACAI Concepts:** Standard (ID: `realia:Standard`); Trumpet (ID: `realia:Trumpet`); Hobabu (ID: `person:Hobab`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Bitter Herbs (ID: `flora:Chicory`); Pedasuri (ID: `person:Pedahzur`); Suri-shadai (ID: `person:Zurishaddai`); Ahiezeri (ID: `person:Ahiezer`); Okirani (ID: `person:Ochran`); Deueli (ID: `person:Deuel`); Elisuri (ID: `person:Elizur`); Pagieli (ID: `person:Pagiel`); Eliasafu (ID: `person:Eliasaph`); Gamalieli (ID: `person:Gamaliel.2`); Suari (ID: `person:Zuar`); Abidani (ID: `person:Abidan`); Enani (ID: `person:Enan`); Ahira (ID: `person:Ahira`); Eliabu (ID: `person:Eliab`); Amihudi (ID: `person:Ammihud`); Yethro (ID: `person:Jethro`); Kohathites (ID: `group:Kohath`); Passover (ID: `keyterm:Passover`); Musa (ID: `person:Moses`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Miriamu (ID: `person:Miriam`); Kalebu (ID: `person:Caleb`); Nuni (ID: `person:Nun`); Medadi (ID: `person:Medad`); Eldadi (ID: `person:Eldad`); Yefune (ID: `person:Jephunneh`); Sethuri (ID: `person:Sethur`); Wofsi (ID: `person:Nahbi`); Yusufu (ID: `person:Joseph.11`); Leek (ID: `flora:Leek`); Shafati (ID: `person:Shaphat`); Sodi (ID: `person:Sodi`); Onion (ID: `flora:Onion`); Rafu (ID: `person:Raphu`); Amieli (ID: `person:Ammiel`); Mikaeli (ID: `person:Michael`); Susi (ID: `person:Susi`); Geueli (ID: `person:Geuel`); Zakuri (ID: `person:Zaccur`); Wofsi (ID: `person:Vophsi`); Gadieli (ID: `person:Gaddiel`); Maki (ID: `person:Machi`); Wahori (ID: `person:Hori.2`); Gemali (ID: `person:Gemalli`); Gadi (ID: `person:Gaddi`); Watermelon (ID: `flora:Watermelon`); Igali (ID: `person:Igal`); Shamua (ID: `person:Shammua`); Palti (ID: `person:Palti`); Garlic (ID: `flora:Garlic`)
...
* **Associated ACAI Concepts:** Dathani (ID: `person:Dathan`); Abiramu (ID: `person:Abiram`); Kora (ID: `person:Korah.3`); Walawi (ID: `group:Levi`); Oni (ID: `person:On`); Pelethi (ID: `person:Peleth`); Eliabu (ID: `person:Eliab.2`); Threshing Floor (ID: `realia:ThreshingFloor`); Tassel (ID: `realia:Tassel`); Grain (ID: `flora:Grain`); Must (ID: `realia:Must`); Hin (ID: `realia:Hin`); Shovel (ID: `realia:Shovel`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Tent of Meeting (ID: `realia:TentOfMeeting`); Rod (ID: `realia:Rod`); To Cleanse (ID: `keyterm:Cleanse.2`); Testimony (ID: `keyterm:Witness.2`); Haruni (ID: `person:Aaron`); Defilement (ID: `keyterm:Defilement`); Musa (ID: `person:Moses`); Tent (ID: `realia:Tent`); Walawi (ID: `person:Levi.3`); Offering (ID: `keyterm:Offering`); Pure (ID: `keyterm:Pure`); To Cause to Possess (ID: `keyterm:Possess`); Cattle (ID: `fauna:Bull`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Balaki (ID: `person:Balak`); Balaamu (ID: `person:Balaam`); Sipori (ID: `person:Zippor`); Hori (ID: `place:HorMount`); Arnoni (ID: `place:Arnon`); Sihoni (ID: `person:Sihon`); njia (ID: `place:KingsHighway`); Bamothi (ID: `place:Bamoth`); Matana (ID: `place:Mattanah`); Donkey (ID: `fauna:Donkey`); Haruni (ID: `person:Aaron`); Kadeshi (ID: `place:Kadesh-barnea`); Kiriath-husothi (ID: `place:Kiriath-huzoth`); Sofimu (ID: `place:Zophim`); Wahebu (ID: `place:Waheb`); Moabites (ID: `group:Moab`); Sufa (ID: `place:Suphah`); Agagi (ID: `person:Agag`); watu (ID: `place:Amaw`); Beeri (ID: `place:Beer`); Atharimu (ID: `place:Atharim`); Messengers (ID: `group:Messengers`); Bamoth-baali (ID: `place:Bamoth-baal`); Beori (ID: `person:Beor.2`); Obothi (ID: `place:Oboth`); Eleazari (ID: `person:Eleazar.2`); Pisga (ID: `place:Pisgah`); Wild Ox (ID: `fauna:WildOx`); Pethori (ID: `place:Pethor`); Wakeni (ID: `place:Kain`)
...
* **Associated ACAI Concepts:** Vow (ID: `keyterm:Vow`); Hezronites (ID: `group:Hezron`); Shuhamites (ID: `group:Shuham`); Kozbi (ID: `person:Cozbi`); Heferi (ID: `person:Hepher`); Plague (ID: `keyterm:Blow`); Jachinites (ID: `group:Jachin`); Suri (ID: `person:Zur`); Punites (ID: `group:Punite`); Jashubites (ID: `group:Jashub`); Jahleelites (ID: `group:Jahleel`); Zimri (ID: `person:Zimri.3`); Shimronites (ID: `group:Shimron`); Hanochites (ID: `group:Hanoch`); Malchielites (ID: `group:Malchiel`); Bekeri (ID: `person:Becher.2`); Shillemites (ID: `group:Shillem`); Ardi (ID: `person:Ard.2`); Shuphamites (ID: `group:Shuphamite`); Machirites (ID: `group:Machir`); Asrielites (ID: `group:Asriel`); Iezerites (ID: `group:Iezer`); Jezerites (ID: `group:Jezer`); Hamulites (ID: `group:Hamul`); Tahani (ID: `person:Tahan`); Ishvites (ID: `group:Ishvi`); Tahanites (ID: `group:Tahan`); Shemidaites (ID: `group:Shemida`); Gunites (ID: `group:Guni`); Perezites (ID: `group:Perez`)
...
* **Associated ACAI Concepts:** Refuge (ID: `keyterm:Refuge`); Gadi (ID: `person:Gad`); Keheletha (ID: `place:Kehelathah`); Hashmona (ID: `place:Hashmonah`); Dofka (ID: `place:Dophkah`); Alushi (ID: `place:Alush`); Hori (ID: `place:HorMount.2`); Hori (ID: `place:HorMount`); Shefamu (ID: `place:Shepham`); Punoni (ID: `place:Punon`); Harada (ID: `place:Haradah`); Moserothi (ID: `place:Moseroth`); Atarothi (ID: `place:Ataroth`); Abrona (ID: `place:Abronah`); Sheferi (ID: `place:ShepherMount`); Tera (ID: `place:Terah`); Mithka (ID: `place:Mithkah`); Tahathi (ID: `place:Tahath`); Risa (ID: `place:Rissah`); Rithma (ID: `place:Rithmah`); Salmona (ID: `place:Zalmonah`); Libna (ID: `place:Libnah`); Almon-diblathaimu (ID: `place:Almon-diblathaim`); Rimon-peresi (ID: `place:Rimmon-perez`); Makelothi (ID: `place:Makheloth`); Diboni (ID: `place:Dibon`); Wakanaani (ID: `place:Canaan`); Hasar-adari (ID: `place:Hazar-addar`); Atrothi-shofani (ID: `place:Atroth-shophan`); Ribla (ID: `place:Riblah`)
