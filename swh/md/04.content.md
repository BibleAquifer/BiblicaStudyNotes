...
* **Associated ACAI Concepts:** Musa (ID: `person:Moses`); BWANA (ID: `deity:Lord`); Haruni (ID: `person:Aaron`); Israeli (ID: `person:Israel`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Gershoni (ID: `person:Gershon`); Kohathi (ID: `person:Kohath`); Holy (ID: `keyterm:Holy`); Merari (ID: `person:Merari`); Force to Serve (ID: `keyterm:EnticedToServe`); Gershonites (ID: `group:Gershon`); Yuda (ID: `group:Judah`); Dani (ID: `group:Dan`); Reubeni (ID: `group:Reuben`); Yuda (ID: `person:Judah.4`); Kohathites (ID: `group:Kohath`); Efraimu (ID: `group:Ephraim`); Dani (ID: `place:Dan`); Efraimu (ID: `person:Ephraim`); Reubeni (ID: `person:Reuben`); Tent of Meeting (ID: `realia:TentOfMeeting`); Standard (ID: `realia:Standard`); Ithamari (ID: `person:Ithamar`); Sinai (ID: `place:SinaiWilderness`); Zabuloni (ID: `group:Zebulun`); Isakari (ID: `group:Issachar`); Zabuloni (ID: `person:Zebulun`); Naftali (ID: `person:Naphtali`); Asheri (ID: `group:Asher`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Musa (ID: `person:Moses`); Passover (ID: `keyterm:Passover`); Trumpet (ID: `realia:Trumpet`); Standard (ID: `realia:Standard`); Offering (ID: `keyterm:Offering`); Defilement (ID: `keyterm:Defilement`); Sinai (ID: `place:SinaiWilderness`); Covenant Box (ID: `keyterm:CovenantBox`); Haruni (ID: `person:Aaron`); Testimony (ID: `keyterm:Witness.2`); Yethro (ID: `person:Jethro`); Pagieli (ID: `person:Pagiel`); Hobabu (ID: `person:Hobab`); Pedasuri (ID: `person:Pedahzur`); Enani (ID: `person:Enan`); Eliasafu (ID: `person:Eliasaph`); Okirani (ID: `person:Ochran`); Amihudi (ID: `person:Ammihud`); Kohathites (ID: `group:Kohath`); Ahira (ID: `person:Ahira`); Elisuri (ID: `person:Elizur`); Eliabu (ID: `person:Eliab`); Abidani (ID: `person:Abidan`); Suari (ID: `person:Zuar`); Deueli (ID: `person:Deuel`); Suri-shadai (ID: `person:Zurishaddai`); Ahiezeri (ID: `person:Ahiezer`); Gamalieli (ID: `person:Gamaliel.2`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); Israeli (ID: `person:Israel`); Misri (ID: `place:Egypt`); Haruni (ID: `person:Aaron`); Kalebu (ID: `person:Caleb`); Nuni (ID: `person:Nun`); Wakanaani (ID: `place:Canaan`); Yoshua (ID: `person:Joshua.2`); Miriamu (ID: `person:Miriam`); Yefune (ID: `person:Jephunneh`); Amaleki (ID: `place:Amalek`); Canaanites (ID: `group:Canaan`); Amalekites (ID: `group:Amalek`); Tent (ID: `realia:Tent`); Parani (ID: `place:Paran`); Anaki (ID: `person:Anak`); Speak as a Prophet (ID: `keyterm:Speak`); Negebu (ID: `place:Negeb`); Forgive (ID: `keyterm:Forgive`); Passion (ID: `keyterm:Ardour`); Glory (ID: `keyterm:Glory`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Dispossess (ID: `keyterm:Dispossess`); Swear (ID: `keyterm:Swear`); Kibroth-hataava (ID: `place:Kibroth-hattaavah`); Eldadi (ID: `person:Eldad`); Medadi (ID: `person:Medad`); Haserothi (ID: `place:Hazeroth`); bonde (ID: `place:EshcolValley`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); Israeli (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Haruni (ID: `person:Aaron`); Defilement (ID: `keyterm:Defilement`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Kora (ID: `person:Korah.3`); To Sin (ID: `keyterm:Sin`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Abiramu (ID: `person:Abiram`); To Cause to Possess (ID: `keyterm:Possess`); Holy (ID: `keyterm:Holy`); Pure (ID: `keyterm:Pure`); Dathani (ID: `person:Dathan`); Force to Serve (ID: `keyterm:EnticedToServe`); To Cleanse (ID: `keyterm:Cleanse.2`); Testimony (ID: `keyterm:Witness.2`); Tent of Meeting (ID: `realia:TentOfMeeting`); Cattle (ID: `fauna:Bull`); Rod (ID: `realia:Rod`); Instruction (ID: `keyterm:Instruction`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Eleazari (ID: `person:Eleazar.2`); Appease (ID: `keyterm:Appease`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Shovel (ID: `realia:Shovel`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Balaamu (ID: `person:Balaam`); Balaki (ID: `person:Balak`); Israeli (ID: `person:Israel`); Moabu (ID: `place:Moab`); Musa (ID: `person:Moses`); An Angel (ID: `deity:Angel`); To Curse (ID: `keyterm:Curse`); Haruni (ID: `person:Aaron`); Amorites (ID: `group:Amorites`); Bless (ID: `keyterm:Bless`); Misri (ID: `place:Egypt`); Sihoni (ID: `person:Sihon`); Edomu (ID: `place:Edom`); Proverb (ID: `keyterm:Saying`); Arnoni (ID: `place:Arnon`); Heshboni (ID: `place:Heshbon`); Sipori (ID: `person:Zippor`); Hori (ID: `place:HorMount`); Donkey (ID: `fauna:Donkey`); Kadeshi (ID: `place:Kadesh-barnea`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Altar (ID: `realia:Altar`); Sheep (ID: `fauna:Lamb`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); To Cause to Possess (ID: `keyterm:Possess`); Yordani (ID: `place:Jordan`); Refuge (ID: `keyterm:Refuge`); Gadi (ID: `person:Gad`); Reubeni (ID: `group:Reuben`); Reubeni (ID: `person:Reuben`); Wakanaani (ID: `place:Canaan`); Manase (ID: `group:Manasseh`); Manase (ID: `person:Manasseh`); Gileadi (ID: `place:Gilead`); Dispossess (ID: `keyterm:Dispossess`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Yeriko (ID: `place:Jericho`); Yusufu (ID: `person:Joseph.10`); tambarare (ID: `place:MoabPlains`); Misri (ID: `place:Egypt`); Hori (ID: `place:HorMount`); Diboni (ID: `place:Dibon`); Lot (ID: `keyterm:Lot`); Kadeshi (ID: `place:Kadesh-barnea`); Selofehadi (ID: `person:Zelophehad`); Makiri (ID: `person:Machir`); Haruni (ID: `person:Aaron`); Ethamu (ID: `place:Etham`); Yoshua (ID: `person:Joshua.2`); Yazeri (ID: `place:Jazer`)
