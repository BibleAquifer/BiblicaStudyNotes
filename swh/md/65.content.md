...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`); Love (ID: `keyterm:Love`); Yuda (ID: `person:Jude`); Favor (ID: `keyterm:Favor`); Believe (ID: `keyterm:Believe`); Ask for (ID: `keyterm:AskFor`); Salvation (ID: `keyterm:Salvation`); Make Peace (ID: `keyterm:Peace`); Judgment (ID: `keyterm:Judgment`); Beloved (ID: `keyterm:Beloved`); Mercy (ID: `keyterm:Mercy`); Eagerness (ID: `keyterm:Eagerness`); Holy (ID: `keyterm:Holy`); Yakobo (ID: `person:James.3`); In Common (ID: `keyterm:InCommon`)
...
* **Associated ACAI Concepts:** Blaspheme (ID: `keyterm:Blaspheme`); Court Case (ID: `keyterm:CourtCase`); Always (ID: `keyterm:Always`); Body (ID: `keyterm:Body.3`); Judgment (ID: `keyterm:Judgment`); BWANA (ID: `deity:Lord`); Kora (ID: `person:Korah.3`); To Command (ID: `keyterm:Command`); Fellowship Meal (ID: `keyterm:FellowshipMeal`); Misri (ID: `place:Egypt`); Disaster (ID: `keyterm:Disaster`); An Angel (ID: `deity:Angel`); Sodoma (ID: `place:Sodom`); Gomora (ID: `place:Gomorrah`); Adamu (ID: `person:Adam`); Kaini (ID: `person:Cain`); Mikaeli (ID: `person:Michael.11`); Ability (ID: `keyterm:Ability`); Eternal Fire (ID: `keyterm:EternalFire`); Musa (ID: `person:Moses`); Discern (ID: `keyterm:Discern`); Defilement (ID: `keyterm:Defilement`); Henoko (ID: `person:Enoch.2`); Believe (ID: `keyterm:Believe`); Salvation (ID: `keyterm:Salvation`); Yesu (ID: `person:Jesus.2`); Speak as a Prophet (ID: `keyterm:Speak`); Balaamu (ID: `person:Balaam`); Holy (ID: `keyterm:Holy`); Chain (ID: `realia:Chain`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Mercy (ID: `keyterm:Mercy`); Yesu (ID: `person:Jesus.2`); Always (ID: `keyterm:Always`); Beloved (ID: `keyterm:Beloved`); BWANA (ID: `deity:Lord`); Roho (ID: `deity:HolySpirit`); Glory (ID: `keyterm:Glory`); Authority (ID: `keyterm:Authority.2`); Fear (ID: `keyterm:Fear`); Natural (ID: `keyterm:Natural`); Creating Divisions (ID: `keyterm:CreatingDivisions`); Ability (ID: `keyterm:Ability`); Body (ID: `keyterm:Body.3`); Pray (ID: `keyterm:Pray`); Discern (ID: `keyterm:Discern`); Unblemished (ID: `keyterm:Unblemished`); Life (ID: `keyterm:Life`); Savior (ID: `keyterm:Savior`); Believe (ID: `keyterm:Believe`); Salvation (ID: `keyterm:Salvation`); Surely! (ID: `keyterm:Surely`); Holy (ID: `keyterm:Holy`); Love (ID: `keyterm:Love`); Word (ID: `keyterm:Word`); Clothing (ID: `realia:Clothing`)
