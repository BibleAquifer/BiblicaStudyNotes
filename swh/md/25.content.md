...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); Rebel (ID: `keyterm:Rebel`); Yerusalemu (ID: `place:Jerusalem`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Jackal (ID: `fauna:Jackal`); Usi (ID: `place:Uz`); Defile (ID: `keyterm:Stain`); Ostrich (ID: `fauna:Ostrich`); To Sin (ID: `keyterm:Sin`); Yerusalemu (ID: `place:Jerusalem`); BWANA (ID: `deity:Lord`)
