...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); Moabu (ID: `place:Moab`); Ruthu (ID: `person:Ruth`); Bethlehemu (ID: `place:Bethlehem`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Kilioni (ID: `person:Chilion`); Orpa (ID: `person:Orpah`); Elimeleki (ID: `person:Elimelech`); Maloni (ID: `person:Mahlon`); Women (ID: `group:GenericFemales`); Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Appoint (ID: `keyterm:Appoint`); Kindness (ID: `keyterm:Kindness`); Hope (ID: `keyterm:Hope`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Boazi (ID: `person:Boaz`); Barley (ID: `flora:Barley`); Naomi (ID: `person:Naomi`); Ruthu (ID: `person:Ruth`); Favor (ID: `keyterm:Favor`); BWANA (ID: `deity:Lord`); Moabu (ID: `place:Moab`); Bless (ID: `keyterm:Bless`); Elimeleki (ID: `person:Elimelech`); Sickle (ID: `realia:Sickle`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Israeli (ID: `person:Israel`); Kindness (ID: `keyterm:Kindness`); Bethlehemu (ID: `place:Bethlehem`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Ephah (ID: `realia:Ephah`)
...
* **Associated ACAI Concepts:** Boazi (ID: `person:Boaz`); Naomi (ID: `person:Naomi`); BWANA (ID: `deity:Lord`); Ruthu (ID: `person:Ruth`); Redeem (ID: `keyterm:Redeem`); Obedi (ID: `person:Obed`); Threshing Floor (ID: `realia:ThreshingFloor`); To Cause to Possess (ID: `keyterm:Possess`); Israeli (ID: `person:Israel`); Moabu (ID: `place:Moab`); Kinsman Redeemer (ID: `person:KinsmanRedeemer`); Hesroni (ID: `person:Hezron.2`); Salmoni (ID: `person:Salmon`); Barley (ID: `flora:Barley`); Yese (ID: `person:Jesse`); Bless (ID: `keyterm:Bless`); Daudi (ID: `person:David`); Peresi (ID: `person:Perez`); Maloni (ID: `person:Mahlon`); Elimeleki (ID: `person:Elimelech`); Aminadabu (ID: `person:Amminadab`); Kilioni (ID: `person:Chilion`); Women (ID: `group:GenericFemales`); Ramu (ID: `person:Ram`); Kindness (ID: `keyterm:Kindness`); Fear (ID: `keyterm:Fear`); Yuda (ID: `group:Judah`); Nashoni (ID: `person:Nahshon`); Raheli (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Lea (ID: `person:Leah`); Tamari (ID: `person:Tamar`); Yuda (ID: `person:Judah.4`); Bethlehemu (ID: `place:Bethlehem`); Love (ID: `keyterm:Love`)
