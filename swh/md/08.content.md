...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); Moabu (ID: `place:Moab`); Ruthu (ID: `person:Ruth`); Bethlehemu (ID: `place:Bethlehem`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Orpa (ID: `person:Orpah`); Kilioni (ID: `person:Chilion`); Maloni (ID: `person:Mahlon`); Elimeleki (ID: `person:Elimelech`); Ephrathites (ID: `group:Ephrathah`); Women (ID: `group:GenericFemales`); Efrata (ID: `person:Ephrathah`); Kindness (ID: `keyterm:Kindness`); Appoint (ID: `keyterm:Appoint`); Hope (ID: `keyterm:Hope`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Boazi (ID: `person:Boaz`); Barley (ID: `flora:Barley`); Naomi (ID: `person:Naomi`); Ruthu (ID: `person:Ruth`); Favor (ID: `keyterm:Favor`); Bless (ID: `keyterm:Bless`); BWANA (ID: `deity:Lord`); Moabu (ID: `place:Moab`); Elimeleki (ID: `person:Elimelech`); Sickle (ID: `realia:Sickle`); Kindness (ID: `keyterm:Kindness`); Israeli (ID: `person:Israel`); Bethlehemu (ID: `place:Bethlehem`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Ephah (ID: `realia:Ephah`)
...
* **Associated ACAI Concepts:** Boazi (ID: `person:Boaz`); Naomi (ID: `person:Naomi`); BWANA (ID: `deity:Lord`); Ruthu (ID: `person:Ruth`); Redeem (ID: `keyterm:Redeem`); Obedi (ID: `person:Obed`); Threshing Floor (ID: `realia:ThreshingFloor`); To Cause to Possess (ID: `keyterm:Possess`); Moabu (ID: `place:Moab`); Israeli (ID: `person:Israel`); Kinsman Redeemer (ID: `person:KinsmanRedeemer`); Salmoni (ID: `person:Salmon`); Hesroni (ID: `person:Hezron.2`); Barley (ID: `flora:Barley`); Maloni (ID: `person:Mahlon`); Peresi (ID: `person:Perez`); Bless (ID: `keyterm:Bless`); Daudi (ID: `person:David`); Elimeleki (ID: `person:Elimelech`); Yese (ID: `person:Jesse`); Aminadabu (ID: `person:Amminadab`); Ramu (ID: `person:Ram`); Women (ID: `group:GenericFemales`); Kilioni (ID: `person:Chilion`); Raheli (ID: `person:Rachel`); Love (ID: `keyterm:Love`); Yuda (ID: `person:Judah.4`); Tamari (ID: `person:Tamar`); Bethlehemu (ID: `place:Bethlehem`); Nashoni (ID: `person:Nahshon`); Fear (ID: `keyterm:Fear`); Elders (ID: `group:GenericElders`); Kindness (ID: `keyterm:Kindness`); Lea (ID: `person:Leah`); Yuda (ID: `group:Judah`)
