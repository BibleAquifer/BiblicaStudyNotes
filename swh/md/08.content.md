...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Orpa (ID: `person:Orpah`); Moabu (ID: `place:Moab`); Ruthu (ID: `person:Ruth`); Kilioni (ID: `person:Chilion`); Maloni (ID: `person:Mahlon`); Elimeleki (ID: `person:Elimelech`); Ephrathites (ID: `group:Ephrathah`); Women (ID: `group:GenericFemales`); Efrata (ID: `person:Ephrathah`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Boazi (ID: `person:Boaz`); Naomi (ID: `person:Naomi`); Barley (ID: `flora:Barley`); Ruthu (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Boazi (ID: `person:Boaz`); Kinsman Redeemer (ID: `person:KinsmanRedeemer`); Ruthu (ID: `person:Ruth`); Obedi (ID: `person:Obed`); Salmoni (ID: `person:Salmon`); Women (ID: `group:GenericFemales`); Hesroni (ID: `person:Hezron.2`); Kilioni (ID: `person:Chilion`); Ramu (ID: `person:Ram`); BWANA (ID: `deity:Lord`)
