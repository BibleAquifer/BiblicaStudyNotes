...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); Moabu (ID: `place:Moab`); Ruthu (ID: `person:Ruth`); Bethlehemu (ID: `place:Bethlehem`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Kilioni (ID: `person:Chilion`); Orpa (ID: `person:Orpah`); Maloni (ID: `person:Mahlon`); Elimeleki (ID: `person:Elimelech`); Women (ID: `group:GenericFemales`); Efrata (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Appoint (ID: `keyterm:Appoint`); Hope (ID: `keyterm:Hope`); Kindness (ID: `keyterm:Kindness`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Boazi (ID: `person:Boaz`); Barley (ID: `flora:Barley`); Naomi (ID: `person:Naomi`); Ruthu (ID: `person:Ruth`); Moabu (ID: `place:Moab`); BWANA (ID: `deity:Lord`); Favor (ID: `keyterm:Favor`); Bless (ID: `keyterm:Bless`); Elimeleki (ID: `person:Elimelech`); Sickle (ID: `realia:Sickle`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Bethlehemu (ID: `place:Bethlehem`); Israeli (ID: `person:Israel`); Kindness (ID: `keyterm:Kindness`); Wheat (ID: `flora:Wheat`); Ephah (ID: `realia:Ephah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Boazi (ID: `person:Boaz`); Naomi (ID: `person:Naomi`); BWANA (ID: `deity:Lord`); Ruthu (ID: `person:Ruth`); Redeem (ID: `keyterm:Redeem`); Obedi (ID: `person:Obed`); Threshing Floor (ID: `realia:ThreshingFloor`); Israeli (ID: `person:Israel`); Moabu (ID: `place:Moab`); To Cause to Possess (ID: `keyterm:Possess`); Kinsman Redeemer (ID: `person:KinsmanRedeemer`); Hesroni (ID: `person:Hezron.2`); Salmoni (ID: `person:Salmon`); Barley (ID: `flora:Barley`); Yese (ID: `person:Jesse`); Maloni (ID: `person:Mahlon`); Elimeleki (ID: `person:Elimelech`); Daudi (ID: `person:David`); Peresi (ID: `person:Perez`); Aminadabu (ID: `person:Amminadab`); Bless (ID: `keyterm:Bless`); Women (ID: `group:GenericFemales`); Ramu (ID: `person:Ram`); Kilioni (ID: `person:Chilion`); Love (ID: `keyterm:Love`); Tamari (ID: `person:Tamar`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Lea (ID: `person:Leah`); Bethlehemu (ID: `place:Bethlehem`); Raheli (ID: `person:Rachel`); Kindness (ID: `keyterm:Kindness`); Elders (ID: `group:GenericElders`); Fear (ID: `keyterm:Fear`); Nashoni (ID: `person:Nahshon`)
