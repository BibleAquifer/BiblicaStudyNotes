...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Yeremia (ID: `person:Jeremiah.6`); Yerusalemu (ID: `place:Jerusalem`); Yosia (ID: `person:Josiah`); Complete (ID: `keyterm:Complete`); Hilkia (ID: `person:Hilkiah.7`); Appoint (ID: `keyterm:Appoint`); Yehoyakimu (ID: `person:Jehoiakim`); Benyamini (ID: `person:Benjamin`); Anathothi (ID: `place:Anathoth`); Holy (ID: `keyterm:Holy`); Sedekia (ID: `person:Zedekiah.3`); Fear (ID: `keyterm:Fear`); Amoni (ID: `person:Amon.3`); Benyamini (ID: `group:Benjamin`); Throne (ID: `realia:Throne`); Cooking Pot (ID: `realia:CookingPot`); Almond (ID: `flora:Almond`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Yerusalemu (ID: `place:Jerusalem`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Defection (ID: `keyterm:Defection`); To Cause to Possess (ID: `keyterm:Possess`); Misri (ID: `place:Egypt`); Peace (ID: `keyterm:IntactState`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Appoint (ID: `keyterm:Appoint`); Baali (ID: `deity:Baal`); Rebel (ID: `keyterm:Rebel`); Trust (ID: `keyterm:LeanOn`); Swear (ID: `keyterm:Swear`); Covenant (ID: `keyterm:Covenant`); Love (ID: `keyterm:Love`); Fear (ID: `keyterm:Fear`); Woe (ID: `keyterm:Woe`); To Sin (ID: `keyterm:Sin`); Perceive (ID: `keyterm:Perceive`); Truth (ID: `keyterm:Truth`); Instruction (ID: `keyterm:Instruction`); Passion (ID: `keyterm:Ardour`); Offering (ID: `keyterm:Offering`); Deceit (ID: `keyterm:Deceit`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Yerusalemu (ID: `place:Jerusalem`); Israeli (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Speak as a Prophet (ID: `keyterm:Speak`); Yeremia (ID: `person:Jeremiah.6`); To Sin (ID: `keyterm:Sin`); Babeli (ID: `place:Babylon`); Passion (ID: `keyterm:Ardour`); Peace (ID: `keyterm:IntactState`); Appoint (ID: `keyterm:Appoint`); Daudi (ID: `person:David`); Force to Serve (ID: `keyterm:EnticedToServe`); Tofethi (ID: `place:Topheth`); Love (ID: `keyterm:Love`); House (ID: `realia:House`); Pashuri (ID: `person:Pashhur.3`); Mto (ID: `place:Euphrates`); Nebukadneza (ID: `person:Nebuchadnezzar`); Wakaldayo (ID: `place:Chaldea`); Yekonia (ID: `person:Jehoiachin`); Sabbath (ID: `keyterm:Sabbath`); Chaldeans (ID: `group:Chaldea`); Lebanoni (ID: `place:Lebanon`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); Sedekia (ID: `person:Zedekiah.3`); Belt (ID: `realia:Belt`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Babeli (ID: `place:Babylon`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Yeremia (ID: `person:Jeremiah.6`); Force to Serve (ID: `keyterm:EnticedToServe`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Yerusalemu (ID: `place:Jerusalem`); Speak as a Prophet (ID: `keyterm:Speak`); Nebukadneza (ID: `person:Nebuchadnezzar`); Israeli (ID: `person:Israel`); Yosia (ID: `person:Josiah`); Buzi (ID: `place:Buz`); Farao (ID: `person:Pharaoh.10`); Usi (ID: `place:Uz`); Tema (ID: `place:Tema`); Zimri (ID: `place:Zimri`); Umedi (ID: `place:Media`); Be Blameless (ID: `keyterm:Blameless`); Tiro (ID: `place:Tyre`); Yehoyakimu (ID: `person:Jehoiakim`); Dedani (ID: `place:Dedan`); Wafilisti (ID: `place:Philistine`); Wasidoni (ID: `place:Sidon`); Waarabu (ID: `place:Arabia`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Gaza (ID: `place:Gaza`); Ekroni (ID: `place:Ekron`); Chaldeans (ID: `group:Chaldea`); Waamoni (ID: `place:Ammon`); Ashdodi (ID: `place:Ashdod`); Wafilisti (ID: `group:Philistine`); Moabu (ID: `place:Moab`); Amoni (ID: `person:Amon.3`); Ashkeloni (ID: `place:Ashkelon`); Appoint (ID: `keyterm:Appoint`); Wakaldayo (ID: `place:Chaldea`); Elamu (ID: `place:Elam`); Misri (ID: `place:Egypt`); Edomu (ID: `place:Edom`); Peace (ID: `keyterm:IntactState`); Passion (ID: `keyterm:Ardour`); Lamp (ID: `realia:Lamp`); Hand-Mill (ID: `realia:Hand-mill`); Lion (ID: `fauna:Lion`); Grass (ID: `flora:Grass`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Babeli (ID: `place:Babylon`); Yeremia (ID: `person:Jeremiah.6`); Speak as a Prophet (ID: `keyterm:Speak`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Yerusalemu (ID: `place:Jerusalem`); Force to Serve (ID: `keyterm:EnticedToServe`); Nebukadneza (ID: `person:Nebuchadnezzar`); Hanania (ID: `person:Hananiah.12`); Israeli (ID: `person:Israel`); Yehoyakimu (ID: `person:Jehoiakim`); House (ID: `realia:House`); Yoke (ID: `realia:Yoke`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Sedekia (ID: `person:Zedekiah.3`); Appoint (ID: `keyterm:Appoint`); Uria (ID: `person:Uriah.2`); Nehelamites (ID: `group:Nehelams`); Shemaya (ID: `person:Shemaiah.25`); Peace (ID: `keyterm:IntactState`); Yekonia (ID: `person:Jehoiachin`); Misri (ID: `place:Egypt`); Sedekia (ID: `person:Zedekiah.6`); Ahabu (ID: `person:Ahab.2`); Trust (ID: `keyterm:LeanOn`); Hezekia (ID: `person:Hezekiah`); Truth (ID: `keyterm:Truth`); Shafani (ID: `person:Shaphan`); Practice Divination (ID: `keyterm:PracticeDivination`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Yerusalemu (ID: `place:Jerusalem`); Yeremia (ID: `person:Jeremiah.6`); Wakaldayo (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Covenant (ID: `keyterm:Covenant`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Babeli (ID: `place:Babylon`); Passion (ID: `keyterm:Ardour`); Daudi (ID: `person:David`); To Sin (ID: `keyterm:Sin`); Hanameli (ID: `person:Hanamel`); Scroll (ID: `realia:Scroll`); Sedekia (ID: `person:Zedekiah.3`); Efraimu (ID: `person:Ephraim`); Fear (ID: `keyterm:Fear`); Efraimu (ID: `group:Ephraim`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Baruku (ID: `person:Baruch.4`); Redeem (ID: `keyterm:Redeem`); Walawi (ID: `person:Levi.3`); Peace (ID: `keyterm:IntactState`); Benyamini (ID: `person:Benjamin`); Anathothi (ID: `place:Anathoth`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yeremia (ID: `person:Jeremiah.6`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Babeli (ID: `place:Babylon`); Misri (ID: `place:Egypt`); Yerusalemu (ID: `place:Jerusalem`); Sedekia (ID: `person:Zedekiah.3`); Gedalia (ID: `person:Gedaliah.2`); Ishmaeli (ID: `person:Ishmael.2`); Israeli (ID: `person:Israel`); Wakaldayo (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Baruku (ID: `person:Baruch.4`); Ahikamu (ID: `person:Ahikam`); Nethania (ID: `person:Nethaniah`); Yohana (ID: `person:Johanan.5`); Karea (ID: `person:Kareah`); Mispa (ID: `place:Mizpah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Yehoyakimu (ID: `person:Jehoiakim`); Shafani (ID: `person:Shaphan`); Rekabu (ID: `person:Rechab.2`); Appoint (ID: `keyterm:Appoint`); Nebukadneza (ID: `person:Nebuchadnezzar`); Yonadabu (ID: `person:Jonadab`); Nebuzaradani (ID: `person:Nebuzaradan`); Ebedmeleki (ID: `person:Ebed-melech`); Neria (ID: `person:Neriah`); Force to Serve (ID: `keyterm:EnticedToServe`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Moabu (ID: `place:Moab`); Misri (ID: `place:Egypt`); Israeli (ID: `person:Israel`); Elamu (ID: `place:Elam`); Edomu (ID: `place:Edom`); Nebukadneza (ID: `person:Nebuchadnezzar`); Babeli (ID: `place:Babylon`); Kiriathaimu (ID: `place:Kiriathaim`); Heshboni (ID: `place:Heshbon`); Yeremia (ID: `person:Jeremiah.6`); Trust (ID: `keyterm:LeanOn`); Waamoni (ID: `place:Ammon`); Hazori (ID: `place:Hazor.5`); Horonaimu (ID: `place:Horonaim`); Neko (ID: `person:Neco`); Kemoshi (ID: `deity:Chemosh`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Appoint (ID: `keyterm:Appoint`); Dameski (ID: `place:Damascus`); Mto (ID: `place:Euphrates`); Ammonites (ID: `group:Ammon`); Counsel (ID: `keyterm:Counsel`); Yahasa (ID: `place:Jahaz`); Nebo (ID: `place:Nebo`); Bozrah (ID: `place:Bozrah.2`); Temani (ID: `place:Teman`); mto (ID: `place:Nile`); Dispossess (ID: `keyterm:Dispossess`); Visitation (ID: `keyterm:Visitation`)
...
* **Associated ACAI Concepts:** Babeli (ID: `place:Babylon`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Wakaldayo (ID: `place:Chaldea`); Appoint (ID: `keyterm:Appoint`); Chaldeans (ID: `group:Chaldea`); Yerusalemu (ID: `place:Jerusalem`); Yeremia (ID: `person:Jeremiah.6`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Holy (ID: `keyterm:Holy`); Horse (ID: `fauna:Horse`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Bow (ID: `realia:Bow`); To Sin (ID: `keyterm:Sin`); Arrow (ID: `keyterm:Arrow`); Graven Image (ID: `realia:GravenImage`); Seraya (ID: `person:Seraiah.8`); Beli (ID: `deity:Bel`); To Cause to Possess (ID: `keyterm:Possess`); Visitation (ID: `keyterm:Visitation`); Assyria (ID: `place:Assyria`); Nebukadneza (ID: `person:Nebuchadnezzar`); Medes (ID: `group:Mede`); Passion (ID: `keyterm:Ardour`); Wamedi (ID: `person:Medan`); Arrow (ID: `realia:Arrow`); Standard (ID: `realia:Standard`)
...
* **Associated ACAI Concepts:** Babeli (ID: `place:Babylon`); Yerusalemu (ID: `place:Jerusalem`); Sedekia (ID: `person:Zedekiah.3`); Nebuzaradani (ID: `person:Nebuzaradan`); BWANA (ID: `deity:Lord`); Nebukadneza (ID: `person:Nebuchadnezzar`); House (ID: `realia:House`); Yuda (ID: `person:Judah.4`); Chaldeans (ID: `group:Chaldea`); Wakaldayo (ID: `place:Chaldea`); Yuda (ID: `group:Judah`); Ribla (ID: `place:Riblah.2`); Hamathi (ID: `place:Hamath`); Judeans (ID: `group:Judea`); Yudea (ID: `place:Judea`); Yekonia (ID: `person:Jehoiachin`); Seraya (ID: `person:Seraiah.2`); Hamutali (ID: `person:Hamutal`); Yeremia (ID: `person:Jeremiah`); Evil-merodaki (ID: `person:Evil-merodach`); Under Siege (ID: `keyterm:StateOfBeingUnderSiege`); Cubit (ID: `realia:Cubit`); Cooking Pot (ID: `realia:CookingPot`); Shovel (ID: `realia:Shovel`); Pomegranate (ID: `flora:Pomegranate`); Sulemani (ID: `person:Solomon`); Yehoyakimu (ID: `person:Jehoiakim`); Yeriko (ID: `place:Jericho`); Rebel (ID: `keyterm:Rebel`); Libnah (ID: `place:Libnah.2`); Araba (ID: `place:Arabah`); Sefania (ID: `person:Zephaniah.2`); Siege-Works (ID: `realia:Siege-works`); Finger (ID: `realia:Finger`); Bowl (ID: `realia:Bowl`); Wick Trimmer (ID: `realia:WickTrimmer`); Lampstand (ID: `realia:Lampstand.2`); Thread (ID: `realia:Thread`); Doorstep (ID: `realia:Doorstep`); Money (ID: `realia:Money`); Prison (ID: `realia:Prison`); Cattle (ID: `fauna:Bull`)
