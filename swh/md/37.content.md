...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Hagai (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Shealtieli (ID: `person:Shealtiel.2`); Yehosadaki (ID: `person:Jehozadak`); Yoshua (ID: `person:Joshua.5`); Dario (ID: `person:Darius.2`); Yuda (ID: `person:Judah.4`); Zerubabeli (ID: `person:Zerubbabel.2`); Yuda (ID: `group:Judah`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Bag (ID: `realia:Bag`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`); Mule (ID: `fauna:Mule`); Must (ID: `realia:Must`); Olive Tree (ID: `flora:OliveTree`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Zerubabeli (ID: `person:Zerubbabel.2`); Yehosadaki (ID: `person:Jehozadak`); Shealtieli (ID: `person:Shealtiel.2`); Yoshua (ID: `person:Joshua.5`); Hagai (ID: `person:Haggai`); An Angel (ID: `deity:Angel`); Fear (ID: `keyterm:Fear`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Dario (ID: `person:Darius.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Yoshua (ID: `person:Joshua.5`); Zerubabeli (ID: `person:Zerubbabel.2`); Yehosadaki (ID: `person:Jehozadak`); Hagai (ID: `person:Haggai`); Shealtieli (ID: `person:Shealtiel.2`); Fear (ID: `keyterm:Fear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Misri (ID: `place:Egypt`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Peace (ID: `keyterm:IntactState`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Hagai (ID: `person:Haggai`); Defilement (ID: `keyterm:Defilement`); Vine (ID: `flora:Vine`); Holy (ID: `keyterm:Holy`); Bless (ID: `keyterm:Bless`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Instruction (ID: `keyterm:Instruction`); Dario (ID: `person:Darius.2`); Winepress (ID: `realia:Winepress`); Grain (ID: `flora:Grain`); Barley (ID: `flora:Barley`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Pomegranate (ID: `flora:Pomegranate`); Coriander (ID: `flora:Coriander`); Anointing Oil (ID: `realia:AnointingOil`); Stew (ID: `realia:Stew`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Zerubabeli (ID: `person:Zerubbabel.2`); BWANA (ID: `deity:Lord`); Shealtieli (ID: `person:Shealtiel.2`); Hagai (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Sword (ID: `realia:Sword`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`)
