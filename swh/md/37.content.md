...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Hagai (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Dario (ID: `person:Darius.2`); Yoshua (ID: `person:Joshua.5`); Shealtieli (ID: `person:Shealtiel.2`); Yehosadaki (ID: `person:Jehozadak`); Zerubabeli (ID: `person:Zerubbabel.2`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Bag (ID: `realia:Bag`); Olive Oil (ID: `realia:OliveOil`); Must (ID: `realia:Must`); Vine (ID: `flora:Vine`); Mule (ID: `fauna:Mule`); Grain (ID: `flora:Grain`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Zerubabeli (ID: `person:Zerubbabel.2`); Yehosadaki (ID: `person:Jehozadak`); Hagai (ID: `person:Haggai`); Yoshua (ID: `person:Joshua.5`); Shealtieli (ID: `person:Shealtiel.2`); Dario (ID: `person:Darius.2`); An Angel (ID: `deity:Angel`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Fear (ID: `keyterm:Fear`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Zerubabeli (ID: `person:Zerubbabel.2`); Yoshua (ID: `person:Joshua.5`); Yehosadaki (ID: `person:Jehozadak`); Hagai (ID: `person:Haggai`); Misri (ID: `place:Egypt`); Yuda (ID: `group:Judah`); Peace (ID: `keyterm:IntactState`); Yuda (ID: `person:Judah.4`); Shealtieli (ID: `person:Shealtiel.2`); Fear (ID: `keyterm:Fear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Hagai (ID: `person:Haggai`); Defilement (ID: `keyterm:Defilement`); Vine (ID: `flora:Vine`); Dario (ID: `person:Darius.2`); Instruction (ID: `keyterm:Instruction`); Bless (ID: `keyterm:Bless`); Holy (ID: `keyterm:Holy`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Coriander (ID: `flora:Coriander`); Olive Oil (ID: `realia:OliveOil`); Pomegranate (ID: `flora:Pomegranate`); Fig (ID: `flora:Fig`); Barley (ID: `flora:Barley`); Wine (ID: `realia:Wine`); Stew (ID: `realia:Stew`); Grain (ID: `flora:Grain`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** Zerubabeli (ID: `person:Zerubbabel.2`); BWANA (ID: `deity:Lord`); Hagai (ID: `person:Haggai`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Shealtieli (ID: `person:Shealtiel.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`)
