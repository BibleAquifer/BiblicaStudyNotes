...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Hagai (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Yoshua (ID: `person:Joshua.5`); Dario (ID: `person:Darius.2`); Yehosadaki (ID: `person:Jehozadak`); Shealtieli (ID: `person:Shealtiel.2`); Yuda (ID: `person:Judah.4`); Zerubabeli (ID: `person:Zerubbabel.2`); Yuda (ID: `group:Judah`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Must (ID: `realia:Must`); Grain (ID: `flora:Grain`); Olive Oil (ID: `realia:OliveOil`); Mule (ID: `fauna:Mule`); Bag (ID: `realia:Bag`); Olive Tree (ID: `flora:OliveTree`); Anointing Oil (ID: `realia:AnointingOil`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Zerubabeli (ID: `person:Zerubbabel.2`); Yehosadaki (ID: `person:Jehozadak`); Hagai (ID: `person:Haggai`); Yoshua (ID: `person:Joshua.5`); Shealtieli (ID: `person:Shealtiel.2`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Fear (ID: `keyterm:Fear`); Dario (ID: `person:Darius.2`); An Angel (ID: `deity:Angel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Yoshua (ID: `person:Joshua.5`); Zerubabeli (ID: `person:Zerubbabel.2`); Yehosadaki (ID: `person:Jehozadak`); Hagai (ID: `person:Haggai`); Yuda (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Peace (ID: `keyterm:IntactState`); Misri (ID: `place:Egypt`); Fear (ID: `keyterm:Fear`); Yuda (ID: `group:Judah`); Shealtieli (ID: `person:Shealtiel.2`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Zerubabeli (ID: `person:Zerubbabel.2`); BWANA (ID: `deity:Lord`); Yuda (ID: `person:Judah.4`); Hagai (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Yuda (ID: `group:Judah`); Shealtieli (ID: `person:Shealtiel.2`); Chariot (ID: `realia:Chariot`); Sword (ID: `realia:Sword`); Horse (ID: `fauna:Horse`)
