...
* **Associated ACAI Concepts:** Perceive (ID: `keyterm:Perceive`); Proverb (ID: `keyterm:Saying`); Ability (ID: `keyterm:Ability`); Intention (ID: `keyterm:Intention`); Guidance (ID: `keyterm:Guidance`); Have Insight (ID: `keyterm:HaveInsight`); Fool (ID: `keyterm:Fool`); Crafty (ID: `keyterm:Crafty`); Discretion (ID: `keyterm:Discretion`); Simple Person (ID: `keyterm:SimplePerson`); Fear (ID: `keyterm:Fear`); Daudi (ID: `person:David`); Fairness (ID: `keyterm:Fairness`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Sulemani (ID: `person:Solomon`); Understanding (ID: `keyterm:Understanding`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Understanding (ID: `keyterm:Understanding`); Ability (ID: `keyterm:Ability`); Intention (ID: `keyterm:Intention`); Stupid (ID: `keyterm:Stupid`); Love (ID: `keyterm:Love`); Simple Person (ID: `keyterm:SimplePerson`); Instruction (ID: `keyterm:Instruction`); Fear (ID: `keyterm:Fear`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`); Discretion (ID: `keyterm:Discretion`); Hell (ID: `place:Hell`); Money (ID: `realia:Money`); Sound Wisdom (ID: `keyterm:SoundWisdom`); Counsel (ID: `keyterm:Counsel`); Safety (ID: `keyterm:Safety`); Glory (ID: `keyterm:Glory`); Trap (ID: `realia:Trap`); Vine (ID: `flora:Vine`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Straightness (ID: `keyterm:Straightness`); Mischief (ID: `keyterm:Mischief`); Exempt (ID: `keyterm:Exempt`); Crafty (ID: `keyterm:Crafty`); Fairness (ID: `keyterm:Fairness`); Bless (ID: `keyterm:Bless`); Passion (ID: `keyterm:Ardour`); Complete (ID: `keyterm:Complete`); Favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Stupid (ID: `keyterm:Stupid`); Intention (ID: `keyterm:Intention`); Perceive (ID: `keyterm:Perceive`); Foolish (ID: `keyterm:Foolish`); Love (ID: `keyterm:Love`); Fool (ID: `keyterm:Fool`); Ability (ID: `keyterm:Ability`); Understanding (ID: `keyterm:Understanding`); Rebel (ID: `keyterm:Rebel`); Deceit (ID: `keyterm:Deceit`); Delight (ID: `keyterm:Delight`); Fear (ID: `keyterm:Fear`); Have Insight (ID: `keyterm:HaveInsight`); Bless (ID: `keyterm:Bless`); To Sin (ID: `keyterm:Sin`); Glory (ID: `keyterm:Glory`); Crafty (ID: `keyterm:Crafty`); Truth (ID: `keyterm:Truth`); Trust (ID: `keyterm:LeanOn`); Hope (ID: `keyterm:Hope`); Kindness (ID: `keyterm:Kindness`); Counsel (ID: `keyterm:Counsel`); Mischief (ID: `keyterm:Mischief`); Simple Person (ID: `keyterm:SimplePerson`); Diligent (ID: `keyterm:Diligent`); Be Blameless (ID: `keyterm:Blameless`); Safety (ID: `keyterm:Safety`); Insight (ID: `keyterm:Insight`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Lemueli (ID: `person:Lemuel`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Utterance (ID: `keyterm:Utterance`); Vow (ID: `keyterm:Vow`)
