...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Anointed (ID: `keyterm:Anointed`); Have Insight (ID: `keyterm:HaveInsight`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Decree (ID: `keyterm:Decree`); Yerusalemu (ID: `place:Jerusalem`); To Cause to Possess (ID: `keyterm:Possess`); Rope (ID: `realia:Rope`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Mighty (ID: `keyterm:Mighty`); Majesty (ID: `keyterm:Majesty`); Appoint (ID: `keyterm:Appoint`); Glory (ID: `keyterm:Glory`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Fish (ID: `fauna:Fish`); Cattle (ID: `fauna:Bull`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Trust (ID: `keyterm:LeanOn`); Lion (ID: `fauna:Lion`); Fear (ID: `keyterm:Fear`); Israeli (ID: `person:Israel`); Dog (ID: `fauna:Dog`); Bashani (ID: `place:Bashan`); Strength (ID: `keyterm:Strength`); Force to Serve (ID: `keyterm:EnticedToServe`); Vow (ID: `keyterm:Vow`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Poor (ID: `keyterm:Poor`); Lot (ID: `keyterm:Lot`); Salvation (ID: `keyterm:Salvation`); Holy (ID: `keyterm:Holy`); Wild Ox (ID: `fauna:WildOx`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Psalm (ID: `keyterm:Psalm`); Fear (ID: `keyterm:Fear`); Daudi (ID: `person:David`); Kindness (ID: `keyterm:Kindness`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`); House (ID: `realia:House`); Green Vegetation (ID: `flora:GreenVegetation`); Flock (ID: `fauna:Flock`); Anointing Oil (ID: `realia:AnointingOil`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Grass (ID: `flora:Grass`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Pure (ID: `keyterm:Pure`); Slaughtering (ID: `keyterm:Slaughtering`); Rebel (ID: `keyterm:Rebel`); Passion (ID: `keyterm:Ardour`); Offering (ID: `keyterm:Offering`); Forgive (ID: `keyterm:Forgive`); Salvation (ID: `keyterm:Salvation`); To Cleanse (ID: `keyterm:Cleanse.2`); Psalm (ID: `keyterm:Psalm`); Kindness (ID: `keyterm:Kindness`); Daudi (ID: `person:David`); Delight (ID: `keyterm:Delight`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Yerusalemu (ID: `place:Jerusalem`); The Way (ID: `keyterm:TheWay`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Cattle (ID: `fauna:Bull`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Hyssop (ID: `flora:Hyssop`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Likeness (ID: `keyterm:Semblance`); Innocence (ID: `keyterm:Innocence`); Counsel (ID: `keyterm:Counsel`); Be Zealous (ID: `keyterm:Zealous`); Peace (ID: `keyterm:IntactState`); Complete (ID: `keyterm:Complete`); Perceive (ID: `keyterm:Perceive`); Asafu (ID: `person:Asaph.2`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Psalm (ID: `keyterm:Psalm`); Israeli (ID: `person:Israel`); Glory (ID: `keyterm:Glory`); Refuge (ID: `keyterm:Refuge`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Misri (ID: `place:Egypt`); Musa (ID: `person:Moses`); Rebel (ID: `keyterm:Rebel`); Israeli (ID: `person:Israel`); To Cause to Possess (ID: `keyterm:Possess`); Kindness (ID: `keyterm:Kindness`); Abrahamu (ID: `person:Abraham`); Hamu (ID: `place:Ham.2`); Covenant (ID: `keyterm:Covenant`); Shamu (ID: `place:RedSea`); Plague (ID: `keyterm:Blow`); Haruni (ID: `person:Aaron`); Symbol (ID: `keyterm:Example`); Wakanaani (ID: `place:Canaan`); Believe In (ID: `keyterm:BelieveIn`); Decree (ID: `keyterm:Decree`); Cattails (ID: `flora:Cattails`); Finehasi (ID: `person:Phinehas`); To Make an Oath (ID: `keyterm:LiftUp`); To Act Wickedly (ID: `keyterm:ActWickedly`); Counsel (ID: `keyterm:Counsel`); Slaughtering (ID: `keyterm:Slaughtering`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Sinai (ID: `place:SinaiMount`); Isaka (ID: `person:Isaac`); Oath (ID: `keyterm:Oath`); Bless (ID: `keyterm:Bless`); Dathani (ID: `person:Dathan`); Exempt (ID: `keyterm:Exempt`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Out of Free Will (ID: `keyterm:OutOfFreeWill`); Melkizedeki (ID: `person:Melchizedek`); Daudi (ID: `person:David`); Swear (ID: `keyterm:Swear`); Psalm (ID: `keyterm:Psalm`); Yerusalemu (ID: `place:Jerusalem`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Vow (ID: `keyterm:Vow`); Loyal Person (ID: `keyterm:LoyalPerson`); Hell (ID: `place:Hell`); Salvation (ID: `keyterm:Salvation`); Praise (ID: `keyterm:Praise`); Slaughtering (ID: `keyterm:Slaughtering`); Plea for Mercy (ID: `keyterm:Supplication`); Generous (ID: `keyterm:Generous`); Yerusalemu (ID: `place:Jerusalem`); Simple Person (ID: `keyterm:SimplePerson`); Believe In (ID: `keyterm:BelieveIn`); Love (ID: `keyterm:Love`); House (ID: `realia:House`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); BWANA (ID: `deity:Lord`); Precept (ID: `keyterm:Precept`); Decree (ID: `keyterm:Decree`); Love (ID: `keyterm:Love`); Perceive (ID: `keyterm:Perceive`); Testimony (ID: `keyterm:Witness.2`); Kindness (ID: `keyterm:Kindness`); Salvation (ID: `keyterm:Salvation`); Fear (ID: `keyterm:Fear`); Truth (ID: `keyterm:Truth`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Complete (ID: `keyterm:Complete`); Redeem (ID: `keyterm:Redeem`); The Way (ID: `keyterm:TheWay`); Have Insight (ID: `keyterm:HaveInsight`); Shield (ID: `keyterm:Shield`); Counsel (ID: `keyterm:Counsel`); Deceit (ID: `keyterm:Deceit`); Offering (ID: `keyterm:Offering`); Ask for (ID: `keyterm:AskFor`); Mischief (ID: `keyterm:Mischief`); Trust (ID: `keyterm:LeanOn`); To Curse (ID: `keyterm:Curse`); Believe In (ID: `keyterm:BelieveIn`); Bless (ID: `keyterm:Bless`); Swear (ID: `keyterm:Swear`); Straightness (ID: `keyterm:Straightness`); Peace (ID: `keyterm:IntactState`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** Yerusalemu (ID: `place:Jerusalem`); Babeli (ID: `place:Babylon`); BWANA (ID: `deity:Lord`); Edomu (ID: `place:Edom`); A Group of People (ID: `group:GenericGroup`); Edomites (ID: `group:Edom`); Lute (ID: `realia:Lute`); Poplar (ID: `flora:Poplar`); Foundation (ID: `realia:Foundation`); Willow (ID: `flora:Willow`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Loyal Person (ID: `keyterm:LoyalPerson`); Yerusalemu (ID: `place:Jerusalem`); Round Dance (ID: `keyterm:RoundDance`); Poor (ID: `keyterm:Poor`); Salvation (ID: `keyterm:Salvation`); Decree (ID: `keyterm:Decree`); Lute (ID: `realia:Lute`); Praise (ID: `keyterm:Praise`); Drum (ID: `realia:Drum`); Majesty (ID: `keyterm:Majesty`); Trust (ID: `keyterm:LeanOn`); Strength (ID: `keyterm:Strength`); Kindness (ID: `keyterm:Kindness`); Understanding (ID: `keyterm:Understanding`); Bless (ID: `keyterm:Bless`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Truth (ID: `keyterm:Truth`); Horn (ID: `keyterm:Horn`); Peace (ID: `keyterm:IntactState`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Lyre (ID: `realia:Lyre`); Cymbals (ID: `realia:Cymbals`); Dragon (ID: `fauna:Dragon`); Cattle (ID: `fauna:Bull`); Chameleon (ID: `fauna:Chameleon`)
