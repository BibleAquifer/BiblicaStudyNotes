...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Anointed (ID: `keyterm:Anointed`); Yerusalemu (ID: `place:Jerusalem`); Have Insight (ID: `keyterm:HaveInsight`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); Decree (ID: `keyterm:Decree`); To Cause to Possess (ID: `keyterm:Possess`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Rope (ID: `realia:Rope`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Mighty (ID: `keyterm:Mighty`); Glory (ID: `keyterm:Glory`); Appoint (ID: `keyterm:Appoint`); Majesty (ID: `keyterm:Majesty`); Fish (ID: `fauna:Fish`); Flock (ID: `fauna:Flock`); Bird (ID: `fauna:Bird`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Trust (ID: `keyterm:LeanOn`); Lion (ID: `fauna:Lion`); Fear (ID: `keyterm:Fear`); Israeli (ID: `person:Israel`); Dog (ID: `fauna:Dog`); Strength (ID: `keyterm:Strength`); Holy (ID: `keyterm:Holy`); Lot (ID: `keyterm:Lot`); Poor (ID: `keyterm:Poor`); Bashani (ID: `place:Bashan`); Force to Serve (ID: `keyterm:EnticedToServe`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Vow (ID: `keyterm:Vow`); Salvation (ID: `keyterm:Salvation`); Wild Ox (ID: `fauna:WildOx`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Psalm (ID: `keyterm:Psalm`); Kindness (ID: `keyterm:Kindness`); Fear (ID: `keyterm:Fear`); Daudi (ID: `person:David`); Staff (ID: `realia:Staff`); Grass (ID: `flora:Grass`); House (ID: `realia:House`); Anointing Oil (ID: `realia:AnointingOil`); Green Vegetation (ID: `flora:GreenVegetation`); Olive Oil (ID: `realia:OliveOil`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Rod (ID: `realia:Rod`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); BWANA (ID: `deity:Lord`); Pure (ID: `keyterm:Pure`); Rebel (ID: `keyterm:Rebel`); Slaughtering (ID: `keyterm:Slaughtering`); Passion (ID: `keyterm:Ardour`); Offering (ID: `keyterm:Offering`); Forgive (ID: `keyterm:Forgive`); Salvation (ID: `keyterm:Salvation`); To Cleanse (ID: `keyterm:Cleanse.2`); Psalm (ID: `keyterm:Psalm`); Yerusalemu (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Delight (ID: `keyterm:Delight`); Truth (ID: `keyterm:Truth`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); The Way (ID: `keyterm:TheWay`); Daudi (ID: `person:David`); Kindness (ID: `keyterm:Kindness`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Hyssop (ID: `flora:Hyssop`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Innocence (ID: `keyterm:Innocence`); Likeness (ID: `keyterm:Semblance`); Perceive (ID: `keyterm:Perceive`); Glory (ID: `keyterm:Glory`); Refuge (ID: `keyterm:Refuge`); Israeli (ID: `person:Israel`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Psalm (ID: `keyterm:Psalm`); Counsel (ID: `keyterm:Counsel`); Be Zealous (ID: `keyterm:Zealous`); Complete (ID: `keyterm:Complete`); Asafu (ID: `person:Asaph.2`); Peace (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); Musa (ID: `person:Moses`); Israeli (ID: `person:Israel`); Misri (ID: `place:Egypt`); To Cause to Possess (ID: `keyterm:Possess`); Hamu (ID: `place:Ham.2`); Shamu (ID: `place:RedSea`); Abrahamu (ID: `person:Abraham`); Kindness (ID: `keyterm:Kindness`); Covenant (ID: `keyterm:Covenant`); Plague (ID: `keyterm:Blow`); Haruni (ID: `person:Aaron`); Decree (ID: `keyterm:Decree`); Symbol (ID: `keyterm:Example`); Wakanaani (ID: `place:Canaan`); Believe In (ID: `keyterm:BelieveIn`); Cattails (ID: `flora:Cattails`); Finehasi (ID: `person:Phinehas`); To Make an Oath (ID: `keyterm:LiftUp`); Glory (ID: `keyterm:Glory`); Exempt (ID: `keyterm:Exempt`); Delight (ID: `keyterm:Delight`); Surely! (ID: `keyterm:Surely`); Have Insight (ID: `keyterm:HaveInsight`); Anointed (ID: `keyterm:Anointed`); Miraculous Sign (ID: `keyterm:MiraculousSign`); Redeem (ID: `keyterm:Redeem`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); To Act Wickedly (ID: `keyterm:ActWickedly`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Melkizedeki (ID: `person:Melchizedek`); Out of Free Will (ID: `keyterm:OutOfFreeWill`); Yerusalemu (ID: `place:Jerusalem`); Swear (ID: `keyterm:Swear`); Psalm (ID: `keyterm:Psalm`); Daudi (ID: `person:David`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Vow (ID: `keyterm:Vow`); Yerusalemu (ID: `place:Jerusalem`); Hell (ID: `place:Hell`); Simple Person (ID: `keyterm:SimplePerson`); Love (ID: `keyterm:Love`); Loyal Person (ID: `keyterm:LoyalPerson`); Praise (ID: `keyterm:Praise`); Slaughtering (ID: `keyterm:Slaughtering`); Plea for Mercy (ID: `keyterm:Supplication`); Generous (ID: `keyterm:Generous`); Believe In (ID: `keyterm:BelieveIn`); Salvation (ID: `keyterm:Salvation`); House (ID: `realia:House`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); BWANA (ID: `deity:Lord`); Precept (ID: `keyterm:Precept`); Decree (ID: `keyterm:Decree`); Love (ID: `keyterm:Love`); Perceive (ID: `keyterm:Perceive`); Testimony (ID: `keyterm:Witness.2`); Kindness (ID: `keyterm:Kindness`); Salvation (ID: `keyterm:Salvation`); Truth (ID: `keyterm:Truth`); Fear (ID: `keyterm:Fear`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Redeem (ID: `keyterm:Redeem`); The Way (ID: `keyterm:TheWay`); Complete (ID: `keyterm:Complete`); Have Insight (ID: `keyterm:HaveInsight`); Shield (ID: `keyterm:Shield`); Trust (ID: `keyterm:LeanOn`); Offering (ID: `keyterm:Offering`); Bless (ID: `keyterm:Bless`); Simple Person (ID: `keyterm:SimplePerson`); To Sin (ID: `keyterm:Sin`); Straightness (ID: `keyterm:Straightness`); Deceit (ID: `keyterm:Deceit`); Plea for Mercy (ID: `keyterm:Supplication`); Swear (ID: `keyterm:Swear`); Believe In (ID: `keyterm:BelieveIn`); To Curse (ID: `keyterm:Curse`); Ask for (ID: `keyterm:AskFor`); Mischief (ID: `keyterm:Mischief`)
...
* **Associated ACAI Concepts:** Yerusalemu (ID: `place:Jerusalem`); Babeli (ID: `place:Babylon`); BWANA (ID: `deity:Lord`); A Group of People (ID: `group:GenericGroup`); Edomites (ID: `group:Edom`); Edomu (ID: `place:Edom`); Poplar (ID: `flora:Poplar`); Lute (ID: `realia:Lute`); Willow (ID: `flora:Willow`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Yerusalemu (ID: `place:Jerusalem`); Loyal Person (ID: `keyterm:LoyalPerson`); Round Dance (ID: `keyterm:RoundDance`); Decree (ID: `keyterm:Decree`); Poor (ID: `keyterm:Poor`); Salvation (ID: `keyterm:Salvation`); Lute (ID: `realia:Lute`); Praise (ID: `keyterm:Praise`); Drum (ID: `realia:Drum`); Glory (ID: `keyterm:Glory`); Trust (ID: `keyterm:LeanOn`); Love (ID: `keyterm:Love`); Horn (ID: `keyterm:Horn`); Strength (ID: `keyterm:Strength`); Truth (ID: `keyterm:Truth`); An Angel (ID: `deity:Angel`); Bless (ID: `keyterm:Bless`); Understanding (ID: `keyterm:Understanding`); Fear (ID: `keyterm:Fear`); Kindness (ID: `keyterm:Kindness`); Majesty (ID: `keyterm:Majesty`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Peace (ID: `keyterm:IntactState`); Lyre (ID: `realia:Lyre`); Cymbals (ID: `realia:Cymbals`); Lizard (ID: `fauna:Lizard`); Cedar (ID: `flora:Cedar`); Sheep (ID: `fauna:Lamb`)
