...
* **Associated ACAI Concepts:** Rehoboamu (ID: `person:Rehoboam`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Yerusalemu (ID: `place:Jerusalem`); Yeroboamu (ID: `person:Jeroboam`); Benyamini (ID: `person:Benjamin`); Sulemani (ID: `person:Solomon`); Daudi (ID: `person:David`); Benyamini (ID: `group:Benjamin`); Shemaya (ID: `person:Shemaiah`); Fortification (ID: `realia:Fortification`); Shishaki (ID: `person:Shishak`); Misri (ID: `place:Egypt`); Yoke (ID: `realia:Yoke`); Maaka (ID: `person:Maacah.3`); Abiya (ID: `person:Abijah.4`); Counsel (ID: `keyterm:Counsel`); House (ID: `realia:House`); Nebati (ID: `person:Nebat`); Walawi (ID: `person:Levi.3`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Yese (ID: `person:Jesse`); Walawi (ID: `group:Levi`); Absalomu (ID: `person:Absalom`); Work (ID: `keyterm:Work`); Shemaria (ID: `person:Shemariah.2`); Yeushi (ID: `person:Jeush.5`); Zifu (ID: `person:Ziph`)
...
* **Associated ACAI Concepts:** Abiya (ID: `person:Abijah.4`); BWANA (ID: `deity:Lord`); Yeroboamu (ID: `person:Jeroboam`); Israeli (ID: `person:Israel`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Daudi (ID: `person:David`); Sulemani (ID: `person:Solomon`); Haruni (ID: `person:Aaron`); Efraimu (ID: `person:Ephraim`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Trumpet (ID: `realia:Trumpet`); Cattle (ID: `fauna:Bull`); Urieli (ID: `person:Uriel.3`); Ido (ID: `person:Iddo.5`); Gibea (ID: `place:Gibeah`); Yeshana (ID: `place:Jeshanah`); Yerusalemu (ID: `place:Jerusalem`); Strength (ID: `keyterm:Strength`); Semaraimu (ID: `place:Zemaraim`); Pure (ID: `keyterm:Pure`); Rebel (ID: `keyterm:Rebel`); Offering (ID: `keyterm:Offering`); Maaka (ID: `person:Maacah.3`); Nebati (ID: `person:Nebat`); Asa (ID: `person:Asa`); Rehoboamu (ID: `person:Rehoboam`); Wickedness (ID: `keyterm:Wickedness`); Betheli (ID: `place:Bethel`); Efraimu (ID: `group:Ephraim`); Covenant (ID: `keyterm:Covenant`); Bread of Display (ID: `realia:BreadOfDisplay`); Molten Image (ID: `realia:MoltenImage`); Lampstand (ID: `realia:Lampstand.2`); Sheep (ID: `fauna:Lamb`); Lamp (ID: `realia:Lamp`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Asa (ID: `person:Asa`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Israeli (ID: `person:Israel`); Ethiopians (ID: `group:Ethiopia`); Benyamini (ID: `person:Benjamin`); Benyamini (ID: `group:Benjamin`); Wakushi (ID: `place:Ethiopia`); Baasha (ID: `person:Baasha`); Ramah (ID: `place:Ramah.2`); Odedi (ID: `person:Oded`); Swear (ID: `keyterm:Swear`); Maresha (ID: `place:Mareshah`); Yerusalemu (ID: `place:Jerusalem`); Ben-hadadi (ID: `person:Ben-hadad`); Gerari (ID: `place:Gerar`); Efraimu (ID: `person:Ephraim`); Instruction (ID: `keyterm:Instruction`); Efraimu (ID: `group:Ephraim`); Covenant (ID: `keyterm:Covenant`); Ashera (ID: `deity:Asherah`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); House (ID: `realia:House`); Money (ID: `realia:Money`); Zera (ID: `person:Zerah.5`); Azaria (ID: `person:Azariah.8`); Kidroni (ID: `place:Kidron`); Iyoni (ID: `place:Ijon`); Hanani (ID: `person:Hanani`); bondeni (ID: `place:ZephathahValley`); Abeli (ID: `place:Abel-beth-maacah`); Simeoni (ID: `person:Simeon.5`); Dani (ID: `group:Dan`); Geba (ID: `place:Geba`); Delight (ID: `keyterm:Delight`); Strength (ID: `keyterm:Strength`); Truth (ID: `keyterm:Truth`); Manase (ID: `person:Manasseh`); Dani (ID: `place:Dan`); Maaka (ID: `person:Maacah.3`); Daudi (ID: `person:David`); Simeoni (ID: `group:Simeon`); Dameski (ID: `place:Damascus`); Manase (ID: `group:Manasseh`); Naftali (ID: `person:Naphtali`); Oath (ID: `keyterm:Oath`); Detested Thing (ID: `keyterm:DetestedThing`); Naftali (ID: `group:Naphtali`); Walubi (ID: `place:Libya`); Mispa (ID: `place:Mizpah`); Peace (ID: `keyterm:IntactState`); Flock (ID: `fauna:Flock`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Goat (ID: `fauna:Goat`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Chariot (ID: `realia:Chariot`); Sacred Pillar (ID: `realia:SacredPillar`); Camel (ID: `fauna:Camel`); Large Shield (ID: `realia:LargeShield`); Balsam Tree (ID: `flora:BalsamTree`); Small Shield (ID: `realia:SmallShield`); Rams Horn (ID: `realia:RamsHorn`); Tent (ID: `realia:Tent`); Spear (ID: `realia:Spear`); Image (ID: `realia:Image`); Trumpet (ID: `realia:Trumpet`); Sacred Pole (ID: `realia:SacredPole`); Bed (ID: `realia:Bed`); Tower (ID: `realia:Tower`); Bow (ID: `realia:Bow`); Fortification (ID: `realia:Fortification`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yehoshafati (ID: `person:Jehoshaphat.3`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Israeli (ID: `person:Israel`); Yerusalemu (ID: `place:Jerusalem`); Mikaya (ID: `person:Micaiah.5`); Ramoth-gileadi (ID: `place:Ramoth-gilead`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Speak as a Prophet (ID: `keyterm:Speak`); Moabu (ID: `place:Moab`); Ahabu (ID: `person:Ahab`); Peace (ID: `keyterm:IntactState`); Fear (ID: `keyterm:Fear`); Waamoni (ID: `place:Ammon`); House (ID: `realia:House`); Chariot (ID: `realia:Chariot`); Seiri (ID: `place:SeirMount`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Kenaana (ID: `person:Chenaanah`); Imla (ID: `person:Imlah`); Ahazia (ID: `person:Ahaziah`); Hanani (ID: `person:Hanani`); Strength (ID: `keyterm:Strength`); Sedekia (ID: `person:Zedekiah.2`); Yehu (ID: `person:Jehu`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Tarshishi (ID: `place:Tarshish`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yehoyada (ID: `person:Jehoiada.2`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); House (ID: `realia:House`); Yerusalemu (ID: `place:Jerusalem`); Ahazia (ID: `person:Ahaziah.2`); Walawi (ID: `person:Levi.3`); Israeli (ID: `person:Israel`); Walawi (ID: `group:Levi`); Ahabu (ID: `person:Ahab`); Athalia (ID: `person:Athaliah`); Daudi (ID: `person:David`); Yehoramu (ID: `person:Jehoram`); Yoashi (ID: `person:Joash.3`); Covenant (ID: `keyterm:Covenant`); Yoramu (ID: `person:Joram.3`); Syrians (ID: `group:Syria`); Musa (ID: `person:Moses`); Yehu (ID: `person:Jehu.2`); Edomu (ID: `place:Edom`); Ramoth-gileadi (ID: `place:Ramoth-gilead`); Arabians (ID: `group:Arabia`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Sabbath (ID: `keyterm:Sabbath`); Waarabu (ID: `place:Arabia`); Smear (ID: `keyterm:Smear`); Testimony (ID: `keyterm:Witness.2`); Hazaeli (ID: `person:Hazael`); Baali (ID: `deity:Baal`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Israeli (ID: `person:Israel`); Amazia (ID: `person:Amaziah`); Uzia (ID: `person:Uzziah`); Yerusalemu (ID: `place:Jerusalem`); Ahazi (ID: `person:Ahaz`); Yothamu (ID: `person:Jotham.2`); Yoashi (ID: `person:Joash.4`); Samaria (ID: `place:Samaria`); House (ID: `realia:House`); Be Unfaithful (ID: `keyterm:Unfaithful`); Efraimu (ID: `group:Ephraim`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Efraimu (ID: `person:Ephraim`); Edomu (ID: `place:Edom`); Beth-shemeshi (ID: `place:Beth-shemesh`); Assyria (ID: `place:Assyria`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Tower (ID: `realia:Tower`); pembeni (ID: `place:CornerGate`); Azaria (ID: `person:Azariah.9`); Shefela (ID: `place:Shephelah`); Yoashi (ID: `person:Joash.3`); Strength (ID: `keyterm:Strength`); Yehoahazi (ID: `person:Jehoahaz.2`); Dameski (ID: `place:Damascus`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Hezekia (ID: `person:Hezekiah`); Yerusalemu (ID: `place:Jerusalem`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Offering (ID: `keyterm:Offering`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Israeli (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Assyria (ID: `place:Assyria`); Daudi (ID: `person:David`); Pure (ID: `keyterm:Pure`); Passover (ID: `keyterm:Passover`); Manase (ID: `group:Manasseh`); Senakeribu (ID: `person:Sennacherib`); Manase (ID: `person:Manasseh`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Cattle (ID: `fauna:Bull`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Instruction (ID: `keyterm:Instruction`); Efraimu (ID: `group:Ephraim`); Work (ID: `keyterm:Work`); Efraimu (ID: `person:Ephraim`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Babeli (ID: `place:Babylon`); House (ID: `realia:House`); Nebukadneza (ID: `person:Nebuchadnezzar`); Yeremia (ID: `person:Jeremiah.6`); Uajemi (ID: `place:Persia`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Koreshi (ID: `person:Cyrus`); Yekonia (ID: `person:Jehoiachin`); Yehoyakimu (ID: `person:Jehoiakim`); An Angel (ID: `deity:Angel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Sedekia (ID: `person:Zedekiah.3`); Israeli (ID: `person:Israel`); Sabbath (ID: `keyterm:Sabbath`); Rebel (ID: `keyterm:Rebel`); Holy (ID: `keyterm:Holy`); Swear (ID: `keyterm:Swear`); Chaldeans (ID: `group:Chaldea`); Be Unfaithful (ID: `keyterm:Unfaithful`); Defilement (ID: `keyterm:Defilement`); Wakaldayo (ID: `place:Chaldea`)
