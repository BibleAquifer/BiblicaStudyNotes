...
* **Associated ACAI Concepts:** Rehoboamu (ID: `person:Rehoboam`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Yerusalemu (ID: `place:Jerusalem`); Yeroboamu (ID: `person:Jeroboam`); Sulemani (ID: `person:Solomon`); Daudi (ID: `person:David`); Benyamini (ID: `group:Benjamin`); Benyamini (ID: `person:Benjamin`); Shemaya (ID: `person:Shemaiah`); Fortification (ID: `realia:Fortification`); Shishaki (ID: `person:Shishak`); Misri (ID: `place:Egypt`); Yoke (ID: `realia:Yoke`); Maaka (ID: `person:Maacah.3`); Abiya (ID: `person:Abijah.4`); Counsel (ID: `keyterm:Counsel`); House (ID: `realia:House`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Yese (ID: `person:Jesse`); Work (ID: `keyterm:Work`); Nebati (ID: `person:Nebat`); Absalomu (ID: `person:Absalom`); Zahamu (ID: `person:Zaham`); Yeushi (ID: `person:Jeush.5`); Sukkiim (ID: `group:Sukkiim`)
...
* **Associated ACAI Concepts:** Abiya (ID: `person:Abijah.4`); BWANA (ID: `deity:Lord`); Yeroboamu (ID: `person:Jeroboam`); Israeli (ID: `person:Israel`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Daudi (ID: `person:David`); Walawi (ID: `group:Levi`); Haruni (ID: `person:Aaron`); Sulemani (ID: `person:Solomon`); Walawi (ID: `person:Levi.3`); Efraimu (ID: `person:Ephraim`); Cattle (ID: `fauna:Bull`); Trumpet (ID: `realia:Trumpet`); Gibea (ID: `place:Gibeah`); Urieli (ID: `person:Uriel.3`); Yeshana (ID: `place:Jeshanah`); Ido (ID: `person:Iddo.5`); Rebel (ID: `keyterm:Rebel`); Wickedness (ID: `keyterm:Wickedness`); Strength (ID: `keyterm:Strength`); Maaka (ID: `person:Maacah.3`); Nebati (ID: `person:Nebat`); Betheli (ID: `place:Bethel`); Pure (ID: `keyterm:Pure`); Rehoboamu (ID: `person:Rehoboam`); Yerusalemu (ID: `place:Jerusalem`); Asa (ID: `person:Asa`); Efraimu (ID: `group:Ephraim`); Semaraimu (ID: `place:Zemaraim`); Covenant (ID: `keyterm:Covenant`); Offering (ID: `keyterm:Offering`); Bread of Display (ID: `realia:BreadOfDisplay`); Molten Image (ID: `realia:MoltenImage`); Lamp (ID: `realia:Lamp`); Sheep (ID: `fauna:Lamb`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Asa (ID: `person:Asa`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Israeli (ID: `person:Israel`); Wakushi (ID: `place:Ethiopia`); Baasha (ID: `person:Baasha`); Benyamini (ID: `group:Benjamin`); Ethiopians (ID: `group:Ethiopia`); Benyamini (ID: `person:Benjamin`); Ramah (ID: `place:Ramah.2`); Odedi (ID: `person:Oded`); Swear (ID: `keyterm:Swear`); Maresha (ID: `place:Mareshah`); Instruction (ID: `keyterm:Instruction`); Gerari (ID: `place:Gerar`); Yerusalemu (ID: `place:Jerusalem`); Efraimu (ID: `group:Ephraim`); Ashera (ID: `deity:Asherah`); Covenant (ID: `keyterm:Covenant`); Ben-hadadi (ID: `person:Ben-hadad`); Efraimu (ID: `person:Ephraim`); House (ID: `realia:House`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Money (ID: `realia:Money`); Hanani (ID: `person:Hanani`); Zera (ID: `person:Zerah.5`); Azaria (ID: `person:Azariah.8`); bondeni (ID: `place:ZephathahValley`); Kidroni (ID: `place:Kidron`); Abeli (ID: `place:Abel-beth-maacah`); Iyoni (ID: `place:Ijon`); Geba (ID: `place:Geba`); Oath (ID: `keyterm:Oath`); Dameski (ID: `place:Damascus`); Strength (ID: `keyterm:Strength`); Maaka (ID: `person:Maacah.3`); Truth (ID: `keyterm:Truth`); Manase (ID: `group:Manasseh`); Peace (ID: `keyterm:IntactState`); Manase (ID: `person:Manasseh`); Simeoni (ID: `person:Simeon.5`); Detested Thing (ID: `keyterm:DetestedThing`); Dani (ID: `place:Dan`); Delight (ID: `keyterm:Delight`); Simeoni (ID: `group:Simeon`); Daudi (ID: `person:David`); Naftali (ID: `person:Naphtali`); Mispa (ID: `place:Mizpah`); Dani (ID: `group:Dan`); Walubi (ID: `place:Libya`); Naftali (ID: `group:Naphtali`); Stone Altar (ID: `realia:StoneAltar`); Goat (ID: `fauna:Goat`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Chariot (ID: `realia:Chariot`); Flock (ID: `fauna:Flock`); Bed (ID: `realia:Bed`); Fortification (ID: `realia:Fortification`); Rams Horn (ID: `realia:RamsHorn`); Image (ID: `realia:Image`); Bow (ID: `realia:Bow`); Cattle (ID: `fauna:Bull`); Large Shield (ID: `realia:LargeShield`); Camel (ID: `fauna:Camel`); Small Shield (ID: `realia:SmallShield`); Sacred Pole (ID: `realia:SacredPole`); Balsam Tree (ID: `flora:BalsamTree`); Trumpet (ID: `realia:Trumpet`); Spear (ID: `realia:Spear`); Tent (ID: `realia:Tent`); Sacred Pillar (ID: `realia:SacredPillar`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yehoyada (ID: `person:Jehoiada.2`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); House (ID: `realia:House`); Yerusalemu (ID: `place:Jerusalem`); Ahazia (ID: `person:Ahaziah.2`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Israeli (ID: `person:Israel`); Daudi (ID: `person:David`); Ahabu (ID: `person:Ahab`); Athalia (ID: `person:Athaliah`); Yehoramu (ID: `person:Jehoram`); Yoashi (ID: `person:Joash.3`); Covenant (ID: `keyterm:Covenant`); Yoramu (ID: `person:Joram.3`); Musa (ID: `person:Moses`); Syrians (ID: `group:Syria`); Edomu (ID: `place:Edom`); Yehu (ID: `person:Jehu.2`); Ramoth-gileadi (ID: `place:Ramoth-gilead`); Sabbath (ID: `keyterm:Sabbath`); Offering (ID: `keyterm:Offering`); Smear (ID: `keyterm:Smear`); Hazaeli (ID: `person:Hazael`); Yehoshafati (ID: `person:Jehoshaphat.3`); Testimony (ID: `keyterm:Witness.2`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Israeli (ID: `person:Israel`); Amazia (ID: `person:Amaziah`); Uzia (ID: `person:Uzziah`); Yerusalemu (ID: `place:Jerusalem`); Ahazi (ID: `person:Ahaz`); Yothamu (ID: `person:Jotham.2`); Yoashi (ID: `person:Joash.4`); Samaria (ID: `place:Samaria`); House (ID: `realia:House`); Be Unfaithful (ID: `keyterm:Unfaithful`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Efraimu (ID: `group:Ephraim`); Efraimu (ID: `person:Ephraim`); Edomu (ID: `place:Edom`); Beth-shemeshi (ID: `place:Beth-shemesh`); Wafilisti (ID: `place:Philistine`); Assyria (ID: `place:Assyria`); Wafilisti (ID: `group:Philistine`); Tower (ID: `realia:Tower`); Azaria (ID: `person:Azariah.9`); pembeni (ID: `place:CornerGate`); Yoashi (ID: `person:Joash.3`); Shefela (ID: `place:Shephelah`); Daudi (ID: `person:David`); Waamoni (ID: `place:Ammon`); Yehoahazi (ID: `person:Jehoahaz.2`); Ammonites (ID: `group:Ammon`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Babeli (ID: `place:Babylon`); House (ID: `realia:House`); Nebukadneza (ID: `person:Nebuchadnezzar`); Yeremia (ID: `person:Jeremiah.6`); Uajemi (ID: `place:Persia`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Koreshi (ID: `person:Cyrus`); Yekonia (ID: `person:Jehoiachin`); Yehoyakimu (ID: `person:Jehoiakim`); An Angel (ID: `deity:Angel`); Sedekia (ID: `person:Zedekiah.3`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Israeli (ID: `person:Israel`); Rebel (ID: `keyterm:Rebel`); Swear (ID: `keyterm:Swear`); Sabbath (ID: `keyterm:Sabbath`); Wakaldayo (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Defilement (ID: `keyterm:Defilement`); Holy (ID: `keyterm:Holy`); Be Unfaithful (ID: `keyterm:Unfaithful`)
