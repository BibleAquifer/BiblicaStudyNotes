...
* **Associated ACAI Concepts:** Hiramu (ID: `person:Hiram`); Plea for Mercy (ID: `keyterm:Supplication`); Covenant Box (ID: `keyterm:CovenantBox`); Temple Altar (ID: `realia:TempleAltar`); Hiramu (ID: `person:Hiram.2`); Tadmori (ID: `place:Tadmor`); Parvaimu (ID: `place:Parvaim`); Slaughtering (ID: `keyterm:Slaughtering`); Sandalwood (ID: `flora:Sandalwood`); Sycomore Fig (ID: `flora:SycomoreFig`); Bath (ID: `realia:Bath`); Baalathi (ID: `place:Baalath.2`); Baboon (ID: `fauna:Baboon`); Monkey (ID: `fauna:Monkey`); Moria (ID: `place:MoriahMount`); wakapewa (ID: `place:Kue`); Cymbals (ID: `realia:Cymbals`); Hamathi (ID: `place:Hamath`); Ido (ID: `person:Iddo.5`); juu (ID: `place:Beth-horonUpper`); Wick Trimmer (ID: `realia:WickTrimmer`); Bread of Display (ID: `keyterm:BreadOfDisplay`); Kor (ID: `realia:Kor`); kijito (ID: `place:BrookOfEgypt`); Yafa (ID: `place:Joppa`); Large Shield (ID: `realia:LargeShield`); Sulemani (ID: `person:Solomon`); Winged Creature (ID: `realia:WingedCreature`); malkia (ID: `person:QueenOfSheba`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Shemaya (ID: `person:Shemaiah`); Rehoboamu (ID: `person:Rehoboam`); Fortification (ID: `realia:Fortification`); Shishaki (ID: `person:Shishak`); Abihaili (ID: `person:Abihail.4`); Shemaria (ID: `person:Shemariah.2`); Mahalathi (ID: `person:Mahalath.2`); Yeushi (ID: `person:Jeush.5`); Zahamu (ID: `person:Zaham`); Shelomithi (ID: `person:Shelomith.3`); Yerimothi (ID: `person:Jerimoth.6`); Atai (ID: `person:Attai.3`); Sukkiim (ID: `group:Sukkiim`); Ziza (ID: `person:Ziza.2`); Adoraimu (ID: `place:Adoraim`); Maaka (ID: `person:Maacah.3`); Zifu (ID: `person:Ziph`); Naama (ID: `person:Naamah`); Ido (ID: `person:Iddo.5`); Adoramu (ID: `person:Adoram`); Ahiya (ID: `person:Ahijah.2`); Yoke (ID: `realia:Yoke`); Yeroboamu (ID: `person:Jeroboam`); Benyamini (ID: `group:Benjamin`); Benyamini (ID: `person:Benjamin`); Sulemani (ID: `person:Solomon`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Yerusalemu (ID: `place:Jerusalem`); Daudi (ID: `person:David`)
...
* **Associated ACAI Concepts:** Abiya (ID: `person:Abijah.4`); Urieli (ID: `person:Uriel.3`); Yeshana (ID: `place:Jeshanah`); Gibea (ID: `place:Gibeah`); Ido (ID: `person:Iddo.5`); Bread of Display (ID: `realia:BreadOfDisplay`); Yeroboamu (ID: `person:Jeroboam`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Odedi (ID: `person:Oded`); Zera (ID: `person:Zerah.5`); bondeni (ID: `place:ZephathahValley`); Azaria (ID: `person:Azariah.8`); Maresha (ID: `place:Mareshah`); Swear (ID: `keyterm:Swear`); Iyoni (ID: `place:Ijon`); Hanani (ID: `person:Hanani`); Abeli (ID: `place:Abel-beth-maacah`); Kidroni (ID: `place:Kidron`); Asa (ID: `person:Asa`); Ethiopians (ID: `group:Ethiopia`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Yehoshafati (ID: `person:Jehoshaphat.3`); Mikaya (ID: `person:Micaiah.5`); Amaria (ID: `person:Amariah.4`); Elishama (ID: `person:Elishama.5`); Shemaya (ID: `person:Shemaiah.10`); Azaria (ID: `person:Azariahu`); Yehieli (ID: `person:Jehiel.4`); Zekaria (ID: `person:Zechariah.10`); Yehoramu (ID: `person:Jehozabad.3`); Zebadia (ID: `person:Zebadiah.7`); Ben-haili (ID: `person:Ben-hail`); Yehonathani (ID: `person:Jehonathan`); Adonia (ID: `person:Tobadonijah`); Tobia (ID: `person:Tobijah`); Matania (ID: `person:Mattaniah.3`); Mahalathi (ID: `person:Micaiah.7`); Nethania (ID: `person:Nethaniah.3`); Eliezeri (ID: `person:Eliezer.7`); Eliada (ID: `person:Eliada.3`); Zekaria (ID: `person:Zechariah.9`); Sisi (ID: `place:Ziz`); Ishmaeli (ID: `person:Ishmael.4`); Yahazieli (ID: `person:Jahaziel.4`); Yehoramu (ID: `person:Jehoram.2`); Asaheli (ID: `person:Asahel.2`); Nethaneli (ID: `person:Nethanel.6`); Zekaria (ID: `person:Zechariah.11`); Zikri (ID: `person:Zichri.8`); Yehohanani (ID: `person:Jehohanan.2`); Yeieli (ID: `person:Jeiel.5`)
...
* **Associated ACAI Concepts:** Yehoyada (ID: `person:Jehoiada.2`); Ahazia (ID: `person:Ahaziah.2`); Yehoramu (ID: `person:Jehoram`); Yoashi (ID: `person:Joash.3`); Azaria (ID: `person:Azariah.14`); Obedi (ID: `person:Obed.5`); Ishmaeli (ID: `person:Ishmael.5`); msingi (ID: `place:FoundationGate`); Zikri (ID: `person:Zichri.9`); Yehohanani (ID: `person:Jehohanan.3`); Yerohamu (ID: `person:Jeroham.7`); Adaya (ID: `person:Adaiah.4`); Elishafati (ID: `person:Elishaphat`); Maaseya (ID: `person:Maaseiah.2`); Azaria (ID: `person:Azariah.13`); Treasury (ID: `realia:Treasury`); Yoramu (ID: `person:Joram.3`); Matani (ID: `person:Mattan`); Shomeri (ID: `person:Shomer`); Jozacar (ID: `person:Jozacar`); Yehosheba (ID: `person:Jehosheba`); Yehozabadi (ID: `person:Jehozabad`); Shimeathi (ID: `person:Shimeath`); aliitwa (ID: `person:Zibiah`); Ramoth-gileadi (ID: `place:Ramoth-gilead`); Zekaria (ID: `person:Zechariah.12`); Nimshi (ID: `person:Nimshi`); Weapons (ID: `realia:Weapons`); Athalia (ID: `person:Athaliah`); Ahabu (ID: `person:Ahab`)
...
* **Associated ACAI Concepts:** Amazia (ID: `person:Amaziah`); Uzia (ID: `person:Uzziah`); Yothamu (ID: `person:Jotham.2`); Yoashi (ID: `person:Joash.4`); Ahazi (ID: `person:Ahaz`); Azaria (ID: `person:Azariah.9`); Maaseya (ID: `person:Maaseiah.3`); Elkana (ID: `person:Elkanah.8`); Azaria (ID: `person:Azariah.10`); Maaseya (ID: `person:Maaseiah.4`); Yeieli (ID: `person:Jeiel.6`); Zikri (ID: `person:Zichri.10`); Amasa (ID: `person:Amasa.2`); Berekia (ID: `person:Berechiah.4`); Hanania (ID: `person:Hananiah.4`); Zekaria (ID: `person:Zechariah.13`); Azrikamu (ID: `person:Azrikam.4`); Odedi (ID: `person:Oded.2`); Yohana (ID: `person:Johanan.4`); Gur-baali (ID: `place:Gurbaal`); Gimzo (ID: `place:Gimzo`); ugeukapo (ID: `place:Angle`); Yehizkia (ID: `person:Jehizkiah`); Shalumu (ID: `person:Shallum.9`); Meshilemothi (ID: `person:Meshillemoth.2`); Hadlai (ID: `person:Hadlai`); Beth-shemeshi (ID: `place:Beth-shemesh`); pembeni (ID: `place:CornerGate`); Sadoki (ID: `person:Zadok.3`); Yekolia (ID: `person:Jecoliah`)
...
* **Associated ACAI Concepts:** Hezekia (ID: `person:Hezekiah`); Shimei (ID: `person:Shimei.14`); Azaria (ID: `person:Azariah.11`); Yehaleleli (ID: `person:Jehallelel.2`); Edeni (ID: `person:Eden.2`); Azaria (ID: `person:Azariah.15`); Nahathi (ID: `person:Nahath.2`); Zima (ID: `person:Zimmah.2`); Elieli (ID: `person:Eliel.8`); Shimri (ID: `person:Shimri.4`); Yoa (ID: `person:Joah.5`); Amaria (ID: `person:Amariah.5`); Shimei (ID: `person:Shimei.13`); Edeni (ID: `person:Eden`); Yoa (ID: `person:Joah.6`); Zekaria (ID: `person:Zechariah.14`); Yehieli (ID: `person:Jehiel.5`); Benaya (ID: `person:Benaiah.7`); Shemaya (ID: `person:Shemaiah.12`); Yehueli (ID: `person:Jehuel`); Shemaya (ID: `person:Shemaiah.11`); Mahathi (ID: `person:Mahath.2`); Matania (ID: `person:Mattaniah.4`); Imna (ID: `person:Imnah.2`); Yeueli (ID: `person:Jeuel.2`); Mahathi (ID: `person:Mahath.3`); Yeshua (ID: `person:Jeshua.2`); Uzieli (ID: `person:Uzziel.5`); Yoeli (ID: `person:Joel.11`); Kishi (ID: `person:Kish.3`)
...
* **Associated ACAI Concepts:** Manase (ID: `person:Manasseh.2`); Hilkia (ID: `person:Hilkiah.2`); Amoni (ID: `person:Amon.3`); Yosia (ID: `person:Josiah`); Shafani (ID: `person:Shaphan`); Yehoahazi (ID: `person:Jehoahaz.3`); Obadia (ID: `person:Obadiah.9`); Shemaya (ID: `person:Shemaiah.13`); Hashabia (ID: `person:Hashabiah.6`); Zekaria (ID: `person:Zechariah.16`); Maaseya (ID: `person:Maaseiah.5`); Nethaneli (ID: `person:Nethanel.7`); Yozabadi (ID: `person:Jozabad.5`); Zekaria (ID: `person:Zechariah.15`); Yoa (ID: `person:Joah.4`); Yeieli (ID: `person:Jeiel.7`); Yahathi (ID: `person:Jahath.4`); Meshulamu (ID: `person:Meshullam.8`); Yehieli (ID: `person:Jehiel.6`); Yoahazi (ID: `person:Joahaz`); Appoint (ID: `keyterm:Appoint`); Shalumu (ID: `person:Shallum.3`); Hulda (ID: `person:Huldah`); Mikaya (ID: `person:Micaiah.3`); Azalia (ID: `person:Azaliah`); Harhasi (ID: `person:Harhas`); Tikwa (ID: `person:Tikvah`); Konania (ID: `person:Conaniah`); Asaya (ID: `person:Asaiah`); Karkemishi (ID: `place:Carchemish`)
...
* **Associated ACAI Concepts:** Babeli (ID: `place:Babylon`); Uajemi (ID: `place:Persia`); Yeremia (ID: `person:Jeremiah.6`); Koreshi (ID: `person:Cyrus`); Yerusalemu (ID: `place:Jerusalem`); House (ID: `realia:House`); BWANA (ID: `deity:Lord`)
