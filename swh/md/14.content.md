...
* **Associated Articles:** Mungu (ID: `367690@BiblicaStudyNotesKeyTerms`); Mbingu (ID: `367692@BiblicaStudyNotesKeyTerms`); Kazi (ID: `367699@BiblicaStudyNotesKeyTerms`); Ukoo (ID: `367711@BiblicaStudyNotesKeyTerms`); Jina (ID: `367716@BiblicaStudyNotesKeyTerms`); Sala (ID: `367718@BiblicaStudyNotesKeyTerms`); Mungu huchagua (ID: `367720@BiblicaStudyNotes`); Dhabihu (ID: `367747@BiblicaStudyNotesKeyTerms`); Israeli (ID: `367771@BiblicaStudyNotesKeyTerms`); Miungu wa uongo (ID: `367775@BiblicaStudyNotesKeyTerms`); Madhabahu (ID: `367776@BiblicaStudyNotesKeyTerms`); Watu wa Mungu (ID: `367793@BiblicaStudyNotes`); Mfalme (ID: `367821@BiblicaStudyNotesKeyTerms`); Kuhani (ID: `367824@BiblicaStudyNotesKeyTerms`); Walawi (ID: `367834@BiblicaStudyNotesKeyTerms`); Mgeni (ID: `367860@BiblicaStudyNotesKeyTerms`); Hekalu (ID: `367908@BiblicaStudyNotesKeyTerms`); Moyo (ID: `367910@BiblicaStudyNotesKeyTerms`); Daudi (ID: `367940@BiblicaStudyNotesKeyTerms`); Agano na Daudi (ID: `367957@BiblicaStudyNotesKeyTerms`); Sulemani (ID: `367964@BiblicaStudyNotesKeyTerms`); Mlima Moria (ID: `367996@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Sulemani (ID: `person:Solomon`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); House (ID: `realia:House`); Daudi (ID: `person:David`); Yerusalemu (ID: `place:Jerusalem`); Covenant Box (ID: `keyterm:CovenantBox`); To Sin (ID: `keyterm:Sin`); Ability (ID: `keyterm:Ability`); Offering (ID: `keyterm:Offering`); Hiramu (ID: `person:Hiram`); Misri (ID: `place:Egypt`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Forgive (ID: `keyterm:Forgive`); Kindness (ID: `keyterm:Kindness`); Glory (ID: `keyterm:Glory`); Plea for Mercy (ID: `keyterm:Supplication`); Holy (ID: `keyterm:Holy`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Cubit (ID: `realia:Cubit`); Temple Altar (ID: `realia:TempleAltar`); Money (ID: `realia:Money`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Slaughtering (ID: `keyterm:Slaughtering`); malkia (ID: `person:QueenOfSheba`); Bless (ID: `keyterm:Bless`); patakatifu (ID: `place:MostHolyPlace`)
...
* **Associated ACAI Concepts:** Rehoboamu (ID: `person:Rehoboam`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Yerusalemu (ID: `place:Jerusalem`); Yeroboamu (ID: `person:Jeroboam`); Benyamini (ID: `group:Benjamin`); Sulemani (ID: `person:Solomon`); Daudi (ID: `person:David`); Benyamini (ID: `person:Benjamin`); Shemaya (ID: `person:Shemaiah`); Fortification (ID: `realia:Fortification`); Shishaki (ID: `person:Shishak`); Misri (ID: `place:Egypt`); Yoke (ID: `realia:Yoke`); Maaka (ID: `person:Maacah.3`); Counsel (ID: `keyterm:Counsel`); Abiya (ID: `person:Abijah.4`); House (ID: `realia:House`); Walawi (ID: `group:Levi`); Absalomu (ID: `person:Absalom`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Walawi (ID: `person:Levi.3`); Yese (ID: `person:Jesse`); Nebati (ID: `person:Nebat`); Work (ID: `keyterm:Work`); Ahiya (ID: `person:Ahijah.2`); Adoramu (ID: `person:Adoram`); Yeushi (ID: `person:Jeush.5`)
...
* **Associated ACAI Concepts:** Abiya (ID: `person:Abijah.4`); BWANA (ID: `deity:Lord`); Yeroboamu (ID: `person:Jeroboam`); Israeli (ID: `person:Israel`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Daudi (ID: `person:David`); Efraimu (ID: `person:Ephraim`); Haruni (ID: `person:Aaron`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Sulemani (ID: `person:Solomon`); Cattle (ID: `fauna:Bull`); Trumpet (ID: `realia:Trumpet`); Gibea (ID: `place:Gibeah`); Yeshana (ID: `place:Jeshanah`); Urieli (ID: `person:Uriel.3`); Ido (ID: `person:Iddo.5`); Offering (ID: `keyterm:Offering`); Nebati (ID: `person:Nebat`); Efraimu (ID: `group:Ephraim`); Strength (ID: `keyterm:Strength`); Semaraimu (ID: `place:Zemaraim`); Covenant (ID: `keyterm:Covenant`); Yerusalemu (ID: `place:Jerusalem`); Pure (ID: `keyterm:Pure`); Asa (ID: `person:Asa`); Rehoboamu (ID: `person:Rehoboam`); Wickedness (ID: `keyterm:Wickedness`); Betheli (ID: `place:Bethel`); Rebel (ID: `keyterm:Rebel`); Maaka (ID: `person:Maacah.3`); Bread of Display (ID: `realia:BreadOfDisplay`); Sheep (ID: `fauna:Lamb`); Lampstand (ID: `realia:Lampstand.2`); Molten Image (ID: `realia:MoltenImage`); Lamp (ID: `realia:Lamp`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Asa (ID: `person:Asa`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Israeli (ID: `person:Israel`); Benyamini (ID: `person:Benjamin`); Wakushi (ID: `place:Ethiopia`); Ethiopians (ID: `group:Ethiopia`); Baasha (ID: `person:Baasha`); Benyamini (ID: `group:Benjamin`); Ramah (ID: `place:Ramah.2`); Odedi (ID: `person:Oded`); Swear (ID: `keyterm:Swear`); Maresha (ID: `place:Mareshah`); Efraimu (ID: `person:Ephraim`); Efraimu (ID: `group:Ephraim`); Ben-hadadi (ID: `person:Ben-hadad`); Ashera (ID: `deity:Asherah`); Covenant (ID: `keyterm:Covenant`); Yerusalemu (ID: `place:Jerusalem`); Instruction (ID: `keyterm:Instruction`); Gerari (ID: `place:Gerar`); High Place (ID: `realia:HighPlace`); Money (ID: `realia:Money`); House (ID: `realia:House`); Stone Pine (ID: `flora:Pine`); Kidroni (ID: `place:Kidron`); Zera (ID: `person:Zerah.5`); Azaria (ID: `person:Azariah.8`); bondeni (ID: `place:ZephathahValley`); Abeli (ID: `place:Abel-beth-maacah`); Hanani (ID: `person:Hanani`); Iyoni (ID: `place:Ijon`); Dani (ID: `place:Dan`); Strength (ID: `keyterm:Strength`); Dameski (ID: `place:Damascus`); Oath (ID: `keyterm:Oath`); Detested Thing (ID: `keyterm:DetestedThing`); Daudi (ID: `person:David`); Delight (ID: `keyterm:Delight`); Dani (ID: `group:Dan`); Simeoni (ID: `group:Simeon`); Truth (ID: `keyterm:Truth`); Manase (ID: `person:Manasseh`); Geba (ID: `place:Geba`); Simeoni (ID: `person:Simeon.5`); Naftali (ID: `person:Naphtali`); Maaka (ID: `person:Maacah.3`); Peace (ID: `keyterm:IntactState`); Manase (ID: `group:Manasseh`); Walubi (ID: `place:Libya`); Mispa (ID: `place:Mizpah`); Naftali (ID: `group:Naphtali`); Stone Altar (ID: `realia:StoneAltar`); Chariot (ID: `realia:Chariot`); Goat (ID: `fauna:Goat`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Flock (ID: `fauna:Flock`); Altar (ID: `realia:Altar`); Cattle (ID: `fauna:Bull`); Tent (ID: `realia:Tent`); Small Shield (ID: `realia:SmallShield`); Image (ID: `realia:Image`); Rams Horn (ID: `realia:RamsHorn`); Sacred Pole (ID: `realia:SacredPole`); Bow (ID: `realia:Bow`); Large Shield (ID: `realia:LargeShield`); Sacred Pillar (ID: `realia:SacredPillar`); Balsam Tree (ID: `flora:BalsamTree`); Camel (ID: `fauna:Camel`); Fortification (ID: `realia:Fortification`); Spear (ID: `realia:Spear`); Tower (ID: `realia:Tower`); Bed (ID: `realia:Bed`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yehoshafati (ID: `person:Jehoshaphat.3`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Israeli (ID: `person:Israel`); Yerusalemu (ID: `place:Jerusalem`); Mikaya (ID: `person:Micaiah.5`); Ramoth-gileadi (ID: `place:Ramoth-gilead`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Speak as a Prophet (ID: `keyterm:Speak`); Moabu (ID: `place:Moab`); Waamoni (ID: `place:Ammon`); Fear (ID: `keyterm:Fear`); Ahabu (ID: `person:Ahab`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Chariot (ID: `realia:Chariot`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Seiri (ID: `place:SeirMount`); Kenaana (ID: `person:Chenaanah`); Imla (ID: `person:Imlah`); Strength (ID: `keyterm:Strength`); Ahazia (ID: `person:Ahaziah`); Hanani (ID: `person:Hanani`); Yehu (ID: `person:Jehu`); Sedekia (ID: `person:Zedekiah.2`); Ashera (ID: `deity:Asherah`); Instruction (ID: `keyterm:Instruction`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yehoyada (ID: `person:Jehoiada.2`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); House (ID: `realia:House`); Yerusalemu (ID: `place:Jerusalem`); Ahazia (ID: `person:Ahaziah.2`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Israeli (ID: `person:Israel`); Daudi (ID: `person:David`); Ahabu (ID: `person:Ahab`); Athalia (ID: `person:Athaliah`); Yehoramu (ID: `person:Jehoram`); Yoashi (ID: `person:Joash.3`); Covenant (ID: `keyterm:Covenant`); Yoramu (ID: `person:Joram.3`); Musa (ID: `person:Moses`); Syrians (ID: `group:Syria`); Yehu (ID: `person:Jehu.2`); Edomu (ID: `place:Edom`); Ramoth-gileadi (ID: `place:Ramoth-gilead`); Testimony (ID: `keyterm:Witness.2`); Arabians (ID: `group:Arabia`); Offering (ID: `keyterm:Offering`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Baali (ID: `deity:Baal`); Hazaeli (ID: `person:Hazael`); Yehoshafati (ID: `person:Jehoshaphat.3`); Rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Israeli (ID: `person:Israel`); Amazia (ID: `person:Amaziah`); Uzia (ID: `person:Uzziah`); Yerusalemu (ID: `place:Jerusalem`); Ahazi (ID: `person:Ahaz`); Yothamu (ID: `person:Jotham.2`); Yoashi (ID: `person:Joash.4`); Samaria (ID: `place:Samaria`); House (ID: `realia:House`); Be Unfaithful (ID: `keyterm:Unfaithful`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Efraimu (ID: `group:Ephraim`); Edomu (ID: `place:Edom`); Efraimu (ID: `person:Ephraim`); Beth-shemeshi (ID: `place:Beth-shemesh`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); Assyria (ID: `place:Assyria`); Tower (ID: `realia:Tower`); pembeni (ID: `place:CornerGate`); Azaria (ID: `person:Azariah.9`); Shefela (ID: `place:Shephelah`); Yoashi (ID: `person:Joash.3`); Ammonites (ID: `group:Ammon`); Seiri (ID: `place:Seir`); Strength (ID: `keyterm:Strength`); Waamoni (ID: `place:Ammon`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Hezekia (ID: `person:Hezekiah`); Yerusalemu (ID: `place:Jerusalem`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Offering (ID: `keyterm:Offering`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Israeli (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Daudi (ID: `person:David`); Assyria (ID: `place:Assyria`); Pure (ID: `keyterm:Pure`); Passover (ID: `keyterm:Passover`); Senakeribu (ID: `person:Sennacherib`); Manase (ID: `person:Manasseh`); Manase (ID: `group:Manasseh`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Instruction (ID: `keyterm:Instruction`); Efraimu (ID: `group:Ephraim`); Efraimu (ID: `person:Ephraim`); Work (ID: `keyterm:Work`); Be Unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Israeli (ID: `person:Israel`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Yosia (ID: `person:Josiah`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Passover (ID: `keyterm:Passover`); Manase (ID: `person:Manasseh.2`); Hilkia (ID: `person:Hilkiah.2`); Daudi (ID: `person:David`); House (ID: `realia:House`); Shafani (ID: `person:Shaphan`); Amoni (ID: `person:Amon.3`); Force to Serve (ID: `keyterm:EnticedToServe`); Ashera (ID: `deity:Asherah`); Instruction (ID: `keyterm:Instruction`); Work (ID: `keyterm:Work`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Scroll (ID: `realia:Scroll`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Graven Image (ID: `realia:GravenImage`); Musa (ID: `person:Moses`); Offering (ID: `keyterm:Offering`); Sacred Pole (ID: `realia:SacredPole`); Yehoahazi (ID: `person:Jehoahaz.3`); Appoint (ID: `keyterm:Appoint`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Babeli (ID: `place:Babylon`); House (ID: `realia:House`); Nebukadneza (ID: `person:Nebuchadnezzar`); Uajemi (ID: `place:Persia`); Yeremia (ID: `person:Jeremiah.6`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Koreshi (ID: `person:Cyrus`); Sedekia (ID: `person:Zedekiah.3`); An Angel (ID: `deity:Angel`); Yehoyakimu (ID: `person:Jehoiakim`); Yekonia (ID: `person:Jehoiachin`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Israeli (ID: `person:Israel`); Wakaldayo (ID: `place:Chaldea`); Be Unfaithful (ID: `keyterm:Unfaithful`); Swear (ID: `keyterm:Swear`); Defilement (ID: `keyterm:Defilement`); Rebel (ID: `keyterm:Rebel`); Sabbath (ID: `keyterm:Sabbath`); Chaldeans (ID: `group:Chaldea`); Holy (ID: `keyterm:Holy`)
