...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Memucan (ID: `person:Memucan`); Ahasuero (ID: `person:Ahasuerus`); Hegai (ID: `person:Hegai`); Esther (ID: `person:Esther`); Mordekai (ID: `person:Mordecai.2`); Carkas (ID: `person:Carkas`); Meres (ID: `person:Meres`); Marsena (ID: `person:Marsena`); Mehuman (ID: `person:Mehuman`); Bigtha (ID: `person:Bigtha`); Admatha (ID: `person:Admatha`); Yairi (ID: `person:Jair.4`); Biztha (ID: `person:Biztha`); Kishi (ID: `person:Kish.4`); Shethar (ID: `person:Shethar`); Zethar (ID: `person:Zethar`); Abagtha (ID: `person:Abagtha`); Shimei (ID: `person:Shimei.18`); Shaashgaz (ID: `person:Shaashgaz`); Carshena (ID: `person:Carshena`); Harbona (ID: `person:Harbona`); Umedi (ID: `place:Media`); Abihaili (ID: `person:Abihail.5`); Cotton (ID: `flora:Cotton`); Bigthan (ID: `person:Bigthan`); Teresh (ID: `person:Teresh`); India (ID: `place:India`); Crown (ID: `realia:Crown`); Balsam Tree (ID: `flora:BalsamTree`); Washushani (ID: `place:Susa`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Ahasuero (ID: `person:Ahasuerus`); Mordekai (ID: `person:Mordecai.2`)
...
* **Associated ACAI Concepts:** Hathach (ID: `person:Hathach`); Mordekai (ID: `person:Mordecai.2`); Esther (ID: `person:Esther`); Sackcloth (ID: `realia:Sackcloth`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Esther (ID: `person:Esther`); Zeresh (ID: `person:Zeresh`); Harbona (ID: `person:Harbona.2`); Teresh (ID: `person:Teresh`); Bigthan (ID: `person:Bigthan`); Mordekai (ID: `person:Mordecai.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Poratha (ID: `person:Poratha`); Aridai (ID: `person:Aridai`); Aspatha (ID: `person:Aspatha`); Adalia (ID: `person:Adalia`); Arisai (ID: `person:Arisai`); Parshandatha (ID: `person:Parshandatha`); Dalphon (ID: `person:Dalphon`); Aridatha (ID: `person:Aridatha`); Vaizatha (ID: `person:Vaizatha`); Parmashta (ID: `person:Parmashta`); Abihaili (ID: `person:Abihail.5`); India (ID: `place:India`); Washushani (ID: `place:Susa`); Ahasuero (ID: `person:Ahasuerus`); Mordekai (ID: `person:Mordecai.2`); Esther (ID: `person:Esther`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`); Scroll (ID: `realia:Scroll`); Agagites (ID: `group:Agag`)
