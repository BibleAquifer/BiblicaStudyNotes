...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Mwelkoshi (ID: `place:Elkosh`); Nahumu (ID: `person:Nahum.2`); Zealous (ID: `keyterm:Zealous.3`); Bashani (ID: `place:Bashan`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); The Way (ID: `keyterm:TheWay`); Lebanoni (ID: `place:Lebanon`); Karmeli (ID: `place:Carmel`); Strength (ID: `keyterm:Strength`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); Utterance (ID: `keyterm:Utterance`); Ninawi (ID: `place:Nineveh`); Scroll (ID: `realia:Scroll`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Lion (ID: `fauna:Lion`); Locust (ID: `fauna:Locust`); Wickedness (ID: `keyterm:Wickedness`); Ninawi (ID: `place:Nineveh`); Amoni (ID: `deity:Amon`); katika (ID: `place:Thebes`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Putu (ID: `place:Put`); Woe (ID: `keyterm:Woe.2`); mto (ID: `place:Nile`); Glory (ID: `keyterm:Glory`); Strength (ID: `keyterm:Strength`); Under Siege (ID: `keyterm:StateOfBeingUnderSiege`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Peace (ID: `keyterm:IntactState`); Misri (ID: `place:Egypt`); Yuda (ID: `group:Judah`); Detested Thing (ID: `keyterm:DetestedThing`); Yuda (ID: `person:Judah.4`); Israeli (ID: `person:Israel`); An Angel (ID: `deity:Angel`); Incantations (ID: `keyterm:Incantations`); Cush (ID: `place:Cush.2`); Assyria (ID: `place:Assyria`); Walubi (ID: `place:Libya`); Lot (ID: `keyterm:Lot`); Vow (ID: `keyterm:Vow`); Protective Shield (ID: `realia:ProtectiveShield`); Brick Mold (ID: `realia:BrickMold`); Brier (ID: `flora:Brier`); Fortification (ID: `realia:Fortification`); Phoenician Juniper (ID: `flora:JuniperTree`); Cypress (ID: `flora:Cypress`); Fortress (ID: `realia:Fortress`); Molten Image (ID: `realia:MoltenImage`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Fir (ID: `flora:Fir`); Dove (ID: `fauna:Dove`); Money (ID: `realia:Money`); Fig (ID: `flora:Fig`); Dyed Cloth (ID: `realia:DyedCloth`); Small Shield (ID: `realia:SmallShield`); Grecian Juniper (ID: `flora:Juniper`); Graven Image (ID: `realia:GravenImage`); Spear (ID: `realia:Spear`); Whip (ID: `realia:Whip`); Horse (ID: `fauna:Horse`); Wagon (ID: `realia:Wagon`); Sheep (ID: `fauna:Lamb`); Strong Drink (ID: `realia:StrongDrink`); Grass (ID: `flora:Grass`); Train (ID: `realia:Train`); Yoke (ID: `realia:Yoke`)
