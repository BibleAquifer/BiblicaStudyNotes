...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Mwelkoshi (ID: `place:Elkosh`); Nahumu (ID: `person:Nahum.2`); Bashani (ID: `place:Bashan`); Ninawi (ID: `place:Nineveh`); The Way (ID: `keyterm:TheWay`); Utterance (ID: `keyterm:Utterance`); Lebanoni (ID: `place:Lebanon`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Zealous (ID: `keyterm:Zealous.3`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); Karmeli (ID: `place:Carmel`); Strength (ID: `keyterm:Strength`); Fortress (ID: `realia:Fortress`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Locust (ID: `fauna:Locust`); Lion (ID: `fauna:Lion`); Ninawi (ID: `place:Nineveh`); Wickedness (ID: `keyterm:Wickedness`); Amoni (ID: `deity:Amon`); katika (ID: `place:Thebes`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Putu (ID: `place:Put`); Strength (ID: `keyterm:Strength`); Detested Thing (ID: `keyterm:DetestedThing`); Incantations (ID: `keyterm:Incantations`); Yuda (ID: `group:Judah`); Vow (ID: `keyterm:Vow`); Misri (ID: `place:Egypt`); An Angel (ID: `deity:Angel`); Woe (ID: `keyterm:Woe.2`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Cush (ID: `place:Cush.2`); Lot (ID: `keyterm:Lot`); mto (ID: `place:Nile`); Assyria (ID: `place:Assyria`); Peace (ID: `keyterm:IntactState`); Yuda (ID: `person:Judah.4`); Under Siege (ID: `keyterm:StateOfBeingUnderSiege`); Walubi (ID: `place:Libya`); Israeli (ID: `person:Israel`); Glory (ID: `keyterm:Glory`); Brick Mold (ID: `realia:BrickMold`); Protective Shield (ID: `realia:ProtectiveShield`); Brier (ID: `flora:Brier`); Fortress (ID: `realia:Fortress`); Yoke (ID: `realia:Yoke`); Small Shield (ID: `realia:SmallShield`); Money (ID: `realia:Money`); Fortification (ID: `realia:Fortification`); Train (ID: `realia:Train`); Phoenician Juniper (ID: `flora:JuniperTree`); Fig (ID: `flora:Fig`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); Dyed Cloth (ID: `realia:DyedCloth`); Dove (ID: `fauna:Dove`); Wagon (ID: `realia:Wagon`); Strong Drink (ID: `realia:StrongDrink`); Molten Image (ID: `realia:MoltenImage`); Fir (ID: `flora:Fir`); Spear (ID: `realia:Spear`); Whip (ID: `realia:Whip`); Graven Image (ID: `realia:GravenImage`); Horse (ID: `fauna:Horse`); Grecian Juniper (ID: `flora:Juniper`); Grass (ID: `flora:Grass`); Cypress (ID: `flora:Cypress`); Sword (ID: `realia:Sword`)
