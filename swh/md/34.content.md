...
* **Associated ACAI Concepts:** Nahumu (ID: `person:Nahum.2`); Mwelkoshi (ID: `place:Elkosh`)
...
* **Associated ACAI Concepts:** Protective Shield (ID: `realia:ProtectiveShield`); Brick Mold (ID: `realia:BrickMold`); Amoni (ID: `deity:Amon`); katika (ID: `place:Thebes`); BWANA (ID: `deity:Lord`)
