...
* **Associated Articles:** Dhambi (ID: `367686@BiblicaStudyNotesKeyTerms`); Wokovu (ID: `367687@BiblicaStudyNotesKeyTerms`); Mungu (ID: `367690@BiblicaStudyNotesKeyTerms`); Ndoa (ID: `367697@BiblicaStudyNotesKeyTerms`); Kazi (ID: `367699@BiblicaStudyNotesKeyTerms`); Hukumu (ID: `367724@BiblicaStudyNotesKeyTerms`); Kanaani (ID: `367737@BiblicaStudyNotesKeyTerms`); Israeli (ID: `367771@BiblicaStudyNotesKeyTerms`); Miungu wa uongo (ID: `367775@BiblicaStudyNotesKeyTerms`); Watu wa Mungu (ID: `367793@BiblicaStudyNotesKeyTerms`); Miujiza (ID: `367796@BiblicaStudyNotesKeyTerms`); Agano la Mlima Sinai (ID: `367819@BiblicaStudyNotes`); Ufalme wa makuhani (ID: `367828@BiblicaStudyNotesKeyTerms`); Kutubu (ID: `367837@BiblicaStudyNotesKeyTerms`); Takatifu (ID: `367852@BiblicaStudyNotesKeyTerms`); Laana za Agano (ID: `367871@BiblicaStudyNotesKeyTerms`); Baali (ID: `367892@BiblicaStudyNotesKeyTerms`); Malaika wa Bwana (ID: `367919@BiblicaStudyNotesKeyTerms`); Ashtorethi (ID: `367920@BiblicaStudyNotesKeyTerms`); Majaji 12 (ID: `367921@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Wakanaani (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Israeli (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Yoshua (ID: `person:Joshua.2`); Kalebu (ID: `person:Caleb`); Force to Serve (ID: `keyterm:EnticedToServe`); Betheli (ID: `place:Bethel`); Amorites (ID: `group:Amorites`); Bezeki (ID: `person:Adoni-bezek`); Yusufu (ID: `person:Joseph.10`); Perizzites (ID: `group:Perizzites`); Musa (ID: `person:Moses`); Negebu (ID: `place:Negeb`); Covenant (ID: `keyterm:Covenant`); Yerusalemu (ID: `place:Jerusalem`); huko (ID: `place:Bezek`); Aksa (ID: `person:Achsah`); Asheri (ID: `group:Asher`); Baali (ID: `deity:Baal`); Jebusites (ID: `group:Jebusites`); To Cause to Possess (ID: `keyterm:Possess`); Misri (ID: `place:Egypt`); Simeoni (ID: `group:Simeon`); Simeoni (ID: `person:Simeon.5`); Hebroni (ID: `place:Hebron`); Debiri (ID: `place:Debir`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Sisera (ID: `person:Sisera`); Baraka (ID: `person:Barak`); Debora (ID: `person:Deborah.2`); Ehudi (ID: `person:Ehud`); Yaeli (ID: `person:Jael`); Moabu (ID: `place:Moab`); Yabini (ID: `person:Jabin.2`); Heberi (ID: `person:Heber.2`); Abinoamu (ID: `person:Abinoam`); Egloni (ID: `person:Eglon`); Chariot (ID: `realia:Chariot`); Tent (ID: `realia:Tent`); Kedeshi (ID: `place:Kedesh`); Zabuloni (ID: `person:Zebulun`); Wakanaani (ID: `place:Canaan`); Zabuloni (ID: `group:Zebulun`); Sword (ID: `realia:Sword`); Mataifa (ID: `place:Harosheth-hagoyim`); Tabori (ID: `place:TaborMount`); Kishoni (ID: `place:Kishon`); Kenites (ID: `group:Kenite`); Force to Serve (ID: `keyterm:EnticedToServe`); Naftali (ID: `person:Naphtali`); Naftali (ID: `group:Naphtali`); Offering (ID: `keyterm:Offering`); Bless (ID: `keyterm:Bless`); Efraimu (ID: `group:Ephraim`); Efraimu (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Gideoni (ID: `person:Gideon`); BWANA (ID: `deity:Lord`); Abimeleki (ID: `person:Abimelech.2`); Midiani (ID: `place:Midian`); Israeli (ID: `person:Israel`); Shekemu (ID: `place:Shechem`); Gaali (ID: `person:Gaal`); Yoashi (ID: `person:Joash`); Salmuna (ID: `person:Zalmunna`); Zeba (ID: `person:Zebah`); An Angel (ID: `deity:Angel`); Ofra (ID: `place:Ophrah.2`); Zebuli (ID: `person:Zebul`); Ebedi (ID: `person:Ebed`); Baali (ID: `deity:Baal`); Sukothi (ID: `place:Succoth`); Fear (ID: `keyterm:Fear`); Abiezeri (ID: `person:Abiezer`); Yothamu (ID: `person:Jotham`); Ashera (ID: `deity:Asherah`); mashariki (ID: `place:East`); Tower (ID: `realia:Tower`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Rams Horn (ID: `realia:RamsHorn`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Abiezrites (ID: `group:Abiezer`); Misri (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** Israeli (ID: `person:Israel`); Waamoni (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Yeftha (ID: `person:Jephthah`); BWANA (ID: `deity:Lord`); Gileadi (ID: `place:Gilead`); Efraimu (ID: `group:Ephraim`); Efraimu (ID: `person:Ephraim`); Yordani (ID: `place:Jordan`); Amorites (ID: `group:Amorites`); Moabu (ID: `place:Moab`); An Angel (ID: `deity:Angel`); Arnoni (ID: `place:Arnon`); Mizpah (ID: `place:Mizpah.2`); Force to Serve (ID: `keyterm:EnticedToServe`); Gileadites (ID: `group:Gilead`); Dispossess (ID: `keyterm:Dispossess`); Misri (ID: `place:Egypt`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); Sihoni (ID: `person:Sihon`); To Sin (ID: `keyterm:Sin`); Gileadi (ID: `person:Gilead.2`); Abdoni (ID: `person:Abdon`); Hileli (ID: `person:Hillel`); Shamiri (ID: `place:Shamir.2`); Yairi (ID: `person:Jair.3`); Eloni (ID: `person:Elon.3`); Ibzani (ID: `person:Ibzan`); Zabuloni (ID: `group:Zebulun`)
...
* **Associated ACAI Concepts:** Samsoni (ID: `person:Samson`); BWANA (ID: `deity:Lord`); Wafilisti (ID: `group:Philistine`); Wafilisti (ID: `place:Philistine`); Manoa (ID: `person:Manoah`); An Angel (ID: `deity:Angel`); Delila (ID: `person:Delilah`); Strength (ID: `keyterm:Strength`); Israeli (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Sora (ID: `place:Zorah`); Lehi (ID: `place:Lehi`); Nazirites (ID: `group:Nazirite`); Offering (ID: `keyterm:Offering`); Gaza (ID: `place:Gaza`); Yuda (ID: `group:Judah`); Defilement (ID: `keyterm:Defilement`); Yuda (ID: `person:Judah.4`); Timna (ID: `place:Timnah`); Love (ID: `keyterm:Love`); Goat (ID: `fauna:Goat`); Lion (ID: `fauna:Lion`); Rope (ID: `realia:Rope`); Kid (ID: `fauna:Kid`); Manoah's Wife (ID: `person:WifeOfManoah`); Etamu (ID: `place:Etam`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Eshtaoli (ID: `place:Eshtaol`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Mika (ID: `person:Micah.3`); Dani (ID: `place:Dan`); Dani (ID: `group:Dan`); BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); kinyago (ID: `deity:Teraphim`); Graven Image (ID: `realia:GravenImage`); Household Idols (ID: `realia:HouseholdIdols`); Molten Image (ID: `realia:MoltenImage`); Ephod (ID: `realia:Ephod`); Efraimu (ID: `person:Ephraim`); Efraimu (ID: `group:Ephraim`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Israeli (ID: `person:Israel`); Eshtaoli (ID: `place:Eshtaol`); Money (ID: `realia:Money`); A Person (ID: `person:GenericPerson`); Trust (ID: `keyterm:LeanOn`); Sora (ID: `place:Zorah`); Bethlehemu (ID: `place:Bethlehem`); Mother of Micah (ID: `person:MotherOfMicah.3`); Wasidoni (ID: `place:Sidon`); Peace (ID: `keyterm:IntactState`); Dispossess (ID: `keyterm:Dispossess`); Mahane-dani (ID: `place:Mahaneh-dan`); Gershomu (ID: `person:Gershom`); Military Members (ID: `group:MilitaryMembers`); Yonathani (ID: `person:Jonathan.2`); Bethrehobu (ID: `place:Beth-rehob`); To Cause to Possess (ID: `keyterm:Possess`); Kiriath-yearimu (ID: `place:Kiriath-jearim`); To Curse (ID: `keyterm:Curse`); Bless (ID: `keyterm:Bless`); Shilo (ID: `place:Shiloh`); Musa (ID: `person:Moses`); Safety (ID: `keyterm:Safety`); Holy (ID: `keyterm:Holy`); Sidonians (ID: `group:Sidon`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** Israeli (ID: `person:Israel`); Benyamini (ID: `group:Benjamin`); Benyamini (ID: `person:Benjamin`); Gibeah (ID: `place:Gibeah.2`); BWANA (ID: `deity:Lord`); Yabeshi (ID: `place:Jabesh-gilead`); Mispa (ID: `place:Mizpah`); Betheli (ID: `place:Bethel`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); To Cause to Possess (ID: `keyterm:Possess`); A Father (ID: `person:GenericFather`); Yuda (ID: `group:Judah`); Foolish (ID: `keyterm:Foolish`); Yuda (ID: `person:Judah.4`); Donkey (ID: `fauna:Donkey`); Rock of Rimmon (ID: `place:Rimmon.3`); Efraimu (ID: `person:Ephraim`); Efraimu (ID: `group:Ephraim`); Swear (ID: `keyterm:Swear`); Shilo (ID: `place:Shiloh`); Bethlehemu (ID: `place:Bethlehem`); Offering (ID: `keyterm:Offering`); A Man (ID: `person:GenericMale`); Yerusalemu (ID: `place:Jerusalem`); Walawi (ID: `group:Levi`); Wickedness (ID: `keyterm:Wickedness`); Walawi (ID: `person:Levi.3`); Peace (ID: `keyterm:IntactState`); Vine (ID: `flora:Vine`)
