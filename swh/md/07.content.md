...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Wakanaani (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Israeli (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Yoshua (ID: `person:Joshua.2`); Kalebu (ID: `person:Caleb`); Force to Serve (ID: `keyterm:EnticedToServe`); Amorites (ID: `group:Amorites`); Betheli (ID: `place:Bethel`); Bezeki (ID: `person:Adoni-bezek`); Negebu (ID: `place:Negeb`); Yusufu (ID: `person:Joseph.10`); Perizzites (ID: `group:Perizzites`); Musa (ID: `person:Moses`); Covenant (ID: `keyterm:Covenant`); Yerusalemu (ID: `place:Jerusalem`); Aksa (ID: `person:Achsah`); huko (ID: `place:Bezek`); Asheri (ID: `group:Asher`); Baali (ID: `deity:Baal`); To Cause to Possess (ID: `keyterm:Possess`); Asheri (ID: `person:Asher`); Wasidoni (ID: `place:Sidon`); Simeoni (ID: `group:Simeon`); Simeoni (ID: `person:Simeon.5`); An Angel (ID: `deity:Angel`); Jebusites (ID: `group:Jebusites`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Sisera (ID: `person:Sisera`); Baraka (ID: `person:Barak`); Debora (ID: `person:Deborah.2`); Ehudi (ID: `person:Ehud`); Yaeli (ID: `person:Jael`); Moabu (ID: `place:Moab`); Yabini (ID: `person:Jabin.2`); Abinoamu (ID: `person:Abinoam`); Heberi (ID: `person:Heber.2`); Egloni (ID: `person:Eglon`); Tent (ID: `realia:Tent`); Chariot (ID: `realia:Chariot`); Wakanaani (ID: `place:Canaan`); Kedeshi (ID: `place:Kedesh`); Zabuloni (ID: `person:Zebulun`); Zabuloni (ID: `group:Zebulun`); Sword (ID: `realia:Sword`); Mataifa (ID: `place:Harosheth-hagoyim`); Tabori (ID: `place:TaborMount`); Kishoni (ID: `place:Kishon`); Kenites (ID: `group:Kenite`); Naftali (ID: `person:Naphtali`); Naftali (ID: `group:Naphtali`); Efraimu (ID: `group:Ephraim`); Bless (ID: `keyterm:Bless`); Force to Serve (ID: `keyterm:EnticedToServe`); Offering (ID: `keyterm:Offering`); Efraimu (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Gideoni (ID: `person:Gideon`); BWANA (ID: `deity:Lord`); Abimeleki (ID: `person:Abimelech.2`); Midiani (ID: `place:Midian`); Israeli (ID: `person:Israel`); Shekemu (ID: `place:Shechem`); Gaali (ID: `person:Gaal`); Yoashi (ID: `person:Joash`); Zeba (ID: `person:Zebah`); Salmuna (ID: `person:Zalmunna`); An Angel (ID: `deity:Angel`); Ofra (ID: `place:Ophrah.2`); Ebedi (ID: `person:Ebed`); Zebuli (ID: `person:Zebul`); Fear (ID: `keyterm:Fear`); Baali (ID: `deity:Baal`); Sukothi (ID: `place:Succoth`); Abiezeri (ID: `person:Abiezer`); Yothamu (ID: `person:Jotham`); mashariki (ID: `place:East`); Ashera (ID: `deity:Asherah`); Rams Horn (ID: `realia:RamsHorn`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Tower (ID: `realia:Tower`); Stone Altar (ID: `realia:StoneAltar`); House (ID: `realia:House`); Abiezrites (ID: `group:Abiezer`); Peace (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** Israeli (ID: `person:Israel`); Waamoni (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Yeftha (ID: `person:Jephthah`); BWANA (ID: `deity:Lord`); Gileadi (ID: `place:Gilead`); Efraimu (ID: `group:Ephraim`); Efraimu (ID: `person:Ephraim`); Amorites (ID: `group:Amorites`); Yordani (ID: `place:Jordan`); Moabu (ID: `place:Moab`); An Angel (ID: `deity:Angel`); Arnoni (ID: `place:Arnon`); Mizpah (ID: `place:Mizpah.2`); Dispossess (ID: `keyterm:Dispossess`); Force to Serve (ID: `keyterm:EnticedToServe`); Gileadites (ID: `group:Gilead`); To Sin (ID: `keyterm:Sin`); Sihoni (ID: `person:Sihon`); Misri (ID: `place:Egypt`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Ibzani (ID: `person:Ibzan`); Gileadi (ID: `person:Gilead.2`); Hileli (ID: `person:Hillel`); Yairi (ID: `person:Jair.3`); Abdoni (ID: `person:Abdon`); Eloni (ID: `person:Elon.3`); Zabuloni (ID: `group:Zebulun`); Shamiri (ID: `place:Shamir.2`)
...
* **Associated ACAI Concepts:** Samsoni (ID: `person:Samson`); BWANA (ID: `deity:Lord`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Manoa (ID: `person:Manoah`); An Angel (ID: `deity:Angel`); Delila (ID: `person:Delilah`); Strength (ID: `keyterm:Strength`); Israeli (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Sora (ID: `place:Zorah`); Lehi (ID: `place:Lehi`); Nazirites (ID: `group:Nazirite`); Love (ID: `keyterm:Love`); Yuda (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); Timna (ID: `place:Timnah`); Gaza (ID: `place:Gaza`); Yuda (ID: `group:Judah`); Defilement (ID: `keyterm:Defilement`); Kid (ID: `fauna:Kid`); Goat (ID: `fauna:Goat`); Lion (ID: `fauna:Lion`); Rope (ID: `realia:Rope`); Manoah's Wife (ID: `person:WifeOfManoah`); Etamu (ID: `place:Etam`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Eshtaoli (ID: `place:Eshtaol`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Mika (ID: `person:Micah.3`); Dani (ID: `place:Dan`); Dani (ID: `group:Dan`); BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); kinyago (ID: `deity:Teraphim`); Graven Image (ID: `realia:GravenImage`); Molten Image (ID: `realia:MoltenImage`); Household Idols (ID: `realia:HouseholdIdols`); Ephod (ID: `realia:Ephod`); Yuda (ID: `person:Judah.4`); Efraimu (ID: `person:Ephraim`); Israeli (ID: `person:Israel`); Efraimu (ID: `group:Ephraim`); Yuda (ID: `group:Judah`); Eshtaoli (ID: `place:Eshtaol`); Money (ID: `realia:Money`); Trust (ID: `keyterm:LeanOn`); Bethlehemu (ID: `place:Bethlehem`); A Person (ID: `person:GenericPerson`); Sora (ID: `place:Zorah`); Mother of Micah (ID: `person:MotherOfMicah.3`); Wasidoni (ID: `place:Sidon`); Dispossess (ID: `keyterm:Dispossess`); Peace (ID: `keyterm:IntactState`); Mahane-dani (ID: `place:Mahaneh-dan`); Yonathani (ID: `person:Jonathan.2`); Military Members (ID: `group:MilitaryMembers`); Bethrehobu (ID: `place:Beth-rehob`); Gershomu (ID: `person:Gershom`); To Cause to Possess (ID: `keyterm:Possess`); Safety (ID: `keyterm:Safety`); Sidonians (ID: `group:Sidon`); Holy (ID: `keyterm:Holy`); Bless (ID: `keyterm:Bless`); Kiriath-yearimu (ID: `place:Kiriath-jearim`); To Curse (ID: `keyterm:Curse`); Musa (ID: `person:Moses`); Shilo (ID: `place:Shiloh`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** Israeli (ID: `person:Israel`); Benyamini (ID: `group:Benjamin`); Benyamini (ID: `person:Benjamin`); Gibeah (ID: `place:Gibeah.2`); BWANA (ID: `deity:Lord`); Yabeshi (ID: `place:Jabesh-gilead`); Mispa (ID: `place:Mizpah`); Betheli (ID: `place:Bethel`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); Foolish (ID: `keyterm:Foolish`); To Cause to Possess (ID: `keyterm:Possess`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); A Father (ID: `person:GenericFather`); Donkey (ID: `fauna:Donkey`); Rock of Rimmon (ID: `place:Rimmon.3`); Bethlehemu (ID: `place:Bethlehem`); Swear (ID: `keyterm:Swear`); Efraimu (ID: `person:Ephraim`); Efraimu (ID: `group:Ephraim`); Shilo (ID: `place:Shiloh`); Yerusalemu (ID: `place:Jerusalem`); Offering (ID: `keyterm:Offering`); A Man (ID: `person:GenericMale`); Wickedness (ID: `keyterm:Wickedness`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Peace (ID: `keyterm:IntactState`); Vine (ID: `flora:Vine`)
