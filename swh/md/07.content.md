...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Wakanaani (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Israeli (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Yoshua (ID: `person:Joshua.2`); Kalebu (ID: `person:Caleb`); Force to Serve (ID: `keyterm:EnticedToServe`); Amorites (ID: `group:Amorites`); Betheli (ID: `place:Bethel`); Bezeki (ID: `person:Adoni-bezek`); Musa (ID: `person:Moses`); Yerusalemu (ID: `place:Jerusalem`); Perizzites (ID: `group:Perizzites`); Negebu (ID: `place:Negeb`); Yusufu (ID: `person:Joseph.10`); Covenant (ID: `keyterm:Covenant`); huko (ID: `place:Bezek`); Aksa (ID: `person:Achsah`); Asheri (ID: `group:Asher`); Baali (ID: `deity:Baal`); To Cause to Possess (ID: `keyterm:Possess`); Hivites (ID: `group:Hivites`); Hebroni (ID: `place:Hebron`); Jebusites (ID: `group:Jebusites`); Wasidoni (ID: `place:Sidon`); An Angel (ID: `deity:Angel`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Sisera (ID: `person:Sisera`); Baraka (ID: `person:Barak`); Debora (ID: `person:Deborah.2`); Ehudi (ID: `person:Ehud`); Yaeli (ID: `person:Jael`); Moabu (ID: `place:Moab`); Yabini (ID: `person:Jabin.2`); Abinoamu (ID: `person:Abinoam`); Heberi (ID: `person:Heber.2`); Egloni (ID: `person:Eglon`); Tent (ID: `realia:Tent`); Chariot (ID: `realia:Chariot`); Zabuloni (ID: `group:Zebulun`); Zabuloni (ID: `person:Zebulun`); Wakanaani (ID: `place:Canaan`); Kedeshi (ID: `place:Kedesh`); Sword (ID: `realia:Sword`); Mataifa (ID: `place:Harosheth-hagoyim`); Tabori (ID: `place:TaborMount`); Kishoni (ID: `place:Kishon`); Kenites (ID: `group:Kenite`); Force to Serve (ID: `keyterm:EnticedToServe`); Naftali (ID: `person:Naphtali`); Offering (ID: `keyterm:Offering`); Naftali (ID: `group:Naphtali`); Bless (ID: `keyterm:Bless`); Efraimu (ID: `group:Ephraim`); Efraimu (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Gideoni (ID: `person:Gideon`); BWANA (ID: `deity:Lord`); Abimeleki (ID: `person:Abimelech.2`); Midiani (ID: `place:Midian`); Israeli (ID: `person:Israel`); Shekemu (ID: `place:Shechem`); Gaali (ID: `person:Gaal`); Yoashi (ID: `person:Joash`); Zeba (ID: `person:Zebah`); Salmuna (ID: `person:Zalmunna`); An Angel (ID: `deity:Angel`); Ebedi (ID: `person:Ebed`); Zebuli (ID: `person:Zebul`); Ofra (ID: `place:Ophrah.2`); Sukothi (ID: `place:Succoth`); Fear (ID: `keyterm:Fear`); Baali (ID: `deity:Baal`); Abiezeri (ID: `person:Abiezer`); Yothamu (ID: `person:Jotham`); Ashera (ID: `deity:Asherah`); mashariki (ID: `place:East`); Altar (ID: `realia:Altar`); Rams Horn (ID: `realia:RamsHorn`); Tower (ID: `realia:Tower`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); House (ID: `realia:House`); Abiezrites (ID: `group:Abiezer`); Truth (ID: `keyterm:Truth`)
...
* **Associated ACAI Concepts:** Israeli (ID: `person:Israel`); Waamoni (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Yeftha (ID: `person:Jephthah`); BWANA (ID: `deity:Lord`); Gileadi (ID: `place:Gilead`); Efraimu (ID: `group:Ephraim`); Efraimu (ID: `person:Ephraim`); Amorites (ID: `group:Amorites`); Yordani (ID: `place:Jordan`); Moabu (ID: `place:Moab`); An Angel (ID: `deity:Angel`); Arnoni (ID: `place:Arnon`); Mizpah (ID: `place:Mizpah.2`); Force to Serve (ID: `keyterm:EnticedToServe`); Dispossess (ID: `keyterm:Dispossess`); Gileadites (ID: `group:Gilead`); Wafilisti (ID: `place:Philistine`); To Sin (ID: `keyterm:Sin`); Sihoni (ID: `person:Sihon`); Wafilisti (ID: `group:Philistine`); Misri (ID: `place:Egypt`); Zabuloni (ID: `group:Zebulun`); Shamiri (ID: `place:Shamir.2`); Hileli (ID: `person:Hillel`); Ibzani (ID: `person:Ibzan`); Gileadi (ID: `person:Gilead.2`); Abdoni (ID: `person:Abdon`); Yairi (ID: `person:Jair.3`); Eloni (ID: `person:Elon.3`)
...
* **Associated ACAI Concepts:** Samsoni (ID: `person:Samson`); BWANA (ID: `deity:Lord`); Wafilisti (ID: `place:Philistine`); Wafilisti (ID: `group:Philistine`); Manoa (ID: `person:Manoah`); An Angel (ID: `deity:Angel`); Delila (ID: `person:Delilah`); Strength (ID: `keyterm:Strength`); Israeli (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Sora (ID: `place:Zorah`); Lehi (ID: `place:Lehi`); Nazirites (ID: `group:Nazirite`); Love (ID: `keyterm:Love`); Gaza (ID: `place:Gaza`); Timna (ID: `place:Timnah`); Yuda (ID: `group:Judah`); Defilement (ID: `keyterm:Defilement`); Yuda (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); Lion (ID: `fauna:Lion`); Rope (ID: `realia:Rope`); Goat (ID: `fauna:Goat`); Kid (ID: `fauna:Kid`); Manoah's Wife (ID: `person:WifeOfManoah`); Etamu (ID: `place:Etam`); Eshtaoli (ID: `place:Eshtaol`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Mika (ID: `person:Micah.3`); Dani (ID: `place:Dan`); Dani (ID: `group:Dan`); BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); kinyago (ID: `deity:Teraphim`); Graven Image (ID: `realia:GravenImage`); Molten Image (ID: `realia:MoltenImage`); Household Idols (ID: `realia:HouseholdIdols`); Ephod (ID: `realia:Ephod`); Efraimu (ID: `group:Ephraim`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Efraimu (ID: `person:Ephraim`); Israeli (ID: `person:Israel`); Eshtaoli (ID: `place:Eshtaol`); Money (ID: `realia:Money`); A Person (ID: `person:GenericPerson`); Sora (ID: `place:Zorah`); Bethlehemu (ID: `place:Bethlehem`); Trust (ID: `keyterm:LeanOn`); Mother of Micah (ID: `person:MotherOfMicah.3`); Dispossess (ID: `keyterm:Dispossess`); Peace (ID: `keyterm:IntactState`); Wasidoni (ID: `place:Sidon`); Military Members (ID: `group:MilitaryMembers`); Mahane-dani (ID: `place:Mahaneh-dan`); Bethrehobu (ID: `place:Beth-rehob`); Yonathani (ID: `person:Jonathan.2`); Gershomu (ID: `person:Gershom`); To Cause to Possess (ID: `keyterm:Possess`); To Curse (ID: `keyterm:Curse`); Shilo (ID: `place:Shiloh`); Bless (ID: `keyterm:Bless`); Musa (ID: `person:Moses`); Safety (ID: `keyterm:Safety`); Kiriath-yearimu (ID: `place:Kiriath-jearim`); Holy (ID: `keyterm:Holy`); Sidonians (ID: `group:Sidon`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** Israeli (ID: `person:Israel`); Benyamini (ID: `group:Benjamin`); Benyamini (ID: `person:Benjamin`); Gibeah (ID: `place:Gibeah.2`); BWANA (ID: `deity:Lord`); Yabeshi (ID: `place:Jabesh-gilead`); Mispa (ID: `place:Mizpah`); Betheli (ID: `place:Bethel`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); To Cause to Possess (ID: `keyterm:Possess`); Foolish (ID: `keyterm:Foolish`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); A Father (ID: `person:GenericFather`); Donkey (ID: `fauna:Donkey`); Rock of Rimmon (ID: `place:Rimmon.3`); Swear (ID: `keyterm:Swear`); Shilo (ID: `place:Shiloh`); Bethlehemu (ID: `place:Bethlehem`); Efraimu (ID: `group:Ephraim`); Efraimu (ID: `person:Ephraim`); Wickedness (ID: `keyterm:Wickedness`); Walawi (ID: `group:Levi`); Peace (ID: `keyterm:IntactState`); Yerusalemu (ID: `place:Jerusalem`); Walawi (ID: `person:Levi.3`); Offering (ID: `keyterm:Offering`); A Man (ID: `person:GenericMale`); Vine (ID: `flora:Vine`)
