...
* **Associated ACAI Concepts:** Yerusalemu (ID: `place:Jerusalem`); BWANA (ID: `deity:Lord`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Koreshi (ID: `person:Cyrus`); House (ID: `realia:House`); Money (ID: `realia:Money`); Israeli (ID: `person:Israel`); Uajemi (ID: `place:Persia`); Walawi (ID: `person:Levi.3`); Zerubabeli (ID: `person:Zerubbabel.2`); Walawi (ID: `group:Levi`); Elamu (ID: `person:Elam`); Nebukadneza (ID: `person:Nebuchadnezzar`); Babeli (ID: `place:Babylon`); Sulemani (ID: `person:Solomon`); Salmai (ID: `person:Shalmai`); Shobai (ID: `person:Shobai`); Akubu (ID: `person:Akkub.3`); Kerosi (ID: `person:Keros`); Yedaya (ID: `person:Jedaiah.4`); Mehida (ID: `person:Mehida`); Siha (ID: `person:Ziha`); Wanetofathi (ID: `place:Netophah`); Gahari (ID: `person:Gahar`); Ateri (ID: `person:Ater.2`); Soferethi (ID: `person:Sophereth`); Hashumu (ID: `person:Hashum`); Resini (ID: `person:Rezin.2`); Yeshua (ID: `person:Jeshua`)
...
* **Associated ACAI Concepts:** Yerusalemu (ID: `place:Jerusalem`); BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Israeli (ID: `person:Israel`); Zerubabeli (ID: `person:Zerubbabel.2`); Mto (ID: `place:Euphrates`); Uajemi (ID: `place:Persia`); Koreshi (ID: `person:Cyrus`); Yuda (ID: `person:Judah.4`); Babeli (ID: `place:Babylon`); Dario (ID: `person:Darius.2`); Offering (ID: `keyterm:Offering`); Rehumu (ID: `person:Rehum.2`); Shimshai (ID: `person:Shimshai`); Artashasta (ID: `person:Artaxerxes.2`); Yoshua (ID: `person:Joshua.5`); Jews (ID: `group:Jews`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Yehosadaki (ID: `person:Jehozadak`); Shealtieli (ID: `person:Shealtiel.2`); Yuda (ID: `group:Judah`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Tatenai (ID: `person:Tattenai`); Nebukadneza (ID: `person:Nebuchadnezzar`); Samaria (ID: `place:Samaria`); Mithredathi (ID: `person:Mithredath.2`); heri (ID: `person:Bishlam`); Henadadi (ID: `person:Henadad`); Hodavia (ID: `person:Hodaviah.4`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Dario (ID: `person:Darius.2`); Yerusalemu (ID: `place:Jerusalem`); Israeli (ID: `person:Israel`); Mto (ID: `place:Euphrates`); Jews (ID: `group:Jews`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Scroll (ID: `realia:Scroll`); Tatenai (ID: `person:Tattenai`); Babeli (ID: `place:Babylon`); Offering (ID: `keyterm:Offering`); BWANA (ID: `deity:Lord`); Passover (ID: `keyterm:Passover`); Koreshi (ID: `person:Cyrus`); Sheep (ID: `fauna:Lamb`); Akmetha (ID: `place:Ecbatana`); Zekaria (ID: `person:Zechariah.17`); Umedi (ID: `place:Media`); Pure (ID: `keyterm:Pure`); Hagai (ID: `person:Haggai`); Artashasta (ID: `person:Artaxerxes`); Nebukadneza (ID: `person:Nebuchadnezzar`); Uajemi (ID: `place:Persia`); Assyria (ID: `place:Assyria`); Musa (ID: `person:Moses`); Defilement (ID: `keyterm:Defilement`); Gentiles (ID: `group:Gentile`); Ido (ID: `person:Iddo.6`); Unleavened Bread (ID: `realia:UnleavenedBread`); Wheat (ID: `flora:Wheat`); Foundation (ID: `realia:Foundation`); Flock (ID: `fauna:Flock`); Cubit (ID: `realia:Cubit`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Israeli (ID: `person:Israel`); Ezra (ID: `person:Ezra`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Artashasta (ID: `person:Artaxerxes`); House (ID: `realia:House`); Money (ID: `realia:Money`); Babeli (ID: `place:Babylon`); Ahava (ID: `place:Ahava`); Offering (ID: `keyterm:Offering`); Mto (ID: `place:Euphrates`); Hashabia (ID: `person:Hashabiah.7`); Sherebia (ID: `person:Sherebiah`); Decree (ID: `keyterm:Decree`); Perceive (ID: `keyterm:Perceive`); Instruction (ID: `keyterm:Instruction`); Finehasi (ID: `person:Phinehas`); Daudi (ID: `person:David`); Yehieli (ID: `person:Jehiel.7`); Zekaria (ID: `person:Zechariah.19`); Danieli (ID: `person:Daniel.2`); Hakatani (ID: `person:Hakkatan`); Elamu (ID: `person:Elam`); Nathani (ID: `person:Nathan.5`); Ebedi (ID: `person:Ebed.2`); Yozabadi (ID: `person:Jozabad.6`); Athalia (ID: `person:Athaliah.3`); Noadia (ID: `person:Noadiah`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Ezra (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Passion (ID: `keyterm:Ardour`); Yerusalemu (ID: `place:Jerusalem`); House (ID: `realia:House`); Harimu (ID: `person:Harim`); Elamu (ID: `person:Elam`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Offering (ID: `keyterm:Offering`); Counsel (ID: `keyterm:Counsel`); Matenai (ID: `person:Mattenai.2`); Matania (ID: `person:Mattaniah.6`); Matenai (ID: `person:Mattenai`); Yeremothi (ID: `person:Jeremoth.4`); Bani (ID: `person:Bani.5`); Zabadi (ID: `person:Zabad.7`); Yazeya (ID: `person:Jahzeiah`); Yehieli (ID: `person:Jehiel.8`); Bedeya (ID: `person:Bedeiah`); Wania (ID: `person:Vaniah`); Maaseya (ID: `person:Maaseiah.9`); Zebina (ID: `person:Zebina`); Benaya (ID: `person:Benaiah.8`); Binui (ID: `person:Binnui.3`); Pethahia (ID: `person:Pethahiah.2`)
