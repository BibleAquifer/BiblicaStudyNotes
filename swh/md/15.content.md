...
* **Associated ACAI Concepts:** Yerusalemu (ID: `place:Jerusalem`); BWANA (ID: `deity:Lord`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Koreshi (ID: `person:Cyrus`); House (ID: `realia:House`); Money (ID: `realia:Money`); Israeli (ID: `person:Israel`); Uajemi (ID: `place:Persia`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Zerubabeli (ID: `person:Zerubbabel.2`); Elamu (ID: `person:Elam`); Sulemani (ID: `person:Solomon`); Babeli (ID: `place:Babylon`); Nebukadneza (ID: `person:Nebuchadnezzar`); Salmai (ID: `person:Shalmai`); Sotai (ID: `person:Sotai`); Siha (ID: `person:Ziha`); Talmoni (ID: `person:Talmon`); Yeshua (ID: `person:Jeshua.4`); Barzilai (ID: `person:Barzillai.3`); Besai (ID: `person:Bezai`); Soferethi (ID: `person:Sophereth`); Harimu (ID: `person:Harim`); Hadidi (ID: `place:Hadid`); Hagaba (ID: `person:Hagabah`); Tema (ID: `person:Temah`); Mehida (ID: `person:Mehida`); Bani (ID: `person:Bani`)
...
* **Associated ACAI Concepts:** Yerusalemu (ID: `place:Jerusalem`); BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Israeli (ID: `person:Israel`); Zerubabeli (ID: `person:Zerubbabel.2`); Mto (ID: `place:Euphrates`); Uajemi (ID: `place:Persia`); Koreshi (ID: `person:Cyrus`); Dario (ID: `person:Darius.2`); Offering (ID: `keyterm:Offering`); Yuda (ID: `person:Judah.4`); Babeli (ID: `place:Babylon`); Rehumu (ID: `person:Rehum.2`); Shimshai (ID: `person:Shimshai`); Yoshua (ID: `person:Joshua.5`); Artashasta (ID: `person:Artaxerxes.2`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Jews (ID: `group:Jews`); Shealtieli (ID: `person:Shealtiel.2`); Yehosadaki (ID: `person:Jehozadak`); Yuda (ID: `group:Judah`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Tatenai (ID: `person:Tattenai`); Samaria (ID: `place:Samaria`); Nebukadneza (ID: `person:Nebuchadnezzar`); Ido (ID: `person:Iddo.6`); Henadadi (ID: `person:Henadad`); Yeshua (ID: `person:Jeshua.4`); Ahasuero (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Dario (ID: `person:Darius.2`); Yerusalemu (ID: `place:Jerusalem`); Israeli (ID: `person:Israel`); Walawi (ID: `group:Levi`); Mto (ID: `place:Euphrates`); Walawi (ID: `person:Levi.3`); Jews (ID: `group:Jews`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Scroll (ID: `realia:Scroll`); Tatenai (ID: `person:Tattenai`); Passover (ID: `keyterm:Passover`); Koreshi (ID: `person:Cyrus`); BWANA (ID: `deity:Lord`); Babeli (ID: `place:Babylon`); Offering (ID: `keyterm:Offering`); Sheep (ID: `fauna:Lamb`); Zekaria (ID: `person:Zechariah.17`); Akmetha (ID: `place:Ecbatana`); Ido (ID: `person:Iddo.6`); Hagai (ID: `person:Haggai`); Nebukadneza (ID: `person:Nebuchadnezzar`); Musa (ID: `person:Moses`); Pure (ID: `keyterm:Pure`); Uajemi (ID: `place:Persia`); Defilement (ID: `keyterm:Defilement`); Artashasta (ID: `person:Artaxerxes`); Assyria (ID: `place:Assyria`); Umedi (ID: `place:Media`); Gentiles (ID: `group:Gentile`); Olive Oil (ID: `realia:OliveOil`); Cubit (ID: `realia:Cubit`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Hewn Stone (ID: `realia:HewnStone`); Wheat (ID: `flora:Wheat`); Anointing Oil (ID: `realia:AnointingOil`); Flock (ID: `fauna:Flock`); Foundation (ID: `realia:Foundation`); Unleavened Bread (ID: `realia:UnleavenedBread`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Israeli (ID: `person:Israel`); Ezra (ID: `person:Ezra`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Artashasta (ID: `person:Artaxerxes`); House (ID: `realia:House`); Money (ID: `realia:Money`); Babeli (ID: `place:Babylon`); Ahava (ID: `place:Ahava`); Offering (ID: `keyterm:Offering`); Mto (ID: `place:Euphrates`); Hashabia (ID: `person:Hashabiah.7`); Sherebia (ID: `person:Sherebiah`); Decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); Daudi (ID: `person:David`); Perceive (ID: `keyterm:Perceive`); Finehasi (ID: `person:Phinehas`); Amaria (ID: `person:Amariah.2`); Elamu (ID: `person:Elam`); Noadia (ID: `person:Noadiah`); Zekaria (ID: `person:Zechariah.20`); Zerahia (ID: `person:Zerahiah`); Meshulamu (ID: `person:Meshullam.9`); Zekaria (ID: `person:Zechariah.19`); Bigwai (ID: `person:Bigvai.2`); Gershomu (ID: `person:Gershom.2`); Yozabadi (ID: `person:Jozabad.6`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Ezra (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Yerusalemu (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); House (ID: `realia:House`); Harimu (ID: `person:Harim`); Elamu (ID: `person:Elam`); Yuda (ID: `group:Judah`); Offering (ID: `keyterm:Offering`); Yuda (ID: `person:Judah.4`); Counsel (ID: `keyterm:Counsel`); Zabadi (ID: `person:Zabad.6`); Eliya (ID: `person:Elijah.4`); Eliashibu (ID: `person:Eliashib.5`); Amramu (ID: `person:Amram.2`); Yehieli (ID: `person:Jehiel.10`); Maaseya (ID: `person:Maaseiah.6`); Bani (ID: `person:Bani.6`); Maluki (ID: `person:Malluch.2`); Nethaneli (ID: `person:Nethanel.8`); Shimei (ID: `person:Shimei.16`); Eliashibu (ID: `person:Eliashib.4`); Ishmaeli (ID: `person:Ishmael.6`); Bani (ID: `person:Bani`); Ueli (ID: `person:Uel`); Eliezeri (ID: `person:Eliezer.11`)
