...
* **Associated ACAI Concepts:** Yerusalemu (ID: `place:Jerusalem`); BWANA (ID: `deity:Lord`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Koreshi (ID: `person:Cyrus`); Money (ID: `realia:Money`); House (ID: `realia:House`); Israeli (ID: `person:Israel`); Uajemi (ID: `place:Persia`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Zerubabeli (ID: `person:Zerubbabel.2`); Elamu (ID: `person:Elam`); Nebukadneza (ID: `person:Nebuchadnezzar`); Babeli (ID: `place:Babylon`); Sulemani (ID: `person:Solomon`); Adonikamu (ID: `person:Adonikam`); Nesia (ID: `person:Neziah`); Nekoda (ID: `person:Nekoda`); Bigwai (ID: `person:Bigvai.2`); Yeshua (ID: `person:Jeshua`); Shefatia (ID: `person:Shephatiah.7`); Basluthi (ID: `person:Bazluth`); Meunim (ID: `group:Meunim`); Besai (ID: `person:Besai`); Magbishi (ID: `place:Magbish`); Mehida (ID: `person:Mehida`); Delaya (ID: `person:Delaiah.3`); Beth-azmaveth (ID: `place:Beth-azmaveth`); Hatifa (ID: `person:Hatipha`)
...
* **Associated ACAI Concepts:** Yerusalemu (ID: `place:Jerusalem`); BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Israeli (ID: `person:Israel`); Zerubabeli (ID: `person:Zerubbabel.2`); Mto (ID: `place:Euphrates`); Koreshi (ID: `person:Cyrus`); Uajemi (ID: `place:Persia`); Yuda (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); Dario (ID: `person:Darius.2`); Babeli (ID: `place:Babylon`); Shimshai (ID: `person:Shimshai`); Rehumu (ID: `person:Rehum.2`); Yoshua (ID: `person:Joshua.5`); Artashasta (ID: `person:Artaxerxes.2`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Jews (ID: `group:Jews`); Yehosadaki (ID: `person:Jehozadak`); Shealtieli (ID: `person:Shealtiel.2`); Yuda (ID: `group:Judah`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Tatenai (ID: `person:Tattenai`); Nebukadneza (ID: `person:Nebuchadnezzar`); Samaria (ID: `place:Samaria`); Kadmieli (ID: `person:Kadmiel`); Hodavia (ID: `person:Hodaviah.4`); Asur-bani-pali (ID: `person:Osnappar`); Kiajemi (ID: `person:Dinaite`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Dario (ID: `person:Darius.2`); Yerusalemu (ID: `place:Jerusalem`); Israeli (ID: `person:Israel`); Walawi (ID: `person:Levi.3`); Jews (ID: `group:Jews`); Walawi (ID: `group:Levi`); Mto (ID: `place:Euphrates`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Scroll (ID: `realia:Scroll`); Tatenai (ID: `person:Tattenai`); Koreshi (ID: `person:Cyrus`); BWANA (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Babeli (ID: `place:Babylon`); Passover (ID: `keyterm:Passover`); Sheep (ID: `fauna:Lamb`); Akmetha (ID: `place:Ecbatana`); Zekaria (ID: `person:Zechariah.17`); Assyria (ID: `place:Assyria`); Defilement (ID: `keyterm:Defilement`); Pure (ID: `keyterm:Pure`); Gentiles (ID: `group:Gentile`); Artashasta (ID: `person:Artaxerxes`); Hagai (ID: `person:Haggai`); Umedi (ID: `place:Media`); Ido (ID: `person:Iddo.6`); Musa (ID: `person:Moses`); Nebukadneza (ID: `person:Nebuchadnezzar`); Uajemi (ID: `place:Persia`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Foundation (ID: `realia:Foundation`); Cubit (ID: `realia:Cubit`); Olive Oil (ID: `realia:OliveOil`); Wheat (ID: `flora:Wheat`); Anointing Oil (ID: `realia:AnointingOil`); Unleavened Bread (ID: `realia:UnleavenedBread`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Ezra (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Passion (ID: `keyterm:Ardour`); Yerusalemu (ID: `place:Jerusalem`); House (ID: `realia:House`); Harimu (ID: `person:Harim`); Yuda (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); Elamu (ID: `person:Elam`); Yuda (ID: `group:Judah`); Counsel (ID: `keyterm:Counsel`); Maaseya (ID: `person:Maaseiah.7`); Yaasu (ID: `person:Jaasu`); Yazeya (ID: `person:Jahzeiah`); Bani (ID: `person:Bani.6`); Abdi (ID: `person:Abdi.3`); Wania (ID: `person:Vaniah`); Yudea (ID: `place:Judea`); Asaheli (ID: `person:Asahel.4`); Meshulamu (ID: `person:Meshullam.11`); Keluhi (ID: `person:Cheluhi`); Telemu (ID: `person:Telem`); Meremothi (ID: `person:Meremoth.2`); Zebadia (ID: `person:Zebadiah.9`); Ido (ID: `person:Jaddai`); Maaseya (ID: `person:Maaseiah.8`)
