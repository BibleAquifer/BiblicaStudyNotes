...
* **Associated ACAI Concepts:** Danieli (ID: `person:Daniel.3`); Azaria (ID: `person:Azariah.20`); Mishaeli (ID: `person:Mishael.3`); Hanania (ID: `person:Hananiah.15`); Ability (ID: `keyterm:Ability`); Yuda (ID: `group:Judah`); BWANA (ID: `deity:Lord`); Yuda (ID: `person:Judah.4`); Melzar (ID: `person:Melzar`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Have Insight (ID: `keyterm:HaveInsight`); Yehoyakimu (ID: `person:Jehoiakim`); Nebukadneza (ID: `person:Nebuchadnezzar`); Perceive (ID: `keyterm:Perceive`); Scroll (ID: `realia:Scroll`); Ashpenaz (ID: `person:Ashpenaz`); Chaldeans (ID: `group:Chaldea`); Babeli (ID: `place:Babylon`); Wakaldayo (ID: `place:Chaldea`); Kindness (ID: `keyterm:Kindness`); Strength (ID: `keyterm:Strength`); Understanding (ID: `keyterm:Understanding`); Defile (ID: `keyterm:Stain`); Intention (ID: `keyterm:Intention`); Yerusalemu (ID: `place:Jerusalem`); Public Official (ID: `person:GenericOfficial`); Shinari (ID: `place:Shinar`); Koreshi (ID: `person:Cyrus`); Israeli (ID: `person:Israel`); Conjurer (ID: `keyterm:Conjurer`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Danieli (ID: `person:Daniel.3`); Babeli (ID: `place:Babylon`); Arioko (ID: `person:Arioch.2`); Wakaldayo (ID: `place:Chaldea`); Nebukadneza (ID: `person:Nebuchadnezzar`); Astrologers (ID: `group:Astrologer`); Hanania (ID: `person:Hananiah.15`); Azaria (ID: `person:Azariah.20`); Mishaeli (ID: `person:Mishael.3`); Chaldeans (ID: `group:Chaldea`); Money (ID: `realia:Money`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Conjurer (ID: `keyterm:Conjurer`); House (ID: `realia:House`); Threshing Floor (ID: `realia:ThreshingFloor`)
...
* **Associated ACAI Concepts:** Nebukadneza (ID: `person:Nebuchadnezzar`); Azaria (ID: `person:Azariah.20`); Mishaeli (ID: `person:Mishael.3`); Hanania (ID: `person:Hananiah.15`); Flute (ID: `realia:Flute`); Rams Horn (ID: `realia:RamsHorn`); Lyre (ID: `realia:Lyre`); Lute (ID: `realia:Lute`); Babeli (ID: `place:Babylon`); Bagpipe (ID: `realia:Bagpipe`); Offering (ID: `keyterm:Offering`); Jews (ID: `group:Jews`); Dura (ID: `place:Dura`); Wakaldayo (ID: `place:Chaldea`); Astrologers (ID: `group:Astrologer`); BWANA (ID: `deity:Lord`); A Messenger (ID: `person:Messenger`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Nebukadneza (ID: `person:Nebuchadnezzar`); BWANA (ID: `deity:Lord`); Danieli (ID: `person:Daniel.3`); Belshazzar (ID: `person:Belshazzar`); Astrologers (ID: `group:Astrologer`); Babeli (ID: `place:Babylon`); Wakaldayo (ID: `place:Chaldea`); House (ID: `realia:House`); Medes (ID: `group:Mede`); Wamedi (ID: `person:Medan`); Yerusalemu (ID: `place:Jerusalem`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`); Dario (ID: `person:Darius.3`); A Disembodied Voice (ID: `deity:Voice`); Persians (ID: `group:Persia`); Yuda (ID: `group:Judah`); Uajemi (ID: `place:Persia`); Yuda (ID: `person:Judah.4`); Mina (ID: `realia:Mina`); Grass (ID: `flora:Grass`); Wild Donkey (ID: `fauna:WildDonkey`); Vulture (ID: `fauna:Vulture`); Throne (ID: `realia:Throne`); Balance (ID: `realia:Balance`)
...
* **Associated ACAI Concepts:** Danieli (ID: `person:Daniel.3`); Dario (ID: `person:Darius.3`); Lion (ID: `fauna:Lion`); Persians (ID: `group:Persia`); Uajemi (ID: `place:Persia`); Wamedi (ID: `person:Medan`); Medes (ID: `group:Mede`); Yuda (ID: `person:Judah.4`); Koreshi (ID: `person:Cyrus`); Yuda (ID: `group:Judah`); Yerusalemu (ID: `place:Jerusalem`); Public Officials (ID: `group:GenericOfficials`); House (ID: `realia:House`); Window (ID: `realia:Window`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); Danieli (ID: `person:Daniel.3`); Strength (ID: `keyterm:Strength`); Have Insight (ID: `keyterm:HaveInsight`); To Sin (ID: `keyterm:Sin`); Covenant (ID: `keyterm:Covenant`); Truth (ID: `keyterm:Truth`); Rebel (ID: `keyterm:Rebel`); Plea for Mercy (ID: `keyterm:Supplication`); Yerusalemu (ID: `place:Jerusalem`); Uajemi (ID: `place:Persia`); Sheep (ID: `fauna:Lamb`); Misri (ID: `place:Egypt`); Delight (ID: `keyterm:Delight`); Fortress (ID: `realia:Fortress`); Mikaeli (ID: `person:Michael.11`); Vision (ID: `keyterm:Vision`); Kigiriki (ID: `place:Greece`); Instruction (ID: `keyterm:Instruction`); Passion (ID: `keyterm:Ardour`); Israeli (ID: `person:Israel`); To Act Wickedly (ID: `keyterm:ActWickedly`); Understanding (ID: `keyterm:Understanding`); Fear (ID: `keyterm:Fear`); Detested Thing (ID: `keyterm:DetestedThing`); Scroll (ID: `realia:Scroll`); Dario (ID: `person:Darius.3`); Ulai (ID: `place:Ulai`); Gabrieli (ID: `deity:Gabriel`)
