...
* **Associated Passages:** Danieli 1:1-21
* **Associated Articles:** Mungu (ID: `367690@BiblicaStudyNotesKeyTerms`); Kazi (ID: `367699@BiblicaStudyNotesKeyTerms`); Ukoo (ID: `367711@BiblicaStudyNotesKeyTerms`); Agano (ID: `367728@BiblicaStudyNotesKeyTerms`); Dhabihu (ID: `367747@BiblicaStudyNotesKeyTerms`); Yakobo (ID: `367759@BiblicaStudyNotesKeyTerms`); Watu wa Mungu (ID: `367793@BiblicaStudyNotesKeyTerms`); Hekima (ID: `367816@BiblicaStudyNotesKeyTerms`); Mlima Sinai (ID: `367818@BiblicaStudyNotesKeyTerms`); Agano la Mlima Sinai (ID: `367819@BiblicaStudyNotesKeyTerms`); Ufalme wa makuhani (ID: `367828@BiblicaStudyNotesKeyTerms`); Ufalme wa Kusini (ID: `367971@BiblicaStudyNotesKeyTerms`); Babiloni (ID: `367989@BiblicaStudyNotesKeyTerms`); Safi au chafu (ID: `367854@BiblicaStudyNotesKeyTerms`); 605 KK (ID: `368042@BiblicaStudyNotesKeyTerms`); Danieli (ID: `368051@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Danieli (ID: `person:Daniel.3`); Azaria (ID: `person:Azariah.20`); Mishaeli (ID: `person:Mishael.3`); Hanania (ID: `person:Hananiah.15`); Ability (ID: `keyterm:Ability`); Yuda (ID: `person:Judah.4`); BWANA (ID: `deity:Lord`); Yuda (ID: `group:Judah`); Melzar (ID: `person:Melzar`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Have Insight (ID: `keyterm:HaveInsight`); Yehoyakimu (ID: `person:Jehoiakim`); Nebukadneza (ID: `person:Nebuchadnezzar`); Perceive (ID: `keyterm:Perceive`); Scroll (ID: `realia:Scroll`); Chaldeans (ID: `group:Chaldea`); Ashpenaz (ID: `person:Ashpenaz`); Yerusalemu (ID: `place:Jerusalem`); Defile (ID: `keyterm:Stain`); Strength (ID: `keyterm:Strength`); Babeli (ID: `place:Babylon`); Conjurer (ID: `keyterm:Conjurer`); Public Official (ID: `person:GenericOfficial`); Shinari (ID: `place:Shinar`); Understanding (ID: `keyterm:Understanding`); Kindness (ID: `keyterm:Kindness`); Israeli (ID: `person:Israel`); Intention (ID: `keyterm:Intention`); Wakaldayo (ID: `place:Chaldea`); Koreshi (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated Passages:** Danieli 2:1-49
...
* **Associated ACAI Concepts:** Danieli (ID: `person:Daniel.3`); Babeli (ID: `place:Babylon`); Arioko (ID: `person:Arioch.2`); Wakaldayo (ID: `place:Chaldea`); Nebukadneza (ID: `person:Nebuchadnezzar`); Astrologers (ID: `group:Astrologer`); Chaldeans (ID: `group:Chaldea`); Azaria (ID: `person:Azariah.20`); Mishaeli (ID: `person:Mishael.3`); Hanania (ID: `person:Hananiah.15`); Money (ID: `realia:Money`); Conjurer (ID: `keyterm:Conjurer`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); House (ID: `realia:House`); Threshing Floor (ID: `realia:ThreshingFloor`)
...
* **Associated Passages:** Danieli 3:1-30
...
* **Associated ACAI Concepts:** Nebukadneza (ID: `person:Nebuchadnezzar`); Mishaeli (ID: `person:Mishael.3`); Azaria (ID: `person:Azariah.20`); Hanania (ID: `person:Hananiah.15`); Flute (ID: `realia:Flute`); Lyre (ID: `realia:Lyre`); Rams Horn (ID: `realia:RamsHorn`); Lute (ID: `realia:Lute`); Babeli (ID: `place:Babylon`); Bagpipe (ID: `realia:Bagpipe`); Offering (ID: `keyterm:Offering`); Jews (ID: `group:Jews`); Dura (ID: `place:Dura`); Astrologers (ID: `group:Astrologer`); A Messenger (ID: `person:Messenger`); BWANA (ID: `deity:Lord`); Wakaldayo (ID: `place:Chaldea`); Cubit (ID: `realia:Cubit`); House (ID: `realia:House`)
...
* **Associated Passages:** Danieli 4:1-5:31
...
* **Associated ACAI Concepts:** Nebukadneza (ID: `person:Nebuchadnezzar`); Danieli (ID: `person:Daniel.3`); BWANA (ID: `deity:Lord`); Belshazzar (ID: `person:Belshazzar`); Astrologers (ID: `group:Astrologer`); Babeli (ID: `place:Babylon`); Wakaldayo (ID: `place:Chaldea`); House (ID: `realia:House`); Medes (ID: `group:Mede`); Yerusalemu (ID: `place:Jerusalem`); Wamedi (ID: `person:Medan`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`); Dario (ID: `person:Darius.3`); Persians (ID: `group:Persia`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Uajemi (ID: `place:Persia`); A Disembodied Voice (ID: `deity:Voice`); Mina (ID: `realia:Mina`); Grass (ID: `flora:Grass`); Wild Donkey (ID: `fauna:WildDonkey`); Throne (ID: `realia:Throne`); Vulture (ID: `fauna:Vulture`); Balance (ID: `realia:Balance`)
...
* **Associated Passages:** Danieli 6:1-28
...
* **Associated ACAI Concepts:** Danieli (ID: `person:Daniel.3`); Dario (ID: `person:Darius.3`); Lion (ID: `fauna:Lion`); Uajemi (ID: `place:Persia`); Persians (ID: `group:Persia`); Wamedi (ID: `person:Medan`); Medes (ID: `group:Mede`); Yerusalemu (ID: `place:Jerusalem`); Public Officials (ID: `group:GenericOfficials`); Koreshi (ID: `person:Cyrus`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); House (ID: `realia:House`); Window (ID: `realia:Window`)
...
* **Associated Passages:** Danieli 7:1-12:13
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); Danieli (ID: `person:Daniel.3`); Strength (ID: `keyterm:Strength`); Have Insight (ID: `keyterm:HaveInsight`); To Sin (ID: `keyterm:Sin`); Truth (ID: `keyterm:Truth`); Covenant (ID: `keyterm:Covenant`); Rebel (ID: `keyterm:Rebel`); Plea for Mercy (ID: `keyterm:Supplication`); Uajemi (ID: `place:Persia`); Yerusalemu (ID: `place:Jerusalem`); Sheep (ID: `fauna:Lamb`); Misri (ID: `place:Egypt`); Delight (ID: `keyterm:Delight`); Fortress (ID: `realia:Fortress`); Mikaeli (ID: `person:Michael.11`); Kigiriki (ID: `place:Greece`); Vision (ID: `keyterm:Vision`); To Act Wickedly (ID: `keyterm:ActWickedly`); Israeli (ID: `person:Israel`); Fear (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); Detested Thing (ID: `keyterm:DetestedThing`); Understanding (ID: `keyterm:Understanding`); Passion (ID: `keyterm:Ardour`); Scroll (ID: `realia:Scroll`); Dario (ID: `person:Darius.3`); Ulai (ID: `place:Ulai`); Gabrieli (ID: `deity:Gabriel`)
