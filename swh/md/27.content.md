...
* **Associated ACAI Concepts:** Danieli (ID: `person:Daniel.3`); Azaria (ID: `person:Azariah.20`); Mishaeli (ID: `person:Mishael.3`); Hanania (ID: `person:Hananiah.15`); Ability (ID: `keyterm:Ability`); BWANA (ID: `deity:Lord`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Melzar (ID: `person:Melzar`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Have Insight (ID: `keyterm:HaveInsight`); Yehoyakimu (ID: `person:Jehoiakim`); Nebukadneza (ID: `person:Nebuchadnezzar`); Perceive (ID: `keyterm:Perceive`); Scroll (ID: `realia:Scroll`); Ashpenaz (ID: `person:Ashpenaz`); Chaldeans (ID: `group:Chaldea`); Strength (ID: `keyterm:Strength`); Conjurer (ID: `keyterm:Conjurer`); Understanding (ID: `keyterm:Understanding`); Wakaldayo (ID: `place:Chaldea`); Kindness (ID: `keyterm:Kindness`); Intention (ID: `keyterm:Intention`); Koreshi (ID: `person:Cyrus`); Babeli (ID: `place:Babylon`); Yerusalemu (ID: `place:Jerusalem`); Defile (ID: `keyterm:Stain`); Public Official (ID: `person:GenericOfficial`); Israeli (ID: `person:Israel`); Shinari (ID: `place:Shinar`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Nebukadneza (ID: `person:Nebuchadnezzar`); Mishaeli (ID: `person:Mishael.3`); Hanania (ID: `person:Hananiah.15`); Azaria (ID: `person:Azariah.20`); Flute (ID: `realia:Flute`); Lyre (ID: `realia:Lyre`); Rams Horn (ID: `realia:RamsHorn`); Lute (ID: `realia:Lute`); Babeli (ID: `place:Babylon`); Bagpipe (ID: `realia:Bagpipe`); Jews (ID: `group:Jews`); Offering (ID: `keyterm:Offering`); Dura (ID: `place:Dura`); Wakaldayo (ID: `place:Chaldea`); BWANA (ID: `deity:Lord`); Astrologers (ID: `group:Astrologer`); A Messenger (ID: `person:Messenger`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Nebukadneza (ID: `person:Nebuchadnezzar`); Danieli (ID: `person:Daniel.3`); BWANA (ID: `deity:Lord`); Belshazzar (ID: `person:Belshazzar`); Astrologers (ID: `group:Astrologer`); Wakaldayo (ID: `place:Chaldea`); Babeli (ID: `place:Babylon`); House (ID: `realia:House`); Medes (ID: `group:Mede`); Yerusalemu (ID: `place:Jerusalem`); Wamedi (ID: `person:Medan`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`); Dario (ID: `person:Darius.3`); A Disembodied Voice (ID: `deity:Voice`); Persians (ID: `group:Persia`); Uajemi (ID: `place:Persia`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Mina (ID: `realia:Mina`); Grass (ID: `flora:Grass`); Wild Donkey (ID: `fauna:WildDonkey`); Vulture (ID: `fauna:Vulture`); Throne (ID: `realia:Throne`); Balance (ID: `realia:Balance`)
...
* **Associated ACAI Concepts:** Danieli (ID: `person:Daniel.3`); Dario (ID: `person:Darius.3`); Lion (ID: `fauna:Lion`); Uajemi (ID: `place:Persia`); Persians (ID: `group:Persia`); Medes (ID: `group:Mede`); Wamedi (ID: `person:Medan`); Public Officials (ID: `group:GenericOfficials`); Yerusalemu (ID: `place:Jerusalem`); Yuda (ID: `group:Judah`); Koreshi (ID: `person:Cyrus`); Yuda (ID: `person:Judah.4`); House (ID: `realia:House`); Window (ID: `realia:Window`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); Danieli (ID: `person:Daniel.3`); Strength (ID: `keyterm:Strength`); To Sin (ID: `keyterm:Sin`); Have Insight (ID: `keyterm:HaveInsight`); Truth (ID: `keyterm:Truth`); Rebel (ID: `keyterm:Rebel`); Covenant (ID: `keyterm:Covenant`); Plea for Mercy (ID: `keyterm:Supplication`); Yerusalemu (ID: `place:Jerusalem`); Uajemi (ID: `place:Persia`); Sheep (ID: `fauna:Lamb`); Delight (ID: `keyterm:Delight`); Misri (ID: `place:Egypt`); Fortress (ID: `realia:Fortress`); Mikaeli (ID: `person:Michael.11`); Vision (ID: `keyterm:Vision`); Kigiriki (ID: `place:Greece`); Instruction (ID: `keyterm:Instruction`); Passion (ID: `keyterm:Ardour`); Fear (ID: `keyterm:Fear`); Israeli (ID: `person:Israel`); Understanding (ID: `keyterm:Understanding`); To Act Wickedly (ID: `keyterm:ActWickedly`); Detested Thing (ID: `keyterm:DetestedThing`); Scroll (ID: `realia:Scroll`); Dario (ID: `person:Darius.3`); Ulai (ID: `place:Ulai`); Gabrieli (ID: `deity:Gabriel`)
