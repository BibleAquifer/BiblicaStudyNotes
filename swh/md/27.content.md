...
* **Associated ACAI Concepts:** Danieli (ID: `person:Daniel.3`); Melzar (ID: `person:Melzar`); Mishaeli (ID: `person:Mishael.3`); Azaria (ID: `person:Azariah.20`); Hanania (ID: `person:Hananiah.15`); Ashpenaz (ID: `person:Ashpenaz`); Ability (ID: `keyterm:Ability`); Yehoyakimu (ID: `person:Jehoiakim`); Have Insight (ID: `keyterm:HaveInsight`); Chaldeans (ID: `group:Chaldea`)
...
* **Associated ACAI Concepts:** Arioko (ID: `person:Arioch.2`); Astrologers (ID: `group:Astrologer`); Danieli (ID: `person:Daniel.3`); Babeli (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Mishaeli (ID: `person:Mishael.3`); Azaria (ID: `person:Azariah.20`); Hanania (ID: `person:Hananiah.15`); Bagpipe (ID: `realia:Bagpipe`); Nebukadneza (ID: `person:Nebuchadnezzar`); Flute (ID: `realia:Flute`); Dura (ID: `place:Dura`)
...
* **Associated ACAI Concepts:** Belshazzar (ID: `person:Belshazzar`); Astrologers (ID: `group:Astrologer`); Medes (ID: `group:Mede`); Dario (ID: `person:Darius.3`); Wild Donkey (ID: `fauna:WildDonkey`); Nebukadneza (ID: `person:Nebuchadnezzar`); Danieli (ID: `person:Daniel.3`); House (ID: `realia:House`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Danieli (ID: `person:Daniel.3`); Dario (ID: `person:Darius.3`); Persians (ID: `group:Persia`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** Plea for Mercy (ID: `keyterm:Supplication`); Ulai (ID: `place:Ulai`); Mikaeli (ID: `person:Michael.11`); Kigiriki (ID: `place:Greece`); Vision (ID: `keyterm:Vision`); Gabrieli (ID: `deity:Gabriel`); Dario (ID: `person:Darius.3`); kutoka (ID: `place:Uphaz`); Hidekeli (ID: `place:Tigris`); Leopard (ID: `fauna:Leopard`); Insight (ID: `keyterm:Insight`); Washushani (ID: `place:Susa`); Appease (ID: `keyterm:Appease`); Ask for (ID: `keyterm:AskFor`); Danieli (ID: `person:Daniel.3`); Uajemi (ID: `place:Persia`); Have Insight (ID: `keyterm:HaveInsight`); Fortress (ID: `realia:Fortress`); Perceive (ID: `keyterm:Perceive`); Strength (ID: `keyterm:Strength`); Sheep (ID: `fauna:Lamb`); Rebel (ID: `keyterm:Rebel`); Truth (ID: `keyterm:Truth`); Covenant (ID: `keyterm:Covenant`); To Sin (ID: `keyterm:Sin`); Yerusalemu (ID: `place:Jerusalem`); BWANA (ID: `deity:Lord`)
