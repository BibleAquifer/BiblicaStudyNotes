...
* **Associated ACAI Concepts:** Danieli (ID: `person:Daniel.3`); Azaria (ID: `person:Azariah.20`); Mishaeli (ID: `person:Mishael.3`); Hanania (ID: `person:Hananiah.15`); Ability (ID: `keyterm:Ability`); Yuda (ID: `person:Judah.4`); BWANA (ID: `deity:Lord`); Yuda (ID: `group:Judah`); Melzar (ID: `person:Melzar`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Yehoyakimu (ID: `person:Jehoiakim`); Have Insight (ID: `keyterm:HaveInsight`); Nebukadneza (ID: `person:Nebuchadnezzar`); Perceive (ID: `keyterm:Perceive`); Scroll (ID: `realia:Scroll`); Ashpenaz (ID: `person:Ashpenaz`); Chaldeans (ID: `group:Chaldea`); Koreshi (ID: `person:Cyrus`); Strength (ID: `keyterm:Strength`); Yerusalemu (ID: `place:Jerusalem`); Public Official (ID: `person:GenericOfficial`); Wakaldayo (ID: `place:Chaldea`); Israeli (ID: `person:Israel`); Shinari (ID: `place:Shinar`); Intention (ID: `keyterm:Intention`); Defile (ID: `keyterm:Stain`); Understanding (ID: `keyterm:Understanding`); Kindness (ID: `keyterm:Kindness`); Babeli (ID: `place:Babylon`); Conjurer (ID: `keyterm:Conjurer`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Danieli (ID: `person:Daniel.3`); Babeli (ID: `place:Babylon`); Arioko (ID: `person:Arioch.2`); Wakaldayo (ID: `place:Chaldea`); Nebukadneza (ID: `person:Nebuchadnezzar`); Astrologers (ID: `group:Astrologer`); Mishaeli (ID: `person:Mishael.3`); Hanania (ID: `person:Hananiah.15`); Chaldeans (ID: `group:Chaldea`); Azaria (ID: `person:Azariah.20`); Money (ID: `realia:Money`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Conjurer (ID: `keyterm:Conjurer`); House (ID: `realia:House`); Threshing Floor (ID: `realia:ThreshingFloor`)
...
* **Associated ACAI Concepts:** Nebukadneza (ID: `person:Nebuchadnezzar`); Mishaeli (ID: `person:Mishael.3`); Azaria (ID: `person:Azariah.20`); Hanania (ID: `person:Hananiah.15`); Flute (ID: `realia:Flute`); Lyre (ID: `realia:Lyre`); Lute (ID: `realia:Lute`); Rams Horn (ID: `realia:RamsHorn`); Babeli (ID: `place:Babylon`); Bagpipe (ID: `realia:Bagpipe`); Jews (ID: `group:Jews`); Offering (ID: `keyterm:Offering`); Dura (ID: `place:Dura`); A Messenger (ID: `person:Messenger`); BWANA (ID: `deity:Lord`); Wakaldayo (ID: `place:Chaldea`); Astrologers (ID: `group:Astrologer`); Cubit (ID: `realia:Cubit`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Nebukadneza (ID: `person:Nebuchadnezzar`); BWANA (ID: `deity:Lord`); Danieli (ID: `person:Daniel.3`); Belshazzar (ID: `person:Belshazzar`); Astrologers (ID: `group:Astrologer`); Wakaldayo (ID: `place:Chaldea`); Babeli (ID: `place:Babylon`); House (ID: `realia:House`); Medes (ID: `group:Mede`); Yerusalemu (ID: `place:Jerusalem`); Wamedi (ID: `person:Medan`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`); Dario (ID: `person:Darius.3`); A Disembodied Voice (ID: `deity:Voice`); Yuda (ID: `person:Judah.4`); Persians (ID: `group:Persia`); Yuda (ID: `group:Judah`); Uajemi (ID: `place:Persia`); Mina (ID: `realia:Mina`); Grass (ID: `flora:Grass`); Wild Donkey (ID: `fauna:WildDonkey`); Balance (ID: `realia:Balance`); Throne (ID: `realia:Throne`); Vulture (ID: `fauna:Vulture`)
...
* **Associated ACAI Concepts:** Danieli (ID: `person:Daniel.3`); Dario (ID: `person:Darius.3`); Lion (ID: `fauna:Lion`); Persians (ID: `group:Persia`); Uajemi (ID: `place:Persia`); Medes (ID: `group:Mede`); Wamedi (ID: `person:Medan`); Yuda (ID: `person:Judah.4`); Koreshi (ID: `person:Cyrus`); Public Officials (ID: `group:GenericOfficials`); Yerusalemu (ID: `place:Jerusalem`); Yuda (ID: `group:Judah`); Window (ID: `realia:Window`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); Danieli (ID: `person:Daniel.3`); Strength (ID: `keyterm:Strength`); To Sin (ID: `keyterm:Sin`); Have Insight (ID: `keyterm:HaveInsight`); Truth (ID: `keyterm:Truth`); Covenant (ID: `keyterm:Covenant`); Rebel (ID: `keyterm:Rebel`); Plea for Mercy (ID: `keyterm:Supplication`); Uajemi (ID: `place:Persia`); Yerusalemu (ID: `place:Jerusalem`); Sheep (ID: `fauna:Lamb`); Misri (ID: `place:Egypt`); Delight (ID: `keyterm:Delight`); Fortress (ID: `realia:Fortress`); Mikaeli (ID: `person:Michael.11`); Kigiriki (ID: `place:Greece`); Vision (ID: `keyterm:Vision`); Instruction (ID: `keyterm:Instruction`); Passion (ID: `keyterm:Ardour`); Understanding (ID: `keyterm:Understanding`); Fear (ID: `keyterm:Fear`); To Act Wickedly (ID: `keyterm:ActWickedly`); Israeli (ID: `person:Israel`); Detested Thing (ID: `keyterm:DetestedThing`); Scroll (ID: `realia:Scroll`); Ulai (ID: `place:Ulai`); Dario (ID: `person:Darius.3`); Gabrieli (ID: `deity:Gabriel`)
