...
* **Associated ACAI Concepts:** Zekaria (ID: `person:Zechariah`); Elisabeti (ID: `person:Elizabeth`); Abiya (ID: `person:Abijah.6`); Strong Drink (ID: `realia:StrongDrink`); Gabrieli (ID: `deity:Gabriel`); Regulations (ID: `keyterm:Regulations`); Herode (ID: `person:Herod`); Be Blameless (ID: `keyterm:Blameless`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Mariamu (ID: `person:Mary`); Word (ID: `keyterm:Word`); Favor (ID: `keyterm:Favor`); Gabrieli (ID: `deity:Gabriel`); Nazareti (ID: `place:Nazareth`); Yesu (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Zekaria (ID: `person:Zechariah`); Height (ID: `keyterm:Height`); Elisabeti (ID: `person:Elizabeth`); Deliver (ID: `keyterm:Deliver`); Liberation (ID: `keyterm:Liberation`); Yudea (ID: `place:Judea`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Manger (ID: `realia:Manger`); Kirenio (ID: `person:Quirinius`); Bethlehemu (ID: `place:Bethlehem`); Inn (ID: `realia:Inn`); Augusto (ID: `person:Augustus`); Savior (ID: `keyterm:Savior`); Register (ID: `keyterm:Register`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Simeoni (ID: `person:Simeon.2`); Ana (ID: `person:Anna`); Fanueli (ID: `person:Phanuel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Abilene (ID: `place:Abilene`); Trakoniti (ID: `person:Lysanias`); Iturea (ID: `place:Trachonitis`); Filipo (ID: `person:Philip.3`); Ituraea (ID: `place:Ituraea`); Anasi (ID: `person:Annas`); Augusto (ID: `person:Augustus`); Tiberio (ID: `person:Tiberius`); Herode (ID: `person:Herod.2`); Yohana (ID: `person:John`); Yordani (ID: `place:Jordan`)
...
* **Associated ACAI Concepts:** Strap (ID: `realia:Strap`); Herodia (ID: `person:Herodias`); Herode (ID: `person:Herod.2`)
...
* **Associated ACAI Concepts:** Eliezeri (ID: `person:Eliezer`); Yana (ID: `person:Jannai`); Eli (ID: `person:Heli`); Walawi (ID: `person:Levi.2`); Yoana (ID: `person:Joanan`); Walawi (ID: `person:Levi`); Esli (ID: `person:Esli`); Matathia (ID: `person:Mattathias`); Yusufu (ID: `person:Joseph.8`); Kosamu (ID: `person:Cosam`); Shealtieli (ID: `person:Shealtiel`); Mena (ID: `person:Menna`); Melki (ID: `person:Melchi.2`); Adi (ID: `person:Addi`); Yoshua (ID: `person:Joshua`); Yuda (ID: `person:Joda`); Yusufu (ID: `person:Joseph.7`); Matatha (ID: `person:Mattatha`); Amosi (ID: `person:Amos.2`); Nahumu (ID: `person:Nahum`); Nagai (ID: `person:Naggai`); Simeoni (ID: `person:Simeon.3`); Yuda (ID: `person:Judah.3`); Yonamu (ID: `person:Jonam`); Maathi (ID: `person:Maath`); Semei (ID: `person:Semein`); Eri (ID: `person:Er`); Mathati (ID: `person:Matthat`); Resa (ID: `person:Rhesa`); Josech (ID: `person:Josech`); Eliakimu (ID: `person:Eliakim.2`); Zerubabeli (ID: `person:Zerubbabel`); Mathati (ID: `person:Matthat.2`); Melea (ID: `person:Melea`); Melki (ID: `person:Melchi`); Elmadamu (ID: `person:Elmadam`); Matathia (ID: `person:Mattathias.2`); Yorimu (ID: `person:Jorim`); Kenani (ID: `person:Cainan`); Neri (ID: `person:Neri`); Nathani (ID: `person:Nathan`); Serugi (ID: `person:Serug`); Reu (ID: `person:Reu`); Salmoni (ID: `person:Salmon`); Methusela (ID: `person:Methuselah`); Yaredi (ID: `person:Jared`); Lameki (ID: `person:Lamech.2`); Mahalaleli (ID: `person:Mahalalel`); Nahori (ID: `person:Nahor`); Kenani (ID: `person:Kenan`); Enoshi (ID: `person:Enosh`); Sala (ID: `person:Shelah.2`); Pelegi (ID: `person:Peleg`); Tera (ID: `person:Terah`); Sethi (ID: `person:Seth`); Eberi (ID: `person:Eber`); Hesroni (ID: `person:Hezron.2`); Yusufu (ID: `person:Joseph.4`); Shemu (ID: `person:Shem`); Boazi (ID: `person:Boaz`); Adamu (ID: `person:Adam`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); Proclaim (ID: `keyterm:Proclaim`); Sarepta (ID: `place:Zarephath`); Naamani (ID: `person:Naaman.3`); Nazareti (ID: `place:Nazareth`); Elisha (ID: `person:Elisha`); Syrians (ID: `group:Syria`); Galilaya (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** To Command (ID: `keyterm:Command`); Kapernaumu (ID: `place:Capernaum`); Yudea (ID: `place:Judea`); Good News (ID: `keyterm:GoodNews`)
...
* **Associated ACAI Concepts:** Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Petro (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Tile (ID: `realia:Tile`); Bring In (ID: `keyterm:BringIn`); Galilaya (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** Happy (ID: `keyterm:Happy`); Simoni (ID: `person:Simon.2`); Yuda (ID: `person:Judas`); Mathayo (ID: `person:Matthew`); Chosen (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); Storeroom (ID: `realia:Storeroom`); Compassionate (ID: `keyterm:Compassionate`); Condemn (ID: `keyterm:Condemn`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Naini (ID: `place:Nain`); Yudea (ID: `place:Judea`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Baptist (ID: `keyterm:Baptist`); Yohana (ID: `person:John`)
...
* **Associated ACAI Concepts:** Simoni (ID: `person:Simon.6`); Alabaster Jar (ID: `realia:AlabasterJar`); Owe (ID: `keyterm:Owe`); Forgive (ID: `keyterm:Forgive`)
...
* **Associated ACAI Concepts:** Susana (ID: `person:Susanna`); Kuza (ID: `person:Chuza`); Parable (ID: `keyterm:Parable`); Yoana (ID: `person:Joanna`); Honest (ID: `keyterm:Honest`); Daily Life (ID: `keyterm:DailyLife`); Mariamu (ID: `person:Marymagdalene`)
...
* **Associated ACAI Concepts:** Gerasa (ID: `place:Gerasa`); Legioni (ID: `deity:Legion`); Fetter (ID: `realia:Fetter`); Abyss (ID: `keyterm:Abyss`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); Demons (ID: `deity:Demons`)
...
* **Associated ACAI Concepts:** Yairo (ID: `person:Jairus`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Korazini (ID: `place:Chorazin`); Make Peace (ID: `keyterm:Peace`); Scorpion (ID: `fauna:Scorpion`); Disaster (ID: `keyterm:Disaster`)
...
* **Associated ACAI Concepts:** Martha (ID: `person:Martha`); Mariamu (ID: `person:Mary.3`)
...
* **Associated ACAI Concepts:** Ninawi (ID: `group:Nineveh`)
...
* **Associated ACAI Concepts:** Rue (ID: `flora:Rue`); Mint (ID: `flora:Mint`); Zekaria (ID: `person:Zechariah.12`); Plate (ID: `realia:Plate.2`); Disaster (ID: `keyterm:Disaster`); Pharisees (ID: `group:Pharisee`)
...
* **Associated ACAI Concepts:** Barn (ID: `realia:Barn`); Oven (ID: `realia:Oven`); Storeroom (ID: `realia:Storeroom`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Crow (ID: `fauna:Crow`); Bag (ID: `realia:Bag`); Flock (ID: `fauna:Flock`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Drachma (ID: `realia:Drachma`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated ACAI Concepts:** Carob (ID: `flora:Carob`); Hired Worker (ID: `keyterm:HiredWorker`); Cattle (ID: `fauna:Bull`); Daily Life (ID: `keyterm:DailyLife`); Kid (ID: `fauna:Kid`); Affection (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Kor (ID: `realia:Kor.2`); Owe (ID: `keyterm:Owe`); Stewardship (ID: `keyterm:Stewardship`)
...
* **Associated ACAI Concepts:** Lazaro (ID: `person:Lazarus`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Dog (ID: `fauna:Dog`); Abrahamu (ID: `person:Abraham`)
...
* **Associated ACAI Concepts:** Mulberry (ID: `flora:Mulberry`); Cause to Stumble (ID: `keyterm:CauseToStumble`); Stumbling Block (ID: `keyterm:StumblingBlock`); Obligated (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** Avenge (ID: `keyterm:GrantJustice`); Tax Collector (ID: `keyterm:TaxCollector`); Pharisees (ID: `group:Pharisee`); Abstain from Food (ID: `keyterm:Fast`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Zakayo (ID: `person:Zacchaeus`); Sycomore Fig (ID: `flora:SycomoreFig`)
...
* **Associated ACAI Concepts:** Bethfage (ID: `place:Bethphage`); Temple (ID: `realia:Temple`); Mizeituni (ID: `place:OlivesMount`); Height (ID: `keyterm:Height`); Siege-Works (ID: `realia:Siege-works`); Bethania (ID: `place:Bethany`); Yerusalemu (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Tiberio (ID: `person:Tiberius`); Resurrection (ID: `keyterm:Resurrection`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Serve (ID: `keyterm:Serve`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); Passover (ID: `keyterm:Passover`)
...
* **Associated ACAI Concepts:** Bag (ID: `realia:Bag`); Pray (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Petro (ID: `person:Peter`); Peter's Second Accuser (ID: `person:SecondAccuserOfPeter`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Baraba (ID: `person:Barabbas`); Pilato (ID: `person:Pilate`)
...
* **Associated ACAI Concepts:** Criminal on the Cross (ID: `person:Dysmas`); Simoni (ID: `person:Simon.5`); Cross (ID: `realia:Cross`); Sour Wine (ID: `realia:SourWine`); Mkirene (ID: `place:Cyrene`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Arimathaya (ID: `place:Arimathea`); Aloes (ID: `realia:Aloes`); Yusufu (ID: `person:Joseph.6`)
...
* **Associated ACAI Concepts:** Yoana (ID: `person:Joanna`); Week (ID: `keyterm:Week`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** Emau (ID: `place:Emmaus`); Kleopa (ID: `person:Cleopas`); Stade (ID: `realia:Stade`)
...
* **Associated ACAI Concepts:** Bethania (ID: `place:Bethany`); To Cause to Happen (ID: `keyterm:Happen`); Written (ID: `keyterm:Scripture`); Bow Down (ID: `keyterm:BowDown`)
