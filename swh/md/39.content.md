...
* **Associated Passages:** Malaki 1:1-5
* **Associated Articles:** Ukoo (ID: `367711@BiblicaStudyNotesKeyTerms`); Mungu huchagua (ID: `367720@BiblicaStudyNotesKeyTerms`); Hukumu (ID: `367724@BiblicaStudyNotesKeyTerms`); Agano (ID: `367728@BiblicaStudyNotesKeyTerms`); Ibrahimu (ID: `367734@BiblicaStudyNotesKeyTerms`); Agano na Abrahamu (ID: `367744@BiblicaStudyNotesKeyTerms`); Yakobo (ID: `367759@BiblicaStudyNotesKeyTerms`); Israeli (ID: `367771@BiblicaStudyNotesKeyTerms`); Yuda (ID: `367782@BiblicaStudyNotesKeyTerms`); Watu wa Mungu (ID: `367793@BiblicaStudyNotesKeyTerms`); Hekalu (ID: `367908@BiblicaStudyNotesKeyTerms`); Ufalme wa Kusini (ID: `367971@BiblicaStudyNotesKeyTerms`); Babiloni (ID: `367989@BiblicaStudyNotesKeyTerms`); Myahudi (ID: `367994@BiblicaStudyNotesKeyTerms`); Uajemi (ID: `368000@BiblicaStudyNotesKeyTerms`); Malaki (ID: `368069@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Edomu (ID: `place:Edom`); Edomites (ID: `group:Edom`); Malaki (ID: `person:Malachi`); Utterance (ID: `keyterm:Utterance`); Love (ID: `keyterm:Love`); Word of the Lord (ID: `keyterm:WordOfTheLord`); To Cause to Possess (ID: `keyterm:Possess`); Jackal (ID: `fauna:Jackal`)
...
* **Associated Passages:** Malaki 1:6-3:15
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); Fear (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); Israeli (ID: `person:Israel`); To Curse (ID: `keyterm:Curse`); To Dishonor (ID: `keyterm:Dishonor`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Glory (ID: `keyterm:Glory`); Yerusalemu (ID: `place:Jerusalem`); Defile (ID: `keyterm:Stain`); Pure (ID: `keyterm:Pure`); Yuda (ID: `person:Judah.4`); An Angel (ID: `deity:Angel`); Bless (ID: `keyterm:Bless`); Priests (ID: `group:GenericPriests`); Yuda (ID: `group:Judah`); Peace (ID: `keyterm:IntactState`); Fairness (ID: `keyterm:Fairness`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Delight (ID: `keyterm:Delight`); Love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); Decree (ID: `keyterm:Decree`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); The Way (ID: `keyterm:TheWay`); Swear (ID: `keyterm:Swear`); Force to Serve (ID: `keyterm:EnticedToServe`); A Group of People (ID: `group:GenericGroup`); Ask for (ID: `keyterm:AskFor`); Intention (ID: `keyterm:Intention`); Gentiles (ID: `group:Gentile`); Vow (ID: `keyterm:Vow`); Passion (ID: `keyterm:Ardour`); Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`)
...
* **Associated Passages:** Malaki 3:16-4:3
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); Molten Image (ID: `realia:MoltenImage`); Scroll (ID: `realia:Scroll`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`)
...
* **Associated Passages:** Malaki 4:4-6
...
* **Associated ACAI Concepts:** Israeli (ID: `person:Israel`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Eliya (ID: `person:Elijah`); Fear (ID: `keyterm:Fear`); Sinai (ID: `place:SinaiMount`); BWANA (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Musa (ID: `person:Moses`); Decree (ID: `keyterm:Decree`)
