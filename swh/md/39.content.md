...
* **Associated ACAI Concepts:** Malaki (ID: `person:Malachi`); Utterance (ID: `keyterm:Utterance`)
...
* **Associated ACAI Concepts:** Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Fairness (ID: `keyterm:Fairness`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Covenant (ID: `keyterm:Covenant`); Offering (ID: `keyterm:Offering`); BWANA (ID: `deity:Lord`)
