...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Yerusalemu (ID: `place:Jerusalem`); Practice Divination (ID: `keyterm:PracticeDivination`); Samaria (ID: `place:Samaria`); Yuda (ID: `group:Judah`); Rebel (ID: `keyterm:Rebel`); Yuda (ID: `person:Judah.4`); To Sin (ID: `keyterm:Sin`); House (ID: `realia:House`); Mmorashti (ID: `place:Moresheth`); Moresheth-gath (ID: `place:Moresheth-gath`); Akzibu (ID: `place:Achzib`); Shafiri (ID: `place:Shaphir`); Mika (ID: `person:Micah.6`); Prophets (ID: `group:GenericProphets`); Beth-eseli (ID: `place:Beth-ezel`); Marothi (ID: `place:Maroth`); Saanani (ID: `place:Zaanan`); Vine (ID: `flora:Vine`); Lakishi (ID: `place:Lachish`); Mischief (ID: `keyterm:Mischief`); To Cause to Possess (ID: `keyterm:Possess`); Strength (ID: `keyterm:Strength`); Ahazi (ID: `person:Ahaz`); Gathi (ID: `place:Gath`); Have a Vision (ID: `keyterm:HaveAVision`); Woe (ID: `keyterm:Woe.2`); Hezekia (ID: `person:Hezekiah`); Maresha (ID: `place:Mareshah`); Adulamu (ID: `place:Adullam`); Lot (ID: `keyterm:Lot`); Proverb (ID: `keyterm:Saying`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Defilement (ID: `keyterm:Defilement`); Safety (ID: `keyterm:Safety`); Yothamu (ID: `person:Jotham.2`); Peace (ID: `keyterm:IntactState`); Dispossess (ID: `keyterm:Dispossess`); Holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); Ofra (ID: `place:Ophrah`); Love (ID: `keyterm:Love`); Sandalwood (ID: `flora:Sandalwood`); Wine (ID: `realia:Wine`); High Place (ID: `realia:HighPlace`); Money (ID: `realia:Money`); Image (ID: `realia:Image`); Ostrich (ID: `fauna:Ostrich`); Chariot (ID: `realia:Chariot`); Stone Pine (ID: `flora:Pine`); Jackal (ID: `fauna:Jackal`); Vulture (ID: `fauna:Vulture`); Goat (ID: `fauna:Goat`); Cloak (ID: `realia:Cloak`); Rope (ID: `realia:Rope`); Flock (ID: `fauna:Flock`); Graven Image (ID: `realia:GravenImage`); Horse (ID: `fauna:Horse`); Foundation (ID: `realia:Foundation`); Sheepfold (ID: `realia:Sheepfold`); Bed (ID: `realia:Bed`); Cooking Pot (ID: `realia:CookingPot`); Owl (ID: `fauna:Owl`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Israeli (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Assyria (ID: `place:Assyria`); Assyrians (ID: `group:Assyria`); Incantations (ID: `keyterm:Incantations`); Bethlehemu (ID: `place:Bethlehem`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sword (ID: `realia:Sword`); Counsel (ID: `keyterm:Counsel`); mnara (ID: `place:TowerOfEder`); Babeli (ID: `place:Babylon`); Set Apart for God (ID: `keyterm:Proscribe`); Redeem (ID: `keyterm:Redeem`); Yuda (ID: `group:Judah`); Ashera (ID: `deity:Asherah`); The Way (ID: `keyterm:TheWay`); Instruction (ID: `keyterm:Instruction`); Horn (ID: `keyterm:Horn`); Gentiles (ID: `group:Gentile`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Yuda (ID: `person:Judah.4`); Peace (ID: `keyterm:IntactState`); Perceive (ID: `keyterm:Perceive`); Under Siege (ID: `keyterm:StateOfBeingUnderSiege`); Nimrodi (ID: `person:Nimrod`); Sheaf (ID: `realia:Sheaf`); Pruning Knife (ID: `realia:PruningKnife`); Sandalwood (ID: `flora:Sandalwood`); Mattock (ID: `realia:Mattock`); Staff (ID: `realia:Staff`); Threshing Floor (ID: `realia:ThreshingFloor`); Fig (ID: `flora:Fig`); Sacred Pole (ID: `realia:SacredPole`); Rod (ID: `realia:Rod`); Chariot (ID: `realia:Chariot`); Sacred Pillar (ID: `realia:SacredPillar`); Vine (ID: `flora:Vine`); Lion (ID: `fauna:Lion`); Spear (ID: `realia:Spear`); Graven Image (ID: `realia:GravenImage`); Horse (ID: `fauna:Horse`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Kindness (ID: `keyterm:Kindness`); Misri (ID: `place:Egypt`); Deceit (ID: `keyterm:Deceit`); To Cause to Possess (ID: `keyterm:Possess`); Rebel (ID: `keyterm:Rebel`); Passion (ID: `keyterm:Ardour`); Israeli (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Bashani (ID: `place:Bashan`); Offering (ID: `keyterm:Offering`); Loyal Person (ID: `keyterm:LoyalPerson`); Balaki (ID: `person:Balak`); Trust (ID: `keyterm:LeanOn`); Forgive (ID: `keyterm:Forgive`); Haruni (ID: `person:Aaron`); Omri (ID: `person:Omri`); Love (ID: `keyterm:Love`); Shitimu (ID: `place:Shittim`); Visitation (ID: `keyterm:Visitation`); Believe In (ID: `keyterm:BelieveIn`); Abrahamu (ID: `person:Abraham`); Fear (ID: `keyterm:Fear`); Redeem (ID: `keyterm:Redeem`); Swear (ID: `keyterm:Swear`); Ahabu (ID: `person:Ahab`); Truth (ID: `keyterm:Truth`); Beori (ID: `person:Beor.2`); Gileadi (ID: `place:Gilead`); Musa (ID: `person:Moses`); Assyria (ID: `place:Assyria`); Salvation (ID: `keyterm:Salvation`); Miriamu (ID: `person:Miriam`); Decree (ID: `keyterm:Decree`); Balaamu (ID: `person:Balaam`); Sound Wisdom (ID: `keyterm:SoundWisdom`); Moabu (ID: `place:Moab`); Mto (ID: `place:Euphrates`); Gilgal (ID: `place:Gilgal.2`); Net (ID: `realia:Net`); Balance (ID: `realia:Balance`); Sandalwood (ID: `flora:Sandalwood`); Brier (ID: `flora:Brier`); Wine (ID: `realia:Wine`); Cattle (ID: `fauna:Bull`); Staff (ID: `realia:Staff`); Dragnet (ID: `realia:Dragnet`); Fig (ID: `flora:Fig`); Rod (ID: `realia:Rod`); House (ID: `realia:House`); Snake (ID: `fauna:Snake`); Thorn Hedge (ID: `realia:ThornHedge`); Bag (ID: `realia:Bag`); Goat (ID: `fauna:Goat`); Ephah (ID: `realia:Ephah`); Molten Image (ID: `realia:MoltenImage`); Flock (ID: `fauna:Flock`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Foundation (ID: `realia:Foundation`); Must (ID: `realia:Must`); Barley (ID: `flora:Barley`)
