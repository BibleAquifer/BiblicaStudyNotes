...
* **Associated ACAI Concepts:** Saanani (ID: `place:Zaanan`); Marothi (ID: `place:Maroth`); Beth-eseli (ID: `place:Beth-ezel`); Shafiri (ID: `place:Shaphir`); Moresheth-gath (ID: `place:Moresheth-gath`); Practice Divination (ID: `keyterm:PracticeDivination`); Mika (ID: `person:Micah.6`); Mmorashti (ID: `place:Moresheth`); Prophets (ID: `group:GenericProphets`); Akzibu (ID: `place:Achzib`); Yerusalemu (ID: `place:Jerusalem`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Pruning Knife (ID: `realia:PruningKnife`); Incantations (ID: `keyterm:Incantations`); Sheaf (ID: `realia:Sheaf`); Bethlehemu (ID: `place:Bethlehem`); Yerusalemu (ID: `place:Jerusalem`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Balance (ID: `realia:Balance`); Net (ID: `realia:Net`); BWANA (ID: `deity:Lord`)
