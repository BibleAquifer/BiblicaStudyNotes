...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Habakuki (ID: `person:Habakkuk`); Utterance (ID: `keyterm:Utterance`); Dispossess (ID: `keyterm:Dispossess`); Instruction (ID: `keyterm:Instruction`); Have a Vision (ID: `keyterm:HaveAVision`); Strength (ID: `keyterm:Strength`); Mischief (ID: `keyterm:Mischief`); Fear (ID: `keyterm:Fear`); Chaldeans (ID: `group:Chaldea`); Wakaldayo (ID: `place:Chaldea`); Believe In (ID: `keyterm:BelieveIn`); Leopard (ID: `fauna:Leopard`); Wolf (ID: `fauna:Wolf`); Vulture (ID: `fauna:Vulture`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Habakuki (ID: `person:Habakkuk`); Kushani (ID: `place:Cushan`); Temani (ID: `place:Teman`); Parani (ID: `place:ParanMount`); Midiani (ID: `place:Midian`); Mischief (ID: `keyterm:Mischief`); Anointed (ID: `keyterm:Anointed`); Holy (ID: `keyterm:Holy`); Arrow (ID: `keyterm:Arrow`); Fear (ID: `keyterm:Fear`); Oath (ID: `keyterm:Oath`); Majesty (ID: `keyterm:Majesty`); Deer (ID: `fauna:Deer`); Goat (ID: `fauna:Goat`); Sheepfold (ID: `realia:Sheepfold`); Animal Pen (ID: `realia:AnimalPen`); Flock (ID: `fauna:Flock`); Foundation (ID: `realia:Foundation`); Tent (ID: `realia:Tent`); Cattle (ID: `fauna:Bull`); Chariot (ID: `realia:Chariot`); Olive Tree (ID: `flora:OliveTree`); Spear (ID: `realia:Spear`); Vine (ID: `flora:Vine`); Bow (ID: `realia:Bow`); Fig (ID: `flora:Fig`)
