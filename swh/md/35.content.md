...
* **Associated ACAI Concepts:** Habakuki (ID: `person:Habakkuk`); Utterance (ID: `keyterm:Utterance`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); Dragnet (ID: `realia:Dragnet`); Casting Net (ID: `realia:CastingNet`); Fortification (ID: `realia:Fortification`); Idol (ID: `keyterm:Idol`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Kushani (ID: `place:Cushan`); Habakuki (ID: `person:Habakkuk`); Parani (ID: `place:ParanMount`); Temani (ID: `place:Teman`); Deer (ID: `fauna:Deer`)
