...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Utterance (ID: `keyterm:Utterance`); Habakuki (ID: `person:Habakkuk`); Wakaldayo (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Dispossess (ID: `keyterm:Dispossess`); Instruction (ID: `keyterm:Instruction`); Mischief (ID: `keyterm:Mischief`); Have a Vision (ID: `keyterm:HaveAVision`); Strength (ID: `keyterm:Strength`); Fear (ID: `keyterm:Fear`); Believe In (ID: `keyterm:BelieveIn`); Vulture (ID: `fauna:Vulture`); Wolf (ID: `fauna:Wolf`); Horse (ID: `fauna:Horse`); Leopard (ID: `fauna:Leopard`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Temani (ID: `place:Teman`); Habakuki (ID: `person:Habakkuk`); Parani (ID: `place:ParanMount`); Kushani (ID: `place:Cushan`); Arrow (ID: `keyterm:Arrow`); Oath (ID: `keyterm:Oath`); Anointed (ID: `keyterm:Anointed`); Midiani (ID: `place:Midian`); Mischief (ID: `keyterm:Mischief`); Fear (ID: `keyterm:Fear`); Holy (ID: `keyterm:Holy`); Majesty (ID: `keyterm:Majesty`); Deer (ID: `fauna:Deer`); Sheepfold (ID: `realia:Sheepfold`); Bow (ID: `realia:Bow`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Spear (ID: `realia:Spear`); Tent (ID: `realia:Tent`); Chariot (ID: `realia:Chariot`); Flock (ID: `fauna:Flock`); Foundation (ID: `realia:Foundation`); Olive Tree (ID: `flora:OliveTree`)
