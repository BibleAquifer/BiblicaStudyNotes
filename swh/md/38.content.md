...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Yerusalemu (ID: `place:Jerusalem`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Yoshua (ID: `person:Joshua.5`); Peace (ID: `keyterm:IntactState`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`); Zekaria (ID: `person:Zechariah.17`); Zerubabeli (ID: `person:Zerubbabel.2`); Passion (ID: `keyterm:Ardour`); Horn (ID: `keyterm:Horn`); Dario (ID: `person:Darius.2`); Ask for (ID: `keyterm:AskFor`); Horse (ID: `fauna:Horse`); Olive Tree (ID: `flora:OliveTree`); Yosia (ID: `person:Josiah.2`); Yedaya (ID: `person:Jedaiah.6`); Ido (ID: `person:Iddo.6`); Berekia (ID: `person:Berechiah.6`); Sefania (ID: `person:Zephaniah.4`); Tobia (ID: `person:Tobijah.2`); alikuwa (ID: `person:Heldai`); Shetani (ID: `deity:Satan`); Be Zealous (ID: `keyterm:Zealous`); Come On! (ID: `keyterm:ComeOn`); Israeli (ID: `person:Israel`); Babeli (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Daudi (ID: `person:David`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Misri (ID: `place:Egypt`); House (ID: `realia:House`); Horse (ID: `fauna:Horse`); Money (ID: `realia:Money`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Israeli (ID: `person:Israel`); Efraimu (ID: `group:Ephraim`); Efraimu (ID: `person:Ephraim`); Plague (ID: `keyterm:Blow`); Lebanoni (ID: `place:Lebanon`); Tiro (ID: `place:Tyre`); Speak as a Prophet (ID: `keyterm:Speak`); Covenant (ID: `keyterm:Covenant`); Assyria (ID: `place:Assyria`); Ekroni (ID: `place:Ekron`); Appoint (ID: `keyterm:Appoint`); Utterance (ID: `keyterm:Utterance`); Bow (ID: `realia:Bow`); Sword (ID: `realia:Sword`); Rod (ID: `realia:Rod`); Staff (ID: `realia:Staff`)
