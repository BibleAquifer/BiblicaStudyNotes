...
* **Associated ACAI Concepts:** Zekaria (ID: `person:Zechariah.17`); Yoshua (ID: `person:Joshua.5`); alikuwa (ID: `person:Heldai`); Tobia (ID: `person:Tobijah.2`); Sefania (ID: `person:Zephaniah.4`); Yedaya (ID: `person:Jedaiah.6`); Berekia (ID: `person:Berechiah.6`); Yosia (ID: `person:Josiah.2`); Myrtle (ID: `flora:Myrtle`); Zerubabeli (ID: `person:Zerubbabel.2`); Shareza (ID: `person:Sharezer.2`); Regem-meleki (ID: `person:Regem-melech`); Ido (ID: `person:Iddo.6`); Shetani (ID: `deity:Satan`); Turban (ID: `realia:Turban.2`); Shinari (ID: `place:Shinar`); Yehosadaki (ID: `person:Jehozadak`); Jews (ID: `group:Jews`); An Angel (ID: `deity:Angel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Peace (ID: `keyterm:IntactState`); Truth (ID: `keyterm:Truth`); Yerusalemu (ID: `place:Jerusalem`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); BWANA (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Aseli (ID: `place:Azal`); Hadraki (ID: `place:Hadrach`); Hadadrimoni (ID: `place:Hadad-rimmon`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Bow (ID: `realia:Bow`); Shimeites (ID: `group:Shimei`); Cedar (ID: `flora:Cedar`); Donkey (ID: `fauna:Donkey`); mnara (ID: `place:TowerOfHananel`); Benyamini (ID: `place:BenjaminGate`); Mizeituni (ID: `place:OlivesMount`); Shimei (ID: `person:Shimei.4`); kinyago (ID: `deity:Teraphim`); Fir (ID: `flora:Fir`); Horse (ID: `fauna:Horse`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Yerusalemu (ID: `place:Jerusalem`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Money (ID: `realia:Money`); House (ID: `realia:House`); Daudi (ID: `person:David`); BWANA (ID: `deity:Lord`)
