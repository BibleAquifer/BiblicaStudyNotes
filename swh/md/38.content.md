...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Daudi (ID: `person:David`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Horse (ID: `fauna:Horse`); House (ID: `realia:House`); Misri (ID: `place:Egypt`); Money (ID: `realia:Money`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Plague (ID: `keyterm:Blow`); Israeli (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Efraimu (ID: `group:Ephraim`); Efraimu (ID: `person:Ephraim`); Utterance (ID: `keyterm:Utterance`); Assyria (ID: `place:Assyria`); Ekroni (ID: `place:Ekron`); Appoint (ID: `keyterm:Appoint`); Covenant (ID: `keyterm:Covenant`); Lebanoni (ID: `place:Lebanon`); Speak as a Prophet (ID: `keyterm:Speak`); Tiro (ID: `place:Tyre`); Bow (ID: `realia:Bow`); Sword (ID: `realia:Sword`); Vine (ID: `flora:Vine`); Staff (ID: `realia:Staff`)
