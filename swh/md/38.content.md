...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Yerusalemu (ID: `place:Jerusalem`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Yoshua (ID: `person:Joshua.5`); Peace (ID: `keyterm:IntactState`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`); Zekaria (ID: `person:Zechariah.17`); Zerubabeli (ID: `person:Zerubbabel.2`); Passion (ID: `keyterm:Ardour`); Ask for (ID: `keyterm:AskFor`); Horn (ID: `keyterm:Horn`); Dario (ID: `person:Darius.2`); Horse (ID: `fauna:Horse`); Olive Tree (ID: `flora:OliveTree`); Sefania (ID: `person:Zephaniah.4`); Yedaya (ID: `person:Jedaiah.6`); Ido (ID: `person:Iddo.6`); Yosia (ID: `person:Josiah.2`); Tobia (ID: `person:Tobijah.2`); Berekia (ID: `person:Berechiah.6`); alikuwa (ID: `person:Heldai`); Shetani (ID: `deity:Satan`); Swear (ID: `keyterm:Swear`); Love (ID: `keyterm:Love`); Babeli (ID: `place:Babylon`); Come On! (ID: `keyterm:ComeOn`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yerusalemu (ID: `place:Jerusalem`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Daudi (ID: `person:David`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Misri (ID: `place:Egypt`); House (ID: `realia:House`); Horse (ID: `fauna:Horse`); Money (ID: `realia:Money`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Plague (ID: `keyterm:Blow`); Efraimu (ID: `person:Ephraim`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Israeli (ID: `person:Israel`); Efraimu (ID: `group:Ephraim`); Tiro (ID: `place:Tyre`); Utterance (ID: `keyterm:Utterance`); Covenant (ID: `keyterm:Covenant`); Lebanoni (ID: `place:Lebanon`); Assyria (ID: `place:Assyria`); Speak as a Prophet (ID: `keyterm:Speak`); Ekroni (ID: `place:Ekron`); Appoint (ID: `keyterm:Appoint`); Bow (ID: `realia:Bow`); Rod (ID: `realia:Rod`); Sword (ID: `realia:Sword`); Vine (ID: `flora:Vine`)
