...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`); BWANA (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`); Roho (ID: `deity:HolySpirit`); Glory (ID: `keyterm:Glory`); Sky (ID: `keyterm:Heaven`); Favor (ID: `keyterm:Favor`); Imperishable (ID: `keyterm:Imperishable`); Hope (ID: `keyterm:Hope`); Kapadokia (ID: `place:Cappadocia`); Galatia (ID: `place:Galatia`); Bithinia (ID: `place:Bithynia`); Consecration (ID: `keyterm:Consecration.2`); Ponto (ID: `place:Pontus`); Undefiled (ID: `keyterm:Undefiled`); Good News (ID: `keyterm:GoodNews`); Bless (ID: `keyterm:Bless`); Make Peace (ID: `keyterm:Peace`); An Angel (ID: `deity:Angel`); Mercy (ID: `keyterm:Mercy`); Chosen (ID: `keyterm:Chosen`); Asia (ID: `place:Asia`); Ability (ID: `keyterm:Ability`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Interpret (ID: `keyterm:Interpret`); Life (ID: `keyterm:Life`); Blood (ID: `keyterm:Blood`); Resurrection (ID: `keyterm:Resurrection`); Speak as a Prophet (ID: `keyterm:Speak`); Petro (ID: `person:Peter`); Love (ID: `keyterm:Love`); Serve (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** Chosen (ID: `keyterm:Chosen`); BWANA (ID: `deity:Lord`); Reject (ID: `keyterm:Reject`); Priesthood (ID: `keyterm:Priesthood`); Believe (ID: `keyterm:Believe`); Holy (ID: `keyterm:Holy`); Life (ID: `keyterm:Life`); Cornerstone (ID: `realia:Cornerstone`); Stumbling Block (ID: `keyterm:StumblingBlock`); Yerusalemu (ID: `place:Jerusalem`); Offering (ID: `keyterm:Offering`); Written (ID: `keyterm:Scripture`); Yesu (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); Disbelieve (ID: `keyterm:Disbelieve`); Mercy (ID: `keyterm:Mercy`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Do Good (ID: `keyterm:DoGood`); Fear (ID: `keyterm:Fear`); Favor (ID: `keyterm:Favor`); Carnal (ID: `keyterm:Carnal`); Unjust (ID: `keyterm:Unjust`); Ask for (ID: `keyterm:AskFor`); Decided (ID: `keyterm:Decided`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Avenge (ID: `keyterm:GrantJustice`); Gentle (ID: `keyterm:Gentle`); Beloved (ID: `keyterm:Beloved`); Gentiles (ID: `group:Gentile`); Body (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); Good (ID: `keyterm:Good`); Yesu (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yesu (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`); Body (ID: `keyterm:Body.3`); Good News (ID: `keyterm:GoodNews`); Decided (ID: `keyterm:Decided`); Life (ID: `keyterm:Life`); To Sin (ID: `keyterm:Sin`); Serve (ID: `keyterm:Serve`); Share (ID: `keyterm:Share`); Christians (ID: `group:Christ`); Blaspheme (ID: `keyterm:Blaspheme`); Disgusting (ID: `keyterm:Disgusting`); Happy (ID: `keyterm:Happy`); Do Good (ID: `keyterm:DoGood`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Always (ID: `keyterm:Always`); Faithfulness (ID: `keyterm:Faithfulness`); Name (ID: `keyterm:Name`); Favor (ID: `keyterm:Favor`); Beloved (ID: `keyterm:Beloved`); Daily Life (ID: `keyterm:DailyLife`); Gentiles (ID: `group:Gentile`); Pray (ID: `keyterm:Pray`); Idolatry (ID: `keyterm:Idolatry`); Roho (ID: `deity:HolySpirit`); Salvation (ID: `keyterm:Salvation`); Judgment (ID: `keyterm:Judgment`); Surely! (ID: `keyterm:Surely`); Spirit (ID: `keyterm:Spirit.2`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); BWANA (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Sheep (ID: `fauna:Lamb`); Favor (ID: `keyterm:Favor`); Ask for (ID: `keyterm:AskFor`); Witness (ID: `keyterm:Witness`); Yesu (ID: `person:Jesus.2`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Favor (ID: `keyterm:Favor`); Yesu (ID: `person:Jesus.2`); Always (ID: `keyterm:Always`); In Christ (ID: `keyterm:InChrist`); Babeli (ID: `place:Babylon`); Glory (ID: `keyterm:Glory`); Believe (ID: `keyterm:Believe`); Ask for (ID: `keyterm:AskFor`); Make Peace (ID: `keyterm:Peace`); Ability (ID: `keyterm:Ability`); Surely! (ID: `keyterm:Surely`); Sila (ID: `person:Silas`); True (ID: `keyterm:True`); Faithfulness (ID: `keyterm:Faithfulness`); Marko (ID: `person:Mark`); Love (ID: `keyterm:Love`); Lion (ID: `fauna:Lion`)
