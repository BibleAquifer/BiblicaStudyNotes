...
* **Associated ACAI Concepts:** Chosen (ID: `keyterm:Chosen`); BWANA (ID: `deity:Lord`); Reject (ID: `keyterm:Reject`); Priesthood (ID: `keyterm:Priesthood`); Holy (ID: `keyterm:Holy`); Believe (ID: `keyterm:Believe`); Life (ID: `keyterm:Life`); Cornerstone (ID: `realia:Cornerstone`); Yerusalemu (ID: `place:Jerusalem`); Stumbling Block (ID: `keyterm:StumblingBlock`); Ability (ID: `keyterm:Ability`); Disbelieve (ID: `keyterm:Disbelieve`); Offering (ID: `keyterm:Offering`); Yesu (ID: `person:Jesus.2`); Written (ID: `keyterm:Scripture`); Mercy (ID: `keyterm:Mercy`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Do Good (ID: `keyterm:DoGood`); Favor (ID: `keyterm:Favor`); Fear (ID: `keyterm:Fear`); Carnal (ID: `keyterm:Carnal`); Glory (ID: `keyterm:Glory`); Body (ID: `keyterm:Body.3`); Love (ID: `keyterm:Love`); Yesu (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Unjust (ID: `keyterm:Unjust`); Decided (ID: `keyterm:Decided`); Beloved (ID: `keyterm:Beloved`); Avenge (ID: `keyterm:GrantJustice`); Good (ID: `keyterm:Good`); Ask for (ID: `keyterm:AskFor`); Gentiles (ID: `group:Gentile`); Gentle (ID: `keyterm:Gentle`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yesu (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`); Body (ID: `keyterm:Body.3`); Good News (ID: `keyterm:GoodNews`); Life (ID: `keyterm:Life`); Decided (ID: `keyterm:Decided`); To Sin (ID: `keyterm:Sin`); Serve (ID: `keyterm:Serve`); Share (ID: `keyterm:Share`); Christians (ID: `group:Christ`); Love (ID: `keyterm:Love`); Surely! (ID: `keyterm:Surely`); Happy (ID: `keyterm:Happy`); Always (ID: `keyterm:Always`); Name (ID: `keyterm:Name`); Beloved (ID: `keyterm:Beloved`); Judgment (ID: `keyterm:Judgment`); Pray (ID: `keyterm:Pray`); Disgusting (ID: `keyterm:Disgusting`); Faithfulness (ID: `keyterm:Faithfulness`); Favor (ID: `keyterm:Favor`); Daily Life (ID: `keyterm:DailyLife`); Idolatry (ID: `keyterm:Idolatry`); Blaspheme (ID: `keyterm:Blaspheme`); Do Good (ID: `keyterm:DoGood`); Roho (ID: `deity:HolySpirit`); Spirit (ID: `keyterm:Spirit.2`); Gentiles (ID: `group:Gentile`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Glory (ID: `keyterm:Glory`); BWANA (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); Witness (ID: `keyterm:Witness`); Favor (ID: `keyterm:Favor`); Yesu (ID: `person:Jesus.2`); Ask for (ID: `keyterm:AskFor`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Favor (ID: `keyterm:Favor`); Yesu (ID: `person:Jesus.2`); In Christ (ID: `keyterm:InChrist`); Always (ID: `keyterm:Always`); Babeli (ID: `place:Babylon`); Glory (ID: `keyterm:Glory`); Make Peace (ID: `keyterm:Peace`); Ability (ID: `keyterm:Ability`); Faithfulness (ID: `keyterm:Faithfulness`); True (ID: `keyterm:True`); Love (ID: `keyterm:Love`); Surely! (ID: `keyterm:Surely`); Believe (ID: `keyterm:Believe`); Sila (ID: `person:Silas`); Marko (ID: `person:Mark`); Ask for (ID: `keyterm:AskFor`); Lion (ID: `fauna:Lion`)
