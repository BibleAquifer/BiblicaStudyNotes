...
* **Associated ACAI Concepts:** Kapadokia (ID: `place:Cappadocia`); Bithinia (ID: `place:Bithynia`); Ponto (ID: `place:Pontus`); Galatia (ID: `place:Galatia`); Imperishable (ID: `keyterm:Imperishable`); Consecration (ID: `keyterm:Consecration.2`); Hope (ID: `keyterm:Hope`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); Love for One's Fellow Believer (ID: `keyterm:LoveForOnesFellowBeliever`); Unblemished (ID: `keyterm:Unblemished`); Liberation (ID: `keyterm:Liberation`); Call Upon (ID: `keyterm:CallUpon`)
...
* **Associated ACAI Concepts:** Chosen (ID: `keyterm:Chosen`); Reject (ID: `keyterm:Reject`); Priesthood (ID: `keyterm:Priesthood`); Stumbling Block (ID: `keyterm:StumblingBlock`); Yerusalemu (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); Carnal (ID: `keyterm:Carnal`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); Boat (ID: `realia:Boat`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Christians (ID: `group:Christ`); Share (ID: `keyterm:Share`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`)
