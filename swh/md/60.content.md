...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`); Salvation (ID: `keyterm:Salvation`); Glory (ID: `keyterm:Glory`); BWANA (ID: `deity:Lord`); Roho (ID: `deity:HolySpirit`); Sky (ID: `keyterm:Heaven`); Favor (ID: `keyterm:Favor`); Kapadokia (ID: `place:Cappadocia`); Consecration (ID: `keyterm:Consecration.2`); Hope (ID: `keyterm:Hope`); Imperishable (ID: `keyterm:Imperishable`); Galatia (ID: `place:Galatia`); Bithinia (ID: `place:Bithynia`); Ponto (ID: `place:Pontus`); Good News (ID: `keyterm:GoodNews`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); Bless (ID: `keyterm:Bless`); Asia (ID: `place:Asia`); Chosen (ID: `keyterm:Chosen`); Interpret (ID: `keyterm:Interpret`); Petro (ID: `person:Peter`); Mercy (ID: `keyterm:Mercy`); Life (ID: `keyterm:Life`); Serve (ID: `keyterm:Serve`); An Angel (ID: `deity:Angel`); Make Peace (ID: `keyterm:Peace`); Resurrection (ID: `keyterm:Resurrection`); Undefiled (ID: `keyterm:Undefiled`); Speak as a Prophet (ID: `keyterm:Speak`); Blood (ID: `keyterm:Blood`)
...
* **Associated ACAI Concepts:** Chosen (ID: `keyterm:Chosen`); BWANA (ID: `deity:Lord`); Priesthood (ID: `keyterm:Priesthood`); Reject (ID: `keyterm:Reject`); Holy (ID: `keyterm:Holy`); Life (ID: `keyterm:Life`); Believe (ID: `keyterm:Believe`); Cornerstone (ID: `realia:Cornerstone`); Yerusalemu (ID: `place:Jerusalem`); Stumbling Block (ID: `keyterm:StumblingBlock`); Yesu (ID: `person:Jesus.2`); Mercy (ID: `keyterm:Mercy`); Disbelieve (ID: `keyterm:Disbelieve`); Written (ID: `keyterm:Scripture`); Offering (ID: `keyterm:Offering`); Ability (ID: `keyterm:Ability`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Do Good (ID: `keyterm:DoGood`); Fear (ID: `keyterm:Fear`); Favor (ID: `keyterm:Favor`); Carnal (ID: `keyterm:Carnal`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Body (ID: `keyterm:Body.3`); Unjust (ID: `keyterm:Unjust`); Gentle (ID: `keyterm:Gentle`); Good (ID: `keyterm:Good`); Ask for (ID: `keyterm:AskFor`); Life (ID: `keyterm:Life`); Avenge (ID: `keyterm:GrantJustice`); Decided (ID: `keyterm:Decided`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Yesu (ID: `person:Jesus.2`); Beloved (ID: `keyterm:Beloved`); Gentiles (ID: `group:Gentile`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yesu (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`); Body (ID: `keyterm:Body.3`); Good News (ID: `keyterm:GoodNews`); To Sin (ID: `keyterm:Sin`); Life (ID: `keyterm:Life`); Decided (ID: `keyterm:Decided`); Serve (ID: `keyterm:Serve`); Christians (ID: `group:Christ`); Share (ID: `keyterm:Share`); Salvation (ID: `keyterm:Salvation`); Surely! (ID: `keyterm:Surely`); Daily Life (ID: `keyterm:DailyLife`); Love (ID: `keyterm:Love`); Judgment (ID: `keyterm:Judgment`); Idolatry (ID: `keyterm:Idolatry`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Pray (ID: `keyterm:Pray`); Roho (ID: `deity:HolySpirit`); Happy (ID: `keyterm:Happy`); Spirit (ID: `keyterm:Spirit.2`); Faithfulness (ID: `keyterm:Faithfulness`); Name (ID: `keyterm:Name`); Do Good (ID: `keyterm:DoGood`); Disgusting (ID: `keyterm:Disgusting`); Favor (ID: `keyterm:Favor`); Always (ID: `keyterm:Always`); Beloved (ID: `keyterm:Beloved`); Gentiles (ID: `group:Gentile`); Blaspheme (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Glory (ID: `keyterm:Glory`); BWANA (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); Yesu (ID: `person:Jesus.2`); Ask for (ID: `keyterm:AskFor`); Witness (ID: `keyterm:Witness`); Favor (ID: `keyterm:Favor`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yesu (ID: `person:Jesus.2`); Always (ID: `keyterm:Always`); Favor (ID: `keyterm:Favor`); In Christ (ID: `keyterm:InChrist`); Babeli (ID: `place:Babylon`); Make Peace (ID: `keyterm:Peace`); Faithfulness (ID: `keyterm:Faithfulness`); Surely! (ID: `keyterm:Surely`); Ask for (ID: `keyterm:AskFor`); Marko (ID: `person:Mark`); True (ID: `keyterm:True`); Glory (ID: `keyterm:Glory`); Sila (ID: `person:Silas`); Believe (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); Lion (ID: `fauna:Lion`)
