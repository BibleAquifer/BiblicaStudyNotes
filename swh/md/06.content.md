...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); Yoshua (ID: `person:Joshua.2`); Yordani (ID: `place:Jordan`); House (ID: `realia:House`); Swear (ID: `keyterm:Swear`); Exempt (ID: `keyterm:Exempt`); Nuni (ID: `person:Nun`); Yeriko (ID: `place:Jericho`); Spies (ID: `group:Spies`); Window (ID: `realia:Window`); Rahabu (ID: `person:Rahab`); Dispossess (ID: `keyterm:Dispossess`); Have Insight (ID: `keyterm:HaveInsight`); Truth (ID: `keyterm:Truth`); Oath (ID: `keyterm:Oath`); Instruction (ID: `keyterm:Instruction`); Kindness (ID: `keyterm:Kindness`); Israeli (ID: `person:Israel`); To Cause to Possess (ID: `keyterm:Possess`); kubwa (ID: `place:GreatSea`); Shitimu (ID: `place:Shittim`); Reubeni (ID: `group:Reuben`); Terror (ID: `keyterm:Terror`); Rebel (ID: `keyterm:Rebel`); Gadi (ID: `person:Gad`); Manase (ID: `person:Manasseh`); Reubeni (ID: `person:Reuben`); Amorites (ID: `group:Amorites`); Mhiti (ID: `person:Heth`); Ogu (ID: `person:Og`); Sihoni (ID: `person:Sihon`); Shamu (ID: `place:RedSea`); Mto (ID: `place:Euphrates`); Manase (ID: `group:Manasseh`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Hittites (ID: `group:Hittite`); Misri (ID: `place:Egypt`); Lebanoni (ID: `place:Lebanon`); Thread (ID: `realia:Thread`); Scroll (ID: `realia:Scroll`); Rope (ID: `realia:Rope`); Cattails (ID: `flora:Cattails`); Flax (ID: `flora:Flax`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yordani (ID: `place:Jordan`); Yoshua (ID: `person:Joshua.2`); Israeli (ID: `person:Israel`); Covenant Box (ID: `keyterm:CovenantBox`); Covenant (ID: `keyterm:Covenant`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Complete (ID: `keyterm:Complete`); Circumcision (ID: `keyterm:Circumcision`); Gilgal (ID: `place:Gilgal.2`); Yeriko (ID: `place:Jericho`); Musa (ID: `person:Moses`); Misri (ID: `place:Egypt`); Wakanaani (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Amorites (ID: `group:Amorites`); Fear (ID: `keyterm:Fear`); Passover (ID: `keyterm:Passover`); Perizzites (ID: `group:Perizzites`); Foreskin (ID: `keyterm:Foreskin`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Sarethani (ID: `place:Zarethan`); Adamu (ID: `place:Adam`); Knife (ID: `realia:Knife`); Gadi (ID: `person:Gad`); Holy (ID: `keyterm:Holy`); Manase (ID: `person:Manasseh`); Jebusites (ID: `group:Jebusites`); Dispossess (ID: `keyterm:Dispossess`); Land Flowing of Milk and Honey (ID: `keyterm:LandFlowingOfMilkAndHoney`)
...
* **Associated ACAI Concepts:** Yoshua (ID: `person:Joshua.2`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); mji (ID: `place:Ai`); Covenant Box (ID: `keyterm:CovenantBox`); Akani (ID: `person:Achan`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Yeriko (ID: `place:Jericho`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Rams Horn (ID: `realia:RamsHorn`); Yuda (ID: `person:Judah.4`); Betheli (ID: `place:Bethel`); Covenant (ID: `keyterm:Covenant`); Yuda (ID: `group:Judah`); Money (ID: `realia:Money`); Zabdi (ID: `person:Zabdi`); Rahabu (ID: `person:Rahab`); Zera (ID: `person:Zerah.3`); An Angel (ID: `deity:Angel`); Tent (ID: `realia:Tent`); Cattle (ID: `fauna:Bull`); Karmi (ID: `person:Carmi.3`); Akori (ID: `place:AchorValley`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); To Sin (ID: `keyterm:Sin`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Swear (ID: `keyterm:Swear`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Set Apart for God (ID: `keyterm:Proscribe`)
...
* **Associated ACAI Concepts:** Yoshua (ID: `person:Joshua.2`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`); Gibeoni (ID: `place:Gibeon`); Musa (ID: `person:Moses`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Lakishi (ID: `place:Lachish`); Amorites (ID: `group:Amorites`); Makeda (ID: `place:Makkedah`); Egloni (ID: `place:Eglon`); Hebroni (ID: `place:Hebron`); Gilgal (ID: `place:Gilgal.2`); Covenant (ID: `keyterm:Covenant`); Hazori (ID: `place:Hazor`); Libnah (ID: `place:Libnah.2`); Shefela (ID: `place:Shephelah`); Hermoni (ID: `place:HermonMount`); Fear (ID: `keyterm:Fear`); Hivites (ID: `group:Hivites`); Yerusalemu (ID: `place:Jerusalem`); Yeriko (ID: `place:Jericho`); Araba (ID: `place:Arabah`); Sword (ID: `realia:Sword`); Debiri (ID: `place:Debir`); Yarmuthi (ID: `place:Jarmuth`); mji (ID: `place:Ai`); Swear (ID: `keyterm:Swear`); Yordani (ID: `place:Jordan`); Negebu (ID: `place:Negeb`); To Cause to Possess (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** To Cause to Possess (ID: `keyterm:Possess`); BWANA (ID: `deity:Lord`); Lot (ID: `keyterm:Lot`); Israeli (ID: `person:Israel`); Manase (ID: `person:Manasseh`); Manase (ID: `group:Manasseh`); Musa (ID: `person:Moses`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Yordani (ID: `place:Jordan`); Yoshua (ID: `person:Joshua.2`); Efraimu (ID: `person:Ephraim`); Efraimu (ID: `group:Ephraim`); Walawi (ID: `person:Levi.3`); Walawi (ID: `group:Levi`); Dispossess (ID: `keyterm:Dispossess`); Yusufu (ID: `person:Joseph.10`); Kalebu (ID: `person:Caleb`); Reubeni (ID: `person:Reuben`); Bashani (ID: `place:Bashan`); Reubeni (ID: `group:Reuben`); Wakanaani (ID: `place:Canaan`); Gileadi (ID: `place:Gilead`); Hebroni (ID: `place:Hebron`); Asheri (ID: `person:Asher`); Asheri (ID: `group:Asher`); Kiriath-yearimu (ID: `place:Kiriath-jearim`); Refuge (ID: `keyterm:Refuge`); Canaanites (ID: `group:Canaan`); Gadi (ID: `person:Gad`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Yoshua (ID: `person:Joshua.2`); Force to Serve (ID: `keyterm:EnticedToServe`); Reubeni (ID: `person:Reuben`); Reubeni (ID: `group:Reuben`); Gadi (ID: `person:Gad`); Manase (ID: `group:Manasseh`); Manase (ID: `person:Manasseh`); Yordani (ID: `place:Jordan`); Musa (ID: `person:Moses`); Misri (ID: `place:Egypt`); Wakanaani (ID: `place:Canaan`); Rebel (ID: `keyterm:Rebel`); Dispossess (ID: `keyterm:Dispossess`); Finehasi (ID: `person:Phinehas`); Offering (ID: `keyterm:Offering`); Amorites (ID: `group:Amorites`); Slaughtering (ID: `keyterm:Slaughtering`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); To Cause to Possess (ID: `keyterm:Possess`); Gileadi (ID: `place:Gilead`); Eleazari (ID: `person:Eleazar.2`); Be Unfaithful (ID: `keyterm:Unfaithful`); Bless (ID: `keyterm:Bless`); Mto (ID: `place:Euphrates`); Shekemu (ID: `place:Shechem`)
