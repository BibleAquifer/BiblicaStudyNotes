...
* **Associated ACAI Concepts:** Spies (ID: `group:Spies`); Yoshua (ID: `person:Joshua.2`); Window (ID: `realia:Window`); Exempt (ID: `keyterm:Exempt`); Rahabu (ID: `person:Rahab`); Dispossess (ID: `keyterm:Dispossess`); Shitimu (ID: `place:Shittim`); kubwa (ID: `place:GreatSea`); Terror (ID: `keyterm:Terror`); Thread (ID: `realia:Thread`); Rope (ID: `realia:Rope`); Reubeni (ID: `group:Reuben`); Scroll (ID: `realia:Scroll`); To Cause to Possess (ID: `keyterm:Possess`); Yordani (ID: `place:Jordan`); Musa (ID: `person:Moses`); House (ID: `realia:House`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Yordani (ID: `place:Jordan`); Circumcision (ID: `keyterm:Circumcision`); Adamu (ID: `place:Adam`); Yeriko (ID: `place:Jericho`); Knife (ID: `realia:Knife`); Canaanites (ID: `group:Canaan`); Sarethani (ID: `place:Zarethan`); Foreskin (ID: `keyterm:Foreskin`); Perizzites (ID: `group:Perizzites`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Gilgal (ID: `place:Gilgal.2`); Yoshua (ID: `person:Joshua.2`); Covenant Box (ID: `keyterm:CovenantBox`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Complete (ID: `keyterm:Complete`); Covenant (ID: `keyterm:Covenant`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Akani (ID: `person:Achan`); mji (ID: `place:Ai`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Yoshua (ID: `person:Joshua.2`); Zabdi (ID: `person:Zabdi`); Yeriko (ID: `place:Jericho`); Rams Horn (ID: `realia:RamsHorn`); Shebarimu (ID: `place:Shebarim`); Rahabu (ID: `person:Rahab`); Karmi (ID: `person:Carmi.3`); Akori (ID: `place:AchorValley`); Sword (ID: `realia:Sword`); Javelin (ID: `realia:Javelin`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Clothing (ID: `realia:Clothing`); Zerahites (ID: `group:Zerah`); Beth-aveni (ID: `place:Beth-aven`); Set Apart for God (ID: `keyterm:Proscribe`); Covenant Box (ID: `keyterm:CovenantBox`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Money (ID: `realia:Money`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Makeda (ID: `place:Makkedah`); Egloni (ID: `place:Eglon`); Hazori (ID: `place:Hazor`); Yarmuthi (ID: `place:Jarmuth`); Libnah (ID: `place:Libnah.2`); Madoni (ID: `place:Madon`); Mispa (ID: `place:MizpehValley`); Halaki (ID: `place:HalakMount`); bonde (ID: `place:LebanonValley`); Adoni-sedeki (ID: `person:Adoni-zedek`); Meromu (ID: `place:Merom`); Debiri (ID: `place:Debir`); Yafia (ID: `person:Japhia`); Yabini (ID: `person:Jabin`); Horamu (ID: `person:Horam`); kwa (ID: `person:Hoham`); Lasharoni (ID: `place:Lasharon`); Piramu (ID: `person:Piram`); Debiri (ID: `person:Debir`); Yobabu (ID: `person:Jobab.3`); Akshafu (ID: `place:Achshaph`); Shimroni (ID: `place:Shimron`); Negebu (ID: `place:Negeb`); Dori (ID: `place:Dor`); To Cause to Possess (ID: `keyterm:Possess`); Azeka (ID: `place:Azekah`); Ashtarothi (ID: `place:Ashtaroth`); Ebali (ID: `place:EbalMount`); Anabu (ID: `place:Anab`); Heferi (ID: `place:Hepher`)
...
* **Associated ACAI Concepts:** Beth-hogla (ID: `place:Beth-hoglah`); Beth-araba (ID: `place:Beth-arabah`); Lot (ID: `keyterm:Lot`); Yefune (ID: `person:Jephunneh`); Anaki (ID: `person:Anak`); Kalebu (ID: `person:Caleb`); Kiriath-yearimu (ID: `place:Kiriath-jearim`); Ekroni (ID: `place:Ekron`); To Cause to Possess (ID: `keyterm:Possess`); Refuge (ID: `keyterm:Refuge`); Simeoni (ID: `group:Simeon`); Tapua (ID: `place:Tappuah`); Hamathi (ID: `place:Hammath`); Adumimu (ID: `place:Adummim`); Kanah (ID: `place:Kanah.2`); Eltekeh (ID: `place:Eltekeh`); Mikmeta (ID: `place:Michmethath`); Ataroth-adari (ID: `place:Ataroth-addar`); Bohani (ID: `person:Bohan`); cha (ID: `place:EphronMount`); Yuta (ID: `place:Juttah`); Ashna (ID: `place:Ashnah`); Etheri (ID: `place:Ether`); Saridi (ID: `place:Sarid`); Atarothi (ID: `place:Ataroth.2`); Neftoa (ID: `place:Nephtoah`); bonde (ID: `place:IphtahelValley`); Nea (ID: `place:Neah`); Janoah (ID: `place:Janoah.2`); Enshemeshi (ID: `place:En-shemesh`)
...
* **Associated ACAI Concepts:** Finehasi (ID: `person:Phinehas`); Yoshua (ID: `person:Joshua.2`); Dispossess (ID: `keyterm:Dispossess`); Shekemu (ID: `place:Shechem`); Timnath-heres (ID: `place:Timnath-heres`); Piece of Money (ID: `realia:PieceOfMoney`); Gaashi (ID: `place:Gaash`); Sipori (ID: `person:Zippor`); Nahori (ID: `person:Nahor`); Tera (ID: `person:Terah`); Hivites (ID: `group:Hivites`); Nuni (ID: `person:Nun`); Balaki (ID: `person:Balak`); Gibeah (ID: `place:Gibeah.2`); Trap (ID: `realia:Trap`); The Way (ID: `keyterm:TheWay`); Gadi (ID: `person:Gad`); Reubeni (ID: `group:Reuben`); Reubeni (ID: `person:Reuben`); Manase (ID: `group:Manasseh`); Manase (ID: `person:Manasseh`); Force to Serve (ID: `keyterm:EnticedToServe`); Amorites (ID: `group:Amorites`); Yordani (ID: `place:Jordan`); Wakanaani (ID: `place:Canaan`); Slaughtering (ID: `keyterm:Slaughtering`); Rebel (ID: `keyterm:Rebel`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`)
