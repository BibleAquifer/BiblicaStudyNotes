...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); Yoshua (ID: `person:Joshua.2`); Yordani (ID: `place:Jordan`); House (ID: `realia:House`); Swear (ID: `keyterm:Swear`); Exempt (ID: `keyterm:Exempt`); Yeriko (ID: `place:Jericho`); Nuni (ID: `person:Nun`); Spies (ID: `group:Spies`); Window (ID: `realia:Window`); Dispossess (ID: `keyterm:Dispossess`); Rahabu (ID: `person:Rahab`); Instruction (ID: `keyterm:Instruction`); Oath (ID: `keyterm:Oath`); Have Insight (ID: `keyterm:HaveInsight`); Truth (ID: `keyterm:Truth`); Kindness (ID: `keyterm:Kindness`); Israeli (ID: `person:Israel`); To Cause to Possess (ID: `keyterm:Possess`); Reubeni (ID: `group:Reuben`); Shitimu (ID: `place:Shittim`); Terror (ID: `keyterm:Terror`); kubwa (ID: `place:GreatSea`); Gadi (ID: `person:Gad`); Rebel (ID: `keyterm:Rebel`); Amorites (ID: `group:Amorites`); Sihoni (ID: `person:Sihon`); Hittites (ID: `group:Hittite`); Reubeni (ID: `person:Reuben`); Mto (ID: `place:Euphrates`); Ogu (ID: `person:Og`); Manase (ID: `group:Manasseh`); Manase (ID: `person:Manasseh`); Misri (ID: `place:Egypt`); Lebanoni (ID: `place:Lebanon`); Mhiti (ID: `person:Heth`); Shamu (ID: `place:RedSea`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Thread (ID: `realia:Thread`); Scroll (ID: `realia:Scroll`); Rope (ID: `realia:Rope`); Flax (ID: `flora:Flax`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yordani (ID: `place:Jordan`); Yoshua (ID: `person:Joshua.2`); Israeli (ID: `person:Israel`); Covenant Box (ID: `keyterm:CovenantBox`); Covenant (ID: `keyterm:Covenant`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Complete (ID: `keyterm:Complete`); Circumcision (ID: `keyterm:Circumcision`); Gilgal (ID: `place:Gilgal.2`); Yeriko (ID: `place:Jericho`); Musa (ID: `person:Moses`); Misri (ID: `place:Egypt`); Wakanaani (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Passover (ID: `keyterm:Passover`); Amorites (ID: `group:Amorites`); Fear (ID: `keyterm:Fear`); Foreskin (ID: `keyterm:Foreskin`); Sarethani (ID: `place:Zarethan`); Perizzites (ID: `group:Perizzites`); Adamu (ID: `place:Adam`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Knife (ID: `realia:Knife`); Gadi (ID: `person:Gad`); Dispossess (ID: `keyterm:Dispossess`); Walawi (ID: `group:Levi`); Araba (ID: `place:SaltSea`); Reubeni (ID: `group:Reuben`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Yoshua (ID: `person:Joshua.2`); BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); mji (ID: `place:Ai`); Covenant Box (ID: `keyterm:CovenantBox`); Akani (ID: `person:Achan`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Yeriko (ID: `place:Jericho`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Rams Horn (ID: `realia:RamsHorn`); Betheli (ID: `place:Bethel`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Covenant (ID: `keyterm:Covenant`); Money (ID: `realia:Money`); Zabdi (ID: `person:Zabdi`); Rahabu (ID: `person:Rahab`); Zera (ID: `person:Zerah.3`); An Angel (ID: `deity:Angel`); Cattle (ID: `fauna:Bull`); Tent (ID: `realia:Tent`); Karmi (ID: `person:Carmi.3`); Akori (ID: `place:AchorValley`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); To Sin (ID: `keyterm:Sin`); Swear (ID: `keyterm:Swear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Set Apart for God (ID: `keyterm:Proscribe`)
...
* **Associated ACAI Concepts:** Yoshua (ID: `person:Joshua.2`); Israeli (ID: `person:Israel`); BWANA (ID: `deity:Lord`); Gibeoni (ID: `place:Gibeon`); Musa (ID: `person:Moses`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Lakishi (ID: `place:Lachish`); Amorites (ID: `group:Amorites`); Makeda (ID: `place:Makkedah`); Egloni (ID: `place:Eglon`); Hebroni (ID: `place:Hebron`); Gilgal (ID: `place:Gilgal.2`); Covenant (ID: `keyterm:Covenant`); Hazori (ID: `place:Hazor`); Libnah (ID: `place:Libnah.2`); Hivites (ID: `group:Hivites`); Yerusalemu (ID: `place:Jerusalem`); Yeriko (ID: `place:Jericho`); Fear (ID: `keyterm:Fear`); Shefela (ID: `place:Shephelah`); Araba (ID: `place:Arabah`); Hermoni (ID: `place:HermonMount`); Sword (ID: `realia:Sword`); Yarmuthi (ID: `place:Jarmuth`); Debiri (ID: `place:Debir`); Yordani (ID: `place:Jordan`); Swear (ID: `keyterm:Swear`); mji (ID: `place:Ai`); Negebu (ID: `place:Negeb`); To Cause to Possess (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** To Cause to Possess (ID: `keyterm:Possess`); BWANA (ID: `deity:Lord`); Lot (ID: `keyterm:Lot`); Manase (ID: `group:Manasseh`); Israeli (ID: `person:Israel`); Manase (ID: `person:Manasseh`); Musa (ID: `person:Moses`); Yordani (ID: `place:Jordan`); Yoshua (ID: `person:Joshua.2`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Efraimu (ID: `group:Ephraim`); Efraimu (ID: `person:Ephraim`); Walawi (ID: `group:Levi`); Walawi (ID: `person:Levi.3`); Dispossess (ID: `keyterm:Dispossess`); Yusufu (ID: `person:Joseph.10`); Kalebu (ID: `person:Caleb`); Wakanaani (ID: `place:Canaan`); Reubeni (ID: `person:Reuben`); Bashani (ID: `place:Bashan`); Reubeni (ID: `group:Reuben`); Asheri (ID: `group:Asher`); Asheri (ID: `person:Asher`); Gileadi (ID: `place:Gilead`); Hebroni (ID: `place:Hebron`); Kiriath-yearimu (ID: `place:Kiriath-jearim`); Refuge (ID: `keyterm:Refuge`); Canaanites (ID: `group:Canaan`); Gadi (ID: `person:Gad`)
