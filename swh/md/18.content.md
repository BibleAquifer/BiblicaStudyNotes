...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Shetani (ID: `deity:Satan`); Ayubu (ID: `person:Job`); Bless (ID: `keyterm:Bless`); Fear (ID: `keyterm:Fear`); House (ID: `realia:House`); To Sin (ID: `keyterm:Sin`); Sheba (ID: `person:Sheba`); Job's Wife (ID: `person:WifeOfJob`); Sword (ID: `realia:Sword`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); An Angel (ID: `deity:Angel`); Sabeans (ID: `group:Sabean`); Chaldeans (ID: `group:Chaldea`); Wakaldayo (ID: `place:Chaldea`); Mattock (ID: `realia:Mattock`); Robe (ID: `realia:Robe`); Camel (ID: `fauna:Camel`); Donkey (ID: `fauna:Donkey`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Ayubu (ID: `person:Job`); Sofari (ID: `person:Zophar`); Shuhites (ID: `group:Shuhites`); Elifazi (ID: `person:Eliphaz.2`); Bildadi (ID: `person:Bildad`); Naamathites (ID: `group:Naamathites`); Temanites (ID: `group:Teman`); To Curse (ID: `keyterm:Curse`); Strength (ID: `keyterm:Strength`); Temani (ID: `place:Teman`); Redeem (ID: `keyterm:Redeem`); House (ID: `realia:House`); Dragon (ID: `fauna:Dragon`); Robe (ID: `realia:Robe`); Money (ID: `realia:Money`); Leviathan (ID: `fauna:GiantCroccodile`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); Passion (ID: `keyterm:Ardour`); Ability (ID: `keyterm:Ability`); Hope (ID: `keyterm:Hope`); Strength (ID: `keyterm:Strength`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Ayubu (ID: `person:Job`); Fear (ID: `keyterm:Fear`); Hell (ID: `place:Hell`); To Sin (ID: `keyterm:Sin`); Mischief (ID: `keyterm:Mischief`); Believe In (ID: `keyterm:BelieveIn`); Rebel (ID: `keyterm:Rebel`); Counsel (ID: `keyterm:Counsel`); Safety (ID: `keyterm:Safety`); Understanding (ID: `keyterm:Understanding`); Exempt (ID: `keyterm:Exempt`); Sound Wisdom (ID: `keyterm:SoundWisdom`); Decree (ID: `keyterm:Decree`); Intention (ID: `keyterm:Intention`); Peace (ID: `keyterm:IntactState`); Pure (ID: `keyterm:Pure`); Salvation (ID: `keyterm:Salvation`); Deceit (ID: `keyterm:Deceit`); House (ID: `realia:House`); Money (ID: `realia:Money`); Worm (ID: `fauna:Maggot`); Bildadi (ID: `person:Bildad`); Mighty (ID: `keyterm:Mighty.2`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Ayubu (ID: `person:Job`); Harpoon (ID: `realia:Harpoon`); Lotus Plant (ID: `flora:LotusPlants`); Plan (ID: `keyterm:Plan`); Trust (ID: `keyterm:LeanOn`); Strength (ID: `keyterm:Strength`); To Declare Guilty (ID: `keyterm:DeclareGuilty`); Plea for Mercy (ID: `keyterm:Supplication`); Perceive (ID: `keyterm:Perceive`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Intention (ID: `keyterm:Intention`); Majesty (ID: `keyterm:Majesty`); Covenant (ID: `keyterm:Covenant`); Counsel (ID: `keyterm:Counsel`); Terror (ID: `keyterm:Terror`); Yordani (ID: `place:Jordan`); Javelin (ID: `realia:Javelin`); Cooking Pot (ID: `realia:CookingPot`); Rope (ID: `realia:Rope`); Leviathan (ID: `fauna:GiantCroccodile`); Elephant (ID: `fauna:Elephant`); Behemoth (ID: `fauna:Hippopotamus`); Rush (ID: `flora:Rush`); Cedar (ID: `flora:Cedar`); War Club (ID: `realia:WarClub`); Sword (ID: `realia:Sword`); Poplar (ID: `flora:Poplar`); Hand-Mill (ID: `realia:Hand-mill`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** Ayubu (ID: `person:Job`); BWANA (ID: `deity:Lord`); Elifazi (ID: `person:Eliphaz.2`); Temanites (ID: `group:Teman`); Temani (ID: `place:Teman`); Cattle (ID: `fauna:Bull`); Bildadi (ID: `person:Bildad`); Sofari (ID: `person:Zophar`); Yemima (ID: `person:Jemimah`); Keren-hapuhu (ID: `person:Keren-happuch`); Kesia (ID: `person:Keziah`); Foolish (ID: `keyterm:Foolish`); To Cause to Possess (ID: `keyterm:Possess`); Offering (ID: `keyterm:Offering`); Bless (ID: `keyterm:Bless`); Naamathites (ID: `group:Naamathites`); Shuhites (ID: `group:Shuhites`); Piece of Money (ID: `realia:PieceOfMoney`); Sheep (ID: `fauna:Lamb`); Camel (ID: `fauna:Camel`); Donkey (ID: `fauna:Donkey`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Earring (ID: `realia:Earring`)
