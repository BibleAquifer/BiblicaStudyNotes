...
* **Associated ACAI Concepts:** Ayubu (ID: `person:Job`); BWANA (ID: `deity:Lord`); Usi (ID: `place:Uz`); Offering (ID: `keyterm:Offering`); Fear (ID: `keyterm:Fear`); To Sin (ID: `keyterm:Sin`); Holy (ID: `keyterm:Holy`); Bless (ID: `keyterm:Bless`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Camel (ID: `fauna:Camel`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`); Donkey (ID: `fauna:Donkey`)
...
* **Associated ACAI Concepts:** Ayubu (ID: `person:Job`); Shuhites (ID: `group:Shuhites`); Temanites (ID: `group:Teman`); Elifazi (ID: `person:Eliphaz.2`); Naamathites (ID: `group:Naamathites`); Sofari (ID: `person:Zophar`); Bildadi (ID: `person:Bildad`); Redeem (ID: `keyterm:Redeem`); Strength (ID: `keyterm:Strength`); To Curse (ID: `keyterm:Curse`); Temani (ID: `place:Teman`); House (ID: `realia:House`); Robe (ID: `realia:Robe`); Dragon (ID: `fauna:Dragon`); Money (ID: `realia:Money`); Leviathan (ID: `fauna:GiantCroccodile`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Passion (ID: `keyterm:Ardour`); Perceive (ID: `keyterm:Perceive`); Strength (ID: `keyterm:Strength`); Hope (ID: `keyterm:Hope`); Ability (ID: `keyterm:Ability`); Ayubu (ID: `person:Job`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Fear (ID: `keyterm:Fear`); Hell (ID: `place:Hell`); To Sin (ID: `keyterm:Sin`); Mischief (ID: `keyterm:Mischief`); Counsel (ID: `keyterm:Counsel`); Believe In (ID: `keyterm:BelieveIn`); Rebel (ID: `keyterm:Rebel`); Exempt (ID: `keyterm:Exempt`); Safety (ID: `keyterm:Safety`); Understanding (ID: `keyterm:Understanding`); Sound Wisdom (ID: `keyterm:SoundWisdom`); Decree (ID: `keyterm:Decree`); Intention (ID: `keyterm:Intention`); Salvation (ID: `keyterm:Salvation`); Deceit (ID: `keyterm:Deceit`); Pure (ID: `keyterm:Pure`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Money (ID: `realia:Money`); Worm (ID: `fauna:Maggot`); Bildadi (ID: `person:Bildad`); To Beg for Mercy (ID: `keyterm:BegForMercy`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Ayubu (ID: `person:Job`); Elihu (ID: `person:Elihu.5`); Mischief (ID: `keyterm:Mischief`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Hell (ID: `place:Hell`); Rebel (ID: `keyterm:Rebel`); Perceive (ID: `keyterm:Perceive`); Strength (ID: `keyterm:Strength`); To Sin (ID: `keyterm:Sin`); Intention (ID: `keyterm:Intention`); To Declare Guilty (ID: `keyterm:DeclareGuilty`); Fear (ID: `keyterm:Fear`); Ability (ID: `keyterm:Ability`); Appoint (ID: `keyterm:Appoint`); Buzites (ID: `group:Buzites`); Barakeli (ID: `person:Barachel`); Understanding (ID: `keyterm:Understanding`); Have Insight (ID: `keyterm:HaveInsight`); Complete (ID: `keyterm:Complete`); Straightness (ID: `keyterm:Straightness`); Ramu (ID: `person:Ram.3`); Mighty One (ID: `keyterm:MightyOne`); To Act Wickedly (ID: `keyterm:ActWickedly`); Majesty (ID: `keyterm:Majesty`); Kindness (ID: `keyterm:Kindness`); Force to Serve (ID: `keyterm:EnticedToServe`); Redeem (ID: `keyterm:Redeem`); An Angel (ID: `deity:Angel`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Ayubu (ID: `person:Job`); Harpoon (ID: `realia:Harpoon`); Lotus Plant (ID: `flora:LotusPlants`); Plan (ID: `keyterm:Plan`); Counsel (ID: `keyterm:Counsel`); Majesty (ID: `keyterm:Majesty`); Trust (ID: `keyterm:LeanOn`); Strength (ID: `keyterm:Strength`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Covenant (ID: `keyterm:Covenant`); Terror (ID: `keyterm:Terror`); Perceive (ID: `keyterm:Perceive`); Yordani (ID: `place:Jordan`); To Declare Guilty (ID: `keyterm:DeclareGuilty`); Intention (ID: `keyterm:Intention`); Plea for Mercy (ID: `keyterm:Supplication`); Rope (ID: `realia:Rope`); Javelin (ID: `realia:Javelin`); Cooking Pot (ID: `realia:CookingPot`); Elephant (ID: `fauna:Elephant`); Leviathan (ID: `fauna:GiantCroccodile`); Behemoth (ID: `fauna:Hippopotamus`); Rush (ID: `flora:Rush`); Dragon (ID: `fauna:Dragon`); Cattle (ID: `fauna:Bull`); Sling (ID: `realia:Sling`); War Club (ID: `realia:WarClub`); Trap (ID: `realia:Trap`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** Ayubu (ID: `person:Job`); BWANA (ID: `deity:Lord`); Elifazi (ID: `person:Eliphaz.2`); Temanites (ID: `group:Teman`); Temani (ID: `place:Teman`); Cattle (ID: `fauna:Bull`); Kesia (ID: `person:Keziah`); Yemima (ID: `person:Jemimah`); Keren-hapuhu (ID: `person:Keren-happuch`); Sofari (ID: `person:Zophar`); Bildadi (ID: `person:Bildad`); Offering (ID: `keyterm:Offering`); To Cause to Possess (ID: `keyterm:Possess`); Bless (ID: `keyterm:Bless`); Naamathites (ID: `group:Naamathites`); Foolish (ID: `keyterm:Foolish`); Shuhites (ID: `group:Shuhites`); Piece of Money (ID: `realia:PieceOfMoney`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); Camel (ID: `fauna:Camel`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Donkey (ID: `fauna:Donkey`); Earring (ID: `realia:Earring`)
