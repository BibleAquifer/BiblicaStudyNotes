...
* **Associated ACAI Concepts:** Sulemani (ID: `person:Solomon`); BWANA (ID: `deity:Lord`); Daudi (ID: `person:David`); Adonia (ID: `person:Adonijah`); Israeli (ID: `person:Israel`); Benaya (ID: `person:Benaiah`); Yehoyada (ID: `person:Jehoiada`); Nathani (ID: `person:Nathan.2`); Sadoki (ID: `person:Zadok.2`); Yoabu (ID: `person:Joab`); Abiathari (ID: `person:Abiathar`); Bathsheba (ID: `person:Bathsheba`); Shimei (ID: `person:Shimei.5`); Swear (ID: `keyterm:Swear`); Abishagi (ID: `person:Abishag`); Yerusalemu (ID: `place:Jerusalem`); Shunammites (ID: `group:Shunammites`); Yuda (ID: `group:Judah`); Ability (ID: `keyterm:Ability`); Yuda (ID: `person:Judah.4`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Perceive (ID: `keyterm:Perceive`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Hagithi (ID: `person:Haggith`); Gileadi (ID: `place:Gilead`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Sulemani (ID: `person:Solomon`); Israeli (ID: `person:Israel`); Daudi (ID: `person:David`); Covenant Box (ID: `keyterm:CovenantBox`); Hiramu (ID: `person:Hiram`); To Sin (ID: `keyterm:Sin`); Plea for Mercy (ID: `keyterm:Supplication`); Bless (ID: `keyterm:Bless`); Misri (ID: `place:Egypt`); Covenant (ID: `keyterm:Covenant`); Forgive (ID: `keyterm:Forgive`); Cubit (ID: `realia:Cubit`); Cedar (ID: `flora:Cedar`); Winged Creature (ID: `realia:WingedCreature`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Craftsman (ID: `realia:Craftsman`); Hewn Stone (ID: `realia:HewnStone`); Cattle (ID: `fauna:Bull`); Hiramu (ID: `person:Hiram.2`); patakatifu (ID: `place:MostHolyPlace`); To Beg for Mercy (ID: `keyterm:BegForMercy`); To Cause to Possess (ID: `keyterm:Possess`); Musa (ID: `person:Moses`); Tiro (ID: `place:Tyre`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Daudi (ID: `person:David`); Holy (ID: `keyterm:Holy`); Sulemani (ID: `person:Solomon`); Force to Serve (ID: `keyterm:EnticedToServe`); Israeli (ID: `person:Israel`); Straightness (ID: `keyterm:Straightness`); Plea for Mercy (ID: `keyterm:Supplication`); Misri (ID: `place:Egypt`); Decree (ID: `keyterm:Decree`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Proverb (ID: `keyterm:Saying`); Gibeoni (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Sulemani (ID: `person:Solomon`); BWANA (ID: `deity:Lord`); Daudi (ID: `person:David`); Israeli (ID: `person:Israel`); Yerusalemu (ID: `place:Jerusalem`); Farao (ID: `person:Pharaoh.7`); Ability (ID: `keyterm:Ability`); Misri (ID: `place:Egypt`); Hadadi (ID: `person:Hadad.3`); Edomu (ID: `place:Edom`); Hiramu (ID: `person:Hiram`); Yeroboamu (ID: `person:Jeroboam`); House (ID: `realia:House`); malkia (ID: `person:QueenOfSheba`); Waamoni (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Money (ID: `realia:Money`); Gezeri (ID: `place:Gezer`); Moabu (ID: `place:Moab`); Milo (ID: `place:Millo`); Offering (ID: `keyterm:Offering`); Wasidoni (ID: `place:Sidon`); Sidonians (ID: `group:Sidon`); Love (ID: `keyterm:Love`); Hittites (ID: `group:Hittite`); Moleki (ID: `deity:Molech`); Yoabu (ID: `person:Joab`); Mhiti (ID: `person:Heth`); Edomites (ID: `group:Edom`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yeroboamu (ID: `person:Jeroboam`); Israeli (ID: `person:Israel`); Rehoboamu (ID: `person:Rehoboam`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Betheli (ID: `place:Bethel`); Daudi (ID: `person:David`); Ahiya (ID: `person:Ahijah.2`); Sulemani (ID: `person:Solomon`); Yerusalemu (ID: `place:Jerusalem`); House (ID: `realia:House`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); To Sin (ID: `keyterm:Sin`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Donkey (ID: `fauna:Donkey`); Yoke (ID: `realia:Yoke`); Counsel (ID: `keyterm:Counsel`); Rebel (ID: `keyterm:Rebel`); Shilo (ID: `place:Shiloh`); Misri (ID: `place:Egypt`); Lion (ID: `fauna:Lion`); Naama (ID: `person:Naamah`); Nebati (ID: `person:Nebat`); Shekemu (ID: `place:Shechem`)
