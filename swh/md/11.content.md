...
* **Associated ACAI Concepts:** Sulemani (ID: `person:Solomon`); BWANA (ID: `deity:Lord`); Daudi (ID: `person:David`); Adonia (ID: `person:Adonijah`); Israeli (ID: `person:Israel`); Benaya (ID: `person:Benaiah`); Yehoyada (ID: `person:Jehoiada`); Nathani (ID: `person:Nathan.2`); Sadoki (ID: `person:Zadok.2`); Yoabu (ID: `person:Joab`); Abiathari (ID: `person:Abiathar`); Bathsheba (ID: `person:Bathsheba`); Shimei (ID: `person:Shimei.5`); Swear (ID: `keyterm:Swear`); Abishagi (ID: `person:Abishag`); Yerusalemu (ID: `place:Jerusalem`); Shunammites (ID: `group:Shunammites`); Peace (ID: `keyterm:IntactState`); Ability (ID: `keyterm:Ability`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); House (ID: `realia:House`); Perceive (ID: `keyterm:Perceive`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Hagithi (ID: `person:Haggith`); Gileadi (ID: `place:Gilead`); Seruya (ID: `person:Zeruiah`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Sulemani (ID: `person:Solomon`); Israeli (ID: `person:Israel`); Daudi (ID: `person:David`); Covenant Box (ID: `keyterm:CovenantBox`); Hiramu (ID: `person:Hiram`); To Sin (ID: `keyterm:Sin`); Plea for Mercy (ID: `keyterm:Supplication`); Bless (ID: `keyterm:Bless`); Covenant (ID: `keyterm:Covenant`); Misri (ID: `place:Egypt`); Forgive (ID: `keyterm:Forgive`); Cubit (ID: `realia:Cubit`); Cedar (ID: `flora:Cedar`); Winged Creature (ID: `realia:WingedCreature`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Craftsman (ID: `realia:Craftsman`); Cattle (ID: `fauna:Bull`); Hewn Stone (ID: `realia:HewnStone`); patakatifu (ID: `place:MostHolyPlace`); Hiramu (ID: `person:Hiram.2`); To Beg for Mercy (ID: `keyterm:BegForMercy`); To Cause to Possess (ID: `keyterm:Possess`); Musa (ID: `person:Moses`); Lebanoni (ID: `place:Lebanon`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Israeli (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Force to Serve (ID: `keyterm:EnticedToServe`); Sulemani (ID: `person:Solomon`); Daudi (ID: `person:David`); Straightness (ID: `keyterm:Straightness`); Gibeoni (ID: `place:Gibeon`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Proverb (ID: `keyterm:Saying`); Plea for Mercy (ID: `keyterm:Supplication`); Misri (ID: `place:Egypt`); Decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** Sulemani (ID: `person:Solomon`); BWANA (ID: `deity:Lord`); Daudi (ID: `person:David`); Israeli (ID: `person:Israel`); Yerusalemu (ID: `place:Jerusalem`); Farao (ID: `person:Pharaoh.7`); Ability (ID: `keyterm:Ability`); Misri (ID: `place:Egypt`); Hadadi (ID: `person:Hadad.3`); Hiramu (ID: `person:Hiram`); Edomu (ID: `place:Edom`); Yeroboamu (ID: `person:Jeroboam`); House (ID: `realia:House`); malkia (ID: `person:QueenOfSheba`); Waamoni (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Money (ID: `realia:Money`); Love (ID: `keyterm:Love`); Yoabu (ID: `person:Joab`); Wasidoni (ID: `place:Sidon`); Moabu (ID: `place:Moab`); Sidonians (ID: `group:Sidon`); Mhiti (ID: `person:Heth`); Edomites (ID: `group:Edom`); Gezeri (ID: `place:Gezer`); Moleki (ID: `deity:Molech`); Hittites (ID: `group:Hittite`); Offering (ID: `keyterm:Offering`); Milo (ID: `place:Millo`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yeroboamu (ID: `person:Jeroboam`); Israeli (ID: `person:Israel`); Rehoboamu (ID: `person:Rehoboam`); Yuda (ID: `person:Judah.4`); Yuda (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Betheli (ID: `place:Bethel`); Daudi (ID: `person:David`); Ahiya (ID: `person:Ahijah.2`); Yerusalemu (ID: `place:Jerusalem`); Sulemani (ID: `person:Solomon`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); To Sin (ID: `keyterm:Sin`); Stone Pine (ID: `flora:Pine`); Donkey (ID: `fauna:Donkey`); High Place (ID: `realia:HighPlace`); Yoke (ID: `realia:Yoke`); Shilo (ID: `place:Shiloh`); Misri (ID: `place:Egypt`); Rebel (ID: `keyterm:Rebel`); Counsel (ID: `keyterm:Counsel`); Lion (ID: `fauna:Lion`); Naama (ID: `person:Naamah`); Nebati (ID: `person:Nebat`); Symbol (ID: `keyterm:Example`)
