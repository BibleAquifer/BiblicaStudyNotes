...
* **Associated ACAI Concepts:** Abishagi (ID: `person:Abishag`); Adonia (ID: `person:Adonijah`); Bathsheba (ID: `person:Bathsheba`); Shunammites (ID: `group:Shunammites`); Benaya (ID: `person:Benaiah`); Yehoyada (ID: `person:Jehoiada`); Shimei (ID: `person:Shimei.5`); Nathani (ID: `person:Nathan.2`); Abiathari (ID: `person:Abiathar`); Sadoki (ID: `person:Zadok.2`); Sulemani (ID: `person:Solomon`); Shimei (ID: `person:Shimei.6`); Prostitute (ID: `person:FirstProstitute`); Yoabu (ID: `person:Joab`); House (ID: `realia:House`); Hagithi (ID: `person:Haggith`); Baana (ID: `person:Baana`); Goose (ID: `fauna:Goose`); Basemathi (ID: `person:Basemath.2`); Ela (ID: `person:Ela`); Tifsa (ID: `place:Tiphsah`); Ahinadabu (ID: `person:Ahinadab`); Mwana (ID: `person:Ben-hur`); Abinadabu (ID: `person:Abinadab.4`); Dekari (ID: `person:Deker`); Ahimaasi (ID: `person:Ahimaaz.3`); Baana (ID: `person:Baana.2`); Zabudi (ID: `person:Zabud`); Elihorefu (ID: `person:Elihoreph`); Parua (ID: `person:Paruah`)
...
* **Associated ACAI Concepts:** Floor (ID: `realia:Floor`); Aleppo Pine (ID: `flora:PineTree`); Hiramu (ID: `person:Hiram`); Bottle Gourd (ID: `flora:BottleGourd`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Forgive (ID: `keyterm:Forgive`); Hiramu (ID: `person:Hiram.2`); Fir (ID: `flora:Fir`); nguzo (ID: `place:HallOfPillars`); Rafts (ID: `realia:Rafts`); baraza (ID: `place:HallOfJudgment`); baraza (ID: `place:HallOfTheThrone`); Wheel (ID: `realia:Wheel`); patakatifu (ID: `place:MostHolyPlace`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Lily (ID: `flora:Lily`); Bath (ID: `realia:Bath`); Room (ID: `realia:Room`); Gebalites (ID: `group:Gebal`); Stone Plane (ID: `realia:StonePlane`); Ability (ID: `keyterm:Ability`); Wagebali (ID: `place:Gebal`); Sarethani (ID: `place:Zarethan`); Wick Trimmer (ID: `realia:WickTrimmer`); nyumba (ID: `place:HouseOfTheForestOfLebanon`); Bowl (ID: `realia:Bowl`); Bread of Display (ID: `realia:BreadOfDisplay`); Handbreadth (ID: `realia:Handbreadth`); kijito (ID: `place:BrookOfEgypt`); Hammer (ID: `realia:Hammer`)
...
* **Associated ACAI Concepts:** Straightness (ID: `keyterm:Straightness`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hadadi (ID: `person:Hadad.3`); Farao (ID: `person:Pharaoh.7`); malkia (ID: `person:QueenOfSheba`); Tapanesi (ID: `person:Tahpenes`); Yeroboamu (ID: `person:Jeroboam`); Genubathi (ID: `person:Genubath`); Kabuli (ID: `place:Cabul.2`); Serua (ID: `person:Zeruah`); Eliada (ID: `person:Eliada.2`); Zeredah (ID: `place:Zeredah.2`); Rezoni (ID: `person:Rezon`); Talent (ID: `realia:Talent`); nyumba (ID: `place:HouseOfTheForestOfLebanon`); Ashtorethi (ID: `deity:Ashtoreth`); Ofiri (ID: `place:Ophir`); Baalathi (ID: `place:Baalath.2`); Baboon (ID: `fauna:Baboon`); Monkey (ID: `fauna:Monkey`); wakapewa (ID: `place:Kue`); Ahiya (ID: `person:Ahijah.2`); Sheba (ID: `place:Sheba.2`); Detested Thing (ID: `keyterm:DetestedThing`); Sandalwood (ID: `flora:Sandalwood`); Throne (ID: `realia:Throne`); Shilonites (ID: `group:Shiloh`); Shishaki (ID: `person:Shishak`); Sycomore Fig (ID: `flora:SycomoreFig`); Hazori (ID: `place:Hazor`); Shefela (ID: `place:Shephelah`); Large Shield (ID: `realia:LargeShield`)
...
* **Associated ACAI Concepts:** Ahiya (ID: `person:Ahijah.2`); Rehoboamu (ID: `person:Rehoboam`); Yeroboamu (ID: `person:Jeroboam`); Yoke (ID: `realia:Yoke`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Abiya (ID: `person:Abijah.3`); Naama (ID: `person:Naamah`); Lion (ID: `fauna:Lion`); Whip (ID: `realia:Whip`); Scorpion (ID: `fauna:Scorpion`); Nebati (ID: `person:Nebat`); Shemaya (ID: `person:Shemaiah`); Adoramu (ID: `person:Adoram`); Shishaki (ID: `person:Shishak`); Tirza (ID: `place:Tirzah`); Abiya (ID: `person:Abijah.4`); Betheli (ID: `place:Bethel`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Donkey (ID: `fauna:Donkey`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Sulemani (ID: `person:Solomon`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); House (ID: `realia:House`); Israeli (ID: `person:Israel`); Daudi (ID: `person:David`)
...
* **Associated ACAI Concepts:** Obadia (ID: `person:Obadiah`); Zimri (ID: `person:Zimri.2`); Nabothi (ID: `person:Naboth`); Ben-hadadi (ID: `person:Ben-hadad`); Baasha (ID: `person:Baasha`); Omri (ID: `person:Omri`); Ela (ID: `person:Elah.2`); Yezebeli (ID: `person:Jezebel`); Ahabu (ID: `person:Ahab`); Mikaya (ID: `person:Micaiah.5`); Asa (ID: `person:Asa`); Eliya (ID: `person:Elijah`); Yehoshafati (ID: `person:Jehoshaphat.3`); Nadabu (ID: `person:Nadab.2`); Ahiya (ID: `person:Ahijah.3`); Samaria (ID: `place:Samaria`); Ginathi (ID: `person:Ginath`); Tibni (ID: `person:Tibni`); Kerithi (ID: `place:Cherith`); Stone Altar (ID: `realia:StoneAltar`); Karmeli (ID: `place:CarmelMount`); Yehu (ID: `person:Jehu`); Gibethoni (ID: `place:Gibbethon`); Tishbites (ID: `group:Tishbite`); Mtishbi (ID: `place:Tishbe`); Ahazia (ID: `person:Ahaziah`); mwa (ID: `person:Arza`); Segubu (ID: `person:Segub`); Abiramu (ID: `person:Abiram.2`); Hezioni (ID: `person:Hezion`)
