...
* **Associated ACAI Concepts:** Sulemani (ID: `person:Solomon`); BWANA (ID: `deity:Lord`); Daudi (ID: `person:David`); Adonia (ID: `person:Adonijah`); Israeli (ID: `person:Israel`); Benaya (ID: `person:Benaiah`); Yehoyada (ID: `person:Jehoiada`); Nathani (ID: `person:Nathan.2`); Sadoki (ID: `person:Zadok.2`); Yoabu (ID: `person:Joab`); Abiathari (ID: `person:Abiathar`); Shimei (ID: `person:Shimei.5`); Bathsheba (ID: `person:Bathsheba`); Swear (ID: `keyterm:Swear`); Abishagi (ID: `person:Abishag`); Yerusalemu (ID: `place:Jerusalem`); Shunammites (ID: `group:Shunammites`); Yuda (ID: `group:Judah`); Peace (ID: `keyterm:IntactState`); Ability (ID: `keyterm:Ability`); Yuda (ID: `person:Judah.4`); House (ID: `realia:House`); Perceive (ID: `keyterm:Perceive`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Hagithi (ID: `person:Haggith`); Misri (ID: `place:Egypt`); Absalomu (ID: `person:Absalom`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Sulemani (ID: `person:Solomon`); Israeli (ID: `person:Israel`); Daudi (ID: `person:David`); Covenant Box (ID: `keyterm:CovenantBox`); Hiramu (ID: `person:Hiram`); To Sin (ID: `keyterm:Sin`); Plea for Mercy (ID: `keyterm:Supplication`); Misri (ID: `place:Egypt`); Bless (ID: `keyterm:Bless`); Covenant (ID: `keyterm:Covenant`); Forgive (ID: `keyterm:Forgive`); Cubit (ID: `realia:Cubit`); Cedar (ID: `flora:Cedar`); Winged Creature (ID: `realia:WingedCreature`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Craftsman (ID: `realia:Craftsman`); Hewn Stone (ID: `realia:HewnStone`); Cattle (ID: `fauna:Bull`); patakatifu (ID: `place:MostHolyPlace`); Hiramu (ID: `person:Hiram.2`); To Beg for Mercy (ID: `keyterm:BegForMercy`); To Cause to Possess (ID: `keyterm:Possess`); Lebanoni (ID: `place:Lebanon`); Musa (ID: `person:Moses`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); House (ID: `realia:House`); Force to Serve (ID: `keyterm:EnticedToServe`); Daudi (ID: `person:David`); Israeli (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Sulemani (ID: `person:Solomon`); Straightness (ID: `keyterm:Straightness`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Misri (ID: `place:Egypt`); Decree (ID: `keyterm:Decree`); Proverb (ID: `keyterm:Saying`); Gibeoni (ID: `place:Gibeon`); Plea for Mercy (ID: `keyterm:Supplication`)
...
* **Associated Articles:** Ndoa (ID: `367697@BiblicaStudyNotes`); Bwana (ID: `367717@BiblicaStudyNotesKeyTerms`); Kanaani (ID: `367737@BiblicaStudyNotesKeyTerms`); Watumwa (ID: `367749@BiblicaStudyNotesKeyTerms`); Wake (ID: `367768@BiblicaStudyNotesKeyTerms`); Makabila 12 (ID: `367777@BiblicaStudyNotesKeyTerms`); Aliyepakwa mafuta (ID: `367851@BiblicaStudyNotesKeyTerms`); Nabii (ID: `367907@BiblicaStudyNotesKeyTerms`); Sauli (ID: `367946@BiblicaStudyNotesKeyTerms`); Yeroboamu (ID: `367967@BiblicaStudyNotesKeyTerms`); Ahiya (ID: `367968@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Sulemani (ID: `person:Solomon`); BWANA (ID: `deity:Lord`); Daudi (ID: `person:David`); Israeli (ID: `person:Israel`); Yerusalemu (ID: `place:Jerusalem`); Farao (ID: `person:Pharaoh.7`); Misri (ID: `place:Egypt`); Ability (ID: `keyterm:Ability`); Hadadi (ID: `person:Hadad.3`); Edomu (ID: `place:Edom`); Hiramu (ID: `person:Hiram`); Yeroboamu (ID: `person:Jeroboam`); House (ID: `realia:House`); malkia (ID: `person:QueenOfSheba`); Ammonites (ID: `group:Ammon`); Waamoni (ID: `place:Ammon`); Money (ID: `realia:Money`); Moabu (ID: `place:Moab`); Sidonians (ID: `group:Sidon`); Offering (ID: `keyterm:Offering`); Moleki (ID: `deity:Molech`); Mhiti (ID: `person:Heth`); Wasidoni (ID: `place:Sidon`); Edomites (ID: `group:Edom`); Love (ID: `keyterm:Love`); Yoabu (ID: `person:Joab`); Gezeri (ID: `place:Gezer`); Milo (ID: `place:Millo`); Hittites (ID: `group:Hittite`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yeroboamu (ID: `person:Jeroboam`); Israeli (ID: `person:Israel`); Rehoboamu (ID: `person:Rehoboam`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Betheli (ID: `place:Bethel`); Daudi (ID: `person:David`); Ahiya (ID: `person:Ahijah.2`); Sulemani (ID: `person:Solomon`); Yerusalemu (ID: `place:Jerusalem`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); To Sin (ID: `keyterm:Sin`); High Place (ID: `realia:HighPlace`); Donkey (ID: `fauna:Donkey`); Stone Pine (ID: `flora:Pine`); Yoke (ID: `realia:Yoke`); Misri (ID: `place:Egypt`); Shilo (ID: `place:Shiloh`); Counsel (ID: `keyterm:Counsel`); Rebel (ID: `keyterm:Rebel`); Lion (ID: `fauna:Lion`); Naama (ID: `person:Naamah`); Nebati (ID: `person:Nebat`); Force to Serve (ID: `keyterm:EnticedToServe`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Israeli (ID: `person:Israel`); Ahabu (ID: `person:Ahab`); Eliya (ID: `person:Elijah`); Asa (ID: `person:Asa`); Baasha (ID: `person:Baasha`); Yehoshafati (ID: `person:Jehoshaphat.3`); Yuda (ID: `group:Judah`); Yuda (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Samaria (ID: `place:Samaria`); Yeroboamu (ID: `person:Jeroboam`); Nabothi (ID: `person:Naboth`); Ben-hadadi (ID: `person:Ben-hadad`); Yezebeli (ID: `person:Jezebel`); To Sin (ID: `keyterm:Sin`); Omri (ID: `person:Omri`); Baali (ID: `deity:Baal`); Mikaya (ID: `person:Micaiah.5`); Zimri (ID: `person:Zimri.2`); Yezreeli (ID: `place:Jezreel.2`); Syrians (ID: `group:Syria`); Tirza (ID: `place:Tirzah`); Obadia (ID: `person:Obadiah`); Daudi (ID: `person:David`); An Angel (ID: `deity:Angel`); Ramoth-gileadi (ID: `place:Ramoth-gilead`); Yezreeli (ID: `group:Jezreel`); Nebati (ID: `person:Nebat`); Speak as a Prophet (ID: `keyterm:Speak`)
