...
* **Associated ACAI Concepts:** Kloe (ID: `person:Chloe`); Paulo (ID: `person:Paul`); Gayo (ID: `person:Gaius.3`); Krispo (ID: `person:Crispus`); Sosthene (ID: `person:Sosthenes`); Stefana (ID: `person:Stephanas`); A Disciple (ID: `person:GenericDisciple`); Baptism (ID: `keyterm:Baptism`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Consecration (ID: `keyterm:Consecration.2`); Ability (ID: `keyterm:Ability`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Discern (ID: `keyterm:Discern`); Spirit (ID: `keyterm:Spirit.2`); Natural (ID: `keyterm:Natural`); Roho (ID: `deity:HolySpirit`); Ability (ID: `keyterm:Ability`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Apolo (ID: `person:Apollos`); Carnal (ID: `keyterm:Carnal`); A Disciple (ID: `person:GenericDisciple`)
...
* **Associated ACAI Concepts:** Interpret (ID: `keyterm:Interpret`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Faithfulness (ID: `keyterm:Faithfulness`); Decided (ID: `keyterm:Decided`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Partake (ID: `keyterm:Partake`); Authority (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Partake (ID: `keyterm:Partake`); Fellowship (ID: `keyterm:Fellowship`); Be Lawful (ID: `keyterm:Lawful`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Resurrection (ID: `keyterm:Resurrection`); Empty (ID: `keyterm:Empty`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Fortunato (ID: `person:Fortunatus`); Achaicus (ID: `person:Achaicus`); Stefana (ID: `person:Stephanas`); Priskila (ID: `person:Priscilla`); Akila (ID: `person:Aquila`); Week (ID: `keyterm:Week`); Akaya (ID: `place:Achaia`); Yesu (ID: `person:Jesus.2`)
