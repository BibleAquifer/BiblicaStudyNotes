...
* **Associated Passages:** 1 Wakorintho 1:1-17
* **Associated Articles:** Mitume (ID: `367544@BiblicaStudyNotesKeyTerms`); Mwamini (ID: `367568@BiblicaStudyNotes`); Kanisa (ID: `367587@BiblicaStudyNotesKeyTerms`); Paulo (ID: `367593@BiblicaStudyNotesKeyTerms`); Korintho (ID: `367624@BiblicaStudyNotesKeyTerms`); Apollos (ID: `367627@BiblicaStudyNotesKeyTerms`); Bwana Yesu Kristo (ID: `367637@BiblicaStudyNotesKeyTerms`); Yesu (ID: `367710@BiblicaStudyNotesKeyTerms`); Mungu huchagua (ID: `367720@BiblicaStudyNotesKeyTerms`); Amini katika (ID: `367746@BiblicaStudyNotesKeyTerms`); Watu wa Mungu (ID: `367793@BiblicaStudyNotesKeyTerms`); Bwana - Mtawala (ID: `367820@BiblicaStudyNotesKeyTerms`); Petro (ID: `368063@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Baptism (ID: `keyterm:Baptism`); BWANA (ID: `deity:Lord`); Name (ID: `keyterm:Name`); Paulo (ID: `person:Paul`); Favor (ID: `keyterm:Favor`); In Christ (ID: `keyterm:InChrist`); Cross (ID: `realia:Cross`); Gayo (ID: `person:Gaius.3`); Sosthene (ID: `person:Sosthenes`); Kloe (ID: `person:Chloe`); Stefana (ID: `person:Stephanas`); A Disciple (ID: `person:GenericDisciple`); Krispo (ID: `person:Crispus`); Good News (ID: `keyterm:GoodNews`); Bear Witness (ID: `keyterm:BearWitness`); Call Upon (ID: `keyterm:CallUpon`); Korintho (ID: `place:Corinth`); Apolo (ID: `person:Apollos`); Petro (ID: `person:Peter`); Without Reproach (ID: `keyterm:WithoutReproach`); Deprive of Power (ID: `keyterm:DepriveOfPower`); Ask for (ID: `keyterm:AskFor`); Fellowship (ID: `keyterm:Fellowship`); Church (ID: `keyterm:Church`); Make Peace (ID: `keyterm:Peace`); Faithfulness (ID: `keyterm:Faithfulness`)
...
* **Associated Passages:** 1 Wakorintho 1:18-31
* **Associated Articles:** Dhambi (ID: `367686@BiblicaStudyNotes`); Dunia (ID: `367706@BiblicaStudyNotes`); Hekima (ID: `367816@BiblicaStudyNotes`); Msalaba (ID: `368021@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Jews (ID: `group:Jews`); Yesu (ID: `person:Jesus.2`); Salvation (ID: `keyterm:Salvation`); Body (ID: `keyterm:Body.3`); Chosen (ID: `keyterm:Chosen`); Yavani (ID: `person:Javan`); Greeks (ID: `group:Greek`); Proclaim (ID: `keyterm:Proclaim`); Cross (ID: `realia:Cross`); Consecration (ID: `keyterm:Consecration.2`); Believe (ID: `keyterm:Believe`); Liberation (ID: `keyterm:Liberation`); Stumbling Block (ID: `keyterm:StumblingBlock`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Always (ID: `keyterm:Always`); Symbol (ID: `keyterm:Example`); Gentiles (ID: `group:Gentile`); In Christ (ID: `keyterm:InChrist`)
...
* **Associated Passages:** 1 Wakorintho 2:1-16
...
* **Associated Passages:** 1 Wakorintho 3:1-9

* **Associated ACAI Concepts:** Apolo (ID: `person:Apollos`); BWANA (ID: `deity:Lord`); Carnal (ID: `keyterm:Carnal`); Yesu (ID: `person:Jesus.2`); Paulo (ID: `person:Paul`); A Disciple (ID: `person:GenericDisciple`); Live (ID: `keyterm:Live.3`); Resentment (ID: `keyterm:Resentment`); Believe (ID: `keyterm:Believe`); In Christ (ID: `keyterm:InChrist`); Ability (ID: `keyterm:Ability`)
...
* **Associated Passages:** 1 Wakorintho 3:10-23
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Yesu (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Foundation (ID: `realia:Foundation`); Interpret (ID: `keyterm:Interpret`); Holy (ID: `keyterm:Holy`); Petro (ID: `person:Peter`); Apolo (ID: `person:Apollos`); Salvation (ID: `keyterm:Salvation`); Worthless (ID: `keyterm:Worthless`); Life (ID: `keyterm:Life`); Paulo (ID: `person:Paul`); Favor (ID: `keyterm:Favor`); Always (ID: `keyterm:Always`); Roho (ID: `deity:HolySpirit`); Reed (ID: `flora:Reed`); Grass (ID: `flora:Grass`)
...
* **Associated Passages:** 1 Wakorintho 4:1-21
* **Associated Articles:** Kutendewa vibaya (ID: `367545@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Discern (ID: `keyterm:Discern`); In Christ (ID: `keyterm:InChrist`); Faithfulness (ID: `keyterm:Faithfulness`); Ask for (ID: `keyterm:AskFor`); Beloved (ID: `keyterm:Beloved`); Decided (ID: `keyterm:Decided`); Glorious (ID: `keyterm:Glorious`); Good News (ID: `keyterm:GoodNews`); Love (ID: `keyterm:Love`); Apolo (ID: `person:Apollos`); Bless (ID: `keyterm:Bless`); Timotheo (ID: `person:Timothy`); Heart (ID: `keyterm:Heart`); Defame (ID: `keyterm:Defame`); Church (ID: `keyterm:Church`); An Angel (ID: `deity:Angel`); Spirit (ID: `keyterm:Spirit.2`); Kingdom (ID: `keyterm:Kingdom`); Staff (ID: `realia:Staff`)
...
* **Associated Passages:** 1 Wakorintho 5:1-13
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Spirit (ID: `keyterm:Spirit.2`); Decided (ID: `keyterm:Decided`); Idolater (ID: `keyterm:Idolater`); Ability (ID: `keyterm:Ability`); Body (ID: `keyterm:Body.3`); Passover (ID: `keyterm:Passover`); Truth (ID: `keyterm:Truth`); Salvation (ID: `keyterm:Salvation`); Name (ID: `keyterm:Name`); Obligated (ID: `keyterm:Ought`); Offering (ID: `keyterm:Offering`); Fornication (ID: `keyterm:Fornication`); BWANA (ID: `deity:Lord`); Gentiles (ID: `group:Gentile`); Shetani (ID: `deity:Satan`); Pure (ID: `keyterm:Pure`); Sheep (ID: `fauna:Lamb`)
...
* **Associated Passages:** 1 Wakorintho 6:1-11
...
* **Associated ACAI Concepts:** Decided (ID: `keyterm:Decided`); BWANA (ID: `deity:Lord`); To Act Wickedly (ID: `keyterm:ActWickedly`); Court Case (ID: `keyterm:CourtCase`); Holy (ID: `keyterm:Holy`); Everyday Matters (ID: `keyterm:OfThisLife`); Kingdom (ID: `keyterm:Kingdom`); Idolater (ID: `keyterm:Idolater`); Yesu (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); Name (ID: `keyterm:Name`); Church (ID: `keyterm:Church`); Discern (ID: `keyterm:Discern`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Roho (ID: `deity:HolySpirit`); Judgment (ID: `keyterm:Judgment`); Ability (ID: `keyterm:Ability`); Consecration (ID: `keyterm:Consecration.2`)
...
* **Associated Passages:** 1 Wakorintho 7:1-16
* **Associated Articles:** Ndoa (ID: `367697@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Be Unfaithful (ID: `keyterm:Unfaithful`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`); Holy (ID: `keyterm:Holy`); Make Peace (ID: `keyterm:Peace`); Debt (ID: `keyterm:Debt`); Reconcile (ID: `keyterm:Reconcile`); Salvation (ID: `keyterm:Salvation`); Body (ID: `keyterm:Body.3`); Favor (ID: `keyterm:Favor`); Defilement (ID: `keyterm:Defilement`); Put to the Test (ID: `keyterm:PutToTheTest`); Authority (ID: `keyterm:Authority.2`); Fornication (ID: `keyterm:Fornication`); Pray (ID: `keyterm:Pray`); Shetani (ID: `deity:Satan`); Consecration (ID: `keyterm:Consecration.2`)
...
* **Associated Passages:** 1 Wakorintho 7:17-40
* **Associated Articles:** Familia ya Mungu (ID: `367536@BiblicaStudyNotesKeyTerms`); Tohara (ID: `367748@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yesu (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); To Sin (ID: `keyterm:Sin`); Body (ID: `keyterm:Body.3`); Commandment (ID: `keyterm:Commandment`); Live (ID: `keyterm:Live.3`); Obligated (ID: `keyterm:Ought`); Heart (ID: `keyterm:Heart`); Mercy (ID: `keyterm:Mercy`); Life (ID: `keyterm:Life`); Decided (ID: `keyterm:Decided`); Redeem (ID: `keyterm:Redeem`); Church (ID: `keyterm:Church`); Authority (ID: `keyterm:Authority.2`); Roho (ID: `deity:HolySpirit`); Holy (ID: `keyterm:Holy`); Faithfulness (ID: `keyterm:Faithfulness`); Spirit (ID: `keyterm:Spirit.2`); Circumcision (ID: `keyterm:Circumcision`)
...
* **Associated Passages:** 1 Wakorintho 9:1-18
* **Associated Articles:** Neno la Mungu (ID: `367691@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Authority (ID: `keyterm:Authority.2`); Yesu (ID: `person:Jesus.2`); Good News (ID: `keyterm:GoodNews`); Partake (ID: `keyterm:Partake`); Law (ID: `keyterm:Law`); Grain (ID: `flora:Grain`); Discern (ID: `keyterm:Discern`); Believe (ID: `keyterm:Believe`); Obligated (ID: `keyterm:Ought`); Hope (ID: `keyterm:Hope`); BWANA (ID: `deity:Lord`); Musa (ID: `person:Moses`); Stewardship (ID: `keyterm:Stewardship`); Petro (ID: `person:Peter`); Deprive of Power (ID: `keyterm:DepriveOfPower`); Life (ID: `keyterm:Life`); Disaster (ID: `keyterm:Disaster`); Barnaba (ID: `person:Barnabas`); Carnal (ID: `keyterm:Carnal`); Certification (ID: `keyterm:Certification`); Cattle (ID: `fauna:Bull`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Temple (ID: `realia:Temple`); Flock (ID: `fauna:Flock`)
...
* **Associated Passages:** 1 Wakorintho 9:19-27
...
* **Associated Passages:** 1 Wakorintho 10:1-13
* **Associated Articles:** Israeli (ID: `367771@BiblicaStudyNotesKeyTerms`); Mataifa (ID: `368038@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`); Put to the Test (ID: `keyterm:PutToTheTest`); Idolater (ID: `keyterm:Idolater`); Faithfulness (ID: `keyterm:Faithfulness`); Always (ID: `keyterm:Always`); Fornication (ID: `keyterm:Fornication`); Musa (ID: `person:Moses`); Snake (ID: `fauna:Snake`)
...
* **Associated Passages:** 1 Wakorintho 11:2-16
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Pray (ID: `keyterm:Pray`); Yesu (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`); Speak as a Prophet (ID: `keyterm:Speak`); An Angel (ID: `deity:Angel`); Decided (ID: `keyterm:Decided`); Obligated (ID: `keyterm:Ought`); Church (ID: `keyterm:Church`); Authority (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); Teaching (ID: `keyterm:Teaching`)
...
* **Associated Passages:** 1 Wakorintho 11:17-34
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Body (ID: `keyterm:Body.3`); Decided (ID: `keyterm:Decided`); Church (ID: `keyterm:Church`); Discern (ID: `keyterm:Discern`); Judgment (ID: `keyterm:Judgment`); Blood (ID: `keyterm:Blood`); House (ID: `realia:House`); Approved (ID: `keyterm:Approved`); Interpret (ID: `keyterm:Interpret`); BWANA (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Condemn (ID: `keyterm:Condemn`); Ability (ID: `keyterm:Ability`); Covenant (ID: `keyterm:Covenant`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** 1 Wakorintho 12:1-11
* **Associated Articles:** Karama za Roho (ID: `367640@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Roho (ID: `deity:HolySpirit`); Yesu (ID: `person:Jesus.2`); Favor (ID: `keyterm:Favor`); BWANA (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Serve (ID: `keyterm:Serve`); Spirit (ID: `keyterm:Spirit.2`); Discern (ID: `keyterm:Discern`); Believe (ID: `keyterm:Believe`); A Person (ID: `person:GenericPerson`); Image (ID: `realia:Image`)
...
* **Associated Passages:** 1 Wakorintho 12:12-31
* **Associated Articles:** Mbingu (ID: `367692@BiblicaStudyNotesKeyTerms`); Baba (ID: `367803@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Favor (ID: `keyterm:Favor`); BWANA (ID: `deity:Lord`); Yesu (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); Glory (ID: `keyterm:Glory`); Greeks (ID: `group:Greek`); Baptism (ID: `keyterm:Baptism`); Church (ID: `keyterm:Church`); Jews (ID: `group:Jews`); Roho (ID: `deity:HolySpirit`); Yavani (ID: `person:Javan`)
...
* **Associated Passages:** 1 Wakorintho 13:1-13
...
* **Associated Passages:** 1 Wakorintho 14:1-25
...
* **Associated Passages:** 1 Wakorintho 14:26-40
* **Associated Articles:** Amani (ID: `367702@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); BWANA (ID: `deity:Lord`); Speak as a Prophet (ID: `keyterm:Speak`); Yesu (ID: `person:Jesus.2`); Holy (ID: `keyterm:Holy`); Make Peace (ID: `keyterm:Peace`); Spirit (ID: `keyterm:Spirit.2`); Ask for (ID: `keyterm:AskFor`); Law (ID: `keyterm:Law`); Building Up (ID: `keyterm:BuildingUp`); Encourage (ID: `keyterm:Encourage`); Discern (ID: `keyterm:Discern`); Ability (ID: `keyterm:Ability`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated Passages:** 1 Wakorintho 15:1-19
* **Associated Articles:** Masihi (ID: `368018@BiblicaStudyNotesKeyTerms`); Ufufuo (ID: `368059@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Resurrection (ID: `keyterm:Resurrection`); Believe (ID: `keyterm:Believe`); BWANA (ID: `deity:Lord`); Proclaim (ID: `keyterm:Proclaim`); Empty (ID: `keyterm:Empty`); Written (ID: `keyterm:Scripture`); Good News (ID: `keyterm:GoodNews`); To Sin (ID: `keyterm:Sin`); In Christ (ID: `keyterm:InChrist`); Worthless (ID: `keyterm:Worthless`); Salvation (ID: `keyterm:Salvation`); Bear Witness (ID: `keyterm:BearWitness`); Yakobo (ID: `person:James.3`); Hope (ID: `keyterm:Hope`); Petro (ID: `person:Peter`); Life (ID: `keyterm:Life`); Pitiful (ID: `keyterm:Pitiful`); Church (ID: `keyterm:Church`); Favor (ID: `keyterm:Favor`)
...
* **Associated Passages:** 1 Wakorintho 15:20-34
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Resurrection (ID: `keyterm:Resurrection`); BWANA (ID: `deity:Lord`); Adamu (ID: `person:Adam`); Efeso (ID: `place:Ephesus`); Kingdom (ID: `keyterm:Kingdom`); Baptism (ID: `keyterm:Baptism`); To Sin (ID: `keyterm:Sin`); Authority (ID: `keyterm:Authority.2`); In Christ (ID: `keyterm:InChrist`); Good (ID: `keyterm:Good`); Ability (ID: `keyterm:Ability`)
...
* **Associated Passages:** 1 Wakorintho 16:1-24
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Holy (ID: `keyterm:Holy`); Stefana (ID: `person:Stephanas`); Love (ID: `keyterm:Love`); Ask for (ID: `keyterm:AskFor`); Church (ID: `keyterm:Church`); Favor (ID: `keyterm:Favor`); Achaicus (ID: `person:Achaicus`); Fortunato (ID: `person:Fortunatus`); Week (ID: `keyterm:Week`); Akila (ID: `person:Aquila`); Priskila (ID: `person:Priscilla`); Akaya (ID: `place:Achaia`); Paulo (ID: `person:Paul`); Makedonia (ID: `place:Macedonia`); Believe (ID: `keyterm:Believe`); Apolo (ID: `person:Apollos`); Friendship (ID: `keyterm:Friendship`); Timotheo (ID: `person:Timothy`); Hope (ID: `keyterm:Hope`); Asia (ID: `place:Asia`); BWANA (ID: `deity:Lord`); Interpret (ID: `keyterm:Interpret`); Yerusalemu (ID: `place:Jerusalem`); Galatia (ID: `place:Galatia`); Serve (ID: `keyterm:Serve`); Make Peace (ID: `keyterm:Peace`); Efeso (ID: `place:Ephesus`); Spirit (ID: `keyterm:Spirit.2`); In Christ (ID: `keyterm:InChrist`); House (ID: `realia:House`); Door (ID: `realia:Door`); Temple (ID: `realia:Temple`)
