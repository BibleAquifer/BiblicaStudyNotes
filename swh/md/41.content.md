...
* **Associated ACAI Concepts:** Yohana (ID: `person:John`); Proclaim (ID: `keyterm:Proclaim`); Good News (ID: `keyterm:GoodNews`); Zebedayo (ID: `person:Zebedee`); Galilaya (ID: `place:Galilee`); Yordani (ID: `place:Jordan`); Strap (ID: `realia:Strap`); Hired Worker (ID: `keyterm:HiredWorker`); Sea of Galilee (ID: `place:GalileeSea`); Yakobo (ID: `person:James`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); Galilaya (ID: `place:Galilee`); Kapernaumu (ID: `place:Capernaum`)
...
* **Associated ACAI Concepts:** Alfayo (ID: `person:Alphaeus.2`); Bed (ID: `realia:Bed`); Patch (ID: `realia:Patch`); Mathayo (ID: `person:Matthew`); Housetop (ID: `realia:Housetop`); Kapernaumu (ID: `place:Capernaum`); Skin-Bottle (ID: `realia:Skin-bottle`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Be Lawful (ID: `keyterm:Lawful`); Herodians (ID: `group:Herodian`); Abiathari (ID: `person:Abiathar`); Sabbath (ID: `keyterm:Sabbath`)
...
* **Associated ACAI Concepts:** Idumaya (ID: `place:Idumea`); Zelote (ID: `group:Zealot`); Bartholomayo (ID: `person:Bartholomew`); Alfayo (ID: `person:Alphaeus`); Yakobo (ID: `person:James.2`); Yakobo (ID: `person:James`); Yohana (ID: `person:John.2`)
...
* **Associated ACAI Concepts:** Cushion (ID: `realia:Cushion`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); Legioni (ID: `deity:Legion`); Fetter (ID: `realia:Fetter`); Chain (ID: `realia:Chain`); Dekapoli (ID: `place:Decapolis`); Gerasa (ID: `place:Gerasa`); To Command (ID: `keyterm:Command`)
...
* **Associated ACAI Concepts:** Cloak (ID: `realia:Cloak`); Yairo (ID: `person:Jairus`)
...
* **Associated ACAI Concepts:** Yusufu (ID: `person:Joseph.3`); Simoni (ID: `person:Simon.3`); Yuda (ID: `person:Jude`); Disbelieve (ID: `keyterm:Disbelieve`)
...
* **Associated ACAI Concepts:** Herode (ID: `person:Herod.2`); Herodia (ID: `person:Herodias`); Plate (ID: `realia:Plate.2`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Filipo (ID: `person:Philip.2`); Yohana (ID: `person:John`)
...
* **Associated ACAI Concepts:** Affection (ID: `keyterm:Affection`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Genesareti (ID: `place:Gennesaret`); Bethsaida (ID: `place:Bethsaida`)
...
* **Associated ACAI Concepts:** Teaching (ID: `keyterm:Teaching`); Pharisees (ID: `group:Pharisee`); Korbani (ID: `place:Corban`); Defilement (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** Syrophoenicians (ID: `group:Phoenicia`); Tiro (ID: `place:Tyre`); Dekapoli (ID: `place:Decapolis`); Msirofoinike (ID: `place:Phoenicia`); Greeks (ID: `group:Greek`); Wasidoni (ID: `place:Sidon`)
...
* **Associated ACAI Concepts:** vya (ID: `place:CaesareaPhilippi`); Bethsaida (ID: `place:Bethsaida`); Baptist (ID: `keyterm:Baptist`)
...
* **Associated ACAI Concepts:** Cause to Stumble (ID: `keyterm:CauseToStumble`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); Yesu (ID: `person:Jesus.2`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Bartimayo (ID: `person:Bartimaeus`); Timayo (ID: `person:Timaeus`); Yesu (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Hosanna (ID: `keyterm:Hosanna`); Bethania (ID: `place:Bethany`); Bethfage (ID: `place:Bethphage`); Rush (ID: `flora:Rush`); Yerusalemu (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); Seat (ID: `realia:Seat`)
...
* **Associated ACAI Concepts:** Herodians (ID: `group:Herodian`); Denarius (ID: `realia:Denarius`); BWANA (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Quadrans (ID: `realia:Quadrans`); Lepton (ID: `realia:Lepton`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `realia:Myrrh`); Simoni (ID: `person:Simon.4`); Oil of Nard (ID: `realia:OilOfNard`); Alabaster Jar (ID: `realia:AlabasterJar`); Nard (ID: `flora:Nard`); Bethania (ID: `place:Bethany`)
...
* **Associated ACAI Concepts:** Centurion at Crucifixion (ID: `person:Centurion.3`); Iskanda (ID: `person:Alexander`); Rufo (ID: `person:Rufus`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Simoni (ID: `person:Simon.5`); Purple Cloth (ID: `realia:PurpleCloth`); Golgotha (ID: `place:Golgotha`); Palace (ID: `realia:Palace`); Mkirene (ID: `place:Cyrene`); Myrrh (ID: `flora:Myrrh`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Mariamu (ID: `person:Mary.2`); Yusufu (ID: `person:Joseph.6`); Yusufu (ID: `person:Joseph.3`); Yusufu (ID: `person:Joseph.5`); Yakobo (ID: `person:James.4`); Salome (ID: `person:Salome`); Arimathaya (ID: `place:Arimathea`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Salome (ID: `person:Salome`); Angels (ID: `group:Angels`); Mariamu (ID: `person:Mary.2`)
