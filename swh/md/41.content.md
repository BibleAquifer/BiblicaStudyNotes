...
* **Associated ACAI Concepts:** Yohana (ID: `person:John`); Baptism (ID: `keyterm:Baptism`); Yesu (ID: `person:Jesus.2`); Good News (ID: `keyterm:GoodNews`); Proclaim (ID: `keyterm:Proclaim`); BWANA (ID: `deity:Lord`); Roho (ID: `deity:HolySpirit`); Yordani (ID: `place:Jordan`); Zebedayo (ID: `person:Zebedee`); Galilaya (ID: `place:Galilee`); Sky (ID: `keyterm:Heaven`); Repent (ID: `keyterm:Repent`); An Angel (ID: `deity:Angel`); To Sin (ID: `keyterm:Sin`); Casting Net (ID: `realia:CastingNet`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Sea of Galilee (ID: `place:GalileeSea`); Hired Worker (ID: `keyterm:HiredWorker`); Yakobo (ID: `person:James`); Forgive (ID: `keyterm:Forgive`); Yohana (ID: `person:John.2`); Yudea (ID: `place:Judea`); Andrea (ID: `person:Andrew`); Kingdom (ID: `keyterm:Kingdom`); Nazareti (ID: `place:Nazareth`); Isaya (ID: `person:Isaiah`); Yerusalemu (ID: `place:Jerusalem`); Put to the Test (ID: `keyterm:PutToTheTest`); Shetani (ID: `deity:Satan`); Beloved (ID: `keyterm:Beloved`); Straightness (ID: `keyterm:Straightness`); Believe (ID: `keyterm:Believe`); Petro (ID: `person:Peter`); Serve (ID: `keyterm:Serve`); Strap (ID: `realia:Strap`); Locust (ID: `fauna:Locust`); Leather (ID: `realia:Leather`); Belt (ID: `realia:Belt`); Camel (ID: `fauna:Camel`); Bag (ID: `realia:Bag`); Bee (ID: `fauna:Bee`); Dove (ID: `fauna:Dove`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** To Cleanse (ID: `keyterm:Cleanse.2`); Synagogue (ID: `realia:Synagogue`); Proclaim (ID: `keyterm:Proclaim`); Petro (ID: `person:Peter`); Galilaya (ID: `place:Galilee`); Authority (ID: `keyterm:Authority.2`); Demons (ID: `deity:Demons`); Ability (ID: `keyterm:Ability`); Yesu (ID: `person:Jesus.2`); Serve (ID: `keyterm:Serve`); Kapernaumu (ID: `place:Capernaum`); Bear Witness (ID: `keyterm:BearWitness`); Offering (ID: `keyterm:Offering`); Ask for (ID: `keyterm:AskFor`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); To Command (ID: `keyterm:Command`); Yohana (ID: `person:John.2`); Andrea (ID: `person:Andrew`); Nazareti (ID: `place:Nazareth`); Musa (ID: `person:Moses`); BWANA (ID: `deity:Lord`); Pray (ID: `keyterm:Pray`); Sabbath (ID: `keyterm:Sabbath`); Yakobo (ID: `person:James`); Holy (ID: `keyterm:Holy`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); House (ID: `realia:House`)
...
* **Associated Articles:** Binadamu (ID: `367693@BiblicaStudyNotesKeyTerms`); Samehe (ID: `367772@BiblicaStudyNotes`)

* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); Bed (ID: `realia:Bed`); Abstain from Food (ID: `keyterm:Fast`); Be a Disciple (ID: `keyterm:Disciple`); House (ID: `realia:House`); Heart (ID: `keyterm:Heart`); Pharisees (ID: `group:Pharisee`); BWANA (ID: `deity:Lord`); Tax Collector (ID: `keyterm:TaxCollector`); Temple (ID: `realia:Temple`); Mathayo (ID: `person:Matthew`); Kapernaumu (ID: `place:Capernaum`); Alfayo (ID: `person:Alphaeus.2`); Authority (ID: `keyterm:Authority.2`); Glory (ID: `keyterm:Glory`); Be Healthy (ID: `keyterm:Healthy`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); Ability (ID: `keyterm:Ability`); Tax Office (ID: `keyterm:TaxOffice`); Believe (ID: `keyterm:Believe`); Spirit (ID: `keyterm:Spirit.2`); Yohana (ID: `person:John`); Patch (ID: `realia:Patch`); Skin-Bottle (ID: `realia:Skin-bottle`); Housetop (ID: `realia:Housetop`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Must (ID: `realia:Must`)
...
* **Associated ACAI Concepts:** Sabbath (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); Pharisees (ID: `group:Pharisee`); Herodians (ID: `group:Herodian`); Abiathari (ID: `person:Abiathar`); Heart (ID: `keyterm:Heart`); Salvation (ID: `keyterm:Salvation`); Daudi (ID: `person:David`); BWANA (ID: `deity:Lord`); Be a Disciple (ID: `keyterm:Disciple`); Life (ID: `keyterm:Life`); Serve (ID: `keyterm:Serve`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`); Grain (ID: `flora:Grain`)
...
* **Associated Articles:** Yudea (ID: `367526@BiblicaStudyNotesKeyTerms`); Galilaya (ID: `367527@BiblicaStudyNotesKeyTerms`); Israeli (ID: `367771@BiblicaStudyNotes`); Mto Yordani (ID: `367897@BiblicaStudyNotesKeyTerms`); Tiro na Sidoni (ID: `367966@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); Be a Disciple (ID: `keyterm:Disciple`); Bartholomayo (ID: `person:Bartholomew`); Alfayo (ID: `person:Alphaeus`); Idumaya (ID: `place:Idumea`); Yohana (ID: `person:John.2`); Zelote (ID: `group:Zealot`); Yakobo (ID: `person:James.2`); Yakobo (ID: `person:James`); Authority (ID: `keyterm:Authority.2`); To Command (ID: `keyterm:Command`); Zebedayo (ID: `person:Zebedee`); Proclaim (ID: `keyterm:Proclaim`); Yudea (ID: `place:Judea`); Andrea (ID: `person:Andrew`); Yuda (ID: `person:Judas.2`); Demons (ID: `deity:Demons`); Yerusalemu (ID: `place:Jerusalem`); Galilaya (ID: `place:Galilee`); Ability (ID: `keyterm:Ability`); Tomaso (ID: `person:Thomas`); Mathayo (ID: `person:Matthew`); Yuda (ID: `person:Judas`); Wasidoni (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); Yesu (ID: `person:Jesus.2`); Yordani (ID: `place:Jordan`); Simoni (ID: `person:Simon.2`); Filipo (ID: `person:Philip`); Petro (ID: `person:Peter`); Serve (ID: `keyterm:Serve`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Shetani (ID: `deity:Satan`); Blaspheme (ID: `keyterm:Blaspheme`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); House (ID: `realia:House`); Roho (ID: `deity:HolySpirit`); Parable (ID: `keyterm:Parable`); Kingdom (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); Surely! (ID: `keyterm:Surely`); BWANA (ID: `deity:Lord`); Always (ID: `keyterm:Always`); Yerusalemu (ID: `place:Jerusalem`); Religious Officials (ID: `group:ReligiousOfficials`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Parable (ID: `keyterm:Parable`); Grain (ID: `flora:Grain`); Kingdom (ID: `keyterm:Kingdom`); BWANA (ID: `deity:Lord`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Grass (ID: `flora:Grass`); Barley (ID: `flora:Barley`); Sky (ID: `keyterm:Heaven`); Ask for (ID: `keyterm:AskFor`); Forgive (ID: `keyterm:Forgive`); Always (ID: `keyterm:Always`); Shetani (ID: `deity:Satan`); Ability (ID: `keyterm:Ability`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Be a Disciple (ID: `keyterm:Disciple`); Mustard (ID: `flora:Mustard`); Wheat (ID: `flora:Wheat`); Lampstand (ID: `realia:Lampstand.2`); Sickle (ID: `realia:Sickle`); Bird (ID: `fauna:Bird`); Ship (ID: `realia:Ship`); Bed (ID: `realia:Bed`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Salvation (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`); Fear (ID: `keyterm:Fear`); Believe (ID: `keyterm:Believe`); Yairo (ID: `person:Jairus`); Ask for (ID: `keyterm:AskFor`); Yohana (ID: `person:John.2`); A Group of Disciples (ID: `group:GenericDisciples`); Make Peace (ID: `keyterm:Peace`); Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); Body (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); Blood (ID: `keyterm:Blood`); Yakobo (ID: `person:James`); Petro (ID: `person:Peter`); Be a Disciple (ID: `keyterm:Disciple`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Serve (ID: `keyterm:Serve`); Yuda (ID: `person:Jude`); Simoni (ID: `person:Simon.3`); Disbelieve (ID: `keyterm:Disbelieve`); Yusufu (ID: `person:Joseph.3`); Bear Witness (ID: `keyterm:BearWitness`); Authority (ID: `keyterm:Authority.2`); Repent (ID: `keyterm:Repent`); Proclaim (ID: `keyterm:Proclaim`); Demons (ID: `deity:Demons`); Yakobo (ID: `person:James.3`); Mariamu (ID: `person:Mary`); Yesu (ID: `person:Jesus.2`); Sabbath (ID: `keyterm:Sabbath`); Anointed (ID: `keyterm:Anointed`); Be a Disciple (ID: `keyterm:Disciple`); Staff (ID: `realia:Staff`); House (ID: `realia:House`); Belt (ID: `realia:Belt`); Synagogue (ID: `realia:Synagogue`); Tunic (ID: `realia:Tunic.2`); Bag (ID: `realia:Bag`); Sandal (ID: `realia:Sandal`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Fish (ID: `fauna:Fish`); Be a Disciple (ID: `keyterm:Disciple`); Affection (ID: `keyterm:Affection`); A Group of Disciples (ID: `group:GenericDisciples`); Sky (ID: `keyterm:Heaven`); Yesu (ID: `person:Jesus.2`); Bless (ID: `keyterm:Bless`); Basket (ID: `realia:Basket`); Ship (ID: `realia:Ship`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`); Sheep (ID: `fauna:Lamb`); Denarius (ID: `realia:Denarius`)
...
* **Associated Articles:** Bahari (ID: `367563@BiblicaStudyNotesKeyTerms`); Sala (ID: `367718@BiblicaStudyNotes`)

* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); Genesareti (ID: `place:Gennesaret`); Bethsaida (ID: `place:Bethsaida`); Heart (ID: `keyterm:Heart`); Ask for (ID: `keyterm:AskFor`); Fear (ID: `keyterm:Fear`); Salvation (ID: `keyterm:Salvation`); Cheer Up (ID: `keyterm:CheerUp`); Pray (ID: `keyterm:Pray`); Be a Disciple (ID: `keyterm:Disciple`); Tassel (ID: `realia:Tassel`); Bed (ID: `realia:Bed`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Defilement (ID: `keyterm:Defilement`); Teaching (ID: `keyterm:Teaching`); Pharisees (ID: `group:Pharisee`); Heart (ID: `keyterm:Heart`); BWANA (ID: `deity:Lord`); Be a Disciple (ID: `keyterm:Disciple`); Commandment (ID: `keyterm:Commandment`); Korbani (ID: `place:Corban`); To Cleanse (ID: `keyterm:Cleanse.2`); Offering (ID: `keyterm:Offering`); Blaspheme (ID: `keyterm:Blaspheme`); Worship (ID: `keyterm:Worship`); Isaya (ID: `person:Isaiah`); Yerusalemu (ID: `place:Jerusalem`); Religious Officials (ID: `group:ReligiousOfficials`); Live (ID: `keyterm:Live.3`); Fornication (ID: `keyterm:Fornication`); Musa (ID: `person:Moses`); Baptism (ID: `keyterm:Baptism`); Parable (ID: `keyterm:Parable`); Speak as a Prophet (ID: `keyterm:Speak`); Jews (ID: `group:Jews`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Bed (ID: `realia:Bed`); Cooking Pot (ID: `realia:CookingPot`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); Tiro (ID: `place:Tyre`); Ask for (ID: `keyterm:AskFor`); House (ID: `realia:House`); Dog (ID: `fauna:Dog`); Msirofoinike (ID: `place:Phoenicia`); Dekapoli (ID: `place:Decapolis`); Syrophoenicians (ID: `group:Phoenicia`); Greeks (ID: `group:Greek`); Wasidoni (ID: `place:Sidon`); Sky (ID: `keyterm:Heaven`); Honest (ID: `keyterm:Honest`); Yavani (ID: `person:Javan`); Proclaim (ID: `keyterm:Proclaim`); Sea of Galilee (ID: `place:GalileeSea`); Temple (ID: `realia:Temple`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); Basket (ID: `realia:Basket`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisees (ID: `group:Pharisee`); Symbol (ID: `keyterm:Example`); Ship (ID: `realia:Ship`); Magadani (ID: `place:Magadan`); Sky (ID: `keyterm:Heaven`); Affection (ID: `keyterm:Affection`); Ask for (ID: `keyterm:AskFor`); Heart (ID: `keyterm:Heart`); Surely! (ID: `keyterm:Surely`); Herode (ID: `person:Herod.2`); Spirit (ID: `keyterm:Spirit.2`); Bless (ID: `keyterm:Bless`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Baptist (ID: `keyterm:Baptist`); vya (ID: `place:CaesareaPhilippi`); Bethsaida (ID: `place:Bethsaida`); Eliya (ID: `person:Elijah`); Ask for (ID: `keyterm:AskFor`); To Command (ID: `keyterm:Command`); Petro (ID: `person:Peter`); Be a Disciple (ID: `keyterm:Disciple`); Yohana (ID: `person:John`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated Articles:** Msalaba (ID: `368021@BiblicaStudyNotes`); Mwana wa Adamu (ID: `368048@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Ability (ID: `keyterm:Ability`); To Command (ID: `keyterm:Command`); Be a Disciple (ID: `keyterm:Disciple`); Petro (ID: `person:Peter`); Salvation (ID: `keyterm:Salvation`); Shetani (ID: `deity:Satan`); Kingdom (ID: `keyterm:Kingdom`); Reject (ID: `keyterm:Reject`); Think (ID: `keyterm:Think`); Surely! (ID: `keyterm:Surely`); An Angel (ID: `deity:Angel`); Holy (ID: `keyterm:Holy`); Good News (ID: `keyterm:GoodNews`); Glory (ID: `keyterm:Glory`); Be Unfaithful (ID: `keyterm:Unfaithful`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Eliya (ID: `person:Elijah`); Yesu (ID: `person:Jesus.2`); Musa (ID: `person:Moses`); Petro (ID: `person:Peter`); Beloved (ID: `keyterm:Beloved`); Yakobo (ID: `person:James`); Yohana (ID: `person:John.2`); Tent (ID: `realia:Tent`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** A Father (ID: `person:GenericFather`); Yesu (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Believe (ID: `keyterm:Believe`); A Group of Disciples (ID: `group:GenericDisciples`); Affection (ID: `keyterm:Affection`); To Command (ID: `keyterm:Command`); Disbelieve (ID: `keyterm:Disbelieve`); A Group of People (ID: `group:GenericGroup`); Pray (ID: `keyterm:Pray`); Be Unfaithful (ID: `keyterm:Unfaithful`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); Kapernaumu (ID: `place:Capernaum`); Fear (ID: `keyterm:Fear`); Galilaya (ID: `place:Galilee`); Be a Disciple (ID: `keyterm:Disciple`); Word (ID: `keyterm:Word`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Cause to Stumble (ID: `keyterm:CauseToStumble`); Name (ID: `keyterm:Name`); Hell (ID: `place:Hell`); Gehenna (ID: `keyterm:Gehenna`); Yesu (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Believe (ID: `keyterm:Believe`); Kingdom (ID: `keyterm:Kingdom`); Ability (ID: `keyterm:Ability`); Demons (ID: `deity:Demons`); Surely! (ID: `keyterm:Surely`); BWANA (ID: `deity:Lord`); Be at Peace (ID: `keyterm:AtPeace`); Yohana (ID: `person:John.2`); Worm (ID: `fauna:Maggot`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Kingdom (ID: `keyterm:Kingdom`); Yesu (ID: `person:Jesus.2`); To Command (ID: `keyterm:Command`); Musa (ID: `person:Moses`); Fornication (ID: `keyterm:Fornication`); Be a Disciple (ID: `keyterm:Disciple`); Yudea (ID: `place:Judea`); Commandment (ID: `keyterm:Commandment`); Yordani (ID: `place:Jordan`); Surely! (ID: `keyterm:Surely`); Hardheartedness (ID: `keyterm:Hardheartedness`); Be Lawful (ID: `keyterm:Lawful`); Body (ID: `keyterm:Body.3`); Bless (ID: `keyterm:Bless`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Yakobo (ID: `person:James`); Baptism (ID: `keyterm:Baptism`); Yerusalemu (ID: `place:Jerusalem`); Gentiles (ID: `group:Gentile`); Yohana (ID: `person:John.2`); Authority (ID: `keyterm:Authority.2`); Fear (ID: `keyterm:Fear`); Condemn (ID: `keyterm:Condemn`); Ransom (ID: `keyterm:Ransom`); Zebedayo (ID: `person:Zebedee`); Life (ID: `keyterm:Life`); Glory (ID: `keyterm:Glory`); Serve (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Daudi (ID: `person:David`); A Group of People (ID: `group:GenericGroup`); Mercy (ID: `keyterm:Mercy`); Bartimayo (ID: `person:Bartimaeus`); Timayo (ID: `person:Timaeus`); Believe (ID: `keyterm:Believe`); Salvation (ID: `keyterm:Salvation`); Yeriko (ID: `place:Jericho`); Cheer Up (ID: `keyterm:CheerUp`); To Command (ID: `keyterm:Command`); Be a Disciple (ID: `keyterm:Disciple`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Donkey (ID: `fauna:Donkey`); Yesu (ID: `person:Jesus.2`); Bethania (ID: `place:Bethany`); Hosanna (ID: `keyterm:Hosanna`); Yerusalemu (ID: `place:Jerusalem`); A Group of People (ID: `group:GenericGroup`); Bless (ID: `keyterm:Bless`); Cloak (ID: `realia:Cloak`); Bethfage (ID: `place:Bethphage`); Name (ID: `keyterm:Name`); Height (ID: `keyterm:Height`); Kingdom (ID: `keyterm:Kingdom`); Daudi (ID: `person:David`); BWANA (ID: `deity:Lord`); Be a Disciple (ID: `keyterm:Disciple`); Rush (ID: `flora:Rush`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); Believe (ID: `keyterm:Believe`); Temple (ID: `realia:Temple`); Fig (ID: `flora:Fig`); BWANA (ID: `deity:Lord`); Heart (ID: `keyterm:Heart`); Sky (ID: `keyterm:Heaven`); Forgive (ID: `keyterm:Forgive`); Fear (ID: `keyterm:Fear`); Yerusalemu (ID: `place:Jerusalem`); Always (ID: `keyterm:Always`); Bethania (ID: `place:Bethany`); Discern (ID: `keyterm:Discern`); Yesu (ID: `person:Jesus.2`); Surely! (ID: `keyterm:Surely`); Petro (ID: `person:Peter`); Be a Disciple (ID: `keyterm:Disciple`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Authority (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Fear (ID: `keyterm:Fear`); Parable (ID: `keyterm:Parable`); Yesu (ID: `person:Jesus.2`); Yohana (ID: `person:John`); Reject (ID: `keyterm:Reject`); Written (ID: `keyterm:Scripture`); Priests (ID: `group:GenericPriests`); Yerusalemu (ID: `place:Jerusalem`); Religious Officials (ID: `group:ReligiousOfficials`); Elders (ID: `group:GenericElders`); Empty (ID: `keyterm:Empty`); Beloved (ID: `keyterm:Beloved`); BWANA (ID: `deity:Lord`); Baptism (ID: `keyterm:Baptism`); Believe (ID: `keyterm:Believe`); Watch-Tower (ID: `realia:Watch-tower`); Winepress (ID: `realia:Winepress`); Temple (ID: `realia:Temple`); Cornerstone (ID: `realia:Cornerstone`); Thorn Hedge (ID: `realia:ThornHedge`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Tiberio (ID: `person:Tiberius`); Resurrection (ID: `keyterm:Resurrection`); Musa (ID: `person:Moses`); Yesu (ID: `person:Jesus.2`); Herodians (ID: `group:Herodian`); Hypocrisy (ID: `keyterm:Hypocrisy`); Written (ID: `keyterm:Scripture`); Sky (ID: `keyterm:Heaven`); True (ID: `keyterm:True`); Isaka (ID: `person:Isaac`); Abrahamu (ID: `person:Abraham`); Pharisees (ID: `group:Pharisee`); An Angel (ID: `deity:Angel`); Be Lawful (ID: `keyterm:Lawful`); The Way (ID: `keyterm:TheWay`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); Sadducees (ID: `group:Sadducee`); Life (ID: `keyterm:Life`); Poll Tax (ID: `keyterm:PollTax`); Israeli (ID: `person:Israel`); Denarius (ID: `realia:Denarius`); Brier (ID: `flora:Brier`); Boxthorn (ID: `flora:Boxthorn`)
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Daudi (ID: `person:David`); Yesu (ID: `person:Jesus.2`); Love (ID: `keyterm:Love`); Heart (ID: `keyterm:Heart`); A Priest (ID: `person:GenericPriest`); Commandment (ID: `keyterm:Commandment`); A Scribe (ID: `person:Scribe`); Treasury (ID: `realia:Treasury`); Offering (ID: `keyterm:Offering`); Kingdom (ID: `keyterm:Kingdom`); Mind (ID: `keyterm:Mind.2`); Truth (ID: `keyterm:Truth`); Daily Life (ID: `keyterm:DailyLife`); Pray (ID: `keyterm:Pray`); Roho (ID: `deity:HolySpirit`); Judgment (ID: `keyterm:Judgment`); Surely! (ID: `keyterm:Surely`); Israeli (ID: `person:Israel`); Be a Disciple (ID: `keyterm:Disciple`); Quadrans (ID: `realia:Quadrans`); Lepton (ID: `realia:Lepton`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); Yesu (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); A Group of Disciples (ID: `group:GenericDisciples`); Bear Witness (ID: `keyterm:BearWitness`); Yohana (ID: `person:John.2`); Roho (ID: `deity:HolySpirit`); Salvation (ID: `keyterm:Salvation`); Andrea (ID: `person:Andrew`); Kingdom (ID: `keyterm:Kingdom`); Yakobo (ID: `person:James`); Symbol (ID: `keyterm:Example`); Petro (ID: `person:Peter`); Good News (ID: `keyterm:GoodNews`); Be a Disciple (ID: `keyterm:Disciple`); Proclaim (ID: `keyterm:Proclaim`); Olive Tree (ID: `flora:OliveTree`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Sky (ID: `keyterm:Heaven`); Chosen (ID: `keyterm:Chosen`); BWANA (ID: `deity:Lord`); House (ID: `realia:House`); An Angel (ID: `deity:Angel`); Ability (ID: `keyterm:Ability`); Portent (ID: `keyterm:Portent`); Authority (ID: `keyterm:Authority.2`); To Command (ID: `keyterm:Command`); Abomination of Desolation (ID: `keyterm:AbominationOfDesolation`); Symbol (ID: `keyterm:Example`); Yudea (ID: `place:Judea`); Disaster (ID: `keyterm:Disaster`); Body (ID: `keyterm:Body.3`); Pray (ID: `keyterm:Pray`); Believe (ID: `keyterm:Believe`); Salvation (ID: `keyterm:Salvation`); Parable (ID: `keyterm:Parable`); Yesu (ID: `person:Jesus.2`); Surely! (ID: `keyterm:Surely`); Glory (ID: `keyterm:Glory`); Door (ID: `realia:Door`); Fig (ID: `flora:Fig`); Cloak (ID: `realia:Cloak`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `flora:Myrrh`); Myrrh (ID: `realia:Myrrh`); Simoni (ID: `person:Simon.4`); Bethania (ID: `place:Bethany`); Good News (ID: `keyterm:GoodNews`); Proclaim (ID: `keyterm:Proclaim`); A Group of Disciples (ID: `group:GenericDisciples`); Passover (ID: `keyterm:Passover`); Yuda (ID: `person:Judas.2`); Pure (ID: `keyterm:Pure`); Ability (ID: `keyterm:Ability`); Promise (ID: `keyterm:Promise`); Body (ID: `keyterm:Body.3`); Yesu (ID: `person:Jesus.2`); Surely! (ID: `keyterm:Surely`); Nard (ID: `flora:Nard`); Alabaster Jar (ID: `realia:AlabasterJar`); Oil of Nard (ID: `realia:OilOfNard`); House (ID: `realia:House`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); Passover (ID: `keyterm:Passover`); Yesu (ID: `person:Jesus.2`); Surely! (ID: `keyterm:Surely`); Sheep (ID: `fauna:Lamb`); Blood (ID: `keyterm:Blood`); Offering (ID: `keyterm:Offering`); Bless (ID: `keyterm:Bless`); Kingdom (ID: `keyterm:Kingdom`); Disaster (ID: `keyterm:Disaster`); Covenant (ID: `keyterm:Covenant`); Galilaya (ID: `place:Galilee`); BWANA (ID: `deity:Lord`); Body (ID: `keyterm:Body.3`); Resurrection (ID: `keyterm:Resurrection`); Petro (ID: `person:Peter`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); Clay Jar (ID: `realia:ClayJar`); Bowl (ID: `realia:Bowl.2`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Olive Tree (ID: `flora:OliveTree`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); Petro (ID: `person:Peter`); Linen (ID: `realia:Linen`); Gethsemane (ID: `place:Gethsemane`); Name (ID: `keyterm:Name`); Written (ID: `keyterm:Scripture`); To Cause to Happen (ID: `keyterm:Happen`); Yohana (ID: `person:John.2`); Body (ID: `keyterm:Body.3`); Yesu (ID: `person:Jesus.2`); Yuda (ID: `person:Judas.2`); Yakobo (ID: `person:James`); BWANA (ID: `deity:Lord`); Put to the Test (ID: `keyterm:PutToTheTest`); Be a Disciple (ID: `keyterm:Disciple`); Spirit (ID: `keyterm:Spirit.2`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Bear Witness (ID: `keyterm:BearWitness`); Sky (ID: `keyterm:Heaven`); Blaspheme (ID: `keyterm:Blaspheme`); Witness (ID: `keyterm:Witness`); Speak as a Prophet (ID: `keyterm:Speak`); Ability (ID: `keyterm:Ability`); Condemn (ID: `keyterm:Condemn`); Petro (ID: `person:Peter`); Temple (ID: `realia:Temple`); Clothing (ID: `realia:Clothing`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Petro (ID: `person:Peter`); Yesu (ID: `person:Jesus.2`); Rooster (ID: `fauna:Rooster`); Galileans (ID: `group:Galilee`); Nazareti (ID: `place:Nazareth`); Galilaya (ID: `place:Galilee`); True (ID: `keyterm:True`); Word (ID: `keyterm:Word`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Pilato (ID: `person:Pilate`); Baraba (ID: `person:Barabbas`); Yesu (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Cross (ID: `realia:Cross`); A Group of People (ID: `group:GenericGroup`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Yesu (ID: `person:Jesus.2`); Eliya (ID: `person:Elijah`); Salvation (ID: `keyterm:Salvation`); Jews (ID: `group:Jews`); Purple Cloth (ID: `realia:PurpleCloth`); Clothing (ID: `realia:Clothing`); Temple (ID: `realia:Temple`); Reed (ID: `flora:Reed`); Centurion at Crucifixion (ID: `person:Centurion.3`); Iskanda (ID: `person:Alexander`); Rufo (ID: `person:Rufus`); Mkirene (ID: `place:Cyrene`); Simoni (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); Priests (ID: `group:GenericPriests`); Blaspheme (ID: `keyterm:Blaspheme`); True (ID: `keyterm:True`); Religious Officials (ID: `group:ReligiousOfficials`); Elders (ID: `group:GenericElders`); Bow Down (ID: `keyterm:BowDown`); A Group of People (ID: `group:GenericGroup`); BWANA (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Israeli (ID: `person:Israel`); Palace (ID: `realia:Palace`); Myrrh (ID: `flora:Myrrh`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Crown (ID: `realia:Crown.2`); Brier (ID: `flora:Brier`); Sour Wine (ID: `realia:SourWine`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Crown (ID: `realia:Crown`); Lot (ID: `realia:Lot`); Courtyard (ID: `realia:Courtyard`); Curtain (ID: `realia:Curtain`)
...
* **Associated ACAI Concepts:** Yusufu (ID: `person:Joseph.6`); Mariamu (ID: `person:Mary.2`); Pilato (ID: `person:Pilate`); Mariamu (ID: `person:Marymagdalene`); Yakobo (ID: `person:James.4`); Arimathaya (ID: `place:Arimathea`); Yusufu (ID: `person:Joseph.3`); Salome (ID: `person:Salome`); Yusufu (ID: `person:Joseph.5`); Kingdom (ID: `keyterm:Kingdom`); Yerusalemu (ID: `place:Jerusalem`); Galilaya (ID: `place:Galilee`); BWANA (ID: `deity:Lord`); Body (ID: `keyterm:Body.3`); Day Before the Sabbath (ID: `keyterm:DayBeforeTheSabbath`); Yesu (ID: `person:Jesus.2`); Serve (ID: `keyterm:Serve`); Linen (ID: `realia:Linen`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Angels (ID: `group:Angels`); Salome (ID: `person:Salome`); Mariamu (ID: `person:Mary.2`); To Command (ID: `keyterm:Command`); Imperishable (ID: `keyterm:Imperishable`); Fear (ID: `keyterm:Fear`); Nazareti (ID: `place:Nazareth`); Galilaya (ID: `place:Galilee`); Yakobo (ID: `person:James.3`); Resurrection (ID: `keyterm:Resurrection`); Salvation (ID: `keyterm:Salvation`); Week (ID: `keyterm:Week`); Yesu (ID: `person:Jesus.2`); Sabbath (ID: `keyterm:Sabbath`); Surely! (ID: `keyterm:Surely`); Anointed (ID: `keyterm:Anointed`); Mariamu (ID: `person:Marymagdalene`); Petro (ID: `person:Peter`); Be a Disciple (ID: `keyterm:Disciple`); Cross (ID: `realia:Cross`); Cloak (ID: `realia:Cloak`); Aloes (ID: `realia:Aloes`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Disbelieve (ID: `keyterm:Disbelieve`); Symbol (ID: `keyterm:Example`); Proclaim (ID: `keyterm:Proclaim`); Demons (ID: `deity:Demons`); Yesu (ID: `person:Jesus.2`); Sky (ID: `keyterm:Heaven`); Good News (ID: `keyterm:GoodNews`); Hardheartedness (ID: `keyterm:Hardheartedness`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Condemn (ID: `keyterm:Condemn`); BWANA (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Resurrection (ID: `keyterm:Resurrection`); Baptism (ID: `keyterm:Baptism`); Salvation (ID: `keyterm:Salvation`); Week (ID: `keyterm:Week`); Mariamu (ID: `person:Marymagdalene`); Snake (ID: `fauna:Snake`)
