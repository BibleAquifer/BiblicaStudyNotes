...
* **Associated Passages:** Waefeso 1:1-14
* **Associated Articles:** Familia ya Mungu (ID: `367536@BiblicaStudyNotesKeyTerms`); Mwamini (ID: `367568@BiblicaStudyNotesKeyTerms`); Kristo (ID: `367589@BiblicaStudyNotesKeyTerms`); Paulo (ID: `367593@BiblicaStudyNotesKeyTerms`); Asilisha (ID: `367631@BiblicaStudyNotesKeyTerms`); Bwana Yesu Kristo (ID: `367637@BiblicaStudyNotesKeyTerms`); Baraka za kiroho (ID: `367646@BiblicaStudyNotesKeyTerms`); Dhambi (ID: `367686@BiblicaStudyNotesKeyTerms`); Mungu (ID: `367690@BiblicaStudyNotesKeyTerms`); Mbingu (ID: `367692@BiblicaStudyNotes`); Dunia (ID: `367706@BiblicaStudyNotesKeyTerms`); Yesu (ID: `367710@BiblicaStudyNotesKeyTerms`); Watu wa Mungu (ID: `367793@BiblicaStudyNotesKeyTerms`); Roho Mtakatifu (ID: `367879@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Favor (ID: `keyterm:Favor`); BWANA (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Liberation (ID: `keyterm:Liberation`); In Christ (ID: `keyterm:InChrist`); Ability (ID: `keyterm:Ability`); Holy (ID: `keyterm:Holy`); Love (ID: `keyterm:Love`); Forgive (ID: `keyterm:Forgive`); Efeso (ID: `place:Ephesus`); Heavenly (ID: `keyterm:Heavenly`); Unblemished (ID: `keyterm:Unblemished`); Blood (ID: `keyterm:Blood`); Sky (ID: `keyterm:Heaven`); Hope Previously (ID: `keyterm:HopePreviously`); Good News (ID: `keyterm:GoodNews`); Bless (ID: `keyterm:Bless`); Make Peace (ID: `keyterm:Peace`); Faithfulness (ID: `keyterm:Faithfulness`); Chosen (ID: `keyterm:Chosen`); Truth (ID: `keyterm:Truth`); Promise (ID: `keyterm:Promise`); Believe (ID: `keyterm:Believe`); Roho (ID: `deity:HolySpirit`); Salvation (ID: `keyterm:Salvation`); Paulo (ID: `person:Paul`)
...
* **Associated Passages:** Waefeso 1:15-23
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Believe (ID: `keyterm:Believe`); Holy (ID: `keyterm:Holy`); Heart (ID: `keyterm:Heart`); Authority (ID: `keyterm:Authority.2`); Hope (ID: `keyterm:Hope`); Always (ID: `keyterm:Always`); Name (ID: `keyterm:Name`); Heavenly (ID: `keyterm:Heavenly`); BWANA (ID: `deity:Lord`); Body (ID: `keyterm:Body.3`); Pray (ID: `keyterm:Pray`); Resurrection (ID: `keyterm:Resurrection`); Roho (ID: `deity:HolySpirit`); Church (ID: `keyterm:Church`); Spirit (ID: `keyterm:Spirit.2`); Love (ID: `keyterm:Love`)
...
* **Associated Passages:** Waefeso 2:1-10
...
* **Associated Passages:** Waefeso 2:11-22
...
* **Associated ACAI Concepts:** BWANA (ID: `deity:Lord`); Yesu (ID: `person:Jesus.2`); Make Peace (ID: `keyterm:Peace`); Body (ID: `keyterm:Body.3`); Roho (ID: `deity:HolySpirit`); Holy (ID: `keyterm:Holy`); Reconcile (ID: `keyterm:Reconcile`); Circumcision (ID: `keyterm:Circumcision`); Without God (ID: `keyterm:WithoutGod`); Good News (ID: `keyterm:GoodNews`); Hope (ID: `keyterm:Hope`); In Christ (ID: `keyterm:InChrist`); Commandment (ID: `keyterm:Commandment`); Covenant (ID: `keyterm:Covenant`); Ability (ID: `keyterm:Ability`); Promise (ID: `keyterm:Promise`); Gentiles (ID: `group:Gentile`); Law (ID: `keyterm:Law`); Blood (ID: `keyterm:Blood`); Israeli (ID: `person:Israel`); Cornerstone (ID: `realia:Cornerstone`); Foundation (ID: `realia:Foundation`); Temple (ID: `realia:Temple`); Cross (ID: `realia:Cross`); Thorn Hedge (ID: `realia:ThornHedge`)
...
* **Associated Passages:** Waefeso 3:1-13
...
* **Associated Passages:** Waefeso 3:14-21

* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); BWANA (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Heart (ID: `keyterm:Heart`); In Christ (ID: `keyterm:InChrist`); Believe (ID: `keyterm:Believe`); Sky (ID: `keyterm:Heaven`); Roho (ID: `deity:HolySpirit`); Church (ID: `keyterm:Church`); Surely! (ID: `keyterm:Surely`); Always (ID: `keyterm:Always`); Holy (ID: `keyterm:Holy`)
...
* **Associated Passages:** Waefeso 4:1-16
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Body (ID: `keyterm:Body.3`); Love (ID: `keyterm:Love`); Building Up (ID: `keyterm:BuildingUp`); Believe (ID: `keyterm:Believe`); Roho (ID: `deity:HolySpirit`); Height (ID: `keyterm:Height`); Sky (ID: `keyterm:Heaven`); Ask for (ID: `keyterm:AskFor`); Hope (ID: `keyterm:Hope`); Make Peace (ID: `keyterm:Peace`); Speak the Truth (ID: `keyterm:SpeakTheTruth`); Favor (ID: `keyterm:Favor`); Live (ID: `keyterm:Live.3`); BWANA (ID: `deity:Lord`); Baptism (ID: `keyterm:Baptism`); Holy (ID: `keyterm:Holy`); Serve (ID: `keyterm:Serve`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated Passages:** Waefeso 5:21-6:9
...
* **Associated ACAI Concepts:** Yesu (ID: `person:Jesus.2`); Church (ID: `keyterm:Church`); Body (ID: `keyterm:Body.3`); Fear (ID: `keyterm:Fear`); Love (ID: `keyterm:Love`); Heart (ID: `keyterm:Heart`); To Cleanse (ID: `keyterm:Cleanse.2`); Sky (ID: `keyterm:Heaven`); Obligated (ID: `keyterm:Ought`); Eye-Service (ID: `keyterm:EyeService`); Commandment (ID: `keyterm:Commandment`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Be Enslaved (ID: `keyterm:Serve.2`); Promise (ID: `keyterm:Promise`); BWANA (ID: `deity:Lord`); Unblemished (ID: `keyterm:Unblemished`); Savior (ID: `keyterm:Savior`); Good (ID: `keyterm:Good`); Consecration (ID: `keyterm:Consecration.2`); Holy (ID: `keyterm:Holy`); Partiality (ID: `keyterm:Partiality`); Glorious (ID: `keyterm:Glorious`)
...
* **Associated Passages:** Waefeso 6:10-24
