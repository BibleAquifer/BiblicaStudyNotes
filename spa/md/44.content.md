...
* **Associated ACAI Concepts:** Teófilo (ID: `person:Theophilus`); cielo (ID: `keyterm:Heaven`); galileo (ID: `group:Galilee`); testimonio (ID: `keyterm:Witness`); Judíos (ID: `place:Judea`); promesa (ID: `keyterm:Promise`)
...
* **Associated ACAI Concepts:** Matías (ID: `person:Matthias`); José (ID: `person:Joseph.9`); Half a Mile (ID: `realia:HalfAMile`); orar (ID: `keyterm:Pray`); Simón (ID: `person:Simon.2`); Bartolomé (ID: `person:Bartholomew`); Akeldama (ID: `place:Akeldama`); Alfeo (ID: `person:Alphaeus`); Jacobo (ID: `person:James.2`); las (ID: `place:OlivesMount`); Upstairs Room (ID: `realia:UpstairsRoom`); Lot (ID: `realia:Lot`); Tomás (ID: `person:Thomas`); Andrés (ID: `person:Andrew`); María (ID: `person:Mary`)
...
* **Associated ACAI Concepts:** Sweet Wine (ID: `realia:SweetWine`); Parthians (ID: `group:Parthians`); Capadocia (ID: `place:Cappadocia`); Almón-diblataim (ID: `group:Elam`); cretenses (ID: `group:Cretan`); Phrygia (ID: `place:Phrygia`); Ponto (ID: `place:Pontus`); Libia (ID: `place:Libya`); Cireneo (ID: `place:Cyrene`); galileo (ID: `group:Galilee`); Elam (ID: `place:Elam`); Medos (ID: `person:Medan`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); hades, mundo de los muertos (ID: `keyterm:WorldOfTheDead`); Joel (ID: `person:Joel.14`); maravilla (ID: `keyterm:Portent`); bautismo (ID: `keyterm:Baptism`); judío (ID: `group:Judea`); invocar (ID: `keyterm:CallUpon`); palabra (ID: `keyterm:Word`); convertirse (ID: `keyterm:Repent`); levantamiento (ID: `keyterm:Resurrection`); Jesús (ID: `person:Jesus.2`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** pórtico (ID: `place:SolomonsPortico`); Abraham (ID: `person:Abraham`); Porch (ID: `realia:Porch`); To Cause to Happen (ID: `keyterm:Happen`); Samuel (ID: `person:Samuel`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** nombre (ID: `keyterm:Name`); Juan (ID: `person:John.3`); Alejandro (ID: `person:Alexander.2`); salvación (ID: `keyterm:Salvation`); Anás (ID: `person:Annas`); Caifás (ID: `person:Caiaphas`); Cornerstone (ID: `realia:Cornerstone`); saduceo (ID: `group:Sadducee`)
...
* **Associated ACAI Concepts:** de Chipre (ID: `group:Cyprus`); rogar (ID: `keyterm:AskFor`); Bernabé (ID: `person:Barnabas`); Pilato (ID: `person:Pilate`)
...
* **Associated ACAI Concepts:** Ananías (ID: `person:Ananias`); Safira (ID: `person:Sapphira`)
...
* **Associated ACAI Concepts:** Prison (ID: `realia:Prison`); Porch (ID: `realia:Porch`); celo (ID: `keyterm:Resentment`); maravilla (ID: `keyterm:Portent`)
...
* **Associated ACAI Concepts:** Teudas (ID: `person:Theudas`); Judas (ID: `person:Judas.3`); persuadir (ID: `keyterm:Persuade`); Gamaliel (ID: `person:Gamaliel`); salvador (ID: `keyterm:Savior`); testimonio (ID: `keyterm:Witness`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Timón (ID: `person:Timon`); de Antioquía (ID: `group:Antioch`); Prócoro (ID: `person:Prochorus`); Nicolás (ID: `person:Nicolaus`); Nicanor (ID: `person:Nicanor`); Parmenas (ID: `person:Parmenas`); servir (ID: `keyterm:Serve`); Judío de habla griega (ID: `group:Hellenist`); Esteban (ID: `person:Stephen`); Felipe (ID: `person:Philip.4`)
...
* **Associated ACAI Concepts:** Liberto (ID: `group:Freedmen`); Esteban (ID: `person:Stephen`); alejandrino (ID: `group:Alexandria`); Alejandrinos (ID: `place:Alexandria`)
...
* **Associated ACAI Concepts:** Remphan (ID: `deity:Rephan`); José (ID: `person:Joseph.10`); hacer lo malo (ID: `keyterm:ActWickedly`); liberar (ID: `keyterm:Rescue`); Faraón (ID: `person:Pharaoh.4`); Mesopotamia (ID: `place:Mesopotamia`); Hamor (ID: `person:Hamor`); Sichêm (ID: `place:Shechem`); juez (ID: `keyterm:Judge`); Egipto (ID: `place:Egypt`); Moisés (ID: `person:Moses`); Israel (ID: `person:Israel`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Esteban (ID: `person:Stephen`); invocar (ID: `keyterm:CallUpon`)
...
* **Associated ACAI Concepts:** Felipe (ID: `person:Philip.4`); Esteban (ID: `person:Stephen`); Judíos (ID: `place:Judea`); proclamar (ID: `keyterm:Proclaim`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Simón (ID: `person:Simon.8`); Felipe (ID: `person:Philip.4`); Money (ID: `realia:Money`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Felipe (ID: `person:Philip.4`); Chariot (ID: `realia:Chariot`); buena noticia (ID: `keyterm:GoodNews`); cusita (ID: `group:Ethiopia`); Etiopes (ID: `place:Ethiopia`); Asdod (ID: `place:Ashdod`); Gaza (ID: `place:Gaza`)
...
* **Associated ACAI Concepts:** Ananías (ID: `person:Ananias.2`); Damasco (ID: `place:Damascus`); Pablo (ID: `person:Paul`); Judas (ID: `person:Judas.4`); Derecha (ID: `place:Straight`); Tarso (ID: `group:Tarsus`); The Way (ID: `keyterm:TheWay`); nombre (ID: `keyterm:Name`); Jesús (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Damasco (ID: `place:Damascus`); Judío de habla griega (ID: `group:Hellenist`); Tarso (ID: `place:Tarsus`); Basket (ID: `realia:Basket`); Jesús (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Tabita (ID: `person:Tabitha`); Eneas (ID: `person:Aeneas`); Joppe (ID: `place:Joppa`); Simón (ID: `person:Simon.9`); Sharon Plain (ID: `place:Sharon.2`); Pedro (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Italiano (ID: `group:Italy`); Cornelio (ID: `person:Cornelius`); Linen Cloth (ID: `realia:LinenCloth`); Simón (ID: `person:Simon.9`); Housetop (ID: `realia:Housetop`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Cornelio (ID: `person:Cornelius`); Simón (ID: `person:Simon.9`); Pedro (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** testificar solemnemente (ID: `keyterm:Declare`); ungido (ID: `keyterm:Anointed`); dar testimonio (ID: `keyterm:BearWitness`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Linen Cloth (ID: `realia:LinenCloth`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Antioquía (ID: `place:Antioch`); Agabo (ID: `person:Agabus`); Cipro (ID: `place:Cyprus`); de Chipre (ID: `group:Cyprus`); Cristiano (ID: `group:Christ`); Judío de habla griega (ID: `group:Hellenist`); ser discípulo (ID: `keyterm:Disciple`); Fenicia (ID: `place:Phoenicia`); Claudio (ID: `person:Claudius`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod.3`); Rhode (ID: `person:Rhoda`); María (ID: `person:Mary.5`); Chain (ID: `realia:Chain`); Marcos (ID: `person:Mark`); Jacobo (ID: `person:James`); Juan (ID: `person:John.2`); Pedro (ID: `person:Peter`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Bedroom (ID: `realia:Bedroom`); Blasto (ID: `person:Blastus`); Herodes (ID: `person:Herod.3`); de Tiro (ID: `group:Tyre`)
...
* **Associated ACAI Concepts:** Barjesús (ID: `person:Bar-jesus`); Pablo (ID: `person:Paul`); Bernabé (ID: `person:Barnabas`); Seleucia (ID: `place:Seleucia`); Salamina (ID: `place:Salamis`); Manahén (ID: `person:Manaen`); Sergio (ID: `person:SergiusPaulus`); Marcos (ID: `person:Mark`); Papho (ID: `place:Paphos`); Simeón (ID: `person:Simeon.4`); ayunar (ID: `keyterm:Fast`); Antioquía (ID: `place:Antioch`); Herodes (ID: `person:Herod.2`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Perge (ID: `place:Perga`); Papho (ID: `place:Paphos`); Synagogue (ID: `realia:Synagogue`); Antioquía (ID: `place:Antioch.2`); Pamphylia (ID: `place:Pamphylia`); Cis (ID: `person:Kish`); Isaí (ID: `person:Jesse`); Cananeo (ID: `place:Canaan`); Saúl (ID: `person:Saul.2`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** adorar (ID: `keyterm:Worship`); celo (ID: `keyterm:Resentment`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Licaonia (ID: `place:Lycaonia`); Derbe (ID: `place:Derbe`); Listra (ID: `place:Lystra`); Iconio (ID: `place:Iconium`)
...
* **Associated ACAI Concepts:** Júpiter (ID: `deity:Zeus`); Garland (ID: `realia:Garland`); Hermes (ID: `deity:Hermes`); Lycaonians (ID: `group:Lycaonia`); inútil (ID: `keyterm:Worthless`); Do Good (ID: `keyterm:DoGood`)
...
* **Associated ACAI Concepts:** Atalia (ID: `place:Attalia`); Antioquía (ID: `place:Antioch.2`); Iconio (ID: `place:Iconium`); Pisidia (ID: `place:Pisidia`); Perge (ID: `place:Perga`); Derbe (ID: `place:Derbe`); Pamphylia (ID: `place:Pamphylia`); ayunar (ID: `keyterm:Fast`)
...
* **Associated ACAI Concepts:** Judas (ID: `person:Judas.5`); Antioquía (ID: `place:Antioch`); Silas (ID: `person:Silas`); Fenicia (ID: `place:Phoenicia`); Jacobo (ID: `person:James.3`); Yoke (ID: `realia:Yoke`); Judíos (ID: `place:Judea`); Bernabé (ID: `person:Barnabas`); nación; gente (ID: `group:Gentile`); Pablo (ID: `person:Paul`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Marcos (ID: `person:Mark`); Cilicia (ID: `place:Cilicia`)
...
* **Associated ACAI Concepts:** Misia (ID: `place:Mysia`); Listra (ID: `place:Lystra`); Bithynia (ID: `place:Bithynia`); Macedonia (ID: `place:Macedonia`); Phrygia (ID: `place:Phrygia`); Derbe (ID: `place:Derbe`); Troas (ID: `place:Troas`); Galacia (ID: `place:Galatia`); Asia (ID: `place:Asia`); Timoteo (ID: `person:Timothy`)
...
* **Associated ACAI Concepts:** Neápolis (ID: `place:Neapolis`); Samotracia (ID: `place:Samothrace`); Lidia (ID: `person:Lydia`); Tiatira (ID: `place:Thyatira`); Filipos (ID: `place:Philippi`); Macedonia (ID: `place:Macedonia`)
...
* **Associated ACAI Concepts:** Philippian Jailer (ID: `person:PhilippianJailer`); Lidia (ID: `person:Lydia`); Silas (ID: `person:Silas`); creer (ID: `keyterm:Believe`); Torch (ID: `realia:Torch`); Pablo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Jasón (ID: `person:Jason`); Apolonia (ID: `place:Apollonia`); por (ID: `place:Amphipolis`); Berea (ID: `place:Berea`); Tesalonicenses (ID: `place:Thessalonica`); javanita (ID: `group:Greek`); escritura (ID: `keyterm:Scripture`); distinguir (ID: `keyterm:Discern`); Pablo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Areópago (ID: `place:Areopagus`); Atenas (ID: `place:Athens`); un ateniense (ID: `group:Athens`); Estoico; quien se adhiere a la filosofía estoica (ID: `group:Stoic`); epicúreo; seguidor de Epicuro (ID: `group:Epicurean`); fué (ID: `person:Dionysius`); miembro del consejo (ID: `group:Areopagus`); Dámaris (ID: `person:Damaris`); adorar (ID: `keyterm:Worship`); divino (ID: `keyterm:Divine`); decidir (ID: `keyterm:Decided`)
...
* **Associated ACAI Concepts:** Galión (ID: `person:Gallio`); Justo (ID: `person:Justus.2`); Ponto (ID: `group:Pontus`); Judgment Seat (ID: `realia:JudgmentSeat`); Corintios (ID: `place:Corinth`); un corintio (ID: `group:Corinth`); Crispo (ID: `person:Crispus`); Sóstenes (ID: `person:Sosthenes`); adorar (ID: `keyterm:Worship`); Ponto (ID: `place:Pontus`); Priscila (ID: `person:Priscilla`); Aquila (ID: `person:Aquila`); Acaya (ID: `place:Achaia`); Claudio (ID: `person:Claudius`); Roma (ID: `place:Rome`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Aquila (ID: `person:Aquila`); Cencreas (ID: `place:Cenchreae`); alejandrino (ID: `group:Alexandria`); Phrygia (ID: `place:Phrygia`); Alejandrinos (ID: `place:Alexandria`); Galacia (ID: `place:Galatia`); Apolos (ID: `person:Apollos`)
...
* **Associated ACAI Concepts:** Tyranno (ID: `person:Tyrannus`); Apron (ID: `realia:Apron`); Sceva (ID: `person:Sceva`); Lecture Hall (ID: `realia:LectureHall`); Asia (ID: `place:Asia`); Efesios (ID: `place:Ephesus`); Macedonia (ID: `place:Macedonia`); Erasto (ID: `person:Erastus`); Band of Cloth (ID: `realia:BandOfCloth`); Acaya (ID: `place:Achaia`); Demons (ID: `deity:Demons`); Pablo (ID: `person:Paul`); Jesús (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Diana (ID: `deity:Artemis`); Efesio (ID: `group:Ephesus`); Theater (ID: `realia:Theater`); Replica Temple (ID: `realia:ReplicaTemple`); Gayo (ID: `person:Gaius`); Alejandro (ID: `person:Alexander.3`); Demetrio (ID: `person:Demetrius`); Aristarco (ID: `person:Aristarchus`)
...
* **Associated ACAI Concepts:** Second Story (ID: `realia:SecondStory`); Segundo (ID: `person:Secundus`); de Asia (ID: `group:Asia`); Gayo (ID: `person:Gaius.2`); de Berea (ID: `group:Berea`); Bereense (ID: `person:Pyrrhus`); Eutichô (ID: `person:Eutychus`); Troas (ID: `place:Troas`); Sopater (ID: `person:Sopater`); Macedonia (ID: `place:Macedonia`); Trófimo (ID: `person:Trophimus`); Filipos (ID: `place:Philippi`); Tichîco (ID: `person:Tychicus`); semana (ID: `keyterm:Week`); Grecia (ID: `place:Greece`); Window (ID: `realia:Window`)
...
* **Associated ACAI Concepts:** Assón (ID: `place:Assos`); testificar solemnemente (ID: `keyterm:Declare`); Mitilene (ID: `place:Mitylene`); Chîo (ID: `place:Chios`); Samo (ID: `place:Samos`); Mileto (ID: `place:Miletus`); Efesios (ID: `place:Ephesus`); servir como esclavo (ID: `keyterm:Serve.2`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Coos (ID: `place:Cos`); Rhodas (ID: `place:Rhodes`); Pátara (ID: `place:Patara`); consigo (ID: `person:Mnason`); Agabo (ID: `person:Agabus`); Cesarea (ID: `place:Caesarea`); de Chipre (ID: `group:Cyprus`); Fenicia (ID: `place:Phoenicia`); Felipe (ID: `person:Philip.4`); Belt (ID: `realia:Belt`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Step (ID: `realia:Step`); Tarso (ID: `group:Tarsus`); Trófimo (ID: `person:Trophimus`); Tarso (ID: `place:Tarsus`); Cilicia (ID: `place:Cilicia`); Pablo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Pablo (ID: `person:Paul`); Gamaliel (ID: `person:Gamaliel`); Ananías (ID: `person:Ananias.2`)
...
* **Associated ACAI Concepts:** Antipatris (ID: `place:Antipatris`); Félix (ID: `person:Felix`); Lisias (ID: `person:Lysias`); Ananías (ID: `person:Ananias.3`); Roma (ID: `place:Rome`); Palace (ID: `realia:Palace`); tener valor (ID: `keyterm:CheerUp`); Cilicia (ID: `place:Cilicia`); Pablo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Félix (ID: `person:Felix`); Tértulo (ID: `person:Tertullus`); Drusila (ID: `person:Drusilla`); Ananías (ID: `person:Ananias.3`); Lisias (ID: `person:Lysias`); The Way (ID: `keyterm:TheWay`); Festo (ID: `person:Festus`); conciencia (ID: `keyterm:Conscience`); Pablo (ID: `person:Paul`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Festo (ID: `person:Festus`); Agripa (ID: `person:Agrippa`); Cesarea (ID: `place:Caesarea`); Audience Hall (ID: `realia:AudienceHall`); Bernice (ID: `person:Bernice`); Augusto (ID: `person:Augustus`); Claudio (ID: `person:Claudius`); Pablo (ID: `person:Paul`); Jews (ID: `group:Jews`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Agripa (ID: `person:Agrippa`); Festo (ID: `person:Festus`); Bernice (ID: `person:Bernice`); Cristiano (ID: `group:Christ`); liberar (ID: `keyterm:Rescue`); Pablo (ID: `person:Paul`); Jews (ID: `group:Jews`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Anchor (ID: `realia:Anchor`); Ship (ID: `realia:Ship`); Julio (ID: `person:Julius`); Creta (ID: `place:Crete`); Mira (ID: `place:Myra`); ciudad (ID: `place:Lycia`); Sirte (ID: `place:Syrtis`); Gnido (ID: `place:Cnidus`); Buenos (ID: `place:FairHavens`); Clauda (ID: `place:Cauda`); Fathom (ID: `realia:Fathom`); Adriático (ID: `place:AdriaticSea`); Adrumentina (ID: `place:Adramyttium`); Fenice (ID: `place:Phoenix`); Lasea (ID: `place:Lasea`); junto (ID: `place:Salmone`); Italia (ID: `place:Italy`); Rudder (ID: `realia:Rudder`); Sail (ID: `realia:Sail`); Alejandrinos (ID: `place:Alexandria`); Pamphylia (ID: `place:Pamphylia`); Aristarco (ID: `person:Aristarchus`); Augusto (ID: `person:Augustus`); Cilicia (ID: `place:Cilicia`); Asia (ID: `place:Asia`); Sidón (ID: `place:Sidon`); Pablo (ID: `person:Paul`); salvación (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Publio (ID: `person:Publius`); Puteolos (ID: `place:Puteoli`); Tabernas (ID: `place:ForumOfAppius`); Emblem (ID: `realia:Emblem`); Las (ID: `place:ThreeTaverns`); Regio (ID: `place:Rhegium`); Melita (ID: `place:Malta`); Siracusa (ID: `place:Syracuse`); Roma (ID: `place:Rome`); Alejandrinos (ID: `place:Alexandria`)
...
* **Associated ACAI Concepts:** persuadir (ID: `keyterm:Persuade`); Chain (ID: `realia:Chain`)
