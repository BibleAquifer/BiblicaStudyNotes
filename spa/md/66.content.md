...
* **Associated ACAI Concepts:** Patmos (ID: `place:Patmos`); Lampstand (ID: `realia:Lampstand.2`); Pérgamo (ID: `place:Pergamum`); Smirna (ID: `place:Smyrna`); Filadelfia (ID: `place:Philadelphia`); Sardis (ID: `place:Sardis`); Laodicea (ID: `place:Laodicea`); Kiln (ID: `realia:Kiln`); Efesios (ID: `place:Ephesus`)
...
* **Associated ACAI Concepts:** nicolaítas (ID: `group:Nicolaitans`); fué (ID: `person:Antipas`); Pérgamo (ID: `place:Pergamum`); Smirna (ID: `place:Smyrna`); Efesios (ID: `place:Ephesus`); hacer lo malo (ID: `keyterm:ActWickedly`); iglesia (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** Tiatira (ID: `place:Thyatira`); Sardis (ID: `place:Sardis`); prostitución (ID: `keyterm:Fornication`); Clothing (ID: `realia:Clothing`); Jezabel (ID: `person:Jezebel`); Rod (ID: `realia:Rod`); iglesia (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** Eye Salve (ID: `realia:EyeSalve`); Filadelfia (ID: `place:Philadelphia`); Door (ID: `realia:Door`); verdadero (ID: `keyterm:True`); Laodicea (ID: `place:Laodicea`); amistad (ID: `keyterm:Friendship`)
...
* **Associated ACAI Concepts:** Scroll (ID: `realia:Scroll`); Seal (ID: `realia:Seal`); Third Living Creature (ID: `deity:ThirdLivingCreature`); Fourth Living Creature (ID: `deity:FourthLivingCreature`); Second Living Creature (ID: `deity:SecondLivingCreature`); First Living Creature (ID: `deity:FirstLivingCreature`); postrarse (ID: `keyterm:BowDown`); Lion (ID: `fauna:Lion`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Quart (ID: `realia:Quart`); Horse (ID: `fauna:Horse`); Third Living Creature (ID: `deity:ThirdLivingCreature`); Fourth Living Creature (ID: `deity:FourthLivingCreature`); Second Living Creature (ID: `deity:SecondLivingCreature`); First Living Creature (ID: `deity:FirstLivingCreature`); Denarius (ID: `realia:Denarius`); Balance (ID: `realia:Balance`)
...
* **Associated ACAI Concepts:** Issachâr (ID: `person:Issachar`); Zabulón (ID: `person:Zebulun`); Nephtalí (ID: `person:Naphtali`); Rubén (ID: `person:Reuben`); Throne (ID: `realia:Throne`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Censer (ID: `realia:Censer`); Incense (ID: `realia:Incense`)
...
* **Associated ACAI Concepts:** Wormwood (ID: `flora:Wormwood`); Vulture (ID: `fauna:Vulture`); Trumpet (ID: `realia:Trumpet`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** infierno (ID: `deity:Abaddon`); abismo (ID: `keyterm:Abyss`)
...
* **Associated ACAI Concepts:** cielo (ID: `keyterm:Heaven`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Measuring Rod (ID: `realia:MeasuringRod`); Measuring Reed (ID: `realia:MeasuringReed`); testimonio (ID: `keyterm:Witness`)
...
* **Associated ACAI Concepts:** Dragon (ID: `fauna:Dragon`); dar testimonio (ID: `keyterm:BearWitness`); Michâel (ID: `person:Michael.11`); Rod (ID: `realia:Rod`); cielo (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** autoridad (ID: `keyterm:Authority.2`); Leopard (ID: `fauna:Leopard`); Bear (ID: `fauna:Bear`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** irreprochable (ID: `keyterm:Unblemished`); Lyre (ID: `realia:Lyre`)
...
* **Associated ACAI Concepts:** Bowl (ID: `realia:Bowl.2`); Frog (ID: `fauna:Frog`); Talent (ID: `realia:Talent`); Eufrates (ID: `place:Euphrates`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** decreto justo (ID: `keyterm:Regulations`); hacer justicia (ID: `keyterm:GrantJustice`); Linen (ID: `realia:Linen`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** abismo (ID: `keyterm:Abyss`); hades, mundo de los muertos (ID: `keyterm:WorldOfTheDead`); Magog (ID: `place:Magog`); Key (ID: `realia:Key`); Gog (ID: `place:Gog`); Chain (ID: `realia:Chain`)
...
* **Associated ACAI Concepts:** City Wall (ID: `realia:CityWall`); Measuring Rod (ID: `realia:MeasuringRod`); Measuring Reed (ID: `realia:MeasuringReed`); Cubit (ID: `realia:Cubit.2`); Bowl (ID: `realia:Bowl.2`)
...
* **Associated ACAI Concepts:** gloria del señor (ID: `keyterm:Glory`); para la eternidad (ID: `keyterm:Always`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** The Church (ID: `group:GenericChurch`); dichoso (ID: `keyterm:Happy`); amén (ID: `keyterm:Surely`); Scroll (ID: `realia:Scroll`)
