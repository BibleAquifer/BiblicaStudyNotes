...
* **Associated ACAI Concepts:** maravilla (ID: `keyterm:Portent`); testificar solemnemente (ID: `keyterm:Declare`)
...
* **Associated ACAI Concepts:** esclavitud (ID: `keyterm:Slavery`); participar (ID: `keyterm:Partake`); deber (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** elemento (ID: `keyterm:FundamentalPrinciples`); empeño (ID: `keyterm:Eagerness`); distinguir (ID: `keyterm:Discern`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** promesa (ID: `keyterm:Promise`); juramento (ID: `keyterm:Oath`); Anchor (ID: `realia:Anchor`); esperanza (ID: `keyterm:Hope`)
...
* **Associated ACAI Concepts:** Melchîsedec (ID: `person:Melchizedek`); sacerdocio (ID: `keyterm:Priesthood`); Jerusalem (ID: `place:Jerusalem`); ley (ID: `keyterm:Law`); Abraham (ID: `person:Abraham`)
...
* **Associated ACAI Concepts:** servidor público (ID: `keyterm:Servant`); mente (ID: `keyterm:Mind.2`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** The Holy Place (ID: `realia:TheHolyPlace`); Most Holy Place (ID: `realia:MostHolyPlace`); Tabernacle (ID: `realia:Tabernacle`); sangre (ID: `keyterm:Blood`); santo (ID: `keyterm:Holy`); decreto justo (ID: `keyterm:Regulations`); liberación (ID: `keyterm:Liberation`); Goat (ID: `fauna:Goat`); Winged Creature (ID: `realia:WingedCreature`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); contaminación (ID: `keyterm:Defilement`); Aarón (ID: `person:Aaron`); santuario (ID: `place:HolyPlace`); sacerdocio (ID: `keyterm:Priesthood`); pacto (ID: `keyterm:Covenant`); ofrenda (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** conciencia (ID: `keyterm:Conscience`); consagración (ID: `keyterm:Consecration.2`); Most Holy Place (ID: `realia:MostHolyPlace`); Curtain (ID: `realia:Curtain`); lealtad (ID: `keyterm:Faithfulness`); pecar (ID: `keyterm:Sin`); ofrenda (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** celo (ID: `keyterm:Extremely`)
...
* **Associated ACAI Concepts:** Isaac (ID: `person:Isaac`); José (ID: `person:Joseph.10`); ofrenda (ID: `keyterm:Offering`); Abel (ID: `person:Abel`); Henoch (ID: `person:Enoch.2`); Caín (ID: `person:Cain`); Heavenly (ID: `keyterm:Heavenly`); Noé (ID: `person:Noah`); creer (ID: `keyterm:Believe`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Skin (ID: `realia:Skin`); temer (ID: `keyterm:Fear`); Rahab (ID: `person:Rahab`); Faraón (ID: `person:Pharaoh.5`); Barac (ID: `person:Barak`); Jephté (ID: `person:Jephthah`); Samsón (ID: `person:Samson`); Gedeón (ID: `person:Gideon`); Samuel (ID: `person:Samuel`); creer (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** hacer la paz (ID: `keyterm:Peace`); profano (ID: `keyterm:Profane`); Esaú (ID: `person:Esau`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** amor fraternal (ID: `keyterm:LoveForOnesFellowBeliever`); llevar a (ID: `keyterm:BringIn`); para la eternidad (ID: `keyterm:Always`); Jehová (ID: `deity:Lord`)
