...
* **Associated ACAI Concepts:** Juan (ID: `person:John`); bautismo (ID: `keyterm:Baptism`); Jesús (ID: `person:Jesus.2`); buena noticia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); Jehová (ID: `deity:Lord`); Espíritu (ID: `deity:HolySpirit`); Jordán (ID: `place:Jordan`); Zebedeo (ID: `person:Zebedee`); Galilea (ID: `place:Galilee`); cielo (ID: `keyterm:Heaven`); convertirse (ID: `keyterm:Repent`); An Angel (ID: `deity:Angel`); pecar (ID: `keyterm:Sin`); Casting Net (ID: `realia:CastingNet`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Sea of Galilee (ID: `place:GalileeSea`); jornalero (ID: `keyterm:HiredWorker`); Jacobo (ID: `person:James`); perdonar (ID: `keyterm:Forgive`); Juan (ID: `person:John.2`); Judíos (ID: `place:Judea`); Andrés (ID: `person:Andrew`); reino (ID: `keyterm:Kingdom`); Nazaret (ID: `place:Nazareth`); Isaías (ID: `person:Isaiah`); Jerusalem (ID: `place:Jerusalem`); tentar (ID: `keyterm:PutToTheTest`); Satanás (ID: `deity:Satan`); amado (ID: `keyterm:Beloved`); rectitud (ID: `keyterm:Straightness`); creer (ID: `keyterm:Believe`); Pedro (ID: `person:Peter`); servir (ID: `keyterm:Serve`); Strap (ID: `realia:Strap`); Locust (ID: `fauna:Locust`); Leather (ID: `realia:Leather`); Belt (ID: `realia:Belt`); Camel (ID: `fauna:Camel`); Bag (ID: `realia:Bag`); Bee (ID: `fauna:Bee`); Dove (ID: `fauna:Dove`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** purificarse (ID: `keyterm:Cleanse.2`); Synagogue (ID: `realia:Synagogue`); proclamar (ID: `keyterm:Proclaim`); Pedro (ID: `person:Peter`); Galilea (ID: `place:Galilee`); autoridad (ID: `keyterm:Authority.2`); Demons (ID: `deity:Demons`); Ability (ID: `keyterm:Ability`); Jesús (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); Capernaum (ID: `place:Capernaum`); dar testimonio (ID: `keyterm:BearWitness`); ofrenda (ID: `keyterm:Offering`); rogar (ID: `keyterm:AskFor`); estar endemoniado (ID: `keyterm:DemonPossessed`); mandar (ID: `keyterm:Command`); Juan (ID: `person:John.2`); Andrés (ID: `person:Andrew`); Nazaret (ID: `place:Nazareth`); Moisés (ID: `person:Moses`); Jehová (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); sábado (ID: `keyterm:Sabbath`); Jacobo (ID: `person:James`); santo (ID: `keyterm:Holy`); enfermedad infecciosa de la piel (ID: `keyterm:InfectiousSkinDisease`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); perdonar (ID: `keyterm:Forgive`); pecar (ID: `keyterm:Sin`); Bed (ID: `realia:Bed`); ayunar (ID: `keyterm:Fast`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); corazón (ID: `keyterm:Heart`); fariseo (ID: `group:Pharisee`); Jehová (ID: `deity:Lord`); recaudador de impuestos (ID: `keyterm:TaxCollector`); Temple (ID: `realia:Temple`); Mateo (ID: `person:Matthew`); Capernaum (ID: `place:Capernaum`); Alfeo (ID: `person:Alphaeus.2`); autoridad (ID: `keyterm:Authority.2`); gloria del señor (ID: `keyterm:Glory`); Be Healthy (ID: `keyterm:Healthy`); ser justo (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); Ability (ID: `keyterm:Ability`); oficina de impuestos (ID: `keyterm:TaxOffice`); creer (ID: `keyterm:Believe`); espíritu (ID: `keyterm:Spirit.2`); Juan (ID: `person:John`); Patch (ID: `realia:Patch`); Skin-Bottle (ID: `realia:Skin-bottle`); Housetop (ID: `realia:Housetop`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Must (ID: `realia:Must`)
...
* **Associated ACAI Concepts:** sábado (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); fariseo (ID: `group:Pharisee`); los seguidores de Herodes; Herodianos (ID: `group:Herodian`); Abiathar (ID: `person:Abiathar`); corazón (ID: `keyterm:Heart`); salvación (ID: `keyterm:Salvation`); David (ID: `person:David`); Jehová (ID: `deity:Lord`); ser discípulo (ID: `keyterm:Disciple`); Life (ID: `keyterm:Life`); servir (ID: `keyterm:Serve`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** nombre (ID: `keyterm:Name`); ser discípulo (ID: `keyterm:Disciple`); Bartolomé (ID: `person:Bartholomew`); Alfeo (ID: `person:Alphaeus`); Idumea (ID: `place:Idumea`); Juan (ID: `person:John.2`); Celador (ID: `group:Zealot`); Jacobo (ID: `person:James.2`); Jacobo (ID: `person:James`); autoridad (ID: `keyterm:Authority.2`); mandar (ID: `keyterm:Command`); Zebedeo (ID: `person:Zebedee`); proclamar (ID: `keyterm:Proclaim`); Judíos (ID: `place:Judea`); Andrés (ID: `person:Andrew`); Judas (ID: `person:Judas.2`); Demons (ID: `deity:Demons`); Jerusalem (ID: `place:Jerusalem`); Galilea (ID: `place:Galilee`); Ability (ID: `keyterm:Ability`); Tomás (ID: `person:Thomas`); Mateo (ID: `person:Matthew`); Judas (ID: `person:Judas`); Sidón (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); Jesús (ID: `person:Jesus.2`); Jordán (ID: `place:Jordan`); Simón (ID: `person:Simon.2`); Felipe (ID: `person:Philip`); Pedro (ID: `person:Peter`); servir (ID: `keyterm:Serve`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Satanás (ID: `deity:Satan`); blasfemar (ID: `keyterm:Blaspheme`); perdonar (ID: `keyterm:Forgive`); pecar (ID: `keyterm:Sin`); House (ID: `realia:House`); Espíritu (ID: `deity:HolySpirit`); parábola (ID: `keyterm:Parable`); reino (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); amén (ID: `keyterm:Surely`); Jehová (ID: `deity:Lord`); para la eternidad (ID: `keyterm:Always`); Jerusalem (ID: `place:Jerusalem`); Religious Officials (ID: `group:ReligiousOfficials`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** parábola (ID: `keyterm:Parable`); Grain (ID: `flora:Grain`); reino (ID: `keyterm:Kingdom`); Jehová (ID: `deity:Lord`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Grass (ID: `flora:Grass`); Barley (ID: `flora:Barley`); cielo (ID: `keyterm:Heaven`); rogar (ID: `keyterm:AskFor`); perdonar (ID: `keyterm:Forgive`); para la eternidad (ID: `keyterm:Always`); Satanás (ID: `deity:Satan`); Ability (ID: `keyterm:Ability`); Cause of Joy (ID: `keyterm:CauseOfJoy`); ser discípulo (ID: `keyterm:Disciple`); Mustard (ID: `flora:Mustard`); Wheat (ID: `flora:Wheat`); Lampstand (ID: `realia:Lampstand.2`); Sickle (ID: `realia:Sickle`); Bird (ID: `fauna:Bird`); Ship (ID: `realia:Ship`); Bed (ID: `realia:Bed`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); Jesús (ID: `person:Jesus.2`); estar endemoniado (ID: `keyterm:DemonPossessed`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); Ship (ID: `realia:Ship`); Grave (ID: `realia:Grave`); temer (ID: `keyterm:Fear`); Jehová (ID: `deity:Lord`); Chain (ID: `realia:Chain`); mandar (ID: `keyterm:Command`); Legión (ID: `deity:Legion`); Gerasa (ID: `place:Gerasa`); Decápolis (ID: `place:Decapolis`); autoridad (ID: `keyterm:Authority.2`); proclamar (ID: `keyterm:Proclaim`); callar (ID: `keyterm:BecomeStill`); misericordia (ID: `keyterm:Mercy`); nombre (ID: `keyterm:Name`); postrarse (ID: `keyterm:BowDown`); creer (ID: `keyterm:Believe`); Fetter (ID: `realia:Fetter`); Cushion (ID: `realia:Cushion`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); salvación (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`); temer (ID: `keyterm:Fear`); creer (ID: `keyterm:Believe`); Jairo (ID: `person:Jairus`); rogar (ID: `keyterm:AskFor`); Juan (ID: `person:John.2`); A Group of Disciples (ID: `group:GenericDisciples`); hacer la paz (ID: `keyterm:Peace`); nombre (ID: `keyterm:Name`); fidelidad (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); cuerpo (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); sangre (ID: `keyterm:Blood`); Jacobo (ID: `person:James`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); servir (ID: `keyterm:Serve`); JUDAS (ID: `person:Jude`); Simón (ID: `person:Simon.3`); no creer (ID: `keyterm:Disbelieve`); José (ID: `person:Joseph.3`); dar testimonio (ID: `keyterm:BearWitness`); autoridad (ID: `keyterm:Authority.2`); convertirse (ID: `keyterm:Repent`); proclamar (ID: `keyterm:Proclaim`); Demons (ID: `deity:Demons`); Jacobo (ID: `person:James.3`); María (ID: `person:Mary`); Jesús (ID: `person:Jesus.2`); sábado (ID: `keyterm:Sabbath`); ungido (ID: `keyterm:Anointed`); ser discípulo (ID: `keyterm:Disciple`); Staff (ID: `realia:Staff`); House (ID: `realia:House`); Belt (ID: `realia:Belt`); Synagogue (ID: `realia:Synagogue`); Tunic (ID: `realia:Tunic.2`); Bag (ID: `realia:Bag`); Sandal (ID: `realia:Sandal`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod.2`); Juan (ID: `person:John`); Herodías (ID: `person:Herodias`); levantamiento (ID: `keyterm:Resurrection`); bautismo (ID: `keyterm:Baptism`); Plate (ID: `realia:Plate.2`); Prison (ID: `realia:Prison`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Felipe (ID: `person:Philip.2`); juramento (ID: `keyterm:Oath`); prontitud (ID: `keyterm:Haste`); Elías (ID: `person:Elijah`); temer (ID: `keyterm:Fear`); reino (ID: `keyterm:Kingdom`); ser justo (ID: `keyterm:Just`); Be Lawful (ID: `keyterm:Lawful`); Galilea (ID: `place:Galilee`); nombre (ID: `keyterm:Name`); bautista (ID: `keyterm:Baptist`); Ability (ID: `keyterm:Ability`); A Group of People (ID: `group:GenericGroup`); santo (ID: `keyterm:Holy`); ser discípulo (ID: `keyterm:Disciple`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Fish (ID: `fauna:Fish`); ser discípulo (ID: `keyterm:Disciple`); entrañas (ID: `keyterm:Affection`); A Group of Disciples (ID: `group:GenericDisciples`); cielo (ID: `keyterm:Heaven`); Jesús (ID: `person:Jesus.2`); bendecir (ID: `keyterm:Bless`); Basket (ID: `realia:Basket`); Ship (ID: `realia:Ship`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`); Sheep (ID: `fauna:Lamb`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); Genezaret (ID: `place:Gennesaret`); Bethsaida (ID: `place:Bethsaida`); corazón (ID: `keyterm:Heart`); rogar (ID: `keyterm:AskFor`); temer (ID: `keyterm:Fear`); salvación (ID: `keyterm:Salvation`); tener valor (ID: `keyterm:CheerUp`); orar (ID: `keyterm:Pray`); ser discípulo (ID: `keyterm:Disciple`); Tassel (ID: `realia:Tassel`); Bed (ID: `realia:Bed`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** contaminación (ID: `keyterm:Defilement`); tradición (ID: `keyterm:Teaching`); fariseo (ID: `group:Pharisee`); corazón (ID: `keyterm:Heart`); Jehová (ID: `deity:Lord`); ser discípulo (ID: `keyterm:Disciple`); mandamiento (ID: `keyterm:Commandment`); Corbán (ID: `place:Corban`); purificarse (ID: `keyterm:Cleanse.2`); ofrenda (ID: `keyterm:Offering`); blasfemar (ID: `keyterm:Blaspheme`); adorar (ID: `keyterm:Worship`); Isaías (ID: `person:Isaiah`); Jerusalem (ID: `place:Jerusalem`); Religious Officials (ID: `group:ReligiousOfficials`); andar (ID: `keyterm:Live.3`); prostitución (ID: `keyterm:Fornication`); Moisés (ID: `person:Moses`); bautismo (ID: `keyterm:Baptism`); parábola (ID: `keyterm:Parable`); profetizar (ID: `keyterm:Speak`); Jews (ID: `group:Jews`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Bed (ID: `realia:Bed`); Cooking Pot (ID: `realia:CookingPot`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); Tiro (ID: `place:Tyre`); rogar (ID: `keyterm:AskFor`); House (ID: `realia:House`); Dog (ID: `fauna:Dog`); Fenicia (ID: `place:Phoenicia`); Decápolis (ID: `place:Decapolis`); mujer sirofenicia (ID: `group:Phoenicia`); javanita (ID: `group:Greek`); Sidón (ID: `place:Sidon`); cielo (ID: `keyterm:Heaven`); bueno (ID: `keyterm:Honest`); Griegos (ID: `person:Javan`); proclamar (ID: `keyterm:Proclaim`); Sea of Galilee (ID: `place:GalileeSea`); Temple (ID: `realia:Temple`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Basket (ID: `realia:Basket`); A Group of Disciples (ID: `group:GenericDisciples`); fariseo (ID: `group:Pharisee`); señal (ID: `keyterm:Example`); Ship (ID: `realia:Ship`); Magdalá (ID: `place:Magadan`); cielo (ID: `keyterm:Heaven`); entrañas (ID: `keyterm:Affection`); rogar (ID: `keyterm:AskFor`); corazón (ID: `keyterm:Heart`); amén (ID: `keyterm:Surely`); Herodes (ID: `person:Herod.2`); espíritu (ID: `keyterm:Spirit.2`); bendecir (ID: `keyterm:Bless`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); bautista (ID: `keyterm:Baptist`); Filipo (ID: `place:CaesareaPhilippi`); Bethsaida (ID: `place:Bethsaida`); Elías (ID: `person:Elijah`); rogar (ID: `keyterm:AskFor`); mandar (ID: `keyterm:Command`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Juan (ID: `person:John`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Ability (ID: `keyterm:Ability`); mandar (ID: `keyterm:Command`); ser discípulo (ID: `keyterm:Disciple`); Pedro (ID: `person:Peter`); salvación (ID: `keyterm:Salvation`); Satanás (ID: `deity:Satan`); reino (ID: `keyterm:Kingdom`); desechar (ID: `keyterm:Reject`); pensar (ID: `keyterm:Think`); amén (ID: `keyterm:Surely`); An Angel (ID: `deity:Angel`); santo (ID: `keyterm:Holy`); buena noticia (ID: `keyterm:GoodNews`); gloria del señor (ID: `keyterm:Glory`); arriba (ID: `keyterm:Unfaithful`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Elías (ID: `person:Elijah`); Jesús (ID: `person:Jesus.2`); Moisés (ID: `person:Moses`); Pedro (ID: `person:Peter`); amado (ID: `keyterm:Beloved`); Jacobo (ID: `person:James`); Juan (ID: `person:John.2`); Tent (ID: `realia:Tent`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** A Father (ID: `person:GenericFather`); Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); creer (ID: `keyterm:Believe`); A Group of Disciples (ID: `group:GenericDisciples`); entrañas (ID: `keyterm:Affection`); mandar (ID: `keyterm:Command`); no creer (ID: `keyterm:Disbelieve`); A Group of People (ID: `group:GenericGroup`); orar (ID: `keyterm:Pray`); arriba (ID: `keyterm:Unfaithful`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** nombre (ID: `keyterm:Name`); Capernaum (ID: `place:Capernaum`); temer (ID: `keyterm:Fear`); Galilea (ID: `place:Galilee`); ser discípulo (ID: `keyterm:Disciple`); palabra (ID: `keyterm:Word`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** hacer tropezar (ID: `keyterm:CauseToStumble`); nombre (ID: `keyterm:Name`); Hell (ID: `place:Hell`); gehenna (ID: `keyterm:Gehenna`); Jesús (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); creer (ID: `keyterm:Believe`); reino (ID: `keyterm:Kingdom`); Ability (ID: `keyterm:Ability`); Demons (ID: `deity:Demons`); amén (ID: `keyterm:Surely`); Jehová (ID: `deity:Lord`); vivir en paz (ID: `keyterm:AtPeace`); Juan (ID: `person:John.2`); Worm (ID: `fauna:Maggot`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`); Jesús (ID: `person:Jesus.2`); mandar (ID: `keyterm:Command`); Moisés (ID: `person:Moses`); prostitución (ID: `keyterm:Fornication`); ser discípulo (ID: `keyterm:Disciple`); Judíos (ID: `place:Judea`); mandamiento (ID: `keyterm:Commandment`); Jordán (ID: `place:Jordan`); amén (ID: `keyterm:Surely`); dureza de corazón (ID: `keyterm:Hardheartedness`); Be Lawful (ID: `keyterm:Lawful`); cuerpo (ID: `keyterm:Body.3`); bendecir (ID: `keyterm:Bless`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Jehová (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`); Rich Young Ruler (ID: `person:RichYoungRuler`); para la eternidad (ID: `keyterm:Always`); Life (ID: `keyterm:Life`); Good (ID: `keyterm:Good`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); cielo (ID: `keyterm:Heaven`); buena noticia (ID: `keyterm:GoodNews`); mandamiento (ID: `keyterm:Commandment`); Ability (ID: `keyterm:Ability`); prostitución (ID: `keyterm:Fornication`); salvación (ID: `keyterm:Salvation`); amén (ID: `keyterm:Surely`); Pedro (ID: `person:Peter`); amar (ID: `keyterm:Love`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Jacobo (ID: `person:James`); bautismo (ID: `keyterm:Baptism`); Jerusalem (ID: `place:Jerusalem`); nación; gente (ID: `group:Gentile`); Juan (ID: `person:John.2`); autoridad (ID: `keyterm:Authority.2`); temer (ID: `keyterm:Fear`); condenar (ID: `keyterm:Condemn`); rescate (ID: `keyterm:Ransom`); Zebedeo (ID: `person:Zebedee`); Life (ID: `keyterm:Life`); gloria del señor (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); David (ID: `person:David`); A Group of People (ID: `group:GenericGroup`); misericordia (ID: `keyterm:Mercy`); Bartimeo (ID: `person:Bartimaeus`); Timeo (ID: `person:Timaeus`); creer (ID: `keyterm:Believe`); salvación (ID: `keyterm:Salvation`); Jericó (ID: `place:Jericho`); tener valor (ID: `keyterm:CheerUp`); mandar (ID: `keyterm:Command`); ser discípulo (ID: `keyterm:Disciple`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Donkey (ID: `fauna:Donkey`); Jesús (ID: `person:Jesus.2`); Bethania (ID: `place:Bethany`); hosana (ID: `keyterm:Hosanna`); Jerusalem (ID: `place:Jerusalem`); A Group of People (ID: `group:GenericGroup`); bendecir (ID: `keyterm:Bless`); Cloak (ID: `realia:Cloak`); Bethfagé (ID: `place:Bethphage`); nombre (ID: `keyterm:Name`); altura (ID: `keyterm:Height`); reino (ID: `keyterm:Kingdom`); David (ID: `person:David`); Jehová (ID: `deity:Lord`); ser discípulo (ID: `keyterm:Disciple`); Rush (ID: `flora:Rush`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); creer (ID: `keyterm:Believe`); Temple (ID: `realia:Temple`); Fig (ID: `flora:Fig`); Jehová (ID: `deity:Lord`); corazón (ID: `keyterm:Heart`); cielo (ID: `keyterm:Heaven`); perdonar (ID: `keyterm:Forgive`); temer (ID: `keyterm:Fear`); Jerusalem (ID: `place:Jerusalem`); para la eternidad (ID: `keyterm:Always`); Bethania (ID: `place:Bethany`); distinguir (ID: `keyterm:Discern`); Jesús (ID: `person:Jesus.2`); amén (ID: `keyterm:Surely`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); autoridad (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); cielo (ID: `keyterm:Heaven`); temer (ID: `keyterm:Fear`); parábola (ID: `keyterm:Parable`); Jesús (ID: `person:Jesus.2`); Juan (ID: `person:John`); desechar (ID: `keyterm:Reject`); escritura (ID: `keyterm:Scripture`); Priests (ID: `group:GenericPriests`); Jerusalem (ID: `place:Jerusalem`); Religious Officials (ID: `group:ReligiousOfficials`); Elders (ID: `group:GenericElders`); vacío (ID: `keyterm:Empty`); amado (ID: `keyterm:Beloved`); Jehová (ID: `deity:Lord`); bautismo (ID: `keyterm:Baptism`); creer (ID: `keyterm:Believe`); Watch-Tower (ID: `realia:Watch-tower`); Winepress (ID: `realia:Winepress`); Temple (ID: `realia:Temple`); Cornerstone (ID: `realia:Cornerstone`); Thorn Hedge (ID: `realia:ThornHedge`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Tiberio (ID: `person:Tiberius`); levantamiento (ID: `keyterm:Resurrection`); Moisés (ID: `person:Moses`); Jesús (ID: `person:Jesus.2`); los seguidores de Herodes; Herodianos (ID: `group:Herodian`); hipocresía (ID: `keyterm:Hypocrisy`); escritura (ID: `keyterm:Scripture`); cielo (ID: `keyterm:Heaven`); verdadero (ID: `keyterm:True`); Isaac (ID: `person:Isaac`); Abraham (ID: `person:Abraham`); fariseo (ID: `group:Pharisee`); An Angel (ID: `deity:Angel`); Be Lawful (ID: `keyterm:Lawful`); The Way (ID: `keyterm:TheWay`); fidelidad (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); saduceo (ID: `group:Sadducee`); Life (ID: `keyterm:Life`); tributo (ID: `keyterm:PollTax`); Israel (ID: `person:Israel`); Denarius (ID: `realia:Denarius`); Brier (ID: `flora:Brier`); Boxthorn (ID: `flora:Boxthorn`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); David (ID: `person:David`); Jesús (ID: `person:Jesus.2`); amar (ID: `keyterm:Love`); corazón (ID: `keyterm:Heart`); A Priest (ID: `person:GenericPriest`); mandamiento (ID: `keyterm:Commandment`); A Scribe (ID: `person:Scribe`); Treasury (ID: `realia:Treasury`); ofrenda (ID: `keyterm:Offering`); reino (ID: `keyterm:Kingdom`); mente (ID: `keyterm:Mind.2`); fidelidad (ID: `keyterm:Truth`); Daily Life (ID: `keyterm:DailyLife`); orar (ID: `keyterm:Pray`); Espíritu (ID: `deity:HolySpirit`); juicio (ID: `keyterm:Judgment`); amén (ID: `keyterm:Surely`); Israel (ID: `person:Israel`); ser discípulo (ID: `keyterm:Disciple`); Quadrans (ID: `realia:Quadrans`); Lepton (ID: `realia:Lepton`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** nombre (ID: `keyterm:Name`); Jesús (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); A Group of Disciples (ID: `group:GenericDisciples`); dar testimonio (ID: `keyterm:BearWitness`); Juan (ID: `person:John.2`); Espíritu (ID: `deity:HolySpirit`); salvación (ID: `keyterm:Salvation`); Andrés (ID: `person:Andrew`); reino (ID: `keyterm:Kingdom`); Jacobo (ID: `person:James`); señal (ID: `keyterm:Example`); Pedro (ID: `person:Peter`); buena noticia (ID: `keyterm:GoodNews`); ser discípulo (ID: `keyterm:Disciple`); proclamar (ID: `keyterm:Proclaim`); Olive Tree (ID: `flora:OliveTree`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** cielo (ID: `keyterm:Heaven`); escogido (ID: `keyterm:Chosen`); Jehová (ID: `deity:Lord`); House (ID: `realia:House`); An Angel (ID: `deity:Angel`); Ability (ID: `keyterm:Ability`); maravilla (ID: `keyterm:Portent`); autoridad (ID: `keyterm:Authority.2`); mandar (ID: `keyterm:Command`); lo detestable de la devastación (ID: `keyterm:AbominationOfDesolation`); señal (ID: `keyterm:Example`); Judíos (ID: `place:Judea`); Disaster (ID: `keyterm:Disaster`); cuerpo (ID: `keyterm:Body.3`); orar (ID: `keyterm:Pray`); creer (ID: `keyterm:Believe`); salvación (ID: `keyterm:Salvation`); parábola (ID: `keyterm:Parable`); Jesús (ID: `person:Jesus.2`); amén (ID: `keyterm:Surely`); gloria del señor (ID: `keyterm:Glory`); Door (ID: `realia:Door`); Fig (ID: `flora:Fig`); Cloak (ID: `realia:Cloak`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `flora:Myrrh`); Myrrh (ID: `realia:Myrrh`); Simón (ID: `person:Simon.4`); Bethania (ID: `place:Bethany`); buena noticia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); A Group of Disciples (ID: `group:GenericDisciples`); pascua (ID: `keyterm:Passover`); Judas (ID: `person:Judas.2`); puro (ID: `keyterm:Pure`); Ability (ID: `keyterm:Ability`); promesa (ID: `keyterm:Promise`); cuerpo (ID: `keyterm:Body.3`); Jesús (ID: `person:Jesus.2`); amén (ID: `keyterm:Surely`); Nard (ID: `flora:Nard`); Alabaster Jar (ID: `realia:AlabasterJar`); Oil of Nard (ID: `realia:OilOfNard`); House (ID: `realia:House`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); pascua (ID: `keyterm:Passover`); Jesús (ID: `person:Jesus.2`); amén (ID: `keyterm:Surely`); Sheep (ID: `fauna:Lamb`); sangre (ID: `keyterm:Blood`); ofrenda (ID: `keyterm:Offering`); bendecir (ID: `keyterm:Bless`); reino (ID: `keyterm:Kingdom`); Disaster (ID: `keyterm:Disaster`); pacto (ID: `keyterm:Covenant`); Galilea (ID: `place:Galilee`); Jehová (ID: `deity:Lord`); cuerpo (ID: `keyterm:Body.3`); levantamiento (ID: `keyterm:Resurrection`); Pedro (ID: `person:Peter`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); Clay Jar (ID: `realia:ClayJar`); Bowl (ID: `realia:Bowl.2`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Olive Tree (ID: `flora:OliveTree`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); Pedro (ID: `person:Peter`); Linen (ID: `realia:Linen`); Gethsemaní (ID: `place:Gethsemane`); nombre (ID: `keyterm:Name`); escritura (ID: `keyterm:Scripture`); To Cause to Happen (ID: `keyterm:Happen`); Juan (ID: `person:John.2`); cuerpo (ID: `keyterm:Body.3`); Jesús (ID: `person:Jesus.2`); Judas (ID: `person:Judas.2`); Jacobo (ID: `person:James`); Jehová (ID: `deity:Lord`); tentar (ID: `keyterm:PutToTheTest`); ser discípulo (ID: `keyterm:Disciple`); espíritu (ID: `keyterm:Spirit.2`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); dar testimonio (ID: `keyterm:BearWitness`); cielo (ID: `keyterm:Heaven`); blasfemar (ID: `keyterm:Blaspheme`); testimonio (ID: `keyterm:Witness`); profetizar (ID: `keyterm:Speak`); Ability (ID: `keyterm:Ability`); condenar (ID: `keyterm:Condemn`); Pedro (ID: `person:Peter`); Temple (ID: `realia:Temple`); Clothing (ID: `realia:Clothing`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Jesús (ID: `person:Jesus.2`); Rooster (ID: `fauna:Rooster`); galileo (ID: `group:Galilee`); Nazaret (ID: `place:Nazareth`); Galilea (ID: `place:Galilee`); verdadero (ID: `keyterm:True`); palabra (ID: `keyterm:Word`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Jesús (ID: `person:Jesus.2`); Elías (ID: `person:Elijah`); salvación (ID: `keyterm:Salvation`); Jews (ID: `group:Jews`); Purple Cloth (ID: `realia:PurpleCloth`); Clothing (ID: `realia:Clothing`); Temple (ID: `realia:Temple`); Reed (ID: `flora:Reed`); Centurion at Crucifixion (ID: `person:Centurion.3`); Alejandro (ID: `person:Alexander`); Rufo (ID: `person:Rufus`); Cireneo (ID: `place:Cyrene`); Simón (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); Priests (ID: `group:GenericPriests`); blasfemar (ID: `keyterm:Blaspheme`); verdadero (ID: `keyterm:True`); Religious Officials (ID: `group:ReligiousOfficials`); Elders (ID: `group:GenericElders`); postrarse (ID: `keyterm:BowDown`); A Group of People (ID: `group:GenericGroup`); Jehová (ID: `deity:Lord`); creer (ID: `keyterm:Believe`); Israel (ID: `person:Israel`); Palace (ID: `realia:Palace`); Myrrh (ID: `flora:Myrrh`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Crown (ID: `realia:Crown.2`); Brier (ID: `flora:Brier`); Sour Wine (ID: `realia:SourWine`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Crown (ID: `realia:Crown`); Lot (ID: `realia:Lot`); Courtyard (ID: `realia:Courtyard`); Curtain (ID: `realia:Curtain`)
...
* **Associated ACAI Concepts:** José (ID: `person:Joseph.6`); María (ID: `person:Mary.2`); Pilato (ID: `person:Pilate`); María (ID: `person:Marymagdalene`); Jacobo (ID: `person:James.4`); Arimatea (ID: `place:Arimathea`); José (ID: `person:Joseph.3`); Salomé (ID: `person:Salome`); José (ID: `person:Joseph.5`); reino (ID: `keyterm:Kingdom`); Jerusalem (ID: `place:Jerusalem`); Galilea (ID: `place:Galilee`); Jehová (ID: `deity:Lord`); cuerpo (ID: `keyterm:Body.3`); víspera del sábado (ID: `keyterm:DayBeforeTheSabbath`); Jesús (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); Linen (ID: `realia:Linen`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Angels (ID: `group:Angels`); Salomé (ID: `person:Salome`); María (ID: `person:Mary.2`); mandar (ID: `keyterm:Command`); inmortal (ID: `keyterm:Imperishable`); temer (ID: `keyterm:Fear`); Nazaret (ID: `place:Nazareth`); Galilea (ID: `place:Galilee`); Jacobo (ID: `person:James.3`); levantamiento (ID: `keyterm:Resurrection`); salvación (ID: `keyterm:Salvation`); semana (ID: `keyterm:Week`); Jesús (ID: `person:Jesus.2`); sábado (ID: `keyterm:Sabbath`); amén (ID: `keyterm:Surely`); ungido (ID: `keyterm:Anointed`); María (ID: `person:Marymagdalene`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Cross (ID: `realia:Cross`); Cloak (ID: `realia:Cloak`); Aloes (ID: `realia:Aloes`)
...
* **Associated ACAI Concepts:** creer (ID: `keyterm:Believe`); no creer (ID: `keyterm:Disbelieve`); señal (ID: `keyterm:Example`); proclamar (ID: `keyterm:Proclaim`); Demons (ID: `deity:Demons`); Jesús (ID: `person:Jesus.2`); cielo (ID: `keyterm:Heaven`); buena noticia (ID: `keyterm:GoodNews`); dureza de corazón (ID: `keyterm:Hardheartedness`); nombre (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); condenar (ID: `keyterm:Condemn`); Jehová (ID: `deity:Lord`); Life (ID: `keyterm:Life`); levantamiento (ID: `keyterm:Resurrection`); bautismo (ID: `keyterm:Baptism`); salvación (ID: `keyterm:Salvation`); semana (ID: `keyterm:Week`); María (ID: `person:Marymagdalene`); Snake (ID: `fauna:Snake`)
