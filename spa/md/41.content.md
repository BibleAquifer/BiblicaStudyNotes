...
* **Associated ACAI Concepts:** Juan (ID: `person:John`); proclamar (ID: `keyterm:Proclaim`); buena noticia (ID: `keyterm:GoodNews`); Zebedeo (ID: `person:Zebedee`); Galilea (ID: `place:Galilee`); Jordán (ID: `place:Jordan`); Strap (ID: `realia:Strap`); jornalero (ID: `keyterm:HiredWorker`); Sea of Galilee (ID: `place:GalileeSea`); Jacobo (ID: `person:James`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); Galilea (ID: `place:Galilee`); Capernaum (ID: `place:Capernaum`)
...
* **Associated ACAI Concepts:** Alfeo (ID: `person:Alphaeus.2`); Bed (ID: `realia:Bed`); Patch (ID: `realia:Patch`); Mateo (ID: `person:Matthew`); Housetop (ID: `realia:Housetop`); Capernaum (ID: `place:Capernaum`); Skin-Bottle (ID: `realia:Skin-bottle`); Jesús (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Be Lawful (ID: `keyterm:Lawful`); los seguidores de Herodes; Herodianos (ID: `group:Herodian`); Abiathar (ID: `person:Abiathar`); sábado (ID: `keyterm:Sabbath`)
...
* **Associated ACAI Concepts:** Idumea (ID: `place:Idumea`); Celador (ID: `group:Zealot`); Bartolomé (ID: `person:Bartholomew`); Alfeo (ID: `person:Alphaeus`); Jacobo (ID: `person:James.2`); Jacobo (ID: `person:James`); Juan (ID: `person:John.2`)
...
* **Associated ACAI Concepts:** parábola (ID: `keyterm:Parable`); Mustard (ID: `flora:Mustard`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Cushion (ID: `realia:Cushion`); estar endemoniado (ID: `keyterm:DemonPossessed`); Legión (ID: `deity:Legion`); Fetter (ID: `realia:Fetter`); Chain (ID: `realia:Chain`); Decápolis (ID: `place:Decapolis`); Gerasa (ID: `place:Gerasa`); mandar (ID: `keyterm:Command`)
...
* **Associated ACAI Concepts:** José (ID: `person:Joseph.3`); Simón (ID: `person:Simon.3`); JUDAS (ID: `person:Jude`); no creer (ID: `keyterm:Disbelieve`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod.2`); Herodías (ID: `person:Herodias`); Plate (ID: `realia:Plate.2`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Felipe (ID: `person:Philip.2`); Juan (ID: `person:John`)
...
* **Associated ACAI Concepts:** entrañas (ID: `keyterm:Affection`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Genezaret (ID: `place:Gennesaret`); Bethsaida (ID: `place:Bethsaida`)
...
* **Associated ACAI Concepts:** tradición (ID: `keyterm:Teaching`); fariseo (ID: `group:Pharisee`); Corbán (ID: `place:Corban`); contaminación (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** mujer sirofenicia (ID: `group:Phoenicia`); Tiro (ID: `place:Tyre`); Decápolis (ID: `place:Decapolis`); Fenicia (ID: `place:Phoenicia`); javanita (ID: `group:Greek`); Sidón (ID: `place:Sidon`)
...
* **Associated ACAI Concepts:** Filipo (ID: `place:CaesareaPhilippi`); Bethsaida (ID: `place:Bethsaida`); bautista (ID: `keyterm:Baptist`)
...
* **Associated ACAI Concepts:** hacer tropezar (ID: `keyterm:CauseToStumble`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); Jesús (ID: `person:Jesus.2`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Bartimeo (ID: `person:Bartimaeus`); Timeo (ID: `person:Timaeus`); Jesús (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** hosana (ID: `keyterm:Hosanna`); Bethania (ID: `place:Bethany`); Bethfagé (ID: `place:Bethphage`); Rush (ID: `flora:Rush`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** los seguidores de Herodes; Herodianos (ID: `group:Herodian`); Denarius (ID: `realia:Denarius`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `realia:Myrrh`); Simón (ID: `person:Simon.4`); Oil of Nard (ID: `realia:OilOfNard`); Alabaster Jar (ID: `realia:AlabasterJar`); Nard (ID: `flora:Nard`); Bethania (ID: `place:Bethany`)
...
* **Associated ACAI Concepts:** Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); sangre (ID: `keyterm:Blood`)
...
* **Associated ACAI Concepts:** Centurion at Crucifixion (ID: `person:Centurion.3`); Alejandro (ID: `person:Alexander`); Rufo (ID: `person:Rufus`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Simón (ID: `person:Simon.5`); Purple Cloth (ID: `realia:PurpleCloth`); Golgotha (ID: `place:Golgotha`); Palace (ID: `realia:Palace`); Cireneo (ID: `place:Cyrene`); Myrrh (ID: `flora:Myrrh`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** María (ID: `person:Mary.2`); José (ID: `person:Joseph.6`); José (ID: `person:Joseph.3`); José (ID: `person:Joseph.5`); Jacobo (ID: `person:James.4`); Salomé (ID: `person:Salome`); Arimatea (ID: `place:Arimathea`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Salomé (ID: `person:Salome`); Angels (ID: `group:Angels`); María (ID: `person:Mary.2`)
