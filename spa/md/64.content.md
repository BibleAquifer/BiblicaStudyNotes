...
* **Associated ACAI Concepts:** Diótrefes (ID: `person:Diotrephes`); Gayo (ID: `person:Gaius.4`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); Demetrio (ID: `person:Demetrius`); fidelidad (ID: `keyterm:Truth`)
