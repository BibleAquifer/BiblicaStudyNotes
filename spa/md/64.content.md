...
* **Associated Passages:** 3 Juan 1:1-15
...
* **Associated ACAI Concepts:** fidelidad (ID: `keyterm:Truth`); amado (ID: `keyterm:Beloved`); iglesia (ID: `keyterm:Church`); dar testimonio (ID: `keyterm:BearWitness`); amar (ID: `keyterm:Love`); andar (ID: `keyterm:Live.3`); nombre (ID: `keyterm:Name`); Jehová (ID: `deity:Lord`); Diótrefes (ID: `person:Diotrephes`); Gayo (ID: `person:Gaius.4`); Demetrio (ID: `person:Demetrius`); deber (ID: `keyterm:Ought`); Cause of Joy (ID: `keyterm:CauseOfJoy`); verdadero (ID: `keyterm:True`); orar (ID: `keyterm:Pray`); lealtad (ID: `keyterm:Faithfulness`); Good (ID: `keyterm:Good`); Do Good (ID: `keyterm:DoGood`); hacer la paz (ID: `keyterm:Peace`); esperanza (ID: `keyterm:Hope`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); Reed (ID: `flora:Reed`)
