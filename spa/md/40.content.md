...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); David (ID: `person:David`); Abraham (ID: `person:Abraham`); Babilonia (ID: `place:Babylon`); Zorobabel (ID: `person:Zerubbabel.2`); Jacob (ID: `person:Jacob.2`); Azor (ID: `person:Azor`); Eliud (ID: `person:Eliud`); Ezechîas (ID: `person:Hezekiah`); Salmón (ID: `person:Salmon`); Ram (ID: `person:Ram`); Joachîn (ID: `person:Jehoiachin`); Salomón (ID: `person:Solomon`); Josías (ID: `person:Josiah`); Asa (ID: `person:Asa`); Uzzías (ID: `person:Uzziah`); Isaí (ID: `person:Jesse`); Judá (ID: `person:Judah.4`); Eleazar (ID: `person:Eleazar`); José (ID: `person:Joseph.4`); Zera (ID: `person:Zerah.3`); Achîm (ID: `person:Achim`); Mathán (ID: `person:Matthan`); Amón (ID: `person:Amon.3`); Joram (ID: `person:Jehoram`); Nahasón (ID: `person:Nahshon`); Achâz (ID: `person:Ahaz`); Obed (ID: `person:Obed`); Booz (ID: `person:Boaz`); Rahab (ID: `person:Rahab`); Thamar (ID: `person:Tamar`); Aminadab (ID: `person:Amminadab`); Roboam (ID: `person:Rehoboam`); Hesrón (ID: `person:Hezron.2`); Abías (ID: `person:Abijah.4`); Abiud (ID: `person:Abiud`); Isaac (ID: `person:Isaac`); Uría (ID: `person:Uriah`); Josaphat (ID: `person:Jehoshaphat.3`); Israel (ID: `person:Israel`); Phares (ID: `person:Perez`); Sadoc (ID: `person:Zadok`); Jotham (ID: `person:Jotham.2`); Eliacim (ID: `person:Eliakim`); Ruth (ID: `person:Ruth`); María (ID: `person:Mary`); Salathiel (ID: `person:Shealtiel.2`); Manasés (ID: `person:Manasseh.2`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); José (ID: `person:Joseph.4`); Jehová (ID: `deity:Lord`); nombre (ID: `keyterm:Name`); María (ID: `person:Mary`); An Angel (ID: `deity:Angel`); Espíritu (ID: `deity:HolySpirit`); To Cause to Happen (ID: `keyterm:Happen`); David (ID: `person:David`); estar comprometido en matrimonio (ID: `keyterm:Engaged`); salvación (ID: `keyterm:Salvation`); pecar (ID: `keyterm:Sin`); temer (ID: `keyterm:Fear`); ser justo (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod`); Catah (ID: `place:Bethlehem`); Egipto (ID: `place:Egypt`); postrarse (ID: `keyterm:BowDown`); Judíos (ID: `place:Judea`); Jehová (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); Israel (ID: `person:Israel`); José (ID: `person:Joseph.4`); Jerusalem (ID: `place:Jerusalem`); Jesús (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Archelao (ID: `person:Archelaus`); Jeremías (ID: `person:Jeremiah.6`); Nazaret (ID: `place:Nazareth`); Galilea (ID: `place:Galilee`); A Priest (ID: `person:GenericPriest`); María (ID: `person:Mary`); Ramah (ID: `place:Ramah.2`); rogar (ID: `keyterm:AskFor`); Life (ID: `keyterm:Life`); Judá (ID: `person:Judah.4`); temer (ID: `keyterm:Fear`); Priests (ID: `group:GenericPriests`); Religious Officials (ID: `group:ReligiousOfficials`); ofrenda (ID: `keyterm:Offering`); exhortar (ID: `keyterm:Encourage`); Jews (ID: `group:Jews`); Rachêl (ID: `person:Rachel`); Frankincense (ID: `flora:Frankincense`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Money Box (ID: `realia:MoneyBox`); House (ID: `realia:House`); Incense (ID: `realia:Incense`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** bautismo (ID: `keyterm:Baptism`); Jesús (ID: `person:Jesus.2`); cielo (ID: `keyterm:Heaven`); Juan (ID: `person:John`); Jordán (ID: `place:Jordan`); Galilea (ID: `place:Galilee`); amado (ID: `keyterm:Beloved`); Jehová (ID: `deity:Lord`); ser justo (ID: `keyterm:Just`); Espíritu (ID: `deity:HolySpirit`); To Cause to Happen (ID: `keyterm:Happen`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Jesús (ID: `person:Jesus.2`); postrarse (ID: `keyterm:BowDown`); tentar (ID: `keyterm:PutToTheTest`); mandar (ID: `keyterm:Command`); servir (ID: `keyterm:Serve`); An Angel (ID: `deity:Angel`); palabra (ID: `keyterm:Word`); sacerdocio (ID: `keyterm:Priesthood`); gloria del señor (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); ayunar (ID: `keyterm:Fast`); Satanás (ID: `deity:Satan`); Life (ID: `keyterm:Life`); Espíritu (ID: `deity:HolySpirit`); santo (ID: `keyterm:Holy`); reino (ID: `keyterm:Kingdom`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Galilea (ID: `place:Galilee`); Nephtalí (ID: `person:Naphtali`); Zabulón (ID: `person:Zebulun`); Zabulón (ID: `group:Zebulun`); convertirse (ID: `keyterm:Repent`); Nazaret (ID: `place:Nazareth`); proclamar (ID: `keyterm:Proclaim`); Jesús (ID: `person:Jesus.2`); Capernaum (ID: `place:Capernaum`); reino (ID: `keyterm:Kingdom`); Jordán (ID: `place:Jordan`); Isaías (ID: `person:Isaiah`); nación; gente (ID: `group:Gentile`); To Cause to Happen (ID: `keyterm:Happen`); cielo (ID: `keyterm:Heaven`); Juan (ID: `person:John`)
...
* **Associated ACAI Concepts:** Casting Net (ID: `realia:CastingNet`); Galilea (ID: `place:Galilee`); servir (ID: `keyterm:Serve`); Andrés (ID: `person:Andrew`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Juan (ID: `person:John.2`); buena noticia (ID: `keyterm:GoodNews`); Sea of Galilee (ID: `place:GalileeSea`); Zebedeo (ID: `person:Zebedee`); Jacobo (ID: `person:James`); Decápolis (ID: `place:Decapolis`); estar endemoniado (ID: `keyterm:DemonPossessed`); Judíos (ID: `place:Judea`); Jordán (ID: `place:Jordan`); Pedro (ID: `person:Peter`); Jerusalem (ID: `place:Jerusalem`); reino (ID: `keyterm:Kingdom`); proclamar (ID: `keyterm:Proclaim`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** dichoso (ID: `keyterm:Happy`); cielo (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); Jehová (ID: `deity:Lord`); ser justo (ID: `keyterm:Just`); misericordia (ID: `keyterm:Mercy`); corazón (ID: `keyterm:Heart`); ser discípulo (ID: `keyterm:Disciple`); limpio (ID: `keyterm:Clean`); espíritu (ID: `keyterm:Spirit.2`); rogar (ID: `keyterm:AskFor`); exhortar (ID: `keyterm:Encourage`)
...
* **Associated ACAI Concepts:** cielo (ID: `keyterm:Heaven`); ley (ID: `keyterm:Law`); reino (ID: `keyterm:Kingdom`); mandamiento (ID: `keyterm:Commandment`); ser justo (ID: `keyterm:Just`); amén (ID: `keyterm:Surely`); gloria del señor (ID: `keyterm:Glory`); fariseo (ID: `group:Pharisee`); Jehová (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Lampstand (ID: `realia:Lampstand.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); gehenna (ID: `keyterm:Gehenna`); prostitución (ID: `keyterm:Fornication`); Hell (ID: `place:Hell`); amar (ID: `keyterm:Love`); tribunal de justicia (ID: `keyterm:CourtCase`); cielo (ID: `keyterm:Heaven`); cuerpo (ID: `keyterm:Body.3`); juicio (ID: `keyterm:Judgment`); hacer tropezar (ID: `keyterm:CauseToStumble`); ofrenda (ID: `keyterm:Offering`); juramento (ID: `keyterm:Oath`); Good (ID: `keyterm:Good`); reconciliar (ID: `keyterm:Reconcile`); Heavenly (ID: `keyterm:Heavenly`); amén (ID: `keyterm:Surely`); recaudador de impuestos (ID: `keyterm:TaxCollector`); corazón (ID: `keyterm:Heart`); Jerusalem (ID: `place:Jerusalem`); decidir (ID: `keyterm:Decided`); ser justo (ID: `keyterm:Just`); orar (ID: `keyterm:Pray`); Cloak (ID: `realia:Cloak`); Quadrans (ID: `realia:Quadrans`); Footstool (ID: `realia:Footstool`); Mile (ID: `realia:Mile`); Tunic (ID: `realia:Tunic.2`); Throne (ID: `realia:Throne`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); perdonar (ID: `keyterm:Forgive`); cielo (ID: `keyterm:Heaven`); amén (ID: `keyterm:Surely`); Synagogue (ID: `realia:Synagogue`); llevar a (ID: `keyterm:BringIn`); reino (ID: `keyterm:Kingdom`); gloria del señor (ID: `keyterm:Glory`); liberar (ID: `keyterm:Deliver`); amistad (ID: `keyterm:Friendship`); tentar (ID: `keyterm:PutToTheTest`); deuda (ID: `keyterm:Wrong`); ser justo (ID: `keyterm:Just`); Heavenly (ID: `keyterm:Heavenly`); santo (ID: `keyterm:Holy`); nombre (ID: `keyterm:Name`); Inner Room (ID: `realia:InnerRoom`); Trumpet (ID: `realia:Trumpet`); Cornerstone (ID: `realia:Cornerstone`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); ayunar (ID: `keyterm:Fast`); cuerpo (ID: `keyterm:Body.3`); cielo (ID: `keyterm:Heaven`); Heavenly (ID: `keyterm:Heavenly`); Clothing (ID: `realia:Clothing`); Moth (ID: `fauna:Moth`); de poca fe (ID: `keyterm:HavingLittleFaith`); amén (ID: `keyterm:Surely`); gloria del señor (ID: `keyterm:Glory`); amar (ID: `keyterm:Love`); servir como esclavo (ID: `keyterm:Serve.2`); corazón (ID: `keyterm:Heart`); Salomón (ID: `person:Solomon`); ungido (ID: `keyterm:Anointed`); Life (ID: `keyterm:Life`); ser justo (ID: `keyterm:Just`); reino (ID: `keyterm:Kingdom`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Oven (ID: `realia:Oven`); Barn (ID: `realia:Barn`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Beam (ID: `realia:Beam`); decidir (ID: `keyterm:Decided`); santo (ID: `keyterm:Holy`); ley (ID: `keyterm:Law`); Jehová (ID: `deity:Lord`); juicio (ID: `keyterm:Judgment`); cielo (ID: `keyterm:Heaven`); Fish (ID: `fauna:Fish`); Snake (ID: `fauna:Snake`); Jackal (ID: `fauna:Jackal`); Dog (ID: `fauna:Dog`); Pig (ID: `fauna:Pig`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); sin ley (ID: `keyterm:Lawless`); borrar (ID: `keyterm:Destroy`); Ability (ID: `keyterm:Ability`); cielo (ID: `keyterm:Heaven`); Jehová (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Demons (ID: `deity:Demons`); nombre (ID: `keyterm:Name`); reino (ID: `keyterm:Kingdom`); profetizar (ID: `keyterm:Speak`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`); Clothing (ID: `realia:Clothing`); Sheep (ID: `fauna:Lamb`); Wolf (ID: `fauna:Wolf`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); creer (ID: `keyterm:Believe`); purificarse (ID: `keyterm:Cleanse.2`); reino (ID: `keyterm:Kingdom`); Israel (ID: `person:Israel`); House (ID: `realia:House`); estar endemoniado (ID: `keyterm:DemonPossessed`); Centurion With Sick Servant (ID: `person:Centurion.2`); enfermedad infecciosa de la piel (ID: `keyterm:InfectiousSkinDisease`); amén (ID: `keyterm:Surely`); mandar (ID: `keyterm:Command`); dar testimonio (ID: `keyterm:BearWitness`); postrarse (ID: `keyterm:BowDown`); Abraham (ID: `person:Abraham`); Ability (ID: `keyterm:Ability`); cielo (ID: `keyterm:Heaven`); tinieblas de afuera (ID: `keyterm:OuterDarkness`); Capernaum (ID: `place:Capernaum`); Isaías (ID: `person:Isaiah`); Moisés (ID: `person:Moses`); To Cause to Happen (ID: `keyterm:Happen`); Pedro (ID: `person:Peter`); rogar (ID: `keyterm:AskFor`); Isaac (ID: `person:Isaac`); autoridad (ID: `keyterm:Authority.2`); ofrenda (ID: `keyterm:Offering`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); estar endemoniado (ID: `keyterm:DemonPossessed`); ser discípulo (ID: `keyterm:Disciple`); rogar (ID: `keyterm:AskFor`); Ship (ID: `realia:Ship`); de poca fe (ID: `keyterm:HavingLittleFaith`); mandar (ID: `keyterm:Command`); A Disciple (ID: `person:GenericDisciple`); Religious Official (ID: `person:ReligiousOfficial`); salvación (ID: `keyterm:Salvation`); autoridad (ID: `keyterm:Authority.2`); Gerasa (ID: `place:Gerasa`); cielo (ID: `keyterm:Heaven`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); pecar (ID: `keyterm:Sin`); perdonar (ID: `keyterm:Forgive`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); recaudador de impuestos (ID: `keyterm:TaxCollector`); Ability (ID: `keyterm:Ability`); ayunar (ID: `keyterm:Fast`); autoridad (ID: `keyterm:Authority.2`); fariseo (ID: `group:Pharisee`); Bed (ID: `realia:Bed`); Temple (ID: `realia:Temple`); Mateo (ID: `person:Matthew`); misericordia (ID: `keyterm:Mercy`); gloria del señor (ID: `keyterm:Glory`); creer (ID: `keyterm:Believe`); tener valor (ID: `keyterm:CheerUp`); Jehová (ID: `deity:Lord`); corazón (ID: `keyterm:Heart`); Juan (ID: `person:John`); temer (ID: `keyterm:Fear`); ser justo (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); Be Healthy (ID: `keyterm:Healthy`); oficina de impuestos (ID: `keyterm:TaxOffice`); ofrenda (ID: `keyterm:Offering`); blasfemar (ID: `keyterm:Blaspheme`); Must (ID: `realia:Must`); Patch (ID: `realia:Patch`); Skin-Bottle (ID: `realia:Skin-bottle`); Ship (ID: `realia:Ship`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); creer (ID: `keyterm:Believe`); salvación (ID: `keyterm:Salvation`); Demons (ID: `deity:Demons`); ser discípulo (ID: `keyterm:Disciple`); Cloak (ID: `realia:Cloak`); House (ID: `realia:House`); entrañas (ID: `keyterm:Affection`); estar endemoniado (ID: `keyterm:DemonPossessed`); buena noticia (ID: `keyterm:GoodNews`); postrarse (ID: `keyterm:BowDown`); tener valor (ID: `keyterm:CheerUp`); misericordia (ID: `keyterm:Mercy`); Life (ID: `keyterm:Life`); rogar (ID: `keyterm:AskFor`); David (ID: `person:David`); servir (ID: `keyterm:Serve`); fariseo (ID: `group:Pharisee`); reino (ID: `keyterm:Kingdom`); proclamar (ID: `keyterm:Proclaim`); Bleed (ID: `keyterm:Bleed`); Israel (ID: `person:Israel`); Tassel (ID: `realia:Tassel`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Flute (ID: `realia:Flute`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); servir (ID: `keyterm:Serve`); Bag (ID: `realia:Bag`); Bartolomé (ID: `person:Bartholomew`); Tomás (ID: `person:Thomas`); Alfeo (ID: `person:Alphaeus`); Judas (ID: `person:Judas.2`); Jacobo (ID: `person:James.2`); Judas (ID: `person:Judas`); Celador (ID: `group:Zealot`); Simón (ID: `person:Simon.2`); hacer la paz (ID: `keyterm:Peace`); Felipe (ID: `person:Philip`); Mateo (ID: `person:Matthew`); Gomorra (ID: `place:Gomorrah`); Juan (ID: `person:John.2`); amén (ID: `keyterm:Surely`); Samaria (ID: `place:Samaria`); Zebedeo (ID: `person:Zebedee`); Ability (ID: `keyterm:Ability`); recaudador de impuestos (ID: `keyterm:TaxCollector`); cielo (ID: `keyterm:Heaven`); Jacobo (ID: `person:James`); Sodoma (ID: `place:Sodom`); juicio (ID: `keyterm:Judgment`); Pedro (ID: `person:Peter`); Demons (ID: `deity:Demons`); autoridad (ID: `keyterm:Authority.2`); tribunal de justicia (ID: `keyterm:CourtCase`); Simrat (ID: `group:Samaritan`); purificarse (ID: `keyterm:Cleanse.2`); Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); levantamiento (ID: `keyterm:Resurrection`); nombre (ID: `keyterm:Name`); reino (ID: `keyterm:Kingdom`); proclamar (ID: `keyterm:Proclaim`); Andrés (ID: `person:Andrew`); nación; gente (ID: `group:Gentile`); Israel (ID: `person:Israel`); Staff (ID: `realia:Staff`); Belt (ID: `realia:Belt`); Tunic (ID: `realia:Tunic.2`); Sandal (ID: `realia:Sandal`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); temer (ID: `keyterm:Fear`); ser discípulo (ID: `keyterm:Disciple`); nombre (ID: `keyterm:Name`); amén (ID: `keyterm:Surely`); cielo (ID: `keyterm:Heaven`); Sparrow (ID: `fauna:Sparrow`); gehenna (ID: `keyterm:Gehenna`); salvación (ID: `keyterm:Salvation`); mandar (ID: `keyterm:Command`); Hell (ID: `place:Hell`); dar testimonio (ID: `keyterm:BearWitness`); amistad (ID: `keyterm:Friendship`); cuerpo (ID: `keyterm:Body.3`); Satanás (ID: `deity:Satan`); Life (ID: `keyterm:Life`); ser justo (ID: `keyterm:Just`); Espíritu (ID: `deity:HolySpirit`); hacer la paz (ID: `keyterm:Peace`); proclamar (ID: `keyterm:Proclaim`); nación; gente (ID: `group:Gentile`); Israel (ID: `person:Israel`); Assarion (ID: `realia:Assarion`); Wolf (ID: `fauna:Wolf`); Dove (ID: `fauna:Dove`); Sheep (ID: `fauna:Lamb`); Cross (ID: `realia:Cross`); Snake (ID: `fauna:Snake`); Synagogue (ID: `realia:Synagogue`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Juan (ID: `person:John`); Jesús (ID: `person:Jesus.2`); bautista (ID: `keyterm:Baptist`); cielo (ID: `keyterm:Heaven`); ser discípulo (ID: `keyterm:Disciple`); reino (ID: `keyterm:Kingdom`); amén (ID: `keyterm:Surely`); buena noticia (ID: `keyterm:GoodNews`); recaudador de impuestos (ID: `keyterm:TaxCollector`); Elías (ID: `person:Elijah`); Demons (ID: `deity:Demons`); ley (ID: `keyterm:Law`); ser justo (ID: `keyterm:Just`); purificarse (ID: `keyterm:Cleanse.2`); dichoso (ID: `keyterm:Happy`); An Angel (ID: `deity:Angel`); levantamiento (ID: `keyterm:Resurrection`); proclamar (ID: `keyterm:Proclaim`); profetizar (ID: `keyterm:Speak`); Reed (ID: `flora:Reed`); House (ID: `realia:House`); Prison (ID: `realia:Prison`); Flute (ID: `realia:Flute`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Jehová (ID: `deity:Lord`); Tiro (ID: `place:Tyre`); cielo (ID: `keyterm:Heaven`); Sodoma (ID: `place:Sodom`); juicio (ID: `keyterm:Judgment`); convertirse (ID: `keyterm:Repent`); Sidón (ID: `place:Sidon`); tribunal de justicia (ID: `keyterm:CourtCase`); Yoke (ID: `realia:Yoke`); hades, mundo de los muertos (ID: `keyterm:WorldOfTheDead`); Disaster (ID: `keyterm:Disaster`); Corazín (ID: `place:Chorazin`); Bethsaida (ID: `place:Bethsaida`); Hell (ID: `place:Hell`); Capernaum (ID: `place:Capernaum`); corazón (ID: `keyterm:Heart`); Good (ID: `keyterm:Good`); Jesús (ID: `person:Jesus.2`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** sábado (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); Temple (ID: `realia:Temple`); ser discípulo (ID: `keyterm:Disciple`); fariseo (ID: `group:Pharisee`); Sheep (ID: `fauna:Lamb`); Jesús (ID: `person:Jesus.2`); David (ID: `person:David`); misericordia (ID: `keyterm:Mercy`); ley (ID: `keyterm:Law`); contaminación (ID: `keyterm:Defilement`); ofrenda (ID: `keyterm:Offering`); condenar (ID: `keyterm:Condemn`); Jehová (ID: `deity:Lord`); Wheat (ID: `flora:Wheat`); Synagogue (ID: `realia:Synagogue`); Grain (ID: `flora:Grain`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** nación; gente (ID: `group:Gentile`); juicio (ID: `keyterm:Judgment`); Jesús (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); nombre (ID: `keyterm:Name`); mandar (ID: `keyterm:Command`); Isaías (ID: `person:Isaiah`); amado (ID: `keyterm:Beloved`); esperanza (ID: `keyterm:Hope`); Espíritu (ID: `deity:HolySpirit`); To Cause to Happen (ID: `keyterm:Happen`); Reed (ID: `flora:Reed`); Lamp (ID: `realia:Lamp`)
...
* **Associated ACAI Concepts:** Satanás (ID: `deity:Satan`); Demons (ID: `deity:Demons`); Espíritu (ID: `deity:HolySpirit`); reino (ID: `keyterm:Kingdom`); perdonar (ID: `keyterm:Forgive`); Good (ID: `keyterm:Good`); condenar (ID: `keyterm:Condemn`); juicio (ID: `keyterm:Judgment`); blasfemar (ID: `keyterm:Blaspheme`); estar endemoniado (ID: `keyterm:DemonPossessed`); inútil (ID: `keyterm:Idle`); palabra (ID: `keyterm:Word`); pecar (ID: `keyterm:Sin`); Ability (ID: `keyterm:Ability`); corazón (ID: `keyterm:Heart`); Jehová (ID: `deity:Lord`); tribunal de justicia (ID: `keyterm:CourtCase`); servir (ID: `keyterm:Serve`); David (ID: `person:David`); fariseo (ID: `group:Pharisee`); para la eternidad (ID: `keyterm:Always`); House (ID: `realia:House`); Cobra (ID: `fauna:Cobra`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** Jonás (ID: `person:Jonah.2`); señal (ID: `keyterm:Example`); juicio (ID: `keyterm:Judgment`); tribunal de justicia (ID: `keyterm:CourtCase`); Nínive (ID: `group:Nineveh`); reina (ID: `person:QueenOfSheba`); cielo (ID: `keyterm:Heaven`); A Group of People (ID: `group:GenericGroup`); corazón (ID: `keyterm:Heart`); Jehová (ID: `deity:Lord`); Salomón (ID: `person:Solomon`); convertirse (ID: `keyterm:Repent`); ser discípulo (ID: `keyterm:Disciple`); fariseo (ID: `group:Pharisee`); arriba (ID: `keyterm:Unfaithful`); proclamar (ID: `keyterm:Proclaim`); Nínive (ID: `place:Nineveh`); House (ID: `realia:House`); Fish (ID: `fauna:Fish`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** parábola (ID: `keyterm:Parable`); corazón (ID: `keyterm:Heart`); reino (ID: `keyterm:Kingdom`); Brier (ID: `flora:Brier`); Thistle (ID: `flora:Thistle`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); amén (ID: `keyterm:Surely`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ability (ID: `keyterm:Ability`); cielo (ID: `keyterm:Heaven`); A Group of Disciples (ID: `group:GenericDisciples`); Isaías (ID: `person:Isaiah`); ser justo (ID: `keyterm:Just`); Jesús (ID: `person:Jesus.2`); dichoso (ID: `keyterm:Happy`); ser discípulo (ID: `keyterm:Disciple`); para la eternidad (ID: `keyterm:Always`); Bird (ID: `fauna:Bird`); Rooster (ID: `fauna:Rooster`); House (ID: `realia:House`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); cielo (ID: `keyterm:Heaven`); parábola (ID: `keyterm:Parable`); Weed (ID: `flora:Weed`); Grain (ID: `flora:Grain`); An Angel (ID: `deity:Angel`); para la eternidad (ID: `keyterm:Always`); Wheat (ID: `flora:Wheat`); ser justo (ID: `keyterm:Just`); ser discípulo (ID: `keyterm:Disciple`); Kiln (ID: `realia:Kiln`); Grass (ID: `flora:Grass`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ability (ID: `keyterm:Ability`); Jehová (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); escándalo (ID: `keyterm:StumblingBlock`); sin ley (ID: `keyterm:Lawless`); Jesús (ID: `person:Jesus.2`); Saton (ID: `realia:Saton`); Mustard (ID: `flora:Mustard`); Storeroom (ID: `realia:Storeroom`); Dragnet (ID: `realia:Dragnet`); House (ID: `realia:House`); Container (ID: `realia:Container`); Barn (ID: `realia:Barn`)
...
* **Associated ACAI Concepts:** Juan (ID: `person:John`); Jesús (ID: `person:Jesus.2`); Herodes (ID: `person:Herod.2`); Ability (ID: `keyterm:Ability`); Herodías (ID: `person:Herodias`); juramento (ID: `keyterm:Oath`); bautista (ID: `keyterm:Baptist`); Prison (ID: `realia:Prison`); Plate (ID: `realia:Plate.2`); Felipe (ID: `person:Philip.2`); Simón (ID: `person:Simon.3`); Jacobo (ID: `person:James.3`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); no creer (ID: `keyterm:Disbelieve`); JUDAS (ID: `person:Jude`); José (ID: `person:Joseph.4`); María (ID: `person:Mary`); parábola (ID: `keyterm:Parable`); temer (ID: `keyterm:Fear`); Be Lawful (ID: `keyterm:Lawful`); ser discípulo (ID: `keyterm:Disciple`); levantamiento (ID: `keyterm:Resurrection`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Fish (ID: `fauna:Fish`); servir (ID: `keyterm:Serve`); cielo (ID: `keyterm:Heaven`); bendecir (ID: `keyterm:Bless`); entrañas (ID: `keyterm:Affection`); Basket (ID: `realia:Basket`); Ship (ID: `realia:Ship`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); tradición (ID: `keyterm:Teaching`); corazón (ID: `keyterm:Heart`); contaminación (ID: `keyterm:Defilement`); ser discípulo (ID: `keyterm:Disciple`); fariseo (ID: `group:Pharisee`); blasfemar (ID: `keyterm:Blaspheme`); mandamiento (ID: `keyterm:Commandment`); adorar (ID: `keyterm:Worship`); A Group of Disciples (ID: `group:GenericDisciples`); Isaías (ID: `person:Isaiah`); Pedro (ID: `person:Peter`); Jerusalem (ID: `place:Jerusalem`); parábola (ID: `keyterm:Parable`); Heavenly (ID: `keyterm:Heavenly`); Jesús (ID: `person:Jesus.2`); ofrenda (ID: `keyterm:Offering`); prostitución (ID: `keyterm:Fornication`); profetizar (ID: `keyterm:Speak`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Dog (ID: `fauna:Dog`); Sidón (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); Syrophonecian Woman (ID: `person:SyrophonecianWoman`); David (ID: `person:David`); ser discípulo (ID: `keyterm:Disciple`); estar endemoniado (ID: `keyterm:DemonPossessed`); misericordia (ID: `keyterm:Mercy`); rogar (ID: `keyterm:AskFor`); bueno (ID: `keyterm:Honest`); postrarse (ID: `keyterm:BowDown`); cananeo (ID: `group:Canaan`); creer (ID: `keyterm:Believe`); Cananeo (ID: `place:Canaan`); Israel (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Fish (ID: `fauna:Fish`); Magdalá (ID: `place:Magadan`); servir (ID: `keyterm:Serve`); gloria del señor (ID: `keyterm:Glory`); entrañas (ID: `keyterm:Affection`); Jehová (ID: `deity:Lord`); Sea of Galilee (ID: `place:GalileeSea`); Israel (ID: `person:Israel`); Ship (ID: `realia:Ship`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** saduceo (ID: `group:Sadducee`); fariseo (ID: `group:Pharisee`); señal (ID: `keyterm:Example`); cielo (ID: `keyterm:Heaven`); Jesús (ID: `person:Jesus.2`); Basket (ID: `realia:Basket`); de poca fe (ID: `keyterm:HavingLittleFaith`); ser discípulo (ID: `keyterm:Disciple`); Jonás (ID: `person:Jonah.2`); arriba (ID: `keyterm:Unfaithful`); distinguir (ID: `keyterm:Discern`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Jehová (ID: `deity:Lord`); Life (ID: `keyterm:Life`); cielo (ID: `keyterm:Heaven`); Filipo (ID: `place:CaesareaPhilippi`); iglesia (ID: `keyterm:Church`); salvación (ID: `keyterm:Salvation`); mandar (ID: `keyterm:Command`); Hell (ID: `place:Hell`); gloria del señor (ID: `keyterm:Glory`); hades, mundo de los muertos (ID: `keyterm:WorldOfTheDead`); Ability (ID: `keyterm:Ability`); pensar (ID: `keyterm:Think`); A Group of Disciples (ID: `group:GenericDisciples`); cuerpo (ID: `keyterm:Body.3`); Jeremías (ID: `person:Jeremiah.6`); Satanás (ID: `deity:Satan`); Elías (ID: `person:Elijah`); Juan (ID: `person:John`); Jerusalem (ID: `place:Jerusalem`); rogar (ID: `keyterm:AskFor`); Juan (ID: `person:John.4`); bautista (ID: `keyterm:Baptist`); escándalo (ID: `keyterm:StumblingBlock`); dichoso (ID: `keyterm:Happy`); An Angel (ID: `deity:Angel`); levantamiento (ID: `keyterm:Resurrection`); reino (ID: `keyterm:Kingdom`); sangre (ID: `keyterm:Blood`); Key (ID: `realia:Key`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Elías (ID: `person:Elijah`); Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Pedro (ID: `person:Peter`); temer (ID: `keyterm:Fear`); Moisés (ID: `person:Moses`); Juan (ID: `person:John.2`); amén (ID: `keyterm:Surely`); levantamiento (ID: `keyterm:Resurrection`); mandar (ID: `keyterm:Command`); Jacobo (ID: `person:James`); reino (ID: `keyterm:Kingdom`); amado (ID: `keyterm:Beloved`); bautista (ID: `keyterm:Baptist`); Juan (ID: `person:John`); Tent (ID: `realia:Tent`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Pedro (ID: `person:Peter`); servir (ID: `keyterm:Serve`); ser discípulo (ID: `keyterm:Disciple`); amén (ID: `keyterm:Surely`); mandar (ID: `keyterm:Command`); Galilea (ID: `place:Galilee`); tributo (ID: `keyterm:PollTax`); creer (ID: `keyterm:Believe`); Capernaum (ID: `place:Capernaum`); A Group of Disciples (ID: `group:GenericDisciples`); misericordia (ID: `keyterm:Mercy`); Demons (ID: `deity:Demons`); levantamiento (ID: `keyterm:Resurrection`); tributo (ID: `keyterm:Tax`); arriba (ID: `keyterm:Unfaithful`); Fishhook (ID: `realia:Fishhook`); Stater (ID: `realia:Stater`); Two-Drachma Piece (ID: `realia:Two-drachmaPiece`); Mustard (ID: `flora:Mustard`); House (ID: `realia:House`); Fish (ID: `fauna:Fish`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** cielo (ID: `keyterm:Heaven`); hacer tropezar (ID: `keyterm:CauseToStumble`); reino (ID: `keyterm:Kingdom`); Life (ID: `keyterm:Life`); escándalo (ID: `keyterm:StumblingBlock`); amén (ID: `keyterm:Surely`); Hell (ID: `place:Hell`); creer (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); Jehová (ID: `deity:Lord`); fuego eterno (ID: `keyterm:EternalFire`); Disaster (ID: `keyterm:Disaster`); Jesús (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); ser discípulo (ID: `keyterm:Disciple`); nombre (ID: `keyterm:Name`); gehenna (ID: `keyterm:Gehenna`); para la eternidad (ID: `keyterm:Always`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** perdonar (ID: `keyterm:Forgive`); deber (ID: `keyterm:Owe`); cielo (ID: `keyterm:Heaven`); amén (ID: `keyterm:Surely`); pecar (ID: `keyterm:Sin`); Jehová (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); testimonio (ID: `keyterm:Witness`); deuda (ID: `keyterm:Debt`); postrarse (ID: `keyterm:BowDown`); palabra (ID: `keyterm:Word`); entrañas (ID: `keyterm:Affection`); recaudador de impuestos (ID: `keyterm:TaxCollector`); corazón (ID: `keyterm:Heart`); Pedro (ID: `person:Peter`); misericordia (ID: `keyterm:Mercy`); iglesia (ID: `keyterm:Church`); Heavenly (ID: `keyterm:Heavenly`); Jesús (ID: `person:Jesus.2`); nombre (ID: `keyterm:Name`); reino (ID: `keyterm:Kingdom`); Talent (ID: `realia:Talent`); Denarius (ID: `realia:Denarius`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** mandar (ID: `keyterm:Command`); cielo (ID: `keyterm:Heaven`); cuerpo (ID: `keyterm:Body.3`); Moisés (ID: `person:Moses`); Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); reino (ID: `keyterm:Kingdom`); Judíos (ID: `place:Judea`); Galilea (ID: `place:Galilee`); A Group of Disciples (ID: `group:GenericDisciples`); Jordán (ID: `place:Jordan`); Jehová (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); Be Lawful (ID: `keyterm:Lawful`); servir (ID: `keyterm:Serve`); dureza de corazón (ID: `keyterm:Hardheartedness`); fariseo (ID: `group:Pharisee`); prostitución (ID: `keyterm:Fornication`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); amén (ID: `keyterm:Surely`); Rich Young Ruler (ID: `person:RichYoungRuler`); cielo (ID: `keyterm:Heaven`); Jehová (ID: `deity:Lord`); Good (ID: `keyterm:Good`); ser discípulo (ID: `keyterm:Disciple`); para la eternidad (ID: `keyterm:Always`); reino (ID: `keyterm:Kingdom`); mandamiento (ID: `keyterm:Commandment`); salvación (ID: `keyterm:Salvation`); gloria del señor (ID: `keyterm:Glory`); amar (ID: `keyterm:Love`); Pedro (ID: `person:Peter`); rogar (ID: `keyterm:AskFor`); decidir (ID: `keyterm:Decided`); regeneración (ID: `keyterm:NewWorld`); nombre (ID: `keyterm:Name`); prostitución (ID: `keyterm:Fornication`); Israel (ID: `person:Israel`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`); House (ID: `realia:House`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Denarius (ID: `realia:Denarius`); inútil (ID: `keyterm:Idle`); reino (ID: `keyterm:Kingdom`); hacer lo malo (ID: `keyterm:ActWickedly`); ser justo (ID: `keyterm:Just`); Good (ID: `keyterm:Good`); cielo (ID: `keyterm:Heaven`); Be Lawful (ID: `keyterm:Lawful`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Jerusalem (ID: `place:Jerusalem`); mandar (ID: `keyterm:Command`); misericordia (ID: `keyterm:Mercy`); David (ID: `person:David`); servir (ID: `keyterm:Serve`); Jericó (ID: `place:Jericho`); postrarse (ID: `keyterm:BowDown`); entrañas (ID: `keyterm:Affection`); Zebedeo (ID: `person:Zebedee`); condenar (ID: `keyterm:Condemn`); Jehová (ID: `deity:Lord`); Life (ID: `keyterm:Life`); autoridad (ID: `keyterm:Authority.2`); rescate (ID: `keyterm:Ransom`); ser discípulo (ID: `keyterm:Disciple`); levantamiento (ID: `keyterm:Resurrection`); reino (ID: `keyterm:Kingdom`); nación; gente (ID: `group:Gentile`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Jerusalem (ID: `place:Jerusalem`); Donkey (ID: `fauna:Donkey`); hosana (ID: `keyterm:Hosanna`); David (ID: `person:David`); ser discípulo (ID: `keyterm:Disciple`); Clothing (ID: `realia:Clothing`); Bethfagé (ID: `place:Bethphage`); altura (ID: `keyterm:Height`); mandar (ID: `keyterm:Command`); Galilea (ID: `place:Galilee`); bendecir (ID: `keyterm:Bless`); A Group of People (ID: `group:GenericGroup`); Jehová (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); Nazaret (ID: `place:Nazareth`); orar (ID: `keyterm:Pray`); Bethania (ID: `place:Bethany`); servir (ID: `keyterm:Serve`); nombre (ID: `keyterm:Name`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); autoridad (ID: `keyterm:Authority.2`); creer (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); Fig (ID: `flora:Fig`); Juan (ID: `person:John`); ser discípulo (ID: `keyterm:Disciple`); amén (ID: `keyterm:Surely`); rogar (ID: `keyterm:AskFor`); para la eternidad (ID: `keyterm:Always`); bautismo (ID: `keyterm:Baptism`); distinguir (ID: `keyterm:Discern`); temer (ID: `keyterm:Fear`); orar (ID: `keyterm:Pray`); cielo (ID: `keyterm:Heaven`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Jehová (ID: `deity:Lord`); recaudador de impuestos (ID: `keyterm:TaxCollector`); convertirse (ID: `keyterm:Repent`); parábola (ID: `keyterm:Parable`); Jesús (ID: `person:Jesus.2`); reino (ID: `keyterm:Kingdom`); desechar (ID: `keyterm:Reject`); amén (ID: `keyterm:Surely`); escritura (ID: `keyterm:Scripture`); creer (ID: `keyterm:Believe`); Juan (ID: `person:John`); temer (ID: `keyterm:Fear`); ser justo (ID: `keyterm:Just`); fariseo (ID: `group:Pharisee`); Cornerstone (ID: `realia:Cornerstone`); Tower (ID: `realia:Tower`); Winepress (ID: `realia:Winepress`); Watch-Tower (ID: `realia:Watch-tower`); Thorn Hedge (ID: `realia:ThornHedge`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); Jesús (ID: `person:Jesus.2`); tinieblas de afuera (ID: `keyterm:OuterDarkness`); mandar (ID: `keyterm:Command`); reino (ID: `keyterm:Kingdom`); parábola (ID: `keyterm:Parable`); escogido (ID: `keyterm:Chosen`); Good (ID: `keyterm:Good`); cielo (ID: `keyterm:Heaven`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); levantamiento (ID: `keyterm:Resurrection`); tributo (ID: `keyterm:PollTax`); Jesús (ID: `person:Jesus.2`); Tiberio (ID: `person:Tiberius`); los seguidores de Herodes; Herodianos (ID: `group:Herodian`); saduceo (ID: `group:Sadducee`); Israel (ID: `person:Israel`); escritura (ID: `keyterm:Scripture`); Abraham (ID: `person:Abraham`); Ability (ID: `keyterm:Ability`); cielo (ID: `keyterm:Heaven`); fidelidad (ID: `keyterm:Truth`); The Way (ID: `keyterm:TheWay`); Moisés (ID: `person:Moses`); Life (ID: `keyterm:Life`); verdadero (ID: `keyterm:True`); Isaac (ID: `person:Isaac`); Be Lawful (ID: `keyterm:Lawful`); ser discípulo (ID: `keyterm:Disciple`); An Angel (ID: `deity:Angel`); fariseo (ID: `group:Pharisee`); Money (ID: `realia:Money`); Denarius (ID: `realia:Denarius`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); mandamiento (ID: `keyterm:Commandment`); David (ID: `person:David`); Jesús (ID: `person:Jesus.2`); fariseo (ID: `group:Pharisee`); ley (ID: `keyterm:Law`); amar (ID: `keyterm:Love`); mente (ID: `keyterm:Mind.2`); corazón (ID: `keyterm:Heart`); saduceo (ID: `group:Sadducee`); Espíritu (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** fariseo (ID: `group:Pharisee`); Disaster (ID: `keyterm:Disaster`); Temple (ID: `realia:Temple`); Jehová (ID: `deity:Lord`); ser justo (ID: `keyterm:Just`); gehenna (ID: `keyterm:Gehenna`); consagración (ID: `keyterm:Consecration.2`); cielo (ID: `keyterm:Heaven`); deber (ID: `keyterm:Ought`); juicio (ID: `keyterm:Judgment`); purificarse (ID: `keyterm:Cleanse.2`); Jesús (ID: `person:Jesus.2`); ofrenda (ID: `keyterm:Offering`); sangre (ID: `keyterm:Blood`); Zachârías (ID: `person:Zechariah.12`); limpio (ID: `keyterm:Clean`); hipocresía (ID: `keyterm:Hypocrisy`); Joiada (ID: `person:Jehoiada.2`); Grave (ID: `realia:Grave`); Synagogue (ID: `realia:Synagogue`); amén (ID: `keyterm:Surely`); Hell (ID: `place:Hell`); dar testimonio (ID: `keyterm:BearWitness`); creer (ID: `keyterm:Believe`); amistad (ID: `keyterm:Friendship`); bendecir (ID: `keyterm:Bless`); Moisés (ID: `person:Moses`); Jerusalem (ID: `place:Jerusalem`); misericordia (ID: `keyterm:Mercy`); ley (ID: `keyterm:Law`); contaminación (ID: `keyterm:Defilement`); Abel (ID: `person:Abel`); tribunal de justicia (ID: `keyterm:CourtCase`); Heavenly (ID: `keyterm:Heavenly`); sin ley (ID: `keyterm:Lawless`); ser discípulo (ID: `keyterm:Disciple`); nombre (ID: `keyterm:Name`); reino (ID: `keyterm:Kingdom`); Dill (ID: `flora:Dill`); Seat (ID: `realia:Seat`); Phylactery (ID: `realia:Phylactery`); Mosquito (ID: `fauna:Mosquito`); Cumin (ID: `flora:Cumin`); Mint (ID: `flora:Mint`); Plate (ID: `realia:Plate.2`); Bird (ID: `fauna:Bird`); Rooster (ID: `fauna:Rooster`); House (ID: `realia:House`); Tassel (ID: `realia:Tassel`); Camel (ID: `fauna:Camel`); Throne (ID: `realia:Throne`); Cross (ID: `realia:Cross`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); nombre (ID: `keyterm:Name`); reino (ID: `keyterm:Kingdom`); salvación (ID: `keyterm:Salvation`); amén (ID: `keyterm:Surely`); buena noticia (ID: `keyterm:GoodNews`); dar testimonio (ID: `keyterm:BearWitness`); para la eternidad (ID: `keyterm:Always`); señal (ID: `keyterm:Example`); proclamar (ID: `keyterm:Proclaim`); amar (ID: `keyterm:Love`); Ability (ID: `keyterm:Ability`); sin ley (ID: `keyterm:Lawless`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** cielo (ID: `keyterm:Heaven`); escogido (ID: `keyterm:Chosen`); Noé (ID: `person:Noah`); amén (ID: `keyterm:Surely`); creer (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); Jesús (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); señal (ID: `keyterm:Example`); Daniel (ID: `person:Daniel.3`); lealtad (ID: `keyterm:Faithfulness`); House (ID: `realia:House`); Judíos (ID: `place:Judea`); salvación (ID: `keyterm:Salvation`); gloria del señor (ID: `keyterm:Glory`); maravilla (ID: `keyterm:Portent`); lo detestable de la devastación (ID: `keyterm:AbominationOfDesolation`); sábado (ID: `keyterm:Sabbath`); cuerpo (ID: `keyterm:Body.3`); corazón (ID: `keyterm:Heart`); Jehová (ID: `deity:Lord`); Disaster (ID: `keyterm:Disaster`); parábola (ID: `keyterm:Parable`); orar (ID: `keyterm:Pray`); dichoso (ID: `keyterm:Happy`); santo (ID: `keyterm:Holy`); Inner Room (ID: `realia:InnerRoom`); Trumpet (ID: `realia:Trumpet`); Vulture (ID: `fauna:Vulture`); Housetop (ID: `realia:Housetop`); Boat (ID: `realia:Boat`); Cloak (ID: `realia:Cloak`); Fig (ID: `flora:Fig`); Tabernacle (ID: `realia:Tabernacle`); Door (ID: `realia:Door`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** Lamp (ID: `realia:Lamp`); Olive Oil (ID: `realia:OliveOil`); amén (ID: `keyterm:Surely`); reino (ID: `keyterm:Kingdom`); cielo (ID: `keyterm:Heaven`); Container (ID: `realia:Container`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** Talent (ID: `realia:Talent`); lealtad (ID: `keyterm:Faithfulness`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Good (ID: `keyterm:Good`); tinieblas de afuera (ID: `keyterm:OuterDarkness`); temer (ID: `keyterm:Fear`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** Prison (ID: `realia:Prison`); amén (ID: `keyterm:Surely`); ser justo (ID: `keyterm:Just`); Jesús (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); para la eternidad (ID: `keyterm:Always`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Kid (ID: `fauna:Kid`); gloria del señor (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); bendecir (ID: `keyterm:Bless`); Jehová (ID: `deity:Lord`); fuego eterno (ID: `keyterm:EternalFire`); Life (ID: `keyterm:Life`); servir (ID: `keyterm:Serve`); reino (ID: `keyterm:Kingdom`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); pascua (ID: `keyterm:Passover`); sangre (ID: `keyterm:Blood`); cuerpo (ID: `keyterm:Body.3`); amén (ID: `keyterm:Surely`); Disaster (ID: `keyterm:Disaster`); bendecir (ID: `keyterm:Bless`); reino (ID: `keyterm:Kingdom`); perdonar (ID: `keyterm:Forgive`); pecar (ID: `keyterm:Sin`); Jehová (ID: `deity:Lord`); Judas (ID: `person:Judas.2`); pacto (ID: `keyterm:Covenant`); Vine (ID: `flora:Vine`); Bowl (ID: `realia:Bowl.2`); Olive Tree (ID: `flora:OliveTree`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); ser discípulo (ID: `keyterm:Disciple`); Pedro (ID: `person:Peter`); Jesús (ID: `person:Jesus.2`); Jehová (ID: `deity:Lord`); espíritu (ID: `keyterm:Spirit.2`); Gethsemaní (ID: `place:Gethsemane`); levantamiento (ID: `keyterm:Resurrection`); amén (ID: `keyterm:Surely`); cuerpo (ID: `keyterm:Body.3`); Galilea (ID: `place:Galilee`); tentar (ID: `keyterm:PutToTheTest`); Zebedeo (ID: `person:Zebedee`); Rooster (ID: `fauna:Rooster`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Olive Tree (ID: `flora:OliveTree`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); To Cause to Happen (ID: `keyterm:Happen`); escritura (ID: `keyterm:Scripture`); ser discípulo (ID: `keyterm:Disciple`); An Angel (ID: `deity:Angel`); rogar (ID: `keyterm:AskFor`); señal (ID: `keyterm:Example`); Jehová (ID: `deity:Lord`); Judas (ID: `person:Judas.2`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Jehová (ID: `deity:Lord`); Caifás (ID: `person:Caiaphas`); Pedro (ID: `person:Peter`); testimonio (ID: `keyterm:Witness`); Life (ID: `keyterm:Life`); cielo (ID: `keyterm:Heaven`); profetizar (ID: `keyterm:Speak`); Ability (ID: `keyterm:Ability`); blasfemar (ID: `keyterm:Blaspheme`); Courtyard (ID: `realia:Courtyard`); Cloak (ID: `realia:Cloak`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Pedro (ID: `person:Peter`); Rooster (ID: `fauna:Rooster`); Nazaret (ID: `place:Nazareth`); galileo (ID: `group:Galilee`); verdadero (ID: `keyterm:True`); Galilea (ID: `place:Galilee`); juramento (ID: `keyterm:Oath`); palabra (ID: `keyterm:Word`); A Group of People (ID: `group:GenericGroup`); A Servant (ID: `person:GenericServant`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Akeldama (ID: `place:Akeldama`); sangre (ID: `keyterm:Blood`); Pilato (ID: `person:Pilate`); Corbán (ID: `place:Corban`); Jesús (ID: `person:Jesus.2`); convertirse (ID: `keyterm:Repent`); Judas (ID: `person:Judas.2`); Jeremías (ID: `person:Jeremiah.6`); pecar (ID: `keyterm:Sin`); condenar (ID: `keyterm:Condemn`); Jehová (ID: `deity:Lord`); Priests (ID: `group:GenericPriests`); Israel (ID: `person:Israel`); To Cause to Happen (ID: `keyterm:Happen`); Be Lawful (ID: `keyterm:Lawful`); Treasury (ID: `realia:Treasury`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Barrabás (ID: `person:Barabbas`); Pilato (ID: `person:Pilate`); A Group of People (ID: `group:GenericGroup`); Cross (ID: `realia:Cross`); sangre (ID: `keyterm:Blood`); palabra (ID: `keyterm:Word`); ser justo (ID: `keyterm:Just`); Jews (ID: `group:Jews`); persuadir (ID: `keyterm:Persuade`); Judgment Seat (ID: `realia:JudgmentSeat`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); salvación (ID: `keyterm:Salvation`); Jesús (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Cloak (ID: `realia:Cloak`); Reed (ID: `flora:Reed`); Clothing (ID: `realia:Clothing`); Simón (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); Cireneo (ID: `place:Cyrene`); blasfemar (ID: `keyterm:Blaspheme`); liberar (ID: `keyterm:Deliver`); creer (ID: `keyterm:Believe`); corazón (ID: `keyterm:Heart`); Jehová (ID: `deity:Lord`); persuadir (ID: `keyterm:Persuade`); nombre (ID: `keyterm:Name`); Israel (ID: `person:Israel`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`); Wine (ID: `realia:Wine`); Boxthorn (ID: `flora:Boxthorn`); Lot (ID: `realia:Lot`); Palace (ID: `realia:Palace`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Grave (ID: `realia:Grave`); levantamiento (ID: `keyterm:Resurrection`); Pilato (ID: `person:Pilate`); cuerpo (ID: `keyterm:Body.3`); María (ID: `person:Marymagdalene`); José (ID: `person:Joseph.6`); María (ID: `person:Mary.2`); A Group of People (ID: `group:GenericGroup`); Elías (ID: `person:Elijah`); santo (ID: `keyterm:Holy`); ser discípulo (ID: `keyterm:Disciple`); Jacobo (ID: `person:James.4`); Zebedeo (ID: `person:Zebedee`); José (ID: `person:Joseph.5`); Arimatea (ID: `place:Arimathea`); salvación (ID: `keyterm:Salvation`); Galilea (ID: `place:Galilee`); limpio (ID: `keyterm:Clean`); Jehová (ID: `deity:Lord`); Life (ID: `keyterm:Life`); verdadero (ID: `keyterm:True`); temer (ID: `keyterm:Fear`); servir (ID: `keyterm:Serve`); espíritu (ID: `keyterm:Spirit.2`); nombre (ID: `keyterm:Name`); fariseo (ID: `group:Pharisee`); Reed (ID: `flora:Reed`); Sour Wine (ID: `realia:SourWine`); Curtain (ID: `realia:Curtain`); Seal (ID: `realia:Seal`); Linen (ID: `realia:Linen`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** temer (ID: `keyterm:Fear`); Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); levantamiento (ID: `keyterm:Resurrection`); Galilea (ID: `place:Galilee`); An Angel (ID: `deity:Angel`); Grave (ID: `realia:Grave`); semana (ID: `keyterm:Week`); Angels (ID: `group:Angels`); postrarse (ID: `keyterm:BowDown`); Cause of Joy (ID: `keyterm:CauseOfJoy`); María (ID: `person:Marymagdalene`); sábado (ID: `keyterm:Sabbath`); cielo (ID: `keyterm:Heaven`); Jehová (ID: `deity:Lord`); persuadir (ID: `keyterm:Persuade`); Jews (ID: `group:Jews`); María (ID: `person:Mary.2`); Clothing (ID: `realia:Clothing`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Jesús (ID: `person:Jesus.2`); autoridad (ID: `keyterm:Authority.2`); mandar (ID: `keyterm:Command`); nombre (ID: `keyterm:Name`); Galilea (ID: `place:Galilee`); para la eternidad (ID: `keyterm:Always`); postrarse (ID: `keyterm:BowDown`); bautismo (ID: `keyterm:Baptism`); Jehová (ID: `deity:Lord`); Espíritu (ID: `deity:HolySpirit`); Ability (ID: `keyterm:Ability`); cielo (ID: `keyterm:Heaven`)
