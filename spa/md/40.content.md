...
* **Associated ACAI Concepts:** David (ID: `person:David`); Jesús (ID: `person:Jesus.2`); Babilonia (ID: `place:Babylon`); Abraham (ID: `person:Abraham`); Jacob (ID: `person:Jacob.2`); Azor (ID: `person:Azor`); Eliud (ID: `person:Eliud`); Zorobabel (ID: `person:Zerubbabel.2`); Uzzías (ID: `person:Uzziah`); Josías (ID: `person:Josiah`); Ezechîas (ID: `person:Hezekiah`); Asa (ID: `person:Asa`); Joachîn (ID: `person:Jehoiachin`); Salmón (ID: `person:Salmon`); Ram (ID: `person:Ram`); Salomón (ID: `person:Solomon`); Isaí (ID: `person:Jesse`); Judá (ID: `person:Judah.4`); Achîm (ID: `person:Achim`); Zera (ID: `person:Zerah.3`); Josaphat (ID: `person:Jehoshaphat.3`); Isaac (ID: `person:Isaac`); Booz (ID: `person:Boaz`); Eliacim (ID: `person:Eliakim`); Sadoc (ID: `person:Zadok`); Achâz (ID: `person:Ahaz`); Eleazar (ID: `person:Eleazar`); Mathán (ID: `person:Matthan`); Abías (ID: `person:Abijah.4`); Hesrón (ID: `person:Hezron.2`); Nahasón (ID: `person:Nahshon`); Phares (ID: `person:Perez`); Roboam (ID: `person:Rehoboam`); Joram (ID: `person:Jehoram`); Obed (ID: `person:Obed`); Thamar (ID: `person:Tamar`); Abiud (ID: `person:Abiud`); Jotham (ID: `person:Jotham.2`); Amón (ID: `person:Amon.3`); José (ID: `person:Joseph.4`); Rahab (ID: `person:Rahab`); Israel (ID: `person:Israel`); Aminadab (ID: `person:Amminadab`); Uría (ID: `person:Uriah`); Ruth (ID: `person:Ruth`); Salathiel (ID: `person:Shealtiel.2`); Manasés (ID: `person:Manasseh.2`); María (ID: `person:Mary`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); José (ID: `person:Joseph.4`); Jehová (ID: `deity:Lord`); nombre (ID: `keyterm:Name`); María (ID: `person:Mary`); Espíritu (ID: `deity:HolySpirit`); An Angel (ID: `deity:Angel`); To Cause to Happen (ID: `keyterm:Happen`); estar comprometido en matrimonio (ID: `keyterm:Engaged`); temer (ID: `keyterm:Fear`); David (ID: `person:David`); salvación (ID: `keyterm:Salvation`); pecar (ID: `keyterm:Sin`); ser justo (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod`); Catah (ID: `place:Bethlehem`); Egipto (ID: `place:Egypt`); postrarse (ID: `keyterm:BowDown`); Judíos (ID: `place:Judea`); Jehová (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); Israel (ID: `person:Israel`); José (ID: `person:Joseph.4`); An Angel (ID: `deity:Angel`); Jerusalem (ID: `place:Jerusalem`); Jesús (ID: `person:Jesus.2`); Nazaret (ID: `place:Nazareth`); Archelao (ID: `person:Archelaus`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Jeremías (ID: `person:Jeremiah.6`); ofrenda (ID: `keyterm:Offering`); Priests (ID: `group:GenericPriests`); rogar (ID: `keyterm:AskFor`); A Priest (ID: `person:GenericPriest`); temer (ID: `keyterm:Fear`); exhortar (ID: `keyterm:Encourage`); Religious Officials (ID: `group:ReligiousOfficials`); Galilea (ID: `place:Galilee`); Rachêl (ID: `person:Rachel`); María (ID: `person:Mary`); Life (ID: `keyterm:Life`); Ramah (ID: `place:Ramah.2`); Judá (ID: `person:Judah.4`); Jews (ID: `group:Jews`); Frankincense (ID: `flora:Frankincense`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Money Box (ID: `realia:MoneyBox`); Incense (ID: `realia:Incense`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** convertirse (ID: `keyterm:Repent`); bautismo (ID: `keyterm:Baptism`); Judíos (ID: `place:Judea`); Juan (ID: `person:John`); Jehová (ID: `deity:Lord`); Jordán (ID: `place:Jordan`); Isaías (ID: `person:Isaiah`); bautista (ID: `keyterm:Baptist`); cielo (ID: `keyterm:Heaven`); proclamar (ID: `keyterm:Proclaim`); Abraham (ID: `person:Abraham`); fariseo (ID: `group:Pharisee`); reino (ID: `keyterm:Kingdom`); Jerusalem (ID: `place:Jerusalem`); saduceo (ID: `group:Sadducee`); rectitud (ID: `keyterm:Straightness`); Espíritu (ID: `deity:HolySpirit`); limpiar (ID: `keyterm:CleanOut`); pecar (ID: `keyterm:Sin`); Locust (ID: `fauna:Locust`); Threshing Floor (ID: `realia:ThreshingFloor`); Leather (ID: `realia:Leather`); Belt (ID: `realia:Belt`); Winnowing Fork (ID: `realia:WinnowingFork`); Sandal (ID: `realia:Sandal`); Clothing (ID: `realia:Clothing`); Snake (ID: `fauna:Snake`); Grain (ID: `flora:Grain`); Bag (ID: `realia:Bag`); Camel (ID: `fauna:Camel`); Bee (ID: `fauna:Bee`); Wheat (ID: `flora:Wheat`); Barn (ID: `realia:Barn`); Axe (ID: `realia:Axe`)
...
* **Associated ACAI Concepts:** bautismo (ID: `keyterm:Baptism`); Jesús (ID: `person:Jesus.2`); cielo (ID: `keyterm:Heaven`); Juan (ID: `person:John`); Jordán (ID: `place:Jordan`); To Cause to Happen (ID: `keyterm:Happen`); Espíritu (ID: `deity:HolySpirit`); Jehová (ID: `deity:Lord`); ser justo (ID: `keyterm:Just`); Galilea (ID: `place:Galilee`); amado (ID: `keyterm:Beloved`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Jesús (ID: `person:Jesus.2`); tentar (ID: `keyterm:PutToTheTest`); postrarse (ID: `keyterm:BowDown`); mandar (ID: `keyterm:Command`); An Angel (ID: `deity:Angel`); servir (ID: `keyterm:Serve`); palabra (ID: `keyterm:Word`); sacerdocio (ID: `keyterm:Priesthood`); reino (ID: `keyterm:Kingdom`); Satanás (ID: `deity:Satan`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); Espíritu (ID: `deity:HolySpirit`); ayunar (ID: `keyterm:Fast`); santo (ID: `keyterm:Holy`); gloria del señor (ID: `keyterm:Glory`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Galilea (ID: `place:Galilee`); Zabulón (ID: `person:Zebulun`); Zabulón (ID: `group:Zebulun`); Nephtalí (ID: `person:Naphtali`); convertirse (ID: `keyterm:Repent`); Nazaret (ID: `place:Nazareth`); proclamar (ID: `keyterm:Proclaim`); cielo (ID: `keyterm:Heaven`); To Cause to Happen (ID: `keyterm:Happen`); Capernaum (ID: `place:Capernaum`); reino (ID: `keyterm:Kingdom`); Jesús (ID: `person:Jesus.2`); Jordán (ID: `place:Jordan`); Juan (ID: `person:John`); Isaías (ID: `person:Isaiah`); nación; gente (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** Casting Net (ID: `realia:CastingNet`); Galilea (ID: `place:Galilee`); servir (ID: `keyterm:Serve`); Andrés (ID: `person:Andrew`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Zebedeo (ID: `person:Zebedee`); Juan (ID: `person:John.2`); buena noticia (ID: `keyterm:GoodNews`); Sea of Galilee (ID: `place:GalileeSea`); Decápolis (ID: `place:Decapolis`); Jacobo (ID: `person:James`); estar endemoniado (ID: `keyterm:DemonPossessed`); proclamar (ID: `keyterm:Proclaim`); Judíos (ID: `place:Judea`); reino (ID: `keyterm:Kingdom`); Jerusalem (ID: `place:Jerusalem`); Jordán (ID: `place:Jordan`); Pedro (ID: `person:Peter`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** dichoso (ID: `keyterm:Happy`); cielo (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); Jehová (ID: `deity:Lord`); ser justo (ID: `keyterm:Just`); corazón (ID: `keyterm:Heart`); misericordia (ID: `keyterm:Mercy`); rogar (ID: `keyterm:AskFor`); exhortar (ID: `keyterm:Encourage`); ser discípulo (ID: `keyterm:Disciple`); espíritu (ID: `keyterm:Spirit.2`); limpio (ID: `keyterm:Clean`)
...
* **Associated ACAI Concepts:** cielo (ID: `keyterm:Heaven`); ley (ID: `keyterm:Law`); reino (ID: `keyterm:Kingdom`); mandamiento (ID: `keyterm:Commandment`); fariseo (ID: `group:Pharisee`); Ability (ID: `keyterm:Ability`); amén (ID: `keyterm:Surely`); Jehová (ID: `deity:Lord`); ser justo (ID: `keyterm:Just`); gloria del señor (ID: `keyterm:Glory`); Lampstand (ID: `realia:Lampstand.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); prostitución (ID: `keyterm:Fornication`); gehenna (ID: `keyterm:Gehenna`); Hell (ID: `place:Hell`); amar (ID: `keyterm:Love`); tribunal de justicia (ID: `keyterm:CourtCase`); ofrenda (ID: `keyterm:Offering`); cielo (ID: `keyterm:Heaven`); hacer tropezar (ID: `keyterm:CauseToStumble`); cuerpo (ID: `keyterm:Body.3`); juicio (ID: `keyterm:Judgment`); reconciliar (ID: `keyterm:Reconcile`); juramento (ID: `keyterm:Oath`); Heavenly (ID: `keyterm:Heavenly`); Good (ID: `keyterm:Good`); corazón (ID: `keyterm:Heart`); decidir (ID: `keyterm:Decided`); ser justo (ID: `keyterm:Just`); Jerusalem (ID: `place:Jerusalem`); orar (ID: `keyterm:Pray`); recaudador de impuestos (ID: `keyterm:TaxCollector`); amén (ID: `keyterm:Surely`); Footstool (ID: `realia:Footstool`); Cloak (ID: `realia:Cloak`); Quadrans (ID: `realia:Quadrans`); Mile (ID: `realia:Mile`); Prison (ID: `realia:Prison`); Tunic (ID: `realia:Tunic.2`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); cielo (ID: `keyterm:Heaven`); perdonar (ID: `keyterm:Forgive`); amén (ID: `keyterm:Surely`); Synagogue (ID: `realia:Synagogue`); reino (ID: `keyterm:Kingdom`); llevar a (ID: `keyterm:BringIn`); amistad (ID: `keyterm:Friendship`); deuda (ID: `keyterm:Wrong`); ser justo (ID: `keyterm:Just`); tentar (ID: `keyterm:PutToTheTest`); nombre (ID: `keyterm:Name`); Heavenly (ID: `keyterm:Heavenly`); santo (ID: `keyterm:Holy`); gloria del señor (ID: `keyterm:Glory`); liberar (ID: `keyterm:Deliver`); Inner Room (ID: `realia:InnerRoom`); Door (ID: `realia:Door`); Cornerstone (ID: `realia:Cornerstone`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); ayunar (ID: `keyterm:Fast`); cuerpo (ID: `keyterm:Body.3`); cielo (ID: `keyterm:Heaven`); Heavenly (ID: `keyterm:Heavenly`); Clothing (ID: `realia:Clothing`); Moth (ID: `fauna:Moth`); de poca fe (ID: `keyterm:HavingLittleFaith`); corazón (ID: `keyterm:Heart`); reino (ID: `keyterm:Kingdom`); ser justo (ID: `keyterm:Just`); servir como esclavo (ID: `keyterm:Serve.2`); Life (ID: `keyterm:Life`); ungido (ID: `keyterm:Anointed`); amén (ID: `keyterm:Surely`); Salomón (ID: `person:Solomon`); gloria del señor (ID: `keyterm:Glory`); amar (ID: `keyterm:Love`); Oven (ID: `realia:Oven`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Barn (ID: `realia:Barn`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Beam (ID: `realia:Beam`); decidir (ID: `keyterm:Decided`); cielo (ID: `keyterm:Heaven`); juicio (ID: `keyterm:Judgment`); Jehová (ID: `deity:Lord`); ley (ID: `keyterm:Law`); santo (ID: `keyterm:Holy`); Snake (ID: `fauna:Snake`); Fish (ID: `fauna:Fish`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); Dog (ID: `fauna:Dog`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); sin ley (ID: `keyterm:Lawless`); borrar (ID: `keyterm:Destroy`); cielo (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); nombre (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Jehová (ID: `deity:Lord`); Life (ID: `keyterm:Life`); profetizar (ID: `keyterm:Speak`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Clothing (ID: `realia:Clothing`); Wolf (ID: `fauna:Wolf`); Fig (ID: `flora:Fig`); Sheep (ID: `fauna:Lamb`); Vine (ID: `flora:Vine`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); autoridad (ID: `keyterm:Authority.2`); Jesús (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); purificarse (ID: `keyterm:Cleanse.2`); creer (ID: `keyterm:Believe`); reino (ID: `keyterm:Kingdom`); Israel (ID: `person:Israel`); House (ID: `realia:House`); estar endemoniado (ID: `keyterm:DemonPossessed`); Centurion With Sick Servant (ID: `person:Centurion.2`); enfermedad infecciosa de la piel (ID: `keyterm:InfectiousSkinDisease`); dar testimonio (ID: `keyterm:BearWitness`); ofrenda (ID: `keyterm:Offering`); cielo (ID: `keyterm:Heaven`); autoridad (ID: `keyterm:Authority.2`); rogar (ID: `keyterm:AskFor`); mandar (ID: `keyterm:Command`); Isaac (ID: `person:Isaac`); tinieblas de afuera (ID: `keyterm:OuterDarkness`); Abraham (ID: `person:Abraham`); Isaías (ID: `person:Isaiah`); postrarse (ID: `keyterm:BowDown`); Ability (ID: `keyterm:Ability`); Moisés (ID: `person:Moses`); Capernaum (ID: `place:Capernaum`); To Cause to Happen (ID: `keyterm:Happen`); amén (ID: `keyterm:Surely`); Pedro (ID: `person:Peter`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); estar endemoniado (ID: `keyterm:DemonPossessed`); rogar (ID: `keyterm:AskFor`); ser discípulo (ID: `keyterm:Disciple`); Ship (ID: `realia:Ship`); de poca fe (ID: `keyterm:HavingLittleFaith`); mandar (ID: `keyterm:Command`); Religious Official (ID: `person:ReligiousOfficial`); A Disciple (ID: `person:GenericDisciple`); autoridad (ID: `keyterm:Authority.2`); cielo (ID: `keyterm:Heaven`); Gerasa (ID: `place:Gerasa`); salvación (ID: `keyterm:Salvation`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); perdonar (ID: `keyterm:Forgive`); pecar (ID: `keyterm:Sin`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); recaudador de impuestos (ID: `keyterm:TaxCollector`); autoridad (ID: `keyterm:Authority.2`); fariseo (ID: `group:Pharisee`); Ability (ID: `keyterm:Ability`); ayunar (ID: `keyterm:Fast`); Temple (ID: `realia:Temple`); Bed (ID: `realia:Bed`); misericordia (ID: `keyterm:Mercy`); Mateo (ID: `person:Matthew`); corazón (ID: `keyterm:Heart`); ofrenda (ID: `keyterm:Offering`); blasfemar (ID: `keyterm:Blaspheme`); Be Healthy (ID: `keyterm:Healthy`); temer (ID: `keyterm:Fear`); ser justo (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); tener valor (ID: `keyterm:CheerUp`); Jehová (ID: `deity:Lord`); oficina de impuestos (ID: `keyterm:TaxOffice`); creer (ID: `keyterm:Believe`); gloria del señor (ID: `keyterm:Glory`); Juan (ID: `person:John`); Patch (ID: `realia:Patch`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Ship (ID: `realia:Ship`); Skin-Bottle (ID: `realia:Skin-bottle`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); creer (ID: `keyterm:Believe`); Demons (ID: `deity:Demons`); salvación (ID: `keyterm:Salvation`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); Cloak (ID: `realia:Cloak`); entrañas (ID: `keyterm:Affection`); rogar (ID: `keyterm:AskFor`); estar endemoniado (ID: `keyterm:DemonPossessed`); buena noticia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); fariseo (ID: `group:Pharisee`); reino (ID: `keyterm:Kingdom`); David (ID: `person:David`); misericordia (ID: `keyterm:Mercy`); postrarse (ID: `keyterm:BowDown`); tener valor (ID: `keyterm:CheerUp`); Life (ID: `keyterm:Life`); Bleed (ID: `keyterm:Bleed`); Israel (ID: `person:Israel`); servir (ID: `keyterm:Serve`); Tassel (ID: `realia:Tassel`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Goat (ID: `fauna:Goat`); Flute (ID: `realia:Flute`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); servir (ID: `keyterm:Serve`); Bag (ID: `realia:Bag`); Bartolomé (ID: `person:Bartholomew`); Alfeo (ID: `person:Alphaeus`); hacer la paz (ID: `keyterm:Peace`); Judas (ID: `person:Judas.2`); Tomás (ID: `person:Thomas`); Judas (ID: `person:Judas`); Celador (ID: `group:Zealot`); Jacobo (ID: `person:James.2`); Simón (ID: `person:Simon.2`); Felipe (ID: `person:Philip`); purificarse (ID: `keyterm:Cleanse.2`); cielo (ID: `keyterm:Heaven`); autoridad (ID: `keyterm:Authority.2`); Samaria (ID: `place:Samaria`); tribunal de justicia (ID: `keyterm:CourtCase`); Juan (ID: `person:John.2`); Zebedeo (ID: `person:Zebedee`); Simrat (ID: `group:Samaritan`); proclamar (ID: `keyterm:Proclaim`); reino (ID: `keyterm:Kingdom`); Andrés (ID: `person:Andrew`); Demons (ID: `deity:Demons`); Sodoma (ID: `place:Sodom`); Gomorra (ID: `place:Gomorrah`); nombre (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Mateo (ID: `person:Matthew`); nación; gente (ID: `group:Gentile`); levantamiento (ID: `keyterm:Resurrection`); recaudador de impuestos (ID: `keyterm:TaxCollector`); Jesús (ID: `person:Jesus.2`); juicio (ID: `keyterm:Judgment`); amén (ID: `keyterm:Surely`); Jacobo (ID: `person:James`); Israel (ID: `person:Israel`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Staff (ID: `realia:Staff`); Belt (ID: `realia:Belt`); Sheep (ID: `fauna:Lamb`); Tunic (ID: `realia:Tunic.2`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); temer (ID: `keyterm:Fear`); nombre (ID: `keyterm:Name`); ser discípulo (ID: `keyterm:Disciple`); cielo (ID: `keyterm:Heaven`); amén (ID: `keyterm:Surely`); Sparrow (ID: `fauna:Sparrow`); gehenna (ID: `keyterm:Gehenna`); dar testimonio (ID: `keyterm:BearWitness`); mandar (ID: `keyterm:Command`); amistad (ID: `keyterm:Friendship`); proclamar (ID: `keyterm:Proclaim`); hacer la paz (ID: `keyterm:Peace`); ser justo (ID: `keyterm:Just`); Hell (ID: `place:Hell`); Satanás (ID: `deity:Satan`); nación; gente (ID: `group:Gentile`); cuerpo (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); Espíritu (ID: `deity:HolySpirit`); salvación (ID: `keyterm:Salvation`); Israel (ID: `person:Israel`); Wolf (ID: `fauna:Wolf`); Assarion (ID: `realia:Assarion`); Snake (ID: `fauna:Snake`); Cross (ID: `realia:Cross`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Dove (ID: `fauna:Dove`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Juan (ID: `person:John`); Jesús (ID: `person:Jesus.2`); bautista (ID: `keyterm:Baptist`); cielo (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); ser discípulo (ID: `keyterm:Disciple`); purificarse (ID: `keyterm:Cleanse.2`); dichoso (ID: `keyterm:Happy`); buena noticia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); Elías (ID: `person:Elijah`); Demons (ID: `deity:Demons`); ser justo (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); ley (ID: `keyterm:Law`); levantamiento (ID: `keyterm:Resurrection`); recaudador de impuestos (ID: `keyterm:TaxCollector`); profetizar (ID: `keyterm:Speak`); amén (ID: `keyterm:Surely`); Reed (ID: `flora:Reed`); Prison (ID: `realia:Prison`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Flute (ID: `realia:Flute`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Jehová (ID: `deity:Lord`); cielo (ID: `keyterm:Heaven`); convertirse (ID: `keyterm:Repent`); tribunal de justicia (ID: `keyterm:CourtCase`); Sodoma (ID: `place:Sodom`); Sidón (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); juicio (ID: `keyterm:Judgment`); Yoke (ID: `realia:Yoke`); Corazín (ID: `place:Chorazin`); Disaster (ID: `keyterm:Disaster`); hades, mundo de los muertos (ID: `keyterm:WorldOfTheDead`); corazón (ID: `keyterm:Heart`); Bethsaida (ID: `place:Bethsaida`); Hell (ID: `place:Hell`); Capernaum (ID: `place:Capernaum`); Good (ID: `keyterm:Good`); Jesús (ID: `person:Jesus.2`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** sábado (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); Temple (ID: `realia:Temple`); fariseo (ID: `group:Pharisee`); ser discípulo (ID: `keyterm:Disciple`); Sheep (ID: `fauna:Lamb`); ofrenda (ID: `keyterm:Offering`); David (ID: `person:David`); Jesús (ID: `person:Jesus.2`); condenar (ID: `keyterm:Condemn`); Jehová (ID: `deity:Lord`); misericordia (ID: `keyterm:Mercy`); contaminación (ID: `keyterm:Defilement`); ley (ID: `keyterm:Law`); Wheat (ID: `flora:Wheat`); House (ID: `realia:House`); Grain (ID: `flora:Grain`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** juicio (ID: `keyterm:Judgment`); nación; gente (ID: `group:Gentile`); nombre (ID: `keyterm:Name`); To Cause to Happen (ID: `keyterm:Happen`); Espíritu (ID: `deity:HolySpirit`); Jesús (ID: `person:Jesus.2`); mandar (ID: `keyterm:Command`); amado (ID: `keyterm:Beloved`); Isaías (ID: `person:Isaiah`); esperanza (ID: `keyterm:Hope`); servir (ID: `keyterm:Serve`); Lamp (ID: `realia:Lamp`); Reed (ID: `flora:Reed`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); Satanás (ID: `deity:Satan`); Espíritu (ID: `deity:HolySpirit`); perdonar (ID: `keyterm:Forgive`); Good (ID: `keyterm:Good`); blasfemar (ID: `keyterm:Blaspheme`); condenar (ID: `keyterm:Condemn`); juicio (ID: `keyterm:Judgment`); corazón (ID: `keyterm:Heart`); inútil (ID: `keyterm:Idle`); estar endemoniado (ID: `keyterm:DemonPossessed`); tribunal de justicia (ID: `keyterm:CourtCase`); fariseo (ID: `group:Pharisee`); David (ID: `person:David`); para la eternidad (ID: `keyterm:Always`); palabra (ID: `keyterm:Word`); Ability (ID: `keyterm:Ability`); Jehová (ID: `deity:Lord`); pecar (ID: `keyterm:Sin`); servir (ID: `keyterm:Serve`); House (ID: `realia:House`); Snake (ID: `fauna:Snake`); Cobra (ID: `fauna:Cobra`)
...
* **Associated ACAI Concepts:** Jonás (ID: `person:Jonah.2`); señal (ID: `keyterm:Example`); tribunal de justicia (ID: `keyterm:CourtCase`); juicio (ID: `keyterm:Judgment`); reina (ID: `person:QueenOfSheba`); Nínive (ID: `group:Nineveh`); corazón (ID: `keyterm:Heart`); cielo (ID: `keyterm:Heaven`); convertirse (ID: `keyterm:Repent`); proclamar (ID: `keyterm:Proclaim`); arriba (ID: `keyterm:Unfaithful`); Nínive (ID: `place:Nineveh`); fariseo (ID: `group:Pharisee`); A Group of People (ID: `group:GenericGroup`); Jehová (ID: `deity:Lord`); Salomón (ID: `person:Solomon`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** parábola (ID: `keyterm:Parable`); corazón (ID: `keyterm:Heart`); reino (ID: `keyterm:Kingdom`); Brier (ID: `flora:Brier`); Thistle (ID: `flora:Thistle`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); cielo (ID: `keyterm:Heaven`); dichoso (ID: `keyterm:Happy`); A Group of Disciples (ID: `group:GenericDisciples`); ser justo (ID: `keyterm:Just`); Isaías (ID: `person:Isaiah`); para la eternidad (ID: `keyterm:Always`); Ability (ID: `keyterm:Ability`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Jesús (ID: `person:Jesus.2`); amén (ID: `keyterm:Surely`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); Bird (ID: `fauna:Bird`); Ship (ID: `realia:Ship`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); cielo (ID: `keyterm:Heaven`); parábola (ID: `keyterm:Parable`); Weed (ID: `flora:Weed`); Grain (ID: `flora:Grain`); An Angel (ID: `deity:Angel`); para la eternidad (ID: `keyterm:Always`); Wheat (ID: `flora:Wheat`); ser justo (ID: `keyterm:Just`); ser discípulo (ID: `keyterm:Disciple`); Kiln (ID: `realia:Kiln`); Grass (ID: `flora:Grass`); sin ley (ID: `keyterm:Lawless`); escándalo (ID: `keyterm:StumblingBlock`); Ability (ID: `keyterm:Ability`); Jehová (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); To Cause to Happen (ID: `keyterm:Happen`); Jesús (ID: `person:Jesus.2`); Dragnet (ID: `realia:Dragnet`); Saton (ID: `realia:Saton`); Mustard (ID: `flora:Mustard`); Storeroom (ID: `realia:Storeroom`); House (ID: `realia:House`); Barn (ID: `realia:Barn`); Container (ID: `realia:Container`)
...
* **Associated ACAI Concepts:** Juan (ID: `person:John`); Jesús (ID: `person:Jesus.2`); Herodes (ID: `person:Herod.2`); Ability (ID: `keyterm:Ability`); Herodías (ID: `person:Herodias`); juramento (ID: `keyterm:Oath`); bautista (ID: `keyterm:Baptist`); Prison (ID: `realia:Prison`); Plate (ID: `realia:Plate.2`); JUDAS (ID: `person:Jude`); Simón (ID: `person:Simon.3`); no creer (ID: `keyterm:Disbelieve`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Jacobo (ID: `person:James.3`); Felipe (ID: `person:Philip.2`); temer (ID: `keyterm:Fear`); Be Lawful (ID: `keyterm:Lawful`); María (ID: `person:Mary`); José (ID: `person:Joseph.4`); levantamiento (ID: `keyterm:Resurrection`); parábola (ID: `keyterm:Parable`); ser discípulo (ID: `keyterm:Disciple`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Fish (ID: `fauna:Fish`); entrañas (ID: `keyterm:Affection`); cielo (ID: `keyterm:Heaven`); bendecir (ID: `keyterm:Bless`); servir (ID: `keyterm:Serve`); Basket (ID: `realia:Basket`); Ship (ID: `realia:Ship`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); temer (ID: `keyterm:Fear`); Jesús (ID: `person:Jesus.2`); salvación (ID: `keyterm:Salvation`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); de poca fe (ID: `keyterm:HavingLittleFaith`); Genezaret (ID: `place:Gennesaret`); tener valor (ID: `keyterm:CheerUp`); postrarse (ID: `keyterm:BowDown`); rogar (ID: `keyterm:AskFor`); verdadero (ID: `keyterm:True`); orar (ID: `keyterm:Pray`); Tassel (ID: `realia:Tassel`); Stade (ID: `realia:Stade`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); tradición (ID: `keyterm:Teaching`); corazón (ID: `keyterm:Heart`); contaminación (ID: `keyterm:Defilement`); fariseo (ID: `group:Pharisee`); ser discípulo (ID: `keyterm:Disciple`); ofrenda (ID: `keyterm:Offering`); blasfemar (ID: `keyterm:Blaspheme`); adorar (ID: `keyterm:Worship`); A Group of Disciples (ID: `group:GenericDisciples`); mandamiento (ID: `keyterm:Commandment`); Isaías (ID: `person:Isaiah`); Jerusalem (ID: `place:Jerusalem`); Heavenly (ID: `keyterm:Heavenly`); prostitución (ID: `keyterm:Fornication`); parábola (ID: `keyterm:Parable`); Jesús (ID: `person:Jesus.2`); profetizar (ID: `keyterm:Speak`); Pedro (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Dog (ID: `fauna:Dog`); Tiro (ID: `place:Tyre`); Syrophonecian Woman (ID: `person:SyrophonecianWoman`); Sidón (ID: `place:Sidon`); creer (ID: `keyterm:Believe`); bueno (ID: `keyterm:Honest`); postrarse (ID: `keyterm:BowDown`); rogar (ID: `keyterm:AskFor`); David (ID: `person:David`); estar endemoniado (ID: `keyterm:DemonPossessed`); cananeo (ID: `group:Canaan`); Israel (ID: `person:Israel`); misericordia (ID: `keyterm:Mercy`); ser discípulo (ID: `keyterm:Disciple`); Cananeo (ID: `place:Canaan`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Fish (ID: `fauna:Fish`); Magdalá (ID: `place:Magadan`); entrañas (ID: `keyterm:Affection`); Jehová (ID: `deity:Lord`); Israel (ID: `person:Israel`); gloria del señor (ID: `keyterm:Glory`); Sea of Galilee (ID: `place:GalileeSea`); servir (ID: `keyterm:Serve`); Ship (ID: `realia:Ship`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** saduceo (ID: `group:Sadducee`); fariseo (ID: `group:Pharisee`); cielo (ID: `keyterm:Heaven`); señal (ID: `keyterm:Example`); Jesús (ID: `person:Jesus.2`); Basket (ID: `realia:Basket`); de poca fe (ID: `keyterm:HavingLittleFaith`); distinguir (ID: `keyterm:Discern`); ser discípulo (ID: `keyterm:Disciple`); Jonás (ID: `person:Jonah.2`); arriba (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Jehová (ID: `deity:Lord`); Life (ID: `keyterm:Life`); cielo (ID: `keyterm:Heaven`); Filipo (ID: `place:CaesareaPhilippi`); iglesia (ID: `keyterm:Church`); rogar (ID: `keyterm:AskFor`); mandar (ID: `keyterm:Command`); dichoso (ID: `keyterm:Happy`); A Group of Disciples (ID: `group:GenericDisciples`); Elías (ID: `person:Elijah`); reino (ID: `keyterm:Kingdom`); pensar (ID: `keyterm:Think`); Juan (ID: `person:John.4`); An Angel (ID: `deity:Angel`); Jerusalem (ID: `place:Jerusalem`); escándalo (ID: `keyterm:StumblingBlock`); bautista (ID: `keyterm:Baptist`); Hell (ID: `place:Hell`); hades, mundo de los muertos (ID: `keyterm:WorldOfTheDead`); Satanás (ID: `deity:Satan`); Ability (ID: `keyterm:Ability`); cuerpo (ID: `keyterm:Body.3`); sangre (ID: `keyterm:Blood`); levantamiento (ID: `keyterm:Resurrection`); Jeremías (ID: `person:Jeremiah.6`); salvación (ID: `keyterm:Salvation`); gloria del señor (ID: `keyterm:Glory`); Juan (ID: `person:John`); Key (ID: `realia:Key`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Elías (ID: `person:Elijah`); Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); temer (ID: `keyterm:Fear`); Moisés (ID: `person:Moses`); Pedro (ID: `person:Peter`); levantamiento (ID: `keyterm:Resurrection`); bautista (ID: `keyterm:Baptist`); reino (ID: `keyterm:Kingdom`); mandar (ID: `keyterm:Command`); amén (ID: `keyterm:Surely`); amado (ID: `keyterm:Beloved`); Jacobo (ID: `person:James`); Juan (ID: `person:John.2`); Juan (ID: `person:John`); Clothing (ID: `realia:Clothing`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); servir (ID: `keyterm:Serve`); mandar (ID: `keyterm:Command`); arriba (ID: `keyterm:Unfaithful`); A Group of Disciples (ID: `group:GenericDisciples`); tributo (ID: `keyterm:Tax`); Demons (ID: `deity:Demons`); misericordia (ID: `keyterm:Mercy`); Galilea (ID: `place:Galilee`); levantamiento (ID: `keyterm:Resurrection`); creer (ID: `keyterm:Believe`); Capernaum (ID: `place:Capernaum`); tributo (ID: `keyterm:PollTax`); amén (ID: `keyterm:Surely`); Mustard (ID: `flora:Mustard`); Stater (ID: `realia:Stater`); Fishhook (ID: `realia:Fishhook`); Two-Drachma Piece (ID: `realia:Two-drachmaPiece`); House (ID: `realia:House`); Fish (ID: `fauna:Fish`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** cielo (ID: `keyterm:Heaven`); hacer tropezar (ID: `keyterm:CauseToStumble`); reino (ID: `keyterm:Kingdom`); Life (ID: `keyterm:Life`); escándalo (ID: `keyterm:StumblingBlock`); Disaster (ID: `keyterm:Disaster`); An Angel (ID: `deity:Angel`); para la eternidad (ID: `keyterm:Always`); nombre (ID: `keyterm:Name`); Hell (ID: `place:Hell`); Ability (ID: `keyterm:Ability`); fuego eterno (ID: `keyterm:EternalFire`); Jehová (ID: `deity:Lord`); creer (ID: `keyterm:Believe`); gehenna (ID: `keyterm:Gehenna`); Jesús (ID: `person:Jesus.2`); amén (ID: `keyterm:Surely`); ser discípulo (ID: `keyterm:Disciple`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** perdonar (ID: `keyterm:Forgive`); deber (ID: `keyterm:Owe`); cielo (ID: `keyterm:Heaven`); rogar (ID: `keyterm:AskFor`); Jehová (ID: `deity:Lord`); pecar (ID: `keyterm:Sin`); amén (ID: `keyterm:Surely`); testimonio (ID: `keyterm:Witness`); corazón (ID: `keyterm:Heart`); reino (ID: `keyterm:Kingdom`); misericordia (ID: `keyterm:Mercy`); nombre (ID: `keyterm:Name`); entrañas (ID: `keyterm:Affection`); postrarse (ID: `keyterm:BowDown`); Heavenly (ID: `keyterm:Heavenly`); recaudador de impuestos (ID: `keyterm:TaxCollector`); Jesús (ID: `person:Jesus.2`); iglesia (ID: `keyterm:Church`); deuda (ID: `keyterm:Debt`); Pedro (ID: `person:Peter`); palabra (ID: `keyterm:Word`); Prison (ID: `realia:Prison`); Denarius (ID: `realia:Denarius`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** cielo (ID: `keyterm:Heaven`); mandar (ID: `keyterm:Command`); reino (ID: `keyterm:Kingdom`); Moisés (ID: `person:Moses`); cuerpo (ID: `keyterm:Body.3`); Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Judíos (ID: `place:Judea`); fariseo (ID: `group:Pharisee`); dureza de corazón (ID: `keyterm:Hardheartedness`); Be Lawful (ID: `keyterm:Lawful`); Galilea (ID: `place:Galilee`); Jehová (ID: `deity:Lord`); prostitución (ID: `keyterm:Fornication`); orar (ID: `keyterm:Pray`); Jordán (ID: `place:Jordan`); servir (ID: `keyterm:Serve`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); cielo (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); Rich Young Ruler (ID: `person:RichYoungRuler`); para la eternidad (ID: `keyterm:Always`); Jehová (ID: `deity:Lord`); Good (ID: `keyterm:Good`); amén (ID: `keyterm:Surely`); ser discípulo (ID: `keyterm:Disciple`); rogar (ID: `keyterm:AskFor`); regeneración (ID: `keyterm:NewWorld`); mandamiento (ID: `keyterm:Commandment`); decidir (ID: `keyterm:Decided`); nombre (ID: `keyterm:Name`); prostitución (ID: `keyterm:Fornication`); salvación (ID: `keyterm:Salvation`); Israel (ID: `person:Israel`); Pedro (ID: `person:Peter`); gloria del señor (ID: `keyterm:Glory`); amar (ID: `keyterm:Love`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`); House (ID: `realia:House`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Denarius (ID: `realia:Denarius`); inútil (ID: `keyterm:Idle`); hacer lo malo (ID: `keyterm:ActWickedly`); cielo (ID: `keyterm:Heaven`); Good (ID: `keyterm:Good`); reino (ID: `keyterm:Kingdom`); ser justo (ID: `keyterm:Just`); Be Lawful (ID: `keyterm:Lawful`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Jerusalem (ID: `place:Jerusalem`); mandar (ID: `keyterm:Command`); David (ID: `person:David`); misericordia (ID: `keyterm:Mercy`); servir (ID: `keyterm:Serve`); autoridad (ID: `keyterm:Authority.2`); Zebedeo (ID: `person:Zebedee`); reino (ID: `keyterm:Kingdom`); Jericó (ID: `place:Jericho`); entrañas (ID: `keyterm:Affection`); postrarse (ID: `keyterm:BowDown`); condenar (ID: `keyterm:Condemn`); Jehová (ID: `deity:Lord`); nación; gente (ID: `group:Gentile`); Life (ID: `keyterm:Life`); levantamiento (ID: `keyterm:Resurrection`); rescate (ID: `keyterm:Ransom`); ser discípulo (ID: `keyterm:Disciple`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Jerusalem (ID: `place:Jerusalem`); Donkey (ID: `fauna:Donkey`); hosana (ID: `keyterm:Hosanna`); David (ID: `person:David`); ser discípulo (ID: `keyterm:Disciple`); Clothing (ID: `realia:Clothing`); Bethfagé (ID: `place:Bethphage`); mandar (ID: `keyterm:Command`); bendecir (ID: `keyterm:Bless`); Nazaret (ID: `place:Nazareth`); Galilea (ID: `place:Galilee`); nombre (ID: `keyterm:Name`); Bethania (ID: `place:Bethany`); A Group of People (ID: `group:GenericGroup`); Jehová (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); To Cause to Happen (ID: `keyterm:Happen`); altura (ID: `keyterm:Height`); servir (ID: `keyterm:Serve`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** creer (ID: `keyterm:Believe`); autoridad (ID: `keyterm:Authority.2`); Jesús (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); Fig (ID: `flora:Fig`); Juan (ID: `person:John`); bautismo (ID: `keyterm:Baptism`); cielo (ID: `keyterm:Heaven`); rogar (ID: `keyterm:AskFor`); temer (ID: `keyterm:Fear`); amén (ID: `keyterm:Surely`); para la eternidad (ID: `keyterm:Always`); orar (ID: `keyterm:Pray`); distinguir (ID: `keyterm:Discern`); ser discípulo (ID: `keyterm:Disciple`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Jehová (ID: `deity:Lord`); recaudador de impuestos (ID: `keyterm:TaxCollector`); convertirse (ID: `keyterm:Repent`); reino (ID: `keyterm:Kingdom`); parábola (ID: `keyterm:Parable`); Jesús (ID: `person:Jesus.2`); desechar (ID: `keyterm:Reject`); escritura (ID: `keyterm:Scripture`); fariseo (ID: `group:Pharisee`); temer (ID: `keyterm:Fear`); ser justo (ID: `keyterm:Just`); creer (ID: `keyterm:Believe`); amén (ID: `keyterm:Surely`); Juan (ID: `person:John`); Winepress (ID: `realia:Winepress`); Cornerstone (ID: `realia:Cornerstone`); Tower (ID: `realia:Tower`); Watch-Tower (ID: `realia:Watch-tower`); Thorn Hedge (ID: `realia:ThornHedge`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); cielo (ID: `keyterm:Heaven`); Good (ID: `keyterm:Good`); reino (ID: `keyterm:Kingdom`); parábola (ID: `keyterm:Parable`); Jesús (ID: `person:Jesus.2`); mandar (ID: `keyterm:Command`); escogido (ID: `keyterm:Chosen`); tinieblas de afuera (ID: `keyterm:OuterDarkness`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); levantamiento (ID: `keyterm:Resurrection`); Tiberio (ID: `person:Tiberius`); Jesús (ID: `person:Jesus.2`); tributo (ID: `keyterm:PollTax`); los seguidores de Herodes; Herodianos (ID: `group:Herodian`); saduceo (ID: `group:Sadducee`); Israel (ID: `person:Israel`); escritura (ID: `keyterm:Scripture`); cielo (ID: `keyterm:Heaven`); verdadero (ID: `keyterm:True`); Isaac (ID: `person:Isaac`); Abraham (ID: `person:Abraham`); fariseo (ID: `group:Pharisee`); An Angel (ID: `deity:Angel`); Be Lawful (ID: `keyterm:Lawful`); The Way (ID: `keyterm:TheWay`); fidelidad (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); Moisés (ID: `person:Moses`); Life (ID: `keyterm:Life`); ser discípulo (ID: `keyterm:Disciple`); Money (ID: `realia:Money`); Denarius (ID: `realia:Denarius`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); mandamiento (ID: `keyterm:Commandment`); David (ID: `person:David`); fariseo (ID: `group:Pharisee`); Jesús (ID: `person:Jesus.2`); amar (ID: `keyterm:Love`); ley (ID: `keyterm:Law`); corazón (ID: `keyterm:Heart`); mente (ID: `keyterm:Mind.2`); Espíritu (ID: `deity:HolySpirit`); saduceo (ID: `group:Sadducee`)
...
* **Associated ACAI Concepts:** fariseo (ID: `group:Pharisee`); Disaster (ID: `keyterm:Disaster`); Temple (ID: `realia:Temple`); ser justo (ID: `keyterm:Just`); Jehová (ID: `deity:Lord`); gehenna (ID: `keyterm:Gehenna`); purificarse (ID: `keyterm:Cleanse.2`); ofrenda (ID: `keyterm:Offering`); cielo (ID: `keyterm:Heaven`); deber (ID: `keyterm:Ought`); sangre (ID: `keyterm:Blood`); consagración (ID: `keyterm:Consecration.2`); Jesús (ID: `person:Jesus.2`); juicio (ID: `keyterm:Judgment`); hipocresía (ID: `keyterm:Hypocrisy`); Joiada (ID: `person:Jehoiada.2`); Zachârías (ID: `person:Zechariah.12`); limpio (ID: `keyterm:Clean`); Synagogue (ID: `realia:Synagogue`); Grave (ID: `realia:Grave`); dar testimonio (ID: `keyterm:BearWitness`); tribunal de justicia (ID: `keyterm:CourtCase`); amistad (ID: `keyterm:Friendship`); bendecir (ID: `keyterm:Bless`); reino (ID: `keyterm:Kingdom`); misericordia (ID: `keyterm:Mercy`); Jerusalem (ID: `place:Jerusalem`); sin ley (ID: `keyterm:Lawless`); Abel (ID: `person:Abel`); nombre (ID: `keyterm:Name`); Hell (ID: `place:Hell`); Heavenly (ID: `keyterm:Heavenly`); Moisés (ID: `person:Moses`); contaminación (ID: `keyterm:Defilement`); ley (ID: `keyterm:Law`); creer (ID: `keyterm:Believe`); amén (ID: `keyterm:Surely`); ser discípulo (ID: `keyterm:Disciple`); Dill (ID: `flora:Dill`); Mint (ID: `flora:Mint`); Phylactery (ID: `realia:Phylactery`); Mosquito (ID: `fauna:Mosquito`); Plate (ID: `realia:Plate.2`); Cumin (ID: `flora:Cumin`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Snake (ID: `fauna:Snake`); Tassel (ID: `realia:Tassel`); Cross (ID: `realia:Cross`); Camel (ID: `fauna:Camel`); Bird (ID: `fauna:Bird`); Throne (ID: `realia:Throne`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); nombre (ID: `keyterm:Name`); reino (ID: `keyterm:Kingdom`); ser discípulo (ID: `keyterm:Disciple`); dar testimonio (ID: `keyterm:BearWitness`); salvación (ID: `keyterm:Salvation`); Ability (ID: `keyterm:Ability`); sin ley (ID: `keyterm:Lawless`); amén (ID: `keyterm:Surely`); para la eternidad (ID: `keyterm:Always`); señal (ID: `keyterm:Example`); buena noticia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); amar (ID: `keyterm:Love`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** cielo (ID: `keyterm:Heaven`); escogido (ID: `keyterm:Chosen`); Noé (ID: `person:Noah`); señal (ID: `keyterm:Example`); An Angel (ID: `deity:Angel`); Ability (ID: `keyterm:Ability`); creer (ID: `keyterm:Believe`); Jesús (ID: `person:Jesus.2`); amén (ID: `keyterm:Surely`); lealtad (ID: `keyterm:Faithfulness`); Daniel (ID: `person:Daniel.3`); House (ID: `realia:House`); corazón (ID: `keyterm:Heart`); maravilla (ID: `keyterm:Portent`); lo detestable de la devastación (ID: `keyterm:AbominationOfDesolation`); dichoso (ID: `keyterm:Happy`); Judíos (ID: `place:Judea`); Disaster (ID: `keyterm:Disaster`); Jehová (ID: `deity:Lord`); cuerpo (ID: `keyterm:Body.3`); orar (ID: `keyterm:Pray`); salvación (ID: `keyterm:Salvation`); parábola (ID: `keyterm:Parable`); sábado (ID: `keyterm:Sabbath`); santo (ID: `keyterm:Holy`); gloria del señor (ID: `keyterm:Glory`); Vulture (ID: `fauna:Vulture`); Inner Room (ID: `realia:InnerRoom`); Trumpet (ID: `realia:Trumpet`); Housetop (ID: `realia:Housetop`); Door (ID: `realia:Door`); Fig (ID: `flora:Fig`); Tabernacle (ID: `realia:Tabernacle`); Cloak (ID: `realia:Cloak`); Hand-Mill (ID: `realia:Hand-mill`); Boat (ID: `realia:Boat`)
...
* **Associated ACAI Concepts:** Lamp (ID: `realia:Lamp`); Olive Oil (ID: `realia:OliveOil`); cielo (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); amén (ID: `keyterm:Surely`); Container (ID: `realia:Container`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** Talent (ID: `realia:Talent`); Good (ID: `keyterm:Good`); lealtad (ID: `keyterm:Faithfulness`); Cause of Joy (ID: `keyterm:CauseOfJoy`); temer (ID: `keyterm:Fear`); Ability (ID: `keyterm:Ability`); tinieblas de afuera (ID: `keyterm:OuterDarkness`)
...
* **Associated ACAI Concepts:** Prison (ID: `realia:Prison`); ser justo (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); para la eternidad (ID: `keyterm:Always`); Jesús (ID: `person:Jesus.2`); amén (ID: `keyterm:Surely`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Kid (ID: `fauna:Kid`); bendecir (ID: `keyterm:Bless`); reino (ID: `keyterm:Kingdom`); fuego eterno (ID: `keyterm:EternalFire`); Ability (ID: `keyterm:Ability`); Jehová (ID: `deity:Lord`); Life (ID: `keyterm:Life`); gloria del señor (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Simón (ID: `person:Simon.4`); Bethania (ID: `place:Bethany`); Judas (ID: `person:Judas.2`); pascua (ID: `keyterm:Passover`); Ability (ID: `keyterm:Ability`); amén (ID: `keyterm:Surely`); Caifás (ID: `person:Caiaphas`); cuerpo (ID: `keyterm:Body.3`); buena noticia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); Alabaster Jar (ID: `realia:AlabasterJar`); House (ID: `realia:House`); Courtyard (ID: `realia:Courtyard`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); pascua (ID: `keyterm:Passover`); sangre (ID: `keyterm:Blood`); cuerpo (ID: `keyterm:Body.3`); reino (ID: `keyterm:Kingdom`); perdonar (ID: `keyterm:Forgive`); Judas (ID: `person:Judas.2`); pecar (ID: `keyterm:Sin`); amén (ID: `keyterm:Surely`); Disaster (ID: `keyterm:Disaster`); Jehová (ID: `deity:Lord`); pacto (ID: `keyterm:Covenant`); bendecir (ID: `keyterm:Bless`); Vine (ID: `flora:Vine`); Bowl (ID: `realia:Bowl.2`); Olive Tree (ID: `flora:OliveTree`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Jesús (ID: `person:Jesus.2`); Jehová (ID: `deity:Lord`); Gethsemaní (ID: `place:Gethsemane`); espíritu (ID: `keyterm:Spirit.2`); levantamiento (ID: `keyterm:Resurrection`); Zebedeo (ID: `person:Zebedee`); tentar (ID: `keyterm:PutToTheTest`); amén (ID: `keyterm:Surely`); cuerpo (ID: `keyterm:Body.3`); Galilea (ID: `place:Galilee`); Rooster (ID: `fauna:Rooster`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Olive Tree (ID: `flora:OliveTree`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); To Cause to Happen (ID: `keyterm:Happen`); escritura (ID: `keyterm:Scripture`); rogar (ID: `keyterm:AskFor`); Judas (ID: `person:Judas.2`); Jehová (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); señal (ID: `keyterm:Example`); ser discípulo (ID: `keyterm:Disciple`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Jehová (ID: `deity:Lord`); Caifás (ID: `person:Caiaphas`); cielo (ID: `keyterm:Heaven`); blasfemar (ID: `keyterm:Blaspheme`); testimonio (ID: `keyterm:Witness`); profetizar (ID: `keyterm:Speak`); Ability (ID: `keyterm:Ability`); Pedro (ID: `person:Peter`); Life (ID: `keyterm:Life`); Courtyard (ID: `realia:Courtyard`); Temple (ID: `realia:Temple`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Pedro (ID: `person:Peter`); Rooster (ID: `fauna:Rooster`); juramento (ID: `keyterm:Oath`); A Group of People (ID: `group:GenericGroup`); galileo (ID: `group:Galilee`); verdadero (ID: `keyterm:True`); Nazaret (ID: `place:Nazareth`); Galilea (ID: `place:Galilee`); A Servant (ID: `person:GenericServant`); palabra (ID: `keyterm:Word`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Akeldama (ID: `place:Akeldama`); sangre (ID: `keyterm:Blood`); Pilato (ID: `person:Pilate`); Corbán (ID: `place:Corban`); Priests (ID: `group:GenericPriests`); Jeremías (ID: `person:Jeremiah.6`); To Cause to Happen (ID: `keyterm:Happen`); Jesús (ID: `person:Jesus.2`); Judas (ID: `person:Judas.2`); pecar (ID: `keyterm:Sin`); condenar (ID: `keyterm:Condemn`); Jehová (ID: `deity:Lord`); convertirse (ID: `keyterm:Repent`); Israel (ID: `person:Israel`); Be Lawful (ID: `keyterm:Lawful`); Temple (ID: `realia:Temple`); Treasury (ID: `realia:Treasury`)
...
* **Associated ACAI Concepts:** Barrabás (ID: `person:Barabbas`); Jesús (ID: `person:Jesus.2`); Pilato (ID: `person:Pilate`); A Group of People (ID: `group:GenericGroup`); Cross (ID: `realia:Cross`); sangre (ID: `keyterm:Blood`); Jews (ID: `group:Jews`); ser justo (ID: `keyterm:Just`); persuadir (ID: `keyterm:Persuade`); palabra (ID: `keyterm:Word`); Judgment Seat (ID: `realia:JudgmentSeat`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); salvación (ID: `keyterm:Salvation`); Jesús (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Clothing (ID: `realia:Clothing`); Reed (ID: `flora:Reed`); Cloak (ID: `realia:Cloak`); Cireneo (ID: `place:Cyrene`); Simón (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); corazón (ID: `keyterm:Heart`); blasfemar (ID: `keyterm:Blaspheme`); persuadir (ID: `keyterm:Persuade`); nombre (ID: `keyterm:Name`); Jehová (ID: `deity:Lord`); creer (ID: `keyterm:Believe`); Israel (ID: `person:Israel`); liberar (ID: `keyterm:Deliver`); Crown (ID: `realia:Crown.2`); Brier (ID: `flora:Brier`); Wine (ID: `realia:Wine`); Acacia (ID: `flora:Acacia`); Crown (ID: `realia:Crown`); Temple (ID: `realia:Temple`); Palace (ID: `realia:Palace`); Boxthorn (ID: `flora:Boxthorn`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Grave (ID: `realia:Grave`); levantamiento (ID: `keyterm:Resurrection`); Pilato (ID: `person:Pilate`); cuerpo (ID: `keyterm:Body.3`); José (ID: `person:Joseph.6`); María (ID: `person:Marymagdalene`); María (ID: `person:Mary.2`); Elías (ID: `person:Elijah`); A Group of People (ID: `group:GenericGroup`); santo (ID: `keyterm:Holy`); ser discípulo (ID: `keyterm:Disciple`); Zebedeo (ID: `person:Zebedee`); Jacobo (ID: `person:James.4`); Arimatea (ID: `place:Arimathea`); José (ID: `person:Joseph.5`); verdadero (ID: `keyterm:True`); fariseo (ID: `group:Pharisee`); temer (ID: `keyterm:Fear`); Galilea (ID: `place:Galilee`); nombre (ID: `keyterm:Name`); Jehová (ID: `deity:Lord`); Life (ID: `keyterm:Life`); limpio (ID: `keyterm:Clean`); salvación (ID: `keyterm:Salvation`); espíritu (ID: `keyterm:Spirit.2`); servir (ID: `keyterm:Serve`); Seal (ID: `realia:Seal`); Sour Wine (ID: `realia:SourWine`); Reed (ID: `flora:Reed`); Curtain (ID: `realia:Curtain`); Temple (ID: `realia:Temple`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** temer (ID: `keyterm:Fear`); Jesús (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); levantamiento (ID: `keyterm:Resurrection`); An Angel (ID: `deity:Angel`); Galilea (ID: `place:Galilee`); Grave (ID: `realia:Grave`); Angels (ID: `group:Angels`); semana (ID: `keyterm:Week`); cielo (ID: `keyterm:Heaven`); persuadir (ID: `keyterm:Persuade`); postrarse (ID: `keyterm:BowDown`); Jehová (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); sábado (ID: `keyterm:Sabbath`); Jews (ID: `group:Jews`); María (ID: `person:Marymagdalene`); María (ID: `person:Mary.2`); Clothing (ID: `realia:Clothing`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Jesús (ID: `person:Jesus.2`); autoridad (ID: `keyterm:Authority.2`); nombre (ID: `keyterm:Name`); bautismo (ID: `keyterm:Baptism`); cielo (ID: `keyterm:Heaven`); Espíritu (ID: `deity:HolySpirit`); postrarse (ID: `keyterm:BowDown`); Ability (ID: `keyterm:Ability`); mandar (ID: `keyterm:Command`); Jehová (ID: `deity:Lord`); para la eternidad (ID: `keyterm:Always`); Galilea (ID: `place:Galilee`)
