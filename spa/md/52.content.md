...
* **Associated ACAI Concepts:** Macedonia (ID: `place:Macedonia`); Tesalonicenses (ID: `place:Thessalonica`); Jesús (ID: `person:Jesus.2`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Atenas (ID: `place:Athens`); creer (ID: `keyterm:Believe`); Jesús (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** amor fraternal (ID: `keyterm:LoveForOnesFellowBeliever`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** quedar libre de castigo (ID: `keyterm:Blameless`); Jesús (ID: `person:Jesus.2`)
