...
* **Associated Passages:** Eclesiastés 1:1-11
...
* **Associated Passages:** Eclesiastés 1:12-11:6
...
* **Associated ACAI Concepts:** insensato (ID: `keyterm:Stupid`); saber (ID: `keyterm:Intention`); Ability (ID: `keyterm:Ability`); pecar (ID: `keyterm:Sin`); amar (ID: `keyterm:Love`); temer (ID: `keyterm:Fear`); House (ID: `realia:House`); Jehová (ID: `deity:Lord`)
...
* **Associated Passages:** Eclesiastés 11:7-12:14
