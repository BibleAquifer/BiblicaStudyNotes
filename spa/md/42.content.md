...
* **Associated ACAI Concepts:** Zachârías (ID: `person:Zechariah`); Elisabet (ID: `person:Elizabeth`); Abías (ID: `person:Abijah.6`); Strong Drink (ID: `realia:StrongDrink`); Gabriel (ID: `deity:Gabriel`); decreto justo (ID: `keyterm:Regulations`); Herodes (ID: `person:Herod`); quedar libre de castigo (ID: `keyterm:Blameless`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** María (ID: `person:Mary`); palabra (ID: `keyterm:Word`); favor (ID: `keyterm:Favor`); Gabriel (ID: `deity:Gabriel`); Nazaret (ID: `place:Nazareth`); Jesús (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Zachârías (ID: `person:Zechariah`); altura (ID: `keyterm:Height`); Elisabet (ID: `person:Elizabeth`); liberar (ID: `keyterm:Deliver`); liberación (ID: `keyterm:Liberation`); Judíos (ID: `place:Judea`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Manger (ID: `realia:Manger`); siendo (ID: `person:Quirinius`); Catah (ID: `place:Bethlehem`); Inn (ID: `realia:Inn`); Augusto (ID: `person:Augustus`); salvador (ID: `keyterm:Savior`); inscribir (ID: `keyterm:Register`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Simeón (ID: `person:Simeon.2`); Ana (ID: `person:Anna`); Phanuel (ID: `person:Phanuel`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Abilinia (ID: `place:Abilene`); Lisanias (ID: `person:Lysanias`); Traconite (ID: `place:Trachonitis`); Felipe (ID: `person:Philip.3`); Iturea (ID: `place:Ituraea`); Anás (ID: `person:Annas`); Augusto (ID: `person:Augustus`); Tiberio (ID: `person:Tiberius`); Herodes (ID: `person:Herod.2`); Juan (ID: `person:John`); Jordán (ID: `place:Jordan`)
...
* **Associated ACAI Concepts:** Strap (ID: `realia:Strap`); Herodías (ID: `person:Herodias`); Herodes (ID: `person:Herod.2`)
...
* **Associated ACAI Concepts:** Eliezer (ID: `person:Eliezer`); que (ID: `person:Jannai`); Elí (ID: `person:Heli`); Levitas (ID: `person:Levi.2`); Que (ID: `person:Joanan`); Levitas (ID: `person:Levi`); que (ID: `person:Esli`); fué (ID: `person:Mattathias`); José (ID: `person:Joseph.8`); que (ID: `person:Cosam`); Salathiel (ID: `person:Shealtiel`); que (ID: `person:Menna`); que (ID: `person:Melchi.2`); que (ID: `person:Addi`); Josué (ID: `person:Joshua`); Maat (ID: `person:Joda`); José (ID: `person:Joseph.7`); que (ID: `person:Mattatha`); Amós (ID: `person:Amos.2`); Nahum (ID: `person:Nahum`); Nagai (ID: `person:Naggai`); Simeón (ID: `person:Simeon.3`); Judá (ID: `person:Judah.3`); que (ID: `person:Jonam`); que (ID: `person:Maath`); que (ID: `person:Semein`); mas (ID: `person:Er`); fué (ID: `person:Matthat`); que (ID: `person:Rhesa`); Josech (ID: `person:Josech`); Eliacim (ID: `person:Eliakim.2`); Zorobabel (ID: `person:Zerubbabel`); fué (ID: `person:Matthat.2`); Que (ID: `person:Melea`); que (ID: `person:Melchi`); que (ID: `person:Elmadam`); fué (ID: `person:Mattathias.2`); que (ID: `person:Jorim`); Mathusala (ID: `person:Cainan`); Rhesa (ID: `person:Neri`); Nathán (ID: `person:Nathan`); Serug (ID: `person:Serug`); Reu (ID: `person:Reu`); Salmón (ID: `person:Salmon`); Mathusalam (ID: `person:Methuselah`); Jared (ID: `person:Jared`); Lamech (ID: `person:Lamech.2`); Mahalaleel (ID: `person:Mahalalel`); Nachôr (ID: `person:Nahor`); Cainán (ID: `person:Kenan`); Enós (ID: `person:Enosh`); Sela (ID: `person:Shelah.2`); Peleg (ID: `person:Peleg`); Thare (ID: `person:Terah`); Seth (ID: `person:Seth`); Heber (ID: `person:Eber`); Hesrón (ID: `person:Hezron.2`); José (ID: `person:Joseph.4`); Sem (ID: `person:Shem`); Booz (ID: `person:Boaz`); Adam (ID: `person:Adam`)
...
* **Associated ACAI Concepts:** tentar (ID: `keyterm:PutToTheTest`); Pinnacle (ID: `realia:Pinnacle`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); proclamar (ID: `keyterm:Proclaim`); Sarepta (ID: `place:Zarephath`); Naamán (ID: `person:Naaman.3`); Nazaret (ID: `place:Nazareth`); Eliseo (ID: `person:Elisha`); Arameo (ID: `group:Syria`); Galilea (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** mandar (ID: `keyterm:Command`); Capernaum (ID: `place:Capernaum`); Judíos (ID: `place:Judea`); buena noticia (ID: `keyterm:GoodNews`)
...
* **Associated ACAI Concepts:** enfermedad infecciosa de la piel (ID: `keyterm:InfectiousSkinDisease`); Pedro (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Tile (ID: `realia:Tile`); llevar a (ID: `keyterm:BringIn`); Galilea (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** recaudador de impuestos (ID: `keyterm:TaxCollector`); Patch (ID: `realia:Patch`)
...
* **Associated ACAI Concepts:** dichoso (ID: `keyterm:Happy`); Simón (ID: `person:Simon.2`); Judas (ID: `person:Judas`); Mateo (ID: `person:Matthew`); escogido (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); Storeroom (ID: `realia:Storeroom`); misericordioso (ID: `keyterm:Compassionate`); condenar (ID: `keyterm:Condemn`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Naín (ID: `place:Nain`); Judíos (ID: `place:Judea`); Jesús (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** bautista (ID: `keyterm:Baptist`); Juan (ID: `person:John`)
...
* **Associated ACAI Concepts:** Simón (ID: `person:Simon.6`); Alabaster Jar (ID: `realia:AlabasterJar`); deber (ID: `keyterm:Owe`); perdonar (ID: `keyterm:Forgive`)
...
* **Associated ACAI Concepts:** Susana (ID: `person:Susanna`); Chuza (ID: `person:Chuza`); parábola (ID: `keyterm:Parable`); Juana (ID: `person:Joanna`); bueno (ID: `keyterm:Honest`); Daily Life (ID: `keyterm:DailyLife`); María (ID: `person:Marymagdalene`)
...
* **Associated ACAI Concepts:** Gerasa (ID: `place:Gerasa`); Legión (ID: `deity:Legion`); Fetter (ID: `realia:Fetter`); abismo (ID: `keyterm:Abyss`); estar endemoniado (ID: `keyterm:DemonPossessed`); Demons (ID: `deity:Demons`)
...
* **Associated ACAI Concepts:** Jairo (ID: `person:Jairus`); Jesús (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Religious Official (ID: `person:ReligiousOfficial`); Simrat (ID: `group:Samaritan`)
...
* **Associated ACAI Concepts:** Corazín (ID: `place:Chorazin`); hacer la paz (ID: `keyterm:Peace`); Scorpion (ID: `fauna:Scorpion`); Disaster (ID: `keyterm:Disaster`)
...
* **Associated ACAI Concepts:** Inn (ID: `realia:Inn`); mente (ID: `keyterm:Mind.2`); misericordia (ID: `keyterm:Mercy`)
...
* **Associated ACAI Concepts:** Marta (ID: `person:Martha`); María (ID: `person:Mary.3`)
...
* **Associated ACAI Concepts:** Nínive (ID: `group:Nineveh`)
...
* **Associated ACAI Concepts:** Rue (ID: `flora:Rue`); Mint (ID: `flora:Mint`); Zachârías (ID: `person:Zechariah.12`); Plate (ID: `realia:Plate.2`); Disaster (ID: `keyterm:Disaster`); fariseo (ID: `group:Pharisee`)
...
* **Associated ACAI Concepts:** Assarion (ID: `realia:Assarion`); Inner Room (ID: `realia:InnerRoom`); hipocresía (ID: `keyterm:Hypocrisy`); gehenna (ID: `keyterm:Gehenna`); blasfemar (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** Barn (ID: `realia:Barn`); Oven (ID: `realia:Oven`); Storeroom (ID: `realia:Storeroom`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Crow (ID: `fauna:Crow`); Bag (ID: `realia:Bag`); Flock (ID: `fauna:Flock`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Carob (ID: `flora:Carob`); jornalero (ID: `keyterm:HiredWorker`); Cattle (ID: `fauna:Bull`); Daily Life (ID: `keyterm:DailyLife`); Kid (ID: `fauna:Kid`); entrañas (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Kor (ID: `realia:Kor.2`); deber (ID: `keyterm:Owe`); administración (ID: `keyterm:Stewardship`)
...
* **Associated ACAI Concepts:** Lázaro (ID: `person:Lazarus`); hades, mundo de los muertos (ID: `keyterm:WorldOfTheDead`); Dog (ID: `fauna:Dog`); Abraham (ID: `person:Abraham`)
...
* **Associated ACAI Concepts:** Mulberry (ID: `flora:Mulberry`); hacer tropezar (ID: `keyterm:CauseToStumble`); escándalo (ID: `keyterm:StumblingBlock`); deber (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** hacer justicia (ID: `keyterm:GrantJustice`); recaudador de impuestos (ID: `keyterm:TaxCollector`); fariseo (ID: `group:Pharisee`); ayunar (ID: `keyterm:Fast`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Zaqueo (ID: `person:Zacchaeus`); Sycomore Fig (ID: `flora:SycomoreFig`)
...
* **Associated ACAI Concepts:** Bethfagé (ID: `place:Bethphage`); Temple (ID: `realia:Temple`); las (ID: `place:OlivesMount`); altura (ID: `keyterm:Height`); Siege-Works (ID: `realia:Siege-works`); Bethania (ID: `place:Bethany`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Tiberio (ID: `person:Tiberius`); levantamiento (ID: `keyterm:Resurrection`); Jehová (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** servir (ID: `keyterm:Serve`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); pascua (ID: `keyterm:Passover`)
...
* **Associated ACAI Concepts:** Bag (ID: `realia:Bag`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Peter's Second Accuser (ID: `person:SecondAccuserOfPeter`); Jesús (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Barrabás (ID: `person:Barabbas`); Pilato (ID: `person:Pilate`)
...
* **Associated ACAI Concepts:** Criminal on the Cross (ID: `person:Dysmas`); Simón (ID: `person:Simon.5`); Cross (ID: `realia:Cross`); Sour Wine (ID: `realia:SourWine`); Cireneo (ID: `place:Cyrene`); Jesús (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Arimatea (ID: `place:Arimathea`); Aloes (ID: `realia:Aloes`); José (ID: `person:Joseph.6`)
...
* **Associated ACAI Concepts:** Juana (ID: `person:Joanna`); semana (ID: `keyterm:Week`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** Emmaús (ID: `place:Emmaus`); Cleofas (ID: `person:Cleopas`); Stade (ID: `realia:Stade`)
...
* **Associated ACAI Concepts:** Bethania (ID: `place:Bethany`); To Cause to Happen (ID: `keyterm:Happen`); escritura (ID: `keyterm:Scripture`); postrarse (ID: `keyterm:BowDown`)
