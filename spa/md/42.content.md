...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Zachârías (ID: `person:Zechariah`); Elisabet (ID: `person:Elizabeth`); An Angel (ID: `deity:Angel`); Temple (ID: `realia:Temple`); sacerdocio (ID: `keyterm:Priesthood`); temer (ID: `keyterm:Fear`); ser justo (ID: `keyterm:Just`); nombre (ID: `keyterm:Name`); orar (ID: `keyterm:Pray`); Espíritu (ID: `deity:HolySpirit`); Herodes (ID: `person:Herod`); Gabriel (ID: `deity:Gabriel`); quedar libre de castigo (ID: `keyterm:Blameless`); Abías (ID: `person:Abijah.6`); decreto justo (ID: `keyterm:Regulations`); corazón (ID: `keyterm:Heart`); Aarón (ID: `person:Aaron`); buena noticia (ID: `keyterm:GoodNews`); Judíos (ID: `place:Judea`); Elías (ID: `person:Elijah`); mandamiento (ID: `keyterm:Commandment`); Ability (ID: `keyterm:Ability`); Cause of Joy (ID: `keyterm:CauseOfJoy`); To Cause to Happen (ID: `keyterm:Happen`); creer (ID: `keyterm:Believe`); Israel (ID: `person:Israel`); espíritu (ID: `keyterm:Spirit.2`); Juan (ID: `person:John`); Strong Drink (ID: `realia:StrongDrink`); Wine (ID: `realia:Wine`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); María (ID: `person:Mary`); nombre (ID: `keyterm:Name`); favor (ID: `keyterm:Favor`); palabra (ID: `keyterm:Word`); David (ID: `person:David`); Jesús (ID: `person:Jesus.2`); Gabriel (ID: `deity:Gabriel`); Nazaret (ID: `place:Nazareth`); estar comprometido en matrimonio (ID: `keyterm:Engaged`); temer (ID: `keyterm:Fear`); reino (ID: `keyterm:Kingdom`); Elisabet (ID: `person:Elizabeth`); para la eternidad (ID: `keyterm:Always`); Galilea (ID: `place:Galilee`); Ability (ID: `keyterm:Ability`); José (ID: `person:Joseph.4`); Espíritu (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`); santo (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** María (ID: `person:Mary`); Jehová (ID: `deity:Lord`); Elisabet (ID: `person:Elizabeth`); misericordia (ID: `keyterm:Mercy`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); nombre (ID: `keyterm:Name`); corazón (ID: `keyterm:Heart`); dichoso (ID: `keyterm:Happy`); bendecir (ID: `keyterm:Bless`); prontitud (ID: `keyterm:Haste`); Abraham (ID: `person:Abraham`); temer (ID: `keyterm:Fear`); para la eternidad (ID: `keyterm:Always`); mente (ID: `keyterm:Mind.2`); Zachârías (ID: `person:Zechariah`); vacío (ID: `keyterm:Empty`); considerar dichoso (ID: `keyterm:RegardAsHappy`); salvador (ID: `keyterm:Savior`); creer (ID: `keyterm:Believe`); Judá (ID: `person:Judah.4`); Espíritu (ID: `deity:HolySpirit`); Jesús (ID: `person:Jesus.2`); Israel (ID: `person:Israel`); santo (ID: `keyterm:Holy`); espíritu (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); misericordia (ID: `keyterm:Mercy`); nombre (ID: `keyterm:Name`); salvación (ID: `keyterm:Salvation`); santo (ID: `keyterm:Holy`); Zachârías (ID: `person:Zechariah`); bendecir (ID: `keyterm:Bless`); Espíritu (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`); Juan (ID: `person:John`); Judíos (ID: `place:Judea`); Elisabet (ID: `person:Elizabeth`); liberación (ID: `keyterm:Liberation`); altura (ID: `keyterm:Height`); liberar (ID: `keyterm:Deliver`); corazón (ID: `keyterm:Heart`); Circumcision (ID: `keyterm:Circumcision`); perdonar (ID: `keyterm:Forgive`); sacerdocio (ID: `keyterm:Priesthood`); juramento (ID: `keyterm:Oath`); Abraham (ID: `person:Abraham`); temer (ID: `keyterm:Fear`); hacer la paz (ID: `keyterm:Peace`); David (ID: `person:David`); ser justo (ID: `keyterm:Just`); pacto (ID: `keyterm:Covenant`); para la eternidad (ID: `keyterm:Always`); entrañas (ID: `keyterm:Affection`); palabra (ID: `keyterm:Word`); A Group of People (ID: `group:GenericGroup`); profetizar (ID: `keyterm:Speak`); pecar (ID: `keyterm:Sin`); servir (ID: `keyterm:Serve`); espíritu (ID: `keyterm:Spirit.2`); Tablet (ID: `realia:Tablet`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); inscribir (ID: `keyterm:Register`); María (ID: `person:Mary`); gloria del señor (ID: `keyterm:Glory`); palabra (ID: `keyterm:Word`); Manger (ID: `realia:Manger`); Catah (ID: `place:Bethlehem`); temer (ID: `keyterm:Fear`); David (ID: `person:David`); José (ID: `person:Joseph.4`); siendo (ID: `person:Quirinius`); Augusto (ID: `person:Augustus`); salvador (ID: `keyterm:Savior`); corazón (ID: `keyterm:Heart`); cielo (ID: `keyterm:Heaven`); señal (ID: `keyterm:Example`); buena noticia (ID: `keyterm:GoodNews`); Judíos (ID: `place:Judea`); estar comprometido en matrimonio (ID: `keyterm:Engaged`); hacer la paz (ID: `keyterm:Peace`); Nazaret (ID: `place:Nazareth`); Galilea (ID: `place:Galilee`); Heavenly (ID: `keyterm:Heavenly`); Ability (ID: `keyterm:Ability`); A Group of People (ID: `group:GenericGroup`); Cause of Joy (ID: `keyterm:CauseOfJoy`); To Guard Against (ID: `keyterm:GuardAgainst`); altura (ID: `keyterm:Height`); censo (ID: `keyterm:Census`); Jesús (ID: `person:Jesus.2`); Inn (ID: `realia:Inn`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); ley (ID: `keyterm:Law`); Jerusalem (ID: `place:Jerusalem`); Espíritu (ID: `deity:HolySpirit`); Jesús (ID: `person:Jesus.2`); Israel (ID: `person:Israel`); Simeón (ID: `person:Simeon.2`); bendecir (ID: `keyterm:Bless`); nombre (ID: `keyterm:Name`); santo (ID: `keyterm:Holy`); Temple (ID: `realia:Temple`); Ana (ID: `person:Anna`); Phanuel (ID: `person:Phanuel`); corazón (ID: `keyterm:Heart`); ofrenda (ID: `keyterm:Offering`); purificarse (ID: `keyterm:Cleanse.2`); Circumcision (ID: `keyterm:Circumcision`); rogar (ID: `keyterm:AskFor`); sacerdocio (ID: `keyterm:Priesthood`); señal (ID: `keyterm:Example`); Aser (ID: `group:Asher`); hacer la paz (ID: `keyterm:Peace`); ser justo (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); liberación (ID: `keyterm:Liberation`); palabra (ID: `keyterm:Word`); Moisés (ID: `person:Moses`); nación; gente (ID: `group:Gentile`); orar (ID: `keyterm:Pray`); María (ID: `person:Mary`); Life (ID: `keyterm:Life`); levantamiento (ID: `keyterm:Resurrection`); salvación (ID: `keyterm:Salvation`); ayunar (ID: `keyterm:Fast`); gloria del señor (ID: `keyterm:Glory`); Aser (ID: `person:Asher`); servir (ID: `keyterm:Serve`); Dove (ID: `fauna:Dove`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Nazaret (ID: `place:Nazareth`); favor (ID: `keyterm:Favor`); palabra (ID: `keyterm:Word`); Jesús (ID: `person:Jesus.2`); corazón (ID: `keyterm:Heart`); pascua (ID: `keyterm:Passover`); ley (ID: `keyterm:Law`); Galilea (ID: `place:Galilee`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); bautismo (ID: `keyterm:Baptism`); convertirse (ID: `keyterm:Repent`); rectitud (ID: `keyterm:Straightness`); Abilinia (ID: `place:Abilene`); Felipe (ID: `person:Philip.3`); Lisanias (ID: `person:Lysanias`); Tiberio (ID: `person:Tiberius`); Anás (ID: `person:Annas`); Augusto (ID: `person:Augustus`); Herodes (ID: `person:Herod.2`); Jordán (ID: `place:Jordan`); Juan (ID: `person:John`); Traconite (ID: `place:Trachonitis`); Iturea (ID: `place:Ituraea`); perdonar (ID: `keyterm:Forgive`); Caifás (ID: `person:Caiaphas`); proclamar (ID: `keyterm:Proclaim`); Judíos (ID: `place:Judea`); Abraham (ID: `person:Abraham`); Pilato (ID: `person:Pilate`); Isaías (ID: `person:Isaiah`); Zachârías (ID: `person:Zechariah`); Galilea (ID: `place:Galilee`); cuerpo (ID: `keyterm:Body.3`); salvación (ID: `keyterm:Salvation`); recaudador de impuestos (ID: `keyterm:TaxCollector`); pecar (ID: `keyterm:Sin`); palabra (ID: `keyterm:Word`); Scroll (ID: `realia:Scroll`); Snake (ID: `fauna:Snake`); Tunic (ID: `realia:Tunic.2`); Axe (ID: `realia:Axe`)
...
* **Associated ACAI Concepts:** Juan (ID: `person:John`); cielo (ID: `keyterm:Heaven`); bautismo (ID: `keyterm:Baptism`); Espíritu (ID: `deity:HolySpirit`); Jesús (ID: `person:Jesus.2`); Herodías (ID: `person:Herodias`); Herodes (ID: `person:Herod.2`); corazón (ID: `keyterm:Heart`); rogar (ID: `keyterm:AskFor`); amado (ID: `keyterm:Beloved`); orar (ID: `keyterm:Pray`); limpiar (ID: `keyterm:CleanOut`); Strap (ID: `realia:Strap`); Prison (ID: `realia:Prison`); Threshing Floor (ID: `realia:ThreshingFloor`); Winnowing Fork (ID: `realia:WinnowingFork`); Grain (ID: `flora:Grain`); Dove (ID: `fauna:Dove`); Wheat (ID: `flora:Wheat`); Barn (ID: `realia:Barn`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Sela (ID: `person:Shelah.2`); que (ID: `person:Jannai`); Seth (ID: `person:Seth`); Nagai (ID: `person:Naggai`); Elí (ID: `person:Heli`); Booz (ID: `person:Boaz`); que (ID: `person:Menna`); que (ID: `person:Jorim`); Josué (ID: `person:Joshua`); Serug (ID: `person:Serug`); que (ID: `person:Melchi.2`); Rhesa (ID: `person:Neri`); fué (ID: `person:Mattathias.2`); Salmón (ID: `person:Salmon`); Josech (ID: `person:Josech`); José (ID: `person:Joseph.4`); Maat (ID: `person:Joda`); Que (ID: `person:Joanan`); Cainán (ID: `person:Kenan`); Mathusalam (ID: `person:Methuselah`); que (ID: `person:Melchi`); Judá (ID: `person:Judah.3`); Levitas (ID: `person:Levi`); Sem (ID: `person:Shem`); Eliezer (ID: `person:Eliezer`); José (ID: `person:Joseph.8`); Lamech (ID: `person:Lamech.2`); que (ID: `person:Maath`); Nathán (ID: `person:Nathan`); Zorobabel (ID: `person:Zerubbabel`); Hesrón (ID: `person:Hezron.2`); Adam (ID: `person:Adam`); Eliacim (ID: `person:Eliakim.2`); fué (ID: `person:Matthat`); Jared (ID: `person:Jared`); Simeón (ID: `person:Simeon.3`); Levitas (ID: `person:Levi.2`); Que (ID: `person:Melea`); que (ID: `person:Mattatha`); que (ID: `person:Jonam`); Amós (ID: `person:Amos.2`); fué (ID: `person:Mattathias`); Reu (ID: `person:Reu`); Mahalaleel (ID: `person:Mahalalel`); mas (ID: `person:Er`); José (ID: `person:Joseph.7`); Enós (ID: `person:Enosh`); que (ID: `person:Cosam`); fué (ID: `person:Matthat.2`); Nachôr (ID: `person:Nahor`); que (ID: `person:Rhesa`); Heber (ID: `person:Eber`); que (ID: `person:Esli`); Thare (ID: `person:Terah`); que (ID: `person:Semein`); Mathusala (ID: `person:Cainan`); Peleg (ID: `person:Peleg`); que (ID: `person:Addi`); Salathiel (ID: `person:Shealtiel`); que (ID: `person:Elmadam`); Nahum (ID: `person:Nahum`); Isaac (ID: `person:Isaac`); Nahasón (ID: `person:Nahshon`); Jehová (ID: `deity:Lord`); Aminadab (ID: `person:Amminadab`); Abraham (ID: `person:Abraham`); Israel (ID: `person:Israel`); Arphaxad (ID: `person:Arpachshad`); Noé (ID: `person:Noah`); Isaí (ID: `person:Jesse`); David (ID: `person:David`); Henoch (ID: `person:Enoch.2`); Ram (ID: `person:Ram`); Phares (ID: `person:Perez`); Obed (ID: `person:Obed`); Judá (ID: `person:Judah.4`); Jesús (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); tentar (ID: `keyterm:PutToTheTest`); mandar (ID: `keyterm:Command`); postrarse (ID: `keyterm:BowDown`); Ability (ID: `keyterm:Ability`); Jehová (ID: `deity:Lord`); autoridad (ID: `keyterm:Authority.2`); sacerdocio (ID: `keyterm:Priesthood`); reino (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); guardar cuidadosamente (ID: `keyterm:Protect`); Jerusalem (ID: `place:Jerusalem`); Life (ID: `keyterm:Life`); Espíritu (ID: `deity:HolySpirit`); Jordán (ID: `place:Jordan`); gloria del señor (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); proclamar (ID: `keyterm:Proclaim`); Elías (ID: `person:Elijah`); Jehová (ID: `deity:Lord`); Espíritu (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`); Scroll (ID: `realia:Scroll`); Eliseo (ID: `person:Elisha`); Naamán (ID: `person:Naaman.3`); Arameo (ID: `group:Syria`); Nazaret (ID: `place:Nazareth`); Galilea (ID: `place:Galilee`); Sarepta (ID: `place:Zarephath`); purificarse (ID: `keyterm:Cleanse.2`); dar testimonio (ID: `keyterm:BearWitness`); escritura (ID: `keyterm:Scripture`); cielo (ID: `keyterm:Heaven`); buena noticia (ID: `keyterm:GoodNews`); Isaías (ID: `person:Isaiah`); favor (ID: `keyterm:Favor`); fidelidad (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); Sidón (ID: `place:Sidon`); José (ID: `person:Joseph.4`); Capernaum (ID: `place:Capernaum`); To Cause to Happen (ID: `keyterm:Happen`); parábola (ID: `keyterm:Parable`); Jesús (ID: `person:Jesus.2`); sábado (ID: `keyterm:Sabbath`); amén (ID: `keyterm:Surely`); ungido (ID: `keyterm:Anointed`); gloria del señor (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** mandar (ID: `keyterm:Command`); Demons (ID: `deity:Demons`); Jesús (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); autoridad (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); Jehová (ID: `deity:Lord`); servir (ID: `keyterm:Serve`); buena noticia (ID: `keyterm:GoodNews`); Judíos (ID: `place:Judea`); Capernaum (ID: `place:Capernaum`); rogar (ID: `keyterm:AskFor`); proclamar (ID: `keyterm:Proclaim`); reino (ID: `keyterm:Kingdom`); Nazaret (ID: `place:Nazareth`); Galilea (ID: `place:Galilee`); contaminación (ID: `keyterm:Defilement`); sábado (ID: `keyterm:Sabbath`); santo (ID: `keyterm:Holy`); Pedro (ID: `person:Peter`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Casting Net (ID: `realia:CastingNet`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); purificarse (ID: `keyterm:Cleanse.2`); Jesús (ID: `person:Jesus.2`); Fish (ID: `fauna:Fish`); enfermedad infecciosa de la piel (ID: `keyterm:InfectiousSkinDisease`); dar testimonio (ID: `keyterm:BearWitness`); ofrenda (ID: `keyterm:Offering`); rogar (ID: `keyterm:AskFor`); Zebedeo (ID: `person:Zebedee`); Juan (ID: `person:John.2`); temer (ID: `keyterm:Fear`); Genezaret (ID: `place:Gennesaret`); Moisés (ID: `person:Moses`); Jehová (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); servir (ID: `keyterm:Serve`); Jacobo (ID: `person:James`); palabra (ID: `keyterm:Word`)
...
* **Associated ACAI Concepts:** perdonar (ID: `keyterm:Forgive`); Jehová (ID: `deity:Lord`); pecar (ID: `keyterm:Sin`); llevar a (ID: `keyterm:BringIn`); Bed (ID: `realia:Bed`); fariseo (ID: `group:Pharisee`); Ability (ID: `keyterm:Ability`); Jesús (ID: `person:Jesus.2`); gloria del señor (ID: `keyterm:Glory`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Galilea (ID: `place:Galilee`); corazón (ID: `keyterm:Heart`); autoridad (ID: `keyterm:Authority.2`); blasfemar (ID: `keyterm:Blaspheme`); Judíos (ID: `place:Judea`); temer (ID: `keyterm:Fear`); Jerusalem (ID: `place:Jerusalem`); creer (ID: `keyterm:Believe`); Tile (ID: `realia:Tile`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** recaudador de impuestos (ID: `keyterm:TaxCollector`); ayunar (ID: `keyterm:Fast`); fariseo (ID: `group:Pharisee`); Mateo (ID: `person:Matthew`); ser discípulo (ID: `keyterm:Disciple`); Skin-Bottle (ID: `realia:Skin-bottle`); Must (ID: `realia:Must`); convertirse (ID: `keyterm:Repent`); ser justo (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); nombre (ID: `keyterm:Name`); orar (ID: `keyterm:Pray`); oficina de impuestos (ID: `keyterm:TaxOffice`); Good (ID: `keyterm:Good`); parábola (ID: `keyterm:Parable`); Jesús (ID: `person:Jesus.2`); Juan (ID: `person:John`); Patch (ID: `realia:Patch`); Clothing (ID: `realia:Clothing`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** sábado (ID: `keyterm:Sabbath`); Jesús (ID: `person:Jesus.2`); Be Lawful (ID: `keyterm:Lawful`); fariseo (ID: `group:Pharisee`); Do Good (ID: `keyterm:DoGood`); salvación (ID: `keyterm:Salvation`); David (ID: `person:David`); Jehová (ID: `deity:Lord`); ser discípulo (ID: `keyterm:Disciple`); Life (ID: `keyterm:Life`); servir (ID: `keyterm:Serve`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** dichoso (ID: `keyterm:Happy`); Disaster (ID: `keyterm:Disaster`); ser discípulo (ID: `keyterm:Disciple`); Jehová (ID: `deity:Lord`); Jacobo (ID: `person:James.2`); escogido (ID: `keyterm:Chosen`); Mateo (ID: `person:Matthew`); Judas (ID: `person:Judas`); Simón (ID: `person:Simon.2`); Bartolomé (ID: `person:Bartholomew`); Alfeo (ID: `person:Alphaeus`); cielo (ID: `keyterm:Heaven`); rogar (ID: `keyterm:AskFor`); Juan (ID: `person:John.2`); Judíos (ID: `place:Judea`); Andrés (ID: `person:Andrew`); reino (ID: `keyterm:Kingdom`); Judas (ID: `person:Judas.2`); Jerusalem (ID: `place:Jerusalem`); nombre (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Tomás (ID: `person:Thomas`); orar (ID: `keyterm:Pray`); Sidón (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); Felipe (ID: `person:Philip`); Jacobo (ID: `person:James`); Pedro (ID: `person:Peter`); servir (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** favor (ID: `keyterm:Favor`); amar (ID: `keyterm:Love`); Do Good (ID: `keyterm:DoGood`); Jehová (ID: `deity:Lord`); Good (ID: `keyterm:Good`); House (ID: `realia:House`); Beam (ID: `realia:Beam`); Foundation (ID: `realia:Foundation`); condenar (ID: `keyterm:Condemn`); misericordioso (ID: `keyterm:Compassionate`); corazón (ID: `keyterm:Heart`); perdonar (ID: `keyterm:Forgive`); esperanza (ID: `keyterm:Hope`); bendecir (ID: `keyterm:Bless`); decidir (ID: `keyterm:Decided`); orar (ID: `keyterm:Pray`); parábola (ID: `keyterm:Parable`); ser discípulo (ID: `keyterm:Disciple`); Cloak (ID: `realia:Cloak`); Storeroom (ID: `realia:Storeroom`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Fig (ID: `flora:Fig`); Tunic (ID: `realia:Tunic.2`); Vine (ID: `flora:Vine`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Judíos (ID: `place:Judea`); Naín (ID: `place:Nain`); autoridad (ID: `keyterm:Authority.2`); mandar (ID: `keyterm:Command`); temer (ID: `keyterm:Fear`); entrañas (ID: `keyterm:Affection`); Ability (ID: `keyterm:Ability`); A Group of People (ID: `group:GenericGroup`); Jehová (ID: `deity:Lord`); Capernaum (ID: `place:Capernaum`); creer (ID: `keyterm:Believe`); salvación (ID: `keyterm:Salvation`); Jews (ID: `group:Jews`); Israel (ID: `person:Israel`); ser discípulo (ID: `keyterm:Disciple`); gloria del señor (ID: `keyterm:Glory`); amar (ID: `keyterm:Love`); palabra (ID: `keyterm:Word`); Bier (ID: `realia:Bier`); Synagogue (ID: `realia:Synagogue`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Juan (ID: `person:John`); Jehová (ID: `deity:Lord`); bautista (ID: `keyterm:Baptist`); An Angel (ID: `deity:Angel`); bautismo (ID: `keyterm:Baptism`); recaudador de impuestos (ID: `keyterm:TaxCollector`); purificarse (ID: `keyterm:Cleanse.2`); perdonar (ID: `keyterm:Forgive`); dichoso (ID: `keyterm:Happy`); buena noticia (ID: `keyterm:GoodNews`); A Group of Disciples (ID: `group:GenericDisciples`); fariseo (ID: `group:Pharisee`); reino (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); ser justo (ID: `keyterm:Just`); levantamiento (ID: `keyterm:Resurrection`); Jesús (ID: `person:Jesus.2`); Obey Righteous Commands (ID: `keyterm:ObeyRighteousCommands`); ser discípulo (ID: `keyterm:Disciple`); glorioso (ID: `keyterm:Glorious`); servir (ID: `keyterm:Serve`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Palace (ID: `realia:Palace`); Reed (ID: `flora:Reed`); Flute (ID: `realia:Flute`)
...
* **Associated ACAI Concepts:** perdonar (ID: `keyterm:Forgive`); Simón (ID: `person:Simon.6`); fariseo (ID: `group:Pharisee`); pecar (ID: `keyterm:Sin`); House (ID: `realia:House`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); ungido (ID: `keyterm:Anointed`); amar (ID: `keyterm:Love`); deber (ID: `keyterm:Owe`); rogar (ID: `keyterm:AskFor`); hacer la paz (ID: `keyterm:Peace`); decidir (ID: `keyterm:Decided`); creer (ID: `keyterm:Believe`); salvación (ID: `keyterm:Salvation`); Jesús (ID: `person:Jesus.2`); Alabaster Jar (ID: `realia:AlabasterJar`); Temple (ID: `realia:Temple`); Denarius (ID: `realia:Denarius`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** parábola (ID: `keyterm:Parable`); Jehová (ID: `deity:Lord`); corazón (ID: `keyterm:Heart`); reino (ID: `keyterm:Kingdom`); creer (ID: `keyterm:Believe`); servir (ID: `keyterm:Serve`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Grain (ID: `flora:Grain`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Barley (ID: `flora:Barley`); Chuza (ID: `person:Chuza`); bueno (ID: `keyterm:Honest`); Juana (ID: `person:Joanna`); Daily Life (ID: `keyterm:DailyLife`); María (ID: `person:Marymagdalene`); Susana (ID: `person:Susanna`); cielo (ID: `keyterm:Heaven`); buena noticia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); Demons (ID: `deity:Demons`); tentar (ID: `keyterm:PutToTheTest`); Herodes (ID: `person:Herod.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`); salvación (ID: `keyterm:Salvation`); ser discípulo (ID: `keyterm:Disciple`); Lampstand (ID: `realia:Lampstand.2`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); Jesús (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); temer (ID: `keyterm:Fear`); Gerasa (ID: `place:Gerasa`); Jehová (ID: `deity:Lord`); Pig (ID: `fauna:Pig`); House (ID: `realia:House`); Jackal (ID: `fauna:Jackal`); Ship (ID: `realia:Ship`); estar endemoniado (ID: `keyterm:DemonPossessed`); abismo (ID: `keyterm:Abyss`); Legión (ID: `deity:Legion`); A Man (ID: `person:GenericMale`); mandar (ID: `keyterm:Command`); proclamar (ID: `keyterm:Proclaim`); Galilea (ID: `place:Galilee`); nombre (ID: `keyterm:Name`); creer (ID: `keyterm:Believe`); salvación (ID: `keyterm:Salvation`); ser discípulo (ID: `keyterm:Disciple`); Fetter (ID: `realia:Fetter`); Clothing (ID: `realia:Clothing`); Temple (ID: `realia:Temple`); Grave (ID: `realia:Grave`); Chain (ID: `realia:Chain`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); sangre (ID: `keyterm:Blood`); creer (ID: `keyterm:Believe`); salvación (ID: `keyterm:Salvation`); Pedro (ID: `person:Peter`); House (ID: `realia:House`); Synagogue (ID: `realia:Synagogue`); Jairo (ID: `person:Jairus`); rogar (ID: `keyterm:AskFor`); Juan (ID: `person:John.2`); temer (ID: `keyterm:Fear`); hacer la paz (ID: `keyterm:Peace`); nombre (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Daily Life (ID: `keyterm:DailyLife`); Life (ID: `keyterm:Life`); Jacobo (ID: `person:James`); espíritu (ID: `keyterm:Spirit.2`); servir (ID: `keyterm:Serve`); Tassel (ID: `realia:Tassel`); Temple (ID: `realia:Temple`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); Herodes (ID: `person:Herod.2`); Jehová (ID: `deity:Lord`); Juan (ID: `person:John`); ser discípulo (ID: `keyterm:Disciple`); servir (ID: `keyterm:Serve`); Fish (ID: `fauna:Fish`); dar testimonio (ID: `keyterm:BearWitness`); cielo (ID: `keyterm:Heaven`); autoridad (ID: `keyterm:Authority.2`); Bethsaida (ID: `place:Bethsaida`); buena noticia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); bendecir (ID: `keyterm:Bless`); A Group of Disciples (ID: `group:GenericDisciples`); Elías (ID: `person:Elijah`); Demons (ID: `deity:Demons`); Ability (ID: `keyterm:Ability`); levantamiento (ID: `keyterm:Resurrection`); Staff (ID: `realia:Staff`); House (ID: `realia:House`); Tunic (ID: `realia:Tunic.2`); Bag (ID: `realia:Bag`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); desechar (ID: `keyterm:Reject`); mandar (ID: `keyterm:Command`); verdadero (ID: `keyterm:True`); A Group of Disciples (ID: `group:GenericDisciples`); Elías (ID: `person:Elijah`); reino (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); bautista (ID: `keyterm:Baptist`); Ability (ID: `keyterm:Ability`); orar (ID: `keyterm:Pray`); Life (ID: `keyterm:Life`); levantamiento (ID: `keyterm:Resurrection`); salvación (ID: `keyterm:Salvation`); Jesús (ID: `person:Jesus.2`); santo (ID: `keyterm:Holy`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); gloria del señor (ID: `keyterm:Glory`); Juan (ID: `person:John`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Elías (ID: `person:Elijah`); Jesús (ID: `person:Jesus.2`); orar (ID: `keyterm:Pray`); Moisés (ID: `person:Moses`); gloria del señor (ID: `keyterm:Glory`); To Cause to Happen (ID: `keyterm:Happen`); temer (ID: `keyterm:Fear`); escogido (ID: `keyterm:Chosen`); Jacobo (ID: `person:James`); Jerusalem (ID: `place:Jerusalem`); Juan (ID: `person:John.2`); Clothing (ID: `realia:Clothing`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); nombre (ID: `keyterm:Name`); Demons (ID: `deity:Demons`); ser discípulo (ID: `keyterm:Disciple`); corazón (ID: `keyterm:Heart`); rogar (ID: `keyterm:AskFor`); temer (ID: `keyterm:Fear`); palabra (ID: `keyterm:Word`); mandar (ID: `keyterm:Command`); Jehová (ID: `deity:Lord`); Juan (ID: `person:John.2`); arriba (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** cielo (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); Jesús (ID: `person:Jesus.2`); Jehová (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Simrat (ID: `group:Samaritan`); Religious Official (ID: `person:ReligiousOfficial`); A Man (ID: `person:GenericMale`); Samaria (ID: `place:Samaria`); mandar (ID: `keyterm:Command`); Jacobo (ID: `person:James`); An Angel (ID: `deity:Angel`); Juan (ID: `person:John.2`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Mattock (ID: `realia:Mattock`); Jackal (ID: `fauna:Jackal`)
...
* **Associated ACAI Concepts:** cielo (ID: `keyterm:Heaven`); Jehová (ID: `deity:Lord`); hacer la paz (ID: `keyterm:Peace`); reino (ID: `keyterm:Kingdom`); nombre (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Sidón (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); House (ID: `realia:House`); Corazín (ID: `place:Chorazin`); Disaster (ID: `keyterm:Disaster`); hacer lo malo (ID: `keyterm:ActWickedly`); autoridad (ID: `keyterm:Authority.2`); rogar (ID: `keyterm:AskFor`); convertirse (ID: `keyterm:Repent`); Bethsaida (ID: `place:Bethsaida`); tribunal de justicia (ID: `keyterm:CourtCase`); dichoso (ID: `keyterm:Happy`); Demons (ID: `deity:Demons`); Sodoma (ID: `place:Sodom`); Hell (ID: `place:Hell`); hades, mundo de los muertos (ID: `keyterm:WorldOfTheDead`); Satanás (ID: `deity:Satan`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Capernaum (ID: `place:Capernaum`); Espíritu (ID: `deity:HolySpirit`); Jesús (ID: `person:Jesus.2`); juicio (ID: `keyterm:Judgment`); ser discípulo (ID: `keyterm:Disciple`); servir (ID: `keyterm:Serve`); Scorpion (ID: `fauna:Scorpion`); Wolf (ID: `fauna:Wolf`); Snake (ID: `fauna:Snake`); Sheep (ID: `fauna:Lamb`); Sackcloth (ID: `realia:Sackcloth`); Bag (ID: `realia:Bag`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** A Priest (ID: `person:GenericPriest`); A Scribe (ID: `person:Scribe`); Jesús (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Inn (ID: `realia:Inn`); misericordia (ID: `keyterm:Mercy`); mente (ID: `keyterm:Mind.2`); corazón (ID: `keyterm:Heart`); Samaria (ID: `place:Samaria`); Simrat (ID: `group:Samaritan`); Jericó (ID: `place:Jericho`); ser justo (ID: `keyterm:Just`); para la eternidad (ID: `keyterm:Always`); Jerusalem (ID: `place:Jerusalem`); Levitas (ID: `group:Levi`); entrañas (ID: `keyterm:Affection`); Jehová (ID: `deity:Lord`); Levitas (ID: `person:Levi.3`); ley (ID: `keyterm:Law`); amar (ID: `keyterm:Love`); Wine (ID: `realia:Wine`); Denarius (ID: `realia:Denarius`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Marta (ID: `person:Martha`); María (ID: `person:Mary.3`); Jesús (ID: `person:Jesus.2`); nombre (ID: `keyterm:Name`); Good (ID: `keyterm:Good`); mandar (ID: `keyterm:Command`); escogido (ID: `keyterm:Chosen`); servir (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); Jehová (ID: `deity:Lord`); A Group of Disciples (ID: `group:GenericDisciples`); nombre (ID: `keyterm:Name`); cielo (ID: `keyterm:Heaven`); Espíritu (ID: `deity:HolySpirit`); reino (ID: `keyterm:Kingdom`); llevar a (ID: `keyterm:BringIn`); perdonar (ID: `keyterm:Forgive`); pecar (ID: `keyterm:Sin`); santo (ID: `keyterm:Holy`); tentar (ID: `keyterm:PutToTheTest`); ser discípulo (ID: `keyterm:Disciple`); Juan (ID: `person:John`); Door (ID: `realia:Door`); Snake (ID: `fauna:Snake`); Fish (ID: `fauna:Fish`); Scorpion (ID: `fauna:Scorpion`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); reino (ID: `keyterm:Kingdom`); Satanás (ID: `deity:Satan`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); corazón (ID: `keyterm:Heart`); cielo (ID: `keyterm:Heaven`); hacer la paz (ID: `keyterm:Peace`); A Group of People (ID: `group:GenericGroup`); persuadir (ID: `keyterm:Persuade`); Jehová (ID: `deity:Lord`); señal (ID: `keyterm:Example`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Jonás (ID: `person:Jonah.2`); Nínive (ID: `group:Nineveh`); Nínive (ID: `place:Nineveh`); dichoso (ID: `keyterm:Happy`); tribunal de justicia (ID: `keyterm:CourtCase`); juicio (ID: `keyterm:Judgment`); cuerpo (ID: `keyterm:Body.3`); señal (ID: `keyterm:Example`); Sheba (ID: `place:Sheba.2`); A Woman (ID: `person:GenericFemale`); Salomón (ID: `person:Solomon`); Jehová (ID: `deity:Lord`); convertirse (ID: `keyterm:Repent`); proclamar (ID: `keyterm:Proclaim`); reina (ID: `person:QueenOfSheba`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** fariseo (ID: `group:Pharisee`); Disaster (ID: `keyterm:Disaster`); Jehová (ID: `deity:Lord`); sangre (ID: `keyterm:Blood`); amar (ID: `keyterm:Love`); Zachârías (ID: `person:Zechariah.12`); purificarse (ID: `keyterm:Cleanse.2`); rogar (ID: `keyterm:AskFor`); testimonio (ID: `keyterm:Witness`); Abel (ID: `person:Abel`); Ability (ID: `keyterm:Ability`); limpio (ID: `keyterm:Clean`); A Scribe (ID: `person:Scribe`); Jesús (ID: `person:Jesus.2`); juicio (ID: `keyterm:Judgment`); Mint (ID: `flora:Mint`); Rue (ID: `flora:Rue`); Plate (ID: `realia:Plate.2`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`); Grave (ID: `realia:Grave`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** temer (ID: `keyterm:Fear`); Jehová (ID: `deity:Lord`); autoridad (ID: `keyterm:Authority.2`); An Angel (ID: `deity:Angel`); Ability (ID: `keyterm:Ability`); Espíritu (ID: `deity:HolySpirit`); Sparrow (ID: `fauna:Sparrow`); hipocresía (ID: `keyterm:Hypocrisy`); blasfemar (ID: `keyterm:Blaspheme`); gehenna (ID: `keyterm:Gehenna`); perdonar (ID: `keyterm:Forgive`); proclamar (ID: `keyterm:Proclaim`); fariseo (ID: `group:Pharisee`); Hell (ID: `place:Hell`); cuerpo (ID: `keyterm:Body.3`); llevar a (ID: `keyterm:BringIn`); ser discípulo (ID: `keyterm:Disciple`); Assarion (ID: `realia:Assarion`); Inner Room (ID: `realia:InnerRoom`); Synagogue (ID: `realia:Synagogue`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); Life (ID: `keyterm:Life`); reino (ID: `keyterm:Kingdom`); cuerpo (ID: `keyterm:Body.3`); Barn (ID: `realia:Barn`); corazón (ID: `keyterm:Heart`); cielo (ID: `keyterm:Heaven`); A Person (ID: `person:GenericPerson`); mandar (ID: `keyterm:Command`); temer (ID: `keyterm:Fear`); de poca fe (ID: `keyterm:HavingLittleFaith`); Ability (ID: `keyterm:Ability`); parábola (ID: `keyterm:Parable`); Salomón (ID: `person:Solomon`); ser discípulo (ID: `keyterm:Disciple`); gloria del señor (ID: `keyterm:Glory`); Crow (ID: `fauna:Crow`); Oven (ID: `realia:Oven`); Cubit (ID: `realia:Cubit.2`); Bag (ID: `realia:Bag`); Wild Flower (ID: `flora:WildFlower`); Flock (ID: `fauna:Flock`); Storeroom (ID: `realia:Storeroom`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`); Bird (ID: `fauna:Bird`); Wheat (ID: `flora:Wheat`); Grass (ID: `flora:Grass`); Rooster (ID: `fauna:Rooster`); Moth (ID: `fauna:Moth`)
...
* **Associated ACAI Concepts:** dichoso (ID: `keyterm:Happy`); corazón (ID: `keyterm:Heart`); cielo (ID: `keyterm:Heaven`); verdadero (ID: `keyterm:True`); arriba (ID: `keyterm:Unfaithful`); liberar (ID: `keyterm:SetFree`); hacer la paz (ID: `keyterm:Peace`); decidir (ID: `keyterm:Decided`); ser justo (ID: `keyterm:Just`); lealtad (ID: `keyterm:Faithfulness`); discernir (ID: `keyterm:Interpret`); bautismo (ID: `keyterm:Baptism`); parábola (ID: `keyterm:Parable`); Jesús (ID: `person:Jesus.2`); amén (ID: `keyterm:Surely`); Pedro (ID: `person:Peter`); servir (ID: `keyterm:Serve`); Lepton (ID: `realia:Lepton`); Prison (ID: `realia:Prison`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** convertirse (ID: `keyterm:Repent`); galileo (ID: `group:Galilee`); Galilea (ID: `place:Galilee`); Fig (ID: `flora:Fig`); sangre (ID: `keyterm:Blood`); ofrenda (ID: `keyterm:Offering`); Siloam (ID: `place:Siloam`); parábola (ID: `keyterm:Parable`); Pilato (ID: `person:Pilate`); Jerusalem (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Watch-Tower (ID: `realia:Watch-tower`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** sábado (ID: `keyterm:Sabbath`); Jesús (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Religious Official (ID: `person:ReligiousOfficial`); Abraham (ID: `person:Abraham`); Satanás (ID: `deity:Satan`); Jehová (ID: `deity:Lord`); gloria del señor (ID: `keyterm:Glory`); glorioso (ID: `keyterm:Glorious`); servir (ID: `keyterm:Serve`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Donkey (ID: `fauna:Donkey`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); Jehová (ID: `deity:Lord`); Door (ID: `realia:Door`); Abraham (ID: `person:Abraham`); cielo (ID: `keyterm:Heaven`); salvación (ID: `keyterm:Salvation`); A Person (ID: `person:GenericPerson`); injusticia (ID: `keyterm:UnjustDeed`); Israel (ID: `person:Israel`); Jerusalem (ID: `place:Jerusalem`); Isaac (ID: `person:Isaac`); Saton (ID: `realia:Saton`); Mustard (ID: `flora:Mustard`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); nombre (ID: `keyterm:Name`); fariseo (ID: `group:Pharisee`); Jesús (ID: `person:Jesus.2`); Demons (ID: `deity:Demons`); Herodes (ID: `person:Herod.2`); Jehová (ID: `deity:Lord`); bendecir (ID: `keyterm:Bless`); Rooster (ID: `fauna:Rooster`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Jackal (ID: `fauna:Jackal`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** sábado (ID: `keyterm:Sabbath`); fariseo (ID: `group:Pharisee`); levantamiento (ID: `keyterm:Resurrection`); parábola (ID: `keyterm:Parable`); Jesús (ID: `person:Jesus.2`); ser justo (ID: `keyterm:Just`); Be Lawful (ID: `keyterm:Lawful`); dichoso (ID: `keyterm:Happy`); escogido (ID: `keyterm:Chosen`); gloria del señor (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); reino (ID: `keyterm:Kingdom`); A Scribe (ID: `person:Scribe`); Jehová (ID: `deity:Lord`); dichoso (ID: `keyterm:Happy`); discernir (ID: `keyterm:Interpret`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); rogar (ID: `keyterm:AskFor`); hacer la paz (ID: `keyterm:Peace`); Life (ID: `keyterm:Life`); Watch-Tower (ID: `realia:Watch-tower`); Tower (ID: `realia:Tower`); Cross (ID: `realia:Cross`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Cause of Joy (ID: `keyterm:CauseOfJoy`); convertirse (ID: `keyterm:Repent`); Drachma (ID: `realia:Drachma`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); cielo (ID: `keyterm:Heaven`); fariseo (ID: `group:Pharisee`); parábola (ID: `keyterm:Parable`); recaudador de impuestos (ID: `keyterm:TaxCollector`); Jehová (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); ser justo (ID: `keyterm:Just`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Cattle (ID: `fauna:Bull`); Daily Life (ID: `keyterm:DailyLife`); jornalero (ID: `keyterm:HiredWorker`); cielo (ID: `keyterm:Heaven`); Life (ID: `keyterm:Life`); pecar (ID: `keyterm:Sin`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); entrañas (ID: `keyterm:Affection`); rogar (ID: `keyterm:AskFor`); mandamiento (ID: `keyterm:Commandment`); servir como esclavo (ID: `keyterm:Serve.2`); Carob (ID: `flora:Carob`); Kid (ID: `fauna:Kid`); Seal (ID: `realia:Seal`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`); Cloak (ID: `realia:Cloak`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** administración (ID: `keyterm:Stewardship`); lealtad (ID: `keyterm:Faithfulness`); deber (ID: `keyterm:Owe`); injusticia (ID: `keyterm:UnjustDeed`); para la eternidad (ID: `keyterm:Always`); Kor (ID: `realia:Kor.2`); creer (ID: `keyterm:Believe`); autoridad (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); verdadero (ID: `keyterm:True`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Temple (ID: `realia:Temple`); Olive Oil (ID: `realia:OliveOil`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); ley (ID: `keyterm:Law`); prostitución (ID: `keyterm:Fornication`); corazón (ID: `keyterm:Heart`); abominación (ID: `keyterm:Abomination`); cielo (ID: `keyterm:Heaven`); fariseo (ID: `group:Pharisee`); reino (ID: `keyterm:Kingdom`); ser justo (ID: `keyterm:Just`); buena noticia (ID: `keyterm:GoodNews`); servir como esclavo (ID: `keyterm:Serve.2`); amante del dinero (ID: `keyterm:LovingWealth`); amar (ID: `keyterm:Love`); Juan (ID: `person:John`)
...
* **Associated ACAI Concepts:** Abraham (ID: `person:Abraham`); Lázaro (ID: `person:Lazarus`); rogar (ID: `keyterm:AskFor`); Moisés (ID: `person:Moses`); hades, mundo de los muertos (ID: `keyterm:WorldOfTheDead`); testificar solemnemente (ID: `keyterm:Declare`); nombre (ID: `keyterm:Name`); Hell (ID: `place:Hell`); persuadir (ID: `keyterm:Persuade`); convertirse (ID: `keyterm:Repent`); An Angel (ID: `deity:Angel`); misericordia (ID: `keyterm:Mercy`); exhortar (ID: `keyterm:Encourage`); Life (ID: `keyterm:Life`); Dog (ID: `fauna:Dog`); Temple (ID: `realia:Temple`); Linen (ID: `realia:Linen`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** perdonar (ID: `keyterm:Forgive`); convertirse (ID: `keyterm:Repent`); creer (ID: `keyterm:Believe`); Jesús (ID: `person:Jesus.2`); pecar (ID: `keyterm:Sin`); deber (ID: `keyterm:Ought`); escándalo (ID: `keyterm:StumblingBlock`); hacer tropezar (ID: `keyterm:CauseToStumble`); mandar (ID: `keyterm:Command`); A Group of Disciples (ID: `group:GenericDisciples`); Disaster (ID: `keyterm:Disaster`); favor (ID: `keyterm:Favor`); ser discípulo (ID: `keyterm:Disciple`); servir (ID: `keyterm:Serve`); Mulberry (ID: `flora:Mulberry`); Mustard (ID: `flora:Mustard`); Sheep (ID: `fauna:Lamb`); Grain (ID: `flora:Grain`); Goat (ID: `fauna:Goat`); Hand-Mill (ID: `realia:Hand-mill`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** purificarse (ID: `keyterm:Cleanse.2`); Jesús (ID: `person:Jesus.2`); Samaria (ID: `place:Samaria`); Jehová (ID: `deity:Lord`); gloria del señor (ID: `keyterm:Glory`); creer (ID: `keyterm:Believe`); salvación (ID: `keyterm:Salvation`); misericordia (ID: `keyterm:Mercy`); Jerusalem (ID: `place:Jerusalem`); Simrat (ID: `group:Samaritan`); Galilea (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** Lot (ID: `person:Lot`); reino (ID: `keyterm:Kingdom`); Noé (ID: `person:Noah`); cielo (ID: `keyterm:Heaven`); Jehová (ID: `deity:Lord`); fariseo (ID: `group:Pharisee`); cuerpo (ID: `keyterm:Body.3`); observación (ID: `keyterm:Observation`); dar vida (ID: `keyterm:Alive`); desechar (ID: `keyterm:Reject`); ser discípulo (ID: `keyterm:Disciple`); Sodoma (ID: `place:Sodom`); Life (ID: `keyterm:Life`); House (ID: `realia:House`); Vulture (ID: `fauna:Vulture`); Bed (ID: `realia:Bed`); Boat (ID: `realia:Boat`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); hacer justicia (ID: `keyterm:GrantJustice`); recaudador de impuestos (ID: `keyterm:TaxCollector`); orar (ID: `keyterm:Pray`); fariseo (ID: `group:Pharisee`); temer (ID: `keyterm:Fear`); reino (ID: `keyterm:Kingdom`); ser justo (ID: `keyterm:Just`); parábola (ID: `keyterm:Parable`); Jesús (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); ayunar (ID: `keyterm:Fast`); corazón (ID: `keyterm:Heart`); cielo (ID: `keyterm:Heaven`); perdonar (ID: `keyterm:Forgive`); mandar (ID: `keyterm:Command`); persuadir (ID: `keyterm:Persuade`); escogido (ID: `keyterm:Chosen`); injusticia (ID: `keyterm:UnjustDeed`); creer (ID: `keyterm:Believe`); semana (ID: `keyterm:Week`); amén (ID: `keyterm:Surely`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`); Jesús (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); para la eternidad (ID: `keyterm:Always`); Life (ID: `keyterm:Life`); cielo (ID: `keyterm:Heaven`); mandamiento (ID: `keyterm:Commandment`); salvación (ID: `keyterm:Salvation`); Ability (ID: `keyterm:Ability`); amén (ID: `keyterm:Surely`); prostitución (ID: `keyterm:Fornication`); Rich Young Ruler (ID: `person:RichYoungRuler`); Pedro (ID: `person:Peter`); Needle (ID: `realia:Needle`); House (ID: `realia:House`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); David (ID: `person:David`); misericordia (ID: `keyterm:Mercy`); creer (ID: `keyterm:Believe`); salvación (ID: `keyterm:Salvation`); Jericó (ID: `place:Jericho`); mandar (ID: `keyterm:Command`); Jehová (ID: `deity:Lord`); Nazaret (ID: `place:Nazareth`); Jerusalem (ID: `place:Jerusalem`); nación; gente (ID: `group:Gentile`); gloria del señor (ID: `keyterm:Glory`); palabra (ID: `keyterm:Word`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Zaqueo (ID: `person:Zacchaeus`); salvación (ID: `keyterm:Salvation`); Abraham (ID: `person:Abraham`); nombre (ID: `keyterm:Name`); Jericó (ID: `place:Jericho`); Sycomore Fig (ID: `flora:SycomoreFig`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Mina (ID: `realia:Mina`); reino (ID: `keyterm:Kingdom`); autoridad (ID: `keyterm:Authority.2`); Good (ID: `keyterm:Good`); temer (ID: `keyterm:Fear`); parábola (ID: `keyterm:Parable`); decidir (ID: `keyterm:Decided`); Ability (ID: `keyterm:Ability`); Jehová (ID: `deity:Lord`); lealtad (ID: `keyterm:Faithfulness`); Jerusalem (ID: `place:Jerusalem`); Band of Cloth (ID: `realia:BandOfCloth`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Donkey (ID: `fauna:Donkey`); hacer la paz (ID: `keyterm:Peace`); Jehová (ID: `deity:Lord`); Jesús (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Jerusalem (ID: `place:Jerusalem`); Clothing (ID: `realia:Clothing`); Olive Tree (ID: `flora:OliveTree`); Bethfagé (ID: `place:Bethphage`); Bethania (ID: `place:Bethany`); las (ID: `place:OlivesMount`); altura (ID: `keyterm:Height`); cielo (ID: `keyterm:Heaven`); rogar (ID: `keyterm:AskFor`); mandar (ID: `keyterm:Command`); bendecir (ID: `keyterm:Bless`); A Group of Disciples (ID: `group:GenericDisciples`); fariseo (ID: `group:Pharisee`); nombre (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); A Group of People (ID: `group:GenericGroup`); orar (ID: `keyterm:Pray`); gloria del señor (ID: `keyterm:Glory`); Siege-Works (ID: `realia:Siege-works`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); autoridad (ID: `keyterm:Authority.2`); cielo (ID: `keyterm:Heaven`); vacío (ID: `keyterm:Empty`); Ability (ID: `keyterm:Ability`); parábola (ID: `keyterm:Parable`); Juan (ID: `person:John`); Temple (ID: `realia:Temple`); corazón (ID: `keyterm:Heart`); rogar (ID: `keyterm:AskFor`); desechar (ID: `keyterm:Reject`); buena noticia (ID: `keyterm:GoodNews`); temer (ID: `keyterm:Fear`); persuadir (ID: `keyterm:Persuade`); amado (ID: `keyterm:Beloved`); bautismo (ID: `keyterm:Baptism`); creer (ID: `keyterm:Believe`); Jesús (ID: `person:Jesus.2`); Cornerstone (ID: `realia:Cornerstone`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); levantamiento (ID: `keyterm:Resurrection`); Tiberio (ID: `person:Tiberius`); David (ID: `person:David`); Ability (ID: `keyterm:Ability`); para la eternidad (ID: `keyterm:Always`); Moisés (ID: `person:Moses`); Jesús (ID: `person:Jesus.2`); hipocresía (ID: `keyterm:Hypocrisy`); autoridad (ID: `keyterm:Authority.2`); Isaac (ID: `person:Isaac`); A Priest (ID: `person:GenericPriest`); Abraham (ID: `person:Abraham`); ser justo (ID: `keyterm:Just`); Be Lawful (ID: `keyterm:Lawful`); Religious Officials (ID: `group:ReligiousOfficials`); The Way (ID: `keyterm:TheWay`); fidelidad (ID: `keyterm:Truth`); saduceo (ID: `group:Sadducee`); Life (ID: `keyterm:Life`); impuesto (ID: `keyterm:TributeTax`); Israel (ID: `person:Israel`); palabra (ID: `keyterm:Word`); Brier (ID: `flora:Brier`); Image (ID: `realia:Image`); Denarius (ID: `realia:Denarius`); Boxthorn (ID: `flora:Boxthorn`); Footstool (ID: `realia:Footstool`)
...
* **Associated ACAI Concepts:** ofrenda (ID: `keyterm:Offering`); juicio (ID: `keyterm:Judgment`); verdadero (ID: `keyterm:True`); Daily Life (ID: `keyterm:DailyLife`); amistad (ID: `keyterm:Friendship`); orar (ID: `keyterm:Pray`); ser discípulo (ID: `keyterm:Disciple`); Lepton (ID: `realia:Lepton`); House (ID: `realia:House`); Cloak (ID: `realia:Cloak`); Synagogue (ID: `realia:Synagogue`); Treasury (ID: `realia:Treasury`)
...
* **Associated ACAI Concepts:** cielo (ID: `keyterm:Heaven`); nombre (ID: `keyterm:Name`); Jerusalem (ID: `place:Jerusalem`); corazón (ID: `keyterm:Heart`); señal (ID: `keyterm:Example`); reino (ID: `keyterm:Kingdom`); Ability (ID: `keyterm:Ability`); dar testimonio (ID: `keyterm:BearWitness`); rogar (ID: `keyterm:AskFor`); (cosas) de la vida diaria (ID: `keyterm:OfThisLife`); Judíos (ID: `place:Judea`); temer (ID: `keyterm:Fear`); Disaster (ID: `keyterm:Disaster`); liberación (ID: `keyterm:Liberation`); hacer justicia (ID: `keyterm:GrantJustice`); horror (ID: `keyterm:DreadfulEventOrSight`); Jehová (ID: `deity:Lord`); nación; gente (ID: `group:Gentile`); parábola (ID: `keyterm:Parable`); amén (ID: `keyterm:Surely`); gloria del señor (ID: `keyterm:Glory`); Prison (ID: `realia:Prison`); Fig (ID: `flora:Fig`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`); Net (ID: `realia:Net`)
...
* **Associated ACAI Concepts:** pascua (ID: `keyterm:Passover`); reino (ID: `keyterm:Kingdom`); Jehová (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); servir (ID: `keyterm:Serve`); House (ID: `realia:House`); ofrenda (ID: `keyterm:Offering`); autoridad (ID: `keyterm:Authority.2`); Juan (ID: `person:John.2`); decidir (ID: `keyterm:Decided`); Disaster (ID: `keyterm:Disaster`); pacto (ID: `keyterm:Covenant`); nación; gente (ID: `group:Gentile`); cuerpo (ID: `keyterm:Body.3`); sangre (ID: `keyterm:Blood`); To Cause to Happen (ID: `keyterm:Happen`); Israel (ID: `person:Israel`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); Clay Jar (ID: `realia:ClayJar`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Jesús (ID: `person:Jesus.2`); Judas (ID: `person:Judas.2`); Temple (ID: `realia:Temple`); Rooster (ID: `fauna:Rooster`); Peter's Second Accuser (ID: `person:SecondAccuserOfPeter`); fidelidad (ID: `keyterm:Truth`); autoridad (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); galileo (ID: `group:Galilee`); A Servant (ID: `person:GenericServant`); Galilea (ID: `place:Galilee`); House (ID: `realia:House`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Pilato (ID: `person:Pilate`); Priests (ID: `group:GenericPriests`); rogar (ID: `keyterm:AskFor`); Religious Officials (ID: `group:ReligiousOfficials`); Galilea (ID: `place:Galilee`); Elders (ID: `group:GenericElders`); Ability (ID: `keyterm:Ability`); Jesús (ID: `person:Jesus.2`); dar testimonio (ID: `keyterm:BearWitness`); autoridad (ID: `keyterm:Authority.2`); blasfemar (ID: `keyterm:Blaspheme`); Judíos (ID: `place:Judea`); galileo (ID: `group:Galilee`); Jerusalem (ID: `place:Jerusalem`); Tiberio (ID: `person:Tiberius`); Herodes (ID: `person:Herod.2`); Jehová (ID: `deity:Lord`); impuesto (ID: `keyterm:TributeTax`); creer (ID: `keyterm:Believe`); profetizar (ID: `keyterm:Speak`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Pilato (ID: `person:Pilate`); Herodes (ID: `person:Herod.2`); Jesús (ID: `person:Jesus.2`); Barrabás (ID: `person:Barabbas`); Cross (ID: `realia:Cross`); Prison (ID: `realia:Prison`); decidir (ID: `keyterm:Decided`); señal (ID: `keyterm:Example`); distinguir (ID: `keyterm:Discern`); esperanza (ID: `keyterm:Hope`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Jehová (ID: `deity:Lord`); salvación (ID: `keyterm:Salvation`); Jews (ID: `group:Jews`); Cross (ID: `realia:Cross`); Criminal on the Cross (ID: `person:Dysmas`); Cireneo (ID: `place:Cyrene`); Simón (ID: `person:Simon.5`); blasfemar (ID: `keyterm:Blaspheme`); perdonar (ID: `keyterm:Forgive`); mandar (ID: `keyterm:Command`); dichoso (ID: `keyterm:Happy`); temer (ID: `keyterm:Fear`); Jerusalem (ID: `place:Jerusalem`); escogido (ID: `keyterm:Chosen`); paraíso (ID: `keyterm:Paradise`); juicio (ID: `keyterm:Judgment`); amén (ID: `keyterm:Surely`); Golgotha (ID: `place:Golgotha`); Sour Wine (ID: `realia:SourWine`); Clothing (ID: `realia:Clothing`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Jehová (ID: `deity:Lord`); ser justo (ID: `keyterm:Just`); Galilea (ID: `place:Galilee`); cuerpo (ID: `keyterm:Body.3`); Jesús (ID: `person:Jesus.2`); sábado (ID: `keyterm:Sabbath`); Grave (ID: `realia:Grave`); José (ID: `person:Joseph.6`); Arimatea (ID: `place:Arimathea`); espíritu (ID: `keyterm:Spirit.2`); reino (ID: `keyterm:Kingdom`); mandamiento (ID: `keyterm:Commandment`); Pilato (ID: `person:Pilate`); nombre (ID: `keyterm:Name`); Good (ID: `keyterm:Good`); Jews (ID: `group:Jews`); gloria del señor (ID: `keyterm:Glory`); Aloes (ID: `realia:Aloes`); Temple (ID: `realia:Temple`); Linen (ID: `realia:Linen`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Curtain (ID: `realia:Curtain`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); palabra (ID: `keyterm:Word`); Juana (ID: `person:Joanna`); semana (ID: `keyterm:Week`); levantamiento (ID: `keyterm:Resurrection`); cuerpo (ID: `keyterm:Body.3`); no creer (ID: `keyterm:Disbelieve`); Jacobo (ID: `person:James.3`); Galilea (ID: `place:Galilee`); María (ID: `person:Marymagdalene`); Pedro (ID: `person:Peter`); María (ID: `person:Mary`); Life (ID: `keyterm:Life`); Linen (ID: `realia:Linen`); Aloes (ID: `realia:Aloes`); Cross (ID: `realia:Cross`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Jesús (ID: `person:Jesus.2`); Jerusalem (ID: `place:Jerusalem`); corazón (ID: `keyterm:Heart`); escritura (ID: `keyterm:Scripture`); nombre (ID: `keyterm:Name`); Grave (ID: `realia:Grave`); Emmaús (ID: `place:Emmaus`); Cleofas (ID: `person:Cleopas`); esperanza (ID: `keyterm:Hope`); bendecir (ID: `keyterm:Bless`); An Angel (ID: `deity:Angel`); liberación (ID: `keyterm:Liberation`); Moisés (ID: `person:Moses`); Jehová (ID: `deity:Lord`); cuerpo (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); levantamiento (ID: `keyterm:Resurrection`); creer (ID: `keyterm:Believe`); juicio (ID: `keyterm:Judgment`); Israel (ID: `person:Israel`); Pedro (ID: `person:Peter`); gloria del señor (ID: `keyterm:Glory`); Stade (ID: `realia:Stade`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** bendecir (ID: `keyterm:Bless`); Jerusalem (ID: `place:Jerusalem`); Jehová (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); espíritu (ID: `keyterm:Spirit.2`); escritura (ID: `keyterm:Scripture`); Bethania (ID: `place:Bethany`); postrarse (ID: `keyterm:BowDown`); To Cause to Happen (ID: `keyterm:Happen`); corazón (ID: `keyterm:Heart`); cielo (ID: `keyterm:Heaven`); perdonar (ID: `keyterm:Forgive`); convertirse (ID: `keyterm:Repent`); proclamar (ID: `keyterm:Proclaim`); testimonio (ID: `keyterm:Witness`); no creer (ID: `keyterm:Disbelieve`); nombre (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); promesa (ID: `keyterm:Promise`); Moisés (ID: `person:Moses`); cuerpo (ID: `keyterm:Body.3`); ley (ID: `keyterm:Law`); altura (ID: `keyterm:Height`); Jesús (ID: `person:Jesus.2`); pecar (ID: `keyterm:Sin`); Temple (ID: `realia:Temple`); Fish (ID: `fauna:Fish`)
