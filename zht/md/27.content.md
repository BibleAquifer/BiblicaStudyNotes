...
* **Associated Passages:** 但以理書 1:1-21
* **Associated Articles:** 神 (ID: `232800@BiblicaStudyNotesKeyTerms`); 工作 (ID: `232809@BiblicaStudyNotesKeyTerms`); 約 (ID: `232838@BiblicaStudyNotesKeyTerms`); 雅各 (ID: `232869@BiblicaStudyNotesKeyTerms`); 祭物（獻祭） (ID: `232857@BiblicaStudyNotesKeyTerms`); 族譜（家譜） (ID: `232821@BiblicaStudyNotesKeyTerms`); 神的子民 (ID: `232903@BiblicaStudyNotesKeyTerms`); 智慧 (ID: `232926@BiblicaStudyNotesKeyTerms`); 西奈山 (ID: `232928@BiblicaStudyNotesKeyTerms`); 西奈山之約 (ID: `232929@BiblicaStudyNotesKeyTerms`); 祭司的國度 (ID: `232938@BiblicaStudyNotesKeyTerms`); 南國 (ID: `233081@BiblicaStudyNotes`); 巴比倫 (ID: `233099@BiblicaStudyNotesKeyTerms`); 潔淨或不潔淨 (ID: `232964@BiblicaStudyNotesKeyTerms`); 公元前605年 (ID: `233152@BiblicaStudyNotesKeyTerms`); 但以理 (ID: `233161@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.3`); Azariah (ID: `person:Azariah.20`); Mishael (ID: `person:Mishael.3`); Hananiah (ID: `person:Hananiah.15`); Ability (ID: `keyterm:Ability`); LORD (ID: `deity:Lord`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Melzar (ID: `person:Melzar`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Have Insight (ID: `keyterm:HaveInsight`); Jehoiakim (ID: `person:Jehoiakim`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Perceive (ID: `keyterm:Perceive`); Scroll (ID: `realia:Scroll`); Ashpenaz (ID: `person:Ashpenaz`); Chaldeans (ID: `group:Chaldea`); Strength (ID: `keyterm:Strength`); Conjurer (ID: `keyterm:Conjurer`); Understanding (ID: `keyterm:Understanding`); Chaldea (ID: `place:Chaldea`); Kindness (ID: `keyterm:Kindness`); Intention (ID: `keyterm:Intention`); Cyrus (ID: `person:Cyrus`); Babylon (ID: `place:Babylon`); Jerusalem (ID: `place:Jerusalem`); Defile (ID: `keyterm:Stain`); Public Official (ID: `person:GenericOfficial`); Israel (ID: `person:Israel`); Shinar (ID: `place:Shinar`); House (ID: `realia:House`)
...
* **Associated Passages:** 但以理書 2:1-49
...
* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.3`); Babylon (ID: `place:Babylon`); Arioch (ID: `person:Arioch.2`); Chaldea (ID: `place:Chaldea`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Astrologers (ID: `group:Astrologer`); Chaldeans (ID: `group:Chaldea`); Azariah (ID: `person:Azariah.20`); Mishael (ID: `person:Mishael.3`); Hananiah (ID: `person:Hananiah.15`); Money (ID: `realia:Money`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Conjurer (ID: `keyterm:Conjurer`); House (ID: `realia:House`); Threshing Floor (ID: `realia:ThreshingFloor`)
...
* **Associated Passages:** 但以理書 3:1-30
...
* **Associated ACAI Concepts:** Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Mishael (ID: `person:Mishael.3`); Hananiah (ID: `person:Hananiah.15`); Azariah (ID: `person:Azariah.20`); Flute (ID: `realia:Flute`); Lyre (ID: `realia:Lyre`); Rams Horn (ID: `realia:RamsHorn`); Lute (ID: `realia:Lute`); Babylon (ID: `place:Babylon`); Bagpipe (ID: `realia:Bagpipe`); Jews (ID: `group:Jews`); Offering (ID: `keyterm:Offering`); Dura (ID: `place:Dura`); Chaldea (ID: `place:Chaldea`); LORD (ID: `deity:Lord`); Astrologers (ID: `group:Astrologer`); A Messenger (ID: `person:Messenger`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated Passages:** 但以理書 4:1-5:31
...
* **Associated ACAI Concepts:** Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Daniel (ID: `person:Daniel.3`); LORD (ID: `deity:Lord`); Belshazzar (ID: `person:Belshazzar`); Astrologers (ID: `group:Astrologer`); Chaldea (ID: `place:Chaldea`); Babylon (ID: `place:Babylon`); House (ID: `realia:House`); Medes (ID: `group:Mede`); Jerusalem (ID: `place:Jerusalem`); Medan (ID: `person:Medan`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`); Darius (ID: `person:Darius.3`); A Disembodied Voice (ID: `deity:Voice`); Persians (ID: `group:Persia`); Persia (ID: `place:Persia`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Mina (ID: `realia:Mina`); Grass (ID: `flora:Grass`); Wild Donkey (ID: `fauna:WildDonkey`); Vulture (ID: `fauna:Vulture`); Throne (ID: `realia:Throne`); Balance (ID: `realia:Balance`)
...
* **Associated Passages:** 但以理書 6:1-28
* **Associated Articles:** 天（天堂） (ID: `232802@BiblicaStudyNotesKeyTerms`); 所羅門 (ID: `233074@BiblicaStudyNotesKeyTerms`); 被擄（Exile） (ID: `233096@BiblicaStudyNotes`); 耶利米 (ID: `233108@BiblicaStudyNotesKeyTerms`); 大流士 (ID: `233113@BiblicaStudyNotesKeyTerms`); 以斯拉 (ID: `233114@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.3`); Darius (ID: `person:Darius.3`); Lion (ID: `fauna:Lion`); Persia (ID: `place:Persia`); Persians (ID: `group:Persia`); Medes (ID: `group:Mede`); Medan (ID: `person:Medan`); Public Officials (ID: `group:GenericOfficials`); Jerusalem (ID: `place:Jerusalem`); Tribe of Judah (ID: `group:Judah`); Cyrus (ID: `person:Cyrus`); Judah (ID: `person:Judah.4`); House (ID: `realia:House`); Window (ID: `realia:Window`)
...
* **Associated Passages:** 但以理書 7:1-12:13
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); Daniel (ID: `person:Daniel.3`); Strength (ID: `keyterm:Strength`); To Sin (ID: `keyterm:Sin`); Have Insight (ID: `keyterm:HaveInsight`); Truth (ID: `keyterm:Truth`); Rebel (ID: `keyterm:Rebel`); Covenant (ID: `keyterm:Covenant`); Plea for Mercy (ID: `keyterm:Supplication`); Jerusalem (ID: `place:Jerusalem`); Persia (ID: `place:Persia`); Sheep (ID: `fauna:Lamb`); Delight (ID: `keyterm:Delight`); Egypt (ID: `place:Egypt`); Fortress (ID: `realia:Fortress`); Michael (ID: `person:Michael.11`); Vision (ID: `keyterm:Vision`); Greece (ID: `place:Greece`); Instruction (ID: `keyterm:Instruction`); Passion (ID: `keyterm:Ardour`); Fear (ID: `keyterm:Fear`); Israel (ID: `person:Israel`); Understanding (ID: `keyterm:Understanding`); To Act Wickedly (ID: `keyterm:ActWickedly`); Detested Thing (ID: `keyterm:DetestedThing`); Scroll (ID: `realia:Scroll`); Darius (ID: `person:Darius.3`); Ulai (ID: `place:Ulai`); Gabriel (ID: `deity:Gabriel`)
