...
* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.3`); Azariah (ID: `person:Azariah.20`); Mishael (ID: `person:Mishael.3`); Hananiah (ID: `person:Hananiah.15`); Ability (ID: `keyterm:Ability`); Tribe of Judah (ID: `group:Judah`); LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`); Melzar (ID: `person:Melzar`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Have Insight (ID: `keyterm:HaveInsight`); Jehoiakim (ID: `person:Jehoiakim`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Perceive (ID: `keyterm:Perceive`); Scroll (ID: `realia:Scroll`); Ashpenaz (ID: `person:Ashpenaz`); Chaldeans (ID: `group:Chaldea`); Babylon (ID: `place:Babylon`); Chaldea (ID: `place:Chaldea`); Kindness (ID: `keyterm:Kindness`); Strength (ID: `keyterm:Strength`); Understanding (ID: `keyterm:Understanding`); Defile (ID: `keyterm:Stain`); Intention (ID: `keyterm:Intention`); Jerusalem (ID: `place:Jerusalem`); Public Official (ID: `person:GenericOfficial`); Shinar (ID: `place:Shinar`); Cyrus (ID: `person:Cyrus`); Israel (ID: `person:Israel`); Conjurer (ID: `keyterm:Conjurer`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.3`); Babylon (ID: `place:Babylon`); Arioch (ID: `person:Arioch.2`); Chaldea (ID: `place:Chaldea`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Astrologers (ID: `group:Astrologer`); Hananiah (ID: `person:Hananiah.15`); Azariah (ID: `person:Azariah.20`); Mishael (ID: `person:Mishael.3`); Chaldeans (ID: `group:Chaldea`); Money (ID: `realia:Money`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Conjurer (ID: `keyterm:Conjurer`); House (ID: `realia:House`); Threshing Floor (ID: `realia:ThreshingFloor`)
...
* **Associated ACAI Concepts:** Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Azariah (ID: `person:Azariah.20`); Mishael (ID: `person:Mishael.3`); Hananiah (ID: `person:Hananiah.15`); Flute (ID: `realia:Flute`); Rams Horn (ID: `realia:RamsHorn`); Lyre (ID: `realia:Lyre`); Lute (ID: `realia:Lute`); Babylon (ID: `place:Babylon`); Bagpipe (ID: `realia:Bagpipe`); Offering (ID: `keyterm:Offering`); Jews (ID: `group:Jews`); Dura (ID: `place:Dura`); Chaldea (ID: `place:Chaldea`); Astrologers (ID: `group:Astrologer`); LORD (ID: `deity:Lord`); A Messenger (ID: `person:Messenger`); House (ID: `realia:House`); Cubit (ID: `realia:Cubit`)
...
* **Associated ACAI Concepts:** Nebuchadnezzar (ID: `person:Nebuchadnezzar`); LORD (ID: `deity:Lord`); Daniel (ID: `person:Daniel.3`); Belshazzar (ID: `person:Belshazzar`); Astrologers (ID: `group:Astrologer`); Babylon (ID: `place:Babylon`); Chaldea (ID: `place:Chaldea`); House (ID: `realia:House`); Medes (ID: `group:Mede`); Medan (ID: `person:Medan`); Jerusalem (ID: `place:Jerusalem`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`); Darius (ID: `person:Darius.3`); A Disembodied Voice (ID: `deity:Voice`); Persians (ID: `group:Persia`); Tribe of Judah (ID: `group:Judah`); Persia (ID: `place:Persia`); Judah (ID: `person:Judah.4`); Mina (ID: `realia:Mina`); Grass (ID: `flora:Grass`); Wild Donkey (ID: `fauna:WildDonkey`); Vulture (ID: `fauna:Vulture`); Throne (ID: `realia:Throne`); Balance (ID: `realia:Balance`)
...
* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.3`); Darius (ID: `person:Darius.3`); Lion (ID: `fauna:Lion`); Persians (ID: `group:Persia`); Persia (ID: `place:Persia`); Medan (ID: `person:Medan`); Medes (ID: `group:Mede`); Judah (ID: `person:Judah.4`); Cyrus (ID: `person:Cyrus`); Tribe of Judah (ID: `group:Judah`); Jerusalem (ID: `place:Jerusalem`); Public Officials (ID: `group:GenericOfficials`); House (ID: `realia:House`); Window (ID: `realia:Window`)
