...
* **Associated Passages:** 詩篇 2:1-12
* **Associated Articles:** 族譜（家譜） (ID: `232821@BiblicaStudyNotesKeyTerms`); 父 (ID: `232913@BiblicaStudyNotesKeyTerms`); 王 (ID: `232931@BiblicaStudyNotesKeyTerms`); 聖潔 (ID: `232962@BiblicaStudyNotesKeyTerms`); 關於耶穌的預言 (ID: `233001@BiblicaStudyNotesKeyTerms`); 分別出來（分別為聖） (ID: `232959@BiblicaStudyNotesKeyTerms`); 聖殿 (ID: `233018@BiblicaStudyNotesKeyTerms`); 大衛 (ID: `233050@BiblicaStudyNotes`); 耶路撒冷 (ID: `233065@BiblicaStudyNotesKeyTerms`); 大衛之約 (ID: `233067@BiblicaStudyNotesKeyTerms`); 猶太人 (ID: `233104@BiblicaStudyNotesKeyTerms`); 神的兒子 (ID: `233127@BiblicaStudyNotesKeyTerms`); 彌賽亞 (ID: `233128@BiblicaStudyNotesKeyTerms`); 巴比倫 (ID: `233099@BiblicaStudyNotesKeyTerms`); 新約聖經 (ID: `233129@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Anointed (ID: `keyterm:Anointed`); Jerusalem (ID: `place:Jerusalem`); Have Insight (ID: `keyterm:HaveInsight`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); To Cause to Possess (ID: `keyterm:Possess`); Decree (ID: `keyterm:Decree`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); Rope (ID: `realia:Rope`)
...
* **Associated Passages:** 詩篇 22:1-31
* **Associated Articles:** 十字架 (ID: `233131@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Trust (ID: `keyterm:LeanOn`); Lion (ID: `fauna:Lion`); Fear (ID: `keyterm:Fear`); Israel (ID: `person:Israel`); Dog (ID: `fauna:Dog`); Salvation (ID: `keyterm:Salvation`); Strength (ID: `keyterm:Strength`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Bashan (ID: `place:Bashan`); Force to Serve (ID: `keyterm:EnticedToServe`); Holy (ID: `keyterm:Holy`); Poor (ID: `keyterm:Poor`); Lot (ID: `keyterm:Lot`); Vow (ID: `keyterm:Vow`); Cattle (ID: `fauna:Bull`); Wild Ox (ID: `fauna:WildOx`); Sheep (ID: `fauna:Lamb`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Psalm (ID: `keyterm:Psalm`); David (ID: `person:David`); Kindness (ID: `keyterm:Kindness`); Fear (ID: `keyterm:Fear`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`); Green Vegetation (ID: `flora:GreenVegetation`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Olive Oil (ID: `realia:OliveOil`); House (ID: `realia:House`); Grass (ID: `flora:Grass`); Sheep (ID: `fauna:Lamb`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated Passages:** 詩篇 51:1-19
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); LORD (ID: `deity:Lord`); Pure (ID: `keyterm:Pure`); Rebel (ID: `keyterm:Rebel`); Slaughtering (ID: `keyterm:Slaughtering`); Passion (ID: `keyterm:Ardour`); Salvation (ID: `keyterm:Salvation`); Forgive (ID: `keyterm:Forgive`); Offering (ID: `keyterm:Offering`); Psalm (ID: `keyterm:Psalm`); To Cleanse (ID: `keyterm:Cleanse.2`); Ability (ID: `keyterm:Ability`); Truth (ID: `keyterm:Truth`); Kindness (ID: `keyterm:Kindness`); The Way (ID: `keyterm:TheWay`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Jerusalem (ID: `place:Jerusalem`); Delight (ID: `keyterm:Delight`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); David (ID: `person:David`); Stone Altar (ID: `realia:StoneAltar`); Hyssop (ID: `flora:Hyssop`); Cattle (ID: `fauna:Bull`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated Passages:** 詩篇 73:1-28
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Likeness (ID: `keyterm:Semblance`); Innocence (ID: `keyterm:Innocence`); Complete (ID: `keyterm:Complete`); Counsel (ID: `keyterm:Counsel`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Glory (ID: `keyterm:Glory`); Asaph (ID: `person:Asaph.2`); Peace (ID: `keyterm:IntactState`); Psalm (ID: `keyterm:Psalm`); Refuge (ID: `keyterm:Refuge`); Be Zealous (ID: `keyterm:Zealous`); Israel (ID: `person:Israel`); Perceive (ID: `keyterm:Perceive`)
...
* **Associated Passages:** 詩篇 105:1-106:48
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); Moses (ID: `person:Moses`); Egypt (ID: `place:Egypt`); Israel (ID: `person:Israel`); To Cause to Possess (ID: `keyterm:Possess`); Abraham (ID: `person:Abraham`); Kindness (ID: `keyterm:Kindness`); Red Sea (ID: `place:RedSea`); Covenant (ID: `keyterm:Covenant`); Ham (ID: `place:Ham.2`); Plague (ID: `keyterm:Blow`); Aaron (ID: `person:Aaron`); Decree (ID: `keyterm:Decree`); Canaan (ID: `place:Canaan`); Believe In (ID: `keyterm:BelieveIn`); Symbol (ID: `keyterm:Example`); Cattails (ID: `flora:Cattails`); Phinehas (ID: `person:Phinehas`); To Make an Oath (ID: `keyterm:LiftUp`); Surely! (ID: `keyterm:Surely`); Salvation (ID: `keyterm:Salvation`); Counsel (ID: `keyterm:Counsel`); Instruction (ID: `keyterm:Instruction`); Glory (ID: `keyterm:Glory`); Dispossess (ID: `keyterm:Dispossess`); Oath (ID: `keyterm:Oath`); To Sin (ID: `keyterm:Sin`); Have Insight (ID: `keyterm:HaveInsight`); Be Zealous (ID: `keyterm:Zealous`)
...
* **Associated Passages:** 詩篇 110:1-7
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Melchizedek (ID: `person:Melchizedek`); Out of Free Will (ID: `keyterm:OutOfFreeWill`); David (ID: `person:David`); Jerusalem (ID: `place:Jerusalem`); Psalm (ID: `keyterm:Psalm`); Swear (ID: `keyterm:Swear`); Rod (ID: `realia:Rod`)
...
* **Associated Passages:** 詩篇 116:1-19

* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Vow (ID: `keyterm:Vow`); Loyal Person (ID: `keyterm:LoyalPerson`); Jerusalem (ID: `place:Jerusalem`); Salvation (ID: `keyterm:Salvation`); Generous (ID: `keyterm:Generous`); Praise (ID: `keyterm:Praise`); Plea for Mercy (ID: `keyterm:Supplication`); Hell (ID: `place:Hell`); Slaughtering (ID: `keyterm:Slaughtering`); Simple Person (ID: `keyterm:SimplePerson`); Believe In (ID: `keyterm:BelieveIn`); Love (ID: `keyterm:Love`); House (ID: `realia:House`); Trap (ID: `realia:Trap`)
...
* **Associated Passages:** 詩篇 119:1-176
...
* **Associated Passages:** 詩篇 137:1-9
* **Associated Articles:** 以東 (ID: `233012@BiblicaStudyNotesKeyTerms`); 南國 (ID: `233081@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); Babylon (ID: `place:Babylon`); LORD (ID: `deity:Lord`); Edom (ID: `place:Edom`); A Group of People (ID: `group:GenericGroup`); Edomites (ID: `group:Edom`); Poplar (ID: `flora:Poplar`); Willow (ID: `flora:Willow`); Lute (ID: `realia:Lute`); Foundation (ID: `realia:Foundation`)
...
* **Associated Passages:** 詩篇 146:1-150:6
