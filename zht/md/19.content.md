...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Instruction (ID: `keyterm:Instruction`); Counsel (ID: `keyterm:Counsel`); Date Palm (ID: `flora:DatePalm`)
## 詩篇 2:1–12 (id: 313501)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Mighty (ID: `keyterm:Mighty`); Appoint (ID: `keyterm:Appoint`); Glory (ID: `keyterm:Glory`); Majesty (ID: `keyterm:Majesty`); Goat (ID: `fauna:Goat`); Bird (ID: `fauna:Bird`); Cattle (ID: `fauna:Bull`); Fish (ID: `fauna:Fish`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Trust (ID: `keyterm:LeanOn`); Lion (ID: `fauna:Lion`); Israel (ID: `person:Israel`); Fear (ID: `keyterm:Fear`); Dog (ID: `fauna:Dog`); Strength (ID: `keyterm:Strength`); Force to Serve (ID: `keyterm:EnticedToServe`); Lot (ID: `keyterm:Lot`); Vow (ID: `keyterm:Vow`); Salvation (ID: `keyterm:Salvation`); Bashan (ID: `place:Bashan`); Holy (ID: `keyterm:Holy`); Poor (ID: `keyterm:Poor`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Worm (ID: `fauna:Maggot`); Wild Ox (ID: `fauna:WildOx`)
## 詩篇 23:1–6 (id: 313504)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Psalm (ID: `keyterm:Psalm`); Kindness (ID: `keyterm:Kindness`); Fear (ID: `keyterm:Fear`); David (ID: `person:David`); Staff (ID: `realia:Staff`); Goat (ID: `fauna:Goat`); Green Vegetation (ID: `flora:GreenVegetation`); Rod (ID: `realia:Rod`); House (ID: `realia:House`); Olive Oil (ID: `realia:OliveOil`); Sheep (ID: `fauna:Lamb`); Anointing Oil (ID: `realia:AnointingOil`); Grass (ID: `flora:Grass`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Likeness (ID: `keyterm:Semblance`); Innocence (ID: `keyterm:Innocence`); Complete (ID: `keyterm:Complete`); Be Zealous (ID: `keyterm:Zealous`); Refuge (ID: `keyterm:Refuge`); Perceive (ID: `keyterm:Perceive`); Psalm (ID: `keyterm:Psalm`); Peace (ID: `keyterm:IntactState`); Glory (ID: `keyterm:Glory`); Counsel (ID: `keyterm:Counsel`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Israel (ID: `person:Israel`); Asaph (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); Israel (ID: `person:Israel`); Egypt (ID: `place:Egypt`); Moses (ID: `person:Moses`); Red Sea (ID: `place:RedSea`); Kindness (ID: `keyterm:Kindness`); Ham (ID: `place:Ham.2`); Abraham (ID: `person:Abraham`); To Cause to Possess (ID: `keyterm:Possess`); Covenant (ID: `keyterm:Covenant`); Plague (ID: `keyterm:Blow`); Aaron (ID: `person:Aaron`); Decree (ID: `keyterm:Decree`); Symbol (ID: `keyterm:Example`); Believe In (ID: `keyterm:BelieveIn`); Canaan (ID: `place:Canaan`); Cattails (ID: `flora:Cattails`); To Make an Oath (ID: `keyterm:LiftUp`); Phinehas (ID: `person:Phinehas`); Exempt (ID: `keyterm:Exempt`); Mount Sinai (ID: `place:SinaiMount`); Bless (ID: `keyterm:Bless`); A Group of People (ID: `group:GenericGroup`); Dispossess (ID: `keyterm:Dispossess`); Miraculous Sign (ID: `keyterm:MiraculousSign`); Instruction (ID: `keyterm:Instruction`); Redeem (ID: `keyterm:Redeem`); Defilement (ID: `keyterm:Defilement`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Out of Free Will (ID: `keyterm:OutOfFreeWill`); Melchizedek (ID: `person:Melchizedek`); David (ID: `person:David`); Psalm (ID: `keyterm:Psalm`); Jerusalem (ID: `place:Jerusalem`); Swear (ID: `keyterm:Swear`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Vow (ID: `keyterm:Vow`); Simple Person (ID: `keyterm:SimplePerson`); Loyal Person (ID: `keyterm:LoyalPerson`); Slaughtering (ID: `keyterm:Slaughtering`); Hell (ID: `place:Hell`); Generous (ID: `keyterm:Generous`); Praise (ID: `keyterm:Praise`); Love (ID: `keyterm:Love`); Salvation (ID: `keyterm:Salvation`); Jerusalem (ID: `place:Jerusalem`); Believe In (ID: `keyterm:BelieveIn`); Plea for Mercy (ID: `keyterm:Supplication`); Trap (ID: `realia:Trap`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Babylon (ID: `place:Babylon`); Edom (ID: `place:Edom`); A Group of People (ID: `group:GenericGroup`); Edomites (ID: `group:Edom`); Foundation (ID: `realia:Foundation`); Lute (ID: `realia:Lute`); Willow (ID: `flora:Willow`); Poplar (ID: `flora:Poplar`)
