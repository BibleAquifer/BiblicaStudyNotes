...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`); Malachi (ID: `person:Malachi`); Utterance (ID: `keyterm:Utterance`); To Cause to Possess (ID: `keyterm:Possess`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Love (ID: `keyterm:Love`); Jackal (ID: `fauna:Jackal`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); Instruction (ID: `keyterm:Instruction`); Fear (ID: `keyterm:Fear`); Israel (ID: `person:Israel`); Tribe of Levi (ID: `group:Levi`); To Curse (ID: `keyterm:Curse`); To Dishonor (ID: `keyterm:Dishonor`); Levi (ID: `person:Levi.3`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Glory (ID: `keyterm:Glory`); Bless (ID: `keyterm:Bless`); Peace (ID: `keyterm:IntactState`); Pure (ID: `keyterm:Pure`); Jerusalem (ID: `place:Jerusalem`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Defile (ID: `keyterm:Stain`); Priests (ID: `group:GenericPriests`); An Angel (ID: `deity:Angel`); Fairness (ID: `keyterm:Fairness`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Vow (ID: `keyterm:Vow`); Swear (ID: `keyterm:Swear`); Love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); Intention (ID: `keyterm:Intention`); The Way (ID: `keyterm:TheWay`); A Group of People (ID: `group:GenericGroup`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Ask for (ID: `keyterm:AskFor`); Passion (ID: `keyterm:Ardour`); Delight (ID: `keyterm:Delight`); Force to Serve (ID: `keyterm:EnticedToServe`); Decree (ID: `keyterm:Decree`); Gentiles (ID: `group:Gentile`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); House (ID: `realia:House`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); Mount Sinai (ID: `place:SinaiMount`); Elijah (ID: `person:Elijah`); LORD (ID: `deity:Lord`); Decree (ID: `keyterm:Decree`); Fear (ID: `keyterm:Fear`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Moses (ID: `person:Moses`); Israel (ID: `person:Israel`)
