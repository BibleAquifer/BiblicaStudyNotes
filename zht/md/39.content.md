...
* **Associated Passages:** 瑪拉基書 1:1-5
* **Associated Articles:** 族譜（家譜） (ID: `232821@BiblicaStudyNotesKeyTerms`); 神選擇 (ID: `232830@BiblicaStudyNotesKeyTerms`); 審判 (ID: `232834@BiblicaStudyNotesKeyTerms`); 約 (ID: `232838@BiblicaStudyNotesKeyTerms`); 亞伯拉罕 (ID: `232844@BiblicaStudyNotesKeyTerms`); 亞伯拉罕之約 (ID: `232854@BiblicaStudyNotesKeyTerms`); 雅各 (ID: `232869@BiblicaStudyNotesKeyTerms`); 以色列 (ID: `232881@BiblicaStudyNotesKeyTerms`); 猶大 (ID: `232892@BiblicaStudyNotesKeyTerms`); 神的子民 (ID: `232903@BiblicaStudyNotesKeyTerms`); 聖殿 (ID: `233018@BiblicaStudyNotesKeyTerms`); 南國 (ID: `233081@BiblicaStudyNotesKeyTerms`); 猶太人 (ID: `233104@BiblicaStudyNotesKeyTerms`); 巴比倫 (ID: `233099@BiblicaStudyNotesKeyTerms`); 波斯 (ID: `233110@BiblicaStudyNotesKeyTerms`); 瑪拉基 (ID: `233179@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`); Malachi (ID: `person:Malachi`); Utterance (ID: `keyterm:Utterance`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Love (ID: `keyterm:Love`); To Cause to Possess (ID: `keyterm:Possess`); Jackal (ID: `fauna:Jackal`)
...
* **Associated Passages:** 瑪拉基書 1:6-3:15
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); Instruction (ID: `keyterm:Instruction`); Israel (ID: `person:Israel`); Fear (ID: `keyterm:Fear`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); To Dishonor (ID: `keyterm:Dishonor`); To Curse (ID: `keyterm:Curse`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Bless (ID: `keyterm:Bless`); Jerusalem (ID: `place:Jerusalem`); Judah (ID: `person:Judah.4`); Pure (ID: `keyterm:Pure`); Glory (ID: `keyterm:Glory`); Tribe of Judah (ID: `group:Judah`); Defile (ID: `keyterm:Stain`); Priests (ID: `group:GenericPriests`); Peace (ID: `keyterm:IntactState`); An Angel (ID: `deity:Angel`); Fairness (ID: `keyterm:Fairness`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Ask for (ID: `keyterm:AskFor`); A Group of People (ID: `group:GenericGroup`); Love (ID: `keyterm:Love`); The Way (ID: `keyterm:TheWay`); Passion (ID: `keyterm:Ardour`); Force to Serve (ID: `keyterm:EnticedToServe`); Decree (ID: `keyterm:Decree`); Gentiles (ID: `group:Gentile`); Swear (ID: `keyterm:Swear`); Intention (ID: `keyterm:Intention`); Vow (ID: `keyterm:Vow`); Delight (ID: `keyterm:Delight`); Truth (ID: `keyterm:Truth`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); Sorghum (ID: `flora:Sorghum`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`)
...
* **Associated Passages:** 瑪拉基書 3:16-4:3
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); Scroll (ID: `realia:Scroll`); Molten Image (ID: `realia:MoltenImage`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`)
...
* **Associated Passages:** 瑪拉基書 4:4-6
...
* **Associated ACAI Concepts:** Mount Sinai (ID: `place:SinaiMount`); LORD (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Decree (ID: `keyterm:Decree`); Fear (ID: `keyterm:Fear`); Moses (ID: `person:Moses`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Israel (ID: `person:Israel`); Elijah (ID: `person:Elijah`)
