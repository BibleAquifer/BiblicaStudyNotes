...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Edom (ID: `place:Edom`); Israel (ID: `person:Israel`); Edomites (ID: `group:Edom`); Utterance (ID: `keyterm:Utterance`); Malachi (ID: `person:Malachi`); Word of the Lord (ID: `keyterm:WordOfTheLord`); To Cause to Possess (ID: `keyterm:Possess`); Love (ID: `keyterm:Love`); Jackal (ID: `fauna:Jackal`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); Fear (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); Israel (ID: `person:Israel`); To Curse (ID: `keyterm:Curse`); To Dishonor (ID: `keyterm:Dishonor`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Priests (ID: `group:GenericPriests`); Glory (ID: `keyterm:Glory`); Bless (ID: `keyterm:Bless`); Defile (ID: `keyterm:Stain`); Tribe of Judah (ID: `group:Judah`); An Angel (ID: `deity:Angel`); Jerusalem (ID: `place:Jerusalem`); Pure (ID: `keyterm:Pure`); Peace (ID: `keyterm:IntactState`); Judah (ID: `person:Judah.4`); Fairness (ID: `keyterm:Fairness`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Ask for (ID: `keyterm:AskFor`); Force to Serve (ID: `keyterm:EnticedToServe`); Swear (ID: `keyterm:Swear`); Delight (ID: `keyterm:Delight`); Vow (ID: `keyterm:Vow`); Intention (ID: `keyterm:Intention`); Truth (ID: `keyterm:Truth`); The Way (ID: `keyterm:TheWay`); A Group of People (ID: `group:GenericGroup`); Gentiles (ID: `group:Gentile`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Passion (ID: `keyterm:Ardour`); Decree (ID: `keyterm:Decree`); Love (ID: `keyterm:Love`); Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Money (ID: `realia:Money`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Wheat (ID: `flora:Wheat`); Flock (ID: `fauna:Flock`); Sorghum (ID: `flora:Sorghum`)
...
* **Associated ACAI Concepts:** Elijah (ID: `person:Elijah`); Instruction (ID: `keyterm:Instruction`); Fear (ID: `keyterm:Fear`); Moses (ID: `person:Moses`); Decree (ID: `keyterm:Decree`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Mount Sinai (ID: `place:SinaiMount`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`)
