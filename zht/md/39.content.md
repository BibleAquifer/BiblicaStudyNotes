...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Edom (ID: `place:Edom`); Edomites (ID: `group:Edom`); Malachi (ID: `person:Malachi`); Utterance (ID: `keyterm:Utterance`); Love (ID: `keyterm:Love`); Word of the Lord (ID: `keyterm:WordOfTheLord`); To Cause to Possess (ID: `keyterm:Possess`); Jackal (ID: `fauna:Jackal`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); Fear (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); Israel (ID: `person:Israel`); To Curse (ID: `keyterm:Curse`); To Dishonor (ID: `keyterm:Dishonor`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Glory (ID: `keyterm:Glory`); Jerusalem (ID: `place:Jerusalem`); Defile (ID: `keyterm:Stain`); Pure (ID: `keyterm:Pure`); Judah (ID: `person:Judah.4`); An Angel (ID: `deity:Angel`); Bless (ID: `keyterm:Bless`); Priests (ID: `group:GenericPriests`); Tribe of Judah (ID: `group:Judah`); Peace (ID: `keyterm:IntactState`); Fairness (ID: `keyterm:Fairness`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Delight (ID: `keyterm:Delight`); Love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); Decree (ID: `keyterm:Decree`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); The Way (ID: `keyterm:TheWay`); Swear (ID: `keyterm:Swear`); Force to Serve (ID: `keyterm:EnticedToServe`); A Group of People (ID: `group:GenericGroup`); Ask for (ID: `keyterm:AskFor`); Intention (ID: `keyterm:Intention`); Gentiles (ID: `group:Gentile`); Vow (ID: `keyterm:Vow`); Passion (ID: `keyterm:Ardour`); Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Elijah (ID: `person:Elijah`); Fear (ID: `keyterm:Fear`); Mount Sinai (ID: `place:SinaiMount`); LORD (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Moses (ID: `person:Moses`); Decree (ID: `keyterm:Decree`)
