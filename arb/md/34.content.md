...
* **Associated ACAI Concepts:** نَاحومَ (ID: `person:Nahum.2`); ٱلْأَلْقوشِيِّ (ID: `place:Elkosh`)
...
* **Associated ACAI Concepts:** Protective Shield (ID: `realia:ProtectiveShield`); Brick Mold (ID: `realia:BrickMold`); آمون (ID: `deity:Amon`); نو (ID: `place:Thebes`); ٱلرَّبِّ (ID: `deity:Lord`)
