...
* **Associated ACAI Concepts:** تَسَالونِيكِي (ID: `place:Thessalonica`); Be Glorified (ID: `keyterm:Glorified`); يَسوع (ID: `person:Jesus.2`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Teaching (ID: `keyterm:Teaching`); يَسوع (ID: `person:Jesus.2`)
