...
* **Associated ACAI Concepts:** فَثوئِيلَ (ID: `person:Pethuel`); يوئِيل (ID: `person:Joel.14`); Locust (ID: `fauna:Locust`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Valley of Shittim (ID: `place:ShittimValley`); Pruning Knife (ID: `realia:PruningKnife`); Sabeans (ID: `group:Sabean`); Greeks (ID: `group:Greek`); يَهوذَا (ID: `group:Judah`); يَهوذَا (ID: `person:Judah.4`); أورشَلِيمَ (ID: `place:Jerusalem`); ٱلرَّبِّ (ID: `deity:Lord`)
