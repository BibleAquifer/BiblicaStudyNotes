...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); Love (ID: `keyterm:Love`); Commandment (ID: `keyterm:Commandment`); ٱلرَّبِّ (ID: `deity:Lord`); يَسوع (ID: `person:Jesus.2`); Chosen (ID: `keyterm:Chosen`); Live (ID: `keyterm:Live.3`); Ask for (ID: `keyterm:AskFor`); Hope (ID: `keyterm:Hope`); Share (ID: `keyterm:Share`); Make Peace (ID: `keyterm:Peace`); Mercy (ID: `keyterm:Mercy`); Always (ID: `keyterm:Always`); Favor (ID: `keyterm:Favor`); Ability (ID: `keyterm:Ability`); Body (ID: `keyterm:Body.3`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ink (ID: `realia:Ink`); Paper (ID: `realia:Paper`); Papyrus (ID: `flora:Papyrus`); House (ID: `realia:House`)
