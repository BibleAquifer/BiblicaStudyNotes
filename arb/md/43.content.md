...
* **Associated Articles:** إنجيل (بشارة) (ID: `133833@BiblicaStudyNotesKeyTerms`); كتاب مقدس (ID: `133995@BiblicaStudyNotesKeyTerms`); القصص (ID: `134000@BiblicaStudyNotesKeyTerms`); الله (ID: `134001@BiblicaStudyNotesKeyTerms`); كلمة الله  (ID: `134002@BiblicaStudyNotesKeyTerms`); إنسان (ID: `134004@BiblicaStudyNotesKeyTerms`); عالم (ID: `134017@BiblicaStudyNotesKeyTerms`); يسوع (ID: `134021@BiblicaStudyNotesKeyTerms`); نعمة (ID: `134037@BiblicaStudyNotesKeyTerms`); يوحنا (ID: `134344@BiblicaStudyNotesKeyTerms`); نور (ID: `134348@BiblicaStudyNotesKeyTerms`); يُوحَنَّا المعمدان (ID: `134382@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Bear Witness (ID: `keyterm:BearWitness`); Ability (ID: `keyterm:Ability`); Favor (ID: `keyterm:Favor`); Body (ID: `keyterm:Body.3`); Name (ID: `keyterm:Name`); Believe (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); يوحَنَّا (ID: `person:John`); Law (ID: `keyterm:Law`); True (ID: `keyterm:True`); Life (ID: `keyterm:Life`); Glory (ID: `keyterm:Glory`); Blood (ID: `keyterm:Blood`); يَسوع (ID: `person:Jesus.2`); Authority (ID: `keyterm:Authority.2`); موسَى (ID: `person:Moses`)
...
* **Associated Passages:** يوحنا 1:19-34
...
* **Associated ACAI Concepts:** Baptism (ID: `keyterm:Baptism`); يوحَنَّا (ID: `person:John`); يَسوع (ID: `person:Jesus.2`); Bear Witness (ID: `keyterm:BearWitness`); Ask for (ID: `keyterm:AskFor`); إِيلِيَّا (ID: `person:Elijah`); ٱلرَّبِّ (ID: `deity:Lord`); ٱلرّوحِ (ID: `deity:HolySpirit`); عَنْيَا (ID: `place:Bethany.2`); أورشَلِيمَ (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); To Sin (ID: `keyterm:Sin`); Sky (ID: `keyterm:Heaven`); إِشَعْيَاء (ID: `person:Isaiah`); Jews (ID: `group:Jews`); لَّاوِي (ID: `person:Levi.3`); إِسْرَائِيلَ (ID: `person:Israel`); Pharisees (ID: `group:Pharisee`); لَّاوِي (ID: `group:Levi`); ٱلْأرْدنِّ (ID: `place:Jordan`); Sheep (ID: `fauna:Lamb`); Strap (ID: `realia:Strap`); Dove (ID: `fauna:Dove`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); نَثَنَائِيلَ (ID: `person:Nathanael`); فِيلبّسَ (ID: `person:Philip`); بطْرس (ID: `person:Peter`); نَاصِرَة (ID: `place:Nazareth`); أَنْدَرَاوسَ (ID: `person:Andrew`); ٱلرَّبِّ (ID: `deity:Lord`); يوحَنَّا (ID: `person:John`); Be a Disciple (ID: `keyterm:Disciple`); إِسْرَائِيلَ (ID: `person:Israel`); Fig (ID: `flora:Fig`); صَيْدَا (ID: `place:Bethsaida`); يوحَنَّا (ID: `person:John.4`); A Disciple (ID: `person:GenericDisciple`); Surely! (ID: `keyterm:Surely`); ٱلْجَلِيلِ (ID: `place:Galilee`); Israelites (ID: `group:Israel`); An Angel (ID: `deity:Angel`); يوسف (ID: `person:Joseph.4`); True (ID: `keyterm:True`); Law (ID: `keyterm:Law`); Sky (ID: `keyterm:Heaven`); Good (ID: `keyterm:Good`); Believe (ID: `keyterm:Believe`); موسَى (ID: `person:Moses`); Sheep (ID: `fauna:Lamb`)
...
* **Associated Passages:** يوحنا 2:1-12
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Wine (ID: `realia:Wine`); قَانَا (ID: `place:Cana`); ٱلْجَلِيلِ (ID: `place:Galilee`); Stone Jar (ID: `realia:StoneJar`); Clay Jar (ID: `realia:ClayJar`); Symbol (ID: `keyterm:Example`); Glory (ID: `keyterm:Glory`); To Cleanse (ID: `keyterm:Cleanse.2`); Believe (ID: `keyterm:Believe`); كَفْرَنَاحومَ (ID: `place:Capernaum`); Jews (ID: `group:Jews`); Measure (ID: `realia:Measure`)
...
* **Associated Passages:** يوحنا 2:13-25
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); يَسوع (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`); Jews (ID: `group:Jews`); أورشَلِيمَ (ID: `place:Jerusalem`); Symbol (ID: `keyterm:Example`); Passover (ID: `keyterm:Passover`); Be a Disciple (ID: `keyterm:Disciple`); Sheep (ID: `fauna:Lamb`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`); Cattle (ID: `fauna:Bull`); Extremely (ID: `keyterm:Extremely`); Body (ID: `keyterm:Body.3`); Name (ID: `keyterm:Name`); ٱلرَّبِّ (ID: `deity:Lord`); Resurrection (ID: `keyterm:Resurrection`); Written (ID: `keyterm:Scripture`); Bear Witness (ID: `keyterm:BearWitness`); Whip (ID: `realia:Whip`); Rope (ID: `realia:Rope`)
...
* **Associated Passages:** يوحنا 3:1-21
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Surely! (ID: `keyterm:Surely`); نِيقودِيموس (ID: `person:Nicodemus`); Ability (ID: `keyterm:Ability`); يَسوع (ID: `person:Jesus.2`); ٱلرّوحِ (ID: `deity:HolySpirit`); Love (ID: `keyterm:Love`); Always (ID: `keyterm:Always`); Life (ID: `keyterm:Life`); Decided (ID: `keyterm:Decided`); Kingdom (ID: `keyterm:Kingdom`); Name (ID: `keyterm:Name`); Heavenly (ID: `keyterm:Heavenly`); Sky (ID: `keyterm:Heaven`); Spirit (ID: `keyterm:Spirit.2`); Body (ID: `keyterm:Body.3`); Truth (ID: `keyterm:Truth`); Symbol (ID: `keyterm:Example`); Judgment (ID: `keyterm:Judgment`); Jews (ID: `group:Jews`); موسَى (ID: `person:Moses`); Court Case (ID: `keyterm:CourtCase`); إِسْرَائِيلَ (ID: `person:Israel`); Salvation (ID: `keyterm:Salvation`); Pharisees (ID: `group:Pharisee`); Bear Witness (ID: `keyterm:BearWitness`); Snake (ID: `fauna:Snake`)
...
* **Associated Passages:** يوحنا 4:1-26
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Bow Down (ID: `keyterm:BowDown`); A Woman (ID: `person:GenericFemale`); ٱلرَّبِّ (ID: `deity:Lord`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Life (ID: `keyterm:Life`); Be a Disciple (ID: `keyterm:Disciple`); إِسْرَائِيلَ (ID: `person:Israel`); أورشَلِيمَ (ID: `place:Jerusalem`); Truth (ID: `keyterm:Truth`); True (ID: `keyterm:True`); Baptism (ID: `keyterm:Baptism`); Jews (ID: `group:Jews`); Spirit (ID: `keyterm:Spirit.2`); Samaritans (ID: `group:Samaritan`); سوخَار (ID: `place:Sychar`); Worshiper (ID: `keyterm:Worshiper`); ٱلْجَلِيلِ (ID: `place:Galilee`); Always (ID: `keyterm:Always`); يوسف (ID: `person:Joseph.10`); يوحَنَّا (ID: `person:John`); يَهوذَا (ID: `place:Judea`); Believe (ID: `keyterm:Believe`); Pharisees (ID: `group:Pharisee`); Salvation (ID: `keyterm:Salvation`); Container (ID: `realia:Container`)
...
* **Associated Passages:** يوحنا 4:43-54
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); ٱلْجَلِيلِ (ID: `place:Galilee`); Believe (ID: `keyterm:Believe`); Life (ID: `keyterm:Life`); يَهوذَا (ID: `place:Judea`); Symbol (ID: `keyterm:Example`); قَانَا (ID: `place:Cana`); Galileans (ID: `group:Galilee`); أورشَلِيمَ (ID: `place:Jerusalem`); Public Official (ID: `person:GenericOfficial`); Portent (ID: `keyterm:Portent`); كَفْرَنَاحومَ (ID: `place:Capernaum`); Ask for (ID: `keyterm:AskFor`); Bear Witness (ID: `keyterm:BearWitness`); Wine (ID: `realia:Wine`)
...
* **Associated Passages:** يوحنا 5:1-15
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Bed (ID: `realia:Bed`); Jews (ID: `group:Jews`); أورشَلِيمَ (ID: `place:Jerusalem`); Sabbath (ID: `keyterm:Sabbath`); Pool (ID: `realia:Pool`); ٱلضَّأْنِ (ID: `place:SheepGate`); بَيْت (ID: `place:Bethesda`); To Sin (ID: `keyterm:Sin`); Be Lawful (ID: `keyterm:Lawful`); Serve (ID: `keyterm:Serve`); Ask for (ID: `keyterm:AskFor`); Porch (ID: `realia:Porch`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** يوحنا 6:1-21

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Ship (ID: `realia:Ship`); Symbol (ID: `keyterm:Example`); فِيلبّسَ (ID: `person:Philip`); Fear (ID: `keyterm:Fear`); Barley (ID: `flora:Barley`); Fish (ID: `fauna:Fish`); كَفْرَنَاحومَ (ID: `place:Capernaum`); Sea of Galilee (ID: `place:GalileeSea`); Ability (ID: `keyterm:Ability`); بطْرس (ID: `person:Peter`); True (ID: `keyterm:True`); A Group of People (ID: `group:GenericGroup`); أَنْدَرَاوسَ (ID: `person:Andrew`); Jews (ID: `group:Jews`); Passover (ID: `keyterm:Passover`); Stade (ID: `realia:Stade`); Grass (ID: `flora:Grass`); Denarius (ID: `realia:Denarius`); Basket (ID: `realia:Basket`)
...
* **Associated Passages:** يوحنا 6:22-59
...
* **Associated ACAI Concepts:** Life (ID: `keyterm:Life`); ٱلرَّبِّ (ID: `deity:Lord`); يَسوع (ID: `person:Jesus.2`); Sky (ID: `keyterm:Heaven`); Body (ID: `keyterm:Body.3`); Always (ID: `keyterm:Always`); Believe (ID: `keyterm:Believe`); Blood (ID: `keyterm:Blood`); Surely! (ID: `keyterm:Surely`); كَفْرَنَاحومَ (ID: `place:Capernaum`); Ship (ID: `realia:Ship`); Ability (ID: `keyterm:Ability`); Symbol (ID: `keyterm:Example`); Jews (ID: `group:Jews`); Be a Disciple (ID: `keyterm:Disciple`); طَبَرِيَّةَ (ID: `place:Tiberias`); يوسف (ID: `person:Joseph.4`); True (ID: `keyterm:True`); موسَى (ID: `person:Moses`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated Passages:** يوحنا 6:60-71
* **Associated Articles:** بُطْرُس (ID: `134374@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Word (ID: `keyterm:Word`); Believe (ID: `keyterm:Believe`); Life (ID: `keyterm:Life`); ٱلرَّبِّ (ID: `deity:Lord`); سِمْعَان (ID: `person:Simon.7`); Chosen (ID: `keyterm:Chosen`); Body (ID: `keyterm:Body.3`); Holy (ID: `keyterm:Holy`); Spirit (ID: `keyterm:Spirit.2`); بطْرس (ID: `person:Peter`); يَهوذَا (ID: `person:Judas.2`); A Group of Disciples (ID: `group:GenericDisciples`); ٱلرّوحِ (ID: `deity:HolySpirit`); Always (ID: `keyterm:Always`)
...
* **Associated Passages:** يوحنا 7:1-36
* **Associated Articles:** مجد (ID: `134150@BiblicaStudyNotesKeyTerms`); عِيد المَظَال (ID: `134179@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); True (ID: `keyterm:True`); A Group of People (ID: `group:GenericGroup`); موسَى (ID: `person:Moses`); ٱلْجَلِيلِ (ID: `place:Galilee`); يَهوذَا (ID: `place:Judea`); Ability (ID: `keyterm:Ability`); Sabbath (ID: `keyterm:Sabbath`); Law (ID: `keyterm:Law`); Believe (ID: `keyterm:Believe`); Circumcision (ID: `keyterm:Circumcision`); Unjust Deed (ID: `keyterm:UnjustDeed`); Relatives (ID: `group:Relatives`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Temple (ID: `realia:Temple`); Glory (ID: `keyterm:Glory`); أورشَلِيمَ (ID: `place:Jerusalem`); Greeks (ID: `group:Greek`); Decided (ID: `keyterm:Decided`); Symbol (ID: `keyterm:Example`); Judgment (ID: `keyterm:Judgment`); ٱلرَّبِّ (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); Good (ID: `keyterm:Good`); Fear (ID: `keyterm:Fear`); Court Case (ID: `keyterm:CourtCase`); Be a Disciple (ID: `keyterm:Disciple`); Demons (ID: `deity:Demons`); يَاان (ID: `person:Javan`); Pharisees (ID: `group:Pharisee`); Bear Witness (ID: `keyterm:BearWitness`); Festival of the Tabernacles (ID: `realia:FestivalOfTheTabernacles`)
...
* **Associated Passages:** يوحنا 7:37-53

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`); Pharisees (ID: `group:Pharisee`); ٱلْجَلِيلِ (ID: `place:Galilee`); Law (ID: `keyterm:Law`); A Group of People (ID: `group:GenericGroup`); Written (ID: `keyterm:Scripture`); لَحْمٍ (ID: `place:Bethlehem`); نِيقودِيموس (ID: `person:Nicodemus`); Glory (ID: `keyterm:Glory`); Life (ID: `keyterm:Life`); Internal Organs (ID: `keyterm:Belly`); Decided (ID: `keyterm:Decided`); True (ID: `keyterm:True`); دَاودَ (ID: `person:David`); Affection (ID: `keyterm:Affection`); ٱلرّوحِ (ID: `deity:HolySpirit`); Religious Officials (ID: `group:ReligiousOfficials`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** يوحنا 8:1-11
* **Associated Articles:** الفرّيسيون (ID: `133852@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Fornication (ID: `keyterm:Fornication`); Law (ID: `keyterm:Law`); To Command (ID: `keyterm:Command`); To Sin (ID: `keyterm:Sin`); Condemn (ID: `keyterm:Condemn`); Pharisees (ID: `group:Pharisee`); Ask for (ID: `keyterm:AskFor`); Without Sin (ID: `keyterm:WithoutSin`); موسَى (ID: `person:Moses`); Olive Tree (ID: `flora:OliveTree`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** يوحنا 8:31-59
...
* **Associated ACAI Concepts:** إِبْرَاهِيمَ (ID: `person:Abraham`); يَسوع (ID: `person:Jesus.2`); ٱلرَّبِّ (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Jews (ID: `group:Jews`); Surely! (ID: `keyterm:Surely`); Always (ID: `keyterm:Always`); Believe (ID: `keyterm:Believe`); Demons (ID: `deity:Demons`); Glory (ID: `keyterm:Glory`); To Sin (ID: `keyterm:Sin`); Be Enslaved (ID: `keyterm:Serve.2`); True (ID: `keyterm:True`); Be a Disciple (ID: `keyterm:Disciple`); Love (ID: `keyterm:Love`); Fornication (ID: `keyterm:Fornication`); Samaritans (ID: `group:Samaritan`); Decided (ID: `keyterm:Decided`); Word (ID: `keyterm:Word`); ٱلسَّامِرَةِ (ID: `place:Samaria`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** يوحنا 9:1-12

* **Associated ACAI Concepts:** Siloam (ID: `place:Siloam`); To Sin (ID: `keyterm:Sin`); يَسوع (ID: `person:Jesus.2`); A Group of People (ID: `group:GenericGroup`); Anointed (ID: `keyterm:Anointed`); A Blind Man (ID: `person:BlindMan`); Be a Disciple (ID: `keyterm:Disciple`); Ability (ID: `keyterm:Ability`); Ask for (ID: `keyterm:AskFor`); ٱلرَّبِّ (ID: `deity:Lord`); Pool (ID: `realia:Pool`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَسوع (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`); Jews (ID: `group:Jews`); Blaspheme (ID: `keyterm:Blaspheme`); يوحَنَّا (ID: `person:John`); Sheep (ID: `fauna:Lamb`); Always (ID: `keyterm:Always`); ٱلْأرْدنِّ (ID: `place:Jordan`); أورشَلِيمَ (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); سلَيْمَانَ (ID: `person:Solomon`); Name (ID: `keyterm:Name`); Symbol (ID: `keyterm:Example`); True (ID: `keyterm:True`); Law (ID: `keyterm:Law`); Baptism (ID: `keyterm:Baptism`); Written (ID: `keyterm:Scripture`); Consecration (ID: `keyterm:Consecration.2`); Bear Witness (ID: `keyterm:BearWitness`); Porch (ID: `realia:Porch`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** يوحنا 11:1-16
* **Associated Articles:** مريم، مرثا ولعازر (ID: `133885@BiblicaStudyNotesKeyTerms`); قيامة (ID: `134370@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); لِعَازَر (ID: `person:Lazarus.2`); Be a Disciple (ID: `keyterm:Disciple`); مَرْيَم (ID: `person:Mary.3`); Stumble (ID: `keyterm:Stumble`); مَرْثَا (ID: `person:Martha`); A Group of Disciples (ID: `group:GenericDisciples`); عَنْيَا (ID: `place:Bethany`); تومَا (ID: `person:Thomas`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); Anointed (ID: `keyterm:Anointed`); ٱلرَّبِّ (ID: `deity:Lord`); يَهوذَا (ID: `place:Judea`); Believe (ID: `keyterm:Believe`); Jews (ID: `group:Jews`); Friendship (ID: `keyterm:Friendship`); Salvation (ID: `keyterm:Salvation`); Myrrh (ID: `flora:Myrrh`); Myrrh (ID: `realia:Myrrh`)
...
* **Associated Passages:** يوحنا 11:17-45
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`); مَرْيَم (ID: `person:Mary.3`); مَرْثَا (ID: `person:Martha`); Jews (ID: `group:Jews`); ٱلرَّبِّ (ID: `deity:Lord`); Resurrection (ID: `keyterm:Resurrection`); Grave (ID: `realia:Grave`); Life (ID: `keyterm:Life`); لِعَازَر (ID: `person:Lazarus.2`); عَنْيَا (ID: `place:Bethany`); House (ID: `realia:House`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); أورشَلِيمَ (ID: `place:Jerusalem`); Always (ID: `keyterm:Always`); Spirit (ID: `keyterm:Spirit.2`); Friendship (ID: `keyterm:Friendship`); Band of Cloth (ID: `realia:BandOfCloth`); Stade (ID: `realia:Stade`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** يوحنا 11:46-57
* **Associated Articles:** السنهدريم (ID: `133869@BiblicaStudyNotesKeyTerms`); رئيس الكهنة (ID: `134170@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Pharisees (ID: `group:Pharisee`); Jews (ID: `group:Jews`); قَيَافَا (ID: `person:Caiaphas`); Passover (ID: `keyterm:Passover`); أورشَلِيمَ (ID: `place:Jerusalem`); أَفْرَايِمَ (ID: `place:Ephraim`); Be a Disciple (ID: `keyterm:Disciple`); Symbol (ID: `keyterm:Example`); Speak as a Prophet (ID: `keyterm:Speak`); Believe (ID: `keyterm:Believe`); ٱلرّومَانِيّونَ (ID: `place:Rome`); Pure (ID: `keyterm:Pure`); ٱلرَّبِّ (ID: `deity:Lord`); Commandment (ID: `keyterm:Commandment`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** يوحنا 12:1-11
* **Associated Articles:** بيت عنيا (ID: `133877@BiblicaStudyNotesKeyTerms`); يهوذا (ID: `133896@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); لِعَازَر (ID: `person:Lazarus.2`); Resurrection (ID: `keyterm:Resurrection`); Jews (ID: `group:Jews`); Myrrh (ID: `flora:Myrrh`); Myrrh (ID: `realia:Myrrh`); مَرْيَم (ID: `person:Mary.3`); مَرْثَا (ID: `person:Martha`); Anointed (ID: `keyterm:Anointed`); Pure (ID: `keyterm:Pure`); يَهوذَا (ID: `person:Judas.2`); Believe (ID: `keyterm:Believe`); عَنْيَا (ID: `place:Bethany`); Serve (ID: `keyterm:Serve`); Passover (ID: `keyterm:Passover`); Be a Disciple (ID: `keyterm:Disciple`); Oil of Nard (ID: `realia:OilOfNard`); Money Box (ID: `realia:MoneyBox`); Nard (ID: `flora:Nard`); Pound (ID: `realia:Pound`); House (ID: `realia:House`); Denarius (ID: `realia:Denarius`)
...
* **Associated Passages:** يوحنا 12:12-36
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); ٱلرَّبِّ (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); فِيلبّسَ (ID: `person:Philip`); أورشَلِيمَ (ID: `place:Jerusalem`); Always (ID: `keyterm:Always`); Name (ID: `keyterm:Name`); A Group of People (ID: `group:GenericGroup`); Donkey (ID: `fauna:Donkey`); Hosanna (ID: `keyterm:Hosanna`); Surely! (ID: `keyterm:Surely`); Life (ID: `keyterm:Life`); لِعَازَر (ID: `person:Lazarus.2`); Live (ID: `keyterm:Live.3`); صَيْدَا (ID: `place:Bethsaida`); Greeks (ID: `group:Greek`); ٱلْجَلِيلِ (ID: `place:Galilee`); An Angel (ID: `deity:Angel`); Bless (ID: `keyterm:Bless`); Symbol (ID: `keyterm:Example`); Judgment (ID: `keyterm:Judgment`); Bow Down (ID: `keyterm:BowDown`); Law (ID: `keyterm:Law`); Sky (ID: `keyterm:Heaven`); Fear (ID: `keyterm:Fear`); Believe (ID: `keyterm:Believe`); Resurrection (ID: `keyterm:Resurrection`); أَنْدَرَاوسَ (ID: `person:Andrew`); Serve (ID: `keyterm:Serve`); Ask for (ID: `keyterm:AskFor`); Be a Disciple (ID: `keyterm:Disciple`); Court Case (ID: `keyterm:CourtCase`); إِسْرَائِيلَ (ID: `person:Israel`); Salvation (ID: `keyterm:Salvation`); Friendship (ID: `keyterm:Friendship`); Religious Officials (ID: `group:ReligiousOfficials`); يَاان (ID: `person:Javan`); Pharisees (ID: `group:Pharisee`); Bear Witness (ID: `keyterm:BearWitness`); Grain (ID: `flora:Grain`); Date Palm (ID: `flora:DatePalm`); Wheat (ID: `flora:Wheat`); Grave (ID: `realia:Grave`)
...
* **Associated Passages:** يوحنا 12:37-50
* **Associated Articles:** أخبار سارة (بشارة) (ID: `133845@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); ٱلرَّبِّ (ID: `deity:Lord`); إِشَعْيَاء (ID: `person:Isaiah`); Glory (ID: `keyterm:Glory`); Decided (ID: `keyterm:Decided`); Ability (ID: `keyterm:Ability`); Word (ID: `keyterm:Word`); Commandment (ID: `keyterm:Commandment`); To Cause to Happen (ID: `keyterm:Happen`); Symbol (ID: `keyterm:Example`); Love (ID: `keyterm:Love`); يَسوع (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Pharisees (ID: `group:Pharisee`); Heart (ID: `keyterm:Heart`); Salvation (ID: `keyterm:Salvation`); Always (ID: `keyterm:Always`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated Passages:** يوحنا 13:1-17
* **Associated Articles:** القائد الخادم (ID: `133861@BiblicaStudyNotesKeyTerms`); عبد الرب (ID: `134346@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); بطْرس (ID: `person:Peter`); Clean (ID: `keyterm:Clean`); ٱلرَّبِّ (ID: `deity:Lord`); Towel (ID: `realia:Towel`); Clothing (ID: `realia:Clothing`); Be a Disciple (ID: `keyterm:Disciple`); Ability (ID: `keyterm:Ability`); Passover (ID: `keyterm:Passover`); سِمْعَان (ID: `person:Simon.7`); Love (ID: `keyterm:Love`); Surely! (ID: `keyterm:Surely`); يَهوذَا (ID: `person:Judas.2`); Obligated (ID: `keyterm:Ought`); Heart (ID: `keyterm:Heart`); Happy (ID: `keyterm:Happy`); Always (ID: `keyterm:Always`); Bowl (ID: `realia:Bowl`)
...
* **Associated Passages:** يوحنا 13:18-38

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Love (ID: `keyterm:Love`); Surely! (ID: `keyterm:Surely`); بطْرس (ID: `person:Peter`); Be a Disciple (ID: `keyterm:Disciple`); Glory (ID: `keyterm:Glory`); Life (ID: `keyterm:Life`); يَهوذَا (ID: `person:Judas.2`); ٱلرَّبِّ (ID: `deity:Lord`); سِمْعَان (ID: `person:Simon.7`); Chosen (ID: `keyterm:Chosen`); Commandment (ID: `keyterm:Commandment`); To Cause to Happen (ID: `keyterm:Happen`); Believe (ID: `keyterm:Believe`); ٱلشَّيْطَان (ID: `deity:Satan`); Written (ID: `keyterm:Scripture`); Jews (ID: `group:Jews`); Spirit (ID: `keyterm:Spirit.2`); Bear Witness (ID: `keyterm:BearWitness`); Money Box (ID: `realia:MoneyBox`); Rooster (ID: `fauna:Rooster`)
...
* **Associated Passages:** يوحنا 14:1-21

* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); Commandment (ID: `keyterm:Commandment`); Name (ID: `keyterm:Name`); فِيلبّسَ (ID: `person:Philip`); ٱلرّوحِ (ID: `deity:HolySpirit`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); يَسوع (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Glory (ID: `keyterm:Glory`); Surely! (ID: `keyterm:Surely`); Heart (ID: `keyterm:Heart`); Always (ID: `keyterm:Always`); Word (ID: `keyterm:Word`); تومَا (ID: `person:Thomas`); Ask for (ID: `keyterm:AskFor`); House (ID: `realia:House`)
...
* **Associated Passages:** يوحنا 14:22-31
* **Associated Articles:** يهوذا (ID: `133896@BiblicaStudyNotesKeyTerms`); سلام (ID: `134013@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); يَهوذَا (ID: `person:Judas`); Make Peace (ID: `keyterm:Peace`); To Command (ID: `keyterm:Command`); Name (ID: `keyterm:Name`); يَهوذَا (ID: `person:Judas.2`); Believe (ID: `keyterm:Believe`); يَسوع (ID: `person:Jesus.2`); Heart (ID: `keyterm:Heart`); ٱلرّوحِ (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Love (ID: `keyterm:Love`); Vine (ID: `flora:Vine`); Chosen (ID: `keyterm:Chosen`); To Command (ID: `keyterm:Command`); Ability (ID: `keyterm:Ability`); Commandment (ID: `keyterm:Commandment`); Name (ID: `keyterm:Name`); To Sin (ID: `keyterm:Sin`); Bear Witness (ID: `keyterm:BearWitness`); Friendship (ID: `keyterm:Friendship`); Glory (ID: `keyterm:Glory`); Truth (ID: `keyterm:Truth`); Life (ID: `keyterm:Life`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Word (ID: `keyterm:Word`); True (ID: `keyterm:True`); Law (ID: `keyterm:Law`); To Cause to Happen (ID: `keyterm:Happen`); Clean (ID: `keyterm:Clean`); ٱلرّوحِ (ID: `deity:HolySpirit`); Be a Disciple (ID: `keyterm:Disciple`)
...
* **Associated Passages:** يوحنا 16:1-15
* **Associated Articles:** يُعامل بقسوة (ID: `133856@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Court Case (ID: `keyterm:CourtCase`); To Sin (ID: `keyterm:Sin`); Judgment (ID: `keyterm:Judgment`); Truth (ID: `keyterm:Truth`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); ٱلرّوحِ (ID: `deity:HolySpirit`); Glory (ID: `keyterm:Glory`); Decided (ID: `keyterm:Decided`); Believe (ID: `keyterm:Believe`); Serve (ID: `keyterm:Serve`); Heart (ID: `keyterm:Heart`); Priesthood (ID: `keyterm:Priesthood`); Ask for (ID: `keyterm:AskFor`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Ask for (ID: `keyterm:AskFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ability (ID: `keyterm:Ability`); Name (ID: `keyterm:Name`); Believe (ID: `keyterm:Believe`); Be a Disciple (ID: `keyterm:Disciple`); Surely! (ID: `keyterm:Surely`); A Group of Disciples (ID: `group:GenericDisciples`); يَسوع (ID: `person:Jesus.2`); Cheer Up (ID: `keyterm:CheerUp`); Make Peace (ID: `keyterm:Peace`); Friendship (ID: `keyterm:Friendship`); Heart (ID: `keyterm:Heart`)
...
* **Associated Passages:** يوحنا 18:1-11

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); يَهوذَا (ID: `person:Judas.2`); Be a Disciple (ID: `keyterm:Disciple`); بطْرس (ID: `person:Peter`); نَاصِرَة (ID: `place:Nazareth`); Military Members (ID: `group:MilitaryMembers`); مَلْخسَ (ID: `person:Malchus`); To Cause to Happen (ID: `keyterm:Happen`); قَدْرونَ (ID: `place:Kidron`); Name (ID: `keyterm:Name`); Pharisees (ID: `group:Pharisee`); Public Officials (ID: `group:GenericOfficials`); ٱلرَّبِّ (ID: `deity:Lord`); Lantern (ID: `realia:Lantern`); Sheath (ID: `realia:Sheath`); Torch (ID: `realia:Torch`)
...
* **Associated Passages:** يوحنا 18:12-27

* **Associated ACAI Concepts:** بطْرس (ID: `person:Peter`); يَسوع (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); قَيَافَا (ID: `person:Caiaphas`); Jews (ID: `group:Jews`); حَنَّانَ (ID: `person:Annas`); A Servant (ID: `person:GenericServant`); Ask for (ID: `keyterm:AskFor`); Ability (ID: `keyterm:Ability`); Bear Witness (ID: `keyterm:BearWitness`); Rooster (ID: `fauna:Rooster`); Door (ID: `realia:Door`); Synagogue (ID: `realia:Synagogue`); Courtyard (ID: `realia:Courtyard`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** يوحنا 18:28-40
* **Associated Articles:** روما (ID: `133849@BiblicaStudyNotesKeyTerms`); باراباس (ID: `133878@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); بِيلَاطسَ (ID: `person:Pilate`); Ability (ID: `keyterm:Ability`); Truth (ID: `keyterm:Truth`); Passover (ID: `keyterm:Passover`); Palace (ID: `realia:Palace`); Be Lawful (ID: `keyterm:Lawful`); قَيَافَا (ID: `person:Caiaphas`); To Cause to Happen (ID: `keyterm:Happen`); Kingdom (ID: `keyterm:Kingdom`); Decided (ID: `keyterm:Decided`); Law (ID: `keyterm:Law`); Defilement (ID: `keyterm:Defilement`); بَارَابَاسَ (ID: `person:Barabbas`); Bear Witness (ID: `keyterm:BearWitness`)
...
* **Associated Passages:** يوحنا 19:17-37
* **Associated Articles:** زَكَرِيَّا (ID: `134313@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Cross (ID: `realia:Cross`); بِيلَاطسَ (ID: `person:Pilate`); Written (ID: `keyterm:Scripture`); Jews (ID: `group:Jews`); To Cause to Happen (ID: `keyterm:Happen`); Be a Disciple (ID: `keyterm:Disciple`); Sour Wine (ID: `realia:SourWine`); Clothing (ID: `realia:Clothing`); كِلْيوبَاس (ID: `person:Cleopas`); نَاصِرَة (ID: `place:Nazareth`); مَرْيَم (ID: `person:Mary.4`); Blood (ID: `keyterm:Blood`); Body (ID: `keyterm:Body.3`); Love (ID: `keyterm:Love`); Sabbath (ID: `keyterm:Sabbath`); مَرْيَم (ID: `person:Marymagdalene`); True (ID: `keyterm:True`); Priests (ID: `group:GenericPriests`); Ask for (ID: `keyterm:AskFor`); Spirit (ID: `keyterm:Spirit.2`); Golgotha (ID: `place:Golgotha`); Bear Witness (ID: `keyterm:BearWitness`); Hyssop (ID: `flora:Hyssop`); Spear (ID: `realia:Spear`); Tunic (ID: `realia:Tunic.2`); Lot (ID: `realia:Lot`)
...
* **Associated Passages:** يوحنا 19:38-42

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Aloes (ID: `realia:Aloes`); Body (ID: `keyterm:Body.3`); Grave (ID: `realia:Grave`); نِيقودِيموس (ID: `person:Nicodemus`); يوسف (ID: `person:Joseph.6`); ٱلرَّامَةِ (ID: `place:Arimathea`); Be a Disciple (ID: `keyterm:Disciple`); Fear (ID: `keyterm:Fear`); Ask for (ID: `keyterm:AskFor`); بِيلَاطسَ (ID: `person:Pilate`); Pound (ID: `realia:Pound`); Myrrh (ID: `realia:Myrrh`); Aloes (ID: `flora:Aloes`); Linen (ID: `realia:Linen`); Cross (ID: `realia:Cross`); Myrrh (ID: `flora:Myrrh`)
...
* **Associated Passages:** يوحنا 20:1-18
* **Associated Articles:** مريم المجدلية (ID: `133870@BiblicaStudyNotesKeyTerms`); ملاك (ID: `134115@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); يَسوع (ID: `person:Jesus.2`); Grave (ID: `realia:Grave`); مَرْيَم (ID: `person:Marymagdalene`); بطْرس (ID: `person:Peter`); Linen (ID: `realia:Linen`); Week (ID: `keyterm:Week`); An Angel (ID: `deity:Angel`); Body (ID: `keyterm:Body.3`); Believe (ID: `keyterm:Believe`); Friendship (ID: `keyterm:Friendship`); Written (ID: `keyterm:Scripture`); ٱلرَّبِّ (ID: `deity:Lord`); Band of Cloth (ID: `realia:BandOfCloth`)
...
* **Associated Passages:** يوحنا 20:19-31
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); تومَا (ID: `person:Thomas`); Believe (ID: `keyterm:Believe`); Make Peace (ID: `keyterm:Peace`); ٱلرَّبِّ (ID: `deity:Lord`); Door (ID: `realia:Door`); Life (ID: `keyterm:Life`); Happy (ID: `keyterm:Happy`); Name (ID: `keyterm:Name`); Symbol (ID: `keyterm:Example`); To Sin (ID: `keyterm:Sin`); Be Unfaithful (ID: `keyterm:Unfaithful`); Faithfulness (ID: `keyterm:Faithfulness`); Fear (ID: `keyterm:Fear`); Jews (ID: `group:Jews`); Forgive (ID: `keyterm:Forgive`); ٱلرّوحِ (ID: `deity:HolySpirit`); Week (ID: `keyterm:Week`); A Group of Disciples (ID: `group:GenericDisciples`); Nail (ID: `realia:Nail`)
...
* **Associated Passages:** يوحنا 21:1-14
* **Associated Articles:** خليقة (ID: `133999@BiblicaStudyNotesKeyTerms`); حكمة (ID: `134127@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Fish (ID: `fauna:Fish`); بطْرس (ID: `person:Peter`); Casting Net (ID: `realia:CastingNet`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); نَثَنَائِيلَ (ID: `person:Nathanael`); Love (ID: `keyterm:Love`); بْنَ (ID: `person:Zebedee`); قَانَا (ID: `place:Cana`); ٱلْجَلِيلِ (ID: `place:Galilee`); Authority (ID: `keyterm:Authority.2`); تومَا (ID: `person:Thomas`); Resurrection (ID: `keyterm:Resurrection`); Sea of Galilee (ID: `place:GalileeSea`); Cloak (ID: `realia:Cloak`); Cubit (ID: `realia:Cubit.2`)
...
* **Associated Passages:** يوحنا 21:15-25

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); بطْرس (ID: `person:Peter`); Friendship (ID: `keyterm:Friendship`); يوحَنَّا (ID: `person:John.4`); Be a Disciple (ID: `keyterm:Disciple`); Love (ID: `keyterm:Love`); Sheep (ID: `fauna:Lamb`); Glory (ID: `keyterm:Glory`); Bear Witness (ID: `keyterm:BearWitness`); Ability (ID: `keyterm:Ability`); Surely! (ID: `keyterm:Surely`); ٱلرَّبِّ (ID: `deity:Lord`); True (ID: `keyterm:True`); Scroll (ID: `realia:Scroll`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
