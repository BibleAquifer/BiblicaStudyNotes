...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); House (ID: `realia:House`); Truth (ID: `keyterm:Truth`); Intention (ID: `keyterm:Intention`); Straightness (ID: `keyterm:Straightness`); Proverb (ID: `keyterm:Saying`); Goad (ID: `realia:Goad`); Caper (ID: `flora:Caper`); Bird (ID: `fauna:Bird`); Money (ID: `realia:Money`); Scroll (ID: `realia:Scroll`); Pit (ID: `realia:Pit`); Rope (ID: `realia:Rope`); Goat (ID: `fauna:Goat`); Locust (ID: `fauna:Locust`); Sheep (ID: `fauna:Lamb`); Clay Jar (ID: `realia:ClayJar`); Nail (ID: `realia:Nail`); Almond (ID: `flora:Almond`); Flock (ID: `fauna:Flock`)
