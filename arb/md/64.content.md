...
* **Associated ACAI Concepts:** دِيوتْرِيفِسَ (ID: `person:Diotrephes`); غَايوس (ID: `person:Gaius.4`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); دِيمِتْرِيوس (ID: `person:Demetrius`); Truth (ID: `keyterm:Truth`)
