...
* **Associated ACAI Concepts:** Perceive (ID: `keyterm:Perceive`); Proverb (ID: `keyterm:Saying`); Ability (ID: `keyterm:Ability`); Intention (ID: `keyterm:Intention`); Discretion (ID: `keyterm:Discretion`); Simple Person (ID: `keyterm:SimplePerson`); Crafty (ID: `keyterm:Crafty`); Have Insight (ID: `keyterm:HaveInsight`); Guidance (ID: `keyterm:Guidance`); Fool (ID: `keyterm:Fool`); إِسْرَائِيلَ (ID: `person:Israel`); Understanding (ID: `keyterm:Understanding`); Fear (ID: `keyterm:Fear`); Fairness (ID: `keyterm:Fairness`); سلَيْمَانَ (ID: `person:Solomon`); ٱلرَّبِّ (ID: `deity:Lord`); دَاودَ (ID: `person:David`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Understanding (ID: `keyterm:Understanding`); Ability (ID: `keyterm:Ability`); Intention (ID: `keyterm:Intention`); Stupid (ID: `keyterm:Stupid`); Love (ID: `keyterm:Love`); Simple Person (ID: `keyterm:SimplePerson`); Instruction (ID: `keyterm:Instruction`); Fear (ID: `keyterm:Fear`); Perceive (ID: `keyterm:Perceive`); House (ID: `realia:House`); Discretion (ID: `keyterm:Discretion`); Hell (ID: `place:Hell`); Money (ID: `realia:Money`); Sound Wisdom (ID: `keyterm:SoundWisdom`); Glory (ID: `keyterm:Glory`); Safety (ID: `keyterm:Safety`); Counsel (ID: `keyterm:Counsel`); Vine (ID: `flora:Vine`); Trap (ID: `realia:Trap`); Straightness (ID: `keyterm:Straightness`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Mischief (ID: `keyterm:Mischief`); To Sin (ID: `keyterm:Sin`); Peace (ID: `keyterm:IntactState`); Crafty (ID: `keyterm:Crafty`); Truth (ID: `keyterm:Truth`); Bless (ID: `keyterm:Bless`); Favor (ID: `keyterm:Favor`); Passion (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** لَموئِيلَ (ID: `person:Lemuel`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Utterance (ID: `keyterm:Utterance`); Vow (ID: `keyterm:Vow`)
...
* **Associated ACAI Concepts:** Fear (ID: `keyterm:Fear`); Kindness (ID: `keyterm:Kindness`); Trust (ID: `keyterm:LeanOn`); ٱلرَّبِّ (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Decree (ID: `keyterm:Decree`); Spindle (ID: `realia:Spindle`); Purple Cloth (ID: `realia:PurpleCloth`); Linen (ID: `realia:Linen`); Wool (ID: `realia:Wool`); Ship (ID: `realia:Ship`); Vine (ID: `flora:Vine`); Tunic (ID: `realia:Tunic.2`); Lamp (ID: `realia:Lamp`); Flax (ID: `flora:Flax`)
