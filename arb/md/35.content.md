...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); حَبَقّوق (ID: `person:Habakkuk`); فَارَانَ (ID: `place:ParanMount`); تَيْمَانَ (ID: `place:Teman`); كوشَانَ (ID: `place:Cushan`); Anointed (ID: `keyterm:Anointed`); Holy (ID: `keyterm:Holy`); Arrow (ID: `keyterm:Arrow`); Oath (ID: `keyterm:Oath`); Fear (ID: `keyterm:Fear`); مِدْيَانَ (ID: `place:Midian`); Mischief (ID: `keyterm:Mischief`); Majesty (ID: `keyterm:Majesty`); Deer (ID: `fauna:Deer`); Foundation (ID: `realia:Foundation`); Animal Pen (ID: `realia:AnimalPen`); Flock (ID: `fauna:Flock`); Tent (ID: `realia:Tent`); Spear (ID: `realia:Spear`); Goat (ID: `fauna:Goat`); Vine (ID: `flora:Vine`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Sheepfold (ID: `realia:Sheepfold`); Bow (ID: `realia:Bow`); Cattle (ID: `fauna:Bull`); Chariot (ID: `realia:Chariot`)
