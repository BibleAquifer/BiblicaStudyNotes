...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Woe (ID: `keyterm:Woe.2`); Dragnet (ID: `realia:Dragnet`); Net (ID: `realia:Net`); Glory (ID: `keyterm:Glory`); Casting Net (ID: `realia:CastingNet`); Idol (ID: `keyterm:Idol`); Be Disgraced (ID: `keyterm:Disgraced`); Trust (ID: `keyterm:LeanOn`); لبْنَانَ (ID: `place:Lebanon`); Pure (ID: `keyterm:Pure`); Hell (ID: `place:Hell`); Proverb (ID: `keyterm:Saying`); Holy (ID: `keyterm:Holy`); Fortification (ID: `realia:Fortification`); Harpoon (ID: `realia:Harpoon`); Wine (ID: `realia:Wine`); Chameleon (ID: `fauna:Chameleon`); Money (ID: `realia:Money`); Monitor (ID: `fauna:Iguana`); Lizard (ID: `fauna:Lizard`); Image (ID: `realia:Image`); Fish (ID: `fauna:Fish`); Tablet (ID: `realia:Tablet`); Beam (ID: `realia:Beam`); Vine (ID: `flora:Vine`); Molten Image (ID: `realia:MoltenImage`); Graven Image (ID: `realia:GravenImage`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`); Horse (ID: `fauna:Horse`); Arrow (ID: `realia:Arrow`); كوشَانَ (ID: `place:Cushan`); حَبَقّوق (ID: `person:Habakkuk`); تَيْمَانَ (ID: `place:Teman`); فَارَانَ (ID: `place:ParanMount`); Majesty (ID: `keyterm:Majesty`); Mischief (ID: `keyterm:Mischief`); مِدْيَانَ (ID: `place:Midian`); Oath (ID: `keyterm:Oath`); Arrow (ID: `keyterm:Arrow`); Fear (ID: `keyterm:Fear`); Anointed (ID: `keyterm:Anointed`); Holy (ID: `keyterm:Holy`); Deer (ID: `fauna:Deer`); Cattle (ID: `fauna:Bull`); Tent (ID: `realia:Tent`); Fig (ID: `flora:Fig`); Chariot (ID: `realia:Chariot`); Bow (ID: `realia:Bow`); Animal Pen (ID: `realia:AnimalPen`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Spear (ID: `realia:Spear`); Olive Tree (ID: `flora:OliveTree`); Sheepfold (ID: `realia:Sheepfold`); Foundation (ID: `realia:Foundation`)
