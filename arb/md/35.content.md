...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); تَيْمَانَ (ID: `place:Teman`); حَبَقّوق (ID: `person:Habakkuk`); فَارَانَ (ID: `place:ParanMount`); كوشَانَ (ID: `place:Cushan`); Arrow (ID: `keyterm:Arrow`); Oath (ID: `keyterm:Oath`); Anointed (ID: `keyterm:Anointed`); مِدْيَانَ (ID: `place:Midian`); Mischief (ID: `keyterm:Mischief`); Fear (ID: `keyterm:Fear`); Holy (ID: `keyterm:Holy`); Majesty (ID: `keyterm:Majesty`); Deer (ID: `fauna:Deer`); Sheepfold (ID: `realia:Sheepfold`); Bow (ID: `realia:Bow`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Spear (ID: `realia:Spear`); Tent (ID: `realia:Tent`); Chariot (ID: `realia:Chariot`); Flock (ID: `fauna:Flock`); Foundation (ID: `realia:Foundation`); Olive Tree (ID: `flora:OliveTree`)
