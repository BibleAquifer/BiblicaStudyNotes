...
* **Associated ACAI Concepts:** لَوْئِيسَ (ID: `person:Lois`); أَفْنِيكِي (ID: `person:Eunice`); فِيجَلّس (ID: `person:Phygelus`); هَرْموجَانِس (ID: `person:Hermogenes`); أنِيسِيفورسَ (ID: `person:Onesiphorus`); Long For (ID: `keyterm:LongFor`); يَسوع (ID: `person:Jesus.2`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** فِيلِيتس (ID: `person:Philetus`); هِيمِينَايس (ID: `person:Hymenaeus`); Approved (ID: `keyterm:Approved`); يَسوع (ID: `person:Jesus.2`); ٱلرَّبِّ (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** يَمْبِرِيس (ID: `person:Jambres`); يَنِّيس (ID: `person:Jannes`); إِيقونِيَةَ (ID: `place:Iconium`); Declare (ID: `keyterm:Declare`); Written (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** كِرِيسْكِيسَ (ID: `person:Crescens`); كَلَافِدِيَّة (ID: `person:Claudia`); كَارْبسَ (ID: `person:Carpus`); دَلْمَاطِيَّةَ (ID: `place:Dalmatia`); بودِيس (ID: `person:Pudens`); Parchment (ID: `realia:Parchment`); أَفْبولس (ID: `person:Eubulus`); وَلِينس (ID: `person:Linus`); ٱلْإِسْكَنْدَرِ (ID: `person:Alexander.4`); أنِيسِيفورسَ (ID: `person:Onesiphorus`); Deliver (ID: `keyterm:Deliver`); مِيلِيتسَ (ID: `place:Miletus`); دِيمَاس (ID: `person:Demas`); أَرَسْطوسَ (ID: `person:Erastus`); تروفِيمس (ID: `person:Trophimus`); لوقَا (ID: `person:Luke`); بِرِيسْكِلَّا (ID: `person:Priscilla`); يَسوع (ID: `person:Jesus.2`)
