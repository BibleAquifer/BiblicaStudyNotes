...
* **Associated Passages:** غلاطية 1:1-10
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Good News (ID: `keyterm:GoodNews`); ٱلرَّبِّ (ID: `deity:Lord`); Favor (ID: `keyterm:Favor`); Always (ID: `keyterm:Always`); غَلَاطِيَّةَ (ID: `place:Galatia`); Rescue (ID: `keyterm:Rescue`); Persuade (ID: `keyterm:Persuade`); An Angel (ID: `deity:Angel`); Make Peace (ID: `keyterm:Peace`); Surely! (ID: `keyterm:Surely`); Resurrection (ID: `keyterm:Resurrection`); Glory (ID: `keyterm:Glory`); بولسَ (ID: `person:Paul`); To Sin (ID: `keyterm:Sin`); Church (ID: `keyterm:Church`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** Good News (ID: `keyterm:GoodNews`); ٱلرَّبِّ (ID: `deity:Lord`); يَسوع (ID: `person:Jesus.2`); أورشَلِيمَ (ID: `place:Jerusalem`); Church (ID: `keyterm:Church`); يَعْقوبَ (ID: `person:James.3`); ٱلْعَرَبِ (ID: `place:Arabia`); Behavior (ID: `keyterm:Behavior`); يَهوذَا (ID: `place:Judea`); Blood (ID: `keyterm:Blood`); Glory (ID: `keyterm:Glory`); دِمَشْقَ (ID: `place:Damascus`); Believe (ID: `keyterm:Believe`); Body (ID: `keyterm:Body.3`); بطْرس (ID: `person:Peter`); كِيلِيكِيَّةَ (ID: `place:Cilicia`); Favor (ID: `keyterm:Favor`); Gentiles (ID: `group:Gentile`); In Christ (ID: `keyterm:InChrist`); Teaching (ID: `keyterm:Teaching`)
...
* **Associated ACAI Concepts:** Good News (ID: `keyterm:GoodNews`); بطْرس (ID: `person:Peter`); Circumcision (ID: `keyterm:Circumcision`); Gentiles (ID: `group:Gentile`); تِيطسَ (ID: `person:Titus`); بَرْنَابَا (ID: `person:Barnabas`); يوحَنَّا (ID: `person:John.2`); Believe (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); يَعْقوبَ (ID: `person:James.3`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Empty (ID: `keyterm:Empty`); Fellowship (ID: `keyterm:Fellowship`); يَاان (ID: `person:Javan`); يَسوع (ID: `person:Jesus.2`); Favor (ID: `keyterm:Favor`); Greeks (ID: `group:Greek`); Proclaim (ID: `keyterm:Proclaim`); In Christ (ID: `keyterm:InChrist`)
...
* **Associated Passages:** غلاطية 2:11-21
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Life (ID: `keyterm:Life`); Law (ID: `keyterm:Law`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Gentiles (ID: `group:Gentile`); Believe (ID: `keyterm:Believe`); Body (ID: `keyterm:Body.3`); ٱلرَّبِّ (ID: `deity:Lord`); بطْرس (ID: `person:Peter`); أَنْطَاكِيَةِ (ID: `place:Antioch`); Hypocrisy (ID: `keyterm:Hypocrisy`); Good News (ID: `keyterm:GoodNews`); To Sin (ID: `keyterm:Sin`); Love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); يَعْقوبَ (ID: `person:James.3`); Condemn (ID: `keyterm:Condemn`); بَرْنَابَا (ID: `person:Barnabas`); Fear (ID: `keyterm:Fear`); Circumcision (ID: `keyterm:Circumcision`); Favor (ID: `keyterm:Favor`); In Christ (ID: `keyterm:InChrist`); Cross (ID: `realia:Cross`)
...
* **Associated Passages:** غلاطية 3:1-14
...
* **Associated Passages:** غلاطية 3:15-29
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Promise (ID: `keyterm:Promise`); Law (ID: `keyterm:Law`); Believe (ID: `keyterm:Believe`); ٱلرَّبِّ (ID: `deity:Lord`); إِبْرَاهِيمَ (ID: `person:Abraham`); In Christ (ID: `keyterm:InChrist`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Covenant (ID: `keyterm:Covenant`); An Angel (ID: `deity:Angel`); Written (ID: `keyterm:Scripture`); Baptism (ID: `keyterm:Baptism`); Greeks (ID: `group:Greek`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); Jews (ID: `group:Jews`); يَاان (ID: `person:Javan`)
...
* **Associated Passages:** غلاطية 4:1-20
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Be Enslaved (ID: `keyterm:Serve.2`); Fundamental Principles (ID: `keyterm:FundamentalPrinciples`); يَسوع (ID: `person:Jesus.2`); Body (ID: `keyterm:Body.3`); Law (ID: `keyterm:Law`); An Angel (ID: `deity:Angel`); Bear Witness (ID: `keyterm:BearWitness`); Redeem (ID: `keyterm:Redeem`); Good News (ID: `keyterm:GoodNews`); Speak the Truth (ID: `keyterm:SpeakTheTruth`); To Act Wickedly (ID: `keyterm:ActWickedly`); Heart (ID: `keyterm:Heart`); Happiness (ID: `keyterm:Happiness`); Fear (ID: `keyterm:Fear`); ٱلرّوحِ (ID: `deity:HolySpirit`); Ability (ID: `keyterm:Ability`)
...
* **Associated Passages:** غلاطية 4:21-31
* **Associated Articles:** عهد (ID: `134039@BiblicaStudyNotesKeyTerms`); سارة (ID: `134049@BiblicaStudyNotesKeyTerms`); هاجر (ID: `134061@BiblicaStudyNotesKeyTerms`); إِسْحَق (ID: `134063@BiblicaStudyNotes`); إِسْمَاعِيل (ID: `134064@BiblicaStudyNotesKeyTerms`); جَبَلِ سِينَاء (ID: `134129@BiblicaStudyNotesKeyTerms`); عهد جبل سيناء (ID: `134130@BiblicaStudyNotesKeyTerms`); أورشليم الجديدة (ID: `134351@BiblicaStudyNotesKeyTerms`); العهد الجديد (ID: `134355@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** هَاجَر (ID: `person:Hagar`); سِينَاءَ (ID: `place:SinaiMount`); أورشَلِيمَ (ID: `place:Jerusalem`); Body (ID: `keyterm:Body.3`); Promise (ID: `keyterm:Promise`); Enslavement (ID: `keyterm:Slavery`); Written (ID: `keyterm:Scripture`); ٱلْعَرَبِ (ID: `place:Arabia`); Law (ID: `keyterm:Law`); Be Enslaved (ID: `keyterm:Serve.2`); إِسْحَاق (ID: `person:Isaac`); إِبْرَاهِيمَ (ID: `person:Abraham`); ٱلرّوحِ (ID: `deity:HolySpirit`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated Passages:** غلاطية 5:1-12
* **Associated Articles:** نعمة (ID: `134037@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Circumcision (ID: `keyterm:Circumcision`); Believe (ID: `keyterm:Believe`); Heart (ID: `keyterm:Heart`); Persuade (ID: `keyterm:Persuade`); Law (ID: `keyterm:Law`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Enslavement (ID: `keyterm:Slavery`); بولسَ (ID: `person:Paul`); Declare (ID: `keyterm:Declare`); Love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); Think (ID: `keyterm:Think`); Hope (ID: `keyterm:Hope`); Judgment (ID: `keyterm:Judgment`); Stumbling Block (ID: `keyterm:StumblingBlock`); That Which Persuades (ID: `keyterm:ThatWhichPersuades`); ٱلرّوحِ (ID: `deity:HolySpirit`); Favor (ID: `keyterm:Favor`); Proclaim (ID: `keyterm:Proclaim`); Cross (ID: `realia:Cross`); Yoke (ID: `realia:Yoke`)
...
* **Associated Passages:** غلاطية 5:13-26
* **Associated Articles:** ثمر الروح القدس (ID: `133956@BiblicaStudyNotesKeyTerms`); قلب (ID: `134221@BiblicaStudyNotes`); ملكوت الله (ID: `134363@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); ٱلرّوحِ (ID: `deity:HolySpirit`); Love (ID: `keyterm:Love`); Law (ID: `keyterm:Law`); Resentment (ID: `keyterm:Resentment`); Live (ID: `keyterm:Live.3`); Good (ID: `keyterm:Good`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Believe (ID: `keyterm:Believe`); Kindness (ID: `keyterm:Kindness`); Be Enslaved (ID: `keyterm:Serve.2`); ٱلرَّبِّ (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Idolatry (ID: `keyterm:Idolatry`); Defilement (ID: `keyterm:Defilement`); يَسوع (ID: `person:Jesus.2`); Make Peace (ID: `keyterm:Peace`); Empty Conceit (ID: `keyterm:Conceit`); Kingdom (ID: `keyterm:Kingdom`); Fornication (ID: `keyterm:Fornication`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); Share (ID: `keyterm:Share`); يَسوع (ID: `person:Jesus.2`); Interpret (ID: `keyterm:Interpret`); Spirit (ID: `keyterm:Spirit.2`); Life (ID: `keyterm:Life`); Body (ID: `keyterm:Body.3`); Law (ID: `keyterm:Law`); Always (ID: `keyterm:Always`); Put to the Test (ID: `keyterm:PutToTheTest`); ٱلرّوحِ (ID: `deity:HolySpirit`); ٱلرَّبِّ (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`)
...
* **Associated Passages:** غلاطية 6:11-18
* **Associated Articles:** يُعامل بقسوة (ID: `133856@BiblicaStudyNotesKeyTerms`); الخليقة الجديدة (ID: `134345@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Body (ID: `keyterm:Body.3`); Cross (ID: `realia:Cross`); Make Peace (ID: `keyterm:Peace`); Spirit (ID: `keyterm:Spirit.2`); Surely! (ID: `keyterm:Surely`); Mercy (ID: `keyterm:Mercy`); Circumcision (ID: `keyterm:Circumcision`); Favor (ID: `keyterm:Favor`); Law (ID: `keyterm:Law`); Mark (ID: `keyterm:Mark`); ٱلرَّبِّ (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); إِسْرَائِيلَ (ID: `person:Israel`)
