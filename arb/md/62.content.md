...
* **Associated Passages:** يوحنا الأولى 1:1-2:2
* **Associated Articles:** ظلام (ID: `133841@BiblicaStudyNotesKeyTerms`); تلميذ (ID: `133842@BiblicaStudyNotesKeyTerms`); خطية (ID: `133997@BiblicaStudyNotesKeyTerms`); الله (ID: `134001@BiblicaStudyNotesKeyTerms`); كلمة الله  (ID: `134002@BiblicaStudyNotesKeyTerms`); رُسُل (ID: `133855@BiblicaStudyNotesKeyTerms`); عالم (ID: `134017@BiblicaStudyNotesKeyTerms`); يسوع (ID: `134021@BiblicaStudyNotesKeyTerms`); يغفر (ID: `134083@BiblicaStudyNotesKeyTerms`); التوبة (ID: `134148@BiblicaStudyNotesKeyTerms`); يوحنا (ID: `134344@BiblicaStudyNotesKeyTerms`); نور (ID: `134348@BiblicaStudyNotesKeyTerms`); حياة أبدية (ID: `134371@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); ٱلرَّبِّ (ID: `deity:Lord`); Fellowship (ID: `keyterm:Fellowship`); يَسوع (ID: `person:Jesus.2`); To Cleanse (ID: `keyterm:Cleanse.2`); Truth (ID: `keyterm:Truth`); Live (ID: `keyterm:Live.3`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Life (ID: `keyterm:Life`); Faithfulness (ID: `keyterm:Faithfulness`); Bear Witness (ID: `keyterm:BearWitness`); Blood (ID: `keyterm:Blood`); Mercy Seat (ID: `keyterm:Propitiation`); Forgive (ID: `keyterm:Forgive`); Ability (ID: `keyterm:Ability`); Unjust Deed (ID: `keyterm:UnjustDeed`); Always (ID: `keyterm:Always`); Cause of Joy (ID: `keyterm:CauseOfJoy`)
...
* **Associated Passages:** يوحنا الأولى 2:3-14
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); Live (ID: `keyterm:Live.3`); True (ID: `keyterm:True`); ٱلرَّبِّ (ID: `deity:Lord`); Love (ID: `keyterm:Love`); Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); Stumbling Block (ID: `keyterm:StumblingBlock`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); Beloved (ID: `keyterm:Beloved`); Obligated (ID: `keyterm:Ought`)
...
* **Associated Passages:** يوحنا الأولى 2:15-29
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Anointed (ID: `keyterm:Anointed`); Always (ID: `keyterm:Always`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Daily Life (ID: `keyterm:DailyLife`); Truth (ID: `keyterm:Truth`); ٱلرّوحِ (ID: `deity:HolySpirit`); يَسوع (ID: `person:Jesus.2`); Promise (ID: `keyterm:Promise`); True (ID: `keyterm:True`); Body (ID: `keyterm:Body.3`); Holy (ID: `keyterm:Holy`); Life (ID: `keyterm:Life`); Love (ID: `keyterm:Love`)
...
* **Associated Passages:** يوحنا الأولى 3:1-24
...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); ٱلرَّبِّ (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Heart (ID: `keyterm:Heart`); Commandment (ID: `keyterm:Commandment`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); Condemn (ID: `keyterm:Condemn`); Truth (ID: `keyterm:Truth`); Beloved (ID: `keyterm:Beloved`); قَايِينَ (ID: `person:Cain`); Hope (ID: `keyterm:Hope`); Persuade (ID: `keyterm:Persuade`); Always (ID: `keyterm:Always`); Lawless (ID: `keyterm:Lawless`); Name (ID: `keyterm:Name`); Pure (ID: `keyterm:Pure`); Affection (ID: `keyterm:Affection`); Daily Life (ID: `keyterm:DailyLife`); Believe (ID: `keyterm:Believe`); ٱلرّوحِ (ID: `deity:HolySpirit`); يَسوع (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Spirit (ID: `keyterm:Spirit.2`); ٱلرّوحِ (ID: `deity:HolySpirit`); يَسوع (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`); Believe (ID: `keyterm:Believe`); Beloved (ID: `keyterm:Beloved`); Body (ID: `keyterm:Body.3`); Interpret (ID: `keyterm:Interpret`)
...
* **Associated Passages:** يوحنا الأولى 4:7-21
* **Associated Articles:** إنجيل (بشارة) (ID: `133833@BiblicaStudyNotesKeyTerms`); كامل (ID: `133967@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); ٱلرَّبِّ (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Beloved (ID: `keyterm:Beloved`); Obligated (ID: `keyterm:Ought`); Savior (ID: `keyterm:Savior`); Bear Witness (ID: `keyterm:BearWitness`); Believe (ID: `keyterm:Believe`); ٱلرّوحِ (ID: `deity:HolySpirit`); Fear (ID: `keyterm:Fear`); Commandment (ID: `keyterm:Commandment`); يَسوع (ID: `person:Jesus.2`); A Person (ID: `person:GenericPerson`); Judgment (ID: `keyterm:Judgment`); Mercy Seat (ID: `keyterm:Propitiation`); To Sin (ID: `keyterm:Sin`); Court Case (ID: `keyterm:CourtCase`); Life (ID: `keyterm:Life`)
...
* **Associated Passages:** يوحنا الأولى 5:1-21
* **Associated Articles:** عبادة الله وحده (ID: `134134@BiblicaStudyNotes`)

* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Bear Witness (ID: `keyterm:BearWitness`); Believe (ID: `keyterm:Believe`); يَسوع (ID: `person:Jesus.2`); Always (ID: `keyterm:Always`); Ability (ID: `keyterm:Ability`); To Sin (ID: `keyterm:Sin`); Love (ID: `keyterm:Love`); Commandment (ID: `keyterm:Commandment`); Blood (ID: `keyterm:Blood`); ٱلرّوحِ (ID: `deity:HolySpirit`); Unjust Deed (ID: `keyterm:UnjustDeed`); Ask for (ID: `keyterm:AskFor`); True (ID: `keyterm:True`); Mind (ID: `keyterm:Mind.2`); Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); Image (ID: `realia:Image`)
