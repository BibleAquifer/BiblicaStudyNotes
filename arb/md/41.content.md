...
* **Associated ACAI Concepts:** يوحَنَّا (ID: `person:John`); Baptism (ID: `keyterm:Baptism`); يَسوع (ID: `person:Jesus.2`); Good News (ID: `keyterm:GoodNews`); Proclaim (ID: `keyterm:Proclaim`); ٱلرَّبِّ (ID: `deity:Lord`); ٱلرّوحِ (ID: `deity:HolySpirit`); ٱلْأرْدنِّ (ID: `place:Jordan`); ٱلْجَلِيلِ (ID: `place:Galilee`); بْنَ (ID: `person:Zebedee`); To Sin (ID: `keyterm:Sin`); Sky (ID: `keyterm:Heaven`); Repent (ID: `keyterm:Repent`); An Angel (ID: `deity:Angel`); Ship (ID: `realia:Ship`); Casting Net (ID: `realia:CastingNet`); Fishnet (ID: `realia:Fishnet`); Sea of Galilee (ID: `place:GalileeSea`); Hired Worker (ID: `keyterm:HiredWorker`); يَعْقوبَ (ID: `person:James`); يوحَنَّا (ID: `person:John.2`); يَهوذَا (ID: `place:Judea`); Forgive (ID: `keyterm:Forgive`); Believe (ID: `keyterm:Believe`); Straightness (ID: `keyterm:Straightness`); إِشَعْيَاء (ID: `person:Isaiah`); Put to the Test (ID: `keyterm:PutToTheTest`); ٱلشَّيْطَان (ID: `deity:Satan`); بطْرس (ID: `person:Peter`); نَاصِرَة (ID: `place:Nazareth`); أورشَلِيمَ (ID: `place:Jerusalem`); Serve (ID: `keyterm:Serve`); Kingdom (ID: `keyterm:Kingdom`); Beloved (ID: `keyterm:Beloved`); أَنْدَرَاوسَ (ID: `person:Andrew`); Strap (ID: `realia:Strap`); Bag (ID: `realia:Bag`); Belt (ID: `realia:Belt`); Dove (ID: `fauna:Dove`); Bee (ID: `fauna:Bee`); Camel (ID: `fauna:Camel`); Locust (ID: `fauna:Locust`); Sandal (ID: `realia:Sandal`); Leather (ID: `realia:Leather`)
...
* **Associated ACAI Concepts:** To Cleanse (ID: `keyterm:Cleanse.2`); Synagogue (ID: `realia:Synagogue`); بطْرس (ID: `person:Peter`); Proclaim (ID: `keyterm:Proclaim`); ٱلْجَلِيلِ (ID: `place:Galilee`); Ability (ID: `keyterm:Ability`); Demons (ID: `deity:Demons`); Authority (ID: `keyterm:Authority.2`); Serve (ID: `keyterm:Serve`); يَسوع (ID: `person:Jesus.2`); كَفْرَنَاحومَ (ID: `place:Capernaum`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); يوحَنَّا (ID: `person:John.2`); To Command (ID: `keyterm:Command`); Bear Witness (ID: `keyterm:BearWitness`); Sabbath (ID: `keyterm:Sabbath`); يَعْقوبَ (ID: `person:James`); ٱلرَّبِّ (ID: `deity:Lord`); موسَى (ID: `person:Moses`); نَاصِرَة (ID: `place:Nazareth`); Ask for (ID: `keyterm:AskFor`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Pray (ID: `keyterm:Pray`); Holy (ID: `keyterm:Holy`); Offering (ID: `keyterm:Offering`); أَنْدَرَاوسَ (ID: `person:Andrew`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Sabbath (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); Pharisees (ID: `group:Pharisee`); Herodians (ID: `group:Herodian`); أَبِيَاثَار (ID: `person:Abiathar`); Serve (ID: `keyterm:Serve`); دَاودَ (ID: `person:David`); Be a Disciple (ID: `keyterm:Disciple`); Salvation (ID: `keyterm:Salvation`); Life (ID: `keyterm:Life`); Heart (ID: `keyterm:Heart`); ٱلرَّبِّ (ID: `deity:Lord`); Wheat (ID: `flora:Wheat`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`); House (ID: `realia:House`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); Name (ID: `keyterm:Name`); بَرْثولَمَاوس (ID: `person:Bartholomew`); يوحَنَّا (ID: `person:John.2`); حَلْفَى (ID: `person:Alphaeus`); يَعْقوبَ (ID: `person:James.2`); يَعْقوبَ (ID: `person:James`); ٱلْغَيورَ (ID: `group:Zealot`); أَدومِيَّةَ (ID: `place:Idumea`); مَتَّى (ID: `person:Matthew`); يَهوذَا (ID: `place:Judea`); To Command (ID: `keyterm:Command`); ٱلْجَلِيلِ (ID: `place:Galilee`); تومَا (ID: `person:Thomas`); صورَ (ID: `place:Tyre`); بْنَ (ID: `person:Zebedee`); Ability (ID: `keyterm:Ability`); يَهوذَا (ID: `person:Judas.2`); ٱلْأرْدنِّ (ID: `place:Jordan`); يَهوذَا (ID: `person:Judas`); بطْرس (ID: `person:Peter`); أورشَلِيمَ (ID: `place:Jerusalem`); صِيْدونَ (ID: `place:Sidon`); Demons (ID: `deity:Demons`); Authority (ID: `keyterm:Authority.2`); سِمْعَان (ID: `person:Simon.2`); Serve (ID: `keyterm:Serve`); يَسوع (ID: `person:Jesus.2`); فِيلبّسَ (ID: `person:Philip`); Proclaim (ID: `keyterm:Proclaim`); أَنْدَرَاوسَ (ID: `person:Andrew`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** ٱلشَّيْطَان (ID: `deity:Satan`); Blaspheme (ID: `keyterm:Blaspheme`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); House (ID: `realia:House`); أورشَلِيمَ (ID: `place:Jerusalem`); Surely! (ID: `keyterm:Surely`); Always (ID: `keyterm:Always`); Demons (ID: `deity:Demons`); Kingdom (ID: `keyterm:Kingdom`); Parable (ID: `keyterm:Parable`); ٱلرَّبِّ (ID: `deity:Lord`); Religious Officials (ID: `group:ReligiousOfficials`); ٱلرّوحِ (ID: `deity:HolySpirit`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Ask for (ID: `keyterm:AskFor`); يَسوع (ID: `person:Jesus.2`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); Ship (ID: `realia:Ship`); Grave (ID: `realia:Grave`); ٱلرَّبِّ (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Chain (ID: `realia:Chain`); To Command (ID: `keyterm:Command`); ٱلْمدنِ (ID: `place:Decapolis`); لَجِئون (ID: `deity:Legion`); Gerasa (ID: `place:Gerasa`); Bow Down (ID: `keyterm:BowDown`); Believe (ID: `keyterm:Believe`); Become Still (ID: `keyterm:BecomeStill`); Mercy (ID: `keyterm:Mercy`); Authority (ID: `keyterm:Authority.2`); Name (ID: `keyterm:Name`); Proclaim (ID: `keyterm:Proclaim`); Cushion (ID: `realia:Cushion`); Fetter (ID: `realia:Fetter`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Salvation (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`); Believe (ID: `keyterm:Believe`); Fear (ID: `keyterm:Fear`); يَايِرس (ID: `person:Jairus`); يوحَنَّا (ID: `person:John.2`); Ability (ID: `keyterm:Ability`); Truth (ID: `keyterm:Truth`); A Group of Disciples (ID: `group:GenericDisciples`); يَعْقوبَ (ID: `person:James`); Body (ID: `keyterm:Body.3`); بطْرس (ID: `person:Peter`); Ask for (ID: `keyterm:AskFor`); Life (ID: `keyterm:Life`); Be a Disciple (ID: `keyterm:Disciple`); Make Peace (ID: `keyterm:Peace`); Name (ID: `keyterm:Name`); Blood (ID: `keyterm:Blood`); House (ID: `realia:House`); Ship (ID: `realia:Ship`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Serve (ID: `keyterm:Serve`); سِمْعَان (ID: `person:Simon.3`); يوسف (ID: `person:Joseph.3`); Disbelieve (ID: `keyterm:Disbelieve`); يَهوذَا (ID: `person:Jude`); Bear Witness (ID: `keyterm:BearWitness`); Sabbath (ID: `keyterm:Sabbath`); يَعْقوبَ (ID: `person:James.3`); مَرْيَم (ID: `person:Mary`); Anointed (ID: `keyterm:Anointed`); Repent (ID: `keyterm:Repent`); Demons (ID: `deity:Demons`); Authority (ID: `keyterm:Authority.2`); يَسوع (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Proclaim (ID: `keyterm:Proclaim`); Bag (ID: `realia:Bag`); Staff (ID: `realia:Staff`); Olive Oil (ID: `realia:OliveOil`); House (ID: `realia:House`); Belt (ID: `realia:Belt`); Tunic (ID: `realia:Tunic.2`); Sandal (ID: `realia:Sandal`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Fish (ID: `fauna:Fish`); Be a Disciple (ID: `keyterm:Disciple`); Affection (ID: `keyterm:Affection`); يَسوع (ID: `person:Jesus.2`); A Group of Disciples (ID: `group:GenericDisciples`); Bless (ID: `keyterm:Bless`); Sky (ID: `keyterm:Heaven`); Basket (ID: `realia:Basket`); Ship (ID: `realia:Ship`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`); Sheep (ID: `fauna:Lamb`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); صَيْدَا (ID: `place:Bethsaida`); جَنِّيسَارَتَ (ID: `place:Gennesaret`); Be a Disciple (ID: `keyterm:Disciple`); Salvation (ID: `keyterm:Salvation`); Ask for (ID: `keyterm:AskFor`); Cheer Up (ID: `keyterm:CheerUp`); Heart (ID: `keyterm:Heart`); Fear (ID: `keyterm:Fear`); Pray (ID: `keyterm:Pray`); Bed (ID: `realia:Bed`); Cloak (ID: `realia:Cloak`); Tassel (ID: `realia:Tassel`)
...
* **Associated ACAI Concepts:** Defilement (ID: `keyterm:Defilement`); Teaching (ID: `keyterm:Teaching`); Pharisees (ID: `group:Pharisee`); Heart (ID: `keyterm:Heart`); ٱلرَّبِّ (ID: `deity:Lord`); Be a Disciple (ID: `keyterm:Disciple`); Commandment (ID: `keyterm:Commandment`); هَدِيَّةٌ (ID: `place:Corban`); Baptism (ID: `keyterm:Baptism`); Worship (ID: `keyterm:Worship`); Live (ID: `keyterm:Live.3`); إِشَعْيَاء (ID: `person:Isaiah`); موسَى (ID: `person:Moses`); أورشَلِيمَ (ID: `place:Jerusalem`); Parable (ID: `keyterm:Parable`); Religious Officials (ID: `group:ReligiousOfficials`); To Cleanse (ID: `keyterm:Cleanse.2`); Offering (ID: `keyterm:Offering`); Fornication (ID: `keyterm:Fornication`); Speak as a Prophet (ID: `keyterm:Speak`); Jews (ID: `group:Jews`); Blaspheme (ID: `keyterm:Blaspheme`); Bed (ID: `realia:Bed`); House (ID: `realia:House`); Cooking Pot (ID: `realia:CookingPot`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); صورَ (ID: `place:Tyre`); Ask for (ID: `keyterm:AskFor`); Dog (ID: `fauna:Dog`); House (ID: `realia:House`); صِيْدونَ (ID: `place:Sidon`); ٱلْمدنِ (ID: `place:Decapolis`); Greeks (ID: `group:Greek`); فِينِيقِيَّةً (ID: `place:Phoenicia`); Syrophoenicians (ID: `group:Phoenicia`); يَاان (ID: `person:Javan`); Honest (ID: `keyterm:Honest`); Proclaim (ID: `keyterm:Proclaim`); Sea of Galilee (ID: `place:GalileeSea`); Sky (ID: `keyterm:Heaven`); Bed (ID: `realia:Bed`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); Basket (ID: `realia:Basket`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisees (ID: `group:Pharisee`); Symbol (ID: `keyterm:Example`); Ship (ID: `realia:Ship`); مَجْدَلَ (ID: `place:Magadan`); Spirit (ID: `keyterm:Spirit.2`); Ask for (ID: `keyterm:AskFor`); Surely! (ID: `keyterm:Surely`); Bless (ID: `keyterm:Bless`); هِيرودسَ (ID: `person:Herod.2`); Heart (ID: `keyterm:Heart`); Affection (ID: `keyterm:Affection`); Sky (ID: `keyterm:Heaven`); Fish (ID: `fauna:Fish`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); صَيْدَا (ID: `place:Bethsaida`); Baptist (ID: `keyterm:Baptist`); قَيْصَرِيَّةِ (ID: `place:CaesareaPhilippi`); Be a Disciple (ID: `keyterm:Disciple`); بطْرس (ID: `person:Peter`); Ask for (ID: `keyterm:AskFor`); To Command (ID: `keyterm:Command`); إِيلِيَّا (ID: `person:Elijah`); يوحَنَّا (ID: `person:John`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Life (ID: `keyterm:Life`); ٱلرَّبِّ (ID: `deity:Lord`); بطْرس (ID: `person:Peter`); Be a Disciple (ID: `keyterm:Disciple`); To Command (ID: `keyterm:Command`); Ability (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); Holy (ID: `keyterm:Holy`); Surely! (ID: `keyterm:Surely`); Salvation (ID: `keyterm:Salvation`); Think (ID: `keyterm:Think`); Glory (ID: `keyterm:Glory`); Good News (ID: `keyterm:GoodNews`); Kingdom (ID: `keyterm:Kingdom`); Be Unfaithful (ID: `keyterm:Unfaithful`); Reject (ID: `keyterm:Reject`); ٱلشَّيْطَان (ID: `deity:Satan`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** إِيلِيَّا (ID: `person:Elijah`); يَسوع (ID: `person:Jesus.2`); بطْرس (ID: `person:Peter`); موسَى (ID: `person:Moses`); يوحَنَّا (ID: `person:John.2`); يَعْقوبَ (ID: `person:James`); Beloved (ID: `keyterm:Beloved`); Tent (ID: `realia:Tent`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); A Father (ID: `person:GenericFather`); Believe (ID: `keyterm:Believe`); Pray (ID: `keyterm:Pray`); Disbelieve (ID: `keyterm:Disbelieve`); A Group of Disciples (ID: `group:GenericDisciples`); To Command (ID: `keyterm:Command`); A Group of People (ID: `group:GenericGroup`); Be Unfaithful (ID: `keyterm:Unfaithful`); Affection (ID: `keyterm:Affection`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); كَفْرَنَاحومَ (ID: `place:Capernaum`); Name (ID: `keyterm:Name`); ٱلْجَلِيلِ (ID: `place:Galilee`); Word (ID: `keyterm:Word`); Fear (ID: `keyterm:Fear`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Cause to Stumble (ID: `keyterm:CauseToStumble`); Name (ID: `keyterm:Name`); Gehenna (ID: `keyterm:Gehenna`); Hell (ID: `place:Hell`); يَسوع (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); يوحَنَّا (ID: `person:John.2`); Surely! (ID: `keyterm:Surely`); Demons (ID: `deity:Demons`); Kingdom (ID: `keyterm:Kingdom`); Be at Peace (ID: `keyterm:AtPeace`); ٱلرَّبِّ (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); Worm (ID: `fauna:Maggot`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); يَسوع (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); To Command (ID: `keyterm:Command`); Kingdom (ID: `keyterm:Kingdom`); Fornication (ID: `keyterm:Fornication`); موسَى (ID: `person:Moses`); يَهوذَا (ID: `place:Judea`); Commandment (ID: `keyterm:Commandment`); Hardheartedness (ID: `keyterm:Hardheartedness`); Surely! (ID: `keyterm:Surely`); Bless (ID: `keyterm:Bless`); Body (ID: `keyterm:Body.3`); ٱلْأرْدنِّ (ID: `place:Jordan`); Be Lawful (ID: `keyterm:Lawful`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); ٱلرَّبِّ (ID: `deity:Lord`); Kingdom (ID: `keyterm:Kingdom`); Rich Young Ruler (ID: `person:RichYoungRuler`); Good (ID: `keyterm:Good`); Life (ID: `keyterm:Life`); Be a Disciple (ID: `keyterm:Disciple`); Always (ID: `keyterm:Always`); House (ID: `realia:House`); Commandment (ID: `keyterm:Commandment`); Salvation (ID: `keyterm:Salvation`); Surely! (ID: `keyterm:Surely`); Good News (ID: `keyterm:GoodNews`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Love (ID: `keyterm:Love`); بطْرس (ID: `person:Peter`); Fornication (ID: `keyterm:Fornication`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); يَعْقوبَ (ID: `person:James`); يوحَنَّا (ID: `person:John.2`); أورشَلِيمَ (ID: `place:Jerusalem`); Baptism (ID: `keyterm:Baptism`); Gentiles (ID: `group:Gentile`); Serve (ID: `keyterm:Serve`); Life (ID: `keyterm:Life`); Glory (ID: `keyterm:Glory`); Condemn (ID: `keyterm:Condemn`); Authority (ID: `keyterm:Authority.2`); Fear (ID: `keyterm:Fear`); بْنَ (ID: `person:Zebedee`); Ransom (ID: `keyterm:Ransom`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); دَاودَ (ID: `person:David`); Mercy (ID: `keyterm:Mercy`); A Group of People (ID: `group:GenericGroup`); كَانَ (ID: `person:Bartimaeus`); تِيمَاوسَ (ID: `person:Timaeus`); Be a Disciple (ID: `keyterm:Disciple`); Salvation (ID: `keyterm:Salvation`); To Command (ID: `keyterm:Command`); Cheer Up (ID: `keyterm:CheerUp`); أَرِيحَا (ID: `place:Jericho`); Believe (ID: `keyterm:Believe`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Donkey (ID: `fauna:Donkey`); يَسوع (ID: `person:Jesus.2`); أورشَلِيمَ (ID: `place:Jerusalem`); Hosanna (ID: `keyterm:Hosanna`); عَنْيَا (ID: `place:Bethany`); Bless (ID: `keyterm:Bless`); A Group of People (ID: `group:GenericGroup`); Cloak (ID: `realia:Cloak`); بَيْتِ (ID: `place:Bethphage`); دَاودَ (ID: `person:David`); Be a Disciple (ID: `keyterm:Disciple`); Height (ID: `keyterm:Height`); Name (ID: `keyterm:Name`); Kingdom (ID: `keyterm:Kingdom`); ٱلرَّبِّ (ID: `deity:Lord`); Rush (ID: `flora:Rush`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Pray (ID: `keyterm:Pray`); Temple (ID: `realia:Temple`); Fig (ID: `flora:Fig`); ٱلرَّبِّ (ID: `deity:Lord`); Surely! (ID: `keyterm:Surely`); Forgive (ID: `keyterm:Forgive`); Discern (ID: `keyterm:Discern`); Sky (ID: `keyterm:Heaven`); Heart (ID: `keyterm:Heart`); بطْرس (ID: `person:Peter`); أورشَلِيمَ (ID: `place:Jerusalem`); Fear (ID: `keyterm:Fear`); عَنْيَا (ID: `place:Bethany`); يَسوع (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Always (ID: `keyterm:Always`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Ability (ID: `keyterm:Ability`); Authority (ID: `keyterm:Authority.2`); Sky (ID: `keyterm:Heaven`); يوحَنَّا (ID: `person:John`); Parable (ID: `keyterm:Parable`); Fear (ID: `keyterm:Fear`); يَسوع (ID: `person:Jesus.2`); Reject (ID: `keyterm:Reject`); Written (ID: `keyterm:Scripture`); Baptism (ID: `keyterm:Baptism`); Believe (ID: `keyterm:Believe`); ٱلرَّبِّ (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); أورشَلِيمَ (ID: `place:Jerusalem`); Empty (ID: `keyterm:Empty`); Priests (ID: `group:GenericPriests`); Religious Officials (ID: `group:ReligiousOfficials`); Beloved (ID: `keyterm:Beloved`); Watch-Tower (ID: `realia:Watch-tower`); Thorn Hedge (ID: `realia:ThornHedge`); Cornerstone (ID: `realia:Cornerstone`); Tower (ID: `realia:Tower`); Temple (ID: `realia:Temple`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); طِيبَارِيوسَ (ID: `person:Tiberius`); Resurrection (ID: `keyterm:Resurrection`); موسَى (ID: `person:Moses`); يَسوع (ID: `person:Jesus.2`); Herodians (ID: `group:Herodian`); Written (ID: `keyterm:Scripture`); Poll Tax (ID: `keyterm:PollTax`); إِبْرَاهِيمَ (ID: `person:Abraham`); Sadducees (ID: `group:Sadducee`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Truth (ID: `keyterm:Truth`); The Way (ID: `keyterm:TheWay`); Life (ID: `keyterm:Life`); True (ID: `keyterm:True`); إِسْحَاق (ID: `person:Isaac`); Hypocrisy (ID: `keyterm:Hypocrisy`); Be Lawful (ID: `keyterm:Lawful`); An Angel (ID: `deity:Angel`); Pharisees (ID: `group:Pharisee`); إِسْرَائِيلَ (ID: `person:Israel`); Denarius (ID: `realia:Denarius`); Brier (ID: `flora:Brier`); Boxthorn (ID: `flora:Boxthorn`)
...
* **Associated ACAI Concepts:** ٱلرَّبِّ (ID: `deity:Lord`); Love (ID: `keyterm:Love`); يَسوع (ID: `person:Jesus.2`); دَاودَ (ID: `person:David`); Commandment (ID: `keyterm:Commandment`); A Priest (ID: `person:GenericPriest`); A Scribe (ID: `person:Scribe`); Heart (ID: `keyterm:Heart`); Treasury (ID: `realia:Treasury`); Surely! (ID: `keyterm:Surely`); Daily Life (ID: `keyterm:DailyLife`); Mind (ID: `keyterm:Mind.2`); Truth (ID: `keyterm:Truth`); Judgment (ID: `keyterm:Judgment`); Pray (ID: `keyterm:Pray`); ٱلرّوحِ (ID: `deity:HolySpirit`); Be a Disciple (ID: `keyterm:Disciple`); Kingdom (ID: `keyterm:Kingdom`); Offering (ID: `keyterm:Offering`); إِسْرَائِيلَ (ID: `person:Israel`); Quadrans (ID: `realia:Quadrans`); Lepton (ID: `realia:Lepton`); Cloak (ID: `realia:Cloak`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); Temple (ID: `realia:Temple`); Be a Disciple (ID: `keyterm:Disciple`); بطْرس (ID: `person:Peter`); يوحَنَّا (ID: `person:John.2`); Salvation (ID: `keyterm:Salvation`); A Group of Disciples (ID: `group:GenericDisciples`); يَعْقوبَ (ID: `person:James`); Bear Witness (ID: `keyterm:BearWitness`); Kingdom (ID: `keyterm:Kingdom`); Good News (ID: `keyterm:GoodNews`); Symbol (ID: `keyterm:Example`); Proclaim (ID: `keyterm:Proclaim`); أَنْدَرَاوسَ (ID: `person:Andrew`); ٱلرّوحِ (ID: `deity:HolySpirit`); Synagogue (ID: `realia:Synagogue`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Sky (ID: `keyterm:Heaven`); ٱلرَّبِّ (ID: `deity:Lord`); Chosen (ID: `keyterm:Chosen`); House (ID: `realia:House`); Ability (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); Surely! (ID: `keyterm:Surely`); Salvation (ID: `keyterm:Salvation`); يَهوذَا (ID: `place:Judea`); To Command (ID: `keyterm:Command`); Glory (ID: `keyterm:Glory`); Portent (ID: `keyterm:Portent`); Believe (ID: `keyterm:Believe`); Abomination of Desolation (ID: `keyterm:AbominationOfDesolation`); Body (ID: `keyterm:Body.3`); Disaster (ID: `keyterm:Disaster`); Parable (ID: `keyterm:Parable`); Authority (ID: `keyterm:Authority.2`); Pray (ID: `keyterm:Pray`); يَسوع (ID: `person:Jesus.2`); Symbol (ID: `keyterm:Example`); Cloak (ID: `realia:Cloak`); Fig (ID: `flora:Fig`); Door (ID: `realia:Door`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `flora:Myrrh`); Myrrh (ID: `realia:Myrrh`); سِمْعَان (ID: `person:Simon.4`); عَنْيَا (ID: `place:Bethany`); Surely! (ID: `keyterm:Surely`); Good News (ID: `keyterm:GoodNews`); Passover (ID: `keyterm:Passover`); Ability (ID: `keyterm:Ability`); يَهوذَا (ID: `person:Judas.2`); A Group of Disciples (ID: `group:GenericDisciples`); Body (ID: `keyterm:Body.3`); Promise (ID: `keyterm:Promise`); Pure (ID: `keyterm:Pure`); يَسوع (ID: `person:Jesus.2`); Proclaim (ID: `keyterm:Proclaim`); Alabaster Jar (ID: `realia:AlabasterJar`); Oil of Nard (ID: `realia:OilOfNard`); Nard (ID: `flora:Nard`); House (ID: `realia:House`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); Surely! (ID: `keyterm:Surely`); Passover (ID: `keyterm:Passover`); يَسوع (ID: `person:Jesus.2`); Sheep (ID: `fauna:Lamb`); Blood (ID: `keyterm:Blood`); ٱلْجَلِيلِ (ID: `place:Galilee`); Bless (ID: `keyterm:Bless`); Body (ID: `keyterm:Body.3`); ٱلرَّبِّ (ID: `deity:Lord`); بطْرس (ID: `person:Peter`); Disaster (ID: `keyterm:Disaster`); Covenant (ID: `keyterm:Covenant`); Resurrection (ID: `keyterm:Resurrection`); Kingdom (ID: `keyterm:Kingdom`); Offering (ID: `keyterm:Offering`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); Rooster (ID: `fauna:Rooster`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Bowl (ID: `realia:Bowl.2`); Clay Jar (ID: `realia:ClayJar`); Flock (ID: `fauna:Flock`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); بطْرس (ID: `person:Peter`); Linen (ID: `realia:Linen`); جَثْسَيْمَانِي (ID: `place:Gethsemane`); يَسوع (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Spirit (ID: `keyterm:Spirit.2`); Written (ID: `keyterm:Scripture`); يوحَنَّا (ID: `person:John.2`); Name (ID: `keyterm:Name`); يَعْقوبَ (ID: `person:James`); Body (ID: `keyterm:Body.3`); Put to the Test (ID: `keyterm:PutToTheTest`); ٱلرَّبِّ (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); يَهوذَا (ID: `person:Judas.2`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** يَسوع (ID: `person:Jesus.2`); Bear Witness (ID: `keyterm:BearWitness`); بطْرس (ID: `person:Peter`); Witness (ID: `keyterm:Witness`); Sky (ID: `keyterm:Heaven`); Condemn (ID: `keyterm:Condemn`); Speak as a Prophet (ID: `keyterm:Speak`); Ability (ID: `keyterm:Ability`); Blaspheme (ID: `keyterm:Blaspheme`); Temple (ID: `realia:Temple`); Clothing (ID: `realia:Clothing`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** بطْرس (ID: `person:Peter`); يَسوع (ID: `person:Jesus.2`); Rooster (ID: `fauna:Rooster`); نَاصِرَة (ID: `place:Nazareth`); Galileans (ID: `group:Galilee`); True (ID: `keyterm:True`); ٱلْجَلِيلِ (ID: `place:Galilee`); Word (ID: `keyterm:Word`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); يَسوع (ID: `person:Jesus.2`); Salvation (ID: `keyterm:Salvation`); إِيلِيَّا (ID: `person:Elijah`); Jews (ID: `group:Jews`); Purple Cloth (ID: `realia:PurpleCloth`); Reed (ID: `flora:Reed`); Clothing (ID: `realia:Clothing`); Temple (ID: `realia:Temple`); سِمْعَان (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); ٱلْإِسْكَنْدَرِ (ID: `person:Alexander`); قَيْرَوَانِيًّا (ID: `place:Cyrene`); روفسَ (ID: `person:Rufus`); Centurion at Crucifixion (ID: `person:Centurion.3`); Bow Down (ID: `keyterm:BowDown`); Believe (ID: `keyterm:Believe`); A Group of People (ID: `group:GenericGroup`); ٱلرَّبِّ (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); True (ID: `keyterm:True`); Priests (ID: `group:GenericPriests`); Religious Officials (ID: `group:ReligiousOfficials`); إِسْرَائِيلَ (ID: `person:Israel`); Blaspheme (ID: `keyterm:Blaspheme`); Myrrh (ID: `flora:Myrrh`); Palace (ID: `realia:Palace`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Sour Wine (ID: `realia:SourWine`); Boxthorn (ID: `flora:Boxthorn`); Lot (ID: `realia:Lot`); Curtain (ID: `realia:Curtain`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** يوسف (ID: `person:Joseph.6`); مَرْيَم (ID: `person:Mary.2`); بِيلَاطسَ (ID: `person:Pilate`); مَرْيَم (ID: `person:Marymagdalene`); يَعْقوبَ (ID: `person:James.4`); يوسف (ID: `person:Joseph.3`); يوسف (ID: `person:Joseph.5`); ٱلرَّامَةِ (ID: `place:Arimathea`); سَالومَة (ID: `person:Salome`); ٱلْجَلِيلِ (ID: `place:Galilee`); Day Before the Sabbath (ID: `keyterm:DayBeforeTheSabbath`); Body (ID: `keyterm:Body.3`); ٱلرَّبِّ (ID: `deity:Lord`); أورشَلِيمَ (ID: `place:Jerusalem`); Serve (ID: `keyterm:Serve`); يَسوع (ID: `person:Jesus.2`); Kingdom (ID: `keyterm:Kingdom`); Grave (ID: `realia:Grave`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Angels (ID: `group:Angels`); سَالومَة (ID: `person:Salome`); مَرْيَم (ID: `person:Mary.2`); Salvation (ID: `keyterm:Salvation`); Surely! (ID: `keyterm:Surely`); To Command (ID: `keyterm:Command`); ٱلْجَلِيلِ (ID: `place:Galilee`); مَرْيَم (ID: `person:Marymagdalene`); Sabbath (ID: `keyterm:Sabbath`); Week (ID: `keyterm:Week`); يَعْقوبَ (ID: `person:James.3`); Anointed (ID: `keyterm:Anointed`); بطْرس (ID: `person:Peter`); نَاصِرَة (ID: `place:Nazareth`); Imperishable (ID: `keyterm:Imperishable`); Fear (ID: `keyterm:Fear`); يَسوع (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Resurrection (ID: `keyterm:Resurrection`); Cloak (ID: `realia:Cloak`); Aloes (ID: `realia:Aloes`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Disbelieve (ID: `keyterm:Disbelieve`); Demons (ID: `deity:Demons`); يَسوع (ID: `person:Jesus.2`); Symbol (ID: `keyterm:Example`); Proclaim (ID: `keyterm:Proclaim`); Salvation (ID: `keyterm:Salvation`); Good News (ID: `keyterm:GoodNews`); Baptism (ID: `keyterm:Baptism`); مَرْيَم (ID: `person:Marymagdalene`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Week (ID: `keyterm:Week`); Condemn (ID: `keyterm:Condemn`); ٱلرَّبِّ (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Hardheartedness (ID: `keyterm:Hardheartedness`); Resurrection (ID: `keyterm:Resurrection`); Name (ID: `keyterm:Name`); Snake (ID: `fauna:Snake`)
