...
* **Associated ACAI Concepts:** Kapadokia (ID: `place:Cappadocia`); Bitinia (ID: `place:Bithynia`); Pontus (ID: `place:Pontus`); Galatia (ID: `place:Galatia`); abadi (ID: `keyterm:Imperishable`); dikhususkan (ID: `keyterm:Consecration.2`); harapan (ID: `keyterm:Hope`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** khusus (ID: `keyterm:Holy`); persaudaraan (ID: `keyterm:LoveForOnesFellowBeliever`); tak bernoda (ID: `keyterm:Unblemished`); penebusan (ID: `keyterm:Liberation`); berdoa (ID: `keyterm:CallUpon`)
...
* **Associated ACAI Concepts:** orang pilihan (ID: `keyterm:Chosen`); membuang (ID: `keyterm:Reject`); imamat (ID: `keyterm:Priesthood`); penyesatan (ID: `keyterm:StumblingBlock`); Yerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** lakukan baik (ID: `keyterm:DoGood`); manusia (ID: `keyterm:Carnal`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** yang baik (ID: `keyterm:Good`); Boat (ID: `realia:Boat`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Christians (ID: `group:Christ`); beroleh bagian (ID: `keyterm:Share`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Babel (ID: `place:Babylon`)
