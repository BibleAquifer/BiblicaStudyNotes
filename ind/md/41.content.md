...
* **Associated ACAI Concepts:** Yohanes (ID: `person:John`); memberitakan (ID: `keyterm:Proclaim`); injil (ID: `keyterm:GoodNews`); Zebedeus (ID: `person:Zebedee`); Galilea (ID: `place:Galilee`); Yordan (ID: `place:Jordan`); Strap (ID: `realia:Strap`); orang upahan (ID: `keyterm:HiredWorker`); Sea of Galilee (ID: `place:GalileeSea`); Yakobus (ID: `person:James`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); Galilea (ID: `place:Galilee`); Kapernaum (ID: `place:Capernaum`)
...
* **Associated ACAI Concepts:** Alfeus (ID: `person:Alphaeus.2`); Bed (ID: `realia:Bed`); Patch (ID: `realia:Patch`); Matius (ID: `person:Matthew`); Housetop (ID: `realia:Housetop`); Kapernaum (ID: `place:Capernaum`); Skin-Bottle (ID: `realia:Skin-bottle`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Be Lawful (ID: `keyterm:Lawful`); Herodians (ID: `group:Herodian`); Abyatar (ID: `person:Abiathar`); sabat (ID: `keyterm:Sabbath`)
...
* **Associated ACAI Concepts:** Idumea (ID: `place:Idumea`); Zelot (ID: `group:Zealot`); Bartolomeus (ID: `person:Bartholomew`); Alfeus (ID: `person:Alphaeus`); Yakobus (ID: `person:James.2`); Yakobus (ID: `person:James`); Yohanes (ID: `person:John.2`)
...
* **Associated ACAI Concepts:** perumpamaan (ID: `keyterm:Parable`); Mustard (ID: `flora:Mustard`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Cushion (ID: `realia:Cushion`); kerasukan setan (ID: `keyterm:DemonPossessed`); Legion (ID: `deity:Legion`); Fetter (ID: `realia:Fetter`); Chain (ID: `realia:Chain`); Dekapolis (ID: `place:Decapolis`); Gerasa (ID: `place:Gerasa`); memerintahkan (ID: `keyterm:Command`)
...
* **Associated ACAI Concepts:** Cloak (ID: `realia:Cloak`); Yairus (ID: `person:Jairus`)
...
* **Associated ACAI Concepts:** Yusuf (ID: `person:Joseph.3`); Simon (ID: `person:Simon.3`); Yudas (ID: `person:Jude`); tidak percaya (ID: `keyterm:Disbelieve`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod.2`); Herodias (ID: `person:Herodias`); Plate (ID: `realia:Plate.2`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Filipus (ID: `person:Philip.2`); Yohanes (ID: `person:John`)
...
* **Associated ACAI Concepts:** rahmat (ID: `keyterm:Affection`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Genesaret (ID: `place:Gennesaret`); Betsaida (ID: `place:Bethsaida`)
...
* **Associated ACAI Concepts:** adat istiadat (ID: `keyterm:Teaching`); Pharisees (ID: `group:Pharisee`); pemeliharaanmu (ID: `place:Corban`); pencemaran (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** Syrophoenicians (ID: `group:Phoenicia`); Tirus (ID: `place:Tyre`); Dekapolis (ID: `place:Decapolis`); Fenisia (ID: `place:Phoenicia`); Greeks (ID: `group:Greek`); Sidon (ID: `place:Sidon`)
...
* **Associated ACAI Concepts:** Kaisarea (ID: `place:CaesareaPhilippi`); Betsaida (ID: `place:Bethsaida`); pembaptis (ID: `keyterm:Baptist`)
...
* **Associated ACAI Concepts:** menyesatkan (ID: `keyterm:CauseToStumble`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Bartimeus (ID: `person:Bartimaeus`); Timeus (ID: `person:Timaeus`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** hosana (ID: `keyterm:Hosanna`); Betania (ID: `place:Bethany`); Betfage (ID: `place:Bethphage`); Rush (ID: `flora:Rush`); Yerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Herodians (ID: `group:Herodian`); Denarius (ID: `realia:Denarius`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `realia:Myrrh`); Simon (ID: `person:Simon.4`); Oil of Nard (ID: `realia:OilOfNard`); Alabaster Jar (ID: `realia:AlabasterJar`); Nard (ID: `flora:Nard`); Betania (ID: `place:Bethany`)
...
* **Associated ACAI Concepts:** Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); darah (ID: `keyterm:Blood`)
...
* **Associated ACAI Concepts:** Centurion at Crucifixion (ID: `person:Centurion.3`); Aleksander (ID: `person:Alexander`); Rufus (ID: `person:Rufus`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Simon (ID: `person:Simon.5`); Purple Cloth (ID: `realia:PurpleCloth`); Golgotha (ID: `place:Golgotha`); Palace (ID: `realia:Palace`); Kirene (ID: `place:Cyrene`); Myrrh (ID: `flora:Myrrh`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Maria (ID: `person:Mary.2`); Yusuf (ID: `person:Joseph.6`); Yusuf (ID: `person:Joseph.3`); Yusuf (ID: `person:Joseph.5`); Yakobus (ID: `person:James.4`); Salome (ID: `person:Salome`); Arimatea (ID: `place:Arimathea`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Salome (ID: `person:Salome`); Angels (ID: `group:Angels`); Maria (ID: `person:Mary.2`)
