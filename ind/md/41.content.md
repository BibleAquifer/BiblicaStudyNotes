...
* **Associated ACAI Concepts:** Yohanes (ID: `person:John`); Yesus (ID: `person:Jesus.2`); baptisan (ID: `keyterm:Baptism`); injil (ID: `keyterm:GoodNews`); memberitakan (ID: `keyterm:Proclaim`); Tuhan (ID: `deity:Lord`); Roh (ID: `deity:HolySpirit`); Yordan (ID: `place:Jordan`); Zebedeus (ID: `person:Zebedee`); Galilea (ID: `place:Galilee`); An Angel (ID: `deity:Angel`); berbuat dosa (ID: `keyterm:Sin`); bertobat (ID: `keyterm:Repent`); sorga (ID: `keyterm:Heaven`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Casting Net (ID: `realia:CastingNet`); Yakobus (ID: `person:James`); orang upahan (ID: `keyterm:HiredWorker`); Sea of Galilee (ID: `place:GalileeSea`); Yerusalem (ID: `place:Jerusalem`); kerajaan (ID: `keyterm:Kingdom`); kekasih (ID: `keyterm:Beloved`); kebenaran (ID: `keyterm:Straightness`); Petrus (ID: `person:Peter`); mencobai (ID: `keyterm:PutToTheTest`); Yesaya (ID: `person:Isaiah`); Yehuda (ID: `place:Judea`); percaya (ID: `keyterm:Believe`); Iblis (ID: `deity:Satan`); Nazaret (ID: `place:Nazareth`); Andreas (ID: `person:Andrew`); melayani (ID: `keyterm:Serve`); mengampuni (ID: `keyterm:Forgive`); Yohanes (ID: `person:John.2`); Strap (ID: `realia:Strap`); Bag (ID: `realia:Bag`); Camel (ID: `fauna:Camel`); Belt (ID: `realia:Belt`); Locust (ID: `fauna:Locust`); Bee (ID: `fauna:Bee`); Dove (ID: `fauna:Dove`); Leather (ID: `realia:Leather`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** membersihkan (ID: `keyterm:Cleanse.2`); Synagogue (ID: `realia:Synagogue`); memberitakan (ID: `keyterm:Proclaim`); Petrus (ID: `person:Peter`); Galilea (ID: `place:Galilee`); keahlian (ID: `keyterm:Ability`); Yesus (ID: `person:Jesus.2`); kekuasaan (ID: `keyterm:Authority.2`); melayani (ID: `keyterm:Serve`); Demons (ID: `deity:Demons`); Kapernaum (ID: `place:Capernaum`); kerasukan setan (ID: `keyterm:DemonPossessed`); penyakit kulit menular (ID: `keyterm:InfectiousSkinDisease`); sabat (ID: `keyterm:Sabbath`); persembahan (ID: `keyterm:Offering`); khusus (ID: `keyterm:Holy`); Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); memerintahkan (ID: `keyterm:Command`); Nazaret (ID: `place:Nazareth`); Andreas (ID: `person:Andrew`); meminta (ID: `keyterm:AskFor`); Musa (ID: `person:Moses`); Yakobus (ID: `person:James`); Yohanes (ID: `person:John.2`); bersaksi (ID: `keyterm:BearWitness`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); berbuat dosa (ID: `keyterm:Sin`); mengampuni (ID: `keyterm:Forgive`); Bed (ID: `realia:Bed`); berpuasa (ID: `keyterm:Fast`); menjadi murid (ID: `keyterm:Disciple`); House (ID: `realia:House`); pemungut cukai (ID: `keyterm:TaxCollector`); hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`); Pharisees (ID: `group:Pharisee`); Temple (ID: `realia:Temple`); Alfeus (ID: `person:Alphaeus.2`); Kapernaum (ID: `place:Capernaum`); Matius (ID: `person:Matthew`); kemuliaan (ID: `keyterm:Glory`); keahlian (ID: `keyterm:Ability`); kekuasaan (ID: `keyterm:Authority.2`); Yohanes (ID: `person:John`); percaya (ID: `keyterm:Believe`); Be Healthy (ID: `keyterm:Healthy`); rumah cukai (ID: `keyterm:TaxOffice`); roh (ID: `keyterm:Spirit.2`); Religious Officials (ID: `group:ReligiousOfficials`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Housetop (ID: `realia:Housetop`); Patch (ID: `realia:Patch`); Skin-Bottle (ID: `realia:Skin-bottle`); Clothing (ID: `realia:Clothing`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** sabat (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); Pharisees (ID: `group:Pharisee`); Abyatar (ID: `person:Abiathar`); Herodians (ID: `group:Herodian`); menjadi murid (ID: `keyterm:Disciple`); keselamatan (ID: `keyterm:Salvation`); kehidupan (ID: `keyterm:Life`); Tuhan (ID: `deity:Lord`); melayani (ID: `keyterm:Serve`); hati (ID: `keyterm:Heart`); Daud (ID: `person:David`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Synagogue (ID: `realia:Synagogue`); Grain (ID: `flora:Grain`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** nama (ID: `keyterm:Name`); menjadi murid (ID: `keyterm:Disciple`); Bartolomeus (ID: `person:Bartholomew`); Idumea (ID: `place:Idumea`); Alfeus (ID: `person:Alphaeus`); Zelot (ID: `group:Zealot`); Yakobus (ID: `person:James`); Yohanes (ID: `person:John.2`); Yakobus (ID: `person:James.2`); Yerusalem (ID: `place:Jerusalem`); keahlian (ID: `keyterm:Ability`); Zebedeus (ID: `person:Zebedee`); memberitakan (ID: `keyterm:Proclaim`); Yesus (ID: `person:Jesus.2`); Tirus (ID: `place:Tyre`); Galilea (ID: `place:Galilee`); Sidon (ID: `place:Sidon`); Yudas (ID: `person:Judas.2`); Petrus (ID: `person:Peter`); kekuasaan (ID: `keyterm:Authority.2`); Filipus (ID: `person:Philip`); Yehuda (ID: `place:Judea`); memerintahkan (ID: `keyterm:Command`); Tomas (ID: `person:Thomas`); Andreas (ID: `person:Andrew`); melayani (ID: `keyterm:Serve`); Simon (ID: `person:Simon.2`); Yudas (ID: `person:Judas`); Demons (ID: `deity:Demons`); Matius (ID: `person:Matthew`); Yordan (ID: `place:Jordan`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Iblis (ID: `deity:Satan`); menghujat (ID: `keyterm:Blaspheme`); berbuat dosa (ID: `keyterm:Sin`); mengampuni (ID: `keyterm:Forgive`); House (ID: `realia:House`); Yerusalem (ID: `place:Jerusalem`); kerajaan (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); amin! (ID: `keyterm:Surely`); Religious Officials (ID: `group:ReligiousOfficials`); selama, lamanya (ID: `keyterm:Always`); Tuhan (ID: `deity:Lord`); Roh (ID: `deity:HolySpirit`); perumpamaan (ID: `keyterm:Parable`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** perumpamaan (ID: `keyterm:Parable`); Grain (ID: `flora:Grain`); kerajaan (ID: `keyterm:Kingdom`); Tuhan (ID: `deity:Lord`); Thistle (ID: `flora:Thistle`); Boxthorn (ID: `flora:Boxthorn`); Grass (ID: `flora:Grass`); Acacia (ID: `flora:Acacia`); Brier (ID: `flora:Brier`); Barley (ID: `flora:Barley`); keahlian (ID: `keyterm:Ability`); Cause of Joy (ID: `keyterm:CauseOfJoy`); selama, lamanya (ID: `keyterm:Always`); sorga (ID: `keyterm:Heaven`); Iblis (ID: `deity:Satan`); meminta (ID: `keyterm:AskFor`); mengampuni (ID: `keyterm:Forgive`); menjadi murid (ID: `keyterm:Disciple`); Wheat (ID: `flora:Wheat`); Mustard (ID: `flora:Mustard`); Lampstand (ID: `realia:Lampstand.2`); Rooster (ID: `fauna:Rooster`); Ship (ID: `realia:Ship`); Bed (ID: `realia:Bed`); Sickle (ID: `realia:Sickle`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); meminta (ID: `keyterm:AskFor`); kerasukan setan (ID: `keyterm:DemonPossessed`); Ship (ID: `realia:Ship`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); Grave (ID: `realia:Grave`); Tuhan (ID: `deity:Lord`); takut (ID: `keyterm:Fear`); Chain (ID: `realia:Chain`); memerintahkan (ID: `keyterm:Command`); Dekapolis (ID: `place:Decapolis`); Gerasa (ID: `place:Gerasa`); Legion (ID: `deity:Legion`); memberitakan (ID: `keyterm:Proclaim`); nama (ID: `keyterm:Name`); kekuasaan (ID: `keyterm:Authority.2`); menyembah (ID: `keyterm:BowDown`); belas kasihan (ID: `keyterm:Mercy`); percaya (ID: `keyterm:Believe`); diam (ID: `keyterm:BecomeStill`); Fetter (ID: `realia:Fetter`); Cushion (ID: `realia:Cushion`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); keselamatan (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`); takut (ID: `keyterm:Fear`); percaya (ID: `keyterm:Believe`); Yairus (ID: `person:Jairus`); keahlian (ID: `keyterm:Ability`); darah (ID: `keyterm:Blood`); tubuh (ID: `keyterm:Body.3`); kehidupan (ID: `keyterm:Life`); kebenaran (ID: `keyterm:Truth`); nama (ID: `keyterm:Name`); Petrus (ID: `person:Peter`); meminta (ID: `keyterm:AskFor`); Yakobus (ID: `person:James`); menjadi murid (ID: `keyterm:Disciple`); memperdamaikan (ID: `keyterm:Peace`); A Group of Disciples (ID: `group:GenericDisciples`); Yohanes (ID: `person:John.2`); Temple (ID: `realia:Temple`); Ship (ID: `realia:Ship`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** keahlian (ID: `keyterm:Ability`); melayani (ID: `keyterm:Serve`); tidak percaya (ID: `keyterm:Disbelieve`); Yudas (ID: `person:Jude`); Simon (ID: `person:Simon.3`); Yusuf (ID: `person:Joseph.3`); memberitakan (ID: `keyterm:Proclaim`); Yakobus (ID: `person:James.3`); Yesus (ID: `person:Jesus.2`); sabat (ID: `keyterm:Sabbath`); diurapi (ID: `keyterm:Anointed`); bertobat (ID: `keyterm:Repent`); kekuasaan (ID: `keyterm:Authority.2`); Maria (ID: `person:Mary`); menjadi murid (ID: `keyterm:Disciple`); Demons (ID: `deity:Demons`); bersaksi (ID: `keyterm:BearWitness`); Bag (ID: `realia:Bag`); Synagogue (ID: `realia:Synagogue`); Belt (ID: `realia:Belt`); Tunic (ID: `realia:Tunic.2`); House (ID: `realia:House`); Staff (ID: `realia:Staff`); Sandal (ID: `realia:Sandal`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod.2`); Yohanes (ID: `person:John`); Herodias (ID: `person:Herodias`); baptisan (ID: `keyterm:Baptism`); kebangkitan (ID: `keyterm:Resurrection`); Plate (ID: `realia:Plate.2`); Prison (ID: `realia:Prison`); Filipus (ID: `person:Philip.2`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); keahlian (ID: `keyterm:Ability`); Elia (ID: `person:Elijah`); cepat, cepat (ID: `keyterm:Haste`); Be Lawful (ID: `keyterm:Lawful`); Galilea (ID: `place:Galilee`); kerajaan (ID: `keyterm:Kingdom`); nama (ID: `keyterm:Name`); khusus (ID: `keyterm:Holy`); sumpah (ID: `keyterm:Oath`); takut (ID: `keyterm:Fear`); A Group of People (ID: `group:GenericGroup`); pembaptis (ID: `keyterm:Baptist`); menjadi murid (ID: `keyterm:Disciple`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Fish (ID: `fauna:Fish`); menjadi murid (ID: `keyterm:Disciple`); rahmat (ID: `keyterm:Affection`); sorga (ID: `keyterm:Heaven`); memberkati (ID: `keyterm:Bless`); A Group of Disciples (ID: `group:GenericDisciples`); Yesus (ID: `person:Jesus.2`); Basket (ID: `realia:Basket`); Grass (ID: `flora:Grass`); Denarius (ID: `realia:Denarius`); Ship (ID: `realia:Ship`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); Genesaret (ID: `place:Gennesaret`); Betsaida (ID: `place:Bethsaida`); menjadi murid (ID: `keyterm:Disciple`); takut (ID: `keyterm:Fear`); meminta (ID: `keyterm:AskFor`); hati (ID: `keyterm:Heart`); percayalah (ID: `keyterm:CheerUp`); keselamatan (ID: `keyterm:Salvation`); berdoa (ID: `keyterm:Pray`); Bed (ID: `realia:Bed`); Tassel (ID: `realia:Tassel`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** pencemaran (ID: `keyterm:Defilement`); adat istiadat (ID: `keyterm:Teaching`); Pharisees (ID: `group:Pharisee`); hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`); menjadi murid (ID: `keyterm:Disciple`); perintah (ID: `keyterm:Commandment`); pemeliharaanmu (ID: `place:Corban`); Yerusalem (ID: `place:Jerusalem`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); persundalan (ID: `keyterm:Fornication`); hidup (ID: `keyterm:Live.3`); persembahan (ID: `keyterm:Offering`); perumpamaan (ID: `keyterm:Parable`); Yesaya (ID: `person:Isaiah`); membersihkan (ID: `keyterm:Cleanse.2`); menghujat (ID: `keyterm:Blaspheme`); baptisan (ID: `keyterm:Baptism`); Jews (ID: `group:Jews`); Musa (ID: `person:Moses`); Religious Officials (ID: `group:ReligiousOfficials`); sembah (ID: `keyterm:Worship`); Cooking Pot (ID: `realia:CookingPot`); House (ID: `realia:House`); Bed (ID: `realia:Bed`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); Tirus (ID: `place:Tyre`); meminta (ID: `keyterm:AskFor`); House (ID: `realia:House`); Dog (ID: `fauna:Dog`); Fenisia (ID: `place:Phoenicia`); Sidon (ID: `place:Sidon`); Dekapolis (ID: `place:Decapolis`); Syrophoenicians (ID: `group:Phoenicia`); Greeks (ID: `group:Greek`); sorga (ID: `keyterm:Heaven`); memberitakan (ID: `keyterm:Proclaim`); Yunani (ID: `person:Javan`); baik (ID: `keyterm:Honest`); Sea of Galilee (ID: `place:GalileeSea`); Temple (ID: `realia:Temple`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** menjadi murid (ID: `keyterm:Disciple`); Basket (ID: `realia:Basket`); tanda (ID: `keyterm:Example`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisees (ID: `group:Pharisee`); Ship (ID: `realia:Ship`); sorga (ID: `keyterm:Heaven`); Herodes (ID: `person:Herod.2`); memberkati (ID: `keyterm:Bless`); roh (ID: `keyterm:Spirit.2`); amin! (ID: `keyterm:Surely`); meminta (ID: `keyterm:AskFor`); hati (ID: `keyterm:Heart`); Magadan (ID: `place:Magadan`); rahmat (ID: `keyterm:Affection`); House (ID: `realia:House`); Fish (ID: `fauna:Fish`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Kaisarea (ID: `place:CaesareaPhilippi`); pembaptis (ID: `keyterm:Baptist`); Betsaida (ID: `place:Bethsaida`); menjadi murid (ID: `keyterm:Disciple`); memerintahkan (ID: `keyterm:Command`); Elia (ID: `person:Elijah`); Petrus (ID: `person:Peter`); meminta (ID: `keyterm:AskFor`); Yohanes (ID: `person:John`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** kehidupan (ID: `keyterm:Life`); Tuhan (ID: `deity:Lord`); keahlian (ID: `keyterm:Ability`); memerintahkan (ID: `keyterm:Command`); Petrus (ID: `person:Peter`); menjadi murid (ID: `keyterm:Disciple`); kerajaan (ID: `keyterm:Kingdom`); membuang (ID: `keyterm:Reject`); kemuliaan (ID: `keyterm:Glory`); tidak setia (ID: `keyterm:Unfaithful`); khusus (ID: `keyterm:Holy`); An Angel (ID: `deity:Angel`); injil (ID: `keyterm:GoodNews`); amin! (ID: `keyterm:Surely`); Iblis (ID: `deity:Satan`); memikirkan (ID: `keyterm:Think`); keselamatan (ID: `keyterm:Salvation`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Elia (ID: `person:Elijah`); Yesus (ID: `person:Jesus.2`); Petrus (ID: `person:Peter`); Musa (ID: `person:Moses`); kekasih (ID: `keyterm:Beloved`); Yohanes (ID: `person:John.2`); Yakobus (ID: `person:James`); Clothing (ID: `realia:Clothing`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** menjadi murid (ID: `keyterm:Disciple`); A Father (ID: `person:GenericFather`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); tidak setia (ID: `keyterm:Unfaithful`); memerintahkan (ID: `keyterm:Command`); tidak percaya (ID: `keyterm:Disbelieve`); A Group of Disciples (ID: `group:GenericDisciples`); A Group of People (ID: `group:GenericGroup`); rahmat (ID: `keyterm:Affection`); berdoa (ID: `keyterm:Pray`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** menjadi murid (ID: `keyterm:Disciple`); nama (ID: `keyterm:Name`); firman (ID: `keyterm:Word`); takut (ID: `keyterm:Fear`); Kapernaum (ID: `place:Capernaum`); Galilea (ID: `place:Galilee`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** menyesatkan (ID: `keyterm:CauseToStumble`); Hell (ID: `place:Hell`); nama (ID: `keyterm:Name`); neraka (ID: `keyterm:Gehenna`); Yesus (ID: `person:Jesus.2`); kehidupan (ID: `keyterm:Life`); kerajaan (ID: `keyterm:Kingdom`); keahlian (ID: `keyterm:Ability`); Demons (ID: `deity:Demons`); amin! (ID: `keyterm:Surely`); percaya (ID: `keyterm:Believe`); Yohanes (ID: `person:John.2`); Tuhan (ID: `deity:Lord`); hidup berdamai (ID: `keyterm:AtPeace`); Worm (ID: `fauna:Maggot`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kerajaan (ID: `keyterm:Kingdom`); menjadi murid (ID: `keyterm:Disciple`); memerintahkan (ID: `keyterm:Command`); Yesus (ID: `person:Jesus.2`); persundalan (ID: `keyterm:Fornication`); Musa (ID: `person:Moses`); Yehuda (ID: `place:Judea`); ketegaran hati (ID: `keyterm:Hardheartedness`); memberkati (ID: `keyterm:Bless`); tubuh (ID: `keyterm:Body.3`); amin! (ID: `keyterm:Surely`); Be Lawful (ID: `keyterm:Lawful`); perintah (ID: `keyterm:Commandment`); Yordan (ID: `place:Jordan`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); kerajaan (ID: `keyterm:Kingdom`); kehidupan (ID: `keyterm:Life`); selama, lamanya (ID: `keyterm:Always`); yang baik (ID: `keyterm:Good`); menjadi murid (ID: `keyterm:Disciple`); Rich Young Ruler (ID: `person:RichYoungRuler`); House (ID: `realia:House`); keahlian (ID: `keyterm:Ability`); injil (ID: `keyterm:GoodNews`); kasihi (ID: `keyterm:Love`); amin! (ID: `keyterm:Surely`); persundalan (ID: `keyterm:Fornication`); perintah (ID: `keyterm:Commandment`); Petrus (ID: `person:Peter`); sorga (ID: `keyterm:Heaven`); keselamatan (ID: `keyterm:Salvation`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Yakobus (ID: `person:James`); Yerusalem (ID: `place:Jerusalem`); Gentiles (ID: `group:Gentile`); baptisan (ID: `keyterm:Baptism`); Yohanes (ID: `person:John.2`); kemuliaan (ID: `keyterm:Glory`); Zebedeus (ID: `person:Zebedee`); tebusan (ID: `keyterm:Ransom`); takut (ID: `keyterm:Fear`); menentang (ID: `keyterm:Condemn`); kekuasaan (ID: `keyterm:Authority.2`); kehidupan (ID: `keyterm:Life`); melayani (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); A Group of People (ID: `group:GenericGroup`); Daud (ID: `person:David`); belas kasihan (ID: `keyterm:Mercy`); Timeus (ID: `person:Timaeus`); Bartimeus (ID: `person:Bartimaeus`); menjadi murid (ID: `keyterm:Disciple`); memerintahkan (ID: `keyterm:Command`); Yerikho (ID: `place:Jericho`); percaya (ID: `keyterm:Believe`); percayalah (ID: `keyterm:CheerUp`); keselamatan (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Donkey (ID: `fauna:Donkey`); Yesus (ID: `person:Jesus.2`); Yerusalem (ID: `place:Jerusalem`); Betania (ID: `place:Bethany`); hosana (ID: `keyterm:Hosanna`); memberkati (ID: `keyterm:Bless`); A Group of People (ID: `group:GenericGroup`); Cloak (ID: `realia:Cloak`); Betfage (ID: `place:Bethphage`); kerajaan (ID: `keyterm:Kingdom`); menjadi murid (ID: `keyterm:Disciple`); nama (ID: `keyterm:Name`); tempat yang tinggi (ID: `keyterm:Height`); Tuhan (ID: `deity:Lord`); Daud (ID: `person:David`); Rush (ID: `flora:Rush`); Olive Tree (ID: `flora:OliveTree`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); percaya (ID: `keyterm:Believe`); Temple (ID: `realia:Temple`); Fig (ID: `flora:Fig`); Tuhan (ID: `deity:Lord`); Yerusalem (ID: `place:Jerusalem`); amin! (ID: `keyterm:Surely`); Yesus (ID: `person:Jesus.2`); hati (ID: `keyterm:Heart`); selama, lamanya (ID: `keyterm:Always`); Petrus (ID: `person:Peter`); sorga (ID: `keyterm:Heaven`); bimbang (ID: `keyterm:Discern`); takut (ID: `keyterm:Fear`); Betania (ID: `place:Bethany`); mengampuni (ID: `keyterm:Forgive`); menjadi murid (ID: `keyterm:Disciple`); Seat (ID: `realia:Seat`); Dove (ID: `fauna:Dove`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); keahlian (ID: `keyterm:Ability`); kekuasaan (ID: `keyterm:Authority.2`); Yesus (ID: `person:Jesus.2`); Yohanes (ID: `person:John`); perumpamaan (ID: `keyterm:Parable`); sorga (ID: `keyterm:Heaven`); takut (ID: `keyterm:Fear`); membuang (ID: `keyterm:Reject`); Yerusalem (ID: `place:Jerusalem`); hampa (ID: `keyterm:Empty`); kekasih (ID: `keyterm:Beloved`); Tuhan (ID: `deity:Lord`); Priests (ID: `group:GenericPriests`); percaya (ID: `keyterm:Believe`); baptisan (ID: `keyterm:Baptism`); kitab suci (ID: `keyterm:Scripture`); Elders (ID: `group:GenericElders`); Religious Officials (ID: `group:ReligiousOfficials`); Cornerstone (ID: `realia:Cornerstone`); Winepress (ID: `realia:Winepress`); Thorn Hedge (ID: `realia:ThornHedge`); Watch-Tower (ID: `realia:Watch-tower`); Tower (ID: `realia:Tower`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Tiberius (ID: `person:Tiberius`); kebangkitan (ID: `keyterm:Resurrection`); Yesus (ID: `person:Jesus.2`); Musa (ID: `person:Moses`); Herodians (ID: `group:Herodian`); keahlian (ID: `keyterm:Ability`); kehidupan (ID: `keyterm:Life`); kebenaran (ID: `keyterm:Truth`); Be Lawful (ID: `keyterm:Lawful`); An Angel (ID: `deity:Angel`); jalan tuhan (ID: `keyterm:TheWay`); benar (ID: `keyterm:True`); Sadducees (ID: `group:Sadducee`); Abraham (ID: `person:Abraham`); sorga (ID: `keyterm:Heaven`); pajak (ID: `keyterm:PollTax`); kitab suci (ID: `keyterm:Scripture`); Israel (ID: `person:Israel`); kemunafikan (ID: `keyterm:Hypocrisy`); Pharisees (ID: `group:Pharisee`); Ishak (ID: `person:Isaac`); Denarius (ID: `realia:Denarius`); Boxthorn (ID: `flora:Boxthorn`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kasihi (ID: `keyterm:Love`); Yesus (ID: `person:Jesus.2`); Daud (ID: `person:David`); hati (ID: `keyterm:Heart`); perintah (ID: `keyterm:Commandment`); A Priest (ID: `person:GenericPriest`); A Scribe (ID: `person:Scribe`); Treasury (ID: `realia:Treasury`); pikiran (ID: `keyterm:Mind.2`); amin! (ID: `keyterm:Surely`); kebenaran (ID: `keyterm:Truth`); kerajaan (ID: `keyterm:Kingdom`); persembahan (ID: `keyterm:Offering`); penghakiman (ID: `keyterm:Judgment`); berdoa (ID: `keyterm:Pray`); hidup (ID: `keyterm:DailyLife`); Roh (ID: `deity:HolySpirit`); menjadi murid (ID: `keyterm:Disciple`); Israel (ID: `person:Israel`); Quadrans (ID: `realia:Quadrans`); Lepton (ID: `realia:Lepton`); Synagogue (ID: `realia:Synagogue`); Cloak (ID: `realia:Cloak`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** nama (ID: `keyterm:Name`); Yesus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); menjadi murid (ID: `keyterm:Disciple`); bersaksi (ID: `keyterm:BearWitness`); injil (ID: `keyterm:GoodNews`); kerajaan (ID: `keyterm:Kingdom`); keselamatan (ID: `keyterm:Salvation`); tanda (ID: `keyterm:Example`); memberitakan (ID: `keyterm:Proclaim`); Petrus (ID: `person:Peter`); Roh (ID: `deity:HolySpirit`); A Group of Disciples (ID: `group:GenericDisciples`); Yohanes (ID: `person:John.2`); Andreas (ID: `person:Andrew`); Yakobus (ID: `person:James`); Synagogue (ID: `realia:Synagogue`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** sorga (ID: `keyterm:Heaven`); orang pilihan (ID: `keyterm:Chosen`); Tuhan (ID: `deity:Lord`); House (ID: `realia:House`); keahlian (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); kemuliaan (ID: `keyterm:Glory`); tubuh (ID: `keyterm:Body.3`); amin! (ID: `keyterm:Surely`); mujizat (ID: `keyterm:Portent`); Yesus (ID: `person:Jesus.2`); tanda (ID: `keyterm:Example`); kekuasaan (ID: `keyterm:Authority.2`); perumpamaan (ID: `keyterm:Parable`); berdoa (ID: `keyterm:Pray`); Yehuda (ID: `place:Judea`); memerintahkan (ID: `keyterm:Command`); percaya (ID: `keyterm:Believe`); pembinasa keji (ID: `keyterm:AbominationOfDesolation`); Disaster (ID: `keyterm:Disaster`); keselamatan (ID: `keyterm:Salvation`); Housetop (ID: `realia:Housetop`); Cloak (ID: `realia:Cloak`); Door (ID: `realia:Door`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `flora:Myrrh`); Myrrh (ID: `realia:Myrrh`); Simon (ID: `person:Simon.4`); Betania (ID: `place:Bethany`); keahlian (ID: `keyterm:Ability`); injil (ID: `keyterm:GoodNews`); tubuh (ID: `keyterm:Body.3`); memberitakan (ID: `keyterm:Proclaim`); amin! (ID: `keyterm:Surely`); Yesus (ID: `person:Jesus.2`); murni (ID: `keyterm:Pure`); Yudas (ID: `person:Judas.2`); janji (ID: `keyterm:Promise`); paskah (ID: `keyterm:Passover`); A Group of Disciples (ID: `group:GenericDisciples`); Alabaster Jar (ID: `realia:AlabasterJar`); Oil of Nard (ID: `realia:OilOfNard`); Nard (ID: `flora:Nard`); House (ID: `realia:House`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** menjadi murid (ID: `keyterm:Disciple`); amin! (ID: `keyterm:Surely`); Yesus (ID: `person:Jesus.2`); paskah (ID: `keyterm:Passover`); Sheep (ID: `fauna:Lamb`); darah (ID: `keyterm:Blood`); tubuh (ID: `keyterm:Body.3`); Galilea (ID: `place:Galilee`); kerajaan (ID: `keyterm:Kingdom`); persembahan (ID: `keyterm:Offering`); memberkati (ID: `keyterm:Bless`); Petrus (ID: `person:Peter`); Tuhan (ID: `deity:Lord`); kebangkitan (ID: `keyterm:Resurrection`); perjanjian (ID: `keyterm:Covenant`); Disaster (ID: `keyterm:Disaster`); Upstairs Room (ID: `realia:UpstairsRoom`); Guest Room (ID: `realia:GuestRoom`); Clay Jar (ID: `realia:ClayJar`); Bowl (ID: `realia:Bowl.2`); Rooster (ID: `fauna:Rooster`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Vine (ID: `flora:Vine`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); Petrus (ID: `person:Peter`); Linen (ID: `realia:Linen`); Getsemani (ID: `place:Gethsemane`); menjadi murid (ID: `keyterm:Disciple`); menggenapi (ID: `keyterm:Happen`); nama (ID: `keyterm:Name`); tubuh (ID: `keyterm:Body.3`); roh (ID: `keyterm:Spirit.2`); Yudas (ID: `person:Judas.2`); Yesus (ID: `person:Jesus.2`); Yohanes (ID: `person:John.2`); kitab suci (ID: `keyterm:Scripture`); mencobai (ID: `keyterm:PutToTheTest`); Tuhan (ID: `deity:Lord`); Yakobus (ID: `person:James`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); bersaksi (ID: `keyterm:BearWitness`); saksi (ID: `keyterm:Witness`); keahlian (ID: `keyterm:Ability`); sorga (ID: `keyterm:Heaven`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); Petrus (ID: `person:Peter`); menghujat (ID: `keyterm:Blaspheme`); menentang (ID: `keyterm:Condemn`); Temple (ID: `realia:Temple`); Courtyard (ID: `realia:Courtyard`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Petrus (ID: `person:Peter`); Yesus (ID: `person:Jesus.2`); Rooster (ID: `fauna:Rooster`); firman (ID: `keyterm:Word`); Nazaret (ID: `place:Nazareth`); Galileans (ID: `group:Galilee`); benar (ID: `keyterm:True`); Galilea (ID: `place:Galilee`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Yesus (ID: `person:Jesus.2`); Elia (ID: `person:Elijah`); Jews (ID: `group:Jews`); keselamatan (ID: `keyterm:Salvation`); Purple Cloth (ID: `realia:PurpleCloth`); Clothing (ID: `realia:Clothing`); Reed (ID: `flora:Reed`); Temple (ID: `realia:Temple`); Simon (ID: `person:Simon.5`); Rufus (ID: `person:Rufus`); Kirene (ID: `place:Cyrene`); Aleksander (ID: `person:Alexander`); Centurion at Crucifixion (ID: `person:Centurion.3`); Golgotha (ID: `place:Golgotha`); Tuhan (ID: `deity:Lord`); benar (ID: `keyterm:True`); Priests (ID: `group:GenericPriests`); menyembah (ID: `keyterm:BowDown`); menghujat (ID: `keyterm:Blaspheme`); percaya (ID: `keyterm:Believe`); A Group of People (ID: `group:GenericGroup`); Elders (ID: `group:GenericElders`); Israel (ID: `person:Israel`); Religious Officials (ID: `group:ReligiousOfficials`); Palace (ID: `realia:Palace`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Myrrh (ID: `flora:Myrrh`); Boxthorn (ID: `flora:Boxthorn`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`); Acacia (ID: `flora:Acacia`); Lot (ID: `realia:Lot`); Brier (ID: `flora:Brier`); Sour Wine (ID: `realia:SourWine`); Curtain (ID: `realia:Curtain`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Yusuf (ID: `person:Joseph.6`); Maria (ID: `person:Mary.2`); Pilatus (ID: `person:Pilate`); Maria (ID: `person:Marymagdalene`); Yakobus (ID: `person:James.4`); Salome (ID: `person:Salome`); Yusuf (ID: `person:Joseph.5`); Yusuf (ID: `person:Joseph.3`); Arimatea (ID: `place:Arimathea`); Yerusalem (ID: `place:Jerusalem`); tubuh (ID: `keyterm:Body.3`); Yesus (ID: `person:Jesus.2`); Galilea (ID: `place:Galilee`); kerajaan (ID: `keyterm:Kingdom`); Tuhan (ID: `deity:Lord`); hari persiapan (ID: `keyterm:DayBeforeTheSabbath`); melayani (ID: `keyterm:Serve`); Linen (ID: `realia:Linen`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Salome (ID: `person:Salome`); Angels (ID: `group:Angels`); Maria (ID: `person:Mary.2`); amin! (ID: `keyterm:Surely`); Yakobus (ID: `person:James.3`); Yesus (ID: `person:Jesus.2`); sabat (ID: `keyterm:Sabbath`); diurapi (ID: `keyterm:Anointed`); Galilea (ID: `place:Galilee`); Petrus (ID: `person:Peter`); Maria (ID: `person:Marymagdalene`); memerintahkan (ID: `keyterm:Command`); takut (ID: `keyterm:Fear`); kebangkitan (ID: `keyterm:Resurrection`); Nazaret (ID: `place:Nazareth`); abadi (ID: `keyterm:Imperishable`); menjadi murid (ID: `keyterm:Disciple`); minggu (ID: `keyterm:Week`); keselamatan (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`); Cross (ID: `realia:Cross`); Aloes (ID: `realia:Aloes`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); tidak percaya (ID: `keyterm:Disbelieve`); memberitakan (ID: `keyterm:Proclaim`); Yesus (ID: `person:Jesus.2`); tanda (ID: `keyterm:Example`); Demons (ID: `deity:Demons`); keahlian (ID: `keyterm:Ability`); injil (ID: `keyterm:GoodNews`); kehidupan (ID: `keyterm:Life`); nama (ID: `keyterm:Name`); Maria (ID: `person:Marymagdalene`); Tuhan (ID: `deity:Lord`); sorga (ID: `keyterm:Heaven`); baptisan (ID: `keyterm:Baptism`); kebangkitan (ID: `keyterm:Resurrection`); ketegaran hati (ID: `keyterm:Hardheartedness`); minggu (ID: `keyterm:Week`); menentang (ID: `keyterm:Condemn`); keselamatan (ID: `keyterm:Salvation`); Snake (ID: `fauna:Snake`)
