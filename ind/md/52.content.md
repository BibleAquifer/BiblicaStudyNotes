...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); Makedonia (ID: `place:Macedonia`); kasihi (ID: `keyterm:Love`); Roh (ID: `deity:HolySpirit`); Akhaya (ID: `place:Achaia`); Tesalonika (ID: `place:Thessalonica`); keahlian (ID: `keyterm:Ability`); injil (ID: `keyterm:GoodNews`); kehidupan (ID: `keyterm:Life`); Paulus (ID: `person:Paul`); orang pilihan (ID: `keyterm:Chosen`); Cause of Joy (ID: `keyterm:CauseOfJoy`); melayani (ID: `keyterm:Serve.2`); benar (ID: `keyterm:True`); Thessalonians (ID: `group:Thessalonica`); menyelamatkan (ID: `keyterm:Deliver`); berdoa (ID: `keyterm:Pray`); sorga (ID: `keyterm:Heaven`); kebaikan (ID: `keyterm:Favor`); kebangkitan (ID: `keyterm:Resurrection`); Silas (ID: `person:Silas`); Timotius (ID: `person:Timothy`); memperdamaikan (ID: `keyterm:Peace`); harapan (ID: `keyterm:Hope`); jemaat (ID: `keyterm:Church`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); injil (ID: `keyterm:GoodNews`); percaya (ID: `keyterm:Believe`); kemuliaan (ID: `keyterm:Glory`); Yesus (ID: `person:Jesus.2`); meminta (ID: `keyterm:AskFor`); saksi (ID: `keyterm:Witness`); memberitakan (ID: `keyterm:Proclaim`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); Filipi (ID: `place:Philippi`); hati (ID: `keyterm:Heart`); hidup (ID: `keyterm:Live.3`); hampa (ID: `keyterm:Empty`); kerajaan (ID: `keyterm:Kingdom`); khusus (ID: `keyterm:Holy`); kekasih (ID: `keyterm:Beloved`); berbuat dosa (ID: `keyterm:Sin`); benar (ID: `keyterm:True`); dalam kristus (ID: `keyterm:InChrist`); Yehuda (ID: `place:Judea`); Jews (ID: `group:Jews`); menilai (ID: `keyterm:Interpret`); pencemaran (ID: `keyterm:Defilement`); Gentiles (ID: `group:Gentile`); jemaat (ID: `keyterm:Church`); memberi kesaksian yang sungguh, sungguh (ID: `keyterm:Declare`); keselamatan (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); meminta (ID: `keyterm:AskFor`); injil (ID: `keyterm:GoodNews`); kasihi (ID: `keyterm:Love`); menasihati (ID: `keyterm:Encourage`); hati (ID: `keyterm:Heart`); Timotius (ID: `person:Timothy`); Atena (ID: `place:Athens`); kemuliaan (ID: `keyterm:Glory`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); kehidupan (ID: `keyterm:Life`); Paulus (ID: `person:Paul`); hampa (ID: `keyterm:Empty`); khusus (ID: `keyterm:Holy`); mencobai (ID: `keyterm:PutToTheTest`); ingin (ID: `keyterm:LongFor`); yang baik (ID: `keyterm:Good`); Iblis (ID: `deity:Satan`); harapan (ID: `keyterm:Hope`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); dikhususkan (ID: `keyterm:Consecration.2`); Yesus (ID: `person:Jesus.2`); meminta (ID: `keyterm:AskFor`); hidup (ID: `keyterm:Live.3`); persaudaraan (ID: `keyterm:LoveForOnesFellowBeliever`); belajar dari allah (ID: `keyterm:TaughtByGod`); kasihi (ID: `keyterm:Love`); Makedonia (ID: `place:Macedonia`); pencemaran (ID: `keyterm:Defilement`); Gentiles (ID: `group:Gentile`); memberi kesaksian yang sungguh, sungguh (ID: `keyterm:Declare`); persundalan (ID: `keyterm:Fornication`); Roh (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); kehidupan (ID: `keyterm:Life`); Tuhan (ID: `deity:Lord`); sorga (ID: `keyterm:Heaven`); percaya (ID: `keyterm:Believe`); harapan (ID: `keyterm:Hope`); menasihati (ID: `keyterm:Encourage`); meminta (ID: `keyterm:AskFor`); dalam kristus (ID: `keyterm:InChrist`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); keselamatan (ID: `keyterm:Salvation`); menasihati (ID: `keyterm:Encourage`); memperdamaikan (ID: `keyterm:Peace`); kasihi (ID: `keyterm:Love`); percaya (ID: `keyterm:Believe`); harapan (ID: `keyterm:Hope`); kehidupan (ID: `keyterm:Life`); meminta (ID: `keyterm:AskFor`); Tuhan (ID: `deity:Lord`); Helmet (ID: `realia:Helmet`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); meminta (ID: `keyterm:AskFor`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); tubuh (ID: `keyterm:Body.3`); kasihi (ID: `keyterm:Love`); hidup berdamai (ID: `keyterm:AtPeace`); khusus (ID: `keyterm:Holy`); tawar hati (ID: `keyterm:FaintHearted`); dalam kristus (ID: `keyterm:InChrist`); kesetiaan (ID: `keyterm:Faithfulness`); kebaikan (ID: `keyterm:Favor`); yang baik (ID: `keyterm:Good`); Roh (ID: `deity:HolySpirit`); menilai (ID: `keyterm:Interpret`); memperdamaikan (ID: `keyterm:Peace`); dikhususkan (ID: `keyterm:Consecration.2`); roh (ID: `keyterm:Spirit.2`)
