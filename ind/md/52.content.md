...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); Makedonia (ID: `place:Macedonia`); kasihi (ID: `keyterm:Love`); Roh (ID: `deity:HolySpirit`); Akhaya (ID: `place:Achaia`); Tesalonika (ID: `place:Thessalonica`); injil (ID: `keyterm:GoodNews`); Paulus (ID: `person:Paul`); menyelamatkan (ID: `keyterm:Deliver`); Cause of Joy (ID: `keyterm:CauseOfJoy`); keahlian (ID: `keyterm:Ability`); sorga (ID: `keyterm:Heaven`); Thessalonians (ID: `group:Thessalonica`); melayani (ID: `keyterm:Serve.2`); Timotius (ID: `person:Timothy`); harapan (ID: `keyterm:Hope`); orang pilihan (ID: `keyterm:Chosen`); kehidupan (ID: `keyterm:Life`); benar (ID: `keyterm:True`); jemaat (ID: `keyterm:Church`); Silas (ID: `person:Silas`); berdoa (ID: `keyterm:Pray`); memperdamaikan (ID: `keyterm:Peace`); kebangkitan (ID: `keyterm:Resurrection`); kebaikan (ID: `keyterm:Favor`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); injil (ID: `keyterm:GoodNews`); percaya (ID: `keyterm:Believe`); kemuliaan (ID: `keyterm:Glory`); saksi (ID: `keyterm:Witness`); meminta (ID: `keyterm:AskFor`); Yesus (ID: `person:Jesus.2`); keselamatan (ID: `keyterm:Salvation`); Yehuda (ID: `place:Judea`); berbuat dosa (ID: `keyterm:Sin`); memberi kesaksian yang sungguh, sungguh (ID: `keyterm:Declare`); dalam kristus (ID: `keyterm:InChrist`); hidup (ID: `keyterm:Live.3`); Filipi (ID: `place:Philippi`); hati (ID: `keyterm:Heart`); menilai (ID: `keyterm:Interpret`); hampa (ID: `keyterm:Empty`); benar (ID: `keyterm:True`); pencemaran (ID: `keyterm:Defilement`); jemaat (ID: `keyterm:Church`); khusus (ID: `keyterm:Holy`); kerajaan (ID: `keyterm:Kingdom`); kekasih (ID: `keyterm:Beloved`); memberitakan (ID: `keyterm:Proclaim`); Gentiles (ID: `group:Gentile`); Jews (ID: `group:Jews`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); meminta (ID: `keyterm:AskFor`); injil (ID: `keyterm:GoodNews`); kasihi (ID: `keyterm:Love`); Timotius (ID: `person:Timothy`); hati (ID: `keyterm:Heart`); menasihati (ID: `keyterm:Encourage`); Atena (ID: `place:Athens`); ingin (ID: `keyterm:LongFor`); Paulus (ID: `person:Paul`); kemuliaan (ID: `keyterm:Glory`); mencobai (ID: `keyterm:PutToTheTest`); harapan (ID: `keyterm:Hope`); Iblis (ID: `deity:Satan`); yang baik (ID: `keyterm:Good`); kehidupan (ID: `keyterm:Life`); hampa (ID: `keyterm:Empty`); khusus (ID: `keyterm:Holy`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`); dikhususkan (ID: `keyterm:Consecration.2`); meminta (ID: `keyterm:AskFor`); hidup (ID: `keyterm:Live.3`); persaudaraan (ID: `keyterm:LoveForOnesFellowBeliever`); belajar dari allah (ID: `keyterm:TaughtByGod`); pencemaran (ID: `keyterm:Defilement`); memberi kesaksian yang sungguh, sungguh (ID: `keyterm:Declare`); Makedonia (ID: `place:Macedonia`); persundalan (ID: `keyterm:Fornication`); Gentiles (ID: `group:Gentile`); Roh (ID: `deity:HolySpirit`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); kehidupan (ID: `keyterm:Life`); Tuhan (ID: `deity:Lord`); meminta (ID: `keyterm:AskFor`); menasihati (ID: `keyterm:Encourage`); harapan (ID: `keyterm:Hope`); percaya (ID: `keyterm:Believe`); dalam kristus (ID: `keyterm:InChrist`); sorga (ID: `keyterm:Heaven`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); keselamatan (ID: `keyterm:Salvation`); menasihati (ID: `keyterm:Encourage`); memperdamaikan (ID: `keyterm:Peace`); meminta (ID: `keyterm:AskFor`); kehidupan (ID: `keyterm:Life`); harapan (ID: `keyterm:Hope`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`); kasihi (ID: `keyterm:Love`); Helmet (ID: `realia:Helmet`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); meminta (ID: `keyterm:AskFor`); berdoa (ID: `keyterm:Pray`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); hidup berdamai (ID: `keyterm:AtPeace`); dikhususkan (ID: `keyterm:Consecration.2`); kasihi (ID: `keyterm:Love`); tubuh (ID: `keyterm:Body.3`); tawar hati (ID: `keyterm:FaintHearted`); yang baik (ID: `keyterm:Good`); menilai (ID: `keyterm:Interpret`); Roh (ID: `deity:HolySpirit`); khusus (ID: `keyterm:Holy`); memperdamaikan (ID: `keyterm:Peace`); roh (ID: `keyterm:Spirit.2`); kesetiaan (ID: `keyterm:Faithfulness`); kebaikan (ID: `keyterm:Favor`); dalam kristus (ID: `keyterm:InChrist`)
