...
Paulus, Silas dan Timotius telah memberitakan tentang Yesus di Tesalonika. Itu terjadi pada Perjalanan Paulusyang kedua. Kisah tentang hal ini dicatat dalam Kisah Para Rasul pasal 17\. Beberapa Orang Yahudi dan banyak orang bukan Yahudi percaya kepada berita tentang Yesus. Mereka menyambut kabar baik itu dengan sukacita. Mereka seperti benih yang jatuh di tanah yang baik, yaitu perumpamaan yang dikatakan Yesus (Matius 13:8 dan 23\). Kebenaran tentang Yesus bukan hanya kata\-kata yang diucapkan Paulus dengan lantang. Kebenaran itu datang dengan kuasa Roh Kudus. Kuasa ini mengubah kehidupan orang percaya di Tesalonika. Mereka berbalik dari menyembah ilah\-ilah palsu. Mereka bertumbuh dalam iman, kasih, dan pengharapan. Mereka menjadi teladan bagi orang\-orang percaya lainnya.

* **Associated Passages:** 1 Tesalonika 1:1-10
* **Associated Articles:** Kabar baik (ID: `203178@BiblicaStudyNotesKeyTerms`); Orang Percaya (ID: `203212@BiblicaStudyNotesKeyTerms`); Perjalanan Paulus (ID: `203246@BiblicaStudyNotesKeyTerms`); Silas (ID: `203256@BiblicaStudyNotesKeyTerms`); Timotius (ID: `203259@BiblicaStudyNotesKeyTerms`); Tesalonika (ID: `203263@BiblicaStudyNotesKeyTerms`); Yesus (ID: `203354@BiblicaStudyNotesKeyTerms`); Iman (ID: `203367@BiblicaStudyNotesKeyTerms`); Berhala-berhala (ID: `203419@BiblicaStudyNotesKeyTerms`); Roh Kudus (ID: `203523@BiblicaStudyNotesKeyTerms`); Yahudi (ID: `203638@BiblicaStudyNotesKeyTerms`); Orang bukan Yahudi (ID: `203682@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); Makedonia (ID: `place:Macedonia`); Roh (ID: `deity:HolySpirit`); Akhaya (ID: `place:Achaia`); kasihi (ID: `keyterm:Love`); Tesalonika (ID: `place:Thessalonica`); sorga (ID: `keyterm:Heaven`); benar (ID: `keyterm:True`); injil (ID: `keyterm:GoodNews`); harapan (ID: `keyterm:Hope`); Timotius (ID: `person:Timothy`); memperdamaikan (ID: `keyterm:Peace`); orang pilihan (ID: `keyterm:Chosen`); melayani (ID: `keyterm:Serve.2`); Silas (ID: `person:Silas`); kebaikan (ID: `keyterm:Favor`); keahlian (ID: `keyterm:Ability`); Thessalonians (ID: `group:Thessalonica`); Cause of Joy (ID: `keyterm:CauseOfJoy`); berdoa (ID: `keyterm:Pray`); kehidupan (ID: `keyterm:Life`); kebangkitan (ID: `keyterm:Resurrection`); Paulus (ID: `person:Paul`); jemaat (ID: `keyterm:Church`); menyelamatkan (ID: `keyterm:Deliver`); Image (ID: `realia:Image`)
...
* **Associated Passages:** 1 Tesalonika 2:1-16
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); injil (ID: `keyterm:GoodNews`); percaya (ID: `keyterm:Believe`); meminta (ID: `keyterm:AskFor`); saksi (ID: `keyterm:Witness`); Yesus (ID: `person:Jesus.2`); kemuliaan (ID: `keyterm:Glory`); hati (ID: `keyterm:Heart`); benar (ID: `keyterm:True`); dalam kristus (ID: `keyterm:InChrist`); memberitakan (ID: `keyterm:Proclaim`); Yehuda (ID: `place:Judea`); memberi kesaksian yang sungguh, sungguh (ID: `keyterm:Declare`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); kerajaan (ID: `keyterm:Kingdom`); Filipi (ID: `place:Philippi`); hidup (ID: `keyterm:Live.3`); hampa (ID: `keyterm:Empty`); kekasih (ID: `keyterm:Beloved`); Gentiles (ID: `group:Gentile`); menilai (ID: `keyterm:Interpret`); pencemaran (ID: `keyterm:Defilement`); keselamatan (ID: `keyterm:Salvation`); Jews (ID: `group:Jews`); berbuat dosa (ID: `keyterm:Sin`); jemaat (ID: `keyterm:Church`); khusus (ID: `keyterm:Holy`)
...
* **Associated Passages:** 1 Tesalonika 2:17-3:13
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`); meminta (ID: `keyterm:AskFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); hati (ID: `keyterm:Heart`); injil (ID: `keyterm:GoodNews`); Timotius (ID: `person:Timothy`); menasihati (ID: `keyterm:Encourage`); kasihi (ID: `keyterm:Love`); Atena (ID: `place:Athens`); harapan (ID: `keyterm:Hope`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); mencobai (ID: `keyterm:PutToTheTest`); ingin (ID: `keyterm:LongFor`); Iblis (ID: `deity:Satan`); hampa (ID: `keyterm:Empty`); kehidupan (ID: `keyterm:Life`); yang baik (ID: `keyterm:Good`); Paulus (ID: `person:Paul`); khusus (ID: `keyterm:Holy`); kemuliaan (ID: `keyterm:Glory`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated Passages:** 1 Tesalonika 4:1-12
* **Associated Articles:** Hidup kudus (ID: `203179@BiblicaStudyNotesKeyTerms`); Kudus (ID: `203496@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); dikhususkan (ID: `keyterm:Consecration.2`); Yesus (ID: `person:Jesus.2`); hidup (ID: `keyterm:Live.3`); meminta (ID: `keyterm:AskFor`); persaudaraan (ID: `keyterm:LoveForOnesFellowBeliever`); memberi kesaksian yang sungguh, sungguh (ID: `keyterm:Declare`); Roh (ID: `deity:HolySpirit`); belajar dari allah (ID: `keyterm:TaughtByGod`); Makedonia (ID: `place:Macedonia`); persundalan (ID: `keyterm:Fornication`); Gentiles (ID: `group:Gentile`); pencemaran (ID: `keyterm:Defilement`); kasihi (ID: `keyterm:Love`)
...
* **Associated Passages:** 1 Tesalonika 4:13-18
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); kehidupan (ID: `keyterm:Life`); dalam kristus (ID: `keyterm:InChrist`); sorga (ID: `keyterm:Heaven`); percaya (ID: `keyterm:Believe`); meminta (ID: `keyterm:AskFor`); menasihati (ID: `keyterm:Encourage`); harapan (ID: `keyterm:Hope`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated Passages:** 1 Tesalonika 5:1-11
...
* **Associated ACAI Concepts:** keselamatan (ID: `keyterm:Salvation`); Yesus (ID: `person:Jesus.2`); menasihati (ID: `keyterm:Encourage`); percaya (ID: `keyterm:Believe`); meminta (ID: `keyterm:AskFor`); memperdamaikan (ID: `keyterm:Peace`); Tuhan (ID: `deity:Lord`); kehidupan (ID: `keyterm:Life`); harapan (ID: `keyterm:Hope`); kasihi (ID: `keyterm:Love`); Helmet (ID: `realia:Helmet`)
...
* **Associated Passages:** 1 Tesalonika 5:12-28
* **Associated Articles:** Damai sejahtera (ID: `203346@BiblicaStudyNotesKeyTerms`); Anugerah (ID: `203370@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); meminta (ID: `keyterm:AskFor`); Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); tawar hati (ID: `keyterm:FaintHearted`); dalam kristus (ID: `keyterm:InChrist`); memperdamaikan (ID: `keyterm:Peace`); kesetiaan (ID: `keyterm:Faithfulness`); hidup berdamai (ID: `keyterm:AtPeace`); kebaikan (ID: `keyterm:Favor`); tubuh (ID: `keyterm:Body.3`); menilai (ID: `keyterm:Interpret`); yang baik (ID: `keyterm:Good`); Roh (ID: `deity:HolySpirit`); dikhususkan (ID: `keyterm:Consecration.2`); khusus (ID: `keyterm:Holy`); roh (ID: `keyterm:Spirit.2`); kasihi (ID: `keyterm:Love`)
