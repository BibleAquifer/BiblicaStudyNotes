...
* **Associated ACAI Concepts:** Makedonia (ID: `place:Macedonia`); Tesalonika (ID: `place:Thessalonica`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Atena (ID: `place:Athens`); percaya (ID: `keyterm:Believe`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** persaudaraan (ID: `keyterm:LoveForOnesFellowBeliever`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** menasihati (ID: `keyterm:Encourage`)
...
* **Associated ACAI Concepts:** lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); Yesus (ID: `person:Jesus.2`)
