...
* **Associated ACAI Concepts:** Petuel (ID: `person:Pethuel`); Yoël (ID: `person:Joel.14`); Locust (ID: `fauna:Locust`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** sungai (ID: `place:ShittimValley`); Pruning Knife (ID: `realia:PruningKnife`); Sabeans (ID: `group:Sabean`); Greeks (ID: `group:Greek`); Yehuda (ID: `group:Judah`); Yehuda (ID: `person:Judah.4`); Yerusalem (ID: `place:Jerusalem`); Tuhan (ID: `deity:Lord`)
