...
* **Associated ACAI Concepts:** Patmos (ID: `place:Patmos`); Lampstand (ID: `realia:Lampstand.2`); Pergamus (ID: `place:Pergamum`); Smirna (ID: `place:Smyrna`); Filadelfia (ID: `place:Philadelphia`); Sardis (ID: `place:Sardis`); Laodikia (ID: `place:Laodicea`); Kiln (ID: `realia:Kiln`); Efesus (ID: `place:Ephesus`)
...
* **Associated ACAI Concepts:** Nicolaitans (ID: `group:Nicolaitans`); Antipas (ID: `person:Antipas`); Pergamus (ID: `place:Pergamum`); Smirna (ID: `place:Smyrna`); Efesus (ID: `place:Ephesus`); bertindak jahat (ID: `keyterm:ActWickedly`); jemaat (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** Tiatira (ID: `place:Thyatira`); Sardis (ID: `place:Sardis`); persundalan (ID: `keyterm:Fornication`); Clothing (ID: `realia:Clothing`); Izebel (ID: `person:Jezebel`); Rod (ID: `realia:Rod`); jemaat (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** Eye Salve (ID: `realia:EyeSalve`); Filadelfia (ID: `place:Philadelphia`); Door (ID: `realia:Door`); benar (ID: `keyterm:True`); Laodikia (ID: `place:Laodicea`); persahabatan (ID: `keyterm:Friendship`)
...
* **Associated ACAI Concepts:** Isakhar (ID: `person:Issachar`); Zebulon (ID: `person:Zebulun`); Naftali (ID: `person:Naphtali`); Ruben (ID: `person:Reuben`); Throne (ID: `realia:Throne`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** kebinasaan (ID: `deity:Abaddon`); jurang maut (ID: `keyterm:Abyss`)
...
* **Associated ACAI Concepts:** sorga (ID: `keyterm:Heaven`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Measuring Rod (ID: `realia:MeasuringRod`); Measuring Reed (ID: `realia:MeasuringReed`); saksi (ID: `keyterm:Witness`)
...
* **Associated ACAI Concepts:** Dragon (ID: `fauna:Dragon`); bersaksi (ID: `keyterm:BearWitness`); Mikhael (ID: `person:Michael.11`); Rod (ID: `realia:Rod`); sorga (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** kekuasaan (ID: `keyterm:Authority.2`); Leopard (ID: `fauna:Leopard`); Bear (ID: `fauna:Bear`); keahlian (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** tak bernoda (ID: `keyterm:Unblemished`); Lyre (ID: `realia:Lyre`)
...
* **Associated ACAI Concepts:** Bowl (ID: `realia:Bowl.2`); Frog (ID: `fauna:Frog`); Talent (ID: `realia:Talent`); Efrat (ID: `place:Euphrates`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** tuntutan (ID: `keyterm:Regulations`); menuntut pembalasan (ID: `keyterm:GrantJustice`); Linen (ID: `realia:Linen`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** jurang maut (ID: `keyterm:Abyss`); alam maut (ID: `keyterm:WorldOfTheDead`); Magog (ID: `place:Magog`); Key (ID: `realia:Key`); Gog (ID: `place:Gog`); Chain (ID: `realia:Chain`)
...
* **Associated ACAI Concepts:** kemuliaan (ID: `keyterm:Glory`); selama, lamanya (ID: `keyterm:Always`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** The Church (ID: `group:GenericChurch`); berbahagialah (ID: `keyterm:Happy`); amin! (ID: `keyterm:Surely`); Scroll (ID: `realia:Scroll`)
