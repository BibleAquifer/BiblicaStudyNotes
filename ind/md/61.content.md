...
* **Associated Passages:** 2 Petrus 1:1-11
...
* **Associated ACAI Concepts:** ilahi (ID: `keyterm:Divine`); kesungguhan (ID: `keyterm:Eagerness`); janji (ID: `keyterm:Promise`)
...
* **Associated Passages:** 2 Petrus 1:12-21
...
* **Associated Passages:** 2 Petrus 2:1-9
...
* **Associated ACAI Concepts:** tak kenal hukum (ID: `keyterm:Lawless`); Lot (ID: `person:Lot`)
...
* **Associated Passages:** 2 Petrus 2:10-22
...
* **Associated ACAI Concepts:** Beor (ID: `person:Beor.2`); Pig (ID: `fauna:Pig`); Bileam (ID: `person:Balaam`); tidak setia (ID: `keyterm:Unfaithful`)
...
* **Associated Passages:** 2 Petrus 3:1-10
...
* **Associated ACAI Concepts:** roh, roh dunia (ID: `keyterm:FundamentalPrinciples`)
...
* **Associated Passages:** 2 Petrus 3:11-18
