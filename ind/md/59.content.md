...
* **Associated ACAI Concepts:** mencobai (ID: `keyterm:PutToTheTest`); Grass (ID: `flora:Grass`); tahan uji (ID: `keyterm:Approved`); menilai (ID: `keyterm:Interpret`); berbahagialah (ID: `keyterm:Happy`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Mirror (ID: `realia:Mirror`); sia, sia (ID: `keyterm:Worthless`); suci (ID: `keyterm:Clean`)
...
* **Associated ACAI Concepts:** tonton bulu atau muka (ID: `keyterm:Partiality`); pengadilan (ID: `keyterm:CourtCase`); tersandung (ID: `keyterm:Stumble`); penghakiman (ID: `keyterm:Judgment`); hukum (ID: `keyterm:Law`)
...
* **Associated ACAI Concepts:** sia, sia (ID: `keyterm:Idle`); Rahab (ID: `person:Rahab`); percaya (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Rudder (ID: `realia:Rudder`); Bit and Bridle (ID: `realia:BitAndBridle`); membujuk (ID: `keyterm:Persuade`)
...
* **Associated ACAI Concepts:** iri hati (ID: `keyterm:Resentment`); alamiah (ID: `keyterm:Natural`); ramah (ID: `keyterm:Gentle`); ikhlas (ID: `keyterm:Unhypocritical`); kelakuan (ID: `keyterm:Behavior`)
...
* **Associated ACAI Concepts:** memutuskan (ID: `keyterm:Decided`); baik (ID: `keyterm:Honest`); persahabatan (ID: `keyterm:Friendship`); tidak setia (ID: `keyterm:Unfaithful`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** penyayang (ID: `keyterm:Compassionate`); Ayub (ID: `person:Job`); Tuhan (ID: `deity:Lord`)
