...
* **Associated ACAI Concepts:** penebusan (ID: `keyterm:Liberation`); tak bernoda (ID: `keyterm:Unblemished`); Efesus (ID: `place:Ephesus`); sorgawi (ID: `keyterm:Heavenly`); darah (ID: `keyterm:Blood`); mengampuni (ID: `keyterm:Forgive`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** memperdamaikan (ID: `keyterm:Reconcile`); Cornerstone (ID: `realia:Cornerstone`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** bertambah kuat (ID: `keyterm:BuildingUp`); tempat yang tinggi (ID: `keyterm:Height`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** hidup (ID: `keyterm:Live.3`); penyembah berhala (ID: `keyterm:Idolater`); kelakuan (ID: `keyterm:Behavior`); bertambah kuat (ID: `keyterm:BuildingUp`); pikiran (ID: `keyterm:Mind.2`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Tikhikus (ID: `person:Tychicus`); Helmet (ID: `realia:Helmet`); Large Shield (ID: `realia:LargeShield`); Arrow (ID: `realia:Arrow`)
