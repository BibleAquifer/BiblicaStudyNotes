...
* **Associated ACAI Concepts:** ingin (ID: `keyterm:LongFor`); kekasih (ID: `keyterm:Beloved`); percaya (ID: `keyterm:Believe`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** lalim (ID: `keyterm:UnjustDeed`); Creeping Animal (ID: `fauna:CreepingAnimal`); ilahi (ID: `keyterm:Divine`); abadi (ID: `keyterm:Imperishable`); sembah (ID: `keyterm:Worship`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** memutuskan (ID: `keyterm:Decided`); penghakiman (ID: `keyterm:Judgment`); tonton bulu atau muka (ID: `keyterm:Partiality`); menentang (ID: `keyterm:Condemn`); hati nurani (ID: `keyterm:Conscience`); kebaikan (ID: `keyterm:Kindness`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); Cobra (ID: `fauna:Cobra`); tidak percaya (ID: `keyterm:Disbelieve`); lalim (ID: `keyterm:UnjustDeed`); benar (ID: `keyterm:True`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** berbuat dosa (ID: `keyterm:Sin`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** janji (ID: `keyterm:Promise`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Abraham (ID: `person:Abraham`); percaya (ID: `keyterm:Believe`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** memperdamaikan (ID: `keyterm:Reconcile`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** kebaikan (ID: `keyterm:Favor`); berbuat dosa (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** kehidupan (ID: `keyterm:Life`); dikhususkan (ID: `keyterm:Consecration.2`); baptisan (ID: `keyterm:Baptism`); melayani (ID: `keyterm:Serve.2`); hidup (ID: `keyterm:Live.3`); berbuat dosa (ID: `keyterm:Sin`); kebaikan (ID: `keyterm:Favor`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** baik (ID: `keyterm:Honest`); tulisan (ID: `keyterm:Letter`); manusia (ID: `keyterm:Carnal`); hukum (ID: `keyterm:Law`); perintah (ID: `keyterm:Commandment`); tubuh (ID: `keyterm:Body.3`); berbuat dosa (ID: `keyterm:Sin`); kehidupan (ID: `keyterm:Life`)
...
* **Associated ACAI Concepts:** roh (ID: `keyterm:Spirit.2`); dalam kristus (ID: `keyterm:InChrist`); perhambaan (ID: `keyterm:Slavery`); menghidupkan (ID: `keyterm:Alive`); tuntutan (ID: `keyterm:Regulations`); memikirkan (ID: `keyterm:Think`); tubuh (ID: `keyterm:Body.3`); Roh (ID: `deity:HolySpirit`); kehidupan (ID: `keyterm:Life`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** orang pilihan (ID: `keyterm:Chosen`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** belas kasihan (ID: `keyterm:Mercy`); Firaun (ID: `person:Pharaoh.6`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** penyesatan (ID: `keyterm:StumblingBlock`); Hosea (ID: `person:Hosea`); tersandung (ID: `keyterm:Stumble`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** hati (ID: `keyterm:Heart`); percaya (ID: `keyterm:Believe`); berdoa (ID: `keyterm:CallUpon`); Yesaya (ID: `person:Isaiah`); kerinduan (ID: `keyterm:Extremely`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Olive Tree (ID: `flora:OliveTree`); tersandung (ID: `keyterm:Stumble`); Trap (ID: `realia:Trap`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** yang baik (ID: `keyterm:Good`); tubuh (ID: `keyterm:Body.3`); kesungguhan (ID: `keyterm:Eagerness`); memikirkan (ID: `keyterm:Think`); melayani (ID: `keyterm:Serve`); kebaikan (ID: `keyterm:Favor`); persaudaraan (ID: `keyterm:LoveForOnesFellowBeliever`); ikhlas (ID: `keyterm:Unhypocritical`); beroleh bagian (ID: `keyterm:Share`); menuntut pembalasan (ID: `keyterm:GrantJustice`); menilai (ID: `keyterm:Interpret`); berdoa (ID: `keyterm:Pray`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** kekuasaan (ID: `keyterm:Authority.2`); pelayan (ID: `keyterm:Servant`)
...
* **Associated ACAI Concepts:** bimbang (ID: `keyterm:Discern`); tahan uji (ID: `keyterm:Approved`); baik (ID: `keyterm:Honest`); Judgment Seat (ID: `realia:JudgmentSeat`); bertambah kuat (ID: `keyterm:BuildingUp`); kerajaan (ID: `keyterm:Kingdom`); memutuskan (ID: `keyterm:Decided`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** harapan (ID: `keyterm:Hope`); pelayan (ID: `keyterm:Servant`); Gentiles (ID: `group:Gentile`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Spanyol (ID: `place:Spain`); Ilirikum (ID: `place:Illyricum`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Herodion (ID: `person:Herodion`); Flegon (ID: `person:Phlegon`); Febe (ID: `person:Phoebe`); Stakhis (ID: `person:Stachys`); Hermas (ID: `person:Hermas`); Yulia (ID: `person:Julia`); Asinkritus (ID: `person:Asyncritus`); Nereus (ID: `person:Nereus`); Urbanus (ID: `person:Urbanus`); Olimpas (ID: `person:Olympas`); Apeles (ID: `person:Apelles`); Trifena (ID: `person:Tryphaena`); Trifosa (ID: `person:Tryphosa`); Filologus (ID: `person:Philologus`); Maria (ID: `person:Mary.6`); Rufus (ID: `person:Rufus.2`); Epenetus (ID: `person:Epaenetus`); Andronikus (ID: `person:Andronicus`); Narkisus (ID: `person:Narcissus`); Hermes (ID: `person:Hermes`); Ampliatus (ID: `person:Ampliatus`); Patrobas (ID: `person:Patrobas`); Yunias (ID: `person:Junia`); Persis (ID: `person:Persis`); Aristobulus (ID: `person:Aristobulus`); kekasih (ID: `keyterm:Beloved`); Kengkrea (ID: `place:Cenchreae`); Priskila (ID: `person:Priscilla`); Akwila (ID: `person:Aquila`); Asia (ID: `place:Asia`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Tertius (ID: `person:Tertius`); Kwartus (ID: `person:Quartus`); Sopater (ID: `person:Sopater`); Gayus (ID: `person:Gaius.3`); Erastus (ID: `person:Erastus`); Yason (ID: `person:Jason`); Yesus (ID: `person:Jesus.2`)
