...
* **Associated ACAI Concepts:** Filipi (ID: `place:Philippi`); ingin (ID: `keyterm:LongFor`); rahmat (ID: `keyterm:Affection`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** memikirkan (ID: `keyterm:Think`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Epafroditus (ID: `person:Epaphroditus`); Timotius (ID: `person:Timothy`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); Hebrews (ID: `group:Hebrews`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Euodia (ID: `person:Euodia`); Sintikhe (ID: `person:Syntyche`); Klemens (ID: `person:Clement`); ramah (ID: `keyterm:Gentle`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Philippians (ID: `group:Philippi`); Nero (ID: `person:Nero`); Epafroditus (ID: `person:Epaphroditus`); beroleh bagian (ID: `keyterm:Share`)
