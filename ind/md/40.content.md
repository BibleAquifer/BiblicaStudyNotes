...
* **Associated ACAI Concepts:** Eliud (ID: `person:Eliud`); Yakub (ID: `person:Jacob.2`); Azor (ID: `person:Azor`); Matan (ID: `person:Matthan`); Zadok (ID: `person:Zadok`); Eleazar (ID: `person:Eleazar`); Abihud (ID: `person:Abiud`); Akhim (ID: `person:Achim`); Elyakim (ID: `person:Eliakim`); Ram (ID: `person:Ram`); memperanakkan (ID: `person:Salmon`); Daud (ID: `person:David`); Yesus (ID: `person:Jesus.2`); raja (ID: `person:Jehoiachin`); Zerubabel (ID: `person:Zerubbabel.2`); Uzia (ID: `person:Uzziah`); Yosia (ID: `person:Josiah`); Asa (ID: `person:Asa`); Hizkia (ID: `person:Hezekiah`); Salomo (ID: `person:Solomon`); Obed (ID: `person:Obed`); Tamar (ID: `person:Tamar`); Rahab (ID: `person:Rahab`); Aminadab (ID: `person:Amminadab`); Nahason (ID: `person:Nahshon`); Zerah (ID: `person:Zerah.3`); Hezron (ID: `person:Hezron.2`); Yusuf (ID: `person:Joseph.4`); Peres (ID: `person:Perez`); Amon (ID: `person:Amon.3`); Abia (ID: `person:Abijah.4`); Yotam (ID: `person:Jotham.2`); Yoram (ID: `person:Jehoram`); Uria (ID: `person:Uriah`); Boas (ID: `person:Boaz`); Ahas (ID: `person:Ahaz`); Rehabeam (ID: `person:Rehoboam`); Yosafat (ID: `person:Jehoshaphat.3`); Ishak (ID: `person:Isaac`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Yusuf (ID: `person:Joseph.4`); Yesus (ID: `person:Jesus.2`); nama (ID: `keyterm:Name`); Maria (ID: `person:Mary`); menggenapi (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod`); Betlehem (ID: `place:Bethlehem`); Arkhelaus (ID: `person:Archelaus`); Mesir (ID: `place:Egypt`); menyembah (ID: `keyterm:BowDown`); Yusuf (ID: `person:Joseph.4`); Money Box (ID: `realia:MoneyBox`); Myrrh (ID: `realia:Myrrh`); Frankincense (ID: `flora:Frankincense`); Nazaret (ID: `place:Nazareth`); Myrrh (ID: `flora:Myrrh`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Yeremia (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** Yehuda (ID: `place:Judea`); Yohanes (ID: `person:John`); Winnowing Fork (ID: `realia:WinnowingFork`); pembaptis (ID: `keyterm:Baptist`); Sandal (ID: `realia:Sandal`); Belt (ID: `realia:Belt`); Leather (ID: `realia:Leather`); Threshing Floor (ID: `realia:ThreshingFloor`); Locust (ID: `fauna:Locust`); Yesaya (ID: `person:Isaiah`)
...
* **Associated ACAI Concepts:** baptisan (ID: `keyterm:Baptism`); Dove (ID: `fauna:Dove`); Yordan (ID: `place:Jordan`)
...
* **Associated ACAI Concepts:** Pinnacle (ID: `realia:Pinnacle`); mencobai (ID: `keyterm:PutToTheTest`); menyembah (ID: `keyterm:BowDown`); firman (ID: `keyterm:Word`)
...
* **Associated ACAI Concepts:** Galilea (ID: `place:Galilee`); Nazaret (ID: `place:Nazareth`); memberitakan (ID: `keyterm:Proclaim`); bertobat (ID: `keyterm:Repent`)
...
* **Associated ACAI Concepts:** Fishnet (ID: `realia:Fishnet`); Dekapolis (ID: `place:Decapolis`); Galilea (ID: `place:Galilee`); Sea of Galilee (ID: `place:GalileeSea`); Zebedeus (ID: `person:Zebedee`); Andreas (ID: `person:Andrew`); Yakobus (ID: `person:James`); Yohanes (ID: `person:John.2`); Synagogue (ID: `realia:Synagogue`); injil (ID: `keyterm:GoodNews`)
...
* **Associated ACAI Concepts:** berbahagialah (ID: `keyterm:Happy`); belas kasihan (ID: `keyterm:Mercy`); hati (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** hukum (ID: `keyterm:Law`); perintah (ID: `keyterm:Commandment`)
...
* **Associated ACAI Concepts:** Mile (ID: `realia:Mile`); neraka (ID: `keyterm:Gehenna`); persundalan (ID: `keyterm:Fornication`); Quadrans (ID: `realia:Quadrans`); pengadilan (ID: `keyterm:CourtCase`); Footstool (ID: `realia:Footstool`); memperdamaikan (ID: `keyterm:Reconcile`); sorgawi (ID: `keyterm:Heavenly`); sumpah (ID: `keyterm:Oath`); Cloak (ID: `realia:Cloak`); yang baik (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); mengampuni (ID: `keyterm:Forgive`); sorga (ID: `keyterm:Heaven`); Inner Room (ID: `realia:InnerRoom`); membawa masuk (ID: `keyterm:BringIn`); kerajaan (ID: `keyterm:Kingdom`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** berpuasa (ID: `keyterm:Fast`); Oven (ID: `realia:Oven`); Moth (ID: `fauna:Moth`); Clothing (ID: `realia:Clothing`); Cubit (ID: `realia:Cubit.2`); kurang percaya (ID: `keyterm:HavingLittleFaith`); Wild Flower (ID: `flora:WildFlower`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Centurion With Sick Servant (ID: `person:Centurion.2`); membersihkan (ID: `keyterm:Cleanse.2`); percaya (ID: `keyterm:Believe`); kerasukan setan (ID: `keyterm:DemonPossessed`); penyakit kulit menular (ID: `keyterm:InfectiousSkinDisease`)
...
* **Associated ACAI Concepts:** Jackal (ID: `fauna:Jackal`); kerasukan setan (ID: `keyterm:DemonPossessed`); Religious Official (ID: `person:ReligiousOfficial`); A Disciple (ID: `person:GenericDisciple`); kurang percaya (ID: `keyterm:HavingLittleFaith`); memerintahkan (ID: `keyterm:Command`)
...
* **Associated ACAI Concepts:** pemungut cukai (ID: `keyterm:TaxCollector`); Patch (ID: `realia:Patch`); Matius (ID: `person:Matthew`); Must (ID: `realia:Must`); belas kasihan (ID: `keyterm:Mercy`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Tassel (ID: `realia:Tassel`); rahmat (ID: `keyterm:Affection`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Zelot (ID: `group:Zealot`); Bag (ID: `realia:Bag`); Simon (ID: `person:Simon.2`); Bartolomeus (ID: `person:Bartholomew`); Alfeus (ID: `person:Alphaeus`); Yakobus (ID: `person:James.2`); Yudas (ID: `person:Judas`); Tomas (ID: `person:Thomas`); Filipus (ID: `person:Philip`); Yudas (ID: `person:Judas.2`); memperdamaikan (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** Sparrow (ID: `fauna:Sparrow`); Assarion (ID: `realia:Assarion`); Wolf (ID: `fauna:Wolf`); neraka (ID: `keyterm:Gehenna`)
...
* **Associated ACAI Concepts:** pembaptis (ID: `keyterm:Baptist`); Reed (ID: `flora:Reed`); Yohanes (ID: `person:John`)
...
* **Associated ACAI Concepts:** Khorazim (ID: `place:Chorazin`); Yoke (ID: `realia:Yoke`); alam maut (ID: `keyterm:WorldOfTheDead`); Disaster (ID: `keyterm:Disaster`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** Be Lawful (ID: `keyterm:Lawful`); Wheat (ID: `flora:Wheat`); sabat (ID: `keyterm:Sabbath`)
...
* **Associated ACAI Concepts:** menentang (ID: `keyterm:Condemn`); menghujat (ID: `keyterm:Blaspheme`); penghakiman (ID: `keyterm:Judgment`)
...
* **Associated ACAI Concepts:** Yunus (ID: `person:Jonah.2`); Niniwe (ID: `group:Nineveh`); tanda (ID: `keyterm:Example`); negeri (ID: `person:QueenOfSheba`)
...
* **Associated ACAI Concepts:** perumpamaan (ID: `keyterm:Parable`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** Weed (ID: `flora:Weed`); Saton (ID: `realia:Saton`); Storeroom (ID: `realia:Storeroom`); Mustard (ID: `flora:Mustard`); Dragnet (ID: `realia:Dragnet`); perumpamaan (ID: `keyterm:Parable`); Grain (ID: `flora:Grain`); kerajaan (ID: `keyterm:Kingdom`); sorga (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod.2`); Herodias (ID: `person:Herodias`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Filipus (ID: `person:Philip.2`); Simon (ID: `person:Simon.3`); Prison (ID: `realia:Prison`); Yudas (ID: `person:Jude`); Yakobus (ID: `person:James.3`); tidak percaya (ID: `keyterm:Disbelieve`); Yohanes (ID: `person:John`)
...
* **Associated ACAI Concepts:** Genesaret (ID: `place:Gennesaret`); kurang percaya (ID: `keyterm:HavingLittleFaith`); percayalah (ID: `keyterm:CheerUp`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Syrophonecian Woman (ID: `person:SyrophonecianWoman`); Dog (ID: `fauna:Dog`); Sidon (ID: `place:Sidon`); Tirus (ID: `place:Tyre`)
...
* **Associated ACAI Concepts:** Petrus (ID: `person:Peter`); Kaisarea (ID: `place:CaesareaPhilippi`); Key (ID: `realia:Key`); jemaat (ID: `keyterm:Church`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Elia (ID: `person:Elijah`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Stater (ID: `realia:Stater`); Two-Drachma Piece (ID: `realia:Two-drachmaPiece`); Fishhook (ID: `realia:Fishhook`); Mustard (ID: `flora:Mustard`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** sorga (ID: `keyterm:Heaven`); menyesatkan (ID: `keyterm:CauseToStumble`); penyesatan (ID: `keyterm:StumblingBlock`)
...
* **Associated ACAI Concepts:** berhutang (ID: `keyterm:Owe`); saksi (ID: `keyterm:Witness`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** sia, sia (ID: `keyterm:Idle`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Yerusalem (ID: `place:Jerusalem`); melayani (ID: `keyterm:Serve`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); hosana (ID: `keyterm:Hosanna`); Yerusalem (ID: `place:Jerusalem`); Seat (ID: `realia:Seat`); Betfage (ID: `place:Bethphage`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** pemungut cukai (ID: `keyterm:TaxCollector`); membuang (ID: `keyterm:Reject`); Cornerstone (ID: `realia:Cornerstone`); Winepress (ID: `realia:Winepress`); Tower (ID: `realia:Tower`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Herodians (ID: `group:Herodian`); Sadducees (ID: `group:Sadducee`); Denarius (ID: `realia:Denarius`); Money (ID: `realia:Money`); Israel (ID: `person:Israel`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** perintah (ID: `keyterm:Commandment`); pikiran (ID: `keyterm:Mind.2`); hati (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** Dill (ID: `flora:Dill`); Phylactery (ID: `realia:Phylactery`); Mint (ID: `flora:Mint`); neraka (ID: `keyterm:Gehenna`); Zakharia (ID: `person:Zechariah.12`); Seat (ID: `realia:Seat`); Cumin (ID: `flora:Cumin`); Mosquito (ID: `fauna:Mosquito`); Plate (ID: `realia:Plate.2`); kemunafikan (ID: `keyterm:Hypocrisy`); suci (ID: `keyterm:Clean`); Yoyada (ID: `person:Jehoiada.2`); Disaster (ID: `keyterm:Disaster`); Pharisees (ID: `group:Pharisee`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Nuh (ID: `person:Noah`); Inner Room (ID: `realia:InnerRoom`); Housetop (ID: `realia:Housetop`); Vulture (ID: `fauna:Vulture`); Trumpet (ID: `realia:Trumpet`); Daniel (ID: `person:Daniel.3`); kesetiaan (ID: `keyterm:Faithfulness`); sorga (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** Simon (ID: `person:Simon.4`); Alabaster Jar (ID: `realia:AlabasterJar`); Betania (ID: `place:Bethany`); Yudas (ID: `person:Judas.2`)
...
* **Associated ACAI Concepts:** Bowl (ID: `realia:Bowl.2`); darah (ID: `keyterm:Blood`); tubuh (ID: `keyterm:Body.3`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Getsemani (ID: `place:Gethsemane`); Rooster (ID: `fauna:Rooster`); roh (ID: `keyterm:Spirit.2`); berdoa (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** menggenapi (ID: `keyterm:Happen`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Kayafas (ID: `person:Caiaphas`); Courtyard (ID: `realia:Courtyard`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Akeldama (ID: `place:Akeldama`); pemeliharaanmu (ID: `place:Corban`); Pilatus (ID: `person:Pilate`)
...
* **Associated ACAI Concepts:** Judgment Seat (ID: `realia:JudgmentSeat`); Barabas (ID: `person:Barabbas`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Simon (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); Kirene (ID: `place:Cyrene`); Crown (ID: `realia:Crown.2`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Crown (ID: `realia:Crown`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Maria (ID: `person:Mary.2`); Yusuf (ID: `person:Joseph.6`); Yusuf (ID: `person:Joseph.5`); Yakobus (ID: `person:James.4`); Maria (ID: `person:Marymagdalene`); Arimatea (ID: `place:Arimathea`); Sour Wine (ID: `realia:SourWine`); Zebedeus (ID: `person:Zebedee`); Seal (ID: `realia:Seal`); Curtain (ID: `realia:Curtain`); Reed (ID: `flora:Reed`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Angels (ID: `group:Angels`); kebangkitan (ID: `keyterm:Resurrection`); minggu (ID: `keyterm:Week`)
...
* **Associated ACAI Concepts:** menjadi murid (ID: `keyterm:Disciple`); kekuasaan (ID: `keyterm:Authority.2`)
