...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Daud (ID: `person:David`); Abraham (ID: `person:Abraham`); Babel (ID: `place:Babylon`); Zerubabel (ID: `person:Zerubbabel.2`); Yakub (ID: `person:Jacob.2`); Azor (ID: `person:Azor`); Eliud (ID: `person:Eliud`); Hizkia (ID: `person:Hezekiah`); memperanakkan (ID: `person:Salmon`); Ram (ID: `person:Ram`); raja (ID: `person:Jehoiachin`); Salomo (ID: `person:Solomon`); Yosia (ID: `person:Josiah`); Asa (ID: `person:Asa`); Uzia (ID: `person:Uzziah`); Isai (ID: `person:Jesse`); Yehuda (ID: `person:Judah.4`); Eleazar (ID: `person:Eleazar`); Yusuf (ID: `person:Joseph.4`); Zerah (ID: `person:Zerah.3`); Akhim (ID: `person:Achim`); Matan (ID: `person:Matthan`); Amon (ID: `person:Amon.3`); Yoram (ID: `person:Jehoram`); Nahason (ID: `person:Nahshon`); Ahas (ID: `person:Ahaz`); Obed (ID: `person:Obed`); Boas (ID: `person:Boaz`); Rahab (ID: `person:Rahab`); Tamar (ID: `person:Tamar`); Aminadab (ID: `person:Amminadab`); Rehabeam (ID: `person:Rehoboam`); Hezron (ID: `person:Hezron.2`); Abia (ID: `person:Abijah.4`); Abihud (ID: `person:Abiud`); Ishak (ID: `person:Isaac`); Uria (ID: `person:Uriah`); Yosafat (ID: `person:Jehoshaphat.3`); Israel (ID: `person:Israel`); Peres (ID: `person:Perez`); Zadok (ID: `person:Zadok`); Yotam (ID: `person:Jotham.2`); Elyakim (ID: `person:Eliakim`); Rut (ID: `person:Ruth`); Maria (ID: `person:Mary`); Sealtiel (ID: `person:Shealtiel.2`); Manasye (ID: `person:Manasseh.2`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Yusuf (ID: `person:Joseph.4`); Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); Maria (ID: `person:Mary`); An Angel (ID: `deity:Angel`); Roh (ID: `deity:HolySpirit`); menggenapi (ID: `keyterm:Happen`); Daud (ID: `person:David`); bertunangan (ID: `keyterm:Engaged`); keselamatan (ID: `keyterm:Salvation`); berbuat dosa (ID: `keyterm:Sin`); takut (ID: `keyterm:Fear`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
...
* **Associated Passages:** Matius 2:1-23
* **Associated Articles:** Orang-orang majus (ID: `203168@BiblicaStudyNotesKeyTerms`); Kaisar (ID: `203169@BiblicaStudyNotesKeyTerms`); Yudea (ID: `203170@BiblicaStudyNotes`); Galilea (ID: `203171@BiblicaStudyNotesKeyTerms`); Mesir (ID: `203386@BiblicaStudyNotesKeyTerms`); Raja (ID: `203465@BiblicaStudyNotesKeyTerms`); Betlehem (ID: `203577@BiblicaStudyNotesKeyTerms`); Herodes Agung (ID: `203693@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Herodes (ID: `person:Herod`); Betlehem (ID: `place:Bethlehem`); Mesir (ID: `place:Egypt`); menyembah (ID: `keyterm:BowDown`); Yehuda (ID: `place:Judea`); Tuhan (ID: `deity:Lord`); menggenapi (ID: `keyterm:Happen`); Israel (ID: `person:Israel`); Yusuf (ID: `person:Joseph.4`); Yerusalem (ID: `place:Jerusalem`); Yesus (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Arkhelaus (ID: `person:Archelaus`); Yeremia (ID: `person:Jeremiah.6`); Nazaret (ID: `place:Nazareth`); Galilea (ID: `place:Galilee`); A Priest (ID: `person:GenericPriest`); Maria (ID: `person:Mary`); Ramah (ID: `place:Ramah.2`); meminta (ID: `keyterm:AskFor`); kehidupan (ID: `keyterm:Life`); Yehuda (ID: `person:Judah.4`); takut (ID: `keyterm:Fear`); Priests (ID: `group:GenericPriests`); Religious Officials (ID: `group:ReligiousOfficials`); persembahan (ID: `keyterm:Offering`); menasihati (ID: `keyterm:Encourage`); Jews (ID: `group:Jews`); Rahel (ID: `person:Rachel`); Frankincense (ID: `flora:Frankincense`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Money Box (ID: `realia:MoneyBox`); House (ID: `realia:House`); Incense (ID: `realia:Incense`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated Passages:** Matius 3:1-12
...
* **Associated ACAI Concepts:** baptisan (ID: `keyterm:Baptism`); bertobat (ID: `keyterm:Repent`); Yehuda (ID: `place:Judea`); Yohanes (ID: `person:John`); Yordan (ID: `place:Jordan`); Tuhan (ID: `deity:Lord`); Yesaya (ID: `person:Isaiah`); pembaptis (ID: `keyterm:Baptist`); bersihkan (ID: `keyterm:CleanOut`); berbuat dosa (ID: `keyterm:Sin`); Abraham (ID: `person:Abraham`); Sadducees (ID: `group:Sadducee`); sorga (ID: `keyterm:Heaven`); kebenaran (ID: `keyterm:Straightness`); Yerusalem (ID: `place:Jerusalem`); Roh (ID: `deity:HolySpirit`); Pharisees (ID: `group:Pharisee`); kerajaan (ID: `keyterm:Kingdom`); memberitakan (ID: `keyterm:Proclaim`); Belt (ID: `realia:Belt`); Locust (ID: `fauna:Locust`); Sandal (ID: `realia:Sandal`); Winnowing Fork (ID: `realia:WinnowingFork`); Threshing Floor (ID: `realia:ThreshingFloor`); Leather (ID: `realia:Leather`); Bag (ID: `realia:Bag`); Axe (ID: `realia:Axe`); Bee (ID: `fauna:Bee`); Camel (ID: `fauna:Camel`); Wheat (ID: `flora:Wheat`); Clothing (ID: `realia:Clothing`); Grain (ID: `flora:Grain`); Barn (ID: `realia:Barn`); Snake (ID: `fauna:Snake`)
...
* **Associated Passages:** Matius 3:13-17
...
* **Associated ACAI Concepts:** baptisan (ID: `keyterm:Baptism`); Yesus (ID: `person:Jesus.2`); sorga (ID: `keyterm:Heaven`); Yohanes (ID: `person:John`); Yordan (ID: `place:Jordan`); Galilea (ID: `place:Galilee`); kekasih (ID: `keyterm:Beloved`); Tuhan (ID: `deity:Lord`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Roh (ID: `deity:HolySpirit`); menggenapi (ID: `keyterm:Happen`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`); menyembah (ID: `keyterm:BowDown`); mencobai (ID: `keyterm:PutToTheTest`); memerintahkan (ID: `keyterm:Command`); melayani (ID: `keyterm:Serve`); An Angel (ID: `deity:Angel`); firman (ID: `keyterm:Word`); imamat (ID: `keyterm:Priesthood`); kemuliaan (ID: `keyterm:Glory`); keahlian (ID: `keyterm:Ability`); berpuasa (ID: `keyterm:Fast`); Iblis (ID: `deity:Satan`); kehidupan (ID: `keyterm:Life`); Roh (ID: `deity:HolySpirit`); khusus (ID: `keyterm:Holy`); kerajaan (ID: `keyterm:Kingdom`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** Matius 4:12-17
...
* **Associated ACAI Concepts:** Galilea (ID: `place:Galilee`); Naftali (ID: `person:Naphtali`); Zebulon (ID: `person:Zebulun`); Zebulon (ID: `group:Zebulun`); bertobat (ID: `keyterm:Repent`); Nazaret (ID: `place:Nazareth`); memberitakan (ID: `keyterm:Proclaim`); Yesus (ID: `person:Jesus.2`); Kapernaum (ID: `place:Capernaum`); kerajaan (ID: `keyterm:Kingdom`); Yordan (ID: `place:Jordan`); Yesaya (ID: `person:Isaiah`); Gentiles (ID: `group:Gentile`); menggenapi (ID: `keyterm:Happen`); sorga (ID: `keyterm:Heaven`); Yohanes (ID: `person:John`)
...
* **Associated Passages:** Matius 4:18-25
...
* **Associated ACAI Concepts:** Casting Net (ID: `realia:CastingNet`); Galilea (ID: `place:Galilee`); melayani (ID: `keyterm:Serve`); Andreas (ID: `person:Andrew`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Yohanes (ID: `person:John.2`); injil (ID: `keyterm:GoodNews`); Sea of Galilee (ID: `place:GalileeSea`); Zebedeus (ID: `person:Zebedee`); Yakobus (ID: `person:James`); Dekapolis (ID: `place:Decapolis`); kerasukan setan (ID: `keyterm:DemonPossessed`); Yehuda (ID: `place:Judea`); Yordan (ID: `place:Jordan`); Petrus (ID: `person:Peter`); Yerusalem (ID: `place:Jerusalem`); kerajaan (ID: `keyterm:Kingdom`); memberitakan (ID: `keyterm:Proclaim`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** berbahagialah (ID: `keyterm:Happy`); sorga (ID: `keyterm:Heaven`); kerajaan (ID: `keyterm:Kingdom`); Tuhan (ID: `deity:Lord`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); belas kasihan (ID: `keyterm:Mercy`); hati (ID: `keyterm:Heart`); menjadi murid (ID: `keyterm:Disciple`); suci (ID: `keyterm:Clean`); roh (ID: `keyterm:Spirit.2`); meminta (ID: `keyterm:AskFor`); menasihati (ID: `keyterm:Encourage`)
...
* **Associated Passages:** Matius 5:13-20
...
* **Associated ACAI Concepts:** sorga (ID: `keyterm:Heaven`); hukum (ID: `keyterm:Law`); kerajaan (ID: `keyterm:Kingdom`); perintah (ID: `keyterm:Commandment`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); amin! (ID: `keyterm:Surely`); kemuliaan (ID: `keyterm:Glory`); Pharisees (ID: `group:Pharisee`); Tuhan (ID: `deity:Lord`); keahlian (ID: `keyterm:Ability`); Lampstand (ID: `realia:Lampstand.2`); House (ID: `realia:House`)
...
* **Associated Passages:** Matius 5:21-48
* **Associated Articles:** Sesama (ID: `203505@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); neraka (ID: `keyterm:Gehenna`); persundalan (ID: `keyterm:Fornication`); Hell (ID: `place:Hell`); kasihi (ID: `keyterm:Love`); pengadilan (ID: `keyterm:CourtCase`); sorga (ID: `keyterm:Heaven`); tubuh (ID: `keyterm:Body.3`); penghakiman (ID: `keyterm:Judgment`); menyesatkan (ID: `keyterm:CauseToStumble`); persembahan (ID: `keyterm:Offering`); sumpah (ID: `keyterm:Oath`); yang baik (ID: `keyterm:Good`); memperdamaikan (ID: `keyterm:Reconcile`); sorgawi (ID: `keyterm:Heavenly`); amin! (ID: `keyterm:Surely`); pemungut cukai (ID: `keyterm:TaxCollector`); hati (ID: `keyterm:Heart`); Yerusalem (ID: `place:Jerusalem`); memutuskan (ID: `keyterm:Decided`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); berdoa (ID: `keyterm:Pray`); Cloak (ID: `realia:Cloak`); Quadrans (ID: `realia:Quadrans`); Footstool (ID: `realia:Footstool`); Mile (ID: `realia:Mile`); Tunic (ID: `realia:Tunic.2`); Throne (ID: `realia:Throne`); Prison (ID: `realia:Prison`)
...
* **Associated Passages:** Matius 6:1-15
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); mengampuni (ID: `keyterm:Forgive`); sorga (ID: `keyterm:Heaven`); amin! (ID: `keyterm:Surely`); Synagogue (ID: `realia:Synagogue`); membawa masuk (ID: `keyterm:BringIn`); kerajaan (ID: `keyterm:Kingdom`); kemuliaan (ID: `keyterm:Glory`); menyelamatkan (ID: `keyterm:Deliver`); persahabatan (ID: `keyterm:Friendship`); mencobai (ID: `keyterm:PutToTheTest`); bersalah (ID: `keyterm:Wrong`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); sorgawi (ID: `keyterm:Heavenly`); khusus (ID: `keyterm:Holy`); nama (ID: `keyterm:Name`); Inner Room (ID: `realia:InnerRoom`); Trumpet (ID: `realia:Trumpet`); Cornerstone (ID: `realia:Cornerstone`); Door (ID: `realia:Door`)
...
* **Associated Passages:** Matius 6:16-34
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berpuasa (ID: `keyterm:Fast`); tubuh (ID: `keyterm:Body.3`); sorga (ID: `keyterm:Heaven`); sorgawi (ID: `keyterm:Heavenly`); Clothing (ID: `realia:Clothing`); Moth (ID: `fauna:Moth`); kurang percaya (ID: `keyterm:HavingLittleFaith`); amin! (ID: `keyterm:Surely`); kemuliaan (ID: `keyterm:Glory`); kasihi (ID: `keyterm:Love`); melayani (ID: `keyterm:Serve.2`); hati (ID: `keyterm:Heart`); Salomo (ID: `person:Solomon`); diurapi (ID: `keyterm:Anointed`); kehidupan (ID: `keyterm:Life`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kerajaan (ID: `keyterm:Kingdom`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Oven (ID: `realia:Oven`); Barn (ID: `realia:Barn`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Beam (ID: `realia:Beam`); memutuskan (ID: `keyterm:Decided`); khusus (ID: `keyterm:Holy`); hukum (ID: `keyterm:Law`); Tuhan (ID: `deity:Lord`); penghakiman (ID: `keyterm:Judgment`); sorga (ID: `keyterm:Heaven`); Fish (ID: `fauna:Fish`); Snake (ID: `fauna:Snake`); Jackal (ID: `fauna:Jackal`); Dog (ID: `fauna:Dog`); Pig (ID: `fauna:Pig`)
...
* **Associated Passages:** Matius 7:13-23
* **Associated Articles:** Hidup yang kekal (ID: `203704@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); tak kenal hukum (ID: `keyterm:Lawless`); menghancurkan (ID: `keyterm:Destroy`); keahlian (ID: `keyterm:Ability`); sorga (ID: `keyterm:Heaven`); Tuhan (ID: `deity:Lord`); kehidupan (ID: `keyterm:Life`); Demons (ID: `deity:Demons`); nama (ID: `keyterm:Name`); kerajaan (ID: `keyterm:Kingdom`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`); Clothing (ID: `realia:Clothing`); Sheep (ID: `fauna:Lamb`); Wolf (ID: `fauna:Wolf`)
...
* **Associated Passages:** Matius 7:24-29
* **Associated Articles:** Rabi (ID: `203181@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** House (ID: `realia:House`); Yesus (ID: `person:Jesus.2`); kekuasaan (ID: `keyterm:Authority.2`); keahlian (ID: `keyterm:Ability`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); melayani (ID: `keyterm:Serve`); percaya (ID: `keyterm:Believe`); membersihkan (ID: `keyterm:Cleanse.2`); kerajaan (ID: `keyterm:Kingdom`); Israel (ID: `person:Israel`); House (ID: `realia:House`); kerasukan setan (ID: `keyterm:DemonPossessed`); Centurion With Sick Servant (ID: `person:Centurion.2`); penyakit kulit menular (ID: `keyterm:InfectiousSkinDisease`); amin! (ID: `keyterm:Surely`); memerintahkan (ID: `keyterm:Command`); bersaksi (ID: `keyterm:BearWitness`); menyembah (ID: `keyterm:BowDown`); Abraham (ID: `person:Abraham`); keahlian (ID: `keyterm:Ability`); sorga (ID: `keyterm:Heaven`); kertak (ID: `keyterm:OuterDarkness`); Kapernaum (ID: `place:Capernaum`); Yesaya (ID: `person:Isaiah`); Musa (ID: `person:Moses`); menggenapi (ID: `keyterm:Happen`); Petrus (ID: `person:Peter`); meminta (ID: `keyterm:AskFor`); Ishak (ID: `person:Isaac`); kekuasaan (ID: `keyterm:Authority.2`); persembahan (ID: `keyterm:Offering`); Housetop (ID: `realia:Housetop`)
...
* **Associated Passages:** Matius 8:18-34

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); kerasukan setan (ID: `keyterm:DemonPossessed`); menjadi murid (ID: `keyterm:Disciple`); meminta (ID: `keyterm:AskFor`); Ship (ID: `realia:Ship`); kurang percaya (ID: `keyterm:HavingLittleFaith`); memerintahkan (ID: `keyterm:Command`); A Disciple (ID: `person:GenericDisciple`); Religious Official (ID: `person:ReligiousOfficial`); keselamatan (ID: `keyterm:Salvation`); kekuasaan (ID: `keyterm:Authority.2`); Gerasa (ID: `place:Gerasa`); sorga (ID: `keyterm:Heaven`); Grave (ID: `realia:Grave`)
...
* **Associated Passages:** Matius 9:1-17
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); berbuat dosa (ID: `keyterm:Sin`); mengampuni (ID: `keyterm:Forgive`); menjadi murid (ID: `keyterm:Disciple`); House (ID: `realia:House`); pemungut cukai (ID: `keyterm:TaxCollector`); keahlian (ID: `keyterm:Ability`); berpuasa (ID: `keyterm:Fast`); kekuasaan (ID: `keyterm:Authority.2`); Pharisees (ID: `group:Pharisee`); Bed (ID: `realia:Bed`); Temple (ID: `realia:Temple`); Matius (ID: `person:Matthew`); belas kasihan (ID: `keyterm:Mercy`); kemuliaan (ID: `keyterm:Glory`); percaya (ID: `keyterm:Believe`); percayalah (ID: `keyterm:CheerUp`); Tuhan (ID: `deity:Lord`); hati (ID: `keyterm:Heart`); Yohanes (ID: `person:John`); takut (ID: `keyterm:Fear`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); Be Healthy (ID: `keyterm:Healthy`); rumah cukai (ID: `keyterm:TaxOffice`); persembahan (ID: `keyterm:Offering`); menghujat (ID: `keyterm:Blaspheme`); Must (ID: `realia:Must`); Patch (ID: `realia:Patch`); Skin-Bottle (ID: `realia:Skin-bottle`); Ship (ID: `realia:Ship`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`)
...
* **Associated Passages:** Matius 9:18-38
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); keselamatan (ID: `keyterm:Salvation`); Demons (ID: `deity:Demons`); menjadi murid (ID: `keyterm:Disciple`); Cloak (ID: `realia:Cloak`); House (ID: `realia:House`); rahmat (ID: `keyterm:Affection`); kerasukan setan (ID: `keyterm:DemonPossessed`); injil (ID: `keyterm:GoodNews`); menyembah (ID: `keyterm:BowDown`); percayalah (ID: `keyterm:CheerUp`); belas kasihan (ID: `keyterm:Mercy`); kehidupan (ID: `keyterm:Life`); meminta (ID: `keyterm:AskFor`); Daud (ID: `person:David`); melayani (ID: `keyterm:Serve`); Pharisees (ID: `group:Pharisee`); kerajaan (ID: `keyterm:Kingdom`); memberitakan (ID: `keyterm:Proclaim`); berdarah (ID: `keyterm:Bleed`); Israel (ID: `person:Israel`); Tassel (ID: `realia:Tassel`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Flute (ID: `realia:Flute`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); melayani (ID: `keyterm:Serve`); Bag (ID: `realia:Bag`); Bartolomeus (ID: `person:Bartholomew`); Tomas (ID: `person:Thomas`); Alfeus (ID: `person:Alphaeus`); Yudas (ID: `person:Judas.2`); Yakobus (ID: `person:James.2`); Yudas (ID: `person:Judas`); Zelot (ID: `group:Zealot`); Simon (ID: `person:Simon.2`); memperdamaikan (ID: `keyterm:Peace`); Filipus (ID: `person:Philip`); Matius (ID: `person:Matthew`); Gomora (ID: `place:Gomorrah`); Yohanes (ID: `person:John.2`); amin! (ID: `keyterm:Surely`); Samaria (ID: `place:Samaria`); Zebedeus (ID: `person:Zebedee`); keahlian (ID: `keyterm:Ability`); pemungut cukai (ID: `keyterm:TaxCollector`); sorga (ID: `keyterm:Heaven`); Yakobus (ID: `person:James`); Sodom (ID: `place:Sodom`); penghakiman (ID: `keyterm:Judgment`); Petrus (ID: `person:Peter`); Demons (ID: `deity:Demons`); kekuasaan (ID: `keyterm:Authority.2`); pengadilan (ID: `keyterm:CourtCase`); Samaritans (ID: `group:Samaritan`); membersihkan (ID: `keyterm:Cleanse.2`); Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); kebangkitan (ID: `keyterm:Resurrection`); nama (ID: `keyterm:Name`); kerajaan (ID: `keyterm:Kingdom`); memberitakan (ID: `keyterm:Proclaim`); Andreas (ID: `person:Andrew`); Gentiles (ID: `group:Gentile`); Israel (ID: `person:Israel`); Staff (ID: `realia:Staff`); Belt (ID: `realia:Belt`); Tunic (ID: `realia:Tunic.2`); Sandal (ID: `realia:Sandal`); Sheep (ID: `fauna:Lamb`)
...
* **Associated Passages:** Matius 10:16-42
* **Associated Articles:** Diperlakukan dengan buruk (ID: `203189@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); takut (ID: `keyterm:Fear`); menjadi murid (ID: `keyterm:Disciple`); nama (ID: `keyterm:Name`); amin! (ID: `keyterm:Surely`); sorga (ID: `keyterm:Heaven`); Sparrow (ID: `fauna:Sparrow`); neraka (ID: `keyterm:Gehenna`); keselamatan (ID: `keyterm:Salvation`); memerintahkan (ID: `keyterm:Command`); Hell (ID: `place:Hell`); bersaksi (ID: `keyterm:BearWitness`); persahabatan (ID: `keyterm:Friendship`); tubuh (ID: `keyterm:Body.3`); Iblis (ID: `deity:Satan`); kehidupan (ID: `keyterm:Life`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Roh (ID: `deity:HolySpirit`); memperdamaikan (ID: `keyterm:Peace`); memberitakan (ID: `keyterm:Proclaim`); Gentiles (ID: `group:Gentile`); Israel (ID: `person:Israel`); Assarion (ID: `realia:Assarion`); Wolf (ID: `fauna:Wolf`); Dove (ID: `fauna:Dove`); Sheep (ID: `fauna:Lamb`); Cross (ID: `realia:Cross`); Snake (ID: `fauna:Snake`); Synagogue (ID: `realia:Synagogue`); Housetop (ID: `realia:Housetop`)
...
* **Associated Passages:** Matius 11:1-19
* **Associated Articles:** Bertobat (ID: `203481@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yohanes (ID: `person:John`); Yesus (ID: `person:Jesus.2`); pembaptis (ID: `keyterm:Baptist`); sorga (ID: `keyterm:Heaven`); menjadi murid (ID: `keyterm:Disciple`); kerajaan (ID: `keyterm:Kingdom`); amin! (ID: `keyterm:Surely`); injil (ID: `keyterm:GoodNews`); pemungut cukai (ID: `keyterm:TaxCollector`); Elia (ID: `person:Elijah`); Demons (ID: `deity:Demons`); hukum (ID: `keyterm:Law`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); membersihkan (ID: `keyterm:Cleanse.2`); berbahagialah (ID: `keyterm:Happy`); An Angel (ID: `deity:Angel`); kebangkitan (ID: `keyterm:Resurrection`); memberitakan (ID: `keyterm:Proclaim`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); Reed (ID: `flora:Reed`); House (ID: `realia:House`); Prison (ID: `realia:Prison`); Flute (ID: `realia:Flute`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** Matius 11:20-30
* **Associated Articles:** Istirahat (ID: `203347@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); Tirus (ID: `place:Tyre`); sorga (ID: `keyterm:Heaven`); Sodom (ID: `place:Sodom`); penghakiman (ID: `keyterm:Judgment`); bertobat (ID: `keyterm:Repent`); Sidon (ID: `place:Sidon`); pengadilan (ID: `keyterm:CourtCase`); Yoke (ID: `realia:Yoke`); alam maut (ID: `keyterm:WorldOfTheDead`); Disaster (ID: `keyterm:Disaster`); Khorazim (ID: `place:Chorazin`); Betsaida (ID: `place:Bethsaida`); Hell (ID: `place:Hell`); Kapernaum (ID: `place:Capernaum`); hati (ID: `keyterm:Heart`); yang baik (ID: `keyterm:Good`); Yesus (ID: `person:Jesus.2`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated Passages:** Matius 12:1-14
* **Associated Articles:** Hari Sabat (ID: `203348@BiblicaStudyNotesKeyTerms`); Imam (ID: `203468@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** sabat (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); Temple (ID: `realia:Temple`); menjadi murid (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); Sheep (ID: `fauna:Lamb`); Yesus (ID: `person:Jesus.2`); Daud (ID: `person:David`); belas kasihan (ID: `keyterm:Mercy`); hukum (ID: `keyterm:Law`); pencemaran (ID: `keyterm:Defilement`); persembahan (ID: `keyterm:Offering`); menentang (ID: `keyterm:Condemn`); Tuhan (ID: `deity:Lord`); Wheat (ID: `flora:Wheat`); Synagogue (ID: `realia:Synagogue`); Grain (ID: `flora:Grain`); House (ID: `realia:House`)
...
* **Associated Passages:** Matius 12:15-21

* **Associated ACAI Concepts:** Gentiles (ID: `group:Gentile`); penghakiman (ID: `keyterm:Judgment`); Yesus (ID: `person:Jesus.2`); melayani (ID: `keyterm:Serve`); nama (ID: `keyterm:Name`); memerintahkan (ID: `keyterm:Command`); Yesaya (ID: `person:Isaiah`); kekasih (ID: `keyterm:Beloved`); harapan (ID: `keyterm:Hope`); Roh (ID: `deity:HolySpirit`); menggenapi (ID: `keyterm:Happen`); Reed (ID: `flora:Reed`); Lamp (ID: `realia:Lamp`)
...
* **Associated Passages:** Matius 12:22-37
* **Associated Articles:** Hati (ID: `203554@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Iblis (ID: `deity:Satan`); Demons (ID: `deity:Demons`); Roh (ID: `deity:HolySpirit`); kerajaan (ID: `keyterm:Kingdom`); mengampuni (ID: `keyterm:Forgive`); yang baik (ID: `keyterm:Good`); menentang (ID: `keyterm:Condemn`); penghakiman (ID: `keyterm:Judgment`); menghujat (ID: `keyterm:Blaspheme`); kerasukan setan (ID: `keyterm:DemonPossessed`); sia, sia (ID: `keyterm:Idle`); firman (ID: `keyterm:Word`); berbuat dosa (ID: `keyterm:Sin`); keahlian (ID: `keyterm:Ability`); hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`); pengadilan (ID: `keyterm:CourtCase`); melayani (ID: `keyterm:Serve`); Daud (ID: `person:David`); Pharisees (ID: `group:Pharisee`); selama, lamanya (ID: `keyterm:Always`); House (ID: `realia:House`); Cobra (ID: `fauna:Cobra`); Snake (ID: `fauna:Snake`)
...
* **Associated Passages:** Matius 12:38-50
* **Associated Articles:** Hari Penghakiman (ID: `203190@BiblicaStudyNotesKeyTerms`); Percaya pada (ID: `203390@BiblicaStudyNotesKeyTerms`); Hikmat (ID: `203460@BiblicaStudyNotes`); Salomo (ID: `203608@BiblicaStudyNotesKeyTerms`); Yunus (ID: `203708@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yunus (ID: `person:Jonah.2`); tanda (ID: `keyterm:Example`); penghakiman (ID: `keyterm:Judgment`); pengadilan (ID: `keyterm:CourtCase`); Niniwe (ID: `group:Nineveh`); negeri (ID: `person:QueenOfSheba`); sorga (ID: `keyterm:Heaven`); A Group of People (ID: `group:GenericGroup`); hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`); Salomo (ID: `person:Solomon`); bertobat (ID: `keyterm:Repent`); menjadi murid (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); tidak setia (ID: `keyterm:Unfaithful`); memberitakan (ID: `keyterm:Proclaim`); Niniwe (ID: `place:Nineveh`); House (ID: `realia:House`); Fish (ID: `fauna:Fish`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** Matius 13:1-23
* **Associated Articles:** Perumpamaan (ID: `203191@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** perumpamaan (ID: `keyterm:Parable`); hati (ID: `keyterm:Heart`); kerajaan (ID: `keyterm:Kingdom`); Brier (ID: `flora:Brier`); Thistle (ID: `flora:Thistle`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); amin! (ID: `keyterm:Surely`); Cause of Joy (ID: `keyterm:CauseOfJoy`); keahlian (ID: `keyterm:Ability`); sorga (ID: `keyterm:Heaven`); A Group of Disciples (ID: `group:GenericDisciples`); Yesaya (ID: `person:Isaiah`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Yesus (ID: `person:Jesus.2`); berbahagialah (ID: `keyterm:Happy`); menjadi murid (ID: `keyterm:Disciple`); selama, lamanya (ID: `keyterm:Always`); Bird (ID: `fauna:Bird`); Rooster (ID: `fauna:Rooster`); House (ID: `realia:House`); Ship (ID: `realia:Ship`)
...
* **Associated Passages:** Matius 13:24-52

* **Associated ACAI Concepts:** kerajaan (ID: `keyterm:Kingdom`); sorga (ID: `keyterm:Heaven`); perumpamaan (ID: `keyterm:Parable`); Weed (ID: `flora:Weed`); Grain (ID: `flora:Grain`); An Angel (ID: `deity:Angel`); selama, lamanya (ID: `keyterm:Always`); Wheat (ID: `flora:Wheat`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); menjadi murid (ID: `keyterm:Disciple`); Kiln (ID: `realia:Kiln`); Grass (ID: `flora:Grass`); Cause of Joy (ID: `keyterm:CauseOfJoy`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); menggenapi (ID: `keyterm:Happen`); penyesatan (ID: `keyterm:StumblingBlock`); tak kenal hukum (ID: `keyterm:Lawless`); Yesus (ID: `person:Jesus.2`); Saton (ID: `realia:Saton`); Mustard (ID: `flora:Mustard`); Storeroom (ID: `realia:Storeroom`); Dragnet (ID: `realia:Dragnet`); House (ID: `realia:House`); Container (ID: `realia:Container`); Barn (ID: `realia:Barn`)
...
* **Associated Passages:** Matius 13:53-14:12
* **Associated Articles:** Herodes Antipas (ID: `203192@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yohanes (ID: `person:John`); Yesus (ID: `person:Jesus.2`); Herodes (ID: `person:Herod.2`); keahlian (ID: `keyterm:Ability`); Herodias (ID: `person:Herodias`); sumpah (ID: `keyterm:Oath`); pembaptis (ID: `keyterm:Baptist`); Prison (ID: `realia:Prison`); Plate (ID: `realia:Plate.2`); Filipus (ID: `person:Philip.2`); Simon (ID: `person:Simon.3`); Yakobus (ID: `person:James.3`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); tidak percaya (ID: `keyterm:Disbelieve`); Yudas (ID: `person:Jude`); Yusuf (ID: `person:Joseph.4`); Maria (ID: `person:Mary`); perumpamaan (ID: `keyterm:Parable`); takut (ID: `keyterm:Fear`); Be Lawful (ID: `keyterm:Lawful`); menjadi murid (ID: `keyterm:Disciple`); kebangkitan (ID: `keyterm:Resurrection`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated Passages:** Matius 14:13-21

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); Fish (ID: `fauna:Fish`); melayani (ID: `keyterm:Serve`); sorga (ID: `keyterm:Heaven`); memberkati (ID: `keyterm:Bless`); rahmat (ID: `keyterm:Affection`); Basket (ID: `realia:Basket`); Ship (ID: `realia:Ship`); Grass (ID: `flora:Grass`)
...
* **Associated Passages:** Matius 14:22-36

* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); Yesus (ID: `person:Jesus.2`); takut (ID: `keyterm:Fear`); menjadi murid (ID: `keyterm:Disciple`); Petrus (ID: `person:Peter`); keselamatan (ID: `keyterm:Salvation`); kurang percaya (ID: `keyterm:HavingLittleFaith`); percayalah (ID: `keyterm:CheerUp`); Genesaret (ID: `place:Gennesaret`); meminta (ID: `keyterm:AskFor`); benar (ID: `keyterm:True`); menyembah (ID: `keyterm:BowDown`); berdoa (ID: `keyterm:Pray`); Cloak (ID: `realia:Cloak`); Stade (ID: `realia:Stade`); Tassel (ID: `realia:Tassel`)
...
* **Associated Passages:** Matius 15:1-20
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); adat istiadat (ID: `keyterm:Teaching`); hati (ID: `keyterm:Heart`); pencemaran (ID: `keyterm:Defilement`); menjadi murid (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); menghujat (ID: `keyterm:Blaspheme`); perintah (ID: `keyterm:Commandment`); sembah (ID: `keyterm:Worship`); A Group of Disciples (ID: `group:GenericDisciples`); Yesaya (ID: `person:Isaiah`); Petrus (ID: `person:Peter`); Yerusalem (ID: `place:Jerusalem`); perumpamaan (ID: `keyterm:Parable`); sorgawi (ID: `keyterm:Heavenly`); Yesus (ID: `person:Jesus.2`); persembahan (ID: `keyterm:Offering`); persundalan (ID: `keyterm:Fornication`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`)
...
* **Associated Passages:** Matius 15:21-28
* **Associated Articles:** Orang bukan Yahudi (ID: `203682@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Dog (ID: `fauna:Dog`); Sidon (ID: `place:Sidon`); Tirus (ID: `place:Tyre`); Syrophonecian Woman (ID: `person:SyrophonecianWoman`); Daud (ID: `person:David`); menjadi murid (ID: `keyterm:Disciple`); kerasukan setan (ID: `keyterm:DemonPossessed`); belas kasihan (ID: `keyterm:Mercy`); meminta (ID: `keyterm:AskFor`); baik (ID: `keyterm:Honest`); menyembah (ID: `keyterm:BowDown`); Canaanites (ID: `group:Canaan`); percaya (ID: `keyterm:Believe`); Kanaan (ID: `place:Canaan`); Israel (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`)
...
* **Associated Passages:** Matius 15:29-39

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Fish (ID: `fauna:Fish`); Magadan (ID: `place:Magadan`); melayani (ID: `keyterm:Serve`); kemuliaan (ID: `keyterm:Glory`); rahmat (ID: `keyterm:Affection`); Tuhan (ID: `deity:Lord`); Sea of Galilee (ID: `place:GalileeSea`); Israel (ID: `person:Israel`); Ship (ID: `realia:Ship`); Basket (ID: `realia:Basket`)
...
* **Associated Passages:** Matius 16:1-12
* **Associated Articles:** Orang Saduki (ID: `203193@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Sadducees (ID: `group:Sadducee`); Pharisees (ID: `group:Pharisee`); tanda (ID: `keyterm:Example`); sorga (ID: `keyterm:Heaven`); Yesus (ID: `person:Jesus.2`); Basket (ID: `realia:Basket`); kurang percaya (ID: `keyterm:HavingLittleFaith`); menjadi murid (ID: `keyterm:Disciple`); Yunus (ID: `person:Jonah.2`); tidak setia (ID: `keyterm:Unfaithful`); bimbang (ID: `keyterm:Discern`)
...
* **Associated Passages:** Matius 16:13-27
* **Associated Articles:** Salib (ID: `203665@BiblicaStudyNotesKeyTerms`); Kebangkitan (ID: `203703@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Petrus (ID: `person:Peter`); menjadi murid (ID: `keyterm:Disciple`); Tuhan (ID: `deity:Lord`); kehidupan (ID: `keyterm:Life`); sorga (ID: `keyterm:Heaven`); Kaisarea (ID: `place:CaesareaPhilippi`); jemaat (ID: `keyterm:Church`); keselamatan (ID: `keyterm:Salvation`); memerintahkan (ID: `keyterm:Command`); Hell (ID: `place:Hell`); kemuliaan (ID: `keyterm:Glory`); alam maut (ID: `keyterm:WorldOfTheDead`); keahlian (ID: `keyterm:Ability`); memikirkan (ID: `keyterm:Think`); A Group of Disciples (ID: `group:GenericDisciples`); tubuh (ID: `keyterm:Body.3`); Yeremia (ID: `person:Jeremiah.6`); Iblis (ID: `deity:Satan`); Elia (ID: `person:Elijah`); Yohanes (ID: `person:John`); Yerusalem (ID: `place:Jerusalem`); meminta (ID: `keyterm:AskFor`); Yohanes (ID: `person:John.4`); pembaptis (ID: `keyterm:Baptist`); penyesatan (ID: `keyterm:StumblingBlock`); berbahagialah (ID: `keyterm:Happy`); An Angel (ID: `deity:Angel`); kebangkitan (ID: `keyterm:Resurrection`); kerajaan (ID: `keyterm:Kingdom`); darah (ID: `keyterm:Blood`); Key (ID: `realia:Key`); Cross (ID: `realia:Cross`)
...
* **Associated Passages:** Matius 16:28-17:13
* **Associated Articles:** Dunia surgawi (ID: `203664@BiblicaStudyNotesKeyTerms`); Anak Manusia (ID: `203692@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Elia (ID: `person:Elijah`); Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); Petrus (ID: `person:Peter`); takut (ID: `keyterm:Fear`); Musa (ID: `person:Moses`); Yohanes (ID: `person:John.2`); amin! (ID: `keyterm:Surely`); kebangkitan (ID: `keyterm:Resurrection`); memerintahkan (ID: `keyterm:Command`); Yakobus (ID: `person:James`); kerajaan (ID: `keyterm:Kingdom`); kekasih (ID: `keyterm:Beloved`); pembaptis (ID: `keyterm:Baptist`); Yohanes (ID: `person:John`); Tent (ID: `realia:Tent`); Clothing (ID: `realia:Clothing`)
...
* **Associated Passages:** Matius 17:14-27
* **Associated Articles:** Ujian (ID: `203398@BiblicaStudyNotesKeyTerms`); Pajak (ID: `203712@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Petrus (ID: `person:Peter`); melayani (ID: `keyterm:Serve`); menjadi murid (ID: `keyterm:Disciple`); amin! (ID: `keyterm:Surely`); memerintahkan (ID: `keyterm:Command`); Galilea (ID: `place:Galilee`); pajak (ID: `keyterm:PollTax`); percaya (ID: `keyterm:Believe`); Kapernaum (ID: `place:Capernaum`); A Group of Disciples (ID: `group:GenericDisciples`); belas kasihan (ID: `keyterm:Mercy`); Demons (ID: `deity:Demons`); kebangkitan (ID: `keyterm:Resurrection`); cukai (ID: `keyterm:Tax`); tidak setia (ID: `keyterm:Unfaithful`); Fishhook (ID: `realia:Fishhook`); Stater (ID: `realia:Stater`); Two-Drachma Piece (ID: `realia:Two-drachmaPiece`); Mustard (ID: `flora:Mustard`); House (ID: `realia:House`); Fish (ID: `fauna:Fish`); Grain (ID: `flora:Grain`)
...
* **Associated Passages:** Matius 18:1-11

* **Associated ACAI Concepts:** sorga (ID: `keyterm:Heaven`); menyesatkan (ID: `keyterm:CauseToStumble`); kerajaan (ID: `keyterm:Kingdom`); kehidupan (ID: `keyterm:Life`); penyesatan (ID: `keyterm:StumblingBlock`); amin! (ID: `keyterm:Surely`); Hell (ID: `place:Hell`); percaya (ID: `keyterm:Believe`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); api kekal (ID: `keyterm:EternalFire`); Disaster (ID: `keyterm:Disaster`); Yesus (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); menjadi murid (ID: `keyterm:Disciple`); nama (ID: `keyterm:Name`); neraka (ID: `keyterm:Gehenna`); selama, lamanya (ID: `keyterm:Always`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated Passages:** Matius 18:12-14

* **Associated ACAI Concepts:** amin! (ID: `keyterm:Surely`); Tuhan (ID: `deity:Lord`); sorga (ID: `keyterm:Heaven`); Sheep (ID: `fauna:Lamb`)
...
* **Associated Passages:** Matius 18:15-35

* **Associated ACAI Concepts:** mengampuni (ID: `keyterm:Forgive`); berhutang (ID: `keyterm:Owe`); sorga (ID: `keyterm:Heaven`); amin! (ID: `keyterm:Surely`); berbuat dosa (ID: `keyterm:Sin`); Tuhan (ID: `deity:Lord`); meminta (ID: `keyterm:AskFor`); saksi (ID: `keyterm:Witness`); utang (ID: `keyterm:Debt`); menyembah (ID: `keyterm:BowDown`); firman (ID: `keyterm:Word`); rahmat (ID: `keyterm:Affection`); pemungut cukai (ID: `keyterm:TaxCollector`); hati (ID: `keyterm:Heart`); Petrus (ID: `person:Peter`); belas kasihan (ID: `keyterm:Mercy`); jemaat (ID: `keyterm:Church`); sorgawi (ID: `keyterm:Heavenly`); Yesus (ID: `person:Jesus.2`); nama (ID: `keyterm:Name`); kerajaan (ID: `keyterm:Kingdom`); Talent (ID: `realia:Talent`); Denarius (ID: `realia:Denarius`); Prison (ID: `realia:Prison`)
...
* **Associated Passages:** Matius 19:1-15
* **Associated Articles:** Pernikahan (ID: `203341@BiblicaStudyNotesKeyTerms`); Perceraian (ID: `203649@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** memerintahkan (ID: `keyterm:Command`); sorga (ID: `keyterm:Heaven`); tubuh (ID: `keyterm:Body.3`); Musa (ID: `person:Moses`); Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); kerajaan (ID: `keyterm:Kingdom`); Yehuda (ID: `place:Judea`); Galilea (ID: `place:Galilee`); A Group of Disciples (ID: `group:GenericDisciples`); Yordan (ID: `place:Jordan`); Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); Be Lawful (ID: `keyterm:Lawful`); melayani (ID: `keyterm:Serve`); ketegaran hati (ID: `keyterm:Hardheartedness`); Pharisees (ID: `group:Pharisee`); persundalan (ID: `keyterm:Fornication`); Scroll (ID: `realia:Scroll`)
...
* **Associated Passages:** Matius 19:16-30
* **Associated Articles:** 12 suku (ID: `203421@BiblicaStudyNotesKeyTerms`); Ciptaan Baru (ID: `203678@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); kehidupan (ID: `keyterm:Life`); amin! (ID: `keyterm:Surely`); Rich Young Ruler (ID: `person:RichYoungRuler`); sorga (ID: `keyterm:Heaven`); Tuhan (ID: `deity:Lord`); yang baik (ID: `keyterm:Good`); menjadi murid (ID: `keyterm:Disciple`); selama, lamanya (ID: `keyterm:Always`); kerajaan (ID: `keyterm:Kingdom`); perintah (ID: `keyterm:Commandment`); keselamatan (ID: `keyterm:Salvation`); kemuliaan (ID: `keyterm:Glory`); kasihi (ID: `keyterm:Love`); Petrus (ID: `person:Peter`); meminta (ID: `keyterm:AskFor`); memutuskan (ID: `keyterm:Decided`); penciptaan kembali (ID: `keyterm:NewWorld`); nama (ID: `keyterm:Name`); persundalan (ID: `keyterm:Fornication`); Israel (ID: `person:Israel`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`); House (ID: `realia:House`); Throne (ID: `realia:Throne`)
...
* **Associated Passages:** Matius 20:1-16
* **Associated Articles:** Anugerah (ID: `203370@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Denarius (ID: `realia:Denarius`); sia, sia (ID: `keyterm:Idle`); kerajaan (ID: `keyterm:Kingdom`); bertindak jahat (ID: `keyterm:ActWickedly`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); yang baik (ID: `keyterm:Good`); sorga (ID: `keyterm:Heaven`); Be Lawful (ID: `keyterm:Lawful`)
...
* **Associated Passages:** Matius 20:17-34
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Yerusalem (ID: `place:Jerusalem`); memerintahkan (ID: `keyterm:Command`); belas kasihan (ID: `keyterm:Mercy`); Daud (ID: `person:David`); melayani (ID: `keyterm:Serve`); Yerikho (ID: `place:Jericho`); menyembah (ID: `keyterm:BowDown`); rahmat (ID: `keyterm:Affection`); Zebedeus (ID: `person:Zebedee`); menentang (ID: `keyterm:Condemn`); Tuhan (ID: `deity:Lord`); kehidupan (ID: `keyterm:Life`); kekuasaan (ID: `keyterm:Authority.2`); tebusan (ID: `keyterm:Ransom`); menjadi murid (ID: `keyterm:Disciple`); kebangkitan (ID: `keyterm:Resurrection`); kerajaan (ID: `keyterm:Kingdom`); Gentiles (ID: `group:Gentile`); Cross (ID: `realia:Cross`)
...
* **Associated Passages:** Matius 21:1-17

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Yerusalem (ID: `place:Jerusalem`); Donkey (ID: `fauna:Donkey`); hosana (ID: `keyterm:Hosanna`); Daud (ID: `person:David`); menjadi murid (ID: `keyterm:Disciple`); Clothing (ID: `realia:Clothing`); Betfage (ID: `place:Bethphage`); tempat yang tinggi (ID: `keyterm:Height`); memerintahkan (ID: `keyterm:Command`); Galilea (ID: `place:Galilee`); memberkati (ID: `keyterm:Bless`); A Group of People (ID: `group:GenericGroup`); Tuhan (ID: `deity:Lord`); menggenapi (ID: `keyterm:Happen`); Nazaret (ID: `place:Nazareth`); berdoa (ID: `keyterm:Pray`); Betania (ID: `place:Bethany`); melayani (ID: `keyterm:Serve`); nama (ID: `keyterm:Name`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated Passages:** Matius 21:18-27
* **Associated Articles:** Perbuatan baik (ID: `203195@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); kekuasaan (ID: `keyterm:Authority.2`); percaya (ID: `keyterm:Believe`); keahlian (ID: `keyterm:Ability`); Fig (ID: `flora:Fig`); Yohanes (ID: `person:John`); menjadi murid (ID: `keyterm:Disciple`); amin! (ID: `keyterm:Surely`); meminta (ID: `keyterm:AskFor`); selama, lamanya (ID: `keyterm:Always`); baptisan (ID: `keyterm:Baptism`); bimbang (ID: `keyterm:Discern`); takut (ID: `keyterm:Fear`); berdoa (ID: `keyterm:Pray`); sorga (ID: `keyterm:Heaven`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** Matius 21:28-46
* **Associated Articles:** Pelacur (ID: `203670@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Tuhan (ID: `deity:Lord`); pemungut cukai (ID: `keyterm:TaxCollector`); bertobat (ID: `keyterm:Repent`); perumpamaan (ID: `keyterm:Parable`); Yesus (ID: `person:Jesus.2`); kerajaan (ID: `keyterm:Kingdom`); membuang (ID: `keyterm:Reject`); amin! (ID: `keyterm:Surely`); kitab suci (ID: `keyterm:Scripture`); percaya (ID: `keyterm:Believe`); Yohanes (ID: `person:John`); takut (ID: `keyterm:Fear`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Pharisees (ID: `group:Pharisee`); Cornerstone (ID: `realia:Cornerstone`); Tower (ID: `realia:Tower`); Winepress (ID: `realia:Winepress`); Watch-Tower (ID: `realia:Watch-tower`); Thorn Hedge (ID: `realia:ThornHedge`)
...
* **Associated Passages:** Matius 22:1-14
* **Associated Articles:** 70 Masehi (ID: `203196@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); Yesus (ID: `person:Jesus.2`); kertak (ID: `keyterm:OuterDarkness`); memerintahkan (ID: `keyterm:Command`); kerajaan (ID: `keyterm:Kingdom`); perumpamaan (ID: `keyterm:Parable`); orang pilihan (ID: `keyterm:Chosen`); yang baik (ID: `keyterm:Good`); sorga (ID: `keyterm:Heaven`); Cattle (ID: `fauna:Bull`)
...
* **Associated Passages:** Matius 22:15-33
* **Associated Articles:** Herodian (ID: `203197@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kebangkitan (ID: `keyterm:Resurrection`); pajak (ID: `keyterm:PollTax`); Yesus (ID: `person:Jesus.2`); Tiberius (ID: `person:Tiberius`); Herodians (ID: `group:Herodian`); Sadducees (ID: `group:Sadducee`); Israel (ID: `person:Israel`); kitab suci (ID: `keyterm:Scripture`); Abraham (ID: `person:Abraham`); keahlian (ID: `keyterm:Ability`); sorga (ID: `keyterm:Heaven`); kebenaran (ID: `keyterm:Truth`); jalan tuhan (ID: `keyterm:TheWay`); Musa (ID: `person:Moses`); kehidupan (ID: `keyterm:Life`); benar (ID: `keyterm:True`); Ishak (ID: `person:Isaac`); Be Lawful (ID: `keyterm:Lawful`); menjadi murid (ID: `keyterm:Disciple`); An Angel (ID: `deity:Angel`); Pharisees (ID: `group:Pharisee`); Money (ID: `realia:Money`); Denarius (ID: `realia:Denarius`); Image (ID: `realia:Image`)
...
* **Associated Passages:** Matius 22:34-46
* **Associated Articles:** Shema (ID: `203549@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); perintah (ID: `keyterm:Commandment`); Daud (ID: `person:David`); Yesus (ID: `person:Jesus.2`); Pharisees (ID: `group:Pharisee`); hukum (ID: `keyterm:Law`); kasihi (ID: `keyterm:Love`); pikiran (ID: `keyterm:Mind.2`); hati (ID: `keyterm:Heart`); Sadducees (ID: `group:Sadducee`); Roh (ID: `deity:HolySpirit`)
...
* **Associated Passages:** Matius 23:1-39
* **Associated Articles:** Tujuh (ID: `203349@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Pharisees (ID: `group:Pharisee`); Disaster (ID: `keyterm:Disaster`); Temple (ID: `realia:Temple`); Tuhan (ID: `deity:Lord`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); neraka (ID: `keyterm:Gehenna`); dikhususkan (ID: `keyterm:Consecration.2`); sorga (ID: `keyterm:Heaven`); wajib (ID: `keyterm:Ought`); penghakiman (ID: `keyterm:Judgment`); membersihkan (ID: `keyterm:Cleanse.2`); Yesus (ID: `person:Jesus.2`); persembahan (ID: `keyterm:Offering`); darah (ID: `keyterm:Blood`); Zakharia (ID: `person:Zechariah.12`); suci (ID: `keyterm:Clean`); kemunafikan (ID: `keyterm:Hypocrisy`); Yoyada (ID: `person:Jehoiada.2`); Grave (ID: `realia:Grave`); Synagogue (ID: `realia:Synagogue`); amin! (ID: `keyterm:Surely`); Hell (ID: `place:Hell`); bersaksi (ID: `keyterm:BearWitness`); percaya (ID: `keyterm:Believe`); persahabatan (ID: `keyterm:Friendship`); memberkati (ID: `keyterm:Bless`); Musa (ID: `person:Moses`); Yerusalem (ID: `place:Jerusalem`); belas kasihan (ID: `keyterm:Mercy`); hukum (ID: `keyterm:Law`); pencemaran (ID: `keyterm:Defilement`); Habel (ID: `person:Abel`); pengadilan (ID: `keyterm:CourtCase`); sorgawi (ID: `keyterm:Heavenly`); tak kenal hukum (ID: `keyterm:Lawless`); menjadi murid (ID: `keyterm:Disciple`); nama (ID: `keyterm:Name`); kerajaan (ID: `keyterm:Kingdom`); Dill (ID: `flora:Dill`); Seat (ID: `realia:Seat`); Phylactery (ID: `realia:Phylactery`); Mosquito (ID: `fauna:Mosquito`); Cumin (ID: `flora:Cumin`); Mint (ID: `flora:Mint`); Plate (ID: `realia:Plate.2`); Bird (ID: `fauna:Bird`); Rooster (ID: `fauna:Rooster`); House (ID: `realia:House`); Tassel (ID: `realia:Tassel`); Camel (ID: `fauna:Camel`); Throne (ID: `realia:Throne`); Cross (ID: `realia:Cross`); Snake (ID: `fauna:Snake`)
...
* **Associated Passages:** Matius 24:1-14
* **Associated Articles:** Bukit Zaitun (ID: `203198@BiblicaStudyNotesKeyTerms`); Masehi (ID: `203199@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); nama (ID: `keyterm:Name`); kerajaan (ID: `keyterm:Kingdom`); keselamatan (ID: `keyterm:Salvation`); amin! (ID: `keyterm:Surely`); injil (ID: `keyterm:GoodNews`); bersaksi (ID: `keyterm:BearWitness`); selama, lamanya (ID: `keyterm:Always`); tanda (ID: `keyterm:Example`); memberitakan (ID: `keyterm:Proclaim`); kasihi (ID: `keyterm:Love`); keahlian (ID: `keyterm:Ability`); tak kenal hukum (ID: `keyterm:Lawless`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated Passages:** Matius 24:15-51
...
* **Associated ACAI Concepts:** sorga (ID: `keyterm:Heaven`); orang pilihan (ID: `keyterm:Chosen`); Nuh (ID: `person:Noah`); amin! (ID: `keyterm:Surely`); percaya (ID: `keyterm:Believe`); keahlian (ID: `keyterm:Ability`); Yesus (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); tanda (ID: `keyterm:Example`); Daniel (ID: `person:Daniel.3`); kesetiaan (ID: `keyterm:Faithfulness`); House (ID: `realia:House`); Yehuda (ID: `place:Judea`); keselamatan (ID: `keyterm:Salvation`); kemuliaan (ID: `keyterm:Glory`); mujizat (ID: `keyterm:Portent`); pembinasa keji (ID: `keyterm:AbominationOfDesolation`); sabat (ID: `keyterm:Sabbath`); tubuh (ID: `keyterm:Body.3`); hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`); Disaster (ID: `keyterm:Disaster`); perumpamaan (ID: `keyterm:Parable`); berdoa (ID: `keyterm:Pray`); berbahagialah (ID: `keyterm:Happy`); khusus (ID: `keyterm:Holy`); Inner Room (ID: `realia:InnerRoom`); Trumpet (ID: `realia:Trumpet`); Vulture (ID: `fauna:Vulture`); Housetop (ID: `realia:Housetop`); Boat (ID: `realia:Boat`); Cloak (ID: `realia:Cloak`); Fig (ID: `flora:Fig`); Tabernacle (ID: `realia:Tabernacle`); Door (ID: `realia:Door`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated Passages:** Matius 25:1-13

* **Associated ACAI Concepts:** Lamp (ID: `realia:Lamp`); Olive Oil (ID: `realia:OliveOil`); amin! (ID: `keyterm:Surely`); kerajaan (ID: `keyterm:Kingdom`); sorga (ID: `keyterm:Heaven`); Container (ID: `realia:Container`); Door (ID: `realia:Door`)
...
* **Associated Passages:** Matius 25:14-30
* **Associated Articles:** Budak (ID: `203393@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Talent (ID: `realia:Talent`); kesetiaan (ID: `keyterm:Faithfulness`); Cause of Joy (ID: `keyterm:CauseOfJoy`); yang baik (ID: `keyterm:Good`); kertak (ID: `keyterm:OuterDarkness`); takut (ID: `keyterm:Fear`); keahlian (ID: `keyterm:Ability`)
...
* **Associated Passages:** Matius 25:31-46

* **Associated ACAI Concepts:** Prison (ID: `realia:Prison`); amin! (ID: `keyterm:Surely`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Yesus (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); selama, lamanya (ID: `keyterm:Always`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Kid (ID: `fauna:Kid`); kemuliaan (ID: `keyterm:Glory`); keahlian (ID: `keyterm:Ability`); memberkati (ID: `keyterm:Bless`); Tuhan (ID: `deity:Lord`); api kekal (ID: `keyterm:EternalFire`); kehidupan (ID: `keyterm:Life`); melayani (ID: `keyterm:Serve`); kerajaan (ID: `keyterm:Kingdom`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`)
...
* **Associated Passages:** Matius 26:1-16

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Simon (ID: `person:Simon.4`); Yudas (ID: `person:Judas.2`); Betania (ID: `place:Bethany`); Kayafas (ID: `person:Caiaphas`); amin! (ID: `keyterm:Surely`); tubuh (ID: `keyterm:Body.3`); paskah (ID: `keyterm:Passover`); injil (ID: `keyterm:GoodNews`); memberitakan (ID: `keyterm:Proclaim`); keahlian (ID: `keyterm:Ability`); Alabaster Jar (ID: `realia:AlabasterJar`); Cross (ID: `realia:Cross`); Courtyard (ID: `realia:Courtyard`); House (ID: `realia:House`)
...
* **Associated Passages:** Matius 26:17-30
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); paskah (ID: `keyterm:Passover`); darah (ID: `keyterm:Blood`); tubuh (ID: `keyterm:Body.3`); amin! (ID: `keyterm:Surely`); Disaster (ID: `keyterm:Disaster`); memberkati (ID: `keyterm:Bless`); kerajaan (ID: `keyterm:Kingdom`); mengampuni (ID: `keyterm:Forgive`); berbuat dosa (ID: `keyterm:Sin`); Tuhan (ID: `deity:Lord`); Yudas (ID: `person:Judas.2`); perjanjian (ID: `keyterm:Covenant`); Vine (ID: `flora:Vine`); Bowl (ID: `realia:Bowl.2`); Olive Tree (ID: `flora:OliveTree`); Sheep (ID: `fauna:Lamb`)
...
* **Associated Passages:** Matius 26:31-46

* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); menjadi murid (ID: `keyterm:Disciple`); Petrus (ID: `person:Peter`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); roh (ID: `keyterm:Spirit.2`); Getsemani (ID: `place:Gethsemane`); kebangkitan (ID: `keyterm:Resurrection`); amin! (ID: `keyterm:Surely`); tubuh (ID: `keyterm:Body.3`); Galilea (ID: `place:Galilee`); mencobai (ID: `keyterm:PutToTheTest`); Zebedeus (ID: `person:Zebedee`); Rooster (ID: `fauna:Rooster`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Olive Tree (ID: `flora:OliveTree`); Sheep (ID: `fauna:Lamb`)
...
* **Associated Passages:** Matius 26:47-56
* **Associated Articles:** Yudas Iskariot (ID: `203201@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); menggenapi (ID: `keyterm:Happen`); kitab suci (ID: `keyterm:Scripture`); menjadi murid (ID: `keyterm:Disciple`); An Angel (ID: `deity:Angel`); meminta (ID: `keyterm:AskFor`); tanda (ID: `keyterm:Example`); Tuhan (ID: `deity:Lord`); Yudas (ID: `person:Judas.2`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** Matius 26:57-68
* **Associated Articles:** Mahkamah Agama (ID: `203202@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); Kayafas (ID: `person:Caiaphas`); Petrus (ID: `person:Peter`); saksi (ID: `keyterm:Witness`); kehidupan (ID: `keyterm:Life`); sorga (ID: `keyterm:Heaven`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); keahlian (ID: `keyterm:Ability`); menghujat (ID: `keyterm:Blaspheme`); Courtyard (ID: `realia:Courtyard`); Cloak (ID: `realia:Cloak`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** Matius 26:69-75

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Petrus (ID: `person:Peter`); Rooster (ID: `fauna:Rooster`); Nazaret (ID: `place:Nazareth`); Galileans (ID: `group:Galilee`); benar (ID: `keyterm:True`); Galilea (ID: `place:Galilee`); sumpah (ID: `keyterm:Oath`); firman (ID: `keyterm:Word`); A Group of People (ID: `group:GenericGroup`); A Servant (ID: `person:GenericServant`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated Passages:** Matius 27:1-10
* **Associated Articles:** Yeremia (ID: `203642@BiblicaStudyNotesKeyTerms`); Zakharia (ID: `203646@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Akeldama (ID: `place:Akeldama`); darah (ID: `keyterm:Blood`); Pilatus (ID: `person:Pilate`); pemeliharaanmu (ID: `place:Corban`); Yesus (ID: `person:Jesus.2`); bertobat (ID: `keyterm:Repent`); Yudas (ID: `person:Judas.2`); Yeremia (ID: `person:Jeremiah.6`); berbuat dosa (ID: `keyterm:Sin`); menentang (ID: `keyterm:Condemn`); Tuhan (ID: `deity:Lord`); Priests (ID: `group:GenericPriests`); Israel (ID: `person:Israel`); menggenapi (ID: `keyterm:Happen`); Be Lawful (ID: `keyterm:Lawful`); Treasury (ID: `realia:Treasury`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** Matius 27:11-26

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Barabas (ID: `person:Barabbas`); Pilatus (ID: `person:Pilate`); A Group of People (ID: `group:GenericGroup`); Cross (ID: `realia:Cross`); darah (ID: `keyterm:Blood`); firman (ID: `keyterm:Word`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Jews (ID: `group:Jews`); membujuk (ID: `keyterm:Persuade`); Judgment Seat (ID: `realia:JudgmentSeat`)
...
* **Associated Passages:** Matius 27:27-44

* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); keselamatan (ID: `keyterm:Salvation`); Yesus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Cloak (ID: `realia:Cloak`); Reed (ID: `flora:Reed`); Clothing (ID: `realia:Clothing`); Simon (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); Kirene (ID: `place:Cyrene`); menghujat (ID: `keyterm:Blaspheme`); menyelamatkan (ID: `keyterm:Deliver`); percaya (ID: `keyterm:Believe`); hati (ID: `keyterm:Heart`); Tuhan (ID: `deity:Lord`); membujuk (ID: `keyterm:Persuade`); nama (ID: `keyterm:Name`); Israel (ID: `person:Israel`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`); Wine (ID: `realia:Wine`); Boxthorn (ID: `flora:Boxthorn`); Lot (ID: `realia:Lot`); Palace (ID: `realia:Palace`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** Matius 27:45-66

* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Grave (ID: `realia:Grave`); kebangkitan (ID: `keyterm:Resurrection`); Pilatus (ID: `person:Pilate`); tubuh (ID: `keyterm:Body.3`); Maria (ID: `person:Marymagdalene`); Yusuf (ID: `person:Joseph.6`); Maria (ID: `person:Mary.2`); A Group of People (ID: `group:GenericGroup`); Elia (ID: `person:Elijah`); khusus (ID: `keyterm:Holy`); menjadi murid (ID: `keyterm:Disciple`); Yakobus (ID: `person:James.4`); Zebedeus (ID: `person:Zebedee`); Yusuf (ID: `person:Joseph.5`); Arimatea (ID: `place:Arimathea`); keselamatan (ID: `keyterm:Salvation`); Galilea (ID: `place:Galilee`); suci (ID: `keyterm:Clean`); Tuhan (ID: `deity:Lord`); kehidupan (ID: `keyterm:Life`); benar (ID: `keyterm:True`); takut (ID: `keyterm:Fear`); melayani (ID: `keyterm:Serve`); roh (ID: `keyterm:Spirit.2`); nama (ID: `keyterm:Name`); Pharisees (ID: `group:Pharisee`); Reed (ID: `flora:Reed`); Sour Wine (ID: `realia:SourWine`); Curtain (ID: `realia:Curtain`); Seal (ID: `realia:Seal`); Linen (ID: `realia:Linen`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** Matius 28:1-15
* **Associated Articles:** Maria Magdalena (ID: `203203@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** takut (ID: `keyterm:Fear`); Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); kebangkitan (ID: `keyterm:Resurrection`); Galilea (ID: `place:Galilee`); An Angel (ID: `deity:Angel`); Grave (ID: `realia:Grave`); minggu (ID: `keyterm:Week`); Angels (ID: `group:Angels`); menyembah (ID: `keyterm:BowDown`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Maria (ID: `person:Marymagdalene`); sabat (ID: `keyterm:Sabbath`); sorga (ID: `keyterm:Heaven`); Tuhan (ID: `deity:Lord`); membujuk (ID: `keyterm:Persuade`); Jews (ID: `group:Jews`); Maria (ID: `person:Mary.2`); Clothing (ID: `realia:Clothing`); Cross (ID: `realia:Cross`)
...
* **Associated Passages:** Matius 28:16-20
* **Associated Articles:** Imanuel (ID: `203673@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** menjadi murid (ID: `keyterm:Disciple`); Yesus (ID: `person:Jesus.2`); kekuasaan (ID: `keyterm:Authority.2`); memerintahkan (ID: `keyterm:Command`); nama (ID: `keyterm:Name`); Galilea (ID: `place:Galilee`); selama, lamanya (ID: `keyterm:Always`); menyembah (ID: `keyterm:BowDown`); baptisan (ID: `keyterm:Baptism`); Tuhan (ID: `deity:Lord`); Roh (ID: `deity:HolySpirit`); keahlian (ID: `keyterm:Ability`); sorga (ID: `keyterm:Heaven`)
