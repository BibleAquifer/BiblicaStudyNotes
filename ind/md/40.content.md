...
* **Associated ACAI Concepts:** Daud (ID: `person:David`); Yesus (ID: `person:Jesus.2`); Babel (ID: `place:Babylon`); Abraham (ID: `person:Abraham`); Yakub (ID: `person:Jacob.2`); Azor (ID: `person:Azor`); Eliud (ID: `person:Eliud`); Zerubabel (ID: `person:Zerubbabel.2`); Uzia (ID: `person:Uzziah`); Yosia (ID: `person:Josiah`); Hizkia (ID: `person:Hezekiah`); Asa (ID: `person:Asa`); raja (ID: `person:Jehoiachin`); memperanakkan (ID: `person:Salmon`); Ram (ID: `person:Ram`); Salomo (ID: `person:Solomon`); Isai (ID: `person:Jesse`); Yehuda (ID: `person:Judah.4`); Akhim (ID: `person:Achim`); Zerah (ID: `person:Zerah.3`); Yosafat (ID: `person:Jehoshaphat.3`); Ishak (ID: `person:Isaac`); Boas (ID: `person:Boaz`); Elyakim (ID: `person:Eliakim`); Zadok (ID: `person:Zadok`); Ahas (ID: `person:Ahaz`); Eleazar (ID: `person:Eleazar`); Matan (ID: `person:Matthan`); Abia (ID: `person:Abijah.4`); Hezron (ID: `person:Hezron.2`); Nahason (ID: `person:Nahshon`); Peres (ID: `person:Perez`); Rehabeam (ID: `person:Rehoboam`); Yoram (ID: `person:Jehoram`); Obed (ID: `person:Obed`); Tamar (ID: `person:Tamar`); Abihud (ID: `person:Abiud`); Yotam (ID: `person:Jotham.2`); Amon (ID: `person:Amon.3`); Yusuf (ID: `person:Joseph.4`); Rahab (ID: `person:Rahab`); Israel (ID: `person:Israel`); Aminadab (ID: `person:Amminadab`); Uria (ID: `person:Uriah`); Rut (ID: `person:Ruth`); Sealtiel (ID: `person:Shealtiel.2`); Manasye (ID: `person:Manasseh.2`); Maria (ID: `person:Mary`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Yusuf (ID: `person:Joseph.4`); Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); Maria (ID: `person:Mary`); Roh (ID: `deity:HolySpirit`); An Angel (ID: `deity:Angel`); menggenapi (ID: `keyterm:Happen`); bertunangan (ID: `keyterm:Engaged`); takut (ID: `keyterm:Fear`); Daud (ID: `person:David`); keselamatan (ID: `keyterm:Salvation`); berbuat dosa (ID: `keyterm:Sin`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod`); Betlehem (ID: `place:Bethlehem`); Mesir (ID: `place:Egypt`); menyembah (ID: `keyterm:BowDown`); Yehuda (ID: `place:Judea`); Tuhan (ID: `deity:Lord`); menggenapi (ID: `keyterm:Happen`); Israel (ID: `person:Israel`); Yusuf (ID: `person:Joseph.4`); An Angel (ID: `deity:Angel`); Yerusalem (ID: `place:Jerusalem`); Yesus (ID: `person:Jesus.2`); Nazaret (ID: `place:Nazareth`); Arkhelaus (ID: `person:Archelaus`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Yeremia (ID: `person:Jeremiah.6`); persembahan (ID: `keyterm:Offering`); Priests (ID: `group:GenericPriests`); meminta (ID: `keyterm:AskFor`); A Priest (ID: `person:GenericPriest`); takut (ID: `keyterm:Fear`); menasihati (ID: `keyterm:Encourage`); Religious Officials (ID: `group:ReligiousOfficials`); Galilea (ID: `place:Galilee`); Rahel (ID: `person:Rachel`); Maria (ID: `person:Mary`); kehidupan (ID: `keyterm:Life`); Ramah (ID: `place:Ramah.2`); Yehuda (ID: `person:Judah.4`); Jews (ID: `group:Jews`); Frankincense (ID: `flora:Frankincense`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Money Box (ID: `realia:MoneyBox`); Incense (ID: `realia:Incense`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** bertobat (ID: `keyterm:Repent`); baptisan (ID: `keyterm:Baptism`); Yehuda (ID: `place:Judea`); Yohanes (ID: `person:John`); Tuhan (ID: `deity:Lord`); Yordan (ID: `place:Jordan`); Yesaya (ID: `person:Isaiah`); pembaptis (ID: `keyterm:Baptist`); sorga (ID: `keyterm:Heaven`); memberitakan (ID: `keyterm:Proclaim`); Abraham (ID: `person:Abraham`); Pharisees (ID: `group:Pharisee`); kerajaan (ID: `keyterm:Kingdom`); Yerusalem (ID: `place:Jerusalem`); Sadducees (ID: `group:Sadducee`); kebenaran (ID: `keyterm:Straightness`); Roh (ID: `deity:HolySpirit`); bersihkan (ID: `keyterm:CleanOut`); berbuat dosa (ID: `keyterm:Sin`); Locust (ID: `fauna:Locust`); Threshing Floor (ID: `realia:ThreshingFloor`); Leather (ID: `realia:Leather`); Belt (ID: `realia:Belt`); Winnowing Fork (ID: `realia:WinnowingFork`); Sandal (ID: `realia:Sandal`); Clothing (ID: `realia:Clothing`); Snake (ID: `fauna:Snake`); Grain (ID: `flora:Grain`); Bag (ID: `realia:Bag`); Camel (ID: `fauna:Camel`); Bee (ID: `fauna:Bee`); Wheat (ID: `flora:Wheat`); Barn (ID: `realia:Barn`); Axe (ID: `realia:Axe`)
...
* **Associated ACAI Concepts:** baptisan (ID: `keyterm:Baptism`); Yesus (ID: `person:Jesus.2`); sorga (ID: `keyterm:Heaven`); Yohanes (ID: `person:John`); Yordan (ID: `place:Jordan`); menggenapi (ID: `keyterm:Happen`); Roh (ID: `deity:HolySpirit`); Tuhan (ID: `deity:Lord`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Galilea (ID: `place:Galilee`); kekasih (ID: `keyterm:Beloved`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`); mencobai (ID: `keyterm:PutToTheTest`); menyembah (ID: `keyterm:BowDown`); memerintahkan (ID: `keyterm:Command`); An Angel (ID: `deity:Angel`); melayani (ID: `keyterm:Serve`); firman (ID: `keyterm:Word`); imamat (ID: `keyterm:Priesthood`); kerajaan (ID: `keyterm:Kingdom`); Iblis (ID: `deity:Satan`); keahlian (ID: `keyterm:Ability`); kehidupan (ID: `keyterm:Life`); Roh (ID: `deity:HolySpirit`); berpuasa (ID: `keyterm:Fast`); khusus (ID: `keyterm:Holy`); kemuliaan (ID: `keyterm:Glory`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Galilea (ID: `place:Galilee`); Zebulon (ID: `person:Zebulun`); Zebulon (ID: `group:Zebulun`); Naftali (ID: `person:Naphtali`); bertobat (ID: `keyterm:Repent`); Nazaret (ID: `place:Nazareth`); memberitakan (ID: `keyterm:Proclaim`); sorga (ID: `keyterm:Heaven`); menggenapi (ID: `keyterm:Happen`); Kapernaum (ID: `place:Capernaum`); kerajaan (ID: `keyterm:Kingdom`); Yesus (ID: `person:Jesus.2`); Yordan (ID: `place:Jordan`); Yohanes (ID: `person:John`); Yesaya (ID: `person:Isaiah`); Gentiles (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** Casting Net (ID: `realia:CastingNet`); Galilea (ID: `place:Galilee`); melayani (ID: `keyterm:Serve`); Andreas (ID: `person:Andrew`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Zebedeus (ID: `person:Zebedee`); Yohanes (ID: `person:John.2`); injil (ID: `keyterm:GoodNews`); Sea of Galilee (ID: `place:GalileeSea`); Dekapolis (ID: `place:Decapolis`); Yakobus (ID: `person:James`); kerasukan setan (ID: `keyterm:DemonPossessed`); memberitakan (ID: `keyterm:Proclaim`); Yehuda (ID: `place:Judea`); kerajaan (ID: `keyterm:Kingdom`); Yerusalem (ID: `place:Jerusalem`); Yordan (ID: `place:Jordan`); Petrus (ID: `person:Peter`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** berbahagialah (ID: `keyterm:Happy`); sorga (ID: `keyterm:Heaven`); kerajaan (ID: `keyterm:Kingdom`); Tuhan (ID: `deity:Lord`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); hati (ID: `keyterm:Heart`); belas kasihan (ID: `keyterm:Mercy`); meminta (ID: `keyterm:AskFor`); menasihati (ID: `keyterm:Encourage`); menjadi murid (ID: `keyterm:Disciple`); roh (ID: `keyterm:Spirit.2`); suci (ID: `keyterm:Clean`)
...
* **Associated ACAI Concepts:** sorga (ID: `keyterm:Heaven`); hukum (ID: `keyterm:Law`); kerajaan (ID: `keyterm:Kingdom`); perintah (ID: `keyterm:Commandment`); Pharisees (ID: `group:Pharisee`); keahlian (ID: `keyterm:Ability`); amin! (ID: `keyterm:Surely`); Tuhan (ID: `deity:Lord`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kemuliaan (ID: `keyterm:Glory`); Lampstand (ID: `realia:Lampstand.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); persundalan (ID: `keyterm:Fornication`); neraka (ID: `keyterm:Gehenna`); Hell (ID: `place:Hell`); kasihi (ID: `keyterm:Love`); pengadilan (ID: `keyterm:CourtCase`); persembahan (ID: `keyterm:Offering`); sorga (ID: `keyterm:Heaven`); menyesatkan (ID: `keyterm:CauseToStumble`); tubuh (ID: `keyterm:Body.3`); penghakiman (ID: `keyterm:Judgment`); memperdamaikan (ID: `keyterm:Reconcile`); sumpah (ID: `keyterm:Oath`); sorgawi (ID: `keyterm:Heavenly`); yang baik (ID: `keyterm:Good`); hati (ID: `keyterm:Heart`); memutuskan (ID: `keyterm:Decided`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Yerusalem (ID: `place:Jerusalem`); berdoa (ID: `keyterm:Pray`); pemungut cukai (ID: `keyterm:TaxCollector`); amin! (ID: `keyterm:Surely`); Footstool (ID: `realia:Footstool`); Cloak (ID: `realia:Cloak`); Quadrans (ID: `realia:Quadrans`); Mile (ID: `realia:Mile`); Prison (ID: `realia:Prison`); Tunic (ID: `realia:Tunic.2`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); sorga (ID: `keyterm:Heaven`); mengampuni (ID: `keyterm:Forgive`); amin! (ID: `keyterm:Surely`); Synagogue (ID: `realia:Synagogue`); kerajaan (ID: `keyterm:Kingdom`); membawa masuk (ID: `keyterm:BringIn`); persahabatan (ID: `keyterm:Friendship`); bersalah (ID: `keyterm:Wrong`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); mencobai (ID: `keyterm:PutToTheTest`); nama (ID: `keyterm:Name`); sorgawi (ID: `keyterm:Heavenly`); khusus (ID: `keyterm:Holy`); kemuliaan (ID: `keyterm:Glory`); menyelamatkan (ID: `keyterm:Deliver`); Inner Room (ID: `realia:InnerRoom`); Door (ID: `realia:Door`); Cornerstone (ID: `realia:Cornerstone`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berpuasa (ID: `keyterm:Fast`); tubuh (ID: `keyterm:Body.3`); sorga (ID: `keyterm:Heaven`); sorgawi (ID: `keyterm:Heavenly`); Clothing (ID: `realia:Clothing`); Moth (ID: `fauna:Moth`); kurang percaya (ID: `keyterm:HavingLittleFaith`); hati (ID: `keyterm:Heart`); kerajaan (ID: `keyterm:Kingdom`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); melayani (ID: `keyterm:Serve.2`); kehidupan (ID: `keyterm:Life`); diurapi (ID: `keyterm:Anointed`); amin! (ID: `keyterm:Surely`); Salomo (ID: `person:Solomon`); kemuliaan (ID: `keyterm:Glory`); kasihi (ID: `keyterm:Love`); Oven (ID: `realia:Oven`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Barn (ID: `realia:Barn`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Beam (ID: `realia:Beam`); memutuskan (ID: `keyterm:Decided`); sorga (ID: `keyterm:Heaven`); penghakiman (ID: `keyterm:Judgment`); Tuhan (ID: `deity:Lord`); hukum (ID: `keyterm:Law`); khusus (ID: `keyterm:Holy`); Snake (ID: `fauna:Snake`); Fish (ID: `fauna:Fish`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); Dog (ID: `fauna:Dog`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); tak kenal hukum (ID: `keyterm:Lawless`); menghancurkan (ID: `keyterm:Destroy`); sorga (ID: `keyterm:Heaven`); kerajaan (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); nama (ID: `keyterm:Name`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); kehidupan (ID: `keyterm:Life`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Clothing (ID: `realia:Clothing`); Wolf (ID: `fauna:Wolf`); Fig (ID: `flora:Fig`); Sheep (ID: `fauna:Lamb`); Vine (ID: `flora:Vine`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); kekuasaan (ID: `keyterm:Authority.2`); Yesus (ID: `person:Jesus.2`); keahlian (ID: `keyterm:Ability`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); melayani (ID: `keyterm:Serve`); membersihkan (ID: `keyterm:Cleanse.2`); percaya (ID: `keyterm:Believe`); kerajaan (ID: `keyterm:Kingdom`); Israel (ID: `person:Israel`); House (ID: `realia:House`); kerasukan setan (ID: `keyterm:DemonPossessed`); Centurion With Sick Servant (ID: `person:Centurion.2`); penyakit kulit menular (ID: `keyterm:InfectiousSkinDisease`); bersaksi (ID: `keyterm:BearWitness`); persembahan (ID: `keyterm:Offering`); sorga (ID: `keyterm:Heaven`); kekuasaan (ID: `keyterm:Authority.2`); meminta (ID: `keyterm:AskFor`); memerintahkan (ID: `keyterm:Command`); Ishak (ID: `person:Isaac`); kertak (ID: `keyterm:OuterDarkness`); Abraham (ID: `person:Abraham`); Yesaya (ID: `person:Isaiah`); menyembah (ID: `keyterm:BowDown`); keahlian (ID: `keyterm:Ability`); Musa (ID: `person:Moses`); Kapernaum (ID: `place:Capernaum`); menggenapi (ID: `keyterm:Happen`); amin! (ID: `keyterm:Surely`); Petrus (ID: `person:Peter`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); kerasukan setan (ID: `keyterm:DemonPossessed`); meminta (ID: `keyterm:AskFor`); menjadi murid (ID: `keyterm:Disciple`); Ship (ID: `realia:Ship`); kurang percaya (ID: `keyterm:HavingLittleFaith`); memerintahkan (ID: `keyterm:Command`); Religious Official (ID: `person:ReligiousOfficial`); A Disciple (ID: `person:GenericDisciple`); kekuasaan (ID: `keyterm:Authority.2`); sorga (ID: `keyterm:Heaven`); Gerasa (ID: `place:Gerasa`); keselamatan (ID: `keyterm:Salvation`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); mengampuni (ID: `keyterm:Forgive`); berbuat dosa (ID: `keyterm:Sin`); menjadi murid (ID: `keyterm:Disciple`); House (ID: `realia:House`); pemungut cukai (ID: `keyterm:TaxCollector`); kekuasaan (ID: `keyterm:Authority.2`); Pharisees (ID: `group:Pharisee`); keahlian (ID: `keyterm:Ability`); berpuasa (ID: `keyterm:Fast`); Temple (ID: `realia:Temple`); Bed (ID: `realia:Bed`); belas kasihan (ID: `keyterm:Mercy`); Matius (ID: `person:Matthew`); hati (ID: `keyterm:Heart`); persembahan (ID: `keyterm:Offering`); menghujat (ID: `keyterm:Blaspheme`); Be Healthy (ID: `keyterm:Healthy`); takut (ID: `keyterm:Fear`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); percayalah (ID: `keyterm:CheerUp`); Tuhan (ID: `deity:Lord`); rumah cukai (ID: `keyterm:TaxOffice`); percaya (ID: `keyterm:Believe`); kemuliaan (ID: `keyterm:Glory`); Yohanes (ID: `person:John`); Patch (ID: `realia:Patch`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Ship (ID: `realia:Ship`); Skin-Bottle (ID: `realia:Skin-bottle`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); Demons (ID: `deity:Demons`); keselamatan (ID: `keyterm:Salvation`); menjadi murid (ID: `keyterm:Disciple`); House (ID: `realia:House`); Cloak (ID: `realia:Cloak`); rahmat (ID: `keyterm:Affection`); meminta (ID: `keyterm:AskFor`); kerasukan setan (ID: `keyterm:DemonPossessed`); injil (ID: `keyterm:GoodNews`); memberitakan (ID: `keyterm:Proclaim`); Pharisees (ID: `group:Pharisee`); kerajaan (ID: `keyterm:Kingdom`); Daud (ID: `person:David`); belas kasihan (ID: `keyterm:Mercy`); menyembah (ID: `keyterm:BowDown`); percayalah (ID: `keyterm:CheerUp`); kehidupan (ID: `keyterm:Life`); berdarah (ID: `keyterm:Bleed`); Israel (ID: `person:Israel`); melayani (ID: `keyterm:Serve`); Tassel (ID: `realia:Tassel`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Goat (ID: `fauna:Goat`); Flute (ID: `realia:Flute`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); melayani (ID: `keyterm:Serve`); Bag (ID: `realia:Bag`); Bartolomeus (ID: `person:Bartholomew`); Alfeus (ID: `person:Alphaeus`); memperdamaikan (ID: `keyterm:Peace`); Yudas (ID: `person:Judas.2`); Tomas (ID: `person:Thomas`); Yudas (ID: `person:Judas`); Zelot (ID: `group:Zealot`); Yakobus (ID: `person:James.2`); Simon (ID: `person:Simon.2`); Filipus (ID: `person:Philip`); membersihkan (ID: `keyterm:Cleanse.2`); sorga (ID: `keyterm:Heaven`); kekuasaan (ID: `keyterm:Authority.2`); Samaria (ID: `place:Samaria`); pengadilan (ID: `keyterm:CourtCase`); Yohanes (ID: `person:John.2`); Zebedeus (ID: `person:Zebedee`); Samaritans (ID: `group:Samaritan`); memberitakan (ID: `keyterm:Proclaim`); kerajaan (ID: `keyterm:Kingdom`); Andreas (ID: `person:Andrew`); Demons (ID: `deity:Demons`); Sodom (ID: `place:Sodom`); Gomora (ID: `place:Gomorrah`); nama (ID: `keyterm:Name`); keahlian (ID: `keyterm:Ability`); Matius (ID: `person:Matthew`); Gentiles (ID: `group:Gentile`); kebangkitan (ID: `keyterm:Resurrection`); pemungut cukai (ID: `keyterm:TaxCollector`); Yesus (ID: `person:Jesus.2`); penghakiman (ID: `keyterm:Judgment`); amin! (ID: `keyterm:Surely`); Yakobus (ID: `person:James`); Israel (ID: `person:Israel`); Petrus (ID: `person:Peter`); menjadi murid (ID: `keyterm:Disciple`); Staff (ID: `realia:Staff`); Belt (ID: `realia:Belt`); Sheep (ID: `fauna:Lamb`); Tunic (ID: `realia:Tunic.2`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); takut (ID: `keyterm:Fear`); nama (ID: `keyterm:Name`); menjadi murid (ID: `keyterm:Disciple`); sorga (ID: `keyterm:Heaven`); amin! (ID: `keyterm:Surely`); Sparrow (ID: `fauna:Sparrow`); neraka (ID: `keyterm:Gehenna`); bersaksi (ID: `keyterm:BearWitness`); memerintahkan (ID: `keyterm:Command`); persahabatan (ID: `keyterm:Friendship`); memberitakan (ID: `keyterm:Proclaim`); memperdamaikan (ID: `keyterm:Peace`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Hell (ID: `place:Hell`); Iblis (ID: `deity:Satan`); Gentiles (ID: `group:Gentile`); tubuh (ID: `keyterm:Body.3`); kehidupan (ID: `keyterm:Life`); Roh (ID: `deity:HolySpirit`); keselamatan (ID: `keyterm:Salvation`); Israel (ID: `person:Israel`); Wolf (ID: `fauna:Wolf`); Assarion (ID: `realia:Assarion`); Snake (ID: `fauna:Snake`); Cross (ID: `realia:Cross`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Dove (ID: `fauna:Dove`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Yohanes (ID: `person:John`); Yesus (ID: `person:Jesus.2`); pembaptis (ID: `keyterm:Baptist`); sorga (ID: `keyterm:Heaven`); kerajaan (ID: `keyterm:Kingdom`); menjadi murid (ID: `keyterm:Disciple`); membersihkan (ID: `keyterm:Cleanse.2`); berbahagialah (ID: `keyterm:Happy`); injil (ID: `keyterm:GoodNews`); memberitakan (ID: `keyterm:Proclaim`); Elia (ID: `person:Elijah`); Demons (ID: `deity:Demons`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); hukum (ID: `keyterm:Law`); kebangkitan (ID: `keyterm:Resurrection`); pemungut cukai (ID: `keyterm:TaxCollector`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); amin! (ID: `keyterm:Surely`); Reed (ID: `flora:Reed`); Prison (ID: `realia:Prison`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Flute (ID: `realia:Flute`)
...
* **Associated ACAI Concepts:** keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); sorga (ID: `keyterm:Heaven`); bertobat (ID: `keyterm:Repent`); pengadilan (ID: `keyterm:CourtCase`); Sodom (ID: `place:Sodom`); Sidon (ID: `place:Sidon`); Tirus (ID: `place:Tyre`); penghakiman (ID: `keyterm:Judgment`); Yoke (ID: `realia:Yoke`); Khorazim (ID: `place:Chorazin`); Disaster (ID: `keyterm:Disaster`); alam maut (ID: `keyterm:WorldOfTheDead`); hati (ID: `keyterm:Heart`); Betsaida (ID: `place:Bethsaida`); Hell (ID: `place:Hell`); Kapernaum (ID: `place:Capernaum`); yang baik (ID: `keyterm:Good`); Yesus (ID: `person:Jesus.2`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** sabat (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); Temple (ID: `realia:Temple`); Pharisees (ID: `group:Pharisee`); menjadi murid (ID: `keyterm:Disciple`); Sheep (ID: `fauna:Lamb`); persembahan (ID: `keyterm:Offering`); Daud (ID: `person:David`); Yesus (ID: `person:Jesus.2`); menentang (ID: `keyterm:Condemn`); Tuhan (ID: `deity:Lord`); belas kasihan (ID: `keyterm:Mercy`); pencemaran (ID: `keyterm:Defilement`); hukum (ID: `keyterm:Law`); Wheat (ID: `flora:Wheat`); House (ID: `realia:House`); Grain (ID: `flora:Grain`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** penghakiman (ID: `keyterm:Judgment`); Gentiles (ID: `group:Gentile`); nama (ID: `keyterm:Name`); menggenapi (ID: `keyterm:Happen`); Roh (ID: `deity:HolySpirit`); Yesus (ID: `person:Jesus.2`); memerintahkan (ID: `keyterm:Command`); kekasih (ID: `keyterm:Beloved`); Yesaya (ID: `person:Isaiah`); harapan (ID: `keyterm:Hope`); melayani (ID: `keyterm:Serve`); Lamp (ID: `realia:Lamp`); Reed (ID: `flora:Reed`)
...
* **Associated ACAI Concepts:** kerajaan (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); Iblis (ID: `deity:Satan`); Roh (ID: `deity:HolySpirit`); mengampuni (ID: `keyterm:Forgive`); yang baik (ID: `keyterm:Good`); menghujat (ID: `keyterm:Blaspheme`); menentang (ID: `keyterm:Condemn`); penghakiman (ID: `keyterm:Judgment`); hati (ID: `keyterm:Heart`); sia, sia (ID: `keyterm:Idle`); kerasukan setan (ID: `keyterm:DemonPossessed`); pengadilan (ID: `keyterm:CourtCase`); Pharisees (ID: `group:Pharisee`); Daud (ID: `person:David`); selama, lamanya (ID: `keyterm:Always`); firman (ID: `keyterm:Word`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); berbuat dosa (ID: `keyterm:Sin`); melayani (ID: `keyterm:Serve`); House (ID: `realia:House`); Snake (ID: `fauna:Snake`); Cobra (ID: `fauna:Cobra`)
...
* **Associated ACAI Concepts:** Yunus (ID: `person:Jonah.2`); tanda (ID: `keyterm:Example`); pengadilan (ID: `keyterm:CourtCase`); penghakiman (ID: `keyterm:Judgment`); negeri (ID: `person:QueenOfSheba`); Niniwe (ID: `group:Nineveh`); hati (ID: `keyterm:Heart`); sorga (ID: `keyterm:Heaven`); bertobat (ID: `keyterm:Repent`); memberitakan (ID: `keyterm:Proclaim`); tidak setia (ID: `keyterm:Unfaithful`); Niniwe (ID: `place:Nineveh`); Pharisees (ID: `group:Pharisee`); A Group of People (ID: `group:GenericGroup`); Tuhan (ID: `deity:Lord`); Salomo (ID: `person:Solomon`); menjadi murid (ID: `keyterm:Disciple`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** perumpamaan (ID: `keyterm:Parable`); hati (ID: `keyterm:Heart`); kerajaan (ID: `keyterm:Kingdom`); Brier (ID: `flora:Brier`); Thistle (ID: `flora:Thistle`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); sorga (ID: `keyterm:Heaven`); berbahagialah (ID: `keyterm:Happy`); A Group of Disciples (ID: `group:GenericDisciples`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Yesaya (ID: `person:Isaiah`); selama, lamanya (ID: `keyterm:Always`); keahlian (ID: `keyterm:Ability`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Yesus (ID: `person:Jesus.2`); amin! (ID: `keyterm:Surely`); menjadi murid (ID: `keyterm:Disciple`); House (ID: `realia:House`); Bird (ID: `fauna:Bird`); Ship (ID: `realia:Ship`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** kerajaan (ID: `keyterm:Kingdom`); sorga (ID: `keyterm:Heaven`); perumpamaan (ID: `keyterm:Parable`); Weed (ID: `flora:Weed`); Grain (ID: `flora:Grain`); An Angel (ID: `deity:Angel`); selama, lamanya (ID: `keyterm:Always`); Wheat (ID: `flora:Wheat`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); menjadi murid (ID: `keyterm:Disciple`); Kiln (ID: `realia:Kiln`); Grass (ID: `flora:Grass`); tak kenal hukum (ID: `keyterm:Lawless`); penyesatan (ID: `keyterm:StumblingBlock`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); menggenapi (ID: `keyterm:Happen`); Yesus (ID: `person:Jesus.2`); Dragnet (ID: `realia:Dragnet`); Saton (ID: `realia:Saton`); Mustard (ID: `flora:Mustard`); Storeroom (ID: `realia:Storeroom`); House (ID: `realia:House`); Barn (ID: `realia:Barn`); Container (ID: `realia:Container`)
...
* **Associated ACAI Concepts:** Yohanes (ID: `person:John`); Yesus (ID: `person:Jesus.2`); Herodes (ID: `person:Herod.2`); keahlian (ID: `keyterm:Ability`); Herodias (ID: `person:Herodias`); sumpah (ID: `keyterm:Oath`); pembaptis (ID: `keyterm:Baptist`); Prison (ID: `realia:Prison`); Plate (ID: `realia:Plate.2`); Yudas (ID: `person:Jude`); Simon (ID: `person:Simon.3`); tidak percaya (ID: `keyterm:Disbelieve`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Yakobus (ID: `person:James.3`); Filipus (ID: `person:Philip.2`); takut (ID: `keyterm:Fear`); Be Lawful (ID: `keyterm:Lawful`); Maria (ID: `person:Mary`); Yusuf (ID: `person:Joseph.4`); kebangkitan (ID: `keyterm:Resurrection`); perumpamaan (ID: `keyterm:Parable`); menjadi murid (ID: `keyterm:Disciple`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); Fish (ID: `fauna:Fish`); rahmat (ID: `keyterm:Affection`); sorga (ID: `keyterm:Heaven`); memberkati (ID: `keyterm:Bless`); melayani (ID: `keyterm:Serve`); Basket (ID: `realia:Basket`); Ship (ID: `realia:Ship`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); takut (ID: `keyterm:Fear`); Yesus (ID: `person:Jesus.2`); keselamatan (ID: `keyterm:Salvation`); Petrus (ID: `person:Peter`); menjadi murid (ID: `keyterm:Disciple`); kurang percaya (ID: `keyterm:HavingLittleFaith`); Genesaret (ID: `place:Gennesaret`); percayalah (ID: `keyterm:CheerUp`); menyembah (ID: `keyterm:BowDown`); meminta (ID: `keyterm:AskFor`); benar (ID: `keyterm:True`); berdoa (ID: `keyterm:Pray`); Tassel (ID: `realia:Tassel`); Stade (ID: `realia:Stade`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); adat istiadat (ID: `keyterm:Teaching`); hati (ID: `keyterm:Heart`); pencemaran (ID: `keyterm:Defilement`); Pharisees (ID: `group:Pharisee`); menjadi murid (ID: `keyterm:Disciple`); persembahan (ID: `keyterm:Offering`); menghujat (ID: `keyterm:Blaspheme`); sembah (ID: `keyterm:Worship`); A Group of Disciples (ID: `group:GenericDisciples`); perintah (ID: `keyterm:Commandment`); Yesaya (ID: `person:Isaiah`); Yerusalem (ID: `place:Jerusalem`); sorgawi (ID: `keyterm:Heavenly`); persundalan (ID: `keyterm:Fornication`); perumpamaan (ID: `keyterm:Parable`); Yesus (ID: `person:Jesus.2`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); Petrus (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Dog (ID: `fauna:Dog`); Tirus (ID: `place:Tyre`); Syrophonecian Woman (ID: `person:SyrophonecianWoman`); Sidon (ID: `place:Sidon`); percaya (ID: `keyterm:Believe`); baik (ID: `keyterm:Honest`); menyembah (ID: `keyterm:BowDown`); meminta (ID: `keyterm:AskFor`); Daud (ID: `person:David`); kerasukan setan (ID: `keyterm:DemonPossessed`); Canaanites (ID: `group:Canaan`); Israel (ID: `person:Israel`); belas kasihan (ID: `keyterm:Mercy`); menjadi murid (ID: `keyterm:Disciple`); Kanaan (ID: `place:Canaan`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Fish (ID: `fauna:Fish`); Magadan (ID: `place:Magadan`); rahmat (ID: `keyterm:Affection`); Tuhan (ID: `deity:Lord`); Israel (ID: `person:Israel`); kemuliaan (ID: `keyterm:Glory`); Sea of Galilee (ID: `place:GalileeSea`); melayani (ID: `keyterm:Serve`); Ship (ID: `realia:Ship`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Sadducees (ID: `group:Sadducee`); Pharisees (ID: `group:Pharisee`); sorga (ID: `keyterm:Heaven`); tanda (ID: `keyterm:Example`); Yesus (ID: `person:Jesus.2`); Basket (ID: `realia:Basket`); kurang percaya (ID: `keyterm:HavingLittleFaith`); bimbang (ID: `keyterm:Discern`); menjadi murid (ID: `keyterm:Disciple`); Yunus (ID: `person:Jonah.2`); tidak setia (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Petrus (ID: `person:Peter`); menjadi murid (ID: `keyterm:Disciple`); Tuhan (ID: `deity:Lord`); kehidupan (ID: `keyterm:Life`); sorga (ID: `keyterm:Heaven`); Kaisarea (ID: `place:CaesareaPhilippi`); jemaat (ID: `keyterm:Church`); meminta (ID: `keyterm:AskFor`); memerintahkan (ID: `keyterm:Command`); berbahagialah (ID: `keyterm:Happy`); A Group of Disciples (ID: `group:GenericDisciples`); Elia (ID: `person:Elijah`); kerajaan (ID: `keyterm:Kingdom`); memikirkan (ID: `keyterm:Think`); Yohanes (ID: `person:John.4`); An Angel (ID: `deity:Angel`); Yerusalem (ID: `place:Jerusalem`); penyesatan (ID: `keyterm:StumblingBlock`); pembaptis (ID: `keyterm:Baptist`); Hell (ID: `place:Hell`); alam maut (ID: `keyterm:WorldOfTheDead`); Iblis (ID: `deity:Satan`); keahlian (ID: `keyterm:Ability`); tubuh (ID: `keyterm:Body.3`); darah (ID: `keyterm:Blood`); kebangkitan (ID: `keyterm:Resurrection`); Yeremia (ID: `person:Jeremiah.6`); keselamatan (ID: `keyterm:Salvation`); kemuliaan (ID: `keyterm:Glory`); Yohanes (ID: `person:John`); Key (ID: `realia:Key`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Elia (ID: `person:Elijah`); Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); takut (ID: `keyterm:Fear`); Musa (ID: `person:Moses`); Petrus (ID: `person:Peter`); kebangkitan (ID: `keyterm:Resurrection`); pembaptis (ID: `keyterm:Baptist`); kerajaan (ID: `keyterm:Kingdom`); memerintahkan (ID: `keyterm:Command`); amin! (ID: `keyterm:Surely`); kekasih (ID: `keyterm:Beloved`); Yakobus (ID: `person:James`); Yohanes (ID: `person:John.2`); Yohanes (ID: `person:John`); Clothing (ID: `realia:Clothing`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Petrus (ID: `person:Peter`); menjadi murid (ID: `keyterm:Disciple`); melayani (ID: `keyterm:Serve`); memerintahkan (ID: `keyterm:Command`); tidak setia (ID: `keyterm:Unfaithful`); A Group of Disciples (ID: `group:GenericDisciples`); cukai (ID: `keyterm:Tax`); Demons (ID: `deity:Demons`); belas kasihan (ID: `keyterm:Mercy`); Galilea (ID: `place:Galilee`); kebangkitan (ID: `keyterm:Resurrection`); percaya (ID: `keyterm:Believe`); Kapernaum (ID: `place:Capernaum`); pajak (ID: `keyterm:PollTax`); amin! (ID: `keyterm:Surely`); Mustard (ID: `flora:Mustard`); Stater (ID: `realia:Stater`); Fishhook (ID: `realia:Fishhook`); Two-Drachma Piece (ID: `realia:Two-drachmaPiece`); House (ID: `realia:House`); Fish (ID: `fauna:Fish`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** sorga (ID: `keyterm:Heaven`); menyesatkan (ID: `keyterm:CauseToStumble`); kerajaan (ID: `keyterm:Kingdom`); kehidupan (ID: `keyterm:Life`); penyesatan (ID: `keyterm:StumblingBlock`); Disaster (ID: `keyterm:Disaster`); An Angel (ID: `deity:Angel`); selama, lamanya (ID: `keyterm:Always`); nama (ID: `keyterm:Name`); Hell (ID: `place:Hell`); keahlian (ID: `keyterm:Ability`); api kekal (ID: `keyterm:EternalFire`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`); neraka (ID: `keyterm:Gehenna`); Yesus (ID: `person:Jesus.2`); amin! (ID: `keyterm:Surely`); menjadi murid (ID: `keyterm:Disciple`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** mengampuni (ID: `keyterm:Forgive`); berhutang (ID: `keyterm:Owe`); sorga (ID: `keyterm:Heaven`); meminta (ID: `keyterm:AskFor`); Tuhan (ID: `deity:Lord`); berbuat dosa (ID: `keyterm:Sin`); amin! (ID: `keyterm:Surely`); saksi (ID: `keyterm:Witness`); hati (ID: `keyterm:Heart`); kerajaan (ID: `keyterm:Kingdom`); belas kasihan (ID: `keyterm:Mercy`); nama (ID: `keyterm:Name`); rahmat (ID: `keyterm:Affection`); menyembah (ID: `keyterm:BowDown`); sorgawi (ID: `keyterm:Heavenly`); pemungut cukai (ID: `keyterm:TaxCollector`); Yesus (ID: `person:Jesus.2`); jemaat (ID: `keyterm:Church`); utang (ID: `keyterm:Debt`); Petrus (ID: `person:Peter`); firman (ID: `keyterm:Word`); Prison (ID: `realia:Prison`); Denarius (ID: `realia:Denarius`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** sorga (ID: `keyterm:Heaven`); memerintahkan (ID: `keyterm:Command`); kerajaan (ID: `keyterm:Kingdom`); Musa (ID: `person:Moses`); tubuh (ID: `keyterm:Body.3`); Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Yehuda (ID: `place:Judea`); Pharisees (ID: `group:Pharisee`); ketegaran hati (ID: `keyterm:Hardheartedness`); Be Lawful (ID: `keyterm:Lawful`); Galilea (ID: `place:Galilee`); Tuhan (ID: `deity:Lord`); persundalan (ID: `keyterm:Fornication`); berdoa (ID: `keyterm:Pray`); Yordan (ID: `place:Jordan`); melayani (ID: `keyterm:Serve`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); kehidupan (ID: `keyterm:Life`); sorga (ID: `keyterm:Heaven`); kerajaan (ID: `keyterm:Kingdom`); Rich Young Ruler (ID: `person:RichYoungRuler`); selama, lamanya (ID: `keyterm:Always`); Tuhan (ID: `deity:Lord`); yang baik (ID: `keyterm:Good`); amin! (ID: `keyterm:Surely`); menjadi murid (ID: `keyterm:Disciple`); meminta (ID: `keyterm:AskFor`); penciptaan kembali (ID: `keyterm:NewWorld`); perintah (ID: `keyterm:Commandment`); memutuskan (ID: `keyterm:Decided`); nama (ID: `keyterm:Name`); persundalan (ID: `keyterm:Fornication`); keselamatan (ID: `keyterm:Salvation`); Israel (ID: `person:Israel`); Petrus (ID: `person:Peter`); kemuliaan (ID: `keyterm:Glory`); kasihi (ID: `keyterm:Love`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`); House (ID: `realia:House`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Denarius (ID: `realia:Denarius`); sia, sia (ID: `keyterm:Idle`); bertindak jahat (ID: `keyterm:ActWickedly`); sorga (ID: `keyterm:Heaven`); yang baik (ID: `keyterm:Good`); kerajaan (ID: `keyterm:Kingdom`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Be Lawful (ID: `keyterm:Lawful`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Yerusalem (ID: `place:Jerusalem`); memerintahkan (ID: `keyterm:Command`); Daud (ID: `person:David`); belas kasihan (ID: `keyterm:Mercy`); melayani (ID: `keyterm:Serve`); kekuasaan (ID: `keyterm:Authority.2`); Zebedeus (ID: `person:Zebedee`); kerajaan (ID: `keyterm:Kingdom`); Yerikho (ID: `place:Jericho`); rahmat (ID: `keyterm:Affection`); menyembah (ID: `keyterm:BowDown`); menentang (ID: `keyterm:Condemn`); Tuhan (ID: `deity:Lord`); Gentiles (ID: `group:Gentile`); kehidupan (ID: `keyterm:Life`); kebangkitan (ID: `keyterm:Resurrection`); tebusan (ID: `keyterm:Ransom`); menjadi murid (ID: `keyterm:Disciple`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Yerusalem (ID: `place:Jerusalem`); Donkey (ID: `fauna:Donkey`); hosana (ID: `keyterm:Hosanna`); Daud (ID: `person:David`); menjadi murid (ID: `keyterm:Disciple`); Clothing (ID: `realia:Clothing`); Betfage (ID: `place:Bethphage`); memerintahkan (ID: `keyterm:Command`); memberkati (ID: `keyterm:Bless`); Nazaret (ID: `place:Nazareth`); Galilea (ID: `place:Galilee`); nama (ID: `keyterm:Name`); Betania (ID: `place:Bethany`); A Group of People (ID: `group:GenericGroup`); Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); menggenapi (ID: `keyterm:Happen`); tempat yang tinggi (ID: `keyterm:Height`); melayani (ID: `keyterm:Serve`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** percaya (ID: `keyterm:Believe`); kekuasaan (ID: `keyterm:Authority.2`); Yesus (ID: `person:Jesus.2`); keahlian (ID: `keyterm:Ability`); Fig (ID: `flora:Fig`); Yohanes (ID: `person:John`); baptisan (ID: `keyterm:Baptism`); sorga (ID: `keyterm:Heaven`); meminta (ID: `keyterm:AskFor`); takut (ID: `keyterm:Fear`); amin! (ID: `keyterm:Surely`); selama, lamanya (ID: `keyterm:Always`); berdoa (ID: `keyterm:Pray`); bimbang (ID: `keyterm:Discern`); menjadi murid (ID: `keyterm:Disciple`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Tuhan (ID: `deity:Lord`); pemungut cukai (ID: `keyterm:TaxCollector`); bertobat (ID: `keyterm:Repent`); kerajaan (ID: `keyterm:Kingdom`); perumpamaan (ID: `keyterm:Parable`); Yesus (ID: `person:Jesus.2`); membuang (ID: `keyterm:Reject`); kitab suci (ID: `keyterm:Scripture`); Pharisees (ID: `group:Pharisee`); takut (ID: `keyterm:Fear`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); percaya (ID: `keyterm:Believe`); amin! (ID: `keyterm:Surely`); Yohanes (ID: `person:John`); Winepress (ID: `realia:Winepress`); Cornerstone (ID: `realia:Cornerstone`); Tower (ID: `realia:Tower`); Watch-Tower (ID: `realia:Watch-tower`); Thorn Hedge (ID: `realia:ThornHedge`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); sorga (ID: `keyterm:Heaven`); yang baik (ID: `keyterm:Good`); kerajaan (ID: `keyterm:Kingdom`); perumpamaan (ID: `keyterm:Parable`); Yesus (ID: `person:Jesus.2`); memerintahkan (ID: `keyterm:Command`); orang pilihan (ID: `keyterm:Chosen`); kertak (ID: `keyterm:OuterDarkness`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kebangkitan (ID: `keyterm:Resurrection`); Tiberius (ID: `person:Tiberius`); Yesus (ID: `person:Jesus.2`); pajak (ID: `keyterm:PollTax`); Herodians (ID: `group:Herodian`); Sadducees (ID: `group:Sadducee`); Israel (ID: `person:Israel`); kitab suci (ID: `keyterm:Scripture`); sorga (ID: `keyterm:Heaven`); benar (ID: `keyterm:True`); Ishak (ID: `person:Isaac`); Abraham (ID: `person:Abraham`); Pharisees (ID: `group:Pharisee`); An Angel (ID: `deity:Angel`); Be Lawful (ID: `keyterm:Lawful`); jalan tuhan (ID: `keyterm:TheWay`); kebenaran (ID: `keyterm:Truth`); keahlian (ID: `keyterm:Ability`); Musa (ID: `person:Moses`); kehidupan (ID: `keyterm:Life`); menjadi murid (ID: `keyterm:Disciple`); Money (ID: `realia:Money`); Denarius (ID: `realia:Denarius`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); perintah (ID: `keyterm:Commandment`); Daud (ID: `person:David`); Pharisees (ID: `group:Pharisee`); Yesus (ID: `person:Jesus.2`); kasihi (ID: `keyterm:Love`); hukum (ID: `keyterm:Law`); hati (ID: `keyterm:Heart`); pikiran (ID: `keyterm:Mind.2`); Roh (ID: `deity:HolySpirit`); Sadducees (ID: `group:Sadducee`)
...
* **Associated ACAI Concepts:** Pharisees (ID: `group:Pharisee`); Disaster (ID: `keyterm:Disaster`); Temple (ID: `realia:Temple`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`); neraka (ID: `keyterm:Gehenna`); membersihkan (ID: `keyterm:Cleanse.2`); persembahan (ID: `keyterm:Offering`); sorga (ID: `keyterm:Heaven`); wajib (ID: `keyterm:Ought`); darah (ID: `keyterm:Blood`); dikhususkan (ID: `keyterm:Consecration.2`); Yesus (ID: `person:Jesus.2`); penghakiman (ID: `keyterm:Judgment`); kemunafikan (ID: `keyterm:Hypocrisy`); Yoyada (ID: `person:Jehoiada.2`); Zakharia (ID: `person:Zechariah.12`); suci (ID: `keyterm:Clean`); Synagogue (ID: `realia:Synagogue`); Grave (ID: `realia:Grave`); bersaksi (ID: `keyterm:BearWitness`); pengadilan (ID: `keyterm:CourtCase`); persahabatan (ID: `keyterm:Friendship`); memberkati (ID: `keyterm:Bless`); kerajaan (ID: `keyterm:Kingdom`); belas kasihan (ID: `keyterm:Mercy`); Yerusalem (ID: `place:Jerusalem`); tak kenal hukum (ID: `keyterm:Lawless`); Habel (ID: `person:Abel`); nama (ID: `keyterm:Name`); Hell (ID: `place:Hell`); sorgawi (ID: `keyterm:Heavenly`); Musa (ID: `person:Moses`); pencemaran (ID: `keyterm:Defilement`); hukum (ID: `keyterm:Law`); percaya (ID: `keyterm:Believe`); amin! (ID: `keyterm:Surely`); menjadi murid (ID: `keyterm:Disciple`); Dill (ID: `flora:Dill`); Mint (ID: `flora:Mint`); Phylactery (ID: `realia:Phylactery`); Mosquito (ID: `fauna:Mosquito`); Plate (ID: `realia:Plate.2`); Cumin (ID: `flora:Cumin`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Snake (ID: `fauna:Snake`); Tassel (ID: `realia:Tassel`); Cross (ID: `realia:Cross`); Camel (ID: `fauna:Camel`); Bird (ID: `fauna:Bird`); Throne (ID: `realia:Throne`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); nama (ID: `keyterm:Name`); kerajaan (ID: `keyterm:Kingdom`); menjadi murid (ID: `keyterm:Disciple`); bersaksi (ID: `keyterm:BearWitness`); keselamatan (ID: `keyterm:Salvation`); keahlian (ID: `keyterm:Ability`); tak kenal hukum (ID: `keyterm:Lawless`); amin! (ID: `keyterm:Surely`); selama, lamanya (ID: `keyterm:Always`); tanda (ID: `keyterm:Example`); injil (ID: `keyterm:GoodNews`); memberitakan (ID: `keyterm:Proclaim`); kasihi (ID: `keyterm:Love`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** sorga (ID: `keyterm:Heaven`); orang pilihan (ID: `keyterm:Chosen`); Nuh (ID: `person:Noah`); tanda (ID: `keyterm:Example`); An Angel (ID: `deity:Angel`); keahlian (ID: `keyterm:Ability`); percaya (ID: `keyterm:Believe`); Yesus (ID: `person:Jesus.2`); amin! (ID: `keyterm:Surely`); kesetiaan (ID: `keyterm:Faithfulness`); Daniel (ID: `person:Daniel.3`); House (ID: `realia:House`); hati (ID: `keyterm:Heart`); mujizat (ID: `keyterm:Portent`); pembinasa keji (ID: `keyterm:AbominationOfDesolation`); berbahagialah (ID: `keyterm:Happy`); Yehuda (ID: `place:Judea`); Disaster (ID: `keyterm:Disaster`); Tuhan (ID: `deity:Lord`); tubuh (ID: `keyterm:Body.3`); berdoa (ID: `keyterm:Pray`); keselamatan (ID: `keyterm:Salvation`); perumpamaan (ID: `keyterm:Parable`); sabat (ID: `keyterm:Sabbath`); khusus (ID: `keyterm:Holy`); kemuliaan (ID: `keyterm:Glory`); Vulture (ID: `fauna:Vulture`); Inner Room (ID: `realia:InnerRoom`); Trumpet (ID: `realia:Trumpet`); Housetop (ID: `realia:Housetop`); Door (ID: `realia:Door`); Fig (ID: `flora:Fig`); Tabernacle (ID: `realia:Tabernacle`); Cloak (ID: `realia:Cloak`); Hand-Mill (ID: `realia:Hand-mill`); Boat (ID: `realia:Boat`)
...
* **Associated ACAI Concepts:** Lamp (ID: `realia:Lamp`); Olive Oil (ID: `realia:OliveOil`); sorga (ID: `keyterm:Heaven`); kerajaan (ID: `keyterm:Kingdom`); amin! (ID: `keyterm:Surely`); Container (ID: `realia:Container`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** Talent (ID: `realia:Talent`); yang baik (ID: `keyterm:Good`); kesetiaan (ID: `keyterm:Faithfulness`); Cause of Joy (ID: `keyterm:CauseOfJoy`); takut (ID: `keyterm:Fear`); keahlian (ID: `keyterm:Ability`); kertak (ID: `keyterm:OuterDarkness`)
...
* **Associated ACAI Concepts:** Prison (ID: `realia:Prison`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); selama, lamanya (ID: `keyterm:Always`); Yesus (ID: `person:Jesus.2`); amin! (ID: `keyterm:Surely`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Kid (ID: `fauna:Kid`); memberkati (ID: `keyterm:Bless`); kerajaan (ID: `keyterm:Kingdom`); api kekal (ID: `keyterm:EternalFire`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); kehidupan (ID: `keyterm:Life`); kemuliaan (ID: `keyterm:Glory`); melayani (ID: `keyterm:Serve`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Simon (ID: `person:Simon.4`); Betania (ID: `place:Bethany`); Yudas (ID: `person:Judas.2`); paskah (ID: `keyterm:Passover`); keahlian (ID: `keyterm:Ability`); amin! (ID: `keyterm:Surely`); Kayafas (ID: `person:Caiaphas`); tubuh (ID: `keyterm:Body.3`); injil (ID: `keyterm:GoodNews`); memberitakan (ID: `keyterm:Proclaim`); Alabaster Jar (ID: `realia:AlabasterJar`); House (ID: `realia:House`); Courtyard (ID: `realia:Courtyard`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); paskah (ID: `keyterm:Passover`); darah (ID: `keyterm:Blood`); tubuh (ID: `keyterm:Body.3`); kerajaan (ID: `keyterm:Kingdom`); mengampuni (ID: `keyterm:Forgive`); Yudas (ID: `person:Judas.2`); berbuat dosa (ID: `keyterm:Sin`); amin! (ID: `keyterm:Surely`); Disaster (ID: `keyterm:Disaster`); Tuhan (ID: `deity:Lord`); perjanjian (ID: `keyterm:Covenant`); memberkati (ID: `keyterm:Bless`); Vine (ID: `flora:Vine`); Bowl (ID: `realia:Bowl.2`); Olive Tree (ID: `flora:OliveTree`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); Petrus (ID: `person:Peter`); menjadi murid (ID: `keyterm:Disciple`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); Getsemani (ID: `place:Gethsemane`); roh (ID: `keyterm:Spirit.2`); kebangkitan (ID: `keyterm:Resurrection`); Zebedeus (ID: `person:Zebedee`); mencobai (ID: `keyterm:PutToTheTest`); amin! (ID: `keyterm:Surely`); tubuh (ID: `keyterm:Body.3`); Galilea (ID: `place:Galilee`); Rooster (ID: `fauna:Rooster`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Olive Tree (ID: `flora:OliveTree`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); menggenapi (ID: `keyterm:Happen`); kitab suci (ID: `keyterm:Scripture`); meminta (ID: `keyterm:AskFor`); Yudas (ID: `person:Judas.2`); Tuhan (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); tanda (ID: `keyterm:Example`); menjadi murid (ID: `keyterm:Disciple`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); Kayafas (ID: `person:Caiaphas`); sorga (ID: `keyterm:Heaven`); menghujat (ID: `keyterm:Blaspheme`); saksi (ID: `keyterm:Witness`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); keahlian (ID: `keyterm:Ability`); Petrus (ID: `person:Peter`); kehidupan (ID: `keyterm:Life`); Courtyard (ID: `realia:Courtyard`); Temple (ID: `realia:Temple`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Petrus (ID: `person:Peter`); Rooster (ID: `fauna:Rooster`); sumpah (ID: `keyterm:Oath`); A Group of People (ID: `group:GenericGroup`); Galileans (ID: `group:Galilee`); benar (ID: `keyterm:True`); Nazaret (ID: `place:Nazareth`); Galilea (ID: `place:Galilee`); A Servant (ID: `person:GenericServant`); firman (ID: `keyterm:Word`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Akeldama (ID: `place:Akeldama`); darah (ID: `keyterm:Blood`); Pilatus (ID: `person:Pilate`); pemeliharaanmu (ID: `place:Corban`); Priests (ID: `group:GenericPriests`); Yeremia (ID: `person:Jeremiah.6`); menggenapi (ID: `keyterm:Happen`); Yesus (ID: `person:Jesus.2`); Yudas (ID: `person:Judas.2`); berbuat dosa (ID: `keyterm:Sin`); menentang (ID: `keyterm:Condemn`); Tuhan (ID: `deity:Lord`); bertobat (ID: `keyterm:Repent`); Israel (ID: `person:Israel`); Be Lawful (ID: `keyterm:Lawful`); Temple (ID: `realia:Temple`); Treasury (ID: `realia:Treasury`)
...
* **Associated ACAI Concepts:** Barabas (ID: `person:Barabbas`); Yesus (ID: `person:Jesus.2`); Pilatus (ID: `person:Pilate`); A Group of People (ID: `group:GenericGroup`); Cross (ID: `realia:Cross`); darah (ID: `keyterm:Blood`); Jews (ID: `group:Jews`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); membujuk (ID: `keyterm:Persuade`); firman (ID: `keyterm:Word`); Judgment Seat (ID: `realia:JudgmentSeat`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); keselamatan (ID: `keyterm:Salvation`); Yesus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Clothing (ID: `realia:Clothing`); Reed (ID: `flora:Reed`); Cloak (ID: `realia:Cloak`); Kirene (ID: `place:Cyrene`); Simon (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); hati (ID: `keyterm:Heart`); menghujat (ID: `keyterm:Blaspheme`); membujuk (ID: `keyterm:Persuade`); nama (ID: `keyterm:Name`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`); Israel (ID: `person:Israel`); menyelamatkan (ID: `keyterm:Deliver`); Crown (ID: `realia:Crown.2`); Brier (ID: `flora:Brier`); Wine (ID: `realia:Wine`); Acacia (ID: `flora:Acacia`); Crown (ID: `realia:Crown`); Temple (ID: `realia:Temple`); Palace (ID: `realia:Palace`); Boxthorn (ID: `flora:Boxthorn`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Grave (ID: `realia:Grave`); kebangkitan (ID: `keyterm:Resurrection`); Pilatus (ID: `person:Pilate`); tubuh (ID: `keyterm:Body.3`); Yusuf (ID: `person:Joseph.6`); Maria (ID: `person:Marymagdalene`); Maria (ID: `person:Mary.2`); Elia (ID: `person:Elijah`); A Group of People (ID: `group:GenericGroup`); khusus (ID: `keyterm:Holy`); menjadi murid (ID: `keyterm:Disciple`); Zebedeus (ID: `person:Zebedee`); Yakobus (ID: `person:James.4`); Arimatea (ID: `place:Arimathea`); Yusuf (ID: `person:Joseph.5`); benar (ID: `keyterm:True`); Pharisees (ID: `group:Pharisee`); takut (ID: `keyterm:Fear`); Galilea (ID: `place:Galilee`); nama (ID: `keyterm:Name`); Tuhan (ID: `deity:Lord`); kehidupan (ID: `keyterm:Life`); suci (ID: `keyterm:Clean`); keselamatan (ID: `keyterm:Salvation`); roh (ID: `keyterm:Spirit.2`); melayani (ID: `keyterm:Serve`); Seal (ID: `realia:Seal`); Sour Wine (ID: `realia:SourWine`); Reed (ID: `flora:Reed`); Curtain (ID: `realia:Curtain`); Temple (ID: `realia:Temple`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** takut (ID: `keyterm:Fear`); Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); kebangkitan (ID: `keyterm:Resurrection`); An Angel (ID: `deity:Angel`); Galilea (ID: `place:Galilee`); Grave (ID: `realia:Grave`); Angels (ID: `group:Angels`); minggu (ID: `keyterm:Week`); sorga (ID: `keyterm:Heaven`); membujuk (ID: `keyterm:Persuade`); menyembah (ID: `keyterm:BowDown`); Tuhan (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); sabat (ID: `keyterm:Sabbath`); Jews (ID: `group:Jews`); Maria (ID: `person:Marymagdalene`); Maria (ID: `person:Mary.2`); Clothing (ID: `realia:Clothing`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** menjadi murid (ID: `keyterm:Disciple`); Yesus (ID: `person:Jesus.2`); kekuasaan (ID: `keyterm:Authority.2`); nama (ID: `keyterm:Name`); baptisan (ID: `keyterm:Baptism`); sorga (ID: `keyterm:Heaven`); Roh (ID: `deity:HolySpirit`); menyembah (ID: `keyterm:BowDown`); keahlian (ID: `keyterm:Ability`); memerintahkan (ID: `keyterm:Command`); Tuhan (ID: `deity:Lord`); selama, lamanya (ID: `keyterm:Always`); Galilea (ID: `place:Galilee`)
