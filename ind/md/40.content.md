...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Daud (ID: `person:David`); Babel (ID: `place:Babylon`); Abraham (ID: `person:Abraham`); Yakub (ID: `person:Jacob.2`); Azor (ID: `person:Azor`); Zerubabel (ID: `person:Zerubbabel.2`); Eliud (ID: `person:Eliud`); memperanakkan (ID: `person:Salmon`); Hizkia (ID: `person:Hezekiah`); raja (ID: `person:Jehoiachin`); Salomo (ID: `person:Solomon`); Ram (ID: `person:Ram`); Asa (ID: `person:Asa`); Uzia (ID: `person:Uzziah`); Yosia (ID: `person:Josiah`); Yehuda (ID: `person:Judah.4`); Isai (ID: `person:Jesse`); Abia (ID: `person:Abijah.4`); Rahab (ID: `person:Rahab`); Peres (ID: `person:Perez`); Uria (ID: `person:Uriah`); Zerah (ID: `person:Zerah.3`); Hezron (ID: `person:Hezron.2`); Zadok (ID: `person:Zadok`); Tamar (ID: `person:Tamar`); Yosafat (ID: `person:Jehoshaphat.3`); Yoram (ID: `person:Jehoram`); Eleazar (ID: `person:Eleazar`); Yusuf (ID: `person:Joseph.4`); Boas (ID: `person:Boaz`); Nahason (ID: `person:Nahshon`); Rehabeam (ID: `person:Rehoboam`); Ahas (ID: `person:Ahaz`); Akhim (ID: `person:Achim`); Elyakim (ID: `person:Eliakim`); Aminadab (ID: `person:Amminadab`); Amon (ID: `person:Amon.3`); Israel (ID: `person:Israel`); Yotam (ID: `person:Jotham.2`); Abihud (ID: `person:Abiud`); Obed (ID: `person:Obed`); Ishak (ID: `person:Isaac`); Matan (ID: `person:Matthan`); Sealtiel (ID: `person:Shealtiel.2`); Maria (ID: `person:Mary`); Manasye (ID: `person:Manasseh.2`); Rut (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Yusuf (ID: `person:Joseph.4`); Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); Maria (ID: `person:Mary`); An Angel (ID: `deity:Angel`); Roh (ID: `deity:HolySpirit`); menggenapi (ID: `keyterm:Happen`); bertunangan (ID: `keyterm:Engaged`); keselamatan (ID: `keyterm:Salvation`); berbuat dosa (ID: `keyterm:Sin`); takut (ID: `keyterm:Fear`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Daud (ID: `person:David`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod`); Betlehem (ID: `place:Bethlehem`); Mesir (ID: `place:Egypt`); menyembah (ID: `keyterm:BowDown`); Tuhan (ID: `deity:Lord`); menggenapi (ID: `keyterm:Happen`); Yehuda (ID: `place:Judea`); Israel (ID: `person:Israel`); Yusuf (ID: `person:Joseph.4`); Yerusalem (ID: `place:Jerusalem`); Yesus (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); Yeremia (ID: `person:Jeremiah.6`); Arkhelaus (ID: `person:Archelaus`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Nazaret (ID: `place:Nazareth`); Rahel (ID: `person:Rachel`); kehidupan (ID: `keyterm:Life`); menasihati (ID: `keyterm:Encourage`); Yehuda (ID: `person:Judah.4`); Galilea (ID: `place:Galilee`); A Priest (ID: `person:GenericPriest`); persembahan (ID: `keyterm:Offering`); Maria (ID: `person:Mary`); Priests (ID: `group:GenericPriests`); takut (ID: `keyterm:Fear`); meminta (ID: `keyterm:AskFor`); Ramah (ID: `place:Ramah.2`); Jews (ID: `group:Jews`); Religious Officials (ID: `group:ReligiousOfficials`); Myrrh (ID: `flora:Myrrh`); Frankincense (ID: `flora:Frankincense`); Money Box (ID: `realia:MoneyBox`); Myrrh (ID: `realia:Myrrh`); Incense (ID: `realia:Incense`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** bertobat (ID: `keyterm:Repent`); baptisan (ID: `keyterm:Baptism`); Yohanes (ID: `person:John`); Yehuda (ID: `place:Judea`); Tuhan (ID: `deity:Lord`); Yordan (ID: `place:Jordan`); Yesaya (ID: `person:Isaiah`); pembaptis (ID: `keyterm:Baptist`); Yerusalem (ID: `place:Jerusalem`); memberitakan (ID: `keyterm:Proclaim`); bersihkan (ID: `keyterm:CleanOut`); kerajaan (ID: `keyterm:Kingdom`); berbuat dosa (ID: `keyterm:Sin`); kebenaran (ID: `keyterm:Straightness`); Sadducees (ID: `group:Sadducee`); Abraham (ID: `person:Abraham`); sorga (ID: `keyterm:Heaven`); Roh (ID: `deity:HolySpirit`); Pharisees (ID: `group:Pharisee`); Winnowing Fork (ID: `realia:WinnowingFork`); Belt (ID: `realia:Belt`); Locust (ID: `fauna:Locust`); Leather (ID: `realia:Leather`); Sandal (ID: `realia:Sandal`); Threshing Floor (ID: `realia:ThreshingFloor`); Bag (ID: `realia:Bag`); Wheat (ID: `flora:Wheat`); Camel (ID: `fauna:Camel`); Barn (ID: `realia:Barn`); Clothing (ID: `realia:Clothing`); Axe (ID: `realia:Axe`); Grain (ID: `flora:Grain`); Bee (ID: `fauna:Bee`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** baptisan (ID: `keyterm:Baptism`); Yesus (ID: `person:Jesus.2`); sorga (ID: `keyterm:Heaven`); Yohanes (ID: `person:John`); Yordan (ID: `place:Jordan`); menggenapi (ID: `keyterm:Happen`); kekasih (ID: `keyterm:Beloved`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`); Roh (ID: `deity:HolySpirit`); Galilea (ID: `place:Galilee`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); mencobai (ID: `keyterm:PutToTheTest`); menyembah (ID: `keyterm:BowDown`); An Angel (ID: `deity:Angel`); memerintahkan (ID: `keyterm:Command`); melayani (ID: `keyterm:Serve`); firman (ID: `keyterm:Word`); kemuliaan (ID: `keyterm:Glory`); keahlian (ID: `keyterm:Ability`); kehidupan (ID: `keyterm:Life`); kerajaan (ID: `keyterm:Kingdom`); khusus (ID: `keyterm:Holy`); berpuasa (ID: `keyterm:Fast`); imamat (ID: `keyterm:Priesthood`); Iblis (ID: `deity:Satan`); Roh (ID: `deity:HolySpirit`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Galilea (ID: `place:Galilee`); Naftali (ID: `person:Naphtali`); Zebulon (ID: `group:Zebulun`); Zebulon (ID: `person:Zebulun`); memberitakan (ID: `keyterm:Proclaim`); bertobat (ID: `keyterm:Repent`); Nazaret (ID: `place:Nazareth`); kerajaan (ID: `keyterm:Kingdom`); menggenapi (ID: `keyterm:Happen`); sorga (ID: `keyterm:Heaven`); Yesaya (ID: `person:Isaiah`); Gentiles (ID: `group:Gentile`); Yesus (ID: `person:Jesus.2`); Kapernaum (ID: `place:Capernaum`); Yohanes (ID: `person:John`); Yordan (ID: `place:Jordan`)
...
* **Associated ACAI Concepts:** Casting Net (ID: `realia:CastingNet`); Galilea (ID: `place:Galilee`); melayani (ID: `keyterm:Serve`); Andreas (ID: `person:Andrew`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); injil (ID: `keyterm:GoodNews`); Zebedeus (ID: `person:Zebedee`); Dekapolis (ID: `place:Decapolis`); Yakobus (ID: `person:James`); Yohanes (ID: `person:John.2`); Sea of Galilee (ID: `place:GalileeSea`); Yerusalem (ID: `place:Jerusalem`); kerasukan setan (ID: `keyterm:DemonPossessed`); memberitakan (ID: `keyterm:Proclaim`); kerajaan (ID: `keyterm:Kingdom`); Petrus (ID: `person:Peter`); Yehuda (ID: `place:Judea`); Yordan (ID: `place:Jordan`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** berbahagialah (ID: `keyterm:Happy`); sorga (ID: `keyterm:Heaven`); kerajaan (ID: `keyterm:Kingdom`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tuhan (ID: `deity:Lord`); hati (ID: `keyterm:Heart`); belas kasihan (ID: `keyterm:Mercy`); menjadi murid (ID: `keyterm:Disciple`); roh (ID: `keyterm:Spirit.2`); menasihati (ID: `keyterm:Encourage`); suci (ID: `keyterm:Clean`); meminta (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** sorga (ID: `keyterm:Heaven`); hukum (ID: `keyterm:Law`); kerajaan (ID: `keyterm:Kingdom`); perintah (ID: `keyterm:Commandment`); kemuliaan (ID: `keyterm:Glory`); keahlian (ID: `keyterm:Ability`); amin! (ID: `keyterm:Surely`); Pharisees (ID: `group:Pharisee`); Tuhan (ID: `deity:Lord`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); House (ID: `realia:House`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); persundalan (ID: `keyterm:Fornication`); neraka (ID: `keyterm:Gehenna`); kasihi (ID: `keyterm:Love`); Hell (ID: `place:Hell`); pengadilan (ID: `keyterm:CourtCase`); tubuh (ID: `keyterm:Body.3`); menyesatkan (ID: `keyterm:CauseToStumble`); persembahan (ID: `keyterm:Offering`); penghakiman (ID: `keyterm:Judgment`); sorga (ID: `keyterm:Heaven`); memperdamaikan (ID: `keyterm:Reconcile`); sorgawi (ID: `keyterm:Heavenly`); sumpah (ID: `keyterm:Oath`); yang baik (ID: `keyterm:Good`); Yerusalem (ID: `place:Jerusalem`); amin! (ID: `keyterm:Surely`); pemungut cukai (ID: `keyterm:TaxCollector`); hati (ID: `keyterm:Heart`); memutuskan (ID: `keyterm:Decided`); berdoa (ID: `keyterm:Pray`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Mile (ID: `realia:Mile`); Footstool (ID: `realia:Footstool`); Cloak (ID: `realia:Cloak`); Quadrans (ID: `realia:Quadrans`); Throne (ID: `realia:Throne`); Tunic (ID: `realia:Tunic.2`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); sorga (ID: `keyterm:Heaven`); mengampuni (ID: `keyterm:Forgive`); amin! (ID: `keyterm:Surely`); Synagogue (ID: `realia:Synagogue`); kerajaan (ID: `keyterm:Kingdom`); membawa masuk (ID: `keyterm:BringIn`); kemuliaan (ID: `keyterm:Glory`); bersalah (ID: `keyterm:Wrong`); nama (ID: `keyterm:Name`); khusus (ID: `keyterm:Holy`); mencobai (ID: `keyterm:PutToTheTest`); menyelamatkan (ID: `keyterm:Deliver`); sorgawi (ID: `keyterm:Heavenly`); persahabatan (ID: `keyterm:Friendship`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Inner Room (ID: `realia:InnerRoom`); Cornerstone (ID: `realia:Cornerstone`); Door (ID: `realia:Door`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); berpuasa (ID: `keyterm:Fast`); tubuh (ID: `keyterm:Body.3`); sorgawi (ID: `keyterm:Heavenly`); sorga (ID: `keyterm:Heaven`); Clothing (ID: `realia:Clothing`); Moth (ID: `fauna:Moth`); kurang percaya (ID: `keyterm:HavingLittleFaith`); kemuliaan (ID: `keyterm:Glory`); kasihi (ID: `keyterm:Love`); amin! (ID: `keyterm:Surely`); kehidupan (ID: `keyterm:Life`); Salomo (ID: `person:Solomon`); diurapi (ID: `keyterm:Anointed`); hati (ID: `keyterm:Heart`); melayani (ID: `keyterm:Serve.2`); kerajaan (ID: `keyterm:Kingdom`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Oven (ID: `realia:Oven`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Barn (ID: `realia:Barn`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Beam (ID: `realia:Beam`); memutuskan (ID: `keyterm:Decided`); hukum (ID: `keyterm:Law`); sorga (ID: `keyterm:Heaven`); khusus (ID: `keyterm:Holy`); penghakiman (ID: `keyterm:Judgment`); Tuhan (ID: `deity:Lord`); Fish (ID: `fauna:Fish`); Snake (ID: `fauna:Snake`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); Dog (ID: `fauna:Dog`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); menghancurkan (ID: `keyterm:Destroy`); tak kenal hukum (ID: `keyterm:Lawless`); keahlian (ID: `keyterm:Ability`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); kehidupan (ID: `keyterm:Life`); kerajaan (ID: `keyterm:Kingdom`); nama (ID: `keyterm:Name`); Tuhan (ID: `deity:Lord`); sorga (ID: `keyterm:Heaven`); Demons (ID: `deity:Demons`); Sheep (ID: `fauna:Lamb`); Wolf (ID: `fauna:Wolf`); Thistle (ID: `flora:Thistle`); Boxthorn (ID: `flora:Boxthorn`); Clothing (ID: `realia:Clothing`); Vine (ID: `flora:Vine`); Acacia (ID: `flora:Acacia`); Brier (ID: `flora:Brier`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); keahlian (ID: `keyterm:Ability`); Yesus (ID: `person:Jesus.2`); kekuasaan (ID: `keyterm:Authority.2`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); melayani (ID: `keyterm:Serve`); membersihkan (ID: `keyterm:Cleanse.2`); percaya (ID: `keyterm:Believe`); kerajaan (ID: `keyterm:Kingdom`); Israel (ID: `person:Israel`); House (ID: `realia:House`); kerasukan setan (ID: `keyterm:DemonPossessed`); penyakit kulit menular (ID: `keyterm:InfectiousSkinDisease`); Centurion With Sick Servant (ID: `person:Centurion.2`); keahlian (ID: `keyterm:Ability`); amin! (ID: `keyterm:Surely`); persembahan (ID: `keyterm:Offering`); Petrus (ID: `person:Peter`); kekuasaan (ID: `keyterm:Authority.2`); menyembah (ID: `keyterm:BowDown`); Abraham (ID: `person:Abraham`); menggenapi (ID: `keyterm:Happen`); sorga (ID: `keyterm:Heaven`); Yesaya (ID: `person:Isaiah`); memerintahkan (ID: `keyterm:Command`); meminta (ID: `keyterm:AskFor`); kertak (ID: `keyterm:OuterDarkness`); Musa (ID: `person:Moses`); Kapernaum (ID: `place:Capernaum`); Ishak (ID: `person:Isaac`); bersaksi (ID: `keyterm:BearWitness`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); kerasukan setan (ID: `keyterm:DemonPossessed`); menjadi murid (ID: `keyterm:Disciple`); meminta (ID: `keyterm:AskFor`); Ship (ID: `realia:Ship`); memerintahkan (ID: `keyterm:Command`); A Disciple (ID: `person:GenericDisciple`); kurang percaya (ID: `keyterm:HavingLittleFaith`); Religious Official (ID: `person:ReligiousOfficial`); sorga (ID: `keyterm:Heaven`); kekuasaan (ID: `keyterm:Authority.2`); Gerasa (ID: `place:Gerasa`); keselamatan (ID: `keyterm:Salvation`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); berbuat dosa (ID: `keyterm:Sin`); mengampuni (ID: `keyterm:Forgive`); menjadi murid (ID: `keyterm:Disciple`); House (ID: `realia:House`); pemungut cukai (ID: `keyterm:TaxCollector`); keahlian (ID: `keyterm:Ability`); berpuasa (ID: `keyterm:Fast`); kekuasaan (ID: `keyterm:Authority.2`); Pharisees (ID: `group:Pharisee`); Bed (ID: `realia:Bed`); Temple (ID: `realia:Temple`); belas kasihan (ID: `keyterm:Mercy`); Matius (ID: `person:Matthew`); kemuliaan (ID: `keyterm:Glory`); hati (ID: `keyterm:Heart`); persembahan (ID: `keyterm:Offering`); Tuhan (ID: `deity:Lord`); Yohanes (ID: `person:John`); takut (ID: `keyterm:Fear`); menghujat (ID: `keyterm:Blaspheme`); percaya (ID: `keyterm:Believe`); percayalah (ID: `keyterm:CheerUp`); Be Healthy (ID: `keyterm:Healthy`); rumah cukai (ID: `keyterm:TaxOffice`); Religious Officials (ID: `group:ReligiousOfficials`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Patch (ID: `realia:Patch`); Must (ID: `realia:Must`); Ship (ID: `realia:Ship`); Clothing (ID: `realia:Clothing`); Skin-Bottle (ID: `realia:Skin-bottle`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); menjadi murid (ID: `keyterm:Disciple`); Demons (ID: `deity:Demons`); keselamatan (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`); House (ID: `realia:House`); rahmat (ID: `keyterm:Affection`); kerasukan setan (ID: `keyterm:DemonPossessed`); injil (ID: `keyterm:GoodNews`); memberitakan (ID: `keyterm:Proclaim`); kehidupan (ID: `keyterm:Life`); kerajaan (ID: `keyterm:Kingdom`); menyembah (ID: `keyterm:BowDown`); Daud (ID: `person:David`); belas kasihan (ID: `keyterm:Mercy`); berdarah (ID: `keyterm:Bleed`); meminta (ID: `keyterm:AskFor`); melayani (ID: `keyterm:Serve`); Israel (ID: `person:Israel`); Pharisees (ID: `group:Pharisee`); percayalah (ID: `keyterm:CheerUp`); Tassel (ID: `realia:Tassel`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Flute (ID: `realia:Flute`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); melayani (ID: `keyterm:Serve`); Bag (ID: `realia:Bag`); Bartolomeus (ID: `person:Bartholomew`); Alfeus (ID: `person:Alphaeus`); Yudas (ID: `person:Judas.2`); Filipus (ID: `person:Philip`); Tomas (ID: `person:Thomas`); Zelot (ID: `group:Zealot`); Simon (ID: `person:Simon.2`); memperdamaikan (ID: `keyterm:Peace`); Yudas (ID: `person:Judas`); Yakobus (ID: `person:James.2`); keahlian (ID: `keyterm:Ability`); Zebedeus (ID: `person:Zebedee`); memberitakan (ID: `keyterm:Proclaim`); Gomora (ID: `place:Gomorrah`); amin! (ID: `keyterm:Surely`); Yesus (ID: `person:Jesus.2`); pemungut cukai (ID: `keyterm:TaxCollector`); Samaritans (ID: `group:Samaritan`); kerajaan (ID: `keyterm:Kingdom`); nama (ID: `keyterm:Name`); Petrus (ID: `person:Peter`); penghakiman (ID: `keyterm:Judgment`); kekuasaan (ID: `keyterm:Authority.2`); sorga (ID: `keyterm:Heaven`); membersihkan (ID: `keyterm:Cleanse.2`); kebangkitan (ID: `keyterm:Resurrection`); Andreas (ID: `person:Andrew`); Samaria (ID: `place:Samaria`); Yakobus (ID: `person:James`); pengadilan (ID: `keyterm:CourtCase`); menjadi murid (ID: `keyterm:Disciple`); Israel (ID: `person:Israel`); Sodom (ID: `place:Sodom`); Demons (ID: `deity:Demons`); Gentiles (ID: `group:Gentile`); Yohanes (ID: `person:John.2`); Matius (ID: `person:Matthew`); Sheep (ID: `fauna:Lamb`); Belt (ID: `realia:Belt`); Tunic (ID: `realia:Tunic.2`); Staff (ID: `realia:Staff`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); takut (ID: `keyterm:Fear`); menjadi murid (ID: `keyterm:Disciple`); amin! (ID: `keyterm:Surely`); sorga (ID: `keyterm:Heaven`); Sparrow (ID: `fauna:Sparrow`); neraka (ID: `keyterm:Gehenna`); tubuh (ID: `keyterm:Body.3`); memberitakan (ID: `keyterm:Proclaim`); kehidupan (ID: `keyterm:Life`); Hell (ID: `place:Hell`); bersaksi (ID: `keyterm:BearWitness`); memerintahkan (ID: `keyterm:Command`); Iblis (ID: `deity:Satan`); Roh (ID: `deity:HolySpirit`); memperdamaikan (ID: `keyterm:Peace`); Israel (ID: `person:Israel`); Gentiles (ID: `group:Gentile`); persahabatan (ID: `keyterm:Friendship`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); keselamatan (ID: `keyterm:Salvation`); Wolf (ID: `fauna:Wolf`); Assarion (ID: `realia:Assarion`); Housetop (ID: `realia:Housetop`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Dove (ID: `fauna:Dove`); Snake (ID: `fauna:Snake`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Yohanes (ID: `person:John`); Yesus (ID: `person:Jesus.2`); pembaptis (ID: `keyterm:Baptist`); kerajaan (ID: `keyterm:Kingdom`); sorga (ID: `keyterm:Heaven`); menjadi murid (ID: `keyterm:Disciple`); injil (ID: `keyterm:GoodNews`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); memberitakan (ID: `keyterm:Proclaim`); amin! (ID: `keyterm:Surely`); Elia (ID: `person:Elijah`); pemungut cukai (ID: `keyterm:TaxCollector`); berbahagialah (ID: `keyterm:Happy`); An Angel (ID: `deity:Angel`); hukum (ID: `keyterm:Law`); membersihkan (ID: `keyterm:Cleanse.2`); kebangkitan (ID: `keyterm:Resurrection`); Demons (ID: `deity:Demons`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Reed (ID: `flora:Reed`); House (ID: `realia:House`); Flute (ID: `realia:Flute`); Prison (ID: `realia:Prison`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); Tirus (ID: `place:Tyre`); Sidon (ID: `place:Sidon`); bertobat (ID: `keyterm:Repent`); penghakiman (ID: `keyterm:Judgment`); sorga (ID: `keyterm:Heaven`); pengadilan (ID: `keyterm:CourtCase`); Sodom (ID: `place:Sodom`); Yoke (ID: `realia:Yoke`); Khorazim (ID: `place:Chorazin`); Disaster (ID: `keyterm:Disaster`); alam maut (ID: `keyterm:WorldOfTheDead`); Yesus (ID: `person:Jesus.2`); hati (ID: `keyterm:Heart`); Hell (ID: `place:Hell`); Betsaida (ID: `place:Bethsaida`); yang baik (ID: `keyterm:Good`); Kapernaum (ID: `place:Capernaum`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** sabat (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); Temple (ID: `realia:Temple`); menjadi murid (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); Sheep (ID: `fauna:Lamb`); hukum (ID: `keyterm:Law`); persembahan (ID: `keyterm:Offering`); pencemaran (ID: `keyterm:Defilement`); Yesus (ID: `person:Jesus.2`); menentang (ID: `keyterm:Condemn`); Tuhan (ID: `deity:Lord`); Daud (ID: `person:David`); belas kasihan (ID: `keyterm:Mercy`); Wheat (ID: `flora:Wheat`); House (ID: `realia:House`); Synagogue (ID: `realia:Synagogue`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** Gentiles (ID: `group:Gentile`); penghakiman (ID: `keyterm:Judgment`); menggenapi (ID: `keyterm:Happen`); Yesaya (ID: `person:Isaiah`); nama (ID: `keyterm:Name`); memerintahkan (ID: `keyterm:Command`); kekasih (ID: `keyterm:Beloved`); harapan (ID: `keyterm:Hope`); Yesus (ID: `person:Jesus.2`); melayani (ID: `keyterm:Serve`); Roh (ID: `deity:HolySpirit`); Lamp (ID: `realia:Lamp`); Reed (ID: `flora:Reed`)
...
* **Associated ACAI Concepts:** kerajaan (ID: `keyterm:Kingdom`); Iblis (ID: `deity:Satan`); Roh (ID: `deity:HolySpirit`); Demons (ID: `deity:Demons`); yang baik (ID: `keyterm:Good`); mengampuni (ID: `keyterm:Forgive`); penghakiman (ID: `keyterm:Judgment`); menghujat (ID: `keyterm:Blaspheme`); menentang (ID: `keyterm:Condemn`); keahlian (ID: `keyterm:Ability`); kerasukan setan (ID: `keyterm:DemonPossessed`); hati (ID: `keyterm:Heart`); sia, sia (ID: `keyterm:Idle`); selama, lamanya (ID: `keyterm:Always`); berbuat dosa (ID: `keyterm:Sin`); firman (ID: `keyterm:Word`); Tuhan (ID: `deity:Lord`); Daud (ID: `person:David`); melayani (ID: `keyterm:Serve`); pengadilan (ID: `keyterm:CourtCase`); Pharisees (ID: `group:Pharisee`); House (ID: `realia:House`); Snake (ID: `fauna:Snake`); Cobra (ID: `fauna:Cobra`)
...
* **Associated ACAI Concepts:** Yunus (ID: `person:Jonah.2`); tanda (ID: `keyterm:Example`); penghakiman (ID: `keyterm:Judgment`); pengadilan (ID: `keyterm:CourtCase`); Niniwe (ID: `group:Nineveh`); negeri (ID: `person:QueenOfSheba`); memberitakan (ID: `keyterm:Proclaim`); Salomo (ID: `person:Solomon`); hati (ID: `keyterm:Heart`); bertobat (ID: `keyterm:Repent`); Tuhan (ID: `deity:Lord`); tidak setia (ID: `keyterm:Unfaithful`); sorga (ID: `keyterm:Heaven`); A Group of People (ID: `group:GenericGroup`); menjadi murid (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); Niniwe (ID: `place:Nineveh`); Fish (ID: `fauna:Fish`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** perumpamaan (ID: `keyterm:Parable`); hati (ID: `keyterm:Heart`); kerajaan (ID: `keyterm:Kingdom`); Brier (ID: `flora:Brier`); Thistle (ID: `flora:Thistle`); Boxthorn (ID: `flora:Boxthorn`); Acacia (ID: `flora:Acacia`); keahlian (ID: `keyterm:Ability`); amin! (ID: `keyterm:Surely`); Yesus (ID: `person:Jesus.2`); berbahagialah (ID: `keyterm:Happy`); Cause of Joy (ID: `keyterm:CauseOfJoy`); selama, lamanya (ID: `keyterm:Always`); sorga (ID: `keyterm:Heaven`); Yesaya (ID: `person:Isaiah`); menjadi murid (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Rooster (ID: `fauna:Rooster`); Ship (ID: `realia:Ship`); House (ID: `realia:House`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** kerajaan (ID: `keyterm:Kingdom`); sorga (ID: `keyterm:Heaven`); perumpamaan (ID: `keyterm:Parable`); Weed (ID: `flora:Weed`); Grain (ID: `flora:Grain`); selama, lamanya (ID: `keyterm:Always`); An Angel (ID: `deity:Angel`); Wheat (ID: `flora:Wheat`); menjadi murid (ID: `keyterm:Disciple`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Kiln (ID: `realia:Kiln`); Grass (ID: `flora:Grass`); keahlian (ID: `keyterm:Ability`); Yesus (ID: `person:Jesus.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Tuhan (ID: `deity:Lord`); menggenapi (ID: `keyterm:Happen`); tak kenal hukum (ID: `keyterm:Lawless`); penyesatan (ID: `keyterm:StumblingBlock`); Storeroom (ID: `realia:Storeroom`); Dragnet (ID: `realia:Dragnet`); Mustard (ID: `flora:Mustard`); Saton (ID: `realia:Saton`); Barn (ID: `realia:Barn`); House (ID: `realia:House`); Container (ID: `realia:Container`)
...
* **Associated ACAI Concepts:** Yohanes (ID: `person:John`); Yesus (ID: `person:Jesus.2`); Herodes (ID: `person:Herod.2`); keahlian (ID: `keyterm:Ability`); Herodias (ID: `person:Herodias`); sumpah (ID: `keyterm:Oath`); pembaptis (ID: `keyterm:Baptist`); Prison (ID: `realia:Prison`); Plate (ID: `realia:Plate.2`); tidak percaya (ID: `keyterm:Disbelieve`); Yudas (ID: `person:Jude`); Yakobus (ID: `person:James.3`); Filipus (ID: `person:Philip.2`); Simon (ID: `person:Simon.3`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Be Lawful (ID: `keyterm:Lawful`); Yusuf (ID: `person:Joseph.4`); Maria (ID: `person:Mary`); perumpamaan (ID: `keyterm:Parable`); takut (ID: `keyterm:Fear`); kebangkitan (ID: `keyterm:Resurrection`); menjadi murid (ID: `keyterm:Disciple`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** menjadi murid (ID: `keyterm:Disciple`); Yesus (ID: `person:Jesus.2`); Fish (ID: `fauna:Fish`); sorga (ID: `keyterm:Heaven`); memberkati (ID: `keyterm:Bless`); melayani (ID: `keyterm:Serve`); rahmat (ID: `keyterm:Affection`); Basket (ID: `realia:Basket`); Grass (ID: `flora:Grass`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); takut (ID: `keyterm:Fear`); Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); Petrus (ID: `person:Peter`); keselamatan (ID: `keyterm:Salvation`); kurang percaya (ID: `keyterm:HavingLittleFaith`); percayalah (ID: `keyterm:CheerUp`); Genesaret (ID: `place:Gennesaret`); meminta (ID: `keyterm:AskFor`); benar (ID: `keyterm:True`); menyembah (ID: `keyterm:BowDown`); berdoa (ID: `keyterm:Pray`); Stade (ID: `realia:Stade`); Tassel (ID: `realia:Tassel`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); adat istiadat (ID: `keyterm:Teaching`); hati (ID: `keyterm:Heart`); pencemaran (ID: `keyterm:Defilement`); menjadi murid (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); Yerusalem (ID: `place:Jerusalem`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); Yesus (ID: `person:Jesus.2`); persundalan (ID: `keyterm:Fornication`); perintah (ID: `keyterm:Commandment`); persembahan (ID: `keyterm:Offering`); Petrus (ID: `person:Peter`); sorgawi (ID: `keyterm:Heavenly`); perumpamaan (ID: `keyterm:Parable`); Yesaya (ID: `person:Isaiah`); menghujat (ID: `keyterm:Blaspheme`); A Group of Disciples (ID: `group:GenericDisciples`); sembah (ID: `keyterm:Worship`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Dog (ID: `fauna:Dog`); Syrophonecian Woman (ID: `person:SyrophonecianWoman`); Sidon (ID: `place:Sidon`); Tirus (ID: `place:Tyre`); menjadi murid (ID: `keyterm:Disciple`); kerasukan setan (ID: `keyterm:DemonPossessed`); Israel (ID: `person:Israel`); percaya (ID: `keyterm:Believe`); Kanaan (ID: `place:Canaan`); baik (ID: `keyterm:Honest`); meminta (ID: `keyterm:AskFor`); menyembah (ID: `keyterm:BowDown`); Daud (ID: `person:David`); belas kasihan (ID: `keyterm:Mercy`); Canaanites (ID: `group:Canaan`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** menjadi murid (ID: `keyterm:Disciple`); Yesus (ID: `person:Jesus.2`); A Group of Disciples (ID: `group:GenericDisciples`); Fish (ID: `fauna:Fish`); Magadan (ID: `place:Magadan`); kemuliaan (ID: `keyterm:Glory`); Israel (ID: `person:Israel`); Sea of Galilee (ID: `place:GalileeSea`); melayani (ID: `keyterm:Serve`); Tuhan (ID: `deity:Lord`); rahmat (ID: `keyterm:Affection`); Ship (ID: `realia:Ship`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Sadducees (ID: `group:Sadducee`); Pharisees (ID: `group:Pharisee`); sorga (ID: `keyterm:Heaven`); tanda (ID: `keyterm:Example`); Yesus (ID: `person:Jesus.2`); Basket (ID: `realia:Basket`); menjadi murid (ID: `keyterm:Disciple`); tidak setia (ID: `keyterm:Unfaithful`); bimbang (ID: `keyterm:Discern`); kurang percaya (ID: `keyterm:HavingLittleFaith`); Yunus (ID: `person:Jonah.2`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Petrus (ID: `person:Peter`); menjadi murid (ID: `keyterm:Disciple`); kehidupan (ID: `keyterm:Life`); Tuhan (ID: `deity:Lord`); sorga (ID: `keyterm:Heaven`); Kaisarea (ID: `place:CaesareaPhilippi`); jemaat (ID: `keyterm:Church`); Yerusalem (ID: `place:Jerusalem`); keahlian (ID: `keyterm:Ability`); kemuliaan (ID: `keyterm:Glory`); Yeremia (ID: `person:Jeremiah.6`); darah (ID: `keyterm:Blood`); tubuh (ID: `keyterm:Body.3`); Elia (ID: `person:Elijah`); Hell (ID: `place:Hell`); berbahagialah (ID: `keyterm:Happy`); kerajaan (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); Yohanes (ID: `person:John`); memikirkan (ID: `keyterm:Think`); Yohanes (ID: `person:John.4`); memerintahkan (ID: `keyterm:Command`); kebangkitan (ID: `keyterm:Resurrection`); pembaptis (ID: `keyterm:Baptist`); Iblis (ID: `deity:Satan`); penyesatan (ID: `keyterm:StumblingBlock`); meminta (ID: `keyterm:AskFor`); A Group of Disciples (ID: `group:GenericDisciples`); alam maut (ID: `keyterm:WorldOfTheDead`); keselamatan (ID: `keyterm:Salvation`); Key (ID: `realia:Key`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Elia (ID: `person:Elijah`); Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); Petrus (ID: `person:Peter`); takut (ID: `keyterm:Fear`); Musa (ID: `person:Moses`); kerajaan (ID: `keyterm:Kingdom`); memerintahkan (ID: `keyterm:Command`); kekasih (ID: `keyterm:Beloved`); amin! (ID: `keyterm:Surely`); Yohanes (ID: `person:John.2`); kebangkitan (ID: `keyterm:Resurrection`); pembaptis (ID: `keyterm:Baptist`); Yohanes (ID: `person:John`); Yakobus (ID: `person:James`); Clothing (ID: `realia:Clothing`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Petrus (ID: `person:Peter`); melayani (ID: `keyterm:Serve`); menjadi murid (ID: `keyterm:Disciple`); amin! (ID: `keyterm:Surely`); Galilea (ID: `place:Galilee`); cukai (ID: `keyterm:Tax`); belas kasihan (ID: `keyterm:Mercy`); tidak setia (ID: `keyterm:Unfaithful`); memerintahkan (ID: `keyterm:Command`); pajak (ID: `keyterm:PollTax`); percaya (ID: `keyterm:Believe`); kebangkitan (ID: `keyterm:Resurrection`); Demons (ID: `deity:Demons`); A Group of Disciples (ID: `group:GenericDisciples`); Kapernaum (ID: `place:Capernaum`); Two-Drachma Piece (ID: `realia:Two-drachmaPiece`); Fishhook (ID: `realia:Fishhook`); Mustard (ID: `flora:Mustard`); Stater (ID: `realia:Stater`); Fish (ID: `fauna:Fish`); Grain (ID: `flora:Grain`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** sorga (ID: `keyterm:Heaven`); menyesatkan (ID: `keyterm:CauseToStumble`); kerajaan (ID: `keyterm:Kingdom`); kehidupan (ID: `keyterm:Life`); penyesatan (ID: `keyterm:StumblingBlock`); keahlian (ID: `keyterm:Ability`); amin! (ID: `keyterm:Surely`); Yesus (ID: `person:Jesus.2`); api kekal (ID: `keyterm:EternalFire`); Hell (ID: `place:Hell`); selama, lamanya (ID: `keyterm:Always`); nama (ID: `keyterm:Name`); An Angel (ID: `deity:Angel`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`); neraka (ID: `keyterm:Gehenna`); menjadi murid (ID: `keyterm:Disciple`); Disaster (ID: `keyterm:Disaster`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** amin! (ID: `keyterm:Surely`); sorga (ID: `keyterm:Heaven`); Tuhan (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** mengampuni (ID: `keyterm:Forgive`); berhutang (ID: `keyterm:Owe`); sorga (ID: `keyterm:Heaven`); amin! (ID: `keyterm:Surely`); berbuat dosa (ID: `keyterm:Sin`); Tuhan (ID: `deity:Lord`); meminta (ID: `keyterm:AskFor`); saksi (ID: `keyterm:Witness`); Yesus (ID: `person:Jesus.2`); pemungut cukai (ID: `keyterm:TaxCollector`); utang (ID: `keyterm:Debt`); hati (ID: `keyterm:Heart`); kerajaan (ID: `keyterm:Kingdom`); nama (ID: `keyterm:Name`); firman (ID: `keyterm:Word`); Petrus (ID: `person:Peter`); menyembah (ID: `keyterm:BowDown`); sorgawi (ID: `keyterm:Heavenly`); belas kasihan (ID: `keyterm:Mercy`); rahmat (ID: `keyterm:Affection`); jemaat (ID: `keyterm:Church`); Denarius (ID: `realia:Denarius`); Talent (ID: `realia:Talent`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** tubuh (ID: `keyterm:Body.3`); Yesus (ID: `person:Jesus.2`); kerajaan (ID: `keyterm:Kingdom`); sorga (ID: `keyterm:Heaven`); memerintahkan (ID: `keyterm:Command`); Musa (ID: `person:Moses`); menjadi murid (ID: `keyterm:Disciple`); Be Lawful (ID: `keyterm:Lawful`); persundalan (ID: `keyterm:Fornication`); Galilea (ID: `place:Galilee`); Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); Yehuda (ID: `place:Judea`); melayani (ID: `keyterm:Serve`); ketegaran hati (ID: `keyterm:Hardheartedness`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisees (ID: `group:Pharisee`); Yordan (ID: `place:Jordan`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); kehidupan (ID: `keyterm:Life`); amin! (ID: `keyterm:Surely`); selama, lamanya (ID: `keyterm:Always`); kerajaan (ID: `keyterm:Kingdom`); Tuhan (ID: `deity:Lord`); sorga (ID: `keyterm:Heaven`); yang baik (ID: `keyterm:Good`); menjadi murid (ID: `keyterm:Disciple`); Rich Young Ruler (ID: `person:RichYoungRuler`); kemuliaan (ID: `keyterm:Glory`); kasihi (ID: `keyterm:Love`); persundalan (ID: `keyterm:Fornication`); perintah (ID: `keyterm:Commandment`); memutuskan (ID: `keyterm:Decided`); nama (ID: `keyterm:Name`); penciptaan kembali (ID: `keyterm:NewWorld`); Petrus (ID: `person:Peter`); meminta (ID: `keyterm:AskFor`); Israel (ID: `person:Israel`); keselamatan (ID: `keyterm:Salvation`); Camel (ID: `fauna:Camel`); Needle (ID: `realia:Needle`); Throne (ID: `realia:Throne`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Denarius (ID: `realia:Denarius`); sia, sia (ID: `keyterm:Idle`); kerajaan (ID: `keyterm:Kingdom`); bertindak jahat (ID: `keyterm:ActWickedly`); sorga (ID: `keyterm:Heaven`); yang baik (ID: `keyterm:Good`); Be Lawful (ID: `keyterm:Lawful`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Yerusalem (ID: `place:Jerusalem`); Daud (ID: `person:David`); belas kasihan (ID: `keyterm:Mercy`); memerintahkan (ID: `keyterm:Command`); melayani (ID: `keyterm:Serve`); Zebedeus (ID: `person:Zebedee`); kehidupan (ID: `keyterm:Life`); Yerikho (ID: `place:Jericho`); kerajaan (ID: `keyterm:Kingdom`); kekuasaan (ID: `keyterm:Authority.2`); Tuhan (ID: `deity:Lord`); menyembah (ID: `keyterm:BowDown`); rahmat (ID: `keyterm:Affection`); tebusan (ID: `keyterm:Ransom`); kebangkitan (ID: `keyterm:Resurrection`); menjadi murid (ID: `keyterm:Disciple`); Gentiles (ID: `group:Gentile`); menentang (ID: `keyterm:Condemn`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Yerusalem (ID: `place:Jerusalem`); Donkey (ID: `fauna:Donkey`); hosana (ID: `keyterm:Hosanna`); Daud (ID: `person:David`); menjadi murid (ID: `keyterm:Disciple`); Clothing (ID: `realia:Clothing`); Betfage (ID: `place:Bethphage`); Galilea (ID: `place:Galilee`); nama (ID: `keyterm:Name`); memberkati (ID: `keyterm:Bless`); Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); menggenapi (ID: `keyterm:Happen`); memerintahkan (ID: `keyterm:Command`); A Group of People (ID: `group:GenericGroup`); Nazaret (ID: `place:Nazareth`); Betania (ID: `place:Bethany`); melayani (ID: `keyterm:Serve`); tempat yang tinggi (ID: `keyterm:Height`); Seat (ID: `realia:Seat`); Dove (ID: `fauna:Dove`); House (ID: `realia:House`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** keahlian (ID: `keyterm:Ability`); percaya (ID: `keyterm:Believe`); Yesus (ID: `person:Jesus.2`); kekuasaan (ID: `keyterm:Authority.2`); Fig (ID: `flora:Fig`); Yohanes (ID: `person:John`); menjadi murid (ID: `keyterm:Disciple`); sorga (ID: `keyterm:Heaven`); bimbang (ID: `keyterm:Discern`); amin! (ID: `keyterm:Surely`); takut (ID: `keyterm:Fear`); berdoa (ID: `keyterm:Pray`); baptisan (ID: `keyterm:Baptism`); meminta (ID: `keyterm:AskFor`); selama, lamanya (ID: `keyterm:Always`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Tuhan (ID: `deity:Lord`); pemungut cukai (ID: `keyterm:TaxCollector`); Yesus (ID: `person:Jesus.2`); kerajaan (ID: `keyterm:Kingdom`); bertobat (ID: `keyterm:Repent`); perumpamaan (ID: `keyterm:Parable`); membuang (ID: `keyterm:Reject`); amin! (ID: `keyterm:Surely`); Yohanes (ID: `person:John`); takut (ID: `keyterm:Fear`); percaya (ID: `keyterm:Believe`); kitab suci (ID: `keyterm:Scripture`); Pharisees (ID: `group:Pharisee`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Cornerstone (ID: `realia:Cornerstone`); Winepress (ID: `realia:Winepress`); Tower (ID: `realia:Tower`); Thorn Hedge (ID: `realia:ThornHedge`); Watch-Tower (ID: `realia:Watch-tower`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); kerajaan (ID: `keyterm:Kingdom`); sorga (ID: `keyterm:Heaven`); memerintahkan (ID: `keyterm:Command`); yang baik (ID: `keyterm:Good`); Yesus (ID: `person:Jesus.2`); kertak (ID: `keyterm:OuterDarkness`); orang pilihan (ID: `keyterm:Chosen`); perumpamaan (ID: `keyterm:Parable`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kebangkitan (ID: `keyterm:Resurrection`); Yesus (ID: `person:Jesus.2`); Tiberius (ID: `person:Tiberius`); pajak (ID: `keyterm:PollTax`); Sadducees (ID: `group:Sadducee`); Herodians (ID: `group:Herodian`); Israel (ID: `person:Israel`); keahlian (ID: `keyterm:Ability`); kebenaran (ID: `keyterm:Truth`); kehidupan (ID: `keyterm:Life`); Be Lawful (ID: `keyterm:Lawful`); An Angel (ID: `deity:Angel`); jalan tuhan (ID: `keyterm:TheWay`); benar (ID: `keyterm:True`); Abraham (ID: `person:Abraham`); sorga (ID: `keyterm:Heaven`); kitab suci (ID: `keyterm:Scripture`); Musa (ID: `person:Moses`); menjadi murid (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); Ishak (ID: `person:Isaac`); Denarius (ID: `realia:Denarius`); Money (ID: `realia:Money`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); perintah (ID: `keyterm:Commandment`); Daud (ID: `person:David`); hukum (ID: `keyterm:Law`); kasihi (ID: `keyterm:Love`); Yesus (ID: `person:Jesus.2`); Pharisees (ID: `group:Pharisee`); pikiran (ID: `keyterm:Mind.2`); hati (ID: `keyterm:Heart`); Roh (ID: `deity:HolySpirit`); Sadducees (ID: `group:Sadducee`)
...
* **Associated ACAI Concepts:** Pharisees (ID: `group:Pharisee`); Disaster (ID: `keyterm:Disaster`); Temple (ID: `realia:Temple`); Tuhan (ID: `deity:Lord`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); neraka (ID: `keyterm:Gehenna`); darah (ID: `keyterm:Blood`); Yesus (ID: `person:Jesus.2`); wajib (ID: `keyterm:Ought`); persembahan (ID: `keyterm:Offering`); penghakiman (ID: `keyterm:Judgment`); sorga (ID: `keyterm:Heaven`); membersihkan (ID: `keyterm:Cleanse.2`); dikhususkan (ID: `keyterm:Consecration.2`); Zakharia (ID: `person:Zechariah.12`); Yoyada (ID: `person:Jehoiada.2`); suci (ID: `keyterm:Clean`); kemunafikan (ID: `keyterm:Hypocrisy`); Synagogue (ID: `realia:Synagogue`); Grave (ID: `realia:Grave`); Yerusalem (ID: `place:Jerusalem`); Habel (ID: `person:Abel`); amin! (ID: `keyterm:Surely`); Hell (ID: `place:Hell`); kerajaan (ID: `keyterm:Kingdom`); bersaksi (ID: `keyterm:BearWitness`); memberkati (ID: `keyterm:Bless`); nama (ID: `keyterm:Name`); sorgawi (ID: `keyterm:Heavenly`); belas kasihan (ID: `keyterm:Mercy`); hukum (ID: `keyterm:Law`); tak kenal hukum (ID: `keyterm:Lawless`); percaya (ID: `keyterm:Believe`); Musa (ID: `person:Moses`); menjadi murid (ID: `keyterm:Disciple`); pengadilan (ID: `keyterm:CourtCase`); pencemaran (ID: `keyterm:Defilement`); persahabatan (ID: `keyterm:Friendship`); Seat (ID: `realia:Seat`); Mosquito (ID: `fauna:Mosquito`); Cumin (ID: `flora:Cumin`); Dill (ID: `flora:Dill`); Plate (ID: `realia:Plate.2`); Phylactery (ID: `realia:Phylactery`); Mint (ID: `flora:Mint`); Camel (ID: `fauna:Camel`); Throne (ID: `realia:Throne`); Tassel (ID: `realia:Tassel`); Rooster (ID: `fauna:Rooster`); House (ID: `realia:House`); Snake (ID: `fauna:Snake`); Cross (ID: `realia:Cross`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); kerajaan (ID: `keyterm:Kingdom`); menjadi murid (ID: `keyterm:Disciple`); nama (ID: `keyterm:Name`); keahlian (ID: `keyterm:Ability`); injil (ID: `keyterm:GoodNews`); keselamatan (ID: `keyterm:Salvation`); tanda (ID: `keyterm:Example`); memberitakan (ID: `keyterm:Proclaim`); kasihi (ID: `keyterm:Love`); amin! (ID: `keyterm:Surely`); tak kenal hukum (ID: `keyterm:Lawless`); bersaksi (ID: `keyterm:BearWitness`); selama, lamanya (ID: `keyterm:Always`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** sorga (ID: `keyterm:Heaven`); orang pilihan (ID: `keyterm:Chosen`); Nuh (ID: `person:Noah`); keahlian (ID: `keyterm:Ability`); amin! (ID: `keyterm:Surely`); Yesus (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); tanda (ID: `keyterm:Example`); percaya (ID: `keyterm:Believe`); Daniel (ID: `person:Daniel.3`); kesetiaan (ID: `keyterm:Faithfulness`); House (ID: `realia:House`); kemuliaan (ID: `keyterm:Glory`); tubuh (ID: `keyterm:Body.3`); mujizat (ID: `keyterm:Portent`); sabat (ID: `keyterm:Sabbath`); hati (ID: `keyterm:Heart`); berbahagialah (ID: `keyterm:Happy`); khusus (ID: `keyterm:Holy`); Tuhan (ID: `deity:Lord`); perumpamaan (ID: `keyterm:Parable`); berdoa (ID: `keyterm:Pray`); Yehuda (ID: `place:Judea`); pembinasa keji (ID: `keyterm:AbominationOfDesolation`); Disaster (ID: `keyterm:Disaster`); keselamatan (ID: `keyterm:Salvation`); Housetop (ID: `realia:Housetop`); Inner Room (ID: `realia:InnerRoom`); Vulture (ID: `fauna:Vulture`); Trumpet (ID: `realia:Trumpet`); Tabernacle (ID: `realia:Tabernacle`); Hand-Mill (ID: `realia:Hand-mill`); Cloak (ID: `realia:Cloak`); Door (ID: `realia:Door`); Boat (ID: `realia:Boat`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Lamp (ID: `realia:Lamp`); Olive Oil (ID: `realia:OliveOil`); kerajaan (ID: `keyterm:Kingdom`); sorga (ID: `keyterm:Heaven`); amin! (ID: `keyterm:Surely`); Container (ID: `realia:Container`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** Talent (ID: `realia:Talent`); kesetiaan (ID: `keyterm:Faithfulness`); yang baik (ID: `keyterm:Good`); Cause of Joy (ID: `keyterm:CauseOfJoy`); keahlian (ID: `keyterm:Ability`); takut (ID: `keyterm:Fear`); kertak (ID: `keyterm:OuterDarkness`)
...
* **Associated ACAI Concepts:** Prison (ID: `realia:Prison`); amin! (ID: `keyterm:Surely`); Yesus (ID: `person:Jesus.2`); selama, lamanya (ID: `keyterm:Always`); An Angel (ID: `deity:Angel`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Sheep (ID: `fauna:Lamb`); Kid (ID: `fauna:Kid`); Goat (ID: `fauna:Goat`); kemuliaan (ID: `keyterm:Glory`); keahlian (ID: `keyterm:Ability`); kehidupan (ID: `keyterm:Life`); api kekal (ID: `keyterm:EternalFire`); kerajaan (ID: `keyterm:Kingdom`); memberkati (ID: `keyterm:Bless`); Tuhan (ID: `deity:Lord`); melayani (ID: `keyterm:Serve`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); Myrrh (ID: `flora:Myrrh`); Myrrh (ID: `realia:Myrrh`); Simon (ID: `person:Simon.4`); Yudas (ID: `person:Judas.2`); Betania (ID: `place:Bethany`); keahlian (ID: `keyterm:Ability`); injil (ID: `keyterm:GoodNews`); Kayafas (ID: `person:Caiaphas`); tubuh (ID: `keyterm:Body.3`); memberitakan (ID: `keyterm:Proclaim`); amin! (ID: `keyterm:Surely`); paskah (ID: `keyterm:Passover`); Alabaster Jar (ID: `realia:AlabasterJar`); House (ID: `realia:House`); Cross (ID: `realia:Cross`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** menjadi murid (ID: `keyterm:Disciple`); Yesus (ID: `person:Jesus.2`); paskah (ID: `keyterm:Passover`); darah (ID: `keyterm:Blood`); tubuh (ID: `keyterm:Body.3`); kerajaan (ID: `keyterm:Kingdom`); memberkati (ID: `keyterm:Bless`); berbuat dosa (ID: `keyterm:Sin`); amin! (ID: `keyterm:Surely`); Yudas (ID: `person:Judas.2`); perjanjian (ID: `keyterm:Covenant`); Disaster (ID: `keyterm:Disaster`); Tuhan (ID: `deity:Lord`); mengampuni (ID: `keyterm:Forgive`); Bowl (ID: `realia:Bowl.2`); Vine (ID: `flora:Vine`); Sheep (ID: `fauna:Lamb`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); menggenapi (ID: `keyterm:Happen`); kitab suci (ID: `keyterm:Scripture`); menjadi murid (ID: `keyterm:Disciple`); tanda (ID: `keyterm:Example`); An Angel (ID: `deity:Angel`); Yudas (ID: `person:Judas.2`); meminta (ID: `keyterm:AskFor`); Tuhan (ID: `deity:Lord`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); Kayafas (ID: `person:Caiaphas`); keahlian (ID: `keyterm:Ability`); saksi (ID: `keyterm:Witness`); sorga (ID: `keyterm:Heaven`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); Petrus (ID: `person:Peter`); menghujat (ID: `keyterm:Blaspheme`); kehidupan (ID: `keyterm:Life`); Courtyard (ID: `realia:Courtyard`); Cloak (ID: `realia:Cloak`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Petrus (ID: `person:Peter`); Yesus (ID: `person:Jesus.2`); Rooster (ID: `fauna:Rooster`); A Servant (ID: `person:GenericServant`); sumpah (ID: `keyterm:Oath`); firman (ID: `keyterm:Word`); A Group of People (ID: `group:GenericGroup`); Nazaret (ID: `place:Nazareth`); Galileans (ID: `group:Galilee`); benar (ID: `keyterm:True`); Galilea (ID: `place:Galilee`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Akeldama (ID: `place:Akeldama`); darah (ID: `keyterm:Blood`); pemeliharaanmu (ID: `place:Corban`); Pilatus (ID: `person:Pilate`); menggenapi (ID: `keyterm:Happen`); Yeremia (ID: `person:Jeremiah.6`); Israel (ID: `person:Israel`); Priests (ID: `group:GenericPriests`); berbuat dosa (ID: `keyterm:Sin`); bertobat (ID: `keyterm:Repent`); Yudas (ID: `person:Judas.2`); menentang (ID: `keyterm:Condemn`); Yesus (ID: `person:Jesus.2`); Be Lawful (ID: `keyterm:Lawful`); Tuhan (ID: `deity:Lord`); Treasury (ID: `realia:Treasury`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Yesus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); keselamatan (ID: `keyterm:Salvation`); Clothing (ID: `realia:Clothing`); Reed (ID: `flora:Reed`); Cloak (ID: `realia:Cloak`); Simon (ID: `person:Simon.5`); Kirene (ID: `place:Cyrene`); Golgotha (ID: `place:Golgotha`); hati (ID: `keyterm:Heart`); membujuk (ID: `keyterm:Persuade`); nama (ID: `keyterm:Name`); Tuhan (ID: `deity:Lord`); menyelamatkan (ID: `keyterm:Deliver`); menghujat (ID: `keyterm:Blaspheme`); percaya (ID: `keyterm:Believe`); Israel (ID: `person:Israel`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`); Acacia (ID: `flora:Acacia`); Brier (ID: `flora:Brier`); Wine (ID: `realia:Wine`); Palace (ID: `realia:Palace`); Boxthorn (ID: `flora:Boxthorn`); Lot (ID: `realia:Lot`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Grave (ID: `realia:Grave`); kebangkitan (ID: `keyterm:Resurrection`); tubuh (ID: `keyterm:Body.3`); Pilatus (ID: `person:Pilate`); Maria (ID: `person:Marymagdalene`); Yusuf (ID: `person:Joseph.6`); Maria (ID: `person:Mary.2`); Elia (ID: `person:Elijah`); khusus (ID: `keyterm:Holy`); A Group of People (ID: `group:GenericGroup`); menjadi murid (ID: `keyterm:Disciple`); Yakobus (ID: `person:James.4`); Zebedeus (ID: `person:Zebedee`); Yusuf (ID: `person:Joseph.5`); Arimatea (ID: `place:Arimathea`); kehidupan (ID: `keyterm:Life`); Galilea (ID: `place:Galilee`); nama (ID: `keyterm:Name`); Tuhan (ID: `deity:Lord`); benar (ID: `keyterm:True`); takut (ID: `keyterm:Fear`); suci (ID: `keyterm:Clean`); melayani (ID: `keyterm:Serve`); roh (ID: `keyterm:Spirit.2`); Pharisees (ID: `group:Pharisee`); keselamatan (ID: `keyterm:Salvation`); Reed (ID: `flora:Reed`); Seal (ID: `realia:Seal`); Sour Wine (ID: `realia:SourWine`); Curtain (ID: `realia:Curtain`); Temple (ID: `realia:Temple`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** takut (ID: `keyterm:Fear`); Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); kebangkitan (ID: `keyterm:Resurrection`); Galilea (ID: `place:Galilee`); An Angel (ID: `deity:Angel`); Grave (ID: `realia:Grave`); minggu (ID: `keyterm:Week`); Angels (ID: `group:Angels`); sabat (ID: `keyterm:Sabbath`); membujuk (ID: `keyterm:Persuade`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Maria (ID: `person:Marymagdalene`); Tuhan (ID: `deity:Lord`); menyembah (ID: `keyterm:BowDown`); sorga (ID: `keyterm:Heaven`); Jews (ID: `group:Jews`); Maria (ID: `person:Mary.2`); Clothing (ID: `realia:Clothing`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** menjadi murid (ID: `keyterm:Disciple`); Yesus (ID: `person:Jesus.2`); kekuasaan (ID: `keyterm:Authority.2`); keahlian (ID: `keyterm:Ability`); sorga (ID: `keyterm:Heaven`); nama (ID: `keyterm:Name`); memerintahkan (ID: `keyterm:Command`); baptisan (ID: `keyterm:Baptism`); Tuhan (ID: `deity:Lord`); menyembah (ID: `keyterm:BowDown`); Roh (ID: `deity:HolySpirit`); Galilea (ID: `place:Galilee`); selama, lamanya (ID: `keyterm:Always`)
