...
* **Associated ACAI Concepts:** Lois (ID: `person:Lois`); Eunike (ID: `person:Eunice`); Figelus (ID: `person:Phygelus`); Hermogenes (ID: `person:Hermogenes`); Onesiforus (ID: `person:Onesiphorus`); ingin (ID: `keyterm:LongFor`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Filetus (ID: `person:Philetus`); Himeneus (ID: `person:Hymenaeus`); tahan uji (ID: `keyterm:Approved`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Yambres (ID: `person:Jambres`); Yanes (ID: `person:Jannes`); Ikonium (ID: `place:Iconium`); memberi kesaksian yang sungguh, sungguh (ID: `keyterm:Declare`); kitab suci (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** Kreskes (ID: `person:Crescens`); Klaudia (ID: `person:Claudia`); Karpus (ID: `person:Carpus`); Dalmatia (ID: `place:Dalmatia`); Pudes (ID: `person:Pudens`); Parchment (ID: `realia:Parchment`); Ebulus (ID: `person:Eubulus`); Linus (ID: `person:Linus`); Aleksander (ID: `person:Alexander.4`); Onesiforus (ID: `person:Onesiphorus`); menyelamatkan (ID: `keyterm:Deliver`); Miletus (ID: `place:Miletus`); Demas (ID: `person:Demas`); Erastus (ID: `person:Erastus`); Trofimus (ID: `person:Trophimus`); Lukas (ID: `person:Luke`); Priskila (ID: `person:Priscilla`); Yesus (ID: `person:Jesus.2`)
