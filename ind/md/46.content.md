...
* **Associated ACAI Concepts:** Kloë (ID: `person:Chloe`); Paulus (ID: `person:Paul`); Gayus (ID: `person:Gaius.3`); Krispus (ID: `person:Crispus`); Sostenes (ID: `person:Sosthenes`); Stefanus (ID: `person:Stephanas`); A Disciple (ID: `person:GenericDisciple`); baptisan (ID: `keyterm:Baptism`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** dikhususkan (ID: `keyterm:Consecration.2`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** bimbang (ID: `keyterm:Discern`); roh (ID: `keyterm:Spirit.2`); alamiah (ID: `keyterm:Natural`); Roh (ID: `deity:HolySpirit`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Apolos (ID: `person:Apollos`); manusia (ID: `keyterm:Carnal`); A Disciple (ID: `person:GenericDisciple`)
...
* **Associated ACAI Concepts:** menilai (ID: `keyterm:Interpret`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** kesetiaan (ID: `keyterm:Faithfulness`); memutuskan (ID: `keyterm:Decided`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** bertindak jahat (ID: `keyterm:ActWickedly`); pengadilan (ID: `keyterm:CourtCase`); penyembah berhala (ID: `keyterm:Idolater`)
...
* **Associated ACAI Concepts:** tubuh (ID: `keyterm:Body.3`); persundalan (ID: `keyterm:Fornication`)
...
* **Associated ACAI Concepts:** Temple of an Idol (ID: `realia:TempleOfAnIdol`); menyesatkan (ID: `keyterm:CauseToStumble`)
...
* **Associated ACAI Concepts:** dapatkan bagian (ID: `keyterm:Partake`); kekuasaan (ID: `keyterm:Authority.2`); keahlian (ID: `keyterm:Ability`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** penyembah berhala (ID: `keyterm:Idolater`); mencobai (ID: `keyterm:PutToTheTest`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** dapatkan bagian (ID: `keyterm:Partake`); persekutuan (ID: `keyterm:Fellowship`); Be Lawful (ID: `keyterm:Lawful`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Mirror (ID: `realia:Mirror`); kasihi (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** bertambah kuat (ID: `keyterm:BuildingUp`); jemaat (ID: `keyterm:Church`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`)
...
* **Associated ACAI Concepts:** kebangkitan (ID: `keyterm:Resurrection`); hampa (ID: `keyterm:Empty`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** alamiah (ID: `keyterm:Natural`); abadi (ID: `keyterm:Imperishable`); Trumpet (ID: `realia:Trumpet`); kebangkitan (ID: `keyterm:Resurrection`); tubuh (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** Fortunatus (ID: `person:Fortunatus`); Akhaikus (ID: `person:Achaicus`); Stefanus (ID: `person:Stephanas`); Priskila (ID: `person:Priscilla`); Akwila (ID: `person:Aquila`); minggu (ID: `keyterm:Week`); Akhaya (ID: `place:Achaia`); Yesus (ID: `person:Jesus.2`)
