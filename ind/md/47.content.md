...
* **Associated ACAI Concepts:** menasihati (ID: `keyterm:Encourage`); Akhaya (ID: `place:Achaia`); menyelamatkan (ID: `keyterm:Deliver`); meminta (ID: `keyterm:AskFor`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Veil (ID: `realia:Veil`); tulisan (ID: `keyterm:Letter`); Ink (ID: `realia:Ink`); menghidupkan (ID: `keyterm:Alive`); Roh (ID: `deity:HolySpirit`); kemuliaan (ID: `keyterm:Glory`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Tent (ID: `realia:Tent`); ingin (ID: `keyterm:LongFor`); tubuh (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** memperdamaikan (ID: `keyterm:Reconcile`); dalam kristus (ID: `keyterm:InChrist`); ikhlas (ID: `keyterm:Unhypocritical`); hampa (ID: `keyterm:Empty`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** menasihati (ID: `keyterm:Encourage`); bertobat (ID: `keyterm:Repent`); kerinduan (ID: `keyterm:Extremely`); murni (ID: `keyterm:Pure`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** kesungguhan (ID: `keyterm:Eagerness`); jemaat (ID: `keyterm:Church`); kebaikan (ID: `keyterm:Favor`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Fortress (ID: `realia:Fortress`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Hawa (ID: `person:Eve`); Snake (ID: `fauna:Snake`); Yesus (ID: `person:Jesus.2`)
