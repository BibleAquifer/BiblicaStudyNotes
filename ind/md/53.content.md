...
* **Associated ACAI Concepts:** Tesalonika (ID: `place:Thessalonica`); dimuliakan (ID: `keyterm:Glorified`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** adat istiadat (ID: `keyterm:Teaching`); Yesus (ID: `person:Jesus.2`)
