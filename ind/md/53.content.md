...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yesus (ID: `person:Jesus.2`); percaya (ID: `keyterm:Believe`); keahlian (ID: `keyterm:Ability`); dimuliakan (ID: `keyterm:Glorified`); jemaat (ID: `keyterm:Church`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kebaikan (ID: `keyterm:Favor`); Tesalonika (ID: `place:Thessalonica`); injil (ID: `keyterm:GoodNews`); Paulus (ID: `person:Paul`); bersaksi (ID: `keyterm:BearWitness`); kemuliaan (ID: `keyterm:Glory`); sorga (ID: `keyterm:Heaven`); kasihi (ID: `keyterm:Love`); Thessalonians (ID: `group:Thessalonica`); wajib (ID: `keyterm:Ought`); Timotius (ID: `person:Timothy`); yang baik (ID: `keyterm:Good`); penghakiman (ID: `keyterm:Judgment`); menggenapi (ID: `keyterm:Happen`); menuntut pembalasan (ID: `keyterm:GrantJustice`); Silas (ID: `person:Silas`); pengadilan (ID: `keyterm:CourtCase`); berdoa (ID: `keyterm:Pray`); An Angel (ID: `deity:Angel`); memperdamaikan (ID: `keyterm:Peace`); khusus (ID: `keyterm:Holy`); nama (ID: `keyterm:Name`); selama, lamanya (ID: `keyterm:Always`); kerajaan (ID: `keyterm:Kingdom`)
...
* **Associated ACAI Concepts:** tak kenal hukum (ID: `keyterm:Lawless`); Yesus (ID: `person:Jesus.2`); kebenaran (ID: `keyterm:Truth`); roh (ID: `keyterm:Spirit.2`); Tuhan (ID: `deity:Lord`); percaya (ID: `keyterm:Believe`); keahlian (ID: `keyterm:Ability`); meminta (ID: `keyterm:AskFor`); keselamatan (ID: `keyterm:Salvation`); memutuskan (ID: `keyterm:Decided`); menghancurkan (ID: `keyterm:Destroy`); tanda (ID: `keyterm:Example`); barang pujaan (ID: `keyterm:ObjectOfWorship`); mujizat (ID: `keyterm:Portent`); kasihi (ID: `keyterm:Love`); lalim (ID: `keyterm:UnjustDeed`); Iblis (ID: `deity:Satan`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); kasihi (ID: `keyterm:Love`); Tuhan (ID: `deity:Lord`); hati (ID: `keyterm:Heart`); kemuliaan (ID: `keyterm:Glory`); percaya (ID: `keyterm:Believe`); yang baik (ID: `keyterm:Good`); meminta (ID: `keyterm:AskFor`); adat istiadat (ID: `keyterm:Teaching`); keselamatan (ID: `keyterm:Salvation`); injil (ID: `keyterm:GoodNews`); menyelamatkan (ID: `keyterm:Deliver`); dikhususkan (ID: `keyterm:Consecration.2`); kebenaran (ID: `keyterm:Truth`); wajib (ID: `keyterm:Ought`); harapan (ID: `keyterm:Hope`); membujuk (ID: `keyterm:Persuade`); berdoa (ID: `keyterm:Pray`); Roh (ID: `deity:HolySpirit`); kesetiaan (ID: `keyterm:Faithfulness`); kebaikan (ID: `keyterm:Favor`); selama, lamanya (ID: `keyterm:Always`); menasihati (ID: `keyterm:Encourage`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); hidup (ID: `keyterm:Live.3`); memperdamaikan (ID: `keyterm:Peace`); meminta (ID: `keyterm:AskFor`); nama (ID: `keyterm:Name`); Paulus (ID: `person:Paul`); kebaikan (ID: `keyterm:Favor`); tanda (ID: `keyterm:Example`); kekuasaan (ID: `keyterm:Authority.2`); sibuk dengan hal, hal yang tidak berguna (ID: `keyterm:Busybody`); keahlian (ID: `keyterm:Ability`); adat istiadat (ID: `keyterm:Teaching`)
