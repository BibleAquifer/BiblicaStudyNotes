...
* **Associated ACAI Concepts:** Filemon (ID: `person:Philemon`); Apfia (ID: `person:Apphia`); Arkhipus (ID: `person:Archippus`); Onesimus (ID: `person:Onesimus`); Epafras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Lukas (ID: `person:Luke`); Guest Room (ID: `realia:GuestRoom`); berhutang (ID: `keyterm:Owe`); Yesus (ID: `person:Jesus.2`)
