...
* **Associated ACAI Concepts:** Teofilus (ID: `person:Theophilus`); sorga (ID: `keyterm:Heaven`); Galileans (ID: `group:Galilee`); saksi (ID: `keyterm:Witness`); Yehuda (ID: `place:Judea`); janji (ID: `keyterm:Promise`)
...
* **Associated ACAI Concepts:** Matias (ID: `person:Matthias`); Yusuf (ID: `person:Joseph.9`); Half a Mile (ID: `realia:HalfAMile`); berdoa (ID: `keyterm:Pray`); Simon (ID: `person:Simon.2`); Bartolomeus (ID: `person:Bartholomew`); Akeldama (ID: `place:Akeldama`); Alfeus (ID: `person:Alphaeus`); Yakobus (ID: `person:James.2`); Zaitun (ID: `place:OlivesMount`); Upstairs Room (ID: `realia:UpstairsRoom`); Lot (ID: `realia:Lot`); Tomas (ID: `person:Thomas`); Andreas (ID: `person:Andrew`); Maria (ID: `person:Mary`)
...
* **Associated ACAI Concepts:** Sweet Wine (ID: `realia:SweetWine`); Parthians (ID: `group:Parthians`); Kapadokia (ID: `place:Cappadocia`); Elamites (ID: `group:Elam`); Cretans (ID: `group:Cretan`); Frigia (ID: `place:Phrygia`); Pontus (ID: `place:Pontus`); Libia (ID: `place:Libya`); Kirene (ID: `place:Cyrene`); Galileans (ID: `group:Galilee`); Elam (ID: `place:Elam`); Media (ID: `person:Medan`); Yerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Petrus (ID: `person:Peter`); alam maut (ID: `keyterm:WorldOfTheDead`); Yoël (ID: `person:Joel.14`); mujizat (ID: `keyterm:Portent`); baptisan (ID: `keyterm:Baptism`); Judeans (ID: `group:Judea`); berdoa (ID: `keyterm:CallUpon`); firman (ID: `keyterm:Word`); bertobat (ID: `keyterm:Repent`); kebangkitan (ID: `keyterm:Resurrection`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** serambi (ID: `place:SolomonsPortico`); Abraham (ID: `person:Abraham`); Porch (ID: `realia:Porch`); menggenapi (ID: `keyterm:Happen`); Samuel (ID: `person:Samuel`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** nama (ID: `keyterm:Name`); Yohanes (ID: `person:John.3`); Aleksander (ID: `person:Alexander.2`); keselamatan (ID: `keyterm:Salvation`); Hanas (ID: `person:Annas`); Kayafas (ID: `person:Caiaphas`); Cornerstone (ID: `realia:Cornerstone`); Sadducees (ID: `group:Sadducee`)
...
* **Associated ACAI Concepts:** Cypriots (ID: `group:Cyprus`); meminta (ID: `keyterm:AskFor`); Barnabas (ID: `person:Barnabas`); Pilatus (ID: `person:Pilate`)
...
* **Associated ACAI Concepts:** Ananias (ID: `person:Ananias`); Safira (ID: `person:Sapphira`)
...
* **Associated ACAI Concepts:** Prison (ID: `realia:Prison`); Porch (ID: `realia:Porch`); iri hati (ID: `keyterm:Resentment`); mujizat (ID: `keyterm:Portent`)
...
* **Associated ACAI Concepts:** Teudas (ID: `person:Theudas`); Yudas (ID: `person:Judas.3`); membujuk (ID: `keyterm:Persuade`); Gamaliel (ID: `person:Gamaliel`); juruselamat (ID: `keyterm:Savior`); saksi (ID: `keyterm:Witness`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Timon (ID: `person:Timon`); Antiochians (ID: `group:Antioch`); Prokhorus (ID: `person:Prochorus`); Nikolaus (ID: `person:Nicolaus`); Nikanor (ID: `person:Nicanor`); Parmenas (ID: `person:Parmenas`); melayani (ID: `keyterm:Serve`); Hellenists (ID: `group:Hellenist`); Stefanus (ID: `person:Stephen`); Filipus (ID: `person:Philip.4`)
...
* **Associated ACAI Concepts:** Freedmen (ID: `group:Freedmen`); Stefanus (ID: `person:Stephen`); Alexandrians (ID: `group:Alexandria`); Aleksandria (ID: `place:Alexandria`)
...
* **Associated ACAI Concepts:** Refan (ID: `deity:Rephan`); Yusuf (ID: `person:Joseph.10`); bertindak jahat (ID: `keyterm:ActWickedly`); melepaskan (ID: `keyterm:Rescue`); Firaun (ID: `person:Pharaoh.4`); Aram-Mesopotamia (ID: `place:Mesopotamia`); Hemor (ID: `person:Hamor`); Sekhem (ID: `place:Shechem`); hakim (ID: `keyterm:Judge`); Mesir (ID: `place:Egypt`); Musa (ID: `person:Moses`); Israel (ID: `person:Israel`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Stefanus (ID: `person:Stephen`); berdoa (ID: `keyterm:CallUpon`)
...
* **Associated ACAI Concepts:** Filipus (ID: `person:Philip.4`); Stefanus (ID: `person:Stephen`); Yehuda (ID: `place:Judea`); memberitakan (ID: `keyterm:Proclaim`); Yerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Simon (ID: `person:Simon.8`); Filipus (ID: `person:Philip.4`); Money (ID: `realia:Money`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Filipus (ID: `person:Philip.4`); Chariot (ID: `realia:Chariot`); injil (ID: `keyterm:GoodNews`); Ethiopians (ID: `group:Ethiopia`); Etiopia (ID: `place:Ethiopia`); Asdod (ID: `place:Ashdod`); Gaza (ID: `place:Gaza`)
...
* **Associated ACAI Concepts:** Ananias (ID: `person:Ananias.2`); Damsyik (ID: `place:Damascus`); Paulus (ID: `person:Paul`); Yudas (ID: `person:Judas.4`); Lurus (ID: `place:Straight`); Tarsus (ID: `group:Tarsus`); jalan tuhan (ID: `keyterm:TheWay`); nama (ID: `keyterm:Name`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Damsyik (ID: `place:Damascus`); Hellenists (ID: `group:Hellenist`); Tarsus (ID: `place:Tarsus`); Basket (ID: `realia:Basket`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Tabita (ID: `person:Tabitha`); Eneas (ID: `person:Aeneas`); Yafo (ID: `place:Joppa`); Simon (ID: `person:Simon.9`); Sharon Plain (ID: `place:Sharon.2`); Petrus (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Italians (ID: `group:Italy`); Kornelius (ID: `person:Cornelius`); Linen Cloth (ID: `realia:LinenCloth`); Simon (ID: `person:Simon.9`); Housetop (ID: `realia:Housetop`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Kornelius (ID: `person:Cornelius`); Simon (ID: `person:Simon.9`); Petrus (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** memberi kesaksian yang sungguh, sungguh (ID: `keyterm:Declare`); diurapi (ID: `keyterm:Anointed`); bersaksi (ID: `keyterm:BearWitness`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Linen Cloth (ID: `realia:LinenCloth`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Antiokhia (ID: `place:Antioch`); Agabus (ID: `person:Agabus`); Siprus (ID: `place:Cyprus`); Cypriots (ID: `group:Cyprus`); Christians (ID: `group:Christ`); Hellenists (ID: `group:Hellenist`); menjadi murid (ID: `keyterm:Disciple`); Fenisia (ID: `place:Phoenicia`); Klaudius (ID: `person:Claudius`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod.3`); Rode (ID: `person:Rhoda`); Maria (ID: `person:Mary.5`); Chain (ID: `realia:Chain`); Markus (ID: `person:Mark`); Yakobus (ID: `person:James`); Yohanes (ID: `person:John.2`); Petrus (ID: `person:Peter`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Bedroom (ID: `realia:Bedroom`); Blastus (ID: `person:Blastus`); Herodes (ID: `person:Herod.3`); Tyrians (ID: `group:Tyre`)
...
* **Associated ACAI Concepts:** Baryesus (ID: `person:Bar-jesus`); Paulus (ID: `person:Paul`); Barnabas (ID: `person:Barnabas`); Seleukia (ID: `place:Seleucia`); Salamis (ID: `place:Salamis`); Menahem (ID: `person:Manaen`); Sergius (ID: `person:SergiusPaulus`); Markus (ID: `person:Mark`); Pafos (ID: `place:Paphos`); Simeon (ID: `person:Simeon.4`); berpuasa (ID: `keyterm:Fast`); Antiokhia (ID: `place:Antioch`); Herodes (ID: `person:Herod.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Perga (ID: `place:Perga`); Pafos (ID: `place:Paphos`); Synagogue (ID: `realia:Synagogue`); Antiokhia (ID: `place:Antioch.2`); Pamfilia (ID: `place:Pamphylia`); Kish (ID: `person:Kish`); Isai (ID: `person:Jesse`); Kanaan (ID: `place:Canaan`); Saul (ID: `person:Saul.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** sembah (ID: `keyterm:Worship`); iri hati (ID: `keyterm:Resentment`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Likaonia (ID: `place:Lycaonia`); Derbe (ID: `place:Derbe`); Listra (ID: `place:Lystra`); Ikonium (ID: `place:Iconium`)
...
* **Associated ACAI Concepts:** Zeus (ID: `deity:Zeus`); Garland (ID: `realia:Garland`); Hermes (ID: `deity:Hermes`); Lycaonians (ID: `group:Lycaonia`); sia, sia (ID: `keyterm:Worthless`); lakukan baik (ID: `keyterm:DoGood`)
...
* **Associated ACAI Concepts:** Atalia (ID: `place:Attalia`); Antiokhia (ID: `place:Antioch.2`); Ikonium (ID: `place:Iconium`); Pisidia (ID: `place:Pisidia`); Perga (ID: `place:Perga`); Derbe (ID: `place:Derbe`); Pamfilia (ID: `place:Pamphylia`); berpuasa (ID: `keyterm:Fast`)
...
* **Associated ACAI Concepts:** Yudas (ID: `person:Judas.5`); Antiokhia (ID: `place:Antioch`); Silas (ID: `person:Silas`); Fenisia (ID: `place:Phoenicia`); Yakobus (ID: `person:James.3`); Yoke (ID: `realia:Yoke`); Yehuda (ID: `place:Judea`); Barnabas (ID: `person:Barnabas`); Gentiles (ID: `group:Gentile`); Paulus (ID: `person:Paul`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Markus (ID: `person:Mark`); Kilikia (ID: `place:Cilicia`)
...
* **Associated ACAI Concepts:** Misia (ID: `place:Mysia`); Listra (ID: `place:Lystra`); Bitinia (ID: `place:Bithynia`); Makedonia (ID: `place:Macedonia`); Frigia (ID: `place:Phrygia`); Derbe (ID: `place:Derbe`); Troas (ID: `place:Troas`); Galatia (ID: `place:Galatia`); Asia (ID: `place:Asia`); Timotius (ID: `person:Timothy`)
...
* **Associated ACAI Concepts:** Neapolis (ID: `place:Neapolis`); Samotrake (ID: `place:Samothrace`); Lidia (ID: `person:Lydia`); Tiatira (ID: `place:Thyatira`); Filipi (ID: `place:Philippi`); Makedonia (ID: `place:Macedonia`)
...
* **Associated ACAI Concepts:** Philippian Jailer (ID: `person:PhilippianJailer`); Lidia (ID: `person:Lydia`); Silas (ID: `person:Silas`); percaya (ID: `keyterm:Believe`); Torch (ID: `realia:Torch`); Paulus (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Yason (ID: `person:Jason`); Apolonia (ID: `place:Apollonia`); Amfipolis (ID: `place:Amphipolis`); Berea (ID: `place:Berea`); Tesalonika (ID: `place:Thessalonica`); Greeks (ID: `group:Greek`); kitab suci (ID: `keyterm:Scripture`); bimbang (ID: `keyterm:Discern`); Paulus (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Areopagus (ID: `place:Areopagus`); Atena (ID: `place:Athens`); Athenians (ID: `group:Athens`); Stoics (ID: `group:Stoic`); Epicureans (ID: `group:Epicurean`); Dionisius (ID: `person:Dionysius`); Areopagites (ID: `group:Areopagus`); Damaris (ID: `person:Damaris`); sembah (ID: `keyterm:Worship`); ilahi (ID: `keyterm:Divine`); memutuskan (ID: `keyterm:Decided`)
...
* **Associated ACAI Concepts:** Galio (ID: `person:Gallio`); Yustus (ID: `person:Justus.2`); Pontus (ID: `group:Pontus`); Judgment Seat (ID: `realia:JudgmentSeat`); Korintus (ID: `place:Corinth`); Corinthians (ID: `group:Corinth`); Krispus (ID: `person:Crispus`); Sostenes (ID: `person:Sosthenes`); sembah (ID: `keyterm:Worship`); Pontus (ID: `place:Pontus`); Priskila (ID: `person:Priscilla`); Akwila (ID: `person:Aquila`); Akhaya (ID: `place:Achaia`); Klaudius (ID: `person:Claudius`); Roma (ID: `place:Rome`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Akwila (ID: `person:Aquila`); Kengkrea (ID: `place:Cenchreae`); Alexandrians (ID: `group:Alexandria`); Frigia (ID: `place:Phrygia`); Aleksandria (ID: `place:Alexandria`); Galatia (ID: `place:Galatia`); Apolos (ID: `person:Apollos`)
...
* **Associated ACAI Concepts:** Tiranus (ID: `person:Tyrannus`); Apron (ID: `realia:Apron`); Skewa (ID: `person:Sceva`); Lecture Hall (ID: `realia:LectureHall`); Asia (ID: `place:Asia`); Efesus (ID: `place:Ephesus`); Makedonia (ID: `place:Macedonia`); Erastus (ID: `person:Erastus`); Band of Cloth (ID: `realia:BandOfCloth`); Akhaya (ID: `place:Achaia`); Demons (ID: `deity:Demons`); Paulus (ID: `person:Paul`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Artemis (ID: `deity:Artemis`); Ephesians (ID: `group:Ephesus`); Theater (ID: `realia:Theater`); Replica Temple (ID: `realia:ReplicaTemple`); Gayus (ID: `person:Gaius`); Aleksander (ID: `person:Alexander.3`); Demetrius (ID: `person:Demetrius`); Aristarkhus (ID: `person:Aristarchus`)
...
* **Associated ACAI Concepts:** Second Story (ID: `realia:SecondStory`); Sekundus (ID: `person:Secundus`); Asians (ID: `group:Asia`); Gayus (ID: `person:Gaius.2`); Bereans (ID: `group:Berea`); Pirus (ID: `person:Pyrrhus`); Eutikhus (ID: `person:Eutychus`); Troas (ID: `place:Troas`); Sopater (ID: `person:Sopater`); Makedonia (ID: `place:Macedonia`); Trofimus (ID: `person:Trophimus`); Filipi (ID: `place:Philippi`); Tikhikus (ID: `person:Tychicus`); minggu (ID: `keyterm:Week`); Yunani (ID: `place:Greece`); Window (ID: `realia:Window`)
...
* **Associated ACAI Concepts:** Asos (ID: `place:Assos`); memberi kesaksian yang sungguh, sungguh (ID: `keyterm:Declare`); Metilene (ID: `place:Mitylene`); Khios (ID: `place:Chios`); Samos (ID: `place:Samos`); Miletus (ID: `place:Miletus`); Efesus (ID: `place:Ephesus`); melayani (ID: `keyterm:Serve.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Kos (ID: `place:Cos`); Rodos (ID: `place:Rhodes`); Patara (ID: `place:Patara`); Manason (ID: `person:Mnason`); Agabus (ID: `person:Agabus`); Kaisarea (ID: `place:Caesarea`); Cypriots (ID: `group:Cyprus`); Fenisia (ID: `place:Phoenicia`); Filipus (ID: `person:Philip.4`); Belt (ID: `realia:Belt`); Yerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Step (ID: `realia:Step`); Tarsus (ID: `group:Tarsus`); Trofimus (ID: `person:Trophimus`); Tarsus (ID: `place:Tarsus`); Kilikia (ID: `place:Cilicia`); Paulus (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Paulus (ID: `person:Paul`); Gamaliel (ID: `person:Gamaliel`); Ananias (ID: `person:Ananias.2`)
...
* **Associated ACAI Concepts:** Antipatris (ID: `place:Antipatris`); Feliks (ID: `person:Felix`); Lisias (ID: `person:Lysias`); Ananias (ID: `person:Ananias.3`); Roma (ID: `place:Rome`); Palace (ID: `realia:Palace`); percayalah (ID: `keyterm:CheerUp`); Kilikia (ID: `place:Cilicia`); Paulus (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Feliks (ID: `person:Felix`); Tertulus (ID: `person:Tertullus`); Drusila (ID: `person:Drusilla`); Ananias (ID: `person:Ananias.3`); Lisias (ID: `person:Lysias`); jalan tuhan (ID: `keyterm:TheWay`); Festus (ID: `person:Festus`); hati nurani (ID: `keyterm:Conscience`); Paulus (ID: `person:Paul`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Festus (ID: `person:Festus`); Agripa (ID: `person:Agrippa`); Kaisarea (ID: `place:Caesarea`); Audience Hall (ID: `realia:AudienceHall`); Bernike (ID: `person:Bernice`); Agustus (ID: `person:Augustus`); Klaudius (ID: `person:Claudius`); Paulus (ID: `person:Paul`); Jews (ID: `group:Jews`); Yerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Agripa (ID: `person:Agrippa`); Festus (ID: `person:Festus`); Bernike (ID: `person:Bernice`); Christians (ID: `group:Christ`); melepaskan (ID: `keyterm:Rescue`); Paulus (ID: `person:Paul`); Jews (ID: `group:Jews`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Anchor (ID: `realia:Anchor`); Ship (ID: `realia:Ship`); Yulius (ID: `person:Julius`); Kreta (ID: `place:Crete`); Mira (ID: `place:Myra`); Likia (ID: `place:Lycia`); Sirtis (ID: `place:Syrtis`); Knidus (ID: `place:Cnidus`); Indah (ID: `place:FairHavens`); Kauda (ID: `place:Cauda`); Fathom (ID: `realia:Fathom`); Adria (ID: `place:AdriaticSea`); Adramitium (ID: `place:Adramyttium`); Feniks (ID: `place:Phoenix`); Lasea (ID: `place:Lasea`); Salmone (ID: `place:Salmone`); Italia (ID: `place:Italy`); Rudder (ID: `realia:Rudder`); Sail (ID: `realia:Sail`); Aleksandria (ID: `place:Alexandria`); Pamfilia (ID: `place:Pamphylia`); Aristarkhus (ID: `person:Aristarchus`); Agustus (ID: `person:Augustus`); Kilikia (ID: `place:Cilicia`); Asia (ID: `place:Asia`); Sidon (ID: `place:Sidon`); Paulus (ID: `person:Paul`); keselamatan (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Publius (ID: `person:Publius`); Putioli (ID: `place:Puteoli`); Forum (ID: `place:ForumOfAppius`); Emblem (ID: `realia:Emblem`); Tres (ID: `place:ThreeTaverns`); Regium (ID: `place:Rhegium`); Malta (ID: `place:Malta`); Sirakusa (ID: `place:Syracuse`); Roma (ID: `place:Rome`); Aleksandria (ID: `place:Alexandria`)
...
* **Associated ACAI Concepts:** membujuk (ID: `keyterm:Persuade`); Chain (ID: `realia:Chain`)
