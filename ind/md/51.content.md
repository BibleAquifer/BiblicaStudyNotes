...
* **Associated ACAI Concepts:** Kolose (ID: `place:Colossae`); Epafras (ID: `person:Epaphras`); menyelamatkan (ID: `keyterm:Deliver`); hidup (ID: `keyterm:Live.3`); kekasih (ID: `keyterm:Beloved`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** tak bercacat (ID: `keyterm:WithoutReproach`); tak bernoda (ID: `keyterm:Unblemished`); memperdamaikan (ID: `keyterm:Peace`); jemaat (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** roh, roh dunia (ID: `keyterm:FundamentalPrinciples`); ilahi (ID: `keyterm:Divine`); adat istiadat (ID: `keyterm:Teaching`); hampa (ID: `keyterm:Empty`); baptisan (ID: `keyterm:Baptism`); tubuh (ID: `keyterm:Body.3`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Scythians (ID: `group:Scythians`); memikirkan (ID: `keyterm:Think`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** tonton bulu atau muka (ID: `keyterm:Partiality`); bertindak jahat (ID: `keyterm:ActWickedly`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Laodikia (ID: `place:Laodicea`); Nimfa (ID: `person:Nympha`); Hierapolis (ID: `place:Hierapolis`); Yustus (ID: `person:Justus.3`); Arkhipus (ID: `person:Archippus`); Onesimus (ID: `person:Onesimus`); Epafras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Lukas (ID: `person:Luke`); Aristarkhus (ID: `person:Aristarchus`); Tikhikus (ID: `person:Tychicus`)
