...
* **Associated ACAI Concepts:** Zakharia (ID: `person:Zechariah`); Elisabet (ID: `person:Elizabeth`); Abia (ID: `person:Abijah.6`); Strong Drink (ID: `realia:StrongDrink`); Gabriel (ID: `deity:Gabriel`); tuntutan (ID: `keyterm:Regulations`); Herodes (ID: `person:Herod`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Maria (ID: `person:Mary`); firman (ID: `keyterm:Word`); kebaikan (ID: `keyterm:Favor`); Gabriel (ID: `deity:Gabriel`); Nazaret (ID: `place:Nazareth`); Yesus (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Zakharia (ID: `person:Zechariah`); tempat yang tinggi (ID: `keyterm:Height`); Elisabet (ID: `person:Elizabeth`); menyelamatkan (ID: `keyterm:Deliver`); penebusan (ID: `keyterm:Liberation`); Yehuda (ID: `place:Judea`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Manger (ID: `realia:Manger`); Kirenius (ID: `person:Quirinius`); Betlehem (ID: `place:Bethlehem`); Inn (ID: `realia:Inn`); Agustus (ID: `person:Augustus`); juruselamat (ID: `keyterm:Savior`); mendaftarkan (ID: `keyterm:Register`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Simeon (ID: `person:Simeon.2`); Hana (ID: `person:Anna`); Fanuel (ID: `person:Phanuel`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Abilene (ID: `place:Abilene`); Lisanias (ID: `person:Lysanias`); Trakhonitis (ID: `place:Trachonitis`); Filipus (ID: `person:Philip.3`); Iturea (ID: `place:Ituraea`); Hanas (ID: `person:Annas`); Agustus (ID: `person:Augustus`); Tiberius (ID: `person:Tiberius`); Herodes (ID: `person:Herod.2`); Yohanes (ID: `person:John`); Yordan (ID: `place:Jordan`)
...
* **Associated ACAI Concepts:** Strap (ID: `realia:Strap`); Herodias (ID: `person:Herodias`); Herodes (ID: `person:Herod.2`)
...
* **Associated ACAI Concepts:** Eliezer (ID: `person:Eliezer`); Yanai (ID: `person:Jannai`); Eli (ID: `person:Heli`); Lewi (ID: `person:Levi.2`); Yohanan (ID: `person:Joanan`); Lewi (ID: `person:Levi`); Hesli (ID: `person:Esli`); Matica (ID: `person:Mattathias`); Yusuf (ID: `person:Joseph.8`); Kosam (ID: `person:Cosam`); Sealtiel (ID: `person:Shealtiel`); Mina (ID: `person:Menna`); Malkhi (ID: `person:Melchi.2`); Adi (ID: `person:Addi`); Yosua (ID: `person:Joshua`); Yoda (ID: `person:Joda`); Yusuf (ID: `person:Joseph.7`); Matata (ID: `person:Mattatha`); Amos (ID: `person:Amos.2`); Nahum (ID: `person:Nahum`); Nagai (ID: `person:Naggai`); Simeon (ID: `person:Simeon.3`); Yehuda (ID: `person:Judah.3`); Yonam (ID: `person:Jonam`); Maat (ID: `person:Maath`); Simei (ID: `person:Semein`); Er (ID: `person:Er`); Matat (ID: `person:Matthat`); Resa (ID: `person:Rhesa`); Josech (ID: `person:Josech`); Elyakim (ID: `person:Eliakim.2`); Zerubabel (ID: `person:Zerubbabel`); Matat (ID: `person:Matthat.2`); Melea (ID: `person:Melea`); Malkhi (ID: `person:Melchi`); Elmadam (ID: `person:Elmadam`); Matica (ID: `person:Mattathias.2`); Yorim (ID: `person:Jorim`); Kenan (ID: `person:Cainan`); Neri (ID: `person:Neri`); Natan (ID: `person:Nathan`); Serug (ID: `person:Serug`); Rehu (ID: `person:Reu`); memperanakkan (ID: `person:Salmon`); Metusalah (ID: `person:Methuselah`); Yared (ID: `person:Jared`); Lamekh (ID: `person:Lamech.2`); Mahalaleel (ID: `person:Mahalalel`); Nahor (ID: `person:Nahor`); Kenan (ID: `person:Kenan`); Enos (ID: `person:Enosh`); Syela (ID: `person:Shelah.2`); Peleg (ID: `person:Peleg`); Terah (ID: `person:Terah`); Set (ID: `person:Seth`); Eber (ID: `person:Eber`); Hezron (ID: `person:Hezron.2`); Yusuf (ID: `person:Joseph.4`); Sem (ID: `person:Shem`); Boas (ID: `person:Boaz`); Manusia (ID: `person:Adam`)
...
* **Associated ACAI Concepts:** mencobai (ID: `keyterm:PutToTheTest`); Pinnacle (ID: `realia:Pinnacle`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); memberitakan (ID: `keyterm:Proclaim`); Sarfat (ID: `place:Zarephath`); Naaman (ID: `person:Naaman.3`); Nazaret (ID: `place:Nazareth`); Elisa (ID: `person:Elisha`); Syrians (ID: `group:Syria`); Galilea (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** memerintahkan (ID: `keyterm:Command`); Kapernaum (ID: `place:Capernaum`); Yehuda (ID: `place:Judea`); injil (ID: `keyterm:GoodNews`)
...
* **Associated ACAI Concepts:** penyakit kulit menular (ID: `keyterm:InfectiousSkinDisease`); Petrus (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Tile (ID: `realia:Tile`); membawa masuk (ID: `keyterm:BringIn`); Galilea (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** pemungut cukai (ID: `keyterm:TaxCollector`); Patch (ID: `realia:Patch`)
...
* **Associated ACAI Concepts:** berbahagialah (ID: `keyterm:Happy`); Simon (ID: `person:Simon.2`); Yudas (ID: `person:Judas`); Matius (ID: `person:Matthew`); orang pilihan (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** lakukan baik (ID: `keyterm:DoGood`); Storeroom (ID: `realia:Storeroom`); penyayang (ID: `keyterm:Compassionate`); menentang (ID: `keyterm:Condemn`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Nain (ID: `place:Nain`); Yehuda (ID: `place:Judea`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** pembaptis (ID: `keyterm:Baptist`); Yohanes (ID: `person:John`)
...
* **Associated ACAI Concepts:** Simon (ID: `person:Simon.6`); Alabaster Jar (ID: `realia:AlabasterJar`); berhutang (ID: `keyterm:Owe`); mengampuni (ID: `keyterm:Forgive`)
...
* **Associated ACAI Concepts:** Susana (ID: `person:Susanna`); Khuza (ID: `person:Chuza`); perumpamaan (ID: `keyterm:Parable`); Yohana (ID: `person:Joanna`); baik (ID: `keyterm:Honest`); hidup (ID: `keyterm:DailyLife`); Maria (ID: `person:Marymagdalene`)
...
* **Associated ACAI Concepts:** Gerasa (ID: `place:Gerasa`); Legion (ID: `deity:Legion`); Fetter (ID: `realia:Fetter`); jurang maut (ID: `keyterm:Abyss`); kerasukan setan (ID: `keyterm:DemonPossessed`); Demons (ID: `deity:Demons`)
...
* **Associated ACAI Concepts:** Yairus (ID: `person:Jairus`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Khorazim (ID: `place:Chorazin`); memperdamaikan (ID: `keyterm:Peace`); Scorpion (ID: `fauna:Scorpion`); Disaster (ID: `keyterm:Disaster`)
...
* **Associated ACAI Concepts:** Inn (ID: `realia:Inn`); pikiran (ID: `keyterm:Mind.2`); belas kasihan (ID: `keyterm:Mercy`)
...
* **Associated ACAI Concepts:** Marta (ID: `person:Martha`); Maria (ID: `person:Mary.3`)
...
* **Associated ACAI Concepts:** Niniwe (ID: `group:Nineveh`)
...
* **Associated ACAI Concepts:** Rue (ID: `flora:Rue`); Mint (ID: `flora:Mint`); Zakharia (ID: `person:Zechariah.12`); Plate (ID: `realia:Plate.2`); Disaster (ID: `keyterm:Disaster`); Pharisees (ID: `group:Pharisee`)
...
* **Associated ACAI Concepts:** Assarion (ID: `realia:Assarion`); Inner Room (ID: `realia:InnerRoom`); kemunafikan (ID: `keyterm:Hypocrisy`); neraka (ID: `keyterm:Gehenna`); menghujat (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** Barn (ID: `realia:Barn`); Oven (ID: `realia:Oven`); Storeroom (ID: `realia:Storeroom`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Crow (ID: `fauna:Crow`); Bag (ID: `realia:Bag`); Flock (ID: `fauna:Flock`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Carob (ID: `flora:Carob`); orang upahan (ID: `keyterm:HiredWorker`); Cattle (ID: `fauna:Bull`); hidup (ID: `keyterm:DailyLife`); Kid (ID: `fauna:Kid`); rahmat (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Kor (ID: `realia:Kor.2`); berhutang (ID: `keyterm:Owe`); tugas bendahara (ID: `keyterm:Stewardship`)
...
* **Associated ACAI Concepts:** Lazarus (ID: `person:Lazarus`); alam maut (ID: `keyterm:WorldOfTheDead`); Dog (ID: `fauna:Dog`); Abraham (ID: `person:Abraham`)
...
* **Associated ACAI Concepts:** Mulberry (ID: `flora:Mulberry`); menyesatkan (ID: `keyterm:CauseToStumble`); penyesatan (ID: `keyterm:StumblingBlock`); wajib (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** menuntut pembalasan (ID: `keyterm:GrantJustice`); pemungut cukai (ID: `keyterm:TaxCollector`); Pharisees (ID: `group:Pharisee`); berpuasa (ID: `keyterm:Fast`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Zakheus (ID: `person:Zacchaeus`); Sycomore Fig (ID: `flora:SycomoreFig`)
...
* **Associated ACAI Concepts:** Betfage (ID: `place:Bethphage`); Temple (ID: `realia:Temple`); Zaitun (ID: `place:OlivesMount`); tempat yang tinggi (ID: `keyterm:Height`); Siege-Works (ID: `realia:Siege-works`); Betania (ID: `place:Bethany`); Yerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Tiberius (ID: `person:Tiberius`); kebangkitan (ID: `keyterm:Resurrection`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** melayani (ID: `keyterm:Serve`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); paskah (ID: `keyterm:Passover`)
...
* **Associated ACAI Concepts:** Bag (ID: `realia:Bag`); berdoa (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Petrus (ID: `person:Peter`); Peter's Second Accuser (ID: `person:SecondAccuserOfPeter`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Barabas (ID: `person:Barabbas`); Pilatus (ID: `person:Pilate`)
...
* **Associated ACAI Concepts:** Criminal on the Cross (ID: `person:Dysmas`); Simon (ID: `person:Simon.5`); Cross (ID: `realia:Cross`); Sour Wine (ID: `realia:SourWine`); Kirene (ID: `place:Cyrene`); Yesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Arimatea (ID: `place:Arimathea`); Aloes (ID: `realia:Aloes`); Yusuf (ID: `person:Joseph.6`)
...
* **Associated ACAI Concepts:** Yohana (ID: `person:Joanna`); minggu (ID: `keyterm:Week`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** Emaus (ID: `place:Emmaus`); Kleopas (ID: `person:Cleopas`); Stade (ID: `realia:Stade`)
...
* **Associated ACAI Concepts:** Betania (ID: `place:Bethany`); menggenapi (ID: `keyterm:Happen`); kitab suci (ID: `keyterm:Scripture`); menyembah (ID: `keyterm:BowDown`)
