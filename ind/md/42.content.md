...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Zakharia (ID: `person:Zechariah`); Elisabet (ID: `person:Elizabeth`); An Angel (ID: `deity:Angel`); Temple (ID: `realia:Temple`); imamat (ID: `keyterm:Priesthood`); nama (ID: `keyterm:Name`); berdoa (ID: `keyterm:Pray`); takut (ID: `keyterm:Fear`); Roh (ID: `deity:HolySpirit`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); tuntutan (ID: `keyterm:Regulations`); lepas atau bebas dari sumpah (ID: `keyterm:Blameless`); Gabriel (ID: `deity:Gabriel`); Herodes (ID: `person:Herod`); Abia (ID: `person:Abijah.6`); keahlian (ID: `keyterm:Ability`); injil (ID: `keyterm:GoodNews`); Elia (ID: `person:Elijah`); Harun (ID: `person:Aaron`); hati (ID: `keyterm:Heart`); perintah (ID: `keyterm:Commandment`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Yohanes (ID: `person:John`); menggenapi (ID: `keyterm:Happen`); Yehuda (ID: `place:Judea`); percaya (ID: `keyterm:Believe`); Israel (ID: `person:Israel`); roh (ID: `keyterm:Spirit.2`); Strong Drink (ID: `realia:StrongDrink`); House (ID: `realia:House`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Maria (ID: `person:Mary`); nama (ID: `keyterm:Name`); firman (ID: `keyterm:Word`); kebaikan (ID: `keyterm:Favor`); Daud (ID: `person:David`); Yesus (ID: `person:Jesus.2`); Gabriel (ID: `deity:Gabriel`); Nazaret (ID: `place:Nazareth`); keahlian (ID: `keyterm:Ability`); bertunangan (ID: `keyterm:Engaged`); Galilea (ID: `place:Galilee`); selama, lamanya (ID: `keyterm:Always`); kerajaan (ID: `keyterm:Kingdom`); khusus (ID: `keyterm:Holy`); Elisabet (ID: `person:Elizabeth`); Yusuf (ID: `person:Joseph.4`); takut (ID: `keyterm:Fear`); Roh (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Maria (ID: `person:Mary`); Tuhan (ID: `deity:Lord`); Elisabet (ID: `person:Elizabeth`); belas kasihan (ID: `keyterm:Mercy`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); nama (ID: `keyterm:Name`); pikiran (ID: `keyterm:Mind.2`); cepat, cepat (ID: `keyterm:Haste`); Yesus (ID: `person:Jesus.2`); Zakharia (ID: `person:Zechariah`); hati (ID: `keyterm:Heart`); Yehuda (ID: `person:Judah.4`); berbahagialah (ID: `keyterm:Happy`); hampa (ID: `keyterm:Empty`); selama, lamanya (ID: `keyterm:Always`); khusus (ID: `keyterm:Holy`); memberkati (ID: `keyterm:Bless`); juruselamat (ID: `keyterm:Savior`); Abraham (ID: `person:Abraham`); takut (ID: `keyterm:Fear`); percaya (ID: `keyterm:Believe`); Roh (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`); roh (ID: `keyterm:Spirit.2`); menyebut berbahagia (ID: `keyterm:RegardAsHappy`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); khusus (ID: `keyterm:Holy`); belas kasihan (ID: `keyterm:Mercy`); keselamatan (ID: `keyterm:Salvation`); Zakharia (ID: `person:Zechariah`); memberkati (ID: `keyterm:Bless`); Yohanes (ID: `person:John`); Roh (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`); Elisabet (ID: `person:Elizabeth`); menyelamatkan (ID: `keyterm:Deliver`); Yehuda (ID: `place:Judea`); penebusan (ID: `keyterm:Liberation`); tempat yang tinggi (ID: `keyterm:Height`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); hati (ID: `keyterm:Heart`); selama, lamanya (ID: `keyterm:Always`); berbuat dosa (ID: `keyterm:Sin`); firman (ID: `keyterm:Word`); imamat (ID: `keyterm:Priesthood`); Daud (ID: `person:David`); rahmat (ID: `keyterm:Affection`); Abraham (ID: `person:Abraham`); sumpah (ID: `keyterm:Oath`); takut (ID: `keyterm:Fear`); penyunatan (ID: `keyterm:Circumcision`); A Group of People (ID: `group:GenericGroup`); melayani (ID: `keyterm:Serve`); mengampuni (ID: `keyterm:Forgive`); memperdamaikan (ID: `keyterm:Peace`); roh (ID: `keyterm:Spirit.2`); perjanjian (ID: `keyterm:Covenant`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Tablet (ID: `realia:Tablet`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); kemuliaan (ID: `keyterm:Glory`); firman (ID: `keyterm:Word`); Maria (ID: `person:Mary`); mendaftarkan (ID: `keyterm:Register`); Manger (ID: `realia:Manger`); Betlehem (ID: `place:Bethlehem`); Yusuf (ID: `person:Joseph.4`); Daud (ID: `person:David`); takut (ID: `keyterm:Fear`); Agustus (ID: `person:Augustus`); juruselamat (ID: `keyterm:Savior`); Kirenius (ID: `person:Quirinius`); keahlian (ID: `keyterm:Ability`); injil (ID: `keyterm:GoodNews`); bertunangan (ID: `keyterm:Engaged`); Yesus (ID: `person:Jesus.2`); hati (ID: `keyterm:Heart`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Galilea (ID: `place:Galilee`); tanda (ID: `keyterm:Example`); sorgawi (ID: `keyterm:Heavenly`); Yehuda (ID: `place:Judea`); sorga (ID: `keyterm:Heaven`); A Group of People (ID: `group:GenericGroup`); Nazaret (ID: `place:Nazareth`); pendaftaran (ID: `keyterm:Census`); memperdamaikan (ID: `keyterm:Peace`); To Guard Against (ID: `keyterm:GuardAgainst`); tempat yang tinggi (ID: `keyterm:Height`); Inn (ID: `realia:Inn`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); hukum (ID: `keyterm:Law`); Yerusalem (ID: `place:Jerusalem`); Yesus (ID: `person:Jesus.2`); Roh (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`); Simeon (ID: `person:Simeon.2`); memberkati (ID: `keyterm:Bless`); nama (ID: `keyterm:Name`); khusus (ID: `keyterm:Holy`); Temple (ID: `realia:Temple`); Hana (ID: `person:Anna`); Fanuel (ID: `person:Phanuel`); kemuliaan (ID: `keyterm:Glory`); kehidupan (ID: `keyterm:Life`); hati (ID: `keyterm:Heart`); Asyer (ID: `person:Asher`); persembahan (ID: `keyterm:Offering`); tanda (ID: `keyterm:Example`); An Angel (ID: `deity:Angel`); firman (ID: `keyterm:Word`); berpuasa (ID: `keyterm:Fast`); Maria (ID: `person:Mary`); imamat (ID: `keyterm:Priesthood`); berdoa (ID: `keyterm:Pray`); membersihkan (ID: `keyterm:Cleanse.2`); penebusan (ID: `keyterm:Liberation`); penyunatan (ID: `keyterm:Circumcision`); kebangkitan (ID: `keyterm:Resurrection`); meminta (ID: `keyterm:AskFor`); melayani (ID: `keyterm:Serve`); Asyer (ID: `group:Asher`); Musa (ID: `person:Moses`); memperdamaikan (ID: `keyterm:Peace`); keselamatan (ID: `keyterm:Salvation`); Gentiles (ID: `group:Gentile`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Rooster (ID: `fauna:Rooster`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yerusalem (ID: `place:Jerusalem`); Nazaret (ID: `place:Nazareth`); kebaikan (ID: `keyterm:Favor`); firman (ID: `keyterm:Word`); Yesus (ID: `person:Jesus.2`); hukum (ID: `keyterm:Law`); hati (ID: `keyterm:Heart`); paskah (ID: `keyterm:Passover`); Galilea (ID: `place:Galilee`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); baptisan (ID: `keyterm:Baptism`); bertobat (ID: `keyterm:Repent`); kebenaran (ID: `keyterm:Straightness`); Agustus (ID: `person:Augustus`); Abilene (ID: `place:Abilene`); Yohanes (ID: `person:John`); Herodes (ID: `person:Herod.2`); Tiberius (ID: `person:Tiberius`); Trakhonitis (ID: `place:Trachonitis`); Lisanias (ID: `person:Lysanias`); Hanas (ID: `person:Annas`); Filipus (ID: `person:Philip.3`); Iturea (ID: `place:Ituraea`); Yordan (ID: `place:Jordan`); Kayafas (ID: `person:Caiaphas`); tubuh (ID: `keyterm:Body.3`); memberitakan (ID: `keyterm:Proclaim`); Zakharia (ID: `person:Zechariah`); pemungut cukai (ID: `keyterm:TaxCollector`); Galilea (ID: `place:Galilee`); Pilatus (ID: `person:Pilate`); berbuat dosa (ID: `keyterm:Sin`); firman (ID: `keyterm:Word`); Abraham (ID: `person:Abraham`); Yehuda (ID: `place:Judea`); Yesaya (ID: `person:Isaiah`); mengampuni (ID: `keyterm:Forgive`); keselamatan (ID: `keyterm:Salvation`); Tunic (ID: `realia:Tunic.2`); Axe (ID: `realia:Axe`); Snake (ID: `fauna:Snake`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Yohanes (ID: `person:John`); Yesus (ID: `person:Jesus.2`); sorga (ID: `keyterm:Heaven`); baptisan (ID: `keyterm:Baptism`); Roh (ID: `deity:HolySpirit`); Herodias (ID: `person:Herodias`); Herodes (ID: `person:Herod.2`); bersihkan (ID: `keyterm:CleanOut`); hati (ID: `keyterm:Heart`); kekasih (ID: `keyterm:Beloved`); berdoa (ID: `keyterm:Pray`); meminta (ID: `keyterm:AskFor`); Strap (ID: `realia:Strap`); Winnowing Fork (ID: `realia:WinnowingFork`); Wheat (ID: `flora:Wheat`); Barn (ID: `realia:Barn`); Grain (ID: `flora:Grain`); Dove (ID: `fauna:Dove`); Prison (ID: `realia:Prison`); Sandal (ID: `realia:Sandal`); Threshing Floor (ID: `realia:ThreshingFloor`)
...
* **Associated ACAI Concepts:** Syela (ID: `person:Shelah.2`); Matica (ID: `person:Mattathias.2`); Lewi (ID: `person:Levi.2`); Enos (ID: `person:Enosh`); Malkhi (ID: `person:Melchi`); Amos (ID: `person:Amos.2`); Serug (ID: `person:Serug`); Yanai (ID: `person:Jannai`); Rehu (ID: `person:Reu`); Yusuf (ID: `person:Joseph.4`); Sem (ID: `person:Shem`); Eber (ID: `person:Eber`); Mahalaleel (ID: `person:Mahalalel`); Resa (ID: `person:Rhesa`); Kosam (ID: `person:Cosam`); Yohanan (ID: `person:Joanan`); Malkhi (ID: `person:Melchi.2`); Er (ID: `person:Er`); Lamekh (ID: `person:Lamech.2`); Matat (ID: `person:Matthat.2`); Hesli (ID: `person:Esli`); Yoda (ID: `person:Joda`); Peleg (ID: `person:Peleg`); Kenan (ID: `person:Cainan`); Elmadam (ID: `person:Elmadam`); Zerubabel (ID: `person:Zerubbabel`); Mina (ID: `person:Menna`); Eliezer (ID: `person:Eliezer`); Natan (ID: `person:Nathan`); Josech (ID: `person:Josech`); Set (ID: `person:Seth`); Hezron (ID: `person:Hezron.2`); Metusalah (ID: `person:Methuselah`); Yusuf (ID: `person:Joseph.8`); Yorim (ID: `person:Jorim`); Sealtiel (ID: `person:Shealtiel`); Simeon (ID: `person:Simeon.3`); Manusia (ID: `person:Adam`); Eli (ID: `person:Heli`); Terah (ID: `person:Terah`); Maat (ID: `person:Maath`); Simei (ID: `person:Semein`); Nahor (ID: `person:Nahor`); memperanakkan (ID: `person:Salmon`); Yehuda (ID: `person:Judah.3`); Lewi (ID: `person:Levi`); Matica (ID: `person:Mattathias`); Yosua (ID: `person:Joshua`); Kenan (ID: `person:Kenan`); Melea (ID: `person:Melea`); Neri (ID: `person:Neri`); Adi (ID: `person:Addi`); Elyakim (ID: `person:Eliakim.2`); Boas (ID: `person:Boaz`); Yusuf (ID: `person:Joseph.7`); Nagai (ID: `person:Naggai`); Matata (ID: `person:Mattatha`); Yonam (ID: `person:Jonam`); Nahum (ID: `person:Nahum`); Yared (ID: `person:Jared`); Matat (ID: `person:Matthat`); Arpakhsad (ID: `person:Arpachshad`); Abraham (ID: `person:Abraham`); Henokh (ID: `person:Enoch.2`); Israel (ID: `person:Israel`); Ishak (ID: `person:Isaac`); Yehuda (ID: `person:Judah.4`); Isai (ID: `person:Jesse`); Aminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Tuhan (ID: `deity:Lord`); Nuh (ID: `person:Noah`); Yesus (ID: `person:Jesus.2`); Peres (ID: `person:Perez`); Daud (ID: `person:David`); Ram (ID: `person:Ram`); Nahason (ID: `person:Nahshon`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); mencobai (ID: `keyterm:PutToTheTest`); keahlian (ID: `keyterm:Ability`); Tuhan (ID: `deity:Lord`); menyembah (ID: `keyterm:BowDown`); memerintahkan (ID: `keyterm:Command`); kemuliaan (ID: `keyterm:Glory`); Yerusalem (ID: `place:Jerusalem`); melindungi (ID: `keyterm:Protect`); kehidupan (ID: `keyterm:Life`); kerajaan (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); kekuasaan (ID: `keyterm:Authority.2`); imamat (ID: `keyterm:Priesthood`); melayani (ID: `keyterm:Serve`); Roh (ID: `deity:HolySpirit`); Yordan (ID: `place:Jordan`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); memberitakan (ID: `keyterm:Proclaim`); Elia (ID: `person:Elijah`); Tuhan (ID: `deity:Lord`); Roh (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`); Scroll (ID: `realia:Scroll`); Syrians (ID: `group:Syria`); Elisa (ID: `person:Elisha`); Galilea (ID: `place:Galilee`); Naaman (ID: `person:Naaman.3`); Sarfat (ID: `place:Zarephath`); Nazaret (ID: `place:Nazareth`); kemuliaan (ID: `keyterm:Glory`); keahlian (ID: `keyterm:Ability`); injil (ID: `keyterm:GoodNews`); amin! (ID: `keyterm:Surely`); Yesus (ID: `person:Jesus.2`); kebenaran (ID: `keyterm:Truth`); sabat (ID: `keyterm:Sabbath`); diurapi (ID: `keyterm:Anointed`); Sidon (ID: `place:Sidon`); Yusuf (ID: `person:Joseph.4`); perumpamaan (ID: `keyterm:Parable`); menggenapi (ID: `keyterm:Happen`); sorga (ID: `keyterm:Heaven`); kebaikan (ID: `keyterm:Favor`); Yesaya (ID: `person:Isaiah`); membersihkan (ID: `keyterm:Cleanse.2`); kitab suci (ID: `keyterm:Scripture`); melayani (ID: `keyterm:Serve`); Kapernaum (ID: `place:Capernaum`); bersaksi (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** memerintahkan (ID: `keyterm:Command`); Yesus (ID: `person:Jesus.2`); Demons (ID: `deity:Demons`); Synagogue (ID: `realia:Synagogue`); keahlian (ID: `keyterm:Ability`); kekuasaan (ID: `keyterm:Authority.2`); Tuhan (ID: `deity:Lord`); melayani (ID: `keyterm:Serve`); injil (ID: `keyterm:GoodNews`); Yehuda (ID: `place:Judea`); Kapernaum (ID: `place:Capernaum`); memberitakan (ID: `keyterm:Proclaim`); sabat (ID: `keyterm:Sabbath`); Galilea (ID: `place:Galilee`); kerajaan (ID: `keyterm:Kingdom`); khusus (ID: `keyterm:Holy`); Petrus (ID: `person:Peter`); Nazaret (ID: `place:Nazareth`); meminta (ID: `keyterm:AskFor`); pencemaran (ID: `keyterm:Defilement`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Petrus (ID: `person:Peter`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Casting Net (ID: `realia:CastingNet`); Yesus (ID: `person:Jesus.2`); membersihkan (ID: `keyterm:Cleanse.2`); Fish (ID: `fauna:Fish`); penyakit kulit menular (ID: `keyterm:InfectiousSkinDisease`); Zebedeus (ID: `person:Zebedee`); persembahan (ID: `keyterm:Offering`); firman (ID: `keyterm:Word`); Tuhan (ID: `deity:Lord`); berdoa (ID: `keyterm:Pray`); takut (ID: `keyterm:Fear`); melayani (ID: `keyterm:Serve`); meminta (ID: `keyterm:AskFor`); Musa (ID: `person:Moses`); Yakobus (ID: `person:James`); Yohanes (ID: `person:John.2`); Genesaret (ID: `place:Gennesaret`); bersaksi (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** berbuat dosa (ID: `keyterm:Sin`); Tuhan (ID: `deity:Lord`); mengampuni (ID: `keyterm:Forgive`); membawa masuk (ID: `keyterm:BringIn`); Bed (ID: `realia:Bed`); keahlian (ID: `keyterm:Ability`); kemuliaan (ID: `keyterm:Glory`); Yesus (ID: `person:Jesus.2`); Pharisees (ID: `group:Pharisee`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Galilea (ID: `place:Galilee`); Yerusalem (ID: `place:Jerusalem`); hati (ID: `keyterm:Heart`); kekuasaan (ID: `keyterm:Authority.2`); Yehuda (ID: `place:Judea`); takut (ID: `keyterm:Fear`); menghujat (ID: `keyterm:Blaspheme`); percaya (ID: `keyterm:Believe`); Tile (ID: `realia:Tile`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** pemungut cukai (ID: `keyterm:TaxCollector`); berpuasa (ID: `keyterm:Fast`); menjadi murid (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); Matius (ID: `person:Matthew`); Skin-Bottle (ID: `realia:Skin-bottle`); Must (ID: `realia:Must`); Yesus (ID: `person:Jesus.2`); nama (ID: `keyterm:Name`); bertobat (ID: `keyterm:Repent`); Yohanes (ID: `person:John`); berdoa (ID: `keyterm:Pray`); perumpamaan (ID: `keyterm:Parable`); yang baik (ID: `keyterm:Good`); rumah cukai (ID: `keyterm:TaxOffice`); Religious Officials (ID: `group:ReligiousOfficials`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Patch (ID: `realia:Patch`); Clothing (ID: `realia:Clothing`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** sabat (ID: `keyterm:Sabbath`); Yesus (ID: `person:Jesus.2`); Be Lawful (ID: `keyterm:Lawful`); Pharisees (ID: `group:Pharisee`); menjadi murid (ID: `keyterm:Disciple`); keselamatan (ID: `keyterm:Salvation`); kehidupan (ID: `keyterm:Life`); Tuhan (ID: `deity:Lord`); lakukan baik (ID: `keyterm:DoGood`); melayani (ID: `keyterm:Serve`); Daud (ID: `person:David`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Synagogue (ID: `realia:Synagogue`); Grain (ID: `flora:Grain`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** berbahagialah (ID: `keyterm:Happy`); menjadi murid (ID: `keyterm:Disciple`); Disaster (ID: `keyterm:Disaster`); Tuhan (ID: `deity:Lord`); Yakobus (ID: `person:James.2`); orang pilihan (ID: `keyterm:Chosen`); Simon (ID: `person:Simon.2`); Yudas (ID: `person:Judas`); Matius (ID: `person:Matthew`); Yerusalem (ID: `place:Jerusalem`); keahlian (ID: `keyterm:Ability`); Bartolomeus (ID: `person:Bartholomew`); Tirus (ID: `place:Tyre`); Alfeus (ID: `person:Alphaeus`); kerajaan (ID: `keyterm:Kingdom`); nama (ID: `keyterm:Name`); Sidon (ID: `place:Sidon`); Yudas (ID: `person:Judas.2`); Petrus (ID: `person:Peter`); berdoa (ID: `keyterm:Pray`); Filipus (ID: `person:Philip`); Yehuda (ID: `place:Judea`); sorga (ID: `keyterm:Heaven`); Tomas (ID: `person:Thomas`); Andreas (ID: `person:Andrew`); meminta (ID: `keyterm:AskFor`); melayani (ID: `keyterm:Serve`); Yakobus (ID: `person:James`); Yohanes (ID: `person:John.2`)
...
* **Associated ACAI Concepts:** kasihi (ID: `keyterm:Love`); kebaikan (ID: `keyterm:Favor`); lakukan baik (ID: `keyterm:DoGood`); Tuhan (ID: `deity:Lord`); yang baik (ID: `keyterm:Good`); Foundation (ID: `realia:Foundation`); House (ID: `realia:House`); Beam (ID: `realia:Beam`); penyayang (ID: `keyterm:Compassionate`); menentang (ID: `keyterm:Condemn`); hati (ID: `keyterm:Heart`); memutuskan (ID: `keyterm:Decided`); memberkati (ID: `keyterm:Bless`); berdoa (ID: `keyterm:Pray`); perumpamaan (ID: `keyterm:Parable`); mengampuni (ID: `keyterm:Forgive`); menjadi murid (ID: `keyterm:Disciple`); harapan (ID: `keyterm:Hope`); Storeroom (ID: `realia:Storeroom`); Cloak (ID: `realia:Cloak`); Thistle (ID: `flora:Thistle`); Boxthorn (ID: `flora:Boxthorn`); Tunic (ID: `realia:Tunic.2`); Vine (ID: `flora:Vine`); Acacia (ID: `flora:Acacia`); Brier (ID: `flora:Brier`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); meminta (ID: `keyterm:AskFor`); Temple (ID: `realia:Temple`); House (ID: `realia:House`); Nain (ID: `place:Nain`); Yehuda (ID: `place:Judea`); kemuliaan (ID: `keyterm:Glory`); keahlian (ID: `keyterm:Ability`); kasihi (ID: `keyterm:Love`); firman (ID: `keyterm:Word`); kekuasaan (ID: `keyterm:Authority.2`); Tuhan (ID: `deity:Lord`); rahmat (ID: `keyterm:Affection`); memerintahkan (ID: `keyterm:Command`); takut (ID: `keyterm:Fear`); percaya (ID: `keyterm:Believe`); A Group of People (ID: `group:GenericGroup`); Jews (ID: `group:Jews`); menjadi murid (ID: `keyterm:Disciple`); Israel (ID: `person:Israel`); Kapernaum (ID: `place:Capernaum`); keselamatan (ID: `keyterm:Salvation`); Housetop (ID: `realia:Housetop`); Synagogue (ID: `realia:Synagogue`); Bier (ID: `realia:Bier`)
...
* **Associated ACAI Concepts:** Yohanes (ID: `person:John`); Tuhan (ID: `deity:Lord`); pembaptis (ID: `keyterm:Baptist`); pemungut cukai (ID: `keyterm:TaxCollector`); An Angel (ID: `deity:Angel`); baptisan (ID: `keyterm:Baptism`); injil (ID: `keyterm:GoodNews`); taati perintah yang benar (ID: `keyterm:ObeyRighteousCommands`); Yesus (ID: `person:Jesus.2`); berbahagialah (ID: `keyterm:Happy`); kerajaan (ID: `keyterm:Kingdom`); indah (ID: `keyterm:Glorious`); membersihkan (ID: `keyterm:Cleanse.2`); kebangkitan (ID: `keyterm:Resurrection`); melayani (ID: `keyterm:Serve`); mengampuni (ID: `keyterm:Forgive`); menjadi murid (ID: `keyterm:Disciple`); Demons (ID: `deity:Demons`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisees (ID: `group:Pharisee`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Palace (ID: `realia:Palace`); Clothing (ID: `realia:Clothing`); Reed (ID: `flora:Reed`); Flute (ID: `realia:Flute`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** mengampuni (ID: `keyterm:Forgive`); Simon (ID: `person:Simon.6`); berbuat dosa (ID: `keyterm:Sin`); Pharisees (ID: `group:Pharisee`); Myrrh (ID: `flora:Myrrh`); House (ID: `realia:House`); Myrrh (ID: `realia:Myrrh`); kasihi (ID: `keyterm:Love`); diurapi (ID: `keyterm:Anointed`); berhutang (ID: `keyterm:Owe`); Yesus (ID: `person:Jesus.2`); memutuskan (ID: `keyterm:Decided`); percaya (ID: `keyterm:Believe`); meminta (ID: `keyterm:AskFor`); memperdamaikan (ID: `keyterm:Peace`); keselamatan (ID: `keyterm:Salvation`); Alabaster Jar (ID: `realia:AlabasterJar`); Temple (ID: `realia:Temple`); Denarius (ID: `realia:Denarius`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** perumpamaan (ID: `keyterm:Parable`); Tuhan (ID: `deity:Lord`); hati (ID: `keyterm:Heart`); kerajaan (ID: `keyterm:Kingdom`); percaya (ID: `keyterm:Believe`); melayani (ID: `keyterm:Serve`); Thistle (ID: `flora:Thistle`); Boxthorn (ID: `flora:Boxthorn`); Grain (ID: `flora:Grain`); Acacia (ID: `flora:Acacia`); Brier (ID: `flora:Brier`); Barley (ID: `flora:Barley`); baik (ID: `keyterm:Honest`); Susana (ID: `person:Susanna`); Maria (ID: `person:Marymagdalene`); hidup (ID: `keyterm:DailyLife`); Khuza (ID: `person:Chuza`); Yohana (ID: `person:Joanna`); injil (ID: `keyterm:GoodNews`); memberitakan (ID: `keyterm:Proclaim`); Cause of Joy (ID: `keyterm:CauseOfJoy`); mencobai (ID: `keyterm:PutToTheTest`); sorga (ID: `keyterm:Heaven`); Herodes (ID: `person:Herod.2`); menjadi murid (ID: `keyterm:Disciple`); Demons (ID: `deity:Demons`); keselamatan (ID: `keyterm:Salvation`); Lampstand (ID: `realia:Lampstand.2`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); Yesus (ID: `person:Jesus.2`); takut (ID: `keyterm:Fear`); meminta (ID: `keyterm:AskFor`); Gerasa (ID: `place:Gerasa`); Tuhan (ID: `deity:Lord`); Ship (ID: `realia:Ship`); House (ID: `realia:House`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); kerasukan setan (ID: `keyterm:DemonPossessed`); Legion (ID: `deity:Legion`); jurang maut (ID: `keyterm:Abyss`); memberitakan (ID: `keyterm:Proclaim`); Galilea (ID: `place:Galilee`); nama (ID: `keyterm:Name`); A Man (ID: `person:GenericMale`); memerintahkan (ID: `keyterm:Command`); percaya (ID: `keyterm:Believe`); menjadi murid (ID: `keyterm:Disciple`); keselamatan (ID: `keyterm:Salvation`); Fetter (ID: `realia:Fetter`); Temple (ID: `realia:Temple`); Clothing (ID: `realia:Clothing`); Chain (ID: `realia:Chain`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); darah (ID: `keyterm:Blood`); Petrus (ID: `person:Peter`); percaya (ID: `keyterm:Believe`); keselamatan (ID: `keyterm:Salvation`); Synagogue (ID: `realia:Synagogue`); House (ID: `realia:House`); Yairus (ID: `person:Jairus`); keahlian (ID: `keyterm:Ability`); kehidupan (ID: `keyterm:Life`); nama (ID: `keyterm:Name`); hidup (ID: `keyterm:DailyLife`); takut (ID: `keyterm:Fear`); melayani (ID: `keyterm:Serve`); meminta (ID: `keyterm:AskFor`); Yakobus (ID: `person:James`); memperdamaikan (ID: `keyterm:Peace`); roh (ID: `keyterm:Spirit.2`); Yohanes (ID: `person:John.2`); Temple (ID: `realia:Temple`); Tassel (ID: `realia:Tassel`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** kerajaan (ID: `keyterm:Kingdom`); Tuhan (ID: `deity:Lord`); Yohanes (ID: `person:John`); Herodes (ID: `person:Herod.2`); melayani (ID: `keyterm:Serve`); menjadi murid (ID: `keyterm:Disciple`); Fish (ID: `fauna:Fish`); keahlian (ID: `keyterm:Ability`); injil (ID: `keyterm:GoodNews`); memberitakan (ID: `keyterm:Proclaim`); Elia (ID: `person:Elijah`); Betsaida (ID: `place:Bethsaida`); memberkati (ID: `keyterm:Bless`); kekuasaan (ID: `keyterm:Authority.2`); sorga (ID: `keyterm:Heaven`); kebangkitan (ID: `keyterm:Resurrection`); Demons (ID: `deity:Demons`); A Group of Disciples (ID: `group:GenericDisciples`); bersaksi (ID: `keyterm:BearWitness`); Bag (ID: `realia:Bag`); Tunic (ID: `realia:Tunic.2`); House (ID: `realia:House`); Staff (ID: `realia:Staff`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); membuang (ID: `keyterm:Reject`); kemuliaan (ID: `keyterm:Glory`); keahlian (ID: `keyterm:Ability`); Elia (ID: `person:Elijah`); Yesus (ID: `person:Jesus.2`); kehidupan (ID: `keyterm:Life`); kerajaan (ID: `keyterm:Kingdom`); khusus (ID: `keyterm:Holy`); An Angel (ID: `deity:Angel`); Petrus (ID: `person:Peter`); benar (ID: `keyterm:True`); Yohanes (ID: `person:John`); berdoa (ID: `keyterm:Pray`); memerintahkan (ID: `keyterm:Command`); kebangkitan (ID: `keyterm:Resurrection`); pembaptis (ID: `keyterm:Baptist`); menjadi murid (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); keselamatan (ID: `keyterm:Salvation`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Petrus (ID: `person:Peter`); kemuliaan (ID: `keyterm:Glory`); Elia (ID: `person:Elijah`); Musa (ID: `person:Moses`); Yesus (ID: `person:Jesus.2`); berdoa (ID: `keyterm:Pray`); Yerusalem (ID: `place:Jerusalem`); menggenapi (ID: `keyterm:Happen`); takut (ID: `keyterm:Fear`); Yohanes (ID: `person:John.2`); orang pilihan (ID: `keyterm:Chosen`); Yakobus (ID: `person:James`); Clothing (ID: `realia:Clothing`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); menjadi murid (ID: `keyterm:Disciple`); nama (ID: `keyterm:Name`); Demons (ID: `deity:Demons`); tidak setia (ID: `keyterm:Unfaithful`); memerintahkan (ID: `keyterm:Command`); firman (ID: `keyterm:Word`); takut (ID: `keyterm:Fear`); Yohanes (ID: `person:John.2`); meminta (ID: `keyterm:AskFor`); Tuhan (ID: `deity:Lord`); hati (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** Yerusalem (ID: `place:Jerusalem`); kerajaan (ID: `keyterm:Kingdom`); sorga (ID: `keyterm:Heaven`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); Samaritans (ID: `group:Samaritan`); Religious Official (ID: `person:ReligiousOfficial`); menjadi murid (ID: `keyterm:Disciple`); memerintahkan (ID: `keyterm:Command`); An Angel (ID: `deity:Angel`); A Man (ID: `person:GenericMale`); Yohanes (ID: `person:John.2`); Samaria (ID: `place:Samaria`); Yakobus (ID: `person:James`); House (ID: `realia:House`); Mattock (ID: `realia:Mattock`); Jackal (ID: `fauna:Jackal`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); sorga (ID: `keyterm:Heaven`); memperdamaikan (ID: `keyterm:Peace`); keahlian (ID: `keyterm:Ability`); Tirus (ID: `place:Tyre`); kerajaan (ID: `keyterm:Kingdom`); nama (ID: `keyterm:Name`); Sidon (ID: `place:Sidon`); House (ID: `realia:House`); Khorazim (ID: `place:Chorazin`); Disaster (ID: `keyterm:Disaster`); Yesus (ID: `person:Jesus.2`); Hell (ID: `place:Hell`); berbahagialah (ID: `keyterm:Happy`); Betsaida (ID: `place:Bethsaida`); Cause of Joy (ID: `keyterm:CauseOfJoy`); bertindak jahat (ID: `keyterm:ActWickedly`); bertobat (ID: `keyterm:Repent`); penghakiman (ID: `keyterm:Judgment`); kekuasaan (ID: `keyterm:Authority.2`); Iblis (ID: `deity:Satan`); meminta (ID: `keyterm:AskFor`); melayani (ID: `keyterm:Serve`); Roh (ID: `deity:HolySpirit`); pengadilan (ID: `keyterm:CourtCase`); menjadi murid (ID: `keyterm:Disciple`); Sodom (ID: `place:Sodom`); Demons (ID: `deity:Demons`); Kapernaum (ID: `place:Capernaum`); alam maut (ID: `keyterm:WorldOfTheDead`); Scorpion (ID: `fauna:Scorpion`); Bag (ID: `realia:Bag`); Sheep (ID: `fauna:Lamb`); Sackcloth (ID: `realia:Sackcloth`); Wolf (ID: `fauna:Wolf`); Snake (ID: `fauna:Snake`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); A Priest (ID: `person:GenericPriest`); A Scribe (ID: `person:Scribe`); kehidupan (ID: `keyterm:Life`); Inn (ID: `realia:Inn`); pikiran (ID: `keyterm:Mind.2`); belas kasihan (ID: `keyterm:Mercy`); Yerusalem (ID: `place:Jerusalem`); kasihi (ID: `keyterm:Love`); hati (ID: `keyterm:Heart`); Yerikho (ID: `place:Jericho`); Samaritans (ID: `group:Samaritan`); selama, lamanya (ID: `keyterm:Always`); Tuhan (ID: `deity:Lord`); rahmat (ID: `keyterm:Affection`); hukum (ID: `keyterm:Law`); Samaria (ID: `place:Samaria`); Lewi (ID: `person:Levi.3`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Lewi (ID: `group:Levi`); Denarius (ID: `realia:Denarius`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Marta (ID: `person:Martha`); Maria (ID: `person:Mary.3`); Yesus (ID: `person:Jesus.2`); memerintahkan (ID: `keyterm:Command`); nama (ID: `keyterm:Name`); yang baik (ID: `keyterm:Good`); melayani (ID: `keyterm:Serve`); orang pilihan (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); Tuhan (ID: `deity:Lord`); kerajaan (ID: `keyterm:Kingdom`); menjadi murid (ID: `keyterm:Disciple`); sorga (ID: `keyterm:Heaven`); khusus (ID: `keyterm:Holy`); berbuat dosa (ID: `keyterm:Sin`); nama (ID: `keyterm:Name`); membawa masuk (ID: `keyterm:BringIn`); A Group of Disciples (ID: `group:GenericDisciples`); mencobai (ID: `keyterm:PutToTheTest`); Yohanes (ID: `person:John`); mengampuni (ID: `keyterm:Forgive`); Roh (ID: `deity:HolySpirit`); Fish (ID: `fauna:Fish`); Snake (ID: `fauna:Snake`); Door (ID: `realia:Door`); Scorpion (ID: `fauna:Scorpion`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); kerajaan (ID: `keyterm:Kingdom`); Iblis (ID: `deity:Satan`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); memperdamaikan (ID: `keyterm:Peace`); sorga (ID: `keyterm:Heaven`); tanda (ID: `keyterm:Example`); A Group of People (ID: `group:GenericGroup`); Tuhan (ID: `deity:Lord`); hati (ID: `keyterm:Heart`); membujuk (ID: `keyterm:Persuade`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Yunus (ID: `person:Jonah.2`); Niniwe (ID: `group:Nineveh`); pengadilan (ID: `keyterm:CourtCase`); tubuh (ID: `keyterm:Body.3`); tanda (ID: `keyterm:Example`); penghakiman (ID: `keyterm:Judgment`); Niniwe (ID: `place:Nineveh`); berbahagialah (ID: `keyterm:Happy`); memberitakan (ID: `keyterm:Proclaim`); bertobat (ID: `keyterm:Repent`); negeri (ID: `person:QueenOfSheba`); Sheba (ID: `place:Sheba.2`); Salomo (ID: `person:Solomon`); Tuhan (ID: `deity:Lord`); A Woman (ID: `person:GenericFemale`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** Pharisees (ID: `group:Pharisee`); Disaster (ID: `keyterm:Disaster`); darah (ID: `keyterm:Blood`); kasihi (ID: `keyterm:Love`); Tuhan (ID: `deity:Lord`); Zakharia (ID: `person:Zechariah.12`); keahlian (ID: `keyterm:Ability`); Habel (ID: `person:Abel`); Yesus (ID: `person:Jesus.2`); penghakiman (ID: `keyterm:Judgment`); membersihkan (ID: `keyterm:Cleanse.2`); suci (ID: `keyterm:Clean`); meminta (ID: `keyterm:AskFor`); saksi (ID: `keyterm:Witness`); A Scribe (ID: `person:Scribe`); Plate (ID: `realia:Plate.2`); Rue (ID: `flora:Rue`); Mint (ID: `flora:Mint`); Synagogue (ID: `realia:Synagogue`); Grass (ID: `flora:Grass`); House (ID: `realia:House`); Grave (ID: `realia:Grave`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); takut (ID: `keyterm:Fear`); keahlian (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); kekuasaan (ID: `keyterm:Authority.2`); Roh (ID: `deity:HolySpirit`); Sparrow (ID: `fauna:Sparrow`); menghujat (ID: `keyterm:Blaspheme`); neraka (ID: `keyterm:Gehenna`); kemunafikan (ID: `keyterm:Hypocrisy`); tubuh (ID: `keyterm:Body.3`); memberitakan (ID: `keyterm:Proclaim`); Hell (ID: `place:Hell`); membawa masuk (ID: `keyterm:BringIn`); mengampuni (ID: `keyterm:Forgive`); menjadi murid (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); Inner Room (ID: `realia:InnerRoom`); Assarion (ID: `realia:Assarion`); Housetop (ID: `realia:Housetop`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kehidupan (ID: `keyterm:Life`); tubuh (ID: `keyterm:Body.3`); kerajaan (ID: `keyterm:Kingdom`); Barn (ID: `realia:Barn`); kemuliaan (ID: `keyterm:Glory`); keahlian (ID: `keyterm:Ability`); Salomo (ID: `person:Solomon`); hati (ID: `keyterm:Heart`); perumpamaan (ID: `keyterm:Parable`); sorga (ID: `keyterm:Heaven`); memerintahkan (ID: `keyterm:Command`); takut (ID: `keyterm:Fear`); menjadi murid (ID: `keyterm:Disciple`); kurang percaya (ID: `keyterm:HavingLittleFaith`); A Person (ID: `person:GenericPerson`); Bag (ID: `realia:Bag`); Oven (ID: `realia:Oven`); Storeroom (ID: `realia:Storeroom`); Flock (ID: `fauna:Flock`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Crow (ID: `fauna:Crow`); Wheat (ID: `flora:Wheat`); Rooster (ID: `fauna:Rooster`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`); Bird (ID: `fauna:Bird`); Moth (ID: `fauna:Moth`)
...
* **Associated ACAI Concepts:** berbahagialah (ID: `keyterm:Happy`); amin! (ID: `keyterm:Surely`); Yesus (ID: `person:Jesus.2`); hati (ID: `keyterm:Heart`); memutuskan (ID: `keyterm:Decided`); berdamai (ID: `keyterm:SetFree`); Petrus (ID: `person:Peter`); benar (ID: `keyterm:True`); perumpamaan (ID: `keyterm:Parable`); kesetiaan (ID: `keyterm:Faithfulness`); tidak setia (ID: `keyterm:Unfaithful`); sorga (ID: `keyterm:Heaven`); baptisan (ID: `keyterm:Baptism`); melayani (ID: `keyterm:Serve`); menilai (ID: `keyterm:Interpret`); memperdamaikan (ID: `keyterm:Peace`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Lepton (ID: `realia:Lepton`); House (ID: `realia:House`); Prison (ID: `realia:Prison`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** bertobat (ID: `keyterm:Repent`); Galileans (ID: `group:Galilee`); Galilea (ID: `place:Galilee`); Fig (ID: `flora:Fig`); Yerusalem (ID: `place:Jerusalem`); darah (ID: `keyterm:Blood`); persembahan (ID: `keyterm:Offering`); Siloam (ID: `place:Siloam`); perumpamaan (ID: `keyterm:Parable`); Pilatus (ID: `person:Pilate`); Tower (ID: `realia:Tower`); Vine (ID: `flora:Vine`); Watch-Tower (ID: `realia:Watch-tower`)
...
* **Associated ACAI Concepts:** sabat (ID: `keyterm:Sabbath`); Yesus (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Religious Official (ID: `person:ReligiousOfficial`); kemuliaan (ID: `keyterm:Glory`); Iblis (ID: `deity:Satan`); melayani (ID: `keyterm:Serve`); Tuhan (ID: `deity:Lord`); indah (ID: `keyterm:Glorious`); Abraham (ID: `person:Abraham`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Donkey (ID: `fauna:Donkey`)
...
* **Associated ACAI Concepts:** kerajaan (ID: `keyterm:Kingdom`); Tuhan (ID: `deity:Lord`); Door (ID: `realia:Door`); Yerusalem (ID: `place:Jerusalem`); lalim (ID: `keyterm:UnjustDeed`); sorga (ID: `keyterm:Heaven`); keselamatan (ID: `keyterm:Salvation`); Israel (ID: `person:Israel`); A Person (ID: `person:GenericPerson`); Ishak (ID: `person:Isaac`); Abraham (ID: `person:Abraham`); Saton (ID: `realia:Saton`); Grain (ID: `flora:Grain`); Mustard (ID: `flora:Mustard`)
...
* **Associated ACAI Concepts:** Yerusalem (ID: `place:Jerusalem`); nama (ID: `keyterm:Name`); memberkati (ID: `keyterm:Bless`); Demons (ID: `deity:Demons`); Herodes (ID: `person:Herod.2`); Yesus (ID: `person:Jesus.2`); Pharisees (ID: `group:Pharisee`); Tuhan (ID: `deity:Lord`); Rooster (ID: `fauna:Rooster`); House (ID: `realia:House`); Jackal (ID: `fauna:Jackal`); Bird (ID: `fauna:Bird`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** sabat (ID: `keyterm:Sabbath`); Pharisees (ID: `group:Pharisee`); kemuliaan (ID: `keyterm:Glory`); berbahagialah (ID: `keyterm:Happy`); Yesus (ID: `person:Jesus.2`); kebangkitan (ID: `keyterm:Resurrection`); Be Lawful (ID: `keyterm:Lawful`); melayani (ID: `keyterm:Serve`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); orang pilihan (ID: `keyterm:Chosen`); perumpamaan (ID: `keyterm:Parable`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** meminta (ID: `keyterm:AskFor`); kerajaan (ID: `keyterm:Kingdom`); A Scribe (ID: `person:Scribe`); Tuhan (ID: `deity:Lord`); berbahagialah (ID: `keyterm:Happy`); menilai (ID: `keyterm:Interpret`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** menjadi murid (ID: `keyterm:Disciple`); memperdamaikan (ID: `keyterm:Peace`); kehidupan (ID: `keyterm:Life`); meminta (ID: `keyterm:AskFor`); Tower (ID: `realia:Tower`); Watch-Tower (ID: `realia:Watch-tower`); Cross (ID: `realia:Cross`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Cause of Joy (ID: `keyterm:CauseOfJoy`); bertobat (ID: `keyterm:Repent`); Drachma (ID: `realia:Drachma`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); sorga (ID: `keyterm:Heaven`); An Angel (ID: `deity:Angel`); Pharisees (ID: `group:Pharisee`); pemungut cukai (ID: `keyterm:TaxCollector`); Tuhan (ID: `deity:Lord`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); perumpamaan (ID: `keyterm:Parable`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Cattle (ID: `fauna:Bull`); hidup (ID: `keyterm:DailyLife`); orang upahan (ID: `keyterm:HiredWorker`); kehidupan (ID: `keyterm:Life`); berbuat dosa (ID: `keyterm:Sin`); sorga (ID: `keyterm:Heaven`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); rahmat (ID: `keyterm:Affection`); perintah (ID: `keyterm:Commandment`); melayani (ID: `keyterm:Serve.2`); meminta (ID: `keyterm:AskFor`); Kid (ID: `fauna:Kid`); Carob (ID: `flora:Carob`); Cloak (ID: `realia:Cloak`); Goat (ID: `fauna:Goat`); Seal (ID: `realia:Seal`); House (ID: `realia:House`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** kesetiaan (ID: `keyterm:Faithfulness`); tugas bendahara (ID: `keyterm:Stewardship`); berhutang (ID: `keyterm:Owe`); lalim (ID: `keyterm:UnjustDeed`); selama, lamanya (ID: `keyterm:Always`); Kor (ID: `realia:Kor.2`); menjadi murid (ID: `keyterm:Disciple`); keahlian (ID: `keyterm:Ability`); percaya (ID: `keyterm:Believe`); kekuasaan (ID: `keyterm:Authority.2`); benar (ID: `keyterm:True`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Olive Oil (ID: `realia:OliveOil`); Tent (ID: `realia:Tent`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); hukum (ID: `keyterm:Law`); persundalan (ID: `keyterm:Fornication`); kerajaan (ID: `keyterm:Kingdom`); injil (ID: `keyterm:GoodNews`); sorga (ID: `keyterm:Heaven`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); kasihi (ID: `keyterm:Love`); hamba uang (ID: `keyterm:LovingWealth`); Pharisees (ID: `group:Pharisee`); Yohanes (ID: `person:John`); hati (ID: `keyterm:Heart`); melayani (ID: `keyterm:Serve.2`); kekejian (ID: `keyterm:Abomination`)
...
* **Associated ACAI Concepts:** Abraham (ID: `person:Abraham`); Lazarus (ID: `person:Lazarus`); Musa (ID: `person:Moses`); meminta (ID: `keyterm:AskFor`); alam maut (ID: `keyterm:WorldOfTheDead`); nama (ID: `keyterm:Name`); An Angel (ID: `deity:Angel`); bertobat (ID: `keyterm:Repent`); menasihati (ID: `keyterm:Encourage`); kehidupan (ID: `keyterm:Life`); membujuk (ID: `keyterm:Persuade`); memberi kesaksian yang sungguh, sungguh (ID: `keyterm:Declare`); Hell (ID: `place:Hell`); belas kasihan (ID: `keyterm:Mercy`); Dog (ID: `fauna:Dog`); Purple Cloth (ID: `realia:PurpleCloth`); Linen (ID: `realia:Linen`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); berbuat dosa (ID: `keyterm:Sin`); bertobat (ID: `keyterm:Repent`); percaya (ID: `keyterm:Believe`); mengampuni (ID: `keyterm:Forgive`); wajib (ID: `keyterm:Ought`); menyesatkan (ID: `keyterm:CauseToStumble`); penyesatan (ID: `keyterm:StumblingBlock`); kebaikan (ID: `keyterm:Favor`); memerintahkan (ID: `keyterm:Command`); melayani (ID: `keyterm:Serve`); menjadi murid (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Disaster (ID: `keyterm:Disaster`); Mulberry (ID: `flora:Mulberry`); Sheep (ID: `fauna:Lamb`); Hand-Mill (ID: `realia:Hand-mill`); Flock (ID: `fauna:Flock`); Grain (ID: `flora:Grain`); Goat (ID: `fauna:Goat`); Mustard (ID: `flora:Mustard`)
...
* **Associated ACAI Concepts:** kemuliaan (ID: `keyterm:Glory`); membersihkan (ID: `keyterm:Cleanse.2`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); Samaria (ID: `place:Samaria`); Yerusalem (ID: `place:Jerusalem`); keselamatan (ID: `keyterm:Salvation`); percaya (ID: `keyterm:Believe`); Samaritans (ID: `group:Samaritan`); belas kasihan (ID: `keyterm:Mercy`); Galilea (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** Lot (ID: `person:Lot`); kerajaan (ID: `keyterm:Kingdom`); sorga (ID: `keyterm:Heaven`); Tuhan (ID: `deity:Lord`); Nuh (ID: `person:Noah`); menjadi murid (ID: `keyterm:Disciple`); membuang (ID: `keyterm:Reject`); Sodom (ID: `place:Sodom`); tubuh (ID: `keyterm:Body.3`); tanda, tanda tampak (ID: `keyterm:Observation`); kehidupan (ID: `keyterm:Life`); Pharisees (ID: `group:Pharisee`); menghidupkan (ID: `keyterm:Alive`); House (ID: `realia:House`); Boat (ID: `realia:Boat`); Vulture (ID: `fauna:Vulture`); Housetop (ID: `realia:Housetop`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); menuntut pembalasan (ID: `keyterm:GrantJustice`); pemungut cukai (ID: `keyterm:TaxCollector`); berdoa (ID: `keyterm:Pray`); Pharisees (ID: `group:Pharisee`); Yesus (ID: `person:Jesus.2`); kerajaan (ID: `keyterm:Kingdom`); perumpamaan (ID: `keyterm:Parable`); takut (ID: `keyterm:Fear`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Temple (ID: `realia:Temple`); berpuasa (ID: `keyterm:Fast`); amin! (ID: `keyterm:Surely`); hati (ID: `keyterm:Heart`); membujuk (ID: `keyterm:Persuade`); orang pilihan (ID: `keyterm:Chosen`); lalim (ID: `keyterm:UnjustDeed`); sorga (ID: `keyterm:Heaven`); memerintahkan (ID: `keyterm:Command`); percaya (ID: `keyterm:Believe`); mengampuni (ID: `keyterm:Forgive`); menjadi murid (ID: `keyterm:Disciple`); minggu (ID: `keyterm:Week`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kerajaan (ID: `keyterm:Kingdom`); Yesus (ID: `person:Jesus.2`); yang baik (ID: `keyterm:Good`); kehidupan (ID: `keyterm:Life`); selama, lamanya (ID: `keyterm:Always`); keahlian (ID: `keyterm:Ability`); sorga (ID: `keyterm:Heaven`); amin! (ID: `keyterm:Surely`); Petrus (ID: `person:Peter`); Rich Young Ruler (ID: `person:RichYoungRuler`); persundalan (ID: `keyterm:Fornication`); perintah (ID: `keyterm:Commandment`); keselamatan (ID: `keyterm:Salvation`); Needle (ID: `realia:Needle`); House (ID: `realia:House`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Daud (ID: `person:David`); belas kasihan (ID: `keyterm:Mercy`); kemuliaan (ID: `keyterm:Glory`); Yerusalem (ID: `place:Jerusalem`); memerintahkan (ID: `keyterm:Command`); firman (ID: `keyterm:Word`); percaya (ID: `keyterm:Believe`); Gentiles (ID: `group:Gentile`); Nazaret (ID: `place:Nazareth`); Tuhan (ID: `deity:Lord`); Yerikho (ID: `place:Jericho`); keselamatan (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Zakheus (ID: `person:Zacchaeus`); keselamatan (ID: `keyterm:Salvation`); nama (ID: `keyterm:Name`); Yerikho (ID: `place:Jericho`); Abraham (ID: `person:Abraham`); Sycomore Fig (ID: `flora:SycomoreFig`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Mina (ID: `realia:Mina`); kerajaan (ID: `keyterm:Kingdom`); memutuskan (ID: `keyterm:Decided`); keahlian (ID: `keyterm:Ability`); Yerusalem (ID: `place:Jerusalem`); kesetiaan (ID: `keyterm:Faithfulness`); yang baik (ID: `keyterm:Good`); takut (ID: `keyterm:Fear`); kekuasaan (ID: `keyterm:Authority.2`); Tuhan (ID: `deity:Lord`); perumpamaan (ID: `keyterm:Parable`); Band of Cloth (ID: `realia:BandOfCloth`)
...
* **Associated ACAI Concepts:** menjadi murid (ID: `keyterm:Disciple`); Donkey (ID: `fauna:Donkey`); Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); memperdamaikan (ID: `keyterm:Peace`); Temple (ID: `realia:Temple`); Yerusalem (ID: `place:Jerusalem`); Clothing (ID: `realia:Clothing`); Olive Tree (ID: `flora:OliveTree`); Betfage (ID: `place:Bethphage`); Betania (ID: `place:Bethany`); Zaitun (ID: `place:OlivesMount`); tempat yang tinggi (ID: `keyterm:Height`); kemuliaan (ID: `keyterm:Glory`); keahlian (ID: `keyterm:Ability`); nama (ID: `keyterm:Name`); memberkati (ID: `keyterm:Bless`); berdoa (ID: `keyterm:Pray`); sorga (ID: `keyterm:Heaven`); memerintahkan (ID: `keyterm:Command`); A Group of People (ID: `group:GenericGroup`); meminta (ID: `keyterm:AskFor`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisees (ID: `group:Pharisee`); Siege-Works (ID: `realia:Siege-works`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); keahlian (ID: `keyterm:Ability`); hampa (ID: `keyterm:Empty`); kekuasaan (ID: `keyterm:Authority.2`); Yohanes (ID: `person:John`); perumpamaan (ID: `keyterm:Parable`); sorga (ID: `keyterm:Heaven`); Temple (ID: `realia:Temple`); injil (ID: `keyterm:GoodNews`); Yesus (ID: `person:Jesus.2`); hati (ID: `keyterm:Heart`); membujuk (ID: `keyterm:Persuade`); membuang (ID: `keyterm:Reject`); kekasih (ID: `keyterm:Beloved`); takut (ID: `keyterm:Fear`); percaya (ID: `keyterm:Believe`); baptisan (ID: `keyterm:Baptism`); meminta (ID: `keyterm:AskFor`); Cornerstone (ID: `realia:Cornerstone`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); kebangkitan (ID: `keyterm:Resurrection`); Tiberius (ID: `person:Tiberius`); keahlian (ID: `keyterm:Ability`); Daud (ID: `person:David`); Yesus (ID: `person:Jesus.2`); selama, lamanya (ID: `keyterm:Always`); Musa (ID: `person:Moses`); kebenaran (ID: `keyterm:Truth`); kehidupan (ID: `keyterm:Life`); Be Lawful (ID: `keyterm:Lawful`); A Priest (ID: `person:GenericPriest`); firman (ID: `keyterm:Word`); jalan tuhan (ID: `keyterm:TheWay`); kekuasaan (ID: `keyterm:Authority.2`); Sadducees (ID: `group:Sadducee`); Abraham (ID: `person:Abraham`); Israel (ID: `person:Israel`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); kemunafikan (ID: `keyterm:Hypocrisy`); Ishak (ID: `person:Isaac`); pajak (ID: `keyterm:TributeTax`); Boxthorn (ID: `flora:Boxthorn`); Footstool (ID: `realia:Footstool`); Denarius (ID: `realia:Denarius`); Image (ID: `realia:Image`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** persembahan (ID: `keyterm:Offering`); menjadi murid (ID: `keyterm:Disciple`); hidup (ID: `keyterm:DailyLife`); persahabatan (ID: `keyterm:Friendship`); penghakiman (ID: `keyterm:Judgment`); benar (ID: `keyterm:True`); berdoa (ID: `keyterm:Pray`); Lepton (ID: `realia:Lepton`); House (ID: `realia:House`); Treasury (ID: `realia:Treasury`); Synagogue (ID: `realia:Synagogue`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** nama (ID: `keyterm:Name`); sorga (ID: `keyterm:Heaven`); Yerusalem (ID: `place:Jerusalem`); keahlian (ID: `keyterm:Ability`); hati (ID: `keyterm:Heart`); kerajaan (ID: `keyterm:Kingdom`); tanda (ID: `keyterm:Example`); kemuliaan (ID: `keyterm:Glory`); amin! (ID: `keyterm:Surely`); menuntut pembalasan (ID: `keyterm:GrantJustice`); Tuhan (ID: `deity:Lord`); perumpamaan (ID: `keyterm:Parable`); Yehuda (ID: `place:Judea`); penebusan (ID: `keyterm:Liberation`); takut (ID: `keyterm:Fear`); meminta (ID: `keyterm:AskFor`); hal, hal yang mengejutkan (ID: `keyterm:DreadfulEventOrSight`); Gentiles (ID: `group:Gentile`); Disaster (ID: `keyterm:Disaster`); duniawi (ID: `keyterm:OfThisLife`); bersaksi (ID: `keyterm:BearWitness`); Temple (ID: `realia:Temple`); Net (ID: `realia:Net`); Synagogue (ID: `realia:Synagogue`); Fig (ID: `flora:Fig`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); Yudas (ID: `person:Judas.2`); takut (ID: `keyterm:Fear`); Iblis (ID: `deity:Satan`); Zaitun (ID: `place:OlivesMount`); paskah (ID: `keyterm:Passover`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** paskah (ID: `keyterm:Passover`); kerajaan (ID: `keyterm:Kingdom`); Tuhan (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); melayani (ID: `keyterm:Serve`); House (ID: `realia:House`); darah (ID: `keyterm:Blood`); tubuh (ID: `keyterm:Body.3`); memutuskan (ID: `keyterm:Decided`); persembahan (ID: `keyterm:Offering`); Petrus (ID: `person:Peter`); kekuasaan (ID: `keyterm:Authority.2`); menggenapi (ID: `keyterm:Happen`); menjadi murid (ID: `keyterm:Disciple`); Israel (ID: `person:Israel`); Gentiles (ID: `group:Gentile`); perjanjian (ID: `keyterm:Covenant`); Yohanes (ID: `person:John.2`); Disaster (ID: `keyterm:Disaster`); Upstairs Room (ID: `realia:UpstairsRoom`); Guest Room (ID: `realia:GuestRoom`); Clay Jar (ID: `realia:ClayJar`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** berdoa (ID: `keyterm:Pray`); Petrus (ID: `person:Peter`); mencobai (ID: `keyterm:PutToTheTest`); menjadi murid (ID: `keyterm:Disciple`); Bag (ID: `realia:Bag`); An Angel (ID: `deity:Angel`); Tuhan (ID: `deity:Lord`); sorga (ID: `keyterm:Heaven`); tak kenal hukum (ID: `keyterm:Lawless`); percaya (ID: `keyterm:Believe`); Iblis (ID: `deity:Satan`); kitab suci (ID: `keyterm:Scripture`); meminta (ID: `keyterm:AskFor`); A Group of Disciples (ID: `group:GenericDisciples`); Wheat (ID: `flora:Wheat`); Rooster (ID: `fauna:Rooster`); Cloak (ID: `realia:Cloak`); Olive Tree (ID: `flora:OliveTree`); Prison (ID: `realia:Prison`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Petrus (ID: `person:Peter`); Yesus (ID: `person:Jesus.2`); Yudas (ID: `person:Judas.2`); Rooster (ID: `fauna:Rooster`); Temple (ID: `realia:Temple`); Peter's Second Accuser (ID: `person:SecondAccuserOfPeter`); A Servant (ID: `person:GenericServant`); keahlian (ID: `keyterm:Ability`); kekuasaan (ID: `keyterm:Authority.2`); kebenaran (ID: `keyterm:Truth`); Galileans (ID: `group:Galilee`); Galilea (ID: `place:Galilee`); House (ID: `realia:House`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Pilatus (ID: `person:Pilate`); keahlian (ID: `keyterm:Ability`); Yesus (ID: `person:Jesus.2`); Galilea (ID: `place:Galilee`); Priests (ID: `group:GenericPriests`); Elders (ID: `group:GenericElders`); meminta (ID: `keyterm:AskFor`); Religious Officials (ID: `group:ReligiousOfficials`); Yerusalem (ID: `place:Jerusalem`); kepenuhan (roh) seperti nabi (ID: `keyterm:Speak`); kekuasaan (ID: `keyterm:Authority.2`); Tuhan (ID: `deity:Lord`); Yehuda (ID: `place:Judea`); Tiberius (ID: `person:Tiberius`); Herodes (ID: `person:Herod.2`); menghujat (ID: `keyterm:Blaspheme`); percaya (ID: `keyterm:Believe`); Galileans (ID: `group:Galilee`); Jews (ID: `group:Jews`); pajak (ID: `keyterm:TributeTax`); bersaksi (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** Pilatus (ID: `person:Pilate`); Herodes (ID: `person:Herod.2`); Yesus (ID: `person:Jesus.2`); Barabas (ID: `person:Barabbas`); Cross (ID: `realia:Cross`); Prison (ID: `realia:Prison`); memutuskan (ID: `keyterm:Decided`); bimbang (ID: `keyterm:Discern`); tanda (ID: `keyterm:Example`); harapan (ID: `keyterm:Hope`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Tuhan (ID: `deity:Lord`); keselamatan (ID: `keyterm:Salvation`); Jews (ID: `group:Jews`); Cross (ID: `realia:Cross`); Criminal on the Cross (ID: `person:Dysmas`); Simon (ID: `person:Simon.5`); Kirene (ID: `place:Cyrene`); Yerusalem (ID: `place:Jerusalem`); amin! (ID: `keyterm:Surely`); berbahagialah (ID: `keyterm:Happy`); orang pilihan (ID: `keyterm:Chosen`); penghakiman (ID: `keyterm:Judgment`); firdaus (ID: `keyterm:Paradise`); memerintahkan (ID: `keyterm:Command`); takut (ID: `keyterm:Fear`); menghujat (ID: `keyterm:Blaspheme`); mengampuni (ID: `keyterm:Forgive`); Golgotha (ID: `place:Golgotha`); Sour Wine (ID: `realia:SourWine`); Clothing (ID: `realia:Clothing`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); tubuh (ID: `keyterm:Body.3`); Yesus (ID: `person:Jesus.2`); sabat (ID: `keyterm:Sabbath`); Galilea (ID: `place:Galilee`); menjadi (atau menunjukkan diri) tidak bersalah (ID: `keyterm:Just`); Grave (ID: `realia:Grave`); Yusuf (ID: `person:Joseph.6`); Arimatea (ID: `place:Arimathea`); kemuliaan (ID: `keyterm:Glory`); perintah (ID: `keyterm:Commandment`); Pilatus (ID: `person:Pilate`); kerajaan (ID: `keyterm:Kingdom`); nama (ID: `keyterm:Name`); yang baik (ID: `keyterm:Good`); Jews (ID: `group:Jews`); roh (ID: `keyterm:Spirit.2`); Aloes (ID: `realia:Aloes`); Linen (ID: `realia:Linen`); Myrrh (ID: `flora:Myrrh`); Curtain (ID: `realia:Curtain`); Temple (ID: `realia:Temple`); Myrrh (ID: `realia:Myrrh`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); firman (ID: `keyterm:Word`); minggu (ID: `keyterm:Week`); Yohana (ID: `person:Joanna`); tidak percaya (ID: `keyterm:Disbelieve`); tubuh (ID: `keyterm:Body.3`); Petrus (ID: `person:Peter`); Yakobus (ID: `person:James.3`); kebangkitan (ID: `keyterm:Resurrection`); kehidupan (ID: `keyterm:Life`); Maria (ID: `person:Marymagdalene`); Maria (ID: `person:Mary`); Galilea (ID: `place:Galilee`); Linen (ID: `realia:Linen`); Cross (ID: `realia:Cross`); Clothing (ID: `realia:Clothing`); Aloes (ID: `realia:Aloes`)
...
* **Associated ACAI Concepts:** Yesus (ID: `person:Jesus.2`); Yerusalem (ID: `place:Jerusalem`); hati (ID: `keyterm:Heart`); nama (ID: `keyterm:Name`); kitab suci (ID: `keyterm:Scripture`); Grave (ID: `realia:Grave`); Kleopas (ID: `person:Cleopas`); Emaus (ID: `place:Emmaus`); kemuliaan (ID: `keyterm:Glory`); tubuh (ID: `keyterm:Body.3`); kehidupan (ID: `keyterm:Life`); An Angel (ID: `deity:Angel`); memberkati (ID: `keyterm:Bless`); Petrus (ID: `person:Peter`); penghakiman (ID: `keyterm:Judgment`); Tuhan (ID: `deity:Lord`); penebusan (ID: `keyterm:Liberation`); percaya (ID: `keyterm:Believe`); kebangkitan (ID: `keyterm:Resurrection`); Musa (ID: `person:Moses`); Israel (ID: `person:Israel`); harapan (ID: `keyterm:Hope`); Stade (ID: `realia:Stade`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** memberkati (ID: `keyterm:Bless`); Yerusalem (ID: `place:Jerusalem`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Tuhan (ID: `deity:Lord`); roh (ID: `keyterm:Spirit.2`); menyembah (ID: `keyterm:BowDown`); menggenapi (ID: `keyterm:Happen`); Betania (ID: `place:Bethany`); kitab suci (ID: `keyterm:Scripture`); keahlian (ID: `keyterm:Ability`); tidak percaya (ID: `keyterm:Disbelieve`); tubuh (ID: `keyterm:Body.3`); memberitakan (ID: `keyterm:Proclaim`); Yesus (ID: `person:Jesus.2`); hati (ID: `keyterm:Heart`); nama (ID: `keyterm:Name`); berbuat dosa (ID: `keyterm:Sin`); bertobat (ID: `keyterm:Repent`); hukum (ID: `keyterm:Law`); sorga (ID: `keyterm:Heaven`); janji (ID: `keyterm:Promise`); mengampuni (ID: `keyterm:Forgive`); Musa (ID: `person:Moses`); saksi (ID: `keyterm:Witness`); tempat yang tinggi (ID: `keyterm:Height`); Fish (ID: `fauna:Fish`); Temple (ID: `realia:Temple`)
