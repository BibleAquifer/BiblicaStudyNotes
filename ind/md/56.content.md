...
* **Associated ACAI Concepts:** tak bercacat (ID: `keyterm:WithoutReproach`); Kreta (ID: `place:Crete`); Titus (ID: `person:Titus`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Cretan Prophet (ID: `person:CretanProphet`); Cretans (ID: `group:Cretan`); suci (ID: `keyterm:Clean`)
...
* **Associated ACAI Concepts:** Artemas (ID: `person:Artemas`); Zenas (ID: `person:Zenas`); Nikopolis (ID: `place:Nicopolis`); ramah (ID: `keyterm:Gentle`); sia, sia (ID: `keyterm:Worthless`)
