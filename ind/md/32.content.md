...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yunus (ID: `person:Jonah.2`); Niniwe (ID: `place:Nineveh`); firman tuhan (ID: `keyterm:WordOfTheLord`); takut (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Sackcloth (ID: `realia:Sackcloth`); Fish (ID: `fauna:Fish`); Hell (ID: `place:Hell`); bernazar (ID: `keyterm:Vow`); Amitai (ID: `person:Amittai`); Yafo (ID: `place:Joppa`); Cattle (ID: `fauna:Bull`); lepas atau bebas dari sumpah (ID: `keyterm:Exempt`); pujian (ID: `keyterm:Praise`); Hebrews (ID: `group:Hebrews`); pengorbanan (ID: `keyterm:Slaughtering`); percaya pada (ID: `keyterm:BelieveIn`); undi (ID: `keyterm:Lot`); keselamatan (ID: `keyterm:Salvation`); Tarsis (ID: `place:Tarshish`); kebaikan (ID: `keyterm:Kindness`); Goat (ID: `fauna:Goat`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Cattails (ID: `flora:Cattails`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yunus (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Niniwe (ID: `place:Nineveh`); murah hati (ID: `keyterm:Generous`); penyayang (ID: `keyterm:Compassionate`); Tarsis (ID: `place:Tarshish`); kebaikan (ID: `keyterm:Kindness`); Cattle (ID: `fauna:Bull`); Worm (ID: `fauna:Maggot`)
