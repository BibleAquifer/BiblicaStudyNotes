...
* **Associated Articles:** Dosa (ID: `203330@Unknown`); Puisi (ID: `203339@BiblicaStudyNotesKeyTerms`); Tuhan (ID: `203361@BiblicaStudyNotesKeyTerms`); Doa (ID: `203362@Unknown`); Penghakiman (ID: `203368@Unknown`); Pengorbanan (ID: `203391@BiblicaStudyNotesKeyTerms`); Mengampuni (ID: `203416@Unknown`); Menyembah hanya kepada Allah (ID: `203467@Unknown`); Rahmat (ID: `203477@BiblicaStudyNotesKeyTerms`); Bertobat (ID: `203481@BiblicaStudyNotesKeyTerms`); Hati (ID: `203554@Unknown`); Puasa (ID: `203591@BiblicaStudyNotesKeyTerms`); Asyur (ID: `203628@BiblicaStudyNotesKeyTerms`); Murka Allah (ID: `203635@BiblicaStudyNotesKeyTerms`); Ibrani (ID: `203667@BiblicaStudyNotesKeyTerms`); Berita Penghakiman (ID: `203669@BiblicaStudyNotesKeyTerms`); Yunus (ID: `203708@BiblicaStudyNotesKeyTerms`); Niniwe (ID: `203709@BiblicaStudyNotesKeyTerms`); Laut Mediterania (ID: `203710@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yunus (ID: `person:Jonah.2`); Niniwe (ID: `place:Nineveh`); firman tuhan (ID: `keyterm:WordOfTheLord`); takut (ID: `keyterm:Fear`); Fish (ID: `fauna:Fish`); Sackcloth (ID: `realia:Sackcloth`); Ship (ID: `realia:Ship`); Hell (ID: `place:Hell`); bernazar (ID: `keyterm:Vow`); Amitai (ID: `person:Amittai`); Yafo (ID: `place:Joppa`); Cattle (ID: `fauna:Bull`); lepas atau bebas dari sumpah (ID: `keyterm:Exempt`); pujian (ID: `keyterm:Praise`); Tarsis (ID: `place:Tarshish`); Hebrews (ID: `group:Hebrews`); undi (ID: `keyterm:Lot`); percaya pada (ID: `keyterm:BelieveIn`); kebaikan (ID: `keyterm:Kindness`); pengorbanan (ID: `keyterm:Slaughtering`); keselamatan (ID: `keyterm:Salvation`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Clothing (ID: `realia:Clothing`); Cattails (ID: `flora:Cattails`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yunus (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); kebaikan (ID: `keyterm:Kindness`); Niniwe (ID: `place:Nineveh`); Tarsis (ID: `place:Tarshish`); penyayang (ID: `keyterm:Compassionate`); murah hati (ID: `keyterm:Generous`); Cattle (ID: `fauna:Bull`); Worm (ID: `fauna:Maggot`)
