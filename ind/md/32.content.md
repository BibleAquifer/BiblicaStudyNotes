...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yunus (ID: `person:Jonah.2`); Niniwe (ID: `place:Nineveh`); takut (ID: `keyterm:Fear`); firman tuhan (ID: `keyterm:WordOfTheLord`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Sackcloth (ID: `realia:Sackcloth`); Hell (ID: `place:Hell`); bernazar (ID: `keyterm:Vow`); Amitai (ID: `person:Amittai`); Yafo (ID: `place:Joppa`); Cattle (ID: `fauna:Bull`); keselamatan (ID: `keyterm:Salvation`); kebaikan (ID: `keyterm:Kindness`); pengorbanan (ID: `keyterm:Slaughtering`); lepas atau bebas dari sumpah (ID: `keyterm:Exempt`); Tarsis (ID: `place:Tarshish`); percaya pada (ID: `keyterm:BelieveIn`); pujian (ID: `keyterm:Praise`); Hebrews (ID: `group:Hebrews`); undi (ID: `keyterm:Lot`); Goat (ID: `fauna:Goat`); Clothing (ID: `realia:Clothing`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yunus (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); kebaikan (ID: `keyterm:Kindness`); murah hati (ID: `keyterm:Generous`); Tarsis (ID: `place:Tarshish`); penyayang (ID: `keyterm:Compassionate`); Niniwe (ID: `place:Nineveh`); Worm (ID: `fauna:Maggot`); Cattle (ID: `fauna:Bull`)
