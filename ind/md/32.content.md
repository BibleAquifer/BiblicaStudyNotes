...
* **Associated Passages:** Yunus 1:1-3:10
* **Associated Articles:** Dosa (ID: `203330@BiblicaStudyNotes`); Puisi (ID: `203339@BiblicaStudyNotesKeyTerms`); Tuhan (ID: `203361@BiblicaStudyNotesKeyTerms`); Doa (ID: `203362@BiblicaStudyNotes`); Penghakiman (ID: `203368@BiblicaStudyNotes`); Pengorbanan (ID: `203391@BiblicaStudyNotesKeyTerms`); Mengampuni (ID: `203416@BiblicaStudyNotes`); Menyembah hanya kepada Allah (ID: `203467@BiblicaStudyNotes`); Rahmat (ID: `203477@BiblicaStudyNotesKeyTerms`); Bertobat (ID: `203481@BiblicaStudyNotesKeyTerms`); Hati (ID: `203554@BiblicaStudyNotes`); Puasa (ID: `203591@BiblicaStudyNotesKeyTerms`); Asyur (ID: `203628@BiblicaStudyNotesKeyTerms`); Murka Allah (ID: `203635@BiblicaStudyNotesKeyTerms`); Ibrani (ID: `203667@BiblicaStudyNotesKeyTerms`); Berita Penghakiman (ID: `203669@BiblicaStudyNotesKeyTerms`); Yunus (ID: `203708@BiblicaStudyNotesKeyTerms`); Niniwe (ID: `203709@BiblicaStudyNotesKeyTerms`); Laut Mediterania (ID: `203710@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yunus (ID: `person:Jonah.2`); Niniwe (ID: `place:Nineveh`); takut (ID: `keyterm:Fear`); firman tuhan (ID: `keyterm:WordOfTheLord`); Fish (ID: `fauna:Fish`); Sackcloth (ID: `realia:Sackcloth`); Ship (ID: `realia:Ship`); bernazar (ID: `keyterm:Vow`); Hell (ID: `place:Hell`); Yafo (ID: `place:Joppa`); Amitai (ID: `person:Amittai`); Cattle (ID: `fauna:Bull`); pengorbanan (ID: `keyterm:Slaughtering`); kebaikan (ID: `keyterm:Kindness`); percaya pada (ID: `keyterm:BelieveIn`); lepas atau bebas dari sumpah (ID: `keyterm:Exempt`); pujian (ID: `keyterm:Praise`); undi (ID: `keyterm:Lot`); keselamatan (ID: `keyterm:Salvation`); Hebrews (ID: `group:Hebrews`); Tarsis (ID: `place:Tarshish`); Clothing (ID: `realia:Clothing`); Cattails (ID: `flora:Cattails`); Goat (ID: `fauna:Goat`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`)
...
* **Associated Passages:** Yunus 4:1-11
* **Associated Articles:** Manusia (ID: `203337@BiblicaStudyNotes`); Garis keturunan (ID: `203355@BiblicaStudyNotes`); Yakub (ID: `203403@BiblicaStudyNotesKeyTerms`); Israel (ID: `203415@BiblicaStudyNotesKeyTerms`); Musa (ID: `203435@BiblicaStudyNotesKeyTerms`); Umat Allah (ID: `203437@BiblicaStudyNotesKeyTerms`); Orang luar (ID: `203504@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Tuhan (ID: `deity:Lord`); Yunus (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Niniwe (ID: `place:Nineveh`); penyayang (ID: `keyterm:Compassionate`); murah hati (ID: `keyterm:Generous`); kebaikan (ID: `keyterm:Kindness`); Tarsis (ID: `place:Tarshish`); Cattle (ID: `fauna:Bull`); Worm (ID: `fauna:Maggot`)
