...
* **Associated ACAI Concepts:** Yunus (ID: `person:Jonah.2`); Niniwe (ID: `place:Nineveh`); Amitai (ID: `person:Amittai`); Yafo (ID: `place:Joppa`); Tuhan (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Castor Oil (ID: `flora:CastorOil`); Yunus (ID: `person:Jonah.2`); Tuhan (ID: `deity:Lord`)
