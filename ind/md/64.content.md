...
* **Associated ACAI Concepts:** kebenaran (ID: `keyterm:Truth`); kekasih (ID: `keyterm:Beloved`); jemaat (ID: `keyterm:Church`); bersaksi (ID: `keyterm:BearWitness`); kasihi (ID: `keyterm:Love`); hidup (ID: `keyterm:Live.3`); nama (ID: `keyterm:Name`); Tuhan (ID: `deity:Lord`); Diotrefes (ID: `person:Diotrephes`); Gayus (ID: `person:Gaius.4`); Demetrius (ID: `person:Demetrius`); wajib (ID: `keyterm:Ought`); Cause of Joy (ID: `keyterm:CauseOfJoy`); benar (ID: `keyterm:True`); berdoa (ID: `keyterm:Pray`); kesetiaan (ID: `keyterm:Faithfulness`); yang baik (ID: `keyterm:Good`); lakukan baik (ID: `keyterm:DoGood`); memperdamaikan (ID: `keyterm:Peace`); harapan (ID: `keyterm:Hope`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); Reed (ID: `flora:Reed`)
