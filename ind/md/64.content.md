...
* **Associated ACAI Concepts:** kebenaran (ID: `keyterm:Truth`); kekasih (ID: `keyterm:Beloved`); bersaksi (ID: `keyterm:BearWitness`); jemaat (ID: `keyterm:Church`); nama (ID: `keyterm:Name`); hidup (ID: `keyterm:Live.3`); Tuhan (ID: `deity:Lord`); kasihi (ID: `keyterm:Love`); Diotrefes (ID: `person:Diotrephes`); Gayus (ID: `person:Gaius.4`); Demetrius (ID: `person:Demetrius`); benar (ID: `keyterm:True`); wajib (ID: `keyterm:Ought`); harapan (ID: `keyterm:Hope`); lakukan baik (ID: `keyterm:DoGood`); memperdamaikan (ID: `keyterm:Peace`); kesetiaan (ID: `keyterm:Faithfulness`); Cause of Joy (ID: `keyterm:CauseOfJoy`); berdoa (ID: `keyterm:Pray`); yang baik (ID: `keyterm:Good`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); Reed (ID: `flora:Reed`)
