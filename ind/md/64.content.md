...
* **Associated ACAI Concepts:** Diotrefes (ID: `person:Diotrephes`); Gayus (ID: `person:Gaius.4`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); Demetrius (ID: `person:Demetrius`); kebenaran (ID: `keyterm:Truth`)
