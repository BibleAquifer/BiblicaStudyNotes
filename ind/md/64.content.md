...
* **Associated ACAI Concepts:** kebenaran (ID: `keyterm:Truth`); kekasih (ID: `keyterm:Beloved`); bersaksi (ID: `keyterm:BearWitness`); jemaat (ID: `keyterm:Church`); kasihi (ID: `keyterm:Love`); hidup (ID: `keyterm:Live.3`); Tuhan (ID: `deity:Lord`); nama (ID: `keyterm:Name`); Demetrius (ID: `person:Demetrius`); Gayus (ID: `person:Gaius.4`); Diotrefes (ID: `person:Diotrephes`); Cause of Joy (ID: `keyterm:CauseOfJoy`); wajib (ID: `keyterm:Ought`); harapan (ID: `keyterm:Hope`); yang baik (ID: `keyterm:Good`); benar (ID: `keyterm:True`); berdoa (ID: `keyterm:Pray`); memperdamaikan (ID: `keyterm:Peace`); kesetiaan (ID: `keyterm:Faithfulness`); lakukan baik (ID: `keyterm:DoGood`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); Reed (ID: `flora:Reed`)
