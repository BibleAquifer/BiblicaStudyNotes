...
* **Associated ACAI Concepts:** Colossos (ID: `place:Colossae`); Epafras (ID: `person:Epaphras`); livrar (ID: `keyterm:Deliver`); andar (ID: `keyterm:Live.3`); amado (ID: `keyterm:Beloved`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** irrepreensível (ID: `keyterm:WithoutReproach`); irrepreensível (ID: `keyterm:Unblemished`); fazer a paz (ID: `keyterm:Peace`); igreja (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** elementos (ID: `keyterm:FundamentalPrinciples`); divino (ID: `keyterm:Divine`); tradição (ID: `keyterm:Teaching`); vazio (ID: `keyterm:Empty`); batismo (ID: `keyterm:Baptism`); corpo (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Scythians (ID: `group:Scythians`); pensar (ID: `keyterm:Think`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** favoritismo (ID: `keyterm:Partiality`); to act wickedly (ID: `keyterm:ActWickedly`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Laodiceia (ID: `place:Laodicea`); Ninfa (ID: `person:Nympha`); Hierápolis (ID: `place:Hierapolis`); Justo (ID: `person:Justus.3`); Arquipo (ID: `person:Archippus`); Onésimo (ID: `person:Onesimus`); Epafras (ID: `person:Epaphras`); Demas (ID: `person:Demas`); Lucas (ID: `person:Luke`); Aristarco (ID: `person:Aristarchus`); Tíquico (ID: `person:Tychicus`)
