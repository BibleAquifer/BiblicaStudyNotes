...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zacarias (ID: `person:Zechariah`); Elisabete (ID: `person:Elizabeth`); An Angel (ID: `deity:Angel`); Temple (ID: `realia:Temple`); priesthood (ID: `keyterm:Priesthood`); fear (ID: `keyterm:Fear`); be (or show oneself) just (ID: `keyterm:Just`); Name (ID: `keyterm:Name`); orar (ID: `keyterm:Pray`); Holy Spirit (ID: `deity:HolySpirit`); Herodes (ID: `person:Herod`); Gabriel (ID: `deity:Gabriel`); be blameless (ID: `keyterm:Blameless`); Abias (ID: `person:Abijah.6`); decreto justo (ID: `keyterm:Regulations`); coração (ID: `keyterm:Heart`); Arão (ID: `person:Aaron`); boa notícia (ID: `keyterm:GoodNews`); Judeia (ID: `place:Judea`); Elias (ID: `person:Elijah`); Commandment (ID: `keyterm:Commandment`); Ability (ID: `keyterm:Ability`); Cause of Joy (ID: `keyterm:CauseOfJoy`); To Cause to Happen (ID: `keyterm:Happen`); crer (ID: `keyterm:Believe`); Israel (ID: `person:Israel`); Spirit (ID: `keyterm:Spirit.2`); João (ID: `person:John`); Strong Drink (ID: `realia:StrongDrink`); Wine (ID: `realia:Wine`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Maria (ID: `person:Mary`); Name (ID: `keyterm:Name`); favor (ID: `keyterm:Favor`); palavra (ID: `keyterm:Word`); Davi (ID: `person:David`); Jesus (ID: `person:Jesus.2`); Gabriel (ID: `deity:Gabriel`); Nazaré (ID: `place:Nazareth`); ter casamento contratado (ID: `keyterm:Engaged`); fear (ID: `keyterm:Fear`); reino (ID: `keyterm:Kingdom`); Elisabete (ID: `person:Elizabeth`); para a eternidade (ID: `keyterm:Always`); Galileia (ID: `place:Galilee`); Ability (ID: `keyterm:Ability`); José (ID: `person:Joseph.4`); Holy Spirit (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Maria (ID: `person:Mary`); SENHOR (ID: `deity:Lord`); Elisabete (ID: `person:Elizabeth`); misericórdia (ID: `keyterm:Mercy`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Name (ID: `keyterm:Name`); coração (ID: `keyterm:Heart`); bem, aventurado (ID: `keyterm:Happy`); bless (ID: `keyterm:Bless`); prontidão (ID: `keyterm:Haste`); Abraão (ID: `person:Abraham`); fear (ID: `keyterm:Fear`); para a eternidade (ID: `keyterm:Always`); mente (ID: `keyterm:Mind.2`); Zacarias (ID: `person:Zechariah`); vazio (ID: `keyterm:Empty`); considerar feliz (ID: `keyterm:RegardAsHappy`); salvador (ID: `keyterm:Savior`); crer (ID: `keyterm:Believe`); Judá (ID: `person:Judah.4`); Holy Spirit (ID: `deity:HolySpirit`); Jesus (ID: `person:Jesus.2`); Israel (ID: `person:Israel`); holy (ID: `keyterm:Holy`); Spirit (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); misericórdia (ID: `keyterm:Mercy`); Name (ID: `keyterm:Name`); salvation (ID: `keyterm:Salvation`); holy (ID: `keyterm:Holy`); Zacarias (ID: `person:Zechariah`); bless (ID: `keyterm:Bless`); Holy Spirit (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`); João (ID: `person:John`); Judeia (ID: `place:Judea`); Elisabete (ID: `person:Elizabeth`); libertação (ID: `keyterm:Liberation`); altura (ID: `keyterm:Height`); livrar (ID: `keyterm:Deliver`); coração (ID: `keyterm:Heart`); Circumcision (ID: `keyterm:Circumcision`); forgive (ID: `keyterm:Forgive`); priesthood (ID: `keyterm:Priesthood`); Oath (ID: `keyterm:Oath`); Abraão (ID: `person:Abraham`); fear (ID: `keyterm:Fear`); fazer a paz (ID: `keyterm:Peace`); Davi (ID: `person:David`); be (or show oneself) just (ID: `keyterm:Just`); Covenant (ID: `keyterm:Covenant`); para a eternidade (ID: `keyterm:Always`); compaixão (ID: `keyterm:Affection`); palavra (ID: `keyterm:Word`); A Group of People (ID: `group:GenericGroup`); speak (ID: `keyterm:Speak`); To Sin (ID: `keyterm:Sin`); servir (ID: `keyterm:Serve`); Spirit (ID: `keyterm:Spirit.2`); Tablet (ID: `realia:Tablet`)
...
* **Associated Articles:** César (ID: `145543@BiblicaStudyNotesKeyTerms`); Mundo (ID: `145724@BiblicaStudyNotesKeyTerms`); Pastor (ID: `145787@BiblicaStudyNotes`); José (ID: `145797@BiblicaStudyNotesKeyTerms`); Salvador (ID: `145828@BiblicaStudyNotesKeyTerms`); Belém (ID: `145951@BiblicaStudyNotesKeyTerms`); a.C. (ID: `146003@BiblicaStudyNotesKeyTerms`); Judeu (ID: `146012@BiblicaStudyNotesKeyTerms`); Messias (ID: `146036@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); inscrever (ID: `keyterm:Register`); Maria (ID: `person:Mary`); Glory (ID: `keyterm:Glory`); palavra (ID: `keyterm:Word`); Manger (ID: `realia:Manger`); Belém (ID: `place:Bethlehem`); fear (ID: `keyterm:Fear`); Davi (ID: `person:David`); José (ID: `person:Joseph.4`); Quirino (ID: `person:Quirinius`); Augusto (ID: `person:Augustus`); salvador (ID: `keyterm:Savior`); coração (ID: `keyterm:Heart`); céu (ID: `keyterm:Heaven`); example (ID: `keyterm:Example`); boa notícia (ID: `keyterm:GoodNews`); Judeia (ID: `place:Judea`); ter casamento contratado (ID: `keyterm:Engaged`); fazer a paz (ID: `keyterm:Peace`); Nazaré (ID: `place:Nazareth`); Galileia (ID: `place:Galilee`); Heavenly (ID: `keyterm:Heavenly`); Ability (ID: `keyterm:Ability`); A Group of People (ID: `group:GenericGroup`); Cause of Joy (ID: `keyterm:CauseOfJoy`); To Guard Against (ID: `keyterm:GuardAgainst`); altura (ID: `keyterm:Height`); recenseamento (ID: `keyterm:Census`); Jesus (ID: `person:Jesus.2`); Inn (ID: `realia:Inn`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); lei (ID: `keyterm:Law`); Jerusalém (ID: `place:Jerusalem`); Holy Spirit (ID: `deity:HolySpirit`); Jesus (ID: `person:Jesus.2`); Israel (ID: `person:Israel`); Simeão (ID: `person:Simeon.2`); bless (ID: `keyterm:Bless`); Name (ID: `keyterm:Name`); holy (ID: `keyterm:Holy`); Temple (ID: `realia:Temple`); Ana (ID: `person:Anna`); Fanuel (ID: `person:Phanuel`); coração (ID: `keyterm:Heart`); offering (ID: `keyterm:Offering`); To Cleanse (ID: `keyterm:Cleanse.2`); Circumcision (ID: `keyterm:Circumcision`); rogar (ID: `keyterm:AskFor`); priesthood (ID: `keyterm:Priesthood`); example (ID: `keyterm:Example`); Aser (ID: `group:Asher`); fazer a paz (ID: `keyterm:Peace`); be (or show oneself) just (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); libertação (ID: `keyterm:Liberation`); palavra (ID: `keyterm:Word`); Moisés (ID: `person:Moses`); Gentiles (ID: `group:Gentile`); orar (ID: `keyterm:Pray`); Maria (ID: `person:Mary`); Life (ID: `keyterm:Life`); levantamento (ID: `keyterm:Resurrection`); salvation (ID: `keyterm:Salvation`); jejuar (ID: `keyterm:Fast`); Glory (ID: `keyterm:Glory`); Aser (ID: `person:Asher`); servir (ID: `keyterm:Serve`); Dove (ID: `fauna:Dove`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Nazaré (ID: `place:Nazareth`); favor (ID: `keyterm:Favor`); palavra (ID: `keyterm:Word`); Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); passover (ID: `keyterm:Passover`); lei (ID: `keyterm:Law`); Galileia (ID: `place:Galilee`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); batismo (ID: `keyterm:Baptism`); arrepender, se (ID: `keyterm:Repent`); straightness (ID: `keyterm:Straightness`); Abilene (ID: `place:Abilene`); Filipe (ID: `person:Philip.3`); Lisânias (ID: `person:Lysanias`); Tibério (ID: `person:Tiberius`); Anás (ID: `person:Annas`); Augusto (ID: `person:Augustus`); Herodes Antipas (ID: `person:Herod.2`); Jordan River (ID: `place:Jordan`); João (ID: `person:John`); Traconites (ID: `place:Trachonitis`); Itureia (ID: `place:Ituraea`); forgive (ID: `keyterm:Forgive`); Caifás (ID: `person:Caiaphas`); proclamar (ID: `keyterm:Proclaim`); Judeia (ID: `place:Judea`); Abraão (ID: `person:Abraham`); Pilatos (ID: `person:Pilate`); Isaías (ID: `person:Isaiah`); Zacarias (ID: `person:Zechariah`); Galileia (ID: `place:Galilee`); corpo (ID: `keyterm:Body.3`); salvation (ID: `keyterm:Salvation`); cobrador de impostos (ID: `keyterm:TaxCollector`); To Sin (ID: `keyterm:Sin`); palavra (ID: `keyterm:Word`); Scroll (ID: `realia:Scroll`); Snake (ID: `fauna:Snake`); Tunic (ID: `realia:Tunic.2`); Axe (ID: `realia:Axe`)
...
* **Associated ACAI Concepts:** João (ID: `person:John`); céu (ID: `keyterm:Heaven`); batismo (ID: `keyterm:Baptism`); Holy Spirit (ID: `deity:HolySpirit`); Jesus (ID: `person:Jesus.2`); Herodias (ID: `person:Herodias`); Herodes Antipas (ID: `person:Herod.2`); coração (ID: `keyterm:Heart`); rogar (ID: `keyterm:AskFor`); amado (ID: `keyterm:Beloved`); orar (ID: `keyterm:Pray`); limpar (ID: `keyterm:CleanOut`); Strap (ID: `realia:Strap`); Prison (ID: `realia:Prison`); Threshing Floor (ID: `realia:ThreshingFloor`); Winnowing Fork (ID: `realia:WinnowingFork`); Grain (ID: `flora:Grain`); Dove (ID: `fauna:Dove`); Wheat (ID: `flora:Wheat`); Barn (ID: `realia:Barn`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Selá (ID: `person:Shelah.2`); Janai (ID: `person:Jannai`); Sete (ID: `person:Seth`); Nagai (ID: `person:Naggai`); Eli (ID: `person:Heli`); Boaz (ID: `person:Boaz`); Mená (ID: `person:Menna`); Jorim (ID: `person:Jorim`); Josué (ID: `person:Joshua`); Serugue (ID: `person:Serug`); Melqui (ID: `person:Melchi.2`); Neri (ID: `person:Neri`); Matatias (ID: `person:Mattathias.2`); Salmom (ID: `person:Salmon`); Josech (ID: `person:Josech`); José (ID: `person:Joseph.4`); Joda (ID: `person:Joda`); Joanã (ID: `person:Joanan`); Cainã (ID: `person:Kenan`); Metusalém (ID: `person:Methuselah`); Melqui (ID: `person:Melchi`); Judá (ID: `person:Judah.3`); Levi (ID: `person:Levi`); Sem (ID: `person:Shem`); Eliezer (ID: `person:Eliezer`); José (ID: `person:Joseph.8`); Lameque (ID: `person:Lamech.2`); Maate (ID: `person:Maath`); Natã (ID: `person:Nathan`); Zorobabel (ID: `person:Zerubbabel`); Hezrom (ID: `person:Hezron.2`); Adão (ID: `person:Adam`); Eliaquim (ID: `person:Eliakim.2`); Matate (ID: `person:Matthat`); Jarede (ID: `person:Jared`); Simeão (ID: `person:Simeon.3`); Levi (ID: `person:Levi.2`); Meleá (ID: `person:Melea`); Matatá (ID: `person:Mattatha`); Jonã (ID: `person:Jonam`); Amós (ID: `person:Amos.2`); Matatias (ID: `person:Mattathias`); Reú (ID: `person:Reu`); Maalalel (ID: `person:Mahalalel`); Er (ID: `person:Er`); José (ID: `person:Joseph.7`); Enos (ID: `person:Enosh`); Cosã (ID: `person:Cosam`); Matate (ID: `person:Matthat.2`); Naor (ID: `person:Nahor`); Resa (ID: `person:Rhesa`); Eber (ID: `person:Eber`); Esli (ID: `person:Esli`); Tera (ID: `person:Terah`); Semei (ID: `person:Semein`); Cainã (ID: `person:Cainan`); Pelegue (ID: `person:Peleg`); Adi (ID: `person:Addi`); Sealtiel (ID: `person:Shealtiel`); Elmadã (ID: `person:Elmadam`); Naum (ID: `person:Nahum`); Isaque (ID: `person:Isaac`); Naassom (ID: `person:Nahshon`); SENHOR (ID: `deity:Lord`); Aminadabe (ID: `person:Amminadab`); Abraão (ID: `person:Abraham`); Israel (ID: `person:Israel`); Arfaxade (ID: `person:Arpachshad`); Noé (ID: `person:Noah`); Jessé (ID: `person:Jesse`); Davi (ID: `person:David`); Enoque (ID: `person:Enoch.2`); Ram (ID: `person:Ram`); Perez (ID: `person:Perez`); Obede (ID: `person:Obed`); Judá (ID: `person:Judah.4`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); tentar (ID: `keyterm:PutToTheTest`); To Command (ID: `keyterm:Command`); prostrar, se (ID: `keyterm:BowDown`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); autoridade (ID: `keyterm:Authority.2`); priesthood (ID: `keyterm:Priesthood`); reino (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); guardar cuidadosamente (ID: `keyterm:Protect`); Jerusalém (ID: `place:Jerusalem`); Life (ID: `keyterm:Life`); Holy Spirit (ID: `deity:HolySpirit`); Jordan River (ID: `place:Jordan`); Glory (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); proclamar (ID: `keyterm:Proclaim`); Elias (ID: `person:Elijah`); SENHOR (ID: `deity:Lord`); Holy Spirit (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`); Scroll (ID: `realia:Scroll`); Eliseu (ID: `person:Elisha`); Naamã (ID: `person:Naaman.3`); Syrians (ID: `group:Syria`); Nazaré (ID: `place:Nazareth`); Galileia (ID: `place:Galilee`); Sarepta (ID: `place:Zarephath`); To Cleanse (ID: `keyterm:Cleanse.2`); testemunhar (ID: `keyterm:BearWitness`); escritura (ID: `keyterm:Scripture`); céu (ID: `keyterm:Heaven`); boa notícia (ID: `keyterm:GoodNews`); Isaías (ID: `person:Isaiah`); favor (ID: `keyterm:Favor`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); Sidom (ID: `place:Sidon`); José (ID: `person:Joseph.4`); Cafarnaum (ID: `place:Capernaum`); To Cause to Happen (ID: `keyterm:Happen`); parábola (ID: `keyterm:Parable`); Jesus (ID: `person:Jesus.2`); sabbath (ID: `keyterm:Sabbath`); surely! (ID: `keyterm:Surely`); anointed (ID: `keyterm:Anointed`); Glory (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** To Command (ID: `keyterm:Command`); Demons (ID: `deity:Demons`); Jesus (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); autoridade (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); servir (ID: `keyterm:Serve`); boa notícia (ID: `keyterm:GoodNews`); Judeia (ID: `place:Judea`); Cafarnaum (ID: `place:Capernaum`); rogar (ID: `keyterm:AskFor`); proclamar (ID: `keyterm:Proclaim`); reino (ID: `keyterm:Kingdom`); Nazaré (ID: `place:Nazareth`); Galileia (ID: `place:Galilee`); defilement (ID: `keyterm:Defilement`); sabbath (ID: `keyterm:Sabbath`); holy (ID: `keyterm:Holy`); Pedro (ID: `person:Peter`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Casting Net (ID: `realia:CastingNet`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); To Cleanse (ID: `keyterm:Cleanse.2`); Jesus (ID: `person:Jesus.2`); Fish (ID: `fauna:Fish`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); testemunhar (ID: `keyterm:BearWitness`); offering (ID: `keyterm:Offering`); rogar (ID: `keyterm:AskFor`); Zebedeu (ID: `person:Zebedee`); João (ID: `person:John.2`); fear (ID: `keyterm:Fear`); Genesaré (ID: `place:Gennesaret`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); servir (ID: `keyterm:Serve`); Tiago (ID: `person:James`); palavra (ID: `keyterm:Word`)
...
* **Associated ACAI Concepts:** forgive (ID: `keyterm:Forgive`); SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Bring In (ID: `keyterm:BringIn`); Bed (ID: `realia:Bed`); Pharisees (ID: `group:Pharisee`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Galileia (ID: `place:Galilee`); coração (ID: `keyterm:Heart`); autoridade (ID: `keyterm:Authority.2`); blasfemar (ID: `keyterm:Blaspheme`); Judeia (ID: `place:Judea`); fear (ID: `keyterm:Fear`); Jerusalém (ID: `place:Jerusalem`); crer (ID: `keyterm:Believe`); Tile (ID: `realia:Tile`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** cobrador de impostos (ID: `keyterm:TaxCollector`); jejuar (ID: `keyterm:Fast`); Pharisees (ID: `group:Pharisee`); Mateus (ID: `person:Matthew`); ser discípulo (ID: `keyterm:Disciple`); Skin-Bottle (ID: `realia:Skin-bottle`); Must (ID: `realia:Must`); arrepender, se (ID: `keyterm:Repent`); be (or show oneself) just (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); Name (ID: `keyterm:Name`); orar (ID: `keyterm:Pray`); coletoria (ID: `keyterm:TaxOffice`); Good (ID: `keyterm:Good`); parábola (ID: `keyterm:Parable`); Jesus (ID: `person:Jesus.2`); João (ID: `person:John`); Patch (ID: `realia:Patch`); Clothing (ID: `realia:Clothing`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** sabbath (ID: `keyterm:Sabbath`); Jesus (ID: `person:Jesus.2`); Be Lawful (ID: `keyterm:Lawful`); Pharisees (ID: `group:Pharisee`); Do Good (ID: `keyterm:DoGood`); salvation (ID: `keyterm:Salvation`); Davi (ID: `person:David`); SENHOR (ID: `deity:Lord`); ser discípulo (ID: `keyterm:Disciple`); Life (ID: `keyterm:Life`); servir (ID: `keyterm:Serve`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** bem, aventurado (ID: `keyterm:Happy`); Disaster (ID: `keyterm:Disaster`); ser discípulo (ID: `keyterm:Disciple`); SENHOR (ID: `deity:Lord`); Tiago (ID: `person:James.2`); escolhido (ID: `keyterm:Chosen`); Mateus (ID: `person:Matthew`); Judas (ID: `person:Judas`); Simão (ID: `person:Simon.2`); Bartolomeu (ID: `person:Bartholomew`); Alfeu (ID: `person:Alphaeus`); céu (ID: `keyterm:Heaven`); rogar (ID: `keyterm:AskFor`); João (ID: `person:John.2`); Judeia (ID: `place:Judea`); André (ID: `person:Andrew`); reino (ID: `keyterm:Kingdom`); Judas (ID: `person:Judas.2`); Jerusalém (ID: `place:Jerusalem`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Tomé (ID: `person:Thomas`); orar (ID: `keyterm:Pray`); Sidom (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); Filipe (ID: `person:Philip`); Tiago (ID: `person:James`); Pedro (ID: `person:Peter`); servir (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Judeia (ID: `place:Judea`); Nain (ID: `place:Nain`); autoridade (ID: `keyterm:Authority.2`); To Command (ID: `keyterm:Command`); fear (ID: `keyterm:Fear`); compaixão (ID: `keyterm:Affection`); Ability (ID: `keyterm:Ability`); A Group of People (ID: `group:GenericGroup`); SENHOR (ID: `deity:Lord`); Cafarnaum (ID: `place:Capernaum`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); Jews (ID: `group:Jews`); Israel (ID: `person:Israel`); ser discípulo (ID: `keyterm:Disciple`); Glory (ID: `keyterm:Glory`); love (ID: `keyterm:Love`); palavra (ID: `keyterm:Word`); Bier (ID: `realia:Bier`); Synagogue (ID: `realia:Synagogue`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** João (ID: `person:John`); SENHOR (ID: `deity:Lord`); batista (ID: `keyterm:Baptist`); An Angel (ID: `deity:Angel`); batismo (ID: `keyterm:Baptism`); cobrador de impostos (ID: `keyterm:TaxCollector`); To Cleanse (ID: `keyterm:Cleanse.2`); forgive (ID: `keyterm:Forgive`); bem, aventurado (ID: `keyterm:Happy`); boa notícia (ID: `keyterm:GoodNews`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisees (ID: `group:Pharisee`); reino (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); be (or show oneself) just (ID: `keyterm:Just`); levantamento (ID: `keyterm:Resurrection`); Jesus (ID: `person:Jesus.2`); Obey Righteous Commands (ID: `keyterm:ObeyRighteousCommands`); ser discípulo (ID: `keyterm:Disciple`); glorioso (ID: `keyterm:Glorious`); servir (ID: `keyterm:Serve`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Palace (ID: `realia:Palace`); Reed (ID: `flora:Reed`); Flute (ID: `realia:Flute`)
...
* **Associated ACAI Concepts:** forgive (ID: `keyterm:Forgive`); Simão (ID: `person:Simon.6`); Pharisees (ID: `group:Pharisee`); To Sin (ID: `keyterm:Sin`); House (ID: `realia:House`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); anointed (ID: `keyterm:Anointed`); love (ID: `keyterm:Love`); ter dívida para com alguém (ID: `keyterm:Owe`); rogar (ID: `keyterm:AskFor`); fazer a paz (ID: `keyterm:Peace`); decidir (ID: `keyterm:Decided`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); Jesus (ID: `person:Jesus.2`); Alabaster Jar (ID: `realia:AlabasterJar`); Temple (ID: `realia:Temple`); Denarius (ID: `realia:Denarius`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** parábola (ID: `keyterm:Parable`); SENHOR (ID: `deity:Lord`); coração (ID: `keyterm:Heart`); reino (ID: `keyterm:Kingdom`); crer (ID: `keyterm:Believe`); servir (ID: `keyterm:Serve`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Grain (ID: `flora:Grain`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Barley (ID: `flora:Barley`); Cuza (ID: `person:Chuza`); bom (ID: `keyterm:Honest`); Joana (ID: `person:Joanna`); Daily Life (ID: `keyterm:DailyLife`); Maria Madalena (ID: `person:Marymagdalene`); Suzana (ID: `person:Susanna`); céu (ID: `keyterm:Heaven`); boa notícia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); Demons (ID: `deity:Demons`); tentar (ID: `keyterm:PutToTheTest`); Herodes Antipas (ID: `person:Herod.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`); salvation (ID: `keyterm:Salvation`); ser discípulo (ID: `keyterm:Disciple`); Lampstand (ID: `realia:Lampstand.2`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); fear (ID: `keyterm:Fear`); Gerasa (ID: `place:Gerasa`); SENHOR (ID: `deity:Lord`); Pig (ID: `fauna:Pig`); House (ID: `realia:House`); Jackal (ID: `fauna:Jackal`); Ship (ID: `realia:Ship`); estar endemoninhado (ID: `keyterm:DemonPossessed`); abismo (ID: `keyterm:Abyss`); Legião (ID: `deity:Legion`); A Man (ID: `person:GenericMale`); To Command (ID: `keyterm:Command`); proclamar (ID: `keyterm:Proclaim`); Galileia (ID: `place:Galilee`); Name (ID: `keyterm:Name`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); ser discípulo (ID: `keyterm:Disciple`); Fetter (ID: `realia:Fetter`); Clothing (ID: `realia:Clothing`); Temple (ID: `realia:Temple`); Grave (ID: `realia:Grave`); Chain (ID: `realia:Chain`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); sangue (ID: `keyterm:Blood`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); Pedro (ID: `person:Peter`); House (ID: `realia:House`); Synagogue (ID: `realia:Synagogue`); Jairo (ID: `person:Jairus`); rogar (ID: `keyterm:AskFor`); João (ID: `person:John.2`); fear (ID: `keyterm:Fear`); fazer a paz (ID: `keyterm:Peace`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Daily Life (ID: `keyterm:DailyLife`); Life (ID: `keyterm:Life`); Tiago (ID: `person:James`); Spirit (ID: `keyterm:Spirit.2`); servir (ID: `keyterm:Serve`); Tassel (ID: `realia:Tassel`); Temple (ID: `realia:Temple`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); Herodes Antipas (ID: `person:Herod.2`); SENHOR (ID: `deity:Lord`); João (ID: `person:John`); ser discípulo (ID: `keyterm:Disciple`); servir (ID: `keyterm:Serve`); Fish (ID: `fauna:Fish`); testemunhar (ID: `keyterm:BearWitness`); céu (ID: `keyterm:Heaven`); autoridade (ID: `keyterm:Authority.2`); Betsaida (ID: `place:Bethsaida`); boa notícia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); bless (ID: `keyterm:Bless`); A Group of Disciples (ID: `group:GenericDisciples`); Elias (ID: `person:Elijah`); Demons (ID: `deity:Demons`); Ability (ID: `keyterm:Ability`); levantamento (ID: `keyterm:Resurrection`); Staff (ID: `realia:Staff`); House (ID: `realia:House`); Tunic (ID: `realia:Tunic.2`); Bag (ID: `realia:Bag`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); rejeitar (ID: `keyterm:Reject`); To Command (ID: `keyterm:Command`); verdadeiro (ID: `keyterm:True`); A Group of Disciples (ID: `group:GenericDisciples`); Elias (ID: `person:Elijah`); reino (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); batista (ID: `keyterm:Baptist`); Ability (ID: `keyterm:Ability`); orar (ID: `keyterm:Pray`); Life (ID: `keyterm:Life`); levantamento (ID: `keyterm:Resurrection`); salvation (ID: `keyterm:Salvation`); Jesus (ID: `person:Jesus.2`); holy (ID: `keyterm:Holy`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Glory (ID: `keyterm:Glory`); João (ID: `person:John`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Elias (ID: `person:Elijah`); Jesus (ID: `person:Jesus.2`); orar (ID: `keyterm:Pray`); Moisés (ID: `person:Moses`); Glory (ID: `keyterm:Glory`); To Cause to Happen (ID: `keyterm:Happen`); fear (ID: `keyterm:Fear`); escolhido (ID: `keyterm:Chosen`); Tiago (ID: `person:James`); Jerusalém (ID: `place:Jerusalem`); João (ID: `person:John.2`); Clothing (ID: `realia:Clothing`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); Demons (ID: `deity:Demons`); ser discípulo (ID: `keyterm:Disciple`); coração (ID: `keyterm:Heart`); rogar (ID: `keyterm:AskFor`); fear (ID: `keyterm:Fear`); palavra (ID: `keyterm:Word`); To Command (ID: `keyterm:Command`); SENHOR (ID: `deity:Lord`); João (ID: `person:John.2`); be unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Samaritans (ID: `group:Samaritan`); Religious Official (ID: `person:ReligiousOfficial`); A Man (ID: `person:GenericMale`); Samaria (ID: `place:Samaria`); To Command (ID: `keyterm:Command`); Tiago (ID: `person:James`); An Angel (ID: `deity:Angel`); João (ID: `person:John.2`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Mattock (ID: `realia:Mattock`); Jackal (ID: `fauna:Jackal`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`); reino (ID: `keyterm:Kingdom`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Sidom (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); House (ID: `realia:House`); Corazim (ID: `place:Chorazin`); Disaster (ID: `keyterm:Disaster`); to act wickedly (ID: `keyterm:ActWickedly`); autoridade (ID: `keyterm:Authority.2`); rogar (ID: `keyterm:AskFor`); arrepender, se (ID: `keyterm:Repent`); Betsaida (ID: `place:Bethsaida`); tribunal de justiça (ID: `keyterm:CourtCase`); bem, aventurado (ID: `keyterm:Happy`); Demons (ID: `deity:Demons`); Sodoma (ID: `place:Sodom`); Hell (ID: `place:Hell`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Satanás (ID: `deity:Satan`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Cafarnaum (ID: `place:Capernaum`); Holy Spirit (ID: `deity:HolySpirit`); Jesus (ID: `person:Jesus.2`); juízo (ID: `keyterm:Judgment`); ser discípulo (ID: `keyterm:Disciple`); servir (ID: `keyterm:Serve`); Scorpion (ID: `fauna:Scorpion`); Wolf (ID: `fauna:Wolf`); Snake (ID: `fauna:Snake`); Sheep (ID: `fauna:Lamb`); Sackcloth (ID: `realia:Sackcloth`); Bag (ID: `realia:Bag`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** A Priest (ID: `person:GenericPriest`); A Scribe (ID: `person:Scribe`); Jesus (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Inn (ID: `realia:Inn`); misericórdia (ID: `keyterm:Mercy`); mente (ID: `keyterm:Mind.2`); coração (ID: `keyterm:Heart`); Samaria (ID: `place:Samaria`); Samaritans (ID: `group:Samaritan`); Jericó (ID: `place:Jericho`); be (or show oneself) just (ID: `keyterm:Just`); para a eternidade (ID: `keyterm:Always`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `group:Levi`); compaixão (ID: `keyterm:Affection`); SENHOR (ID: `deity:Lord`); Levi (ID: `person:Levi.3`); lei (ID: `keyterm:Law`); love (ID: `keyterm:Love`); Wine (ID: `realia:Wine`); Denarius (ID: `realia:Denarius`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Marta (ID: `person:Martha`); Maria (ID: `person:Mary.3`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); Good (ID: `keyterm:Good`); To Command (ID: `keyterm:Command`); escolhido (ID: `keyterm:Chosen`); servir (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); SENHOR (ID: `deity:Lord`); A Group of Disciples (ID: `group:GenericDisciples`); Name (ID: `keyterm:Name`); céu (ID: `keyterm:Heaven`); Holy Spirit (ID: `deity:HolySpirit`); reino (ID: `keyterm:Kingdom`); Bring In (ID: `keyterm:BringIn`); forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); holy (ID: `keyterm:Holy`); tentar (ID: `keyterm:PutToTheTest`); ser discípulo (ID: `keyterm:Disciple`); João (ID: `person:John`); Door (ID: `realia:Door`); Snake (ID: `fauna:Snake`); Fish (ID: `fauna:Fish`); Scorpion (ID: `fauna:Scorpion`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); reino (ID: `keyterm:Kingdom`); Satanás (ID: `deity:Satan`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); coração (ID: `keyterm:Heart`); céu (ID: `keyterm:Heaven`); fazer a paz (ID: `keyterm:Peace`); A Group of People (ID: `group:GenericGroup`); persuadir (ID: `keyterm:Persuade`); SENHOR (ID: `deity:Lord`); example (ID: `keyterm:Example`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Jonas (ID: `person:Jonah.2`); Nínive (ID: `group:Nineveh`); Nínive (ID: `place:Nineveh`); bem, aventurado (ID: `keyterm:Happy`); tribunal de justiça (ID: `keyterm:CourtCase`); juízo (ID: `keyterm:Judgment`); corpo (ID: `keyterm:Body.3`); example (ID: `keyterm:Example`); Sheba (ID: `place:Sheba.2`); A Woman (ID: `person:GenericFemale`); Salomão (ID: `person:Solomon`); SENHOR (ID: `deity:Lord`); arrepender, se (ID: `keyterm:Repent`); proclamar (ID: `keyterm:Proclaim`); Rainha de Sabá (ID: `person:QueenOfSheba`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** Pharisees (ID: `group:Pharisee`); Disaster (ID: `keyterm:Disaster`); SENHOR (ID: `deity:Lord`); sangue (ID: `keyterm:Blood`); love (ID: `keyterm:Love`); Zacarias (ID: `person:Zechariah.12`); To Cleanse (ID: `keyterm:Cleanse.2`); rogar (ID: `keyterm:AskFor`); witness (ID: `keyterm:Witness`); Abel (ID: `person:Abel`); Ability (ID: `keyterm:Ability`); limpo (ID: `keyterm:Clean`); A Scribe (ID: `person:Scribe`); Jesus (ID: `person:Jesus.2`); juízo (ID: `keyterm:Judgment`); Mint (ID: `flora:Mint`); Rue (ID: `flora:Rue`); Plate (ID: `realia:Plate.2`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`); Grave (ID: `realia:Grave`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** fear (ID: `keyterm:Fear`); SENHOR (ID: `deity:Lord`); autoridade (ID: `keyterm:Authority.2`); An Angel (ID: `deity:Angel`); Ability (ID: `keyterm:Ability`); Holy Spirit (ID: `deity:HolySpirit`); Sparrow (ID: `fauna:Sparrow`); hipocrisia (ID: `keyterm:Hypocrisy`); blasfemar (ID: `keyterm:Blaspheme`); geena (ID: `keyterm:Gehenna`); forgive (ID: `keyterm:Forgive`); proclamar (ID: `keyterm:Proclaim`); Pharisees (ID: `group:Pharisee`); Hell (ID: `place:Hell`); corpo (ID: `keyterm:Body.3`); Bring In (ID: `keyterm:BringIn`); ser discípulo (ID: `keyterm:Disciple`); Assarion (ID: `realia:Assarion`); Inner Room (ID: `realia:InnerRoom`); Synagogue (ID: `realia:Synagogue`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); reino (ID: `keyterm:Kingdom`); corpo (ID: `keyterm:Body.3`); Barn (ID: `realia:Barn`); coração (ID: `keyterm:Heart`); céu (ID: `keyterm:Heaven`); A Person (ID: `person:GenericPerson`); To Command (ID: `keyterm:Command`); fear (ID: `keyterm:Fear`); de pequena fé (ID: `keyterm:HavingLittleFaith`); Ability (ID: `keyterm:Ability`); parábola (ID: `keyterm:Parable`); Salomão (ID: `person:Solomon`); ser discípulo (ID: `keyterm:Disciple`); Glory (ID: `keyterm:Glory`); Crow (ID: `fauna:Crow`); Oven (ID: `realia:Oven`); Cubit (ID: `realia:Cubit.2`); Bag (ID: `realia:Bag`); Wild Flower (ID: `flora:WildFlower`); Flock (ID: `fauna:Flock`); Storeroom (ID: `realia:Storeroom`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`); Bird (ID: `fauna:Bird`); Wheat (ID: `flora:Wheat`); Grass (ID: `flora:Grass`); Rooster (ID: `fauna:Rooster`); Moth (ID: `fauna:Moth`)
...
* **Associated ACAI Concepts:** bem, aventurado (ID: `keyterm:Happy`); coração (ID: `keyterm:Heart`); céu (ID: `keyterm:Heaven`); verdadeiro (ID: `keyterm:True`); be unfaithful (ID: `keyterm:Unfaithful`); libertar (ID: `keyterm:SetFree`); fazer a paz (ID: `keyterm:Peace`); decidir (ID: `keyterm:Decided`); be (or show oneself) just (ID: `keyterm:Just`); Faithfulness (ID: `keyterm:Faithfulness`); discernir (ID: `keyterm:Interpret`); batismo (ID: `keyterm:Baptism`); parábola (ID: `keyterm:Parable`); Jesus (ID: `person:Jesus.2`); surely! (ID: `keyterm:Surely`); Pedro (ID: `person:Peter`); servir (ID: `keyterm:Serve`); Lepton (ID: `realia:Lepton`); Prison (ID: `realia:Prison`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** arrepender, se (ID: `keyterm:Repent`); Galileans (ID: `group:Galilee`); Galileia (ID: `place:Galilee`); Fig (ID: `flora:Fig`); sangue (ID: `keyterm:Blood`); offering (ID: `keyterm:Offering`); Siloam (ID: `place:Siloam`); parábola (ID: `keyterm:Parable`); Pilatos (ID: `person:Pilate`); Jerusalém (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Watch-Tower (ID: `realia:Watch-tower`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** sabbath (ID: `keyterm:Sabbath`); Jesus (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Religious Official (ID: `person:ReligiousOfficial`); Abraão (ID: `person:Abraham`); Satanás (ID: `deity:Satan`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); glorioso (ID: `keyterm:Glorious`); servir (ID: `keyterm:Serve`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Donkey (ID: `fauna:Donkey`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); SENHOR (ID: `deity:Lord`); Door (ID: `realia:Door`); Abraão (ID: `person:Abraham`); céu (ID: `keyterm:Heaven`); salvation (ID: `keyterm:Salvation`); A Person (ID: `person:GenericPerson`); injustiça (ID: `keyterm:UnjustDeed`); Israel (ID: `person:Israel`); Jerusalém (ID: `place:Jerusalem`); Isaque (ID: `person:Isaac`); Saton (ID: `realia:Saton`); Mustard (ID: `flora:Mustard`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Name (ID: `keyterm:Name`); Pharisees (ID: `group:Pharisee`); Jesus (ID: `person:Jesus.2`); Demons (ID: `deity:Demons`); Herodes Antipas (ID: `person:Herod.2`); SENHOR (ID: `deity:Lord`); bless (ID: `keyterm:Bless`); Rooster (ID: `fauna:Rooster`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Jackal (ID: `fauna:Jackal`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** sabbath (ID: `keyterm:Sabbath`); Pharisees (ID: `group:Pharisee`); levantamento (ID: `keyterm:Resurrection`); parábola (ID: `keyterm:Parable`); Jesus (ID: `person:Jesus.2`); be (or show oneself) just (ID: `keyterm:Just`); Be Lawful (ID: `keyterm:Lawful`); bem, aventurado (ID: `keyterm:Happy`); escolhido (ID: `keyterm:Chosen`); Glory (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); reino (ID: `keyterm:Kingdom`); A Scribe (ID: `person:Scribe`); SENHOR (ID: `deity:Lord`); bem, aventurado (ID: `keyterm:Happy`); discernir (ID: `keyterm:Interpret`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); rogar (ID: `keyterm:AskFor`); fazer a paz (ID: `keyterm:Peace`); Life (ID: `keyterm:Life`); Watch-Tower (ID: `realia:Watch-tower`); Tower (ID: `realia:Tower`); Cross (ID: `realia:Cross`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Cause of Joy (ID: `keyterm:CauseOfJoy`); arrepender, se (ID: `keyterm:Repent`); Drachma (ID: `realia:Drachma`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); céu (ID: `keyterm:Heaven`); Pharisees (ID: `group:Pharisee`); parábola (ID: `keyterm:Parable`); cobrador de impostos (ID: `keyterm:TaxCollector`); SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); be (or show oneself) just (ID: `keyterm:Just`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Cattle (ID: `fauna:Bull`); Daily Life (ID: `keyterm:DailyLife`); empregado (ID: `keyterm:HiredWorker`); céu (ID: `keyterm:Heaven`); Life (ID: `keyterm:Life`); To Sin (ID: `keyterm:Sin`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); compaixão (ID: `keyterm:Affection`); rogar (ID: `keyterm:AskFor`); Commandment (ID: `keyterm:Commandment`); servir como escravo (ID: `keyterm:Serve.2`); Carob (ID: `flora:Carob`); Kid (ID: `fauna:Kid`); Seal (ID: `realia:Seal`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`); Cloak (ID: `realia:Cloak`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** administração (ID: `keyterm:Stewardship`); Faithfulness (ID: `keyterm:Faithfulness`); ter dívida para com alguém (ID: `keyterm:Owe`); injustiça (ID: `keyterm:UnjustDeed`); para a eternidade (ID: `keyterm:Always`); Kor (ID: `realia:Kor.2`); crer (ID: `keyterm:Believe`); autoridade (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); verdadeiro (ID: `keyterm:True`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Temple (ID: `realia:Temple`); Olive Oil (ID: `realia:OliveOil`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); lei (ID: `keyterm:Law`); fornication (ID: `keyterm:Fornication`); coração (ID: `keyterm:Heart`); Abomination (ID: `keyterm:Abomination`); céu (ID: `keyterm:Heaven`); Pharisees (ID: `group:Pharisee`); reino (ID: `keyterm:Kingdom`); be (or show oneself) just (ID: `keyterm:Just`); boa notícia (ID: `keyterm:GoodNews`); servir como escravo (ID: `keyterm:Serve.2`); avarento (ID: `keyterm:LovingWealth`); love (ID: `keyterm:Love`); João (ID: `person:John`)
...
* **Associated ACAI Concepts:** Abraão (ID: `person:Abraham`); Lázaro (ID: `person:Lazarus`); rogar (ID: `keyterm:AskFor`); Moisés (ID: `person:Moses`); World of the Dead (ID: `keyterm:WorldOfTheDead`); testemunhar solenemente (ID: `keyterm:Declare`); Name (ID: `keyterm:Name`); Hell (ID: `place:Hell`); persuadir (ID: `keyterm:Persuade`); arrepender, se (ID: `keyterm:Repent`); An Angel (ID: `deity:Angel`); misericórdia (ID: `keyterm:Mercy`); exortar (ID: `keyterm:Encourage`); Life (ID: `keyterm:Life`); Dog (ID: `fauna:Dog`); Temple (ID: `realia:Temple`); Linen (ID: `realia:Linen`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** To Cleanse (ID: `keyterm:Cleanse.2`); Jesus (ID: `person:Jesus.2`); Samaria (ID: `place:Samaria`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); misericórdia (ID: `keyterm:Mercy`); Jerusalém (ID: `place:Jerusalem`); Samaritans (ID: `group:Samaritan`); Galileia (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** Ló (ID: `person:Lot`); reino (ID: `keyterm:Kingdom`); Noé (ID: `person:Noah`); céu (ID: `keyterm:Heaven`); SENHOR (ID: `deity:Lord`); Pharisees (ID: `group:Pharisee`); corpo (ID: `keyterm:Body.3`); observação (ID: `keyterm:Observation`); Make Alive (ID: `keyterm:Alive`); rejeitar (ID: `keyterm:Reject`); ser discípulo (ID: `keyterm:Disciple`); Sodoma (ID: `place:Sodom`); Life (ID: `keyterm:Life`); House (ID: `realia:House`); Vulture (ID: `fauna:Vulture`); Bed (ID: `realia:Bed`); Boat (ID: `realia:Boat`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); fazer justiça (ID: `keyterm:GrantJustice`); cobrador de impostos (ID: `keyterm:TaxCollector`); orar (ID: `keyterm:Pray`); Pharisees (ID: `group:Pharisee`); fear (ID: `keyterm:Fear`); reino (ID: `keyterm:Kingdom`); be (or show oneself) just (ID: `keyterm:Just`); parábola (ID: `keyterm:Parable`); Jesus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); jejuar (ID: `keyterm:Fast`); coração (ID: `keyterm:Heart`); céu (ID: `keyterm:Heaven`); forgive (ID: `keyterm:Forgive`); To Command (ID: `keyterm:Command`); persuadir (ID: `keyterm:Persuade`); escolhido (ID: `keyterm:Chosen`); injustiça (ID: `keyterm:UnjustDeed`); crer (ID: `keyterm:Believe`); Week (ID: `keyterm:Week`); surely! (ID: `keyterm:Surely`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`); Jesus (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); para a eternidade (ID: `keyterm:Always`); Life (ID: `keyterm:Life`); céu (ID: `keyterm:Heaven`); Commandment (ID: `keyterm:Commandment`); salvation (ID: `keyterm:Salvation`); Ability (ID: `keyterm:Ability`); surely! (ID: `keyterm:Surely`); fornication (ID: `keyterm:Fornication`); Rich Young Ruler (ID: `person:RichYoungRuler`); Pedro (ID: `person:Peter`); Needle (ID: `realia:Needle`); House (ID: `realia:House`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Davi (ID: `person:David`); misericórdia (ID: `keyterm:Mercy`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); Jericó (ID: `place:Jericho`); To Command (ID: `keyterm:Command`); SENHOR (ID: `deity:Lord`); Nazaré (ID: `place:Nazareth`); Jerusalém (ID: `place:Jerusalem`); Gentiles (ID: `group:Gentile`); Glory (ID: `keyterm:Glory`); palavra (ID: `keyterm:Word`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Zaqueu (ID: `person:Zacchaeus`); salvation (ID: `keyterm:Salvation`); Abraão (ID: `person:Abraham`); Name (ID: `keyterm:Name`); Jericó (ID: `place:Jericho`); Sycomore Fig (ID: `flora:SycomoreFig`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Mina (ID: `realia:Mina`); reino (ID: `keyterm:Kingdom`); autoridade (ID: `keyterm:Authority.2`); Good (ID: `keyterm:Good`); fear (ID: `keyterm:Fear`); parábola (ID: `keyterm:Parable`); decidir (ID: `keyterm:Decided`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); Jerusalém (ID: `place:Jerusalem`); Band of Cloth (ID: `realia:BandOfCloth`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Donkey (ID: `fauna:Donkey`); fazer a paz (ID: `keyterm:Peace`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Jerusalém (ID: `place:Jerusalem`); Clothing (ID: `realia:Clothing`); Olive Tree (ID: `flora:OliveTree`); Betfagé (ID: `place:Bethphage`); Betânia (ID: `place:Bethany`); Monte das Oliveiras (ID: `place:OlivesMount`); altura (ID: `keyterm:Height`); céu (ID: `keyterm:Heaven`); rogar (ID: `keyterm:AskFor`); To Command (ID: `keyterm:Command`); bless (ID: `keyterm:Bless`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisees (ID: `group:Pharisee`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); A Group of People (ID: `group:GenericGroup`); orar (ID: `keyterm:Pray`); Glory (ID: `keyterm:Glory`); Siege-Works (ID: `realia:Siege-works`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); autoridade (ID: `keyterm:Authority.2`); céu (ID: `keyterm:Heaven`); vazio (ID: `keyterm:Empty`); Ability (ID: `keyterm:Ability`); parábola (ID: `keyterm:Parable`); João (ID: `person:John`); Temple (ID: `realia:Temple`); coração (ID: `keyterm:Heart`); rogar (ID: `keyterm:AskFor`); rejeitar (ID: `keyterm:Reject`); boa notícia (ID: `keyterm:GoodNews`); fear (ID: `keyterm:Fear`); persuadir (ID: `keyterm:Persuade`); amado (ID: `keyterm:Beloved`); batismo (ID: `keyterm:Baptism`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); Cornerstone (ID: `realia:Cornerstone`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); levantamento (ID: `keyterm:Resurrection`); Tibério (ID: `person:Tiberius`); Davi (ID: `person:David`); Ability (ID: `keyterm:Ability`); para a eternidade (ID: `keyterm:Always`); Moisés (ID: `person:Moses`); Jesus (ID: `person:Jesus.2`); hipocrisia (ID: `keyterm:Hypocrisy`); autoridade (ID: `keyterm:Authority.2`); Isaque (ID: `person:Isaac`); A Priest (ID: `person:GenericPriest`); Abraão (ID: `person:Abraham`); be (or show oneself) just (ID: `keyterm:Just`); Be Lawful (ID: `keyterm:Lawful`); Religious Officials (ID: `group:ReligiousOfficials`); The Way (ID: `keyterm:TheWay`); Truth (ID: `keyterm:Truth`); Sadducees (ID: `group:Sadducee`); Life (ID: `keyterm:Life`); imposto (ID: `keyterm:TributeTax`); Israel (ID: `person:Israel`); palavra (ID: `keyterm:Word`); Brier (ID: `flora:Brier`); Image (ID: `realia:Image`); Denarius (ID: `realia:Denarius`); Boxthorn (ID: `flora:Boxthorn`); Footstool (ID: `realia:Footstool`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); juízo (ID: `keyterm:Judgment`); verdadeiro (ID: `keyterm:True`); Daily Life (ID: `keyterm:DailyLife`); amizade (ID: `keyterm:Friendship`); orar (ID: `keyterm:Pray`); ser discípulo (ID: `keyterm:Disciple`); Lepton (ID: `realia:Lepton`); House (ID: `realia:House`); Cloak (ID: `realia:Cloak`); Synagogue (ID: `realia:Synagogue`); Treasury (ID: `realia:Treasury`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); Name (ID: `keyterm:Name`); Jerusalém (ID: `place:Jerusalem`); coração (ID: `keyterm:Heart`); example (ID: `keyterm:Example`); reino (ID: `keyterm:Kingdom`); Ability (ID: `keyterm:Ability`); testemunhar (ID: `keyterm:BearWitness`); rogar (ID: `keyterm:AskFor`); (coisas) da vida diária (ID: `keyterm:OfThisLife`); Judeia (ID: `place:Judea`); fear (ID: `keyterm:Fear`); Disaster (ID: `keyterm:Disaster`); libertação (ID: `keyterm:Liberation`); fazer justiça (ID: `keyterm:GrantJustice`); coisa terrível (ID: `keyterm:DreadfulEventOrSight`); SENHOR (ID: `deity:Lord`); Gentiles (ID: `group:Gentile`); parábola (ID: `keyterm:Parable`); surely! (ID: `keyterm:Surely`); Glory (ID: `keyterm:Glory`); Prison (ID: `realia:Prison`); Fig (ID: `flora:Fig`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`); Net (ID: `realia:Net`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); Judas (ID: `person:Judas.2`); passover (ID: `keyterm:Passover`); Monte das Oliveiras (ID: `place:OlivesMount`); Satanás (ID: `deity:Satan`); fear (ID: `keyterm:Fear`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** passover (ID: `keyterm:Passover`); reino (ID: `keyterm:Kingdom`); SENHOR (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); servir (ID: `keyterm:Serve`); House (ID: `realia:House`); offering (ID: `keyterm:Offering`); autoridade (ID: `keyterm:Authority.2`); João (ID: `person:John.2`); decidir (ID: `keyterm:Decided`); Disaster (ID: `keyterm:Disaster`); Covenant (ID: `keyterm:Covenant`); Gentiles (ID: `group:Gentile`); corpo (ID: `keyterm:Body.3`); sangue (ID: `keyterm:Blood`); To Cause to Happen (ID: `keyterm:Happen`); Israel (ID: `person:Israel`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); Clay Jar (ID: `realia:ClayJar`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Jesus (ID: `person:Jesus.2`); Judas (ID: `person:Judas.2`); Temple (ID: `realia:Temple`); Rooster (ID: `fauna:Rooster`); Peter's Second Accuser (ID: `person:SecondAccuserOfPeter`); Truth (ID: `keyterm:Truth`); autoridade (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); Galileans (ID: `group:Galilee`); A Servant (ID: `person:GenericServant`); Galileia (ID: `place:Galilee`); House (ID: `realia:House`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Pilatos (ID: `person:Pilate`); Priests (ID: `group:GenericPriests`); rogar (ID: `keyterm:AskFor`); Religious Officials (ID: `group:ReligiousOfficials`); Galileia (ID: `place:Galilee`); Elders (ID: `group:GenericElders`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); testemunhar (ID: `keyterm:BearWitness`); autoridade (ID: `keyterm:Authority.2`); blasfemar (ID: `keyterm:Blaspheme`); Judeia (ID: `place:Judea`); Galileans (ID: `group:Galilee`); Jerusalém (ID: `place:Jerusalem`); Tibério (ID: `person:Tiberius`); Herodes Antipas (ID: `person:Herod.2`); SENHOR (ID: `deity:Lord`); imposto (ID: `keyterm:TributeTax`); crer (ID: `keyterm:Believe`); speak (ID: `keyterm:Speak`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Pilatos (ID: `person:Pilate`); Herodes Antipas (ID: `person:Herod.2`); Jesus (ID: `person:Jesus.2`); Barrabás (ID: `person:Barabbas`); Cross (ID: `realia:Cross`); Prison (ID: `realia:Prison`); decidir (ID: `keyterm:Decided`); example (ID: `keyterm:Example`); distinguir (ID: `keyterm:Discern`); hope (ID: `keyterm:Hope`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Jews (ID: `group:Jews`); Cross (ID: `realia:Cross`); Criminal on the Cross (ID: `person:Dysmas`); Cirene (ID: `place:Cyrene`); Simão (ID: `person:Simon.5`); blasfemar (ID: `keyterm:Blaspheme`); forgive (ID: `keyterm:Forgive`); To Command (ID: `keyterm:Command`); bem, aventurado (ID: `keyterm:Happy`); fear (ID: `keyterm:Fear`); Jerusalém (ID: `place:Jerusalem`); escolhido (ID: `keyterm:Chosen`); paraíso (ID: `keyterm:Paradise`); juízo (ID: `keyterm:Judgment`); surely! (ID: `keyterm:Surely`); Golgotha (ID: `place:Golgotha`); Sour Wine (ID: `realia:SourWine`); Clothing (ID: `realia:Clothing`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); be (or show oneself) just (ID: `keyterm:Just`); Galileia (ID: `place:Galilee`); corpo (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`); sabbath (ID: `keyterm:Sabbath`); Grave (ID: `realia:Grave`); José (ID: `person:Joseph.6`); Arimateia (ID: `place:Arimathea`); Spirit (ID: `keyterm:Spirit.2`); reino (ID: `keyterm:Kingdom`); Commandment (ID: `keyterm:Commandment`); Pilatos (ID: `person:Pilate`); Name (ID: `keyterm:Name`); Good (ID: `keyterm:Good`); Jews (ID: `group:Jews`); Glory (ID: `keyterm:Glory`); Aloes (ID: `realia:Aloes`); Temple (ID: `realia:Temple`); Linen (ID: `realia:Linen`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Curtain (ID: `realia:Curtain`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); palavra (ID: `keyterm:Word`); Joana (ID: `person:Joanna`); Week (ID: `keyterm:Week`); levantamento (ID: `keyterm:Resurrection`); corpo (ID: `keyterm:Body.3`); não crer (ID: `keyterm:Disbelieve`); Tiago (ID: `person:James.3`); Galileia (ID: `place:Galilee`); Maria Madalena (ID: `person:Marymagdalene`); Pedro (ID: `person:Peter`); Maria (ID: `person:Mary`); Life (ID: `keyterm:Life`); Linen (ID: `realia:Linen`); Aloes (ID: `realia:Aloes`); Cross (ID: `realia:Cross`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Jerusalém (ID: `place:Jerusalem`); coração (ID: `keyterm:Heart`); escritura (ID: `keyterm:Scripture`); Name (ID: `keyterm:Name`); Grave (ID: `realia:Grave`); Emaús (ID: `place:Emmaus`); Cleopas (ID: `person:Cleopas`); hope (ID: `keyterm:Hope`); bless (ID: `keyterm:Bless`); An Angel (ID: `deity:Angel`); libertação (ID: `keyterm:Liberation`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); levantamento (ID: `keyterm:Resurrection`); crer (ID: `keyterm:Believe`); juízo (ID: `keyterm:Judgment`); Israel (ID: `person:Israel`); Pedro (ID: `person:Peter`); Glory (ID: `keyterm:Glory`); Stade (ID: `realia:Stade`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** bless (ID: `keyterm:Bless`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Spirit (ID: `keyterm:Spirit.2`); escritura (ID: `keyterm:Scripture`); Betânia (ID: `place:Bethany`); prostrar, se (ID: `keyterm:BowDown`); To Cause to Happen (ID: `keyterm:Happen`); coração (ID: `keyterm:Heart`); céu (ID: `keyterm:Heaven`); forgive (ID: `keyterm:Forgive`); arrepender, se (ID: `keyterm:Repent`); proclamar (ID: `keyterm:Proclaim`); witness (ID: `keyterm:Witness`); não crer (ID: `keyterm:Disbelieve`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); promessa (ID: `keyterm:Promise`); Moisés (ID: `person:Moses`); corpo (ID: `keyterm:Body.3`); lei (ID: `keyterm:Law`); altura (ID: `keyterm:Height`); Jesus (ID: `person:Jesus.2`); To Sin (ID: `keyterm:Sin`); Temple (ID: `realia:Temple`); Fish (ID: `fauna:Fish`)
