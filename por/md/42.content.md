...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Zacarias (ID: `person:Zechariah`); Elisabete (ID: `person:Elizabeth`); An Angel (ID: `deity:Angel`); Temple (ID: `realia:Temple`); priesthood (ID: `keyterm:Priesthood`); Name (ID: `keyterm:Name`); orar (ID: `keyterm:Pray`); fear (ID: `keyterm:Fear`); Holy Spirit (ID: `deity:HolySpirit`); be (or show oneself) just (ID: `keyterm:Just`); decreto justo (ID: `keyterm:Regulations`); be blameless (ID: `keyterm:Blameless`); Gabriel (ID: `deity:Gabriel`); Herodes (ID: `person:Herod`); Abias (ID: `person:Abijah.6`); Ability (ID: `keyterm:Ability`); boa notícia (ID: `keyterm:GoodNews`); Elias (ID: `person:Elijah`); Arão (ID: `person:Aaron`); coração (ID: `keyterm:Heart`); Commandment (ID: `keyterm:Commandment`); Cause of Joy (ID: `keyterm:CauseOfJoy`); João (ID: `person:John`); To Cause to Happen (ID: `keyterm:Happen`); Judeia (ID: `place:Judea`); crer (ID: `keyterm:Believe`); Israel (ID: `person:Israel`); Spirit (ID: `keyterm:Spirit.2`); Strong Drink (ID: `realia:StrongDrink`); House (ID: `realia:House`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Maria (ID: `person:Mary`); Name (ID: `keyterm:Name`); palavra (ID: `keyterm:Word`); favor (ID: `keyterm:Favor`); Davi (ID: `person:David`); Jesus (ID: `person:Jesus.2`); Gabriel (ID: `deity:Gabriel`); Nazaré (ID: `place:Nazareth`); Ability (ID: `keyterm:Ability`); ter casamento contratado (ID: `keyterm:Engaged`); Galileia (ID: `place:Galilee`); para a eternidade (ID: `keyterm:Always`); reino (ID: `keyterm:Kingdom`); holy (ID: `keyterm:Holy`); Elisabete (ID: `person:Elizabeth`); José (ID: `person:Joseph.4`); fear (ID: `keyterm:Fear`); Holy Spirit (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Maria (ID: `person:Mary`); SENHOR (ID: `deity:Lord`); Elisabete (ID: `person:Elizabeth`); misericórdia (ID: `keyterm:Mercy`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Name (ID: `keyterm:Name`); mente (ID: `keyterm:Mind.2`); prontidão (ID: `keyterm:Haste`); Jesus (ID: `person:Jesus.2`); Zacarias (ID: `person:Zechariah`); coração (ID: `keyterm:Heart`); Judá (ID: `person:Judah.4`); bem, aventurado (ID: `keyterm:Happy`); vazio (ID: `keyterm:Empty`); para a eternidade (ID: `keyterm:Always`); holy (ID: `keyterm:Holy`); bless (ID: `keyterm:Bless`); salvador (ID: `keyterm:Savior`); Abraão (ID: `person:Abraham`); fear (ID: `keyterm:Fear`); crer (ID: `keyterm:Believe`); Holy Spirit (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`); Spirit (ID: `keyterm:Spirit.2`); considerar feliz (ID: `keyterm:RegardAsHappy`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Name (ID: `keyterm:Name`); holy (ID: `keyterm:Holy`); misericórdia (ID: `keyterm:Mercy`); salvation (ID: `keyterm:Salvation`); Zacarias (ID: `person:Zechariah`); bless (ID: `keyterm:Bless`); João (ID: `person:John`); Holy Spirit (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`); Elisabete (ID: `person:Elizabeth`); livrar (ID: `keyterm:Deliver`); Judeia (ID: `place:Judea`); libertação (ID: `keyterm:Liberation`); altura (ID: `keyterm:Height`); speak (ID: `keyterm:Speak`); coração (ID: `keyterm:Heart`); para a eternidade (ID: `keyterm:Always`); To Sin (ID: `keyterm:Sin`); palavra (ID: `keyterm:Word`); priesthood (ID: `keyterm:Priesthood`); Davi (ID: `person:David`); compaixão (ID: `keyterm:Affection`); Abraão (ID: `person:Abraham`); Oath (ID: `keyterm:Oath`); fear (ID: `keyterm:Fear`); Circumcision (ID: `keyterm:Circumcision`); A Group of People (ID: `group:GenericGroup`); servir (ID: `keyterm:Serve`); forgive (ID: `keyterm:Forgive`); fazer a paz (ID: `keyterm:Peace`); Spirit (ID: `keyterm:Spirit.2`); Covenant (ID: `keyterm:Covenant`); be (or show oneself) just (ID: `keyterm:Just`); Tablet (ID: `realia:Tablet`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Glory (ID: `keyterm:Glory`); palavra (ID: `keyterm:Word`); Maria (ID: `person:Mary`); inscrever (ID: `keyterm:Register`); Manger (ID: `realia:Manger`); Belém (ID: `place:Bethlehem`); José (ID: `person:Joseph.4`); Davi (ID: `person:David`); fear (ID: `keyterm:Fear`); Augusto (ID: `person:Augustus`); salvador (ID: `keyterm:Savior`); Quirino (ID: `person:Quirinius`); Ability (ID: `keyterm:Ability`); boa notícia (ID: `keyterm:GoodNews`); ter casamento contratado (ID: `keyterm:Engaged`); Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Galileia (ID: `place:Galilee`); example (ID: `keyterm:Example`); Heavenly (ID: `keyterm:Heavenly`); Judeia (ID: `place:Judea`); céu (ID: `keyterm:Heaven`); A Group of People (ID: `group:GenericGroup`); Nazaré (ID: `place:Nazareth`); recenseamento (ID: `keyterm:Census`); fazer a paz (ID: `keyterm:Peace`); To Guard Against (ID: `keyterm:GuardAgainst`); altura (ID: `keyterm:Height`); Inn (ID: `realia:Inn`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); lei (ID: `keyterm:Law`); Jerusalém (ID: `place:Jerusalem`); Jesus (ID: `person:Jesus.2`); Holy Spirit (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`); Simeão (ID: `person:Simeon.2`); bless (ID: `keyterm:Bless`); Name (ID: `keyterm:Name`); holy (ID: `keyterm:Holy`); Temple (ID: `realia:Temple`); Ana (ID: `person:Anna`); Fanuel (ID: `person:Phanuel`); Glory (ID: `keyterm:Glory`); Life (ID: `keyterm:Life`); coração (ID: `keyterm:Heart`); Aser (ID: `person:Asher`); offering (ID: `keyterm:Offering`); example (ID: `keyterm:Example`); An Angel (ID: `deity:Angel`); palavra (ID: `keyterm:Word`); jejuar (ID: `keyterm:Fast`); Maria (ID: `person:Mary`); priesthood (ID: `keyterm:Priesthood`); orar (ID: `keyterm:Pray`); To Cleanse (ID: `keyterm:Cleanse.2`); libertação (ID: `keyterm:Liberation`); Circumcision (ID: `keyterm:Circumcision`); levantamento (ID: `keyterm:Resurrection`); rogar (ID: `keyterm:AskFor`); servir (ID: `keyterm:Serve`); Aser (ID: `group:Asher`); Moisés (ID: `person:Moses`); fazer a paz (ID: `keyterm:Peace`); salvation (ID: `keyterm:Salvation`); Gentiles (ID: `group:Gentile`); be (or show oneself) just (ID: `keyterm:Just`); Rooster (ID: `fauna:Rooster`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); Nazaré (ID: `place:Nazareth`); favor (ID: `keyterm:Favor`); palavra (ID: `keyterm:Word`); Jesus (ID: `person:Jesus.2`); lei (ID: `keyterm:Law`); coração (ID: `keyterm:Heart`); passover (ID: `keyterm:Passover`); Galileia (ID: `place:Galilee`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); batismo (ID: `keyterm:Baptism`); arrepender, se (ID: `keyterm:Repent`); straightness (ID: `keyterm:Straightness`); Augusto (ID: `person:Augustus`); Abilene (ID: `place:Abilene`); João (ID: `person:John`); Herodes Antipas (ID: `person:Herod.2`); Tibério (ID: `person:Tiberius`); Traconites (ID: `place:Trachonitis`); Lisânias (ID: `person:Lysanias`); Anás (ID: `person:Annas`); Filipe (ID: `person:Philip.3`); Itureia (ID: `place:Ituraea`); Jordan River (ID: `place:Jordan`); Caifás (ID: `person:Caiaphas`); corpo (ID: `keyterm:Body.3`); proclamar (ID: `keyterm:Proclaim`); Zacarias (ID: `person:Zechariah`); cobrador de impostos (ID: `keyterm:TaxCollector`); Galileia (ID: `place:Galilee`); Pilatos (ID: `person:Pilate`); To Sin (ID: `keyterm:Sin`); palavra (ID: `keyterm:Word`); Abraão (ID: `person:Abraham`); Judeia (ID: `place:Judea`); Isaías (ID: `person:Isaiah`); forgive (ID: `keyterm:Forgive`); salvation (ID: `keyterm:Salvation`); Tunic (ID: `realia:Tunic.2`); Axe (ID: `realia:Axe`); Snake (ID: `fauna:Snake`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** João (ID: `person:John`); Jesus (ID: `person:Jesus.2`); céu (ID: `keyterm:Heaven`); batismo (ID: `keyterm:Baptism`); Holy Spirit (ID: `deity:HolySpirit`); Herodias (ID: `person:Herodias`); Herodes Antipas (ID: `person:Herod.2`); limpar (ID: `keyterm:CleanOut`); coração (ID: `keyterm:Heart`); amado (ID: `keyterm:Beloved`); orar (ID: `keyterm:Pray`); rogar (ID: `keyterm:AskFor`); Strap (ID: `realia:Strap`); Winnowing Fork (ID: `realia:WinnowingFork`); Wheat (ID: `flora:Wheat`); Barn (ID: `realia:Barn`); Grain (ID: `flora:Grain`); Dove (ID: `fauna:Dove`); Prison (ID: `realia:Prison`); Sandal (ID: `realia:Sandal`); Threshing Floor (ID: `realia:ThreshingFloor`)
...
* **Associated ACAI Concepts:** Selá (ID: `person:Shelah.2`); Matatias (ID: `person:Mattathias.2`); Levi (ID: `person:Levi.2`); Enos (ID: `person:Enosh`); Melqui (ID: `person:Melchi`); Amós (ID: `person:Amos.2`); Serugue (ID: `person:Serug`); Janai (ID: `person:Jannai`); Reú (ID: `person:Reu`); José (ID: `person:Joseph.4`); Sem (ID: `person:Shem`); Eber (ID: `person:Eber`); Maalalel (ID: `person:Mahalalel`); Resa (ID: `person:Rhesa`); Cosã (ID: `person:Cosam`); Joanã (ID: `person:Joanan`); Melqui (ID: `person:Melchi.2`); Er (ID: `person:Er`); Lameque (ID: `person:Lamech.2`); Matate (ID: `person:Matthat.2`); Esli (ID: `person:Esli`); Joda (ID: `person:Joda`); Pelegue (ID: `person:Peleg`); Cainã (ID: `person:Cainan`); Elmadã (ID: `person:Elmadam`); Zorobabel (ID: `person:Zerubbabel`); Mená (ID: `person:Menna`); Eliezer (ID: `person:Eliezer`); Natã (ID: `person:Nathan`); Josech (ID: `person:Josech`); Sete (ID: `person:Seth`); Hezrom (ID: `person:Hezron.2`); Metusalém (ID: `person:Methuselah`); José (ID: `person:Joseph.8`); Jorim (ID: `person:Jorim`); Sealtiel (ID: `person:Shealtiel`); Simeão (ID: `person:Simeon.3`); Adão (ID: `person:Adam`); Eli (ID: `person:Heli`); Tera (ID: `person:Terah`); Maate (ID: `person:Maath`); Semei (ID: `person:Semein`); Naor (ID: `person:Nahor`); Salmom (ID: `person:Salmon`); Judá (ID: `person:Judah.3`); Levi (ID: `person:Levi`); Matatias (ID: `person:Mattathias`); Josué (ID: `person:Joshua`); Cainã (ID: `person:Kenan`); Meleá (ID: `person:Melea`); Neri (ID: `person:Neri`); Adi (ID: `person:Addi`); Eliaquim (ID: `person:Eliakim.2`); Boaz (ID: `person:Boaz`); José (ID: `person:Joseph.7`); Nagai (ID: `person:Naggai`); Matatá (ID: `person:Mattatha`); Jonã (ID: `person:Jonam`); Naum (ID: `person:Nahum`); Jarede (ID: `person:Jared`); Matate (ID: `person:Matthat`); Arfaxade (ID: `person:Arpachshad`); Abraão (ID: `person:Abraham`); Enoque (ID: `person:Enoch.2`); Israel (ID: `person:Israel`); Isaque (ID: `person:Isaac`); Judá (ID: `person:Judah.4`); Jessé (ID: `person:Jesse`); Aminadabe (ID: `person:Amminadab`); Obede (ID: `person:Obed`); SENHOR (ID: `deity:Lord`); Noé (ID: `person:Noah`); Jesus (ID: `person:Jesus.2`); Perez (ID: `person:Perez`); Davi (ID: `person:David`); Ram (ID: `person:Ram`); Naassom (ID: `person:Nahshon`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); tentar (ID: `keyterm:PutToTheTest`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); prostrar, se (ID: `keyterm:BowDown`); To Command (ID: `keyterm:Command`); Glory (ID: `keyterm:Glory`); Jerusalém (ID: `place:Jerusalem`); guardar cuidadosamente (ID: `keyterm:Protect`); Life (ID: `keyterm:Life`); reino (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); autoridade (ID: `keyterm:Authority.2`); priesthood (ID: `keyterm:Priesthood`); servir (ID: `keyterm:Serve`); Holy Spirit (ID: `deity:HolySpirit`); Jordan River (ID: `place:Jordan`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); proclamar (ID: `keyterm:Proclaim`); Elias (ID: `person:Elijah`); SENHOR (ID: `deity:Lord`); Holy Spirit (ID: `deity:HolySpirit`); Israel (ID: `person:Israel`); Scroll (ID: `realia:Scroll`); Syrians (ID: `group:Syria`); Eliseu (ID: `person:Elisha`); Galileia (ID: `place:Galilee`); Naamã (ID: `person:Naaman.3`); Sarepta (ID: `place:Zarephath`); Nazaré (ID: `place:Nazareth`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); boa notícia (ID: `keyterm:GoodNews`); surely! (ID: `keyterm:Surely`); Jesus (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`); sabbath (ID: `keyterm:Sabbath`); anointed (ID: `keyterm:Anointed`); Sidom (ID: `place:Sidon`); José (ID: `person:Joseph.4`); parábola (ID: `keyterm:Parable`); To Cause to Happen (ID: `keyterm:Happen`); céu (ID: `keyterm:Heaven`); favor (ID: `keyterm:Favor`); Isaías (ID: `person:Isaiah`); To Cleanse (ID: `keyterm:Cleanse.2`); escritura (ID: `keyterm:Scripture`); servir (ID: `keyterm:Serve`); Cafarnaum (ID: `place:Capernaum`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** To Command (ID: `keyterm:Command`); Jesus (ID: `person:Jesus.2`); Demons (ID: `deity:Demons`); Synagogue (ID: `realia:Synagogue`); Ability (ID: `keyterm:Ability`); autoridade (ID: `keyterm:Authority.2`); SENHOR (ID: `deity:Lord`); servir (ID: `keyterm:Serve`); boa notícia (ID: `keyterm:GoodNews`); Judeia (ID: `place:Judea`); Cafarnaum (ID: `place:Capernaum`); proclamar (ID: `keyterm:Proclaim`); sabbath (ID: `keyterm:Sabbath`); Galileia (ID: `place:Galilee`); reino (ID: `keyterm:Kingdom`); holy (ID: `keyterm:Holy`); Pedro (ID: `person:Peter`); Nazaré (ID: `place:Nazareth`); rogar (ID: `keyterm:AskFor`); defilement (ID: `keyterm:Defilement`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Casting Net (ID: `realia:CastingNet`); Jesus (ID: `person:Jesus.2`); To Cleanse (ID: `keyterm:Cleanse.2`); Fish (ID: `fauna:Fish`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Zebedeu (ID: `person:Zebedee`); offering (ID: `keyterm:Offering`); palavra (ID: `keyterm:Word`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); fear (ID: `keyterm:Fear`); servir (ID: `keyterm:Serve`); rogar (ID: `keyterm:AskFor`); Moisés (ID: `person:Moses`); Tiago (ID: `person:James`); João (ID: `person:John.2`); Genesaré (ID: `place:Gennesaret`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); SENHOR (ID: `deity:Lord`); forgive (ID: `keyterm:Forgive`); Bring In (ID: `keyterm:BringIn`); Bed (ID: `realia:Bed`); Ability (ID: `keyterm:Ability`); Glory (ID: `keyterm:Glory`); Jesus (ID: `person:Jesus.2`); Pharisees (ID: `group:Pharisee`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Galileia (ID: `place:Galilee`); Jerusalém (ID: `place:Jerusalem`); coração (ID: `keyterm:Heart`); autoridade (ID: `keyterm:Authority.2`); Judeia (ID: `place:Judea`); fear (ID: `keyterm:Fear`); blasfemar (ID: `keyterm:Blaspheme`); crer (ID: `keyterm:Believe`); Tile (ID: `realia:Tile`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** cobrador de impostos (ID: `keyterm:TaxCollector`); jejuar (ID: `keyterm:Fast`); ser discípulo (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); Mateus (ID: `person:Matthew`); Skin-Bottle (ID: `realia:Skin-bottle`); Must (ID: `realia:Must`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); arrepender, se (ID: `keyterm:Repent`); João (ID: `person:John`); orar (ID: `keyterm:Pray`); parábola (ID: `keyterm:Parable`); Good (ID: `keyterm:Good`); coletoria (ID: `keyterm:TaxOffice`); Religious Officials (ID: `group:ReligiousOfficials`); be (or show oneself) just (ID: `keyterm:Just`); Patch (ID: `realia:Patch`); Clothing (ID: `realia:Clothing`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** sabbath (ID: `keyterm:Sabbath`); Jesus (ID: `person:Jesus.2`); Be Lawful (ID: `keyterm:Lawful`); Pharisees (ID: `group:Pharisee`); ser discípulo (ID: `keyterm:Disciple`); salvation (ID: `keyterm:Salvation`); Life (ID: `keyterm:Life`); SENHOR (ID: `deity:Lord`); Do Good (ID: `keyterm:DoGood`); servir (ID: `keyterm:Serve`); Davi (ID: `person:David`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Synagogue (ID: `realia:Synagogue`); Grain (ID: `flora:Grain`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** bem, aventurado (ID: `keyterm:Happy`); ser discípulo (ID: `keyterm:Disciple`); Disaster (ID: `keyterm:Disaster`); SENHOR (ID: `deity:Lord`); Tiago (ID: `person:James.2`); escolhido (ID: `keyterm:Chosen`); Simão (ID: `person:Simon.2`); Judas (ID: `person:Judas`); Mateus (ID: `person:Matthew`); Jerusalém (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Bartolomeu (ID: `person:Bartholomew`); Tiro (ID: `place:Tyre`); Alfeu (ID: `person:Alphaeus`); reino (ID: `keyterm:Kingdom`); Name (ID: `keyterm:Name`); Sidom (ID: `place:Sidon`); Judas (ID: `person:Judas.2`); Pedro (ID: `person:Peter`); orar (ID: `keyterm:Pray`); Filipe (ID: `person:Philip`); Judeia (ID: `place:Judea`); céu (ID: `keyterm:Heaven`); Tomé (ID: `person:Thomas`); André (ID: `person:Andrew`); rogar (ID: `keyterm:AskFor`); servir (ID: `keyterm:Serve`); Tiago (ID: `person:James`); João (ID: `person:John.2`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); favor (ID: `keyterm:Favor`); Do Good (ID: `keyterm:DoGood`); SENHOR (ID: `deity:Lord`); Good (ID: `keyterm:Good`); Foundation (ID: `realia:Foundation`); House (ID: `realia:House`); Beam (ID: `realia:Beam`); Compassionate (ID: `keyterm:Compassionate`); condenar (ID: `keyterm:Condemn`); coração (ID: `keyterm:Heart`); decidir (ID: `keyterm:Decided`); bless (ID: `keyterm:Bless`); orar (ID: `keyterm:Pray`); parábola (ID: `keyterm:Parable`); forgive (ID: `keyterm:Forgive`); ser discípulo (ID: `keyterm:Disciple`); hope (ID: `keyterm:Hope`); Storeroom (ID: `realia:Storeroom`); Cloak (ID: `realia:Cloak`); Thistle (ID: `flora:Thistle`); Boxthorn (ID: `flora:Boxthorn`); Tunic (ID: `realia:Tunic.2`); Vine (ID: `flora:Vine`); Acacia (ID: `flora:Acacia`); Brier (ID: `flora:Brier`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); Temple (ID: `realia:Temple`); House (ID: `realia:House`); Nain (ID: `place:Nain`); Judeia (ID: `place:Judea`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); love (ID: `keyterm:Love`); palavra (ID: `keyterm:Word`); autoridade (ID: `keyterm:Authority.2`); SENHOR (ID: `deity:Lord`); compaixão (ID: `keyterm:Affection`); To Command (ID: `keyterm:Command`); fear (ID: `keyterm:Fear`); crer (ID: `keyterm:Believe`); A Group of People (ID: `group:GenericGroup`); Jews (ID: `group:Jews`); ser discípulo (ID: `keyterm:Disciple`); Israel (ID: `person:Israel`); Cafarnaum (ID: `place:Capernaum`); salvation (ID: `keyterm:Salvation`); Housetop (ID: `realia:Housetop`); Synagogue (ID: `realia:Synagogue`); Bier (ID: `realia:Bier`)
...
* **Associated ACAI Concepts:** João (ID: `person:John`); SENHOR (ID: `deity:Lord`); batista (ID: `keyterm:Baptist`); cobrador de impostos (ID: `keyterm:TaxCollector`); An Angel (ID: `deity:Angel`); batismo (ID: `keyterm:Baptism`); boa notícia (ID: `keyterm:GoodNews`); Obey Righteous Commands (ID: `keyterm:ObeyRighteousCommands`); Jesus (ID: `person:Jesus.2`); bem, aventurado (ID: `keyterm:Happy`); reino (ID: `keyterm:Kingdom`); glorioso (ID: `keyterm:Glorious`); To Cleanse (ID: `keyterm:Cleanse.2`); levantamento (ID: `keyterm:Resurrection`); servir (ID: `keyterm:Serve`); forgive (ID: `keyterm:Forgive`); ser discípulo (ID: `keyterm:Disciple`); Demons (ID: `deity:Demons`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisees (ID: `group:Pharisee`); be (or show oneself) just (ID: `keyterm:Just`); Palace (ID: `realia:Palace`); Clothing (ID: `realia:Clothing`); Reed (ID: `flora:Reed`); Flute (ID: `realia:Flute`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** forgive (ID: `keyterm:Forgive`); Simão (ID: `person:Simon.6`); To Sin (ID: `keyterm:Sin`); Pharisees (ID: `group:Pharisee`); Myrrh (ID: `flora:Myrrh`); House (ID: `realia:House`); Myrrh (ID: `realia:Myrrh`); love (ID: `keyterm:Love`); anointed (ID: `keyterm:Anointed`); ter dívida para com alguém (ID: `keyterm:Owe`); Jesus (ID: `person:Jesus.2`); decidir (ID: `keyterm:Decided`); crer (ID: `keyterm:Believe`); rogar (ID: `keyterm:AskFor`); fazer a paz (ID: `keyterm:Peace`); salvation (ID: `keyterm:Salvation`); Alabaster Jar (ID: `realia:AlabasterJar`); Temple (ID: `realia:Temple`); Denarius (ID: `realia:Denarius`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** parábola (ID: `keyterm:Parable`); SENHOR (ID: `deity:Lord`); coração (ID: `keyterm:Heart`); reino (ID: `keyterm:Kingdom`); crer (ID: `keyterm:Believe`); servir (ID: `keyterm:Serve`); Thistle (ID: `flora:Thistle`); Boxthorn (ID: `flora:Boxthorn`); Grain (ID: `flora:Grain`); Acacia (ID: `flora:Acacia`); Brier (ID: `flora:Brier`); Barley (ID: `flora:Barley`); bom (ID: `keyterm:Honest`); Suzana (ID: `person:Susanna`); Maria Madalena (ID: `person:Marymagdalene`); Daily Life (ID: `keyterm:DailyLife`); Cuza (ID: `person:Chuza`); Joana (ID: `person:Joanna`); boa notícia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); Cause of Joy (ID: `keyterm:CauseOfJoy`); tentar (ID: `keyterm:PutToTheTest`); céu (ID: `keyterm:Heaven`); Herodes Antipas (ID: `person:Herod.2`); ser discípulo (ID: `keyterm:Disciple`); Demons (ID: `deity:Demons`); salvation (ID: `keyterm:Salvation`); Lampstand (ID: `realia:Lampstand.2`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); Jesus (ID: `person:Jesus.2`); fear (ID: `keyterm:Fear`); rogar (ID: `keyterm:AskFor`); Gerasa (ID: `place:Gerasa`); SENHOR (ID: `deity:Lord`); Ship (ID: `realia:Ship`); House (ID: `realia:House`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); estar endemoninhado (ID: `keyterm:DemonPossessed`); Legião (ID: `deity:Legion`); abismo (ID: `keyterm:Abyss`); proclamar (ID: `keyterm:Proclaim`); Galileia (ID: `place:Galilee`); Name (ID: `keyterm:Name`); A Man (ID: `person:GenericMale`); To Command (ID: `keyterm:Command`); crer (ID: `keyterm:Believe`); ser discípulo (ID: `keyterm:Disciple`); salvation (ID: `keyterm:Salvation`); Fetter (ID: `realia:Fetter`); Temple (ID: `realia:Temple`); Clothing (ID: `realia:Clothing`); Chain (ID: `realia:Chain`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); sangue (ID: `keyterm:Blood`); Pedro (ID: `person:Peter`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); Synagogue (ID: `realia:Synagogue`); House (ID: `realia:House`); Jairo (ID: `person:Jairus`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); Name (ID: `keyterm:Name`); Daily Life (ID: `keyterm:DailyLife`); fear (ID: `keyterm:Fear`); servir (ID: `keyterm:Serve`); rogar (ID: `keyterm:AskFor`); Tiago (ID: `person:James`); fazer a paz (ID: `keyterm:Peace`); Spirit (ID: `keyterm:Spirit.2`); João (ID: `person:John.2`); Temple (ID: `realia:Temple`); Tassel (ID: `realia:Tassel`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); SENHOR (ID: `deity:Lord`); João (ID: `person:John`); Herodes Antipas (ID: `person:Herod.2`); servir (ID: `keyterm:Serve`); ser discípulo (ID: `keyterm:Disciple`); Fish (ID: `fauna:Fish`); Ability (ID: `keyterm:Ability`); boa notícia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); Elias (ID: `person:Elijah`); Betsaida (ID: `place:Bethsaida`); bless (ID: `keyterm:Bless`); autoridade (ID: `keyterm:Authority.2`); céu (ID: `keyterm:Heaven`); levantamento (ID: `keyterm:Resurrection`); Demons (ID: `deity:Demons`); A Group of Disciples (ID: `group:GenericDisciples`); testemunhar (ID: `keyterm:BearWitness`); Bag (ID: `realia:Bag`); Tunic (ID: `realia:Tunic.2`); House (ID: `realia:House`); Staff (ID: `realia:Staff`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); rejeitar (ID: `keyterm:Reject`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Elias (ID: `person:Elijah`); Jesus (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); reino (ID: `keyterm:Kingdom`); holy (ID: `keyterm:Holy`); An Angel (ID: `deity:Angel`); Pedro (ID: `person:Peter`); verdadeiro (ID: `keyterm:True`); João (ID: `person:John`); orar (ID: `keyterm:Pray`); To Command (ID: `keyterm:Command`); levantamento (ID: `keyterm:Resurrection`); batista (ID: `keyterm:Baptist`); ser discípulo (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); salvation (ID: `keyterm:Salvation`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Glory (ID: `keyterm:Glory`); Elias (ID: `person:Elijah`); Moisés (ID: `person:Moses`); Jesus (ID: `person:Jesus.2`); orar (ID: `keyterm:Pray`); Jerusalém (ID: `place:Jerusalem`); To Cause to Happen (ID: `keyterm:Happen`); fear (ID: `keyterm:Fear`); João (ID: `person:John.2`); escolhido (ID: `keyterm:Chosen`); Tiago (ID: `person:James`); Clothing (ID: `realia:Clothing`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Name (ID: `keyterm:Name`); Demons (ID: `deity:Demons`); be unfaithful (ID: `keyterm:Unfaithful`); To Command (ID: `keyterm:Command`); palavra (ID: `keyterm:Word`); fear (ID: `keyterm:Fear`); João (ID: `person:John.2`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); coração (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); reino (ID: `keyterm:Kingdom`); céu (ID: `keyterm:Heaven`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Samaritans (ID: `group:Samaritan`); Religious Official (ID: `person:ReligiousOfficial`); ser discípulo (ID: `keyterm:Disciple`); To Command (ID: `keyterm:Command`); An Angel (ID: `deity:Angel`); A Man (ID: `person:GenericMale`); João (ID: `person:John.2`); Samaria (ID: `place:Samaria`); Tiago (ID: `person:James`); House (ID: `realia:House`); Mattock (ID: `realia:Mattock`); Jackal (ID: `fauna:Jackal`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); céu (ID: `keyterm:Heaven`); fazer a paz (ID: `keyterm:Peace`); Ability (ID: `keyterm:Ability`); Tiro (ID: `place:Tyre`); reino (ID: `keyterm:Kingdom`); Name (ID: `keyterm:Name`); Sidom (ID: `place:Sidon`); House (ID: `realia:House`); Corazim (ID: `place:Chorazin`); Disaster (ID: `keyterm:Disaster`); Jesus (ID: `person:Jesus.2`); Hell (ID: `place:Hell`); bem, aventurado (ID: `keyterm:Happy`); Betsaida (ID: `place:Bethsaida`); Cause of Joy (ID: `keyterm:CauseOfJoy`); to act wickedly (ID: `keyterm:ActWickedly`); arrepender, se (ID: `keyterm:Repent`); juízo (ID: `keyterm:Judgment`); autoridade (ID: `keyterm:Authority.2`); Satanás (ID: `deity:Satan`); rogar (ID: `keyterm:AskFor`); servir (ID: `keyterm:Serve`); Holy Spirit (ID: `deity:HolySpirit`); tribunal de justiça (ID: `keyterm:CourtCase`); ser discípulo (ID: `keyterm:Disciple`); Sodoma (ID: `place:Sodom`); Demons (ID: `deity:Demons`); Cafarnaum (ID: `place:Capernaum`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Scorpion (ID: `fauna:Scorpion`); Bag (ID: `realia:Bag`); Sheep (ID: `fauna:Lamb`); Sackcloth (ID: `realia:Sackcloth`); Wolf (ID: `fauna:Wolf`); Snake (ID: `fauna:Snake`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); A Priest (ID: `person:GenericPriest`); A Scribe (ID: `person:Scribe`); Life (ID: `keyterm:Life`); Inn (ID: `realia:Inn`); mente (ID: `keyterm:Mind.2`); misericórdia (ID: `keyterm:Mercy`); Jerusalém (ID: `place:Jerusalem`); love (ID: `keyterm:Love`); coração (ID: `keyterm:Heart`); Jericó (ID: `place:Jericho`); Samaritans (ID: `group:Samaritan`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); compaixão (ID: `keyterm:Affection`); lei (ID: `keyterm:Law`); Samaria (ID: `place:Samaria`); Levi (ID: `person:Levi.3`); be (or show oneself) just (ID: `keyterm:Just`); Levi (ID: `group:Levi`); Denarius (ID: `realia:Denarius`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`)
...
* **Associated Articles:** Maria, Marta e Lázaro (ID: `145592@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Marta (ID: `person:Martha`); Maria (ID: `person:Mary.3`); Jesus (ID: `person:Jesus.2`); To Command (ID: `keyterm:Command`); Name (ID: `keyterm:Name`); Good (ID: `keyterm:Good`); servir (ID: `keyterm:Serve`); escolhido (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); SENHOR (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`); ser discípulo (ID: `keyterm:Disciple`); céu (ID: `keyterm:Heaven`); holy (ID: `keyterm:Holy`); To Sin (ID: `keyterm:Sin`); Name (ID: `keyterm:Name`); Bring In (ID: `keyterm:BringIn`); A Group of Disciples (ID: `group:GenericDisciples`); tentar (ID: `keyterm:PutToTheTest`); João (ID: `person:John`); forgive (ID: `keyterm:Forgive`); Holy Spirit (ID: `deity:HolySpirit`); Fish (ID: `fauna:Fish`); Snake (ID: `fauna:Snake`); Door (ID: `realia:Door`); Scorpion (ID: `fauna:Scorpion`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); reino (ID: `keyterm:Kingdom`); Satanás (ID: `deity:Satan`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); fazer a paz (ID: `keyterm:Peace`); céu (ID: `keyterm:Heaven`); example (ID: `keyterm:Example`); A Group of People (ID: `group:GenericGroup`); SENHOR (ID: `deity:Lord`); coração (ID: `keyterm:Heart`); persuadir (ID: `keyterm:Persuade`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Jonas (ID: `person:Jonah.2`); Nínive (ID: `group:Nineveh`); tribunal de justiça (ID: `keyterm:CourtCase`); corpo (ID: `keyterm:Body.3`); example (ID: `keyterm:Example`); juízo (ID: `keyterm:Judgment`); Nínive (ID: `place:Nineveh`); bem, aventurado (ID: `keyterm:Happy`); proclamar (ID: `keyterm:Proclaim`); arrepender, se (ID: `keyterm:Repent`); Rainha de Sabá (ID: `person:QueenOfSheba`); Sheba (ID: `place:Sheba.2`); Salomão (ID: `person:Solomon`); SENHOR (ID: `deity:Lord`); A Woman (ID: `person:GenericFemale`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** Pharisees (ID: `group:Pharisee`); Disaster (ID: `keyterm:Disaster`); sangue (ID: `keyterm:Blood`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); Zacarias (ID: `person:Zechariah.12`); Ability (ID: `keyterm:Ability`); Abel (ID: `person:Abel`); Jesus (ID: `person:Jesus.2`); juízo (ID: `keyterm:Judgment`); To Cleanse (ID: `keyterm:Cleanse.2`); limpo (ID: `keyterm:Clean`); rogar (ID: `keyterm:AskFor`); witness (ID: `keyterm:Witness`); A Scribe (ID: `person:Scribe`); Plate (ID: `realia:Plate.2`); Rue (ID: `flora:Rue`); Mint (ID: `flora:Mint`); Synagogue (ID: `realia:Synagogue`); Grass (ID: `flora:Grass`); House (ID: `realia:House`); Grave (ID: `realia:Grave`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Ability (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); autoridade (ID: `keyterm:Authority.2`); Holy Spirit (ID: `deity:HolySpirit`); Sparrow (ID: `fauna:Sparrow`); blasfemar (ID: `keyterm:Blaspheme`); geena (ID: `keyterm:Gehenna`); hipocrisia (ID: `keyterm:Hypocrisy`); corpo (ID: `keyterm:Body.3`); proclamar (ID: `keyterm:Proclaim`); Hell (ID: `place:Hell`); Bring In (ID: `keyterm:BringIn`); forgive (ID: `keyterm:Forgive`); ser discípulo (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); Inner Room (ID: `realia:InnerRoom`); Assarion (ID: `realia:Assarion`); Housetop (ID: `realia:Housetop`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); corpo (ID: `keyterm:Body.3`); reino (ID: `keyterm:Kingdom`); Barn (ID: `realia:Barn`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Salomão (ID: `person:Solomon`); coração (ID: `keyterm:Heart`); parábola (ID: `keyterm:Parable`); céu (ID: `keyterm:Heaven`); To Command (ID: `keyterm:Command`); fear (ID: `keyterm:Fear`); ser discípulo (ID: `keyterm:Disciple`); de pequena fé (ID: `keyterm:HavingLittleFaith`); A Person (ID: `person:GenericPerson`); Bag (ID: `realia:Bag`); Oven (ID: `realia:Oven`); Storeroom (ID: `realia:Storeroom`); Flock (ID: `fauna:Flock`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Crow (ID: `fauna:Crow`); Wheat (ID: `flora:Wheat`); Rooster (ID: `fauna:Rooster`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`); Bird (ID: `fauna:Bird`); Moth (ID: `fauna:Moth`)
...
* **Associated ACAI Concepts:** bem, aventurado (ID: `keyterm:Happy`); surely! (ID: `keyterm:Surely`); Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); decidir (ID: `keyterm:Decided`); libertar (ID: `keyterm:SetFree`); Pedro (ID: `person:Peter`); verdadeiro (ID: `keyterm:True`); parábola (ID: `keyterm:Parable`); Faithfulness (ID: `keyterm:Faithfulness`); be unfaithful (ID: `keyterm:Unfaithful`); céu (ID: `keyterm:Heaven`); batismo (ID: `keyterm:Baptism`); servir (ID: `keyterm:Serve`); discernir (ID: `keyterm:Interpret`); fazer a paz (ID: `keyterm:Peace`); be (or show oneself) just (ID: `keyterm:Just`); Lepton (ID: `realia:Lepton`); House (ID: `realia:House`); Prison (ID: `realia:Prison`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** arrepender, se (ID: `keyterm:Repent`); Galileans (ID: `group:Galilee`); Galileia (ID: `place:Galilee`); Fig (ID: `flora:Fig`); Jerusalém (ID: `place:Jerusalem`); sangue (ID: `keyterm:Blood`); offering (ID: `keyterm:Offering`); Siloam (ID: `place:Siloam`); parábola (ID: `keyterm:Parable`); Pilatos (ID: `person:Pilate`); Tower (ID: `realia:Tower`); Vine (ID: `flora:Vine`); Watch-Tower (ID: `realia:Watch-tower`)
...
* **Associated ACAI Concepts:** sabbath (ID: `keyterm:Sabbath`); Jesus (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Religious Official (ID: `person:ReligiousOfficial`); Glory (ID: `keyterm:Glory`); Satanás (ID: `deity:Satan`); servir (ID: `keyterm:Serve`); SENHOR (ID: `deity:Lord`); glorioso (ID: `keyterm:Glorious`); Abraão (ID: `person:Abraham`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Donkey (ID: `fauna:Donkey`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); SENHOR (ID: `deity:Lord`); Door (ID: `realia:Door`); Jerusalém (ID: `place:Jerusalem`); injustiça (ID: `keyterm:UnjustDeed`); céu (ID: `keyterm:Heaven`); salvation (ID: `keyterm:Salvation`); Israel (ID: `person:Israel`); A Person (ID: `person:GenericPerson`); Isaque (ID: `person:Isaac`); Abraão (ID: `person:Abraham`); Saton (ID: `realia:Saton`); Grain (ID: `flora:Grain`); Mustard (ID: `flora:Mustard`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); Name (ID: `keyterm:Name`); bless (ID: `keyterm:Bless`); Demons (ID: `deity:Demons`); Herodes Antipas (ID: `person:Herod.2`); Jesus (ID: `person:Jesus.2`); Pharisees (ID: `group:Pharisee`); SENHOR (ID: `deity:Lord`); Rooster (ID: `fauna:Rooster`); House (ID: `realia:House`); Jackal (ID: `fauna:Jackal`); Bird (ID: `fauna:Bird`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** sabbath (ID: `keyterm:Sabbath`); Pharisees (ID: `group:Pharisee`); Glory (ID: `keyterm:Glory`); bem, aventurado (ID: `keyterm:Happy`); Jesus (ID: `person:Jesus.2`); levantamento (ID: `keyterm:Resurrection`); Be Lawful (ID: `keyterm:Lawful`); servir (ID: `keyterm:Serve`); be (or show oneself) just (ID: `keyterm:Just`); escolhido (ID: `keyterm:Chosen`); parábola (ID: `keyterm:Parable`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); reino (ID: `keyterm:Kingdom`); A Scribe (ID: `person:Scribe`); SENHOR (ID: `deity:Lord`); bem, aventurado (ID: `keyterm:Happy`); discernir (ID: `keyterm:Interpret`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); fazer a paz (ID: `keyterm:Peace`); Life (ID: `keyterm:Life`); rogar (ID: `keyterm:AskFor`); Tower (ID: `realia:Tower`); Watch-Tower (ID: `realia:Watch-tower`); Cross (ID: `realia:Cross`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Cause of Joy (ID: `keyterm:CauseOfJoy`); arrepender, se (ID: `keyterm:Repent`); Drachma (ID: `realia:Drachma`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); céu (ID: `keyterm:Heaven`); An Angel (ID: `deity:Angel`); Pharisees (ID: `group:Pharisee`); cobrador de impostos (ID: `keyterm:TaxCollector`); SENHOR (ID: `deity:Lord`); be (or show oneself) just (ID: `keyterm:Just`); parábola (ID: `keyterm:Parable`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Cattle (ID: `fauna:Bull`); Daily Life (ID: `keyterm:DailyLife`); empregado (ID: `keyterm:HiredWorker`); Life (ID: `keyterm:Life`); To Sin (ID: `keyterm:Sin`); céu (ID: `keyterm:Heaven`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); compaixão (ID: `keyterm:Affection`); Commandment (ID: `keyterm:Commandment`); servir como escravo (ID: `keyterm:Serve.2`); rogar (ID: `keyterm:AskFor`); Kid (ID: `fauna:Kid`); Carob (ID: `flora:Carob`); Cloak (ID: `realia:Cloak`); Goat (ID: `fauna:Goat`); Seal (ID: `realia:Seal`); House (ID: `realia:House`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Faithfulness (ID: `keyterm:Faithfulness`); administração (ID: `keyterm:Stewardship`); ter dívida para com alguém (ID: `keyterm:Owe`); injustiça (ID: `keyterm:UnjustDeed`); para a eternidade (ID: `keyterm:Always`); Kor (ID: `realia:Kor.2`); ser discípulo (ID: `keyterm:Disciple`); Ability (ID: `keyterm:Ability`); crer (ID: `keyterm:Believe`); autoridade (ID: `keyterm:Authority.2`); verdadeiro (ID: `keyterm:True`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Olive Oil (ID: `realia:OliveOil`); Tent (ID: `realia:Tent`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); lei (ID: `keyterm:Law`); fornication (ID: `keyterm:Fornication`); reino (ID: `keyterm:Kingdom`); boa notícia (ID: `keyterm:GoodNews`); céu (ID: `keyterm:Heaven`); be (or show oneself) just (ID: `keyterm:Just`); love (ID: `keyterm:Love`); avarento (ID: `keyterm:LovingWealth`); Pharisees (ID: `group:Pharisee`); João (ID: `person:John`); coração (ID: `keyterm:Heart`); servir como escravo (ID: `keyterm:Serve.2`); Abomination (ID: `keyterm:Abomination`)
...
* **Associated ACAI Concepts:** Abraão (ID: `person:Abraham`); Lázaro (ID: `person:Lazarus`); Moisés (ID: `person:Moses`); rogar (ID: `keyterm:AskFor`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Name (ID: `keyterm:Name`); An Angel (ID: `deity:Angel`); arrepender, se (ID: `keyterm:Repent`); exortar (ID: `keyterm:Encourage`); Life (ID: `keyterm:Life`); persuadir (ID: `keyterm:Persuade`); testemunhar solenemente (ID: `keyterm:Declare`); Hell (ID: `place:Hell`); misericórdia (ID: `keyterm:Mercy`); Dog (ID: `fauna:Dog`); Purple Cloth (ID: `realia:PurpleCloth`); Linen (ID: `realia:Linen`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); To Sin (ID: `keyterm:Sin`); arrepender, se (ID: `keyterm:Repent`); crer (ID: `keyterm:Believe`); forgive (ID: `keyterm:Forgive`); dever (ID: `keyterm:Ought`); fazer tropeçar (ID: `keyterm:CauseToStumble`); escândalo (ID: `keyterm:StumblingBlock`); favor (ID: `keyterm:Favor`); To Command (ID: `keyterm:Command`); servir (ID: `keyterm:Serve`); ser discípulo (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Disaster (ID: `keyterm:Disaster`); Mulberry (ID: `flora:Mulberry`); Sheep (ID: `fauna:Lamb`); Hand-Mill (ID: `realia:Hand-mill`); Flock (ID: `fauna:Flock`); Grain (ID: `flora:Grain`); Goat (ID: `fauna:Goat`); Mustard (ID: `flora:Mustard`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); To Cleanse (ID: `keyterm:Cleanse.2`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Samaria (ID: `place:Samaria`); Jerusalém (ID: `place:Jerusalem`); salvation (ID: `keyterm:Salvation`); crer (ID: `keyterm:Believe`); Samaritans (ID: `group:Samaritan`); misericórdia (ID: `keyterm:Mercy`); Galileia (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** Ló (ID: `person:Lot`); reino (ID: `keyterm:Kingdom`); céu (ID: `keyterm:Heaven`); SENHOR (ID: `deity:Lord`); Noé (ID: `person:Noah`); ser discípulo (ID: `keyterm:Disciple`); rejeitar (ID: `keyterm:Reject`); Sodoma (ID: `place:Sodom`); corpo (ID: `keyterm:Body.3`); observação (ID: `keyterm:Observation`); Life (ID: `keyterm:Life`); Pharisees (ID: `group:Pharisee`); Make Alive (ID: `keyterm:Alive`); House (ID: `realia:House`); Boat (ID: `realia:Boat`); Vulture (ID: `fauna:Vulture`); Housetop (ID: `realia:Housetop`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); fazer justiça (ID: `keyterm:GrantJustice`); cobrador de impostos (ID: `keyterm:TaxCollector`); orar (ID: `keyterm:Pray`); Pharisees (ID: `group:Pharisee`); Jesus (ID: `person:Jesus.2`); reino (ID: `keyterm:Kingdom`); parábola (ID: `keyterm:Parable`); fear (ID: `keyterm:Fear`); be (or show oneself) just (ID: `keyterm:Just`); Temple (ID: `realia:Temple`); jejuar (ID: `keyterm:Fast`); surely! (ID: `keyterm:Surely`); coração (ID: `keyterm:Heart`); persuadir (ID: `keyterm:Persuade`); escolhido (ID: `keyterm:Chosen`); injustiça (ID: `keyterm:UnjustDeed`); céu (ID: `keyterm:Heaven`); To Command (ID: `keyterm:Command`); crer (ID: `keyterm:Believe`); forgive (ID: `keyterm:Forgive`); ser discípulo (ID: `keyterm:Disciple`); Week (ID: `keyterm:Week`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`); Jesus (ID: `person:Jesus.2`); Good (ID: `keyterm:Good`); Life (ID: `keyterm:Life`); para a eternidade (ID: `keyterm:Always`); Ability (ID: `keyterm:Ability`); céu (ID: `keyterm:Heaven`); surely! (ID: `keyterm:Surely`); Pedro (ID: `person:Peter`); Rich Young Ruler (ID: `person:RichYoungRuler`); fornication (ID: `keyterm:Fornication`); Commandment (ID: `keyterm:Commandment`); salvation (ID: `keyterm:Salvation`); Needle (ID: `realia:Needle`); House (ID: `realia:House`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Davi (ID: `person:David`); misericórdia (ID: `keyterm:Mercy`); Glory (ID: `keyterm:Glory`); Jerusalém (ID: `place:Jerusalem`); To Command (ID: `keyterm:Command`); palavra (ID: `keyterm:Word`); crer (ID: `keyterm:Believe`); Gentiles (ID: `group:Gentile`); Nazaré (ID: `place:Nazareth`); SENHOR (ID: `deity:Lord`); Jericó (ID: `place:Jericho`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Zaqueu (ID: `person:Zacchaeus`); salvation (ID: `keyterm:Salvation`); Name (ID: `keyterm:Name`); Jericó (ID: `place:Jericho`); Abraão (ID: `person:Abraham`); Sycomore Fig (ID: `flora:SycomoreFig`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Mina (ID: `realia:Mina`); reino (ID: `keyterm:Kingdom`); decidir (ID: `keyterm:Decided`); Ability (ID: `keyterm:Ability`); Jerusalém (ID: `place:Jerusalem`); Faithfulness (ID: `keyterm:Faithfulness`); Good (ID: `keyterm:Good`); fear (ID: `keyterm:Fear`); autoridade (ID: `keyterm:Authority.2`); SENHOR (ID: `deity:Lord`); parábola (ID: `keyterm:Parable`); Band of Cloth (ID: `realia:BandOfCloth`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Donkey (ID: `fauna:Donkey`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); fazer a paz (ID: `keyterm:Peace`); Temple (ID: `realia:Temple`); Jerusalém (ID: `place:Jerusalem`); Clothing (ID: `realia:Clothing`); Olive Tree (ID: `flora:OliveTree`); Betfagé (ID: `place:Bethphage`); Betânia (ID: `place:Bethany`); Monte das Oliveiras (ID: `place:OlivesMount`); altura (ID: `keyterm:Height`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Name (ID: `keyterm:Name`); bless (ID: `keyterm:Bless`); orar (ID: `keyterm:Pray`); céu (ID: `keyterm:Heaven`); To Command (ID: `keyterm:Command`); A Group of People (ID: `group:GenericGroup`); rogar (ID: `keyterm:AskFor`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisees (ID: `group:Pharisee`); Siege-Works (ID: `realia:Siege-works`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Ability (ID: `keyterm:Ability`); vazio (ID: `keyterm:Empty`); autoridade (ID: `keyterm:Authority.2`); João (ID: `person:John`); parábola (ID: `keyterm:Parable`); céu (ID: `keyterm:Heaven`); Temple (ID: `realia:Temple`); boa notícia (ID: `keyterm:GoodNews`); Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); persuadir (ID: `keyterm:Persuade`); rejeitar (ID: `keyterm:Reject`); amado (ID: `keyterm:Beloved`); fear (ID: `keyterm:Fear`); crer (ID: `keyterm:Believe`); batismo (ID: `keyterm:Baptism`); rogar (ID: `keyterm:AskFor`); Cornerstone (ID: `realia:Cornerstone`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); levantamento (ID: `keyterm:Resurrection`); Tibério (ID: `person:Tiberius`); Ability (ID: `keyterm:Ability`); Davi (ID: `person:David`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); Moisés (ID: `person:Moses`); Truth (ID: `keyterm:Truth`); Life (ID: `keyterm:Life`); Be Lawful (ID: `keyterm:Lawful`); A Priest (ID: `person:GenericPriest`); palavra (ID: `keyterm:Word`); The Way (ID: `keyterm:TheWay`); autoridade (ID: `keyterm:Authority.2`); Sadducees (ID: `group:Sadducee`); Abraão (ID: `person:Abraham`); Israel (ID: `person:Israel`); be (or show oneself) just (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); hipocrisia (ID: `keyterm:Hypocrisy`); Isaque (ID: `person:Isaac`); imposto (ID: `keyterm:TributeTax`); Boxthorn (ID: `flora:Boxthorn`); Footstool (ID: `realia:Footstool`); Denarius (ID: `realia:Denarius`); Image (ID: `realia:Image`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** offering (ID: `keyterm:Offering`); ser discípulo (ID: `keyterm:Disciple`); Daily Life (ID: `keyterm:DailyLife`); amizade (ID: `keyterm:Friendship`); juízo (ID: `keyterm:Judgment`); verdadeiro (ID: `keyterm:True`); orar (ID: `keyterm:Pray`); Lepton (ID: `realia:Lepton`); House (ID: `realia:House`); Treasury (ID: `realia:Treasury`); Synagogue (ID: `realia:Synagogue`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); céu (ID: `keyterm:Heaven`); Jerusalém (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); coração (ID: `keyterm:Heart`); reino (ID: `keyterm:Kingdom`); example (ID: `keyterm:Example`); Glory (ID: `keyterm:Glory`); surely! (ID: `keyterm:Surely`); fazer justiça (ID: `keyterm:GrantJustice`); SENHOR (ID: `deity:Lord`); parábola (ID: `keyterm:Parable`); Judeia (ID: `place:Judea`); libertação (ID: `keyterm:Liberation`); fear (ID: `keyterm:Fear`); rogar (ID: `keyterm:AskFor`); coisa terrível (ID: `keyterm:DreadfulEventOrSight`); Gentiles (ID: `group:Gentile`); Disaster (ID: `keyterm:Disaster`); (coisas) da vida diária (ID: `keyterm:OfThisLife`); testemunhar (ID: `keyterm:BearWitness`); Temple (ID: `realia:Temple`); Net (ID: `realia:Net`); Synagogue (ID: `realia:Synagogue`); Fig (ID: `flora:Fig`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); Judas (ID: `person:Judas.2`); fear (ID: `keyterm:Fear`); Satanás (ID: `deity:Satan`); Monte das Oliveiras (ID: `place:OlivesMount`); passover (ID: `keyterm:Passover`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** passover (ID: `keyterm:Passover`); reino (ID: `keyterm:Kingdom`); SENHOR (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); servir (ID: `keyterm:Serve`); House (ID: `realia:House`); sangue (ID: `keyterm:Blood`); corpo (ID: `keyterm:Body.3`); decidir (ID: `keyterm:Decided`); offering (ID: `keyterm:Offering`); Pedro (ID: `person:Peter`); autoridade (ID: `keyterm:Authority.2`); To Cause to Happen (ID: `keyterm:Happen`); ser discípulo (ID: `keyterm:Disciple`); Israel (ID: `person:Israel`); Gentiles (ID: `group:Gentile`); Covenant (ID: `keyterm:Covenant`); João (ID: `person:John.2`); Disaster (ID: `keyterm:Disaster`); Upstairs Room (ID: `realia:UpstairsRoom`); Guest Room (ID: `realia:GuestRoom`); Clay Jar (ID: `realia:ClayJar`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); Pedro (ID: `person:Peter`); tentar (ID: `keyterm:PutToTheTest`); ser discípulo (ID: `keyterm:Disciple`); Bag (ID: `realia:Bag`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); céu (ID: `keyterm:Heaven`); sem lei (ID: `keyterm:Lawless`); crer (ID: `keyterm:Believe`); Satanás (ID: `deity:Satan`); escritura (ID: `keyterm:Scripture`); rogar (ID: `keyterm:AskFor`); A Group of Disciples (ID: `group:GenericDisciples`); Wheat (ID: `flora:Wheat`); Rooster (ID: `fauna:Rooster`); Cloak (ID: `realia:Cloak`); Olive Tree (ID: `flora:OliveTree`); Prison (ID: `realia:Prison`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Jesus (ID: `person:Jesus.2`); Judas (ID: `person:Judas.2`); Rooster (ID: `fauna:Rooster`); Temple (ID: `realia:Temple`); Peter's Second Accuser (ID: `person:SecondAccuserOfPeter`); A Servant (ID: `person:GenericServant`); Ability (ID: `keyterm:Ability`); autoridade (ID: `keyterm:Authority.2`); Truth (ID: `keyterm:Truth`); Galileans (ID: `group:Galilee`); Galileia (ID: `place:Galilee`); House (ID: `realia:House`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Pilatos (ID: `person:Pilate`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); Galileia (ID: `place:Galilee`); Priests (ID: `group:GenericPriests`); Elders (ID: `group:GenericElders`); rogar (ID: `keyterm:AskFor`); Religious Officials (ID: `group:ReligiousOfficials`); Jerusalém (ID: `place:Jerusalem`); speak (ID: `keyterm:Speak`); autoridade (ID: `keyterm:Authority.2`); SENHOR (ID: `deity:Lord`); Judeia (ID: `place:Judea`); Tibério (ID: `person:Tiberius`); Herodes Antipas (ID: `person:Herod.2`); blasfemar (ID: `keyterm:Blaspheme`); crer (ID: `keyterm:Believe`); Galileans (ID: `group:Galilee`); Jews (ID: `group:Jews`); imposto (ID: `keyterm:TributeTax`); testemunhar (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** Pilatos (ID: `person:Pilate`); Herodes Antipas (ID: `person:Herod.2`); Jesus (ID: `person:Jesus.2`); Barrabás (ID: `person:Barabbas`); Cross (ID: `realia:Cross`); Prison (ID: `realia:Prison`); decidir (ID: `keyterm:Decided`); distinguir (ID: `keyterm:Discern`); example (ID: `keyterm:Example`); hope (ID: `keyterm:Hope`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Jews (ID: `group:Jews`); Cross (ID: `realia:Cross`); Criminal on the Cross (ID: `person:Dysmas`); Simão (ID: `person:Simon.5`); Cirene (ID: `place:Cyrene`); Jerusalém (ID: `place:Jerusalem`); surely! (ID: `keyterm:Surely`); bem, aventurado (ID: `keyterm:Happy`); escolhido (ID: `keyterm:Chosen`); juízo (ID: `keyterm:Judgment`); paraíso (ID: `keyterm:Paradise`); To Command (ID: `keyterm:Command`); fear (ID: `keyterm:Fear`); blasfemar (ID: `keyterm:Blaspheme`); forgive (ID: `keyterm:Forgive`); Golgotha (ID: `place:Golgotha`); Sour Wine (ID: `realia:SourWine`); Clothing (ID: `realia:Clothing`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`); sabbath (ID: `keyterm:Sabbath`); Galileia (ID: `place:Galilee`); be (or show oneself) just (ID: `keyterm:Just`); Grave (ID: `realia:Grave`); José (ID: `person:Joseph.6`); Arimateia (ID: `place:Arimathea`); Glory (ID: `keyterm:Glory`); Commandment (ID: `keyterm:Commandment`); Pilatos (ID: `person:Pilate`); reino (ID: `keyterm:Kingdom`); Name (ID: `keyterm:Name`); Good (ID: `keyterm:Good`); Jews (ID: `group:Jews`); Spirit (ID: `keyterm:Spirit.2`); Aloes (ID: `realia:Aloes`); Linen (ID: `realia:Linen`); Myrrh (ID: `flora:Myrrh`); Curtain (ID: `realia:Curtain`); Temple (ID: `realia:Temple`); Myrrh (ID: `realia:Myrrh`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); palavra (ID: `keyterm:Word`); Week (ID: `keyterm:Week`); Joana (ID: `person:Joanna`); não crer (ID: `keyterm:Disbelieve`); corpo (ID: `keyterm:Body.3`); Pedro (ID: `person:Peter`); Tiago (ID: `person:James.3`); levantamento (ID: `keyterm:Resurrection`); Life (ID: `keyterm:Life`); Maria Madalena (ID: `person:Marymagdalene`); Maria (ID: `person:Mary`); Galileia (ID: `place:Galilee`); Linen (ID: `realia:Linen`); Cross (ID: `realia:Cross`); Clothing (ID: `realia:Clothing`); Aloes (ID: `realia:Aloes`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Jerusalém (ID: `place:Jerusalem`); coração (ID: `keyterm:Heart`); Name (ID: `keyterm:Name`); escritura (ID: `keyterm:Scripture`); Grave (ID: `realia:Grave`); Cleopas (ID: `person:Cleopas`); Emaús (ID: `place:Emmaus`); Glory (ID: `keyterm:Glory`); corpo (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); An Angel (ID: `deity:Angel`); bless (ID: `keyterm:Bless`); Pedro (ID: `person:Peter`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); libertação (ID: `keyterm:Liberation`); crer (ID: `keyterm:Believe`); levantamento (ID: `keyterm:Resurrection`); Moisés (ID: `person:Moses`); Israel (ID: `person:Israel`); hope (ID: `keyterm:Hope`); Stade (ID: `realia:Stade`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** bless (ID: `keyterm:Bless`); Jerusalém (ID: `place:Jerusalem`); Cause of Joy (ID: `keyterm:CauseOfJoy`); SENHOR (ID: `deity:Lord`); Spirit (ID: `keyterm:Spirit.2`); prostrar, se (ID: `keyterm:BowDown`); To Cause to Happen (ID: `keyterm:Happen`); Betânia (ID: `place:Bethany`); escritura (ID: `keyterm:Scripture`); Ability (ID: `keyterm:Ability`); não crer (ID: `keyterm:Disbelieve`); corpo (ID: `keyterm:Body.3`); proclamar (ID: `keyterm:Proclaim`); Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); Name (ID: `keyterm:Name`); To Sin (ID: `keyterm:Sin`); arrepender, se (ID: `keyterm:Repent`); lei (ID: `keyterm:Law`); céu (ID: `keyterm:Heaven`); promessa (ID: `keyterm:Promise`); forgive (ID: `keyterm:Forgive`); Moisés (ID: `person:Moses`); witness (ID: `keyterm:Witness`); altura (ID: `keyterm:Height`); Fish (ID: `fauna:Fish`); Temple (ID: `realia:Temple`)
