...
* **Associated ACAI Concepts:** Zacarias (ID: `person:Zechariah`); Elisabete (ID: `person:Elizabeth`); Abias (ID: `person:Abijah.6`); Strong Drink (ID: `realia:StrongDrink`); Gabriel (ID: `deity:Gabriel`); decreto justo (ID: `keyterm:Regulations`); Herodes (ID: `person:Herod`); be blameless (ID: `keyterm:Blameless`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Maria (ID: `person:Mary`); palavra (ID: `keyterm:Word`); favor (ID: `keyterm:Favor`); Gabriel (ID: `deity:Gabriel`); Nazaré (ID: `place:Nazareth`); Jesus (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Zacarias (ID: `person:Zechariah`); altura (ID: `keyterm:Height`); Elisabete (ID: `person:Elizabeth`); livrar (ID: `keyterm:Deliver`); libertação (ID: `keyterm:Liberation`); Judeia (ID: `place:Judea`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Manger (ID: `realia:Manger`); Quirino (ID: `person:Quirinius`); Belém (ID: `place:Bethlehem`); Inn (ID: `realia:Inn`); Augusto (ID: `person:Augustus`); salvador (ID: `keyterm:Savior`); inscrever (ID: `keyterm:Register`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Simeão (ID: `person:Simeon.2`); Ana (ID: `person:Anna`); Fanuel (ID: `person:Phanuel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Abilene (ID: `place:Abilene`); Lisânias (ID: `person:Lysanias`); Traconites (ID: `place:Trachonitis`); Filipe (ID: `person:Philip.3`); Itureia (ID: `place:Ituraea`); Anás (ID: `person:Annas`); Augusto (ID: `person:Augustus`); Tibério (ID: `person:Tiberius`); Herodes Antipas (ID: `person:Herod.2`); João (ID: `person:John`); Jordan River (ID: `place:Jordan`)
...
* **Associated ACAI Concepts:** Strap (ID: `realia:Strap`); Herodias (ID: `person:Herodias`); Herodes Antipas (ID: `person:Herod.2`)
...
* **Associated ACAI Concepts:** Eliezer (ID: `person:Eliezer`); Janai (ID: `person:Jannai`); Eli (ID: `person:Heli`); Levi (ID: `person:Levi.2`); Joanã (ID: `person:Joanan`); Levi (ID: `person:Levi`); Esli (ID: `person:Esli`); Matatias (ID: `person:Mattathias`); José (ID: `person:Joseph.8`); Cosã (ID: `person:Cosam`); Sealtiel (ID: `person:Shealtiel`); Mená (ID: `person:Menna`); Melqui (ID: `person:Melchi.2`); Adi (ID: `person:Addi`); Josué (ID: `person:Joshua`); Joda (ID: `person:Joda`); José (ID: `person:Joseph.7`); Matatá (ID: `person:Mattatha`); Amós (ID: `person:Amos.2`); Naum (ID: `person:Nahum`); Nagai (ID: `person:Naggai`); Simeão (ID: `person:Simeon.3`); Judá (ID: `person:Judah.3`); Jonã (ID: `person:Jonam`); Maate (ID: `person:Maath`); Semei (ID: `person:Semein`); Er (ID: `person:Er`); Matate (ID: `person:Matthat`); Resa (ID: `person:Rhesa`); Josech (ID: `person:Josech`); Eliaquim (ID: `person:Eliakim.2`); Zorobabel (ID: `person:Zerubbabel`); Matate (ID: `person:Matthat.2`); Meleá (ID: `person:Melea`); Melqui (ID: `person:Melchi`); Elmadã (ID: `person:Elmadam`); Matatias (ID: `person:Mattathias.2`); Jorim (ID: `person:Jorim`); Cainã (ID: `person:Cainan`); Neri (ID: `person:Neri`); Natã (ID: `person:Nathan`); Serugue (ID: `person:Serug`); Reú (ID: `person:Reu`); Salmom (ID: `person:Salmon`); Metusalém (ID: `person:Methuselah`); Jarede (ID: `person:Jared`); Lameque (ID: `person:Lamech.2`); Maalalel (ID: `person:Mahalalel`); Naor (ID: `person:Nahor`); Cainã (ID: `person:Kenan`); Enos (ID: `person:Enosh`); Selá (ID: `person:Shelah.2`); Pelegue (ID: `person:Peleg`); Tera (ID: `person:Terah`); Sete (ID: `person:Seth`); Eber (ID: `person:Eber`); Hezrom (ID: `person:Hezron.2`); José (ID: `person:Joseph.4`); Sem (ID: `person:Shem`); Boaz (ID: `person:Boaz`); Adão (ID: `person:Adam`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); proclamar (ID: `keyterm:Proclaim`); Sarepta (ID: `place:Zarephath`); Naamã (ID: `person:Naaman.3`); Nazaré (ID: `place:Nazareth`); Eliseu (ID: `person:Elisha`); Syrians (ID: `group:Syria`); Galileia (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** To Command (ID: `keyterm:Command`); Cafarnaum (ID: `place:Capernaum`); Judeia (ID: `place:Judea`); boa notícia (ID: `keyterm:GoodNews`)
...
* **Associated ACAI Concepts:** Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Pedro (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Tile (ID: `realia:Tile`); Bring In (ID: `keyterm:BringIn`); Galileia (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** cobrador de impostos (ID: `keyterm:TaxCollector`); Patch (ID: `realia:Patch`)
...
* **Associated ACAI Concepts:** bem, aventurado (ID: `keyterm:Happy`); Simão (ID: `person:Simon.2`); Judas (ID: `person:Judas`); Mateus (ID: `person:Matthew`); escolhido (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); Storeroom (ID: `realia:Storeroom`); Compassionate (ID: `keyterm:Compassionate`); condenar (ID: `keyterm:Condemn`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Nain (ID: `place:Nain`); Judeia (ID: `place:Judea`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** batista (ID: `keyterm:Baptist`); João (ID: `person:John`)
...
* **Associated ACAI Concepts:** Simão (ID: `person:Simon.6`); Alabaster Jar (ID: `realia:AlabasterJar`); ter dívida para com alguém (ID: `keyterm:Owe`); forgive (ID: `keyterm:Forgive`)
...
* **Associated ACAI Concepts:** Suzana (ID: `person:Susanna`); Cuza (ID: `person:Chuza`); parábola (ID: `keyterm:Parable`); Joana (ID: `person:Joanna`); bom (ID: `keyterm:Honest`); Daily Life (ID: `keyterm:DailyLife`); Maria Madalena (ID: `person:Marymagdalene`)
...
* **Associated ACAI Concepts:** Gerasa (ID: `place:Gerasa`); Legião (ID: `deity:Legion`); Fetter (ID: `realia:Fetter`); abismo (ID: `keyterm:Abyss`); estar endemoninhado (ID: `keyterm:DemonPossessed`); Demons (ID: `deity:Demons`)
...
* **Associated ACAI Concepts:** Jairo (ID: `person:Jairus`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Corazim (ID: `place:Chorazin`); fazer a paz (ID: `keyterm:Peace`); Scorpion (ID: `fauna:Scorpion`); Disaster (ID: `keyterm:Disaster`)
...
* **Associated ACAI Concepts:** Inn (ID: `realia:Inn`); mente (ID: `keyterm:Mind.2`); misericórdia (ID: `keyterm:Mercy`)
...
* **Associated ACAI Concepts:** Rue (ID: `flora:Rue`); Mint (ID: `flora:Mint`); Zacarias (ID: `person:Zechariah.12`); Plate (ID: `realia:Plate.2`); Disaster (ID: `keyterm:Disaster`); Pharisees (ID: `group:Pharisee`)
...
* **Associated ACAI Concepts:** Assarion (ID: `realia:Assarion`); Inner Room (ID: `realia:InnerRoom`); hipocrisia (ID: `keyterm:Hypocrisy`); geena (ID: `keyterm:Gehenna`); blasfemar (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** Barn (ID: `realia:Barn`); Oven (ID: `realia:Oven`); Storeroom (ID: `realia:Storeroom`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Crow (ID: `fauna:Crow`); Bag (ID: `realia:Bag`); Flock (ID: `fauna:Flock`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Carob (ID: `flora:Carob`); empregado (ID: `keyterm:HiredWorker`); Cattle (ID: `fauna:Bull`); Daily Life (ID: `keyterm:DailyLife`); Kid (ID: `fauna:Kid`); compaixão (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Kor (ID: `realia:Kor.2`); ter dívida para com alguém (ID: `keyterm:Owe`); administração (ID: `keyterm:Stewardship`)
...
* **Associated ACAI Concepts:** Lázaro (ID: `person:Lazarus`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Dog (ID: `fauna:Dog`); Abraão (ID: `person:Abraham`)
...
* **Associated ACAI Concepts:** Mulberry (ID: `flora:Mulberry`); fazer tropeçar (ID: `keyterm:CauseToStumble`); escândalo (ID: `keyterm:StumblingBlock`); dever (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** fazer justiça (ID: `keyterm:GrantJustice`); cobrador de impostos (ID: `keyterm:TaxCollector`); Pharisees (ID: `group:Pharisee`); jejuar (ID: `keyterm:Fast`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Zaqueu (ID: `person:Zacchaeus`); Sycomore Fig (ID: `flora:SycomoreFig`)
...
* **Associated ACAI Concepts:** Betfagé (ID: `place:Bethphage`); Temple (ID: `realia:Temple`); Monte das Oliveiras (ID: `place:OlivesMount`); altura (ID: `keyterm:Height`); Siege-Works (ID: `realia:Siege-works`); Betânia (ID: `place:Bethany`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Tibério (ID: `person:Tiberius`); levantamento (ID: `keyterm:Resurrection`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** servir (ID: `keyterm:Serve`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); passover (ID: `keyterm:Passover`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Peter's Second Accuser (ID: `person:SecondAccuserOfPeter`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Barrabás (ID: `person:Barabbas`); Pilatos (ID: `person:Pilate`)
...
* **Associated ACAI Concepts:** Criminal on the Cross (ID: `person:Dysmas`); Simão (ID: `person:Simon.5`); Cross (ID: `realia:Cross`); Sour Wine (ID: `realia:SourWine`); Cirene (ID: `place:Cyrene`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Arimateia (ID: `place:Arimathea`); Aloes (ID: `realia:Aloes`); José (ID: `person:Joseph.6`)
...
* **Associated ACAI Concepts:** Joana (ID: `person:Joanna`); Week (ID: `keyterm:Week`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** Emaús (ID: `place:Emmaus`); Cleopas (ID: `person:Cleopas`); Stade (ID: `realia:Stade`)
...
* **Associated ACAI Concepts:** Betânia (ID: `place:Bethany`); To Cause to Happen (ID: `keyterm:Happen`); escritura (ID: `keyterm:Scripture`); prostrar, se (ID: `keyterm:BowDown`)
