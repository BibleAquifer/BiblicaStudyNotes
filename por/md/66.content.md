...
* **Associated ACAI Concepts:** Patmos (ID: `place:Patmos`); Lampstand (ID: `realia:Lampstand.2`); Pérgamo (ID: `place:Pergamum`); Esmirna (ID: `place:Smyrna`); Filadélfia (ID: `place:Philadelphia`); Sardes (ID: `place:Sardis`); Laodiceia (ID: `place:Laodicea`); Kiln (ID: `realia:Kiln`); Éfeso (ID: `place:Ephesus`)
...
* **Associated ACAI Concepts:** Nicolaitans (ID: `group:Nicolaitans`); Antipas (ID: `person:Antipas`); Pérgamo (ID: `place:Pergamum`); Esmirna (ID: `place:Smyrna`); Éfeso (ID: `place:Ephesus`); to act wickedly (ID: `keyterm:ActWickedly`); igreja (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** Tiatira (ID: `place:Thyatira`); Sardes (ID: `place:Sardis`); fornication (ID: `keyterm:Fornication`); Clothing (ID: `realia:Clothing`); Jezabel (ID: `person:Jezebel`); Rod (ID: `realia:Rod`); igreja (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** Eye Salve (ID: `realia:EyeSalve`); Filadélfia (ID: `place:Philadelphia`); Door (ID: `realia:Door`); verdadeiro (ID: `keyterm:True`); Laodiceia (ID: `place:Laodicea`); amizade (ID: `keyterm:Friendship`)
...
* **Associated ACAI Concepts:** Issacar (ID: `person:Issachar`); Zebulom (ID: `person:Zebulun`); Naftali (ID: `person:Naphtali`); Rúben (ID: `person:Reuben`); Throne (ID: `realia:Throne`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Abadom (ID: `deity:Abaddon`); abismo (ID: `keyterm:Abyss`)
...
* **Associated ACAI Concepts:** Dragon (ID: `fauna:Dragon`); testemunhar (ID: `keyterm:BearWitness`); Miguel (ID: `person:Michael.11`); Rod (ID: `realia:Rod`); céu (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** autoridade (ID: `keyterm:Authority.2`); Leopard (ID: `fauna:Leopard`); Bear (ID: `fauna:Bear`); Ability (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** irrepreensível (ID: `keyterm:Unblemished`); Lyre (ID: `realia:Lyre`)
...
* **Associated ACAI Concepts:** Bowl (ID: `realia:Bowl.2`); Frog (ID: `fauna:Frog`); Talent (ID: `realia:Talent`); Rio Eufrates (ID: `place:Euphrates`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** decreto justo (ID: `keyterm:Regulations`); fazer justiça (ID: `keyterm:GrantJustice`); Linen (ID: `realia:Linen`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** abismo (ID: `keyterm:Abyss`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Magogue (ID: `place:Magog`); Key (ID: `realia:Key`); Gog (ID: `place:Gog`); Chain (ID: `realia:Chain`)
...
* **Associated ACAI Concepts:** Glory (ID: `keyterm:Glory`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** The Church (ID: `group:GenericChurch`); bem, aventurado (ID: `keyterm:Happy`); surely! (ID: `keyterm:Surely`); Scroll (ID: `realia:Scroll`)
