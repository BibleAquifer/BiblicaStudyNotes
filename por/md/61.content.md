...
* **Associated ACAI Concepts:** divino (ID: `keyterm:Divine`); empenho (ID: `keyterm:Eagerness`); promessa (ID: `keyterm:Promise`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Ló (ID: `person:Lot`)
...
* **Associated ACAI Concepts:** Beor (ID: `person:Beor.2`); Pig (ID: `fauna:Pig`); Balaão (ID: `person:Balaam`); be unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** elementos (ID: `keyterm:FundamentalPrinciples`)
