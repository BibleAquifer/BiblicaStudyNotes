...
* **Associated ACAI Concepts:** Capadócia (ID: `place:Cappadocia`); Bitínia (ID: `place:Bithynia`); Ponto (ID: `place:Pontus`); Galácia (ID: `place:Galatia`); imortal (ID: `keyterm:Imperishable`); consecration (ID: `keyterm:Consecration.2`); hope (ID: `keyterm:Hope`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** holy (ID: `keyterm:Holy`); amor fraternal (ID: `keyterm:LoveForOnesFellowBeliever`); irrepreensível (ID: `keyterm:Unblemished`); libertação (ID: `keyterm:Liberation`); invocar (ID: `keyterm:CallUpon`)
...
* **Associated ACAI Concepts:** escolhido (ID: `keyterm:Chosen`); rejeitar (ID: `keyterm:Reject`); priesthood (ID: `keyterm:Priesthood`); escândalo (ID: `keyterm:StumblingBlock`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Do Good (ID: `keyterm:DoGood`); carnal (ID: `keyterm:Carnal`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); Boat (ID: `realia:Boat`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Christians (ID: `group:Christ`); compartilhar (ID: `keyterm:Share`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
