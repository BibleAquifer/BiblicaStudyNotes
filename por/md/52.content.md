...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Macedônia (ID: `place:Macedonia`); Holy Spirit (ID: `deity:HolySpirit`); Acaia (ID: `place:Achaia`); love (ID: `keyterm:Love`); Tessalônica (ID: `place:Thessalonica`); céu (ID: `keyterm:Heaven`); verdadeiro (ID: `keyterm:True`); boa notícia (ID: `keyterm:GoodNews`); hope (ID: `keyterm:Hope`); Timóteo (ID: `person:Timothy`); fazer a paz (ID: `keyterm:Peace`); escolhido (ID: `keyterm:Chosen`); servir como escravo (ID: `keyterm:Serve.2`); Silas (ID: `person:Silas`); favor (ID: `keyterm:Favor`); Ability (ID: `keyterm:Ability`); Thessalonians (ID: `group:Thessalonica`); Cause of Joy (ID: `keyterm:CauseOfJoy`); orar (ID: `keyterm:Pray`); Life (ID: `keyterm:Life`); levantamento (ID: `keyterm:Resurrection`); Paulo (ID: `person:Paul`); igreja (ID: `keyterm:Church`); livrar (ID: `keyterm:Deliver`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); boa notícia (ID: `keyterm:GoodNews`); crer (ID: `keyterm:Believe`); rogar (ID: `keyterm:AskFor`); witness (ID: `keyterm:Witness`); Jesus (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`); coração (ID: `keyterm:Heart`); verdadeiro (ID: `keyterm:True`); em cristo (ID: `keyterm:InChrist`); proclamar (ID: `keyterm:Proclaim`); Judeia (ID: `place:Judea`); testemunhar solenemente (ID: `keyterm:Declare`); be blameless (ID: `keyterm:Blameless`); reino (ID: `keyterm:Kingdom`); Filipos (ID: `place:Philippi`); andar (ID: `keyterm:Live.3`); vazio (ID: `keyterm:Empty`); amado (ID: `keyterm:Beloved`); Gentiles (ID: `group:Gentile`); discernir (ID: `keyterm:Interpret`); defilement (ID: `keyterm:Defilement`); salvation (ID: `keyterm:Salvation`); Jews (ID: `group:Jews`); To Sin (ID: `keyterm:Sin`); igreja (ID: `keyterm:Church`); holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); coração (ID: `keyterm:Heart`); boa notícia (ID: `keyterm:GoodNews`); Timóteo (ID: `person:Timothy`); exortar (ID: `keyterm:Encourage`); love (ID: `keyterm:Love`); Atenas (ID: `place:Athens`); hope (ID: `keyterm:Hope`); be blameless (ID: `keyterm:Blameless`); tentar (ID: `keyterm:PutToTheTest`); desejar (ID: `keyterm:LongFor`); Satanás (ID: `deity:Satan`); vazio (ID: `keyterm:Empty`); Life (ID: `keyterm:Life`); Good (ID: `keyterm:Good`); Paulo (ID: `person:Paul`); holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); consecration (ID: `keyterm:Consecration.2`); Jesus (ID: `person:Jesus.2`); andar (ID: `keyterm:Live.3`); rogar (ID: `keyterm:AskFor`); amor fraternal (ID: `keyterm:LoveForOnesFellowBeliever`); testemunhar solenemente (ID: `keyterm:Declare`); Holy Spirit (ID: `deity:HolySpirit`); ensinado por deus (ID: `keyterm:TaughtByGod`); Macedônia (ID: `place:Macedonia`); fornication (ID: `keyterm:Fornication`); Gentiles (ID: `group:Gentile`); defilement (ID: `keyterm:Defilement`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); em cristo (ID: `keyterm:InChrist`); céu (ID: `keyterm:Heaven`); crer (ID: `keyterm:Believe`); rogar (ID: `keyterm:AskFor`); exortar (ID: `keyterm:Encourage`); hope (ID: `keyterm:Hope`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** salvation (ID: `keyterm:Salvation`); Jesus (ID: `person:Jesus.2`); exortar (ID: `keyterm:Encourage`); crer (ID: `keyterm:Believe`); rogar (ID: `keyterm:AskFor`); fazer a paz (ID: `keyterm:Peace`); SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); hope (ID: `keyterm:Hope`); love (ID: `keyterm:Love`); Helmet (ID: `realia:Helmet`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); be blameless (ID: `keyterm:Blameless`); desanimado (ID: `keyterm:FaintHearted`); em cristo (ID: `keyterm:InChrist`); fazer a paz (ID: `keyterm:Peace`); Faithfulness (ID: `keyterm:Faithfulness`); viver em paz (ID: `keyterm:AtPeace`); favor (ID: `keyterm:Favor`); corpo (ID: `keyterm:Body.3`); discernir (ID: `keyterm:Interpret`); Good (ID: `keyterm:Good`); Holy Spirit (ID: `deity:HolySpirit`); consecration (ID: `keyterm:Consecration.2`); holy (ID: `keyterm:Holy`); Spirit (ID: `keyterm:Spirit.2`); love (ID: `keyterm:Love`)
