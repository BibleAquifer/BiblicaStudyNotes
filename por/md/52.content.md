...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Macedônia (ID: `place:Macedonia`); love (ID: `keyterm:Love`); Holy Spirit (ID: `deity:HolySpirit`); Acaia (ID: `place:Achaia`); Tessalônica (ID: `place:Thessalonica`); Ability (ID: `keyterm:Ability`); boa notícia (ID: `keyterm:GoodNews`); Life (ID: `keyterm:Life`); Paulo (ID: `person:Paul`); escolhido (ID: `keyterm:Chosen`); Cause of Joy (ID: `keyterm:CauseOfJoy`); servir como escravo (ID: `keyterm:Serve.2`); verdadeiro (ID: `keyterm:True`); Thessalonians (ID: `group:Thessalonica`); livrar (ID: `keyterm:Deliver`); orar (ID: `keyterm:Pray`); céu (ID: `keyterm:Heaven`); favor (ID: `keyterm:Favor`); levantamento (ID: `keyterm:Resurrection`); Silas (ID: `person:Silas`); Timóteo (ID: `person:Timothy`); fazer a paz (ID: `keyterm:Peace`); hope (ID: `keyterm:Hope`); igreja (ID: `keyterm:Church`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); boa notícia (ID: `keyterm:GoodNews`); crer (ID: `keyterm:Believe`); Glory (ID: `keyterm:Glory`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); witness (ID: `keyterm:Witness`); proclamar (ID: `keyterm:Proclaim`); be blameless (ID: `keyterm:Blameless`); Filipos (ID: `place:Philippi`); coração (ID: `keyterm:Heart`); andar (ID: `keyterm:Live.3`); vazio (ID: `keyterm:Empty`); reino (ID: `keyterm:Kingdom`); holy (ID: `keyterm:Holy`); amado (ID: `keyterm:Beloved`); To Sin (ID: `keyterm:Sin`); verdadeiro (ID: `keyterm:True`); em cristo (ID: `keyterm:InChrist`); Judeia (ID: `place:Judea`); Jews (ID: `group:Jews`); discernir (ID: `keyterm:Interpret`); defilement (ID: `keyterm:Defilement`); Gentiles (ID: `group:Gentile`); igreja (ID: `keyterm:Church`); testemunhar solenemente (ID: `keyterm:Declare`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); rogar (ID: `keyterm:AskFor`); boa notícia (ID: `keyterm:GoodNews`); love (ID: `keyterm:Love`); exortar (ID: `keyterm:Encourage`); coração (ID: `keyterm:Heart`); Timóteo (ID: `person:Timothy`); Atenas (ID: `place:Athens`); Glory (ID: `keyterm:Glory`); be blameless (ID: `keyterm:Blameless`); Life (ID: `keyterm:Life`); Paulo (ID: `person:Paul`); vazio (ID: `keyterm:Empty`); holy (ID: `keyterm:Holy`); tentar (ID: `keyterm:PutToTheTest`); desejar (ID: `keyterm:LongFor`); Good (ID: `keyterm:Good`); Satanás (ID: `deity:Satan`); hope (ID: `keyterm:Hope`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); consecration (ID: `keyterm:Consecration.2`); Jesus (ID: `person:Jesus.2`); rogar (ID: `keyterm:AskFor`); andar (ID: `keyterm:Live.3`); amor fraternal (ID: `keyterm:LoveForOnesFellowBeliever`); ensinado por deus (ID: `keyterm:TaughtByGod`); love (ID: `keyterm:Love`); Macedônia (ID: `place:Macedonia`); defilement (ID: `keyterm:Defilement`); Gentiles (ID: `group:Gentile`); testemunhar solenemente (ID: `keyterm:Declare`); fornication (ID: `keyterm:Fornication`); Holy Spirit (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); SENHOR (ID: `deity:Lord`); céu (ID: `keyterm:Heaven`); crer (ID: `keyterm:Believe`); hope (ID: `keyterm:Hope`); exortar (ID: `keyterm:Encourage`); rogar (ID: `keyterm:AskFor`); em cristo (ID: `keyterm:InChrist`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); salvation (ID: `keyterm:Salvation`); exortar (ID: `keyterm:Encourage`); fazer a paz (ID: `keyterm:Peace`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); hope (ID: `keyterm:Hope`); Life (ID: `keyterm:Life`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); Helmet (ID: `realia:Helmet`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); rogar (ID: `keyterm:AskFor`); be blameless (ID: `keyterm:Blameless`); corpo (ID: `keyterm:Body.3`); love (ID: `keyterm:Love`); viver em paz (ID: `keyterm:AtPeace`); holy (ID: `keyterm:Holy`); desanimado (ID: `keyterm:FaintHearted`); em cristo (ID: `keyterm:InChrist`); Faithfulness (ID: `keyterm:Faithfulness`); favor (ID: `keyterm:Favor`); Good (ID: `keyterm:Good`); Holy Spirit (ID: `deity:HolySpirit`); discernir (ID: `keyterm:Interpret`); fazer a paz (ID: `keyterm:Peace`); consecration (ID: `keyterm:Consecration.2`); Spirit (ID: `keyterm:Spirit.2`)
