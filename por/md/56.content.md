...
* **Associated ACAI Concepts:** irrepreensível (ID: `keyterm:WithoutReproach`); Creta (ID: `place:Crete`); Tito (ID: `person:Titus`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Cretan Prophet (ID: `person:CretanProphet`); Cretenses (ID: `group:Cretan`); limpo (ID: `keyterm:Clean`)
...
* **Associated ACAI Concepts:** Ártemas (ID: `person:Artemas`); Zenas (ID: `person:Zenas`); Nicópolis (ID: `place:Nicopolis`); compreensivo (ID: `keyterm:Gentle`); inútil (ID: `keyterm:Worthless`)
