...
* **Associated ACAI Concepts:** Diótrefes (ID: `person:Diotrephes`); Gaio (ID: `person:Gaius.4`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); Demétrio (ID: `person:Demetrius`); Truth (ID: `keyterm:Truth`)
