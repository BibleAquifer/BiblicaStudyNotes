...
* **Associated Passages:** 3 João 1:1-15
...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); amado (ID: `keyterm:Beloved`); testemunhar (ID: `keyterm:BearWitness`); igreja (ID: `keyterm:Church`); love (ID: `keyterm:Love`); andar (ID: `keyterm:Live.3`); SENHOR (ID: `deity:Lord`); Name (ID: `keyterm:Name`); Demétrio (ID: `person:Demetrius`); Gaio (ID: `person:Gaius.4`); Diótrefes (ID: `person:Diotrephes`); Cause of Joy (ID: `keyterm:CauseOfJoy`); dever (ID: `keyterm:Ought`); hope (ID: `keyterm:Hope`); Good (ID: `keyterm:Good`); verdadeiro (ID: `keyterm:True`); orar (ID: `keyterm:Pray`); fazer a paz (ID: `keyterm:Peace`); Faithfulness (ID: `keyterm:Faithfulness`); Do Good (ID: `keyterm:DoGood`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); Reed (ID: `flora:Reed`)
