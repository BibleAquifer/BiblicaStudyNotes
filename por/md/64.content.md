...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); amado (ID: `keyterm:Beloved`); testemunhar (ID: `keyterm:BearWitness`); igreja (ID: `keyterm:Church`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`); andar (ID: `keyterm:Live.3`); Name (ID: `keyterm:Name`); Gaio (ID: `person:Gaius.4`); Diótrefes (ID: `person:Diotrephes`); Demétrio (ID: `person:Demetrius`); orar (ID: `keyterm:Pray`); Faithfulness (ID: `keyterm:Faithfulness`); hope (ID: `keyterm:Hope`); fazer a paz (ID: `keyterm:Peace`); dever (ID: `keyterm:Ought`); Do Good (ID: `keyterm:DoGood`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Good (ID: `keyterm:Good`); verdadeiro (ID: `keyterm:True`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); Reed (ID: `flora:Reed`)
