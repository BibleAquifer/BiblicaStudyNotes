...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); amado (ID: `keyterm:Beloved`); igreja (ID: `keyterm:Church`); testemunhar (ID: `keyterm:BearWitness`); love (ID: `keyterm:Love`); andar (ID: `keyterm:Live.3`); Name (ID: `keyterm:Name`); SENHOR (ID: `deity:Lord`); Diótrefes (ID: `person:Diotrephes`); Gaio (ID: `person:Gaius.4`); Demétrio (ID: `person:Demetrius`); dever (ID: `keyterm:Ought`); Cause of Joy (ID: `keyterm:CauseOfJoy`); verdadeiro (ID: `keyterm:True`); orar (ID: `keyterm:Pray`); Faithfulness (ID: `keyterm:Faithfulness`); Good (ID: `keyterm:Good`); Do Good (ID: `keyterm:DoGood`); fazer a paz (ID: `keyterm:Peace`); hope (ID: `keyterm:Hope`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); Reed (ID: `flora:Reed`)
