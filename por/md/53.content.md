...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); ser glorificado (ID: `keyterm:Glorified`); be (or show oneself) just (ID: `keyterm:Just`); favor (ID: `keyterm:Favor`); Ability (ID: `keyterm:Ability`); igreja (ID: `keyterm:Church`); Tessalônica (ID: `place:Thessalonica`); testemunhar (ID: `keyterm:BearWitness`); céu (ID: `keyterm:Heaven`); dever (ID: `keyterm:Ought`); tribunal de justiça (ID: `keyterm:CourtCase`); boa notícia (ID: `keyterm:GoodNews`); Timóteo (ID: `person:Timothy`); reino (ID: `keyterm:Kingdom`); fazer a paz (ID: `keyterm:Peace`); An Angel (ID: `deity:Angel`); para a eternidade (ID: `keyterm:Always`); Silas (ID: `person:Silas`); Name (ID: `keyterm:Name`); fazer justiça (ID: `keyterm:GrantJustice`); Thessalonians (ID: `group:Thessalonica`); orar (ID: `keyterm:Pray`); To Cause to Happen (ID: `keyterm:Happen`); Good (ID: `keyterm:Good`); Paulo (ID: `person:Paul`); juízo (ID: `keyterm:Judgment`); holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** sem lei (ID: `keyterm:Lawless`); Jesus (ID: `person:Jesus.2`); Truth (ID: `keyterm:Truth`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Spirit (ID: `keyterm:Spirit.2`); maravilha (ID: `keyterm:Portent`); rogar (ID: `keyterm:AskFor`); Satanás (ID: `deity:Satan`); salvation (ID: `keyterm:Salvation`); decidir (ID: `keyterm:Decided`); Ability (ID: `keyterm:Ability`); objeto de culto (ID: `keyterm:ObjectOfWorship`); injustiça (ID: `keyterm:UnjustDeed`); wipe (out), destroy (ID: `keyterm:Destroy`); example (ID: `keyterm:Example`); love (ID: `keyterm:Love`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); rogar (ID: `keyterm:AskFor`); crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); Glory (ID: `keyterm:Glory`); tradição (ID: `keyterm:Teaching`); dever (ID: `keyterm:Ought`); boa notícia (ID: `keyterm:GoodNews`); hope (ID: `keyterm:Hope`); persuadir (ID: `keyterm:Persuade`); para a eternidade (ID: `keyterm:Always`); Faithfulness (ID: `keyterm:Faithfulness`); exortar (ID: `keyterm:Encourage`); favor (ID: `keyterm:Favor`); Truth (ID: `keyterm:Truth`); orar (ID: `keyterm:Pray`); Holy Spirit (ID: `deity:HolySpirit`); consecration (ID: `keyterm:Consecration.2`); salvation (ID: `keyterm:Salvation`); livrar (ID: `keyterm:Deliver`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); andar (ID: `keyterm:Live.3`); tradição (ID: `keyterm:Teaching`); Name (ID: `keyterm:Name`); favor (ID: `keyterm:Favor`); intrometer, se em assuntos alheios (ID: `keyterm:Busybody`); autoridade (ID: `keyterm:Authority.2`); rogar (ID: `keyterm:AskFor`); fazer a paz (ID: `keyterm:Peace`); Paulo (ID: `person:Paul`); Ability (ID: `keyterm:Ability`); example (ID: `keyterm:Example`)
