...
* **Associated ACAI Concepts:** Tessalônica (ID: `place:Thessalonica`); ser glorificado (ID: `keyterm:Glorified`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** tradição (ID: `keyterm:Teaching`); Jesus (ID: `person:Jesus.2`)
