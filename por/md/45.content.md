...
* **Associated ACAI Concepts:** desejar (ID: `keyterm:LongFor`); amado (ID: `keyterm:Beloved`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** injustiça (ID: `keyterm:UnjustDeed`); Creeping Animal (ID: `fauna:CreepingAnimal`); divino (ID: `keyterm:Divine`); imortal (ID: `keyterm:Imperishable`); adorar (ID: `keyterm:Worship`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** decidir (ID: `keyterm:Decided`); juízo (ID: `keyterm:Judgment`); favoritismo (ID: `keyterm:Partiality`); condenar (ID: `keyterm:Condemn`); consciência (ID: `keyterm:Conscience`); kindness (ID: `keyterm:Kindness`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Circumcision (ID: `keyterm:Circumcision`); lei (ID: `keyterm:Law`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); Cobra (ID: `fauna:Cobra`); não crer (ID: `keyterm:Disbelieve`); injustiça (ID: `keyterm:UnjustDeed`); verdadeiro (ID: `keyterm:True`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); be (or show oneself) just (ID: `keyterm:Just`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** promessa (ID: `keyterm:Promise`); be (or show oneself) just (ID: `keyterm:Just`); Abraão (ID: `person:Abraham`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** reconciliar (ID: `keyterm:Reconcile`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Life (ID: `keyterm:Life`); consecration (ID: `keyterm:Consecration.2`); batismo (ID: `keyterm:Baptism`); servir como escravo (ID: `keyterm:Serve.2`); andar (ID: `keyterm:Live.3`); To Sin (ID: `keyterm:Sin`); favor (ID: `keyterm:Favor`); be (or show oneself) just (ID: `keyterm:Just`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** bom (ID: `keyterm:Honest`); letra (ID: `keyterm:Letter`); carnal (ID: `keyterm:Carnal`); lei (ID: `keyterm:Law`); Commandment (ID: `keyterm:Commandment`); corpo (ID: `keyterm:Body.3`); To Sin (ID: `keyterm:Sin`); Life (ID: `keyterm:Life`)
...
* **Associated ACAI Concepts:** Spirit (ID: `keyterm:Spirit.2`); em cristo (ID: `keyterm:InChrist`); escravidão (ID: `keyterm:Slavery`); Make Alive (ID: `keyterm:Alive`); decreto justo (ID: `keyterm:Regulations`); pensar (ID: `keyterm:Think`); corpo (ID: `keyterm:Body.3`); Holy Spirit (ID: `deity:HolySpirit`); Life (ID: `keyterm:Life`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** escolhido (ID: `keyterm:Chosen`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** misericórdia (ID: `keyterm:Mercy`); Faraó (ID: `person:Pharaoh.6`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** escândalo (ID: `keyterm:StumblingBlock`); Oseias (ID: `person:Hosea`); tropeçar (ID: `keyterm:Stumble`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** coração (ID: `keyterm:Heart`); crer (ID: `keyterm:Believe`); invocar (ID: `keyterm:CallUpon`); Isaías (ID: `person:Isaiah`); zelo (ID: `keyterm:Extremely`); be (or show oneself) just (ID: `keyterm:Just`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Olive Tree (ID: `flora:OliveTree`); tropeçar (ID: `keyterm:Stumble`); Trap (ID: `realia:Trap`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Good (ID: `keyterm:Good`); corpo (ID: `keyterm:Body.3`); empenho (ID: `keyterm:Eagerness`); pensar (ID: `keyterm:Think`); servir (ID: `keyterm:Serve`); favor (ID: `keyterm:Favor`); amor fraternal (ID: `keyterm:LoveForOnesFellowBeliever`); sem hipocrisia (ID: `keyterm:Unhypocritical`); compartilhar (ID: `keyterm:Share`); fazer justiça (ID: `keyterm:GrantJustice`); discernir (ID: `keyterm:Interpret`); orar (ID: `keyterm:Pray`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** autoridade (ID: `keyterm:Authority.2`); servidor público (ID: `keyterm:Servant`)
...
* **Associated ACAI Concepts:** love (ID: `keyterm:Love`); dever (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** distinguir (ID: `keyterm:Discern`); aprovado (ID: `keyterm:Approved`); bom (ID: `keyterm:Honest`); Judgment Seat (ID: `realia:JudgmentSeat`); Building Up (ID: `keyterm:BuildingUp`); reino (ID: `keyterm:Kingdom`); decidir (ID: `keyterm:Decided`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** hope (ID: `keyterm:Hope`); servidor público (ID: `keyterm:Servant`); Gentiles (ID: `group:Gentile`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Espanha (ID: `place:Spain`); Ilírico (ID: `place:Illyricum`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Herodião (ID: `person:Herodion`); Flegonte (ID: `person:Phlegon`); Febe (ID: `person:Phoebe`); Estáquis (ID: `person:Stachys`); Hermas (ID: `person:Hermas`); Júlia (ID: `person:Julia`); Asíncrito (ID: `person:Asyncritus`); Nereus (ID: `person:Nereus`); Urbano (ID: `person:Urbanus`); Olimpas (ID: `person:Olympas`); Apeles (ID: `person:Apelles`); Trifena (ID: `person:Tryphaena`); Trifosa (ID: `person:Tryphosa`); Filólogo (ID: `person:Philologus`); Maria (ID: `person:Mary.6`); Rufo (ID: `person:Rufus.2`); Epêneto (ID: `person:Epaenetus`); Andrônico (ID: `person:Andronicus`); Narciso (ID: `person:Narcissus`); Hermes (ID: `person:Hermes`); Amplíato (ID: `person:Ampliatus`); Pátrobas (ID: `person:Patrobas`); Júnias (ID: `person:Junia`); Pérside (ID: `person:Persis`); Aristóbulo (ID: `person:Aristobulus`); amado (ID: `keyterm:Beloved`); Cencreia (ID: `place:Cenchreae`); Priscila (ID: `person:Priscilla`); Áquila (ID: `person:Aquila`); Asia (ID: `place:Asia`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Tércio (ID: `person:Tertius`); Quarto (ID: `person:Quartus`); Sópatro (ID: `person:Sopater`); Gaio (ID: `person:Gaius.3`); Erasto (ID: `person:Erastus`); Jasão (ID: `person:Jason`); Jesus (ID: `person:Jesus.2`)
