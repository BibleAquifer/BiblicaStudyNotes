...
* **Associated ACAI Concepts:** Davi (ID: `person:David`); Jesus (ID: `person:Jesus.2`); Babilônia (ID: `place:Babylon`); Abraão (ID: `person:Abraham`); Jacó (ID: `person:Jacob.2`); Azor (ID: `person:Azor`); Eliúde (ID: `person:Eliud`); Zorobabel (ID: `person:Zerubbabel.2`); Uzias (ID: `person:Uzziah`); Josias (ID: `person:Josiah`); Ezequias (ID: `person:Hezekiah`); Asa (ID: `person:Asa`); Jeoaquim (ID: `person:Jehoiachin`); Salmom (ID: `person:Salmon`); Ram (ID: `person:Ram`); Salomão (ID: `person:Solomon`); Jessé (ID: `person:Jesse`); Judá (ID: `person:Judah.4`); Aquim (ID: `person:Achim`); Zerá (ID: `person:Zerah.3`); Josafá (ID: `person:Jehoshaphat.3`); Isaque (ID: `person:Isaac`); Boaz (ID: `person:Boaz`); Eliaquim (ID: `person:Eliakim`); Zadoque (ID: `person:Zadok`); Acaz (ID: `person:Ahaz`); Eleazar (ID: `person:Eleazar`); Matã (ID: `person:Matthan`); Abias (ID: `person:Abijah.4`); Hezrom (ID: `person:Hezron.2`); Naassom (ID: `person:Nahshon`); Perez (ID: `person:Perez`); Roboão (ID: `person:Rehoboam`); Jeorão (ID: `person:Jehoram`); Obede (ID: `person:Obed`); Tamar (ID: `person:Tamar`); Abiúde (ID: `person:Abiud`); Jotão (ID: `person:Jotham.2`); Amon (ID: `person:Amon.3`); José (ID: `person:Joseph.4`); Raabe (ID: `person:Rahab`); Israel (ID: `person:Israel`); Aminadabe (ID: `person:Amminadab`); Urias (ID: `person:Uriah`); Rute (ID: `person:Ruth`); Sealtiel (ID: `person:Shealtiel.2`); Manassés (ID: `person:Manasseh.2`); Maria (ID: `person:Mary`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); José (ID: `person:Joseph.4`); SENHOR (ID: `deity:Lord`); Name (ID: `keyterm:Name`); Maria (ID: `person:Mary`); Holy Spirit (ID: `deity:HolySpirit`); An Angel (ID: `deity:Angel`); To Cause to Happen (ID: `keyterm:Happen`); ter casamento contratado (ID: `keyterm:Engaged`); fear (ID: `keyterm:Fear`); Davi (ID: `person:David`); salvation (ID: `keyterm:Salvation`); To Sin (ID: `keyterm:Sin`); be (or show oneself) just (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod`); Belém (ID: `place:Bethlehem`); Egito (ID: `place:Egypt`); prostrar, se (ID: `keyterm:BowDown`); Judeia (ID: `place:Judea`); SENHOR (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); Israel (ID: `person:Israel`); José (ID: `person:Joseph.4`); An Angel (ID: `deity:Angel`); Jerusalém (ID: `place:Jerusalem`); Jesus (ID: `person:Jesus.2`); Nazaré (ID: `place:Nazareth`); Arquelau (ID: `person:Archelaus`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Jeremias (ID: `person:Jeremiah.6`); offering (ID: `keyterm:Offering`); Priests (ID: `group:GenericPriests`); rogar (ID: `keyterm:AskFor`); A Priest (ID: `person:GenericPriest`); fear (ID: `keyterm:Fear`); exortar (ID: `keyterm:Encourage`); Religious Officials (ID: `group:ReligiousOfficials`); Galileia (ID: `place:Galilee`); Raquel (ID: `person:Rachel`); Maria (ID: `person:Mary`); Life (ID: `keyterm:Life`); Ramah (ID: `place:Ramah.2`); Judá (ID: `person:Judah.4`); Jews (ID: `group:Jews`); Frankincense (ID: `flora:Frankincense`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Money Box (ID: `realia:MoneyBox`); Incense (ID: `realia:Incense`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** arrepender, se (ID: `keyterm:Repent`); batismo (ID: `keyterm:Baptism`); Judeia (ID: `place:Judea`); João (ID: `person:John`); SENHOR (ID: `deity:Lord`); Jordan River (ID: `place:Jordan`); Isaías (ID: `person:Isaiah`); batista (ID: `keyterm:Baptist`); céu (ID: `keyterm:Heaven`); proclamar (ID: `keyterm:Proclaim`); Abraão (ID: `person:Abraham`); Pharisees (ID: `group:Pharisee`); reino (ID: `keyterm:Kingdom`); Jerusalém (ID: `place:Jerusalem`); Sadducees (ID: `group:Sadducee`); straightness (ID: `keyterm:Straightness`); Holy Spirit (ID: `deity:HolySpirit`); limpar (ID: `keyterm:CleanOut`); To Sin (ID: `keyterm:Sin`); Locust (ID: `fauna:Locust`); Threshing Floor (ID: `realia:ThreshingFloor`); Leather (ID: `realia:Leather`); Belt (ID: `realia:Belt`); Winnowing Fork (ID: `realia:WinnowingFork`); Sandal (ID: `realia:Sandal`); Clothing (ID: `realia:Clothing`); Snake (ID: `fauna:Snake`); Grain (ID: `flora:Grain`); Bag (ID: `realia:Bag`); Camel (ID: `fauna:Camel`); Bee (ID: `fauna:Bee`); Wheat (ID: `flora:Wheat`); Barn (ID: `realia:Barn`); Axe (ID: `realia:Axe`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); tentar (ID: `keyterm:PutToTheTest`); prostrar, se (ID: `keyterm:BowDown`); To Command (ID: `keyterm:Command`); An Angel (ID: `deity:Angel`); servir (ID: `keyterm:Serve`); palavra (ID: `keyterm:Word`); priesthood (ID: `keyterm:Priesthood`); reino (ID: `keyterm:Kingdom`); Satanás (ID: `deity:Satan`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); Holy Spirit (ID: `deity:HolySpirit`); jejuar (ID: `keyterm:Fast`); holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Galileia (ID: `place:Galilee`); Zebulom (ID: `person:Zebulun`); Zebulom (ID: `group:Zebulun`); Naftali (ID: `person:Naphtali`); arrepender, se (ID: `keyterm:Repent`); Nazaré (ID: `place:Nazareth`); proclamar (ID: `keyterm:Proclaim`); céu (ID: `keyterm:Heaven`); To Cause to Happen (ID: `keyterm:Happen`); Cafarnaum (ID: `place:Capernaum`); reino (ID: `keyterm:Kingdom`); Jesus (ID: `person:Jesus.2`); Jordan River (ID: `place:Jordan`); João (ID: `person:John`); Isaías (ID: `person:Isaiah`); Gentiles (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** Casting Net (ID: `realia:CastingNet`); Galileia (ID: `place:Galilee`); servir (ID: `keyterm:Serve`); André (ID: `person:Andrew`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Zebedeu (ID: `person:Zebedee`); João (ID: `person:John.2`); boa notícia (ID: `keyterm:GoodNews`); Sea of Galilee (ID: `place:GalileeSea`); Decápolis (ID: `place:Decapolis`); Tiago (ID: `person:James`); estar endemoninhado (ID: `keyterm:DemonPossessed`); proclamar (ID: `keyterm:Proclaim`); Judeia (ID: `place:Judea`); reino (ID: `keyterm:Kingdom`); Jerusalém (ID: `place:Jerusalem`); Jordan River (ID: `place:Jordan`); Pedro (ID: `person:Peter`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** bem, aventurado (ID: `keyterm:Happy`); céu (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); SENHOR (ID: `deity:Lord`); be (or show oneself) just (ID: `keyterm:Just`); coração (ID: `keyterm:Heart`); misericórdia (ID: `keyterm:Mercy`); rogar (ID: `keyterm:AskFor`); exortar (ID: `keyterm:Encourage`); ser discípulo (ID: `keyterm:Disciple`); Spirit (ID: `keyterm:Spirit.2`); limpo (ID: `keyterm:Clean`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); lei (ID: `keyterm:Law`); reino (ID: `keyterm:Kingdom`); Commandment (ID: `keyterm:Commandment`); Pharisees (ID: `group:Pharisee`); Ability (ID: `keyterm:Ability`); surely! (ID: `keyterm:Surely`); SENHOR (ID: `deity:Lord`); be (or show oneself) just (ID: `keyterm:Just`); Glory (ID: `keyterm:Glory`); Lampstand (ID: `realia:Lampstand.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); fornication (ID: `keyterm:Fornication`); geena (ID: `keyterm:Gehenna`); Hell (ID: `place:Hell`); love (ID: `keyterm:Love`); tribunal de justiça (ID: `keyterm:CourtCase`); offering (ID: `keyterm:Offering`); céu (ID: `keyterm:Heaven`); fazer tropeçar (ID: `keyterm:CauseToStumble`); corpo (ID: `keyterm:Body.3`); juízo (ID: `keyterm:Judgment`); reconciliar (ID: `keyterm:Reconcile`); Oath (ID: `keyterm:Oath`); Heavenly (ID: `keyterm:Heavenly`); Good (ID: `keyterm:Good`); coração (ID: `keyterm:Heart`); decidir (ID: `keyterm:Decided`); be (or show oneself) just (ID: `keyterm:Just`); Jerusalém (ID: `place:Jerusalem`); orar (ID: `keyterm:Pray`); cobrador de impostos (ID: `keyterm:TaxCollector`); surely! (ID: `keyterm:Surely`); Footstool (ID: `realia:Footstool`); Cloak (ID: `realia:Cloak`); Quadrans (ID: `realia:Quadrans`); Mile (ID: `realia:Mile`); Prison (ID: `realia:Prison`); Tunic (ID: `realia:Tunic.2`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); céu (ID: `keyterm:Heaven`); forgive (ID: `keyterm:Forgive`); surely! (ID: `keyterm:Surely`); Synagogue (ID: `realia:Synagogue`); reino (ID: `keyterm:Kingdom`); Bring In (ID: `keyterm:BringIn`); amizade (ID: `keyterm:Friendship`); ofensa (ID: `keyterm:Wrong`); be (or show oneself) just (ID: `keyterm:Just`); tentar (ID: `keyterm:PutToTheTest`); Name (ID: `keyterm:Name`); Heavenly (ID: `keyterm:Heavenly`); holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); livrar (ID: `keyterm:Deliver`); Inner Room (ID: `realia:InnerRoom`); Door (ID: `realia:Door`); Cornerstone (ID: `realia:Cornerstone`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); jejuar (ID: `keyterm:Fast`); corpo (ID: `keyterm:Body.3`); céu (ID: `keyterm:Heaven`); Heavenly (ID: `keyterm:Heavenly`); Clothing (ID: `realia:Clothing`); Moth (ID: `fauna:Moth`); de pequena fé (ID: `keyterm:HavingLittleFaith`); coração (ID: `keyterm:Heart`); reino (ID: `keyterm:Kingdom`); be (or show oneself) just (ID: `keyterm:Just`); servir como escravo (ID: `keyterm:Serve.2`); Life (ID: `keyterm:Life`); anointed (ID: `keyterm:Anointed`); surely! (ID: `keyterm:Surely`); Salomão (ID: `person:Solomon`); Glory (ID: `keyterm:Glory`); love (ID: `keyterm:Love`); Oven (ID: `realia:Oven`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Barn (ID: `realia:Barn`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Beam (ID: `realia:Beam`); decidir (ID: `keyterm:Decided`); céu (ID: `keyterm:Heaven`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); lei (ID: `keyterm:Law`); holy (ID: `keyterm:Holy`); Snake (ID: `fauna:Snake`); Fish (ID: `fauna:Fish`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); Dog (ID: `fauna:Dog`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); sem lei (ID: `keyterm:Lawless`); wipe (out), destroy (ID: `keyterm:Destroy`); céu (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); speak (ID: `keyterm:Speak`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Clothing (ID: `realia:Clothing`); Wolf (ID: `fauna:Wolf`); Fig (ID: `flora:Fig`); Sheep (ID: `fauna:Lamb`); Vine (ID: `flora:Vine`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); autoridade (ID: `keyterm:Authority.2`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); To Cleanse (ID: `keyterm:Cleanse.2`); crer (ID: `keyterm:Believe`); reino (ID: `keyterm:Kingdom`); Israel (ID: `person:Israel`); House (ID: `realia:House`); estar endemoninhado (ID: `keyterm:DemonPossessed`); Centurion With Sick Servant (ID: `person:Centurion.2`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); testemunhar (ID: `keyterm:BearWitness`); offering (ID: `keyterm:Offering`); céu (ID: `keyterm:Heaven`); autoridade (ID: `keyterm:Authority.2`); rogar (ID: `keyterm:AskFor`); To Command (ID: `keyterm:Command`); Isaque (ID: `person:Isaac`); Outer Darkness (ID: `keyterm:OuterDarkness`); Abraão (ID: `person:Abraham`); Isaías (ID: `person:Isaiah`); prostrar, se (ID: `keyterm:BowDown`); Ability (ID: `keyterm:Ability`); Moisés (ID: `person:Moses`); Cafarnaum (ID: `place:Capernaum`); To Cause to Happen (ID: `keyterm:Happen`); surely! (ID: `keyterm:Surely`); Pedro (ID: `person:Peter`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); cobrador de impostos (ID: `keyterm:TaxCollector`); autoridade (ID: `keyterm:Authority.2`); Pharisees (ID: `group:Pharisee`); Ability (ID: `keyterm:Ability`); jejuar (ID: `keyterm:Fast`); Temple (ID: `realia:Temple`); Bed (ID: `realia:Bed`); misericórdia (ID: `keyterm:Mercy`); Mateus (ID: `person:Matthew`); coração (ID: `keyterm:Heart`); offering (ID: `keyterm:Offering`); blasfemar (ID: `keyterm:Blaspheme`); Be Healthy (ID: `keyterm:Healthy`); fear (ID: `keyterm:Fear`); be (or show oneself) just (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); ter bom ânimo (ID: `keyterm:CheerUp`); SENHOR (ID: `deity:Lord`); coletoria (ID: `keyterm:TaxOffice`); crer (ID: `keyterm:Believe`); Glory (ID: `keyterm:Glory`); João (ID: `person:John`); Patch (ID: `realia:Patch`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Ship (ID: `realia:Ship`); Skin-Bottle (ID: `realia:Skin-bottle`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Demons (ID: `deity:Demons`); salvation (ID: `keyterm:Salvation`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); Cloak (ID: `realia:Cloak`); compaixão (ID: `keyterm:Affection`); rogar (ID: `keyterm:AskFor`); estar endemoninhado (ID: `keyterm:DemonPossessed`); boa notícia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); Pharisees (ID: `group:Pharisee`); reino (ID: `keyterm:Kingdom`); Davi (ID: `person:David`); misericórdia (ID: `keyterm:Mercy`); prostrar, se (ID: `keyterm:BowDown`); ter bom ânimo (ID: `keyterm:CheerUp`); Life (ID: `keyterm:Life`); Bleed (ID: `keyterm:Bleed`); Israel (ID: `person:Israel`); servir (ID: `keyterm:Serve`); Tassel (ID: `realia:Tassel`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Goat (ID: `fauna:Goat`); Flute (ID: `realia:Flute`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); servir (ID: `keyterm:Serve`); Bag (ID: `realia:Bag`); Bartolomeu (ID: `person:Bartholomew`); Alfeu (ID: `person:Alphaeus`); fazer a paz (ID: `keyterm:Peace`); Judas (ID: `person:Judas.2`); Tomé (ID: `person:Thomas`); Judas (ID: `person:Judas`); Zelote (ID: `group:Zealot`); Tiago (ID: `person:James.2`); Simão (ID: `person:Simon.2`); Filipe (ID: `person:Philip`); To Cleanse (ID: `keyterm:Cleanse.2`); céu (ID: `keyterm:Heaven`); autoridade (ID: `keyterm:Authority.2`); Samaria (ID: `place:Samaria`); tribunal de justiça (ID: `keyterm:CourtCase`); João (ID: `person:John.2`); Zebedeu (ID: `person:Zebedee`); Samaritans (ID: `group:Samaritan`); proclamar (ID: `keyterm:Proclaim`); reino (ID: `keyterm:Kingdom`); André (ID: `person:Andrew`); Demons (ID: `deity:Demons`); Sodoma (ID: `place:Sodom`); Gomorra (ID: `place:Gomorrah`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Mateus (ID: `person:Matthew`); Gentiles (ID: `group:Gentile`); levantamento (ID: `keyterm:Resurrection`); cobrador de impostos (ID: `keyterm:TaxCollector`); Jesus (ID: `person:Jesus.2`); juízo (ID: `keyterm:Judgment`); surely! (ID: `keyterm:Surely`); Tiago (ID: `person:James`); Israel (ID: `person:Israel`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Staff (ID: `realia:Staff`); Belt (ID: `realia:Belt`); Sheep (ID: `fauna:Lamb`); Tunic (ID: `realia:Tunic.2`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Name (ID: `keyterm:Name`); ser discípulo (ID: `keyterm:Disciple`); céu (ID: `keyterm:Heaven`); surely! (ID: `keyterm:Surely`); Sparrow (ID: `fauna:Sparrow`); geena (ID: `keyterm:Gehenna`); testemunhar (ID: `keyterm:BearWitness`); To Command (ID: `keyterm:Command`); amizade (ID: `keyterm:Friendship`); proclamar (ID: `keyterm:Proclaim`); fazer a paz (ID: `keyterm:Peace`); be (or show oneself) just (ID: `keyterm:Just`); Hell (ID: `place:Hell`); Satanás (ID: `deity:Satan`); Gentiles (ID: `group:Gentile`); corpo (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); Holy Spirit (ID: `deity:HolySpirit`); salvation (ID: `keyterm:Salvation`); Israel (ID: `person:Israel`); Wolf (ID: `fauna:Wolf`); Assarion (ID: `realia:Assarion`); Snake (ID: `fauna:Snake`); Cross (ID: `realia:Cross`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Dove (ID: `fauna:Dove`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** João (ID: `person:John`); Jesus (ID: `person:Jesus.2`); batista (ID: `keyterm:Baptist`); céu (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); ser discípulo (ID: `keyterm:Disciple`); To Cleanse (ID: `keyterm:Cleanse.2`); bem, aventurado (ID: `keyterm:Happy`); boa notícia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); Elias (ID: `person:Elijah`); Demons (ID: `deity:Demons`); be (or show oneself) just (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); lei (ID: `keyterm:Law`); levantamento (ID: `keyterm:Resurrection`); cobrador de impostos (ID: `keyterm:TaxCollector`); speak (ID: `keyterm:Speak`); surely! (ID: `keyterm:Surely`); Reed (ID: `flora:Reed`); Prison (ID: `realia:Prison`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Flute (ID: `realia:Flute`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); céu (ID: `keyterm:Heaven`); arrepender, se (ID: `keyterm:Repent`); tribunal de justiça (ID: `keyterm:CourtCase`); Sodoma (ID: `place:Sodom`); Sidom (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); juízo (ID: `keyterm:Judgment`); Yoke (ID: `realia:Yoke`); Corazim (ID: `place:Chorazin`); Disaster (ID: `keyterm:Disaster`); World of the Dead (ID: `keyterm:WorldOfTheDead`); coração (ID: `keyterm:Heart`); Betsaida (ID: `place:Bethsaida`); Hell (ID: `place:Hell`); Cafarnaum (ID: `place:Capernaum`); Good (ID: `keyterm:Good`); Jesus (ID: `person:Jesus.2`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** sabbath (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); Temple (ID: `realia:Temple`); Pharisees (ID: `group:Pharisee`); ser discípulo (ID: `keyterm:Disciple`); Sheep (ID: `fauna:Lamb`); offering (ID: `keyterm:Offering`); Davi (ID: `person:David`); Jesus (ID: `person:Jesus.2`); condenar (ID: `keyterm:Condemn`); SENHOR (ID: `deity:Lord`); misericórdia (ID: `keyterm:Mercy`); defilement (ID: `keyterm:Defilement`); lei (ID: `keyterm:Law`); Wheat (ID: `flora:Wheat`); House (ID: `realia:House`); Grain (ID: `flora:Grain`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** juízo (ID: `keyterm:Judgment`); Gentiles (ID: `group:Gentile`); Name (ID: `keyterm:Name`); To Cause to Happen (ID: `keyterm:Happen`); Holy Spirit (ID: `deity:HolySpirit`); Jesus (ID: `person:Jesus.2`); To Command (ID: `keyterm:Command`); amado (ID: `keyterm:Beloved`); Isaías (ID: `person:Isaiah`); hope (ID: `keyterm:Hope`); servir (ID: `keyterm:Serve`); Lamp (ID: `realia:Lamp`); Reed (ID: `flora:Reed`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); Satanás (ID: `deity:Satan`); Holy Spirit (ID: `deity:HolySpirit`); forgive (ID: `keyterm:Forgive`); Good (ID: `keyterm:Good`); blasfemar (ID: `keyterm:Blaspheme`); condenar (ID: `keyterm:Condemn`); juízo (ID: `keyterm:Judgment`); coração (ID: `keyterm:Heart`); inútil (ID: `keyterm:Idle`); estar endemoninhado (ID: `keyterm:DemonPossessed`); tribunal de justiça (ID: `keyterm:CourtCase`); Pharisees (ID: `group:Pharisee`); Davi (ID: `person:David`); para a eternidade (ID: `keyterm:Always`); palavra (ID: `keyterm:Word`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); servir (ID: `keyterm:Serve`); House (ID: `realia:House`); Snake (ID: `fauna:Snake`); Cobra (ID: `fauna:Cobra`)
...
* **Associated ACAI Concepts:** Jonas (ID: `person:Jonah.2`); example (ID: `keyterm:Example`); tribunal de justiça (ID: `keyterm:CourtCase`); juízo (ID: `keyterm:Judgment`); Rainha de Sabá (ID: `person:QueenOfSheba`); Nínive (ID: `group:Nineveh`); coração (ID: `keyterm:Heart`); céu (ID: `keyterm:Heaven`); arrepender, se (ID: `keyterm:Repent`); proclamar (ID: `keyterm:Proclaim`); be unfaithful (ID: `keyterm:Unfaithful`); Nínive (ID: `place:Nineveh`); Pharisees (ID: `group:Pharisee`); A Group of People (ID: `group:GenericGroup`); SENHOR (ID: `deity:Lord`); Salomão (ID: `person:Solomon`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** parábola (ID: `keyterm:Parable`); coração (ID: `keyterm:Heart`); reino (ID: `keyterm:Kingdom`); Brier (ID: `flora:Brier`); Thistle (ID: `flora:Thistle`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); céu (ID: `keyterm:Heaven`); bem, aventurado (ID: `keyterm:Happy`); A Group of Disciples (ID: `group:GenericDisciples`); be (or show oneself) just (ID: `keyterm:Just`); Isaías (ID: `person:Isaiah`); para a eternidade (ID: `keyterm:Always`); Ability (ID: `keyterm:Ability`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Jesus (ID: `person:Jesus.2`); surely! (ID: `keyterm:Surely`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); Bird (ID: `fauna:Bird`); Ship (ID: `realia:Ship`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); céu (ID: `keyterm:Heaven`); parábola (ID: `keyterm:Parable`); Weed (ID: `flora:Weed`); Grain (ID: `flora:Grain`); An Angel (ID: `deity:Angel`); para a eternidade (ID: `keyterm:Always`); Wheat (ID: `flora:Wheat`); be (or show oneself) just (ID: `keyterm:Just`); ser discípulo (ID: `keyterm:Disciple`); Kiln (ID: `realia:Kiln`); Grass (ID: `flora:Grass`); sem lei (ID: `keyterm:Lawless`); escândalo (ID: `keyterm:StumblingBlock`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); To Cause to Happen (ID: `keyterm:Happen`); Jesus (ID: `person:Jesus.2`); Dragnet (ID: `realia:Dragnet`); Saton (ID: `realia:Saton`); Mustard (ID: `flora:Mustard`); Storeroom (ID: `realia:Storeroom`); House (ID: `realia:House`); Barn (ID: `realia:Barn`); Container (ID: `realia:Container`)
...
* **Associated ACAI Concepts:** João (ID: `person:John`); Jesus (ID: `person:Jesus.2`); Herodes Antipas (ID: `person:Herod.2`); Ability (ID: `keyterm:Ability`); Herodias (ID: `person:Herodias`); Oath (ID: `keyterm:Oath`); batista (ID: `keyterm:Baptist`); Prison (ID: `realia:Prison`); Plate (ID: `realia:Plate.2`); Judas (ID: `person:Jude`); Simão (ID: `person:Simon.3`); não crer (ID: `keyterm:Disbelieve`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Tiago (ID: `person:James.3`); Filipe (ID: `person:Philip.2`); fear (ID: `keyterm:Fear`); Be Lawful (ID: `keyterm:Lawful`); Maria (ID: `person:Mary`); José (ID: `person:Joseph.4`); levantamento (ID: `keyterm:Resurrection`); parábola (ID: `keyterm:Parable`); ser discípulo (ID: `keyterm:Disciple`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Fish (ID: `fauna:Fish`); compaixão (ID: `keyterm:Affection`); céu (ID: `keyterm:Heaven`); bless (ID: `keyterm:Bless`); servir (ID: `keyterm:Serve`); Basket (ID: `realia:Basket`); Ship (ID: `realia:Ship`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); fear (ID: `keyterm:Fear`); Jesus (ID: `person:Jesus.2`); salvation (ID: `keyterm:Salvation`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); de pequena fé (ID: `keyterm:HavingLittleFaith`); Genesaré (ID: `place:Gennesaret`); ter bom ânimo (ID: `keyterm:CheerUp`); prostrar, se (ID: `keyterm:BowDown`); rogar (ID: `keyterm:AskFor`); verdadeiro (ID: `keyterm:True`); orar (ID: `keyterm:Pray`); Tassel (ID: `realia:Tassel`); Stade (ID: `realia:Stade`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); tradição (ID: `keyterm:Teaching`); coração (ID: `keyterm:Heart`); defilement (ID: `keyterm:Defilement`); Pharisees (ID: `group:Pharisee`); ser discípulo (ID: `keyterm:Disciple`); offering (ID: `keyterm:Offering`); blasfemar (ID: `keyterm:Blaspheme`); adorar (ID: `keyterm:Worship`); A Group of Disciples (ID: `group:GenericDisciples`); Commandment (ID: `keyterm:Commandment`); Isaías (ID: `person:Isaiah`); Jerusalém (ID: `place:Jerusalem`); Heavenly (ID: `keyterm:Heavenly`); fornication (ID: `keyterm:Fornication`); parábola (ID: `keyterm:Parable`); Jesus (ID: `person:Jesus.2`); speak (ID: `keyterm:Speak`); Pedro (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Dog (ID: `fauna:Dog`); Tiro (ID: `place:Tyre`); Syrophonecian Woman (ID: `person:SyrophonecianWoman`); Sidom (ID: `place:Sidon`); crer (ID: `keyterm:Believe`); bom (ID: `keyterm:Honest`); prostrar, se (ID: `keyterm:BowDown`); rogar (ID: `keyterm:AskFor`); Davi (ID: `person:David`); estar endemoninhado (ID: `keyterm:DemonPossessed`); cananeu (ID: `group:Canaan`); Israel (ID: `person:Israel`); misericórdia (ID: `keyterm:Mercy`); ser discípulo (ID: `keyterm:Disciple`); Canaã (ID: `place:Canaan`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Fish (ID: `fauna:Fish`); Magadã (ID: `place:Magadan`); compaixão (ID: `keyterm:Affection`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); Glory (ID: `keyterm:Glory`); Sea of Galilee (ID: `place:GalileeSea`); servir (ID: `keyterm:Serve`); Ship (ID: `realia:Ship`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Sadducees (ID: `group:Sadducee`); Pharisees (ID: `group:Pharisee`); céu (ID: `keyterm:Heaven`); example (ID: `keyterm:Example`); Jesus (ID: `person:Jesus.2`); Basket (ID: `realia:Basket`); de pequena fé (ID: `keyterm:HavingLittleFaith`); distinguir (ID: `keyterm:Discern`); ser discípulo (ID: `keyterm:Disciple`); Jonas (ID: `person:Jonah.2`); be unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); céu (ID: `keyterm:Heaven`); Cesareia de Filipos (ID: `place:CaesareaPhilippi`); igreja (ID: `keyterm:Church`); rogar (ID: `keyterm:AskFor`); To Command (ID: `keyterm:Command`); bem, aventurado (ID: `keyterm:Happy`); A Group of Disciples (ID: `group:GenericDisciples`); Elias (ID: `person:Elijah`); reino (ID: `keyterm:Kingdom`); pensar (ID: `keyterm:Think`); João (ID: `person:John.4`); An Angel (ID: `deity:Angel`); Jerusalém (ID: `place:Jerusalem`); escândalo (ID: `keyterm:StumblingBlock`); batista (ID: `keyterm:Baptist`); Hell (ID: `place:Hell`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Satanás (ID: `deity:Satan`); Ability (ID: `keyterm:Ability`); corpo (ID: `keyterm:Body.3`); sangue (ID: `keyterm:Blood`); levantamento (ID: `keyterm:Resurrection`); Jeremias (ID: `person:Jeremiah.6`); salvation (ID: `keyterm:Salvation`); Glory (ID: `keyterm:Glory`); João (ID: `person:John`); Key (ID: `realia:Key`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Elias (ID: `person:Elijah`); Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); fear (ID: `keyterm:Fear`); Moisés (ID: `person:Moses`); Pedro (ID: `person:Peter`); levantamento (ID: `keyterm:Resurrection`); batista (ID: `keyterm:Baptist`); reino (ID: `keyterm:Kingdom`); To Command (ID: `keyterm:Command`); surely! (ID: `keyterm:Surely`); amado (ID: `keyterm:Beloved`); Tiago (ID: `person:James`); João (ID: `person:John.2`); João (ID: `person:John`); Clothing (ID: `realia:Clothing`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); servir (ID: `keyterm:Serve`); To Command (ID: `keyterm:Command`); be unfaithful (ID: `keyterm:Unfaithful`); A Group of Disciples (ID: `group:GenericDisciples`); tributo (ID: `keyterm:Tax`); Demons (ID: `deity:Demons`); misericórdia (ID: `keyterm:Mercy`); Galileia (ID: `place:Galilee`); levantamento (ID: `keyterm:Resurrection`); crer (ID: `keyterm:Believe`); Cafarnaum (ID: `place:Capernaum`); tributo (ID: `keyterm:PollTax`); surely! (ID: `keyterm:Surely`); Mustard (ID: `flora:Mustard`); Stater (ID: `realia:Stater`); Fishhook (ID: `realia:Fishhook`); Two-Drachma Piece (ID: `realia:Two-drachmaPiece`); House (ID: `realia:House`); Fish (ID: `fauna:Fish`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); fazer tropeçar (ID: `keyterm:CauseToStumble`); reino (ID: `keyterm:Kingdom`); Life (ID: `keyterm:Life`); escândalo (ID: `keyterm:StumblingBlock`); Disaster (ID: `keyterm:Disaster`); An Angel (ID: `deity:Angel`); para a eternidade (ID: `keyterm:Always`); Name (ID: `keyterm:Name`); Hell (ID: `place:Hell`); Ability (ID: `keyterm:Ability`); fogo eterno (ID: `keyterm:EternalFire`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); geena (ID: `keyterm:Gehenna`); Jesus (ID: `person:Jesus.2`); surely! (ID: `keyterm:Surely`); ser discípulo (ID: `keyterm:Disciple`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** forgive (ID: `keyterm:Forgive`); ter dívida para com alguém (ID: `keyterm:Owe`); céu (ID: `keyterm:Heaven`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); surely! (ID: `keyterm:Surely`); witness (ID: `keyterm:Witness`); coração (ID: `keyterm:Heart`); reino (ID: `keyterm:Kingdom`); misericórdia (ID: `keyterm:Mercy`); Name (ID: `keyterm:Name`); compaixão (ID: `keyterm:Affection`); prostrar, se (ID: `keyterm:BowDown`); Heavenly (ID: `keyterm:Heavenly`); cobrador de impostos (ID: `keyterm:TaxCollector`); Jesus (ID: `person:Jesus.2`); igreja (ID: `keyterm:Church`); dívida (ID: `keyterm:Debt`); Pedro (ID: `person:Peter`); palavra (ID: `keyterm:Word`); Prison (ID: `realia:Prison`); Denarius (ID: `realia:Denarius`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); To Command (ID: `keyterm:Command`); reino (ID: `keyterm:Kingdom`); Moisés (ID: `person:Moses`); corpo (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Judeia (ID: `place:Judea`); Pharisees (ID: `group:Pharisee`); dureza de coração (ID: `keyterm:Hardheartedness`); Be Lawful (ID: `keyterm:Lawful`); Galileia (ID: `place:Galilee`); SENHOR (ID: `deity:Lord`); fornication (ID: `keyterm:Fornication`); orar (ID: `keyterm:Pray`); Jordan River (ID: `place:Jordan`); servir (ID: `keyterm:Serve`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); céu (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); Rich Young Ruler (ID: `person:RichYoungRuler`); para a eternidade (ID: `keyterm:Always`); SENHOR (ID: `deity:Lord`); Good (ID: `keyterm:Good`); surely! (ID: `keyterm:Surely`); ser discípulo (ID: `keyterm:Disciple`); rogar (ID: `keyterm:AskFor`); regeneração (ID: `keyterm:NewWorld`); Commandment (ID: `keyterm:Commandment`); decidir (ID: `keyterm:Decided`); Name (ID: `keyterm:Name`); fornication (ID: `keyterm:Fornication`); salvation (ID: `keyterm:Salvation`); Israel (ID: `person:Israel`); Pedro (ID: `person:Peter`); Glory (ID: `keyterm:Glory`); love (ID: `keyterm:Love`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`); House (ID: `realia:House`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Denarius (ID: `realia:Denarius`); inútil (ID: `keyterm:Idle`); to act wickedly (ID: `keyterm:ActWickedly`); céu (ID: `keyterm:Heaven`); Good (ID: `keyterm:Good`); reino (ID: `keyterm:Kingdom`); be (or show oneself) just (ID: `keyterm:Just`); Be Lawful (ID: `keyterm:Lawful`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Jerusalém (ID: `place:Jerusalem`); To Command (ID: `keyterm:Command`); Davi (ID: `person:David`); misericórdia (ID: `keyterm:Mercy`); servir (ID: `keyterm:Serve`); autoridade (ID: `keyterm:Authority.2`); Zebedeu (ID: `person:Zebedee`); reino (ID: `keyterm:Kingdom`); Jericó (ID: `place:Jericho`); compaixão (ID: `keyterm:Affection`); prostrar, se (ID: `keyterm:BowDown`); condenar (ID: `keyterm:Condemn`); SENHOR (ID: `deity:Lord`); Gentiles (ID: `group:Gentile`); Life (ID: `keyterm:Life`); levantamento (ID: `keyterm:Resurrection`); resgate (ID: `keyterm:Ransom`); ser discípulo (ID: `keyterm:Disciple`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Jerusalém (ID: `place:Jerusalem`); Donkey (ID: `fauna:Donkey`); hosana (ID: `keyterm:Hosanna`); Davi (ID: `person:David`); ser discípulo (ID: `keyterm:Disciple`); Clothing (ID: `realia:Clothing`); Betfagé (ID: `place:Bethphage`); To Command (ID: `keyterm:Command`); bless (ID: `keyterm:Bless`); Nazaré (ID: `place:Nazareth`); Galileia (ID: `place:Galilee`); Name (ID: `keyterm:Name`); Betânia (ID: `place:Bethany`); A Group of People (ID: `group:GenericGroup`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); To Cause to Happen (ID: `keyterm:Happen`); altura (ID: `keyterm:Height`); servir (ID: `keyterm:Serve`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); autoridade (ID: `keyterm:Authority.2`); Jesus (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); Fig (ID: `flora:Fig`); João (ID: `person:John`); batismo (ID: `keyterm:Baptism`); céu (ID: `keyterm:Heaven`); rogar (ID: `keyterm:AskFor`); fear (ID: `keyterm:Fear`); surely! (ID: `keyterm:Surely`); para a eternidade (ID: `keyterm:Always`); orar (ID: `keyterm:Pray`); distinguir (ID: `keyterm:Discern`); ser discípulo (ID: `keyterm:Disciple`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); SENHOR (ID: `deity:Lord`); cobrador de impostos (ID: `keyterm:TaxCollector`); arrepender, se (ID: `keyterm:Repent`); reino (ID: `keyterm:Kingdom`); parábola (ID: `keyterm:Parable`); Jesus (ID: `person:Jesus.2`); rejeitar (ID: `keyterm:Reject`); escritura (ID: `keyterm:Scripture`); Pharisees (ID: `group:Pharisee`); fear (ID: `keyterm:Fear`); be (or show oneself) just (ID: `keyterm:Just`); crer (ID: `keyterm:Believe`); surely! (ID: `keyterm:Surely`); João (ID: `person:John`); Winepress (ID: `realia:Winepress`); Cornerstone (ID: `realia:Cornerstone`); Tower (ID: `realia:Tower`); Watch-Tower (ID: `realia:Watch-tower`); Thorn Hedge (ID: `realia:ThornHedge`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); céu (ID: `keyterm:Heaven`); Good (ID: `keyterm:Good`); reino (ID: `keyterm:Kingdom`); parábola (ID: `keyterm:Parable`); Jesus (ID: `person:Jesus.2`); To Command (ID: `keyterm:Command`); escolhido (ID: `keyterm:Chosen`); Outer Darkness (ID: `keyterm:OuterDarkness`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); levantamento (ID: `keyterm:Resurrection`); Tibério (ID: `person:Tiberius`); Jesus (ID: `person:Jesus.2`); tributo (ID: `keyterm:PollTax`); Herodians (ID: `group:Herodian`); Sadducees (ID: `group:Sadducee`); Israel (ID: `person:Israel`); escritura (ID: `keyterm:Scripture`); céu (ID: `keyterm:Heaven`); verdadeiro (ID: `keyterm:True`); Isaque (ID: `person:Isaac`); Abraão (ID: `person:Abraham`); Pharisees (ID: `group:Pharisee`); An Angel (ID: `deity:Angel`); Be Lawful (ID: `keyterm:Lawful`); The Way (ID: `keyterm:TheWay`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); Moisés (ID: `person:Moses`); Life (ID: `keyterm:Life`); ser discípulo (ID: `keyterm:Disciple`); Money (ID: `realia:Money`); Denarius (ID: `realia:Denarius`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Commandment (ID: `keyterm:Commandment`); Davi (ID: `person:David`); Pharisees (ID: `group:Pharisee`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); lei (ID: `keyterm:Law`); coração (ID: `keyterm:Heart`); mente (ID: `keyterm:Mind.2`); Holy Spirit (ID: `deity:HolySpirit`); Sadducees (ID: `group:Sadducee`)
...
* **Associated ACAI Concepts:** Pharisees (ID: `group:Pharisee`); Disaster (ID: `keyterm:Disaster`); Temple (ID: `realia:Temple`); be (or show oneself) just (ID: `keyterm:Just`); SENHOR (ID: `deity:Lord`); geena (ID: `keyterm:Gehenna`); To Cleanse (ID: `keyterm:Cleanse.2`); offering (ID: `keyterm:Offering`); céu (ID: `keyterm:Heaven`); dever (ID: `keyterm:Ought`); sangue (ID: `keyterm:Blood`); consecration (ID: `keyterm:Consecration.2`); Jesus (ID: `person:Jesus.2`); juízo (ID: `keyterm:Judgment`); hipocrisia (ID: `keyterm:Hypocrisy`); Jeoiada (ID: `person:Jehoiada.2`); Zacarias (ID: `person:Zechariah.12`); limpo (ID: `keyterm:Clean`); Synagogue (ID: `realia:Synagogue`); Grave (ID: `realia:Grave`); testemunhar (ID: `keyterm:BearWitness`); tribunal de justiça (ID: `keyterm:CourtCase`); amizade (ID: `keyterm:Friendship`); bless (ID: `keyterm:Bless`); reino (ID: `keyterm:Kingdom`); misericórdia (ID: `keyterm:Mercy`); Jerusalém (ID: `place:Jerusalem`); sem lei (ID: `keyterm:Lawless`); Abel (ID: `person:Abel`); Name (ID: `keyterm:Name`); Hell (ID: `place:Hell`); Heavenly (ID: `keyterm:Heavenly`); Moisés (ID: `person:Moses`); defilement (ID: `keyterm:Defilement`); lei (ID: `keyterm:Law`); crer (ID: `keyterm:Believe`); surely! (ID: `keyterm:Surely`); ser discípulo (ID: `keyterm:Disciple`); Dill (ID: `flora:Dill`); Mint (ID: `flora:Mint`); Phylactery (ID: `realia:Phylactery`); Mosquito (ID: `fauna:Mosquito`); Plate (ID: `realia:Plate.2`); Cumin (ID: `flora:Cumin`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Snake (ID: `fauna:Snake`); Tassel (ID: `realia:Tassel`); Cross (ID: `realia:Cross`); Camel (ID: `fauna:Camel`); Bird (ID: `fauna:Bird`); Throne (ID: `realia:Throne`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); reino (ID: `keyterm:Kingdom`); ser discípulo (ID: `keyterm:Disciple`); testemunhar (ID: `keyterm:BearWitness`); salvation (ID: `keyterm:Salvation`); Ability (ID: `keyterm:Ability`); sem lei (ID: `keyterm:Lawless`); surely! (ID: `keyterm:Surely`); para a eternidade (ID: `keyterm:Always`); example (ID: `keyterm:Example`); boa notícia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); love (ID: `keyterm:Love`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); escolhido (ID: `keyterm:Chosen`); Noé (ID: `person:Noah`); example (ID: `keyterm:Example`); An Angel (ID: `deity:Angel`); Ability (ID: `keyterm:Ability`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); surely! (ID: `keyterm:Surely`); Faithfulness (ID: `keyterm:Faithfulness`); Daniel (ID: `person:Daniel.3`); House (ID: `realia:House`); coração (ID: `keyterm:Heart`); maravilha (ID: `keyterm:Portent`); o detestável da desolação (ID: `keyterm:AbominationOfDesolation`); bem, aventurado (ID: `keyterm:Happy`); Judeia (ID: `place:Judea`); Disaster (ID: `keyterm:Disaster`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); orar (ID: `keyterm:Pray`); salvation (ID: `keyterm:Salvation`); parábola (ID: `keyterm:Parable`); sabbath (ID: `keyterm:Sabbath`); holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); Vulture (ID: `fauna:Vulture`); Inner Room (ID: `realia:InnerRoom`); Trumpet (ID: `realia:Trumpet`); Housetop (ID: `realia:Housetop`); Door (ID: `realia:Door`); Fig (ID: `flora:Fig`); Tabernacle (ID: `realia:Tabernacle`); Cloak (ID: `realia:Cloak`); Hand-Mill (ID: `realia:Hand-mill`); Boat (ID: `realia:Boat`)
...
* **Associated ACAI Concepts:** Lamp (ID: `realia:Lamp`); Olive Oil (ID: `realia:OliveOil`); céu (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); surely! (ID: `keyterm:Surely`); Container (ID: `realia:Container`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** Prison (ID: `realia:Prison`); be (or show oneself) just (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); para a eternidade (ID: `keyterm:Always`); Jesus (ID: `person:Jesus.2`); surely! (ID: `keyterm:Surely`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Kid (ID: `fauna:Kid`); bless (ID: `keyterm:Bless`); reino (ID: `keyterm:Kingdom`); fogo eterno (ID: `keyterm:EternalFire`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Glory (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Simão (ID: `person:Simon.4`); Betânia (ID: `place:Bethany`); Judas (ID: `person:Judas.2`); passover (ID: `keyterm:Passover`); Ability (ID: `keyterm:Ability`); surely! (ID: `keyterm:Surely`); Caifás (ID: `person:Caiaphas`); corpo (ID: `keyterm:Body.3`); boa notícia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); Alabaster Jar (ID: `realia:AlabasterJar`); House (ID: `realia:House`); Courtyard (ID: `realia:Courtyard`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); passover (ID: `keyterm:Passover`); sangue (ID: `keyterm:Blood`); corpo (ID: `keyterm:Body.3`); reino (ID: `keyterm:Kingdom`); forgive (ID: `keyterm:Forgive`); Judas (ID: `person:Judas.2`); To Sin (ID: `keyterm:Sin`); surely! (ID: `keyterm:Surely`); Disaster (ID: `keyterm:Disaster`); SENHOR (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); bless (ID: `keyterm:Bless`); Vine (ID: `flora:Vine`); Bowl (ID: `realia:Bowl.2`); Olive Tree (ID: `flora:OliveTree`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Getsêmani (ID: `place:Gethsemane`); Spirit (ID: `keyterm:Spirit.2`); levantamento (ID: `keyterm:Resurrection`); Zebedeu (ID: `person:Zebedee`); tentar (ID: `keyterm:PutToTheTest`); surely! (ID: `keyterm:Surely`); corpo (ID: `keyterm:Body.3`); Galileia (ID: `place:Galilee`); Rooster (ID: `fauna:Rooster`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Olive Tree (ID: `flora:OliveTree`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); To Cause to Happen (ID: `keyterm:Happen`); escritura (ID: `keyterm:Scripture`); rogar (ID: `keyterm:AskFor`); Judas (ID: `person:Judas.2`); SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); example (ID: `keyterm:Example`); ser discípulo (ID: `keyterm:Disciple`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Caifás (ID: `person:Caiaphas`); céu (ID: `keyterm:Heaven`); blasfemar (ID: `keyterm:Blaspheme`); witness (ID: `keyterm:Witness`); speak (ID: `keyterm:Speak`); Ability (ID: `keyterm:Ability`); Pedro (ID: `person:Peter`); Life (ID: `keyterm:Life`); Courtyard (ID: `realia:Courtyard`); Temple (ID: `realia:Temple`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Pedro (ID: `person:Peter`); Rooster (ID: `fauna:Rooster`); Oath (ID: `keyterm:Oath`); A Group of People (ID: `group:GenericGroup`); Galileans (ID: `group:Galilee`); verdadeiro (ID: `keyterm:True`); Nazaré (ID: `place:Nazareth`); Galileia (ID: `place:Galilee`); A Servant (ID: `person:GenericServant`); palavra (ID: `keyterm:Word`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Akeldama (ID: `place:Akeldama`); sangue (ID: `keyterm:Blood`); Pilatos (ID: `person:Pilate`); Tesouro do templo (ID: `place:Corban`); Priests (ID: `group:GenericPriests`); Jeremias (ID: `person:Jeremiah.6`); To Cause to Happen (ID: `keyterm:Happen`); Jesus (ID: `person:Jesus.2`); Judas (ID: `person:Judas.2`); To Sin (ID: `keyterm:Sin`); condenar (ID: `keyterm:Condemn`); SENHOR (ID: `deity:Lord`); arrepender, se (ID: `keyterm:Repent`); Israel (ID: `person:Israel`); Be Lawful (ID: `keyterm:Lawful`); Temple (ID: `realia:Temple`); Treasury (ID: `realia:Treasury`)
...
* **Associated ACAI Concepts:** Barrabás (ID: `person:Barabbas`); Jesus (ID: `person:Jesus.2`); Pilatos (ID: `person:Pilate`); A Group of People (ID: `group:GenericGroup`); Cross (ID: `realia:Cross`); sangue (ID: `keyterm:Blood`); Jews (ID: `group:Jews`); be (or show oneself) just (ID: `keyterm:Just`); persuadir (ID: `keyterm:Persuade`); palavra (ID: `keyterm:Word`); Judgment Seat (ID: `realia:JudgmentSeat`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); salvation (ID: `keyterm:Salvation`); Jesus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Clothing (ID: `realia:Clothing`); Reed (ID: `flora:Reed`); Cloak (ID: `realia:Cloak`); Cirene (ID: `place:Cyrene`); Simão (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); coração (ID: `keyterm:Heart`); blasfemar (ID: `keyterm:Blaspheme`); persuadir (ID: `keyterm:Persuade`); Name (ID: `keyterm:Name`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Israel (ID: `person:Israel`); livrar (ID: `keyterm:Deliver`); Crown (ID: `realia:Crown.2`); Brier (ID: `flora:Brier`); Wine (ID: `realia:Wine`); Acacia (ID: `flora:Acacia`); Crown (ID: `realia:Crown`); Temple (ID: `realia:Temple`); Palace (ID: `realia:Palace`); Boxthorn (ID: `flora:Boxthorn`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Grave (ID: `realia:Grave`); levantamento (ID: `keyterm:Resurrection`); Pilatos (ID: `person:Pilate`); corpo (ID: `keyterm:Body.3`); José (ID: `person:Joseph.6`); Maria Madalena (ID: `person:Marymagdalene`); Maria (ID: `person:Mary.2`); Elias (ID: `person:Elijah`); A Group of People (ID: `group:GenericGroup`); holy (ID: `keyterm:Holy`); ser discípulo (ID: `keyterm:Disciple`); Zebedeu (ID: `person:Zebedee`); Tiago (ID: `person:James.4`); Arimateia (ID: `place:Arimathea`); José (ID: `person:Joseph.5`); verdadeiro (ID: `keyterm:True`); Pharisees (ID: `group:Pharisee`); fear (ID: `keyterm:Fear`); Galileia (ID: `place:Galilee`); Name (ID: `keyterm:Name`); SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); limpo (ID: `keyterm:Clean`); salvation (ID: `keyterm:Salvation`); Spirit (ID: `keyterm:Spirit.2`); servir (ID: `keyterm:Serve`); Seal (ID: `realia:Seal`); Sour Wine (ID: `realia:SourWine`); Reed (ID: `flora:Reed`); Curtain (ID: `realia:Curtain`); Temple (ID: `realia:Temple`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** fear (ID: `keyterm:Fear`); Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); levantamento (ID: `keyterm:Resurrection`); An Angel (ID: `deity:Angel`); Galileia (ID: `place:Galilee`); Grave (ID: `realia:Grave`); Angels (ID: `group:Angels`); Week (ID: `keyterm:Week`); céu (ID: `keyterm:Heaven`); persuadir (ID: `keyterm:Persuade`); prostrar, se (ID: `keyterm:BowDown`); SENHOR (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); sabbath (ID: `keyterm:Sabbath`); Jews (ID: `group:Jews`); Maria Madalena (ID: `person:Marymagdalene`); Maria (ID: `person:Mary.2`); Clothing (ID: `realia:Clothing`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Jesus (ID: `person:Jesus.2`); autoridade (ID: `keyterm:Authority.2`); Name (ID: `keyterm:Name`); batismo (ID: `keyterm:Baptism`); céu (ID: `keyterm:Heaven`); Holy Spirit (ID: `deity:HolySpirit`); prostrar, se (ID: `keyterm:BowDown`); Ability (ID: `keyterm:Ability`); To Command (ID: `keyterm:Command`); SENHOR (ID: `deity:Lord`); para a eternidade (ID: `keyterm:Always`); Galileia (ID: `place:Galilee`)
