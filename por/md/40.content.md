...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Davi (ID: `person:David`); Babilônia (ID: `place:Babylon`); Abraão (ID: `person:Abraham`); Jacó (ID: `person:Jacob.2`); Azor (ID: `person:Azor`); Zorobabel (ID: `person:Zerubbabel.2`); Eliúde (ID: `person:Eliud`); Salmom (ID: `person:Salmon`); Ezequias (ID: `person:Hezekiah`); Jeoaquim (ID: `person:Jehoiachin`); Salomão (ID: `person:Solomon`); Ram (ID: `person:Ram`); Asa (ID: `person:Asa`); Uzias (ID: `person:Uzziah`); Josias (ID: `person:Josiah`); Judá (ID: `person:Judah.4`); Jessé (ID: `person:Jesse`); Abias (ID: `person:Abijah.4`); Raabe (ID: `person:Rahab`); Perez (ID: `person:Perez`); Urias (ID: `person:Uriah`); Zerá (ID: `person:Zerah.3`); Hezrom (ID: `person:Hezron.2`); Zadoque (ID: `person:Zadok`); Tamar (ID: `person:Tamar`); Josafá (ID: `person:Jehoshaphat.3`); Jeorão (ID: `person:Jehoram`); Eleazar (ID: `person:Eleazar`); José (ID: `person:Joseph.4`); Boaz (ID: `person:Boaz`); Naassom (ID: `person:Nahshon`); Roboão (ID: `person:Rehoboam`); Acaz (ID: `person:Ahaz`); Aquim (ID: `person:Achim`); Eliaquim (ID: `person:Eliakim`); Aminadabe (ID: `person:Amminadab`); Amon (ID: `person:Amon.3`); Israel (ID: `person:Israel`); Jotão (ID: `person:Jotham.2`); Abiúde (ID: `person:Abiud`); Obede (ID: `person:Obed`); Isaque (ID: `person:Isaac`); Matã (ID: `person:Matthan`); Sealtiel (ID: `person:Shealtiel.2`); Maria (ID: `person:Mary`); Manassés (ID: `person:Manasseh.2`); Rute (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); José (ID: `person:Joseph.4`); SENHOR (ID: `deity:Lord`); Name (ID: `keyterm:Name`); Maria (ID: `person:Mary`); An Angel (ID: `deity:Angel`); Holy Spirit (ID: `deity:HolySpirit`); To Cause to Happen (ID: `keyterm:Happen`); ter casamento contratado (ID: `keyterm:Engaged`); salvation (ID: `keyterm:Salvation`); To Sin (ID: `keyterm:Sin`); fear (ID: `keyterm:Fear`); be (or show oneself) just (ID: `keyterm:Just`); Davi (ID: `person:David`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod`); Belém (ID: `place:Bethlehem`); Egito (ID: `place:Egypt`); prostrar, se (ID: `keyterm:BowDown`); SENHOR (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); Judeia (ID: `place:Judea`); Israel (ID: `person:Israel`); José (ID: `person:Joseph.4`); Jerusalém (ID: `place:Jerusalem`); Jesus (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); Jeremias (ID: `person:Jeremiah.6`); Arquelau (ID: `person:Archelaus`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Nazaré (ID: `place:Nazareth`); Raquel (ID: `person:Rachel`); Life (ID: `keyterm:Life`); exortar (ID: `keyterm:Encourage`); Judá (ID: `person:Judah.4`); Galileia (ID: `place:Galilee`); A Priest (ID: `person:GenericPriest`); offering (ID: `keyterm:Offering`); Maria (ID: `person:Mary`); Priests (ID: `group:GenericPriests`); fear (ID: `keyterm:Fear`); rogar (ID: `keyterm:AskFor`); Ramah (ID: `place:Ramah.2`); Jews (ID: `group:Jews`); Religious Officials (ID: `group:ReligiousOfficials`); Myrrh (ID: `flora:Myrrh`); Frankincense (ID: `flora:Frankincense`); Money Box (ID: `realia:MoneyBox`); Myrrh (ID: `realia:Myrrh`); Incense (ID: `realia:Incense`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** arrepender, se (ID: `keyterm:Repent`); batismo (ID: `keyterm:Baptism`); João (ID: `person:John`); Judeia (ID: `place:Judea`); SENHOR (ID: `deity:Lord`); Jordan River (ID: `place:Jordan`); Isaías (ID: `person:Isaiah`); batista (ID: `keyterm:Baptist`); Jerusalém (ID: `place:Jerusalem`); proclamar (ID: `keyterm:Proclaim`); limpar (ID: `keyterm:CleanOut`); reino (ID: `keyterm:Kingdom`); To Sin (ID: `keyterm:Sin`); straightness (ID: `keyterm:Straightness`); Sadducees (ID: `group:Sadducee`); Abraão (ID: `person:Abraham`); céu (ID: `keyterm:Heaven`); Holy Spirit (ID: `deity:HolySpirit`); Pharisees (ID: `group:Pharisee`); Winnowing Fork (ID: `realia:WinnowingFork`); Belt (ID: `realia:Belt`); Locust (ID: `fauna:Locust`); Leather (ID: `realia:Leather`); Sandal (ID: `realia:Sandal`); Threshing Floor (ID: `realia:ThreshingFloor`); Bag (ID: `realia:Bag`); Wheat (ID: `flora:Wheat`); Camel (ID: `fauna:Camel`); Barn (ID: `realia:Barn`); Clothing (ID: `realia:Clothing`); Axe (ID: `realia:Axe`); Grain (ID: `flora:Grain`); Bee (ID: `fauna:Bee`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); tentar (ID: `keyterm:PutToTheTest`); prostrar, se (ID: `keyterm:BowDown`); An Angel (ID: `deity:Angel`); To Command (ID: `keyterm:Command`); servir (ID: `keyterm:Serve`); palavra (ID: `keyterm:Word`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); reino (ID: `keyterm:Kingdom`); holy (ID: `keyterm:Holy`); jejuar (ID: `keyterm:Fast`); priesthood (ID: `keyterm:Priesthood`); Satanás (ID: `deity:Satan`); Holy Spirit (ID: `deity:HolySpirit`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Galileia (ID: `place:Galilee`); Naftali (ID: `person:Naphtali`); Zebulom (ID: `group:Zebulun`); Zebulom (ID: `person:Zebulun`); proclamar (ID: `keyterm:Proclaim`); arrepender, se (ID: `keyterm:Repent`); Nazaré (ID: `place:Nazareth`); reino (ID: `keyterm:Kingdom`); To Cause to Happen (ID: `keyterm:Happen`); céu (ID: `keyterm:Heaven`); Isaías (ID: `person:Isaiah`); Gentiles (ID: `group:Gentile`); Jesus (ID: `person:Jesus.2`); Cafarnaum (ID: `place:Capernaum`); João (ID: `person:John`); Jordan River (ID: `place:Jordan`)
...
* **Associated ACAI Concepts:** Casting Net (ID: `realia:CastingNet`); Galileia (ID: `place:Galilee`); servir (ID: `keyterm:Serve`); André (ID: `person:Andrew`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); boa notícia (ID: `keyterm:GoodNews`); Zebedeu (ID: `person:Zebedee`); Decápolis (ID: `place:Decapolis`); Tiago (ID: `person:James`); João (ID: `person:John.2`); Sea of Galilee (ID: `place:GalileeSea`); Jerusalém (ID: `place:Jerusalem`); estar endemoninhado (ID: `keyterm:DemonPossessed`); proclamar (ID: `keyterm:Proclaim`); reino (ID: `keyterm:Kingdom`); Pedro (ID: `person:Peter`); Judeia (ID: `place:Judea`); Jordan River (ID: `place:Jordan`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** bem, aventurado (ID: `keyterm:Happy`); céu (ID: `keyterm:Heaven`); reino (ID: `keyterm:Kingdom`); be (or show oneself) just (ID: `keyterm:Just`); SENHOR (ID: `deity:Lord`); coração (ID: `keyterm:Heart`); misericórdia (ID: `keyterm:Mercy`); ser discípulo (ID: `keyterm:Disciple`); Spirit (ID: `keyterm:Spirit.2`); exortar (ID: `keyterm:Encourage`); limpo (ID: `keyterm:Clean`); rogar (ID: `keyterm:AskFor`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); lei (ID: `keyterm:Law`); reino (ID: `keyterm:Kingdom`); Commandment (ID: `keyterm:Commandment`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); surely! (ID: `keyterm:Surely`); Pharisees (ID: `group:Pharisee`); SENHOR (ID: `deity:Lord`); be (or show oneself) just (ID: `keyterm:Just`); House (ID: `realia:House`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); fornication (ID: `keyterm:Fornication`); geena (ID: `keyterm:Gehenna`); love (ID: `keyterm:Love`); Hell (ID: `place:Hell`); tribunal de justiça (ID: `keyterm:CourtCase`); corpo (ID: `keyterm:Body.3`); fazer tropeçar (ID: `keyterm:CauseToStumble`); offering (ID: `keyterm:Offering`); juízo (ID: `keyterm:Judgment`); céu (ID: `keyterm:Heaven`); reconciliar (ID: `keyterm:Reconcile`); Heavenly (ID: `keyterm:Heavenly`); Oath (ID: `keyterm:Oath`); Good (ID: `keyterm:Good`); Jerusalém (ID: `place:Jerusalem`); surely! (ID: `keyterm:Surely`); cobrador de impostos (ID: `keyterm:TaxCollector`); coração (ID: `keyterm:Heart`); decidir (ID: `keyterm:Decided`); orar (ID: `keyterm:Pray`); be (or show oneself) just (ID: `keyterm:Just`); Mile (ID: `realia:Mile`); Footstool (ID: `realia:Footstool`); Cloak (ID: `realia:Cloak`); Quadrans (ID: `realia:Quadrans`); Throne (ID: `realia:Throne`); Tunic (ID: `realia:Tunic.2`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); céu (ID: `keyterm:Heaven`); forgive (ID: `keyterm:Forgive`); surely! (ID: `keyterm:Surely`); Synagogue (ID: `realia:Synagogue`); reino (ID: `keyterm:Kingdom`); Bring In (ID: `keyterm:BringIn`); Glory (ID: `keyterm:Glory`); ofensa (ID: `keyterm:Wrong`); Name (ID: `keyterm:Name`); holy (ID: `keyterm:Holy`); tentar (ID: `keyterm:PutToTheTest`); livrar (ID: `keyterm:Deliver`); Heavenly (ID: `keyterm:Heavenly`); amizade (ID: `keyterm:Friendship`); be (or show oneself) just (ID: `keyterm:Just`); Inner Room (ID: `realia:InnerRoom`); Cornerstone (ID: `realia:Cornerstone`); Door (ID: `realia:Door`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); jejuar (ID: `keyterm:Fast`); corpo (ID: `keyterm:Body.3`); Heavenly (ID: `keyterm:Heavenly`); céu (ID: `keyterm:Heaven`); Clothing (ID: `realia:Clothing`); Moth (ID: `fauna:Moth`); de pequena fé (ID: `keyterm:HavingLittleFaith`); Glory (ID: `keyterm:Glory`); love (ID: `keyterm:Love`); surely! (ID: `keyterm:Surely`); Life (ID: `keyterm:Life`); Salomão (ID: `person:Solomon`); anointed (ID: `keyterm:Anointed`); coração (ID: `keyterm:Heart`); servir como escravo (ID: `keyterm:Serve.2`); reino (ID: `keyterm:Kingdom`); be (or show oneself) just (ID: `keyterm:Just`); Oven (ID: `realia:Oven`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Barn (ID: `realia:Barn`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Beam (ID: `realia:Beam`); decidir (ID: `keyterm:Decided`); lei (ID: `keyterm:Law`); céu (ID: `keyterm:Heaven`); holy (ID: `keyterm:Holy`); juízo (ID: `keyterm:Judgment`); SENHOR (ID: `deity:Lord`); Fish (ID: `fauna:Fish`); Snake (ID: `fauna:Snake`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); Dog (ID: `fauna:Dog`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); wipe (out), destroy (ID: `keyterm:Destroy`); sem lei (ID: `keyterm:Lawless`); Ability (ID: `keyterm:Ability`); speak (ID: `keyterm:Speak`); Life (ID: `keyterm:Life`); reino (ID: `keyterm:Kingdom`); Name (ID: `keyterm:Name`); SENHOR (ID: `deity:Lord`); céu (ID: `keyterm:Heaven`); Demons (ID: `deity:Demons`); Sheep (ID: `fauna:Lamb`); Wolf (ID: `fauna:Wolf`); Thistle (ID: `flora:Thistle`); Boxthorn (ID: `flora:Boxthorn`); Clothing (ID: `realia:Clothing`); Vine (ID: `flora:Vine`); Acacia (ID: `flora:Acacia`); Brier (ID: `flora:Brier`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); autoridade (ID: `keyterm:Authority.2`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); To Cleanse (ID: `keyterm:Cleanse.2`); crer (ID: `keyterm:Believe`); reino (ID: `keyterm:Kingdom`); Israel (ID: `person:Israel`); House (ID: `realia:House`); estar endemoninhado (ID: `keyterm:DemonPossessed`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Centurion With Sick Servant (ID: `person:Centurion.2`); Ability (ID: `keyterm:Ability`); surely! (ID: `keyterm:Surely`); offering (ID: `keyterm:Offering`); Pedro (ID: `person:Peter`); autoridade (ID: `keyterm:Authority.2`); prostrar, se (ID: `keyterm:BowDown`); Abraão (ID: `person:Abraham`); To Cause to Happen (ID: `keyterm:Happen`); céu (ID: `keyterm:Heaven`); Isaías (ID: `person:Isaiah`); To Command (ID: `keyterm:Command`); rogar (ID: `keyterm:AskFor`); Outer Darkness (ID: `keyterm:OuterDarkness`); Moisés (ID: `person:Moses`); Cafarnaum (ID: `place:Capernaum`); Isaque (ID: `person:Isaac`); testemunhar (ID: `keyterm:BearWitness`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); estar endemoninhado (ID: `keyterm:DemonPossessed`); ser discípulo (ID: `keyterm:Disciple`); rogar (ID: `keyterm:AskFor`); Ship (ID: `realia:Ship`); To Command (ID: `keyterm:Command`); A Disciple (ID: `person:GenericDisciple`); de pequena fé (ID: `keyterm:HavingLittleFaith`); Religious Official (ID: `person:ReligiousOfficial`); céu (ID: `keyterm:Heaven`); autoridade (ID: `keyterm:Authority.2`); Gerasa (ID: `place:Gerasa`); salvation (ID: `keyterm:Salvation`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); To Sin (ID: `keyterm:Sin`); forgive (ID: `keyterm:Forgive`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); cobrador de impostos (ID: `keyterm:TaxCollector`); Ability (ID: `keyterm:Ability`); jejuar (ID: `keyterm:Fast`); autoridade (ID: `keyterm:Authority.2`); Pharisees (ID: `group:Pharisee`); Bed (ID: `realia:Bed`); Temple (ID: `realia:Temple`); misericórdia (ID: `keyterm:Mercy`); Mateus (ID: `person:Matthew`); Glory (ID: `keyterm:Glory`); coração (ID: `keyterm:Heart`); offering (ID: `keyterm:Offering`); SENHOR (ID: `deity:Lord`); João (ID: `person:John`); fear (ID: `keyterm:Fear`); blasfemar (ID: `keyterm:Blaspheme`); crer (ID: `keyterm:Believe`); ter bom ânimo (ID: `keyterm:CheerUp`); Be Healthy (ID: `keyterm:Healthy`); coletoria (ID: `keyterm:TaxOffice`); Religious Officials (ID: `group:ReligiousOfficials`); be (or show oneself) just (ID: `keyterm:Just`); Patch (ID: `realia:Patch`); Must (ID: `realia:Must`); Ship (ID: `realia:Ship`); Clothing (ID: `realia:Clothing`); Skin-Bottle (ID: `realia:Skin-bottle`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); ser discípulo (ID: `keyterm:Disciple`); Demons (ID: `deity:Demons`); salvation (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`); House (ID: `realia:House`); compaixão (ID: `keyterm:Affection`); estar endemoninhado (ID: `keyterm:DemonPossessed`); boa notícia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); Life (ID: `keyterm:Life`); reino (ID: `keyterm:Kingdom`); prostrar, se (ID: `keyterm:BowDown`); Davi (ID: `person:David`); misericórdia (ID: `keyterm:Mercy`); Bleed (ID: `keyterm:Bleed`); rogar (ID: `keyterm:AskFor`); servir (ID: `keyterm:Serve`); Israel (ID: `person:Israel`); Pharisees (ID: `group:Pharisee`); ter bom ânimo (ID: `keyterm:CheerUp`); Tassel (ID: `realia:Tassel`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Flute (ID: `realia:Flute`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); servir (ID: `keyterm:Serve`); Bag (ID: `realia:Bag`); Bartolomeu (ID: `person:Bartholomew`); Alfeu (ID: `person:Alphaeus`); Judas (ID: `person:Judas.2`); Filipe (ID: `person:Philip`); Tomé (ID: `person:Thomas`); Zelote (ID: `group:Zealot`); Simão (ID: `person:Simon.2`); fazer a paz (ID: `keyterm:Peace`); Judas (ID: `person:Judas`); Tiago (ID: `person:James.2`); Ability (ID: `keyterm:Ability`); Zebedeu (ID: `person:Zebedee`); proclamar (ID: `keyterm:Proclaim`); Gomorra (ID: `place:Gomorrah`); surely! (ID: `keyterm:Surely`); Jesus (ID: `person:Jesus.2`); cobrador de impostos (ID: `keyterm:TaxCollector`); Samaritans (ID: `group:Samaritan`); reino (ID: `keyterm:Kingdom`); Name (ID: `keyterm:Name`); Pedro (ID: `person:Peter`); juízo (ID: `keyterm:Judgment`); autoridade (ID: `keyterm:Authority.2`); céu (ID: `keyterm:Heaven`); To Cleanse (ID: `keyterm:Cleanse.2`); levantamento (ID: `keyterm:Resurrection`); André (ID: `person:Andrew`); Samaria (ID: `place:Samaria`); Tiago (ID: `person:James`); tribunal de justiça (ID: `keyterm:CourtCase`); ser discípulo (ID: `keyterm:Disciple`); Israel (ID: `person:Israel`); Sodoma (ID: `place:Sodom`); Demons (ID: `deity:Demons`); Gentiles (ID: `group:Gentile`); João (ID: `person:John.2`); Mateus (ID: `person:Matthew`); Sheep (ID: `fauna:Lamb`); Belt (ID: `realia:Belt`); Tunic (ID: `realia:Tunic.2`); Staff (ID: `realia:Staff`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Name (ID: `keyterm:Name`); fear (ID: `keyterm:Fear`); ser discípulo (ID: `keyterm:Disciple`); surely! (ID: `keyterm:Surely`); céu (ID: `keyterm:Heaven`); Sparrow (ID: `fauna:Sparrow`); geena (ID: `keyterm:Gehenna`); corpo (ID: `keyterm:Body.3`); proclamar (ID: `keyterm:Proclaim`); Life (ID: `keyterm:Life`); Hell (ID: `place:Hell`); testemunhar (ID: `keyterm:BearWitness`); To Command (ID: `keyterm:Command`); Satanás (ID: `deity:Satan`); Holy Spirit (ID: `deity:HolySpirit`); fazer a paz (ID: `keyterm:Peace`); Israel (ID: `person:Israel`); Gentiles (ID: `group:Gentile`); amizade (ID: `keyterm:Friendship`); be (or show oneself) just (ID: `keyterm:Just`); salvation (ID: `keyterm:Salvation`); Wolf (ID: `fauna:Wolf`); Assarion (ID: `realia:Assarion`); Housetop (ID: `realia:Housetop`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Dove (ID: `fauna:Dove`); Snake (ID: `fauna:Snake`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** João (ID: `person:John`); Jesus (ID: `person:Jesus.2`); batista (ID: `keyterm:Baptist`); reino (ID: `keyterm:Kingdom`); céu (ID: `keyterm:Heaven`); ser discípulo (ID: `keyterm:Disciple`); boa notícia (ID: `keyterm:GoodNews`); speak (ID: `keyterm:Speak`); proclamar (ID: `keyterm:Proclaim`); surely! (ID: `keyterm:Surely`); Elias (ID: `person:Elijah`); cobrador de impostos (ID: `keyterm:TaxCollector`); bem, aventurado (ID: `keyterm:Happy`); An Angel (ID: `deity:Angel`); lei (ID: `keyterm:Law`); To Cleanse (ID: `keyterm:Cleanse.2`); levantamento (ID: `keyterm:Resurrection`); Demons (ID: `deity:Demons`); be (or show oneself) just (ID: `keyterm:Just`); Reed (ID: `flora:Reed`); House (ID: `realia:House`); Flute (ID: `realia:Flute`); Prison (ID: `realia:Prison`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); Tiro (ID: `place:Tyre`); Sidom (ID: `place:Sidon`); arrepender, se (ID: `keyterm:Repent`); juízo (ID: `keyterm:Judgment`); céu (ID: `keyterm:Heaven`); tribunal de justiça (ID: `keyterm:CourtCase`); Sodoma (ID: `place:Sodom`); Yoke (ID: `realia:Yoke`); Corazim (ID: `place:Chorazin`); Disaster (ID: `keyterm:Disaster`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Jesus (ID: `person:Jesus.2`); coração (ID: `keyterm:Heart`); Hell (ID: `place:Hell`); Betsaida (ID: `place:Bethsaida`); Good (ID: `keyterm:Good`); Cafarnaum (ID: `place:Capernaum`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** sabbath (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); Temple (ID: `realia:Temple`); ser discípulo (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); Sheep (ID: `fauna:Lamb`); lei (ID: `keyterm:Law`); offering (ID: `keyterm:Offering`); defilement (ID: `keyterm:Defilement`); Jesus (ID: `person:Jesus.2`); condenar (ID: `keyterm:Condemn`); SENHOR (ID: `deity:Lord`); Davi (ID: `person:David`); misericórdia (ID: `keyterm:Mercy`); Wheat (ID: `flora:Wheat`); House (ID: `realia:House`); Synagogue (ID: `realia:Synagogue`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** Gentiles (ID: `group:Gentile`); juízo (ID: `keyterm:Judgment`); To Cause to Happen (ID: `keyterm:Happen`); Isaías (ID: `person:Isaiah`); Name (ID: `keyterm:Name`); To Command (ID: `keyterm:Command`); amado (ID: `keyterm:Beloved`); hope (ID: `keyterm:Hope`); Jesus (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); Holy Spirit (ID: `deity:HolySpirit`); Lamp (ID: `realia:Lamp`); Reed (ID: `flora:Reed`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); Satanás (ID: `deity:Satan`); Holy Spirit (ID: `deity:HolySpirit`); Demons (ID: `deity:Demons`); Good (ID: `keyterm:Good`); forgive (ID: `keyterm:Forgive`); juízo (ID: `keyterm:Judgment`); blasfemar (ID: `keyterm:Blaspheme`); condenar (ID: `keyterm:Condemn`); Ability (ID: `keyterm:Ability`); estar endemoninhado (ID: `keyterm:DemonPossessed`); coração (ID: `keyterm:Heart`); inútil (ID: `keyterm:Idle`); para a eternidade (ID: `keyterm:Always`); To Sin (ID: `keyterm:Sin`); palavra (ID: `keyterm:Word`); SENHOR (ID: `deity:Lord`); Davi (ID: `person:David`); servir (ID: `keyterm:Serve`); tribunal de justiça (ID: `keyterm:CourtCase`); Pharisees (ID: `group:Pharisee`); House (ID: `realia:House`); Snake (ID: `fauna:Snake`); Cobra (ID: `fauna:Cobra`)
...
* **Associated ACAI Concepts:** Jonas (ID: `person:Jonah.2`); example (ID: `keyterm:Example`); juízo (ID: `keyterm:Judgment`); tribunal de justiça (ID: `keyterm:CourtCase`); Nínive (ID: `group:Nineveh`); Rainha de Sabá (ID: `person:QueenOfSheba`); proclamar (ID: `keyterm:Proclaim`); Salomão (ID: `person:Solomon`); coração (ID: `keyterm:Heart`); arrepender, se (ID: `keyterm:Repent`); SENHOR (ID: `deity:Lord`); be unfaithful (ID: `keyterm:Unfaithful`); céu (ID: `keyterm:Heaven`); A Group of People (ID: `group:GenericGroup`); ser discípulo (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); Nínive (ID: `place:Nineveh`); Fish (ID: `fauna:Fish`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** parábola (ID: `keyterm:Parable`); coração (ID: `keyterm:Heart`); reino (ID: `keyterm:Kingdom`); Brier (ID: `flora:Brier`); Thistle (ID: `flora:Thistle`); Boxthorn (ID: `flora:Boxthorn`); Acacia (ID: `flora:Acacia`); Ability (ID: `keyterm:Ability`); surely! (ID: `keyterm:Surely`); Jesus (ID: `person:Jesus.2`); bem, aventurado (ID: `keyterm:Happy`); Cause of Joy (ID: `keyterm:CauseOfJoy`); para a eternidade (ID: `keyterm:Always`); céu (ID: `keyterm:Heaven`); Isaías (ID: `person:Isaiah`); ser discípulo (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); be (or show oneself) just (ID: `keyterm:Just`); Rooster (ID: `fauna:Rooster`); Ship (ID: `realia:Ship`); House (ID: `realia:House`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** reino (ID: `keyterm:Kingdom`); céu (ID: `keyterm:Heaven`); parábola (ID: `keyterm:Parable`); Weed (ID: `flora:Weed`); Grain (ID: `flora:Grain`); para a eternidade (ID: `keyterm:Always`); An Angel (ID: `deity:Angel`); Wheat (ID: `flora:Wheat`); ser discípulo (ID: `keyterm:Disciple`); be (or show oneself) just (ID: `keyterm:Just`); Kiln (ID: `realia:Kiln`); Grass (ID: `flora:Grass`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`); SENHOR (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); sem lei (ID: `keyterm:Lawless`); escândalo (ID: `keyterm:StumblingBlock`); Storeroom (ID: `realia:Storeroom`); Dragnet (ID: `realia:Dragnet`); Mustard (ID: `flora:Mustard`); Saton (ID: `realia:Saton`); Barn (ID: `realia:Barn`); House (ID: `realia:House`); Container (ID: `realia:Container`)
...
* **Associated ACAI Concepts:** João (ID: `person:John`); Jesus (ID: `person:Jesus.2`); Herodes Antipas (ID: `person:Herod.2`); Ability (ID: `keyterm:Ability`); Herodias (ID: `person:Herodias`); Oath (ID: `keyterm:Oath`); batista (ID: `keyterm:Baptist`); Prison (ID: `realia:Prison`); Plate (ID: `realia:Plate.2`); não crer (ID: `keyterm:Disbelieve`); Judas (ID: `person:Jude`); Tiago (ID: `person:James.3`); Filipe (ID: `person:Philip.2`); Simão (ID: `person:Simon.3`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Be Lawful (ID: `keyterm:Lawful`); José (ID: `person:Joseph.4`); Maria (ID: `person:Mary`); parábola (ID: `keyterm:Parable`); fear (ID: `keyterm:Fear`); levantamento (ID: `keyterm:Resurrection`); ser discípulo (ID: `keyterm:Disciple`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Jesus (ID: `person:Jesus.2`); Fish (ID: `fauna:Fish`); céu (ID: `keyterm:Heaven`); bless (ID: `keyterm:Bless`); servir (ID: `keyterm:Serve`); compaixão (ID: `keyterm:Affection`); Basket (ID: `realia:Basket`); Grass (ID: `flora:Grass`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); fear (ID: `keyterm:Fear`); Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Pedro (ID: `person:Peter`); salvation (ID: `keyterm:Salvation`); de pequena fé (ID: `keyterm:HavingLittleFaith`); ter bom ânimo (ID: `keyterm:CheerUp`); Genesaré (ID: `place:Gennesaret`); rogar (ID: `keyterm:AskFor`); verdadeiro (ID: `keyterm:True`); prostrar, se (ID: `keyterm:BowDown`); orar (ID: `keyterm:Pray`); Stade (ID: `realia:Stade`); Tassel (ID: `realia:Tassel`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); tradição (ID: `keyterm:Teaching`); coração (ID: `keyterm:Heart`); defilement (ID: `keyterm:Defilement`); ser discípulo (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); Jerusalém (ID: `place:Jerusalem`); speak (ID: `keyterm:Speak`); Jesus (ID: `person:Jesus.2`); fornication (ID: `keyterm:Fornication`); Commandment (ID: `keyterm:Commandment`); offering (ID: `keyterm:Offering`); Pedro (ID: `person:Peter`); Heavenly (ID: `keyterm:Heavenly`); parábola (ID: `keyterm:Parable`); Isaías (ID: `person:Isaiah`); blasfemar (ID: `keyterm:Blaspheme`); A Group of Disciples (ID: `group:GenericDisciples`); adorar (ID: `keyterm:Worship`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Dog (ID: `fauna:Dog`); Syrophonecian Woman (ID: `person:SyrophonecianWoman`); Sidom (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); ser discípulo (ID: `keyterm:Disciple`); estar endemoninhado (ID: `keyterm:DemonPossessed`); Israel (ID: `person:Israel`); crer (ID: `keyterm:Believe`); Canaã (ID: `place:Canaan`); bom (ID: `keyterm:Honest`); rogar (ID: `keyterm:AskFor`); prostrar, se (ID: `keyterm:BowDown`); Davi (ID: `person:David`); misericórdia (ID: `keyterm:Mercy`); cananeu (ID: `group:Canaan`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Jesus (ID: `person:Jesus.2`); A Group of Disciples (ID: `group:GenericDisciples`); Fish (ID: `fauna:Fish`); Magadã (ID: `place:Magadan`); Glory (ID: `keyterm:Glory`); Israel (ID: `person:Israel`); Sea of Galilee (ID: `place:GalileeSea`); servir (ID: `keyterm:Serve`); SENHOR (ID: `deity:Lord`); compaixão (ID: `keyterm:Affection`); Ship (ID: `realia:Ship`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Sadducees (ID: `group:Sadducee`); Pharisees (ID: `group:Pharisee`); céu (ID: `keyterm:Heaven`); example (ID: `keyterm:Example`); Jesus (ID: `person:Jesus.2`); Basket (ID: `realia:Basket`); ser discípulo (ID: `keyterm:Disciple`); be unfaithful (ID: `keyterm:Unfaithful`); distinguir (ID: `keyterm:Discern`); de pequena fé (ID: `keyterm:HavingLittleFaith`); Jonas (ID: `person:Jonah.2`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Life (ID: `keyterm:Life`); SENHOR (ID: `deity:Lord`); céu (ID: `keyterm:Heaven`); Cesareia de Filipos (ID: `place:CaesareaPhilippi`); igreja (ID: `keyterm:Church`); Jerusalém (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Glory (ID: `keyterm:Glory`); Jeremias (ID: `person:Jeremiah.6`); sangue (ID: `keyterm:Blood`); corpo (ID: `keyterm:Body.3`); Elias (ID: `person:Elijah`); Hell (ID: `place:Hell`); bem, aventurado (ID: `keyterm:Happy`); reino (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); João (ID: `person:John`); pensar (ID: `keyterm:Think`); João (ID: `person:John.4`); To Command (ID: `keyterm:Command`); levantamento (ID: `keyterm:Resurrection`); batista (ID: `keyterm:Baptist`); Satanás (ID: `deity:Satan`); escândalo (ID: `keyterm:StumblingBlock`); rogar (ID: `keyterm:AskFor`); A Group of Disciples (ID: `group:GenericDisciples`); World of the Dead (ID: `keyterm:WorldOfTheDead`); salvation (ID: `keyterm:Salvation`); Key (ID: `realia:Key`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Elias (ID: `person:Elijah`); Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Pedro (ID: `person:Peter`); fear (ID: `keyterm:Fear`); Moisés (ID: `person:Moses`); reino (ID: `keyterm:Kingdom`); To Command (ID: `keyterm:Command`); amado (ID: `keyterm:Beloved`); surely! (ID: `keyterm:Surely`); João (ID: `person:John.2`); levantamento (ID: `keyterm:Resurrection`); batista (ID: `keyterm:Baptist`); João (ID: `person:John`); Tiago (ID: `person:James`); Clothing (ID: `realia:Clothing`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Pedro (ID: `person:Peter`); servir (ID: `keyterm:Serve`); ser discípulo (ID: `keyterm:Disciple`); surely! (ID: `keyterm:Surely`); Galileia (ID: `place:Galilee`); tributo (ID: `keyterm:Tax`); misericórdia (ID: `keyterm:Mercy`); be unfaithful (ID: `keyterm:Unfaithful`); To Command (ID: `keyterm:Command`); tributo (ID: `keyterm:PollTax`); crer (ID: `keyterm:Believe`); levantamento (ID: `keyterm:Resurrection`); Demons (ID: `deity:Demons`); A Group of Disciples (ID: `group:GenericDisciples`); Cafarnaum (ID: `place:Capernaum`); Two-Drachma Piece (ID: `realia:Two-drachmaPiece`); Fishhook (ID: `realia:Fishhook`); Mustard (ID: `flora:Mustard`); Stater (ID: `realia:Stater`); Fish (ID: `fauna:Fish`); Grain (ID: `flora:Grain`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); fazer tropeçar (ID: `keyterm:CauseToStumble`); reino (ID: `keyterm:Kingdom`); Life (ID: `keyterm:Life`); escândalo (ID: `keyterm:StumblingBlock`); Ability (ID: `keyterm:Ability`); surely! (ID: `keyterm:Surely`); Jesus (ID: `person:Jesus.2`); fogo eterno (ID: `keyterm:EternalFire`); Hell (ID: `place:Hell`); para a eternidade (ID: `keyterm:Always`); Name (ID: `keyterm:Name`); An Angel (ID: `deity:Angel`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); geena (ID: `keyterm:Gehenna`); ser discípulo (ID: `keyterm:Disciple`); Disaster (ID: `keyterm:Disaster`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** surely! (ID: `keyterm:Surely`); céu (ID: `keyterm:Heaven`); SENHOR (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** forgive (ID: `keyterm:Forgive`); ter dívida para com alguém (ID: `keyterm:Owe`); céu (ID: `keyterm:Heaven`); surely! (ID: `keyterm:Surely`); To Sin (ID: `keyterm:Sin`); SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); witness (ID: `keyterm:Witness`); Jesus (ID: `person:Jesus.2`); cobrador de impostos (ID: `keyterm:TaxCollector`); dívida (ID: `keyterm:Debt`); coração (ID: `keyterm:Heart`); reino (ID: `keyterm:Kingdom`); Name (ID: `keyterm:Name`); palavra (ID: `keyterm:Word`); Pedro (ID: `person:Peter`); prostrar, se (ID: `keyterm:BowDown`); Heavenly (ID: `keyterm:Heavenly`); misericórdia (ID: `keyterm:Mercy`); compaixão (ID: `keyterm:Affection`); igreja (ID: `keyterm:Church`); Denarius (ID: `realia:Denarius`); Talent (ID: `realia:Talent`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** corpo (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`); reino (ID: `keyterm:Kingdom`); céu (ID: `keyterm:Heaven`); To Command (ID: `keyterm:Command`); Moisés (ID: `person:Moses`); ser discípulo (ID: `keyterm:Disciple`); Be Lawful (ID: `keyterm:Lawful`); fornication (ID: `keyterm:Fornication`); Galileia (ID: `place:Galilee`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); Judeia (ID: `place:Judea`); servir (ID: `keyterm:Serve`); dureza de coração (ID: `keyterm:Hardheartedness`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisees (ID: `group:Pharisee`); Jordan River (ID: `place:Jordan`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); surely! (ID: `keyterm:Surely`); para a eternidade (ID: `keyterm:Always`); reino (ID: `keyterm:Kingdom`); SENHOR (ID: `deity:Lord`); céu (ID: `keyterm:Heaven`); Good (ID: `keyterm:Good`); ser discípulo (ID: `keyterm:Disciple`); Rich Young Ruler (ID: `person:RichYoungRuler`); Glory (ID: `keyterm:Glory`); love (ID: `keyterm:Love`); fornication (ID: `keyterm:Fornication`); Commandment (ID: `keyterm:Commandment`); decidir (ID: `keyterm:Decided`); Name (ID: `keyterm:Name`); regeneração (ID: `keyterm:NewWorld`); Pedro (ID: `person:Peter`); rogar (ID: `keyterm:AskFor`); Israel (ID: `person:Israel`); salvation (ID: `keyterm:Salvation`); Camel (ID: `fauna:Camel`); Needle (ID: `realia:Needle`); Throne (ID: `realia:Throne`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Denarius (ID: `realia:Denarius`); inútil (ID: `keyterm:Idle`); reino (ID: `keyterm:Kingdom`); to act wickedly (ID: `keyterm:ActWickedly`); céu (ID: `keyterm:Heaven`); Good (ID: `keyterm:Good`); Be Lawful (ID: `keyterm:Lawful`); be (or show oneself) just (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Jerusalém (ID: `place:Jerusalem`); Davi (ID: `person:David`); misericórdia (ID: `keyterm:Mercy`); To Command (ID: `keyterm:Command`); servir (ID: `keyterm:Serve`); Zebedeu (ID: `person:Zebedee`); Life (ID: `keyterm:Life`); Jericó (ID: `place:Jericho`); reino (ID: `keyterm:Kingdom`); autoridade (ID: `keyterm:Authority.2`); SENHOR (ID: `deity:Lord`); prostrar, se (ID: `keyterm:BowDown`); compaixão (ID: `keyterm:Affection`); resgate (ID: `keyterm:Ransom`); levantamento (ID: `keyterm:Resurrection`); ser discípulo (ID: `keyterm:Disciple`); Gentiles (ID: `group:Gentile`); condenar (ID: `keyterm:Condemn`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Jerusalém (ID: `place:Jerusalem`); Donkey (ID: `fauna:Donkey`); hosana (ID: `keyterm:Hosanna`); Davi (ID: `person:David`); ser discípulo (ID: `keyterm:Disciple`); Clothing (ID: `realia:Clothing`); Betfagé (ID: `place:Bethphage`); Galileia (ID: `place:Galilee`); Name (ID: `keyterm:Name`); bless (ID: `keyterm:Bless`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); To Cause to Happen (ID: `keyterm:Happen`); To Command (ID: `keyterm:Command`); A Group of People (ID: `group:GenericGroup`); Nazaré (ID: `place:Nazareth`); Betânia (ID: `place:Bethany`); servir (ID: `keyterm:Serve`); altura (ID: `keyterm:Height`); Seat (ID: `realia:Seat`); Dove (ID: `fauna:Dove`); House (ID: `realia:House`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); autoridade (ID: `keyterm:Authority.2`); Fig (ID: `flora:Fig`); João (ID: `person:John`); ser discípulo (ID: `keyterm:Disciple`); céu (ID: `keyterm:Heaven`); distinguir (ID: `keyterm:Discern`); surely! (ID: `keyterm:Surely`); fear (ID: `keyterm:Fear`); orar (ID: `keyterm:Pray`); batismo (ID: `keyterm:Baptism`); rogar (ID: `keyterm:AskFor`); para a eternidade (ID: `keyterm:Always`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); SENHOR (ID: `deity:Lord`); cobrador de impostos (ID: `keyterm:TaxCollector`); Jesus (ID: `person:Jesus.2`); reino (ID: `keyterm:Kingdom`); arrepender, se (ID: `keyterm:Repent`); parábola (ID: `keyterm:Parable`); rejeitar (ID: `keyterm:Reject`); surely! (ID: `keyterm:Surely`); João (ID: `person:John`); fear (ID: `keyterm:Fear`); crer (ID: `keyterm:Believe`); escritura (ID: `keyterm:Scripture`); Pharisees (ID: `group:Pharisee`); be (or show oneself) just (ID: `keyterm:Just`); Cornerstone (ID: `realia:Cornerstone`); Winepress (ID: `realia:Winepress`); Tower (ID: `realia:Tower`); Thorn Hedge (ID: `realia:ThornHedge`); Watch-Tower (ID: `realia:Watch-tower`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); reino (ID: `keyterm:Kingdom`); céu (ID: `keyterm:Heaven`); To Command (ID: `keyterm:Command`); Good (ID: `keyterm:Good`); Jesus (ID: `person:Jesus.2`); Outer Darkness (ID: `keyterm:OuterDarkness`); escolhido (ID: `keyterm:Chosen`); parábola (ID: `keyterm:Parable`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); levantamento (ID: `keyterm:Resurrection`); Jesus (ID: `person:Jesus.2`); Tibério (ID: `person:Tiberius`); tributo (ID: `keyterm:PollTax`); Sadducees (ID: `group:Sadducee`); Herodians (ID: `group:Herodian`); Israel (ID: `person:Israel`); Ability (ID: `keyterm:Ability`); Truth (ID: `keyterm:Truth`); Life (ID: `keyterm:Life`); Be Lawful (ID: `keyterm:Lawful`); An Angel (ID: `deity:Angel`); The Way (ID: `keyterm:TheWay`); verdadeiro (ID: `keyterm:True`); Abraão (ID: `person:Abraham`); céu (ID: `keyterm:Heaven`); escritura (ID: `keyterm:Scripture`); Moisés (ID: `person:Moses`); ser discípulo (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); Isaque (ID: `person:Isaac`); Denarius (ID: `realia:Denarius`); Money (ID: `realia:Money`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Commandment (ID: `keyterm:Commandment`); Davi (ID: `person:David`); lei (ID: `keyterm:Law`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); Pharisees (ID: `group:Pharisee`); mente (ID: `keyterm:Mind.2`); coração (ID: `keyterm:Heart`); Holy Spirit (ID: `deity:HolySpirit`); Sadducees (ID: `group:Sadducee`)
...
* **Associated ACAI Concepts:** Pharisees (ID: `group:Pharisee`); Disaster (ID: `keyterm:Disaster`); Temple (ID: `realia:Temple`); SENHOR (ID: `deity:Lord`); be (or show oneself) just (ID: `keyterm:Just`); geena (ID: `keyterm:Gehenna`); sangue (ID: `keyterm:Blood`); Jesus (ID: `person:Jesus.2`); dever (ID: `keyterm:Ought`); offering (ID: `keyterm:Offering`); juízo (ID: `keyterm:Judgment`); céu (ID: `keyterm:Heaven`); To Cleanse (ID: `keyterm:Cleanse.2`); consecration (ID: `keyterm:Consecration.2`); Zacarias (ID: `person:Zechariah.12`); Jeoiada (ID: `person:Jehoiada.2`); limpo (ID: `keyterm:Clean`); hipocrisia (ID: `keyterm:Hypocrisy`); Synagogue (ID: `realia:Synagogue`); Grave (ID: `realia:Grave`); Jerusalém (ID: `place:Jerusalem`); Abel (ID: `person:Abel`); surely! (ID: `keyterm:Surely`); Hell (ID: `place:Hell`); reino (ID: `keyterm:Kingdom`); testemunhar (ID: `keyterm:BearWitness`); bless (ID: `keyterm:Bless`); Name (ID: `keyterm:Name`); Heavenly (ID: `keyterm:Heavenly`); misericórdia (ID: `keyterm:Mercy`); lei (ID: `keyterm:Law`); sem lei (ID: `keyterm:Lawless`); crer (ID: `keyterm:Believe`); Moisés (ID: `person:Moses`); ser discípulo (ID: `keyterm:Disciple`); tribunal de justiça (ID: `keyterm:CourtCase`); defilement (ID: `keyterm:Defilement`); amizade (ID: `keyterm:Friendship`); Seat (ID: `realia:Seat`); Mosquito (ID: `fauna:Mosquito`); Cumin (ID: `flora:Cumin`); Dill (ID: `flora:Dill`); Plate (ID: `realia:Plate.2`); Phylactery (ID: `realia:Phylactery`); Mint (ID: `flora:Mint`); Camel (ID: `fauna:Camel`); Throne (ID: `realia:Throne`); Tassel (ID: `realia:Tassel`); Rooster (ID: `fauna:Rooster`); House (ID: `realia:House`); Snake (ID: `fauna:Snake`); Cross (ID: `realia:Cross`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); reino (ID: `keyterm:Kingdom`); ser discípulo (ID: `keyterm:Disciple`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); boa notícia (ID: `keyterm:GoodNews`); salvation (ID: `keyterm:Salvation`); example (ID: `keyterm:Example`); proclamar (ID: `keyterm:Proclaim`); love (ID: `keyterm:Love`); surely! (ID: `keyterm:Surely`); sem lei (ID: `keyterm:Lawless`); testemunhar (ID: `keyterm:BearWitness`); para a eternidade (ID: `keyterm:Always`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); escolhido (ID: `keyterm:Chosen`); Noé (ID: `person:Noah`); Ability (ID: `keyterm:Ability`); surely! (ID: `keyterm:Surely`); Jesus (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); example (ID: `keyterm:Example`); crer (ID: `keyterm:Believe`); Daniel (ID: `person:Daniel.3`); Faithfulness (ID: `keyterm:Faithfulness`); House (ID: `realia:House`); Glory (ID: `keyterm:Glory`); corpo (ID: `keyterm:Body.3`); maravilha (ID: `keyterm:Portent`); sabbath (ID: `keyterm:Sabbath`); coração (ID: `keyterm:Heart`); bem, aventurado (ID: `keyterm:Happy`); holy (ID: `keyterm:Holy`); SENHOR (ID: `deity:Lord`); parábola (ID: `keyterm:Parable`); orar (ID: `keyterm:Pray`); Judeia (ID: `place:Judea`); o detestável da desolação (ID: `keyterm:AbominationOfDesolation`); Disaster (ID: `keyterm:Disaster`); salvation (ID: `keyterm:Salvation`); Housetop (ID: `realia:Housetop`); Inner Room (ID: `realia:InnerRoom`); Vulture (ID: `fauna:Vulture`); Trumpet (ID: `realia:Trumpet`); Tabernacle (ID: `realia:Tabernacle`); Hand-Mill (ID: `realia:Hand-mill`); Cloak (ID: `realia:Cloak`); Door (ID: `realia:Door`); Boat (ID: `realia:Boat`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Lamp (ID: `realia:Lamp`); Olive Oil (ID: `realia:OliveOil`); reino (ID: `keyterm:Kingdom`); céu (ID: `keyterm:Heaven`); surely! (ID: `keyterm:Surely`); Container (ID: `realia:Container`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** Prison (ID: `realia:Prison`); surely! (ID: `keyterm:Surely`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); An Angel (ID: `deity:Angel`); be (or show oneself) just (ID: `keyterm:Just`); Sheep (ID: `fauna:Lamb`); Kid (ID: `fauna:Kid`); Goat (ID: `fauna:Goat`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); fogo eterno (ID: `keyterm:EternalFire`); reino (ID: `keyterm:Kingdom`); bless (ID: `keyterm:Bless`); SENHOR (ID: `deity:Lord`); servir (ID: `keyterm:Serve`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Myrrh (ID: `flora:Myrrh`); Myrrh (ID: `realia:Myrrh`); Simão (ID: `person:Simon.4`); Judas (ID: `person:Judas.2`); Betânia (ID: `place:Bethany`); Ability (ID: `keyterm:Ability`); boa notícia (ID: `keyterm:GoodNews`); Caifás (ID: `person:Caiaphas`); corpo (ID: `keyterm:Body.3`); proclamar (ID: `keyterm:Proclaim`); surely! (ID: `keyterm:Surely`); passover (ID: `keyterm:Passover`); Alabaster Jar (ID: `realia:AlabasterJar`); House (ID: `realia:House`); Cross (ID: `realia:Cross`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Jesus (ID: `person:Jesus.2`); passover (ID: `keyterm:Passover`); sangue (ID: `keyterm:Blood`); corpo (ID: `keyterm:Body.3`); reino (ID: `keyterm:Kingdom`); bless (ID: `keyterm:Bless`); To Sin (ID: `keyterm:Sin`); surely! (ID: `keyterm:Surely`); Judas (ID: `person:Judas.2`); Covenant (ID: `keyterm:Covenant`); Disaster (ID: `keyterm:Disaster`); SENHOR (ID: `deity:Lord`); forgive (ID: `keyterm:Forgive`); Bowl (ID: `realia:Bowl.2`); Vine (ID: `flora:Vine`); Sheep (ID: `fauna:Lamb`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); To Cause to Happen (ID: `keyterm:Happen`); escritura (ID: `keyterm:Scripture`); ser discípulo (ID: `keyterm:Disciple`); example (ID: `keyterm:Example`); An Angel (ID: `deity:Angel`); Judas (ID: `person:Judas.2`); rogar (ID: `keyterm:AskFor`); SENHOR (ID: `deity:Lord`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Caifás (ID: `person:Caiaphas`); Ability (ID: `keyterm:Ability`); witness (ID: `keyterm:Witness`); céu (ID: `keyterm:Heaven`); speak (ID: `keyterm:Speak`); Pedro (ID: `person:Peter`); blasfemar (ID: `keyterm:Blaspheme`); Life (ID: `keyterm:Life`); Courtyard (ID: `realia:Courtyard`); Cloak (ID: `realia:Cloak`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Jesus (ID: `person:Jesus.2`); Rooster (ID: `fauna:Rooster`); A Servant (ID: `person:GenericServant`); Oath (ID: `keyterm:Oath`); palavra (ID: `keyterm:Word`); A Group of People (ID: `group:GenericGroup`); Nazaré (ID: `place:Nazareth`); Galileans (ID: `group:Galilee`); verdadeiro (ID: `keyterm:True`); Galileia (ID: `place:Galilee`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Akeldama (ID: `place:Akeldama`); sangue (ID: `keyterm:Blood`); Tesouro do templo (ID: `place:Corban`); Pilatos (ID: `person:Pilate`); To Cause to Happen (ID: `keyterm:Happen`); Jeremias (ID: `person:Jeremiah.6`); Israel (ID: `person:Israel`); Priests (ID: `group:GenericPriests`); To Sin (ID: `keyterm:Sin`); arrepender, se (ID: `keyterm:Repent`); Judas (ID: `person:Judas.2`); condenar (ID: `keyterm:Condemn`); Jesus (ID: `person:Jesus.2`); Be Lawful (ID: `keyterm:Lawful`); SENHOR (ID: `deity:Lord`); Treasury (ID: `realia:Treasury`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Barrabás (ID: `person:Barabbas`); Pilatos (ID: `person:Pilate`); A Group of People (ID: `group:GenericGroup`); Cross (ID: `realia:Cross`); sangue (ID: `keyterm:Blood`); palavra (ID: `keyterm:Word`); be (or show oneself) just (ID: `keyterm:Just`); persuadir (ID: `keyterm:Persuade`); Jews (ID: `group:Jews`); Judgment Seat (ID: `realia:JudgmentSeat`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Jesus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); salvation (ID: `keyterm:Salvation`); Clothing (ID: `realia:Clothing`); Reed (ID: `flora:Reed`); Cloak (ID: `realia:Cloak`); Simão (ID: `person:Simon.5`); Cirene (ID: `place:Cyrene`); Golgotha (ID: `place:Golgotha`); coração (ID: `keyterm:Heart`); persuadir (ID: `keyterm:Persuade`); Name (ID: `keyterm:Name`); SENHOR (ID: `deity:Lord`); livrar (ID: `keyterm:Deliver`); blasfemar (ID: `keyterm:Blaspheme`); crer (ID: `keyterm:Believe`); Israel (ID: `person:Israel`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`); Acacia (ID: `flora:Acacia`); Brier (ID: `flora:Brier`); Wine (ID: `realia:Wine`); Palace (ID: `realia:Palace`); Boxthorn (ID: `flora:Boxthorn`); Lot (ID: `realia:Lot`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Grave (ID: `realia:Grave`); levantamento (ID: `keyterm:Resurrection`); corpo (ID: `keyterm:Body.3`); Pilatos (ID: `person:Pilate`); Maria Madalena (ID: `person:Marymagdalene`); José (ID: `person:Joseph.6`); Maria (ID: `person:Mary.2`); Elias (ID: `person:Elijah`); holy (ID: `keyterm:Holy`); A Group of People (ID: `group:GenericGroup`); ser discípulo (ID: `keyterm:Disciple`); Tiago (ID: `person:James.4`); Zebedeu (ID: `person:Zebedee`); José (ID: `person:Joseph.5`); Arimateia (ID: `place:Arimathea`); Life (ID: `keyterm:Life`); Galileia (ID: `place:Galilee`); Name (ID: `keyterm:Name`); SENHOR (ID: `deity:Lord`); verdadeiro (ID: `keyterm:True`); fear (ID: `keyterm:Fear`); limpo (ID: `keyterm:Clean`); servir (ID: `keyterm:Serve`); Spirit (ID: `keyterm:Spirit.2`); Pharisees (ID: `group:Pharisee`); salvation (ID: `keyterm:Salvation`); Reed (ID: `flora:Reed`); Seal (ID: `realia:Seal`); Sour Wine (ID: `realia:SourWine`); Curtain (ID: `realia:Curtain`); Temple (ID: `realia:Temple`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** fear (ID: `keyterm:Fear`); Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); levantamento (ID: `keyterm:Resurrection`); Galileia (ID: `place:Galilee`); An Angel (ID: `deity:Angel`); Grave (ID: `realia:Grave`); Week (ID: `keyterm:Week`); Angels (ID: `group:Angels`); sabbath (ID: `keyterm:Sabbath`); persuadir (ID: `keyterm:Persuade`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Maria Madalena (ID: `person:Marymagdalene`); SENHOR (ID: `deity:Lord`); prostrar, se (ID: `keyterm:BowDown`); céu (ID: `keyterm:Heaven`); Jews (ID: `group:Jews`); Maria (ID: `person:Mary.2`); Clothing (ID: `realia:Clothing`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Jesus (ID: `person:Jesus.2`); autoridade (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); céu (ID: `keyterm:Heaven`); Name (ID: `keyterm:Name`); To Command (ID: `keyterm:Command`); batismo (ID: `keyterm:Baptism`); SENHOR (ID: `deity:Lord`); prostrar, se (ID: `keyterm:BowDown`); Holy Spirit (ID: `deity:HolySpirit`); Galileia (ID: `place:Galilee`); para a eternidade (ID: `keyterm:Always`)
