...
* **Associated ACAI Concepts:** Eliúde (ID: `person:Eliud`); Jacó (ID: `person:Jacob.2`); Azor (ID: `person:Azor`); Matã (ID: `person:Matthan`); Zadoque (ID: `person:Zadok`); Eleazar (ID: `person:Eleazar`); Abiúde (ID: `person:Abiud`); Aquim (ID: `person:Achim`); Eliaquim (ID: `person:Eliakim`); Ram (ID: `person:Ram`); Salmom (ID: `person:Salmon`); Davi (ID: `person:David`); Jesus (ID: `person:Jesus.2`); Jeoaquim (ID: `person:Jehoiachin`); Zorobabel (ID: `person:Zerubbabel.2`); Uzias (ID: `person:Uzziah`); Josias (ID: `person:Josiah`); Asa (ID: `person:Asa`); Ezequias (ID: `person:Hezekiah`); Salomão (ID: `person:Solomon`); Obede (ID: `person:Obed`); Tamar (ID: `person:Tamar`); Raabe (ID: `person:Rahab`); Aminadabe (ID: `person:Amminadab`); Naassom (ID: `person:Nahshon`); Zerá (ID: `person:Zerah.3`); Hezrom (ID: `person:Hezron.2`); José (ID: `person:Joseph.4`); Perez (ID: `person:Perez`); Amon (ID: `person:Amon.3`); Abias (ID: `person:Abijah.4`); Jotão (ID: `person:Jotham.2`); Jeorão (ID: `person:Jehoram`); Urias (ID: `person:Uriah`); Boaz (ID: `person:Boaz`); Acaz (ID: `person:Ahaz`); Roboão (ID: `person:Rehoboam`); Josafá (ID: `person:Jehoshaphat.3`); Isaque (ID: `person:Isaac`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** José (ID: `person:Joseph.4`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); Maria (ID: `person:Mary`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod`); Belém (ID: `place:Bethlehem`); Arquelau (ID: `person:Archelaus`); Egito (ID: `place:Egypt`); prostrar, se (ID: `keyterm:BowDown`); José (ID: `person:Joseph.4`); Money Box (ID: `realia:MoneyBox`); Myrrh (ID: `realia:Myrrh`); Frankincense (ID: `flora:Frankincense`); Nazaré (ID: `place:Nazareth`); Myrrh (ID: `flora:Myrrh`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Jeremias (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** Judeia (ID: `place:Judea`); João (ID: `person:John`); Winnowing Fork (ID: `realia:WinnowingFork`); batista (ID: `keyterm:Baptist`); Sandal (ID: `realia:Sandal`); Belt (ID: `realia:Belt`); Leather (ID: `realia:Leather`); Threshing Floor (ID: `realia:ThreshingFloor`); Locust (ID: `fauna:Locust`); Isaías (ID: `person:Isaiah`)
...
* **Associated ACAI Concepts:** batismo (ID: `keyterm:Baptism`); Dove (ID: `fauna:Dove`); Jordan River (ID: `place:Jordan`)
...
* **Associated ACAI Concepts:** Pinnacle (ID: `realia:Pinnacle`); tentar (ID: `keyterm:PutToTheTest`); prostrar, se (ID: `keyterm:BowDown`); palavra (ID: `keyterm:Word`)
...
* **Associated ACAI Concepts:** Galileia (ID: `place:Galilee`); Nazaré (ID: `place:Nazareth`); proclamar (ID: `keyterm:Proclaim`); arrepender, se (ID: `keyterm:Repent`)
...
* **Associated ACAI Concepts:** Fishnet (ID: `realia:Fishnet`); Decápolis (ID: `place:Decapolis`); Galileia (ID: `place:Galilee`); Sea of Galilee (ID: `place:GalileeSea`); Zebedeu (ID: `person:Zebedee`); André (ID: `person:Andrew`); Tiago (ID: `person:James`); João (ID: `person:John.2`); Synagogue (ID: `realia:Synagogue`); boa notícia (ID: `keyterm:GoodNews`)
...
* **Associated ACAI Concepts:** bem, aventurado (ID: `keyterm:Happy`); misericórdia (ID: `keyterm:Mercy`); coração (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); Commandment (ID: `keyterm:Commandment`)
...
* **Associated ACAI Concepts:** Mile (ID: `realia:Mile`); geena (ID: `keyterm:Gehenna`); fornication (ID: `keyterm:Fornication`); Quadrans (ID: `realia:Quadrans`); tribunal de justiça (ID: `keyterm:CourtCase`); Footstool (ID: `realia:Footstool`); reconciliar (ID: `keyterm:Reconcile`); Heavenly (ID: `keyterm:Heavenly`); Oath (ID: `keyterm:Oath`); Cloak (ID: `realia:Cloak`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); forgive (ID: `keyterm:Forgive`); céu (ID: `keyterm:Heaven`); Inner Room (ID: `realia:InnerRoom`); Bring In (ID: `keyterm:BringIn`); reino (ID: `keyterm:Kingdom`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** jejuar (ID: `keyterm:Fast`); Oven (ID: `realia:Oven`); Moth (ID: `fauna:Moth`); Clothing (ID: `realia:Clothing`); Cubit (ID: `realia:Cubit.2`); de pequena fé (ID: `keyterm:HavingLittleFaith`); Wild Flower (ID: `flora:WildFlower`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Centurion With Sick Servant (ID: `person:Centurion.2`); To Cleanse (ID: `keyterm:Cleanse.2`); crer (ID: `keyterm:Believe`); estar endemoninhado (ID: `keyterm:DemonPossessed`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`)
...
* **Associated ACAI Concepts:** Jackal (ID: `fauna:Jackal`); estar endemoninhado (ID: `keyterm:DemonPossessed`); Religious Official (ID: `person:ReligiousOfficial`); A Disciple (ID: `person:GenericDisciple`); de pequena fé (ID: `keyterm:HavingLittleFaith`); To Command (ID: `keyterm:Command`)
...
* **Associated ACAI Concepts:** cobrador de impostos (ID: `keyterm:TaxCollector`); Patch (ID: `realia:Patch`); Mateus (ID: `person:Matthew`); Must (ID: `realia:Must`); misericórdia (ID: `keyterm:Mercy`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Tassel (ID: `realia:Tassel`); compaixão (ID: `keyterm:Affection`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Zelote (ID: `group:Zealot`); Bag (ID: `realia:Bag`); Simão (ID: `person:Simon.2`); Bartolomeu (ID: `person:Bartholomew`); Alfeu (ID: `person:Alphaeus`); Tiago (ID: `person:James.2`); Judas (ID: `person:Judas`); Tomé (ID: `person:Thomas`); Filipe (ID: `person:Philip`); Judas (ID: `person:Judas.2`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** Sparrow (ID: `fauna:Sparrow`); Assarion (ID: `realia:Assarion`); Wolf (ID: `fauna:Wolf`); geena (ID: `keyterm:Gehenna`)
...
* **Associated ACAI Concepts:** batista (ID: `keyterm:Baptist`); Reed (ID: `flora:Reed`); João (ID: `person:John`)
...
* **Associated ACAI Concepts:** Corazim (ID: `place:Chorazin`); Yoke (ID: `realia:Yoke`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Disaster (ID: `keyterm:Disaster`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** condenar (ID: `keyterm:Condemn`); blasfemar (ID: `keyterm:Blaspheme`); juízo (ID: `keyterm:Judgment`)
...
* **Associated ACAI Concepts:** Jonas (ID: `person:Jonah.2`); Nínive (ID: `group:Nineveh`); example (ID: `keyterm:Example`); Rainha de Sabá (ID: `person:QueenOfSheba`)
...
* **Associated ACAI Concepts:** Weed (ID: `flora:Weed`); Saton (ID: `realia:Saton`); Storeroom (ID: `realia:Storeroom`); Mustard (ID: `flora:Mustard`); Dragnet (ID: `realia:Dragnet`); parábola (ID: `keyterm:Parable`); Grain (ID: `flora:Grain`); reino (ID: `keyterm:Kingdom`); céu (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** Herodes Antipas (ID: `person:Herod.2`); Herodias (ID: `person:Herodias`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Filipe (ID: `person:Philip.2`); Simão (ID: `person:Simon.3`); Prison (ID: `realia:Prison`); Judas (ID: `person:Jude`); Tiago (ID: `person:James.3`); não crer (ID: `keyterm:Disbelieve`); João (ID: `person:John`)
...
* **Associated ACAI Concepts:** Genesaré (ID: `place:Gennesaret`); de pequena fé (ID: `keyterm:HavingLittleFaith`); ter bom ânimo (ID: `keyterm:CheerUp`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Syrophonecian Woman (ID: `person:SyrophonecianWoman`); Dog (ID: `fauna:Dog`); Sidom (ID: `place:Sidon`); Tiro (ID: `place:Tyre`)
...
* **Associated ACAI Concepts:** Magadã (ID: `place:Magadan`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Cesareia de Filipos (ID: `place:CaesareaPhilippi`); Key (ID: `realia:Key`); igreja (ID: `keyterm:Church`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Elias (ID: `person:Elijah`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); fazer tropeçar (ID: `keyterm:CauseToStumble`); escândalo (ID: `keyterm:StumblingBlock`)
...
* **Associated ACAI Concepts:** ter dívida para com alguém (ID: `keyterm:Owe`); witness (ID: `keyterm:Witness`)
...
* **Associated ACAI Concepts:** Jerusalém (ID: `place:Jerusalem`); servir (ID: `keyterm:Serve`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); hosana (ID: `keyterm:Hosanna`); Jerusalém (ID: `place:Jerusalem`); Seat (ID: `realia:Seat`); Betfagé (ID: `place:Bethphage`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** cobrador de impostos (ID: `keyterm:TaxCollector`); rejeitar (ID: `keyterm:Reject`); Cornerstone (ID: `realia:Cornerstone`); Winepress (ID: `realia:Winepress`); Tower (ID: `realia:Tower`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Herodians (ID: `group:Herodian`); Sadducees (ID: `group:Sadducee`); Denarius (ID: `realia:Denarius`); Money (ID: `realia:Money`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Commandment (ID: `keyterm:Commandment`); mente (ID: `keyterm:Mind.2`); coração (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** Dill (ID: `flora:Dill`); Phylactery (ID: `realia:Phylactery`); Mint (ID: `flora:Mint`); geena (ID: `keyterm:Gehenna`); Zacarias (ID: `person:Zechariah.12`); Seat (ID: `realia:Seat`); Cumin (ID: `flora:Cumin`); Mosquito (ID: `fauna:Mosquito`); Plate (ID: `realia:Plate.2`); hipocrisia (ID: `keyterm:Hypocrisy`); limpo (ID: `keyterm:Clean`); Jeoiada (ID: `person:Jehoiada.2`); Disaster (ID: `keyterm:Disaster`); Pharisees (ID: `group:Pharisee`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Noé (ID: `person:Noah`); Inner Room (ID: `realia:InnerRoom`); Housetop (ID: `realia:Housetop`); Vulture (ID: `fauna:Vulture`); Trumpet (ID: `realia:Trumpet`); Daniel (ID: `person:Daniel.3`); Faithfulness (ID: `keyterm:Faithfulness`); céu (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** Simão (ID: `person:Simon.4`); Alabaster Jar (ID: `realia:AlabasterJar`); Betânia (ID: `place:Bethany`); Judas (ID: `person:Judas.2`)
...
* **Associated ACAI Concepts:** Bowl (ID: `realia:Bowl.2`); sangue (ID: `keyterm:Blood`); corpo (ID: `keyterm:Body.3`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Getsêmani (ID: `place:Gethsemane`); Rooster (ID: `fauna:Rooster`); Spirit (ID: `keyterm:Spirit.2`); orar (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Caifás (ID: `person:Caiaphas`); Courtyard (ID: `realia:Courtyard`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Akeldama (ID: `place:Akeldama`); Tesouro do templo (ID: `place:Corban`); Pilatos (ID: `person:Pilate`)
...
* **Associated ACAI Concepts:** Judgment Seat (ID: `realia:JudgmentSeat`); Barrabás (ID: `person:Barabbas`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Simão (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); Cirene (ID: `place:Cyrene`); Crown (ID: `realia:Crown.2`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Crown (ID: `realia:Crown`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Maria (ID: `person:Mary.2`); José (ID: `person:Joseph.6`); José (ID: `person:Joseph.5`); Tiago (ID: `person:James.4`); Maria Madalena (ID: `person:Marymagdalene`); Arimateia (ID: `place:Arimathea`); Sour Wine (ID: `realia:SourWine`); Zebedeu (ID: `person:Zebedee`); Seal (ID: `realia:Seal`); Curtain (ID: `realia:Curtain`); Reed (ID: `flora:Reed`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Angels (ID: `group:Angels`); levantamento (ID: `keyterm:Resurrection`); Week (ID: `keyterm:Week`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); autoridade (ID: `keyterm:Authority.2`)
