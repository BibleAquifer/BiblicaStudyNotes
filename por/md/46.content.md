...
* **Associated ACAI Concepts:** Cloe (ID: `person:Chloe`); Paulo (ID: `person:Paul`); Gaio (ID: `person:Gaius.3`); Crispo (ID: `person:Crispus`); Sóstenes (ID: `person:Sosthenes`); Estéfanas (ID: `person:Stephanas`); A Disciple (ID: `person:GenericDisciple`); batismo (ID: `keyterm:Baptism`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** consecration (ID: `keyterm:Consecration.2`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** distinguir (ID: `keyterm:Discern`); Spirit (ID: `keyterm:Spirit.2`); natural (ID: `keyterm:Natural`); Holy Spirit (ID: `deity:HolySpirit`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** discernir (ID: `keyterm:Interpret`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Faithfulness (ID: `keyterm:Faithfulness`); decidir (ID: `keyterm:Decided`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** to act wickedly (ID: `keyterm:ActWickedly`); tribunal de justiça (ID: `keyterm:CourtCase`); idólatra (ID: `keyterm:Idolater`)
...
* **Associated ACAI Concepts:** corpo (ID: `keyterm:Body.3`); fornication (ID: `keyterm:Fornication`)
...
* **Associated ACAI Concepts:** Temple of an Idol (ID: `realia:TempleOfAnIdol`); fazer tropeçar (ID: `keyterm:CauseToStumble`)
...
* **Associated ACAI Concepts:** participar (ID: `keyterm:Partake`); autoridade (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** idólatra (ID: `keyterm:Idolater`); tentar (ID: `keyterm:PutToTheTest`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** participar (ID: `keyterm:Partake`); comunhão (ID: `keyterm:Fellowship`); Be Lawful (ID: `keyterm:Lawful`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Building Up (ID: `keyterm:BuildingUp`); igreja (ID: `keyterm:Church`); speak (ID: `keyterm:Speak`)
...
* **Associated ACAI Concepts:** levantamento (ID: `keyterm:Resurrection`); vazio (ID: `keyterm:Empty`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** natural (ID: `keyterm:Natural`); imortal (ID: `keyterm:Imperishable`); Trumpet (ID: `realia:Trumpet`); levantamento (ID: `keyterm:Resurrection`); corpo (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** Fortunato (ID: `person:Fortunatus`); Acaico (ID: `person:Achaicus`); Estéfanas (ID: `person:Stephanas`); Priscila (ID: `person:Priscilla`); Áquila (ID: `person:Aquila`); Week (ID: `keyterm:Week`); Acaia (ID: `place:Achaia`); Jesus (ID: `person:Jesus.2`)
