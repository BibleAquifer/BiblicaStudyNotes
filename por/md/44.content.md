...
* **Associated ACAI Concepts:** Teófilo (ID: `person:Theophilus`); céu (ID: `keyterm:Heaven`); Galileans (ID: `group:Galilee`); witness (ID: `keyterm:Witness`); Judeia (ID: `place:Judea`); promessa (ID: `keyterm:Promise`)
...
* **Associated ACAI Concepts:** Matias (ID: `person:Matthias`); José (ID: `person:Joseph.9`); Half a Mile (ID: `realia:HalfAMile`); orar (ID: `keyterm:Pray`); Simão (ID: `person:Simon.2`); Bartolomeu (ID: `person:Bartholomew`); Akeldama (ID: `place:Akeldama`); Alfeu (ID: `person:Alphaeus`); Tiago (ID: `person:James.2`); Monte das Oliveiras (ID: `place:OlivesMount`); Upstairs Room (ID: `realia:UpstairsRoom`); Lot (ID: `realia:Lot`); Tomé (ID: `person:Thomas`); André (ID: `person:Andrew`); Maria (ID: `person:Mary`)
...
* **Associated ACAI Concepts:** Sweet Wine (ID: `realia:SweetWine`); Parthians (ID: `group:Parthians`); Capadócia (ID: `place:Cappadocia`); Elamites (ID: `group:Elam`); Cretenses (ID: `group:Cretan`); Frígia (ID: `place:Phrygia`); Ponto (ID: `place:Pontus`); Líbia (ID: `place:Libya`); Cirene (ID: `place:Cyrene`); Galileans (ID: `group:Galilee`); Elam (ID: `place:Elam`); Medã (ID: `person:Medan`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Joel (ID: `person:Joel.14`); maravilha (ID: `keyterm:Portent`); batismo (ID: `keyterm:Baptism`); Judeans (ID: `group:Judea`); invocar (ID: `keyterm:CallUpon`); palavra (ID: `keyterm:Word`); arrepender, se (ID: `keyterm:Repent`); levantamento (ID: `keyterm:Resurrection`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Solomon's Colonnade (ID: `place:SolomonsPortico`); Abraão (ID: `person:Abraham`); Porch (ID: `realia:Porch`); To Cause to Happen (ID: `keyterm:Happen`); Samuel (ID: `person:Samuel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); João (ID: `person:John.3`); Alexandre (ID: `person:Alexander.2`); salvation (ID: `keyterm:Salvation`); Anás (ID: `person:Annas`); Caifás (ID: `person:Caiaphas`); Cornerstone (ID: `realia:Cornerstone`); Sadducees (ID: `group:Sadducee`)
...
* **Associated ACAI Concepts:** Cypriots (ID: `group:Cyprus`); rogar (ID: `keyterm:AskFor`); Barnabé (ID: `person:Barnabas`); Pilatos (ID: `person:Pilate`)
...
* **Associated ACAI Concepts:** Prison (ID: `realia:Prison`); Porch (ID: `realia:Porch`); zelo (ID: `keyterm:Resentment`); maravilha (ID: `keyterm:Portent`)
...
* **Associated ACAI Concepts:** Teudas (ID: `person:Theudas`); Judas (ID: `person:Judas.3`); persuadir (ID: `keyterm:Persuade`); Gamaliel (ID: `person:Gamaliel`); salvador (ID: `keyterm:Savior`); witness (ID: `keyterm:Witness`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Timão (ID: `person:Timon`); Antiochians (ID: `group:Antioch`); Prócoro (ID: `person:Prochorus`); Nicolau (ID: `person:Nicolaus`); Nicanor (ID: `person:Nicanor`); Pármenas (ID: `person:Parmenas`); servir (ID: `keyterm:Serve`); Hellenists (ID: `group:Hellenist`); Estevão (ID: `person:Stephen`); Filipe (ID: `person:Philip.4`)
...
* **Associated ACAI Concepts:** Freedmen (ID: `group:Freedmen`); Estevão (ID: `person:Stephen`); Alexandrians (ID: `group:Alexandria`); Alexandria (ID: `place:Alexandria`)
...
* **Associated ACAI Concepts:** Renfã (ID: `deity:Rephan`); José (ID: `person:Joseph.10`); to act wickedly (ID: `keyterm:ActWickedly`); libertar (ID: `keyterm:Rescue`); Faraó (ID: `person:Pharaoh.4`); Mesopotâmia (ID: `place:Mesopotamia`); Hamor (ID: `person:Hamor`); Siquém (ID: `place:Shechem`); juiz (ID: `keyterm:Judge`); Egito (ID: `place:Egypt`); Moisés (ID: `person:Moses`); Israel (ID: `person:Israel`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Estevão (ID: `person:Stephen`); invocar (ID: `keyterm:CallUpon`)
...
* **Associated ACAI Concepts:** Filipe (ID: `person:Philip.4`); Estevão (ID: `person:Stephen`); Judeia (ID: `place:Judea`); proclamar (ID: `keyterm:Proclaim`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Simão (ID: `person:Simon.8`); Filipe (ID: `person:Philip.4`); Money (ID: `realia:Money`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Filipe (ID: `person:Philip.4`); Chariot (ID: `realia:Chariot`); boa notícia (ID: `keyterm:GoodNews`); Ethiopians (ID: `group:Ethiopia`); Etiópia (ID: `place:Ethiopia`); Asdode (ID: `place:Ashdod`); Gaza (ID: `place:Gaza`)
...
* **Associated ACAI Concepts:** Ananias (ID: `person:Ananias.2`); Damasco (ID: `place:Damascus`); Paulo (ID: `person:Paul`); Judas (ID: `person:Judas.4`); Rua Direita (ID: `place:Straight`); Tarso (ID: `group:Tarsus`); The Way (ID: `keyterm:TheWay`); Name (ID: `keyterm:Name`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Damasco (ID: `place:Damascus`); Hellenists (ID: `group:Hellenist`); Tarso (ID: `place:Tarsus`); Basket (ID: `realia:Basket`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Tabita (ID: `person:Tabitha`); Eneias (ID: `person:Aeneas`); Jope (ID: `place:Joppa`); Simão (ID: `person:Simon.9`); Sharon Plain (ID: `place:Sharon.2`); Pedro (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Italians (ID: `group:Italy`); Cornélio (ID: `person:Cornelius`); Linen Cloth (ID: `realia:LinenCloth`); Simão (ID: `person:Simon.9`); Housetop (ID: `realia:Housetop`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Cornélio (ID: `person:Cornelius`); Simão (ID: `person:Simon.9`); Pedro (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** testemunhar solenemente (ID: `keyterm:Declare`); anointed (ID: `keyterm:Anointed`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Linen Cloth (ID: `realia:LinenCloth`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Antioquia (ID: `place:Antioch`); Ágabo (ID: `person:Agabus`); Chipre (ID: `place:Cyprus`); Cypriots (ID: `group:Cyprus`); Christians (ID: `group:Christ`); Hellenists (ID: `group:Hellenist`); ser discípulo (ID: `keyterm:Disciple`); Fenícia (ID: `place:Phoenicia`); Cláudio (ID: `person:Claudius`)
...
* **Associated ACAI Concepts:** Herodes (ID: `person:Herod.3`); Rode (ID: `person:Rhoda`); Maria (ID: `person:Mary.5`); Chain (ID: `realia:Chain`); Marcos (ID: `person:Mark`); Tiago (ID: `person:James`); João (ID: `person:John.2`); Pedro (ID: `person:Peter`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Bedroom (ID: `realia:Bedroom`); Blasto (ID: `person:Blastus`); Herodes (ID: `person:Herod.3`); Tyrians (ID: `group:Tyre`)
...
* **Associated ACAI Concepts:** Barjesus (ID: `person:Bar-jesus`); Paulo (ID: `person:Paul`); Barnabé (ID: `person:Barnabas`); Selêucia (ID: `place:Seleucia`); Salamina (ID: `place:Salamis`); Manaém (ID: `person:Manaen`); Sérgio Paulo (ID: `person:SergiusPaulus`); Marcos (ID: `person:Mark`); Pafos (ID: `place:Paphos`); Simeão (ID: `person:Simeon.4`); jejuar (ID: `keyterm:Fast`); Antioquia (ID: `place:Antioch`); Herodes Antipas (ID: `person:Herod.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Perga (ID: `place:Perga`); Pafos (ID: `place:Paphos`); Synagogue (ID: `realia:Synagogue`); Antioquia (ID: `place:Antioch.2`); Panfília (ID: `place:Pamphylia`); Quis (ID: `person:Kish`); Jessé (ID: `person:Jesse`); Canaã (ID: `place:Canaan`); Saul (ID: `person:Saul.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** adorar (ID: `keyterm:Worship`); zelo (ID: `keyterm:Resentment`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Licônia (ID: `place:Lycaonia`); Derbe (ID: `place:Derbe`); Listra (ID: `place:Lystra`); Icônio (ID: `place:Iconium`)
...
* **Associated ACAI Concepts:** Zeus (ID: `deity:Zeus`); Garland (ID: `realia:Garland`); Hermes (ID: `deity:Hermes`); Lycaonians (ID: `group:Lycaonia`); inútil (ID: `keyterm:Worthless`); Do Good (ID: `keyterm:DoGood`)
...
* **Associated ACAI Concepts:** Atália (ID: `place:Attalia`); Antioquia (ID: `place:Antioch.2`); Icônio (ID: `place:Iconium`); Pisídia (ID: `place:Pisidia`); Perga (ID: `place:Perga`); Derbe (ID: `place:Derbe`); Panfília (ID: `place:Pamphylia`); jejuar (ID: `keyterm:Fast`)
...
* **Associated ACAI Concepts:** Judas (ID: `person:Judas.5`); Antioquia (ID: `place:Antioch`); Silas (ID: `person:Silas`); Fenícia (ID: `place:Phoenicia`); Tiago (ID: `person:James.3`); Yoke (ID: `realia:Yoke`); Judeia (ID: `place:Judea`); Barnabé (ID: `person:Barnabas`); Gentiles (ID: `group:Gentile`); Paulo (ID: `person:Paul`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Marcos (ID: `person:Mark`); Cilícia (ID: `place:Cilicia`)
...
* **Associated ACAI Concepts:** Mísia (ID: `place:Mysia`); Listra (ID: `place:Lystra`); Bitínia (ID: `place:Bithynia`); Macedônia (ID: `place:Macedonia`); Frígia (ID: `place:Phrygia`); Derbe (ID: `place:Derbe`); Troas (ID: `place:Troas`); Galácia (ID: `place:Galatia`); Asia (ID: `place:Asia`); Timóteo (ID: `person:Timothy`)
...
* **Associated ACAI Concepts:** Neápolis (ID: `place:Neapolis`); Samotrácia (ID: `place:Samothrace`); Lídia (ID: `person:Lydia`); Tiatira (ID: `place:Thyatira`); Filipos (ID: `place:Philippi`); Macedônia (ID: `place:Macedonia`)
...
* **Associated ACAI Concepts:** Philippian Jailer (ID: `person:PhilippianJailer`); Lídia (ID: `person:Lydia`); Silas (ID: `person:Silas`); crer (ID: `keyterm:Believe`); Torch (ID: `realia:Torch`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Jasão (ID: `person:Jason`); Apolônia (ID: `place:Apollonia`); Amfipolis (ID: `place:Amphipolis`); Bereia (ID: `place:Berea`); Tessalônica (ID: `place:Thessalonica`); Greeks (ID: `group:Greek`); escritura (ID: `keyterm:Scripture`); distinguir (ID: `keyterm:Discern`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Areópago (ID: `place:Areopagus`); Atenas (ID: `place:Athens`); Athenians (ID: `group:Athens`); Stoics (ID: `group:Stoic`); Epicureans (ID: `group:Epicurean`); Dionísio (ID: `person:Dionysius`); Areopagites (ID: `group:Areopagus`); Dâmaris (ID: `person:Damaris`); adorar (ID: `keyterm:Worship`); divino (ID: `keyterm:Divine`); decidir (ID: `keyterm:Decided`)
...
* **Associated ACAI Concepts:** Gálio (ID: `person:Gallio`); Justo (ID: `person:Justus.2`); Ponto (ID: `group:Pontus`); Judgment Seat (ID: `realia:JudgmentSeat`); Corinto (ID: `place:Corinth`); Corinthians (ID: `group:Corinth`); Crispo (ID: `person:Crispus`); Sóstenes (ID: `person:Sosthenes`); adorar (ID: `keyterm:Worship`); Ponto (ID: `place:Pontus`); Priscila (ID: `person:Priscilla`); Áquila (ID: `person:Aquila`); Acaia (ID: `place:Achaia`); Cláudio (ID: `person:Claudius`); Roma (ID: `place:Rome`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Áquila (ID: `person:Aquila`); Cencreia (ID: `place:Cenchreae`); Alexandrians (ID: `group:Alexandria`); Frígia (ID: `place:Phrygia`); Alexandria (ID: `place:Alexandria`); Galácia (ID: `place:Galatia`); Apolo (ID: `person:Apollos`)
...
* **Associated ACAI Concepts:** Tirano (ID: `person:Tyrannus`); Apron (ID: `realia:Apron`); Ceva (ID: `person:Sceva`); Lecture Hall (ID: `realia:LectureHall`); Asia (ID: `place:Asia`); Éfeso (ID: `place:Ephesus`); Macedônia (ID: `place:Macedonia`); Erasto (ID: `person:Erastus`); Band of Cloth (ID: `realia:BandOfCloth`); Acaia (ID: `place:Achaia`); Demons (ID: `deity:Demons`); Paulo (ID: `person:Paul`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Ártemis (ID: `deity:Artemis`); Ephesians (ID: `group:Ephesus`); Theater (ID: `realia:Theater`); Replica Temple (ID: `realia:ReplicaTemple`); Gaio (ID: `person:Gaius`); Alexandre (ID: `person:Alexander.3`); Demétrio (ID: `person:Demetrius`); Aristarco (ID: `person:Aristarchus`)
...
* **Associated ACAI Concepts:** Second Story (ID: `realia:SecondStory`); Segundo (ID: `person:Secundus`); Asians (ID: `group:Asia`); Gaio (ID: `person:Gaius.2`); Bereans (ID: `group:Berea`); Pirro (ID: `person:Pyrrhus`); Êutico (ID: `person:Eutychus`); Troas (ID: `place:Troas`); Sópatro (ID: `person:Sopater`); Macedônia (ID: `place:Macedonia`); Trófimo (ID: `person:Trophimus`); Filipos (ID: `place:Philippi`); Tíquico (ID: `person:Tychicus`); Week (ID: `keyterm:Week`); Grécia (ID: `place:Greece`); Window (ID: `realia:Window`)
...
* **Associated ACAI Concepts:** Assôs (ID: `place:Assos`); testemunhar solenemente (ID: `keyterm:Declare`); Mitilene (ID: `place:Mitylene`); Quios (ID: `place:Chios`); Samos (ID: `place:Samos`); Mileto (ID: `place:Miletus`); Éfeso (ID: `place:Ephesus`); servir como escravo (ID: `keyterm:Serve.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Cos (ID: `place:Cos`); Rodes (ID: `place:Rhodes`); Pátara (ID: `place:Patara`); Mnasom (ID: `person:Mnason`); Ágabo (ID: `person:Agabus`); Cesareia (ID: `place:Caesarea`); Cypriots (ID: `group:Cyprus`); Fenícia (ID: `place:Phoenicia`); Filipe (ID: `person:Philip.4`); Belt (ID: `realia:Belt`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Step (ID: `realia:Step`); Tarso (ID: `group:Tarsus`); Trófimo (ID: `person:Trophimus`); Tarso (ID: `place:Tarsus`); Cilícia (ID: `place:Cilicia`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Paulo (ID: `person:Paul`); Gamaliel (ID: `person:Gamaliel`); Ananias (ID: `person:Ananias.2`)
...
* **Associated ACAI Concepts:** Antipátrida (ID: `place:Antipatris`); Felix (ID: `person:Felix`); Lísias (ID: `person:Lysias`); Ananias (ID: `person:Ananias.3`); Roma (ID: `place:Rome`); Palace (ID: `realia:Palace`); ter bom ânimo (ID: `keyterm:CheerUp`); Cilícia (ID: `place:Cilicia`); Paulo (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Felix (ID: `person:Felix`); Tértulo (ID: `person:Tertullus`); Drusila (ID: `person:Drusilla`); Ananias (ID: `person:Ananias.3`); Lísias (ID: `person:Lysias`); The Way (ID: `keyterm:TheWay`); Festo (ID: `person:Festus`); consciência (ID: `keyterm:Conscience`); Paulo (ID: `person:Paul`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Festo (ID: `person:Festus`); Agripa (ID: `person:Agrippa`); Cesareia (ID: `place:Caesarea`); Audience Hall (ID: `realia:AudienceHall`); Berenice (ID: `person:Bernice`); Augusto (ID: `person:Augustus`); Cláudio (ID: `person:Claudius`); Paulo (ID: `person:Paul`); Jews (ID: `group:Jews`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Agripa (ID: `person:Agrippa`); Festo (ID: `person:Festus`); Berenice (ID: `person:Bernice`); Christians (ID: `group:Christ`); libertar (ID: `keyterm:Rescue`); Paulo (ID: `person:Paul`); Jews (ID: `group:Jews`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Anchor (ID: `realia:Anchor`); Ship (ID: `realia:Ship`); Júlio (ID: `person:Julius`); Creta (ID: `place:Crete`); Mirra (ID: `place:Myra`); Lícia (ID: `place:Lycia`); the Syrtis (ID: `place:Syrtis`); Cnido (ID: `place:Cnidus`); Fair Havens (ID: `place:FairHavens`); Clauda (ID: `place:Cauda`); Fathom (ID: `realia:Fathom`); Mar Adriático (ID: `place:AdriaticSea`); Adramício (ID: `place:Adramyttium`); Fênix (ID: `place:Phoenix`); Laséia (ID: `place:Lasea`); Salmona (ID: `place:Salmone`); Italy (ID: `place:Italy`); Rudder (ID: `realia:Rudder`); Sail (ID: `realia:Sail`); Alexandria (ID: `place:Alexandria`); Panfília (ID: `place:Pamphylia`); Aristarco (ID: `person:Aristarchus`); Augusto (ID: `person:Augustus`); Cilícia (ID: `place:Cilicia`); Asia (ID: `place:Asia`); Sidom (ID: `place:Sidon`); Paulo (ID: `person:Paul`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Públio (ID: `person:Publius`); Puteóli (ID: `place:Puteoli`); Praça de Ápio (ID: `place:ForumOfAppius`); Emblem (ID: `realia:Emblem`); Three Taverns (ID: `place:ThreeTaverns`); Régio (ID: `place:Rhegium`); Malta (ID: `place:Malta`); Siracusa (ID: `place:Syracuse`); Roma (ID: `place:Rome`); Alexandria (ID: `place:Alexandria`)
