...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); tentar (ID: `keyterm:PutToTheTest`); crer (ID: `keyterm:Believe`); Grass (ID: `flora:Grass`); Wild Flower (ID: `flora:WildFlower`); bem, aventurado (ID: `keyterm:Happy`); discernir (ID: `keyterm:Interpret`); aprovado (ID: `keyterm:Approved`); love (ID: `keyterm:Love`); Tiago (ID: `person:James.3`); Truth (ID: `keyterm:Truth`); Life (ID: `keyterm:Life`); Jesus (ID: `person:Jesus.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`); amado (ID: `keyterm:Beloved`); To Sin (ID: `keyterm:Sin`); distinguir (ID: `keyterm:Discern`); Good (ID: `keyterm:Good`); promessa (ID: `keyterm:Promise`); que não pode ser tentado (ID: `keyterm:NotTempted`); A Person (ID: `person:GenericPerson`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); limpo (ID: `keyterm:Clean`); inútil (ID: `keyterm:Worthless`); lei (ID: `keyterm:Law`); Ability (ID: `keyterm:Ability`); sem mancha (ID: `keyterm:Undefiled`); be (or show oneself) just (ID: `keyterm:Just`); amado (ID: `keyterm:Beloved`); sem mancha (ID: `keyterm:AboveCriticism`); coração (ID: `keyterm:Heart`); bem, aventurado (ID: `keyterm:Happy`); salvation (ID: `keyterm:Salvation`); Mirror (ID: `realia:Mirror`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); favoritismo (ID: `keyterm:Partiality`); tribunal de justiça (ID: `keyterm:CourtCase`); love (ID: `keyterm:Love`); crer (ID: `keyterm:Believe`); Clothing (ID: `realia:Clothing`); juízo (ID: `keyterm:Judgment`); tropeçar (ID: `keyterm:Stumble`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); fornication (ID: `keyterm:Fornication`); escolhido (ID: `keyterm:Chosen`); reino (ID: `keyterm:Kingdom`); decidir (ID: `keyterm:Decided`); Name (ID: `keyterm:Name`); To Sin (ID: `keyterm:Sin`); amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); misericórdia (ID: `keyterm:Mercy`); distinguir (ID: `keyterm:Discern`); promessa (ID: `keyterm:Promise`); blasfemar (ID: `keyterm:Blaspheme`); escritura (ID: `keyterm:Scripture`); inclemente (ID: `keyterm:Merciless`); Synagogue (ID: `realia:Synagogue`); Footstool (ID: `realia:Footstool`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); corpo (ID: `keyterm:Body.3`); A Person (ID: `person:GenericPerson`); SENHOR (ID: `deity:Lord`); Abraão (ID: `person:Abraham`); Raabe (ID: `person:Rahab`); inútil (ID: `keyterm:Idle`); To Cause to Happen (ID: `keyterm:Happen`); fazer a paz (ID: `keyterm:Peace`); An Angel (ID: `deity:Angel`); Demons (ID: `deity:Demons`); Isaque (ID: `person:Isaac`); Spirit (ID: `keyterm:Spirit.2`); escritura (ID: `keyterm:Scripture`); vazio (ID: `keyterm:Empty`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** zelo (ID: `keyterm:Resentment`); fazer a paz (ID: `keyterm:Peace`); sem hipocrisia (ID: `keyterm:Unhypocritical`); compreensivo (ID: `keyterm:Gentle`); conduta (ID: `keyterm:Behavior`); natural (ID: `keyterm:Natural`); Good (ID: `keyterm:Good`); demoníaco (ID: `keyterm:Demonic`); Truth (ID: `keyterm:Truth`); pure (ID: `keyterm:Pure`); coração (ID: `keyterm:Heart`); be (or show oneself) just (ID: `keyterm:Just`); misericórdia (ID: `keyterm:Mercy`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); decidir (ID: `keyterm:Decided`); Life (ID: `keyterm:Life`); bom (ID: `keyterm:Honest`); be unfaithful (ID: `keyterm:Unfaithful`); amizade (ID: `keyterm:Friendship`); Ability (ID: `keyterm:Ability`); pure (ID: `keyterm:Pure`); coração (ID: `keyterm:Heart`); Cause of Joy (ID: `keyterm:CauseOfJoy`); To Sin (ID: `keyterm:Sin`); lei (ID: `keyterm:Law`); legislador (ID: `keyterm:Lawgiver`); desejar (ID: `keyterm:LongFor`); favor (ID: `keyterm:Favor`); To Cleanse (ID: `keyterm:Cleanse.2`); escritura (ID: `keyterm:Scripture`); Holy Spirit (ID: `deity:HolySpirit`); Spirit (ID: `keyterm:Spirit.2`); salvation (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); coração (ID: `keyterm:Heart`); Jó (ID: `person:Job`); Compassionate (ID: `keyterm:Compassionate`); decidir (ID: `keyterm:Decided`); mui compassivo (ID: `keyterm:FullOfCompassion`); testemunhar (ID: `keyterm:BearWitness`); Name (ID: `keyterm:Name`); corpo (ID: `keyterm:Body.3`); be (or show oneself) just (ID: `keyterm:Just`); condenar (ID: `keyterm:Condemn`); considerar feliz (ID: `keyterm:RegardAsHappy`); Clothing (ID: `realia:Clothing`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); To Sin (ID: `keyterm:Sin`); céu (ID: `keyterm:Heaven`); SENHOR (ID: `deity:Lord`); salvation (ID: `keyterm:Salvation`); Name (ID: `keyterm:Name`); Oath (ID: `keyterm:Oath`); Elias (ID: `person:Elijah`); crer (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); autoridade (ID: `keyterm:Authority.2`); anointed (ID: `keyterm:Anointed`); igreja (ID: `keyterm:Church`); be (or show oneself) just (ID: `keyterm:Just`); forgive (ID: `keyterm:Forgive`); Olive Oil (ID: `realia:OliveOil`)
