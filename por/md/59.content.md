...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); tentar (ID: `keyterm:PutToTheTest`); crer (ID: `keyterm:Believe`); Grass (ID: `flora:Grass`); Wild Flower (ID: `flora:WildFlower`); aprovado (ID: `keyterm:Approved`); discernir (ID: `keyterm:Interpret`); bem, aventurado (ID: `keyterm:Happy`); To Sin (ID: `keyterm:Sin`); Cause of Joy (ID: `keyterm:CauseOfJoy`); distinguir (ID: `keyterm:Discern`); A Person (ID: `person:GenericPerson`); love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); Tiago (ID: `person:James.3`); promessa (ID: `keyterm:Promise`); Good (ID: `keyterm:Good`); Life (ID: `keyterm:Life`); Jesus (ID: `person:Jesus.2`); que não pode ser tentado (ID: `keyterm:NotTempted`); amado (ID: `keyterm:Beloved`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); limpo (ID: `keyterm:Clean`); inútil (ID: `keyterm:Worthless`); bem, aventurado (ID: `keyterm:Happy`); salvation (ID: `keyterm:Salvation`); lei (ID: `keyterm:Law`); amado (ID: `keyterm:Beloved`); sem mancha (ID: `keyterm:Undefiled`); coração (ID: `keyterm:Heart`); be (or show oneself) just (ID: `keyterm:Just`); Ability (ID: `keyterm:Ability`); sem mancha (ID: `keyterm:AboveCriticism`); Mirror (ID: `realia:Mirror`)
...
* **Associated ACAI Concepts:** lei (ID: `keyterm:Law`); favoritismo (ID: `keyterm:Partiality`); tribunal de justiça (ID: `keyterm:CourtCase`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); Clothing (ID: `realia:Clothing`); tropeçar (ID: `keyterm:Stumble`); juízo (ID: `keyterm:Judgment`); escritura (ID: `keyterm:Scripture`); Glory (ID: `keyterm:Glory`); To Sin (ID: `keyterm:Sin`); distinguir (ID: `keyterm:Discern`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); promessa (ID: `keyterm:Promise`); escolhido (ID: `keyterm:Chosen`); misericórdia (ID: `keyterm:Mercy`); decidir (ID: `keyterm:Decided`); Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); inclemente (ID: `keyterm:Merciless`); reino (ID: `keyterm:Kingdom`); amado (ID: `keyterm:Beloved`); fornication (ID: `keyterm:Fornication`); blasfemar (ID: `keyterm:Blaspheme`); Footstool (ID: `realia:Footstool`); Synagogue (ID: `realia:Synagogue`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); be (or show oneself) just (ID: `keyterm:Just`); corpo (ID: `keyterm:Body.3`); Abraão (ID: `person:Abraham`); SENHOR (ID: `deity:Lord`); A Person (ID: `person:GenericPerson`); inútil (ID: `keyterm:Idle`); Raabe (ID: `person:Rahab`); An Angel (ID: `deity:Angel`); fazer a paz (ID: `keyterm:Peace`); Spirit (ID: `keyterm:Spirit.2`); escritura (ID: `keyterm:Scripture`); salvation (ID: `keyterm:Salvation`); vazio (ID: `keyterm:Empty`); Demons (ID: `deity:Demons`); Isaque (ID: `person:Isaac`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** zelo (ID: `keyterm:Resentment`); fazer a paz (ID: `keyterm:Peace`); natural (ID: `keyterm:Natural`); sem hipocrisia (ID: `keyterm:Unhypocritical`); conduta (ID: `keyterm:Behavior`); compreensivo (ID: `keyterm:Gentle`); Truth (ID: `keyterm:Truth`); misericórdia (ID: `keyterm:Mercy`); demoníaco (ID: `keyterm:Demonic`); coração (ID: `keyterm:Heart`); be (or show oneself) just (ID: `keyterm:Just`); Good (ID: `keyterm:Good`); pure (ID: `keyterm:Pure`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); decidir (ID: `keyterm:Decided`); Life (ID: `keyterm:Life`); amizade (ID: `keyterm:Friendship`); bom (ID: `keyterm:Honest`); be unfaithful (ID: `keyterm:Unfaithful`); desejar (ID: `keyterm:LongFor`); escritura (ID: `keyterm:Scripture`); salvation (ID: `keyterm:Salvation`); To Sin (ID: `keyterm:Sin`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ability (ID: `keyterm:Ability`); coração (ID: `keyterm:Heart`); pure (ID: `keyterm:Pure`); lei (ID: `keyterm:Law`); legislador (ID: `keyterm:Lawgiver`); Holy Spirit (ID: `deity:HolySpirit`); To Cleanse (ID: `keyterm:Cleanse.2`); Spirit (ID: `keyterm:Spirit.2`); favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); coração (ID: `keyterm:Heart`); Compassionate (ID: `keyterm:Compassionate`); Jó (ID: `person:Job`); be (or show oneself) just (ID: `keyterm:Just`); Name (ID: `keyterm:Name`); corpo (ID: `keyterm:Body.3`); testemunhar (ID: `keyterm:BearWitness`); mui compassivo (ID: `keyterm:FullOfCompassion`); considerar feliz (ID: `keyterm:RegardAsHappy`); decidir (ID: `keyterm:Decided`); condenar (ID: `keyterm:Condemn`); Door (ID: `realia:Door`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); To Sin (ID: `keyterm:Sin`); salvation (ID: `keyterm:Salvation`); SENHOR (ID: `deity:Lord`); céu (ID: `keyterm:Heaven`); crer (ID: `keyterm:Believe`); Truth (ID: `keyterm:Truth`); be (or show oneself) just (ID: `keyterm:Just`); Name (ID: `keyterm:Name`); Oath (ID: `keyterm:Oath`); forgive (ID: `keyterm:Forgive`); autoridade (ID: `keyterm:Authority.2`); igreja (ID: `keyterm:Church`); anointed (ID: `keyterm:Anointed`); Elias (ID: `person:Elijah`); Olive Oil (ID: `realia:OliveOil`)
