...
* **Associated ACAI Concepts:** Loide (ID: `person:Lois`); Eunice (ID: `person:Eunice`); Fígelo (ID: `person:Phygelus`); Hermógenes (ID: `person:Hermogenes`); Onesíforo (ID: `person:Onesiphorus`); desejar (ID: `keyterm:LongFor`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Fileto (ID: `person:Philetus`); Himeneu (ID: `person:Hymenaeus`); aprovado (ID: `keyterm:Approved`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jambres (ID: `person:Jambres`); Janes (ID: `person:Jannes`); Icônio (ID: `place:Iconium`); testemunhar solenemente (ID: `keyterm:Declare`); escritura (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** Crescente (ID: `person:Crescens`); Cláudia (ID: `person:Claudia`); Carpo (ID: `person:Carpus`); Dalmácia (ID: `place:Dalmatia`); Prudente (ID: `person:Pudens`); Parchment (ID: `realia:Parchment`); Êubulo (ID: `person:Eubulus`); Lino (ID: `person:Linus`); Alexandre (ID: `person:Alexander.4`); Onesíforo (ID: `person:Onesiphorus`); livrar (ID: `keyterm:Deliver`); Mileto (ID: `place:Miletus`); Demas (ID: `person:Demas`); Erasto (ID: `person:Erastus`); Trófimo (ID: `person:Trophimus`); Lucas (ID: `person:Luke`); Priscila (ID: `person:Priscilla`); Jesus (ID: `person:Jesus.2`)
