...
* **Associated ACAI Concepts:** testemunhar (ID: `keyterm:BearWitness`); verdadeiro (ID: `keyterm:True`); lei (ID: `keyterm:Law`); Life (ID: `keyterm:Life`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Betânia (ID: `place:Bethany.2`); Strap (ID: `realia:Strap`); Sheep (ID: `fauna:Lamb`); batismo (ID: `keyterm:Baptism`)
...
* **Associated ACAI Concepts:** Natanael (ID: `person:Nathanael`); Filipe (ID: `person:Philip`); André (ID: `person:Andrew`); Nazaré (ID: `place:Nazareth`); A Disciple (ID: `person:GenericDisciple`); João (ID: `person:John.4`); Betsaida (ID: `place:Bethsaida`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Measure (ID: `realia:Measure`); Stone Jar (ID: `realia:StoneJar`); Caná (ID: `place:Cana`); Clay Jar (ID: `realia:ClayJar`); example (ID: `keyterm:Example`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); zelo (ID: `keyterm:Extremely`); Whip (ID: `realia:Whip`); Rope (ID: `realia:Rope`)
...
* **Associated ACAI Concepts:** Nicodemos (ID: `person:Nicodemus`); crer (ID: `keyterm:Believe`); surely! (ID: `keyterm:Surely`); para a eternidade (ID: `keyterm:Always`); love (ID: `keyterm:Love`); Heavenly (ID: `keyterm:Heavenly`); Spirit (ID: `keyterm:Spirit.2`); céu (ID: `keyterm:Heaven`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Salim (ID: `place:Salim`); Enom (ID: `place:Aenon`); Judeans (ID: `group:Judea`); João (ID: `person:John`)
...
* **Associated ACAI Concepts:** Sicar (ID: `place:Sychar`); Jerusalém (ID: `place:Jerusalem`); Samaritans (ID: `group:Samaritan`); prostrar, se (ID: `keyterm:BowDown`); A Woman (ID: `person:GenericFemale`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Galileia (ID: `place:Galilee`); Caná (ID: `place:Cana`); Galileans (ID: `group:Galilee`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Betesda (ID: `place:Bethesda`); Pool (ID: `realia:Pool`); Bed (ID: `realia:Bed`); Sheep Gate (ID: `place:SheepGate`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** tribunal de justiça (ID: `keyterm:CourtCase`); juízo (ID: `keyterm:Judgment`); Life (ID: `keyterm:Life`); Make Alive (ID: `keyterm:Alive`); be (or show oneself) just (ID: `keyterm:Just`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** letra (ID: `keyterm:Letter`); escritura (ID: `keyterm:Scripture`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Barley (ID: `flora:Barley`); Stade (ID: `realia:Stade`); Sea of Galilee (ID: `place:GalileeSea`); Cafarnaum (ID: `place:Capernaum`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** corpo (ID: `keyterm:Body.3`); Tiberíades (ID: `place:Tiberias`); Cafarnaum (ID: `place:Capernaum`); Life (ID: `keyterm:Life`); para a eternidade (ID: `keyterm:Always`); céu (ID: `keyterm:Heaven`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Simão (ID: `person:Simon.7`)
...
* **Associated ACAI Concepts:** Festival of the Tabernacles (ID: `realia:FestivalOfTheTabernacles`); Relatives (ID: `group:Relatives`); Judeia (ID: `place:Judea`); Galileia (ID: `place:Galilee`); injustiça (ID: `keyterm:UnjustDeed`); be (or show oneself) just (ID: `keyterm:Just`); Jews (ID: `group:Jews`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Nicodemos (ID: `person:Nicodemus`); Belém (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Treasury (ID: `realia:Treasury`); verdadeiro (ID: `keyterm:True`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** servir como escravo (ID: `keyterm:Serve.2`); verdadeiro (ID: `keyterm:True`); ser discípulo (ID: `keyterm:Disciple`); Abraão (ID: `person:Abraham`); Truth (ID: `keyterm:Truth`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Parents (ID: `group:Parents`); A Blind Man (ID: `person:BlindMan`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** empregado (ID: `keyterm:HiredWorker`); Sheepfold (ID: `realia:Sheepfold`); A Blind Man (ID: `person:BlindMan`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** blasfemar (ID: `keyterm:Blaspheme`); Porch (ID: `realia:Porch`); para a eternidade (ID: `keyterm:Always`); Jordan River (ID: `place:Jordan`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Lázaro (ID: `person:Lazarus.2`); tropeçar (ID: `keyterm:Stumble`); Maria (ID: `person:Mary.3`); Marta (ID: `person:Martha`); Betânia (ID: `place:Bethany`); Tomé (ID: `person:Thomas`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** levantamento (ID: `keyterm:Resurrection`); Band of Cloth (ID: `realia:BandOfCloth`); Lázaro (ID: `person:Lazarus.2`); Betânia (ID: `place:Bethany`); Maria (ID: `person:Mary.3`); Marta (ID: `person:Martha`); Jews (ID: `group:Jews`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Caifás (ID: `person:Caiaphas`); passover (ID: `keyterm:Passover`)
...
* **Associated ACAI Concepts:** Lázaro (ID: `person:Lazarus.2`); Pound (ID: `realia:Pound`); Oil of Nard (ID: `realia:OilOfNard`); Money Box (ID: `realia:MoneyBox`); Nard (ID: `flora:Nard`); Maria (ID: `person:Mary.3`); Marta (ID: `person:Martha`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Filipe (ID: `person:Philip`); Donkey (ID: `fauna:Donkey`); hosana (ID: `keyterm:Hosanna`); Date Palm (ID: `flora:DatePalm`); Grain (ID: `flora:Grain`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Towel (ID: `realia:Towel`); limpo (ID: `keyterm:Clean`); Bowl (ID: `realia:Bowl`)
...
* **Associated ACAI Concepts:** Money Box (ID: `realia:MoneyBox`); Simão (ID: `person:Simon.7`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Filipe (ID: `person:Philip`); Commandment (ID: `keyterm:Commandment`); Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); Holy Spirit (ID: `deity:HolySpirit`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Judas (ID: `person:Judas`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** escolhido (ID: `keyterm:Chosen`); To Command (ID: `keyterm:Command`); amizade (ID: `keyterm:Friendship`); love (ID: `keyterm:Love`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Cause of Joy (ID: `keyterm:CauseOfJoy`); rogar (ID: `keyterm:AskFor`); ter bom ânimo (ID: `keyterm:CheerUp`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Truth (ID: `keyterm:Truth`); wipe (out), destroy (ID: `keyterm:Destroy`); autoridade (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); Glory (ID: `keyterm:Glory`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Malco (ID: `person:Malchus`); Lantern (ID: `realia:Lantern`); Military Members (ID: `group:MilitaryMembers`); Torch (ID: `realia:Torch`); Sheath (ID: `realia:Sheath`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Caifás (ID: `person:Caiaphas`); Anás (ID: `person:Annas`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Be Lawful (ID: `keyterm:Lawful`); Pilatos (ID: `person:Pilate`); Jews (ID: `group:Jews`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Pilatos (ID: `person:Pilate`); Gabbatha (ID: `place:Gabbatha`); Tibério (ID: `person:Tiberius`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Maria (ID: `person:Mary.4`); Sour Wine (ID: `realia:SourWine`); Cleopas (ID: `person:Cleopas`); Hyssop (ID: `flora:Hyssop`); Nazaré (ID: `place:Nazareth`); Spear (ID: `realia:Spear`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Aloes (ID: `realia:Aloes`); Pound (ID: `realia:Pound`); Grave (ID: `realia:Grave`); Aloes (ID: `flora:Aloes`); Arimateia (ID: `place:Arimathea`); Nicodemos (ID: `person:Nicodemus`); José (ID: `person:Joseph.6`); Myrrh (ID: `realia:Myrrh`)
...
* **Associated ACAI Concepts:** Maria Madalena (ID: `person:Marymagdalene`); Band of Cloth (ID: `realia:BandOfCloth`); Grave (ID: `realia:Grave`); ser discípulo (ID: `keyterm:Disciple`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Tomé (ID: `person:Thomas`); Jesus (ID: `person:Jesus.2`); Nail (ID: `realia:Nail`); ser discípulo (ID: `keyterm:Disciple`)
...
* **Associated ACAI Concepts:** Fish (ID: `fauna:Fish`); Casting Net (ID: `realia:CastingNet`); Natanael (ID: `person:Nathanael`); ser discípulo (ID: `keyterm:Disciple`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); João (ID: `person:John.4`); amizade (ID: `keyterm:Friendship`); Jesus (ID: `person:Jesus.2`)
