...
* **Associated Passages:** João 1:1-18
* **Associated Articles:** Evangelho (ID: `145540@BiblicaStudyNotesKeyTerms`); Bíblia (ID: `145702@BiblicaStudyNotesKeyTerms`); Histórias (ID: `145707@BiblicaStudyNotesKeyTerms`); Deus (ID: `145708@BiblicaStudyNotesKeyTerms`); A palavra de Deus (ID: `145709@BiblicaStudyNotesKeyTerms`); Seres humanos (ID: `145711@BiblicaStudyNotesKeyTerms`); Mundo (ID: `145724@BiblicaStudyNotesKeyTerms`); Jesus (ID: `145728@BiblicaStudyNotesKeyTerms`); Graça (ID: `145744@BiblicaStudyNotesKeyTerms`); João (ID: `146051@BiblicaStudyNotesKeyTerms`); Luz (ID: `146055@BiblicaStudyNotesKeyTerms`); João Batista (ID: `146089@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); testemunhar (ID: `keyterm:BearWitness`); favor (ID: `keyterm:Favor`); Ability (ID: `keyterm:Ability`); Truth (ID: `keyterm:Truth`); crer (ID: `keyterm:Believe`); Name (ID: `keyterm:Name`); corpo (ID: `keyterm:Body.3`); João (ID: `person:John`); lei (ID: `keyterm:Law`); verdadeiro (ID: `keyterm:True`); Life (ID: `keyterm:Life`); sangue (ID: `keyterm:Blood`); autoridade (ID: `keyterm:Authority.2`); Jesus (ID: `person:Jesus.2`); Moisés (ID: `person:Moses`); Glory (ID: `keyterm:Glory`)
...
* **Associated Passages:** João 1:19-34
...
* **Associated ACAI Concepts:** batismo (ID: `keyterm:Baptism`); João (ID: `person:John`); testemunhar (ID: `keyterm:BearWitness`); rogar (ID: `keyterm:AskFor`); Jesus (ID: `person:Jesus.2`); Elias (ID: `person:Elijah`); SENHOR (ID: `deity:Lord`); Holy Spirit (ID: `deity:HolySpirit`); Betânia (ID: `place:Bethany.2`); céu (ID: `keyterm:Heaven`); Pharisees (ID: `group:Pharisee`); Isaías (ID: `person:Isaiah`); Jerusalém (ID: `place:Jerusalem`); Levi (ID: `group:Levi`); Ability (ID: `keyterm:Ability`); Levi (ID: `person:Levi.3`); Jordan River (ID: `place:Jordan`); Jews (ID: `group:Jews`); To Sin (ID: `keyterm:Sin`); Israel (ID: `person:Israel`); Strap (ID: `realia:Strap`); Sheep (ID: `fauna:Lamb`); Dove (ID: `fauna:Dove`); Sandal (ID: `realia:Sandal`)
...
* **Associated Passages:** João 1:35-51
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Natanael (ID: `person:Nathanael`); Filipe (ID: `person:Philip`); Pedro (ID: `person:Peter`); André (ID: `person:Andrew`); Nazaré (ID: `place:Nazareth`); SENHOR (ID: `deity:Lord`); Israel (ID: `person:Israel`); ser discípulo (ID: `keyterm:Disciple`); João (ID: `person:John`); Fig (ID: `flora:Fig`); Betsaida (ID: `place:Bethsaida`); João (ID: `person:John.4`); A Disciple (ID: `person:GenericDisciple`); céu (ID: `keyterm:Heaven`); verdadeiro (ID: `keyterm:True`); An Angel (ID: `deity:Angel`); Galileia (ID: `place:Galilee`); Moisés (ID: `person:Moses`); Israelites (ID: `group:Israel`); lei (ID: `keyterm:Law`); José (ID: `person:Joseph.4`); crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); surely! (ID: `keyterm:Surely`); Sheep (ID: `fauna:Lamb`)
...
* **Associated Passages:** João 2:1-12
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Wine (ID: `realia:Wine`); Caná (ID: `place:Cana`); Galileia (ID: `place:Galilee`); Stone Jar (ID: `realia:StoneJar`); Clay Jar (ID: `realia:ClayJar`); example (ID: `keyterm:Example`); To Cleanse (ID: `keyterm:Cleanse.2`); Cafarnaum (ID: `place:Capernaum`); crer (ID: `keyterm:Believe`); Jews (ID: `group:Jews`); Glory (ID: `keyterm:Glory`); Measure (ID: `realia:Measure`)
...
* **Associated Passages:** João 2:13-25
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); Jesus (ID: `person:Jesus.2`); crer (ID: `keyterm:Believe`); Jews (ID: `group:Jews`); example (ID: `keyterm:Example`); passover (ID: `keyterm:Passover`); Jerusalém (ID: `place:Jerusalem`); ser discípulo (ID: `keyterm:Disciple`); Cattle (ID: `fauna:Bull`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); Dove (ID: `fauna:Dove`); zelo (ID: `keyterm:Extremely`); testemunhar (ID: `keyterm:BearWitness`); escritura (ID: `keyterm:Scripture`); Name (ID: `keyterm:Name`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); levantamento (ID: `keyterm:Resurrection`); Rope (ID: `realia:Rope`); Whip (ID: `realia:Whip`)
...
* **Associated Passages:** João 3:1-21
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Nicodemos (ID: `person:Nicodemus`); surely! (ID: `keyterm:Surely`); Ability (ID: `keyterm:Ability`); Holy Spirit (ID: `deity:HolySpirit`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); love (ID: `keyterm:Love`); reino (ID: `keyterm:Kingdom`); decidir (ID: `keyterm:Decided`); Name (ID: `keyterm:Name`); Life (ID: `keyterm:Life`); céu (ID: `keyterm:Heaven`); Heavenly (ID: `keyterm:Heavenly`); Spirit (ID: `keyterm:Spirit.2`); testemunhar (ID: `keyterm:BearWitness`); tribunal de justiça (ID: `keyterm:CourtCase`); example (ID: `keyterm:Example`); Pharisees (ID: `group:Pharisee`); Truth (ID: `keyterm:Truth`); Moisés (ID: `person:Moses`); corpo (ID: `keyterm:Body.3`); salvation (ID: `keyterm:Salvation`); juízo (ID: `keyterm:Judgment`); Jews (ID: `group:Jews`); Israel (ID: `person:Israel`); Snake (ID: `fauna:Snake`)
...
* **Associated Passages:** João 3:22-36
* **Associated Articles:** Ira de Deus (ID: `146009@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** João (ID: `person:John`); testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`); batismo (ID: `keyterm:Baptism`); céu (ID: `keyterm:Heaven`); Jesus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); ser discípulo (ID: `keyterm:Disciple`); Judeans (ID: `group:Judea`); Enom (ID: `place:Aenon`); Salim (ID: `place:Salim`); To Cleanse (ID: `keyterm:Cleanse.2`); verdadeiro (ID: `keyterm:True`); Judeia (ID: `place:Judea`); para a eternidade (ID: `keyterm:Always`); palavra (ID: `keyterm:Word`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Life (ID: `keyterm:Life`); crer (ID: `keyterm:Believe`); Holy Spirit (ID: `deity:HolySpirit`); Jordan River (ID: `place:Jordan`); love (ID: `keyterm:Love`); Prison (ID: `realia:Prison`)
...
* **Associated Passages:** João 4:1-26
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); prostrar, se (ID: `keyterm:BowDown`); Samaria (ID: `place:Samaria`); A Woman (ID: `person:GenericFemale`); SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Israel (ID: `person:Israel`); ser discípulo (ID: `keyterm:Disciple`); Jerusalém (ID: `place:Jerusalem`); verdadeiro (ID: `keyterm:True`); Truth (ID: `keyterm:Truth`); batismo (ID: `keyterm:Baptism`); Jews (ID: `group:Jews`); Spirit (ID: `keyterm:Spirit.2`); Sicar (ID: `place:Sychar`); Samaritans (ID: `group:Samaritan`); Judeia (ID: `place:Judea`); Pharisees (ID: `group:Pharisee`); José (ID: `person:Joseph.10`); para a eternidade (ID: `keyterm:Always`); Galileia (ID: `place:Galilee`); adorador (ID: `keyterm:Worshiper`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); João (ID: `person:John`); Container (ID: `realia:Container`)
...
* **Associated Passages:** João 4:27-42
* **Associated Articles:** Trabalho (ID: `145717@BiblicaStudyNotesKeyTerms`); Pai (ID: `145821@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); ser discípulo (ID: `keyterm:Disciple`); Samaritans (ID: `group:Samaritan`); rogar (ID: `keyterm:AskFor`); Jesus (ID: `person:Jesus.2`); Samaria (ID: `place:Samaria`); verdadeiro (ID: `keyterm:True`); testemunhar (ID: `keyterm:BearWitness`); A Group of Disciples (ID: `group:GenericDisciples`); A Person (ID: `person:GenericPerson`); Ability (ID: `keyterm:Ability`); para a eternidade (ID: `keyterm:Always`); Life (ID: `keyterm:Life`); salvador (ID: `keyterm:Savior`); Stone Jar (ID: `realia:StoneJar`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated Passages:** João 4:43-54
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Galileia (ID: `place:Galilee`); crer (ID: `keyterm:Believe`); Life (ID: `keyterm:Life`); Judeia (ID: `place:Judea`); example (ID: `keyterm:Example`); Caná (ID: `place:Cana`); Galileans (ID: `group:Galilee`); testemunhar (ID: `keyterm:BearWitness`); maravilha (ID: `keyterm:Portent`); Cafarnaum (ID: `place:Capernaum`); rogar (ID: `keyterm:AskFor`); Public Official (ID: `person:GenericOfficial`); Jerusalém (ID: `place:Jerusalem`); Wine (ID: `realia:Wine`)
...
* **Associated Passages:** João 5:1-15
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Bed (ID: `realia:Bed`); Jews (ID: `group:Jews`); sabbath (ID: `keyterm:Sabbath`); Jerusalém (ID: `place:Jerusalem`); Pool (ID: `realia:Pool`); Sheep Gate (ID: `place:SheepGate`); Betesda (ID: `place:Bethesda`); rogar (ID: `keyterm:AskFor`); To Sin (ID: `keyterm:Sin`); Be Lawful (ID: `keyterm:Lawful`); servir (ID: `keyterm:Serve`); Temple (ID: `realia:Temple`); Porch (ID: `realia:Porch`)
...
* **Associated Passages:** João 5:16-30
* **Associated Articles:** Julgamento (ID: `145742@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); tribunal de justiça (ID: `keyterm:CourtCase`); Life (ID: `keyterm:Life`); juízo (ID: `keyterm:Judgment`); surely! (ID: `keyterm:Surely`); decidir (ID: `keyterm:Decided`); levantamento (ID: `keyterm:Resurrection`); Jesus (ID: `person:Jesus.2`); sabbath (ID: `keyterm:Sabbath`); Jews (ID: `group:Jews`); Make Alive (ID: `keyterm:Alive`); be (or show oneself) just (ID: `keyterm:Just`); autoridade (ID: `keyterm:Authority.2`); amizade (ID: `keyterm:Friendship`); para a eternidade (ID: `keyterm:Always`); Ability (ID: `keyterm:Ability`); crer (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); Grave (ID: `realia:Grave`)
...
* **Associated Passages:** João 5:31-47
* **Associated Articles:** Moisés (ID: `145809@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** testemunhar (ID: `keyterm:BearWitness`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Glory (ID: `keyterm:Glory`); Moisés (ID: `person:Moses`); verdadeiro (ID: `keyterm:True`); Life (ID: `keyterm:Life`); João (ID: `person:John`); escritura (ID: `keyterm:Scripture`); letra (ID: `keyterm:Letter`); Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); salvation (ID: `keyterm:Salvation`); palavra (ID: `keyterm:Word`); para a eternidade (ID: `keyterm:Always`); hope (ID: `keyterm:Hope`); love (ID: `keyterm:Love`)
...
* **Associated Passages:** João 6:1-21

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Ship (ID: `realia:Ship`); example (ID: `keyterm:Example`); fear (ID: `keyterm:Fear`); Filipe (ID: `person:Philip`); Barley (ID: `flora:Barley`); Fish (ID: `fauna:Fish`); Sea of Galilee (ID: `place:GalileeSea`); Cafarnaum (ID: `place:Capernaum`); verdadeiro (ID: `keyterm:True`); passover (ID: `keyterm:Passover`); André (ID: `person:Andrew`); Ability (ID: `keyterm:Ability`); A Group of People (ID: `group:GenericGroup`); Jews (ID: `group:Jews`); Pedro (ID: `person:Peter`); Stade (ID: `realia:Stade`); Denarius (ID: `realia:Denarius`); Basket (ID: `realia:Basket`); Grass (ID: `flora:Grass`)
...
* **Associated Passages:** João 6:22-59
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Jesus (ID: `person:Jesus.2`); céu (ID: `keyterm:Heaven`); corpo (ID: `keyterm:Body.3`); para a eternidade (ID: `keyterm:Always`); crer (ID: `keyterm:Believe`); sangue (ID: `keyterm:Blood`); surely! (ID: `keyterm:Surely`); Cafarnaum (ID: `place:Capernaum`); Ship (ID: `realia:Ship`); example (ID: `keyterm:Example`); Ability (ID: `keyterm:Ability`); Jews (ID: `group:Jews`); ser discípulo (ID: `keyterm:Disciple`); Tiberíades (ID: `place:Tiberias`); verdadeiro (ID: `keyterm:True`); Moisés (ID: `person:Moses`); José (ID: `person:Joseph.4`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated Passages:** João 6:60-71
* **Associated Articles:** Pedro (ID: `146081@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); crer (ID: `keyterm:Believe`); Life (ID: `keyterm:Life`); SENHOR (ID: `deity:Lord`); palavra (ID: `keyterm:Word`); Simão (ID: `person:Simon.7`); A Group of Disciples (ID: `group:GenericDisciples`); corpo (ID: `keyterm:Body.3`); Holy Spirit (ID: `deity:HolySpirit`); Judas (ID: `person:Judas.2`); escolhido (ID: `keyterm:Chosen`); holy (ID: `keyterm:Holy`); para a eternidade (ID: `keyterm:Always`); Pedro (ID: `person:Peter`); Spirit (ID: `keyterm:Spirit.2`)
...
* **Associated Passages:** João 7:1-36
* **Associated Articles:** Glória (ID: `145857@BiblicaStudyNotesKeyTerms`); Festa das Barracas (ID: `145886@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); verdadeiro (ID: `keyterm:True`); A Group of People (ID: `group:GenericGroup`); Moisés (ID: `person:Moses`); Judeia (ID: `place:Judea`); Galileia (ID: `place:Galilee`); Circumcision (ID: `keyterm:Circumcision`); Ability (ID: `keyterm:Ability`); lei (ID: `keyterm:Law`); crer (ID: `keyterm:Believe`); sabbath (ID: `keyterm:Sabbath`); be (or show oneself) just (ID: `keyterm:Just`); injustiça (ID: `keyterm:UnjustDeed`); Relatives (ID: `group:Relatives`); Temple (ID: `realia:Temple`); testemunhar (ID: `keyterm:BearWitness`); tribunal de justiça (ID: `keyterm:CourtCase`); example (ID: `keyterm:Example`); Pharisees (ID: `group:Pharisee`); fear (ID: `keyterm:Fear`); decidir (ID: `keyterm:Decided`); Demons (ID: `deity:Demons`); Javã (ID: `person:Javan`); Jerusalém (ID: `place:Jerusalem`); SENHOR (ID: `deity:Lord`); Greeks (ID: `group:Greek`); To Cause to Happen (ID: `keyterm:Happen`); Good (ID: `keyterm:Good`); juízo (ID: `keyterm:Judgment`); ser discípulo (ID: `keyterm:Disciple`); Glory (ID: `keyterm:Glory`); Festival of the Tabernacles (ID: `realia:FestivalOfTheTabernacles`)
...
* **Associated Passages:** João 7:37-53

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Pharisees (ID: `group:Pharisee`); crer (ID: `keyterm:Believe`); escritura (ID: `keyterm:Scripture`); Galileia (ID: `place:Galilee`); A Group of People (ID: `group:GenericGroup`); lei (ID: `keyterm:Law`); Nicodemos (ID: `person:Nicodemus`); Belém (ID: `place:Bethlehem`); verdadeiro (ID: `keyterm:True`); Davi (ID: `person:David`); decidir (ID: `keyterm:Decided`); Religious Officials (ID: `group:ReligiousOfficials`); compaixão (ID: `keyterm:Affection`); Life (ID: `keyterm:Life`); estômago (ID: `keyterm:Belly`); Holy Spirit (ID: `deity:HolySpirit`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** João 8:1-11
* **Associated Articles:** Fariseus (ID: `145559@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); fornication (ID: `keyterm:Fornication`); sem pecado (ID: `keyterm:WithoutSin`); Pharisees (ID: `group:Pharisee`); rogar (ID: `keyterm:AskFor`); To Sin (ID: `keyterm:Sin`); To Command (ID: `keyterm:Command`); condenar (ID: `keyterm:Condemn`); Moisés (ID: `person:Moses`); lei (ID: `keyterm:Law`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated Passages:** João 8:12-30

* **Associated ACAI Concepts:** verdadeiro (ID: `keyterm:True`); SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); testemunhar (ID: `keyterm:BearWitness`); decidir (ID: `keyterm:Decided`); Ability (ID: `keyterm:Ability`); crer (ID: `keyterm:Believe`); To Sin (ID: `keyterm:Sin`); tribunal de justiça (ID: `keyterm:CourtCase`); Pharisees (ID: `group:Pharisee`); andar (ID: `keyterm:Live.3`); corpo (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); lei (ID: `keyterm:Law`); juízo (ID: `keyterm:Judgment`); Jews (ID: `group:Jews`); palavra (ID: `keyterm:Word`); Treasury (ID: `realia:Treasury`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** João 8:31-59
...
* **Associated ACAI Concepts:** Abraão (ID: `person:Abraham`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Jews (ID: `group:Jews`); Demons (ID: `deity:Demons`); para a eternidade (ID: `keyterm:Always`); crer (ID: `keyterm:Believe`); surely! (ID: `keyterm:Surely`); To Sin (ID: `keyterm:Sin`); Glory (ID: `keyterm:Glory`); verdadeiro (ID: `keyterm:True`); servir como escravo (ID: `keyterm:Serve.2`); ser discípulo (ID: `keyterm:Disciple`); Samaria (ID: `place:Samaria`); Samaritans (ID: `group:Samaritan`); decidir (ID: `keyterm:Decided`); fornication (ID: `keyterm:Fornication`); love (ID: `keyterm:Love`); palavra (ID: `keyterm:Word`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** João 9:1-12

* **Associated ACAI Concepts:** Siloam (ID: `place:Siloam`); Jesus (ID: `person:Jesus.2`); To Sin (ID: `keyterm:Sin`); A Group of People (ID: `group:GenericGroup`); anointed (ID: `keyterm:Anointed`); A Blind Man (ID: `person:BlindMan`); rogar (ID: `keyterm:AskFor`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); ser discípulo (ID: `keyterm:Disciple`); Pool (ID: `realia:Pool`)
...
* **Associated Passages:** João 9:13-34
* **Associated Articles:** Sinagoga (ID: `145560@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); Pharisees (ID: `group:Pharisee`); Moisés (ID: `person:Moses`); Jesus (ID: `person:Jesus.2`); sabbath (ID: `keyterm:Sabbath`); Jews (ID: `group:Jews`); ser discípulo (ID: `keyterm:Disciple`); A Blind Man (ID: `person:BlindMan`); Parents (ID: `group:Parents`); example (ID: `keyterm:Example`); A Father (ID: `person:GenericFather`); fear (ID: `keyterm:Fear`); para a eternidade (ID: `keyterm:Always`); piedoso (ID: `keyterm:GodFearing`); crer (ID: `keyterm:Believe`); To Sin (ID: `keyterm:Sin`); Glory (ID: `keyterm:Glory`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated Passages:** João 9:35-10:21
* **Associated Articles:** Pastor (ID: `145787@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Sheep (ID: `fauna:Lamb`); Jesus (ID: `person:Jesus.2`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Life (ID: `keyterm:Life`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); empregado (ID: `keyterm:HiredWorker`); Demons (ID: `deity:Demons`); Ability (ID: `keyterm:Ability`); surely! (ID: `keyterm:Surely`); Sheepfold (ID: `realia:Sheepfold`); A Blind Man (ID: `person:BlindMan`); autoridade (ID: `keyterm:Authority.2`); estar endemoninhado (ID: `keyterm:DemonPossessed`); Pharisees (ID: `group:Pharisee`); Commandment (ID: `keyterm:Commandment`); Name (ID: `keyterm:Name`); prostrar, se (ID: `keyterm:BowDown`); salvation (ID: `keyterm:Salvation`); juízo (ID: `keyterm:Judgment`); Jews (ID: `group:Jews`); To Sin (ID: `keyterm:Sin`); love (ID: `keyterm:Love`); palavra (ID: `keyterm:Word`); Wolf (ID: `fauna:Wolf`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Jesus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); blasfemar (ID: `keyterm:Blaspheme`); João (ID: `person:John`); Sheep (ID: `fauna:Lamb`); para a eternidade (ID: `keyterm:Always`); Jordan River (ID: `place:Jordan`); testemunhar (ID: `keyterm:BearWitness`); escritura (ID: `keyterm:Scripture`); verdadeiro (ID: `keyterm:True`); example (ID: `keyterm:Example`); Jerusalém (ID: `place:Jerusalem`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); lei (ID: `keyterm:Law`); batismo (ID: `keyterm:Baptism`); consecration (ID: `keyterm:Consecration.2`); Salomão (ID: `person:Solomon`); Porch (ID: `realia:Porch`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** João 11:1-16
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Lázaro (ID: `person:Lazarus.2`); ser discípulo (ID: `keyterm:Disciple`); Marta (ID: `person:Martha`); tropeçar (ID: `keyterm:Stumble`); Maria (ID: `person:Mary.3`); A Group of Disciples (ID: `group:GenericDisciples`); Betânia (ID: `place:Bethany`); Tomé (ID: `person:Thomas`); amizade (ID: `keyterm:Friendship`); Judeia (ID: `place:Judea`); Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); Jews (ID: `group:Jews`); anointed (ID: `keyterm:Anointed`); Glory (ID: `keyterm:Glory`); love (ID: `keyterm:Love`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`)
...
* **Associated Passages:** João 11:17-45
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Marta (ID: `person:Martha`); crer (ID: `keyterm:Believe`); Maria (ID: `person:Mary.3`); Jews (ID: `group:Jews`); SENHOR (ID: `deity:Lord`); levantamento (ID: `keyterm:Resurrection`); Grave (ID: `realia:Grave`); Life (ID: `keyterm:Life`); Lázaro (ID: `person:Lazarus.2`); Betânia (ID: `place:Bethany`); House (ID: `realia:House`); amizade (ID: `keyterm:Friendship`); Glory (ID: `keyterm:Glory`); para a eternidade (ID: `keyterm:Always`); Jerusalém (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Spirit (ID: `keyterm:Spirit.2`); Band of Cloth (ID: `realia:BandOfCloth`); Temple (ID: `realia:Temple`); Stade (ID: `realia:Stade`)
...
* **Associated Passages:** João 11:46-57
* **Associated Articles:** Sinédrio (ID: `145576@BiblicaStudyNotesKeyTerms`); Sumo sacerdote (ID: `145877@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Pharisees (ID: `group:Pharisee`); Jews (ID: `group:Jews`); passover (ID: `keyterm:Passover`); Caifás (ID: `person:Caiaphas`); pure (ID: `keyterm:Pure`); crer (ID: `keyterm:Believe`); Commandment (ID: `keyterm:Commandment`); speak (ID: `keyterm:Speak`); SENHOR (ID: `deity:Lord`); Roma (ID: `place:Rome`); Jerusalém (ID: `place:Jerusalem`); Efraim (ID: `place:Ephraim`); example (ID: `keyterm:Example`); ser discípulo (ID: `keyterm:Disciple`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** João 12:1-11
* **Associated Articles:** Betânia (ID: `145584@BiblicaStudyNotesKeyTerms`); Judas (ID: `145603@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Lázaro (ID: `person:Lazarus.2`); levantamento (ID: `keyterm:Resurrection`); Jews (ID: `group:Jews`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Marta (ID: `person:Martha`); Maria (ID: `person:Mary.3`); passover (ID: `keyterm:Passover`); Judas (ID: `person:Judas.2`); pure (ID: `keyterm:Pure`); Betânia (ID: `place:Bethany`); crer (ID: `keyterm:Believe`); anointed (ID: `keyterm:Anointed`); ser discípulo (ID: `keyterm:Disciple`); servir (ID: `keyterm:Serve`); Nard (ID: `flora:Nard`); Oil of Nard (ID: `realia:OilOfNard`); Money Box (ID: `realia:MoneyBox`); Pound (ID: `realia:Pound`); House (ID: `realia:House`); Denarius (ID: `realia:Denarius`)
...
* **Associated Passages:** João 12:12-36
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Glory (ID: `keyterm:Glory`); Filipe (ID: `person:Philip`); Jerusalém (ID: `place:Jerusalem`); para a eternidade (ID: `keyterm:Always`); Name (ID: `keyterm:Name`); A Group of People (ID: `group:GenericGroup`); Donkey (ID: `fauna:Donkey`); hosana (ID: `keyterm:Hosanna`); testemunhar (ID: `keyterm:BearWitness`); céu (ID: `keyterm:Heaven`); rogar (ID: `keyterm:AskFor`); Betsaida (ID: `place:Bethsaida`); tribunal de justiça (ID: `keyterm:CourtCase`); example (ID: `keyterm:Example`); Lázaro (ID: `person:Lazarus.2`); amizade (ID: `keyterm:Friendship`); bless (ID: `keyterm:Bless`); Pharisees (ID: `group:Pharisee`); André (ID: `person:Andrew`); fear (ID: `keyterm:Fear`); Javã (ID: `person:Javan`); An Angel (ID: `deity:Angel`); Religious Officials (ID: `group:ReligiousOfficials`); Galileia (ID: `place:Galilee`); andar (ID: `keyterm:Live.3`); prostrar, se (ID: `keyterm:BowDown`); Greeks (ID: `group:Greek`); Life (ID: `keyterm:Life`); lei (ID: `keyterm:Law`); levantamento (ID: `keyterm:Resurrection`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); juízo (ID: `keyterm:Judgment`); surely! (ID: `keyterm:Surely`); Israel (ID: `person:Israel`); ser discípulo (ID: `keyterm:Disciple`); servir (ID: `keyterm:Serve`); Date Palm (ID: `flora:DatePalm`); Grain (ID: `flora:Grain`); Grave (ID: `realia:Grave`); Wheat (ID: `flora:Wheat`)
...
* **Associated Passages:** João 12:37-50
* **Associated Articles:** Boas novas (ID: `145552@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Isaías (ID: `person:Isaiah`); Commandment (ID: `keyterm:Commandment`); decidir (ID: `keyterm:Decided`); Ability (ID: `keyterm:Ability`); Glory (ID: `keyterm:Glory`); palavra (ID: `keyterm:Word`); coração (ID: `keyterm:Heart`); Pharisees (ID: `group:Pharisee`); To Cause to Happen (ID: `keyterm:Happen`); salvation (ID: `keyterm:Salvation`); Jesus (ID: `person:Jesus.2`); para a eternidade (ID: `keyterm:Always`); example (ID: `keyterm:Example`); Life (ID: `keyterm:Life`); love (ID: `keyterm:Love`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated Passages:** João 13:1-17
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Pedro (ID: `person:Peter`); limpo (ID: `keyterm:Clean`); SENHOR (ID: `deity:Lord`); Towel (ID: `realia:Towel`); Clothing (ID: `realia:Clothing`); coração (ID: `keyterm:Heart`); passover (ID: `keyterm:Passover`); Simão (ID: `person:Simon.7`); Judas (ID: `person:Judas.2`); Ability (ID: `keyterm:Ability`); surely! (ID: `keyterm:Surely`); dever (ID: `keyterm:Ought`); bem, aventurado (ID: `keyterm:Happy`); para a eternidade (ID: `keyterm:Always`); ser discípulo (ID: `keyterm:Disciple`); love (ID: `keyterm:Love`); Bowl (ID: `realia:Bowl`)
...
* **Associated Passages:** João 13:18-38

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); surely! (ID: `keyterm:Surely`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); love (ID: `keyterm:Love`); Judas (ID: `person:Judas.2`); SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Glory (ID: `keyterm:Glory`); Simão (ID: `person:Simon.7`); testemunhar (ID: `keyterm:BearWitness`); escritura (ID: `keyterm:Scripture`); Spirit (ID: `keyterm:Spirit.2`); Commandment (ID: `keyterm:Commandment`); escolhido (ID: `keyterm:Chosen`); Satanás (ID: `deity:Satan`); To Cause to Happen (ID: `keyterm:Happen`); crer (ID: `keyterm:Believe`); Jews (ID: `group:Jews`); Money Box (ID: `realia:MoneyBox`); Rooster (ID: `fauna:Rooster`)
...
* **Associated Passages:** João 14:1-21

* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Commandment (ID: `keyterm:Commandment`); Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); Holy Spirit (ID: `deity:HolySpirit`); Filipe (ID: `person:Philip`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); coração (ID: `keyterm:Heart`); rogar (ID: `keyterm:AskFor`); para a eternidade (ID: `keyterm:Always`); Tomé (ID: `person:Thomas`); surely! (ID: `keyterm:Surely`); Glory (ID: `keyterm:Glory`); palavra (ID: `keyterm:Word`); House (ID: `realia:House`)
...
* **Associated Passages:** João 14:22-31
* **Associated Articles:** Judas (ID: `145603@BiblicaStudyNotesKeyTerms`); Paz (ID: `145720@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); love (ID: `keyterm:Love`); Judas (ID: `person:Judas`); coração (ID: `keyterm:Heart`); Name (ID: `keyterm:Name`); crer (ID: `keyterm:Believe`); Holy Spirit (ID: `deity:HolySpirit`); fazer a paz (ID: `keyterm:Peace`); Jesus (ID: `person:Jesus.2`); Judas (ID: `person:Judas.2`); To Command (ID: `keyterm:Command`)
...
* **Associated Passages:** João 15:1-27
* **Associated Articles:** Ame a Deus (ID: `145864@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); Vine (ID: `flora:Vine`); To Command (ID: `keyterm:Command`); escolhido (ID: `keyterm:Chosen`); testemunhar (ID: `keyterm:BearWitness`); Commandment (ID: `keyterm:Commandment`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); To Sin (ID: `keyterm:Sin`); amizade (ID: `keyterm:Friendship`); verdadeiro (ID: `keyterm:True`); Truth (ID: `keyterm:Truth`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Life (ID: `keyterm:Life`); limpo (ID: `keyterm:Clean`); lei (ID: `keyterm:Law`); To Cause to Happen (ID: `keyterm:Happen`); Holy Spirit (ID: `deity:HolySpirit`); ser discípulo (ID: `keyterm:Disciple`); Glory (ID: `keyterm:Glory`); palavra (ID: `keyterm:Word`)
...
* **Associated Passages:** João 16:1-15
* **Associated Articles:** Maltradado (ID: `145563@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Truth (ID: `keyterm:Truth`); Holy Spirit (ID: `deity:HolySpirit`); juízo (ID: `keyterm:Judgment`); Ability (ID: `keyterm:Ability`); To Sin (ID: `keyterm:Sin`); be (or show oneself) just (ID: `keyterm:Just`); tribunal de justiça (ID: `keyterm:CourtCase`); coração (ID: `keyterm:Heart`); crer (ID: `keyterm:Believe`); rogar (ID: `keyterm:AskFor`); decidir (ID: `keyterm:Decided`); priesthood (ID: `keyterm:Priesthood`); Glory (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated Passages:** João 16:16-33

* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); rogar (ID: `keyterm:AskFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ability (ID: `keyterm:Ability`); Name (ID: `keyterm:Name`); crer (ID: `keyterm:Believe`); A Group of Disciples (ID: `group:GenericDisciples`); Jesus (ID: `person:Jesus.2`); surely! (ID: `keyterm:Surely`); ser discípulo (ID: `keyterm:Disciple`); ter bom ânimo (ID: `keyterm:CheerUp`); coração (ID: `keyterm:Heart`); amizade (ID: `keyterm:Friendship`); fazer a paz (ID: `keyterm:Peace`)
...
* **Associated Passages:** João 17:1-26

* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); SENHOR (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); Name (ID: `keyterm:Name`); rogar (ID: `keyterm:AskFor`); crer (ID: `keyterm:Believe`); love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); verdadeiro (ID: `keyterm:True`); para a eternidade (ID: `keyterm:Always`); Life (ID: `keyterm:Life`); consecration (ID: `keyterm:Consecration.2`); Jesus (ID: `person:Jesus.2`); autoridade (ID: `keyterm:Authority.2`); wipe (out), destroy (ID: `keyterm:Destroy`); escritura (ID: `keyterm:Scripture`); céu (ID: `keyterm:Heaven`); be (or show oneself) just (ID: `keyterm:Just`); corpo (ID: `keyterm:Body.3`); Cause of Joy (ID: `keyterm:CauseOfJoy`); To Cause to Happen (ID: `keyterm:Happen`); holy (ID: `keyterm:Holy`); palavra (ID: `keyterm:Word`)
...
* **Associated Passages:** João 18:1-11

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Judas (ID: `person:Judas.2`); Nazaré (ID: `place:Nazareth`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Malco (ID: `person:Malchus`); Military Members (ID: `group:MilitaryMembers`); Name (ID: `keyterm:Name`); Pharisees (ID: `group:Pharisee`); To Cause to Happen (ID: `keyterm:Happen`); Cedrom (ID: `place:Kidron`); SENHOR (ID: `deity:Lord`); Public Officials (ID: `group:GenericOfficials`); Torch (ID: `realia:Torch`); Sheath (ID: `realia:Sheath`); Lantern (ID: `realia:Lantern`)
...
* **Associated Passages:** João 18:12-27

* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Caifás (ID: `person:Caiaphas`); Jews (ID: `group:Jews`); Anás (ID: `person:Annas`); rogar (ID: `keyterm:AskFor`); A Servant (ID: `person:GenericServant`); testemunhar (ID: `keyterm:BearWitness`); Ability (ID: `keyterm:Ability`); Temple (ID: `realia:Temple`); Rooster (ID: `fauna:Rooster`); Synagogue (ID: `realia:Synagogue`); Door (ID: `realia:Door`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated Passages:** João 18:28-40
* **Associated Articles:** Roma (ID: `145556@BiblicaStudyNotesKeyTerms`); Barrabás (ID: `145585@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Pilatos (ID: `person:Pilate`); Truth (ID: `keyterm:Truth`); passover (ID: `keyterm:Passover`); Ability (ID: `keyterm:Ability`); Palace (ID: `realia:Palace`); Be Lawful (ID: `keyterm:Lawful`); Barrabás (ID: `person:Barabbas`); testemunhar (ID: `keyterm:BearWitness`); To Cause to Happen (ID: `keyterm:Happen`); reino (ID: `keyterm:Kingdom`); decidir (ID: `keyterm:Decided`); Caifás (ID: `person:Caiaphas`); defilement (ID: `keyterm:Defilement`); lei (ID: `keyterm:Law`)
...
* **Associated Passages:** João 19:1-16
* **Associated Articles:** César (ID: `145543@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Pilatos (ID: `person:Pilate`); Jesus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Cross (ID: `realia:Cross`); Tibério (ID: `person:Tiberius`); autoridade (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); Crown (ID: `realia:Crown.2`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Cloak (ID: `realia:Cloak`); Crown (ID: `realia:Crown`); Gabbatha (ID: `place:Gabbatha`); dever (ID: `keyterm:Ought`); passover (ID: `keyterm:Passover`); fear (ID: `keyterm:Fear`); lei (ID: `keyterm:Law`); To Sin (ID: `keyterm:Sin`); Palace (ID: `realia:Palace`); Judgment Seat (ID: `realia:JudgmentSeat`)
...
* **Associated Passages:** João 19:17-37
* **Associated Articles:** Zacarias (ID: `146020@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Cross (ID: `realia:Cross`); escritura (ID: `keyterm:Scripture`); Pilatos (ID: `person:Pilate`); Jews (ID: `group:Jews`); To Cause to Happen (ID: `keyterm:Happen`); ser discípulo (ID: `keyterm:Disciple`); Sour Wine (ID: `realia:SourWine`); Clothing (ID: `realia:Clothing`); Cleopas (ID: `person:Cleopas`); Nazaré (ID: `place:Nazareth`); Maria (ID: `person:Mary.4`); testemunhar (ID: `keyterm:BearWitness`); Priests (ID: `group:GenericPriests`); rogar (ID: `keyterm:AskFor`); verdadeiro (ID: `keyterm:True`); corpo (ID: `keyterm:Body.3`); sangue (ID: `keyterm:Blood`); sabbath (ID: `keyterm:Sabbath`); Golgotha (ID: `place:Golgotha`); Maria Madalena (ID: `person:Marymagdalene`); Spirit (ID: `keyterm:Spirit.2`); love (ID: `keyterm:Love`); Hyssop (ID: `flora:Hyssop`); Spear (ID: `realia:Spear`); Tunic (ID: `realia:Tunic.2`); Lot (ID: `realia:Lot`)
...
* **Associated Passages:** João 19:38-42

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Aloes (ID: `realia:Aloes`); corpo (ID: `keyterm:Body.3`); Grave (ID: `realia:Grave`); Nicodemos (ID: `person:Nicodemus`); José (ID: `person:Joseph.6`); Arimateia (ID: `place:Arimathea`); rogar (ID: `keyterm:AskFor`); fear (ID: `keyterm:Fear`); Pilatos (ID: `person:Pilate`); ser discípulo (ID: `keyterm:Disciple`); Pound (ID: `realia:Pound`); Myrrh (ID: `realia:Myrrh`); Aloes (ID: `flora:Aloes`); Linen (ID: `realia:Linen`); Cross (ID: `realia:Cross`); Myrrh (ID: `flora:Myrrh`)
...
* **Associated Passages:** João 20:1-18
* **Associated Articles:** Maria Madalena (ID: `145577@BiblicaStudyNotesKeyTerms`); Anjo (ID: `145822@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Grave (ID: `realia:Grave`); Maria Madalena (ID: `person:Marymagdalene`); Pedro (ID: `person:Peter`); Linen (ID: `realia:Linen`); escritura (ID: `keyterm:Scripture`); crer (ID: `keyterm:Believe`); corpo (ID: `keyterm:Body.3`); amizade (ID: `keyterm:Friendship`); Week (ID: `keyterm:Week`); SENHOR (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Band of Cloth (ID: `realia:BandOfCloth`)
...
* **Associated Passages:** João 20:19-31
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Tomé (ID: `person:Thomas`); fazer a paz (ID: `keyterm:Peace`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Door (ID: `realia:Door`); forgive (ID: `keyterm:Forgive`); bem, aventurado (ID: `keyterm:Happy`); example (ID: `keyterm:Example`); be unfaithful (ID: `keyterm:Unfaithful`); A Group of Disciples (ID: `group:GenericDisciples`); fear (ID: `keyterm:Fear`); Faithfulness (ID: `keyterm:Faithfulness`); Name (ID: `keyterm:Name`); Life (ID: `keyterm:Life`); Holy Spirit (ID: `deity:HolySpirit`); Week (ID: `keyterm:Week`); Jews (ID: `group:Jews`); To Sin (ID: `keyterm:Sin`); Nail (ID: `realia:Nail`)
...
* **Associated Passages:** João 21:1-14
* **Associated Articles:** Criação (ID: `145706@BiblicaStudyNotesKeyTerms`); Sabedoria (ID: `145834@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Fish (ID: `fauna:Fish`); Pedro (ID: `person:Peter`); Casting Net (ID: `realia:CastingNet`); Ship (ID: `realia:Ship`); Fishnet (ID: `realia:Fishnet`); Natanael (ID: `person:Nathanael`); levantamento (ID: `keyterm:Resurrection`); autoridade (ID: `keyterm:Authority.2`); Zebedeu (ID: `person:Zebedee`); Caná (ID: `place:Cana`); Tomé (ID: `person:Thomas`); Sea of Galilee (ID: `place:GalileeSea`); love (ID: `keyterm:Love`); Galileia (ID: `place:Galilee`); Cloak (ID: `realia:Cloak`); Cubit (ID: `realia:Cubit.2`)
...
* **Associated Passages:** João 21:15-25

* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Pedro (ID: `person:Peter`); João (ID: `person:John.4`); amizade (ID: `keyterm:Friendship`); ser discípulo (ID: `keyterm:Disciple`); love (ID: `keyterm:Love`); Sheep (ID: `fauna:Lamb`); testemunhar (ID: `keyterm:BearWitness`); Ability (ID: `keyterm:Ability`); surely! (ID: `keyterm:Surely`); SENHOR (ID: `deity:Lord`); verdadeiro (ID: `keyterm:True`); Glory (ID: `keyterm:Glory`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Scroll (ID: `realia:Scroll`)
