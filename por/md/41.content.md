...
* **Associated ACAI Concepts:** João (ID: `person:John`); proclamar (ID: `keyterm:Proclaim`); boa notícia (ID: `keyterm:GoodNews`); Zebedeu (ID: `person:Zebedee`); Galileia (ID: `place:Galilee`); Jordan River (ID: `place:Jordan`); Strap (ID: `realia:Strap`); empregado (ID: `keyterm:HiredWorker`); Sea of Galilee (ID: `place:GalileeSea`); Tiago (ID: `person:James`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); Galileia (ID: `place:Galilee`); Cafarnaum (ID: `place:Capernaum`)
...
* **Associated ACAI Concepts:** Alfeu (ID: `person:Alphaeus.2`); Bed (ID: `realia:Bed`); Patch (ID: `realia:Patch`); Mateus (ID: `person:Matthew`); Housetop (ID: `realia:Housetop`); Cafarnaum (ID: `place:Capernaum`); Skin-Bottle (ID: `realia:Skin-bottle`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Idumeia (ID: `place:Idumea`); Zelote (ID: `group:Zealot`); Bartolomeu (ID: `person:Bartholomew`); Alfeu (ID: `person:Alphaeus`); Tiago (ID: `person:James.2`); Tiago (ID: `person:James`); João (ID: `person:John.2`)
...
* **Associated ACAI Concepts:** Cushion (ID: `realia:Cushion`); estar endemoninhado (ID: `keyterm:DemonPossessed`); Legião (ID: `deity:Legion`); Fetter (ID: `realia:Fetter`); Chain (ID: `realia:Chain`); Decápolis (ID: `place:Decapolis`); Gerasa (ID: `place:Gerasa`); To Command (ID: `keyterm:Command`)
...
* **Associated ACAI Concepts:** José (ID: `person:Joseph.3`); Simão (ID: `person:Simon.3`); Judas (ID: `person:Jude`); não crer (ID: `keyterm:Disbelieve`)
...
* **Associated ACAI Concepts:** Herodes Antipas (ID: `person:Herod.2`); Herodias (ID: `person:Herodias`); Plate (ID: `realia:Plate.2`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Filipe (ID: `person:Philip.2`); João (ID: `person:John`)
...
* **Associated ACAI Concepts:** tradição (ID: `keyterm:Teaching`); Pharisees (ID: `group:Pharisee`); Tesouro do templo (ID: `place:Corban`); defilement (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** Syrophoenicians (ID: `group:Phoenicia`); Tiro (ID: `place:Tyre`); Decápolis (ID: `place:Decapolis`); Fenícia (ID: `place:Phoenicia`); Greeks (ID: `group:Greek`); Sidom (ID: `place:Sidon`)
...
* **Associated ACAI Concepts:** Cesareia de Filipos (ID: `place:CaesareaPhilippi`); Betsaida (ID: `place:Bethsaida`); batista (ID: `keyterm:Baptist`)
...
* **Associated ACAI Concepts:** fazer tropeçar (ID: `keyterm:CauseToStumble`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Bartimeu (ID: `person:Bartimaeus`); Timeu (ID: `person:Timaeus`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** hosana (ID: `keyterm:Hosanna`); Betânia (ID: `place:Bethany`); Betfagé (ID: `place:Bethphage`); Rush (ID: `flora:Rush`); Jerusalém (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Herodians (ID: `group:Herodian`); Denarius (ID: `realia:Denarius`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `realia:Myrrh`); Simão (ID: `person:Simon.4`); Oil of Nard (ID: `realia:OilOfNard`); Alabaster Jar (ID: `realia:AlabasterJar`); Nard (ID: `flora:Nard`); Betânia (ID: `place:Bethany`)
...
* **Associated ACAI Concepts:** Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); sangue (ID: `keyterm:Blood`)
...
* **Associated ACAI Concepts:** Centurion at Crucifixion (ID: `person:Centurion.3`); Alexandre (ID: `person:Alexander`); Rufo (ID: `person:Rufus`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Simão (ID: `person:Simon.5`); Purple Cloth (ID: `realia:PurpleCloth`); Golgotha (ID: `place:Golgotha`); Palace (ID: `realia:Palace`); Cirene (ID: `place:Cyrene`); Myrrh (ID: `flora:Myrrh`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Maria (ID: `person:Mary.2`); José (ID: `person:Joseph.6`); José (ID: `person:Joseph.3`); José (ID: `person:Joseph.5`); Tiago (ID: `person:James.4`); Salomé (ID: `person:Salome`); Arimateia (ID: `place:Arimathea`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Salomé (ID: `person:Salome`); Angels (ID: `group:Angels`); Maria (ID: `person:Mary.2`)
