...
* **Associated ACAI Concepts:** João (ID: `person:John`); batismo (ID: `keyterm:Baptism`); Jesus (ID: `person:Jesus.2`); boa notícia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); SENHOR (ID: `deity:Lord`); Holy Spirit (ID: `deity:HolySpirit`); Jordan River (ID: `place:Jordan`); Galileia (ID: `place:Galilee`); Zebedeu (ID: `person:Zebedee`); To Sin (ID: `keyterm:Sin`); céu (ID: `keyterm:Heaven`); arrepender, se (ID: `keyterm:Repent`); An Angel (ID: `deity:Angel`); Ship (ID: `realia:Ship`); Casting Net (ID: `realia:CastingNet`); Fishnet (ID: `realia:Fishnet`); Sea of Galilee (ID: `place:GalileeSea`); empregado (ID: `keyterm:HiredWorker`); Tiago (ID: `person:James`); João (ID: `person:John.2`); Judeia (ID: `place:Judea`); forgive (ID: `keyterm:Forgive`); crer (ID: `keyterm:Believe`); straightness (ID: `keyterm:Straightness`); Isaías (ID: `person:Isaiah`); tentar (ID: `keyterm:PutToTheTest`); Satanás (ID: `deity:Satan`); Pedro (ID: `person:Peter`); Nazaré (ID: `place:Nazareth`); Jerusalém (ID: `place:Jerusalem`); servir (ID: `keyterm:Serve`); reino (ID: `keyterm:Kingdom`); amado (ID: `keyterm:Beloved`); André (ID: `person:Andrew`); Strap (ID: `realia:Strap`); Bag (ID: `realia:Bag`); Belt (ID: `realia:Belt`); Dove (ID: `fauna:Dove`); Bee (ID: `fauna:Bee`); Camel (ID: `fauna:Camel`); Locust (ID: `fauna:Locust`); Sandal (ID: `realia:Sandal`); Leather (ID: `realia:Leather`)
...
* **Associated ACAI Concepts:** To Cleanse (ID: `keyterm:Cleanse.2`); Synagogue (ID: `realia:Synagogue`); Pedro (ID: `person:Peter`); proclamar (ID: `keyterm:Proclaim`); Galileia (ID: `place:Galilee`); Ability (ID: `keyterm:Ability`); Demons (ID: `deity:Demons`); autoridade (ID: `keyterm:Authority.2`); servir (ID: `keyterm:Serve`); Jesus (ID: `person:Jesus.2`); Cafarnaum (ID: `place:Capernaum`); estar endemoninhado (ID: `keyterm:DemonPossessed`); João (ID: `person:John.2`); To Command (ID: `keyterm:Command`); testemunhar (ID: `keyterm:BearWitness`); sabbath (ID: `keyterm:Sabbath`); Tiago (ID: `person:James`); SENHOR (ID: `deity:Lord`); Moisés (ID: `person:Moses`); Nazaré (ID: `place:Nazareth`); rogar (ID: `keyterm:AskFor`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); orar (ID: `keyterm:Pray`); holy (ID: `keyterm:Holy`); offering (ID: `keyterm:Offering`); André (ID: `person:Andrew`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); To Sin (ID: `keyterm:Sin`); forgive (ID: `keyterm:Forgive`); Bed (ID: `realia:Bed`); jejuar (ID: `keyterm:Fast`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); cobrador de impostos (ID: `keyterm:TaxCollector`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`); Pharisees (ID: `group:Pharisee`); Temple (ID: `realia:Temple`); Mateus (ID: `person:Matthew`); Alfeu (ID: `person:Alphaeus.2`); Cafarnaum (ID: `place:Capernaum`); Glory (ID: `keyterm:Glory`); crer (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); João (ID: `person:John`); autoridade (ID: `keyterm:Authority.2`); be (or show oneself) just (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); Be Healthy (ID: `keyterm:Healthy`); coletoria (ID: `keyterm:TaxOffice`); Spirit (ID: `keyterm:Spirit.2`); Skin-Bottle (ID: `realia:Skin-bottle`); Patch (ID: `realia:Patch`); Housetop (ID: `realia:Housetop`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** sabbath (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); Pharisees (ID: `group:Pharisee`); Herodians (ID: `group:Herodian`); Abiatar (ID: `person:Abiathar`); servir (ID: `keyterm:Serve`); Davi (ID: `person:David`); ser discípulo (ID: `keyterm:Disciple`); salvation (ID: `keyterm:Salvation`); Life (ID: `keyterm:Life`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`); Wheat (ID: `flora:Wheat`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`); House (ID: `realia:House`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Name (ID: `keyterm:Name`); Bartolomeu (ID: `person:Bartholomew`); João (ID: `person:John.2`); Alfeu (ID: `person:Alphaeus`); Tiago (ID: `person:James.2`); Tiago (ID: `person:James`); Zelote (ID: `group:Zealot`); Idumeia (ID: `place:Idumea`); Mateus (ID: `person:Matthew`); Judeia (ID: `place:Judea`); To Command (ID: `keyterm:Command`); Galileia (ID: `place:Galilee`); Tomé (ID: `person:Thomas`); Tiro (ID: `place:Tyre`); Zebedeu (ID: `person:Zebedee`); Ability (ID: `keyterm:Ability`); Judas (ID: `person:Judas.2`); Jordan River (ID: `place:Jordan`); Judas (ID: `person:Judas`); Pedro (ID: `person:Peter`); Jerusalém (ID: `place:Jerusalem`); Sidom (ID: `place:Sidon`); Demons (ID: `deity:Demons`); autoridade (ID: `keyterm:Authority.2`); Simão (ID: `person:Simon.2`); servir (ID: `keyterm:Serve`); Jesus (ID: `person:Jesus.2`); Filipe (ID: `person:Philip`); proclamar (ID: `keyterm:Proclaim`); André (ID: `person:Andrew`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Satanás (ID: `deity:Satan`); blasfemar (ID: `keyterm:Blaspheme`); forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); House (ID: `realia:House`); Jerusalém (ID: `place:Jerusalem`); surely! (ID: `keyterm:Surely`); para a eternidade (ID: `keyterm:Always`); Demons (ID: `deity:Demons`); reino (ID: `keyterm:Kingdom`); parábola (ID: `keyterm:Parable`); SENHOR (ID: `deity:Lord`); Religious Officials (ID: `group:ReligiousOfficials`); Holy Spirit (ID: `deity:HolySpirit`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** parábola (ID: `keyterm:Parable`); Grain (ID: `flora:Grain`); SENHOR (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Barley (ID: `flora:Barley`); Grass (ID: `flora:Grass`); Cause of Joy (ID: `keyterm:CauseOfJoy`); forgive (ID: `keyterm:Forgive`); Ability (ID: `keyterm:Ability`); céu (ID: `keyterm:Heaven`); Satanás (ID: `deity:Satan`); rogar (ID: `keyterm:AskFor`); ser discípulo (ID: `keyterm:Disciple`); para a eternidade (ID: `keyterm:Always`); Mustard (ID: `flora:Mustard`); Wheat (ID: `flora:Wheat`); Bird (ID: `fauna:Bird`); Bed (ID: `realia:Bed`); Rooster (ID: `fauna:Rooster`); Ship (ID: `realia:Ship`); Sickle (ID: `realia:Sickle`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); Jesus (ID: `person:Jesus.2`); estar endemoninhado (ID: `keyterm:DemonPossessed`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); Ship (ID: `realia:Ship`); Grave (ID: `realia:Grave`); SENHOR (ID: `deity:Lord`); fear (ID: `keyterm:Fear`); Chain (ID: `realia:Chain`); To Command (ID: `keyterm:Command`); Decápolis (ID: `place:Decapolis`); Legião (ID: `deity:Legion`); Gerasa (ID: `place:Gerasa`); prostrar, se (ID: `keyterm:BowDown`); crer (ID: `keyterm:Believe`); calar (ID: `keyterm:BecomeStill`); misericórdia (ID: `keyterm:Mercy`); autoridade (ID: `keyterm:Authority.2`); Name (ID: `keyterm:Name`); proclamar (ID: `keyterm:Proclaim`); Cushion (ID: `realia:Cushion`); Fetter (ID: `realia:Fetter`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); salvation (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`); crer (ID: `keyterm:Believe`); fear (ID: `keyterm:Fear`); Jairo (ID: `person:Jairus`); João (ID: `person:John.2`); Ability (ID: `keyterm:Ability`); Truth (ID: `keyterm:Truth`); A Group of Disciples (ID: `group:GenericDisciples`); Tiago (ID: `person:James`); corpo (ID: `keyterm:Body.3`); Pedro (ID: `person:Peter`); rogar (ID: `keyterm:AskFor`); Life (ID: `keyterm:Life`); ser discípulo (ID: `keyterm:Disciple`); fazer a paz (ID: `keyterm:Peace`); Name (ID: `keyterm:Name`); sangue (ID: `keyterm:Blood`); House (ID: `realia:House`); Ship (ID: `realia:Ship`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); servir (ID: `keyterm:Serve`); Simão (ID: `person:Simon.3`); José (ID: `person:Joseph.3`); não crer (ID: `keyterm:Disbelieve`); Judas (ID: `person:Jude`); testemunhar (ID: `keyterm:BearWitness`); sabbath (ID: `keyterm:Sabbath`); Tiago (ID: `person:James.3`); Maria (ID: `person:Mary`); anointed (ID: `keyterm:Anointed`); arrepender, se (ID: `keyterm:Repent`); Demons (ID: `deity:Demons`); autoridade (ID: `keyterm:Authority.2`); Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); proclamar (ID: `keyterm:Proclaim`); Bag (ID: `realia:Bag`); Staff (ID: `realia:Staff`); Olive Oil (ID: `realia:OliveOil`); House (ID: `realia:House`); Belt (ID: `realia:Belt`); Tunic (ID: `realia:Tunic.2`); Sandal (ID: `realia:Sandal`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Herodes Antipas (ID: `person:Herod.2`); João (ID: `person:John`); Herodias (ID: `person:Herodias`); batismo (ID: `keyterm:Baptism`); levantamento (ID: `keyterm:Resurrection`); Plate (ID: `realia:Plate.2`); Prison (ID: `realia:Prison`); Filipe (ID: `person:Philip.2`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Galileia (ID: `place:Galilee`); Oath (ID: `keyterm:Oath`); Ability (ID: `keyterm:Ability`); prontidão (ID: `keyterm:Haste`); A Group of People (ID: `group:GenericGroup`); Elias (ID: `person:Elijah`); batista (ID: `keyterm:Baptist`); fear (ID: `keyterm:Fear`); be (or show oneself) just (ID: `keyterm:Just`); Be Lawful (ID: `keyterm:Lawful`); ser discípulo (ID: `keyterm:Disciple`); holy (ID: `keyterm:Holy`); Name (ID: `keyterm:Name`); reino (ID: `keyterm:Kingdom`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Fish (ID: `fauna:Fish`); ser discípulo (ID: `keyterm:Disciple`); compaixão (ID: `keyterm:Affection`); Jesus (ID: `person:Jesus.2`); A Group of Disciples (ID: `group:GenericDisciples`); bless (ID: `keyterm:Bless`); céu (ID: `keyterm:Heaven`); Basket (ID: `realia:Basket`); Ship (ID: `realia:Ship`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`); Sheep (ID: `fauna:Lamb`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); Betsaida (ID: `place:Bethsaida`); Genesaré (ID: `place:Gennesaret`); ser discípulo (ID: `keyterm:Disciple`); salvation (ID: `keyterm:Salvation`); rogar (ID: `keyterm:AskFor`); ter bom ânimo (ID: `keyterm:CheerUp`); coração (ID: `keyterm:Heart`); fear (ID: `keyterm:Fear`); orar (ID: `keyterm:Pray`); Bed (ID: `realia:Bed`); Cloak (ID: `realia:Cloak`); Tassel (ID: `realia:Tassel`)
...
* **Associated ACAI Concepts:** defilement (ID: `keyterm:Defilement`); tradição (ID: `keyterm:Teaching`); Pharisees (ID: `group:Pharisee`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`); ser discípulo (ID: `keyterm:Disciple`); Commandment (ID: `keyterm:Commandment`); Tesouro do templo (ID: `place:Corban`); batismo (ID: `keyterm:Baptism`); adorar (ID: `keyterm:Worship`); andar (ID: `keyterm:Live.3`); Isaías (ID: `person:Isaiah`); Moisés (ID: `person:Moses`); Jerusalém (ID: `place:Jerusalem`); parábola (ID: `keyterm:Parable`); Religious Officials (ID: `group:ReligiousOfficials`); To Cleanse (ID: `keyterm:Cleanse.2`); offering (ID: `keyterm:Offering`); fornication (ID: `keyterm:Fornication`); speak (ID: `keyterm:Speak`); Jews (ID: `group:Jews`); blasfemar (ID: `keyterm:Blaspheme`); Bed (ID: `realia:Bed`); House (ID: `realia:House`); Cooking Pot (ID: `realia:CookingPot`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); Tiro (ID: `place:Tyre`); rogar (ID: `keyterm:AskFor`); Dog (ID: `fauna:Dog`); House (ID: `realia:House`); Sidom (ID: `place:Sidon`); Decápolis (ID: `place:Decapolis`); Greeks (ID: `group:Greek`); Fenícia (ID: `place:Phoenicia`); Syrophoenicians (ID: `group:Phoenicia`); Javã (ID: `person:Javan`); bom (ID: `keyterm:Honest`); proclamar (ID: `keyterm:Proclaim`); Sea of Galilee (ID: `place:GalileeSea`); céu (ID: `keyterm:Heaven`); Bed (ID: `realia:Bed`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Basket (ID: `realia:Basket`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisees (ID: `group:Pharisee`); example (ID: `keyterm:Example`); Ship (ID: `realia:Ship`); Magadã (ID: `place:Magadan`); Spirit (ID: `keyterm:Spirit.2`); rogar (ID: `keyterm:AskFor`); surely! (ID: `keyterm:Surely`); bless (ID: `keyterm:Bless`); Herodes Antipas (ID: `person:Herod.2`); coração (ID: `keyterm:Heart`); compaixão (ID: `keyterm:Affection`); céu (ID: `keyterm:Heaven`); Fish (ID: `fauna:Fish`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Betsaida (ID: `place:Bethsaida`); batista (ID: `keyterm:Baptist`); Cesareia de Filipos (ID: `place:CaesareaPhilippi`); ser discípulo (ID: `keyterm:Disciple`); Pedro (ID: `person:Peter`); rogar (ID: `keyterm:AskFor`); To Command (ID: `keyterm:Command`); Elias (ID: `person:Elijah`); João (ID: `person:John`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Life (ID: `keyterm:Life`); SENHOR (ID: `deity:Lord`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); To Command (ID: `keyterm:Command`); Ability (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); holy (ID: `keyterm:Holy`); surely! (ID: `keyterm:Surely`); salvation (ID: `keyterm:Salvation`); pensar (ID: `keyterm:Think`); Glory (ID: `keyterm:Glory`); boa notícia (ID: `keyterm:GoodNews`); reino (ID: `keyterm:Kingdom`); be unfaithful (ID: `keyterm:Unfaithful`); rejeitar (ID: `keyterm:Reject`); Satanás (ID: `deity:Satan`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Elias (ID: `person:Elijah`); Jesus (ID: `person:Jesus.2`); Pedro (ID: `person:Peter`); Moisés (ID: `person:Moses`); João (ID: `person:John.2`); Tiago (ID: `person:James`); amado (ID: `keyterm:Beloved`); Tent (ID: `realia:Tent`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); A Father (ID: `person:GenericFather`); crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); não crer (ID: `keyterm:Disbelieve`); A Group of Disciples (ID: `group:GenericDisciples`); To Command (ID: `keyterm:Command`); A Group of People (ID: `group:GenericGroup`); be unfaithful (ID: `keyterm:Unfaithful`); compaixão (ID: `keyterm:Affection`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Cafarnaum (ID: `place:Capernaum`); Name (ID: `keyterm:Name`); Galileia (ID: `place:Galilee`); palavra (ID: `keyterm:Word`); fear (ID: `keyterm:Fear`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** fazer tropeçar (ID: `keyterm:CauseToStumble`); Name (ID: `keyterm:Name`); geena (ID: `keyterm:Gehenna`); Hell (ID: `place:Hell`); Jesus (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); João (ID: `person:John.2`); surely! (ID: `keyterm:Surely`); Demons (ID: `deity:Demons`); reino (ID: `keyterm:Kingdom`); viver em paz (ID: `keyterm:AtPeace`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); Worm (ID: `fauna:Maggot`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); To Command (ID: `keyterm:Command`); reino (ID: `keyterm:Kingdom`); fornication (ID: `keyterm:Fornication`); Moisés (ID: `person:Moses`); Judeia (ID: `place:Judea`); Commandment (ID: `keyterm:Commandment`); dureza de coração (ID: `keyterm:Hardheartedness`); surely! (ID: `keyterm:Surely`); bless (ID: `keyterm:Bless`); corpo (ID: `keyterm:Body.3`); Jordan River (ID: `place:Jordan`); Be Lawful (ID: `keyterm:Lawful`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`); Rich Young Ruler (ID: `person:RichYoungRuler`); Good (ID: `keyterm:Good`); Life (ID: `keyterm:Life`); ser discípulo (ID: `keyterm:Disciple`); para a eternidade (ID: `keyterm:Always`); House (ID: `realia:House`); Commandment (ID: `keyterm:Commandment`); salvation (ID: `keyterm:Salvation`); surely! (ID: `keyterm:Surely`); boa notícia (ID: `keyterm:GoodNews`); Ability (ID: `keyterm:Ability`); céu (ID: `keyterm:Heaven`); love (ID: `keyterm:Love`); Pedro (ID: `person:Peter`); fornication (ID: `keyterm:Fornication`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Tiago (ID: `person:James`); João (ID: `person:John.2`); Jerusalém (ID: `place:Jerusalem`); batismo (ID: `keyterm:Baptism`); Gentiles (ID: `group:Gentile`); servir (ID: `keyterm:Serve`); Life (ID: `keyterm:Life`); Glory (ID: `keyterm:Glory`); condenar (ID: `keyterm:Condemn`); autoridade (ID: `keyterm:Authority.2`); fear (ID: `keyterm:Fear`); Zebedeu (ID: `person:Zebedee`); resgate (ID: `keyterm:Ransom`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Davi (ID: `person:David`); misericórdia (ID: `keyterm:Mercy`); A Group of People (ID: `group:GenericGroup`); Bartimeu (ID: `person:Bartimaeus`); Timeu (ID: `person:Timaeus`); ser discípulo (ID: `keyterm:Disciple`); salvation (ID: `keyterm:Salvation`); To Command (ID: `keyterm:Command`); ter bom ânimo (ID: `keyterm:CheerUp`); Jericó (ID: `place:Jericho`); crer (ID: `keyterm:Believe`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Donkey (ID: `fauna:Donkey`); Jesus (ID: `person:Jesus.2`); Jerusalém (ID: `place:Jerusalem`); hosana (ID: `keyterm:Hosanna`); Betânia (ID: `place:Bethany`); bless (ID: `keyterm:Bless`); A Group of People (ID: `group:GenericGroup`); Cloak (ID: `realia:Cloak`); Betfagé (ID: `place:Bethphage`); Davi (ID: `person:David`); ser discípulo (ID: `keyterm:Disciple`); altura (ID: `keyterm:Height`); Name (ID: `keyterm:Name`); reino (ID: `keyterm:Kingdom`); SENHOR (ID: `deity:Lord`); Rush (ID: `flora:Rush`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); orar (ID: `keyterm:Pray`); Temple (ID: `realia:Temple`); Fig (ID: `flora:Fig`); SENHOR (ID: `deity:Lord`); surely! (ID: `keyterm:Surely`); forgive (ID: `keyterm:Forgive`); distinguir (ID: `keyterm:Discern`); céu (ID: `keyterm:Heaven`); coração (ID: `keyterm:Heart`); Pedro (ID: `person:Peter`); Jerusalém (ID: `place:Jerusalem`); fear (ID: `keyterm:Fear`); Betânia (ID: `place:Bethany`); Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); para a eternidade (ID: `keyterm:Always`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Ability (ID: `keyterm:Ability`); autoridade (ID: `keyterm:Authority.2`); céu (ID: `keyterm:Heaven`); João (ID: `person:John`); parábola (ID: `keyterm:Parable`); fear (ID: `keyterm:Fear`); Jesus (ID: `person:Jesus.2`); rejeitar (ID: `keyterm:Reject`); escritura (ID: `keyterm:Scripture`); batismo (ID: `keyterm:Baptism`); crer (ID: `keyterm:Believe`); SENHOR (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Jerusalém (ID: `place:Jerusalem`); vazio (ID: `keyterm:Empty`); Priests (ID: `group:GenericPriests`); Religious Officials (ID: `group:ReligiousOfficials`); amado (ID: `keyterm:Beloved`); Watch-Tower (ID: `realia:Watch-tower`); Thorn Hedge (ID: `realia:ThornHedge`); Cornerstone (ID: `realia:Cornerstone`); Tower (ID: `realia:Tower`); Temple (ID: `realia:Temple`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Tibério (ID: `person:Tiberius`); levantamento (ID: `keyterm:Resurrection`); Moisés (ID: `person:Moses`); Jesus (ID: `person:Jesus.2`); Herodians (ID: `group:Herodian`); escritura (ID: `keyterm:Scripture`); tributo (ID: `keyterm:PollTax`); Abraão (ID: `person:Abraham`); Sadducees (ID: `group:Sadducee`); Ability (ID: `keyterm:Ability`); céu (ID: `keyterm:Heaven`); Truth (ID: `keyterm:Truth`); The Way (ID: `keyterm:TheWay`); Life (ID: `keyterm:Life`); verdadeiro (ID: `keyterm:True`); Isaque (ID: `person:Isaac`); hipocrisia (ID: `keyterm:Hypocrisy`); Be Lawful (ID: `keyterm:Lawful`); An Angel (ID: `deity:Angel`); Pharisees (ID: `group:Pharisee`); Israel (ID: `person:Israel`); Denarius (ID: `realia:Denarius`); Brier (ID: `flora:Brier`); Boxthorn (ID: `flora:Boxthorn`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); love (ID: `keyterm:Love`); Jesus (ID: `person:Jesus.2`); Davi (ID: `person:David`); Commandment (ID: `keyterm:Commandment`); A Priest (ID: `person:GenericPriest`); A Scribe (ID: `person:Scribe`); coração (ID: `keyterm:Heart`); Treasury (ID: `realia:Treasury`); surely! (ID: `keyterm:Surely`); Daily Life (ID: `keyterm:DailyLife`); mente (ID: `keyterm:Mind.2`); Truth (ID: `keyterm:Truth`); juízo (ID: `keyterm:Judgment`); orar (ID: `keyterm:Pray`); Holy Spirit (ID: `deity:HolySpirit`); ser discípulo (ID: `keyterm:Disciple`); reino (ID: `keyterm:Kingdom`); offering (ID: `keyterm:Offering`); Israel (ID: `person:Israel`); Quadrans (ID: `realia:Quadrans`); Lepton (ID: `realia:Lepton`); Cloak (ID: `realia:Cloak`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); Temple (ID: `realia:Temple`); ser discípulo (ID: `keyterm:Disciple`); Pedro (ID: `person:Peter`); João (ID: `person:John.2`); salvation (ID: `keyterm:Salvation`); A Group of Disciples (ID: `group:GenericDisciples`); Tiago (ID: `person:James`); testemunhar (ID: `keyterm:BearWitness`); reino (ID: `keyterm:Kingdom`); boa notícia (ID: `keyterm:GoodNews`); example (ID: `keyterm:Example`); proclamar (ID: `keyterm:Proclaim`); André (ID: `person:Andrew`); Holy Spirit (ID: `deity:HolySpirit`); Synagogue (ID: `realia:Synagogue`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); SENHOR (ID: `deity:Lord`); escolhido (ID: `keyterm:Chosen`); House (ID: `realia:House`); Ability (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); surely! (ID: `keyterm:Surely`); salvation (ID: `keyterm:Salvation`); Judeia (ID: `place:Judea`); To Command (ID: `keyterm:Command`); Glory (ID: `keyterm:Glory`); maravilha (ID: `keyterm:Portent`); crer (ID: `keyterm:Believe`); o detestável da desolação (ID: `keyterm:AbominationOfDesolation`); corpo (ID: `keyterm:Body.3`); Disaster (ID: `keyterm:Disaster`); parábola (ID: `keyterm:Parable`); autoridade (ID: `keyterm:Authority.2`); orar (ID: `keyterm:Pray`); Jesus (ID: `person:Jesus.2`); example (ID: `keyterm:Example`); Cloak (ID: `realia:Cloak`); Fig (ID: `flora:Fig`); Door (ID: `realia:Door`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `flora:Myrrh`); Myrrh (ID: `realia:Myrrh`); Simão (ID: `person:Simon.4`); Betânia (ID: `place:Bethany`); surely! (ID: `keyterm:Surely`); boa notícia (ID: `keyterm:GoodNews`); passover (ID: `keyterm:Passover`); Ability (ID: `keyterm:Ability`); Judas (ID: `person:Judas.2`); A Group of Disciples (ID: `group:GenericDisciples`); corpo (ID: `keyterm:Body.3`); promessa (ID: `keyterm:Promise`); pure (ID: `keyterm:Pure`); Jesus (ID: `person:Jesus.2`); proclamar (ID: `keyterm:Proclaim`); Alabaster Jar (ID: `realia:AlabasterJar`); Oil of Nard (ID: `realia:OilOfNard`); Nard (ID: `flora:Nard`); House (ID: `realia:House`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); surely! (ID: `keyterm:Surely`); passover (ID: `keyterm:Passover`); Jesus (ID: `person:Jesus.2`); Sheep (ID: `fauna:Lamb`); sangue (ID: `keyterm:Blood`); Galileia (ID: `place:Galilee`); bless (ID: `keyterm:Bless`); corpo (ID: `keyterm:Body.3`); SENHOR (ID: `deity:Lord`); Pedro (ID: `person:Peter`); Disaster (ID: `keyterm:Disaster`); Covenant (ID: `keyterm:Covenant`); levantamento (ID: `keyterm:Resurrection`); reino (ID: `keyterm:Kingdom`); offering (ID: `keyterm:Offering`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); Rooster (ID: `fauna:Rooster`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Bowl (ID: `realia:Bowl.2`); Clay Jar (ID: `realia:ClayJar`); Flock (ID: `fauna:Flock`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); Pedro (ID: `person:Peter`); Linen (ID: `realia:Linen`); Getsêmani (ID: `place:Gethsemane`); Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); Spirit (ID: `keyterm:Spirit.2`); escritura (ID: `keyterm:Scripture`); João (ID: `person:John.2`); Name (ID: `keyterm:Name`); Tiago (ID: `person:James`); corpo (ID: `keyterm:Body.3`); tentar (ID: `keyterm:PutToTheTest`); SENHOR (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); Judas (ID: `person:Judas.2`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Jesus (ID: `person:Jesus.2`); Rooster (ID: `fauna:Rooster`); Nazaré (ID: `place:Nazareth`); Galileans (ID: `group:Galilee`); verdadeiro (ID: `keyterm:True`); Galileia (ID: `place:Galilee`); palavra (ID: `keyterm:Word`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Jesus (ID: `person:Jesus.2`); salvation (ID: `keyterm:Salvation`); Elias (ID: `person:Elijah`); Jews (ID: `group:Jews`); Purple Cloth (ID: `realia:PurpleCloth`); Reed (ID: `flora:Reed`); Clothing (ID: `realia:Clothing`); Temple (ID: `realia:Temple`); Simão (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); Alexandre (ID: `person:Alexander`); Cirene (ID: `place:Cyrene`); Rufo (ID: `person:Rufus`); Centurion at Crucifixion (ID: `person:Centurion.3`); prostrar, se (ID: `keyterm:BowDown`); crer (ID: `keyterm:Believe`); A Group of People (ID: `group:GenericGroup`); SENHOR (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); verdadeiro (ID: `keyterm:True`); Priests (ID: `group:GenericPriests`); Religious Officials (ID: `group:ReligiousOfficials`); Israel (ID: `person:Israel`); blasfemar (ID: `keyterm:Blaspheme`); Myrrh (ID: `flora:Myrrh`); Palace (ID: `realia:Palace`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Sour Wine (ID: `realia:SourWine`); Boxthorn (ID: `flora:Boxthorn`); Lot (ID: `realia:Lot`); Curtain (ID: `realia:Curtain`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** José (ID: `person:Joseph.6`); Maria (ID: `person:Mary.2`); Pilatos (ID: `person:Pilate`); Maria Madalena (ID: `person:Marymagdalene`); Tiago (ID: `person:James.4`); José (ID: `person:Joseph.3`); José (ID: `person:Joseph.5`); Arimateia (ID: `place:Arimathea`); Salomé (ID: `person:Salome`); Galileia (ID: `place:Galilee`); véspera do sábado (ID: `keyterm:DayBeforeTheSabbath`); corpo (ID: `keyterm:Body.3`); SENHOR (ID: `deity:Lord`); Jerusalém (ID: `place:Jerusalem`); servir (ID: `keyterm:Serve`); Jesus (ID: `person:Jesus.2`); reino (ID: `keyterm:Kingdom`); Grave (ID: `realia:Grave`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Angels (ID: `group:Angels`); Salomé (ID: `person:Salome`); Maria (ID: `person:Mary.2`); salvation (ID: `keyterm:Salvation`); surely! (ID: `keyterm:Surely`); To Command (ID: `keyterm:Command`); Galileia (ID: `place:Galilee`); Maria Madalena (ID: `person:Marymagdalene`); sabbath (ID: `keyterm:Sabbath`); Week (ID: `keyterm:Week`); Tiago (ID: `person:James.3`); anointed (ID: `keyterm:Anointed`); Pedro (ID: `person:Peter`); Nazaré (ID: `place:Nazareth`); imortal (ID: `keyterm:Imperishable`); fear (ID: `keyterm:Fear`); Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); levantamento (ID: `keyterm:Resurrection`); Cloak (ID: `realia:Cloak`); Aloes (ID: `realia:Aloes`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); não crer (ID: `keyterm:Disbelieve`); Demons (ID: `deity:Demons`); Jesus (ID: `person:Jesus.2`); example (ID: `keyterm:Example`); proclamar (ID: `keyterm:Proclaim`); salvation (ID: `keyterm:Salvation`); boa notícia (ID: `keyterm:GoodNews`); batismo (ID: `keyterm:Baptism`); Maria Madalena (ID: `person:Marymagdalene`); Ability (ID: `keyterm:Ability`); céu (ID: `keyterm:Heaven`); Week (ID: `keyterm:Week`); condenar (ID: `keyterm:Condemn`); SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); dureza de coração (ID: `keyterm:Hardheartedness`); levantamento (ID: `keyterm:Resurrection`); Name (ID: `keyterm:Name`); Snake (ID: `fauna:Snake`)
