...
* **Associated ACAI Concepts:** João (ID: `person:John`); batismo (ID: `keyterm:Baptism`); Jesus (ID: `person:Jesus.2`); boa notícia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); SENHOR (ID: `deity:Lord`); Holy Spirit (ID: `deity:HolySpirit`); Jordan River (ID: `place:Jordan`); Zebedeu (ID: `person:Zebedee`); Galileia (ID: `place:Galilee`); céu (ID: `keyterm:Heaven`); arrepender, se (ID: `keyterm:Repent`); An Angel (ID: `deity:Angel`); To Sin (ID: `keyterm:Sin`); Casting Net (ID: `realia:CastingNet`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Sea of Galilee (ID: `place:GalileeSea`); empregado (ID: `keyterm:HiredWorker`); Tiago (ID: `person:James`); forgive (ID: `keyterm:Forgive`); João (ID: `person:John.2`); Judeia (ID: `place:Judea`); André (ID: `person:Andrew`); reino (ID: `keyterm:Kingdom`); Nazaré (ID: `place:Nazareth`); Isaías (ID: `person:Isaiah`); Jerusalém (ID: `place:Jerusalem`); tentar (ID: `keyterm:PutToTheTest`); Satanás (ID: `deity:Satan`); amado (ID: `keyterm:Beloved`); straightness (ID: `keyterm:Straightness`); crer (ID: `keyterm:Believe`); Pedro (ID: `person:Peter`); servir (ID: `keyterm:Serve`); Strap (ID: `realia:Strap`); Locust (ID: `fauna:Locust`); Leather (ID: `realia:Leather`); Belt (ID: `realia:Belt`); Camel (ID: `fauna:Camel`); Bag (ID: `realia:Bag`); Bee (ID: `fauna:Bee`); Dove (ID: `fauna:Dove`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** To Cleanse (ID: `keyterm:Cleanse.2`); Synagogue (ID: `realia:Synagogue`); proclamar (ID: `keyterm:Proclaim`); Pedro (ID: `person:Peter`); Galileia (ID: `place:Galilee`); autoridade (ID: `keyterm:Authority.2`); Demons (ID: `deity:Demons`); Ability (ID: `keyterm:Ability`); Jesus (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); Cafarnaum (ID: `place:Capernaum`); testemunhar (ID: `keyterm:BearWitness`); offering (ID: `keyterm:Offering`); rogar (ID: `keyterm:AskFor`); estar endemoninhado (ID: `keyterm:DemonPossessed`); To Command (ID: `keyterm:Command`); João (ID: `person:John.2`); André (ID: `person:Andrew`); Nazaré (ID: `place:Nazareth`); Moisés (ID: `person:Moses`); SENHOR (ID: `deity:Lord`); orar (ID: `keyterm:Pray`); sabbath (ID: `keyterm:Sabbath`); Tiago (ID: `person:James`); holy (ID: `keyterm:Holy`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); Bed (ID: `realia:Bed`); jejuar (ID: `keyterm:Fast`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); coração (ID: `keyterm:Heart`); Pharisees (ID: `group:Pharisee`); SENHOR (ID: `deity:Lord`); cobrador de impostos (ID: `keyterm:TaxCollector`); Temple (ID: `realia:Temple`); Mateus (ID: `person:Matthew`); Cafarnaum (ID: `place:Capernaum`); Alfeu (ID: `person:Alphaeus.2`); autoridade (ID: `keyterm:Authority.2`); Glory (ID: `keyterm:Glory`); Be Healthy (ID: `keyterm:Healthy`); be (or show oneself) just (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); Ability (ID: `keyterm:Ability`); coletoria (ID: `keyterm:TaxOffice`); crer (ID: `keyterm:Believe`); Spirit (ID: `keyterm:Spirit.2`); João (ID: `person:John`); Patch (ID: `realia:Patch`); Skin-Bottle (ID: `realia:Skin-bottle`); Housetop (ID: `realia:Housetop`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Must (ID: `realia:Must`)
...
* **Associated ACAI Concepts:** sabbath (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); Pharisees (ID: `group:Pharisee`); Herodians (ID: `group:Herodian`); Abiatar (ID: `person:Abiathar`); coração (ID: `keyterm:Heart`); salvation (ID: `keyterm:Salvation`); Davi (ID: `person:David`); SENHOR (ID: `deity:Lord`); ser discípulo (ID: `keyterm:Disciple`); Life (ID: `keyterm:Life`); servir (ID: `keyterm:Serve`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); ser discípulo (ID: `keyterm:Disciple`); Bartolomeu (ID: `person:Bartholomew`); Alfeu (ID: `person:Alphaeus`); Idumeia (ID: `place:Idumea`); João (ID: `person:John.2`); Zelote (ID: `group:Zealot`); Tiago (ID: `person:James.2`); Tiago (ID: `person:James`); autoridade (ID: `keyterm:Authority.2`); To Command (ID: `keyterm:Command`); Zebedeu (ID: `person:Zebedee`); proclamar (ID: `keyterm:Proclaim`); Judeia (ID: `place:Judea`); André (ID: `person:Andrew`); Judas (ID: `person:Judas.2`); Demons (ID: `deity:Demons`); Jerusalém (ID: `place:Jerusalem`); Galileia (ID: `place:Galilee`); Ability (ID: `keyterm:Ability`); Tomé (ID: `person:Thomas`); Mateus (ID: `person:Matthew`); Judas (ID: `person:Judas`); Sidom (ID: `place:Sidon`); Tiro (ID: `place:Tyre`); Jesus (ID: `person:Jesus.2`); Jordan River (ID: `place:Jordan`); Simão (ID: `person:Simon.2`); Filipe (ID: `person:Philip`); Pedro (ID: `person:Peter`); servir (ID: `keyterm:Serve`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** parábola (ID: `keyterm:Parable`); Grain (ID: `flora:Grain`); reino (ID: `keyterm:Kingdom`); SENHOR (ID: `deity:Lord`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Grass (ID: `flora:Grass`); Barley (ID: `flora:Barley`); céu (ID: `keyterm:Heaven`); rogar (ID: `keyterm:AskFor`); forgive (ID: `keyterm:Forgive`); para a eternidade (ID: `keyterm:Always`); Satanás (ID: `deity:Satan`); Ability (ID: `keyterm:Ability`); Cause of Joy (ID: `keyterm:CauseOfJoy`); ser discípulo (ID: `keyterm:Disciple`); Mustard (ID: `flora:Mustard`); Wheat (ID: `flora:Wheat`); Lampstand (ID: `realia:Lampstand.2`); Sickle (ID: `realia:Sickle`); Bird (ID: `fauna:Bird`); Ship (ID: `realia:Ship`); Bed (ID: `realia:Bed`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** rogar (ID: `keyterm:AskFor`); Jesus (ID: `person:Jesus.2`); estar endemoninhado (ID: `keyterm:DemonPossessed`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); Ship (ID: `realia:Ship`); Grave (ID: `realia:Grave`); fear (ID: `keyterm:Fear`); SENHOR (ID: `deity:Lord`); Chain (ID: `realia:Chain`); To Command (ID: `keyterm:Command`); Legião (ID: `deity:Legion`); Gerasa (ID: `place:Gerasa`); Decápolis (ID: `place:Decapolis`); autoridade (ID: `keyterm:Authority.2`); proclamar (ID: `keyterm:Proclaim`); calar (ID: `keyterm:BecomeStill`); misericórdia (ID: `keyterm:Mercy`); Name (ID: `keyterm:Name`); prostrar, se (ID: `keyterm:BowDown`); crer (ID: `keyterm:Believe`); Fetter (ID: `realia:Fetter`); Cushion (ID: `realia:Cushion`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); salvation (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`); fear (ID: `keyterm:Fear`); crer (ID: `keyterm:Believe`); Jairo (ID: `person:Jairus`); rogar (ID: `keyterm:AskFor`); João (ID: `person:John.2`); A Group of Disciples (ID: `group:GenericDisciples`); fazer a paz (ID: `keyterm:Peace`); Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); corpo (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); sangue (ID: `keyterm:Blood`); Tiago (ID: `person:James`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); servir (ID: `keyterm:Serve`); Judas (ID: `person:Jude`); Simão (ID: `person:Simon.3`); não crer (ID: `keyterm:Disbelieve`); José (ID: `person:Joseph.3`); testemunhar (ID: `keyterm:BearWitness`); autoridade (ID: `keyterm:Authority.2`); arrepender, se (ID: `keyterm:Repent`); proclamar (ID: `keyterm:Proclaim`); Demons (ID: `deity:Demons`); Tiago (ID: `person:James.3`); Maria (ID: `person:Mary`); Jesus (ID: `person:Jesus.2`); sabbath (ID: `keyterm:Sabbath`); anointed (ID: `keyterm:Anointed`); ser discípulo (ID: `keyterm:Disciple`); Staff (ID: `realia:Staff`); House (ID: `realia:House`); Belt (ID: `realia:Belt`); Synagogue (ID: `realia:Synagogue`); Tunic (ID: `realia:Tunic.2`); Bag (ID: `realia:Bag`); Sandal (ID: `realia:Sandal`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Herodes Antipas (ID: `person:Herod.2`); João (ID: `person:John`); Herodias (ID: `person:Herodias`); levantamento (ID: `keyterm:Resurrection`); batismo (ID: `keyterm:Baptism`); Plate (ID: `realia:Plate.2`); Prison (ID: `realia:Prison`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Filipe (ID: `person:Philip.2`); Oath (ID: `keyterm:Oath`); prontidão (ID: `keyterm:Haste`); Elias (ID: `person:Elijah`); fear (ID: `keyterm:Fear`); reino (ID: `keyterm:Kingdom`); be (or show oneself) just (ID: `keyterm:Just`); Be Lawful (ID: `keyterm:Lawful`); Galileia (ID: `place:Galilee`); Name (ID: `keyterm:Name`); batista (ID: `keyterm:Baptist`); Ability (ID: `keyterm:Ability`); A Group of People (ID: `group:GenericGroup`); holy (ID: `keyterm:Holy`); ser discípulo (ID: `keyterm:Disciple`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Fish (ID: `fauna:Fish`); ser discípulo (ID: `keyterm:Disciple`); compaixão (ID: `keyterm:Affection`); A Group of Disciples (ID: `group:GenericDisciples`); céu (ID: `keyterm:Heaven`); Jesus (ID: `person:Jesus.2`); bless (ID: `keyterm:Bless`); Basket (ID: `realia:Basket`); Ship (ID: `realia:Ship`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`); Sheep (ID: `fauna:Lamb`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); Genesaré (ID: `place:Gennesaret`); Betsaida (ID: `place:Bethsaida`); coração (ID: `keyterm:Heart`); rogar (ID: `keyterm:AskFor`); fear (ID: `keyterm:Fear`); salvation (ID: `keyterm:Salvation`); ter bom ânimo (ID: `keyterm:CheerUp`); orar (ID: `keyterm:Pray`); ser discípulo (ID: `keyterm:Disciple`); Tassel (ID: `realia:Tassel`); Bed (ID: `realia:Bed`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** defilement (ID: `keyterm:Defilement`); tradição (ID: `keyterm:Teaching`); Pharisees (ID: `group:Pharisee`); coração (ID: `keyterm:Heart`); SENHOR (ID: `deity:Lord`); ser discípulo (ID: `keyterm:Disciple`); Commandment (ID: `keyterm:Commandment`); Tesouro do templo (ID: `place:Corban`); To Cleanse (ID: `keyterm:Cleanse.2`); offering (ID: `keyterm:Offering`); blasfemar (ID: `keyterm:Blaspheme`); adorar (ID: `keyterm:Worship`); Isaías (ID: `person:Isaiah`); Jerusalém (ID: `place:Jerusalem`); Religious Officials (ID: `group:ReligiousOfficials`); andar (ID: `keyterm:Live.3`); fornication (ID: `keyterm:Fornication`); Moisés (ID: `person:Moses`); batismo (ID: `keyterm:Baptism`); parábola (ID: `keyterm:Parable`); speak (ID: `keyterm:Speak`); Jews (ID: `group:Jews`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Bed (ID: `realia:Bed`); Cooking Pot (ID: `realia:CookingPot`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); Tiro (ID: `place:Tyre`); rogar (ID: `keyterm:AskFor`); House (ID: `realia:House`); Dog (ID: `fauna:Dog`); Fenícia (ID: `place:Phoenicia`); Decápolis (ID: `place:Decapolis`); Syrophoenicians (ID: `group:Phoenicia`); Greeks (ID: `group:Greek`); Sidom (ID: `place:Sidon`); céu (ID: `keyterm:Heaven`); bom (ID: `keyterm:Honest`); Javã (ID: `person:Javan`); proclamar (ID: `keyterm:Proclaim`); Sea of Galilee (ID: `place:GalileeSea`); Temple (ID: `realia:Temple`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); Basket (ID: `realia:Basket`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisees (ID: `group:Pharisee`); example (ID: `keyterm:Example`); Ship (ID: `realia:Ship`); Magadã (ID: `place:Magadan`); céu (ID: `keyterm:Heaven`); compaixão (ID: `keyterm:Affection`); rogar (ID: `keyterm:AskFor`); coração (ID: `keyterm:Heart`); surely! (ID: `keyterm:Surely`); Herodes Antipas (ID: `person:Herod.2`); Spirit (ID: `keyterm:Spirit.2`); bless (ID: `keyterm:Bless`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); batista (ID: `keyterm:Baptist`); Cesareia de Filipos (ID: `place:CaesareaPhilippi`); Betsaida (ID: `place:Bethsaida`); Elias (ID: `person:Elijah`); rogar (ID: `keyterm:AskFor`); To Command (ID: `keyterm:Command`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); João (ID: `person:John`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Ability (ID: `keyterm:Ability`); To Command (ID: `keyterm:Command`); ser discípulo (ID: `keyterm:Disciple`); Pedro (ID: `person:Peter`); salvation (ID: `keyterm:Salvation`); Satanás (ID: `deity:Satan`); reino (ID: `keyterm:Kingdom`); rejeitar (ID: `keyterm:Reject`); pensar (ID: `keyterm:Think`); surely! (ID: `keyterm:Surely`); An Angel (ID: `deity:Angel`); holy (ID: `keyterm:Holy`); boa notícia (ID: `keyterm:GoodNews`); Glory (ID: `keyterm:Glory`); be unfaithful (ID: `keyterm:Unfaithful`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Elias (ID: `person:Elijah`); Jesus (ID: `person:Jesus.2`); Moisés (ID: `person:Moses`); Pedro (ID: `person:Peter`); amado (ID: `keyterm:Beloved`); Tiago (ID: `person:James`); João (ID: `person:John.2`); Tent (ID: `realia:Tent`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** A Father (ID: `person:GenericFather`); Jesus (ID: `person:Jesus.2`); ser discípulo (ID: `keyterm:Disciple`); crer (ID: `keyterm:Believe`); A Group of Disciples (ID: `group:GenericDisciples`); compaixão (ID: `keyterm:Affection`); To Command (ID: `keyterm:Command`); não crer (ID: `keyterm:Disbelieve`); A Group of People (ID: `group:GenericGroup`); orar (ID: `keyterm:Pray`); be unfaithful (ID: `keyterm:Unfaithful`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); Cafarnaum (ID: `place:Capernaum`); fear (ID: `keyterm:Fear`); Galileia (ID: `place:Galilee`); ser discípulo (ID: `keyterm:Disciple`); palavra (ID: `keyterm:Word`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** fazer tropeçar (ID: `keyterm:CauseToStumble`); Name (ID: `keyterm:Name`); Hell (ID: `place:Hell`); geena (ID: `keyterm:Gehenna`); Jesus (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); crer (ID: `keyterm:Believe`); reino (ID: `keyterm:Kingdom`); Ability (ID: `keyterm:Ability`); Demons (ID: `deity:Demons`); surely! (ID: `keyterm:Surely`); SENHOR (ID: `deity:Lord`); viver em paz (ID: `keyterm:AtPeace`); João (ID: `person:John.2`); Worm (ID: `fauna:Maggot`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`); Jesus (ID: `person:Jesus.2`); To Command (ID: `keyterm:Command`); Moisés (ID: `person:Moses`); fornication (ID: `keyterm:Fornication`); ser discípulo (ID: `keyterm:Disciple`); Judeia (ID: `place:Judea`); Commandment (ID: `keyterm:Commandment`); Jordan River (ID: `place:Jordan`); surely! (ID: `keyterm:Surely`); dureza de coração (ID: `keyterm:Hardheartedness`); Be Lawful (ID: `keyterm:Lawful`); corpo (ID: `keyterm:Body.3`); bless (ID: `keyterm:Bless`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); SENHOR (ID: `deity:Lord`); reino (ID: `keyterm:Kingdom`); Rich Young Ruler (ID: `person:RichYoungRuler`); para a eternidade (ID: `keyterm:Always`); Life (ID: `keyterm:Life`); Good (ID: `keyterm:Good`); ser discípulo (ID: `keyterm:Disciple`); House (ID: `realia:House`); céu (ID: `keyterm:Heaven`); boa notícia (ID: `keyterm:GoodNews`); Commandment (ID: `keyterm:Commandment`); Ability (ID: `keyterm:Ability`); fornication (ID: `keyterm:Fornication`); salvation (ID: `keyterm:Salvation`); surely! (ID: `keyterm:Surely`); Pedro (ID: `person:Peter`); love (ID: `keyterm:Love`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Tiago (ID: `person:James`); batismo (ID: `keyterm:Baptism`); Jerusalém (ID: `place:Jerusalem`); Gentiles (ID: `group:Gentile`); João (ID: `person:John.2`); autoridade (ID: `keyterm:Authority.2`); fear (ID: `keyterm:Fear`); condenar (ID: `keyterm:Condemn`); resgate (ID: `keyterm:Ransom`); Zebedeu (ID: `person:Zebedee`); Life (ID: `keyterm:Life`); Glory (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); Davi (ID: `person:David`); A Group of People (ID: `group:GenericGroup`); misericórdia (ID: `keyterm:Mercy`); Bartimeu (ID: `person:Bartimaeus`); Timeu (ID: `person:Timaeus`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); Jericó (ID: `place:Jericho`); ter bom ânimo (ID: `keyterm:CheerUp`); To Command (ID: `keyterm:Command`); ser discípulo (ID: `keyterm:Disciple`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Donkey (ID: `fauna:Donkey`); Jesus (ID: `person:Jesus.2`); Betânia (ID: `place:Bethany`); hosana (ID: `keyterm:Hosanna`); Jerusalém (ID: `place:Jerusalem`); A Group of People (ID: `group:GenericGroup`); bless (ID: `keyterm:Bless`); Cloak (ID: `realia:Cloak`); Betfagé (ID: `place:Bethphage`); Name (ID: `keyterm:Name`); altura (ID: `keyterm:Height`); reino (ID: `keyterm:Kingdom`); Davi (ID: `person:David`); SENHOR (ID: `deity:Lord`); ser discípulo (ID: `keyterm:Disciple`); Rush (ID: `flora:Rush`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); crer (ID: `keyterm:Believe`); Temple (ID: `realia:Temple`); Fig (ID: `flora:Fig`); SENHOR (ID: `deity:Lord`); coração (ID: `keyterm:Heart`); céu (ID: `keyterm:Heaven`); forgive (ID: `keyterm:Forgive`); fear (ID: `keyterm:Fear`); Jerusalém (ID: `place:Jerusalem`); para a eternidade (ID: `keyterm:Always`); Betânia (ID: `place:Bethany`); distinguir (ID: `keyterm:Discern`); Jesus (ID: `person:Jesus.2`); surely! (ID: `keyterm:Surely`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); autoridade (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); céu (ID: `keyterm:Heaven`); fear (ID: `keyterm:Fear`); parábola (ID: `keyterm:Parable`); Jesus (ID: `person:Jesus.2`); João (ID: `person:John`); rejeitar (ID: `keyterm:Reject`); escritura (ID: `keyterm:Scripture`); Priests (ID: `group:GenericPriests`); Jerusalém (ID: `place:Jerusalem`); Religious Officials (ID: `group:ReligiousOfficials`); Elders (ID: `group:GenericElders`); vazio (ID: `keyterm:Empty`); amado (ID: `keyterm:Beloved`); SENHOR (ID: `deity:Lord`); batismo (ID: `keyterm:Baptism`); crer (ID: `keyterm:Believe`); Watch-Tower (ID: `realia:Watch-tower`); Winepress (ID: `realia:Winepress`); Temple (ID: `realia:Temple`); Cornerstone (ID: `realia:Cornerstone`); Thorn Hedge (ID: `realia:ThornHedge`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Tibério (ID: `person:Tiberius`); levantamento (ID: `keyterm:Resurrection`); Moisés (ID: `person:Moses`); Jesus (ID: `person:Jesus.2`); Herodians (ID: `group:Herodian`); hipocrisia (ID: `keyterm:Hypocrisy`); escritura (ID: `keyterm:Scripture`); céu (ID: `keyterm:Heaven`); verdadeiro (ID: `keyterm:True`); Isaque (ID: `person:Isaac`); Abraão (ID: `person:Abraham`); Pharisees (ID: `group:Pharisee`); An Angel (ID: `deity:Angel`); Be Lawful (ID: `keyterm:Lawful`); The Way (ID: `keyterm:TheWay`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); Sadducees (ID: `group:Sadducee`); Life (ID: `keyterm:Life`); tributo (ID: `keyterm:PollTax`); Israel (ID: `person:Israel`); Denarius (ID: `realia:Denarius`); Brier (ID: `flora:Brier`); Boxthorn (ID: `flora:Boxthorn`)
...
* **Associated ACAI Concepts:** SENHOR (ID: `deity:Lord`); Davi (ID: `person:David`); Jesus (ID: `person:Jesus.2`); love (ID: `keyterm:Love`); coração (ID: `keyterm:Heart`); A Priest (ID: `person:GenericPriest`); Commandment (ID: `keyterm:Commandment`); A Scribe (ID: `person:Scribe`); Treasury (ID: `realia:Treasury`); offering (ID: `keyterm:Offering`); reino (ID: `keyterm:Kingdom`); mente (ID: `keyterm:Mind.2`); Truth (ID: `keyterm:Truth`); Daily Life (ID: `keyterm:DailyLife`); orar (ID: `keyterm:Pray`); Holy Spirit (ID: `deity:HolySpirit`); juízo (ID: `keyterm:Judgment`); surely! (ID: `keyterm:Surely`); Israel (ID: `person:Israel`); ser discípulo (ID: `keyterm:Disciple`); Quadrans (ID: `realia:Quadrans`); Lepton (ID: `realia:Lepton`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); Jesus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); A Group of Disciples (ID: `group:GenericDisciples`); testemunhar (ID: `keyterm:BearWitness`); João (ID: `person:John.2`); Holy Spirit (ID: `deity:HolySpirit`); salvation (ID: `keyterm:Salvation`); André (ID: `person:Andrew`); reino (ID: `keyterm:Kingdom`); Tiago (ID: `person:James`); example (ID: `keyterm:Example`); Pedro (ID: `person:Peter`); boa notícia (ID: `keyterm:GoodNews`); ser discípulo (ID: `keyterm:Disciple`); proclamar (ID: `keyterm:Proclaim`); Olive Tree (ID: `flora:OliveTree`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** céu (ID: `keyterm:Heaven`); escolhido (ID: `keyterm:Chosen`); SENHOR (ID: `deity:Lord`); House (ID: `realia:House`); An Angel (ID: `deity:Angel`); Ability (ID: `keyterm:Ability`); maravilha (ID: `keyterm:Portent`); autoridade (ID: `keyterm:Authority.2`); To Command (ID: `keyterm:Command`); o detestável da desolação (ID: `keyterm:AbominationOfDesolation`); example (ID: `keyterm:Example`); Judeia (ID: `place:Judea`); Disaster (ID: `keyterm:Disaster`); corpo (ID: `keyterm:Body.3`); orar (ID: `keyterm:Pray`); crer (ID: `keyterm:Believe`); salvation (ID: `keyterm:Salvation`); parábola (ID: `keyterm:Parable`); Jesus (ID: `person:Jesus.2`); surely! (ID: `keyterm:Surely`); Glory (ID: `keyterm:Glory`); Door (ID: `realia:Door`); Fig (ID: `flora:Fig`); Cloak (ID: `realia:Cloak`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `flora:Myrrh`); Myrrh (ID: `realia:Myrrh`); Simão (ID: `person:Simon.4`); Betânia (ID: `place:Bethany`); boa notícia (ID: `keyterm:GoodNews`); proclamar (ID: `keyterm:Proclaim`); A Group of Disciples (ID: `group:GenericDisciples`); passover (ID: `keyterm:Passover`); Judas (ID: `person:Judas.2`); pure (ID: `keyterm:Pure`); Ability (ID: `keyterm:Ability`); promessa (ID: `keyterm:Promise`); corpo (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`); surely! (ID: `keyterm:Surely`); Nard (ID: `flora:Nard`); Alabaster Jar (ID: `realia:AlabasterJar`); Oil of Nard (ID: `realia:OilOfNard`); House (ID: `realia:House`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** ser discípulo (ID: `keyterm:Disciple`); passover (ID: `keyterm:Passover`); Jesus (ID: `person:Jesus.2`); surely! (ID: `keyterm:Surely`); Sheep (ID: `fauna:Lamb`); sangue (ID: `keyterm:Blood`); offering (ID: `keyterm:Offering`); bless (ID: `keyterm:Bless`); reino (ID: `keyterm:Kingdom`); Disaster (ID: `keyterm:Disaster`); Covenant (ID: `keyterm:Covenant`); Galileia (ID: `place:Galilee`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); levantamento (ID: `keyterm:Resurrection`); Pedro (ID: `person:Peter`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); Clay Jar (ID: `realia:ClayJar`); Bowl (ID: `realia:Bowl.2`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Olive Tree (ID: `flora:OliveTree`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** orar (ID: `keyterm:Pray`); Pedro (ID: `person:Peter`); Linen (ID: `realia:Linen`); Getsêmani (ID: `place:Gethsemane`); Name (ID: `keyterm:Name`); escritura (ID: `keyterm:Scripture`); To Cause to Happen (ID: `keyterm:Happen`); João (ID: `person:John.2`); corpo (ID: `keyterm:Body.3`); Jesus (ID: `person:Jesus.2`); Judas (ID: `person:Judas.2`); Tiago (ID: `person:James`); SENHOR (ID: `deity:Lord`); tentar (ID: `keyterm:PutToTheTest`); ser discípulo (ID: `keyterm:Disciple`); Spirit (ID: `keyterm:Spirit.2`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Jesus (ID: `person:Jesus.2`); testemunhar (ID: `keyterm:BearWitness`); céu (ID: `keyterm:Heaven`); blasfemar (ID: `keyterm:Blaspheme`); witness (ID: `keyterm:Witness`); speak (ID: `keyterm:Speak`); Ability (ID: `keyterm:Ability`); condenar (ID: `keyterm:Condemn`); Pedro (ID: `person:Peter`); Temple (ID: `realia:Temple`); Clothing (ID: `realia:Clothing`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Pedro (ID: `person:Peter`); Jesus (ID: `person:Jesus.2`); Rooster (ID: `fauna:Rooster`); Galileans (ID: `group:Galilee`); Nazaré (ID: `place:Nazareth`); Galileia (ID: `place:Galilee`); verdadeiro (ID: `keyterm:True`); palavra (ID: `keyterm:Word`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Jesus (ID: `person:Jesus.2`); Elias (ID: `person:Elijah`); salvation (ID: `keyterm:Salvation`); Jews (ID: `group:Jews`); Purple Cloth (ID: `realia:PurpleCloth`); Clothing (ID: `realia:Clothing`); Temple (ID: `realia:Temple`); Reed (ID: `flora:Reed`); Centurion at Crucifixion (ID: `person:Centurion.3`); Alexandre (ID: `person:Alexander`); Rufo (ID: `person:Rufus`); Cirene (ID: `place:Cyrene`); Simão (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); Priests (ID: `group:GenericPriests`); blasfemar (ID: `keyterm:Blaspheme`); verdadeiro (ID: `keyterm:True`); Religious Officials (ID: `group:ReligiousOfficials`); Elders (ID: `group:GenericElders`); prostrar, se (ID: `keyterm:BowDown`); A Group of People (ID: `group:GenericGroup`); SENHOR (ID: `deity:Lord`); crer (ID: `keyterm:Believe`); Israel (ID: `person:Israel`); Palace (ID: `realia:Palace`); Myrrh (ID: `flora:Myrrh`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Crown (ID: `realia:Crown.2`); Brier (ID: `flora:Brier`); Sour Wine (ID: `realia:SourWine`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Crown (ID: `realia:Crown`); Lot (ID: `realia:Lot`); Courtyard (ID: `realia:Courtyard`); Curtain (ID: `realia:Curtain`)
...
* **Associated ACAI Concepts:** José (ID: `person:Joseph.6`); Maria (ID: `person:Mary.2`); Pilatos (ID: `person:Pilate`); Maria Madalena (ID: `person:Marymagdalene`); Tiago (ID: `person:James.4`); Arimateia (ID: `place:Arimathea`); José (ID: `person:Joseph.3`); Salomé (ID: `person:Salome`); José (ID: `person:Joseph.5`); reino (ID: `keyterm:Kingdom`); Jerusalém (ID: `place:Jerusalem`); Galileia (ID: `place:Galilee`); SENHOR (ID: `deity:Lord`); corpo (ID: `keyterm:Body.3`); véspera do sábado (ID: `keyterm:DayBeforeTheSabbath`); Jesus (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); Linen (ID: `realia:Linen`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Angels (ID: `group:Angels`); Salomé (ID: `person:Salome`); Maria (ID: `person:Mary.2`); To Command (ID: `keyterm:Command`); imortal (ID: `keyterm:Imperishable`); fear (ID: `keyterm:Fear`); Nazaré (ID: `place:Nazareth`); Galileia (ID: `place:Galilee`); Tiago (ID: `person:James.3`); levantamento (ID: `keyterm:Resurrection`); salvation (ID: `keyterm:Salvation`); Week (ID: `keyterm:Week`); Jesus (ID: `person:Jesus.2`); sabbath (ID: `keyterm:Sabbath`); surely! (ID: `keyterm:Surely`); anointed (ID: `keyterm:Anointed`); Maria Madalena (ID: `person:Marymagdalene`); Pedro (ID: `person:Peter`); ser discípulo (ID: `keyterm:Disciple`); Cross (ID: `realia:Cross`); Cloak (ID: `realia:Cloak`); Aloes (ID: `realia:Aloes`)
...
* **Associated ACAI Concepts:** crer (ID: `keyterm:Believe`); não crer (ID: `keyterm:Disbelieve`); example (ID: `keyterm:Example`); proclamar (ID: `keyterm:Proclaim`); Demons (ID: `deity:Demons`); Jesus (ID: `person:Jesus.2`); céu (ID: `keyterm:Heaven`); boa notícia (ID: `keyterm:GoodNews`); dureza de coração (ID: `keyterm:Hardheartedness`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); condenar (ID: `keyterm:Condemn`); SENHOR (ID: `deity:Lord`); Life (ID: `keyterm:Life`); levantamento (ID: `keyterm:Resurrection`); batismo (ID: `keyterm:Baptism`); salvation (ID: `keyterm:Salvation`); Week (ID: `keyterm:Week`); Maria Madalena (ID: `person:Marymagdalene`); Snake (ID: `fauna:Snake`)
