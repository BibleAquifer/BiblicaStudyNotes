...
* **Associated ACAI Concepts:** he who lacks heart (ID: `keyterm:Stupid`); evil intention (ID: `keyterm:Intention`); Ability (ID: `keyterm:Ability`); To Sin (ID: `keyterm:Sin`); love (ID: `keyterm:Love`); fear (ID: `keyterm:Fear`); House (ID: `realia:House`); SENHOR (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Caper (ID: `flora:Caper`); Goad (ID: `realia:Goad`)
