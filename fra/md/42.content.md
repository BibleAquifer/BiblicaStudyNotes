...
* **Associated ACAI Concepts:** Zacharie (ID: `person:Zechariah`); Élisabeth (ID: `person:Elizabeth`); Abijah (ID: `person:Abijah.6`); Strong Drink (ID: `realia:StrongDrink`); Gabriel (ID: `deity:Gabriel`); ordonnance (ID: `keyterm:Regulations`); Hérode (ID: `person:Herod`); être exempt de la punition (ID: `keyterm:Blameless`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Marie (ID: `person:Mary`); ce qui est dit (ID: `keyterm:Word`); grâce (ID: `keyterm:Favor`); Gabriel (ID: `deity:Gabriel`); Nazareth (ID: `place:Nazareth`); Jésus (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Zacharie (ID: `person:Zechariah`); hauteur (ID: `keyterm:Height`); Élisabeth (ID: `person:Elizabeth`); sauver (ID: `keyterm:Deliver`); libération (ID: `keyterm:Liberation`); Judée (ID: `place:Judea`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Manger (ID: `realia:Manger`); Quirinius (ID: `person:Quirinius`); Bethléhem (ID: `place:Bethlehem`); Inn (ID: `realia:Inn`); Auguste (ID: `person:Augustus`); sauveur (ID: `keyterm:Savior`); s'enregisrer (ID: `keyterm:Register`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Siméon (ID: `person:Simeon.2`); Anne (ID: `person:Anna`); Phanuel (ID: `person:Phanuel`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Abilène (ID: `place:Abilene`); Lysanias (ID: `person:Lysanias`); Trachonite (ID: `place:Trachonitis`); Philippe (ID: `person:Philip.3`); Iturée (ID: `place:Ituraea`); Anne (ID: `person:Annas`); Auguste (ID: `person:Augustus`); Tibère (ID: `person:Tiberius`); Hérode Antipas (ID: `person:Herod.2`); Jean (ID: `person:John`); Jourdain (ID: `place:Jordan`)
...
* **Associated ACAI Concepts:** Strap (ID: `realia:Strap`); Hérodias (ID: `person:Herodias`); Hérode Antipas (ID: `person:Herod.2`)
...
* **Associated ACAI Concepts:** Éliézer (ID: `person:Eliezer`); Jannaï (ID: `person:Jannai`); Héli (ID: `person:Heli`); Lévi (ID: `person:Levi.2`); Joanan (ID: `person:Joanan`); Lévi (ID: `person:Levi`); Esli (ID: `person:Esli`); Mattathias (ID: `person:Mattathias`); Joseph (ID: `person:Joseph.8`); Kosam (ID: `person:Cosam`); Schealthiel (ID: `person:Shealtiel`); Menna (ID: `person:Menna`); Melchi (ID: `person:Melchi.2`); Addi (ID: `person:Addi`); Josué (ID: `person:Joshua`); Joda (ID: `person:Joda`); Joseph (ID: `person:Joseph.7`); Mattatha (ID: `person:Mattatha`); Amos (ID: `person:Amos.2`); Nahum (ID: `person:Nahum`); Naggaï (ID: `person:Naggai`); Siméon (ID: `person:Simeon.3`); Juda (ID: `person:Judah.3`); Jonam (ID: `person:Jonam`); Maath (ID: `person:Maath`); Sémeï (ID: `person:Semein`); Er (ID: `person:Er`); Matthat (ID: `person:Matthat`); Rhésa (ID: `person:Rhesa`); Josech (ID: `person:Josech`); Éliakim (ID: `person:Eliakim.2`); Zorobabel (ID: `person:Zerubbabel`); Matthat (ID: `person:Matthat.2`); Méléa (ID: `person:Melea`); Melchi (ID: `person:Melchi`); Elmadam (ID: `person:Elmadam`); Mattathias (ID: `person:Mattathias.2`); Jorim (ID: `person:Jorim`); Kaïnan (ID: `person:Cainan`); Néri (ID: `person:Neri`); Nathan (ID: `person:Nathan`); Serug (ID: `person:Serug`); Reu (ID: `person:Reu`); Salmon (ID: `person:Salmon`); Methuselah (ID: `person:Methuselah`); Jéred (ID: `person:Jared`); Lémec (ID: `person:Lamech.2`); Mahalalel (ID: `person:Mahalalel`); Nachor (ID: `person:Nahor`); Kénan (ID: `person:Kenan`); Énosch (ID: `person:Enosh`); Shelah (ID: `person:Shelah.2`); Péleg (ID: `person:Peleg`); Térach (ID: `person:Terah`); Seth (ID: `person:Seth`); Eber (ID: `person:Eber`); Hetsron (ID: `person:Hezron.2`); Joseph (ID: `person:Joseph.4`); Sem (ID: `person:Shem`); Boaz (ID: `person:Boaz`); Adam (ID: `person:Adam`)
...
* **Associated ACAI Concepts:** mis à l'essai (ID: `keyterm:PutToTheTest`); Pinnacle (ID: `realia:Pinnacle`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); proclamer (ID: `keyterm:Proclaim`); Sarepta (ID: `place:Zarephath`); Naaman (ID: `person:Naaman.3`); Nazareth (ID: `place:Nazareth`); Élisée (ID: `person:Elisha`); Araméen (ID: `group:Syria`); Galilée (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** prescrire (ID: `keyterm:Command`); Capernaüm (ID: `place:Capernaum`); Judée (ID: `place:Judea`); bonnes nouvelles (ID: `keyterm:GoodNews`)
...
* **Associated ACAI Concepts:** lèpre (ID: `keyterm:InfectiousSkinDisease`); Pierre (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Tile (ID: `realia:Tile`); conduis (ID: `keyterm:BringIn`); Galilée (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** collecteur d'impôt (ID: `keyterm:TaxCollector`); Patch (ID: `realia:Patch`)
...
* **Associated ACAI Concepts:** béni (ID: `keyterm:Happy`); Simon (ID: `person:Simon.2`); Judas (ID: `person:Judas`); Matthieu (ID: `person:Matthew`); choisi (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** faire du bien (ID: `keyterm:DoGood`); Storeroom (ID: `realia:Storeroom`); miséricordieux (ID: `keyterm:Compassionate`); condamner (ID: `keyterm:Condemn`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Naïn (ID: `place:Nain`); Judée (ID: `place:Judea`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** baptiste [jean] (ID: `keyterm:Baptist`); Jean (ID: `person:John`)
...
* **Associated ACAI Concepts:** Simon (ID: `person:Simon.6`); Alabaster Jar (ID: `realia:AlabasterJar`); devoir (qch) à [qqn] (ID: `keyterm:Owe`); pardonner (ID: `keyterm:Forgive`)
...
* **Associated ACAI Concepts:** Susanne (ID: `person:Susanna`); Chuza (ID: `person:Chuza`); parabole (ID: `keyterm:Parable`); Jeanne (ID: `person:Joanna`); bien (ID: `keyterm:Honest`); vie quotidienne (ID: `keyterm:DailyLife`); Marie de Magdala (ID: `person:Marymagdalene`)
...
* **Associated ACAI Concepts:** Gerasa (ID: `place:Gerasa`); Légion (ID: `deity:Legion`); Fetter (ID: `realia:Fetter`); le monde des morts (ID: `keyterm:Abyss`); être possédé par un démon (ID: `keyterm:DemonPossessed`); Demons (ID: `deity:Demons`)
...
* **Associated ACAI Concepts:** Jaïrus (ID: `person:Jairus`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Religious Official (ID: `person:ReligiousOfficial`); Shimrath (ID: `group:Samaritan`)
...
* **Associated ACAI Concepts:** Chorazin (ID: `place:Chorazin`); faire la paix (ID: `keyterm:Peace`); Scorpion (ID: `fauna:Scorpion`); Disaster (ID: `keyterm:Disaster`)
...
* **Associated ACAI Concepts:** Inn (ID: `realia:Inn`); intelligence (ID: `keyterm:Mind.2`); pitié (ID: `keyterm:Mercy`)
...
* **Associated ACAI Concepts:** Marthe (ID: `person:Martha`); Marie (ID: `person:Mary.3`)
...
* **Associated ACAI Concepts:** Ninive (ID: `group:Nineveh`)
...
* **Associated ACAI Concepts:** Rue (ID: `flora:Rue`); Mint (ID: `flora:Mint`); Zacharie (ID: `person:Zechariah.12`); Plate (ID: `realia:Plate.2`); Disaster (ID: `keyterm:Disaster`); Pharisien (ID: `group:Pharisee`)
...
* **Associated ACAI Concepts:** Assarion (ID: `realia:Assarion`); Inner Room (ID: `realia:InnerRoom`); hypocrisie (ID: `keyterm:Hypocrisy`); enfer (ID: `keyterm:Gehenna`); parler contre dieu (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** Barn (ID: `realia:Barn`); Oven (ID: `realia:Oven`); Storeroom (ID: `realia:Storeroom`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Crow (ID: `fauna:Crow`); Bag (ID: `realia:Bag`); Flock (ID: `fauna:Flock`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Carob (ID: `flora:Carob`); travailleur employé (ID: `keyterm:HiredWorker`); Cattle (ID: `fauna:Bull`); vie quotidienne (ID: `keyterm:DailyLife`); Kid (ID: `fauna:Kid`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`)
...
* **Associated ACAI Concepts:** Kor (ID: `realia:Kor.2`); devoir (qch) à [qqn] (ID: `keyterm:Owe`); gestion d'un foyer (ID: `keyterm:Stewardship`)
...
* **Associated ACAI Concepts:** Lazare (ID: `person:Lazarus`); hadès (ID: `keyterm:WorldOfTheDead`); Dog (ID: `fauna:Dog`); Abraham (ID: `person:Abraham`)
...
* **Associated ACAI Concepts:** Mulberry (ID: `flora:Mulberry`); faire pécher qqn (ID: `keyterm:CauseToStumble`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); sois obligé (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** aider (quelqu'un) à obtenir justice (ID: `keyterm:GrantJustice`); collecteur d'impôt (ID: `keyterm:TaxCollector`); Pharisien (ID: `group:Pharisee`); jeûner (ID: `keyterm:Fast`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Zachée (ID: `person:Zacchaeus`); Sycomore Fig (ID: `flora:SycomoreFig`)
...
* **Associated ACAI Concepts:** Bethphagé (ID: `place:Bethphage`); Temple (ID: `realia:Temple`); montagne des oliviers (ID: `place:OlivesMount`); hauteur (ID: `keyterm:Height`); Siege-Works (ID: `realia:Siege-works`); Béthanie (ID: `place:Bethany`); Jérusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Tibère (ID: `person:Tiberius`); résurrection (ID: `keyterm:Resurrection`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** servir (ID: `keyterm:Serve`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); sacrifice de la pâque (ID: `keyterm:Passover`)
...
* **Associated ACAI Concepts:** Bag (ID: `realia:Bag`); prier (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Pierre (ID: `person:Peter`); Peter's Second Accuser (ID: `person:SecondAccuserOfPeter`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Criminal on the Cross (ID: `person:Dysmas`); Simon (ID: `person:Simon.5`); Cross (ID: `realia:Cross`); Sour Wine (ID: `realia:SourWine`); Cyrène (ID: `place:Cyrene`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Arimathée (ID: `place:Arimathea`); Aloes (ID: `realia:Aloes`); Joseph (ID: `person:Joseph.6`)
...
* **Associated ACAI Concepts:** Jeanne (ID: `person:Joanna`); semaine (ID: `keyterm:Week`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** Émmaüs (ID: `place:Emmaus`); Cléopas (ID: `person:Cleopas`); Stade (ID: `realia:Stade`)
...
* **Associated ACAI Concepts:** Béthanie (ID: `place:Bethany`); To Cause to Happen (ID: `keyterm:Happen`); scripture (ID: `keyterm:Scripture`); adorer (ID: `keyterm:BowDown`)
