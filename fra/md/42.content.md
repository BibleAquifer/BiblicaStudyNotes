...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Zacharie (ID: `person:Zechariah`); Élisabeth (ID: `person:Elizabeth`); An Angel (ID: `deity:Angel`); Temple (ID: `realia:Temple`); sacerdoce (ID: `keyterm:Priesthood`); craindre (ID: `keyterm:Fear`); prier (ID: `keyterm:Pray`); être juste (ID: `keyterm:Just`); Saint-Esprit (ID: `deity:HolySpirit`); nom (ID: `keyterm:Name`); Abijah (ID: `person:Abijah.6`); Gabriel (ID: `deity:Gabriel`); ordonnance (ID: `keyterm:Regulations`); être exempt de la punition (ID: `keyterm:Blameless`); Hérode (ID: `person:Herod`); commandement (ID: `keyterm:Commandment`); Judée (ID: `place:Judea`); bonnes nouvelles (ID: `keyterm:GoodNews`); Cause of Joy (ID: `keyterm:CauseOfJoy`); croire (ID: `keyterm:Believe`); Aaron (ID: `person:Aaron`); capacité (ID: `keyterm:Ability`); coeur (ID: `keyterm:Heart`); To Cause to Happen (ID: `keyterm:Happen`); Élie (ID: `person:Elijah`); Jean (ID: `person:John`); esprit (ID: `keyterm:Spirit.2`); Israël (ID: `person:Israel`); Strong Drink (ID: `realia:StrongDrink`); House (ID: `realia:House`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Marie (ID: `person:Mary`); nom (ID: `keyterm:Name`); ce qui est dit (ID: `keyterm:Word`); grâce (ID: `keyterm:Favor`); David (ID: `person:David`); Jésus (ID: `person:Jesus.2`); Nazareth (ID: `place:Nazareth`); Gabriel (ID: `deity:Gabriel`); Joseph (ID: `person:Joseph.4`); Élisabeth (ID: `person:Elizabeth`); Galilée (ID: `place:Galilee`); capacité (ID: `keyterm:Ability`); être fiancé (ID: `keyterm:Engaged`); craindre (ID: `keyterm:Fear`); Saint-Esprit (ID: `deity:HolySpirit`); saint (ID: `keyterm:Holy`); éternellement (ID: `keyterm:Always`); régne (ID: `keyterm:Kingdom`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Marie (ID: `person:Mary`); Éternel (ID: `deity:Lord`); Élisabeth (ID: `person:Elizabeth`); pitié (ID: `keyterm:Mercy`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); nom (ID: `keyterm:Name`); intelligence (ID: `keyterm:Mind.2`); considérer chanceux ou heureux (ID: `keyterm:RegardAsHappy`); croire (ID: `keyterm:Believe`); Abraham (ID: `person:Abraham`); sérieux (ID: `keyterm:Haste`); Zacharie (ID: `person:Zechariah`); benir (ID: `keyterm:Bless`); coeur (ID: `keyterm:Heart`); sauveur (ID: `keyterm:Savior`); vide (ID: `keyterm:Empty`); Juda (ID: `person:Judah.4`); craindre (ID: `keyterm:Fear`); Saint-Esprit (ID: `deity:HolySpirit`); béni (ID: `keyterm:Happy`); Jésus (ID: `person:Jesus.2`); saint (ID: `keyterm:Holy`); esprit (ID: `keyterm:Spirit.2`); éternellement (ID: `keyterm:Always`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); aide (ID: `keyterm:Salvation`); pitié (ID: `keyterm:Mercy`); saint (ID: `keyterm:Holy`); nom (ID: `keyterm:Name`); Zacharie (ID: `person:Zechariah`); benir (ID: `keyterm:Bless`); Jean (ID: `person:John`); Saint-Esprit (ID: `deity:HolySpirit`); Israël (ID: `person:Israel`); Judée (ID: `place:Judea`); hauteur (ID: `keyterm:Height`); Élisabeth (ID: `person:Elizabeth`); sauver (ID: `keyterm:Deliver`); libération (ID: `keyterm:Liberation`); sacerdoce (ID: `keyterm:Priesthood`); adjuration (ID: `keyterm:Oath`); ce qui est dit (ID: `keyterm:Word`); pécher (ID: `keyterm:Sin`); pardonner (ID: `keyterm:Forgive`); Abraham (ID: `person:Abraham`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); A Group of People (ID: `group:GenericGroup`); coeur (ID: `keyterm:Heart`); craindre (ID: `keyterm:Fear`); être juste (ID: `keyterm:Just`); alliance (ID: `keyterm:Covenant`); David (ID: `person:David`); servir (ID: `keyterm:Serve`); faire la paix (ID: `keyterm:Peace`); esprit (ID: `keyterm:Spirit.2`); Circumcision (ID: `keyterm:Circumcision`); éternellement (ID: `keyterm:Always`); parler (ID: `keyterm:Speak`); Tablet (ID: `realia:Tablet`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); gloire (ID: `keyterm:Glory`); ce qui est dit (ID: `keyterm:Word`); Marie (ID: `person:Mary`); s'enregisrer (ID: `keyterm:Register`); Manger (ID: `realia:Manger`); Bethléhem (ID: `place:Bethlehem`); Joseph (ID: `person:Joseph.4`); craindre (ID: `keyterm:Fear`); David (ID: `person:David`); Quirinius (ID: `person:Quirinius`); Auguste (ID: `person:Augustus`); sauveur (ID: `keyterm:Savior`); Judée (ID: `place:Judea`); hauteur (ID: `keyterm:Height`); bonnes nouvelles (ID: `keyterm:GoodNews`); Galilée (ID: `place:Galilee`); Cause of Joy (ID: `keyterm:CauseOfJoy`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); To Guard Against (ID: `keyterm:GuardAgainst`); A Group of People (ID: `group:GenericGroup`); coeur (ID: `keyterm:Heart`); être fiancé (ID: `keyterm:Engaged`); Nazareth (ID: `place:Nazareth`); céleste (ID: `keyterm:Heavenly`); Jésus (ID: `person:Jesus.2`); faire la paix (ID: `keyterm:Peace`); enregistrement (ID: `keyterm:Census`); exemple (ID: `keyterm:Example`); Inn (ID: `realia:Inn`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); loi (ID: `keyterm:Law`); Jérusalem (ID: `place:Jerusalem`); Saint-Esprit (ID: `deity:HolySpirit`); Jésus (ID: `person:Jesus.2`); Israël (ID: `person:Israel`); Siméon (ID: `person:Simeon.2`); benir (ID: `keyterm:Bless`); saint (ID: `keyterm:Holy`); nom (ID: `keyterm:Name`); Temple (ID: `realia:Temple`); Anne (ID: `person:Anna`); Phanuel (ID: `person:Phanuel`); sacerdoce (ID: `keyterm:Priesthood`); aide (ID: `keyterm:Salvation`); gloire (ID: `keyterm:Glory`); ce qui est dit (ID: `keyterm:Word`); Marie (ID: `person:Mary`); jeûner (ID: `keyterm:Fast`); coeur (ID: `keyterm:Heart`); Moïse (ID: `person:Moses`); libération (ID: `keyterm:Liberation`); Aser (ID: `person:Asher`); prier (ID: `keyterm:AskFor`); vie (ID: `keyterm:Life`); prier (ID: `keyterm:Pray`); être juste (ID: `keyterm:Just`); purifier (ID: `keyterm:Cleanse.2`); servir (ID: `keyterm:Serve`); An Angel (ID: `deity:Angel`); faire la paix (ID: `keyterm:Peace`); résurrection (ID: `keyterm:Resurrection`); Circumcision (ID: `keyterm:Circumcision`); exemple (ID: `keyterm:Example`); offrande (ID: `keyterm:Offering`); nation; peuple (ID: `group:Gentile`); Aser (ID: `group:Asher`); Rooster (ID: `fauna:Rooster`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); baptême (ID: `keyterm:Baptism`); droiture (ID: `keyterm:Straightness`); se repentir (ID: `keyterm:Repent`); Philippe (ID: `person:Philip.3`); Auguste (ID: `person:Augustus`); Abilène (ID: `place:Abilene`); Jourdain (ID: `place:Jordan`); Jean (ID: `person:John`); Anne (ID: `person:Annas`); Hérode Antipas (ID: `person:Herod.2`); Lysanias (ID: `person:Lysanias`); Tibère (ID: `person:Tiberius`); Trachonite (ID: `place:Trachonitis`); Iturée (ID: `place:Ituraea`); Pilate (ID: `person:Pilate`); Judée (ID: `place:Judea`); aide (ID: `keyterm:Salvation`); Galilée (ID: `place:Galilee`); ce qui est dit (ID: `keyterm:Word`); pardonner (ID: `keyterm:Forgive`); pécher (ID: `keyterm:Sin`); Abraham (ID: `person:Abraham`); collecteur d'impôt (ID: `keyterm:TaxCollector`); Zacharie (ID: `person:Zechariah`); corps (ID: `keyterm:Body.3`); Ésaïe (ID: `person:Isaiah`); Caïphe (ID: `person:Caiaphas`); proclamer (ID: `keyterm:Proclaim`); Axe (ID: `realia:Axe`); Scroll (ID: `realia:Scroll`); Tunic (ID: `realia:Tunic.2`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** Jean (ID: `person:John`); baptême (ID: `keyterm:Baptism`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Saint-Esprit (ID: `deity:HolySpirit`); Jésus (ID: `person:Jesus.2`); Hérodias (ID: `person:Herodias`); Hérode Antipas (ID: `person:Herod.2`); nettoyer (ID: `keyterm:CleanOut`); coeur (ID: `keyterm:Heart`); prier (ID: `keyterm:AskFor`); prier (ID: `keyterm:Pray`); bien, aimé (ID: `keyterm:Beloved`); Strap (ID: `realia:Strap`); Dove (ID: `fauna:Dove`); Wheat (ID: `flora:Wheat`); Sandal (ID: `realia:Sandal`); Grain (ID: `flora:Grain`); Winnowing Fork (ID: `realia:WinnowingFork`); Barn (ID: `realia:Barn`); Prison (ID: `realia:Prison`); Threshing Floor (ID: `realia:ThreshingFloor`)
...
* **Associated ACAI Concepts:** Shelah (ID: `person:Shelah.2`); Joseph (ID: `person:Joseph.4`); Kosam (ID: `person:Cosam`); Esli (ID: `person:Esli`); Addi (ID: `person:Addi`); Mattathias (ID: `person:Mattathias.2`); Schealthiel (ID: `person:Shealtiel`); Lémec (ID: `person:Lamech.2`); Méléa (ID: `person:Melea`); Er (ID: `person:Er`); Jannaï (ID: `person:Jannai`); Mahalalel (ID: `person:Mahalalel`); Amos (ID: `person:Amos.2`); Éliézer (ID: `person:Eliezer`); Joda (ID: `person:Joda`); Héli (ID: `person:Heli`); Jonam (ID: `person:Jonam`); Melchi (ID: `person:Melchi`); Éliakim (ID: `person:Eliakim.2`); Sémeï (ID: `person:Semein`); Péleg (ID: `person:Peleg`); Melchi (ID: `person:Melchi.2`); Nachor (ID: `person:Nahor`); Elmadam (ID: `person:Elmadam`); Nahum (ID: `person:Nahum`); Reu (ID: `person:Reu`); Lévi (ID: `person:Levi.2`); Juda (ID: `person:Judah.3`); Énosch (ID: `person:Enosh`); Methuselah (ID: `person:Methuselah`); Salmon (ID: `person:Salmon`); Serug (ID: `person:Serug`); Josué (ID: `person:Joshua`); Matthat (ID: `person:Matthat.2`); Matthat (ID: `person:Matthat`); Mattatha (ID: `person:Mattatha`); Kaïnan (ID: `person:Cainan`); Joanan (ID: `person:Joanan`); Menna (ID: `person:Menna`); Maath (ID: `person:Maath`); Seth (ID: `person:Seth`); Adam (ID: `person:Adam`); Kénan (ID: `person:Kenan`); Néri (ID: `person:Neri`); Joseph (ID: `person:Joseph.7`); Nathan (ID: `person:Nathan`); Térach (ID: `person:Terah`); Jéred (ID: `person:Jared`); Boaz (ID: `person:Boaz`); Siméon (ID: `person:Simeon.3`); Naggaï (ID: `person:Naggai`); Hetsron (ID: `person:Hezron.2`); Sem (ID: `person:Shem`); Joseph (ID: `person:Joseph.8`); Jorim (ID: `person:Jorim`); Eber (ID: `person:Eber`); Josech (ID: `person:Josech`); Rhésa (ID: `person:Rhesa`); Mattathias (ID: `person:Mattathias`); Zorobabel (ID: `person:Zerubbabel`); Lévi (ID: `person:Levi`); Abraham (ID: `person:Abraham`); Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); David (ID: `person:David`); Nahshon (ID: `person:Nahshon`); Amminadab (ID: `person:Amminadab`); Juda (ID: `person:Judah.4`); Perets (ID: `person:Perez`); Israël (ID: `person:Israel`); Ram (ID: `person:Ram`); Obed (ID: `person:Obed`); Hénoc (ID: `person:Enoch.2`); Isaï (ID: `person:Jesse`); Isaac (ID: `person:Isaac`); Noah (ID: `person:Noah`); Arpacschad (ID: `person:Arpachshad`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); mis à l'essai (ID: `keyterm:PutToTheTest`); prescrire (ID: `keyterm:Command`); adorer (ID: `keyterm:BowDown`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); sacerdoce (ID: `keyterm:Priesthood`); gloire (ID: `keyterm:Glory`); Jourdain (ID: `place:Jordan`); protéger (ID: `keyterm:Protect`); Jérusalem (ID: `place:Jerusalem`); vie (ID: `keyterm:Life`); autorité (ID: `keyterm:Authority.2`); Saint-Esprit (ID: `deity:HolySpirit`); servir (ID: `keyterm:Serve`); An Angel (ID: `deity:Angel`); régne (ID: `keyterm:Kingdom`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); proclamer (ID: `keyterm:Proclaim`); Éternel (ID: `deity:Lord`); Élie (ID: `person:Elijah`); Saint-Esprit (ID: `deity:HolySpirit`); Israël (ID: `person:Israel`); Scroll (ID: `realia:Scroll`); Galilée (ID: `place:Galilee`); Élisée (ID: `person:Elisha`); Sarepta (ID: `place:Zarephath`); Nazareth (ID: `place:Nazareth`); Araméen (ID: `group:Syria`); Naaman (ID: `person:Naaman.3`); Joseph (ID: `person:Joseph.4`); scripture (ID: `keyterm:Scripture`); sûrement! (ID: `keyterm:Surely`); gloire (ID: `keyterm:Glory`); bonnes nouvelles (ID: `keyterm:GoodNews`); témoigner (ID: `keyterm:BearWitness`); sabbat (ID: `keyterm:Sabbath`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); vérité (ID: `keyterm:Truth`); Capernaüm (ID: `place:Capernaum`); Ésaïe (ID: `person:Isaiah`); oint (ID: `keyterm:Anointed`); To Cause to Happen (ID: `keyterm:Happen`); Sidon (ID: `place:Sidon`); parabole (ID: `keyterm:Parable`); purifier (ID: `keyterm:Cleanse.2`); servir (ID: `keyterm:Serve`); Jésus (ID: `person:Jesus.2`); grâce (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** prescrire (ID: `keyterm:Command`); Demons (ID: `deity:Demons`); Jésus (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); autorité (ID: `keyterm:Authority.2`); servir (ID: `keyterm:Serve`); Judée (ID: `place:Judea`); bonnes nouvelles (ID: `keyterm:GoodNews`); Capernaüm (ID: `place:Capernaum`); Galilée (ID: `place:Galilee`); sabbat (ID: `keyterm:Sabbath`); Pierre (ID: `person:Peter`); Nazareth (ID: `place:Nazareth`); prier (ID: `keyterm:AskFor`); pollution (ID: `keyterm:Defilement`); saint (ID: `keyterm:Holy`); régne (ID: `keyterm:Kingdom`); proclamer (ID: `keyterm:Proclaim`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Pierre (ID: `person:Peter`); Ship (ID: `realia:Ship`); Casting Net (ID: `realia:CastingNet`); Fishnet (ID: `realia:Fishnet`); purifier (ID: `keyterm:Cleanse.2`); Jésus (ID: `person:Jesus.2`); Fish (ID: `fauna:Fish`); lèpre (ID: `keyterm:InfectiousSkinDisease`); Jean (ID: `person:John.2`); témoigner (ID: `keyterm:BearWitness`); ce qui est dit (ID: `keyterm:Word`); Zébédée (ID: `person:Zebedee`); Jacques (ID: `person:James`); Éternel (ID: `deity:Lord`); Moïse (ID: `person:Moses`); prier (ID: `keyterm:AskFor`); Génésareth (ID: `place:Gennesaret`); craindre (ID: `keyterm:Fear`); prier (ID: `keyterm:Pray`); servir (ID: `keyterm:Serve`); offrande (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** pécher (ID: `keyterm:Sin`); pardonner (ID: `keyterm:Forgive`); Éternel (ID: `deity:Lord`); conduis (ID: `keyterm:BringIn`); Bed (ID: `realia:Bed`); gloire (ID: `keyterm:Glory`); capacité (ID: `keyterm:Ability`); Jésus (ID: `person:Jesus.2`); Pharisien (ID: `group:Pharisee`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Galilée (ID: `place:Galilee`); Judée (ID: `place:Judea`); croire (ID: `keyterm:Believe`); coeur (ID: `keyterm:Heart`); Jérusalem (ID: `place:Jerusalem`); autorité (ID: `keyterm:Authority.2`); craindre (ID: `keyterm:Fear`); parler contre dieu (ID: `keyterm:Blaspheme`); Tile (ID: `realia:Tile`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** collecteur d'impôt (ID: `keyterm:TaxCollector`); jeûner (ID: `keyterm:Fast`); Matthieu (ID: `person:Matthew`); trans. faire un disciple de (ID: `keyterm:Disciple`); Pharisien (ID: `group:Pharisee`); Skin-Bottle (ID: `realia:Skin-bottle`); Must (ID: `realia:Must`); le bien (ID: `keyterm:Good`); Jean (ID: `person:John`); se repentir (ID: `keyterm:Repent`); parabole (ID: `keyterm:Parable`); prier (ID: `keyterm:Pray`); être juste (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); bureau de perception (ID: `keyterm:TaxOffice`); Jésus (ID: `person:Jesus.2`); nom (ID: `keyterm:Name`); Patch (ID: `realia:Patch`); House (ID: `realia:House`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** sabbat (ID: `keyterm:Sabbath`); Jésus (ID: `person:Jesus.2`); Be Lawful (ID: `keyterm:Lawful`); Pharisien (ID: `group:Pharisee`); servir (ID: `keyterm:Serve`); trans. faire un disciple de (ID: `keyterm:Disciple`); David (ID: `person:David`); aide (ID: `keyterm:Salvation`); vie (ID: `keyterm:Life`); faire du bien (ID: `keyterm:DoGood`); Éternel (ID: `deity:Lord`); Wheat (ID: `flora:Wheat`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`); Grain (ID: `flora:Grain`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** béni (ID: `keyterm:Happy`); Disaster (ID: `keyterm:Disaster`); trans. faire un disciple de (ID: `keyterm:Disciple`); Jacques (ID: `person:James.2`); Éternel (ID: `deity:Lord`); Matthieu (ID: `person:Matthew`); Judas (ID: `person:Judas`); choisi (ID: `keyterm:Chosen`); Simon (ID: `person:Simon.2`); Jean (ID: `person:John.2`); Judée (ID: `place:Judea`); Thomas (ID: `person:Thomas`); Tyr (ID: `place:Tyre`); Alphée (ID: `person:Alphaeus`); capacité (ID: `keyterm:Ability`); Judas (ID: `person:Judas.2`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Jacques (ID: `person:James`); Pierre (ID: `person:Peter`); Jérusalem (ID: `place:Jerusalem`); prier (ID: `keyterm:AskFor`); Sidon (ID: `place:Sidon`); prier (ID: `keyterm:Pray`); servir (ID: `keyterm:Serve`); Philippe (ID: `person:Philip`); nom (ID: `keyterm:Name`); Barthélemy (ID: `person:Bartholomew`); régne (ID: `keyterm:Kingdom`); André (ID: `person:Andrew`)
...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); grâce (ID: `keyterm:Favor`); faire du bien (ID: `keyterm:DoGood`); Éternel (ID: `deity:Lord`); le bien (ID: `keyterm:Good`); House (ID: `realia:House`); Beam (ID: `realia:Beam`); Foundation (ID: `realia:Foundation`); condamner (ID: `keyterm:Condemn`); miséricordieux (ID: `keyterm:Compassionate`); pardonner (ID: `keyterm:Forgive`); benir (ID: `keyterm:Bless`); coeur (ID: `keyterm:Heart`); espoir (ID: `keyterm:Hope`); decider (ID: `keyterm:Decided`); parabole (ID: `keyterm:Parable`); prier (ID: `keyterm:Pray`); trans. faire un disciple de (ID: `keyterm:Disciple`); Cloak (ID: `realia:Cloak`); Storeroom (ID: `realia:Storeroom`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`); Tunic (ID: `realia:Tunic.2`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); prier (ID: `keyterm:AskFor`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Judée (ID: `place:Judea`); Naïn (ID: `place:Nain`); aide (ID: `keyterm:Salvation`); prescrire (ID: `keyterm:Command`); gloire (ID: `keyterm:Glory`); ce qui est dit (ID: `keyterm:Word`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); croire (ID: `keyterm:Believe`); capacité (ID: `keyterm:Ability`); aimer (ID: `keyterm:Love`); Capernaüm (ID: `place:Capernaum`); A Group of People (ID: `group:GenericGroup`); Éternel (ID: `deity:Lord`); autorité (ID: `keyterm:Authority.2`); craindre (ID: `keyterm:Fear`); trans. faire un disciple de (ID: `keyterm:Disciple`); Jews (ID: `group:Jews`); Israël (ID: `person:Israel`); Bier (ID: `realia:Bier`); Synagogue (ID: `realia:Synagogue`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Jean (ID: `person:John`); Éternel (ID: `deity:Lord`); baptiste [jean] (ID: `keyterm:Baptist`); baptême (ID: `keyterm:Baptism`); collecteur d'impôt (ID: `keyterm:TaxCollector`); An Angel (ID: `deity:Angel`); glorieux (ID: `keyterm:Glorious`); bonnes nouvelles (ID: `keyterm:GoodNews`); pardonner (ID: `keyterm:Forgive`); A Group of Disciples (ID: `group:GenericDisciples`); Demons (ID: `deity:Demons`); être juste (ID: `keyterm:Just`); purifier (ID: `keyterm:Cleanse.2`); servir (ID: `keyterm:Serve`); Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); béni (ID: `keyterm:Happy`); résurrection (ID: `keyterm:Resurrection`); obéir (ID: `keyterm:ObeyRighteousCommands`); Pharisien (ID: `group:Pharisee`); régne (ID: `keyterm:Kingdom`); Reed (ID: `flora:Reed`); Palace (ID: `realia:Palace`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Flute (ID: `realia:Flute`)
...
* **Associated ACAI Concepts:** pardonner (ID: `keyterm:Forgive`); Simon (ID: `person:Simon.6`); pécher (ID: `keyterm:Sin`); Pharisien (ID: `group:Pharisee`); House (ID: `realia:House`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); aimer (ID: `keyterm:Love`); oint (ID: `keyterm:Anointed`); devoir (qch) à [qqn] (ID: `keyterm:Owe`); aide (ID: `keyterm:Salvation`); croire (ID: `keyterm:Believe`); prier (ID: `keyterm:AskFor`); decider (ID: `keyterm:Decided`); Jésus (ID: `person:Jesus.2`); faire la paix (ID: `keyterm:Peace`); Alabaster Jar (ID: `realia:AlabasterJar`); Olive Oil (ID: `realia:OliveOil`); Denarius (ID: `realia:Denarius`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** parabole (ID: `keyterm:Parable`); Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); coeur (ID: `keyterm:Heart`); servir (ID: `keyterm:Serve`); régne (ID: `keyterm:Kingdom`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Barley (ID: `flora:Barley`); Grain (ID: `flora:Grain`); vie quotidienne (ID: `keyterm:DailyLife`); Jeanne (ID: `person:Joanna`); Marie de Magdala (ID: `person:Marymagdalene`); bien (ID: `keyterm:Honest`); Chuza (ID: `person:Chuza`); Susanne (ID: `person:Susanna`); aide (ID: `keyterm:Salvation`); bonnes nouvelles (ID: `keyterm:GoodNews`); Cause of Joy (ID: `keyterm:CauseOfJoy`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); mis à l'essai (ID: `keyterm:PutToTheTest`); Hérode Antipas (ID: `person:Herod.2`); Demons (ID: `deity:Demons`); trans. faire un disciple de (ID: `keyterm:Disciple`); proclamer (ID: `keyterm:Proclaim`); Bed (ID: `realia:Bed`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); Jésus (ID: `person:Jesus.2`); prier (ID: `keyterm:AskFor`); craindre (ID: `keyterm:Fear`); Gerasa (ID: `place:Gerasa`); Éternel (ID: `deity:Lord`); Jackal (ID: `fauna:Jackal`); House (ID: `realia:House`); Pig (ID: `fauna:Pig`); Ship (ID: `realia:Ship`); être possédé par un démon (ID: `keyterm:DemonPossessed`); Légion (ID: `deity:Legion`); le monde des morts (ID: `keyterm:Abyss`); aide (ID: `keyterm:Salvation`); prescrire (ID: `keyterm:Command`); Galilée (ID: `place:Galilee`); croire (ID: `keyterm:Believe`); trans. faire un disciple de (ID: `keyterm:Disciple`); nom (ID: `keyterm:Name`); proclamer (ID: `keyterm:Proclaim`); A Man (ID: `person:GenericMale`); Fetter (ID: `realia:Fetter`); Grave (ID: `realia:Grave`); Chain (ID: `realia:Chain`); Clothing (ID: `realia:Clothing`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); aide (ID: `keyterm:Salvation`); croire (ID: `keyterm:Believe`); Pierre (ID: `person:Peter`); sang (ID: `keyterm:Blood`); House (ID: `realia:House`); Synagogue (ID: `realia:Synagogue`); Jaïrus (ID: `person:Jairus`); Jean (ID: `person:John.2`); vie quotidienne (ID: `keyterm:DailyLife`); capacité (ID: `keyterm:Ability`); Jacques (ID: `person:James`); prier (ID: `keyterm:AskFor`); vie (ID: `keyterm:Life`); craindre (ID: `keyterm:Fear`); servir (ID: `keyterm:Serve`); faire la paix (ID: `keyterm:Peace`); esprit (ID: `keyterm:Spirit.2`); nom (ID: `keyterm:Name`); Cloak (ID: `realia:Cloak`); Tassel (ID: `realia:Tassel`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jean (ID: `person:John`); Hérode Antipas (ID: `person:Herod.2`); servir (ID: `keyterm:Serve`); trans. faire un disciple de (ID: `keyterm:Disciple`); régne (ID: `keyterm:Kingdom`); Fish (ID: `fauna:Fish`); Bethsaïda (ID: `place:Bethsaida`); bonnes nouvelles (ID: `keyterm:GoodNews`); témoigner (ID: `keyterm:BearWitness`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); benir (ID: `keyterm:Bless`); A Group of Disciples (ID: `group:GenericDisciples`); Élie (ID: `person:Elijah`); Demons (ID: `deity:Demons`); autorité (ID: `keyterm:Authority.2`); résurrection (ID: `keyterm:Resurrection`); proclamer (ID: `keyterm:Proclaim`); Bag (ID: `realia:Bag`); Staff (ID: `realia:Staff`); House (ID: `realia:House`); Tunic (ID: `realia:Tunic.2`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); rejeter (ID: `keyterm:Reject`); aide (ID: `keyterm:Salvation`); prescrire (ID: `keyterm:Command`); gloire (ID: `keyterm:Glory`); capacité (ID: `keyterm:Ability`); A Group of Disciples (ID: `group:GenericDisciples`); Élie (ID: `person:Elijah`); Jean (ID: `person:John`); Pierre (ID: `person:Peter`); vie (ID: `keyterm:Life`); vrai (ID: `keyterm:True`); baptiste [jean] (ID: `keyterm:Baptist`); prier (ID: `keyterm:Pray`); Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); An Angel (ID: `deity:Angel`); saint (ID: `keyterm:Holy`); résurrection (ID: `keyterm:Resurrection`); régne (ID: `keyterm:Kingdom`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Pierre (ID: `person:Peter`); Jésus (ID: `person:Jesus.2`); gloire (ID: `keyterm:Glory`); prier (ID: `keyterm:Pray`); Moïse (ID: `person:Moses`); Élie (ID: `person:Elijah`); Jean (ID: `person:John.2`); Jérusalem (ID: `place:Jerusalem`); Jacques (ID: `person:James`); craindre (ID: `keyterm:Fear`); choisi (ID: `keyterm:Chosen`); To Cause to Happen (ID: `keyterm:Happen`); Tent (ID: `realia:Tent`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); nom (ID: `keyterm:Name`); Demons (ID: `deity:Demons`); Jean (ID: `person:John.2`); prier (ID: `keyterm:AskFor`); prescrire (ID: `keyterm:Command`); ce qui est dit (ID: `keyterm:Word`); être infidèle (ID: `keyterm:Unfaithful`); coeur (ID: `keyterm:Heart`); craindre (ID: `keyterm:Fear`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Jérusalem (ID: `place:Jerusalem`); régne (ID: `keyterm:Kingdom`); Éternel (ID: `deity:Lord`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Shimrath (ID: `group:Samaritan`); Religious Official (ID: `person:ReligiousOfficial`); An Angel (ID: `deity:Angel`); trans. faire un disciple de (ID: `keyterm:Disciple`); Jean (ID: `person:John.2`); prescrire (ID: `keyterm:Command`); Jacques (ID: `person:James`); Samarie (ID: `place:Samaria`); A Man (ID: `person:GenericMale`); Mattock (ID: `realia:Mattock`); Jackal (ID: `fauna:Jackal`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Éternel (ID: `deity:Lord`); faire la paix (ID: `keyterm:Peace`); Tyr (ID: `place:Tyre`); capacité (ID: `keyterm:Ability`); Sidon (ID: `place:Sidon`); nom (ID: `keyterm:Name`); régne (ID: `keyterm:Kingdom`); House (ID: `realia:House`); Disaster (ID: `keyterm:Disaster`); Chorazin (ID: `place:Chorazin`); Bethsaïda (ID: `place:Bethsaida`); Hell (ID: `place:Hell`); Cause of Joy (ID: `keyterm:CauseOfJoy`); hadès (ID: `keyterm:WorldOfTheDead`); Capernaüm (ID: `place:Capernaum`); Sodome (ID: `place:Sodom`); agir par méchanceté (ID: `keyterm:ActWickedly`); Satan (ID: `deity:Satan`); jugement (ID: `keyterm:Judgment`); se repentir (ID: `keyterm:Repent`); prier (ID: `keyterm:AskFor`); Demons (ID: `deity:Demons`); autorité (ID: `keyterm:Authority.2`); tribunal (ID: `keyterm:CourtCase`); Saint-Esprit (ID: `deity:HolySpirit`); servir (ID: `keyterm:Serve`); Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); béni (ID: `keyterm:Happy`); Scorpion (ID: `fauna:Scorpion`); Bag (ID: `realia:Bag`); Sackcloth (ID: `realia:Sackcloth`); Sandal (ID: `realia:Sandal`); Sheep (ID: `fauna:Lamb`); Snake (ID: `fauna:Snake`); Wolf (ID: `fauna:Wolf`)
...
* **Associated ACAI Concepts:** A Priest (ID: `person:GenericPriest`); A Scribe (ID: `person:Scribe`); Jésus (ID: `person:Jesus.2`); vie (ID: `keyterm:Life`); Inn (ID: `realia:Inn`); intelligence (ID: `keyterm:Mind.2`); pitié (ID: `keyterm:Mercy`); Jéricho (ID: `place:Jericho`); Samarie (ID: `place:Samaria`); Lévi (ID: `group:Levi`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); aimer (ID: `keyterm:Love`); coeur (ID: `keyterm:Heart`); Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); loi (ID: `keyterm:Law`); être juste (ID: `keyterm:Just`); Shimrath (ID: `group:Samaritan`); Lévi (ID: `person:Levi.3`); éternellement (ID: `keyterm:Always`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** Marthe (ID: `person:Martha`); Marie (ID: `person:Mary.3`); Jésus (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); nom (ID: `keyterm:Name`); prescrire (ID: `keyterm:Command`); choisi (ID: `keyterm:Chosen`); le bien (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** prier (ID: `keyterm:Pray`); Éternel (ID: `deity:Lord`); saint (ID: `keyterm:Holy`); trans. faire un disciple de (ID: `keyterm:Disciple`); nom (ID: `keyterm:Name`); A Group of Disciples (ID: `group:GenericDisciples`); régne (ID: `keyterm:Kingdom`); pécher (ID: `keyterm:Sin`); pardonner (ID: `keyterm:Forgive`); mis à l'essai (ID: `keyterm:PutToTheTest`); conduis (ID: `keyterm:BringIn`); Saint-Esprit (ID: `deity:HolySpirit`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Jean (ID: `person:John`); Fish (ID: `fauna:Fish`); Door (ID: `realia:Door`); Scorpion (ID: `fauna:Scorpion`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); régne (ID: `keyterm:Kingdom`); Satan (ID: `deity:Satan`); Temple (ID: `realia:Temple`); House (ID: `realia:House`); faire la paix (ID: `keyterm:Peace`); A Group of People (ID: `group:GenericGroup`); exemple (ID: `keyterm:Example`); coeur (ID: `keyterm:Heart`); Éternel (ID: `deity:Lord`); persuader (ID: `keyterm:Persuade`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Jonas (ID: `person:Jonah.2`); Ninive (ID: `group:Nineveh`); béni (ID: `keyterm:Happy`); corps (ID: `keyterm:Body.3`); exemple (ID: `keyterm:Example`); tribunal (ID: `keyterm:CourtCase`); Ninive (ID: `place:Nineveh`); jugement (ID: `keyterm:Judgment`); se repentir (ID: `keyterm:Repent`); Sheba (ID: `place:Sheba.2`); reine de Séba (ID: `person:QueenOfSheba`); A Woman (ID: `person:GenericFemale`); Salomon (ID: `person:Solomon`); Éternel (ID: `deity:Lord`); proclamer (ID: `keyterm:Proclaim`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** Disaster (ID: `keyterm:Disaster`); Pharisien (ID: `group:Pharisee`); aimer (ID: `keyterm:Love`); Éternel (ID: `deity:Lord`); sang (ID: `keyterm:Blood`); Zacharie (ID: `person:Zechariah.12`); capacité (ID: `keyterm:Ability`); pur (ID: `keyterm:Clean`); A Scribe (ID: `person:Scribe`); jugement (ID: `keyterm:Judgment`); témoin (ID: `keyterm:Witness`); prier (ID: `keyterm:AskFor`); Abel (ID: `person:Abel`); purifier (ID: `keyterm:Cleanse.2`); Jésus (ID: `person:Jesus.2`); Mint (ID: `flora:Mint`); Rue (ID: `flora:Rue`); Plate (ID: `realia:Plate.2`); Grave (ID: `realia:Grave`); House (ID: `realia:House`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); capacité (ID: `keyterm:Ability`); autorité (ID: `keyterm:Authority.2`); Saint-Esprit (ID: `deity:HolySpirit`); An Angel (ID: `deity:Angel`); Sparrow (ID: `fauna:Sparrow`); hypocrisie (ID: `keyterm:Hypocrisy`); enfer (ID: `keyterm:Gehenna`); parler contre dieu (ID: `keyterm:Blaspheme`); Hell (ID: `place:Hell`); pardonner (ID: `keyterm:Forgive`); conduis (ID: `keyterm:BringIn`); corps (ID: `keyterm:Body.3`); trans. faire un disciple de (ID: `keyterm:Disciple`); Pharisien (ID: `group:Pharisee`); proclamer (ID: `keyterm:Proclaim`); Inner Room (ID: `realia:InnerRoom`); Assarion (ID: `realia:Assarion`); Synagogue (ID: `realia:Synagogue`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); vie (ID: `keyterm:Life`); corps (ID: `keyterm:Body.3`); régne (ID: `keyterm:Kingdom`); Barn (ID: `realia:Barn`); qui manque de foi (ID: `keyterm:HavingLittleFaith`); prescrire (ID: `keyterm:Command`); gloire (ID: `keyterm:Glory`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); A Person (ID: `person:GenericPerson`); Salomon (ID: `person:Solomon`); coeur (ID: `keyterm:Heart`); parabole (ID: `keyterm:Parable`); craindre (ID: `keyterm:Fear`); trans. faire un disciple de (ID: `keyterm:Disciple`); Crow (ID: `fauna:Crow`); Bag (ID: `realia:Bag`); Cubit (ID: `realia:Cubit.2`); Flock (ID: `fauna:Flock`); Wild Flower (ID: `flora:WildFlower`); Oven (ID: `realia:Oven`); Storeroom (ID: `realia:Storeroom`); Bird (ID: `fauna:Bird`); Rooster (ID: `fauna:Rooster`); Goat (ID: `fauna:Goat`); Wheat (ID: `flora:Wheat`); Clothing (ID: `realia:Clothing`); Moth (ID: `fauna:Moth`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** béni (ID: `keyterm:Happy`); sûrement! (ID: `keyterm:Surely`); baptême (ID: `keyterm:Baptism`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); coeur (ID: `keyterm:Heart`); tester (ID: `keyterm:Interpret`); Pierre (ID: `person:Peter`); decider (ID: `keyterm:Decided`); vrai (ID: `keyterm:True`); parabole (ID: `keyterm:Parable`); être juste (ID: `keyterm:Just`); Jésus (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); faire la paix (ID: `keyterm:Peace`); fidelité (ID: `keyterm:Faithfulness`); trans. libérer (ID: `keyterm:SetFree`); être infidèle (ID: `keyterm:Unfaithful`); Lepton (ID: `realia:Lepton`); House (ID: `realia:House`); Prison (ID: `realia:Prison`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** se repentir (ID: `keyterm:Repent`); Galiléen (ID: `group:Galilee`); Galilée (ID: `place:Galilee`); Fig (ID: `flora:Fig`); Jérusalem (ID: `place:Jerusalem`); Pilate (ID: `person:Pilate`); Siloam (ID: `place:Siloam`); parabole (ID: `keyterm:Parable`); offrande (ID: `keyterm:Offering`); sang (ID: `keyterm:Blood`); Watch-Tower (ID: `realia:Watch-tower`); Vine (ID: `flora:Vine`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** sabbat (ID: `keyterm:Sabbath`); Jésus (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Religious Official (ID: `person:ReligiousOfficial`); servir (ID: `keyterm:Serve`); Satan (ID: `deity:Satan`); glorieux (ID: `keyterm:Glorious`); gloire (ID: `keyterm:Glory`); Éternel (ID: `deity:Lord`); Abraham (ID: `person:Abraham`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Donkey (ID: `fauna:Donkey`)
...
* **Associated ACAI Concepts:** régne (ID: `keyterm:Kingdom`); Éternel (ID: `deity:Lord`); Door (ID: `realia:Door`); Jérusalem (ID: `place:Jerusalem`); aide (ID: `keyterm:Salvation`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Isaac (ID: `person:Isaac`); A Person (ID: `person:GenericPerson`); Abraham (ID: `person:Abraham`); méfaits (ID: `keyterm:UnjustDeed`); Israël (ID: `person:Israel`); Saton (ID: `realia:Saton`); Grain (ID: `flora:Grain`); Mustard (ID: `flora:Mustard`)
...
* **Associated ACAI Concepts:** sabbat (ID: `keyterm:Sabbath`); Pharisien (ID: `group:Pharisee`); Jésus (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); béni (ID: `keyterm:Happy`); être juste (ID: `keyterm:Just`); résurrection (ID: `keyterm:Resurrection`); gloire (ID: `keyterm:Glory`); parabole (ID: `keyterm:Parable`); choisi (ID: `keyterm:Chosen`); Be Lawful (ID: `keyterm:Lawful`); Cattle (ID: `fauna:Bull`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** prier (ID: `keyterm:AskFor`); béni (ID: `keyterm:Happy`); tester (ID: `keyterm:Interpret`); régne (ID: `keyterm:Kingdom`); A Scribe (ID: `person:Scribe`); Éternel (ID: `deity:Lord`); Cattle (ID: `fauna:Bull`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** trans. faire un disciple de (ID: `keyterm:Disciple`); faire la paix (ID: `keyterm:Peace`); prier (ID: `keyterm:AskFor`); vie (ID: `keyterm:Life`); Watch-Tower (ID: `realia:Watch-tower`); Cross (ID: `realia:Cross`); Tower (ID: `realia:Tower`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Cause of Joy (ID: `keyterm:CauseOfJoy`); se repentir (ID: `keyterm:Repent`); Drachma (ID: `realia:Drachma`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); collecteur d'impôt (ID: `keyterm:TaxCollector`); An Angel (ID: `deity:Angel`); Pharisien (ID: `group:Pharisee`); parabole (ID: `keyterm:Parable`); Éternel (ID: `deity:Lord`); être juste (ID: `keyterm:Just`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Cattle (ID: `fauna:Bull`); vie quotidienne (ID: `keyterm:DailyLife`); travailleur employé (ID: `keyterm:HiredWorker`); pécher (ID: `keyterm:Sin`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); vie (ID: `keyterm:Life`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); commandement (ID: `keyterm:Commandment`); servir (ID: `keyterm:Serve.2`); prier (ID: `keyterm:AskFor`); Carob (ID: `flora:Carob`); Kid (ID: `fauna:Kid`); Cloak (ID: `realia:Cloak`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`); Sandal (ID: `realia:Sandal`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** fidelité (ID: `keyterm:Faithfulness`); gestion d'un foyer (ID: `keyterm:Stewardship`); devoir (qch) à [qqn] (ID: `keyterm:Owe`); éternellement (ID: `keyterm:Always`); méfaits (ID: `keyterm:UnjustDeed`); Kor (ID: `realia:Kor.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); vrai (ID: `keyterm:True`); autorité (ID: `keyterm:Authority.2`); croire (ID: `keyterm:Believe`); capacité (ID: `keyterm:Ability`); Tent (ID: `realia:Tent`); Wheat (ID: `flora:Wheat`); Temple (ID: `realia:Temple`); Olive Oil (ID: `realia:OliveOil`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); loi (ID: `keyterm:Law`); fornication (ID: `keyterm:Fornication`); ami de l'argent (ID: `keyterm:LovingWealth`); bonnes nouvelles (ID: `keyterm:GoodNews`); Pharisien (ID: `group:Pharisee`); régne (ID: `keyterm:Kingdom`); servir (ID: `keyterm:Serve.2`); coeur (ID: `keyterm:Heart`); aimer (ID: `keyterm:Love`); être juste (ID: `keyterm:Just`); abomination (ID: `keyterm:Abomination`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Jean (ID: `person:John`)
...
* **Associated ACAI Concepts:** Abraham (ID: `person:Abraham`); Lazare (ID: `person:Lazarus`); prier (ID: `keyterm:AskFor`); Moïse (ID: `person:Moses`); hadès (ID: `keyterm:WorldOfTheDead`); se repentir (ID: `keyterm:Repent`); An Angel (ID: `deity:Angel`); pitié (ID: `keyterm:Mercy`); vie (ID: `keyterm:Life`); nom (ID: `keyterm:Name`); Hell (ID: `place:Hell`); prier (ID: `keyterm:Encourage`); declarer solennellement et catégoriquement (ID: `keyterm:Declare`); persuader (ID: `keyterm:Persuade`); Dog (ID: `fauna:Dog`); Linen (ID: `realia:Linen`); Purple Cloth (ID: `realia:PurpleCloth`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** pécher (ID: `keyterm:Sin`); pardonner (ID: `keyterm:Forgive`); croire (ID: `keyterm:Believe`); se repentir (ID: `keyterm:Repent`); Jésus (ID: `person:Jesus.2`); sois obligé (ID: `keyterm:Ought`); faire pécher qqn (ID: `keyterm:CauseToStumble`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); prescrire (ID: `keyterm:Command`); A Group of Disciples (ID: `group:GenericDisciples`); Disaster (ID: `keyterm:Disaster`); servir (ID: `keyterm:Serve`); trans. faire un disciple de (ID: `keyterm:Disciple`); grâce (ID: `keyterm:Favor`); Mulberry (ID: `flora:Mulberry`); Goat (ID: `fauna:Goat`); Mustard (ID: `flora:Mustard`); Grain (ID: `flora:Grain`); Sheep (ID: `fauna:Lamb`); Hand-Mill (ID: `realia:Hand-mill`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); gloire (ID: `keyterm:Glory`); Samarie (ID: `place:Samaria`); Éternel (ID: `deity:Lord`); purifier (ID: `keyterm:Cleanse.2`); Jérusalem (ID: `place:Jerusalem`); aide (ID: `keyterm:Salvation`); pitié (ID: `keyterm:Mercy`); Galilée (ID: `place:Galilee`); croire (ID: `keyterm:Believe`); Shimrath (ID: `group:Samaritan`)
...
* **Associated ACAI Concepts:** Lot (ID: `person:Lot`); régne (ID: `keyterm:Kingdom`); Noah (ID: `person:Noah`); Éternel (ID: `deity:Lord`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); trans. faire un disciple de (ID: `keyterm:Disciple`); observation (ID: `keyterm:Observation`); vie (ID: `keyterm:Life`); corps (ID: `keyterm:Body.3`); Pharisien (ID: `group:Pharisee`); Sodome (ID: `place:Sodom`); rejeter (ID: `keyterm:Reject`); faire vivre (ID: `keyterm:Alive`); Boat (ID: `realia:Boat`); Vulture (ID: `fauna:Vulture`); Bed (ID: `realia:Bed`); Housetop (ID: `realia:Housetop`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); aider (quelqu'un) à obtenir justice (ID: `keyterm:GrantJustice`); collecteur d'impôt (ID: `keyterm:TaxCollector`); prier (ID: `keyterm:Pray`); Pharisien (ID: `group:Pharisee`); parabole (ID: `keyterm:Parable`); craindre (ID: `keyterm:Fear`); être juste (ID: `keyterm:Just`); Jésus (ID: `person:Jesus.2`); régne (ID: `keyterm:Kingdom`); Temple (ID: `realia:Temple`); jeûner (ID: `keyterm:Fast`); sûrement! (ID: `keyterm:Surely`); prescrire (ID: `keyterm:Command`); pardonner (ID: `keyterm:Forgive`); croire (ID: `keyterm:Believe`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); semaine (ID: `keyterm:Week`); coeur (ID: `keyterm:Heart`); choisi (ID: `keyterm:Chosen`); méfaits (ID: `keyterm:UnjustDeed`); persuader (ID: `keyterm:Persuade`); trans. faire un disciple de (ID: `keyterm:Disciple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); régne (ID: `keyterm:Kingdom`); vie (ID: `keyterm:Life`); éternellement (ID: `keyterm:Always`); le bien (ID: `keyterm:Good`); commandement (ID: `keyterm:Commandment`); Pierre (ID: `person:Peter`); aide (ID: `keyterm:Salvation`); sûrement! (ID: `keyterm:Surely`); Rich Young Ruler (ID: `person:RichYoungRuler`); fornication (ID: `keyterm:Fornication`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); David (ID: `person:David`); pitié (ID: `keyterm:Mercy`); Nazareth (ID: `place:Nazareth`); Jérusalem (ID: `place:Jerusalem`); aide (ID: `keyterm:Salvation`); prescrire (ID: `keyterm:Command`); gloire (ID: `keyterm:Glory`); Jéricho (ID: `place:Jericho`); ce qui est dit (ID: `keyterm:Word`); Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); nation; peuple (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Zachée (ID: `person:Zacchaeus`); aide (ID: `keyterm:Salvation`); nom (ID: `keyterm:Name`); Jéricho (ID: `place:Jericho`); Abraham (ID: `person:Abraham`); Sycomore Fig (ID: `flora:SycomoreFig`); Fig (ID: `flora:Fig`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mina (ID: `realia:Mina`); régne (ID: `keyterm:Kingdom`); Jérusalem (ID: `place:Jerusalem`); fidelité (ID: `keyterm:Faithfulness`); decider (ID: `keyterm:Decided`); parabole (ID: `keyterm:Parable`); autorité (ID: `keyterm:Authority.2`); craindre (ID: `keyterm:Fear`); Éternel (ID: `deity:Lord`); le bien (ID: `keyterm:Good`); capacité (ID: `keyterm:Ability`); Band of Cloth (ID: `realia:BandOfCloth`)
...
* **Associated ACAI Concepts:** trans. faire un disciple de (ID: `keyterm:Disciple`); Donkey (ID: `fauna:Donkey`); Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); faire la paix (ID: `keyterm:Peace`); Temple (ID: `realia:Temple`); Jérusalem (ID: `place:Jerusalem`); Clothing (ID: `realia:Clothing`); Olive Tree (ID: `flora:OliveTree`); hauteur (ID: `keyterm:Height`); Bethphagé (ID: `place:Bethphage`); Béthanie (ID: `place:Bethany`); montagne des oliviers (ID: `place:OlivesMount`); prescrire (ID: `keyterm:Command`); gloire (ID: `keyterm:Glory`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); A Group of Disciples (ID: `group:GenericDisciples`); benir (ID: `keyterm:Bless`); A Group of People (ID: `group:GenericGroup`); prier (ID: `keyterm:AskFor`); prier (ID: `keyterm:Pray`); nom (ID: `keyterm:Name`); Pharisien (ID: `group:Pharisee`); Siege-Works (ID: `realia:Siege-works`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Jean (ID: `person:John`); vide (ID: `keyterm:Empty`); parabole (ID: `keyterm:Parable`); autorité (ID: `keyterm:Authority.2`); Temple (ID: `realia:Temple`); bonnes nouvelles (ID: `keyterm:GoodNews`); baptême (ID: `keyterm:Baptism`); rejeter (ID: `keyterm:Reject`); croire (ID: `keyterm:Believe`); coeur (ID: `keyterm:Heart`); persuader (ID: `keyterm:Persuade`); prier (ID: `keyterm:AskFor`); craindre (ID: `keyterm:Fear`); Jésus (ID: `person:Jesus.2`); bien, aimé (ID: `keyterm:Beloved`); Cornerstone (ID: `realia:Cornerstone`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); résurrection (ID: `keyterm:Resurrection`); Tibère (ID: `person:Tiberius`); capacité (ID: `keyterm:Ability`); David (ID: `person:David`); Moïse (ID: `person:Moses`); Jésus (ID: `person:Jesus.2`); éternellement (ID: `keyterm:Always`); ce qui est dit (ID: `keyterm:Word`); Abraham (ID: `person:Abraham`); Sadducéens (ID: `group:Sadducee`); A Priest (ID: `person:GenericPriest`); vérité (ID: `keyterm:Truth`); chemin (ID: `keyterm:TheWay`); vie (ID: `keyterm:Life`); hypocrisie (ID: `keyterm:Hypocrisy`); Isaac (ID: `person:Isaac`); autorité (ID: `keyterm:Authority.2`); être juste (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); Be Lawful (ID: `keyterm:Lawful`); taxe (ID: `keyterm:TributeTax`); Israël (ID: `person:Israel`); Brier (ID: `flora:Brier`); Image (ID: `realia:Image`); Boxthorn (ID: `flora:Boxthorn`); Footstool (ID: `realia:Footstool`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** offrande (ID: `keyterm:Offering`); trans. faire un disciple de (ID: `keyterm:Disciple`); vie quotidienne (ID: `keyterm:DailyLife`); amour (ID: `keyterm:Friendship`); vrai (ID: `keyterm:True`); prier (ID: `keyterm:Pray`); jugement (ID: `keyterm:Judgment`); Lepton (ID: `realia:Lepton`); Treasury (ID: `realia:Treasury`); Cloak (ID: `realia:Cloak`); Synagogue (ID: `realia:Synagogue`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); nom (ID: `keyterm:Name`); Jérusalem (ID: `place:Jerusalem`); capacité (ID: `keyterm:Ability`); coeur (ID: `keyterm:Heart`); régne (ID: `keyterm:Kingdom`); exemple (ID: `keyterm:Example`); sûrement! (ID: `keyterm:Surely`); Judée (ID: `place:Judea`); gloire (ID: `keyterm:Glory`); témoigner (ID: `keyterm:BearWitness`); Éternel (ID: `deity:Lord`); vue ou événement redoutable (ID: `keyterm:DreadfulEventOrSight`); libération (ID: `keyterm:Liberation`); concernant la vie quotidienne (ID: `keyterm:OfThisLife`); prier (ID: `keyterm:AskFor`); aider (quelqu'un) à obtenir justice (ID: `keyterm:GrantJustice`); Disaster (ID: `keyterm:Disaster`); parabole (ID: `keyterm:Parable`); craindre (ID: `keyterm:Fear`); nation; peuple (ID: `group:Gentile`); Fig (ID: `flora:Fig`); Net (ID: `realia:Net`); Prison (ID: `realia:Prison`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); Judas (ID: `person:Judas.2`); sacrifice de la pâque (ID: `keyterm:Passover`); craindre (ID: `keyterm:Fear`); Satan (ID: `deity:Satan`); montagne des oliviers (ID: `place:OlivesMount`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** sacrifice de la pâque (ID: `keyterm:Passover`); régne (ID: `keyterm:Kingdom`); Éternel (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); servir (ID: `keyterm:Serve`); House (ID: `realia:House`); Jean (ID: `person:John.2`); corps (ID: `keyterm:Body.3`); To Cause to Happen (ID: `keyterm:Happen`); Pierre (ID: `person:Peter`); Disaster (ID: `keyterm:Disaster`); decider (ID: `keyterm:Decided`); autorité (ID: `keyterm:Authority.2`); Israël (ID: `person:Israel`); alliance (ID: `keyterm:Covenant`); trans. faire un disciple de (ID: `keyterm:Disciple`); offrande (ID: `keyterm:Offering`); nation; peuple (ID: `group:Gentile`); sang (ID: `keyterm:Blood`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); Vine (ID: `flora:Vine`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** prier (ID: `keyterm:Pray`); mis à l'essai (ID: `keyterm:PutToTheTest`); Pierre (ID: `person:Peter`); trans. faire un disciple de (ID: `keyterm:Disciple`); Bag (ID: `realia:Bag`); scripture (ID: `keyterm:Scripture`); croire (ID: `keyterm:Believe`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); A Group of Disciples (ID: `group:GenericDisciples`); Éternel (ID: `deity:Lord`); Satan (ID: `deity:Satan`); prier (ID: `keyterm:AskFor`); corruption morale (ID: `keyterm:Lawless`); An Angel (ID: `deity:Angel`); Cloak (ID: `realia:Cloak`); Rooster (ID: `fauna:Rooster`); Wheat (ID: `flora:Wheat`); Sandal (ID: `realia:Sandal`); Prison (ID: `realia:Prison`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Pierre (ID: `person:Peter`); Jésus (ID: `person:Jesus.2`); Judas (ID: `person:Judas.2`); Rooster (ID: `fauna:Rooster`); Temple (ID: `realia:Temple`); Peter's Second Accuser (ID: `person:SecondAccuserOfPeter`); vérité (ID: `keyterm:Truth`); Galiléen (ID: `group:Galilee`); Galilée (ID: `place:Galilee`); autorité (ID: `keyterm:Authority.2`); A Servant (ID: `person:GenericServant`); capacité (ID: `keyterm:Ability`); Courtyard (ID: `realia:Courtyard`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Pilate (ID: `person:Pilate`); Galilée (ID: `place:Galilee`); capacité (ID: `keyterm:Ability`); Elders (ID: `group:GenericElders`); prier (ID: `keyterm:AskFor`); Priests (ID: `group:GenericPriests`); Religious Officials (ID: `group:ReligiousOfficials`); Jésus (ID: `person:Jesus.2`); Judée (ID: `place:Judea`); témoigner (ID: `keyterm:BearWitness`); croire (ID: `keyterm:Believe`); Galiléen (ID: `group:Galilee`); Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); Hérode Antipas (ID: `person:Herod.2`); autorité (ID: `keyterm:Authority.2`); Tibère (ID: `person:Tiberius`); taxe (ID: `keyterm:TributeTax`); parler (ID: `keyterm:Speak`); Jews (ID: `group:Jews`); parler contre dieu (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** Pilate (ID: `person:Pilate`); Hérode Antipas (ID: `person:Herod.2`); Jésus (ID: `person:Jesus.2`); Barabbas (ID: `person:Barabbas`); Prison (ID: `realia:Prison`); Cross (ID: `realia:Cross`); decider (ID: `keyterm:Decided`); exemple (ID: `keyterm:Example`); évaluer (ID: `keyterm:Discern`); espoir (ID: `keyterm:Hope`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); aide (ID: `keyterm:Salvation`); Éternel (ID: `deity:Lord`); Jews (ID: `group:Jews`); Cross (ID: `realia:Cross`); Simon (ID: `person:Simon.5`); Cyrène (ID: `place:Cyrene`); Criminal on the Cross (ID: `person:Dysmas`); sûrement! (ID: `keyterm:Surely`); prescrire (ID: `keyterm:Command`); Golgotha (ID: `place:Golgotha`); pardonner (ID: `keyterm:Forgive`); paradis (ID: `keyterm:Paradise`); choisi (ID: `keyterm:Chosen`); jugement (ID: `keyterm:Judgment`); Jérusalem (ID: `place:Jerusalem`); craindre (ID: `keyterm:Fear`); béni (ID: `keyterm:Happy`); parler contre dieu (ID: `keyterm:Blaspheme`); Sour Wine (ID: `realia:SourWine`); Lot (ID: `realia:Lot`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Galilée (ID: `place:Galilee`); sabbat (ID: `keyterm:Sabbath`); corps (ID: `keyterm:Body.3`); être juste (ID: `keyterm:Just`); Jésus (ID: `person:Jesus.2`); Grave (ID: `realia:Grave`); Arimathée (ID: `place:Arimathea`); Joseph (ID: `person:Joseph.6`); commandement (ID: `keyterm:Commandment`); Pilate (ID: `person:Pilate`); gloire (ID: `keyterm:Glory`); le bien (ID: `keyterm:Good`); esprit (ID: `keyterm:Spirit.2`); nom (ID: `keyterm:Name`); régne (ID: `keyterm:Kingdom`); Jews (ID: `group:Jews`); Aloes (ID: `realia:Aloes`); Myrrh (ID: `realia:Myrrh`); Linen (ID: `realia:Linen`); Curtain (ID: `realia:Curtain`); Myrrh (ID: `flora:Myrrh`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); ce qui est dit (ID: `keyterm:Word`); semaine (ID: `keyterm:Week`); Jeanne (ID: `person:Joanna`); Pierre (ID: `person:Peter`); résurrection (ID: `keyterm:Resurrection`); Jacques (ID: `person:James.3`); vie (ID: `keyterm:Life`); ne pas réussir ou refuser de croire (ID: `keyterm:Disbelieve`); Marie (ID: `person:Mary`); corps (ID: `keyterm:Body.3`); Galilée (ID: `place:Galilee`); Marie de Magdala (ID: `person:Marymagdalene`); Linen (ID: `realia:Linen`); Cross (ID: `realia:Cross`); Clothing (ID: `realia:Clothing`); Aloes (ID: `realia:Aloes`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Jérusalem (ID: `place:Jerusalem`); scripture (ID: `keyterm:Scripture`); coeur (ID: `keyterm:Heart`); nom (ID: `keyterm:Name`); Grave (ID: `realia:Grave`); Émmaüs (ID: `place:Emmaus`); Cléopas (ID: `person:Cleopas`); gloire (ID: `keyterm:Glory`); croire (ID: `keyterm:Believe`); benir (ID: `keyterm:Bless`); corps (ID: `keyterm:Body.3`); espoir (ID: `keyterm:Hope`); Éternel (ID: `deity:Lord`); Moïse (ID: `person:Moses`); libération (ID: `keyterm:Liberation`); jugement (ID: `keyterm:Judgment`); Pierre (ID: `person:Peter`); vie (ID: `keyterm:Life`); An Angel (ID: `deity:Angel`); résurrection (ID: `keyterm:Resurrection`); Israël (ID: `person:Israel`); Stade (ID: `realia:Stade`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** benir (ID: `keyterm:Bless`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); esprit (ID: `keyterm:Spirit.2`); scripture (ID: `keyterm:Scripture`); adorer (ID: `keyterm:BowDown`); To Cause to Happen (ID: `keyterm:Happen`); Béthanie (ID: `place:Bethany`); hauteur (ID: `keyterm:Height`); pécher (ID: `keyterm:Sin`); pardonner (ID: `keyterm:Forgive`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); corps (ID: `keyterm:Body.3`); coeur (ID: `keyterm:Heart`); promesse (ID: `keyterm:Promise`); Moïse (ID: `person:Moses`); se repentir (ID: `keyterm:Repent`); témoin (ID: `keyterm:Witness`); ne pas réussir ou refuser de croire (ID: `keyterm:Disbelieve`); loi (ID: `keyterm:Law`); Jésus (ID: `person:Jesus.2`); nom (ID: `keyterm:Name`); proclamer (ID: `keyterm:Proclaim`); Fish (ID: `fauna:Fish`); Temple (ID: `realia:Temple`)
