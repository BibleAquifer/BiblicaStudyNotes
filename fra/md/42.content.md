...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Zacharie (ID: `person:Zechariah`); Élisabeth (ID: `person:Elizabeth`); An Angel (ID: `deity:Angel`); Temple (ID: `realia:Temple`); sacerdoce (ID: `keyterm:Priesthood`); nom (ID: `keyterm:Name`); prier (ID: `keyterm:Pray`); craindre (ID: `keyterm:Fear`); Saint-Esprit (ID: `deity:HolySpirit`); être juste (ID: `keyterm:Just`); ordonnance (ID: `keyterm:Regulations`); être exempt de la punition (ID: `keyterm:Blameless`); Gabriel (ID: `deity:Gabriel`); Hérode (ID: `person:Herod`); Abijah (ID: `person:Abijah.6`); capacité (ID: `keyterm:Ability`); bonnes nouvelles (ID: `keyterm:GoodNews`); Élie (ID: `person:Elijah`); Aaron (ID: `person:Aaron`); coeur (ID: `keyterm:Heart`); commandement (ID: `keyterm:Commandment`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Jean (ID: `person:John`); To Cause to Happen (ID: `keyterm:Happen`); Judée (ID: `place:Judea`); croire (ID: `keyterm:Believe`); Israël (ID: `person:Israel`); esprit (ID: `keyterm:Spirit.2`); Strong Drink (ID: `realia:StrongDrink`); House (ID: `realia:House`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Marie (ID: `person:Mary`); nom (ID: `keyterm:Name`); ce qui est dit (ID: `keyterm:Word`); grâce (ID: `keyterm:Favor`); David (ID: `person:David`); Jésus (ID: `person:Jesus.2`); Gabriel (ID: `deity:Gabriel`); Nazareth (ID: `place:Nazareth`); capacité (ID: `keyterm:Ability`); être fiancé (ID: `keyterm:Engaged`); Galilée (ID: `place:Galilee`); éternellement (ID: `keyterm:Always`); régne (ID: `keyterm:Kingdom`); saint (ID: `keyterm:Holy`); Élisabeth (ID: `person:Elizabeth`); Joseph (ID: `person:Joseph.4`); craindre (ID: `keyterm:Fear`); Saint-Esprit (ID: `deity:HolySpirit`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Marie (ID: `person:Mary`); Éternel (ID: `deity:Lord`); Élisabeth (ID: `person:Elizabeth`); pitié (ID: `keyterm:Mercy`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); nom (ID: `keyterm:Name`); intelligence (ID: `keyterm:Mind.2`); sérieux (ID: `keyterm:Haste`); Jésus (ID: `person:Jesus.2`); Zacharie (ID: `person:Zechariah`); coeur (ID: `keyterm:Heart`); Juda (ID: `person:Judah.4`); béni (ID: `keyterm:Happy`); vide (ID: `keyterm:Empty`); éternellement (ID: `keyterm:Always`); saint (ID: `keyterm:Holy`); benir (ID: `keyterm:Bless`); sauveur (ID: `keyterm:Savior`); Abraham (ID: `person:Abraham`); craindre (ID: `keyterm:Fear`); croire (ID: `keyterm:Believe`); Saint-Esprit (ID: `deity:HolySpirit`); Israël (ID: `person:Israel`); esprit (ID: `keyterm:Spirit.2`); considérer chanceux ou heureux (ID: `keyterm:RegardAsHappy`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); nom (ID: `keyterm:Name`); saint (ID: `keyterm:Holy`); pitié (ID: `keyterm:Mercy`); aide (ID: `keyterm:Salvation`); Zacharie (ID: `person:Zechariah`); benir (ID: `keyterm:Bless`); Jean (ID: `person:John`); Saint-Esprit (ID: `deity:HolySpirit`); Israël (ID: `person:Israel`); Élisabeth (ID: `person:Elizabeth`); sauver (ID: `keyterm:Deliver`); Judée (ID: `place:Judea`); libération (ID: `keyterm:Liberation`); hauteur (ID: `keyterm:Height`); parler (ID: `keyterm:Speak`); coeur (ID: `keyterm:Heart`); éternellement (ID: `keyterm:Always`); pécher (ID: `keyterm:Sin`); ce qui est dit (ID: `keyterm:Word`); sacerdoce (ID: `keyterm:Priesthood`); David (ID: `person:David`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); Abraham (ID: `person:Abraham`); adjuration (ID: `keyterm:Oath`); craindre (ID: `keyterm:Fear`); Circumcision (ID: `keyterm:Circumcision`); A Group of People (ID: `group:GenericGroup`); servir (ID: `keyterm:Serve`); pardonner (ID: `keyterm:Forgive`); faire la paix (ID: `keyterm:Peace`); esprit (ID: `keyterm:Spirit.2`); alliance (ID: `keyterm:Covenant`); être juste (ID: `keyterm:Just`); Tablet (ID: `realia:Tablet`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); gloire (ID: `keyterm:Glory`); ce qui est dit (ID: `keyterm:Word`); Marie (ID: `person:Mary`); s'enregisrer (ID: `keyterm:Register`); Manger (ID: `realia:Manger`); Bethléhem (ID: `place:Bethlehem`); Joseph (ID: `person:Joseph.4`); David (ID: `person:David`); craindre (ID: `keyterm:Fear`); Auguste (ID: `person:Augustus`); sauveur (ID: `keyterm:Savior`); Quirinius (ID: `person:Quirinius`); capacité (ID: `keyterm:Ability`); bonnes nouvelles (ID: `keyterm:GoodNews`); être fiancé (ID: `keyterm:Engaged`); Jésus (ID: `person:Jesus.2`); coeur (ID: `keyterm:Heart`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Galilée (ID: `place:Galilee`); exemple (ID: `keyterm:Example`); céleste (ID: `keyterm:Heavenly`); Judée (ID: `place:Judea`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); A Group of People (ID: `group:GenericGroup`); Nazareth (ID: `place:Nazareth`); enregistrement (ID: `keyterm:Census`); faire la paix (ID: `keyterm:Peace`); To Guard Against (ID: `keyterm:GuardAgainst`); hauteur (ID: `keyterm:Height`); Inn (ID: `realia:Inn`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); loi (ID: `keyterm:Law`); Jérusalem (ID: `place:Jerusalem`); Jésus (ID: `person:Jesus.2`); Saint-Esprit (ID: `deity:HolySpirit`); Israël (ID: `person:Israel`); Siméon (ID: `person:Simeon.2`); benir (ID: `keyterm:Bless`); nom (ID: `keyterm:Name`); saint (ID: `keyterm:Holy`); Temple (ID: `realia:Temple`); Anne (ID: `person:Anna`); Phanuel (ID: `person:Phanuel`); gloire (ID: `keyterm:Glory`); vie (ID: `keyterm:Life`); coeur (ID: `keyterm:Heart`); Aser (ID: `person:Asher`); offrande (ID: `keyterm:Offering`); exemple (ID: `keyterm:Example`); An Angel (ID: `deity:Angel`); ce qui est dit (ID: `keyterm:Word`); jeûner (ID: `keyterm:Fast`); Marie (ID: `person:Mary`); sacerdoce (ID: `keyterm:Priesthood`); prier (ID: `keyterm:Pray`); purifier (ID: `keyterm:Cleanse.2`); libération (ID: `keyterm:Liberation`); Circumcision (ID: `keyterm:Circumcision`); résurrection (ID: `keyterm:Resurrection`); prier (ID: `keyterm:AskFor`); servir (ID: `keyterm:Serve`); Aser (ID: `group:Asher`); Moïse (ID: `person:Moses`); faire la paix (ID: `keyterm:Peace`); aide (ID: `keyterm:Salvation`); nation; peuple (ID: `group:Gentile`); être juste (ID: `keyterm:Just`); Rooster (ID: `fauna:Rooster`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); Nazareth (ID: `place:Nazareth`); grâce (ID: `keyterm:Favor`); ce qui est dit (ID: `keyterm:Word`); Jésus (ID: `person:Jesus.2`); loi (ID: `keyterm:Law`); coeur (ID: `keyterm:Heart`); sacrifice de la pâque (ID: `keyterm:Passover`); Galilée (ID: `place:Galilee`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); baptême (ID: `keyterm:Baptism`); se repentir (ID: `keyterm:Repent`); droiture (ID: `keyterm:Straightness`); Auguste (ID: `person:Augustus`); Abilène (ID: `place:Abilene`); Jean (ID: `person:John`); Hérode Antipas (ID: `person:Herod.2`); Tibère (ID: `person:Tiberius`); Trachonite (ID: `place:Trachonitis`); Lysanias (ID: `person:Lysanias`); Anne (ID: `person:Annas`); Philippe (ID: `person:Philip.3`); Iturée (ID: `place:Ituraea`); Jourdain (ID: `place:Jordan`); Caïphe (ID: `person:Caiaphas`); corps (ID: `keyterm:Body.3`); proclamer (ID: `keyterm:Proclaim`); Zacharie (ID: `person:Zechariah`); collecteur d'impôt (ID: `keyterm:TaxCollector`); Galilée (ID: `place:Galilee`); Pilate (ID: `person:Pilate`); pécher (ID: `keyterm:Sin`); ce qui est dit (ID: `keyterm:Word`); Abraham (ID: `person:Abraham`); Judée (ID: `place:Judea`); Ésaïe (ID: `person:Isaiah`); pardonner (ID: `keyterm:Forgive`); aide (ID: `keyterm:Salvation`); Tunic (ID: `realia:Tunic.2`); Axe (ID: `realia:Axe`); Snake (ID: `fauna:Snake`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jean (ID: `person:John`); Jésus (ID: `person:Jesus.2`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); baptême (ID: `keyterm:Baptism`); Saint-Esprit (ID: `deity:HolySpirit`); Hérodias (ID: `person:Herodias`); Hérode Antipas (ID: `person:Herod.2`); nettoyer (ID: `keyterm:CleanOut`); coeur (ID: `keyterm:Heart`); bien, aimé (ID: `keyterm:Beloved`); prier (ID: `keyterm:Pray`); prier (ID: `keyterm:AskFor`); Strap (ID: `realia:Strap`); Winnowing Fork (ID: `realia:WinnowingFork`); Wheat (ID: `flora:Wheat`); Barn (ID: `realia:Barn`); Grain (ID: `flora:Grain`); Dove (ID: `fauna:Dove`); Prison (ID: `realia:Prison`); Sandal (ID: `realia:Sandal`); Threshing Floor (ID: `realia:ThreshingFloor`)
...
* **Associated ACAI Concepts:** Shelah (ID: `person:Shelah.2`); Mattathias (ID: `person:Mattathias.2`); Lévi (ID: `person:Levi.2`); Énosch (ID: `person:Enosh`); Melchi (ID: `person:Melchi`); Amos (ID: `person:Amos.2`); Serug (ID: `person:Serug`); Jannaï (ID: `person:Jannai`); Reu (ID: `person:Reu`); Joseph (ID: `person:Joseph.4`); Sem (ID: `person:Shem`); Eber (ID: `person:Eber`); Mahalalel (ID: `person:Mahalalel`); Rhésa (ID: `person:Rhesa`); Kosam (ID: `person:Cosam`); Joanan (ID: `person:Joanan`); Melchi (ID: `person:Melchi.2`); Er (ID: `person:Er`); Lémec (ID: `person:Lamech.2`); Matthat (ID: `person:Matthat.2`); Esli (ID: `person:Esli`); Joda (ID: `person:Joda`); Péleg (ID: `person:Peleg`); Kaïnan (ID: `person:Cainan`); Elmadam (ID: `person:Elmadam`); Zorobabel (ID: `person:Zerubbabel`); Menna (ID: `person:Menna`); Éliézer (ID: `person:Eliezer`); Nathan (ID: `person:Nathan`); Josech (ID: `person:Josech`); Seth (ID: `person:Seth`); Hetsron (ID: `person:Hezron.2`); Methuselah (ID: `person:Methuselah`); Joseph (ID: `person:Joseph.8`); Jorim (ID: `person:Jorim`); Schealthiel (ID: `person:Shealtiel`); Siméon (ID: `person:Simeon.3`); Adam (ID: `person:Adam`); Héli (ID: `person:Heli`); Térach (ID: `person:Terah`); Maath (ID: `person:Maath`); Sémeï (ID: `person:Semein`); Nachor (ID: `person:Nahor`); Salmon (ID: `person:Salmon`); Juda (ID: `person:Judah.3`); Lévi (ID: `person:Levi`); Mattathias (ID: `person:Mattathias`); Josué (ID: `person:Joshua`); Kénan (ID: `person:Kenan`); Méléa (ID: `person:Melea`); Néri (ID: `person:Neri`); Addi (ID: `person:Addi`); Éliakim (ID: `person:Eliakim.2`); Boaz (ID: `person:Boaz`); Joseph (ID: `person:Joseph.7`); Naggaï (ID: `person:Naggai`); Mattatha (ID: `person:Mattatha`); Jonam (ID: `person:Jonam`); Nahum (ID: `person:Nahum`); Jéred (ID: `person:Jared`); Matthat (ID: `person:Matthat`); Arpacschad (ID: `person:Arpachshad`); Abraham (ID: `person:Abraham`); Hénoc (ID: `person:Enoch.2`); Israël (ID: `person:Israel`); Isaac (ID: `person:Isaac`); Juda (ID: `person:Judah.4`); Isaï (ID: `person:Jesse`); Amminadab (ID: `person:Amminadab`); Obed (ID: `person:Obed`); Éternel (ID: `deity:Lord`); Noah (ID: `person:Noah`); Jésus (ID: `person:Jesus.2`); Perets (ID: `person:Perez`); David (ID: `person:David`); Ram (ID: `person:Ram`); Nahshon (ID: `person:Nahshon`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); mis à l'essai (ID: `keyterm:PutToTheTest`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); adorer (ID: `keyterm:BowDown`); prescrire (ID: `keyterm:Command`); gloire (ID: `keyterm:Glory`); Jérusalem (ID: `place:Jerusalem`); protéger (ID: `keyterm:Protect`); vie (ID: `keyterm:Life`); régne (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); autorité (ID: `keyterm:Authority.2`); sacerdoce (ID: `keyterm:Priesthood`); servir (ID: `keyterm:Serve`); Saint-Esprit (ID: `deity:HolySpirit`); Jourdain (ID: `place:Jordan`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); proclamer (ID: `keyterm:Proclaim`); Élie (ID: `person:Elijah`); Éternel (ID: `deity:Lord`); Saint-Esprit (ID: `deity:HolySpirit`); Israël (ID: `person:Israel`); Scroll (ID: `realia:Scroll`); Araméen (ID: `group:Syria`); Élisée (ID: `person:Elisha`); Galilée (ID: `place:Galilee`); Naaman (ID: `person:Naaman.3`); Sarepta (ID: `place:Zarephath`); Nazareth (ID: `place:Nazareth`); gloire (ID: `keyterm:Glory`); capacité (ID: `keyterm:Ability`); bonnes nouvelles (ID: `keyterm:GoodNews`); sûrement! (ID: `keyterm:Surely`); Jésus (ID: `person:Jesus.2`); vérité (ID: `keyterm:Truth`); sabbat (ID: `keyterm:Sabbath`); oint (ID: `keyterm:Anointed`); Sidon (ID: `place:Sidon`); Joseph (ID: `person:Joseph.4`); parabole (ID: `keyterm:Parable`); To Cause to Happen (ID: `keyterm:Happen`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); grâce (ID: `keyterm:Favor`); Ésaïe (ID: `person:Isaiah`); purifier (ID: `keyterm:Cleanse.2`); scripture (ID: `keyterm:Scripture`); servir (ID: `keyterm:Serve`); Capernaüm (ID: `place:Capernaum`); témoigner (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** prescrire (ID: `keyterm:Command`); Jésus (ID: `person:Jesus.2`); Demons (ID: `deity:Demons`); Synagogue (ID: `realia:Synagogue`); capacité (ID: `keyterm:Ability`); autorité (ID: `keyterm:Authority.2`); Éternel (ID: `deity:Lord`); servir (ID: `keyterm:Serve`); bonnes nouvelles (ID: `keyterm:GoodNews`); Judée (ID: `place:Judea`); Capernaüm (ID: `place:Capernaum`); proclamer (ID: `keyterm:Proclaim`); sabbat (ID: `keyterm:Sabbath`); Galilée (ID: `place:Galilee`); régne (ID: `keyterm:Kingdom`); saint (ID: `keyterm:Holy`); Pierre (ID: `person:Peter`); Nazareth (ID: `place:Nazareth`); prier (ID: `keyterm:AskFor`); pollution (ID: `keyterm:Defilement`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Pierre (ID: `person:Peter`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Casting Net (ID: `realia:CastingNet`); Jésus (ID: `person:Jesus.2`); purifier (ID: `keyterm:Cleanse.2`); Fish (ID: `fauna:Fish`); lèpre (ID: `keyterm:InfectiousSkinDisease`); Zébédée (ID: `person:Zebedee`); offrande (ID: `keyterm:Offering`); ce qui est dit (ID: `keyterm:Word`); Éternel (ID: `deity:Lord`); prier (ID: `keyterm:Pray`); craindre (ID: `keyterm:Fear`); servir (ID: `keyterm:Serve`); prier (ID: `keyterm:AskFor`); Moïse (ID: `person:Moses`); Jacques (ID: `person:James`); Jean (ID: `person:John.2`); Génésareth (ID: `place:Gennesaret`); témoigner (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** pécher (ID: `keyterm:Sin`); Éternel (ID: `deity:Lord`); pardonner (ID: `keyterm:Forgive`); conduis (ID: `keyterm:BringIn`); Bed (ID: `realia:Bed`); capacité (ID: `keyterm:Ability`); gloire (ID: `keyterm:Glory`); Jésus (ID: `person:Jesus.2`); Pharisien (ID: `group:Pharisee`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Galilée (ID: `place:Galilee`); Jérusalem (ID: `place:Jerusalem`); coeur (ID: `keyterm:Heart`); autorité (ID: `keyterm:Authority.2`); Judée (ID: `place:Judea`); craindre (ID: `keyterm:Fear`); parler contre dieu (ID: `keyterm:Blaspheme`); croire (ID: `keyterm:Believe`); Tile (ID: `realia:Tile`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** collecteur d'impôt (ID: `keyterm:TaxCollector`); jeûner (ID: `keyterm:Fast`); trans. faire un disciple de (ID: `keyterm:Disciple`); Pharisien (ID: `group:Pharisee`); Matthieu (ID: `person:Matthew`); Skin-Bottle (ID: `realia:Skin-bottle`); Must (ID: `realia:Must`); Jésus (ID: `person:Jesus.2`); nom (ID: `keyterm:Name`); se repentir (ID: `keyterm:Repent`); Jean (ID: `person:John`); prier (ID: `keyterm:Pray`); parabole (ID: `keyterm:Parable`); le bien (ID: `keyterm:Good`); bureau de perception (ID: `keyterm:TaxOffice`); Religious Officials (ID: `group:ReligiousOfficials`); être juste (ID: `keyterm:Just`); Patch (ID: `realia:Patch`); Clothing (ID: `realia:Clothing`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** sabbat (ID: `keyterm:Sabbath`); Jésus (ID: `person:Jesus.2`); Be Lawful (ID: `keyterm:Lawful`); Pharisien (ID: `group:Pharisee`); trans. faire un disciple de (ID: `keyterm:Disciple`); aide (ID: `keyterm:Salvation`); vie (ID: `keyterm:Life`); Éternel (ID: `deity:Lord`); faire du bien (ID: `keyterm:DoGood`); servir (ID: `keyterm:Serve`); David (ID: `person:David`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Synagogue (ID: `realia:Synagogue`); Grain (ID: `flora:Grain`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** béni (ID: `keyterm:Happy`); trans. faire un disciple de (ID: `keyterm:Disciple`); Disaster (ID: `keyterm:Disaster`); Éternel (ID: `deity:Lord`); Jacques (ID: `person:James.2`); choisi (ID: `keyterm:Chosen`); Simon (ID: `person:Simon.2`); Judas (ID: `person:Judas`); Matthieu (ID: `person:Matthew`); Jérusalem (ID: `place:Jerusalem`); capacité (ID: `keyterm:Ability`); Barthélemy (ID: `person:Bartholomew`); Tyr (ID: `place:Tyre`); Alphée (ID: `person:Alphaeus`); régne (ID: `keyterm:Kingdom`); nom (ID: `keyterm:Name`); Sidon (ID: `place:Sidon`); Judas (ID: `person:Judas.2`); Pierre (ID: `person:Peter`); prier (ID: `keyterm:Pray`); Philippe (ID: `person:Philip`); Judée (ID: `place:Judea`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Thomas (ID: `person:Thomas`); André (ID: `person:Andrew`); prier (ID: `keyterm:AskFor`); servir (ID: `keyterm:Serve`); Jacques (ID: `person:James`); Jean (ID: `person:John.2`)
...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); grâce (ID: `keyterm:Favor`); faire du bien (ID: `keyterm:DoGood`); Éternel (ID: `deity:Lord`); le bien (ID: `keyterm:Good`); Foundation (ID: `realia:Foundation`); House (ID: `realia:House`); Beam (ID: `realia:Beam`); miséricordieux (ID: `keyterm:Compassionate`); condamner (ID: `keyterm:Condemn`); coeur (ID: `keyterm:Heart`); decider (ID: `keyterm:Decided`); benir (ID: `keyterm:Bless`); prier (ID: `keyterm:Pray`); parabole (ID: `keyterm:Parable`); pardonner (ID: `keyterm:Forgive`); trans. faire un disciple de (ID: `keyterm:Disciple`); espoir (ID: `keyterm:Hope`); Storeroom (ID: `realia:Storeroom`); Cloak (ID: `realia:Cloak`); Thistle (ID: `flora:Thistle`); Boxthorn (ID: `flora:Boxthorn`); Tunic (ID: `realia:Tunic.2`); Vine (ID: `flora:Vine`); Acacia (ID: `flora:Acacia`); Brier (ID: `flora:Brier`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); prier (ID: `keyterm:AskFor`); Temple (ID: `realia:Temple`); House (ID: `realia:House`); Naïn (ID: `place:Nain`); Judée (ID: `place:Judea`); gloire (ID: `keyterm:Glory`); capacité (ID: `keyterm:Ability`); aimer (ID: `keyterm:Love`); ce qui est dit (ID: `keyterm:Word`); autorité (ID: `keyterm:Authority.2`); Éternel (ID: `deity:Lord`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); prescrire (ID: `keyterm:Command`); craindre (ID: `keyterm:Fear`); croire (ID: `keyterm:Believe`); A Group of People (ID: `group:GenericGroup`); Jews (ID: `group:Jews`); trans. faire un disciple de (ID: `keyterm:Disciple`); Israël (ID: `person:Israel`); Capernaüm (ID: `place:Capernaum`); aide (ID: `keyterm:Salvation`); Housetop (ID: `realia:Housetop`); Synagogue (ID: `realia:Synagogue`); Bier (ID: `realia:Bier`)
...
* **Associated ACAI Concepts:** Jean (ID: `person:John`); Éternel (ID: `deity:Lord`); baptiste [jean] (ID: `keyterm:Baptist`); collecteur d'impôt (ID: `keyterm:TaxCollector`); An Angel (ID: `deity:Angel`); baptême (ID: `keyterm:Baptism`); bonnes nouvelles (ID: `keyterm:GoodNews`); obéir (ID: `keyterm:ObeyRighteousCommands`); Jésus (ID: `person:Jesus.2`); béni (ID: `keyterm:Happy`); régne (ID: `keyterm:Kingdom`); glorieux (ID: `keyterm:Glorious`); purifier (ID: `keyterm:Cleanse.2`); résurrection (ID: `keyterm:Resurrection`); servir (ID: `keyterm:Serve`); pardonner (ID: `keyterm:Forgive`); trans. faire un disciple de (ID: `keyterm:Disciple`); Demons (ID: `deity:Demons`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisien (ID: `group:Pharisee`); être juste (ID: `keyterm:Just`); Palace (ID: `realia:Palace`); Clothing (ID: `realia:Clothing`); Reed (ID: `flora:Reed`); Flute (ID: `realia:Flute`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** pardonner (ID: `keyterm:Forgive`); Simon (ID: `person:Simon.6`); pécher (ID: `keyterm:Sin`); Pharisien (ID: `group:Pharisee`); Myrrh (ID: `flora:Myrrh`); House (ID: `realia:House`); Myrrh (ID: `realia:Myrrh`); aimer (ID: `keyterm:Love`); oint (ID: `keyterm:Anointed`); devoir (qch) à [qqn] (ID: `keyterm:Owe`); Jésus (ID: `person:Jesus.2`); decider (ID: `keyterm:Decided`); croire (ID: `keyterm:Believe`); prier (ID: `keyterm:AskFor`); faire la paix (ID: `keyterm:Peace`); aide (ID: `keyterm:Salvation`); Alabaster Jar (ID: `realia:AlabasterJar`); Temple (ID: `realia:Temple`); Denarius (ID: `realia:Denarius`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** parabole (ID: `keyterm:Parable`); Éternel (ID: `deity:Lord`); coeur (ID: `keyterm:Heart`); régne (ID: `keyterm:Kingdom`); croire (ID: `keyterm:Believe`); servir (ID: `keyterm:Serve`); Thistle (ID: `flora:Thistle`); Boxthorn (ID: `flora:Boxthorn`); Grain (ID: `flora:Grain`); Acacia (ID: `flora:Acacia`); Brier (ID: `flora:Brier`); Barley (ID: `flora:Barley`); bien (ID: `keyterm:Honest`); Susanne (ID: `person:Susanna`); Marie de Magdala (ID: `person:Marymagdalene`); vie quotidienne (ID: `keyterm:DailyLife`); Chuza (ID: `person:Chuza`); Jeanne (ID: `person:Joanna`); bonnes nouvelles (ID: `keyterm:GoodNews`); proclamer (ID: `keyterm:Proclaim`); Cause of Joy (ID: `keyterm:CauseOfJoy`); mis à l'essai (ID: `keyterm:PutToTheTest`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Hérode Antipas (ID: `person:Herod.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); Demons (ID: `deity:Demons`); aide (ID: `keyterm:Salvation`); Lampstand (ID: `realia:Lampstand.2`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); Jésus (ID: `person:Jesus.2`); craindre (ID: `keyterm:Fear`); prier (ID: `keyterm:AskFor`); Gerasa (ID: `place:Gerasa`); Éternel (ID: `deity:Lord`); Ship (ID: `realia:Ship`); House (ID: `realia:House`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); être possédé par un démon (ID: `keyterm:DemonPossessed`); Légion (ID: `deity:Legion`); le monde des morts (ID: `keyterm:Abyss`); proclamer (ID: `keyterm:Proclaim`); Galilée (ID: `place:Galilee`); nom (ID: `keyterm:Name`); A Man (ID: `person:GenericMale`); prescrire (ID: `keyterm:Command`); croire (ID: `keyterm:Believe`); trans. faire un disciple de (ID: `keyterm:Disciple`); aide (ID: `keyterm:Salvation`); Fetter (ID: `realia:Fetter`); Temple (ID: `realia:Temple`); Clothing (ID: `realia:Clothing`); Chain (ID: `realia:Chain`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); sang (ID: `keyterm:Blood`); Pierre (ID: `person:Peter`); croire (ID: `keyterm:Believe`); aide (ID: `keyterm:Salvation`); Synagogue (ID: `realia:Synagogue`); House (ID: `realia:House`); Jaïrus (ID: `person:Jairus`); capacité (ID: `keyterm:Ability`); vie (ID: `keyterm:Life`); nom (ID: `keyterm:Name`); vie quotidienne (ID: `keyterm:DailyLife`); craindre (ID: `keyterm:Fear`); servir (ID: `keyterm:Serve`); prier (ID: `keyterm:AskFor`); Jacques (ID: `person:James`); faire la paix (ID: `keyterm:Peace`); esprit (ID: `keyterm:Spirit.2`); Jean (ID: `person:John.2`); Temple (ID: `realia:Temple`); Tassel (ID: `realia:Tassel`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** régne (ID: `keyterm:Kingdom`); Éternel (ID: `deity:Lord`); Jean (ID: `person:John`); Hérode Antipas (ID: `person:Herod.2`); servir (ID: `keyterm:Serve`); trans. faire un disciple de (ID: `keyterm:Disciple`); Fish (ID: `fauna:Fish`); capacité (ID: `keyterm:Ability`); bonnes nouvelles (ID: `keyterm:GoodNews`); proclamer (ID: `keyterm:Proclaim`); Élie (ID: `person:Elijah`); Bethsaïda (ID: `place:Bethsaida`); benir (ID: `keyterm:Bless`); autorité (ID: `keyterm:Authority.2`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); résurrection (ID: `keyterm:Resurrection`); Demons (ID: `deity:Demons`); A Group of Disciples (ID: `group:GenericDisciples`); témoigner (ID: `keyterm:BearWitness`); Bag (ID: `realia:Bag`); Tunic (ID: `realia:Tunic.2`); House (ID: `realia:House`); Staff (ID: `realia:Staff`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); rejeter (ID: `keyterm:Reject`); gloire (ID: `keyterm:Glory`); capacité (ID: `keyterm:Ability`); Élie (ID: `person:Elijah`); Jésus (ID: `person:Jesus.2`); vie (ID: `keyterm:Life`); régne (ID: `keyterm:Kingdom`); saint (ID: `keyterm:Holy`); An Angel (ID: `deity:Angel`); Pierre (ID: `person:Peter`); vrai (ID: `keyterm:True`); Jean (ID: `person:John`); prier (ID: `keyterm:Pray`); prescrire (ID: `keyterm:Command`); résurrection (ID: `keyterm:Resurrection`); baptiste [jean] (ID: `keyterm:Baptist`); trans. faire un disciple de (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); aide (ID: `keyterm:Salvation`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Pierre (ID: `person:Peter`); gloire (ID: `keyterm:Glory`); Élie (ID: `person:Elijah`); Moïse (ID: `person:Moses`); Jésus (ID: `person:Jesus.2`); prier (ID: `keyterm:Pray`); Jérusalem (ID: `place:Jerusalem`); To Cause to Happen (ID: `keyterm:Happen`); craindre (ID: `keyterm:Fear`); Jean (ID: `person:John.2`); choisi (ID: `keyterm:Chosen`); Jacques (ID: `person:James`); Clothing (ID: `realia:Clothing`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); nom (ID: `keyterm:Name`); Demons (ID: `deity:Demons`); être infidèle (ID: `keyterm:Unfaithful`); prescrire (ID: `keyterm:Command`); ce qui est dit (ID: `keyterm:Word`); craindre (ID: `keyterm:Fear`); Jean (ID: `person:John.2`); prier (ID: `keyterm:AskFor`); Éternel (ID: `deity:Lord`); coeur (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); régne (ID: `keyterm:Kingdom`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); Shimrath (ID: `group:Samaritan`); Religious Official (ID: `person:ReligiousOfficial`); trans. faire un disciple de (ID: `keyterm:Disciple`); prescrire (ID: `keyterm:Command`); An Angel (ID: `deity:Angel`); A Man (ID: `person:GenericMale`); Jean (ID: `person:John.2`); Samarie (ID: `place:Samaria`); Jacques (ID: `person:James`); House (ID: `realia:House`); Mattock (ID: `realia:Mattock`); Jackal (ID: `fauna:Jackal`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); faire la paix (ID: `keyterm:Peace`); capacité (ID: `keyterm:Ability`); Tyr (ID: `place:Tyre`); régne (ID: `keyterm:Kingdom`); nom (ID: `keyterm:Name`); Sidon (ID: `place:Sidon`); House (ID: `realia:House`); Chorazin (ID: `place:Chorazin`); Disaster (ID: `keyterm:Disaster`); Jésus (ID: `person:Jesus.2`); Hell (ID: `place:Hell`); béni (ID: `keyterm:Happy`); Bethsaïda (ID: `place:Bethsaida`); Cause of Joy (ID: `keyterm:CauseOfJoy`); agir par méchanceté (ID: `keyterm:ActWickedly`); se repentir (ID: `keyterm:Repent`); jugement (ID: `keyterm:Judgment`); autorité (ID: `keyterm:Authority.2`); Satan (ID: `deity:Satan`); prier (ID: `keyterm:AskFor`); servir (ID: `keyterm:Serve`); Saint-Esprit (ID: `deity:HolySpirit`); tribunal (ID: `keyterm:CourtCase`); trans. faire un disciple de (ID: `keyterm:Disciple`); Sodome (ID: `place:Sodom`); Demons (ID: `deity:Demons`); Capernaüm (ID: `place:Capernaum`); hadès (ID: `keyterm:WorldOfTheDead`); Scorpion (ID: `fauna:Scorpion`); Bag (ID: `realia:Bag`); Sheep (ID: `fauna:Lamb`); Sackcloth (ID: `realia:Sackcloth`); Wolf (ID: `fauna:Wolf`); Snake (ID: `fauna:Snake`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); A Priest (ID: `person:GenericPriest`); A Scribe (ID: `person:Scribe`); vie (ID: `keyterm:Life`); Inn (ID: `realia:Inn`); intelligence (ID: `keyterm:Mind.2`); pitié (ID: `keyterm:Mercy`); Jérusalem (ID: `place:Jerusalem`); aimer (ID: `keyterm:Love`); coeur (ID: `keyterm:Heart`); Jéricho (ID: `place:Jericho`); Shimrath (ID: `group:Samaritan`); éternellement (ID: `keyterm:Always`); Éternel (ID: `deity:Lord`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); loi (ID: `keyterm:Law`); Samarie (ID: `place:Samaria`); Lévi (ID: `person:Levi.3`); être juste (ID: `keyterm:Just`); Lévi (ID: `group:Levi`); Denarius (ID: `realia:Denarius`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Marthe (ID: `person:Martha`); Marie (ID: `person:Mary.3`); Jésus (ID: `person:Jesus.2`); prescrire (ID: `keyterm:Command`); nom (ID: `keyterm:Name`); le bien (ID: `keyterm:Good`); servir (ID: `keyterm:Serve`); choisi (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** prier (ID: `keyterm:Pray`); Éternel (ID: `deity:Lord`); régne (ID: `keyterm:Kingdom`); trans. faire un disciple de (ID: `keyterm:Disciple`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); saint (ID: `keyterm:Holy`); pécher (ID: `keyterm:Sin`); nom (ID: `keyterm:Name`); conduis (ID: `keyterm:BringIn`); A Group of Disciples (ID: `group:GenericDisciples`); mis à l'essai (ID: `keyterm:PutToTheTest`); Jean (ID: `person:John`); pardonner (ID: `keyterm:Forgive`); Saint-Esprit (ID: `deity:HolySpirit`); Fish (ID: `fauna:Fish`); Snake (ID: `fauna:Snake`); Door (ID: `realia:Door`); Scorpion (ID: `fauna:Scorpion`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); régne (ID: `keyterm:Kingdom`); Satan (ID: `deity:Satan`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); faire la paix (ID: `keyterm:Peace`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); exemple (ID: `keyterm:Example`); A Group of People (ID: `group:GenericGroup`); Éternel (ID: `deity:Lord`); coeur (ID: `keyterm:Heart`); persuader (ID: `keyterm:Persuade`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Jonas (ID: `person:Jonah.2`); Ninive (ID: `group:Nineveh`); tribunal (ID: `keyterm:CourtCase`); corps (ID: `keyterm:Body.3`); exemple (ID: `keyterm:Example`); jugement (ID: `keyterm:Judgment`); Ninive (ID: `place:Nineveh`); béni (ID: `keyterm:Happy`); proclamer (ID: `keyterm:Proclaim`); se repentir (ID: `keyterm:Repent`); reine de Séba (ID: `person:QueenOfSheba`); Sheba (ID: `place:Sheba.2`); Salomon (ID: `person:Solomon`); Éternel (ID: `deity:Lord`); A Woman (ID: `person:GenericFemale`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** Pharisien (ID: `group:Pharisee`); Disaster (ID: `keyterm:Disaster`); sang (ID: `keyterm:Blood`); aimer (ID: `keyterm:Love`); Éternel (ID: `deity:Lord`); Zacharie (ID: `person:Zechariah.12`); capacité (ID: `keyterm:Ability`); Abel (ID: `person:Abel`); Jésus (ID: `person:Jesus.2`); jugement (ID: `keyterm:Judgment`); purifier (ID: `keyterm:Cleanse.2`); pur (ID: `keyterm:Clean`); prier (ID: `keyterm:AskFor`); témoin (ID: `keyterm:Witness`); A Scribe (ID: `person:Scribe`); Plate (ID: `realia:Plate.2`); Rue (ID: `flora:Rue`); Mint (ID: `flora:Mint`); Synagogue (ID: `realia:Synagogue`); Grass (ID: `flora:Grass`); House (ID: `realia:House`); Grave (ID: `realia:Grave`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); capacité (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); autorité (ID: `keyterm:Authority.2`); Saint-Esprit (ID: `deity:HolySpirit`); Sparrow (ID: `fauna:Sparrow`); parler contre dieu (ID: `keyterm:Blaspheme`); enfer (ID: `keyterm:Gehenna`); hypocrisie (ID: `keyterm:Hypocrisy`); corps (ID: `keyterm:Body.3`); proclamer (ID: `keyterm:Proclaim`); Hell (ID: `place:Hell`); conduis (ID: `keyterm:BringIn`); pardonner (ID: `keyterm:Forgive`); trans. faire un disciple de (ID: `keyterm:Disciple`); Pharisien (ID: `group:Pharisee`); Inner Room (ID: `realia:InnerRoom`); Assarion (ID: `realia:Assarion`); Housetop (ID: `realia:Housetop`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); vie (ID: `keyterm:Life`); corps (ID: `keyterm:Body.3`); régne (ID: `keyterm:Kingdom`); Barn (ID: `realia:Barn`); gloire (ID: `keyterm:Glory`); capacité (ID: `keyterm:Ability`); Salomon (ID: `person:Solomon`); coeur (ID: `keyterm:Heart`); parabole (ID: `keyterm:Parable`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); prescrire (ID: `keyterm:Command`); craindre (ID: `keyterm:Fear`); trans. faire un disciple de (ID: `keyterm:Disciple`); qui manque de foi (ID: `keyterm:HavingLittleFaith`); A Person (ID: `person:GenericPerson`); Bag (ID: `realia:Bag`); Oven (ID: `realia:Oven`); Storeroom (ID: `realia:Storeroom`); Flock (ID: `fauna:Flock`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Crow (ID: `fauna:Crow`); Wheat (ID: `flora:Wheat`); Rooster (ID: `fauna:Rooster`); Clothing (ID: `realia:Clothing`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`); Bird (ID: `fauna:Bird`); Moth (ID: `fauna:Moth`)
...
* **Associated ACAI Concepts:** béni (ID: `keyterm:Happy`); sûrement! (ID: `keyterm:Surely`); Jésus (ID: `person:Jesus.2`); coeur (ID: `keyterm:Heart`); decider (ID: `keyterm:Decided`); trans. libérer (ID: `keyterm:SetFree`); Pierre (ID: `person:Peter`); vrai (ID: `keyterm:True`); parabole (ID: `keyterm:Parable`); fidelité (ID: `keyterm:Faithfulness`); être infidèle (ID: `keyterm:Unfaithful`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); baptême (ID: `keyterm:Baptism`); servir (ID: `keyterm:Serve`); tester (ID: `keyterm:Interpret`); faire la paix (ID: `keyterm:Peace`); être juste (ID: `keyterm:Just`); Lepton (ID: `realia:Lepton`); House (ID: `realia:House`); Prison (ID: `realia:Prison`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** se repentir (ID: `keyterm:Repent`); Galiléen (ID: `group:Galilee`); Galilée (ID: `place:Galilee`); Fig (ID: `flora:Fig`); Jérusalem (ID: `place:Jerusalem`); sang (ID: `keyterm:Blood`); offrande (ID: `keyterm:Offering`); Siloam (ID: `place:Siloam`); parabole (ID: `keyterm:Parable`); Pilate (ID: `person:Pilate`); Tower (ID: `realia:Tower`); Vine (ID: `flora:Vine`); Watch-Tower (ID: `realia:Watch-tower`)
...
* **Associated ACAI Concepts:** sabbat (ID: `keyterm:Sabbath`); Jésus (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Religious Official (ID: `person:ReligiousOfficial`); gloire (ID: `keyterm:Glory`); Satan (ID: `deity:Satan`); servir (ID: `keyterm:Serve`); Éternel (ID: `deity:Lord`); glorieux (ID: `keyterm:Glorious`); Abraham (ID: `person:Abraham`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Donkey (ID: `fauna:Donkey`)
...
* **Associated ACAI Concepts:** régne (ID: `keyterm:Kingdom`); Éternel (ID: `deity:Lord`); Door (ID: `realia:Door`); Jérusalem (ID: `place:Jerusalem`); méfaits (ID: `keyterm:UnjustDeed`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); aide (ID: `keyterm:Salvation`); Israël (ID: `person:Israel`); A Person (ID: `person:GenericPerson`); Isaac (ID: `person:Isaac`); Abraham (ID: `person:Abraham`); Saton (ID: `realia:Saton`); Grain (ID: `flora:Grain`); Mustard (ID: `flora:Mustard`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); nom (ID: `keyterm:Name`); benir (ID: `keyterm:Bless`); Demons (ID: `deity:Demons`); Hérode Antipas (ID: `person:Herod.2`); Jésus (ID: `person:Jesus.2`); Pharisien (ID: `group:Pharisee`); Éternel (ID: `deity:Lord`); Rooster (ID: `fauna:Rooster`); House (ID: `realia:House`); Jackal (ID: `fauna:Jackal`); Bird (ID: `fauna:Bird`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** sabbat (ID: `keyterm:Sabbath`); Pharisien (ID: `group:Pharisee`); gloire (ID: `keyterm:Glory`); béni (ID: `keyterm:Happy`); Jésus (ID: `person:Jesus.2`); résurrection (ID: `keyterm:Resurrection`); Be Lawful (ID: `keyterm:Lawful`); servir (ID: `keyterm:Serve`); être juste (ID: `keyterm:Just`); choisi (ID: `keyterm:Chosen`); parabole (ID: `keyterm:Parable`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** prier (ID: `keyterm:AskFor`); régne (ID: `keyterm:Kingdom`); A Scribe (ID: `person:Scribe`); Éternel (ID: `deity:Lord`); béni (ID: `keyterm:Happy`); tester (ID: `keyterm:Interpret`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** trans. faire un disciple de (ID: `keyterm:Disciple`); faire la paix (ID: `keyterm:Peace`); vie (ID: `keyterm:Life`); prier (ID: `keyterm:AskFor`); Tower (ID: `realia:Tower`); Watch-Tower (ID: `realia:Watch-tower`); Cross (ID: `realia:Cross`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Cause of Joy (ID: `keyterm:CauseOfJoy`); se repentir (ID: `keyterm:Repent`); Drachma (ID: `realia:Drachma`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); An Angel (ID: `deity:Angel`); Pharisien (ID: `group:Pharisee`); collecteur d'impôt (ID: `keyterm:TaxCollector`); Éternel (ID: `deity:Lord`); être juste (ID: `keyterm:Just`); parabole (ID: `keyterm:Parable`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Cattle (ID: `fauna:Bull`); vie quotidienne (ID: `keyterm:DailyLife`); travailleur employé (ID: `keyterm:HiredWorker`); vie (ID: `keyterm:Life`); pécher (ID: `keyterm:Sin`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); commandement (ID: `keyterm:Commandment`); servir (ID: `keyterm:Serve.2`); prier (ID: `keyterm:AskFor`); Kid (ID: `fauna:Kid`); Carob (ID: `flora:Carob`); Cloak (ID: `realia:Cloak`); Goat (ID: `fauna:Goat`); Seal (ID: `realia:Seal`); House (ID: `realia:House`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** fidelité (ID: `keyterm:Faithfulness`); gestion d'un foyer (ID: `keyterm:Stewardship`); devoir (qch) à [qqn] (ID: `keyterm:Owe`); méfaits (ID: `keyterm:UnjustDeed`); éternellement (ID: `keyterm:Always`); Kor (ID: `realia:Kor.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); capacité (ID: `keyterm:Ability`); croire (ID: `keyterm:Believe`); autorité (ID: `keyterm:Authority.2`); vrai (ID: `keyterm:True`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Olive Oil (ID: `realia:OliveOil`); Tent (ID: `realia:Tent`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); loi (ID: `keyterm:Law`); fornication (ID: `keyterm:Fornication`); régne (ID: `keyterm:Kingdom`); bonnes nouvelles (ID: `keyterm:GoodNews`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); être juste (ID: `keyterm:Just`); aimer (ID: `keyterm:Love`); ami de l'argent (ID: `keyterm:LovingWealth`); Pharisien (ID: `group:Pharisee`); Jean (ID: `person:John`); coeur (ID: `keyterm:Heart`); servir (ID: `keyterm:Serve.2`); abomination (ID: `keyterm:Abomination`)
...
* **Associated ACAI Concepts:** Abraham (ID: `person:Abraham`); Lazare (ID: `person:Lazarus`); Moïse (ID: `person:Moses`); prier (ID: `keyterm:AskFor`); hadès (ID: `keyterm:WorldOfTheDead`); nom (ID: `keyterm:Name`); An Angel (ID: `deity:Angel`); se repentir (ID: `keyterm:Repent`); prier (ID: `keyterm:Encourage`); vie (ID: `keyterm:Life`); persuader (ID: `keyterm:Persuade`); declarer solennellement et catégoriquement (ID: `keyterm:Declare`); Hell (ID: `place:Hell`); pitié (ID: `keyterm:Mercy`); Dog (ID: `fauna:Dog`); Purple Cloth (ID: `realia:PurpleCloth`); Linen (ID: `realia:Linen`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); pécher (ID: `keyterm:Sin`); se repentir (ID: `keyterm:Repent`); croire (ID: `keyterm:Believe`); pardonner (ID: `keyterm:Forgive`); sois obligé (ID: `keyterm:Ought`); faire pécher qqn (ID: `keyterm:CauseToStumble`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); grâce (ID: `keyterm:Favor`); prescrire (ID: `keyterm:Command`); servir (ID: `keyterm:Serve`); trans. faire un disciple de (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Disaster (ID: `keyterm:Disaster`); Mulberry (ID: `flora:Mulberry`); Sheep (ID: `fauna:Lamb`); Hand-Mill (ID: `realia:Hand-mill`); Flock (ID: `fauna:Flock`); Grain (ID: `flora:Grain`); Goat (ID: `fauna:Goat`); Mustard (ID: `flora:Mustard`)
...
* **Associated ACAI Concepts:** gloire (ID: `keyterm:Glory`); purifier (ID: `keyterm:Cleanse.2`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); Samarie (ID: `place:Samaria`); Jérusalem (ID: `place:Jerusalem`); aide (ID: `keyterm:Salvation`); croire (ID: `keyterm:Believe`); Shimrath (ID: `group:Samaritan`); pitié (ID: `keyterm:Mercy`); Galilée (ID: `place:Galilee`)
...
* **Associated ACAI Concepts:** Lot (ID: `person:Lot`); régne (ID: `keyterm:Kingdom`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Éternel (ID: `deity:Lord`); Noah (ID: `person:Noah`); trans. faire un disciple de (ID: `keyterm:Disciple`); rejeter (ID: `keyterm:Reject`); Sodome (ID: `place:Sodom`); corps (ID: `keyterm:Body.3`); observation (ID: `keyterm:Observation`); vie (ID: `keyterm:Life`); Pharisien (ID: `group:Pharisee`); faire vivre (ID: `keyterm:Alive`); House (ID: `realia:House`); Boat (ID: `realia:Boat`); Vulture (ID: `fauna:Vulture`); Housetop (ID: `realia:Housetop`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); aider (quelqu'un) à obtenir justice (ID: `keyterm:GrantJustice`); collecteur d'impôt (ID: `keyterm:TaxCollector`); prier (ID: `keyterm:Pray`); Pharisien (ID: `group:Pharisee`); Jésus (ID: `person:Jesus.2`); régne (ID: `keyterm:Kingdom`); parabole (ID: `keyterm:Parable`); craindre (ID: `keyterm:Fear`); être juste (ID: `keyterm:Just`); Temple (ID: `realia:Temple`); jeûner (ID: `keyterm:Fast`); sûrement! (ID: `keyterm:Surely`); coeur (ID: `keyterm:Heart`); persuader (ID: `keyterm:Persuade`); choisi (ID: `keyterm:Chosen`); méfaits (ID: `keyterm:UnjustDeed`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); prescrire (ID: `keyterm:Command`); croire (ID: `keyterm:Believe`); pardonner (ID: `keyterm:Forgive`); trans. faire un disciple de (ID: `keyterm:Disciple`); semaine (ID: `keyterm:Week`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); régne (ID: `keyterm:Kingdom`); Jésus (ID: `person:Jesus.2`); le bien (ID: `keyterm:Good`); vie (ID: `keyterm:Life`); éternellement (ID: `keyterm:Always`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); sûrement! (ID: `keyterm:Surely`); Pierre (ID: `person:Peter`); Rich Young Ruler (ID: `person:RichYoungRuler`); fornication (ID: `keyterm:Fornication`); commandement (ID: `keyterm:Commandment`); aide (ID: `keyterm:Salvation`); Needle (ID: `realia:Needle`); House (ID: `realia:House`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); David (ID: `person:David`); pitié (ID: `keyterm:Mercy`); gloire (ID: `keyterm:Glory`); Jérusalem (ID: `place:Jerusalem`); prescrire (ID: `keyterm:Command`); ce qui est dit (ID: `keyterm:Word`); croire (ID: `keyterm:Believe`); nation; peuple (ID: `group:Gentile`); Nazareth (ID: `place:Nazareth`); Éternel (ID: `deity:Lord`); Jéricho (ID: `place:Jericho`); aide (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Zachée (ID: `person:Zacchaeus`); aide (ID: `keyterm:Salvation`); nom (ID: `keyterm:Name`); Jéricho (ID: `place:Jericho`); Abraham (ID: `person:Abraham`); Sycomore Fig (ID: `flora:SycomoreFig`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Fig (ID: `flora:Fig`)
...
* **Associated ACAI Concepts:** Mina (ID: `realia:Mina`); régne (ID: `keyterm:Kingdom`); decider (ID: `keyterm:Decided`); capacité (ID: `keyterm:Ability`); Jérusalem (ID: `place:Jerusalem`); fidelité (ID: `keyterm:Faithfulness`); le bien (ID: `keyterm:Good`); craindre (ID: `keyterm:Fear`); autorité (ID: `keyterm:Authority.2`); Éternel (ID: `deity:Lord`); parabole (ID: `keyterm:Parable`); Band of Cloth (ID: `realia:BandOfCloth`)
...
* **Associated ACAI Concepts:** trans. faire un disciple de (ID: `keyterm:Disciple`); Donkey (ID: `fauna:Donkey`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); faire la paix (ID: `keyterm:Peace`); Temple (ID: `realia:Temple`); Jérusalem (ID: `place:Jerusalem`); Clothing (ID: `realia:Clothing`); Olive Tree (ID: `flora:OliveTree`); Bethphagé (ID: `place:Bethphage`); Béthanie (ID: `place:Bethany`); montagne des oliviers (ID: `place:OlivesMount`); hauteur (ID: `keyterm:Height`); gloire (ID: `keyterm:Glory`); capacité (ID: `keyterm:Ability`); nom (ID: `keyterm:Name`); benir (ID: `keyterm:Bless`); prier (ID: `keyterm:Pray`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); prescrire (ID: `keyterm:Command`); A Group of People (ID: `group:GenericGroup`); prier (ID: `keyterm:AskFor`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisien (ID: `group:Pharisee`); Siege-Works (ID: `realia:Siege-works`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); capacité (ID: `keyterm:Ability`); vide (ID: `keyterm:Empty`); autorité (ID: `keyterm:Authority.2`); Jean (ID: `person:John`); parabole (ID: `keyterm:Parable`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Temple (ID: `realia:Temple`); bonnes nouvelles (ID: `keyterm:GoodNews`); Jésus (ID: `person:Jesus.2`); coeur (ID: `keyterm:Heart`); persuader (ID: `keyterm:Persuade`); rejeter (ID: `keyterm:Reject`); bien, aimé (ID: `keyterm:Beloved`); craindre (ID: `keyterm:Fear`); croire (ID: `keyterm:Believe`); baptême (ID: `keyterm:Baptism`); prier (ID: `keyterm:AskFor`); Cornerstone (ID: `realia:Cornerstone`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); résurrection (ID: `keyterm:Resurrection`); Tibère (ID: `person:Tiberius`); capacité (ID: `keyterm:Ability`); David (ID: `person:David`); Jésus (ID: `person:Jesus.2`); éternellement (ID: `keyterm:Always`); Moïse (ID: `person:Moses`); vérité (ID: `keyterm:Truth`); vie (ID: `keyterm:Life`); Be Lawful (ID: `keyterm:Lawful`); A Priest (ID: `person:GenericPriest`); ce qui est dit (ID: `keyterm:Word`); chemin (ID: `keyterm:TheWay`); autorité (ID: `keyterm:Authority.2`); Sadducéens (ID: `group:Sadducee`); Abraham (ID: `person:Abraham`); Israël (ID: `person:Israel`); être juste (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); hypocrisie (ID: `keyterm:Hypocrisy`); Isaac (ID: `person:Isaac`); taxe (ID: `keyterm:TributeTax`); Boxthorn (ID: `flora:Boxthorn`); Footstool (ID: `realia:Footstool`); Denarius (ID: `realia:Denarius`); Image (ID: `realia:Image`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** offrande (ID: `keyterm:Offering`); trans. faire un disciple de (ID: `keyterm:Disciple`); vie quotidienne (ID: `keyterm:DailyLife`); amour (ID: `keyterm:Friendship`); jugement (ID: `keyterm:Judgment`); vrai (ID: `keyterm:True`); prier (ID: `keyterm:Pray`); Lepton (ID: `realia:Lepton`); House (ID: `realia:House`); Treasury (ID: `realia:Treasury`); Synagogue (ID: `realia:Synagogue`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** nom (ID: `keyterm:Name`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Jérusalem (ID: `place:Jerusalem`); capacité (ID: `keyterm:Ability`); coeur (ID: `keyterm:Heart`); régne (ID: `keyterm:Kingdom`); exemple (ID: `keyterm:Example`); gloire (ID: `keyterm:Glory`); sûrement! (ID: `keyterm:Surely`); aider (quelqu'un) à obtenir justice (ID: `keyterm:GrantJustice`); Éternel (ID: `deity:Lord`); parabole (ID: `keyterm:Parable`); Judée (ID: `place:Judea`); libération (ID: `keyterm:Liberation`); craindre (ID: `keyterm:Fear`); prier (ID: `keyterm:AskFor`); vue ou événement redoutable (ID: `keyterm:DreadfulEventOrSight`); nation; peuple (ID: `group:Gentile`); Disaster (ID: `keyterm:Disaster`); concernant la vie quotidienne (ID: `keyterm:OfThisLife`); témoigner (ID: `keyterm:BearWitness`); Temple (ID: `realia:Temple`); Net (ID: `realia:Net`); Synagogue (ID: `realia:Synagogue`); Fig (ID: `flora:Fig`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); Judas (ID: `person:Judas.2`); craindre (ID: `keyterm:Fear`); Satan (ID: `deity:Satan`); montagne des oliviers (ID: `place:OlivesMount`); sacrifice de la pâque (ID: `keyterm:Passover`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** sacrifice de la pâque (ID: `keyterm:Passover`); régne (ID: `keyterm:Kingdom`); Éternel (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); servir (ID: `keyterm:Serve`); House (ID: `realia:House`); sang (ID: `keyterm:Blood`); corps (ID: `keyterm:Body.3`); decider (ID: `keyterm:Decided`); offrande (ID: `keyterm:Offering`); Pierre (ID: `person:Peter`); autorité (ID: `keyterm:Authority.2`); To Cause to Happen (ID: `keyterm:Happen`); trans. faire un disciple de (ID: `keyterm:Disciple`); Israël (ID: `person:Israel`); nation; peuple (ID: `group:Gentile`); alliance (ID: `keyterm:Covenant`); Jean (ID: `person:John.2`); Disaster (ID: `keyterm:Disaster`); Upstairs Room (ID: `realia:UpstairsRoom`); Guest Room (ID: `realia:GuestRoom`); Clay Jar (ID: `realia:ClayJar`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** prier (ID: `keyterm:Pray`); Pierre (ID: `person:Peter`); mis à l'essai (ID: `keyterm:PutToTheTest`); trans. faire un disciple de (ID: `keyterm:Disciple`); Bag (ID: `realia:Bag`); An Angel (ID: `deity:Angel`); Éternel (ID: `deity:Lord`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); corruption morale (ID: `keyterm:Lawless`); croire (ID: `keyterm:Believe`); Satan (ID: `deity:Satan`); scripture (ID: `keyterm:Scripture`); prier (ID: `keyterm:AskFor`); A Group of Disciples (ID: `group:GenericDisciples`); Wheat (ID: `flora:Wheat`); Rooster (ID: `fauna:Rooster`); Cloak (ID: `realia:Cloak`); Olive Tree (ID: `flora:OliveTree`); Prison (ID: `realia:Prison`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Pierre (ID: `person:Peter`); Jésus (ID: `person:Jesus.2`); Judas (ID: `person:Judas.2`); Rooster (ID: `fauna:Rooster`); Temple (ID: `realia:Temple`); Peter's Second Accuser (ID: `person:SecondAccuserOfPeter`); A Servant (ID: `person:GenericServant`); capacité (ID: `keyterm:Ability`); autorité (ID: `keyterm:Authority.2`); vérité (ID: `keyterm:Truth`); Galiléen (ID: `group:Galilee`); Galilée (ID: `place:Galilee`); House (ID: `realia:House`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Pilate (ID: `person:Pilate`); capacité (ID: `keyterm:Ability`); Jésus (ID: `person:Jesus.2`); Galilée (ID: `place:Galilee`); Priests (ID: `group:GenericPriests`); Elders (ID: `group:GenericElders`); prier (ID: `keyterm:AskFor`); Religious Officials (ID: `group:ReligiousOfficials`); Jérusalem (ID: `place:Jerusalem`); parler (ID: `keyterm:Speak`); autorité (ID: `keyterm:Authority.2`); Éternel (ID: `deity:Lord`); Judée (ID: `place:Judea`); Tibère (ID: `person:Tiberius`); Hérode Antipas (ID: `person:Herod.2`); parler contre dieu (ID: `keyterm:Blaspheme`); croire (ID: `keyterm:Believe`); Galiléen (ID: `group:Galilee`); Jews (ID: `group:Jews`); taxe (ID: `keyterm:TributeTax`); témoigner (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** Pilate (ID: `person:Pilate`); Hérode Antipas (ID: `person:Herod.2`); Jésus (ID: `person:Jesus.2`); Barabbas (ID: `person:Barabbas`); Cross (ID: `realia:Cross`); Prison (ID: `realia:Prison`); decider (ID: `keyterm:Decided`); évaluer (ID: `keyterm:Discern`); exemple (ID: `keyterm:Example`); espoir (ID: `keyterm:Hope`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); aide (ID: `keyterm:Salvation`); Jews (ID: `group:Jews`); Cross (ID: `realia:Cross`); Criminal on the Cross (ID: `person:Dysmas`); Simon (ID: `person:Simon.5`); Cyrène (ID: `place:Cyrene`); Jérusalem (ID: `place:Jerusalem`); sûrement! (ID: `keyterm:Surely`); béni (ID: `keyterm:Happy`); choisi (ID: `keyterm:Chosen`); jugement (ID: `keyterm:Judgment`); paradis (ID: `keyterm:Paradise`); prescrire (ID: `keyterm:Command`); craindre (ID: `keyterm:Fear`); parler contre dieu (ID: `keyterm:Blaspheme`); pardonner (ID: `keyterm:Forgive`); Golgotha (ID: `place:Golgotha`); Sour Wine (ID: `realia:SourWine`); Clothing (ID: `realia:Clothing`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); corps (ID: `keyterm:Body.3`); Jésus (ID: `person:Jesus.2`); sabbat (ID: `keyterm:Sabbath`); Galilée (ID: `place:Galilee`); être juste (ID: `keyterm:Just`); Grave (ID: `realia:Grave`); Joseph (ID: `person:Joseph.6`); Arimathée (ID: `place:Arimathea`); gloire (ID: `keyterm:Glory`); commandement (ID: `keyterm:Commandment`); Pilate (ID: `person:Pilate`); régne (ID: `keyterm:Kingdom`); nom (ID: `keyterm:Name`); le bien (ID: `keyterm:Good`); Jews (ID: `group:Jews`); esprit (ID: `keyterm:Spirit.2`); Aloes (ID: `realia:Aloes`); Linen (ID: `realia:Linen`); Myrrh (ID: `flora:Myrrh`); Curtain (ID: `realia:Curtain`); Temple (ID: `realia:Temple`); Myrrh (ID: `realia:Myrrh`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); ce qui est dit (ID: `keyterm:Word`); semaine (ID: `keyterm:Week`); Jeanne (ID: `person:Joanna`); ne pas réussir ou refuser de croire (ID: `keyterm:Disbelieve`); corps (ID: `keyterm:Body.3`); Pierre (ID: `person:Peter`); Jacques (ID: `person:James.3`); résurrection (ID: `keyterm:Resurrection`); vie (ID: `keyterm:Life`); Marie de Magdala (ID: `person:Marymagdalene`); Marie (ID: `person:Mary`); Galilée (ID: `place:Galilee`); Linen (ID: `realia:Linen`); Cross (ID: `realia:Cross`); Clothing (ID: `realia:Clothing`); Aloes (ID: `realia:Aloes`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Jérusalem (ID: `place:Jerusalem`); coeur (ID: `keyterm:Heart`); nom (ID: `keyterm:Name`); scripture (ID: `keyterm:Scripture`); Grave (ID: `realia:Grave`); Cléopas (ID: `person:Cleopas`); Émmaüs (ID: `place:Emmaus`); gloire (ID: `keyterm:Glory`); corps (ID: `keyterm:Body.3`); vie (ID: `keyterm:Life`); An Angel (ID: `deity:Angel`); benir (ID: `keyterm:Bless`); Pierre (ID: `person:Peter`); jugement (ID: `keyterm:Judgment`); Éternel (ID: `deity:Lord`); libération (ID: `keyterm:Liberation`); croire (ID: `keyterm:Believe`); résurrection (ID: `keyterm:Resurrection`); Moïse (ID: `person:Moses`); Israël (ID: `person:Israel`); espoir (ID: `keyterm:Hope`); Stade (ID: `realia:Stade`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** benir (ID: `keyterm:Bless`); Jérusalem (ID: `place:Jerusalem`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Éternel (ID: `deity:Lord`); esprit (ID: `keyterm:Spirit.2`); adorer (ID: `keyterm:BowDown`); To Cause to Happen (ID: `keyterm:Happen`); Béthanie (ID: `place:Bethany`); scripture (ID: `keyterm:Scripture`); capacité (ID: `keyterm:Ability`); ne pas réussir ou refuser de croire (ID: `keyterm:Disbelieve`); corps (ID: `keyterm:Body.3`); proclamer (ID: `keyterm:Proclaim`); Jésus (ID: `person:Jesus.2`); coeur (ID: `keyterm:Heart`); nom (ID: `keyterm:Name`); pécher (ID: `keyterm:Sin`); se repentir (ID: `keyterm:Repent`); loi (ID: `keyterm:Law`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); promesse (ID: `keyterm:Promise`); pardonner (ID: `keyterm:Forgive`); Moïse (ID: `person:Moses`); témoin (ID: `keyterm:Witness`); hauteur (ID: `keyterm:Height`); Fish (ID: `fauna:Fish`); Temple (ID: `realia:Temple`)
