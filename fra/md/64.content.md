...
* **Associated ACAI Concepts:** Diotrèphe (ID: `person:Diotrephes`); Gaïus (ID: `person:Gaius.4`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); Démétrius (ID: `person:Demetrius`); vérité (ID: `keyterm:Truth`)
