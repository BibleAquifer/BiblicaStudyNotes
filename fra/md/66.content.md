...
* **Associated ACAI Concepts:** Patmos (ID: `place:Patmos`); Lampstand (ID: `realia:Lampstand.2`); Pergame (ID: `place:Pergamum`); Smyrne (ID: `place:Smyrna`); Philadelphie (ID: `place:Philadelphia`); Sardes (ID: `place:Sardis`); Laodicée (ID: `place:Laodicea`); Kiln (ID: `realia:Kiln`); Éphèse (ID: `place:Ephesus`)
...
* **Associated ACAI Concepts:** Nicolaïte (ID: `group:Nicolaitans`); Antipas (ID: `person:Antipas`); Pergame (ID: `place:Pergamum`); Smyrne (ID: `place:Smyrna`); Éphèse (ID: `place:Ephesus`); agir par méchanceté (ID: `keyterm:ActWickedly`); église (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** Thyatire (ID: `place:Thyatira`); Sardes (ID: `place:Sardis`); fornication (ID: `keyterm:Fornication`); Clothing (ID: `realia:Clothing`); Jézabel (ID: `person:Jezebel`); Rod (ID: `realia:Rod`); église (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** Eye Salve (ID: `realia:EyeSalve`); Philadelphie (ID: `place:Philadelphia`); Door (ID: `realia:Door`); vrai (ID: `keyterm:True`); Laodicée (ID: `place:Laodicea`); amour (ID: `keyterm:Friendship`)
...
* **Associated ACAI Concepts:** Issacar (ID: `person:Issachar`); Zabulon (ID: `person:Zebulun`); Nephthali (ID: `person:Naphtali`); Ruben (ID: `person:Reuben`); Throne (ID: `realia:Throne`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Abaddôn signifiant Destructeur (ID: `deity:Abaddon`); le monde des morts (ID: `keyterm:Abyss`)
...
* **Associated ACAI Concepts:** Measuring Rod (ID: `realia:MeasuringRod`); Measuring Reed (ID: `realia:MeasuringReed`); témoin (ID: `keyterm:Witness`)
...
* **Associated ACAI Concepts:** Dragon (ID: `fauna:Dragon`); témoigner (ID: `keyterm:BearWitness`); Micaël (ID: `person:Michael.11`); Rod (ID: `realia:Rod`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** autorité (ID: `keyterm:Authority.2`); Leopard (ID: `fauna:Leopard`); Bear (ID: `fauna:Bear`); capacité (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** irréprochable (ID: `keyterm:Unblemished`); Lyre (ID: `realia:Lyre`)
...
* **Associated ACAI Concepts:** Bowl (ID: `realia:Bowl.2`); Frog (ID: `fauna:Frog`); Talent (ID: `realia:Talent`); Euphrate (ID: `place:Euphrates`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** ordonnance (ID: `keyterm:Regulations`); aider (quelqu'un) à obtenir justice (ID: `keyterm:GrantJustice`); Linen (ID: `realia:Linen`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** le monde des morts (ID: `keyterm:Abyss`); hadès (ID: `keyterm:WorldOfTheDead`); Magog (ID: `place:Magog`); Key (ID: `realia:Key`); Gog (ID: `place:Gog`); Chain (ID: `realia:Chain`)
...
* **Associated ACAI Concepts:** idolâtre (ID: `keyterm:Idolater`)
...
* **Associated ACAI Concepts:** gloire (ID: `keyterm:Glory`); éternellement (ID: `keyterm:Always`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** The Church (ID: `group:GenericChurch`); béni (ID: `keyterm:Happy`); sûrement! (ID: `keyterm:Surely`); Scroll (ID: `realia:Scroll`)
