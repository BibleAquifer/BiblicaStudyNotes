...
* **Associated ACAI Concepts:** Loïs (ID: `person:Lois`); Eunice (ID: `person:Eunice`); Phygelle (ID: `person:Phygelus`); Hermogène (ID: `person:Hermogenes`); Onésiphore (ID: `person:Onesiphorus`); désirer ardemment (ID: `keyterm:LongFor`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Philète (ID: `person:Philetus`); Hyménée (ID: `person:Hymenaeus`); approuvé (ID: `keyterm:Approved`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jambrès (ID: `person:Jambres`); Jannès (ID: `person:Jannes`); Icone (ID: `place:Iconium`); declarer solennellement et catégoriquement (ID: `keyterm:Declare`); scripture (ID: `keyterm:Scripture`)
...
* **Associated ACAI Concepts:** Crescens (ID: `person:Crescens`); Claudia (ID: `person:Claudia`); Carpus (ID: `person:Carpus`); Dalmatie (ID: `place:Dalmatia`); Pudens (ID: `person:Pudens`); Parchment (ID: `realia:Parchment`); Eubulus (ID: `person:Eubulus`); Linus (ID: `person:Linus`); Alexandre (ID: `person:Alexander.4`); Onésiphore (ID: `person:Onesiphorus`); sauver (ID: `keyterm:Deliver`); Milet (ID: `place:Miletus`); Démas (ID: `person:Demas`); Éraste (ID: `person:Erastus`); Trophime (ID: `person:Trophimus`); Luc (ID: `person:Luke`); Priscille (ID: `person:Priscilla`); Jésus (ID: `person:Jesus.2`)
