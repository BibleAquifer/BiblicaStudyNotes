...
* **Associated ACAI Concepts:** proverbe (ID: `keyterm:Saying`); discrétion (ID: `keyterm:Discretion`); conseils (ID: `keyterm:Guidance`); simple (ID: `keyterm:SimplePerson`); judicieux (ID: `keyterm:Crafty`); stupide (ID: `keyterm:Fool`); prospérer (ID: `keyterm:HaveInsight`)
...
* **Associated ACAI Concepts:** discrétion (ID: `keyterm:Discretion`); simple (ID: `keyterm:SimplePerson`); comprehension (ID: `keyterm:Understanding`); la connaissance (ID: `keyterm:Intention`); stupide (ID: `keyterm:Stupid`); percevoir (ID: `keyterm:Perceive`); Instruction (ID: `keyterm:Instruction`); saine sagesse (ID: `keyterm:SoundWisdom`); Ant (ID: `fauna:Ant`); droiture (ID: `keyterm:Straightness`); Aloes (ID: `flora:Aloes`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); méchanceté (ID: `keyterm:Mischief`); Agarwood (ID: `flora:Agarwood`); Cinnamon (ID: `flora:Cinnamon`); Wormwood (ID: `flora:Wormwood`); Barn (ID: `realia:Barn`); discernement (ID: `keyterm:Insight`); pauvre (ID: `keyterm:Poor`); méchanceté (ID: `keyterm:Wickedness`); personne qui est fidèle (ID: `keyterm:LoyalPerson`); insensé (ID: `keyterm:Foolish`); Must (ID: `realia:Must`); délice (ID: `keyterm:Delight`); s'appuyer sur (ID: `keyterm:LeanOn`); capacité (ID: `keyterm:Ability`); aimer (ID: `keyterm:Love`); Money (ID: `realia:Money`); craindre (ID: `keyterm:Fear`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** personne diligente (ID: `keyterm:Diligent`); stupide (ID: `keyterm:Fool`); stupide (ID: `keyterm:Stupid`); insensé (ID: `keyterm:Foolish`); conseils (ID: `keyterm:Guidance`); simple (ID: `keyterm:SimplePerson`); discernement (ID: `keyterm:Insight`); prospérer (ID: `keyterm:HaveInsight`); tromperie (ID: `keyterm:Deceit`); A Lazy Person (ID: `person:Sluggard`); avis (ID: `keyterm:Counsel`); securité (ID: `keyterm:Safety`); proverbe (ID: `keyterm:Saying`); Jaké (ID: `person:Jakeh`); Ithiel (ID: `person:Ithiel.2`); Leech (ID: `fauna:Leech`); Hinge (ID: `realia:Hinge`); Agur (ID: `person:Agur`); Oukal (ID: `person:Ucal`); réflexion (ID: `keyterm:Plan`); Balance (ID: `realia:Balance`); Ant (ID: `fauna:Ant`); condamner comme coupable (ID: `keyterm:DeclareGuilty`); méchanceté (ID: `keyterm:Wickedness`); se réfugier (ID: `keyterm:SeekfindRefuge`); Mast (ID: `realia:Mast`); destin (ID: `keyterm:Lot`); Swallow (ID: `fauna:Swallow`); Green Vegetation (ID: `flora:GreenVegetation`); Rooster (ID: `fauna:Rooster`)
