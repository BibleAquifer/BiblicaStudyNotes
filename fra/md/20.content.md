...
* **Associated ACAI Concepts:** percevoir (ID: `keyterm:Perceive`); proverbe (ID: `keyterm:Saying`); capacité (ID: `keyterm:Ability`); la connaissance (ID: `keyterm:Intention`); conseils (ID: `keyterm:Guidance`); prospérer (ID: `keyterm:HaveInsight`); stupide (ID: `keyterm:Fool`); judicieux (ID: `keyterm:Crafty`); discrétion (ID: `keyterm:Discretion`); simple (ID: `keyterm:SimplePerson`); craindre (ID: `keyterm:Fear`); David (ID: `person:David`); niveau (ID: `keyterm:Fairness`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Salomon (ID: `person:Solomon`); comprehension (ID: `keyterm:Understanding`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); stupide (ID: `keyterm:Stupid`); la connaissance (ID: `keyterm:Intention`); percevoir (ID: `keyterm:Perceive`); insensé (ID: `keyterm:Foolish`); aimer (ID: `keyterm:Love`); stupide (ID: `keyterm:Fool`); capacité (ID: `keyterm:Ability`); comprehension (ID: `keyterm:Understanding`); se rebeller (ID: `keyterm:Rebel`); tromperie (ID: `keyterm:Deceit`); délice (ID: `keyterm:Delight`); craindre (ID: `keyterm:Fear`); prospérer (ID: `keyterm:HaveInsight`); benir (ID: `keyterm:Bless`); pécher (ID: `keyterm:Sin`); gloire (ID: `keyterm:Glory`); judicieux (ID: `keyterm:Crafty`); vérité (ID: `keyterm:Truth`); s'appuyer sur (ID: `keyterm:LeanOn`); espoir (ID: `keyterm:Hope`); bonté (ID: `keyterm:Kindness`); avis (ID: `keyterm:Counsel`); méchanceté (ID: `keyterm:Mischief`); simple (ID: `keyterm:SimplePerson`); personne diligente (ID: `keyterm:Diligent`); être exempt de la punition (ID: `keyterm:Blameless`); securité (ID: `keyterm:Safety`); discernement (ID: `keyterm:Insight`); Instruction (ID: `keyterm:Instruction`)
...
* **Associated ACAI Concepts:** Lemuel (ID: `person:Lemuel`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Utterance (ID: `keyterm:Utterance`); faire un voeu (ID: `keyterm:Vow`)
...
* **Associated ACAI Concepts:** craindre (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); s'appuyer sur (ID: `keyterm:LeanOn`); Éternel (ID: `deity:Lord`); limite (ID: `keyterm:Decree`); bonté (ID: `keyterm:Kindness`); Spindle (ID: `realia:Spindle`); Vine (ID: `flora:Vine`); Ship (ID: `realia:Ship`); Wool (ID: `realia:Wool`); Linen (ID: `realia:Linen`); Flax (ID: `flora:Flax`); Purple Cloth (ID: `realia:PurpleCloth`); Lamp (ID: `realia:Lamp`); Tunic (ID: `realia:Tunic.2`)
