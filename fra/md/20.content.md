...
* **Associated ACAI Concepts:** percevoir (ID: `keyterm:Perceive`); proverbe (ID: `keyterm:Saying`); la connaissance (ID: `keyterm:Intention`); capacité (ID: `keyterm:Ability`); simple (ID: `keyterm:SimplePerson`); discrétion (ID: `keyterm:Discretion`); prospérer (ID: `keyterm:HaveInsight`); stupide (ID: `keyterm:Fool`); judicieux (ID: `keyterm:Crafty`); conseils (ID: `keyterm:Guidance`); Salomon (ID: `person:Solomon`); Israël (ID: `person:Israel`); comprehension (ID: `keyterm:Understanding`); Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); niveau (ID: `keyterm:Fairness`); David (ID: `person:David`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); comprehension (ID: `keyterm:Understanding`); capacité (ID: `keyterm:Ability`); la connaissance (ID: `keyterm:Intention`); stupide (ID: `keyterm:Stupid`); aimer (ID: `keyterm:Love`); simple (ID: `keyterm:SimplePerson`); Instruction (ID: `keyterm:Instruction`); craindre (ID: `keyterm:Fear`); percevoir (ID: `keyterm:Perceive`); House (ID: `realia:House`); discrétion (ID: `keyterm:Discretion`); Hell (ID: `place:Hell`); Money (ID: `realia:Money`); saine sagesse (ID: `keyterm:SoundWisdom`); securité (ID: `keyterm:Safety`); gloire (ID: `keyterm:Glory`); avis (ID: `keyterm:Counsel`); Trap (ID: `realia:Trap`); Vine (ID: `flora:Vine`); droiture (ID: `keyterm:Straightness`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); méchanceté (ID: `keyterm:Mischief`); judicieux (ID: `keyterm:Crafty`); juste (ID: `keyterm:Complete`); état intact (ID: `keyterm:IntactState`); vérité (ID: `keyterm:Truth`); grâce (ID: `keyterm:Favor`); pécher (ID: `keyterm:Sin`); ardeur (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** Lemuel (ID: `person:Lemuel`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); faire un voeu (ID: `keyterm:Vow`); Utterance (ID: `keyterm:Utterance`)
...
* **Associated ACAI Concepts:** craindre (ID: `keyterm:Fear`); Éternel (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); s'appuyer sur (ID: `keyterm:LeanOn`); limite (ID: `keyterm:Decree`); bonté (ID: `keyterm:Kindness`); Spindle (ID: `realia:Spindle`); Ship (ID: `realia:Ship`); Vine (ID: `flora:Vine`); Purple Cloth (ID: `realia:PurpleCloth`); Lamp (ID: `realia:Lamp`); Linen (ID: `realia:Linen`); Flax (ID: `flora:Flax`); Tunic (ID: `realia:Tunic.2`); Wool (ID: `realia:Wool`)
