...
* **Associated Passages:** 2 Corinthiens 1.1-11
...
* **Associated ACAI Concepts:** prier (ID: `keyterm:AskFor`); Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); prier (ID: `keyterm:Encourage`); espoir (ID: `keyterm:Hope`); grâce (ID: `keyterm:Favor`); Achaïe (ID: `place:Achaia`); sauver (ID: `keyterm:Deliver`); coeur (ID: `keyterm:Heart`); Corinthe (ID: `place:Corinth`); benir (ID: `keyterm:Bless`); Timothée (ID: `person:Timothy`); faire la paix (ID: `keyterm:Peace`); sentence (ID: `keyterm:Verdict`); persuader (ID: `keyterm:Persuade`); pitié (ID: `keyterm:Mercy`); Asie (ID: `place:Asia`); capacité (ID: `keyterm:Ability`); prier (ID: `keyterm:Pray`); vie (ID: `keyterm:Life`); résurrection (ID: `keyterm:Resurrection`); aide (ID: `keyterm:Salvation`); Paul (ID: `person:Paul`); église (ID: `keyterm:Church`); saint (ID: `keyterm:Holy`)
...
* **Associated Passages:** 2 Corinthiens 1.12-22
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); grâce (ID: `keyterm:Favor`); Silas (ID: `person:Silas`); coeur (ID: `keyterm:Heart`); témoigner (ID: `keyterm:BearWitness`); Macédoine (ID: `place:Macedonia`); espoir (ID: `keyterm:Hope`); proclamer (ID: `keyterm:Proclaim`); Judée (ID: `place:Judea`); appartenant à ce monde (ID: `keyterm:Carnal`); Timothée (ID: `person:Timothy`); fidelité (ID: `keyterm:Faithfulness`); promesse (ID: `keyterm:Promise`); capacité (ID: `keyterm:Ability`); corps (ID: `keyterm:Body.3`); Saint-Esprit (ID: `deity:HolySpirit`); conscience (ID: `keyterm:Conscience`); sûrement! (ID: `keyterm:Surely`); oint (ID: `keyterm:Anointed`); gloire (ID: `keyterm:Glory`)
...
* **Associated Passages:** 2 Corinthiens 1.23-2.11
...
* **Associated ACAI Concepts:** coeur (ID: `keyterm:Heart`); prier (ID: `keyterm:AskFor`); pardonner (ID: `keyterm:Forgive`); Cause of Joy (ID: `keyterm:CauseOfJoy`); aimer (ID: `keyterm:Love`); croire (ID: `keyterm:Believe`); Corinthe (ID: `place:Corinth`); Satan (ID: `deity:Satan`); témoin (ID: `keyterm:Witness`); Jésus (ID: `person:Jesus.2`); decider (ID: `keyterm:Decided`); appeler (ID: `keyterm:CallUpon`); persuader (ID: `keyterm:Persuade`); Éternel (ID: `deity:Lord`); prier (ID: `keyterm:Encourage`)
...
* **Associated Passages:** 2 Corinthiens 2.12-17
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); Tite (ID: `person:Titus`); grâce (ID: `keyterm:Favor`); Troas (ID: `place:Troas`); aide (ID: `keyterm:Salvation`); Macédoine (ID: `place:Macedonia`); esprit (ID: `keyterm:Spirit.2`); bonnes nouvelles (ID: `keyterm:GoodNews`); vie (ID: `keyterm:Life`); en christ (ID: `keyterm:InChrist`); Door (ID: `realia:Door`)
...
* **Associated Passages:** 2 Corinthiens 3.1-18
...
* **Associated ACAI Concepts:** gloire (ID: `keyterm:Glory`); Saint-Esprit (ID: `deity:HolySpirit`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); servir (ID: `keyterm:Serve`); Veil (ID: `realia:Veil`); coeur (ID: `keyterm:Heart`); Moïse (ID: `person:Moses`); lettre de l'alphabet (ID: `keyterm:Letter`); alliance (ID: `keyterm:Covenant`); Israël (ID: `group:Israel`); Israël (ID: `person:Israel`); faire vivre (ID: `keyterm:Alive`); espoir (ID: `keyterm:Hope`); en christ (ID: `keyterm:InChrist`); appartenant à ce monde (ID: `keyterm:Carnal`); être juste (ID: `keyterm:Just`); condamner (ID: `keyterm:Condemn`); vie (ID: `keyterm:Life`); Ink (ID: `realia:Ink`)
...
* **Associated Passages:** 2 Corinthiens 4.1-18
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); gloire (ID: `keyterm:Glory`); éternellement (ID: `keyterm:Always`); vie (ID: `keyterm:Life`); bonnes nouvelles (ID: `keyterm:GoodNews`); capacité (ID: `keyterm:Ability`); corps (ID: `keyterm:Body.3`); coeur (ID: `keyterm:Heart`); proclamer (ID: `keyterm:Proclaim`); être infidèle (ID: `keyterm:Unfaithful`); pitié (ID: `keyterm:Mercy`); grâce (ID: `keyterm:Favor`); vérité (ID: `keyterm:Truth`); marcher (ID: `keyterm:Live.3`); résurrection (ID: `keyterm:Resurrection`); croire (ID: `keyterm:Believe`); conscience (ID: `keyterm:Conscience`); esprit (ID: `keyterm:Spirit.2`); servir (ID: `keyterm:Serve`)
...
* **Associated Passages:** 2 Corinthiens 5.1-10
...
* **Associated ACAI Concepts:** corps (ID: `keyterm:Body.3`); Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Tent (ID: `realia:Tent`); désirer ardemment (ID: `keyterm:LongFor`); croire (ID: `keyterm:Believe`); marcher (ID: `keyterm:Live.3`); le bien (ID: `keyterm:Good`); Saint-Esprit (ID: `deity:HolySpirit`); éternellement (ID: `keyterm:Always`); vie (ID: `keyterm:Life`); House (ID: `realia:House`); Judgment Seat (ID: `realia:JudgmentSeat`)
...
* **Associated Passages:** 2 Corinthiens 5.11-6.10
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); réconcilier (ID: `keyterm:Reconcile`); en christ (ID: `keyterm:InChrist`); prier (ID: `keyterm:AskFor`); être juste (ID: `keyterm:Just`); capacité (ID: `keyterm:Ability`); vie (ID: `keyterm:Life`); aimer (ID: `keyterm:Love`); servir (ID: `keyterm:Serve`); vide (ID: `keyterm:Empty`); sincère (ID: `keyterm:Unhypocritical`); coeur (ID: `keyterm:Heart`); pureté morale (ID: `keyterm:WithoutMoralDefect`); vrai (ID: `keyterm:True`); bonté (ID: `keyterm:Kindness`); espoir (ID: `keyterm:Hope`); gloire (ID: `keyterm:Glory`); craindre (ID: `keyterm:Fear`); decider (ID: `keyterm:Decided`); persuader (ID: `keyterm:Persuade`); grâce (ID: `keyterm:Favor`); vérité (ID: `keyterm:Truth`); corps (ID: `keyterm:Body.3`); résurrection (ID: `keyterm:Resurrection`); cause d'offense (ID: `keyterm:Obstacle`); aide (ID: `keyterm:Salvation`); Saint-Esprit (ID: `deity:HolySpirit`); conscience (ID: `keyterm:Conscience`); pécher (ID: `keyterm:Sin`); jeûner (ID: `keyterm:Fast`); esprit (ID: `keyterm:Spirit.2`); Prison (ID: `realia:Prison`)
...
* **Associated Passages:** 2 Corinthiens 6.11-7.1
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); être infidèle (ID: `keyterm:Unfaithful`); pollution (ID: `keyterm:Defilement`); un corinthien (ID: `group:Corinth`); coeur (ID: `keyterm:Heart`); purifier (ID: `keyterm:Cleanse.2`); être désuni (ID: `keyterm:UnequallyYoked`); Corinthe (ID: `place:Corinth`); craindre (ID: `keyterm:Fear`); être juste (ID: `keyterm:Just`); fidelité (ID: `keyterm:Faithfulness`); association (ID: `keyterm:Partnership`); corruption morale (ID: `keyterm:Lawless`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); Satan (ID: `deity:Satan`); promesse (ID: `keyterm:Promise`); bien, aimé (ID: `keyterm:Beloved`); corps (ID: `keyterm:Body.3`); vie (ID: `keyterm:Life`); Jésus (ID: `person:Jesus.2`); fraternité (ID: `keyterm:Fellowship`); saint (ID: `keyterm:Holy`); esprit (ID: `keyterm:Spirit.2`); Image (ID: `realia:Image`); Temple (ID: `realia:Temple`)
...
* **Associated Passages:** 2 Corinthiens 7.2-16
* **Associated Articles:** Tite (ID: `133404@BiblicaStudyNotesKeyTerms`); Se repentir (ID: `133598@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); prier (ID: `keyterm:AskFor`); prier (ID: `keyterm:Encourage`); se repentir (ID: `keyterm:Repent`); craindre (ID: `keyterm:Fear`); Tite (ID: `person:Titus`); jalousie (ID: `keyterm:Extremely`); agir par méchanceté (ID: `keyterm:ActWickedly`); sérieux (ID: `keyterm:Eagerness`); Cause of Joy (ID: `keyterm:CauseOfJoy`); sans saleté (ID: `keyterm:Pure`); coeur (ID: `keyterm:Heart`); qu'on ne regrette pas (ID: `keyterm:NotToBeRegretted`); Macédoine (ID: `place:Macedonia`); vérité (ID: `keyterm:Truth`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); aider (quelqu'un) à obtenir justice (ID: `keyterm:GrantJustice`); capacité (ID: `keyterm:Ability`); condamner (ID: `keyterm:Condemn`); vivre avec ou ensemble (ID: `keyterm:LiveWith`); corps (ID: `keyterm:Body.3`); aide (ID: `keyterm:Salvation`); esprit (ID: `keyterm:Spirit.2`)
...
* **Associated Passages:** 2 Corinthiens 8.1-9.5
...
* **Associated ACAI Concepts:** grâce (ID: `keyterm:Favor`); Jésus (ID: `person:Jesus.2`); église (ID: `keyterm:Church`); prier (ID: `keyterm:AskFor`); servir (ID: `keyterm:Serve`); sérieux (ID: `keyterm:Eagerness`); Macédoine (ID: `place:Macedonia`); Éternel (ID: `deity:Lord`); Tite (ID: `person:Titus`); aimer (ID: `keyterm:Love`); saint (ID: `keyterm:Holy`); coeur (ID: `keyterm:Heart`); témoigner (ID: `keyterm:BearWitness`); bonnes nouvelles (ID: `keyterm:GoodNews`); espoir (ID: `keyterm:Hope`); jalousie (ID: `keyterm:Extremely`); confiance (ID: `keyterm:Confidence`); capacité (ID: `keyterm:Ability`); promesse (ID: `keyterm:Promise`); Cause of Joy (ID: `keyterm:CauseOfJoy`); tester (ID: `keyterm:Interpret`); croire (ID: `keyterm:Believe`); priver de la puissance (ID: `keyterm:DepriveOfPower`); fraternité (ID: `keyterm:Fellowship`); Achaïe (ID: `place:Achaia`); gloire (ID: `keyterm:Glory`)
...
* **Associated Passages:** 2 Corinthiens 9.6-15
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); grâce (ID: `keyterm:Favor`); être juste (ID: `keyterm:Just`); servir (ID: `keyterm:Serve`); coeur (ID: `keyterm:Heart`); désirer ardemment (ID: `keyterm:LongFor`); le bien (ID: `keyterm:Good`); Jésus (ID: `person:Jesus.2`); fraternité (ID: `keyterm:Fellowship`); sacerdoce (ID: `keyterm:Priesthood`); saint (ID: `keyterm:Holy`); éternellement (ID: `keyterm:Always`); prier (ID: `keyterm:Pray`); bonnes nouvelles (ID: `keyterm:GoodNews`); gloire (ID: `keyterm:Glory`); aimer (ID: `keyterm:Love`); Grain (ID: `flora:Grain`); Barley (ID: `flora:Barley`)
...
* **Associated Passages:** 2 Corinthiens 10.1-18
* **Associated Articles:** Les lettres de Paul (ID: `133372@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); corps (ID: `keyterm:Body.3`); marcher (ID: `keyterm:Live.3`); bonnes nouvelles (ID: `keyterm:GoodNews`); coeur (ID: `keyterm:Heart`); croire (ID: `keyterm:Believe`); autorité (ID: `keyterm:Authority.2`); appartenant à ce monde (ID: `keyterm:Carnal`); prier (ID: `keyterm:AskFor`); Paul (ID: `person:Paul`); approuvé (ID: `keyterm:Approved`); capacité (ID: `keyterm:Ability`); persuader (ID: `keyterm:Persuade`); bonté (ID: `keyterm:Kindness`); espoir (ID: `keyterm:Hope`); rénforcer (ID: `keyterm:BuildingUp`); Fortress (ID: `realia:Fortress`)
...
* **Associated Passages:** 2 Corinthiens 11.1-15
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); bonnes nouvelles (ID: `keyterm:GoodNews`); Ève (ID: `person:Eve`); pureté morale (ID: `keyterm:WithoutMoralDefect`); Macédoine (ID: `place:Macedonia`); proclamer (ID: `keyterm:Proclaim`); être fiancé (ID: `keyterm:Engaged`); craindre (ID: `keyterm:Fear`); être juste (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); jalousie (ID: `keyterm:Extremely`); sans saleté (ID: `keyterm:Pure`); vérité (ID: `keyterm:Truth`); Satan (ID: `deity:Satan`); église (ID: `keyterm:Church`); pécher (ID: `keyterm:Sin`); Achaïe (ID: `place:Achaia`); esprit (ID: `keyterm:Spirit.2`); aimer (ID: `keyterm:Love`); servir (ID: `keyterm:Serve`); Snake (ID: `fauna:Snake`)
...
* **Associated Passages:** 2 Corinthiens 11.16-33
* **Associated Articles:** Sacrifice (ID: `133508@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Arétas (ID: `person:Aretas`); Damas (ID: `place:Damascus`); benir (ID: `keyterm:Bless`); Abraham (ID: `person:Abraham`); éternellement (ID: `keyterm:Always`); confiance (ID: `keyterm:Confidence`); faire pécher qqn (ID: `keyterm:CauseToStumble`); Éternel (ID: `deity:Lord`); corps (ID: `keyterm:Body.3`); nation; peuple (ID: `group:Gentile`); Israël (ID: `group:Israel`); Jews (ID: `group:Jews`); église (ID: `keyterm:Church`); jeûner (ID: `keyterm:Fast`); Hebrews (ID: `group:Hebrews`); Israël (ID: `person:Israel`); Prison (ID: `realia:Prison`); City Wall (ID: `realia:CityWall`); Window (ID: `realia:Window`); Basket (ID: `realia:Basket`)
...
* **Associated Passages:** 2 Corinthiens 12.1-10
* **Associated Articles:** Vision (ID: `133548@BiblicaStudyNotesKeyTerms`); Monde céleste (ID: `133781@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); corps (ID: `keyterm:Body.3`); grâce (ID: `keyterm:Favor`); vérité (ID: `keyterm:Truth`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); prier (ID: `keyterm:AskFor`); paradis (ID: `keyterm:Paradise`); capacité (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); Be Lawful (ID: `keyterm:Lawful`); en christ (ID: `keyterm:InChrist`); ce qui est dit (ID: `keyterm:Word`)
...
* **Associated Passages:** 2 Corinthiens 12.11-20
* **Associated Articles:** Foi (ID: `133484@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** sois obligé (ID: `keyterm:Ought`); en christ (ID: `keyterm:InChrist`); une merveille (ID: `keyterm:Portent`); prier (ID: `keyterm:AskFor`); craindre (ID: `keyterm:Fear`); Jésus (ID: `person:Jesus.2`); pardonner (ID: `keyterm:Forgive`); église (ID: `keyterm:Church`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); méfaits (ID: `keyterm:UnjustDeed`); bien, aimé (ID: `keyterm:Beloved`); Tite (ID: `person:Titus`); jalousie (ID: `keyterm:Resentment`); exemple (ID: `keyterm:Example`); esprit (ID: `keyterm:Spirit.2`); rénforcer (ID: `keyterm:BuildingUp`); aimer (ID: `keyterm:Love`)
...
* **Associated Passages:** 2 Corinthiens 12.21-13.14

* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); capacité (ID: `keyterm:Ability`); prier (ID: `keyterm:Pray`); pécher (ID: `keyterm:Sin`); aimer (ID: `keyterm:Love`); tester (ID: `keyterm:Interpret`); autorité (ID: `keyterm:Authority.2`); prier (ID: `keyterm:AskFor`); se repentir (ID: `keyterm:Repent`); espoir (ID: `keyterm:Hope`); témoin (ID: `keyterm:Witness`); faire la paix (ID: `keyterm:Peace`); vivre ou être en paix (ID: `keyterm:AtPeace`); prier (ID: `keyterm:Encourage`); vérité (ID: `keyterm:Truth`); bien (ID: `keyterm:Honest`); fornication (ID: `keyterm:Fornication`); pollution (ID: `keyterm:Defilement`); vie (ID: `keyterm:Life`); croire (ID: `keyterm:Believe`); Saint-Esprit (ID: `deity:HolySpirit`); approuvé (ID: `keyterm:Approved`); fraternité (ID: `keyterm:Fellowship`); saint (ID: `keyterm:Holy`); rénforcer (ID: `keyterm:BuildingUp`); ce qui est dit (ID: `keyterm:Word`); Cross (ID: `realia:Cross`)
