...
* **Associated ACAI Concepts:** Bikath-Aven (ID: `place:AvenValley`); Beth-Éden (ID: `place:Beth-eden`); Amos (ID: `person:Amos.3`); Kir (ID: `place:Kir`); Tekoa (ID: `place:Tekoa`); voir (ID: `keyterm:HaveAVision`); Hazaël (ID: `person:Hazael`); se rebeller (ID: `keyterm:Rebel`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Soukkot (ID: `deity:Sikkuth`); Kiyyoun (ID: `deity:Kiyyun`); la forteresse (ID: `place:Harmon`); torrent du désert (ID: `place:BrookOfTheArabah`); Woe (ID: `keyterm:Woe.2`); Calné (ID: `place:Calneh`); Lo-debar (ID: `place:Lo-debar`); lamentation (ID: `keyterm:Lamentation`); Horns of Altar (ID: `realia:HornsOfAltar`); Israël (ID: `person:Israel`); House (ID: `realia:House`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Amos (ID: `person:Amos.3`); Amatsia (ID: `person:Amaziah.4`); Jéroboam (ID: `person:Jeroboam.2`); Plumb Line (ID: `realia:PlumbLine`); Sieve (ID: `realia:Sieve`); Floor (ID: `realia:Floor`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`)
