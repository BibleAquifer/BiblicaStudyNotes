...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); pécher (ID: `keyterm:Sin`); Instruction (ID: `keyterm:Instruction`); avis (ID: `keyterm:Counsel`); Date Palm (ID: `flora:DatePalm`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); oint (ID: `keyterm:Anointed`); être attiré à servir (ID: `keyterm:EnticedToServe`); se réfugier (ID: `keyterm:SeekfindRefuge`); prospérer (ID: `keyterm:HaveInsight`); limite (ID: `keyterm:Decree`); craindre (ID: `keyterm:Fear`); Jérusalem (ID: `place:Jerusalem`); laissiez en possession (ID: `keyterm:Possess`); Rope (ID: `realia:Rope`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); magnifique (ID: `keyterm:Mighty`); charger (ID: `keyterm:Appoint`); gloire (ID: `keyterm:Glory`); splendeur (ID: `keyterm:Majesty`); Goat (ID: `fauna:Goat`); Bird (ID: `fauna:Bird`); Cattle (ID: `fauna:Bull`); Fish (ID: `fauna:Fish`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); s'appuyer sur (ID: `keyterm:LeanOn`); Lion (ID: `fauna:Lion`); Israël (ID: `person:Israel`); craindre (ID: `keyterm:Fear`); Dog (ID: `fauna:Dog`); force (ID: `keyterm:Strength`); être attiré à servir (ID: `keyterm:EnticedToServe`); destin (ID: `keyterm:Lot`); faire un voeu (ID: `keyterm:Vow`); aide (ID: `keyterm:Salvation`); Basan (ID: `place:Bashan`); saint (ID: `keyterm:Holy`); pauvre (ID: `keyterm:Poor`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Worm (ID: `fauna:Maggot`); Wild Ox (ID: `fauna:WildOx`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); psaume (ID: `keyterm:Psalm`); bonté (ID: `keyterm:Kindness`); craindre (ID: `keyterm:Fear`); David (ID: `person:David`); Staff (ID: `realia:Staff`); Goat (ID: `fauna:Goat`); Green Vegetation (ID: `flora:GreenVegetation`); Rod (ID: `realia:Rod`); House (ID: `realia:House`); Olive Oil (ID: `realia:OliveOil`); Sheep (ID: `fauna:Lamb`); Anointing Oil (ID: `realia:AnointingOil`); Grass (ID: `flora:Grass`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); pécher (ID: `keyterm:Sin`); sans saleté (ID: `keyterm:Pure`); ardeur (ID: `keyterm:Ardour`); se rebeller (ID: `keyterm:Rebel`); tuerie (ID: `keyterm:Slaughtering`); offrande (ID: `keyterm:Offering`); pardonner (ID: `keyterm:Forgive`); aide (ID: `keyterm:Salvation`); purifier (ID: `keyterm:Cleanse.2`); psaume (ID: `keyterm:Psalm`); Jérusalem (ID: `place:Jerusalem`); être juste (ID: `keyterm:Just`); chemin (ID: `keyterm:TheWay`); David (ID: `person:David`); délice (ID: `keyterm:Delight`); bonté (ID: `keyterm:Kindness`); vérité (ID: `keyterm:Truth`); agir avec bonté (ID: `keyterm:KindlyDisposed`); capacité (ID: `keyterm:Ability`); Hyssop (ID: `flora:Hyssop`); Temple Altar (ID: `realia:TempleAltar`); Cattle (ID: `fauna:Bull`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); ressemblance (ID: `keyterm:Semblance`); propreté (ID: `keyterm:Innocence`); juste (ID: `keyterm:Complete`); être zélé (ID: `keyterm:Zealous`); refuge (ID: `keyterm:Refuge`); percevoir (ID: `keyterm:Perceive`); psaume (ID: `keyterm:Psalm`); état intact (ID: `keyterm:IntactState`); gloire (ID: `keyterm:Glory`); avis (ID: `keyterm:Counsel`); se prostituer (ID: `keyterm:PlayTheProstitute`); Israël (ID: `person:Israel`); Asaph (ID: `person:Asaph.2`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); se rebeller (ID: `keyterm:Rebel`); Israël (ID: `person:Israel`); Égypte (ID: `place:Egypt`); Moïse (ID: `person:Moses`); mer Rouge (ID: `place:RedSea`); bonté (ID: `keyterm:Kindness`); Cham (ID: `place:Ham.2`); Abraham (ID: `person:Abraham`); laissiez en possession (ID: `keyterm:Possess`); alliance (ID: `keyterm:Covenant`); peste (ID: `keyterm:Blow`); Aaron (ID: `person:Aaron`); limite (ID: `keyterm:Decree`); exemple (ID: `keyterm:Example`); fie (ID: `keyterm:BelieveIn`); Canaan (ID: `place:Canaan`); Cattails (ID: `flora:Cattails`); levér (ID: `keyterm:LiftUp`); Phinées (ID: `person:Phinehas`); exempt (ID: `keyterm:Exempt`); montagne de Sinaï (ID: `place:SinaiMount`); benir (ID: `keyterm:Bless`); A Group of People (ID: `group:GenericGroup`); déposséder (ID: `keyterm:Dispossess`); signe (ID: `keyterm:MiraculousSign`); Instruction (ID: `keyterm:Instruction`); acheter (ID: `keyterm:Redeem`); pollution (ID: `keyterm:Defilement`); se prostituer (ID: `keyterm:PlayTheProstitute`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); utilisé comme adverbe: empressement (ID: `keyterm:OutOfFreeWill`); Melchisédek (ID: `person:Melchizedek`); David (ID: `person:David`); psaume (ID: `keyterm:Psalm`); Jérusalem (ID: `place:Jerusalem`); jurer (ID: `keyterm:Swear`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); faire un voeu (ID: `keyterm:Vow`); simple (ID: `keyterm:SimplePerson`); personne qui est fidèle (ID: `keyterm:LoyalPerson`); tuerie (ID: `keyterm:Slaughtering`); Hell (ID: `place:Hell`); bienveillant (ID: `keyterm:Generous`); louange (ID: `keyterm:Praise`); aimer (ID: `keyterm:Love`); aide (ID: `keyterm:Salvation`); Jérusalem (ID: `place:Jerusalem`); fie (ID: `keyterm:BelieveIn`); supplication (ID: `keyterm:Supplication`); Trap (ID: `realia:Trap`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Babylone (ID: `place:Babylon`); Édom (ID: `place:Edom`); A Group of People (ID: `group:GenericGroup`); Édom (ID: `group:Edom`); Foundation (ID: `realia:Foundation`); Lute (ID: `realia:Lute`); Willow (ID: `flora:Willow`); Poplar (ID: `flora:Poplar`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); personne qui est fidèle (ID: `keyterm:LoyalPerson`); danse en rond (ID: `keyterm:RoundDance`); limite (ID: `keyterm:Decree`); aide (ID: `keyterm:Salvation`); pauvre (ID: `keyterm:Poor`); Lute (ID: `realia:Lute`); louange (ID: `keyterm:Praise`); Drum (ID: `realia:Drum`); benir (ID: `keyterm:Bless`); force (ID: `keyterm:Strength`); aimer (ID: `keyterm:Love`); gloire (ID: `keyterm:Glory`); colline (ID: `keyterm:Horn`); comprehension (ID: `keyterm:Understanding`); état intact (ID: `keyterm:IntactState`); s'appuyer sur (ID: `keyterm:LeanOn`); bonté (ID: `keyterm:Kindness`); An Angel (ID: `deity:Angel`); vérité (ID: `keyterm:Truth`); craindre (ID: `keyterm:Fear`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); splendeur (ID: `keyterm:Majesty`); Lyre (ID: `realia:Lyre`); Cymbals (ID: `realia:Cymbals`); Bird (ID: `fauna:Bird`); Cattle (ID: `fauna:Bull`); Chameleon (ID: `fauna:Chameleon`)
