...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); oint (ID: `keyterm:Anointed`); Jérusalem (ID: `place:Jerusalem`); prospérer (ID: `keyterm:HaveInsight`); se réfugier (ID: `keyterm:SeekfindRefuge`); laissiez en possession (ID: `keyterm:Possess`); limite (ID: `keyterm:Decree`); être attiré à servir (ID: `keyterm:EnticedToServe`); craindre (ID: `keyterm:Fear`); Rope (ID: `realia:Rope`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); magnifique (ID: `keyterm:Mighty`); splendeur (ID: `keyterm:Majesty`); gloire (ID: `keyterm:Glory`); charger (ID: `keyterm:Appoint`); Fish (ID: `fauna:Fish`); Bird (ID: `fauna:Bird`); Cattle (ID: `fauna:Bull`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); s'appuyer sur (ID: `keyterm:LeanOn`); Lion (ID: `fauna:Lion`); craindre (ID: `keyterm:Fear`); Israël (ID: `person:Israel`); Dog (ID: `fauna:Dog`); aide (ID: `keyterm:Salvation`); force (ID: `keyterm:Strength`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Basan (ID: `place:Bashan`); être attiré à servir (ID: `keyterm:EnticedToServe`); saint (ID: `keyterm:Holy`); pauvre (ID: `keyterm:Poor`); destin (ID: `keyterm:Lot`); faire un voeu (ID: `keyterm:Vow`); Cattle (ID: `fauna:Bull`); Wild Ox (ID: `fauna:WildOx`); Sheep (ID: `fauna:Lamb`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); psaume (ID: `keyterm:Psalm`); David (ID: `person:David`); bonté (ID: `keyterm:Kindness`); craindre (ID: `keyterm:Fear`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`); Green Vegetation (ID: `flora:GreenVegetation`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Olive Oil (ID: `realia:OliveOil`); House (ID: `realia:House`); Grass (ID: `flora:Grass`); Sheep (ID: `fauna:Lamb`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** pécher (ID: `keyterm:Sin`); Éternel (ID: `deity:Lord`); sans saleté (ID: `keyterm:Pure`); se rebeller (ID: `keyterm:Rebel`); tuerie (ID: `keyterm:Slaughtering`); ardeur (ID: `keyterm:Ardour`); aide (ID: `keyterm:Salvation`); pardonner (ID: `keyterm:Forgive`); offrande (ID: `keyterm:Offering`); psaume (ID: `keyterm:Psalm`); purifier (ID: `keyterm:Cleanse.2`); capacité (ID: `keyterm:Ability`); vérité (ID: `keyterm:Truth`); bonté (ID: `keyterm:Kindness`); chemin (ID: `keyterm:TheWay`); agir avec bonté (ID: `keyterm:KindlyDisposed`); Jérusalem (ID: `place:Jerusalem`); délice (ID: `keyterm:Delight`); être juste (ID: `keyterm:Just`); David (ID: `person:David`); Stone Altar (ID: `realia:StoneAltar`); Hyssop (ID: `flora:Hyssop`); Cattle (ID: `fauna:Bull`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); ressemblance (ID: `keyterm:Semblance`); propreté (ID: `keyterm:Innocence`); juste (ID: `keyterm:Complete`); avis (ID: `keyterm:Counsel`); se prostituer (ID: `keyterm:PlayTheProstitute`); gloire (ID: `keyterm:Glory`); Asaph (ID: `person:Asaph.2`); état intact (ID: `keyterm:IntactState`); psaume (ID: `keyterm:Psalm`); refuge (ID: `keyterm:Refuge`); être zélé (ID: `keyterm:Zealous`); Israël (ID: `person:Israel`); percevoir (ID: `keyterm:Perceive`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); se rebeller (ID: `keyterm:Rebel`); Moïse (ID: `person:Moses`); Égypte (ID: `place:Egypt`); Israël (ID: `person:Israel`); laissiez en possession (ID: `keyterm:Possess`); Abraham (ID: `person:Abraham`); bonté (ID: `keyterm:Kindness`); mer Rouge (ID: `place:RedSea`); alliance (ID: `keyterm:Covenant`); Cham (ID: `place:Ham.2`); peste (ID: `keyterm:Blow`); Aaron (ID: `person:Aaron`); limite (ID: `keyterm:Decree`); Canaan (ID: `place:Canaan`); fie (ID: `keyterm:BelieveIn`); exemple (ID: `keyterm:Example`); Cattails (ID: `flora:Cattails`); Phinées (ID: `person:Phinehas`); levér (ID: `keyterm:LiftUp`); sûrement! (ID: `keyterm:Surely`); aide (ID: `keyterm:Salvation`); avis (ID: `keyterm:Counsel`); Instruction (ID: `keyterm:Instruction`); gloire (ID: `keyterm:Glory`); déposséder (ID: `keyterm:Dispossess`); adjuration (ID: `keyterm:Oath`); pécher (ID: `keyterm:Sin`); prospérer (ID: `keyterm:HaveInsight`); être zélé (ID: `keyterm:Zealous`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Melchisédek (ID: `person:Melchizedek`); utilisé comme adverbe: empressement (ID: `keyterm:OutOfFreeWill`); David (ID: `person:David`); Jérusalem (ID: `place:Jerusalem`); psaume (ID: `keyterm:Psalm`); jurer (ID: `keyterm:Swear`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); faire un voeu (ID: `keyterm:Vow`); personne qui est fidèle (ID: `keyterm:LoyalPerson`); Jérusalem (ID: `place:Jerusalem`); aide (ID: `keyterm:Salvation`); bienveillant (ID: `keyterm:Generous`); louange (ID: `keyterm:Praise`); supplication (ID: `keyterm:Supplication`); Hell (ID: `place:Hell`); tuerie (ID: `keyterm:Slaughtering`); simple (ID: `keyterm:SimplePerson`); fie (ID: `keyterm:BelieveIn`); aimer (ID: `keyterm:Love`); House (ID: `realia:House`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); Éternel (ID: `deity:Lord`); précepte (ID: `keyterm:Precept`); limite (ID: `keyterm:Decree`); aimer (ID: `keyterm:Love`); percevoir (ID: `keyterm:Perceive`); témoin (ID: `keyterm:Witness.2`); bonté (ID: `keyterm:Kindness`); aide (ID: `keyterm:Salvation`); vérité (ID: `keyterm:Truth`); craindre (ID: `keyterm:Fear`); agir avec bonté (ID: `keyterm:KindlyDisposed`); chemin (ID: `keyterm:TheWay`); acheter (ID: `keyterm:Redeem`); juste (ID: `keyterm:Complete`); prospérer (ID: `keyterm:HaveInsight`); bouclier (ID: `keyterm:Shield`); supplication (ID: `keyterm:Supplication`); avis (ID: `keyterm:Counsel`); pécher (ID: `keyterm:Sin`); jurer (ID: `keyterm:Swear`); pleurer (ID: `keyterm:Curse`); droiture (ID: `keyterm:Straightness`); la connaissance (ID: `keyterm:Intention`); benir (ID: `keyterm:Bless`); état intact (ID: `keyterm:IntactState`); simple (ID: `keyterm:SimplePerson`); prier (ID: `keyterm:AskFor`); méchanceté (ID: `keyterm:Mischief`); ardeur (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Babylone (ID: `place:Babylon`); Éternel (ID: `deity:Lord`); Édom (ID: `place:Edom`); A Group of People (ID: `group:GenericGroup`); Édom (ID: `group:Edom`); Poplar (ID: `flora:Poplar`); Willow (ID: `flora:Willow`); Lute (ID: `realia:Lute`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); personne qui est fidèle (ID: `keyterm:LoyalPerson`); danse en rond (ID: `keyterm:RoundDance`); aide (ID: `keyterm:Salvation`); pauvre (ID: `keyterm:Poor`); limite (ID: `keyterm:Decree`); Lute (ID: `realia:Lute`); louange (ID: `keyterm:Praise`); Drum (ID: `realia:Drum`); gloire (ID: `keyterm:Glory`); force (ID: `keyterm:Strength`); comprehension (ID: `keyterm:Understanding`); aimer (ID: `keyterm:Love`); vérité (ID: `keyterm:Truth`); bonté (ID: `keyterm:Kindness`); benir (ID: `keyterm:Bless`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); état intact (ID: `keyterm:IntactState`); colline (ID: `keyterm:Horn`); craindre (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); s'appuyer sur (ID: `keyterm:LeanOn`); splendeur (ID: `keyterm:Majesty`); Lyre (ID: `realia:Lyre`); Cymbals (ID: `realia:Cymbals`); Bird (ID: `fauna:Bird`); Crow (ID: `fauna:Crow`); Bed (ID: `realia:Bed`)
