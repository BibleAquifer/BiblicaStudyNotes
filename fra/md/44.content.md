...
* **Associated ACAI Concepts:** Théophile (ID: `person:Theophilus`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Galiléen (ID: `group:Galilee`); témoin (ID: `keyterm:Witness`); Judée (ID: `place:Judea`); promesse (ID: `keyterm:Promise`)
...
* **Associated ACAI Concepts:** Matthias (ID: `person:Matthias`); Joseph (ID: `person:Joseph.9`); Half a Mile (ID: `realia:HalfAMile`); prier (ID: `keyterm:Pray`); Simon (ID: `person:Simon.2`); Barthélemy (ID: `person:Bartholomew`); Akeldama (ID: `place:Akeldama`); Alphée (ID: `person:Alphaeus`); Jacques (ID: `person:James.2`); montagne des oliviers (ID: `place:OlivesMount`); Upstairs Room (ID: `realia:UpstairsRoom`); Lot (ID: `realia:Lot`); Thomas (ID: `person:Thomas`); André (ID: `person:Andrew`); Marie (ID: `person:Mary`)
...
* **Associated ACAI Concepts:** Sweet Wine (ID: `realia:SweetWine`); Parthians (ID: `group:Parthians`); Cappadoce (ID: `place:Cappadocia`); Almôn-Divlataïm (ID: `group:Elam`); un crétois (ID: `group:Cretan`); Phrygie (ID: `place:Phrygia`); Pontus (ID: `place:Pontus`); Libya (ID: `place:Libya`); Cyrène (ID: `place:Cyrene`); Galiléen (ID: `group:Galilee`); Élam (ID: `place:Elam`); Medan (ID: `person:Medan`); Jérusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Pierre (ID: `person:Peter`); hadès (ID: `keyterm:WorldOfTheDead`); Joël (ID: `person:Joel.14`); une merveille (ID: `keyterm:Portent`); baptême (ID: `keyterm:Baptism`); Judéen (ID: `group:Judea`); appeler (ID: `keyterm:CallUpon`); ce qui est dit (ID: `keyterm:Word`); se repentir (ID: `keyterm:Repent`); résurrection (ID: `keyterm:Resurrection`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** portique de Salomon (ID: `place:SolomonsPortico`); Abraham (ID: `person:Abraham`); Porch (ID: `realia:Porch`); To Cause to Happen (ID: `keyterm:Happen`); Samuel (ID: `person:Samuel`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** nom (ID: `keyterm:Name`); Jean (ID: `person:John.3`); Alexandre (ID: `person:Alexander.2`); aide (ID: `keyterm:Salvation`); Anne (ID: `person:Annas`); Caïphe (ID: `person:Caiaphas`); Cornerstone (ID: `realia:Cornerstone`); Sadducéens (ID: `group:Sadducee`)
...
* **Associated ACAI Concepts:** Chypriote (ID: `group:Cyprus`); prier (ID: `keyterm:AskFor`); Barnabas (ID: `person:Barnabas`); Pilate (ID: `person:Pilate`)
...
* **Associated ACAI Concepts:** Ananias (ID: `person:Ananias`); Saphira (ID: `person:Sapphira`)
...
* **Associated ACAI Concepts:** Prison (ID: `realia:Prison`); Porch (ID: `realia:Porch`); jalousie (ID: `keyterm:Resentment`); une merveille (ID: `keyterm:Portent`)
...
* **Associated ACAI Concepts:** Theudas (ID: `person:Theudas`); Judas (ID: `person:Judas.3`); persuader (ID: `keyterm:Persuade`); Gamaliel (ID: `person:Gamaliel`); sauveur (ID: `keyterm:Savior`); témoin (ID: `keyterm:Witness`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Timon (ID: `person:Timon`); d'Antioche (ID: `group:Antioch`); Prochore (ID: `person:Prochorus`); Nicolas (ID: `person:Nicolaus`); Nicanor (ID: `person:Nicanor`); Parménas (ID: `person:Parmenas`); servir (ID: `keyterm:Serve`); Juif de langue grecque (ID: `group:Hellenist`); Étienne (ID: `person:Stephen`); Philippe (ID: `person:Philip.4`)
...
* **Associated ACAI Concepts:** homme libre (ID: `group:Freedmen`); Étienne (ID: `person:Stephen`); un Alexandrin (ID: `group:Alexandria`); Alexandrie (ID: `place:Alexandria`)
...
* **Associated ACAI Concepts:** Remphan (ID: `deity:Rephan`); Joseph (ID: `person:Joseph.10`); agir par méchanceté (ID: `keyterm:ActWickedly`); déliver (ID: `keyterm:Rescue`); Pharaon (ID: `person:Pharaoh.4`); Mésopotamie (ID: `place:Mesopotamia`); Hamor (ID: `person:Hamor`); Sichem (ID: `place:Shechem`); juge (ID: `keyterm:Judge`); Égypte (ID: `place:Egypt`); Moïse (ID: `person:Moses`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Étienne (ID: `person:Stephen`); appeler (ID: `keyterm:CallUpon`)
...
* **Associated ACAI Concepts:** Philippe (ID: `person:Philip.4`); Étienne (ID: `person:Stephen`); Judée (ID: `place:Judea`); proclamer (ID: `keyterm:Proclaim`); Jérusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Simon (ID: `person:Simon.8`); Philippe (ID: `person:Philip.4`); Money (ID: `realia:Money`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Philippe (ID: `person:Philip.4`); Chariot (ID: `realia:Chariot`); bonnes nouvelles (ID: `keyterm:GoodNews`); Koushite (ID: `group:Ethiopia`); Éthiopie (ID: `place:Ethiopia`); Asdod (ID: `place:Ashdod`); Gaza (ID: `place:Gaza`)
...
* **Associated ACAI Concepts:** Ananias (ID: `person:Ananias.2`); Damas (ID: `place:Damascus`); Paul (ID: `person:Paul`); Judas (ID: `person:Judas.4`); Straight Street (ID: `place:Straight`); Tarse (ID: `group:Tarsus`); chemin (ID: `keyterm:TheWay`); nom (ID: `keyterm:Name`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Damas (ID: `place:Damascus`); Juif de langue grecque (ID: `group:Hellenist`); Tarse (ID: `place:Tarsus`); Basket (ID: `realia:Basket`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Tabitha (ID: `person:Tabitha`); Énée (ID: `person:Aeneas`); Joppa (ID: `place:Joppa`); Simon (ID: `person:Simon.9`); Sharon Plain (ID: `place:Sharon.2`); Pierre (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** italien (ID: `group:Italy`); Corneille (ID: `person:Cornelius`); Linen Cloth (ID: `realia:LinenCloth`); Simon (ID: `person:Simon.9`); Housetop (ID: `realia:Housetop`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Corneille (ID: `person:Cornelius`); Simon (ID: `person:Simon.9`); Pierre (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** declarer solennellement et catégoriquement (ID: `keyterm:Declare`); oint (ID: `keyterm:Anointed`); témoigner (ID: `keyterm:BearWitness`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Linen Cloth (ID: `realia:LinenCloth`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Antioche (ID: `place:Antioch`); Agabus (ID: `person:Agabus`); Cyprus (ID: `place:Cyprus`); Chypriote (ID: `group:Cyprus`); chrétien (ID: `group:Christ`); Juif de langue grecque (ID: `group:Hellenist`); trans. faire un disciple de (ID: `keyterm:Disciple`); Phénicie (ID: `place:Phoenicia`); Claude (ID: `person:Claudius`)
...
* **Associated ACAI Concepts:** Hérode (ID: `person:Herod.3`); Rhode (ID: `person:Rhoda`); Marie (ID: `person:Mary.5`); Chain (ID: `realia:Chain`); Marc (ID: `person:Mark`); Jacques (ID: `person:James`); Jean (ID: `person:John.2`); Pierre (ID: `person:Peter`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Bedroom (ID: `realia:Bedroom`); Blaste (ID: `person:Blastus`); Hérode (ID: `person:Herod.3`); Tyrien (ID: `group:Tyre`)
...
* **Associated ACAI Concepts:** Bar-Jésus (ID: `person:Bar-jesus`); Paul (ID: `person:Paul`); Barnabas (ID: `person:Barnabas`); Séleucie (ID: `place:Seleucia`); Salamine (ID: `place:Salamis`); Manahen (ID: `person:Manaen`); Sergius Paulus (ID: `person:SergiusPaulus`); Marc (ID: `person:Mark`); Paphos (ID: `place:Paphos`); Siméon (ID: `person:Simeon.4`); jeûner (ID: `keyterm:Fast`); Antioche (ID: `place:Antioch`); Hérode Antipas (ID: `person:Herod.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Perge (ID: `place:Perga`); Paphos (ID: `place:Paphos`); Synagogue (ID: `realia:Synagogue`); Antioche (ID: `place:Antioch.2`); Pamphylie (ID: `place:Pamphylia`); Kis (ID: `person:Kish`); Isaï (ID: `person:Jesse`); Canaan (ID: `place:Canaan`); Saül (ID: `person:Saul.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** adorer (ID: `keyterm:Worship`); jalousie (ID: `keyterm:Resentment`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Lycaonie (ID: `place:Lycaonia`); Derbe (ID: `place:Derbe`); Lystre (ID: `place:Lystra`); Icone (ID: `place:Iconium`)
...
* **Associated ACAI Concepts:** Jupiter (ID: `deity:Zeus`); Garland (ID: `realia:Garland`); Hermès (ID: `deity:Hermes`); Lycaonians (ID: `group:Lycaonia`); sans valeur (ID: `keyterm:Worthless`); faire du bien (ID: `keyterm:DoGood`)
...
* **Associated ACAI Concepts:** Attalie (ID: `place:Attalia`); Antioche (ID: `place:Antioch.2`); Icone (ID: `place:Iconium`); Pisidie (ID: `place:Pisidia`); Perge (ID: `place:Perga`); Derbe (ID: `place:Derbe`); Pamphylie (ID: `place:Pamphylia`); jeûner (ID: `keyterm:Fast`)
...
* **Associated ACAI Concepts:** Judas (ID: `person:Judas.5`); Antioche (ID: `place:Antioch`); Silas (ID: `person:Silas`); Phénicie (ID: `place:Phoenicia`); Jacques (ID: `person:James.3`); Yoke (ID: `realia:Yoke`); Judée (ID: `place:Judea`); Barnabas (ID: `person:Barnabas`); nation; peuple (ID: `group:Gentile`); Paul (ID: `person:Paul`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Marc (ID: `person:Mark`); Cilicie (ID: `place:Cilicia`)
...
* **Associated ACAI Concepts:** Mysie (ID: `place:Mysia`); Lystre (ID: `place:Lystra`); Bithynie (ID: `place:Bithynia`); Macédoine (ID: `place:Macedonia`); Phrygie (ID: `place:Phrygia`); Derbe (ID: `place:Derbe`); Troas (ID: `place:Troas`); Galatie (ID: `place:Galatia`); Asie (ID: `place:Asia`); Timothée (ID: `person:Timothy`)
...
* **Associated ACAI Concepts:** Néapolis (ID: `place:Neapolis`); Samothrace (ID: `place:Samothrace`); Lydie (ID: `person:Lydia`); Thyatire (ID: `place:Thyatira`); Philippes (ID: `place:Philippi`); Macédoine (ID: `place:Macedonia`)
...
* **Associated ACAI Concepts:** Philippian Jailer (ID: `person:PhilippianJailer`); Lydie (ID: `person:Lydia`); Silas (ID: `person:Silas`); croire (ID: `keyterm:Believe`); Torch (ID: `realia:Torch`); Paul (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Jason (ID: `person:Jason`); Apollonie (ID: `place:Apollonia`); Amphipolis (ID: `place:Amphipolis`); Bérée (ID: `place:Berea`); Thessalonique (ID: `place:Thessalonica`); Yavanite (ID: `group:Greek`); scripture (ID: `keyterm:Scripture`); évaluer (ID: `keyterm:Discern`); Paul (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Aréopage (ID: `place:Areopagus`); Athènes (ID: `place:Athens`); un Athénien (ID: `group:Athens`); Stoïcien (ID: `group:Stoic`); Épicurien; disciple d'Épicure (ID: `group:Epicurean`); Denys (ID: `person:Dionysius`); un membre du conseil (ID: `group:Areopagus`); Damaris (ID: `person:Damaris`); adorer (ID: `keyterm:Worship`); divin (ID: `keyterm:Divine`); decider (ID: `keyterm:Decided`)
...
* **Associated ACAI Concepts:** Gallion (ID: `person:Gallio`); Justus (ID: `person:Justus.2`); du Pont (ID: `group:Pontus`); Judgment Seat (ID: `realia:JudgmentSeat`); Corinthe (ID: `place:Corinth`); un corinthien (ID: `group:Corinth`); Crispus (ID: `person:Crispus`); Sosthène (ID: `person:Sosthenes`); adorer (ID: `keyterm:Worship`); Pontus (ID: `place:Pontus`); Priscille (ID: `person:Priscilla`); Aquilas (ID: `person:Aquila`); Achaïe (ID: `place:Achaia`); Claude (ID: `person:Claudius`); Rome (ID: `place:Rome`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Aquilas (ID: `person:Aquila`); Cenchrées (ID: `place:Cenchreae`); un Alexandrin (ID: `group:Alexandria`); Phrygie (ID: `place:Phrygia`); Alexandrie (ID: `place:Alexandria`); Galatie (ID: `place:Galatia`); Apollos (ID: `person:Apollos`)
...
* **Associated ACAI Concepts:** Tyrannus (ID: `person:Tyrannus`); Apron (ID: `realia:Apron`); Scéva (ID: `person:Sceva`); Lecture Hall (ID: `realia:LectureHall`); Asie (ID: `place:Asia`); Éphèse (ID: `place:Ephesus`); Macédoine (ID: `place:Macedonia`); Éraste (ID: `person:Erastus`); Band of Cloth (ID: `realia:BandOfCloth`); Achaïe (ID: `place:Achaia`); Demons (ID: `deity:Demons`); Paul (ID: `person:Paul`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Diane (ID: `deity:Artemis`); Éphésiens (ID: `group:Ephesus`); Theater (ID: `realia:Theater`); Replica Temple (ID: `realia:ReplicaTemple`); Gaïus (ID: `person:Gaius`); Alexandre (ID: `person:Alexander.3`); Démétrius (ID: `person:Demetrius`); Aristarque (ID: `person:Aristarchus`)
...
* **Associated ACAI Concepts:** Second Story (ID: `realia:SecondStory`); Second (ID: `person:Secundus`); d'Asie (ID: `group:Asia`); Gaïus (ID: `person:Gaius.2`); de Bérée (ID: `group:Berea`); Pyrrhus (ID: `person:Pyrrhus`); Eutychus (ID: `person:Eutychus`); Troas (ID: `place:Troas`); Sopater (ID: `person:Sopater`); Macédoine (ID: `place:Macedonia`); Trophime (ID: `person:Trophimus`); Philippes (ID: `place:Philippi`); Tychique (ID: `person:Tychicus`); semaine (ID: `keyterm:Week`); Javan (ID: `place:Greece`); Window (ID: `realia:Window`)
...
* **Associated ACAI Concepts:** Assos (ID: `place:Assos`); declarer solennellement et catégoriquement (ID: `keyterm:Declare`); Mytilène (ID: `place:Mitylene`); Chios (ID: `place:Chios`); Samos (ID: `place:Samos`); Milet (ID: `place:Miletus`); Éphèse (ID: `place:Ephesus`); servir (ID: `keyterm:Serve.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Cos (ID: `place:Cos`); Rhodes (ID: `place:Rhodes`); Patara (ID: `place:Patara`); Mnason (ID: `person:Mnason`); Agabus (ID: `person:Agabus`); Césarée (ID: `place:Caesarea`); Chypriote (ID: `group:Cyprus`); Phénicie (ID: `place:Phoenicia`); Philippe (ID: `person:Philip.4`); Belt (ID: `realia:Belt`); Jérusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Step (ID: `realia:Step`); Tarse (ID: `group:Tarsus`); Trophime (ID: `person:Trophimus`); Tarse (ID: `place:Tarsus`); Cilicie (ID: `place:Cilicia`); Paul (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Antipatris (ID: `place:Antipatris`); Félix (ID: `person:Felix`); Lysias (ID: `person:Lysias`); Ananias (ID: `person:Ananias.3`); Rome (ID: `place:Rome`); Palace (ID: `realia:Palace`); courage! prends courage! bon courage! (ID: `keyterm:CheerUp`); Cilicie (ID: `place:Cilicia`); Paul (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Félix (ID: `person:Felix`); Tertulle (ID: `person:Tertullus`); Drusille (ID: `person:Drusilla`); Ananias (ID: `person:Ananias.3`); Lysias (ID: `person:Lysias`); chemin (ID: `keyterm:TheWay`); Festus (ID: `person:Festus`); conscience (ID: `keyterm:Conscience`); Paul (ID: `person:Paul`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Festus (ID: `person:Festus`); Agrippa (ID: `person:Agrippa`); Césarée (ID: `place:Caesarea`); Audience Hall (ID: `realia:AudienceHall`); Bérénice (ID: `person:Bernice`); Auguste (ID: `person:Augustus`); Claude (ID: `person:Claudius`); Paul (ID: `person:Paul`); Jews (ID: `group:Jews`); Jérusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Agrippa (ID: `person:Agrippa`); Festus (ID: `person:Festus`); Bérénice (ID: `person:Bernice`); chrétien (ID: `group:Christ`); déliver (ID: `keyterm:Rescue`); Paul (ID: `person:Paul`); Jews (ID: `group:Jews`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Anchor (ID: `realia:Anchor`); Ship (ID: `realia:Ship`); Julius (ID: `person:Julius`); Crète (ID: `place:Crete`); Myra (ID: `place:Myra`); Lycie (ID: `place:Lycia`); la Syrte (ID: `place:Syrtis`); Cnide (ID: `place:Cnidus`); Beaux Ports (ID: `place:FairHavens`); Clauda (ID: `place:Cauda`); Fathom (ID: `realia:Fathom`); mer Adriatique (ID: `place:AdriaticSea`); Adramytte (ID: `place:Adramyttium`); Phénix (ID: `place:Phoenix`); Lasée (ID: `place:Lasea`); Salmone (ID: `place:Salmone`); Italie (ID: `place:Italy`); Rudder (ID: `realia:Rudder`); Sail (ID: `realia:Sail`); Alexandrie (ID: `place:Alexandria`); Pamphylie (ID: `place:Pamphylia`); Aristarque (ID: `person:Aristarchus`); Auguste (ID: `person:Augustus`); Cilicie (ID: `place:Cilicia`); Asie (ID: `place:Asia`); Sidon (ID: `place:Sidon`); Paul (ID: `person:Paul`); aide (ID: `keyterm:Salvation`)
...
* **Associated ACAI Concepts:** Publius (ID: `person:Publius`); Pouzzoles (ID: `place:Puteoli`); Forum d'Appius (ID: `place:ForumOfAppius`); Emblem (ID: `realia:Emblem`); Trois Tavernes (ID: `place:ThreeTaverns`); Reggio (ID: `place:Rhegium`); Malte (ID: `place:Malta`); Syracuse (ID: `place:Syracuse`); Rome (ID: `place:Rome`); Alexandrie (ID: `place:Alexandria`)
...
* **Associated ACAI Concepts:** persuader (ID: `keyterm:Persuade`); Chain (ID: `realia:Chain`)
