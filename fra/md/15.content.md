...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Cyrus (ID: `person:Cyrus`); House (ID: `realia:House`); Money (ID: `realia:Money`); Israël (ID: `person:Israel`); Perse (ID: `place:Persia`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); Zorobabel (ID: `person:Zerubbabel.2`); Élam (ID: `person:Elam`); Salomon (ID: `person:Solomon`); Babylone (ID: `place:Babylon`); Nebucadnetsar (ID: `person:Nebuchadnezzar`); Shalmai (ID: `person:Shalmai`); Sothaï (ID: `person:Sotai`); Tsicha (ID: `person:Ziha`); Thalmon (ID: `person:Talmon`); Josué (ID: `person:Jeshua.4`); Barzillaï (ID: `person:Barzillai.3`); Betsaï (ID: `person:Bezai`); Sophéreth (ID: `person:Sophereth`); Harim (ID: `person:Harim`); Hadid (ID: `place:Hadid`); Hagaba (ID: `person:Hagabah`); Thamach (ID: `person:Temah`); Mehida (ID: `person:Mehida`); Bani (ID: `person:Bani`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`); Israël (ID: `person:Israel`); Zorobabel (ID: `person:Zerubbabel.2`); Euphrate (ID: `place:Euphrates`); Perse (ID: `place:Persia`); Cyrus (ID: `person:Cyrus`); Darius (ID: `person:Darius.2`); offrande (ID: `keyterm:Offering`); Juda (ID: `person:Judah.4`); Babylone (ID: `place:Babylon`); Rehum (ID: `person:Rehum.2`); Schimschaï (ID: `person:Shimshai`); Josué (ID: `person:Joshua.5`); Artaxerxès (ID: `person:Artaxerxes.2`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); Jews (ID: `group:Jews`); Schealthiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Juda (ID: `group:Judah`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Thathnaï (ID: `person:Tattenai`); Samarie (ID: `place:Samaria`); Nebucadnetsar (ID: `person:Nebuchadnezzar`); Iddo (ID: `person:Iddo.6`); Hénadad (ID: `person:Henadad`); Josué (ID: `person:Jeshua.4`); Assuérus (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Darius (ID: `person:Darius.2`); Jérusalem (ID: `place:Jerusalem`); Israël (ID: `person:Israel`); Lévi (ID: `group:Levi`); Euphrate (ID: `place:Euphrates`); Lévi (ID: `person:Levi.3`); Jews (ID: `group:Jews`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Scroll (ID: `realia:Scroll`); Thathnaï (ID: `person:Tattenai`); sacrifice de la pâque (ID: `keyterm:Passover`); Cyrus (ID: `person:Cyrus`); Éternel (ID: `deity:Lord`); Babylone (ID: `place:Babylon`); offrande (ID: `keyterm:Offering`); Sheep (ID: `fauna:Lamb`); Zacharie (ID: `person:Zechariah.17`); Achmetha (ID: `place:Ecbatana`); Iddo (ID: `person:Iddo.6`); Aggée (ID: `person:Haggai`); Nebucadnetsar (ID: `person:Nebuchadnezzar`); Moïse (ID: `person:Moses`); sans saleté (ID: `keyterm:Pure`); Perse (ID: `place:Persia`); pollution (ID: `keyterm:Defilement`); Artaxerxès (ID: `person:Artaxerxes`); Assyria (ID: `place:Assyria`); Médie (ID: `place:Media`); nation; peuple (ID: `group:Gentile`); Olive Oil (ID: `realia:OliveOil`); Cubit (ID: `realia:Cubit`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Hewn Stone (ID: `realia:HewnStone`); Wheat (ID: `flora:Wheat`); Anointing Oil (ID: `realia:AnointingOil`); Flock (ID: `fauna:Flock`); Foundation (ID: `realia:Foundation`); Unleavened Bread (ID: `realia:UnleavenedBread`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); Israël (ID: `person:Israel`); Esdras (ID: `person:Ezra`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); Artaxerxès (ID: `person:Artaxerxes`); House (ID: `realia:House`); Money (ID: `realia:Money`); Babylone (ID: `place:Babylon`); Ahava (ID: `place:Ahava`); offrande (ID: `keyterm:Offering`); Euphrate (ID: `place:Euphrates`); Haschabia (ID: `person:Hashabiah.7`); Schérébia (ID: `person:Sherebiah`); limite (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); David (ID: `person:David`); percevoir (ID: `keyterm:Perceive`); Phinées (ID: `person:Phinehas`); Amaria (ID: `person:Amariah.2`); Élam (ID: `person:Elam`); Noadia (ID: `person:Noadiah`); Zacharie (ID: `person:Zechariah.20`); Zerachja (ID: `person:Zerahiah`); Meschullam (ID: `person:Meshullam.9`); Zacharie (ID: `person:Zechariah.19`); Bigvaï (ID: `person:Bigvai.2`); Guershom (ID: `person:Gershom.2`); Jozabad (ID: `person:Jozabad.6`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Esdras (ID: `person:Ezra`); être infidèle (ID: `keyterm:Unfaithful`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); Jérusalem (ID: `place:Jerusalem`); ardeur (ID: `keyterm:Ardour`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Élam (ID: `person:Elam`); Juda (ID: `group:Judah`); offrande (ID: `keyterm:Offering`); Juda (ID: `person:Judah.4`); avis (ID: `keyterm:Counsel`); Zabad (ID: `person:Zabad.6`); Élie (ID: `person:Elijah.4`); Éliaschib (ID: `person:Eliashib.5`); Amram (ID: `person:Amram.2`); Jehiel (ID: `person:Jehiel.10`); Maaséja (ID: `person:Maaseiah.6`); Bani (ID: `person:Bani.6`); Malluc (ID: `person:Malluch.2`); Nethaneel (ID: `person:Nethanel.8`); Schimeï (ID: `person:Shimei.16`); Éliaschib (ID: `person:Eliashib.4`); Ismaël (ID: `person:Ishmael.6`); Bani (ID: `person:Bani`); Uel (ID: `person:Uel`); Éliézer (ID: `person:Eliezer.11`)
