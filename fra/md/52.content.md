...
* **Associated ACAI Concepts:** Macédoine (ID: `place:Macedonia`); Thessalonique (ID: `place:Thessalonica`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Athènes (ID: `place:Athens`); croire (ID: `keyterm:Believe`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** amour fraternel (ID: `keyterm:LoveForOnesFellowBeliever`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** être exempt de la punition (ID: `keyterm:Blameless`); Jésus (ID: `person:Jesus.2`)
