...
* **Associated ACAI Concepts:** vérité (ID: `keyterm:Truth`); aimer (ID: `keyterm:Love`); commandement (ID: `keyterm:Commandment`); Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); choisi (ID: `keyterm:Chosen`); marcher (ID: `keyterm:Live.3`); prier (ID: `keyterm:AskFor`); espoir (ID: `keyterm:Hope`); partager (ID: `keyterm:Share`); faire la paix (ID: `keyterm:Peace`); pitié (ID: `keyterm:Mercy`); éternellement (ID: `keyterm:Always`); grâce (ID: `keyterm:Favor`); capacité (ID: `keyterm:Ability`); corps (ID: `keyterm:Body.3`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ink (ID: `realia:Ink`); Paper (ID: `realia:Paper`); Papyrus (ID: `flora:Papyrus`); House (ID: `realia:House`)
