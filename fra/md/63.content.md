...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); vérité (ID: `keyterm:Truth`); commandement (ID: `keyterm:Commandment`); Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); marcher (ID: `keyterm:Live.3`); choisi (ID: `keyterm:Chosen`); Cause of Joy (ID: `keyterm:CauseOfJoy`); capacité (ID: `keyterm:Ability`); partager (ID: `keyterm:Share`); corps (ID: `keyterm:Body.3`); espoir (ID: `keyterm:Hope`); pitié (ID: `keyterm:Mercy`); prier (ID: `keyterm:AskFor`); faire la paix (ID: `keyterm:Peace`); grâce (ID: `keyterm:Favor`); éternellement (ID: `keyterm:Always`); Paper (ID: `realia:Paper`); Ink (ID: `realia:Ink`); House (ID: `realia:House`); Papyrus (ID: `flora:Papyrus`)
