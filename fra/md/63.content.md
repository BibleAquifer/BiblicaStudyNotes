...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); vérité (ID: `keyterm:Truth`); Jésus (ID: `person:Jesus.2`); commandement (ID: `keyterm:Commandment`); Éternel (ID: `deity:Lord`); marcher (ID: `keyterm:Live.3`); choisi (ID: `keyterm:Chosen`); capacité (ID: `keyterm:Ability`); corps (ID: `keyterm:Body.3`); partager (ID: `keyterm:Share`); Cause of Joy (ID: `keyterm:CauseOfJoy`); éternellement (ID: `keyterm:Always`); pitié (ID: `keyterm:Mercy`); grâce (ID: `keyterm:Favor`); prier (ID: `keyterm:AskFor`); faire la paix (ID: `keyterm:Peace`); espoir (ID: `keyterm:Hope`); Paper (ID: `realia:Paper`); Ink (ID: `realia:Ink`); House (ID: `realia:House`); Papyrus (ID: `flora:Papyrus`)
