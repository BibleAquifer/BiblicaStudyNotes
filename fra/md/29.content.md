...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); offrande (ID: `keyterm:Offering`); Must (ID: `realia:Must`); Fig (ID: `flora:Fig`); Sackcloth (ID: `realia:Sackcloth`); Grain (ID: `flora:Grain`); Joël (ID: `person:Joel.14`); Pethuel (ID: `person:Pethuel`); saint (ID: `keyterm:Holy`); parole du seigneur (ID: `keyterm:WordOfTheLord`); Locust (ID: `fauna:Locust`); Stone Altar (ID: `realia:StoneAltar`); Olive Oil (ID: `realia:OliveOil`); Pomegranate (ID: `flora:Pomegranate`); Cattle (ID: `fauna:Bull`); Lion (ID: `fauna:Lion`); Barley (ID: `flora:Barley`); Goat (ID: `fauna:Goat`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Mule (ID: `fauna:Mule`); Wheat (ID: `flora:Wheat`); Altar (ID: `realia:Altar`); Barn (ID: `realia:Barn`); Anointing Oil (ID: `realia:AnointingOil`); Temple Altar (ID: `realia:TempleAltar`); Date Palm (ID: `flora:DatePalm`); Flock (ID: `fauna:Flock`); Olive Tree (ID: `flora:OliveTree`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); craindre (ID: `keyterm:Fear`); Vine (ID: `flora:Vine`); saint (ID: `keyterm:Holy`); Rams Horn (ID: `realia:RamsHorn`); Olive Oil (ID: `realia:OliveOil`); Must (ID: `realia:Must`); Mule (ID: `fauna:Mule`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); laissiez en possession (ID: `keyterm:Possess`); être zélé (ID: `keyterm:Zealous`); Garden of Eden (ID: `place:Eden.2`); bonté (ID: `keyterm:Kindness`); benir (ID: `keyterm:Bless`); miséricordieux (ID: `keyterm:Compassionate`); bienveillant (ID: `keyterm:Generous`); offrande (ID: `keyterm:Offering`); Israël (ID: `person:Israel`); Stone Altar (ID: `realia:StoneAltar`); House (ID: `realia:House`); Fig (ID: `flora:Fig`); Weapons (ID: `realia:Weapons`); Window (ID: `realia:Window`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Locust (ID: `fauna:Locust`); Wine (ID: `realia:Wine`); Horse (ID: `fauna:Horse`); Grain (ID: `flora:Grain`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Chariot (ID: `realia:Chariot`); Threshing Floor (ID: `realia:ThreshingFloor`); Grass (ID: `flora:Grass`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Cédron (ID: `place:Kidron`); Israël (ID: `person:Israel`); Sabeans (ID: `group:Sabean`); Valley of Shittim (ID: `place:ShittimValley`); Yavanite (ID: `group:Greek`); Édom (ID: `place:Edom`); Tyr (ID: `place:Tyre`); laissiez en possession (ID: `keyterm:Possess`); Philistia (ID: `place:Philistine`); Sidon (ID: `place:Sidon`); exempt (ID: `keyterm:Exempt`); Égypte (ID: `place:Egypt`); destin (ID: `keyterm:Lot`); craindre (ID: `keyterm:Fear`); Javan (ID: `person:Javan`); saint (ID: `keyterm:Holy`); Sheba (ID: `person:Sheba`); exemple (ID: `keyterm:Example`); refuge (ID: `keyterm:Refuge`); A Man (ID: `person:GenericMale`); déclarer innocent (ID: `keyterm:PronounceInnocent`); nation; peuple (ID: `group:Gentile`); parler (ID: `keyterm:Speak`); Pruning Knife (ID: `realia:PruningKnife`); Fortress (ID: `realia:Fortress`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); Sickle (ID: `realia:Sickle`); Spear (ID: `realia:Spear`); Wine (ID: `realia:Wine`); Mattock (ID: `realia:Mattock`); Winepress (ID: `realia:Winepress`)
