...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); offrande (ID: `keyterm:Offering`); Fig (ID: `flora:Fig`); Sackcloth (ID: `realia:Sackcloth`); Grain (ID: `flora:Grain`); Must (ID: `realia:Must`); Pethuel (ID: `person:Pethuel`); Joël (ID: `person:Joel.14`); parole du seigneur (ID: `keyterm:WordOfTheLord`); saint (ID: `keyterm:Holy`); Locust (ID: `fauna:Locust`); Date Palm (ID: `flora:DatePalm`); Pomegranate (ID: `flora:Pomegranate`); Cattle (ID: `fauna:Bull`); Stone Altar (ID: `realia:StoneAltar`); Goat (ID: `fauna:Goat`); Lion (ID: `fauna:Lion`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Flock (ID: `fauna:Flock`); Wheat (ID: `flora:Wheat`); Anointing Oil (ID: `realia:AnointingOil`); Barn (ID: `realia:Barn`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Grass (ID: `flora:Grass`); Barley (ID: `flora:Barley`); Olive Oil (ID: `realia:OliveOil`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); Jérusalem (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); saint (ID: `keyterm:Holy`); Rams Horn (ID: `realia:RamsHorn`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Must (ID: `realia:Must`); Olive Oil (ID: `realia:OliveOil`); offrande (ID: `keyterm:Offering`); bonté (ID: `keyterm:Kindness`); laissiez en possession (ID: `keyterm:Possess`); benir (ID: `keyterm:Bless`); être zélé (ID: `keyterm:Zealous`); Garden of Eden (ID: `place:Eden.2`); miséricordieux (ID: `keyterm:Compassionate`); bienveillant (ID: `keyterm:Generous`); Israël (ID: `person:Israel`); Wine (ID: `realia:Wine`); Locust (ID: `fauna:Locust`); Winepress (ID: `realia:Winepress`); Threshing Floor (ID: `realia:ThreshingFloor`); Fig (ID: `flora:Fig`); Stone Altar (ID: `realia:StoneAltar`); House (ID: `realia:House`); Chariot (ID: `realia:Chariot`); Grain (ID: `flora:Grain`); Temple Altar (ID: `realia:TempleAltar`); Weapons (ID: `realia:Weapons`); Window (ID: `realia:Window`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Horse (ID: `fauna:Horse`); Grass (ID: `flora:Grass`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Cédron (ID: `place:Kidron`); Israël (ID: `person:Israel`); Yavanite (ID: `group:Greek`); Sabeans (ID: `group:Sabean`); Valley of Shittim (ID: `place:ShittimValley`); A Man (ID: `person:GenericMale`); laissiez en possession (ID: `keyterm:Possess`); exemple (ID: `keyterm:Example`); Philistia (ID: `place:Philistine`); exempt (ID: `keyterm:Exempt`); craindre (ID: `keyterm:Fear`); Sheba (ID: `person:Sheba`); Égypte (ID: `place:Egypt`); Javan (ID: `person:Javan`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Édom (ID: `place:Edom`); destin (ID: `keyterm:Lot`); nation; peuple (ID: `group:Gentile`); Sidon (ID: `place:Sidon`); refuge (ID: `keyterm:Refuge`); Tyr (ID: `place:Tyre`); parler (ID: `keyterm:Speak`); saint (ID: `keyterm:Holy`); Pruning Knife (ID: `realia:PruningKnife`); Wine (ID: `realia:Wine`); Mattock (ID: `realia:Mattock`); Fortress (ID: `realia:Fortress`); Winepress (ID: `realia:Winepress`); Money (ID: `realia:Money`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Sickle (ID: `realia:Sickle`); Spear (ID: `realia:Spear`); Sword (ID: `realia:Sword`)
