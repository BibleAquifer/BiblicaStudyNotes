...
* **Associated ACAI Concepts:** Pethuel (ID: `person:Pethuel`); Joël (ID: `person:Joel.14`); Locust (ID: `fauna:Locust`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Valley of Shittim (ID: `place:ShittimValley`); Pruning Knife (ID: `realia:PruningKnife`); Sabeans (ID: `group:Sabean`); Yavanite (ID: `group:Greek`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`)
