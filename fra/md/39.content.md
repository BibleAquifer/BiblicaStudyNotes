...
* **Associated ACAI Concepts:** Malachie (ID: `person:Malachi`); Utterance (ID: `keyterm:Utterance`)
...
* **Associated ACAI Concepts:** Soap (ID: `realia:Soap`); Hammada (ID: `flora:Soap`); niveau (ID: `keyterm:Fairness`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); alliance (ID: `keyterm:Covenant`); offrande (ID: `keyterm:Offering`); Éternel (ID: `deity:Lord`)
