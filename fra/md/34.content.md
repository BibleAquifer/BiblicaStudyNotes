...
* **Associated ACAI Concepts:** Nahum (ID: `person:Nahum.2`); Elkosch (ID: `place:Elkosh`)
...
* **Associated ACAI Concepts:** Protective Shield (ID: `realia:ProtectiveShield`); Brick Mold (ID: `realia:BrickMold`); Amon (ID: `deity:Amon`); Amôn (ID: `place:Thebes`); Éternel (ID: `deity:Lord`)
