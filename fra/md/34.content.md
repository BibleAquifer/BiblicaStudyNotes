...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Elkosch (ID: `place:Elkosh`); Nahum (ID: `person:Nahum.2`); zélé (ID: `keyterm:Zealous.3`); Basan (ID: `place:Bashan`); se réfugier (ID: `keyterm:SeekfindRefuge`); chemin (ID: `keyterm:TheWay`); Liban (ID: `place:Lebanon`); Carmel (ID: `place:Carmel`); force (ID: `keyterm:Strength`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Utterance (ID: `keyterm:Utterance`); Ninive (ID: `place:Nineveh`); Scroll (ID: `realia:Scroll`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Lion (ID: `fauna:Lion`); Locust (ID: `fauna:Locust`); méchanceté (ID: `keyterm:Wickedness`); Ninive (ID: `place:Nineveh`); Amon (ID: `deity:Amon`); Amôn (ID: `place:Thebes`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Puth (ID: `place:Put`); Woe (ID: `keyterm:Woe.2`); Nile River (ID: `place:Nile`); gloire (ID: `keyterm:Glory`); force (ID: `keyterm:Strength`); état d'être en état de siège (ID: `keyterm:StateOfBeingUnderSiege`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); état intact (ID: `keyterm:IntactState`); Égypte (ID: `place:Egypt`); Juda (ID: `group:Judah`); abomination (ID: `keyterm:DetestedThing`); Juda (ID: `person:Judah.4`); Israël (ID: `person:Israel`); An Angel (ID: `deity:Angel`); incantations (ID: `keyterm:Incantations`); Cush (ID: `place:Cush.2`); Assyria (ID: `place:Assyria`); Libya (ID: `place:Libya`); destin (ID: `keyterm:Lot`); faire un voeu (ID: `keyterm:Vow`); Protective Shield (ID: `realia:ProtectiveShield`); Brick Mold (ID: `realia:BrickMold`); Brier (ID: `flora:Brier`); Fortification (ID: `realia:Fortification`); Phoenician Juniper (ID: `flora:JuniperTree`); Cypress (ID: `flora:Cypress`); Fortress (ID: `realia:Fortress`); Molten Image (ID: `realia:MoltenImage`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Fir (ID: `flora:Fir`); Dove (ID: `fauna:Dove`); Money (ID: `realia:Money`); Fig (ID: `flora:Fig`); Dyed Cloth (ID: `realia:DyedCloth`); Small Shield (ID: `realia:SmallShield`); Grecian Juniper (ID: `flora:Juniper`); Graven Image (ID: `realia:GravenImage`); Spear (ID: `realia:Spear`); Whip (ID: `realia:Whip`); Horse (ID: `fauna:Horse`); Wagon (ID: `realia:Wagon`); Sheep (ID: `fauna:Lamb`); Strong Drink (ID: `realia:StrongDrink`); Grass (ID: `flora:Grass`); Train (ID: `realia:Train`); Yoke (ID: `realia:Yoke`)
