...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Nahum (ID: `person:Nahum.2`); Elkosch (ID: `place:Elkosh`); zélé (ID: `keyterm:Zealous.3`); Basan (ID: `place:Bashan`); Carmel (ID: `place:Carmel`); chemin (ID: `keyterm:TheWay`); force (ID: `keyterm:Strength`); Utterance (ID: `keyterm:Utterance`); déclarer innocent (ID: `keyterm:PronounceInnocent`); Ninive (ID: `place:Nineveh`); Liban (ID: `place:Lebanon`); se réfugier (ID: `keyterm:SeekfindRefuge`); Scroll (ID: `realia:Scroll`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Locust (ID: `fauna:Locust`); Lion (ID: `fauna:Lion`); méchanceté (ID: `keyterm:Wickedness`); Ninive (ID: `place:Nineveh`); Amon (ID: `deity:Amon`); Amôn (ID: `place:Thebes`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); gloire (ID: `keyterm:Glory`); Woe (ID: `keyterm:Woe.2`); force (ID: `keyterm:Strength`); incantations (ID: `keyterm:Incantations`); Juda (ID: `person:Judah.4`); Nile River (ID: `place:Nile`); An Angel (ID: `deity:Angel`); Cush (ID: `place:Cush.2`); destin (ID: `keyterm:Lot`); Puth (ID: `place:Put`); Assyria (ID: `place:Assyria`); abomination (ID: `keyterm:DetestedThing`); Israël (ID: `person:Israel`); faire un voeu (ID: `keyterm:Vow`); état d'être en état de siège (ID: `keyterm:StateOfBeingUnderSiege`); Libya (ID: `place:Libya`); Égypte (ID: `place:Egypt`); Juda (ID: `group:Judah`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); état intact (ID: `keyterm:IntactState`); Protective Shield (ID: `realia:ProtectiveShield`); Brick Mold (ID: `realia:BrickMold`); Molten Image (ID: `realia:MoltenImage`); Sheep (ID: `fauna:Lamb`); Wagon (ID: `realia:Wagon`); Cypress (ID: `flora:Cypress`); Fir (ID: `flora:Fir`); Horse (ID: `fauna:Horse`); Whip (ID: `realia:Whip`); Sword (ID: `realia:Sword`); Small Shield (ID: `realia:SmallShield`); Dyed Cloth (ID: `realia:DyedCloth`); Strong Drink (ID: `realia:StrongDrink`); Phoenician Juniper (ID: `flora:JuniperTree`); Fortress (ID: `realia:Fortress`); Spear (ID: `realia:Spear`); Dove (ID: `fauna:Dove`); Grass (ID: `flora:Grass`); House (ID: `realia:House`); Brier (ID: `flora:Brier`); Yoke (ID: `realia:Yoke`); Money (ID: `realia:Money`); Fig (ID: `flora:Fig`); Grecian Juniper (ID: `flora:Juniper`); Train (ID: `realia:Train`); Graven Image (ID: `realia:GravenImage`); Fortification (ID: `realia:Fortification`)
