...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); bonnes nouvelles (ID: `keyterm:GoodNews`); Éternel (ID: `deity:Lord`); grâce (ID: `keyterm:Favor`); éternellement (ID: `keyterm:Always`); Galatie (ID: `place:Galatia`); déliver (ID: `keyterm:Rescue`); persuader (ID: `keyterm:Persuade`); gloire (ID: `keyterm:Glory`); faire la paix (ID: `keyterm:Peace`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); An Angel (ID: `deity:Angel`); pécher (ID: `keyterm:Sin`); sûrement! (ID: `keyterm:Surely`); résurrection (ID: `keyterm:Resurrection`); Paul (ID: `person:Paul`); église (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** bonnes nouvelles (ID: `keyterm:GoodNews`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); église (ID: `keyterm:Church`); Jacques (ID: `person:James.3`); manière de vivre (ID: `keyterm:Behavior`); Arabie (ID: `place:Arabia`); gloire (ID: `keyterm:Glory`); sang (ID: `keyterm:Blood`); corps (ID: `keyterm:Body.3`); se rendre (ID: `keyterm:Teaching`); Pierre (ID: `person:Peter`); en christ (ID: `keyterm:InChrist`); Judée (ID: `place:Judea`); Damas (ID: `place:Damascus`); grâce (ID: `keyterm:Favor`); croire (ID: `keyterm:Believe`); nation; peuple (ID: `group:Gentile`); Cilicie (ID: `place:Cilicia`)
...
* **Associated ACAI Concepts:** bonnes nouvelles (ID: `keyterm:GoodNews`); Pierre (ID: `person:Peter`); Circumcision (ID: `keyterm:Circumcision`); nation; peuple (ID: `group:Gentile`); Tite (ID: `person:Titus`); Barnabas (ID: `person:Barnabas`); Jérusalem (ID: `place:Jerusalem`); proclamer (ID: `keyterm:Proclaim`); Jacques (ID: `person:James.3`); vérité (ID: `keyterm:Truth`); Jésus (ID: `person:Jesus.2`); vide (ID: `keyterm:Empty`); Yavanite (ID: `group:Greek`); fraternité (ID: `keyterm:Fellowship`); Éternel (ID: `deity:Lord`); en christ (ID: `keyterm:InChrist`); grâce (ID: `keyterm:Favor`); croire (ID: `keyterm:Believe`); Javan (ID: `person:Javan`); Jean (ID: `person:John.2`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); vie (ID: `keyterm:Life`); loi (ID: `keyterm:Law`); Jews (ID: `group:Jews`); nation; peuple (ID: `group:Gentile`); être juste (ID: `keyterm:Just`); corps (ID: `keyterm:Body.3`); Pierre (ID: `person:Peter`); Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); Antioche (ID: `place:Antioch`); hypocrisie (ID: `keyterm:Hypocrisy`); bonnes nouvelles (ID: `keyterm:GoodNews`); aimer (ID: `keyterm:Love`); Jacques (ID: `person:James.3`); vérité (ID: `keyterm:Truth`); pécher (ID: `keyterm:Sin`); en christ (ID: `keyterm:InChrist`); grâce (ID: `keyterm:Favor`); craindre (ID: `keyterm:Fear`); Circumcision (ID: `keyterm:Circumcision`); Barnabas (ID: `person:Barnabas`); condamner (ID: `keyterm:Condemn`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** croire (ID: `keyterm:Believe`); loi (ID: `keyterm:Law`); Abraham (ID: `person:Abraham`); Saint-Esprit (ID: `deity:HolySpirit`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); être juste (ID: `keyterm:Just`); vie (ID: `keyterm:Life`); benir (ID: `keyterm:Bless`); Cross (ID: `realia:Cross`); Galate (ID: `group:Galatia`); capacité (ID: `keyterm:Ability`); Galatie (ID: `place:Galatia`); corps (ID: `keyterm:Body.3`); acheter (ID: `keyterm:Redeem`); en christ (ID: `keyterm:InChrist`); fidelité (ID: `keyterm:Faithfulness`); promesse (ID: `keyterm:Promise`); scripture (ID: `keyterm:Scripture`); nation; peuple (ID: `group:Gentile`); proclamer la bonne nouvelle à l'avance ou avant l'heure (ID: `keyterm:BringTheGoodNewsAheadOfTime`)
...
* **Associated ACAI Concepts:** promesse (ID: `keyterm:Promise`); Jésus (ID: `person:Jesus.2`); loi (ID: `keyterm:Law`); croire (ID: `keyterm:Believe`); Éternel (ID: `deity:Lord`); Abraham (ID: `person:Abraham`); en christ (ID: `keyterm:InChrist`); alliance (ID: `keyterm:Covenant`); être juste (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); pécher (ID: `keyterm:Sin`); baptême (ID: `keyterm:Baptism`); Javan (ID: `person:Javan`); pardonner (ID: `keyterm:Forgive`); scripture (ID: `keyterm:Scripture`); Jews (ID: `group:Jews`); Yavanite (ID: `group:Greek`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); éléments (ID: `keyterm:FundamentalPrinciples`); servir (ID: `keyterm:Serve.2`); loi (ID: `keyterm:Law`); corps (ID: `keyterm:Body.3`); Jésus (ID: `person:Jesus.2`); agir par méchanceté (ID: `keyterm:ActWickedly`); capacité (ID: `keyterm:Ability`); bonnes nouvelles (ID: `keyterm:GoodNews`); témoigner (ID: `keyterm:BearWitness`); An Angel (ID: `deity:Angel`); bonheur (ID: `keyterm:Happiness`); craindre (ID: `keyterm:Fear`); acheter (ID: `keyterm:Redeem`); coeur (ID: `keyterm:Heart`); dire la vérité (ID: `keyterm:SpeakTheTruth`); Saint-Esprit (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** montagne de Sinaï (ID: `place:SinaiMount`); Agar (ID: `person:Hagar`); Jérusalem (ID: `place:Jerusalem`); corps (ID: `keyterm:Body.3`); promesse (ID: `keyterm:Promise`); esclavage (ID: `keyterm:Slavery`); loi (ID: `keyterm:Law`); Arabie (ID: `place:Arabia`); Abraham (ID: `person:Abraham`); alliance (ID: `keyterm:Covenant`); scripture (ID: `keyterm:Scripture`); Isaac (ID: `person:Isaac`); Saint-Esprit (ID: `deity:HolySpirit`); servir (ID: `keyterm:Serve.2`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Circumcision (ID: `keyterm:Circumcision`); coeur (ID: `keyterm:Heart`); persuader (ID: `keyterm:Persuade`); loi (ID: `keyterm:Law`); croire (ID: `keyterm:Believe`); être juste (ID: `keyterm:Just`); proclamer (ID: `keyterm:Proclaim`); aimer (ID: `keyterm:Love`); vérité (ID: `keyterm:Truth`); Paul (ID: `person:Paul`); esclavage (ID: `keyterm:Slavery`); jugement (ID: `keyterm:Judgment`); penser (ID: `keyterm:Think`); grâce (ID: `keyterm:Favor`); persuasion (ID: `keyterm:ThatWhichPersuades`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); Saint-Esprit (ID: `deity:HolySpirit`); espoir (ID: `keyterm:Hope`); declarer solennellement et catégoriquement (ID: `keyterm:Declare`); Yoke (ID: `realia:Yoke`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** corps (ID: `keyterm:Body.3`); Saint-Esprit (ID: `deity:HolySpirit`); aimer (ID: `keyterm:Love`); loi (ID: `keyterm:Law`); jalousie (ID: `keyterm:Resentment`); marcher (ID: `keyterm:Live.3`); le bien (ID: `keyterm:Good`); Jésus (ID: `person:Jesus.2`); vie (ID: `keyterm:Life`); fornication (ID: `keyterm:Fornication`); Cause of Joy (ID: `keyterm:CauseOfJoy`); servir (ID: `keyterm:Serve.2`); régne (ID: `keyterm:Kingdom`); Éternel (ID: `deity:Lord`); idolâtrie (ID: `keyterm:Idolatry`); croire (ID: `keyterm:Believe`); bonté (ID: `keyterm:Kindness`); faire la paix (ID: `keyterm:Peace`); pollution (ID: `keyterm:Defilement`); vanité (ID: `keyterm:Conceit`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** le bien (ID: `keyterm:Good`); partager (ID: `keyterm:Share`); loi (ID: `keyterm:Law`); capacité (ID: `keyterm:Ability`); corps (ID: `keyterm:Body.3`); esprit (ID: `keyterm:Spirit.2`); croire (ID: `keyterm:Believe`); Jésus (ID: `person:Jesus.2`); éternellement (ID: `keyterm:Always`); vie (ID: `keyterm:Life`); mis à l'essai (ID: `keyterm:PutToTheTest`); Éternel (ID: `deity:Lord`); Saint-Esprit (ID: `deity:HolySpirit`); tester (ID: `keyterm:Interpret`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); corps (ID: `keyterm:Body.3`); Cross (ID: `realia:Cross`); loi (ID: `keyterm:Law`); capacité (ID: `keyterm:Ability`); faire la paix (ID: `keyterm:Peace`); Israël (ID: `person:Israel`); grâce (ID: `keyterm:Favor`); esprit (ID: `keyterm:Spirit.2`); sûrement! (ID: `keyterm:Surely`); Circumcision (ID: `keyterm:Circumcision`); Éternel (ID: `deity:Lord`); marque (ID: `keyterm:Mark`); pitié (ID: `keyterm:Mercy`)
