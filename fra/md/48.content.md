...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); bonnes nouvelles (ID: `keyterm:GoodNews`); grâce (ID: `keyterm:Favor`); éternellement (ID: `keyterm:Always`); Galatie (ID: `place:Galatia`); déliver (ID: `keyterm:Rescue`); persuader (ID: `keyterm:Persuade`); résurrection (ID: `keyterm:Resurrection`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); faire la paix (ID: `keyterm:Peace`); Paul (ID: `person:Paul`); église (ID: `keyterm:Church`); capacité (ID: `keyterm:Ability`); pécher (ID: `keyterm:Sin`); sûrement! (ID: `keyterm:Surely`); An Angel (ID: `deity:Angel`); gloire (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** bonnes nouvelles (ID: `keyterm:GoodNews`); Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); Jérusalem (ID: `place:Jerusalem`); église (ID: `keyterm:Church`); Jacques (ID: `person:James.3`); manière de vivre (ID: `keyterm:Behavior`); Arabie (ID: `place:Arabia`); Damas (ID: `place:Damascus`); en christ (ID: `keyterm:InChrist`); Judée (ID: `place:Judea`); se rendre (ID: `keyterm:Teaching`); grâce (ID: `keyterm:Favor`); nation; peuple (ID: `group:Gentile`); corps (ID: `keyterm:Body.3`); sang (ID: `keyterm:Blood`); croire (ID: `keyterm:Believe`); Cilicie (ID: `place:Cilicia`); Pierre (ID: `person:Peter`); gloire (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** Circumcision (ID: `keyterm:Circumcision`); bonnes nouvelles (ID: `keyterm:GoodNews`); nation; peuple (ID: `group:Gentile`); Pierre (ID: `person:Peter`); Barnabas (ID: `person:Barnabas`); Tite (ID: `person:Titus`); Jean (ID: `person:John.2`); proclamer (ID: `keyterm:Proclaim`); en christ (ID: `keyterm:InChrist`); Javan (ID: `person:Javan`); Jérusalem (ID: `place:Jerusalem`); grâce (ID: `keyterm:Favor`); vérité (ID: `keyterm:Truth`); vide (ID: `keyterm:Empty`); Éternel (ID: `deity:Lord`); Jacques (ID: `person:James.3`); Yavanite (ID: `group:Greek`); croire (ID: `keyterm:Believe`); Jésus (ID: `person:Jesus.2`); fraternité (ID: `keyterm:Fellowship`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); être juste (ID: `keyterm:Just`); nation; peuple (ID: `group:Gentile`); vie (ID: `keyterm:Life`); loi (ID: `keyterm:Law`); Jews (ID: `group:Jews`); Éternel (ID: `deity:Lord`); corps (ID: `keyterm:Body.3`); croire (ID: `keyterm:Believe`); Pierre (ID: `person:Peter`); hypocrisie (ID: `keyterm:Hypocrisy`); Antioche (ID: `place:Antioch`); Circumcision (ID: `keyterm:Circumcision`); bonnes nouvelles (ID: `keyterm:GoodNews`); en christ (ID: `keyterm:InChrist`); craindre (ID: `keyterm:Fear`); Barnabas (ID: `person:Barnabas`); grâce (ID: `keyterm:Favor`); vérité (ID: `keyterm:Truth`); condamner (ID: `keyterm:Condemn`); Jacques (ID: `person:James.3`); pécher (ID: `keyterm:Sin`); aimer (ID: `keyterm:Love`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** croire (ID: `keyterm:Believe`); loi (ID: `keyterm:Law`); Abraham (ID: `person:Abraham`); Saint-Esprit (ID: `deity:HolySpirit`); être juste (ID: `keyterm:Just`); Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); benir (ID: `keyterm:Bless`); vie (ID: `keyterm:Life`); Cross (ID: `realia:Cross`); Galate (ID: `group:Galatia`); scripture (ID: `keyterm:Scripture`); en christ (ID: `keyterm:InChrist`); acheter (ID: `keyterm:Redeem`); fidelité (ID: `keyterm:Faithfulness`); Galatie (ID: `place:Galatia`); proclamer la bonne nouvelle à l'avance ou avant l'heure (ID: `keyterm:BringTheGoodNewsAheadOfTime`); promesse (ID: `keyterm:Promise`); capacité (ID: `keyterm:Ability`); nation; peuple (ID: `group:Gentile`); corps (ID: `keyterm:Body.3`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); éléments (ID: `keyterm:FundamentalPrinciples`); servir (ID: `keyterm:Serve.2`); Jésus (ID: `person:Jesus.2`); corps (ID: `keyterm:Body.3`); loi (ID: `keyterm:Law`); agir par méchanceté (ID: `keyterm:ActWickedly`); coeur (ID: `keyterm:Heart`); témoigner (ID: `keyterm:BearWitness`); Saint-Esprit (ID: `deity:HolySpirit`); craindre (ID: `keyterm:Fear`); acheter (ID: `keyterm:Redeem`); capacité (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); bonnes nouvelles (ID: `keyterm:GoodNews`); bonheur (ID: `keyterm:Happiness`); dire la vérité (ID: `keyterm:SpeakTheTruth`)
...
* **Associated ACAI Concepts:** Agar (ID: `person:Hagar`); montagne de Sinaï (ID: `place:SinaiMount`); promesse (ID: `keyterm:Promise`); Jérusalem (ID: `place:Jerusalem`); corps (ID: `keyterm:Body.3`); esclavage (ID: `keyterm:Slavery`); Abraham (ID: `person:Abraham`); Arabie (ID: `place:Arabia`); scripture (ID: `keyterm:Scripture`); Saint-Esprit (ID: `deity:HolySpirit`); alliance (ID: `keyterm:Covenant`); Isaac (ID: `person:Isaac`); servir (ID: `keyterm:Serve.2`); loi (ID: `keyterm:Law`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Circumcision (ID: `keyterm:Circumcision`); coeur (ID: `keyterm:Heart`); être juste (ID: `keyterm:Just`); persuader (ID: `keyterm:Persuade`); loi (ID: `keyterm:Law`); croire (ID: `keyterm:Believe`); proclamer (ID: `keyterm:Proclaim`); espoir (ID: `keyterm:Hope`); esclavage (ID: `keyterm:Slavery`); declarer solennellement et catégoriquement (ID: `keyterm:Declare`); penser (ID: `keyterm:Think`); grâce (ID: `keyterm:Favor`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); vérité (ID: `keyterm:Truth`); Saint-Esprit (ID: `deity:HolySpirit`); Paul (ID: `person:Paul`); jugement (ID: `keyterm:Judgment`); persuasion (ID: `keyterm:ThatWhichPersuades`); aimer (ID: `keyterm:Love`); Yoke (ID: `realia:Yoke`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** corps (ID: `keyterm:Body.3`); Saint-Esprit (ID: `deity:HolySpirit`); loi (ID: `keyterm:Law`); aimer (ID: `keyterm:Love`); jalousie (ID: `keyterm:Resentment`); marcher (ID: `keyterm:Live.3`); le bien (ID: `keyterm:Good`); bonté (ID: `keyterm:Kindness`); régne (ID: `keyterm:Kingdom`); faire la paix (ID: `keyterm:Peace`); servir (ID: `keyterm:Serve.2`); vanité (ID: `keyterm:Conceit`); fornication (ID: `keyterm:Fornication`); Éternel (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); pollution (ID: `keyterm:Defilement`); vie (ID: `keyterm:Life`); idolâtrie (ID: `keyterm:Idolatry`); croire (ID: `keyterm:Believe`); Jésus (ID: `person:Jesus.2`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** le bien (ID: `keyterm:Good`); partager (ID: `keyterm:Share`); croire (ID: `keyterm:Believe`); corps (ID: `keyterm:Body.3`); Saint-Esprit (ID: `deity:HolySpirit`); Jésus (ID: `person:Jesus.2`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); éternellement (ID: `keyterm:Always`); mis à l'essai (ID: `keyterm:PutToTheTest`); tester (ID: `keyterm:Interpret`); vie (ID: `keyterm:Life`); esprit (ID: `keyterm:Spirit.2`); loi (ID: `keyterm:Law`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); corps (ID: `keyterm:Body.3`); Cross (ID: `realia:Cross`); grâce (ID: `keyterm:Favor`); marque (ID: `keyterm:Mark`); Circumcision (ID: `keyterm:Circumcision`); faire la paix (ID: `keyterm:Peace`); capacité (ID: `keyterm:Ability`); sûrement! (ID: `keyterm:Surely`); Éternel (ID: `deity:Lord`); pitié (ID: `keyterm:Mercy`); Israël (ID: `person:Israel`); esprit (ID: `keyterm:Spirit.2`); loi (ID: `keyterm:Law`)
