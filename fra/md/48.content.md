...
* **Associated Passages:** Galates 1.1-10
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); bonnes nouvelles (ID: `keyterm:GoodNews`); Éternel (ID: `deity:Lord`); grâce (ID: `keyterm:Favor`); éternellement (ID: `keyterm:Always`); Galatie (ID: `place:Galatia`); déliver (ID: `keyterm:Rescue`); persuader (ID: `keyterm:Persuade`); An Angel (ID: `deity:Angel`); faire la paix (ID: `keyterm:Peace`); sûrement! (ID: `keyterm:Surely`); résurrection (ID: `keyterm:Resurrection`); gloire (ID: `keyterm:Glory`); Paul (ID: `person:Paul`); pécher (ID: `keyterm:Sin`); église (ID: `keyterm:Church`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`)
...
* **Associated Passages:** Galates 1.11-24
...
* **Associated ACAI Concepts:** bonnes nouvelles (ID: `keyterm:GoodNews`); Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); Jérusalem (ID: `place:Jerusalem`); église (ID: `keyterm:Church`); Jacques (ID: `person:James.3`); Arabie (ID: `place:Arabia`); manière de vivre (ID: `keyterm:Behavior`); Judée (ID: `place:Judea`); sang (ID: `keyterm:Blood`); gloire (ID: `keyterm:Glory`); Damas (ID: `place:Damascus`); croire (ID: `keyterm:Believe`); corps (ID: `keyterm:Body.3`); Pierre (ID: `person:Peter`); Cilicie (ID: `place:Cilicia`); grâce (ID: `keyterm:Favor`); nation; peuple (ID: `group:Gentile`); en christ (ID: `keyterm:InChrist`); se rendre (ID: `keyterm:Teaching`)
...
* **Associated Passages:** Galates 2.1-10
...
* **Associated ACAI Concepts:** bonnes nouvelles (ID: `keyterm:GoodNews`); Pierre (ID: `person:Peter`); Circumcision (ID: `keyterm:Circumcision`); nation; peuple (ID: `group:Gentile`); Tite (ID: `person:Titus`); Barnabas (ID: `person:Barnabas`); Jean (ID: `person:John.2`); croire (ID: `keyterm:Believe`); vérité (ID: `keyterm:Truth`); Jacques (ID: `person:James.3`); Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); vide (ID: `keyterm:Empty`); fraternité (ID: `keyterm:Fellowship`); Javan (ID: `person:Javan`); Jésus (ID: `person:Jesus.2`); grâce (ID: `keyterm:Favor`); Yavanite (ID: `group:Greek`); proclamer (ID: `keyterm:Proclaim`); en christ (ID: `keyterm:InChrist`)
...
* **Associated Passages:** Galates 2.11-21
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); vie (ID: `keyterm:Life`); loi (ID: `keyterm:Law`); être juste (ID: `keyterm:Just`); nation; peuple (ID: `group:Gentile`); croire (ID: `keyterm:Believe`); corps (ID: `keyterm:Body.3`); Éternel (ID: `deity:Lord`); Pierre (ID: `person:Peter`); Antioche (ID: `place:Antioch`); hypocrisie (ID: `keyterm:Hypocrisy`); bonnes nouvelles (ID: `keyterm:GoodNews`); pécher (ID: `keyterm:Sin`); aimer (ID: `keyterm:Love`); vérité (ID: `keyterm:Truth`); Jacques (ID: `person:James.3`); condamner (ID: `keyterm:Condemn`); Barnabas (ID: `person:Barnabas`); craindre (ID: `keyterm:Fear`); Circumcision (ID: `keyterm:Circumcision`); grâce (ID: `keyterm:Favor`); en christ (ID: `keyterm:InChrist`); Cross (ID: `realia:Cross`)
...
* **Associated Passages:** Galates 3.1-14
* **Associated Articles:** Foi (ID: `133484@BiblicaStudyNotes`); Abraham (ID: `133495@BiblicaStudyNotesKeyTerms`); Bénir toutes les nations (ID: `133497@BiblicaStudyNotesKeyTerms`); Malédictions de l'alliance (ID: `133632@BiblicaStudyNotesKeyTerms`); Le Saint-Esprit (ID: `133640@BiblicaStudyNotesKeyTerms`); Vie éternelle (ID: `133821@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** croire (ID: `keyterm:Believe`); loi (ID: `keyterm:Law`); Abraham (ID: `person:Abraham`); Saint-Esprit (ID: `deity:HolySpirit`); Éternel (ID: `deity:Lord`); être juste (ID: `keyterm:Just`); Jésus (ID: `person:Jesus.2`); benir (ID: `keyterm:Bless`); vie (ID: `keyterm:Life`); Cross (ID: `realia:Cross`); Galate (ID: `group:Galatia`); scripture (ID: `keyterm:Scripture`); capacité (ID: `keyterm:Ability`); corps (ID: `keyterm:Body.3`); promesse (ID: `keyterm:Promise`); Galatie (ID: `place:Galatia`); proclamer la bonne nouvelle à l'avance ou avant l'heure (ID: `keyterm:BringTheGoodNewsAheadOfTime`); acheter (ID: `keyterm:Redeem`); fidelité (ID: `keyterm:Faithfulness`); nation; peuple (ID: `group:Gentile`); en christ (ID: `keyterm:InChrist`)
...
* **Associated Passages:** Galates 3.15-29
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); promesse (ID: `keyterm:Promise`); loi (ID: `keyterm:Law`); croire (ID: `keyterm:Believe`); Éternel (ID: `deity:Lord`); Abraham (ID: `person:Abraham`); en christ (ID: `keyterm:InChrist`); être juste (ID: `keyterm:Just`); alliance (ID: `keyterm:Covenant`); An Angel (ID: `deity:Angel`); scripture (ID: `keyterm:Scripture`); baptême (ID: `keyterm:Baptism`); Yavanite (ID: `group:Greek`); pardonner (ID: `keyterm:Forgive`); pécher (ID: `keyterm:Sin`); Jews (ID: `group:Jews`); Javan (ID: `person:Javan`)
...
* **Associated Passages:** Galates 4.1-20
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); servir (ID: `keyterm:Serve.2`); éléments (ID: `keyterm:FundamentalPrinciples`); Jésus (ID: `person:Jesus.2`); corps (ID: `keyterm:Body.3`); loi (ID: `keyterm:Law`); An Angel (ID: `deity:Angel`); témoigner (ID: `keyterm:BearWitness`); acheter (ID: `keyterm:Redeem`); bonnes nouvelles (ID: `keyterm:GoodNews`); dire la vérité (ID: `keyterm:SpeakTheTruth`); agir par méchanceté (ID: `keyterm:ActWickedly`); coeur (ID: `keyterm:Heart`); bonheur (ID: `keyterm:Happiness`); craindre (ID: `keyterm:Fear`); Saint-Esprit (ID: `deity:HolySpirit`); capacité (ID: `keyterm:Ability`)
...
* **Associated Passages:** Galates 4.21-31
...
* **Associated ACAI Concepts:** Agar (ID: `person:Hagar`); montagne de Sinaï (ID: `place:SinaiMount`); Jérusalem (ID: `place:Jerusalem`); corps (ID: `keyterm:Body.3`); promesse (ID: `keyterm:Promise`); esclavage (ID: `keyterm:Slavery`); scripture (ID: `keyterm:Scripture`); Arabie (ID: `place:Arabia`); loi (ID: `keyterm:Law`); servir (ID: `keyterm:Serve.2`); Isaac (ID: `person:Isaac`); Abraham (ID: `person:Abraham`); Saint-Esprit (ID: `deity:HolySpirit`); alliance (ID: `keyterm:Covenant`)
...
* **Associated Passages:** Galates 5.1-12
* **Associated Articles:** Grâce (ID: `133487@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Circumcision (ID: `keyterm:Circumcision`); croire (ID: `keyterm:Believe`); coeur (ID: `keyterm:Heart`); persuader (ID: `keyterm:Persuade`); loi (ID: `keyterm:Law`); être juste (ID: `keyterm:Just`); esclavage (ID: `keyterm:Slavery`); Paul (ID: `person:Paul`); declarer solennellement et catégoriquement (ID: `keyterm:Declare`); aimer (ID: `keyterm:Love`); vérité (ID: `keyterm:Truth`); penser (ID: `keyterm:Think`); espoir (ID: `keyterm:Hope`); jugement (ID: `keyterm:Judgment`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); persuasion (ID: `keyterm:ThatWhichPersuades`); Saint-Esprit (ID: `deity:HolySpirit`); grâce (ID: `keyterm:Favor`); proclamer (ID: `keyterm:Proclaim`); Cross (ID: `realia:Cross`); Yoke (ID: `realia:Yoke`)
...
* **Associated Passages:** Galates 5.13-26
...
* **Associated ACAI Concepts:** corps (ID: `keyterm:Body.3`); Saint-Esprit (ID: `deity:HolySpirit`); aimer (ID: `keyterm:Love`); loi (ID: `keyterm:Law`); jalousie (ID: `keyterm:Resentment`); marcher (ID: `keyterm:Live.3`); le bien (ID: `keyterm:Good`); Cause of Joy (ID: `keyterm:CauseOfJoy`); croire (ID: `keyterm:Believe`); bonté (ID: `keyterm:Kindness`); servir (ID: `keyterm:Serve.2`); Éternel (ID: `deity:Lord`); vie (ID: `keyterm:Life`); idolâtrie (ID: `keyterm:Idolatry`); pollution (ID: `keyterm:Defilement`); Jésus (ID: `person:Jesus.2`); faire la paix (ID: `keyterm:Peace`); vanité (ID: `keyterm:Conceit`); régne (ID: `keyterm:Kingdom`); fornication (ID: `keyterm:Fornication`); Cross (ID: `realia:Cross`)
...
* **Associated Passages:** Galates 6.1-10
* **Associated Articles:** Loi du Christ (ID: `133399@BiblicaStudyNotesKeyTerms`); Vie éternelle (ID: `133821@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** le bien (ID: `keyterm:Good`); partager (ID: `keyterm:Share`); Jésus (ID: `person:Jesus.2`); tester (ID: `keyterm:Interpret`); esprit (ID: `keyterm:Spirit.2`); vie (ID: `keyterm:Life`); corps (ID: `keyterm:Body.3`); loi (ID: `keyterm:Law`); éternellement (ID: `keyterm:Always`); mis à l'essai (ID: `keyterm:PutToTheTest`); Saint-Esprit (ID: `deity:HolySpirit`); Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); capacité (ID: `keyterm:Ability`)
...
* **Associated Passages:** Galates 6.11-18
* **Associated Articles:** Persécutés (ID: `133306@BiblicaStudyNotesKeyTerms`); Nouvelle création (ID: `133795@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); corps (ID: `keyterm:Body.3`); Cross (ID: `realia:Cross`); faire la paix (ID: `keyterm:Peace`); esprit (ID: `keyterm:Spirit.2`); sûrement! (ID: `keyterm:Surely`); pitié (ID: `keyterm:Mercy`); Circumcision (ID: `keyterm:Circumcision`); grâce (ID: `keyterm:Favor`); loi (ID: `keyterm:Law`); marque (ID: `keyterm:Mark`); Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); Israël (ID: `person:Israel`)
