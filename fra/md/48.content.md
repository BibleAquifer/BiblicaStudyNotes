...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); bonnes nouvelles (ID: `keyterm:GoodNews`); Éternel (ID: `deity:Lord`); grâce (ID: `keyterm:Favor`); éternellement (ID: `keyterm:Always`); déliver (ID: `keyterm:Rescue`); persuader (ID: `keyterm:Persuade`); Galatie (ID: `place:Galatia`); église (ID: `keyterm:Church`); faire la paix (ID: `keyterm:Peace`); sûrement! (ID: `keyterm:Surely`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); gloire (ID: `keyterm:Glory`); pécher (ID: `keyterm:Sin`); résurrection (ID: `keyterm:Resurrection`); An Angel (ID: `deity:Angel`); capacité (ID: `keyterm:Ability`); Paul (ID: `person:Paul`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); bonnes nouvelles (ID: `keyterm:GoodNews`); Jérusalem (ID: `place:Jerusalem`); église (ID: `keyterm:Church`); manière de vivre (ID: `keyterm:Behavior`); Arabie (ID: `place:Arabia`); Jacques (ID: `person:James.3`); Damas (ID: `place:Damascus`); Judée (ID: `place:Judea`); gloire (ID: `keyterm:Glory`); nation; peuple (ID: `group:Gentile`); se rendre (ID: `keyterm:Teaching`); Cilicie (ID: `place:Cilicia`); corps (ID: `keyterm:Body.3`); en christ (ID: `keyterm:InChrist`); sang (ID: `keyterm:Blood`); Pierre (ID: `person:Peter`); grâce (ID: `keyterm:Favor`); croire (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** nation; peuple (ID: `group:Gentile`); bonnes nouvelles (ID: `keyterm:GoodNews`); Circumcision (ID: `keyterm:Circumcision`); Pierre (ID: `person:Peter`); Tite (ID: `person:Titus`); Barnabas (ID: `person:Barnabas`); Jérusalem (ID: `place:Jerusalem`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); Yavanite (ID: `group:Greek`); fraternité (ID: `keyterm:Fellowship`); vide (ID: `keyterm:Empty`); Javan (ID: `person:Javan`); Jacques (ID: `person:James.3`); Jean (ID: `person:John.2`); vérité (ID: `keyterm:Truth`); en christ (ID: `keyterm:InChrist`); grâce (ID: `keyterm:Favor`); croire (ID: `keyterm:Believe`); proclamer (ID: `keyterm:Proclaim`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); être juste (ID: `keyterm:Just`); vie (ID: `keyterm:Life`); nation; peuple (ID: `group:Gentile`); loi (ID: `keyterm:Law`); Éternel (ID: `deity:Lord`); corps (ID: `keyterm:Body.3`); Pierre (ID: `person:Peter`); croire (ID: `keyterm:Believe`); hypocrisie (ID: `keyterm:Hypocrisy`); Antioche (ID: `place:Antioch`); aimer (ID: `keyterm:Love`); condamner (ID: `keyterm:Condemn`); bonnes nouvelles (ID: `keyterm:GoodNews`); Jacques (ID: `person:James.3`); Circumcision (ID: `keyterm:Circumcision`); vérité (ID: `keyterm:Truth`); en christ (ID: `keyterm:InChrist`); grâce (ID: `keyterm:Favor`); Barnabas (ID: `person:Barnabas`); pécher (ID: `keyterm:Sin`); craindre (ID: `keyterm:Fear`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** croire (ID: `keyterm:Believe`); loi (ID: `keyterm:Law`); Abraham (ID: `person:Abraham`); Saint-Esprit (ID: `deity:HolySpirit`); être juste (ID: `keyterm:Just`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); vie (ID: `keyterm:Life`); benir (ID: `keyterm:Bless`); Cross (ID: `realia:Cross`); Galate (ID: `group:Galatia`); Galatie (ID: `place:Galatia`); acheter (ID: `keyterm:Redeem`); nation; peuple (ID: `group:Gentile`); fidelité (ID: `keyterm:Faithfulness`); proclamer la bonne nouvelle à l'avance ou avant l'heure (ID: `keyterm:BringTheGoodNewsAheadOfTime`); corps (ID: `keyterm:Body.3`); en christ (ID: `keyterm:InChrist`); scripture (ID: `keyterm:Scripture`); capacité (ID: `keyterm:Ability`); promesse (ID: `keyterm:Promise`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); promesse (ID: `keyterm:Promise`); loi (ID: `keyterm:Law`); Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); Abraham (ID: `person:Abraham`); en christ (ID: `keyterm:InChrist`); alliance (ID: `keyterm:Covenant`); être juste (ID: `keyterm:Just`); Jews (ID: `group:Jews`); baptême (ID: `keyterm:Baptism`); Javan (ID: `person:Javan`); pardonner (ID: `keyterm:Forgive`); pécher (ID: `keyterm:Sin`); Yavanite (ID: `group:Greek`); scripture (ID: `keyterm:Scripture`); An Angel (ID: `deity:Angel`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); servir (ID: `keyterm:Serve.2`); éléments (ID: `keyterm:FundamentalPrinciples`); Jésus (ID: `person:Jesus.2`); loi (ID: `keyterm:Law`); corps (ID: `keyterm:Body.3`); bonheur (ID: `keyterm:Happiness`); bonnes nouvelles (ID: `keyterm:GoodNews`); agir par méchanceté (ID: `keyterm:ActWickedly`); capacité (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); acheter (ID: `keyterm:Redeem`); Saint-Esprit (ID: `deity:HolySpirit`); témoigner (ID: `keyterm:BearWitness`); coeur (ID: `keyterm:Heart`); dire la vérité (ID: `keyterm:SpeakTheTruth`); craindre (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** montagne de Sinaï (ID: `place:SinaiMount`); Agar (ID: `person:Hagar`); Jérusalem (ID: `place:Jerusalem`); corps (ID: `keyterm:Body.3`); promesse (ID: `keyterm:Promise`); esclavage (ID: `keyterm:Slavery`); servir (ID: `keyterm:Serve.2`); Abraham (ID: `person:Abraham`); Arabie (ID: `place:Arabia`); Saint-Esprit (ID: `deity:HolySpirit`); scripture (ID: `keyterm:Scripture`); loi (ID: `keyterm:Law`); alliance (ID: `keyterm:Covenant`); Isaac (ID: `person:Isaac`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Circumcision (ID: `keyterm:Circumcision`); persuader (ID: `keyterm:Persuade`); être juste (ID: `keyterm:Just`); loi (ID: `keyterm:Law`); coeur (ID: `keyterm:Heart`); croire (ID: `keyterm:Believe`); penser (ID: `keyterm:Think`); persuasion (ID: `keyterm:ThatWhichPersuades`); aimer (ID: `keyterm:Love`); jugement (ID: `keyterm:Judgment`); esclavage (ID: `keyterm:Slavery`); espoir (ID: `keyterm:Hope`); Saint-Esprit (ID: `deity:HolySpirit`); vérité (ID: `keyterm:Truth`); Paul (ID: `person:Paul`); grâce (ID: `keyterm:Favor`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); declarer solennellement et catégoriquement (ID: `keyterm:Declare`); proclamer (ID: `keyterm:Proclaim`); Cross (ID: `realia:Cross`); Yoke (ID: `realia:Yoke`)
...
* **Associated ACAI Concepts:** Saint-Esprit (ID: `deity:HolySpirit`); corps (ID: `keyterm:Body.3`); aimer (ID: `keyterm:Love`); loi (ID: `keyterm:Law`); marcher (ID: `keyterm:Live.3`); jalousie (ID: `keyterm:Resentment`); le bien (ID: `keyterm:Good`); pollution (ID: `keyterm:Defilement`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); vie (ID: `keyterm:Life`); faire la paix (ID: `keyterm:Peace`); fornication (ID: `keyterm:Fornication`); bonté (ID: `keyterm:Kindness`); servir (ID: `keyterm:Serve.2`); Cause of Joy (ID: `keyterm:CauseOfJoy`); vanité (ID: `keyterm:Conceit`); régne (ID: `keyterm:Kingdom`); idolâtrie (ID: `keyterm:Idolatry`); croire (ID: `keyterm:Believe`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** le bien (ID: `keyterm:Good`); partager (ID: `keyterm:Share`); corps (ID: `keyterm:Body.3`); tester (ID: `keyterm:Interpret`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); éternellement (ID: `keyterm:Always`); vie (ID: `keyterm:Life`); mis à l'essai (ID: `keyterm:PutToTheTest`); esprit (ID: `keyterm:Spirit.2`); Saint-Esprit (ID: `deity:HolySpirit`); loi (ID: `keyterm:Law`); capacité (ID: `keyterm:Ability`); croire (ID: `keyterm:Believe`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); corps (ID: `keyterm:Body.3`); Cross (ID: `realia:Cross`); faire la paix (ID: `keyterm:Peace`); pitié (ID: `keyterm:Mercy`); sûrement! (ID: `keyterm:Surely`); marque (ID: `keyterm:Mark`); Éternel (ID: `deity:Lord`); grâce (ID: `keyterm:Favor`); Circumcision (ID: `keyterm:Circumcision`); esprit (ID: `keyterm:Spirit.2`); loi (ID: `keyterm:Law`); Israël (ID: `person:Israel`); capacité (ID: `keyterm:Ability`)
