...
* **Associated ACAI Concepts:** Thessalonique (ID: `place:Thessalonica`); recevoir la gloire (ID: `keyterm:Glorified`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** se rendre (ID: `keyterm:Teaching`); Jésus (ID: `person:Jesus.2`)
