...
* **Associated Passages:** Ecclésiaste 1.1-11
...
* **Associated ACAI Concepts:** David (ID: `person:David`); Jérusalem (ID: `place:Jerusalem`)
...
* **Associated Passages:** Ecclésiaste 1.12-11.6
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); stupide (ID: `keyterm:Stupid`); pécher (ID: `keyterm:Sin`); la connaissance (ID: `keyterm:Intention`); craindre (ID: `keyterm:Fear`); aimer (ID: `keyterm:Love`); Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); A Man (ID: `person:GenericMale`); force (ID: `keyterm:Strength`); gloire (ID: `keyterm:Glory`); adjuration (ID: `keyterm:Oath`); faire un voeu (ID: `keyterm:Vow`); grâce (ID: `keyterm:Favor`); ardeur (ID: `keyterm:Ardour`); Wine (ID: `realia:Wine`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); agir par méchanceté (ID: `keyterm:ActWickedly`); tuerie (ID: `keyterm:Slaughtering`); laissiez en possession (ID: `keyterm:Possess`); stupidité (ID: `keyterm:Stupidity`); être attiré à servir (ID: `keyterm:EnticedToServe`); jurer (ID: `keyterm:Swear`); An Angel (ID: `deity:Angel`); sans saleté (ID: `keyterm:Pure`); Hell (ID: `place:Hell`)
...
* **Associated Passages:** Ecclésiaste 11.7-12.14
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); House (ID: `realia:House`); vérité (ID: `keyterm:Truth`); proverbe (ID: `keyterm:Saying`); droiture (ID: `keyterm:Straightness`); la connaissance (ID: `keyterm:Intention`); Caper (ID: `flora:Caper`); Goad (ID: `realia:Goad`); Locust (ID: `fauna:Locust`); Clay Jar (ID: `realia:ClayJar`); Money (ID: `realia:Money`); Scroll (ID: `realia:Scroll`); Nail (ID: `realia:Nail`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Bird (ID: `fauna:Bird`); Almond (ID: `flora:Almond`); Rope (ID: `realia:Rope`); Flock (ID: `fauna:Flock`); Pit (ID: `realia:Pit`)
