...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); David (ID: `person:David`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); stupide (ID: `keyterm:Stupid`); pécher (ID: `keyterm:Sin`); la connaissance (ID: `keyterm:Intention`); aimer (ID: `keyterm:Love`); craindre (ID: `keyterm:Fear`); Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); force (ID: `keyterm:Strength`); ardeur (ID: `keyterm:Ardour`); A Man (ID: `person:GenericMale`); gloire (ID: `keyterm:Glory`); faire un voeu (ID: `keyterm:Vow`); grâce (ID: `keyterm:Favor`); adjuration (ID: `keyterm:Oath`); Olive Oil (ID: `realia:OliveOil`); Anointing Oil (ID: `realia:AnointingOil`); Wine (ID: `realia:Wine`); pollution (ID: `keyterm:Defilement`); stupidité (ID: `keyterm:Stupidity`); être attiré à servir (ID: `keyterm:EnticedToServe`); sans saleté (ID: `keyterm:Pure`); securité (ID: `keyterm:Safety`); Hell (ID: `place:Hell`); tuerie (ID: `keyterm:Slaughtering`); Israël (ID: `person:Israel`); agir par méchanceté (ID: `keyterm:ActWickedly`)
