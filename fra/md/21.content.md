...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); stupide (ID: `keyterm:Stupid`); pécher (ID: `keyterm:Sin`); la connaissance (ID: `keyterm:Intention`); aimer (ID: `keyterm:Love`); craindre (ID: `keyterm:Fear`); Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); gloire (ID: `keyterm:Glory`); force (ID: `keyterm:Strength`); A Man (ID: `person:GenericMale`); grâce (ID: `keyterm:Favor`); adjuration (ID: `keyterm:Oath`); faire un voeu (ID: `keyterm:Vow`); ardeur (ID: `keyterm:Ardour`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); laissiez en possession (ID: `keyterm:Possess`); sans saleté (ID: `keyterm:Pure`); Hell (ID: `place:Hell`); securité (ID: `keyterm:Safety`); agir par méchanceté (ID: `keyterm:ActWickedly`); saint (ID: `keyterm:Holy`); An Angel (ID: `deity:Angel`); jurer (ID: `keyterm:Swear`); être attiré à servir (ID: `keyterm:EnticedToServe`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); House (ID: `realia:House`); vérité (ID: `keyterm:Truth`); droiture (ID: `keyterm:Straightness`); proverbe (ID: `keyterm:Saying`); la connaissance (ID: `keyterm:Intention`); Caper (ID: `flora:Caper`); Goad (ID: `realia:Goad`); Sheep (ID: `fauna:Lamb`); Clay Jar (ID: `realia:ClayJar`); Locust (ID: `fauna:Locust`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Pit (ID: `realia:Pit`); Money (ID: `realia:Money`); Almond (ID: `flora:Almond`); Nail (ID: `realia:Nail`); Scroll (ID: `realia:Scroll`); Bird (ID: `fauna:Bird`); Rope (ID: `realia:Rope`)
