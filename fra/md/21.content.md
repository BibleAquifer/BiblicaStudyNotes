...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); stupide (ID: `keyterm:Stupid`); pécher (ID: `keyterm:Sin`); la connaissance (ID: `keyterm:Intention`); aimer (ID: `keyterm:Love`); craindre (ID: `keyterm:Fear`); Jérusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); gloire (ID: `keyterm:Glory`); adjuration (ID: `keyterm:Oath`); force (ID: `keyterm:Strength`); ardeur (ID: `keyterm:Ardour`); grâce (ID: `keyterm:Favor`); A Man (ID: `person:GenericMale`); faire un voeu (ID: `keyterm:Vow`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); Anointing Oil (ID: `realia:AnointingOil`); Hell (ID: `place:Hell`); laissiez en possession (ID: `keyterm:Possess`); jurer (ID: `keyterm:Swear`); stupidité (ID: `keyterm:Stupidity`); tuerie (ID: `keyterm:Slaughtering`); agir par méchanceté (ID: `keyterm:ActWickedly`); état intact (ID: `keyterm:IntactState`); sans saleté (ID: `keyterm:Pure`); securité (ID: `keyterm:Safety`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); House (ID: `realia:House`); vérité (ID: `keyterm:Truth`); la connaissance (ID: `keyterm:Intention`); droiture (ID: `keyterm:Straightness`); proverbe (ID: `keyterm:Saying`); Goad (ID: `realia:Goad`); Caper (ID: `flora:Caper`); Bird (ID: `fauna:Bird`); Money (ID: `realia:Money`); Scroll (ID: `realia:Scroll`); Pit (ID: `realia:Pit`); Rope (ID: `realia:Rope`); Goat (ID: `fauna:Goat`); Locust (ID: `fauna:Locust`); Sheep (ID: `fauna:Lamb`); Clay Jar (ID: `realia:ClayJar`); Nail (ID: `realia:Nail`); Almond (ID: `flora:Almond`); Flock (ID: `fauna:Flock`)
