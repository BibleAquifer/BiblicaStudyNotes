...
* **Associated ACAI Concepts:** stupide (ID: `keyterm:Stupid`); la connaissance (ID: `keyterm:Intention`); capacité (ID: `keyterm:Ability`); pécher (ID: `keyterm:Sin`); aimer (ID: `keyterm:Love`); craindre (ID: `keyterm:Fear`); House (ID: `realia:House`); Éternel (ID: `deity:Lord`)
