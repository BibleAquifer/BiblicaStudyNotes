...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Kiljon (ID: `person:Chilion`); Orpa (ID: `person:Orpah`); Machlon (ID: `person:Mahlon`); Élimélec (ID: `person:Elimelech`); Women (ID: `group:GenericFemales`); Éphrata (ID: `person:Ephrathah`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); charger (ID: `keyterm:Appoint`); espoir (ID: `keyterm:Hope`); bonté (ID: `keyterm:Kindness`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Boaz (ID: `person:Boaz`); Barley (ID: `flora:Barley`); Naomi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); Éternel (ID: `deity:Lord`); grâce (ID: `keyterm:Favor`); benir (ID: `keyterm:Bless`); Élimélec (ID: `person:Elimelech`); Sickle (ID: `realia:Sickle`); se réfugier (ID: `keyterm:SeekfindRefuge`); Bethléhem (ID: `place:Bethlehem`); Israël (ID: `person:Israel`); bonté (ID: `keyterm:Kindness`); Wheat (ID: `flora:Wheat`); Ephah (ID: `realia:Ephah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Boaz (ID: `person:Boaz`); Naomi (ID: `person:Naomi`); Éternel (ID: `deity:Lord`); Ruth (ID: `person:Ruth`); acheter (ID: `keyterm:Redeem`); Obed (ID: `person:Obed`); Threshing Floor (ID: `realia:ThreshingFloor`); Israël (ID: `person:Israel`); Moab (ID: `place:Moab`); laissiez en possession (ID: `keyterm:Possess`); Kinsman Redeemer (ID: `person:KinsmanRedeemer`); Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Barley (ID: `flora:Barley`); Isaï (ID: `person:Jesse`); Machlon (ID: `person:Mahlon`); Élimélec (ID: `person:Elimelech`); David (ID: `person:David`); Perets (ID: `person:Perez`); Amminadab (ID: `person:Amminadab`); benir (ID: `keyterm:Bless`); Women (ID: `group:GenericFemales`); Ram (ID: `person:Ram`); Kiljon (ID: `person:Chilion`); aimer (ID: `keyterm:Love`); Tamar (ID: `person:Tamar`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Léa (ID: `person:Leah`); Bethléhem (ID: `place:Bethlehem`); Rachel (ID: `person:Rachel`); bonté (ID: `keyterm:Kindness`); Elders (ID: `group:GenericElders`); craindre (ID: `keyterm:Fear`); Nahshon (ID: `person:Nahshon`)
