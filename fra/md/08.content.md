...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Orpa (ID: `person:Orpah`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Kiljon (ID: `person:Chilion`); Machlon (ID: `person:Mahlon`); Élimélec (ID: `person:Elimelech`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Women (ID: `group:GenericFemales`); Éphrata (ID: `person:Ephrathah`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Boaz (ID: `person:Boaz`); Naomi (ID: `person:Naomi`); Barley (ID: `flora:Barley`); Ruth (ID: `person:Ruth`)
...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Boaz (ID: `person:Boaz`); Kinsman Redeemer (ID: `person:KinsmanRedeemer`); Ruth (ID: `person:Ruth`); Obed (ID: `person:Obed`); Salmon (ID: `person:Salmon`); Women (ID: `group:GenericFemales`); Hetsron (ID: `person:Hezron.2`); Kiljon (ID: `person:Chilion`); Ram (ID: `person:Ram`); Éternel (ID: `deity:Lord`)
