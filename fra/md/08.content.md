...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Orpa (ID: `person:Orpah`); Kiljon (ID: `person:Chilion`); Machlon (ID: `person:Mahlon`); Élimélec (ID: `person:Elimelech`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); Women (ID: `group:GenericFemales`); Éphrata (ID: `person:Ephrathah`); bonté (ID: `keyterm:Kindness`); charger (ID: `keyterm:Appoint`); espoir (ID: `keyterm:Hope`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Boaz (ID: `person:Boaz`); Barley (ID: `flora:Barley`); Naomi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); grâce (ID: `keyterm:Favor`); benir (ID: `keyterm:Bless`); Éternel (ID: `deity:Lord`); Moab (ID: `place:Moab`); Élimélec (ID: `person:Elimelech`); Sickle (ID: `realia:Sickle`); bonté (ID: `keyterm:Kindness`); Israël (ID: `person:Israel`); Bethléhem (ID: `place:Bethlehem`); se réfugier (ID: `keyterm:SeekfindRefuge`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Ephah (ID: `realia:Ephah`)
...
* **Associated ACAI Concepts:** Boaz (ID: `person:Boaz`); Naomi (ID: `person:Naomi`); Éternel (ID: `deity:Lord`); Ruth (ID: `person:Ruth`); acheter (ID: `keyterm:Redeem`); Obed (ID: `person:Obed`); Threshing Floor (ID: `realia:ThreshingFloor`); laissiez en possession (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Israël (ID: `person:Israel`); Kinsman Redeemer (ID: `person:KinsmanRedeemer`); Salmon (ID: `person:Salmon`); Hetsron (ID: `person:Hezron.2`); Barley (ID: `flora:Barley`); Machlon (ID: `person:Mahlon`); Perets (ID: `person:Perez`); benir (ID: `keyterm:Bless`); David (ID: `person:David`); Élimélec (ID: `person:Elimelech`); Isaï (ID: `person:Jesse`); Amminadab (ID: `person:Amminadab`); Ram (ID: `person:Ram`); Women (ID: `group:GenericFemales`); Kiljon (ID: `person:Chilion`); Rachel (ID: `person:Rachel`); aimer (ID: `keyterm:Love`); Juda (ID: `person:Judah.4`); Tamar (ID: `person:Tamar`); Bethléhem (ID: `place:Bethlehem`); Nahshon (ID: `person:Nahshon`); craindre (ID: `keyterm:Fear`); Elders (ID: `group:GenericElders`); bonté (ID: `keyterm:Kindness`); Léa (ID: `person:Leah`); Juda (ID: `group:Judah`)
