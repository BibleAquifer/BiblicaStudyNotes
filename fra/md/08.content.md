...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Orpa (ID: `person:Orpah`); Kiljon (ID: `person:Chilion`); Machlon (ID: `person:Mahlon`); Élimélec (ID: `person:Elimelech`); Women (ID: `group:GenericFemales`); Éphrata (ID: `person:Ephrathah`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); bonté (ID: `keyterm:Kindness`); charger (ID: `keyterm:Appoint`); espoir (ID: `keyterm:Hope`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Boaz (ID: `person:Boaz`); Barley (ID: `flora:Barley`); Naomi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); benir (ID: `keyterm:Bless`); grâce (ID: `keyterm:Favor`); Éternel (ID: `deity:Lord`); Moab (ID: `place:Moab`); Élimélec (ID: `person:Elimelech`); Sickle (ID: `realia:Sickle`); bonté (ID: `keyterm:Kindness`); se réfugier (ID: `keyterm:SeekfindRefuge`); Bethléhem (ID: `place:Bethlehem`); Israël (ID: `person:Israel`); Wheat (ID: `flora:Wheat`); House (ID: `realia:House`); Ephah (ID: `realia:Ephah`)
...
* **Associated ACAI Concepts:** Boaz (ID: `person:Boaz`); Naomi (ID: `person:Naomi`); Éternel (ID: `deity:Lord`); Ruth (ID: `person:Ruth`); acheter (ID: `keyterm:Redeem`); Obed (ID: `person:Obed`); Threshing Floor (ID: `realia:ThreshingFloor`); laissiez en possession (ID: `keyterm:Possess`); Moab (ID: `place:Moab`); Israël (ID: `person:Israel`); Kinsman Redeemer (ID: `person:KinsmanRedeemer`); Salmon (ID: `person:Salmon`); Hetsron (ID: `person:Hezron.2`); Barley (ID: `flora:Barley`); Élimélec (ID: `person:Elimelech`); benir (ID: `keyterm:Bless`); Machlon (ID: `person:Mahlon`); Amminadab (ID: `person:Amminadab`); Isaï (ID: `person:Jesse`); David (ID: `person:David`); Perets (ID: `person:Perez`); Women (ID: `group:GenericFemales`); Kiljon (ID: `person:Chilion`); Ram (ID: `person:Ram`); Léa (ID: `person:Leah`); aimer (ID: `keyterm:Love`); Nahshon (ID: `person:Nahshon`); bonté (ID: `keyterm:Kindness`); Elders (ID: `group:GenericElders`); Tamar (ID: `person:Tamar`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); craindre (ID: `keyterm:Fear`); Rachel (ID: `person:Rachel`)
