...
* **Associated Passages:** Ruth 1.1-22
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Bethléhem (ID: `place:Bethlehem`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Kiljon (ID: `person:Chilion`); Orpa (ID: `person:Orpah`); Élimélec (ID: `person:Elimelech`); Machlon (ID: `person:Mahlon`); Women (ID: `group:GenericFemales`); Éphrata (ID: `person:Ephrathah`); Èfratite; d'Èfrata (ID: `group:Ephrathah`); charger (ID: `keyterm:Appoint`); bonté (ID: `keyterm:Kindness`); espoir (ID: `keyterm:Hope`); Barley (ID: `flora:Barley`)
...
* **Associated Passages:** Ruth 2.1-23
...
* **Associated ACAI Concepts:** Boaz (ID: `person:Boaz`); Barley (ID: `flora:Barley`); Naomi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); grâce (ID: `keyterm:Favor`); Éternel (ID: `deity:Lord`); Moab (ID: `place:Moab`); benir (ID: `keyterm:Bless`); Élimélec (ID: `person:Elimelech`); Sickle (ID: `realia:Sickle`); se réfugier (ID: `keyterm:SeekfindRefuge`); Israël (ID: `person:Israel`); bonté (ID: `keyterm:Kindness`); Bethléhem (ID: `place:Bethlehem`); House (ID: `realia:House`); Wheat (ID: `flora:Wheat`); Ephah (ID: `realia:Ephah`)
...
* **Associated Passages:** Ruth 3.1-4.22
...
* **Associated ACAI Concepts:** Boaz (ID: `person:Boaz`); Naomi (ID: `person:Naomi`); Éternel (ID: `deity:Lord`); Ruth (ID: `person:Ruth`); acheter (ID: `keyterm:Redeem`); Obed (ID: `person:Obed`); Threshing Floor (ID: `realia:ThreshingFloor`); laissiez en possession (ID: `keyterm:Possess`); Israël (ID: `person:Israel`); Moab (ID: `place:Moab`); Kinsman Redeemer (ID: `person:KinsmanRedeemer`); Hetsron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Barley (ID: `flora:Barley`); Isaï (ID: `person:Jesse`); benir (ID: `keyterm:Bless`); David (ID: `person:David`); Perets (ID: `person:Perez`); Machlon (ID: `person:Mahlon`); Élimélec (ID: `person:Elimelech`); Amminadab (ID: `person:Amminadab`); Kiljon (ID: `person:Chilion`); Women (ID: `group:GenericFemales`); Ram (ID: `person:Ram`); bonté (ID: `keyterm:Kindness`); craindre (ID: `keyterm:Fear`); Juda (ID: `group:Judah`); Nahshon (ID: `person:Nahshon`); Rachel (ID: `person:Rachel`); Elders (ID: `group:GenericElders`); Léa (ID: `person:Leah`); Tamar (ID: `person:Tamar`); Juda (ID: `person:Judah.4`); Bethléhem (ID: `place:Bethlehem`); aimer (ID: `keyterm:Love`)
