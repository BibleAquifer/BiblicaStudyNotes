...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); Sisera (ID: `person:Sisera`); Barak (ID: `person:Barak`); Débora (ID: `person:Deborah.2`); Éhud (ID: `person:Ehud`); Jaël (ID: `person:Jael`); Moab (ID: `place:Moab`); Jabin (ID: `person:Jabin.2`); Héber (ID: `person:Heber.2`); Abinoam (ID: `person:Abinoam`); Églon (ID: `person:Eglon`); Chariot (ID: `realia:Chariot`); Tent (ID: `realia:Tent`); Kédesch (ID: `place:Kedesh`); Zabulon (ID: `person:Zebulun`); Canaan (ID: `place:Canaan`); Zabulon (ID: `group:Zebulun`); Sword (ID: `realia:Sword`); Haroscheth-Goïm (ID: `place:Harosheth-hagoyim`); mont Thabor (ID: `place:TaborMount`); Kison (ID: `place:Kishon`); Kenites (ID: `group:Kenite`); être attiré à servir (ID: `keyterm:EnticedToServe`); Nephthali (ID: `person:Naphtali`); Nephthali (ID: `group:Naphtali`); offrande (ID: `keyterm:Offering`); benir (ID: `keyterm:Bless`); Éphraïm (ID: `group:Ephraim`); Éphraïm (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Gédéon (ID: `person:Gideon`); Éternel (ID: `deity:Lord`); Abimélec (ID: `person:Abimelech.2`); Madian (ID: `place:Midian`); Israël (ID: `person:Israel`); Sichem (ID: `place:Shechem`); Gaal (ID: `person:Gaal`); Yoash (ID: `person:Joash`); Tsalmunna (ID: `person:Zalmunna`); Zébach (ID: `person:Zebah`); An Angel (ID: `deity:Angel`); Ophra (ID: `place:Ophrah.2`); Zebul (ID: `person:Zebul`); Ébed (ID: `person:Ebed`); Baal (ID: `deity:Baal`); Succoth (ID: `place:Succoth`); craindre (ID: `keyterm:Fear`); Abiézer (ID: `person:Abiezer`); Jotham (ID: `person:Jotham`); Ashéra (ID: `deity:Asherah`); l'orient (ID: `place:East`); Tower (ID: `realia:Tower`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Rams Horn (ID: `realia:RamsHorn`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); abiézrite (ID: `group:Abiezer`); Égypte (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Ammon (ID: `place:Ammon`); Amos (ID: `group:Ammon`); Jephthé (ID: `person:Jephthah`); Éternel (ID: `deity:Lord`); Galaad (ID: `place:Gilead`); Éphraïm (ID: `group:Ephraim`); Éphraïm (ID: `person:Ephraim`); Jourdain (ID: `place:Jordan`); Amorites (ID: `group:Amorites`); Moab (ID: `place:Moab`); An Angel (ID: `deity:Angel`); Arnon (ID: `place:Arnon`); Mizpah (ID: `place:Mizpah.2`); être attiré à servir (ID: `keyterm:EnticedToServe`); Galaadite (ID: `group:Gilead`); déposséder (ID: `keyterm:Dispossess`); Égypte (ID: `place:Egypt`); Philistins (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); Sihon (ID: `person:Sihon`); pécher (ID: `keyterm:Sin`); Galaad (ID: `person:Gilead.2`); Abdon (ID: `person:Abdon`); Hillel (ID: `person:Hillel`); Schamir (ID: `place:Shamir.2`); Jaïr (ID: `person:Jair.3`); Élon (ID: `person:Elon.3`); Ibtsan (ID: `person:Ibzan`); Zabulon (ID: `group:Zebulun`)
...
* **Associated ACAI Concepts:** Samson (ID: `person:Samson`); Éternel (ID: `deity:Lord`); Philistins (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); Manoach (ID: `person:Manoah`); An Angel (ID: `deity:Angel`); Delila (ID: `person:Delilah`); force (ID: `keyterm:Strength`); Israël (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Tsorea (ID: `place:Zorah`); Léchi (ID: `place:Lehi`); Nazirites (ID: `group:Nazirite`); offrande (ID: `keyterm:Offering`); Gaza (ID: `place:Gaza`); Juda (ID: `group:Judah`); pollution (ID: `keyterm:Defilement`); Juda (ID: `person:Judah.4`); Thimna (ID: `place:Timnah`); aimer (ID: `keyterm:Love`); Goat (ID: `fauna:Goat`); Lion (ID: `fauna:Lion`); Rope (ID: `realia:Rope`); Kid (ID: `fauna:Kid`); Manoah's Wife (ID: `person:WifeOfManoah`); Iyé-Avarim (ID: `place:Etam`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Eschthaol (ID: `place:Eshtaol`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Micah (ID: `person:Micah.3`); Dan (ID: `place:Dan`); Dan (ID: `group:Dan`); Éternel (ID: `deity:Lord`); House (ID: `realia:House`); Lévi (ID: `group:Levi`); Lévi (ID: `person:Levi.3`); théraphim (ID: `deity:Teraphim`); Graven Image (ID: `realia:GravenImage`); Household Idols (ID: `realia:HouseholdIdols`); Molten Image (ID: `realia:MoltenImage`); Ephod (ID: `realia:Ephod`); Éphraïm (ID: `person:Ephraim`); Éphraïm (ID: `group:Ephraim`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Israël (ID: `person:Israel`); Eschthaol (ID: `place:Eshtaol`); Money (ID: `realia:Money`); A Person (ID: `person:GenericPerson`); s'appuyer sur (ID: `keyterm:LeanOn`); Tsorea (ID: `place:Zorah`); Bethléhem (ID: `place:Bethlehem`); Mother of Micah (ID: `person:MotherOfMicah.3`); Sidon (ID: `place:Sidon`); état intact (ID: `keyterm:IntactState`); déposséder (ID: `keyterm:Dispossess`); Mahané-Dân (ID: `place:Mahaneh-dan`); Guershom (ID: `person:Gershom`); Military Members (ID: `group:MilitaryMembers`); Jonathan (ID: `person:Jonathan.2`); Beth-Rehob (ID: `place:Beth-rehob`); laissiez en possession (ID: `keyterm:Possess`); Kirjath-Jearim (ID: `place:Kiriath-jearim`); pleurer (ID: `keyterm:Curse`); benir (ID: `keyterm:Bless`); Shiloh (ID: `place:Shiloh`); Moïse (ID: `person:Moses`); securité (ID: `keyterm:Safety`); saint (ID: `keyterm:Holy`); Sidonien (ID: `group:Sidon`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** Israël (ID: `person:Israel`); Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`); Gibeah (ID: `place:Gibeah.2`); Éternel (ID: `deity:Lord`); Jabès en Galaad (ID: `place:Jabesh-gilead`); Mitspa (ID: `place:Mizpah`); Bethel (ID: `place:Bethel`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); laissiez en possession (ID: `keyterm:Possess`); A Father (ID: `person:GenericFather`); Juda (ID: `group:Judah`); insensé (ID: `keyterm:Foolish`); Juda (ID: `person:Judah.4`); Donkey (ID: `fauna:Donkey`); Rock of Rimmon (ID: `place:Rimmon.3`); Éphraïm (ID: `person:Ephraim`); Éphraïm (ID: `group:Ephraim`); jurer (ID: `keyterm:Swear`); Shiloh (ID: `place:Shiloh`); Bethléhem (ID: `place:Bethlehem`); offrande (ID: `keyterm:Offering`); A Man (ID: `person:GenericMale`); Jérusalem (ID: `place:Jerusalem`); Lévi (ID: `group:Levi`); méchanceté (ID: `keyterm:Wickedness`); Lévi (ID: `person:Levi.3`); état intact (ID: `keyterm:IntactState`); Vine (ID: `flora:Vine`)
