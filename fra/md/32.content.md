...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Ninive (ID: `place:Nineveh`); craindre (ID: `keyterm:Fear`); parole du seigneur (ID: `keyterm:WordOfTheLord`); Ship (ID: `realia:Ship`); Fish (ID: `fauna:Fish`); Sackcloth (ID: `realia:Sackcloth`); Hell (ID: `place:Hell`); faire un voeu (ID: `keyterm:Vow`); Amitthaï (ID: `person:Amittai`); Joppa (ID: `place:Joppa`); Cattle (ID: `fauna:Bull`); aide (ID: `keyterm:Salvation`); bonté (ID: `keyterm:Kindness`); tuerie (ID: `keyterm:Slaughtering`); exempt (ID: `keyterm:Exempt`); Tarsis (ID: `place:Tarshish`); fie (ID: `keyterm:BelieveIn`); louange (ID: `keyterm:Praise`); Hebrews (ID: `group:Hebrews`); destin (ID: `keyterm:Lot`); Goat (ID: `fauna:Goat`); Clothing (ID: `realia:Clothing`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); bonté (ID: `keyterm:Kindness`); bienveillant (ID: `keyterm:Generous`); Tarsis (ID: `place:Tarshish`); miséricordieux (ID: `keyterm:Compassionate`); Ninive (ID: `place:Nineveh`); Worm (ID: `fauna:Maggot`); Cattle (ID: `fauna:Bull`)
