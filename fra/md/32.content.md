...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Ninive (ID: `place:Nineveh`); parole du seigneur (ID: `keyterm:WordOfTheLord`); craindre (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Sackcloth (ID: `realia:Sackcloth`); Fish (ID: `fauna:Fish`); Hell (ID: `place:Hell`); faire un voeu (ID: `keyterm:Vow`); Amitthaï (ID: `person:Amittai`); Joppa (ID: `place:Joppa`); Cattle (ID: `fauna:Bull`); exempt (ID: `keyterm:Exempt`); louange (ID: `keyterm:Praise`); Hebrews (ID: `group:Hebrews`); tuerie (ID: `keyterm:Slaughtering`); fie (ID: `keyterm:BelieveIn`); destin (ID: `keyterm:Lot`); aide (ID: `keyterm:Salvation`); Tarsis (ID: `place:Tarshish`); bonté (ID: `keyterm:Kindness`); Goat (ID: `fauna:Goat`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Cattails (ID: `flora:Cattails`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jonas (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Ninive (ID: `place:Nineveh`); bienveillant (ID: `keyterm:Generous`); miséricordieux (ID: `keyterm:Compassionate`); Tarsis (ID: `place:Tarshish`); bonté (ID: `keyterm:Kindness`); Cattle (ID: `fauna:Bull`); Worm (ID: `fauna:Maggot`)
