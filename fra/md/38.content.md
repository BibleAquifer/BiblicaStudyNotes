...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Jérusalem (ID: `place:Jerusalem`); parole du seigneur (ID: `keyterm:WordOfTheLord`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); Josué (ID: `person:Joshua.5`); état intact (ID: `keyterm:IntactState`); vérité (ID: `keyterm:Truth`); House (ID: `realia:House`); Zacharie (ID: `person:Zechariah.17`); Zorobabel (ID: `person:Zerubbabel.2`); ardeur (ID: `keyterm:Ardour`); colline (ID: `keyterm:Horn`); Darius (ID: `person:Darius.2`); prier (ID: `keyterm:AskFor`); Horse (ID: `fauna:Horse`); Olive Tree (ID: `flora:OliveTree`); Josias (ID: `person:Josiah.2`); Yedaya (ID: `person:Jedaiah.6`); Iddo (ID: `person:Iddo.6`); Bérékia (ID: `person:Berechiah.6`); Sophonie (ID: `person:Zephaniah.4`); Tobija (ID: `person:Tobijah.2`); Heldaï (ID: `person:Heldai`); Satan (ID: `deity:Satan`); être zélé (ID: `keyterm:Zealous`); Come On! (ID: `keyterm:ComeOn`); Israël (ID: `person:Israel`); Babylone (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); David (ID: `person:David`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Égypte (ID: `place:Egypt`); House (ID: `realia:House`); Horse (ID: `fauna:Horse`); Money (ID: `realia:Money`); fourré (ID: `keyterm:FeastOfTabernacles`); parole du seigneur (ID: `keyterm:WordOfTheLord`); Israël (ID: `person:Israel`); Éphraïm (ID: `group:Ephraim`); Éphraïm (ID: `person:Ephraim`); peste (ID: `keyterm:Blow`); Liban (ID: `place:Lebanon`); Tyr (ID: `place:Tyre`); parler (ID: `keyterm:Speak`); alliance (ID: `keyterm:Covenant`); Assyria (ID: `place:Assyria`); Ékron (ID: `place:Ekron`); charger (ID: `keyterm:Appoint`); Utterance (ID: `keyterm:Utterance`); Bow (ID: `realia:Bow`); Sword (ID: `realia:Sword`); Rod (ID: `realia:Rod`); Staff (ID: `realia:Staff`)
