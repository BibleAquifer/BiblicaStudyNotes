...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Jérusalem (ID: `place:Jerusalem`); parole du seigneur (ID: `keyterm:WordOfTheLord`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); Josué (ID: `person:Joshua.5`); état intact (ID: `keyterm:IntactState`); vérité (ID: `keyterm:Truth`); House (ID: `realia:House`); Zacharie (ID: `person:Zechariah.17`); Zorobabel (ID: `person:Zerubbabel.2`); ardeur (ID: `keyterm:Ardour`); colline (ID: `keyterm:Horn`); prier (ID: `keyterm:AskFor`); Darius (ID: `person:Darius.2`); Horse (ID: `fauna:Horse`); Olive Tree (ID: `flora:OliveTree`); Yedaya (ID: `person:Jedaiah.6`); Josias (ID: `person:Josiah.2`); Bérékia (ID: `person:Berechiah.6`); Iddo (ID: `person:Iddo.6`); Sophonie (ID: `person:Zephaniah.4`); Tobija (ID: `person:Tobijah.2`); Heldaï (ID: `person:Heldai`); Satan (ID: `deity:Satan`); gloire (ID: `keyterm:Glory`); aimer (ID: `keyterm:Love`); Israël (ID: `person:Israel`); Come On! (ID: `keyterm:ComeOn`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); David (ID: `person:David`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Horse (ID: `fauna:Horse`); House (ID: `realia:House`); Égypte (ID: `place:Egypt`); Money (ID: `realia:Money`); fourré (ID: `keyterm:FeastOfTabernacles`); peste (ID: `keyterm:Blow`); Israël (ID: `person:Israel`); parole du seigneur (ID: `keyterm:WordOfTheLord`); Éphraïm (ID: `group:Ephraim`); Éphraïm (ID: `person:Ephraim`); Utterance (ID: `keyterm:Utterance`); Assyria (ID: `place:Assyria`); Ékron (ID: `place:Ekron`); charger (ID: `keyterm:Appoint`); alliance (ID: `keyterm:Covenant`); Liban (ID: `place:Lebanon`); parler (ID: `keyterm:Speak`); Tyr (ID: `place:Tyre`); Bow (ID: `realia:Bow`); Sword (ID: `realia:Sword`); Vine (ID: `flora:Vine`); Staff (ID: `realia:Staff`)
