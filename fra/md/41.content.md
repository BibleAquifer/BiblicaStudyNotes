...
* **Associated ACAI Concepts:** Jean (ID: `person:John`); baptême (ID: `keyterm:Baptism`); Jésus (ID: `person:Jesus.2`); bonnes nouvelles (ID: `keyterm:GoodNews`); proclamer (ID: `keyterm:Proclaim`); Éternel (ID: `deity:Lord`); Saint-Esprit (ID: `deity:HolySpirit`); Jourdain (ID: `place:Jordan`); Galilée (ID: `place:Galilee`); Zébédée (ID: `person:Zebedee`); pécher (ID: `keyterm:Sin`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); se repentir (ID: `keyterm:Repent`); An Angel (ID: `deity:Angel`); Ship (ID: `realia:Ship`); Casting Net (ID: `realia:CastingNet`); Fishnet (ID: `realia:Fishnet`); Sea of Galilee (ID: `place:GalileeSea`); travailleur employé (ID: `keyterm:HiredWorker`); Jacques (ID: `person:James`); Jean (ID: `person:John.2`); Judée (ID: `place:Judea`); pardonner (ID: `keyterm:Forgive`); croire (ID: `keyterm:Believe`); droiture (ID: `keyterm:Straightness`); Ésaïe (ID: `person:Isaiah`); mis à l'essai (ID: `keyterm:PutToTheTest`); Satan (ID: `deity:Satan`); Pierre (ID: `person:Peter`); Nazareth (ID: `place:Nazareth`); Jérusalem (ID: `place:Jerusalem`); servir (ID: `keyterm:Serve`); régne (ID: `keyterm:Kingdom`); bien, aimé (ID: `keyterm:Beloved`); André (ID: `person:Andrew`); Strap (ID: `realia:Strap`); Bag (ID: `realia:Bag`); Belt (ID: `realia:Belt`); Dove (ID: `fauna:Dove`); Bee (ID: `fauna:Bee`); Camel (ID: `fauna:Camel`); Locust (ID: `fauna:Locust`); Sandal (ID: `realia:Sandal`); Leather (ID: `realia:Leather`)
...
* **Associated ACAI Concepts:** purifier (ID: `keyterm:Cleanse.2`); Synagogue (ID: `realia:Synagogue`); Pierre (ID: `person:Peter`); proclamer (ID: `keyterm:Proclaim`); Galilée (ID: `place:Galilee`); capacité (ID: `keyterm:Ability`); Demons (ID: `deity:Demons`); autorité (ID: `keyterm:Authority.2`); servir (ID: `keyterm:Serve`); Jésus (ID: `person:Jesus.2`); Capernaüm (ID: `place:Capernaum`); être possédé par un démon (ID: `keyterm:DemonPossessed`); Jean (ID: `person:John.2`); prescrire (ID: `keyterm:Command`); témoigner (ID: `keyterm:BearWitness`); sabbat (ID: `keyterm:Sabbath`); Jacques (ID: `person:James`); Éternel (ID: `deity:Lord`); Moïse (ID: `person:Moses`); Nazareth (ID: `place:Nazareth`); prier (ID: `keyterm:AskFor`); lèpre (ID: `keyterm:InfectiousSkinDisease`); prier (ID: `keyterm:Pray`); saint (ID: `keyterm:Holy`); offrande (ID: `keyterm:Offering`); André (ID: `person:Andrew`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); pécher (ID: `keyterm:Sin`); pardonner (ID: `keyterm:Forgive`); Bed (ID: `realia:Bed`); jeûner (ID: `keyterm:Fast`); trans. faire un disciple de (ID: `keyterm:Disciple`); House (ID: `realia:House`); collecteur d'impôt (ID: `keyterm:TaxCollector`); coeur (ID: `keyterm:Heart`); Éternel (ID: `deity:Lord`); Pharisien (ID: `group:Pharisee`); Temple (ID: `realia:Temple`); Matthieu (ID: `person:Matthew`); Alphée (ID: `person:Alphaeus.2`); Capernaüm (ID: `place:Capernaum`); gloire (ID: `keyterm:Glory`); croire (ID: `keyterm:Believe`); capacité (ID: `keyterm:Ability`); Jean (ID: `person:John`); autorité (ID: `keyterm:Authority.2`); être juste (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); Be Healthy (ID: `keyterm:Healthy`); bureau de perception (ID: `keyterm:TaxOffice`); esprit (ID: `keyterm:Spirit.2`); Skin-Bottle (ID: `realia:Skin-bottle`); Patch (ID: `realia:Patch`); Housetop (ID: `realia:Housetop`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** sabbat (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); Pharisien (ID: `group:Pharisee`); les partisans d'Hérode; Hérodiens (ID: `group:Herodian`); Abiathar (ID: `person:Abiathar`); servir (ID: `keyterm:Serve`); David (ID: `person:David`); trans. faire un disciple de (ID: `keyterm:Disciple`); aide (ID: `keyterm:Salvation`); vie (ID: `keyterm:Life`); coeur (ID: `keyterm:Heart`); Éternel (ID: `deity:Lord`); Wheat (ID: `flora:Wheat`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`); House (ID: `realia:House`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** trans. faire un disciple de (ID: `keyterm:Disciple`); nom (ID: `keyterm:Name`); Barthélemy (ID: `person:Bartholomew`); Jean (ID: `person:John.2`); Alphée (ID: `person:Alphaeus`); Jacques (ID: `person:James.2`); Jacques (ID: `person:James`); zélote; nationaliste (ID: `group:Zealot`); Idumée (ID: `place:Idumea`); Matthieu (ID: `person:Matthew`); Judée (ID: `place:Judea`); prescrire (ID: `keyterm:Command`); Galilée (ID: `place:Galilee`); Thomas (ID: `person:Thomas`); Tyr (ID: `place:Tyre`); Zébédée (ID: `person:Zebedee`); capacité (ID: `keyterm:Ability`); Judas (ID: `person:Judas.2`); Jourdain (ID: `place:Jordan`); Judas (ID: `person:Judas`); Pierre (ID: `person:Peter`); Jérusalem (ID: `place:Jerusalem`); Sidon (ID: `place:Sidon`); Demons (ID: `deity:Demons`); autorité (ID: `keyterm:Authority.2`); Simon (ID: `person:Simon.2`); servir (ID: `keyterm:Serve`); Jésus (ID: `person:Jesus.2`); Philippe (ID: `person:Philip`); proclamer (ID: `keyterm:Proclaim`); André (ID: `person:Andrew`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Satan (ID: `deity:Satan`); parler contre dieu (ID: `keyterm:Blaspheme`); pardonner (ID: `keyterm:Forgive`); pécher (ID: `keyterm:Sin`); House (ID: `realia:House`); Jérusalem (ID: `place:Jerusalem`); sûrement! (ID: `keyterm:Surely`); éternellement (ID: `keyterm:Always`); Demons (ID: `deity:Demons`); régne (ID: `keyterm:Kingdom`); parabole (ID: `keyterm:Parable`); Éternel (ID: `deity:Lord`); Religious Officials (ID: `group:ReligiousOfficials`); Saint-Esprit (ID: `deity:HolySpirit`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** parabole (ID: `keyterm:Parable`); Grain (ID: `flora:Grain`); Éternel (ID: `deity:Lord`); régne (ID: `keyterm:Kingdom`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Barley (ID: `flora:Barley`); Grass (ID: `flora:Grass`); Cause of Joy (ID: `keyterm:CauseOfJoy`); pardonner (ID: `keyterm:Forgive`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Satan (ID: `deity:Satan`); prier (ID: `keyterm:AskFor`); trans. faire un disciple de (ID: `keyterm:Disciple`); éternellement (ID: `keyterm:Always`); Mustard (ID: `flora:Mustard`); Wheat (ID: `flora:Wheat`); Bird (ID: `fauna:Bird`); Bed (ID: `realia:Bed`); Rooster (ID: `fauna:Rooster`); Ship (ID: `realia:Ship`); Sickle (ID: `realia:Sickle`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** prier (ID: `keyterm:AskFor`); Jésus (ID: `person:Jesus.2`); être possédé par un démon (ID: `keyterm:DemonPossessed`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); Ship (ID: `realia:Ship`); Grave (ID: `realia:Grave`); Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); Chain (ID: `realia:Chain`); prescrire (ID: `keyterm:Command`); Décapole (ID: `place:Decapolis`); Légion (ID: `deity:Legion`); Gerasa (ID: `place:Gerasa`); adorer (ID: `keyterm:BowDown`); croire (ID: `keyterm:Believe`); être silencieux ou calme (ID: `keyterm:BecomeStill`); pitié (ID: `keyterm:Mercy`); autorité (ID: `keyterm:Authority.2`); nom (ID: `keyterm:Name`); proclamer (ID: `keyterm:Proclaim`); Cushion (ID: `realia:Cushion`); Fetter (ID: `realia:Fetter`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); aide (ID: `keyterm:Salvation`); Cloak (ID: `realia:Cloak`); croire (ID: `keyterm:Believe`); craindre (ID: `keyterm:Fear`); Jaïrus (ID: `person:Jairus`); Jean (ID: `person:John.2`); capacité (ID: `keyterm:Ability`); vérité (ID: `keyterm:Truth`); A Group of Disciples (ID: `group:GenericDisciples`); Jacques (ID: `person:James`); corps (ID: `keyterm:Body.3`); Pierre (ID: `person:Peter`); prier (ID: `keyterm:AskFor`); vie (ID: `keyterm:Life`); trans. faire un disciple de (ID: `keyterm:Disciple`); faire la paix (ID: `keyterm:Peace`); nom (ID: `keyterm:Name`); sang (ID: `keyterm:Blood`); House (ID: `realia:House`); Ship (ID: `realia:Ship`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); servir (ID: `keyterm:Serve`); Simon (ID: `person:Simon.3`); Joseph (ID: `person:Joseph.3`); ne pas réussir ou refuser de croire (ID: `keyterm:Disbelieve`); Jude (ID: `person:Jude`); témoigner (ID: `keyterm:BearWitness`); sabbat (ID: `keyterm:Sabbath`); Jacques (ID: `person:James.3`); Marie (ID: `person:Mary`); oint (ID: `keyterm:Anointed`); se repentir (ID: `keyterm:Repent`); Demons (ID: `deity:Demons`); autorité (ID: `keyterm:Authority.2`); Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); proclamer (ID: `keyterm:Proclaim`); Bag (ID: `realia:Bag`); Staff (ID: `realia:Staff`); Olive Oil (ID: `realia:OliveOil`); House (ID: `realia:House`); Belt (ID: `realia:Belt`); Tunic (ID: `realia:Tunic.2`); Sandal (ID: `realia:Sandal`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Hérode Antipas (ID: `person:Herod.2`); Jean (ID: `person:John`); Hérodias (ID: `person:Herodias`); baptême (ID: `keyterm:Baptism`); résurrection (ID: `keyterm:Resurrection`); Plate (ID: `realia:Plate.2`); Prison (ID: `realia:Prison`); Philippe (ID: `person:Philip.2`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Galilée (ID: `place:Galilee`); adjuration (ID: `keyterm:Oath`); capacité (ID: `keyterm:Ability`); sérieux (ID: `keyterm:Haste`); A Group of People (ID: `group:GenericGroup`); Élie (ID: `person:Elijah`); baptiste [jean] (ID: `keyterm:Baptist`); craindre (ID: `keyterm:Fear`); être juste (ID: `keyterm:Just`); Be Lawful (ID: `keyterm:Lawful`); trans. faire un disciple de (ID: `keyterm:Disciple`); saint (ID: `keyterm:Holy`); nom (ID: `keyterm:Name`); régne (ID: `keyterm:Kingdom`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Fish (ID: `fauna:Fish`); trans. faire un disciple de (ID: `keyterm:Disciple`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); Jésus (ID: `person:Jesus.2`); A Group of Disciples (ID: `group:GenericDisciples`); benir (ID: `keyterm:Bless`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Basket (ID: `realia:Basket`); Ship (ID: `realia:Ship`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Grass (ID: `flora:Grass`); Sheep (ID: `fauna:Lamb`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); Bethsaïda (ID: `place:Bethsaida`); Génésareth (ID: `place:Gennesaret`); trans. faire un disciple de (ID: `keyterm:Disciple`); aide (ID: `keyterm:Salvation`); prier (ID: `keyterm:AskFor`); courage! prends courage! bon courage! (ID: `keyterm:CheerUp`); coeur (ID: `keyterm:Heart`); craindre (ID: `keyterm:Fear`); prier (ID: `keyterm:Pray`); Bed (ID: `realia:Bed`); Cloak (ID: `realia:Cloak`); Tassel (ID: `realia:Tassel`)
...
* **Associated ACAI Concepts:** pollution (ID: `keyterm:Defilement`); se rendre (ID: `keyterm:Teaching`); Pharisien (ID: `group:Pharisee`); coeur (ID: `keyterm:Heart`); Éternel (ID: `deity:Lord`); trans. faire un disciple de (ID: `keyterm:Disciple`); commandement (ID: `keyterm:Commandment`); Temple Treasury (ID: `place:Corban`); baptême (ID: `keyterm:Baptism`); adorer (ID: `keyterm:Worship`); marcher (ID: `keyterm:Live.3`); Ésaïe (ID: `person:Isaiah`); Moïse (ID: `person:Moses`); Jérusalem (ID: `place:Jerusalem`); parabole (ID: `keyterm:Parable`); Religious Officials (ID: `group:ReligiousOfficials`); purifier (ID: `keyterm:Cleanse.2`); offrande (ID: `keyterm:Offering`); fornication (ID: `keyterm:Fornication`); parler (ID: `keyterm:Speak`); Jews (ID: `group:Jews`); parler contre dieu (ID: `keyterm:Blaspheme`); Bed (ID: `realia:Bed`); House (ID: `realia:House`); Cooking Pot (ID: `realia:CookingPot`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); Tyr (ID: `place:Tyre`); prier (ID: `keyterm:AskFor`); Dog (ID: `fauna:Dog`); House (ID: `realia:House`); Sidon (ID: `place:Sidon`); Décapole (ID: `place:Decapolis`); Yavanite (ID: `group:Greek`); Phénicie (ID: `place:Phoenicia`); syro-phénicienne (ID: `group:Phoenicia`); Javan (ID: `person:Javan`); bien (ID: `keyterm:Honest`); proclamer (ID: `keyterm:Proclaim`); Sea of Galilee (ID: `place:GalileeSea`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Bed (ID: `realia:Bed`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** trans. faire un disciple de (ID: `keyterm:Disciple`); Basket (ID: `realia:Basket`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisien (ID: `group:Pharisee`); exemple (ID: `keyterm:Example`); Ship (ID: `realia:Ship`); Magadan (ID: `place:Magadan`); esprit (ID: `keyterm:Spirit.2`); prier (ID: `keyterm:AskFor`); sûrement! (ID: `keyterm:Surely`); benir (ID: `keyterm:Bless`); Hérode Antipas (ID: `person:Herod.2`); coeur (ID: `keyterm:Heart`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Fish (ID: `fauna:Fish`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Bethsaïda (ID: `place:Bethsaida`); baptiste [jean] (ID: `keyterm:Baptist`); Césarée de Philippe (ID: `place:CaesareaPhilippi`); trans. faire un disciple de (ID: `keyterm:Disciple`); Pierre (ID: `person:Peter`); prier (ID: `keyterm:AskFor`); prescrire (ID: `keyterm:Command`); Élie (ID: `person:Elijah`); Jean (ID: `person:John`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** vie (ID: `keyterm:Life`); Éternel (ID: `deity:Lord`); Pierre (ID: `person:Peter`); trans. faire un disciple de (ID: `keyterm:Disciple`); prescrire (ID: `keyterm:Command`); capacité (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); saint (ID: `keyterm:Holy`); sûrement! (ID: `keyterm:Surely`); aide (ID: `keyterm:Salvation`); penser (ID: `keyterm:Think`); gloire (ID: `keyterm:Glory`); bonnes nouvelles (ID: `keyterm:GoodNews`); régne (ID: `keyterm:Kingdom`); être infidèle (ID: `keyterm:Unfaithful`); rejeter (ID: `keyterm:Reject`); Satan (ID: `deity:Satan`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Élie (ID: `person:Elijah`); Jésus (ID: `person:Jesus.2`); Pierre (ID: `person:Peter`); Moïse (ID: `person:Moses`); Jean (ID: `person:John.2`); Jacques (ID: `person:James`); bien, aimé (ID: `keyterm:Beloved`); Tent (ID: `realia:Tent`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); A Father (ID: `person:GenericFather`); croire (ID: `keyterm:Believe`); prier (ID: `keyterm:Pray`); ne pas réussir ou refuser de croire (ID: `keyterm:Disbelieve`); A Group of Disciples (ID: `group:GenericDisciples`); prescrire (ID: `keyterm:Command`); A Group of People (ID: `group:GenericGroup`); être infidèle (ID: `keyterm:Unfaithful`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** trans. faire un disciple de (ID: `keyterm:Disciple`); Capernaüm (ID: `place:Capernaum`); nom (ID: `keyterm:Name`); Galilée (ID: `place:Galilee`); ce qui est dit (ID: `keyterm:Word`); craindre (ID: `keyterm:Fear`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** faire pécher qqn (ID: `keyterm:CauseToStumble`); nom (ID: `keyterm:Name`); enfer (ID: `keyterm:Gehenna`); Hell (ID: `place:Hell`); Jésus (ID: `person:Jesus.2`); vie (ID: `keyterm:Life`); Jean (ID: `person:John.2`); sûrement! (ID: `keyterm:Surely`); Demons (ID: `deity:Demons`); régne (ID: `keyterm:Kingdom`); vivre ou être en paix (ID: `keyterm:AtPeace`); Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); capacité (ID: `keyterm:Ability`); Worm (ID: `fauna:Maggot`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); prescrire (ID: `keyterm:Command`); régne (ID: `keyterm:Kingdom`); fornication (ID: `keyterm:Fornication`); Moïse (ID: `person:Moses`); Judée (ID: `place:Judea`); commandement (ID: `keyterm:Commandment`); obstination (ID: `keyterm:Hardheartedness`); sûrement! (ID: `keyterm:Surely`); benir (ID: `keyterm:Bless`); corps (ID: `keyterm:Body.3`); Jourdain (ID: `place:Jordan`); Be Lawful (ID: `keyterm:Lawful`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); régne (ID: `keyterm:Kingdom`); Rich Young Ruler (ID: `person:RichYoungRuler`); le bien (ID: `keyterm:Good`); vie (ID: `keyterm:Life`); trans. faire un disciple de (ID: `keyterm:Disciple`); éternellement (ID: `keyterm:Always`); House (ID: `realia:House`); commandement (ID: `keyterm:Commandment`); aide (ID: `keyterm:Salvation`); sûrement! (ID: `keyterm:Surely`); bonnes nouvelles (ID: `keyterm:GoodNews`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); aimer (ID: `keyterm:Love`); Pierre (ID: `person:Peter`); fornication (ID: `keyterm:Fornication`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Jacques (ID: `person:James`); Jean (ID: `person:John.2`); Jérusalem (ID: `place:Jerusalem`); baptême (ID: `keyterm:Baptism`); nation; peuple (ID: `group:Gentile`); servir (ID: `keyterm:Serve`); vie (ID: `keyterm:Life`); gloire (ID: `keyterm:Glory`); condamner (ID: `keyterm:Condemn`); autorité (ID: `keyterm:Authority.2`); craindre (ID: `keyterm:Fear`); Zébédée (ID: `person:Zebedee`); rançon (ID: `keyterm:Ransom`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); David (ID: `person:David`); pitié (ID: `keyterm:Mercy`); A Group of People (ID: `group:GenericGroup`); Bartimée (ID: `person:Bartimaeus`); Timée (ID: `person:Timaeus`); trans. faire un disciple de (ID: `keyterm:Disciple`); aide (ID: `keyterm:Salvation`); prescrire (ID: `keyterm:Command`); courage! prends courage! bon courage! (ID: `keyterm:CheerUp`); Jéricho (ID: `place:Jericho`); croire (ID: `keyterm:Believe`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Donkey (ID: `fauna:Donkey`); Jésus (ID: `person:Jesus.2`); Jérusalem (ID: `place:Jerusalem`); hosanna [en araméen] (ID: `keyterm:Hosanna`); Béthanie (ID: `place:Bethany`); benir (ID: `keyterm:Bless`); A Group of People (ID: `group:GenericGroup`); Cloak (ID: `realia:Cloak`); Bethphagé (ID: `place:Bethphage`); David (ID: `person:David`); trans. faire un disciple de (ID: `keyterm:Disciple`); hauteur (ID: `keyterm:Height`); nom (ID: `keyterm:Name`); régne (ID: `keyterm:Kingdom`); Éternel (ID: `deity:Lord`); Rush (ID: `flora:Rush`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** croire (ID: `keyterm:Believe`); prier (ID: `keyterm:Pray`); Temple (ID: `realia:Temple`); Fig (ID: `flora:Fig`); Éternel (ID: `deity:Lord`); sûrement! (ID: `keyterm:Surely`); pardonner (ID: `keyterm:Forgive`); évaluer (ID: `keyterm:Discern`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); coeur (ID: `keyterm:Heart`); Pierre (ID: `person:Peter`); Jérusalem (ID: `place:Jerusalem`); craindre (ID: `keyterm:Fear`); Béthanie (ID: `place:Bethany`); Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); éternellement (ID: `keyterm:Always`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); capacité (ID: `keyterm:Ability`); autorité (ID: `keyterm:Authority.2`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Jean (ID: `person:John`); parabole (ID: `keyterm:Parable`); craindre (ID: `keyterm:Fear`); Jésus (ID: `person:Jesus.2`); rejeter (ID: `keyterm:Reject`); scripture (ID: `keyterm:Scripture`); baptême (ID: `keyterm:Baptism`); croire (ID: `keyterm:Believe`); Éternel (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); Jérusalem (ID: `place:Jerusalem`); vide (ID: `keyterm:Empty`); Priests (ID: `group:GenericPriests`); Religious Officials (ID: `group:ReligiousOfficials`); bien, aimé (ID: `keyterm:Beloved`); Watch-Tower (ID: `realia:Watch-tower`); Thorn Hedge (ID: `realia:ThornHedge`); Cornerstone (ID: `realia:Cornerstone`); Tower (ID: `realia:Tower`); Temple (ID: `realia:Temple`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Tibère (ID: `person:Tiberius`); résurrection (ID: `keyterm:Resurrection`); Moïse (ID: `person:Moses`); Jésus (ID: `person:Jesus.2`); les partisans d'Hérode; Hérodiens (ID: `group:Herodian`); scripture (ID: `keyterm:Scripture`); taxe (ID: `keyterm:PollTax`); Abraham (ID: `person:Abraham`); Sadducéens (ID: `group:Sadducee`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); vérité (ID: `keyterm:Truth`); chemin (ID: `keyterm:TheWay`); vie (ID: `keyterm:Life`); vrai (ID: `keyterm:True`); Isaac (ID: `person:Isaac`); hypocrisie (ID: `keyterm:Hypocrisy`); Be Lawful (ID: `keyterm:Lawful`); An Angel (ID: `deity:Angel`); Pharisien (ID: `group:Pharisee`); Israël (ID: `person:Israel`); Denarius (ID: `realia:Denarius`); Brier (ID: `flora:Brier`); Boxthorn (ID: `flora:Boxthorn`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); aimer (ID: `keyterm:Love`); Jésus (ID: `person:Jesus.2`); David (ID: `person:David`); commandement (ID: `keyterm:Commandment`); A Priest (ID: `person:GenericPriest`); A Scribe (ID: `person:Scribe`); coeur (ID: `keyterm:Heart`); Treasury (ID: `realia:Treasury`); sûrement! (ID: `keyterm:Surely`); vie quotidienne (ID: `keyterm:DailyLife`); intelligence (ID: `keyterm:Mind.2`); vérité (ID: `keyterm:Truth`); jugement (ID: `keyterm:Judgment`); prier (ID: `keyterm:Pray`); Saint-Esprit (ID: `deity:HolySpirit`); trans. faire un disciple de (ID: `keyterm:Disciple`); régne (ID: `keyterm:Kingdom`); offrande (ID: `keyterm:Offering`); Israël (ID: `person:Israel`); Quadrans (ID: `realia:Quadrans`); Lepton (ID: `realia:Lepton`); Cloak (ID: `realia:Cloak`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); nom (ID: `keyterm:Name`); Temple (ID: `realia:Temple`); trans. faire un disciple de (ID: `keyterm:Disciple`); Pierre (ID: `person:Peter`); Jean (ID: `person:John.2`); aide (ID: `keyterm:Salvation`); A Group of Disciples (ID: `group:GenericDisciples`); Jacques (ID: `person:James`); témoigner (ID: `keyterm:BearWitness`); régne (ID: `keyterm:Kingdom`); bonnes nouvelles (ID: `keyterm:GoodNews`); exemple (ID: `keyterm:Example`); proclamer (ID: `keyterm:Proclaim`); André (ID: `person:Andrew`); Saint-Esprit (ID: `deity:HolySpirit`); Synagogue (ID: `realia:Synagogue`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Éternel (ID: `deity:Lord`); choisi (ID: `keyterm:Chosen`); House (ID: `realia:House`); capacité (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); sûrement! (ID: `keyterm:Surely`); aide (ID: `keyterm:Salvation`); Judée (ID: `place:Judea`); prescrire (ID: `keyterm:Command`); gloire (ID: `keyterm:Glory`); une merveille (ID: `keyterm:Portent`); croire (ID: `keyterm:Believe`); abominable dévastateur (ID: `keyterm:AbominationOfDesolation`); corps (ID: `keyterm:Body.3`); Disaster (ID: `keyterm:Disaster`); parabole (ID: `keyterm:Parable`); autorité (ID: `keyterm:Authority.2`); prier (ID: `keyterm:Pray`); Jésus (ID: `person:Jesus.2`); exemple (ID: `keyterm:Example`); Cloak (ID: `realia:Cloak`); Fig (ID: `flora:Fig`); Door (ID: `realia:Door`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `flora:Myrrh`); Myrrh (ID: `realia:Myrrh`); Simon (ID: `person:Simon.4`); Béthanie (ID: `place:Bethany`); sûrement! (ID: `keyterm:Surely`); bonnes nouvelles (ID: `keyterm:GoodNews`); sacrifice de la pâque (ID: `keyterm:Passover`); capacité (ID: `keyterm:Ability`); Judas (ID: `person:Judas.2`); A Group of Disciples (ID: `group:GenericDisciples`); corps (ID: `keyterm:Body.3`); promesse (ID: `keyterm:Promise`); sans saleté (ID: `keyterm:Pure`); Jésus (ID: `person:Jesus.2`); proclamer (ID: `keyterm:Proclaim`); Alabaster Jar (ID: `realia:AlabasterJar`); Oil of Nard (ID: `realia:OilOfNard`); Nard (ID: `flora:Nard`); House (ID: `realia:House`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** trans. faire un disciple de (ID: `keyterm:Disciple`); sûrement! (ID: `keyterm:Surely`); sacrifice de la pâque (ID: `keyterm:Passover`); Jésus (ID: `person:Jesus.2`); Sheep (ID: `fauna:Lamb`); sang (ID: `keyterm:Blood`); Galilée (ID: `place:Galilee`); benir (ID: `keyterm:Bless`); corps (ID: `keyterm:Body.3`); Éternel (ID: `deity:Lord`); Pierre (ID: `person:Peter`); Disaster (ID: `keyterm:Disaster`); alliance (ID: `keyterm:Covenant`); résurrection (ID: `keyterm:Resurrection`); régne (ID: `keyterm:Kingdom`); offrande (ID: `keyterm:Offering`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); Rooster (ID: `fauna:Rooster`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Bowl (ID: `realia:Bowl.2`); Clay Jar (ID: `realia:ClayJar`); Flock (ID: `fauna:Flock`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** prier (ID: `keyterm:Pray`); Pierre (ID: `person:Peter`); Linen (ID: `realia:Linen`); Gethsémané (ID: `place:Gethsemane`); Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); esprit (ID: `keyterm:Spirit.2`); scripture (ID: `keyterm:Scripture`); Jean (ID: `person:John.2`); nom (ID: `keyterm:Name`); Jacques (ID: `person:James`); corps (ID: `keyterm:Body.3`); mis à l'essai (ID: `keyterm:PutToTheTest`); Éternel (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); Judas (ID: `person:Judas.2`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); témoigner (ID: `keyterm:BearWitness`); Pierre (ID: `person:Peter`); témoin (ID: `keyterm:Witness`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); condamner (ID: `keyterm:Condemn`); parler (ID: `keyterm:Speak`); capacité (ID: `keyterm:Ability`); parler contre dieu (ID: `keyterm:Blaspheme`); Temple (ID: `realia:Temple`); Clothing (ID: `realia:Clothing`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Pierre (ID: `person:Peter`); Jésus (ID: `person:Jesus.2`); Rooster (ID: `fauna:Rooster`); Nazareth (ID: `place:Nazareth`); Galiléen (ID: `group:Galilee`); vrai (ID: `keyterm:True`); Galilée (ID: `place:Galilee`); ce qui est dit (ID: `keyterm:Word`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Jésus (ID: `person:Jesus.2`); aide (ID: `keyterm:Salvation`); Élie (ID: `person:Elijah`); Jews (ID: `group:Jews`); Purple Cloth (ID: `realia:PurpleCloth`); Reed (ID: `flora:Reed`); Clothing (ID: `realia:Clothing`); Temple (ID: `realia:Temple`); Simon (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); Alexandre (ID: `person:Alexander`); Cyrène (ID: `place:Cyrene`); Rufus (ID: `person:Rufus`); Centurion at Crucifixion (ID: `person:Centurion.3`); adorer (ID: `keyterm:BowDown`); croire (ID: `keyterm:Believe`); A Group of People (ID: `group:GenericGroup`); Éternel (ID: `deity:Lord`); Elders (ID: `group:GenericElders`); vrai (ID: `keyterm:True`); Priests (ID: `group:GenericPriests`); Religious Officials (ID: `group:ReligiousOfficials`); Israël (ID: `person:Israel`); parler contre dieu (ID: `keyterm:Blaspheme`); Myrrh (ID: `flora:Myrrh`); Palace (ID: `realia:Palace`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Sour Wine (ID: `realia:SourWine`); Boxthorn (ID: `flora:Boxthorn`); Lot (ID: `realia:Lot`); Curtain (ID: `realia:Curtain`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Joseph (ID: `person:Joseph.6`); Marie (ID: `person:Mary.2`); Pilate (ID: `person:Pilate`); Marie de Magdala (ID: `person:Marymagdalene`); Jacques (ID: `person:James.4`); Joseph (ID: `person:Joseph.3`); Joseph (ID: `person:Joseph.5`); Arimathée (ID: `place:Arimathea`); Salomé (ID: `person:Salome`); Galilée (ID: `place:Galilee`); le jour avant le sabbat (ID: `keyterm:DayBeforeTheSabbath`); corps (ID: `keyterm:Body.3`); Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); servir (ID: `keyterm:Serve`); Jésus (ID: `person:Jesus.2`); régne (ID: `keyterm:Kingdom`); Grave (ID: `realia:Grave`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Angels (ID: `group:Angels`); Salomé (ID: `person:Salome`); Marie (ID: `person:Mary.2`); aide (ID: `keyterm:Salvation`); sûrement! (ID: `keyterm:Surely`); prescrire (ID: `keyterm:Command`); Galilée (ID: `place:Galilee`); Marie de Magdala (ID: `person:Marymagdalene`); sabbat (ID: `keyterm:Sabbath`); semaine (ID: `keyterm:Week`); Jacques (ID: `person:James.3`); oint (ID: `keyterm:Anointed`); Pierre (ID: `person:Peter`); Nazareth (ID: `place:Nazareth`); imperissable (ID: `keyterm:Imperishable`); craindre (ID: `keyterm:Fear`); Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); résurrection (ID: `keyterm:Resurrection`); Cloak (ID: `realia:Cloak`); Aloes (ID: `realia:Aloes`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** croire (ID: `keyterm:Believe`); ne pas réussir ou refuser de croire (ID: `keyterm:Disbelieve`); Demons (ID: `deity:Demons`); Jésus (ID: `person:Jesus.2`); exemple (ID: `keyterm:Example`); proclamer (ID: `keyterm:Proclaim`); aide (ID: `keyterm:Salvation`); bonnes nouvelles (ID: `keyterm:GoodNews`); baptême (ID: `keyterm:Baptism`); Marie de Magdala (ID: `person:Marymagdalene`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); semaine (ID: `keyterm:Week`); condamner (ID: `keyterm:Condemn`); Éternel (ID: `deity:Lord`); vie (ID: `keyterm:Life`); obstination (ID: `keyterm:Hardheartedness`); résurrection (ID: `keyterm:Resurrection`); nom (ID: `keyterm:Name`); Snake (ID: `fauna:Snake`)
