...
* **Associated ACAI Concepts:** Jean (ID: `person:John`); proclamer (ID: `keyterm:Proclaim`); bonnes nouvelles (ID: `keyterm:GoodNews`); Zébédée (ID: `person:Zebedee`); Galilée (ID: `place:Galilee`); Jourdain (ID: `place:Jordan`); Strap (ID: `realia:Strap`); travailleur employé (ID: `keyterm:HiredWorker`); Sea of Galilee (ID: `place:GalileeSea`); Jacques (ID: `person:James`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); Galilée (ID: `place:Galilee`); Capernaüm (ID: `place:Capernaum`)
...
* **Associated ACAI Concepts:** Alphée (ID: `person:Alphaeus.2`); Bed (ID: `realia:Bed`); Patch (ID: `realia:Patch`); Matthieu (ID: `person:Matthew`); Housetop (ID: `realia:Housetop`); Capernaüm (ID: `place:Capernaum`); Skin-Bottle (ID: `realia:Skin-bottle`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Be Lawful (ID: `keyterm:Lawful`); les partisans d'Hérode; Hérodiens (ID: `group:Herodian`); Abiathar (ID: `person:Abiathar`); sabbat (ID: `keyterm:Sabbath`)
...
* **Associated ACAI Concepts:** Idumée (ID: `place:Idumea`); zélote; nationaliste (ID: `group:Zealot`); Barthélemy (ID: `person:Bartholomew`); Alphée (ID: `person:Alphaeus`); Jacques (ID: `person:James.2`); Jacques (ID: `person:James`); Jean (ID: `person:John.2`)
...
* **Associated ACAI Concepts:** parabole (ID: `keyterm:Parable`); Mustard (ID: `flora:Mustard`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Cushion (ID: `realia:Cushion`); être possédé par un démon (ID: `keyterm:DemonPossessed`); Légion (ID: `deity:Legion`); Fetter (ID: `realia:Fetter`); Chain (ID: `realia:Chain`); Décapole (ID: `place:Decapolis`); Gerasa (ID: `place:Gerasa`); prescrire (ID: `keyterm:Command`)
...
* **Associated ACAI Concepts:** Cloak (ID: `realia:Cloak`); Jaïrus (ID: `person:Jairus`)
...
* **Associated ACAI Concepts:** Joseph (ID: `person:Joseph.3`); Simon (ID: `person:Simon.3`); Jude (ID: `person:Jude`); ne pas réussir ou refuser de croire (ID: `keyterm:Disbelieve`)
...
* **Associated ACAI Concepts:** Hérode Antipas (ID: `person:Herod.2`); Hérodias (ID: `person:Herodias`); Plate (ID: `realia:Plate.2`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Philippe (ID: `person:Philip.2`); Jean (ID: `person:John`)
...
* **Associated ACAI Concepts:** ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Génésareth (ID: `place:Gennesaret`); Bethsaïda (ID: `place:Bethsaida`)
...
* **Associated ACAI Concepts:** se rendre (ID: `keyterm:Teaching`); Pharisien (ID: `group:Pharisee`); Temple Treasury (ID: `place:Corban`); pollution (ID: `keyterm:Defilement`)
...
* **Associated ACAI Concepts:** syro-phénicienne (ID: `group:Phoenicia`); Tyr (ID: `place:Tyre`); Décapole (ID: `place:Decapolis`); Phénicie (ID: `place:Phoenicia`); Yavanite (ID: `group:Greek`); Sidon (ID: `place:Sidon`)
...
* **Associated ACAI Concepts:** Césarée de Philippe (ID: `place:CaesareaPhilippi`); Bethsaïda (ID: `place:Bethsaida`); baptiste [jean] (ID: `keyterm:Baptist`)
...
* **Associated ACAI Concepts:** faire pécher qqn (ID: `keyterm:CauseToStumble`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Bartimée (ID: `person:Bartimaeus`); Timée (ID: `person:Timaeus`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** hosanna [en araméen] (ID: `keyterm:Hosanna`); Béthanie (ID: `place:Bethany`); Bethphagé (ID: `place:Bethphage`); Rush (ID: `flora:Rush`); Jérusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** les partisans d'Hérode; Hérodiens (ID: `group:Herodian`); Denarius (ID: `realia:Denarius`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Myrrh (ID: `realia:Myrrh`); Simon (ID: `person:Simon.4`); Oil of Nard (ID: `realia:OilOfNard`); Alabaster Jar (ID: `realia:AlabasterJar`); Nard (ID: `flora:Nard`); Béthanie (ID: `place:Bethany`)
...
* **Associated ACAI Concepts:** Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); sang (ID: `keyterm:Blood`)
...
* **Associated ACAI Concepts:** Gethsémané (ID: `place:Gethsemane`)
...
* **Associated ACAI Concepts:** Centurion at Crucifixion (ID: `person:Centurion.3`); Alexandre (ID: `person:Alexander`); Rufus (ID: `person:Rufus`); Myrrhed Wine (ID: `realia:MyrrhedWine`); Simon (ID: `person:Simon.5`); Purple Cloth (ID: `realia:PurpleCloth`); Golgotha (ID: `place:Golgotha`); Palace (ID: `realia:Palace`); Cyrène (ID: `place:Cyrene`); Myrrh (ID: `flora:Myrrh`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Marie (ID: `person:Mary.2`); Joseph (ID: `person:Joseph.6`); Joseph (ID: `person:Joseph.3`); Joseph (ID: `person:Joseph.5`); Jacques (ID: `person:James.4`); Salomé (ID: `person:Salome`); Arimathée (ID: `place:Arimathea`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Salomé (ID: `person:Salome`); Angels (ID: `group:Angels`); Marie (ID: `person:Mary.2`)
