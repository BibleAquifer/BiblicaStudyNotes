...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); témoigner (ID: `keyterm:BearWitness`); grâce (ID: `keyterm:Favor`); capacité (ID: `keyterm:Ability`); vérité (ID: `keyterm:Truth`); nom (ID: `keyterm:Name`); corps (ID: `keyterm:Body.3`); croire (ID: `keyterm:Believe`); Jean (ID: `person:John`); vie (ID: `keyterm:Life`); loi (ID: `keyterm:Law`); vrai (ID: `keyterm:True`); Jésus (ID: `person:Jesus.2`); gloire (ID: `keyterm:Glory`); autorité (ID: `keyterm:Authority.2`); Moïse (ID: `person:Moses`); sang (ID: `keyterm:Blood`)
...
* **Associated ACAI Concepts:** baptême (ID: `keyterm:Baptism`); Jean (ID: `person:John`); témoigner (ID: `keyterm:BearWitness`); prier (ID: `keyterm:AskFor`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); Élie (ID: `person:Elijah`); Saint-Esprit (ID: `deity:HolySpirit`); Béthanie (ID: `place:Bethany.2`); pécher (ID: `keyterm:Sin`); Lévi (ID: `group:Levi`); capacité (ID: `keyterm:Ability`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Jourdain (ID: `place:Jordan`); Ésaïe (ID: `person:Isaiah`); Jérusalem (ID: `place:Jerusalem`); Lévi (ID: `person:Levi.3`); Pharisien (ID: `group:Pharisee`); Jews (ID: `group:Jews`); Israël (ID: `person:Israel`); Strap (ID: `realia:Strap`); Sheep (ID: `fauna:Lamb`); Dove (ID: `fauna:Dove`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Nathanaël (ID: `person:Nathanael`); Philippe (ID: `person:Philip`); Pierre (ID: `person:Peter`); Nazareth (ID: `place:Nazareth`); André (ID: `person:Andrew`); Éternel (ID: `deity:Lord`); Jean (ID: `person:John`); trans. faire un disciple de (ID: `keyterm:Disciple`); Israël (ID: `person:Israel`); Fig (ID: `flora:Fig`); Bethsaïda (ID: `place:Bethsaida`); Jean (ID: `person:John.4`); A Disciple (ID: `person:GenericDisciple`); Joseph (ID: `person:Joseph.4`); sûrement! (ID: `keyterm:Surely`); Galilée (ID: `place:Galilee`); croire (ID: `keyterm:Believe`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Moïse (ID: `person:Moses`); le bien (ID: `keyterm:Good`); vrai (ID: `keyterm:True`); loi (ID: `keyterm:Law`); An Angel (ID: `deity:Angel`); Israël (ID: `group:Israel`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); Wine (ID: `realia:Wine`); Cana (ID: `place:Cana`); Galilée (ID: `place:Galilee`); Stone Jar (ID: `realia:StoneJar`); Clay Jar (ID: `realia:ClayJar`); exemple (ID: `keyterm:Example`); Capernaüm (ID: `place:Capernaum`); gloire (ID: `keyterm:Glory`); croire (ID: `keyterm:Believe`); Jews (ID: `group:Jews`); purifier (ID: `keyterm:Cleanse.2`); Measure (ID: `realia:Measure`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); Jésus (ID: `person:Jesus.2`); croire (ID: `keyterm:Believe`); Jews (ID: `group:Jews`); sacrifice de la pâque (ID: `keyterm:Passover`); Jérusalem (ID: `place:Jerusalem`); trans. faire un disciple de (ID: `keyterm:Disciple`); exemple (ID: `keyterm:Example`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Dove (ID: `fauna:Dove`); Sheep (ID: `fauna:Lamb`); jalousie (ID: `keyterm:Extremely`); scripture (ID: `keyterm:Scripture`); témoigner (ID: `keyterm:BearWitness`); corps (ID: `keyterm:Body.3`); Éternel (ID: `deity:Lord`); résurrection (ID: `keyterm:Resurrection`); nom (ID: `keyterm:Name`); Rope (ID: `realia:Rope`); Whip (ID: `realia:Whip`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); sûrement! (ID: `keyterm:Surely`); Nicodème (ID: `person:Nicodemus`); capacité (ID: `keyterm:Ability`); Saint-Esprit (ID: `deity:HolySpirit`); Jésus (ID: `person:Jesus.2`); aimer (ID: `keyterm:Love`); éternellement (ID: `keyterm:Always`); vie (ID: `keyterm:Life`); decider (ID: `keyterm:Decided`); nom (ID: `keyterm:Name`); régne (ID: `keyterm:Kingdom`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); céleste (ID: `keyterm:Heavenly`); esprit (ID: `keyterm:Spirit.2`); aide (ID: `keyterm:Salvation`); témoigner (ID: `keyterm:BearWitness`); vérité (ID: `keyterm:Truth`); corps (ID: `keyterm:Body.3`); Moïse (ID: `person:Moses`); jugement (ID: `keyterm:Judgment`); tribunal (ID: `keyterm:CourtCase`); Pharisien (ID: `group:Pharisee`); exemple (ID: `keyterm:Example`); Jews (ID: `group:Jews`); Israël (ID: `person:Israel`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** Jean (ID: `person:John`); témoigner (ID: `keyterm:BearWitness`); Éternel (ID: `deity:Lord`); baptême (ID: `keyterm:Baptism`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); Jews (ID: `group:Jews`); Judéen (ID: `group:Judea`); Salim (ID: `place:Salim`); Énon (ID: `place:Aenon`); Judée (ID: `place:Judea`); ce qui est dit (ID: `keyterm:Word`); Cause of Joy (ID: `keyterm:CauseOfJoy`); croire (ID: `keyterm:Believe`); aimer (ID: `keyterm:Love`); Jourdain (ID: `place:Jordan`); vie (ID: `keyterm:Life`); vrai (ID: `keyterm:True`); Saint-Esprit (ID: `deity:HolySpirit`); purifier (ID: `keyterm:Cleanse.2`); éternellement (ID: `keyterm:Always`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); adorer (ID: `keyterm:BowDown`); Samarie (ID: `place:Samaria`); Éternel (ID: `deity:Lord`); A Woman (ID: `person:GenericFemale`); vie (ID: `keyterm:Life`); trans. faire un disciple de (ID: `keyterm:Disciple`); Israël (ID: `person:Israel`); Jérusalem (ID: `place:Jerusalem`); baptême (ID: `keyterm:Baptism`); vérité (ID: `keyterm:Truth`); vrai (ID: `keyterm:True`); esprit (ID: `keyterm:Spirit.2`); Jews (ID: `group:Jews`); Sychar (ID: `place:Sychar`); Shimrath (ID: `group:Samaritan`); aide (ID: `keyterm:Salvation`); Judée (ID: `place:Judea`); Galilée (ID: `place:Galilee`); croire (ID: `keyterm:Believe`); Jean (ID: `person:John`); adorateur (ID: `keyterm:Worshiper`); Pharisien (ID: `group:Pharisee`); éternellement (ID: `keyterm:Always`); Joseph (ID: `person:Joseph.10`); Container (ID: `realia:Container`)
...
* **Associated ACAI Concepts:** trans. faire un disciple de (ID: `keyterm:Disciple`); croire (ID: `keyterm:Believe`); Jésus (ID: `person:Jesus.2`); prier (ID: `keyterm:AskFor`); vrai (ID: `keyterm:True`); Samarie (ID: `place:Samaria`); Shimrath (ID: `group:Samaritan`); vie (ID: `keyterm:Life`); sauveur (ID: `keyterm:Savior`); A Group of Disciples (ID: `group:GenericDisciples`); éternellement (ID: `keyterm:Always`); témoigner (ID: `keyterm:BearWitness`); capacité (ID: `keyterm:Ability`); A Person (ID: `person:GenericPerson`); Stone Jar (ID: `realia:StoneJar`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Galilée (ID: `place:Galilee`); vie (ID: `keyterm:Life`); croire (ID: `keyterm:Believe`); Judée (ID: `place:Judea`); exemple (ID: `keyterm:Example`); Galiléen (ID: `group:Galilee`); Cana (ID: `place:Cana`); Jérusalem (ID: `place:Jerusalem`); prier (ID: `keyterm:AskFor`); Capernaüm (ID: `place:Capernaum`); témoigner (ID: `keyterm:BearWitness`); une merveille (ID: `keyterm:Portent`); Public Official (ID: `person:GenericOfficial`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Bed (ID: `realia:Bed`); Jews (ID: `group:Jews`); Jérusalem (ID: `place:Jerusalem`); sabbat (ID: `keyterm:Sabbath`); Pool (ID: `realia:Pool`); Béthesda (ID: `place:Bethesda`); porte des brebis (ID: `place:SheepGate`); servir (ID: `keyterm:Serve`); prier (ID: `keyterm:AskFor`); pécher (ID: `keyterm:Sin`); Be Lawful (ID: `keyterm:Lawful`); Porch (ID: `realia:Porch`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); jugement (ID: `keyterm:Judgment`); vie (ID: `keyterm:Life`); tribunal (ID: `keyterm:CourtCase`); sûrement! (ID: `keyterm:Surely`); sabbat (ID: `keyterm:Sabbath`); decider (ID: `keyterm:Decided`); Jésus (ID: `person:Jesus.2`); résurrection (ID: `keyterm:Resurrection`); Jews (ID: `group:Jews`); faire vivre (ID: `keyterm:Alive`); être juste (ID: `keyterm:Just`); croire (ID: `keyterm:Believe`); capacité (ID: `keyterm:Ability`); amour (ID: `keyterm:Friendship`); le bien (ID: `keyterm:Good`); autorité (ID: `keyterm:Authority.2`); éternellement (ID: `keyterm:Always`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** témoigner (ID: `keyterm:BearWitness`); Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); vie (ID: `keyterm:Life`); gloire (ID: `keyterm:Glory`); vrai (ID: `keyterm:True`); Moïse (ID: `person:Moses`); Jean (ID: `person:John`); scripture (ID: `keyterm:Scripture`); lettre de l'alphabet (ID: `keyterm:Letter`); vérité (ID: `keyterm:Truth`); aide (ID: `keyterm:Salvation`); nom (ID: `keyterm:Name`); éternellement (ID: `keyterm:Always`); ce qui est dit (ID: `keyterm:Word`); espoir (ID: `keyterm:Hope`); aimer (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); Ship (ID: `realia:Ship`); craindre (ID: `keyterm:Fear`); Philippe (ID: `person:Philip`); exemple (ID: `keyterm:Example`); Barley (ID: `flora:Barley`); Fish (ID: `fauna:Fish`); Sea of Galilee (ID: `place:GalileeSea`); Capernaüm (ID: `place:Capernaum`); sacrifice de la pâque (ID: `keyterm:Passover`); capacité (ID: `keyterm:Ability`); A Group of People (ID: `group:GenericGroup`); Pierre (ID: `person:Peter`); vrai (ID: `keyterm:True`); André (ID: `person:Andrew`); Jews (ID: `group:Jews`); Stade (ID: `realia:Stade`); Denarius (ID: `realia:Denarius`); Basket (ID: `realia:Basket`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); vie (ID: `keyterm:Life`); Jésus (ID: `person:Jesus.2`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); corps (ID: `keyterm:Body.3`); croire (ID: `keyterm:Believe`); éternellement (ID: `keyterm:Always`); sûrement! (ID: `keyterm:Surely`); sang (ID: `keyterm:Blood`); Capernaüm (ID: `place:Capernaum`); Ship (ID: `realia:Ship`); capacité (ID: `keyterm:Ability`); trans. faire un disciple de (ID: `keyterm:Disciple`); exemple (ID: `keyterm:Example`); Jews (ID: `group:Jews`); Tibériade (ID: `place:Tiberias`); Joseph (ID: `person:Joseph.4`); Moïse (ID: `person:Moses`); vrai (ID: `keyterm:True`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); vie (ID: `keyterm:Life`); ce qui est dit (ID: `keyterm:Word`); Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); Simon (ID: `person:Simon.7`); saint (ID: `keyterm:Holy`); Pierre (ID: `person:Peter`); esprit (ID: `keyterm:Spirit.2`); A Group of Disciples (ID: `group:GenericDisciples`); corps (ID: `keyterm:Body.3`); éternellement (ID: `keyterm:Always`); choisi (ID: `keyterm:Chosen`); Saint-Esprit (ID: `deity:HolySpirit`); Judas (ID: `person:Judas.2`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); A Group of People (ID: `group:GenericGroup`); Moïse (ID: `person:Moses`); vrai (ID: `keyterm:True`); Judée (ID: `place:Judea`); Galilée (ID: `place:Galilee`); croire (ID: `keyterm:Believe`); sabbat (ID: `keyterm:Sabbath`); capacité (ID: `keyterm:Ability`); loi (ID: `keyterm:Law`); Circumcision (ID: `keyterm:Circumcision`); Relatives (ID: `group:Relatives`); méfaits (ID: `keyterm:UnjustDeed`); être juste (ID: `keyterm:Just`); Temple (ID: `realia:Temple`); gloire (ID: `keyterm:Glory`); témoigner (ID: `keyterm:BearWitness`); Éternel (ID: `deity:Lord`); le bien (ID: `keyterm:Good`); jugement (ID: `keyterm:Judgment`); To Cause to Happen (ID: `keyterm:Happen`); Jérusalem (ID: `place:Jerusalem`); decider (ID: `keyterm:Decided`); Demons (ID: `deity:Demons`); craindre (ID: `keyterm:Fear`); tribunal (ID: `keyterm:CourtCase`); Javan (ID: `person:Javan`); trans. faire un disciple de (ID: `keyterm:Disciple`); Pharisien (ID: `group:Pharisee`); Yavanite (ID: `group:Greek`); exemple (ID: `keyterm:Example`); Festival of the Tabernacles (ID: `realia:FestivalOfTheTabernacles`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); croire (ID: `keyterm:Believe`); Pharisien (ID: `group:Pharisee`); scripture (ID: `keyterm:Scripture`); Galilée (ID: `place:Galilee`); A Group of People (ID: `group:GenericGroup`); loi (ID: `keyterm:Law`); Nicodème (ID: `person:Nicodemus`); Bethléhem (ID: `place:Bethlehem`); gloire (ID: `keyterm:Glory`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); vie (ID: `keyterm:Life`); decider (ID: `keyterm:Decided`); vrai (ID: `keyterm:True`); Saint-Esprit (ID: `deity:HolySpirit`); Religious Officials (ID: `group:ReligiousOfficials`); David (ID: `person:David`); estomac (ID: `keyterm:Belly`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); fornication (ID: `keyterm:Fornication`); prier (ID: `keyterm:AskFor`); prescrire (ID: `keyterm:Command`); Pharisien (ID: `group:Pharisee`); loi (ID: `keyterm:Law`); pécher (ID: `keyterm:Sin`); condamner (ID: `keyterm:Condemn`); sans péché (ID: `keyterm:WithoutSin`); Moïse (ID: `person:Moses`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); vrai (ID: `keyterm:True`); Jésus (ID: `person:Jesus.2`); témoigner (ID: `keyterm:BearWitness`); capacité (ID: `keyterm:Ability`); decider (ID: `keyterm:Decided`); pécher (ID: `keyterm:Sin`); croire (ID: `keyterm:Believe`); ce qui est dit (ID: `keyterm:Word`); marcher (ID: `keyterm:Live.3`); corps (ID: `keyterm:Body.3`); jugement (ID: `keyterm:Judgment`); vie (ID: `keyterm:Life`); loi (ID: `keyterm:Law`); tribunal (ID: `keyterm:CourtCase`); Pharisien (ID: `group:Pharisee`); Jews (ID: `group:Jews`); Treasury (ID: `realia:Treasury`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Abraham (ID: `person:Abraham`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); vérité (ID: `keyterm:Truth`); Jews (ID: `group:Jews`); sûrement! (ID: `keyterm:Surely`); croire (ID: `keyterm:Believe`); Demons (ID: `deity:Demons`); éternellement (ID: `keyterm:Always`); gloire (ID: `keyterm:Glory`); pécher (ID: `keyterm:Sin`); servir (ID: `keyterm:Serve.2`); vrai (ID: `keyterm:True`); trans. faire un disciple de (ID: `keyterm:Disciple`); Samarie (ID: `place:Samaria`); ce qui est dit (ID: `keyterm:Word`); aimer (ID: `keyterm:Love`); decider (ID: `keyterm:Decided`); Shimrath (ID: `group:Samaritan`); fornication (ID: `keyterm:Fornication`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Siloam (ID: `place:Siloam`); Jésus (ID: `person:Jesus.2`); pécher (ID: `keyterm:Sin`); A Group of People (ID: `group:GenericGroup`); oint (ID: `keyterm:Anointed`); A Blind Man (ID: `person:BlindMan`); trans. faire un disciple de (ID: `keyterm:Disciple`); prier (ID: `keyterm:AskFor`); Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); Pool (ID: `realia:Pool`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); prier (ID: `keyterm:AskFor`); Pharisien (ID: `group:Pharisee`); sabbat (ID: `keyterm:Sabbath`); Moïse (ID: `person:Moses`); Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); Jews (ID: `group:Jews`); Parents (ID: `group:Parents`); A Blind Man (ID: `person:BlindMan`); gloire (ID: `keyterm:Glory`); pécher (ID: `keyterm:Sin`); croire (ID: `keyterm:Believe`); dévot (ID: `keyterm:GodFearing`); craindre (ID: `keyterm:Fear`); éternellement (ID: `keyterm:Always`); exemple (ID: `keyterm:Example`); A Father (ID: `person:GenericFather`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Sheep (ID: `fauna:Lamb`); Jésus (ID: `person:Jesus.2`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); vie (ID: `keyterm:Life`); croire (ID: `keyterm:Believe`); Éternel (ID: `deity:Lord`); travailleur employé (ID: `keyterm:HiredWorker`); sûrement! (ID: `keyterm:Surely`); capacité (ID: `keyterm:Ability`); Demons (ID: `deity:Demons`); Sheepfold (ID: `realia:Sheepfold`); A Blind Man (ID: `person:BlindMan`); commandement (ID: `keyterm:Commandment`); être possédé par un démon (ID: `keyterm:DemonPossessed`); aide (ID: `keyterm:Salvation`); ce qui est dit (ID: `keyterm:Word`); adorer (ID: `keyterm:BowDown`); pécher (ID: `keyterm:Sin`); aimer (ID: `keyterm:Love`); jugement (ID: `keyterm:Judgment`); autorité (ID: `keyterm:Authority.2`); nom (ID: `keyterm:Name`); Pharisien (ID: `group:Pharisee`); Jews (ID: `group:Jews`); Wolf (ID: `fauna:Wolf`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); Jésus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); parler contre dieu (ID: `keyterm:Blaspheme`); Jean (ID: `person:John`); Sheep (ID: `fauna:Lamb`); Jourdain (ID: `place:Jordan`); éternellement (ID: `keyterm:Always`); scripture (ID: `keyterm:Scripture`); témoigner (ID: `keyterm:BearWitness`); baptême (ID: `keyterm:Baptism`); capacité (ID: `keyterm:Ability`); consécration (ID: `keyterm:Consecration.2`); Salomon (ID: `person:Solomon`); Jérusalem (ID: `place:Jerusalem`); vie (ID: `keyterm:Life`); vrai (ID: `keyterm:True`); loi (ID: `keyterm:Law`); nom (ID: `keyterm:Name`); exemple (ID: `keyterm:Example`); Porch (ID: `realia:Porch`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Lazare (ID: `person:Lazarus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); intrans. trébucher (ID: `keyterm:Stumble`); Marie (ID: `person:Mary.3`); Marthe (ID: `person:Martha`); A Group of Disciples (ID: `group:GenericDisciples`); Thomas (ID: `person:Thomas`); Béthanie (ID: `place:Bethany`); aide (ID: `keyterm:Salvation`); Judée (ID: `place:Judea`); gloire (ID: `keyterm:Glory`); croire (ID: `keyterm:Believe`); capacité (ID: `keyterm:Ability`); aimer (ID: `keyterm:Love`); amour (ID: `keyterm:Friendship`); Éternel (ID: `deity:Lord`); oint (ID: `keyterm:Anointed`); Jews (ID: `group:Jews`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); croire (ID: `keyterm:Believe`); Marie (ID: `person:Mary.3`); Marthe (ID: `person:Martha`); Jews (ID: `group:Jews`); Éternel (ID: `deity:Lord`); résurrection (ID: `keyterm:Resurrection`); Grave (ID: `realia:Grave`); vie (ID: `keyterm:Life`); Lazare (ID: `person:Lazarus.2`); Béthanie (ID: `place:Bethany`); House (ID: `realia:House`); gloire (ID: `keyterm:Glory`); capacité (ID: `keyterm:Ability`); amour (ID: `keyterm:Friendship`); Jérusalem (ID: `place:Jerusalem`); esprit (ID: `keyterm:Spirit.2`); éternellement (ID: `keyterm:Always`); Band of Cloth (ID: `realia:BandOfCloth`); Stade (ID: `realia:Stade`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Pharisien (ID: `group:Pharisee`); Jews (ID: `group:Jews`); Caïphe (ID: `person:Caiaphas`); sacrifice de la pâque (ID: `keyterm:Passover`); croire (ID: `keyterm:Believe`); trans. faire un disciple de (ID: `keyterm:Disciple`); commandement (ID: `keyterm:Commandment`); Jérusalem (ID: `place:Jerusalem`); Rome (ID: `place:Rome`); exemple (ID: `keyterm:Example`); Éternel (ID: `deity:Lord`); parler (ID: `keyterm:Speak`); Éphraïm (ID: `place:Ephraim`); sans saleté (ID: `keyterm:Pure`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Lazare (ID: `person:Lazarus.2`); résurrection (ID: `keyterm:Resurrection`); Jews (ID: `group:Jews`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Marie (ID: `person:Mary.3`); Marthe (ID: `person:Martha`); sacrifice de la pâque (ID: `keyterm:Passover`); croire (ID: `keyterm:Believe`); Judas (ID: `person:Judas.2`); oint (ID: `keyterm:Anointed`); sans saleté (ID: `keyterm:Pure`); Béthanie (ID: `place:Bethany`); servir (ID: `keyterm:Serve`); trans. faire un disciple de (ID: `keyterm:Disciple`); Oil of Nard (ID: `realia:OilOfNard`); Pound (ID: `realia:Pound`); Money Box (ID: `realia:MoneyBox`); Nard (ID: `flora:Nard`); House (ID: `realia:House`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); gloire (ID: `keyterm:Glory`); capacité (ID: `keyterm:Ability`); Philippe (ID: `person:Philip`); A Group of People (ID: `group:GenericGroup`); Jérusalem (ID: `place:Jerusalem`); nom (ID: `keyterm:Name`); éternellement (ID: `keyterm:Always`); Donkey (ID: `fauna:Donkey`); hosanna [en araméen] (ID: `keyterm:Hosanna`); Bethsaïda (ID: `place:Bethsaida`); aide (ID: `keyterm:Salvation`); sûrement! (ID: `keyterm:Surely`); Galilée (ID: `place:Galilee`); témoigner (ID: `keyterm:BearWitness`); adorer (ID: `keyterm:BowDown`); croire (ID: `keyterm:Believe`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); marcher (ID: `keyterm:Live.3`); benir (ID: `keyterm:Bless`); amour (ID: `keyterm:Friendship`); Lazare (ID: `person:Lazarus.2`); jugement (ID: `keyterm:Judgment`); prier (ID: `keyterm:AskFor`); vie (ID: `keyterm:Life`); loi (ID: `keyterm:Law`); craindre (ID: `keyterm:Fear`); tribunal (ID: `keyterm:CourtCase`); Religious Officials (ID: `group:ReligiousOfficials`); Javan (ID: `person:Javan`); servir (ID: `keyterm:Serve`); trans. faire un disciple de (ID: `keyterm:Disciple`); An Angel (ID: `deity:Angel`); résurrection (ID: `keyterm:Resurrection`); Pharisien (ID: `group:Pharisee`); Yavanite (ID: `group:Greek`); exemple (ID: `keyterm:Example`); André (ID: `person:Andrew`); Israël (ID: `person:Israel`); Grain (ID: `flora:Grain`); Date Palm (ID: `flora:DatePalm`); Grave (ID: `realia:Grave`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** croire (ID: `keyterm:Believe`); Éternel (ID: `deity:Lord`); Ésaïe (ID: `person:Isaiah`); commandement (ID: `keyterm:Commandment`); capacité (ID: `keyterm:Ability`); gloire (ID: `keyterm:Glory`); decider (ID: `keyterm:Decided`); ce qui est dit (ID: `keyterm:Word`); Jésus (ID: `person:Jesus.2`); aide (ID: `keyterm:Salvation`); vie (ID: `keyterm:Life`); éternellement (ID: `keyterm:Always`); Pharisien (ID: `group:Pharisee`); exemple (ID: `keyterm:Example`); coeur (ID: `keyterm:Heart`); To Cause to Happen (ID: `keyterm:Happen`); aimer (ID: `keyterm:Love`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Pierre (ID: `person:Peter`); pur (ID: `keyterm:Clean`); Éternel (ID: `deity:Lord`); Towel (ID: `realia:Towel`); Clothing (ID: `realia:Clothing`); béni (ID: `keyterm:Happy`); trans. faire un disciple de (ID: `keyterm:Disciple`); sûrement! (ID: `keyterm:Surely`); Simon (ID: `person:Simon.7`); sacrifice de la pâque (ID: `keyterm:Passover`); sois obligé (ID: `keyterm:Ought`); éternellement (ID: `keyterm:Always`); coeur (ID: `keyterm:Heart`); capacité (ID: `keyterm:Ability`); Judas (ID: `person:Judas.2`); aimer (ID: `keyterm:Love`); Bowl (ID: `realia:Bowl`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); sûrement! (ID: `keyterm:Surely`); aimer (ID: `keyterm:Love`); Pierre (ID: `person:Peter`); trans. faire un disciple de (ID: `keyterm:Disciple`); gloire (ID: `keyterm:Glory`); Judas (ID: `person:Judas.2`); Éternel (ID: `deity:Lord`); vie (ID: `keyterm:Life`); Simon (ID: `person:Simon.7`); commandement (ID: `keyterm:Commandment`); scripture (ID: `keyterm:Scripture`); témoigner (ID: `keyterm:BearWitness`); croire (ID: `keyterm:Believe`); Satan (ID: `deity:Satan`); choisi (ID: `keyterm:Chosen`); To Cause to Happen (ID: `keyterm:Happen`); esprit (ID: `keyterm:Spirit.2`); Jews (ID: `group:Jews`); Money Box (ID: `realia:MoneyBox`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); commandement (ID: `keyterm:Commandment`); vérité (ID: `keyterm:Truth`); Saint-Esprit (ID: `deity:HolySpirit`); Philippe (ID: `person:Philip`); nom (ID: `keyterm:Name`); capacité (ID: `keyterm:Ability`); aimer (ID: `keyterm:Love`); vie (ID: `keyterm:Life`); Jésus (ID: `person:Jesus.2`); sûrement! (ID: `keyterm:Surely`); gloire (ID: `keyterm:Glory`); Thomas (ID: `person:Thomas`); ce qui est dit (ID: `keyterm:Word`); coeur (ID: `keyterm:Heart`); prier (ID: `keyterm:AskFor`); éternellement (ID: `keyterm:Always`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); aimer (ID: `keyterm:Love`); Judas (ID: `person:Judas`); croire (ID: `keyterm:Believe`); Jésus (ID: `person:Jesus.2`); faire la paix (ID: `keyterm:Peace`); nom (ID: `keyterm:Name`); prescrire (ID: `keyterm:Command`); coeur (ID: `keyterm:Heart`); Saint-Esprit (ID: `deity:HolySpirit`); Judas (ID: `person:Judas.2`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); aimer (ID: `keyterm:Love`); Vine (ID: `flora:Vine`); prescrire (ID: `keyterm:Command`); choisi (ID: `keyterm:Chosen`); commandement (ID: `keyterm:Commandment`); témoigner (ID: `keyterm:BearWitness`); pécher (ID: `keyterm:Sin`); capacité (ID: `keyterm:Ability`); nom (ID: `keyterm:Name`); amour (ID: `keyterm:Friendship`); gloire (ID: `keyterm:Glory`); ce qui est dit (ID: `keyterm:Word`); Cause of Joy (ID: `keyterm:CauseOfJoy`); vérité (ID: `keyterm:Truth`); pur (ID: `keyterm:Clean`); To Cause to Happen (ID: `keyterm:Happen`); vie (ID: `keyterm:Life`); vrai (ID: `keyterm:True`); loi (ID: `keyterm:Law`); Saint-Esprit (ID: `deity:HolySpirit`); trans. faire un disciple de (ID: `keyterm:Disciple`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); vérité (ID: `keyterm:Truth`); pécher (ID: `keyterm:Sin`); être juste (ID: `keyterm:Just`); tribunal (ID: `keyterm:CourtCase`); Saint-Esprit (ID: `deity:HolySpirit`); jugement (ID: `keyterm:Judgment`); capacité (ID: `keyterm:Ability`); servir (ID: `keyterm:Serve`); sacerdoce (ID: `keyterm:Priesthood`); prier (ID: `keyterm:AskFor`); gloire (ID: `keyterm:Glory`); decider (ID: `keyterm:Decided`); coeur (ID: `keyterm:Heart`); croire (ID: `keyterm:Believe`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); prier (ID: `keyterm:AskFor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); capacité (ID: `keyterm:Ability`); nom (ID: `keyterm:Name`); croire (ID: `keyterm:Believe`); Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); sûrement! (ID: `keyterm:Surely`); A Group of Disciples (ID: `group:GenericDisciples`); courage! prends courage! bon courage! (ID: `keyterm:CheerUp`); faire la paix (ID: `keyterm:Peace`); amour (ID: `keyterm:Friendship`); coeur (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); gloire (ID: `keyterm:Glory`); nom (ID: `keyterm:Name`); croire (ID: `keyterm:Believe`); aimer (ID: `keyterm:Love`); prier (ID: `keyterm:AskFor`); vérité (ID: `keyterm:Truth`); consécration (ID: `keyterm:Consecration.2`); vie (ID: `keyterm:Life`); vrai (ID: `keyterm:True`); Jésus (ID: `person:Jesus.2`); éternellement (ID: `keyterm:Always`); autorité (ID: `keyterm:Authority.2`); atteindre (ID: `keyterm:Destroy`); scripture (ID: `keyterm:Scripture`); ce qui est dit (ID: `keyterm:Word`); Cause of Joy (ID: `keyterm:CauseOfJoy`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); corps (ID: `keyterm:Body.3`); To Cause to Happen (ID: `keyterm:Happen`); être juste (ID: `keyterm:Just`); saint (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Judas (ID: `person:Judas.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); Pierre (ID: `person:Peter`); Nazareth (ID: `place:Nazareth`); Military Members (ID: `group:MilitaryMembers`); Malchus (ID: `person:Malchus`); nom (ID: `keyterm:Name`); Pharisien (ID: `group:Pharisee`); Cédron (ID: `place:Kidron`); Éternel (ID: `deity:Lord`); Public Officials (ID: `group:GenericOfficials`); To Cause to Happen (ID: `keyterm:Happen`); Torch (ID: `realia:Torch`); Lantern (ID: `realia:Lantern`); Sheath (ID: `realia:Sheath`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Pilate (ID: `person:Pilate`); Jews (ID: `group:Jews`); vérité (ID: `keyterm:Truth`); sacrifice de la pâque (ID: `keyterm:Passover`); capacité (ID: `keyterm:Ability`); Palace (ID: `realia:Palace`); Be Lawful (ID: `keyterm:Lawful`); Caïphe (ID: `person:Caiaphas`); Barabbas (ID: `person:Barabbas`); témoigner (ID: `keyterm:BearWitness`); régne (ID: `keyterm:Kingdom`); pollution (ID: `keyterm:Defilement`); decider (ID: `keyterm:Decided`); loi (ID: `keyterm:Law`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** Pilate (ID: `person:Pilate`); Jésus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Cross (ID: `realia:Cross`); Tibère (ID: `person:Tiberius`); capacité (ID: `keyterm:Ability`); autorité (ID: `keyterm:Authority.2`); Brier (ID: `flora:Brier`); Cloak (ID: `realia:Cloak`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Crown (ID: `realia:Crown`); Crown (ID: `realia:Crown.2`); Gabbatha (ID: `place:Gabbatha`); sacrifice de la pâque (ID: `keyterm:Passover`); pécher (ID: `keyterm:Sin`); sois obligé (ID: `keyterm:Ought`); loi (ID: `keyterm:Law`); craindre (ID: `keyterm:Fear`); Judgment Seat (ID: `realia:JudgmentSeat`); Palace (ID: `realia:Palace`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Cross (ID: `realia:Cross`); Pilate (ID: `person:Pilate`); scripture (ID: `keyterm:Scripture`); Jews (ID: `group:Jews`); To Cause to Happen (ID: `keyterm:Happen`); trans. faire un disciple de (ID: `keyterm:Disciple`); Sour Wine (ID: `realia:SourWine`); Clothing (ID: `realia:Clothing`); Marie (ID: `person:Mary.4`); Nazareth (ID: `place:Nazareth`); Cléopas (ID: `person:Cleopas`); Golgotha (ID: `place:Golgotha`); témoigner (ID: `keyterm:BearWitness`); Marie de Magdala (ID: `person:Marymagdalene`); sabbat (ID: `keyterm:Sabbath`); aimer (ID: `keyterm:Love`); corps (ID: `keyterm:Body.3`); prier (ID: `keyterm:AskFor`); vrai (ID: `keyterm:True`); Priests (ID: `group:GenericPriests`); esprit (ID: `keyterm:Spirit.2`); sang (ID: `keyterm:Blood`); Hyssop (ID: `flora:Hyssop`); Spear (ID: `realia:Spear`); Lot (ID: `realia:Lot`); Tunic (ID: `realia:Tunic.2`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Aloes (ID: `realia:Aloes`); corps (ID: `keyterm:Body.3`); Grave (ID: `realia:Grave`); Nicodème (ID: `person:Nicodemus`); Joseph (ID: `person:Joseph.6`); Arimathée (ID: `place:Arimathea`); trans. faire un disciple de (ID: `keyterm:Disciple`); Pilate (ID: `person:Pilate`); prier (ID: `keyterm:AskFor`); craindre (ID: `keyterm:Fear`); Myrrh (ID: `realia:Myrrh`); Pound (ID: `realia:Pound`); Aloes (ID: `flora:Aloes`); Linen (ID: `realia:Linen`); Myrrh (ID: `flora:Myrrh`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); Grave (ID: `realia:Grave`); Marie de Magdala (ID: `person:Marymagdalene`); Pierre (ID: `person:Peter`); Linen (ID: `realia:Linen`); semaine (ID: `keyterm:Week`); scripture (ID: `keyterm:Scripture`); An Angel (ID: `deity:Angel`); amour (ID: `keyterm:Friendship`); corps (ID: `keyterm:Body.3`); Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); Band of Cloth (ID: `realia:BandOfCloth`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); Thomas (ID: `person:Thomas`); croire (ID: `keyterm:Believe`); faire la paix (ID: `keyterm:Peace`); Éternel (ID: `deity:Lord`); Door (ID: `realia:Door`); pécher (ID: `keyterm:Sin`); pardonner (ID: `keyterm:Forgive`); semaine (ID: `keyterm:Week`); A Group of Disciples (ID: `group:GenericDisciples`); vie (ID: `keyterm:Life`); craindre (ID: `keyterm:Fear`); Saint-Esprit (ID: `deity:HolySpirit`); béni (ID: `keyterm:Happy`); fidelité (ID: `keyterm:Faithfulness`); nom (ID: `keyterm:Name`); exemple (ID: `keyterm:Example`); être infidèle (ID: `keyterm:Unfaithful`); Jews (ID: `group:Jews`); Nail (ID: `realia:Nail`)
