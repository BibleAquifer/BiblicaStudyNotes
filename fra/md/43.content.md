...
* **Associated ACAI Concepts:** témoigner (ID: `keyterm:BearWitness`); vrai (ID: `keyterm:True`); loi (ID: `keyterm:Law`); vie (ID: `keyterm:Life`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Béthanie (ID: `place:Bethany.2`); Strap (ID: `realia:Strap`); Sheep (ID: `fauna:Lamb`); baptême (ID: `keyterm:Baptism`)
...
* **Associated ACAI Concepts:** Nathanaël (ID: `person:Nathanael`); Philippe (ID: `person:Philip`); André (ID: `person:Andrew`); Nazareth (ID: `place:Nazareth`); A Disciple (ID: `person:GenericDisciple`); Jean (ID: `person:John.4`); Bethsaïda (ID: `place:Bethsaida`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Measure (ID: `realia:Measure`); Stone Jar (ID: `realia:StoneJar`); Cana (ID: `place:Cana`); Clay Jar (ID: `realia:ClayJar`); exemple (ID: `keyterm:Example`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); jalousie (ID: `keyterm:Extremely`); Whip (ID: `realia:Whip`); Rope (ID: `realia:Rope`)
...
* **Associated ACAI Concepts:** Nicodème (ID: `person:Nicodemus`); croire (ID: `keyterm:Believe`); sûrement! (ID: `keyterm:Surely`); éternellement (ID: `keyterm:Always`); aimer (ID: `keyterm:Love`); céleste (ID: `keyterm:Heavenly`); esprit (ID: `keyterm:Spirit.2`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Salim (ID: `place:Salim`); Énon (ID: `place:Aenon`); Judéen (ID: `group:Judea`); Jean (ID: `person:John`)
...
* **Associated ACAI Concepts:** Sychar (ID: `place:Sychar`); Jérusalem (ID: `place:Jerusalem`); Shimrath (ID: `group:Samaritan`); adorer (ID: `keyterm:BowDown`); A Woman (ID: `person:GenericFemale`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Galilée (ID: `place:Galilee`); Cana (ID: `place:Cana`); Galiléen (ID: `group:Galilee`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Béthesda (ID: `place:Bethesda`); Pool (ID: `realia:Pool`); Bed (ID: `realia:Bed`); porte des brebis (ID: `place:SheepGate`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** tribunal (ID: `keyterm:CourtCase`); jugement (ID: `keyterm:Judgment`); vie (ID: `keyterm:Life`); faire vivre (ID: `keyterm:Alive`); être juste (ID: `keyterm:Just`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** lettre de l'alphabet (ID: `keyterm:Letter`); scripture (ID: `keyterm:Scripture`); témoigner (ID: `keyterm:BearWitness`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Barley (ID: `flora:Barley`); Stade (ID: `realia:Stade`); Sea of Galilee (ID: `place:GalileeSea`); Capernaüm (ID: `place:Capernaum`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** corps (ID: `keyterm:Body.3`); Tibériade (ID: `place:Tiberias`); Capernaüm (ID: `place:Capernaum`); vie (ID: `keyterm:Life`); éternellement (ID: `keyterm:Always`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); croire (ID: `keyterm:Believe`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Festival of the Tabernacles (ID: `realia:FestivalOfTheTabernacles`); Relatives (ID: `group:Relatives`); Judée (ID: `place:Judea`); Galilée (ID: `place:Galilee`); méfaits (ID: `keyterm:UnjustDeed`); être juste (ID: `keyterm:Just`); Jews (ID: `group:Jews`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Nicodème (ID: `person:Nicodemus`); Bethléhem (ID: `place:Bethlehem`)
...
* **Associated ACAI Concepts:** Treasury (ID: `realia:Treasury`); vrai (ID: `keyterm:True`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** servir (ID: `keyterm:Serve.2`); vrai (ID: `keyterm:True`); trans. faire un disciple de (ID: `keyterm:Disciple`); Abraham (ID: `person:Abraham`); vérité (ID: `keyterm:Truth`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Parents (ID: `group:Parents`); A Blind Man (ID: `person:BlindMan`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** travailleur employé (ID: `keyterm:HiredWorker`); Sheepfold (ID: `realia:Sheepfold`); A Blind Man (ID: `person:BlindMan`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** parler contre dieu (ID: `keyterm:Blaspheme`); Porch (ID: `realia:Porch`); éternellement (ID: `keyterm:Always`); Jourdain (ID: `place:Jordan`); croire (ID: `keyterm:Believe`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Lazare (ID: `person:Lazarus.2`); intrans. trébucher (ID: `keyterm:Stumble`); Marie (ID: `person:Mary.3`); Marthe (ID: `person:Martha`); Béthanie (ID: `place:Bethany`); Thomas (ID: `person:Thomas`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** résurrection (ID: `keyterm:Resurrection`); Band of Cloth (ID: `realia:BandOfCloth`); Lazare (ID: `person:Lazarus.2`); Béthanie (ID: `place:Bethany`); Marie (ID: `person:Mary.3`); Marthe (ID: `person:Martha`); Jews (ID: `group:Jews`); croire (ID: `keyterm:Believe`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Caïphe (ID: `person:Caiaphas`); sacrifice de la pâque (ID: `keyterm:Passover`)
...
* **Associated ACAI Concepts:** Lazare (ID: `person:Lazarus.2`); Pound (ID: `realia:Pound`); Oil of Nard (ID: `realia:OilOfNard`); Money Box (ID: `realia:MoneyBox`); Nard (ID: `flora:Nard`); Marie (ID: `person:Mary.3`); Marthe (ID: `person:Martha`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Philippe (ID: `person:Philip`); Donkey (ID: `fauna:Donkey`); hosanna [en araméen] (ID: `keyterm:Hosanna`); Date Palm (ID: `flora:DatePalm`); Grain (ID: `flora:Grain`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Towel (ID: `realia:Towel`); pur (ID: `keyterm:Clean`); Bowl (ID: `realia:Bowl`)
...
* **Associated ACAI Concepts:** Money Box (ID: `realia:MoneyBox`); Simon (ID: `person:Simon.7`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Philippe (ID: `person:Philip`); commandement (ID: `keyterm:Commandment`); nom (ID: `keyterm:Name`); vérité (ID: `keyterm:Truth`); Saint-Esprit (ID: `deity:HolySpirit`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Judas (ID: `person:Judas`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** choisi (ID: `keyterm:Chosen`); prescrire (ID: `keyterm:Command`); amour (ID: `keyterm:Friendship`); aimer (ID: `keyterm:Love`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Cause of Joy (ID: `keyterm:CauseOfJoy`); prier (ID: `keyterm:AskFor`); courage! prends courage! bon courage! (ID: `keyterm:CheerUp`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** vérité (ID: `keyterm:Truth`); atteindre (ID: `keyterm:Destroy`); autorité (ID: `keyterm:Authority.2`); capacité (ID: `keyterm:Ability`); gloire (ID: `keyterm:Glory`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Malchus (ID: `person:Malchus`); Lantern (ID: `realia:Lantern`); Military Members (ID: `group:MilitaryMembers`); Torch (ID: `realia:Torch`); Sheath (ID: `realia:Sheath`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Caïphe (ID: `person:Caiaphas`); Anne (ID: `person:Annas`); Pierre (ID: `person:Peter`); trans. faire un disciple de (ID: `keyterm:Disciple`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Be Lawful (ID: `keyterm:Lawful`); Pilate (ID: `person:Pilate`); Jews (ID: `group:Jews`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Pilate (ID: `person:Pilate`); Gabbatha (ID: `place:Gabbatha`); Tibère (ID: `person:Tiberius`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Marie (ID: `person:Mary.4`); Sour Wine (ID: `realia:SourWine`); Cléopas (ID: `person:Cleopas`); Hyssop (ID: `flora:Hyssop`); Nazareth (ID: `place:Nazareth`); Spear (ID: `realia:Spear`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Aloes (ID: `realia:Aloes`); Pound (ID: `realia:Pound`); Grave (ID: `realia:Grave`); Aloes (ID: `flora:Aloes`); Arimathée (ID: `place:Arimathea`); Nicodème (ID: `person:Nicodemus`); Joseph (ID: `person:Joseph.6`); Myrrh (ID: `realia:Myrrh`)
...
* **Associated ACAI Concepts:** Marie de Magdala (ID: `person:Marymagdalene`); Band of Cloth (ID: `realia:BandOfCloth`); Grave (ID: `realia:Grave`); trans. faire un disciple de (ID: `keyterm:Disciple`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Thomas (ID: `person:Thomas`); Jésus (ID: `person:Jesus.2`); Nail (ID: `realia:Nail`); trans. faire un disciple de (ID: `keyterm:Disciple`)
...
* **Associated ACAI Concepts:** Fish (ID: `fauna:Fish`); Casting Net (ID: `realia:CastingNet`); Nathanaël (ID: `person:Nathanael`); trans. faire un disciple de (ID: `keyterm:Disciple`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Pierre (ID: `person:Peter`); Jean (ID: `person:John.4`); amour (ID: `keyterm:Friendship`); Jésus (ID: `person:Jesus.2`)
