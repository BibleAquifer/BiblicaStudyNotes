...
* **Associated ACAI Concepts:** Philémon (ID: `person:Philemon`); Apphia (ID: `person:Apphia`); Archippe (ID: `person:Archippus`); Onésime (ID: `person:Onesimus`); Épaphras (ID: `person:Epaphras`); Démas (ID: `person:Demas`); Luc (ID: `person:Luke`); Guest Room (ID: `realia:GuestRoom`); devoir (qch) à [qqn] (ID: `keyterm:Owe`); Jésus (ID: `person:Jesus.2`)
