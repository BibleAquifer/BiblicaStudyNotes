...
* **Associated ACAI Concepts:** David (ID: `person:David`); Jésus (ID: `person:Jesus.2`); Babylone (ID: `place:Babylon`); Abraham (ID: `person:Abraham`); Jacob (ID: `person:Jacob.2`); Azor (ID: `person:Azor`); Éliud (ID: `person:Eliud`); Zorobabel (ID: `person:Zerubbabel.2`); Ozias (ID: `person:Uzziah`); Josias (ID: `person:Josiah`); Ézéchias (ID: `person:Hezekiah`); Asa (ID: `person:Asa`); Jojakin (ID: `person:Jehoiachin`); Salmon (ID: `person:Salmon`); Ram (ID: `person:Ram`); Salomon (ID: `person:Solomon`); Isaï (ID: `person:Jesse`); Juda (ID: `person:Judah.4`); Achim (ID: `person:Achim`); Zérach (ID: `person:Zerah.3`); Josaphat (ID: `person:Jehoshaphat.3`); Isaac (ID: `person:Isaac`); Boaz (ID: `person:Boaz`); Éliakim (ID: `person:Eliakim`); Tsadok (ID: `person:Zadok`); Achaz (ID: `person:Ahaz`); Éléazar (ID: `person:Eleazar`); Matthan (ID: `person:Matthan`); Abijah (ID: `person:Abijah.4`); Hetsron (ID: `person:Hezron.2`); Nahshon (ID: `person:Nahshon`); Perets (ID: `person:Perez`); Roboam (ID: `person:Rehoboam`); Joram (ID: `person:Jehoram`); Obed (ID: `person:Obed`); Tamar (ID: `person:Tamar`); Abiud (ID: `person:Abiud`); Jotham (ID: `person:Jotham.2`); Amon (ID: `person:Amon.3`); Joseph (ID: `person:Joseph.4`); Rahab (ID: `person:Rahab`); Israël (ID: `person:Israel`); Amminadab (ID: `person:Amminadab`); Urie (ID: `person:Uriah`); Ruth (ID: `person:Ruth`); Schealthiel (ID: `person:Shealtiel.2`); Manassé (ID: `person:Manasseh.2`); Marie (ID: `person:Mary`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Joseph (ID: `person:Joseph.4`); Éternel (ID: `deity:Lord`); nom (ID: `keyterm:Name`); Marie (ID: `person:Mary`); Saint-Esprit (ID: `deity:HolySpirit`); An Angel (ID: `deity:Angel`); To Cause to Happen (ID: `keyterm:Happen`); être fiancé (ID: `keyterm:Engaged`); craindre (ID: `keyterm:Fear`); David (ID: `person:David`); aide (ID: `keyterm:Salvation`); pécher (ID: `keyterm:Sin`); être juste (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** Hérode (ID: `person:Herod`); Bethléhem (ID: `place:Bethlehem`); Égypte (ID: `place:Egypt`); adorer (ID: `keyterm:BowDown`); Judée (ID: `place:Judea`); Éternel (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); Israël (ID: `person:Israel`); Joseph (ID: `person:Joseph.4`); An Angel (ID: `deity:Angel`); Jérusalem (ID: `place:Jerusalem`); Jésus (ID: `person:Jesus.2`); Nazareth (ID: `place:Nazareth`); Archélaüs (ID: `person:Archelaus`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Jérémie (ID: `person:Jeremiah.6`); offrande (ID: `keyterm:Offering`); Priests (ID: `group:GenericPriests`); prier (ID: `keyterm:AskFor`); A Priest (ID: `person:GenericPriest`); craindre (ID: `keyterm:Fear`); prier (ID: `keyterm:Encourage`); Religious Officials (ID: `group:ReligiousOfficials`); Galilée (ID: `place:Galilee`); Rachel (ID: `person:Rachel`); Marie (ID: `person:Mary`); vie (ID: `keyterm:Life`); Ramah (ID: `place:Ramah.2`); Juda (ID: `person:Judah.4`); Jews (ID: `group:Jews`); Frankincense (ID: `flora:Frankincense`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Money Box (ID: `realia:MoneyBox`); Incense (ID: `realia:Incense`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** se repentir (ID: `keyterm:Repent`); baptême (ID: `keyterm:Baptism`); Judée (ID: `place:Judea`); Jean (ID: `person:John`); Éternel (ID: `deity:Lord`); Jourdain (ID: `place:Jordan`); Ésaïe (ID: `person:Isaiah`); baptiste [jean] (ID: `keyterm:Baptist`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); proclamer (ID: `keyterm:Proclaim`); Abraham (ID: `person:Abraham`); Pharisien (ID: `group:Pharisee`); régne (ID: `keyterm:Kingdom`); Jérusalem (ID: `place:Jerusalem`); Sadducéens (ID: `group:Sadducee`); droiture (ID: `keyterm:Straightness`); Saint-Esprit (ID: `deity:HolySpirit`); nettoyer (ID: `keyterm:CleanOut`); pécher (ID: `keyterm:Sin`); Locust (ID: `fauna:Locust`); Threshing Floor (ID: `realia:ThreshingFloor`); Leather (ID: `realia:Leather`); Belt (ID: `realia:Belt`); Winnowing Fork (ID: `realia:WinnowingFork`); Sandal (ID: `realia:Sandal`); Clothing (ID: `realia:Clothing`); Snake (ID: `fauna:Snake`); Grain (ID: `flora:Grain`); Bag (ID: `realia:Bag`); Camel (ID: `fauna:Camel`); Bee (ID: `fauna:Bee`); Wheat (ID: `flora:Wheat`); Barn (ID: `realia:Barn`); Axe (ID: `realia:Axe`)
...
* **Associated ACAI Concepts:** baptême (ID: `keyterm:Baptism`); Jésus (ID: `person:Jesus.2`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Jean (ID: `person:John`); Jourdain (ID: `place:Jordan`); To Cause to Happen (ID: `keyterm:Happen`); Saint-Esprit (ID: `deity:HolySpirit`); Éternel (ID: `deity:Lord`); être juste (ID: `keyterm:Just`); Galilée (ID: `place:Galilee`); bien, aimé (ID: `keyterm:Beloved`); Dove (ID: `fauna:Dove`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); mis à l'essai (ID: `keyterm:PutToTheTest`); adorer (ID: `keyterm:BowDown`); prescrire (ID: `keyterm:Command`); An Angel (ID: `deity:Angel`); servir (ID: `keyterm:Serve`); ce qui est dit (ID: `keyterm:Word`); sacerdoce (ID: `keyterm:Priesthood`); régne (ID: `keyterm:Kingdom`); Satan (ID: `deity:Satan`); capacité (ID: `keyterm:Ability`); vie (ID: `keyterm:Life`); Saint-Esprit (ID: `deity:HolySpirit`); jeûner (ID: `keyterm:Fast`); saint (ID: `keyterm:Holy`); gloire (ID: `keyterm:Glory`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Galilée (ID: `place:Galilee`); Zabulon (ID: `person:Zebulun`); Zabulon (ID: `group:Zebulun`); Nephthali (ID: `person:Naphtali`); se repentir (ID: `keyterm:Repent`); Nazareth (ID: `place:Nazareth`); proclamer (ID: `keyterm:Proclaim`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); To Cause to Happen (ID: `keyterm:Happen`); Capernaüm (ID: `place:Capernaum`); régne (ID: `keyterm:Kingdom`); Jésus (ID: `person:Jesus.2`); Jourdain (ID: `place:Jordan`); Jean (ID: `person:John`); Ésaïe (ID: `person:Isaiah`); nation; peuple (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** Casting Net (ID: `realia:CastingNet`); Galilée (ID: `place:Galilee`); servir (ID: `keyterm:Serve`); André (ID: `person:Andrew`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Zébédée (ID: `person:Zebedee`); Jean (ID: `person:John.2`); bonnes nouvelles (ID: `keyterm:GoodNews`); Sea of Galilee (ID: `place:GalileeSea`); Décapole (ID: `place:Decapolis`); Jacques (ID: `person:James`); être possédé par un démon (ID: `keyterm:DemonPossessed`); proclamer (ID: `keyterm:Proclaim`); Judée (ID: `place:Judea`); régne (ID: `keyterm:Kingdom`); Jérusalem (ID: `place:Jerusalem`); Jourdain (ID: `place:Jordan`); Pierre (ID: `person:Peter`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** béni (ID: `keyterm:Happy`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); régne (ID: `keyterm:Kingdom`); Éternel (ID: `deity:Lord`); être juste (ID: `keyterm:Just`); coeur (ID: `keyterm:Heart`); pitié (ID: `keyterm:Mercy`); prier (ID: `keyterm:AskFor`); prier (ID: `keyterm:Encourage`); trans. faire un disciple de (ID: `keyterm:Disciple`); esprit (ID: `keyterm:Spirit.2`); pur (ID: `keyterm:Clean`)
...
* **Associated ACAI Concepts:** cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); loi (ID: `keyterm:Law`); régne (ID: `keyterm:Kingdom`); commandement (ID: `keyterm:Commandment`); Pharisien (ID: `group:Pharisee`); capacité (ID: `keyterm:Ability`); sûrement! (ID: `keyterm:Surely`); Éternel (ID: `deity:Lord`); être juste (ID: `keyterm:Just`); gloire (ID: `keyterm:Glory`); Lampstand (ID: `realia:Lampstand.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); fornication (ID: `keyterm:Fornication`); enfer (ID: `keyterm:Gehenna`); Hell (ID: `place:Hell`); aimer (ID: `keyterm:Love`); tribunal (ID: `keyterm:CourtCase`); offrande (ID: `keyterm:Offering`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); faire pécher qqn (ID: `keyterm:CauseToStumble`); corps (ID: `keyterm:Body.3`); jugement (ID: `keyterm:Judgment`); réconcilier (ID: `keyterm:Reconcile`); adjuration (ID: `keyterm:Oath`); céleste (ID: `keyterm:Heavenly`); le bien (ID: `keyterm:Good`); coeur (ID: `keyterm:Heart`); decider (ID: `keyterm:Decided`); être juste (ID: `keyterm:Just`); Jérusalem (ID: `place:Jerusalem`); prier (ID: `keyterm:Pray`); collecteur d'impôt (ID: `keyterm:TaxCollector`); sûrement! (ID: `keyterm:Surely`); Footstool (ID: `realia:Footstool`); Cloak (ID: `realia:Cloak`); Quadrans (ID: `realia:Quadrans`); Mile (ID: `realia:Mile`); Prison (ID: `realia:Prison`); Tunic (ID: `realia:Tunic.2`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); prier (ID: `keyterm:Pray`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); pardonner (ID: `keyterm:Forgive`); sûrement! (ID: `keyterm:Surely`); Synagogue (ID: `realia:Synagogue`); régne (ID: `keyterm:Kingdom`); conduis (ID: `keyterm:BringIn`); amour (ID: `keyterm:Friendship`); dette (ID: `keyterm:Wrong`); être juste (ID: `keyterm:Just`); mis à l'essai (ID: `keyterm:PutToTheTest`); nom (ID: `keyterm:Name`); céleste (ID: `keyterm:Heavenly`); saint (ID: `keyterm:Holy`); gloire (ID: `keyterm:Glory`); sauver (ID: `keyterm:Deliver`); Inner Room (ID: `realia:InnerRoom`); Door (ID: `realia:Door`); Cornerstone (ID: `realia:Cornerstone`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); jeûner (ID: `keyterm:Fast`); corps (ID: `keyterm:Body.3`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); céleste (ID: `keyterm:Heavenly`); Clothing (ID: `realia:Clothing`); Moth (ID: `fauna:Moth`); qui manque de foi (ID: `keyterm:HavingLittleFaith`); coeur (ID: `keyterm:Heart`); régne (ID: `keyterm:Kingdom`); être juste (ID: `keyterm:Just`); servir (ID: `keyterm:Serve.2`); vie (ID: `keyterm:Life`); oint (ID: `keyterm:Anointed`); sûrement! (ID: `keyterm:Surely`); Salomon (ID: `person:Solomon`); gloire (ID: `keyterm:Glory`); aimer (ID: `keyterm:Love`); Oven (ID: `realia:Oven`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Barn (ID: `realia:Barn`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Beam (ID: `realia:Beam`); decider (ID: `keyterm:Decided`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); jugement (ID: `keyterm:Judgment`); Éternel (ID: `deity:Lord`); loi (ID: `keyterm:Law`); saint (ID: `keyterm:Holy`); Snake (ID: `fauna:Snake`); Fish (ID: `fauna:Fish`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); Dog (ID: `fauna:Dog`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); corruption morale (ID: `keyterm:Lawless`); atteindre (ID: `keyterm:Destroy`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); régne (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); nom (ID: `keyterm:Name`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); vie (ID: `keyterm:Life`); parler (ID: `keyterm:Speak`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Clothing (ID: `realia:Clothing`); Wolf (ID: `fauna:Wolf`); Fig (ID: `flora:Fig`); Sheep (ID: `fauna:Lamb`); Vine (ID: `flora:Vine`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); autorité (ID: `keyterm:Authority.2`); Jésus (ID: `person:Jesus.2`); capacité (ID: `keyterm:Ability`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); servir (ID: `keyterm:Serve`); purifier (ID: `keyterm:Cleanse.2`); croire (ID: `keyterm:Believe`); régne (ID: `keyterm:Kingdom`); Israël (ID: `person:Israel`); House (ID: `realia:House`); être possédé par un démon (ID: `keyterm:DemonPossessed`); Centurion With Sick Servant (ID: `person:Centurion.2`); lèpre (ID: `keyterm:InfectiousSkinDisease`); témoigner (ID: `keyterm:BearWitness`); offrande (ID: `keyterm:Offering`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); autorité (ID: `keyterm:Authority.2`); prier (ID: `keyterm:AskFor`); prescrire (ID: `keyterm:Command`); Isaac (ID: `person:Isaac`); les ténèbres du dehors (ID: `keyterm:OuterDarkness`); Abraham (ID: `person:Abraham`); Ésaïe (ID: `person:Isaiah`); adorer (ID: `keyterm:BowDown`); capacité (ID: `keyterm:Ability`); Moïse (ID: `person:Moses`); Capernaüm (ID: `place:Capernaum`); To Cause to Happen (ID: `keyterm:Happen`); sûrement! (ID: `keyterm:Surely`); Pierre (ID: `person:Peter`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Jackal (ID: `fauna:Jackal`); Pig (ID: `fauna:Pig`); être possédé par un démon (ID: `keyterm:DemonPossessed`); prier (ID: `keyterm:AskFor`); trans. faire un disciple de (ID: `keyterm:Disciple`); Ship (ID: `realia:Ship`); qui manque de foi (ID: `keyterm:HavingLittleFaith`); prescrire (ID: `keyterm:Command`); Religious Official (ID: `person:ReligiousOfficial`); A Disciple (ID: `person:GenericDisciple`); autorité (ID: `keyterm:Authority.2`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Gerasa (ID: `place:Gerasa`); aide (ID: `keyterm:Salvation`); Grave (ID: `realia:Grave`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); pardonner (ID: `keyterm:Forgive`); pécher (ID: `keyterm:Sin`); trans. faire un disciple de (ID: `keyterm:Disciple`); House (ID: `realia:House`); collecteur d'impôt (ID: `keyterm:TaxCollector`); autorité (ID: `keyterm:Authority.2`); Pharisien (ID: `group:Pharisee`); capacité (ID: `keyterm:Ability`); jeûner (ID: `keyterm:Fast`); Temple (ID: `realia:Temple`); Bed (ID: `realia:Bed`); pitié (ID: `keyterm:Mercy`); Matthieu (ID: `person:Matthew`); coeur (ID: `keyterm:Heart`); offrande (ID: `keyterm:Offering`); parler contre dieu (ID: `keyterm:Blaspheme`); Be Healthy (ID: `keyterm:Healthy`); craindre (ID: `keyterm:Fear`); être juste (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); courage! prends courage! bon courage! (ID: `keyterm:CheerUp`); Éternel (ID: `deity:Lord`); bureau de perception (ID: `keyterm:TaxOffice`); croire (ID: `keyterm:Believe`); gloire (ID: `keyterm:Glory`); Jean (ID: `person:John`); Patch (ID: `realia:Patch`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Ship (ID: `realia:Ship`); Skin-Bottle (ID: `realia:Skin-bottle`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); croire (ID: `keyterm:Believe`); Demons (ID: `deity:Demons`); aide (ID: `keyterm:Salvation`); trans. faire un disciple de (ID: `keyterm:Disciple`); House (ID: `realia:House`); Cloak (ID: `realia:Cloak`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); prier (ID: `keyterm:AskFor`); être possédé par un démon (ID: `keyterm:DemonPossessed`); bonnes nouvelles (ID: `keyterm:GoodNews`); proclamer (ID: `keyterm:Proclaim`); Pharisien (ID: `group:Pharisee`); régne (ID: `keyterm:Kingdom`); David (ID: `person:David`); pitié (ID: `keyterm:Mercy`); adorer (ID: `keyterm:BowDown`); courage! prends courage! bon courage! (ID: `keyterm:CheerUp`); vie (ID: `keyterm:Life`); saigner (ID: `keyterm:Bleed`); Israël (ID: `person:Israel`); servir (ID: `keyterm:Serve`); Tassel (ID: `realia:Tassel`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Goat (ID: `fauna:Goat`); Flute (ID: `realia:Flute`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); servir (ID: `keyterm:Serve`); Bag (ID: `realia:Bag`); Barthélemy (ID: `person:Bartholomew`); Alphée (ID: `person:Alphaeus`); faire la paix (ID: `keyterm:Peace`); Judas (ID: `person:Judas.2`); Thomas (ID: `person:Thomas`); Judas (ID: `person:Judas`); zélote; nationaliste (ID: `group:Zealot`); Jacques (ID: `person:James.2`); Simon (ID: `person:Simon.2`); Philippe (ID: `person:Philip`); purifier (ID: `keyterm:Cleanse.2`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); autorité (ID: `keyterm:Authority.2`); Samarie (ID: `place:Samaria`); tribunal (ID: `keyterm:CourtCase`); Jean (ID: `person:John.2`); Zébédée (ID: `person:Zebedee`); Shimrath (ID: `group:Samaritan`); proclamer (ID: `keyterm:Proclaim`); régne (ID: `keyterm:Kingdom`); André (ID: `person:Andrew`); Demons (ID: `deity:Demons`); Sodome (ID: `place:Sodom`); Gomorrhe (ID: `place:Gomorrah`); nom (ID: `keyterm:Name`); capacité (ID: `keyterm:Ability`); Matthieu (ID: `person:Matthew`); nation; peuple (ID: `group:Gentile`); résurrection (ID: `keyterm:Resurrection`); collecteur d'impôt (ID: `keyterm:TaxCollector`); Jésus (ID: `person:Jesus.2`); jugement (ID: `keyterm:Judgment`); sûrement! (ID: `keyterm:Surely`); Jacques (ID: `person:James`); Israël (ID: `person:Israel`); Pierre (ID: `person:Peter`); trans. faire un disciple de (ID: `keyterm:Disciple`); Staff (ID: `realia:Staff`); Belt (ID: `realia:Belt`); Sheep (ID: `fauna:Lamb`); Tunic (ID: `realia:Tunic.2`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); craindre (ID: `keyterm:Fear`); nom (ID: `keyterm:Name`); trans. faire un disciple de (ID: `keyterm:Disciple`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); sûrement! (ID: `keyterm:Surely`); Sparrow (ID: `fauna:Sparrow`); enfer (ID: `keyterm:Gehenna`); témoigner (ID: `keyterm:BearWitness`); prescrire (ID: `keyterm:Command`); amour (ID: `keyterm:Friendship`); proclamer (ID: `keyterm:Proclaim`); faire la paix (ID: `keyterm:Peace`); être juste (ID: `keyterm:Just`); Hell (ID: `place:Hell`); Satan (ID: `deity:Satan`); nation; peuple (ID: `group:Gentile`); corps (ID: `keyterm:Body.3`); vie (ID: `keyterm:Life`); Saint-Esprit (ID: `deity:HolySpirit`); aide (ID: `keyterm:Salvation`); Israël (ID: `person:Israel`); Wolf (ID: `fauna:Wolf`); Assarion (ID: `realia:Assarion`); Snake (ID: `fauna:Snake`); Cross (ID: `realia:Cross`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Dove (ID: `fauna:Dove`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Jean (ID: `person:John`); Jésus (ID: `person:Jesus.2`); baptiste [jean] (ID: `keyterm:Baptist`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); régne (ID: `keyterm:Kingdom`); trans. faire un disciple de (ID: `keyterm:Disciple`); purifier (ID: `keyterm:Cleanse.2`); béni (ID: `keyterm:Happy`); bonnes nouvelles (ID: `keyterm:GoodNews`); proclamer (ID: `keyterm:Proclaim`); Élie (ID: `person:Elijah`); Demons (ID: `deity:Demons`); être juste (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); loi (ID: `keyterm:Law`); résurrection (ID: `keyterm:Resurrection`); collecteur d'impôt (ID: `keyterm:TaxCollector`); parler (ID: `keyterm:Speak`); sûrement! (ID: `keyterm:Surely`); Reed (ID: `flora:Reed`); Prison (ID: `realia:Prison`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Flute (ID: `realia:Flute`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); se repentir (ID: `keyterm:Repent`); tribunal (ID: `keyterm:CourtCase`); Sodome (ID: `place:Sodom`); Sidon (ID: `place:Sidon`); Tyr (ID: `place:Tyre`); jugement (ID: `keyterm:Judgment`); Yoke (ID: `realia:Yoke`); Chorazin (ID: `place:Chorazin`); Disaster (ID: `keyterm:Disaster`); hadès (ID: `keyterm:WorldOfTheDead`); coeur (ID: `keyterm:Heart`); Bethsaïda (ID: `place:Bethsaida`); Hell (ID: `place:Hell`); Capernaüm (ID: `place:Capernaum`); le bien (ID: `keyterm:Good`); Jésus (ID: `person:Jesus.2`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** sabbat (ID: `keyterm:Sabbath`); Be Lawful (ID: `keyterm:Lawful`); Temple (ID: `realia:Temple`); Pharisien (ID: `group:Pharisee`); trans. faire un disciple de (ID: `keyterm:Disciple`); Sheep (ID: `fauna:Lamb`); offrande (ID: `keyterm:Offering`); David (ID: `person:David`); Jésus (ID: `person:Jesus.2`); condamner (ID: `keyterm:Condemn`); Éternel (ID: `deity:Lord`); pitié (ID: `keyterm:Mercy`); pollution (ID: `keyterm:Defilement`); loi (ID: `keyterm:Law`); Wheat (ID: `flora:Wheat`); House (ID: `realia:House`); Grain (ID: `flora:Grain`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** jugement (ID: `keyterm:Judgment`); nation; peuple (ID: `group:Gentile`); nom (ID: `keyterm:Name`); To Cause to Happen (ID: `keyterm:Happen`); Saint-Esprit (ID: `deity:HolySpirit`); Jésus (ID: `person:Jesus.2`); prescrire (ID: `keyterm:Command`); bien, aimé (ID: `keyterm:Beloved`); Ésaïe (ID: `person:Isaiah`); espoir (ID: `keyterm:Hope`); servir (ID: `keyterm:Serve`); Lamp (ID: `realia:Lamp`); Reed (ID: `flora:Reed`)
...
* **Associated ACAI Concepts:** régne (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); Satan (ID: `deity:Satan`); Saint-Esprit (ID: `deity:HolySpirit`); pardonner (ID: `keyterm:Forgive`); le bien (ID: `keyterm:Good`); parler contre dieu (ID: `keyterm:Blaspheme`); condamner (ID: `keyterm:Condemn`); jugement (ID: `keyterm:Judgment`); coeur (ID: `keyterm:Heart`); désoeuvré (ID: `keyterm:Idle`); être possédé par un démon (ID: `keyterm:DemonPossessed`); tribunal (ID: `keyterm:CourtCase`); Pharisien (ID: `group:Pharisee`); David (ID: `person:David`); éternellement (ID: `keyterm:Always`); ce qui est dit (ID: `keyterm:Word`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); pécher (ID: `keyterm:Sin`); servir (ID: `keyterm:Serve`); House (ID: `realia:House`); Snake (ID: `fauna:Snake`); Cobra (ID: `fauna:Cobra`)
...
* **Associated ACAI Concepts:** Jonas (ID: `person:Jonah.2`); exemple (ID: `keyterm:Example`); tribunal (ID: `keyterm:CourtCase`); jugement (ID: `keyterm:Judgment`); reine de Séba (ID: `person:QueenOfSheba`); Ninive (ID: `group:Nineveh`); coeur (ID: `keyterm:Heart`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); se repentir (ID: `keyterm:Repent`); proclamer (ID: `keyterm:Proclaim`); être infidèle (ID: `keyterm:Unfaithful`); Ninive (ID: `place:Nineveh`); Pharisien (ID: `group:Pharisee`); A Group of People (ID: `group:GenericGroup`); Éternel (ID: `deity:Lord`); Salomon (ID: `person:Solomon`); trans. faire un disciple de (ID: `keyterm:Disciple`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** parabole (ID: `keyterm:Parable`); coeur (ID: `keyterm:Heart`); régne (ID: `keyterm:Kingdom`); Brier (ID: `flora:Brier`); Thistle (ID: `flora:Thistle`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); béni (ID: `keyterm:Happy`); A Group of Disciples (ID: `group:GenericDisciples`); être juste (ID: `keyterm:Just`); Ésaïe (ID: `person:Isaiah`); éternellement (ID: `keyterm:Always`); capacité (ID: `keyterm:Ability`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Jésus (ID: `person:Jesus.2`); sûrement! (ID: `keyterm:Surely`); trans. faire un disciple de (ID: `keyterm:Disciple`); House (ID: `realia:House`); Bird (ID: `fauna:Bird`); Ship (ID: `realia:Ship`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** régne (ID: `keyterm:Kingdom`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); parabole (ID: `keyterm:Parable`); Weed (ID: `flora:Weed`); Grain (ID: `flora:Grain`); An Angel (ID: `deity:Angel`); éternellement (ID: `keyterm:Always`); Wheat (ID: `flora:Wheat`); être juste (ID: `keyterm:Just`); trans. faire un disciple de (ID: `keyterm:Disciple`); Kiln (ID: `realia:Kiln`); Grass (ID: `flora:Grass`); corruption morale (ID: `keyterm:Lawless`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); To Cause to Happen (ID: `keyterm:Happen`); Jésus (ID: `person:Jesus.2`); Dragnet (ID: `realia:Dragnet`); Saton (ID: `realia:Saton`); Mustard (ID: `flora:Mustard`); Storeroom (ID: `realia:Storeroom`); House (ID: `realia:House`); Barn (ID: `realia:Barn`); Container (ID: `realia:Container`)
...
* **Associated ACAI Concepts:** Jean (ID: `person:John`); Jésus (ID: `person:Jesus.2`); Hérode Antipas (ID: `person:Herod.2`); capacité (ID: `keyterm:Ability`); Hérodias (ID: `person:Herodias`); adjuration (ID: `keyterm:Oath`); baptiste [jean] (ID: `keyterm:Baptist`); Prison (ID: `realia:Prison`); Plate (ID: `realia:Plate.2`); Jude (ID: `person:Jude`); Simon (ID: `person:Simon.3`); ne pas réussir ou refuser de croire (ID: `keyterm:Disbelieve`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Jacques (ID: `person:James.3`); Philippe (ID: `person:Philip.2`); craindre (ID: `keyterm:Fear`); Be Lawful (ID: `keyterm:Lawful`); Marie (ID: `person:Mary`); Joseph (ID: `person:Joseph.4`); résurrection (ID: `keyterm:Resurrection`); parabole (ID: `keyterm:Parable`); trans. faire un disciple de (ID: `keyterm:Disciple`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); Fish (ID: `fauna:Fish`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); benir (ID: `keyterm:Bless`); servir (ID: `keyterm:Serve`); Basket (ID: `realia:Basket`); Ship (ID: `realia:Ship`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); craindre (ID: `keyterm:Fear`); Jésus (ID: `person:Jesus.2`); aide (ID: `keyterm:Salvation`); Pierre (ID: `person:Peter`); trans. faire un disciple de (ID: `keyterm:Disciple`); qui manque de foi (ID: `keyterm:HavingLittleFaith`); Génésareth (ID: `place:Gennesaret`); courage! prends courage! bon courage! (ID: `keyterm:CheerUp`); adorer (ID: `keyterm:BowDown`); prier (ID: `keyterm:AskFor`); vrai (ID: `keyterm:True`); prier (ID: `keyterm:Pray`); Tassel (ID: `realia:Tassel`); Stade (ID: `realia:Stade`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); se rendre (ID: `keyterm:Teaching`); coeur (ID: `keyterm:Heart`); pollution (ID: `keyterm:Defilement`); Pharisien (ID: `group:Pharisee`); trans. faire un disciple de (ID: `keyterm:Disciple`); offrande (ID: `keyterm:Offering`); parler contre dieu (ID: `keyterm:Blaspheme`); adorer (ID: `keyterm:Worship`); A Group of Disciples (ID: `group:GenericDisciples`); commandement (ID: `keyterm:Commandment`); Ésaïe (ID: `person:Isaiah`); Jérusalem (ID: `place:Jerusalem`); céleste (ID: `keyterm:Heavenly`); fornication (ID: `keyterm:Fornication`); parabole (ID: `keyterm:Parable`); Jésus (ID: `person:Jesus.2`); parler (ID: `keyterm:Speak`); Pierre (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Dog (ID: `fauna:Dog`); Tyr (ID: `place:Tyre`); Syrophonecian Woman (ID: `person:SyrophonecianWoman`); Sidon (ID: `place:Sidon`); croire (ID: `keyterm:Believe`); bien (ID: `keyterm:Honest`); adorer (ID: `keyterm:BowDown`); prier (ID: `keyterm:AskFor`); David (ID: `person:David`); être possédé par un démon (ID: `keyterm:DemonPossessed`); Canaan (ID: `group:Canaan`); Israël (ID: `person:Israel`); pitié (ID: `keyterm:Mercy`); trans. faire un disciple de (ID: `keyterm:Disciple`); Canaan (ID: `place:Canaan`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Fish (ID: `fauna:Fish`); Magadan (ID: `place:Magadan`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`); gloire (ID: `keyterm:Glory`); Sea of Galilee (ID: `place:GalileeSea`); servir (ID: `keyterm:Serve`); Ship (ID: `realia:Ship`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Sadducéens (ID: `group:Sadducee`); Pharisien (ID: `group:Pharisee`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); exemple (ID: `keyterm:Example`); Jésus (ID: `person:Jesus.2`); Basket (ID: `realia:Basket`); qui manque de foi (ID: `keyterm:HavingLittleFaith`); évaluer (ID: `keyterm:Discern`); trans. faire un disciple de (ID: `keyterm:Disciple`); Jonas (ID: `person:Jonah.2`); être infidèle (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Pierre (ID: `person:Peter`); trans. faire un disciple de (ID: `keyterm:Disciple`); Éternel (ID: `deity:Lord`); vie (ID: `keyterm:Life`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Césarée de Philippe (ID: `place:CaesareaPhilippi`); église (ID: `keyterm:Church`); prier (ID: `keyterm:AskFor`); prescrire (ID: `keyterm:Command`); béni (ID: `keyterm:Happy`); A Group of Disciples (ID: `group:GenericDisciples`); Élie (ID: `person:Elijah`); régne (ID: `keyterm:Kingdom`); penser (ID: `keyterm:Think`); Jean (ID: `person:John.4`); An Angel (ID: `deity:Angel`); Jérusalem (ID: `place:Jerusalem`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); baptiste [jean] (ID: `keyterm:Baptist`); Hell (ID: `place:Hell`); hadès (ID: `keyterm:WorldOfTheDead`); Satan (ID: `deity:Satan`); capacité (ID: `keyterm:Ability`); corps (ID: `keyterm:Body.3`); sang (ID: `keyterm:Blood`); résurrection (ID: `keyterm:Resurrection`); Jérémie (ID: `person:Jeremiah.6`); aide (ID: `keyterm:Salvation`); gloire (ID: `keyterm:Glory`); Jean (ID: `person:John`); Key (ID: `realia:Key`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Élie (ID: `person:Elijah`); Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); craindre (ID: `keyterm:Fear`); Moïse (ID: `person:Moses`); Pierre (ID: `person:Peter`); résurrection (ID: `keyterm:Resurrection`); baptiste [jean] (ID: `keyterm:Baptist`); régne (ID: `keyterm:Kingdom`); prescrire (ID: `keyterm:Command`); sûrement! (ID: `keyterm:Surely`); bien, aimé (ID: `keyterm:Beloved`); Jacques (ID: `person:James`); Jean (ID: `person:John.2`); Jean (ID: `person:John`); Clothing (ID: `realia:Clothing`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Pierre (ID: `person:Peter`); trans. faire un disciple de (ID: `keyterm:Disciple`); servir (ID: `keyterm:Serve`); prescrire (ID: `keyterm:Command`); être infidèle (ID: `keyterm:Unfaithful`); A Group of Disciples (ID: `group:GenericDisciples`); fin (ID: `keyterm:Tax`); Demons (ID: `deity:Demons`); pitié (ID: `keyterm:Mercy`); Galilée (ID: `place:Galilee`); résurrection (ID: `keyterm:Resurrection`); croire (ID: `keyterm:Believe`); Capernaüm (ID: `place:Capernaum`); taxe (ID: `keyterm:PollTax`); sûrement! (ID: `keyterm:Surely`); Mustard (ID: `flora:Mustard`); Stater (ID: `realia:Stater`); Fishhook (ID: `realia:Fishhook`); Two-Drachma Piece (ID: `realia:Two-drachmaPiece`); House (ID: `realia:House`); Fish (ID: `fauna:Fish`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); faire pécher qqn (ID: `keyterm:CauseToStumble`); régne (ID: `keyterm:Kingdom`); vie (ID: `keyterm:Life`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); Disaster (ID: `keyterm:Disaster`); An Angel (ID: `deity:Angel`); éternellement (ID: `keyterm:Always`); nom (ID: `keyterm:Name`); Hell (ID: `place:Hell`); capacité (ID: `keyterm:Ability`); feu éternel (ID: `keyterm:EternalFire`); Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); enfer (ID: `keyterm:Gehenna`); Jésus (ID: `person:Jesus.2`); sûrement! (ID: `keyterm:Surely`); trans. faire un disciple de (ID: `keyterm:Disciple`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** pardonner (ID: `keyterm:Forgive`); devoir (qch) à [qqn] (ID: `keyterm:Owe`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); prier (ID: `keyterm:AskFor`); Éternel (ID: `deity:Lord`); pécher (ID: `keyterm:Sin`); sûrement! (ID: `keyterm:Surely`); témoin (ID: `keyterm:Witness`); coeur (ID: `keyterm:Heart`); régne (ID: `keyterm:Kingdom`); pitié (ID: `keyterm:Mercy`); nom (ID: `keyterm:Name`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); adorer (ID: `keyterm:BowDown`); céleste (ID: `keyterm:Heavenly`); collecteur d'impôt (ID: `keyterm:TaxCollector`); Jésus (ID: `person:Jesus.2`); église (ID: `keyterm:Church`); dette (ID: `keyterm:Debt`); Pierre (ID: `person:Peter`); ce qui est dit (ID: `keyterm:Word`); Prison (ID: `realia:Prison`); Denarius (ID: `realia:Denarius`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); prescrire (ID: `keyterm:Command`); régne (ID: `keyterm:Kingdom`); Moïse (ID: `person:Moses`); corps (ID: `keyterm:Body.3`); Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Judée (ID: `place:Judea`); Pharisien (ID: `group:Pharisee`); obstination (ID: `keyterm:Hardheartedness`); Be Lawful (ID: `keyterm:Lawful`); Galilée (ID: `place:Galilee`); Éternel (ID: `deity:Lord`); fornication (ID: `keyterm:Fornication`); prier (ID: `keyterm:Pray`); Jourdain (ID: `place:Jordan`); servir (ID: `keyterm:Serve`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); vie (ID: `keyterm:Life`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); régne (ID: `keyterm:Kingdom`); Rich Young Ruler (ID: `person:RichYoungRuler`); éternellement (ID: `keyterm:Always`); Éternel (ID: `deity:Lord`); le bien (ID: `keyterm:Good`); sûrement! (ID: `keyterm:Surely`); trans. faire un disciple de (ID: `keyterm:Disciple`); prier (ID: `keyterm:AskFor`); nouvelle naissance (ID: `keyterm:NewWorld`); commandement (ID: `keyterm:Commandment`); decider (ID: `keyterm:Decided`); nom (ID: `keyterm:Name`); fornication (ID: `keyterm:Fornication`); aide (ID: `keyterm:Salvation`); Israël (ID: `person:Israel`); Pierre (ID: `person:Peter`); gloire (ID: `keyterm:Glory`); aimer (ID: `keyterm:Love`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`); House (ID: `realia:House`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Denarius (ID: `realia:Denarius`); désoeuvré (ID: `keyterm:Idle`); agir par méchanceté (ID: `keyterm:ActWickedly`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); le bien (ID: `keyterm:Good`); régne (ID: `keyterm:Kingdom`); être juste (ID: `keyterm:Just`); Be Lawful (ID: `keyterm:Lawful`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Jérusalem (ID: `place:Jerusalem`); prescrire (ID: `keyterm:Command`); David (ID: `person:David`); pitié (ID: `keyterm:Mercy`); servir (ID: `keyterm:Serve`); autorité (ID: `keyterm:Authority.2`); Zébédée (ID: `person:Zebedee`); régne (ID: `keyterm:Kingdom`); Jéricho (ID: `place:Jericho`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); adorer (ID: `keyterm:BowDown`); condamner (ID: `keyterm:Condemn`); Éternel (ID: `deity:Lord`); nation; peuple (ID: `group:Gentile`); vie (ID: `keyterm:Life`); résurrection (ID: `keyterm:Resurrection`); rançon (ID: `keyterm:Ransom`); trans. faire un disciple de (ID: `keyterm:Disciple`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Jérusalem (ID: `place:Jerusalem`); Donkey (ID: `fauna:Donkey`); hosanna [en araméen] (ID: `keyterm:Hosanna`); David (ID: `person:David`); trans. faire un disciple de (ID: `keyterm:Disciple`); Clothing (ID: `realia:Clothing`); Bethphagé (ID: `place:Bethphage`); prescrire (ID: `keyterm:Command`); benir (ID: `keyterm:Bless`); Nazareth (ID: `place:Nazareth`); Galilée (ID: `place:Galilee`); nom (ID: `keyterm:Name`); Béthanie (ID: `place:Bethany`); A Group of People (ID: `group:GenericGroup`); Éternel (ID: `deity:Lord`); prier (ID: `keyterm:Pray`); To Cause to Happen (ID: `keyterm:Happen`); hauteur (ID: `keyterm:Height`); servir (ID: `keyterm:Serve`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** croire (ID: `keyterm:Believe`); autorité (ID: `keyterm:Authority.2`); Jésus (ID: `person:Jesus.2`); capacité (ID: `keyterm:Ability`); Fig (ID: `flora:Fig`); Jean (ID: `person:John`); baptême (ID: `keyterm:Baptism`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); prier (ID: `keyterm:AskFor`); craindre (ID: `keyterm:Fear`); sûrement! (ID: `keyterm:Surely`); éternellement (ID: `keyterm:Always`); prier (ID: `keyterm:Pray`); évaluer (ID: `keyterm:Discern`); trans. faire un disciple de (ID: `keyterm:Disciple`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Éternel (ID: `deity:Lord`); collecteur d'impôt (ID: `keyterm:TaxCollector`); se repentir (ID: `keyterm:Repent`); régne (ID: `keyterm:Kingdom`); parabole (ID: `keyterm:Parable`); Jésus (ID: `person:Jesus.2`); rejeter (ID: `keyterm:Reject`); scripture (ID: `keyterm:Scripture`); Pharisien (ID: `group:Pharisee`); craindre (ID: `keyterm:Fear`); être juste (ID: `keyterm:Just`); croire (ID: `keyterm:Believe`); sûrement! (ID: `keyterm:Surely`); Jean (ID: `person:John`); Winepress (ID: `realia:Winepress`); Cornerstone (ID: `realia:Cornerstone`); Tower (ID: `realia:Tower`); Watch-Tower (ID: `realia:Watch-tower`); Thorn Hedge (ID: `realia:ThornHedge`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); le bien (ID: `keyterm:Good`); régne (ID: `keyterm:Kingdom`); parabole (ID: `keyterm:Parable`); Jésus (ID: `person:Jesus.2`); prescrire (ID: `keyterm:Command`); choisi (ID: `keyterm:Chosen`); les ténèbres du dehors (ID: `keyterm:OuterDarkness`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); résurrection (ID: `keyterm:Resurrection`); Tibère (ID: `person:Tiberius`); Jésus (ID: `person:Jesus.2`); taxe (ID: `keyterm:PollTax`); les partisans d'Hérode; Hérodiens (ID: `group:Herodian`); Sadducéens (ID: `group:Sadducee`); Israël (ID: `person:Israel`); scripture (ID: `keyterm:Scripture`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); vrai (ID: `keyterm:True`); Isaac (ID: `person:Isaac`); Abraham (ID: `person:Abraham`); Pharisien (ID: `group:Pharisee`); An Angel (ID: `deity:Angel`); Be Lawful (ID: `keyterm:Lawful`); chemin (ID: `keyterm:TheWay`); vérité (ID: `keyterm:Truth`); capacité (ID: `keyterm:Ability`); Moïse (ID: `person:Moses`); vie (ID: `keyterm:Life`); trans. faire un disciple de (ID: `keyterm:Disciple`); Money (ID: `realia:Money`); Denarius (ID: `realia:Denarius`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); commandement (ID: `keyterm:Commandment`); David (ID: `person:David`); Pharisien (ID: `group:Pharisee`); Jésus (ID: `person:Jesus.2`); aimer (ID: `keyterm:Love`); loi (ID: `keyterm:Law`); coeur (ID: `keyterm:Heart`); intelligence (ID: `keyterm:Mind.2`); Saint-Esprit (ID: `deity:HolySpirit`); Sadducéens (ID: `group:Sadducee`)
...
* **Associated ACAI Concepts:** Pharisien (ID: `group:Pharisee`); Disaster (ID: `keyterm:Disaster`); Temple (ID: `realia:Temple`); être juste (ID: `keyterm:Just`); Éternel (ID: `deity:Lord`); enfer (ID: `keyterm:Gehenna`); purifier (ID: `keyterm:Cleanse.2`); offrande (ID: `keyterm:Offering`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); sois obligé (ID: `keyterm:Ought`); sang (ID: `keyterm:Blood`); consécration (ID: `keyterm:Consecration.2`); Jésus (ID: `person:Jesus.2`); jugement (ID: `keyterm:Judgment`); hypocrisie (ID: `keyterm:Hypocrisy`); Jehojada (ID: `person:Jehoiada.2`); Zacharie (ID: `person:Zechariah.12`); pur (ID: `keyterm:Clean`); Synagogue (ID: `realia:Synagogue`); Grave (ID: `realia:Grave`); témoigner (ID: `keyterm:BearWitness`); tribunal (ID: `keyterm:CourtCase`); amour (ID: `keyterm:Friendship`); benir (ID: `keyterm:Bless`); régne (ID: `keyterm:Kingdom`); pitié (ID: `keyterm:Mercy`); Jérusalem (ID: `place:Jerusalem`); corruption morale (ID: `keyterm:Lawless`); Abel (ID: `person:Abel`); nom (ID: `keyterm:Name`); Hell (ID: `place:Hell`); céleste (ID: `keyterm:Heavenly`); Moïse (ID: `person:Moses`); pollution (ID: `keyterm:Defilement`); loi (ID: `keyterm:Law`); croire (ID: `keyterm:Believe`); sûrement! (ID: `keyterm:Surely`); trans. faire un disciple de (ID: `keyterm:Disciple`); Dill (ID: `flora:Dill`); Mint (ID: `flora:Mint`); Phylactery (ID: `realia:Phylactery`); Mosquito (ID: `fauna:Mosquito`); Plate (ID: `realia:Plate.2`); Cumin (ID: `flora:Cumin`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Snake (ID: `fauna:Snake`); Tassel (ID: `realia:Tassel`); Cross (ID: `realia:Cross`); Camel (ID: `fauna:Camel`); Bird (ID: `fauna:Bird`); Throne (ID: `realia:Throne`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); nom (ID: `keyterm:Name`); régne (ID: `keyterm:Kingdom`); trans. faire un disciple de (ID: `keyterm:Disciple`); témoigner (ID: `keyterm:BearWitness`); aide (ID: `keyterm:Salvation`); capacité (ID: `keyterm:Ability`); corruption morale (ID: `keyterm:Lawless`); sûrement! (ID: `keyterm:Surely`); éternellement (ID: `keyterm:Always`); exemple (ID: `keyterm:Example`); bonnes nouvelles (ID: `keyterm:GoodNews`); proclamer (ID: `keyterm:Proclaim`); aimer (ID: `keyterm:Love`); Temple (ID: `realia:Temple`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); choisi (ID: `keyterm:Chosen`); Noah (ID: `person:Noah`); exemple (ID: `keyterm:Example`); An Angel (ID: `deity:Angel`); capacité (ID: `keyterm:Ability`); croire (ID: `keyterm:Believe`); Jésus (ID: `person:Jesus.2`); sûrement! (ID: `keyterm:Surely`); fidelité (ID: `keyterm:Faithfulness`); Daniel (ID: `person:Daniel.3`); House (ID: `realia:House`); coeur (ID: `keyterm:Heart`); une merveille (ID: `keyterm:Portent`); abominable dévastateur (ID: `keyterm:AbominationOfDesolation`); béni (ID: `keyterm:Happy`); Judée (ID: `place:Judea`); Disaster (ID: `keyterm:Disaster`); Éternel (ID: `deity:Lord`); corps (ID: `keyterm:Body.3`); prier (ID: `keyterm:Pray`); aide (ID: `keyterm:Salvation`); parabole (ID: `keyterm:Parable`); sabbat (ID: `keyterm:Sabbath`); saint (ID: `keyterm:Holy`); gloire (ID: `keyterm:Glory`); Vulture (ID: `fauna:Vulture`); Inner Room (ID: `realia:InnerRoom`); Trumpet (ID: `realia:Trumpet`); Housetop (ID: `realia:Housetop`); Door (ID: `realia:Door`); Fig (ID: `flora:Fig`); Tabernacle (ID: `realia:Tabernacle`); Cloak (ID: `realia:Cloak`); Hand-Mill (ID: `realia:Hand-mill`); Boat (ID: `realia:Boat`)
...
* **Associated ACAI Concepts:** Lamp (ID: `realia:Lamp`); Olive Oil (ID: `realia:OliveOil`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); régne (ID: `keyterm:Kingdom`); sûrement! (ID: `keyterm:Surely`); Container (ID: `realia:Container`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** Talent (ID: `realia:Talent`); le bien (ID: `keyterm:Good`); fidelité (ID: `keyterm:Faithfulness`); Cause of Joy (ID: `keyterm:CauseOfJoy`); craindre (ID: `keyterm:Fear`); capacité (ID: `keyterm:Ability`); les ténèbres du dehors (ID: `keyterm:OuterDarkness`)
...
* **Associated ACAI Concepts:** Prison (ID: `realia:Prison`); être juste (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); éternellement (ID: `keyterm:Always`); Jésus (ID: `person:Jesus.2`); sûrement! (ID: `keyterm:Surely`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Kid (ID: `fauna:Kid`); benir (ID: `keyterm:Bless`); régne (ID: `keyterm:Kingdom`); feu éternel (ID: `keyterm:EternalFire`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); vie (ID: `keyterm:Life`); gloire (ID: `keyterm:Glory`); servir (ID: `keyterm:Serve`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Simon (ID: `person:Simon.4`); Béthanie (ID: `place:Bethany`); Judas (ID: `person:Judas.2`); sacrifice de la pâque (ID: `keyterm:Passover`); capacité (ID: `keyterm:Ability`); sûrement! (ID: `keyterm:Surely`); Caïphe (ID: `person:Caiaphas`); corps (ID: `keyterm:Body.3`); bonnes nouvelles (ID: `keyterm:GoodNews`); proclamer (ID: `keyterm:Proclaim`); Alabaster Jar (ID: `realia:AlabasterJar`); House (ID: `realia:House`); Courtyard (ID: `realia:Courtyard`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** prier (ID: `keyterm:Pray`); Pierre (ID: `person:Peter`); trans. faire un disciple de (ID: `keyterm:Disciple`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); Gethsémané (ID: `place:Gethsemane`); esprit (ID: `keyterm:Spirit.2`); résurrection (ID: `keyterm:Resurrection`); Zébédée (ID: `person:Zebedee`); mis à l'essai (ID: `keyterm:PutToTheTest`); sûrement! (ID: `keyterm:Surely`); corps (ID: `keyterm:Body.3`); Galilée (ID: `place:Galilee`); Rooster (ID: `fauna:Rooster`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Olive Tree (ID: `flora:OliveTree`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); To Cause to Happen (ID: `keyterm:Happen`); scripture (ID: `keyterm:Scripture`); prier (ID: `keyterm:AskFor`); Judas (ID: `person:Judas.2`); Éternel (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); exemple (ID: `keyterm:Example`); trans. faire un disciple de (ID: `keyterm:Disciple`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); Caïphe (ID: `person:Caiaphas`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); parler contre dieu (ID: `keyterm:Blaspheme`); témoin (ID: `keyterm:Witness`); parler (ID: `keyterm:Speak`); capacité (ID: `keyterm:Ability`); Pierre (ID: `person:Peter`); vie (ID: `keyterm:Life`); Courtyard (ID: `realia:Courtyard`); Temple (ID: `realia:Temple`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Pierre (ID: `person:Peter`); Rooster (ID: `fauna:Rooster`); adjuration (ID: `keyterm:Oath`); A Group of People (ID: `group:GenericGroup`); Galiléen (ID: `group:Galilee`); vrai (ID: `keyterm:True`); Nazareth (ID: `place:Nazareth`); Galilée (ID: `place:Galilee`); A Servant (ID: `person:GenericServant`); ce qui est dit (ID: `keyterm:Word`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Akeldama (ID: `place:Akeldama`); sang (ID: `keyterm:Blood`); Pilate (ID: `person:Pilate`); Temple Treasury (ID: `place:Corban`); Priests (ID: `group:GenericPriests`); Jérémie (ID: `person:Jeremiah.6`); To Cause to Happen (ID: `keyterm:Happen`); Jésus (ID: `person:Jesus.2`); Judas (ID: `person:Judas.2`); pécher (ID: `keyterm:Sin`); condamner (ID: `keyterm:Condemn`); Éternel (ID: `deity:Lord`); se repentir (ID: `keyterm:Repent`); Israël (ID: `person:Israel`); Be Lawful (ID: `keyterm:Lawful`); Temple (ID: `realia:Temple`); Treasury (ID: `realia:Treasury`)
...
* **Associated ACAI Concepts:** Barabbas (ID: `person:Barabbas`); Jésus (ID: `person:Jesus.2`); Pilate (ID: `person:Pilate`); A Group of People (ID: `group:GenericGroup`); Cross (ID: `realia:Cross`); sang (ID: `keyterm:Blood`); Jews (ID: `group:Jews`); être juste (ID: `keyterm:Just`); persuader (ID: `keyterm:Persuade`); ce qui est dit (ID: `keyterm:Word`); Judgment Seat (ID: `realia:JudgmentSeat`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); aide (ID: `keyterm:Salvation`); Jésus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Clothing (ID: `realia:Clothing`); Reed (ID: `flora:Reed`); Cloak (ID: `realia:Cloak`); Cyrène (ID: `place:Cyrene`); Simon (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); coeur (ID: `keyterm:Heart`); parler contre dieu (ID: `keyterm:Blaspheme`); persuader (ID: `keyterm:Persuade`); nom (ID: `keyterm:Name`); Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); Israël (ID: `person:Israel`); sauver (ID: `keyterm:Deliver`); Crown (ID: `realia:Crown.2`); Brier (ID: `flora:Brier`); Wine (ID: `realia:Wine`); Acacia (ID: `flora:Acacia`); Crown (ID: `realia:Crown`); Temple (ID: `realia:Temple`); Palace (ID: `realia:Palace`); Boxthorn (ID: `flora:Boxthorn`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Grave (ID: `realia:Grave`); résurrection (ID: `keyterm:Resurrection`); Pilate (ID: `person:Pilate`); corps (ID: `keyterm:Body.3`); Joseph (ID: `person:Joseph.6`); Marie de Magdala (ID: `person:Marymagdalene`); Marie (ID: `person:Mary.2`); Élie (ID: `person:Elijah`); A Group of People (ID: `group:GenericGroup`); saint (ID: `keyterm:Holy`); trans. faire un disciple de (ID: `keyterm:Disciple`); Zébédée (ID: `person:Zebedee`); Jacques (ID: `person:James.4`); Arimathée (ID: `place:Arimathea`); Joseph (ID: `person:Joseph.5`); vrai (ID: `keyterm:True`); Pharisien (ID: `group:Pharisee`); craindre (ID: `keyterm:Fear`); Galilée (ID: `place:Galilee`); nom (ID: `keyterm:Name`); Éternel (ID: `deity:Lord`); vie (ID: `keyterm:Life`); pur (ID: `keyterm:Clean`); aide (ID: `keyterm:Salvation`); esprit (ID: `keyterm:Spirit.2`); servir (ID: `keyterm:Serve`); Seal (ID: `realia:Seal`); Sour Wine (ID: `realia:SourWine`); Reed (ID: `flora:Reed`); Curtain (ID: `realia:Curtain`); Temple (ID: `realia:Temple`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** craindre (ID: `keyterm:Fear`); Jésus (ID: `person:Jesus.2`); trans. faire un disciple de (ID: `keyterm:Disciple`); résurrection (ID: `keyterm:Resurrection`); An Angel (ID: `deity:Angel`); Galilée (ID: `place:Galilee`); Grave (ID: `realia:Grave`); Angels (ID: `group:Angels`); semaine (ID: `keyterm:Week`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); persuader (ID: `keyterm:Persuade`); adorer (ID: `keyterm:BowDown`); Éternel (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); sabbat (ID: `keyterm:Sabbath`); Jews (ID: `group:Jews`); Marie de Magdala (ID: `person:Marymagdalene`); Marie (ID: `person:Mary.2`); Clothing (ID: `realia:Clothing`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** trans. faire un disciple de (ID: `keyterm:Disciple`); Jésus (ID: `person:Jesus.2`); autorité (ID: `keyterm:Authority.2`); nom (ID: `keyterm:Name`); baptême (ID: `keyterm:Baptism`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Saint-Esprit (ID: `deity:HolySpirit`); adorer (ID: `keyterm:BowDown`); capacité (ID: `keyterm:Ability`); prescrire (ID: `keyterm:Command`); Éternel (ID: `deity:Lord`); éternellement (ID: `keyterm:Always`); Galilée (ID: `place:Galilee`)
