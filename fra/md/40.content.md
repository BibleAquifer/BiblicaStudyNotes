...
* **Associated ACAI Concepts:** Éliud (ID: `person:Eliud`); Jacob (ID: `person:Jacob.2`); Azor (ID: `person:Azor`); Matthan (ID: `person:Matthan`); Tsadok (ID: `person:Zadok`); Éléazar (ID: `person:Eleazar`); Abiud (ID: `person:Abiud`); Achim (ID: `person:Achim`); Éliakim (ID: `person:Eliakim`); Ram (ID: `person:Ram`); Salmon (ID: `person:Salmon`); David (ID: `person:David`); Jésus (ID: `person:Jesus.2`); Jojakin (ID: `person:Jehoiachin`); Zorobabel (ID: `person:Zerubbabel.2`); Ozias (ID: `person:Uzziah`); Josias (ID: `person:Josiah`); Asa (ID: `person:Asa`); Ézéchias (ID: `person:Hezekiah`); Salomon (ID: `person:Solomon`); Obed (ID: `person:Obed`); Tamar (ID: `person:Tamar`); Rahab (ID: `person:Rahab`); Amminadab (ID: `person:Amminadab`); Nahshon (ID: `person:Nahshon`); Zérach (ID: `person:Zerah.3`); Hetsron (ID: `person:Hezron.2`); Joseph (ID: `person:Joseph.4`); Perets (ID: `person:Perez`); Amon (ID: `person:Amon.3`); Abijah (ID: `person:Abijah.4`); Jotham (ID: `person:Jotham.2`); Joram (ID: `person:Jehoram`); Urie (ID: `person:Uriah`); Boaz (ID: `person:Boaz`); Achaz (ID: `person:Ahaz`); Roboam (ID: `person:Rehoboam`); Josaphat (ID: `person:Jehoshaphat.3`); Isaac (ID: `person:Isaac`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Joseph (ID: `person:Joseph.4`); Jésus (ID: `person:Jesus.2`); nom (ID: `keyterm:Name`); Marie (ID: `person:Mary`); To Cause to Happen (ID: `keyterm:Happen`)
...
* **Associated ACAI Concepts:** Hérode (ID: `person:Herod`); Bethléhem (ID: `place:Bethlehem`); Archélaüs (ID: `person:Archelaus`); Égypte (ID: `place:Egypt`); adorer (ID: `keyterm:BowDown`); Joseph (ID: `person:Joseph.4`); Money Box (ID: `realia:MoneyBox`); Myrrh (ID: `realia:Myrrh`); Frankincense (ID: `flora:Frankincense`); Nazareth (ID: `place:Nazareth`); Myrrh (ID: `flora:Myrrh`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Jérémie (ID: `person:Jeremiah.6`)
...
* **Associated ACAI Concepts:** Judée (ID: `place:Judea`); Jean (ID: `person:John`); Winnowing Fork (ID: `realia:WinnowingFork`); baptiste [jean] (ID: `keyterm:Baptist`); Sandal (ID: `realia:Sandal`); Belt (ID: `realia:Belt`); Leather (ID: `realia:Leather`); Threshing Floor (ID: `realia:ThreshingFloor`); Locust (ID: `fauna:Locust`); Ésaïe (ID: `person:Isaiah`)
...
* **Associated ACAI Concepts:** baptême (ID: `keyterm:Baptism`); Dove (ID: `fauna:Dove`); Jourdain (ID: `place:Jordan`)
...
* **Associated ACAI Concepts:** Pinnacle (ID: `realia:Pinnacle`); mis à l'essai (ID: `keyterm:PutToTheTest`); adorer (ID: `keyterm:BowDown`); ce qui est dit (ID: `keyterm:Word`)
...
* **Associated ACAI Concepts:** Galilée (ID: `place:Galilee`); Nazareth (ID: `place:Nazareth`); proclamer (ID: `keyterm:Proclaim`); se repentir (ID: `keyterm:Repent`)
...
* **Associated ACAI Concepts:** Fishnet (ID: `realia:Fishnet`); Décapole (ID: `place:Decapolis`); Galilée (ID: `place:Galilee`); Sea of Galilee (ID: `place:GalileeSea`); Zébédée (ID: `person:Zebedee`); André (ID: `person:Andrew`); Jacques (ID: `person:James`); Jean (ID: `person:John.2`); Synagogue (ID: `realia:Synagogue`); bonnes nouvelles (ID: `keyterm:GoodNews`)
...
* **Associated ACAI Concepts:** béni (ID: `keyterm:Happy`); pitié (ID: `keyterm:Mercy`); coeur (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** loi (ID: `keyterm:Law`); commandement (ID: `keyterm:Commandment`)
...
* **Associated ACAI Concepts:** Mile (ID: `realia:Mile`); enfer (ID: `keyterm:Gehenna`); fornication (ID: `keyterm:Fornication`); Quadrans (ID: `realia:Quadrans`); tribunal (ID: `keyterm:CourtCase`); Footstool (ID: `realia:Footstool`); réconcilier (ID: `keyterm:Reconcile`); céleste (ID: `keyterm:Heavenly`); adjuration (ID: `keyterm:Oath`); Cloak (ID: `realia:Cloak`); le bien (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** prier (ID: `keyterm:Pray`); pardonner (ID: `keyterm:Forgive`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Inner Room (ID: `realia:InnerRoom`); conduis (ID: `keyterm:BringIn`); régne (ID: `keyterm:Kingdom`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** jeûner (ID: `keyterm:Fast`); Oven (ID: `realia:Oven`); Moth (ID: `fauna:Moth`); Clothing (ID: `realia:Clothing`); Cubit (ID: `realia:Cubit.2`); qui manque de foi (ID: `keyterm:HavingLittleFaith`); Wild Flower (ID: `flora:WildFlower`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Centurion With Sick Servant (ID: `person:Centurion.2`); purifier (ID: `keyterm:Cleanse.2`); croire (ID: `keyterm:Believe`); être possédé par un démon (ID: `keyterm:DemonPossessed`); lèpre (ID: `keyterm:InfectiousSkinDisease`)
...
* **Associated ACAI Concepts:** Jackal (ID: `fauna:Jackal`); être possédé par un démon (ID: `keyterm:DemonPossessed`); Religious Official (ID: `person:ReligiousOfficial`); A Disciple (ID: `person:GenericDisciple`); qui manque de foi (ID: `keyterm:HavingLittleFaith`); prescrire (ID: `keyterm:Command`)
...
* **Associated ACAI Concepts:** collecteur d'impôt (ID: `keyterm:TaxCollector`); Patch (ID: `realia:Patch`); Matthieu (ID: `person:Matthew`); Must (ID: `realia:Must`); pitié (ID: `keyterm:Mercy`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Tassel (ID: `realia:Tassel`); ses sentiments ou son être les plus profonds (ID: `keyterm:Affection`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** zélote; nationaliste (ID: `group:Zealot`); Bag (ID: `realia:Bag`); Simon (ID: `person:Simon.2`); Barthélemy (ID: `person:Bartholomew`); Alphée (ID: `person:Alphaeus`); Jacques (ID: `person:James.2`); Judas (ID: `person:Judas`); Thomas (ID: `person:Thomas`); Philippe (ID: `person:Philip`); Judas (ID: `person:Judas.2`); faire la paix (ID: `keyterm:Peace`)
...
* **Associated ACAI Concepts:** Sparrow (ID: `fauna:Sparrow`); Assarion (ID: `realia:Assarion`); Wolf (ID: `fauna:Wolf`); enfer (ID: `keyterm:Gehenna`)
...
* **Associated ACAI Concepts:** baptiste [jean] (ID: `keyterm:Baptist`); Reed (ID: `flora:Reed`); Jean (ID: `person:John`)
...
* **Associated ACAI Concepts:** Chorazin (ID: `place:Chorazin`); Yoke (ID: `realia:Yoke`); hadès (ID: `keyterm:WorldOfTheDead`); Disaster (ID: `keyterm:Disaster`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** Be Lawful (ID: `keyterm:Lawful`); Wheat (ID: `flora:Wheat`); sabbat (ID: `keyterm:Sabbath`)
...
* **Associated ACAI Concepts:** condamner (ID: `keyterm:Condemn`); parler contre dieu (ID: `keyterm:Blaspheme`); jugement (ID: `keyterm:Judgment`)
...
* **Associated ACAI Concepts:** Jonas (ID: `person:Jonah.2`); Ninive (ID: `group:Nineveh`); exemple (ID: `keyterm:Example`); reine de Séba (ID: `person:QueenOfSheba`)
...
* **Associated ACAI Concepts:** parabole (ID: `keyterm:Parable`); Brier (ID: `flora:Brier`)
...
* **Associated ACAI Concepts:** Weed (ID: `flora:Weed`); Saton (ID: `realia:Saton`); Storeroom (ID: `realia:Storeroom`); Mustard (ID: `flora:Mustard`); Dragnet (ID: `realia:Dragnet`); parabole (ID: `keyterm:Parable`); Grain (ID: `flora:Grain`); régne (ID: `keyterm:Kingdom`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** Hérode Antipas (ID: `person:Herod.2`); Hérodias (ID: `person:Herodias`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Philippe (ID: `person:Philip.2`); Simon (ID: `person:Simon.3`); Prison (ID: `realia:Prison`); Jude (ID: `person:Jude`); Jacques (ID: `person:James.3`); ne pas réussir ou refuser de croire (ID: `keyterm:Disbelieve`); Jean (ID: `person:John`)
...
* **Associated ACAI Concepts:** Génésareth (ID: `place:Gennesaret`); qui manque de foi (ID: `keyterm:HavingLittleFaith`); courage! prends courage! bon courage! (ID: `keyterm:CheerUp`); Ship (ID: `realia:Ship`)
...
* **Associated ACAI Concepts:** Syrophonecian Woman (ID: `person:SyrophonecianWoman`); Dog (ID: `fauna:Dog`); Sidon (ID: `place:Sidon`); Tyr (ID: `place:Tyre`)
...
* **Associated ACAI Concepts:** Sadducéens (ID: `group:Sadducee`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Pierre (ID: `person:Peter`); Césarée de Philippe (ID: `place:CaesareaPhilippi`); Key (ID: `realia:Key`); église (ID: `keyterm:Church`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Élie (ID: `person:Elijah`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Stater (ID: `realia:Stater`); Two-Drachma Piece (ID: `realia:Two-drachmaPiece`); Fishhook (ID: `realia:Fishhook`); Mustard (ID: `flora:Mustard`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); faire pécher qqn (ID: `keyterm:CauseToStumble`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`)
...
* **Associated ACAI Concepts:** devoir (qch) à [qqn] (ID: `keyterm:Owe`); témoin (ID: `keyterm:Witness`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** désoeuvré (ID: `keyterm:Idle`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Jérusalem (ID: `place:Jerusalem`); servir (ID: `keyterm:Serve`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); hosanna [en araméen] (ID: `keyterm:Hosanna`); Jérusalem (ID: `place:Jerusalem`); Seat (ID: `realia:Seat`); Bethphagé (ID: `place:Bethphage`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** collecteur d'impôt (ID: `keyterm:TaxCollector`); rejeter (ID: `keyterm:Reject`); Cornerstone (ID: `realia:Cornerstone`); Winepress (ID: `realia:Winepress`); Tower (ID: `realia:Tower`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** les partisans d'Hérode; Hérodiens (ID: `group:Herodian`); Sadducéens (ID: `group:Sadducee`); Denarius (ID: `realia:Denarius`); Money (ID: `realia:Money`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** commandement (ID: `keyterm:Commandment`); intelligence (ID: `keyterm:Mind.2`); coeur (ID: `keyterm:Heart`)
...
* **Associated ACAI Concepts:** Dill (ID: `flora:Dill`); Phylactery (ID: `realia:Phylactery`); Mint (ID: `flora:Mint`); enfer (ID: `keyterm:Gehenna`); Zacharie (ID: `person:Zechariah.12`); Seat (ID: `realia:Seat`); Cumin (ID: `flora:Cumin`); Mosquito (ID: `fauna:Mosquito`); Plate (ID: `realia:Plate.2`); hypocrisie (ID: `keyterm:Hypocrisy`); pur (ID: `keyterm:Clean`); Jehojada (ID: `person:Jehoiada.2`); Disaster (ID: `keyterm:Disaster`); Pharisien (ID: `group:Pharisee`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Noah (ID: `person:Noah`); Inner Room (ID: `realia:InnerRoom`); Housetop (ID: `realia:Housetop`); Vulture (ID: `fauna:Vulture`); Trumpet (ID: `realia:Trumpet`); Daniel (ID: `person:Daniel.3`); fidelité (ID: `keyterm:Faithfulness`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`)
...
* **Associated ACAI Concepts:** Simon (ID: `person:Simon.4`); Alabaster Jar (ID: `realia:AlabasterJar`); Béthanie (ID: `place:Bethany`); Judas (ID: `person:Judas.2`)
...
* **Associated ACAI Concepts:** Bowl (ID: `realia:Bowl.2`); sang (ID: `keyterm:Blood`); corps (ID: `keyterm:Body.3`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** Gethsémané (ID: `place:Gethsemane`); Rooster (ID: `fauna:Rooster`); esprit (ID: `keyterm:Spirit.2`); prier (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Caïphe (ID: `person:Caiaphas`); Courtyard (ID: `realia:Courtyard`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Judgment Seat (ID: `realia:JudgmentSeat`); Barabbas (ID: `person:Barabbas`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Simon (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); Cyrène (ID: `place:Cyrene`); Crown (ID: `realia:Crown.2`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Crown (ID: `realia:Crown`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Marie (ID: `person:Mary.2`); Joseph (ID: `person:Joseph.6`); Joseph (ID: `person:Joseph.5`); Jacques (ID: `person:James.4`); Marie de Magdala (ID: `person:Marymagdalene`); Arimathée (ID: `place:Arimathea`); Sour Wine (ID: `realia:SourWine`); Zébédée (ID: `person:Zebedee`); Seal (ID: `realia:Seal`); Curtain (ID: `realia:Curtain`); Reed (ID: `flora:Reed`); Jésus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Angels (ID: `group:Angels`); résurrection (ID: `keyterm:Resurrection`); semaine (ID: `keyterm:Week`)
...
* **Associated ACAI Concepts:** trans. faire un disciple de (ID: `keyterm:Disciple`); autorité (ID: `keyterm:Authority.2`)
