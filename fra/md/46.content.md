...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); baptême (ID: `keyterm:Baptism`); Éternel (ID: `deity:Lord`); nom (ID: `keyterm:Name`); Paul (ID: `person:Paul`); grâce (ID: `keyterm:Favor`); en christ (ID: `keyterm:InChrist`); Cross (ID: `realia:Cross`); Gaïus (ID: `person:Gaius.3`); Sosthène (ID: `person:Sosthenes`); Chloé (ID: `person:Chloe`); Stéphanas (ID: `person:Stephanas`); A Disciple (ID: `person:GenericDisciple`); Crispus (ID: `person:Crispus`); bonnes nouvelles (ID: `keyterm:GoodNews`); témoigner (ID: `keyterm:BearWitness`); appeler (ID: `keyterm:CallUpon`); Corinthe (ID: `place:Corinth`); Apollos (ID: `person:Apollos`); Pierre (ID: `person:Peter`); au, dessus de tout reproche (ID: `keyterm:WithoutReproach`); priver de la puissance (ID: `keyterm:DepriveOfPower`); prier (ID: `keyterm:AskFor`); fraternité (ID: `keyterm:Fellowship`); église (ID: `keyterm:Church`); faire la paix (ID: `keyterm:Peace`); fidelité (ID: `keyterm:Faithfulness`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); Jews (ID: `group:Jews`); Jésus (ID: `person:Jesus.2`); aide (ID: `keyterm:Salvation`); corps (ID: `keyterm:Body.3`); choisi (ID: `keyterm:Chosen`); Javan (ID: `person:Javan`); Yavanite (ID: `group:Greek`); proclamer (ID: `keyterm:Proclaim`); Cross (ID: `realia:Cross`); consécration (ID: `keyterm:Consecration.2`); croire (ID: `keyterm:Believe`); libération (ID: `keyterm:Liberation`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); être juste (ID: `keyterm:Just`); éternellement (ID: `keyterm:Always`); exemple (ID: `keyterm:Example`); nation; peuple (ID: `group:Gentile`); en christ (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); Saint-Esprit (ID: `deity:HolySpirit`); Jésus (ID: `person:Jesus.2`); éternellement (ID: `keyterm:Always`); esprit (ID: `keyterm:Spirit.2`); évaluer (ID: `keyterm:Discern`); gloire (ID: `keyterm:Glory`); Cross (ID: `realia:Cross`); non spirituel (ID: `keyterm:Natural`); decider (ID: `keyterm:Decided`); pardonner (ID: `keyterm:Forgive`); proclamer (ID: `keyterm:Proclaim`); croire (ID: `keyterm:Believe`); craindre (ID: `keyterm:Fear`); coeur (ID: `keyterm:Heart`); aimer (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); Jésus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Foundation (ID: `realia:Foundation`); tester (ID: `keyterm:Interpret`); saint (ID: `keyterm:Holy`); Pierre (ID: `person:Peter`); Apollos (ID: `person:Apollos`); aide (ID: `keyterm:Salvation`); sans valeur (ID: `keyterm:Worthless`); vie (ID: `keyterm:Life`); Paul (ID: `person:Paul`); grâce (ID: `keyterm:Favor`); éternellement (ID: `keyterm:Always`); Saint-Esprit (ID: `deity:HolySpirit`); Reed (ID: `flora:Reed`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); évaluer (ID: `keyterm:Discern`); en christ (ID: `keyterm:InChrist`); fidelité (ID: `keyterm:Faithfulness`); prier (ID: `keyterm:AskFor`); bien, aimé (ID: `keyterm:Beloved`); decider (ID: `keyterm:Decided`); glorieux (ID: `keyterm:Glorious`); bonnes nouvelles (ID: `keyterm:GoodNews`); aimer (ID: `keyterm:Love`); Apollos (ID: `person:Apollos`); benir (ID: `keyterm:Bless`); Timothée (ID: `person:Timothy`); coeur (ID: `keyterm:Heart`); calomnier (ID: `keyterm:Defame`); église (ID: `keyterm:Church`); An Angel (ID: `deity:Angel`); esprit (ID: `keyterm:Spirit.2`); régne (ID: `keyterm:Kingdom`); Staff (ID: `realia:Staff`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); esprit (ID: `keyterm:Spirit.2`); decider (ID: `keyterm:Decided`); idolâtre (ID: `keyterm:Idolater`); capacité (ID: `keyterm:Ability`); corps (ID: `keyterm:Body.3`); sacrifice de la pâque (ID: `keyterm:Passover`); vérité (ID: `keyterm:Truth`); aide (ID: `keyterm:Salvation`); nom (ID: `keyterm:Name`); sois obligé (ID: `keyterm:Ought`); offrande (ID: `keyterm:Offering`); fornication (ID: `keyterm:Fornication`); Éternel (ID: `deity:Lord`); nation; peuple (ID: `group:Gentile`); Satan (ID: `deity:Satan`); sans saleté (ID: `keyterm:Pure`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** decider (ID: `keyterm:Decided`); Éternel (ID: `deity:Lord`); agir par méchanceté (ID: `keyterm:ActWickedly`); tribunal (ID: `keyterm:CourtCase`); saint (ID: `keyterm:Holy`); concernant la vie quotidienne (ID: `keyterm:OfThisLife`); régne (ID: `keyterm:Kingdom`); idolâtre (ID: `keyterm:Idolater`); Jésus (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); nom (ID: `keyterm:Name`); église (ID: `keyterm:Church`); évaluer (ID: `keyterm:Discern`); être juste (ID: `keyterm:Just`); Saint-Esprit (ID: `deity:HolySpirit`); jugement (ID: `keyterm:Judgment`); capacité (ID: `keyterm:Ability`); consécration (ID: `keyterm:Consecration.2`)
...
* **Associated ACAI Concepts:** corps (ID: `keyterm:Body.3`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); fornication (ID: `keyterm:Fornication`); esprit (ID: `keyterm:Spirit.2`); résurrection (ID: `keyterm:Resurrection`); gloire (ID: `keyterm:Glory`); acheter (ID: `keyterm:Redeem`); pécher (ID: `keyterm:Sin`); autorité (ID: `keyterm:Authority.2`); Saint-Esprit (ID: `deity:HolySpirit`); capacité (ID: `keyterm:Ability`); Be Lawful (ID: `keyterm:Lawful`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** être infidèle (ID: `keyterm:Unfaithful`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); saint (ID: `keyterm:Holy`); faire la paix (ID: `keyterm:Peace`); dette (ID: `keyterm:Debt`); réconcilier (ID: `keyterm:Reconcile`); aide (ID: `keyterm:Salvation`); corps (ID: `keyterm:Body.3`); grâce (ID: `keyterm:Favor`); pollution (ID: `keyterm:Defilement`); mis à l'essai (ID: `keyterm:PutToTheTest`); autorité (ID: `keyterm:Authority.2`); fornication (ID: `keyterm:Fornication`); prier (ID: `keyterm:Pray`); Satan (ID: `deity:Satan`); consécration (ID: `keyterm:Consecration.2`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); capacité (ID: `keyterm:Ability`); pécher (ID: `keyterm:Sin`); corps (ID: `keyterm:Body.3`); commandement (ID: `keyterm:Commandment`); marcher (ID: `keyterm:Live.3`); sois obligé (ID: `keyterm:Ought`); coeur (ID: `keyterm:Heart`); pitié (ID: `keyterm:Mercy`); vie (ID: `keyterm:Life`); decider (ID: `keyterm:Decided`); acheter (ID: `keyterm:Redeem`); église (ID: `keyterm:Church`); autorité (ID: `keyterm:Authority.2`); Saint-Esprit (ID: `deity:HolySpirit`); saint (ID: `keyterm:Holy`); fidelité (ID: `keyterm:Faithfulness`); esprit (ID: `keyterm:Spirit.2`); Circumcision (ID: `keyterm:Circumcision`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); conscience (ID: `keyterm:Conscience`); capacité (ID: `keyterm:Ability`); aimer (ID: `keyterm:Love`); Image (ID: `realia:Image`); faire pécher qqn (ID: `keyterm:CauseToStumble`); éternellement (ID: `keyterm:Always`); pollution (ID: `keyterm:Defilement`); pécher (ID: `keyterm:Sin`); autorité (ID: `keyterm:Authority.2`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Temple of an Idol (ID: `realia:TempleOfAnIdol`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); autorité (ID: `keyterm:Authority.2`); Jésus (ID: `person:Jesus.2`); bonnes nouvelles (ID: `keyterm:GoodNews`); prendre part (ID: `keyterm:Partake`); loi (ID: `keyterm:Law`); Grain (ID: `flora:Grain`); évaluer (ID: `keyterm:Discern`); croire (ID: `keyterm:Believe`); sois obligé (ID: `keyterm:Ought`); espoir (ID: `keyterm:Hope`); Éternel (ID: `deity:Lord`); Moïse (ID: `person:Moses`); gestion d'un foyer (ID: `keyterm:Stewardship`); Pierre (ID: `person:Peter`); priver de la puissance (ID: `keyterm:DepriveOfPower`); vie (ID: `keyterm:Life`); Disaster (ID: `keyterm:Disaster`); Barnabas (ID: `person:Barnabas`); appartenant à ce monde (ID: `keyterm:Carnal`); preuve (ID: `keyterm:Certification`); Cattle (ID: `fauna:Bull`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Temple (ID: `realia:Temple`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); aide (ID: `keyterm:Salvation`); imperissable (ID: `keyterm:Imperishable`); corps (ID: `keyterm:Body.3`); bonnes nouvelles (ID: `keyterm:GoodNews`); loi (ID: `keyterm:Law`); corruption morale (ID: `keyterm:Lawless`); proclamer (ID: `keyterm:Proclaim`); Éternel (ID: `deity:Lord`); maîtriser (ID: `keyterm:ReadyForService`); Jews (ID: `group:Jews`); Be Lawful (ID: `keyterm:Lawful`); Arena (ID: `realia:Arena`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); mis à l'essai (ID: `keyterm:PutToTheTest`); idolâtre (ID: `keyterm:Idolater`); fidelité (ID: `keyterm:Faithfulness`); éternellement (ID: `keyterm:Always`); fornication (ID: `keyterm:Fornication`); Moïse (ID: `person:Moses`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); conscience (ID: `keyterm:Conscience`); prendre part (ID: `keyterm:Partake`); corps (ID: `keyterm:Body.3`); évaluer (ID: `keyterm:Discern`); decider (ID: `keyterm:Decided`); Demons (ID: `deity:Demons`); offrande (ID: `keyterm:Offering`); fraternité (ID: `keyterm:Fellowship`); Be Lawful (ID: `keyterm:Lawful`); parler contre dieu (ID: `keyterm:Blaspheme`); aide (ID: `keyterm:Salvation`); sang (ID: `keyterm:Blood`); gloire (ID: `keyterm:Glory`); A Person (ID: `person:GenericPerson`); benir (ID: `keyterm:Bless`); idolâtrie (ID: `keyterm:Idolatry`); église (ID: `keyterm:Church`); Javan (ID: `person:Javan`); grâce (ID: `keyterm:Favor`); Yavanite (ID: `group:Greek`); bien, aimé (ID: `keyterm:Beloved`); Jews (ID: `group:Jews`); Israël (ID: `person:Israel`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); prier (ID: `keyterm:Pray`); Jésus (ID: `person:Jesus.2`); gloire (ID: `keyterm:Glory`); parler (ID: `keyterm:Speak`); An Angel (ID: `deity:Angel`); decider (ID: `keyterm:Decided`); sois obligé (ID: `keyterm:Ought`); église (ID: `keyterm:Church`); autorité (ID: `keyterm:Authority.2`); capacité (ID: `keyterm:Ability`); se rendre (ID: `keyterm:Teaching`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); corps (ID: `keyterm:Body.3`); decider (ID: `keyterm:Decided`); église (ID: `keyterm:Church`); évaluer (ID: `keyterm:Discern`); jugement (ID: `keyterm:Judgment`); sang (ID: `keyterm:Blood`); House (ID: `realia:House`); approuvé (ID: `keyterm:Approved`); tester (ID: `keyterm:Interpret`); Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); condamner (ID: `keyterm:Condemn`); capacité (ID: `keyterm:Ability`); alliance (ID: `keyterm:Covenant`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Saint-Esprit (ID: `deity:HolySpirit`); Jésus (ID: `person:Jesus.2`); grâce (ID: `keyterm:Favor`); Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); servir (ID: `keyterm:Serve`); esprit (ID: `keyterm:Spirit.2`); évaluer (ID: `keyterm:Discern`); croire (ID: `keyterm:Believe`); A Person (ID: `person:GenericPerson`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** corps (ID: `keyterm:Body.3`); grâce (ID: `keyterm:Favor`); Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); capacité (ID: `keyterm:Ability`); gloire (ID: `keyterm:Glory`); Yavanite (ID: `group:Greek`); baptême (ID: `keyterm:Baptism`); église (ID: `keyterm:Church`); Jews (ID: `group:Jews`); Saint-Esprit (ID: `deity:HolySpirit`); Javan (ID: `person:Javan`)
...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); croire (ID: `keyterm:Believe`); espoir (ID: `keyterm:Hope`); An Angel (ID: `deity:Angel`); vérité (ID: `keyterm:Truth`); penser (ID: `keyterm:Think`); corps (ID: `keyterm:Body.3`); parler (ID: `keyterm:Speak`); méfaits (ID: `keyterm:UnjustDeed`); Mirror (ID: `realia:Mirror`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** église (ID: `keyterm:Church`); parler (ID: `keyterm:Speak`); Éternel (ID: `deity:Lord`); esprit (ID: `keyterm:Spirit.2`); rénforcer (ID: `keyterm:BuildingUp`); prier (ID: `keyterm:Pray`); Saint-Esprit (ID: `deity:HolySpirit`); capacité (ID: `keyterm:Ability`); être infidèle (ID: `keyterm:Unfaithful`); sûrement! (ID: `keyterm:Surely`); adorer (ID: `keyterm:BowDown`); évaluer (ID: `keyterm:Discern`); croire (ID: `keyterm:Believe`); A Person (ID: `person:GenericPerson`); aimer (ID: `keyterm:Love`); benir (ID: `keyterm:Bless`); coeur (ID: `keyterm:Heart`); prier (ID: `keyterm:AskFor`); loi (ID: `keyterm:Law`); exemple (ID: `keyterm:Example`); Lyre (ID: `realia:Lyre`); Trumpet (ID: `realia:Trumpet`); Flute (ID: `realia:Flute`)
...
* **Associated ACAI Concepts:** église (ID: `keyterm:Church`); Éternel (ID: `deity:Lord`); parler (ID: `keyterm:Speak`); Jésus (ID: `person:Jesus.2`); saint (ID: `keyterm:Holy`); faire la paix (ID: `keyterm:Peace`); esprit (ID: `keyterm:Spirit.2`); prier (ID: `keyterm:AskFor`); loi (ID: `keyterm:Law`); rénforcer (ID: `keyterm:BuildingUp`); prier (ID: `keyterm:Encourage`); évaluer (ID: `keyterm:Discern`); capacité (ID: `keyterm:Ability`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); résurrection (ID: `keyterm:Resurrection`); croire (ID: `keyterm:Believe`); Éternel (ID: `deity:Lord`); proclamer (ID: `keyterm:Proclaim`); vide (ID: `keyterm:Empty`); scripture (ID: `keyterm:Scripture`); bonnes nouvelles (ID: `keyterm:GoodNews`); pécher (ID: `keyterm:Sin`); en christ (ID: `keyterm:InChrist`); sans valeur (ID: `keyterm:Worthless`); aide (ID: `keyterm:Salvation`); témoigner (ID: `keyterm:BearWitness`); Jacques (ID: `person:James.3`); espoir (ID: `keyterm:Hope`); Pierre (ID: `person:Peter`); vie (ID: `keyterm:Life`); pitoyable (ID: `keyterm:Pitiful`); église (ID: `keyterm:Church`); grâce (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); résurrection (ID: `keyterm:Resurrection`); Éternel (ID: `deity:Lord`); Adam (ID: `person:Adam`); Éphèse (ID: `place:Ephesus`); régne (ID: `keyterm:Kingdom`); baptême (ID: `keyterm:Baptism`); pécher (ID: `keyterm:Sin`); autorité (ID: `keyterm:Authority.2`); en christ (ID: `keyterm:InChrist`); le bien (ID: `keyterm:Good`); capacité (ID: `keyterm:Ability`)
...
* **Associated ACAI Concepts:** corps (ID: `keyterm:Body.3`); résurrection (ID: `keyterm:Resurrection`); capacité (ID: `keyterm:Ability`); gloire (ID: `keyterm:Glory`); Éternel (ID: `deity:Lord`); non spirituel (ID: `keyterm:Natural`); céleste (ID: `keyterm:Heavenly`); Jésus (ID: `person:Jesus.2`); Grain (ID: `flora:Grain`); imperissable (ID: `keyterm:Imperishable`); pécher (ID: `keyterm:Sin`); A Person (ID: `person:GenericPerson`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); faire vivre (ID: `keyterm:Alive`); vie (ID: `keyterm:Life`); vide (ID: `keyterm:Empty`); loi (ID: `keyterm:Law`); Adam (ID: `person:Adam`); esprit (ID: `keyterm:Spirit.2`); grâce (ID: `keyterm:Favor`); régne (ID: `keyterm:Kingdom`); bien, aimé (ID: `keyterm:Beloved`); sang (ID: `keyterm:Blood`); Trumpet (ID: `realia:Trumpet`); Bird (ID: `fauna:Bird`); Rooster (ID: `fauna:Rooster`); Fish (ID: `fauna:Fish`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); saint (ID: `keyterm:Holy`); Stéphanas (ID: `person:Stephanas`); aimer (ID: `keyterm:Love`); prier (ID: `keyterm:AskFor`); église (ID: `keyterm:Church`); grâce (ID: `keyterm:Favor`); Achaïcus (ID: `person:Achaicus`); Fortunatus (ID: `person:Fortunatus`); semaine (ID: `keyterm:Week`); Aquilas (ID: `person:Aquila`); Priscille (ID: `person:Priscilla`); Achaïe (ID: `place:Achaia`); Paul (ID: `person:Paul`); Macédoine (ID: `place:Macedonia`); croire (ID: `keyterm:Believe`); Apollos (ID: `person:Apollos`); amour (ID: `keyterm:Friendship`); Timothée (ID: `person:Timothy`); espoir (ID: `keyterm:Hope`); Asie (ID: `place:Asia`); Éternel (ID: `deity:Lord`); tester (ID: `keyterm:Interpret`); Jérusalem (ID: `place:Jerusalem`); Galatie (ID: `place:Galatia`); servir (ID: `keyterm:Serve`); faire la paix (ID: `keyterm:Peace`); Éphèse (ID: `place:Ephesus`); esprit (ID: `keyterm:Spirit.2`); en christ (ID: `keyterm:InChrist`); House (ID: `realia:House`); Door (ID: `realia:Door`); Temple (ID: `realia:Temple`)
