...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); baptême (ID: `keyterm:Baptism`); nom (ID: `keyterm:Name`); Paul (ID: `person:Paul`); grâce (ID: `keyterm:Favor`); en christ (ID: `keyterm:InChrist`); Cross (ID: `realia:Cross`); Chloé (ID: `person:Chloe`); Crispus (ID: `person:Crispus`); Stéphanas (ID: `person:Stephanas`); Sosthène (ID: `person:Sosthenes`); A Disciple (ID: `person:GenericDisciple`); Gaïus (ID: `person:Gaius.3`); bonnes nouvelles (ID: `keyterm:GoodNews`); appeler (ID: `keyterm:CallUpon`); Apollos (ID: `person:Apollos`); fraternité (ID: `keyterm:Fellowship`); Pierre (ID: `person:Peter`); priver de la puissance (ID: `keyterm:DepriveOfPower`); fidelité (ID: `keyterm:Faithfulness`); Corinthe (ID: `place:Corinth`); prier (ID: `keyterm:AskFor`); faire la paix (ID: `keyterm:Peace`); au, dessus de tout reproche (ID: `keyterm:WithoutReproach`); église (ID: `keyterm:Church`); témoigner (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); Jésus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); corps (ID: `keyterm:Body.3`); proclamer (ID: `keyterm:Proclaim`); choisi (ID: `keyterm:Chosen`); Yavanite (ID: `group:Greek`); Javan (ID: `person:Javan`); aide (ID: `keyterm:Salvation`); Cross (ID: `realia:Cross`); consécration (ID: `keyterm:Consecration.2`); éternellement (ID: `keyterm:Always`); exemple (ID: `keyterm:Example`); en christ (ID: `keyterm:InChrist`); libération (ID: `keyterm:Liberation`); croire (ID: `keyterm:Believe`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); nation; peuple (ID: `group:Gentile`); être juste (ID: `keyterm:Just`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); Saint-Esprit (ID: `deity:HolySpirit`); Jésus (ID: `person:Jesus.2`); éternellement (ID: `keyterm:Always`); évaluer (ID: `keyterm:Discern`); esprit (ID: `keyterm:Spirit.2`); gloire (ID: `keyterm:Glory`); Cross (ID: `realia:Cross`); non spirituel (ID: `keyterm:Natural`); decider (ID: `keyterm:Decided`); proclamer (ID: `keyterm:Proclaim`); aimer (ID: `keyterm:Love`); craindre (ID: `keyterm:Fear`); croire (ID: `keyterm:Believe`); coeur (ID: `keyterm:Heart`); pardonner (ID: `keyterm:Forgive`)
...
* **Associated ACAI Concepts:** Apollos (ID: `person:Apollos`); Éternel (ID: `deity:Lord`); appartenant à ce monde (ID: `keyterm:Carnal`); Jésus (ID: `person:Jesus.2`); Paul (ID: `person:Paul`); A Disciple (ID: `person:GenericDisciple`); capacité (ID: `keyterm:Ability`); jalousie (ID: `keyterm:Resentment`); croire (ID: `keyterm:Believe`); en christ (ID: `keyterm:InChrist`); marcher (ID: `keyterm:Live.3`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); Jésus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Foundation (ID: `realia:Foundation`); tester (ID: `keyterm:Interpret`); grâce (ID: `keyterm:Favor`); Apollos (ID: `person:Apollos`); saint (ID: `keyterm:Holy`); Saint-Esprit (ID: `deity:HolySpirit`); Pierre (ID: `person:Peter`); vie (ID: `keyterm:Life`); Paul (ID: `person:Paul`); sans valeur (ID: `keyterm:Worthless`); aide (ID: `keyterm:Salvation`); éternellement (ID: `keyterm:Always`); Grass (ID: `flora:Grass`); Reed (ID: `flora:Reed`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); en christ (ID: `keyterm:InChrist`); évaluer (ID: `keyterm:Discern`); fidelité (ID: `keyterm:Faithfulness`); bien, aimé (ID: `keyterm:Beloved`); prier (ID: `keyterm:AskFor`); decider (ID: `keyterm:Decided`); bonnes nouvelles (ID: `keyterm:GoodNews`); aimer (ID: `keyterm:Love`); coeur (ID: `keyterm:Heart`); régne (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); benir (ID: `keyterm:Bless`); Apollos (ID: `person:Apollos`); glorieux (ID: `keyterm:Glorious`); Timothée (ID: `person:Timothy`); esprit (ID: `keyterm:Spirit.2`); église (ID: `keyterm:Church`); calomnier (ID: `keyterm:Defame`); Staff (ID: `realia:Staff`)
...
* **Associated ACAI Concepts:** decider (ID: `keyterm:Decided`); esprit (ID: `keyterm:Spirit.2`); Jésus (ID: `person:Jesus.2`); capacité (ID: `keyterm:Ability`); corps (ID: `keyterm:Body.3`); idolâtre (ID: `keyterm:Idolater`); sacrifice de la pâque (ID: `keyterm:Passover`); offrande (ID: `keyterm:Offering`); nom (ID: `keyterm:Name`); nation; peuple (ID: `group:Gentile`); vérité (ID: `keyterm:Truth`); Satan (ID: `deity:Satan`); sois obligé (ID: `keyterm:Ought`); sans saleté (ID: `keyterm:Pure`); fornication (ID: `keyterm:Fornication`); Éternel (ID: `deity:Lord`); aide (ID: `keyterm:Salvation`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** decider (ID: `keyterm:Decided`); Éternel (ID: `deity:Lord`); agir par méchanceté (ID: `keyterm:ActWickedly`); tribunal (ID: `keyterm:CourtCase`); saint (ID: `keyterm:Holy`); régne (ID: `keyterm:Kingdom`); concernant la vie quotidienne (ID: `keyterm:OfThisLife`); idolâtre (ID: `keyterm:Idolater`); capacité (ID: `keyterm:Ability`); consécration (ID: `keyterm:Consecration.2`); An Angel (ID: `deity:Angel`); être juste (ID: `keyterm:Just`); nom (ID: `keyterm:Name`); évaluer (ID: `keyterm:Discern`); jugement (ID: `keyterm:Judgment`); Jésus (ID: `person:Jesus.2`); église (ID: `keyterm:Church`); Saint-Esprit (ID: `deity:HolySpirit`)
...
* **Associated ACAI Concepts:** corps (ID: `keyterm:Body.3`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); fornication (ID: `keyterm:Fornication`); gloire (ID: `keyterm:Glory`); capacité (ID: `keyterm:Ability`); pécher (ID: `keyterm:Sin`); esprit (ID: `keyterm:Spirit.2`); Saint-Esprit (ID: `deity:HolySpirit`); autorité (ID: `keyterm:Authority.2`); résurrection (ID: `keyterm:Resurrection`); Be Lawful (ID: `keyterm:Lawful`); acheter (ID: `keyterm:Redeem`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** être infidèle (ID: `keyterm:Unfaithful`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); faire la paix (ID: `keyterm:Peace`); consécration (ID: `keyterm:Consecration.2`); saint (ID: `keyterm:Holy`); grâce (ID: `keyterm:Favor`); corps (ID: `keyterm:Body.3`); pollution (ID: `keyterm:Defilement`); autorité (ID: `keyterm:Authority.2`); Satan (ID: `deity:Satan`); réconcilier (ID: `keyterm:Reconcile`); mis à l'essai (ID: `keyterm:PutToTheTest`); dette (ID: `keyterm:Debt`); fornication (ID: `keyterm:Fornication`); aide (ID: `keyterm:Salvation`); prier (ID: `keyterm:Pray`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); capacité (ID: `keyterm:Ability`); corps (ID: `keyterm:Body.3`); pécher (ID: `keyterm:Sin`); vie (ID: `keyterm:Life`); sois obligé (ID: `keyterm:Ought`); coeur (ID: `keyterm:Heart`); acheter (ID: `keyterm:Redeem`); marcher (ID: `keyterm:Live.3`); commandement (ID: `keyterm:Commandment`); decider (ID: `keyterm:Decided`); saint (ID: `keyterm:Holy`); autorité (ID: `keyterm:Authority.2`); pitié (ID: `keyterm:Mercy`); fidelité (ID: `keyterm:Faithfulness`); Circumcision (ID: `keyterm:Circumcision`); Saint-Esprit (ID: `deity:HolySpirit`); esprit (ID: `keyterm:Spirit.2`); église (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); conscience (ID: `keyterm:Conscience`); capacité (ID: `keyterm:Ability`); aimer (ID: `keyterm:Love`); Image (ID: `realia:Image`); faire pécher qqn (ID: `keyterm:CauseToStumble`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); pollution (ID: `keyterm:Defilement`); pécher (ID: `keyterm:Sin`); autorité (ID: `keyterm:Authority.2`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); éternellement (ID: `keyterm:Always`); Temple of an Idol (ID: `realia:TempleOfAnIdol`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Jésus (ID: `person:Jesus.2`); autorité (ID: `keyterm:Authority.2`); bonnes nouvelles (ID: `keyterm:GoodNews`); prendre part (ID: `keyterm:Partake`); loi (ID: `keyterm:Law`); Grain (ID: `flora:Grain`); vie (ID: `keyterm:Life`); preuve (ID: `keyterm:Certification`); sois obligé (ID: `keyterm:Ought`); Pierre (ID: `person:Peter`); priver de la puissance (ID: `keyterm:DepriveOfPower`); Éternel (ID: `deity:Lord`); gestion d'un foyer (ID: `keyterm:Stewardship`); évaluer (ID: `keyterm:Discern`); croire (ID: `keyterm:Believe`); Moïse (ID: `person:Moses`); appartenant à ce monde (ID: `keyterm:Carnal`); Barnabas (ID: `person:Barnabas`); espoir (ID: `keyterm:Hope`); Disaster (ID: `keyterm:Disaster`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Vine (ID: `flora:Vine`); Cattle (ID: `fauna:Bull`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** loi (ID: `keyterm:Law`); bonnes nouvelles (ID: `keyterm:GoodNews`); corps (ID: `keyterm:Body.3`); proclamer (ID: `keyterm:Proclaim`); corruption morale (ID: `keyterm:Lawless`); Jésus (ID: `person:Jesus.2`); Be Lawful (ID: `keyterm:Lawful`); imperissable (ID: `keyterm:Imperishable`); maîtriser (ID: `keyterm:ReadyForService`); Éternel (ID: `deity:Lord`); Jews (ID: `group:Jews`); aide (ID: `keyterm:Salvation`); Arena (ID: `realia:Arena`); Crown (ID: `realia:Crown.2`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); conscience (ID: `keyterm:Conscience`); prendre part (ID: `keyterm:Partake`); corps (ID: `keyterm:Body.3`); decider (ID: `keyterm:Decided`); offrande (ID: `keyterm:Offering`); évaluer (ID: `keyterm:Discern`); Demons (ID: `deity:Demons`); Be Lawful (ID: `keyterm:Lawful`); fraternité (ID: `keyterm:Fellowship`); gloire (ID: `keyterm:Glory`); sang (ID: `keyterm:Blood`); Yavanite (ID: `group:Greek`); benir (ID: `keyterm:Bless`); bien, aimé (ID: `keyterm:Beloved`); grâce (ID: `keyterm:Favor`); idolâtrie (ID: `keyterm:Idolatry`); parler contre dieu (ID: `keyterm:Blaspheme`); Jews (ID: `group:Jews`); Israël (ID: `person:Israel`); A Person (ID: `person:GenericPerson`); Javan (ID: `person:Javan`); église (ID: `keyterm:Church`); aide (ID: `keyterm:Salvation`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); prier (ID: `keyterm:Pray`); gloire (ID: `keyterm:Glory`); parler (ID: `keyterm:Speak`); Jésus (ID: `person:Jesus.2`); capacité (ID: `keyterm:Ability`); decider (ID: `keyterm:Decided`); An Angel (ID: `deity:Angel`); se rendre (ID: `keyterm:Teaching`); autorité (ID: `keyterm:Authority.2`); sois obligé (ID: `keyterm:Ought`); église (ID: `keyterm:Church`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); corps (ID: `keyterm:Body.3`); decider (ID: `keyterm:Decided`); sang (ID: `keyterm:Blood`); évaluer (ID: `keyterm:Discern`); jugement (ID: `keyterm:Judgment`); église (ID: `keyterm:Church`); House (ID: `realia:House`); approuvé (ID: `keyterm:Approved`); capacité (ID: `keyterm:Ability`); alliance (ID: `keyterm:Covenant`); croire (ID: `keyterm:Believe`); condamner (ID: `keyterm:Condemn`); Éternel (ID: `deity:Lord`); tester (ID: `keyterm:Interpret`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Saint-Esprit (ID: `deity:HolySpirit`); capacité (ID: `keyterm:Ability`); grâce (ID: `keyterm:Favor`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); évaluer (ID: `keyterm:Discern`); A Person (ID: `person:GenericPerson`); esprit (ID: `keyterm:Spirit.2`); croire (ID: `keyterm:Believe`); servir (ID: `keyterm:Serve`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** corps (ID: `keyterm:Body.3`); grâce (ID: `keyterm:Favor`); Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); Jésus (ID: `person:Jesus.2`); gloire (ID: `keyterm:Glory`); Saint-Esprit (ID: `deity:HolySpirit`); Javan (ID: `person:Javan`); baptême (ID: `keyterm:Baptism`); église (ID: `keyterm:Church`); Jews (ID: `group:Jews`); Yavanite (ID: `group:Greek`)
...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); croire (ID: `keyterm:Believe`); espoir (ID: `keyterm:Hope`); méfaits (ID: `keyterm:UnjustDeed`); An Angel (ID: `deity:Angel`); corps (ID: `keyterm:Body.3`); parler (ID: `keyterm:Speak`); vérité (ID: `keyterm:Truth`); penser (ID: `keyterm:Think`); Mirror (ID: `realia:Mirror`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** parler (ID: `keyterm:Speak`); église (ID: `keyterm:Church`); Éternel (ID: `deity:Lord`); esprit (ID: `keyterm:Spirit.2`); rénforcer (ID: `keyterm:BuildingUp`); prier (ID: `keyterm:Pray`); Saint-Esprit (ID: `deity:HolySpirit`); capacité (ID: `keyterm:Ability`); être infidèle (ID: `keyterm:Unfaithful`); aimer (ID: `keyterm:Love`); sûrement! (ID: `keyterm:Surely`); coeur (ID: `keyterm:Heart`); exemple (ID: `keyterm:Example`); benir (ID: `keyterm:Bless`); adorer (ID: `keyterm:BowDown`); loi (ID: `keyterm:Law`); évaluer (ID: `keyterm:Discern`); croire (ID: `keyterm:Believe`); prier (ID: `keyterm:AskFor`); A Person (ID: `person:GenericPerson`); Lyre (ID: `realia:Lyre`); Flute (ID: `realia:Flute`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); église (ID: `keyterm:Church`); parler (ID: `keyterm:Speak`); loi (ID: `keyterm:Law`); faire la paix (ID: `keyterm:Peace`); capacité (ID: `keyterm:Ability`); saint (ID: `keyterm:Holy`); évaluer (ID: `keyterm:Discern`); esprit (ID: `keyterm:Spirit.2`); prier (ID: `keyterm:Encourage`); Jésus (ID: `person:Jesus.2`); prier (ID: `keyterm:AskFor`); rénforcer (ID: `keyterm:BuildingUp`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); résurrection (ID: `keyterm:Resurrection`); croire (ID: `keyterm:Believe`); proclamer (ID: `keyterm:Proclaim`); Éternel (ID: `deity:Lord`); vide (ID: `keyterm:Empty`); bonnes nouvelles (ID: `keyterm:GoodNews`); pécher (ID: `keyterm:Sin`); en christ (ID: `keyterm:InChrist`); scripture (ID: `keyterm:Scripture`); Jacques (ID: `person:James.3`); vie (ID: `keyterm:Life`); Pierre (ID: `person:Peter`); grâce (ID: `keyterm:Favor`); sans valeur (ID: `keyterm:Worthless`); pitoyable (ID: `keyterm:Pitiful`); aide (ID: `keyterm:Salvation`); espoir (ID: `keyterm:Hope`); église (ID: `keyterm:Church`); témoigner (ID: `keyterm:BearWitness`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); résurrection (ID: `keyterm:Resurrection`); Éternel (ID: `deity:Lord`); Adam (ID: `person:Adam`); régne (ID: `keyterm:Kingdom`); capacité (ID: `keyterm:Ability`); pécher (ID: `keyterm:Sin`); le bien (ID: `keyterm:Good`); Éphèse (ID: `place:Ephesus`); autorité (ID: `keyterm:Authority.2`); baptême (ID: `keyterm:Baptism`); en christ (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** corps (ID: `keyterm:Body.3`); résurrection (ID: `keyterm:Resurrection`); capacité (ID: `keyterm:Ability`); gloire (ID: `keyterm:Glory`); Éternel (ID: `deity:Lord`); non spirituel (ID: `keyterm:Natural`); Jésus (ID: `person:Jesus.2`); céleste (ID: `keyterm:Heavenly`); Grain (ID: `flora:Grain`); imperissable (ID: `keyterm:Imperishable`); sang (ID: `keyterm:Blood`); vie (ID: `keyterm:Life`); vide (ID: `keyterm:Empty`); régne (ID: `keyterm:Kingdom`); bien, aimé (ID: `keyterm:Beloved`); pécher (ID: `keyterm:Sin`); loi (ID: `keyterm:Law`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); grâce (ID: `keyterm:Favor`); Adam (ID: `person:Adam`); A Person (ID: `person:GenericPerson`); esprit (ID: `keyterm:Spirit.2`); faire vivre (ID: `keyterm:Alive`); Trumpet (ID: `realia:Trumpet`); Fish (ID: `fauna:Fish`); Wheat (ID: `flora:Wheat`); Rooster (ID: `fauna:Rooster`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); saint (ID: `keyterm:Holy`); Stéphanas (ID: `person:Stephanas`); aimer (ID: `keyterm:Love`); grâce (ID: `keyterm:Favor`); prier (ID: `keyterm:AskFor`); église (ID: `keyterm:Church`); Achaïcus (ID: `person:Achaicus`); Fortunatus (ID: `person:Fortunatus`); Priscille (ID: `person:Priscilla`); Aquilas (ID: `person:Aquila`); Achaïe (ID: `place:Achaia`); semaine (ID: `keyterm:Week`); Jérusalem (ID: `place:Jerusalem`); Galatie (ID: `place:Galatia`); Macédoine (ID: `place:Macedonia`); Paul (ID: `person:Paul`); Apollos (ID: `person:Apollos`); Éphèse (ID: `place:Ephesus`); Éternel (ID: `deity:Lord`); en christ (ID: `keyterm:InChrist`); croire (ID: `keyterm:Believe`); Asie (ID: `place:Asia`); servir (ID: `keyterm:Serve`); Timothée (ID: `person:Timothy`); tester (ID: `keyterm:Interpret`); faire la paix (ID: `keyterm:Peace`); esprit (ID: `keyterm:Spirit.2`); amour (ID: `keyterm:Friendship`); espoir (ID: `keyterm:Hope`); Door (ID: `realia:Door`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
