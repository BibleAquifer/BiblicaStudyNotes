...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); baptême (ID: `keyterm:Baptism`); nom (ID: `keyterm:Name`); Paul (ID: `person:Paul`); grâce (ID: `keyterm:Favor`); en christ (ID: `keyterm:InChrist`); Cross (ID: `realia:Cross`); Gaïus (ID: `person:Gaius.3`); Sosthène (ID: `person:Sosthenes`); A Disciple (ID: `person:GenericDisciple`); Chloé (ID: `person:Chloe`); Crispus (ID: `person:Crispus`); Stéphanas (ID: `person:Stephanas`); témoigner (ID: `keyterm:BearWitness`); Corinthe (ID: `place:Corinth`); prier (ID: `keyterm:AskFor`); Apollos (ID: `person:Apollos`); bonnes nouvelles (ID: `keyterm:GoodNews`); faire la paix (ID: `keyterm:Peace`); au, dessus de tout reproche (ID: `keyterm:WithoutReproach`); fidelité (ID: `keyterm:Faithfulness`); priver de la puissance (ID: `keyterm:DepriveOfPower`); appeler (ID: `keyterm:CallUpon`); église (ID: `keyterm:Church`); fraternité (ID: `keyterm:Fellowship`); Pierre (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); Jésus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); proclamer (ID: `keyterm:Proclaim`); Javan (ID: `person:Javan`); choisi (ID: `keyterm:Chosen`); corps (ID: `keyterm:Body.3`); Yavanite (ID: `group:Greek`); aide (ID: `keyterm:Salvation`); Cross (ID: `realia:Cross`); consécration (ID: `keyterm:Consecration.2`); exemple (ID: `keyterm:Example`); en christ (ID: `keyterm:InChrist`); être juste (ID: `keyterm:Just`); éternellement (ID: `keyterm:Always`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); libération (ID: `keyterm:Liberation`); nation; peuple (ID: `group:Gentile`); croire (ID: `keyterm:Believe`)
...
* **Associated Articles:** Leader serviteur (ID: `133311@BiblicaStudyNotesKeyTerms`); Christ (ID: `133350@BiblicaStudyNotesKeyTerms`); Mystère du Christ (ID: `133397@BiblicaStudyNotesKeyTerms`); Les êtres humains (ID: `133454@BiblicaStudyNotesKeyTerms`); Foi (ID: `133484@BiblicaStudyNotes`); Sacrifice (ID: `133508@BiblicaStudyNotesKeyTerms`); Le Saint-Esprit (ID: `133640@BiblicaStudyNotesKeyTerms`); Spirituel (ID: `133714@BiblicaStudyNotesKeyTerms`); Fils de Dieu (ID: `133778@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); Saint-Esprit (ID: `deity:HolySpirit`); Jésus (ID: `person:Jesus.2`); éternellement (ID: `keyterm:Always`); esprit (ID: `keyterm:Spirit.2`); évaluer (ID: `keyterm:Discern`); gloire (ID: `keyterm:Glory`); Cross (ID: `realia:Cross`); non spirituel (ID: `keyterm:Natural`); coeur (ID: `keyterm:Heart`); croire (ID: `keyterm:Believe`); craindre (ID: `keyterm:Fear`); pardonner (ID: `keyterm:Forgive`); decider (ID: `keyterm:Decided`); proclamer (ID: `keyterm:Proclaim`); aimer (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); Jésus (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Foundation (ID: `realia:Foundation`); tester (ID: `keyterm:Interpret`); Pierre (ID: `person:Peter`); grâce (ID: `keyterm:Favor`); sans valeur (ID: `keyterm:Worthless`); Saint-Esprit (ID: `deity:HolySpirit`); aide (ID: `keyterm:Salvation`); Paul (ID: `person:Paul`); vie (ID: `keyterm:Life`); éternellement (ID: `keyterm:Always`); saint (ID: `keyterm:Holy`); Apollos (ID: `person:Apollos`); Grass (ID: `flora:Grass`); Reed (ID: `flora:Reed`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); capacité (ID: `keyterm:Ability`); en christ (ID: `keyterm:InChrist`); évaluer (ID: `keyterm:Discern`); fidelité (ID: `keyterm:Faithfulness`); prier (ID: `keyterm:AskFor`); bien, aimé (ID: `keyterm:Beloved`); decider (ID: `keyterm:Decided`); coeur (ID: `keyterm:Heart`); bonnes nouvelles (ID: `keyterm:GoodNews`); Apollos (ID: `person:Apollos`); benir (ID: `keyterm:Bless`); Timothée (ID: `person:Timothy`); régne (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); calomnier (ID: `keyterm:Defame`); église (ID: `keyterm:Church`); esprit (ID: `keyterm:Spirit.2`); glorieux (ID: `keyterm:Glorious`); aimer (ID: `keyterm:Love`); Staff (ID: `realia:Staff`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); decider (ID: `keyterm:Decided`); esprit (ID: `keyterm:Spirit.2`); idolâtre (ID: `keyterm:Idolater`); capacité (ID: `keyterm:Ability`); corps (ID: `keyterm:Body.3`); sacrifice de la pâque (ID: `keyterm:Passover`); offrande (ID: `keyterm:Offering`); sans saleté (ID: `keyterm:Pure`); vérité (ID: `keyterm:Truth`); nom (ID: `keyterm:Name`); aide (ID: `keyterm:Salvation`); Satan (ID: `deity:Satan`); fornication (ID: `keyterm:Fornication`); Éternel (ID: `deity:Lord`); sois obligé (ID: `keyterm:Ought`); nation; peuple (ID: `group:Gentile`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** decider (ID: `keyterm:Decided`); Éternel (ID: `deity:Lord`); agir par méchanceté (ID: `keyterm:ActWickedly`); tribunal (ID: `keyterm:CourtCase`); régne (ID: `keyterm:Kingdom`); concernant la vie quotidienne (ID: `keyterm:OfThisLife`); saint (ID: `keyterm:Holy`); idolâtre (ID: `keyterm:Idolater`); nom (ID: `keyterm:Name`); Saint-Esprit (ID: `deity:HolySpirit`); consécration (ID: `keyterm:Consecration.2`); Jésus (ID: `person:Jesus.2`); jugement (ID: `keyterm:Judgment`); capacité (ID: `keyterm:Ability`); église (ID: `keyterm:Church`); être juste (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); évaluer (ID: `keyterm:Discern`)
...
* **Associated ACAI Concepts:** corps (ID: `keyterm:Body.3`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); fornication (ID: `keyterm:Fornication`); résurrection (ID: `keyterm:Resurrection`); autorité (ID: `keyterm:Authority.2`); Saint-Esprit (ID: `deity:HolySpirit`); acheter (ID: `keyterm:Redeem`); capacité (ID: `keyterm:Ability`); pécher (ID: `keyterm:Sin`); esprit (ID: `keyterm:Spirit.2`); Be Lawful (ID: `keyterm:Lawful`); gloire (ID: `keyterm:Glory`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** être infidèle (ID: `keyterm:Unfaithful`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); grâce (ID: `keyterm:Favor`); autorité (ID: `keyterm:Authority.2`); aide (ID: `keyterm:Salvation`); Satan (ID: `deity:Satan`); consécration (ID: `keyterm:Consecration.2`); faire la paix (ID: `keyterm:Peace`); fornication (ID: `keyterm:Fornication`); mis à l'essai (ID: `keyterm:PutToTheTest`); dette (ID: `keyterm:Debt`); saint (ID: `keyterm:Holy`); corps (ID: `keyterm:Body.3`); prier (ID: `keyterm:Pray`); pollution (ID: `keyterm:Defilement`); réconcilier (ID: `keyterm:Reconcile`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); capacité (ID: `keyterm:Ability`); corps (ID: `keyterm:Body.3`); pécher (ID: `keyterm:Sin`); coeur (ID: `keyterm:Heart`); autorité (ID: `keyterm:Authority.2`); Circumcision (ID: `keyterm:Circumcision`); sois obligé (ID: `keyterm:Ought`); commandement (ID: `keyterm:Commandment`); acheter (ID: `keyterm:Redeem`); decider (ID: `keyterm:Decided`); pitié (ID: `keyterm:Mercy`); fidelité (ID: `keyterm:Faithfulness`); marcher (ID: `keyterm:Live.3`); vie (ID: `keyterm:Life`); Saint-Esprit (ID: `deity:HolySpirit`); église (ID: `keyterm:Church`); saint (ID: `keyterm:Holy`); esprit (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); conscience (ID: `keyterm:Conscience`); Jésus (ID: `person:Jesus.2`); capacité (ID: `keyterm:Ability`); aimer (ID: `keyterm:Love`); Image (ID: `realia:Image`); faire pécher qqn (ID: `keyterm:CauseToStumble`); ce qui cause le péché ou donne l'occasion de pécher (ID: `keyterm:StumblingBlock`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); autorité (ID: `keyterm:Authority.2`); pécher (ID: `keyterm:Sin`); éternellement (ID: `keyterm:Always`); pollution (ID: `keyterm:Defilement`); Temple of an Idol (ID: `realia:TempleOfAnIdol`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); autorité (ID: `keyterm:Authority.2`); Jésus (ID: `person:Jesus.2`); bonnes nouvelles (ID: `keyterm:GoodNews`); prendre part (ID: `keyterm:Partake`); loi (ID: `keyterm:Law`); Grain (ID: `flora:Grain`); gestion d'un foyer (ID: `keyterm:Stewardship`); sois obligé (ID: `keyterm:Ought`); espoir (ID: `keyterm:Hope`); appartenant à ce monde (ID: `keyterm:Carnal`); Barnabas (ID: `person:Barnabas`); Disaster (ID: `keyterm:Disaster`); Moïse (ID: `person:Moses`); Éternel (ID: `deity:Lord`); évaluer (ID: `keyterm:Discern`); vie (ID: `keyterm:Life`); croire (ID: `keyterm:Believe`); priver de la puissance (ID: `keyterm:DepriveOfPower`); preuve (ID: `keyterm:Certification`); Pierre (ID: `person:Peter`); Cattle (ID: `fauna:Bull`); Temple (ID: `realia:Temple`); Sheep (ID: `fauna:Lamb`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** aide (ID: `keyterm:Salvation`); Jésus (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); imperissable (ID: `keyterm:Imperishable`); Éternel (ID: `deity:Lord`); maîtriser (ID: `keyterm:ReadyForService`); Be Lawful (ID: `keyterm:Lawful`); corps (ID: `keyterm:Body.3`); bonnes nouvelles (ID: `keyterm:GoodNews`); corruption morale (ID: `keyterm:Lawless`); proclamer (ID: `keyterm:Proclaim`); loi (ID: `keyterm:Law`); Crown (ID: `realia:Crown.2`); Arena (ID: `realia:Arena`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); idolâtre (ID: `keyterm:Idolater`); mis à l'essai (ID: `keyterm:PutToTheTest`); Moïse (ID: `person:Moses`); fornication (ID: `keyterm:Fornication`); fidelité (ID: `keyterm:Faithfulness`); éternellement (ID: `keyterm:Always`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); conscience (ID: `keyterm:Conscience`); prendre part (ID: `keyterm:Partake`); corps (ID: `keyterm:Body.3`); offrande (ID: `keyterm:Offering`); decider (ID: `keyterm:Decided`); Demons (ID: `deity:Demons`); évaluer (ID: `keyterm:Discern`); Be Lawful (ID: `keyterm:Lawful`); fraternité (ID: `keyterm:Fellowship`); parler contre dieu (ID: `keyterm:Blaspheme`); A Person (ID: `person:GenericPerson`); benir (ID: `keyterm:Bless`); Javan (ID: `person:Javan`); grâce (ID: `keyterm:Favor`); bien, aimé (ID: `keyterm:Beloved`); Yavanite (ID: `group:Greek`); idolâtrie (ID: `keyterm:Idolatry`); sang (ID: `keyterm:Blood`); aide (ID: `keyterm:Salvation`); Jews (ID: `group:Jews`); église (ID: `keyterm:Church`); Israël (ID: `person:Israel`); gloire (ID: `keyterm:Glory`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); prier (ID: `keyterm:Pray`); Jésus (ID: `person:Jesus.2`); parler (ID: `keyterm:Speak`); gloire (ID: `keyterm:Glory`); se rendre (ID: `keyterm:Teaching`); autorité (ID: `keyterm:Authority.2`); église (ID: `keyterm:Church`); capacité (ID: `keyterm:Ability`); decider (ID: `keyterm:Decided`); An Angel (ID: `deity:Angel`); sois obligé (ID: `keyterm:Ought`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); corps (ID: `keyterm:Body.3`); sang (ID: `keyterm:Blood`); jugement (ID: `keyterm:Judgment`); decider (ID: `keyterm:Decided`); église (ID: `keyterm:Church`); évaluer (ID: `keyterm:Discern`); House (ID: `realia:House`); approuvé (ID: `keyterm:Approved`); croire (ID: `keyterm:Believe`); tester (ID: `keyterm:Interpret`); capacité (ID: `keyterm:Ability`); condamner (ID: `keyterm:Condemn`); Éternel (ID: `deity:Lord`); alliance (ID: `keyterm:Covenant`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Saint-Esprit (ID: `deity:HolySpirit`); grâce (ID: `keyterm:Favor`); Jésus (ID: `person:Jesus.2`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); croire (ID: `keyterm:Believe`); A Person (ID: `person:GenericPerson`); évaluer (ID: `keyterm:Discern`); esprit (ID: `keyterm:Spirit.2`); servir (ID: `keyterm:Serve`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** corps (ID: `keyterm:Body.3`); grâce (ID: `keyterm:Favor`); Éternel (ID: `deity:Lord`); Jésus (ID: `person:Jesus.2`); capacité (ID: `keyterm:Ability`); baptême (ID: `keyterm:Baptism`); Saint-Esprit (ID: `deity:HolySpirit`); église (ID: `keyterm:Church`); Jews (ID: `group:Jews`); Javan (ID: `person:Javan`); Yavanite (ID: `group:Greek`); gloire (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** aimer (ID: `keyterm:Love`); croire (ID: `keyterm:Believe`); espoir (ID: `keyterm:Hope`); vérité (ID: `keyterm:Truth`); parler (ID: `keyterm:Speak`); penser (ID: `keyterm:Think`); An Angel (ID: `deity:Angel`); méfaits (ID: `keyterm:UnjustDeed`); corps (ID: `keyterm:Body.3`); Mirror (ID: `realia:Mirror`); Cymbals (ID: `realia:Cymbals`)
...
* **Associated ACAI Concepts:** parler (ID: `keyterm:Speak`); église (ID: `keyterm:Church`); Éternel (ID: `deity:Lord`); esprit (ID: `keyterm:Spirit.2`); rénforcer (ID: `keyterm:BuildingUp`); prier (ID: `keyterm:Pray`); Saint-Esprit (ID: `deity:HolySpirit`); être infidèle (ID: `keyterm:Unfaithful`); capacité (ID: `keyterm:Ability`); coeur (ID: `keyterm:Heart`); prier (ID: `keyterm:AskFor`); A Person (ID: `person:GenericPerson`); exemple (ID: `keyterm:Example`); benir (ID: `keyterm:Bless`); adorer (ID: `keyterm:BowDown`); évaluer (ID: `keyterm:Discern`); loi (ID: `keyterm:Law`); croire (ID: `keyterm:Believe`); sûrement! (ID: `keyterm:Surely`); aimer (ID: `keyterm:Love`); Lyre (ID: `realia:Lyre`); Flute (ID: `realia:Flute`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** église (ID: `keyterm:Church`); Éternel (ID: `deity:Lord`); parler (ID: `keyterm:Speak`); prier (ID: `keyterm:AskFor`); faire la paix (ID: `keyterm:Peace`); Jésus (ID: `person:Jesus.2`); capacité (ID: `keyterm:Ability`); saint (ID: `keyterm:Holy`); évaluer (ID: `keyterm:Discern`); prier (ID: `keyterm:Encourage`); esprit (ID: `keyterm:Spirit.2`); rénforcer (ID: `keyterm:BuildingUp`); loi (ID: `keyterm:Law`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); résurrection (ID: `keyterm:Resurrection`); croire (ID: `keyterm:Believe`); proclamer (ID: `keyterm:Proclaim`); Éternel (ID: `deity:Lord`); vide (ID: `keyterm:Empty`); scripture (ID: `keyterm:Scripture`); bonnes nouvelles (ID: `keyterm:GoodNews`); en christ (ID: `keyterm:InChrist`); pécher (ID: `keyterm:Sin`); témoigner (ID: `keyterm:BearWitness`); espoir (ID: `keyterm:Hope`); grâce (ID: `keyterm:Favor`); pitoyable (ID: `keyterm:Pitiful`); sans valeur (ID: `keyterm:Worthless`); Jacques (ID: `person:James.3`); vie (ID: `keyterm:Life`); aide (ID: `keyterm:Salvation`); église (ID: `keyterm:Church`); Pierre (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** résurrection (ID: `keyterm:Resurrection`); Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); Adam (ID: `person:Adam`); baptême (ID: `keyterm:Baptism`); autorité (ID: `keyterm:Authority.2`); le bien (ID: `keyterm:Good`); régne (ID: `keyterm:Kingdom`); pécher (ID: `keyterm:Sin`); capacité (ID: `keyterm:Ability`); Éphèse (ID: `place:Ephesus`); en christ (ID: `keyterm:InChrist`)
...
* **Associated ACAI Concepts:** corps (ID: `keyterm:Body.3`); résurrection (ID: `keyterm:Resurrection`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); gloire (ID: `keyterm:Glory`); non spirituel (ID: `keyterm:Natural`); céleste (ID: `keyterm:Heavenly`); Jésus (ID: `person:Jesus.2`); Grain (ID: `flora:Grain`); imperissable (ID: `keyterm:Imperishable`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); A Person (ID: `person:GenericPerson`); faire vivre (ID: `keyterm:Alive`); esprit (ID: `keyterm:Spirit.2`); régne (ID: `keyterm:Kingdom`); Adam (ID: `person:Adam`); grâce (ID: `keyterm:Favor`); vide (ID: `keyterm:Empty`); bien, aimé (ID: `keyterm:Beloved`); vie (ID: `keyterm:Life`); loi (ID: `keyterm:Law`); sang (ID: `keyterm:Blood`); pécher (ID: `keyterm:Sin`); Trumpet (ID: `realia:Trumpet`); Fish (ID: `fauna:Fish`); Bird (ID: `fauna:Bird`); Wheat (ID: `flora:Wheat`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); saint (ID: `keyterm:Holy`); Stéphanas (ID: `person:Stephanas`); prier (ID: `keyterm:AskFor`); grâce (ID: `keyterm:Favor`); église (ID: `keyterm:Church`); aimer (ID: `keyterm:Love`); Achaïcus (ID: `person:Achaicus`); Fortunatus (ID: `person:Fortunatus`); Priscille (ID: `person:Priscilla`); Aquilas (ID: `person:Aquila`); semaine (ID: `keyterm:Week`); Achaïe (ID: `place:Achaia`); Macédoine (ID: `place:Macedonia`); amour (ID: `keyterm:Friendship`); Apollos (ID: `person:Apollos`); en christ (ID: `keyterm:InChrist`); espoir (ID: `keyterm:Hope`); Timothée (ID: `person:Timothy`); faire la paix (ID: `keyterm:Peace`); Jérusalem (ID: `place:Jerusalem`); Éphèse (ID: `place:Ephesus`); Asie (ID: `place:Asia`); Galatie (ID: `place:Galatia`); Éternel (ID: `deity:Lord`); tester (ID: `keyterm:Interpret`); croire (ID: `keyterm:Believe`); Paul (ID: `person:Paul`); esprit (ID: `keyterm:Spirit.2`); servir (ID: `keyterm:Serve`); Door (ID: `realia:Door`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
