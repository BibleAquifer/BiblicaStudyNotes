...
* **Associated ACAI Concepts:** Tsaanan (ID: `place:Zaanan`); Maroth (ID: `place:Maroth`); Beth-Haëtsel (ID: `place:Beth-ezel`); Schaphir (ID: `place:Shaphir`); Moréschet-Gath (ID: `place:Moresheth-gath`); pratiquer le divination (ID: `keyterm:PracticeDivination`); Micah (ID: `person:Micah.6`); de Morèsheth (ID: `place:Moresheth`); Prophets (ID: `group:GenericProphets`); Aczib (ID: `place:Achzib`); Jérusalem (ID: `place:Jerusalem`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Pruning Knife (ID: `realia:PruningKnife`); incantations (ID: `keyterm:Incantations`); Sheaf (ID: `realia:Sheaf`); Bethléhem (ID: `place:Bethlehem`); Jérusalem (ID: `place:Jerusalem`); Israël (ID: `person:Israel`); Éternel (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Balance (ID: `realia:Balance`); Net (ID: `realia:Net`); Éternel (ID: `deity:Lord`)
