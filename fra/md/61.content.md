...
* **Associated Passages:** 2 Pierre 1.1-11
...
* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); divin (ID: `keyterm:Divine`); capacité (ID: `keyterm:Ability`); Éternel (ID: `deity:Lord`); sauveur (ID: `keyterm:Savior`); croire (ID: `keyterm:Believe`); promesse (ID: `keyterm:Promise`); sérieux (ID: `keyterm:Eagerness`); purifier (ID: `keyterm:Cleanse.2`); désoeuvré (ID: `keyterm:Idle`); régne (ID: `keyterm:Kingdom`); faire la paix (ID: `keyterm:Peace`); intrans. trébucher (ID: `keyterm:Stumble`); être juste (ID: `keyterm:Just`); éternellement (ID: `keyterm:Always`); choisi (ID: `keyterm:Chosen`); grâce (ID: `keyterm:Favor`); amour fraternel (ID: `keyterm:LoveForOnesFellowBeliever`); vie (ID: `keyterm:Life`); Pierre (ID: `person:Peter`); gloire (ID: `keyterm:Glory`); aimer (ID: `keyterm:Love`)
...
* **Associated Passages:** 2 Pierre 1.12-21
* **Associated Articles:** Ténèbres (ID: `133291@BiblicaStudyNotes`); Apôtres (ID: `133305@BiblicaStudyNotesKeyTerms`); Le retour de Jésus (ID: `133317@BiblicaStudyNotes`); Jacques (ID: `133371@BiblicaStudyNotesKeyTerms`); Ancien Testament (ID: `133444@BiblicaStudyNotesKeyTerms`); Lignée familiale (ID: `133472@BiblicaStudyNotesKeyTerms`); Jacob (ID: `133520@BiblicaStudyNotesKeyTerms`); Gloire (ID: `133600@BiblicaStudyNotesKeyTerms`); Le Saint-Esprit (ID: `133640@BiblicaStudyNotesKeyTerms`); Balaam (ID: `133650@BiblicaStudyNotesKeyTerms`); Prophétie (ID: `133651@BiblicaStudyNotesKeyTerms`); Prophéties au sujet de Jésus (ID: `133652@BiblicaStudyNotesKeyTerms`); Prophète (ID: `133668@BiblicaStudyNotesKeyTerms`); Jean (ID: `133794@BiblicaStudyNotesKeyTerms`); La lumière (ID: `133798@BiblicaStudyNotes`)

* **Associated ACAI Concepts:** Jésus (ID: `person:Jesus.2`); Éternel (ID: `deity:Lord`); corps (ID: `keyterm:Body.3`); Tent (ID: `realia:Tent`); coeur (ID: `keyterm:Heart`); vérité (ID: `keyterm:Truth`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); scripture (ID: `keyterm:Scripture`); Saint-Esprit (ID: `deity:HolySpirit`); parler (ID: `keyterm:Speak`); capacité (ID: `keyterm:Ability`); bien, aimé (ID: `keyterm:Beloved`); être juste (ID: `keyterm:Just`); saint (ID: `keyterm:Holy`); gloire (ID: `keyterm:Glory`)
...
* **Associated Passages:** 2 Pierre 2.1-9
...
* **Associated ACAI Concepts:** être juste (ID: `keyterm:Just`); jugement (ID: `keyterm:Judgment`); corruption morale (ID: `keyterm:Lawless`); tribunal (ID: `keyterm:CourtCase`); Éternel (ID: `deity:Lord`); sauver (ID: `keyterm:Deliver`); Lot (ID: `person:Lot`); Noah (ID: `person:Noah`); parler contre dieu (ID: `keyterm:Blaspheme`); acheter (ID: `keyterm:Redeem`); An Angel (ID: `deity:Angel`); Sodome (ID: `place:Sodom`); Gomorrhe (ID: `place:Gomorrah`); mis en enfer (ID: `keyterm:HoldInTartarus`); vérité (ID: `keyterm:Truth`); Hell (ID: `place:Hell`); capacité (ID: `keyterm:Ability`); condamner (ID: `keyterm:Condemn`); pécher (ID: `keyterm:Sin`)
...
* **Associated Passages:** 2 Pierre 2.10-22
...
* **Associated ACAI Concepts:** capacité (ID: `keyterm:Ability`); parler contre dieu (ID: `keyterm:Blaspheme`); méfaits (ID: `keyterm:UnjustDeed`); corps (ID: `keyterm:Body.3`); pollution (ID: `keyterm:Defilement`); être infidèle (ID: `keyterm:Unfaithful`); Beor (ID: `person:Beor.2`); Balaam (ID: `person:Balaam`); coeur (ID: `keyterm:Heart`); agir par méchanceté (ID: `keyterm:ActWickedly`); A Person (ID: `person:GenericPerson`); vrai (ID: `keyterm:True`); tribunal (ID: `keyterm:CourtCase`); commandement (ID: `keyterm:Commandment`); être juste (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); sans valeur (ID: `keyterm:Worthless`); promesse (ID: `keyterm:Promise`); manière de vivre (ID: `keyterm:Behavior`); sauveur (ID: `keyterm:Savior`); droiture (ID: `keyterm:Straightness`); qui parle contre dieu (ID: `keyterm:Blasphemous`); Jésus (ID: `person:Jesus.2`); jugement (ID: `keyterm:Judgment`); pécher (ID: `keyterm:Sin`); saint (ID: `keyterm:Holy`); aimer (ID: `keyterm:Love`); Pig (ID: `fauna:Pig`); Jackal (ID: `fauna:Jackal`); Donkey (ID: `fauna:Donkey`); Dog (ID: `fauna:Dog`)
...
* **Associated Passages:** 2 Pierre 3.1-10
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); promesse (ID: `keyterm:Promise`); bien, aimé (ID: `keyterm:Beloved`); éléments (ID: `keyterm:FundamentalPrinciples`); sans saleté (ID: `keyterm:Pure`); commandement (ID: `keyterm:Commandment`); Jésus (ID: `person:Jesus.2`); jugement (ID: `keyterm:Judgment`); capacité (ID: `keyterm:Ability`); se repentir (ID: `keyterm:Repent`); saint (ID: `keyterm:Holy`); tribunal (ID: `keyterm:CourtCase`); intelligence (ID: `keyterm:Mind.2`); sauveur (ID: `keyterm:Savior`); ce qui est dit (ID: `keyterm:Word`)
...
* **Associated Passages:** 2 Pierre 3.11-18
...
* **Associated ACAI Concepts:** bien, aimé (ID: `keyterm:Beloved`); cieux [également employé pour dieu pour éviter la mention du nom sacré] (ID: `keyterm:Heaven`); Éternel (ID: `deity:Lord`); scripture (ID: `keyterm:Scripture`); éléments (ID: `keyterm:FundamentalPrinciples`); être exempt de la punition (ID: `keyterm:Blameless`); faire la paix (ID: `keyterm:Peace`); être juste (ID: `keyterm:Just`); éternellement (ID: `keyterm:Always`); corruption morale (ID: `keyterm:Lawless`); grâce (ID: `keyterm:Favor`); promesse (ID: `keyterm:Promise`); sauveur (ID: `keyterm:Savior`); aide (ID: `keyterm:Salvation`); Paul (ID: `person:Paul`); Jésus (ID: `person:Jesus.2`); saint (ID: `keyterm:Holy`); pur (ID: `keyterm:AboveCriticism`); gloire (ID: `keyterm:Glory`)
