...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); se rebeller (ID: `keyterm:Rebel`); Israël (ID: `person:Israel`); Juda (ID: `person:Judah.4`); Juda (ID: `group:Judah`); fête déterminée (ID: `keyterm:AppointedFeast`); force (ID: `keyterm:Strength`); aimer (ID: `keyterm:Love`); colline (ID: `keyterm:Horn`); Sheep (ID: `fauna:Lamb`); House (ID: `realia:House`); Instruction (ID: `keyterm:Instruction`); voir (ID: `keyterm:HaveAVision`); pollution (ID: `keyterm:Defilement`); sabbat (ID: `keyterm:Sabbath`); ardeur (ID: `keyterm:Ardour`); profaner, déshonorer (ID: `keyterm:Dishonor`); indomptables (ID: `keyterm:MightyOne`); nation; peuple (ID: `group:Gentile`); travil (ID: `keyterm:Work`); Utterance (ID: `keyterm:Utterance`); pécher (ID: `keyterm:Sin`); tromperie (ID: `keyterm:Deceit`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); Train (ID: `realia:Train`); Winepress (ID: `realia:Winepress`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Grain (ID: `flora:Grain`); Tent (ID: `realia:Tent`); Measuring Reed (ID: `realia:MeasuringReed`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Grass (ID: `flora:Grass`); Casting Net (ID: `realia:CastingNet`); Sackcloth (ID: `realia:Sackcloth`); Yoke (ID: `realia:Yoke`); Altar (ID: `realia:Altar`); Deer (ID: `fauna:Deer`); Net (ID: `realia:Net`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Bow (ID: `realia:Bow`); Tabernacle Altar (ID: `realia:TabernacleAltar`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); pécher (ID: `keyterm:Sin`); ardeur (ID: `keyterm:Ardour`); juste (ID: `keyterm:Complete`); Édom (ID: `place:Edom`); bonté (ID: `keyterm:Kindness`); Uts (ID: `place:Uz`); souiller (ID: `keyterm:Stain`); danse en rond (ID: `keyterm:RoundDance`); Assyria (ID: `place:Assyria`); acheter (ID: `keyterm:Redeem`); pollution (ID: `keyterm:Defilement`); Juda (ID: `person:Judah.4`); se rebeller (ID: `keyterm:Rebel`); Juda (ID: `group:Judah`); fie (ID: `keyterm:BelieveIn`); espoir (ID: `keyterm:Hope`); craindre (ID: `keyterm:Fear`); Sodome (ID: `place:Sodom`); oint (ID: `keyterm:Anointed`); pardonner (ID: `keyterm:Forgive`); état intact (ID: `keyterm:IntactState`); aide (ID: `keyterm:Salvation`); Égypte (ID: `place:Egypt`); Woe (ID: `keyterm:Woe`); flèche (ID: `keyterm:Arrow`); charger (ID: `keyterm:Appoint`); agir avec bonté (ID: `keyterm:KindlyDisposed`); punition (ID: `keyterm:Punishment`)
