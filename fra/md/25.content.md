...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); se rebeller (ID: `keyterm:Rebel`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`); Israël (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Jackal (ID: `fauna:Jackal`); Uts (ID: `place:Uz`); souiller (ID: `keyterm:Stain`); Ostrich (ID: `fauna:Ostrich`); pécher (ID: `keyterm:Sin`); Jérusalem (ID: `place:Jerusalem`); Éternel (ID: `deity:Lord`)
