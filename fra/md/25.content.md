...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); se rebeller (ID: `keyterm:Rebel`); Israël (ID: `person:Israel`); Juda (ID: `group:Judah`); Juda (ID: `person:Judah.4`); fête déterminée (ID: `keyterm:AppointedFeast`); force (ID: `keyterm:Strength`); aimer (ID: `keyterm:Love`); colline (ID: `keyterm:Horn`); House (ID: `realia:House`); Sheep (ID: `fauna:Lamb`); indomptables (ID: `keyterm:MightyOne`); Instruction (ID: `keyterm:Instruction`); travil (ID: `keyterm:Work`); pécher (ID: `keyterm:Sin`); sabbat (ID: `keyterm:Sabbath`); profaner, déshonorer (ID: `keyterm:Dishonor`); se rendre honoré (ID: `keyterm:BringHonorAndGloryOnOneself`); pollution (ID: `keyterm:Defilement`); ardeur (ID: `keyterm:Ardour`); voir (ID: `keyterm:HaveAVision`); nation; peuple (ID: `group:Gentile`); tromperie (ID: `keyterm:Deceit`); Utterance (ID: `keyterm:Utterance`); Train (ID: `realia:Train`); Stone Altar (ID: `realia:StoneAltar`); Measuring Reed (ID: `realia:MeasuringReed`); Bow (ID: `realia:Bow`); Vine (ID: `flora:Vine`); Deer (ID: `fauna:Deer`); Goat (ID: `fauna:Goat`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Sackcloth (ID: `realia:Sackcloth`); Tent (ID: `realia:Tent`); Wine (ID: `realia:Wine`); Grain (ID: `flora:Grain`); Altar (ID: `realia:Altar`); Casting Net (ID: `realia:CastingNet`); Temple Altar (ID: `realia:TempleAltar`); Net (ID: `realia:Net`); Flock (ID: `fauna:Flock`); Yoke (ID: `realia:Yoke`); Grass (ID: `flora:Grass`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** Éternel (ID: `deity:Lord`); Jérusalem (ID: `place:Jerusalem`); pécher (ID: `keyterm:Sin`); ardeur (ID: `keyterm:Ardour`); Édom (ID: `place:Edom`); bonté (ID: `keyterm:Kindness`); juste (ID: `keyterm:Complete`); Uts (ID: `place:Uz`); souiller (ID: `keyterm:Stain`); se rebeller (ID: `keyterm:Rebel`); aide (ID: `keyterm:Salvation`); flèche (ID: `keyterm:Arrow`); laissiez en possession (ID: `keyterm:Possess`); pardonner (ID: `keyterm:Forgive`); punition (ID: `keyterm:Punishment`); Sodome (ID: `place:Sodom`); espoir (ID: `keyterm:Hope`); état intact (ID: `keyterm:IntactState`); agir avec bonté (ID: `keyterm:KindlyDisposed`); oint (ID: `keyterm:Anointed`); danse en rond (ID: `keyterm:RoundDance`); acheter (ID: `keyterm:Redeem`); Juda (ID: `group:Judah`); pollution (ID: `keyterm:Defilement`); Égypte (ID: `place:Egypt`); Juda (ID: `person:Judah.4`); craindre (ID: `keyterm:Fear`); fie (ID: `keyterm:BelieveIn`); Woe (ID: `keyterm:Woe`); Assyria (ID: `place:Assyria`)
