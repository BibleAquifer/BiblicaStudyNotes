...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Fear (ID: `keyterm:Fear`); Vine (ID: `flora:Vine`); Holy (ID: `keyterm:Holy`); Rams Horn (ID: `realia:RamsHorn`); Olive Oil (ID: `realia:OliveOil`); Must (ID: `realia:Must`); Mule (ID: `fauna:Mule`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); To Cause to Possess (ID: `keyterm:Possess`); Be Zealous (ID: `keyterm:Zealous`); Garden of Eden (ID: `place:Eden.2`); Kindness (ID: `keyterm:Kindness`); Bless (ID: `keyterm:Bless`); Compassionate (ID: `keyterm:Compassionate`); Generous (ID: `keyterm:Generous`); Offering (ID: `keyterm:Offering`); Израиль (ID: `person:Israel`); Stone Altar (ID: `realia:StoneAltar`); House (ID: `realia:House`); Fig (ID: `flora:Fig`); Weapons (ID: `realia:Weapons`); Window (ID: `realia:Window`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Locust (ID: `fauna:Locust`); Wine (ID: `realia:Wine`); Horse (ID: `fauna:Horse`); Grain (ID: `flora:Grain`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Chariot (ID: `realia:Chariot`); Threshing Floor (ID: `realia:ThreshingFloor`); Grass (ID: `flora:Grass`); Winepress (ID: `realia:Winepress`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Кедрон (ID: `place:Kidron`); Израиль (ID: `person:Israel`); Sabeans (ID: `group:Sabean`); Valley of Shittim (ID: `place:ShittimValley`); Greeks (ID: `group:Greek`); Едом (ID: `place:Edom`); Тир (ID: `place:Tyre`); To Cause to Possess (ID: `keyterm:Possess`); Филистимской (ID: `place:Philistine`); Сидон (ID: `place:Sidon`); Exempt (ID: `keyterm:Exempt`); Египет (ID: `place:Egypt`); Lot (ID: `keyterm:Lot`); Fear (ID: `keyterm:Fear`); Иаван (ID: `person:Javan`); Holy (ID: `keyterm:Holy`); Шева (ID: `person:Sheba`); Symbol (ID: `keyterm:Example`); Refuge (ID: `keyterm:Refuge`); A Man (ID: `person:GenericMale`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); Gentiles (ID: `group:Gentile`); Speak as a Prophet (ID: `keyterm:Speak`); Pruning Knife (ID: `realia:PruningKnife`); Fortress (ID: `realia:Fortress`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); Sickle (ID: `realia:Sickle`); Spear (ID: `realia:Spear`); Wine (ID: `realia:Wine`); Mattock (ID: `realia:Mattock`); Winepress (ID: `realia:Winepress`)
