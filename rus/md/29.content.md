...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Иерусалим (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Holy (ID: `keyterm:Holy`); Rams Horn (ID: `realia:RamsHorn`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Must (ID: `realia:Must`); Olive Oil (ID: `realia:OliveOil`); Offering (ID: `keyterm:Offering`); Kindness (ID: `keyterm:Kindness`); To Cause to Possess (ID: `keyterm:Possess`); Bless (ID: `keyterm:Bless`); Be Zealous (ID: `keyterm:Zealous`); Garden of Eden (ID: `place:Eden.2`); Compassionate (ID: `keyterm:Compassionate`); Generous (ID: `keyterm:Generous`); Израиль (ID: `person:Israel`); Wine (ID: `realia:Wine`); Locust (ID: `fauna:Locust`); Winepress (ID: `realia:Winepress`); Threshing Floor (ID: `realia:ThreshingFloor`); Fig (ID: `flora:Fig`); Stone Altar (ID: `realia:StoneAltar`); House (ID: `realia:House`); Chariot (ID: `realia:Chariot`); Grain (ID: `flora:Grain`); Temple Altar (ID: `realia:TempleAltar`); Weapons (ID: `realia:Weapons`); Window (ID: `realia:Window`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Horse (ID: `fauna:Horse`); Grass (ID: `flora:Grass`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Кедрон (ID: `place:Kidron`); Израиль (ID: `person:Israel`); Greeks (ID: `group:Greek`); Sabeans (ID: `group:Sabean`); Valley of Shittim (ID: `place:ShittimValley`); A Man (ID: `person:GenericMale`); To Cause to Possess (ID: `keyterm:Possess`); Symbol (ID: `keyterm:Example`); Филистимской (ID: `place:Philistine`); Exempt (ID: `keyterm:Exempt`); Fear (ID: `keyterm:Fear`); Шева (ID: `person:Sheba`); Египет (ID: `place:Egypt`); Иаван (ID: `person:Javan`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); Едом (ID: `place:Edom`); Lot (ID: `keyterm:Lot`); Gentiles (ID: `group:Gentile`); Сидон (ID: `place:Sidon`); Refuge (ID: `keyterm:Refuge`); Тир (ID: `place:Tyre`); Speak as a Prophet (ID: `keyterm:Speak`); Holy (ID: `keyterm:Holy`); Pruning Knife (ID: `realia:PruningKnife`); Wine (ID: `realia:Wine`); Mattock (ID: `realia:Mattock`); Fortress (ID: `realia:Fortress`); Winepress (ID: `realia:Winepress`); Money (ID: `realia:Money`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Sickle (ID: `realia:Sickle`); Spear (ID: `realia:Spear`); Sword (ID: `realia:Sword`)
