...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Holy (ID: `keyterm:Holy`); Defilement (ID: `keyterm:Defilement`); Израиль (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); To Dishonor (ID: `keyterm:Dishonor`); Моисей (ID: `person:Moses`); Аарона (ID: `person:Aaron`); Slaughtering (ID: `keyterm:Slaughtering`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Passion (ID: `keyterm:Ardour`); Молох (ID: `deity:Molech`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Delight (ID: `keyterm:Delight`); Cattle (ID: `fauna:Bull`); Pure (ID: `keyterm:Pure`); Египет (ID: `place:Egypt`); Fear (ID: `keyterm:Fear`); Sheep (ID: `fauna:Lamb`); Tent of Meeting (ID: `realia:TentOfMeeting`); Necromancer (ID: `keyterm:Spirit`); Vow (ID: `keyterm:Vow`); Stone Altar (ID: `realia:StoneAltar`); Goat (ID: `fauna:Goat`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Flock (ID: `fauna:Flock`); Appease (ID: `keyterm:Appease`); Sabbath (ID: `keyterm:Sabbath`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Моисей (ID: `person:Moses`); Israelites (ID: `group:Israel`); Cattle (ID: `fauna:Bull`); Dibri (ID: `person:Dibri`); Шеломиф (ID: `person:Shelomith.2`); Дан (ID: `group:Dan`); Египет (ID: `place:Egypt`); Egyptians (ID: `group:Egypt`); Дан (ID: `place:Dan`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`)
...
* **Associated ACAI Concepts:** Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Redeem (ID: `keyterm:Redeem`); LORD (ID: `deity:Lord`); Sabbath (ID: `keyterm:Sabbath`); Израиль (ID: `person:Israel`); House (ID: `realia:House`); Египет (ID: `place:Egypt`); Fear (ID: `keyterm:Fear`); Force to Serve (ID: `keyterm:EnticedToServe`); Левий (ID: `group:Levi`); Safety (ID: `keyterm:Safety`); Holy (ID: `keyterm:Holy`); Complete (ID: `keyterm:Complete`); Левий (ID: `person:Levi.3`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); Atonement (ID: `keyterm:Atonement`); Dispossess (ID: `keyterm:Dispossess`); Work (ID: `keyterm:Work`); Bless (ID: `keyterm:Bless`); Mount Sinai (ID: `place:SinaiMount`); Моисей (ID: `person:Moses`); Ханаан (ID: `place:Canaan`); Barley (ID: `flora:Barley`); Rams Horn (ID: `realia:RamsHorn`); Cattle (ID: `fauna:Bull`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Passion (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); Sabbath (ID: `keyterm:Sabbath`); Египет (ID: `place:Egypt`); Израиль (ID: `person:Israel`); Stubborn (ID: `keyterm:Stubborn`); Instruction (ID: `keyterm:Instruction`); Strength (ID: `keyterm:Strength`); Авраам (ID: `person:Abraham`); Mount Sinai (ID: `place:SinaiMount`); Peace (ID: `keyterm:IntactState`); Моисей (ID: `person:Moses`); Repent (ID: `keyterm:Repent`); Safety (ID: `keyterm:Safety`); Исаак (ID: `person:Isaac`); Fear (ID: `keyterm:Fear`); Decree (ID: `keyterm:Decree`); Idol (ID: `keyterm:Idol`); Complete (ID: `keyterm:Complete`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Be Unfaithful (ID: `keyterm:Unfaithful`); Image (ID: `realia:Image`); High Place (ID: `realia:HighPlace`); Graven Image (ID: `realia:GravenImage`); Yoke (ID: `realia:Yoke`); Coriander (ID: `flora:Coriander`); Jackal (ID: `fauna:Jackal`); Sword (ID: `realia:Sword`); Stone Pine (ID: `flora:Pine`); Cattle (ID: `fauna:Bull`); Hyena (ID: `fauna:Hyena`); Lion (ID: `fauna:Lion`); Vine (ID: `flora:Vine`); Barley (ID: `flora:Barley`); Bear (ID: `fauna:Bear`); Sacred Pillar (ID: `realia:SacredPillar`)
...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); LORD (ID: `deity:Lord`); Redeem (ID: `keyterm:Redeem`); Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Shekel (ID: `realia:Shekel`); Money (ID: `realia:Money`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Set Apart for God (ID: `keyterm:Proscribe`); Cattle (ID: `fauna:Bull`); Моисей (ID: `person:Moses`); Defilement (ID: `keyterm:Defilement`); Израиль (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Vow (ID: `keyterm:Vow`); Barley (ID: `flora:Barley`); Coriander (ID: `flora:Coriander`); House (ID: `realia:House`); Mount Sinai (ID: `place:SinaiMount`); Homer (ID: `realia:Homer`); Gerah (ID: `realia:Gerah`); Staff (ID: `realia:Staff`); Goat (ID: `fauna:Goat`); Rod (ID: `realia:Rod`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`)
