...
* **Associated ACAI Concepts:** Моисей (ID: `person:Moses`); LORD (ID: `deity:Lord`); Аарона (ID: `person:Aaron`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); To Sin (ID: `keyterm:Sin`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Priesthood (ID: `keyterm:Priesthood`); Израиль (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Tent of Meeting (ID: `realia:TentOfMeeting`); Cattle (ID: `fauna:Bull`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Decree (ID: `keyterm:Decree`); Appease (ID: `keyterm:Appease`); Ифамар (ID: `person:Ithamar`); Smear (ID: `keyterm:Smear`); Елеазар (ID: `person:Eleazar.2`); Glory (ID: `keyterm:Glory`); Pure (ID: `keyterm:Pure`); Bless (ID: `keyterm:Bless`); Complete (ID: `keyterm:Complete`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Slaughtering (ID: `keyterm:Slaughtering`); Tunic (ID: `realia:Tunic`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); Израиль (ID: `person:Israel`); Sabbath (ID: `keyterm:Sabbath`); Моисей (ID: `person:Moses`); Work (ID: `keyterm:Work`); Appointed Feast (ID: `keyterm:AppointedFeast`); Barley (ID: `flora:Barley`); Complete (ID: `keyterm:Complete`); Sheep (ID: `fauna:Lamb`); Sickle (ID: `realia:Sickle`); Atonement (ID: `keyterm:Atonement`); Pure (ID: `keyterm:Pure`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Slaughtering (ID: `keyterm:Slaughtering`); Аарона (ID: `person:Aaron`); Wine (ID: `realia:Wine`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Lamp (ID: `realia:Lamp`); Delight (ID: `keyterm:Delight`); Memorial Portion (ID: `keyterm:MemorialOrTokenPortion`); Decree (ID: `keyterm:Decree`); Israelites (ID: `group:Israel`); To Sin (ID: `keyterm:Sin`); Appease (ID: `keyterm:Appease`); Testimony (ID: `keyterm:Witness.2`); Passover (ID: `keyterm:Passover`); Covenant (ID: `keyterm:Covenant`); Египет (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Моисей (ID: `person:Moses`); Israelites (ID: `group:Israel`); Cattle (ID: `fauna:Bull`); Dibri (ID: `person:Dibri`); Шеломиф (ID: `person:Shelomith.2`); Дан (ID: `group:Dan`); Дан (ID: `place:Dan`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Египет (ID: `place:Egypt`); Egyptians (ID: `group:Egypt`)
...
* **Associated ACAI Concepts:** Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Redeem (ID: `keyterm:Redeem`); LORD (ID: `deity:Lord`); Sabbath (ID: `keyterm:Sabbath`); Израиль (ID: `person:Israel`); House (ID: `realia:House`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); Египет (ID: `place:Egypt`); Safety (ID: `keyterm:Safety`); Holy (ID: `keyterm:Holy`); Complete (ID: `keyterm:Complete`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Vine (ID: `flora:Vine`); Money (ID: `realia:Money`); Bless (ID: `keyterm:Bless`); Ханаан (ID: `place:Canaan`); Dispossess (ID: `keyterm:Dispossess`); Mount Sinai (ID: `place:SinaiMount`); Work (ID: `keyterm:Work`); Моисей (ID: `person:Moses`); Atonement (ID: `keyterm:Atonement`); Barley (ID: `flora:Barley`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`); Rams Horn (ID: `realia:RamsHorn`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Passion (ID: `keyterm:Ardour`); Sabbath (ID: `keyterm:Sabbath`); To Sin (ID: `keyterm:Sin`); Израиль (ID: `person:Israel`); Египет (ID: `place:Egypt`); Idol (ID: `keyterm:Idol`); Strength (ID: `keyterm:Strength`); Safety (ID: `keyterm:Safety`); Decree (ID: `keyterm:Decree`); Repent (ID: `keyterm:Repent`); Stubborn (ID: `keyterm:Stubborn`); Mount Sinai (ID: `place:SinaiMount`); Complete (ID: `keyterm:Complete`); Авраам (ID: `person:Abraham`); Be Unfaithful (ID: `keyterm:Unfaithful`); Fear (ID: `keyterm:Fear`); Instruction (ID: `keyterm:Instruction`); Моисей (ID: `person:Moses`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Исаак (ID: `person:Isaac`); Peace (ID: `keyterm:IntactState`); Image (ID: `realia:Image`); High Place (ID: `realia:HighPlace`); Yoke (ID: `realia:Yoke`); Graven Image (ID: `realia:GravenImage`); Sacred Pillar (ID: `realia:SacredPillar`); Sword (ID: `realia:Sword`); Stone Pine (ID: `flora:Pine`); Lion (ID: `fauna:Lion`); Vine (ID: `flora:Vine`); Barley (ID: `flora:Barley`); Hyena (ID: `fauna:Hyena`); Coriander (ID: `flora:Coriander`); Bear (ID: `fauna:Bear`); Jackal (ID: `fauna:Jackal`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); LORD (ID: `deity:Lord`); Redeem (ID: `keyterm:Redeem`); Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Shekel (ID: `realia:Shekel`); Money (ID: `realia:Money`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Set Apart for God (ID: `keyterm:Proscribe`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); Моисей (ID: `person:Moses`); Израиль (ID: `person:Israel`); Defilement (ID: `keyterm:Defilement`); Vow (ID: `keyterm:Vow`); Barley (ID: `flora:Barley`); House (ID: `realia:House`); Coriander (ID: `flora:Coriander`); Mount Sinai (ID: `place:SinaiMount`); Gerah (ID: `realia:Gerah`); Homer (ID: `realia:Homer`); Sheep (ID: `fauna:Lamb`); Rod (ID: `realia:Rod`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Staff (ID: `realia:Staff`)
