...
* **Associated ACAI Concepts:** Соломон (ID: `person:Solomon`); LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); House (ID: `realia:House`); Давид (ID: `person:David`); Иерусалим (ID: `place:Jerusalem`); Covenant Box (ID: `keyterm:CovenantBox`); Ability (ID: `keyterm:Ability`); To Sin (ID: `keyterm:Sin`); Offering (ID: `keyterm:Offering`); Хирам (ID: `person:Hiram`); Египет (ID: `place:Egypt`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Glory (ID: `keyterm:Glory`); Forgive (ID: `keyterm:Forgive`); Kindness (ID: `keyterm:Kindness`); Plea for Mercy (ID: `keyterm:Supplication`); Holy (ID: `keyterm:Holy`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Cubit (ID: `realia:Cubit`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Money (ID: `realia:Money`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Slaughtering (ID: `keyterm:Slaughtering`); царица Савская (ID: `person:QueenOfSheba`); Bless (ID: `keyterm:Bless`); Sheba (ID: `place:Sheba.2`)
...
* **Associated ACAI Concepts:** Ровоам (ID: `person:Rehoboam`); LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Иерусалим (ID: `place:Jerusalem`); Иеровоам (ID: `person:Jeroboam`); Соломон (ID: `person:Solomon`); Давид (ID: `person:David`); Вениамин (ID: `group:Benjamin`); Вениамин (ID: `person:Benjamin`); Шемаия (ID: `person:Shemaiah`); Fortification (ID: `realia:Fortification`); Сусаким (ID: `person:Shishak`); Египет (ID: `place:Egypt`); Yoke (ID: `realia:Yoke`); Мааха (ID: `person:Maacah.3`); Авия (ID: `person:Abijah.4`); Counsel (ID: `keyterm:Counsel`); House (ID: `realia:House`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Иессей (ID: `person:Jesse`); Work (ID: `keyterm:Work`); Нават (ID: `person:Nebat`); Авессалом (ID: `person:Absalom`); Загам (ID: `person:Zaham`); Иеуш (ID: `person:Jeush.5`); Sukkiim (ID: `group:Sukkiim`)
...
* **Associated ACAI Concepts:** Авия (ID: `person:Abijah.4`); LORD (ID: `deity:Lord`); Иеровоам (ID: `person:Jeroboam`); Израиль (ID: `person:Israel`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Давид (ID: `person:David`); Левий (ID: `group:Levi`); Аарона (ID: `person:Aaron`); Соломон (ID: `person:Solomon`); Левий (ID: `person:Levi.3`); Ефрем (ID: `person:Ephraim`); Cattle (ID: `fauna:Bull`); Trumpet (ID: `realia:Trumpet`); Гива (ID: `place:Gibeah`); Уриил (ID: `person:Uriel.3`); Иешана (ID: `place:Jeshanah`); Iddo (ID: `person:Iddo.5`); Rebel (ID: `keyterm:Rebel`); Wickedness (ID: `keyterm:Wickedness`); Strength (ID: `keyterm:Strength`); Мааха (ID: `person:Maacah.3`); Нават (ID: `person:Nebat`); Bethel (ID: `place:Bethel`); Pure (ID: `keyterm:Pure`); Ровоам (ID: `person:Rehoboam`); Иерусалим (ID: `place:Jerusalem`); Аса (ID: `person:Asa`); Ефрем (ID: `group:Ephraim`); Цемараим (ID: `place:Zemaraim`); Covenant (ID: `keyterm:Covenant`); Offering (ID: `keyterm:Offering`); Bread of Display (ID: `realia:BreadOfDisplay`); Molten Image (ID: `realia:MoltenImage`); Lamp (ID: `realia:Lamp`); Sheep (ID: `fauna:Lamb`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Аса (ID: `person:Asa`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Израиль (ID: `person:Israel`); Ефиопия (ID: `place:Ethiopia`); Вааса (ID: `person:Baasha`); Вениамин (ID: `group:Benjamin`); Ethiopians (ID: `group:Ethiopia`); Вениамин (ID: `person:Benjamin`); Ramah (ID: `place:Ramah.2`); Одед (ID: `person:Oded`); Swear (ID: `keyterm:Swear`); Мареша (ID: `place:Mareshah`); Instruction (ID: `keyterm:Instruction`); Герар (ID: `place:Gerar`); Иерусалим (ID: `place:Jerusalem`); Ефрем (ID: `group:Ephraim`); Asherah (ID: `deity:Asherah`); Covenant (ID: `keyterm:Covenant`); Ben-hadad (ID: `person:Ben-hadad`); Ефрем (ID: `person:Ephraim`); House (ID: `realia:House`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Money (ID: `realia:Money`); Хананий (ID: `person:Hanani`); Зерах (ID: `person:Zerah.5`); Азария (ID: `person:Azariah.8`); Valley of Zephathah (ID: `place:ZephathahValley`); Кедрон (ID: `place:Kidron`); Авел-Беф-Мааху (ID: `place:Abel-beth-maacah`); Ijon (ID: `place:Ijon`); Гава (ID: `place:Geba`); Oath (ID: `keyterm:Oath`); Дамаск (ID: `place:Damascus`); Strength (ID: `keyterm:Strength`); Мааха (ID: `person:Maacah.3`); Truth (ID: `keyterm:Truth`); Манассия (ID: `group:Manasseh`); Peace (ID: `keyterm:IntactState`); Манассия (ID: `person:Manasseh`); Симеон (ID: `person:Simeon.5`); Detested Thing (ID: `keyterm:DetestedThing`); Дан (ID: `place:Dan`); Delight (ID: `keyterm:Delight`); Симеон (ID: `group:Simeon`); Давид (ID: `person:David`); Неффалим (ID: `person:Naphtali`); Массифа (ID: `place:Mizpah`); Дан (ID: `group:Dan`); Ливияне (ID: `place:Libya`); Неффалим (ID: `group:Naphtali`); Stone Altar (ID: `realia:StoneAltar`); Goat (ID: `fauna:Goat`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Chariot (ID: `realia:Chariot`); Flock (ID: `fauna:Flock`); Bed (ID: `realia:Bed`); Fortification (ID: `realia:Fortification`); Rams Horn (ID: `realia:RamsHorn`); Image (ID: `realia:Image`); Bow (ID: `realia:Bow`); Cattle (ID: `fauna:Bull`); Large Shield (ID: `realia:LargeShield`); Camel (ID: `fauna:Camel`); Small Shield (ID: `realia:SmallShield`); Sacred Pole (ID: `realia:SacredPole`); Balsam Tree (ID: `flora:BalsamTree`); Trumpet (ID: `realia:Trumpet`); Spear (ID: `realia:Spear`); Tent (ID: `realia:Tent`); Sacred Pillar (ID: `realia:SacredPillar`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иосафат (ID: `person:Jehoshaphat.3`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Израиль (ID: `person:Israel`); Иерусалим (ID: `place:Jerusalem`); Михей (ID: `person:Micaiah.5`); Рамоф Галаадский (ID: `place:Ramoth-gilead`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Speak as a Prophet (ID: `keyterm:Speak`); Моав (ID: `place:Moab`); Аммон (ID: `place:Ammon`); Fear (ID: `keyterm:Fear`); Ахав (ID: `person:Ahab`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Chariot (ID: `realia:Chariot`); Mount Seir (ID: `place:SeirMount`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Хенаана (ID: `person:Chenaanah`); Иемвлая (ID: `person:Imlah`); Охозия (ID: `person:Ahaziah`); Хананий (ID: `person:Hanani`); Ииуй (ID: `person:Jehu`); Strength (ID: `keyterm:Strength`); Седекия (ID: `person:Zedekiah.2`); Instruction (ID: `keyterm:Instruction`); Иорам (ID: `person:Jehoram`); Asherah (ID: `deity:Asherah`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иодай (ID: `person:Jehoiada.2`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); House (ID: `realia:House`); Иерусалим (ID: `place:Jerusalem`); Охозия (ID: `person:Ahaziah.2`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Израиль (ID: `person:Israel`); Давид (ID: `person:David`); Ахав (ID: `person:Ahab`); Афалия (ID: `person:Athaliah`); Иорам (ID: `person:Jehoram`); Иоас (ID: `person:Joash.3`); Covenant (ID: `keyterm:Covenant`); Иорам (ID: `person:Joram.3`); Моисей (ID: `person:Moses`); Syrians (ID: `group:Syria`); Едом (ID: `place:Edom`); Ииуй (ID: `person:Jehu.2`); Рамоф Галаадский (ID: `place:Ramoth-gilead`); Sabbath (ID: `keyterm:Sabbath`); Offering (ID: `keyterm:Offering`); Smear (ID: `keyterm:Smear`); Азаил (ID: `person:Hazael`); Иосафат (ID: `person:Jehoshaphat.3`); Testimony (ID: `keyterm:Witness.2`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Израиль (ID: `person:Israel`); Амасси (ID: `person:Amaziah`); Узия (ID: `person:Uzziah`); Иерусалим (ID: `place:Jerusalem`); Ахаз (ID: `person:Ahaz`); Иофам (ID: `person:Jotham.2`); Иоас (ID: `person:Joash.4`); Самария (ID: `place:Samaria`); House (ID: `realia:House`); Be Unfaithful (ID: `keyterm:Unfaithful`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Ефрем (ID: `group:Ephraim`); Ефрем (ID: `person:Ephraim`); Едом (ID: `place:Edom`); Beth-shemesh (ID: `place:Beth-shemesh`); Филистимской (ID: `place:Philistine`); Assyria (ID: `place:Assyria`); Филистимлянин (ID: `group:Philistine`); Tower (ID: `realia:Tower`); Азария (ID: `person:Azariah.9`); Corner Gate (ID: `place:CornerGate`); Иоас (ID: `person:Joash.3`); Shephelah (ID: `place:Shephelah`); Давид (ID: `person:David`); Аммон (ID: `place:Ammon`); Иоахаз (ID: `person:Jehoahaz.2`); Ammonites (ID: `group:Ammon`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Езекия (ID: `person:Hezekiah`); Иерусалим (ID: `place:Jerusalem`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Offering (ID: `keyterm:Offering`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Израиль (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Давид (ID: `person:David`); Assyria (ID: `place:Assyria`); Passover (ID: `keyterm:Passover`); Pure (ID: `keyterm:Pure`); Манассия (ID: `group:Manasseh`); Манассия (ID: `person:Manasseh`); Сеннахирим (ID: `person:Sennacherib`); House (ID: `realia:House`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Instruction (ID: `keyterm:Instruction`); Ефрем (ID: `group:Ephraim`); Ефрем (ID: `person:Ephraim`); Work (ID: `keyterm:Work`); Завулон (ID: `group:Zebulun`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Израиль (ID: `person:Israel`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Иосия (ID: `person:Josiah`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Passover (ID: `keyterm:Passover`); Манассия (ID: `person:Manasseh.2`); Хелкия (ID: `person:Hilkiah.2`); Давид (ID: `person:David`); House (ID: `realia:House`); Шафан (ID: `person:Shaphan`); Амон (ID: `person:Amon.3`); Instruction (ID: `keyterm:Instruction`); Asherah (ID: `deity:Asherah`); Force to Serve (ID: `keyterm:EnticedToServe`); Work (ID: `keyterm:Work`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Scroll (ID: `realia:Scroll`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Graven Image (ID: `realia:GravenImage`); Моисей (ID: `person:Moses`); Offering (ID: `keyterm:Offering`); Sacred Pole (ID: `realia:SacredPole`); Appoint (ID: `keyterm:Appoint`); Иоахаз (ID: `person:Jehoahaz.3`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Вавилон (ID: `place:Babylon`); House (ID: `realia:House`); Навуходоносор (ID: `person:Nebuchadnezzar`); Иеремия (ID: `person:Jeremiah.6`); Персия (ID: `place:Persia`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Кир (ID: `person:Cyrus`); Иехония (ID: `person:Jehoiachin`); Иоаким (ID: `person:Jehoiakim`); An Angel (ID: `deity:Angel`); Седекия (ID: `person:Zedekiah.3`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Израиль (ID: `person:Israel`); Rebel (ID: `keyterm:Rebel`); Swear (ID: `keyterm:Swear`); Sabbath (ID: `keyterm:Sabbath`); Халдея (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Defilement (ID: `keyterm:Defilement`); Holy (ID: `keyterm:Holy`); Be Unfaithful (ID: `keyterm:Unfaithful`)
