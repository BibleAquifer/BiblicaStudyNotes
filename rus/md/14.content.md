...
* **Associated ACAI Concepts:** Ровоам (ID: `person:Rehoboam`); LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Иерусалим (ID: `place:Jerusalem`); Иеровоам (ID: `person:Jeroboam`); Вениамин (ID: `person:Benjamin`); Соломон (ID: `person:Solomon`); Давид (ID: `person:David`); Вениамин (ID: `group:Benjamin`); Шемаия (ID: `person:Shemaiah`); Fortification (ID: `realia:Fortification`); Сусаким (ID: `person:Shishak`); Египет (ID: `place:Egypt`); Yoke (ID: `realia:Yoke`); Мааха (ID: `person:Maacah.3`); Авия (ID: `person:Abijah.4`); Counsel (ID: `keyterm:Counsel`); House (ID: `realia:House`); Нават (ID: `person:Nebat`); Левий (ID: `person:Levi.3`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Иессей (ID: `person:Jesse`); Левий (ID: `group:Levi`); Авессалом (ID: `person:Absalom`); Work (ID: `keyterm:Work`); Шемария (ID: `person:Shemariah.2`); Иеуш (ID: `person:Jeush.5`); Зиф (ID: `person:Ziph`)
...
* **Associated ACAI Concepts:** Авия (ID: `person:Abijah.4`); LORD (ID: `deity:Lord`); Иеровоам (ID: `person:Jeroboam`); Израиль (ID: `person:Israel`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Давид (ID: `person:David`); Соломон (ID: `person:Solomon`); Аарона (ID: `person:Aaron`); Ефрем (ID: `person:Ephraim`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Trumpet (ID: `realia:Trumpet`); Cattle (ID: `fauna:Bull`); Уриил (ID: `person:Uriel.3`); Iddo (ID: `person:Iddo.5`); Гива (ID: `place:Gibeah`); Иешана (ID: `place:Jeshanah`); Иерусалим (ID: `place:Jerusalem`); Strength (ID: `keyterm:Strength`); Цемараим (ID: `place:Zemaraim`); Pure (ID: `keyterm:Pure`); Rebel (ID: `keyterm:Rebel`); Offering (ID: `keyterm:Offering`); Мааха (ID: `person:Maacah.3`); Нават (ID: `person:Nebat`); Аса (ID: `person:Asa`); Ровоам (ID: `person:Rehoboam`); Wickedness (ID: `keyterm:Wickedness`); Bethel (ID: `place:Bethel`); Ефрем (ID: `group:Ephraim`); Covenant (ID: `keyterm:Covenant`); Bread of Display (ID: `realia:BreadOfDisplay`); Molten Image (ID: `realia:MoltenImage`); Lampstand (ID: `realia:Lampstand.2`); Sheep (ID: `fauna:Lamb`); Lamp (ID: `realia:Lamp`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Аса (ID: `person:Asa`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Израиль (ID: `person:Israel`); Ethiopians (ID: `group:Ethiopia`); Вениамин (ID: `person:Benjamin`); Вениамин (ID: `group:Benjamin`); Ефиопия (ID: `place:Ethiopia`); Вааса (ID: `person:Baasha`); Ramah (ID: `place:Ramah.2`); Одед (ID: `person:Oded`); Swear (ID: `keyterm:Swear`); Мареша (ID: `place:Mareshah`); Иерусалим (ID: `place:Jerusalem`); Ben-hadad (ID: `person:Ben-hadad`); Герар (ID: `place:Gerar`); Ефрем (ID: `person:Ephraim`); Instruction (ID: `keyterm:Instruction`); Ефрем (ID: `group:Ephraim`); Covenant (ID: `keyterm:Covenant`); Asherah (ID: `deity:Asherah`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); House (ID: `realia:House`); Money (ID: `realia:Money`); Зерах (ID: `person:Zerah.5`); Азария (ID: `person:Azariah.8`); Кедрон (ID: `place:Kidron`); Ijon (ID: `place:Ijon`); Хананий (ID: `person:Hanani`); Valley of Zephathah (ID: `place:ZephathahValley`); Авел-Беф-Мааху (ID: `place:Abel-beth-maacah`); Симеон (ID: `person:Simeon.5`); Дан (ID: `group:Dan`); Гава (ID: `place:Geba`); Delight (ID: `keyterm:Delight`); Strength (ID: `keyterm:Strength`); Truth (ID: `keyterm:Truth`); Манассия (ID: `person:Manasseh`); Дан (ID: `place:Dan`); Мааха (ID: `person:Maacah.3`); Давид (ID: `person:David`); Симеон (ID: `group:Simeon`); Дамаск (ID: `place:Damascus`); Манассия (ID: `group:Manasseh`); Неффалим (ID: `person:Naphtali`); Oath (ID: `keyterm:Oath`); Detested Thing (ID: `keyterm:DetestedThing`); Неффалим (ID: `group:Naphtali`); Ливияне (ID: `place:Libya`); Массифа (ID: `place:Mizpah`); Peace (ID: `keyterm:IntactState`); Flock (ID: `fauna:Flock`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Goat (ID: `fauna:Goat`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Chariot (ID: `realia:Chariot`); Sacred Pillar (ID: `realia:SacredPillar`); Camel (ID: `fauna:Camel`); Large Shield (ID: `realia:LargeShield`); Balsam Tree (ID: `flora:BalsamTree`); Small Shield (ID: `realia:SmallShield`); Rams Horn (ID: `realia:RamsHorn`); Tent (ID: `realia:Tent`); Spear (ID: `realia:Spear`); Image (ID: `realia:Image`); Trumpet (ID: `realia:Trumpet`); Sacred Pole (ID: `realia:SacredPole`); Bed (ID: `realia:Bed`); Tower (ID: `realia:Tower`); Bow (ID: `realia:Bow`); Fortification (ID: `realia:Fortification`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иосафат (ID: `person:Jehoshaphat.3`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Израиль (ID: `person:Israel`); Иерусалим (ID: `place:Jerusalem`); Михей (ID: `person:Micaiah.5`); Рамоф Галаадский (ID: `place:Ramoth-gilead`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Speak as a Prophet (ID: `keyterm:Speak`); Моав (ID: `place:Moab`); Ахав (ID: `person:Ahab`); Peace (ID: `keyterm:IntactState`); Fear (ID: `keyterm:Fear`); Аммон (ID: `place:Ammon`); House (ID: `realia:House`); Chariot (ID: `realia:Chariot`); Mount Seir (ID: `place:SeirMount`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Хенаана (ID: `person:Chenaanah`); Иемвлая (ID: `person:Imlah`); Охозия (ID: `person:Ahaziah`); Хананий (ID: `person:Hanani`); Strength (ID: `keyterm:Strength`); Седекия (ID: `person:Zedekiah.2`); Ииуй (ID: `person:Jehu`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Фарсис (ID: `place:Tarshish`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иодай (ID: `person:Jehoiada.2`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); House (ID: `realia:House`); Иерусалим (ID: `place:Jerusalem`); Охозия (ID: `person:Ahaziah.2`); Левий (ID: `person:Levi.3`); Израиль (ID: `person:Israel`); Левий (ID: `group:Levi`); Ахав (ID: `person:Ahab`); Афалия (ID: `person:Athaliah`); Давид (ID: `person:David`); Иорам (ID: `person:Jehoram`); Иоас (ID: `person:Joash.3`); Covenant (ID: `keyterm:Covenant`); Иорам (ID: `person:Joram.3`); Syrians (ID: `group:Syria`); Моисей (ID: `person:Moses`); Ииуй (ID: `person:Jehu.2`); Едом (ID: `place:Edom`); Рамоф Галаадский (ID: `place:Ramoth-gilead`); Arabians (ID: `group:Arabia`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Sabbath (ID: `keyterm:Sabbath`); Арбитянин (ID: `place:Arabia`); Smear (ID: `keyterm:Smear`); Testimony (ID: `keyterm:Witness.2`); Азаил (ID: `person:Hazael`); Ваал (ID: `deity:Baal`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Израиль (ID: `person:Israel`); Амасси (ID: `person:Amaziah`); Узия (ID: `person:Uzziah`); Иерусалим (ID: `place:Jerusalem`); Ахаз (ID: `person:Ahaz`); Иофам (ID: `person:Jotham.2`); Иоас (ID: `person:Joash.4`); Самария (ID: `place:Samaria`); House (ID: `realia:House`); Be Unfaithful (ID: `keyterm:Unfaithful`); Ефрем (ID: `group:Ephraim`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Ефрем (ID: `person:Ephraim`); Едом (ID: `place:Edom`); Beth-shemesh (ID: `place:Beth-shemesh`); Assyria (ID: `place:Assyria`); Филистимской (ID: `place:Philistine`); Филистимлянин (ID: `group:Philistine`); Tower (ID: `realia:Tower`); Corner Gate (ID: `place:CornerGate`); Азария (ID: `person:Azariah.9`); Shephelah (ID: `place:Shephelah`); Иоас (ID: `person:Joash.3`); Strength (ID: `keyterm:Strength`); Иоахаз (ID: `person:Jehoahaz.2`); Дамаск (ID: `place:Damascus`); Edomites (ID: `group:Edom`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Езекия (ID: `person:Hezekiah`); Иерусалим (ID: `place:Jerusalem`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Offering (ID: `keyterm:Offering`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Израиль (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Assyria (ID: `place:Assyria`); Давид (ID: `person:David`); Pure (ID: `keyterm:Pure`); Passover (ID: `keyterm:Passover`); Манассия (ID: `group:Manasseh`); Сеннахирим (ID: `person:Sennacherib`); Манассия (ID: `person:Manasseh`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Cattle (ID: `fauna:Bull`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Instruction (ID: `keyterm:Instruction`); Ефрем (ID: `group:Ephraim`); Work (ID: `keyterm:Work`); Ефрем (ID: `person:Ephraim`); To Sin (ID: `keyterm:Sin`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Вавилон (ID: `place:Babylon`); House (ID: `realia:House`); Навуходоносор (ID: `person:Nebuchadnezzar`); Иеремия (ID: `person:Jeremiah.6`); Персия (ID: `place:Persia`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Кир (ID: `person:Cyrus`); Иехония (ID: `person:Jehoiachin`); Иоаким (ID: `person:Jehoiakim`); An Angel (ID: `deity:Angel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Седекия (ID: `person:Zedekiah.3`); Израиль (ID: `person:Israel`); Sabbath (ID: `keyterm:Sabbath`); Rebel (ID: `keyterm:Rebel`); Holy (ID: `keyterm:Holy`); Swear (ID: `keyterm:Swear`); Chaldeans (ID: `group:Chaldea`); Be Unfaithful (ID: `keyterm:Unfaithful`); Defilement (ID: `keyterm:Defilement`); Халдея (ID: `place:Chaldea`)
