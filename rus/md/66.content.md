...
* **Associated ACAI Concepts:** Lampstand (ID: `realia:Lampstand.2`); Church (ID: `keyterm:Church`); Филадельфия (ID: `place:Philadelphia`); Патмос (ID: `place:Patmos`); Лаодикия (ID: `place:Laodicea`); Сардис (ID: `place:Sardis`); Смирна (ID: `place:Smyrna`); Ефес (ID: `place:Ephesus`); Пергам (ID: `place:Pergamum`); Иоанн (ID: `person:John.2`); Hell (ID: `place:Hell`); Bear Witness (ID: `keyterm:BearWitness`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Ability (ID: `keyterm:Ability`); LORD (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Fear (ID: `keyterm:Fear`); Святой Дух (ID: `deity:HolySpirit`); Иисус (ID: `person:Jesus.2`); Фиатира (ID: `place:Thyatira`); An Angel (ID: `deity:Angel`); Always (ID: `keyterm:Always`); Kingdom (ID: `keyterm:Kingdom`); Kiln (ID: `realia:Kiln`); Bag (ID: `realia:Bag`); Cloak (ID: `realia:Cloak`); Belt (ID: `realia:Belt`); Scroll (ID: `realia:Scroll`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); Life (ID: `keyterm:Life`); Святой Дух (ID: `deity:HolySpirit`); An Angel (ID: `deity:Angel`); Name (ID: `keyterm:Name`); Nicolaitans (ID: `group:Nicolaitans`); сатана (ID: `deity:Satan`); Repent (ID: `keyterm:Repent`); Faithfulness (ID: `keyterm:Faithfulness`); Lampstand (ID: `realia:Lampstand.2`); Антипа (ID: `person:Antipas`); To Act Wickedly (ID: `keyterm:ActWickedly`); Смирна (ID: `place:Smyrna`); Ефес (ID: `place:Ephesus`); Пергам (ID: `place:Pergamum`); Blaspheme (ID: `keyterm:Blaspheme`); Believe (ID: `keyterm:Believe`); Paradise (ID: `keyterm:Paradise`); Love (ID: `keyterm:Love`); LORD (ID: `deity:Lord`); Witness (ID: `keyterm:Witness`); Валаам (ID: `person:Balaam`); Stumbling Block (ID: `keyterm:StumblingBlock`); Fear (ID: `keyterm:Fear`); Fornication (ID: `keyterm:Fornication`); Jews (ID: `group:Jews`); Израиль (ID: `person:Israel`); Валак (ID: `person:Balak`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); LORD (ID: `deity:Lord`); Fornication (ID: `keyterm:Fornication`); Repent (ID: `keyterm:Repent`); An Angel (ID: `deity:Angel`); Name (ID: `keyterm:Name`); Сардис (ID: `place:Sardis`); Фиатира (ID: `place:Thyatira`); Life (ID: `keyterm:Life`); Святой Дух (ID: `deity:HolySpirit`); Clothing (ID: `realia:Clothing`); Иезавель (ID: `person:Jezebel`); Believe (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); Heart (ID: `keyterm:Heart`); сатана (ID: `deity:Satan`); Defilement (ID: `keyterm:Defilement`); Authority (ID: `keyterm:Authority.2`); Serve (ID: `keyterm:Serve`); Spirit (ID: `keyterm:Spirit.2`); Rod (ID: `realia:Rod`); Bed (ID: `realia:Bed`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); LORD (ID: `deity:Lord`); True (ID: `keyterm:True`); Ability (ID: `keyterm:Ability`); Святой Дух (ID: `deity:HolySpirit`); An Angel (ID: `deity:Angel`); Name (ID: `keyterm:Name`); Door (ID: `realia:Door`); Филадельфия (ID: `place:Philadelphia`); Лаодикия (ID: `place:Laodicea`); Friendship (ID: `keyterm:Friendship`); Surely! (ID: `keyterm:Surely`); Bow Down (ID: `keyterm:BowDown`); Sky (ID: `keyterm:Heaven`); Love (ID: `keyterm:Love`); сатана (ID: `deity:Satan`); Anointed (ID: `keyterm:Anointed`); Repent (ID: `keyterm:Repent`); Иерусалим (ID: `place:Jerusalem`); Witness (ID: `keyterm:Witness`); Pitiful (ID: `keyterm:Pitiful`); Давид (ID: `person:David`); Holy (ID: `keyterm:Holy`); Faithfulness (ID: `keyterm:Faithfulness`); Jews (ID: `group:Jews`); Eye Salve (ID: `realia:EyeSalve`); Capital (ID: `realia:Capital`); Clothing (ID: `realia:Clothing`); Throne (ID: `realia:Throne`); Temple (ID: `realia:Temple`)
...
* **Associated Articles:** День суда (ID: `193137@BiblicaStudyNotesKeyTerms`); Числа (ID: `193265@BiblicaStudyNotesKeyTerms`); 144 000 (ID: `193266@BiblicaStudyNotesKeyTerms`); Пастух (пастырь) (ID: `193360@BiblicaStudyNotesKeyTerms`); 12 колен  (ID: `193368@BiblicaStudyNotesKeyTerms`); Кровь (ID: `193397@BiblicaStudyNotes`); Новое творение (ID: `193625@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Throne (ID: `realia:Throne`); An Angel (ID: `deity:Angel`); Cloak (ID: `realia:Cloak`); To Act Wickedly (ID: `keyterm:ActWickedly`); Life (ID: `keyterm:Life`); Иссахар (ID: `person:Issachar`); Завулон (ID: `person:Zebulun`); Рувим (ID: `person:Reuben`); Неффалим (ID: `person:Naphtali`); Гад (ID: `person:Gad`); Priesthood (ID: `keyterm:Priesthood`); Salvation (ID: `keyterm:Salvation`); Surely! (ID: `keyterm:Surely`); Завулон (ID: `group:Zebulun`); Glory (ID: `keyterm:Glory`); Bow Down (ID: `keyterm:BowDown`); Левий (ID: `group:Levi`); Рувим (ID: `group:Reuben`); Ability (ID: `keyterm:Ability`); Иссахар (ID: `group:Issachar`); Bless (ID: `keyterm:Bless`); Вениамин (ID: `group:Benjamin`); Манассия (ID: `group:Manasseh`); Асир (ID: `person:Asher`); Манассия (ID: `person:Manasseh`); Вениамин (ID: `person:Benjamin`); Иуда (ID: `group:Judah`); Симеон (ID: `person:Simeon.5`); Иуда (ID: `person:Judah.4`); Симеон (ID: `group:Simeon`); Израиль (ID: `person:Israel`); Serve (ID: `keyterm:Serve`); Левий (ID: `person:Levi.3`); Always (ID: `keyterm:Always`); Иосиф (ID: `person:Joseph.10`); Асир (ID: `group:Asher`); Blood (ID: `keyterm:Blood`); Goat (ID: `fauna:Goat`); Cornerstone (ID: `realia:Cornerstone`); Date Palm (ID: `flora:DatePalm`); Temple (ID: `realia:Temple`); Flock (ID: `fauna:Flock`); Seal (ID: `realia:Seal`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); Repent (ID: `keyterm:Repent`); Trumpet (ID: `realia:Trumpet`); Horse (ID: `fauna:Horse`); Demons (ID: `deity:Demons`); Bow Down (ID: `keyterm:BowDown`); To Act Wickedly (ID: `keyterm:ActWickedly`); Евфрат (ID: `place:Euphrates`); Fornication (ID: `keyterm:Fornication`); LORD (ID: `deity:Lord`); Authority (ID: `keyterm:Authority.2`); Ability (ID: `keyterm:Ability`); Snake (ID: `fauna:Snake`); Lion (ID: `fauna:Lion`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Kingdom (ID: `keyterm:Kingdom`); Иисус (ID: `person:Jesus.2`); Holy (ID: `keyterm:Holy`); An Angel (ID: `deity:Angel`); Name (ID: `keyterm:Name`); Decided (ID: `keyterm:Decided`); Always (ID: `keyterm:Always`); Bow Down (ID: `keyterm:BowDown`); Fear (ID: `keyterm:Fear`); Covenant (ID: `keyterm:Covenant`); Trumpet (ID: `realia:Trumpet`); Temple (ID: `realia:Temple`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Sky (ID: `keyterm:Heaven`); Dragon (ID: `fauna:Dragon`); LORD (ID: `deity:Lord`); Snake (ID: `fauna:Snake`); Bear Witness (ID: `keyterm:BearWitness`); Ability (ID: `keyterm:Ability`); Иисус (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); Symbol (ID: `keyterm:Example`); Crown (ID: `realia:Crown`); Михаил (ID: `person:Michael.11`); Commandment (ID: `keyterm:Commandment`); Salvation (ID: `keyterm:Salvation`); A Disembodied Voice (ID: `deity:Voice`); Love (ID: `keyterm:Love`); сатана (ID: `deity:Satan`); Life (ID: `keyterm:Life`); Disaster (ID: `keyterm:Disaster`); Authority (ID: `keyterm:Authority.2`); Kingdom (ID: `keyterm:Kingdom`); Blood (ID: `keyterm:Blood`); Rod (ID: `realia:Rod`); Crown (ID: `realia:Crown.2`); Vulture (ID: `fauna:Vulture`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Redeem (ID: `keyterm:Redeem`); LORD (ID: `deity:Lord`); Unblemished (ID: `keyterm:Unblemished`); Иерусалим (ID: `place:Jerusalem`); Name (ID: `keyterm:Name`); Defilement (ID: `keyterm:Defilement`); Sky (ID: `keyterm:Heaven`); Lyre (ID: `realia:Lyre`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Bow Down (ID: `keyterm:BowDown`); Sky (ID: `keyterm:Heaven`); Holy (ID: `keyterm:Holy`); Always (ID: `keyterm:Always`); Image (ID: `realia:Image`); Wine (ID: `realia:Wine`); Commandment (ID: `keyterm:Commandment`); A Disembodied Voice (ID: `deity:Voice`); Good News (ID: `keyterm:GoodNews`); Glory (ID: `keyterm:Glory`); Believe (ID: `keyterm:Believe`); Midheaven (ID: `keyterm:Midheaven`); Judgment (ID: `keyterm:Judgment`); Вавилон (ID: `place:Babylon`); Fear (ID: `keyterm:Fear`); Court Case (ID: `keyterm:CourtCase`); Святой Дух (ID: `deity:HolySpirit`); Happy (ID: `keyterm:Happy`); Иисус (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); Fornication (ID: `keyterm:Fornication`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Bowl (ID: `realia:Bowl.2`); Blood (ID: `keyterm:Blood`); Blaspheme (ID: `keyterm:Blaspheme`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Repent (ID: `keyterm:Repent`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); Throne (ID: `realia:Throne`); Temple (ID: `realia:Temple`); Евфрат (ID: `place:Euphrates`); Мегиддон (ID: `place:Megiddo`); A Disembodied Voice (ID: `deity:Voice`); Glory (ID: `keyterm:Glory`); Bow Down (ID: `keyterm:BowDown`); Judgment (ID: `keyterm:Judgment`); Вавилон (ID: `place:Babylon`); Life (ID: `keyterm:Life`); Decided (ID: `keyterm:Decided`); True (ID: `keyterm:True`); Demons (ID: `deity:Demons`); Authority (ID: `keyterm:Authority.2`); Court Case (ID: `keyterm:CourtCase`); Happy (ID: `keyterm:Happy`); Holy (ID: `keyterm:Holy`); Name (ID: `keyterm:Name`); Kingdom (ID: `keyterm:Kingdom`); Symbol (ID: `keyterm:Example`); Talent (ID: `realia:Talent`); Frog (ID: `fauna:Frog`); Image (ID: `realia:Image`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Dragon (ID: `fauna:Dragon`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Name (ID: `keyterm:Name`); Kingdom (ID: `keyterm:Kingdom`); Authority (ID: `keyterm:Authority.2`); Abomination (ID: `keyterm:Abomination`); Иисус (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); Fornication (ID: `keyterm:Fornication`); Blaspheme (ID: `keyterm:Blaspheme`); Body (ID: `keyterm:Body.3`); Heart (ID: `keyterm:Heart`); LORD (ID: `deity:Lord`); Chosen (ID: `keyterm:Chosen`); Judgment (ID: `keyterm:Judgment`); Вавилон (ID: `place:Babylon`); Witness (ID: `keyterm:Witness`); Life (ID: `keyterm:Life`); Defilement (ID: `keyterm:Defilement`); Святой Дух (ID: `deity:HolySpirit`); Abyss (ID: `keyterm:Abyss`); Holy (ID: `keyterm:Holy`); Faithfulness (ID: `keyterm:Faithfulness`); Blood (ID: `keyterm:Blood`); Purple Cloth (ID: `realia:PurpleCloth`); Gold Jewelry (ID: `realia:GoldJewelry`); Scroll (ID: `realia:Scroll`); Wine (ID: `realia:Wine`); Bowl (ID: `realia:Bowl.2`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Throne (ID: `realia:Throne`); Idolater (ID: `keyterm:Idolater`); Holy (ID: `keyterm:Holy`); Иерусалим (ID: `place:Jerusalem`); Faithfulness (ID: `keyterm:Faithfulness`); A Disembodied Voice (ID: `deity:Voice`); Life (ID: `keyterm:Life`); True (ID: `keyterm:True`); Be Unfaithful (ID: `keyterm:Unfaithful`); Tabernacle (ID: `realia:Tabernacle`)
...
* **Associated ACAI Concepts:** City Wall (ID: `realia:CityWall`); Temple (ID: `realia:Temple`); An Angel (ID: `deity:Angel`); Foundation (ID: `realia:Foundation`); Clean (ID: `keyterm:Clean`); Name (ID: `keyterm:Name`); LORD (ID: `deity:Lord`); Measuring Rod (ID: `realia:MeasuringRod`); Measuring Reed (ID: `realia:MeasuringReed`); Reed (ID: `flora:Reed`); Holy (ID: `keyterm:Holy`); Израиль (ID: `person:Israel`); Иерусалим (ID: `place:Jerusalem`); Glory (ID: `keyterm:Glory`); Святой Дух (ID: `deity:HolySpirit`); Sky (ID: `keyterm:Heaven`); Cubit (ID: `realia:Cubit.2`); Bowl (ID: `realia:Bowl.2`)
...
* **Associated ACAI Concepts:** Scroll (ID: `realia:Scroll`); LORD (ID: `deity:Lord`); Bear Witness (ID: `keyterm:BearWitness`); Life (ID: `keyterm:Life`); Иисус (ID: `person:Jesus.2`); An Angel (ID: `deity:Angel`); Happy (ID: `keyterm:Happy`); Bow Down (ID: `keyterm:BowDown`); Holy (ID: `keyterm:Holy`); Surely! (ID: `keyterm:Surely`); The Church (ID: `group:GenericChurch`); Иоанн (ID: `person:John.2`); To Command (ID: `keyterm:Command`); Idolater (ID: `keyterm:Idolater`); Ability (ID: `keyterm:Ability`); A Person (ID: `person:GenericPerson`); Consecration (ID: `keyterm:Consecration.2`); Friendship (ID: `keyterm:Friendship`); To Act Wickedly (ID: `keyterm:ActWickedly`); True (ID: `keyterm:True`); Authority (ID: `keyterm:Authority.2`); Church (ID: `keyterm:Church`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Святой Дух (ID: `deity:HolySpirit`); Давид (ID: `person:David`); Faithfulness (ID: `keyterm:Faithfulness`); Spirit (ID: `keyterm:Spirit.2`); Favor (ID: `keyterm:Favor`); Cloak (ID: `realia:Cloak`); Temple (ID: `realia:Temple`); Seal (ID: `realia:Seal`)
