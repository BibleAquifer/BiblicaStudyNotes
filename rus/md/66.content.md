...
* **Associated ACAI Concepts:** Lampstand (ID: `realia:Lampstand.2`); Church (ID: `keyterm:Church`); Сардис (ID: `place:Sardis`); Филадельфия (ID: `place:Philadelphia`); Ефес (ID: `place:Ephesus`); Пергам (ID: `place:Pergamum`); Смирна (ID: `place:Smyrna`); Лаодикия (ID: `place:Laodicea`); Патмос (ID: `place:Patmos`); Ability (ID: `keyterm:Ability`); Иисус (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Hell (ID: `place:Hell`); Always (ID: `keyterm:Always`); Kingdom (ID: `keyterm:Kingdom`); An Angel (ID: `deity:Angel`); LORD (ID: `deity:Lord`); Фиатира (ID: `place:Thyatira`); Fear (ID: `keyterm:Fear`); Святой Дух (ID: `deity:HolySpirit`); Иоанн (ID: `person:John.2`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Bear Witness (ID: `keyterm:BearWitness`); Kiln (ID: `realia:Kiln`); Bag (ID: `realia:Bag`); Belt (ID: `realia:Belt`); Cloak (ID: `realia:Cloak`); Trumpet (ID: `realia:Trumpet`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); Life (ID: `keyterm:Life`); Name (ID: `keyterm:Name`); An Angel (ID: `deity:Angel`); Святой Дух (ID: `deity:HolySpirit`); Nicolaitans (ID: `group:Nicolaitans`); Repent (ID: `keyterm:Repent`); Faithfulness (ID: `keyterm:Faithfulness`); сатана (ID: `deity:Satan`); Lampstand (ID: `realia:Lampstand.2`); To Act Wickedly (ID: `keyterm:ActWickedly`); Антипа (ID: `person:Antipas`); Ефес (ID: `place:Ephesus`); Пергам (ID: `place:Pergamum`); Смирна (ID: `place:Smyrna`); Love (ID: `keyterm:Love`); Валак (ID: `person:Balak`); Fornication (ID: `keyterm:Fornication`); LORD (ID: `deity:Lord`); Paradise (ID: `keyterm:Paradise`); Fear (ID: `keyterm:Fear`); Believe (ID: `keyterm:Believe`); Blaspheme (ID: `keyterm:Blaspheme`); Stumbling Block (ID: `keyterm:StumblingBlock`); Jews (ID: `group:Jews`); Witness (ID: `keyterm:Witness`); Израиль (ID: `person:Israel`); Валаам (ID: `person:Balaam`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); LORD (ID: `deity:Lord`); Fornication (ID: `keyterm:Fornication`); Name (ID: `keyterm:Name`); An Angel (ID: `deity:Angel`); Repent (ID: `keyterm:Repent`); Сардис (ID: `place:Sardis`); Фиатира (ID: `place:Thyatira`); Life (ID: `keyterm:Life`); Святой Дух (ID: `deity:HolySpirit`); Clothing (ID: `realia:Clothing`); Иезавель (ID: `person:Jezebel`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); Heart (ID: `keyterm:Heart`); Authority (ID: `keyterm:Authority.2`); Believe (ID: `keyterm:Believe`); сатана (ID: `deity:Satan`); Serve (ID: `keyterm:Serve`); Spirit (ID: `keyterm:Spirit.2`); Defilement (ID: `keyterm:Defilement`); Rod (ID: `realia:Rod`); Bed (ID: `realia:Bed`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); LORD (ID: `deity:Lord`); True (ID: `keyterm:True`); Ability (ID: `keyterm:Ability`); Name (ID: `keyterm:Name`); An Angel (ID: `deity:Angel`); Святой Дух (ID: `deity:HolySpirit`); Door (ID: `realia:Door`); Филадельфия (ID: `place:Philadelphia`); Лаодикия (ID: `place:Laodicea`); Friendship (ID: `keyterm:Friendship`); Иерусалим (ID: `place:Jerusalem`); Love (ID: `keyterm:Love`); Surely! (ID: `keyterm:Surely`); Anointed (ID: `keyterm:Anointed`); Holy (ID: `keyterm:Holy`); Repent (ID: `keyterm:Repent`); Bow Down (ID: `keyterm:BowDown`); Давид (ID: `person:David`); Sky (ID: `keyterm:Heaven`); Faithfulness (ID: `keyterm:Faithfulness`); сатана (ID: `deity:Satan`); Jews (ID: `group:Jews`); Pitiful (ID: `keyterm:Pitiful`); Witness (ID: `keyterm:Witness`); Eye Salve (ID: `realia:EyeSalve`); Throne (ID: `realia:Throne`); Clothing (ID: `realia:Clothing`); Capital (ID: `realia:Capital`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Scroll (ID: `realia:Scroll`); Throne (ID: `realia:Throne`); Seal (ID: `realia:Seal`); LORD (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); An Angel (ID: `deity:Angel`); Bless (ID: `keyterm:Bless`); Sky (ID: `keyterm:Heaven`); Fourth Living Creature (ID: `deity:FourthLivingCreature`); Third Living Creature (ID: `deity:ThirdLivingCreature`); First Living Creature (ID: `deity:FirstLivingCreature`); Bow Down (ID: `keyterm:BowDown`); Second Living Creature (ID: `deity:SecondLivingCreature`); Ability (ID: `keyterm:Ability`); Blood (ID: `keyterm:Blood`); Proclaim (ID: `keyterm:Proclaim`); Surely! (ID: `keyterm:Surely`); Redeem (ID: `keyterm:Redeem`); Иуда (ID: `person:Judah.4`); Always (ID: `keyterm:Always`); Kingdom (ID: `keyterm:Kingdom`); Holy (ID: `keyterm:Holy`); Давид (ID: `person:David`); Pray (ID: `keyterm:Pray`); Elders (ID: `group:GenericElders`); Spirit (ID: `keyterm:Spirit.2`); Иуда (ID: `group:Judah`); Lion (ID: `fauna:Lion`); Incense (ID: `realia:Incense`); Lyre (ID: `realia:Lyre`); Bowl (ID: `realia:Bowl.2`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Throne (ID: `realia:Throne`); An Angel (ID: `deity:Angel`); Cloak (ID: `realia:Cloak`); Life (ID: `keyterm:Life`); To Act Wickedly (ID: `keyterm:ActWickedly`); Рувим (ID: `person:Reuben`); Иссахар (ID: `person:Issachar`); Неффалим (ID: `person:Naphtali`); Завулон (ID: `person:Zebulun`); Glory (ID: `keyterm:Glory`); Симеон (ID: `person:Simeon.5`); Ability (ID: `keyterm:Ability`); Blood (ID: `keyterm:Blood`); Surely! (ID: `keyterm:Surely`); Иссахар (ID: `group:Issachar`); Асир (ID: `person:Asher`); Вениамин (ID: `person:Benjamin`); Иуда (ID: `person:Judah.4`); Always (ID: `keyterm:Always`); Гад (ID: `person:Gad`); Иосиф (ID: `person:Joseph.10`); Манассия (ID: `person:Manasseh`); Левий (ID: `group:Levi`); Bless (ID: `keyterm:Bless`); Bow Down (ID: `keyterm:BowDown`); Priesthood (ID: `keyterm:Priesthood`); Симеон (ID: `group:Simeon`); Манассия (ID: `group:Manasseh`); Завулон (ID: `group:Zebulun`); Serve (ID: `keyterm:Serve`); Асир (ID: `group:Asher`); Вениамин (ID: `group:Benjamin`); Левий (ID: `person:Levi.3`); Израиль (ID: `person:Israel`); Рувим (ID: `group:Reuben`); Иуда (ID: `group:Judah`); Salvation (ID: `keyterm:Salvation`); Temple (ID: `realia:Temple`); Cornerstone (ID: `realia:Cornerstone`); Flock (ID: `fauna:Flock`); Seal (ID: `realia:Seal`); Goat (ID: `fauna:Goat`); Date Palm (ID: `flora:DatePalm`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Ability (ID: `keyterm:Ability`); Temple (ID: `realia:Temple`); Witness (ID: `keyterm:Witness`); Glory (ID: `keyterm:Glory`); Blood (ID: `keyterm:Blood`); Speak as a Prophet (ID: `keyterm:Speak`); Life (ID: `keyterm:Life`); Иисус (ID: `person:Jesus.2`); To Act Wickedly (ID: `keyterm:ActWickedly`); Bear Witness (ID: `keyterm:BearWitness`); Name (ID: `keyterm:Name`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); Authority (ID: `keyterm:Authority.2`); Bow Down (ID: `keyterm:BowDown`); A Disembodied Voice (ID: `deity:Voice`); Fear (ID: `keyterm:Fear`); Содом (ID: `place:Sodom`); Spirit (ID: `keyterm:Spirit.2`); Gentiles (ID: `group:Gentile`); Египет (ID: `place:Egypt`); Disaster (ID: `keyterm:Disaster`); Abyss (ID: `keyterm:Abyss`); Measuring Reed (ID: `realia:MeasuringReed`); Measuring Rod (ID: `realia:MeasuringRod`); Lampstand (ID: `realia:Lampstand.2`); Sackcloth (ID: `realia:Sackcloth`); Reed (ID: `flora:Reed`); Cross (ID: `realia:Cross`); Olive Tree (ID: `flora:OliveTree`); Staff (ID: `realia:Staff`); Grave (ID: `realia:Grave`); Sheepfold (ID: `realia:Sheepfold`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Kingdom (ID: `keyterm:Kingdom`); Decided (ID: `keyterm:Decided`); Name (ID: `keyterm:Name`); Holy (ID: `keyterm:Holy`); An Angel (ID: `deity:Angel`); Fear (ID: `keyterm:Fear`); Covenant (ID: `keyterm:Covenant`); Иисус (ID: `person:Jesus.2`); Bow Down (ID: `keyterm:BowDown`); Always (ID: `keyterm:Always`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Trumpet (ID: `realia:Trumpet`); Throne (ID: `realia:Throne`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Redeem (ID: `keyterm:Redeem`); Unblemished (ID: `keyterm:Unblemished`); Иерусалим (ID: `place:Jerusalem`); Sky (ID: `keyterm:Heaven`); Name (ID: `keyterm:Name`); Defilement (ID: `keyterm:Defilement`); Lyre (ID: `realia:Lyre`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); LORD (ID: `deity:Lord`); Bow Down (ID: `keyterm:BowDown`); Always (ID: `keyterm:Always`); Holy (ID: `keyterm:Holy`); Sky (ID: `keyterm:Heaven`); Image (ID: `realia:Image`); Wine (ID: `realia:Wine`); Glory (ID: `keyterm:Glory`); Good News (ID: `keyterm:GoodNews`); Вавилон (ID: `place:Babylon`); Иисус (ID: `person:Jesus.2`); Midheaven (ID: `keyterm:Midheaven`); Fornication (ID: `keyterm:Fornication`); Happy (ID: `keyterm:Happy`); Commandment (ID: `keyterm:Commandment`); Name (ID: `keyterm:Name`); Judgment (ID: `keyterm:Judgment`); Fear (ID: `keyterm:Fear`); Believe (ID: `keyterm:Believe`); Святой Дух (ID: `deity:HolySpirit`); Court Case (ID: `keyterm:CourtCase`); A Disembodied Voice (ID: `deity:Voice`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Bowl (ID: `realia:Bowl.2`); Blood (ID: `keyterm:Blood`); Blaspheme (ID: `keyterm:Blaspheme`); Ability (ID: `keyterm:Ability`); An Angel (ID: `deity:Angel`); Repent (ID: `keyterm:Repent`); Sky (ID: `keyterm:Heaven`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Throne (ID: `realia:Throne`); Temple (ID: `realia:Temple`); Евфрат (ID: `place:Euphrates`); Glory (ID: `keyterm:Glory`); Вавилон (ID: `place:Babylon`); Life (ID: `keyterm:Life`); Happy (ID: `keyterm:Happy`); Kingdom (ID: `keyterm:Kingdom`); Decided (ID: `keyterm:Decided`); Name (ID: `keyterm:Name`); Symbol (ID: `keyterm:Example`); Holy (ID: `keyterm:Holy`); Judgment (ID: `keyterm:Judgment`); Authority (ID: `keyterm:Authority.2`); True (ID: `keyterm:True`); Bow Down (ID: `keyterm:BowDown`); Мегиддон (ID: `place:Megiddo`); Court Case (ID: `keyterm:CourtCase`); Demons (ID: `deity:Demons`); A Disembodied Voice (ID: `deity:Voice`); Talent (ID: `realia:Talent`); Frog (ID: `fauna:Frog`); Clothing (ID: `realia:Clothing`); Image (ID: `realia:Image`); Dragon (ID: `fauna:Dragon`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); Kingdom (ID: `keyterm:Kingdom`); Name (ID: `keyterm:Name`); Иисус (ID: `person:Jesus.2`); Fornication (ID: `keyterm:Fornication`); An Angel (ID: `deity:Angel`); Authority (ID: `keyterm:Authority.2`); Abomination (ID: `keyterm:Abomination`); Blood (ID: `keyterm:Blood`); Body (ID: `keyterm:Body.3`); Вавилон (ID: `place:Babylon`); Life (ID: `keyterm:Life`); Heart (ID: `keyterm:Heart`); Chosen (ID: `keyterm:Chosen`); Holy (ID: `keyterm:Holy`); Judgment (ID: `keyterm:Judgment`); LORD (ID: `deity:Lord`); Faithfulness (ID: `keyterm:Faithfulness`); Blaspheme (ID: `keyterm:Blaspheme`); Святой Дух (ID: `deity:HolySpirit`); Witness (ID: `keyterm:Witness`); Defilement (ID: `keyterm:Defilement`); Abyss (ID: `keyterm:Abyss`); Purple Cloth (ID: `realia:PurpleCloth`); Gold Jewelry (ID: `realia:GoldJewelry`); Bowl (ID: `realia:Bowl.2`); Scroll (ID: `realia:Scroll`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Life (ID: `keyterm:Life`); Sky (ID: `keyterm:Heaven`); Abyss (ID: `keyterm:Abyss`); Throne (ID: `realia:Throne`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Иисус (ID: `person:Jesus.2`); Hell (ID: `place:Hell`); Decided (ID: `keyterm:Decided`); Holy (ID: `keyterm:Holy`); LORD (ID: `deity:Lord`); Resurrection (ID: `keyterm:Resurrection`); сатана (ID: `deity:Satan`); Scroll (ID: `realia:Scroll`); Магог (ID: `place:Magog`); Gog (ID: `place:Gog`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); Happy (ID: `keyterm:Happy`); Always (ID: `keyterm:Always`); An Angel (ID: `deity:Angel`); Judgment (ID: `keyterm:Judgment`); Authority (ID: `keyterm:Authority.2`); Bow Down (ID: `keyterm:BowDown`); Bear Witness (ID: `keyterm:BearWitness`); Key (ID: `realia:Key`); Chain (ID: `realia:Chain`); Cornerstone (ID: `realia:Cornerstone`); Seal (ID: `realia:Seal`); Snake (ID: `fauna:Snake`); Image (ID: `realia:Image`); Prison (ID: `realia:Prison`); Dragon (ID: `fauna:Dragon`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Throne (ID: `realia:Throne`); Idolater (ID: `keyterm:Idolater`); Иерусалим (ID: `place:Jerusalem`); Be Unfaithful (ID: `keyterm:Unfaithful`); Holy (ID: `keyterm:Holy`); Faithfulness (ID: `keyterm:Faithfulness`); True (ID: `keyterm:True`); Life (ID: `keyterm:Life`); A Disembodied Voice (ID: `deity:Voice`); Tabernacle (ID: `realia:Tabernacle`)
...
* **Associated ACAI Concepts:** City Wall (ID: `realia:CityWall`); Temple (ID: `realia:Temple`); An Angel (ID: `deity:Angel`); Foundation (ID: `realia:Foundation`); Name (ID: `keyterm:Name`); Clean (ID: `keyterm:Clean`); LORD (ID: `deity:Lord`); Measuring Rod (ID: `realia:MeasuringRod`); Measuring Reed (ID: `realia:MeasuringReed`); Reed (ID: `flora:Reed`); Glory (ID: `keyterm:Glory`); Иерусалим (ID: `place:Jerusalem`); Израиль (ID: `person:Israel`); Sky (ID: `keyterm:Heaven`); Holy (ID: `keyterm:Holy`); Святой Дух (ID: `deity:HolySpirit`); Bowl (ID: `realia:Bowl.2`); Cubit (ID: `realia:Cubit.2`)
...
* **Associated ACAI Concepts:** Scroll (ID: `realia:Scroll`); LORD (ID: `deity:Lord`); Иисус (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); An Angel (ID: `deity:Angel`); Bear Witness (ID: `keyterm:BearWitness`); Happy (ID: `keyterm:Happy`); Holy (ID: `keyterm:Holy`); Bow Down (ID: `keyterm:BowDown`); Surely! (ID: `keyterm:Surely`); The Church (ID: `group:GenericChurch`); Ability (ID: `keyterm:Ability`); Idolater (ID: `keyterm:Idolater`); To Act Wickedly (ID: `keyterm:ActWickedly`); Authority (ID: `keyterm:Authority.2`); True (ID: `keyterm:True`); Давид (ID: `person:David`); Faithfulness (ID: `keyterm:Faithfulness`); To Command (ID: `keyterm:Command`); Favor (ID: `keyterm:Favor`); Святой Дух (ID: `deity:HolySpirit`); Consecration (ID: `keyterm:Consecration.2`); A Person (ID: `person:GenericPerson`); Spirit (ID: `keyterm:Spirit.2`); Friendship (ID: `keyterm:Friendship`); Иоанн (ID: `person:John.2`); Church (ID: `keyterm:Church`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Temple (ID: `realia:Temple`); Cloak (ID: `realia:Cloak`); Seal (ID: `realia:Seal`)
