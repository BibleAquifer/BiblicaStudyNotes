...
* **Associated ACAI Concepts:** Lampstand (ID: `realia:Lampstand.2`); Church (ID: `keyterm:Church`); Сардис (ID: `place:Sardis`); Лаодикия (ID: `place:Laodicea`); Пергам (ID: `place:Pergamum`); Ефес (ID: `place:Ephesus`); Патмос (ID: `place:Patmos`); Филадельфия (ID: `place:Philadelphia`); Смирна (ID: `place:Smyrna`); Bear Witness (ID: `keyterm:BearWitness`); Иоанн (ID: `person:John.2`); Kingdom (ID: `keyterm:Kingdom`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Always (ID: `keyterm:Always`); Hell (ID: `place:Hell`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Ability (ID: `keyterm:Ability`); LORD (ID: `deity:Lord`); Фиатира (ID: `place:Thyatira`); Life (ID: `keyterm:Life`); Святой Дух (ID: `deity:HolySpirit`); Иисус (ID: `person:Jesus.2`); Kiln (ID: `realia:Kiln`); Scroll (ID: `realia:Scroll`); Belt (ID: `realia:Belt`); Bag (ID: `realia:Bag`); Cloak (ID: `realia:Cloak`); Trumpet (ID: `realia:Trumpet`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); An Angel (ID: `deity:Angel`); Name (ID: `keyterm:Name`); Life (ID: `keyterm:Life`); Святой Дух (ID: `deity:HolySpirit`); Nicolaitans (ID: `group:Nicolaitans`); Repent (ID: `keyterm:Repent`); Faithfulness (ID: `keyterm:Faithfulness`); сатана (ID: `deity:Satan`); Lampstand (ID: `realia:Lampstand.2`); To Act Wickedly (ID: `keyterm:ActWickedly`); Пергам (ID: `place:Pergamum`); Ефес (ID: `place:Ephesus`); Антипа (ID: `person:Antipas`); Смирна (ID: `place:Smyrna`); Валак (ID: `person:Balak`); Blaspheme (ID: `keyterm:Blaspheme`); Witness (ID: `keyterm:Witness`); Fear (ID: `keyterm:Fear`); Stumbling Block (ID: `keyterm:StumblingBlock`); Fornication (ID: `keyterm:Fornication`); LORD (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Валаам (ID: `person:Balaam`); Paradise (ID: `keyterm:Paradise`); Jews (ID: `group:Jews`); Израиль (ID: `person:Israel`); Love (ID: `keyterm:Love`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); LORD (ID: `deity:Lord`); Fornication (ID: `keyterm:Fornication`); Repent (ID: `keyterm:Repent`); An Angel (ID: `deity:Angel`); Name (ID: `keyterm:Name`); Сардис (ID: `place:Sardis`); Фиатира (ID: `place:Thyatira`); Life (ID: `keyterm:Life`); Святой Дух (ID: `deity:HolySpirit`); Clothing (ID: `realia:Clothing`); Иезавель (ID: `person:Jezebel`); Heart (ID: `keyterm:Heart`); Authority (ID: `keyterm:Authority.2`); сатана (ID: `deity:Satan`); Ability (ID: `keyterm:Ability`); Defilement (ID: `keyterm:Defilement`); Believe (ID: `keyterm:Believe`); Spirit (ID: `keyterm:Spirit.2`); Love (ID: `keyterm:Love`); Serve (ID: `keyterm:Serve`); Rod (ID: `realia:Rod`); Scroll (ID: `realia:Scroll`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** Church (ID: `keyterm:Church`); LORD (ID: `deity:Lord`); True (ID: `keyterm:True`); An Angel (ID: `deity:Angel`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Святой Дух (ID: `deity:HolySpirit`); Door (ID: `realia:Door`); Лаодикия (ID: `place:Laodicea`); Friendship (ID: `keyterm:Friendship`); Филадельфия (ID: `place:Philadelphia`); Sky (ID: `keyterm:Heaven`); Repent (ID: `keyterm:Repent`); Witness (ID: `keyterm:Witness`); Давид (ID: `person:David`); Иерусалим (ID: `place:Jerusalem`); Faithfulness (ID: `keyterm:Faithfulness`); Pitiful (ID: `keyterm:Pitiful`); Bow Down (ID: `keyterm:BowDown`); сатана (ID: `deity:Satan`); Jews (ID: `group:Jews`); Surely! (ID: `keyterm:Surely`); Anointed (ID: `keyterm:Anointed`); Holy (ID: `keyterm:Holy`); Love (ID: `keyterm:Love`); Eye Salve (ID: `realia:EyeSalve`); Clothing (ID: `realia:Clothing`); Temple (ID: `realia:Temple`); Throne (ID: `realia:Throne`); Capital (ID: `realia:Capital`)
...
* **Associated ACAI Concepts:** Scroll (ID: `realia:Scroll`); Throne (ID: `realia:Throne`); Seal (ID: `realia:Seal`); LORD (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Bless (ID: `keyterm:Bless`); An Angel (ID: `deity:Angel`); Glory (ID: `keyterm:Glory`); First Living Creature (ID: `deity:FirstLivingCreature`); Fourth Living Creature (ID: `deity:FourthLivingCreature`); Bow Down (ID: `keyterm:BowDown`); Second Living Creature (ID: `deity:SecondLivingCreature`); Third Living Creature (ID: `deity:ThirdLivingCreature`); Spirit (ID: `keyterm:Spirit.2`); Proclaim (ID: `keyterm:Proclaim`); Kingdom (ID: `keyterm:Kingdom`); Давид (ID: `person:David`); Redeem (ID: `keyterm:Redeem`); Иуда (ID: `group:Judah`); Always (ID: `keyterm:Always`); Elders (ID: `group:GenericElders`); Ability (ID: `keyterm:Ability`); Pray (ID: `keyterm:Pray`); Blood (ID: `keyterm:Blood`); Иуда (ID: `person:Judah.4`); Surely! (ID: `keyterm:Surely`); Holy (ID: `keyterm:Holy`); Lion (ID: `fauna:Lion`); Incense (ID: `realia:Incense`); Bowl (ID: `realia:Bowl.2`); Lyre (ID: `realia:Lyre`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Throne (ID: `realia:Throne`); An Angel (ID: `deity:Angel`); Cloak (ID: `realia:Cloak`); To Act Wickedly (ID: `keyterm:ActWickedly`); Life (ID: `keyterm:Life`); Рувим (ID: `person:Reuben`); Иссахар (ID: `person:Issachar`); Неффалим (ID: `person:Naphtali`); Завулон (ID: `person:Zebulun`); Вениамин (ID: `person:Benjamin`); Priesthood (ID: `keyterm:Priesthood`); Рувим (ID: `group:Reuben`); Bless (ID: `keyterm:Bless`); Асир (ID: `group:Asher`); Иосиф (ID: `person:Joseph.10`); Иуда (ID: `group:Judah`); Always (ID: `keyterm:Always`); Симеон (ID: `group:Simeon`); Завулон (ID: `group:Zebulun`); Левий (ID: `group:Levi`); Гад (ID: `person:Gad`); Bow Down (ID: `keyterm:BowDown`); Ability (ID: `keyterm:Ability`); Манассия (ID: `person:Manasseh`); Левий (ID: `person:Levi.3`); Симеон (ID: `person:Simeon.5`); Blood (ID: `keyterm:Blood`); Иссахар (ID: `group:Issachar`); Salvation (ID: `keyterm:Salvation`); Иуда (ID: `person:Judah.4`); Манассия (ID: `group:Manasseh`); Вениамин (ID: `group:Benjamin`); Surely! (ID: `keyterm:Surely`); Израиль (ID: `person:Israel`); Glory (ID: `keyterm:Glory`); Асир (ID: `person:Asher`); Serve (ID: `keyterm:Serve`); Date Palm (ID: `flora:DatePalm`); Seal (ID: `realia:Seal`); Temple (ID: `realia:Temple`); Cornerstone (ID: `realia:Cornerstone`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Ability (ID: `keyterm:Ability`); Temple (ID: `realia:Temple`); Witness (ID: `keyterm:Witness`); To Act Wickedly (ID: `keyterm:ActWickedly`); Bear Witness (ID: `keyterm:BearWitness`); Offering (ID: `keyterm:Offering`); Authority (ID: `keyterm:Authority.2`); Abyss (ID: `keyterm:Abyss`); Spirit (ID: `keyterm:Spirit.2`); A Disembodied Voice (ID: `deity:Voice`); Fear (ID: `keyterm:Fear`); Египет (ID: `place:Egypt`); Disaster (ID: `keyterm:Disaster`); Содом (ID: `place:Sodom`); Name (ID: `keyterm:Name`); Bow Down (ID: `keyterm:BowDown`); Gentiles (ID: `group:Gentile`); Life (ID: `keyterm:Life`); Blood (ID: `keyterm:Blood`); Иисус (ID: `person:Jesus.2`); Speak as a Prophet (ID: `keyterm:Speak`); Holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); Measuring Rod (ID: `realia:MeasuringRod`); Measuring Reed (ID: `realia:MeasuringReed`); Staff (ID: `realia:Staff`); Cross (ID: `realia:Cross`); Sackcloth (ID: `realia:Sackcloth`); Grave (ID: `realia:Grave`); Reed (ID: `flora:Reed`); Lampstand (ID: `realia:Lampstand.2`); Courtyard (ID: `realia:Courtyard`); Olive Tree (ID: `flora:OliveTree`); Sheepfold (ID: `realia:Sheepfold`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Ability (ID: `keyterm:Ability`); Kingdom (ID: `keyterm:Kingdom`); Name (ID: `keyterm:Name`); Bow Down (ID: `keyterm:BowDown`); Fear (ID: `keyterm:Fear`); Иисус (ID: `person:Jesus.2`); Decided (ID: `keyterm:Decided`); An Angel (ID: `deity:Angel`); Covenant (ID: `keyterm:Covenant`); Holy (ID: `keyterm:Holy`); Always (ID: `keyterm:Always`); Temple (ID: `realia:Temple`); Trumpet (ID: `realia:Trumpet`); Throne (ID: `realia:Throne`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`)
...
* **Associated ACAI Concepts:** Sky (ID: `keyterm:Heaven`); Dragon (ID: `fauna:Dragon`); LORD (ID: `deity:Lord`); Snake (ID: `fauna:Snake`); Bear Witness (ID: `keyterm:BearWitness`); Symbol (ID: `keyterm:Example`); An Angel (ID: `deity:Angel`); Ability (ID: `keyterm:Ability`); Иисус (ID: `person:Jesus.2`); Crown (ID: `realia:Crown`); Михаил (ID: `person:Michael.11`); Authority (ID: `keyterm:Authority.2`); A Disembodied Voice (ID: `deity:Voice`); Kingdom (ID: `keyterm:Kingdom`); Commandment (ID: `keyterm:Commandment`); Disaster (ID: `keyterm:Disaster`); сатана (ID: `deity:Satan`); Life (ID: `keyterm:Life`); Blood (ID: `keyterm:Blood`); Salvation (ID: `keyterm:Salvation`); Love (ID: `keyterm:Love`); Rod (ID: `realia:Rod`); Crown (ID: `realia:Crown.2`); Vulture (ID: `fauna:Vulture`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Redeem (ID: `keyterm:Redeem`); LORD (ID: `deity:Lord`); Unblemished (ID: `keyterm:Unblemished`); Name (ID: `keyterm:Name`); Sky (ID: `keyterm:Heaven`); Иерусалим (ID: `place:Jerusalem`); Defilement (ID: `keyterm:Defilement`); Lyre (ID: `realia:Lyre`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** An Angel (ID: `deity:Angel`); LORD (ID: `deity:Lord`); Bow Down (ID: `keyterm:BowDown`); Sky (ID: `keyterm:Heaven`); Always (ID: `keyterm:Always`); Holy (ID: `keyterm:Holy`); Wine (ID: `realia:Wine`); Image (ID: `realia:Image`); Вавилон (ID: `place:Babylon`); Court Case (ID: `keyterm:CourtCase`); Happy (ID: `keyterm:Happy`); A Disembodied Voice (ID: `deity:Voice`); Good News (ID: `keyterm:GoodNews`); Fear (ID: `keyterm:Fear`); Commandment (ID: `keyterm:Commandment`); Midheaven (ID: `keyterm:Midheaven`); Name (ID: `keyterm:Name`); Fornication (ID: `keyterm:Fornication`); Believe (ID: `keyterm:Believe`); Святой Дух (ID: `deity:HolySpirit`); Иисус (ID: `person:Jesus.2`); Judgment (ID: `keyterm:Judgment`); Glory (ID: `keyterm:Glory`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Bowl (ID: `realia:Bowl.2`); Blaspheme (ID: `keyterm:Blaspheme`); Blood (ID: `keyterm:Blood`); Sky (ID: `keyterm:Heaven`); Repent (ID: `keyterm:Repent`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); Ability (ID: `keyterm:Ability`); Temple (ID: `realia:Temple`); Throne (ID: `realia:Throne`); Евфрат (ID: `place:Euphrates`); Authority (ID: `keyterm:Authority.2`); Вавилон (ID: `place:Babylon`); True (ID: `keyterm:True`); Court Case (ID: `keyterm:CourtCase`); Happy (ID: `keyterm:Happy`); A Disembodied Voice (ID: `deity:Voice`); Symbol (ID: `keyterm:Example`); Мегиддон (ID: `place:Megiddo`); Kingdom (ID: `keyterm:Kingdom`); Decided (ID: `keyterm:Decided`); Demons (ID: `deity:Demons`); Name (ID: `keyterm:Name`); Bow Down (ID: `keyterm:BowDown`); Life (ID: `keyterm:Life`); Judgment (ID: `keyterm:Judgment`); Holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); Talent (ID: `realia:Talent`); Frog (ID: `fauna:Frog`); Dragon (ID: `fauna:Dragon`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** Kingdom (ID: `keyterm:Kingdom`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Authority (ID: `keyterm:Authority.2`); Abomination (ID: `keyterm:Abomination`); An Angel (ID: `deity:Angel`); Fornication (ID: `keyterm:Fornication`); Иисус (ID: `person:Jesus.2`); Heart (ID: `keyterm:Heart`); Blaspheme (ID: `keyterm:Blaspheme`); Вавилон (ID: `place:Babylon`); Abyss (ID: `keyterm:Abyss`); Witness (ID: `keyterm:Witness`); Faithfulness (ID: `keyterm:Faithfulness`); Chosen (ID: `keyterm:Chosen`); LORD (ID: `deity:Lord`); Body (ID: `keyterm:Body.3`); Defilement (ID: `keyterm:Defilement`); Life (ID: `keyterm:Life`); Blood (ID: `keyterm:Blood`); Святой Дух (ID: `deity:HolySpirit`); Judgment (ID: `keyterm:Judgment`); Holy (ID: `keyterm:Holy`); Wine (ID: `realia:Wine`); Purple Cloth (ID: `realia:PurpleCloth`); Gold Jewelry (ID: `realia:GoldJewelry`); Scroll (ID: `realia:Scroll`); Bowl (ID: `realia:Bowl.2`)
...
* **Associated ACAI Concepts:** Horse (ID: `fauna:Horse`); Name (ID: `keyterm:Name`); LORD (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Body (ID: `keyterm:Body.3`); Cloak (ID: `realia:Cloak`); Bird (ID: `fauna:Bird`); Rooster (ID: `fauna:Rooster`); True (ID: `keyterm:True`); Symbol (ID: `keyterm:Example`); Decided (ID: `keyterm:Decided`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); Midheaven (ID: `keyterm:Midheaven`); Faithfulness (ID: `keyterm:Faithfulness`); Bow Down (ID: `keyterm:BowDown`); Life (ID: `keyterm:Life`); Clean (ID: `keyterm:Clean`); Blood (ID: `keyterm:Blood`); Иисус (ID: `person:Jesus.2`); Wine (ID: `realia:Wine`); Winepress (ID: `realia:Winepress`); Image (ID: `realia:Image`); Rod (ID: `realia:Rod`); Linen (ID: `realia:Linen`); Crown (ID: `realia:Crown`)
...
* **Associated ACAI Concepts:** Life (ID: `keyterm:Life`); Sky (ID: `keyterm:Heaven`); Abyss (ID: `keyterm:Abyss`); Throne (ID: `realia:Throne`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Decided (ID: `keyterm:Decided`); Hell (ID: `place:Hell`); сатана (ID: `deity:Satan`); LORD (ID: `deity:Lord`); Resurrection (ID: `keyterm:Resurrection`); Иисус (ID: `person:Jesus.2`); Holy (ID: `keyterm:Holy`); Scroll (ID: `realia:Scroll`); Gog (ID: `place:Gog`); Магог (ID: `place:Magog`); Bear Witness (ID: `keyterm:BearWitness`); Authority (ID: `keyterm:Authority.2`); Happy (ID: `keyterm:Happy`); An Angel (ID: `deity:Angel`); Always (ID: `keyterm:Always`); Bow Down (ID: `keyterm:BowDown`); Ability (ID: `keyterm:Ability`); Judgment (ID: `keyterm:Judgment`); Love (ID: `keyterm:Love`); Chain (ID: `realia:Chain`); Key (ID: `realia:Key`); Seal (ID: `realia:Seal`); Dragon (ID: `fauna:Dragon`); Prison (ID: `realia:Prison`); Image (ID: `realia:Image`); Snake (ID: `fauna:Snake`); Cornerstone (ID: `realia:Cornerstone`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Throne (ID: `realia:Throne`); Idolater (ID: `keyterm:Idolater`); True (ID: `keyterm:True`); Faithfulness (ID: `keyterm:Faithfulness`); Holy (ID: `keyterm:Holy`); Иерусалим (ID: `place:Jerusalem`); A Disembodied Voice (ID: `deity:Voice`); Life (ID: `keyterm:Life`); Be Unfaithful (ID: `keyterm:Unfaithful`); Tabernacle (ID: `realia:Tabernacle`)
...
* **Associated ACAI Concepts:** City Wall (ID: `realia:CityWall`); Temple (ID: `realia:Temple`); An Angel (ID: `deity:Angel`); Foundation (ID: `realia:Foundation`); Name (ID: `keyterm:Name`); Clean (ID: `keyterm:Clean`); LORD (ID: `deity:Lord`); Measuring Rod (ID: `realia:MeasuringRod`); Measuring Reed (ID: `realia:MeasuringReed`); Reed (ID: `flora:Reed`); Sky (ID: `keyterm:Heaven`); Святой Дух (ID: `deity:HolySpirit`); Израиль (ID: `person:Israel`); Иерусалим (ID: `place:Jerusalem`); Holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); Bowl (ID: `realia:Bowl.2`); Cubit (ID: `realia:Cubit.2`)
...
* **Associated ACAI Concepts:** Scroll (ID: `realia:Scroll`); LORD (ID: `deity:Lord`); Bear Witness (ID: `keyterm:BearWitness`); An Angel (ID: `deity:Angel`); Life (ID: `keyterm:Life`); Иисус (ID: `person:Jesus.2`); Happy (ID: `keyterm:Happy`); Bow Down (ID: `keyterm:BowDown`); Holy (ID: `keyterm:Holy`); The Church (ID: `group:GenericChurch`); Surely! (ID: `keyterm:Surely`); To Act Wickedly (ID: `keyterm:ActWickedly`); Authority (ID: `keyterm:Authority.2`); A Person (ID: `person:GenericPerson`); To Command (ID: `keyterm:Command`); True (ID: `keyterm:True`); Friendship (ID: `keyterm:Friendship`); Иоанн (ID: `person:John.2`); Давид (ID: `person:David`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Faithfulness (ID: `keyterm:Faithfulness`); Favor (ID: `keyterm:Favor`); Idolater (ID: `keyterm:Idolater`); Ability (ID: `keyterm:Ability`); Святой Дух (ID: `deity:HolySpirit`); Consecration (ID: `keyterm:Consecration.2`); Church (ID: `keyterm:Church`); Spirit (ID: `keyterm:Spirit.2`); Seal (ID: `realia:Seal`); Temple (ID: `realia:Temple`); Cloak (ID: `realia:Cloak`)
