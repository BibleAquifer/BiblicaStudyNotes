...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Ханаан (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Израиль (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Иисус (ID: `person:Joshua.2`); Халев (ID: `person:Caleb`); Force to Serve (ID: `keyterm:EnticedToServe`); Bethel (ID: `place:Bethel`); Amorites (ID: `group:Amorites`); Adoni-bezek (ID: `person:Adoni-bezek`); Иосиф (ID: `person:Joseph.10`); Perizzites (ID: `group:Perizzites`); Моисей (ID: `person:Moses`); юг (ID: `place:Negeb`); Covenant (ID: `keyterm:Covenant`); Иерусалим (ID: `place:Jerusalem`); Везек (ID: `place:Bezek`); Ахсf (ID: `person:Achsah`); Асир (ID: `group:Asher`); Ваал (ID: `deity:Baal`); Jebusites (ID: `group:Jebusites`); To Cause to Possess (ID: `keyterm:Possess`); Египет (ID: `place:Egypt`); Симеон (ID: `group:Simeon`); Симеон (ID: `person:Simeon.5`); Хеврон (ID: `place:Hebron`); Девир (ID: `place:Debir`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Сисара (ID: `person:Sisera`); Варак (ID: `person:Barak`); Девора (ID: `person:Deborah.2`); Егуд (ID: `person:Ehud`); Иаили (ID: `person:Jael`); Моав (ID: `place:Moab`); Иавин (ID: `person:Jabin.2`); Хевер (ID: `person:Heber.2`); Авиноамов (ID: `person:Abinoam`); Еглон (ID: `person:Eglon`); Chariot (ID: `realia:Chariot`); Tent (ID: `realia:Tent`); Кедес (ID: `place:Kedesh`); Завулон (ID: `person:Zebulun`); Ханаан (ID: `place:Canaan`); Завулон (ID: `group:Zebulun`); Sword (ID: `realia:Sword`); Harosheth-hagoyim (ID: `place:Harosheth-hagoyim`); Mount Tabor (ID: `place:TaborMount`); Киссон (ID: `place:Kishon`); Kenites (ID: `group:Kenite`); Force to Serve (ID: `keyterm:EnticedToServe`); Неффалим (ID: `person:Naphtali`); Неффалим (ID: `group:Naphtali`); Offering (ID: `keyterm:Offering`); Bless (ID: `keyterm:Bless`); Ефрем (ID: `group:Ephraim`); Ефрем (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Гедеон (ID: `person:Gideon`); LORD (ID: `deity:Lord`); Авимелех (ID: `person:Abimelech.2`); Мадиан (ID: `place:Midian`); Израиль (ID: `person:Israel`); Шехем (ID: `place:Shechem`); Гаал (ID: `person:Gaal`); Иоас (ID: `person:Joash`); Салмана (ID: `person:Zalmunna`); Зевей (ID: `person:Zebah`); An Angel (ID: `deity:Angel`); Офра (ID: `place:Ophrah.2`); Зевул (ID: `person:Zebul`); Евед (ID: `person:Ebed`); Ваал (ID: `deity:Baal`); Сокхоф (ID: `place:Succoth`); Fear (ID: `keyterm:Fear`); Евиезер (ID: `person:Abiezer`); Иофам (ID: `person:Jotham`); Asherah (ID: `deity:Asherah`); восток (ID: `place:East`); Tower (ID: `realia:Tower`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Rams Horn (ID: `realia:RamsHorn`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); House (ID: `realia:House`); Abiezrites (ID: `group:Abiezer`); Египет (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** Израиль (ID: `person:Israel`); Аммон (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Иеффай (ID: `person:Jephthah`); LORD (ID: `deity:Lord`); Галаад (ID: `place:Gilead`); Ефрем (ID: `group:Ephraim`); Ефрем (ID: `person:Ephraim`); Jordan River (ID: `place:Jordan`); Amorites (ID: `group:Amorites`); Моав (ID: `place:Moab`); An Angel (ID: `deity:Angel`); Арнон (ID: `place:Arnon`); Mizpah (ID: `place:Mizpah.2`); Force to Serve (ID: `keyterm:EnticedToServe`); Gileadites (ID: `group:Gilead`); Dispossess (ID: `keyterm:Dispossess`); Египет (ID: `place:Egypt`); Филистимлянин (ID: `group:Philistine`); Филистимской (ID: `place:Philistine`); Сигон (ID: `person:Sihon`); To Sin (ID: `keyterm:Sin`); Галаад (ID: `person:Gilead.2`); Авдон (ID: `person:Abdon`); Гиллел (ID: `person:Hillel`); Шамир (ID: `place:Shamir.2`); Иаир (ID: `person:Jair.3`); Елон (ID: `person:Elon.3`); Есевон (ID: `person:Ibzan`); Завулон (ID: `group:Zebulun`)
...
* **Associated ACAI Concepts:** Самсон (ID: `person:Samson`); LORD (ID: `deity:Lord`); Филистимлянин (ID: `group:Philistine`); Филистимской (ID: `place:Philistine`); Маной (ID: `person:Manoah`); An Angel (ID: `deity:Angel`); Далида (ID: `person:Delilah`); Strength (ID: `keyterm:Strength`); Израиль (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Цора (ID: `place:Zorah`); Лехий (ID: `place:Lehi`); Nazirites (ID: `group:Nazirite`); Offering (ID: `keyterm:Offering`); Газа (ID: `place:Gaza`); Иуда (ID: `group:Judah`); Defilement (ID: `keyterm:Defilement`); Иуда (ID: `person:Judah.4`); Фимна (ID: `place:Timnah`); Love (ID: `keyterm:Love`); Goat (ID: `fauna:Goat`); Lion (ID: `fauna:Lion`); Rope (ID: `realia:Rope`); Kid (ID: `fauna:Kid`); Manoah's Wife (ID: `person:WifeOfManoah`); Етам (ID: `place:Etam`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Естаол (ID: `place:Eshtaol`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Миха (ID: `person:Micah.3`); Дан (ID: `place:Dan`); Дан (ID: `group:Dan`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); терафим (ID: `deity:Teraphim`); Graven Image (ID: `realia:GravenImage`); Household Idols (ID: `realia:HouseholdIdols`); Molten Image (ID: `realia:MoltenImage`); Ephod (ID: `realia:Ephod`); Ефрем (ID: `person:Ephraim`); Ефрем (ID: `group:Ephraim`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Израиль (ID: `person:Israel`); Естаол (ID: `place:Eshtaol`); Money (ID: `realia:Money`); A Person (ID: `person:GenericPerson`); Trust (ID: `keyterm:LeanOn`); Цора (ID: `place:Zorah`); Вифлеем (ID: `place:Bethlehem`); Mother of Micah (ID: `person:MotherOfMicah.3`); Сидон (ID: `place:Sidon`); Peace (ID: `keyterm:IntactState`); Dispossess (ID: `keyterm:Dispossess`); Mahaneh-dan (ID: `place:Mahaneh-dan`); Gershom (ID: `person:Gershom`); Military Members (ID: `group:MilitaryMembers`); Ионафан (ID: `person:Jonathan.2`); Beth-rehob (ID: `place:Beth-rehob`); To Cause to Possess (ID: `keyterm:Possess`); Kiriath-jearim (ID: `place:Kiriath-jearim`); To Curse (ID: `keyterm:Curse`); Bless (ID: `keyterm:Bless`); Силом (ID: `place:Shiloh`); Моисей (ID: `person:Moses`); Safety (ID: `keyterm:Safety`); Holy (ID: `keyterm:Holy`); Sidonians (ID: `group:Sidon`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** Израиль (ID: `person:Israel`); Вениамин (ID: `group:Benjamin`); Вениамин (ID: `person:Benjamin`); Gibeah (ID: `place:Gibeah.2`); LORD (ID: `deity:Lord`); Иавис Галаадский (ID: `place:Jabesh-gilead`); Массифа (ID: `place:Mizpah`); Bethel (ID: `place:Bethel`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); To Cause to Possess (ID: `keyterm:Possess`); A Father (ID: `person:GenericFather`); Иуда (ID: `group:Judah`); Foolish (ID: `keyterm:Foolish`); Иуда (ID: `person:Judah.4`); Donkey (ID: `fauna:Donkey`); Rock of Rimmon (ID: `place:Rimmon.3`); Ефрем (ID: `person:Ephraim`); Ефрем (ID: `group:Ephraim`); Swear (ID: `keyterm:Swear`); Силом (ID: `place:Shiloh`); Вифлеем (ID: `place:Bethlehem`); Offering (ID: `keyterm:Offering`); A Man (ID: `person:GenericMale`); Иерусалим (ID: `place:Jerusalem`); Левий (ID: `group:Levi`); Wickedness (ID: `keyterm:Wickedness`); Левий (ID: `person:Levi.3`); Peace (ID: `keyterm:IntactState`); Vine (ID: `flora:Vine`)
