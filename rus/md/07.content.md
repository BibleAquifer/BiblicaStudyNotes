...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Ханаан (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Израиль (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Иисус (ID: `person:Joshua.2`); Халев (ID: `person:Caleb`); Force to Serve (ID: `keyterm:EnticedToServe`); Bethel (ID: `place:Bethel`); Amorites (ID: `group:Amorites`); Adoni-bezek (ID: `person:Adoni-bezek`); Моисей (ID: `person:Moses`); Иосиф (ID: `person:Joseph.10`); Covenant (ID: `keyterm:Covenant`); юг (ID: `place:Negeb`); Perizzites (ID: `group:Perizzites`); Иерусалим (ID: `place:Jerusalem`); Везек (ID: `place:Bezek`); Ахсf (ID: `person:Achsah`); Ваал (ID: `deity:Baal`); Асир (ID: `group:Asher`); Jebusites (ID: `group:Jebusites`); Египет (ID: `place:Egypt`); Hittites (ID: `group:Hittite`); To Cause to Possess (ID: `keyterm:Possess`); Swear (ID: `keyterm:Swear`); Асир (ID: `person:Asher`); Hivites (ID: `group:Hivites`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Сисара (ID: `person:Sisera`); Варак (ID: `person:Barak`); Девора (ID: `person:Deborah.2`); Егуд (ID: `person:Ehud`); Иаили (ID: `person:Jael`); Моав (ID: `place:Moab`); Иавин (ID: `person:Jabin.2`); Хевер (ID: `person:Heber.2`); Авиноамов (ID: `person:Abinoam`); Еглон (ID: `person:Eglon`); Chariot (ID: `realia:Chariot`); Tent (ID: `realia:Tent`); Ханаан (ID: `place:Canaan`); Завулон (ID: `group:Zebulun`); Завулон (ID: `person:Zebulun`); Кедес (ID: `place:Kedesh`); Sword (ID: `realia:Sword`); Harosheth-hagoyim (ID: `place:Harosheth-hagoyim`); Киссон (ID: `place:Kishon`); Mount Tabor (ID: `place:TaborMount`); Kenites (ID: `group:Kenite`); Offering (ID: `keyterm:Offering`); Ефрем (ID: `person:Ephraim`); Неффалим (ID: `group:Naphtali`); Неффалим (ID: `person:Naphtali`); Bless (ID: `keyterm:Bless`); Force to Serve (ID: `keyterm:EnticedToServe`); Ефрем (ID: `group:Ephraim`)
...
* **Associated ACAI Concepts:** Израиль (ID: `person:Israel`); Аммон (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Иеффай (ID: `person:Jephthah`); LORD (ID: `deity:Lord`); Галаад (ID: `place:Gilead`); Ефрем (ID: `group:Ephraim`); Ефрем (ID: `person:Ephraim`); Jordan River (ID: `place:Jordan`); Amorites (ID: `group:Amorites`); An Angel (ID: `deity:Angel`); Моав (ID: `place:Moab`); Арнон (ID: `place:Arnon`); Mizpah (ID: `place:Mizpah.2`); Gileadites (ID: `group:Gilead`); Dispossess (ID: `keyterm:Dispossess`); Force to Serve (ID: `keyterm:EnticedToServe`); Филистимлянин (ID: `group:Philistine`); Египет (ID: `place:Egypt`); To Sin (ID: `keyterm:Sin`); Филистимской (ID: `place:Philistine`); Сигон (ID: `person:Sihon`); Есевон (ID: `person:Ibzan`); Гиллел (ID: `person:Hillel`); Завулон (ID: `group:Zebulun`); Иаир (ID: `person:Jair.3`); Елон (ID: `person:Elon.3`); Авдон (ID: `person:Abdon`); Шамир (ID: `place:Shamir.2`); Галаад (ID: `person:Gilead.2`)
...
* **Associated ACAI Concepts:** Самсон (ID: `person:Samson`); LORD (ID: `deity:Lord`); Филистимской (ID: `place:Philistine`); Филистимлянин (ID: `group:Philistine`); Маной (ID: `person:Manoah`); An Angel (ID: `deity:Angel`); Далида (ID: `person:Delilah`); Strength (ID: `keyterm:Strength`); Израиль (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Цора (ID: `place:Zorah`); Лехий (ID: `place:Lehi`); Nazirites (ID: `group:Nazirite`); Love (ID: `keyterm:Love`); Defilement (ID: `keyterm:Defilement`); Иуда (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); Иуда (ID: `group:Judah`); Газа (ID: `place:Gaza`); Фимна (ID: `place:Timnah`); Goat (ID: `fauna:Goat`); Rope (ID: `realia:Rope`); Kid (ID: `fauna:Kid`); Lion (ID: `fauna:Lion`); Етам (ID: `place:Etam`); Manoah's Wife (ID: `person:WifeOfManoah`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Естаол (ID: `place:Eshtaol`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Миха (ID: `person:Micah.3`); Дан (ID: `place:Dan`); Дан (ID: `group:Dan`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); терафим (ID: `deity:Teraphim`); Graven Image (ID: `realia:GravenImage`); Household Idols (ID: `realia:HouseholdIdols`); Molten Image (ID: `realia:MoltenImage`); Ephod (ID: `realia:Ephod`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Израиль (ID: `person:Israel`); Ефрем (ID: `person:Ephraim`); Ефрем (ID: `group:Ephraim`); Естаол (ID: `place:Eshtaol`); Money (ID: `realia:Money`); Trust (ID: `keyterm:LeanOn`); Вифлеем (ID: `place:Bethlehem`); Цора (ID: `place:Zorah`); A Person (ID: `person:GenericPerson`); Mother of Micah (ID: `person:MotherOfMicah.3`); Dispossess (ID: `keyterm:Dispossess`); Сидон (ID: `place:Sidon`); Peace (ID: `keyterm:IntactState`); Military Members (ID: `group:MilitaryMembers`); Mahaneh-dan (ID: `place:Mahaneh-dan`); Ионафан (ID: `person:Jonathan.2`); Gershom (ID: `person:Gershom`); Beth-rehob (ID: `place:Beth-rehob`); Sidonians (ID: `group:Sidon`); Safety (ID: `keyterm:Safety`); Силом (ID: `place:Shiloh`); To Curse (ID: `keyterm:Curse`); Моисей (ID: `person:Moses`); Holy (ID: `keyterm:Holy`); Kiriath-jearim (ID: `place:Kiriath-jearim`); To Cause to Possess (ID: `keyterm:Possess`); Bless (ID: `keyterm:Bless`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** Израиль (ID: `person:Israel`); Вениамин (ID: `group:Benjamin`); Вениамин (ID: `person:Benjamin`); Gibeah (ID: `place:Gibeah.2`); LORD (ID: `deity:Lord`); Иавис Галаадский (ID: `place:Jabesh-gilead`); Массифа (ID: `place:Mizpah`); Bethel (ID: `place:Bethel`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); A Father (ID: `person:GenericFather`); Иуда (ID: `person:Judah.4`); Foolish (ID: `keyterm:Foolish`); Иуда (ID: `group:Judah`); To Cause to Possess (ID: `keyterm:Possess`); Donkey (ID: `fauna:Donkey`); Rock of Rimmon (ID: `place:Rimmon.3`); Силом (ID: `place:Shiloh`); Вифлеем (ID: `place:Bethlehem`); Ефрем (ID: `person:Ephraim`); Ефрем (ID: `group:Ephraim`); Swear (ID: `keyterm:Swear`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Иерусалим (ID: `place:Jerusalem`); A Man (ID: `person:GenericMale`); Wickedness (ID: `keyterm:Wickedness`); Offering (ID: `keyterm:Offering`); Peace (ID: `keyterm:IntactState`); Vine (ID: `flora:Vine`)
