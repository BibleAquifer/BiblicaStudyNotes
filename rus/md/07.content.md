...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Ханаан (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Израиль (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Иисус (ID: `person:Joshua.2`); Халев (ID: `person:Caleb`); Force to Serve (ID: `keyterm:EnticedToServe`); Amorites (ID: `group:Amorites`); Bethel (ID: `place:Bethel`); Adoni-bezek (ID: `person:Adoni-bezek`); Моисей (ID: `person:Moses`); Иерусалим (ID: `place:Jerusalem`); Perizzites (ID: `group:Perizzites`); юг (ID: `place:Negeb`); Иосиф (ID: `person:Joseph.10`); Covenant (ID: `keyterm:Covenant`); Везек (ID: `place:Bezek`); Ахсf (ID: `person:Achsah`); Асир (ID: `group:Asher`); Ваал (ID: `deity:Baal`); To Cause to Possess (ID: `keyterm:Possess`); Hivites (ID: `group:Hivites`); Хеврон (ID: `place:Hebron`); Jebusites (ID: `group:Jebusites`); Сидон (ID: `place:Sidon`); An Angel (ID: `deity:Angel`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Сисара (ID: `person:Sisera`); Варак (ID: `person:Barak`); Девора (ID: `person:Deborah.2`); Егуд (ID: `person:Ehud`); Иаили (ID: `person:Jael`); Моав (ID: `place:Moab`); Иавин (ID: `person:Jabin.2`); Авиноамов (ID: `person:Abinoam`); Хевер (ID: `person:Heber.2`); Еглон (ID: `person:Eglon`); Tent (ID: `realia:Tent`); Chariot (ID: `realia:Chariot`); Завулон (ID: `group:Zebulun`); Завулон (ID: `person:Zebulun`); Ханаан (ID: `place:Canaan`); Кедес (ID: `place:Kedesh`); Sword (ID: `realia:Sword`); Harosheth-hagoyim (ID: `place:Harosheth-hagoyim`); Mount Tabor (ID: `place:TaborMount`); Киссон (ID: `place:Kishon`); Kenites (ID: `group:Kenite`); Force to Serve (ID: `keyterm:EnticedToServe`); Неффалим (ID: `person:Naphtali`); Offering (ID: `keyterm:Offering`); Неффалим (ID: `group:Naphtali`); Bless (ID: `keyterm:Bless`); Ефрем (ID: `group:Ephraim`); Ефрем (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Израиль (ID: `person:Israel`); Аммон (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Иеффай (ID: `person:Jephthah`); LORD (ID: `deity:Lord`); Галаад (ID: `place:Gilead`); Ефрем (ID: `group:Ephraim`); Ефрем (ID: `person:Ephraim`); Amorites (ID: `group:Amorites`); Jordan River (ID: `place:Jordan`); Моав (ID: `place:Moab`); An Angel (ID: `deity:Angel`); Арнон (ID: `place:Arnon`); Mizpah (ID: `place:Mizpah.2`); Force to Serve (ID: `keyterm:EnticedToServe`); Dispossess (ID: `keyterm:Dispossess`); Gileadites (ID: `group:Gilead`); Филистимской (ID: `place:Philistine`); To Sin (ID: `keyterm:Sin`); Сигон (ID: `person:Sihon`); Филистимлянин (ID: `group:Philistine`); Египет (ID: `place:Egypt`); Завулон (ID: `group:Zebulun`); Шамир (ID: `place:Shamir.2`); Гиллел (ID: `person:Hillel`); Есевон (ID: `person:Ibzan`); Галаад (ID: `person:Gilead.2`); Авдон (ID: `person:Abdon`); Иаир (ID: `person:Jair.3`); Елон (ID: `person:Elon.3`)
...
* **Associated ACAI Concepts:** Самсон (ID: `person:Samson`); LORD (ID: `deity:Lord`); Филистимской (ID: `place:Philistine`); Филистимлянин (ID: `group:Philistine`); Маной (ID: `person:Manoah`); An Angel (ID: `deity:Angel`); Далида (ID: `person:Delilah`); Strength (ID: `keyterm:Strength`); Израиль (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Цора (ID: `place:Zorah`); Лехий (ID: `place:Lehi`); Nazirites (ID: `group:Nazirite`); Love (ID: `keyterm:Love`); Газа (ID: `place:Gaza`); Фимна (ID: `place:Timnah`); Иуда (ID: `group:Judah`); Defilement (ID: `keyterm:Defilement`); Иуда (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); Lion (ID: `fauna:Lion`); Rope (ID: `realia:Rope`); Goat (ID: `fauna:Goat`); Kid (ID: `fauna:Kid`); Manoah's Wife (ID: `person:WifeOfManoah`); Етам (ID: `place:Etam`); Естаол (ID: `place:Eshtaol`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Миха (ID: `person:Micah.3`); Дан (ID: `place:Dan`); Дан (ID: `group:Dan`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); терафим (ID: `deity:Teraphim`); Graven Image (ID: `realia:GravenImage`); Molten Image (ID: `realia:MoltenImage`); Household Idols (ID: `realia:HouseholdIdols`); Ephod (ID: `realia:Ephod`); Ефрем (ID: `group:Ephraim`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Ефрем (ID: `person:Ephraim`); Израиль (ID: `person:Israel`); Естаол (ID: `place:Eshtaol`); Money (ID: `realia:Money`); A Person (ID: `person:GenericPerson`); Цора (ID: `place:Zorah`); Вифлеем (ID: `place:Bethlehem`); Trust (ID: `keyterm:LeanOn`); Mother of Micah (ID: `person:MotherOfMicah.3`); Dispossess (ID: `keyterm:Dispossess`); Peace (ID: `keyterm:IntactState`); Сидон (ID: `place:Sidon`); Military Members (ID: `group:MilitaryMembers`); Mahaneh-dan (ID: `place:Mahaneh-dan`); Beth-rehob (ID: `place:Beth-rehob`); Ионафан (ID: `person:Jonathan.2`); Gershom (ID: `person:Gershom`); To Cause to Possess (ID: `keyterm:Possess`); To Curse (ID: `keyterm:Curse`); Силом (ID: `place:Shiloh`); Bless (ID: `keyterm:Bless`); Моисей (ID: `person:Moses`); Safety (ID: `keyterm:Safety`); Kiriath-jearim (ID: `place:Kiriath-jearim`); Holy (ID: `keyterm:Holy`); Sidonians (ID: `group:Sidon`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** Израиль (ID: `person:Israel`); Вениамин (ID: `group:Benjamin`); Вениамин (ID: `person:Benjamin`); Gibeah (ID: `place:Gibeah.2`); LORD (ID: `deity:Lord`); Иавис Галаадский (ID: `place:Jabesh-gilead`); Массифа (ID: `place:Mizpah`); Bethel (ID: `place:Bethel`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); To Cause to Possess (ID: `keyterm:Possess`); Foolish (ID: `keyterm:Foolish`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); A Father (ID: `person:GenericFather`); Donkey (ID: `fauna:Donkey`); Rock of Rimmon (ID: `place:Rimmon.3`); Swear (ID: `keyterm:Swear`); Силом (ID: `place:Shiloh`); Вифлеем (ID: `place:Bethlehem`); Ефрем (ID: `group:Ephraim`); Ефрем (ID: `person:Ephraim`); Wickedness (ID: `keyterm:Wickedness`); Левий (ID: `group:Levi`); Peace (ID: `keyterm:IntactState`); Иерусалим (ID: `place:Jerusalem`); Левий (ID: `person:Levi.3`); Offering (ID: `keyterm:Offering`); A Man (ID: `person:GenericMale`); Vine (ID: `flora:Vine`)
