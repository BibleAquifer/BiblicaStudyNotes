...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Ханаан (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Израиль (ID: `person:Israel`); Dispossess (ID: `keyterm:Dispossess`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Иисус (ID: `person:Joshua.2`); Халев (ID: `person:Caleb`); Force to Serve (ID: `keyterm:EnticedToServe`); Amorites (ID: `group:Amorites`); Bethel (ID: `place:Bethel`); Adoni-bezek (ID: `person:Adoni-bezek`); юг (ID: `place:Negeb`); Иосиф (ID: `person:Joseph.10`); Perizzites (ID: `group:Perizzites`); Моисей (ID: `person:Moses`); Covenant (ID: `keyterm:Covenant`); Иерусалим (ID: `place:Jerusalem`); Ахсf (ID: `person:Achsah`); Везек (ID: `place:Bezek`); Асир (ID: `group:Asher`); Ваал (ID: `deity:Baal`); To Cause to Possess (ID: `keyterm:Possess`); Асир (ID: `person:Asher`); Сидон (ID: `place:Sidon`); Симеон (ID: `group:Simeon`); Симеон (ID: `person:Simeon.5`); An Angel (ID: `deity:Angel`); Jebusites (ID: `group:Jebusites`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Сисара (ID: `person:Sisera`); Варак (ID: `person:Barak`); Девора (ID: `person:Deborah.2`); Егуд (ID: `person:Ehud`); Иаили (ID: `person:Jael`); Моав (ID: `place:Moab`); Иавин (ID: `person:Jabin.2`); Авиноамов (ID: `person:Abinoam`); Хевер (ID: `person:Heber.2`); Еглон (ID: `person:Eglon`); Tent (ID: `realia:Tent`); Chariot (ID: `realia:Chariot`); Ханаан (ID: `place:Canaan`); Кедес (ID: `place:Kedesh`); Завулон (ID: `person:Zebulun`); Завулон (ID: `group:Zebulun`); Sword (ID: `realia:Sword`); Harosheth-hagoyim (ID: `place:Harosheth-hagoyim`); Mount Tabor (ID: `place:TaborMount`); Киссон (ID: `place:Kishon`); Kenites (ID: `group:Kenite`); Неффалим (ID: `person:Naphtali`); Неффалим (ID: `group:Naphtali`); Ефрем (ID: `group:Ephraim`); Bless (ID: `keyterm:Bless`); Force to Serve (ID: `keyterm:EnticedToServe`); Offering (ID: `keyterm:Offering`); Ефрем (ID: `person:Ephraim`)
...
* **Associated ACAI Concepts:** Гедеон (ID: `person:Gideon`); LORD (ID: `deity:Lord`); Авимелех (ID: `person:Abimelech.2`); Мадиан (ID: `place:Midian`); Израиль (ID: `person:Israel`); Шехем (ID: `place:Shechem`); Гаал (ID: `person:Gaal`); Иоас (ID: `person:Joash`); Зевей (ID: `person:Zebah`); Салмана (ID: `person:Zalmunna`); An Angel (ID: `deity:Angel`); Офра (ID: `place:Ophrah.2`); Евед (ID: `person:Ebed`); Зевул (ID: `person:Zebul`); Fear (ID: `keyterm:Fear`); Ваал (ID: `deity:Baal`); Сокхоф (ID: `place:Succoth`); Евиезер (ID: `person:Abiezer`); Иофам (ID: `person:Jotham`); восток (ID: `place:East`); Asherah (ID: `deity:Asherah`); Rams Horn (ID: `realia:RamsHorn`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Tower (ID: `realia:Tower`); Stone Altar (ID: `realia:StoneAltar`); House (ID: `realia:House`); Abiezrites (ID: `group:Abiezer`); Peace (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** Израиль (ID: `person:Israel`); Аммон (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Иеффай (ID: `person:Jephthah`); LORD (ID: `deity:Lord`); Галаад (ID: `place:Gilead`); Ефрем (ID: `group:Ephraim`); Ефрем (ID: `person:Ephraim`); Amorites (ID: `group:Amorites`); Jordan River (ID: `place:Jordan`); Моав (ID: `place:Moab`); An Angel (ID: `deity:Angel`); Арнон (ID: `place:Arnon`); Mizpah (ID: `place:Mizpah.2`); Dispossess (ID: `keyterm:Dispossess`); Force to Serve (ID: `keyterm:EnticedToServe`); Gileadites (ID: `group:Gilead`); To Sin (ID: `keyterm:Sin`); Сигон (ID: `person:Sihon`); Египет (ID: `place:Egypt`); Филистимской (ID: `place:Philistine`); Филистимлянин (ID: `group:Philistine`); Есевон (ID: `person:Ibzan`); Галаад (ID: `person:Gilead.2`); Гиллел (ID: `person:Hillel`); Иаир (ID: `person:Jair.3`); Авдон (ID: `person:Abdon`); Елон (ID: `person:Elon.3`); Завулон (ID: `group:Zebulun`); Шамир (ID: `place:Shamir.2`)
...
* **Associated ACAI Concepts:** Самсон (ID: `person:Samson`); LORD (ID: `deity:Lord`); Филистимской (ID: `place:Philistine`); Филистимлянин (ID: `group:Philistine`); Маной (ID: `person:Manoah`); An Angel (ID: `deity:Angel`); Далида (ID: `person:Delilah`); Strength (ID: `keyterm:Strength`); Израиль (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Цора (ID: `place:Zorah`); Лехий (ID: `place:Lehi`); Nazirites (ID: `group:Nazirite`); Love (ID: `keyterm:Love`); Иуда (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); Фимна (ID: `place:Timnah`); Газа (ID: `place:Gaza`); Иуда (ID: `group:Judah`); Defilement (ID: `keyterm:Defilement`); Kid (ID: `fauna:Kid`); Goat (ID: `fauna:Goat`); Lion (ID: `fauna:Lion`); Rope (ID: `realia:Rope`); Manoah's Wife (ID: `person:WifeOfManoah`); Етам (ID: `place:Etam`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Естаол (ID: `place:Eshtaol`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Миха (ID: `person:Micah.3`); Дан (ID: `place:Dan`); Дан (ID: `group:Dan`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); терафим (ID: `deity:Teraphim`); Graven Image (ID: `realia:GravenImage`); Molten Image (ID: `realia:MoltenImage`); Household Idols (ID: `realia:HouseholdIdols`); Ephod (ID: `realia:Ephod`); Иуда (ID: `person:Judah.4`); Ефрем (ID: `person:Ephraim`); Израиль (ID: `person:Israel`); Ефрем (ID: `group:Ephraim`); Иуда (ID: `group:Judah`); Естаол (ID: `place:Eshtaol`); Money (ID: `realia:Money`); Trust (ID: `keyterm:LeanOn`); Вифлеем (ID: `place:Bethlehem`); A Person (ID: `person:GenericPerson`); Цора (ID: `place:Zorah`); Mother of Micah (ID: `person:MotherOfMicah.3`); Сидон (ID: `place:Sidon`); Dispossess (ID: `keyterm:Dispossess`); Peace (ID: `keyterm:IntactState`); Mahaneh-dan (ID: `place:Mahaneh-dan`); Ионафан (ID: `person:Jonathan.2`); Military Members (ID: `group:MilitaryMembers`); Beth-rehob (ID: `place:Beth-rehob`); Gershom (ID: `person:Gershom`); To Cause to Possess (ID: `keyterm:Possess`); Safety (ID: `keyterm:Safety`); Sidonians (ID: `group:Sidon`); Holy (ID: `keyterm:Holy`); Bless (ID: `keyterm:Bless`); Kiriath-jearim (ID: `place:Kiriath-jearim`); To Curse (ID: `keyterm:Curse`); Моисей (ID: `person:Moses`); Силом (ID: `place:Shiloh`); Sword (ID: `realia:Sword`)
...
* **Associated ACAI Concepts:** Израиль (ID: `person:Israel`); Вениамин (ID: `group:Benjamin`); Вениамин (ID: `person:Benjamin`); Gibeah (ID: `place:Gibeah.2`); LORD (ID: `deity:Lord`); Иавис Галаадский (ID: `place:Jabesh-gilead`); Массифа (ID: `place:Mizpah`); Bethel (ID: `place:Bethel`); House (ID: `realia:House`); Sword (ID: `realia:Sword`); Foolish (ID: `keyterm:Foolish`); To Cause to Possess (ID: `keyterm:Possess`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); A Father (ID: `person:GenericFather`); Donkey (ID: `fauna:Donkey`); Rock of Rimmon (ID: `place:Rimmon.3`); Вифлеем (ID: `place:Bethlehem`); Swear (ID: `keyterm:Swear`); Ефрем (ID: `person:Ephraim`); Ефрем (ID: `group:Ephraim`); Силом (ID: `place:Shiloh`); Иерусалим (ID: `place:Jerusalem`); Offering (ID: `keyterm:Offering`); A Man (ID: `person:GenericMale`); Wickedness (ID: `keyterm:Wickedness`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Peace (ID: `keyterm:IntactState`); Vine (ID: `flora:Vine`)
