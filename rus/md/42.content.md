...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Захария (ID: `person:Zechariah`); Елисавета (ID: `person:Elizabeth`); An Angel (ID: `deity:Angel`); Temple (ID: `realia:Temple`); Priesthood (ID: `keyterm:Priesthood`); Fear (ID: `keyterm:Fear`); Pray (ID: `keyterm:Pray`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Святой Дух (ID: `deity:HolySpirit`); Name (ID: `keyterm:Name`); Авия (ID: `person:Abijah.6`); Гавриил (ID: `deity:Gabriel`); Regulations (ID: `keyterm:Regulations`); Be Blameless (ID: `keyterm:Blameless`); Ирод (ID: `person:Herod`); Commandment (ID: `keyterm:Commandment`); Иудея (ID: `place:Judea`); Good News (ID: `keyterm:GoodNews`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Believe (ID: `keyterm:Believe`); Аарона (ID: `person:Aaron`); Ability (ID: `keyterm:Ability`); Heart (ID: `keyterm:Heart`); To Cause to Happen (ID: `keyterm:Happen`); Елия (ID: `person:Elijah`); Иоанн (ID: `person:John`); Spirit (ID: `keyterm:Spirit.2`); Израиль (ID: `person:Israel`); Strong Drink (ID: `realia:StrongDrink`); House (ID: `realia:House`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Мария (ID: `person:Mary`); Name (ID: `keyterm:Name`); Word (ID: `keyterm:Word`); Favor (ID: `keyterm:Favor`); Давид (ID: `person:David`); Иисус (ID: `person:Jesus.2`); Назарет (ID: `place:Nazareth`); Гавриил (ID: `deity:Gabriel`); Иосиф (ID: `person:Joseph.4`); Елисавета (ID: `person:Elizabeth`); Галилея (ID: `place:Galilee`); Ability (ID: `keyterm:Ability`); Be Engaged (ID: `keyterm:Engaged`); Fear (ID: `keyterm:Fear`); Святой Дух (ID: `deity:HolySpirit`); Holy (ID: `keyterm:Holy`); Always (ID: `keyterm:Always`); Kingdom (ID: `keyterm:Kingdom`); Израиль (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Мария (ID: `person:Mary`); LORD (ID: `deity:Lord`); Елисавета (ID: `person:Elizabeth`); Mercy (ID: `keyterm:Mercy`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Name (ID: `keyterm:Name`); Mind (ID: `keyterm:Mind.2`); Regard as Happy (ID: `keyterm:RegardAsHappy`); Believe (ID: `keyterm:Believe`); Авраам (ID: `person:Abraham`); Haste (ID: `keyterm:Haste`); Захария (ID: `person:Zechariah`); Bless (ID: `keyterm:Bless`); Heart (ID: `keyterm:Heart`); Savior (ID: `keyterm:Savior`); Empty (ID: `keyterm:Empty`); Иуда (ID: `person:Judah.4`); Fear (ID: `keyterm:Fear`); Святой Дух (ID: `deity:HolySpirit`); Happy (ID: `keyterm:Happy`); Иисус (ID: `person:Jesus.2`); Holy (ID: `keyterm:Holy`); Spirit (ID: `keyterm:Spirit.2`); Always (ID: `keyterm:Always`); Израиль (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`); Mercy (ID: `keyterm:Mercy`); Holy (ID: `keyterm:Holy`); Name (ID: `keyterm:Name`); Захария (ID: `person:Zechariah`); Bless (ID: `keyterm:Bless`); Иоанн (ID: `person:John`); Святой Дух (ID: `deity:HolySpirit`); Израиль (ID: `person:Israel`); Иудея (ID: `place:Judea`); Height (ID: `keyterm:Height`); Елисавета (ID: `person:Elizabeth`); Deliver (ID: `keyterm:Deliver`); Liberation (ID: `keyterm:Liberation`); Priesthood (ID: `keyterm:Priesthood`); Oath (ID: `keyterm:Oath`); Word (ID: `keyterm:Word`); To Sin (ID: `keyterm:Sin`); Forgive (ID: `keyterm:Forgive`); Авраам (ID: `person:Abraham`); Affection (ID: `keyterm:Affection`); A Group of People (ID: `group:GenericGroup`); Heart (ID: `keyterm:Heart`); Fear (ID: `keyterm:Fear`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Covenant (ID: `keyterm:Covenant`); Давид (ID: `person:David`); Serve (ID: `keyterm:Serve`); Make Peace (ID: `keyterm:Peace`); Spirit (ID: `keyterm:Spirit.2`); Circumcision (ID: `keyterm:Circumcision`); Always (ID: `keyterm:Always`); Speak as a Prophet (ID: `keyterm:Speak`); Tablet (ID: `realia:Tablet`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Назарет (ID: `place:Nazareth`); Иисус (ID: `person:Jesus.2`); Favor (ID: `keyterm:Favor`); Word (ID: `keyterm:Word`); Passover (ID: `keyterm:Passover`); Галилея (ID: `place:Galilee`); Law (ID: `keyterm:Law`); Heart (ID: `keyterm:Heart`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Baptism (ID: `keyterm:Baptism`); Straightness (ID: `keyterm:Straightness`); Repent (ID: `keyterm:Repent`); Филипп (ID: `person:Philip.3`); Август (ID: `person:Augustus`); Авилинея (ID: `place:Abilene`); Jordan River (ID: `place:Jordan`); Иоанн (ID: `person:John`); Анна (ID: `person:Annas`); Ирод Антипа (ID: `person:Herod.2`); Лисаний (ID: `person:Lysanias`); Тиверий (ID: `person:Tiberius`); Трахонитской (ID: `place:Trachonitis`); Итурея (ID: `place:Ituraea`); Пилат (ID: `person:Pilate`); Иудея (ID: `place:Judea`); Salvation (ID: `keyterm:Salvation`); Галилея (ID: `place:Galilee`); Word (ID: `keyterm:Word`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); Авраам (ID: `person:Abraham`); Tax Collector (ID: `keyterm:TaxCollector`); Захария (ID: `person:Zechariah`); Body (ID: `keyterm:Body.3`); Исаия (ID: `person:Isaiah`); Каиафа (ID: `person:Caiaphas`); Proclaim (ID: `keyterm:Proclaim`); Axe (ID: `realia:Axe`); Scroll (ID: `realia:Scroll`); Tunic (ID: `realia:Tunic.2`); Snake (ID: `fauna:Snake`)
...
* **Associated ACAI Concepts:** Иоанн (ID: `person:John`); Baptism (ID: `keyterm:Baptism`); Sky (ID: `keyterm:Heaven`); Святой Дух (ID: `deity:HolySpirit`); Иисус (ID: `person:Jesus.2`); Иродиада (ID: `person:Herodias`); Ирод Антипа (ID: `person:Herod.2`); Clean Out (ID: `keyterm:CleanOut`); Heart (ID: `keyterm:Heart`); Ask for (ID: `keyterm:AskFor`); Pray (ID: `keyterm:Pray`); Beloved (ID: `keyterm:Beloved`); Strap (ID: `realia:Strap`); Dove (ID: `fauna:Dove`); Wheat (ID: `flora:Wheat`); Sandal (ID: `realia:Sandal`); Grain (ID: `flora:Grain`); Winnowing Fork (ID: `realia:WinnowingFork`); Barn (ID: `realia:Barn`); Prison (ID: `realia:Prison`); Threshing Floor (ID: `realia:ThreshingFloor`)
...
* **Associated ACAI Concepts:** Сала (ID: `person:Shelah.2`); Иосиф (ID: `person:Joseph.4`); Косам (ID: `person:Cosam`); Еслим (ID: `person:Esli`); Аддий (ID: `person:Addi`); Маттафий (ID: `person:Mattathias.2`); Салафиил (ID: `person:Shealtiel`); Ламех (ID: `person:Lamech.2`); Мелеаев (ID: `person:Melea`); Ир (ID: `person:Er`); Ианнаев (ID: `person:Jannai`); Малелеил (ID: `person:Mahalalel`); Амос (ID: `person:Amos.2`); Елиезер (ID: `person:Eliezer`); Иудин (ID: `person:Joda`); Илия (ID: `person:Heli`); Ионанов (ID: `person:Jonam`); Мелхий (ID: `person:Melchi`); Елиаким (ID: `person:Eliakim.2`); Семеиев (ID: `person:Semein`); Фалек (ID: `person:Peleg`); Мелхий (ID: `person:Melchi.2`); Нахор (ID: `person:Nahor`); Елмодамов (ID: `person:Elmadam`); Наум (ID: `person:Nahum`); Рагав (ID: `person:Reu`); Левий (ID: `person:Levi.2`); Иуда (ID: `person:Judah.3`); Енос (ID: `person:Enosh`); Мафусал (ID: `person:Methuselah`); Салмон (ID: `person:Salmon`); Серух (ID: `person:Serug`); Иисус (ID: `person:Joshua`); Матфатов (ID: `person:Matthat.2`); Матфатов (ID: `person:Matthat`); Маттафа (ID: `person:Mattatha`); Каинан (ID: `person:Cainan`); Иоаннан (ID: `person:Joanan`); Маинанов (ID: `person:Menna`); Мааф (ID: `person:Maath`); Сиф (ID: `person:Seth`); Адам (ID: `person:Adam`); Каинан (ID: `person:Kenan`); Нириев (ID: `person:Neri`); Иосиф (ID: `person:Joseph.7`); Нафан (ID: `person:Nathan`); Фарра (ID: `person:Terah`); Иаред (ID: `person:Jared`); Вооз (ID: `person:Boaz`); Симеон (ID: `person:Simeon.3`); Наггеев (ID: `person:Naggai`); Есром (ID: `person:Hezron.2`); Сима (ID: `person:Shem`); Иосиф (ID: `person:Joseph.8`); Иорим (ID: `person:Jorim`); Евер (ID: `person:Eber`); Josech (ID: `person:Josech`); Рисаев (ID: `person:Rhesa`); Маттафий (ID: `person:Mattathias`); Зоровавель (ID: `person:Zerubbabel`); Левий (ID: `person:Levi`); Авраам (ID: `person:Abraham`); LORD (ID: `deity:Lord`); Иисус (ID: `person:Jesus.2`); Давид (ID: `person:David`); Наассон (ID: `person:Nahshon`); Аминадав (ID: `person:Amminadab`); Иуда (ID: `person:Judah.4`); Фарес (ID: `person:Perez`); Израиль (ID: `person:Israel`); Рам (ID: `person:Ram`); Овид (ID: `person:Obed`); Енох (ID: `person:Enoch.2`); Иессей (ID: `person:Jesse`); Исаак (ID: `person:Isaac`); Ноа (ID: `person:Noah`); Арфаксад (ID: `person:Arpachshad`)
...
* **Associated ACAI Concepts:** Synagogue (ID: `realia:Synagogue`); Proclaim (ID: `keyterm:Proclaim`); LORD (ID: `deity:Lord`); Елия (ID: `person:Elijah`); Святой Дух (ID: `deity:HolySpirit`); Израиль (ID: `person:Israel`); Scroll (ID: `realia:Scroll`); Галилея (ID: `place:Galilee`); Елисей (ID: `person:Elisha`); Сарепта (ID: `place:Zarephath`); Назарет (ID: `place:Nazareth`); Syrians (ID: `group:Syria`); Нааман (ID: `person:Naaman.3`); Иосиф (ID: `person:Joseph.4`); Written (ID: `keyterm:Scripture`); Surely! (ID: `keyterm:Surely`); Glory (ID: `keyterm:Glory`); Good News (ID: `keyterm:GoodNews`); Bear Witness (ID: `keyterm:BearWitness`); Sabbath (ID: `keyterm:Sabbath`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Truth (ID: `keyterm:Truth`); Капернаум (ID: `place:Capernaum`); Исаия (ID: `person:Isaiah`); Anointed (ID: `keyterm:Anointed`); To Cause to Happen (ID: `keyterm:Happen`); Сидон (ID: `place:Sidon`); Parable (ID: `keyterm:Parable`); To Cleanse (ID: `keyterm:Cleanse.2`); Serve (ID: `keyterm:Serve`); Иисус (ID: `person:Jesus.2`); Favor (ID: `keyterm:Favor`)
...
* **Associated ACAI Concepts:** To Command (ID: `keyterm:Command`); Demons (ID: `deity:Demons`); Иисус (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Ability (ID: `keyterm:Ability`); LORD (ID: `deity:Lord`); Authority (ID: `keyterm:Authority.2`); Serve (ID: `keyterm:Serve`); Иудея (ID: `place:Judea`); Good News (ID: `keyterm:GoodNews`); Капернаум (ID: `place:Capernaum`); Галилея (ID: `place:Galilee`); Sabbath (ID: `keyterm:Sabbath`); Пётр (ID: `person:Peter`); Назарет (ID: `place:Nazareth`); Ask for (ID: `keyterm:AskFor`); Defilement (ID: `keyterm:Defilement`); Holy (ID: `keyterm:Holy`); Kingdom (ID: `keyterm:Kingdom`); Proclaim (ID: `keyterm:Proclaim`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Пётр (ID: `person:Peter`); Ship (ID: `realia:Ship`); Casting Net (ID: `realia:CastingNet`); Fishnet (ID: `realia:Fishnet`); To Cleanse (ID: `keyterm:Cleanse.2`); Иисус (ID: `person:Jesus.2`); Fish (ID: `fauna:Fish`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Иоанн (ID: `person:John.2`); Bear Witness (ID: `keyterm:BearWitness`); Word (ID: `keyterm:Word`); Зеведей (ID: `person:Zebedee`); Иаков (ID: `person:James`); LORD (ID: `deity:Lord`); Моисей (ID: `person:Moses`); Ask for (ID: `keyterm:AskFor`); Геннисаретская (ID: `place:Gennesaret`); Fear (ID: `keyterm:Fear`); Pray (ID: `keyterm:Pray`); Serve (ID: `keyterm:Serve`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); Forgive (ID: `keyterm:Forgive`); LORD (ID: `deity:Lord`); Bring In (ID: `keyterm:BringIn`); Bed (ID: `realia:Bed`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Иисус (ID: `person:Jesus.2`); Pharisees (ID: `group:Pharisee`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Галилея (ID: `place:Galilee`); Иудея (ID: `place:Judea`); Believe (ID: `keyterm:Believe`); Heart (ID: `keyterm:Heart`); Иерусалим (ID: `place:Jerusalem`); Authority (ID: `keyterm:Authority.2`); Fear (ID: `keyterm:Fear`); Blaspheme (ID: `keyterm:Blaspheme`); Tile (ID: `realia:Tile`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Tax Collector (ID: `keyterm:TaxCollector`); Abstain from Food (ID: `keyterm:Fast`); Матфей (ID: `person:Matthew`); Be a Disciple (ID: `keyterm:Disciple`); Pharisees (ID: `group:Pharisee`); Skin-Bottle (ID: `realia:Skin-bottle`); Must (ID: `realia:Must`); Good (ID: `keyterm:Good`); Иоанн (ID: `person:John`); Repent (ID: `keyterm:Repent`); Parable (ID: `keyterm:Parable`); Pray (ID: `keyterm:Pray`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); Tax Office (ID: `keyterm:TaxOffice`); Иисус (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); Patch (ID: `realia:Patch`); House (ID: `realia:House`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Sabbath (ID: `keyterm:Sabbath`); Иисус (ID: `person:Jesus.2`); Be Lawful (ID: `keyterm:Lawful`); Pharisees (ID: `group:Pharisee`); Serve (ID: `keyterm:Serve`); Be a Disciple (ID: `keyterm:Disciple`); Давид (ID: `person:David`); Salvation (ID: `keyterm:Salvation`); Life (ID: `keyterm:Life`); Do Good (ID: `keyterm:DoGood`); LORD (ID: `deity:Lord`); Wheat (ID: `flora:Wheat`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`); Grain (ID: `flora:Grain`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Happy (ID: `keyterm:Happy`); Disaster (ID: `keyterm:Disaster`); Be a Disciple (ID: `keyterm:Disciple`); Иаков (ID: `person:James.2`); LORD (ID: `deity:Lord`); Матфей (ID: `person:Matthew`); Иуда (ID: `person:Judas`); Chosen (ID: `keyterm:Chosen`); Симон (ID: `person:Simon.2`); Иоанн (ID: `person:John.2`); Иудея (ID: `place:Judea`); Фома (ID: `person:Thomas`); Тир (ID: `place:Tyre`); Алфей (ID: `person:Alphaeus`); Ability (ID: `keyterm:Ability`); Иуда (ID: `person:Judas.2`); Sky (ID: `keyterm:Heaven`); Иаков (ID: `person:James`); Пётр (ID: `person:Peter`); Иерусалим (ID: `place:Jerusalem`); Ask for (ID: `keyterm:AskFor`); Сидон (ID: `place:Sidon`); Pray (ID: `keyterm:Pray`); Serve (ID: `keyterm:Serve`); Филипп (ID: `person:Philip`); Name (ID: `keyterm:Name`); Варфоломей (ID: `person:Bartholomew`); Kingdom (ID: `keyterm:Kingdom`); Андрей (ID: `person:Andrew`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Ask for (ID: `keyterm:AskFor`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Иудея (ID: `place:Judea`); Наин (ID: `place:Nain`); Salvation (ID: `keyterm:Salvation`); To Command (ID: `keyterm:Command`); Glory (ID: `keyterm:Glory`); Word (ID: `keyterm:Word`); Affection (ID: `keyterm:Affection`); Believe (ID: `keyterm:Believe`); Ability (ID: `keyterm:Ability`); Love (ID: `keyterm:Love`); Капернаум (ID: `place:Capernaum`); A Group of People (ID: `group:GenericGroup`); LORD (ID: `deity:Lord`); Authority (ID: `keyterm:Authority.2`); Fear (ID: `keyterm:Fear`); Be a Disciple (ID: `keyterm:Disciple`); Jews (ID: `group:Jews`); Израиль (ID: `person:Israel`); Bier (ID: `realia:Bier`); Synagogue (ID: `realia:Synagogue`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Иоанн (ID: `person:John`); LORD (ID: `deity:Lord`); Baptist (ID: `keyterm:Baptist`); Baptism (ID: `keyterm:Baptism`); Tax Collector (ID: `keyterm:TaxCollector`); An Angel (ID: `deity:Angel`); Glorious (ID: `keyterm:Glorious`); Good News (ID: `keyterm:GoodNews`); Forgive (ID: `keyterm:Forgive`); A Group of Disciples (ID: `group:GenericDisciples`); Demons (ID: `deity:Demons`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); To Cleanse (ID: `keyterm:Cleanse.2`); Serve (ID: `keyterm:Serve`); Иисус (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Happy (ID: `keyterm:Happy`); Resurrection (ID: `keyterm:Resurrection`); Obey Righteous Commands (ID: `keyterm:ObeyRighteousCommands`); Pharisees (ID: `group:Pharisee`); Kingdom (ID: `keyterm:Kingdom`); Reed (ID: `flora:Reed`); Palace (ID: `realia:Palace`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Flute (ID: `realia:Flute`)
...
* **Associated ACAI Concepts:** Forgive (ID: `keyterm:Forgive`); Симон (ID: `person:Simon.6`); To Sin (ID: `keyterm:Sin`); Pharisees (ID: `group:Pharisee`); House (ID: `realia:House`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Love (ID: `keyterm:Love`); Anointed (ID: `keyterm:Anointed`); Owe (ID: `keyterm:Owe`); Salvation (ID: `keyterm:Salvation`); Believe (ID: `keyterm:Believe`); Ask for (ID: `keyterm:AskFor`); Decided (ID: `keyterm:Decided`); Иисус (ID: `person:Jesus.2`); Make Peace (ID: `keyterm:Peace`); Alabaster Jar (ID: `realia:AlabasterJar`); Olive Oil (ID: `realia:OliveOil`); Denarius (ID: `realia:Denarius`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Parable (ID: `keyterm:Parable`); LORD (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Heart (ID: `keyterm:Heart`); Serve (ID: `keyterm:Serve`); Kingdom (ID: `keyterm:Kingdom`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Barley (ID: `flora:Barley`); Grain (ID: `flora:Grain`); Daily Life (ID: `keyterm:DailyLife`); Иоанна (ID: `person:Joanna`); Мария Магдалина (ID: `person:Marymagdalene`); Honest (ID: `keyterm:Honest`); Хуза (ID: `person:Chuza`); Сусанна (ID: `person:Susanna`); Salvation (ID: `keyterm:Salvation`); Good News (ID: `keyterm:GoodNews`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Sky (ID: `keyterm:Heaven`); Put to the Test (ID: `keyterm:PutToTheTest`); Ирод Антипа (ID: `person:Herod.2`); Demons (ID: `deity:Demons`); Be a Disciple (ID: `keyterm:Disciple`); Proclaim (ID: `keyterm:Proclaim`); Bed (ID: `realia:Bed`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** Demons (ID: `deity:Demons`); Иисус (ID: `person:Jesus.2`); Ask for (ID: `keyterm:AskFor`); Fear (ID: `keyterm:Fear`); Gerasa (ID: `place:Gerasa`); LORD (ID: `deity:Lord`); Jackal (ID: `fauna:Jackal`); House (ID: `realia:House`); Pig (ID: `fauna:Pig`); Ship (ID: `realia:Ship`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); легион (ID: `deity:Legion`); Abyss (ID: `keyterm:Abyss`); Salvation (ID: `keyterm:Salvation`); To Command (ID: `keyterm:Command`); Галилея (ID: `place:Galilee`); Believe (ID: `keyterm:Believe`); Be a Disciple (ID: `keyterm:Disciple`); Name (ID: `keyterm:Name`); Proclaim (ID: `keyterm:Proclaim`); A Man (ID: `person:GenericMale`); Fetter (ID: `realia:Fetter`); Grave (ID: `realia:Grave`); Chain (ID: `realia:Chain`); Clothing (ID: `realia:Clothing`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Salvation (ID: `keyterm:Salvation`); Believe (ID: `keyterm:Believe`); Пётр (ID: `person:Peter`); Blood (ID: `keyterm:Blood`); House (ID: `realia:House`); Synagogue (ID: `realia:Synagogue`); Иаир (ID: `person:Jairus`); Иоанн (ID: `person:John.2`); Daily Life (ID: `keyterm:DailyLife`); Ability (ID: `keyterm:Ability`); Иаков (ID: `person:James`); Ask for (ID: `keyterm:AskFor`); Life (ID: `keyterm:Life`); Fear (ID: `keyterm:Fear`); Serve (ID: `keyterm:Serve`); Make Peace (ID: `keyterm:Peace`); Spirit (ID: `keyterm:Spirit.2`); Name (ID: `keyterm:Name`); Cloak (ID: `realia:Cloak`); Tassel (ID: `realia:Tassel`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Reject (ID: `keyterm:Reject`); Salvation (ID: `keyterm:Salvation`); To Command (ID: `keyterm:Command`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); A Group of Disciples (ID: `group:GenericDisciples`); Елия (ID: `person:Elijah`); Иоанн (ID: `person:John`); Пётр (ID: `person:Peter`); Life (ID: `keyterm:Life`); True (ID: `keyterm:True`); Baptist (ID: `keyterm:Baptist`); Pray (ID: `keyterm:Pray`); Иисус (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); An Angel (ID: `deity:Angel`); Holy (ID: `keyterm:Holy`); Resurrection (ID: `keyterm:Resurrection`); Kingdom (ID: `keyterm:Kingdom`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Пётр (ID: `person:Peter`); Иисус (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`); Pray (ID: `keyterm:Pray`); Моисей (ID: `person:Moses`); Елия (ID: `person:Elijah`); Иоанн (ID: `person:John.2`); Иерусалим (ID: `place:Jerusalem`); Иаков (ID: `person:James`); Fear (ID: `keyterm:Fear`); Chosen (ID: `keyterm:Chosen`); To Cause to Happen (ID: `keyterm:Happen`); Tent (ID: `realia:Tent`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Name (ID: `keyterm:Name`); Demons (ID: `deity:Demons`); Иоанн (ID: `person:John.2`); Ask for (ID: `keyterm:AskFor`); To Command (ID: `keyterm:Command`); Word (ID: `keyterm:Word`); Be Unfaithful (ID: `keyterm:Unfaithful`); Heart (ID: `keyterm:Heart`); Fear (ID: `keyterm:Fear`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Иерусалим (ID: `place:Jerusalem`); Kingdom (ID: `keyterm:Kingdom`); LORD (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Samaritans (ID: `group:Samaritan`); Religious Official (ID: `person:ReligiousOfficial`); An Angel (ID: `deity:Angel`); Be a Disciple (ID: `keyterm:Disciple`); Иоанн (ID: `person:John.2`); To Command (ID: `keyterm:Command`); Иаков (ID: `person:James`); Самария (ID: `place:Samaria`); A Man (ID: `person:GenericMale`); Mattock (ID: `realia:Mattock`); Jackal (ID: `fauna:Jackal`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Sky (ID: `keyterm:Heaven`); LORD (ID: `deity:Lord`); Make Peace (ID: `keyterm:Peace`); Тир (ID: `place:Tyre`); Ability (ID: `keyterm:Ability`); Сидон (ID: `place:Sidon`); Name (ID: `keyterm:Name`); Kingdom (ID: `keyterm:Kingdom`); House (ID: `realia:House`); Disaster (ID: `keyterm:Disaster`); Хоразин (ID: `place:Chorazin`); Вифсаида (ID: `place:Bethsaida`); Hell (ID: `place:Hell`); Cause of Joy (ID: `keyterm:CauseOfJoy`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Капернаум (ID: `place:Capernaum`); Содом (ID: `place:Sodom`); To Act Wickedly (ID: `keyterm:ActWickedly`); сатана (ID: `deity:Satan`); Judgment (ID: `keyterm:Judgment`); Repent (ID: `keyterm:Repent`); Ask for (ID: `keyterm:AskFor`); Demons (ID: `deity:Demons`); Authority (ID: `keyterm:Authority.2`); Court Case (ID: `keyterm:CourtCase`); Святой Дух (ID: `deity:HolySpirit`); Serve (ID: `keyterm:Serve`); Иисус (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Happy (ID: `keyterm:Happy`); Scorpion (ID: `fauna:Scorpion`); Bag (ID: `realia:Bag`); Sackcloth (ID: `realia:Sackcloth`); Sandal (ID: `realia:Sandal`); Sheep (ID: `fauna:Lamb`); Snake (ID: `fauna:Snake`); Wolf (ID: `fauna:Wolf`)
...
* **Associated ACAI Concepts:** A Priest (ID: `person:GenericPriest`); A Scribe (ID: `person:Scribe`); Иисус (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Inn (ID: `realia:Inn`); Mind (ID: `keyterm:Mind.2`); Mercy (ID: `keyterm:Mercy`); Иерихон (ID: `place:Jericho`); Самария (ID: `place:Samaria`); Левий (ID: `group:Levi`); Affection (ID: `keyterm:Affection`); Love (ID: `keyterm:Love`); Heart (ID: `keyterm:Heart`); LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Law (ID: `keyterm:Law`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Samaritans (ID: `group:Samaritan`); Левий (ID: `person:Levi.3`); Always (ID: `keyterm:Always`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** Марфа (ID: `person:Martha`); Мария (ID: `person:Mary.3`); Иисус (ID: `person:Jesus.2`); Serve (ID: `keyterm:Serve`); Name (ID: `keyterm:Name`); To Command (ID: `keyterm:Command`); Chosen (ID: `keyterm:Chosen`); Good (ID: `keyterm:Good`)
...
* **Associated ACAI Concepts:** Иона (ID: `person:Jonah.2`); Ниневия (ID: `group:Nineveh`); Happy (ID: `keyterm:Happy`); Body (ID: `keyterm:Body.3`); Symbol (ID: `keyterm:Example`); Court Case (ID: `keyterm:CourtCase`); Ниневия (ID: `place:Nineveh`); Judgment (ID: `keyterm:Judgment`); Repent (ID: `keyterm:Repent`); Sheba (ID: `place:Sheba.2`); царица Савская (ID: `person:QueenOfSheba`); A Woman (ID: `person:GenericFemale`); Соломон (ID: `person:Solomon`); LORD (ID: `deity:Lord`); Proclaim (ID: `keyterm:Proclaim`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** Disaster (ID: `keyterm:Disaster`); Pharisees (ID: `group:Pharisee`); Love (ID: `keyterm:Love`); LORD (ID: `deity:Lord`); Blood (ID: `keyterm:Blood`); Захария (ID: `person:Zechariah.12`); Ability (ID: `keyterm:Ability`); Clean (ID: `keyterm:Clean`); A Scribe (ID: `person:Scribe`); Judgment (ID: `keyterm:Judgment`); Witness (ID: `keyterm:Witness`); Ask for (ID: `keyterm:AskFor`); Авель (ID: `person:Abel`); To Cleanse (ID: `keyterm:Cleanse.2`); Иисус (ID: `person:Jesus.2`); Mint (ID: `flora:Mint`); Rue (ID: `flora:Rue`); Plate (ID: `realia:Plate.2`); Grave (ID: `realia:Grave`); House (ID: `realia:House`); Synagogue (ID: `realia:Synagogue`); Temple (ID: `realia:Temple`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Body (ID: `keyterm:Body.3`); Kingdom (ID: `keyterm:Kingdom`); Barn (ID: `realia:Barn`); Having Little Faith (ID: `keyterm:HavingLittleFaith`); To Command (ID: `keyterm:Command`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); A Person (ID: `person:GenericPerson`); Соломон (ID: `person:Solomon`); Heart (ID: `keyterm:Heart`); Parable (ID: `keyterm:Parable`); Fear (ID: `keyterm:Fear`); Be a Disciple (ID: `keyterm:Disciple`); Crow (ID: `fauna:Crow`); Bag (ID: `realia:Bag`); Cubit (ID: `realia:Cubit.2`); Flock (ID: `fauna:Flock`); Wild Flower (ID: `flora:WildFlower`); Oven (ID: `realia:Oven`); Storeroom (ID: `realia:Storeroom`); Bird (ID: `fauna:Bird`); Rooster (ID: `fauna:Rooster`); Goat (ID: `fauna:Goat`); Wheat (ID: `flora:Wheat`); Clothing (ID: `realia:Clothing`); Moth (ID: `fauna:Moth`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Happy (ID: `keyterm:Happy`); Surely! (ID: `keyterm:Surely`); Baptism (ID: `keyterm:Baptism`); Sky (ID: `keyterm:Heaven`); Heart (ID: `keyterm:Heart`); Interpret (ID: `keyterm:Interpret`); Пётр (ID: `person:Peter`); Decided (ID: `keyterm:Decided`); True (ID: `keyterm:True`); Parable (ID: `keyterm:Parable`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Иисус (ID: `person:Jesus.2`); Serve (ID: `keyterm:Serve`); Make Peace (ID: `keyterm:Peace`); Faithfulness (ID: `keyterm:Faithfulness`); Set Free (ID: `keyterm:SetFree`); Be Unfaithful (ID: `keyterm:Unfaithful`); Lepton (ID: `realia:Lepton`); House (ID: `realia:House`); Prison (ID: `realia:Prison`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Repent (ID: `keyterm:Repent`); Galileans (ID: `group:Galilee`); Галилея (ID: `place:Galilee`); Fig (ID: `flora:Fig`); Иерусалим (ID: `place:Jerusalem`); Пилат (ID: `person:Pilate`); Siloam (ID: `place:Siloam`); Parable (ID: `keyterm:Parable`); Offering (ID: `keyterm:Offering`); Blood (ID: `keyterm:Blood`); Watch-Tower (ID: `realia:Watch-tower`); Vine (ID: `flora:Vine`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** Sabbath (ID: `keyterm:Sabbath`); Иисус (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Religious Official (ID: `person:ReligiousOfficial`); Serve (ID: `keyterm:Serve`); сатана (ID: `deity:Satan`); Glorious (ID: `keyterm:Glorious`); Glory (ID: `keyterm:Glory`); LORD (ID: `deity:Lord`); Авраам (ID: `person:Abraham`); Animal Pen (ID: `realia:AnimalPen`); Cattle (ID: `fauna:Bull`); Donkey (ID: `fauna:Donkey`)
...
* **Associated ACAI Concepts:** Kingdom (ID: `keyterm:Kingdom`); LORD (ID: `deity:Lord`); Door (ID: `realia:Door`); Иерусалим (ID: `place:Jerusalem`); Salvation (ID: `keyterm:Salvation`); Sky (ID: `keyterm:Heaven`); Исаак (ID: `person:Isaac`); A Person (ID: `person:GenericPerson`); Авраам (ID: `person:Abraham`); Unjust Deed (ID: `keyterm:UnjustDeed`); Израиль (ID: `person:Israel`); Saton (ID: `realia:Saton`); Grain (ID: `flora:Grain`); Mustard (ID: `flora:Mustard`)
...
* **Associated ACAI Concepts:** Sabbath (ID: `keyterm:Sabbath`); Pharisees (ID: `group:Pharisee`); Иисус (ID: `person:Jesus.2`); Serve (ID: `keyterm:Serve`); Happy (ID: `keyterm:Happy`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Resurrection (ID: `keyterm:Resurrection`); Glory (ID: `keyterm:Glory`); Parable (ID: `keyterm:Parable`); Chosen (ID: `keyterm:Chosen`); Be Lawful (ID: `keyterm:Lawful`); Cattle (ID: `fauna:Bull`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Авраам (ID: `person:Abraham`); Лазарь (ID: `person:Lazarus`); Ask for (ID: `keyterm:AskFor`); Моисей (ID: `person:Moses`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Repent (ID: `keyterm:Repent`); An Angel (ID: `deity:Angel`); Mercy (ID: `keyterm:Mercy`); Life (ID: `keyterm:Life`); Name (ID: `keyterm:Name`); Hell (ID: `place:Hell`); Encourage (ID: `keyterm:Encourage`); Declare (ID: `keyterm:Declare`); Persuade (ID: `keyterm:Persuade`); Dog (ID: `fauna:Dog`); Linen (ID: `realia:Linen`); Purple Cloth (ID: `realia:PurpleCloth`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Glory (ID: `keyterm:Glory`); Самария (ID: `place:Samaria`); LORD (ID: `deity:Lord`); To Cleanse (ID: `keyterm:Cleanse.2`); Иерусалим (ID: `place:Jerusalem`); Salvation (ID: `keyterm:Salvation`); Mercy (ID: `keyterm:Mercy`); Галилея (ID: `place:Galilee`); Believe (ID: `keyterm:Believe`); Samaritans (ID: `group:Samaritan`)
...
* **Associated ACAI Concepts:** Лота (ID: `person:Lot`); Kingdom (ID: `keyterm:Kingdom`); Ноа (ID: `person:Noah`); LORD (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Be a Disciple (ID: `keyterm:Disciple`); Observation (ID: `keyterm:Observation`); Life (ID: `keyterm:Life`); Body (ID: `keyterm:Body.3`); Pharisees (ID: `group:Pharisee`); Содом (ID: `place:Sodom`); Reject (ID: `keyterm:Reject`); Make Alive (ID: `keyterm:Alive`); Boat (ID: `realia:Boat`); Vulture (ID: `fauna:Vulture`); Bed (ID: `realia:Bed`); Housetop (ID: `realia:Housetop`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Avenge (ID: `keyterm:GrantJustice`); Tax Collector (ID: `keyterm:TaxCollector`); Pray (ID: `keyterm:Pray`); Pharisees (ID: `group:Pharisee`); Parable (ID: `keyterm:Parable`); Fear (ID: `keyterm:Fear`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Иисус (ID: `person:Jesus.2`); Kingdom (ID: `keyterm:Kingdom`); Temple (ID: `realia:Temple`); Abstain from Food (ID: `keyterm:Fast`); Surely! (ID: `keyterm:Surely`); To Command (ID: `keyterm:Command`); Forgive (ID: `keyterm:Forgive`); Believe (ID: `keyterm:Believe`); Sky (ID: `keyterm:Heaven`); Week (ID: `keyterm:Week`); Heart (ID: `keyterm:Heart`); Chosen (ID: `keyterm:Chosen`); Unjust Deed (ID: `keyterm:UnjustDeed`); Persuade (ID: `keyterm:Persuade`); Be a Disciple (ID: `keyterm:Disciple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иисус (ID: `person:Jesus.2`); Kingdom (ID: `keyterm:Kingdom`); Life (ID: `keyterm:Life`); Always (ID: `keyterm:Always`); Good (ID: `keyterm:Good`); Commandment (ID: `keyterm:Commandment`); Пётр (ID: `person:Peter`); Salvation (ID: `keyterm:Salvation`); Surely! (ID: `keyterm:Surely`); Rich Young Ruler (ID: `person:RichYoungRuler`); Fornication (ID: `keyterm:Fornication`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Давид (ID: `person:David`); Mercy (ID: `keyterm:Mercy`); Назарет (ID: `place:Nazareth`); Иерусалим (ID: `place:Jerusalem`); Salvation (ID: `keyterm:Salvation`); To Command (ID: `keyterm:Command`); Glory (ID: `keyterm:Glory`); Иерихон (ID: `place:Jericho`); Word (ID: `keyterm:Word`); LORD (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Gentiles (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Закхей (ID: `person:Zacchaeus`); Salvation (ID: `keyterm:Salvation`); Name (ID: `keyterm:Name`); Иерихон (ID: `place:Jericho`); Авраам (ID: `person:Abraham`); Sycomore Fig (ID: `flora:SycomoreFig`); Fig (ID: `flora:Fig`); Temple (ID: `realia:Temple`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Mina (ID: `realia:Mina`); Kingdom (ID: `keyterm:Kingdom`); Иерусалим (ID: `place:Jerusalem`); Faithfulness (ID: `keyterm:Faithfulness`); Decided (ID: `keyterm:Decided`); Parable (ID: `keyterm:Parable`); Authority (ID: `keyterm:Authority.2`); Fear (ID: `keyterm:Fear`); LORD (ID: `deity:Lord`); Good (ID: `keyterm:Good`); Ability (ID: `keyterm:Ability`); Band of Cloth (ID: `realia:BandOfCloth`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); Donkey (ID: `fauna:Donkey`); LORD (ID: `deity:Lord`); Иисус (ID: `person:Jesus.2`); Make Peace (ID: `keyterm:Peace`); Temple (ID: `realia:Temple`); Иерусалим (ID: `place:Jerusalem`); Clothing (ID: `realia:Clothing`); Olive Tree (ID: `flora:OliveTree`); Height (ID: `keyterm:Height`); Виффагия (ID: `place:Bethphage`); Вифания (ID: `place:Bethany`); Mount of Olives (ID: `place:OlivesMount`); To Command (ID: `keyterm:Command`); Glory (ID: `keyterm:Glory`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); A Group of Disciples (ID: `group:GenericDisciples`); Bless (ID: `keyterm:Bless`); A Group of People (ID: `group:GenericGroup`); Ask for (ID: `keyterm:AskFor`); Pray (ID: `keyterm:Pray`); Name (ID: `keyterm:Name`); Pharisees (ID: `group:Pharisee`); Siege-Works (ID: `realia:Siege-works`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Иоанн (ID: `person:John`); Empty (ID: `keyterm:Empty`); Parable (ID: `keyterm:Parable`); Authority (ID: `keyterm:Authority.2`); Temple (ID: `realia:Temple`); Good News (ID: `keyterm:GoodNews`); Baptism (ID: `keyterm:Baptism`); Reject (ID: `keyterm:Reject`); Believe (ID: `keyterm:Believe`); Heart (ID: `keyterm:Heart`); Persuade (ID: `keyterm:Persuade`); Ask for (ID: `keyterm:AskFor`); Fear (ID: `keyterm:Fear`); Иисус (ID: `person:Jesus.2`); Beloved (ID: `keyterm:Beloved`); Cornerstone (ID: `realia:Cornerstone`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Resurrection (ID: `keyterm:Resurrection`); Тиверий (ID: `person:Tiberius`); Ability (ID: `keyterm:Ability`); Давид (ID: `person:David`); Моисей (ID: `person:Moses`); Иисус (ID: `person:Jesus.2`); Always (ID: `keyterm:Always`); Word (ID: `keyterm:Word`); Авраам (ID: `person:Abraham`); Sadducees (ID: `group:Sadducee`); A Priest (ID: `person:GenericPriest`); Truth (ID: `keyterm:Truth`); The Way (ID: `keyterm:TheWay`); Life (ID: `keyterm:Life`); Hypocrisy (ID: `keyterm:Hypocrisy`); Исаак (ID: `person:Isaac`); Authority (ID: `keyterm:Authority.2`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); Be Lawful (ID: `keyterm:Lawful`); Tribute Tax (ID: `keyterm:TributeTax`); Израиль (ID: `person:Israel`); Brier (ID: `flora:Brier`); Image (ID: `realia:Image`); Boxthorn (ID: `flora:Boxthorn`); Footstool (ID: `realia:Footstool`); Denarius (ID: `realia:Denarius`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); Иуда (ID: `person:Judas.2`); Passover (ID: `keyterm:Passover`); Fear (ID: `keyterm:Fear`); сатана (ID: `deity:Satan`); Mount of Olives (ID: `place:OlivesMount`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Passover (ID: `keyterm:Passover`); Kingdom (ID: `keyterm:Kingdom`); LORD (ID: `deity:Lord`); Sheep (ID: `fauna:Lamb`); Serve (ID: `keyterm:Serve`); House (ID: `realia:House`); Иоанн (ID: `person:John.2`); Body (ID: `keyterm:Body.3`); To Cause to Happen (ID: `keyterm:Happen`); Пётр (ID: `person:Peter`); Disaster (ID: `keyterm:Disaster`); Decided (ID: `keyterm:Decided`); Authority (ID: `keyterm:Authority.2`); Израиль (ID: `person:Israel`); Covenant (ID: `keyterm:Covenant`); Be a Disciple (ID: `keyterm:Disciple`); Offering (ID: `keyterm:Offering`); Gentiles (ID: `group:Gentile`); Blood (ID: `keyterm:Blood`); Guest Room (ID: `realia:GuestRoom`); Upstairs Room (ID: `realia:UpstairsRoom`); Vine (ID: `flora:Vine`); Clay Jar (ID: `realia:ClayJar`)
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); Put to the Test (ID: `keyterm:PutToTheTest`); Пётр (ID: `person:Peter`); Be a Disciple (ID: `keyterm:Disciple`); Bag (ID: `realia:Bag`); Written (ID: `keyterm:Scripture`); Believe (ID: `keyterm:Believe`); Sky (ID: `keyterm:Heaven`); A Group of Disciples (ID: `group:GenericDisciples`); LORD (ID: `deity:Lord`); сатана (ID: `deity:Satan`); Ask for (ID: `keyterm:AskFor`); Lawless (ID: `keyterm:Lawless`); An Angel (ID: `deity:Angel`); Cloak (ID: `realia:Cloak`); Rooster (ID: `fauna:Rooster`); Wheat (ID: `flora:Wheat`); Sandal (ID: `realia:Sandal`); Prison (ID: `realia:Prison`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Пётр (ID: `person:Peter`); Иисус (ID: `person:Jesus.2`); Иуда (ID: `person:Judas.2`); Rooster (ID: `fauna:Rooster`); Temple (ID: `realia:Temple`); Peter's Second Accuser (ID: `person:SecondAccuserOfPeter`); Truth (ID: `keyterm:Truth`); Galileans (ID: `group:Galilee`); Галилея (ID: `place:Galilee`); Authority (ID: `keyterm:Authority.2`); A Servant (ID: `person:GenericServant`); Ability (ID: `keyterm:Ability`); Courtyard (ID: `realia:Courtyard`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Пилат (ID: `person:Pilate`); Галилея (ID: `place:Galilee`); Ability (ID: `keyterm:Ability`); Elders (ID: `group:GenericElders`); Ask for (ID: `keyterm:AskFor`); Priests (ID: `group:GenericPriests`); Religious Officials (ID: `group:ReligiousOfficials`); Иисус (ID: `person:Jesus.2`); Иудея (ID: `place:Judea`); Bear Witness (ID: `keyterm:BearWitness`); Believe (ID: `keyterm:Believe`); Galileans (ID: `group:Galilee`); LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Ирод Антипа (ID: `person:Herod.2`); Authority (ID: `keyterm:Authority.2`); Тиверий (ID: `person:Tiberius`); Tribute Tax (ID: `keyterm:TributeTax`); Speak as a Prophet (ID: `keyterm:Speak`); Jews (ID: `group:Jews`); Blaspheme (ID: `keyterm:Blaspheme`)
...
* **Associated ACAI Concepts:** Пилат (ID: `person:Pilate`); Ирод Антипа (ID: `person:Herod.2`); Иисус (ID: `person:Jesus.2`); Варавва (ID: `person:Barabbas`); Prison (ID: `realia:Prison`); Cross (ID: `realia:Cross`); Decided (ID: `keyterm:Decided`); Symbol (ID: `keyterm:Example`); Discern (ID: `keyterm:Discern`); Hope (ID: `keyterm:Hope`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Salvation (ID: `keyterm:Salvation`); LORD (ID: `deity:Lord`); Jews (ID: `group:Jews`); Cross (ID: `realia:Cross`); Симон (ID: `person:Simon.5`); киринеянин (ID: `place:Cyrene`); Criminal on the Cross (ID: `person:Dysmas`); Surely! (ID: `keyterm:Surely`); To Command (ID: `keyterm:Command`); Golgotha (ID: `place:Golgotha`); Forgive (ID: `keyterm:Forgive`); Paradise (ID: `keyterm:Paradise`); Chosen (ID: `keyterm:Chosen`); Judgment (ID: `keyterm:Judgment`); Иерусалим (ID: `place:Jerusalem`); Fear (ID: `keyterm:Fear`); Happy (ID: `keyterm:Happy`); Blaspheme (ID: `keyterm:Blaspheme`); Sour Wine (ID: `realia:SourWine`); Lot (ID: `realia:Lot`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Галилея (ID: `place:Galilee`); Sabbath (ID: `keyterm:Sabbath`); Body (ID: `keyterm:Body.3`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Иисус (ID: `person:Jesus.2`); Grave (ID: `realia:Grave`); Аримафея (ID: `place:Arimathea`); Иосиф (ID: `person:Joseph.6`); Commandment (ID: `keyterm:Commandment`); Пилат (ID: `person:Pilate`); Glory (ID: `keyterm:Glory`); Good (ID: `keyterm:Good`); Spirit (ID: `keyterm:Spirit.2`); Name (ID: `keyterm:Name`); Kingdom (ID: `keyterm:Kingdom`); Jews (ID: `group:Jews`); Aloes (ID: `realia:Aloes`); Myrrh (ID: `realia:Myrrh`); Linen (ID: `realia:Linen`); Curtain (ID: `realia:Curtain`); Myrrh (ID: `flora:Myrrh`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Word (ID: `keyterm:Word`); Week (ID: `keyterm:Week`); Иоанна (ID: `person:Joanna`); Пётр (ID: `person:Peter`); Resurrection (ID: `keyterm:Resurrection`); Иаков (ID: `person:James.3`); Life (ID: `keyterm:Life`); Disbelieve (ID: `keyterm:Disbelieve`); Мария (ID: `person:Mary`); Body (ID: `keyterm:Body.3`); Галилея (ID: `place:Galilee`); Мария Магдалина (ID: `person:Marymagdalene`); Linen (ID: `realia:Linen`); Cross (ID: `realia:Cross`); Clothing (ID: `realia:Clothing`); Aloes (ID: `realia:Aloes`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Иерусалим (ID: `place:Jerusalem`); Written (ID: `keyterm:Scripture`); Heart (ID: `keyterm:Heart`); Name (ID: `keyterm:Name`); Grave (ID: `realia:Grave`); Эммаус (ID: `place:Emmaus`); Клеопа (ID: `person:Cleopas`); Glory (ID: `keyterm:Glory`); Believe (ID: `keyterm:Believe`); Bless (ID: `keyterm:Bless`); Body (ID: `keyterm:Body.3`); Hope (ID: `keyterm:Hope`); LORD (ID: `deity:Lord`); Моисей (ID: `person:Moses`); Liberation (ID: `keyterm:Liberation`); Judgment (ID: `keyterm:Judgment`); Пётр (ID: `person:Peter`); Life (ID: `keyterm:Life`); An Angel (ID: `deity:Angel`); Resurrection (ID: `keyterm:Resurrection`); Израиль (ID: `person:Israel`); Stade (ID: `realia:Stade`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Bless (ID: `keyterm:Bless`); Cause of Joy (ID: `keyterm:CauseOfJoy`); LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Spirit (ID: `keyterm:Spirit.2`); Written (ID: `keyterm:Scripture`); Bow Down (ID: `keyterm:BowDown`); To Cause to Happen (ID: `keyterm:Happen`); Вифания (ID: `place:Bethany`); Height (ID: `keyterm:Height`); To Sin (ID: `keyterm:Sin`); Forgive (ID: `keyterm:Forgive`); Ability (ID: `keyterm:Ability`); Sky (ID: `keyterm:Heaven`); Body (ID: `keyterm:Body.3`); Heart (ID: `keyterm:Heart`); Promise (ID: `keyterm:Promise`); Моисей (ID: `person:Moses`); Repent (ID: `keyterm:Repent`); Witness (ID: `keyterm:Witness`); Disbelieve (ID: `keyterm:Disbelieve`); Law (ID: `keyterm:Law`); Иисус (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); Proclaim (ID: `keyterm:Proclaim`); Fish (ID: `fauna:Fish`); Temple (ID: `realia:Temple`)
