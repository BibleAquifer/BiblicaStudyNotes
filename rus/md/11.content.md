...
* **Associated ACAI Concepts:** Соломон (ID: `person:Solomon`); LORD (ID: `deity:Lord`); Давид (ID: `person:David`); Адония (ID: `person:Adonijah`); Израиль (ID: `person:Israel`); Ванея (ID: `person:Benaiah`); Иодай (ID: `person:Jehoiada`); Нафан (ID: `person:Nathan.2`); Садок (ID: `person:Zadok.2`); Иоав (ID: `person:Joab`); Авиафар (ID: `person:Abiathar`); Шимей (ID: `person:Shimei.5`); Bathsheba (ID: `person:Bathsheba`); Swear (ID: `keyterm:Swear`); Ависаг (ID: `person:Abishag`); Иерусалим (ID: `place:Jerusalem`); Shunammites (ID: `group:Shunammites`); Иуда (ID: `group:Judah`); Peace (ID: `keyterm:IntactState`); Ability (ID: `keyterm:Ability`); Иуда (ID: `person:Judah.4`); House (ID: `realia:House`); Perceive (ID: `keyterm:Perceive`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Аггиф (ID: `person:Haggith`); Египет (ID: `place:Egypt`); Авессалом (ID: `person:Absalom`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Соломон (ID: `person:Solomon`); Израиль (ID: `person:Israel`); Давид (ID: `person:David`); Covenant Box (ID: `keyterm:CovenantBox`); Хирам (ID: `person:Hiram`); To Sin (ID: `keyterm:Sin`); Plea for Mercy (ID: `keyterm:Supplication`); Египет (ID: `place:Egypt`); Bless (ID: `keyterm:Bless`); Covenant (ID: `keyterm:Covenant`); Forgive (ID: `keyterm:Forgive`); Cubit (ID: `realia:Cubit`); Cedar (ID: `flora:Cedar`); Winged Creature (ID: `realia:WingedCreature`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Craftsman (ID: `realia:Craftsman`); Hewn Stone (ID: `realia:HewnStone`); Cattle (ID: `fauna:Bull`); Святое святых (ID: `place:MostHolyPlace`); Хирам (ID: `person:Hiram.2`); To Beg for Mercy (ID: `keyterm:BegForMercy`); To Cause to Possess (ID: `keyterm:Possess`); Ливан (ID: `place:Lebanon`); Моисей (ID: `person:Moses`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Force to Serve (ID: `keyterm:EnticedToServe`); Давид (ID: `person:David`); Израиль (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Соломон (ID: `person:Solomon`); Straightness (ID: `keyterm:Straightness`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Египет (ID: `place:Egypt`); Decree (ID: `keyterm:Decree`); Proverb (ID: `keyterm:Saying`); Гаваон (ID: `place:Gibeon`); Plea for Mercy (ID: `keyterm:Supplication`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иеровоам (ID: `person:Jeroboam`); Израиль (ID: `person:Israel`); Ровоам (ID: `person:Rehoboam`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Bethel (ID: `place:Bethel`); Давид (ID: `person:David`); Ахия (ID: `person:Ahijah.2`); Соломон (ID: `person:Solomon`); Иерусалим (ID: `place:Jerusalem`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); To Sin (ID: `keyterm:Sin`); High Place (ID: `realia:HighPlace`); Donkey (ID: `fauna:Donkey`); Stone Pine (ID: `flora:Pine`); Yoke (ID: `realia:Yoke`); Египет (ID: `place:Egypt`); Силом (ID: `place:Shiloh`); Counsel (ID: `keyterm:Counsel`); Rebel (ID: `keyterm:Rebel`); Lion (ID: `fauna:Lion`); Ноема (ID: `person:Naamah`); Нават (ID: `person:Nebat`); Force to Serve (ID: `keyterm:EnticedToServe`)
