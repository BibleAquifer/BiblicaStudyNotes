...
* **Associated ACAI Concepts:** Соломон (ID: `person:Solomon`); LORD (ID: `deity:Lord`); Давид (ID: `person:David`); Адония (ID: `person:Adonijah`); Израиль (ID: `person:Israel`); Ванея (ID: `person:Benaiah`); Иодай (ID: `person:Jehoiada`); Нафан (ID: `person:Nathan.2`); Садок (ID: `person:Zadok.2`); Иоав (ID: `person:Joab`); Авиафар (ID: `person:Abiathar`); Bathsheba (ID: `person:Bathsheba`); Шимей (ID: `person:Shimei.5`); Swear (ID: `keyterm:Swear`); Ависаг (ID: `person:Abishag`); Иерусалим (ID: `place:Jerusalem`); Shunammites (ID: `group:Shunammites`); Иуда (ID: `group:Judah`); Ability (ID: `keyterm:Ability`); Иуда (ID: `person:Judah.4`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Perceive (ID: `keyterm:Perceive`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Аггиф (ID: `person:Haggith`); Галаад (ID: `place:Gilead`); Offering (ID: `keyterm:Offering`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Соломон (ID: `person:Solomon`); Израиль (ID: `person:Israel`); Давид (ID: `person:David`); Covenant Box (ID: `keyterm:CovenantBox`); Хирам (ID: `person:Hiram`); To Sin (ID: `keyterm:Sin`); Plea for Mercy (ID: `keyterm:Supplication`); Bless (ID: `keyterm:Bless`); Египет (ID: `place:Egypt`); Covenant (ID: `keyterm:Covenant`); Forgive (ID: `keyterm:Forgive`); Cubit (ID: `realia:Cubit`); Cedar (ID: `flora:Cedar`); Winged Creature (ID: `realia:WingedCreature`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Craftsman (ID: `realia:Craftsman`); Hewn Stone (ID: `realia:HewnStone`); Cattle (ID: `fauna:Bull`); Хирам (ID: `person:Hiram.2`); Святое святых (ID: `place:MostHolyPlace`); To Beg for Mercy (ID: `keyterm:BegForMercy`); To Cause to Possess (ID: `keyterm:Possess`); Моисей (ID: `person:Moses`); Тир (ID: `place:Tyre`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Давид (ID: `person:David`); Holy (ID: `keyterm:Holy`); Соломон (ID: `person:Solomon`); Force to Serve (ID: `keyterm:EnticedToServe`); Израиль (ID: `person:Israel`); Straightness (ID: `keyterm:Straightness`); Plea for Mercy (ID: `keyterm:Supplication`); Египет (ID: `place:Egypt`); Decree (ID: `keyterm:Decree`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Proverb (ID: `keyterm:Saying`); Гаваон (ID: `place:Gibeon`)
...
* **Associated ACAI Concepts:** Соломон (ID: `person:Solomon`); LORD (ID: `deity:Lord`); Давид (ID: `person:David`); Израиль (ID: `person:Israel`); Иерусалим (ID: `place:Jerusalem`); фараон (ID: `person:Pharaoh.7`); Ability (ID: `keyterm:Ability`); Египет (ID: `place:Egypt`); Гадад (ID: `person:Hadad.3`); Едом (ID: `place:Edom`); Хирам (ID: `person:Hiram`); Иеровоам (ID: `person:Jeroboam`); House (ID: `realia:House`); царица Савская (ID: `person:QueenOfSheba`); Аммон (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Money (ID: `realia:Money`); Газер (ID: `place:Gezer`); Моав (ID: `place:Moab`); Милло (ID: `place:Millo`); Offering (ID: `keyterm:Offering`); Сидон (ID: `place:Sidon`); Sidonians (ID: `group:Sidon`); Love (ID: `keyterm:Love`); Hittites (ID: `group:Hittite`); Молох (ID: `deity:Molech`); Иоав (ID: `person:Joab`); Хет (ID: `person:Heth`); Edomites (ID: `group:Edom`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иеровоам (ID: `person:Jeroboam`); Израиль (ID: `person:Israel`); Ровоам (ID: `person:Rehoboam`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Bethel (ID: `place:Bethel`); Давид (ID: `person:David`); Ахия (ID: `person:Ahijah.2`); Соломон (ID: `person:Solomon`); Иерусалим (ID: `place:Jerusalem`); House (ID: `realia:House`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); To Sin (ID: `keyterm:Sin`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Donkey (ID: `fauna:Donkey`); Yoke (ID: `realia:Yoke`); Counsel (ID: `keyterm:Counsel`); Rebel (ID: `keyterm:Rebel`); Силом (ID: `place:Shiloh`); Египет (ID: `place:Egypt`); Lion (ID: `fauna:Lion`); Ноема (ID: `person:Naamah`); Нават (ID: `person:Nebat`); Шехем (ID: `place:Shechem`)
