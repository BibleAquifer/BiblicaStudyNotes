...
* **Associated ACAI Concepts:** Соломон (ID: `person:Solomon`); LORD (ID: `deity:Lord`); Давид (ID: `person:David`); Адония (ID: `person:Adonijah`); Израиль (ID: `person:Israel`); Ванея (ID: `person:Benaiah`); Иодай (ID: `person:Jehoiada`); Нафан (ID: `person:Nathan.2`); Садок (ID: `person:Zadok.2`); Иоав (ID: `person:Joab`); Авиафар (ID: `person:Abiathar`); Bathsheba (ID: `person:Bathsheba`); Шимей (ID: `person:Shimei.5`); Swear (ID: `keyterm:Swear`); Ависаг (ID: `person:Abishag`); Иерусалим (ID: `place:Jerusalem`); Shunammites (ID: `group:Shunammites`); Peace (ID: `keyterm:IntactState`); Ability (ID: `keyterm:Ability`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); House (ID: `realia:House`); Perceive (ID: `keyterm:Perceive`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Аггиф (ID: `person:Haggith`); Галаад (ID: `place:Gilead`); Саруина (ID: `person:Zeruiah`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Израиль (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Force to Serve (ID: `keyterm:EnticedToServe`); Соломон (ID: `person:Solomon`); Давид (ID: `person:David`); Straightness (ID: `keyterm:Straightness`); Гаваон (ID: `place:Gibeon`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Proverb (ID: `keyterm:Saying`); Plea for Mercy (ID: `keyterm:Supplication`); Египет (ID: `place:Egypt`); Decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** Соломон (ID: `person:Solomon`); LORD (ID: `deity:Lord`); Давид (ID: `person:David`); Израиль (ID: `person:Israel`); Иерусалим (ID: `place:Jerusalem`); фараон (ID: `person:Pharaoh.7`); Ability (ID: `keyterm:Ability`); Египет (ID: `place:Egypt`); Гадад (ID: `person:Hadad.3`); Хирам (ID: `person:Hiram`); Едом (ID: `place:Edom`); Иеровоам (ID: `person:Jeroboam`); House (ID: `realia:House`); царица Савская (ID: `person:QueenOfSheba`); Аммон (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Money (ID: `realia:Money`); Love (ID: `keyterm:Love`); Иоав (ID: `person:Joab`); Сидон (ID: `place:Sidon`); Моав (ID: `place:Moab`); Sidonians (ID: `group:Sidon`); Хет (ID: `person:Heth`); Edomites (ID: `group:Edom`); Газер (ID: `place:Gezer`); Молох (ID: `deity:Molech`); Hittites (ID: `group:Hittite`); Offering (ID: `keyterm:Offering`); Милло (ID: `place:Millo`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иеровоам (ID: `person:Jeroboam`); Израиль (ID: `person:Israel`); Ровоам (ID: `person:Rehoboam`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Bethel (ID: `place:Bethel`); Давид (ID: `person:David`); Ахия (ID: `person:Ahijah.2`); Иерусалим (ID: `place:Jerusalem`); Соломон (ID: `person:Solomon`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); To Sin (ID: `keyterm:Sin`); Stone Pine (ID: `flora:Pine`); Donkey (ID: `fauna:Donkey`); High Place (ID: `realia:HighPlace`); Yoke (ID: `realia:Yoke`); Силом (ID: `place:Shiloh`); Египет (ID: `place:Egypt`); Rebel (ID: `keyterm:Rebel`); Counsel (ID: `keyterm:Counsel`); Lion (ID: `fauna:Lion`); Ноема (ID: `person:Naamah`); Нават (ID: `person:Nebat`); Symbol (ID: `keyterm:Example`)
