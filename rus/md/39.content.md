...
* **Associated Passages:** Малахия 1:1-5
* **Associated Articles:** Родословие  (ID: `193302@BiblicaStudyNotesKeyTerms`); Бог избирает (ID: `193311@BiblicaStudyNotesKeyTerms`); Суд (ID: `193315@BiblicaStudyNotesKeyTerms`); Завет (ID: `193319@BiblicaStudyNotesKeyTerms`); Авраам (ID: `193325@BiblicaStudyNotesKeyTerms`); Завет с Авраамом (ID: `193335@BiblicaStudyNotesKeyTerms`); Иаков, патриарх (ID: `193350@BiblicaStudyNotesKeyTerms`); Израиль (ID: `193362@BiblicaStudyNotesKeyTerms`); Иуда, патриарх (ID: `193373@BiblicaStudyNotesKeyTerms`); Божий народ (ID: `193384@BiblicaStudyNotesKeyTerms`); Храм (ID: `193499@BiblicaStudyNotesKeyTerms`); Южное Царство (ID: `193562@BiblicaStudyNotesKeyTerms`); Вавилон (ID: `193580@BiblicaStudyNotesKeyTerms`); Иудей (ID: `193585@BiblicaStudyNotesKeyTerms`); Персия (ID: `193591@BiblicaStudyNotes`); Малахия (ID: `193660@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Едом (ID: `place:Edom`); Израиль (ID: `person:Israel`); Edomites (ID: `group:Edom`); Малахия (ID: `person:Malachi`); Utterance (ID: `keyterm:Utterance`); To Cause to Possess (ID: `keyterm:Possess`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Love (ID: `keyterm:Love`); Jackal (ID: `fauna:Jackal`)
...
* **Associated Passages:** Малахия 1:6-3:15
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Covenant (ID: `keyterm:Covenant`); Instruction (ID: `keyterm:Instruction`); Fear (ID: `keyterm:Fear`); Израиль (ID: `person:Israel`); Левий (ID: `group:Levi`); To Curse (ID: `keyterm:Curse`); To Dishonor (ID: `keyterm:Dishonor`); Левий (ID: `person:Levi.3`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Glory (ID: `keyterm:Glory`); Bless (ID: `keyterm:Bless`); Peace (ID: `keyterm:IntactState`); Pure (ID: `keyterm:Pure`); Иерусалим (ID: `place:Jerusalem`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Defile (ID: `keyterm:Stain`); Priests (ID: `group:GenericPriests`); An Angel (ID: `deity:Angel`); Fairness (ID: `keyterm:Fairness`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Vow (ID: `keyterm:Vow`); Swear (ID: `keyterm:Swear`); Love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); Intention (ID: `keyterm:Intention`); The Way (ID: `keyterm:TheWay`); A Group of People (ID: `group:GenericGroup`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Ask for (ID: `keyterm:AskFor`); Passion (ID: `keyterm:Ardour`); Delight (ID: `keyterm:Delight`); Force to Serve (ID: `keyterm:EnticedToServe`); Decree (ID: `keyterm:Decree`); Gentiles (ID: `group:Gentile`); Hammada (ID: `flora:Soap`); Soap (ID: `realia:Soap`); House (ID: `realia:House`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`); Flock (ID: `fauna:Flock`)
...
* **Associated Passages:** Малахия 3:16-4:3
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Force to Serve (ID: `keyterm:EnticedToServe`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`); Scroll (ID: `realia:Scroll`); Molten Image (ID: `realia:MoltenImage`)
...
* **Associated Passages:** Малахия 4:4-6
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); Mount Sinai (ID: `place:SinaiMount`); Елия (ID: `person:Elijah`); LORD (ID: `deity:Lord`); Decree (ID: `keyterm:Decree`); Fear (ID: `keyterm:Fear`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Моисей (ID: `person:Moses`); Израиль (ID: `person:Israel`)
