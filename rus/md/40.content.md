...
* **Associated ACAI Concepts:** Давид (ID: `person:David`); Иисус (ID: `person:Jesus.2`); Вавилон (ID: `place:Babylon`); Авраам (ID: `person:Abraham`); Иаков (ID: `person:Jacob.2`); Азор (ID: `person:Azor`); Елиуд (ID: `person:Eliud`); Зоровавель (ID: `person:Zerubbabel.2`); Узия (ID: `person:Uzziah`); Иосия (ID: `person:Josiah`); Езекия (ID: `person:Hezekiah`); Аса (ID: `person:Asa`); Иехония (ID: `person:Jehoiachin`); Салмон (ID: `person:Salmon`); Рам (ID: `person:Ram`); Соломон (ID: `person:Solomon`); Иессей (ID: `person:Jesse`); Иуда (ID: `person:Judah.4`); Ахим (ID: `person:Achim`); Зерах (ID: `person:Zerah.3`); Иосафат (ID: `person:Jehoshaphat.3`); Исаак (ID: `person:Isaac`); Вооз (ID: `person:Boaz`); Елиаким (ID: `person:Eliakim`); Садок (ID: `person:Zadok`); Ахаз (ID: `person:Ahaz`); Елеазар (ID: `person:Eleazar`); Матфан (ID: `person:Matthan`); Авия (ID: `person:Abijah.4`); Есром (ID: `person:Hezron.2`); Наассон (ID: `person:Nahshon`); Фарес (ID: `person:Perez`); Ровоам (ID: `person:Rehoboam`); Иорам (ID: `person:Jehoram`); Овид (ID: `person:Obed`); Фамарь (ID: `person:Tamar`); Авиуд (ID: `person:Abiud`); Иофам (ID: `person:Jotham.2`); Амон (ID: `person:Amon.3`); Иосиф (ID: `person:Joseph.4`); Раав (ID: `person:Rahab`); Израиль (ID: `person:Israel`); Аминадав (ID: `person:Amminadab`); Урия (ID: `person:Uriah`); Руфь (ID: `person:Ruth`); Салафиил (ID: `person:Shealtiel.2`); Манассия (ID: `person:Manasseh.2`); Мария (ID: `person:Mary`)
...
* **Associated ACAI Concepts:** Ирод (ID: `person:Herod`); Вифлеем (ID: `place:Bethlehem`); Египет (ID: `place:Egypt`); Bow Down (ID: `keyterm:BowDown`); Иудея (ID: `place:Judea`); LORD (ID: `deity:Lord`); To Cause to Happen (ID: `keyterm:Happen`); Израиль (ID: `person:Israel`); Иосиф (ID: `person:Joseph.4`); An Angel (ID: `deity:Angel`); Иерусалим (ID: `place:Jerusalem`); Иисус (ID: `person:Jesus.2`); Назарет (ID: `place:Nazareth`); Архелай (ID: `person:Archelaus`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Иеремия (ID: `person:Jeremiah.6`); Offering (ID: `keyterm:Offering`); Priests (ID: `group:GenericPriests`); Ask for (ID: `keyterm:AskFor`); A Priest (ID: `person:GenericPriest`); Fear (ID: `keyterm:Fear`); Encourage (ID: `keyterm:Encourage`); Religious Officials (ID: `group:ReligiousOfficials`); Галилея (ID: `place:Galilee`); Рахиль (ID: `person:Rachel`); Мария (ID: `person:Mary`); Life (ID: `keyterm:Life`); Ramah (ID: `place:Ramah.2`); Иуда (ID: `person:Judah.4`); Jews (ID: `group:Jews`); Frankincense (ID: `flora:Frankincense`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Money Box (ID: `realia:MoneyBox`); Incense (ID: `realia:Incense`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** Repent (ID: `keyterm:Repent`); Baptism (ID: `keyterm:Baptism`); Иудея (ID: `place:Judea`); Иоанн (ID: `person:John`); LORD (ID: `deity:Lord`); Jordan River (ID: `place:Jordan`); Исаия (ID: `person:Isaiah`); Baptist (ID: `keyterm:Baptist`); Sky (ID: `keyterm:Heaven`); Proclaim (ID: `keyterm:Proclaim`); Авраам (ID: `person:Abraham`); Pharisees (ID: `group:Pharisee`); Kingdom (ID: `keyterm:Kingdom`); Иерусалим (ID: `place:Jerusalem`); Sadducees (ID: `group:Sadducee`); Straightness (ID: `keyterm:Straightness`); Святой Дух (ID: `deity:HolySpirit`); Clean Out (ID: `keyterm:CleanOut`); To Sin (ID: `keyterm:Sin`); Locust (ID: `fauna:Locust`); Threshing Floor (ID: `realia:ThreshingFloor`); Leather (ID: `realia:Leather`); Belt (ID: `realia:Belt`); Winnowing Fork (ID: `realia:WinnowingFork`); Sandal (ID: `realia:Sandal`); Clothing (ID: `realia:Clothing`); Snake (ID: `fauna:Snake`); Grain (ID: `flora:Grain`); Bag (ID: `realia:Bag`); Camel (ID: `fauna:Camel`); Bee (ID: `fauna:Bee`); Wheat (ID: `flora:Wheat`); Barn (ID: `realia:Barn`); Axe (ID: `realia:Axe`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иисус (ID: `person:Jesus.2`); Put to the Test (ID: `keyterm:PutToTheTest`); Bow Down (ID: `keyterm:BowDown`); To Command (ID: `keyterm:Command`); An Angel (ID: `deity:Angel`); Serve (ID: `keyterm:Serve`); Word (ID: `keyterm:Word`); Priesthood (ID: `keyterm:Priesthood`); Kingdom (ID: `keyterm:Kingdom`); сатана (ID: `deity:Satan`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); Святой Дух (ID: `deity:HolySpirit`); Abstain from Food (ID: `keyterm:Fast`); Holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); Pinnacle (ID: `realia:Pinnacle`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Галилея (ID: `place:Galilee`); Завулон (ID: `person:Zebulun`); Завулон (ID: `group:Zebulun`); Неффалим (ID: `person:Naphtali`); Repent (ID: `keyterm:Repent`); Назарет (ID: `place:Nazareth`); Proclaim (ID: `keyterm:Proclaim`); Sky (ID: `keyterm:Heaven`); To Cause to Happen (ID: `keyterm:Happen`); Капернаум (ID: `place:Capernaum`); Kingdom (ID: `keyterm:Kingdom`); Иисус (ID: `person:Jesus.2`); Jordan River (ID: `place:Jordan`); Иоанн (ID: `person:John`); Исаия (ID: `person:Isaiah`); Gentiles (ID: `group:Gentile`)
...
* **Associated ACAI Concepts:** Casting Net (ID: `realia:CastingNet`); Галилея (ID: `place:Galilee`); Serve (ID: `keyterm:Serve`); Андрей (ID: `person:Andrew`); Fishnet (ID: `realia:Fishnet`); Ship (ID: `realia:Ship`); Зеведей (ID: `person:Zebedee`); Иоанн (ID: `person:John.2`); Good News (ID: `keyterm:GoodNews`); Sea of Galilee (ID: `place:GalileeSea`); Десятиградие (ID: `place:Decapolis`); Иаков (ID: `person:James`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); Proclaim (ID: `keyterm:Proclaim`); Иудея (ID: `place:Judea`); Kingdom (ID: `keyterm:Kingdom`); Иерусалим (ID: `place:Jerusalem`); Jordan River (ID: `place:Jordan`); Пётр (ID: `person:Peter`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Fornication (ID: `keyterm:Fornication`); Gehenna (ID: `keyterm:Gehenna`); Hell (ID: `place:Hell`); Love (ID: `keyterm:Love`); Court Case (ID: `keyterm:CourtCase`); Offering (ID: `keyterm:Offering`); Sky (ID: `keyterm:Heaven`); Cause to Stumble (ID: `keyterm:CauseToStumble`); Body (ID: `keyterm:Body.3`); Judgment (ID: `keyterm:Judgment`); Reconcile (ID: `keyterm:Reconcile`); Oath (ID: `keyterm:Oath`); Heavenly (ID: `keyterm:Heavenly`); Good (ID: `keyterm:Good`); Heart (ID: `keyterm:Heart`); Decided (ID: `keyterm:Decided`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Иерусалим (ID: `place:Jerusalem`); Pray (ID: `keyterm:Pray`); Tax Collector (ID: `keyterm:TaxCollector`); Surely! (ID: `keyterm:Surely`); Footstool (ID: `realia:Footstool`); Cloak (ID: `realia:Cloak`); Quadrans (ID: `realia:Quadrans`); Mile (ID: `realia:Mile`); Prison (ID: `realia:Prison`); Tunic (ID: `realia:Tunic.2`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Abstain from Food (ID: `keyterm:Fast`); Body (ID: `keyterm:Body.3`); Sky (ID: `keyterm:Heaven`); Heavenly (ID: `keyterm:Heavenly`); Clothing (ID: `realia:Clothing`); Moth (ID: `fauna:Moth`); Having Little Faith (ID: `keyterm:HavingLittleFaith`); Heart (ID: `keyterm:Heart`); Kingdom (ID: `keyterm:Kingdom`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Be Enslaved (ID: `keyterm:Serve.2`); Life (ID: `keyterm:Life`); Anointed (ID: `keyterm:Anointed`); Surely! (ID: `keyterm:Surely`); Соломон (ID: `person:Solomon`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Oven (ID: `realia:Oven`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Barn (ID: `realia:Barn`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Lawless (ID: `keyterm:Lawless`); Destroy (ID: `keyterm:Destroy`); Sky (ID: `keyterm:Heaven`); Kingdom (ID: `keyterm:Kingdom`); Demons (ID: `deity:Demons`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); LORD (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Speak as a Prophet (ID: `keyterm:Speak`); Thistle (ID: `flora:Thistle`); Brier (ID: `flora:Brier`); Clothing (ID: `realia:Clothing`); Wolf (ID: `fauna:Wolf`); Fig (ID: `flora:Fig`); Sheep (ID: `fauna:Lamb`); Vine (ID: `flora:Vine`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Authority (ID: `keyterm:Authority.2`); Иисус (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Forgive (ID: `keyterm:Forgive`); To Sin (ID: `keyterm:Sin`); Be a Disciple (ID: `keyterm:Disciple`); House (ID: `realia:House`); Tax Collector (ID: `keyterm:TaxCollector`); Authority (ID: `keyterm:Authority.2`); Pharisees (ID: `group:Pharisee`); Ability (ID: `keyterm:Ability`); Abstain from Food (ID: `keyterm:Fast`); Temple (ID: `realia:Temple`); Bed (ID: `realia:Bed`); Mercy (ID: `keyterm:Mercy`); Матфей (ID: `person:Matthew`); Heart (ID: `keyterm:Heart`); Offering (ID: `keyterm:Offering`); Blaspheme (ID: `keyterm:Blaspheme`); Be Healthy (ID: `keyterm:Healthy`); Fear (ID: `keyterm:Fear`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Religious Officials (ID: `group:ReligiousOfficials`); Cheer Up (ID: `keyterm:CheerUp`); LORD (ID: `deity:Lord`); Tax Office (ID: `keyterm:TaxOffice`); Believe (ID: `keyterm:Believe`); Glory (ID: `keyterm:Glory`); Иоанн (ID: `person:John`); Patch (ID: `realia:Patch`); Must (ID: `realia:Must`); Wine (ID: `realia:Wine`); Clothing (ID: `realia:Clothing`); Ship (ID: `realia:Ship`); Skin-Bottle (ID: `realia:Skin-bottle`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Believe (ID: `keyterm:Believe`); Demons (ID: `deity:Demons`); Salvation (ID: `keyterm:Salvation`); Be a Disciple (ID: `keyterm:Disciple`); House (ID: `realia:House`); Cloak (ID: `realia:Cloak`); Affection (ID: `keyterm:Affection`); Ask for (ID: `keyterm:AskFor`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); Good News (ID: `keyterm:GoodNews`); Proclaim (ID: `keyterm:Proclaim`); Pharisees (ID: `group:Pharisee`); Kingdom (ID: `keyterm:Kingdom`); Давид (ID: `person:David`); Mercy (ID: `keyterm:Mercy`); Bow Down (ID: `keyterm:BowDown`); Cheer Up (ID: `keyterm:CheerUp`); Life (ID: `keyterm:Life`); Bleed (ID: `keyterm:Bleed`); Израиль (ID: `person:Israel`); Serve (ID: `keyterm:Serve`); Tassel (ID: `realia:Tassel`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Goat (ID: `fauna:Goat`); Flute (ID: `realia:Flute`); Flock (ID: `fauna:Flock`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Serve (ID: `keyterm:Serve`); Bag (ID: `realia:Bag`); Варфоломей (ID: `person:Bartholomew`); Алфей (ID: `person:Alphaeus`); Make Peace (ID: `keyterm:Peace`); Иуда (ID: `person:Judas.2`); Фома (ID: `person:Thomas`); Иуда (ID: `person:Judas`); Зилот (ID: `group:Zealot`); Иаков (ID: `person:James.2`); Симон (ID: `person:Simon.2`); Филипп (ID: `person:Philip`); To Cleanse (ID: `keyterm:Cleanse.2`); Sky (ID: `keyterm:Heaven`); Authority (ID: `keyterm:Authority.2`); Самария (ID: `place:Samaria`); Court Case (ID: `keyterm:CourtCase`); Иоанн (ID: `person:John.2`); Зеведей (ID: `person:Zebedee`); Samaritans (ID: `group:Samaritan`); Proclaim (ID: `keyterm:Proclaim`); Kingdom (ID: `keyterm:Kingdom`); Андрей (ID: `person:Andrew`); Demons (ID: `deity:Demons`); Содом (ID: `place:Sodom`); Гоморра (ID: `place:Gomorrah`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Матфей (ID: `person:Matthew`); Gentiles (ID: `group:Gentile`); Resurrection (ID: `keyterm:Resurrection`); Tax Collector (ID: `keyterm:TaxCollector`); Иисус (ID: `person:Jesus.2`); Judgment (ID: `keyterm:Judgment`); Surely! (ID: `keyterm:Surely`); Иаков (ID: `person:James`); Израиль (ID: `person:Israel`); Пётр (ID: `person:Peter`); Be a Disciple (ID: `keyterm:Disciple`); Staff (ID: `realia:Staff`); Belt (ID: `realia:Belt`); Sheep (ID: `fauna:Lamb`); Tunic (ID: `realia:Tunic.2`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Name (ID: `keyterm:Name`); Be a Disciple (ID: `keyterm:Disciple`); Sky (ID: `keyterm:Heaven`); Surely! (ID: `keyterm:Surely`); Sparrow (ID: `fauna:Sparrow`); Gehenna (ID: `keyterm:Gehenna`); Bear Witness (ID: `keyterm:BearWitness`); To Command (ID: `keyterm:Command`); Friendship (ID: `keyterm:Friendship`); Proclaim (ID: `keyterm:Proclaim`); Make Peace (ID: `keyterm:Peace`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Hell (ID: `place:Hell`); сатана (ID: `deity:Satan`); Gentiles (ID: `group:Gentile`); Body (ID: `keyterm:Body.3`); Life (ID: `keyterm:Life`); Святой Дух (ID: `deity:HolySpirit`); Salvation (ID: `keyterm:Salvation`); Израиль (ID: `person:Israel`); Wolf (ID: `fauna:Wolf`); Assarion (ID: `realia:Assarion`); Snake (ID: `fauna:Snake`); Cross (ID: `realia:Cross`); Sheep (ID: `fauna:Lamb`); Synagogue (ID: `realia:Synagogue`); Dove (ID: `fauna:Dove`); Housetop (ID: `realia:Housetop`)
...
* **Associated ACAI Concepts:** Ability (ID: `keyterm:Ability`); LORD (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Repent (ID: `keyterm:Repent`); Court Case (ID: `keyterm:CourtCase`); Содом (ID: `place:Sodom`); Сидон (ID: `place:Sidon`); Тир (ID: `place:Tyre`); Judgment (ID: `keyterm:Judgment`); Yoke (ID: `realia:Yoke`); Хоразин (ID: `place:Chorazin`); Disaster (ID: `keyterm:Disaster`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Heart (ID: `keyterm:Heart`); Вифсаида (ID: `place:Bethsaida`); Hell (ID: `place:Hell`); Капернаум (ID: `place:Capernaum`); Good (ID: `keyterm:Good`); Иисус (ID: `person:Jesus.2`); Sackcloth (ID: `realia:Sackcloth`)
...
* **Associated ACAI Concepts:** Judgment (ID: `keyterm:Judgment`); Gentiles (ID: `group:Gentile`); Name (ID: `keyterm:Name`); To Cause to Happen (ID: `keyterm:Happen`); Святой Дух (ID: `deity:HolySpirit`); Иисус (ID: `person:Jesus.2`); To Command (ID: `keyterm:Command`); Beloved (ID: `keyterm:Beloved`); Исаия (ID: `person:Isaiah`); Hope (ID: `keyterm:Hope`); Serve (ID: `keyterm:Serve`); Lamp (ID: `realia:Lamp`); Reed (ID: `flora:Reed`)
...
* **Associated ACAI Concepts:** Иона (ID: `person:Jonah.2`); Symbol (ID: `keyterm:Example`); Court Case (ID: `keyterm:CourtCase`); Judgment (ID: `keyterm:Judgment`); царица Савская (ID: `person:QueenOfSheba`); Ниневия (ID: `group:Nineveh`); Heart (ID: `keyterm:Heart`); Sky (ID: `keyterm:Heaven`); Repent (ID: `keyterm:Repent`); Proclaim (ID: `keyterm:Proclaim`); Be Unfaithful (ID: `keyterm:Unfaithful`); Ниневия (ID: `place:Nineveh`); Pharisees (ID: `group:Pharisee`); A Group of People (ID: `group:GenericGroup`); LORD (ID: `deity:Lord`); Соломон (ID: `person:Solomon`); Be a Disciple (ID: `keyterm:Disciple`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Fish (ID: `fauna:Fish`)
...
* **Associated ACAI Concepts:** Parable (ID: `keyterm:Parable`); Heart (ID: `keyterm:Heart`); Kingdom (ID: `keyterm:Kingdom`); Brier (ID: `flora:Brier`); Thistle (ID: `flora:Thistle`); Acacia (ID: `flora:Acacia`); Boxthorn (ID: `flora:Boxthorn`); Sky (ID: `keyterm:Heaven`); Happy (ID: `keyterm:Happy`); A Group of Disciples (ID: `group:GenericDisciples`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Исаия (ID: `person:Isaiah`); Always (ID: `keyterm:Always`); Ability (ID: `keyterm:Ability`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Иисус (ID: `person:Jesus.2`); Surely! (ID: `keyterm:Surely`); Be a Disciple (ID: `keyterm:Disciple`); House (ID: `realia:House`); Bird (ID: `fauna:Bird`); Ship (ID: `realia:Ship`); Rooster (ID: `fauna:Rooster`)
...
* **Associated ACAI Concepts:** Kingdom (ID: `keyterm:Kingdom`); Sky (ID: `keyterm:Heaven`); Parable (ID: `keyterm:Parable`); Weed (ID: `flora:Weed`); Grain (ID: `flora:Grain`); An Angel (ID: `deity:Angel`); Always (ID: `keyterm:Always`); Wheat (ID: `flora:Wheat`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Be a Disciple (ID: `keyterm:Disciple`); Kiln (ID: `realia:Kiln`); Grass (ID: `flora:Grass`); Lawless (ID: `keyterm:Lawless`); Stumbling Block (ID: `keyterm:StumblingBlock`); Ability (ID: `keyterm:Ability`); LORD (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); To Cause to Happen (ID: `keyterm:Happen`); Иисус (ID: `person:Jesus.2`); Dragnet (ID: `realia:Dragnet`); Saton (ID: `realia:Saton`); Mustard (ID: `flora:Mustard`); Storeroom (ID: `realia:Storeroom`); House (ID: `realia:House`); Barn (ID: `realia:Barn`); Container (ID: `realia:Container`)
...
* **Associated ACAI Concepts:** Иоанн (ID: `person:John`); Иисус (ID: `person:Jesus.2`); Ирод Антипа (ID: `person:Herod.2`); Ability (ID: `keyterm:Ability`); Иродиада (ID: `person:Herodias`); Oath (ID: `keyterm:Oath`); Baptist (ID: `keyterm:Baptist`); Prison (ID: `realia:Prison`); Plate (ID: `realia:Plate.2`); Иуда (ID: `person:Jude`); Симон (ID: `person:Simon.3`); Disbelieve (ID: `keyterm:Disbelieve`); Daughter of Herodias (ID: `person:DaughterOfHerodias`); Иаков (ID: `person:James.3`); Филипп (ID: `person:Philip.2`); Fear (ID: `keyterm:Fear`); Be Lawful (ID: `keyterm:Lawful`); Мария (ID: `person:Mary`); Иосиф (ID: `person:Joseph.4`); Resurrection (ID: `keyterm:Resurrection`); Parable (ID: `keyterm:Parable`); Be a Disciple (ID: `keyterm:Disciple`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Fish (ID: `fauna:Fish`); Affection (ID: `keyterm:Affection`); Sky (ID: `keyterm:Heaven`); Bless (ID: `keyterm:Bless`); Serve (ID: `keyterm:Serve`); Basket (ID: `realia:Basket`); Ship (ID: `realia:Ship`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); Fear (ID: `keyterm:Fear`); Иисус (ID: `person:Jesus.2`); Salvation (ID: `keyterm:Salvation`); Пётр (ID: `person:Peter`); Be a Disciple (ID: `keyterm:Disciple`); Having Little Faith (ID: `keyterm:HavingLittleFaith`); Геннисаретская (ID: `place:Gennesaret`); Cheer Up (ID: `keyterm:CheerUp`); Bow Down (ID: `keyterm:BowDown`); Ask for (ID: `keyterm:AskFor`); True (ID: `keyterm:True`); Pray (ID: `keyterm:Pray`); Tassel (ID: `realia:Tassel`); Stade (ID: `realia:Stade`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Teaching (ID: `keyterm:Teaching`); Heart (ID: `keyterm:Heart`); Defilement (ID: `keyterm:Defilement`); Pharisees (ID: `group:Pharisee`); Be a Disciple (ID: `keyterm:Disciple`); Offering (ID: `keyterm:Offering`); Blaspheme (ID: `keyterm:Blaspheme`); Worship (ID: `keyterm:Worship`); A Group of Disciples (ID: `group:GenericDisciples`); Commandment (ID: `keyterm:Commandment`); Исаия (ID: `person:Isaiah`); Иерусалим (ID: `place:Jerusalem`); Heavenly (ID: `keyterm:Heavenly`); Fornication (ID: `keyterm:Fornication`); Parable (ID: `keyterm:Parable`); Иисус (ID: `person:Jesus.2`); Speak as a Prophet (ID: `keyterm:Speak`); Пётр (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Dog (ID: `fauna:Dog`); Тир (ID: `place:Tyre`); Syrophonecian Woman (ID: `person:SyrophonecianWoman`); Сидон (ID: `place:Sidon`); Believe (ID: `keyterm:Believe`); Honest (ID: `keyterm:Honest`); Bow Down (ID: `keyterm:BowDown`); Ask for (ID: `keyterm:AskFor`); Давид (ID: `person:David`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); Canaanites (ID: `group:Canaan`); Израиль (ID: `person:Israel`); Mercy (ID: `keyterm:Mercy`); Be a Disciple (ID: `keyterm:Disciple`); Ханаан (ID: `place:Canaan`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Fish (ID: `fauna:Fish`); Магдалинские (ID: `place:Magadan`); Affection (ID: `keyterm:Affection`); LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Glory (ID: `keyterm:Glory`); Sea of Galilee (ID: `place:GalileeSea`); Serve (ID: `keyterm:Serve`); Ship (ID: `realia:Ship`); Basket (ID: `realia:Basket`)
...
* **Associated ACAI Concepts:** Sadducees (ID: `group:Sadducee`); Pharisees (ID: `group:Pharisee`); Sky (ID: `keyterm:Heaven`); Symbol (ID: `keyterm:Example`); Иисус (ID: `person:Jesus.2`); Basket (ID: `realia:Basket`); Having Little Faith (ID: `keyterm:HavingLittleFaith`); Discern (ID: `keyterm:Discern`); Be a Disciple (ID: `keyterm:Disciple`); Иона (ID: `person:Jonah.2`); Be Unfaithful (ID: `keyterm:Unfaithful`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Пётр (ID: `person:Peter`); Be a Disciple (ID: `keyterm:Disciple`); LORD (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Sky (ID: `keyterm:Heaven`); Кесария Филиппова (ID: `place:CaesareaPhilippi`); Church (ID: `keyterm:Church`); Ask for (ID: `keyterm:AskFor`); To Command (ID: `keyterm:Command`); Happy (ID: `keyterm:Happy`); A Group of Disciples (ID: `group:GenericDisciples`); Елия (ID: `person:Elijah`); Kingdom (ID: `keyterm:Kingdom`); Think (ID: `keyterm:Think`); Иоанн (ID: `person:John.4`); An Angel (ID: `deity:Angel`); Иерусалим (ID: `place:Jerusalem`); Stumbling Block (ID: `keyterm:StumblingBlock`); Baptist (ID: `keyterm:Baptist`); Hell (ID: `place:Hell`); World of the Dead (ID: `keyterm:WorldOfTheDead`); сатана (ID: `deity:Satan`); Ability (ID: `keyterm:Ability`); Body (ID: `keyterm:Body.3`); Blood (ID: `keyterm:Blood`); Resurrection (ID: `keyterm:Resurrection`); Иеремия (ID: `person:Jeremiah.6`); Salvation (ID: `keyterm:Salvation`); Glory (ID: `keyterm:Glory`); Иоанн (ID: `person:John`); Key (ID: `realia:Key`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Елия (ID: `person:Elijah`); Иисус (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Fear (ID: `keyterm:Fear`); Моисей (ID: `person:Moses`); Пётр (ID: `person:Peter`); Resurrection (ID: `keyterm:Resurrection`); Baptist (ID: `keyterm:Baptist`); Kingdom (ID: `keyterm:Kingdom`); To Command (ID: `keyterm:Command`); Surely! (ID: `keyterm:Surely`); Beloved (ID: `keyterm:Beloved`); Иаков (ID: `person:James`); Иоанн (ID: `person:John.2`); Иоанн (ID: `person:John`); Clothing (ID: `realia:Clothing`); Tent (ID: `realia:Tent`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Пётр (ID: `person:Peter`); Be a Disciple (ID: `keyterm:Disciple`); Serve (ID: `keyterm:Serve`); To Command (ID: `keyterm:Command`); Be Unfaithful (ID: `keyterm:Unfaithful`); A Group of Disciples (ID: `group:GenericDisciples`); Tax (ID: `keyterm:Tax`); Demons (ID: `deity:Demons`); Mercy (ID: `keyterm:Mercy`); Галилея (ID: `place:Galilee`); Resurrection (ID: `keyterm:Resurrection`); Believe (ID: `keyterm:Believe`); Капернаум (ID: `place:Capernaum`); Poll Tax (ID: `keyterm:PollTax`); Surely! (ID: `keyterm:Surely`); Mustard (ID: `flora:Mustard`); Stater (ID: `realia:Stater`); Fishhook (ID: `realia:Fishhook`); Two-Drachma Piece (ID: `realia:Two-drachmaPiece`); House (ID: `realia:House`); Fish (ID: `fauna:Fish`); Grain (ID: `flora:Grain`)
...
* **Associated ACAI Concepts:** Sky (ID: `keyterm:Heaven`); Cause to Stumble (ID: `keyterm:CauseToStumble`); Kingdom (ID: `keyterm:Kingdom`); Life (ID: `keyterm:Life`); Stumbling Block (ID: `keyterm:StumblingBlock`); Disaster (ID: `keyterm:Disaster`); An Angel (ID: `deity:Angel`); Always (ID: `keyterm:Always`); Name (ID: `keyterm:Name`); Hell (ID: `place:Hell`); Ability (ID: `keyterm:Ability`); Eternal Fire (ID: `keyterm:EternalFire`); LORD (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Gehenna (ID: `keyterm:Gehenna`); Иисус (ID: `person:Jesus.2`); Surely! (ID: `keyterm:Surely`); Be a Disciple (ID: `keyterm:Disciple`); Hand-Mill (ID: `realia:Hand-mill`)
...
* **Associated ACAI Concepts:** Forgive (ID: `keyterm:Forgive`); Owe (ID: `keyterm:Owe`); Sky (ID: `keyterm:Heaven`); Ask for (ID: `keyterm:AskFor`); LORD (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Surely! (ID: `keyterm:Surely`); Witness (ID: `keyterm:Witness`); Heart (ID: `keyterm:Heart`); Kingdom (ID: `keyterm:Kingdom`); Mercy (ID: `keyterm:Mercy`); Name (ID: `keyterm:Name`); Affection (ID: `keyterm:Affection`); Bow Down (ID: `keyterm:BowDown`); Heavenly (ID: `keyterm:Heavenly`); Tax Collector (ID: `keyterm:TaxCollector`); Иисус (ID: `person:Jesus.2`); Church (ID: `keyterm:Church`); Debt (ID: `keyterm:Debt`); Пётр (ID: `person:Peter`); Word (ID: `keyterm:Word`); Prison (ID: `realia:Prison`); Denarius (ID: `realia:Denarius`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** Sky (ID: `keyterm:Heaven`); To Command (ID: `keyterm:Command`); Kingdom (ID: `keyterm:Kingdom`); Моисей (ID: `person:Moses`); Body (ID: `keyterm:Body.3`); Иисус (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); A Group of Disciples (ID: `group:GenericDisciples`); Иудея (ID: `place:Judea`); Pharisees (ID: `group:Pharisee`); Hardheartedness (ID: `keyterm:Hardheartedness`); Be Lawful (ID: `keyterm:Lawful`); Галилея (ID: `place:Galilee`); LORD (ID: `deity:Lord`); Fornication (ID: `keyterm:Fornication`); Pray (ID: `keyterm:Pray`); Jordan River (ID: `place:Jordan`); Serve (ID: `keyterm:Serve`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Life (ID: `keyterm:Life`); Sky (ID: `keyterm:Heaven`); Kingdom (ID: `keyterm:Kingdom`); Rich Young Ruler (ID: `person:RichYoungRuler`); Always (ID: `keyterm:Always`); LORD (ID: `deity:Lord`); Good (ID: `keyterm:Good`); Surely! (ID: `keyterm:Surely`); Be a Disciple (ID: `keyterm:Disciple`); Ask for (ID: `keyterm:AskFor`); New World (ID: `keyterm:NewWorld`); Commandment (ID: `keyterm:Commandment`); Decided (ID: `keyterm:Decided`); Name (ID: `keyterm:Name`); Fornication (ID: `keyterm:Fornication`); Salvation (ID: `keyterm:Salvation`); Израиль (ID: `person:Israel`); Пётр (ID: `person:Peter`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Needle (ID: `realia:Needle`); Camel (ID: `fauna:Camel`); House (ID: `realia:House`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Иерусалим (ID: `place:Jerusalem`); To Command (ID: `keyterm:Command`); Давид (ID: `person:David`); Mercy (ID: `keyterm:Mercy`); Serve (ID: `keyterm:Serve`); Authority (ID: `keyterm:Authority.2`); Зеведей (ID: `person:Zebedee`); Kingdom (ID: `keyterm:Kingdom`); Иерихон (ID: `place:Jericho`); Affection (ID: `keyterm:Affection`); Bow Down (ID: `keyterm:BowDown`); Condemn (ID: `keyterm:Condemn`); LORD (ID: `deity:Lord`); Gentiles (ID: `group:Gentile`); Life (ID: `keyterm:Life`); Resurrection (ID: `keyterm:Resurrection`); Ransom (ID: `keyterm:Ransom`); Be a Disciple (ID: `keyterm:Disciple`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Temple (ID: `realia:Temple`); Иерусалим (ID: `place:Jerusalem`); Donkey (ID: `fauna:Donkey`); Hosanna (ID: `keyterm:Hosanna`); Давид (ID: `person:David`); Be a Disciple (ID: `keyterm:Disciple`); Clothing (ID: `realia:Clothing`); Виффагия (ID: `place:Bethphage`); To Command (ID: `keyterm:Command`); Bless (ID: `keyterm:Bless`); Назарет (ID: `place:Nazareth`); Галилея (ID: `place:Galilee`); Name (ID: `keyterm:Name`); Вифания (ID: `place:Bethany`); A Group of People (ID: `group:GenericGroup`); LORD (ID: `deity:Lord`); Pray (ID: `keyterm:Pray`); To Cause to Happen (ID: `keyterm:Happen`); Height (ID: `keyterm:Height`); Serve (ID: `keyterm:Serve`); Seat (ID: `realia:Seat`); House (ID: `realia:House`); Dove (ID: `fauna:Dove`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Believe (ID: `keyterm:Believe`); Authority (ID: `keyterm:Authority.2`); Иисус (ID: `person:Jesus.2`); Ability (ID: `keyterm:Ability`); Fig (ID: `flora:Fig`); Иоанн (ID: `person:John`); Baptism (ID: `keyterm:Baptism`); Sky (ID: `keyterm:Heaven`); Ask for (ID: `keyterm:AskFor`); Fear (ID: `keyterm:Fear`); Surely! (ID: `keyterm:Surely`); Always (ID: `keyterm:Always`); Pray (ID: `keyterm:Pray`); Discern (ID: `keyterm:Discern`); Be a Disciple (ID: `keyterm:Disciple`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); LORD (ID: `deity:Lord`); Tax Collector (ID: `keyterm:TaxCollector`); Repent (ID: `keyterm:Repent`); Kingdom (ID: `keyterm:Kingdom`); Parable (ID: `keyterm:Parable`); Иисус (ID: `person:Jesus.2`); Reject (ID: `keyterm:Reject`); Written (ID: `keyterm:Scripture`); Pharisees (ID: `group:Pharisee`); Fear (ID: `keyterm:Fear`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Believe (ID: `keyterm:Believe`); Surely! (ID: `keyterm:Surely`); Иоанн (ID: `person:John`); Winepress (ID: `realia:Winepress`); Cornerstone (ID: `realia:Cornerstone`); Tower (ID: `realia:Tower`); Watch-Tower (ID: `realia:Watch-tower`); Thorn Hedge (ID: `realia:ThornHedge`)
...
* **Associated ACAI Concepts:** Clothing (ID: `realia:Clothing`); Sky (ID: `keyterm:Heaven`); Good (ID: `keyterm:Good`); Kingdom (ID: `keyterm:Kingdom`); Parable (ID: `keyterm:Parable`); Иисус (ID: `person:Jesus.2`); To Command (ID: `keyterm:Command`); Chosen (ID: `keyterm:Chosen`); Outer Darkness (ID: `keyterm:OuterDarkness`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Resurrection (ID: `keyterm:Resurrection`); Тиверий (ID: `person:Tiberius`); Иисус (ID: `person:Jesus.2`); Poll Tax (ID: `keyterm:PollTax`); Herodians (ID: `group:Herodian`); Sadducees (ID: `group:Sadducee`); Израиль (ID: `person:Israel`); Written (ID: `keyterm:Scripture`); Sky (ID: `keyterm:Heaven`); True (ID: `keyterm:True`); Исаак (ID: `person:Isaac`); Авраам (ID: `person:Abraham`); Pharisees (ID: `group:Pharisee`); An Angel (ID: `deity:Angel`); Be Lawful (ID: `keyterm:Lawful`); The Way (ID: `keyterm:TheWay`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); Моисей (ID: `person:Moses`); Life (ID: `keyterm:Life`); Be a Disciple (ID: `keyterm:Disciple`); Money (ID: `realia:Money`); Denarius (ID: `realia:Denarius`); Image (ID: `realia:Image`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Commandment (ID: `keyterm:Commandment`); Давид (ID: `person:David`); Pharisees (ID: `group:Pharisee`); Иисус (ID: `person:Jesus.2`); Love (ID: `keyterm:Love`); Law (ID: `keyterm:Law`); Heart (ID: `keyterm:Heart`); Mind (ID: `keyterm:Mind.2`); Святой Дух (ID: `deity:HolySpirit`); Sadducees (ID: `group:Sadducee`)
...
* **Associated ACAI Concepts:** Sky (ID: `keyterm:Heaven`); Chosen (ID: `keyterm:Chosen`); Ноа (ID: `person:Noah`); Symbol (ID: `keyterm:Example`); An Angel (ID: `deity:Angel`); Ability (ID: `keyterm:Ability`); Believe (ID: `keyterm:Believe`); Иисус (ID: `person:Jesus.2`); Surely! (ID: `keyterm:Surely`); Faithfulness (ID: `keyterm:Faithfulness`); Даниил (ID: `person:Daniel.3`); House (ID: `realia:House`); Heart (ID: `keyterm:Heart`); Portent (ID: `keyterm:Portent`); Abomination of Desolation (ID: `keyterm:AbominationOfDesolation`); Happy (ID: `keyterm:Happy`); Иудея (ID: `place:Judea`); Disaster (ID: `keyterm:Disaster`); LORD (ID: `deity:Lord`); Body (ID: `keyterm:Body.3`); Pray (ID: `keyterm:Pray`); Salvation (ID: `keyterm:Salvation`); Parable (ID: `keyterm:Parable`); Sabbath (ID: `keyterm:Sabbath`); Holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); Vulture (ID: `fauna:Vulture`); Inner Room (ID: `realia:InnerRoom`); Trumpet (ID: `realia:Trumpet`); Housetop (ID: `realia:Housetop`); Door (ID: `realia:Door`); Fig (ID: `flora:Fig`); Tabernacle (ID: `realia:Tabernacle`); Cloak (ID: `realia:Cloak`); Hand-Mill (ID: `realia:Hand-mill`); Boat (ID: `realia:Boat`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Myrrh (ID: `realia:Myrrh`); Myrrh (ID: `flora:Myrrh`); Симон (ID: `person:Simon.4`); Вифания (ID: `place:Bethany`); Иуда (ID: `person:Judas.2`); Passover (ID: `keyterm:Passover`); Ability (ID: `keyterm:Ability`); Surely! (ID: `keyterm:Surely`); Каиафа (ID: `person:Caiaphas`); Body (ID: `keyterm:Body.3`); Good News (ID: `keyterm:GoodNews`); Proclaim (ID: `keyterm:Proclaim`); Alabaster Jar (ID: `realia:AlabasterJar`); House (ID: `realia:House`); Courtyard (ID: `realia:Courtyard`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Passover (ID: `keyterm:Passover`); Blood (ID: `keyterm:Blood`); Body (ID: `keyterm:Body.3`); Kingdom (ID: `keyterm:Kingdom`); Forgive (ID: `keyterm:Forgive`); Иуда (ID: `person:Judas.2`); To Sin (ID: `keyterm:Sin`); Surely! (ID: `keyterm:Surely`); Disaster (ID: `keyterm:Disaster`); LORD (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Bless (ID: `keyterm:Bless`); Vine (ID: `flora:Vine`); Bowl (ID: `realia:Bowl.2`); Olive Tree (ID: `flora:OliveTree`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Pray (ID: `keyterm:Pray`); Пётр (ID: `person:Peter`); Be a Disciple (ID: `keyterm:Disciple`); Иисус (ID: `person:Jesus.2`); LORD (ID: `deity:Lord`); Гефсимания (ID: `place:Gethsemane`); Spirit (ID: `keyterm:Spirit.2`); Resurrection (ID: `keyterm:Resurrection`); Зеведей (ID: `person:Zebedee`); Put to the Test (ID: `keyterm:PutToTheTest`); Surely! (ID: `keyterm:Surely`); Body (ID: `keyterm:Body.3`); Галилея (ID: `place:Galilee`); Rooster (ID: `fauna:Rooster`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Olive Tree (ID: `flora:OliveTree`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); To Cause to Happen (ID: `keyterm:Happen`); Written (ID: `keyterm:Scripture`); Ask for (ID: `keyterm:AskFor`); Иуда (ID: `person:Judas.2`); LORD (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Symbol (ID: `keyterm:Example`); Be a Disciple (ID: `keyterm:Disciple`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); LORD (ID: `deity:Lord`); Каиафа (ID: `person:Caiaphas`); Sky (ID: `keyterm:Heaven`); Blaspheme (ID: `keyterm:Blaspheme`); Witness (ID: `keyterm:Witness`); Speak as a Prophet (ID: `keyterm:Speak`); Ability (ID: `keyterm:Ability`); Пётр (ID: `person:Peter`); Life (ID: `keyterm:Life`); Courtyard (ID: `realia:Courtyard`); Temple (ID: `realia:Temple`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Пётр (ID: `person:Peter`); Rooster (ID: `fauna:Rooster`); Oath (ID: `keyterm:Oath`); A Group of People (ID: `group:GenericGroup`); Galileans (ID: `group:Galilee`); True (ID: `keyterm:True`); Назарет (ID: `place:Nazareth`); Галилея (ID: `place:Galilee`); A Servant (ID: `person:GenericServant`); Word (ID: `keyterm:Word`); Entrance (ID: `realia:Entrance`); Courtyard (ID: `realia:Courtyard`)
...
* **Associated ACAI Concepts:** Akeldama (ID: `place:Akeldama`); Blood (ID: `keyterm:Blood`); Пилат (ID: `person:Pilate`); Temple Treasury (ID: `place:Corban`); Priests (ID: `group:GenericPriests`); Иеремия (ID: `person:Jeremiah.6`); To Cause to Happen (ID: `keyterm:Happen`); Иисус (ID: `person:Jesus.2`); Иуда (ID: `person:Judas.2`); To Sin (ID: `keyterm:Sin`); Condemn (ID: `keyterm:Condemn`); LORD (ID: `deity:Lord`); Repent (ID: `keyterm:Repent`); Израиль (ID: `person:Israel`); Be Lawful (ID: `keyterm:Lawful`); Temple (ID: `realia:Temple`); Treasury (ID: `realia:Treasury`)
...
* **Associated ACAI Concepts:** Варавва (ID: `person:Barabbas`); Иисус (ID: `person:Jesus.2`); Пилат (ID: `person:Pilate`); A Group of People (ID: `group:GenericGroup`); Cross (ID: `realia:Cross`); Blood (ID: `keyterm:Blood`); Jews (ID: `group:Jews`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Persuade (ID: `keyterm:Persuade`); Word (ID: `keyterm:Word`); Judgment Seat (ID: `realia:JudgmentSeat`)
...
* **Associated ACAI Concepts:** Cross (ID: `realia:Cross`); Salvation (ID: `keyterm:Salvation`); Иисус (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Clothing (ID: `realia:Clothing`); Reed (ID: `flora:Reed`); Cloak (ID: `realia:Cloak`); киринеянин (ID: `place:Cyrene`); Симон (ID: `person:Simon.5`); Golgotha (ID: `place:Golgotha`); Heart (ID: `keyterm:Heart`); Blaspheme (ID: `keyterm:Blaspheme`); Persuade (ID: `keyterm:Persuade`); Name (ID: `keyterm:Name`); LORD (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Израиль (ID: `person:Israel`); Deliver (ID: `keyterm:Deliver`); Crown (ID: `realia:Crown.2`); Brier (ID: `flora:Brier`); Wine (ID: `realia:Wine`); Acacia (ID: `flora:Acacia`); Crown (ID: `realia:Crown`); Temple (ID: `realia:Temple`); Palace (ID: `realia:Palace`); Boxthorn (ID: `flora:Boxthorn`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Grave (ID: `realia:Grave`); Resurrection (ID: `keyterm:Resurrection`); Пилат (ID: `person:Pilate`); Body (ID: `keyterm:Body.3`); Иосиф (ID: `person:Joseph.6`); Мария Магдалина (ID: `person:Marymagdalene`); Мария (ID: `person:Mary.2`); Елия (ID: `person:Elijah`); A Group of People (ID: `group:GenericGroup`); Holy (ID: `keyterm:Holy`); Be a Disciple (ID: `keyterm:Disciple`); Зеведей (ID: `person:Zebedee`); Иаков (ID: `person:James.4`); Аримафея (ID: `place:Arimathea`); Иосиф (ID: `person:Joseph.5`); True (ID: `keyterm:True`); Pharisees (ID: `group:Pharisee`); Fear (ID: `keyterm:Fear`); Галилея (ID: `place:Galilee`); Name (ID: `keyterm:Name`); LORD (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Clean (ID: `keyterm:Clean`); Salvation (ID: `keyterm:Salvation`); Spirit (ID: `keyterm:Spirit.2`); Serve (ID: `keyterm:Serve`); Seal (ID: `realia:Seal`); Sour Wine (ID: `realia:SourWine`); Reed (ID: `flora:Reed`); Curtain (ID: `realia:Curtain`); Temple (ID: `realia:Temple`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** Fear (ID: `keyterm:Fear`); Иисус (ID: `person:Jesus.2`); Be a Disciple (ID: `keyterm:Disciple`); Resurrection (ID: `keyterm:Resurrection`); An Angel (ID: `deity:Angel`); Галилея (ID: `place:Galilee`); Grave (ID: `realia:Grave`); Angels (ID: `group:Angels`); Week (ID: `keyterm:Week`); Sky (ID: `keyterm:Heaven`); Persuade (ID: `keyterm:Persuade`); Bow Down (ID: `keyterm:BowDown`); LORD (ID: `deity:Lord`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Sabbath (ID: `keyterm:Sabbath`); Jews (ID: `group:Jews`); Мария Магдалина (ID: `person:Marymagdalene`); Мария (ID: `person:Mary.2`); Clothing (ID: `realia:Clothing`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Be a Disciple (ID: `keyterm:Disciple`); Иисус (ID: `person:Jesus.2`); Authority (ID: `keyterm:Authority.2`); Name (ID: `keyterm:Name`); Baptism (ID: `keyterm:Baptism`); Sky (ID: `keyterm:Heaven`); Святой Дух (ID: `deity:HolySpirit`); Bow Down (ID: `keyterm:BowDown`); Ability (ID: `keyterm:Ability`); To Command (ID: `keyterm:Command`); LORD (ID: `deity:Lord`); Always (ID: `keyterm:Always`); Галилея (ID: `place:Galilee`)
