...
* **Associated Passages:** Иуды 1:1-4
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); LORD (ID: `deity:Lord`); Love (ID: `keyterm:Love`); Иуда (ID: `person:Jude`); Holy (ID: `keyterm:Holy`); Make Peace (ID: `keyterm:Peace`); Иаков (ID: `person:James.3`); Salvation (ID: `keyterm:Salvation`); Ask for (ID: `keyterm:AskFor`); Mercy (ID: `keyterm:Mercy`); Eagerness (ID: `keyterm:Eagerness`); Favor (ID: `keyterm:Favor`); In Common (ID: `keyterm:InCommon`); Beloved (ID: `keyterm:Beloved`); Believe (ID: `keyterm:Believe`); Judgment (ID: `keyterm:Judgment`)
...
* **Associated Passages:** Иуды 1:5-16
...
* **Associated ACAI Concepts:** Body (ID: `keyterm:Body.3`); Judgment (ID: `keyterm:Judgment`); Court Case (ID: `keyterm:CourtCase`); Always (ID: `keyterm:Always`); Blaspheme (ID: `keyterm:Blaspheme`); LORD (ID: `deity:Lord`); Корей (ID: `person:Korah.3`); Гоморра (ID: `place:Gomorrah`); Salvation (ID: `keyterm:Salvation`); To Command (ID: `keyterm:Command`); Fellowship Meal (ID: `keyterm:FellowshipMeal`); Discern (ID: `keyterm:Discern`); Believe (ID: `keyterm:Believe`); Каин (ID: `person:Cain`); Ability (ID: `keyterm:Ability`); Содом (ID: `place:Sodom`); Eternal Fire (ID: `keyterm:EternalFire`); Моисей (ID: `person:Moses`); Disaster (ID: `keyterm:Disaster`); Енох (ID: `person:Enoch.2`); Египет (ID: `place:Egypt`); Defilement (ID: `keyterm:Defilement`); Валаам (ID: `person:Balaam`); Адам (ID: `person:Adam`); Иисус (ID: `person:Jesus.2`); Holy (ID: `keyterm:Holy`); An Angel (ID: `deity:Angel`); Михаил (ID: `person:Michael.11`); Speak as a Prophet (ID: `keyterm:Speak`); Chain (ID: `realia:Chain`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
