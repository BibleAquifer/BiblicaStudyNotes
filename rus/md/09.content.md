...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Анна (ID: `person:Hannah`); Илий (ID: `person:Eli`); Елкана (ID: `person:Elkanah.2`); Рама (ID: `place:Ramah`); House (ID: `realia:House`); Силом (ID: `place:Shiloh`); Феннана (ID: `person:Peninnah`); Horn (ID: `keyterm:Horn`); Vow (ID: `keyterm:Vow`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Тоху (ID: `person:Tohu`); Финеес (ID: `person:Phinehas.2`); Иерохам (ID: `person:Jeroham`); Elihu (ID: `person:Elihu`); Самуил (ID: `person:Samuel`); Цуф (ID: `person:Zuph`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Офни (ID: `person:Hophni`); Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); Loyal Person (ID: `keyterm:LoyalPerson`); Hell (ID: `place:Hell`); Glory (ID: `keyterm:Glory`); Wickedness (ID: `keyterm:Wickedness`); Slaughtering (ID: `keyterm:Slaughtering`); Израиль (ID: `person:Israel`); Anointed (ID: `keyterm:Anointed`); Peace (ID: `keyterm:IntactState`); Salvation (ID: `keyterm:Salvation`); Ефрем (ID: `person:Ephraim`); Holy (ID: `keyterm:Holy`); Ефрем (ID: `group:Ephraim`); Favor (ID: `keyterm:Favor`); Throne (ID: `realia:Throne`); Doorpost (ID: `realia:Doorpost`); Skin-Bottle (ID: `realia:Skin-bottle`); Bow (ID: `realia:Bow`); Razor (ID: `realia:Razor`); Ephah (ID: `realia:Ephah`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Самуил (ID: `person:Samuel`); Саул (ID: `person:Saul.2`); Израиль (ID: `person:Israel`); Вениамин (ID: `group:Benjamin`); Вениамин (ID: `person:Benjamin`); Force to Serve (ID: `keyterm:EnticedToServe`); Speak as a Prophet (ID: `keyterm:Speak`); Иавис Галаадский (ID: `place:Jabesh-gilead`); Donkey (ID: `fauna:Donkey`); High Place (ID: `realia:HighPlace`); Кис (ID: `person:Kish`); Stone Pine (ID: `flora:Pine`); Slaughtering (ID: `keyterm:Slaughtering`); Египет (ID: `place:Egypt`); Ammonites (ID: `group:Ammon`); Аммон (ID: `place:Ammon`); An Angel (ID: `deity:Angel`); Gibeah (ID: `place:Gibeah.2`); Fear (ID: `keyterm:Fear`); Наас (ID: `person:Nahash`); Филистимлянин (ID: `group:Philistine`); Offering (ID: `keyterm:Offering`); To Sin (ID: `keyterm:Sin`); Филистимской (ID: `place:Philistine`); Gilgal (ID: `place:Gilgal.2`); A Group of People (ID: `group:GenericGroup`); Моисей (ID: `person:Moses`); Men (ID: `group:GenericMales`); Аарона (ID: `person:Aaron`)
...
* **Associated ACAI Concepts:** Саул (ID: `person:Saul.2`); LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Ионафан (ID: `person:Jonathan.3`); Самуил (ID: `person:Samuel`); Филистимлянин (ID: `group:Philistine`); Филистимской (ID: `place:Philistine`); Амалик (ID: `place:Amalek`); Михмас (ID: `place:Michmash`); Amalekites (ID: `group:Amalek`); Gilgal (ID: `place:Gilgal.2`); To Sin (ID: `keyterm:Sin`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Агаг (ID: `person:Agag.2`); Hebrews (ID: `group:Hebrews`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Gibeah (ID: `place:Gibeah.2`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); Вениамин (ID: `group:Benjamin`); Вениамин (ID: `person:Benjamin`); Sword (ID: `realia:Sword`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Гава (ID: `place:Geba`); Египет (ID: `place:Egypt`); Sheep (ID: `fauna:Lamb`); Нир (ID: `person:Ner.2`); Авенир (ID: `person:Abner`); Beth-aven (ID: `place:Beth-aven`)
...
* **Associated ACAI Concepts:** Давид (ID: `person:David`); Филистимлянин (ID: `group:Philistine`); Филистимской (ID: `place:Philistine`); Саул (ID: `person:Saul.2`); LORD (ID: `deity:Lord`); Иессей (ID: `person:Jesse`); Израиль (ID: `person:Israel`); Самуил (ID: `person:Samuel`); Вифлеем (ID: `place:Bethlehem`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Peace (ID: `keyterm:IntactState`); Sword (ID: `realia:Sword`); Елиав (ID: `person:Eliab.3`); Smear (ID: `keyterm:Smear`); Bethlehemites (ID: `group:Bethlehem`); Геф (ID: `place:Gath`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Sheep (ID: `fauna:Lamb`); Голиаф (ID: `person:Goliath`); Авинадав (ID: `person:Abinadab.3`); Valley of Elah (ID: `place:ElahValley`); Самая (ID: `person:Shimeah.2`); Slaughtering (ID: `keyterm:Slaughtering`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Авенир (ID: `person:Abner`); Fear (ID: `keyterm:Fear`); Spear (ID: `realia:Spear`); Bear (ID: `fauna:Bear`)
...
* **Associated ACAI Concepts:** Давид (ID: `person:David`); Саул (ID: `person:Saul.2`); LORD (ID: `deity:Lord`); Ионафан (ID: `person:Jonathan.3`); Филистимлянин (ID: `group:Philistine`); Филистимской (ID: `place:Philistine`); Кеила (ID: `place:Keilah`); Ахимелех (ID: `person:Ahimelech`); Израиль (ID: `person:Israel`); Мелхола (ID: `person:Michal`); Иессей (ID: `person:Jesse`); Love (ID: `keyterm:Love`); An Angel (ID: `deity:Angel`); Fear (ID: `keyterm:Fear`); Авиафар (ID: `person:Abiathar`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Наваф (ID: `place:Naioth`); Рама (ID: `place:Ramah`); Speak as a Prophet (ID: `keyterm:Speak`); Доик (ID: `person:Doeg`); Ахитув (ID: `person:Ahitub`); Wilderness of Ziph (ID: `place:Ziph.2`); Horesh (ID: `place:Horesh`); Номв (ID: `place:Nob`); Анхус (ID: `person:Achish`); Иуда (ID: `person:Judah.4`); Едом (ID: `place:Edom`); Peace (ID: `keyterm:IntactState`); Swear (ID: `keyterm:Swear`); Самуил (ID: `person:Samuel`)
...
* **Associated ACAI Concepts:** Давид (ID: `person:David`); LORD (ID: `deity:Lord`); Саул (ID: `person:Saul.2`); Навал (ID: `person:Nabal`); Авигея (ID: `person:Abigail`); Израиль (ID: `person:Israel`); Bless (ID: `keyterm:Bless`); Anointed (ID: `keyterm:Anointed`); Кармил (ID: `place:Carmel`); Авесса (ID: `person:Abishai`); Авенир (ID: `person:Abner`); Spear (ID: `realia:Spear`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Donkey (ID: `fauna:Donkey`); Гахила (ID: `place:Hachilah`); En-gedi (ID: `place:Engedi`); Wickedness (ID: `keyterm:Wickedness`); To Sin (ID: `keyterm:Sin`); Swear (ID: `keyterm:Swear`); Нир (ID: `person:Ner.2`); An Angel (ID: `deity:Angel`); Rebel (ID: `keyterm:Rebel`); Иесимон (ID: `place:Jeshimon`); Wilderness of Ziph (ID: `place:Ziph.2`); Clay Jar (ID: `realia:ClayJar`); Ахимелех (ID: `person:Ahimelech.2`); Галлим (ID: `place:Gallim`)
...
* **Associated ACAI Concepts:** Давид (ID: `person:David`); Саул (ID: `person:Saul.2`); Филистимлянин (ID: `group:Philistine`); Филистимской (ID: `place:Philistine`); Анхус (ID: `person:Achish`); LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Самуил (ID: `person:Samuel`); Амалик (ID: `place:Amalek`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Изреель (ID: `place:Jezreel`); Циклаг (ID: `place:Ziklag`); Necromancer (ID: `keyterm:Spirit`); Amalekites (ID: `group:Amalek`); юг (ID: `place:Negeb`); Fear (ID: `keyterm:Fear`); Геф (ID: `place:Gath`); Восор (ID: `place:Besor`); Иавис Галаадский (ID: `place:Jabesh-gilead`); Mount Gilboa (ID: `place:GilboaMount`); Египет (ID: `place:Egypt`); Strength (ID: `keyterm:Strength`); Кармил (ID: `place:Carmel`); Jerahmeelites (ID: `group:Jerahmeel`); Иерахмеил (ID: `person:Jerahmeel`); Изреель (ID: `place:Jezreel.2`); Ахиноам (ID: `person:Ahinoam.2`); Изреель (ID: `group:Jezreel`); A Woman (ID: `person:GenericFemale`)
