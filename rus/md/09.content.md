...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Анна (ID: `person:Hannah`); Илий (ID: `person:Eli`); Елкана (ID: `person:Elkanah.2`); Рама (ID: `place:Ramah`); House (ID: `realia:House`); Силом (ID: `place:Shiloh`); Феннана (ID: `person:Peninnah`); Horn (ID: `keyterm:Horn`); Vow (ID: `keyterm:Vow`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Elihu (ID: `person:Elihu`); Иерохам (ID: `person:Jeroham`); Тоху (ID: `person:Tohu`); Цуф (ID: `person:Zuph`); Самуил (ID: `person:Samuel`); Финеес (ID: `person:Phinehas.2`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Loyal Person (ID: `keyterm:LoyalPerson`); Strength (ID: `keyterm:Strength`); Anointed (ID: `keyterm:Anointed`); Hell (ID: `place:Hell`); Holy (ID: `keyterm:Holy`); Favor (ID: `keyterm:Favor`); Wickedness (ID: `keyterm:Wickedness`); Ефрем (ID: `person:Ephraim`); Офни (ID: `person:Hophni`); Израиль (ID: `person:Israel`); Ефрем (ID: `group:Ephraim`); Slaughtering (ID: `keyterm:Slaughtering`); Salvation (ID: `keyterm:Salvation`); Peace (ID: `keyterm:IntactState`); Doorpost (ID: `realia:Doorpost`); Throne (ID: `realia:Throne`); Ephah (ID: `realia:Ephah`); Skin-Bottle (ID: `realia:Skin-bottle`); Razor (ID: `realia:Razor`); Bow (ID: `realia:Bow`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Covenant Box (ID: `keyterm:CovenantBox`); Самуил (ID: `person:Samuel`); Филистимской (ID: `place:Philistine`); Филистимлянин (ID: `group:Philistine`); Илий (ID: `person:Eli`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Offering (ID: `keyterm:Offering`); Tumors (ID: `keyterm:Tumors`); Beth-shemesh (ID: `place:Beth-shemesh`); Азот (ID: `place:Ashdod`); Массифа (ID: `place:Mizpah`); Силом (ID: `place:Shiloh`); Финеес (ID: `person:Phinehas.2`); Дагон (ID: `deity:Dagon`); Slaughtering (ID: `keyterm:Slaughtering`); Офни (ID: `person:Hophni`); House (ID: `realia:House`); Екрон (ID: `place:Ekron`); Fear (ID: `keyterm:Fear`); Wagon (ID: `realia:Wagon`); Ebenezer (ID: `place:Ebenezer`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Glory (ID: `keyterm:Glory`); To Sin (ID: `keyterm:Sin`); Kiriath-jearim (ID: `place:Kiriath-jearim`); Force to Serve (ID: `keyterm:EnticedToServe`); Геф (ID: `place:Gath`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Самуил (ID: `person:Samuel`); Саул (ID: `person:Saul.2`); Израиль (ID: `person:Israel`); Вениамин (ID: `person:Benjamin`); Вениамин (ID: `group:Benjamin`); Force to Serve (ID: `keyterm:EnticedToServe`); Speak as a Prophet (ID: `keyterm:Speak`); Иавис Галаадский (ID: `place:Jabesh-gilead`); Donkey (ID: `fauna:Donkey`); Stone Pine (ID: `flora:Pine`); High Place (ID: `realia:HighPlace`); Кис (ID: `person:Kish`); Gibeah (ID: `place:Gibeah.2`); An Angel (ID: `deity:Angel`); Fear (ID: `keyterm:Fear`); Египет (ID: `place:Egypt`); Аммон (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Slaughtering (ID: `keyterm:Slaughtering`); Наас (ID: `person:Nahash`); Gilgal (ID: `place:Gilgal.2`); To Sin (ID: `keyterm:Sin`); Филистимской (ID: `place:Philistine`); Offering (ID: `keyterm:Offering`); Филистимлянин (ID: `group:Philistine`); Men (ID: `group:GenericMales`); Моисей (ID: `person:Moses`); Salvation (ID: `keyterm:Salvation`); Smear (ID: `keyterm:Smear`)
...
* **Associated ACAI Concepts:** Саул (ID: `person:Saul.2`); LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Ионафан (ID: `person:Jonathan.3`); Самуил (ID: `person:Samuel`); Филистимской (ID: `place:Philistine`); Филистимлянин (ID: `group:Philistine`); Амалик (ID: `place:Amalek`); Михмас (ID: `place:Michmash`); Gilgal (ID: `place:Gilgal.2`); Amalekites (ID: `group:Amalek`); To Sin (ID: `keyterm:Sin`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Агаг (ID: `person:Agag.2`); Gibeah (ID: `place:Gibeah.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Hebrews (ID: `group:Hebrews`); Cattle (ID: `fauna:Bull`); Вениамин (ID: `person:Benjamin`); Offering (ID: `keyterm:Offering`); Вениамин (ID: `group:Benjamin`); Sword (ID: `realia:Sword`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Гава (ID: `place:Geba`); Египет (ID: `place:Egypt`); Sheep (ID: `fauna:Lamb`); Нир (ID: `person:Ner.2`); Авенир (ID: `person:Abner`); To Curse (ID: `keyterm:Curse`)
...
* **Associated ACAI Concepts:** Давид (ID: `person:David`); Филистимлянин (ID: `group:Philistine`); Филистимской (ID: `place:Philistine`); Саул (ID: `person:Saul.2`); LORD (ID: `deity:Lord`); Иессей (ID: `person:Jesse`); Израиль (ID: `person:Israel`); Самуил (ID: `person:Samuel`); Вифлеем (ID: `place:Bethlehem`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Peace (ID: `keyterm:IntactState`); Sword (ID: `realia:Sword`); Елиав (ID: `person:Eliab.3`); Bethlehemites (ID: `group:Bethlehem`); Smear (ID: `keyterm:Smear`); Геф (ID: `place:Gath`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Sheep (ID: `fauna:Lamb`); Голиаф (ID: `person:Goliath`); Valley of Elah (ID: `place:ElahValley`); Авинадав (ID: `person:Abinadab.3`); Самая (ID: `person:Shimeah.2`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Fear (ID: `keyterm:Fear`); Авенир (ID: `person:Abner`); Slaughtering (ID: `keyterm:Slaughtering`); Sling (ID: `realia:Sling`); Bear (ID: `fauna:Bear`)
...
* **Associated ACAI Concepts:** Давид (ID: `person:David`); Саул (ID: `person:Saul.2`); LORD (ID: `deity:Lord`); Ионафан (ID: `person:Jonathan.3`); Филистимской (ID: `place:Philistine`); Филистимлянин (ID: `group:Philistine`); Кеила (ID: `place:Keilah`); Ахимелех (ID: `person:Ahimelech`); Израиль (ID: `person:Israel`); Мелхола (ID: `person:Michal`); Love (ID: `keyterm:Love`); An Angel (ID: `deity:Angel`); Иессей (ID: `person:Jesse`); Fear (ID: `keyterm:Fear`); Авиафар (ID: `person:Abiathar`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Наваф (ID: `place:Naioth`); Рама (ID: `place:Ramah`); Speak as a Prophet (ID: `keyterm:Speak`); Доик (ID: `person:Doeg`); Wilderness of Ziph (ID: `place:Ziph.2`); Ахитув (ID: `person:Ahitub`); Horesh (ID: `place:Horesh`); Номв (ID: `place:Nob`); Анхус (ID: `person:Achish`); Have Insight (ID: `keyterm:HaveInsight`); Peace (ID: `keyterm:IntactState`); Иуда (ID: `person:Judah.4`); Arrow (ID: `keyterm:Arrow`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Давид (ID: `person:David`); LORD (ID: `deity:Lord`); Саул (ID: `person:Saul.2`); Навал (ID: `person:Nabal`); Авигея (ID: `person:Abigail`); Израиль (ID: `person:Israel`); Bless (ID: `keyterm:Bless`); Anointed (ID: `keyterm:Anointed`); Кармил (ID: `place:Carmel`); Авесса (ID: `person:Abishai`); Авенир (ID: `person:Abner`); Spear (ID: `realia:Spear`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Peace (ID: `keyterm:IntactState`); Donkey (ID: `fauna:Donkey`); House (ID: `realia:House`); Гахила (ID: `place:Hachilah`); Wilderness of Ziph (ID: `place:Ziph.2`); To Sin (ID: `keyterm:Sin`); Нир (ID: `person:Ner.2`); An Angel (ID: `deity:Angel`); Swear (ID: `keyterm:Swear`); Rebel (ID: `keyterm:Rebel`); Иесимон (ID: `place:Jeshimon`); Wickedness (ID: `keyterm:Wickedness`); Clay Jar (ID: `realia:ClayJar`); Ziphites (ID: `group:Ziph`); Ахиноам (ID: `person:Ahinoam.2`); Лаиш (ID: `person:Laish`)
...
* **Associated ACAI Concepts:** Давид (ID: `person:David`); Саул (ID: `person:Saul.2`); Филистимской (ID: `place:Philistine`); Филистимлянин (ID: `group:Philistine`); Анхус (ID: `person:Achish`); LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Самуил (ID: `person:Samuel`); Амалик (ID: `place:Amalek`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Necromancer (ID: `keyterm:Spirit`); Изреель (ID: `place:Jezreel`); Циклаг (ID: `place:Ziklag`); юг (ID: `place:Negeb`); Fear (ID: `keyterm:Fear`); Геф (ID: `place:Gath`); Amalekites (ID: `group:Amalek`); Иавис Галаадский (ID: `place:Jabesh-gilead`); Восор (ID: `place:Besor`); Mount Gilboa (ID: `place:GilboaMount`); Кармил (ID: `place:Carmel`); Strength (ID: `keyterm:Strength`); Египет (ID: `place:Egypt`); Jerahmeelites (ID: `group:Jerahmeel`); Иерахмеил (ID: `person:Jerahmeel`); Ахиноам (ID: `person:Ahinoam.2`); Изреель (ID: `place:Jezreel.2`); Peace (ID: `keyterm:IntactState`); Изреель (ID: `group:Jezreel`)
