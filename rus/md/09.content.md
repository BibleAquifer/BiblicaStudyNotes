...
* **Associated ACAI Concepts:** Анна (ID: `person:Hannah`); Елкана (ID: `person:Elkanah.2`); Илий (ID: `person:Eli`); Феннана (ID: `person:Peninnah`); Рама (ID: `place:Ramah`); Horn (ID: `keyterm:Horn`); Elihu (ID: `person:Elihu`); Цуф (ID: `person:Zuph`); Тоху (ID: `person:Tohu`); Иерохам (ID: `person:Jeroham`); Vow (ID: `keyterm:Vow`); Финеес (ID: `person:Phinehas.2`); Самуил (ID: `person:Samuel`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Tumors (ID: `keyterm:Tumors`); Дагон (ID: `deity:Dagon`); Финеес (ID: `person:Phinehas.2`); Илий (ID: `person:Eli`); Офни (ID: `person:Hophni`); Ebenezer (ID: `place:Ebenezer`); Mouse (ID: `fauna:Mouse`); Азот (ID: `place:Ashdod`); Самуил (ID: `person:Samuel`); Силом (ID: `place:Shiloh`); Wagon (ID: `realia:Wagon`); Иисус (ID: `person:Joshua.3`); People From Beth-Shemesh (ID: `group:Beth-shemesh`); Сен (ID: `place:Shen`); Авель (ID: `place:Abel`); Елеазар (ID: `person:Eleazar.3`); Beth-car (ID: `place:Beth-car`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Fork (ID: `realia:Fork`); Иохавед (ID: `person:Ichabod`); Woe (ID: `keyterm:Woe`); Plague (ID: `keyterm:Blow`); Well-Established (ID: `keyterm:BeFirm`); Авинадав (ID: `person:Abinadab`); Елкана (ID: `person:Elkanah.2`); Анна (ID: `person:Hannah`); Газа (ID: `place:Gaza`); Beth-shemesh (ID: `place:Beth-shemesh`); Массифа (ID: `place:Mizpah`); Covenant Box (ID: `keyterm:CovenantBox`)
...
* **Associated ACAI Concepts:** Наас (ID: `person:Nahash`); Саул (ID: `person:Saul.2`); Speak as a Prophet (ID: `keyterm:Speak`); Кис (ID: `person:Kish`); Матриево (ID: `person:Matri`); Целцах (ID: `place:Zelzah`); Шаалим (ID: `place:Shaalim`); Бехораф (ID: `person:Becorath`); Церон (ID: `person:Zeror`); Везек (ID: `place:Bezek.2`); Цуф (ID: `place:Zuph`); холм Божий (ID: `place:Gibeath-elohim`); Шалиша (ID: `place:Shalishah`); Oak of Tabor (ID: `place:Tabor.2`); Saul's Uncle (ID: `person:UncleOfSaul`); Афия (ID: `person:Aphiah`); Авия (ID: `person:Abijah.2`); Иоиль (ID: `person:Joel`); Авиила (ID: `person:Abiel.2`); Anointing Flask (ID: `realia:AnointingFlask`); Drum (ID: `realia:Drum`); Anointing Oil (ID: `realia:AnointingOil`); Самуил (ID: `person:Samuel`); Иавис Галаадский (ID: `place:Jabesh-gilead`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Donkey (ID: `fauna:Donkey`); Вениамин (ID: `group:Benjamin`); Вениамин (ID: `person:Benjamin`); Force to Serve (ID: `keyterm:EnticedToServe`)
...
* **Associated ACAI Concepts:** Михмас (ID: `place:Michmash`); Агаг (ID: `person:Agag.2`); Ионафан (ID: `person:Jonathan.3`); Амалик (ID: `place:Amalek`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Саул (ID: `person:Saul.2`); Plough (ID: `realia:Plough`); Fork (ID: `realia:Fork.2`); Valley of Zeboim (ID: `place:ZeboimValley`); Ахимаас (ID: `person:Ahimaaz`); Шуал (ID: `place:Shual`); Сена (ID: `place:Seneh`); Телаим (ID: `place:Telaim`); Ахиноам (ID: `person:Ahinoam`); Боцец (ID: `place:Bozez`); Acre (ID: `realia:Acre`); Иохавед (ID: `person:Ichabod`); Мигрон (ID: `place:Migron`); Хавила (ID: `place:Havilah.2`); Нир (ID: `person:Ner.2`); Авенир (ID: `person:Abner`); Офра (ID: `place:Ophrah`); Goad (ID: `realia:Goad`); Меров (ID: `person:Merab`); Авиила (ID: `person:Abiel.2`); Ахитув (ID: `person:Ahitub`); Malchi-shua (ID: `person:Malchi-shua`); Финеес (ID: `person:Phinehas.2`); Kenites (ID: `group:Kenite`); Кис (ID: `person:Kish`)
...
* **Associated ACAI Concepts:** Иессей (ID: `person:Jesse`); Bethlehemites (ID: `group:Bethlehem`); Филистимлянин (ID: `group:Philistine`); Вифлеем (ID: `place:Bethlehem`); Coat of Mail (ID: `realia:CoatOfMail`); Давид (ID: `person:David`); Елиав (ID: `person:Eliab.3`); Pouch (ID: `realia:Pouch`); Greaves (ID: `realia:Greaves`); Valley of Elah (ID: `place:ElahValley`); Авинадав (ID: `person:Abinadab.3`); Sling (ID: `realia:Sling`); Bear (ID: `fauna:Bear`); Геф (ID: `place:Gath`); Spear (ID: `realia:Spear`); Smear (ID: `keyterm:Smear`); Голиаф (ID: `person:Goliath`); Anointing Flask (ID: `realia:AnointingFlask`); Самая (ID: `person:Shimeah.2`); Javelin (ID: `realia:Javelin`); Point of Spear (ID: `realia:PointOfSpear`); Шаарим (ID: `place:Shaaraim`); Ephrathites (ID: `group:Ephrathah`); Ephes-dammim (ID: `place:Ephes-dammim`); Helmet (ID: `realia:Helmet`); Lute (ID: `realia:Lute`); Shekel (ID: `realia:Shekel`); Сохо (ID: `place:Socoh`); Weavers Beam (ID: `realia:WeaversBeam`); Ефрафа (ID: `person:Ephrathah`)
...
* **Associated ACAI Concepts:** Наваф (ID: `place:Naioth`); Кеила (ID: `place:Keilah`); Horesh (ID: `place:Horesh`); Ахимелех (ID: `person:Ahimelech`); Доик (ID: `person:Doeg`); Ахитув (ID: `person:Ahitub`); Мелхола (ID: `person:Michal`); Ионафан (ID: `person:Jonathan.3`); Номв (ID: `place:Nob`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Wilderness of Ziph (ID: `place:Ziph.2`); Авиафар (ID: `person:Abiathar`); Spear (ID: `realia:Spear`); Arrow (ID: `realia:Arrow`); Анхус (ID: `person:Achish`); Sela-hammahlekoth (ID: `place:RockOfEscape`); Херет (ID: `place:Hereth`); Азель (ID: `place:EzelStone`); Сефе (ID: `place:Secu`); Иесимон (ID: `place:Jeshimon`); Меров (ID: `person:Merab`); Ephod (ID: `realia:Ephod`); To Lead (ID: `keyterm:Lead`); Адриэл (ID: `person:Adriel`); Meholathites (ID: `group:Meholathites`); Household Idols (ID: `realia:HouseholdIdols`); Tamarisk (ID: `flora:Tamarisk`); Ziphites (ID: `group:Ziph`); Гахила (ID: `place:Hachilah`); Valley of Elah (ID: `place:ElahValley`)
...
* **Associated ACAI Concepts:** Навал (ID: `person:Nabal`); Авигея (ID: `person:Abigail`); Flea (ID: `fauna:Flea`); Кармил (ID: `place:Carmel`); Авесса (ID: `person:Abishai`); Wildgoats' Rocks (ID: `place:WildgoatsRocks`); Calebites (ID: `group:Caleb`); Ахимелех (ID: `person:Ahimelech.2`); Гахила (ID: `place:Hachilah`); En-gedi (ID: `place:Engedi`); Галлим (ID: `place:Gallim`); Лаиш (ID: `person:Laish`); Rock Partridge (ID: `fauna:RockPartridge`); Фалтий (ID: `person:Palti.2`); Partridge (ID: `fauna:Partridge`); Robe (ID: `realia:Robe`); Ziphites (ID: `group:Ziph`); Маон (ID: `place:Maon`); Fig Cake (ID: `realia:FigCake`); Ахиноам (ID: `person:Ahinoam.2`); Изреель (ID: `place:Jezreel`); Мелхола (ID: `person:Michal`); Anointed (ID: `keyterm:Anointed`); Spear (ID: `realia:Spear`); Саул (ID: `person:Saul.2`); Давид (ID: `person:David`); Bless (ID: `keyterm:Bless`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Израиль (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Анхус (ID: `person:Achish`); Восор (ID: `place:Besor`); Изреель (ID: `place:Jezreel`); Амалик (ID: `place:Amalek`); Jerahmeelites (ID: `group:Jerahmeel`); Циклаг (ID: `place:Ziklag`); Necromancer (ID: `keyterm:Spirit`); Ароер (ID: `place:Aroer.3`); Атах (ID: `place:Athach`); Beth-ashtoreth (ID: `place:Beth-ashtoreth`); Girzites (ID: `group:Girzites`); Шифмоф (ID: `place:Siphmoth`); Bor-ashan (ID: `place:Bor-ashan`); Mount Gilboa (ID: `place:GilboaMount`); Иавис Галаадский (ID: `place:Jabesh-gilead`); Ахиноам (ID: `person:Ahinoam.2`); Иерахмеил (ID: `person:Jerahmeel`); Маох (ID: `person:Maoch`); Bethel (ID: `place:Bethel.2`); Изреель (ID: `place:Jezreel.2`); Tamarisk (ID: `flora:Tamarisk`); Сунем (ID: `place:Shunem`); Endor (ID: `place:En-dor`); Fig Cake (ID: `realia:FigCake`); Malchi-shua (ID: `person:Malchi-shua`); Авинадав (ID: `person:Abinadab.2`); Cherethites (ID: `group:Cherethite`); Practice Divination (ID: `keyterm:PracticeDivination`); Филистимлянин (ID: `group:Philistine`); Филистимской (ID: `place:Philistine`)
