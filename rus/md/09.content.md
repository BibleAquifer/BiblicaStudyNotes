...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Анна (ID: `person:Hannah`); Илий (ID: `person:Eli`); Елкана (ID: `person:Elkanah.2`); Рама (ID: `place:Ramah`); House (ID: `realia:House`); Силом (ID: `place:Shiloh`); Феннана (ID: `person:Peninnah`); Horn (ID: `keyterm:Horn`); Vow (ID: `keyterm:Vow`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Иерохам (ID: `person:Jeroham`); Elihu (ID: `person:Elihu`); Тоху (ID: `person:Tohu`); Цуф (ID: `person:Zuph`); Самуил (ID: `person:Samuel`); Финеес (ID: `person:Phinehas.2`); Cattle (ID: `fauna:Bull`); Sheep (ID: `fauna:Lamb`); Salvation (ID: `keyterm:Salvation`); Wickedness (ID: `keyterm:Wickedness`); Hell (ID: `place:Hell`); Glory (ID: `keyterm:Glory`); Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); Slaughtering (ID: `keyterm:Slaughtering`); Peace (ID: `keyterm:IntactState`); Anointed (ID: `keyterm:Anointed`); Ефрем (ID: `group:Ephraim`); Офни (ID: `person:Hophni`); Израиль (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Loyal Person (ID: `keyterm:LoyalPerson`); Favor (ID: `keyterm:Favor`); Ефрем (ID: `person:Ephraim`); Skin-Bottle (ID: `realia:Skin-bottle`); Bow (ID: `realia:Bow`); Throne (ID: `realia:Throne`); Doorpost (ID: `realia:Doorpost`); Razor (ID: `realia:Razor`); Ephah (ID: `realia:Ephah`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Covenant Box (ID: `keyterm:CovenantBox`); Самуил (ID: `person:Samuel`); Филистимской (ID: `place:Philistine`); Филистимлянин (ID: `group:Philistine`); Илий (ID: `person:Eli`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Offering (ID: `keyterm:Offering`); Tumors (ID: `keyterm:Tumors`); Beth-shemesh (ID: `place:Beth-shemesh`); Азот (ID: `place:Ashdod`); Массифа (ID: `place:Mizpah`); Дагон (ID: `deity:Dagon`); Финеес (ID: `person:Phinehas.2`); Силом (ID: `place:Shiloh`); Slaughtering (ID: `keyterm:Slaughtering`); Офни (ID: `person:Hophni`); House (ID: `realia:House`); Fear (ID: `keyterm:Fear`); Екрон (ID: `place:Ekron`); Wagon (ID: `realia:Wagon`); Ebenezer (ID: `place:Ebenezer`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Kiriath-jearim (ID: `place:Kiriath-jearim`); Force to Serve (ID: `keyterm:EnticedToServe`); Glory (ID: `keyterm:Glory`); To Sin (ID: `keyterm:Sin`); Геф (ID: `place:Gath`); Египет (ID: `place:Egypt`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Самуил (ID: `person:Samuel`); Саул (ID: `person:Saul.2`); Израиль (ID: `person:Israel`); Вениамин (ID: `group:Benjamin`); Вениамин (ID: `person:Benjamin`); Force to Serve (ID: `keyterm:EnticedToServe`); Speak as a Prophet (ID: `keyterm:Speak`); Иавис Галаадский (ID: `place:Jabesh-gilead`); Donkey (ID: `fauna:Donkey`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Кис (ID: `person:Kish`); Аммон (ID: `place:Ammon`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Ammonites (ID: `group:Ammon`); Gibeah (ID: `place:Gibeah.2`); Slaughtering (ID: `keyterm:Slaughtering`); Египет (ID: `place:Egypt`); Наас (ID: `person:Nahash`); Филистимской (ID: `place:Philistine`); Gilgal (ID: `place:Gilgal.2`); Offering (ID: `keyterm:Offering`); To Sin (ID: `keyterm:Sin`); Филистимлянин (ID: `group:Philistine`); Моисей (ID: `person:Moses`); Smear (ID: `keyterm:Smear`); Аарона (ID: `person:Aaron`); Men (ID: `group:GenericMales`)
...
* **Associated ACAI Concepts:** Саул (ID: `person:Saul.2`); LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Ионафан (ID: `person:Jonathan.3`); Самуил (ID: `person:Samuel`); Филистимской (ID: `place:Philistine`); Филистимлянин (ID: `group:Philistine`); Амалик (ID: `place:Amalek`); Михмас (ID: `place:Michmash`); Gilgal (ID: `place:Gilgal.2`); Amalekites (ID: `group:Amalek`); To Sin (ID: `keyterm:Sin`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Агаг (ID: `person:Agag.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Gibeah (ID: `place:Gibeah.2`); Hebrews (ID: `group:Hebrews`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); Вениамин (ID: `group:Benjamin`); Вениамин (ID: `person:Benjamin`); Goat (ID: `fauna:Goat`); Sword (ID: `realia:Sword`); Flock (ID: `fauna:Flock`); Гава (ID: `place:Geba`); Египет (ID: `place:Egypt`); Sheep (ID: `fauna:Lamb`); Нир (ID: `person:Ner.2`); Авенир (ID: `person:Abner`); Ахимелех (ID: `person:Ahimelech`)
...
* **Associated ACAI Concepts:** Давид (ID: `person:David`); Саул (ID: `person:Saul.2`); LORD (ID: `deity:Lord`); Ионафан (ID: `person:Jonathan.3`); Филистимской (ID: `place:Philistine`); Филистимлянин (ID: `group:Philistine`); Кеила (ID: `place:Keilah`); Ахимелех (ID: `person:Ahimelech`); Израиль (ID: `person:Israel`); Мелхола (ID: `person:Michal`); An Angel (ID: `deity:Angel`); Иессей (ID: `person:Jesse`); Love (ID: `keyterm:Love`); Fear (ID: `keyterm:Fear`); Авиафар (ID: `person:Abiathar`); Наваф (ID: `place:Naioth`); New Moon Festival (ID: `keyterm:NewMoonFestival`); Рама (ID: `place:Ramah`); Speak as a Prophet (ID: `keyterm:Speak`); Доик (ID: `person:Doeg`); Ахитув (ID: `person:Ahitub`); Wilderness of Ziph (ID: `place:Ziph.2`); Horesh (ID: `place:Horesh`); Номв (ID: `place:Nob`); Анхус (ID: `person:Achish`); Иуда (ID: `group:Judah`); Самуил (ID: `person:Samuel`); Arrow (ID: `keyterm:Arrow`); Иуда (ID: `person:Judah.4`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Давид (ID: `person:David`); LORD (ID: `deity:Lord`); Саул (ID: `person:Saul.2`); Навал (ID: `person:Nabal`); Авигея (ID: `person:Abigail`); Израиль (ID: `person:Israel`); Bless (ID: `keyterm:Bless`); Anointed (ID: `keyterm:Anointed`); Авесса (ID: `person:Abishai`); Кармил (ID: `place:Carmel`); Авенир (ID: `person:Abner`); Goat (ID: `fauna:Goat`); Spear (ID: `realia:Spear`); Flock (ID: `fauna:Flock`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Donkey (ID: `fauna:Donkey`); Гахила (ID: `place:Hachilah`); Нир (ID: `person:Ner.2`); Иесимон (ID: `place:Jeshimon`); An Angel (ID: `deity:Angel`); Wickedness (ID: `keyterm:Wickedness`); To Sin (ID: `keyterm:Sin`); Swear (ID: `keyterm:Swear`); Rebel (ID: `keyterm:Rebel`); Wilderness of Ziph (ID: `place:Ziph.2`); Clay Jar (ID: `realia:ClayJar`); Галлим (ID: `place:Gallim`); Изреель (ID: `place:Jezreel`); Ахимелех (ID: `person:Ahimelech.2`)
...
* **Associated ACAI Concepts:** Давид (ID: `person:David`); Саул (ID: `person:Saul.2`); Филистимской (ID: `place:Philistine`); Филистимлянин (ID: `group:Philistine`); Анхус (ID: `person:Achish`); LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Самуил (ID: `person:Samuel`); Амалик (ID: `place:Amalek`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Изреель (ID: `place:Jezreel`); Циклаг (ID: `place:Ziklag`); Necromancer (ID: `keyterm:Spirit`); Fear (ID: `keyterm:Fear`); юг (ID: `place:Negeb`); Геф (ID: `place:Gath`); Amalekites (ID: `group:Amalek`); Иавис Галаадский (ID: `place:Jabesh-gilead`); Восор (ID: `place:Besor`); Mount Gilboa (ID: `place:GilboaMount`); Strength (ID: `keyterm:Strength`); Кармил (ID: `place:Carmel`); Египет (ID: `place:Egypt`); Jerahmeelites (ID: `group:Jerahmeel`); Иерахмеил (ID: `person:Jerahmeel`); Изреель (ID: `place:Jezreel.2`); Ахиноам (ID: `person:Ahinoam.2`); Изреель (ID: `group:Jezreel`); Навал (ID: `person:Nabal`)
