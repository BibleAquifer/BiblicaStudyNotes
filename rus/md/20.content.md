...
* **Associated ACAI Concepts:** Лемуил (ID: `person:Lemuel`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Utterance (ID: `keyterm:Utterance`); Vow (ID: `keyterm:Vow`)
