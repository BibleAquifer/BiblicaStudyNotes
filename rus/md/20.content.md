...
* **Associated ACAI Concepts:** Perceive (ID: `keyterm:Perceive`); Proverb (ID: `keyterm:Saying`); Intention (ID: `keyterm:Intention`); Ability (ID: `keyterm:Ability`); Have Insight (ID: `keyterm:HaveInsight`); Fool (ID: `keyterm:Fool`); Crafty (ID: `keyterm:Crafty`); Simple Person (ID: `keyterm:SimplePerson`); Guidance (ID: `keyterm:Guidance`); Discretion (ID: `keyterm:Discretion`); Давид (ID: `person:David`); Fairness (ID: `keyterm:Fairness`); Израиль (ID: `person:Israel`); Understanding (ID: `keyterm:Understanding`); Соломон (ID: `person:Solomon`); LORD (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`)
...
* **Associated ACAI Concepts:** Лемуил (ID: `person:Lemuel`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Utterance (ID: `keyterm:Utterance`); Vow (ID: `keyterm:Vow`)
