...
* **Associated ACAI Concepts:** Захария (ID: `person:Zechariah.17`); Иисус (ID: `person:Joshua.5`); Хелдай (ID: `person:Heldai`); Товия (ID: `person:Tobijah.2`); Цефания (ID: `person:Zephaniah.4`); Иедаия (ID: `person:Jedaiah.6`); Верехия (ID: `person:Berechiah.6`); Иосия (ID: `person:Josiah.2`); Myrtle (ID: `flora:Myrtle`); Зоровавель (ID: `person:Zerubbabel.2`); Шарецер (ID: `person:Sharezer.2`); Regem-melech (ID: `person:Regem-melech`); Iddo (ID: `person:Iddo.6`); сатана (ID: `deity:Satan`); Turban (ID: `realia:Turban.2`); Сеннаар (ID: `place:Shinar`); Иоседек (ID: `person:Jehozadak`); Jews (ID: `group:Jews`); An Angel (ID: `deity:Angel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Peace (ID: `keyterm:IntactState`); Truth (ID: `keyterm:Truth`); Иерусалим (ID: `place:Jerusalem`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); LORD (ID: `deity:Lord`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Azal (ID: `place:Azal`); Хадрах (ID: `place:Hadrach`); Hadad-rimmon (ID: `place:Hadad-rimmon`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Bow (ID: `realia:Bow`); Shimeites (ID: `group:Shimei`); Cedar (ID: `flora:Cedar`); Donkey (ID: `fauna:Donkey`); башня Анамеила (ID: `place:TowerOfHananel`); Вениаминовы ворота (ID: `place:BenjaminGate`); Mount of Olives (ID: `place:OlivesMount`); Шимей (ID: `person:Shimei.4`); терафим (ID: `deity:Teraphim`); Fir (ID: `flora:Fir`); Horse (ID: `fauna:Horse`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Иерусалим (ID: `place:Jerusalem`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Money (ID: `realia:Money`); House (ID: `realia:House`); Давид (ID: `person:David`); LORD (ID: `deity:Lord`)
