...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Иерусалим (ID: `place:Jerusalem`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Иисус (ID: `person:Joshua.5`); Truth (ID: `keyterm:Truth`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Зоровавель (ID: `person:Zerubbabel.2`); Захария (ID: `person:Zechariah.17`); Passion (ID: `keyterm:Ardour`); Дарий (ID: `person:Darius.2`); Horn (ID: `keyterm:Horn`); Ask for (ID: `keyterm:AskFor`); Olive Tree (ID: `flora:OliveTree`); Horse (ID: `fauna:Horse`); Iddo (ID: `person:Iddo.6`); Иедаия (ID: `person:Jedaiah.6`); Иосия (ID: `person:Josiah.2`); Хелдай (ID: `person:Heldai`); Товия (ID: `person:Tobijah.2`); Цефания (ID: `person:Zephaniah.4`); Верехия (ID: `person:Berechiah.6`); сатана (ID: `deity:Satan`); Glory (ID: `keyterm:Glory`); Fear (ID: `keyterm:Fear`); Come On! (ID: `keyterm:ComeOn`); Израиль (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Давид (ID: `person:David`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); House (ID: `realia:House`); Египет (ID: `place:Egypt`); Horse (ID: `fauna:Horse`); Money (ID: `realia:Money`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Plague (ID: `keyterm:Blow`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Израиль (ID: `person:Israel`); Ефрем (ID: `group:Ephraim`); Ефрем (ID: `person:Ephraim`); Assyria (ID: `place:Assyria`); Тир (ID: `place:Tyre`); Ливан (ID: `place:Lebanon`); Speak as a Prophet (ID: `keyterm:Speak`); Utterance (ID: `keyterm:Utterance`); Appoint (ID: `keyterm:Appoint`); Covenant (ID: `keyterm:Covenant`); Екрон (ID: `place:Ekron`); Bow (ID: `realia:Bow`); Staff (ID: `realia:Staff`); Vine (ID: `flora:Vine`); Sword (ID: `realia:Sword`)
