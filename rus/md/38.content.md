...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Иерусалим (ID: `place:Jerusalem`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Иисус (ID: `person:Joshua.5`); Peace (ID: `keyterm:IntactState`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`); Захария (ID: `person:Zechariah.17`); Зоровавель (ID: `person:Zerubbabel.2`); Passion (ID: `keyterm:Ardour`); Horn (ID: `keyterm:Horn`); Дарий (ID: `person:Darius.2`); Ask for (ID: `keyterm:AskFor`); Horse (ID: `fauna:Horse`); Olive Tree (ID: `flora:OliveTree`); Иосия (ID: `person:Josiah.2`); Иедаия (ID: `person:Jedaiah.6`); Iddo (ID: `person:Iddo.6`); Верехия (ID: `person:Berechiah.6`); Цефания (ID: `person:Zephaniah.4`); Товия (ID: `person:Tobijah.2`); Хелдай (ID: `person:Heldai`); сатана (ID: `deity:Satan`); Be Zealous (ID: `keyterm:Zealous`); Come On! (ID: `keyterm:ComeOn`); Израиль (ID: `person:Israel`); Вавилон (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Давид (ID: `person:David`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Египет (ID: `place:Egypt`); House (ID: `realia:House`); Horse (ID: `fauna:Horse`); Money (ID: `realia:Money`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Израиль (ID: `person:Israel`); Ефрем (ID: `group:Ephraim`); Ефрем (ID: `person:Ephraim`); Plague (ID: `keyterm:Blow`); Ливан (ID: `place:Lebanon`); Тир (ID: `place:Tyre`); Speak as a Prophet (ID: `keyterm:Speak`); Covenant (ID: `keyterm:Covenant`); Assyria (ID: `place:Assyria`); Екрон (ID: `place:Ekron`); Appoint (ID: `keyterm:Appoint`); Utterance (ID: `keyterm:Utterance`); Bow (ID: `realia:Bow`); Sword (ID: `realia:Sword`); Rod (ID: `realia:Rod`); Staff (ID: `realia:Staff`)
