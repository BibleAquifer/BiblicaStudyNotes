...
* **Associated ACAI Concepts:** Кир (ID: `person:Cyrus`); Магбиш (ID: `place:Magbish`); Хагав (ID: `person:Hagab`); Мифредат (ID: `person:Mithredath`); Аккув (ID: `person:Akkub.3`); Асна (ID: `person:Asnah`); Персия (ID: `place:Persia`); Елам (ID: `person:Elam`); Делайя (ID: `person:Delaiah.3`); Сотай (ID: `person:Sotai`); Хатита (ID: `person:Hatita`); Хабайя (ID: `person:Habaiah`); Феруда (ID: `person:Peruda`); Таббаоф (ID: `person:Tabbaoth`); Газзам (ID: `person:Gazzam`); Nephushesim (ID: `group:Nephushesim`); Мардохей (ID: `person:Mordecai`); Неемия (ID: `person:Nehemiah`); Езекия (ID: `person:Hezekiah.2`); Фадон (ID: `person:Padon`); Нециах (ID: `person:Neziah`); Гахар (ID: `person:Gahar`); Закхая (ID: `person:Zaccai.2`); Фамах (ID: `person:Temah`); Ханан (ID: `person:Hanan.4`); Иешуа (ID: `person:Jeshua.3`); Харим (ID: `person:Harim.2`); Бигвай (ID: `person:Bigvai`); Хасуфа (ID: `person:Hasupha`); Хатифа (ID: `person:Hatipha`)
...
* **Associated ACAI Concepts:** Артаксеркс (ID: `person:Artaxerxes.2`); Рехум (ID: `person:Rehum.2`); Шимшай (ID: `person:Shimshai`); Зоровавель (ID: `person:Zerubbabel.2`); Иисус (ID: `person:Joshua.5`); Бишлам (ID: `person:Bishlam`); Табеел (ID: `person:Tabeel`); Мифредат (ID: `person:Mithredath.2`); Babylonians (ID: `group:Babylon`); Динеи (ID: `person:Dinaite`); Аснафар (ID: `person:Osnappar`); Салафиил (ID: `person:Shealtiel.2`); Иоседек (ID: `person:Jehozadak`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Фафнай (ID: `person:Tattenai`); Relatives (ID: `group:Relatives`); Эрех (ID: `place:Erech`); Хенадад (ID: `person:Henadad`); Esarhaddon (ID: `person:Esarhaddon`); Годавия (ID: `person:Hodaviah.4`); Iddo (ID: `person:Iddo.6`); Захария (ID: `person:Zechariah.17`); Иешуа (ID: `person:Jeshua.4`); Кадмиил (ID: `person:Kadmiel`); Аггей (ID: `person:Haggai`); Артаксеркс (ID: `person:Ahasuerus`); Кир (ID: `person:Cyrus`); Дарий (ID: `person:Darius.2`); Персия (ID: `place:Persia`); Евфрат (ID: `place:Euphrates`)
...
* **Associated ACAI Concepts:** Дарий (ID: `person:Darius.2`); Екбатана (ID: `place:Ecbatana`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Фафнай (ID: `person:Tattenai`); Захария (ID: `person:Zechariah.17`); House (ID: `realia:House`); Иерусалим (ID: `place:Jerusalem`); Израиль (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Агава (ID: `place:Ahava`); Ездра (ID: `person:Ezra`); Евед (ID: `person:Ebed.2`); Иоиарив (ID: `person:Joiarib.2`); Елнафан (ID: `person:Elnathan.2`); Биннуй (ID: `person:Binnui.2`); Шеломиф (ID: `person:Shelomith.4`); Gershom (ID: `person:Gershom.2`); Иарив (ID: `person:Jarib.2`); Jahaziel (ID: `person:Jahaziel.5`); Зевадия (ID: `person:Zebadiah.8`); Иоханан (ID: `person:Johanan.8`); Уфай (ID: `person:Uthai.2`); Шемаия (ID: `person:Shemaiah.14`); Елиоенай (ID: `person:Eliehoenai.2`); Исаия (ID: `person:Jeshaiah.5`); Захария (ID: `person:Zechariah.18`); Ноадия (ID: `person:Noadiah`); Иосифия (ID: `person:Josiphiah`); Мешуллам (ID: `person:Meshullam.9`); Елнафан (ID: `person:Elnathan.3`); Захария (ID: `person:Zechariah.20`); Ионафан (ID: `person:Jonathan.9`); Касифья (ID: `place:Casiphia`); Елнафан (ID: `person:Elnathan.4`); Иешуа (ID: `person:Jeshua.5`); Захария (ID: `person:Zechariah.19`); Зерахия (ID: `person:Zerahiah.2`); Иоав (ID: `person:Joab.4`); Гаккатан (ID: `person:Hakkatan`)
...
* **Associated ACAI Concepts:** Be Unfaithful (ID: `keyterm:Unfaithful`); Шемария (ID: `person:Shemariah.4`); Узия (ID: `person:Uzziah.4`); Маасея (ID: `person:Maaseiah.7`); Малхия (ID: `person:Malchijah.5`); Мафафа (ID: `person:Mattattah`); Иозавад (ID: `person:Jozabad.8`); Ванея (ID: `person:Benaiah.8`); Шемария (ID: `person:Shemariah.3`); Иремоф (ID: `person:Jeremoth.4`); Иаддай (ID: `person:Jaddai`); Рамаия (ID: `person:Ramiah`); Елиезер (ID: `person:Eliezer.11`); Шеал (ID: `person:Sheal`); Афлай (ID: `person:Athlai`); Симон (ID: `person:Shimeon`); Иремоф (ID: `person:Jeremoth.5`); Иремоф (ID: `person:Jeremoth.3`); Шелемия (ID: `person:Shelemiah.3`); Захария (ID: `person:Zechariah.21`); Маттафия (ID: `person:Mattithiah.3`); Зевина (ID: `person:Zebina`); Елеазар (ID: `person:Eleazar.7`); Биннуй (ID: `person:Binnui.4`); Адаия (ID: `person:Adaiah.5`); Манассия (ID: `person:Manasseh.3`); Иоханан (ID: `person:Jehohanan.4`); Ванея (ID: `person:Vaniah`); Миямин (ID: `person:Mijamin.2`); Елия (ID: `person:Elijah.3`)
