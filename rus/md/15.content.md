...
* **Associated ACAI Concepts:** Иерусалим (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Кир (ID: `person:Cyrus`); House (ID: `realia:House`); Money (ID: `realia:Money`); Израиль (ID: `person:Israel`); Персия (ID: `place:Persia`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Зоровавель (ID: `person:Zerubbabel.2`); Елам (ID: `person:Elam`); Соломон (ID: `person:Solomon`); Вавилон (ID: `place:Babylon`); Навуходоносор (ID: `person:Nebuchadnezzar`); Салмай (ID: `person:Shalmai`); Сотай (ID: `person:Sotai`); Циха (ID: `person:Ziha`); Талмон (ID: `person:Talmon`); Иешуа (ID: `person:Jeshua.4`); Верзеллий (ID: `person:Barzillai.3`); Бецай (ID: `person:Bezai`); Софереф (ID: `person:Sophereth`); Харим (ID: `person:Harim`); Хадид (ID: `place:Hadid`); Хагаба (ID: `person:Hagabah`); Фамах (ID: `person:Temah`); Мехида (ID: `person:Mehida`); Ваний (ID: `person:Bani`)
...
* **Associated ACAI Concepts:** Иерусалим (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Израиль (ID: `person:Israel`); Зоровавель (ID: `person:Zerubbabel.2`); Евфрат (ID: `place:Euphrates`); Персия (ID: `place:Persia`); Кир (ID: `person:Cyrus`); Дарий (ID: `person:Darius.2`); Offering (ID: `keyterm:Offering`); Иуда (ID: `person:Judah.4`); Вавилон (ID: `place:Babylon`); Рехум (ID: `person:Rehum.2`); Шимшай (ID: `person:Shimshai`); Иисус (ID: `person:Joshua.5`); Артаксеркс (ID: `person:Artaxerxes.2`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Jews (ID: `group:Jews`); Салафиил (ID: `person:Shealtiel.2`); Иоседек (ID: `person:Jehozadak`); Иуда (ID: `group:Judah`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Фафнай (ID: `person:Tattenai`); Самария (ID: `place:Samaria`); Навуходоносор (ID: `person:Nebuchadnezzar`); Iddo (ID: `person:Iddo.6`); Хенадад (ID: `person:Henadad`); Иешуа (ID: `person:Jeshua.4`); Артаксеркс (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Дарий (ID: `person:Darius.2`); Иерусалим (ID: `place:Jerusalem`); Израиль (ID: `person:Israel`); Левий (ID: `group:Levi`); Евфрат (ID: `place:Euphrates`); Левий (ID: `person:Levi.3`); Jews (ID: `group:Jews`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Scroll (ID: `realia:Scroll`); Фафнай (ID: `person:Tattenai`); Passover (ID: `keyterm:Passover`); Кир (ID: `person:Cyrus`); LORD (ID: `deity:Lord`); Вавилон (ID: `place:Babylon`); Offering (ID: `keyterm:Offering`); Sheep (ID: `fauna:Lamb`); Захария (ID: `person:Zechariah.17`); Екбатана (ID: `place:Ecbatana`); Iddo (ID: `person:Iddo.6`); Аггей (ID: `person:Haggai`); Навуходоносор (ID: `person:Nebuchadnezzar`); Моисей (ID: `person:Moses`); Pure (ID: `keyterm:Pure`); Персия (ID: `place:Persia`); Defilement (ID: `keyterm:Defilement`); Артаксеркс (ID: `person:Artaxerxes`); Assyria (ID: `place:Assyria`); Мидия (ID: `place:Media`); Gentiles (ID: `group:Gentile`); Olive Oil (ID: `realia:OliveOil`); Cubit (ID: `realia:Cubit`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Hewn Stone (ID: `realia:HewnStone`); Wheat (ID: `flora:Wheat`); Anointing Oil (ID: `realia:AnointingOil`); Flock (ID: `fauna:Flock`); Foundation (ID: `realia:Foundation`); Unleavened Bread (ID: `realia:UnleavenedBread`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Израиль (ID: `person:Israel`); Ездра (ID: `person:Ezra`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Артаксеркс (ID: `person:Artaxerxes`); House (ID: `realia:House`); Money (ID: `realia:Money`); Вавилон (ID: `place:Babylon`); Агава (ID: `place:Ahava`); Offering (ID: `keyterm:Offering`); Евфрат (ID: `place:Euphrates`); Хашавия (ID: `person:Hashabiah.7`); Шеревия (ID: `person:Sherebiah`); Decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); Давид (ID: `person:David`); Perceive (ID: `keyterm:Perceive`); Финеес (ID: `person:Phinehas`); Амария (ID: `person:Amariah.2`); Елам (ID: `person:Elam`); Ноадия (ID: `person:Noadiah`); Захария (ID: `person:Zechariah.20`); Зерахия (ID: `person:Zerahiah`); Мешуллам (ID: `person:Meshullam.9`); Захария (ID: `person:Zechariah.19`); Бигвай (ID: `person:Bigvai.2`); Gershom (ID: `person:Gershom.2`); Иозавад (ID: `person:Jozabad.6`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Ездра (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Иерусалим (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); House (ID: `realia:House`); Харим (ID: `person:Harim`); Елам (ID: `person:Elam`); Иуда (ID: `group:Judah`); Offering (ID: `keyterm:Offering`); Иуда (ID: `person:Judah.4`); Counsel (ID: `keyterm:Counsel`); Завад (ID: `person:Zabad.6`); Елия (ID: `person:Elijah.4`); Елиашив (ID: `person:Eliashib.5`); Амрам (ID: `person:Amram.2`); Иехиел (ID: `person:Jehiel.10`); Маасея (ID: `person:Maaseiah.6`); Ваний (ID: `person:Bani.6`); Маллух (ID: `person:Malluch.2`); Нафанаил (ID: `person:Nethanel.8`); Шимей (ID: `person:Shimei.16`); Елиашив (ID: `person:Eliashib.4`); Исмаил (ID: `person:Ishmael.6`); Ваний (ID: `person:Bani`); Уел (ID: `person:Uel`); Елиезер (ID: `person:Eliezer.11`)
