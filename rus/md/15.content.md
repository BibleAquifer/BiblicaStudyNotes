...
* **Associated ACAI Concepts:** Иерусалим (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Кир (ID: `person:Cyrus`); House (ID: `realia:House`); Money (ID: `realia:Money`); Израиль (ID: `person:Israel`); Персия (ID: `place:Persia`); Левий (ID: `person:Levi.3`); Зоровавель (ID: `person:Zerubbabel.2`); Левий (ID: `group:Levi`); Елам (ID: `person:Elam`); Навуходоносор (ID: `person:Nebuchadnezzar`); Вавилон (ID: `place:Babylon`); Соломон (ID: `person:Solomon`); Салмай (ID: `person:Shalmai`); Шовай (ID: `person:Shobai`); Аккув (ID: `person:Akkub.3`); Керос (ID: `person:Keros`); Иедаия (ID: `person:Jedaiah.4`); Мехида (ID: `person:Mehida`); Циха (ID: `person:Ziha`); Нетофа (ID: `place:Netophah`); Гахар (ID: `person:Gahar`); Атер (ID: `person:Ater.2`); Софереф (ID: `person:Sophereth`); Хашум (ID: `person:Hashum`); Рецин (ID: `person:Rezin.2`); Иешуа (ID: `person:Jeshua`)
...
* **Associated ACAI Concepts:** Иерусалим (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Израиль (ID: `person:Israel`); Зоровавель (ID: `person:Zerubbabel.2`); Евфрат (ID: `place:Euphrates`); Персия (ID: `place:Persia`); Кир (ID: `person:Cyrus`); Иуда (ID: `person:Judah.4`); Вавилон (ID: `place:Babylon`); Дарий (ID: `person:Darius.2`); Offering (ID: `keyterm:Offering`); Рехум (ID: `person:Rehum.2`); Шимшай (ID: `person:Shimshai`); Артаксеркс (ID: `person:Artaxerxes.2`); Иисус (ID: `person:Joshua.5`); Jews (ID: `group:Jews`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Иоседек (ID: `person:Jehozadak`); Салафиил (ID: `person:Shealtiel.2`); Иуда (ID: `group:Judah`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Фафнай (ID: `person:Tattenai`); Навуходоносор (ID: `person:Nebuchadnezzar`); Самария (ID: `place:Samaria`); Мифредат (ID: `person:Mithredath.2`); Бишлам (ID: `person:Bishlam`); Хенадад (ID: `person:Henadad`); Годавия (ID: `person:Hodaviah.4`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Дарий (ID: `person:Darius.2`); Иерусалим (ID: `place:Jerusalem`); Израиль (ID: `person:Israel`); Евфрат (ID: `place:Euphrates`); Jews (ID: `group:Jews`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Scroll (ID: `realia:Scroll`); Фафнай (ID: `person:Tattenai`); Вавилон (ID: `place:Babylon`); Offering (ID: `keyterm:Offering`); LORD (ID: `deity:Lord`); Passover (ID: `keyterm:Passover`); Кир (ID: `person:Cyrus`); Sheep (ID: `fauna:Lamb`); Екбатана (ID: `place:Ecbatana`); Захария (ID: `person:Zechariah.17`); Мидия (ID: `place:Media`); Pure (ID: `keyterm:Pure`); Аггей (ID: `person:Haggai`); Артаксеркс (ID: `person:Artaxerxes`); Навуходоносор (ID: `person:Nebuchadnezzar`); Персия (ID: `place:Persia`); Assyria (ID: `place:Assyria`); Моисей (ID: `person:Moses`); Defilement (ID: `keyterm:Defilement`); Gentiles (ID: `group:Gentile`); Iddo (ID: `person:Iddo.6`); Unleavened Bread (ID: `realia:UnleavenedBread`); Wheat (ID: `flora:Wheat`); Foundation (ID: `realia:Foundation`); Flock (ID: `fauna:Flock`); Cubit (ID: `realia:Cubit`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Израиль (ID: `person:Israel`); Ездра (ID: `person:Ezra`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Артаксеркс (ID: `person:Artaxerxes`); House (ID: `realia:House`); Money (ID: `realia:Money`); Вавилон (ID: `place:Babylon`); Агава (ID: `place:Ahava`); Offering (ID: `keyterm:Offering`); Евфрат (ID: `place:Euphrates`); Хашавия (ID: `person:Hashabiah.7`); Шеревия (ID: `person:Sherebiah`); Decree (ID: `keyterm:Decree`); Perceive (ID: `keyterm:Perceive`); Instruction (ID: `keyterm:Instruction`); Финеес (ID: `person:Phinehas`); Давид (ID: `person:David`); Иехиел (ID: `person:Jehiel.7`); Захария (ID: `person:Zechariah.19`); Даниил (ID: `person:Daniel.2`); Гаккатан (ID: `person:Hakkatan`); Елам (ID: `person:Elam`); Нафан (ID: `person:Nathan.5`); Евед (ID: `person:Ebed.2`); Иозавад (ID: `person:Jozabad.6`); Афалия (ID: `person:Athaliah.3`); Ноадия (ID: `person:Noadiah`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Ездра (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Passion (ID: `keyterm:Ardour`); Иерусалим (ID: `place:Jerusalem`); House (ID: `realia:House`); Харим (ID: `person:Harim`); Елам (ID: `person:Elam`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Offering (ID: `keyterm:Offering`); Counsel (ID: `keyterm:Counsel`); Мафнай (ID: `person:Mattenai.2`); Матфания (ID: `person:Mattaniah.6`); Мафнай (ID: `person:Mattenai`); Иремоф (ID: `person:Jeremoth.4`); Ваний (ID: `person:Bani.5`); Завад (ID: `person:Zabad.7`); Яхзеия (ID: `person:Jahzeiah`); Иехиел (ID: `person:Jehiel.8`); Бидья (ID: `person:Bedeiah`); Ванея (ID: `person:Vaniah`); Маасея (ID: `person:Maaseiah.9`); Зевина (ID: `person:Zebina`); Ванея (ID: `person:Benaiah.8`); Биннуй (ID: `person:Binnui.3`); Пафахия (ID: `person:Pethahiah.2`)
