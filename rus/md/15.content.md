...
* **Associated Articles:** Бог (ID: `193281@BiblicaStudyNotesKeyTerms`); Труд (ID: `193290@BiblicaStudyNotesKeyTerms`); Египет (ID: `193333@BiblicaStudyNotesKeyTerms`); Завет с Авраамом (ID: `193335@BiblicaStudyNotesKeyTerms`); Рабство (ID: `193340@BiblicaStudyNotesKeyTerms`); Израиль (ID: `193362@BiblicaStudyNotesKeyTerms`); Иуда, патриарх (ID: `193373@BiblicaStudyNotesKeyTerms`); Вениамин (ID: `193376@BiblicaStudyNotesKeyTerms`); Божий народ (ID: `193384@BiblicaStudyNotes`); Исход (ID: `193398@BiblicaStudyNotesKeyTerms`); Царь (ID: `193412@BiblicaStudyNotesKeyTerms`); Священник (ID: `193415@BiblicaStudyNotesKeyTerms`); Скиния  (ID: `193416@BiblicaStudyNotesKeyTerms`); Левиты (ID: `193425@BiblicaStudyNotesKeyTerms`); Пророчество (ID: `193481@BiblicaStudyNotesKeyTerms`); Храм (ID: `193499@BiblicaStudyNotesKeyTerms`); Иерусалим (ID: `193546@BiblicaStudyNotesKeyTerms`); Соломон (ID: `193555@BiblicaStudyNotesKeyTerms`); Южное Царство (ID: `193562@BiblicaStudyNotesKeyTerms`); до н.э. (ID: `193576@BiblicaStudyNotesKeyTerms`); Плен (изгнание) (ID: `193577@BiblicaStudyNotesKeyTerms`); Исаия (ID: `193579@BiblicaStudyNotesKeyTerms`); Вавилон (ID: `193580@BiblicaStudyNotesKeyTerms`); Навуходоносор (ID: `193583@BiblicaStudyNotesKeyTerms`); Кир (ID: `193584@BiblicaStudyNotesKeyTerms`); Иудей (ID: `193585@BiblicaStudyNotesKeyTerms`); Иеремия (ID: `193589@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Иерусалим (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Кир (ID: `person:Cyrus`); Money (ID: `realia:Money`); House (ID: `realia:House`); Израиль (ID: `person:Israel`); Персия (ID: `place:Persia`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Зоровавель (ID: `person:Zerubbabel.2`); Елам (ID: `person:Elam`); Навуходоносор (ID: `person:Nebuchadnezzar`); Соломон (ID: `person:Solomon`); Вавилон (ID: `place:Babylon`); Арах (ID: `person:Arah.2`); Даркон (ID: `person:Darkon`); Хаттил (ID: `person:Hattil`); Нево (ID: `place:Nebo.2`); Мифредат (ID: `person:Mithredath`); Езекия (ID: `person:Hezekiah.2`); Некода (ID: `person:Nekoda`); Бесай (ID: `person:Besai`); Хадид (ID: `place:Hadid`); Хархур (ID: `person:Harhur`); Амий (ID: `person:Ami`); Харим (ID: `person:Harim.2`); Лебана (ID: `person:Lebanah`); Мехида (ID: `person:Mehida`)
...
* **Associated ACAI Concepts:** Иерусалим (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Израиль (ID: `person:Israel`); Зоровавель (ID: `person:Zerubbabel.2`); Евфрат (ID: `place:Euphrates`); Кир (ID: `person:Cyrus`); Персия (ID: `place:Persia`); Offering (ID: `keyterm:Offering`); Вавилон (ID: `place:Babylon`); Дарий (ID: `person:Darius.2`); Иуда (ID: `person:Judah.4`); Рехум (ID: `person:Rehum.2`); Шимшай (ID: `person:Shimshai`); Артаксеркс (ID: `person:Artaxerxes.2`); Иисус (ID: `person:Joshua.5`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Jews (ID: `group:Jews`); Салафиил (ID: `person:Shealtiel.2`); Иоседек (ID: `person:Jehozadak`); Иуда (ID: `group:Judah`); Фафнай (ID: `person:Tattenai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Навуходоносор (ID: `person:Nebuchadnezzar`); Самария (ID: `place:Samaria`); Аснафар (ID: `person:Osnappar`); Хенадад (ID: `person:Henadad`); Иешуа (ID: `person:Jeshua.4`); Бишлам (ID: `person:Bishlam`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Дарий (ID: `person:Darius.2`); Иерусалим (ID: `place:Jerusalem`); Израиль (ID: `person:Israel`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Jews (ID: `group:Jews`); Евфрат (ID: `place:Euphrates`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Scroll (ID: `realia:Scroll`); Фафнай (ID: `person:Tattenai`); Offering (ID: `keyterm:Offering`); Вавилон (ID: `place:Babylon`); Passover (ID: `keyterm:Passover`); LORD (ID: `deity:Lord`); Кир (ID: `person:Cyrus`); Sheep (ID: `fauna:Lamb`); Екбатана (ID: `place:Ecbatana`); Захария (ID: `person:Zechariah.17`); Iddo (ID: `person:Iddo.6`); Мидия (ID: `place:Media`); Персия (ID: `place:Persia`); Pure (ID: `keyterm:Pure`); Моисей (ID: `person:Moses`); Gentiles (ID: `group:Gentile`); Defilement (ID: `keyterm:Defilement`); Аггей (ID: `person:Haggai`); Артаксеркс (ID: `person:Artaxerxes`); Assyria (ID: `place:Assyria`); Навуходоносор (ID: `person:Nebuchadnezzar`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`); Goat (ID: `fauna:Goat`); Cubit (ID: `realia:Cubit`); Flock (ID: `fauna:Flock`); Wheat (ID: `flora:Wheat`); Unleavened Bread (ID: `realia:UnleavenedBread`); Anointing Oil (ID: `realia:AnointingOil`); Foundation (ID: `realia:Foundation`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Ездра (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Passion (ID: `keyterm:Ardour`); Иерусалим (ID: `place:Jerusalem`); House (ID: `realia:House`); Харим (ID: `person:Harim`); Иуда (ID: `group:Judah`); Counsel (ID: `keyterm:Counsel`); Offering (ID: `keyterm:Offering`); Елам (ID: `person:Elam`); Иуда (ID: `person:Judah.4`); Иехиел (ID: `person:Jehiel.9`); Шеал (ID: `person:Sheal`); Маасея (ID: `person:Maaseiah.8`); Ванея (ID: `person:Benaiah.8`); Пафахия (ID: `person:Pethahiah.2`); Елиезер (ID: `person:Eliezer.10`); Иремоф (ID: `person:Jeremoth.5`); Ваний (ID: `person:Bani.5`); Perizzites (ID: `group:Perizzites`); Мафнай (ID: `person:Mattenai`); Маттафия (ID: `person:Mattithiah.3`); Маллух (ID: `person:Malluch.3`); Иоиль (ID: `person:Joel.12`); Шаллум (ID: `person:Shallum.10`); Иеремай (ID: `person:Jeremai`)
