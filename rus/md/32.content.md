...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иона (ID: `person:Jonah.2`); Ниневия (ID: `place:Nineveh`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Fear (ID: `keyterm:Fear`); Ship (ID: `realia:Ship`); Sackcloth (ID: `realia:Sackcloth`); Fish (ID: `fauna:Fish`); Hell (ID: `place:Hell`); Vow (ID: `keyterm:Vow`); Амафиин (ID: `person:Amittai`); Иоппия (ID: `place:Joppa`); Cattle (ID: `fauna:Bull`); Exempt (ID: `keyterm:Exempt`); Praise (ID: `keyterm:Praise`); Hebrews (ID: `group:Hebrews`); Slaughtering (ID: `keyterm:Slaughtering`); Believe In (ID: `keyterm:BelieveIn`); Lot (ID: `keyterm:Lot`); Salvation (ID: `keyterm:Salvation`); Фарсис (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Goat (ID: `fauna:Goat`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Cattails (ID: `flora:Cattails`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иона (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Ниневия (ID: `place:Nineveh`); Generous (ID: `keyterm:Generous`); Compassionate (ID: `keyterm:Compassionate`); Фарсис (ID: `place:Tarshish`); Kindness (ID: `keyterm:Kindness`); Cattle (ID: `fauna:Bull`); Worm (ID: `fauna:Maggot`)
