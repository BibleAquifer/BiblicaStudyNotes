...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иона (ID: `person:Jonah.2`); Ниневия (ID: `place:Nineveh`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Fear (ID: `keyterm:Fear`); Fish (ID: `fauna:Fish`); Sackcloth (ID: `realia:Sackcloth`); Ship (ID: `realia:Ship`); Hell (ID: `place:Hell`); Vow (ID: `keyterm:Vow`); Амафиин (ID: `person:Amittai`); Иоппия (ID: `place:Joppa`); Cattle (ID: `fauna:Bull`); Exempt (ID: `keyterm:Exempt`); Praise (ID: `keyterm:Praise`); Фарсис (ID: `place:Tarshish`); Hebrews (ID: `group:Hebrews`); Lot (ID: `keyterm:Lot`); Believe In (ID: `keyterm:BelieveIn`); Kindness (ID: `keyterm:Kindness`); Slaughtering (ID: `keyterm:Slaughtering`); Salvation (ID: `keyterm:Salvation`); Throne (ID: `realia:Throne`); Flock (ID: `fauna:Flock`); Clothing (ID: `realia:Clothing`); Cattails (ID: `flora:Cattails`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иона (ID: `person:Jonah.2`); Castor Oil (ID: `flora:CastorOil`); Kindness (ID: `keyterm:Kindness`); Ниневия (ID: `place:Nineveh`); Фарсис (ID: `place:Tarshish`); Compassionate (ID: `keyterm:Compassionate`); Generous (ID: `keyterm:Generous`); Cattle (ID: `fauna:Bull`); Worm (ID: `fauna:Maggot`)
