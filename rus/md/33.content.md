...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Иерусалим (ID: `place:Jerusalem`); Practice Divination (ID: `keyterm:PracticeDivination`); Rebel (ID: `keyterm:Rebel`); Самария (ID: `place:Samaria`); To Sin (ID: `keyterm:Sin`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); House (ID: `realia:House`); Moresheth-gath (ID: `place:Moresheth-gath`); Морасфитянин (ID: `place:Moresheth`); Мароф (ID: `place:Maroth`); Шафир (ID: `place:Shaphir`); Beth-ezel (ID: `place:Beth-ezel`); Цаан (ID: `place:Zaanan`); Ахзив (ID: `place:Achzib`); Миха (ID: `person:Micah.6`); Prophets (ID: `group:GenericProphets`); Vine (ID: `flora:Vine`); Woe (ID: `keyterm:Woe.2`); Dispossess (ID: `keyterm:Dispossess`); Glory (ID: `keyterm:Glory`); To Cause to Possess (ID: `keyterm:Possess`); Езекия (ID: `person:Hezekiah`); Strength (ID: `keyterm:Strength`); Love (ID: `keyterm:Love`); Ахаз (ID: `person:Ahaz`); Лахис (ID: `place:Lachish`); Peace (ID: `keyterm:IntactState`); Proverb (ID: `keyterm:Saying`); Офра (ID: `place:Ophrah`); Одоллам (ID: `place:Adullam`); Мареша (ID: `place:Mareshah`); Safety (ID: `keyterm:Safety`); Defilement (ID: `keyterm:Defilement`); Mischief (ID: `keyterm:Mischief`); Have a Vision (ID: `keyterm:HaveAVision`); Holy (ID: `keyterm:Holy`); Геф (ID: `place:Gath`); Иофам (ID: `person:Jotham.2`); Lot (ID: `keyterm:Lot`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Bed (ID: `realia:Bed`); Cloak (ID: `realia:Cloak`); Sheepfold (ID: `realia:Sheepfold`); Sandalwood (ID: `flora:Sandalwood`); Jackal (ID: `fauna:Jackal`); Image (ID: `realia:Image`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Money (ID: `realia:Money`); Rope (ID: `realia:Rope`); Goat (ID: `fauna:Goat`); Vulture (ID: `fauna:Vulture`); Graven Image (ID: `realia:GravenImage`); Cooking Pot (ID: `realia:CookingPot`); Wine (ID: `realia:Wine`); Horse (ID: `fauna:Horse`); Chariot (ID: `realia:Chariot`); Owl (ID: `fauna:Owl`); Flock (ID: `fauna:Flock`); Foundation (ID: `realia:Foundation`); Ostrich (ID: `fauna:Ostrich`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Израиль (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Assyrians (ID: `group:Assyria`); Assyria (ID: `place:Assyria`); Вифлеем (ID: `place:Bethlehem`); Incantations (ID: `keyterm:Incantations`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Counsel (ID: `keyterm:Counsel`); Instruction (ID: `keyterm:Instruction`); Under Siege (ID: `keyterm:StateOfBeingUnderSiege`); Set Apart for God (ID: `keyterm:Proscribe`); Нимрод (ID: `person:Nimrod`); The Way (ID: `keyterm:TheWay`); Peace (ID: `keyterm:IntactState`); Horn (ID: `keyterm:Horn`); Вавилон (ID: `place:Babylon`); Tower of Eder (ID: `place:TowerOfEder`); Redeem (ID: `keyterm:Redeem`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Asherah (ID: `deity:Asherah`); Perceive (ID: `keyterm:Perceive`); Gentiles (ID: `group:Gentile`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Pruning Knife (ID: `realia:PruningKnife`); Sheaf (ID: `realia:Sheaf`); Staff (ID: `realia:Staff`); Sandalwood (ID: `flora:Sandalwood`); Fig (ID: `flora:Fig`); Lion (ID: `fauna:Lion`); Vine (ID: `flora:Vine`); Sacred Pole (ID: `realia:SacredPole`); Graven Image (ID: `realia:GravenImage`); Rod (ID: `realia:Rod`); Spear (ID: `realia:Spear`); Horse (ID: `fauna:Horse`); Mattock (ID: `realia:Mattock`); Chariot (ID: `realia:Chariot`); Sacred Pillar (ID: `realia:SacredPillar`); Threshing Floor (ID: `realia:ThreshingFloor`); Grass (ID: `flora:Grass`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Kindness (ID: `keyterm:Kindness`); Египет (ID: `place:Egypt`); Rebel (ID: `keyterm:Rebel`); To Cause to Possess (ID: `keyterm:Possess`); Passion (ID: `keyterm:Ardour`); Deceit (ID: `keyterm:Deceit`); Израиль (ID: `person:Israel`); Olive Oil (ID: `realia:OliveOil`); Vine (ID: `flora:Vine`); Sheep (ID: `fauna:Lamb`); Anointing Oil (ID: `realia:AnointingOil`); Salvation (ID: `keyterm:Salvation`); Валак (ID: `person:Balak`); Sound Wisdom (ID: `keyterm:SoundWisdom`); Ахав (ID: `person:Ahab`); Forgive (ID: `keyterm:Forgive`); Авраам (ID: `person:Abraham`); Аарона (ID: `person:Aaron`); Моав (ID: `place:Moab`); Swear (ID: `keyterm:Swear`); Ситтим (ID: `place:Shittim`); Love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); Евфрат (ID: `place:Euphrates`); Галаад (ID: `place:Gilead`); Моисей (ID: `person:Moses`); Васан (ID: `place:Bashan`); Амрий (ID: `person:Omri`); Redeem (ID: `keyterm:Redeem`); Валаам (ID: `person:Balaam`); Fear (ID: `keyterm:Fear`); Decree (ID: `keyterm:Decree`); Believe In (ID: `keyterm:BelieveIn`); Веоров (ID: `person:Beor.2`); Loyal Person (ID: `keyterm:LoyalPerson`); Trust (ID: `keyterm:LeanOn`); Мариам (ID: `person:Miriam`); Visitation (ID: `keyterm:Visitation`); Assyria (ID: `place:Assyria`); Gilgal (ID: `place:Gilgal.2`); Offering (ID: `keyterm:Offering`); Net (ID: `realia:Net`); Balance (ID: `realia:Balance`); Bag (ID: `realia:Bag`); Brier (ID: `flora:Brier`); Sandalwood (ID: `flora:Sandalwood`); Staff (ID: `realia:Staff`); Molten Image (ID: `realia:MoltenImage`); House (ID: `realia:House`); Cattle (ID: `fauna:Bull`); Must (ID: `realia:Must`); Fig (ID: `flora:Fig`); Barley (ID: `flora:Barley`); Goat (ID: `fauna:Goat`); Rod (ID: `realia:Rod`); Mule (ID: `fauna:Mule`); Thorn Hedge (ID: `realia:ThornHedge`); Wine (ID: `realia:Wine`); Snake (ID: `fauna:Snake`); Ephah (ID: `realia:Ephah`); Flock (ID: `fauna:Flock`); Foundation (ID: `realia:Foundation`); Olive Tree (ID: `flora:OliveTree`); Dragnet (ID: `realia:Dragnet`)
