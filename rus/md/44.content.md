...
* **Associated ACAI Concepts:** Святой Дух (ID: `deity:HolySpirit`); LORD (ID: `deity:Lord`); Иисус (ID: `person:Jesus.2`); Sky (ID: `keyterm:Heaven`); Kingdom (ID: `keyterm:Kingdom`); Иерусалим (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Иудея (ID: `place:Judea`); Witness (ID: `keyterm:Witness`); Galileans (ID: `group:Galilee`); Promise (ID: `keyterm:Promise`); Феофил (ID: `person:Theophilus`); Authority (ID: `keyterm:Authority.2`); Ask for (ID: `keyterm:AskFor`); Самария (ID: `place:Samaria`); To Command (ID: `keyterm:Command`); Chosen (ID: `keyterm:Chosen`); Галилея (ID: `place:Galilee`); Life (ID: `keyterm:Life`); Baptism (ID: `keyterm:Baptism`); Израиль (ID: `person:Israel`); Иоанн (ID: `person:John`); Clothing (ID: `realia:Clothing`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Матфий (ID: `person:Matthias`); Pray (ID: `keyterm:Pray`); Иуда (ID: `person:Judas.2`); Иерусалим (ID: `place:Jerusalem`); Пётр (ID: `person:Peter`); Serve (ID: `keyterm:Serve`); Алфей (ID: `person:Alphaeus`); Варфоломей (ID: `person:Bartholomew`); Akeldama (ID: `place:Akeldama`); Иосиф (ID: `person:Joseph.9`); Андрей (ID: `person:Andrew`); Mount of Olives (ID: `place:OlivesMount`); Фома (ID: `person:Thomas`); Мария (ID: `person:Mary`); Иаков (ID: `person:James.2`); Симон (ID: `person:Simon.2`); Written (ID: `keyterm:Scripture`); Иоанн (ID: `person:John.2`); Sabbath Journey (ID: `keyterm:HalfAMile`); Witness (ID: `keyterm:Witness`); Давид (ID: `person:David`); Knower of Hearts (ID: `keyterm:KnowerOfHearts`); Chosen (ID: `keyterm:Chosen`); Name (ID: `keyterm:Name`); Матфей (ID: `person:Matthew`); LORD (ID: `deity:Lord`); Unjust Deed (ID: `keyterm:UnjustDeed`); Иуда (ID: `person:Judas`); Resurrection (ID: `keyterm:Resurrection`); Baptism (ID: `keyterm:Baptism`); Blood (ID: `keyterm:Blood`); To Cause to Happen (ID: `keyterm:Happen`); Святой Дух (ID: `deity:HolySpirit`); Иоанн (ID: `person:John`); Position of Responsibility (ID: `keyterm:PositionOfResponsibility`); Филипп (ID: `person:Philip`); Иаков (ID: `person:James`); Lot (ID: `realia:Lot`); Half a Mile (ID: `realia:HalfAMile`); Upstairs Room (ID: `realia:UpstairsRoom`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Sky (ID: `keyterm:Heaven`); Jews (ID: `group:Jews`); Фригия (ID: `place:Phrygia`); Elamites (ID: `group:Elam`); Елам (ID: `place:Elam`); Медан (ID: `person:Medan`); Galileans (ID: `group:Galilee`); Иерусалим (ID: `place:Jerusalem`); Каппадокия (ID: `place:Cappadocia`); критянин (ID: `group:Cretan`); Ливияне (ID: `place:Libya`); Понт (ID: `place:Pontus`); киринеянин (ID: `place:Cyrene`); Parthians (ID: `group:Parthians`); Medes (ID: `group:Mede`); Arabians (ID: `group:Arabia`); Месопотамия (ID: `place:Mesopotamia`); Иудея (ID: `place:Judea`); Египет (ID: `place:Egypt`); Римлянин (ID: `place:Rome`); Крит (ID: `place:Crete`); Асии (ID: `place:Asia`); Галилея (ID: `place:Galilee`); LORD (ID: `deity:Lord`); Арбитянин (ID: `place:Arabia`); Святой Дух (ID: `deity:HolySpirit`); Памфилия (ID: `place:Pamphylia`); Mighty Act (ID: `keyterm:MightyAct`); Sweet Wine (ID: `realia:SweetWine`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иисус (ID: `person:Jesus.2`); Святой Дух (ID: `deity:HolySpirit`); Пётр (ID: `person:Peter`); Давид (ID: `person:David`); Body (ID: `keyterm:Body.3`); Portent (ID: `keyterm:Portent`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Baptism (ID: `keyterm:Baptism`); Heart (ID: `keyterm:Heart`); Sky (ID: `keyterm:Heaven`); Symbol (ID: `keyterm:Example`); Name (ID: `keyterm:Name`); Hell (ID: `place:Hell`); Promise (ID: `keyterm:Promise`); Blood (ID: `keyterm:Blood`); Salvation (ID: `keyterm:Salvation`); Speak as a Prophet (ID: `keyterm:Speak`); Израиль (ID: `person:Israel`); Judeans (ID: `group:Judea`); Repent (ID: `keyterm:Repent`); Иоиль (ID: `person:Joel.14`); Resurrection (ID: `keyterm:Resurrection`); Call Upon (ID: `keyterm:CallUpon`); Word (ID: `keyterm:Word`); Cross (ID: `realia:Cross`); Ask for (ID: `keyterm:AskFor`); Forgive (ID: `keyterm:Forgive`); Hope (ID: `keyterm:Hope`); Oath (ID: `keyterm:Oath`); Иудея (ID: `place:Judea`); Declare (ID: `keyterm:Declare`); Witness (ID: `keyterm:Witness`); Назарет (ID: `place:Nazareth`); Be Lawful (ID: `keyterm:Lawful`); Иерусалим (ID: `place:Jerusalem`); Lawless (ID: `keyterm:Lawless`); Ability (ID: `keyterm:Ability`); Something Definite (ID: `keyterm:SomethingDefinite`); Life (ID: `keyterm:Life`); Israelites (ID: `group:Israel`); To Sin (ID: `keyterm:Sin`); Holy (ID: `keyterm:Holy`); Grave (ID: `realia:Grave`); Footstool (ID: `realia:Footstool`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Fellowship (ID: `keyterm:Fellowship`); Heart (ID: `keyterm:Heart`); Favor (ID: `keyterm:Favor`); Portent (ID: `keyterm:Portent`); Believe (ID: `keyterm:Believe`); Salvation (ID: `keyterm:Salvation`); Fear (ID: `keyterm:Fear`); Иисус (ID: `person:Jesus.2`); Symbol (ID: `keyterm:Example`); LORD (ID: `deity:Lord`); Pray (ID: `keyterm:Pray`); In Common (ID: `keyterm:InCommon`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Temple (ID: `realia:Temple`); Пётр (ID: `person:Peter`); Иоанн (ID: `person:John.2`); Beautiful Gate (ID: `place:BeautifulGate`); LORD (ID: `deity:Lord`); Name (ID: `keyterm:Name`); Ask for (ID: `keyterm:AskFor`); Иисус (ID: `person:Jesus.2`); Pray (ID: `keyterm:Pray`); Назарет (ID: `place:Nazareth`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иисус (ID: `person:Jesus.2`); Авраам (ID: `person:Abraham`); Израиль (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Пётр (ID: `person:Peter`); Solomon's Colonnade (ID: `place:SolomonsPortico`); Самуил (ID: `person:Samuel`); To Cause to Happen (ID: `keyterm:Happen`); Sky (ID: `keyterm:Heaven`); Forgive (ID: `keyterm:Forgive`); Repent (ID: `keyterm:Repent`); Иоанн (ID: `person:John.2`); Исаак (ID: `person:Isaac`); Bless (ID: `keyterm:Bless`); Witness (ID: `keyterm:Witness`); Decided (ID: `keyterm:Decided`); Пилат (ID: `person:Pilate`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Covenant (ID: `keyterm:Covenant`); Always (ID: `keyterm:Always`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Моисей (ID: `person:Moses`); Life (ID: `keyterm:Life`); Israelites (ID: `group:Israel`); Resurrection (ID: `keyterm:Resurrection`); Believe (ID: `keyterm:Believe`); To Sin (ID: `keyterm:Sin`); Glory (ID: `keyterm:Glory`); Porch (ID: `realia:Porch`)
...
* **Associated ACAI Concepts:** Name (ID: `keyterm:Name`); Иисус (ID: `person:Jesus.2`); LORD (ID: `deity:Lord`); Пётр (ID: `person:Peter`); Salvation (ID: `keyterm:Salvation`); Symbol (ID: `keyterm:Example`); Иоанн (ID: `person:John.2`); Иерусалим (ID: `place:Jerusalem`); Resurrection (ID: `keyterm:Resurrection`); Каиафа (ID: `person:Caiaphas`); Иоанн (ID: `person:John.3`); Александр (ID: `person:Alexander.2`); Анна (ID: `person:Annas`); Sadducees (ID: `group:Sadducee`); Sky (ID: `keyterm:Heaven`); Decided (ID: `keyterm:Decided`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Назарет (ID: `place:Nazareth`); Ability (ID: `keyterm:Ability`); Discern (ID: `keyterm:Discern`); Believe (ID: `keyterm:Believe`); Святой Дух (ID: `deity:HolySpirit`); Израиль (ID: `person:Israel`); Glory (ID: `keyterm:Glory`); Serve (ID: `keyterm:Serve`); Cornerstone (ID: `realia:Cornerstone`); Temple (ID: `realia:Temple`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иисус (ID: `person:Jesus.2`); Ask for (ID: `keyterm:AskFor`); Gentiles (ID: `group:Gentile`); Святой Дух (ID: `deity:HolySpirit`); Holy (ID: `keyterm:Holy`); Варнава (ID: `person:Barnabas`); Пилат (ID: `person:Pilate`); Cypriots (ID: `group:Cyprus`); Heart (ID: `keyterm:Heart`); Bear Witness (ID: `keyterm:BearWitness`); Portent (ID: `keyterm:Portent`); Sky (ID: `keyterm:Heaven`); Киттим (ID: `place:Cyprus`); Symbol (ID: `keyterm:Example`); Давид (ID: `person:David`); Левий (ID: `group:Levi`); Name (ID: `keyterm:Name`); Favor (ID: `keyterm:Favor`); Truth (ID: `keyterm:Truth`); Empty (ID: `keyterm:Empty`); Ability (ID: `keyterm:Ability`); Ирод Антипа (ID: `person:Herod.2`); Левий (ID: `person:Levi.3`); Resurrection (ID: `keyterm:Resurrection`); Believe (ID: `keyterm:Believe`); Anointed (ID: `keyterm:Anointed`); Израиль (ID: `person:Israel`); In Common (ID: `keyterm:InCommon`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Анания (ID: `person:Ananias`); Пётр (ID: `person:Peter`); Heart (ID: `keyterm:Heart`); Fear (ID: `keyterm:Fear`); Святой Дух (ID: `deity:HolySpirit`); LORD (ID: `deity:Lord`); Сапфира (ID: `person:Sapphira`); Name (ID: `keyterm:Name`); Authority (ID: `keyterm:Authority.2`); сатана (ID: `deity:Satan`); Church (ID: `keyterm:Church`); Ability (ID: `keyterm:Ability`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** Prison (ID: `realia:Prison`); Temple (ID: `realia:Temple`); LORD (ID: `deity:Lord`); Door (ID: `realia:Door`); Portent (ID: `keyterm:Portent`); Resentment (ID: `keyterm:Resentment`); A Person (ID: `person:GenericPerson`); Symbol (ID: `keyterm:Example`); Fear (ID: `keyterm:Fear`); An Angel (ID: `deity:Angel`); Иерусалим (ID: `place:Jerusalem`); Sadducees (ID: `group:Sadducee`); Life (ID: `keyterm:Life`); Believe (ID: `keyterm:Believe`); Serve (ID: `keyterm:Serve`); Израиль (ID: `person:Israel`); Пётр (ID: `person:Peter`); Word (ID: `keyterm:Word`); Porch (ID: `realia:Porch`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Name (ID: `keyterm:Name`); Persuade (ID: `keyterm:Persuade`); Heart (ID: `keyterm:Heart`); Иисус (ID: `person:Jesus.2`); Израиль (ID: `person:Israel`); Иуда (ID: `person:Judas.3`); Witness (ID: `keyterm:Witness`); Февда (ID: `person:Theudas`); Гамалиил (ID: `person:Gamaliel`); Savior (ID: `keyterm:Savior`); Forgive (ID: `keyterm:Forgive`); Repent (ID: `keyterm:Repent`); Good News (ID: `keyterm:GoodNews`); A Group of Disciples (ID: `group:GenericDisciples`); Pharisees (ID: `group:Pharisee`); Galileans (ID: `group:Galilee`); Иерусалим (ID: `place:Jerusalem`); Галилея (ID: `place:Galilee`); Israelites (ID: `group:Israel`); Blood (ID: `keyterm:Blood`); Resurrection (ID: `keyterm:Resurrection`); Census (ID: `keyterm:Census`); Святой Дух (ID: `deity:HolySpirit`); Opposing God (ID: `keyterm:OpposingGod`); To Sin (ID: `keyterm:Sin`); Пётр (ID: `person:Peter`); Word (ID: `keyterm:Word`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** Serve (ID: `keyterm:Serve`); Be a Disciple (ID: `keyterm:Disciple`); Филипп (ID: `person:Philip.4`); LORD (ID: `deity:Lord`); Pray (ID: `keyterm:Pray`); Believe (ID: `keyterm:Believe`); Святой Дух (ID: `deity:HolySpirit`); Стефан (ID: `person:Stephen`); Antiochians (ID: `group:Antioch`); Никанор (ID: `person:Nicanor`); Прохор (ID: `person:Prochorus`); Николай (ID: `person:Nicolaus`); Тимон (ID: `person:Timon`); Hellenists (ID: `group:Hellenist`); Пармена (ID: `person:Parmenas`); Bear Witness (ID: `keyterm:BearWitness`); A Group of Disciples (ID: `group:GenericDisciples`); Иерусалим (ID: `place:Jerusalem`); Chosen (ID: `keyterm:Chosen`); Greece (ID: `place:Greece`); Антиохия (ID: `place:Antioch`); Hebrews (ID: `group:Hebrews`); Spirit (ID: `keyterm:Spirit.2`)
...
* **Associated ACAI Concepts:** Стефан (ID: `person:Stephen`); Моисей (ID: `person:Moses`); Word (ID: `keyterm:Word`); Alexandrians (ID: `group:Alexandria`); Александрия (ID: `place:Alexandria`); Freedmen (ID: `group:Freedmen`); Portent (ID: `keyterm:Portent`); Symbol (ID: `keyterm:Example`); Witness (ID: `keyterm:Witness`); An Angel (ID: `deity:Angel`); Назарет (ID: `place:Nazareth`); Асии (ID: `place:Asia`); Favor (ID: `keyterm:Favor`); Ability (ID: `keyterm:Ability`); LORD (ID: `deity:Lord`); Law (ID: `keyterm:Law`); Святой Дух (ID: `deity:HolySpirit`); Иисус (ID: `person:Jesus.2`); Blasphemous (ID: `keyterm:Blasphemous`); киринеянин (ID: `place:Cyrene`); Holy (ID: `keyterm:Holy`); Киликия (ID: `place:Cilicia`); Spirit (ID: `keyterm:Spirit.2`); Tabernacle (ID: `realia:Tabernacle`)
...
* **Associated ACAI Concepts:** Египет (ID: `place:Egypt`); LORD (ID: `deity:Lord`); Моисей (ID: `person:Moses`); Израиль (ID: `person:Israel`); Иосиф (ID: `person:Joseph.10`); Авраам (ID: `person:Abraham`); To Act Wickedly (ID: `keyterm:ActWickedly`); An Angel (ID: `deity:Angel`); Egyptians (ID: `group:Egypt`); Rescue (ID: `keyterm:Rescue`); фараон (ID: `person:Pharaoh.4`); Offering (ID: `keyterm:Offering`); Heart (ID: `keyterm:Heart`); Аран (ID: `place:Haran`); Priesthood (ID: `keyterm:Priesthood`); Mount Sinai (ID: `place:SinaiMount`); Исаак (ID: `person:Isaac`); Judge (ID: `keyterm:Judge`); Promise (ID: `keyterm:Promise`); Serve (ID: `keyterm:Serve`); Месопотамия (ID: `place:Mesopotamia`); Ремфан (ID: `deity:Rephan`); Шехем (ID: `place:Shechem`); Еммор (ID: `person:Hamor`); Brier (ID: `flora:Brier`); Image (ID: `realia:Image`); Boxthorn (ID: `flora:Boxthorn`); Portent (ID: `keyterm:Portent`); Sky (ID: `keyterm:Heaven`); Circumcision (ID: `keyterm:Circumcision`); Вавилон (ID: `place:Babylon`); Аарона (ID: `person:Aaron`); Халдея (ID: `place:Chaldea`); Мадиан (ID: `place:Midian`); Symbol (ID: `keyterm:Example`); Reconcile (ID: `keyterm:Reconcile`); Ханаан (ID: `place:Canaan`); Молох (ID: `deity:Molech`); Make Peace (ID: `keyterm:Peace`); Decided (ID: `keyterm:Decided`); Covenant (ID: `keyterm:Covenant`); фараон (ID: `person:Pharaoh.5`); Be Enslaved (ID: `keyterm:Serve.2`); Favor (ID: `keyterm:Favor`); Avenge (ID: `keyterm:GrantJustice`); Bow Down (ID: `keyterm:BowDown`); Life (ID: `keyterm:Life`); Savior (ID: `keyterm:Savior`); Israelites (ID: `group:Israel`); Red Sea (ID: `place:RedSea`); Salvation (ID: `keyterm:Salvation`); Chaldeans (ID: `group:Chaldea`); Holy (ID: `keyterm:Holy`); Glory (ID: `keyterm:Glory`); Tent (ID: `realia:Tent`); Grave (ID: `realia:Grave`); Wheat (ID: `flora:Wheat`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Heart (ID: `keyterm:Heart`); Bear Witness (ID: `keyterm:BearWitness`); Sky (ID: `keyterm:Heaven`); Иисус (ID: `person:Joshua.2`); Давид (ID: `person:David`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); Favor (ID: `keyterm:Favor`); Моисей (ID: `person:Moses`); Gentiles (ID: `group:Gentile`); Law (ID: `keyterm:Law`); Святой Дух (ID: `deity:HolySpirit`); Израиль (ID: `person:Israel`); Соломон (ID: `person:Solomon`); Tabernacle (ID: `realia:Tabernacle`); Footstool (ID: `realia:Footstool`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Sky (ID: `keyterm:Heaven`); LORD (ID: `deity:Lord`); Стефан (ID: `person:Stephen`); Call Upon (ID: `keyterm:CallUpon`); Glory (ID: `keyterm:Glory`); Witness (ID: `keyterm:Witness`); Святой Дух (ID: `deity:HolySpirit`); Павел (ID: `person:Paul`); To Sin (ID: `keyterm:Sin`); Spirit (ID: `keyterm:Spirit.2`); Cloak (ID: `realia:Cloak`)
...
* **Associated ACAI Concepts:** Филипп (ID: `person:Philip.4`); Павел (ID: `person:Paul`); Самария (ID: `place:Samaria`); Church (ID: `keyterm:Church`); Стефан (ID: `person:Stephen`); Иудея (ID: `place:Judea`); Иерусалим (ID: `place:Jerusalem`); Proclaim (ID: `keyterm:Proclaim`); Иисус (ID: `person:Jesus.2`); Serve (ID: `keyterm:Serve`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Symbol (ID: `keyterm:Example`); Good News (ID: `keyterm:GoodNews`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Prison (ID: `realia:Prison`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Святой Дух (ID: `deity:HolySpirit`); Симон (ID: `person:Simon.8`); Самария (ID: `place:Samaria`); Name (ID: `keyterm:Name`); Ability (ID: `keyterm:Ability`); Baptism (ID: `keyterm:Baptism`); Филипп (ID: `person:Philip.4`); Heart (ID: `keyterm:Heart`); Ask for (ID: `keyterm:AskFor`); Good News (ID: `keyterm:GoodNews`); Иерусалим (ID: `place:Jerusalem`); Believe (ID: `keyterm:Believe`); Иисус (ID: `person:Jesus.2`); Пётр (ID: `person:Peter`); Money (ID: `realia:Money`); Authority (ID: `keyterm:Authority.2`); Forgive (ID: `keyterm:Forgive`); Repent (ID: `keyterm:Repent`); Samaritans (ID: `group:Samaritan`); Иоанн (ID: `person:John.2`); Symbol (ID: `keyterm:Example`); Declare (ID: `keyterm:Declare`); Kingdom (ID: `keyterm:Kingdom`); Симон (ID: `person:Simon.9`); Unjust Deed (ID: `keyterm:UnjustDeed`); Pray (ID: `keyterm:Pray`); Straightness (ID: `keyterm:Straightness`)
...
* **Associated ACAI Concepts:** Филипп (ID: `person:Philip.4`); Public Official (ID: `person:GenericOfficial`); Chariot (ID: `realia:Chariot`); Good News (ID: `keyterm:GoodNews`); Written (ID: `keyterm:Scripture`); Ask for (ID: `keyterm:AskFor`); Исаия (ID: `person:Isaiah`); Иерусалим (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Baptism (ID: `keyterm:Baptism`); Святой Дух (ID: `deity:HolySpirit`); Ефиопия (ID: `place:Ethiopia`); Газа (ID: `place:Gaza`); Азот (ID: `place:Ashdod`); Ethiopians (ID: `group:Ethiopia`); An Angel (ID: `deity:Angel`); Bow Down (ID: `keyterm:BowDown`); Кесария (ID: `place:Caesarea`); Life (ID: `keyterm:Life`); Иисус (ID: `person:Jesus.2`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Павел (ID: `person:Paul`); Иисус (ID: `person:Jesus.2`); Name (ID: `keyterm:Name`); Дамаск (ID: `place:Damascus`); Анания (ID: `person:Ananias.2`); Be a Disciple (ID: `keyterm:Disciple`); Иерусалим (ID: `place:Jerusalem`); House (ID: `realia:House`); Иуда (ID: `person:Judas.4`); Straight Street (ID: `place:Straight`); Тарсянин (ID: `group:Tarsus`); The Way (ID: `keyterm:TheWay`); Sky (ID: `keyterm:Heaven`); Authority (ID: `keyterm:Authority.2`); Chosen (ID: `keyterm:Chosen`); Ability (ID: `keyterm:Ability`); Gentiles (ID: `group:Gentile`); Pray (ID: `keyterm:Pray`); Тарсянин (ID: `place:Tarsus`); Straightness (ID: `keyterm:Straightness`); Baptism (ID: `keyterm:Baptism`); Святой Дух (ID: `deity:HolySpirit`); Call Upon (ID: `keyterm:CallUpon`); Израиль (ID: `person:Israel`); Holy (ID: `keyterm:Holy`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Jesus.2`); Иерусалим (ID: `place:Jerusalem`); Name (ID: `keyterm:Name`); Дамаск (ID: `place:Damascus`); Fear (ID: `keyterm:Fear`); Павел (ID: `person:Paul`); Jews (ID: `group:Jews`); Be a Disciple (ID: `keyterm:Disciple`); Hellenists (ID: `group:Hellenist`); Тарсянин (ID: `place:Tarsus`); Ask for (ID: `keyterm:AskFor`); Самария (ID: `place:Samaria`); Proclaim (ID: `keyterm:Proclaim`); Иудея (ID: `place:Judea`); Make Peace (ID: `keyterm:Peace`); Варнава (ID: `person:Barnabas`); Галилея (ID: `place:Galilee`); Greece (ID: `place:Greece`); Кесария (ID: `place:Caesarea`); Believe (ID: `keyterm:Believe`); Святой Дух (ID: `deity:HolySpirit`); Church (ID: `keyterm:Church`); Call Upon (ID: `keyterm:CallUpon`); Basket (ID: `realia:Basket`); City Wall (ID: `realia:CityWall`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Пётр (ID: `person:Peter`); Иоппия (ID: `place:Joppa`); Тавифа (ID: `person:Tabitha`); Лод (ID: `place:Lod`); Иисус (ID: `person:Jesus.2`); Эней (ID: `person:Aeneas`); Name (ID: `keyterm:Name`); Holy (ID: `keyterm:Holy`); Be a Disciple (ID: `keyterm:Disciple`); Upstairs Room (ID: `realia:UpstairsRoom`); Симон (ID: `person:Simon.9`); Sharon Plain (ID: `place:Sharon.2`); Ask for (ID: `keyterm:AskFor`); Body (ID: `keyterm:Body.3`); Pray (ID: `keyterm:Pray`); Life (ID: `keyterm:Life`); Believe (ID: `keyterm:Believe`); Good (ID: `keyterm:Good`); Leather (ID: `realia:Leather`); Tunic (ID: `realia:Tunic.2`); Cloak (ID: `realia:Cloak`); Bed (ID: `realia:Bed`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Пётр (ID: `person:Peter`); Sky (ID: `keyterm:Heaven`); An Angel (ID: `deity:Angel`); Корнилий (ID: `person:Cornelius`); Иоппия (ID: `place:Joppa`); Pray (ID: `keyterm:Pray`); Defilement (ID: `keyterm:Defilement`); Italians (ID: `group:Italy`); Симон (ID: `person:Simon.9`); To Cleanse (ID: `keyterm:Cleanse.2`); Ask for (ID: `keyterm:AskFor`); Италийский (ID: `place:Italy`); Fear (ID: `keyterm:Fear`); Name (ID: `keyterm:Name`); Кесария (ID: `place:Caesarea`); Linen Cloth (ID: `realia:LinenCloth`); Housetop (ID: `realia:Housetop`); Chameleon (ID: `fauna:Chameleon`); Monitor (ID: `fauna:Iguana`); Lizard (ID: `fauna:Lizard`); House (ID: `realia:House`); Snake (ID: `fauna:Snake`); Leather (ID: `realia:Leather`); Creeping Animal (ID: `fauna:CreepingAnimal`)
...
* **Associated ACAI Concepts:** Пётр (ID: `person:Peter`); Корнилий (ID: `person:Cornelius`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Симон (ID: `person:Simon.9`); Иоппия (ID: `place:Joppa`); Pray (ID: `keyterm:Pray`); Jews (ID: `group:Jews`); Bear Witness (ID: `keyterm:BearWitness`); Disgusting (ID: `keyterm:Disgusting`); Fear (ID: `keyterm:Fear`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); An Angel (ID: `deity:Angel`); Men (ID: `group:GenericMales`); Bow Down (ID: `keyterm:BowDown`); Кесария (ID: `place:Caesarea`); Discern (ID: `keyterm:Discern`); Defilement (ID: `keyterm:Defilement`); Святой Дух (ID: `deity:HolySpirit`); Holy (ID: `keyterm:Holy`); Word (ID: `keyterm:Word`); Clothing (ID: `realia:Clothing`); Leather (ID: `realia:Leather`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Святой Дух (ID: `deity:HolySpirit`); Пётр (ID: `person:Peter`); Baptism (ID: `keyterm:Baptism`); Proclaim (ID: `keyterm:Proclaim`); Witness (ID: `keyterm:Witness`); Name (ID: `keyterm:Name`); Иисус (ID: `person:Jesus.2`); Word (ID: `keyterm:Word`); Bear Witness (ID: `keyterm:BearWitness`); Declare (ID: `keyterm:Declare`); Anointed (ID: `keyterm:Anointed`); Circumcision (ID: `keyterm:Circumcision`); Ask for (ID: `keyterm:AskFor`); Forgive (ID: `keyterm:Forgive`); Good News (ID: `keyterm:GoodNews`); Иудея (ID: `place:Judea`); Fear (ID: `keyterm:Fear`); Make Peace (ID: `keyterm:Peace`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Назарет (ID: `place:Nazareth`); Иерусалим (ID: `place:Jerusalem`); Faithfulness (ID: `keyterm:Faithfulness`); Галилея (ID: `place:Galilee`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); Gentiles (ID: `group:Gentile`); Life (ID: `keyterm:Life`); Resurrection (ID: `keyterm:Resurrection`); Believe (ID: `keyterm:Believe`); Иоанн (ID: `person:John`); Jews (ID: `group:Jews`); To Sin (ID: `keyterm:Sin`); Израиль (ID: `person:Israel`); Cross (ID: `realia:Cross`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Sky (ID: `keyterm:Heaven`); Пётр (ID: `person:Peter`); Святой Дух (ID: `deity:HolySpirit`); House (ID: `realia:House`); Иоппия (ID: `place:Joppa`); Gentiles (ID: `group:Gentile`); Discern (ID: `keyterm:Discern`); Defilement (ID: `keyterm:Defilement`); Иисус (ID: `person:Jesus.2`); Word (ID: `keyterm:Word`); Temple (ID: `realia:Temple`); To Cleanse (ID: `keyterm:Cleanse.2`); Circumcision (ID: `keyterm:Circumcision`); Repent (ID: `keyterm:Repent`); Иудея (ID: `place:Judea`); An Angel (ID: `deity:Angel`); Иерусалим (ID: `place:Jerusalem`); Кесария (ID: `place:Caesarea`); Pray (ID: `keyterm:Pray`); Life (ID: `keyterm:Life`); Baptism (ID: `keyterm:Baptism`); Believe (ID: `keyterm:Believe`); Salvation (ID: `keyterm:Salvation`); Иоанн (ID: `person:John`); Glory (ID: `keyterm:Glory`); Linen Cloth (ID: `realia:LinenCloth`); Chameleon (ID: `fauna:Chameleon`); Monitor (ID: `fauna:Iguana`); Lizard (ID: `fauna:Lizard`); Snake (ID: `fauna:Snake`); Creeping Animal (ID: `fauna:CreepingAnimal`)
...
* **Associated ACAI Concepts:** Антиохия (ID: `place:Antioch`); LORD (ID: `deity:Lord`); Киттим (ID: `place:Cyprus`); Be a Disciple (ID: `keyterm:Disciple`); Варнава (ID: `person:Barnabas`); Иерусалим (ID: `place:Jerusalem`); Believe (ID: `keyterm:Believe`); Святой Дух (ID: `deity:HolySpirit`); Павел (ID: `person:Paul`); Иисус (ID: `person:Jesus.2`); Church (ID: `keyterm:Church`); Клавдий (ID: `person:Claudius`); Агав (ID: `person:Agabus`); Финикия (ID: `place:Phoenicia`); Hellenists (ID: `group:Hellenist`); Cypriots (ID: `group:Cyprus`); Christians (ID: `group:Christ`); Стефан (ID: `person:Stephen`); Heart (ID: `keyterm:Heart`); Ask for (ID: `keyterm:AskFor`); Good News (ID: `keyterm:GoodNews`); Иудея (ID: `place:Judea`); Name (ID: `keyterm:Name`); Favor (ID: `keyterm:Favor`); Greece (ID: `place:Greece`); Ability (ID: `keyterm:Ability`); Тарсянин (ID: `place:Tarsus`); Good (ID: `keyterm:Good`); Jews (ID: `group:Jews`); киринеянин (ID: `place:Cyrene`); Serve (ID: `keyterm:Serve`)
...
* **Associated ACAI Concepts:** Пётр (ID: `person:Peter`); An Angel (ID: `deity:Angel`); LORD (ID: `deity:Lord`); Ирод (ID: `person:Herod.3`); Prison (ID: `realia:Prison`); True (ID: `keyterm:True`); Pray (ID: `keyterm:Pray`); Church (ID: `keyterm:Church`); Jews (ID: `group:Jews`); Chain (ID: `realia:Chain`); Иаков (ID: `person:James`); Door (ID: `realia:Door`); Temple (ID: `realia:Temple`); Рода (ID: `person:Rhoda`); Иоанн (ID: `person:John.2`); Марк (ID: `person:Mark`); Мария (ID: `person:Mary.5`); Passover (ID: `keyterm:Passover`); Name (ID: `keyterm:Name`); Rescue (ID: `keyterm:Rescue`); A Group of People (ID: `group:GenericGroup`); Иаков (ID: `person:James.3`); Cause of Joy (ID: `keyterm:CauseOfJoy`); House (ID: `realia:House`); Entrance (ID: `realia:Entrance`); Cloak (ID: `realia:Cloak`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** Ирод (ID: `person:Herod.3`); LORD (ID: `deity:Lord`); Власт (ID: `person:Blastus`); Tyrians (ID: `group:Tyre`); Иудея (ID: `place:Judea`); Make Peace (ID: `keyterm:Peace`); Persuade (ID: `keyterm:Persuade`); An Angel (ID: `deity:Angel`); A Group of People (ID: `group:GenericGroup`); Кесария (ID: `place:Caesarea`); Discern (ID: `keyterm:Discern`); Сидон (ID: `place:Sidon`); Тир (ID: `place:Tyre`); Пётр (ID: `person:Peter`); Glory (ID: `keyterm:Glory`); Sidonians (ID: `group:Sidon`); Bedroom (ID: `realia:Bedroom`); Clothing (ID: `realia:Clothing`); Judgment Seat (ID: `realia:JudgmentSeat`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Павел (ID: `person:Paul`); Варнава (ID: `person:Barnabas`); Святой Дух (ID: `deity:HolySpirit`); Вариисус (ID: `person:Bar-jesus`); Марк (ID: `person:Mark`); Abstain from Food (ID: `keyterm:Fast`); Name (ID: `keyterm:Name`); Believe (ID: `keyterm:Believe`); Jews (ID: `group:Jews`); Саламий (ID: `place:Salamis`); Паф (ID: `place:Paphos`); Симеон (ID: `person:Simeon.4`); Павел Сергий (ID: `person:SergiusPaulus`); Селевкия (ID: `place:Seleucia`); Манаил (ID: `person:Manaen`); Ирод Антипа (ID: `person:Herod.2`); Антиохия (ID: `place:Antioch`); Киттим (ID: `place:Cyprus`); Priesthood (ID: `keyterm:Priesthood`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Иерусалим (ID: `place:Jerusalem`); The Way (ID: `keyterm:TheWay`); Pray (ID: `keyterm:Pray`); Straightness (ID: `keyterm:Straightness`); Church (ID: `keyterm:Church`); киринеянин (ID: `place:Cyrene`); Serve (ID: `keyterm:Serve`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Давид (ID: `person:David`); Иерусалим (ID: `place:Jerusalem`); Пергия (ID: `place:Perga`); Fear (ID: `keyterm:Fear`); Promise (ID: `keyterm:Promise`); Law (ID: `keyterm:Law`); Resurrection (ID: `keyterm:Resurrection`); Believe (ID: `keyterm:Believe`); Павел (ID: `person:Paul`); Иисус (ID: `person:Jesus.2`); Sabbath (ID: `keyterm:Sabbath`); Holy (ID: `keyterm:Holy`); Иоанн (ID: `person:John`); Synagogue (ID: `realia:Synagogue`); Иессей (ID: `person:Jesse`); Антиохия (ID: `place:Antioch.2`); Ханаан (ID: `place:Canaan`); Паф (ID: `place:Paphos`); Саул (ID: `person:Saul.2`); Памфилия (ID: `place:Pamphylia`); Кис (ID: `person:Kish`); Heart (ID: `keyterm:Heart`); Bear Witness (ID: `keyterm:BearWitness`); Вениамин (ID: `person:Benjamin`); Ask for (ID: `keyterm:AskFor`); Forgive (ID: `keyterm:Forgive`); Repent (ID: `keyterm:Repent`); Писидийская (ID: `place:Pisidia`); Good News (ID: `keyterm:GoodNews`); Авраам (ID: `person:Abraham`); Witness (ID: `keyterm:Witness`); Decided (ID: `keyterm:Decided`); Пилат (ID: `person:Pilate`); Египет (ID: `place:Egypt`); Марк (ID: `person:Mark`); Chosen (ID: `keyterm:Chosen`); Самуил (ID: `person:Samuel`); Faithfulness (ID: `keyterm:Faithfulness`); Галилея (ID: `place:Galilee`); Моисей (ID: `person:Moses`); Israelites (ID: `group:Israel`); Savior (ID: `keyterm:Savior`); Baptism (ID: `keyterm:Baptism`); To Cause to Happen (ID: `keyterm:Happen`); Salvation (ID: `keyterm:Salvation`); To Sin (ID: `keyterm:Sin`); Вениамин (ID: `group:Benjamin`); Serve (ID: `keyterm:Serve`); Grave (ID: `realia:Grave`); Sandal (ID: `realia:Sandal`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Павел (ID: `person:Paul`); Варнава (ID: `person:Barnabas`); Gentiles (ID: `group:Gentile`); Jews (ID: `group:Jews`); Worship (ID: `keyterm:Worship`); Always (ID: `keyterm:Always`); Life (ID: `keyterm:Life`); Sabbath (ID: `keyterm:Sabbath`); Resentment (ID: `keyterm:Resentment`); Blaspheme (ID: `keyterm:Blaspheme`); Ask for (ID: `keyterm:AskFor`); To Command (ID: `keyterm:Command`); Decided (ID: `keyterm:Decided`); Persuade (ID: `keyterm:Persuade`); Икония (ID: `place:Iconium`); Favor (ID: `keyterm:Favor`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Believe (ID: `keyterm:Believe`); Святой Дух (ID: `deity:HolySpirit`); Salvation (ID: `keyterm:Salvation`); Be a Disciple (ID: `keyterm:Disciple`); Glory (ID: `keyterm:Glory`); Word (ID: `keyterm:Word`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Gentiles (ID: `group:Gentile`); Листра (ID: `place:Lystra`); Ликаония (ID: `place:Lycaonia`); Икония (ID: `place:Iconium`); Дервия (ID: `place:Derbe`); Bear Witness (ID: `keyterm:BearWitness`); Favor (ID: `keyterm:Favor`); Portent (ID: `keyterm:Portent`); Believe (ID: `keyterm:Believe`); Greeks (ID: `group:Greek`); Иаван (ID: `person:Javan`); LORD (ID: `deity:Lord`); Symbol (ID: `keyterm:Example`); Good News (ID: `keyterm:GoodNews`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Павел (ID: `person:Paul`); Зевс (ID: `deity:Zeus`); Offering (ID: `keyterm:Offering`); Варнава (ID: `person:Barnabas`); Ермия (ID: `deity:Hermes`); Do Good (ID: `keyterm:DoGood`); Worthless (ID: `keyterm:Worthless`); Lycaonians (ID: `group:Lycaonia`); Heart (ID: `keyterm:Heart`); Листра (ID: `place:Lystra`); Sky (ID: `keyterm:Heaven`); Ликаония (ID: `place:Lycaonia`); Good News (ID: `keyterm:GoodNews`); LORD (ID: `deity:Lord`); Life (ID: `keyterm:Life`); Believe (ID: `keyterm:Believe`); Salvation (ID: `keyterm:Salvation`); From Heaven (ID: `keyterm:FromHeaven`); Garland (ID: `realia:Garland`); Cattle (ID: `fauna:Bull`); Clothing (ID: `realia:Clothing`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Be a Disciple (ID: `keyterm:Disciple`); Believe (ID: `keyterm:Believe`); Антиохия (ID: `place:Antioch.2`); Икония (ID: `place:Iconium`); Church (ID: `keyterm:Church`); Писидийская (ID: `place:Pisidia`); Пергия (ID: `place:Perga`); Дервия (ID: `place:Derbe`); Памфилия (ID: `place:Pamphylia`); Abstain from Food (ID: `keyterm:Fast`); Атталия (ID: `place:Attalia`); Листра (ID: `place:Lystra`); Ask for (ID: `keyterm:AskFor`); Good News (ID: `keyterm:GoodNews`); Kingdom (ID: `keyterm:Kingdom`); Варнава (ID: `person:Barnabas`); Persuade (ID: `keyterm:Persuade`); Favor (ID: `keyterm:Favor`); Gentiles (ID: `group:Gentile`); Pray (ID: `keyterm:Pray`); Антиохия (ID: `place:Antioch`); Павел (ID: `person:Paul`); Jews (ID: `group:Jews`); Door (ID: `realia:Door`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Gentiles (ID: `group:Gentile`); Варнава (ID: `person:Barnabas`); Павел (ID: `person:Paul`); Антиохия (ID: `place:Antioch`); Believe (ID: `keyterm:Believe`); Иуда (ID: `person:Judas.5`); Сила (ID: `person:Silas`); Chosen (ID: `keyterm:Chosen`); Name (ID: `keyterm:Name`); Моисей (ID: `person:Moses`); Church (ID: `keyterm:Church`); Circumcision (ID: `keyterm:Circumcision`); Ask for (ID: `keyterm:AskFor`); Good News (ID: `keyterm:GoodNews`); Иерусалим (ID: `place:Jerusalem`); Fornication (ID: `keyterm:Fornication`); Blood (ID: `keyterm:Blood`); Святой Дух (ID: `deity:HolySpirit`); Salvation (ID: `keyterm:Salvation`); Иисус (ID: `person:Jesus.2`); Пётр (ID: `person:Peter`); Иудея (ID: `place:Judea`); Финикия (ID: `place:Phoenicia`); Иаков (ID: `person:James.3`); Heart (ID: `keyterm:Heart`); Bear Witness (ID: `keyterm:BearWitness`); Portent (ID: `keyterm:Portent`); To Cleanse (ID: `keyterm:Cleanse.2`); Authority (ID: `keyterm:Authority.2`); Самария (ID: `place:Samaria`); Symbol (ID: `keyterm:Example`); Proclaim (ID: `keyterm:Proclaim`); Pharisees (ID: `group:Pharisee`); Make Peace (ID: `keyterm:Peace`); Давид (ID: `person:David`); Decided (ID: `keyterm:Decided`); Knower of Hearts (ID: `keyterm:KnowerOfHearts`); Always (ID: `keyterm:Always`); Encourage (ID: `keyterm:Encourage`); Men (ID: `group:GenericMales`); Favor (ID: `keyterm:Favor`); Beloved (ID: `keyterm:Beloved`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Discern (ID: `keyterm:Discern`); Life (ID: `keyterm:Life`); Law (ID: `keyterm:Law`); Call Upon (ID: `keyterm:CallUpon`); Sabbath (ID: `keyterm:Sabbath`); Киликия (ID: `place:Cilicia`); Be a Disciple (ID: `keyterm:Disciple`); Yoke (ID: `realia:Yoke`); Image (ID: `realia:Image`); Synagogue (ID: `realia:Synagogue`); Tabernacle (ID: `realia:Tabernacle`)
...
* **Associated ACAI Concepts:** Павел (ID: `person:Paul`); Варнава (ID: `person:Barnabas`); Марк (ID: `person:Mark`); LORD (ID: `deity:Lord`); Киликия (ID: `place:Cilicia`); Favor (ID: `keyterm:Favor`); Church (ID: `keyterm:Church`); Памфилия (ID: `place:Pamphylia`); Киттим (ID: `place:Cyprus`); Сила (ID: `person:Silas`)
...
* **Associated ACAI Concepts:** Листра (ID: `place:Lystra`); Македонянин (ID: `place:Macedonia`); Мисия (ID: `place:Mysia`); Иаван (ID: `person:Javan`); Greeks (ID: `group:Greek`); Святой Дух (ID: `deity:HolySpirit`); Павел (ID: `person:Paul`); Jews (ID: `group:Jews`); Фригия (ID: `place:Phrygia`); Тимофей (ID: `person:Timothy`); Асии (ID: `place:Asia`); Галатийский (ID: `place:Galatia`); Троада (ID: `place:Troas`); Дервия (ID: `place:Derbe`); Вифиния (ID: `place:Bithynia`); Bear Witness (ID: `keyterm:BearWitness`); Ask for (ID: `keyterm:AskFor`); Good News (ID: `keyterm:GoodNews`); Decided (ID: `keyterm:Decided`); Икония (ID: `place:Iconium`); Иерусалим (ID: `place:Jerusalem`); Faithfulness (ID: `keyterm:Faithfulness`); Name (ID: `keyterm:Name`); LORD (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Иисус (ID: `person:Jesus.2`); Church (ID: `keyterm:Church`); Be a Disciple (ID: `keyterm:Disciple`)
...
* **Associated ACAI Concepts:** Павел (ID: `person:Paul`); LORD (ID: `deity:Lord`); Римлянин (ID: `place:Rome`); Name (ID: `keyterm:Name`); Pray (ID: `keyterm:Pray`); Prison (ID: `realia:Prison`); Temple (ID: `realia:Temple`); Самофракия (ID: `place:Samothrace`); Македонянин (ID: `place:Macedonia`); Неаполь (ID: `place:Neapolis`); Филиппы (ID: `place:Philippi`); Фиатира (ID: `place:Thyatira`); Лидия (ID: `person:Lydia`); Heart (ID: `keyterm:Heart`); Ask for (ID: `keyterm:AskFor`); Worship (ID: `keyterm:Worship`); Hope (ID: `keyterm:Hope`); Decided (ID: `keyterm:Decided`); Be Lawful (ID: `keyterm:Lawful`); Faithfulness (ID: `keyterm:Faithfulness`); Сила (ID: `person:Silas`); Троада (ID: `place:Troas`); Baptism (ID: `keyterm:Baptism`); Salvation (ID: `keyterm:Salvation`); Sabbath (ID: `keyterm:Sabbath`); Иисус (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Clothing (ID: `realia:Clothing`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Павел (ID: `person:Paul`); Prison (ID: `realia:Prison`); LORD (ID: `deity:Lord`); Сила (ID: `person:Silas`); Believe (ID: `keyterm:Believe`); Ask for (ID: `keyterm:AskFor`); Римлянин (ID: `place:Rome`); Salvation (ID: `keyterm:Salvation`); Door (ID: `realia:Door`); Philippian Jailer (ID: `person:PhilippianJailer`); Лидия (ID: `person:Lydia`); Fear (ID: `keyterm:Fear`); Make Peace (ID: `keyterm:Peace`); Encourage (ID: `keyterm:Encourage`); Pray (ID: `keyterm:Pray`); Baptism (ID: `keyterm:Baptism`); Иисус (ID: `person:Jesus.2`); Word (ID: `keyterm:Word`); Torch (ID: `realia:Torch`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Chain (ID: `realia:Chain`); Foundation (ID: `realia:Foundation`)
...
* **Associated ACAI Concepts:** Павел (ID: `person:Paul`); Иасон (ID: `person:Jason`); Сила (ID: `person:Silas`); Jews (ID: `group:Jews`); Фессалоника (ID: `place:Thessalonica`); Written (ID: `keyterm:Scripture`); Верию (ID: `place:Berea`); Greeks (ID: `group:Greek`); Тимофей (ID: `person:Timothy`); Иаван (ID: `person:Javan`); Иисус (ID: `person:Jesus.2`); Synagogue (ID: `realia:Synagogue`); Аполлония (ID: `place:Apollonia`); Амфиполь (ID: `place:Amphipolis`); Discern (ID: `keyterm:Discern`); Worship (ID: `keyterm:Worship`); Клавдий (ID: `person:Claudius`); Афины (ID: `place:Athens`); Commandment (ID: `keyterm:Commandment`); Persuade (ID: `keyterm:Persuade`); Ability (ID: `keyterm:Ability`); LORD (ID: `deity:Lord`); Believe (ID: `keyterm:Believe`); Sabbath (ID: `keyterm:Sabbath`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); ареопаг (ID: `place:Areopagus`); Афины (ID: `place:Athens`); Павел (ID: `person:Paul`); Worship (ID: `keyterm:Worship`); Ability (ID: `keyterm:Ability`); Life (ID: `keyterm:Life`); Resurrection (ID: `keyterm:Resurrection`); Image (ID: `realia:Image`); Дамарь (ID: `person:Damaris`); Athenians (ID: `group:Athens`); Decided (ID: `keyterm:Decided`); Areopagites (ID: `group:Areopagus`); Divine (ID: `keyterm:Divine`); Epicureans (ID: `group:Epicurean`); Stoics (ID: `group:Stoic`); Дионисий (ID: `person:Dionysius`); Sky (ID: `keyterm:Heaven`); Repent (ID: `keyterm:Repent`); Obligated (ID: `keyterm:Ought`); Bring to the Attention Of (ID: `keyterm:BringToTheAttentionOf`); Good News (ID: `keyterm:GoodNews`); Proof (ID: `keyterm:Proof`); Demons (ID: `deity:Demons`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Name (ID: `keyterm:Name`); Believe (ID: `keyterm:Believe`); Иисус (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Object of Worship (ID: `keyterm:ObjectOfWorship`); Spirit (ID: `keyterm:Spirit.2`); Serve (ID: `keyterm:Serve`); Stone Altar (ID: `realia:StoneAltar`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); LORD (ID: `deity:Lord`); Павел (ID: `person:Paul`); Галлион (ID: `person:Gallio`); Synagogue (ID: `realia:Synagogue`); Name (ID: `keyterm:Name`); Judgment Seat (ID: `realia:JudgmentSeat`); Коринф (ID: `place:Corinth`); Worship (ID: `keyterm:Worship`); Law (ID: `keyterm:Law`); Иисус (ID: `person:Jesus.2`); Прискилла (ID: `person:Priscilla`); Иуст (ID: `person:Justus.2`); Клавдий (ID: `person:Claudius`); Понт (ID: `group:Pontus`); Corinthians (ID: `group:Corinth`); Римлянин (ID: `place:Rome`); Сосфен (ID: `person:Sosthenes`); Акила (ID: `person:Aquila`); Крисп (ID: `person:Crispus`); Понт (ID: `place:Pontus`); Ахаия (ID: `place:Achaia`); Blaspheme (ID: `keyterm:Blaspheme`); Македонянин (ID: `place:Macedonia`); Афины (ID: `place:Athens`); Unrighteous Act (ID: `keyterm:UnrighteousAct`); Declare (ID: `keyterm:Declare`); Италийский (ID: `place:Italy`); Тимофей (ID: `person:Timothy`); Fear (ID: `keyterm:Fear`); Иаван (ID: `person:Javan`); Persuade (ID: `keyterm:Persuade`); Сила (ID: `person:Silas`); Gentiles (ID: `group:Gentile`); Greeks (ID: `group:Greek`); Clean (ID: `keyterm:Clean`); Blood (ID: `keyterm:Blood`); Baptism (ID: `keyterm:Baptism`); Believe (ID: `keyterm:Believe`); Sabbath (ID: `keyterm:Sabbath`); Tent (ID: `realia:Tent`); Clothing (ID: `realia:Clothing`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Ефес (ID: `place:Ephesus`); LORD (ID: `deity:Lord`); Jews (ID: `group:Jews`); Акила (ID: `person:Aquila`); Прискилла (ID: `person:Priscilla`); Written (ID: `keyterm:Scripture`); The Way (ID: `keyterm:TheWay`); Be a Disciple (ID: `keyterm:Disciple`); Synagogue (ID: `realia:Synagogue`); Alexandrians (ID: `group:Alexandria`); Александрия (ID: `place:Alexandria`); Фригия (ID: `place:Phrygia`); Аполлос (ID: `person:Apollos`); Кенхреи (ID: `place:Cenchreae`); Галатийский (ID: `place:Galatia`); Ask for (ID: `keyterm:AskFor`); Vow (ID: `keyterm:Vow`); Name (ID: `keyterm:Name`); Favor (ID: `keyterm:Favor`); Кесария (ID: `place:Caesarea`); Baptism (ID: `keyterm:Baptism`); Believe (ID: `keyterm:Believe`); Антиохия (ID: `place:Antioch`); Павел (ID: `person:Paul`); Иисус (ID: `person:Jesus.2`); Church (ID: `keyterm:Church`); Ахаия (ID: `place:Achaia`); Spirit (ID: `keyterm:Spirit.2`); Иоанн (ID: `person:John`)
...
* **Associated ACAI Concepts:** Павел (ID: `person:Paul`); Иисус (ID: `person:Jesus.2`); LORD (ID: `deity:Lord`); Jews (ID: `group:Jews`); Name (ID: `keyterm:Name`); Baptism (ID: `keyterm:Baptism`); Believe (ID: `keyterm:Believe`); Асии (ID: `place:Asia`); Македонянин (ID: `place:Macedonia`); Ефес (ID: `place:Ephesus`); Authority (ID: `keyterm:Authority.2`); Иаван (ID: `person:Javan`); Greeks (ID: `group:Greek`); Святой Дух (ID: `deity:HolySpirit`); Иоанн (ID: `person:John`); Be a Disciple (ID: `keyterm:Disciple`); Тиранн (ID: `person:Tyrannus`); Demons (ID: `deity:Demons`); Ераст (ID: `person:Erastus`); Скева (ID: `person:Sceva`); Ахаия (ID: `place:Achaia`); Коринф (ID: `place:Corinth`); Repent (ID: `keyterm:Repent`); Аполлос (ID: `person:Apollos`); Proclaim (ID: `keyterm:Proclaim`); Set Free (ID: `keyterm:SetFree`); Тимофей (ID: `person:Timothy`); Kingdom (ID: `keyterm:Kingdom`); Fear (ID: `keyterm:Fear`); Persuade (ID: `keyterm:Persuade`); Римлянин (ID: `place:Rome`); Иерусалим (ID: `place:Jerusalem`); The Way (ID: `keyterm:TheWay`); Ability (ID: `keyterm:Ability`); Speak as a Prophet (ID: `keyterm:Speak`); Magic (ID: `keyterm:Magic`); Spirit (ID: `keyterm:Spirit.2`); Serve (ID: `keyterm:Serve`); Apron (ID: `realia:Apron`); Lecture Hall (ID: `realia:LectureHall`); Band of Cloth (ID: `realia:BandOfCloth`); Scroll (ID: `realia:Scroll`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Артемида (ID: `deity:Artemis`); Ефес (ID: `place:Ephesus`); Ephesians (ID: `group:Ephesus`); Павел (ID: `person:Paul`); Димитрий (ID: `person:Demetrius`); Асии (ID: `place:Asia`); Jews (ID: `group:Jews`); Theater (ID: `realia:Theater`); Аристарх (ID: `person:Aristarchus`); Александр (ID: `person:Alexander.3`); Гай (ID: `person:Gaius`); Blaspheme (ID: `keyterm:Blaspheme`); Ask for (ID: `keyterm:AskFor`); Worship (ID: `keyterm:Worship`); Македонянин (ID: `place:Macedonia`); Persuade (ID: `keyterm:Persuade`); Be Lawful (ID: `keyterm:Lawful`); Name (ID: `keyterm:Name`); The Way (ID: `keyterm:TheWay`); Ability (ID: `keyterm:Ability`); Public Official (ID: `person:GenericOfficial`); Be a Disciple (ID: `keyterm:Disciple`); Replica Temple (ID: `realia:ReplicaTemple`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Павел (ID: `person:Paul`); Ask for (ID: `keyterm:AskFor`); Encourage (ID: `keyterm:Encourage`); Македонянин (ID: `place:Macedonia`); Троада (ID: `place:Troas`); Life (ID: `keyterm:Life`); Bereans (ID: `group:Berea`); Евтих (ID: `person:Eutychus`); Тихик (ID: `person:Tychicus`); Гай (ID: `person:Gaius.2`); Asians (ID: `group:Asia`); Филиппы (ID: `place:Philippi`); Greece (ID: `place:Greece`); Секунд (ID: `person:Secundus`); Сосипатр (ID: `person:Sopater`); Week (ID: `keyterm:Week`); Pyrrhus (ID: `person:Pyrrhus`); Трофим (ID: `person:Trophimus`); Фессалоника (ID: `place:Thessalonica`); Аристарх (ID: `person:Aristarchus`); Верию (ID: `place:Berea`); Тимофей (ID: `person:Timothy`); Асии (ID: `place:Asia`); Name (ID: `keyterm:Name`); Thessalonians (ID: `group:Thessalonica`); Дервия (ID: `place:Derbe`); Jews (ID: `group:Jews`); Be a Disciple (ID: `keyterm:Disciple`); Second Story (ID: `realia:SecondStory`); Window (ID: `realia:Window`); Upstairs Room (ID: `realia:UpstairsRoom`); Lamp (ID: `realia:Lamp`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Declare (ID: `keyterm:Declare`); Святой Дух (ID: `deity:HolySpirit`); Иисус (ID: `person:Jesus.2`); Павел (ID: `person:Paul`); Милит (ID: `place:Miletus`); Асс (ID: `place:Assos`); Ефес (ID: `place:Ephesus`); Иерусалим (ID: `place:Jerusalem`); Асии (ID: `place:Asia`); Favor (ID: `keyterm:Favor`); Blood (ID: `keyterm:Blood`); Church (ID: `keyterm:Church`); Jews (ID: `group:Jews`); Serve (ID: `keyterm:Serve`); Самос (ID: `place:Samos`); Хиос (ID: `place:Chios`); Be Enslaved (ID: `keyterm:Serve.2`); Митилин (ID: `place:Mitylene`); Goat (ID: `fauna:Goat`); Ship (ID: `realia:Ship`); Flock (ID: `fauna:Flock`); Repent (ID: `keyterm:Repent`); Happy (ID: `keyterm:Happy`); Good News (ID: `keyterm:GoodNews`); Proclaim (ID: `keyterm:Proclaim`); Kingdom (ID: `keyterm:Kingdom`); Decided (ID: `keyterm:Decided`); Иаван (ID: `person:Javan`); Pray (ID: `keyterm:Pray`); Greeks (ID: `group:Greek`); Life (ID: `keyterm:Life`); Clean (ID: `keyterm:Clean`); Believe (ID: `keyterm:Believe`); Consecration (ID: `keyterm:Consecration.2`); Be a Disciple (ID: `keyterm:Disciple`); Spirit (ID: `keyterm:Spirit.2`); Clothing (ID: `realia:Clothing`); Wolf (ID: `fauna:Wolf`); House (ID: `realia:House`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Иерусалим (ID: `place:Jerusalem`); Павел (ID: `person:Paul`); Ship (ID: `realia:Ship`); Кесария (ID: `place:Caesarea`); Киттим (ID: `place:Cyprus`); Name (ID: `keyterm:Name`); Святой Дух (ID: `deity:HolySpirit`); Тир (ID: `place:Tyre`); Be a Disciple (ID: `keyterm:Disciple`); Агав (ID: `person:Agabus`); Патара (ID: `place:Patara`); Кос (ID: `place:Cos`); Филипп (ID: `person:Philip.4`); Финикия (ID: `place:Phoenicia`); Родос (ID: `place:Rhodes`); Cypriots (ID: `group:Cyprus`); Мнасон (ID: `person:Mnason`); Heart (ID: `keyterm:Heart`); Ask for (ID: `keyterm:AskFor`); Иудея (ID: `place:Judea`); Persuade (ID: `keyterm:Persuade`); Акко (ID: `place:Acco`); LORD (ID: `deity:Lord`); Gentiles (ID: `group:Gentile`); Pray (ID: `keyterm:Pray`); Иисус (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Speak as a Prophet (ID: `keyterm:Speak`); Belt (ID: `realia:Belt`); House (ID: `realia:House`); Temple (ID: `realia:Temple`); Bag (ID: `realia:Bag`)
...
* **Associated ACAI Concepts:** Gentiles (ID: `group:Gentile`); Pure (ID: `keyterm:Pure`); LORD (ID: `deity:Lord`); Law (ID: `keyterm:Law`); Believe (ID: `keyterm:Believe`); Павел (ID: `person:Paul`); Jews (ID: `group:Jews`); Offering (ID: `keyterm:Offering`); Decided (ID: `keyterm:Decided`); Vow (ID: `keyterm:Vow`); Иерусалим (ID: `place:Jerusalem`); Live (ID: `keyterm:Live.3`); Fornication (ID: `keyterm:Fornication`); Моисей (ID: `person:Moses`); Иаков (ID: `person:James.3`); Blood (ID: `keyterm:Blood`); Glory (ID: `keyterm:Glory`); Serve (ID: `keyterm:Serve`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Павел (ID: `person:Paul`); Temple (ID: `realia:Temple`); Jews (ID: `group:Jews`); Step (ID: `realia:Step`); Тарсянин (ID: `group:Tarsus`); Тарсянин (ID: `place:Tarsus`); Киликия (ID: `place:Cilicia`); Трофим (ID: `person:Trophimus`); Ephesians (ID: `group:Ephesus`); Египет (ID: `place:Egypt`); Иаван (ID: `person:Javan`); Be Lawful (ID: `keyterm:Lawful`); Иерусалим (ID: `place:Jerusalem`); Ефес (ID: `place:Ephesus`); Асии (ID: `place:Asia`); Military Member (ID: `person:MilitaryMember`); Something Definite (ID: `keyterm:SomethingDefinite`); Greeks (ID: `group:Greek`); Defilement (ID: `keyterm:Defilement`); Israelites (ID: `group:Israel`); Law (ID: `keyterm:Law`); Egyptians (ID: `group:Egypt`); Израиль (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Door (ID: `realia:Door`); Chain (ID: `realia:Chain`); Tabernacle (ID: `realia:Tabernacle`)
...
* **Associated ACAI Concepts:** Павел (ID: `person:Paul`); Дамаск (ID: `place:Damascus`); Римлянин (ID: `place:Rome`); Bear Witness (ID: `keyterm:BearWitness`); Иерусалим (ID: `place:Jerusalem`); Иисус (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Witness (ID: `keyterm:Witness`); Military Member (ID: `person:MilitaryMember`); LORD (ID: `deity:Lord`); Law (ID: `keyterm:Law`); Анания (ID: `person:Ananias.2`); Гамалиил (ID: `person:Gamaliel`); Cloak (ID: `realia:Cloak`); Стефан (ID: `person:Stephen`); Sky (ID: `keyterm:Heaven`); Fear (ID: `keyterm:Fear`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Назарет (ID: `place:Nazareth`); Be Lawful (ID: `keyterm:Lawful`); Name (ID: `keyterm:Name`); The Way (ID: `keyterm:TheWay`); Gentiles (ID: `group:Gentile`); Pray (ID: `keyterm:Pray`); Something Definite (ID: `keyterm:SomethingDefinite`); Life (ID: `keyterm:Life`); Тарсянин (ID: `place:Tarsus`); Blood (ID: `keyterm:Blood`); Baptism (ID: `keyterm:Baptism`); Believe (ID: `keyterm:Believe`); Call Upon (ID: `keyterm:CallUpon`); To Sin (ID: `keyterm:Sin`); Киликия (ID: `place:Cilicia`); Glory (ID: `keyterm:Glory`); Prison (ID: `realia:Prison`); Strap (ID: `realia:Strap`); Temple (ID: `realia:Temple`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Павел (ID: `person:Paul`); Pharisees (ID: `group:Pharisee`); Sadducees (ID: `group:Sadducee`); LORD (ID: `deity:Lord`); Jews (ID: `group:Jews`); Феликс (ID: `person:Felix`); Римлянин (ID: `place:Rome`); Ask for (ID: `keyterm:AskFor`); Decided (ID: `keyterm:Decided`); An Angel (ID: `deity:Angel`); Кесария (ID: `place:Caesarea`); Law (ID: `keyterm:Law`); Resurrection (ID: `keyterm:Resurrection`); Лисий (ID: `person:Lysias`); Cheer Up (ID: `keyterm:CheerUp`); Антипатрида (ID: `place:Antipatris`); Анания (ID: `person:Ananias.3`); Киликия (ID: `place:Cilicia`); Bear Witness (ID: `keyterm:BearWitness`); Ирод (ID: `person:Herod`); Hope (ID: `keyterm:Hope`); Declare (ID: `keyterm:Declare`); Decision (ID: `keyterm:Decision`); Fear (ID: `keyterm:Fear`); Persuade (ID: `keyterm:Persuade`); Иерусалим (ID: `place:Jerusalem`); Military Member (ID: `person:MilitaryMember`); Live (ID: `keyterm:Live.3`); Disobey (ID: `keyterm:Disobey`); Rescue (ID: `keyterm:Rescue`); Promise (ID: `keyterm:Promise`); A Group of People (ID: `group:GenericGroup`); Salvation (ID: `keyterm:Salvation`); Conscience (ID: `keyterm:Conscience`); Good (ID: `keyterm:Good`); Иисус (ID: `person:Jesus.2`); Palace (ID: `realia:Palace`)
...
* **Associated ACAI Concepts:** Феликс (ID: `person:Felix`); Павел (ID: `person:Paul`); Jews (ID: `group:Jews`); LORD (ID: `deity:Lord`); Тертулл (ID: `person:Tertullus`); The Way (ID: `keyterm:TheWay`); Temple (ID: `realia:Temple`); Hope (ID: `keyterm:Hope`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Resurrection (ID: `keyterm:Resurrection`); Believe (ID: `keyterm:Believe`); Serve (ID: `keyterm:Serve`); Лисий (ID: `person:Lysias`); Фест (ID: `person:Festus`); Conscience (ID: `keyterm:Conscience`); Анания (ID: `person:Ananias.3`); Друзилла (ID: `person:Drusilla`); Ask for (ID: `keyterm:AskFor`); Unrighteous Act (ID: `keyterm:UnrighteousAct`); Priesthood (ID: `keyterm:Priesthood`); Kindness (ID: `keyterm:Kindness`); Decision (ID: `keyterm:Decision`); Make Peace (ID: `keyterm:Peace`); Decided (ID: `keyterm:Decided`); Назарет (ID: `place:Nazareth`); Иерусалим (ID: `place:Jerusalem`); Асии (ID: `place:Asia`); Pure (ID: `keyterm:Pure`); Favor (ID: `keyterm:Favor`); Bow Down (ID: `keyterm:BowDown`); Ability (ID: `keyterm:Ability`); Discern (ID: `keyterm:Discern`); Defilement (ID: `keyterm:Defilement`); Law (ID: `keyterm:Law`); Иисус (ID: `person:Jesus.2`); Judgment (ID: `keyterm:Judgment`); Money (ID: `realia:Money`); Synagogue (ID: `realia:Synagogue`)
...
* **Associated ACAI Concepts:** Павел (ID: `person:Paul`); Фест (ID: `person:Festus`); Иерусалим (ID: `place:Jerusalem`); Jews (ID: `group:Jews`); Агриппа (ID: `person:Agrippa`); Клавдий (ID: `person:Claudius`); Кесария (ID: `place:Caesarea`); Decided (ID: `keyterm:Decided`); Call Upon (ID: `keyterm:CallUpon`); Вереника (ID: `person:Bernice`); Август (ID: `person:Augustus`); Judgment Seat (ID: `realia:JudgmentSeat`); To Act Wickedly (ID: `keyterm:ActWickedly`); Forgive (ID: `keyterm:Forgive`); Favor (ID: `keyterm:Favor`); Life (ID: `keyterm:Life`); Ask for (ID: `keyterm:AskFor`); Decision (ID: `keyterm:Decision`); Римлянин (ID: `place:Rome`); Феликс (ID: `person:Felix`); Condemn (ID: `keyterm:Condemn`); Discern (ID: `keyterm:Discern`); Law (ID: `keyterm:Law`); Иисус (ID: `person:Jesus.2`); To Sin (ID: `keyterm:Sin`); Audience Hall (ID: `realia:AudienceHall`); Temple (ID: `realia:Temple`)
...
* **Associated ACAI Concepts:** Агриппа (ID: `person:Agrippa`); LORD (ID: `deity:Lord`); Павел (ID: `person:Paul`); Jews (ID: `group:Jews`); Иисус (ID: `person:Jesus.2`); Фест (ID: `person:Festus`); Authority (ID: `keyterm:Authority.2`); Иерусалим (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Gentiles (ID: `group:Gentile`); Дамаск (ID: `place:Damascus`); Hope (ID: `keyterm:Hope`); Decided (ID: `keyterm:Decided`); Persuade (ID: `keyterm:Persuade`); Resurrection (ID: `keyterm:Resurrection`); Believe (ID: `keyterm:Believe`); Вереника (ID: `person:Bernice`); Rescue (ID: `keyterm:Rescue`); Christians (ID: `group:Christ`); Bear Witness (ID: `keyterm:BearWitness`); Blaspheme (ID: `keyterm:Blaspheme`); Forgive (ID: `keyterm:Forgive`); Repent (ID: `keyterm:Repent`); Клавдий (ID: `person:Claudius`); Priesthood (ID: `keyterm:Priesthood`); Happy (ID: `keyterm:Happy`); Declare (ID: `keyterm:Declare`); Иудея (ID: `place:Judea`); Pharisees (ID: `group:Pharisee`); Witness (ID: `keyterm:Witness`); Назарет (ID: `place:Nazareth`); Name (ID: `keyterm:Name`); Truth (ID: `keyterm:Truth`); сатана (ID: `deity:Satan`); Heavenly (ID: `keyterm:Heavenly`); Promise (ID: `keyterm:Promise`); Моисей (ID: `person:Moses`); Daily Life (ID: `keyterm:DailyLife`); Life (ID: `keyterm:Life`); Consecration (ID: `keyterm:Consecration.2`); To Sin (ID: `keyterm:Sin`); Call Upon (ID: `keyterm:CallUpon`); From Heaven (ID: `keyterm:FromHeaven`); Serve (ID: `keyterm:Serve`); Holy (ID: `keyterm:Holy`); Word (ID: `keyterm:Word`); Prison (ID: `realia:Prison`); Temple (ID: `realia:Temple`); Cornerstone (ID: `realia:Cornerstone`); Synagogue (ID: `realia:Synagogue`); Chain (ID: `realia:Chain`)
...
* **Associated ACAI Concepts:** Ship (ID: `realia:Ship`); Павел (ID: `person:Paul`); Salvation (ID: `keyterm:Salvation`); Крит (ID: `place:Crete`); LORD (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Anchor (ID: `realia:Anchor`); Юлий (ID: `person:Julius`); Италийский (ID: `place:Italy`); Ask for (ID: `keyterm:AskFor`); Life (ID: `keyterm:Life`); Fair Havens (ID: `place:FairHavens`); Клавда (ID: `place:Cauda`); Аристарх (ID: `person:Aristarchus`); Александрия (ID: `place:Alexandria`); Ликийские (ID: `place:Lycia`); Адрамитский (ID: `place:Adramyttium`); the Syrtis (ID: `place:Syrtis`); Асии (ID: `place:Asia`); Салмон (ID: `place:Salmone`); Адриатическое море (ID: `place:AdriaticSea`); Август (ID: `person:Augustus`); Мира (ID: `place:Myra`); Финик (ID: `place:Phoenix`); Сидон (ID: `place:Sidon`); Памфилия (ID: `place:Pamphylia`); Книд (ID: `place:Cnidus`); Киликия (ID: `place:Cilicia`); Ласея (ID: `place:Lasea`); Rope (ID: `realia:Rope`); Фессалоника (ID: `place:Thessalonica`); Forgive (ID: `keyterm:Forgive`); Македонянин (ID: `place:Macedonia`); Киттим (ID: `place:Cyprus`); Клавдий (ID: `person:Claudius`); Priesthood (ID: `keyterm:Priesthood`); Hope (ID: `keyterm:Hope`); Decided (ID: `keyterm:Decided`); Persuade (ID: `keyterm:Persuade`); An Angel (ID: `deity:Angel`); Name (ID: `keyterm:Name`); Thessalonians (ID: `group:Thessalonica`); Pray (ID: `keyterm:Pray`); Believe (ID: `keyterm:Believe`); Abstain from Food (ID: `keyterm:Fast`); Serve (ID: `keyterm:Serve`); Sail (ID: `realia:Sail`); Fathom (ID: `realia:Fathom`); Rudder (ID: `realia:Rudder`); Wheat (ID: `flora:Wheat`)
...
* **Associated ACAI Concepts:** Павел (ID: `person:Paul`); Публий (ID: `person:Publius`); Римлянин (ID: `place:Rome`); Salvation (ID: `keyterm:Salvation`); Александрия (ID: `place:Alexandria`); Three Taverns (ID: `place:ThreeTaverns`); Сиракузы (ID: `place:Syracuse`); Ригий (ID: `place:Rhegium`); Аппиевой площади (ID: `place:ForumOfAppius`); Путеол (ID: `place:Puteoli`); Мелит (ID: `place:Malta`); Ask for (ID: `keyterm:AskFor`); Kindness (ID: `keyterm:Kindness`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Name (ID: `keyterm:Name`); LORD (ID: `deity:Lord`); Pray (ID: `keyterm:Pray`); Life (ID: `keyterm:Life`); Hospitably (ID: `keyterm:Hospitably`); Serve (ID: `keyterm:Serve`); Emblem (ID: `realia:Emblem`); Snake (ID: `fauna:Snake`); Inn (ID: `realia:Inn`); Ship (ID: `realia:Ship`); Cobra (ID: `fauna:Cobra`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Persuade (ID: `keyterm:Persuade`); Kingdom (ID: `keyterm:Kingdom`); Иисус (ID: `person:Jesus.2`); Jews (ID: `group:Jews`); Heart (ID: `keyterm:Heart`); Ask for (ID: `keyterm:AskFor`); Клавдий (ID: `person:Claudius`); Hope (ID: `keyterm:Hope`); Proclaim (ID: `keyterm:Proclaim`); Иудея (ID: `place:Judea`); Declare (ID: `keyterm:Declare`); Disbelieve (ID: `keyterm:Disbelieve`); Think (ID: `keyterm:Think`); Римлянин (ID: `place:Rome`); Иерусалим (ID: `place:Jerusalem`); Исаия (ID: `person:Isaiah`); Моисей (ID: `person:Moses`); Gentiles (ID: `group:Gentile`); Discern (ID: `keyterm:Discern`); Law (ID: `keyterm:Law`); Salvation (ID: `keyterm:Salvation`); Святой Дух (ID: `deity:HolySpirit`); Call Upon (ID: `keyterm:CallUpon`); Павел (ID: `person:Paul`); Израиль (ID: `person:Israel`); Word (ID: `keyterm:Word`); Chain (ID: `realia:Chain`); Guest Room (ID: `realia:GuestRoom`)
