...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Иерусалим (ID: `place:Jerusalem`); Соломон (ID: `person:Solomon`); Ливан (ID: `place:Lebanon`); Swear (ID: `keyterm:Swear`); Vine (ID: `flora:Vine`); Lily (ID: `flora:Lily`); Wine (ID: `realia:Wine`); Gazelle (ID: `fauna:Gazelle`); Balsam Tree (ID: `flora:BalsamTree`); Myrrh (ID: `flora:Myrrh`); Dove (ID: `fauna:Dove`); Pomegranate (ID: `flora:Pomegranate`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Deer (ID: `fauna:Deer`); Apple (ID: `flora:AppleTree`); Veil (ID: `realia:Veil`); Money (ID: `realia:Money`); Mount Hermon (ID: `place:HermonMount`); Галаад (ID: `place:Gilead`); Fairness (ID: `keyterm:Fairness`); Henna (ID: `flora:Henna`); Nard (ID: `flora:Nard`); Standard (ID: `realia:Standard`); Cedar (ID: `flora:Cedar`); Sheep (ID: `fauna:Lamb`); Frankincense (ID: `flora:Frankincense`); Tower (ID: `realia:Tower`)
