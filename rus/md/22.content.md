...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Иерусалим (ID: `place:Jerusalem`); Соломон (ID: `person:Solomon`); Ливан (ID: `place:Lebanon`); Swear (ID: `keyterm:Swear`); Vine (ID: `flora:Vine`); Lily (ID: `flora:Lily`); Wine (ID: `realia:Wine`); Myrrh (ID: `flora:Myrrh`); Balsam Tree (ID: `flora:BalsamTree`); Dove (ID: `fauna:Dove`); Gazelle (ID: `fauna:Gazelle`); Pomegranate (ID: `flora:Pomegranate`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); House (ID: `realia:House`); Deer (ID: `fauna:Deer`); Apple (ID: `flora:AppleTree`); Veil (ID: `realia:Veil`); Money (ID: `realia:Money`); Mount Hermon (ID: `place:HermonMount`); Fairness (ID: `keyterm:Fairness`); Галаад (ID: `place:Gilead`); Henna (ID: `flora:Henna`); Nard (ID: `flora:Nard`); Frankincense (ID: `flora:Frankincense`); Tower (ID: `realia:Tower`); Sheep (ID: `fauna:Lamb`); Standard (ID: `realia:Standard`); Cedar (ID: `flora:Cedar`)
