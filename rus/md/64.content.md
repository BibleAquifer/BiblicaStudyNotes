...
* **Associated ACAI Concepts:** Диотреф (ID: `person:Diotrephes`); Гай (ID: `person:Gaius.4`); Pen (ID: `realia:Pen`); Ink (ID: `realia:Ink`); Димитрий (ID: `person:Demetrius`); Truth (ID: `keyterm:Truth`)
