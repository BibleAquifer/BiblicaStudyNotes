...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); сатана (ID: `deity:Satan`); Иов (ID: `person:Job`); Bless (ID: `keyterm:Bless`); Fear (ID: `keyterm:Fear`); House (ID: `realia:House`); To Sin (ID: `keyterm:Sin`); Шева (ID: `person:Sheba`); Job's Wife (ID: `person:WifeOfJob`); Sword (ID: `realia:Sword`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); An Angel (ID: `deity:Angel`); Sabeans (ID: `group:Sabean`); Chaldeans (ID: `group:Chaldea`); Халдея (ID: `place:Chaldea`); Mattock (ID: `realia:Mattock`); Robe (ID: `realia:Robe`); Camel (ID: `fauna:Camel`); Donkey (ID: `fauna:Donkey`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** Иов (ID: `person:Job`); Софар (ID: `person:Zophar`); Shuhites (ID: `group:Shuhites`); Елифаз (ID: `person:Eliphaz.2`); Вилдад (ID: `person:Bildad`); Naamathites (ID: `group:Naamathites`); Temanites (ID: `group:Teman`); To Curse (ID: `keyterm:Curse`); Strength (ID: `keyterm:Strength`); Феман (ID: `place:Teman`); Redeem (ID: `keyterm:Redeem`); House (ID: `realia:House`); Dragon (ID: `fauna:Dragon`); Robe (ID: `realia:Robe`); Money (ID: `realia:Money`); Leviathan (ID: `fauna:GiantCroccodile`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Perceive (ID: `keyterm:Perceive`); Passion (ID: `keyterm:Ardour`); Ability (ID: `keyterm:Ability`); Hope (ID: `keyterm:Hope`); Strength (ID: `keyterm:Strength`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Иов (ID: `person:Job`); Fear (ID: `keyterm:Fear`); Hell (ID: `place:Hell`); To Sin (ID: `keyterm:Sin`); Mischief (ID: `keyterm:Mischief`); Believe In (ID: `keyterm:BelieveIn`); Rebel (ID: `keyterm:Rebel`); Counsel (ID: `keyterm:Counsel`); Safety (ID: `keyterm:Safety`); Understanding (ID: `keyterm:Understanding`); Exempt (ID: `keyterm:Exempt`); Sound Wisdom (ID: `keyterm:SoundWisdom`); Decree (ID: `keyterm:Decree`); Intention (ID: `keyterm:Intention`); Peace (ID: `keyterm:IntactState`); Pure (ID: `keyterm:Pure`); Salvation (ID: `keyterm:Salvation`); Deceit (ID: `keyterm:Deceit`); House (ID: `realia:House`); Money (ID: `realia:Money`); Worm (ID: `fauna:Maggot`); Вилдад (ID: `person:Bildad`); Mighty (ID: `keyterm:Mighty.2`)
...
* **Associated ACAI Concepts:** Иов (ID: `person:Job`); LORD (ID: `deity:Lord`); Елифаз (ID: `person:Eliphaz.2`); Temanites (ID: `group:Teman`); Феман (ID: `place:Teman`); Cattle (ID: `fauna:Bull`); Вилдад (ID: `person:Bildad`); Софар (ID: `person:Zophar`); Емима (ID: `person:Jemimah`); Keren-happuch (ID: `person:Keren-happuch`); Кассия (ID: `person:Keziah`); Foolish (ID: `keyterm:Foolish`); To Cause to Possess (ID: `keyterm:Possess`); Offering (ID: `keyterm:Offering`); Bless (ID: `keyterm:Bless`); Naamathites (ID: `group:Naamathites`); Shuhites (ID: `group:Shuhites`); Piece of Money (ID: `realia:PieceOfMoney`); Sheep (ID: `fauna:Lamb`); Camel (ID: `fauna:Camel`); Donkey (ID: `fauna:Donkey`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); House (ID: `realia:House`); Earring (ID: `realia:Earring`)
