...
* **Associated ACAI Concepts:** Valley of Aven (ID: `place:AvenValley`); Beth-eden (ID: `place:Beth-eden`); Амос (ID: `person:Amos.3`); Кир (ID: `place:Kir`); Фекоа (ID: `place:Tekoa`); Have a Vision (ID: `keyterm:HaveAVision`); Азаил (ID: `person:Hazael`); Rebel (ID: `keyterm:Rebel`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** скиния (ID: `deity:Sikkuth`); Kiyyun (ID: `deity:Kiyyun`); Harmon (ID: `place:Harmon`); Brook of the Arabah (ID: `place:BrookOfTheArabah`); Woe (ID: `keyterm:Woe.2`); Хална (ID: `place:Calneh`); Lo-debar (ID: `place:Lo-debar`); Lamentation (ID: `keyterm:Lamentation`); Horns of Altar (ID: `realia:HornsOfAltar`); Израиль (ID: `person:Israel`); House (ID: `realia:House`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Амос (ID: `person:Amos.3`); Амасси (ID: `person:Amaziah.4`); Иеровоам (ID: `person:Jeroboam.2`); Plumb Line (ID: `realia:PlumbLine`); Sieve (ID: `realia:Sieve`); Floor (ID: `realia:Floor`); Израиль (ID: `person:Israel`); LORD (ID: `deity:Lord`)
