...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Иеремия (ID: `person:Jeremiah.6`); Иерусалим (ID: `place:Jerusalem`); Иосия (ID: `person:Josiah`); Complete (ID: `keyterm:Complete`); Хелкия (ID: `person:Hilkiah.7`); Appoint (ID: `keyterm:Appoint`); Иоаким (ID: `person:Jehoiakim`); Вениамин (ID: `person:Benjamin`); Анафоф (ID: `place:Anathoth`); Holy (ID: `keyterm:Holy`); Седекия (ID: `person:Zedekiah.3`); Fear (ID: `keyterm:Fear`); Амон (ID: `person:Amon.3`); Вениамин (ID: `group:Benjamin`); Throne (ID: `realia:Throne`); Cooking Pot (ID: `realia:CookingPot`); Almond (ID: `flora:Almond`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Иерусалим (ID: `place:Jerusalem`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Defection (ID: `keyterm:Defection`); To Cause to Possess (ID: `keyterm:Possess`); Египет (ID: `place:Egypt`); Peace (ID: `keyterm:IntactState`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Appoint (ID: `keyterm:Appoint`); Ваал (ID: `deity:Baal`); Rebel (ID: `keyterm:Rebel`); Trust (ID: `keyterm:LeanOn`); Swear (ID: `keyterm:Swear`); Covenant (ID: `keyterm:Covenant`); Love (ID: `keyterm:Love`); Fear (ID: `keyterm:Fear`); Woe (ID: `keyterm:Woe`); To Sin (ID: `keyterm:Sin`); Perceive (ID: `keyterm:Perceive`); Truth (ID: `keyterm:Truth`); Instruction (ID: `keyterm:Instruction`); Passion (ID: `keyterm:Ardour`); Offering (ID: `keyterm:Offering`); Deceit (ID: `keyterm:Deceit`); House (ID: `realia:House`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Иерусалим (ID: `place:Jerusalem`); Израиль (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Speak as a Prophet (ID: `keyterm:Speak`); Иеремия (ID: `person:Jeremiah.6`); To Sin (ID: `keyterm:Sin`); Вавилон (ID: `place:Babylon`); Passion (ID: `keyterm:Ardour`); Peace (ID: `keyterm:IntactState`); Appoint (ID: `keyterm:Appoint`); Давид (ID: `person:David`); Force to Serve (ID: `keyterm:EnticedToServe`); Тофет (ID: `place:Topheth`); Love (ID: `keyterm:Love`); House (ID: `realia:House`); Пашхур (ID: `person:Pashhur.3`); Евфрат (ID: `place:Euphrates`); Навуходоносор (ID: `person:Nebuchadnezzar`); Халдея (ID: `place:Chaldea`); Иехония (ID: `person:Jehoiachin`); Sabbath (ID: `keyterm:Sabbath`); Chaldeans (ID: `group:Chaldea`); Ливан (ID: `place:Lebanon`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); Седекия (ID: `person:Zedekiah.3`); Belt (ID: `realia:Belt`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Вавилон (ID: `place:Babylon`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Иеремия (ID: `person:Jeremiah.6`); Force to Serve (ID: `keyterm:EnticedToServe`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Иерусалим (ID: `place:Jerusalem`); Speak as a Prophet (ID: `keyterm:Speak`); Навуходоносор (ID: `person:Nebuchadnezzar`); Израиль (ID: `person:Israel`); Иосия (ID: `person:Josiah`); Буз (ID: `place:Buz`); фараон (ID: `person:Pharaoh.10`); Уц (ID: `place:Uz`); Фема (ID: `place:Tema`); Замврий (ID: `place:Zimri`); Мидия (ID: `place:Media`); Be Blameless (ID: `keyterm:Blameless`); Тир (ID: `place:Tyre`); Иоаким (ID: `person:Jehoiakim`); Дедан (ID: `place:Dedan`); Филистимской (ID: `place:Philistine`); Сидон (ID: `place:Sidon`); Арбитянин (ID: `place:Arabia`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Газа (ID: `place:Gaza`); Екрон (ID: `place:Ekron`); Chaldeans (ID: `group:Chaldea`); Аммон (ID: `place:Ammon`); Азот (ID: `place:Ashdod`); Филистимлянин (ID: `group:Philistine`); Моав (ID: `place:Moab`); Амон (ID: `person:Amon.3`); Аскалонский (ID: `place:Ashkelon`); Appoint (ID: `keyterm:Appoint`); Халдея (ID: `place:Chaldea`); Елам (ID: `place:Elam`); Египет (ID: `place:Egypt`); Едом (ID: `place:Edom`); Peace (ID: `keyterm:IntactState`); Passion (ID: `keyterm:Ardour`); Lamp (ID: `realia:Lamp`); Hand-Mill (ID: `realia:Hand-mill`); Lion (ID: `fauna:Lion`); Grass (ID: `flora:Grass`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Вавилон (ID: `place:Babylon`); Иеремия (ID: `person:Jeremiah.6`); Speak as a Prophet (ID: `keyterm:Speak`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Иерусалим (ID: `place:Jerusalem`); Force to Serve (ID: `keyterm:EnticedToServe`); Навуходоносор (ID: `person:Nebuchadnezzar`); Ханания (ID: `person:Hananiah.12`); Израиль (ID: `person:Israel`); Иоаким (ID: `person:Jehoiakim`); House (ID: `realia:House`); Yoke (ID: `realia:Yoke`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Седекия (ID: `person:Zedekiah.3`); Appoint (ID: `keyterm:Appoint`); Урия (ID: `person:Uriah.2`); Nehelamites (ID: `group:Nehelams`); Шемаия (ID: `person:Shemaiah.25`); Peace (ID: `keyterm:IntactState`); Иехония (ID: `person:Jehoiachin`); Египет (ID: `place:Egypt`); Седекия (ID: `person:Zedekiah.6`); Ахав (ID: `person:Ahab.2`); Trust (ID: `keyterm:LeanOn`); Езекия (ID: `person:Hezekiah`); Truth (ID: `keyterm:Truth`); Шафан (ID: `person:Shaphan`); Practice Divination (ID: `keyterm:PracticeDivination`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Иерусалим (ID: `place:Jerusalem`); Иеремия (ID: `person:Jeremiah.6`); Халдея (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Covenant (ID: `keyterm:Covenant`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Вавилон (ID: `place:Babylon`); Passion (ID: `keyterm:Ardour`); Давид (ID: `person:David`); To Sin (ID: `keyterm:Sin`); Анамеил (ID: `person:Hanamel`); Scroll (ID: `realia:Scroll`); Седекия (ID: `person:Zedekiah.3`); Ефрем (ID: `person:Ephraim`); Fear (ID: `keyterm:Fear`); Ефрем (ID: `group:Ephraim`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Варух (ID: `person:Baruch.4`); Redeem (ID: `keyterm:Redeem`); Левий (ID: `person:Levi.3`); Peace (ID: `keyterm:IntactState`); Вениамин (ID: `person:Benjamin`); Анафоф (ID: `place:Anathoth`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иеремия (ID: `person:Jeremiah.6`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Вавилон (ID: `place:Babylon`); Египет (ID: `place:Egypt`); Иерусалим (ID: `place:Jerusalem`); Седекия (ID: `person:Zedekiah.3`); Годолия (ID: `person:Gedaliah.2`); Исмаил (ID: `person:Ishmael.2`); Израиль (ID: `person:Israel`); Халдея (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Варух (ID: `person:Baruch.4`); Ахикам (ID: `person:Ahikam`); Нефания (ID: `person:Nethaniah`); Иоханан (ID: `person:Johanan.5`); Карея (ID: `person:Kareah`); Массифа (ID: `place:Mizpah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Иоаким (ID: `person:Jehoiakim`); Шафан (ID: `person:Shaphan`); Рихав (ID: `person:Rechab.2`); Appoint (ID: `keyterm:Appoint`); Навуходоносор (ID: `person:Nebuchadnezzar`); Ионадав (ID: `person:Jonadab`); Навузардан (ID: `person:Nebuzaradan`); Ebed-melech (ID: `person:Ebed-melech`); Нирия (ID: `person:Neriah`); Force to Serve (ID: `keyterm:EnticedToServe`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Моав (ID: `place:Moab`); Египет (ID: `place:Egypt`); Израиль (ID: `person:Israel`); Елам (ID: `place:Elam`); Едом (ID: `place:Edom`); Навуходоносор (ID: `person:Nebuchadnezzar`); Вавилон (ID: `place:Babylon`); Кариафаим (ID: `place:Kiriathaim`); Есевон (ID: `place:Heshbon`); Иеремия (ID: `person:Jeremiah.6`); Trust (ID: `keyterm:LeanOn`); Аммон (ID: `place:Ammon`); Асор (ID: `place:Hazor.5`); Оронаим (ID: `place:Horonaim`); Нехао (ID: `person:Neco`); Хамос (ID: `deity:Chemosh`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Appoint (ID: `keyterm:Appoint`); Дамаск (ID: `place:Damascus`); Евфрат (ID: `place:Euphrates`); Ammonites (ID: `group:Ammon`); Counsel (ID: `keyterm:Counsel`); Иаацы (ID: `place:Jahaz`); Нево (ID: `place:Nebo`); Bozrah (ID: `place:Bozrah.2`); Феман (ID: `place:Teman`); Нил (ID: `place:Nile`); Dispossess (ID: `keyterm:Dispossess`); Visitation (ID: `keyterm:Visitation`)
...
* **Associated ACAI Concepts:** Вавилон (ID: `place:Babylon`); LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Халдея (ID: `place:Chaldea`); Appoint (ID: `keyterm:Appoint`); Chaldeans (ID: `group:Chaldea`); Иерусалим (ID: `place:Jerusalem`); Иеремия (ID: `person:Jeremiah.6`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Holy (ID: `keyterm:Holy`); Horse (ID: `fauna:Horse`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Bow (ID: `realia:Bow`); To Sin (ID: `keyterm:Sin`); Arrow (ID: `keyterm:Arrow`); Graven Image (ID: `realia:GravenImage`); Сераию (ID: `person:Seraiah.8`); Вил (ID: `deity:Bel`); To Cause to Possess (ID: `keyterm:Possess`); Visitation (ID: `keyterm:Visitation`); Assyria (ID: `place:Assyria`); Навуходоносор (ID: `person:Nebuchadnezzar`); Medes (ID: `group:Mede`); Passion (ID: `keyterm:Ardour`); Медан (ID: `person:Medan`); Arrow (ID: `realia:Arrow`); Standard (ID: `realia:Standard`)
...
* **Associated ACAI Concepts:** Вавилон (ID: `place:Babylon`); Иерусалим (ID: `place:Jerusalem`); Седекия (ID: `person:Zedekiah.3`); Навузардан (ID: `person:Nebuzaradan`); LORD (ID: `deity:Lord`); Навуходоносор (ID: `person:Nebuchadnezzar`); House (ID: `realia:House`); Иуда (ID: `person:Judah.4`); Chaldeans (ID: `group:Chaldea`); Халдея (ID: `place:Chaldea`); Иуда (ID: `group:Judah`); Ривла (ID: `place:Riblah.2`); Емаф (ID: `place:Hamath`); Judeans (ID: `group:Judea`); Иудея (ID: `place:Judea`); Иехония (ID: `person:Jehoiachin`); Сераию (ID: `person:Seraiah.2`); Хамуталь (ID: `person:Hamutal`); Иеремия (ID: `person:Jeremiah`); Evil-merodach (ID: `person:Evil-merodach`); Under Siege (ID: `keyterm:StateOfBeingUnderSiege`); Cubit (ID: `realia:Cubit`); Cooking Pot (ID: `realia:CookingPot`); Shovel (ID: `realia:Shovel`); Pomegranate (ID: `flora:Pomegranate`); Соломон (ID: `person:Solomon`); Иоаким (ID: `person:Jehoiakim`); Иерихон (ID: `place:Jericho`); Rebel (ID: `keyterm:Rebel`); Libnah (ID: `place:Libnah.2`); Arabah (ID: `place:Arabah`); Цефания (ID: `person:Zephaniah.2`); Siege-Works (ID: `realia:Siege-works`); Finger (ID: `realia:Finger`); Bowl (ID: `realia:Bowl`); Wick Trimmer (ID: `realia:WickTrimmer`); Lampstand (ID: `realia:Lampstand.2`); Thread (ID: `realia:Thread`); Doorstep (ID: `realia:Doorstep`); Money (ID: `realia:Money`); Prison (ID: `realia:Prison`); Cattle (ID: `fauna:Bull`)
