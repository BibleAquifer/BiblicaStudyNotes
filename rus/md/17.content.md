...
* **Associated ACAI Concepts:** Артаксеркс (ID: `person:Ahasuerus`); Астинь (ID: `person:Vashti`); Есфирь (ID: `person:Esther`); Мардохей (ID: `person:Mordecai.2`); Сузы (ID: `place:Susa`); House (ID: `realia:House`); Персия (ID: `place:Persia`); Гегай (ID: `person:Hegai`); Мемухан (ID: `person:Memucan`); Мидия (ID: `place:Media`); Kindness (ID: `keyterm:Kindness`); Favor (ID: `keyterm:Favor`); Каршена (ID: `person:Carshena`); Бигефа (ID: `person:Bigtha`); Марсена (ID: `person:Marsena`); Шаазгаз (ID: `person:Shaashgaz`); Шимей (ID: `person:Shimei.18`); Адмафа (ID: `person:Admatha`); Мерес (ID: `person:Meres`); Гавафа (ID: `person:Bigthan`); Авагфа (ID: `person:Abagtha`); Каркас (ID: `person:Carkas`); Crown (ID: `realia:Crown`); Иаир (ID: `person:Jair.4`); Харбона (ID: `person:Harbona`); Кис (ID: `person:Kish.4`); Авихаиль (ID: `person:Abihail.5`); Мегуман (ID: `person:Mehuman`); Фарра (ID: `person:Teresh`); Шефар (ID: `person:Shethar`); Бизфа (ID: `person:Biztha`); Индия (ID: `place:India`); Зефар (ID: `person:Zethar`); Ефиопия (ID: `place:Ethiopia`); Glory (ID: `keyterm:Glory`); Навуходоносор (ID: `person:Nebuchadnezzar`); Love (ID: `keyterm:Love`); Persians (ID: `group:Persia`); Scroll (ID: `realia:Scroll`); Иехония (ID: `person:Jehoiachin`); Vine (ID: `flora:Vine`); Вениамин (ID: `group:Benjamin`); Peace (ID: `keyterm:IntactState`); Вавилон (ID: `place:Babylon`); Иерусалим (ID: `place:Jerusalem`); Wine (ID: `realia:Wine`); Вениамин (ID: `person:Benjamin`); Фарсис (ID: `place:Tarshish`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Delight (ID: `keyterm:Delight`); Медан (ID: `person:Medan`); Medes (ID: `group:Mede`); Appoint (ID: `keyterm:Appoint`); Jews (ID: `group:Jews`); Balsam Tree (ID: `flora:BalsamTree`); Cotton (ID: `flora:Cotton`); Bed (ID: `realia:Bed`); Purple Cloth (ID: `realia:PurpleCloth`); Olive Oil (ID: `realia:OliveOil`); Linen (ID: `realia:Linen`); Money (ID: `realia:Money`); Myrrh (ID: `flora:Myrrh`); Doorstep (ID: `realia:Doorstep`); Rope (ID: `realia:Rope`); Anointing Oil (ID: `realia:AnointingOil`)
...
* **Associated ACAI Concepts:** Аман (ID: `person:Haman`); Мардохей (ID: `person:Mordecai.2`); Артаксеркс (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Agagites (ID: `group:Agag`); Амадафа (ID: `person:Hammedatha`); Агаг (ID: `person:Agag.2`); Money (ID: `realia:Money`); Сузы (ID: `place:Susa`); Servants (ID: `group:GenericServants`); Lot (ID: `keyterm:Lot`); Scroll (ID: `realia:Scroll`); Talent (ID: `realia:Talent`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Мардохей (ID: `person:Mordecai.2`); Есфирь (ID: `person:Esther`); Jews (ID: `group:Jews`); Гафах (ID: `person:Hathach`); Sackcloth (ID: `realia:Sackcloth`); Сузы (ID: `place:Susa`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Аман (ID: `person:Haman`); Money (ID: `realia:Money`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Аман (ID: `person:Haman`); Есфирь (ID: `person:Esther`); Мардохей (ID: `person:Mordecai.2`); House (ID: `realia:House`); Jews (ID: `group:Jews`); Зерешь (ID: `person:Zeresh`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Horse (ID: `fauna:Horse`); Артаксеркс (ID: `person:Ahasuerus`); Love (ID: `keyterm:Love`); Favor (ID: `keyterm:Favor`); A Group of People (ID: `group:GenericGroup`); Servants (ID: `group:GenericServants`); Гавафа (ID: `person:Bigthan`); Фарра (ID: `person:Teresh`); Харбона (ID: `person:Harbona.2`); Cubit (ID: `realia:Cubit`); Glory (ID: `keyterm:Glory`); Bed (ID: `realia:Bed`); Scroll (ID: `realia:Scroll`); Crown (ID: `realia:Crown`); Doorstep (ID: `realia:Doorstep`); Throne (ID: `realia:Throne`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Мардохей (ID: `person:Mordecai.2`); Сузы (ID: `place:Susa`); Артаксеркс (ID: `person:Ahasuerus`); Есфирь (ID: `person:Esther`); Аман (ID: `person:Haman`); Scroll (ID: `realia:Scroll`); Амадафа (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Агаг (ID: `person:Agag.2`); Peace (ID: `keyterm:IntactState`); Аридая (ID: `person:Aridai`); Ваиезафа (ID: `person:Vaizatha`); Авихаиль (ID: `person:Abihail.5`); Арисай (ID: `person:Arisai`); Индия (ID: `place:India`); Аридафа (ID: `person:Aridatha`); Порафа (ID: `person:Poratha`); Паршандафа (ID: `person:Parshandatha`); Пармашфа (ID: `person:Parmashta`); Далфон (ID: `person:Dalphon`); Адалья (ID: `person:Adalia`); Асфафа (ID: `person:Aspatha`); Ефиопия (ID: `place:Ethiopia`); Truth (ID: `keyterm:Truth`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Персия (ID: `place:Persia`); Lot (ID: `keyterm:Lot`); Delight (ID: `keyterm:Delight`); Favor (ID: `keyterm:Favor`); Мидия (ID: `place:Media`); Lot (ID: `realia:Lot`); Horse (ID: `fauna:Horse`); Purple Cloth (ID: `realia:PurpleCloth`); House (ID: `realia:House`); Linen (ID: `realia:Linen`); Crown (ID: `realia:Crown`)
