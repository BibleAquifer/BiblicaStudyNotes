...
* **Associated ACAI Concepts:** Артаксеркс (ID: `person:Ahasuerus`); Астинь (ID: `person:Vashti`); Есфирь (ID: `person:Esther`); Мардохей (ID: `person:Mordecai.2`); Сузы (ID: `place:Susa`); House (ID: `realia:House`); Персия (ID: `place:Persia`); Гегай (ID: `person:Hegai`); Мемухан (ID: `person:Memucan`); Мидия (ID: `place:Media`); Kindness (ID: `keyterm:Kindness`); Favor (ID: `keyterm:Favor`); Индия (ID: `place:India`); Каркас (ID: `person:Carkas`); Каршена (ID: `person:Carshena`); Адмафа (ID: `person:Admatha`); Фарра (ID: `person:Teresh`); Мерес (ID: `person:Meres`); Зефар (ID: `person:Zethar`); Шефар (ID: `person:Shethar`); Харбона (ID: `person:Harbona`); Иаир (ID: `person:Jair.4`); Кис (ID: `person:Kish.4`); Авагфа (ID: `person:Abagtha`); Шаазгаз (ID: `person:Shaashgaz`); Шимей (ID: `person:Shimei.18`); Crown (ID: `realia:Crown`); Бигефа (ID: `person:Bigtha`); Авихаиль (ID: `person:Abihail.5`); Бизфа (ID: `person:Biztha`); Мегуман (ID: `person:Mehuman`); Гавафа (ID: `person:Bigthan`); Марсена (ID: `person:Marsena`); Medes (ID: `group:Mede`); Вениамин (ID: `person:Benjamin`); Вавилон (ID: `place:Babylon`); Wine (ID: `realia:Wine`); Ефиопия (ID: `place:Ethiopia`); Scroll (ID: `realia:Scroll`); Медан (ID: `person:Medan`); Persians (ID: `group:Persia`); Delight (ID: `keyterm:Delight`); Иуда (ID: `group:Judah`); Иерусалим (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Иехония (ID: `person:Jehoiachin`); Appoint (ID: `keyterm:Appoint`); Peace (ID: `keyterm:IntactState`); Иуда (ID: `person:Judah.4`); Навуходоносор (ID: `person:Nebuchadnezzar`); Jews (ID: `group:Jews`); Вениамин (ID: `group:Benjamin`); Фарсис (ID: `place:Tarshish`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Cotton (ID: `flora:Cotton`); Balsam Tree (ID: `flora:BalsamTree`); Olive Oil (ID: `realia:OliveOil`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`); Linen (ID: `realia:Linen`); Myrrh (ID: `flora:Myrrh`); Rope (ID: `realia:Rope`); Anointing Oil (ID: `realia:AnointingOil`); Bed (ID: `realia:Bed`); Doorstep (ID: `realia:Doorstep`)
...
* **Associated ACAI Concepts:** Аман (ID: `person:Haman`); Мардохей (ID: `person:Mordecai.2`); Артаксеркс (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Agagites (ID: `group:Agag`); Амадафа (ID: `person:Hammedatha`); Агаг (ID: `person:Agag.2`); Money (ID: `realia:Money`); Servants (ID: `group:GenericServants`); Lot (ID: `keyterm:Lot`); Сузы (ID: `place:Susa`); Talent (ID: `realia:Talent`); Lot (ID: `realia:Lot`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Мардохей (ID: `person:Mordecai.2`); Есфирь (ID: `person:Esther`); Jews (ID: `group:Jews`); Гафах (ID: `person:Hathach`); Sackcloth (ID: `realia:Sackcloth`); Сузы (ID: `place:Susa`); Аман (ID: `person:Haman`); To Beg for Mercy (ID: `keyterm:BegForMercy`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Мардохей (ID: `person:Mordecai.2`); Сузы (ID: `place:Susa`); Аман (ID: `person:Haman`); Есфирь (ID: `person:Esther`); Артаксеркс (ID: `person:Ahasuerus`); Scroll (ID: `realia:Scroll`); Амадафа (ID: `person:Hammedatha`); Агаг (ID: `person:Agag.2`); Agagites (ID: `group:Agag`); Peace (ID: `keyterm:IntactState`); Индия (ID: `place:India`); Аридая (ID: `person:Aridai`); Асфафа (ID: `person:Aspatha`); Арисай (ID: `person:Arisai`); Ваиезафа (ID: `person:Vaizatha`); Порафа (ID: `person:Poratha`); Аридафа (ID: `person:Aridatha`); Далфон (ID: `person:Dalphon`); Паршандафа (ID: `person:Parshandatha`); Пармашфа (ID: `person:Parmashta`); Адалья (ID: `person:Adalia`); Авихаиль (ID: `person:Abihail.5`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Ефиопия (ID: `place:Ethiopia`); Мидия (ID: `place:Media`); Delight (ID: `keyterm:Delight`); Персия (ID: `place:Persia`); Favor (ID: `keyterm:Favor`); Truth (ID: `keyterm:Truth`); Lot (ID: `keyterm:Lot`); Lot (ID: `realia:Lot`); Horse (ID: `fauna:Horse`); Purple Cloth (ID: `realia:PurpleCloth`); House (ID: `realia:House`); Linen (ID: `realia:Linen`); Crown (ID: `realia:Crown`)
