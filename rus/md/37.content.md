...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Аггей (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Дарий (ID: `person:Darius.2`); Иисус (ID: `person:Joshua.5`); Салафиил (ID: `person:Shealtiel.2`); Иоседек (ID: `person:Jehozadak`); Зоровавель (ID: `person:Zerubbabel.2`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Bag (ID: `realia:Bag`); Olive Oil (ID: `realia:OliveOil`); Must (ID: `realia:Must`); Vine (ID: `flora:Vine`); Mule (ID: `fauna:Mule`); Grain (ID: `flora:Grain`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Зоровавель (ID: `person:Zerubbabel.2`); Иоседек (ID: `person:Jehozadak`); Аггей (ID: `person:Haggai`); Иисус (ID: `person:Joshua.5`); Салафиил (ID: `person:Shealtiel.2`); Дарий (ID: `person:Darius.2`); An Angel (ID: `deity:Angel`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Fear (ID: `keyterm:Fear`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Зоровавель (ID: `person:Zerubbabel.2`); Иисус (ID: `person:Joshua.5`); Иоседек (ID: `person:Jehozadak`); Аггей (ID: `person:Haggai`); Египет (ID: `place:Egypt`); Иуда (ID: `group:Judah`); Peace (ID: `keyterm:IntactState`); Иуда (ID: `person:Judah.4`); Салафиил (ID: `person:Shealtiel.2`); Fear (ID: `keyterm:Fear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Зоровавель (ID: `person:Zerubbabel.2`); LORD (ID: `deity:Lord`); Аггей (ID: `person:Haggai`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Салафиил (ID: `person:Shealtiel.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`)
