...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Аггей (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Дарий (ID: `person:Darius.2`); Иисус (ID: `person:Joshua.5`); Салафиил (ID: `person:Shealtiel.2`); Иоседек (ID: `person:Jehozadak`); Иуда (ID: `group:Judah`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Иуда (ID: `person:Judah.4`); Зоровавель (ID: `person:Zerubbabel.2`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`); Bag (ID: `realia:Bag`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Must (ID: `realia:Must`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иоседек (ID: `person:Jehozadak`); Зоровавель (ID: `person:Zerubbabel.2`); Салафиил (ID: `person:Shealtiel.2`); Иисус (ID: `person:Joshua.5`); Аггей (ID: `person:Haggai`); Иуда (ID: `person:Judah.4`); Fear (ID: `keyterm:Fear`); Иуда (ID: `group:Judah`); An Angel (ID: `deity:Angel`); Дарий (ID: `person:Darius.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Иисус (ID: `person:Joshua.5`); Иоседек (ID: `person:Jehozadak`); Зоровавель (ID: `person:Zerubbabel.2`); Аггей (ID: `person:Haggai`); Peace (ID: `keyterm:IntactState`); Иуда (ID: `person:Judah.4`); Fear (ID: `keyterm:Fear`); Салафиил (ID: `person:Shealtiel.2`); Иуда (ID: `group:Judah`); Египет (ID: `place:Egypt`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Зоровавель (ID: `person:Zerubbabel.2`); Иуда (ID: `person:Judah.4`); Салафиил (ID: `person:Shealtiel.2`); Иуда (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Аггей (ID: `person:Haggai`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`)
