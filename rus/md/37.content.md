...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Аггей (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Салафиил (ID: `person:Shealtiel.2`); Иоседек (ID: `person:Jehozadak`); Иисус (ID: `person:Joshua.5`); Дарий (ID: `person:Darius.2`); Иуда (ID: `person:Judah.4`); Зоровавель (ID: `person:Zerubbabel.2`); Иуда (ID: `group:Judah`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Bag (ID: `realia:Bag`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`); Mule (ID: `fauna:Mule`); Must (ID: `realia:Must`); Olive Tree (ID: `flora:OliveTree`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Зоровавель (ID: `person:Zerubbabel.2`); Иоседек (ID: `person:Jehozadak`); Салафиил (ID: `person:Shealtiel.2`); Иисус (ID: `person:Joshua.5`); Аггей (ID: `person:Haggai`); An Angel (ID: `deity:Angel`); Fear (ID: `keyterm:Fear`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Дарий (ID: `person:Darius.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Иисус (ID: `person:Joshua.5`); Зоровавель (ID: `person:Zerubbabel.2`); Иоседек (ID: `person:Jehozadak`); Аггей (ID: `person:Haggai`); Салафиил (ID: `person:Shealtiel.2`); Fear (ID: `keyterm:Fear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Египет (ID: `place:Egypt`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Peace (ID: `keyterm:IntactState`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Аггей (ID: `person:Haggai`); Defilement (ID: `keyterm:Defilement`); Vine (ID: `flora:Vine`); Holy (ID: `keyterm:Holy`); Bless (ID: `keyterm:Bless`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Instruction (ID: `keyterm:Instruction`); Дарий (ID: `person:Darius.2`); Winepress (ID: `realia:Winepress`); Grain (ID: `flora:Grain`); Barley (ID: `flora:Barley`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Pomegranate (ID: `flora:Pomegranate`); Coriander (ID: `flora:Coriander`); Anointing Oil (ID: `realia:AnointingOil`); Stew (ID: `realia:Stew`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Зоровавель (ID: `person:Zerubbabel.2`); LORD (ID: `deity:Lord`); Салафиил (ID: `person:Shealtiel.2`); Аггей (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Sword (ID: `realia:Sword`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`)
