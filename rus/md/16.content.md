...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Иерусалим (ID: `place:Jerusalem`); Моисей (ID: `person:Moses`); Неемия (ID: `person:Nehemiah.2`); Hacaliah (ID: `person:Hacaliah`); Сузы (ID: `place:Susa`); Хананий (ID: `person:Hanani.4`); Repent (ID: `keyterm:Repent`); Kindness (ID: `keyterm:Kindness`); Strength (ID: `keyterm:Strength`); Be Unfaithful (ID: `keyterm:Unfaithful`); Redeem (ID: `keyterm:Redeem`); Иуда (ID: `group:Judah`); Covenant (ID: `keyterm:Covenant`); Иуда (ID: `person:Judah.4`); Jews (ID: `group:Jews`); To Sin (ID: `keyterm:Sin`); Decree (ID: `keyterm:Decree`); Израиль (ID: `person:Israel`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Иерусалим (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Horonites (ID: `group:Horonites`); Valley Gate (ID: `place:ValleyGate`); Товия (ID: `person:Tobiah.2`); Санаваллат (ID: `person:Sanballat`); Аммон (ID: `place:Ammon`); Иуда (ID: `group:Judah`); Ammonites (ID: `group:Ammon`); Иуда (ID: `person:Judah.4`); Евфрат (ID: `place:Euphrates`); Cattle (ID: `fauna:Bull`); Dung Gate (ID: `place:DungGate`); Гешем (ID: `person:Geshem`); ворота Источника (ID: `place:FountainGate`); Асаф (ID: `person:Asaph.4`); Артаксеркс (ID: `person:Artaxerxes`); Dragon Spring (ID: `place:DragonSpring`); Arabians (ID: `group:Arabia`); Siloam (ID: `place:Siloam`); Fear (ID: `keyterm:Fear`); Rebel (ID: `keyterm:Rebel`); Арбитянин (ID: `place:Arabia`); Jews (ID: `group:Jews`); Израиль (ID: `person:Israel`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Иерусалим (ID: `place:Jerusalem`); Санаваллат (ID: `person:Sanballat`); Товия (ID: `person:Tobiah.2`); Jews (ID: `group:Jews`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Гешем (ID: `person:Geshem`); Елиашив (ID: `person:Eliashib.7`); Мешуллам (ID: `person:Meshullam.12`); Верехия (ID: `person:Berechiah.5`); Массифа (ID: `place:Mizpah`); Tower (ID: `realia:Tower`); Money (ID: `realia:Money`); Grain (ID: `flora:Grain`); Офел (ID: `place:Ophel`); Урия (ID: `person:Uriah.4`); Азария (ID: `person:Azariah.17`); Гаккоц (ID: `person:Hakkoz.3`); Овечьи ворота (ID: `place:SheepGate`); Меремоф (ID: `person:Meremoth`); Фекоа (ID: `place:Tekoa`); Dung Gate (ID: `place:DungGate`); Arabians (ID: `group:Arabia`); Ammonites (ID: `group:Ammon`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); LORD (ID: `deity:Lord`); Ездра (ID: `person:Ezra`); Perceive (ID: `keyterm:Perceive`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Израиль (ID: `person:Israel`); Scroll (ID: `realia:Scroll`); Water Gate (ID: `place:WaterGate`); Holy (ID: `keyterm:Holy`); Елам (ID: `person:Elam`); Моисей (ID: `person:Moses`); Иешуа (ID: `person:Jeshua.4`); Соломон (ID: `person:Solomon`); Иерусалим (ID: `place:Jerusalem`); Daric (ID: `realia:Daric`); Арах (ID: `person:Arah.2`); Даркон (ID: `person:Darkon`); Хаттил (ID: `person:Hattil`); Нево (ID: `place:Nebo.2`); Малхия (ID: `person:Malchijah.9`); Езекия (ID: `person:Hezekiah.2`); Иамин (ID: `person:Jamin.3`); Некода (ID: `person:Nekoda`); Бесай (ID: `person:Besai`); Хадид (ID: `place:Hadid`); Хархур (ID: `person:Harhur`); Амий (ID: `person:Ami`); Харим (ID: `person:Harim.2`); Лебана (ID: `person:Lebanah`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Dispossess (ID: `keyterm:Dispossess`); House (ID: `realia:House`); Израиль (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Шевания (ID: `person:Shebaniah.2`); Ваний (ID: `person:Bani.8`); Кадмиил (ID: `person:Kadmiel`); Египет (ID: `place:Egypt`); Иешуа (ID: `person:Jeshua.4`); Offering (ID: `keyterm:Offering`); Decree (ID: `keyterm:Decree`); Sabbath (ID: `keyterm:Sabbath`); Ваний (ID: `person:Bani.11`); Годия (ID: `person:Hodiah.2`); Шеревия (ID: `person:Sherebiah`); Моисей (ID: `person:Moses`); Compassionate (ID: `keyterm:Compassionate`); Delight (ID: `keyterm:Delight`); Repent (ID: `keyterm:Repent`); Covenant (ID: `keyterm:Covenant`); Canaanites (ID: `group:Canaan`); Kindness (ID: `keyterm:Kindness`); Ханаан (ID: `place:Canaan`); Truth (ID: `keyterm:Truth`); Work (ID: `keyterm:Work`); Generous (ID: `keyterm:Generous`)
...
* **Associated ACAI Concepts:** Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Иерусалим (ID: `place:Jerusalem`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Вениамин (ID: `group:Benjamin`); Praise (ID: `keyterm:Praise`); Иисус (ID: `person:Joshua.5`); Вениамин (ID: `person:Benjamin`); Ездра (ID: `person:Ezra.2`); Бакбукия (ID: `person:Bakbukiah`); Иоаким (ID: `person:Joiakim`); Иоханан (ID: `person:Johanan.9`); Иоиада (ID: `person:Joiada.2`); Матфания (ID: `person:Mattaniah`); Елиашив (ID: `person:Eliashib.8`); Иеремия (ID: `person:Jeremiah.7`); Иедаия (ID: `person:Jedaiah.3`); Шемаия (ID: `person:Shemaiah.20`); Иоиарив (ID: `person:Joiarib`); Давид (ID: `person:David`); Иуда (ID: `person:Judah.7`); Овадия (ID: `person:Obadiah.5`); Маллух (ID: `person:Malluch.4`); Миха (ID: `person:Mica.3`); Шевания (ID: `person:Shebaniah.3`); Iddo (ID: `person:Iddo.7`); Авия (ID: `person:Abijah.7`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Sabbath (ID: `keyterm:Sabbath`); Иерусалим (ID: `place:Jerusalem`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Израиль (ID: `person:Israel`); House (ID: `realia:House`); Pure (ID: `keyterm:Pure`); Offering (ID: `keyterm:Offering`); Товия (ID: `person:Tobiah.2`); Елиашив (ID: `person:Eliashib.9`); Vine (ID: `flora:Vine`); Kindness (ID: `keyterm:Kindness`); Аммон (ID: `place:Ammon`); Давид (ID: `person:David`); Азот (ID: `place:Ashdod`); To Dishonor (ID: `keyterm:Dishonor`); Instruction (ID: `keyterm:Instruction`); Holy (ID: `keyterm:Holy`); Соломон (ID: `person:Solomon`); Моав (ID: `place:Moab`); Елиашив (ID: `person:Eliashib.8`); Федаия (ID: `person:Pedaiah.7`); Асаф (ID: `person:Asaph.2`); Иоиада (ID: `person:Joiada.2`); Horonites (ID: `group:Horonites`); Ханан (ID: `person:Hanan.8`); Шелемия (ID: `person:Shelemiah.5`); Садок (ID: `person:Zadok.8`); Матфания (ID: `person:Mattaniah.10`); Закур (ID: `person:Zaccur.8`); Frankincense (ID: `flora:Frankincense`); Grain (ID: `flora:Grain`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Must (ID: `realia:Must`); Olive Oil (ID: `realia:OliveOil`); Вавилон (ID: `place:Babylon`); Аарона (ID: `person:Aaron`); Priesthood (ID: `keyterm:Priesthood`); Well-Established (ID: `keyterm:BeFirm`); Be Unfaithful (ID: `keyterm:Unfaithful`); Bless (ID: `keyterm:Bless`); Неемия (ID: `person:Nehemiah.2`); Swear (ID: `keyterm:Swear`); Covenant (ID: `keyterm:Covenant`); Ammonites (ID: `group:Ammon`); Моисей (ID: `person:Moses`); Санаваллат (ID: `person:Sanballat`); Appoint (ID: `keyterm:Appoint`); Defilement (ID: `keyterm:Defilement`); Артаксеркс (ID: `person:Artaxerxes`); Tyrians (ID: `group:Tyre`); Perceive (ID: `keyterm:Perceive`); Тир (ID: `place:Tyre`); To Sin (ID: `keyterm:Sin`); Jews (ID: `group:Jews`); Валаам (ID: `person:Balaam`); Зоровавель (ID: `person:Zerubbabel.2`); Love (ID: `keyterm:Love`); Wine (ID: `realia:Wine`); Winepress (ID: `realia:Winepress`); Fig (ID: `flora:Fig`); Scroll (ID: `realia:Scroll`); Fish (ID: `fauna:Fish`); Donkey (ID: `fauna:Donkey`)
