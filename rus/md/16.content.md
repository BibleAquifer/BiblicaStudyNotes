...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Иерусалим (ID: `place:Jerusalem`); Fear (ID: `keyterm:Fear`); Моисей (ID: `person:Moses`); Hacaliah (ID: `person:Hacaliah`); Хананий (ID: `person:Hanani.4`); Сузы (ID: `place:Susa`); Неемия (ID: `person:Nehemiah.2`); Love (ID: `keyterm:Love`); Strength (ID: `keyterm:Strength`); Redeem (ID: `keyterm:Redeem`); Иуда (ID: `person:Judah.4`); Decree (ID: `keyterm:Decree`); To Sin (ID: `keyterm:Sin`); Repent (ID: `keyterm:Repent`); Be Unfaithful (ID: `keyterm:Unfaithful`); Jews (ID: `group:Jews`); Kindness (ID: `keyterm:Kindness`); Израиль (ID: `person:Israel`); Covenant (ID: `keyterm:Covenant`); Иуда (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Иерусалим (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Horonites (ID: `group:Horonites`); Товия (ID: `person:Tobiah.2`); Valley Gate (ID: `place:ValleyGate`); Санаваллат (ID: `person:Sanballat`); Иуда (ID: `person:Judah.4`); Евфрат (ID: `place:Euphrates`); Аммон (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Иуда (ID: `group:Judah`); Cattle (ID: `fauna:Bull`); Гешем (ID: `person:Geshem`); Асаф (ID: `person:Asaph.4`); Dragon Spring (ID: `place:DragonSpring`); Артаксеркс (ID: `person:Artaxerxes`); ворота Источника (ID: `place:FountainGate`); Dung Gate (ID: `place:DungGate`); Rebel (ID: `keyterm:Rebel`); Арбитянин (ID: `place:Arabia`); Siloam (ID: `place:Siloam`); Arabians (ID: `group:Arabia`); Fear (ID: `keyterm:Fear`); Jews (ID: `group:Jews`); Израиль (ID: `person:Israel`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Иерусалим (ID: `place:Jerusalem`); Товия (ID: `person:Tobiah.2`); Санаваллат (ID: `person:Sanballat`); Jews (ID: `group:Jews`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Мешуллам (ID: `person:Meshullam.12`); Верехия (ID: `person:Berechiah.5`); Гешем (ID: `person:Geshem`); Елиашив (ID: `person:Eliashib.7`); Массифа (ID: `place:Mizpah`); Grain (ID: `flora:Grain`); Money (ID: `realia:Money`); Tower (ID: `realia:Tower`); Гаккоц (ID: `person:Hakkoz.3`); Овечьи ворота (ID: `place:SheepGate`); Урия (ID: `person:Uriah.4`); Офел (ID: `place:Ophel`); Азария (ID: `person:Azariah.17`); Фекоа (ID: `place:Tekoa`); Меремоф (ID: `person:Meremoth`); Dung Gate (ID: `place:DungGate`); To Sin (ID: `keyterm:Sin`); Arabians (ID: `group:Arabia`); Левий (ID: `person:Levi.3`); Арбитянин (ID: `place:Arabia`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); LORD (ID: `deity:Lord`); Ездра (ID: `person:Ezra`); Perceive (ID: `keyterm:Perceive`); Левий (ID: `person:Levi.3`); Израиль (ID: `person:Israel`); Левий (ID: `group:Levi`); Scroll (ID: `realia:Scroll`); Water Gate (ID: `place:WaterGate`); Holy (ID: `keyterm:Holy`); Елам (ID: `person:Elam`); Моисей (ID: `person:Moses`); Иешуа (ID: `person:Jeshua.4`); Иерусалим (ID: `place:Jerusalem`); Соломон (ID: `person:Solomon`); Daric (ID: `realia:Daric`); Салмай (ID: `person:Shalmai`); Шовай (ID: `person:Shobai`); Хашум (ID: `person:Hashum.2`); Керос (ID: `person:Keros`); Иедаия (ID: `person:Jedaiah.4`); Мехида (ID: `person:Mehida`); Федаия (ID: `person:Pedaiah.5`); Шема (ID: `person:Shema.4`); Циха (ID: `person:Ziha`); Шавтай (ID: `person:Shabbethai.2`); Годия (ID: `person:Hodiah.2`); Нетофа (ID: `place:Netophah`); Гахар (ID: `person:Gahar`); Атер (ID: `person:Ater.2`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Dispossess (ID: `keyterm:Dispossess`); House (ID: `realia:House`); To Sin (ID: `keyterm:Sin`); Израиль (ID: `person:Israel`); Шевания (ID: `person:Shebaniah.2`); Ваний (ID: `person:Bani.8`); Кадмиил (ID: `person:Kadmiel`); Sabbath (ID: `keyterm:Sabbath`); Иешуа (ID: `person:Jeshua.4`); Египет (ID: `place:Egypt`); Decree (ID: `keyterm:Decree`); Offering (ID: `keyterm:Offering`); Ваний (ID: `person:Bani.11`); Годия (ID: `person:Hodiah.2`); Шеревия (ID: `person:Sherebiah`); Ханаан (ID: `place:Canaan`); Generous (ID: `keyterm:Generous`); Truth (ID: `keyterm:Truth`); Моисей (ID: `person:Moses`); Canaanites (ID: `group:Canaan`); Compassionate (ID: `keyterm:Compassionate`); Kindness (ID: `keyterm:Kindness`); Covenant (ID: `keyterm:Covenant`); Delight (ID: `keyterm:Delight`); Repent (ID: `keyterm:Repent`); Work (ID: `keyterm:Work`)
...
* **Associated ACAI Concepts:** Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Иерусалим (ID: `place:Jerusalem`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Praise (ID: `keyterm:Praise`); Вениамин (ID: `person:Benjamin`); Иисус (ID: `person:Joshua.5`); Вениамин (ID: `group:Benjamin`); Иоиада (ID: `person:Joiada.2`); Ездра (ID: `person:Ezra.2`); Иоаким (ID: `person:Joiakim`); Иоханан (ID: `person:Johanan.9`); Бакбукия (ID: `person:Bakbukiah`); Матфания (ID: `person:Mattaniah`); Иоиарив (ID: `person:Joiarib`); Елиашив (ID: `person:Eliashib.8`); Иеремия (ID: `person:Jeremiah.7`); Иедаия (ID: `person:Jedaiah.3`); Шемаия (ID: `person:Shemaiah.20`); Давид (ID: `person:David`); Амок (ID: `person:Amok`); Овадия (ID: `person:Obadiah.5`); Гиннефон (ID: `person:Ginnethon`); Амария (ID: `person:Amariah.7`); Иуда (ID: `person:Judah.7`); Иедаия (ID: `person:Jedaiah.5`); Иаддуя (ID: `person:Jaddua.2`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Sabbath (ID: `keyterm:Sabbath`); Иерусалим (ID: `place:Jerusalem`); Иуда (ID: `person:Judah.4`); Израиль (ID: `person:Israel`); Иуда (ID: `group:Judah`); House (ID: `realia:House`); Pure (ID: `keyterm:Pure`); Offering (ID: `keyterm:Offering`); Товия (ID: `person:Tobiah.2`); Елиашив (ID: `person:Eliashib.9`); Vine (ID: `flora:Vine`); Соломон (ID: `person:Solomon`); Holy (ID: `keyterm:Holy`); Давид (ID: `person:David`); Азот (ID: `place:Ashdod`); Аммон (ID: `place:Ammon`); To Dishonor (ID: `keyterm:Dishonor`); Instruction (ID: `keyterm:Instruction`); Моав (ID: `place:Moab`); Kindness (ID: `keyterm:Kindness`); Елиашив (ID: `person:Eliashib.8`); Шелемия (ID: `person:Shelemiah.5`); Закур (ID: `person:Zaccur.8`); Horonites (ID: `group:Horonites`); Ханан (ID: `person:Hanan.8`); Садок (ID: `person:Zadok.8`); Федаия (ID: `person:Pedaiah.7`); Асаф (ID: `person:Asaph.2`); Иоиада (ID: `person:Joiada.2`); Матфания (ID: `person:Mattaniah.10`); Grain (ID: `flora:Grain`); Frankincense (ID: `flora:Frankincense`); Mule (ID: `fauna:Mule`); Must (ID: `realia:Must`); Olive Tree (ID: `flora:OliveTree`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Love (ID: `keyterm:Love`); Вавилон (ID: `place:Babylon`); Тир (ID: `place:Tyre`); Well-Established (ID: `keyterm:BeFirm`); Tyrians (ID: `group:Tyre`); Аарона (ID: `person:Aaron`); Зоровавель (ID: `person:Zerubbabel.2`); Bless (ID: `keyterm:Bless`); To Sin (ID: `keyterm:Sin`); Swear (ID: `keyterm:Swear`); Priesthood (ID: `keyterm:Priesthood`); Артаксеркс (ID: `person:Artaxerxes`); Be Unfaithful (ID: `keyterm:Unfaithful`); Санаваллат (ID: `person:Sanballat`); Jews (ID: `group:Jews`); Моисей (ID: `person:Moses`); Ammonites (ID: `group:Ammon`); Perceive (ID: `keyterm:Perceive`); Appoint (ID: `keyterm:Appoint`); Defilement (ID: `keyterm:Defilement`); Covenant (ID: `keyterm:Covenant`); Неемия (ID: `person:Nehemiah.2`); Валаам (ID: `person:Balaam`); Fish (ID: `fauna:Fish`); Donkey (ID: `fauna:Donkey`); Winepress (ID: `realia:Winepress`); Fig (ID: `flora:Fig`); Scroll (ID: `realia:Scroll`); Wine (ID: `realia:Wine`)
