...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Елкосеянин (ID: `place:Elkosh`); Наум (ID: `person:Nahum.2`); Zealous (ID: `keyterm:Zealous.3`); Васан (ID: `place:Bashan`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); The Way (ID: `keyterm:TheWay`); Ливан (ID: `place:Lebanon`); Кармил (ID: `place:Carmel`); Strength (ID: `keyterm:Strength`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); Utterance (ID: `keyterm:Utterance`); Ниневия (ID: `place:Nineveh`); Scroll (ID: `realia:Scroll`); Fortress (ID: `realia:Fortress`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Chariot (ID: `realia:Chariot`); Lion (ID: `fauna:Lion`); Locust (ID: `fauna:Locust`); Wickedness (ID: `keyterm:Wickedness`); Ниневия (ID: `place:Nineveh`); Амон (ID: `deity:Amon`); Но (ID: `place:Thebes`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Фут (ID: `place:Put`); Woe (ID: `keyterm:Woe.2`); Нил (ID: `place:Nile`); Glory (ID: `keyterm:Glory`); Strength (ID: `keyterm:Strength`); Under Siege (ID: `keyterm:StateOfBeingUnderSiege`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Peace (ID: `keyterm:IntactState`); Египет (ID: `place:Egypt`); Иуда (ID: `group:Judah`); Detested Thing (ID: `keyterm:DetestedThing`); Иуда (ID: `person:Judah.4`); Израиль (ID: `person:Israel`); An Angel (ID: `deity:Angel`); Incantations (ID: `keyterm:Incantations`); Cush (ID: `place:Cush.2`); Assyria (ID: `place:Assyria`); Ливияне (ID: `place:Libya`); Lot (ID: `keyterm:Lot`); Vow (ID: `keyterm:Vow`); Protective Shield (ID: `realia:ProtectiveShield`); Brick Mold (ID: `realia:BrickMold`); Brier (ID: `flora:Brier`); Fortification (ID: `realia:Fortification`); Phoenician Juniper (ID: `flora:JuniperTree`); Cypress (ID: `flora:Cypress`); Fortress (ID: `realia:Fortress`); Molten Image (ID: `realia:MoltenImage`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Fir (ID: `flora:Fir`); Dove (ID: `fauna:Dove`); Money (ID: `realia:Money`); Fig (ID: `flora:Fig`); Dyed Cloth (ID: `realia:DyedCloth`); Small Shield (ID: `realia:SmallShield`); Grecian Juniper (ID: `flora:Juniper`); Graven Image (ID: `realia:GravenImage`); Spear (ID: `realia:Spear`); Whip (ID: `realia:Whip`); Horse (ID: `fauna:Horse`); Wagon (ID: `realia:Wagon`); Sheep (ID: `fauna:Lamb`); Strong Drink (ID: `realia:StrongDrink`); Grass (ID: `flora:Grass`); Train (ID: `realia:Train`); Yoke (ID: `realia:Yoke`)
