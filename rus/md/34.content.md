...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Наум (ID: `person:Nahum.2`); Елкосеянин (ID: `place:Elkosh`); The Way (ID: `keyterm:TheWay`); Кармил (ID: `place:Carmel`); Ниневия (ID: `place:Nineveh`); Zealous (ID: `keyterm:Zealous.3`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Ливан (ID: `place:Lebanon`); Strength (ID: `keyterm:Strength`); Utterance (ID: `keyterm:Utterance`); Васан (ID: `place:Bashan`); Pronounce Innocent (ID: `keyterm:PronounceInnocent`); Scroll (ID: `realia:Scroll`); Fortress (ID: `realia:Fortress`)
