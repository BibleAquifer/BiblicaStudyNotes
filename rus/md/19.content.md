...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Mighty (ID: `keyterm:Mighty`); Glory (ID: `keyterm:Glory`); Appoint (ID: `keyterm:Appoint`); Majesty (ID: `keyterm:Majesty`); Fish (ID: `fauna:Fish`); Flock (ID: `fauna:Flock`); Bird (ID: `fauna:Bird`); Cattle (ID: `fauna:Bull`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Trust (ID: `keyterm:LeanOn`); Lion (ID: `fauna:Lion`); Fear (ID: `keyterm:Fear`); Израиль (ID: `person:Israel`); Dog (ID: `fauna:Dog`); Strength (ID: `keyterm:Strength`); Holy (ID: `keyterm:Holy`); Lot (ID: `keyterm:Lot`); Poor (ID: `keyterm:Poor`); Васан (ID: `place:Bashan`); Force to Serve (ID: `keyterm:EnticedToServe`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Vow (ID: `keyterm:Vow`); Salvation (ID: `keyterm:Salvation`); Wild Ox (ID: `fauna:WildOx`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Worm (ID: `fauna:Maggot`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Psalm (ID: `keyterm:Psalm`); Kindness (ID: `keyterm:Kindness`); Fear (ID: `keyterm:Fear`); Давид (ID: `person:David`); Staff (ID: `realia:Staff`); Grass (ID: `flora:Grass`); House (ID: `realia:House`); Anointing Oil (ID: `realia:AnointingOil`); Green Vegetation (ID: `flora:GreenVegetation`); Olive Oil (ID: `realia:OliveOil`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Rod (ID: `realia:Rod`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** To Sin (ID: `keyterm:Sin`); LORD (ID: `deity:Lord`); Pure (ID: `keyterm:Pure`); Rebel (ID: `keyterm:Rebel`); Slaughtering (ID: `keyterm:Slaughtering`); Passion (ID: `keyterm:Ardour`); Offering (ID: `keyterm:Offering`); Forgive (ID: `keyterm:Forgive`); Salvation (ID: `keyterm:Salvation`); To Cleanse (ID: `keyterm:Cleanse.2`); Psalm (ID: `keyterm:Psalm`); Иерусалим (ID: `place:Jerusalem`); Ability (ID: `keyterm:Ability`); Delight (ID: `keyterm:Delight`); Truth (ID: `keyterm:Truth`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); The Way (ID: `keyterm:TheWay`); Давид (ID: `person:David`); Kindness (ID: `keyterm:Kindness`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Hyssop (ID: `flora:Hyssop`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); Cattle (ID: `fauna:Bull`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Innocence (ID: `keyterm:Innocence`); Likeness (ID: `keyterm:Semblance`); Perceive (ID: `keyterm:Perceive`); Glory (ID: `keyterm:Glory`); Refuge (ID: `keyterm:Refuge`); Израиль (ID: `person:Israel`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Psalm (ID: `keyterm:Psalm`); Counsel (ID: `keyterm:Counsel`); Be Zealous (ID: `keyterm:Zealous`); Complete (ID: `keyterm:Complete`); Асаф (ID: `person:Asaph.2`); Peace (ID: `keyterm:IntactState`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); Моисей (ID: `person:Moses`); Израиль (ID: `person:Israel`); Египет (ID: `place:Egypt`); To Cause to Possess (ID: `keyterm:Possess`); Хам (ID: `place:Ham.2`); Red Sea (ID: `place:RedSea`); Авраам (ID: `person:Abraham`); Kindness (ID: `keyterm:Kindness`); Covenant (ID: `keyterm:Covenant`); Plague (ID: `keyterm:Blow`); Аарона (ID: `person:Aaron`); Decree (ID: `keyterm:Decree`); Symbol (ID: `keyterm:Example`); Ханаан (ID: `place:Canaan`); Believe In (ID: `keyterm:BelieveIn`); Cattails (ID: `flora:Cattails`); Финеес (ID: `person:Phinehas`); To Make an Oath (ID: `keyterm:LiftUp`); Glory (ID: `keyterm:Glory`); Exempt (ID: `keyterm:Exempt`); Delight (ID: `keyterm:Delight`); Surely! (ID: `keyterm:Surely`); Have Insight (ID: `keyterm:HaveInsight`); Anointed (ID: `keyterm:Anointed`); Miraculous Sign (ID: `keyterm:MiraculousSign`); Redeem (ID: `keyterm:Redeem`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); To Act Wickedly (ID: `keyterm:ActWickedly`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Мелхиседек (ID: `person:Melchizedek`); Out of Free Will (ID: `keyterm:OutOfFreeWill`); Иерусалим (ID: `place:Jerusalem`); Swear (ID: `keyterm:Swear`); Psalm (ID: `keyterm:Psalm`); Давид (ID: `person:David`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** Иерусалим (ID: `place:Jerusalem`); Вавилон (ID: `place:Babylon`); LORD (ID: `deity:Lord`); A Group of People (ID: `group:GenericGroup`); Edomites (ID: `group:Edom`); Едом (ID: `place:Edom`); Poplar (ID: `flora:Poplar`); Lute (ID: `realia:Lute`); Willow (ID: `flora:Willow`); Foundation (ID: `realia:Foundation`)
