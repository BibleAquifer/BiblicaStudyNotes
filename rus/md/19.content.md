...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Anointed (ID: `keyterm:Anointed`); Have Insight (ID: `keyterm:HaveInsight`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Decree (ID: `keyterm:Decree`); Иерусалим (ID: `place:Jerusalem`); To Cause to Possess (ID: `keyterm:Possess`); Rope (ID: `realia:Rope`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Mighty (ID: `keyterm:Mighty`); Majesty (ID: `keyterm:Majesty`); Appoint (ID: `keyterm:Appoint`); Glory (ID: `keyterm:Glory`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Fish (ID: `fauna:Fish`); Cattle (ID: `fauna:Bull`); Bird (ID: `fauna:Bird`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Psalm (ID: `keyterm:Psalm`); Fear (ID: `keyterm:Fear`); Давид (ID: `person:David`); Kindness (ID: `keyterm:Kindness`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`); House (ID: `realia:House`); Green Vegetation (ID: `flora:GreenVegetation`); Flock (ID: `fauna:Flock`); Anointing Oil (ID: `realia:AnointingOil`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Grass (ID: `flora:Grass`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); To Sin (ID: `keyterm:Sin`); Pure (ID: `keyterm:Pure`); Slaughtering (ID: `keyterm:Slaughtering`); Rebel (ID: `keyterm:Rebel`); Passion (ID: `keyterm:Ardour`); Offering (ID: `keyterm:Offering`); Forgive (ID: `keyterm:Forgive`); Salvation (ID: `keyterm:Salvation`); To Cleanse (ID: `keyterm:Cleanse.2`); Psalm (ID: `keyterm:Psalm`); Kindness (ID: `keyterm:Kindness`); Давид (ID: `person:David`); Delight (ID: `keyterm:Delight`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); Иерусалим (ID: `place:Jerusalem`); The Way (ID: `keyterm:TheWay`); Truth (ID: `keyterm:Truth`); Ability (ID: `keyterm:Ability`); To Be Kindly Disposed (ID: `keyterm:KindlyDisposed`); Cattle (ID: `fauna:Bull`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Hyssop (ID: `flora:Hyssop`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Likeness (ID: `keyterm:Semblance`); Innocence (ID: `keyterm:Innocence`); Counsel (ID: `keyterm:Counsel`); Be Zealous (ID: `keyterm:Zealous`); Peace (ID: `keyterm:IntactState`); Complete (ID: `keyterm:Complete`); Perceive (ID: `keyterm:Perceive`); Асаф (ID: `person:Asaph.2`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Psalm (ID: `keyterm:Psalm`); Израиль (ID: `person:Israel`); Glory (ID: `keyterm:Glory`); Refuge (ID: `keyterm:Refuge`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Египет (ID: `place:Egypt`); Моисей (ID: `person:Moses`); Rebel (ID: `keyterm:Rebel`); Израиль (ID: `person:Israel`); To Cause to Possess (ID: `keyterm:Possess`); Kindness (ID: `keyterm:Kindness`); Авраам (ID: `person:Abraham`); Хам (ID: `place:Ham.2`); Covenant (ID: `keyterm:Covenant`); Red Sea (ID: `place:RedSea`); Plague (ID: `keyterm:Blow`); Аарона (ID: `person:Aaron`); Symbol (ID: `keyterm:Example`); Ханаан (ID: `place:Canaan`); Believe In (ID: `keyterm:BelieveIn`); Decree (ID: `keyterm:Decree`); Cattails (ID: `flora:Cattails`); Финеес (ID: `person:Phinehas`); To Make an Oath (ID: `keyterm:LiftUp`); To Act Wickedly (ID: `keyterm:ActWickedly`); Counsel (ID: `keyterm:Counsel`); Slaughtering (ID: `keyterm:Slaughtering`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Mount Sinai (ID: `place:SinaiMount`); Исаак (ID: `person:Isaac`); Oath (ID: `keyterm:Oath`); Bless (ID: `keyterm:Bless`); Дафан (ID: `person:Dathan`); Exempt (ID: `keyterm:Exempt`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Out of Free Will (ID: `keyterm:OutOfFreeWill`); Мелхиседек (ID: `person:Melchizedek`); Давид (ID: `person:David`); Swear (ID: `keyterm:Swear`); Psalm (ID: `keyterm:Psalm`); Иерусалим (ID: `place:Jerusalem`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Vow (ID: `keyterm:Vow`); Loyal Person (ID: `keyterm:LoyalPerson`); Hell (ID: `place:Hell`); Salvation (ID: `keyterm:Salvation`); Praise (ID: `keyterm:Praise`); Slaughtering (ID: `keyterm:Slaughtering`); Plea for Mercy (ID: `keyterm:Supplication`); Generous (ID: `keyterm:Generous`); Иерусалим (ID: `place:Jerusalem`); Simple Person (ID: `keyterm:SimplePerson`); Believe In (ID: `keyterm:BelieveIn`); Love (ID: `keyterm:Love`); House (ID: `realia:House`); Trap (ID: `realia:Trap`)
...
* **Associated ACAI Concepts:** Иерусалим (ID: `place:Jerusalem`); Вавилон (ID: `place:Babylon`); LORD (ID: `deity:Lord`); Едом (ID: `place:Edom`); A Group of People (ID: `group:GenericGroup`); Edomites (ID: `group:Edom`); Lute (ID: `realia:Lute`); Poplar (ID: `flora:Poplar`); Foundation (ID: `realia:Foundation`); Willow (ID: `flora:Willow`)
