...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Truth (ID: `keyterm:Truth`); Commandment (ID: `keyterm:Commandment`); LORD (ID: `deity:Lord`); Иисус (ID: `person:Jesus.2`); Live (ID: `keyterm:Live.3`); Chosen (ID: `keyterm:Chosen`); Cause of Joy (ID: `keyterm:CauseOfJoy`); Ability (ID: `keyterm:Ability`); Share (ID: `keyterm:Share`); Body (ID: `keyterm:Body.3`); Hope (ID: `keyterm:Hope`); Mercy (ID: `keyterm:Mercy`); Ask for (ID: `keyterm:AskFor`); Make Peace (ID: `keyterm:Peace`); Favor (ID: `keyterm:Favor`); Always (ID: `keyterm:Always`); Paper (ID: `realia:Paper`); Ink (ID: `realia:Ink`); House (ID: `realia:House`); Papyrus (ID: `flora:Papyrus`)
