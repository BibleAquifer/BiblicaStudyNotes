...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Моисей (ID: `person:Moses`); Иисус (ID: `person:Joshua.2`); Jordan River (ID: `place:Jordan`); House (ID: `realia:House`); Swear (ID: `keyterm:Swear`); Exempt (ID: `keyterm:Exempt`); Иерихон (ID: `place:Jericho`); Навин (ID: `person:Nun`); Spies (ID: `group:Spies`); Window (ID: `realia:Window`); Dispossess (ID: `keyterm:Dispossess`); Раав (ID: `person:Rahab`); Instruction (ID: `keyterm:Instruction`); Oath (ID: `keyterm:Oath`); Have Insight (ID: `keyterm:HaveInsight`); Truth (ID: `keyterm:Truth`); Kindness (ID: `keyterm:Kindness`); Израиль (ID: `person:Israel`); To Cause to Possess (ID: `keyterm:Possess`); Рувим (ID: `group:Reuben`); Ситтим (ID: `place:Shittim`); Terror (ID: `keyterm:Terror`); Mediterranean Sea (ID: `place:GreatSea`); Гад (ID: `person:Gad`); Rebel (ID: `keyterm:Rebel`); Amorites (ID: `group:Amorites`); Сигон (ID: `person:Sihon`); Hittites (ID: `group:Hittite`); Рувим (ID: `person:Reuben`); Евфрат (ID: `place:Euphrates`); Ог (ID: `person:Og`); Манассия (ID: `group:Manasseh`); Манассия (ID: `person:Manasseh`); Египет (ID: `place:Egypt`); Ливан (ID: `place:Lebanon`); Хет (ID: `person:Heth`); Red Sea (ID: `place:RedSea`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Thread (ID: `realia:Thread`); Scroll (ID: `realia:Scroll`); Rope (ID: `realia:Rope`); Flax (ID: `flora:Flax`); Cattails (ID: `flora:Cattails`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jordan River (ID: `place:Jordan`); Иисус (ID: `person:Joshua.2`); Израиль (ID: `person:Israel`); Covenant Box (ID: `keyterm:CovenantBox`); Covenant (ID: `keyterm:Covenant`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Complete (ID: `keyterm:Complete`); Circumcision (ID: `keyterm:Circumcision`); Gilgal (ID: `place:Gilgal.2`); Иерихон (ID: `place:Jericho`); Моисей (ID: `person:Moses`); Египет (ID: `place:Egypt`); Ханаан (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Passover (ID: `keyterm:Passover`); Amorites (ID: `group:Amorites`); Fear (ID: `keyterm:Fear`); Foreskin (ID: `keyterm:Foreskin`); Цартан (ID: `place:Zarethan`); Perizzites (ID: `group:Perizzites`); Адам (ID: `place:Adam`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Knife (ID: `realia:Knife`); Гад (ID: `person:Gad`); Dispossess (ID: `keyterm:Dispossess`); Левий (ID: `group:Levi`); море Солёное (ID: `place:SaltSea`); Рувим (ID: `group:Reuben`); Swear (ID: `keyterm:Swear`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Joshua.2`); LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Гай (ID: `place:Ai`); Covenant Box (ID: `keyterm:CovenantBox`); Ахан (ID: `person:Achan`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Иерихон (ID: `place:Jericho`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Rams Horn (ID: `realia:RamsHorn`); Bethel (ID: `place:Bethel`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Covenant (ID: `keyterm:Covenant`); Money (ID: `realia:Money`); Завдий (ID: `person:Zabdi`); Раав (ID: `person:Rahab`); Зерах (ID: `person:Zerah.3`); An Angel (ID: `deity:Angel`); Cattle (ID: `fauna:Bull`); Tent (ID: `realia:Tent`); Харми (ID: `person:Carmi.3`); долина Ахор (ID: `place:AchorValley`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); To Sin (ID: `keyterm:Sin`); Swear (ID: `keyterm:Swear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Set Apart for God (ID: `keyterm:Proscribe`)
...
* **Associated ACAI Concepts:** To Cause to Possess (ID: `keyterm:Possess`); LORD (ID: `deity:Lord`); Lot (ID: `keyterm:Lot`); Манассия (ID: `group:Manasseh`); Израиль (ID: `person:Israel`); Манассия (ID: `person:Manasseh`); Моисей (ID: `person:Moses`); Jordan River (ID: `place:Jordan`); Иисус (ID: `person:Joshua.2`); Иуда (ID: `group:Judah`); Иуда (ID: `person:Judah.4`); Ефрем (ID: `group:Ephraim`); Ефрем (ID: `person:Ephraim`); Левий (ID: `group:Levi`); Левий (ID: `person:Levi.3`); Dispossess (ID: `keyterm:Dispossess`); Иосиф (ID: `person:Joseph.10`); Халев (ID: `person:Caleb`); Ханаан (ID: `place:Canaan`); Рувим (ID: `person:Reuben`); Васан (ID: `place:Bashan`); Рувим (ID: `group:Reuben`); Асир (ID: `group:Asher`); Асир (ID: `person:Asher`); Галаад (ID: `place:Gilead`); Хеврон (ID: `place:Hebron`); Kiriath-jearim (ID: `place:Kiriath-jearim`); Refuge (ID: `keyterm:Refuge`); Canaanites (ID: `group:Canaan`); Гад (ID: `person:Gad`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Иисус (ID: `person:Joshua.2`); Force to Serve (ID: `keyterm:EnticedToServe`); Рувим (ID: `group:Reuben`); Гад (ID: `person:Gad`); Рувим (ID: `person:Reuben`); Манассия (ID: `group:Manasseh`); Манассия (ID: `person:Manasseh`); Jordan River (ID: `place:Jordan`); Моисей (ID: `person:Moses`); Египет (ID: `place:Egypt`); Ханаан (ID: `place:Canaan`); Rebel (ID: `keyterm:Rebel`); Dispossess (ID: `keyterm:Dispossess`); Финеес (ID: `person:Phinehas`); Amorites (ID: `group:Amorites`); Offering (ID: `keyterm:Offering`); Slaughtering (ID: `keyterm:Slaughtering`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); To Cause to Possess (ID: `keyterm:Possess`); Галаад (ID: `place:Gilead`); Be Unfaithful (ID: `keyterm:Unfaithful`); Bless (ID: `keyterm:Bless`); Елеазар (ID: `person:Eleazar.2`); Евфрат (ID: `place:Euphrates`); Шехем (ID: `place:Shechem`)
