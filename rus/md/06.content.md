...
* **Associated ACAI Concepts:** Spies (ID: `group:Spies`); Иисус (ID: `person:Joshua.2`); Window (ID: `realia:Window`); Exempt (ID: `keyterm:Exempt`); Раав (ID: `person:Rahab`); Dispossess (ID: `keyterm:Dispossess`); Ситтим (ID: `place:Shittim`); Mediterranean Sea (ID: `place:GreatSea`); Terror (ID: `keyterm:Terror`); Thread (ID: `realia:Thread`); Rope (ID: `realia:Rope`); Рувим (ID: `group:Reuben`); Scroll (ID: `realia:Scroll`); To Cause to Possess (ID: `keyterm:Possess`); Jordan River (ID: `place:Jordan`); Моисей (ID: `person:Moses`); House (ID: `realia:House`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jordan River (ID: `place:Jordan`); Circumcision (ID: `keyterm:Circumcision`); Адам (ID: `place:Adam`); Иерихон (ID: `place:Jericho`); Knife (ID: `realia:Knife`); Canaanites (ID: `group:Canaan`); Цартан (ID: `place:Zarethan`); Foreskin (ID: `keyterm:Foreskin`); Perizzites (ID: `group:Perizzites`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Gilgal (ID: `place:Gilgal.2`); Иисус (ID: `person:Joshua.2`); Covenant Box (ID: `keyterm:CovenantBox`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Complete (ID: `keyterm:Complete`); Covenant (ID: `keyterm:Covenant`); Израиль (ID: `person:Israel`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Ахан (ID: `person:Achan`); Гай (ID: `place:Ai`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Иисус (ID: `person:Joshua.2`); Завдий (ID: `person:Zabdi`); Иерихон (ID: `place:Jericho`); Rams Horn (ID: `realia:RamsHorn`); Севарим (ID: `place:Shebarim`); Раав (ID: `person:Rahab`); Харми (ID: `person:Carmi.3`); долина Ахор (ID: `place:AchorValley`); Sword (ID: `realia:Sword`); Javelin (ID: `realia:Javelin`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Clothing (ID: `realia:Clothing`); Zerahites (ID: `group:Zerah`); Beth-aven (ID: `place:Beth-aven`); Set Apart for God (ID: `keyterm:Proscribe`); Covenant Box (ID: `keyterm:CovenantBox`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Money (ID: `realia:Money`); Израиль (ID: `person:Israel`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Македа (ID: `place:Makkedah`); Еглон (ID: `place:Eglon`); Асор (ID: `place:Hazor`); Иармуф (ID: `place:Jarmuth`); Libnah (ID: `place:Libnah.2`); Мадон (ID: `place:Madon`); Valley of Mizpeh (ID: `place:MizpehValley`); Mount Halak (ID: `place:HalakMount`); Valley of Lebanon (ID: `place:LebanonValley`); Adoni-zedek (ID: `person:Adoni-zedek`); Waters of Merom (ID: `place:Merom`); Девир (ID: `place:Debir`); Иафиа (ID: `person:Japhia`); Иавин (ID: `person:Jabin`); Горам (ID: `person:Horam`); Гогам (ID: `person:Hoham`); Шарон (ID: `place:Lasharon`); Фирам (ID: `person:Piram`); Девир (ID: `person:Debir`); Иовав (ID: `person:Jobab.3`); Ахсафскому (ID: `place:Achshaph`); Шимрон (ID: `place:Shimron`); юг (ID: `place:Negeb`); Дор (ID: `place:Dor`); To Cause to Possess (ID: `keyterm:Possess`); Азека (ID: `place:Azekah`); Аcтароф (ID: `place:Ashtaroth`); Mount Ebal (ID: `place:EbalMount`); Анав (ID: `place:Anab`); Хефер (ID: `place:Hepher`)
...
* **Associated ACAI Concepts:** Beth-hoglah (ID: `place:Beth-hoglah`); Беф-Арава (ID: `place:Beth-arabah`); Lot (ID: `keyterm:Lot`); Иефунни (ID: `person:Jephunneh`); Енак (ID: `person:Anak`); Халев (ID: `person:Caleb`); Kiriath-jearim (ID: `place:Kiriath-jearim`); Екрон (ID: `place:Ekron`); To Cause to Possess (ID: `keyterm:Possess`); Refuge (ID: `keyterm:Refuge`); Симеон (ID: `group:Simeon`); Таппуах (ID: `place:Tappuah`); Хамаф (ID: `place:Hammath`); возвышенности Адуммима (ID: `place:Adummim`); Kanah (ID: `place:Kanah.2`); Eltekeh (ID: `place:Eltekeh`); Михмефаф (ID: `place:Michmethath`); Ataroth-addar (ID: `place:Ataroth-addar`); Боган (ID: `person:Bohan`); Mount Ephron (ID: `place:EphronMount`); Юта (ID: `place:Juttah`); Ашна (ID: `place:Ashnah`); Ефер (ID: `place:Ether`); Сарид (ID: `place:Sarid`); Атароф (ID: `place:Ataroth.2`); Waters of Nephtoah (ID: `place:Nephtoah`); Valley of Iphtahel (ID: `place:IphtahelValley`); Неа (ID: `place:Neah`); Janoah (ID: `place:Janoah.2`); En-shemesh (ID: `place:En-shemesh`)
...
* **Associated ACAI Concepts:** Финеес (ID: `person:Phinehas`); Иисус (ID: `person:Joshua.2`); Dispossess (ID: `keyterm:Dispossess`); Шехем (ID: `place:Shechem`); Timnath-heres (ID: `place:Timnath-heres`); Piece of Money (ID: `realia:PieceOfMoney`); Гааш (ID: `place:Gaash`); Сепфор (ID: `person:Zippor`); Нахор (ID: `person:Nahor`); Фарра (ID: `person:Terah`); Hivites (ID: `group:Hivites`); Навин (ID: `person:Nun`); Валак (ID: `person:Balak`); Gibeah (ID: `place:Gibeah.2`); Trap (ID: `realia:Trap`); The Way (ID: `keyterm:TheWay`); Гад (ID: `person:Gad`); Рувим (ID: `group:Reuben`); Рувим (ID: `person:Reuben`); Манассия (ID: `group:Manasseh`); Манассия (ID: `person:Manasseh`); Force to Serve (ID: `keyterm:EnticedToServe`); Amorites (ID: `group:Amorites`); Jordan River (ID: `place:Jordan`); Ханаан (ID: `place:Canaan`); Slaughtering (ID: `keyterm:Slaughtering`); Rebel (ID: `keyterm:Rebel`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`)
