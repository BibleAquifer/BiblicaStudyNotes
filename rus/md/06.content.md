...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Моисей (ID: `person:Moses`); Иисус (ID: `person:Joshua.2`); Jordan River (ID: `place:Jordan`); House (ID: `realia:House`); Swear (ID: `keyterm:Swear`); Exempt (ID: `keyterm:Exempt`); Навин (ID: `person:Nun`); Иерихон (ID: `place:Jericho`); Spies (ID: `group:Spies`); Window (ID: `realia:Window`); Раав (ID: `person:Rahab`); Dispossess (ID: `keyterm:Dispossess`); Have Insight (ID: `keyterm:HaveInsight`); Truth (ID: `keyterm:Truth`); Oath (ID: `keyterm:Oath`); Instruction (ID: `keyterm:Instruction`); Kindness (ID: `keyterm:Kindness`); Израиль (ID: `person:Israel`); To Cause to Possess (ID: `keyterm:Possess`); Mediterranean Sea (ID: `place:GreatSea`); Ситтим (ID: `place:Shittim`); Рувим (ID: `group:Reuben`); Terror (ID: `keyterm:Terror`); Rebel (ID: `keyterm:Rebel`); Гад (ID: `person:Gad`); Манассия (ID: `person:Manasseh`); Рувим (ID: `person:Reuben`); Amorites (ID: `group:Amorites`); Хет (ID: `person:Heth`); Ог (ID: `person:Og`); Сигон (ID: `person:Sihon`); Red Sea (ID: `place:RedSea`); Евфрат (ID: `place:Euphrates`); Манассия (ID: `group:Manasseh`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Hittites (ID: `group:Hittite`); Египет (ID: `place:Egypt`); Ливан (ID: `place:Lebanon`); Thread (ID: `realia:Thread`); Scroll (ID: `realia:Scroll`); Rope (ID: `realia:Rope`); Cattails (ID: `flora:Cattails`); Flax (ID: `flora:Flax`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jordan River (ID: `place:Jordan`); Иисус (ID: `person:Joshua.2`); Израиль (ID: `person:Israel`); Covenant Box (ID: `keyterm:CovenantBox`); Covenant (ID: `keyterm:Covenant`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Complete (ID: `keyterm:Complete`); Circumcision (ID: `keyterm:Circumcision`); Gilgal (ID: `place:Gilgal.2`); Иерихон (ID: `place:Jericho`); Моисей (ID: `person:Moses`); Египет (ID: `place:Egypt`); Ханаан (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Amorites (ID: `group:Amorites`); Fear (ID: `keyterm:Fear`); Passover (ID: `keyterm:Passover`); Perizzites (ID: `group:Perizzites`); Foreskin (ID: `keyterm:Foreskin`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Цартан (ID: `place:Zarethan`); Адам (ID: `place:Adam`); Knife (ID: `realia:Knife`); Гад (ID: `person:Gad`); Holy (ID: `keyterm:Holy`); Манассия (ID: `person:Manasseh`); Jebusites (ID: `group:Jebusites`); Dispossess (ID: `keyterm:Dispossess`); Land Flowing of Milk and Honey (ID: `keyterm:LandFlowingOfMilkAndHoney`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Joshua.2`); LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Гай (ID: `place:Ai`); Covenant Box (ID: `keyterm:CovenantBox`); Ахан (ID: `person:Achan`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Иерихон (ID: `place:Jericho`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Rams Horn (ID: `realia:RamsHorn`); Иуда (ID: `person:Judah.4`); Bethel (ID: `place:Bethel`); Covenant (ID: `keyterm:Covenant`); Иуда (ID: `group:Judah`); Money (ID: `realia:Money`); Завдий (ID: `person:Zabdi`); Раав (ID: `person:Rahab`); Зерах (ID: `person:Zerah.3`); An Angel (ID: `deity:Angel`); Tent (ID: `realia:Tent`); Cattle (ID: `fauna:Bull`); Харми (ID: `person:Carmi.3`); долина Ахор (ID: `place:AchorValley`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); To Sin (ID: `keyterm:Sin`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Swear (ID: `keyterm:Swear`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Set Apart for God (ID: `keyterm:Proscribe`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Joshua.2`); Израиль (ID: `person:Israel`); LORD (ID: `deity:Lord`); Гаваон (ID: `place:Gibeon`); Моисей (ID: `person:Moses`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Лахис (ID: `place:Lachish`); Amorites (ID: `group:Amorites`); Македа (ID: `place:Makkedah`); Еглон (ID: `place:Eglon`); Хеврон (ID: `place:Hebron`); Gilgal (ID: `place:Gilgal.2`); Covenant (ID: `keyterm:Covenant`); Асор (ID: `place:Hazor`); Libnah (ID: `place:Libnah.2`); Shephelah (ID: `place:Shephelah`); Mount Hermon (ID: `place:HermonMount`); Fear (ID: `keyterm:Fear`); Hivites (ID: `group:Hivites`); Иерусалим (ID: `place:Jerusalem`); Иерихон (ID: `place:Jericho`); Arabah (ID: `place:Arabah`); Sword (ID: `realia:Sword`); Девир (ID: `place:Debir`); Иармуф (ID: `place:Jarmuth`); Гай (ID: `place:Ai`); Swear (ID: `keyterm:Swear`); Jordan River (ID: `place:Jordan`); юг (ID: `place:Negeb`); To Cause to Possess (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** To Cause to Possess (ID: `keyterm:Possess`); LORD (ID: `deity:Lord`); Lot (ID: `keyterm:Lot`); Израиль (ID: `person:Israel`); Манассия (ID: `person:Manasseh`); Манассия (ID: `group:Manasseh`); Моисей (ID: `person:Moses`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Jordan River (ID: `place:Jordan`); Иисус (ID: `person:Joshua.2`); Ефрем (ID: `person:Ephraim`); Ефрем (ID: `group:Ephraim`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Dispossess (ID: `keyterm:Dispossess`); Иосиф (ID: `person:Joseph.10`); Халев (ID: `person:Caleb`); Рувим (ID: `person:Reuben`); Васан (ID: `place:Bashan`); Рувим (ID: `group:Reuben`); Ханаан (ID: `place:Canaan`); Галаад (ID: `place:Gilead`); Хеврон (ID: `place:Hebron`); Асир (ID: `person:Asher`); Асир (ID: `group:Asher`); Kiriath-jearim (ID: `place:Kiriath-jearim`); Refuge (ID: `keyterm:Refuge`); Canaanites (ID: `group:Canaan`); Гад (ID: `person:Gad`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Иисус (ID: `person:Joshua.2`); Force to Serve (ID: `keyterm:EnticedToServe`); Рувим (ID: `person:Reuben`); Рувим (ID: `group:Reuben`); Гад (ID: `person:Gad`); Манассия (ID: `group:Manasseh`); Манассия (ID: `person:Manasseh`); Jordan River (ID: `place:Jordan`); Моисей (ID: `person:Moses`); Египет (ID: `place:Egypt`); Ханаан (ID: `place:Canaan`); Rebel (ID: `keyterm:Rebel`); Dispossess (ID: `keyterm:Dispossess`); Финеес (ID: `person:Phinehas`); Offering (ID: `keyterm:Offering`); Amorites (ID: `group:Amorites`); Slaughtering (ID: `keyterm:Slaughtering`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Stone Altar (ID: `realia:StoneAltar`); To Cause to Possess (ID: `keyterm:Possess`); Галаад (ID: `place:Gilead`); Елеазар (ID: `person:Eleazar.2`); Be Unfaithful (ID: `keyterm:Unfaithful`); Bless (ID: `keyterm:Bless`); Евфрат (ID: `place:Euphrates`); Шехем (ID: `place:Shechem`)
