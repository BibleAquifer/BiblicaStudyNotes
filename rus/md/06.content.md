...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Моисей (ID: `person:Moses`); Иисус (ID: `person:Joshua.2`); Jordan River (ID: `place:Jordan`); House (ID: `realia:House`); Swear (ID: `keyterm:Swear`); Exempt (ID: `keyterm:Exempt`); Навин (ID: `person:Nun`); Иерихон (ID: `place:Jericho`); Spies (ID: `group:Spies`); Window (ID: `realia:Window`); Dispossess (ID: `keyterm:Dispossess`); Раав (ID: `person:Rahab`); Instruction (ID: `keyterm:Instruction`); Have Insight (ID: `keyterm:HaveInsight`); Израиль (ID: `person:Israel`); Kindness (ID: `keyterm:Kindness`); Truth (ID: `keyterm:Truth`); Oath (ID: `keyterm:Oath`); Ситтим (ID: `place:Shittim`); Mediterranean Sea (ID: `place:GreatSea`); Рувим (ID: `group:Reuben`); Terror (ID: `keyterm:Terror`); To Cause to Possess (ID: `keyterm:Possess`); Ливан (ID: `place:Lebanon`); Манассия (ID: `person:Manasseh`); Rebel (ID: `keyterm:Rebel`); Манассия (ID: `group:Manasseh`); Хет (ID: `person:Heth`); Ог (ID: `person:Og`); Red Sea (ID: `place:RedSea`); Гад (ID: `person:Gad`); Сигон (ID: `person:Sihon`); Египет (ID: `place:Egypt`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Рувим (ID: `person:Reuben`); Amorites (ID: `group:Amorites`); Евфрат (ID: `place:Euphrates`); Hittites (ID: `group:Hittite`); Rope (ID: `realia:Rope`); Thread (ID: `realia:Thread`); Scroll (ID: `realia:Scroll`); Cattails (ID: `flora:Cattails`); Flax (ID: `flora:Flax`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jordan River (ID: `place:Jordan`); Иисус (ID: `person:Joshua.2`); Израиль (ID: `person:Israel`); Covenant Box (ID: `keyterm:CovenantBox`); Covenant (ID: `keyterm:Covenant`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Complete (ID: `keyterm:Complete`); Circumcision (ID: `keyterm:Circumcision`); Gilgal (ID: `place:Gilgal.2`); Иерихон (ID: `place:Jericho`); Египет (ID: `place:Egypt`); Моисей (ID: `person:Moses`); Ханаан (ID: `place:Canaan`); Canaanites (ID: `group:Canaan`); Passover (ID: `keyterm:Passover`); Amorites (ID: `group:Amorites`); Fear (ID: `keyterm:Fear`); Uncircumcised Person (ID: `keyterm:UncircumcisedPerson`); Цартан (ID: `place:Zarethan`); Адам (ID: `place:Adam`); Foreskin (ID: `keyterm:Foreskin`); Perizzites (ID: `group:Perizzites`); Knife (ID: `realia:Knife`); Левий (ID: `person:Levi.3`); Hivites (ID: `group:Hivites`); Dispossess (ID: `keyterm:Dispossess`); Ситтим (ID: `place:Shittim`); Левий (ID: `group:Levi`); Jebusites (ID: `group:Jebusites`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Joshua.2`); LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Гай (ID: `place:Ai`); Covenant Box (ID: `keyterm:CovenantBox`); Ахан (ID: `person:Achan`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Иерихон (ID: `place:Jericho`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Rams Horn (ID: `realia:RamsHorn`); Иуда (ID: `person:Judah.4`); Иуда (ID: `group:Judah`); Bethel (ID: `place:Bethel`); Covenant (ID: `keyterm:Covenant`); Money (ID: `realia:Money`); Завдий (ID: `person:Zabdi`); Раав (ID: `person:Rahab`); Зерах (ID: `person:Zerah.3`); An Angel (ID: `deity:Angel`); Tent (ID: `realia:Tent`); Cattle (ID: `fauna:Bull`); Харми (ID: `person:Carmi.3`); долина Ахор (ID: `place:AchorValley`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); To Sin (ID: `keyterm:Sin`); Swear (ID: `keyterm:Swear`); Sword (ID: `realia:Sword`); House (ID: `realia:House`); Set Apart for God (ID: `keyterm:Proscribe`)
...
* **Associated ACAI Concepts:** Иисус (ID: `person:Joshua.2`); Израиль (ID: `person:Israel`); LORD (ID: `deity:Lord`); Гаваон (ID: `place:Gibeon`); Моисей (ID: `person:Moses`); Set Apart for Destruction (ID: `keyterm:Proscribe.2`); Лахис (ID: `place:Lachish`); Amorites (ID: `group:Amorites`); Македа (ID: `place:Makkedah`); Еглон (ID: `place:Eglon`); Хеврон (ID: `place:Hebron`); Covenant (ID: `keyterm:Covenant`); Gilgal (ID: `place:Gilgal.2`); Асор (ID: `place:Hazor`); Libnah (ID: `place:Libnah.2`); Mount Hermon (ID: `place:HermonMount`); Shephelah (ID: `place:Shephelah`); Hivites (ID: `group:Hivites`); Иерихон (ID: `place:Jericho`); Arabah (ID: `place:Arabah`); Fear (ID: `keyterm:Fear`); Иерусалим (ID: `place:Jerusalem`); Sword (ID: `realia:Sword`); Девир (ID: `place:Debir`); Иармуф (ID: `place:Jarmuth`); Swear (ID: `keyterm:Swear`); Гай (ID: `place:Ai`); Jordan River (ID: `place:Jordan`); юг (ID: `place:Negeb`); To Cause to Possess (ID: `keyterm:Possess`)
...
* **Associated ACAI Concepts:** To Cause to Possess (ID: `keyterm:Possess`); LORD (ID: `deity:Lord`); Lot (ID: `keyterm:Lot`); Манассия (ID: `person:Manasseh`); Израиль (ID: `person:Israel`); Манассия (ID: `group:Manasseh`); Моисей (ID: `person:Moses`); Иуда (ID: `person:Judah.4`); Иисус (ID: `person:Joshua.2`); Jordan River (ID: `place:Jordan`); Иуда (ID: `group:Judah`); Ефрем (ID: `person:Ephraim`); Ефрем (ID: `group:Ephraim`); Левий (ID: `person:Levi.3`); Левий (ID: `group:Levi`); Dispossess (ID: `keyterm:Dispossess`); Иосиф (ID: `person:Joseph.10`); Халев (ID: `person:Caleb`); Ханаан (ID: `place:Canaan`); Васан (ID: `place:Bashan`); Рувим (ID: `person:Reuben`); Рувим (ID: `group:Reuben`); Хеврон (ID: `place:Hebron`); Асир (ID: `person:Asher`); Галаад (ID: `place:Gilead`); Асир (ID: `group:Asher`); Kiriath-jearim (ID: `place:Kiriath-jearim`); Refuge (ID: `keyterm:Refuge`); Canaanites (ID: `group:Canaan`); Гад (ID: `person:Gad`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Израиль (ID: `person:Israel`); Иисус (ID: `person:Joshua.2`); Force to Serve (ID: `keyterm:EnticedToServe`); Рувим (ID: `group:Reuben`); Рувим (ID: `person:Reuben`); Гад (ID: `person:Gad`); Манассия (ID: `group:Manasseh`); Манассия (ID: `person:Manasseh`); Jordan River (ID: `place:Jordan`); Египет (ID: `place:Egypt`); Моисей (ID: `person:Moses`); Ханаан (ID: `place:Canaan`); Rebel (ID: `keyterm:Rebel`); Dispossess (ID: `keyterm:Dispossess`); Финеес (ID: `person:Phinehas`); Slaughtering (ID: `keyterm:Slaughtering`); Offering (ID: `keyterm:Offering`); Amorites (ID: `group:Amorites`); Temple Altar (ID: `realia:TempleAltar`); Stone Altar (ID: `realia:StoneAltar`); Altar (ID: `realia:Altar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); To Cause to Possess (ID: `keyterm:Possess`); Елеазар (ID: `person:Eleazar.2`); Евфрат (ID: `place:Euphrates`); Bless (ID: `keyterm:Bless`); Галаад (ID: `place:Gilead`); Be Unfaithful (ID: `keyterm:Unfaithful`); Шехем (ID: `place:Shechem`)
