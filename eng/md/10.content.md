...
* **Associated ACAI Concepts:** David (ID: `person:David`); LORD (ID: `deity:Lord`); Abner (ID: `person:Abner`); Saul (ID: `person:Saul.2`); Israel (ID: `person:Israel`); Hebron (ID: `place:Hebron`); Joab (ID: `person:Joab`); Ish-bosheth (ID: `person:Ish-bosheth`); Covenant Box (ID: `keyterm:CovenantBox`); Asahel (ID: `person:Asahel`); Jonathan (ID: `person:Jonathan.3`); Tribe of Judah (ID: `group:Judah`); Philistines (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); Judah (ID: `person:Judah.4`); Ner (ID: `person:Ner.2`); Michal (ID: `person:Michal`); Gibeon (ID: `place:Gibeon`); Tribe of Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`); Jerusalem (ID: `place:Jerusalem`); Bless (ID: `keyterm:Bless`); An Angel (ID: `deity:Angel`); Smear (ID: `keyterm:Smear`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); House (ID: `realia:House`); Baanah (ID: `person:Baanah`); Rechab (ID: `person:Rechab`); Uzzah (ID: `person:Uzzah`); Beeroth (ID: `place:Beeroth`)
...
* **Associated ACAI Concepts:** David (ID: `person:David`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Syrians (ID: `group:Syria`); Ammonites (ID: `group:Ammon`); Ammon (ID: `place:Ammon`); Hadadezer (ID: `person:Hadadezer`); Ziba (ID: `person:Ziba`); Saul (ID: `person:Saul.2`); Zobah (ID: `place:Zobah`); Joab (ID: `person:Joab`); Mephibosheth (ID: `person:Mephibosheth`); Kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Hanun (ID: `person:Hanun`); Nathan (ID: `person:Nathan.2`); Jonathan (ID: `person:Jonathan.3`); Fear (ID: `keyterm:Fear`); Edom (ID: `place:Edom`); Jerusalem (ID: `place:Jerusalem`); Rehob (ID: `person:Rehob`); Shobach (ID: `person:Shobach`); Beth-rehob (ID: `place:Beth-rehob`); Toi (ID: `person:Toi`); Ammiel (ID: `person:Ammiel.2`); Machir (ID: `person:Machir.2`); People of Tob (ID: `group:Tob`); Moab (ID: `place:Moab`); Lo-debar (ID: `place:Lo-debar`); Tob (ID: `place:Tob`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); David (ID: `person:David`); Israel (ID: `person:Israel`); Philistines (ID: `group:Philistine`); Philistia (ID: `place:Philistine`); Saul (ID: `person:Saul.2`); Ornan (ID: `person:Ornan`); Salvation (ID: `keyterm:Salvation`); Joab (ID: `person:Joab`); Gad (ID: `person:Gad.2`); Gibeon (ID: `place:Gibeon`); Bethlehem (ID: `place:Bethlehem`); Gibeonites (ID: `group:Gibeon`); Rapha (ID: `person:Rapha`); Tribe of Judah (ID: `group:Judah`); Jonathan (ID: `person:Jonathan.3`); Complete (ID: `keyterm:Complete`); Judah (ID: `person:Judah.4`); Rizpah (ID: `person:Rizpah`); Aiah (ID: `person:Aiah.2`); Offering (ID: `keyterm:Offering`); Zeruiah (ID: `person:Zeruiah`); Gath (ID: `place:Gath`); Dan (ID: `place:Dan`); Tribe of Dan (ID: `group:Dan`); Beersheba (ID: `place:Beersheba`); Shield (ID: `keyterm:Shield`); Threshing Floor (ID: `realia:ThreshingFloor`); Spear (ID: `realia:Spear`); Benaiah (ID: `person:Benaiah`)
