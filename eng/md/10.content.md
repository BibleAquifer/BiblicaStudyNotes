...
* **Associated ACAI Concepts:** David (ID: `person:David`); LORD (ID: `deity:Lord`); Abner (ID: `person:Abner`); Saul (ID: `person:Saul.2`); Israel (ID: `person:Israel`); Hebron (ID: `place:Hebron`); Joab (ID: `person:Joab`); Ish-bosheth (ID: `person:Ish-bosheth`); Covenant Box (ID: `keyterm:CovenantBox`); Asahel (ID: `person:Asahel`); Jonathan (ID: `person:Jonathan.3`); Philistia (ID: `place:Philistine`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Philistines (ID: `group:Philistine`); Ner (ID: `person:Ner.2`); Michal (ID: `person:Michal`); Gibeon (ID: `place:Gibeon`); Tribe of Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`); Jerusalem (ID: `place:Jerusalem`); Smear (ID: `keyterm:Smear`); An Angel (ID: `deity:Angel`); Bless (ID: `keyterm:Bless`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); House (ID: `realia:House`); Baanah (ID: `person:Baanah`); Rechab (ID: `person:Rechab`); Uzzah (ID: `person:Uzzah`); Beeroth (ID: `place:Beeroth`)
...
* **Associated ACAI Concepts:** David (ID: `person:David`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Syrians (ID: `group:Syria`); Ammon (ID: `place:Ammon`); Ammonites (ID: `group:Ammon`); Hadadezer (ID: `person:Hadadezer`); Ziba (ID: `person:Ziba`); Saul (ID: `person:Saul.2`); Mephibosheth (ID: `person:Mephibosheth`); Zobah (ID: `place:Zobah`); Joab (ID: `person:Joab`); Kindness (ID: `keyterm:Kindness`); House (ID: `realia:House`); Hanun (ID: `person:Hanun`); Nathan (ID: `person:Nathan.2`); Jonathan (ID: `person:Jonathan.3`); Jerusalem (ID: `place:Jerusalem`); Fear (ID: `keyterm:Fear`); Edom (ID: `place:Edom`); Shobach (ID: `person:Shobach`); Machir (ID: `person:Machir.2`); Beth-rehob (ID: `place:Beth-rehob`); Toi (ID: `person:Toi`); People of Tob (ID: `group:Tob`); Ammiel (ID: `person:Ammiel.2`); Rehob (ID: `person:Rehob`); Maacah (ID: `place:Maacah`); Moab (ID: `place:Moab`); Helam (ID: `place:Helam`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); David (ID: `person:David`); Israel (ID: `person:Israel`); Philistia (ID: `place:Philistine`); Philistines (ID: `group:Philistine`); Saul (ID: `person:Saul.2`); Ornan (ID: `person:Ornan`); Salvation (ID: `keyterm:Salvation`); Joab (ID: `person:Joab`); Gad (ID: `person:Gad.2`); Bethlehem (ID: `place:Bethlehem`); Gibeon (ID: `place:Gibeon`); Gibeonites (ID: `group:Gibeon`); Rapha (ID: `person:Rapha`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Jonathan (ID: `person:Jonathan.3`); Complete (ID: `keyterm:Complete`); Rizpah (ID: `person:Rizpah`); Aiah (ID: `person:Aiah.2`); Tribe of Dan (ID: `group:Dan`); Offering (ID: `keyterm:Offering`); Beersheba (ID: `place:Beersheba`); Dan (ID: `place:Dan`); Gath (ID: `place:Gath`); Zeruiah (ID: `person:Zeruiah`); Shield (ID: `keyterm:Shield`); Threshing Floor (ID: `realia:ThreshingFloor`); Spear (ID: `realia:Spear`); Ahohites (ID: `group:Ahoah`)
