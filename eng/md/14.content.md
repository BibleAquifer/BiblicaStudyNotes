...
* **Associated ACAI Concepts:** Rehoboam (ID: `person:Rehoboam`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Jerusalem (ID: `place:Jerusalem`); Jeroboam (ID: `person:Jeroboam`); Solomon (ID: `person:Solomon`); David (ID: `person:David`); Tribe of Benjamin (ID: `group:Benjamin`); Benjamin (ID: `person:Benjamin`); Shemaiah (ID: `person:Shemaiah`); Fortification (ID: `realia:Fortification`); Shishak (ID: `person:Shishak`); Egypt (ID: `place:Egypt`); Yoke (ID: `realia:Yoke`); Maacah (ID: `person:Maacah.3`); Abijah (ID: `person:Abijah.4`); Counsel (ID: `keyterm:Counsel`); House (ID: `realia:House`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Jesse (ID: `person:Jesse`); Work (ID: `keyterm:Work`); Nebat (ID: `person:Nebat`); Absalom (ID: `person:Absalom`); Zaham (ID: `person:Zaham`); Jeush (ID: `person:Jeush.5`); Sukkiim (ID: `group:Sukkiim`)
...
* **Associated ACAI Concepts:** Abijah (ID: `person:Abijah.4`); LORD (ID: `deity:Lord`); Jeroboam (ID: `person:Jeroboam`); Israel (ID: `person:Israel`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); David (ID: `person:David`); Tribe of Levi (ID: `group:Levi`); Aaron (ID: `person:Aaron`); Solomon (ID: `person:Solomon`); Levi (ID: `person:Levi.3`); Ephraim (ID: `person:Ephraim`); Cattle (ID: `fauna:Bull`); Trumpet (ID: `realia:Trumpet`); Gibeah (ID: `place:Gibeah`); Uriel (ID: `person:Uriel.3`); Jeshanah (ID: `place:Jeshanah`); Iddo (ID: `person:Iddo.5`); Rebel (ID: `keyterm:Rebel`); Wickedness (ID: `keyterm:Wickedness`); Strength (ID: `keyterm:Strength`); Maacah (ID: `person:Maacah.3`); Nebat (ID: `person:Nebat`); Bethel (ID: `place:Bethel`); Pure (ID: `keyterm:Pure`); Rehoboam (ID: `person:Rehoboam`); Jerusalem (ID: `place:Jerusalem`); Asa (ID: `person:Asa`); Tribe of Ephraim (ID: `group:Ephraim`); Zemaraim (ID: `place:Zemaraim`); Covenant (ID: `keyterm:Covenant`); Offering (ID: `keyterm:Offering`); Bread of Display (ID: `realia:BreadOfDisplay`); Molten Image (ID: `realia:MoltenImage`); Lamp (ID: `realia:Lamp`); Sheep (ID: `fauna:Lamb`); Lampstand (ID: `realia:Lampstand.2`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Asa (ID: `person:Asa`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Ethiopia (ID: `place:Ethiopia`); Baasha (ID: `person:Baasha`); Tribe of Benjamin (ID: `group:Benjamin`); Ethiopians (ID: `group:Ethiopia`); Benjamin (ID: `person:Benjamin`); Ramah (ID: `place:Ramah.2`); Oded (ID: `person:Oded`); Swear (ID: `keyterm:Swear`); Mareshah (ID: `place:Mareshah`); Instruction (ID: `keyterm:Instruction`); Gerar (ID: `place:Gerar`); Jerusalem (ID: `place:Jerusalem`); Tribe of Ephraim (ID: `group:Ephraim`); Asherah (ID: `deity:Asherah`); Covenant (ID: `keyterm:Covenant`); Ben-hadad (ID: `person:Ben-hadad`); Ephraim (ID: `person:Ephraim`); House (ID: `realia:House`); High Place (ID: `realia:HighPlace`); Stone Pine (ID: `flora:Pine`); Money (ID: `realia:Money`); Hanani (ID: `person:Hanani`); Zerah (ID: `person:Zerah.5`); Azariah (ID: `person:Azariah.8`); Valley of Zephathah (ID: `place:ZephathahValley`); Kidron (ID: `place:Kidron`); Abel-beth-maacah (ID: `place:Abel-beth-maacah`); Ijon (ID: `place:Ijon`); Geba (ID: `place:Geba`); Oath (ID: `keyterm:Oath`); Damascus (ID: `place:Damascus`); Strength (ID: `keyterm:Strength`); Maacah (ID: `person:Maacah.3`); Truth (ID: `keyterm:Truth`); Tribe of Manasseh (ID: `group:Manasseh`); Peace (ID: `keyterm:IntactState`); Manasseh (ID: `person:Manasseh`); Simeon (ID: `person:Simeon.5`); Detested Thing (ID: `keyterm:DetestedThing`); Dan (ID: `place:Dan`); Delight (ID: `keyterm:Delight`); Tribe of Simeon (ID: `group:Simeon`); David (ID: `person:David`); Naphtali (ID: `person:Naphtali`); Mizpah (ID: `place:Mizpah`); Tribe of Dan (ID: `group:Dan`); Libya (ID: `place:Libya`); Tribe of Naphtali (ID: `group:Naphtali`); Stone Altar (ID: `realia:StoneAltar`); Goat (ID: `fauna:Goat`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Temple Altar (ID: `realia:TempleAltar`); Chariot (ID: `realia:Chariot`); Flock (ID: `fauna:Flock`); Bed (ID: `realia:Bed`); Fortification (ID: `realia:Fortification`); Rams Horn (ID: `realia:RamsHorn`); Image (ID: `realia:Image`); Bow (ID: `realia:Bow`); Cattle (ID: `fauna:Bull`); Large Shield (ID: `realia:LargeShield`); Camel (ID: `fauna:Camel`); Small Shield (ID: `realia:SmallShield`); Sacred Pole (ID: `realia:SacredPole`); Balsam Tree (ID: `flora:BalsamTree`); Trumpet (ID: `realia:Trumpet`); Spear (ID: `realia:Spear`); Tent (ID: `realia:Tent`); Sacred Pillar (ID: `realia:SacredPillar`); Tower (ID: `realia:Tower`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jehoshaphat (ID: `person:Jehoshaphat.3`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Jerusalem (ID: `place:Jerusalem`); Micaiah (ID: `person:Micaiah.5`); Ramoth-gilead (ID: `place:Ramoth-gilead`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Speak as a Prophet (ID: `keyterm:Speak`); Moab (ID: `place:Moab`); Ammon (ID: `place:Ammon`); Fear (ID: `keyterm:Fear`); Ahab (ID: `person:Ahab`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Chariot (ID: `realia:Chariot`); Mount Seir (ID: `place:SeirMount`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Chenaanah (ID: `person:Chenaanah`); Imlah (ID: `person:Imlah`); Ahaziah (ID: `person:Ahaziah`); Hanani (ID: `person:Hanani`); Jehu (ID: `person:Jehu`); Strength (ID: `keyterm:Strength`); Zedekiah (ID: `person:Zedekiah.2`); Instruction (ID: `keyterm:Instruction`); Jehoram (ID: `person:Jehoram`); Asherah (ID: `deity:Asherah`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jehoiada (ID: `person:Jehoiada.2`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); House (ID: `realia:House`); Jerusalem (ID: `place:Jerusalem`); Ahaziah (ID: `person:Ahaziah.2`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`); David (ID: `person:David`); Ahab (ID: `person:Ahab`); Athaliah (ID: `person:Athaliah`); Jehoram (ID: `person:Jehoram`); Joash (ID: `person:Joash.3`); Covenant (ID: `keyterm:Covenant`); Joram (ID: `person:Joram.3`); Moses (ID: `person:Moses`); Syrians (ID: `group:Syria`); Edom (ID: `place:Edom`); Jehu (ID: `person:Jehu.2`); Ramoth-gilead (ID: `place:Ramoth-gilead`); Sabbath (ID: `keyterm:Sabbath`); Offering (ID: `keyterm:Offering`); Smear (ID: `keyterm:Smear`); Hazael (ID: `person:Hazael`); Jehoshaphat (ID: `person:Jehoshaphat.3`); Testimony (ID: `keyterm:Witness.2`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Rebel (ID: `keyterm:Rebel`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Israel (ID: `person:Israel`); Amaziah (ID: `person:Amaziah`); Uzziah (ID: `person:Uzziah`); Jerusalem (ID: `place:Jerusalem`); Ahaz (ID: `person:Ahaz`); Jotham (ID: `person:Jotham.2`); Joash (ID: `person:Joash.4`); Samaria (ID: `place:Samaria`); House (ID: `realia:House`); Be Unfaithful (ID: `keyterm:Unfaithful`); Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Tribe of Ephraim (ID: `group:Ephraim`); Ephraim (ID: `person:Ephraim`); Edom (ID: `place:Edom`); Beth-shemesh (ID: `place:Beth-shemesh`); Philistia (ID: `place:Philistine`); Assyria (ID: `place:Assyria`); Philistines (ID: `group:Philistine`); Tower (ID: `realia:Tower`); Azariah (ID: `person:Azariah.9`); Corner Gate (ID: `place:CornerGate`); Joash (ID: `person:Joash.3`); Shephelah (ID: `place:Shephelah`); David (ID: `person:David`); Ammon (ID: `place:Ammon`); Jehoahaz (ID: `person:Jehoahaz.2`); Ammonites (ID: `group:Ammon`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Babylon (ID: `place:Babylon`); House (ID: `realia:House`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Jeremiah (ID: `person:Jeremiah.6`); Persia (ID: `place:Persia`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Cyrus (ID: `person:Cyrus`); Jehoiachin (ID: `person:Jehoiachin`); Jehoiakim (ID: `person:Jehoiakim`); An Angel (ID: `deity:Angel`); Zedekiah (ID: `person:Zedekiah.3`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Israel (ID: `person:Israel`); Rebel (ID: `keyterm:Rebel`); Swear (ID: `keyterm:Swear`); Sabbath (ID: `keyterm:Sabbath`); Chaldea (ID: `place:Chaldea`); Chaldeans (ID: `group:Chaldea`); Defilement (ID: `keyterm:Defilement`); Holy (ID: `keyterm:Holy`); Be Unfaithful (ID: `keyterm:Unfaithful`)
