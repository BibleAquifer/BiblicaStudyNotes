...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Memucan (ID: `person:Memucan`); Ahasuerus (ID: `person:Ahasuerus`); Hegai (ID: `person:Hegai`); Esther (ID: `person:Esther`); Mordecai (ID: `person:Mordecai.2`); Carkas (ID: `person:Carkas`); Meres (ID: `person:Meres`); Marsena (ID: `person:Marsena`); Mehuman (ID: `person:Mehuman`); Bigtha (ID: `person:Bigtha`); Admatha (ID: `person:Admatha`); Jair (ID: `person:Jair.4`); Biztha (ID: `person:Biztha`); Kish (ID: `person:Kish.4`); Shethar (ID: `person:Shethar`); Zethar (ID: `person:Zethar`); Abagtha (ID: `person:Abagtha`); Shimei (ID: `person:Shimei.18`); Shaashgaz (ID: `person:Shaashgaz`); Carshena (ID: `person:Carshena`); Harbona (ID: `person:Harbona`); Media (ID: `place:Media`); Abihail (ID: `person:Abihail.5`); Cotton (ID: `flora:Cotton`); Bigthan (ID: `person:Bigthan`); Teresh (ID: `person:Teresh`); India (ID: `place:India`); Crown (ID: `realia:Crown`); Balsam Tree (ID: `flora:BalsamTree`); Susa (ID: `place:Susa`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Ahasuerus (ID: `person:Ahasuerus`); Mordecai (ID: `person:Mordecai.2`)
...
* **Associated ACAI Concepts:** Hathach (ID: `person:Hathach`); Mordecai (ID: `person:Mordecai.2`); Esther (ID: `person:Esther`); Sackcloth (ID: `realia:Sackcloth`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Esther (ID: `person:Esther`); Zeresh (ID: `person:Zeresh`); Harbona (ID: `person:Harbona.2`); Teresh (ID: `person:Teresh`); Bigthan (ID: `person:Bigthan`); Mordecai (ID: `person:Mordecai.2`); House (ID: `realia:House`)
