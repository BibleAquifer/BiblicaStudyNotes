...
* **Associated ACAI Concepts:** Ahasuerus (ID: `person:Ahasuerus`); Vashti (ID: `person:Vashti`); Esther (ID: `person:Esther`); Mordecai (ID: `person:Mordecai.2`); Susa (ID: `place:Susa`); House (ID: `realia:House`); Persia (ID: `place:Persia`); Hegai (ID: `person:Hegai`); Memucan (ID: `person:Memucan`); Media (ID: `place:Media`); Kindness (ID: `keyterm:Kindness`); Favor (ID: `keyterm:Favor`); India (ID: `place:India`); Carkas (ID: `person:Carkas`); Carshena (ID: `person:Carshena`); Admatha (ID: `person:Admatha`); Teresh (ID: `person:Teresh`); Meres (ID: `person:Meres`); Zethar (ID: `person:Zethar`); Shethar (ID: `person:Shethar`); Harbona (ID: `person:Harbona`); Jair (ID: `person:Jair.4`); Kish (ID: `person:Kish.4`); Abagtha (ID: `person:Abagtha`); Shaashgaz (ID: `person:Shaashgaz`); Shimei (ID: `person:Shimei.18`); Crown (ID: `realia:Crown`); Bigtha (ID: `person:Bigtha`); Abihail (ID: `person:Abihail.5`); Biztha (ID: `person:Biztha`); Mehuman (ID: `person:Mehuman`); Bigthan (ID: `person:Bigthan`); Marsena (ID: `person:Marsena`); Medes (ID: `group:Mede`); Benjamin (ID: `person:Benjamin`); Babylon (ID: `place:Babylon`); Wine (ID: `realia:Wine`); Ethiopia (ID: `place:Ethiopia`); Scroll (ID: `realia:Scroll`); Medan (ID: `person:Medan`); Persians (ID: `group:Persia`); Delight (ID: `keyterm:Delight`); Tribe of Judah (ID: `group:Judah`); Jerusalem (ID: `place:Jerusalem`); Vine (ID: `flora:Vine`); Jehoiachin (ID: `person:Jehoiachin`); Appoint (ID: `keyterm:Appoint`); Peace (ID: `keyterm:IntactState`); Judah (ID: `person:Judah.4`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Jews (ID: `group:Jews`); Tribe of Benjamin (ID: `group:Benjamin`); Tarshish (ID: `place:Tarshish`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Cotton (ID: `flora:Cotton`); Balsam Tree (ID: `flora:BalsamTree`); Olive Oil (ID: `realia:OliveOil`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`); Linen (ID: `realia:Linen`); Myrrh (ID: `flora:Myrrh`); Rope (ID: `realia:Rope`); Anointing Oil (ID: `realia:AnointingOil`); Bed (ID: `realia:Bed`); Doorstep (ID: `realia:Doorstep`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Ahasuerus (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Agagites (ID: `group:Agag`); Hammedatha (ID: `person:Hammedatha`); Agag (ID: `person:Agag.2`); Money (ID: `realia:Money`); Servants (ID: `group:GenericServants`); Lot (ID: `keyterm:Lot`); Susa (ID: `place:Susa`); Talent (ID: `realia:Talent`); Lot (ID: `realia:Lot`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Esther (ID: `person:Esther`); Jews (ID: `group:Jews`); Hathach (ID: `person:Hathach`); Sackcloth (ID: `realia:Sackcloth`); Susa (ID: `place:Susa`); Haman (ID: `person:Haman`); To Beg for Mercy (ID: `keyterm:BegForMercy`); House (ID: `realia:House`); Money (ID: `realia:Money`)
