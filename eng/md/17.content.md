...
* **Associated ACAI Concepts:** Ahasuerus (ID: `person:Ahasuerus`); Vashti (ID: `person:Vashti`); Esther (ID: `person:Esther`); Mordecai (ID: `person:Mordecai.2`); Susa (ID: `place:Susa`); House (ID: `realia:House`); Persia (ID: `place:Persia`); Hegai (ID: `person:Hegai`); Memucan (ID: `person:Memucan`); Media (ID: `place:Media`); Favor (ID: `keyterm:Favor`); Kindness (ID: `keyterm:Kindness`); Shimei (ID: `person:Shimei.18`); India (ID: `place:India`); Bigthan (ID: `person:Bigthan`); Zethar (ID: `person:Zethar`); Shaashgaz (ID: `person:Shaashgaz`); Crown (ID: `realia:Crown`); Admatha (ID: `person:Admatha`); Meres (ID: `person:Meres`); Mehuman (ID: `person:Mehuman`); Harbona (ID: `person:Harbona`); Bigtha (ID: `person:Bigtha`); Biztha (ID: `person:Biztha`); Teresh (ID: `person:Teresh`); Carkas (ID: `person:Carkas`); Abagtha (ID: `person:Abagtha`); Marsena (ID: `person:Marsena`); Kish (ID: `person:Kish.4`); Jair (ID: `person:Jair.4`); Carshena (ID: `person:Carshena`); Shethar (ID: `person:Shethar`); Abihail (ID: `person:Abihail.5`); Glory (ID: `keyterm:Glory`); Jerusalem (ID: `place:Jerusalem`); Delight (ID: `keyterm:Delight`); Love (ID: `keyterm:Love`); Babylon (ID: `place:Babylon`); Jehoiachin (ID: `person:Jehoiachin`); Benjamin (ID: `person:Benjamin`); Persians (ID: `group:Persia`); Tarshish (ID: `place:Tarshish`); Judah (ID: `person:Judah.4`); Medan (ID: `person:Medan`); Tribe of Judah (ID: `group:Judah`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Vine (ID: `flora:Vine`); Medes (ID: `group:Mede`); Tribe of Benjamin (ID: `group:Benjamin`); Jews (ID: `group:Jews`); Ethiopia (ID: `place:Ethiopia`); Scroll (ID: `realia:Scroll`); Appoint (ID: `keyterm:Appoint`); Wine (ID: `realia:Wine`); Peace (ID: `keyterm:IntactState`); Balsam Tree (ID: `flora:BalsamTree`); Cotton (ID: `flora:Cotton`); Purple Cloth (ID: `realia:PurpleCloth`); Linen (ID: `realia:Linen`); Doorstep (ID: `realia:Doorstep`); Myrrh (ID: `flora:Myrrh`); Money (ID: `realia:Money`); Bed (ID: `realia:Bed`); Anointing Oil (ID: `realia:AnointingOil`); Rope (ID: `realia:Rope`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Mordecai (ID: `person:Mordecai.2`); Ahasuerus (ID: `person:Ahasuerus`); Jews (ID: `group:Jews`); Agagites (ID: `group:Agag`); Hammedatha (ID: `person:Hammedatha`); Agag (ID: `person:Agag.2`); Money (ID: `realia:Money`); Servants (ID: `group:GenericServants`); Susa (ID: `place:Susa`); Lot (ID: `keyterm:Lot`); Scroll (ID: `realia:Scroll`); Lot (ID: `realia:Lot`); Talent (ID: `realia:Talent`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Esther (ID: `person:Esther`); Jews (ID: `group:Jews`); Hathach (ID: `person:Hathach`); Sackcloth (ID: `realia:Sackcloth`); Susa (ID: `place:Susa`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Haman (ID: `person:Haman`); House (ID: `realia:House`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Jews (ID: `group:Jews`); Mordecai (ID: `person:Mordecai.2`); Susa (ID: `place:Susa`); Ahasuerus (ID: `person:Ahasuerus`); Haman (ID: `person:Haman`); Esther (ID: `person:Esther`); Scroll (ID: `realia:Scroll`); Hammedatha (ID: `person:Hammedatha`); Agagites (ID: `group:Agag`); Agag (ID: `person:Agag.2`); Peace (ID: `keyterm:IntactState`); India (ID: `place:India`); Vaizatha (ID: `person:Vaizatha`); Aspatha (ID: `person:Aspatha`); Arisai (ID: `person:Arisai`); Dalphon (ID: `person:Dalphon`); Poratha (ID: `person:Poratha`); Adalia (ID: `person:Adalia`); Parmashta (ID: `person:Parmashta`); Parshandatha (ID: `person:Parshandatha`); Aridai (ID: `person:Aridai`); Aridatha (ID: `person:Aridatha`); Abihail (ID: `person:Abihail.5`); Media (ID: `place:Media`); Delight (ID: `keyterm:Delight`); Truth (ID: `keyterm:Truth`); Lot (ID: `keyterm:Lot`); Favor (ID: `keyterm:Favor`); Persia (ID: `place:Persia`); Ethiopia (ID: `place:Ethiopia`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Horse (ID: `fauna:Horse`); Lot (ID: `realia:Lot`); Purple Cloth (ID: `realia:PurpleCloth`); Crown (ID: `realia:Crown`); Linen (ID: `realia:Linen`); House (ID: `realia:House`)
