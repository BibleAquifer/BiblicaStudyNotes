...
* **Associated ACAI Concepts:** Zaanan (ID: `place:Zaanan`); Maroth (ID: `place:Maroth`); Beth-ezel (ID: `place:Beth-ezel`); Shaphir (ID: `place:Shaphir`); Moresheth-gath (ID: `place:Moresheth-gath`); Practice Divination (ID: `keyterm:PracticeDivination`); Micah (ID: `person:Micah.6`); Moresheth (ID: `place:Moresheth`); Prophets (ID: `group:GenericProphets`); Achzib (ID: `place:Achzib`); Jerusalem (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Pruning Knife (ID: `realia:PruningKnife`); Incantations (ID: `keyterm:Incantations`); Sheaf (ID: `realia:Sheaf`); Bethlehem (ID: `place:Bethlehem`); Jerusalem (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Balance (ID: `realia:Balance`); Net (ID: `realia:Net`); LORD (ID: `deity:Lord`)
