...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); Israel (ID: `person:Israel`); Sabbath (ID: `keyterm:Sabbath`); Moses (ID: `person:Moses`); Work (ID: `keyterm:Work`); Appointed Feast (ID: `keyterm:AppointedFeast`); Barley (ID: `flora:Barley`); Complete (ID: `keyterm:Complete`); Sickle (ID: `realia:Sickle`); Sheep (ID: `fauna:Lamb`); Atonement (ID: `keyterm:Atonement`); Aaron (ID: `person:Aaron`); Slaughtering (ID: `keyterm:Slaughtering`); Pure (ID: `keyterm:Pure`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Wine (ID: `realia:Wine`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Lamp (ID: `realia:Lamp`); Appease (ID: `keyterm:Appease`); Passover (ID: `keyterm:Passover`); To Sin (ID: `keyterm:Sin`); Testimony (ID: `keyterm:Witness.2`); Egypt (ID: `place:Egypt`); Delight (ID: `keyterm:Delight`); Decree (ID: `keyterm:Decree`); Covenant (ID: `keyterm:Covenant`); Israelites (ID: `group:Israel`); Memorial Portion (ID: `keyterm:MemorialOrTokenPortion`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Moses (ID: `person:Moses`); Israelites (ID: `group:Israel`); Cattle (ID: `fauna:Bull`); Dibri (ID: `person:Dibri`); Shelomith (ID: `person:Shelomith.2`); Tribe of Dan (ID: `group:Dan`); Egypt (ID: `place:Egypt`); Egyptians (ID: `group:Egypt`); Dan (ID: `place:Dan`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`)
...
* **Associated ACAI Concepts:** Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Redeem (ID: `keyterm:Redeem`); LORD (ID: `deity:Lord`); Sabbath (ID: `keyterm:Sabbath`); Israel (ID: `person:Israel`); House (ID: `realia:House`); Egypt (ID: `place:Egypt`); Fear (ID: `keyterm:Fear`); Force to Serve (ID: `keyterm:EnticedToServe`); Tribe of Levi (ID: `group:Levi`); Safety (ID: `keyterm:Safety`); Holy (ID: `keyterm:Holy`); Complete (ID: `keyterm:Complete`); Levi (ID: `person:Levi.3`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); Atonement (ID: `keyterm:Atonement`); Dispossess (ID: `keyterm:Dispossess`); Work (ID: `keyterm:Work`); Bless (ID: `keyterm:Bless`); Mount Sinai (ID: `place:SinaiMount`); Moses (ID: `person:Moses`); Canaan (ID: `place:Canaan`); Barley (ID: `flora:Barley`); Rams Horn (ID: `realia:RamsHorn`); Cattle (ID: `fauna:Bull`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Covenant (ID: `keyterm:Covenant`); Passion (ID: `keyterm:Ardour`); To Sin (ID: `keyterm:Sin`); Sabbath (ID: `keyterm:Sabbath`); Egypt (ID: `place:Egypt`); Israel (ID: `person:Israel`); Stubborn (ID: `keyterm:Stubborn`); Instruction (ID: `keyterm:Instruction`); Strength (ID: `keyterm:Strength`); Abraham (ID: `person:Abraham`); Mount Sinai (ID: `place:SinaiMount`); Peace (ID: `keyterm:IntactState`); Moses (ID: `person:Moses`); Repent (ID: `keyterm:Repent`); Safety (ID: `keyterm:Safety`); Isaac (ID: `person:Isaac`); Fear (ID: `keyterm:Fear`); Decree (ID: `keyterm:Decree`); Idol (ID: `keyterm:Idol`); Complete (ID: `keyterm:Complete`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Be Unfaithful (ID: `keyterm:Unfaithful`); Image (ID: `realia:Image`); High Place (ID: `realia:HighPlace`); Graven Image (ID: `realia:GravenImage`); Yoke (ID: `realia:Yoke`); Coriander (ID: `flora:Coriander`); Jackal (ID: `fauna:Jackal`); Sword (ID: `realia:Sword`); Stone Pine (ID: `flora:Pine`); Cattle (ID: `fauna:Bull`); Hyena (ID: `fauna:Hyena`); Lion (ID: `fauna:Lion`); Vine (ID: `flora:Vine`); Barley (ID: `flora:Barley`); Bear (ID: `fauna:Bear`); Sacred Pillar (ID: `realia:SacredPillar`)
...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); LORD (ID: `deity:Lord`); Redeem (ID: `keyterm:Redeem`); Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Shekel (ID: `realia:Shekel`); Money (ID: `realia:Money`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Set Apart for God (ID: `keyterm:Proscribe`); Cattle (ID: `fauna:Bull`); Moses (ID: `person:Moses`); Defilement (ID: `keyterm:Defilement`); Israel (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); Vow (ID: `keyterm:Vow`); Barley (ID: `flora:Barley`); Coriander (ID: `flora:Coriander`); House (ID: `realia:House`); Mount Sinai (ID: `place:SinaiMount`); Homer (ID: `realia:Homer`); Gerah (ID: `realia:Gerah`); Staff (ID: `realia:Staff`); Goat (ID: `fauna:Goat`); Rod (ID: `realia:Rod`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`)
