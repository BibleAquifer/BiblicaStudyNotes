...
* **Associated ACAI Concepts:** Moses (ID: `person:Moses`); LORD (ID: `deity:Lord`); Aaron (ID: `person:Aaron`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); To Sin (ID: `keyterm:Sin`); Stone Altar (ID: `realia:StoneAltar`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Altar (ID: `realia:Altar`); Priesthood (ID: `keyterm:Priesthood`); Israel (ID: `person:Israel`); Sheep (ID: `fauna:Lamb`); Cattle (ID: `fauna:Bull`); Tent of Meeting (ID: `realia:TentOfMeeting`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Decree (ID: `keyterm:Decree`); Appease (ID: `keyterm:Appease`); Ithamar (ID: `person:Ithamar`); Smear (ID: `keyterm:Smear`); Eleazar (ID: `person:Eleazar.2`); Slaughtering (ID: `keyterm:Slaughtering`); Glory (ID: `keyterm:Glory`); Bless (ID: `keyterm:Bless`); Complete (ID: `keyterm:Complete`); Pure (ID: `keyterm:Pure`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Tunic (ID: `realia:Tunic`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Holy (ID: `keyterm:Holy`); Defilement (ID: `keyterm:Defilement`); Israel (ID: `person:Israel`); Offering (ID: `keyterm:Offering`); To Dishonor (ID: `keyterm:Dishonor`); Moses (ID: `person:Moses`); Aaron (ID: `person:Aaron`); Slaughtering (ID: `keyterm:Slaughtering`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Passion (ID: `keyterm:Ardour`); Molech (ID: `deity:Molech`); Play the Prostitute (ID: `keyterm:PlayTheProstitute`); Delight (ID: `keyterm:Delight`); Cattle (ID: `fauna:Bull`); Fear (ID: `keyterm:Fear`); Egypt (ID: `place:Egypt`); Pure (ID: `keyterm:Pure`); Sheep (ID: `fauna:Lamb`); Tent of Meeting (ID: `realia:TentOfMeeting`); Necromancer (ID: `keyterm:Spirit`); Vow (ID: `keyterm:Vow`); Stone Altar (ID: `realia:StoneAltar`); Goat (ID: `fauna:Goat`); Temple Altar (ID: `realia:TempleAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Flock (ID: `fauna:Flock`); Altar (ID: `realia:Altar`); Appease (ID: `keyterm:Appease`); Complete (ID: `keyterm:Complete`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Offering (ID: `keyterm:Offering`); Holy (ID: `keyterm:Holy`); Israel (ID: `person:Israel`); Sabbath (ID: `keyterm:Sabbath`); Moses (ID: `person:Moses`); Work (ID: `keyterm:Work`); Appointed Feast (ID: `keyterm:AppointedFeast`); Barley (ID: `flora:Barley`); Complete (ID: `keyterm:Complete`); Sheep (ID: `fauna:Lamb`); Sickle (ID: `realia:Sickle`); Atonement (ID: `keyterm:Atonement`); Slaughtering (ID: `keyterm:Slaughtering`); Aaron (ID: `person:Aaron`); Pure (ID: `keyterm:Pure`); Pleasing Odor (ID: `keyterm:PleasingOdor`); Wine (ID: `realia:Wine`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Lamp (ID: `realia:Lamp`); Testimony (ID: `keyterm:Witness.2`); Memorial Portion (ID: `keyterm:MemorialOrTokenPortion`); Passover (ID: `keyterm:Passover`); Vow (ID: `keyterm:Vow`); Delight (ID: `keyterm:Delight`); Egypt (ID: `place:Egypt`); Covenant (ID: `keyterm:Covenant`); Israelites (ID: `group:Israel`); To Sin (ID: `keyterm:Sin`); Decree (ID: `keyterm:Decree`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Moses (ID: `person:Moses`); Israelites (ID: `group:Israel`); Cattle (ID: `fauna:Bull`); Dibri (ID: `person:Dibri`); Shelomith (ID: `person:Shelomith.2`); Bear the Consequences Of (ID: `keyterm:BearTheConsequencesOf`); Dan (ID: `place:Dan`); Egyptians (ID: `group:Egypt`); Egypt (ID: `place:Egypt`); Tribe of Dan (ID: `group:Dan`)
...
* **Associated ACAI Concepts:** Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Redeem (ID: `keyterm:Redeem`); LORD (ID: `deity:Lord`); Sabbath (ID: `keyterm:Sabbath`); Israel (ID: `person:Israel`); House (ID: `realia:House`); Force to Serve (ID: `keyterm:EnticedToServe`); Fear (ID: `keyterm:Fear`); Egypt (ID: `place:Egypt`); Complete (ID: `keyterm:Complete`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Safety (ID: `keyterm:Safety`); Holy (ID: `keyterm:Holy`); Money (ID: `realia:Money`); Vine (ID: `flora:Vine`); Mount Sinai (ID: `place:SinaiMount`); Canaan (ID: `place:Canaan`); Bless (ID: `keyterm:Bless`); Atonement (ID: `keyterm:Atonement`); Moses (ID: `person:Moses`); Work (ID: `keyterm:Work`); Dispossess (ID: `keyterm:Dispossess`); Barley (ID: `flora:Barley`); Cattle (ID: `fauna:Bull`); Rams Horn (ID: `realia:RamsHorn`); Wheat (ID: `flora:Wheat`); Sorghum (ID: `flora:Sorghum`)
...
* **Associated ACAI Concepts:** Holy (ID: `keyterm:Holy`); LORD (ID: `deity:Lord`); Redeem (ID: `keyterm:Redeem`); Year of Acquittance (ID: `keyterm:YearOfAcquittance`); Shekel (ID: `realia:Shekel`); Money (ID: `realia:Money`); Something Devoted to God (ID: `keyterm:SomethingDevotedToGod`); Set Apart for God (ID: `keyterm:Proscribe`); Cattle (ID: `fauna:Bull`); Offering (ID: `keyterm:Offering`); Vow (ID: `keyterm:Vow`); Moses (ID: `person:Moses`); Defilement (ID: `keyterm:Defilement`); Israel (ID: `person:Israel`); Barley (ID: `flora:Barley`); House (ID: `realia:House`); Coriander (ID: `flora:Coriander`); Mount Sinai (ID: `place:SinaiMount`); Gerah (ID: `realia:Gerah`); Homer (ID: `realia:Homer`); Staff (ID: `realia:Staff`); Rod (ID: `realia:Rod`); Sheep (ID: `fauna:Lamb`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`)
