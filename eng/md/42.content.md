...
* **Associated ACAI Concepts:** Zechariah (ID: `person:Zechariah`); Elizabeth (ID: `person:Elizabeth`); Abijah (ID: `person:Abijah.6`); Strong Drink (ID: `realia:StrongDrink`); Gabriel (ID: `deity:Gabriel`); Regulations (ID: `keyterm:Regulations`); Herod (ID: `person:Herod`); Be Blameless (ID: `keyterm:Blameless`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Zechariah (ID: `person:Zechariah`); Height (ID: `keyterm:Height`); Elizabeth (ID: `person:Elizabeth`); Deliver (ID: `keyterm:Deliver`); Liberation (ID: `keyterm:Liberation`); Judea (ID: `place:Judea`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Manger (ID: `realia:Manger`); Quirinius (ID: `person:Quirinius`); Bethlehem (ID: `place:Bethlehem`); Inn (ID: `realia:Inn`); Augustus (ID: `person:Augustus`); Savior (ID: `keyterm:Savior`); Register (ID: `keyterm:Register`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Simeon (ID: `person:Simeon.2`); Anna (ID: `person:Anna`); Phanuel (ID: `person:Phanuel`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Abilene (ID: `place:Abilene`); Lysanias (ID: `person:Lysanias`); Trachonitis (ID: `place:Trachonitis`); Philip (ID: `person:Philip.3`); Ituraea (ID: `place:Ituraea`); Annas (ID: `person:Annas`); Augustus (ID: `person:Augustus`); Tiberius (ID: `person:Tiberius`); Herod Antipas (ID: `person:Herod.2`); John (ID: `person:John`); Jordan River (ID: `place:Jordan`)
...
* **Associated ACAI Concepts:** Eliezer (ID: `person:Eliezer`); Jannai (ID: `person:Jannai`); Heli (ID: `person:Heli`); Levi (ID: `person:Levi.2`); Joanan (ID: `person:Joanan`); Levi (ID: `person:Levi`); Esli (ID: `person:Esli`); Mattathias (ID: `person:Mattathias`); Joseph (ID: `person:Joseph.8`); Cosam (ID: `person:Cosam`); Shealtiel (ID: `person:Shealtiel`); Menna (ID: `person:Menna`); Melchi (ID: `person:Melchi.2`); Addi (ID: `person:Addi`); Joshua (ID: `person:Joshua`); Joda (ID: `person:Joda`); Joseph (ID: `person:Joseph.7`); Mattatha (ID: `person:Mattatha`); Amos (ID: `person:Amos.2`); Nahum (ID: `person:Nahum`); Naggai (ID: `person:Naggai`); Simeon (ID: `person:Simeon.3`); Judah (ID: `person:Judah.3`); Jonam (ID: `person:Jonam`); Maath (ID: `person:Maath`); Semein (ID: `person:Semein`); Er (ID: `person:Er`); Matthat (ID: `person:Matthat`); Rhesa (ID: `person:Rhesa`); Josech (ID: `person:Josech`); Eliakim (ID: `person:Eliakim.2`); Zerubbabel (ID: `person:Zerubbabel`); Matthat (ID: `person:Matthat.2`); Melea (ID: `person:Melea`); Melchi (ID: `person:Melchi`); Elmadam (ID: `person:Elmadam`); Mattathias (ID: `person:Mattathias.2`); Jorim (ID: `person:Jorim`); Cainan (ID: `person:Cainan`); Neri (ID: `person:Neri`); Nathan (ID: `person:Nathan`); Serug (ID: `person:Serug`); Reu (ID: `person:Reu`); Salmon (ID: `person:Salmon`); Methuselah (ID: `person:Methuselah`); Jared (ID: `person:Jared`); Lamech (ID: `person:Lamech.2`); Mahalalel (ID: `person:Mahalalel`); Nahor (ID: `person:Nahor`); Kenan (ID: `person:Kenan`); Enosh (ID: `person:Enosh`); Shelah (ID: `person:Shelah.2`); Peleg (ID: `person:Peleg`); Terah (ID: `person:Terah`); Seth (ID: `person:Seth`); Eber (ID: `person:Eber`); Hezron (ID: `person:Hezron.2`); Joseph (ID: `person:Joseph.4`); Shem (ID: `person:Shem`); Boaz (ID: `person:Boaz`); Adam (ID: `person:Adam`)
...
* **Associated ACAI Concepts:** Infectious Skin Disease (ID: `keyterm:InfectiousSkinDisease`); Peter (ID: `person:Peter`)
...
* **Associated ACAI Concepts:** Happy (ID: `keyterm:Happy`); Simon (ID: `person:Simon.2`); Judas (ID: `person:Judas`); Matthew (ID: `person:Matthew`); Chosen (ID: `keyterm:Chosen`)
...
* **Associated ACAI Concepts:** Nain (ID: `place:Nain`); Judea (ID: `place:Judea`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Simon (ID: `person:Simon.6`); Alabaster Jar (ID: `realia:AlabasterJar`); Owe (ID: `keyterm:Owe`); Forgive (ID: `keyterm:Forgive`)
...
* **Associated ACAI Concepts:** Susanna (ID: `person:Susanna`); Chuza (ID: `person:Chuza`); Parable (ID: `keyterm:Parable`); Joanna (ID: `person:Joanna`); Honest (ID: `keyterm:Honest`); Daily Life (ID: `keyterm:DailyLife`); Mary Magdalene (ID: `person:Marymagdalene`)
...
* **Associated ACAI Concepts:** Gerasa (ID: `place:Gerasa`); Legion (ID: `deity:Legion`); Fetter (ID: `realia:Fetter`); Abyss (ID: `keyterm:Abyss`); Be Demon Possessed (ID: `keyterm:DemonPossessed`); Demons (ID: `deity:Demons`)
...
* **Associated ACAI Concepts:** Chorazin (ID: `place:Chorazin`); Make Peace (ID: `keyterm:Peace`); Scorpion (ID: `fauna:Scorpion`); Disaster (ID: `keyterm:Disaster`)
...
* **Associated ACAI Concepts:** Ninevites (ID: `group:Nineveh`)
...
* **Associated ACAI Concepts:** Barn (ID: `realia:Barn`); Oven (ID: `realia:Oven`); Storeroom (ID: `realia:Storeroom`); Cubit (ID: `realia:Cubit.2`); Wild Flower (ID: `flora:WildFlower`); Crow (ID: `fauna:Crow`); Bag (ID: `realia:Bag`); Flock (ID: `fauna:Flock`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Lazarus (ID: `person:Lazarus`); World of the Dead (ID: `keyterm:WorldOfTheDead`); Dog (ID: `fauna:Dog`); Abraham (ID: `person:Abraham`)
...
* **Associated ACAI Concepts:** Avenge (ID: `keyterm:GrantJustice`); Tax Collector (ID: `keyterm:TaxCollector`); Pharisees (ID: `group:Pharisee`); Abstain from Food (ID: `keyterm:Fast`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Needle (ID: `realia:Needle`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Zacchaeus (ID: `person:Zacchaeus`); Sycomore Fig (ID: `flora:SycomoreFig`)
...
* **Associated ACAI Concepts:** Bethphage (ID: `place:Bethphage`); Temple (ID: `realia:Temple`); Mount of Olives (ID: `place:OlivesMount`); Height (ID: `keyterm:Height`); Siege-Works (ID: `realia:Siege-works`); Bethany (ID: `place:Bethany`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Tiberius (ID: `person:Tiberius`); Resurrection (ID: `keyterm:Resurrection`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Peter (ID: `person:Peter`); Peter's Second Accuser (ID: `person:SecondAccuserOfPeter`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Criminal on the Cross (ID: `person:Dysmas`); Simon (ID: `person:Simon.5`); Cross (ID: `realia:Cross`); Sour Wine (ID: `realia:SourWine`); Cyrene (ID: `place:Cyrene`); Jesus (ID: `person:Jesus.2`)
...
* **Associated ACAI Concepts:** Grave (ID: `realia:Grave`); Arimathea (ID: `place:Arimathea`); Aloes (ID: `realia:Aloes`); Joseph (ID: `person:Joseph.6`)
...
* **Associated ACAI Concepts:** Joanna (ID: `person:Joanna`); Week (ID: `keyterm:Week`); Linen (ID: `realia:Linen`)
...
* **Associated ACAI Concepts:** Emmaus (ID: `place:Emmaus`); Cleopas (ID: `person:Cleopas`); Stade (ID: `realia:Stade`)
...
* **Associated ACAI Concepts:** Bethany (ID: `place:Bethany`); To Cause to Happen (ID: `keyterm:Happen`); Written (ID: `keyterm:Scripture`); Bow Down (ID: `keyterm:BowDown`)
