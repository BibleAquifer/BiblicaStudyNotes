...
* **Associated ACAI Concepts:** Habakkuk (ID: `person:Habakkuk`); Utterance (ID: `keyterm:Utterance`)
...
* **Associated ACAI Concepts:** Woe (ID: `keyterm:Woe.2`); Dragnet (ID: `realia:Dragnet`); Casting Net (ID: `realia:CastingNet`); Fortification (ID: `realia:Fortification`); Idol (ID: `keyterm:Idol`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Cushan (ID: `place:Cushan`); Habakkuk (ID: `person:Habakkuk`); Mount Paran (ID: `place:ParanMount`); Teman (ID: `place:Teman`); Deer (ID: `fauna:Deer`)
