...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Salvation (ID: `keyterm:Salvation`); Arrow (ID: `realia:Arrow`); Horse (ID: `fauna:Horse`); Teman (ID: `place:Teman`); Habakkuk (ID: `person:Habakkuk`); Mount Paran (ID: `place:ParanMount`); Cushan (ID: `place:Cushan`); Arrow (ID: `keyterm:Arrow`); Oath (ID: `keyterm:Oath`); Anointed (ID: `keyterm:Anointed`); Midian (ID: `place:Midian`); Mischief (ID: `keyterm:Mischief`); Fear (ID: `keyterm:Fear`); Holy (ID: `keyterm:Holy`); Majesty (ID: `keyterm:Majesty`); Deer (ID: `fauna:Deer`); Sheepfold (ID: `realia:Sheepfold`); Bow (ID: `realia:Bow`); Cattle (ID: `fauna:Bull`); Animal Pen (ID: `realia:AnimalPen`); Fig (ID: `flora:Fig`); Vine (ID: `flora:Vine`); Goat (ID: `fauna:Goat`); Spear (ID: `realia:Spear`); Tent (ID: `realia:Tent`); Chariot (ID: `realia:Chariot`); Flock (ID: `fauna:Flock`); Foundation (ID: `realia:Foundation`); Olive Tree (ID: `flora:OliveTree`)
