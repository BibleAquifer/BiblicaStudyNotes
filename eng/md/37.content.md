...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Haggai (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Darius (ID: `person:Darius.2`); Joshua (ID: `person:Joshua.5`); Shealtiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Tribe of Judah (ID: `group:Judah`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Judah (ID: `person:Judah.4`); Zerubbabel (ID: `person:Zerubbabel.2`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`); Bag (ID: `realia:Bag`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Must (ID: `realia:Must`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jehozadak (ID: `person:Jehozadak`); Zerubbabel (ID: `person:Zerubbabel.2`); Shealtiel (ID: `person:Shealtiel.2`); Joshua (ID: `person:Joshua.5`); Haggai (ID: `person:Haggai`); Judah (ID: `person:Judah.4`); Fear (ID: `keyterm:Fear`); Tribe of Judah (ID: `group:Judah`); An Angel (ID: `deity:Angel`); Darius (ID: `person:Darius.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Joshua (ID: `person:Joshua.5`); Jehozadak (ID: `person:Jehozadak`); Zerubbabel (ID: `person:Zerubbabel.2`); Haggai (ID: `person:Haggai`); Peace (ID: `keyterm:IntactState`); Judah (ID: `person:Judah.4`); Fear (ID: `keyterm:Fear`); Shealtiel (ID: `person:Shealtiel.2`); Tribe of Judah (ID: `group:Judah`); Egypt (ID: `place:Egypt`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Zerubbabel (ID: `person:Zerubbabel.2`); Judah (ID: `person:Judah.4`); Shealtiel (ID: `person:Shealtiel.2`); Tribe of Judah (ID: `group:Judah`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Haggai (ID: `person:Haggai`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`)
