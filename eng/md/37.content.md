...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Haggai (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Shealtiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Joshua (ID: `person:Joshua.5`); Darius (ID: `person:Darius.2`); Judah (ID: `person:Judah.4`); Zerubbabel (ID: `person:Zerubbabel.2`); Tribe of Judah (ID: `group:Judah`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Bag (ID: `realia:Bag`); Grain (ID: `flora:Grain`); Vine (ID: `flora:Vine`); Mule (ID: `fauna:Mule`); Must (ID: `realia:Must`); Olive Tree (ID: `flora:OliveTree`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Zerubbabel (ID: `person:Zerubbabel.2`); Jehozadak (ID: `person:Jehozadak`); Shealtiel (ID: `person:Shealtiel.2`); Joshua (ID: `person:Joshua.5`); Haggai (ID: `person:Haggai`); An Angel (ID: `deity:Angel`); Fear (ID: `keyterm:Fear`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Darius (ID: `person:Darius.2`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Joshua (ID: `person:Joshua.5`); Zerubbabel (ID: `person:Zerubbabel.2`); Jehozadak (ID: `person:Jehozadak`); Haggai (ID: `person:Haggai`); Shealtiel (ID: `person:Shealtiel.2`); Fear (ID: `keyterm:Fear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Egypt (ID: `place:Egypt`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Peace (ID: `keyterm:IntactState`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Haggai (ID: `person:Haggai`); Defilement (ID: `keyterm:Defilement`); Vine (ID: `flora:Vine`); Holy (ID: `keyterm:Holy`); Bless (ID: `keyterm:Bless`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Instruction (ID: `keyterm:Instruction`); Darius (ID: `person:Darius.2`); Winepress (ID: `realia:Winepress`); Grain (ID: `flora:Grain`); Barley (ID: `flora:Barley`); Fig (ID: `flora:Fig`); Olive Tree (ID: `flora:OliveTree`); Pomegranate (ID: `flora:Pomegranate`); Coriander (ID: `flora:Coriander`); Anointing Oil (ID: `realia:AnointingOil`); Stew (ID: `realia:Stew`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Zerubbabel (ID: `person:Zerubbabel.2`); LORD (ID: `deity:Lord`); Shealtiel (ID: `person:Shealtiel.2`); Haggai (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Sword (ID: `realia:Sword`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`)
