...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Haggai (ID: `person:Haggai`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Darius (ID: `person:Darius.2`); Joshua (ID: `person:Joshua.5`); Shealtiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Zerubbabel (ID: `person:Zerubbabel.2`); Bring Honor and Glory on Oneself (ID: `keyterm:BringHonorAndGloryOnOneself`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Bag (ID: `realia:Bag`); Olive Oil (ID: `realia:OliveOil`); Must (ID: `realia:Must`); Vine (ID: `flora:Vine`); Mule (ID: `fauna:Mule`); Grain (ID: `flora:Grain`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Zerubbabel (ID: `person:Zerubbabel.2`); Jehozadak (ID: `person:Jehozadak`); Haggai (ID: `person:Haggai`); Joshua (ID: `person:Joshua.5`); Shealtiel (ID: `person:Shealtiel.2`); Darius (ID: `person:Darius.2`); An Angel (ID: `deity:Angel`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Fear (ID: `keyterm:Fear`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Glory (ID: `keyterm:Glory`); House (ID: `realia:House`); Zerubbabel (ID: `person:Zerubbabel.2`); Joshua (ID: `person:Joshua.5`); Jehozadak (ID: `person:Jehozadak`); Haggai (ID: `person:Haggai`); Egypt (ID: `place:Egypt`); Tribe of Judah (ID: `group:Judah`); Peace (ID: `keyterm:IntactState`); Judah (ID: `person:Judah.4`); Shealtiel (ID: `person:Shealtiel.2`); Fear (ID: `keyterm:Fear`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Zerubbabel (ID: `person:Zerubbabel.2`); LORD (ID: `deity:Lord`); Haggai (ID: `person:Haggai`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Shealtiel (ID: `person:Shealtiel.2`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`); Sword (ID: `realia:Sword`)
