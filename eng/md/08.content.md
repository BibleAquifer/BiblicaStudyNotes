...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Orpah (ID: `person:Orpah`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Chilion (ID: `person:Chilion`); Mahlon (ID: `person:Mahlon`); Elimelech (ID: `person:Elimelech`); Ephrathites (ID: `group:Ephrathah`); Women (ID: `group:GenericFemales`); Ephrathah (ID: `person:Ephrathah`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Naomi (ID: `person:Naomi`); Boaz (ID: `person:Boaz`); Kinsman Redeemer (ID: `person:KinsmanRedeemer`); Ruth (ID: `person:Ruth`); Obed (ID: `person:Obed`); Salmon (ID: `person:Salmon`); Women (ID: `group:GenericFemales`); Hezron (ID: `person:Hezron.2`); Chilion (ID: `person:Chilion`); Ram (ID: `person:Ram`); LORD (ID: `deity:Lord`)
