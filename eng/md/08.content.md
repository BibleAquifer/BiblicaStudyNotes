...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Naomi (ID: `person:Naomi`); Moab (ID: `place:Moab`); Ruth (ID: `person:Ruth`); Bethlehem (ID: `place:Bethlehem`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Chilion (ID: `person:Chilion`); Orpah (ID: `person:Orpah`); Mahlon (ID: `person:Mahlon`); Elimelech (ID: `person:Elimelech`); Women (ID: `group:GenericFemales`); Ephrathah (ID: `person:Ephrathah`); Ephrathites (ID: `group:Ephrathah`); Appoint (ID: `keyterm:Appoint`); Hope (ID: `keyterm:Hope`); Kindness (ID: `keyterm:Kindness`); Barley (ID: `flora:Barley`)
...
* **Associated ACAI Concepts:** Boaz (ID: `person:Boaz`); Barley (ID: `flora:Barley`); Naomi (ID: `person:Naomi`); Ruth (ID: `person:Ruth`); Moab (ID: `place:Moab`); LORD (ID: `deity:Lord`); Favor (ID: `keyterm:Favor`); Bless (ID: `keyterm:Bless`); Elimelech (ID: `person:Elimelech`); Sickle (ID: `realia:Sickle`); Seek Refugue (ID: `keyterm:SeekfindRefuge`); Bethlehem (ID: `place:Bethlehem`); Israel (ID: `person:Israel`); Kindness (ID: `keyterm:Kindness`); Wheat (ID: `flora:Wheat`); Ephah (ID: `realia:Ephah`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Boaz (ID: `person:Boaz`); Naomi (ID: `person:Naomi`); LORD (ID: `deity:Lord`); Ruth (ID: `person:Ruth`); Redeem (ID: `keyterm:Redeem`); Obed (ID: `person:Obed`); Threshing Floor (ID: `realia:ThreshingFloor`); Israel (ID: `person:Israel`); Moab (ID: `place:Moab`); To Cause to Possess (ID: `keyterm:Possess`); Kinsman Redeemer (ID: `person:KinsmanRedeemer`); Hezron (ID: `person:Hezron.2`); Salmon (ID: `person:Salmon`); Barley (ID: `flora:Barley`); Jesse (ID: `person:Jesse`); Mahlon (ID: `person:Mahlon`); Elimelech (ID: `person:Elimelech`); David (ID: `person:David`); Perez (ID: `person:Perez`); Amminadab (ID: `person:Amminadab`); Bless (ID: `keyterm:Bless`); Women (ID: `group:GenericFemales`); Ram (ID: `person:Ram`); Chilion (ID: `person:Chilion`); Love (ID: `keyterm:Love`); Tamar (ID: `person:Tamar`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Leah (ID: `person:Leah`); Bethlehem (ID: `place:Bethlehem`); Rachel (ID: `person:Rachel`); Kindness (ID: `keyterm:Kindness`); Elders (ID: `group:GenericElders`); Fear (ID: `keyterm:Fear`); Nahshon (ID: `person:Nahshon`)
