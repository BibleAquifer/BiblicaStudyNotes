...
* **Associated ACAI Concepts:** Pethuel (ID: `person:Pethuel`); Joel (ID: `person:Joel.14`); Locust (ID: `fauna:Locust`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Valley of Shittim (ID: `place:ShittimValley`); Pruning Knife (ID: `realia:PruningKnife`); Sabeans (ID: `group:Sabean`); Greeks (ID: `group:Greek`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`)
