...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Jerusalem (ID: `place:Jerusalem`); Moses (ID: `person:Moses`); Nehemiah (ID: `person:Nehemiah.2`); Hacaliah (ID: `person:Hacaliah`); Susa (ID: `place:Susa`); Hanani (ID: `person:Hanani.4`); Repent (ID: `keyterm:Repent`); Kindness (ID: `keyterm:Kindness`); Strength (ID: `keyterm:Strength`); Be Unfaithful (ID: `keyterm:Unfaithful`); Redeem (ID: `keyterm:Redeem`); Tribe of Judah (ID: `group:Judah`); Covenant (ID: `keyterm:Covenant`); Judah (ID: `person:Judah.4`); Jews (ID: `group:Jews`); To Sin (ID: `keyterm:Sin`); Decree (ID: `keyterm:Decree`); Israel (ID: `person:Israel`); Love (ID: `keyterm:Love`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Horonites (ID: `group:Horonites`); Valley Gate (ID: `place:ValleyGate`); Tobiah (ID: `person:Tobiah.2`); Sanballat (ID: `person:Sanballat`); Ammon (ID: `place:Ammon`); Tribe of Judah (ID: `group:Judah`); Ammonites (ID: `group:Ammon`); Judah (ID: `person:Judah.4`); Euphrates River (ID: `place:Euphrates`); Cattle (ID: `fauna:Bull`); Dung Gate (ID: `place:DungGate`); Geshem (ID: `person:Geshem`); Fountain Gate (ID: `place:FountainGate`); Asaph (ID: `person:Asaph.4`); Artaxerxes (ID: `person:Artaxerxes`); Dragon Spring (ID: `place:DragonSpring`); Arabians (ID: `group:Arabia`); Siloam (ID: `place:Siloam`); Fear (ID: `keyterm:Fear`); Rebel (ID: `keyterm:Rebel`); Arabia (ID: `place:Arabia`); Jews (ID: `group:Jews`); Israel (ID: `person:Israel`); Wine (ID: `realia:Wine`); House (ID: `realia:House`); Vine (ID: `flora:Vine`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); Jerusalem (ID: `place:Jerusalem`); Sanballat (ID: `person:Sanballat`); Tobiah (ID: `person:Tobiah.2`); Jews (ID: `group:Jews`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); House (ID: `realia:House`); Vine (ID: `flora:Vine`); Geshem (ID: `person:Geshem`); Eliashib (ID: `person:Eliashib.7`); Meshullam (ID: `person:Meshullam.12`); Berechiah (ID: `person:Berechiah.5`); Mizpah (ID: `place:Mizpah`); Tower (ID: `realia:Tower`); Money (ID: `realia:Money`); Grain (ID: `flora:Grain`); Ophel (ID: `place:Ophel`); Uriah (ID: `person:Uriah.4`); Azariah (ID: `person:Azariah.17`); Hakkoz (ID: `person:Hakkoz.3`); Sheep Gate (ID: `place:SheepGate`); Meremoth (ID: `person:Meremoth`); Tekoa (ID: `place:Tekoa`); Dung Gate (ID: `place:DungGate`); Arabians (ID: `group:Arabia`); Ammonites (ID: `group:Ammon`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`)
...
* **Associated ACAI Concepts:** Instruction (ID: `keyterm:Instruction`); LORD (ID: `deity:Lord`); Ezra (ID: `person:Ezra`); Perceive (ID: `keyterm:Perceive`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Israel (ID: `person:Israel`); Scroll (ID: `realia:Scroll`); Water Gate (ID: `place:WaterGate`); Holy (ID: `keyterm:Holy`); Elam (ID: `person:Elam`); Moses (ID: `person:Moses`); Jeshua (ID: `person:Jeshua.4`); Solomon (ID: `person:Solomon`); Jerusalem (ID: `place:Jerusalem`); Daric (ID: `realia:Daric`); Arah (ID: `person:Arah.2`); Darkon (ID: `person:Darkon`); Hattil (ID: `person:Hattil`); Nebo (ID: `place:Nebo.2`); Malchijah (ID: `person:Malchijah.9`); Hezekiah (ID: `person:Hezekiah.2`); Jamin (ID: `person:Jamin.3`); Nekoda (ID: `person:Nekoda`); Besai (ID: `person:Besai`); Hadid (ID: `place:Hadid`); Harhur (ID: `person:Harhur`); Ami (ID: `person:Ami`); Harim (ID: `person:Harim.2`); Lebanah (ID: `person:Lebanah`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Dispossess (ID: `keyterm:Dispossess`); House (ID: `realia:House`); Israel (ID: `person:Israel`); To Sin (ID: `keyterm:Sin`); Shebaniah (ID: `person:Shebaniah.2`); Bani (ID: `person:Bani.8`); Kadmiel (ID: `person:Kadmiel`); Egypt (ID: `place:Egypt`); Jeshua (ID: `person:Jeshua.4`); Offering (ID: `keyterm:Offering`); Decree (ID: `keyterm:Decree`); Sabbath (ID: `keyterm:Sabbath`); Bani (ID: `person:Bani.11`); Hodiah (ID: `person:Hodiah.2`); Sherebiah (ID: `person:Sherebiah`); Moses (ID: `person:Moses`); Compassionate (ID: `keyterm:Compassionate`); Delight (ID: `keyterm:Delight`); Repent (ID: `keyterm:Repent`); Covenant (ID: `keyterm:Covenant`); Canaanites (ID: `group:Canaan`); Kindness (ID: `keyterm:Kindness`); Canaan (ID: `place:Canaan`); Truth (ID: `keyterm:Truth`); Work (ID: `keyterm:Work`); Generous (ID: `keyterm:Generous`)
...
* **Associated ACAI Concepts:** Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Jerusalem (ID: `place:Jerusalem`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Tribe of Benjamin (ID: `group:Benjamin`); Praise (ID: `keyterm:Praise`); Joshua (ID: `person:Joshua.5`); Benjamin (ID: `person:Benjamin`); Ezra (ID: `person:Ezra.2`); Bakbukiah (ID: `person:Bakbukiah`); Joiakim (ID: `person:Joiakim`); Johanan (ID: `person:Johanan.9`); Joiada (ID: `person:Joiada.2`); Mattaniah (ID: `person:Mattaniah`); Eliashib (ID: `person:Eliashib.8`); Jeremiah (ID: `person:Jeremiah.7`); Jedaiah (ID: `person:Jedaiah.3`); Shemaiah (ID: `person:Shemaiah.20`); Joiarib (ID: `person:Joiarib`); David (ID: `person:David`); Judah (ID: `person:Judah.7`); Obadiah (ID: `person:Obadiah.5`); Malluch (ID: `person:Malluch.4`); Mica (ID: `person:Mica.3`); Shebaniah (ID: `person:Shebaniah.3`); Iddo (ID: `person:Iddo.7`); Abijah (ID: `person:Abijah.7`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Sabbath (ID: `keyterm:Sabbath`); Jerusalem (ID: `place:Jerusalem`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Israel (ID: `person:Israel`); House (ID: `realia:House`); Pure (ID: `keyterm:Pure`); Offering (ID: `keyterm:Offering`); Tobiah (ID: `person:Tobiah.2`); Eliashib (ID: `person:Eliashib.9`); Vine (ID: `flora:Vine`); Kindness (ID: `keyterm:Kindness`); Ammon (ID: `place:Ammon`); David (ID: `person:David`); Ashdod (ID: `place:Ashdod`); To Dishonor (ID: `keyterm:Dishonor`); Instruction (ID: `keyterm:Instruction`); Holy (ID: `keyterm:Holy`); Solomon (ID: `person:Solomon`); Moab (ID: `place:Moab`); Eliashib (ID: `person:Eliashib.8`); Pedaiah (ID: `person:Pedaiah.7`); Asaph (ID: `person:Asaph.2`); Joiada (ID: `person:Joiada.2`); Horonites (ID: `group:Horonites`); Hanan (ID: `person:Hanan.8`); Shelemiah (ID: `person:Shelemiah.5`); Zadok (ID: `person:Zadok.8`); Mattaniah (ID: `person:Mattaniah.10`); Zaccur (ID: `person:Zaccur.8`); Frankincense (ID: `flora:Frankincense`); Grain (ID: `flora:Grain`); Anointing Oil (ID: `realia:AnointingOil`); Olive Tree (ID: `flora:OliveTree`); Mule (ID: `fauna:Mule`); Must (ID: `realia:Must`); Olive Oil (ID: `realia:OliveOil`); Babylon (ID: `place:Babylon`); Aaron (ID: `person:Aaron`); Priesthood (ID: `keyterm:Priesthood`); Well-Established (ID: `keyterm:BeFirm`); Be Unfaithful (ID: `keyterm:Unfaithful`); Bless (ID: `keyterm:Bless`); Nehemiah (ID: `person:Nehemiah.2`); Swear (ID: `keyterm:Swear`); Covenant (ID: `keyterm:Covenant`); Ammonites (ID: `group:Ammon`); Moses (ID: `person:Moses`); Sanballat (ID: `person:Sanballat`); Appoint (ID: `keyterm:Appoint`); Defilement (ID: `keyterm:Defilement`); Artaxerxes (ID: `person:Artaxerxes`); Tyrians (ID: `group:Tyre`); Perceive (ID: `keyterm:Perceive`); Tyre (ID: `place:Tyre`); To Sin (ID: `keyterm:Sin`); Jews (ID: `group:Jews`); Balaam (ID: `person:Balaam`); Zerubbabel (ID: `person:Zerubbabel.2`); Love (ID: `keyterm:Love`); Wine (ID: `realia:Wine`); Winepress (ID: `realia:Winepress`); Fig (ID: `flora:Fig`); Scroll (ID: `realia:Scroll`); Fish (ID: `fauna:Fish`); Donkey (ID: `fauna:Donkey`)
