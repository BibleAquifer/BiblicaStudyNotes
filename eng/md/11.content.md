...
* **Associated ACAI Concepts:** Solomon (ID: `person:Solomon`); LORD (ID: `deity:Lord`); David (ID: `person:David`); Adonijah (ID: `person:Adonijah`); Israel (ID: `person:Israel`); Benaiah (ID: `person:Benaiah`); Jehoiada (ID: `person:Jehoiada`); Nathan (ID: `person:Nathan.2`); Zadok (ID: `person:Zadok.2`); Joab (ID: `person:Joab`); Abiathar (ID: `person:Abiathar`); Shimei (ID: `person:Shimei.5`); Bathsheba (ID: `person:Bathsheba`); Swear (ID: `keyterm:Swear`); Abishag (ID: `person:Abishag`); Jerusalem (ID: `place:Jerusalem`); Shunammites (ID: `group:Shunammites`); Tribe of Judah (ID: `group:Judah`); Peace (ID: `keyterm:IntactState`); Ability (ID: `keyterm:Ability`); Judah (ID: `person:Judah.4`); House (ID: `realia:House`); Perceive (ID: `keyterm:Perceive`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Haggith (ID: `person:Haggith`); Egypt (ID: `place:Egypt`); Absalom (ID: `person:Absalom`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Solomon (ID: `person:Solomon`); Israel (ID: `person:Israel`); David (ID: `person:David`); Covenant Box (ID: `keyterm:CovenantBox`); Hiram (ID: `person:Hiram`); To Sin (ID: `keyterm:Sin`); Plea for Mercy (ID: `keyterm:Supplication`); Egypt (ID: `place:Egypt`); Bless (ID: `keyterm:Bless`); Covenant (ID: `keyterm:Covenant`); Forgive (ID: `keyterm:Forgive`); Cubit (ID: `realia:Cubit`); Cedar (ID: `flora:Cedar`); Winged Creature (ID: `realia:WingedCreature`); Ark of the Covenant (ID: `realia:ArkOfTheCovenant`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Craftsman (ID: `realia:Craftsman`); Hewn Stone (ID: `realia:HewnStone`); Cattle (ID: `fauna:Bull`); Most Holy Place (ID: `place:MostHolyPlace`); Hiram (ID: `person:Hiram.2`); To Beg for Mercy (ID: `keyterm:BegForMercy`); To Cause to Possess (ID: `keyterm:Possess`); Lebanon (ID: `place:Lebanon`); Moses (ID: `person:Moses`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); House (ID: `realia:House`); Force to Serve (ID: `keyterm:EnticedToServe`); David (ID: `person:David`); Israel (ID: `person:Israel`); Holy (ID: `keyterm:Holy`); Solomon (ID: `person:Solomon`); Straightness (ID: `keyterm:Straightness`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Egypt (ID: `place:Egypt`); Decree (ID: `keyterm:Decree`); Proverb (ID: `keyterm:Saying`); Gibeon (ID: `place:Gibeon`); Plea for Mercy (ID: `keyterm:Supplication`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jeroboam (ID: `person:Jeroboam`); Israel (ID: `person:Israel`); Rehoboam (ID: `person:Rehoboam`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Bethel (ID: `place:Bethel`); David (ID: `person:David`); Ahijah (ID: `person:Ahijah.2`); Solomon (ID: `person:Solomon`); Jerusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); To Sin (ID: `keyterm:Sin`); High Place (ID: `realia:HighPlace`); Donkey (ID: `fauna:Donkey`); Stone Pine (ID: `flora:Pine`); Yoke (ID: `realia:Yoke`); Egypt (ID: `place:Egypt`); Shiloh (ID: `place:Shiloh`); Counsel (ID: `keyterm:Counsel`); Rebel (ID: `keyterm:Rebel`); Lion (ID: `fauna:Lion`); Naamah (ID: `person:Naamah`); Nebat (ID: `person:Nebat`); Force to Serve (ID: `keyterm:EnticedToServe`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ahab (ID: `person:Ahab`); Elijah (ID: `person:Elijah`); Asa (ID: `person:Asa`); Baasha (ID: `person:Baasha`); Jehoshaphat (ID: `person:Jehoshaphat.3`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Samaria (ID: `place:Samaria`); Jeroboam (ID: `person:Jeroboam`); Naboth (ID: `person:Naboth`); Ben-hadad (ID: `person:Ben-hadad`); Jezebel (ID: `person:Jezebel`); To Sin (ID: `keyterm:Sin`); Omri (ID: `person:Omri`); Baal (ID: `deity:Baal`); Micaiah (ID: `person:Micaiah.5`); Zimri (ID: `person:Zimri.2`); Jezreel (ID: `place:Jezreel.2`); Syrians (ID: `group:Syria`); Tirzah (ID: `place:Tirzah`); Obadiah (ID: `person:Obadiah`); David (ID: `person:David`); An Angel (ID: `deity:Angel`); Ramoth-gilead (ID: `place:Ramoth-gilead`); Jezreel (ID: `group:Jezreel`); Nebat (ID: `person:Nebat`); Speak as a Prophet (ID: `keyterm:Speak`)
