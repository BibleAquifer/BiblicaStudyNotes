...
* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.3`); Azariah (ID: `person:Azariah.20`); Mishael (ID: `person:Mishael.3`); Hananiah (ID: `person:Hananiah.15`); Ability (ID: `keyterm:Ability`); Judah (ID: `person:Judah.4`); LORD (ID: `deity:Lord`); Tribe of Judah (ID: `group:Judah`); Melzar (ID: `person:Melzar`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`); Have Insight (ID: `keyterm:HaveInsight`); Jehoiakim (ID: `person:Jehoiakim`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Perceive (ID: `keyterm:Perceive`); Scroll (ID: `realia:Scroll`); Chaldeans (ID: `group:Chaldea`); Ashpenaz (ID: `person:Ashpenaz`); Jerusalem (ID: `place:Jerusalem`); Defile (ID: `keyterm:Stain`); Strength (ID: `keyterm:Strength`); Babylon (ID: `place:Babylon`); Conjurer (ID: `keyterm:Conjurer`); Public Official (ID: `person:GenericOfficial`); Shinar (ID: `place:Shinar`); Understanding (ID: `keyterm:Understanding`); Kindness (ID: `keyterm:Kindness`); Israel (ID: `person:Israel`); Intention (ID: `keyterm:Intention`); Chaldea (ID: `place:Chaldea`); Cyrus (ID: `person:Cyrus`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Mishael (ID: `person:Mishael.3`); Azariah (ID: `person:Azariah.20`); Hananiah (ID: `person:Hananiah.15`); Flute (ID: `realia:Flute`); Lyre (ID: `realia:Lyre`); Rams Horn (ID: `realia:RamsHorn`); Lute (ID: `realia:Lute`); Babylon (ID: `place:Babylon`); Bagpipe (ID: `realia:Bagpipe`); Offering (ID: `keyterm:Offering`); Jews (ID: `group:Jews`); Dura (ID: `place:Dura`); Astrologers (ID: `group:Astrologer`); A Messenger (ID: `person:Messenger`); LORD (ID: `deity:Lord`); Chaldea (ID: `place:Chaldea`); Cubit (ID: `realia:Cubit`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Daniel (ID: `person:Daniel.3`); LORD (ID: `deity:Lord`); Belshazzar (ID: `person:Belshazzar`); Astrologers (ID: `group:Astrologer`); Babylon (ID: `place:Babylon`); Chaldea (ID: `place:Chaldea`); House (ID: `realia:House`); Medes (ID: `group:Mede`); Jerusalem (ID: `place:Jerusalem`); Medan (ID: `person:Medan`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`); Darius (ID: `person:Darius.3`); Persians (ID: `group:Persia`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Persia (ID: `place:Persia`); A Disembodied Voice (ID: `deity:Voice`); Mina (ID: `realia:Mina`); Grass (ID: `flora:Grass`); Wild Donkey (ID: `fauna:WildDonkey`); Throne (ID: `realia:Throne`); Vulture (ID: `fauna:Vulture`); Balance (ID: `realia:Balance`)
...
* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.3`); Darius (ID: `person:Darius.3`); Lion (ID: `fauna:Lion`); Persia (ID: `place:Persia`); Persians (ID: `group:Persia`); Medan (ID: `person:Medan`); Medes (ID: `group:Mede`); Jerusalem (ID: `place:Jerusalem`); Public Officials (ID: `group:GenericOfficials`); Cyrus (ID: `person:Cyrus`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); House (ID: `realia:House`); Window (ID: `realia:Window`)
