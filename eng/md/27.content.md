...
* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.3`); Melzar (ID: `person:Melzar`); Mishael (ID: `person:Mishael.3`); Azariah (ID: `person:Azariah.20`); Hananiah (ID: `person:Hananiah.15`); Ashpenaz (ID: `person:Ashpenaz`); Ability (ID: `keyterm:Ability`); Jehoiakim (ID: `person:Jehoiakim`); Have Insight (ID: `keyterm:HaveInsight`); Chaldeans (ID: `group:Chaldea`)
...
* **Associated ACAI Concepts:** Arioch (ID: `person:Arioch.2`); Astrologers (ID: `group:Astrologer`); Daniel (ID: `person:Daniel.3`); Babylon (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Mishael (ID: `person:Mishael.3`); Azariah (ID: `person:Azariah.20`); Hananiah (ID: `person:Hananiah.15`); Bagpipe (ID: `realia:Bagpipe`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Flute (ID: `realia:Flute`); Dura (ID: `place:Dura`)
...
* **Associated ACAI Concepts:** Belshazzar (ID: `person:Belshazzar`); Astrologers (ID: `group:Astrologer`); Medes (ID: `group:Mede`); Darius (ID: `person:Darius.3`); Wild Donkey (ID: `fauna:WildDonkey`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Daniel (ID: `person:Daniel.3`); House (ID: `realia:House`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.3`); Darius (ID: `person:Darius.3`); Persians (ID: `group:Persia`); Lion (ID: `fauna:Lion`)
...
* **Associated ACAI Concepts:** Plea for Mercy (ID: `keyterm:Supplication`); Ulai (ID: `place:Ulai`); Michael (ID: `person:Michael.11`); Greece (ID: `place:Greece`); Vision (ID: `keyterm:Vision`); Gabriel (ID: `deity:Gabriel`); Darius (ID: `person:Darius.3`); Uphaz (ID: `place:Uphaz`); Tigris River (ID: `place:Tigris`); Leopard (ID: `fauna:Leopard`); Insight (ID: `keyterm:Insight`); Susa (ID: `place:Susa`); Appease (ID: `keyterm:Appease`); Ask for (ID: `keyterm:AskFor`); Daniel (ID: `person:Daniel.3`); Persia (ID: `place:Persia`); Have Insight (ID: `keyterm:HaveInsight`); Fortress (ID: `realia:Fortress`); Perceive (ID: `keyterm:Perceive`); Strength (ID: `keyterm:Strength`); Sheep (ID: `fauna:Lamb`); Rebel (ID: `keyterm:Rebel`); Truth (ID: `keyterm:Truth`); Covenant (ID: `keyterm:Covenant`); To Sin (ID: `keyterm:Sin`); Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`)
