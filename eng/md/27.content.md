...
* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.3`); Azariah (ID: `person:Azariah.20`); Mishael (ID: `person:Mishael.3`); Hananiah (ID: `person:Hananiah.15`); Ability (ID: `keyterm:Ability`); Judah (ID: `person:Judah.4`); LORD (ID: `deity:Lord`); Tribe of Judah (ID: `group:Judah`); Melzar (ID: `person:Melzar`); Wine (ID: `realia:Wine`); Vine (ID: `flora:Vine`); Jehoiakim (ID: `person:Jehoiakim`); Have Insight (ID: `keyterm:HaveInsight`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Perceive (ID: `keyterm:Perceive`); Scroll (ID: `realia:Scroll`); Ashpenaz (ID: `person:Ashpenaz`); Chaldeans (ID: `group:Chaldea`); Cyrus (ID: `person:Cyrus`); Strength (ID: `keyterm:Strength`); Jerusalem (ID: `place:Jerusalem`); Public Official (ID: `person:GenericOfficial`); Chaldea (ID: `place:Chaldea`); Israel (ID: `person:Israel`); Shinar (ID: `place:Shinar`); Intention (ID: `keyterm:Intention`); Defile (ID: `keyterm:Stain`); Understanding (ID: `keyterm:Understanding`); Kindness (ID: `keyterm:Kindness`); Babylon (ID: `place:Babylon`); Conjurer (ID: `keyterm:Conjurer`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.3`); Babylon (ID: `place:Babylon`); Arioch (ID: `person:Arioch.2`); Chaldea (ID: `place:Chaldea`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Astrologers (ID: `group:Astrologer`); Mishael (ID: `person:Mishael.3`); Hananiah (ID: `person:Hananiah.15`); Chaldeans (ID: `group:Chaldea`); Azariah (ID: `person:Azariah.20`); Money (ID: `realia:Money`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Conjurer (ID: `keyterm:Conjurer`); House (ID: `realia:House`); Threshing Floor (ID: `realia:ThreshingFloor`)
...
* **Associated ACAI Concepts:** Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Mishael (ID: `person:Mishael.3`); Azariah (ID: `person:Azariah.20`); Hananiah (ID: `person:Hananiah.15`); Flute (ID: `realia:Flute`); Lyre (ID: `realia:Lyre`); Lute (ID: `realia:Lute`); Rams Horn (ID: `realia:RamsHorn`); Babylon (ID: `place:Babylon`); Bagpipe (ID: `realia:Bagpipe`); Jews (ID: `group:Jews`); Offering (ID: `keyterm:Offering`); Dura (ID: `place:Dura`); A Messenger (ID: `person:Messenger`); LORD (ID: `deity:Lord`); Chaldea (ID: `place:Chaldea`); Astrologers (ID: `group:Astrologer`); Cubit (ID: `realia:Cubit`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** Nebuchadnezzar (ID: `person:Nebuchadnezzar`); LORD (ID: `deity:Lord`); Daniel (ID: `person:Daniel.3`); Belshazzar (ID: `person:Belshazzar`); Astrologers (ID: `group:Astrologer`); Chaldea (ID: `place:Chaldea`); Babylon (ID: `place:Babylon`); House (ID: `realia:House`); Medes (ID: `group:Mede`); Jerusalem (ID: `place:Jerusalem`); Medan (ID: `person:Medan`); Purple Cloth (ID: `realia:PurpleCloth`); Money (ID: `realia:Money`); Darius (ID: `person:Darius.3`); A Disembodied Voice (ID: `deity:Voice`); Judah (ID: `person:Judah.4`); Persians (ID: `group:Persia`); Tribe of Judah (ID: `group:Judah`); Persia (ID: `place:Persia`); Mina (ID: `realia:Mina`); Grass (ID: `flora:Grass`); Wild Donkey (ID: `fauna:WildDonkey`); Balance (ID: `realia:Balance`); Throne (ID: `realia:Throne`); Vulture (ID: `fauna:Vulture`)
...
* **Associated ACAI Concepts:** Daniel (ID: `person:Daniel.3`); Darius (ID: `person:Darius.3`); Lion (ID: `fauna:Lion`); Persians (ID: `group:Persia`); Persia (ID: `place:Persia`); Medes (ID: `group:Mede`); Medan (ID: `person:Medan`); Judah (ID: `person:Judah.4`); Cyrus (ID: `person:Cyrus`); Public Officials (ID: `group:GenericOfficials`); Jerusalem (ID: `place:Jerusalem`); Tribe of Judah (ID: `group:Judah`); Window (ID: `realia:Window`); House (ID: `realia:House`)
