...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Jerusalem (ID: `place:Jerusalem`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Joshua (ID: `person:Joshua.5`); Peace (ID: `keyterm:IntactState`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`); Zechariah (ID: `person:Zechariah.17`); Zerubbabel (ID: `person:Zerubbabel.2`); Passion (ID: `keyterm:Ardour`); Horn (ID: `keyterm:Horn`); Ask for (ID: `keyterm:AskFor`); Darius (ID: `person:Darius.2`); Horse (ID: `fauna:Horse`); Olive Tree (ID: `flora:OliveTree`); Jedaiah (ID: `person:Jedaiah.6`); Josiah (ID: `person:Josiah.2`); Berechiah (ID: `person:Berechiah.6`); Iddo (ID: `person:Iddo.6`); Zephaniah (ID: `person:Zephaniah.4`); Tobijah (ID: `person:Tobijah.2`); Heldai (ID: `person:Heldai`); Satan (ID: `deity:Satan`); Glory (ID: `keyterm:Glory`); Love (ID: `keyterm:Love`); Israel (ID: `person:Israel`); Come On! (ID: `keyterm:ComeOn`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); David (ID: `person:David`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Sheep (ID: `fauna:Lamb`); Horse (ID: `fauna:Horse`); House (ID: `realia:House`); Egypt (ID: `place:Egypt`); Money (ID: `realia:Money`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Plague (ID: `keyterm:Blow`); Israel (ID: `person:Israel`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Tribe of Ephraim (ID: `group:Ephraim`); Ephraim (ID: `person:Ephraim`); Utterance (ID: `keyterm:Utterance`); Assyria (ID: `place:Assyria`); Ekron (ID: `place:Ekron`); Appoint (ID: `keyterm:Appoint`); Covenant (ID: `keyterm:Covenant`); Lebanon (ID: `place:Lebanon`); Speak as a Prophet (ID: `keyterm:Speak`); Tyre (ID: `place:Tyre`); Bow (ID: `realia:Bow`); Sword (ID: `realia:Sword`); Vine (ID: `flora:Vine`); Staff (ID: `realia:Staff`)
