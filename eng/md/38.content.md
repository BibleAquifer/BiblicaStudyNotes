...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Jerusalem (ID: `place:Jerusalem`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Joshua (ID: `person:Joshua.5`); Truth (ID: `keyterm:Truth`); Peace (ID: `keyterm:IntactState`); House (ID: `realia:House`); Zerubbabel (ID: `person:Zerubbabel.2`); Zechariah (ID: `person:Zechariah.17`); Passion (ID: `keyterm:Ardour`); Darius (ID: `person:Darius.2`); Horn (ID: `keyterm:Horn`); Ask for (ID: `keyterm:AskFor`); Olive Tree (ID: `flora:OliveTree`); Horse (ID: `fauna:Horse`); Iddo (ID: `person:Iddo.6`); Jedaiah (ID: `person:Jedaiah.6`); Josiah (ID: `person:Josiah.2`); Heldai (ID: `person:Heldai`); Tobijah (ID: `person:Tobijah.2`); Zephaniah (ID: `person:Zephaniah.4`); Berechiah (ID: `person:Berechiah.6`); Satan (ID: `deity:Satan`); Glory (ID: `keyterm:Glory`); Fear (ID: `keyterm:Fear`); Come On! (ID: `keyterm:ComeOn`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); David (ID: `person:David`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); House (ID: `realia:House`); Egypt (ID: `place:Egypt`); Horse (ID: `fauna:Horse`); Money (ID: `realia:Money`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Plague (ID: `keyterm:Blow`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Israel (ID: `person:Israel`); Tribe of Ephraim (ID: `group:Ephraim`); Ephraim (ID: `person:Ephraim`); Assyria (ID: `place:Assyria`); Tyre (ID: `place:Tyre`); Lebanon (ID: `place:Lebanon`); Speak as a Prophet (ID: `keyterm:Speak`); Utterance (ID: `keyterm:Utterance`); Appoint (ID: `keyterm:Appoint`); Covenant (ID: `keyterm:Covenant`); Ekron (ID: `place:Ekron`); Bow (ID: `realia:Bow`); Staff (ID: `realia:Staff`); Vine (ID: `flora:Vine`); Sword (ID: `realia:Sword`)
