...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); An Angel (ID: `deity:Angel`); Jerusalem (ID: `place:Jerusalem`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Joshua (ID: `person:Joshua.5`); Peace (ID: `keyterm:IntactState`); Truth (ID: `keyterm:Truth`); House (ID: `realia:House`); Zechariah (ID: `person:Zechariah.17`); Zerubbabel (ID: `person:Zerubbabel.2`); Passion (ID: `keyterm:Ardour`); Horn (ID: `keyterm:Horn`); Darius (ID: `person:Darius.2`); Ask for (ID: `keyterm:AskFor`); Horse (ID: `fauna:Horse`); Olive Tree (ID: `flora:OliveTree`); Josiah (ID: `person:Josiah.2`); Jedaiah (ID: `person:Jedaiah.6`); Iddo (ID: `person:Iddo.6`); Berechiah (ID: `person:Berechiah.6`); Zephaniah (ID: `person:Zephaniah.4`); Tobijah (ID: `person:Tobijah.2`); Heldai (ID: `person:Heldai`); Satan (ID: `deity:Satan`); Be Zealous (ID: `keyterm:Zealous`); Come On! (ID: `keyterm:ComeOn`); Israel (ID: `person:Israel`); Babylon (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); David (ID: `person:David`); Goat (ID: `fauna:Goat`); Flock (ID: `fauna:Flock`); Sheep (ID: `fauna:Lamb`); Egypt (ID: `place:Egypt`); House (ID: `realia:House`); Horse (ID: `fauna:Horse`); Money (ID: `realia:Money`); Feast of Tabernacles (ID: `keyterm:FeastOfTabernacles`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Israel (ID: `person:Israel`); Tribe of Ephraim (ID: `group:Ephraim`); Ephraim (ID: `person:Ephraim`); Plague (ID: `keyterm:Blow`); Lebanon (ID: `place:Lebanon`); Tyre (ID: `place:Tyre`); Speak as a Prophet (ID: `keyterm:Speak`); Covenant (ID: `keyterm:Covenant`); Assyria (ID: `place:Assyria`); Ekron (ID: `place:Ekron`); Appoint (ID: `keyterm:Appoint`); Utterance (ID: `keyterm:Utterance`); Bow (ID: `realia:Bow`); Sword (ID: `realia:Sword`); Rod (ID: `realia:Rod`); Staff (ID: `realia:Staff`)
