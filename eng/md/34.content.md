...
* **Associated ACAI Concepts:** Nahum (ID: `person:Nahum.2`); Elkosh (ID: `place:Elkosh`)
...
* **Associated ACAI Concepts:** Protective Shield (ID: `realia:ProtectiveShield`); Brick Mold (ID: `realia:BrickMold`); Amon (ID: `deity:Amon`); Thebes (ID: `place:Thebes`); LORD (ID: `deity:Lord`)
