...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Cyrus (ID: `person:Cyrus`); House (ID: `realia:House`); Money (ID: `realia:Money`); Israel (ID: `person:Israel`); Persia (ID: `place:Persia`); Levi (ID: `person:Levi.3`); Zerubbabel (ID: `person:Zerubbabel.2`); Tribe of Levi (ID: `group:Levi`); Elam (ID: `person:Elam`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Babylon (ID: `place:Babylon`); Solomon (ID: `person:Solomon`); Shalmai (ID: `person:Shalmai`); Shobai (ID: `person:Shobai`); Akkub (ID: `person:Akkub.3`); Keros (ID: `person:Keros`); Jedaiah (ID: `person:Jedaiah.4`); Mehida (ID: `person:Mehida`); Ziha (ID: `person:Ziha`); Netophah (ID: `place:Netophah`); Gahar (ID: `person:Gahar`); Ater (ID: `person:Ater.2`); Sophereth (ID: `person:Sophereth`); Hashum (ID: `person:Hashum`); Rezin (ID: `person:Rezin.2`); Jeshua (ID: `person:Jeshua`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Israel (ID: `person:Israel`); Zerubbabel (ID: `person:Zerubbabel.2`); Euphrates River (ID: `place:Euphrates`); Persia (ID: `place:Persia`); Cyrus (ID: `person:Cyrus`); Judah (ID: `person:Judah.4`); Babylon (ID: `place:Babylon`); Darius (ID: `person:Darius.2`); Offering (ID: `keyterm:Offering`); Rehum (ID: `person:Rehum.2`); Shimshai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Joshua (ID: `person:Joshua.5`); Jews (ID: `group:Jews`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Jehozadak (ID: `person:Jehozadak`); Shealtiel (ID: `person:Shealtiel.2`); Tribe of Judah (ID: `group:Judah`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Samaria (ID: `place:Samaria`); Mithredath (ID: `person:Mithredath.2`); Bishlam (ID: `person:Bishlam`); Henadad (ID: `person:Henadad`); Hodaviah (ID: `person:Hodaviah.4`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Darius (ID: `person:Darius.2`); Jerusalem (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Euphrates River (ID: `place:Euphrates`); Jews (ID: `group:Jews`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Scroll (ID: `realia:Scroll`); Tattenai (ID: `person:Tattenai`); Babylon (ID: `place:Babylon`); Offering (ID: `keyterm:Offering`); LORD (ID: `deity:Lord`); Passover (ID: `keyterm:Passover`); Cyrus (ID: `person:Cyrus`); Sheep (ID: `fauna:Lamb`); Ecbatana (ID: `place:Ecbatana`); Zechariah (ID: `person:Zechariah.17`); Media (ID: `place:Media`); Pure (ID: `keyterm:Pure`); Haggai (ID: `person:Haggai`); Artaxerxes (ID: `person:Artaxerxes`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Persia (ID: `place:Persia`); Assyria (ID: `place:Assyria`); Moses (ID: `person:Moses`); Defilement (ID: `keyterm:Defilement`); Gentiles (ID: `group:Gentile`); Iddo (ID: `person:Iddo.6`); Unleavened Bread (ID: `realia:UnleavenedBread`); Wheat (ID: `flora:Wheat`); Foundation (ID: `realia:Foundation`); Flock (ID: `fauna:Flock`); Cubit (ID: `realia:Cubit`); Goat (ID: `fauna:Goat`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Artaxerxes (ID: `person:Artaxerxes`); House (ID: `realia:House`); Money (ID: `realia:Money`); Babylon (ID: `place:Babylon`); Ahava (ID: `place:Ahava`); Offering (ID: `keyterm:Offering`); Euphrates River (ID: `place:Euphrates`); Hashabiah (ID: `person:Hashabiah.7`); Sherebiah (ID: `person:Sherebiah`); Decree (ID: `keyterm:Decree`); Perceive (ID: `keyterm:Perceive`); Instruction (ID: `keyterm:Instruction`); Phinehas (ID: `person:Phinehas`); David (ID: `person:David`); Jehiel (ID: `person:Jehiel.7`); Zechariah (ID: `person:Zechariah.19`); Daniel (ID: `person:Daniel.2`); Hakkatan (ID: `person:Hakkatan`); Elam (ID: `person:Elam`); Nathan (ID: `person:Nathan.5`); Ebed (ID: `person:Ebed.2`); Jozabad (ID: `person:Jozabad.6`); Athaliah (ID: `person:Athaliah.3`); Noadiah (ID: `person:Noadiah`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); Levi (ID: `person:Levi.3`); Tribe of Levi (ID: `group:Levi`); Passion (ID: `keyterm:Ardour`); Jerusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Elam (ID: `person:Elam`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`); Offering (ID: `keyterm:Offering`); Counsel (ID: `keyterm:Counsel`); Mattenai (ID: `person:Mattenai.2`); Mattaniah (ID: `person:Mattaniah.6`); Mattenai (ID: `person:Mattenai`); Jeremoth (ID: `person:Jeremoth.4`); Bani (ID: `person:Bani.5`); Zabad (ID: `person:Zabad.7`); Jahzeiah (ID: `person:Jahzeiah`); Jehiel (ID: `person:Jehiel.8`); Bedeiah (ID: `person:Bedeiah`); Vaniah (ID: `person:Vaniah`); Maaseiah (ID: `person:Maaseiah.9`); Zebina (ID: `person:Zebina`); Benaiah (ID: `person:Benaiah.8`); Binnui (ID: `person:Binnui.3`); Pethahiah (ID: `person:Pethahiah.2`)
