...
* **Associated Articles:** God (ID: `132145@BiblicaStudyNotesKeyTerms`); Work (ID: `132154@BiblicaStudyNotesKeyTerms`); Egypt (ID: `132197@BiblicaStudyNotesKeyTerms`); Covenant with Abraham (ID: `132199@BiblicaStudyNotesKeyTerms`); Slaves (ID: `132204@BiblicaStudyNotesKeyTerms`); Israel (ID: `132226@BiblicaStudyNotesKeyTerms`); Judah (ID: `132237@BiblicaStudyNotesKeyTerms`); Benjamin (ID: `132240@BiblicaStudyNotesKeyTerms`); God’s people (ID: `132248@BiblicaStudyNotes`); Exodus (ID: `132262@BiblicaStudyNotesKeyTerms`); King (ID: `132276@BiblicaStudyNotesKeyTerms`); Priest (ID: `132279@BiblicaStudyNotesKeyTerms`); Holy tent (ID: `132280@BiblicaStudyNotesKeyTerms`); Levites (ID: `132289@BiblicaStudyNotesKeyTerms`); Prophecy (ID: `132345@BiblicaStudyNotesKeyTerms`); Temple (ID: `132363@BiblicaStudyNotesKeyTerms`); Jerusalem (ID: `132410@BiblicaStudyNotesKeyTerms`); Solomon (ID: `132419@BiblicaStudyNotesKeyTerms`); Southern kingdom (ID: `132426@BiblicaStudyNotesKeyTerms`); BC (ID: `132440@BiblicaStudyNotesKeyTerms`); Exile (ID: `132441@BiblicaStudyNotesKeyTerms`); Isaiah (ID: `132443@BiblicaStudyNotesKeyTerms`); Babylon (ID: `132444@BiblicaStudyNotesKeyTerms`); Nebuchadnezzar (ID: `132447@BiblicaStudyNotesKeyTerms`); Cyrus (ID: `132448@BiblicaStudyNotesKeyTerms`); Jew (ID: `132449@BiblicaStudyNotesKeyTerms`); Jeremiah (ID: `132453@BiblicaStudyNotesKeyTerms`)

* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Cyrus (ID: `person:Cyrus`); Money (ID: `realia:Money`); House (ID: `realia:House`); Israel (ID: `person:Israel`); Persia (ID: `place:Persia`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Zerubbabel (ID: `person:Zerubbabel.2`); Elam (ID: `person:Elam`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Solomon (ID: `person:Solomon`); Babylon (ID: `place:Babylon`); Arah (ID: `person:Arah.2`); Darkon (ID: `person:Darkon`); Hattil (ID: `person:Hattil`); Nebo (ID: `place:Nebo.2`); Mithredath (ID: `person:Mithredath`); Hezekiah (ID: `person:Hezekiah.2`); Nekoda (ID: `person:Nekoda`); Besai (ID: `person:Besai`); Hadid (ID: `place:Hadid`); Harhur (ID: `person:Harhur`); Ami (ID: `person:Ami`); Harim (ID: `person:Harim.2`); Lebanah (ID: `person:Lebanah`); Mehida (ID: `person:Mehida`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Israel (ID: `person:Israel`); Zerubbabel (ID: `person:Zerubbabel.2`); Euphrates River (ID: `place:Euphrates`); Cyrus (ID: `person:Cyrus`); Persia (ID: `place:Persia`); Offering (ID: `keyterm:Offering`); Babylon (ID: `place:Babylon`); Darius (ID: `person:Darius.2`); Judah (ID: `person:Judah.4`); Rehum (ID: `person:Rehum.2`); Shimshai (ID: `person:Shimshai`); Artaxerxes (ID: `person:Artaxerxes.2`); Joshua (ID: `person:Joshua.5`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Jews (ID: `group:Jews`); Shealtiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Tribe of Judah (ID: `group:Judah`); Tattenai (ID: `person:Tattenai`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Samaria (ID: `place:Samaria`); Osnappar (ID: `person:Osnappar`); Henadad (ID: `person:Henadad`); Jeshua (ID: `person:Jeshua.4`); Bishlam (ID: `person:Bishlam`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Darius (ID: `person:Darius.2`); Jerusalem (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Jews (ID: `group:Jews`); Euphrates River (ID: `place:Euphrates`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Scroll (ID: `realia:Scroll`); Tattenai (ID: `person:Tattenai`); Offering (ID: `keyterm:Offering`); Babylon (ID: `place:Babylon`); Passover (ID: `keyterm:Passover`); LORD (ID: `deity:Lord`); Cyrus (ID: `person:Cyrus`); Sheep (ID: `fauna:Lamb`); Ecbatana (ID: `place:Ecbatana`); Zechariah (ID: `person:Zechariah.17`); Iddo (ID: `person:Iddo.6`); Media (ID: `place:Media`); Persia (ID: `place:Persia`); Pure (ID: `keyterm:Pure`); Moses (ID: `person:Moses`); Gentiles (ID: `group:Gentile`); Defilement (ID: `keyterm:Defilement`); Haggai (ID: `person:Haggai`); Artaxerxes (ID: `person:Artaxerxes`); Assyria (ID: `place:Assyria`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Money (ID: `realia:Money`); Hewn Stone (ID: `realia:HewnStone`); Goat (ID: `fauna:Goat`); Cubit (ID: `realia:Cubit`); Flock (ID: `fauna:Flock`); Wheat (ID: `flora:Wheat`); Unleavened Bread (ID: `realia:UnleavenedBread`); Anointing Oil (ID: `realia:AnointingOil`); Foundation (ID: `realia:Foundation`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Passion (ID: `keyterm:Ardour`); Jerusalem (ID: `place:Jerusalem`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Tribe of Judah (ID: `group:Judah`); Counsel (ID: `keyterm:Counsel`); Offering (ID: `keyterm:Offering`); Elam (ID: `person:Elam`); Judah (ID: `person:Judah.4`); Jehiel (ID: `person:Jehiel.9`); Sheal (ID: `person:Sheal`); Maaseiah (ID: `person:Maaseiah.8`); Benaiah (ID: `person:Benaiah.8`); Pethahiah (ID: `person:Pethahiah.2`); Eliezer (ID: `person:Eliezer.10`); Jeremoth (ID: `person:Jeremoth.5`); Bani (ID: `person:Bani.5`); Perizzites (ID: `group:Perizzites`); Mattenai (ID: `person:Mattenai`); Mattithiah (ID: `person:Mattithiah.3`); Malluch (ID: `person:Malluch.3`); Joel (ID: `person:Joel.12`); Shallum (ID: `person:Shallum.10`); Jeremai (ID: `person:Jeremai`)
