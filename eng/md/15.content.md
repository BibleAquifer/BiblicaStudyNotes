...
* **Associated ACAI Concepts:** Cyrus (ID: `person:Cyrus`); Magbish (ID: `place:Magbish`); Hagab (ID: `person:Hagab`); Mithredath (ID: `person:Mithredath`); Akkub (ID: `person:Akkub.3`); Asnah (ID: `person:Asnah`); Persia (ID: `place:Persia`); Elam (ID: `person:Elam`); Delaiah (ID: `person:Delaiah.3`); Sotai (ID: `person:Sotai`); Hatita (ID: `person:Hatita`); Habaiah (ID: `person:Habaiah`); Peruda (ID: `person:Peruda`); Tabbaoth (ID: `person:Tabbaoth`); Gazzam (ID: `person:Gazzam`); Nephushesim (ID: `group:Nephushesim`); Mordecai (ID: `person:Mordecai`); Nehemiah (ID: `person:Nehemiah`); Hezekiah (ID: `person:Hezekiah.2`); Padon (ID: `person:Padon`); Neziah (ID: `person:Neziah`); Gahar (ID: `person:Gahar`); Zaccai (ID: `person:Zaccai.2`); Temah (ID: `person:Temah`); Hanan (ID: `person:Hanan.4`); Jeshua (ID: `person:Jeshua.3`); Harim (ID: `person:Harim.2`); Bigvai (ID: `person:Bigvai`); Hasupha (ID: `person:Hasupha`); Hatipha (ID: `person:Hatipha`)
...
* **Associated ACAI Concepts:** Artaxerxes (ID: `person:Artaxerxes.2`); Rehum (ID: `person:Rehum.2`); Shimshai (ID: `person:Shimshai`); Zerubbabel (ID: `person:Zerubbabel.2`); Joshua (ID: `person:Joshua.5`); Bishlam (ID: `person:Bishlam`); Tabeel (ID: `person:Tabeel`); Mithredath (ID: `person:Mithredath.2`); Babylonians (ID: `group:Babylon`); Dinaite (ID: `person:Dinaite`); Osnappar (ID: `person:Osnappar`); Shealtiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Relatives (ID: `group:Relatives`); Erech (ID: `place:Erech`); Henadad (ID: `person:Henadad`); Esarhaddon (ID: `person:Esarhaddon`); Hodaviah (ID: `person:Hodaviah.4`); Iddo (ID: `person:Iddo.6`); Zechariah (ID: `person:Zechariah.17`); Jeshua (ID: `person:Jeshua.4`); Kadmiel (ID: `person:Kadmiel`); Haggai (ID: `person:Haggai`); Ahasuerus (ID: `person:Ahasuerus`); Cyrus (ID: `person:Cyrus`); Darius (ID: `person:Darius.2`); Persia (ID: `place:Persia`); Euphrates River (ID: `place:Euphrates`)
...
* **Associated ACAI Concepts:** Darius (ID: `person:Darius.2`); Ecbatana (ID: `place:Ecbatana`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Zechariah (ID: `person:Zechariah.17`); House (ID: `realia:House`); Jerusalem (ID: `place:Jerusalem`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Ahava (ID: `place:Ahava`); Ezra (ID: `person:Ezra`); Ebed (ID: `person:Ebed.2`); Joiarib (ID: `person:Joiarib.2`); Elnathan (ID: `person:Elnathan.2`); Binnui (ID: `person:Binnui.2`); Shelomith (ID: `person:Shelomith.4`); Gershom (ID: `person:Gershom.2`); Jarib (ID: `person:Jarib.2`); Jahaziel (ID: `person:Jahaziel.5`); Zebadiah (ID: `person:Zebadiah.8`); Johanan (ID: `person:Johanan.8`); Uthai (ID: `person:Uthai.2`); Shemaiah (ID: `person:Shemaiah.14`); Eliehoenai (ID: `person:Eliehoenai.2`); Jeshaiah (ID: `person:Jeshaiah.5`); Zechariah (ID: `person:Zechariah.18`); Noadiah (ID: `person:Noadiah`); Josiphiah (ID: `person:Josiphiah`); Meshullam (ID: `person:Meshullam.9`); Elnathan (ID: `person:Elnathan.3`); Zechariah (ID: `person:Zechariah.20`); Jonathan (ID: `person:Jonathan.9`); Casiphia (ID: `place:Casiphia`); Elnathan (ID: `person:Elnathan.4`); Jeshua (ID: `person:Jeshua.5`); Zechariah (ID: `person:Zechariah.19`); Zerahiah (ID: `person:Zerahiah.2`); Joab (ID: `person:Joab.4`); Hakkatan (ID: `person:Hakkatan`)
...
* **Associated ACAI Concepts:** Be Unfaithful (ID: `keyterm:Unfaithful`); Shemariah (ID: `person:Shemariah.4`); Uzziah (ID: `person:Uzziah.4`); Maaseiah (ID: `person:Maaseiah.7`); Malchijah (ID: `person:Malchijah.5`); Mattattah (ID: `person:Mattattah`); Jozabad (ID: `person:Jozabad.8`); Benaiah (ID: `person:Benaiah.8`); Shemariah (ID: `person:Shemariah.3`); Jeremoth (ID: `person:Jeremoth.4`); Jaddai (ID: `person:Jaddai`); Ramiah (ID: `person:Ramiah`); Eliezer (ID: `person:Eliezer.11`); Sheal (ID: `person:Sheal`); Athlai (ID: `person:Athlai`); Shimeon (ID: `person:Shimeon`); Jeremoth (ID: `person:Jeremoth.5`); Jeremoth (ID: `person:Jeremoth.3`); Shelemiah (ID: `person:Shelemiah.3`); Zechariah (ID: `person:Zechariah.21`); Mattithiah (ID: `person:Mattithiah.3`); Zebina (ID: `person:Zebina`); Eleazar (ID: `person:Eleazar.7`); Binnui (ID: `person:Binnui.4`); Adaiah (ID: `person:Adaiah.5`); Manasseh (ID: `person:Manasseh.3`); Jehohanan (ID: `person:Jehohanan.4`); Vaniah (ID: `person:Vaniah`); Mijamin (ID: `person:Mijamin.2`); Elijah (ID: `person:Elijah.3`)
