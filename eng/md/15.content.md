...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Tribe of Judah (ID: `group:Judah`); Judah (ID: `person:Judah.4`); Cyrus (ID: `person:Cyrus`); House (ID: `realia:House`); Money (ID: `realia:Money`); Israel (ID: `person:Israel`); Persia (ID: `place:Persia`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Zerubbabel (ID: `person:Zerubbabel.2`); Elam (ID: `person:Elam`); Solomon (ID: `person:Solomon`); Babylon (ID: `place:Babylon`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Shalmai (ID: `person:Shalmai`); Sotai (ID: `person:Sotai`); Ziha (ID: `person:Ziha`); Talmon (ID: `person:Talmon`); Jeshua (ID: `person:Jeshua.4`); Barzillai (ID: `person:Barzillai.3`); Bezai (ID: `person:Bezai`); Sophereth (ID: `person:Sophereth`); Harim (ID: `person:Harim`); Hadid (ID: `place:Hadid`); Hagabah (ID: `person:Hagabah`); Temah (ID: `person:Temah`); Mehida (ID: `person:Mehida`); Bani (ID: `person:Bani`)
...
* **Associated ACAI Concepts:** Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); House (ID: `realia:House`); Israel (ID: `person:Israel`); Zerubbabel (ID: `person:Zerubbabel.2`); Euphrates River (ID: `place:Euphrates`); Persia (ID: `place:Persia`); Cyrus (ID: `person:Cyrus`); Darius (ID: `person:Darius.2`); Offering (ID: `keyterm:Offering`); Judah (ID: `person:Judah.4`); Babylon (ID: `place:Babylon`); Rehum (ID: `person:Rehum.2`); Shimshai (ID: `person:Shimshai`); Joshua (ID: `person:Joshua.5`); Artaxerxes (ID: `person:Artaxerxes.2`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Jews (ID: `group:Jews`); Shealtiel (ID: `person:Shealtiel.2`); Jehozadak (ID: `person:Jehozadak`); Tribe of Judah (ID: `group:Judah`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Tattenai (ID: `person:Tattenai`); Samaria (ID: `place:Samaria`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Iddo (ID: `person:Iddo.6`); Henadad (ID: `person:Henadad`); Jeshua (ID: `person:Jeshua.4`); Ahasuerus (ID: `person:Ahasuerus`)
...
* **Associated ACAI Concepts:** House (ID: `realia:House`); Darius (ID: `person:Darius.2`); Jerusalem (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Tribe of Levi (ID: `group:Levi`); Euphrates River (ID: `place:Euphrates`); Levi (ID: `person:Levi.3`); Jews (ID: `group:Jews`); Shethar-bozenai (ID: `person:Shethar-bozenai`); Scroll (ID: `realia:Scroll`); Tattenai (ID: `person:Tattenai`); Passover (ID: `keyterm:Passover`); Cyrus (ID: `person:Cyrus`); LORD (ID: `deity:Lord`); Babylon (ID: `place:Babylon`); Offering (ID: `keyterm:Offering`); Sheep (ID: `fauna:Lamb`); Zechariah (ID: `person:Zechariah.17`); Ecbatana (ID: `place:Ecbatana`); Iddo (ID: `person:Iddo.6`); Haggai (ID: `person:Haggai`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Moses (ID: `person:Moses`); Pure (ID: `keyterm:Pure`); Persia (ID: `place:Persia`); Defilement (ID: `keyterm:Defilement`); Artaxerxes (ID: `person:Artaxerxes`); Assyria (ID: `place:Assyria`); Media (ID: `place:Media`); Gentiles (ID: `group:Gentile`); Olive Oil (ID: `realia:OliveOil`); Cubit (ID: `realia:Cubit`); Money (ID: `realia:Money`); Goat (ID: `fauna:Goat`); Hewn Stone (ID: `realia:HewnStone`); Wheat (ID: `flora:Wheat`); Anointing Oil (ID: `realia:AnointingOil`); Flock (ID: `fauna:Flock`); Foundation (ID: `realia:Foundation`); Unleavened Bread (ID: `realia:UnleavenedBread`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Artaxerxes (ID: `person:Artaxerxes`); House (ID: `realia:House`); Money (ID: `realia:Money`); Babylon (ID: `place:Babylon`); Ahava (ID: `place:Ahava`); Offering (ID: `keyterm:Offering`); Euphrates River (ID: `place:Euphrates`); Hashabiah (ID: `person:Hashabiah.7`); Sherebiah (ID: `person:Sherebiah`); Decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); David (ID: `person:David`); Perceive (ID: `keyterm:Perceive`); Phinehas (ID: `person:Phinehas`); Amariah (ID: `person:Amariah.2`); Elam (ID: `person:Elam`); Noadiah (ID: `person:Noadiah`); Zechariah (ID: `person:Zechariah.20`); Zerahiah (ID: `person:Zerahiah`); Meshullam (ID: `person:Meshullam.9`); Zechariah (ID: `person:Zechariah.19`); Bigvai (ID: `person:Bigvai.2`); Gershom (ID: `person:Gershom.2`); Jozabad (ID: `person:Jozabad.6`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`); Ezra (ID: `person:Ezra`); Be Unfaithful (ID: `keyterm:Unfaithful`); Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); Jerusalem (ID: `place:Jerusalem`); Passion (ID: `keyterm:Ardour`); House (ID: `realia:House`); Harim (ID: `person:Harim`); Elam (ID: `person:Elam`); Tribe of Judah (ID: `group:Judah`); Offering (ID: `keyterm:Offering`); Judah (ID: `person:Judah.4`); Counsel (ID: `keyterm:Counsel`); Zabad (ID: `person:Zabad.6`); Elijah (ID: `person:Elijah.4`); Eliashib (ID: `person:Eliashib.5`); Amram (ID: `person:Amram.2`); Jehiel (ID: `person:Jehiel.10`); Maaseiah (ID: `person:Maaseiah.6`); Bani (ID: `person:Bani.6`); Malluch (ID: `person:Malluch.2`); Nethanel (ID: `person:Nethanel.8`); Shimei (ID: `person:Shimei.16`); Eliashib (ID: `person:Eliashib.4`); Ishmael (ID: `person:Ishmael.6`); Bani (ID: `person:Bani`); Uel (ID: `person:Uel`); Eliezer (ID: `person:Eliezer.11`)
