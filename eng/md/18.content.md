...
* **Associated ACAI Concepts:** Satan (ID: `deity:Satan`); Job (ID: `person:Job`); Job's Wife (ID: `person:WifeOfJob`); Sheba (ID: `person:Sheba`); Bless (ID: `keyterm:Bless`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Naamathites (ID: `group:Naamathites`); Zophar (ID: `person:Zophar`); Shuhites (ID: `group:Shuhites`); Bildad (ID: `person:Bildad`); Eliphaz (ID: `person:Eliphaz.2`); Temanites (ID: `group:Teman`)
...
* **Associated ACAI Concepts:** Sound Wisdom (ID: `keyterm:SoundWisdom`); Mallow (ID: `flora:Mallow`); Mischief (ID: `keyterm:Mischief`); Bildad (ID: `person:Bildad`); Orache (ID: `flora:Orache`); Loincloth (ID: `realia:Loincloth`); Trap (ID: `realia:Trap`); Intention (ID: `keyterm:Intention`); Moth (ID: `fauna:Moth`); Zophar (ID: `person:Zophar`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Mighty (ID: `keyterm:Mighty.2`); Papyrus (ID: `flora:Papyrus`); Spider (ID: `fauna:Spider`); Shuttle (ID: `realia:Shuttle`); Tema (ID: `place:Tema`); Stylus (ID: `realia:Stylus`); Broom (ID: `flora:Broom`); Hammada (ID: `flora:Soap`); Weed (ID: `flora:Weed`); Fishnet (ID: `realia:Fishnet`); Dragon (ID: `fauna:Dragon`); Worm (ID: `fauna:Maggot`); Job (ID: `person:Job`); Believe In (ID: `keyterm:BelieveIn`); Exempt (ID: `keyterm:Exempt`); Hope (ID: `keyterm:Hope`); Strength (ID: `keyterm:Strength`); Safety (ID: `keyterm:Safety`); Perceive (ID: `keyterm:Perceive`)
...
* **Associated ACAI Concepts:** Elihu (Friend of Job). (ID: `person:Elihu.5`); Barachel (ID: `person:Barachel`); Buzites (ID: `group:Buzites`); Ram (ID: `person:Ram.3`); To Declare Guilty (ID: `keyterm:DeclareGuilty`); Mighty One (ID: `keyterm:MightyOne`); Skin-Bottle (ID: `realia:Skin-bottle`); Job (ID: `person:Job`); Mischief (ID: `keyterm:Mischief`); Hell (ID: `place:Hell`); Perceive (ID: `keyterm:Perceive`); Rebel (ID: `keyterm:Rebel`); Be (Or Show Oneself) Just (ID: `keyterm:Just`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Ibex (ID: `fauna:Ibex`); Manger (ID: `realia:Manger`); Falcon (ID: `fauna:Falcon`); Ostrich (ID: `fauna:Ostrich`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** Jemimah (ID: `person:Jemimah`); Keziah (ID: `person:Keziah`); Keren-happuch (ID: `person:Keren-happuch`); Eliphaz (ID: `person:Eliphaz.2`); Piece of Money (ID: `realia:PieceOfMoney`); Zophar (ID: `person:Zophar`); Bildad (ID: `person:Bildad`); Job (ID: `person:Job`); LORD (ID: `deity:Lord`)
