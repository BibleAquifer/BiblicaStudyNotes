...
* **Associated ACAI Concepts:** Train (ID: `realia:Train`); Rebel (ID: `keyterm:Rebel`); Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`); Israel (ID: `person:Israel`)
...
* **Associated ACAI Concepts:** Poisonous Hemlock (ID: `flora:PoisonousHemlock`); Jackal (ID: `fauna:Jackal`); Uz (ID: `place:Uz`); Defile (ID: `keyterm:Stain`); Ostrich (ID: `fauna:Ostrich`); To Sin (ID: `keyterm:Sin`); Jerusalem (ID: `place:Jerusalem`); LORD (ID: `deity:Lord`)
